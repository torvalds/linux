...
early_param("kasan.page_alloc.sample.order",
    early_kasan_flag_page_alloc_sample_order);
...
void __init kasan_init_hw_tags(void) {
  ...
  pr_info(
      "KernelAddressSanitizer initialized (hw-tags, mode=%s, vmalloc=%s, stacktrace=%s)\n",
      kasan_mode_info(),
