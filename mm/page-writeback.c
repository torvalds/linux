...
static struct dirty_throttle_control *mdtc_gdtc(
...
static int __bdi_set_min_ratio(struct backing_dev_info *bdi,
...
static int __bdi_set_max_ratio(struct backing_dev_info *bdi,
...
static unsigned long __wb_calc_thresh(struct dirty_throttle_control *dtc) {
  ...
  wb_thresh = (thresh * (100 * BDI_RATIO_SCALE - bdi_min_ratio))
      / (100 * BDI_RATIO_SCALE);
  wb_thresh *= numerator;
...
/**
 * filemap_dirty_folio - Mark a folio dirty for filesystems which do not use
 * buffer_heads.
