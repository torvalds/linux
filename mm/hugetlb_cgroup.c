...
static inline struct page_counter *__hugetlb_cgroup_counter_from_cgroup(
    struct hugetlb_cgroup *h_cg, int idx,
    bool rsvd) {
  if (rsvd) {
...
static inline struct page_counter *hugetlb_cgroup_counter_from_cgroup_rsvd(
    struct hugetlb_cgroup *h_cg, int idx) {
...
static inline struct hugetlb_cgroup *parent_hugetlb_cgroup(
...
static struct cgroup_subsys_state *hugetlb_cgroup_css_alloc(
