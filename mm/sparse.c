...
static struct mem_section_usage *__init sparse_early_usemaps_alloc_pgdat_section(
...
static int clear_subsection_map(unsigned long pfn, unsigned long nr_pages) {
  DECLARE_BITMAP(map, SUBSECTIONS_PER_SECTION) = {
    0
  };
  DECLARE_BITMAP(tmp, SUBSECTIONS_PER_SECTION) = {
    0
  };
