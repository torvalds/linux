...
static struct damon_sysfs_scheme_regions *damon_sysfs_scheme_regions_alloc(void)
{
...
static struct damon_sysfs_scheme_filters *damon_sysfs_scheme_filters_alloc(void)
{
