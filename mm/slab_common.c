...
#ifdef CONFIG_PRINTK
static void kmem_obj_info(struct kmem_obj_info *kpp, void *object,
    struct slab *slab) {
...
#define KMA_RAND_3(sz)  KMA_RAND_2(sz).name[KMALLOC_RANDOM_START \
      + 3] = "kmalloc-rnd-03-" #sz,
#define KMA_RAND_4(sz)  KMA_RAND_3(sz).name[KMALLOC_RANDOM_START \
      + 4] = "kmalloc-rnd-04-" #sz,
#define KMA_RAND_5(sz)  KMA_RAND_4(sz).name[KMALLOC_RANDOM_START \
      + 5] = "kmalloc-rnd-05-" #sz,
#define KMA_RAND_6(sz)  KMA_RAND_5(sz).name[KMALLOC_RANDOM_START \
      + 6] = "kmalloc-rnd-06-" #sz,
#define KMA_RAND_7(sz)  KMA_RAND_6(sz).name[KMALLOC_RANDOM_START \
      + 7] = "kmalloc-rnd-07-" #sz,
#define KMA_RAND_8(sz)  KMA_RAND_7(sz).name[KMALLOC_RANDOM_START \
      + 8] = "kmalloc-rnd-08-" #sz,
#define KMA_RAND_9(sz)  KMA_RAND_8(sz).name[KMALLOC_RANDOM_START \
      + 9] = "kmalloc-rnd-09-" #sz,
#define KMA_RAND_10(sz) KMA_RAND_9(sz).name[KMALLOC_RANDOM_START \
      + 10] = "kmalloc-rnd-10-" #sz,
#define KMA_RAND_11(sz) KMA_RAND_10(sz).name[KMALLOC_RANDOM_START \
      + 11] = "kmalloc-rnd-11-" #sz,
#define KMA_RAND_12(sz) KMA_RAND_11(sz).name[KMALLOC_RANDOM_START \
      + 12] = "kmalloc-rnd-12-" #sz,
#define KMA_RAND_13(sz) KMA_RAND_12(sz).name[KMALLOC_RANDOM_START \
      + 13] = "kmalloc-rnd-13-" #sz,
#define KMA_RAND_14(sz) KMA_RAND_13(sz).name[KMALLOC_RANDOM_START \
      + 14] = "kmalloc-rnd-14-" #sz,
#define KMA_RAND_15(sz) KMA_RAND_14(sz).name[KMALLOC_RANDOM_START \
      + 15] = "kmalloc-rnd-15-" #sz,
