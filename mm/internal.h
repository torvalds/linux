...
struct compact_control {
  struct list_head freepages[NR_PAGE_ORDERS]; /* List of free pages to migrate
                                               * to */
 ...
 */
static inline bool folio_within_range(struct folio *folio,
    struct vm_area_struct *vma,
    unsigned long start, unsigned long end) {
  pgoff_t pgoff, addr;
...
static inline bool folio_within_vma(struct folio *folio,
    struct vm_area_struct *vma) {
...
static inline void vunmap_range_noflush(unsigned long start,
    unsigned long end) {
}
...
#define ALLOC_KSWAPD    0x800 /* allow waking of kswapd, __GFP_KSWAPD_RECLAIM
                               * set */
