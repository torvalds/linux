...
static bool vsock_msg_wait_data(struct sock *sk, struct sk_psock *psock,
    long timeo) {
  bool ret;
...
static int __vsock_recvmsg(struct sock *sk, struct msghdr *msg, size_t len,
    int flags) {
...
static void vsock_bpf_rebuild_protos(struct proto *prot,
...
int vsock_bpf_update_proto(struct sock *sk, struct sk_psock *psock,
    bool restore) {
