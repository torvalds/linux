...
struct vmci_transport_recv_yestify_data {
	u64 consume_head;
	u64 produce_tail;
	bool yestify_on_block;
};

struct vmci_transport_send_yestify_data {
	u64 consume_head;
	u64 produce_tail;
};

/* Socket yestification callbacks. */
struct vmci_transport_yestify_ops {
	...
	void (*handle_yestify_pkt) (struct sock *sk,
...
extern const struct vmci_transport_yestify_ops vmci_transport_yestify_pkt_ops;
extern const
struct vmci_transport_yestify_ops vmci_transport_yestify_pkt_q_state_ops;
