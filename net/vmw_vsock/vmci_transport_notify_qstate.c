...
static void vmci_transport_handle_read(struct sock *sk,
...
static void vmci_transport_handle_wrote(struct sock *sk,
    struct vmci_transport_packet *pkt,
    bool bottom_half,
    struct sockaddr_vm *dst, struct sockaddr_vm *src) {
  vsock_data_ready(sk);
...
static int vmci_transport_notify_pkt_poll_in(struct sock *sk,
...
static int vmci_transport_notify_pkt_poll_out(struct sock *sk,
...
static int vmci_transport_notify_pkt_recv_init(
    struct sock *sk,
    size_t target,
...
static int vmci_transport_notify_pkt_recv_pre_block(
    struct sock *sk,
    size_t target,
    struct vmci_transport_recv_notify_data *data) {
  int err = 0;
...
static int vmci_transport_notify_pkt_recv_post_dequeue(
    struct sock *sk,
    size_t target,
    ssize_t copied,
    bool data_read,
...
static int vmci_transport_notify_pkt_send_init(
    struct sock *sk,
...
static int vmci_transport_notify_pkt_send_post_enqueue(
    struct sock *sk,
    ssize_t written,
    struct vmci_transport_send_notify_data *data) {
  int err = 0;
...
static void vmci_transport_notify_pkt_handle_pkt(
    struct sock *sk,
    struct vmci_transport_packet *pkt,
    bool bottom_half,
...
static int vmci_transport_notify_pkt_recv_pre_dequeue(
    struct sock *sk,
    size_t target,
    struct vmci_transport_recv_notify_data *data) {
...
static int vmci_transport_notify_pkt_send_pre_block(
    struct sock *sk,
    struct vmci_transport_send_notify_data *data) {
  return 0; /* NOP for QState. */
}

static int vmci_transport_notify_pkt_send_pre_enqueue(
    struct sock *sk,
    struct vmci_transport_send_notify_data *data) {
  return 0; /* NOP for QState. */
}
