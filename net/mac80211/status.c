...
static void ieee80211_check_pending_bar(struct sta_info *sta, u8 *addr,
    u8 tid) {
...
static struct ieee80211_sub_if_data *ieee80211_sdata_from_skb(
...
static void ieee80211_lost_packet(struct sta_info *sta,
  ...
  if (sta->deflink.status_stats.lost_packets < pkt_thr
      || !time_after(jiffies,
      sta->deflink.status_stats.last_pkt_time + pkt_time)) {
    return;
  }
