...
struct mesh_path *mesh_path_lookup_by_idx(struct ieee80211_sub_if_data *sdata,
    int idx);
struct mesh_path *mpp_path_lookup_by_idx(struct ieee80211_sub_if_data *sdata,
    int idx);
...
struct ieee80211_mesh_fast_tx *mesh_fast_tx_get(
