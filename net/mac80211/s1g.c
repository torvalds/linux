...
static void ieee80211_s1g_send_twt_setup(struct ieee80211_sub_if_data *sdata,
    const u8 *da,
...
static void ieee80211_s1g_send_twt_teardown(struct ieee80211_sub_if_data *sdata,
...
static void ieee80211_s1g_rx_twt_setup(struct ieee80211_sub_if_data *sdata,
...
static void ieee80211_s1g_rx_twt_teardown(struct ieee80211_sub_if_data *sdata,
    struct sta_info *sta, struct sk_buff *skb) {
  struct ieee80211_mgmt *mgmt = (struct ieee80211_mgmt *) skb->data;
...
static void ieee80211_s1g_tx_twt_setup_fail(struct ieee80211_sub_if_data *sdata,
    struct sta_info *sta, struct sk_buff *skb) {
  struct ieee80211_mgmt *mgmt = (struct ieee80211_mgmt *) skb->data;
  struct ieee80211_twt_setup *twt = (void *) mgmt->u.action.u.s1g.variable;
  struct ieee80211_twt_params *twt_agrt = (void *) twt->params;
