...
static struct sta_info *__mesh_sta_info_alloc(
...
static struct sta_info *mesh_sta_info_alloc(struct ieee80211_sub_if_data *sdata,
    u8 *addr,
    struct ieee802_11_elems *elems,
 ...
 */
static struct sta_info *mesh_sta_info_get(struct ieee80211_sub_if_data *sdata,
 ...
 * an error.
 */
static enum plink_event mesh_plink_get_event(
    struct ieee80211_sub_if_data *sdata,
    struct sta_info *sta,
    struct ieee802_11_elems *elems,
...
static void mesh_process_plink_frame(struct ieee80211_sub_if_data *sdata,
    struct ieee80211_mgmt *mgmt,
    struct ieee802_11_elems *elems,
    struct ieee80211_rx_status *rx_status) {
  struct sta_info *sta;
