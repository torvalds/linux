...
static struct ieee80211_chanctx *ieee80211_link_get_chanctx(
    struct ieee80211_link_data *link) {
...
static const struct ieee80211_chan_req *ieee80211_chanreq_compatible(
    const struct ieee80211_chan_req *a,
    const struct ieee80211_chan_req *b,
...
static const struct ieee80211_chan_req *ieee80211_chanctx_compatible(
    struct ieee80211_chanctx *ctx,
...
static const struct ieee80211_chan_req *ieee80211_chanctx_reserved_chanreq(
...
static const struct ieee80211_chan_req *ieee80211_chanctx_non_reserved_chandef(
    struct ieee80211_local *local,
    struct ieee80211_chanctx *ctx,
...
static bool ieee80211_chanctx_can_reserve(struct ieee80211_local *local,
    struct ieee80211_chanctx *ctx,
    const struct ieee80211_chan_req *req) {
  struct ieee80211_chan_req tmp;
  lockdep_assert_wiphy(local->hw.wiphy);
...
static struct ieee80211_chanctx *ieee80211_find_reservation_chanctx(
    struct ieee80211_local *local,
...
static enum nl80211_chan_width ieee80211_get_max_required_bw(
    struct ieee80211_link_data *link) {
...
static enum nl80211_chan_width ieee80211_get_chanctx_max_required_bw(
    struct ieee80211_local *local,
    struct ieee80211_chanctx *ctx,
...
static void _ieee80211_change_chanctx(struct ieee80211_local *local,
  ...
  /* Check maybe BW narrowed - we do this _before_ calling
   * recalc_chanctx_min_def
...
static struct ieee80211_chanctx *ieee80211_find_chanctx(
    struct ieee80211_local *local,
    const struct ieee80211_chan_req *chanreq,
    enum ieee80211_chanctx_mode mode) {
  struct ieee80211_chan_req tmp;
...
static bool ieee80211_chanctx_radar_required(struct ieee80211_local *local,
    struct ieee80211_chanctx *ctx) {
...
static struct ieee80211_chanctx *ieee80211_alloc_chanctx(
    struct ieee80211_local *local,
    const struct ieee80211_chan_req *chanreq,
    enum ieee80211_chanctx_mode mode) {
  struct ieee80211_chanctx *ctx;
...
static struct ieee80211_chanctx *ieee80211_new_chanctx(
    struct ieee80211_local *local,
    const struct ieee80211_chan_req *chanreq,
    enum ieee80211_chanctx_mode mode) {
  struct ieee80211_chanctx *ctx;
...
static void __ieee80211_link_copy_chanctx_to_vlans(
    struct ieee80211_link_data *link,
    bool clear) {
  struct ieee80211_sub_if_data *sdata = link->sdata;
  unsigned int link_id = link->link_id;
...
static void ieee80211_link_chanctx_reservation_complete(
    struct ieee80211_link_data *link) {
  struct ieee80211_sub_if_data *sdata = link->sdata;
...
static void ieee80211_link_update_chanreq(struct ieee80211_link_data *link,
    const struct ieee80211_chan_req *chanreq) {
  struct ieee80211_sub_if_data *sdata = link->sdata;
  unsigned int link_id = link->link_id;
  struct ieee80211_sub_if_data *vlan;
...
static int ieee80211_link_use_reserved_reassign(
    struct ieee80211_link_data *link) {
  struct ieee80211_sub_if_data *sdata = link->sdata;
  struct ieee80211_bss_conf *link_conf = link->conf;
  struct ieee80211_local *local = sdata->local;
...
static int ieee80211_link_use_reserved_assign(struct ieee80211_link_data *link)
{
  struct ieee80211_sub_if_data *sdata = link->sdata;
  struct ieee80211_local *local = sdata->local;
  struct ieee80211_chanctx *old_ctx, *new_ctx;
...
static bool ieee80211_link_has_in_place_reservation(
    struct ieee80211_link_data *link) {
  struct ieee80211_sub_if_data *sdata = link->sdata;
  struct ieee80211_chanctx *old_ctx, *new_ctx;
  lockdep_assert_wiphy(sdata->local->hw.wiphy);
...
static void __ieee80211_link_release_channel(struct ieee80211_link_data *link) {
  ...
  if (link->reserved_chanctx) {
    if (link->reserved_chanctx->replace_state
        == IEEE80211_CHANCTX_REPLACES_OTHER
 ...
 */
static const struct ieee80211_chan_req *ieee80211_chanctx_recheck(
    struct ieee80211_local *local,
