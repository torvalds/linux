...
static inline bool ieee80211_sta_keep_active(struct sta_info *sta, u8 ac) {
...
/**
 * struct ieee80211_mesh_sync_ops - Extensible synchronization framework
 * interface
 *
 ...
 *
 * @rht: hash table containing struct ieee80211_mesh_fast_tx, using skb DA as
 * key
...
static inline int ieee80211_get_mbssid_beacon_len(
...
static inline struct ieee80211_sub_if_data *IEEE80211_DEV_TO_SUB_IF(
    const struct net_device *dev) {
  return netdev_priv(dev);
}

static inline struct ieee80211_sub_if_data *IEEE80211_WDEV_TO_SUB_IF(
    struct wireless_dev *wdev) {
  return container_of(wdev, struct ieee80211_sub_if_data, wdev);
}

static inline struct ieee80211_supported_band *ieee80211_get_sband(
    struct ieee80211_sub_if_data *sdata) {
...
static inline struct ieee80211_supported_band *ieee80211_get_link_sband(
    struct ieee80211_link_data *link) {
...
static inline bool ieee80211_have_rx_timestamp(
 ...
 */
static inline int ieee80211_vif_get_num_mcast_if(
    struct ieee80211_sub_if_data *sdata) {
...
static inline void ieee80211_vif_clear_links(
    struct ieee80211_sub_if_data *sdata) {
...
void ieee80211_purge_tx_queue(struct ieee80211_hw *hw,
    struct sk_buff_head *skbs);
struct sk_buff *ieee80211_build_data_template(
  struct ieee80211_sub_if_data *sdata,
...
static inline void ieee80211_tx_skb_tid_band(
    struct ieee80211_sub_if_data *sdata,
...
static inline struct ieee802_11_elems *ieee802_11_parse_elems_crc(
    const u8 *start, size_t len, bool action,
    u64 filter, u32 crc,
    struct cfg80211_bss *bss) {
  struct ieee80211_elems_parse_params params = {
...
static inline struct ieee802_11_elems *ieee802_11_parse_elems(const u8 *start,
    size_t len,
    bool action,
    struct cfg80211_bss *bss) {
...
void ieee80211_chandef_downgrade(struct cfg80211_chan_def *chandef,
    struct ieee80211_conn_settings *conn);
static inline void ieee80211_chanreq_downgrade(
    struct ieee80211_chan_req *chanreq,
    struct ieee80211_conn_settings *conn) {
...
int __must_check ieee80211_link_use_channel(struct ieee80211_link_data *link,
    const struct ieee80211_chan_req *req,
    enum ieee80211_chanctx_mode mode);
int __must_check ieee80211_link_reserve_chanctx(
  struct ieee80211_link_data *link,
  const struct ieee80211_chan_req *req,
  enum ieee80211_chanctx_mode mode,
  bool radar_required);
int __must_check ieee80211_link_use_reserved_context(
  struct ieee80211_link_data *link);
int ieee80211_link_unreserve_chanctx(struct ieee80211_link_data *link);

int __must_check ieee80211_link_change_chanreq(struct ieee80211_link_data *link,
    const struct ieee80211_chan_req *req,
    u64 *changed);
...
ieee80211_rx_result ieee80211_drop_unencrypted_mgmt(
