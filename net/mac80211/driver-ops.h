...
static inline struct ieee80211_sub_if_data *get_bss_sdata(
...
static inline void drv_release_buffered_frames(struct ieee80211_local *local,
...
static inline void drv_allow_buffered_frames(struct ieee80211_local *local,
    struct sta_info *sta, u16 tids, int num_frames,
    enum ieee80211_frame_release_type reason,
    bool more_data) {
...
static inline void drv_mgd_protect_tdls_discover(struct ieee80211_local *local,
    struct ieee80211_sub_if_data *sdata,
    int link_id) {
  might_sleep();
  lockdep_assert_wiphy(local->hw.wiphy);
...
static inline void drv_reconfig_complete(struct ieee80211_local *local,
...
static inline void drv_set_default_unicast_key(struct ieee80211_local *local,
    struct ieee80211_sub_if_data *sdata,
    int key_idx) {
  might_sleep();
  lockdep_assert_wiphy(local->hw.wiphy);
...
static inline void drv_channel_switch_beacon(
    struct ieee80211_sub_if_data *sdata,
...
static inline int drv_pre_channel_switch(struct ieee80211_sub_if_data *sdata,
    struct ieee80211_channel_switch *ch_switch) {
  struct ieee80211_local *local = sdata->local;
  int ret = 0;
  might_sleep();
...
static inline int drv_post_channel_switch(struct ieee80211_link_data *link) {
...
static inline void drv_abort_channel_switch(struct ieee80211_link_data *link) {
  struct ieee80211_sub_if_data *sdata = link->sdata;
  struct ieee80211_local *local = sdata->local;
  might_sleep();
  lockdep_assert_wiphy(local->hw.wiphy);
...
static inline void drv_channel_switch_rx_beacon(
    struct ieee80211_sub_if_data *sdata,
    struct ieee80211_channel_switch *ch_switch) {
  struct ieee80211_local *local = sdata->local;
  might_sleep();
...
static inline int drv_tdls_channel_switch(struct ieee80211_local *local,
    struct ieee80211_sub_if_data *sdata,
...
static inline void drv_tdls_cancel_channel_switch(struct ieee80211_local *local,
    struct ieee80211_sub_if_data *sdata,
    struct ieee80211_sta *sta) {
  might_sleep();
  lockdep_assert_wiphy(local->hw.wiphy);
...
static inline void drv_tdls_recv_channel_switch(struct ieee80211_local *local,
    struct ieee80211_sub_if_data *sdata,
...
static inline int drv_get_ftm_responder_stats(struct ieee80211_local *local,
    struct ieee80211_sub_if_data *sdata,
...
static inline enum ieee80211_neg_ttlm_res drv_can_neg_ttlm(
