...
static struct ieee80211_link_data *ieee80211_link_or_deflink(
    struct ieee80211_sub_if_data *sdata, int link_id,
    bool require_valid) {
...
static struct cfg80211_nan_func *ieee80211_find_nan_func_by_cookie(
    struct ieee80211_sub_if_data *sdata,
    u64 cookie) {
...
static struct ieee80211_key *ieee80211_lookup_key(
    struct ieee80211_sub_if_data *sdata, int link_id,
...
static int ieee80211_set_unsol_bcast_probe_resp(
    struct ieee80211_sub_if_data *sdata,
...
static int ieee80211_copy_mbssid_beacon(u8 *pos,
    struct cfg80211_mbssid_elems *dst,
...
static int ieee80211_copy_rnr_beacon(u8 *pos, struct cfg80211_rnr_elems *dst,
...
static void ieee80211_abort_scan(struct wiphy *wiphy,
    struct wireless_dev *wdev) {
...
static struct cfg80211_beacon_data *cfg80211_beacon_dup(
...
static int __ieee80211_channel_switch(struct wiphy *wiphy,
    struct net_device *dev,
    struct cfg80211_csa_settings *params) {
  struct ieee80211_sub_if_data *sdata = IEEE80211_DEV_TO_SUB_IF(dev);
  struct ieee80211_chan_req chanreq = {
...
static int ieee80211_get_antenna(struct wiphy *wiphy, u32 *tx_ant,
    u32 *rx_ant) {
  struct ieee80211_local *local = wiphy_priv(wiphy);
...
static int ieee80211_start_pmsr(struct wiphy *wiphy, struct wireless_dev *dev,
...
static void ieee80211_abort_pmsr(struct wiphy *wiphy, struct wireless_dev *dev,
    struct cfg80211_pmsr_request *request) {
  struct ieee80211_local *local = wiphy_priv(wiphy);
  struct ieee80211_sub_if_data *sdata = IEEE80211_WDEV_TO_SUB_IF(dev);
...
static int ieee80211_set_after_color_change_beacon(
    struct ieee80211_sub_if_data *sdata,
    u64 *changed) {
  switch (sdata->vif.type) {
    case NL80211_IFTYPE_AP:
...
static int ieee80211_set_color_change_beacon(
    struct ieee80211_sub_if_data *sdata,
...
static void ieee80211_color_change_bss_config_notify(
    struct ieee80211_sub_if_data *sdata,
...
static int ieee80211_set_radar_background(struct wiphy *wiphy,
    struct cfg80211_chan_def *chandef) {
  struct ieee80211_local *local = wiphy_priv(wiphy);
...
static int ieee80211_add_link_station(struct wiphy *wiphy,
    struct net_device *dev,
    struct link_station_parameters *params) {
  struct ieee80211_sub_if_data *sdata = IEEE80211_DEV_TO_SUB_IF(dev);
  struct ieee80211_local *local = wiphy_priv(wiphy);
...
static int ieee80211_mod_link_station(struct wiphy *wiphy,
    struct net_device *dev,
    struct link_station_parameters *params) {
  struct ieee80211_sub_if_data *sdata = IEEE80211_DEV_TO_SUB_IF(dev);
  struct ieee80211_local *local = wiphy_priv(wiphy);
...
static int ieee80211_del_link_station(struct wiphy *wiphy,
    struct net_device *dev,
    struct link_station_del_parameters *params) {
  struct ieee80211_sub_if_data *sdata = IEEE80211_DEV_TO_SUB_IF(dev);
  lockdep_assert_wiphy(sdata->local->hw.wiphy);
...
static int ieee80211_set_ttlm(struct wiphy *wiphy, struct net_device *dev,
