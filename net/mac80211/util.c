...
static void __releases( &local->queue_stop_reason_lock)
...
static unsigned int ieee80211_get_vif_queues(struct ieee80211_local *local,
    struct ieee80211_sub_if_data *sdata) {
  unsigned int queues;
...
static void ieee80211_get_adjusted_he_cap(
...
static bool ieee80211_extend_noa_desc(struct ieee80211_noa_data *data, u32 tsf,
    int i) {
...
static bool ieee80211_extend_absent_time(struct ieee80211_noa_data *data,
    u32 tsf,
    s32 *offset) {
  bool ret = false;
  int i;
...
static u32 ieee80211_get_noa_absent_time(struct ieee80211_noa_data *data,
    u32 tsf) {
  s32 offset = 0;
  int tries = 0;
  /*
...
static void ieee80211_iter_max_chans(
...
u16 ieee80211_encode_usf(int listen_interval) {
  static const int listen_int_usf[] = {
    1, 10, 1000, 10000
  };
  u16 ui, usf = 0;
  /* find greatest USF */
...
enum ieee80211_conn_bw_limit ieee80211_min_bw_limit_from_chandef(
    struct cfg80211_chan_def *chandef) {
  switch (chandef->width) {
    case NL80211_CHAN_WIDTH_20_NOHT:
    case NL80211_CHAN_WIDTH_20:
