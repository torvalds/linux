...
static struct sta_info *__sta_info_alloc(struct ieee80211_sub_if_data *sdata,
...
static void ieee80211_recalc_p2p_go_ps_allowed(
    struct ieee80211_sub_if_data *sdata) {
  struct ieee80211_local *local = sdata->local;
 ...
 */
static bool ieee80211_sta_ps_more_data(struct sta_info *sta, u8 ignored_acs,
    enum ieee80211_frame_release_type reason,
...
static void ieee80211_sta_ps_get_frames(struct sta_info *sta, int n_frames,
    u8 ignored_acs,
    enum ieee80211_frame_release_type reason,
...
static void ieee80211_sta_ps_deliver_response(struct sta_info *sta,
  ...
  more_data = ieee80211_sta_ps_more_data(sta, ignored_acs, reason,
      driver_release_tids);
...
static struct ieee80211_sta_rx_stats *sta_get_last_rx_stats(
    struct sta_info *sta) {
