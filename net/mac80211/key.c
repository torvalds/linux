...
static void update_vlan_tailroom_need_count(struct ieee80211_sub_if_data *sdata,
    int delta) {
...
static void ieee80211_pairwise_rekey(struct ieee80211_key *old,
  ...
  if (new->conf.flags & IEEE80211_KEY_FLAG_NO_AUTO_TX) {
    ...
    if (!wiphy_ext_feature_isset(local->hw.wiphy,
      ...
      pr_warn_ratelimited(
          "Rekeying PTK for STA %pM but driver can't safely do that.",
          sta->sta.addr);
...
static void __ieee80211_set_default_mgmt_key(struct ieee80211_link_data *link,
    int idx) {
  struct ieee80211_sub_if_data *sdata = link->sdata;
  struct ieee80211_key *key = NULL;
  lockdep_assert_wiphy(sdata->local->hw.wiphy);
...
static void __ieee80211_set_default_beacon_key(struct ieee80211_link_data *link,
    int idx) {
  struct ieee80211_sub_if_data *sdata = link->sdata;
  struct ieee80211_key *key = NULL;
  lockdep_assert_wiphy(sdata->local->hw.wiphy);
...
static void _ieee80211_iter_keys_rcu(struct ieee80211_hw *hw,
    struct ieee80211_sub_if_data *sdata,
    void (*iter)(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
    struct ieee80211_sta *sta,
...
struct ieee80211_key_conf *ieee80211_gtk_rekey_add(struct ieee80211_vif *vif,
