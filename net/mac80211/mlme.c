...
static enum ieee80211_conn_mode ieee80211_determine_ap_chan(
...
static bool ieee80211_verify_peer_he_mcs_support(
    struct ieee80211_sub_if_data *sdata,
...
static u8 ieee80211_get_eht_cap_mcs_nss(
    const struct ieee80211_sta_he_cap *sta_he_cap,
...
static bool ieee80211_verify_sta_eht_mcs_support(
    struct ieee80211_sub_if_data *sdata,
    struct ieee80211_supported_band *sband,
...
static struct ieee802_11_elems *ieee80211_determine_chan_mode(
    struct ieee80211_sub_if_data *sdata,
...
static void ieee80211_sta_abort_chanswitch(struct ieee80211_link_data *link) {
  struct ieee80211_sub_if_data *sdata = link->sdata;
  struct ieee80211_local *local = sdata->local;
  lockdep_assert_wiphy(local->hw.wiphy);
...
static void ieee80211_sta_process_chanswitch(struct ieee80211_link_data *link,
...
void ieee80211_dfs_cac_timer_work(struct wiphy *wiphy,
    struct wiphy_work *work) {
  struct ieee80211_link_data *link
    = container_of(work, struct ieee80211_link_data,
...
static bool __ieee80211_sta_handle_tspec_ac_params(
    struct ieee80211_sub_if_data *sdata) {
  struct ieee80211_local *local = sdata->local;
  struct ieee80211_if_managed *ifmgd = &sdata->u.mgd;
  bool ret = false;
...
static void ieee80211_determine_our_sta_mode(
    struct ieee80211_sub_if_data *sdata,
    struct ieee80211_supported_band *sband,
...
static void ieee80211_determine_our_sta_mode_auth(
    struct ieee80211_sub_if_data *sdata,
    struct ieee80211_supported_band *sband,
...
static void ieee80211_determine_our_sta_mode_assoc(
    struct ieee80211_sub_if_data *sdata,
    struct ieee80211_supported_band *sband,
    struct cfg80211_assoc_request *req,
    bool wmm_used, int link_id,
...
static int ieee80211_parse_adv_t2l(struct ieee80211_sub_if_data *sdata,
...
static void ieee80211_neg_ttlm_add_suggested_map(struct sk_buff *skb,
    struct ieee80211_neg_ttlm *neg_ttlm) {
...
static void ieee80211_send_neg_ttlm_req(struct ieee80211_sub_if_data *sdata,
    struct ieee80211_neg_ttlm *neg_ttlm,
    u8 dialog_token) {
  struct ieee80211_local *local = sdata->local;
  struct ieee80211_mgmt *mgmt;
...
static void ieee80211_send_neg_ttlm_res(struct ieee80211_sub_if_data *sdata,
...
static int ieee80211_parse_neg_ttlm(struct ieee80211_sub_if_data *sdata,
    const struct ieee80211_ttlm_elem *ttlm,
    struct ieee80211_neg_ttlm *neg_ttlm,
    u8 *direction) {
  u8 control, link_map_presence, map_size, tid;
...
static void ieee80211_setup_assoc_link(struct ieee80211_sub_if_data *sdata,
    struct ieee80211_mgd_assoc_data *assoc_data,
    struct cfg80211_assoc_request *req,
    struct ieee80211_conn_settings *conn,
    unsigned int link_id) {
...
static int ieee80211_mgd_get_ap_ht_vht_capa(struct ieee80211_sub_if_data *sdata,
    struct ieee80211_mgd_assoc_data *assoc_data,
    int link_id) {
  struct cfg80211_bss *cbss = assoc_data->link[link_id].bss;
