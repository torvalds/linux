...
static u8 ieee80211_tdls_add_subband(struct ieee80211_sub_if_data *sdata,
...
static void ieee80211_tdls_add_supp_channels(
    struct ieee80211_sub_if_data *sdata,
    struct sk_buff *skb) {
  /*
...
static void ieee80211_tdls_add_aid(struct ieee80211_sub_if_data *sdata,
    struct sk_buff *skb) {
...
static void ieee80211_tdls_chandef_vht_upgrade(
    struct ieee80211_sub_if_data *sdata,
    struct sta_info *sta) {
  /* IEEE802.11ac-2013 Table E-4 */
  static const u16 centers_80mhz[] = {
...
static void ieee80211_tdls_add_setup_start_ies(struct ieee80211_link_data *link,
    struct sk_buff *skb, const u8 *peer,
...
static void ieee80211_tdls_add_setup_cfm_ies(struct ieee80211_link_data *link,
    struct sk_buff *skb, const u8 *peer,
   ...
   */
  if (!ap_sta->sta.deflink.ht_cap.ht_supported
...
static void ieee80211_tdls_add_chan_switch_resp_ies(
    struct ieee80211_link_data *link,
    struct sk_buff *skb, const u8 *peer,
...
static struct sk_buff *ieee80211_tdls_build_mgmt_packet_data(
    struct ieee80211_sub_if_data *sdata,
...
static int ieee80211_tdls_prep_mgmt_packet(struct wiphy *wiphy,
    struct net_device *dev,
    const u8 *peer, int link_id,
    u8 action_code, u8 dialog_token,
...
static int ieee80211_tdls_mgmt_setup(struct wiphy *wiphy,
    struct net_device *dev,
    const u8 *peer, int link_id,
    u8 action_code, u8 dialog_token,
...
static int ieee80211_tdls_mgmt_teardown(struct wiphy *wiphy,
    struct net_device *dev,
    const u8 *peer, int link_id,
    u8 action_code, u8 dialog_token,
    u16 status_code, u32 peer_capability,
...
static void iee80211_tdls_recalc_ht_protection(
    struct ieee80211_sub_if_data *sdata,
    struct sta_info *sta) {
  bool tdls_ht;
...
static void iee80211_tdls_add_ch_switch_timing(u8 *buf, u16 switch_time,
    u16 switch_timeout) {
...
static struct sk_buff *ieee80211_tdls_ch_sw_tmpl_get(struct sta_info *sta,
    u8 oper_class,
    struct cfg80211_chan_def *chandef,
...
static struct sk_buff *ieee80211_tdls_ch_sw_resp_tmpl_get(struct sta_info *sta,
    u32 *ch_sw_tm_ie_offset) {
  struct ieee80211_sub_if_data *sdata = sta->sdata;
  struct sk_buff *skb;
...
static int ieee80211_process_tdls_channel_switch_resp(
    struct ieee80211_sub_if_data *sdata,
    struct sk_buff *skb) {
  struct ieee80211_local *local = sdata->local;
