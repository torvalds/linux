...
static void rxperf_rx_attach(struct rxrpc_call *rxcall,
    unsigned long user_call_ID) {
...
static void rxperf_log_error(struct rxperf_call *call, s32 remote_abort) {
  ...
  switch (remote_abort) {
    ...
    case RXGEN_CC_MARSHAL:
      msg = "client marshalling";
      break;
    case RXGEN_CC_UNMARSHAL:
      msg = "client unmarshalling";
      break;
    case RXGEN_SS_MARSHAL:
      msg = "server marshalling";
      break;
    case RXGEN_SS_UNMARSHAL:
      msg = "server unmarshalling";
      break;
    case RXGEN_DECODE:
      msg = "opcode decode";
      break;
    case RXGEN_SS_XDRFREE:
      msg = "server XDR cleanup";
      break;
    case RXGEN_CC_XDRFREE:
      msg = "client XDR cleanup";
      break;
    case -32:
