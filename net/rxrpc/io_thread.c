...
static bool rxrpc_bad_message(struct sk_buff *skb,
 ...
 */
static bool rxrpc_input_version(struct rxrpc_local *local,
    struct sk_buff *skb) {
  struct rxrpc_skb_priv *sp = rxrpc_skb(skb);
  char v;
  _enter("");
 ...
 */
static bool rxrpc_input_packet(struct rxrpc_local *local,
    struct sk_buff **_skb) {
