...
#define RXRPC_PACKET_TYPE_CHALLENGE 6 /* connection security challenge
                                       * (SRVR->CLNT) */
...
#define RXRPC_REQUEST_ACK 0x02    /* request an unconditional ACK of this packet
                                   * */
#define RXRPC_LAST_PACKET 0x04    /* the last packet from this side for this
                                   * call */
...
#define RXRPC_USERSTATUS_SERVICE_UPGRADE 0x01 /* AuriStor service upgrade
                                               * request */
...
#define RXRPC_JUMBO_SUBPKTLEN (RXRPC_JUMBO_DATALEN \
