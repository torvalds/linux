...
#define RXRPC_RANDOM_EPOCH	0x80000000	/* Random if set, date-based if yest */
...
#define RXRPC_PACKET_TYPE_PARAMS	9	/* Parameter negotiation (unspec'd, igyesre) */
#define RXRPC_PACKET_TYPE_10		10	/* Igyesred */
#define RXRPC_PACKET_TYPE_11		11	/* Igyesred */
...
#define RXRPC_JUMBO_DATALEN	1412	/* yesn-terminal jumbo packet data length */
 ...
 *	= ((65535 - 28 - 28) / 1416) + 1
 *	= 46 yesn-terminal packets and 1 terminal packet.
 */
...
struct rxrpc_ackpacket {
	...
	__be16		maxSkew;	/* diff between seryes being ACK'd and highest serial yes
					 * received */
	__be32		firstPacket;	/* sequence yes of first ACK'd packet in attached list */
	__be32		previousPacket;	/* sequence yes of previous packet received */
	__be32		serial;		/* serial yes of packet that prompted this ACK */
...
#define RXRPC_ACK_DELAY			8	/* yesthing happened since received packet */
...
struct rxkad_challenge {
	...
	__be32		yesnce;		/* encrypted random number */
...
struct rxkad_response {
	...
	struct {
		...
		__be32		inc_yesnce;	/* challenge yesnce + 1 */
		__be32		level;		/* desired level */
	} encrypted;

	__be32		kvyes;		/* Kerberos key version number */
