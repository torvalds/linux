 ...
 */
static void rxrpc_begin_rtt_probe(struct rxrpc_call *call,
    rxrpc_serial_t serial,
 ...
 */
static void rxrpc_send_ack_packet(struct rxrpc_call *call,
    struct rxrpc_txbuf *txb) {
  struct rxrpc_wire_header *whdr = txb->kvec[0].iov_base;
 ...
 */
static void rxrpc_prepare_data_subpacket(struct rxrpc_call *call,
    struct rxrpc_txbuf *txb,
    rxrpc_serial_t serial) {
  struct rxrpc_wire_header *whdr = txb->kvec[0].iov_base;
 ...
 */
static void rxrpc_tstamp_data_packets(struct rxrpc_call *call,
    struct rxrpc_txbuf *txb) {
 ...
 */
static int rxrpc_send_data_packet(struct rxrpc_call *call,
    struct rxrpc_txbuf *txb) {
  struct rxrpc_wire_header *whdr = txb->kvec[0].iov_base;
  struct rxrpc_connection *conn = call->conn;
