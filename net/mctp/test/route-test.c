...
static int mctp_test_route_output(struct mctp_route *rt, struct sk_buff *skb) {
  struct mctp_test_route *test_rt
    = container_of(rt, struct mctp_test_route, rt);
...
static void mctp_route_input_sk_to_desc(
    const struct mctp_route_input_sk_test *t,
    char *desc) {
...
#define RX_FRAG(f, s) RX_HDR(1, 10, 8, \
    FL_TO | (f) | ((s) << MCTP_HDR_SEQ_SHIFT))

static const struct mctp_route_input_sk_reasm_test
...
static void mctp_test_route_input_multiple_nets_bind_init(struct kunit *test,
    struct test_net *t) {
...
static void mctp_test_route_input_multiple_nets_bind_fini(struct kunit *test,
    struct test_net *t) {
...
static void mctp_test_route_input_multiple_nets_key_init(struct kunit *test,
    struct test_net *t) {
...
static void mctp_test_route_input_multiple_nets_key_fini(struct kunit *test,
    struct test_net *t) {
