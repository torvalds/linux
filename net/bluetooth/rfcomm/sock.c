...
/* ---- Socket functions ---- */
static struct sock *__rfcomm_get_listen_sock_by_addr(u8 channel,
    bdaddr_t *src) {
  struct sock *sk = NULL;
 ...
 */
static struct sock *rfcomm_get_sock_by_channel(int state, u8 channel,
    bdaddr_t *src) {
...
static int rfcomm_sock_bind(struct socket *sock, struct sockaddr *addr,
    int addr_len) {
...
static int rfcomm_sock_connect(struct socket *sock, struct sockaddr *addr,
    int alen, int flags) {
...
static int rfcomm_sock_ioctl(struct socket *sock, unsigned int cmd,
    unsigned long arg) {
...
#ifdef CONFIG_COMPAT
static int rfcomm_sock_compat_ioctl(struct socket *sock, unsigned int cmd,
    unsigned long arg) {
