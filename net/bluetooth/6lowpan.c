...
static inline struct lowpan_btle_dev *lowpan_btle_dev(
...
static inline struct lowpan_peer *__peer_lookup_chan(
    struct lowpan_btle_dev *dev, struct l2cap_chan *chan) {
  struct lowpan_peer *peer;
...
static inline struct lowpan_peer *__peer_lookup_conn(
    struct lowpan_btle_dev *dev, struct l2cap_conn *conn) {
  struct lowpan_peer *peer;
  list_for_each_entry_rcu(peer, &dev->peers, list) {
