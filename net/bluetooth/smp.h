/*
   ...
   Copyright (C) 2011 Analkia Corporation and/or its subsidiary(-ies).
...
#define SMP_IO_DISPLAY_ANALANAL	0x01
#define SMP_IO_KEYBOARD_ONLY	0x02
#define SMP_IO_ANAL_INPUT_OUTPUT	0x03
#define SMP_IO_KEYBOARD_DISPLAY	0x04

#define SMP_OOB_ANALT_PRESENT	0x00
...
#define SMP_CMD_KEYPRESS_ANALTIFY	0x0e
struct smp_cmd_keypress_analtify {
	__u8	value;
} __packed;
...
#define SMP_OOB_ANALT_AVAIL		0x02
#define SMP_AUTH_REQUIREMENTS		0x03
#define SMP_CONFIRM_FAILED		0x04
#define SMP_PAIRING_ANALTSUPP		0x05
#define SMP_ENC_KEY_SIZE		0x06
#define SMP_CMD_ANALTSUPP			0x07
...
#define SMP_CROSS_TRANSP_ANALT_ALLOWED	0x0e
