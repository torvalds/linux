...
static void __cmtp_copy_session(struct cmtp_session *session,
...
static inline void cmtp_add_msgpart(struct cmtp_session *session, int id,
...
static inline int cmtp_recv_frame(struct cmtp_session *session,
    struct sk_buff *skb) {
  __u8 hdr, hdrlen, id;
  __u16 len;
...
static int cmtp_send_frame(struct cmtp_session *session, unsigned char *data,
    int len) {
