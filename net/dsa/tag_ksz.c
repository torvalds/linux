...
static struct ksz_tagger_private *ksz_tagger_private(struct dsa_switch *ds) {
...
static struct sk_buff *ksz8795_rcv(struct sk_buff *skb,
    struct net_device *dev) {
...
static struct sk_buff *ksz_defer_xmit(struct dsa_port *dp,
    struct sk_buff *skb) {
...
static struct sk_buff *ksz9477_rcv(struct sk_buff *skb,
    struct net_device *dev) {
  /* Tag decoding */
  u8 *tag = skb_tail_pointer(skb) - KSZ_EGRESS_TAG_LEN;
