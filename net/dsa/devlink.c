...
static int dsa_devlink_sb_tc_pool_bind_get(struct devlink_port *dlp,
...
static int dsa_devlink_sb_tc_pool_bind_set(struct devlink_port *dlp,
    unsigned int sb_index, u16 tc_index,
    enum devlink_sb_pool_type pool_type,
...
static int dsa_devlink_sb_occ_tc_port_bind_get(struct devlink_port *dlp,
    unsigned int sb_index, u16 tc_index,
    enum devlink_sb_pool_type pool_type,
    u32 *p_cur, u32 *p_max) {
  struct dsa_switch *ds = dsa_devlink_port_to_ds(dlp);
...
struct devlink_region *dsa_devlink_region_create(struct dsa_switch *ds,
...
struct devlink_region *dsa_devlink_port_region_create(struct dsa_switch *ds,
    int port,
