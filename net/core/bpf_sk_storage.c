...
static struct bpf_local_storage_data *bpf_sk_storage_lookup(struct sock *sk,
    struct bpf_map *map,
    bool cacheit_lockit) {
...
static struct bpf_local_storage_elem *bpf_sk_storage_clone_elem(
    struct sock *newsk,
    struct bpf_local_storage_map *smap,
...
static struct bpf_local_storage __rcu **bpf_sk_storage_ptr(void *owner) {
  struct sock *sk = owner;
...
static struct bpf_local_storage_elem *bpf_sk_storage_map_seq_find_next(
