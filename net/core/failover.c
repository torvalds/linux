...
static struct net_device *failover_get_bymac(u8 *mac,
...
static int failover_event(struct notifier_block *this, unsigned long event,
    void *ptr) {
...
static void failover_existing_slave_register(struct net_device *failover_dev) {
...
static __init int failover_init(void) {
