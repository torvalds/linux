...
static int netdev_nl_page_pool_get_do(struct genl_info *info, u32 id,
    pp_nl_fill_cb fill) {
...
static int netdev_nl_page_pool_get_dump(struct sk_buff *skb,
...
static int page_pool_nl_stats_fill(struct sk_buff *rsp,
...
static int page_pool_nl_fill(struct sk_buff *rsp, const struct page_pool *pool,
    const struct genl_info *info) {
...
static int page_pool_netdevice_event(struct notifier_block *nb,
