...
static inline int gnet_stats_copy(struct gnet_dump *d, int type, void *buf,
...
static int ___gnet_stats_copy_basic(struct gnet_dump *d,
    struct gnet_stats_basic_sync __percpu *cpu,
...
/**
 * gnet_stats_copy_app - copy application specific statistics into statistics
 * TLV
 * @d: dumping handle
