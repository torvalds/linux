...
static int netdev_nl_dev_fill(struct net_device *netdev, struct sk_buff *rsp,
...
static void netdev_genl_dev_notify(struct net_device *netdev, int cmd) {
...
static int netdev_nl_napi_fill_one(struct sk_buff *rsp,
...
static int netdev_nl_napi_dump_one(struct net_device *netdev,
    struct sk_buff *rsp,
    const struct genl_info *info,
...
int netdev_nl_napi_get_dumpit(struct sk_buff *skb,
...
static int netdev_nl_queue_fill_one(struct sk_buff *rsp,
    struct net_device *netdev,
...
static int netdev_nl_queue_fill(struct sk_buff *rsp, struct net_device *netdev,
    u32 q_idx,
...
static int netdev_nl_queue_dump_one(struct net_device *netdev,
    struct sk_buff *rsp,
    const struct genl_info *info,
    struct netdev_nl_dump_ctx *ctx) {
  int err = 0;
...
static int netdev_stat_put(struct sk_buff *rsp, unsigned int attr_id,
    u64 value) {
...
static int netdev_nl_stats_write_rx(struct sk_buff *rsp,
...
static int netdev_nl_stats_write_tx(struct sk_buff *rsp,
...
static int netdev_nl_stats_queue(struct net_device *netdev, struct sk_buff *rsp,
...
static int netdev_nl_stats_by_queue(struct net_device *netdev,
    struct sk_buff *rsp,
    const struct genl_info *info,
    struct netdev_nl_dump_ctx *ctx) {
  const struct netdev_stat_ops *ops = netdev->stat_ops;
...
static int netdev_nl_stats_by_netdev(struct net_device *netdev,
    struct sk_buff *rsp,
    const struct genl_info *info) {
