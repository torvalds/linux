...
static struct mac802154_llsec_key *llsec_key_alloc(
    const struct ieee802154_llsec_key *template) {
  const int authsizes[3] = {
    4, 8, 16
  };
...
static struct mac802154_llsec_key *llsec_key_get(
    struct mac802154_llsec_key *key) {
  kref_get(&key->ref);
  return key;
}
...
static struct mac802154_llsec_device *llsec_dev_find_short(
    struct mac802154_llsec *sec, __le16 short_addr,
    __le16 pan_id) {
...
static struct mac802154_llsec_device *llsec_dev_find_long(
    struct mac802154_llsec *sec, __le64 hwaddr) {
  struct mac802154_llsec_device *dev;
...
static struct mac802154_llsec_device_key *llsec_devkey_find(
    struct mac802154_llsec_device *dev,
    const struct ieee802154_llsec_key_id *key) {
...
static struct mac802154_llsec_seclevel *llsec_find_seclevel(
...
static struct mac802154_llsec_key *llsec_lookup_key(struct mac802154_llsec *sec,
...
static void llsec_geniv(u8 iv[16], __le64 addr,
  ...
  __be32 frame_counter = (__force __be32) swab32(
      (__force u32) sec->frame_counter);
  iv[0] = 1; /* L' = L - 1 = 1 */
...
static int llsec_do_encrypt_unauth(struct sk_buff *skb,
    const struct mac802154_llsec *sec,
    const struct ieee802154_hdr *hdr,
    struct mac802154_llsec_key *key) {
  u8 iv[16];
...
static struct crypto_aead *llsec_tfm_by_len(struct mac802154_llsec_key *key,
    int authlen) {
  int i;
  for (i = 0; i < ARRAY_SIZE(key->tfm); i++) {
...
static int llsec_do_encrypt_auth(struct sk_buff *skb,
    const struct mac802154_llsec *sec,
    const struct ieee802154_hdr *hdr,
    struct mac802154_llsec_key *key) {
  u8 iv[16];
...
static struct mac802154_llsec_device *llsec_lookup_dev(
...
static int llsec_do_decrypt_unauth(struct sk_buff *skb,
    const struct mac802154_llsec *sec,
    const struct ieee802154_hdr *hdr,
...
static int llsec_do_decrypt_auth(struct sk_buff *skb,
    const struct mac802154_llsec *sec,
    const struct ieee802154_hdr *hdr,
    struct mac802154_llsec_key *key, __le64 dev_addr) {
  u8 iv[16];
...
static int llsec_update_devkey_record(struct mac802154_llsec_device *dev,
...
static int llsec_update_devkey_info(struct mac802154_llsec_device *dev,
    const struct ieee802154_llsec_key_id *in_key,
    u32 frame_counter) {
