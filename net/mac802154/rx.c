...
static void ieee802154_print_addr(const char *name,
...
static int ieee802154_parse_frame_start(struct sk_buff *skb,
...
static void __ieee802154_rx_handle_packet(struct ieee802154_local *local,
    struct sk_buff *skb) {
  int ret;
