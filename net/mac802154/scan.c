...
static void mac802154_scan_get_next_channel(struct ieee802154_local *local,
...
static int mac802154_scan_prepare_beacon_req(struct ieee802154_local *local) {
  ...
  local->scan_beacon_req.mhr.dest.pan_id = cpu_to_le16(
      IEEE802154_PANID_BROADCAST);
  local->scan_beacon_req.mhr.dest.short_addr = cpu_to_le16(
