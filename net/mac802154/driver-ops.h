...
static inline int drv_xmit_async(struct ieee802154_local *local,
    struct sk_buff *skb) {
...
static inline int drv_set_channel(struct ieee802154_local *local, u8 page,
    u8 channel) {
  int ret;
  might_sleep();
...
static inline int drv_set_csma_params(struct ieee802154_local *local, u8 min_be,
    u8 max_be,
