...
static struct net_device *ieee802154_add_iface_deprecated(
...
static int ieee802154_del_iface(struct wpan_phy *wpan_phy,
...
static int ieee802154_set_cca_mode(struct wpan_phy *wpan_phy,
...
static int ieee802154_set_cca_ed_level(struct wpan_phy *wpan_phy,
    s32 ed_level) {
  struct ieee802154_local *local = wpan_phy_priv(wpan_phy);
  int ret;
  ASSERT_RTNL();
...
static int ieee802154_set_tx_power(struct wpan_phy *wpan_phy, s32 power) {
  struct ieee802154_local *local = wpan_phy_priv(wpan_phy);
  int ret;
  ASSERT_RTNL();
...
static int ieee802154_set_backoff_exponent(struct wpan_phy *wpan_phy,
    struct wpan_dev *wpan_dev,
    u8 min_be, u8 max_be) {
  ASSERT_RTNL();
...
static void ieee802154_get_llsec_table(struct wpan_phy *wpan_phy,
    struct wpan_dev *wpan_dev,
...
static void ieee802154_lock_llsec_table(struct wpan_phy *wpan_phy,
    struct wpan_dev *wpan_dev) {
  struct net_device *dev = wpan_dev->netdev;
  struct ieee802154_sub_if_data *sdata = IEEE802154_DEV_TO_SUB_IF(dev);
...
static int ieee802154_set_llsec_params(struct wpan_phy *wpan_phy,
    struct wpan_dev *wpan_dev,
...
static int ieee802154_add_seclevel(struct wpan_phy *wpan_phy,
    struct wpan_dev *wpan_dev,
...
static int ieee802154_add_device(struct wpan_phy *wpan_phy,
    struct wpan_dev *wpan_dev,
...
static int ieee802154_del_device(struct wpan_phy *wpan_phy,
    struct wpan_dev *wpan_dev,
...
static int ieee802154_add_devkey(struct wpan_phy *wpan_phy,
    struct wpan_dev *wpan_dev,
    __le64 extended_addr,
...
static int ieee802154_del_devkey(struct wpan_phy *wpan_phy,
    struct wpan_dev *wpan_dev,
    __le64 extended_addr,
    const struct ieee802154_llsec_device_key *key) {
  struct net_device *dev = wpan_dev->netdev;
