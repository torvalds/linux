...
static int br_switchdev_fdb_replay_one(struct net_bridge *br,
...
static int br_switchdev_fdb_replay(const struct net_device *br_dev,
    const void *ctx,
...
static int br_switchdev_vlan_replay_one(struct notifier_block *nb,
...
static int br_switchdev_mdb_replay_one(struct notifier_block *nb,
    struct net_device *dev,
...
static int br_switchdev_mdb_replay(struct net_device *br_dev,
    struct net_device *dev,
