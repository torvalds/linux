...
static void br_multicast_create_eht_set_entry(
...
static struct net_bridge_group_eht_host *br_multicast_eht_host_lookup(
    struct net_bridge_port_group *pg,
    union net_bridge_eht_addr *h_addr) {
...
static struct net_bridge_group_eht_set_entry *br_multicast_eht_set_entry_lookup(
...
static struct net_bridge_group_eht_set *br_multicast_eht_set_lookup(
    struct net_bridge_port_group *pg,
    union net_bridge_eht_addr *src_addr) {
...
static struct net_bridge_group_eht_host *__eht_lookup_create_host(
    struct net_bridge_port_group *pg,
    union net_bridge_eht_addr *h_addr,
...
static struct net_bridge_group_eht_set_entry *__eht_lookup_create_set_entry(
...
static struct net_bridge_group_eht_set *__eht_lookup_create_set(
    struct net_bridge_port_group *pg,
    union net_bridge_eht_addr *src_addr) {
...
static void br_eht_convert_host_filter_mode(
    const struct net_bridge_mcast *brmctx,
    struct net_bridge_port_group *pg,
    union net_bridge_eht_addr *h_addr,
    int filter_mode) {
