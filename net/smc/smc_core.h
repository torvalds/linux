...
#define SMC_CONN_PER_LGR_MAX  255 /* max. # of connections per link group,
                                   * also is the default value for SMC-R v1 and
                                   * v2.0
                                   */
#define SMC_CONN_PER_LGR_PREFER 255 /* Preferred connections per link group used
                                     * for
                                     * SMC-R v2.1 and later negotiation, vendors
                                     * or
                                     * distrubutions may modify it to a value
                                     * between
                                     * 16-255 as needed.
                                     */
...
#define SMC_LINKS_ADD_LNK_MAX 2 /* max. # of links per link group, also is the
                                 ...
                                 */
#define SMC_LINKS_PER_LGR_MAX_PREFER  2 /* Preferred max links per link group
                                         * used for
                                         * SMC-R v2.1 and later negotiation,
                                         * vendors or
                                         * distrubutions may modify it to a
                                         * value between
                                         * 1-2 as needed.
                                         */
