...
static inline struct smc_clc_msg_proposal_prefix *smc_clc_proposal_get_prefix(
...
static inline struct smc_clc_msg_smcd *smc_get_clc_msg_smcd(
    struct smc_clc_msg_proposal *prop) {
...
static inline struct smc_clc_v2_extension *smc_get_clc_v2_ext(
    struct smc_clc_msg_proposal *prop) {
...
static inline struct smc_clc_smcd_v2_extension *smc_get_clc_smcd_v2_ext(
    struct smc_clc_v2_extension *prop_v2ext) {
  if (!prop_v2ext) {
    return NULL;
  }
...
static inline struct smc_clc_first_contact_ext *smc_get_clc_first_contact_ext(
