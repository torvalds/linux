...
static struct meta_ops __meta_ops[TCF_META_TYPE_MAX + 1][TCF_META_ID_MAX
    + 1] = {
  [TCF_META_TYPE_VAR] = {
...
MODULE_DESCRIPTION(
    "ematch classifier for various internal kernel metadata, skb metadata and sk metadata");
MODULE_LICENSE("GPL");
