...
static struct ets_class *ets_class_from_arg(struct Qdisc *sch,
    unsigned long arg) {
...
static bool ets_class_is_strict(struct ets_sched *q,
    const struct ets_class *cl) {
...
static struct sk_buff *ets_qdisc_dequeue_skb(struct Qdisc *sch,
    struct sk_buff *skb) {
