...
static bool svc_xprt_reserve_slot(struct svc_rqst *rqstp,
    struct svc_xprt *xprt) {
...
static bool svc_thread_should_sleep(struct svc_rqst *rqstp) {
...
static void svc_add_new_temp_xprt(struct svc_serv *serv,
 ...
 * address is deleted.
 */
void svc_age_temp_xprts_now(struct svc_serv *serv,
