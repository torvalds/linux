...
static struct crypto_sync_skcipher *gss_krb5_alloc_cipher_v2(const char *cname,
    const struct xdr_netobj *key) {
...
static struct crypto_ahash *gss_krb5_alloc_hash_v2(struct krb5_ctx *kctx,
    const struct xdr_netobj *key) {
...
static int gss_import_v2_context(const void *p, const void *end,
    struct krb5_ctx *ctx,
    gfp_t gfp_mask) {
  u64 seq_send64;
  int keylen;
...
static int gss_krb5_import_sec_context(const void *p, size_t len,
...
static void gss_krb5_delete_sec_context(void *internal_ctx) {
