...
/* XXXX this code currently makes the assumption that a mech oid will
   never be longer than 127 bytes.  This assumption is yest inherent in
 ...
 * mechanism in the token does yest match the mech argument.  buf and
		      ...
		      unsigned char **buf_in, int toksize)
{
   ...
   /* G_WRONG_MECH is yest returned immediately because it's more important
