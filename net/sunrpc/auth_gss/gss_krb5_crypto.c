...
u32 krb5_encrypt(
  ...
  u8 local_iv[GSS_KRB5_MAX_BLOCKSIZE] = {
    0
  };
...
static int checksummer(struct scatterlist *sg, void *data) {
...
static int encryptor(struct scatterlist *sg, void *data) {
...
int gss_encrypt_xdr_buf(struct crypto_sync_skcipher *tfm, struct xdr_buf *buf,
...
static int decryptor(struct scatterlist *sg, void *data) {
...
int gss_decrypt_xdr_buf(struct crypto_sync_skcipher *tfm, struct xdr_buf *buf,
    int offset) {
  int ret;
...
static u32 gss_krb5_cts_crypt(struct crypto_sync_skcipher *cipher,
    struct xdr_buf *buf,
 ...
 */
u32 krb5_etm_encrypt(struct krb5_ctx *kctx, u32 offset,
    struct xdr_buf *buf, struct page **pages) {
  struct crypto_sync_skcipher *cipher, *aux_cipher;
  struct crypto_ahash *ahash;
  struct xdr_netobj hmac;
