...
static inline struct rpc_xprt *rpc_sysfs_xprt_kobj_get_xprt(
    struct kobject *kobj) {
...
static inline struct rpc_xprt_switch *rpc_sysfs_xprt_kobj_get_xprt_switch(
    struct kobject *kobj) {
  struct rpc_sysfs_xprt *x = container_of(kobj,
      struct rpc_sysfs_xprt, kobject);
...
static inline struct rpc_xprt_switch *rpc_sysfs_xprt_switch_kobj_get_xprt(
    struct kobject *kobj) {
...
static struct rpc_sysfs_xprt_switch *rpc_sysfs_xprt_switch_alloc(
    struct kobject *parent,
    struct rpc_xprt_switch *xprt_switch,
    struct net *net,
    gfp_t gfp_flags) {
