 ...
 *
 */
void xdr_inline_pages(struct xdr_buf *xdr, unsigned int offset,
 ...
 */
static void _shift_data_left_pages(struct page **pages, size_t pgto_base,
 ...
 *  they point to may overlap.
 */
static void _shift_data_right_pages(struct page **pages, size_t pgto_base,
    size_t pgfrom_base, size_t len) {
  struct page **pgfrom, **pgto;
  char *vfrom, *vto;
  size_t copy;
 ...
 */
static void _copy_to_pages(struct page **pages, size_t pgbase, const char *p,
    size_t len) {
  struct page **pgto;
  char *vto;
  size_t copy;
 ...
 */
unsigned int xdr_stream_move_subsegment(struct xdr_stream *xdr,
    unsigned int offset,
