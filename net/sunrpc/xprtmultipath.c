...
static
struct rpc_xprt *__xprt_switch_find_next_entry_roundrobin(
    struct list_head *head,
    const struct rpc_xprt *cur) {
  struct rpc_xprt *ret;
...
static
struct rpc_xprt *xprt_switch_find_next_entry_roundrobin(
    struct rpc_xprt_switch *xps,
    const struct rpc_xprt *cur) {
...
static
struct rpc_xprt *xprt_switch_find_next_entry_offline(
    struct rpc_xprt_switch *xps,
    const struct rpc_xprt *cur) {
