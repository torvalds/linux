...
static struct sk_buff *digital_send_dep_data_prep(struct nfc_digital_dev *ddev,
    struct sk_buff *skb,
...
static struct sk_buff *digital_recv_dep_data_gather(
    struct nfc_digital_dev *ddev, u8 pfb,
    struct sk_buff *resp,
