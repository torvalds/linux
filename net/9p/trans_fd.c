...
static __poll_t p9_fd_poll(struct p9_client *client,
    struct poll_table_struct *pt, int *err) {
  __poll_t ret;
...
static int p9_pollwake(wait_queue_entry_t *wait, unsigned int mode, int sync,
    void *key) {
...
static int p9_fd_create_tcp(struct p9_client *client, const char *addr,
    char *args) {
  int err;
...
static int p9_fd_create_unix(struct p9_client *client, const char *addr,
    char *args) {
  int err;
  struct socket *csocket;
...
static int p9_fd_create(struct p9_client *client, const char *addr,
    char *args) {
  int err;
  struct p9_fd_opts opts;
  err = parse_opts(args, &opts);
