...
#else
static inline int nft_masq_module_init_ipv6(void) {
  return 0;
}
...
static void nft_masq_inet_destroy(const struct nft_ctx *ctx,
    const struct nft_expr *expr) {
...
#else
static inline int nft_masq_module_init_inet(void) {
  return 0;
}
