...
static int cfg_copy(struct hashlimit_cfg3 *to, const void *from, int revision) {
  if (revision == 1) {
...
static u_int32_t hash_dst(const struct xt_hashlimit_htable *ht,
...
static struct dsthash_ent *dsthash_find(const struct xt_hashlimit_htable *ht,
    const struct dsthash_dst *dst) {
...
static struct dsthash_ent *dsthash_alloc_init(struct xt_hashlimit_htable *ht,
...
static inline void dsthash_free(struct xt_hashlimit_htable *ht,
    struct dsthash_ent *ent) {
...
static int hashlimit_init_dst(const struct xt_hashlimit_htable *hinfo,
    struct dsthash_dst *dst,
...
static bool hashlimit_mt_common(const struct sk_buff *skb,
...
static bool hashlimit_mt_v2(const struct sk_buff *skb,
    struct xt_action_param *par) {
