...
static unsigned int tproxy_tg4(struct net *net, struct sk_buff *skb,
...
static unsigned int tproxy_tg4_v1(struct sk_buff *skb,
    const struct xt_action_param *par) {
...
static unsigned int tproxy_tg6_v1(struct sk_buff *skb,
    const struct xt_action_param *par) {
