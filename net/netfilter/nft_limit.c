...
static int nft_limit_dump(struct sk_buff *skb,
...
static int nft_limit_pkts_clone(struct nft_expr *dst,
...
static const struct nft_expr_ops *nft_limit_select_ops(
...
static const struct nft_object_ops *nft_limit_obj_select_ops(
    const struct nft_ctx *ctx,
    const struct nlattr * const tb[]) {
