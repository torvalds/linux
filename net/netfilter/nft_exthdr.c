...
static int nft_skb_copy_to_reg(const struct sk_buff *skb, int offset, u32 *dest,
    unsigned int len) {
...
static int nft_exthdr_dump_common(struct sk_buff *skb,
    const struct nft_exthdr *priv) {
...
static const struct nft_expr_ops *nft_exthdr_select_ops(
