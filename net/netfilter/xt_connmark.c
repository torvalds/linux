...
static unsigned int connmark_tg_shift(struct sk_buff *skb,
...
static unsigned int connmark_tg(struct sk_buff *skb,
...
static unsigned int connmark_tg_v2(struct sk_buff *skb,
    const struct xt_action_param *par) {
