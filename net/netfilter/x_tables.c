...
int xt_compat_check_entry_offsets(const void *base, const char *elems,
   ...
   */
  BUILD_BUG_ON(sizeof(struct compat_xt_entry_match)
 ...
 *
 * Also see xt_compat_check_entry_offsets for CONFIG_NETFILTER_XTABLES_COMPAT
 * version.
 *
