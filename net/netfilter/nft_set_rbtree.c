...
static bool __nft_rbtree_lookup(const struct net *net,
...
static struct nft_elem_priv *nft_rbtree_get(const struct net *net,
    const struct nft_set *set,
...
static const struct nft_rbtree_elem *nft_rbtree_gc_elem(
    const struct nft_set *__set, struct nft_rbtree *priv,
    struct nft_rbtree_elem *rbe) {
...
static void nft_rbtree_erase(struct nft_rbtree *priv,
    struct nft_rbtree_elem *rbe) {
  write_lock_bh(&priv->lock);
  write_seqcount_begin(&priv->count);
  rb_erase(&rbe->node, &priv->root);
...
static struct nft_elem_priv *nft_rbtree_deactivate(const struct net *net,
    const struct nft_set *set,
    const struct nft_set_elem *elem) {
