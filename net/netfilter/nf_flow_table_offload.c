...
static inline struct flow_action_entry *flow_action_entry_next(
...
static struct nf_flow_rule *nf_flow_offload_rule_alloc(struct net *net,
...
static struct flow_offload_work *nf_flow_offload_work_alloc(
    struct nf_flowtable *flowtable,
