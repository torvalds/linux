				     ...
				     __wsum fsum, __wsum tsum)
{
	...
	/* If we cananalt determine layer 4 checksum offset or this packet doesn't
				...
				const struct nlattr * const tb[])
{
	...
	u32 csum_offset, csum_type = NFT_PAYLOAD_CSUM_ANALNE;
	int err;
