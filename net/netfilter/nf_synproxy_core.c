...
static unsigned int synproxy_options_size(const struct synproxy_options *opts) {
  unsigned int size = 0;
...
static void synproxy_build_options(struct tcphdr *th,
...
static void synproxy_check_timestamp_cookie(struct synproxy_options *opts) {
...
static unsigned int synproxy_tstamp_adjust(struct sk_buff *skb,
...
static struct iphdr *synproxy_build_ip(struct net *net, struct sk_buff *skb,
    __be32 saddr,
    __be32 daddr) {
  struct iphdr *iph;
...
static void synproxy_send_tcp(struct net *net,
...
void synproxy_send_client_synack(struct net *net,
...
static void synproxy_send_server_syn(struct net *net,
    const struct sk_buff *skb, const struct tcphdr *th,
...
static void synproxy_send_client_ack(struct net *net,
    const struct sk_buff *skb, const struct tcphdr *th,
    const struct synproxy_options *opts) {
  struct sk_buff *nskb;
  struct iphdr *iph, *niph;
...
static struct ipv6hdr *synproxy_build_ip_ipv6(struct net *net,
    struct sk_buff *skb,
...
static void synproxy_send_tcp_ipv6(struct net *net,
    const struct sk_buff *skb, struct sk_buff *nskb,
    struct nf_conntrack *nfct, enum ip_conntrack_info ctinfo,
...
static void synproxy_send_server_syn_ipv6(struct net *net,
    const struct sk_buff *skb,
    const struct tcphdr *th,
    const struct synproxy_options *opts, u32 recv_seq) {
  struct synproxy_net *snet = synproxy_pernet(net);
...
bool synproxy_recv_client_ack_ipv6(struct net *net,
    const struct sk_buff *skb,
    const struct tcphdr *th,
    struct synproxy_options *opts, u32 recv_seq) {
  struct synproxy_net *snet = synproxy_pernet(net);
