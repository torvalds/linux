 ...
 */
static int ip_vs_app_inc_new(struct netns_ipvs *ipvs, struct ip_vs_app *app,
    __u16 proto,
    __u16 port) {
 ...
 */
static void ip_vs_app_inc_release(struct netns_ipvs *ipvs,
    struct ip_vs_app *inc) {
  struct ip_vs_protocol *pp;
 ...
 */
static inline void vs_fix_ack_seq(const struct ip_vs_seq *vseq,
    struct tcphdr *th) {
