 ...
 */
static inline unsigned int ip_vs_dh_hashkey(int af,
 ...
 */
static inline struct ip_vs_dest *ip_vs_dh_get(int af, struct ip_vs_dh_state *s,
    const union nf_inet_addr *addr) {
 ...
 */
static int ip_vs_dh_reassign(struct ip_vs_dh_state *s,
