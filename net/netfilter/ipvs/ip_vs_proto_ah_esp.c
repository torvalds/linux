...
static struct ip_vs_conn *ah_esp_conn_in_get(struct netns_ipvs *ipvs, int af,
...
static struct ip_vs_conn *ah_esp_conn_out_get(struct netns_ipvs *ipvs, int af,
    const struct sk_buff *skb,
    const struct ip_vs_iphdr *iph) {
  struct ip_vs_conn *cp;
  struct ip_vs_conn_param p;
...
static int ah_esp_conn_schedule(struct netns_ipvs *ipvs, int af,
    struct sk_buff *skb,
