...
static inline unsigned int ip_vs_mh_hashkey(int af,
...
static inline struct ip_vs_dest *ip_vs_mh_get(struct ip_vs_service *svc,
...
static inline struct ip_vs_dest *ip_vs_mh_get_fallback(
    struct ip_vs_service *svc, struct ip_vs_mh_state *s,
    const union nf_inet_addr *addr, __be16 port) {
...
static inline __be16 ip_vs_mh_get_port(const struct sk_buff *skb,
...
static struct ip_vs_dest *ip_vs_mh_schedule(struct ip_vs_service *svc,
