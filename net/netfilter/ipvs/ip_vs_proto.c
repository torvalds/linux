 ...
 */
static int register_ip_vs_proto_netns(struct netns_ipvs *ipvs,
 ...
 */
static int unregister_ip_vs_proto_netns(struct netns_ipvs *ipvs,
    struct ip_vs_proto_data *pd) {
...
static void ip_vs_tcpudp_debug_packet_v6(struct ip_vs_protocol *pp,
    const struct sk_buff *skb,
    int offset,
    const char *msg) {
  char buf[192];
