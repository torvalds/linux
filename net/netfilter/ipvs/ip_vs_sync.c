 ...
 */
static inline struct ip_vs_sync_buff *ip_vs_sync_buff_create(
    struct netns_ipvs *ipvs, unsigned int len) {
  struct ip_vs_sync_buff *sb;
 ...
 */
static inline struct ip_vs_sync_buff *get_curr_sync_buff(
    struct netns_ipvs *ipvs, struct ipvs_master_sync_state *ms,
    unsigned long time) {
  struct ip_vs_sync_buff *sb;
...
static inline int select_master_thread_id(struct netns_ipvs *ipvs,
 ...
 */
static inline struct ip_vs_sync_buff *ip_vs_sync_buff_create_v0(
    struct netns_ipvs *ipvs, unsigned int len) {
  struct ip_vs_sync_buff *sb;
 ...
 */
static inline int ip_vs_conn_fill_param_sync(struct netns_ipvs *ipvs, int af,
    union ip_vs_sync_conn *sc,
 ...
 *         timeout is in sec.
 */
static void ip_vs_proc_conn(struct netns_ipvs *ipvs,
 ...
 */
static void ip_vs_process_message_v0(struct netns_ipvs *ipvs,
    const char *buffer,
    const size_t buflen) {
 ...
 */
static inline int ip_vs_proc_sync_conn(struct netns_ipvs *ipvs, __u8 *p,
    __u8 *msg_end) {
  struct ip_vs_sync_conn_options opt;
  union  ip_vs_sync_conn *s;
  struct ip_vs_protocol *pp;
 ...
 */
static int join_mcast_group(struct sock *sk, struct in_addr *addr,
...
static int ip_vs_send_sync_msg(struct socket *sock,
    struct ip_vs_sync_mesg *msg) {
  int msize;
  int ret;
...
static int ip_vs_receive(struct socket *sock, char *buffer,
    const size_t buflen) {
  struct msghdr msg = {
    NULL,
  };
...
static inline struct ip_vs_sync_buff *next_sync_buff(struct netns_ipvs *ipvs,
    struct ipvs_master_sync_state *ms) {
  struct ip_vs_sync_buff *sb;
