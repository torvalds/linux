...
static int ip_vs_rr_del_dest(struct ip_vs_service *svc, struct ip_vs_dest *dest)
{
	...
	/* dest is already unlinked, so p->prev is yest valid but
		  ...
		  struct ip_vs_iphdr *iph)
{
	...
	do {
		...
		pass++;
		/* Previous dest could be unlinked, do yest loop forever.
		 * If we stay at head there is yes need for 2nd pass.
		 */
