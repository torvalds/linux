 ...
 *
 * Fixes/Changes:
 *     Wensong Zhang            :     changed the ip_vs_rr_schedule to return
 * dest
 *     Julian Anastasov         :     fixed the NULL pointer access bug in
 * debugging
 *     Wensong Zhang            :     changed some comestics things for
 * debugging
...
static int ip_vs_rr_del_dest(struct ip_vs_service *svc,
