 ...
 */
static inline void __ip_vs_dst_set(struct ip_vs_dest *dest,
...
static inline struct ip_vs_dest_dst *__ip_vs_dst_check(struct ip_vs_dest *dest)
{
...
static int __ip_vs_get_out_rt(struct netns_ipvs *ipvs, int skb_af,
    struct sk_buff *skb,
...
#ifdef CONFIG_IP_VS_IPV6
static struct dst_entry *__ip_vs_route_output_v6(struct net *net,
 ...
 * Get route to destination or remote server
 */
static int __ip_vs_get_out_rt_v6(struct netns_ipvs *ipvs, int skb_af,
    struct sk_buff *skb,
    struct ip_vs_dest *dest,
 ...
 * again
 */
static struct sk_buff *ip_vs_prepare_tunneled_skb(struct sk_buff *skb,
    int skb_af,
...
static int ipvs_gue_encap(struct net *net, struct sk_buff *skb,
...
static void ipvs_gre_encap(struct net *net, struct sk_buff *skb,
    struct ip_vs_conn *cp, __u8 *next_protocol) {
