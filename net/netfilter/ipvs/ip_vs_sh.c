 ...
 *       return n;
 *
 * Notes that serveryesde is a 256-bucket hash table that maps the hash
 ...
 * distribution of connections to the destinations in serveryesde. The
