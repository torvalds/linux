 ...
 */
static inline struct ip_vs_dest *ip_vs_sh_get(struct ip_vs_service *svc,
 ...
 */
static inline struct ip_vs_dest *ip_vs_sh_get_fallback(
    struct ip_vs_service *svc, struct ip_vs_sh_state *s,
    const union nf_inet_addr *addr, __be16 port) {
 ...
 */
static int ip_vs_sh_reassign(struct ip_vs_sh_state *s,
...
static inline __be16 ip_vs_sh_get_port(const struct sk_buff *skb,
