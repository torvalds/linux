...
static int ctnl_timeout_fill_info(struct sk_buff *skb, u32 portid, u32 seq,
    u32 type,
...
static int cttimeout_default_fill_info(struct net *net, struct sk_buff *skb,
    u32 portid,
...
static void __net_exit cttimeout_net_exit(struct net *net) {
  ...
  list_for_each_entry_safe(cur, tmp, &pernet->nfct_timeout_freelist,
      free_head) {
