...
static struct recent_entry *recent_entry_lookup(
...
static bool recent_mt(const struct sk_buff *skb, struct xt_action_param *par) {
...
static ssize_t recent_mt_proc_write(struct file *file, const char __user *input,
