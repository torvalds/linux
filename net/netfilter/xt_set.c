...
static bool set_match_v0(const struct sk_buff *skb,
...
static void compat_flags(struct xt_set_info_v0 *info) {
  u_int8_t i;
...
static int set_match_v0_checkentry(const struct xt_mtchk_param *par) {
...
static void set_match_v0_destroy(const struct xt_mtdtor_param *par) {
  struct xt_set_info_match_v0 *info = par->matchinfo;
  ip_set_nfnl_put(par->net, info->match_set.index);
}
...
static bool set_match_v1(const struct sk_buff *skb,
    struct xt_action_param *par) {
...
static int set_match_v1_checkentry(const struct xt_mtchk_param *par) {
...
static void set_match_v1_destroy(const struct xt_mtdtor_param *par) {
  struct xt_set_info_match_v1 *info = par->matchinfo;
  ip_set_nfnl_put(par->net, info->match_set.index);
}
...
static bool set_match_v3(const struct sk_buff *skb,
    struct xt_action_param *par) {
...
static bool set_match_v4(const struct sk_buff *skb,
    struct xt_action_param *par) {
...
static unsigned int set_target_v0(struct sk_buff *skb,
    const struct xt_action_param *par) {
...
static int set_target_v0_checkentry(const struct xt_tgchk_param *par) {
...
static void set_target_v0_destroy(const struct xt_tgdtor_param *par) {
  const struct xt_set_info_target_v0 *info = par->targinfo;
  if (info->add_set.index != IPSET_INVALID_ID) {
    ip_set_nfnl_put(par->net, info->add_set.index);
  }
...
static unsigned int set_target_v1(struct sk_buff *skb,
    const struct xt_action_param *par) {
...
static int set_target_v1_checkentry(const struct xt_tgchk_param *par) {
  const struct xt_set_info_target_v1 *info = par->targinfo;
  ip_set_id_t index;
  if (info->add_set.index != IPSET_INVALID_ID) {
    index = ip_set_nfnl_get_byindex(par->net, info->add_set.index);
...
static void set_target_v1_destroy(const struct xt_tgdtor_param *par) {
  const struct xt_set_info_target_v1 *info = par->targinfo;
  if (info->add_set.index != IPSET_INVALID_ID) {
    ip_set_nfnl_put(par->net, info->add_set.index);
  }
...
static unsigned int set_target_v2(struct sk_buff *skb,
    const struct xt_action_param *par) {
...
static unsigned int set_target_v3(struct sk_buff *skb,
    const struct xt_action_param *par) {
...
static int set_target_v3_checkentry(const struct xt_tgchk_param *par) {
  const struct xt_set_info_target_v3 *info = par->targinfo;
  ip_set_id_t index;
  int ret = 0;
  if (info->add_set.index != IPSET_INVALID_ID) {
...
static void set_target_v3_destroy(const struct xt_tgdtor_param *par) {
  const struct xt_set_info_target_v3 *info = par->targinfo;
  if (info->add_set.index != IPSET_INVALID_ID) {
    ip_set_nfnl_put(par->net, info->add_set.index);
  }
