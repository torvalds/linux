...
static const struct field_t
    _H223LogicalChannelParameters_adaptationLayerType_al3[] = { /* SEQUENCE */
...
static const struct field_t
    _OpenLogicalChannelAck_reverseLogicalChannelParameters[] = {  /* SEQUENCE */
