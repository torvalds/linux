...
static int list_set_ktest(struct ip_set *set, const struct sk_buff *skb,
...
static int list_set_kadd(struct ip_set *set, const struct sk_buff *skb,
    const struct xt_action_param *par,
    struct ip_set_adt_opt *opt, const struct ip_set_ext *ext) {
  struct list_set *map = set->data;
  struct set_elem *e;
...
static int list_set_kdel(struct ip_set *set, const struct sk_buff *skb,
    const struct xt_action_param *par,
    struct ip_set_adt_opt *opt, const struct ip_set_ext *ext) {
  struct list_set *map = set->data;
  struct set_elem *e;
...
static int list_set_kadt(struct ip_set *set, const struct sk_buff *skb,
    const struct xt_action_param *par,
...
static void __list_set_del_rcu(struct rcu_head *rcu) {
...
static void list_set_del(struct ip_set *set, struct set_elem *e) {
  struct list_set *map = set->data;
  set->elements--;
  list_del_rcu(&e->list);
...
static void list_set_replace(struct ip_set *set, struct set_elem *e,
    struct set_elem *old) {
  struct list_set *map = set->data;
...
static void set_cleanup_entries(struct ip_set *set) {
  struct list_set *map = set->data;
  struct set_elem *e, *n;
...
static int list_set_utest(struct ip_set *set, void *value,
...
static void list_set_init_extensions(struct ip_set *set,
    const struct ip_set_ext *ext,
    struct set_elem *e) {
...
static int list_set_uadd(struct ip_set *set, void *value,
    const struct ip_set_ext *ext,
    struct ip_set_ext *mext, u32 flags) {
  struct list_set *map = set->data;
  struct set_adt_elem *d = value;
...
static int list_set_udel(struct ip_set *set, void *value,
    const struct ip_set_ext *ext,
    struct ip_set_ext *mext, u32 flags) {
  struct list_set *map = set->data;
  struct set_adt_elem *d = value;
...
static int list_set_uadt(struct ip_set *set, struct nlattr *tb[],
    enum ipset_adt adt, u32 *lineno, u32 flags, bool retried) {
  struct list_set *map = set->data;
  ipset_adtfn adtfn = set->variant->adt[adt];
  struct set_adt_elem e = {
    .refid = IPSET_INVALID_ID
  };
...
static void list_set_flush(struct ip_set *set) {
  struct list_set *map = set->data;
  struct set_elem *e, *n;
  list_for_each_entry_safe(e, n, &map->members, list)
  list_set_del(set, e);
...
static void list_set_destroy(struct ip_set *set) {
  struct list_set *map = set->data;
  struct set_elem *e, *n;
  list_for_each_entry_safe(e, n, &map->members, list) {
    list_del(&e->list);
...
static size_t list_set_memsize(const struct list_set *map, size_t dsize) {
  struct set_elem *e;
  u32 n = 0;
  rcu_read_lock();
  list_for_each_entry_rcu(e, &map->members, list)
...
static int list_set_head(struct ip_set *set, struct sk_buff *skb) {
...
static int list_set_list(const struct ip_set *set,
...
static bool list_set_same_set(const struct ip_set *a, const struct ip_set *b) {
...
static void list_set_cancel_gc(struct ip_set *set) {
  struct list_set *map = set->data;
  if (SET_WITH_TIMEOUT(set)) {
...
static void list_set_gc(struct timer_list *t) {
...
static void list_set_gc_init(struct ip_set *set, void (*gc)(
    struct timer_list *t)) {
  struct list_set *map = set->data;
...
static int list_set_create(struct net *net, struct ip_set *set,
    struct nlattr *tb[],
    u32 flags) {
...
static int __init list_set_init(void) {
  return ip_set_type_register(&list_set_type);
}

static void __exit list_set_fini(void) {
  rcu_barrier();
