...
static bool hash_ipmac4_data_equal(const struct hash_ipmac4_elem *e1,
    const struct hash_ipmac4_elem *e2,
    u32 *multi) {
  return e1->ip == e2->ip && ether_addr_equal(e1->ether, e2->ether);
}

static bool hash_ipmac4_data_list(struct sk_buff *skb,
...
static void hash_ipmac4_data_next(struct hash_ipmac4_elem *next,
    const struct hash_ipmac4_elem *e) {
  next->ip = e->ip;
}
...
static int hash_ipmac4_kadt(struct ip_set *set, const struct sk_buff *skb,
    const struct xt_action_param *par,
    enum ipset_adt adt, struct ip_set_adt_opt *opt) {
  ipset_adtfn adtfn = set->variant->adt[adt];
  struct hash_ipmac4_elem e = {
    .ip = 0, { .foo[0] = 0, .foo[1] = 0 }
  };
...
static int hash_ipmac4_uadt(struct ip_set *set, struct nlattr *tb[],
...
static bool hash_ipmac6_data_equal(const struct hash_ipmac6_elem *e1,
...
static bool hash_ipmac6_data_list(struct sk_buff *skb,
...
static void hash_ipmac6_data_next(struct hash_ipmac6_elem *next,
    const struct hash_ipmac6_elem *e) {
}
...
static int hash_ipmac6_kadt(struct ip_set *set, const struct sk_buff *skb,
    const struct xt_action_param *par,
    enum ipset_adt adt, struct ip_set_adt_opt *opt) {
  ipset_adtfn adtfn = set->variant->adt[adt];
...
static int hash_ipmac6_uadt(struct ip_set *set, struct nlattr *tb[],
    enum ipset_adt adt, u32 *lineno, u32 flags, bool retried) {
  ipset_adtfn adtfn = set->variant->adt[adt];
  struct hash_ipmac6_elem e = {
    { .all = { 0 } },
...
static int __init hash_ipmac_init(void) {
  return ip_set_type_register(&hash_ipmac_type);
}

static void __exit hash_ipmac_fini(void) {
