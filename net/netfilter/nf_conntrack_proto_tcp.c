...
static enum nf_ct_tcp_action tcp_in_window(struct nf_conn *ct,
    enum ip_conntrack_dir dir,
...
static const u8 tcp_valid_flags[(TCPHDR_FIN | TCPHDR_SYN | TCPHDR_RST
    | TCPHDR_ACK
    | TCPHDR_URG) + 1] = {
  [TCPHDR_SYN] = 1,
...
static const struct nla_policy tcp_nla_policy[CTA_PROTOINFO_TCP_MAX + 1] = {
  ...
  [CTA_PROTOINFO_TCP_FLAGS_ORIGINAL]
    = { .len = sizeof(struct nf_ct_tcp_flags) },
...
static const struct nla_policy tcp_timeout_nla_policy[CTA_TIMEOUT_TCP_MAX
    + 1] = {
