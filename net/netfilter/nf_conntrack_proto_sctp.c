 ...
 * COOKIE ECHOED     - We have seen a COOKIE_ECHO chunk in the original
 * direction.
 * ESTABLISHED       - We have seen a COOKIE_ACK in the reply direction.
 * SHUTDOWN_SENT     - We have seen a SHUTDOWN chunk in the original direction.
 * SHUTDOWN_RECD     - We have seen a SHUTDOWN chunk in the reply direction.
 * SHUTDOWN_ACK_SENT - We have seen a SHUTDOWN_ACK chunk in the direction
 * opposite
...
static const u8 sctp_conntracks[2][11][SCTP_CONNTRACK_MAX] = {
  {
    ...
    /* error        */ {sCL, sCL, sCW, sCE, sES, sSS, sSR, sSA, sCL}, /* Can't
                                                                       * have
                                                                       * Stale
                                                                       * cookie*/
    /* cookie_echo  */ {sCL, sCL, sCE, sCE, sES, sSS, sSR, sSA, sCL}, /* 5.2.4 -
                                                                       * Big
                                                                       * TODO */
    /* cookie_ack   */ {sCL, sCL, sCW, sES, sES, sSS, sSR, sSA, sCL}, /* Can't
                                                                      * come in
                                                                      * orig
                                                                      * dir */
  ...
  },
  {
     ...
     *                  sNO, sCL, sCW, sCE, sES, sSS, sSR, sSA, sHS
     * init*/
    {sIV, sCL, sCW, sCE, sES, sSS, sSR, sSA, sIV},                    /* INIT in
                                                                       * sCL Big
                                                                       * TODO */
    ...
    /* cookie_echo  */ {sIV, sCL, sCE, sCE, sES, sSS, sSR, sSA, sIV}, /* Can't
                                                                      * come in
                                                                      * reply
                                                                      * dir */
...
static noinline bool sctp_new(struct nf_conn *ct, const struct sk_buff *skb,
...
int nf_conntrack_sctp_packet(struct nf_conn *ct,
  ...
  unsigned long map[256 / sizeof(unsigned long)] = {
    0
  };
  bool ignore = false;
...
static int sctp_timeout_obj_to_nlattr(struct sk_buff *skb, const void *data) {
