...
static struct nf_conntrack_nat_helper *nf_conntrack_nat_helper_find(
    const char *mod_name) {
...
struct nf_ct_helper_expectfn *nf_ct_helper_expectfn_find_by_name(
    const char *name) {
