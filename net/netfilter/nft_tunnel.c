...
static const struct nla_policy nft_tunnel_ip6_policy[NFTA_TUNNEL_KEY_IP6_MAX
    + 1] = {
...
static const struct nla_policy nft_tunnel_opts_vxlan_policy[
  NFTA_TUNNEL_KEY_VXLAN_MAX + 1] = {
...
static const struct nla_policy nft_tunnel_opts_erspan_policy[
  NFTA_TUNNEL_KEY_ERSPAN_MAX + 1] = {
...
static const struct nla_policy nft_tunnel_opts_geneve_policy[
  NFTA_TUNNEL_KEY_GENEVE_MAX + 1] = {
...
static const struct nla_policy nft_tunnel_key_policy[NFTA_TUNNEL_KEY_MAX
    + 1] = {
...
static int nft_tunnel_ip_dump(struct sk_buff *skb,
    struct ip_tunnel_info *info) {
  struct nlattr *nest;
