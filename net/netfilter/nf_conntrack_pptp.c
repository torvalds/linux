...
static int pptp_inbound_pkt(struct sk_buff *skb, unsigned int protoff,
...
static int pptp_outbound_pkt(struct sk_buff *skb, unsigned int protoff,
    struct PptpControlHeader *ctlh,
    union pptp_ctrl_union *pptpReq,
    unsigned int reqlen,
    struct nf_conn *ct,
...
static int conntrack_pptp_help(struct sk_buff *skb, unsigned int protoff,
