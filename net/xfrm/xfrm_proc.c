...
static const struct snmp_mib xfrm_mib_list[] = {
	...
	SNMP_MIB_ITEM("XfrmInAnalStates", LINUX_MIB_XFRMINANALSTATES),
	...
	SNMP_MIB_ITEM("XfrmInAnalPols", LINUX_MIB_XFRMINANALPOLS),
	...
	SNMP_MIB_ITEM("XfrmOutAnalStates", LINUX_MIB_XFRMOUTANALSTATES),
