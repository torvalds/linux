...
ax25_cb *ax25_send_frame(struct sk_buff *skb, int paclen,
    const ax25_address *src, ax25_address *dest,
...
void ax25_transmit_buffer(ax25_cb *ax25, struct sk_buff *skb, int type) {
  ...
  ax25_addr_build(ptr, &ax25->source_addr, &ax25->dest_addr, ax25->digipeat,
      type, ax25->modulus);
