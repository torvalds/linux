...
#define TCP_YEAH_DELTA        3 /* log minimum fraction of cwnd to be removed on
                                 * loss */
#define TCP_YEAH_EPSILON      1 /* log maximum fraction to be removed on early
                                 * decongestion */
#define TCP_YEAH_PHY          8 /* maximum delta from base */
#define TCP_YEAH_RHO         16 /* minimum number of consecutive rtt to consider
                                 * competition on loss */
#define TCP_YEAH_ZETA        50 /* minimum number of state switches to reset
                                 * reno_count */
