 ...
 *    Alan Cox  :   Fixed bug with 1.3.18 and IPIP not working (now needs to set
 * skb->h.iph)
 *          to keep ip_forward happy.
 *    Alan Cox  : More fixes for 1.3.21, and firewall fix. Maybe this will work
 * soon 8).
 *    Kai Schulte : Fixed #defines for IP_FIREWALL->FIREWALL
 *              David Woodhouse :       Perform some basic ICMP handling.
 *                                      IPIP Routing without decapsulation.
 *              Carlos Picoto   :       GRE over IP support
 *    Alexey Kuznetsov: Reworked. Really, now it is truncated version of
 * ipv4/ip_gre.c.
...
static int ipip_tunnel_ctl(struct net_device *dev, struct ip_tunnel_parm *p,
    int cmd) {
