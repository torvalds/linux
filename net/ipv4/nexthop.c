...
static void __nh_notifier_single_info_init(
    struct nh_notifier_single_info *nh_info,
...
static int nh_notifier_res_bucket_idle_timer_get(
...
static struct nh_res_table *nexthop_res_table_alloc(struct net *net, u32 nhg_id,
...
static void nexthop_notify(int event, struct nexthop *nh,
    struct nl_info *info) {
...
static unsigned long nh_res_bucket_idle_point(
    const struct nh_res_table *res_table,
...
static unsigned long nh_res_table_unb_point(
    const struct nh_res_table *res_table) {
...
static struct nexthop *nexthop_select_path_hthr(struct nh_group *nhg,
    int hash) {
...
static struct rtm_dump_nh_ctx *rtm_dump_nh_ctx(struct netlink_callback *cb) {
...
static struct nexthop *nexthop_find_group_resilient(struct net *net, u32 id,
    struct netlink_ext_ack *extack) {
  struct nh_group *nhg;
  struct nexthop *nh;
  nh = nexthop_find_by_id(net, id);
...
static struct rtm_dump_res_bucket_ctx *rtm_dump_res_bucket_ctx(
    struct netlink_callback *cb) {
