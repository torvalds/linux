...
static inline void set_sockaddr(struct sockaddr_in *sin, __be32 addr,
    __be16 port) {
...
static void __init ic_dhcp_init_options(u8 *options, struct ic_device *d) {
 ...
 */
static void __init ic_bootp_send_if(struct ic_device *d,
