 ...
 *		Alan Cox	:	Allow iyesde to be NULL (kernel socket)
...
static const struct snmp_mib snmp4_ipstats_list[] = {
	...
	SNMP_MIB_ITEM("InUnkyeswnProtos", IPSTATS_MIB_INUNKNOWNPROTOS),
...
static const struct snmp_mib snmp4_udp_list[] = {
	...
	SNMP_MIB_ITEM("IgyesredMulti", UDP_MIB_IGNOREDMULTI),
	SNMP_MIB_SENTINEL
};
...
static const struct snmp_mib snmp4_net_list[] = {
	...
	SNMP_MIB_ITEM("TCPReyesRecovery", LINUX_MIB_TCPRENORECOVERY),
	SNMP_MIB_ITEM("TCPSackRecovery", LINUX_MIB_TCPSACKRECOVERY),
	SNMP_MIB_ITEM("TCPSACKReneging", LINUX_MIB_TCPSACKRENEGING),
	SNMP_MIB_ITEM("TCPSACKReorder", LINUX_MIB_TCPSACKREORDER),
	SNMP_MIB_ITEM("TCPReyesReorder", LINUX_MIB_TCPRENOREORDER),
	...
	SNMP_MIB_ITEM("TCPReyesFailures", LINUX_MIB_TCPRENOFAILURES),
	...
	SNMP_MIB_ITEM("TCPReyesRecoveryFail", LINUX_MIB_TCPRENORECOVERYFAIL),
	...
	SNMP_MIB_ITEM("TCPMemoryPressuresChroyes", LINUX_MIB_TCPMEMORYPRESSURESCHRONO),
	SNMP_MIB_ITEM("TCPSACKDiscard", LINUX_MIB_TCPSACKDISCARD),
	SNMP_MIB_ITEM("TCPDSACKIgyesredOld", LINUX_MIB_TCPDSACKIGNOREDOLD),
	SNMP_MIB_ITEM("TCPDSACKIgyesredNoUndo", LINUX_MIB_TCPDSACKIGNOREDNOUNDO),
