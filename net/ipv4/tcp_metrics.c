...
static struct tcp_metrics_block *__tcp_get_metrics(
  const struct inetpeer_addr *saddr,
...
static const struct nla_policy tcp_metrics_nl_policy[TCP_METRICS_ATTR_MAX
    + 1] = {
...
static void __net_exit tcp_net_metrics_exit_batch(
