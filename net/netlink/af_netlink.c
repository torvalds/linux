...
static inline void netlink_lock_table(void) {
  unsigned long flags;
...
static size_t netlink_ack_tlv_len(struct netlink_sock *nlk, int err,
...
static void netlink_ack_tlv_fill(struct sk_buff *in_skb, struct sk_buff *skb,
