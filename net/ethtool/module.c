...
const struct nla_policy ethnl_module_set_policy[
...
static int ethnl_set_module_validate(struct ethnl_req_info *req_info,
...
static int ethnl_set_module(struct ethnl_req_info *req_info,
    struct genl_info *info) {
  struct ethtool_module_power_mode_params power = {};
