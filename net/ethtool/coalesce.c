...
static int ethnl_set_coalesce_validate(struct ethnl_req_info *req_info,
...
static int __ethnl_set_coalesce(struct ethnl_req_info *req_info,
    struct genl_info *info,
    bool *dual_change) {
  struct kernel_ethtool_coalesce kernel_coalesce = {};
...
static int ethnl_set_coalesce(struct ethnl_req_info *req_info,
    struct genl_info *info) {
  bool dual_change;
  int err, ret;
