...
static int rss_parse_request(struct ethnl_req_info *req_info,
    struct nlattr **tb,
...
static int rss_prepare_data(const struct ethnl_req_info *req_base,
...
static int rss_reply_size(const struct ethnl_req_info *req_base,
...
static int rss_fill_reply(struct sk_buff *skb,
