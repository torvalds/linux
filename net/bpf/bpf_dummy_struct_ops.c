...
static struct bpf_dummy_ops_test_args *dummy_ops_init_args(
    const union bpf_attr *kattr, unsigned int nr) {
  __u32 size_in;
...
static int dummy_ops_call_op(void *image,
    struct bpf_dummy_ops_test_args *args) {
...
static int bpf_dummy_test_2(struct bpf_dummy_ops_state *cb, int a1,
    unsigned short a2,
