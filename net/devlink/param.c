...
static struct devlink_param_item *devlink_param_find_by_name(
    struct xarray *params, const char *param_name) {
...
static struct devlink_param_item *devlink_param_find_by_id(
    struct xarray *params, u32 param_id) {
  return xa_load(params, param_id);
}

static bool devlink_param_cmode_is_supported(const struct devlink_param *param,
...
static int devlink_param_type_to_nla_type(enum devlink_param_type param_type) {
  switch (param_type) {
...
static int devlink_nl_param_value_fill_one(struct sk_buff *msg,
...
static int devlink_param_type_get_from_info(struct genl_info *info,
...
static int devlink_param_value_get_from_info(const struct devlink_param *param,
...
static struct devlink_param_item *devlink_param_get_from_info(
    struct xarray *params, struct genl_info *info) {
  char *param_name;
