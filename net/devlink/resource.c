...
static struct devlink_resource *devlink_resource_find(struct devlink *devlink,
...
static void devlink_resource_validate_children(
...
static int devlink_resource_validate_size(struct devlink_resource *resource,
    u64 size,
...
static int devlink_resource_size_params_put(struct devlink_resource *resource,
    struct sk_buff *skb) {
  struct devlink_resource_size_params *size_params;
