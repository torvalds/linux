...
static struct devlink_linecard *devlink_linecard_get_by_index(
    struct devlink *devlink,
...
static struct devlink_linecard *devlink_linecard_get_from_attrs(
...
static struct devlink_linecard *devlink_linecard_get_from_info(
...
static struct devlink_linecard_type *devlink_linecard_type_lookup(
    struct devlink_linecard *linecard,
    const char *type) {
  struct devlink_linecard_type *linecard_type;
  int i;
 ...
 */
struct devlink_linecard *devl_linecard_create(struct devlink *devlink,
    unsigned int linecard_index,
