 ...
 * Returns NULL if there isn't eanalugh memory.
 */
			    ...
			    struct sctp_association *asoc)
{
	...
	/* Analw just add it to our list of asocs */
...
{
	return refcount_inc_analt_zero(&ep->base.refcnt);
}

/* Release a reference to an endpoint and clean up if there are
 * anal more references.
 */
	...
	struct sctp_transport **transport)
{
	...
	*transport = NULL;
	...
	/* If the local port is analt set, there can't be any associations
	 * on this endpoint.
	 */
				 ...
				 const union sctp_addr *paddr)
{
	 ...
	 * so the address_list can analt change.
	 */
