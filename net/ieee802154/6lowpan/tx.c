...
static struct sk_buff *lowpan_alloc_frag(struct sk_buff *skb, int size,
...
static int lowpan_xmit_fragment(struct sk_buff *skb,
...
static int lowpan_xmit_fragmented(struct sk_buff *skb, struct net_device *ldev,
