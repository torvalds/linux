...
static inline struct net_device *rdev_add_virtual_intf_deprecated(
...
static inline void rdev_del_virtual_intf_deprecated(
    struct cfg802154_registered_device *rdev,
    struct net_device *dev) {
  rdev->ops->del_virtual_intf_deprecated(&rdev->wpan_phy, dev);
}

static inline int rdev_suspend(struct cfg802154_registered_device *rdev) {
  int ret;
...
static inline int rdev_resume(struct cfg802154_registered_device *rdev) {
  int ret;
...
static inline int rdev_add_virtual_intf(
    struct cfg802154_registered_device *rdev, char *name,
    unsigned char name_assign_type,
...
static inline int rdev_del_virtual_intf(
    struct cfg802154_registered_device *rdev,
...
static inline int rdev_set_channel(struct cfg802154_registered_device *rdev,
    u8 page, u8 channel) {
  int ret;
...
static inline int rdev_set_cca_mode(struct cfg802154_registered_device *rdev,
...
static inline int rdev_set_cca_ed_level(
    struct cfg802154_registered_device *rdev, s32 ed_level) {
  int ret;
...
static inline int rdev_set_tx_power(struct cfg802154_registered_device *rdev,
    s32 power) {
  int ret;
...
static inline int rdev_set_pan_id(struct cfg802154_registered_device *rdev,
...
static inline int rdev_set_short_addr(struct cfg802154_registered_device *rdev,
...
static inline int rdev_set_backoff_exponent(
    struct cfg802154_registered_device *rdev,
...
static inline int rdev_set_max_csma_backoffs(
    struct cfg802154_registered_device *rdev,
...
static inline int rdev_set_lbt_mode(struct cfg802154_registered_device *rdev,
...
static inline int rdev_set_ackreq_default(
    struct cfg802154_registered_device *rdev,
...
static inline void rdev_get_llsec_table(
    struct cfg802154_registered_device *rdev,
    struct wpan_dev *wpan_dev,
...
static inline void rdev_lock_llsec_table(
    struct cfg802154_registered_device *rdev,
    struct wpan_dev *wpan_dev) {
  rdev->ops->lock_llsec_table(&rdev->wpan_phy, wpan_dev);
}

static inline void rdev_unlock_llsec_table(
    struct cfg802154_registered_device *rdev,
    struct wpan_dev *wpan_dev) {
  rdev->ops->unlock_llsec_table(&rdev->wpan_phy, wpan_dev);
}

static inline int rdev_get_llsec_params(
    struct cfg802154_registered_device *rdev,
    struct wpan_dev *wpan_dev,
...
static inline int rdev_set_llsec_params(
    struct cfg802154_registered_device *rdev,
    struct wpan_dev *wpan_dev,
...
static inline int rdev_add_llsec_key(struct cfg802154_registered_device *rdev,
    struct wpan_dev *wpan_dev,
...
static inline int rdev_del_llsec_key(struct cfg802154_registered_device *rdev,
    struct wpan_dev *wpan_dev,
    const struct ieee802154_llsec_key_id *id) {
  return rdev->ops->del_llsec_key(&rdev->wpan_phy, wpan_dev, id);
}

static inline int rdev_add_seclevel(struct cfg802154_registered_device *rdev,
    struct wpan_dev *wpan_dev,
    const struct ieee802154_llsec_seclevel *sl) {
  return rdev->ops->add_seclevel(&rdev->wpan_phy, wpan_dev, sl);
}

static inline int rdev_del_seclevel(struct cfg802154_registered_device *rdev,
    struct wpan_dev *wpan_dev,
    const struct ieee802154_llsec_seclevel *sl) {
  return rdev->ops->del_seclevel(&rdev->wpan_phy, wpan_dev, sl);
}

static inline int rdev_add_device(struct cfg802154_registered_device *rdev,
    struct wpan_dev *wpan_dev,
    const struct ieee802154_llsec_device *dev_desc) {
  return rdev->ops->add_device(&rdev->wpan_phy, wpan_dev, dev_desc);
}

static inline int rdev_del_device(struct cfg802154_registered_device *rdev,
    struct wpan_dev *wpan_dev, __le64 extended_addr) {
  return rdev->ops->del_device(&rdev->wpan_phy, wpan_dev, extended_addr);
}

static inline int rdev_add_devkey(struct cfg802154_registered_device *rdev,
    struct wpan_dev *wpan_dev, __le64 extended_addr,
...
static inline int rdev_del_devkey(struct cfg802154_registered_device *rdev,
    struct wpan_dev *wpan_dev, __le64 extended_addr,
    const struct ieee802154_llsec_device_key *devkey) {
