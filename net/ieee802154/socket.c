...
static struct net_device *ieee802154_get_dev(struct net *net,
...
static void ieee802154_raw_deliver(struct net_device *dev,
    struct sk_buff *skb) {
  struct sock *sk;
  read_lock(&raw_lock);
...
static inline bool ieee802154_match_sock(__le64 hw_addr, __le16 pan_id,
    __le16 short_addr,
...
static int ieee802154_dgram_deliver(struct net_device *dev,
    struct sk_buff *skb) {
