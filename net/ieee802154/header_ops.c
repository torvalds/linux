...
static int ieee802154_hdr_push_addr(u8 *buf, const struct ieee802154_addr *addr,
    bool omit_pan) {
  int pos = 0;
...
static int ieee802154_hdr_push_sechdr(u8 *buf,
    const struct ieee802154_sechdr *hdr) {
  int pos = 5;
  memcpy(buf, hdr, 1);
...
static int ieee802154_hdr_get_sechdr(const u8 *buf,
    struct ieee802154_sechdr *hdr) {
  int pos = 5;
  memcpy(hdr, buf, 1);
...
static int ieee802154_hdr_get_addrs(const u8 *buf, struct ieee802154_hdr *hdr) {
  int pos = 0;
