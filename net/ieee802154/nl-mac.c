...
int ieee802154_set_macparams(struct sk_buff *skb, struct genl_info *info) {
  ...
  if (info->attrs[IEEE802154_ATTR_FRAME_RETRIES]) {
    params.frame_retries
      = nla_get_s8(info->attrs[IEEE802154_ATTR_FRAME_RETRIES]);
  }
...
static int ieee802154_llsec_parse_key_id(struct genl_info *info,
  ...
  switch (desc->mode) {
    case IEEE802154_SCF_KEY_SHORT_INDEX:
      {
        u32 source
          = nla_get_u32(info->attrs[IEEE802154_ATTR_LLSEC_KEY_SOURCE_SHORT]);
        desc->short_source = cpu_to_le32(source);
        break;
      }
    case IEEE802154_SCF_KEY_HW_INDEX:
      desc->extended_source
        = nla_get_hwaddr(info->attrs[IEEE802154_ATTR_LLSEC_KEY_SOURCE_EXTENDED]);
      break;
  }
  return 0;
}

static int ieee802154_llsec_fill_key_id(struct sk_buff *msg,
...
static int ieee802154_llsec_dump_table(struct sk_buff *skb,
...
static int ieee802154_nl_llsec_change(struct sk_buff *skb,
...
static int ieee802154_llsec_parse_key(struct genl_info *info,
...
static int ieee802154_nl_fill_key(struct sk_buff *msg, u32 portid, u32 seq,
...
static int llsec_parse_dev(struct genl_info *info,
...
static int ieee802154_nl_fill_dev(struct sk_buff *msg, u32 portid, u32 seq,
...
static int ieee802154_nl_fill_devkey(struct sk_buff *msg, u32 portid, u32 seq,
    __le64 devaddr,
...
static int llsec_parse_seclevel(struct genl_info *info,
  ...
  if (sl->frame_type == IEEE802154_FC_TYPE_MAC_CMD) {
    ...
    sl->cmd_frame_id = nla_get_u8(
        info->attrs[IEEE802154_ATTR_LLSEC_CMD_FRAME_ID]);
  }
...
static int ieee802154_nl_fill_seclevel(struct sk_buff *msg, u32 portid, u32 seq,
