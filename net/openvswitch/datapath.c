...
static struct sk_buff *ovs_flow_cmd_alloc_info(
 ...
 * to mask.
 * */
static noinline_for_stack int ovs_nla_init_match_and_action(struct net *net,
    struct sw_flow_match *match,
    struct sw_flow_key *key,
    struct nlattr **a,
    struct sw_flow_actions **acts,
...
static int ovs_flow_cmd_del(struct sk_buff *skb, struct genl_info *info) {
  ...
  reply = ovs_flow_cmd_alloc_info(
      (const struct sw_flow_actions __force *) flow->sf_acts,
...
/* Called with ovs_mutex */
static void ovs_update_headroom(struct datapath *dp,
...
static int ovs_vport_cmd_dump(struct sk_buff *skb,
