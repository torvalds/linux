 ...
 */
static struct ceph_object_extent *lookup_last(struct list_head *object_extents,
    u64 objno,
...
static struct ceph_object_extent *lookup_containing(
    struct list_head *object_extents, u64 objno,
    u64 objoff, u32 xlen) {
  struct ceph_object_extent *ex;
