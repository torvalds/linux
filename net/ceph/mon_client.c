 ...
 */
static void __send_prepared_auth_request(struct ceph_mon_client *monc,
    int len) {
  monc->pending_auth = 1;
...
static struct ceph_mon_generic_request *alloc_generic_request(
    struct ceph_mon_client *monc, gfp_t gfp) {
  struct ceph_mon_generic_request *req;
...
static struct ceph_mon_generic_request *__ceph_monc_get_version(
    struct ceph_mon_client *monc, const char *what,
