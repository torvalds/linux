...
struct sk_buff *ndisc_ns_create(struct net_device *dev,
...
static bool ndisc_suppress_frag_ndisc(struct sk_buff *skb) {
  ...
  if (IP6CB(skb)->flags & IP6SKB_FRAGMENTED
    ...
    net_warn_ratelimited(
        "Received fragmented ndisc packet. Carefully consider disabling suppress_frag_ndisc.\n");
    return true;
  }
  return false;
}
...
static int ndisc_netdev_event(struct notifier_block *this, unsigned long event,
    void *ptr) {
