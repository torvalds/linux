 ...
 *   else %NULL
 **/
static struct ip6_tnl *vti6_tnl_lookup(struct net *net,
 ...
 **/
static struct ip6_tnl __rcu **vti6_tnl_bucket(struct vti6_net *ip6n,
...
static void vti6_tnl_link(struct vti6_net *ip6n, struct ip6_tnl *t) {
  struct ip6_tnl __rcu **tp = vti6_tnl_bucket(ip6n, &t->parms);
  rcu_assign_pointer(t->next, rtnl_dereference(*tp));
  rcu_assign_pointer(*tp, t);
}

static void vti6_tnl_unlink(struct vti6_net *ip6n, struct ip6_tnl *t) {
...
static struct ip6_tnl *vti6_tnl_create(struct net *net,
 ...
 *   0 else
 **/
static inline bool vti6_addr_conflict(const struct ip6_tnl *t,
...
static netdev_tx_t vti6_tnl_xmit(struct sk_buff *skb, struct net_device *dev) {
  struct ip6_tnl *t = netdev_priv(dev);
  struct flowi fl;
  int ret;
 ...
 **/
static int vti6_tnl_change(struct ip6_tnl *t, const struct __ip6_tnl_parm *p,
    bool keep_mtu) {
...
static void vti6_parm_from_user(struct __ip6_tnl_parm *p,
...
static void vti6_parm_to_user(struct ip6_tnl_parm2 *u,
    const struct __ip6_tnl_parm *p) {
  u->laddr = p->laddr;
  u->raddr = p->raddr;
  u->link = p->link;
 ...
 **/
static int vti6_siocdevprivate(struct net_device *dev, struct ifreq *ifr,
