...
static int ip6_finish_output2(struct net *net, struct sock *sk,
    struct sk_buff *skb) {
...
static int ip6_finish_output_gso_slowpath_drop(struct net *net, struct sock *sk,
...
static int __ip6_finish_output(struct net *net, struct sock *sk,
    struct sk_buff *skb) {
  unsigned int mtu;
...
static int ip6_finish_output(struct net *net, struct sock *sk,
    struct sk_buff *skb) {
  int ret;
...
static void ip6_cork_steal_dst(struct sk_buff *skb,
