...
VISIBLE_IF_CFG80211_KUNIT size_t cfg80211_gen_new_ie(const u8 *ie, size_t ielen,
...
VISIBLE_IF_CFG80211_KUNIT void cfg80211_free_coloc_ap_list(
    struct list_head *coloc_ap_list) {
...
static enum cfg80211_rnr_iter_ret cfg80211_parse_colocated_ap_iter(void *_data,
    u8 type,
    const struct ieee80211_neighbor_ap_info *info,
    const u8 *tbtt_info, u8 tbtt_info_len) {
...
VISIBLE_IF_CFG80211_KUNIT int cfg80211_parse_colocated_ap(
    const struct cfg80211_bss_ies *ies,
...
static struct cfg80211_sched_scan_request *cfg80211_find_sched_scan_req(
    struct cfg80211_registered_device *rdev, u64 reqid) {
...
static struct cfg80211_internal_bss *rb_find_bss(
    struct cfg80211_registered_device *rdev,
...
/* Returned bss is reference counted and must be cleaned up appropriately. */
static struct cfg80211_internal_bss *__cfg80211_bss_update(
    struct cfg80211_registered_device *rdev,
...
struct cfg80211_internal_bss *cfg80211_bss_update(
    struct cfg80211_registered_device *rdev,
    struct cfg80211_internal_bss *tmp,
    bool signal_valid, unsigned long ts) {
  struct cfg80211_internal_bss *res;
 ...
 */
static struct ieee80211_channel *cfg80211_get_bss_channel(struct wiphy *wiphy,
    const u8 *ie,
    size_t ielen,
    struct ieee80211_channel *channel) {
  u32 freq;
...
/* Returned bss is reference counted and must be cleaned up appropriately. */
static struct cfg80211_bss *cfg80211_inform_single_bss_data(struct wiphy *wiphy,
...
static struct cfg80211_mle *cfg80211_defrag_mle(const struct element *mle,
...
static enum cfg80211_rnr_iter_ret cfg802121_mld_ap_rnr_iter(void *_data,
    u8 type,
    const struct ieee80211_neighbor_ap_info *info,
    const u8 *tbtt_info, u8 tbtt_info_len) {
...
static u8 cfg80211_rnr_info_for_mld_ap(const u8 *ie, size_t ielen, u8 mld_id,
    u8 link_id,
    const struct ieee80211_neighbor_ap_info **ap_info,
    u8 *param_ch_count) {
...
static struct element *cfg80211_gen_reporter_rnr(
    struct cfg80211_bss *source_bss, bool is_mbssid,
  ...
  ap_info.channel = ieee80211_frequency_to_channel(
      source_bss->channel->center_freq);
  /* operating class */
...
static void cfg80211_parse_ml_elem_sta_data(struct wiphy *wiphy,
    struct cfg80211_inform_single_bss_data *tx_data,
    struct cfg80211_bss *source_bss,
    const struct element *elem,
    gfp_t gfp) {
...
struct cfg80211_bss *cfg80211_inform_bss_frame_data(struct wiphy *wiphy,
    struct cfg80211_inform_bss *data,
...
#ifdef CONFIG_CFG80211_WEXT
static struct cfg80211_registered_device *cfg80211_get_dev_from_ifindex(
