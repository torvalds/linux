...
static const struct cfg80211_chan_def *check_chandef_primary_compat(
    const struct cfg80211_chan_def *c1,
...
static const struct cfg80211_chan_def *_cfg80211_chandef_compatible(
    const struct cfg80211_chan_def *c1,
    const struct cfg80211_chan_def *c2) {
...
const struct cfg80211_chan_def *cfg80211_chandef_compatible(
    const struct cfg80211_chan_def *c1,
    const struct cfg80211_chan_def *c2) {
  const struct cfg80211_chan_def *ret;
...
static bool cfg80211_dfs_permissive_check_wdev(
...
static bool cfg80211_offchan_chain_is_active(
    struct cfg80211_registered_device *rdev,
