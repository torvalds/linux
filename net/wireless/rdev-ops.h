...
static inline int rdev_del_virtual_intf(struct cfg80211_registered_device *rdev,
...
static inline int rdev_change_virtual_intf(
...
static inline int rdev_get_key(struct cfg80211_registered_device *rdev,
...
static inline int rdev_set_default_key(struct cfg80211_registered_device *rdev,
...
static inline int rdev_set_default_mgmt_key(
    struct cfg80211_registered_device *rdev,
    struct net_device *netdev, int link_id, u8 key_index) {
  int ret;
...
static inline int rdev_set_default_beacon_key(
    struct cfg80211_registered_device *rdev,
    struct net_device *netdev, int link_id,
    u8 key_index) {
  int ret;
...
static inline int rdev_get_mesh_config(struct cfg80211_registered_device *rdev,
...
static inline int rdev_update_mesh_config(
    struct cfg80211_registered_device *rdev,
...
static inline int rdev_libertas_set_mesh_channel(
    struct cfg80211_registered_device *rdev,
    struct net_device *dev,
...
static inline int rdev_set_monitor_channel(
    struct cfg80211_registered_device *rdev,
...
static inline int rdev_update_connect_params(
    struct cfg80211_registered_device *rdev,
    struct net_device *dev,
...
static inline int rdev_set_wiphy_params(struct cfg80211_registered_device *rdev,
    u32 changed) {
  int ret;
...
static inline int rdev_set_multicast_to_unicast(
    struct cfg80211_registered_device *rdev,
    struct net_device *dev,
    const bool enabled) {
  int ret;
...
static inline int rdev_get_txq_stats(struct cfg80211_registered_device *rdev,
    struct wireless_dev *wdev,
...
static inline int rdev_set_bitrate_mask(struct cfg80211_registered_device *rdev,
    struct net_device *dev, unsigned int link_id,
    const u8 *peer,
...
static inline int rdev_remain_on_channel(
    struct cfg80211_registered_device *rdev,
    struct wireless_dev *wdev,
    struct ieee80211_channel *chan,
...
static inline int rdev_cancel_remain_on_channel(
    struct cfg80211_registered_device *rdev,
...
static inline int rdev_mgmt_tx_cancel_wait(
    struct cfg80211_registered_device *rdev,
    struct wireless_dev *wdev, u64 cookie) {
  int ret;
...
static inline int rdev_set_cqm_rssi_config(
    struct cfg80211_registered_device *rdev,
...
static inline int rdev_set_cqm_rssi_range_config(
    struct cfg80211_registered_device *rdev,
...
static inline int rdev_set_cqm_txe_config(
    struct cfg80211_registered_device *rdev,
...
static inline void rdev_update_mgmt_frame_registrations(
    struct cfg80211_registered_device *rdev,
    struct wireless_dev *wdev,
...
static inline int rdev_sched_scan_start(struct cfg80211_registered_device *rdev,
    struct net_device *dev,
...
static inline int rdev_get_channel(struct cfg80211_registered_device *rdev,
    struct wireless_dev *wdev,
...
static inline int rdev_add_nan_func(struct cfg80211_registered_device *rdev,
    struct wireless_dev *wdev,
...
static inline int rdev_nan_change_conf(struct cfg80211_registered_device *rdev,
    struct wireless_dev *wdev,
...
static inline int rdev_set_ap_chanwidth(struct cfg80211_registered_device *rdev,
    struct net_device *dev,
    unsigned int link_id,
    struct cfg80211_chan_def *chandef) {
  int ret;
...
static inline int rdev_add_tx_ts(struct cfg80211_registered_device *rdev,
...
static inline int rdev_del_tx_ts(struct cfg80211_registered_device *rdev,
    struct net_device *dev, u8 tsid, const u8 *peer) {
  int ret = -EOPNOTSUPP;
...
static inline int rdev_tdls_channel_switch(
    struct cfg80211_registered_device *rdev,
...
static inline void rdev_tdls_cancel_channel_switch(
    struct cfg80211_registered_device *rdev,
    struct net_device *dev, const u8 *addr) {
...
static inline int rdev_start_radar_detection(
    struct cfg80211_registered_device *rdev,
    struct net_device *dev,
    struct cfg80211_chan_def *chandef,
    u32 cac_time_ms) {
...
static inline void rdev_end_cac(struct cfg80211_registered_device *rdev,
    struct net_device *dev) {
...
static inline int rdev_set_mcast_rate(struct cfg80211_registered_device *rdev,
    struct net_device *dev,
...
static inline int rdev_set_coalesce(struct cfg80211_registered_device *rdev,
...
static inline int rdev_external_auth(struct cfg80211_registered_device *rdev,
    struct net_device *dev,
...
static inline int rdev_get_ftm_responder_stats(
    struct cfg80211_registered_device *rdev,
    struct net_device *dev,
...
static inline int rdev_start_pmsr(struct cfg80211_registered_device *rdev,
    struct wireless_dev *wdev,
...
static inline void rdev_abort_pmsr(struct cfg80211_registered_device *rdev,
    struct wireless_dev *wdev,
    struct cfg80211_pmsr_request *request) {
...
static inline int rdev_probe_mesh_link(struct cfg80211_registered_device *rdev,
...
static inline int rdev_set_fils_aad(struct cfg80211_registered_device *rdev,
...
static inline int rdev_set_radar_background(
    struct cfg80211_registered_device *rdev,
    struct cfg80211_chan_def *chandef) {
...
static inline int rdev_add_intf_link(struct cfg80211_registered_device *rdev,
    struct wireless_dev *wdev,
    unsigned int link_id) {
  int ret = 0;
...
static inline void rdev_del_intf_link(struct cfg80211_registered_device *rdev,
    struct wireless_dev *wdev,
    unsigned int link_id) {
...
static inline int rdev_add_link_station(struct cfg80211_registered_device *rdev,
    struct net_device *dev,
...
static inline int rdev_mod_link_station(struct cfg80211_registered_device *rdev,
    struct net_device *dev,
    struct link_station_parameters *params) {
  int ret;
...
static inline int rdev_del_link_station(struct cfg80211_registered_device *rdev,
    struct net_device *dev,
...
static inline int rdev_set_hw_timestamp(struct cfg80211_registered_device *rdev,
    struct net_device *dev,
...
static inline int rdev_set_ttlm(struct cfg80211_registered_device *rdev,
    struct net_device *dev,
