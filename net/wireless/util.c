...
const struct ieee80211_rate *ieee80211_get_response_rate(
...
static bool cfg80211_igtk_cipher_supported(
...
static void __frame_add_frag(struct sk_buff *skb, struct page *page,
...
static u16 ieee80211_amsdu_subframe_length(void *field, u8 mesh_flags,
    u8 hdr_type) {
...
#define SCALE 6144
  ...
  u32 rates_160M[3] = {
    960777777, 907400000, 816666666
  };
  u32 rates_969[3] = {
    480388888, 453700000, 408333333
  };
  u32 rates_484[3] = {
    229411111, 216666666, 195000000
  };
  u32 rates_242[3] = {
    114711111, 108333333, 97500000
  };
  u32 rates_106[3] = {
    40000000, 37777777, 34000000
  };
  u32 rates_52[3] = {
    18820000, 17777777, 16000000
  };
  u32 rates_26[3] = {
    9411111, 8888888, 8000000
  };
  u64 tmp;
  u32 result;
...
#define SCALE 6144
  ...
  static const u32 rates_996[3] = {
    480388888, 453700000, 408333333
  };
  static const u32 rates_484[3] = {
    229411111, 216666666, 195000000
  };
  static const u32 rates_242[3] = {
    114711111, 108333333, 97500000
  };
  static const u32 rates_106[3] = {
    40000000, 37777777, 34000000
  };
  static const u32 rates_52[3] = {
    18820000, 17777777, 16000000
  };
  static const u32 rates_26[3] = {
    9411111, 8888888, 8000000
  };
  u64 tmp;
  u32 result;
...
static void cfg80211_iter_sum_ifcombs(
    const struct ieee80211_iface_combination *c,
    void *data) {
  int *num = data;
  (*num)++;
...
const struct wiphy_iftype_ext_capab *cfg80211_get_iftype_ext_capa(
    struct wiphy *wiphy, enum nl80211_iftype type) {
  int i;
