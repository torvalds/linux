...
static int x25_bind(struct socket *sock, struct sockaddr *uaddr, int addr_len)
{
	...
	release_sock(sk);
	SOCK_DE(sk, "x25_bind: socket is bound\n");
out:
	return rc;
}
...
static int x25_sendmsg(struct socket *sock, struct msghdr *msg, size_t len)
{
	...
	SOCK_DE(sk, "x25_sendmsg: sendto: Addresses built.\n");

	/* Build a packet */
	SOCK_DE(sk, "x25_sendmsg: sendto: building packet.\n");
	 ...
	 */
	SOCK_DE(sk, "x25_sendmsg: Copying user data\n");
	 ...
	 */
	SOCK_DE(sk, "x25_sendmsg: Building X.25 Header.\n");
	...
	SOCK_DE(sk, "x25_sendmsg: Built header.\n");
	SOCK_DE(sk, "x25_sendmsg: Transmitting buffer\n");
