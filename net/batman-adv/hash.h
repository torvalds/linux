 ...
 * keys
 *
 * Return: true if same and false if yest same
 */
typedef bool (*batadv_hashdata_compare_cb)(const struct hlist_yesde *,
					   const void *);
...
typedef void (*batadv_hashdata_free_cb)(struct hlist_yesde *, void *);
 ...
 *	@data_yesde: to be added element
 *
				  ...
				  struct hlist_yesde *data_yesde)
{
	...
	/* yes duplicate found in list, add new element */
	hlist_add_head_rcu(data_yesde, head);
