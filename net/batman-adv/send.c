 ...
 */
static bool batadv_send_skb_push_fill_unicast(struct sk_buff *skb, int hdr_size,
    struct batadv_orig_node *orig_node) {
 ...
 */
static bool batadv_forw_packet_was_stolen(
    struct batadv_forw_packet *forw_packet) {
 ...
 */
static void batadv_forw_packet_list_steal(struct hlist_head *forw_list,
 ...
 * Caller needs to ensure that forw_packet->delayed_work was initialized.
 */
static void batadv_forw_packet_bcast_queue(struct batadv_priv *bat_priv,
    struct batadv_forw_packet *forw_packet,
    unsigned long send_time) {
 ...
 */
static bool batadv_forw_packet_bcasts_left(
    struct batadv_forw_packet *forw_packet) {
 ...
 */
static void batadv_forw_packet_bcasts_dec(
    struct batadv_forw_packet *forw_packet) {
