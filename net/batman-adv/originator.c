 ...
 */
struct batadv_orig_node *batadv_orig_hash_find(struct batadv_priv *bat_priv,
    const void *data) {
 ...
 */
struct batadv_orig_node_vlan *batadv_orig_node_vlan_get(
 ...
 */
struct batadv_orig_node_vlan *batadv_orig_node_vlan_new(
    struct batadv_orig_node *orig_node,
    unsigned short vid) {
 ...
 * The object is returned with refcounter increased by 1.
 */
struct batadv_neigh_node *batadv_orig_router_get(
    struct batadv_orig_node *orig_node,
 ...
 * address.
 */
struct batadv_neigh_node *batadv_orig_to_router(struct batadv_priv *bat_priv,
    u8 *orig_addr,
 ...
 * The object is returned with refcounter increased by 1.
 */
struct batadv_orig_ifinfo *batadv_orig_ifinfo_get(
    struct batadv_orig_node *orig_node,
    struct batadv_hard_iface *if_outgoing) {
 ...
 * The object is returned with refcounter increased by 1.
 */
struct batadv_orig_ifinfo *batadv_orig_ifinfo_new(
    struct batadv_orig_node *orig_node,
    struct batadv_hard_iface *if_outgoing) {
  struct batadv_orig_ifinfo *orig_ifinfo;
 ...
 */
struct batadv_neigh_ifinfo *batadv_neigh_ifinfo_get(
 ...
 * The object is returned with refcounter increased by 1.
 */
struct batadv_neigh_ifinfo *batadv_neigh_ifinfo_new(
    struct batadv_neigh_node *neigh,
    struct batadv_hard_iface *if_outgoing) {
  struct batadv_neigh_ifinfo *neigh_ifinfo;
 ...
 */
static struct batadv_neigh_node *batadv_neigh_node_get(
 ...
 */
static struct batadv_hardif_neigh_node *batadv_hardif_neigh_create(
 ...
 * Return: the hardif neighbour node if found or created or NULL otherwise.
 */
static struct batadv_hardif_neigh_node *batadv_hardif_neigh_get_or_create(
    struct batadv_hard_iface *hard_iface,
    const u8 *neigh_addr,
    struct batadv_orig_node *orig_node) {
  struct batadv_hardif_neigh_node *hardif_neigh;
 ...
 * Return: neighbor when found. Otherwise NULL
 */
struct batadv_hardif_neigh_node *batadv_hardif_neigh_get(
    const struct batadv_hard_iface *hard_iface,
    const u8 *neigh_addr) {
 ...
 */
static struct batadv_neigh_node *batadv_neigh_node_create(
    struct batadv_orig_node *orig_node,
    struct batadv_hard_iface *hard_iface,
    const u8 *neigh_addr) {
  struct batadv_neigh_node *neigh_node;
 ...
 * Return: the neighbour node if found or created or NULL otherwise.
 */
struct batadv_neigh_node *batadv_neigh_node_get_or_create(
    struct batadv_orig_node *orig_node,
    struct batadv_hard_iface *hard_iface,
    const u8 *neigh_addr) {
  struct batadv_neigh_node *neigh_node;
 ...
 */
static struct batadv_neigh_node *batadv_find_best_neighbor(
    struct batadv_priv *bat_priv,
    struct batadv_orig_node *orig_node,
    struct batadv_hard_iface *if_outgoing) {
