...
static netdev_tx_t batadv_interface_tx(struct sk_buff *skb,
  ...
  static const u8 stp_addr[ETH_ALEN] = {
    0x01, 0x80, 0xC2, 0x00,
    0x00, 0x00
  };
  static const u8 ectp_addr[ETH_ALEN] = {
    0xCF, 0x00, 0x00, 0x00,
    0x00, 0x00
  };
 ...
 */
int batadv_softif_create_vlan(struct batadv_priv *bat_priv,
    unsigned short vid) {
  struct batadv_softif_vlan *vlan;
...
static void batadv_get_strings(struct net_device *dev, u32 stringset,
    u8 *data) {
