...
static void batadv_v_hardif_neigh_init(
 ...
 */
static int batadv_v_neigh_dump_neigh(struct sk_buff *msg, u32 portid, u32 seq,
    struct batadv_hardif_neigh_node *hardif_neigh) {
  void *hdr;
 ...
 * Return: Error code, or 0 on success
 */
static int batadv_v_neigh_dump_hardif(struct sk_buff *msg, u32 portid, u32 seq,
 ...
 */
static void batadv_v_neigh_dump(struct sk_buff *msg,
 ...
 * Return: Error code, or 0 on success
 */
static int batadv_v_orig_dump_subentry(struct sk_buff *msg, u32 portid, u32 seq,
    struct batadv_priv *bat_priv,
 ...
 * Return: Error code, or 0 on success
 */
static int batadv_v_orig_dump_entry(struct sk_buff *msg, u32 portid, u32 seq,
    struct batadv_priv *bat_priv,
    struct batadv_hard_iface *if_outgoing,
 ...
 * Return: Error code, or 0 on success
 */
static int batadv_v_orig_dump_bucket(struct sk_buff *msg, u32 portid, u32 seq,
    struct batadv_priv *bat_priv,
    struct batadv_hard_iface *if_outgoing,
 ...
 * @if_outgoing: Limit dump to entries with this outgoing interface
 */
static void batadv_v_orig_dump(struct sk_buff *msg, struct netlink_callback *cb,
    struct batadv_priv *bat_priv,
    struct batadv_hard_iface *if_outgoing) {
 ...
 */
static struct batadv_gw_node *batadv_v_gw_get_best_gw_node(
    struct batadv_priv *bat_priv) {
