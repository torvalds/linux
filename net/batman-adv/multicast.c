...
#else
static inline u8 batadv_mcast_mla_rtr_flags_softif_get_ipv6(
 ...
 * bridge state.
 */
static struct batadv_mcast_mla_flags batadv_mcast_mla_flags_get(
 ...
 */
static int batadv_mcast_mla_softif_get_ipv4(struct net_device *dev,
    struct hlist_head *mcast_list,
...
static int batadv_mcast_mla_softif_get_ipv6(struct net_device *dev,
    struct hlist_head *mcast_list,
    struct batadv_mcast_mla_flags *flags) {
  struct batadv_hw_addr *new;
...
#else
static inline int batadv_mcast_mla_softif_get_ipv6(struct net_device *dev,
    struct hlist_head *mcast_list,
    struct batadv_mcast_mla_flags *flags) {
  return 0;
}
 ...
 * soft interface.
 */
static void batadv_mcast_querier_log(struct batadv_priv *bat_priv,
    char *str_proto,
 ...
 */
static void batadv_mcast_bridge_log(struct batadv_priv *bat_priv,
 ...
 */
static void batadv_mcast_mla_flags_update(struct batadv_priv *bat_priv,
    struct batadv_mcast_mla_flags *flags) {
 ...
 */
static enum batadv_forw_mode batadv_mcast_forw_mode_by_count(
    struct batadv_priv *bat_priv,
 ...
 */
enum batadv_forw_mode batadv_mcast_forw_mode(struct batadv_priv *bat_priv,
    struct sk_buff *skb,
 ...
 * otherwise.
 */
static int batadv_mcast_forw_tt(struct batadv_priv *bat_priv,
    struct sk_buff *skb,
    unsigned short vid) {
 ...
 * otherwise.
 */
static int batadv_mcast_forw_want_all_ipv4(struct batadv_priv *bat_priv,
    struct sk_buff *skb, unsigned short vid) {
  struct batadv_orig_node *orig_node;
  int ret = NET_XMIT_SUCCESS;
  struct sk_buff *newskb;
 ...
 * otherwise.
 */
static int batadv_mcast_forw_want_all_ipv6(struct batadv_priv *bat_priv,
    struct sk_buff *skb, unsigned short vid) {
  struct batadv_orig_node *orig_node;
  int ret = NET_XMIT_SUCCESS;
  struct sk_buff *newskb;
 ...
 */
static int batadv_mcast_forw_want_all(struct batadv_priv *bat_priv,
    struct sk_buff *skb, unsigned short vid) {
 ...
 * otherwise.
 */
static int batadv_mcast_forw_want_all_rtr4(struct batadv_priv *bat_priv,
    struct sk_buff *skb, unsigned short vid) {
  struct batadv_orig_node *orig_node;
  int ret = NET_XMIT_SUCCESS;
  struct sk_buff *newskb;
 ...
 * otherwise.
 */
static int batadv_mcast_forw_want_all_rtr6(struct batadv_priv *bat_priv,
    struct sk_buff *skb, unsigned short vid) {
  struct batadv_orig_node *orig_node;
  int ret = NET_XMIT_SUCCESS;
  struct sk_buff *newskb;
 ...
 * is neither IPv4 nor IPv6. NET_XMIT_SUCCESS otherwise.
 */
static int batadv_mcast_forw_want_rtr(struct batadv_priv *bat_priv,
    struct sk_buff *skb, unsigned short vid) {
  switch (ntohs(eth_hdr(skb)->h_proto)) {
    case ETH_P_IP:
 ...
 */
static u8 batadv_mcast_tvlv_flags_get(bool enabled, void *tvlv_value,
    u16 tvlv_value_len) {
 ...
 * Return: 0 or error code.
 */
static int batadv_mcast_flags_dump_entry(struct sk_buff *msg, u32 portid,
 ...
 * Return: 0 or error code.
 */
static int batadv_mcast_flags_dump_bucket(struct sk_buff *msg, u32 portid,
    struct netlink_callback *cb,
 ...
 * Return: 0 or error code.
 */
static int __batadv_mcast_flags_dump(struct sk_buff *msg, u32 portid,
    struct netlink_callback *cb,
 ...
 * Return: 0 or error code.
 */
static int batadv_mcast_netlink_get_primary(struct netlink_callback *cb,
