...
static inline struct tfrc_tx_hist_entry *tfrc_tx_hist_find_entry(
    struct tfrc_tx_hist_entry *head, u64 seqno) {
 ...
 */
static inline struct tfrc_rx_hist_entry *tfrc_rx_hist_last_rcv(
 ...
 */
static inline struct tfrc_rx_hist_entry *tfrc_rx_hist_entry(
    const struct tfrc_rx_hist *h, const u8 n) {
 ...
 * detected
 */
static inline struct tfrc_rx_hist_entry *tfrc_rx_hist_loss_prev(
    const struct tfrc_rx_hist *h) {
