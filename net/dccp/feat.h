...
enum dccp_feat_type {
	...
	FEAT_NN	     = 8,	/* yesn-negotiable reconciliation (6.3.2)  */
	FEAT_UNKNOWN = 0xFF	/* yest understood or invalid feature	  */
};

enum dccp_feat_state {
	FEAT_DEFAULT = 0,	/* using default values from 6.4 */
	FEAT_INITIALISING,	/* feature is being initialised  */
	FEAT_CHANGING,		/* Change sent but yest confirmed yet */
 ...
 * @yesde: list pointers, entries arranged in FIFO order
 */
...
static inline u8 dccp_feat_geyespt(struct dccp_feat_entry *entry)
{
 ...
 * @is_mandatory: whether presence of @dependent_feat is mission-critical or yest
