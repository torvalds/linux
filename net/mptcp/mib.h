...
enum linux_mptcp_mib_field {
  ...
  MPTCP_MIB_DSSTCPMISMATCH, /* DSS-mapping did not map with TCP's sequence
                             * numbers */
  ...
  MPTCP_MIB_JOINPORTSYNRX,  /* Received a SYN MP_JOIN with a different
                             * port-number */
  MPTCP_MIB_JOINPORTSYNACKRX, /* Received a SYNACK MP_JOIN with a different
                               * port-number */
  MPTCP_MIB_JOINPORTACKRX,  /* Received an ACK MP_JOIN with a different
                             * port-number */
  MPTCP_MIB_MISMATCHPORTSYNRX,  /* Received a SYN MP_JOIN with a mismatched
                                 * port-number */
  MPTCP_MIB_MISMATCHPORTACKRX,  /* Received an ACK MP_JOIN with a mismatched
                                 * port-number */
  ...
  MPTCP_MIB_SUBFLOWRECOVER, /* Subflows returned to active status after being
                             * stale */
  ...
  MPTCP_MIB_RCVWNDCONFLICTUPDATE, /* subflow rcv wnd is overridden by msk's one
                                   * due to
                                   * conflict with another subflow while
                                   * updating msk rcv wnd
                                   */
