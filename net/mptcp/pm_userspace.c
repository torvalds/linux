...
static int mptcp_userspace_pm_delete_local_addr(struct mptcp_sock *msk,
  ...
  struct mptcp_pm_addr_entry *entry, *tmp;
  list_for_each_entry_safe(entry, tmp, &msk->pm.userspace_pm_local_addr_list,
      list) {
...
static struct mptcp_pm_addr_entry *mptcp_userspace_pm_lookup_addr_by_id(
    struct mptcp_sock *msk, unsigned int id) {
  struct mptcp_pm_addr_entry *entry;
...
int mptcp_userspace_pm_set_flags(struct sk_buff *skb, struct genl_info *info) {
  ...
  struct mptcp_pm_addr_entry rem = {
    .addr = { .family = AF_UNSPEC },
  };
