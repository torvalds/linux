...
static struct sdw_intel_link_dev *intel_link_dev_register(
...
*sdw_intel_probe_controller(struct sdw_intel_res *res) {
   ...
   * as part of the first loop below and released with the
   *auxiliary_device_uninit().
   * If some links are disabled, the link pointer will remain NULL. Given that
   *the
   * number of links is small, this is simpler than using a list to keep track
   *of links.
   */
