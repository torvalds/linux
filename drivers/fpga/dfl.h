...
#define DFHv1_CSR_SIZE_GRP_INSTANCE_ID  GENMASK_ULL(15, 0)  /* Enumeration
                                                             * instantiated IP
                                                             * */
#define DFHv1_CSR_SIZE_GRP_GROUPING_ID  GENMASK_ULL(30, 16) /* Group
                                                             * Features/interfaces
                                                             * */
#define DFHv1_CSR_SIZE_GRP_HAS_PARAMS BIT_ULL(31)   /* Presence of Parameters */
#define DFHv1_CSR_SIZE_GRP_SIZE   GENMASK_ULL(63, 32) /* Size of CSR Block in
                                                       * bytes */
...
struct dfl_fpga_cdev *dfl_fpga_feature_devs_enumerate(
 ...
 * functions.
 */
struct platform_device *__dfl_fpga_cdev_find_port(struct dfl_fpga_cdev *cdev,
    void *data,
    int (*match)(struct platform_device *, void *));

static inline struct platform_device *dfl_fpga_cdev_find_port(
    struct dfl_fpga_cdev *cdev, void *data,
    int (*match)(struct platform_device *, void *)) {
