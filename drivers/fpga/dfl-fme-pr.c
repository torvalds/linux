...
static struct dfl_fme_region *dfl_fme_region_find_by_port_id(
    struct dfl_fme *fme, int port_id) {
...
static struct fpga_region *dfl_fme_region_find(struct dfl_fme *fme,
    int port_id) {
  struct dfl_fme_region *fme_region;
 ...
 */
static struct platform_device *dfl_fme_create_mgr(
 ...
 */
static struct dfl_fme_bridge *dfl_fme_create_bridge(
    struct dfl_feature_platform_data *pdata, int port_id) {
 ...
 */
static struct dfl_fme_region *dfl_fme_create_region(
    struct dfl_feature_platform_data *pdata,
