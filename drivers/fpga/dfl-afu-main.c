...
static ssize_t ltr_show(struct device *dev, struct device_attribute *attr,
    char *buf) {
...
static ssize_t ltr_store(struct device *dev, struct device_attribute *attr,
...
static ssize_t ap1_event_show(struct device *dev, struct device_attribute *attr,
    char *buf) {
  struct dfl_feature_platform_data *pdata = dev_get_platdata(dev);
  void __iomem *base;
  u64 v;
...
static ssize_t ap1_event_store(struct device *dev,
...
static ssize_t ap2_event_show(struct device *dev, struct device_attribute *attr,
    char *buf) {
  struct dfl_feature_platform_data *pdata = dev_get_platdata(dev);
  void __iomem *base;
  u64 v;
...
static ssize_t ap2_event_store(struct device *dev,
    struct device_attribute *attr,
    const char *buf, size_t count) {
  struct dfl_feature_platform_data *pdata = dev_get_platdata(dev);
  void __iomem *base;
...
static ssize_t userclk_freqcmd_store(struct device *dev,
    struct device_attribute *attr,
    const char *buf, size_t count) {
  struct dfl_feature_platform_data *pdata = dev_get_platdata(dev);
...
static ssize_t userclk_freqcntrcmd_store(struct device *dev,
    struct device_attribute *attr,
    const char *buf, size_t count) {
  struct dfl_feature_platform_data *pdata = dev_get_platdata(dev);
...
static ssize_t userclk_freqsts_show(struct device *dev,
    struct device_attribute *attr,
    char *buf) {
  struct dfl_feature_platform_data *pdata = dev_get_platdata(dev);
  u64 userclk_freqsts;
...
static ssize_t userclk_freqcntrsts_show(struct device *dev,
    struct device_attribute *attr,
    char *buf) {
  struct dfl_feature_platform_data *pdata = dev_get_platdata(dev);
...
static long port_hdr_ioctl(struct platform_device *pdev,
    struct dfl_feature *feature,
...
static ssize_t afu_id_show(struct device *dev, struct device_attribute *attr,
    char *buf) {
  struct dfl_feature_platform_data *pdata = dev_get_platdata(dev);
  void __iomem *base;
  u64 guidl, guidh;
...
static long port_uint_ioctl(struct platform_device *pdev,
    struct dfl_feature *feature,
    unsigned int cmd, unsigned long arg) {
  switch (cmd) {
...
static long afu_ioctl_get_info(struct dfl_feature_platform_data *pdata,
    void __user *arg) {
...
static long afu_ioctl_dma_map(struct dfl_feature_platform_data *pdata,
    void __user *arg) {
...
static long afu_ioctl_dma_unmap(struct dfl_feature_platform_data *pdata,
    void __user *arg) {
