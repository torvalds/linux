...
struct dfl_afu_dma_region *afu_dma_region_find(
    struct dfl_feature_platform_data *pdata, u64 iova, u64 size) {
  struct dfl_afu *afu = dfl_fpga_pdata_get_private(pdata);
 ...
 * Needs to be called with pdata->lock held.
 */
static struct dfl_afu_dma_region *afu_dma_region_find_iova(
    struct dfl_feature_platform_data *pdata, u64 iova) {
