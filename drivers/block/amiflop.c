...
static unsigned long int fd_def_df0 = FD_DD_3;     /* default for df0 if it
                                                    * doesn't identify */
...
static int raw_write(int drive) {
  ...
  custom.dskptr = (u_char *) ZTWO_PADDR((u_char *) raw_buf);
  custom.dsklen = unit[drive].type->write_size / sizeof(short) | DSKLEN_DMAEN
      | DSKLEN_WRITE;
  custom.dsklen = unit[drive].type->write_size / sizeof(short) | DSKLEN_DMAEN
      | DSKLEN_WRITE;
  block_flag = 2;
...
static int amiga_read(int drive) {
  ...
  for (scnt = 0; scnt < unit[drive].dtype->sects * unit[drive].type->sect_mult;
      scnt++) {
...
static void amiga_write(int disk) {
  ...
  /* sectors */
  for (cnt = 0; cnt < unit[disk].dtype->sects * unit[disk].type->sect_mult;
      cnt++) {
...
static ushort dos_crc(void *data_a3, int data_d0, int data_d1, int data_d3) {
  static unsigned char CRCTable1[] = {
    ...
    ,
  ...
  static unsigned char CRCTable2[] = {
    ...
    
  };
  /* look at the asm-code - what looks in C a bit strange is almost as good as
   * handmade */
  register int i;
...
static unsigned long dos_decode(unsigned char *data, unsigned short *raw,
    int len) {
  int i;
  for (i = 0; i < len; i++) {
...
static int dos_read(int drive) {
  ...
  for (scnt = 0; scnt < unit[drive].dtype->sects * unit[drive].type->sect_mult;
    ...
    raw
      = dos_decode(
        (unsigned char *) (unit[drive].trackbuf + (hdr.sec - 1) * 512),
        (ushort *) raw, 512);
 ...
 */
static unsigned amiga_check_events(struct gendisk *disk,
