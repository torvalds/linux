...
static inline struct virtio_blk_vq *get_virtio_blk_vq(
...
static int virtblk_setup_discard_write_zeroes_erase(struct request *req,
    bool unmap) {
...
static int virtblk_read_limits(struct virtio_blk *vblk,
   ...
   *
   * discard sector alignment is set to the minimum between
