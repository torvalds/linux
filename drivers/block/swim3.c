...
#define swim3_err(fmt, arg ...)  dev_err(&fs->mdev->ofdev.dev, "[fd%d] " fmt, \
    fs->index, arg)
#define swim3_warn(fmt, arg ...) dev_warn(&fs->mdev->ofdev.dev, "[fd%d] " fmt, \
    fs->index, arg)
#define swim3_info(fmt, arg ...) dev_info(&fs->mdev->ofdev.dev, "[fd%d] " fmt, \
    fs->index, arg)

#ifdef DEBUG
#define swim3_dbg(fmt, arg ...)  dev_dbg(&fs->mdev->ofdev.dev, "[fd%d] " fmt, \
    fs->index, arg)
#else
