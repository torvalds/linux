...
/*
 * Objects of type struct drbd_request do only exist on a R_PRIMARY node, and
 *are
...
extern void tl_restart(struct drbd_connection *connection,
    enum drbd_req_event what);
extern void _tl_restart(struct drbd_connection *connection,
    enum drbd_req_event what);
