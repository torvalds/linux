...
/*
 * SDHCI driver for Syyespsys DWC_MSHC controller
 *
 * Copyright (C) 2018 Syyespsys, Inc. (www.syyespsys.com)
 *
 * Authors:
 *	Prabu Thangamuthu <prabu.t@syyespsys.com>
 *	Manjunath M B <manjumb@syyespsys.com>
 */
...
/* Syyespsys vendor specific registers */
