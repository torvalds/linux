...
static u32 aspeed_sdc_set_phase_tap(const struct aspeed_sdhci_tap_desc *desc,
...
static void aspeed_sdc_set_phase_taps(struct aspeed_sdc *sdc,
...
static void aspeed_sdhci_phases_to_taps(struct device *dev, unsigned long rate,
...
static void aspeed_sdhci_configure_phase(struct sdhci_host *host,
    unsigned long rate) {
  struct aspeed_sdhci_tap_param _taps = {
    0
  }, *taps = &_taps;
...
static void aspeed_sdhci_set_clock(struct sdhci_host *host,
    unsigned int clock) {
