...
static ssize_t omap_hsmmc_show_slot_name(struct device *dev,
 ...
 */
static void omap_hsmmc_start_command(struct omap_hsmmc_host *host,
    struct mmc_command *cmd,
    struct mmc_data *data) {
 ...
 */
static void omap_hsmmc_xfer_done(struct omap_hsmmc_host *host,
    struct mmc_data *data) {
  if (!data) {
 ...
 */
static void omap_hsmmc_cmd_done(struct omap_hsmmc_host *host,
    struct mmc_command *cmd) {
...
static void omap_hsmmc_dbg_report_irq(struct omap_hsmmc_host *host,
    u32 status) {
 ...
 */
static int omap_hsmmc_prepare_data(struct omap_hsmmc_host *host,
    struct mmc_request *req) {
  int ret;
...
static const struct dev_pm_ops omap_hsmmc_dev_pm_ops = {
  ...
  SET_RUNTIME_PM_OPS(omap_hsmmc_runtime_suspend, omap_hsmmc_runtime_resume,
      NULL)
};
