...
#define USDHI6_SD_INFO1_CARD_INSERT (USDHI6_SD_INFO1_CARD_IN \
  | USDHI6_SD_INFO1_D3_CARD_IN)
#define USDHI6_SD_INFO1_CARD_EJECT (USDHI6_SD_INFO1_CARD_OUT \
  | USDHI6_SD_INFO1_D3_CARD_OUT)
#define USDHI6_SD_INFO1_CARD (USDHI6_SD_INFO1_CARD_INSERT \
  | USDHI6_SD_INFO1_CARD_EJECT)
#define USDHI6_SD_INFO1_CARD_CD (USDHI6_SD_INFO1_CARD_IN \
...
#define USDHI6_SD_INFO1_IRQ (USDHI6_SD_INFO1_RSP_END \
...
static int usdhi6_reset(struct usdhi6_host *host) {
  ...
  cpu_relax();
  usdhi6_write(host, USDHI6_SOFT_RST,
      USDHI6_SOFT_RST_RESERVED | USDHI6_SOFT_RST_RESET);
  for (i = 1000; i; i--) {
