...
static void vub300_delete(struct kref *kref) { /* kref callback - softirq */
 ...
 */
static void vub300_pollwork_thread(struct work_struct *work) { /* NOT irq */
...
static void vub300_deadwork_thread(struct work_struct *work) { /* NOT irq */
...
static int vub300_probe(struct usb_interface *interface,
    const struct usb_device_id *id) { /* NOT irq */
  struct vub300_mmc_host *vub300;
...
static void vub300_disconnect(struct usb_interface *interface) { /* NOT irq */
...
#endif
static int vub300_pre_reset(struct usb_interface *intf) { /* NOT irq */
  struct vub300_mmc_host *vub300 = usb_get_intfdata(intf);
  mutex_lock(&vub300->cmd_mutex);
  return 0;
}

static int vub300_post_reset(struct usb_interface *intf) { /* NOT irq */
  struct vub300_mmc_host *vub300 = usb_get_intfdata(intf);
...
static int __init vub300_init(void) { /* NOT irq */
  int result;
