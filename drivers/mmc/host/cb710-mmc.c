...
static int cb710_mmc_receive_pio(struct cb710_slot *slot,
  ...
  if (!(cb710_read_port_8(slot,
      CB710_MMC_STATUS2_PORT) & CB710_MMC_S2_FIFO_READY)) {
...
static u16 cb710_encode_cmd_flags(struct cb710_mmc_reader *reader,
  ...
  switch (flags & MMC_CMD_MASK) {
    case MMC_CMD_AC:
      cb_flags = CB710_MMC_CMD_AC;
      break;
    case MMC_CMD_ADTC:
      cb_flags = CB710_MMC_CMD_ADTC;
      break;
    case MMC_CMD_BC:
      cb_flags = CB710_MMC_CMD_BC;
      break;
    case MMC_CMD_BCR:
      cb_flags = CB710_MMC_CMD_BCR;
      break;
  }
