...
static const struct soc_device_attribute sdhi_quirks_match[] = {
  ...
  { .soc_id = "r8a7796", .revision = "ES1.0",
    .data = &sdhi_quirks_4tap_nohs400_one_rx },
  { .soc_id = "r8a7796", .revision = "ES1.[12]",
    .data = &sdhi_quirks_4tap_nohs400 },
...
static const struct renesas_sdhi_of_data_with_quirks
    of_rcar_gen3_nohs400_compatible = {
  .of_data = &of_data_rcar_gen3,
  .quirks = &sdhi_quirks_nohs400,
};
...
static const struct of_device_id renesas_sdhi_internal_dmac_of_match[] = {
  ...
  { .compatible = "renesas,sdhi-r8a77995",
    .data = &of_rcar_gen3_nohs400_compatible, },
...
static void renesas_sdhi_internal_dmac_enable_dma(struct tmio_mmc_host *host,
    bool enable) {
...
static void renesas_sdhi_internal_dmac_abort_dma(struct tmio_mmc_host *host) {
...
static void renesas_sdhi_internal_dmac_dataend_dma(struct tmio_mmc_host *host) {
  struct renesas_sdhi *priv = host_to_priv(host);
  struct renesas_sdhi_dma *dma_priv = &priv->dma_priv;
 ...
 */
static void renesas_sdhi_internal_dmac_unmap(struct tmio_mmc_host *host,
...
static bool renesas_sdhi_internal_dmac_map(struct tmio_mmc_host *host,
    struct mmc_data *data,
    enum renesas_sdhi_dma_cookie cookie) {
...
static void renesas_sdhi_internal_dmac_start_dma(struct tmio_mmc_host *host,
    struct mmc_data *data) {
  struct renesas_sdhi *priv = host_to_priv(host);
...
static void renesas_sdhi_internal_dmac_request_dma(struct tmio_mmc_host *host,
...
static void renesas_sdhi_internal_dmac_release_dma(struct tmio_mmc_host *host) {
