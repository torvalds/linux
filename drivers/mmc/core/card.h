...
static inline void __maybe_unused remove_quirk(struct mmc_card *card,
    int data) {
  card->quirks &= ~data;
}
 ...
 */
static inline void __maybe_unused add_quirk_mmc(struct mmc_card *card,
    int data) {
 ...
 */
static inline void __maybe_unused add_quirk_sd(struct mmc_card *card,
    int data) {
  if (mmc_card_sd(card)) {
    card->quirks |= data;
  }
