...
static inline void snic_icmnd_init(struct snic_host_req *req, u32 cmnd_id,
    u32 host_id, u64 ctx,
...
static inline void snic_itmf_init(struct snic_host_req *req, u32 cmnd_id,
    u32 host_id, ulong ctx,
...
static inline void snic_queue_wq_eth_desc(struct vnic_wq *wq,
    void *os_buf,
    dma_addr_t dma_addr,
    unsigned int len,
    int vlan_tag_insert,
