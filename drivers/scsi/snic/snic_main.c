 ...
 */
static int snic_dev_wait(struct vnic_dev *vdev,
 ...
 */
static int snic_probe(struct pci_dev *pdev, const struct pci_device_id *ent) {
...
static int __init snic_init_module(void) {
  int ret = 0;
#ifndef __x86_64__
...
static void __exit snic_cleanup_module(void) {
