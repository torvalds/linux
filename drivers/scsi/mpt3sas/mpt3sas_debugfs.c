...
static ssize_t _debugfs_iocdump_read(struct file *filp, char __user *ubuf,
    size_t cnt,
    loff_t *ppos) {
 ...
 */
static int _debugfs_iocdump_open(struct inode *inode, struct file *file) {
 ...
 * @file: File pointer
 */
static int _debugfs_iocdump_release(struct inode *inode, struct file *file) {
