...
typedef struct _MPI26_CONFIG_PAGE_DRIVER_TRIGGER_1 {
  ...
  U16 Reserved0xA;    /* 0x0A */
  MPI26_DRIVER_MASTER_TRIGGER_ENTRY MasterTriggers[MPI26_MAX_MASTER_TRIGGERS];  /*
                                                                                 *
                                                                                 *0x0C
                                                                                 *
                                                                                 **/
...
typedef struct _MPI26_CONFIG_PAGE_DRIVER_TRIGGER_2 {
  ...
  U16 Reserved0xA;    /* 0x0A */
  MPI26_DRIVER_MPI_EVENT_TRIGGER_ENTRY MPIEventTriggers[
    MPI26_MAX_MPI_EVENT_TRIGGERS]; /* 0x0C */
...
typedef struct _MPI26_CONFIG_PAGE_DRIVER_TRIGGER_3 {
  ...
  U16 Reserved0xA;        /* 0x0A */
  MPI26_DRIVER_SCSI_SENSE_TRIGGER_ENTRY SCSISenseTriggers[
    MPI26_MAX_SCSI_SENSE_TRIGGERS]; /* 0x0C */
...
typedef struct _MPI26_CONFIG_PAGE_DRIVER_TRIGGER_4 {
  ...
  U16 Reserved0xA;        /* 0x0A */
  MPI26_DRIVER_IOCSTATUS_LOGINFO_TRIGGER_ENTRY IOCStatusLoginfoTriggers[
    MPI26_MAX_LOGINFO_TRIGGERS];  /* 0x0C */
