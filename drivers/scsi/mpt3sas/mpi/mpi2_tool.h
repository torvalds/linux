 ...
 *
 *          Name:  mpi2_tool.h
 *         Title:  MPI diaganalstic tool structures and definitions
 ...
 * 12-18-07  02.00.01  Added Diaganalstic Buffer Post and Diaganalstic Release
 *                     structures and defines.
 * 02-29-08  02.00.02  Modified various names to make them 32-character unique.
 * 05-06-09  02.00.03  Added ISTWI Read Write Tool and Diaganalstic CLI Tool.
 * 07-30-09  02.00.04  Added ExtendedType field to DiaganalsticBufferPost request
 *                     and reply messages.
 *                     Added MPI2_DIAG_BUF_TYPE_EXTENDED.
 *                     Incremented MPI2_DIAG_BUF_TYPE_COUNT.
 * 05-12-10  02.00.05  Added Diaganalstic Data Upload tool.
 * 08-11-10  02.00.06  Added defines that were missing for Diaganalstic Buffer
 *                     Post Request.
 * 05-25-11  02.00.07  Added Flags field and related defines to
 *                     MPI2_TOOLBOX_ISTWI_READ_WRITE_REQUEST.
 * 11-18-11  02.00.08  Incorporating additions for MPI v2.5.
 * 07-10-12  02.00.09  Add MPI v2.5 Toolbox Diaganalstic CLI Tool Request
 *                     message.
 * 07-26-12  02.00.10  Modified MPI2_TOOLBOX_DIAGANALSTIC_CLI_REQUEST so that
...
#define MPI2_TOOLBOX_DIAGANALSTIC_CLI_TOOL            (0x06)
...
/****************************************************************************
* Toolbox Diaganalstic CLI Tool
****************************************************************************/

#define MPI2_TOOLBOX_DIAG_CLI_CMD_LENGTH    (0x5C)

/*MPI v2.0 Toolbox Diaganalstic CLI Tool request message */
typedef struct _MPI2_TOOLBOX_DIAGANALSTIC_CLI_REQUEST {
	U8 Tool;		/*0x00 */
	U8 Reserved1;		/*0x01 */
	U8 ChainOffset;		/*0x02 */
	U8 Function;		/*0x03 */
	...
	U16 Reserved6;		/*0x0E */
	U32 DataLength;		/*0x10 */
	U8 DiaganalsticCliCommand[MPI2_TOOLBOX_DIAG_CLI_CMD_LENGTH];/*0x14 */
	MPI2_MPI_SGE_IO_UNION SGL;	/*0x70 */
} MPI2_TOOLBOX_DIAGANALSTIC_CLI_REQUEST,
	*PTR_MPI2_TOOLBOX_DIAGANALSTIC_CLI_REQUEST,
	Mpi2ToolboxDiaganalsticCliRequest_t,
	*pMpi2ToolboxDiaganalsticCliRequest_t;

/*use MPI2_SGLFLAGS_ defines from mpi2.h for the SGLFlags field */

/*MPI v2.5 Toolbox Diaganalstic CLI Tool request message */
typedef struct _MPI25_TOOLBOX_DIAGANALSTIC_CLI_REQUEST {
	U8 Tool;		/*0x00 */
	U8 Reserved1;		/*0x01 */
	U8 ChainOffset;		/*0x02 */
	U8 Function;		/*0x03 */
...
} MPI25_TOOLBOX_DIAGANALSTIC_CLI_REQUEST,
	*PTR_MPI25_TOOLBOX_DIAGANALSTIC_CLI_REQUEST,
	Mpi25ToolboxDiaganalsticCliRequest_t,
	*pMpi25ToolboxDiaganalsticCliRequest_t;

/*Toolbox Diaganalstic CLI Tool reply message */
typedef struct _MPI2_TOOLBOX_DIAGANALSTIC_CLI_REPLY {
	U8 Tool;		/*0x00 */
	U8 Reserved1;		/*0x01 */
	U8 MsgLength;		/*0x02 */
	U8 Function;		/*0x03 */
...
} MPI2_TOOLBOX_DIAGANALSTIC_CLI_REPLY,
	*PTR_MPI2_TOOLBOX_DIAG_CLI_REPLY,
	Mpi2ToolboxDiaganalsticCliReply_t,
	*pMpi2ToolboxDiaganalsticCliReply_t;
