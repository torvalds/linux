...
static inline void qla27xx_insert16(uint16_t value, void *buf, ulong *len) {
  if (buf) {
    buf += *len;
...
static inline void qla27xx_insert32(uint32_t value, void *buf, ulong *len) {
  if (buf) {
    buf += *len;
...
static inline void qla27xx_insertbuf(void *mem, ulong size, void *buf,
    ulong *len) {
  if (buf && mem && size) {
    buf += *len;
    memcpy(buf, mem, size);
...
static inline void qla27xx_read8(void __iomem *window, void *buf, ulong *len) {
  uint8_t value = ~0;
  if (buf) {
...
static inline void qla27xx_read16(void __iomem *window, void *buf, ulong *len) {
  uint16_t value = ~0;
  if (buf) {
...
static inline void qla27xx_read32(void __iomem *window, void *buf, ulong *len) {
  uint32_t value = ~0;
  if (buf) {
...
static inline void(*qla27xx_read_vector(uint width)) (void __iomem *, void *,
    ulong *)
{
  return
...
static inline void qla27xx_read_reg(__iomem struct device_reg_24xx *reg,
    uint offset, void *buf, ulong *len) {
  void __iomem *window = (void __iomem *) reg + offset;
  qla27xx_read32(window, buf, len);
}

static inline void qla27xx_write_reg(__iomem struct device_reg_24xx *reg,
...
static inline void qla27xx_read_window(__iomem struct device_reg_24xx *reg,
...
static inline void qla27xx_skip_entry(struct qla27xx_fwdt_entry *ent,
    void *buf) {
  if (buf) {
...
static inline struct qla27xx_fwdt_entry *qla27xx_next_entry(
    struct qla27xx_fwdt_entry *ent) {
  return (void *) ent + le32_to_cpu(ent->hdr.size);
}

static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t0(
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t255(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t256(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t257(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t258(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t259(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t260(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t261(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t262(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t263(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t264(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t265(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t266(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t267(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t268(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t269(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t270(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t271(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t272(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t273(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t274(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t275(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t276(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t277(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_t278(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static struct qla27xx_fwdt_entry *qla27xx_fwdt_entry_other(
    struct scsi_qla_host *vha,
    struct qla27xx_fwdt_entry *ent, void *buf, ulong *len) {
...
static void qla27xx_walk_template(struct scsi_qla_host *vha,
...
static void qla27xx_firmware_info(struct scsi_qla_host *vha,
...
static void ql27xx_edit_template(struct scsi_qla_host *vha,
    struct qla27xx_fwdt_template *tmp) {
...
static inline uint32_t qla27xx_template_checksum(void *p, ulong size) {
  __le32 *buf = p;
  uint64_t sum = 0;
  size /= sizeof(*buf);
  for ( ; size--; buf++) {
...
static inline int qla27xx_verify_template_checksum(
    struct qla27xx_fwdt_template *tmp) {
  return qla27xx_template_checksum(tmp,
      le32_to_cpu(tmp->template_size)) == 0;
}

static inline int qla27xx_verify_template_header(
    struct qla27xx_fwdt_template *tmp) {
  return le32_to_cpu(tmp->template_type) == TEMPLATE_TYPE_FWDUMP;
}

static ulong qla27xx_execute_fwdt_template(struct scsi_qla_host *vha,
...
ulong qla27xx_fwdt_calculate_dump_size(struct scsi_qla_host *vha, void *p) {
...
void qla27xx_mpi_fwdump(scsi_qla_host_t *vha, int hardware_locked) {
  ulong flags = 0;
  if (!hardware_locked) {
