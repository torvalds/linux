...
int qla2x00_load_ram(scsi_qla_host_t *vha, dma_addr_t req_dma,
    uint32_t risc_addr,
...
int qla_get_exlogin_status(scsi_qla_host_t *vha, uint16_t *buf_sz,
...
int qla_set_exlogin_mem_cfg(scsi_qla_host_t *vha, dma_addr_t phys_addr) {
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
  struct qla_hw_data *ha = vha->hw;
...
int qla_get_exchoffld_status(scsi_qla_host_t *vha, uint16_t *buf_sz,
    uint16_t *ex_logins_cnt) {
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
...
int qla_set_exchoffld_mem_cfg(scsi_qla_host_t *vha) {
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
  struct qla_hw_data *ha = vha->hw;
 ...
 *  Kernel context.
 */
int qla2x00_issue_iocb_timeout(scsi_qla_host_t *vha, void *buffer,
 ...
 *  Kernel context.
 */
int qla2x00_get_retry_cnt(scsi_qla_host_t *vha, uint8_t *retry_cnt,
    uint8_t *tov,
    uint16_t *r_a_tov) {
  int rval;
  uint16_t ratov;
 ...
 *  Kernel context.
 */
int qla2x00_get_port_database(scsi_qla_host_t *vha, fc_port_t *fcport,
    uint8_t opt) {
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
...
int qla24xx_get_port_database(scsi_qla_host_t *vha, u16 nport_handle,
 ...
 *  Kernel context.
 */
int qla2x00_send_sns(scsi_qla_host_t *vha, dma_addr_t sns_phys_address,
 ...
 *
 */
int qla2x00_login_local_device(scsi_qla_host_t *vha, fc_port_t *fcport,
...
int qla24xx_fabric_logout(scsi_qla_host_t *vha, uint16_t loop_id,
    uint8_t domain,
 ...
 *  Kernel context.
 */
int qla2x00_fabric_logout(scsi_qla_host_t *vha, uint16_t loop_id,
    uint8_t domain,
    uint8_t area, uint8_t al_pa) {
  int rval;
  mbx_cmd_t mc;
 ...
 *  Kernel context.
 */
int qla2x00_get_id_list(scsi_qla_host_t *vha, void *id_list,
 ...
 *  Kernel context.
 */
int qla2x00_get_resource_cnts(scsi_qla_host_t *vha) {
  struct qla_hw_data *ha = vha->hw;
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
 ...
 *  BIT_1 = mailbox error.
 */
int qla2x00_get_link_status(scsi_qla_host_t *vha, uint16_t loop_id,
...
int qla24xx_get_isp_stats(scsi_qla_host_t *vha, struct link_statistics *stats,
...
static int __qla24xx_issue_tmf(char *name, uint32_t type,
...
int qla2x00_write_serdes_word(scsi_qla_host_t *vha, uint16_t addr,
    uint16_t data) {
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
...
int qla2x00_read_serdes_word(scsi_qla_host_t *vha, uint16_t addr,
    uint16_t *data) {
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
...
int qla8044_write_serdes_word(scsi_qla_host_t *vha, uint32_t addr,
    uint32_t data) {
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
...
int qla8044_read_serdes_word(scsi_qla_host_t *vha, uint32_t addr,
    uint32_t *data) {
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
 ...
 * Returns
 */
int qla2x00_set_serdes_params(scsi_qla_host_t *vha, uint16_t sw_em_1g,
...
int qla2x00_enable_eft_trace(scsi_qla_host_t *vha, dma_addr_t eft_dma,
    uint16_t buffers) {
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
...
int qla2x00_enable_fce_trace(scsi_qla_host_t *vha, dma_addr_t fce_dma,
  ...
  mcp->out_mb = MBX_10 | MBX_9 | MBX_8 | MBX_7 | MBX_6 | MBX_5 | MBX_4 | MBX_3
      | MBX_2
      | MBX_1 | MBX_0;
  mcp->in_mb = MBX_6 | MBX_5 | MBX_4 | MBX_3 | MBX_2 | MBX_1 | MBX_0;
  mcp->tov = MBX_TOV_SECONDS;
...
int qla2x00_disable_fce_trace(scsi_qla_host_t *vha, uint64_t *wr,
    uint64_t *rd) {
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
...
int qla2x00_get_idma_speed(scsi_qla_host_t *vha, uint16_t loop_id,
...
int qla2x00_set_idma_speed(scsi_qla_host_t *vha, uint16_t loop_id,
    uint16_t port_speed, uint16_t *mb) {
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
...
void qla24xx_report_id_acquisition(scsi_qla_host_t *vha,
...
int qla2x00_send_change_request(scsi_qla_host_t *vha, uint16_t format,
    uint16_t vp_idx) {
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
...
int qla2x00_dump_ram(scsi_qla_host_t *vha, dma_addr_t req_dma, uint32_t addr,
    uint32_t size) {
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
...
int qla25xx_init_req_que(struct scsi_qla_host *vha, struct req_que *req) {
  ...
  mcp->out_mb = MBX_14 | MBX_13 | MBX_12 | MBX_11 | MBX_10 | MBX_9 | MBX_8
      | MBX_7
...
int qla81xx_fac_erase_sector(scsi_qla_host_t *vha, uint32_t start,
    uint32_t finish) {
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
...
int qla81xx_fac_semaphore_access(scsi_qla_host_t *vha, int lock) {
...
int qla24xx_get_port_login_templ(scsi_qla_host_t *vha, dma_addr_t buf_dma,
...
int qla25xx_set_els_cmds_supported(scsi_qla_host_t *vha) {
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
  uint8_t *els_cmd_map;
...
int qla2x00_read_sfp(scsi_qla_host_t *vha, dma_addr_t sfp_dma, uint8_t *sfp,
  ...
  mcp->mb[9] = off;
  mcp->mb[10] = opt;
  mcp->out_mb = MBX_10 | MBX_9 | MBX_8 | MBX_7 | MBX_6 | MBX_3 | MBX_2 | MBX_1
      | MBX_0;
  mcp->in_mb = MBX_1 | MBX_0;
  mcp->tov = MBX_TOV_SECONDS;
  mcp->flags = 0;
...
int qla2x00_write_sfp(scsi_qla_host_t *vha, dma_addr_t sfp_dma, uint8_t *sfp,
    uint16_t dev, uint16_t off, uint16_t len, uint16_t opt) {
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
...
int qla2x00_get_xgmac_stats(scsi_qla_host_t *vha, dma_addr_t stats_dma,
...
int qla2x00_get_dcbx_params(scsi_qla_host_t *vha, dma_addr_t tlv_dma,
    uint16_t size) {
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
...
int qla2x00_read_ram_word(scsi_qla_host_t *vha, uint32_t risc_addr,
    uint32_t *data) {
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
...
int qla2x00_loopback_test(scsi_qla_host_t *vha, struct msg_echo_lb *mreq,
    uint16_t *mresp) {
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
  ...
  mcp->out_mb = MBX_21 | MBX_20 | MBX_19 | MBX_18 | MBX_17 | MBX_16 | MBX_15
      | MBX_14 | MBX_13 | MBX_12 | MBX_11 | MBX_10 | MBX_7 | MBX_6 | MBX_1
      | MBX_0;
  if (IS_CNA_CAPABLE(vha->hw)) {
    mcp->out_mb |= MBX_2;
  }
...
int qla2x00_echo_test(scsi_qla_host_t *vha, struct msg_echo_lb *mreq,
    uint16_t *mresp) {
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
...
int qla2x00_write_ram_word(scsi_qla_host_t *vha, uint32_t risc_addr,
    uint32_t data) {
  int rval;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
...
int qla24xx_set_fcp_prio(scsi_qla_host_t *vha, uint16_t loop_id,
    uint16_t priority,
    uint16_t *mb) {
  int rval;
  mbx_cmd_t mc;
...
int qla83xx_access_control(scsi_qla_host_t *vha, uint16_t options,
...
int qla2x00_dump_mctp_data(scsi_qla_host_t *vha, dma_addr_t req_dma,
    uint32_t addr,
    uint32_t size) {
  int rval;
  mbx_cmd_t mc;
  ...
  mcp->out_mb |= MBX_10 | MBX_8 | MBX_7 | MBX_6 | MBX_5 | MBX_4 | MBX_3
      | MBX_2 | MBX_1
      | MBX_0;
  mcp->in_mb = MBX_0;
  mcp->tov = MBX_TOV_SECONDS;
...
int qla26xx_dport_diagnostics(scsi_qla_host_t *vha,
...
int qla26xx_dport_diagnostics_v2(scsi_qla_host_t *vha,
...
int qla2x00_read_sfp_dev(struct scsi_qla_host *vha, char *buf, int count) {
  struct qla_hw_data *ha = vha->hw;
...
int qla28xx_secure_flash_update(scsi_qla_host_t *vha, uint16_t opts,
  ...
  mcp->mb[9] = sfub_len;
  mcp->out_mb
    = MBX_9 | MBX_8 | MBX_7 | MBX_6 | MBX_5 | MBX_4 | MBX_3 | MBX_2 | MBX_1
      | MBX_0;
  mcp->in_mb = MBX_2 | MBX_1 | MBX_0;
  mcp->tov = MBX_TOV_SECONDS;
  mcp->flags = 0;
...
int ql26xx_led_config(scsi_qla_host_t *vha, uint16_t options, uint16_t *led) {
  struct qla_hw_data *ha = vha->hw;
  mbx_cmd_t mc;
  mbx_cmd_t *mcp = &mc;
  int rval;
