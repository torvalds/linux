...
int qla24xx_async_yestify_ack(scsi_qla_host_t *, fc_port_t *,
...
extern int qla24xx_walk_and_build_sglist_yes_difb(struct qla_hw_data *, srb_t *,
...
extern int
qla26xx_dport_diagyesstics(scsi_qla_host_t *, void *, uint, uint);
...
extern void qla2x00_get_sym_yesde_name(scsi_qla_host_t *, uint8_t *, size_t);
...
void qlt_unkyeswn_atio_work_fn(struct work_struct *);
