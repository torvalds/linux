 ...
 **/
struct lpfc_iocbq *lpfc_prep_els_iocb(struct lpfc_vport *vport, u8 expect_rsp,
 ...
 *
 **/
static uint8_t lpfc_check_clean_addr_bit(struct lpfc_vport *vport,
    struct serv_parm *sp) {
  struct lpfc_hba *phba = vport->phba;
 ...
 **/
static int lpfc_cmpl_els_flogi_fabric(struct lpfc_vport *vport,
    struct lpfc_nodelist *ndlp,
 ...
 *   -ENXIO - Fail
 **/
static int lpfc_cmpl_els_flogi_nport(struct lpfc_vport *vport,
    struct lpfc_nodelist *ndlp,
    struct serv_parm *sp) {
  struct lpfc_hba *phba = vport->phba;
  LPFC_MBOXQ_t *mbox;
 ...
 **/
static void lpfc_cmpl_els_flogi(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_iocbq *rspiocb) {
 ...
 *
 */
static void lpfc_cmpl_els_link_down(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_iocbq *rspiocb) {
  uint32_t *pcmd;
  uint32_t cmd;
 ...
 **/
static int lpfc_issue_els_flogi(struct lpfc_vport *vport,
    struct lpfc_nodelist *ndlp,
    uint8_t retry) {
  struct lpfc_hba *phba = vport->phba;
  struct serv_parm *sp;
 ...
 **/
static struct lpfc_nodelist *lpfc_plogi_confirm_nport(struct lpfc_hba *phba,
    uint32_t *prsp,
    struct lpfc_nodelist *ndlp) {
...
static void lpfc_cmpl_els_rrq(struct lpfc_hba *phba, struct lpfc_iocbq *cmdiocb,
    struct lpfc_iocbq *rspiocb) {
  struct lpfc_vport *vport = cmdiocb->vport;
  struct lpfc_nodelist *ndlp = cmdiocb->ndlp;
 ...
 * PLOGIs.
 **/
static void lpfc_cmpl_els_plogi(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_iocbq *rspiocb) {
  struct lpfc_vport *vport = cmdiocb->vport;
  IOCB_t *irsp;
 ...
 **/
int lpfc_issue_els_plogi(struct lpfc_vport *vport, uint32_t did,
    uint8_t retry) {
  struct lpfc_hba *phba = vport->phba;
  struct serv_parm *sp;
  struct lpfc_nodelist *ndlp;
 ...
 **/
static void lpfc_cmpl_els_prli(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_iocbq *rspiocb) {
  struct lpfc_vport *vport = cmdiocb->vport;
  struct lpfc_nodelist *ndlp;
 ...
 **/
int lpfc_issue_els_prli(struct lpfc_vport *vport, struct lpfc_nodelist *ndlp,
    uint8_t retry) {
  int rc = 0;
  struct lpfc_hba *phba = vport->phba;
  PRLI *npr;
 ...
 **/
static void lpfc_rscn_disc(struct lpfc_vport *vport) {
  lpfc_can_disctmo(vport);
  /* RSCN discovery
 ...
 **/
static void lpfc_adisc_done(struct lpfc_vport *vport) {
  struct lpfc_hba *phba = vport->phba;
  /*
 ...
 **/
static void lpfc_cmpl_els_adisc(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_iocbq *rspiocb) {
  struct lpfc_vport *vport = cmdiocb->vport;
  IOCB_t *irsp;
 ...
 **/
int lpfc_issue_els_adisc(struct lpfc_vport *vport, struct lpfc_nodelist *ndlp,
    uint8_t retry) {
  int rc = 0;
  struct lpfc_hba *phba = vport->phba;
  ADISC *ap;
 ...
 **/
static void lpfc_cmpl_els_logo(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_iocbq *rspiocb) {
  struct lpfc_nodelist *ndlp = cmdiocb->ndlp;
  struct lpfc_vport *vport = ndlp->vport;
 ...
 **/
int lpfc_issue_els_logo(struct lpfc_vport *vport, struct lpfc_nodelist *ndlp,
    uint8_t retry) {
  struct lpfc_hba *phba = vport->phba;
  struct lpfc_iocbq *elsiocb;
  uint8_t *pcmd;
 ...
 * discovery process.
 **/
static void lpfc_cmpl_els_cmd(struct lpfc_hba *phba, struct lpfc_iocbq *cmdiocb,
    struct lpfc_iocbq *rspiocb) {
  struct lpfc_vport *vport = cmdiocb->vport;
 ...
 * with SLI4 first.
 **/
static int lpfc_reg_fab_ctrl_node(struct lpfc_vport *vport,
    struct lpfc_nodelist *fc_ndlp) {
  int rc = 0;
  struct lpfc_hba *phba = vport->phba;
 ...
 **/
static void lpfc_cmpl_els_disc_cmd(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_iocbq *rspiocb) {
  struct lpfc_vport *vport = cmdiocb->vport;
  IOCB_t *irsp;
 ...
 **/
static int lpfc_issue_els_farpr(struct lpfc_vport *vport, uint32_t nportid,
    uint8_t retry) {
  int rc = 0;
  struct lpfc_hba *phba = vport->phba;
  struct lpfc_iocbq *elsiocb;
 ...
 **/
static int lpfc_els_rcv_rdf(struct lpfc_vport *vport,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_nodelist *ndlp) {
  /* Send LS_ACC */
 ...
 **/
static void lpfc_least_capable_settings(struct lpfc_hba *phba,
 ...
 **/
static void lpfc_cmpl_els_edc(struct lpfc_hba *phba, struct lpfc_iocbq *cmdiocb,
    struct lpfc_iocbq *rspiocb) {
  IOCB_t *irsp_iocb;
...
static void lpfc_format_edc_lft_desc(struct lpfc_hba *phba,
    struct fc_tlv_desc *tlv) {
...
static void lpfc_format_edc_cgn_desc(struct lpfc_hba *phba,
    struct fc_tlv_desc *tlv) {
...
static bool lpfc_link_is_lds_capable(struct lpfc_hba *phba) {
 ...
 **/
void lpfc_els_retry_delay(struct timer_list *t) {
 ...
 **/
static int lpfc_els_retry(struct lpfc_hba *phba, struct lpfc_iocbq *cmdiocb,
    struct lpfc_iocbq *rspiocb) {
  struct lpfc_vport *vport = cmdiocb->vport;
 ...
 **/
static int lpfc_els_free_data(struct lpfc_hba *phba,
    struct lpfc_dmabuf *buf_ptr1) {
 ...
 *   0 - Successfully released lpfc DMA buffer (currently, always return 0)
 **/
static int lpfc_els_free_bpl(struct lpfc_hba *phba,
    struct lpfc_dmabuf *buf_ptr) {
  lpfc_mbuf_free(phba, buf_ptr->virt, buf_ptr->phys);
  kfree(buf_ptr);
  return 0;
 ...
 **/
static void lpfc_cmpl_els_logo_acc(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_iocbq *rspiocb) {
  struct lpfc_nodelist *ndlp = cmdiocb->ndlp;
  struct lpfc_vport *vport = cmdiocb->vport;
 ...
 * the IOCB.
 **/
static void lpfc_cmpl_els_rsp(struct lpfc_hba *phba, struct lpfc_iocbq *cmdiocb,
    struct lpfc_iocbq *rspiocb) {
  struct lpfc_nodelist *ndlp = cmdiocb->ndlp;
 ...
 **/
int lpfc_els_rsp_reject(struct lpfc_vport *vport, uint32_t rejectError,
    struct lpfc_iocbq *oldiocb, struct lpfc_nodelist *ndlp,
    LPFC_MBOXQ_t *mbox) {
  int rc;
  struct lpfc_hba *phba = vport->phba;
 ...
 **/
static int lpfc_issue_els_edc_rsp(struct lpfc_vport *vport,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_nodelist *ndlp) {
  struct lpfc_hba *phba = vport->phba;
  struct fc_els_edc_resp *edc_rsp;
 ...
 **/
int lpfc_els_rsp_adisc_acc(struct lpfc_vport *vport, struct lpfc_iocbq *oldiocb,
    struct lpfc_nodelist *ndlp) {
  struct lpfc_hba *phba = vport->phba;
  ADISC *ap;
  IOCB_t *icmd, *oldcmd;
 ...
 **/
int lpfc_els_rsp_prli_acc(struct lpfc_vport *vport, struct lpfc_iocbq *oldiocb,
    struct lpfc_nodelist *ndlp) {
  struct lpfc_hba *phba = vport->phba;
  PRLI *npr;
  struct lpfc_nvme_prli *npr_nvme;
 ...
 **/
static int lpfc_els_rsp_rnid_acc(struct lpfc_vport *vport, uint8_t format,
    struct lpfc_iocbq *oldiocb, struct lpfc_nodelist *ndlp) {
  struct lpfc_hba *phba = vport->phba;
  RNID *rn;
  IOCB_t *icmd, *oldcmd;
 ...
 * Return
 **/
static void lpfc_els_clear_rrq(struct lpfc_vport *vport,
 ...
 **/
static int lpfc_els_rsp_echo_acc(struct lpfc_vport *vport, uint8_t *data,
    struct lpfc_iocbq *oldiocb, struct lpfc_nodelist *ndlp) {
  struct lpfc_hba *phba = vport->phba;
  IOCB_t *icmd, *oldcmd;
  union lpfc_wqe128 *wqe;
...
static uint32_t lpfc_rdp_res_link_service(struct fc_rdp_link_service_desc *desc,
    uint32_t word0) {
...
static uint32_t lpfc_rdp_res_sfp_desc(struct fc_rdp_sfp_desc *desc,
...
static uint32_t lpfc_rdp_res_link_error(
    struct fc_rdp_link_error_status_desc *desc,
    READ_LNK_VAR *stat) {
  uint32_t type;
...
static uint32_t lpfc_rdp_res_bbc_desc(struct fc_rdp_bbc_desc *desc,
    READ_LNK_VAR *stat,
...
static uint32_t lpfc_rdp_res_oed_temp_desc(struct lpfc_hba *phba,
...
static uint32_t lpfc_rdp_res_oed_voltage_desc(struct lpfc_hba *phba,
...
static uint32_t lpfc_rdp_res_oed_txbias_desc(struct lpfc_hba *phba,
    struct fc_rdp_oed_sfp_desc *desc,
    uint8_t *page_a2) {
  uint32_t flags = 0;
  desc->tag = cpu_to_be32(RDP_OED_DESC_TAG);
...
static uint32_t lpfc_rdp_res_oed_txpower_desc(struct lpfc_hba *phba,
    struct fc_rdp_oed_sfp_desc *desc,
    uint8_t *page_a2) {
  uint32_t flags = 0;
  desc->tag = cpu_to_be32(RDP_OED_DESC_TAG);
...
static uint32_t lpfc_rdp_res_oed_rxpower_desc(struct lpfc_hba *phba,
    struct fc_rdp_oed_sfp_desc *desc,
    uint8_t *page_a2) {
  uint32_t flags = 0;
  desc->tag = cpu_to_be32(RDP_OED_DESC_TAG);
...
static uint32_t lpfc_rdp_res_opd_desc(struct fc_rdp_opd_sfp_desc *desc,
...
static uint32_t lpfc_rdp_res_fec_desc(struct fc_fec_rdp_desc *desc,
    READ_LNK_VAR *stat) {
...
static uint32_t lpfc_rdp_res_speed(struct fc_rdp_port_speed_desc *desc,
...
static uint32_t lpfc_rdp_res_diag_port_names(struct fc_rdp_port_name_desc *desc,
    struct lpfc_vport *vport) {
...
static uint32_t lpfc_rdp_res_attach_port_names(
    struct fc_rdp_port_name_desc *desc,
...
static void lpfc_els_rdp_cmpl(struct lpfc_hba *phba,
...
static int lpfc_get_rdp_info(struct lpfc_hba *phba,
    struct lpfc_rdp_context *rdp_context) {
  LPFC_MBOXQ_t *mbox = NULL;
  int rc;
  mbox = mempool_alloc(phba->mbox_mem_pool, GFP_KERNEL);
 ...
 */
static int lpfc_els_rcv_rdp(struct lpfc_vport *vport,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_nodelist *ndlp) {
  struct lpfc_hba *phba = vport->phba;
...
static void lpfc_els_lcb_rsp(struct lpfc_hba *phba, LPFC_MBOXQ_t *pmb) {
  MAILBOX_t *mb;
  IOCB_t *icmd;
  union lpfc_wqe128 *wqe;
  uint8_t *pcmd;
...
static int lpfc_sli4_set_beacon(struct lpfc_vport *vport,
    struct lpfc_lcb_context *lcb_context,
 ...
 * 1 - Sent the reject response.
 **/
static int lpfc_els_rcv_lcb(struct lpfc_vport *vport,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_nodelist *ndlp) {
  struct lpfc_hba *phba = vport->phba;
  struct lpfc_dmabuf *pcmd;
 ...
 * applications.
 */
static void lpfc_send_rscn_event(struct lpfc_vport *vport,
    struct lpfc_iocbq *cmdiocb) {
  struct lpfc_dmabuf *pcmd;
  struct Scsi_Host *shost = lpfc_shost_from_vport(vport);
 ...
 **/
static int lpfc_els_rcv_rscn(struct lpfc_vport *vport,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_nodelist *ndlp) {
  struct Scsi_Host *shost = lpfc_shost_from_vport(vport);
  struct lpfc_hba *phba = vport->phba;
 ...
 **/
static int lpfc_els_rcv_flogi(struct lpfc_vport *vport,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_nodelist *ndlp) {
  struct Scsi_Host *shost = lpfc_shost_from_vport(vport);
  struct lpfc_hba *phba = vport->phba;
 ...
 **/
static int lpfc_els_rcv_rnid(struct lpfc_vport *vport,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_nodelist *ndlp) {
  struct lpfc_dmabuf *pcmd;
  uint32_t *lp;
 ...
 **/
static int lpfc_els_rcv_echo(struct lpfc_vport *vport,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_nodelist *ndlp) {
  uint8_t *pcmd;
 ...
 **/
static int lpfc_els_rcv_lirr(struct lpfc_vport *vport,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_nodelist *ndlp) {
  struct ls_rjt stat;
 ...
 * RRQ from the target.
 **/
static void lpfc_els_rcv_rrq(struct lpfc_vport *vport,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_nodelist *ndlp) {
  lpfc_els_rsp_acc(vport, ELS_CMD_ACC, cmdiocb, ndlp, NULL);
 ...
 *
 **/
static void lpfc_els_rsp_rls_acc(struct lpfc_hba *phba, LPFC_MBOXQ_t *pmb) {
  int rc = 0;
  MAILBOX_t *mb;
  IOCB_t *icmd;
  union lpfc_wqe128 *wqe;
 ...
 **/
static int lpfc_els_rcv_rls(struct lpfc_vport *vport,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_nodelist *ndlp) {
  struct lpfc_hba *phba = vport->phba;
  LPFC_MBOXQ_t *mbox;
 ...
 **/
static int lpfc_els_rcv_rtv(struct lpfc_vport *vport,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_nodelist *ndlp) {
  int rc = 0;
  IOCB_t *icmd;
 ...
 **/
static int lpfc_issue_els_rrq(struct lpfc_vport *vport,
    struct lpfc_nodelist *ndlp,
 ...
 **/
static int lpfc_els_rsp_rpl_acc(struct lpfc_vport *vport, uint16_t cmdsize,
    struct lpfc_iocbq *oldiocb, struct lpfc_nodelist *ndlp) {
  int rc = 0;
  struct lpfc_hba *phba = vport->phba;
  IOCB_t *icmd;
 ...
 **/
static int lpfc_els_rcv_rpl(struct lpfc_vport *vport,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_nodelist *ndlp) {
  struct lpfc_dmabuf *pcmd;
  uint32_t *lp;
 ...
 **/
static int lpfc_els_rcv_farp(struct lpfc_vport *vport,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_nodelist *ndlp) {
  struct lpfc_dmabuf *pcmd;
  uint32_t *lp;
 ...
 **/
static int lpfc_els_rcv_farpr(struct lpfc_vport *vport,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_nodelist *ndlp) {
  uint32_t did;
  did = get_job_els_rsp64_did(vport->phba, cmdiocb);
 ...
 **/
static int lpfc_els_rcv_fan(struct lpfc_vport *vport,
    struct lpfc_iocbq *cmdiocb,
 ...
 *   0 - Successfully processed echo iocb (currently always return 0)
 **/
static int lpfc_els_rcv_edc(struct lpfc_vport *vport,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_nodelist *ndlp) {
  struct lpfc_hba *phba = vport->phba;
  struct fc_els_edc *edc_req;
 ...
 **/
void lpfc_els_timeout(struct timer_list *t) {
 ...
 **/
static void lpfc_send_els_event(struct lpfc_vport *vport,
    struct lpfc_nodelist *ndlp,
    uint32_t *payload) {
 ...
 */
static void lpfc_display_fpin_wwpn(struct lpfc_hba *phba, __be64 *wwnlist,
    u32 cnt) {
 ...
 **/
static void lpfc_els_rcv_fpin_li(struct lpfc_hba *phba,
    struct fc_tlv_desc *tlv) {
 ...
 **/
static void lpfc_els_rcv_fpin_del(struct lpfc_hba *phba,
    struct fc_tlv_desc *tlv) {
 ...
 **/
static void lpfc_els_rcv_fpin_peer_cgn(struct lpfc_hba *phba,
    struct fc_tlv_desc *tlv) {
 ...
 **/
static int lpfc_els_rcv_fpin_cgn(struct lpfc_hba *phba,
    struct fc_tlv_desc *tlv) {
 ...
 **/
static void lpfc_els_unsol_buffer(struct lpfc_hba *phba,
    struct lpfc_sli_ring *pring,
 ...
 **/
void lpfc_els_unsol_event(struct lpfc_hba *phba, struct lpfc_sli_ring *pring,
    struct lpfc_iocbq *elsiocb) {
...
static void lpfc_start_fdmi(struct lpfc_vport *vport) {
  struct lpfc_nodelist *ndlp;
 ...
 **/
static void lpfc_cmpl_reg_new_vport(struct lpfc_hba *phba, LPFC_MBOXQ_t *pmb) {
 ...
 **/
void lpfc_register_new_vport(struct lpfc_hba *phba, struct lpfc_vport *vport,
    struct lpfc_nodelist *ndlp) {
  LPFC_MBOXQ_t *mbox;
  mbox = mempool_alloc(phba->mbox_mem_pool, GFP_KERNEL);
  if (mbox) {
 ...
 * to succeed.
 **/
static int lpfc_fabric_login_reqd(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_iocbq *rspiocb) {
  u32 ulp_status = get_job_ulpstatus(phba, rspiocb);
  u32 ulp_word4 = get_job_word4(phba, rspiocb);
 ...
 **/
static void lpfc_cmpl_els_fdisc(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_iocbq *rspiocb) {
  struct lpfc_vport *vport = cmdiocb->vport;
  struct lpfc_nodelist *ndlp = cmdiocb->ndlp;
 ...
 **/
static void lpfc_cmpl_els_npiv_logo(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_iocbq *rspiocb) {
  struct lpfc_vport *vport = cmdiocb->vport;
  IOCB_t *irsp;
 ...
 **/
void lpfc_fabric_block_timeout(struct timer_list *t) {
 ...
 **/
static void lpfc_resume_fabric_iocbs(struct lpfc_hba *phba) {
  struct lpfc_iocbq *iocb;
  unsigned long iflags;
  int ret;
repeat:
 ...
 **/
static void lpfc_block_fabric_iocbs(struct lpfc_hba *phba) {
  int blocked;
 ...
 **/
static void lpfc_cmpl_fabric_iocb(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_iocbq *rspiocb) {
  struct ls_rjt stat;
  u32 ulp_status = get_job_ulpstatus(phba, rspiocb);
...
static void lpfc_cmpl_els_qfpa(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_iocbq *rspiocb) {
  struct lpfc_vport *vport = cmdiocb->vport;
...
int lpfc_vmid_uvem(struct lpfc_vport *vport,
