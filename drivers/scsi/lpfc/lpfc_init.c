...
static void lpfc_cgn_update_tstamp(struct lpfc_hba *phba,
    struct lpfc_cgn_ts *ts);
 ...
 **/
static void lpfc_config_async_cmpl(struct lpfc_hba *phba,
    LPFC_MBOXQ_t *pmboxq) {
 ...
 **/
static void lpfc_dump_wakeup_param_cmpl(struct lpfc_hba *phba,
    LPFC_MBOXQ_t *pmboxq) {
  struct prog_id *prg;
 ...
 *    Any other value - error
 **/
static int lpfc_hba_init_link(struct lpfc_hba *phba, uint32_t flag) {
 ...
 *              Any other value - error
 **/
int lpfc_hba_init_link_fc_topology(struct lpfc_hba *phba, uint32_t fc_topology,
    uint32_t flag) {
  struct lpfc_vport *vport = phba->pport;
  LPFC_MBOXQ_t *pmb;
  MAILBOX_t *mb;
 ...
 *    Any other value - error
 **/
static int lpfc_hba_down_link(struct lpfc_hba *phba, uint32_t flag) {
  LPFC_MBOXQ_t *pmb;
  int rc;
  pmb = mempool_alloc(phba->mbox_mem_pool, GFP_KERNEL);
  if (!pmb) {
 ...
 *   void.
 **/
static void lpfc_sli4_free_sp_events(struct lpfc_hba *phba) {
 ...
 *   void.
 **/
static void lpfc_hba_free_post_buf(struct lpfc_hba *phba) {
  struct lpfc_sli *psli = &phba->sli;
 ...
 *   void
 **/
static void lpfc_hba_clean_txcmplq(struct lpfc_hba *phba) {
  struct lpfc_sli *psli = &phba->sli;
 ...
 **/
static void lpfc_hb_timeout(struct timer_list *t) {
 ...
 * be cleared by the worker thread after it has taken the event bitmap out.
 **/
static void lpfc_rrq_timeout(struct timer_list *t) {
  struct lpfc_hba *phba;
  unsigned long iflag;
 ...
 **/
static void lpfc_hb_mbox_cmpl(struct lpfc_hba *phba, LPFC_MBOXQ_t *pmboxq) {
 ...
 *   None
 **/
static void lpfc_idle_stat_delay_work(struct work_struct *work) {
...
static void lpfc_hb_eq_delay_work(struct work_struct *work) {
  struct lpfc_hba *phba = container_of(to_delayed_work(work),
 ...
 * other than Port Error 6 has been detected.
 **/
void lpfc_sli4_offline_eratt(struct lpfc_hba *phba) {
  spin_lock_irq(&phba->hbalock);
  if (phba->link_state == LPFC_HBA_ERROR
 ...
 **/
static void lpfc_handle_deferred_eratt(struct lpfc_hba *phba) {
...
static void lpfc_board_errevt_to_mgmt(struct lpfc_hba *phba) {
 ...
 **/
static void lpfc_handle_eratt_s3(struct lpfc_hba *phba) {
  struct lpfc_vport *vport = phba->pport;
  struct lpfc_sli *psli = &phba->sli;
  uint32_t event_data;
 ...
 **/
static int lpfc_sli4_port_sta_fn_reset(struct lpfc_hba *phba, int mbx_action,
    bool en_rn_msg) {
  int rc;
  uint32_t intr_mode;
  LPFC_MBOXQ_t *mboxq;
 ...
 * conditions.
 **/
static void lpfc_handle_eratt_s4(struct lpfc_hba *phba) {
  struct lpfc_vport *vport = phba->pport;
  uint32_t event_data;
  struct Scsi_Host *shost;
  uint32_t if_type;
...
static void lpfc_fill_vpd(struct lpfc_hba *phba, uint8_t *vpd, int length,
    int *pindex) {
  int i, j;
  while (length > 0) {
...
/**
 * lpfc_get_atto_model_desc - Retrieve ATTO HBA device model name and
 * description
 * @phba: pointer to lpfc hba data structure.
 ...
 **/
static void lpfc_get_atto_model_desc(struct lpfc_hba *phba, uint8_t *mdp,
    uint8_t *descp) {
 ...
 * function returns, the @mdp will be filled with the model name.
 **/
static void lpfc_get_hba_model_desc(struct lpfc_hba *phba, uint8_t *mdp,
    uint8_t *descp) {
  lpfc_vpd_t *vp;
...
/**
 * lpfc_sli3_post_buffer - Post IOCB(s) with DMA buffer descriptor(s) to a IOCB
 * ring
 * @phba: pointer to lpfc hba data structure.
 ...
 **/
static int lpfc_post_rcv_buf(struct lpfc_hba *phba) {
  struct lpfc_sli *psli = &phba->sli;
 ...
 * for the LC HBAs.
 **/
static void lpfc_sha_init(uint32_t *HashResultPointer) {
 ...
 **/
static void lpfc_sha_iterate(uint32_t *HashResultPointer,
 ...
 **/
static void lpfc_challenge_key(uint32_t *RandomChallenge,
...
static inline uint64_t lpfc_get_max_line_rate(struct lpfc_hba *phba) {
 ...
 **/
static void lpfc_block_mgmt_io(struct lpfc_hba *phba, int mbx_action) {
  unsigned long iflag;
 ...
 **/
void lpfc_offline_prep(struct lpfc_hba *phba, int mbx_action) {
  struct lpfc_vport *vport = phba->pport;
  struct lpfc_nodelist *ndlp, *next_ndlp;
  struct lpfc_vport **vports;
  struct Scsi_Host *shost;
 ...
 **/
static void lpfc_scsi_free(struct lpfc_hba *phba) {
...
int lpfc_io_buf_flush(struct lpfc_hba *phba, struct list_head *cbuf) {
  LIST_HEAD(blist);
  struct lpfc_sli4_hdw_queue *qp;
...
static uint64_t lpfc_get_wwpn(struct lpfc_hba *phba) {
  uint64_t wwn;
  int rc;
  LPFC_MBOXQ_t *mboxq;
  MAILBOX_t *mb;
 ...
 *  Non-0 on Failure
 */
static int lpfc_vmid_res_alloc(struct lpfc_hba *phba,
    struct lpfc_vport *vport) {
 ...
 **/
struct lpfc_vport *lpfc_create_port(struct lpfc_hba *phba, int instance,
    struct device *dev) {
  struct lpfc_vport *vport;
 ...
 **/
static void lpfc_sli4_fcf_redisc_wait_tmo(struct timer_list *t) {
 ...
 **/
static void lpfc_vmid_poll(struct timer_list *t) {
 ...
 **/
static void lpfc_sli4_parse_latt_fault(struct lpfc_hba *phba,
 ...
 **/
static uint8_t lpfc_sli4_parse_latt_type(struct lpfc_hba *phba,
    struct lpfc_acqe_link *acqe_link) {
  uint8_t att_type;
 ...
 * Return: link speed in terms of Mbps.
 **/
static uint32_t lpfc_sli4_port_speed_parse(struct lpfc_hba *phba,
    uint32_t evt_code,
    uint8_t speed_code) {
  uint32_t port_speed;
  switch (evt_code) {
 ...
 **/
static void lpfc_sli4_async_link_evt(struct lpfc_hba *phba,
    struct lpfc_acqe_link *acqe_link) {
  LPFC_MBOXQ_t *pmb;
  MAILBOX_t *mb;
 ...
 **/
static uint8_t lpfc_async_link_speed_to_read_top(struct lpfc_hba *phba,
    uint8_t speed_code) {
  uint8_t port_speed;
  switch (speed_code) {
    case LPFC_FC_LA_SPEED_1G:
 ...
 */
void lpfc_cgn_update_tstamp(struct lpfc_hba *phba, struct lpfc_cgn_ts *ts) {
 ...
 */
static enum hrtimer_restart lpfc_cmf_stats_timer(struct hrtimer *timer) {
  struct lpfc_hba *phba;
  struct lpfc_cgn_info *cp;
  uint32_t i, index;
 ...
 */
static enum hrtimer_restart lpfc_cmf_timer(struct hrtimer *timer) {
...
static void lpfc_update_trunk_link_status(struct lpfc_hba *phba,
 ...
 **/
static void lpfc_sli4_async_fc_evt(struct lpfc_hba *phba,
    struct lpfc_acqe_fc_la *acqe_fc) {
  LPFC_MBOXQ_t *pmb;
  MAILBOX_t *mb;
  struct lpfc_mbx_read_top *la;
 ...
 **/
static void lpfc_sli4_async_sli_evt(struct lpfc_hba *phba,
 ...
 * return NULL.
 **/
static struct lpfc_nodelist *lpfc_sli4_perform_vport_cvl(
    struct lpfc_vport *vport) {
 ...
 **/
static void lpfc_sli4_perform_all_vport_cvl(struct lpfc_hba *phba) {
  struct lpfc_vport **vports;
  int i;
  vports = lpfc_create_vport_work_array(phba);
  if (vports) {
 ...
 **/
static void lpfc_sli4_async_fip_evt(struct lpfc_hba *phba,
 ...
 **/
static void lpfc_sli4_async_dcbx_evt(struct lpfc_hba *phba,
 ...
 **/
static void lpfc_sli4_async_grp5_evt(struct lpfc_hba *phba,
 ...
 **/
static void lpfc_cgn_params_val(struct lpfc_hba *phba,
    struct lpfc_cgn_param *p_cfg_param) {
  spin_lock_irq(&phba->hbalock);
 ...
 * logged.
 **/
static void lpfc_cgn_params_parse(struct lpfc_hba *phba,
 ...
 **/
static int lpfc_sli4_cgn_parm_chg_evt(struct lpfc_hba *phba) {
  int ret = 0;
  if (!phba->sli4_hba.pc_sli4_params.cmf) {
    lpfc_printf_log(phba, KERN_ERR, LOG_CGN_MGMT | LOG_INIT,
 ...
 * API call does not considered as an error condition for most of the device.
 **/
int lpfc_sli_probe_sriov_nr_virtfn(struct lpfc_hba *phba, int nr_vfn) {
  struct pci_dev *pdev = phba->pcidev;
  uint16_t max_nr_vfn;
  int rc;
...
static void lpfc_unblock_requests_work(struct work_struct *work) {
 ...
 * other values - error
 **/
static int lpfc_sli_driver_resource_setup(struct lpfc_hba *phba) {
  int rc, entry_sz;
  /*
 ...
 **/
static void lpfc_sli_driver_resource_unset(struct lpfc_hba *phba) {
 ...
 *  other values - error
 **/
static int lpfc_sli4_driver_resource_setup(struct lpfc_hba *phba) {
  LPFC_MBOXQ_t *mboxq;
  MAILBOX_t *mb;
 ...
 **/
static void lpfc_sli4_driver_resource_unset(struct lpfc_hba *phba) {
 ...
 * attached to.
 **/
static void lpfc_unset_driver_resource_phase2(struct lpfc_hba *phba) {
  if (phba->wq) {
    destroy_workqueue(phba->wq);
    phba->wq = NULL;
  }
 ...
 *  other values - error
 **/
int lpfc_init_iocb_list(struct lpfc_hba *phba, int iocb_count) {
 ...
 **/
void lpfc_free_sgl_list(struct lpfc_hba *phba, struct list_head *sglq_list) {
 ...
 **/
static void lpfc_free_els_sgl_list(struct lpfc_hba *phba) {
  LIST_HEAD(sglq_list);
 ...
 **/
static void lpfc_free_nvmet_sgl_list(struct lpfc_hba *phba) {
  struct lpfc_sglq *sglq_entry = NULL, *sglq_next = NULL;
  LIST_HEAD(sglq_list);
 ...
 **/
static int lpfc_init_active_sgl_array(struct lpfc_hba *phba) {
  int size;
 ...
 **/
static void lpfc_free_active_sgl(struct lpfc_hba *phba) {
 ...
 *
 **/
static void lpfc_init_sgl_list(struct lpfc_hba *phba) {
 ...
 *      other values - error
 **/
static int lpfc_create_shost(struct lpfc_hba *phba) {
  struct lpfc_vport *vport;
  struct Scsi_Host *shost;
 ...
 * SCSI host.
 **/
static void lpfc_destroy_shost(struct lpfc_hba *phba) {
  struct lpfc_vport *vport = phba->pport;
 ...
 **/
static void lpfc_setup_bg(struct lpfc_hba *phba, struct Scsi_Host *shost) {
  uint32_t old_mask;
  uint32_t old_guard;
 ...
 **/
static void lpfc_post_init_setup(struct lpfc_hba *phba) {
  struct Scsi_Host *shost;
 ...
 *  other values - error
 **/
static int lpfc_sli_pci_mem_setup(struct lpfc_hba *phba) {
  struct pci_dev *pdev = phba->pcidev;
 ...
 * memory map.
 **/
static void lpfc_sli4_bar0_register_memmap(struct lpfc_hba *phba,
    uint32_t if_type) {
  switch (if_type) {
    case LPFC_SLI_INTF_IF_TYPE_0:
      phba->sli4_hba.u.if_type0.UERRLOregaddr
 ...
 **/
static void lpfc_sli4_bar1_register_memmap(struct lpfc_hba *phba,
    uint32_t if_type) {
  switch (if_type) {
    case LPFC_SLI_INTF_IF_TYPE_0:
      phba->sli4_hba.PSMPHRregaddr
 ...
 * Return 0 if successful, otherwise -ENODEV.
 **/
static int lpfc_sli4_bar2_register_memmap(struct lpfc_hba *phba, uint32_t vf) {
 ...
 **/
static int lpfc_create_bootstrap_mbox(struct lpfc_hba *phba) {
  uint32_t bmbx_size;
  struct lpfc_dmabuf *dmabuf;
 ...
 *
 **/
static void lpfc_destroy_bootstrap_mbox(struct lpfc_hba *phba) {
 ...
 **/
static void lpfc_map_topology(struct lpfc_hba *phba,
 ...
 *      -EIO - The mailbox failed to complete successfully.
 **/
static int lpfc_setup_endian_order(struct lpfc_hba *phba) {
  LPFC_MBOXQ_t *mboxq;
  uint32_t if_type, rc = 0;
  uint32_t endian_mb_data[2] = {
 ...
 *      -ENOMEM - No available memory
 **/
static int lpfc_sli4_queue_verify(struct lpfc_hba *phba) {
  /*
...
static int lpfc_alloc_io_wq_cq(struct lpfc_hba *phba, int idx) {
...
static inline void __lpfc_sli4_release_queue(struct lpfc_queue **qp) {
  if (*qp != NULL) {
...
static inline void lpfc_sli4_release_queues(struct lpfc_queue ***qs, int max) {
  int idx;
  if (*qs == NULL) {
    return;
  }
...
static inline void lpfc_sli4_release_hdwq(struct lpfc_hba *phba) {
  struct lpfc_sli4_hdw_queue *hdwq;
  struct lpfc_queue *eq;
  uint32_t idx;
...
int lpfc_free_rq_buffer(struct lpfc_hba *phba, struct lpfc_queue *rq) {
...
static int lpfc_create_wq_cq(struct lpfc_hba *phba, struct lpfc_queue *eq,
 ...
 **/
static void lpfc_setup_cq_lookup(struct lpfc_hba *phba) {
 ...
 *      -ENOMEM - No available memory
 **/
static int lpfc_sli4_cq_event_pool_create(struct lpfc_hba *phba) {
  struct lpfc_cq_event *cq_event;
  int i;
 ...
 * to destroy the pool.
 **/
static void lpfc_sli4_cq_event_pool_destroy(struct lpfc_hba *phba) {
 ...
 **/
static void lpfc_sli4_cq_event_release_all(struct lpfc_hba *phba) {
 ...
 *  other values - error
 **/
static int lpfc_sli4_pci_mem_setup(struct lpfc_hba *phba) {
  struct pci_dev *pdev = phba->pcidev;
 ...
 *   other values - error
 **/
static int lpfc_sli_enable_msix(struct lpfc_hba *phba) {
  int rc;
  LPFC_MBOXQ_t *pmb;
 ...
 *   other values - error
 **/
static uint32_t lpfc_sli_enable_intr(struct lpfc_hba *phba, uint32_t cfg_mode) {
 ...
 */
static uint16_t lpfc_find_cpu_handle(struct lpfc_hba *phba, uint16_t id,
    int match) {
  struct lpfc_vector_map_info *cpup;
  int cpu;
 ...
 * @core_id: CPU core id
 */
static int lpfc_find_hyper(struct lpfc_hba *phba, int cpu,
 ...
 */
static inline void lpfc_assign_eq_map_info(struct lpfc_hba *phba,
    uint16_t eqidx, uint16_t flag,
    unsigned int cpu) {
 ...
 */
static void lpfc_cpu_map_array_init(struct lpfc_hba *phba) {
  struct lpfc_vector_map_info *cpup;
  struct lpfc_eq_intr_info *eqi;
  int cpu;
 ...
 */
static void lpfc_hba_eq_hdl_array_init(struct lpfc_hba *phba) {
 ...
 */
static void lpfc_cpu_affinity_check(struct lpfc_hba *phba, int vectors) {
 ...
 */
static int lpfc_cpuhp_get_eq(struct lpfc_hba *phba, unsigned int cpu,
 ...
 *
 **/
static inline void lpfc_irq_set_aff(struct lpfc_hba_eq_hdl *eqhdl,
    unsigned int cpu) {
 ...
 *
 **/
static inline void lpfc_irq_clear_aff(struct lpfc_hba_eq_hdl *eqhdl) {
  cpumask_clear(&eqhdl->aff_mask);
 ...
 *
 **/
static void lpfc_irq_rebalance(struct lpfc_hba *phba, unsigned int cpu,
    bool offline) {
  struct lpfc_vector_map_info *cpup;
 ...
 * other values - error
 **/
static int lpfc_sli4_enable_msix(struct lpfc_hba *phba) {
 ...
 *  other values - error
 **/
static int lpfc_sli4_enable_msi(struct lpfc_hba *phba) {
  int rc, index;
  unsigned int cpu;
  struct lpfc_hba_eq_hdl *eqhdl;
 ...
 **/
static uint32_t lpfc_sli4_enable_intr(struct lpfc_hba *phba,
    uint32_t cfg_mode) {
  uint32_t intr_mode = LPFC_INTR_ERROR;
  int retval, idx;
  if (cfg_mode == 2) {
 ...
 **/
static void lpfc_sli4_xri_exchange_busy_wait(struct lpfc_hba *phba) {
  struct lpfc_sli4_hdw_queue *qp;
  int idx, ccnt;
  int wait_time = 0;
  int io_xri_cmpl = 1;
 ...
 **/
static void lpfc_sli4_hba_unset(struct lpfc_hba *phba) {
  int wait_cnt = 0;
  LPFC_MBOXQ_t *mboxq;
  struct pci_dev *pdev = phba->pcidev;
  lpfc_stop_hba_timers(phba);
...
static uint32_t lpfc_cgn_crc32(uint32_t crc, u8 byte) {
  uint32_t msb = 0;
  uint32_t bit;
  for (bit = 0; bit < 8; bit++) {
    msb = (crc >> 31) & 1;
...
static uint32_t lpfc_cgn_reverse_bits(uint32_t wd) {
  uint32_t result = 0;
  uint32_t i;
  for (i = 0; i < 32; i++) {
    result <<= 1;
 ...
 */
uint32_t lpfc_cgn_calc_crc32(void *ptr, uint32_t byteLen, uint32_t crc) {
  uint32_t i;
  uint32_t result;
 ...
 */
static int __lpfc_reg_congestion_buf(struct lpfc_hba *phba, int reg) {
 ...
 **/
int lpfc_get_sli4_parameters(struct lpfc_hba *phba, LPFC_MBOXQ_t *mboxq) {
  int rc;
 ...
 **/
static int lpfc_pci_probe_one_s3(struct pci_dev *pdev,
 ...
 **/
static void lpfc_pci_remove_one_s3(struct pci_dev *pdev) {
 ...
 *  Error otherwise
 **/
static int __maybe_unused lpfc_pci_suspend_one_s3(struct device *dev_d) {
 ...
 *  Error otherwise
 **/
static int __maybe_unused lpfc_pci_resume_one_s3(struct device *dev_d) {
  struct Scsi_Host *shost = dev_get_drvdata(dev_d);
  struct lpfc_hba *phba = ((struct lpfc_vport *) shost->hostdata)->phba;
  uint32_t intr_mode;
  int error;
 ...
 * pending I/Os.
 **/
static void lpfc_sli_prep_dev_for_reset(struct lpfc_hba *phba) {
  lpfc_printf_log(phba, KERN_ERR, LOG_TRACE_EVENT,
 ...
 * pending I/Os.
 **/
static void lpfc_sli_prep_dev_for_perm_failure(struct lpfc_hba *phba) {
  lpfc_printf_log(phba, KERN_ERR, LOG_TRACE_EVENT,
 ...
 **/
static pci_ers_result_t lpfc_io_error_detected_s3(struct pci_dev *pdev,
 ...
 *  PCI_ERS_RESULT_DISCONNECT - device could not be recovered
 */
static pci_ers_result_t lpfc_io_slot_reset_s3(struct pci_dev *pdev) {
  struct Scsi_Host *shost = pci_get_drvdata(pdev);
  struct lpfc_hba *phba = ((struct lpfc_vport *) shost->hostdata)->phba;
  struct lpfc_sli *psli = &phba->sli;
  uint32_t intr_mode;
...
static int lpfc_log_write_firmware_error(struct lpfc_hba *phba, uint32_t offset,
 ...
 *
 **/
static void lpfc_write_firmware(const struct firmware *fw, void *context) {
 ...
 **/
int lpfc_sli4_request_firmware_update(struct lpfc_hba *phba,
    uint8_t fw_upgrade) {
  char file_name[ELX_FW_NAME_SIZE] = {
    0
  };
  int ret;
  const struct firmware *fw;
 ...
 *  negative value - driver can not claim the device
 **/
static int lpfc_pci_probe_one_s4(struct pci_dev *pdev,
    const struct pci_device_id *pid) {
  struct lpfc_hba *phba;
  struct lpfc_vport *vport = NULL;
  struct Scsi_Host *shost = NULL;
 ...
 * device to be removed from the PCI subsystem properly.
 **/
static void lpfc_pci_remove_one_s4(struct pci_dev *pdev) {
  struct Scsi_Host *shost = pci_get_drvdata(pdev);
  struct lpfc_vport *vport = (struct lpfc_vport *) shost->hostdata;
  struct lpfc_vport **vports;
  struct lpfc_hba *phba = vport->phba;
 ...
 *  Error otherwise
 **/
static int __maybe_unused lpfc_pci_suspend_one_s4(struct device *dev_d) {
  struct Scsi_Host *shost = dev_get_drvdata(dev_d);
  struct lpfc_hba *phba = ((struct lpfc_vport *) shost->hostdata)->phba;
  lpfc_printf_log(phba, KERN_INFO, LOG_INIT,
 ...
 *  Error otherwise
 **/
static int __maybe_unused lpfc_pci_resume_one_s4(struct device *dev_d) {
  struct Scsi_Host *shost = dev_get_drvdata(dev_d);
  struct lpfc_hba *phba = ((struct lpfc_vport *) shost->hostdata)->phba;
  uint32_t intr_mode;
  int error;
 ...
 * aborts all the outstanding SCSI I/Os to the pci device.
 **/
static void lpfc_sli4_prep_dev_for_recover(struct lpfc_hba *phba) {
  lpfc_printf_log(phba, KERN_ERR, LOG_TRACE_EVENT,
 ...
 * pending I/Os.
 **/
static void lpfc_sli4_prep_dev_for_perm_failure(struct lpfc_hba *phba) {
  lpfc_printf_log(phba, KERN_ERR, LOG_TRACE_EVENT,
 ...
 *  PCI_ERS_RESULT_DISCONNECT - device could not be recovered
 **/
static pci_ers_result_t lpfc_io_error_detected_s4(struct pci_dev *pdev,
    pci_channel_state_t state) {
  struct Scsi_Host *shost = pci_get_drvdata(pdev);
  struct lpfc_hba *phba = ((struct lpfc_vport *) shost->hostdata)->phba;
  bool hba_pci_err;
 ...
 * again.
 **/
static void lpfc_io_resume_s4(struct pci_dev *pdev) {
  struct Scsi_Host *shost = pci_get_drvdata(pdev);
  struct lpfc_hba *phba = ((struct lpfc_vport *) shost->hostdata)->phba;
  /*
 ...
 *  negative value - driver can not claim the device
 **/
static int lpfc_pci_probe_one(struct pci_dev *pdev,
    const struct pci_device_id *pid) {
  int rc;
 ...
 * device to be removed from the PCI subsystem properly.
 **/
static void lpfc_pci_remove_one(struct pci_dev *pdev) {
  struct Scsi_Host *shost = pci_get_drvdata(pdev);
  struct lpfc_hba *phba = ((struct lpfc_vport *) shost->hostdata)->phba;
  switch (phba->pci_dev_grp) {
    case LPFC_PCI_DEV_LP:
 ...
 *  Error otherwise
 **/
static int __maybe_unused lpfc_pci_suspend_one(struct device *dev) {
 ...
 *  Error otherwise
 **/
static int __maybe_unused lpfc_pci_resume_one(struct device *dev) {
  struct Scsi_Host *shost = dev_get_drvdata(dev);
  struct lpfc_hba *phba = ((struct lpfc_vport *) shost->hostdata)->phba;
  int rc = -ENODEV;
  switch (phba->pci_dev_grp) {
 ...
 */
static void __exit lpfc_exit(void) {
  misc_deregister(&lpfc_mgmt_dev);
