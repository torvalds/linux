...
static int lpfc_sli4_read_rev(struct lpfc_hba *, LPFC_MBOXQ_t *,
    uint8_t *, uint32_t *);
static struct lpfc_iocbq *lpfc_sli4_els_preprocess_rspiocbq(
 ...
 * lock.
 **/
static void lpfc_sli4_pcimem_bcopy(void *srcp, void *destp, uint32_t cnt) {
  uint64_t *src = srcp;
  uint64_t *dest = destp;
  int i;
 ...
 **/
static int lpfc_sli4_wq_put(struct lpfc_queue *q, union lpfc_wqe128 *wqe) {
 ...
 * pointers.
 **/
static void lpfc_sli4_wq_release(struct lpfc_queue *q, uint32_t index) {
  /* sanity check on queue memory */
  if (unlikely(!q)) {
    return;
  }
 ...
 * The caller is expected to hold the hbalock when calling this routine.
 **/
static uint32_t lpfc_sli4_mq_put(struct lpfc_queue *q, struct lpfc_mqe *mqe) {
 ...
 *
 **/
void lpfc_sli4_eq_clr_intr(struct lpfc_queue *q) {
  struct lpfc_register doorbell;
  doorbell.word0 = 0;
...
static void __lpfc_sli4_consume_eqe(struct lpfc_hba *phba,
    struct lpfc_queue *eq,
    struct lpfc_eqe *eqe) {
...
static void lpfc_sli4_eqcq_flush(struct lpfc_hba *phba, struct lpfc_queue *eq) {
...
static int lpfc_sli4_process_eq(struct lpfc_hba *phba, struct lpfc_queue *eq,
 ...
 * consumed by the HBA.
 **/
static uint32_t lpfc_sli4_rq_release(struct lpfc_queue *hq,
    struct lpfc_queue *dq) {
  /* sanity check on queue memory */
  if (unlikely(!hq) || unlikely(!dq)) {
    return 0;
  }
 ...
 **/
static inline IOCB_t *lpfc_cmd_iocb(struct lpfc_hba *phba,
 ...
 * SLI-2/SLI-3 provide different sized iocbs.
 **/
static inline IOCB_t *lpfc_resp_iocb(struct lpfc_hba *phba,
    struct lpfc_sli_ring *pring) {
 ...
 **/
struct lpfc_sglq *__lpfc_clear_active_sglq(struct lpfc_hba *phba,
    uint16_t xritag) {
  struct lpfc_sglq *sglq;
 ...
 **/
int lpfc_test_rrq_active(struct lpfc_hba *phba, struct lpfc_nodelist *ndlp,
    uint16_t xritag) {
  if (!ndlp) {
    return 0;
  }
 ...
 **/
int lpfc_set_rrq_active(struct lpfc_hba *phba, struct lpfc_nodelist *ndlp,
 ...
 **/
static struct lpfc_sglq *__lpfc_sli_get_els_sglq(struct lpfc_hba *phba,
 ...
 **/
static void __lpfc_sli_release_iocbq_s4(struct lpfc_hba *phba,
 ...
 **/
static void __lpfc_sli_release_iocbq_s3(struct lpfc_hba *phba,
    struct lpfc_iocbq *iocbq) {
  /*
   * Clean all volatile data fields, preserve iotag and node struct.
   */
 ...
 * clears all other fields of the iocb object when it is freed.
 **/
static void __lpfc_sli_release_iocbq(struct lpfc_hba *phba,
    struct lpfc_iocbq *iocbq) {
  lockdep_assert_held(&phba->hbalock);
 ...
 **/
static lpfc_iocb_type lpfc_sli_iocb_cmd_type(uint8_t iocb_cmnd) {
 ...
 * error code.
 **/
static int lpfc_sli_ring_map(struct lpfc_hba *phba) {
 ...
 **/
static int lpfc_sli_ringtxcmpl_put(struct lpfc_hba *phba,
    struct lpfc_sli_ring *pring,
    struct lpfc_iocbq *piocb) {
  u32 ulp_command = 0;
  BUG_ON(!piocb);
 ...
 * with LOG_CGN_MGMT.
 **/
static void lpfc_cmf_sync_cmpl(struct lpfc_hba *phba,
 ...
 **/
static IOCB_t *lpfc_sli_next_iocb_slot(struct lpfc_hba *phba,
    struct lpfc_sli_ring *pring) {
 ...
 * this routine.
 **/
static void lpfc_sli_submit_iocb(struct lpfc_hba *phba,
    struct lpfc_sli_ring *pring,
 ...
 **/
static void lpfc_sli_update_full_ring(struct lpfc_hba *phba,
    struct lpfc_sli_ring *pring) {
 ...
 **/
static void lpfc_sli_update_ring(struct lpfc_hba *phba,
    struct lpfc_sli_ring *pring) {
  int ringno = pring->ringno;
  /*
 ...
 **/
static void lpfc_sli_resume_iocb(struct lpfc_hba *phba,
    struct lpfc_sli_ring *pring) {
  IOCB_t *iocb;
 ...
 **/
static struct lpfc_hbq_entry *lpfc_sli_next_hbq_slot(struct lpfc_hba *phba,
    uint32_t hbqno) {
 ...
 **/
static int lpfc_sli_hbq_to_firmware(struct lpfc_hba *phba, uint32_t hbqno,
    struct hbq_dmabuf *hbq_buf) {
  lockdep_assert_held(&phba->hbalock);
 ...
 **/
static int lpfc_sli_hbq_to_firmware_s3(struct lpfc_hba *phba, uint32_t hbqno,
    struct hbq_dmabuf *hbq_buf) {
 ...
 **/
static int lpfc_sli_hbq_to_firmware_s4(struct lpfc_hba *phba, uint32_t hbqno,
    struct hbq_dmabuf *hbq_buf) {
  int rc;
 ...
 * posted.
 **/
static int lpfc_sli_hbqbuf_fill_hbqs(struct lpfc_hba *phba, uint32_t hbqno,
    uint32_t count) {
  uint32_t i, posted = 0;
  unsigned long flags;
 ...
 * pointer to that buffer. If it finds no buffers on the list it returns NULL.
 **/
static struct rqb_dmabuf *lpfc_sli_rqbuf_get(struct lpfc_hba *phba,
    struct lpfc_queue *hrq) {
 ...
 **/
static struct hbq_dmabuf *lpfc_sli_hbqbuf_find(struct lpfc_hba *phba,
    uint32_t tag) {
  struct lpfc_dmabuf *d_buf;
  struct hbq_dmabuf *hbq_buf;
  uint32_t hbqno;
...
static void __lpfc_sli_rpi_release(struct lpfc_vport *vport,
    struct lpfc_nodelist *ndlp) {
  unsigned long iflags;
 ...
 *
 **/
void lpfc_sli4_unreg_rpi_cmpl_clr(struct lpfc_hba *phba, LPFC_MBOXQ_t *pmb) {
  struct lpfc_vport *vport = pmb->vport;
  struct lpfc_nodelist *ndlp;
  ndlp = pmb->ctx_ndlp;
  if (pmb->u.mb.mbxCommand == MBX_UNREG_LOGIN) {
 ...
 **/
static struct lpfc_dmabuf *lpfc_sli_get_buff(struct lpfc_hba *phba,
    struct lpfc_sli_ring *pring,
    uint32_t tag) {
 ...
 **/
static void lpfc_nvme_unsol_ls_handler(struct lpfc_hba *phba,
    struct lpfc_iocbq *piocb) {
  struct lpfc_nodelist *ndlp;
  struct lpfc_dmabuf *d_buf;
 ...
 **/
static int lpfc_complete_unsol_iocb(struct lpfc_hba *phba,
    struct lpfc_sli_ring *pring,
...
static void lpfc_sli_prep_unsol_wqe(struct lpfc_hba *phba,
 ...
 **/
static int lpfc_sli_process_unsol_iocb(struct lpfc_hba *phba,
    struct lpfc_sli_ring *pring,
    struct lpfc_iocbq *saveq) {
  IOCB_t *irsp;
  WORD5 *w5p;
 ...
 **/
static struct lpfc_iocbq *lpfc_sli_iocbq_lookup(struct lpfc_hba *phba,
    struct lpfc_sli_ring *pring,
 ...
 * iocb else returns NULL.
 **/
static struct lpfc_iocbq *lpfc_sli_iocbq_lookup_by_tag(struct lpfc_hba *phba,
 ...
 **/
static int lpfc_sli_process_sol_iocb(struct lpfc_hba *phba,
    struct lpfc_sli_ring *pring,
    struct lpfc_iocbq *saveq) {
 ...
 **/
static struct lpfc_iocbq *lpfc_sli_sp_handle_rspiocb(struct lpfc_hba *phba,
    struct lpfc_sli_ring *pring,
 ...
 **/
static void lpfc_sli_handle_slow_ring_event_s3(struct lpfc_hba *phba,
    struct lpfc_sli_ring *pring, uint32_t mask) {
  struct lpfc_pgp *pgp;
  IOCB_t *entry;
  IOCB_t *irsp = NULL;
 ...
 * response iocb routine (lpfc_sli_sp_handle_rspiocb) to process it.
 **/
static void lpfc_sli_handle_slow_ring_event_s4(struct lpfc_hba *phba,
    struct lpfc_sli_ring *pring, uint32_t mask) {
 ...
 * zero.
 **/
static int lpfc_sli_brdready_s3(struct lpfc_hba *phba, uint32_t mask) {
  uint32_t status;
  int i = 0;
  int retval = 0;
 ...
 **/
static int lpfc_sli_brdready_s4(struct lpfc_hba *phba, uint32_t mask) {
  uint32_t status;
  int retval = 0;
  /* Read the HBA Host Status Register */
 ...
 **/
static int lpfc_sli_brdrestart_s3(struct lpfc_hba *phba) {
 ...
 * the total count.
 **/
static int lpfc_sli_hbq_entry_count(void) {
 ...
 **/
static int lpfc_sli_hbq_setup(struct lpfc_hba *phba) {
  int hbq_count = lpfc_sli_hbq_count();
  LPFC_MBOXQ_t *pmb;
  MAILBOX_t *pmbox;
  uint32_t hbqno;
 ...
 * else it will return negative error code.
 **/
static int lpfc_sli4_rb_setup(struct lpfc_hba *phba) {
  phba->hbq_in_use = 1;
  /**
 ...
 * data structure.
 **/
static int lpfc_sli4_read_fcoe_params(struct lpfc_hba *phba) {
  LPFC_MBOXQ_t *mboxq;
  struct lpfc_dmabuf *mp;
  struct lpfc_mqe *mqe;
 ...
 **/
static int lpfc_sli4_read_rev(struct lpfc_hba *phba, LPFC_MBOXQ_t *mboxq,
 ...
 **/
static int lpfc_sli4_get_ctl_attr(struct lpfc_hba *phba) {
  LPFC_MBOXQ_t *mboxq;
 ...
 **/
static int lpfc_sli4_retrieve_pport_name(struct lpfc_hba *phba) {
  LPFC_MBOXQ_t *mboxq;
 ...
 * event queues
 **/
static void lpfc_sli4_arm_cqeq_intr(struct lpfc_hba *phba) {
  int qidx;
 ...
 **/
int lpfc_sli4_get_avail_extnt_rsrc(struct lpfc_hba *phba, uint16_t type,
 ...
 *   0: No changes.
 **/
static int lpfc_sli4_chk_avail_extnt_rsrc(struct lpfc_hba *phba,
    uint16_t type) {
 ...
 *   0: if successful
 **/
static int lpfc_sli4_cfg_post_extnts(struct lpfc_hba *phba, uint16_t extnt_cnt,
 ...
 * resource type.
 **/
static int lpfc_sli4_alloc_extent(struct lpfc_hba *phba, uint16_t type) {
  bool emb = false;
 ...
 **/
static int lpfc_sli4_dealloc_extent(struct lpfc_hba *phba, uint16_t type) {
  int rc;
...
static void lpfc_set_features(struct lpfc_hba *phba, LPFC_MBOXQ_t *mbox,
    uint32_t feature) {
  uint32_t len;
  u32 sig_freq = 0;
...
static int lpfc_sli4_ras_dma_alloc(struct lpfc_hba *phba,
 ...
 **/
static void lpfc_sli4_ras_mbox_cmpl(struct lpfc_hba *phba, LPFC_MBOXQ_t *pmb) {
  MAILBOX_t *mb;
  union lpfc_sli4_cfg_shdr *shdr;
  uint32_t shdr_status, shdr_add_status;
  struct lpfc_ras_fwlog *ras_fwlog = &phba->ras_fwlog;
 ...
 * memory.
 **/
int lpfc_sli4_ras_fwlog_init(struct lpfc_hba *phba,
 ...
 **/
int lpfc_sli4_get_allocated_extnts(struct lpfc_hba *phba, uint16_t type,
 ...
 **/
static int lpfc_sli4_repost_sgl_list(struct lpfc_hba *phba,
 ...
 * Returns: 0 = success, non-zero failure.
 **/
static int lpfc_sli4_repost_io_sgl_list(struct lpfc_hba *phba) {
...
static void lpfc_set_host_data(struct lpfc_hba *phba, LPFC_MBOXQ_t *mbox) {
  uint32_t len;
...
static void lpfc_mbx_cmpl_read_lds_params(struct lpfc_hba *phba,
    LPFC_MBOXQ_t *pmb) {
  union lpfc_sli4_cfg_shdr *shdr;
...
static void lpfc_mbx_cmpl_cgn_set_ftrs(struct lpfc_hba *phba,
    LPFC_MBOXQ_t *pmb) {
  struct lpfc_vport *vport = pmb->vport;
  union lpfc_sli4_cfg_shdr *shdr;
  u32 shdr_status, shdr_add_status;
 ...
 **/
static int lpfc_cmf_setup(struct lpfc_hba *phba) {
  LPFC_MBOXQ_t *mboxq;
  struct lpfc_dmabuf *mp;
...
static int lpfc_set_host_tm(struct lpfc_hba *phba) {
  LPFC_MBOXQ_t *mboxq;
  uint32_t len, rc;
 ...
 * the function.
 **/
static int lpfc_sli_issue_mbox_s3(struct lpfc_hba *phba, LPFC_MBOXQ_t *pmbox,
    uint32_t flag) {
  MAILBOX_t *mbx;
  struct lpfc_sli *psli = &phba->sli;
 ...
 **/
static int lpfc_sli4_async_mbox_block(struct lpfc_hba *phba) {
  struct lpfc_sli *psli = &phba->sli;
  LPFC_MBOXQ_t *mboxq;
  int rc = 0;
 ...
 **/
static void lpfc_sli4_async_mbox_unblock(struct lpfc_hba *phba) {
  struct lpfc_sli *psli = &phba->sli;
  spin_lock_irq(&phba->hbalock);
 ...
 **/
static int lpfc_sli4_wait_bmbx_ready(struct lpfc_hba *phba,
    LPFC_MBOXQ_t *mboxq) {
  uint32_t db_ready;
  unsigned long timeout;
 ...
 **/
static int lpfc_sli4_post_sync_mbox(struct lpfc_hba *phba,
    LPFC_MBOXQ_t *mboxq) {
  int rc = MBX_SUCCESS;
  unsigned long iflag;
 ...
 * function.
 **/
static int lpfc_sli_issue_mbox_s4(struct lpfc_hba *phba, LPFC_MBOXQ_t *mboxq,
    uint32_t flag) {
  struct lpfc_sli *psli = &phba->sli;
  unsigned long iflags;
  int rc;
 ...
 * function.
 **/
int lpfc_sli_issue_mbox(struct lpfc_hba *phba, LPFC_MBOXQ_t *pmbox,
    uint32_t flag) {
 ...
 * to the ring.
 **/
void __lpfc_sli_ringtx_put(struct lpfc_hba *phba, struct lpfc_sli_ring *pring,
    struct lpfc_iocbq *piocb) {
  if (phba->sli_rev == LPFC_SLI_REV4) {
 ...
 **/
static struct lpfc_iocbq *lpfc_sli_next_iocb(struct lpfc_hba *phba,
    struct lpfc_sli_ring *pring,
    struct lpfc_iocbq **piocb) {
  struct lpfc_iocbq *nextiocb;
  lockdep_assert_held(&phba->hbalock);
 ...
 * txq.
 **/
static int __lpfc_sli_issue_iocb_s3(struct lpfc_hba *phba, uint32_t ring_number,
 ...
 **/
static int __lpfc_sli_issue_fcp_io_s3(struct lpfc_hba *phba,
 ...
 * txq.
 **/
static int __lpfc_sli_issue_fcp_io_s4(struct lpfc_hba *phba,
    uint32_t ring_number,
    struct lpfc_iocbq *piocb, uint32_t flag) {
...
void lpfc_prep_embed_io(struct lpfc_hba *phba, struct lpfc_io_buf *lpfc_cmd) {
 ...
 * txq.
 **/
static int __lpfc_sli_issue_iocb_s4(struct lpfc_hba *phba, uint32_t ring_number,
    struct lpfc_iocbq *piocb, uint32_t flag) {
  struct lpfc_sglq *sglq;
  union lpfc_wqe128 *wqe;
 ...
 * IOCB_BUSY - Busy
 **/
int __lpfc_sli_issue_iocb(struct lpfc_hba *phba, uint32_t ring_number,
    struct lpfc_iocbq *piocb, uint32_t flag) {
  return phba->__lpfc_sli_issue_iocb(phba, ring_number, piocb, flag);
}

static void __lpfc_sli_prep_els_req_rsp_s3(struct lpfc_iocbq *cmdiocbq,
...
static void __lpfc_sli_prep_els_req_rsp_s4(struct lpfc_iocbq *cmdiocbq,
    struct lpfc_vport *vport,
    struct lpfc_dmabuf *bmp, u16 cmd_size, u32 did,
    u32 elscmd, u8 tmo, u8 expect_rsp) {
  struct lpfc_hba *phba = vport->phba;
...
static void __lpfc_sli_prep_gen_req_s3(struct lpfc_iocbq *cmdiocbq,
...
static void __lpfc_sli_prep_gen_req_s4(struct lpfc_iocbq *cmdiocbq,
    struct lpfc_dmabuf *bmp,
    u16 rpi, u32 num_entry, u8 tmo) {
...
static void __lpfc_sli_prep_xmit_seq64_s3(struct lpfc_iocbq *cmdiocbq,
...
static void __lpfc_sli_prep_xmit_seq64_s4(struct lpfc_iocbq *cmdiocbq,
    struct lpfc_dmabuf *bmp, u16 rpi, u16 ox_id,
...
static void __lpfc_sli_prep_abort_xri_s3(struct lpfc_iocbq *cmdiocbq,
    u16 ulp_context,
...
static void __lpfc_sli_prep_abort_xri_s4(struct lpfc_iocbq *cmdiocbq,
    u16 ulp_context,
    u16 iotag, u8 ulp_class, u16 cqid, bool ia,
    bool wqec) {
  union lpfc_wqe128 *wqe;
 ...
 **/
int lpfc_sli_issue_iocb(struct lpfc_hba *phba, uint32_t ring_number,
    struct lpfc_iocbq *piocb, uint32_t flag) {
  struct lpfc_sli_ring *pring;
  struct lpfc_queue *eq;
  unsigned long iflags;
 ...
 **/
static int lpfc_extra_ring_setup(struct lpfc_hba *phba) {
  struct lpfc_sli *psli;
  struct lpfc_sli_ring *pring;
  psli = &phba->sli;
...
static void lpfc_sli_post_recovery_event(struct lpfc_hba *phba,
    struct lpfc_nodelist *ndlp) {
  unsigned long iflags;
 ...
 */
static void lpfc_sli_abts_err_handler(struct lpfc_hba *phba,
    struct lpfc_iocbq *iocbq) {
  struct lpfc_nodelist *ndlp = NULL;
 ...
 **/
static void lpfc_sli_async_event_handler(struct lpfc_hba *phba,
 ...
 **/
static void lpfc_sli_mbox_sys_flush(struct lpfc_hba *phba) {
 ...
 * buffer list.
 **/
int lpfc_sli_ringpostbuf_put(struct lpfc_hba *phba, struct lpfc_sli_ring *pring,
    struct lpfc_dmabuf *mp) {
 ...
 **/
static void lpfc_sli_abort_els_cmpl(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_iocbq *rspiocb) {
...
/**
 * lpfc_sli_validate_fcp_iocb_for_abort - filter iocbs appropriate for FCP
 * aborts
 * @iocbq: Pointer to iocb object.
 ...
 * -EINVAL, if the iocb is not an FCP I/O, not on the TX cmpl queue, premarked
 * as
 *          driver already started the abort process, or is an abort iocb itself
 * 0, passes criteria for aborting the FCP I/O iocb
 **/
static int lpfc_sli_validate_fcp_iocb_for_abort(struct lpfc_iocbq *iocbq,
    struct lpfc_vport *vport) {
  u8 ulp_command;
  /* No null ptr vports */
 ...
 **/
static int lpfc_sli_validate_fcp_iocb(struct lpfc_iocbq *iocbq,
    struct lpfc_vport *vport,
 ...
 **/
int lpfc_sli_sum_iocb(struct lpfc_vport *vport, uint16_t tgt_id,
    uint64_t lun_id,
    lpfc_ctx_cmd ctx_cmd) {
  struct lpfc_hba *phba = vport->phba;
  struct lpfc_iocbq *iocbq;
 ...
 **/
void lpfc_sli_abort_fcp_cmpl(struct lpfc_hba *phba, struct lpfc_iocbq *cmdiocb,
    struct lpfc_iocbq *rspiocb) {
  lpfc_printf_log(phba, KERN_INFO, LOG_SLI,
 ...
 * command is sent.
 **/
int lpfc_sli_abort_taskmgmt(struct lpfc_vport *vport,
    struct lpfc_sli_ring *pring,
 ...
 **/
static void lpfc_sli_wake_iocb_wait(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdiocbq,
    struct lpfc_iocbq *rspiocbq) {
 ...
 **/
static int lpfc_chk_iocb_flg(struct lpfc_hba *phba,
 ...
 * Register and returns 0 otherwise.
 **/
static int lpfc_sli4_eratt_read(struct lpfc_hba *phba) {
 ...
 */
static inline int lpfc_intr_state_check(struct lpfc_hba *phba) {
...
inline struct lpfc_cq_event *lpfc_cq_event_setup(struct lpfc_hba *phba,
    void *entry, int size) {
  struct lpfc_cq_event *cq_event;
 ...
 **/
static bool lpfc_sli4_sp_handle_async_event(struct lpfc_hba *phba,
    struct lpfc_mcqe *mcqe) {
  struct lpfc_cq_event *cq_event;
  unsigned long iflags;
  lpfc_printf_log(phba, KERN_INFO, LOG_SLI,
 ...
 * Return: true if work posted to worker thread, otherwise false.
 **/
static bool lpfc_sli4_sp_handle_mbox_event(struct lpfc_hba *phba,
    struct lpfc_mcqe *mcqe) {
  uint32_t mcqe_status;
  MAILBOX_t *mbox, *pmbox;
  struct lpfc_mqe *mqe;
 ...
 * Return: true if work posted to worker thread, otherwise false.
 **/
static bool lpfc_sli4_sp_handle_mcqe(struct lpfc_hba *phba,
    struct lpfc_queue *cq,
    struct lpfc_cqe *cqe) {
  struct lpfc_mcqe mcqe;
  bool workposted;
 ...
 * Return: true if work posted to worker thread, otherwise false.
 **/
static bool lpfc_sli4_sp_handle_els_wcqe(struct lpfc_hba *phba,
    struct lpfc_queue *cq,
    struct lpfc_wcqe_complete *wcqe) {
  struct lpfc_iocbq *irspiocbq;
  unsigned long iflags;
 ...
 **/
static void lpfc_sli4_sp_handle_rel_wcqe(struct lpfc_hba *phba,
 ...
 * Return: true if work posted to worker thread, otherwise false.
 **/
static bool lpfc_sli4_sp_handle_abort_xri_wcqe(struct lpfc_hba *phba,
    struct lpfc_queue *cq,
 ...
 * Return: true if work posted to worker thread, otherwise false.
 **/
static bool lpfc_sli4_sp_handle_rcqe(struct lpfc_hba *phba,
 ...
 * Return: true if work posted to worker thread, otherwise false.
 **/
static bool lpfc_sli4_sp_handle_cqe(struct lpfc_hba *phba,
    struct lpfc_queue *cq,
    struct lpfc_cqe *cqe) {
 ...
 *
 **/
static void lpfc_sli4_sp_handle_eqe(struct lpfc_hba *phba, struct lpfc_eqe *eqe,
 ...
 **/
static bool __lpfc_sli4_process_cq(struct lpfc_hba *phba, struct lpfc_queue *cq,
 ...
 **/
static void __lpfc_sli4_sp_process_cq(struct lpfc_queue *cq) {
 ...
 **/
static void lpfc_sli4_sp_process_cq(struct work_struct *work) {
 ...
 * translates from the work handler and calls the slow-path handler.
 **/
static void lpfc_sli4_dly_sp_process_cq(struct work_struct *work) {
 ...
 **/
static void lpfc_sli4_fp_handle_fcp_wcqe(struct lpfc_hba *phba,
    struct lpfc_queue *cq,
    struct lpfc_wcqe_complete *wcqe) {
  struct lpfc_sli_ring *pring = cq->pring;
  struct lpfc_iocbq *cmdiocbq;
 ...
 * proper WQ release routine to the slow-path WQ.
 **/
static void lpfc_sli4_fp_handle_rel_wcqe(struct lpfc_hba *phba,
    struct lpfc_queue *cq,
    struct lpfc_wcqe_release *wcqe) {
 ...
 * Return: true if work posted to worker thread, otherwise false.
 **/
static bool lpfc_sli4_nvmet_handle_rcqe(struct lpfc_hba *phba,
    struct lpfc_queue *cq,
    struct lpfc_rcqe *rcqe) {
  bool workposted = false;
  struct lpfc_queue *hrq;
 ...
 * the delay indicates when to reschedule it.
 **/
static void __lpfc_sli4_hba_process_cq(struct lpfc_queue *cq) {
  struct lpfc_hba *phba = cq->phba;
  unsigned long delay;
  bool workposted = false;
  int ret;
 ...
 **/
static void lpfc_sli4_hba_process_cq(struct work_struct *work) {
 ...
 * translates from the work handler and calls the fast-path handler.
 **/
static void lpfc_sli4_dly_hba_process_cq(struct work_struct *work) {
  struct lpfc_queue *cq = container_of(to_delayed_work(work),
...
static inline void __lpfc_sli4_switch_eqmode(struct lpfc_queue *eq,
    uint8_t mode) {
  if (mode == eq->mode) {
    return;
  }
 ...
 */
static void __iomem *lpfc_dual_chute_pci_bar_map(struct lpfc_hba *phba,
    uint16_t pci_barset) {
  if (!phba->pcidev) {
    return NULL;
  }
 ...
 **/
int lpfc_eq_create(struct lpfc_hba *phba, struct lpfc_queue *eq,
    uint32_t imax) {
 ...
 * fails this function will return -ENXIO.
 **/
int lpfc_cq_create(struct lpfc_hba *phba, struct lpfc_queue *cq,
 ...
 **/
static void lpfc_mq_create_fb_init(struct lpfc_hba *phba, struct lpfc_queue *mq,
 ...
 * fails this function will return -ENXIO.
 **/
int32_t lpfc_mq_create(struct lpfc_hba *phba, struct lpfc_queue *mq,
 ...
 * fails this function will return -ENXIO.
 **/
int lpfc_wq_create(struct lpfc_hba *phba, struct lpfc_queue *wq,
    struct lpfc_queue *cq, uint32_t subtype) {
 ...
 * fails this function will return -ENXIO.
 **/
int lpfc_rq_create(struct lpfc_hba *phba, struct lpfc_queue *hrq,
 ...
 **/
int lpfc_eq_destroy(struct lpfc_hba *phba, struct lpfc_queue *eq) {
  LPFC_MBOXQ_t *mbox;
  int rc, length, status = 0;
  uint32_t shdr_status, shdr_add_status;
  union lpfc_sli4_cfg_shdr *shdr;
 ...
 * command fails this function will return -ENXIO.
 **/
int lpfc_cq_destroy(struct lpfc_hba *phba, struct lpfc_queue *cq) {
  LPFC_MBOXQ_t *mbox;
  int rc, length, status = 0;
  uint32_t shdr_status, shdr_add_status;
  union lpfc_sli4_cfg_shdr *shdr;
 ...
 * command fails this function will return -ENXIO.
 **/
int lpfc_mq_destroy(struct lpfc_hba *phba, struct lpfc_queue *mq) {
  LPFC_MBOXQ_t *mbox;
  int rc, length, status = 0;
  uint32_t shdr_status, shdr_add_status;
  union lpfc_sli4_cfg_shdr *shdr;
 ...
 * command fails this function will return -ENXIO.
 **/
int lpfc_wq_destroy(struct lpfc_hba *phba, struct lpfc_queue *wq) {
  LPFC_MBOXQ_t *mbox;
  int rc, length, status = 0;
  uint32_t shdr_status, shdr_add_status;
  union lpfc_sli4_cfg_shdr *shdr;
 ...
 * command fails this function will return -ENXIO.
 **/
int lpfc_rq_destroy(struct lpfc_hba *phba, struct lpfc_queue *hrq,
    struct lpfc_queue *drq) {
  LPFC_MBOXQ_t *mbox;
  int rc, length, status = 0;
  uint32_t shdr_status, shdr_add_status;
 ...
 **/
static uint16_t lpfc_sli4_alloc_xri(struct lpfc_hba *phba) {
  unsigned long xri;
  /*
 ...
 **/
static void __lpfc_sli4_free_xri(struct lpfc_hba *phba, int xri) {
 ...
 * stopped.
 **/
static int lpfc_sli4_post_sgl_list(struct lpfc_hba *phba,
 ...
 *
 **/
static int lpfc_sli4_post_io_sgl_block(struct lpfc_hba *phba,
 ...
 **/
static int lpfc_fc_frame_check(struct lpfc_hba *phba,
    struct fc_frame_header *fc_hdr) {
 ...
 * vport.
 **/
static struct lpfc_vport *lpfc_fc_frame_to_vport(struct lpfc_hba *phba,
    struct fc_frame_header *fc_hdr,
 ...
 * timed out.
 **/
static void lpfc_update_rcv_time_stamp(struct lpfc_vport *vport) {
  struct lpfc_dmabuf *h_buf;
 ...
 **/
static struct hbq_dmabuf *lpfc_fc_frame_add(struct lpfc_vport *vport,
    struct hbq_dmabuf *dmabuf) {
 ...
 **/
static bool lpfc_sli4_abort_partial_seq(struct lpfc_vport *vport,
    struct hbq_dmabuf *dmabuf) {
  struct fc_frame_header *new_hdr;
  struct fc_frame_header *temp_hdr;
 ...
 *          at ulp.
 **/
static bool lpfc_sli4_abort_ulp_seq(struct lpfc_vport *vport,
    struct hbq_dmabuf *dmabuf) {
  struct lpfc_hba *phba = vport->phba;
  int handled;
 ...
 * accept iocb.
 **/
static void lpfc_sli4_seq_abort_rsp_cmpl(struct lpfc_hba *phba,
 ...
 **/
static void lpfc_sli4_handle_unsol_abort(struct lpfc_vport *vport,
    struct hbq_dmabuf *dmabuf) {
  struct lpfc_hba *phba = vport->phba;
  struct fc_frame_header fc_hdr;
  uint32_t fctl;
 ...
 **/
static int lpfc_seq_complete(struct hbq_dmabuf *dmabuf) {
 ...
 **/
static struct lpfc_iocbq *lpfc_prep_seq(struct lpfc_vport *vport,
    struct hbq_dmabuf *seq_dmabuf) {
  struct hbq_dmabuf *hbq_buf;
...
static void lpfc_sli4_send_seq_to_ulp(struct lpfc_vport *vport,
    struct hbq_dmabuf *seq_dmabuf) {
  struct fc_frame_header *fc_hdr;
...
static void lpfc_sli4_mds_loopback_cmpl(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdiocb,
    struct lpfc_iocbq *rspiocb) {
 ...
 * available rpis maintained by the driver.
 **/
static void __lpfc_sli4_free_rpi(struct lpfc_hba *phba, int rpi) {
  /*
 ...
 **/
static void lpfc_mbx_cmpl_add_fcf_record(struct lpfc_hba *phba,
    LPFC_MBOXQ_t *mboxq) {
  void *virt_addr;
  union lpfc_sli4_cfg_shdr *shdr;
  uint32_t shdr_status, shdr_add_status;
 ...
 * 1=success 0=failure
 **/
static int lpfc_check_next_fcf_pri_level(struct lpfc_hba *phba) {
 ...
 **/
static void lpfc_mbx_cmpl_redisc_fcf_table(struct lpfc_hba *phba,
    LPFC_MBOXQ_t *mbox) {
 ...
 **/
static uint32_t lpfc_sli_get_config_region23(struct lpfc_hba *phba,
    char *rgn23_data) {
 ...
 * will be returned, otherwise, 0 will be returned.
 **/
static uint32_t lpfc_sli4_get_config_region23(struct lpfc_hba *phba,
    char *rgn23_data) {
 ...
 **/
static void lpfc_log_fw_write_cmpl(struct lpfc_hba *phba, u32 shdr_status,
 ...
 **/
int lpfc_wr_object(struct lpfc_hba *phba, struct list_head *dmabuf_list,
 ...
 **/
static bool _lpfc_move_xri_pbl_to_pvt(struct lpfc_hba *phba,
    struct lpfc_sli4_hdw_queue *qp,
    struct lpfc_pbl_pool *pbl_pool,
 ...
 **/
static struct lpfc_io_buf *lpfc_get_io_buf_from_private_pool(
    struct lpfc_hba *phba,
    struct lpfc_sli4_hdw_queue *qp,
    struct lpfc_pvt_pool *pvt_pool,
    struct lpfc_nodelist *ndlp) {
 ...
 **/
static struct lpfc_io_buf *lpfc_get_io_buf_from_expedite_pool(
    struct lpfc_hba *phba) {
 ...
 *   NULL - if private pool is empty
 **/
static struct lpfc_io_buf *lpfc_get_io_buf_from_multixri_pools(
    struct lpfc_hba *phba,
    struct lpfc_nodelist *ndlp,
...
static inline struct lpfc_io_buf *lpfc_io_buf(struct lpfc_hba *phba,
    struct lpfc_nodelist *ndlp,
    int idx) {
  struct lpfc_sli4_hdw_queue *qp;
 ...
 * the memory.
 */
int lpfc_read_object(struct lpfc_hba *phba, char *rdobject, uint32_t *datap,
    uint32_t datasz) {
  ...
  u32 rd_object_name[LPFC_MBX_OBJECT_NAME_LEN_DW] = {
    0
  };
  mbox = mempool_alloc(phba->mbox_mem_pool, GFP_KERNEL);
  if (!mbox) {
