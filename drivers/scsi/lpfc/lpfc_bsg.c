...
static void lpfc_free_bsg_buffers(struct lpfc_hba *phba,
    struct lpfc_dmabuf *mlist) {
...
static struct lpfc_dmabuf *lpfc_alloc_bsg_buffers(struct lpfc_hba *phba,
    unsigned int size,
...
static unsigned int lpfc_bsg_copy_data(struct lpfc_dmabuf *dma_buffers,
 ...
 **/
static void lpfc_bsg_send_mgmt_cmd_cmp(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdiocbq,
 ...
 **/
static int lpfc_bsg_send_mgmt_cmd(struct bsg_job *job) {
 ...
 * sleeps for the iocb completion.
 **/
static void lpfc_bsg_rport_els_cmp(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdiocbq,
    struct lpfc_iocbq *rspiocbq) {
  struct bsg_job_data *dd_data;
  struct bsg_job *job;
 ...
 * @job: fc_bsg_job to handle
 **/
static int lpfc_bsg_rport_els(struct bsg_job *job) {
  struct lpfc_vport *vport = shost_priv(fc_bsg_to_shost(job));
  struct lpfc_hba *phba = vport->phba;
  struct lpfc_rport_data *rdata = fc_bsg_to_rport(job)->dd_data;
  struct lpfc_nodelist *ndlp = rdata->pnode;
 ...
 **/
static void lpfc_bsg_event_free(struct kref *kref) {
 ...
 **/
static inline void lpfc_bsg_event_ref(struct lpfc_bsg_event *evt) {
  kref_get(&evt->kref);
}
 ...
 * @evt: Pointer to an event structure.
 **/
static inline void lpfc_bsg_event_unref(struct lpfc_bsg_event *evt) {
 ...
 **/
static struct lpfc_bsg_event *lpfc_bsg_event_new(uint32_t ev_mask,
    int ev_reg_id,
    uint32_t ev_req_id) {
 ...
 **/
static int diag_cmd_data_free(struct lpfc_hba *phba,
    struct lpfc_dmabufext *mlist) {
 ...
 **/
int lpfc_bsg_ct_unsol_event(struct lpfc_hba *phba, struct lpfc_sli_ring *pring,
 ...
 * no context exists.
 **/
int lpfc_bsg_ct_unsol_abort(struct lpfc_hba *phba, struct hbq_dmabuf *dmabuf) {
 ...
 **/
static int lpfc_bsg_hba_get_event(struct bsg_job *job) {
  struct lpfc_vport *vport = shost_priv(fc_bsg_to_shost(job));
  struct lpfc_hba *phba = vport->phba;
  struct fc_bsg_request *bsg_request = job->request;
  struct fc_bsg_reply *bsg_reply = job->reply;
 ...
 * sleeps for the iocb completion.
 **/
static void lpfc_issue_ct_rsp_cmp(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdiocbq,
    struct lpfc_iocbq *rspiocbq) {
  struct bsg_job_data *dd_data;
  struct bsg_job *job;
 ...
 **/
static int lpfc_issue_ct_rsp(struct lpfc_hba *phba, struct bsg_job *job,
    uint32_t tag,
 ...
 **/
static int lpfc_bsg_send_mgmt_rsp(struct bsg_job *job) {
  struct lpfc_vport *vport = shost_priv(fc_bsg_to_shost(job));
  struct lpfc_hba *phba = vport->phba;
  struct fc_bsg_request *bsg_request = job->request;
  struct fc_bsg_reply *bsg_reply = job->reply;
 ...
 * on device.
 */
static int lpfc_bsg_diag_mode_enter(struct lpfc_hba *phba) {
 ...
 */
static void lpfc_bsg_diag_mode_exit(struct lpfc_hba *phba) {
  struct Scsi_Host *shost;
  struct lpfc_vport **vports;
  int i;
  vports = lpfc_create_vport_work_array(phba);
 ...
 */
static int lpfc_sli3_bsg_diag_loopback_mode(struct lpfc_hba *phba,
    struct bsg_job *job) {
  struct fc_bsg_request *bsg_request = job->request;
  struct fc_bsg_reply *bsg_reply = job->reply;
 ...
 */
static int lpfc_sli4_bsg_set_link_diag_state(struct lpfc_hba *phba,
    uint32_t diag) {
  LPFC_MBOXQ_t *pmboxq;
 ...
 */
static int lpfc_sli4_bsg_set_loopback_mode(struct lpfc_hba *phba, int mode,
    uint32_t link_no) {
  LPFC_MBOXQ_t *pmboxq;
  uint32_t req_len, alloc_len;
 ...
 */
static int lpfc_sli4_diag_fcport_reg_setup(struct lpfc_hba *phba) {
 ...
 * loopback mode in order to perform a diagnostic loopback test.
 */
static int lpfc_sli4_bsg_diag_loopback_mode(struct lpfc_hba *phba,
    struct bsg_job *job) {
  struct fc_bsg_request *bsg_request = job->request;
  struct fc_bsg_reply *bsg_reply = job->reply;
  struct diag_mode_set *loopback_mode;
 ...
 */
static int lpfc_bsg_diag_loopback_mode(struct bsg_job *job) {
  struct Scsi_Host *shost;
 ...
 * command from the user to proper driver action routines.
 */
static int lpfc_sli4_bsg_diag_mode_end(struct bsg_job *job) {
  struct fc_bsg_request *bsg_request = job->request;
  struct fc_bsg_reply *bsg_reply = job->reply;
  struct Scsi_Host *shost;
  struct lpfc_vport *vport;
 ...
 * applicaiton.
 */
static int lpfc_sli4_bsg_link_diag_test(struct bsg_job *job) {
  struct fc_bsg_request *bsg_request = job->request;
  struct fc_bsg_reply *bsg_reply = job->reply;
  struct Scsi_Host *shost;
  struct lpfc_vport *vport;
 ...
 **/
static struct lpfc_dmabuf *lpfc_bsg_dma_page_alloc(struct lpfc_hba *phba) {
  struct lpfc_dmabuf *dmabuf;
 ...
 **/
static void lpfc_bsg_dma_page_free(struct lpfc_hba *phba,
    struct lpfc_dmabuf *dmabuf) {
  struct pci_dev *pcidev = phba->pcidev;
  if (!dmabuf) {
    return;
 ...
 **/
static void lpfc_bsg_dma_page_list_free(struct lpfc_hba *phba,
 ...
 **/
static struct lpfc_dmabufext *diag_cmd_data_alloc(struct lpfc_hba *phba,
 ...
 * of loopback mode.
 **/
static int lpfc_bsg_diag_loopback_run(struct bsg_job *job) {
  struct lpfc_vport *vport = shost_priv(fc_bsg_to_shost(job));
  struct fc_bsg_reply *bsg_reply = job->reply;
  struct lpfc_hba *phba = vport->phba;
  struct lpfc_bsg_event *evt;
 ...
 **/
static int lpfc_bsg_get_dfc_rev(struct bsg_job *job) {
  struct lpfc_vport *vport = shost_priv(fc_bsg_to_shost(job));
  struct fc_bsg_reply *bsg_reply = job->reply;
  struct lpfc_hba *phba = vport->phba;
 ...
 * of the mailbox.
 **/
static void lpfc_bsg_issue_mbox_cmpl(struct lpfc_hba *phba,
    LPFC_MBOXQ_t *pmboxq) {
  struct bsg_job_data *dd_data;
  struct fc_bsg_reply *bsg_reply;
  struct bsg_job *job;
 ...
 * command session.
 **/
static void lpfc_bsg_mbox_ext_session_reset(struct lpfc_hba *phba) {
 ...
 **/
static struct bsg_job *lpfc_bsg_issue_mbox_ext_handle_job(struct lpfc_hba *phba,
    LPFC_MBOXQ_t *pmboxq) {
  struct bsg_job_data *dd_data;
  struct bsg_job *job;
  struct fc_bsg_reply *bsg_reply;
 ...
 * external buffers.
 **/
static void lpfc_bsg_issue_read_mbox_ext_cmpl(struct lpfc_hba *phba,
    LPFC_MBOXQ_t *pmboxq) {
  struct bsg_job *job;
  struct fc_bsg_reply *bsg_reply;
 ...
 * external buffers.
 **/
static void lpfc_bsg_issue_write_mbox_ext_cmpl(struct lpfc_hba *phba,
    LPFC_MBOXQ_t *pmboxq) {
  struct bsg_job *job;
  struct fc_bsg_reply *bsg_reply;
  job = lpfc_bsg_issue_mbox_ext_handle_job(phba, pmboxq);
...
static void lpfc_bsg_sli_cfg_dma_desc_setup(struct lpfc_hba *phba,
 ...
 **/
static int lpfc_bsg_sli_cfg_read_cmd_ext(struct lpfc_hba *phba,
    struct bsg_job *job,
    enum nemb_type nemb_tp,
    struct lpfc_dmabuf *dmabuf) {
  struct fc_bsg_request *bsg_request = job->request;
 ...
 * non-embedded external buffers.
 **/
static int lpfc_bsg_sli_cfg_write_cmd_ext(struct lpfc_hba *phba,
    struct bsg_job *job,
    enum nemb_type nemb_tp,
    struct lpfc_dmabuf *dmabuf) {
  struct fc_bsg_request *bsg_request = job->request;
 ...
 **/
static int lpfc_bsg_handle_sli_cfg_mbox(struct lpfc_hba *phba,
    struct bsg_job *job,
    struct lpfc_dmabuf *dmabuf) {
  struct lpfc_sli_config_mbox *sli_cfg_mbx;
  uint32_t subsys;
 ...
 **/
static void lpfc_bsg_mbox_ext_abort(struct lpfc_hba *phba) {
 ...
 **/
static int lpfc_bsg_read_ebuf_get(struct lpfc_hba *phba, struct bsg_job *job) {
  struct fc_bsg_reply *bsg_reply = job->reply;
  struct lpfc_sli_config_mbox *sli_cfg_mbx;
  struct lpfc_dmabuf *dmabuf;
  uint8_t *pbuf;
 ...
 **/
static int lpfc_bsg_write_ebuf_set(struct lpfc_hba *phba, struct bsg_job *job,
    struct lpfc_dmabuf *dmabuf) {
  struct fc_bsg_reply *bsg_reply = job->reply;
  struct bsg_job_data *dd_data = NULL;
  LPFC_MBOXQ_t *pmboxq = NULL;
 ...
 **/
static int lpfc_bsg_handle_sli_cfg_ebuf(struct lpfc_hba *phba,
    struct bsg_job *job,
    struct lpfc_dmabuf *dmabuf) {
  int rc;
  lpfc_printf_log(phba, KERN_INFO, LOG_LIBDFC,
 ...
 **/
static int lpfc_bsg_handle_sli_cfg_ext(struct lpfc_hba *phba,
    struct bsg_job *job,
    struct lpfc_dmabuf *dmabuf) {
  struct fc_bsg_request *bsg_request = job->request;
  struct dfc_mbox_req *mbox_req;
 ...
 **/
static int lpfc_bsg_issue_mbox(struct lpfc_hba *phba, struct bsg_job *job,
    struct lpfc_vport *vport) {
  struct fc_bsg_request *bsg_request = job->request;
  struct fc_bsg_reply *bsg_reply = job->reply;
 ...
 **/
static int lpfc_bsg_mbox_cmd(struct bsg_job *job) {
  struct lpfc_vport *vport = shost_priv(fc_bsg_to_shost(job));
  struct fc_bsg_request *bsg_request = job->request;
  struct fc_bsg_reply *bsg_reply = job->reply;
  struct lpfc_hba *phba = vport->phba;
...
static int lpfc_forced_link_speed(struct bsg_job *job) {
 ...
 **/
static int lpfc_bsg_get_ras_config(struct bsg_job *job) {
  struct Scsi_Host *shost = fc_bsg_to_shost(job);
  struct lpfc_vport *vport = shost_priv(shost);
  struct fc_bsg_reply *bsg_reply = job->reply;
  struct lpfc_hba *phba = vport->phba;
 ...
 **/
static int lpfc_bsg_set_ras_config(struct bsg_job *job) {
  struct Scsi_Host *shost = fc_bsg_to_shost(job);
  struct lpfc_vport *vport = shost_priv(shost);
  struct lpfc_hba *phba = vport->phba;
 ...
 * in host memory
 **/
static int lpfc_bsg_get_ras_lwpd(struct bsg_job *job) {
  struct Scsi_Host *shost = fc_bsg_to_shost(job);
  struct lpfc_vport *vport = shost_priv(shost);
 ...
 **/
static int lpfc_bsg_get_ras_fwlog(struct bsg_job *job) {
  struct Scsi_Host *shost = fc_bsg_to_shost(job);
  struct lpfc_vport *vport = shost_priv(shost);
  struct lpfc_hba *phba = vport->phba;
  struct fc_bsg_request *bsg_request = job->request;
...
static int lpfc_get_trunk_info(struct bsg_job *job) {
  struct lpfc_vport *vport = shost_priv(fc_bsg_to_shost(job));
  struct lpfc_hba *phba = vport->phba;
  struct fc_bsg_reply *bsg_reply = job->reply;
...
static int lpfc_get_cgnbuf_info(struct bsg_job *job) {
  struct lpfc_vport *vport = shost_priv(fc_bsg_to_shost(job));
  struct lpfc_hba *phba = vport->phba;
  struct fc_bsg_request *bsg_request = job->request;
  struct fc_bsg_reply *bsg_reply = job->reply;
 ...
 * @job: fc_bsg_job to handle
 **/
static int lpfc_bsg_hst_vendor(struct bsg_job *job) {
  struct fc_bsg_request *bsg_request = job->request;
  struct fc_bsg_reply *bsg_reply = job->reply;
