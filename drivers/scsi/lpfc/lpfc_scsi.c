...
static struct lpfc_rport_data *lpfc_rport_data_from_scsi_device(
...
static void lpfc_release_scsi_buf_s4(struct lpfc_hba *phba,
    struct lpfc_io_buf *psb);
static void lpfc_release_scsi_buf_s3(struct lpfc_hba *phba,
    struct lpfc_io_buf *psb);
static int lpfc_prot_group_type(struct lpfc_hba *phba, struct scsi_cmnd *sc);
 ...
 **/
static void lpfc_sli4_set_rsp_sgl_last(struct lpfc_hba *phba,
 ...
 **/
static int lpfc_new_scsi_buf_s3(struct lpfc_vport *vport, int num_to_alloc) {
 ...
 **/
static struct lpfc_io_buf *lpfc_get_scsi_buf_s3(struct lpfc_hba *phba,
    struct lpfc_nodelist *ndlp,
 ...
 *   Pointer to lpfc_scsi_buf - Success
 **/
static struct lpfc_io_buf *lpfc_get_scsi_buf_s4(struct lpfc_hba *phba,
    struct lpfc_nodelist *ndlp,
    struct scsi_cmnd *cmnd) {
  struct lpfc_io_buf *lpfc_cmd;
  struct lpfc_sli4_hdw_queue *qp;
 ...
 *   Pointer to lpfc_scsi_buf - Success
 **/
static struct lpfc_io_buf *lpfc_get_scsi_buf(struct lpfc_hba *phba,
    struct lpfc_nodelist *ndlp,
    struct scsi_cmnd *cmnd) {
 ...
 * lpfc_scsi_buf_list list.
 **/
static void lpfc_release_scsi_buf(struct lpfc_hba *phba,
    struct lpfc_io_buf *psb) {
 ...
 **/
static void lpfc_fcpcmd_to_iocb(u8 *data, struct fcp_cmnd *fcp_cmnd) {
  int i, j;
 ...
 *   0 - Success
 **/
static int lpfc_scsi_prep_dma_buf_s3(struct lpfc_hba *phba,
    struct lpfc_io_buf *lpfc_cmd) {
 ...
 **/
static int lpfc_bg_err_inject(struct lpfc_hba *phba, struct scsi_cmnd *sc,
 ...
 *
 **/
static int lpfc_sc_to_bg_opcodes(struct lpfc_hba *phba, struct scsi_cmnd *sc,
 ...
 *
 **/
static int lpfc_bg_err_opcodes(struct lpfc_hba *phba, struct scsi_cmnd *sc,
    uint8_t *txop, uint8_t *rxop) {
  if (sc->prot_flags & SCSI_PROT_IP_CHECKSUM) {
    switch (scsi_get_prot_op(sc)) {
      case SCSI_PROT_READ_INSERT:
 ...
 **/
static int lpfc_bg_setup_bpl(struct lpfc_hba *phba, struct scsi_cmnd *sc,
 ...
 * Returns the number of BDEs added to the BPL.
 **/
static int lpfc_bg_setup_bpl_prot(struct lpfc_hba *phba, struct scsi_cmnd *sc,
 ...
 **/
static uint32_t lpfc_bg_setup_sgl(struct lpfc_hba *phba, struct scsi_cmnd *sc,
 ...
 * Returns the number of SGEs added to the SGL.
 **/
static uint32_t lpfc_bg_setup_sgl_prot(struct lpfc_hba *phba,
    struct scsi_cmnd *sc,
 ...
 **/
static int lpfc_bg_scsi_adjust_dl(struct lpfc_hba *phba,
    struct lpfc_io_buf *lpfc_cmd) {
 ...
 **/
static int lpfc_bg_scsi_prep_dma_buf_s3(struct lpfc_hba *phba,
    struct lpfc_io_buf *lpfc_cmd) {
  struct scsi_cmnd *scsi_cmnd = lpfc_cmd->pCmd;
  struct fcp_cmnd *fcp_cmnd = lpfc_cmd->fcp_cmnd;
  struct ulp_bde64 *bpl = (struct ulp_bde64 *) lpfc_cmd->dma_sgl;
 ...
 * using crc_t10dif.
 */
static uint16_t lpfc_bg_crc(uint8_t *data, int count) {
  uint16_t crc = 0;
  uint16_t x;
 ...
 */
static uint16_t lpfc_bg_csum(uint8_t *data, int count) {
  uint16_t ret;
 ...
 */
static void lpfc_calc_bg_err(struct lpfc_hba *phba,
    struct lpfc_io_buf *lpfc_cmd) {
  struct scatterlist *sgpe; /* s/g prot entry */
 ...
 */
static int lpfc_parse_bg_err(struct lpfc_hba *phba,
    struct lpfc_io_buf *lpfc_cmd,
 ...
 *  0 - Success
 **/
static int lpfc_scsi_prep_dma_buf_s4(struct lpfc_hba *phba,
    struct lpfc_io_buf *lpfc_cmd) {
  struct scsi_cmnd *scsi_cmnd = lpfc_cmd->pCmd;
  struct scatterlist *sgel = NULL;
  struct fcp_cmnd *fcp_cmnd = lpfc_cmd->fcp_cmnd;
 ...
 *  0 - Success
 **/
static int lpfc_bg_scsi_prep_dma_buf_s4(struct lpfc_hba *phba,
    struct lpfc_io_buf *lpfc_cmd) {
  struct scsi_cmnd *scsi_cmnd = lpfc_cmd->pCmd;
  struct fcp_cmnd *fcp_cmnd = lpfc_cmd->fcp_cmnd;
  struct sli4_sge *sgl = (struct sli4_sge *) (lpfc_cmd->dma_sgl);
 ...
 *  0 - Success
 **/
static inline int lpfc_scsi_prep_dma_buf(struct lpfc_hba *phba,
    struct lpfc_io_buf *lpfc_cmd) {
 ...
 *  0 - Success
 **/
static inline int lpfc_bg_scsi_prep_dma_buf(struct lpfc_hba *phba,
    struct lpfc_io_buf *lpfc_cmd) {
 ...
 *  0 - Success
 **/
static inline int lpfc_scsi_prep_cmnd_buf(struct lpfc_vport *vport,
    struct lpfc_io_buf *lpfc_cmd,
    uint8_t tmo) {
 ...
 **/
static void lpfc_send_scsi_error_event(struct lpfc_hba *phba,
 ...
 **/
static void lpfc_scsi_unprep_dma_buf(struct lpfc_hba *phba,
    struct lpfc_io_buf *psb) {
  /*
 ...
 */
int lpfc_update_cmf_cmpl(struct lpfc_hba *phba,
 ...
 */
int lpfc_update_cmf_cmd(struct lpfc_hba *phba, uint32_t size) {
  uint64_t total;
  struct lpfc_cgn_stat *cgs;
  int cpu;
 ...
 **/
static void lpfc_handle_fcp_err(struct lpfc_vport *vport,
    struct lpfc_io_buf *lpfc_cmd,
    uint32_t fcpi_parm) {
  struct scsi_cmnd *cmnd = lpfc_cmd->pCmd;
 ...
 **/
static void lpfc_fcp_io_cmd_wqe_cmpl(struct lpfc_hba *phba,
 ...
 * well by ramping down device queue depth.
 **/
static void lpfc_scsi_cmd_iocb_cmpl(struct lpfc_hba *phba,
 ...
 **/
static int lpfc_scsi_prep_cmnd(struct lpfc_vport *vport,
    struct lpfc_io_buf *lpfc_cmd,
 ...
 *   1 - Success
 **/
static int lpfc_scsi_prep_task_mgmt_cmd_s3(struct lpfc_vport *vport,
    struct lpfc_io_buf *lpfc_cmd,
 ...
 *   1 - Success
 **/
static int lpfc_scsi_prep_task_mgmt_cmd_s4(struct lpfc_vport *vport,
    struct lpfc_io_buf *lpfc_cmd,
    u64 lun, u8 task_mgmt_cmd) {
  struct lpfc_iocbq *pwqeq = &lpfc_cmd->cur_iocbq;
  union lpfc_wqe128 *wqe = &pwqeq->wqe;
 ...
 **/
static void lpfc_tskmgmt_def_cmpl(struct lpfc_hba *phba,
 ...
 **/
static int lpfc_queuecommand(struct Scsi_Host *shost, struct scsi_cmnd *cmnd) {
 ...
 *   0x2002 - Success
 **/
static int lpfc_abort_handler(struct scsi_cmnd *cmnd) {
...
static char *lpfc_taskmgmt_name(uint8_t task_mgmt_cmd) {
 ...
 *   0x2002 - Success
 **/
static int lpfc_check_fcp_rsp(struct lpfc_vport *vport,
    struct lpfc_io_buf *lpfc_cmd) {
  struct fcp_rsp *fcprsp = lpfc_cmd->fcp_rsp;
  uint32_t rsp_info;
  uint32_t rsp_len;
 ...
 *   0x2002 - Success.
 **/
static int lpfc_send_taskmgmt(struct lpfc_vport *vport, struct fc_rport *rport,
 ...
 *  0x2002 - Success
 **/
static int lpfc_chk_tgt_mapped(struct lpfc_vport *vport,
    struct fc_rport *rport) {
  struct lpfc_rport_data *rdata;
 ...
 *  0x2002 - Success
 **/
static int lpfc_reset_flush_io_context(struct lpfc_vport *vport,
    uint16_t tgt_id,
 ...
 *  0x2002 - Success
 **/
static int lpfc_device_reset_handler(struct scsi_cmnd *cmnd) {
  struct Scsi_Host *shost = cmnd->device->host;
  struct fc_rport *rport = starget_to_rport(scsi_target(cmnd->device));
  struct lpfc_vport *vport = (struct lpfc_vport *) shost->hostdata;
  struct lpfc_rport_data *rdata;
 ...
 *  0x2002 - Success
 **/
static int lpfc_target_reset_handler(struct scsi_cmnd *cmnd) {
  struct Scsi_Host *shost = cmnd->device->host;
  struct fc_rport *rport = starget_to_rport(scsi_target(cmnd->device));
  struct lpfc_vport *vport = (struct lpfc_vport *) shost->hostdata;
  struct lpfc_rport_data *rdata;
 ...
 *  0x2002 - Success
 **/
static int lpfc_host_reset_handler(struct scsi_cmnd *cmnd) {
  struct Scsi_Host *shost = cmnd->device->host;
  struct lpfc_vport *vport = (struct lpfc_vport *) shost->hostdata;
  struct lpfc_hba *phba = vport->phba;
  int rc, ret = SUCCESS;
 ...
 *   0 - Success
 **/
static int lpfc_slave_alloc(struct scsi_device *sdev) {
  struct lpfc_vport *vport = (struct lpfc_vport *) sdev->host->hostdata;
  struct lpfc_hba *phba = vport->phba;
 ...
 **/
struct lpfc_device_data *lpfc_create_device_data(struct lpfc_hba *phba,
 ...
 *
 **/
void lpfc_delete_device_data(struct lpfc_hba *phba,
    struct lpfc_device_data *lun_info) {
 ...
 *   Pointer to lpfc_device_data - Success
 **/
struct lpfc_device_data *__lpfc_get_device_data(struct lpfc_hba *phba,
 ...
 *   0 - Success
 **/
bool lpfc_find_next_oas_lun(struct lpfc_hba *phba, struct lpfc_name *vport_wwpn,
 ...
 *   true - Success
 **/
bool lpfc_enable_oas_lun(struct lpfc_hba *phba, struct lpfc_name *vport_wwpn,
 ...
 *   true - Success
 **/
bool lpfc_disable_oas_lun(struct lpfc_hba *phba, struct lpfc_name *vport_wwpn,
    struct lpfc_name *target_wwpn, uint64_t lun, uint8_t pri) {
  struct lpfc_device_data *lun_info;
  unsigned long flags;
  if (unlikely(!phba) || !vport_wwpn || !target_wwpn
...
static int lpfc_no_command(struct Scsi_Host *shost, struct scsi_cmnd *cmnd) {
  return SCSI_MLQUEUE_HOST_BUSY;
}

static int lpfc_no_slave(struct scsi_device *sdev) {
  return -ENODEV;
}
