...
static struct lpfc_io_buf *lpfc_get_nvme_buf(struct lpfc_hba *phba,
    struct lpfc_nodelist *ndlp,
    int idx, int expedite);

static void lpfc_release_nvme_buf(struct lpfc_hba *, struct lpfc_io_buf *);
 ...
 **/
static int lpfc_nvme_create_queue(struct nvme_fc_local_port *pnvme_lport,
 ...
 **/
static void lpfc_nvme_delete_queue(struct nvme_fc_local_port *pnvme_lport,
    unsigned int qidx,
    void *handle) {
  struct lpfc_nvme_lport *lport;
  struct lpfc_vport *vport;
...
static void lpfc_nvme_localport_delete(struct nvme_fc_local_port *localport) {
 ...
 * None
 */
static void lpfc_nvme_remoteport_delete(struct nvme_fc_remote_port *remoteport)
{
...
static void lpfc_nvme_ls_req_cmp(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdwqe,
...
static int lpfc_nvme_gen_req(struct lpfc_vport *vport, struct lpfc_dmabuf *bmp,
 ...
 *   non-zero: various error codes, in form of -Exxx
 **/
static int lpfc_nvme_ls_req(struct nvme_fc_local_port *pnvme_lport,
 ...
 **/
int __lpfc_nvme_ls_abort(struct lpfc_vport *vport, struct lpfc_nodelist *ndlp,
    struct nvmefc_ls_req *pnvme_lsreq) {
  struct lpfc_hba *phba = vport->phba;
...
static int lpfc_nvme_xmt_ls_rsp(struct nvme_fc_local_port *localport,
    struct nvme_fc_remote_port *remoteport,
 ...
 **/
static void lpfc_nvme_ls_abort(struct nvme_fc_local_port *pnvme_lport,
    struct nvme_fc_remote_port *pnvme_rport,
    struct nvmefc_ls_req *pnvme_lsreq) {
  struct lpfc_nvme_lport *lport;
  struct lpfc_vport *vport;
...
static inline void lpfc_nvme_adj_fcp_sgls(struct lpfc_vport *vport,
 ...
 *   TODO: What are the failure codes.
 **/
static void lpfc_nvme_io_cmd_cmpl(struct lpfc_hba *phba,
    struct lpfc_iocbq *pwqeIn,
 ...
 *   TODO: What are the failure codes.
 **/
static int lpfc_nvme_prep_io_cmd(struct lpfc_vport *vport,
    struct lpfc_io_buf *lpfc_ncmd,
 ...
 *   TODO: What are the failure codes.
 **/
static int lpfc_nvme_prep_io_dma(struct lpfc_vport *vport,
    struct lpfc_io_buf *lpfc_ncmd) {
  struct lpfc_hba *phba = vport->phba;
  struct nvmefc_fcp_req *nCmd = lpfc_ncmd->nvmeCmd;
 ...
 *   TODO: What are the failure codes.
 **/
static int lpfc_nvme_fcp_io_submit(struct nvme_fc_local_port *pnvme_lport,
    struct nvme_fc_remote_port *pnvme_rport,
 ...
 *   None
 **/
static void lpfc_nvme_fcp_abort(struct nvme_fc_local_port *pnvme_lport,
    struct nvme_fc_remote_port *pnvme_rport,
    void *hw_queue_handle,
    struct nvmefc_fcp_req *pnvme_fcreq) {
  struct lpfc_nvme_lport *lport;
 ...
 * aborted.
 **/
static void lpfc_release_nvme_buf(struct lpfc_hba *phba,
    struct lpfc_io_buf *lpfc_ncmd) {
  struct lpfc_sli4_hdw_queue *qp;
 ...
 */
static void lpfc_nvme_lport_unreg_wait(struct lpfc_vport *vport,
    struct lpfc_nvme_lport *lport,
