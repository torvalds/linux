 ...
 * not exceed @size.
 **/
static int lpfc_debugfs_disc_trc_data(struct lpfc_vport *vport, char *buf,
    int size) {
 ...
 * not exceed @size.
 **/
static int lpfc_debugfs_slow_ring_trc_data(struct lpfc_hba *phba, char *buf,
    int size) {
  int i, index, len, enable;
  uint32_t ms;
  struct lpfc_debugfs_trc *dtp;
 ...
 * not exceed @size.
 **/
static int lpfc_debugfs_hbqinfo_data(struct lpfc_hba *phba, char *buf,
    int size) {
  int len = 0;
 ...
 * not exceed @size.
 **/
static int lpfc_debugfs_commonxripools_data(struct lpfc_hba *phba, char *buf,
    int size) {
 ...
 * not exceed @size.
 **/
static int lpfc_debugfs_multixripools_data(struct lpfc_hba *phba, char *buf,
    int size) {
  u32 i;
  u32 hwq_count;
  struct lpfc_sli4_hdw_queue *qp;
 ...
 * not exceed @size.
 **/
static int lpfc_debugfs_lockstat_data(struct lpfc_hba *phba, char *buf,
    int size) {
  struct lpfc_sli4_hdw_queue *qp;
  int len = 0;
  int i;
 ...
 * not exceed @size.
 **/
static int lpfc_debugfs_dumpHBASlim_data(struct lpfc_hba *phba, char *buf,
    int size) {
  int len = 0;
  int i, off;
  uint32_t *ptr;
 ...
 * not exceed @size.
 **/
static int lpfc_debugfs_dumpHostSlim_data(struct lpfc_hba *phba, char *buf,
    int size) {
  int len = 0;
  int i, off;
 ...
 * not exceed @size.
 **/
static int lpfc_debugfs_nodelist_data(struct lpfc_vport *vport, char *buf,
    int size) {
  int len = 0;
 ...
 * not exceed @size.
 **/
static int lpfc_debugfs_nvmestat_data(struct lpfc_vport *vport, char *buf,
    int size) {
  struct lpfc_hba *phba = vport->phba;
 ...
 * not exceed @size.
 **/
static int lpfc_debugfs_scsistat_data(struct lpfc_vport *vport, char *buf,
    int size) {
  int len;
  struct lpfc_hba *phba = vport->phba;
  struct lpfc_fc4_ctrl_stat *cstat;
  ...
  int i;
  char tmp[LPFC_MAX_SCSI_INFO_TMP_LEN] = {
    0
  };
...
void lpfc_io_ktime(struct lpfc_hba *phba, struct lpfc_io_buf *lpfc_cmd) {
 ...
 * not exceed @size.
 **/
static int lpfc_debugfs_ioktime_data(struct lpfc_vport *vport, char *buf,
    int size) {
  struct lpfc_hba *phba = vport->phba;
  int len = 0;
 ...
 * not exceed @size.
 **/
static int lpfc_debugfs_nvmeio_trc_data(struct lpfc_hba *phba, char *buf,
    int size) {
 ...
 * not exceed @size.
 **/
static int lpfc_debugfs_hdwqstat_data(struct lpfc_vport *vport, char *buf,
    int size) {
  struct lpfc_hba *phba = vport->phba;
 ...
 **/
inline void lpfc_debugfs_disc_trc(struct lpfc_vport *vport, int mask, char *fmt,
 ...
 **/
inline void lpfc_debugfs_slow_ring_trc(struct lpfc_hba *phba, char *fmt,
    uint32_t data1, uint32_t data2, uint32_t data3) {
#ifdef CONFIG_SCSI_LPFC_DEBUG_FS
  struct lpfc_debugfs_trc *dtp;
  int index;
 ...
 * @data3 are used like printf when displaying the log.
 **/
inline void lpfc_debugfs_nvme_trc(struct lpfc_hba *phba, char *fmt,
 ...
 * error value.
 **/
static int lpfc_debugfs_disc_trc_open(struct inode *inode, struct file *file) {
 ...
 * error value.
 **/
static int lpfc_debugfs_slow_ring_trc_open(struct inode *inode,
    struct file *file) {
 ...
 * error value.
 **/
static int lpfc_debugfs_hbqinfo_open(struct inode *inode, struct file *file) {
  struct lpfc_hba *phba = inode->i_private;
  struct lpfc_debug *debug;
  int rc = -ENOMEM;
  debug = kmalloc(sizeof(*debug), GFP_KERNEL);
 ...
 * error value.
 **/
static int lpfc_debugfs_multixripools_open(struct inode *inode,
    struct file *file) {
  struct lpfc_hba *phba = inode->i_private;
  struct lpfc_debug *debug;
  int rc = -ENOMEM;
 ...
 * error value.
 **/
static int lpfc_debugfs_lockstat_open(struct inode *inode, struct file *file) {
  struct lpfc_hba *phba = inode->i_private;
  struct lpfc_debug *debug;
  int rc = -ENOMEM;
  debug = kmalloc(sizeof(*debug), GFP_KERNEL);
...
static ssize_t lpfc_debugfs_lockstat_write(struct file *file,
...
static int lpfc_debugfs_ras_log_release(struct inode *inode,
    struct file *file) {
  struct lpfc_debug *debug = file->private_data;
  vfree(debug->buffer);
  kfree(debug);
 ...
 * error value.
 **/
static int lpfc_debugfs_ras_log_open(struct inode *inode, struct file *file) {
  struct lpfc_hba *phba = inode->i_private;
  struct lpfc_debug *debug;
  int size;
  int rc = -ENOMEM;
 ...
 * error value.
 **/
static int lpfc_debugfs_dumpHBASlim_open(struct inode *inode,
    struct file *file) {
  struct lpfc_hba *phba = inode->i_private;
  struct lpfc_debug *debug;
  int rc = -ENOMEM;
 ...
 * error value.
 **/
static int lpfc_debugfs_dumpHostSlim_open(struct inode *inode,
    struct file *file) {
  struct lpfc_hba *phba = inode->i_private;
  struct lpfc_debug *debug;
  int rc = -ENOMEM;
...
static ssize_t lpfc_debugfs_dif_err_read(struct file *file, char __user *buf,
    size_t nbytes, loff_t *ppos) {
...
static ssize_t lpfc_debugfs_dif_err_write(struct file *file,
    const char __user *buf,
    size_t nbytes, loff_t *ppos) {
  struct dentry *dent = file->f_path.dentry;
  struct lpfc_hba *phba = file->private_data;
...
static int lpfc_debugfs_dif_err_release(struct inode *inode,
    struct file *file) {
  return 0;
}
 ...
 * error value.
 **/
static int lpfc_debugfs_nodelist_open(struct inode *inode, struct file *file) {
  struct lpfc_vport *vport = inode->i_private;
  struct lpfc_debug *debug;
  int rc = -ENOMEM;
  debug = kmalloc(sizeof(*debug), GFP_KERNEL);
 ...
 **/
static loff_t lpfc_debugfs_lseek(struct file *file, loff_t off, int whence) {
  struct lpfc_debug *debug = file->private_data;
 ...
 **/
static ssize_t lpfc_debugfs_read(struct file *file, char __user *buf,
    size_t nbytes, loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
 ...
 **/
static int lpfc_debugfs_release(struct inode *inode, struct file *file) {
  struct lpfc_debug *debug = file->private_data;
  kfree(debug->buffer);
  kfree(debug);
  return 0;
 ...
 * space.
 **/
static ssize_t lpfc_debugfs_multixripools_write(struct file *file,
    const char __user *buf,
    size_t nbytes, loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
  struct lpfc_hba *phba = (struct lpfc_hba *) debug->i_private;
...
static int lpfc_debugfs_nvmestat_open(struct inode *inode, struct file *file) {
  struct lpfc_vport *vport = inode->i_private;
  struct lpfc_debug *debug;
  int rc = -ENOMEM;
  debug = kmalloc(sizeof(*debug), GFP_KERNEL);
...
static ssize_t lpfc_debugfs_nvmestat_write(struct file *file,
    const char __user *buf,
    size_t nbytes, loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
...
static int lpfc_debugfs_scsistat_open(struct inode *inode, struct file *file) {
  struct lpfc_vport *vport = inode->i_private;
  struct lpfc_debug *debug;
  int rc = -ENOMEM;
  debug = kmalloc(sizeof(*debug), GFP_KERNEL);
...
static ssize_t lpfc_debugfs_scsistat_write(struct file *file,
    const char __user *buf,
    size_t nbytes, loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
  struct lpfc_vport *vport = (struct lpfc_vport *) debug->i_private;
...
static int lpfc_debugfs_ioktime_open(struct inode *inode, struct file *file) {
  struct lpfc_vport *vport = inode->i_private;
  struct lpfc_debug *debug;
  int rc = -ENOMEM;
  debug = kmalloc(sizeof(*debug), GFP_KERNEL);
...
static ssize_t lpfc_debugfs_ioktime_write(struct file *file,
    const char __user *buf,
    size_t nbytes, loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
  struct lpfc_vport *vport = (struct lpfc_vport *) debug->i_private;
...
static int lpfc_debugfs_nvmeio_trc_open(struct inode *inode,
    struct file *file) {
  struct lpfc_hba *phba = inode->i_private;
  struct lpfc_debug *debug;
  int rc = -ENOMEM;
...
static ssize_t lpfc_debugfs_nvmeio_trc_write(struct file *file,
    const char __user *buf,
    size_t nbytes, loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
  struct lpfc_hba *phba = (struct lpfc_hba *) debug->i_private;
...
static int lpfc_debugfs_hdwqstat_open(struct inode *inode, struct file *file) {
  struct lpfc_vport *vport = inode->i_private;
  struct lpfc_debug *debug;
  int rc = -ENOMEM;
  debug = kmalloc(sizeof(*debug), GFP_KERNEL);
...
static ssize_t lpfc_debugfs_hdwqstat_write(struct file *file,
    const char __user *buf,
    size_t nbytes, loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
  struct lpfc_vport *vport = (struct lpfc_vport *) debug->i_private;
 ...
 **/
static int lpfc_idiag_open(struct inode *inode, struct file *file) {
  struct lpfc_debug *debug;
  debug = kmalloc(sizeof(*debug), GFP_KERNEL);
  if (!debug) {
    return -ENOMEM;
 ...
 * This function returns zero.
 **/
static int lpfc_idiag_release(struct inode *inode, struct file *file) {
  struct lpfc_debug *debug = file->private_data;
 ...
 * This function returns zero.
 **/
static int lpfc_idiag_cmd_release(struct inode *inode, struct file *file) {
  struct lpfc_debug *debug = file->private_data;
 ...
 * than @nbytes if the end of the file was reached) or a negative error value.
 **/
static ssize_t lpfc_idiag_pcicfg_read(struct file *file, char __user *buf,
    size_t nbytes,
    loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
  struct lpfc_hba *phba = (struct lpfc_hba *) debug->i_private;
 ...
 * space.
 */
static ssize_t lpfc_idiag_pcicfg_write(struct file *file,
    const char __user *buf,
    size_t nbytes, loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
  struct lpfc_hba *phba = (struct lpfc_hba *) debug->i_private;
 ...
 * than @nbytes if the end of the file was reached) or a negative error value.
 **/
static ssize_t lpfc_idiag_baracc_read(struct file *file, char __user *buf,
    size_t nbytes,
    loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
  struct lpfc_hba *phba = (struct lpfc_hba *) debug->i_private;
 ...
 * space.
 */
static ssize_t lpfc_idiag_baracc_write(struct file *file,
    const char __user *buf,
    size_t nbytes, loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
  struct lpfc_hba *phba = (struct lpfc_hba *) debug->i_private;
...
static int __lpfc_idiag_print_wq(struct lpfc_queue *qp, char *wqtype,
...
static int lpfc_idiag_wqs_for_cq(struct lpfc_hba *phba, char *wqtype,
    char *pbuffer,
...
static int __lpfc_idiag_print_cq(struct lpfc_queue *qp, char *cqtype,
    char *pbuffer, int len) {
  if (!qp) {
    return len;
  }
...
static int __lpfc_idiag_print_rqpair(struct lpfc_queue *qp,
...
static int lpfc_idiag_cqs_for_eq(struct lpfc_hba *phba, char *pbuffer,
...
static int __lpfc_idiag_print_eq(struct lpfc_queue *qp, char *eqtype,
    char *pbuffer, int len) {
  if (!qp) {
    return len;
  }
 ...
 * than @nbytes if the end of the file was reached) or a negative error value.
 **/
static ssize_t lpfc_idiag_queinfo_read(struct file *file, char __user *buf,
    size_t nbytes,
    loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
  struct lpfc_hba *phba = (struct lpfc_hba *) debug->i_private;
 ...
 * returns 0.
 **/
static int lpfc_idiag_que_param_check(struct lpfc_queue *q, int index,
    int count) {
 ...
 **/
static int lpfc_idiag_queacc_read_qe(char *pbuffer, int len,
 ...
 * than @nbytes if the end of the file was reached) or a negative error value.
 **/
static ssize_t lpfc_idiag_queacc_read(struct file *file, char __user *buf,
    size_t nbytes,
    loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
 ...
 * space.
 **/
static ssize_t lpfc_idiag_queacc_write(struct file *file,
    const char __user *buf,
    size_t nbytes, loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
  struct lpfc_hba *phba = (struct lpfc_hba *) debug->i_private;
 ...
 **/
static int lpfc_idiag_drbacc_read_reg(struct lpfc_hba *phba, char *pbuffer,
 ...
 * than @nbytes if the end of the file was reached) or a negative error value.
 **/
static ssize_t lpfc_idiag_drbacc_read(struct file *file, char __user *buf,
    size_t nbytes,
    loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
  struct lpfc_hba *phba = (struct lpfc_hba *) debug->i_private;
 ...
 * space.
 **/
static ssize_t lpfc_idiag_drbacc_write(struct file *file,
    const char __user *buf,
    size_t nbytes, loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
  struct lpfc_hba *phba = (struct lpfc_hba *) debug->i_private;
 ...
 * This function returns the amount of data that was copied into @pbuffer.
 **/
static int lpfc_idiag_ctlacc_read_reg(struct lpfc_hba *phba, char *pbuffer,
 ...
 * than @nbytes if the end of the file was reached) or a negative error value.
 **/
static ssize_t lpfc_idiag_ctlacc_read(struct file *file, char __user *buf,
    size_t nbytes,
    loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
  struct lpfc_hba *phba = (struct lpfc_hba *) debug->i_private;
 ...
 * space.
 **/
static ssize_t lpfc_idiag_ctlacc_write(struct file *file,
    const char __user *buf,
    size_t nbytes, loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
  struct lpfc_hba *phba = (struct lpfc_hba *) debug->i_private;
 ...
 * than @nbytes if the end of the file was reached) or a negative error value.
 **/
static int lpfc_idiag_mbxacc_get_setup(struct lpfc_hba *phba, char *pbuffer) {
 ...
 * than @nbytes if the end of the file was reached) or a negative error value.
 **/
static ssize_t lpfc_idiag_mbxacc_read(struct file *file, char __user *buf,
    size_t nbytes,
    loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
  struct lpfc_hba *phba = (struct lpfc_hba *) debug->i_private;
 ...
 * space.
 **/
static ssize_t lpfc_idiag_mbxacc_write(struct file *file,
    const char __user *buf,
    size_t nbytes, loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
  uint32_t mbx_dump_map, mbx_dump_cnt, mbx_word_cnt, mbx_mbox_cmd;
 ...
 **/
static int lpfc_idiag_extacc_avail_get(struct lpfc_hba *phba, char *pbuffer,
    int len) {
 ...
 * overall length of the data read into the internal buffer.
 **/
static int lpfc_idiag_extacc_alloc_get(struct lpfc_hba *phba, char *pbuffer,
    int len) {
 ...
 * overall length of the data read into the internal buffer.
 **/
static int lpfc_idiag_extacc_drivr_get(struct lpfc_hba *phba, char *pbuffer,
    int len) {
 ...
 * space.
 **/
static ssize_t lpfc_idiag_extacc_write(struct file *file,
    const char __user *buf,
    size_t nbytes, loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
  uint32_t ext_map;
 ...
 * than @nbytes if the end of the file was reached) or a negative error value.
 **/
static ssize_t lpfc_idiag_extacc_read(struct file *file, char __user *buf,
    size_t nbytes,
    loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
  struct lpfc_hba *phba = (struct lpfc_hba *) debug->i_private;
...
static int lpfc_cgn_buffer_open(struct inode *inode, struct file *file) {
  struct lpfc_debug *debug;
  int rc = -ENOMEM;
  debug = kmalloc(sizeof(*debug), GFP_KERNEL);
  if (!debug) {
...
static ssize_t lpfc_cgn_buffer_read(struct file *file, char __user *buf,
    size_t nbytes,
    loff_t *ppos) {
  struct lpfc_debug *debug = file->private_data;
  struct lpfc_hba *phba = (struct lpfc_hba *) debug->i_private;
...
static int lpfc_cgn_buffer_release(struct inode *inode, struct file *file) {
  struct lpfc_debug *debug = file->private_data;
  vfree(debug->buffer);
  kfree(debug);
  return 0;
...
static int lpfc_rx_monitor_open(struct inode *inode, struct file *file) {
...
static ssize_t lpfc_rx_monitor_read(struct file *file, char __user *buf,
    size_t nbytes,
    loff_t *ppos) {
...
static int lpfc_rx_monitor_release(struct inode *inode, struct file *file) {
  struct lpfc_rx_monitor_debug *debug = file->private_data;
  vfree(debug->buffer);
  kfree(debug);
  return 0;
 ...
 **/
inline void lpfc_debugfs_initialize(struct lpfc_vport *vport) {
#ifdef CONFIG_SCSI_LPFC_DEBUG_FS
  struct lpfc_hba *phba = vport->phba;
  char name[64];
  uint32_t num, i;
 ...
 **/
inline void lpfc_debugfs_terminate(struct lpfc_vport *vport) {
#ifdef CONFIG_SCSI_LPFC_DEBUG_FS
  struct lpfc_hba *phba = vport->phba;
