 ...
 **/
int lpfc_dump_static_vport(struct lpfc_hba *phba, LPFC_MBOXQ_t *pmb,
    uint16_t offset) {
  MAILBOX_t *mb;
  struct lpfc_dmabuf *mp;
  int rc;
 ...
 **/
void lpfc_dump_mem(struct lpfc_hba *phba, LPFC_MBOXQ_t *pmb, uint16_t offset,
    uint16_t region_id) {
  MAILBOX_t *mb;
  void *ctx;
  mb = &pmb->u.mb;
 ...
 **/
void lpfc_config_async(struct lpfc_hba *phba, LPFC_MBOXQ_t *pmb,
    uint32_t ring) {
  MAILBOX_t *mb;
  mb = &pmb->u.mb;
  memset(pmb, 0, sizeof(LPFC_MBOXQ_t));
 ...
 **/
int lpfc_read_topology(struct lpfc_hba *phba, LPFC_MBOXQ_t *pmb,
    struct lpfc_dmabuf *mp) {
  MAILBOX_t *mb;
  mb = &pmb->u.mb;
  memset(pmb, 0, sizeof(LPFC_MBOXQ_t));
 ...
 **/
void lpfc_unreg_did(struct lpfc_hba *phba, uint16_t vpi, uint32_t did,
    LPFC_MBOXQ_t *pmb) {
  MAILBOX_t *mb;
  mb = &pmb->u.mb;
  memset(pmb, 0, sizeof(LPFC_MBOXQ_t));
 ...
 *    1 - DMA memory allocation failed
 **/
int lpfc_reg_rpi(struct lpfc_hba *phba, uint16_t vpi, uint32_t did,
 ...
 **/
void lpfc_unreg_login(struct lpfc_hba *phba, uint16_t vpi, uint32_t rpi,
    LPFC_MBOXQ_t *pmb) {
  MAILBOX_t *mb;
  mb = &pmb->u.mb;
  memset(pmb, 0, sizeof(LPFC_MBOXQ_t));
 ...
 * Block (PCB).
 **/
static void lpfc_config_pcb_setup(struct lpfc_hba *phba) {
 ...
 **/
static void lpfc_build_hbq_profile2(struct config_hbq_var *hbqmb,
 ...
 **/
static void lpfc_build_hbq_profile3(struct config_hbq_var *hbqmb,
    struct lpfc_hbq_init *hbq_desc) {
 ...
 * words 20:31.
 **/
static void lpfc_build_hbq_profile5(struct config_hbq_var *hbqmb,
    struct lpfc_hbq_init *hbq_desc) {
 ...
 **/
void lpfc_config_hbq(struct lpfc_hba *phba, uint32_t id,
    struct lpfc_hbq_init *hbq_desc,
 ...
 * index location.
 **/
void lpfc_sli4_mbx_sge_set(struct lpfcMboxq *mbox, uint32_t sgentry,
 ...
 * index location.
 **/
void lpfc_sli4_mbx_sge_get(struct lpfcMboxq *mbox, uint32_t sgentry,
 ...
 **/
int lpfc_sli4_config(struct lpfc_hba *phba, struct lpfcMboxq *mbox,
 ...
 **/
int lpfc_sli4_mbox_rsrc_extent(struct lpfc_hba *phba, struct lpfcMboxq *mbox,
 ...
 **/
void lpfc_reg_vfi(struct lpfcMboxq *mbox, struct lpfc_vport *vport,
    dma_addr_t phys) {
 ...
 **/
void lpfc_init_vpi(struct lpfc_hba *phba, struct lpfcMboxq *mbox,
    uint16_t vpi) {
  memset(mbox, 0, sizeof(*mbox));
...
static void lpfc_mbx_cmpl_rdp_link_stat(struct lpfc_hba *phba,
    LPFC_MBOXQ_t *mboxq) {
  MAILBOX_t *mb;
  int rc = FAILURE;
...
static void lpfc_mbx_cmpl_rdp_page_a2(struct lpfc_hba *phba,
    LPFC_MBOXQ_t *mbox) {
...
void lpfc_mbx_cmpl_rdp_page_a0(struct lpfc_hba *phba, LPFC_MBOXQ_t *mbox) {
  int rc;
  struct lpfc_dmabuf *mp = (struct lpfc_dmabuf *) (mbox->ctx_buf);
  struct lpfc_rdp_context *rdp_context
    = (struct lpfc_rdp_context *) (mbox->ctx_ndlp);
 ...
 * more complicated setups.
 **/
void lpfc_reg_fcfi_mrq(struct lpfc_hba *phba, struct lpfcMboxq *mbox,
    int mode) {
