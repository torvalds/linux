 ...
 * queue descriptor @q.
 **/
static void lpfc_debug_dump_qe(struct lpfc_queue *q, uint32_t idx) {
 ...
 * descriptor @q.
 **/
static inline void lpfc_debug_dump_q(struct lpfc_queue *q) {
  int idx, entry_count;
  /* sanity check */
  if (!q) {
    return;
 ...
 * by the wqidx.
 **/
static inline void lpfc_debug_dump_wq(struct lpfc_hba *phba, int qtype,
    int wqidx) {
 ...
 **/
static inline void lpfc_debug_dump_cq(struct lpfc_hba *phba, int qtype,
    int wqidx) {
 ...
 **/
static inline void lpfc_debug_dump_hba_eq(struct lpfc_hba *phba, int qidx) {
 ...
 **/
static inline void lpfc_debug_dump_dat_rq(struct lpfc_hba *phba) {
 ...
 **/
static inline void lpfc_debug_dump_hdr_rq(struct lpfc_hba *phba) {
 ...
 * identifier.
 **/
static inline void lpfc_debug_dump_wq_by_id(struct lpfc_hba *phba, int qid) {
  int wq_idx;
 ...
 * queue identifier.
 **/
static inline void lpfc_debug_dump_mq_by_id(struct lpfc_hba *phba, int qid) {
 ...
 * queue identifier.
 **/
static inline void lpfc_debug_dump_rq_by_id(struct lpfc_hba *phba, int qid) {
 ...
 * queue identifier.
 **/
static inline void lpfc_debug_dump_cq_by_id(struct lpfc_hba *phba, int qid) {
  int cq_idx;
 ...
 * queue identifier.
 **/
static inline void lpfc_debug_dump_eq_by_id(struct lpfc_hba *phba, int qid) {
  int eq_idx;
