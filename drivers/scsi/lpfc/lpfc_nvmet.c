...
static struct lpfc_async_xchg_ctx *lpfc_nvmet_get_ctx_for_xri(
    struct lpfc_hba *phba, u16 xri) {
...
static struct lpfc_async_xchg_ctx *lpfc_nvmet_get_ctx_for_oxid(
    struct lpfc_hba *phba, u16 oxid, u32 sid) {
  struct lpfc_async_xchg_ctx *ctxp;
  unsigned long iflag;
  bool found = false;
  spin_lock_irqsave(&phba->sli4_hba.t_active_list_lock, iflag);
...
static void lpfc_nvmet_defer_release(struct lpfc_hba *phba,
    struct lpfc_async_xchg_ctx *ctxp) {
 ...
 **/
static void lpfc_nvmet_xmt_ls_rsp_cmp(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdwqe,
    struct lpfc_iocbq *rspwqe) {
...
#ifdef CONFIG_SCSI_LPFC_DEBUG_FS
static void lpfc_nvmet_ktime(struct lpfc_hba *phba,
    struct lpfc_async_xchg_ctx *ctxp) {
 ...
 **/
static void lpfc_nvmet_xmt_fcp_op_cmp(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdwqe,
    struct lpfc_iocbq *rspwqe) {
  struct lpfc_nvmet_tgtport *tgtp;
 ...
 *  non-zero : if response failed to transmit, of the form -Exxx.
 **/
static int lpfc_nvmet_xmt_ls_rsp(struct nvmet_fc_target_port *tgtport,
    struct nvmefc_ls_rsp *ls_rsp) {
...
static int lpfc_nvmet_xmt_fcp_op(struct nvmet_fc_target_port *tgtport,
    struct nvmefc_tgt_fcp_req *rsp) {
...
static void lpfc_nvmet_targetport_delete(
...
static void lpfc_nvmet_xmt_fcp_abort(struct nvmet_fc_target_port *tgtport,
...
static void lpfc_nvmet_xmt_fcp_release(struct nvmet_fc_target_port *tgtport,
    struct nvmefc_tgt_fcp_req *rsp) {
  struct lpfc_nvmet_tgtport *lpfc_nvmep = tgtport->private;
  struct lpfc_async_xchg_ctx *ctxp
    = container_of(rsp, struct lpfc_async_xchg_ctx, hdlrctx.fcp_req);
...
static void lpfc_nvmet_defer_rcv(struct nvmet_fc_target_port *tgtport,
    struct nvmefc_tgt_fcp_req *rsp) {
  struct lpfc_nvmet_tgtport *tgtp;
  struct lpfc_async_xchg_ctx *ctxp
    = container_of(rsp, struct lpfc_async_xchg_ctx, hdlrctx.fcp_req);
 ...
 **/
static void lpfc_nvmet_ls_req_cmp(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdwqe,
    struct lpfc_iocbq *rspwqe) {
  struct lpfc_wcqe_complete *wcqe = &rspwqe->wcqe_cmpl;
 ...
 **/
static int lpfc_nvmet_ls_req(struct nvmet_fc_target_port *targetport,
    void *hosthandle,
 ...
 **/
static void lpfc_nvmet_ls_abort(struct nvmet_fc_target_port *targetport,
    void *hosthandle,
    struct nvmefc_ls_req *pnvme_lsreq) {
  struct lpfc_nvmet_tgtport *lpfc_nvmet = targetport->private;
  struct lpfc_hba *phba;
...
static void lpfc_nvmet_host_release(void *hosthandle) {
...
static void lpfc_nvmet_discovery_event(struct nvmet_fc_target_port *tgtport) {
  struct lpfc_nvmet_tgtport *tgtp;
  struct lpfc_hba *phba;
  uint32_t rc;
...
static void __lpfc_nvmet_clean_io_for_cpu(struct lpfc_hba *phba,
    struct lpfc_nvmet_ctx_info *infop) {
...
static void lpfc_nvmet_cleanup_io_context(struct lpfc_hba *phba) {
  struct lpfc_nvmet_ctx_info *infop;
  int i, j;
...
static int lpfc_nvmet_setup_io_context(struct lpfc_hba *phba) {
  struct lpfc_nvmet_ctxbuf *ctx_buf;
...
static void lpfc_nvmet_wqfull_flush(struct lpfc_hba *phba,
    struct lpfc_queue *wq,
    struct lpfc_async_xchg_ctx *ctxp) {
  struct lpfc_sli_ring *pring;
  struct lpfc_iocbq *nvmewqeq;
...
void lpfc_nvmet_wqfull_process(struct lpfc_hba *phba,
    struct lpfc_queue *wq) {
#if (IS_ENABLED(CONFIG_NVME_TARGET_FC))
  struct lpfc_sli_ring *pring;
  struct lpfc_iocbq *nvmewqeq;
...
static void lpfc_nvmet_fcp_rqst_defer_work(struct work_struct *work) {
#if (IS_ENABLED(CONFIG_NVME_TARGET_FC))
  struct lpfc_nvmet_ctxbuf *ctx_buf
...
static struct lpfc_nvmet_ctxbuf *lpfc_nvmet_replenish_context(
    struct lpfc_hba *phba,
 ...
 **/
static void lpfc_nvmet_unsol_fcp_buffer(struct lpfc_hba *phba,
    uint32_t idx,
    struct rqb_dmabuf *nvmebuf,
 ...
 **/
static struct lpfc_iocbq *lpfc_nvmet_prep_ls_wqe(struct lpfc_hba *phba,
    struct lpfc_async_xchg_ctx *ctxp,
...
static struct lpfc_iocbq *lpfc_nvmet_prep_fcp_wqe(struct lpfc_hba *phba,
    struct lpfc_async_xchg_ctx *ctxp) {
 ...
 * The function frees memory resources used for the NVME commands.
 **/
static void lpfc_nvmet_sol_fcp_abort_cmp(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdwqe,
    struct lpfc_iocbq *rspwqe) {
  struct lpfc_async_xchg_ctx *ctxp;
  struct lpfc_nvmet_tgtport *tgtp;
 ...
 * The function frees memory resources used for the NVME commands.
 **/
static void lpfc_nvmet_unsol_fcp_abort_cmp(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdwqe,
    struct lpfc_iocbq *rspwqe) {
  struct lpfc_async_xchg_ctx *ctxp;
  struct lpfc_nvmet_tgtport *tgtp;
 ...
 * The function frees memory resources used for the NVME commands.
 **/
static void lpfc_nvmet_xmt_ls_abort_cmp(struct lpfc_hba *phba,
    struct lpfc_iocbq *cmdwqe,
    struct lpfc_iocbq *rspwqe) {
  struct lpfc_async_xchg_ctx *ctxp;
  struct lpfc_nvmet_tgtport *tgtp;
...
static int lpfc_nvmet_unsol_issue_abort(struct lpfc_hba *phba,
    struct lpfc_async_xchg_ctx *ctxp,
...
static int lpfc_nvmet_sol_fcp_issue_abort(struct lpfc_hba *phba,
    struct lpfc_async_xchg_ctx *ctxp,
    uint32_t sid, uint16_t xri) {
  struct lpfc_nvmet_tgtport *tgtp;
  struct lpfc_iocbq *abts_wqeq;
...
static int lpfc_nvmet_unsol_fcp_issue_abort(struct lpfc_hba *phba,
    struct lpfc_async_xchg_ctx *ctxp,
    uint32_t sid, uint16_t xri) {
  struct lpfc_nvmet_tgtport *tgtp;
  struct lpfc_iocbq *abts_wqeq;
