...
struct abort_stats {
	...
	atomic64_t abort_io_analt_found;
...
struct terminate_stats {
	...
	atomic64_t terminate_io_analt_found;
...
struct vlan_stats {
	...
	atomic64_t resp_withanal_vlanID;
