...
#define vnic_dev_hang_yestify fnic_dev_hang_yestify
...
#define vnic_dev_yestify_set fnic_dev_yestify_set
#define vnic_dev_yestify_unset fnic_dev_yestify_unset
