 ...
 */
static void *sli_config_cmd_init(struct sli4 *sli4, void *buf, u32 length,
    struct efc_dma *dma) {
 ...
 * Return: status -EIO/0.
 */
static int sli_cmd_common_create_cq(struct sli4 *sli4, void *buf,
    struct efc_dma *qmem,
    u16 eq_id) {
...
static int sli_cmd_common_create_eq(struct sli4 *sli4, void *buf,
    struct efc_dma *qmem) {
...
static int sli_cmd_common_create_mq_ext(struct sli4 *sli4, void *buf,
    struct efc_dma *qmem,
    u16 cq_id) {
...
int sli_cmd_wq_create(struct sli4 *sli4, void *buf, struct efc_dma *qmem,
    u16 cq_id) {
...
static int sli_cmd_rq_create_v1(struct sli4 *sli4, void *buf,
    struct efc_dma *qmem,
...
static int sli_cmd_rq_create_v2(struct sli4 *sli4, u32 num_rqs,
...
static void __sli_queue_destroy(struct sli4 *sli4, struct sli4_queue *q) {
  if (!q->dma.size) {
    return;
  }
...
int sli_fc_rq_alloc(struct sli4 *sli4, struct sli4_queue *q,
...
static int sli_res_sli_config(struct sli4 *sli4, void *buf) {
...
int sli_queue_alloc(struct sli4 *sli4, u32 qtype,
...
int sli_cq_alloc_set(struct sli4 *sli4, struct sli4_queue *qs[],
...
static int sli_cmd_common_destroy_q(struct sli4 *sli4, u8 opc, u8 subsystem,
    u16 q_id) {
...
int sli_queue_free(struct sli4 *sli4, struct sli4_queue *q,
...
int sli_abort_wqe(struct sli4 *sli, void *buf, enum sli4_abort_type type,
...
int sli_els_request64_wqe(struct sli4 *sli, void *buf, struct efc_dma *sgl,
...
int sli_fcp_icmnd64_wqe(struct sli4 *sli, void *buf, struct efc_dma *sgl,
    u16 xri,
...
int sli_fcp_iread64_wqe(struct sli4 *sli, void *buf, struct efc_dma *sgl,
...
int sli_fcp_iwrite64_wqe(struct sli4 *sli, void *buf, struct efc_dma *sgl,
...
int sli_send_frame_wqe(struct sli4 *sli, void *buf, u8 sof, u8 eof, u32 *hdr,
...
int sli_xmit_bls_rsp64_wqe(struct sli4 *sli, void *buf,
...
int sli_xmit_els_rsp64_wqe(struct sli4 *sli, void *buf, struct efc_dma *rsp,
    struct sli_els_params *params) {
...
static int sli_bmbx_wait(struct sli4 *sli4, u32 msec) {
  u32 val;
  unsigned long end;
...
static int sli_bmbx_write(struct sli4 *sli4) {
  u32 val;
...
int sli_cmd_read_link_stats(struct sli4 *sli4, void *buf, u8 req_ext_counters,
...
int sli_cmd_read_status(struct sli4 *sli4, void *buf, u8 clear_counters) {
...
int sli_cmd_init_link(struct sli4 *sli4, void *buf, u32 speed, u8 reset_alpa) {
...
int sli_cmd_init_vfi(struct sli4 *sli4, void *buf, u16 vfi, u16 fcfi, u16 vpi) {
...
int sli_cmd_post_xri(struct sli4 *sli4, void *buf, u16 xri_base,
    u16 xri_count) {
...
static int sli_cmd_read_config(struct sli4 *sli4, void *buf) {
...
int sli_cmd_write_nvparms(struct sli4 *sli4, void *buf, u8 *wwpn, u8 *wwnn,
...
static int sli_cmd_read_rev(struct sli4 *sli4, void *buf, struct efc_dma *vpd) {
...
int sli_cmd_read_sparm64(struct sli4 *sli4, void *buf, struct efc_dma *dma,
    u16 vpi) {
...
int sli_cmd_reg_fcfi_mrq(struct sli4 *sli4, void *buf, u8 mode, u16 fcf_index,
...
int sli_cmd_reg_vpi(struct sli4 *sli4, void *buf, u32 fc_id, __be64 sli_wwpn,
...
static int sli_cmd_request_features(struct sli4 *sli4, void *buf,
    u32 features_mask,
    bool query) {
...
int sli_cmd_unreg_vfi(struct sli4 *sli4, void *buf, u16 index, u32 which) {
...
int sli_cmd_unreg_vpi(struct sli4 *sli4, void *buf, u16 indicator, u32 which) {
...
static int sli_cmd_common_modify_eq_delay(struct sli4 *sli4, void *buf,
...
void sli4_cmd_lowlevel_set_watchdog(struct sli4 *sli4, void *buf,
...
static int sli_cmd_common_get_cntl_attributes(struct sli4 *sli4, void *buf,
    struct efc_dma *dma) {
...
static int sli_cmd_common_get_cntl_addl_attributes(struct sli4 *sli4, void *buf,
    struct efc_dma *dma) {
  struct sli4_rqst_hdr *hdr = NULL;
  hdr = sli_config_cmd_init(sli4, buf, SLI4_RQST_CMDSZ(hdr), dma);
  if (!hdr) {
...
static int sli_cmd_common_get_port_name(struct sli4 *sli4, void *buf) {
...
int sli_cmd_common_delete_object(struct sli4 *sli4, void *buf, char *obj_name) {
...
int sli_cmd_dmtf_exec_clp_cmd(struct sli4 *sli4, void *buf, struct efc_dma *cmd,
    struct efc_dma *resp) {
...
int sli_cmd_common_set_dump_location(struct sli4 *sli4, void *buf, bool query,
    bool is_buffer_list,
...
int sli_cmd_common_set_features(struct sli4 *sli4, void *buf, u32 feature,
...
static bool sli_wait_for_fw_ready(struct sli4 *sli4, u32 timeout_ms) {
  unsigned long end;
...
static bool sli_sliport_reset(struct sli4 *sli4) {
  bool rc;
  u32 val;
...
static bool sli_fw_init(struct sli4 *sli4) {
  /*
...
static int sli_request_features(struct sli4 *sli4, u32 *features, bool query) {
...
static int sli_get_read_config(struct sli4 *sli4) {
...
static int sli_get_sli4_parameters(struct sli4 *sli4) {
...
static int sli_get_ctrl_attributes(struct sli4 *sli4) {
...
static int sli_get_fw_rev(struct sli4 *sli4) {
...
static int sli_get_config(struct sli4 *sli4) {
...
int sli_callback(struct sli4 *sli4, enum sli4_callback which,
    void *func, void *arg) {
  if (!func) {
...
int sli_eq_modify_delay(struct sli4 *sli4, struct sli4_queue *eq,
...
int sli_resource_alloc(struct sli4 *sli4, enum sli4_resource rtype,
    u32 *rid, u32 *index) {
  int rc = 0;
  u32 size;
  u32 ext_idx;
