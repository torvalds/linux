...
static struct efct_node *efct_node_find(struct efct *efct, u32 port_id,
    u32 node_id) {
...
static int efct_dispatch_frame(struct efct *efct, struct efc_hw_sequence *seq) {
  struct efct_node *node;
...
static int efct_fc_tmf_rejected_cb(struct efct_io *io,
...
static void efct_dispatch_unsol_tmf(struct efct_io *io, u8 tm_flags, u32 lun) {
  u32 i;
  struct {
    u32 mask;
...
static int efct_validate_fcp_cmd(struct efct *efct,
...
static void efct_populate_io_fcp_cmd(struct efct_io *io, struct fcp_cmnd *cmnd,
...
static u32 efct_get_flags_fcp_cmd(struct fcp_cmnd *cmnd) {
  u32 flags = 0;
...
static void efct_sframe_common_send_cb(void *arg, u8 *cqe, int status) {
...
static int efct_sframe_common_send(struct efct_node *node,
    struct efc_hw_sequence *seq,
...
static int efct_sframe_send_fcp_rsp(struct efct_node *node,
    struct efc_hw_sequence *seq,
...
static int efct_sframe_send_task_set_full_or_busy(struct efct_node *node,
    struct efc_hw_sequence *seq) {
...
static int efct_process_abts(struct efct_io *io, struct fc_frame_header *hdr) {
