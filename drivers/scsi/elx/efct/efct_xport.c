...
static int efct_xport_init_debugfs(struct efct *efct) {
...
static void efct_xport_async_link_stats_cb(int status, u32 num_counters,
...
static void efct_xport_async_host_stats_cb(int status, u32 num_counters,
...
static void efct_xport_config_stats_timer(struct efct *efct);
...
static int efct_get_link_supported_speeds(struct efct *efct) {
...
static void efct_xport_domain_free_cb(struct efc *efc, void *arg) {
...
static void efct_xport_remove_host(struct Scsi_Host *shost) {
...
static void efct_get_host_port_id(struct Scsi_Host *shost) {
...
static void efct_get_host_port_type(struct Scsi_Host *shost) {
  struct efct_vport *vport = (struct efct_vport *) shost->hostdata;
  struct efct *efct = vport->efct;
  struct efc *efc = efct->efcport;
...
static void efct_get_host_vport_type(struct Scsi_Host *shost) {
  fc_host_port_type(shost) = FC_PORTTYPE_NPIV;
}

static void efct_get_host_port_state(struct Scsi_Host *shost) {
  struct efct_vport *vport = (struct efct_vport *) shost->hostdata;
  struct efct *efct = vport->efct;
...
static void efct_get_host_speed(struct Scsi_Host *shost) {
  struct efct_vport *vport = (struct efct_vport *) shost->hostdata;
  struct efct *efct = vport->efct;
  struct efc *efc = efct->efcport;
...
static void efct_get_host_fabric_name(struct Scsi_Host *shost) {
  struct efct_vport *vport = (struct efct_vport *) shost->hostdata;
  struct efct *efct = vport->efct;
  struct efc *efc = efct->efcport;
  if (efc->domain) {
...
static struct fc_host_statistics *efct_get_stats(struct Scsi_Host *shost) {
  struct efct_vport *vport = (struct efct_vport *) shost->hostdata;
  struct efct *efct = vport->efct;
...
static void efct_reset_stats(struct Scsi_Host *shost) {
  struct efct_vport *vport = (struct efct_vport *) shost->hostdata;
  struct efct *efct = vport->efct;
...
static int efct_issue_lip(struct Scsi_Host *shost) {
...
struct efct_vport *efct_scsi_new_vport(struct efct *efct, struct device *dev) {
  struct Scsi_Host *shost = NULL;
  int error = 0;
  struct efct_vport *vport = NULL;
  shost = scsi_host_alloc(&efct_template, sizeof(*vport));
...
static int efct_vport_create(struct fc_vport *fc_vport, bool disable) {
...
static int efct_vport_delete(struct fc_vport *fc_vport) {
...
static int efct_vport_disable(struct fc_vport *fc_vport, bool disable) {
  return 0;
}
