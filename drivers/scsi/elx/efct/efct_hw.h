...
static inline int efct_hw_get_link_speed(struct efct_hw *hw) {
...
uint64_t efct_get_wwnn(struct efct_hw *hw);
uint64_t efct_get_wwpn(struct efct_hw *hw);
...
int efct_hw_io_send(struct efct_hw *hw, enum efct_hw_io_type type,
    ...
    void *cb, void *arg);
int efct_hw_io_register_sgl(struct efct_hw *hw, struct efct_hw_io *io,
    struct efc_dma *sgl,
    u32 sgl_count);
int efct_hw_io_init_sges(struct efct_hw *hw,
...
u32 efct_hw_io_get_count(struct efct_hw *hw,
...
int efct_hw_rqpair_process_rq(struct efct_hw *hw,
    struct hw_cq *cq, u8 *cqe);
int efct_hw_rqpair_sequence_free(struct efct_hw *hw,
    struct efc_hw_sequence *seq);
static inline void efct_hw_sequence_copy(struct efc_hw_sequence *dst,
...
static inline int efct_hw_sequence_free(struct efct_hw *hw,
    struct efc_hw_sequence *seq) {
...
void efct_hw_xabt_process(struct efct_hw *hw, struct hw_cq *cq,
    u8 *cqe, u16 rid);
int efct_hw_process(struct efct_hw *hw, u32 vector, u32 max_isr_time_msec);
...
int efct_hw_get_link_stats(struct efct_hw *hw,
    u8 req_ext_counters,
...
int efct_hw_get_host_stats(struct efct_hw *hw,
    u8 cc,
    void (*efct_hw_host_stat_cb_t)(int status,
    u32 num_counters,
    struct efct_hw_host_stat_counts *counters, void *arg),
    void *arg);
int efct_hw_firmware_write(struct efct_hw *hw, struct efc_dma *dma,
