...
struct efct_io *efct_scsi_io_alloc(struct efct_node *node) {
  struct efct *efct;
...
static void efct_target_io_cb(struct efct_hw_io *hio, u32 length, int status,
...
static int efct_scsi_build_sgls(struct efct_hw *hw, struct efct_hw_io *hio,
...
static void efct_scsi_check_pending_async_cb(struct efct_hw *hw, int status,
    u8 *mqe, void *arg) {
...
static int efct_scsi_io_dispatch_hw_io(struct efct_io *io,
...
static int efct_scsi_io_dispatch_no_hw_io(struct efct_io *io) {
  int rc;
  switch (io->io_type) {
...
static struct efct_io *efct_scsi_dispatch_pending(struct efct *efct) {
...
static inline int efct_scsi_xfer_data(struct efct_io *io, u32 flags,
...
int efct_scsi_send_rd_data(struct efct_io *io, u32 flags,
...
int efct_scsi_recv_wr_data(struct efct_io *io, u32 flags,
    struct efct_scsi_sgl *sgl, u32 sgl_count, u64 len,
    efct_scsi_io_cb_t cb, void *arg) {
...
int efct_scsi_send_resp(struct efct_io *io, u32 flags,
...
static int efct_target_bls_resp_cb(struct efct_hw_io *hio, u32 length,
    int status,
    u32 ext_status, void *app) {
  struct efct_io *io = app;
  struct efct *efct;
...
static int efct_target_send_bls_resp(struct efct_io *io,
    efct_scsi_io_cb_t cb, void *arg) {
  struct efct_node *node = io->node;
...
struct efct_io *efct_bls_send_rjt(struct efct_io *io,
...
int efct_scsi_send_tmf_resp(struct efct_io *io,
...
static int efct_target_abort_cb(struct efct_hw_io *hio, u32 length, int status,
    u32 ext_status, void *app) {
  struct efct_io *io = app;
  struct efct *efct;
...
int efct_scsi_tgt_abort_io(struct efct_io *io, efct_scsi_io_cb_t cb,
    void *arg) {
  struct efct *efct;
  struct efct_xport *xport;
  int rc;
