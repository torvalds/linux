...
static void efc_fabric_initiate_shutdown(struct efc_node *node) {
...
static void __efc_fabric_common(const char *funcname, struct efc_sm_ctx *ctx,
...
void __efc_fabric_init(struct efc_sm_ctx *ctx, enum efc_sm_event evt,
    void *arg) {
...
void efc_fabric_set_topology(struct efc_node *node,
...
void __efc_fabric_flogi_wait_rsp(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
...
void __efc_vport_fabric_init(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  struct efc_node *node = ctx->app;
  efc_node_evt_set(ctx, evt, __func__);
  node_sm_trace();
...
void __efc_fabric_fdisc_wait_rsp(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  struct efc_node_cb *cbdata = arg;
  struct efc_node *node = ctx->app;
  efc_node_evt_set(ctx, evt, __func__);
...
static int efc_start_ns_node(struct efc_nport *nport) {
  struct efc_node *ns;
...
static int efc_start_fabctl_node(struct efc_nport *nport) {
...
void __efc_fabric_wait_domain_attach(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  struct efc_node *node = ctx->app;
  efc_node_evt_set(ctx, evt, __func__);
  node_sm_trace();
...
void __efc_fabric_idle(struct efc_sm_ctx *ctx, enum efc_sm_event evt,
    void *arg) {
  struct efc_node *node = ctx->app;
  efc_node_evt_set(ctx, evt, __func__);
  node_sm_trace();
...
void __efc_ns_init(struct efc_sm_ctx *ctx, enum efc_sm_event evt, void *arg) {
  struct efc_node *node = ctx->app;
  efc_node_evt_set(ctx, evt, __func__);
  node_sm_trace();
  switch (evt) {
...
void __efc_ns_plogi_wait_rsp(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  struct efc_node_cb *cbdata = arg;
  struct efc_node *node = ctx->app;
  efc_node_evt_set(ctx, evt, __func__);
...
void __efc_ns_wait_node_attach(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  struct efc_node *node = ctx->app;
  efc_node_evt_set(ctx, evt, __func__);
  node_sm_trace();
...
void __efc_fabric_wait_attach_evt_shutdown(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  struct efc_node *node = ctx->app;
  efc_node_evt_set(ctx, evt, __func__);
  node_sm_trace();
...
void __efc_ns_rftid_wait_rsp(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  struct efc_node *node = ctx->app;
  efc_node_evt_set(ctx, evt, __func__);
  node_sm_trace();
...
void __efc_ns_rffid_wait_rsp(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  struct efc_node *node = ctx->app;
  efc_node_evt_set(ctx, evt, __func__);
  node_sm_trace();
...
static int efc_process_gidpt_payload(struct efc_node *node,
...
void __efc_ns_gidpt_wait_rsp(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  struct efc_node_cb *cbdata = arg;
  struct efc_node *node = ctx->app;
  efc_node_evt_set(ctx, evt, __func__);
...
void __efc_ns_idle(struct efc_sm_ctx *ctx, enum efc_sm_event evt, void *arg) {
  struct efc_node *node = ctx->app;
  struct efc *efc = node->efc;
  efc_node_evt_set(ctx, evt, __func__);
  node_sm_trace();
...
void __efc_ns_gidpt_delay(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  struct efc_node *node = ctx->app;
  struct efc *efc = node->efc;
  efc_node_evt_set(ctx, evt, __func__);
...
void __efc_fabctl_init(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  struct efc_node *node = ctx->app;
  node_sm_trace();
  switch (evt) {
...
void __efc_fabctl_wait_scr_rsp(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  struct efc_node *node = ctx->app;
  efc_node_evt_set(ctx, evt, __func__);
  node_sm_trace();
...
static void efc_process_rscn(struct efc_node *node,
...
void __efc_fabctl_ready(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  struct efc_node_cb *cbdata = arg;
  struct efc_node *node = ctx->app;
  efc_node_evt_set(ctx, evt, __func__);
...
void __efc_fabctl_wait_ls_acc_cmpl(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  struct efc_node *node = ctx->app;
  efc_node_evt_set(ctx, evt, __func__);
  node_sm_trace();
...
static int efc_rnode_is_winner(struct efc_nport *nport) {
...
void __efc_p2p_wait_domain_attach(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  struct efc_node *node = ctx->app;
  struct efc *efc = node->efc;
  efc_node_evt_set(ctx, evt, __func__);
...
void __efc_p2p_rnode_init(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  struct efc_node_cb *cbdata = arg;
  struct efc_node *node = ctx->app;
  efc_node_evt_set(ctx, evt, __func__);
...
void __efc_p2p_wait_flogi_acc_cmpl(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  struct efc_node_cb *cbdata = arg;
  struct efc_node *node = ctx->app;
  efc_node_evt_set(ctx, evt, __func__);
...
void __efc_p2p_wait_plogi_rsp(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  struct efc_node_cb *cbdata = arg;
  struct efc_node *node = ctx->app;
  efc_node_evt_set(ctx, evt, __func__);
...
void __efc_p2p_wait_plogi_rsp_recvd_prli(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  struct efc_node_cb *cbdata = arg;
  struct efc_node *node = ctx->app;
  efc_node_evt_set(ctx, evt, __func__);
...
void __efc_p2p_wait_node_attach(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  struct efc_node_cb *cbdata = arg;
  struct efc_node *node = ctx->app;
  efc_node_evt_set(ctx, evt, __func__);
...
int efc_p2p_setup(struct efc_nport *nport) {
