...
struct efc_els_io_req *efc_els_io_alloc(struct efc_node *node, u32 reqlen) {
  return efc_els_io_alloc_size(node, reqlen, EFC_ELS_RSP_LEN);
}

struct efc_els_io_req *efc_els_io_alloc_size(struct efc_node *node, u32 reqlen,
    u32 rsplen) {
  struct efc *efc;
...
static void efc_els_retry(struct efc_els_io_req *els);

static void efc_els_delay_timer_cb(struct timer_list *t) {
  struct efc_els_io_req *els = from_timer(els, t, delay_timer);
  /* Retry delay timer expired, retry the ELS request */
  efc_els_retry(els);
}

static int efc_els_req_cb(void *arg, u32 length, int status, u32 ext_status) {
  struct efc_els_io_req *els;
  struct efc_node *node;
  struct efc *efc;
...
static int efc_els_acc_cb(void *arg, u32 length, int status, u32 ext_status) {
  struct efc_els_io_req *els;
  struct efc_node *node;
  struct efc *efc;
  struct efc_node_cb cbdata;
...
static int efc_els_send_rsp(struct efc_els_io_req *els, u32 rsplen) {
  int rc = 0;
  struct efc_node_cb cbdata;
...
int efc_send_plogi(struct efc_node *node) {
  struct efc_els_io_req *els;
  struct efc *efc = node->efc;
...
int efc_send_flogi(struct efc_node *node) {
  struct efc_els_io_req *els;
  struct efc *efc;
...
int efc_send_ls_rjt(struct efc_node *node, u32 ox_id, u32 reason_code,
...
int efc_send_plogi_acc(struct efc_node *node, u32 ox_id) {
  struct efc *efc = node->efc;
  struct efc_els_io_req *els = NULL;
  struct fc_els_flogi *plogi;
...
int efc_send_flogi_p2p_acc(struct efc_node *node, u32 ox_id, u32 s_id) {
  struct efc *efc = node->efc;
  struct efc_els_io_req *els = NULL;
  struct fc_els_flogi *flogi;
  node_els_trace();
...
int efc_send_prli_acc(struct efc_node *node, u32 ox_id) {
  struct efc *efc = node->efc;
  struct efc_els_io_req *els = NULL;
  struct {
    struct fc_els_prli prli;
...
int efc_send_prlo_acc(struct efc_node *node, u32 ox_id) {
  struct efc *efc = node->efc;
  struct efc_els_io_req *els = NULL;
  struct {
...
int efc_send_ls_acc(struct efc_node *node, u32 ox_id) {
  struct efc *efc = node->efc;
  struct efc_els_io_req *els = NULL;
...
int efc_send_logo_acc(struct efc_node *node, u32 ox_id) {
  struct efc_els_io_req *els = NULL;
  struct efc *efc = node->efc;
...
int efc_send_adisc_acc(struct efc_node *node, u32 ox_id) {
  struct efc *efc = node->efc;
  struct efc_els_io_req *els = NULL;
  struct fc_els_adisc *adisc;
  struct fc_els_flogi *sparams;
...
static inline void fcct_build_req_header(struct fc_ct_hdr *hdr, u16 cmd,
    u16 max_size) {
...
int efc_ns_send_rftid(struct efc_node *node) {
  struct efc *efc = node->efc;
  struct efc_els_io_req *els;
  struct {
...
void efc_els_io_cleanup(struct efc_els_io_req *els, int evt, void *arg) {
...
static int efc_ct_acc_cb(void *arg, u32 length, int status, u32 ext_status) {
  struct efc_els_io_req *els = arg;
  efc_els_io_free(els);
  return 0;
}

int efc_send_ct_rsp(struct efc *efc, struct efc_node *node, u16 ox_id,
...
int efc_send_bls_acc(struct efc_node *node, struct fc_frame_header *hdr) {
