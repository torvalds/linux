...
static void efc_nport_free_resources(struct efc_nport *nport, int evt,
    void *data) {
...
static int efc_nport_get_mbox_status(struct efc_nport *nport, u8 *mqe,
    int status) {
  struct efc *efc = nport->efc;
...
static int efc_nport_free_unreg_vpi_cb(struct efc *efc, int status, u8 *mqe,
    void *arg) {
...
static void efc_nport_free_unreg_vpi(struct efc_nport *nport) {
  struct efc *efc = nport->efc;
  int rc;
...
static void efc_nport_send_evt(struct efc_nport *nport, int evt, void *data) {
  struct efc *efc = nport->efc;
...
static int efc_nport_alloc_init_vpi_cb(struct efc *efc, int status, u8 *mqe,
    void *arg) {
  struct efc_nport *nport = arg;
...
static void efc_nport_alloc_init_vpi(struct efc_nport *nport) {
  struct efc *efc = nport->efc;
  u8 data[SLI4_BMBX_SIZE];
  int rc;
  /* If there is a pending free request, then handle it now */
...
static int efc_nport_alloc_read_sparm64_cb(struct efc *efc, int status, u8 *mqe,
    void *arg) {
  struct efc_nport *nport = arg;
  u8 *payload = NULL;
  if (efc_nport_get_mbox_status(nport, mqe, status)) {
...
static void efc_nport_alloc_read_sparm64(struct efc *efc,
...
int efc_cmd_nport_alloc(struct efc *efc, struct efc_nport *nport,
...
static int efc_nport_attach_reg_vpi_cb(struct efc *efc, int status, u8 *mqe,
    void *arg) {
  struct efc_nport *nport = arg;
...
int efc_cmd_nport_attach(struct efc *efc, struct efc_nport *nport, u32 fc_id) {
...
int efc_cmd_nport_free(struct efc *efc, struct efc_nport *nport) {
  if (!nport) {
...
static int efc_domain_get_mbox_status(struct efc_domain *domain, u8 *mqe,
    int status) {
...
static void efc_domain_free_resources(struct efc_domain *domain, int evt,
    void *data) {
  struct efc *efc = domain->efc;
  /* Free the service parameters buffer */
  if (domain->dma.virt) {
...
static void efc_domain_send_nport_evt(struct efc_domain *domain,
...
static int efc_domain_alloc_read_sparm64_cb(struct efc *efc, int status,
    u8 *mqe,
    void *arg) {
...
static void efc_domain_alloc_read_sparm64(struct efc_domain *domain) {
  struct efc *efc = domain->efc;
  u8 data[SLI4_BMBX_SIZE];
  int rc;
...
static int efc_domain_alloc_init_vfi_cb(struct efc *efc, int status, u8 *mqe,
    void *arg) {
  struct efc_domain *domain = arg;
  if (efc_domain_get_mbox_status(domain, mqe, status)) {
    efc_domain_free_resources(domain,
...
static void efc_domain_alloc_init_vfi(struct efc_domain *domain) {
  struct efc *efc = domain->efc;
...
int efc_cmd_domain_alloc(struct efc *efc, struct efc_domain *domain, u32 fcf) {
  u32 index;
...
static int efc_domain_attach_reg_vfi_cb(struct efc *efc, int status, u8 *mqe,
    void *arg) {
  struct efc_domain *domain = arg;
  if (efc_domain_get_mbox_status(domain, mqe, status)) {
    efc_domain_free_resources(domain,
...
int efc_cmd_domain_attach(struct efc *efc, struct efc_domain *domain,
    u32 fc_id) {
  u8 buf[SLI4_BMBX_SIZE];
  int rc = 0;
  if (!domain) {
...
static int efc_domain_free_unreg_vfi_cb(struct efc *efc, int status, u8 *mqe,
    void *arg) {
  struct efc_domain *domain = arg;
...
static void efc_domain_free_unreg_vfi(struct efc_domain *domain) {
  struct efc *efc = domain->efc;
  int rc;
  u8 data[SLI4_BMBX_SIZE];
...
int efc_cmd_domain_free(struct efc *efc, struct efc_domain *domain) {
  if (!domain) {
...
int efc_cmd_node_alloc(struct efc *efc, struct efc_remote_node *rnode,
    u32 fc_addr,
    struct efc_nport *nport) {
...
static int efc_cmd_node_attach_cb(struct efc *efc, int status, u8 *mqe,
    void *arg) {
...
int efc_cmd_node_attach(struct efc *efc, struct efc_remote_node *rnode,
...
int efc_node_free_resources(struct efc *efc, struct efc_remote_node *rnode) {
  int rc = 0;
  if (!rnode) {
...
static int efc_cmd_node_free_cb(struct efc *efc, int status, u8 *mqe,
    void *arg) {
  struct efc_remote_node *rnode = arg;
  struct sli4_mbox_command_header *hdr
    = (struct sli4_mbox_command_header *) mqe;
...
int efc_cmd_node_detach(struct efc *efc, struct efc_remote_node *rnode) {
  u8 buf[SLI4_BMBX_SIZE];
  int rc = -EIO;
  if (!rnode) {
    efc_log_err(efc, "bad parameter rnode=%p\n", rnode);
