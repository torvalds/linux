...
struct efc_node *efc_node_find(struct efc_nport *nport, u32 port_id) {
  /* Find an FC node structure given the FC port ID */
  return xa_load(&nport->lookup, port_id);
}

static void _efc_node_free(struct kref *arg) {
...
void efc_node_free(struct efc_node *node) {
...
static void efc_dma_copy_in(struct efc_dma *dma, void *buffer,
    u32 buffer_length) {
...
void efc_node_fcid_display(u32 fc_id, char *buffer, u32 buffer_length) {
  switch (fc_id) {
    case FC_FID_FLOGI:
...
static void efc_node_purge_pending(struct efc_node *node) {
  struct efc *efc = node->efc;
...
static bool efc_node_check_els_quiesced(struct efc_node *node) {
...
int efc_node_check_els_req(struct efc_sm_ctx *ctx, enum efc_sm_event evt,
    void *arg,
...
int efc_node_check_ns_req(struct efc_sm_ctx *ctx, enum efc_sm_event evt,
    void *arg,
...
void efc_node_recv_els_frame(struct efc_node *node,
...
void efc_node_recv_ct_frame(struct efc_node *node,
    struct efc_hw_sequence *seq) {
...
void efc_process_node_pending(struct efc_node *node) {
  struct efc *efc = node->efc;
