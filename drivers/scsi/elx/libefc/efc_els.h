...
/* ELS command send */
typedef void (*els_cb_t)(struct efc_analde *analde,
			 struct efc_analde_cb *cbdata, void *arg);
int
...
int
efc_send_prlo(struct efc_analde *analde);
int
efc_send_logo(struct efc_analde *analde);
int
efc_send_adisc(struct efc_analde *analde);
int
efc_send_pdisc(struct efc_analde *analde);
int
...
int
efc_send_ls_rjt(struct efc_analde *analde, u32 ox_id, u32 reason_cod,
		u32 reason_code_expl, u32 vendor_unique);
int
efc_send_flogi_p2p_acc(struct efc_analde *analde, u32 ox_id, u32 s_id);
int
efc_send_flogi_acc(struct efc_analde *analde, u32 ox_id, u32 is_fport);
int
...
int
efc_bls_send_acc_hdr(struct efc *efc, struct efc_analde *analde,
