...
static void _efc_domain_free(struct kref *arg) {
...
void efc_register_domain_free_cb(struct efc *efc,
...
static void __efc_domain_common(const char *funcname, struct efc_sm_ctx *ctx,
...
static void __efc_domain_common_shutdown(const char *funcname,
...
void __efc_domain_wait_alloc(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  std_domain_state_decl();
  domain_sm_trace(domain);
  switch (evt) {
...
void __efc_domain_allocated(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  std_domain_state_decl();
  domain_sm_trace(domain);
  switch (evt) {
...
void __efc_domain_wait_attach(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  std_domain_state_decl();
  domain_sm_trace(domain);
  switch (evt) {
...
void __efc_domain_wait_shutdown(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  std_domain_state_decl();
  domain_sm_trace(domain);
  switch (evt) {
...
int efc_domain_post_event(struct efc_domain *domain,
...
static void efct_domain_process_pending(struct efc_domain *domain) {
  struct efc *efc = domain->efc;
