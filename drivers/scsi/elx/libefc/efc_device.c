...
void efc_d_send_prli_rsp(struct efc_node *node, u16 ox_id) {
...
static void __efc_d_common(const char *funcname, struct efc_sm_ctx *ctx,
...
static void __efc_d_wait_del_node(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
...
static void __efc_d_wait_del_ini_tgt(struct efc_sm_ctx *ctx,
    enum efc_sm_event evt, void *arg) {
  struct efc_node *node = ctx->app;
  efc_node_evt_set(ctx, evt, __func__);
  node_sm_trace();
...
void efc_process_prli_payload(struct efc_node *node, void *prli) {
  struct {
...
static void efc_d_check_plogi_topology(struct efc_node *node, u32 d_id) {
