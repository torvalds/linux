...
static struct efc_nport *efc_nport_find_wwn(struct efc_domain *domain,
...
static void _efc_nport_free(struct kref *arg) {
...
static void efc_nport_shutdown(struct efc_nport *nport) {
  struct efc *efc = nport->efc;
  struct efc_node *node;
  unsigned long index;
  xa_for_each(&nport->lookup, index, node) {
...
static void efc_vport_link_down(struct efc_nport *nport) {
  struct efc *efc = nport->efc;
...
static void __efc_nport_common(const char *funcname, struct efc_sm_ctx *ctx,
...
static void efc_vport_update_spec(struct efc_nport *nport) {
  struct efc *efc = nport->efc;
  struct efc_vport *vport;
  unsigned long flags = 0;
...
static int efc_vport_nport_alloc(struct efc_domain *domain,
    struct efc_vport *vport) {
  struct efc_nport *nport;
...
int efc_nport_vport_new(struct efc_domain *domain, uint64_t wwpn, uint64_t wwnn,
...
struct efc_vport *efc_vport_create_spec(struct efc *efc, uint64_t wwnn,
    uint64_t wwpn,
