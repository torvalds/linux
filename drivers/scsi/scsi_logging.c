...
static size_t scsi_format_extd_sense(char *buffer, size_t buf_len,
...
static size_t scsi_format_sense_hdr(char *buffer, size_t buf_len,
...
static void scsi_log_dump_sense(const struct scsi_device *sdev,
    const char *name, int tag,
...
static void scsi_log_print_sense_hdr(const struct scsi_device *sdev,
    const char *name,
...
static void scsi_log_print_sense(const struct scsi_device *sdev,
    const char *name, int tag,
    const unsigned char *sense_buffer, int sense_len) {
 ...
 */
void scsi_print_sense_hdr(const struct scsi_device *sdev, const char *name,
    const struct scsi_sense_hdr *sshdr) {
