 ...
 */
static fasdmatype_t arxescsi_dma_setup(struct Scsi_Host *host,
 ...
 */
static void arxescsi_dma_pseudo(struct Scsi_Host *host,
    struct scsi_pointer *SCp,
...
static int arxescsi_show_info(struct seq_file *m, struct Scsi_Host *host) {
