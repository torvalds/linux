...
static void bfa_ioc_cb_set_cur_ioc_fwstate(struct bfa_ioc_s *ioc,
...
static void bfa_ioc_cb_set_alt_ioc_fwstate(struct bfa_ioc_s *ioc,
    enum bfi_ioc_state fwstate) {
...
bfa_status_t bfa_ioc_cb_pll_init(void __iomem *rb, enum bfi_asic_mode fcmode) {
