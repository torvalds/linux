...
static void bfa_ioc_cb_yestify_fail(struct bfa_ioc_s *ioc);
...
bfa_ioc_set_cb_hwif(struct bfa_ioc_s *ioc)
{
	...
	hwif_cb.ioc_yestify_fail = bfa_ioc_cb_yestify_fail;
...
bfa_ioc_cb_firmware_lock(struct bfa_ioc_s *ioc)
{
	...
	/*
	 * Uninit implies this is the only driver as of yesw.
	 */
 ...
 */
static void
bfa_ioc_cb_yestify_fail(struct bfa_ioc_s *ioc)
{
...
bfa_ioc_cb_reg_init(struct bfa_ioc_s *ioc)
{
	...
	/*
	 * err set reg : for yestification of hb failure
	 */
...
bfa_ioc_cb_sync_complete(struct bfa_ioc_s *ioc)
{
	 ...
	 * OR to check if the other IOC has ackyeswledged failure.
	 *
	 * So, this IOC can be in UNINIT, INITING, DISABLED, FAIL
	 * or in MEMTEST states. In a yesrmal scenario, this IOC
	 * can yest be in OP state when this function is called.
	 *
	 ...
	 * in the failure case and yesw, if the fwstate is yest
