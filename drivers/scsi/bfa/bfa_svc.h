...
struct bfa_fcxp_rsp_info_s {
	...
	u8		rsp_timeout;
				/* timeout in seconds, 0-yes response */
	u8		rsvd2[3];
...
struct bfa_lps_s {
	...
	wwn_t		nwwn;		/*  yesde wwn of lport		*/
	wwn_t		pr_pwwn;	/*  port wwn of lport peer	*/
	wwn_t		pr_nwwn;	/*  yesde wwn of lport peer	*/
...
/*
 * Link yestification data structure
 */
...
struct bfa_fcport_s {
	...
	u8			alpabm_valid; /* alpa bitmap valid or yest */
...
wwn_t bfa_fcport_get_wwn(struct bfa_s *bfa, bfa_boolean_t yesde);
...
void bfa_cb_rport_scn_yes_dev(void *rp);
...
bfa_status_t	bfa_fcdiag_queuetest(struct bfa_s *bfa, u32 igyesre,
