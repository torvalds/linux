...
typedef void (*bfa_fcport_ln_sm_t)(struct bfa_fcport_ln_s *,
    enum bfa_fcport_ln_sm_event);
...
struct bfa_fcport_s;
typedef void (*bfa_fcport_sm_t)(struct bfa_fcport_s *,
    enum bfa_fcport_sm_event);
...
static inline void *bfa_uf_get_frmbuf(struct bfa_uf_s *uf) {
  return uf->data_ptr;
}

static inline u16 bfa_uf_get_frmlen(struct bfa_uf_s *uf) {
  return uf->data_len;
}
