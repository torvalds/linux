...
static inline enum bfa_rport_state bfa_rport_sm_to_state(
    struct bfa_fcs_rport_sm_table_s *smt, bfa_fcs_rport_sm_t sm) {
  int i = 0;
 ...
 */
static void bfa_fcs_rport_sm_adisc_offline_sending(
...
static void bfa_fcs_rport_process_rpsc(struct bfa_fcs_rport_s *rport,
    struct fchs_s *rx_fchs, u16 len) {
  struct bfa_fcxp_s *fcxp;
  struct fchs_s fchs;
  struct bfa_fcs_lport_s *port = rport->port;
...
static void bfa_fcs_rport_aen_post(struct bfa_fcs_rport_s *rport,
 ...
 */
static void bfa_fcs_rport_process_logo(struct bfa_fcs_rport_s *rport,
    struct fchs_s *fchs) {
...
struct bfa_fcs_rport_s *bfa_fcs_rport_create_by_wwn(
    struct bfa_fcs_lport_s *port, wwn_t rpwwn) {
  struct bfa_fcs_rport_s *rport;
 ...
 * @param[in] rpid  - remote port ID
 */
void bfa_fcs_rport_start(struct bfa_fcs_lport_s *port, struct fchs_s *fchs,
    struct fc_logi_s *plogi) {
  struct bfa_fcs_rport_s *rport;
...
static void bfa_fcs_rpf_send_rpsc2(void *rpf_cbarg,
    struct bfa_fcxp_s *fcxp_alloced) {
...
static void bfa_fcs_rpf_rpsc2_response(void *fcsarg, struct bfa_fcxp_s *fcxp,
    void *cbarg,
    bfa_status_t req_status, u32 rsp_len,
    u32 resid_len, struct fchs_s *rsp_fchs) {
