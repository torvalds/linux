...
static void bfa_port_stats_swap(struct bfa_port_s *port,
 ...
 * @return void
 */
static void bfa_port_enable_isr(struct bfa_port_s *port, bfa_status_t status) {
  bfa_trc(port, status);
 ...
 * @return void
 */
static void bfa_port_disable_isr(struct bfa_port_s *port, bfa_status_t status) {
  bfa_trc(port, status);
  port->endis_pending = BFA_FALSE;
  port->endis_cbfn(port->endis_cbarg, status);
}
 ...
 * @return void
 */
static void bfa_port_get_stats_isr(struct bfa_port_s *port,
    bfa_status_t status) {
 ...
 * @return void
 */
static void bfa_port_clear_stats_isr(struct bfa_port_s *port,
    bfa_status_t status) {
  port->stats_status = status;
  port->stats_busy = BFA_FALSE;
  /*
 ...
 * @return void
 */
static void bfa_cee_get_attr_isr(struct bfa_cee_s *cee, bfa_status_t status) {
 ...
 * @return void
 */
static void bfa_cee_get_stats_isr(struct bfa_cee_s *cee, bfa_status_t status) {
  u32 *buffer;
  int i;
 ...
 * @return void
 */
static void bfa_cee_reset_stats_isr(struct bfa_cee_s *cee,
    bfa_status_t status) {
...
static void bfa_cee_isr(void *cbarg, struct bfi_mbmsg_s *m) {
...
static void bfa_cee_notify(void *arg, enum bfa_ioc_event_e event) {
 ...
 * @return void
 */
void bfa_cee_attach(struct bfa_cee_s *cee, struct bfa_ioc_s *ioc,
    void *dev) {
  WARN_ON(cee == NULL);
  cee->dev = dev;
  cee->ioc = ioc;
