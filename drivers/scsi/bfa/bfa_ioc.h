...
static inline void __bfa_dma_be_addr_set(union bfi_addr_u *dma_addr, u64 pa) {
...
static inline void __bfa_alen_set(struct bfi_alen_s *alen, u32 len, u64 pa) {
...
typedef void (*bfa_dconf_sm_t)(struct bfa_dconf_mod_s *fsm,
    enum bfa_dconf_event);
...
static inline u32 *bfi_image_cb_get_chunk(u32 off) {
  return (u32 *) (bfi_image_cb + off);
}

static inline u32 *bfi_image_ct_get_chunk(u32 off) {
  return (u32 *) (bfi_image_ct + off);
}

static inline u32 *bfi_image_ct2_get_chunk(u32 off) {
  return (u32 *) (bfi_image_ct2 + off);
}

static inline u32 *bfa_cb_image_get_chunk(enum bfi_asic_gen asic_gen, u32 off) {
  switch (asic_gen) {
...
static inline u32 bfa_cb_image_get_size(enum bfi_asic_gen asic_gen) {
  switch (asic_gen) {
    case BFI_ASIC_GEN_CB:
