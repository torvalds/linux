...
enum {
	...
	BFA_MFG_TYPE_CHINOOK2   = 1869,	 /*!< Chiyesok2 cards		*/
...
enum bfa_status {
	...
	BFA_STATUS_UNKNOWN_VFID = 11,	/*  VF_ID yest found */
	BFA_STATUS_DATACORRUPTED = 12,  /*  Diag returned data corrupted */
	BFA_STATUS_DEVBUSY	= 13,	/*  Device busy - Retry operation */
	BFA_STATUS_HDMA_FAILED  = 16,   /* Host dma failed contact support */
	BFA_STATUS_FLASH_BAD_LEN = 17,	/*  Flash bad length */
	BFA_STATUS_UNKNOWN_LWWN = 18,	/*  LPORT PWWN yest found */
	BFA_STATUS_UNKNOWN_RWWN = 19,	/*  RPORT PWWN yest found */
	BFA_STATUS_VPORT_EXISTS = 21,	/*  VPORT already exists */
	BFA_STATUS_VPORT_MAX	= 22,	/*  Reached max VPORT supported limit */
	BFA_STATUS_UNSUPP_SPEED	= 23,	/*  Invalid Speed Check speed setting */
	BFA_STATUS_INVLD_DFSZ	= 24,	/*  Invalid Max data field size */
	BFA_STATUS_CMD_NOTSUPP  = 26,   /*  Command/API yest supported */
	BFA_STATUS_FABRIC_RJT	= 29,	/*  Reject from attached fabric */
	BFA_STATUS_UNKNOWN_VWWN = 30,	/*  VPORT PWWN yest found */
	BFA_STATUS_PORT_OFFLINE = 34,	/*  Port is yest online */
	BFA_STATUS_VPORT_WWN_BP	= 46,	/*  WWN is same as base port's WWN */
	BFA_STATUS_PORT_NOT_DISABLED = 47, /* Port yest disabled disable port */
	BFA_STATUS_NO_FCPIM_NEXUS = 52,	/* No FCP Nexus exists with the rport */
	BFA_STATUS_IOC_FAILURE	= 56,	/* IOC failure - Retry, if persists
					 * contact support */
	BFA_STATUS_INVALID_WWN	= 57,	/*  Invalid WWN */
	BFA_STATUS_ADAPTER_ENABLED = 60, /* Adapter is yest disabled */
	BFA_STATUS_IOC_NON_OP   = 61,	/* IOC is yest operational */
	...
	BFA_STATUS_CMD_NOTSUPP_CNA = 146, /* Command yest supported for CNA */
	BFA_STATUS_PBC		= 154, /*  Operation yest allowed for pre-boot
					*  configuration */
	BFA_STATUS_BAD_FWCFG = 156,	/* Bad firmware configuration */
	BFA_STATUS_INVALID_VENDOR = 158, /* Invalid switch vendor */
	BFA_STATUS_SFP_NOT_READY = 159,	/* SFP info is yest ready. Retry */
	BFA_STATUS_TRUNK_ENABLED = 164, /* Trunk is already enabled on
					 * this adapter */
	BFA_STATUS_TRUNK_DISABLED  = 165, /* Trunking is disabled on
					   * the adapter */
	BFA_STATUS_IOPROFILE_OFF = 175, /* IO profile OFF */
	BFA_STATUS_PHY_NOT_PRESENT = 183, /* PHY module yest present */
	BFA_STATUS_FEATURE_NOT_SUPPORTED = 192,	/* Feature yest supported */
	BFA_STATUS_ENTRY_EXISTS = 193,	/* Entry already exists */
	BFA_STATUS_ENTRY_NOT_EXISTS = 194, /* Entry does yest exist */
	...
	BFA_STATUS_LOOP_UNSUPP_MEZZ = 231, /* Loop topology is yest supported
					    * on mezz cards */
	...
	BFA_STATUS_CMD_NOTSUPP_MEZZ = 239, /* Cmd yest supported for MEZZ card */
	BFA_STATUS_FRU_NOT_PRESENT = 240, /* fru module yest present */
	BFA_STATUS_DPORT_NO_SFP = 243, /* SFP is yest present.\n D-port will be
					* enabled but it will be operational
					* only after inserting a valid SFP. */
	BFA_STATUS_DPORT_ERR = 245,	/* D-port mode is enabled */
	BFA_STATUS_DPORT_ENOSYS = 254, /* Switch has yes D_Port functionality */
	BFA_STATUS_DPORT_CANT_PERF = 255, /* Switch port is yest D_Port capable
	...
	BFA_STATUS_DPORT_SW_NOTREADY = 268, /* Remote port is yest ready to
					* start dport test. Check remote
					* port status. */
	BFA_STATUS_DPORT_INV_SFP = 271, /* Invalid SFP for D-PORT mode. */
	BFA_STATUS_DPORT_CMD_NOTSUPP    = 273, /* Dport is yest supported by
					* remote port */
	BFA_STATUS_MAX_VAL		/* Unkyeswn error code */
};
...
struct bfa_adapter_attr_s {
	...
	wwn_t		pwwn;
	char		yesde_symname[FC_SYMNAME_MAX];
...
enum bfa_port_aen_event {
	...
	BFA_PORT_AEN_RLIR	= 3,    /* RLIR event, yest supported */
...
enum bfa_lport_aen_event {
	...
	BFA_LPORT_AEN_NPIV_UNKNOWN = 12,	/* Unkyeswn NPIV Error code */
};
...
/* SFP state change yestification event */
...
struct sfp_srlid_ext_s {
	...
	u8	vendor_sn[16];
	u8	date_code[8];
	u8	diag_mon_type;  /* 92: Diagyesstic Monitoring type */
	u8	en_options;
	u8	sff_8472;
	u8	cc_ext;
};
...
/*
 * Diagyesstic: Data Fields -- Address A2h
 * Diagyesstic and control/status base field total 96 bytes
 */
...
/*
 * Diagyesstic: Data Fields -- Address A2h
 * Diagyesstic and control/status extended field total 24 bytes
 */
...
struct sfp_xcvr_fc1_code_s {
	...
	u8	xmtr_tech2:3;
	u8	xmtr_tech1:7;   /* FC transmitter techyeslogy */
	u8	reserved1:1;
};
...
struct bfa_diag_loopback_result_s {
	u32	numtxmfrm;      /* yes. of transmit frame */
	u32	numosffrm;      /* yes. of outstanding frame */
	u32	numrcvfrm;      /* yes. of received good frame */
...
enum bfa_diag_dport_test_status {
	DPORT_TEST_ST_IDLE	= 0,    /* the test has yest started yet. */
...
struct bfa_diag_dport_result_s {
	...
	wwn_t	rp_nwwn;	/* switch yesde wwn  */
	...
	u32	pat;		/* Pattern */
	u32	roundtrip_latency;	/* in nayes sec */
...
struct bfa_diag_ledtest_s {
	...
	u16	freq;   /* yes. of blinks every 10 secs */
...
enum bfa_phy_status_e {
	...
	BFA_PHY_STATUS_NOT_PRESENT	= 1, /* phy does yest exist */
