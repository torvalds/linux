...
void __bfa_trc(struct bfa_trc_mod_s *trcm, int fileno, int line, u64 data) {
  int tail = trcm->tail;
...
static void bfa_com_flash_attach(struct bfa_s *bfa, bfa_boolean_t mincfg) {
...
static void bfa_com_phy_attach(struct bfa_s *bfa, bfa_boolean_t mincfg) {
...
static void bfa_com_fru_attach(struct bfa_s *bfa, bfa_boolean_t mincfg) {
...
static void bfa_iocfc_sm_stopped(struct bfa_iocfc_s *iocfc,
...
static void bfa_iocfc_sm_initing(struct bfa_iocfc_s *iocfc,
    enum iocfc_event event) {
  bfa_trc(iocfc->bfa, event);
  switch (event) {
...
static void bfa_iocfc_sm_dconf_read(struct bfa_iocfc_s *iocfc,
    enum iocfc_event event) {
  bfa_trc(iocfc->bfa, event);
  switch (event) {
...
static void bfa_iocfc_sm_init_cfg_wait(struct bfa_iocfc_s *iocfc,
    enum iocfc_event event) {
  bfa_trc(iocfc->bfa, event);
  switch (event) {
...
static void bfa_iocfc_sm_init_cfg_done(struct bfa_iocfc_s *iocfc,
    enum iocfc_event event) {
  bfa_trc(iocfc->bfa, event);
  switch (event) {
    case IOCFC_E_START:
...
static void bfa_iocfc_sm_operational(struct bfa_iocfc_s *iocfc,
    enum iocfc_event event) {
  bfa_trc(iocfc->bfa, event);
  switch (event) {
    case IOCFC_E_STOP:
...
static void bfa_iocfc_sm_dconf_write(struct bfa_iocfc_s *iocfc,
    enum iocfc_event event) {
  bfa_trc(iocfc->bfa, event);
  switch (event) {
    case IOCFC_E_DCONF_DONE:
...
static void bfa_iocfc_sm_stopping(struct bfa_iocfc_s *iocfc,
    enum iocfc_event event) {
  bfa_trc(iocfc->bfa, event);
  switch (event) {
...
static void bfa_iocfc_sm_enabling(struct bfa_iocfc_s *iocfc,
    enum iocfc_event event) {
  bfa_trc(iocfc->bfa, event);
  switch (event) {
    case IOCFC_E_IOC_ENABLED:
...
static void bfa_iocfc_sm_cfg_wait(struct bfa_iocfc_s *iocfc,
    enum iocfc_event event) {
  bfa_trc(iocfc->bfa, event);
  switch (event) {
    case IOCFC_E_CFG_DONE:
...
static void bfa_iocfc_sm_disabling(struct bfa_iocfc_s *iocfc,
    enum iocfc_event event) {
  bfa_trc(iocfc->bfa, event);
  switch (event) {
    case IOCFC_E_IOC_DISABLED:
...
static void bfa_iocfc_sm_disabled(struct bfa_iocfc_s *iocfc,
    enum iocfc_event event) {
  bfa_trc(iocfc->bfa, event);
  switch (event) {
    case IOCFC_E_STOP:
...
static void bfa_iocfc_sm_failed(struct bfa_iocfc_s *iocfc,
    enum iocfc_event event) {
  bfa_trc(iocfc->bfa, event);
  switch (event) {
    case IOCFC_E_STOP:
...
static void bfa_iocfc_sm_init_failed(struct bfa_iocfc_s *iocfc,
    enum iocfc_event event) {
  bfa_trc(iocfc->bfa, event);
  switch (event) {
    case IOCFC_E_STOP:
...
static bfa_boolean_t bfa_isr_rspq(struct bfa_s *bfa, int qid) {
  struct bfi_msg_s *m;
  u32 pi, ci;
...
static inline void bfa_isr_reqq(struct bfa_s *bfa, int qid) {
  struct list_head *waitq;
...
static void bfa_iocfc_init_mem(struct bfa_s *bfa, void *bfad,
...
static void bfa_iocfc_mem_claim(struct bfa_s *bfa,
    struct bfa_iocfc_cfg_s *cfg) {
  u8 *dm_kva = NULL;
  u64 dm_pa = 0;
...
static void bfa_iocfc_res_recfg(struct bfa_s *bfa,
 ...
 */
static void bfa_iocfc_process_faa_addr(struct bfa_s *bfa,
 ...
 */
static bfa_status_t bfa_faa_validate_request(struct bfa_s *bfa) {
 ...
 *  FAA query response
 */
static void bfa_faa_query_reply(struct bfa_iocfc_s *iocfc,
