...
void bfa_cb_ioim_done(void *drv, struct bfad_ioim_s *dio,
...
static bfa_status_t bfad_im_target_reset_send(struct bfad_s *bfad,
 ...
 */
static int bfad_im_reset_target_handler(struct scsi_cmnd *cmnd) {
  struct Scsi_Host *shost = cmnd->device->host;
 ...
 */
static int bfad_im_check_if_make_lun_visible(struct scsi_device *sdev,
