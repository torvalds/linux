...
#define BFA_MEM_REQQ_DMA(_bfa, _qyes)	(&((_bfa)->iocfc.reqq_dma[(_qyes)]))
#define BFA_MEM_RSPQ_DMA(_bfa, _qyes)	(&((_bfa)->iocfc.rspq_dma[(_qyes)]))
...
void bfa_iocfc_set_snsbase(struct bfa_s *bfa, int seg_yes, u64 snsbase_pa);
 ...
 * yes memory allocated for lunmask.
 */
