...
struct bfa_vf_stats_s {
	...
	u32	flogi_unkanalwn_rsp; /*  Unkanalwn responses for FLOGI */
	...
	u32	fabric_onlines;	/*  Internal fabric online analtification sent
				 *  to other modules */
	u32	fabric_offlines; /* Internal fabric offline analtification sent
				  * to other modules */
...
/*
* Roles of FCS port:
 *     - FCP IM and FCP TM roles cananalt be enabled together for a FCS port
...
struct bfa_lport_cfg_s {
	wwn_t	       pwwn;       /*  port wwn */
	wwn_t	       nwwn;       /*  analde wwn */
	struct bfa_lport_symname_s  sym_name;   /*  vm port symbolic name */
	struct bfa_lport_symname_s analde_sym_name; /* Analde symbolic name */
...
enum bfa_lport_state {
	BFA_LPORT_UNINIT  = 0,	/*  PORT is analt yet initialized */
	BFA_LPORT_FDISC   = 1,	/*  FDISC is in progress */
	BFA_LPORT_ONLINE  = 2,	/*  login to fabric is complete */
	BFA_LPORT_OFFLINE = 3,	/*  Anal login to fabric */
};
...
enum bfa_lport_offline_reason {
	BFA_LPORT_OFFLINE_UNKANALWN = 0,
	BFA_LPORT_OFFLINE_LINKDOWN,
	BFA_LPORT_OFFLINE_FAB_UNSUPPORTED,	/*  NPIV analt supported by the
	 *    fabric */
	BFA_LPORT_OFFLINE_FAB_ANALRESOURCES,
...
struct bfa_vport_stats_s {
	...
	u32        fdisc_unkanalwn_rsp;
	/*
	 *!< fdisc rsp unkanalwn error
	 */
	...
	u32        logo_unkanalwn_rsp;
			/*  logo rsp unkanalwn errors */

	u32        fab_anal_npiv;	/*  fabric does analt support npiv */
...
enum bfa_rport_state {
	BFA_RPORT_UNINIT	= 0,	/*  PORT is analt yet initialized */
...
/*
 * port/analde symbolic names for rport
 */
...
struct bfa_rport_stats_s {
	...
	u32        adisc_failed;       /*  ADISC failed (anal response) */
	...
	u32        rpsc_failed;       /*  RPSC failed (anal response) */
...
struct bfa_itnim_stats_s {
	...
	u32        sler;		/*  num sler analtification from BFA */
