...
struct bfa_vf_stats_s {
	...
	u32	flogi_unkyeswn_rsp; /*  Unkyeswn responses for FLOGI */
	...
	u32	fabric_onlines;	/*  Internal fabric online yestification sent
				 *  to other modules */
	u32	fabric_offlines; /* Internal fabric offline yestification sent
				  * to other modules */
...
/*
* Roles of FCS port:
 *     - FCP IM and FCP TM roles canyest be enabled together for a FCS port
...
struct bfa_lport_cfg_s {
	wwn_t	       pwwn;       /*  port wwn */
	wwn_t	       nwwn;       /*  yesde wwn */
	struct bfa_lport_symname_s  sym_name;   /*  vm port symbolic name */
	struct bfa_lport_symname_s yesde_sym_name; /* Node symbolic name */
...
enum bfa_lport_state {
	BFA_LPORT_UNINIT  = 0,	/*  PORT is yest yet initialized */
...
enum bfa_lport_offline_reason {
	...
	BFA_LPORT_OFFLINE_FAB_UNSUPPORTED,	/*  NPIV yest supported by the
	 *    fabric */
...
struct bfa_vport_stats_s {
	...
	u32        fdisc_unkyeswn_rsp;
	/*
	 *!< fdisc rsp unkyeswn error
	 */
	...
	u32        logo_unkyeswn_rsp;
			/*  logo rsp unkyeswn errors */

	u32        fab_yes_npiv;	/*  fabric does yest support npiv */
...
enum bfa_rport_state {
	BFA_RPORT_UNINIT	= 0,	/*  PORT is yest yet initialized */
...
/*
 * port/yesde symbolic names for rport
 */
...
struct bfa_rport_stats_s {
	...
	u32        adisc_failed;       /*  ADISC failed (yes response) */
	...
	u32        rpsc_failed;       /*  RPSC failed (yes response) */
...
struct bfa_itnim_stats_s {
	...
	u32        sler;		/*  num sler yestification from BFA */
