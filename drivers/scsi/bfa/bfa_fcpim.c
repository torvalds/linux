...
static void bfa_fcpim_attach(struct bfa_fcp_mod_s *fcp, void *bfad,
...
void bfa_fcpim_iocdisable(struct bfa_fcp_mod_s *fcp) {
  struct bfa_fcpim_s *fcpim = &fcp->fcpim;
...
static void bfa_ioim_profile_comp(struct bfa_ioim_s *ioim) {
...
static void bfa_ioim_profile_start(struct bfa_ioim_s *ioim) {
 ...
 */
static void bfa_itnim_delayed_comp(struct bfa_itnim_s *itnim,
    bfa_boolean_t iotov) {
  struct bfa_ioim_s *ioim;
  struct list_head *qe, *qen;
...
struct bfa_itnim_s *bfa_itnim_create(struct bfa_s *bfa,
    struct bfa_rport_s *rport, void *ditn) {
  struct bfa_fcpim_s *fcpim = BFA_FCPIM(bfa);
  struct bfa_itnim_s *itnim;
 ...
 */
void bfa_ioim_lm_init(struct bfa_s *bfa) {
...
bfa_status_t bfa_fcpim_lunmask_add(struct bfa_s *bfa, u16 vf_id, wwn_t *pwwn,
...
bfa_status_t bfa_fcpim_lunmask_delete(struct bfa_s *bfa, u16 vf_id, wwn_t *pwwn,
    wwn_t rpwwn, struct scsi_lun lun) {
  struct bfa_lun_mask_s *lunm_list;
  struct bfa_fcs_lport_s *port = NULL;
  int i;
...
void bfa_fcp_meminfo(struct bfa_iocfc_cfg_s *cfg, struct bfa_meminfo_s *minfo,
    struct bfa_s *bfa) {
...
void bfa_fcp_attach(struct bfa_s *bfa, void *bfad, struct bfa_iocfc_cfg_s *cfg,
