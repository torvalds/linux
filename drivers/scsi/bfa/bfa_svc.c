...
static inline enum bfa_port_states bfa_fcport_sm_to_state(
    struct bfa_fcport_sm_table_s *smt, bfa_fcport_sm_t sm) {
  int i = 0;
...
static void bfa_plog_add(struct bfa_plog_s *plog,
    struct bfa_plog_rec_s *pl_rec) {
  u16 tail;
...
void bfa_fcxp_meminfo(struct bfa_iocfc_cfg_s *cfg, struct bfa_meminfo_s *minfo,
    struct bfa_s *bfa) {
...
void bfa_fcxp_attach(struct bfa_s *bfa, void *bfad, struct bfa_iocfc_cfg_s *cfg,
...
void bfa_fcxp_iocdisable(struct bfa_s *bfa) {
  struct bfa_fcxp_mod_s *mod = BFA_FCXP_MOD(bfa);
  struct bfa_fcxp_s *fcxp;
...
static struct bfa_fcxp_s *bfa_fcxp_get(struct bfa_fcxp_mod_s *fm,
    bfa_boolean_t req) {
  struct bfa_fcxp_s *fcxp;
  if (req) {
...
static void bfa_fcxp_init_reqrsp(struct bfa_fcxp_s *fcxp,
    struct bfa_s *bfa,
    u8 *use_ibuf,
    u32 *nr_sgles,
...
static void bfa_fcxp_init(struct bfa_fcxp_s *fcxp,
...
static void bfa_fcxp_null_comp(void *bfad_fcxp, struct bfa_fcxp_s *fcxp,
    void *cbarg,
...
static void hal_fcxp_send_comp(struct bfa_s *bfa,
    struct bfi_fcxp_send_rsp_s *fcxp_rsp) {
  struct bfa_fcxp_mod_s *mod = BFA_FCXP_MOD(bfa);
  struct bfa_fcxp_s *fcxp;
 ...
 */
struct bfa_fcxp_s *bfa_fcxp_req_rsp_alloc(void *caller, struct bfa_s *bfa,
    int nreq_sgles,
    int nrsp_sgles, bfa_fcxp_get_sgaddr_t req_sga_cbfn,
    bfa_fcxp_get_sglen_t req_sglen_cbfn,
    bfa_fcxp_get_sgaddr_t rsp_sga_cbfn,
 ...
 */
void bfa_lps_meminfo(struct bfa_iocfc_cfg_s *cfg, struct bfa_meminfo_s *minfo,
    struct bfa_s *bfa) {
 ...
 */
void bfa_lps_attach(struct bfa_s *bfa, void *bfad, struct bfa_iocfc_cfg_s *cfg,
    struct bfa_pcidev_s *pcidev) {
 ...
 */
static void bfa_lps_rx_cvl_event(struct bfa_s *bfa,
    struct bfi_lps_cvl_event_s *cvl) {
  struct bfa_lps_mod_s *mod = BFA_LPS_MOD(bfa);
  struct bfa_lps_s *lps;
 ...
 */
static void bfa_lps_login_comp_cb(void *arg, bfa_boolean_t complete) {
 ...
 */
static void bfa_lps_logout_comp_cb(void *arg, bfa_boolean_t complete) {
  struct bfa_lps_s *lps = arg;
  if (!complete) {
    return;
  }
 ...
 */
static void bfa_lps_cvl_event_cb(void *arg, bfa_boolean_t complete) {
  struct bfa_lps_s *lps = arg;
  if (!complete) {
    return;
  }
...
static void bfa_fcport_aen_post(struct bfa_fcport_s *fcport,
...
void bfa_fcport_meminfo(struct bfa_iocfc_cfg_s *cfg,
 ...
 */
void bfa_fcport_attach(struct bfa_s *bfa, void *bfad,
...
void bfa_fcport_start(struct bfa_s *bfa) {
 ...
 */
void bfa_fcport_iocdisable(struct bfa_s *bfa) {
  struct bfa_fcport_s *fcport = BFA_FCPORT_MOD(bfa);
 ...
 */
static void bfa_fcport_update_loop_info(struct bfa_fcport_s *fcport,
...
static void bfa_fcport_qos_stats_swap(struct bfa_qos_stats_s *d,
...
static void bfa_fcport_fcoe_stats_swap(struct bfa_fcoe_stats_s *d,
...
static void __bfa_cb_fcport_stats_get(void *cbarg, bfa_boolean_t complete) {
 ...
 */
static void bfa_trunk_scn(struct bfa_fcport_s *fcport,
    struct bfi_fcport_trunk_scn_s *scn) {
  struct bfa_fcport_trunk_s *trunk = &fcport->trunk;
...
bfa_status_t bfa_fcport_cfg_bbcr(struct bfa_s *bfa, bfa_boolean_t on_off,
    u8 bb_scn) {
  struct bfa_fcport_s *fcport = BFA_FCPORT_MOD(bfa);
  bfa_trc(bfa, on_off);
  if (bfa_ioc_get_type(&fcport->bfa->ioc) != BFA_IOC_TYPE_FC) {
...
static void bfa_fcport_ddportenable(struct bfa_s *bfa) {
  /*
   * Assume caller check for port is in disable state
   */
...
static void bfa_fcport_ddportdisable(struct bfa_s *bfa) {
  /*
   * Assume caller check for port is in disable state
   */
...
void bfa_rport_meminfo(struct bfa_iocfc_cfg_s *cfg, struct bfa_meminfo_s *minfo,
    struct bfa_s *bfa) {
...
void bfa_rport_attach(struct bfa_s *bfa, void *bfad,
    struct bfa_iocfc_cfg_s *cfg,
    struct bfa_pcidev_s *pcidev) {
 ...
 */
void bfa_sgpg_meminfo(struct bfa_iocfc_cfg_s *cfg, struct bfa_meminfo_s *minfo,
    struct bfa_s *bfa) {
...
void bfa_sgpg_attach(struct bfa_s *bfa, void *bfad, struct bfa_iocfc_cfg_s *cfg,
    struct bfa_pcidev_s *pcidev) {
...
void bfa_sgpg_winit(struct bfa_sgpg_wqe_s *wqe, void (*cbfn)(void *cbarg),
    void *cbarg) {
 ...
 *****************************************************************************
 */
static void __bfa_cb_uf_recv(void *cbarg, bfa_boolean_t complete) {
...
void bfa_uf_meminfo(struct bfa_iocfc_cfg_s *cfg, struct bfa_meminfo_s *minfo,
    struct bfa_s *bfa) {
...
void bfa_uf_attach(struct bfa_s *bfa, void *bfad, struct bfa_iocfc_cfg_s *cfg,
    struct bfa_pcidev_s *pcidev) {
  struct bfa_uf_mod_s *ufm = BFA_UF_MOD(bfa);
  ufm->bfa = bfa;
...
static bfa_status_t bfa_uf_post(struct bfa_uf_mod_s *ufm, struct bfa_uf_s *uf) {
...
void bfa_uf_iocdisable(struct bfa_s *bfa) {
  struct bfa_uf_mod_s *ufm = BFA_UF_MOD(bfa);
  struct bfa_uf_s *uf;
  struct list_head *qe, *qen;
...
void bfa_uf_start(struct bfa_s *bfa) {
...
void bfa_fcdiag_attach(struct bfa_s *bfa, void *bfad,
    struct bfa_iocfc_cfg_s *cfg,
    struct bfa_pcidev_s *pcidev) {
...
void bfa_fcdiag_iocdisable(struct bfa_s *bfa) {
  struct bfa_fcdiag_s *fcdiag = BFA_FCDIAG_MOD(bfa);
  struct bfa_dport_s *dport = &fcdiag->dport;
...
static bfa_status_t bfa_fcdiag_queuetest_send(struct bfa_fcdiag_s *fcdiag) {
  u32 i;
...
static void bfa_fcdiag_queuetest_comp(struct bfa_fcdiag_s *fcdiag,
...
static void bfa_fcdiag_loopback_comp(struct bfa_fcdiag_s *fcdiag,
...
static bfa_status_t bfa_fcdiag_loopback_send(struct bfa_fcdiag_s *fcdiag,
 ...
 *   @param[out]
 */
bfa_status_t bfa_fcdiag_loopback(struct bfa_s *bfa, enum bfa_port_opmode opmode,
 ...
 *   @param[out]
 */
bfa_status_t bfa_fcdiag_queuetest(struct bfa_s *bfa, u32 force, u32 queue,
...
static void bfa_cb_fcdiag_dport(struct bfa_dport_s *dport,
...
static bfa_boolean_t bfa_dport_is_sending_req(struct bfa_dport_s *dport) {
