...
static void fc_gs_fchdr_build(struct fchs_s *fchs, u32 d_id, u32 s_id,
    u32 ox_id) {
...
static void fc_gsresp_fchdr_build(struct fchs_s *fchs, u32 d_id, u32 s_id,
    u16 ox_id) {
  memset(fchs, 0, sizeof(struct fchs_s));
  fchs->routing = FC_RTG_FC4_DEV_DATA;
...
u16 fc_plogi_build(struct fchs_s *fchs, void *pld, u32 d_id, u32 s_id,
...
u16 fc_plogi_acc_build(struct fchs_s *fchs, void *pld, u32 d_id, u32 s_id,
    u16 ox_id, wwn_t port_name, wwn_t node_name,
    u16 pdu_size, u16 bb_cr) {
  return fc_plogi_x_build(fchs, pld, d_id, s_id, ox_id, port_name,
...
u16 fc_prli_build(struct fchs_s *fchs, void *pld, u32 d_id, u32 s_id,
    u16 ox_id) {
...
static u16 fc_adisc_x_build(struct fchs_s *fchs, struct fc_adisc_s *adisc,
    u32 d_id,
...
u16 fc_pdisc_build(struct fchs_s *fchs, u32 d_id, u32 s_id, u16 ox_id,
...
u16 fc_prlo_build(struct fchs_s *fchs, u32 d_id, u32 s_id, u16 ox_id,
    int num_pages) {
...
u16 fc_tprlo_build(struct fchs_s *fchs, u32 d_id, u32 s_id, u16 ox_id,
...
u16 fc_ba_rjt_build(struct fchs_s *fchs, u32 d_id, u32 s_id, __be16 ox_id,
...
static void fc_gs_fdmi_cthdr_build(struct ct_hdr_s *cthdr, u32 s_id,
    u16 cmd_code) {
  memset(cthdr, 0, sizeof(struct ct_hdr_s));
  cthdr->rev_id = CT_GS3_REVISION;
...
u16 fc_gidpn_build(struct fchs_s *fchs, void *pyld, u32 s_id, u16 ox_id,
    wwn_t port_name) {
...
u16 fc_gpnid_build(struct fchs_s *fchs, void *pyld, u32 s_id, u16 ox_id,
    u32 port_id) {
  struct ct_hdr_s *cthdr = (struct ct_hdr_s *) pyld;
...
u16 fc_rftid_build_sol(struct fchs_s *fchs, void *pyld, u32 s_id, u16 ox_id,
...
u16 fc_rffid_build(struct fchs_s *fchs, void *pyld, u32 s_id, u16 ox_id,
...
u16 fc_rspnid_build(struct fchs_s *fchs, void *pyld, u32 s_id, u16 ox_id,
    u8 *name) {
  struct ct_hdr_s *cthdr = (struct ct_hdr_s *) pyld;
...
u16 fc_rsnn_nn_build(struct fchs_s *fchs, void *pyld, u32 s_id,
...
u16 fc_rpnid_build(struct fchs_s *fchs, void *pyld, u32 s_id, u32 port_id,
    wwn_t port_name) {
  struct ct_hdr_s *cthdr = (struct ct_hdr_s *) pyld;
...
u16 fc_rnnid_build(struct fchs_s *fchs, void *pyld, u32 s_id, u32 port_id,
    wwn_t node_name) {
  struct ct_hdr_s *cthdr = (struct ct_hdr_s *) pyld;
...
u16 fc_rcsid_build(struct fchs_s *fchs, void *pyld, u32 s_id, u32 port_id,
    u32 cos) {
  struct ct_hdr_s *cthdr = (struct ct_hdr_s *) pyld;
...
u16 fc_rptid_build(struct fchs_s *fchs, void *pyld, u32 s_id, u32 port_id,
    u8 port_type) {
  struct ct_hdr_s *cthdr = (struct ct_hdr_s *) pyld;
