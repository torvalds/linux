...
static int bfad_iocmd_ioc_enable(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_ioc_disable(struct bfad_s *bfad, void *cmd) {
  struct bfa_bsg_gen_s *iocmd = (struct bfa_bsg_gen_s *) cmd;
  unsigned long flags;
  spin_lock_irqsave(&bfad->bfad_lock, flags);
  if (bfa_ioc_is_disabled(&bfad->bfa.ioc)) {
...
static int bfad_iocmd_ioc_get_stats(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_ioc_get_fwstats(struct bfad_s *bfad, void *cmd,
...
static int bfad_iocmd_ioc_reset_stats(struct bfad_s *bfad, void *cmd,
    unsigned int v_cmd) {
  struct bfa_bsg_gen_s *iocmd = (struct bfa_bsg_gen_s *) cmd;
  unsigned long flags;
...
static int bfad_iocmd_ioc_set_name(struct bfad_s *bfad, void *cmd,
    unsigned int v_cmd) {
...
static int bfad_iocmd_iocfc_get_attr(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_ioc_fw_sig_inv(struct bfad_s *bfad, void *cmd) {
  struct bfa_bsg_gen_s *iocmd = (struct bfa_bsg_gen_s *) cmd;
  unsigned long flags;
  spin_lock_irqsave(&bfad->bfad_lock, flags);
...
static int bfad_iocmd_iocfc_set_intr(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_port_enable(struct bfad_s *bfad, void *cmd) {
  struct bfa_bsg_gen_s *iocmd = (struct bfa_bsg_gen_s *) cmd;
...
static int bfad_iocmd_port_disable(struct bfad_s *bfad, void *cmd) {
  struct bfa_bsg_gen_s *iocmd = (struct bfa_bsg_gen_s *) cmd;
  struct bfad_hal_comp fcomp;
  unsigned long flags;
  init_completion(&fcomp.comp);
...
static int bfad_iocmd_port_get_stats(struct bfad_s *bfad, void *cmd,
    unsigned int payload_len) {
...
static int bfad_iocmd_port_reset_stats(struct bfad_s *bfad, void *cmd) {
  struct bfa_bsg_gen_s *iocmd = (struct bfa_bsg_gen_s *) cmd;
  struct bfad_hal_comp fcomp;
  unsigned long flags;
  init_completion(&fcomp.comp);
...
static int bfad_iocmd_set_port_cfg(struct bfad_s *bfad, void *iocmd,
    unsigned int v_cmd) {
...
static int bfad_iocmd_port_cfg_maxfrsize(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_port_cfg_bbcr(struct bfad_s *bfad, unsigned int cmd,
    void *pcmd) {
...
static int bfad_iocmd_port_get_bbcr_attr(struct bfad_s *bfad, void *pcmd) {
...
static int bfad_iocmd_lport_get_stats(struct bfad_s *bfad, void *cmd) {
  struct bfa_fcs_lport_s *fcs_port;
...
static int bfad_iocmd_lport_reset_stats(struct bfad_s *bfad, void *cmd) {
  struct bfa_fcs_lport_s *fcs_port;
...
static int bfad_iocmd_lport_get_iostats(struct bfad_s *bfad, void *cmd) {
  struct bfa_fcs_lport_s *fcs_port;
...
static int bfad_iocmd_lport_get_rports(struct bfad_s *bfad, void *cmd,
    unsigned int payload_len) {
...
static int bfad_iocmd_rport_get_attr(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_rport_get_stats(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_rport_clr_stats(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_rport_set_speed(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_vport_get_attr(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_vport_get_stats(struct bfad_s *bfad, void *cmd) {
  struct bfa_fcs_vport_s *fcs_vport;
...
static int bfad_iocmd_vport_clr_stats(struct bfad_s *bfad, void *cmd) {
  struct bfa_fcs_vport_s *fcs_vport;
  struct bfa_bsg_reset_stats_s *iocmd
    = (struct bfa_bsg_reset_stats_s *) cmd;
  unsigned long flags;
...
static int bfad_iocmd_fabric_get_lports(struct bfad_s *bfad, void *cmd,
    unsigned int payload_len) {
...
static int bfad_iocmd_qos_set_bw(struct bfad_s *bfad, void *pcmd) {
...
static int bfad_iocmd_ratelim(struct bfad_s *bfad, unsigned int cmd,
    void *pcmd) {
...
static int bfad_iocmd_ratelim_speed(struct bfad_s *bfad, unsigned int cmd,
    void *pcmd) {
...
static int bfad_iocmd_cfg_fcpim(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_fcpim_get_modstats(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_fcpim_clr_modstats(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_fcpim_get_del_itn_stats(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_fcport_enable(struct bfad_s *bfad, void *cmd) {
  struct bfa_bsg_gen_s *iocmd = (struct bfa_bsg_gen_s *) cmd;
  unsigned long flags;
  spin_lock_irqsave(&bfad->bfad_lock, flags);
...
static int bfad_iocmd_fcport_disable(struct bfad_s *bfad, void *cmd) {
  struct bfa_bsg_gen_s *iocmd = (struct bfa_bsg_gen_s *) cmd;
  unsigned long flags;
  spin_lock_irqsave(&bfad->bfad_lock, flags);
...
static int bfad_iocmd_ioc_get_pcifn_cfg(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_pcifn_create(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_pcifn_delete(struct bfad_s *bfad, void *cmd) {
  struct bfa_bsg_pcifn_s *iocmd = (struct bfa_bsg_pcifn_s *) cmd;
  struct bfad_hal_comp fcomp;
  unsigned long flags;
  init_completion(&fcomp.comp);
...
static int bfad_iocmd_pcifn_bw(struct bfad_s *bfad, void *cmd) {
  struct bfa_bsg_pcifn_s *iocmd = (struct bfa_bsg_pcifn_s *) cmd;
  struct bfad_hal_comp fcomp;
  unsigned long flags;
  init_completion(&fcomp.comp);
...
static int bfad_iocmd_adapter_cfg_mode(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_port_cfg_mode(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_ablk_optrom(struct bfad_s *bfad, unsigned int cmd,
    void *pcmd) {
  struct bfa_bsg_gen_s *iocmd = (struct bfa_bsg_gen_s *) pcmd;
  struct bfad_hal_comp fcomp;
  unsigned long flags;
...
static int bfad_iocmd_faa_query(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_cee_attr(struct bfad_s *bfad, void *cmd,
    unsigned int payload_len) {
...
static int bfad_iocmd_cee_get_stats(struct bfad_s *bfad, void *cmd,
    unsigned int payload_len) {
...
static int bfad_iocmd_cee_reset_stats(struct bfad_s *bfad, void *cmd) {
  struct bfa_bsg_gen_s *iocmd = (struct bfa_bsg_gen_s *) cmd;
  unsigned long flags;
  spin_lock_irqsave(&bfad->bfad_lock, flags);
...
static int bfad_iocmd_sfp_media(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_sfp_speed(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_flash_get_attr(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_flash_erase_part(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_flash_update_part(struct bfad_s *bfad, void *cmd,
    unsigned int payload_len) {
  struct bfa_bsg_flash_s *iocmd = (struct bfa_bsg_flash_s *) cmd;
  void *iocmd_bufptr;
  struct bfad_hal_comp fcomp;
...
static int bfad_iocmd_flash_read_part(struct bfad_s *bfad, void *cmd,
    unsigned int payload_len) {
  struct bfa_bsg_flash_s *iocmd = (struct bfa_bsg_flash_s *) cmd;
  struct bfad_hal_comp fcomp;
  void *iocmd_bufptr;
...
static int bfad_iocmd_diag_temp(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_diag_memtest(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_diag_loopback(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_diag_fwping(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_diag_queuetest(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_diag_sfp(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_diag_led(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_diag_beacon_lport(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_diag_lb_stat(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_diag_dport_enable(struct bfad_s *bfad, void *pcmd) {
...
static int bfad_iocmd_diag_dport_disable(struct bfad_s *bfad, void *pcmd) {
  struct bfa_bsg_gen_s *iocmd = (struct bfa_bsg_gen_s *) pcmd;
  unsigned long flags;
  struct bfad_hal_comp fcomp;
  init_completion(&fcomp.comp);
...
static int bfad_iocmd_diag_dport_start(struct bfad_s *bfad, void *pcmd) {
  struct bfa_bsg_dport_enable_s *iocmd
    = (struct bfa_bsg_dport_enable_s *) pcmd;
  unsigned long flags;
  struct bfad_hal_comp fcomp;
...
static int bfad_iocmd_diag_dport_show(struct bfad_s *bfad, void *pcmd) {
...
static int bfad_iocmd_phy_get_attr(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_phy_get_stats(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_phy_read(struct bfad_s *bfad, void *cmd,
    unsigned int payload_len) {
...
static int bfad_iocmd_vhba_query(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_phy_update(struct bfad_s *bfad, void *cmd,
    unsigned int payload_len) {
  struct bfa_bsg_phy_s *iocmd = (struct bfa_bsg_phy_s *) cmd;
  void *iocmd_bufptr;
  struct bfad_hal_comp fcomp;
...
static int bfad_iocmd_porglog_get(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_debug_fw_core(struct bfad_s *bfad, void *cmd,
    unsigned int payload_len) {
  struct bfa_bsg_debug_s *iocmd = (struct bfa_bsg_debug_s *) cmd;
  void *iocmd_bufptr;
  unsigned long flags;
...
static int bfad_iocmd_debug_ctl(struct bfad_s *bfad, void *cmd,
    unsigned int v_cmd) {
  struct bfa_bsg_gen_s *iocmd = (struct bfa_bsg_gen_s *) cmd;
  unsigned long flags;
...
static int bfad_iocmd_porglog_ctl(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_fcpim_cfg_profile(struct bfad_s *bfad, void *cmd,
    unsigned int v_cmd) {
...
static int bfad_iocmd_fcport_get_stats(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_fcport_reset_stats(struct bfad_s *bfad, void *cmd) {
  struct bfa_bsg_gen_s *iocmd = (struct bfa_bsg_gen_s *) cmd;
  struct bfad_hal_comp fcomp;
  unsigned long flags;
  struct bfa_cb_pending_q_s cb_qe;
...
static int bfad_iocmd_boot_cfg(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_boot_query(struct bfad_s *bfad, void *cmd) {
  struct bfa_bsg_boot_s *iocmd = (struct bfa_bsg_boot_s *) cmd;
  struct bfad_hal_comp fcomp;
  unsigned long flags;
  init_completion(&fcomp.comp);
...
static int bfad_iocmd_preboot_query(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_ethboot_cfg(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_ethboot_query(struct bfad_s *bfad, void *cmd) {
  struct bfa_bsg_ethboot_s *iocmd = (struct bfa_bsg_ethboot_s *) cmd;
  struct bfad_hal_comp fcomp;
  unsigned long flags;
  init_completion(&fcomp.comp);
...
static int bfad_iocmd_cfg_trunk(struct bfad_s *bfad, void *cmd,
    unsigned int v_cmd) {
  struct bfa_bsg_gen_s *iocmd = (struct bfa_bsg_gen_s *) cmd;
  struct bfa_fcport_s *fcport = BFA_FCPORT_MOD(&bfad->bfa);
...
static int bfad_iocmd_trunk_get_attr(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_qos(struct bfad_s *bfad, void *cmd, unsigned int v_cmd) {
  struct bfa_bsg_gen_s *iocmd = (struct bfa_bsg_gen_s *) cmd;
  struct bfa_fcport_s *fcport = BFA_FCPORT_MOD(&bfad->bfa);
  unsigned long flags;
  spin_lock_irqsave(&bfad->bfad_lock, flags);
...
static int bfad_iocmd_qos_get_attr(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_qos_get_vc_attr(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_qos_get_stats(struct bfad_s *bfad, void *cmd) {
  struct bfa_bsg_fcport_stats_s *iocmd
    = (struct bfa_bsg_fcport_stats_s *) cmd;
  struct bfad_hal_comp fcomp;
  unsigned long flags;
...
static int bfad_iocmd_qos_reset_stats(struct bfad_s *bfad, void *cmd) {
  struct bfa_bsg_gen_s *iocmd = (struct bfa_bsg_gen_s *) cmd;
  struct bfad_hal_comp fcomp;
  unsigned long flags;
  struct bfa_cb_pending_q_s cb_qe;
...
static int bfad_iocmd_vf_get_stats(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_vf_clr_stats(struct bfad_s *bfad, void *cmd) {
...
static void bfad_iocmd_lunmask_reset_lunscan_mode(struct bfad_s *bfad,
    int lunmask_cfg) {
...
static int bfad_iocmd_lunmask(struct bfad_s *bfad, void *pcmd,
    unsigned int v_cmd) {
  struct bfa_bsg_gen_s *iocmd = (struct bfa_bsg_gen_s *) pcmd;
  unsigned long flags;
  spin_lock_irqsave(&bfad->bfad_lock, flags);
...
static int bfad_iocmd_fcpim_lunmask_query(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_fcpim_cfg_lunmask(struct bfad_s *bfad, void *cmd,
    unsigned int v_cmd) {
...
static int bfad_iocmd_fcpim_throttle_query(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_fcpim_throttle_set(struct bfad_s *bfad, void *cmd) {
  struct bfa_bsg_fcpim_throttle_s *iocmd
    = (struct bfa_bsg_fcpim_throttle_s *) cmd;
  unsigned long flags;
  spin_lock_irqsave(&bfad->bfad_lock, flags);
...
static int bfad_iocmd_tfru_read(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_tfru_write(struct bfad_s *bfad, void *cmd) {
  struct bfa_bsg_tfru_s *iocmd
    = (struct bfa_bsg_tfru_s *) cmd;
  struct bfad_hal_comp fcomp;
  unsigned long flags = 0;
...
static int bfad_iocmd_fruvpd_read(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_fruvpd_update(struct bfad_s *bfad, void *cmd) {
  struct bfa_bsg_fruvpd_s *iocmd
    = (struct bfa_bsg_fruvpd_s *) cmd;
  struct bfad_hal_comp fcomp;
  unsigned long flags = 0;
...
static int bfad_iocmd_fruvpd_get_max_size(struct bfad_s *bfad, void *cmd) {
...
static int bfad_iocmd_handler(struct bfad_s *bfad, unsigned int cmd,
    void *iocmd,
    unsigned int payload_len) {
  int rc = -EINVAL;
  switch (cmd) {
...
static int bfad_im_bsg_vendor_request(struct bsg_job *job) {
...
static u64 bfad_fcxp_get_req_sgaddr_cb(void *bfad_fcxp, int sgeid) {
...
static u32 bfad_fcxp_get_req_sglen_cb(void *bfad_fcxp, int sgeid) {
  struct bfad_fcxp *drv_fcxp = bfad_fcxp;
  struct bfa_sge_s *sge;
  sge = drv_fcxp->req_sge + sgeid;
  return sge->sg_len;
...
static u64 bfad_fcxp_get_rsp_sgaddr_cb(void *bfad_fcxp, int sgeid) {
  struct bfad_fcxp *drv_fcxp = bfad_fcxp;
  struct bfa_sge_s *sge;
  u64 addr;
...
static u32 bfad_fcxp_get_rsp_sglen_cb(void *bfad_fcxp, int sgeid) {
  struct bfad_fcxp *drv_fcxp = bfad_fcxp;
  struct bfa_sge_s *sge;
  sge = drv_fcxp->rsp_sge + sgeid;
  return sge->sg_len;
...
static void bfad_send_fcpt_cb(void *bfad_fcxp, struct bfa_fcxp_s *fcxp,
    void *cbarg,
...
static struct bfad_buf_info *bfad_fcxp_map_sg(struct bfad_s *bfad,
    void *payload_kbuf,
...
static void bfad_fcxp_free_mem(struct bfad_s *bfad,
...
static int bfad_fcxp_bsg_send(struct bsg_job *job, struct bfad_fcxp *drv_fcxp,
...
static int bfad_im_bsg_els_ct_request(struct bsg_job *job) {
