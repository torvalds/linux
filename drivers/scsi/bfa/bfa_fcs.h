...
typedef void (*bfa_fcs_lport_ns_sm_t)(struct bfa_fcs_lport_ns_s *fsm,
    enum vport_ns_event);
...
typedef void (*bfa_fcs_lport_scn_sm_t)(struct bfa_fcs_lport_scn_s *fsm,
    enum port_scn_event);
...
typedef void (*bfa_fcs_lport_fdmi_sm_t)(struct bfa_fcs_lport_fdmi_s *fsm,
    enum port_fdmi_event);
...
typedef void (*bfa_fcs_lport_ms_sm_t)(struct bfa_fcs_lport_ms_s *fsm,
    enum port_ms_event);
...
typedef void (*bfa_fcs_lport_sm_t)(struct bfa_fcs_lport_s *fsm,
    enum bfa_fcs_lport_event);
...
typedef void (*bfa_fcs_fabric_sm_t)(struct bfa_fcs_fabric_s *fsm,
    enum bfa_fcs_fabric_event);
...
static inline struct bfad_port_s *bfa_fcs_lport_get_drvport(
...
typedef void (*bfa_fcs_vport_sm_t)(struct bfa_fcs_vport_s *fsm,
    enum bfa_fcs_vport_event);
...
static inline struct bfa_rport_s *bfa_fcs_rport_get_halrport(
    struct bfa_fcs_rport_s *rport) {
...
struct bfa_fcs_itnim_s;
typedef void (*bfa_fcs_itnim_sm_t)(struct bfa_fcs_itnim_s *,
    enum bfa_fcs_itnim_event);
...
static inline struct bfad_port_s *bfa_fcs_itnim_get_drvport(
    struct bfa_fcs_itnim_s *itnim) {
  return itnim->rport->port->bfad_port;
}

static inline struct bfa_fcs_lport_s *bfa_fcs_itnim_get_port(
    struct bfa_fcs_itnim_s *itnim) {
  return itnim->rport->port;
}

static inline wwn_t bfa_fcs_itnim_get_nwwn(struct bfa_fcs_itnim_s *itnim) {
  return itnim->rport->nwwn;
}

static inline wwn_t bfa_fcs_itnim_get_pwwn(struct bfa_fcs_itnim_s *itnim) {
  return itnim->rport->pwwn;
}

static inline u32 bfa_fcs_itnim_get_fcid(struct bfa_fcs_itnim_s *itnim) {
  return itnim->rport->pid;
}

static inline u32 bfa_fcs_itnim_get_maxfrsize(struct bfa_fcs_itnim_s *itnim) {
  return itnim->rport->maxfrsize;
}

static inline enum fc_cos bfa_fcs_itnim_get_cos(struct bfa_fcs_itnim_s *itnim) {
  return itnim->rport->fc_cos;
}

static inline struct bfad_itnim_s *bfa_fcs_itnim_get_drvitn(
    struct bfa_fcs_itnim_s *itnim) {
  return itnim->itnim_drv;
}

static inline struct bfa_itnim_s *bfa_fcs_itnim_get_halitn(
    struct bfa_fcs_itnim_s *itnim) {
