...
static void bfa_ioc_ct_yestify_fail(struct bfa_ioc_s *ioc);
 ...
 */
static void
bfa_ioc_ct_yestify_fail(struct bfa_ioc_s *ioc)
{
...
bfa_ioc_set_ctx_hwif(struct bfa_ioc_s *ioc, struct bfa_ioc_hwif_s *hwif)
{
	...
	hwif->ioc_yestify_fail = bfa_ioc_ct_yestify_fail;
...
/*
 * Workaround for MSI-X resource allocation for catapult-2 with yes asic block
 */
