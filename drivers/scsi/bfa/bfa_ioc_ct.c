...
static bfa_boolean_t bfa_ioc_ct2_lpu_read_stat(struct bfa_ioc_s *ioc) {
  u32 r32;
 ...
 */
static void bfa_ioc_set_ctx_hwif(struct bfa_ioc_s *ioc,
    struct bfa_ioc_hwif_s *hwif) {
...
static void bfa_ioc_ct2_enable_flash(void __iomem *rb) {
  u32 r32;
...
static bfa_boolean_t bfa_ioc_ct2_nfc_halted(void __iomem *rb) {
  u32 r32;
...
static void bfa_ioc_ct2_nfc_halt(void __iomem *rb) {
  int i;
...
static void bfa_ioc_ct2_nfc_clk_reset(void __iomem *rb) {
  u32 r32, i;
  r32 = readl((rb + PSS_CTL_REG));
...
static void bfa_ioc_ct2_wait_till_nfc_running(void __iomem *rb) {
  u32 r32;
  int i;
  if (bfa_ioc_ct2_nfc_halted(rb)) {
...
static void bfa_ioc_ct_set_cur_ioc_fwstate(struct bfa_ioc_s *ioc,
...
static void bfa_ioc_ct_set_alt_ioc_fwstate(struct bfa_ioc_s *ioc,
    enum bfi_ioc_state fwstate) {
