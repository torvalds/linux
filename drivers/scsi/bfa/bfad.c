...
static void bfad_sm_initializing(struct bfad_s *bfad,
 ...
 */
static void bfad_init_msix_entry(struct bfad_s *bfad,
 ...
 */
static pci_ers_result_t bfad_pci_error_detected(struct pci_dev *pdev,
 ...
 * Driver module init.
 */
static int __init bfad_init(void) {
  int error = 0;
 ...
 * Driver module exit.
 */
static void __exit bfad_exit(void) {
