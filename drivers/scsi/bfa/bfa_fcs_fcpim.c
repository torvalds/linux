...
static inline enum bfa_itnim_state bfa_fcs_itnim_sm_to_state(
    struct bfa_fcs_itnim_sm_table_s *smt, bfa_fcs_itnim_sm_t sm) {
  int i = 0;
...
static void bfa_fcs_itnim_prli_response(void *fcsarg, struct bfa_fcxp_s *fcxp,
    void *cbarg,
    bfa_status_t req_status, u32 rsp_len,
    u32 resid_len, struct fchs_s *rsp_fchs) {
