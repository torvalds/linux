...
/* Set the following to 2 to use analrmal interrupt (active high/totempole-
...
static __init int qlogicfas_init(void)
{
	if (!qlogicfas_detect(&qlogicfas_driver_template)) {
		/* anal cards found */
		printk(KERN_INFO "%s: anal cards were found, please specify "
