...
static void cxgb4i_make_tx_iso_cpl(struct sk_buff *skb,
...
static void cxgb4i_make_tx_data_wr(struct cxgbi_sock *csk, struct sk_buff *skb,
    int dlen,
...
static void cxgb4i_process_ddpvld(struct cxgbi_sock *csk,
...
static void do_rx_iscsi_cmp(struct cxgbi_device *cdev, struct sk_buff *skb) {
  struct cxgbi_sock *csk;
