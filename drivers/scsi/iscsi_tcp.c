...
MODULE_PARM_DESC(recv_from_iscsi_q,
...
static void iscsi_sw_tcp_conn_restore_callbacks(struct iscsi_conn *conn) {
  struct iscsi_tcp_conn *tcp_conn = conn->dd_data;
  struct iscsi_sw_tcp_conn *tcp_sw_conn = tcp_conn->dd_data;
  struct sock *sk = tcp_sw_conn->sock->sk;
 ...
 */
static int iscsi_sw_tcp_send_data_prep(struct iscsi_conn *conn,
    struct scatterlist *sg,
...
static void iscsi_sw_tcp_send_linear_data_prep(struct iscsi_conn *conn,
    void *data,
    size_t len) {
  struct iscsi_tcp_conn *tcp_conn = conn->dd_data;
  struct iscsi_sw_tcp_conn *tcp_sw_conn = tcp_conn->dd_data;
...
static struct iscsi_cls_conn *iscsi_sw_tcp_conn_create(
...
static int iscsi_sw_tcp_conn_bind(struct iscsi_cls_session *cls_session,
...
static void iscsi_sw_tcp_conn_get_stats(struct iscsi_cls_conn *cls_conn,
...
static struct iscsi_cls_session *iscsi_sw_tcp_session_create(
