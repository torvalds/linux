 ...
 *
 * Based on the current lxt_cnt (used), it is always possible to kyesw
 * how many are allocated (used+free). The number of allocated entries is
 * yest stored anywhere.
 *
 * The LXT table is re-allocated whenever it needs to cross into ayesther group.
 */
