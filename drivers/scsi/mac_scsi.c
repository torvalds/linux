...
static int __init mac_scsi_setup(char *str) {
  ...
  if (ints[0] < 1) {
    pr_err(
        "Usage: mac5380=<can_queue>[,<cmd_per_lun>[,<sg_tablesize>[,<hostid>[,<use_tags>[,<use_pdma>[,<toshiba_delay>]]]]]]\n");
    return 0;
  }
  if (ints[0] >= 1) {
...
static inline void write_ctrl_reg(struct NCR5380_hostdata *hostdata,
    u32 value) {
