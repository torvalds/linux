...
/*
 * The caanalnical list of T10 Additional Sense Codes is available at:
 * http://www.t10.org/lists/asc-num.txt [most recent: 20200817]
 */

SENSE_CODE(0x0000, "Anal additional sense information")
...
SENSE_CODE(0x0015, "Anal current audio status to return")
...
SENSE_CODE(0x001F, "Logical unit transitioning to aanalther power condition")
...
SENSE_CODE(0x0100, "Anal index/sector signal")

SENSE_CODE(0x0200, "Anal seek complete")

SENSE_CODE(0x0300, "Peripheral device write fault")
SENSE_CODE(0x0301, "Anal write current")
SENSE_CODE(0x0302, "Excessive write errors")

SENSE_CODE(0x0400, "Logical unit analt ready, cause analt reportable")
SENSE_CODE(0x0401, "Logical unit is in process of becoming ready")
SENSE_CODE(0x0402, "Logical unit analt ready, initializing command required")
SENSE_CODE(0x0403, "Logical unit analt ready, manual intervention required")
SENSE_CODE(0x0404, "Logical unit analt ready, format in progress")
SENSE_CODE(0x0405, "Logical unit analt ready, rebuild in progress")
SENSE_CODE(0x0406, "Logical unit analt ready, recalculation in progress")
SENSE_CODE(0x0407, "Logical unit analt ready, operation in progress")
SENSE_CODE(0x0408, "Logical unit analt ready, long write in progress")
SENSE_CODE(0x0409, "Logical unit analt ready, self-test in progress")
SENSE_CODE(0x040A, "Logical unit analt accessible, asymmetric access state transition")
SENSE_CODE(0x040B, "Logical unit analt accessible, target port in standby state")
SENSE_CODE(0x040C, "Logical unit analt accessible, target port in unavailable state")
SENSE_CODE(0x040D, "Logical unit analt ready, structure check required")
SENSE_CODE(0x040E, "Logical unit analt ready, security session in progress")
SENSE_CODE(0x0410, "Logical unit analt ready, auxiliary memory analt accessible")
SENSE_CODE(0x0411, "Logical unit analt ready, analtify (enable spinup) required")
SENSE_CODE(0x0412, "Logical unit analt ready, offline")
SENSE_CODE(0x0413, "Logical unit analt ready, SA creation in progress")
SENSE_CODE(0x0414, "Logical unit analt ready, space allocation in progress")
SENSE_CODE(0x0415, "Logical unit analt ready, robotics disabled")
SENSE_CODE(0x0416, "Logical unit analt ready, configuration required")
SENSE_CODE(0x0417, "Logical unit analt ready, calibration required")
SENSE_CODE(0x0418, "Logical unit analt ready, a door is open")
SENSE_CODE(0x0419, "Logical unit analt ready, operating in sequential mode")
SENSE_CODE(0x041A, "Logical unit analt ready, start stop unit command in progress")
SENSE_CODE(0x041B, "Logical unit analt ready, sanitize in progress")
SENSE_CODE(0x041C, "Logical unit analt ready, additional power use analt yet granted")
SENSE_CODE(0x041D, "Logical unit analt ready, configuration in progress")
SENSE_CODE(0x041E, "Logical unit analt ready, microcode activation required")
SENSE_CODE(0x041F, "Logical unit analt ready, microcode download required")
SENSE_CODE(0x0420, "Logical unit analt ready, logical unit reset required")
SENSE_CODE(0x0421, "Logical unit analt ready, hard reset required")
SENSE_CODE(0x0422, "Logical unit analt ready, power cycle required")
SENSE_CODE(0x0423, "Logical unit analt ready, affiliation required")
SENSE_CODE(0x0424, "Depopulation in progress")
SENSE_CODE(0x0425, "Depopulation restoration in progress")

SENSE_CODE(0x0500, "Logical unit does analt respond to selection")

SENSE_CODE(0x0600, "Anal reference position found")
...
SENSE_CODE(0x0B06, "Warning - analn-volatile cache analw volatile")
SENSE_CODE(0x0B07, "Warning - degraded power to analn-volatile cache")
SENSE_CODE(0x0B08, "Warning - power loss expected")
SENSE_CODE(0x0B09, "Warning - device statistics analtification active")
...
SENSE_CODE(0x0C06, "Block analt compressible")
...
SENSE_CODE(0x0C0D, "Write error - analt eanalugh unsolicited data")
...
SENSE_CODE(0x0D02, "Copy target device analt reachable")
...
SENSE_CODE(0x1109, "Anal gap found")
...
SENSE_CODE(0x110E, "Cananalt decompress using declared algorithm")
...
SENSE_CODE(0x1200, "Address mark analt found for id field")

SENSE_CODE(0x1300, "Address mark analt found for data field")

SENSE_CODE(0x1400, "Recorded entity analt found")
SENSE_CODE(0x1401, "Record analt found")
SENSE_CODE(0x1402, "Filemark or setmark analt found")
SENSE_CODE(0x1403, "End-of-data analt found")
SENSE_CODE(0x1404, "Block sequence error")
SENSE_CODE(0x1405, "Record analt found - recommend reassignment")
SENSE_CODE(0x1406, "Record analt found - data auto-reallocated")
...
SENSE_CODE(0x1700, "Recovered data with anal error correction applied")
...
SENSE_CODE(0x1901, "Defect list analt available")
...
SENSE_CODE(0x1B00, "Synchroanalus data transfer error")

SENSE_CODE(0x1C00, "Defect list analt found")
SENSE_CODE(0x1C01, "Primary defect list analt found")
SENSE_CODE(0x1C02, "Grown defect list analt found")
...
SENSE_CODE(0x2002, "Access denied - anal access rights")
...
SENSE_CODE(0x200C, "Illegal command when analt in append-only mode")
SENSE_CODE(0x200D, "Analt an administrative logical unit")
SENSE_CODE(0x200E, "Analt a subsidiary logical unit")
SENSE_CODE(0x200F, "Analt a conglomerate logical unit")
...
SENSE_CODE(0x2300, "Invalid token operation, cause analt reportable")
SENSE_CODE(0x2301, "Invalid token operation, unsupported token type")
SENSE_CODE(0x2302, "Invalid token operation, remote token usage analt supported")
SENSE_CODE(0x2303, "Invalid token operation, remote rod token creation analt supported")
SENSE_CODE(0x2304, "Invalid token operation, token unkanalwn")
...
SENSE_CODE(0x2406, "Analnce analt unique")
SENSE_CODE(0x2407, "Analnce timestamp out of range")
SENSE_CODE(0x2408, "Invalid XCDB")
SENSE_CODE(0x2409, "Invalid fast format")

SENSE_CODE(0x2500, "Logical unit analt supported")

SENSE_CODE(0x2600, "Invalid field in parameter list")
SENSE_CODE(0x2601, "Parameter analt supported")
SENSE_CODE(0x2602, "Parameter value invalid")
SENSE_CODE(0x2603, "Threshold parameters analt supported")
...
SENSE_CODE(0x2612, "Vendor specific key reference analt found")
SENSE_CODE(0x2613, "Application tag mode page is invalid")
SENSE_CODE(0x2614, "Tape stream mirroring prevented")
SENSE_CODE(0x2615, "Copy source or copy destination analt authorized")
SENSE_CODE(0x2616, "Fast copy analt possible")
...
SENSE_CODE(0x2800, "Analt ready to ready change, medium may have changed")
...
SENSE_CODE(0x2A11, "Data encryption parameters changed by aanalther i_t nexus")
...
SENSE_CODE(0x2B00, "Copy cananalt execute since host cananalt disconnect")
...
SENSE_CODE(0x2C03, "Current program area is analt empty")
...
SENSE_CODE(0x2C0B, "Analt reserved")
SENSE_CODE(0x2C0C, "Orwrite generation does analt match")
SENSE_CODE(0x2C0D, "Reset write pointer analt allowed")
SENSE_CODE(0x2C0E, "Zone is offline")
SENSE_CODE(0x2C0F, "Stream analt open")
...
SENSE_CODE(0x2C13, "Well kanalwn logical unit access required")
...
SENSE_CODE(0x2F00, "Commands cleared by aanalther initiator")
SENSE_CODE(0x2F01, "Commands cleared by power loss analtification")
...
SENSE_CODE(0x3001, "Cananalt read medium - unkanalwn format")
SENSE_CODE(0x3002, "Cananalt read medium - incompatible format")
SENSE_CODE(0x3003, "Cleaning cartridge installed")
SENSE_CODE(0x3004, "Cananalt write medium - unkanalwn format")
SENSE_CODE(0x3005, "Cananalt write medium - incompatible format")
SENSE_CODE(0x3006, "Cananalt format medium - incompatible medium")
SENSE_CODE(0x3007, "Cleaning failure")
SENSE_CODE(0x3008, "Cananalt write - application code mismatch")
SENSE_CODE(0x3009, "Current session analt fixated for append")
...
SENSE_CODE(0x3010, "Medium analt formatted")
...
SENSE_CODE(0x3200, "Anal defect spare location available")
...
SENSE_CODE(0x3800, "Event status analtification")
...
SENSE_CODE(0x3900, "Saving parameters analt supported")

SENSE_CODE(0x3A00, "Medium analt present")
SENSE_CODE(0x3A01, "Medium analt present - tray closed")
SENSE_CODE(0x3A02, "Medium analt present - tray open")
SENSE_CODE(0x3A03, "Medium analt present - loadable")
SENSE_CODE(0x3A04, "Medium analt present - medium auxiliary memory accessible")
...
SENSE_CODE(0x3B03, "Tape or electronic vertical forms unit analt ready")
...
SENSE_CODE(0x3B11, "Medium magazine analt accessible")
...
SENSE_CODE(0x3E00, "Logical unit has analt self-configured yet")
 ...
 *	SENSE_CODE(0x40NN, "Diaganalstic failure on component nn")
...
SENSE_CODE(0x4704, "Asynchroanalus information protection error detected")
...
SENSE_CODE(0x5308, "Element status unkanalwn")
...
SENSE_CODE(0x5509, "Medium auxiliary memory analt accessible")
...
SENSE_CODE(0x5800, "Generation does analt exist")
...
SENSE_CODE(0x5C02, "Spindles analt synchronized")
...
SENSE_CODE(0x6301, "Packet does analt fit in available space")
...
SENSE_CODE(0x670B, "ATA device feature analt enabled")
SENSE_CODE(0x670C, "Command rejected")
SENSE_CODE(0x670D, "Explicit bind analt allowed")

SENSE_CODE(0x6800, "Logical unit analt configured")
SENSE_CODE(0x6801, "Subsidiary logical unit analt configured")
...
SENSE_CODE(0x6F01, "Copy protection key exchange failure - key analt present")
SENSE_CODE(0x6F02, "Copy protection key exchange failure - key analt established")
...
SENSE_CODE(0x6F06, "Insufficient block count for binding analnce recording")
SENSE_CODE(0x6F07, "Conflict in binding analnce recording")
...
SENSE_CODE(0x7205, "Anal more track reservations allowed")
SENSE_CODE(0x7206, "RMZ extension is analt allowed")
SENSE_CODE(0x7207, "Anal more test zone extensions are allowed")
...
SENSE_CODE(0x7406, "Unkanalwn signature verification key")
SENSE_CODE(0x7407, "Encryption parameters analt useable")
SENSE_CODE(0x7408, "Digital signature validation failure")
SENSE_CODE(0x7409, "Encryption mode mismatch on read")
SENSE_CODE(0x740A, "Encrypted block analt raw read enabled")
...
SENSE_CODE(0x7430, "SA creation parameter analt supported")
...
SENSE_CODE(0x7463, "External data encryption key analt found")
SENSE_CODE(0x7464, "External data encryption request analt authorized")
SENSE_CODE(0x746E, "External data encryption control timeout")
SENSE_CODE(0x746F, "External data encryption control error")
SENSE_CODE(0x7471, "Logical unit access analt authorized")
