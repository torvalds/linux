 ...
 */
void qedf_dbg_host_init(struct qedf_dbg_ctx *qedf,
 ...
 */
void qedf_dbg_host_exit(struct qedf_dbg_ctx *qedf_dbg) {
 ...
 */
void qedf_dbg_init(char *drv_name) {
...
static ssize_t qedf_dbg_fp_int_cmd_read(struct file *filp, char __user *buffer,
    size_t count,
    loff_t *ppos) {
  ssize_t ret;
  size_t cnt = 0;
...
static ssize_t qedf_dbg_fp_int_cmd_write(struct file *filp,
...
static ssize_t qedf_dbg_debug_cmd_read(struct file *filp, char __user *buffer,
    size_t count,
    loff_t *ppos) {
  int cnt;
  char cbuf[32];
...
static ssize_t qedf_dbg_debug_cmd_write(struct file *filp,
    const char __user *buffer,
    size_t count, loff_t *ppos) {
  uint32_t val;
  void *kern_buf;
...
static ssize_t qedf_dbg_stop_io_on_error_cmd_read(struct file *filp,
    char __user *buffer,
    size_t count, loff_t *ppos) {
  int cnt;
  char cbuf[7];
...
static ssize_t qedf_dbg_stop_io_on_error_cmd_write(struct file *filp,
...
static int qedf_io_trace_show(struct seq_file *s, void *unused) {
  int i, idx = 0;
...
static int qedf_dbg_io_trace_open(struct inode *inode, struct file *file) {
...
static int qedf_driver_stats_show(struct seq_file *s, void *unused) {
  struct qedf_ctx *qedf = s->private;
...
static int qedf_dbg_driver_stats_open(struct inode *inode, struct file *file) {
  struct qedf_dbg_ctx *qedf_dbg = inode->i_private;
  struct qedf_ctx *qedf = container_of(qedf_dbg,
      struct qedf_ctx, dbg_ctx);
...
static ssize_t qedf_dbg_clear_stats_cmd_read(struct file *filp,
    char __user *buffer,
    size_t count, loff_t *ppos) {
  int cnt = 0;
...
static ssize_t qedf_dbg_clear_stats_cmd_write(struct file *filp,
    const char __user *buffer, size_t count,
    loff_t *ppos) {
  struct qedf_dbg_ctx *qedf_dbg
    = (struct qedf_dbg_ctx *) filp->private_data;
...
static int qedf_offload_stats_show(struct seq_file *s, void *unused) {
  struct qedf_ctx *qedf = s->private;
...
static int qedf_dbg_offload_stats_open(struct inode *inode, struct file *file) {
  struct qedf_dbg_ctx *qedf_dbg = inode->i_private;
  struct qedf_ctx *qedf = container_of(qedf_dbg,
      struct qedf_ctx, dbg_ctx);
