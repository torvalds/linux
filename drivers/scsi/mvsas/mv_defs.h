...
enum hw_register_bits {
	...
	TXQ_PRIO_HI		= (1U << 27),	/* priority: 0=yesrmal, 1=high */
	TXQ_PRI_NORMAL		= 0,
	TXQ_PRI_HIGH		= 1,
	...
	PHY_BCAST_CHG		= (1U << 2),	/* broadcast(change) yestif */
	...
	PHYEV_AN		= (1U << 18),	/* SATA async yestification */
	...
	PHYEV_UNK_TAG		= (1U << 9),	/* unkyeswn tag */
...
enum error_info_rec {
	...
	NO_DEST 	= (1U << 9),	/* I_T nexus lost, yes destination */
	STP_RES_BSY	= (1U << 8),	/* STP resources busy */
	BREAK		= (1U << 7),	/* break received */
	BAD_DEST	= (1U << 6),	/* bad destination */
	BAD_PROTO	= (1U << 5),	/* protocol yest supported */
	BAD_RATE	= (1U << 4),	/* cxn rate yest supported */
