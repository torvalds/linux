...
#define EXP_ROM_CONTROL   0x08  /* BASE+08, IDX+08, B, R/W */ /* external ROM
                                 * control */
...
#define CHIP_MODE   0x0b  /* BASE+08, IDX+0b, B, R   */ /* NinjaSCSI-32Bi only
                           * */
#define OEM0 BIT(1)  /* OEM select */ /* 00=I-O DATA, 01=KME, 10=Workbit, 11=Ext
                      * ROM */
...
#define BUSMON_MESSAGE_IN  (BUSMON_BSY | BUSMON_MSG | BUSMON_IO | BUSMON_CD \
  | BUSMON_REQ)
...
typedef struct _nsp32_lunt {
  ...
  unsigned long save_datp;  /* Save Data Pointer - saved position from initial
                             * address */
