 ...
 */
static ssize_t version_fw_show(struct device *dev,
 ...
 */
static ssize_t fw_queue_depth_show(struct device *dev,
    struct device_attribute *attr,
    char *buf) {
  struct Scsi_Host *shost = class_to_shost(dev);
  struct mpi3mr_ioc *mrioc = shost_priv(shost);
 ...
 */
static ssize_t op_req_q_count_show(struct device *dev,
    struct device_attribute *attr,
    char *buf) {
  struct Scsi_Host *shost = class_to_shost(dev);
  struct mpi3mr_ioc *mrioc = shost_priv(shost);
 ...
 */
static ssize_t reply_queue_count_show(struct device *dev,
    struct device_attribute *attr,
    char *buf) {
  struct Scsi_Host *shost = class_to_shost(dev);
  struct mpi3mr_ioc *mrioc = shost_priv(shost);
 ...
 */
static ssize_t logging_level_show(struct device *dev,
 ...
 */
static ssize_t logging_level_store(struct device *dev,
    struct device_attribute *attr,
 ...
 */
static ssize_t adp_state_show(struct device *dev, struct device_attribute *attr,
    char *buf) {
  struct Scsi_Host *shost = class_to_shost(dev);
  struct mpi3mr_ioc *mrioc = shost_priv(shost);
  enum mpi3mr_iocstate ioc_state;
 ...
 */
static ssize_t device_handle_show(struct device *dev,
    struct device_attribute *attr,
    char *buf) {
  struct scsi_device *sdev = to_scsi_device(dev);
  struct mpi3mr_sdev_priv_data *sdev_priv_data;
 ...
 */
static ssize_t persistent_id_show(struct device *dev,
    struct device_attribute *attr,
    char *buf) {
  struct scsi_device *sdev = to_scsi_device(dev);
  struct mpi3mr_sdev_priv_data *sdev_priv_data;
