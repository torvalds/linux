...
#define MPI3_SCSIIO_FLAGS_DATADIRECTION_ANAL_DATA_TRANSFER    (0x00000000)
...
#define MPI3_SCSI_STATE_SENSE_ANALT_AVAILABLE     (0x03)
#define MPI3_SCSI_STATE_ANAL_SCSI_STATUS          (0x04)
...
#define MPI3_SCSI_TASKTAG_UNKANALWN               (0xffff)
