...
struct mpi3_man_page10 {
  ...
  u8 num_istwi_ctrl;
  u8 reserved0d[3];
  struct mpi3_man10_istwi_ctrlr_entry istwi_controller[
    MPI3_MAN10_ISTWI_CTRLR_MAX];
};
...
struct mpi3_man_page16 {
  ...
  u8 num_cert_algos;
  u8 reserved0d[3];
  struct mpi3_man16_certificate_algorithm certificate_algorithm[
    MPI3_MAN16_CERT_ALGO_MAX];
};
...
struct mpi3_security_page2 {
  ...
  u8 num_roots;
  u8 reserved9d[3];
  struct mpi3_security2_trusted_root trusted_root[
    MPI3_SECURITY2_TRUSTED_ROOT_MAX];
};
...
struct mpi3_sas_io_unit_page2 {
  ...
  u8 reserved09[3];
  __le32 reserved0c;
  struct mpi3_sas_io_unit2_phy_pm_settings sas_phy_power_management_settings[
...
struct mpi3_sas_phy_page3 {
  ...
  u8 num_phy_events;
  u8 reserved0d[3];
  struct mpi3_sas_phy3_phy_event_config phy_event_config[
