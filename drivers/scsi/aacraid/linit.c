...
static const struct pci_device_id aac_pci_tbl[] = {
  ...
  { 0x1028, 0x0004, 0x1028, 0x00d0, 0, 0, 3 }, /* PERC 3/Di (Iguana
                                                * FlipChip/PERC3DiF */
  ...
  { 0x9005, 0x0285, 0x9005, 0x028a, 0, 0, 18 }, /* ASR-2020ZCR SCSI PCI-X ZCR
                                                 * (Skyhawk) */
  { 0x9005, 0x0285, 0x9005, 0x028b, 0, 0, 19 }, /* ASR-2025ZCR SCSI SO-DIMM
                                                * PCI-X ZCR (Terminator) */
  { 0x9005, 0x0286, 0x9005, 0x028c, 0, 0, 20 }, /* ASR-2230S + ASR-2230SLP PCI-X
                                                 * (Lancer) */
  ...
  { 0x9005, 0x0285, 0x9005, 0x028e, 0, 0, 35 }, /* ASR-2020SA SATA PCI-X ZCR
                                                 * (Skyhawk) */
  { 0x9005, 0x0285, 0x9005, 0x028f, 0, 0, 36 }, /* ASR-2025SA SATA SO-DIMM PCI-X
                                                 * ZCR (Terminator) */
  { 0x9005, 0x0285, 0x9005, 0x0290, 0, 0, 37 }, /* AAR-2410SA PCI SATA 4ch
                                                 * (Jaguar II) */
  { 0x9005, 0x0285, 0x1028, 0x0291, 0, 0, 38 }, /* CERC SATA RAID 2 PCI SATA 6ch
                                                 * (DellCorsair) */
  { 0x9005, 0x0285, 0x9005, 0x0292, 0, 0, 39 }, /* AAR-2810SA PCI SATA 8ch
                                                 * (Corsair-8) */
  { 0x9005, 0x0285, 0x9005, 0x0293, 0, 0, 40 }, /* AAR-21610SA PCI SATA 16ch
                                                 * (Corsair-16) */
  { 0x9005, 0x0285, 0x9005, 0x0294, 0, 0, 41 }, /* ESD SO-DIMM PCI-X SATA ZCR
                                                 * (Prowler) */
  ...
  { 0x9005, 0x0286, PCI_ANY_ID, PCI_ANY_ID, 0, 0, 60 }, /* Adaptec Rocket Catch
                                                         * All */
  { 0x9005, 0x0288, PCI_ANY_ID, PCI_ANY_ID, 0, 0, 61 }, /* Adaptec NEMER/ARK
                                                         * Catch All */
  { 0x9005, 0x028b, PCI_ANY_ID, PCI_ANY_ID, 0, 0, 62 }, /* Adaptec PMC Series 6
                                                         * (Tupelo) */
  { 0x9005, 0x028c, PCI_ANY_ID, PCI_ANY_ID, 0, 0, 63 }, /* Adaptec PMC Series 7
                                                         * (Denali) */
...
static struct aac_driver_ident aac_drivers[] = {
  ...
  { aac_rx_init, "aacraid", "Legend  ", "Legend S220     ", 1,
    AAC_QUIRK_31BIT | AAC_QUIRK_34SG | AAC_QUIRK_SCSI_32 }, /* Legend S220
                                                             * (Legend Crusader)
                                                             * */
  { aac_rx_init, "aacraid", "Legend  ", "Legend S230     ", 2,
    AAC_QUIRK_31BIT | AAC_QUIRK_34SG | AAC_QUIRK_SCSI_32 }, /* Legend S230
                                                             * (Legend Vulcan)
                                                             * */

  { aac_rx_init, "aacraid", "ADAPTEC ", "Adaptec 3230S   ", 2 }, /* Adaptec
                                                                  * 3230S
                                                                  * (Harrier) */
  { aac_rx_init, "aacraid", "ADAPTEC ", "Adaptec 3240S   ", 2 }, /* Adaptec
                                                                  * 3240S
                                                                  * (Tornado) */
  { aac_rx_init, "aacraid", "ADAPTEC ", "ASR-2020ZCR     ", 2 }, /* ASR-2020ZCR
                                                                 * SCSI PCI-X
                                                                 * ZCR
                                                                 * (Skyhawk) */
  { aac_rx_init, "aacraid", "ADAPTEC ", "ASR-2025ZCR     ", 2 }, /* ASR-2025ZCR
                                                                  * SCSI SO-DIMM
                                                                  * PCI-X ZCR
                                                                  * (Terminator)
                                                                  * */
  { aac_rkt_init, "aacraid", "ADAPTEC ", "ASR-2230S PCI-X ", 2 }, /* ASR-2230S +
                                                                   * ASR-2230SLP
                                                                   * PCI-X
                                                                   * (Lancer) */
  { aac_rkt_init, "aacraid", "ADAPTEC ", "ASR-2130S PCI-X ", 1 }, /* ASR-2130S
                                                                   * (Lancer) */
  { aac_rkt_init, "aacraid", "ADAPTEC ", "AAR-2820SA      ", 1 }, /* AAR-2820SA
                                                                   * (Intruder)
                                                                   * */
  { aac_rkt_init, "aacraid", "ADAPTEC ", "AAR-2620SA      ", 1 }, /* AAR-2620SA
                                                                   * (Intruder)
                                                                   * */
  { aac_rkt_init, "aacraid", "ADAPTEC ", "AAR-2420SA      ", 1 }, /* AAR-2420SA
                                                                   * (Intruder)
                                                                   * */
  { aac_rkt_init, "aacraid", "ICP     ", "ICP9024RO       ", 2 }, /* ICP9024RO
                                                                   * (Lancer) */
  { aac_rkt_init, "aacraid", "ICP     ", "ICP9014RO       ", 1 }, /* ICP9014RO
                                                                   * (Lancer) */
  { aac_rkt_init, "aacraid", "ICP     ", "ICP9047MA       ", 1 }, /* ICP9047MA
                                                                   * (Lancer) */
  { aac_rkt_init, "aacraid", "ICP     ", "ICP9087MA       ", 1 }, /* ICP9087MA
                                                                   * (Lancer) */
  { aac_rkt_init, "aacraid", "ICP     ", "ICP5445AU       ", 1 }, /* ICP5445AU
                                                                   * (Hurricane44)
                                                                   * */
  { aac_rx_init, "aacraid", "ICP     ", "ICP9085LI       ", 1 }, /* ICP9085LI
                                                                  * (Marauder-X)
                                                                  * */
  { aac_rx_init, "aacraid", "ICP     ", "ICP5085BR       ", 1 }, /* ICP5085BR
                                                                  * (Marauder-E)
                                                                  * */
  { aac_rkt_init, "aacraid", "ICP     ", "ICP9067MA       ", 1 }, /* ICP9067MA
                                                                   * (Intruder-6)
                                                                   * */
  { NULL, "aacraid", "ADAPTEC ", "Themisto        ", 0, AAC_QUIRK_SLAVE }, /*
                                                                            ...
                                                                            * Platform
                                                                            * */
  { aac_rkt_init, "aacraid", "ADAPTEC ", "Callisto        ", 2,
    AAC_QUIRK_MASTER }, /* Jupiter Platform */
  { aac_rx_init, "aacraid", "ADAPTEC ", "ASR-2020SA       ", 1 }, /* ASR-2020SA
                                                                   * SATA PCI-X
                                                                   * ZCR
                                                                   * (Skyhawk)
                                                                   * */
  { aac_rx_init, "aacraid", "ADAPTEC ", "ASR-2025SA       ", 1 }, /* ASR-2025SA
                                                                   * SATA
                                                                   * SO-DIMM
                                                                   * PCI-X ZCR
                                                                   * (Terminator)
  ...
  { aac_rx_init, "aacraid", "ADAPTEC ", "AAR-21610SA SATA", 1, AAC_QUIRK_17SG }, /*
                                                                                  ...
                                                                                  *
                                                                                  **/
  { aac_rx_init, "aacraid", "ADAPTEC ", "ASR-2026ZCR     ", 1 }, /* ESD SO-DIMM
                                                                 * PCI-X SATA
                                                                 * ZCR
                                                                 * (Prowler) */
  { aac_rx_init, "aacraid", "ADAPTEC ", "AAR-2610SA      ", 1 }, /* SATA 6Ch
                                                                  * (Bearcat) */
  { aac_rx_init, "aacraid", "ADAPTEC ", "ASR-2240S       ", 1 }, /* ASR-2240S
                                                                  * (SabreExpress)
                                                                  * */
  { aac_rx_init, "aacraid", "ADAPTEC ", "ASR-4005        ", 1 }, /* ASR-4005 */
  { aac_rx_init, "ServeRAID", "IBM     ", "ServeRAID 8i    ", 1 }, /* IBM 8i
                                                                    * (AvonPark)
                                                                    * */
  { aac_rkt_init, "ServeRAID", "IBM     ", "ServeRAID 8k-l8 ", 1 }, /* IBM
                                                                     * 8k/8k-l8
                                                                     * (Aurora)
                                                                     * */
  { aac_rkt_init, "ServeRAID", "IBM     ", "ServeRAID 8k-l4 ", 1 }, /* IBM
                                                                     * 8k/8k-l4
                                                                     * (Aurora
                                                                     * Lite) */
  { aac_rx_init, "aacraid", "ADAPTEC ", "ASR-4000        ", 1 }, /* ASR-4000
                                                                  * (BlackBird &
                                                                  * AvonPark) */
  ...
  { aac_rx_init, "aacraid", "ADAPTEC ", "ASR-4805SAS     ", 1 }, /* ASR-4805SAS
                                                                  * (Marauder-E)
                                                                  * */
  { aac_rkt_init, "aacraid", "ADAPTEC ", "ASR-3800        ", 1 }, /* ASR-3800
                                                                   * (Hurricane44)
                                                                   * */
  ...
  { aac_rx_init, "aacraid", "Legend  ", "RAID            ", 2,
    AAC_QUIRK_31BIT | AAC_QUIRK_34SG | AAC_QUIRK_SCSI_32 }, /* Legend Catchall
                                                             * */
  { aac_rx_init, "aacraid", "ADAPTEC ", "RAID            ", 2 }, /* Adaptec
                                                                  * Catch All */
  { aac_rkt_init, "aacraid", "ADAPTEC ", "RAID            ", 2 }, /* Adaptec
                                                                   * Rocket
                                                                   * Catch All
                                                                   * */
  { aac_nark_init, "aacraid", "ADAPTEC ", "RAID           ", 2 }, /* Adaptec
                                                                   * NEMER/ARK
                                                                   * Catch All
                                                                   * */
...
static ssize_t aac_show_raid_level(struct device *dev,
