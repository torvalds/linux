 ...
 * offset.
 */
static inline void iscsi_tcp_segment_init_sg(struct iscsi_segment *segment,
 ...
 */
static inline void iscsi_tcp_segment_splice_digest(
    struct iscsi_segment *segment, void *digest) {
  segment->data = digest;
 ...
 */
static int iscsi_tcp_segment_recv(struct iscsi_tcp_conn *tcp_conn,
...
inline void iscsi_tcp_dgst_header(struct ahash_request *hash, const void *hdr,
...
static inline int iscsi_tcp_dgst_verify(struct iscsi_tcp_conn *tcp_conn,
    struct iscsi_segment *segment) {
 ...
 */
static inline void __iscsi_segment_init(struct iscsi_segment *segment,
    size_t size,
...
inline void iscsi_segment_init_linear(struct iscsi_segment *segment, void *data,
...
inline int iscsi_segment_seek_sg(struct iscsi_segment *segment,
 ...
 */
static int iscsi_tcp_data_recv_done(struct iscsi_tcp_conn *tcp_conn,
    struct iscsi_segment *segment) {
...
static void iscsi_tcp_data_recv_prep(struct iscsi_tcp_conn *tcp_conn) {
  struct iscsi_conn *conn = tcp_conn->iscsi_conn;
 ...
 */
static int iscsi_tcp_process_data_in(struct iscsi_tcp_conn *tcp_conn,
    struct iscsi_segment *segment) {
  struct iscsi_conn *conn = tcp_conn->iscsi_conn;
 ...
 */
static int iscsi_tcp_hdr_dissect(struct iscsi_conn *conn,
...
struct iscsi_cls_conn *iscsi_tcp_conn_setup(
    struct iscsi_cls_session *cls_session, int dd_data_size,
    uint32_t conn_idx) {
