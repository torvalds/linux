...
MODULE_PARM_DESC(qedi_flags_override,
    "Disable/Enable MFW error flags bits action.");
...
static int qedi_iscsi_event_cb(void *context, u8 fw_event_code,
    void *fw_handle) {
...
static void qedi_get_generic_tlv_data(void *dev,
...
static ssize_t qedi_show_boot_tgt_info(struct qedi_ctx *qedi, int type,
