...
static char *blogic_msglevelmap[] = {
...
static int blogic_adapter_addr_count[3] = {
  0, BLOGIC_MULTIMASTER_ADDR_COUNT, BLOGIC_FLASHPOINT_ADDR_COUNT
};
...
static char *blogic_adapter_busnames[] = {
