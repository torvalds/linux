 ...
 */
static void sym_fw1_patch(struct Scsi_Host *shost) {
 ...
 */
static void sym_fw2_patch(struct Scsi_Host *shost) {
 ...
 */
static void sym_fw_fill_data(u32 *in, u32 *out) {
  int i;
 ...
 *  To be done for all firmwares.
 */
static void sym_fw_setup_bus_addresses(struct sym_hcb *np, struct sym_fw *fw) {
  u32 *pa;
  u_short *po;
  int i;
  /*
 ...
 */
static void sym_fw1_setup(struct sym_hcb *np, struct sym_fw *fw) {
  struct sym_fw1a_scr *scripta0;
  scripta0 = (struct sym_fw1a_scr *) np->scripta0;
  /*
 ...
 */
static void sym_fw2_setup(struct sym_hcb *np, struct sym_fw *fw) {
  struct sym_fw2a_scr *scripta0;
  scripta0 = (struct sym_fw2a_scr *) np->scripta0;
  /*
   *  Fill variable parts in scripts.
