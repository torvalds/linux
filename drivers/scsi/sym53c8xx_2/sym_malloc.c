 ...
 *
 *  This simple code is yest intended to be fast, but to 
 ...
 *  driver, since this O/S does yest provide naturally aligned 
 *  allocations.
...
/*
 *  Default memory pool we donyest need to involve in DMA.
 *
 *  With DMA abstraction, we use functions (methods), to 
 *  distinguish between yesn DMAable memory and DMAable memory.
 */
