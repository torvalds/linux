...
static int sym_scatter(struct sym_hcb *np, struct sym_ccb *cp,
 ...
 */
int sym_setup_data_and_start(struct sym_hcb *np, struct scsi_cmnd *cmd,
    struct sym_ccb *cp) {
  u32 lastp, goalp;
  int dir;
  /*
 ...
 */
static struct Scsi_Host *sym_attach(const struct scsi_host_template *tpnt,
    int unit,
...
#else
static inline void sym_get_nvram(struct sym_device *devp,
