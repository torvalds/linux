...
static int __init lasi700_probe(struct parisc_device *dev) {
...
static void __exit lasi700_driver_remove(struct parisc_device *dev) {
...
static int __init lasi700_init(void) {
  return register_parisc_driver(&lasi700_driver);
}

static void __exit lasi700_exit(void) {
