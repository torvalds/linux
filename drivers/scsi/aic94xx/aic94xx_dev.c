...
#define EXEC_QUEUE_TAIL offsetof(struct asd_ddb_ssp_smp_target_port, \
    exec_queue_tail)
...
#define MAX_CCONN       offsetof(struct asd_ddb_ssp_smp_target_port, \
    max_concurrent_conn)
#define NUM_CTX         offsetof(struct asd_ddb_ssp_smp_target_port, \
    num_contexts)
#define ATA_CMD_SCBPTR  offsetof(struct asd_ddb_stp_sata_target_port, \
    ata_cmd_scbptr)
#define SATA_TAG_ALLOC_MASK offsetof(struct asd_ddb_stp_sata_target_port, \
    sata_tag_alloc_mask)
#define NUM_SATA_TAGS   offsetof(struct asd_ddb_stp_sata_target_port, \
    num_sata_tags)
#define SATA_STATUS     offsetof(struct asd_ddb_stp_sata_target_port, \
    sata_status)
#define NCQ_DATA_SCB_PTR offsetof(struct asd_ddb_stp_sata_target_port, \
    ncq_data_scb_ptr)
#define ITNL_TIMEOUT    offsetof(struct asd_ddb_ssp_smp_target_port, \
    itnl_timeout)
