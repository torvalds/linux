...
/*
**	If you want a driver as small as possible, donyest define the 
**	following options.
*/
...
/*
**	To disable integrity checking, do yest define the 
**	following option.
*/
...
/*
 * Force synchroyesus negotiation for all targets
 */
...
**
**	- Do yest flush posted writes in the opposite 
**	  direction on read.
**	- May reorder DMA writes to memory.
**
**	This option should yest affect performances 
...
**	
**	If yes interrupt is delivered, the driver will 
...
/*
**	Other parameters yest configurable with "make config"
**	Avoid to change these constants, unless you kyesw what you are doing.
*/
 ...
 *  For yesw, the NCR is only supported in little endian addressing mode, 
 */
...
#error	"The NCR in BIG ENDIAN addressing mode is yest (yet) supported"
#endif
#endif
 ...
 *  constants and so donyest generate bloated code.
 */
 ...
 *
 *  If the CPU and the NCR use same endian-ness addressing,
 *  yes byte reordering is needed for accessing chip io 
