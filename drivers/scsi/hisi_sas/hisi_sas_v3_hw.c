...
static const struct hisi_sas_defs_reg_lu defs_port_reg_lu[] = {
	HISI_SAS_DEFS_REG(PHY_CFG),
	HISI_SAS_DEFS_REG(HARD_PHY_LINKRATE),
	HISI_SAS_DEFS_REG(PROG_PHY_LINK_RATE),
	HISI_SAS_DEFS_REG(PHY_CTRL),
	HISI_SAS_DEFS_REG(SL_CFG),
	HISI_SAS_DEFS_REG(AIP_LIMIT),
	HISI_SAS_DEFS_REG(SL_CONTROL),
	HISI_SAS_DEFS_REG(RX_PRIMS_STATUS),
	HISI_SAS_DEFS_REG(TX_ID_DWORD0),
	HISI_SAS_DEFS_REG(TX_ID_DWORD1),
	HISI_SAS_DEFS_REG(TX_ID_DWORD2),
	HISI_SAS_DEFS_REG(TX_ID_DWORD3),
	HISI_SAS_DEFS_REG(TX_ID_DWORD4),
	HISI_SAS_DEFS_REG(TX_ID_DWORD5),
	HISI_SAS_DEFS_REG(TX_ID_DWORD6),
	HISI_SAS_DEFS_REG(TXID_AUTO),
	HISI_SAS_DEFS_REG(RX_IDAF_DWORD0),
	HISI_SAS_DEFS_REG(RXOP_CHECK_CFG_H),
	HISI_SAS_DEFS_REG(STP_LINK_TIMER),
	HISI_SAS_DEFS_REG(STP_LINK_TIMEOUT_STATE),
	HISI_SAS_DEFS_REG(CON_CFG_DRIVER),
	HISI_SAS_DEFS_REG(SAS_SSP_CON_TIMER_CFG),
	HISI_SAS_DEFS_REG(SAS_SMP_CON_TIMER_CFG),
	HISI_SAS_DEFS_REG(SAS_STP_CON_TIMER_CFG),
	HISI_SAS_DEFS_REG(CHL_INT0),
	HISI_SAS_DEFS_REG(CHL_INT1),
	HISI_SAS_DEFS_REG(CHL_INT2),
	HISI_SAS_DEFS_REG(CHL_INT0_MSK),
	HISI_SAS_DEFS_REG(CHL_INT1_MSK),
	HISI_SAS_DEFS_REG(CHL_INT2_MSK),
	HISI_SAS_DEFS_REG(SAS_EC_INT_COAL_TIME),
	HISI_SAS_DEFS_REG(CHL_INT_COAL_EN),
	HISI_SAS_DEFS_REG(SAS_RX_TRAIN_TIMER),
	HISI_SAS_DEFS_REG(PHY_CTRL_RDY_MSK),
	HISI_SAS_DEFS_REG(PHYCTRL_NOT_RDY_MSK),
	HISI_SAS_DEFS_REG(PHYCTRL_DWS_RESET_MSK),
	HISI_SAS_DEFS_REG(PHYCTRL_PHY_ENA_MSK),
	HISI_SAS_DEFS_REG(SL_RX_BCAST_CHK_MSK),
	HISI_SAS_DEFS_REG(PHYCTRL_OOB_RESTART_MSK),
	HISI_SAS_DEFS_REG(DMA_TX_STATUS),
	HISI_SAS_DEFS_REG(DMA_RX_STATUS),
	HISI_SAS_DEFS_REG(COARSETUNE_TIME),
	HISI_SAS_DEFS_REG(ERR_CNT_DWS_LOST),
	HISI_SAS_DEFS_REG(ERR_CNT_RESET_PROB),
	HISI_SAS_DEFS_REG(ERR_CNT_INVLD_DW),
	HISI_SAS_DEFS_REG(ERR_CNT_CODE_ERR),
	HISI_SAS_DEFS_REG(ERR_CNT_DISP_ERR),
	{}
};

static const struct hisi_sas_defs_reg defs_port_reg = {
	.lu = defs_port_reg_lu,
	.count = 0x100,
	.base_off = PORT_BASE,
...
static const struct hisi_sas_defs_reg_lu defs_global_reg_lu[] = {
	HISI_SAS_DEFS_REG(DLVRY_QUEUE_ENABLE),
	HISI_SAS_DEFS_REG(PHY_CONTEXT),
	HISI_SAS_DEFS_REG(PHY_STATE),
	HISI_SAS_DEFS_REG(PHY_PORT_NUM_MA),
	HISI_SAS_DEFS_REG(PHY_CONN_RATE),
	HISI_SAS_DEFS_REG(ITCT_CLR),
	HISI_SAS_DEFS_REG(IO_SATA_BROKEN_MSG_ADDR_LO),
	HISI_SAS_DEFS_REG(IO_SATA_BROKEN_MSG_ADDR_HI),
	HISI_SAS_DEFS_REG(SATA_INITI_D2H_STORE_ADDR_LO),
	HISI_SAS_DEFS_REG(SATA_INITI_D2H_STORE_ADDR_HI),
	HISI_SAS_DEFS_REG(CFG_MAX_TAG),
	HISI_SAS_DEFS_REG(HGC_SAS_TX_OPEN_FAIL_RETRY_CTRL),
	HISI_SAS_DEFS_REG(HGC_SAS_TXFAIL_RETRY_CTRL),
	HISI_SAS_DEFS_REG(HGC_GET_ITV_TIME),
	HISI_SAS_DEFS_REG(DEVICE_MSG_WORK_MODE),
	HISI_SAS_DEFS_REG(OPENA_WT_CONTI_TIME),
	HISI_SAS_DEFS_REG(I_T_NEXUS_LOSS_TIME),
	HISI_SAS_DEFS_REG(MAX_CON_TIME_LIMIT_TIME),
	HISI_SAS_DEFS_REG(BUS_INACTIVE_LIMIT_TIME),
	HISI_SAS_DEFS_REG(REJECT_TO_OPEN_LIMIT_TIME),
	HISI_SAS_DEFS_REG(CQ_INT_CONVERGE_EN),
	HISI_SAS_DEFS_REG(CFG_AGING_TIME),
	HISI_SAS_DEFS_REG(HGC_DFX_CFG2),
	HISI_SAS_DEFS_REG(CFG_ABT_SET_QUERY_IPTT),
	HISI_SAS_DEFS_REG(CFG_ABT_SET_IPTT_DONE),
	HISI_SAS_DEFS_REG(HGC_IOMB_PROC1_STATUS),
	HISI_SAS_DEFS_REG(CHNL_INT_STATUS),
	HISI_SAS_DEFS_REG(HGC_AXI_FIFO_ERR_INFO),
	HISI_SAS_DEFS_REG(INT_COAL_EN),
	HISI_SAS_DEFS_REG(OQ_INT_COAL_TIME),
	HISI_SAS_DEFS_REG(OQ_INT_COAL_CNT),
	HISI_SAS_DEFS_REG(ENT_INT_COAL_TIME),
	HISI_SAS_DEFS_REG(ENT_INT_COAL_CNT),
	HISI_SAS_DEFS_REG(OQ_INT_SRC),
	HISI_SAS_DEFS_REG(OQ_INT_SRC_MSK),
	HISI_SAS_DEFS_REG(ENT_INT_SRC1),
	HISI_SAS_DEFS_REG(ENT_INT_SRC2),
	HISI_SAS_DEFS_REG(ENT_INT_SRC3),
	HISI_SAS_DEFS_REG(ENT_INT_SRC_MSK1),
	HISI_SAS_DEFS_REG(ENT_INT_SRC_MSK2),
	HISI_SAS_DEFS_REG(ENT_INT_SRC_MSK3),
	HISI_SAS_DEFS_REG(CHNL_PHYUPDOWN_INT_MSK),
	HISI_SAS_DEFS_REG(CHNL_ENT_INT_MSK),
	HISI_SAS_DEFS_REG(HGC_COM_INT_MSK),
	HISI_SAS_DEFS_REG(SAS_ECC_INTR),
	HISI_SAS_DEFS_REG(SAS_ECC_INTR_MSK),
	HISI_SAS_DEFS_REG(HGC_ERR_STAT_EN),
	HISI_SAS_DEFS_REG(CQE_SEND_CNT),
	HISI_SAS_DEFS_REG(DLVRY_Q_0_DEPTH),
	HISI_SAS_DEFS_REG(DLVRY_Q_0_WR_PTR),
	HISI_SAS_DEFS_REG(DLVRY_Q_0_RD_PTR),
	HISI_SAS_DEFS_REG(HYPER_STREAM_ID_EN_CFG),
	HISI_SAS_DEFS_REG(OQ0_INT_SRC_MSK),
	HISI_SAS_DEFS_REG(COMPL_Q_0_DEPTH),
	HISI_SAS_DEFS_REG(COMPL_Q_0_WR_PTR),
	HISI_SAS_DEFS_REG(COMPL_Q_0_RD_PTR),
	HISI_SAS_DEFS_REG(AWQOS_AWCACHE_CFG),
	HISI_SAS_DEFS_REG(ARQOS_ARCACHE_CFG),
	HISI_SAS_DEFS_REG(HILINK_ERR_DFX),
	HISI_SAS_DEFS_REG(SAS_GPIO_CFG_0),
	HISI_SAS_DEFS_REG(SAS_GPIO_CFG_1),
	HISI_SAS_DEFS_REG(SAS_GPIO_TX_0_1),
	HISI_SAS_DEFS_REG(SAS_CFG_DRIVE_VLD),
	{}
};

static const struct hisi_sas_defs_reg defs_global_reg = {
	.lu = defs_global_reg_lu,
	.count = 0x800,
	.read_global_reg = hisi_sas_read32,
};

static void defs_snapshot_prepare_v3_hw(struct hisi_hba *hisi_hba)
{
	struct device *dev = hisi_hba->dev;
...
static void defs_snapshot_restore_v3_hw(struct hisi_hba *hisi_hba)
{
	hisi_sas_write32(hisi_hba, DLVRY_QUEUE_ENABLE,
			 (u32)((1ULL << hisi_hba->queue_count) - 1));
...
static const struct hisi_sas_hw hisi_sas_v3_hw = {
	...
	.defs_reg_global = &defs_global_reg,
	.defs_reg_port = &defs_port_reg,
	.snapshot_prepare = defs_snapshot_prepare_v3_hw,
	.snapshot_restore = defs_snapshot_restore_v3_hw,
};
...
hisi_sas_shost_alloc_pci(struct pci_dev *pdev)
{
	...
	INIT_WORK(&hisi_hba->defs_work, hisi_sas_defs_work_handler);
...
hisi_sas_v3_probe(struct pci_dev *pdev, const struct pci_device_id *id)
{
	...
	if (hisi_sas_defs_enable)
		hisi_sas_defs_init(hisi_hba);
