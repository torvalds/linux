...
static struct {
  ...
  {"COMPAQ", "LOGICAL VOLUME", NULL, BLIST_FORCELUN | BLIST_MAX_512}, /* Compaq
                                                                       * RA4x00
                                                                       * */
  ...
  {"Generic", "USB Storage-SMC", NULL, BLIST_FORCELUN | BLIST_INQUIRY_36}, /*
                                                                            ...
                                                                            * 0207
                                                                            * */
  {"Generic", "Ultra HS-SD/MMC", "2.09",
   BLIST_IGN_MEDIA_CHANGE | BLIST_INQUIRY_36},
...
/**
 * scsi_get_device_flags_keyed - get device specific flags from the dynamic
 * device list
 * @sdev:       &scsi_device to get flags for
 * @vendor: vendor name
 * @model:  model name
