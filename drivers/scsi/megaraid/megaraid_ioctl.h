 ...
 */
#define	CL_ANN		0	/* print unconditionally, anyesuncements */
 ...
 * @adapyes	: Adapter number
 * @cmdbuf	: Pointer to buffer - can point to mbox or plain data buffer
 * @xferlen	: xferlen for DCMD and yesn mailbox commands
 ...
 * @drv_data		: Driver specific; yest touched by the common module
 ...
 * @kioc_semaphore	: so as yest to exceed @max_kioc parallel ioctls
