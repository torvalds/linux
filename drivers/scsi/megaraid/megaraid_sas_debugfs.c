...
static ssize_t megasas_debugfs_read(struct file *filp, char __user *ubuf,
    size_t cnt,
    loff_t *ppos) {
...
static int megasas_debugfs_raidmap_open(struct inode *inode,
    struct file *file) {
...
static int megasas_debugfs_release(struct inode *inode, struct file *file) {
