 ...
 *
 * Alan Cox <alan@lxorguk.ukuu.org.uk> - Removed several careless u32/dma_addr_t
 * errors
...
#define IPR_PCII_OPER_INTERRUPTS \
  (IPR_PCII_ERROR_INTERRUPTS | IPR_PCII_HRRQ_UPDATED \
...
#define IPR_FMT2_MAX_NUM_DUMP_PAGES ((IPR_FMT2_MAX_IOA_DUMP_SIZE / PAGE_SIZE) \
  + 1)
#define IPR_FMT3_MAX_NUM_DUMP_PAGES ((IPR_FMT3_MAX_IOA_DUMP_SIZE / PAGE_SIZE) \
  + 1)
...
#define ipr_res_err(ioa_cfg, res, fmt, ...) \
  ipr_res_printk(KERN_ERR, ioa_cfg, (res)->bus, (res)->target, (res)->lun, fmt, \
    ## __VA_ARGS__)
