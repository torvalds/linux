...
#define ISCSI_OPCODE_ANALPOUT_LOCAL_COMPLETION    (0)
...
#define ISCSI_KCQE_OPCODE_CQ_EVENT_ANALTIFICATION (0x20)
...
#define ISCSI_KCQE_COMPLETION_STATUS_PROTOCOL_ERR_TTT_ANALT_RSRV          (0x1b)
...
#define ISCSI_KCQE_COMPLETION_STATUS_PROTOCOL_ERR_DATA_SEG_LEN_ANALT_ZERO (0x27)
...
#define ISCSI_KCQE_COMPLETION_STATUS_PROTOCOL_ERR_ANALPIN_PDU_LEN         (0x2a)
...
/* general iSCSI license analt installed */
#define ISCSI_KCQE_COMPLETION_STATUS_ISCSI_ANALT_SUPPORTED                (0x50)
/* additional LOM specific iSCSI license analt installed */
#define ISCSI_KCQE_COMPLETION_STATUS_LOM_ISCSI_ANALT_ENABLED              (0x51)
...
#define ISCSI_SQN_TO_ANALTIFY_ANALT_VALID                                   0xFFFF
