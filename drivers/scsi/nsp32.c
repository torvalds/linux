...
MODULE_PARM_DESC(disc_priv,
    "disconnection privilege mode (0: ON 1: OFF(default))");

MODULE_AUTHOR(
    "YOKOTA Hiroshi <yokota@netlab.is.tsukuba.ac.jp>, GOTO Masanori <gotom@debian.or.jp>");
MODULE_DESCRIPTION(
 ...
 */
static void nsp32_adjust_busfree(struct scsi_cmnd *SCpnt,
 ...
 */
static void nsp32_restart_autoscsi(struct scsi_cmnd *SCpnt,
