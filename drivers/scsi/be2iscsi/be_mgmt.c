...
static void __beiscsi_eq_delay_compl(struct beiscsi_hba *phba,
    unsigned int tag) {
  struct be_dma_mem *tag_mem;
  /* status is ignored */
...
static int beiscsi_if_clr_ip(struct beiscsi_hba *phba,
...
static int beiscsi_if_set_ip(struct beiscsi_hba *phba, u8 *ip,
 ...
 * size of the formatted string
 **/
ssize_t beiscsi_fw_ver_disp(struct device *dev, struct device_attribute *attr,
    char *buf) {
