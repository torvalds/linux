...
static const struct {
  ...
  { IBMVFC_FABRIC_MAPPED, IBMVFC_UNABLE_TO_ESTABLISH, DID_ERROR, 1, 1,
    "unable to establish" },
  { IBMVFC_FABRIC_MAPPED, IBMVFC_XPORT_FAULT, DID_OK, 1, 0, "transport fault" },
  { IBMVFC_FABRIC_MAPPED, IBMVFC_CMD_TIMEOUT, DID_TIME_OUT, 1, 1,
    "command timeout" },
  { IBMVFC_FABRIC_MAPPED, IBMVFC_ENETDOWN, DID_TRANSPORT_DISRUPTED, 1, 1,
    "network down" },
  { IBMVFC_FABRIC_MAPPED, IBMVFC_HW_FAILURE, DID_ERROR, 1, 1,
    "hardware failure" },
  { IBMVFC_FABRIC_MAPPED, IBMVFC_LINK_DOWN_ERR, DID_REQUEUE, 0, 0,
    "link down" },
  { IBMVFC_FABRIC_MAPPED, IBMVFC_LINK_DEAD_ERR, DID_ERROR, 0, 0, "link dead" },
  { IBMVFC_FABRIC_MAPPED, IBMVFC_UNABLE_TO_REGISTER, DID_ERROR, 1, 1,
    "unable to register" },
  { IBMVFC_FABRIC_MAPPED, IBMVFC_XPORT_BUSY, DID_BUS_BUSY, 1, 0,
    "transport busy" },
  { IBMVFC_FABRIC_MAPPED, IBMVFC_XPORT_DEAD, DID_ERROR, 0, 1,
    "transport dead" },
  { IBMVFC_FABRIC_MAPPED, IBMVFC_CONFIG_ERROR, DID_ERROR, 1, 1,
    "configuration error" },
  { IBMVFC_FABRIC_MAPPED, IBMVFC_NAME_SERVER_FAIL, DID_ERROR, 1, 1,
    "name server failure" },
  { IBMVFC_FABRIC_MAPPED, IBMVFC_LINK_HALTED, DID_REQUEUE, 1, 0,
    "link halted" },
  { IBMVFC_FABRIC_MAPPED, IBMVFC_XPORT_GENERAL, DID_OK, 1, 0,
    "general transport error" },

  { IBMVFC_VIOS_FAILURE, IBMVFC_CRQ_FAILURE, DID_REQUEUE, 1, 1, "CRQ failure" },
  { IBMVFC_VIOS_FAILURE, IBMVFC_SW_FAILURE, DID_ERROR, 0, 1,
    "software failure" },
  { IBMVFC_VIOS_FAILURE, IBMVFC_INVALID_PARAMETER, DID_ERROR, 0, 1,
    "invalid parameter" },
  { IBMVFC_VIOS_FAILURE, IBMVFC_MISSING_PARAMETER, DID_ERROR, 0, 1,
    "missing parameter" },
  { IBMVFC_VIOS_FAILURE, IBMVFC_HOST_IO_BUS, DID_ERROR, 1, 1,
    "host I/O bus failure" },
  { IBMVFC_VIOS_FAILURE, IBMVFC_TRANS_CANCELLED, DID_ERROR, 0, 1,
    "transaction cancelled" },
  { IBMVFC_VIOS_FAILURE, IBMVFC_TRANS_CANCELLED_IMPLICIT, DID_ERROR, 0, 1,
    "transaction cancelled implicit" },
  { IBMVFC_VIOS_FAILURE, IBMVFC_INSUFFICIENT_RESOURCE, DID_REQUEUE, 1, 1,
    "insufficient resources" },
  { IBMVFC_VIOS_FAILURE, IBMVFC_PLOGI_REQUIRED, DID_ERROR, 0, 1,
    "port login required" },
  { IBMVFC_VIOS_FAILURE, IBMVFC_COMMAND_FAILED, DID_ERROR, 1, 1,
    "command failed" },

  { IBMVFC_FC_FAILURE, IBMVFC_INVALID_ELS_CMD_CODE, DID_ERROR, 0, 1,
    "invalid ELS command code" },
  { IBMVFC_FC_FAILURE, IBMVFC_INVALID_VERSION, DID_ERROR, 0, 1,
    "invalid version level" },
  { IBMVFC_FC_FAILURE, IBMVFC_LOGICAL_ERROR, DID_ERROR, 1, 1, "logical error" },
  { IBMVFC_FC_FAILURE, IBMVFC_INVALID_CT_IU_SIZE, DID_ERROR, 0, 1,
    "invalid CT_IU size" },
  { IBMVFC_FC_FAILURE, IBMVFC_LOGICAL_BUSY, DID_REQUEUE, 1, 0, "logical busy" },
  { IBMVFC_FC_FAILURE, IBMVFC_PROTOCOL_ERROR, DID_ERROR, 1, 1,
    "protocol error" },
  { IBMVFC_FC_FAILURE, IBMVFC_UNABLE_TO_PERFORM_REQ, DID_ERROR, 1, 1,
    "unable to perform request" },
  { IBMVFC_FC_FAILURE, IBMVFC_CMD_NOT_SUPPORTED, DID_ERROR, 0, 0,
    "command not supported" },
  { IBMVFC_FC_FAILURE, IBMVFC_SERVER_NOT_AVAIL, DID_ERROR, 0, 1,
    "server not available" },
  { IBMVFC_FC_FAILURE, IBMVFC_CMD_IN_PROGRESS, DID_ERROR, 0, 1,
    "command already in progress" },
  { IBMVFC_FC_FAILURE, IBMVFC_VENDOR_SPECIFIC, DID_ERROR, 1, 1,
    "vendor specific" },

  { IBMVFC_FC_SCSI_ERROR, 0, DID_OK, 1, 0, "SCSI error" },
  { IBMVFC_FC_SCSI_ERROR, IBMVFC_COMMAND_FAILED, DID_ERROR, 0, 1,
    "PRLI to device failed." },
};
...
static int ibmvfc_check_caps(struct ibmvfc_host *vhost,
 ...
 **/
static int ibmvfc_get_err_result(struct ibmvfc_host *vhost,
    struct ibmvfc_cmd *vfc_cmd) {
  int err;
  struct ibmvfc_fcp_rsp *rsp = ibmvfc_get_fcp_rsp(vhost, vfc_cmd);
  ...
  err
    = ibmvfc_get_err_index(be16_to_cpu(vfc_cmd->status), be16_to_cpu(
      vfc_cmd->error));
  if (err >= 0) {
...
/**
 * ibmvfc_purge_requests - Our virtual adapter just shut down. Purge any sent
 * requests
 * @vhost:    ibmvfc host struct
...
/**
 * ibmvfc_hard_reset_host - Reset the connection to the server by breaking the
 * CRQ
 ...
 **/
static struct ibmvfc_event *__ibmvfc_get_event(struct ibmvfc_queue *queue,
    int reserved) {
...
static void ibmvfc_log_error(struct ibmvfc_event *evt) {
  ...
  int index
    = ibmvfc_get_err_index(be16_to_cpu(vfc_cmd->status),
...
static void ibmvfc_scsi_done(struct ibmvfc_event *evt) {
  ...
  if (cmnd) {
    ...
    if (vfc_cmd->status) {
      ...
      if (!cmnd->result
          && (!scsi_get_resid(cmnd) || (rsp->flags & FCP_RESID_OVER))) {
...
static struct ibmvfc_cmd *ibmvfc_init_vfc_cmd(struct ibmvfc_event *evt,
 ...
 *  0 on success / other on failure
 **/
static int ibmvfc_queuecommand(struct Scsi_Host *shost,
...
static int ibmvfc_bsg_request(struct bsg_job *job) {
  ...
  mad->common.length
    = cpu_to_be16(sizeof(*mad) - sizeof(mad->fc_iu) - sizeof(mad->iu));
...
static int ibmvfc_reset_device(struct scsi_device *sdev, int type, char *desc) {
  ...
  if (rsp_code) {
    ...
    sdev_printk(KERN_ERR, sdev, "%s reset failed: %s (%x:%x) "
        ...
        be16_to_cpu(rsp_iu.cmd.status), be16_to_cpu(
        rsp_iu.cmd.error), fc_rsp->flags, rsp_code,
        fc_rsp->scsi_status);
    rsp_rc = -EIO;
  } else {
...
static struct ibmvfc_event *ibmvfc_init_tmf(struct ibmvfc_queue *queue,
  ...
  if (vhost->state == IBMVFC_ACTIVE) {
    ...
    tmf->flags
      = cpu_to_be32(((type & IBMVFC_TMF_SUPPRESS_ABTS)
    ...
    if (status != IBMVFC_MAD_SUCCESS) {
      ...
      switch (status) {
        ...
        case IBMVFC_MAD_CRQ_ERROR:
           ...
           * the caller will wait for the command being cancelled to get
           * returned
           */
          break;
        default:
 ...
 *
 **/
static void ibmvfc_dev_cancel_all_noreset(struct scsi_device *sdev,
    void *data) {
  ...
  switch (be64_to_cpu(crq->event)) {
    ...
    case IBMVFC_AE_ELS_PLOGI:
      list_for_each_entry(tgt, &vhost->targets, queue) {
        ...
        if (crq->node_name
            && cpu_to_be64(tgt->ids.node_name) != crq->node_name) {
          continue;
        }
        ...
        if (!tgt->need_login
            || be64_to_cpu(crq->event) == IBMVFC_AE_ELS_PLOGI) {
          ibmvfc_del_tgt(tgt);
          ibmvfc_reinit_host(vhost);
        }
      }
...
static void ibmvfc_handle_scrq(struct ibmvfc_crq *crq,
    struct ibmvfc_host *vhost,
    struct list_head *evt_doneq) {
  struct ibmvfc_event *evt = (struct ibmvfc_event *) be64_to_cpu(crq->ioba);
  switch (crq->valid) {
  ...
  switch (status) {
    ...
    default:
      if ((be16_to_cpu(rsp->status) & IBMVFC_VIOS_FAILURE)
        ...
        level += ibmvfc_retry_tgt_init(tgt, ibmvfc_tgt_send_plogi);
      } else if (ibmvfc_retry_cmd(be16_to_cpu(rsp->status),
      ...
      tgt_log(tgt, level, "Process Login failed: %s (%x:%x) rc=0x%02X\n",
          ibmvfc_get_cmd_error(be16_to_cpu(rsp->status), be16_to_cpu(
              rsp->error)),
...
static void ibmvfc_tgt_send_prli(struct ibmvfc_target *tgt) {
  ...
  prli->parms.service_parms |= cpu_to_be32(
...
/**
 * __ibmvfc_tgt_get_implicit_logout_evt - Allocate and init an event for
 * implicit logout
 * @tgt:    ibmvfc target struct
 * @done:   Routine to call when the event is responded to
 *
 ...
 **/
static struct ibmvfc_event *__ibmvfc_tgt_get_implicit_logout_evt(
    struct ibmvfc_target *tgt,
...
/**
 * ibmvfc_tgt_implicit_logout_and_del_done - Completion handler for Implicit
 * Logout MAD
 * @evt:  ibmvfc event struct
 *
 **/
...
/**
 * ibmvfc_tgt_implicit_logout_and_del - Initiate an Implicit Logout for
 * specified target
 * @tgt:    ibmvfc target struct
 *
 **/
  ...
  switch (status) {
    ...
    default:
      ...
      tgt_log(tgt, level,
          ...
          tgt->new_scsi_id, be32_to_cpu(rsp->flags), be16_to_cpu(
          rsp->vios_flags),
          status);
      break;
  }
...
static void ibmvfc_tgt_adisc(struct ibmvfc_target *tgt) {
  ...
  mad->fc_iu.payload[6] = cpu_to_be32(be64_to_cpu(
      vhost->login_buf->resp.scsi_id) & 0x00ffffff);
...
static void ibmvfc_tgt_query_target_done(struct ibmvfc_event *evt) {
  ...
  switch (status) {
    ...
    case IBMVFC_MAD_FAILED:
    default:
      if ((be16_to_cpu(rsp->status) & IBMVFC_FABRIC_MAPPED)
...
static void ibmvfc_npiv_login_done(struct ibmvfc_event *evt) {
  ...
  vhost->logged_in = 1;
  npiv_max_sectors = min((uint) (be64_to_cpu(
      rsp->max_dma_len) >> 9), IBMVFC_MAX_SECTORS);
  ...
  if (ibmvfc_check_caps(vhost,
      IBMVFC_CAN_SUPPORT_CHANNELS) && vhost->do_enquiry) {
...
static void ibmvfc_tgt_add_rport(struct ibmvfc_target *tgt) {
  ...
  if (rport) {
    ...
    tgt->rport = rport;
    rport->maxframe_size = be16_to_cpu(tgt->service_parms.common.bb_rcv_sz)
        & 0x0fff;
    ...
    case IBMVFC_HOST_ACTION_TGT_DEL_FAILED:
      ...
      list_for_each_entry(tgt, &vhost->targets, queue) {
        if (tgt->action == IBMVFC_TGT_ACTION_DEL_RPORT) {
           ...
           * rport LUNs will stay outstanding indefinitely, since the EH
           * handlers
...
static void ibmvfc_free_disc_buf(struct device *dev,
    struct ibmvfc_channels *channels) {
...
static int ibmvfc_alloc_disc_buf(struct device *dev,
    struct ibmvfc_channels *channels) {
...
static int ibmvfc_probe(struct vio_dev *vdev, const struct vio_device_id *id) {
  ...
  unsigned int max_scsi_queues = min((unsigned int) IBMVFC_MAX_SCSI_QUEUES,
      online_cpus);
  ENTER;
  ...
  shost->nr_hw_queues
    = mq_enabled ? min(max_scsi_queues, nr_scsi_hw_queues) : 1;
