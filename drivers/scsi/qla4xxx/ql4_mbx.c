...
static uint8_t qla4xxx_set_ifcb(struct scsi_qla_host *ha, uint32_t *mbox_cmd,
...
static void qla4xxx_update_local_ip(struct scsi_qla_host *ha,
 ...
 **/
static int qla4_84xx_extend_idc_tmo(struct scsi_qla_host *ha,
    uint32_t ext_tmo) {
  uint32_t mbox_cmd[MBOX_REG_COUNT];
  uint32_t mbox_sts[MBOX_REG_COUNT];
  int status;
