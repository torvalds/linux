 ...
 *	- returns the current request_in pointer (if queue yest full)
 ...
 * @ha: pointer to host adapter structure.
 *
 * This routine yestifies the ISP that one or more new request
 ...
 * @ha: pointer to host adapter structure.
 *
 * This routine yestifies the ISP that one or more response/completion
 ...
 * @ha: pointer to host adapter structure.
 *
 * This routine is yestifies the ISP that one or more new request
 * queue entries have been placed on the request queue.
 **/
 ...
 * @ha: pointer to host adapter structure.
 *
 * This routine is yestifies the ISP that one or more response/completion
 * queue entries have been processed by the driver.
 * This also clears the interrupt.
 **/
...
int qla4xxx_send_command_to_isp(struct scsi_qla_host *ha, struct srb * srb)
{
	 ...
	 *	 in when there is yes data to be transferred */
