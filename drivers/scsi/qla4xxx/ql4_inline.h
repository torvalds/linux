 ...
 */
static inline struct ddb_entry *qla4xxx_lookup_ddb_by_fw_index(
    struct scsi_qla_host *ha, uint32_t fw_ddb_index) {
...
static inline void __qla4xxx_enable_intrs(struct scsi_qla_host *ha) {
...
static inline void __qla4xxx_disable_intrs(struct scsi_qla_host *ha) {
  if (is_qla4022(ha) | is_qla4032(ha)) {
...
static inline void qla4xxx_enable_intrs(struct scsi_qla_host *ha) {
  unsigned long flags;
...
static inline void qla4xxx_disable_intrs(struct scsi_qla_host *ha) {
  unsigned long flags;
  spin_lock_irqsave(&ha->hardware_lock, flags);
