 ...
 * For details see
 *https://www.amd.com/products/epd/desiging/evalboards/18.elansc520/520_cdp_brief/index.html
 */
...
static void sc520cdp_setup_par(void) {
  ...
  */
  for (i = 0; i < NUM_FLASH_BANKS; i++) {    /* for each par_table entry  */
    ...
    if (j == NUM_SC520_PAR) { /* no matching PAR found: try default BIOS address
                               * */
