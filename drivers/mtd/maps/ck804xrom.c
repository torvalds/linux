...
MODULE_PARM_DESC(win_size_bits,
...
static int __init ck804xrom_init_one(struct pci_dev *pdev,
  ...
  switch (ent->driver_data) {
    ...
    case DEV_MCP55:
      ...
      pci_write_config_word(pdev, 0x90,
          word | ((win_size_bits & 0x7fff0000) >> 16));
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR(
    "Eric Biederman <ebiederman@lnxi.com>, Dave Olsen <dolsen@lnxi.com>");
MODULE_DESCRIPTION(
