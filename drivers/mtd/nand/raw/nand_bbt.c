...
/**
 * read_abs_bbts - [GENERIC] Read the bad block table(s) for all chips starting
 *at a given page
 * @this: NAND chip object
 * @buf: temporary buffer
 * @td: descriptor for the bad block table
 ...
 * table.
 */
static void verify_bbt_descr(struct nand_chip *this,
    struct nand_bbt_descr *bd) {
  u64 targetsize = nanddev_target_size(&this->base);
  struct mtd_info *mtd = nand_to_mtd(this);
  u32 pattern_len;
...
/**
 * nand_scan_bbt - [NAND Interface] scan, find, read and maybe create bad block
 *table(s)
 * @this: the NAND device
 * @bd: descriptor for the good/bad block search pattern
 *
...
/**
 * nand_create_bbt - [NAND Interface] Select a default bad block table for the
 *device
 * @this: NAND chip object
 *
