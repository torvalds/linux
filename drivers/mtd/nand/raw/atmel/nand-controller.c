...
static inline struct atmel_nand_controller *to_nand_controller(
    struct nand_controller *ctl) {
...
static inline struct atmel_smc_nand_controller *to_smc_nand_controller(
    struct nand_controller *ctl) {
...
static inline struct atmel_hsmc_nand_controller *to_hsmc_nand_controller(
    struct nand_controller *ctl) {
  return container_of(to_nand_controller(ctl),
...
static int atmel_nand_waitrdy(struct atmel_nand *nand,
    unsigned int timeout_ms) {
...
static void atmel_nfc_set_op_addr(struct nand_chip *chip, int page,
    int column) {
  struct mtd_info *mtd = nand_to_mtd(chip);
  struct atmel_hsmc_nand_controller *nc;
  nc = to_hsmc_nand_controller(chip->controller);
...
static int atmel_nand_pmecc_generate_eccbytes(struct nand_chip *chip,
    bool raw) {
  struct atmel_nand *nand = to_atmel_nand(chip);
  struct mtd_info *mtd = nand_to_mtd(chip);
  struct atmel_nand_controller *nc;
...
static int atmel_nand_controller_add_nand(struct atmel_nand_controller *nc,
    struct atmel_nand *nand) {
  struct nand_chip *chip = &nand->base;
  struct mtd_info *mtd = nand_to_mtd(chip);
  int ret;
...
static int atmel_nand_controller_remove_nands(struct atmel_nand_controller *nc)
{
...
static int atmel_nand_controller_legacy_add_nands(
    struct atmel_nand_controller *nc) {
...
static int atmel_smc_nand_controller_init(struct atmel_smc_nand_controller *nc)
{
...
static int atmel_hsmc_nand_controller_legacy_init(
    struct atmel_hsmc_nand_controller *nc) {
...
static int atmel_hsmc_nand_controller_init(
    struct atmel_hsmc_nand_controller *nc) {
  struct device *dev = nc->base.dev;
  struct device_node *np;
  int ret;
...
static int atmel_hsmc_nand_controller_remove(struct atmel_nand_controller *nc) {
...
static int atmel_smc_nand_controller_remove(struct atmel_nand_controller *nc) {
  int ret;
  ret = atmel_nand_controller_remove_nands(nc);
  if (ret) {
    return ret;
