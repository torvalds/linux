...
static const struct atmel_pmecc_gf_tables *atmel_pmecc_create_gf_tables(
    const struct atmel_pmecc_user_req *req) {
  struct atmel_pmecc_gf_tables *gf_tables;
...
static const struct atmel_pmecc_gf_tables *atmel_pmecc_get_gf_tables(
    const struct atmel_pmecc_user_req *req) {
