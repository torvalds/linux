...
static bool cadence_nand_dma_buf_ok(struct cdns_nand_ctrl *cdns_ctrl,
    const void *buf,
    u32 buf_len) {
...
static void cadence_nand_clear_interrupt(struct cdns_nand_ctrl *cdns_ctrl,
    struct cadence_nand_irq_status *irq_status) {
...
static void cadence_nand_read_int_status(struct cdns_nand_ctrl *cdns_ctrl,
    struct cadence_nand_irq_status *irq_status) {
...
static void cadence_nand_wait_for_irq(struct cdns_nand_ctrl *cdns_ctrl,
    struct cadence_nand_irq_status *irq_mask,
    struct cadence_nand_irq_status *irq_status) {
...
static void cadence_nand_cdma_desc_prepare(struct cdns_nand_ctrl *cdns_ctrl,
...
static u32 cadence_nand_cdma_send_and_wait(struct cdns_nand_ctrl *cdns_ctrl,
    u8 thread) {
  struct cadence_nand_irq_status irq_mask, irq_status = {
    0
  };
...
static void cadence_nand_prepare_data_size(struct nand_chip *chip,
    int transfer_type) {
...
static int cadence_nand_cdma_transfer(struct cdns_nand_ctrl *cdns_ctrl,
    u8 chip_nr,
...
static int cadence_nand_setup_interface(struct nand_chip *chip, int chipnr,
...
static void cadence_nand_irq_cleanup(int irqnum,
