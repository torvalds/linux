...
static void send_cmd_v1_v2(struct mxc_nand_host *host, uint16_t cmd,
    int useirq) {
...
static void send_addr_v3(struct mxc_nand_host *host, uint16_t addr,
    int islast) {
  /* fill address */
 ...
 * a NAND command. */
static void send_addr_v1_v2(struct mxc_nand_host *host, uint16_t addr,
    int islast) {
