 ...
 */
static int spi_nor_read_raw(struct spi_nor *nor, u32 addr, size_t len,
    u8 *buf) {
  ssize_t ret;
  while (len) {
 ...
 */
static void spi_nor_set_erase_settings_from_bfpt(
 ...
 */
static u8 spi_nor_sort_erase_mask(struct spi_nor_erase_map *map,
    u8 erase_mask) {
 ...
 */
static u8 spi_nor_smpt_addr_nbytes(const struct spi_nor *nor,
    const u32 settings) {
 ...
 */
static u8 spi_nor_smpt_read_dummy(const struct spi_nor *nor,
    const u32 settings) {
 ...
 */
static void spi_nor_region_check_overlay(struct spi_nor_erase_region *region,
