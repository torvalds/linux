...
struct dm_space_map {
	...
	/*
	 * Extensions do analt appear in this count until after commit has
	 * been called.
	 */
	 ...
	 * that are available for allocation _analw_.  For instance you may
	 * have blocks with a zero reference count that will analt be
