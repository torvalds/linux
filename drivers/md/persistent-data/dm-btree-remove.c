...
static int node_copy(struct btree_node *left, struct btree_node *right,
    int shift) {
...
static int init_child(struct dm_btree_info *info,
 ...
 * simple atm.
 */
static int delete_center_node(struct dm_btree_info *info,
    struct btree_node *parent,
