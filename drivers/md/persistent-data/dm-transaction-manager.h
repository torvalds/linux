 ...
 * to clones.
 */
struct dm_transaction_manager *dm_tm_create_non_blocking_clone(
...
void dm_tm_inc_range(struct dm_transaction_manager *tm, dm_block_t b,
    dm_block_t e);
void dm_tm_dec(struct dm_transaction_manager *tm, dm_block_t b);
void dm_tm_dec_range(struct dm_transaction_manager *tm, dm_block_t b,
    dm_block_t e);
 ...
 */
typedef void (*dm_tm_run_fn)(struct dm_transaction_manager *, dm_block_t,
    dm_block_t);
