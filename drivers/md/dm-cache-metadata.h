 ...
 */
#define DM_CACHE_METADATA_MAX_SECTORS_WARNING (16 \
...
int dm_cache_set_discard(struct dm_cache_metadata *cmd, dm_dblock_t dblock,
    bool discard);

int dm_cache_remove_mapping(struct dm_cache_metadata *cmd, dm_cblock_t cblock);
int dm_cache_insert_mapping(struct dm_cache_metadata *cmd, dm_cblock_t cblock,
    dm_oblock_t oblock);
 ...
 */
int dm_cache_write_hints(struct dm_cache_metadata *cmd,
