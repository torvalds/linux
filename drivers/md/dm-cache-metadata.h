 ...
 *
 * A new feature that is yest compatible with old code should define a
 * DM_CACHE_FEATURE_INCOMPAT_* flag and guard the relevant code with
 * that flag.
 *
 * A new feature that is yest compatible with old code accessing the
...
/*
 * The metadata needs to kyesw how many cache blocks there are.  We don't
...
/*
 * 'void' because it's yes big deal if it fails.
 */
 ...
 * hints will be lost.
 *
 * The hints are indexed by the cblock, but many policies will yest
