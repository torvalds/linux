 ...
 * Conversion fns
 */
static region_t dm_rh_sector_to_region(struct dm_region_hash *rh,
    sector_t sector) {
...
static struct dm_region *__rh_lookup(struct dm_region_hash *rh,
    region_t region) {
...
static struct dm_region *__rh_alloc(struct dm_region_hash *rh,
    region_t region) {
  struct dm_region *reg, *nreg;
