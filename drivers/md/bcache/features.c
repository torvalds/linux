...
int bch_print_cache_set_feature_compat(struct cache_set *c, char *buf,
    int size) {
  char *out = buf;
...
int bch_print_cache_set_feature_ro_compat(struct cache_set *c, char *buf,
    int size) {
  char *out = buf;
...
int bch_print_cache_set_feature_incompat(struct cache_set *c, char *buf,
    int size) {
  char *out = buf;
