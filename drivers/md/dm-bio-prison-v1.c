...
struct dm_bio_prison_cell *dm_bio_prison_alloc_cell(
    struct dm_bio_prison *prison, gfp_t gfp) {
...
static inline unsigned int lock_nr(struct dm_cell_key *key,
    unsigned int num_locks) {
...
static int bio_detain(struct dm_bio_prison *prison,
  ...
  r = __bio_detain(&prison->regions[l].cell, key, inmate, cell_prealloc,
      cell_result);
