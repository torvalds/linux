...
enum {
  /*
   * The maximum number of contiguous PBNs which will go to a single bio
   * submission queue,
  ...
  /*
   * The height of a block map tree. Assuming a root count of 60 and 812 entries
   * per page,
  ...
  /*
   * The initial size of lbn_operations and pbn_operations, which is based upon
   * the expected
   * maximum number of outstanding VIOs. This value was chosen to make it highly
   * unlikely
