...
struct hash_zone {
  ...
  /*
   * Statistics shared by all hash locks in this zone. Only modified on the hash
   * zone thread,
...
/*
 * Minimum time interval (in milliseconds) between timer invocations to check
 * for requests waiting
