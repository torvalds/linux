 ...
 * they are received,
 * and will attempt to handle requeued requests before new ones. However, the
 * nature of the
 * implementation means that it cannot guarantee this ordering; the
 * prioritization is merely a
 * hint.
 */
