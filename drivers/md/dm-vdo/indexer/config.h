...
/*
 * The uds_configuration records a variety of parameters used to configure a new
 * UDS index. Some
 * parameters are provided by the client, while others are fixed or derived from
 * user-supplied
