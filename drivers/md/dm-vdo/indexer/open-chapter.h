 ...
 * whole, each open
 * chapter is divided into a number of independent zones which are interleaved
 * when the chapter is
...
int __must_check uds_close_open_chapter(
  struct open_chapter_zone **chapter_zones,
