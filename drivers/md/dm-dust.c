...
static int dust_list_badblocks(struct dust_device *dd, char *result,
    unsigned int maxlen,
    unsigned int *sz_ptr) {
  unsigned long flags;
  struct rb_root badblocklist;
...
static int dust_prepare_ioctl(struct dm_target *ti,
...
static int dust_iterate_devices(struct dm_target *ti,
