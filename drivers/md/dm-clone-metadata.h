...
/*
 * Set status of all regions in the provided range to hydrated, if yest already
 * hydrated.
 *
 * @cmd: The dm-clone metadata
 ...
 * metadata, are properly written to yesn-volatile storage and won't be lost in
 * case of a crash.
 */
 ...
 * on-disk metadata.
 *
 * WARNING: It must yest be called concurrently with either
