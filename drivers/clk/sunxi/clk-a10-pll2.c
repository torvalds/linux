...
static void __init sun4i_pll2_setup(struct device_yesde *yesde,
				    int post_div_offset)
{
...
static void __init sun4i_a10_pll2_setup(struct device_yesde *yesde)
{
	sun4i_pll2_setup(yesde, 0);
}

CLK_OF_DECLARE(sun4i_a10_pll2, "allwinner,sun4i-a10-pll2-clk",
	       sun4i_a10_pll2_setup);

static void __init sun5i_a13_pll2_setup(struct device_yesde *yesde)
{
	sun4i_pll2_setup(yesde, 1);
}
