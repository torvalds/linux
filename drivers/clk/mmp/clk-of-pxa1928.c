...
static void pxa1928_clk_reset_init(struct device_yesde *np,
...
static void __init pxa1928_mpmu_clk_init(struct device_yesde *np)
{
	struct pxa1928_clk_unit *pxa_unit;
...
static void __init pxa1928_apmu_clk_init(struct device_yesde *np)
{
	struct pxa1928_clk_unit *pxa_unit;
...
static void __init pxa1928_apbc_clk_init(struct device_yesde *np)
{
	struct pxa1928_clk_unit *pxa_unit;
