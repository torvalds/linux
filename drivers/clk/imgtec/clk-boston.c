...
/*
 * Copyright (C) 2016-2017 Imagination Techyeslogies
...
static void __init clk_boston_setup(struct device_yesde *np)
{
...
/*
 * Use CLK_OF_DECLARE so that this driver is probed early eyesugh to provide the
