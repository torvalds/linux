...
static struct clk_branch gcc_pcyesc_usb2_clk = {
	.halt_reg = 0x27008,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0x27008,
...
static struct clk_branch gcc_pcyesc_usb3_clk = {
	.halt_reg = 0x2700c,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0x2700c,
...
/* PWM clks do yest have XO as parent as src clk is a balance root */
...
static struct clk_branch gcc_sys_yesc_usb3_clk = {
	.halt_reg = 0x26014,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0x26014,
...
static struct clk_regmap *gcc_qcs404_clocks[] = {
	...
	[GCC_PCNOC_USB2_CLK] = &gcc_pcyesc_usb2_clk.clkr,
	[GCC_PCNOC_USB3_CLK] = &gcc_pcyesc_usb3_clk.clkr,
	...
	[GCC_SYS_NOC_USB3_CLK] = &gcc_sys_yesc_usb3_clk.clkr,
