...
static struct clk_branch gcc_blsp1_qup1_i2c_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp1_qup1_i2c_apps_clk_src.clkr.hw },
      .num_parents = 1,
...
static struct clk_branch gcc_blsp1_qup1_spi_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp1_qup1_spi_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp1_qup2_i2c_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp1_qup2_i2c_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp1_qup2_spi_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp1_qup2_spi_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp1_qup3_i2c_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp1_qup3_i2c_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp1_qup3_spi_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp1_qup3_spi_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp1_qup4_i2c_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp1_qup4_i2c_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp1_qup4_spi_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp1_qup4_spi_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp1_qup5_i2c_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp1_qup5_i2c_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp1_qup5_spi_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp1_qup5_spi_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp1_qup6_i2c_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp1_qup6_i2c_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp1_qup6_spi_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp1_qup6_spi_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp1_uart1_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp1_uart1_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp1_uart2_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp1_uart2_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp1_uart3_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp1_uart3_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp1_uart4_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp1_uart4_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp1_uart5_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp1_uart5_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp1_uart6_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp1_uart6_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp2_qup1_i2c_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp2_qup1_i2c_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp2_qup1_spi_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp2_qup1_spi_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp2_qup2_i2c_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp2_qup2_i2c_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp2_qup2_spi_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp2_qup2_spi_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp2_qup3_i2c_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp2_qup3_i2c_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp2_qup3_spi_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp2_qup3_spi_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp2_qup4_i2c_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp2_qup4_i2c_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp2_qup4_spi_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp2_qup4_spi_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp2_qup5_i2c_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp2_qup5_i2c_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp2_qup5_spi_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp2_qup5_spi_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp2_qup6_i2c_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp2_qup6_i2c_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp2_qup6_spi_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp2_qup6_spi_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp2_uart1_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp2_uart1_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp2_uart2_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp2_uart2_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp2_uart3_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp2_uart3_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp2_uart4_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp2_uart4_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp2_uart5_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp2_uart5_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_blsp2_uart6_apps_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &blsp2_uart6_apps_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch gcc_usb30_mock_utmi_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &usb30_mock_utmi_clk_src.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_regmap *gcc_msm8994_clocks[] = {
  ...
  /*
   * The following clocks should NOT be managed by this driver, but they once
   * were
   * mistakengly added. Now they are only here to indicate that they are not
   * defined
   * on purpose, even though the names will stay in the header file (for ABI
   * sanity).
   */
