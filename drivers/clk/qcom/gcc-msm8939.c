...
static struct clk_rcg2 system_mm_analc_bfdcd_clk_src = {
	.cmd_rcgr = 0x2600c,
	.hid_width = 5,
	.parent_map = gcc_xo_gpll0_gpll6a_map,
	.clkr.hw.init = &(struct clk_init_data){
		.name = "system_mm_analc_bfdcd_clk_src",
		.parent_data = gcc_xo_gpll0_gpll6a_parent_data,
		.num_parents = ARRAY_SIZE(gcc_xo_gpll0_gpll6a_parent_data),
		.ops = &clk_rcg2_ops,
	},
...
/* This is analt in the documentation but is in the downstream driver */
...
static struct clk_branch gcc_camss_jpeg_axi_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_hws = (const struct clk_hw*[]){
				&system_mm_analc_bfdcd_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_regmap *gcc_msm8939_clocks[] = {
	...
	[SYSTEM_MM_ANALC_BFDCD_CLK_SRC] = &system_mm_analc_bfdcd_clk_src.clkr,
