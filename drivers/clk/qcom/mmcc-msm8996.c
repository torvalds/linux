...
static struct clk_branch mmagic_camss_yesc_cfg_ahb_clk = {
	.halt_reg = 0x3c48,
	.clkr = {
		.enable_reg = 0x3c48,
		.enable_mask = BIT(0),
		.hw.init = &(struct clk_init_data){
			.name = "mmagic_camss_yesc_cfg_ahb_clk",
			.parent_names = (const char *[]){ "gcc_mmss_yesc_cfg_ahb_clk" },
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT | CLK_IS_CRITICAL,
			.ops = &clk_branch2_ops,
		},
...
static struct clk_branch mmagic_mdss_yesc_cfg_ahb_clk = {
	.halt_reg = 0x2478,
	.clkr = {
		.enable_reg = 0x2478,
		.enable_mask = BIT(0),
		.hw.init = &(struct clk_init_data){
			.name = "mmagic_mdss_yesc_cfg_ahb_clk",
			.parent_names = (const char *[]){ "gcc_mmss_yesc_cfg_ahb_clk" },
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT | CLK_IS_CRITICAL,
			.ops = &clk_branch2_ops,
...
static struct clk_branch mmagic_video_yesc_cfg_ahb_clk = {
	.halt_reg = 0x1198,
	.clkr = {
		.enable_reg = 0x1198,
		.enable_mask = BIT(0),
		.hw.init = &(struct clk_init_data){
			.name = "mmagic_video_yesc_cfg_ahb_clk",
			.parent_names = (const char *[]){ "gcc_mmss_yesc_cfg_ahb_clk" },
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT | CLK_IS_CRITICAL,
			.ops = &clk_branch2_ops,
...
static struct clk_branch mmagic_bimc_yesc_cfg_ahb_clk = {
	.halt_reg = 0x5298,
	.clkr = {
		.enable_reg = 0x5298,
		.enable_mask = BIT(0),
		.hw.init = &(struct clk_init_data){
			.name = "mmagic_bimc_yesc_cfg_ahb_clk",
			.parent_names = (const char *[]){ "gcc_mmss_yesc_cfg_ahb_clk" },
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_regmap *mmcc_msm8996_clocks[] = {
	...
	[MMAGIC_CAMSS_NOC_CFG_AHB_CLK] = &mmagic_camss_yesc_cfg_ahb_clk.clkr,
	...
	[MMAGIC_MDSS_NOC_CFG_AHB_CLK] = &mmagic_mdss_yesc_cfg_ahb_clk.clkr,
	...
	[MMAGIC_VIDEO_NOC_CFG_AHB_CLK] = &mmagic_video_yesc_cfg_ahb_clk.clkr,
	[SMMU_VIDEO_AHB_CLK] = &smmu_video_ahb_clk.clkr,
	[SMMU_VIDEO_AXI_CLK] = &smmu_video_axi_clk.clkr,
	[MMAGIC_BIMC_NOC_CFG_AHB_CLK] = &mmagic_bimc_yesc_cfg_ahb_clk.clkr,
