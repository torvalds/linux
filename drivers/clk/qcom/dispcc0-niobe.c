...
static struct clk_vdd_class *disp_cc_0_niobe_regulators[] = {
	&vdd_disp_cx,
	&vdd_mx,
};
...
static const struct clk_parent_data disp_cc_0_parent_data_7_ao[] = {
...
static struct clk_rcg2 mdss_0_disp_cc_mdss_byte0_clk_src = {
	...
	.clkr.vdd_data = {
		.vdd_classes = disp_cc_0_niobe_regulators,
		.num_vdd_classes = ARRAY_SIZE(disp_cc_0_niobe_regulators),
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
...
static const struct freq_tbl ftbl_mdss_0_disp_cc_mdss_mdp_clk_src[] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
	F(85714286, P_MDSS_0_DISP_CC_PLL0_OUT_MAIN, 3, 0, 0),
	F(100000000, P_MDSS_0_DISP_CC_PLL0_OUT_MAIN, 3, 0, 0),
	F(150000000, P_MDSS_0_DISP_CC_PLL0_OUT_MAIN, 3, 0, 0),
	F(200000000, P_MDSS_0_DISP_CC_PLL0_OUT_MAIN, 3, 0, 0),
	F(342000000, P_MDSS_0_DISP_CC_PLL0_OUT_MAIN, 3, 0, 0),
	F(402000000, P_MDSS_0_DISP_CC_PLL0_OUT_MAIN, 3, 0, 0),
	F(550000000, P_MDSS_0_DISP_CC_PLL0_OUT_MAIN, 3, 0, 0),
	F(600000000, P_MDSS_0_DISP_CC_PLL0_OUT_MAIN, 3, 0, 0),
	F(660000000, P_MDSS_0_DISP_CC_PLL0_OUT_MAIN, 3, 0, 0),
	{ }
};
...
static struct clk_rcg2 mdss_0_disp_cc_sleep_clk_src = {
	...
	.clkr.hw.init = &(const struct clk_init_data) {
		...
		.parent_data = disp_cc_0_parent_data_7_ao,
		.num_parents = ARRAY_SIZE(disp_cc_0_parent_data_7_ao),
		.ops = &clk_rcg2_ops,
	},
};
...
static struct clk_regmap *disp_cc_0_niobe_clocks[] = {
	[MDSS_0_DISP_CC_MDSS_ACCU_CLK] = &mdss_0_disp_cc_mdss_accu_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_AHB1_CLK] = &mdss_0_disp_cc_mdss_ahb1_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_AHB_CLK] = &mdss_0_disp_cc_mdss_ahb_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_AHB_CLK_SRC] = &mdss_0_disp_cc_mdss_ahb_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_BYTE0_CLK] = &mdss_0_disp_cc_mdss_byte0_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_BYTE0_CLK_SRC] = &mdss_0_disp_cc_mdss_byte0_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_BYTE0_DIV_CLK_SRC] = &mdss_0_disp_cc_mdss_byte0_div_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_BYTE0_INTF_CLK] = &mdss_0_disp_cc_mdss_byte0_intf_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_BYTE1_CLK] = &mdss_0_disp_cc_mdss_byte1_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_BYTE1_CLK_SRC] = &mdss_0_disp_cc_mdss_byte1_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_BYTE1_DIV_CLK_SRC] = &mdss_0_disp_cc_mdss_byte1_div_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_BYTE1_INTF_CLK] = &mdss_0_disp_cc_mdss_byte1_intf_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX0_AUX_CLK] = &mdss_0_disp_cc_mdss_dptx0_aux_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX0_AUX_CLK_SRC] = &mdss_0_disp_cc_mdss_dptx0_aux_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX0_CRYPTO_CLK] = &mdss_0_disp_cc_mdss_dptx0_crypto_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX0_LINK_CLK] = &mdss_0_disp_cc_mdss_dptx0_link_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX0_LINK_CLK_SRC] = &mdss_0_disp_cc_mdss_dptx0_link_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX0_LINK_DIV_CLK_SRC] =
		&mdss_0_disp_cc_mdss_dptx0_link_div_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX0_LINK_INTF_CLK] = &mdss_0_disp_cc_mdss_dptx0_link_intf_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX0_PIXEL0_CLK] = &mdss_0_disp_cc_mdss_dptx0_pixel0_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX0_PIXEL0_CLK_SRC] = &mdss_0_disp_cc_mdss_dptx0_pixel0_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX0_PIXEL1_CLK] = &mdss_0_disp_cc_mdss_dptx0_pixel1_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX0_PIXEL1_CLK_SRC] = &mdss_0_disp_cc_mdss_dptx0_pixel1_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX0_USB_ROUTER_LINK_INTF_CLK] =
		&mdss_0_disp_cc_mdss_dptx0_usb_router_link_intf_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX1_AUX_CLK] = &mdss_0_disp_cc_mdss_dptx1_aux_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX1_AUX_CLK_SRC] = &mdss_0_disp_cc_mdss_dptx1_aux_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX1_CRYPTO_CLK] = &mdss_0_disp_cc_mdss_dptx1_crypto_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX1_LINK_CLK] = &mdss_0_disp_cc_mdss_dptx1_link_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX1_LINK_CLK_SRC] = &mdss_0_disp_cc_mdss_dptx1_link_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX1_LINK_DIV_CLK_SRC] =
		&mdss_0_disp_cc_mdss_dptx1_link_div_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX1_LINK_INTF_CLK] = &mdss_0_disp_cc_mdss_dptx1_link_intf_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX1_PIXEL0_CLK] = &mdss_0_disp_cc_mdss_dptx1_pixel0_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX1_PIXEL0_CLK_SRC] = &mdss_0_disp_cc_mdss_dptx1_pixel0_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX1_PIXEL1_CLK] = &mdss_0_disp_cc_mdss_dptx1_pixel1_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX1_PIXEL1_CLK_SRC] = &mdss_0_disp_cc_mdss_dptx1_pixel1_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX1_USB_ROUTER_LINK_INTF_CLK] =
		&mdss_0_disp_cc_mdss_dptx1_usb_router_link_intf_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX2_AUX_CLK] = &mdss_0_disp_cc_mdss_dptx2_aux_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX2_AUX_CLK_SRC] = &mdss_0_disp_cc_mdss_dptx2_aux_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX2_CRYPTO_CLK] = &mdss_0_disp_cc_mdss_dptx2_crypto_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX2_LINK_CLK] = &mdss_0_disp_cc_mdss_dptx2_link_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX2_LINK_CLK_SRC] = &mdss_0_disp_cc_mdss_dptx2_link_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX2_LINK_DIV_CLK_SRC] =
		&mdss_0_disp_cc_mdss_dptx2_link_div_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX2_LINK_INTF_CLK] = &mdss_0_disp_cc_mdss_dptx2_link_intf_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX2_PIXEL0_CLK] = &mdss_0_disp_cc_mdss_dptx2_pixel0_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX2_PIXEL0_CLK_SRC] = &mdss_0_disp_cc_mdss_dptx2_pixel0_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX2_PIXEL1_CLK] = &mdss_0_disp_cc_mdss_dptx2_pixel1_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX2_PIXEL1_CLK_SRC] = &mdss_0_disp_cc_mdss_dptx2_pixel1_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX3_AUX_CLK] = &mdss_0_disp_cc_mdss_dptx3_aux_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX3_AUX_CLK_SRC] = &mdss_0_disp_cc_mdss_dptx3_aux_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX3_CRYPTO_CLK] = &mdss_0_disp_cc_mdss_dptx3_crypto_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX3_LINK_CLK] = &mdss_0_disp_cc_mdss_dptx3_link_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX3_LINK_CLK_SRC] = &mdss_0_disp_cc_mdss_dptx3_link_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX3_LINK_DIV_CLK_SRC] =
		&mdss_0_disp_cc_mdss_dptx3_link_div_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX3_LINK_INTF_CLK] = &mdss_0_disp_cc_mdss_dptx3_link_intf_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX3_PIXEL0_CLK] = &mdss_0_disp_cc_mdss_dptx3_pixel0_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_DPTX3_PIXEL0_CLK_SRC] = &mdss_0_disp_cc_mdss_dptx3_pixel0_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_ESC0_CLK] = &mdss_0_disp_cc_mdss_esc0_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_ESC0_CLK_SRC] = &mdss_0_disp_cc_mdss_esc0_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_ESC1_CLK] = &mdss_0_disp_cc_mdss_esc1_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_ESC1_CLK_SRC] = &mdss_0_disp_cc_mdss_esc1_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_MDP1_CLK] = &mdss_0_disp_cc_mdss_mdp1_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_MDP_CLK] = &mdss_0_disp_cc_mdss_mdp_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_MDP_CLK_SRC] = &mdss_0_disp_cc_mdss_mdp_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_MDP_LUT1_CLK] = &mdss_0_disp_cc_mdss_mdp_lut1_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_MDP_LUT_CLK] = &mdss_0_disp_cc_mdss_mdp_lut_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_NON_GDSC_AHB_CLK] = &mdss_0_disp_cc_mdss_non_gdsc_ahb_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_PCLK0_CLK] = &mdss_0_disp_cc_mdss_pclk0_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_PCLK0_CLK_SRC] = &mdss_0_disp_cc_mdss_pclk0_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_PCLK1_CLK] = &mdss_0_disp_cc_mdss_pclk1_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_PCLK1_CLK_SRC] = &mdss_0_disp_cc_mdss_pclk1_clk_src.clkr,
	[MDSS_0_DISP_CC_MDSS_RSCC_AHB_CLK] = &mdss_0_disp_cc_mdss_rscc_ahb_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_RSCC_VSYNC_CLK] = &mdss_0_disp_cc_mdss_rscc_vsync_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_VSYNC1_CLK] = &mdss_0_disp_cc_mdss_vsync1_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_VSYNC_CLK] = &mdss_0_disp_cc_mdss_vsync_clk.clkr,
	[MDSS_0_DISP_CC_MDSS_VSYNC_CLK_SRC] = &mdss_0_disp_cc_mdss_vsync_clk_src.clkr,
	[MDSS_0_DISP_CC_PLL0] = &mdss_0_disp_cc_pll0.clkr,
	[MDSS_0_DISP_CC_PLL1] = &mdss_0_disp_cc_pll1.clkr,
	[MDSS_0_DISP_CC_SLEEP_CLK_SRC] = &mdss_0_disp_cc_sleep_clk_src.clkr,
	[MDSS_0_DISP_CC_XO_CLK_SRC] = &mdss_0_disp_cc_xo_clk_src.clkr,
};

static const struct qcom_reset_map disp_cc_0_niobe_resets[] = {
	[MDSS_0_DISP_CC_MDSS_CORE_BCR] = { 0x8000 },
	[MDSS_0_DISP_CC_MDSS_CORE_INT2_BCR] = { 0xa000 },
	[MDSS_0_DISP_CC_MDSS_RSCC_BCR] = { 0xc000 },
};

static const struct regmap_config disp_cc_0_niobe_regmap_config = {
	.reg_bits = 32,
	.reg_stride = 4,
	.val_bits = 32,
...
static struct qcom_cc_desc disp_cc_0_niobe_desc = {
	.config = &disp_cc_0_niobe_regmap_config,
	.clks = disp_cc_0_niobe_clocks,
	.num_clks = ARRAY_SIZE(disp_cc_0_niobe_clocks),
	.resets = disp_cc_0_niobe_resets,
	.num_resets = ARRAY_SIZE(disp_cc_0_niobe_resets),
	.clk_regulators = disp_cc_0_niobe_regulators,
	.num_clk_regulators = ARRAY_SIZE(disp_cc_0_niobe_regulators),
};

static const struct of_device_id disp_cc_0_niobe_match_table[] = {
	{ .compatible = "qcom,niobe-dispcc0" },
	{ }
};
MODULE_DEVICE_TABLE(of, disp_cc_0_niobe_match_table);

static int disp_cc_0_niobe_probe(struct platform_device *pdev)
{
	struct regmap *regmap;
	int ret;

	regmap = qcom_cc_map(pdev, &disp_cc_0_niobe_desc);
	if (IS_ERR(regmap))
		return PTR_ERR(regmap);

	ret = qcom_cc_runtime_init(pdev, &disp_cc_0_niobe_desc);
	if (ret)
		return ret;
	...
	clk_lucid_ole_pll_configure(&mdss_0_disp_cc_pll0, regmap, &mdss_0_disp_cc_pll0_config);
	clk_lucid_ole_pll_configure(&mdss_0_disp_cc_pll1, regmap, &mdss_0_disp_cc_pll1_config);
	...
	ret = qcom_cc_really_probe(pdev, &disp_cc_0_niobe_desc, regmap);
	if (ret) {
...
static void disp_cc_0_niobe_sync_state(struct device *dev)
{
	qcom_cc_sync_state(dev, &disp_cc_0_niobe_desc);
}

static const struct dev_pm_ops disp_cc_0_niobe_pm_ops = {
	SET_RUNTIME_PM_OPS(qcom_cc_runtime_suspend, qcom_cc_runtime_resume, NULL)
	SET_SYSTEM_SLEEP_PM_OPS(pm_runtime_force_suspend,
				pm_runtime_force_resume)
};

static struct platform_driver disp_cc_0_niobe_driver = {
	.probe = disp_cc_0_niobe_probe,
	.driver = {
		.name = "disp_cc_0-niobe",
		.of_match_table = disp_cc_0_niobe_match_table,
		.sync_state = disp_cc_0_niobe_sync_state,
		.pm = &disp_cc_0_niobe_pm_ops,
	},
};

static int __init disp_cc_0_niobe_init(void)
{
	return platform_driver_register(&disp_cc_0_niobe_driver);
}
subsys_initcall(disp_cc_0_niobe_init);

static void __exit disp_cc_0_niobe_exit(void)
{
	platform_driver_unregister(&disp_cc_0_niobe_driver);
}
module_exit(disp_cc_0_niobe_exit);

MODULE_DESCRIPTION("QTI DISP_CC_0 NIOBE Driver");
MODULE_LICENSE("GPL");
