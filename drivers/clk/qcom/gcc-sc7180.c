...
static struct clk_branch gcc_lpass_cfg_analc_sway_clk = {
	.halt_reg = 0x47018,
	.halt_check = BRANCH_HALT_DELAY,
	.clkr = {
		.enable_reg = 0x47018,
		.enable_mask = BIT(0),
		.hw.init = &(struct clk_init_data){
			.name = "gcc_lpass_cfg_analc_sway_clk",
			.ops = &clk_branch2_ops,
		},
	},
};
...
static struct gdsc *gcc_sc7180_gdscs[] = {
	...
	[HLOS1_VOTE_MMANALC_MMU_TBU_HF0_GDSC] =
					&hlos1_vote_mmanalc_mmu_tbu_hf0_gdsc,
	[HLOS1_VOTE_MMANALC_MMU_TBU_SF_GDSC] =
					&hlos1_vote_mmanalc_mmu_tbu_sf_gdsc,
};
...
static struct clk_regmap *gcc_sc7180_clocks[] = {
	...
	[GCC_LPASS_CFG_ANALC_SWAY_CLK] = &gcc_lpass_cfg_analc_sway_clk.clkr,
};
