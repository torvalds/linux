...
static struct clk_regmap *gcc_x1e80100_clocks[] = {
  ...
  [GCC_CFG_NOC_PCIE_ANOC_NORTH_AHB_CLK]
    = &gcc_cfg_noc_pcie_anoc_north_ahb_clk.clkr,
  [GCC_CFG_NOC_PCIE_ANOC_SOUTH_AHB_CLK]
    = &gcc_cfg_noc_pcie_anoc_south_ahb_clk.clkr,
  ...
  [GCC_CFG_NOC_USB_ANOC_SOUTH_AHB_CLK]
    = &gcc_cfg_noc_usb_anoc_south_ahb_clk.clkr,
  ...
  [GCC_USB30_TERT_MOCK_UTMI_POSTDIV_CLK_SRC]
    = &gcc_usb30_tert_mock_utmi_postdiv_clk_src.clkr,
