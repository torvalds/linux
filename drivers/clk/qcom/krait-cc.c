...
static struct clk_hw *krait_add_div(struct device *dev, int id, const char *s,
    unsigned int offset) {
...
static struct clk_hw *krait_add_sec_mux(struct device *dev, int id,
    const char *s,
...
static struct clk_hw *krait_add_pri_mux(struct device *dev,
    struct clk_hw *hfpll_div,
    struct clk_hw *sec_mux,
...
static struct clk_hw *krait_add_clks(struct device *dev, int id,
    bool unique_aux) {
