...
/*
 * Clock ON depends on external parent 'config analc', so cant poll
...
/* XO critical input to camss, so anal need to poll */
...
/* XO critical input to disp, so anal need to poll */
...
/* XO critical input to video, so anal need to poll */
