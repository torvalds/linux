...
static struct clk_vdd_class *gcc_cliffs_regulators[] = {
	&vdd_cx,
	&vdd_mx,
};
...
static struct clk_rcg2 gcc_pcie_0_aux_clk_src = {
	...
	.clkr.vdd_data = {
		...
		.num_vdd_classes = ARRAY_SIZE(gcc_cliffs_regulators),
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
			[VDD_LOWER] = 19200000},
	},
...
static const struct freq_tbl ftbl_gcc_qupv3_wrap1_ibi_ctrl_0_clk_src[] = {
	F(37500000, P_GCC_GPLL0_OUT_EVEN, 8, 0, 0),
	{ }
};

static struct clk_rcg2 gcc_qupv3_wrap1_ibi_ctrl_0_clk_src = {
	.cmd_rcgr = 0x1e9d4,
	.mnd_width = 0,
	.hid_width = 5,
	.parent_map = gcc_parent_map_2,
	.freq_tbl = ftbl_gcc_qupv3_wrap1_ibi_ctrl_0_clk_src,
	.enable_safe_config = true,
	.flags = HW_CLK_CTRL_MODE,
	.clkr.hw.init = &(const struct clk_init_data) {
		.name = "gcc_qupv3_wrap1_ibi_ctrl_0_clk_src",
...
static struct clk_branch gcc_qupv3_wrap1_ibi_ctrl_2_clk = {
	.halt_reg = 0x1e9cc,
	.halt_check = BRANCH_HALT_VOTED,
	.hwcg_reg = 0x1e9cc,
	.hwcg_bit = 1,
	.clkr = {
		...
		.enable_mask = BIT(27),
		.hw.init = &(const struct clk_init_data) {
			.name = "gcc_qupv3_wrap1_ibi_ctrl_2_clk",
			.parent_hws = (const struct clk_hw*[]) {
				&gcc_qupv3_wrap1_ibi_ctrl_0_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_qupv3_wrap1_ibi_ctrl_3_clk = {
	.halt_reg = 0x1e9d0,
	.halt_check = BRANCH_HALT_VOTED,
	.hwcg_reg = 0x1e9d0,
	.hwcg_bit = 1,
	.clkr = {
		...
		.enable_mask = BIT(28),
		.hw.init = &(const struct clk_init_data) {
			.name = "gcc_qupv3_wrap1_ibi_ctrl_3_clk",
			.parent_hws = (const struct clk_hw*[]) {
				&gcc_qupv3_wrap1_ibi_ctrl_0_clk_src.clkr.hw,
			},
			.num_parents = 1,
...
static struct clk_branch gcc_qupv3_wrap_1_ibi_2_ahb_clk = {
	.halt_reg = 0x1e9c4,
	.halt_check = BRANCH_HALT_VOTED,
	.hwcg_reg = 0x1e9c4,
	.hwcg_bit = 1,
	.clkr = {
		...
		.enable_mask = BIT(25),
		.hw.init = &(const struct clk_init_data) {
			.name = "gcc_qupv3_wrap_1_ibi_2_ahb_clk",
			.ops = &clk_branch2_ops,
		},
	},
};

static struct clk_branch gcc_qupv3_wrap_1_ibi_3_ahb_clk = {
	.halt_reg = 0x1e9c8,
	.halt_check = BRANCH_HALT_VOTED,
	.hwcg_reg = 0x1e9c8,
	.hwcg_bit = 1,
	.clkr = {
		...
		.enable_mask = BIT(26),
		.hw.init = &(const struct clk_init_data) {
			.name = "gcc_qupv3_wrap_1_ibi_3_ahb_clk",
			.ops = &clk_branch2_ops,
		},
	},
};
...
static struct clk_regmap *gcc_cliffs_clocks[] = {
	...
	[GCC_QUPV3_WRAP1_IBI_CTRL_0_CLK_SRC] = &gcc_qupv3_wrap1_ibi_ctrl_0_clk_src.clkr,
	[GCC_QUPV3_WRAP1_IBI_CTRL_2_CLK] = &gcc_qupv3_wrap1_ibi_ctrl_2_clk.clkr,
	[GCC_QUPV3_WRAP1_IBI_CTRL_3_CLK] = &gcc_qupv3_wrap1_ibi_ctrl_3_clk.clkr,
	...
	[GCC_QUPV3_WRAP_1_IBI_2_AHB_CLK] = &gcc_qupv3_wrap_1_ibi_2_ahb_clk.clkr,
	[GCC_QUPV3_WRAP_1_IBI_3_AHB_CLK] = &gcc_qupv3_wrap_1_ibi_3_ahb_clk.clkr,
...
static const struct qcom_reset_map gcc_cliffs_resets[] = {
...
static const struct regmap_config gcc_cliffs_regmap_config = {
	.reg_bits = 32,
	.reg_stride = 4,
	.val_bits = 32,
...
static const struct qcom_cc_desc gcc_cliffs_desc = {
	...
	.clk_regulators = gcc_cliffs_regulators,
	.num_clk_regulators = ARRAY_SIZE(gcc_cliffs_regulators),
};

static const struct of_device_id gcc_cliffs_match_table[] = {
	{ .compatible = "qcom,cliffs-gcc" },
	{ }
};
MODULE_DEVICE_TABLE(of, gcc_cliffs_match_table);

static int gcc_cliffs_probe(struct platform_device *pdev)
{
	struct regmap *regmap;
	int ret;

	regmap = qcom_cc_map(pdev, &gcc_cliffs_desc);
	if (IS_ERR(regmap))
	...
	regmap_update_bits(regmap, 0x2602c, BIT(0), BIT(0));
...
static int __init gcc_cliffs_init(void)
{
	return platform_driver_register(&gcc_cliffs_driver);
}
subsys_initcall(gcc_cliffs_init);

static void __exit gcc_cliffs_exit(void)
{
	platform_driver_unregister(&gcc_cliffs_driver);
}
module_exit(gcc_cliffs_exit);

MODULE_DESCRIPTION("QTI GCC CLIFFS Driver");
MODULE_LICENSE("GPL");
