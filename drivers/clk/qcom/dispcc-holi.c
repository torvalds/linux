...
static struct clk_vdd_class *disp_cc_holi_regulators[] = {
	&vdd_cx,
};
...
static const struct qcom_cc_desc disp_cc_holi_desc = {
	...
	.clk_regulators = disp_cc_holi_regulators,
	.num_clk_regulators = ARRAY_SIZE(disp_cc_holi_regulators),
};
