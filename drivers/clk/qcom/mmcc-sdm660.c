...
static const struct parent_map
    mmcc_xo_mmpll0_mmpll4_mmpll7_mmpll8_gpll0_gpll0_div_map[] = {
  { P_XO, 0 },
  { P_MMPLL0, 1 },
  { P_MMPLL4, 2 },
  { P_MMPLL7, 3 },
...
static const struct clk_parent_data
    mmcc_xo_mmpll0_mmpll4_mmpll7_mmpll8_gpll0_gpll0_div[] = {
  { .fw_name = "xo" },
  { .hw = &mmpll0.clkr.hw },
  { .hw = &mmpll4.clkr.hw },
  { .hw = &mmpll7.clkr.hw },
...
static const struct clk_parent_data
    mmcc_xo_mmpll0_mmpll4_mmpll7_mmpll10_gpll0_gpll0_div[] = {
  { .fw_name = "xo" },
  { .hw = &mmpll0.clkr.hw },
  { .hw = &mmpll4.clkr.hw },
  { .hw = &mmpll7.clkr.hw },
...
static const struct clk_parent_data
    mmcc_xo_mmpll4_mmpll7_mmpll10_sleep_gpll0_gpll0_div[] = {
  { .fw_name = "xo" },
  { .hw = &mmpll4.clkr.hw },
  { .hw = &mmpll7.clkr.hw },
  { .hw = &mmpll10.clkr.hw },
...
static const struct clk_parent_data
    mmcc_mmpll0_mmpll4_mmpll7_mmpll10_mmpll6_gpll0[] = {
  { .fw_name = "xo" },
  { .hw = &mmpll0.clkr.hw },
  { .hw = &mmpll4.clkr.hw },
  { .hw = &mmpll7.clkr.hw },
...
static const struct parent_map
    mmcc_xo_mmpll0_mmpll4_mmpll7_mmpll10_gpll0_mmpll6_map[] = {
  { P_XO, 0 },
  { P_MMPLL0, 1 },
  { P_MMPLL4, 2 },
  { P_MMPLL7, 3 },
...
static const struct clk_parent_data
    mmcc_xo_mmpll0_mmpll4_mmpll7_mmpll10_gpll0_mmpll6[] = {
  { .fw_name = "xo" },
  { .hw = &mmpll0.clkr.hw },
  { .hw = &mmpll4.clkr.hw },
  { .hw = &mmpll7.clkr.hw },
...
static struct clk_rcg2 cpp_clk_src = {
  ...
  .clkr.hw.init = &(struct clk_init_data){
    ...
    .num_parents
      = ARRAY_SIZE(mmcc_xo_mmpll0_mmpll4_mmpll7_mmpll10_gpll0_mmpll6),
    .ops = &clk_rcg2_ops,
  },
};
...
static struct clk_branch mdss_byte0_intf_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &mdss_byte0_intf_div_clk.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT | CLK_GET_RATE_NOCACHE,
      .ops = &clk_branch2_ops,
    },
...
static struct clk_branch mdss_byte1_intf_clk = {
  ...
  .clkr = {
    ...
    .hw.init = &(struct clk_init_data){
      ...
      .parent_hws
        = (const struct clk_hw *[]){ &mdss_byte1_intf_div_clk.clkr.hw },
      .num_parents = 1,
      .flags = CLK_SET_RATE_PARENT | CLK_GET_RATE_NOCACHE,
      .ops = &clk_branch2_ops,
    },
