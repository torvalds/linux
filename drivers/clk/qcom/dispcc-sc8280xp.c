...
static struct clk_regmap *disp0_cc_sc8280xp_clocks[] = {
  ...
  [DISP_CC_MDSS_DPTX0_LINK_DIV_CLK_SRC]
    = &disp0_cc_mdss_dptx0_link_div_clk_src.clkr,
  ...
  [DISP_CC_MDSS_DPTX0_PIXEL0_CLK_SRC]
    = &disp0_cc_mdss_dptx0_pixel0_clk_src.clkr,
  [DISP_CC_MDSS_DPTX0_PIXEL1_CLK] = &disp0_cc_mdss_dptx0_pixel1_clk.clkr,
  [DISP_CC_MDSS_DPTX0_PIXEL1_CLK_SRC]
    = &disp0_cc_mdss_dptx0_pixel1_clk_src.clkr,
  [DISP_CC_MDSS_DPTX0_USB_ROUTER_LINK_INTF_CLK]
    = &disp0_cc_mdss_dptx0_usb_router_link_intf_clk.clkr,
  ...
  [DISP_CC_MDSS_DPTX1_LINK_DIV_CLK_SRC]
    = &disp0_cc_mdss_dptx1_link_div_clk_src.clkr,
  ...
  [DISP_CC_MDSS_DPTX1_PIXEL0_CLK_SRC]
    = &disp0_cc_mdss_dptx1_pixel0_clk_src.clkr,
  [DISP_CC_MDSS_DPTX1_PIXEL1_CLK] = &disp0_cc_mdss_dptx1_pixel1_clk.clkr,
  [DISP_CC_MDSS_DPTX1_PIXEL1_CLK_SRC]
    = &disp0_cc_mdss_dptx1_pixel1_clk_src.clkr,
  [DISP_CC_MDSS_DPTX1_USB_ROUTER_LINK_INTF_CLK]
    = &disp0_cc_mdss_dptx1_usb_router_link_intf_clk.clkr,
  ...
  [DISP_CC_MDSS_DPTX2_LINK_DIV_CLK_SRC]
    = &disp0_cc_mdss_dptx2_link_div_clk_src.clkr,
  ...
  [DISP_CC_MDSS_DPTX3_LINK_DIV_CLK_SRC]
    = &disp0_cc_mdss_dptx3_link_div_clk_src.clkr,
  ...
  [DISP_CC_MDSS_DPTX3_PIXEL0_CLK_SRC]
    = &disp0_cc_mdss_dptx3_pixel0_clk_src.clkr,
...
static struct clk_regmap *disp1_cc_sc8280xp_clocks[] = {
  ...
  [DISP_CC_MDSS_DPTX0_LINK_DIV_CLK_SRC]
    = &disp1_cc_mdss_dptx0_link_div_clk_src.clkr,
  ...
  [DISP_CC_MDSS_DPTX0_PIXEL1_CLK_SRC]
    = &disp1_cc_mdss_dptx0_pixel1_clk_src.clkr,
  [DISP_CC_MDSS_DPTX0_USB_ROUTER_LINK_INTF_CLK]
    = &disp1_cc_mdss_dptx0_usb_router_link_intf_clk.clkr,
  ...
  [DISP_CC_MDSS_DPTX1_LINK_DIV_CLK_SRC]
    = &disp1_cc_mdss_dptx1_link_div_clk_src.clkr,
  ...
  [DISP_CC_MDSS_DPTX1_PIXEL0_CLK_SRC]
    = &disp1_cc_mdss_dptx1_pixel0_clk_src.clkr,
  [DISP_CC_MDSS_DPTX1_PIXEL1_CLK] = &disp1_cc_mdss_dptx1_pixel1_clk.clkr,
  [DISP_CC_MDSS_DPTX1_PIXEL1_CLK_SRC]
    = &disp1_cc_mdss_dptx1_pixel1_clk_src.clkr,
  [DISP_CC_MDSS_DPTX1_USB_ROUTER_LINK_INTF_CLK]
    = &disp1_cc_mdss_dptx1_usb_router_link_intf_clk.clkr,
  ...
  [DISP_CC_MDSS_DPTX2_LINK_DIV_CLK_SRC]
    = &disp1_cc_mdss_dptx2_link_div_clk_src.clkr,
  ...
  [DISP_CC_MDSS_DPTX2_PIXEL0_CLK_SRC]
    = &disp1_cc_mdss_dptx2_pixel0_clk_src.clkr,
  [DISP_CC_MDSS_DPTX2_PIXEL1_CLK] = &disp1_cc_mdss_dptx2_pixel1_clk.clkr,
  [DISP_CC_MDSS_DPTX2_PIXEL1_CLK_SRC]
    = &disp1_cc_mdss_dptx2_pixel1_clk_src.clkr,
  ...
  [DISP_CC_MDSS_DPTX3_LINK_DIV_CLK_SRC]
    = &disp1_cc_mdss_dptx3_link_div_clk_src.clkr,
  ...
  [DISP_CC_MDSS_DPTX3_PIXEL0_CLK_SRC]
    = &disp1_cc_mdss_dptx3_pixel0_clk_src.clkr,
...
#define clkr_to_alpha_clk_pll(_clkr) container_of(_clkr, struct clk_alpha_pll, \
    clkr)
...
static int disp_cc_sc8280xp_probe(struct platform_device *pdev) {
  ...
  clk_lucid_pll_configure(clkr_to_alpha_clk_pll(
      desc->clks[DISP_CC_PLL0]), regmap, &disp_cc_pll0_config);
  clk_lucid_pll_configure(clkr_to_alpha_clk_pll(
      desc->clks[DISP_CC_PLL1]), regmap, &disp_cc_pll1_config);
  clk_lucid_pll_configure(clkr_to_alpha_clk_pll(
      desc->clks[DISP_CC_PLL2]), regmap, &disp_cc_pll2_config);
