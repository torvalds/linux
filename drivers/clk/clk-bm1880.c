...
static unsigned long bm1880_pll_rate_calc(u32 regval,
...
static struct clk_hw *bm1880_clk_register_pll(
    struct bm1880_pll_hw_clock *pll_clk,
    void __iomem *sys_base) {
  struct clk_hw *hw;
  int err;
...
static struct clk_hw *bm1880_clk_register_div(
    struct bm1880_div_hw_clock *div_clk,
    void __iomem *sys_base) {
  struct clk_hw *hw;
  int err;
...
static struct clk_hw *bm1880_clk_register_composite(
    struct bm1880_composite_clock *clks,
    void __iomem *sys_base) {
  struct clk_hw *hw;
