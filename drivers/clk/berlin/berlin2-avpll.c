...
static u8 vco_refdiv[] = {
  1, 2, 4, 3
};

static unsigned long berlin2_avpll_vco_recalc_rate(struct clk_hw *hw,
...
static const u8 div_hdmi[] = {
  1, 2, 4, 6
};
static const u8 div_av1[] = {
  1, 2, 5, 5
};

static unsigned long berlin2_avpll_channel_recalc_rate(struct clk_hw *hw,
    unsigned long parent_rate) {
  struct berlin2_avpll_channel *ch = to_avpll_channel(hw);
 ...
 */
static const u8 quirk_index[] __initconst = {
  0, 6, 5, 4, 3, 2, 1, 7
};
