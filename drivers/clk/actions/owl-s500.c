...
#define CMU_DIGITALDE		(0x00D0)
#define CMU_ANALOGDE			(0x00D4)
#define CMU_COREPLLDE		(0x00D8)
#define CMU_DEVPLLDE			(0x00DC)
#define CMU_DDRPLLDE			(0x00E0)
#define CMU_NANDPLLDE		(0x00E4)
#define CMU_DISPLAYPLLDE		(0x00E8)
#define CMU_TVOUTPLLDE		(0x00EC)
#define CMU_DEEPCOLORPLLDE		(0x00F4)
#define CMU_AUDIOPLL_ETHPLLDE	(0x00F8)
#define CMU_CVBSPLLDE		(0x00FC)
