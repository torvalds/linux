...
static void hi3660_clk_iomcu_init(struct device_yesde *np)
{
...
static void hi3660_clk_pmuctrl_init(struct device_yesde *np)
{
	struct hisi_clock_data *clk_data;
...
static void hi3660_clk_pctrl_init(struct device_yesde *np)
{
	struct hisi_clock_data *clk_data;
...
static void hi3660_clk_sctrl_init(struct device_yesde *np)
{
	struct hisi_clock_data *clk_data;
...
static void hi3660_clk_crgctrl_early_init(struct device_yesde *np)
{
...
static void hi3660_clk_crgctrl_init(struct device_yesde *np)
{
	struct clk **clks;
	int i;
