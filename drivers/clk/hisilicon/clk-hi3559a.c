...
static const u32 fmc_mux_table[] = {
  0, 1, 2, 3, 4, 5, 6, 7
};
static const u32 mmc_mux_table[] = {
  0, 1, 2, 3, 4, 5, 6, 7
};
static const u32 sysapb_mux_table[] = {
  0, 1
};
static const u32 sysbus_mux_table[] = {
  0, 1
};
static const u32 uart_mux_table[] = {
  0, 1, 2
};
static const u32 a73_clksel_mux_table[] = {
  0, 1, 2
};
...
static struct hisi_mux_clock hi3559av100_mux_clks_crg[] = {
  ...
  {
    HI3559AV100_A73_MUX, "a73_mux", a73_clksel_mux_p, ARRAY_SIZE(
        a73_clksel_mux_p),
...
/* shub mux clk */
static u32 shub_source_clk_mux_table[] = {
  0, 1, 2, 3
};
...
static u32 shub_uart_source_clk_mux_table[] = {
  0, 1, 2, 3
};
...
/* shub div clk */
static struct clk_div_table shub_spi_clk_table[]
  = {{0, 8}, {1, 4}, {2, 2}, { /*sentinel*/}};
static struct clk_div_table shub_uart_div_clk_table[]
  = {{1, 8}, {2, 4}, { /*sentinel*/}};

static struct hisi_divider_clock hi3559av100_shub_div_clks[] = {
  { HI3559AV100_SHUB_SPI_SOURCE_CLK, "clk_spi_clk", "shub_clk", 0, 0x20, 24, 2,
    CLK_DIVIDER_ALLOW_ZERO, shub_spi_clk_table, },
  { HI3559AV100_SHUB_UART_DIV_CLK, "clk_uart_div_clk", "shub_clk", 0, 0x1c, 28,
    2,
