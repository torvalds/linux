...
static u32 sdio_mux_table[] = {
  0, 1, 2, 3
};

static const char * const fephy_mux_p[] __initconst = {
  "25m", "125m"
};
static u32 fephy_mux_table[] = {
  0, 1
};
...
static void __init hix5hd2_clk_register_complex(
