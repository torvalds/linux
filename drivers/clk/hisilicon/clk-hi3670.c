...
static const struct hisi_gate_clock hi3670_crgctrl_gate_sep_clks[] = {
  ...
  { HI3670_CLK_GATE_VCODECBUS2DDR, "clk_gate_vcodecbus2ddr",
    "clk_div_vcodecbus",
  ...
  { HI3670_CLK_GATE_DP_AUDIO_PLL_AO, "clk_gate_dp_audio_pll_ao",
...
static const char * const
clk_mux_vcodecbus_p[] = {
  "clk_invalid", "clk_ppll4", "clk_ppll0",
...
static const char * const
clk_mux_sd_sys_p[] = {
  "clk_sd_sys", "clk_div_sd",
};
static const char * const
clk_mux_sd_pll_p[] = {
  "clk_ppll0", "clk_ppll3", "clk_ppll2", "clk_ppll2",
};
static const char * const
clk_mux_sdio_sys_p[] = {
  "clk_sdio_sys", "clk_div_sdio",
};
static const char * const
clk_mux_sdio_pll_p[] = {
  "clk_ppll0", "clk_ppll3", "clk_ppll2", "clk_ppll2",
...
static const char * const
clk_mux_uarth_p[] = {
  "clkin_sys", "clk_div_uarth",
};
static const char * const
clk_mux_uartl_p[] = {
  "clkin_sys", "clk_div_uartl",
};
static const char * const
clk_mux_uart0_p[] = {
...
static const char * const
clk_mux_i2c_p[] = {
  "clkin_sys", "clk_div_i2c",
};
static const char * const
clk_mux_spi_p[] = {
  "clkin_sys", "clk_div_spi",
};
static const char * const
clk_mux_pcieaxi_p[] = {
  "clkin_sys", "clk_ppll0",
...
static const char * const
clk_mux_vdec_p[] = {
  "clk_invalid", "clk_ppll4", "clk_ppll0", "clk_invalid",
...
static const char * const
clk_isp_snclk_mux0_p[] = {
  "clkin_sys", "clk_isp_snclk_div0",
};
static const char * const
clk_isp_snclk_mux1_p[] = {
  "clkin_sys", "clk_isp_snclk_div1",
};
static const char * const
clk_isp_snclk_mux2_p[] = {
  "clkin_sys", "clk_isp_snclk_div2",
};
static const char * const
clk_mux_rxdphy_cfg_p[] = {
  "clk_factor_rxdphy", "clkin_sys",
};
static const char * const
clk_mux_ics_p[] = {
  "clk_invalid", "clk_ppll4", "clk_ppll0", "clk_invalid",
...
static const struct hisi_divider_clock hi3670_crgctrl_divider_clks[] = {
  ...
  { HI3670_CLKDIV_DP_AUDIO_PLL_AO, "clkdiv_dp_audio_pll_ao",
...
static const char * const
clk_mux_ufs_subsys_p[] = {
  "clkin_sys", "clk_ppll0",
};
static const char * const
clk_mux_clkout0_p[] = {
  "clkin_ref", "clk_div_clkout0_tcxo",
  "clk_div_clkout0_pll", "clk_div_clkout0_pll",
};
static const char * const
clk_mux_clkout1_p[] = {
  "clkin_ref", "clk_div_clkout1_tcxo",
  "clk_div_clkout1_pll", "clk_div_clkout1_pll",
};
static const char * const
clk_mux_asp_subsys_peri_p[] = {
  "clk_ppll0", "clk_fll_src",
};
static const char * const
clk_mux_asp_pll_p[] = {
  "clk_ppll0", "clk_fll_src", "clk_gate_ao_asp",
  "clk_pciepll_rev",
};
...
static const struct hisi_divider_clock hi3670_sctrl_divider_clks[] = {
  ...
  { HI3670_CLK_ASP_SUBSYS_PERI_DIV, "clk_asp_subsys_peri_div",
...
static const struct hisi_gate_clock hi3670_media1_gate_sep_clks[] = {
  { HI3670_ACLK_GATE_NOC_DSS, "aclk_gate_noc_dss", "aclk_gate_disp_noc_subsys",
    CLK_SET_RATE_PARENT, 0x10, 21, 0, },
  { HI3670_PCLK_GATE_NOC_DSS_CFG, "pclk_gate_noc_dss_cfg",
    "pclk_gate_disp_noc_subsys",
    CLK_SET_RATE_PARENT, 0x10, 22, 0, },
  { HI3670_PCLK_GATE_MMBUF_CFG, "pclk_gate_mmbuf_cfg",
    "pclk_gate_disp_noc_subsys",
    CLK_SET_RATE_PARENT, 0x20, 5, 0, },
  { HI3670_PCLK_GATE_DISP_NOC_SUBSYS, "pclk_gate_disp_noc_subsys",
    "clk_div_sysbus",
    CLK_SET_RATE_PARENT, 0x10, 18, 0, },
  { HI3670_ACLK_GATE_DISP_NOC_SUBSYS, "aclk_gate_disp_noc_subsys",
    "clk_gate_vivobusfreq",
    CLK_SET_RATE_PARENT, 0x10, 17, 0, },
...
static const char * const
clk_mux_vivobus_p[] = {
  "clk_invalid", "clk_invalid", "clk_gate_ppll0_media",
...
static const char * const
clk_mux_ldi0_p[] = {
  "clk_invalid", "clk_gate_ppll7_media",
