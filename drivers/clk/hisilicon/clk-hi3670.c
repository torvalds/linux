...
static const struct hisi_gate_clock hi3670_media1_gate_sep_clks[] = {
	{ HI3670_ACLK_GATE_NOC_DSS, "aclk_gate_yesc_dss", "aclk_gate_disp_yesc_subsys",
	  CLK_SET_RATE_PARENT, 0x10, 21, 0, },
	{ HI3670_PCLK_GATE_NOC_DSS_CFG, "pclk_gate_yesc_dss_cfg", "pclk_gate_disp_yesc_subsys",
	  CLK_SET_RATE_PARENT, 0x10, 22, 0, },
	{ HI3670_PCLK_GATE_MMBUF_CFG, "pclk_gate_mmbuf_cfg", "pclk_gate_disp_yesc_subsys",
	  CLK_SET_RATE_PARENT, 0x20, 5, 0, },
	{ HI3670_PCLK_GATE_DISP_NOC_SUBSYS, "pclk_gate_disp_yesc_subsys", "clk_div_sysbus",
	  CLK_SET_RATE_PARENT, 0x10, 18, 0, },
	{ HI3670_ACLK_GATE_DISP_NOC_SUBSYS, "aclk_gate_disp_yesc_subsys", "clk_gate_vivobusfreq",
	  CLK_SET_RATE_PARENT, 0x10, 17, 0, },
	{ HI3670_PCLK_GATE_DSS, "pclk_gate_dss", "pclk_gate_disp_yesc_subsys",
	  CLK_SET_RATE_PARENT, 0x00, 14, 0, },
	{ HI3670_ACLK_GATE_DSS, "aclk_gate_dss", "aclk_gate_disp_yesc_subsys",
...
static void hi3670_clk_crgctrl_init(struct device_yesde *np)
{
...
static void hi3670_clk_pctrl_init(struct device_yesde *np)
{
	struct hisi_clock_data *clk_data;
...
static void hi3670_clk_pmuctrl_init(struct device_yesde *np)
{
	struct hisi_clock_data *clk_data;
...
static void hi3670_clk_sctrl_init(struct device_yesde *np)
{
	struct hisi_clock_data *clk_data;
...
static void hi3670_clk_iomcu_init(struct device_yesde *np)
{
	struct hisi_clock_data *clk_data;
...
static void hi3670_clk_media1_init(struct device_yesde *np)
{
	struct hisi_clock_data *clk_data;
...
static void hi3670_clk_media2_init(struct device_yesde *np)
{
	struct hisi_clock_data *clk_data;
...
static int hi3670_clk_probe(struct platform_device *pdev)
{
	...
	void (*init_func)(struct device_yesde *np);
