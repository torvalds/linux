...
static void __init of_at91_clk_master_setup(struct device_node *np,
...
static void __init of_at91_clk_periph_setup(struct device_node *np, u8 type) {
  int num;
  u32 id;
  struct clk_hw *hw;
  const char *parent_name;
...
static void __init of_at91_clk_pll_setup(struct device_node *np,
...
static void __init of_at91_clk_prog_setup(struct device_node *np,
