...
static struct clk_hw *__init at91_clk_register_master_internal(
    struct regmap *regmap,
...
struct clk_hw *__init at91_clk_register_master_pres(struct regmap *regmap,
    const char *name, int num_parents,
    const char **parent_names,
    struct clk_hw **parent_hws,
    const struct clk_master_layout *layout,
...
struct clk_hw *__init at91_clk_register_master_div(struct regmap *regmap,
...
static unsigned long clk_sama7g5_master_recalc_rate(struct clk_hw *hw,
    unsigned long parent_rate) {
  struct clk_master *master = to_clk_master(hw);
...
struct clk_hw *__init at91_clk_sama7g5_register_master(struct regmap *regmap,
    const char *name, int num_parents,
    const char **parent_names,
    struct clk_hw **parent_hws,
    u32 *mux_table,
