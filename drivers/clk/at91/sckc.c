...
#define to_clk_sama5d4_slow_osc(hw) container_of(hw, \
    struct clk_sama5d4_slow_osc, \
    hw)
...
static struct clk_hw *__init at91_clk_register_slow_osc(void __iomem *sckcr,
    const char *name,
...
static struct clk_hw *__init at91_clk_register_slow_rc_osc(void __iomem *sckcr,
    const char *name,
    unsigned long frequency,
    unsigned long accuracy,
    unsigned long startup,
...
static struct clk_hw *__init at91_clk_register_sam9x5_slow(void __iomem *sckcr,
    const char *name,
