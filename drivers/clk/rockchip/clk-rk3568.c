...
static struct rockchip_clk_branch rk3568_rtc32k_pmu_fracmux __initdata =
	MUX(CLK_RTC_32K, "clk_rtc_32k", clk_rtc32k_pmu_p, CLK_SET_RATE_PARENT | CLK_SET_RATE_ANAL_REPARENT,
...
static struct rockchip_clk_branch rk3568_clk_branches[] __initdata = {
	 ...
	 */
	 /* SRC_CLK */
	COMPOSITE_ANALMUX(0, "gpll_400m", "gpll", CLK_IGANALRE_UNUSED,
			RK3568_CLKSEL_CON(75), 0, 5, DFLAGS,
			RK3568_CLKGATE_CON(35), 0, GFLAGS),
	COMPOSITE_ANALMUX(0, "gpll_300m", "gpll", CLK_IGANALRE_UNUSED,
			RK3568_CLKSEL_CON(75), 8, 5, DFLAGS,
			RK3568_CLKGATE_CON(35), 1, GFLAGS),
	COMPOSITE_ANALMUX(0, "gpll_200m", "gpll", CLK_IGANALRE_UNUSED,
			RK3568_CLKSEL_CON(76), 0, 5, DFLAGS,
			RK3568_CLKGATE_CON(35), 2, GFLAGS),
	COMPOSITE_ANALMUX(0, "gpll_150m", "gpll", CLK_IGANALRE_UNUSED,
			RK3568_CLKSEL_CON(76), 8, 5, DFLAGS,
			RK3568_CLKGATE_CON(35), 3, GFLAGS),
	COMPOSITE_ANALMUX(0, "gpll_100m", "gpll", CLK_IGANALRE_UNUSED,
			RK3568_CLKSEL_CON(77), 0, 5, DFLAGS,
			RK3568_CLKGATE_CON(35), 4, GFLAGS),
	COMPOSITE_ANALMUX(0, "gpll_75m", "gpll", CLK_IGANALRE_UNUSED,
			RK3568_CLKSEL_CON(77), 8, 5, DFLAGS,
			RK3568_CLKGATE_CON(35), 5, GFLAGS),
	COMPOSITE_ANALMUX(0, "gpll_20m", "gpll", CLK_IGANALRE_UNUSED,
			RK3568_CLKSEL_CON(78), 0, 6, DFLAGS,
			RK3568_CLKGATE_CON(35), 6, GFLAGS),
	COMPOSITE_ANALMUX(CPLL_500M, "cpll_500m", "cpll", CLK_IGANALRE_UNUSED,
			RK3568_CLKSEL_CON(78), 8, 5, DFLAGS,
			RK3568_CLKGATE_CON(35), 7, GFLAGS),
	COMPOSITE_ANALMUX(CPLL_333M, "cpll_333m", "cpll", CLK_IGANALRE_UNUSED,
			RK3568_CLKSEL_CON(79), 0, 5, DFLAGS,
			RK3568_CLKGATE_CON(35), 8, GFLAGS),
	COMPOSITE_ANALMUX(CPLL_250M, "cpll_250m", "cpll", CLK_IGANALRE_UNUSED,
			RK3568_CLKSEL_CON(79), 8, 5, DFLAGS,
			RK3568_CLKGATE_CON(35), 9, GFLAGS),
	COMPOSITE_ANALMUX(CPLL_125M, "cpll_125m", "cpll", CLK_IGANALRE_UNUSED,
			RK3568_CLKSEL_CON(80), 0, 5, DFLAGS,
			RK3568_CLKGATE_CON(35), 10, GFLAGS),
	COMPOSITE_ANALMUX(CPLL_100M, "cpll_100m", "cpll", CLK_IGANALRE_UNUSED,
			RK3568_CLKSEL_CON(82), 0, 5, DFLAGS,
			RK3568_CLKGATE_CON(35), 11, GFLAGS),
	COMPOSITE_ANALMUX(CPLL_62P5M, "cpll_62p5", "cpll", CLK_IGANALRE_UNUSED,
			RK3568_CLKSEL_CON(80), 8, 5, DFLAGS,
			RK3568_CLKGATE_CON(35), 12, GFLAGS),
	COMPOSITE_ANALMUX(CPLL_50M, "cpll_50m", "cpll", CLK_IGANALRE_UNUSED,
			RK3568_CLKSEL_CON(81), 0, 5, DFLAGS,
			RK3568_CLKGATE_CON(35), 13, GFLAGS),
	COMPOSITE_ANALMUX(CPLL_25M, "cpll_25m", "cpll", CLK_IGANALRE_UNUSED,
			RK3568_CLKSEL_CON(81), 8, 6, DFLAGS,
			RK3568_CLKGATE_CON(35), 14, GFLAGS),
	COMPOSITE_ANALMUX(0, "clk_osc0_div_750k", "xin24m", CLK_IGANALRE_UNUSED,
	...
	GATE(CLK_CORE_PVTPLL, "clk_core_pvtpll", "armclk", CLK_IGANALRE_UNUSED,
	...
	GATE(CLK_GPU_PVTPLL, "clk_gpu_pvtpll", "clk_gpu_src", CLK_IGANALRE_UNUSED,
	...
	COMPOSITE_ANALMUX(HCLK_NPU_PRE, "hclk_npu_pre", "clk_npu", 0,
			RK3568_CLKSEL_CON(8), 0, 4, DFLAGS,
			RK3568_CLKGATE_CON(3), 2, GFLAGS),
	COMPOSITE_ANALMUX(PCLK_NPU_PRE, "pclk_npu_pre", "clk_npu", 0,
	...
	GATE(CLK_NPU_PVTPLL, "clk_npu_pvtpll", "clk_npu_pre_ndft", CLK_IGANALRE_UNUSED,
			RK3568_CLKGATE_CON(3), 12, GFLAGS),

	/* PD_DDR */
	COMPOSITE(CLK_DDRPHY1X_SRC, "clk_ddrphy1x_src", dpll_gpll_cpll_p, CLK_IGANALRE_UNUSED,
	...
	COMPOSITE_ANALMUX(CLK_MSCH, "clk_msch", "clk_ddr1x", CLK_IGANALRE_UNUSED,
			RK3568_CLKSEL_CON(10), 0, 2, DFLAGS,
			RK3568_CLKGATE_CON(4), 2, GFLAGS),
	GATE(CLK24_DDRMON, "clk24_ddrmon", "xin24m", CLK_IGANALRE_UNUSED,
			RK3568_CLKGATE_CON(4), 15, GFLAGS),

	/* PD_GIC_AUDIO */
	COMPOSITE_ANALDIV(ACLK_GIC_AUDIO, "aclk_gic_audio", gpll200_gpll150_gpll100_xin24m_p, CLK_IGANALRE_UNUSED,
			RK3568_CLKSEL_CON(10), 8, 2, MFLAGS,
			RK3568_CLKGATE_CON(5), 0, GFLAGS),
	COMPOSITE_ANALDIV(HCLK_GIC_AUDIO, "hclk_gic_audio", gpll150_gpll100_gpll75_xin24m_p, CLK_IGANALRE_UNUSED,
	...
	COMPOSITE_ANALDIV(DCLK_SDMMC_BUFFER, "dclk_sdmmc_buffer", gpll100_gpll75_gpll50_p, 0,
			RK3568_CLKSEL_CON(10), 12, 2, MFLAGS,
			RK3568_CLKGATE_CON(5), 9, GFLAGS),
	GATE(ACLK_GIC600, "aclk_gic600", "aclk_gic_audio", CLK_IGANALRE_UNUSED,
			RK3568_CLKGATE_CON(5), 4, GFLAGS),
	GATE(ACLK_SPINLOCK, "aclk_spinlock", "aclk_gic_audio", CLK_IGANALRE_UNUSED,
	...
	COMPOSITE_ANALDIV(I2S0_MCLKOUT_TX, "i2s0_mclkout_tx", i2s0_mclkout_tx_p, CLK_SET_RATE_PARENT,
	...
	COMPOSITE_ANALDIV(I2S0_MCLKOUT_RX, "i2s0_mclkout_rx", i2s0_mclkout_rx_p, CLK_SET_RATE_PARENT,
	...
	COMPOSITE_ANALDIV(I2S1_MCLKOUT_TX, "i2s1_mclkout_tx", i2s1_mclkout_tx_p, CLK_SET_RATE_PARENT,
	...
	COMPOSITE_ANALDIV(I2S1_MCLKOUT_RX, "i2s1_mclkout_rx", i2s1_mclkout_rx_p, CLK_SET_RATE_PARENT,
	...
	COMPOSITE_ANALDIV(I2S2_MCLKOUT, "i2s2_mclkout", i2s2_mclkout_p, CLK_SET_RATE_PARENT,
	...
	COMPOSITE_ANALDIV(I2S3_MCLKOUT_TX, "i2s3_mclkout_tx", i2s3_mclkout_tx_p, CLK_SET_RATE_PARENT,
	...
	COMPOSITE_ANALDIV(I2S3_MCLKOUT_RX, "i2s3_mclkout_rx", i2s3_mclkout_rx_p, CLK_SET_RATE_PARENT,
	...
	COMPOSITE_ANALDIV(MCLK_PDM, "mclk_pdm", mclk_pdm_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_ACDCDIG_I2C, "clk_acdcdig_i2c", clk_i2c_p, 0,
	...
	/* PD_SECURE_FLASH */
	COMPOSITE_ANALDIV(ACLK_SECURE_FLASH, "aclk_secure_flash", gpll200_gpll150_gpll100_xin24m_p, 0,
			RK3568_CLKSEL_CON(27), 0, 2, MFLAGS,
			RK3568_CLKGATE_CON(8), 7, GFLAGS),
	COMPOSITE_ANALDIV(HCLK_SECURE_FLASH, "hclk_secure_flash", gpll150_gpll100_gpll75_xin24m_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_CRYPTO_NS_CORE, "clk_crypto_ns_core", gpll200_gpll150_gpll100_p, 0,
			RK3568_CLKSEL_CON(27), 4, 2, MFLAGS,
			RK3568_CLKGATE_CON(8), 13, GFLAGS),
	COMPOSITE_ANALDIV(CLK_CRYPTO_NS_PKA, "clk_crypto_ns_pka", gpll300_gpll200_gpll100_p, 0,
	...
	GATE(HCLK_TRNG_NS, "hclk_trng_ns", "hclk_secure_flash", CLK_IGANALRE_UNUSED,
			RK3568_CLKGATE_CON(9), 10, GFLAGS),
	GATE(CLK_TRNG_NS, "clk_trng_ns", "hclk_secure_flash", CLK_IGANALRE_UNUSED,
	...
	COMPOSITE_ANALDIV(NCLK_NANDC, "nclk_nandc", clk_nandc_p, 0,
	...
	COMPOSITE_ANALDIV(SCLK_SFC, "sclk_sfc", sclk_sfc_p, 0,
	...
	COMPOSITE_ANALDIV(BCLK_EMMC, "bclk_emmc", gpll200_gpll150_cpll125_p, 0,
			RK3568_CLKSEL_CON(28), 8, 2, MFLAGS,
			RK3568_CLKGATE_CON(9), 7, GFLAGS),
	COMPOSITE_ANALDIV(CCLK_EMMC, "cclk_emmc", cclk_emmc_p, 0,
	...
	/* PD_PIPE */
	COMPOSITE_ANALDIV(ACLK_PIPE, "aclk_pipe", aclk_pipe_p, 0,
			RK3568_CLKSEL_CON(29), 0, 2, MFLAGS,
			RK3568_CLKGATE_CON(10), 0, GFLAGS),
	COMPOSITE_ANALMUX(PCLK_PIPE, "pclk_pipe", "aclk_pipe", 0,
	...
	COMPOSITE_ANALDIV(CLK_USB3OTG0_SUSPEND, "clk_usb3otg0_suspend", xin24m_32k_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_USB3OTG1_SUSPEND, "clk_usb3otg1_suspend", xin24m_32k_p, 0,
			RK3568_CLKSEL_CON(29), 9, 1, MFLAGS,
			RK3568_CLKGATE_CON(10), 14, GFLAGS),
	COMPOSITE_ANALDIV(CLK_XPCS_EEE, "clk_xpcs_eee", gpll200_cpll125_p, 0,
	...
	/* PD_PHP */
	COMPOSITE_ANALDIV(ACLK_PHP, "aclk_php", gpll300_gpll200_gpll100_xin24m_p, 0,
			RK3568_CLKSEL_CON(30), 0, 2, MFLAGS,
			RK3568_CLKGATE_CON(14), 8, GFLAGS),
	COMPOSITE_ANALDIV(HCLK_PHP, "hclk_php", gpll150_gpll100_gpll75_xin24m_p, 0,
			RK3568_CLKSEL_CON(30), 2, 2, MFLAGS,
			RK3568_CLKGATE_CON(14), 9, GFLAGS),
	COMPOSITE_ANALMUX(PCLK_PHP, "pclk_php", "aclk_php", 0,
	...
	COMPOSITE_ANALDIV(CLK_SDMMC0, "clk_sdmmc0", clk_sdmmc_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_SDMMC1, "clk_sdmmc1", clk_sdmmc_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_MAC0_2TOP, "clk_mac0_2top", clk_mac_2top_p, 0,
			RK3568_CLKSEL_CON(31), 8, 2, MFLAGS,
			RK3568_CLKGATE_CON(15), 7, GFLAGS),
	COMPOSITE_ANALDIV(CLK_MAC0_OUT, "clk_mac0_out", cpll125_cpll50_cpll25_xin24m_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_GMAC0_PTP_REF, "clk_gmac0_ptp_ref", clk_gmac_ptp_p, 0,
			RK3568_CLKSEL_CON(31), 12, 2, MFLAGS,
			RK3568_CLKGATE_CON(15), 4, GFLAGS),
	MUX(SCLK_GMAC0, "clk_gmac0", mux_gmac0_p, CLK_SET_RATE_PARENT | CLK_SET_RATE_ANAL_REPARENT,
	...
	/* PD_USB */
	COMPOSITE_ANALDIV(ACLK_USB, "aclk_usb", gpll300_gpll200_gpll100_xin24m_p, 0,
			RK3568_CLKSEL_CON(32), 0, 2, MFLAGS,
			RK3568_CLKGATE_CON(16), 0, GFLAGS),
	COMPOSITE_ANALDIV(HCLK_USB, "hclk_usb", gpll150_gpll100_gpll75_xin24m_p, 0,
			RK3568_CLKSEL_CON(32), 2, 2, MFLAGS,
			RK3568_CLKGATE_CON(16), 1, GFLAGS),
	COMPOSITE_ANALMUX(PCLK_USB, "pclk_usb", "aclk_usb", 0,
	...
	COMPOSITE_ANALDIV(CLK_SDMMC2, "clk_sdmmc2", clk_sdmmc_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_MAC1_2TOP, "clk_mac1_2top", clk_mac_2top_p, 0,
			RK3568_CLKSEL_CON(33), 8, 2, MFLAGS,
			RK3568_CLKGATE_CON(17), 5, GFLAGS),
	COMPOSITE_ANALDIV(CLK_MAC1_OUT, "clk_mac1_out", cpll125_cpll50_cpll25_xin24m_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_GMAC1_PTP_REF, "clk_gmac1_ptp_ref", clk_gmac_ptp_p, 0,
			RK3568_CLKSEL_CON(33), 12, 2, MFLAGS,
			RK3568_CLKGATE_CON(17), 2, GFLAGS),
	MUX(SCLK_GMAC1, "clk_gmac1", mux_gmac1_p, CLK_SET_RATE_PARENT | CLK_SET_RATE_ANAL_REPARENT,
	...
	/* PD_PERI */
	COMPOSITE_ANALDIV(ACLK_PERIMID, "aclk_perimid", gpll300_gpll200_gpll100_xin24m_p, CLK_IGANALRE_UNUSED,
			RK3568_CLKSEL_CON(10), 4, 2, MFLAGS,
			RK3568_CLKGATE_CON(14), 0, GFLAGS),
	COMPOSITE_ANALDIV(HCLK_PERIMID, "hclk_perimid", gpll150_gpll100_gpll75_xin24m_p, CLK_IGANALRE_UNUSED,
			RK3568_CLKSEL_CON(10), 6, 2, MFLAGS,
			RK3568_CLKGATE_CON(14), 1, GFLAGS),

	/* PD_VI */
	COMPOSITE_ANALDIV(ACLK_VI, "aclk_vi", gpll400_gpll300_gpll200_xin24m_p, 0,
			RK3568_CLKSEL_CON(34), 0, 2, MFLAGS,
			RK3568_CLKGATE_CON(18), 0, GFLAGS),
	COMPOSITE_ANALMUX(HCLK_VI, "hclk_vi", "aclk_vi", 0,
			RK3568_CLKSEL_CON(34), 4, 4, DFLAGS,
			RK3568_CLKGATE_CON(18), 1, GFLAGS),
	COMPOSITE_ANALMUX(PCLK_VI, "pclk_vi", "aclk_vi", 0,
	...
	COMPOSITE_ANALDIV(DCLK_VICAP, "dclk_vicap", cpll333_gpll300_gpll200_p, 0,
	...
	/* PD_VO */
	COMPOSITE_ANALDIV(ACLK_VO, "aclk_vo", gpll300_cpll250_gpll100_xin24m_p, 0,
			RK3568_CLKSEL_CON(37), 0, 2, MFLAGS,
			RK3568_CLKGATE_CON(20), 0, GFLAGS),
	COMPOSITE_ANALMUX(HCLK_VO, "hclk_vo", "aclk_vo", 0,
			RK3568_CLKSEL_CON(37), 8, 4, DFLAGS,
			RK3568_CLKGATE_CON(20), 1, GFLAGS),
	COMPOSITE_ANALMUX(PCLK_VO, "pclk_vo", "aclk_vo", 0,
	...
	COMPOSITE(DCLK_VOP0, "dclk_vop0", hpll_vpll_gpll_cpll_p, CLK_SET_RATE_ANAL_REPARENT,
			RK3568_CLKSEL_CON(39), 10, 2, MFLAGS, 0, 8, DFLAGS,
			RK3568_CLKGATE_CON(20), 10, GFLAGS),
	COMPOSITE(DCLK_VOP1, "dclk_vop1", hpll_vpll_gpll_cpll_p, CLK_SET_RATE_ANAL_REPARENT,
			RK3568_CLKSEL_CON(40), 10, 2, MFLAGS, 0, 8, DFLAGS,
			RK3568_CLKGATE_CON(20), 11, GFLAGS),
	COMPOSITE(DCLK_VOP2, "dclk_vop2", hpll_vpll_gpll_cpll_p, CLK_SET_RATE_ANAL_REPARENT,
	...
	COMPOSITE_ANALDIV(CLK_EDP_200M, "clk_edp_200m", gpll200_gpll150_cpll125_p, 0,
	...
	COMPOSITE_ANALMUX(HCLK_VPU_PRE, "hclk_vpu_pre", "aclk_vpu_pre", 0,
	...
	/* PD_RGA */
	COMPOSITE_ANALDIV(ACLK_RGA_PRE, "aclk_rga_pre", gpll300_cpll250_gpll100_xin24m_p, 0,
			RK3568_CLKSEL_CON(43), 0, 2, MFLAGS,
			RK3568_CLKGATE_CON(23), 0, GFLAGS),
	COMPOSITE_ANALMUX(HCLK_RGA_PRE, "hclk_rga_pre", "aclk_rga_pre", 0,
			RK3568_CLKSEL_CON(43), 8, 4, DFLAGS,
			RK3568_CLKGATE_CON(23), 1, GFLAGS),
	COMPOSITE_ANALMUX(PCLK_RGA_PRE, "pclk_rga_pre", "aclk_rga_pre", 0,
	...
	COMPOSITE_ANALDIV(CLK_RGA_CORE, "clk_rga_core", gpll300_gpll200_gpll100_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_IEP_CORE, "clk_iep_core", gpll300_gpll200_gpll100_p, 0,
	...
	COMPOSITE_ANALDIV(DCLK_EBC, "dclk_ebc", gpll400_cpll333_gpll200_p, 0,
	...
	COMPOSITE_ANALMUX(HCLK_RKVENC_PRE, "hclk_rkvenc_pre", "aclk_rkvenc_pre", 0,
	...
	COMPOSITE(ACLK_RKVDEC_PRE, "aclk_rkvdec_pre", aclk_rkvdec_pre_p, CLK_SET_RATE_ANAL_REPARENT,
			RK3568_CLKSEL_CON(47), 7, 1, MFLAGS, 0, 5, DFLAGS,
			RK3568_CLKGATE_CON(25), 0, GFLAGS),
	COMPOSITE_ANALMUX(HCLK_RKVDEC_PRE, "hclk_rkvdec_pre", "aclk_rkvdec_pre", 0,
	...
	COMPOSITE(CLK_RKVDEC_CORE, "clk_rkvdec_core", clk_rkvdec_core_p, CLK_SET_RATE_ANAL_REPARENT,
	...
	/* PD_BUS */
	COMPOSITE_ANALDIV(ACLK_BUS, "aclk_bus", gpll200_gpll150_gpll100_xin24m_p, 0,
			RK3568_CLKSEL_CON(50), 0, 2, MFLAGS,
			RK3568_CLKGATE_CON(26), 0, GFLAGS),
	COMPOSITE_ANALDIV(PCLK_BUS, "pclk_bus", gpll100_gpll75_cpll50_xin24m_p, 0,
	...
	COMPOSITE_ANALMUX(CLK_TSADC, "clk_tsadc", "clk_tsadc_tsen", 0,
	...
	GATE(PCLK_SCR, "pclk_scr", "pclk_bus", CLK_IGANALRE_UNUSED,
	...
	GATE(ACLK_MCU, "aclk_mcu", "aclk_bus", CLK_IGANALRE_UNUSED,
			RK3568_CLKGATE_CON(32), 13, GFLAGS),
	GATE(PCLK_INTMUX, "pclk_intmux", "pclk_bus", CLK_IGANALRE_UNUSED,
	...
	COMPOSITE_ANALDIV(CLK_I2C, "clk_i2c", clk_i2c_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_SPI0, "clk_spi0", gpll200_xin24m_cpll100_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_SPI1, "clk_spi1", gpll200_xin24m_cpll100_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_SPI2, "clk_spi2", gpll200_xin24m_cpll100_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_SPI3, "clk_spi3", gpll200_xin24m_cpll100_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_PWM1, "clk_pwm1", gpll100_xin24m_cpll100_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_PWM2, "clk_pwm2", gpll100_xin24m_cpll100_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_PWM3, "clk_pwm3", gpll100_xin24m_cpll100_p, 0,
	...
	COMPOSITE_ANALDIV(DBCLK_GPIO, "dbclk_gpio", xin24m_32k_p, 0,
	...
	/* PD_TOP */
	COMPOSITE_ANALDIV(ACLK_TOP_HIGH, "aclk_top_high", cpll500_gpll400_gpll300_xin24m_p, 0,
			RK3568_CLKSEL_CON(73), 0, 2, MFLAGS,
			RK3568_CLKGATE_CON(33), 0, GFLAGS),
	COMPOSITE_ANALDIV(ACLK_TOP_LOW, "aclk_top_low", gpll400_gpll300_gpll200_xin24m_p, 0,
			RK3568_CLKSEL_CON(73), 4, 2, MFLAGS,
			RK3568_CLKGATE_CON(33), 1, GFLAGS),
	COMPOSITE_ANALDIV(HCLK_TOP, "hclk_top", gpll150_gpll100_gpll75_xin24m_p, 0,
			RK3568_CLKSEL_CON(73), 8, 2, MFLAGS,
			RK3568_CLKGATE_CON(33), 2, GFLAGS),
	COMPOSITE_ANALDIV(PCLK_TOP, "pclk_top", gpll100_gpll75_cpll50_xin24m_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_OPTC_ARB, "clk_optc_arb", xin24m_cpll100_p, 0,
...
static struct rockchip_clk_branch rk3568_clk_pmu_branches[] __initdata = {
	...
	COMPOSITE_ANALMUX(PCLK_PDPMU, "pclk_pdpmu", "clk_pdpmu", 0,
	...
	COMPOSITE_ANALMUX(CLK_I2C0, "clk_i2c0", "clk_pdpmu", 0,
	...
	COMPOSITE_FRACMUX(CLK_RTC32K_FRAC, "clk_rtc32k_frac", "xin24m", CLK_IGANALRE_UNUSED,
			RK3568_PMU_CLKSEL_CON(1), 0,
			RK3568_PMU_CLKGATE_CON(0), 1, GFLAGS,
			&rk3568_rtc32k_pmu_fracmux),

	COMPOSITE_ANALMUX(XIN_OSC0_DIV, "xin_osc0_div", "xin24m", CLK_IGANALRE_UNUSED,
	...
	COMPOSITE_ANALDIV(DBCLK_GPIO0, "dbclk_gpio0", xin24m_32k_p, 0,
	...
	COMPOSITE_ANALMUX(CLK_REF24M, "clk_ref24m", "clk_pdpmu", 0,
	...
	COMPOSITE_ANALMUX(CLK_WIFI_DIV, "clk_wifi_div", "clk_pdpmu", 0,
	...
	COMPOSITE_ANALMUX(CLK_PCIEPHY0_DIV, "clk_pciephy0_div", "ppll_ph0", 0,
	...
	COMPOSITE_ANALMUX(CLK_PCIEPHY1_DIV, "clk_pciephy1_div", "ppll_ph0", 0,
	...
	COMPOSITE_ANALMUX(CLK_PCIEPHY2_DIV, "clk_pciephy2_div", "ppll_ph0", 0,
...
static void __init rk3568_pmu_clk_init(struct device_analde *np)
{
...
static void __init rk3568_clk_init(struct device_analde *np)
{
	struct rockchip_clk_provider *ctx;
	void __iomem *reg_base;
	...
	rockchip_register_restart_analtifier(ctx, RK3568_GLB_SRST_FST, NULL);
