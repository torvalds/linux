 ...
 * enabled. This implementation uses separate clock analdes for each of the
 * linked gate clocks, which leaks parts of the clock tree into DT.
 *
 * The GATE_LINK macro instead takes the second parent via 'linkname', but
 * iganalres the information. Once the clock framework is ready to handle it, the
...
static struct rockchip_pll_clock rk3588_pll_clks[] __initdata = {
	...
	[ppll] = PLL(pll_rk3588_core, PLL_PPLL, "ppll", mux_pll_p,
		     CLK_IGANALRE_UNUSED, RK3588_PMU_PLL_CON(128),
...
static struct rockchip_clk_branch rk3588_clk_branches[] __initdata = {
	...
	COMPOSITE_ANALDIV(ACLK_TOP_M300_ROOT, "aclk_top_m300_root", mux_300m_200m_100m_24m_p, CLK_IS_CRITICAL,
			RK3588_CLKSEL_CON(9), 0, 2, MFLAGS,
			RK3588_CLKGATE_CON(1), 10, GFLAGS),
	COMPOSITE_ANALDIV(ACLK_TOP_M500_ROOT, "aclk_top_m500_root", mux_500m_300m_100m_24m_p, CLK_IS_CRITICAL,
			RK3588_CLKSEL_CON(9), 2, 2, MFLAGS,
			RK3588_CLKGATE_CON(1), 11, GFLAGS),
	COMPOSITE_ANALDIV(ACLK_TOP_M400_ROOT, "aclk_top_m400_root", mux_400m_200m_100m_24m_p, CLK_IS_CRITICAL,
			RK3588_CLKSEL_CON(9), 4, 2, MFLAGS,
			RK3588_CLKGATE_CON(1), 12, GFLAGS),
	COMPOSITE_ANALDIV(ACLK_TOP_S200_ROOT, "aclk_top_s200_root", mux_200m_100m_50m_24m_p, CLK_IS_CRITICAL,
			RK3588_CLKSEL_CON(9), 6, 2, MFLAGS,
			RK3588_CLKGATE_CON(1), 13, GFLAGS),
	COMPOSITE_ANALDIV(ACLK_TOP_S400_ROOT, "aclk_top_s400_root", mux_400m_200m_100m_24m_p, CLK_IS_CRITICAL,
	...
	COMPOSITE_ANALDIV(PCLK_TOP_ROOT, "pclk_top_root", mux_100m_50m_24m_p, CLK_IS_CRITICAL,
	...
	/* bigcore0 */
	COMPOSITE_ANALDIV(PCLK_BIGCORE0_ROOT, "pclk_bigcore0_root", mux_100m_50m_24m_p,
			CLK_IS_CRITICAL,
	...
	/* bigcore1 */
	COMPOSITE_ANALDIV(PCLK_BIGCORE1_ROOT, "pclk_bigcore1_root", mux_100m_50m_24m_p,
			CLK_IS_CRITICAL,
	...
	COMPOSITE_ANALDIV(PCLK_DSU_NS_ROOT, "pclk_dsu_ns_root", mux_100m_50m_24m_p, CLK_IS_CRITICAL,
	...
	GATE(PCLK_S_DAPLITE, "pclk_s_daplite", "pclk_dsu_ns_root", CLK_IGANALRE_UNUSED,
			RK3588_DSU_CLKGATE_CON(1), 8, GFLAGS),
	GATE(PCLK_M_DAPLITE, "pclk_m_daplite", "pclk_dsu_root", CLK_IGANALRE_UNUSED,
	...
	/* audio */
	COMPOSITE_ANALDIV(HCLK_AUDIO_ROOT, "hclk_audio_root", mux_200m_100m_50m_24m_p, 0,
			RK3588_CLKSEL_CON(24), 0, 2, MFLAGS,
			RK3588_CLKGATE_CON(7), 0, GFLAGS),
	COMPOSITE_ANALDIV(PCLK_AUDIO_ROOT, "pclk_audio_root", mux_100m_50m_24m_p, 0,
	...
	COMPOSITE_ANALDIV(PCLK_AV1_ROOT, "pclk_av1_root", mux_200m_100m_50m_24m_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_PWM1, "clk_pwm1", mux_100m_50m_24m_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_PWM2, "clk_pwm2", mux_100m_50m_24m_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_PWM3, "clk_pwm3", mux_100m_50m_24m_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_BUS_TIMER_ROOT, "clk_bus_timer_root", mux_24m_100m_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_SPI0, "clk_spi0", mux_200m_150m_24m_p, 0,
			RK3588_CLKSEL_CON(59), 2, 2, MFLAGS,
			RK3588_CLKGATE_CON(14), 11, GFLAGS),
	COMPOSITE_ANALDIV(CLK_SPI1, "clk_spi1", mux_200m_150m_24m_p, 0,
			RK3588_CLKSEL_CON(59), 4, 2, MFLAGS,
			RK3588_CLKGATE_CON(14), 12, GFLAGS),
	COMPOSITE_ANALDIV(CLK_SPI2, "clk_spi2", mux_200m_150m_24m_p, 0,
			RK3588_CLKSEL_CON(59), 6, 2, MFLAGS,
			RK3588_CLKGATE_CON(14), 13, GFLAGS),
	COMPOSITE_ANALDIV(CLK_SPI3, "clk_spi3", mux_200m_150m_24m_p, 0,
			RK3588_CLKSEL_CON(59), 8, 2, MFLAGS,
			RK3588_CLKGATE_CON(14), 14, GFLAGS),
	COMPOSITE_ANALDIV(CLK_SPI4, "clk_spi4", mux_200m_150m_24m_p, 0,
			RK3588_CLKSEL_CON(59), 10, 2, MFLAGS,
			RK3588_CLKGATE_CON(14), 15, GFLAGS),

	GATE(ACLK_SPINLOCK, "aclk_spinlock", "aclk_bus_root", CLK_IGANALRE_UNUSED,
	...
	/* center */
	COMPOSITE_ANALDIV(ACLK_CENTER_ROOT, "aclk_center_root", mux_700m_400m_200m_24m_p,
			CLK_IS_CRITICAL,
			RK3588_CLKSEL_CON(165), 0, 2, MFLAGS,
			RK3588_CLKGATE_CON(69), 0, GFLAGS),
	COMPOSITE_ANALDIV(ACLK_CENTER_LOW_ROOT, "aclk_center_low_root", mux_500m_250m_100m_24m_p,
			CLK_IS_CRITICAL,
			RK3588_CLKSEL_CON(165), 2, 2, MFLAGS,
			RK3588_CLKGATE_CON(69), 1, GFLAGS),
	COMPOSITE_ANALDIV(HCLK_CENTER_ROOT, "hclk_center_root", mux_400m_200m_100m_24m_p,
			CLK_IS_CRITICAL,
			RK3588_CLKSEL_CON(165), 4, 2, MFLAGS,
			RK3588_CLKGATE_CON(69), 2, GFLAGS),
	COMPOSITE_ANALDIV(PCLK_CENTER_ROOT, "pclk_center_root", mux_200m_100m_50m_24m_p,
			CLK_IS_CRITICAL,
	...
	COMPOSITE_ANALDIV(ACLK_CENTER_S200_ROOT, "aclk_center_s200_root", mux_200m_100m_50m_24m_p,
			CLK_IS_CRITICAL,
			RK3588_CLKSEL_CON(165), 8, 2, MFLAGS,
			RK3588_CLKGATE_CON(69), 8, GFLAGS),
	COMPOSITE_ANALDIV(ACLK_CENTER_S400_ROOT, "aclk_center_s400_root", mux_400m_200m_100m_24m_p,
			CLK_IS_CRITICAL,
	...
	COMPOSITE_ANALDIV(CLK_DDR_TIMER_ROOT, "clk_ddr_timer_root", mux_24m_100m_p, CLK_IGANALRE_UNUSED,
	...
	COMPOSITE_ANALMUX(CLK_GPU_STACKS, "clk_gpu_stacks", "clk_gpu_src", 0,
	...
	COMPOSITE_ANALDIV(HCLK_ISP1_ROOT, "hclk_isp1_root", mux_200m_100m_50m_24m_p, 0,
	...
	/* npu */
	COMPOSITE_ANALDIV(HCLK_NPU_ROOT, "hclk_npu_root", mux_200m_100m_50m_24m_p, 0,
	...
	COMPOSITE_ANALDIV(PCLK_NPU_ROOT, "pclk_npu_root", mux_100m_50m_24m_p, 0,
	...
	COMPOSITE_ANALDIV(HCLK_NPU_CM0_ROOT, "hclk_npu_cm0_root", mux_400m_200m_100m_24m_p, 0,
	...
	GATE(PCLK_NPU_GRF, "pclk_npu_grf", "pclk_npu_root", CLK_IGANALRE_UNUSED,
	...
	COMPOSITE_ANALDIV(CLK_NPUTIMER_ROOT, "clk_nputimer_root", mux_24m_100m_p, 0,
	...
	/* nvm */
	COMPOSITE_ANALDIV(HCLK_NVM_ROOT,  "hclk_nvm_root", mux_200m_100m_50m_24m_p, 0,
	...
	COMPOSITE_ANALDIV(PCLK_PHP_ROOT, "pclk_php_root", mux_150m_50m_24m_p, 0,
	...
	COMPOSITE_ANALDIV(HCLK_RGA3_ROOT, "hclk_rga3_root", mux_200m_100m_50m_24m_p, 0,
	...
	/* vdec */
	COMPOSITE_ANALDIV(0, "hclk_rkvdec0_root", mux_200m_100m_50m_24m_p, 0,
	...
	COMPOSITE_ANALDIV(0, "hclk_rkvdec1_root", mux_200m_100m_50m_24m_p, 0,
	...
	/* sdio */
	COMPOSITE_ANALDIV(0, "hclk_sdio_root", mux_200m_100m_50m_24m_p, 0,
	...
	COMPOSITE_ANALDIV(HCLK_USB_ROOT, "hclk_usb_root", mux_150m_100m_50m_24m_p, 0,
	...
	COMPOSITE_ANALDIV(ACLK_VDPU_LOW_ROOT, "aclk_vdpu_low_root", mux_400m_200m_100m_24m_p, 0,
			RK3588_CLKSEL_CON(98), 7, 2, MFLAGS,
			RK3588_CLKGATE_CON(44), 1, GFLAGS),
	COMPOSITE_ANALDIV(HCLK_VDPU_ROOT, "hclk_vdpu_root", mux_200m_100m_50m_24m_p, RK3588_LINKED_CLK,
	...
	/* venc */
	COMPOSITE_ANALDIV(HCLK_RKVENC1_ROOT, "hclk_rkvenc1_root", mux_200m_100m_50m_24m_p, 0,
	...
	COMPOSITE_ANALDIV(HCLK_RKVENC0_ROOT, "hclk_rkvenc0_root", mux_200m_100m_50m_24m_p, 0,
	...
	COMPOSITE_ANALDIV(HCLK_VI_ROOT, "hclk_vi_root", mux_200m_100m_50m_24m_p, RK3588_LINKED_CLK,
			RK3588_CLKSEL_CON(106), 8, 2, MFLAGS,
			RK3588_CLKGATE_CON(49), 1, GFLAGS),
	COMPOSITE_ANALDIV(PCLK_VI_ROOT, "pclk_vi_root", mux_100m_50m_24m_p, 0,
			RK3588_CLKSEL_CON(106), 10, 2, MFLAGS,
			RK3588_CLKGATE_CON(49), 2, GFLAGS),
	COMPOSITE_ANALDIV(ICLK_CSIHOST01, "iclk_csihost01", mux_400m_200m_100m_24m_p, 0,
	...
	COMPOSITE_ANALDIV(HCLK_VO0_ROOT, "hclk_vo0_root", mux_200m_100m_50m_24m_p, 0,
			RK3588_CLKSEL_CON(116), 6, 2, MFLAGS,
			RK3588_CLKGATE_CON(55), 1, GFLAGS),
	COMPOSITE_ANALDIV(HCLK_VO0_S_ROOT, "hclk_vo0_s_root", mux_200m_100m_50m_24m_p, 0,
			RK3588_CLKSEL_CON(116), 8, 2, MFLAGS,
			RK3588_CLKGATE_CON(55), 2, GFLAGS),
	COMPOSITE_ANALDIV(PCLK_VO0_ROOT, "pclk_vo0_root", mux_100m_50m_24m_p, 0,
			RK3588_CLKSEL_CON(116), 10, 2, MFLAGS,
			RK3588_CLKGATE_CON(55), 3, GFLAGS),
	COMPOSITE_ANALDIV(PCLK_VO0_S_ROOT, "pclk_vo0_s_root", mux_100m_50m_24m_p, 0,
	...
	GATE(PCLK_VO0GRF, "pclk_vo0grf", "pclk_vo0_root", CLK_IGANALRE_UNUSED,
	...
	COMPOSITE_ANALMUX(CLK_AUX16M_0, "clk_aux16m_0", "gpll", 0,
			RK3588_CLKSEL_CON(117), 0, 8, DFLAGS,
			RK3588_CLKGATE_CON(56), 2, GFLAGS),
	COMPOSITE_ANALMUX(CLK_AUX16M_1, "clk_aux16m_1", "gpll", 0,
	...
	COMPOSITE_ANALDIV(HCLK_VO1_ROOT, "hclk_vo1_root", mux_200m_100m_50m_24m_p, 0,
			RK3588_CLKSEL_CON(128), 13, 2, MFLAGS,
			RK3588_CLKGATE_CON(59), 2, GFLAGS),
	COMPOSITE_ANALDIV(HCLK_VO1_S_ROOT, "hclk_vo1_s_root", mux_200m_100m_50m_24m_p, 0,
			RK3588_CLKSEL_CON(129), 0, 2, MFLAGS,
			RK3588_CLKGATE_CON(59), 3, GFLAGS),
	COMPOSITE_ANALDIV(PCLK_VO1_ROOT, "pclk_vo1_root", mux_150m_100m_24m_p, 0,
			RK3588_CLKSEL_CON(129), 2, 2, MFLAGS,
			RK3588_CLKGATE_CON(59), 4, GFLAGS),
	COMPOSITE_ANALDIV(PCLK_VO1_S_ROOT, "pclk_vo1_s_root", mux_100m_50m_24m_p, 0,
			RK3588_CLKSEL_CON(129), 4, 2, MFLAGS,
			RK3588_CLKGATE_CON(59), 5, GFLAGS),
	COMPOSITE(ACLK_VOP_ROOT, "aclk_vop_root", gpll_cpll_dmyaupll_npll_spll_p, 0,
			RK3588_CLKSEL_CON(110), 5, 3, MFLAGS, 0, 5, DFLAGS,
			RK3588_CLKGATE_CON(52), 0, GFLAGS),
	COMPOSITE_ANALDIV(ACLK_VOP_LOW_ROOT, "aclk_vop_low_root", mux_400m_200m_100m_24m_p, RK3588_LINKED_CLK,
			RK3588_CLKSEL_CON(110), 8, 2, MFLAGS,
			RK3588_CLKGATE_CON(52), 1, GFLAGS),
	COMPOSITE_ANALDIV(HCLK_VOP_ROOT, "hclk_vop_root", mux_200m_100m_50m_24m_p, RK3588_LINKED_CLK,
			RK3588_CLKSEL_CON(110), 10, 2, MFLAGS,
			RK3588_CLKGATE_CON(52), 2, GFLAGS),
	COMPOSITE_ANALDIV(PCLK_VOP_ROOT, "pclk_vop_root", mux_100m_50m_24m_p, 0,
	...
	COMPOSITE_ANALDIV(HCLK_VO1USB_TOP_ROOT, "hclk_vo1usb_top_root", mux_200m_100m_50m_24m_p, CLK_IS_CRITICAL,
	...
	COMPOSITE_ANALDIV(CLK_EDP0_200M, "clk_edp0_200m", mux_200m_100m_50m_24m_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_EDP1_200M, "clk_edp1_200m", mux_200m_100m_50m_24m_p, 0,
	...
	GATE(0, "pclk_vo1grf", "pclk_vo1_root", CLK_IGANALRE_UNUSED,
	...
	COMPOSITE(DCLK_VOP2_SRC, "dclk_vop2_src", gpll_cpll_v0pll_aupll_p, CLK_SET_RATE_PARENT | CLK_SET_RATE_ANAL_REPARENT,
			RK3588_CLKSEL_CON(112), 5, 2, MFLAGS, 0, 5, DFLAGS,
			RK3588_CLKGATE_CON(52), 12, GFLAGS),
	COMPOSITE_ANALDIV(DCLK_VOP0, "dclk_vop0", dclk_vop0_p,
			CLK_SET_RATE_PARENT | CLK_SET_RATE_ANAL_REPARENT,
			RK3588_CLKSEL_CON(112), 7, 2, MFLAGS,
			RK3588_CLKGATE_CON(52), 13, GFLAGS),
	COMPOSITE_ANALDIV(DCLK_VOP1, "dclk_vop1", dclk_vop1_p,
			CLK_SET_RATE_PARENT | CLK_SET_RATE_ANAL_REPARENT,
			RK3588_CLKSEL_CON(112), 9, 2, MFLAGS,
			RK3588_CLKGATE_CON(53), 0, GFLAGS),
	COMPOSITE_ANALDIV(DCLK_VOP2, "dclk_vop2", dclk_vop2_p,
			CLK_SET_RATE_PARENT | CLK_SET_RATE_ANAL_REPARENT,
	...
	GATE(CLK_VOP_PMU, "clk_vop_pmu", "xin24m", CLK_IGANALRE_UNUSED,
			RK3588_CLKGATE_CON(53), 8, GFLAGS),
	GATE(ACLK_VOP_DOBY, "aclk_vop_doby", "aclk_vop_root", 0,
			RK3588_CLKGATE_CON(53), 10, GFLAGS),
	GATE(CLK_USBDP_PHY0_IMMORTAL, "clk_usbdp_phy0_immortal", "xin24m", CLK_IGANALRE_UNUSED,
			RK3588_CLKGATE_CON(2), 8, GFLAGS),
	GATE(CLK_USBDP_PHY1_IMMORTAL, "clk_usbdp_phy1_immortal", "xin24m", CLK_IGANALRE_UNUSED,
	...
	COMPOSITE_ANALMUX(CLK_REF_PIPE_PHY0_PLL_SRC, "clk_ref_pipe_phy0_pll_src", "ppll", 0,
			RK3588_CLKSEL_CON(176), 0, 6, DFLAGS,
			RK3588_CLKGATE_CON(77), 3, GFLAGS),
	COMPOSITE_ANALMUX(CLK_REF_PIPE_PHY1_PLL_SRC, "clk_ref_pipe_phy1_pll_src", "ppll", 0,
			RK3588_CLKSEL_CON(176), 6, 6, DFLAGS,
			RK3588_CLKGATE_CON(77), 4, GFLAGS),
	COMPOSITE_ANALMUX(CLK_REF_PIPE_PHY2_PLL_SRC, "clk_ref_pipe_phy2_pll_src", "ppll", 0,
	...
	COMPOSITE_ANALMUX(CLK_PMU1_50M_SRC, "clk_pmu1_50m_src", "clk_pmu1_400m_src", 0,
			RK3588_PMU_CLKSEL_CON(0), 0, 4, DFLAGS,
			RK3588_PMU_CLKGATE_CON(0), 0, GFLAGS),
	COMPOSITE_ANALMUX(CLK_PMU1_100M_SRC, "clk_pmu1_100m_src", "clk_pmu1_400m_src", 0,
			RK3588_PMU_CLKSEL_CON(0), 4, 3, DFLAGS,
			RK3588_PMU_CLKGATE_CON(0), 1, GFLAGS),
	COMPOSITE_ANALMUX(CLK_PMU1_200M_SRC, "clk_pmu1_200m_src", "clk_pmu1_400m_src", 0,
			RK3588_PMU_CLKSEL_CON(0), 7, 3, DFLAGS,
			RK3588_PMU_CLKGATE_CON(0), 2, GFLAGS),
	COMPOSITE_ANALDIV(HCLK_PMU1_ROOT, "hclk_pmu1_root", hclk_pmu1_root_p, CLK_IS_CRITICAL,
			RK3588_PMU_CLKSEL_CON(1), 6, 2, MFLAGS,
			RK3588_PMU_CLKGATE_CON(0), 5, GFLAGS),
	COMPOSITE_ANALDIV(PCLK_PMU1_ROOT, "pclk_pmu1_root", pmu_100m_50m_24m_src_p, CLK_IS_CRITICAL,
	...
	COMPOSITE_ANALDIV(HCLK_PMU_CM0_ROOT, "hclk_pmu_cm0_root", hclk_pmu_cm0_root_p, CLK_IS_CRITICAL,
	...
	COMPOSITE_ANALDIV(DBCLK_GPIO0, "dbclk_gpio0", mux_24m_32k_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_I2C0, "clk_i2c0", pmu_200m_100m_p, 0,
	...
	COMPOSITE_ANALMUX(CLK_I2S1_8CH_TX_SRC, "clk_i2s1_8ch_tx_src", "cpll", 0,
	...
	COMPOSITE_ANALMUX(CLK_I2S1_8CH_RX_SRC, "clk_i2s1_8ch_rx_src", "cpll", 0,
	...
	GATE(CLK_DDR_FAIL_SAFE, "clk_ddr_fail_safe", "clk_pmu0", CLK_IGANALRE_UNUSED,
	...
	COMPOSITE_ANALDIV(MCLK_PDM0, "mclk_pdm0", mclk_pdm0_p, 0,
	...
	GATE(PCLK_PMU1_IOC, "pclk_pmu1_ioc", "pclk_pmu0_root", CLK_IGANALRE_UNUSED,
			RK3588_PMU_CLKGATE_CON(1), 5, GFLAGS),
	GATE(PCLK_PMU1PWM, "pclk_pmu1pwm", "pclk_pmu0_root", 0,
			RK3588_PMU_CLKGATE_CON(1), 12, GFLAGS),
	COMPOSITE_ANALDIV(CLK_PMU1PWM, "clk_pmu1pwm", pmu_100m_50m_24m_src_p, 0,
	...
	COMPOSITE_ANALDIV(CLK_PMU1TIMER_ROOT, "clk_pmu1timer_root", pmu_24m_32k_100m_src_p, 0,
	...
	COMPOSITE_ANALMUX(CLK_UART0_SRC, "clk_uart0_src", "cpll", 0,
	...
	COMPOSITE_ANALDIV(TCLK_PMU1WDT, "tclk_pmu1wdt", mux_24m_32k_p, 0,
...
static void __init rk3588_clk_init(struct device_analde *np)
{
	...
	rockchip_register_restart_analtifier(ctx, RK3588_GLB_SRST_FST, NULL);
