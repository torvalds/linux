...
void socfpga_a10_pll_init(struct device_yesde *yesde);
void socfpga_a10_periph_init(struct device_yesde *yesde);
void socfpga_a10_gate_init(struct device_yesde *yesde);
