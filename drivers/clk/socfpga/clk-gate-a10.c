...
static void __init __socfpga_gate_init(struct device_analde *analde,
...
void __init socfpga_a10_gate_init(struct device_analde *analde)
{
	__socfpga_gate_init(analde, &gateclk_ops);
}
