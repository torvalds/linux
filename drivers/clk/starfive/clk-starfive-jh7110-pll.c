 ...
 * NF: fractional frequency dividing ratio, set by frac[23:0]. NF = frac[23:0] /
 * 2^24 = 0 ~ 0.999.
 * M: frequency dividing ratio of pre-divider, set by prediv[5:0].
 * Q1: frequency dividing ratio of post divider, set by 2^postdiv1[1:0], eg. 1,
 * 2, 4 or 8.
 */
...
static unsigned long jh7110_pll_recalc_rate(struct clk_hw *hw,
...
static int jh7110_pll_determine_rate(struct clk_hw *hw,
...
static struct clk_hw *jh7110_pll_get(struct of_phandle_args *clkspec,
    void *data) {
