...
static const struct jh71x0_clk_data jh7110_voutclk_data[] = {
  ...
  JH71X0__DIV(JH7110_VOUTCLK_DC8200_PIX, "dc8200_pix", 63,
      JH7110_VOUTCLK_VOUT_SRC),
  ...
  /* dc8200 */
  JH71X0_GATE(JH7110_VOUTCLK_DC8200_AXI, "dc8200_axi", 0,
      JH7110_VOUTCLK_VOUT_TOP_AXI),
  JH71X0_GATE(JH7110_VOUTCLK_DC8200_CORE, "dc8200_core", 0,
      JH7110_VOUTCLK_VOUT_TOP_AXI),
  JH71X0_GATE(JH7110_VOUTCLK_DC8200_AHB, "dc8200_ahb", 0,
      JH7110_VOUTCLK_VOUT_TOP_AHB),
  ...
  JH71X0_GMUX(JH7110_VOUTCLK_DSITX_DPI, "dsiTx_dpi", 0, 2,
      JH7110_VOUTCLK_DC8200_PIX,
      JH7110_VOUTCLK_HDMITX0_PIXELCLK),
  JH71X0_GATE(JH7110_VOUTCLK_DSITX_TXESC, "dsiTx_txesc", 0,
...
static int jh7110_vout_top_rst_init(struct jh71x0_clk_priv *priv) {
  ...
  if (IS_ERR(top_rst)) {
    return dev_err_probe(priv->dev, PTR_ERR(
        top_rst), "failed to get top reset\n");
  }
