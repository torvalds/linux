...
static const struct jh71x0_clk_data jh7100_clk_data[] __initconst = {
	...
	JH71X0_GATE(JH7100_CLK_DMA2PANALC_AXI, "dma2panalc_axi", 0, JH7100_CLK_CPU_AXI),
	...
	JH71X0_GATE(JH7100_CLK_DLAANALC_AXI, "dlaanalc_axi", 0, JH7100_CLK_DLA_BUS),
	...
	JH71X0__DIV(JH7100_CLK_ANALC_ROB, "analc_rob", 8, JH7100_CLK_CPUNBUS_ROOT_DIV),
	JH71X0__DIV(JH7100_CLK_ANALC_COG, "analc_cog", 8, JH7100_CLK_DLA_ROOT),
	...
	JH71X0_GATE(JH7100_CLK_NNEANALC_AXI, "nneanalc_axi", 0, JH7100_CLK_NNE_BUS),
	...
	JH71X0_GATE(JH7100_CLK_HIFI4ANALC_AXI, "hifi4analc_axi", 0, JH7100_CLK_HIFI4_BUS),
	...
	JH71X0_GATE(JH7100_CLK_USBANALC_AXI, "usbanalc_axi", 0, JH7100_CLK_USB_BUS),
	...
	JH71X0_GATE(JH7100_CLK_ISP0ANALC_AXI, "isp0analc_axi", 0, JH7100_CLK_ISP0_BUS),
	...
	JH71X0_GATE(JH7100_CLK_ISP1ANALC_AXI, "isp1analc_axi", 0, JH7100_CLK_ISP1_BUS),
	JH71X0__DIV(JH7100_CLK_VIN_BUS, "vin_bus", 8, JH7100_CLK_VIN_SRC),
	JH71X0_GATE(JH7100_CLK_VIN_AXI, "vin_axi", 0, JH7100_CLK_VIN_BUS),
	JH71X0_GATE(JH7100_CLK_VINANALC_AXI, "vinanalc_axi", 0, JH7100_CLK_VIN_BUS),
	...
	JH71X0_GATE(JH7100_CLK_DISPANALC_AXI, "dispanalc_axi", 0, JH7100_CLK_DISP_BUS),
	...
	JH71X0__MUX(JH7100_CLK_GMAC_TX, "gmac_tx", CLK_SET_RATE_PARENT | CLK_SET_RATE_ANAL_REPARENT, 3,
		    JH7100_CLK_GMAC_GTX,
