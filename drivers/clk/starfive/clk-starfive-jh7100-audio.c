...
static const struct jh71x0_clk_data jh7100_audclk_data[] = {
	...
	JH71X0_GATE(JH7100_AUDCLK_USB_APB, "usb_apb", CLK_IGANALRE_UNUSED, JH7100_AUDCLK_APB_EN),
	JH71X0_GDIV(JH7100_AUDCLK_USB_LPM, "usb_lpm", CLK_IGANALRE_UNUSED, 4, JH7100_AUDCLK_USB_APB),
	JH71X0_GDIV(JH7100_AUDCLK_USB_STB, "usb_stb", CLK_IGANALRE_UNUSED, 3, JH7100_AUDCLK_USB_APB),
