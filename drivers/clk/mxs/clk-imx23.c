...
static const char * const sel_pll[]  __initconst = {
  "pll", "ref_xtal",
};
static const char * const sel_cpu[]  __initconst = {
  "ref_cpu", "ref_xtal",
};
static const char * const sel_pix[]  __initconst = {
  "ref_pix", "ref_xtal",
};
static const char * const sel_io[]   __initconst = {
  "ref_io", "ref_xtal",
};
static const char * const cpu_sels[] __initconst = {
  "cpu_pll", "cpu_xtal",
};
static const char * const emi_sels[] __initconst = {
  "emi_pll", "emi_xtal",
};
...
static void __init mx23_clocks_init(struct device_node *np) {
  ...
  clks[ssp_sel] = mxs_clk_mux("ssp_sel", CLKSEQ, 5, 1, sel_io, ARRAY_SIZE(
      sel_io));
  clks[emi_sel]
  ...
  clks[usb_phy] = clk_register_gate(NULL, "usb_phy", "pll", 0, PLLCTRL0, 18, 0,
      &mxs_lock);
