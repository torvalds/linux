...
/* FTM counter clock source, yest module clock */
...
static struct clk * __init vf610_get_fixed_clock(
				struct device_yesde *ccm_yesde, const char *name)
{
	struct clk *clk = of_clk_get_by_name(ccm_yesde, name);
...
static void __init vf610_clocks_init(struct device_yesde *ccm_yesde)
{
	...
	clk[VF610_CLK_SXOSC] = vf610_get_fixed_clock(ccm_yesde, "sxosc");
	clk[VF610_CLK_FXOSC] = vf610_get_fixed_clock(ccm_yesde, "fxosc");
	clk[VF610_CLK_AUDIO_EXT] = vf610_get_fixed_clock(ccm_yesde, "audio_ext");
	clk[VF610_CLK_ENET_EXT] = vf610_get_fixed_clock(ccm_yesde, "enet_ext");

	/* Clock source from external clock via LVDs PAD */
	clk[VF610_CLK_ANACLK1] = vf610_get_fixed_clock(ccm_yesde, "anaclk1");

	clk[VF610_CLK_FXOSC_HALF] = imx_clk_fixed_factor("fxosc_half", "fxosc", 1, 2);

	np = of_find_compatible_yesde(NULL, NULL, "fsl,vf610-anatop");
