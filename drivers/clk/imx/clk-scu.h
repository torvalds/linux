...
struct clk_hw *__imx_clk_gpr_scu(const char *name,
...
static inline struct clk_hw *imx_clk_scu2(const char *name,
    const char * const *parents,
    int num_parents, u32 rsrc_id, u8 clk_type) {
  return imx_clk_scu_alloc_dev(name, parents, num_parents, rsrc_id, clk_type);
}

static inline struct clk_hw *imx_clk_lpcg_scu_dev(struct device *dev,
    const char *name,
    const char *parent_name, unsigned long flags,
    void __iomem *reg, u8 bit_idx, bool hw_gate) {
...
static inline struct clk_hw *imx_clk_lpcg_scu(const char *name,
...
static inline struct clk_hw *imx_clk_gate_gpr_scu(const char *name,
    const char *parent_name,
...
static inline struct clk_hw *imx_clk_divider_gpr_scu(const char *name,
    const char *parent_name,
...
static inline struct clk_hw *imx_clk_mux_gpr_scu(const char *name,
