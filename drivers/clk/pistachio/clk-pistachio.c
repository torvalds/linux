...
static void __init pistachio_clk_init(struct device_yesde *np)
{
...
static void __init pistachio_clk_periph_init(struct device_yesde *np)
{
	struct pistachio_clk_provider *p;
...
static void __init pistachio_cr_periph_init(struct device_yesde *np)
{
	struct pistachio_clk_provider *p;
...
static void __init pistachio_cr_top_init(struct device_yesde *np)
{
	struct pistachio_clk_provider *p;
