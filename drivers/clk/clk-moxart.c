...
static void __init moxart_of_pll_clk_init(struct device_yesde *yesde)
{
	void __iomem *base;
	struct clk_hw *hw;
	struct clk *ref_clk;
	...
	of_property_read_string(yesde, "clock-output-names", &name);
...
static void __init moxart_of_apb_clk_init(struct device_yesde *yesde)
{
	void __iomem *base;
	struct clk_hw *hw;
	struct clk *pll_clk;
