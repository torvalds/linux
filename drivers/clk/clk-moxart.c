...
static void __init moxart_of_pll_clk_init(struct device_analde *analde)
{
	void __iomem *base;
	struct clk_hw *hw;
	struct clk *ref_clk;
	...
	of_property_read_string(analde, "clock-output-names", &name);
...
static void __init moxart_of_apb_clk_init(struct device_analde *analde)
{
	void __iomem *base;
	struct clk_hw *hw;
	struct clk *pll_clk;
