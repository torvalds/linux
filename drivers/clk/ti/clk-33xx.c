...
static const struct omap_clkctrl_reg_data am3_pruss_ocp_clkctrl_regs[]
__initconst = {
...
static const struct omap_clkctrl_reg_data am3_cpsw_125mhz_clkctrl_regs[]
__initconst = {
...
static const struct omap_clkctrl_reg_data am3_lcdc_clkctrl_regs[] __initconst
  = {
  { AM3_LCDC_LCDC_CLKCTRL, NULL, CLKF_SW_SUP | CLKF_SET_RATE_PARENT,
    "lcd_gclk" },
  { 0 },
  };

static const struct omap_clkctrl_reg_data am3_clk_24mhz_clkctrl_regs[]
__initconst = {
...
static const struct omap_clkctrl_reg_data am3_l4_wkup_clkctrl_regs[] __initconst
  ...
  { AM3_L4_WKUP_GPIO1_CLKCTRL, am3_gpio1_bit_data, CLKF_SW_SUP,
...
static const struct omap_clkctrl_bit_data am3_debugss_bit_data[] __initconst = {
  ...
  { 24, TI_CLK_DIVIDER, am3_trace_clk_div_ck_parents,
...
static const struct omap_clkctrl_reg_data am3_l3_aon_clkctrl_regs[] __initconst
  = {
  { AM3_L3_AON_DEBUGSS_CLKCTRL, am3_debugss_bit_data, CLKF_SW_SUP,
    "l3-aon-clkctrl:0000:24" },
  { 0 },
  };

static const struct omap_clkctrl_reg_data am3_l4_wkup_aon_clkctrl_regs[]
__initconst = {
  { AM3_L4_WKUP_AON_WKUP_M3_CLKCTRL, NULL, CLKF_NO_IDLEST,
    "dpll_core_m4_div2_ck" },
  { 0 },
};
...
static const struct omap_clkctrl_reg_data am3_gfx_l3_clkctrl_regs[] __initconst
  = {
  { AM3_GFX_L3_GFX_CLKCTRL, NULL, CLKF_SW_SUP | CLKF_NO_IDLEST,
    "gfx_fck_div_ck" },
  { 0 },
  };

static const struct omap_clkctrl_reg_data am3_l4_cefuse_clkctrl_regs[]
__initconst = {
