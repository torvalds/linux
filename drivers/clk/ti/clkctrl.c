...
static int __init _ti_clkctrl_clk_register(
...
static void __init _ti_clkctrl_setup_gate(
    struct omap_clkctrl_provider *provider,
...
static void __init _ti_clkctrl_setup_mux(struct omap_clkctrl_provider *provider,
    struct device_node *node, u16 offset,
    const struct omap_clkctrl_bit_data *data,
    void __iomem *reg, const char *clkctrl_name) {
...
static void __init _ti_clkctrl_setup_div(struct omap_clkctrl_provider *provider,
    struct device_node *node, u16 offset,
    const struct omap_clkctrl_bit_data *data,
    void __iomem *reg, const char *clkctrl_name) {
...
static void __init _ti_clkctrl_setup_subclks(
    struct omap_clkctrl_provider *provider,
