...
static const struct omap_clkctrl_reg_data am4_l4_wkup_aon_clkctrl_regs[]
__initconst = {
  { AM4_L4_WKUP_AON_WKUP_M3_CLKCTRL, NULL, CLKF_SW_SUP | CLKF_NO_IDLEST,
    "sys_clkin_ck" },
  { AM4_L4_WKUP_AON_COUNTER_32K_CLKCTRL, am4_counter_32k_bit_data, CLKF_SW_SUP,
...
static const struct omap_clkctrl_reg_data am4_l4_wkup_clkctrl_regs[] __initconst
  ...
  { AM4_L4_WKUP_UART1_CLKCTRL, NULL, CLKF_SW_SUP,
  ...
  { AM4_L4_WKUP_GPIO1_CLKCTRL, am4_gpio1_bit_data, CLKF_SW_SUP,
    "sys_clkin_ck" },
  { 0 },
  };
...
static const struct omap_clkctrl_reg_data am4_gfx_l3_clkctrl_regs[] __initconst
  = {
  { AM4_GFX_L3_GFX_CLKCTRL, NULL, CLKF_SW_SUP | CLKF_NO_IDLEST,
    "gfx_fck_div_ck" },
  { 0 },
  };
...
static const struct omap_clkctrl_reg_data am4_l3s_clkctrl_regs[] __initconst = {
  ...
  { AM4_L3S_USB_OTG_SS0_CLKCTRL, am4_usb_otg_ss0_bit_data, CLKF_SW_SUP,
    "l3s_gclk" },
  { AM4_L3S_USB_OTG_SS1_CLKCTRL, am4_usb_otg_ss1_bit_data, CLKF_SW_SUP,
    "l3s_gclk" },
  { 0 },
};

static const struct omap_clkctrl_reg_data am4_pruss_ocp_clkctrl_regs[]
__initconst = {
...
static const struct omap_clkctrl_reg_data am4_dss_clkctrl_regs[] __initconst = {
  { AM4_DSS_DSS_CORE_CLKCTRL, NULL, CLKF_SW_SUP | CLKF_SET_RATE_PARENT,
    "disp_clk" },
  { 0 },
};

static const struct omap_clkctrl_reg_data am4_cpsw_125mhz_clkctrl_regs[]
__initconst = {
