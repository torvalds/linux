...
static const struct omap_clkctrl_reg_data omap5_dsp_clkctrl_regs[] __initconst
  = {
  { OMAP5_MMU_DSP_CLKCTRL, NULL, CLKF_HW_SUP | CLKF_NO_IDLEST,
    "dpll_iva_h11x2_ck" },
  { 0 },
  };
...
static const struct omap_clkctrl_reg_data omap5_l3main1_clkctrl_regs[]
__initconst = {
...
static const struct omap_clkctrl_reg_data omap5_ipu_clkctrl_regs[] __initconst
  = {
  { OMAP5_MMU_IPU_CLKCTRL, NULL, CLKF_HW_SUP | CLKF_NO_IDLEST,
    "dpll_core_h22x2_ck" },
  { 0 },
  };
...
static const struct omap_clkctrl_reg_data omap5_l3instr_clkctrl_regs[]
__initconst = {
...
static const char * const omap5_usb_host_hs_hsic480m_p3_clk_parents[]
__initconst = {
  "dpll_usb_m2_ck",
  NULL,
};
...
static const struct omap_clkctrl_bit_data omap5_usb_host_hs_bit_data[]
__initconst = {
...
static const struct omap_clkctrl_bit_data omap5_usb_tll_hs_bit_data[]
__initconst = {
...
static const struct omap_clkctrl_bit_data omap5_usb_otg_ss_bit_data[]
__initconst = {
...
__initconst = {
  ...
  { OMAP5_USB_OTG_SS_CLKCTRL, omap5_usb_otg_ss_bit_data, CLKF_HW_SUP,
    "dpll_core_h13x2_ck" },
  { 0 },
};
...
static const struct omap_clkctrl_reg_data omap5_wkupaon_clkctrl_regs[]
__initconst = {
