...
static const struct omap_clkctrl_reg_data omap4_ducati_clkctrl_regs[]
__initconst = {
  { OMAP4_IPU_CLKCTRL, NULL, CLKF_HW_SUP | CLKF_NO_IDLEST,
    "ducati_clk_mux_ck" },
  { 0 },
};

static const struct omap_clkctrl_reg_data omap4_l3_dma_clkctrl_regs[]
__initconst = {
  { OMAP4_DMA_SYSTEM_CLKCTRL, NULL, 0, "l3_div_ck" },
  { 0 },
};

static const struct omap_clkctrl_reg_data omap4_l3_emif_clkctrl_regs[]
__initconst = {
...
static const struct omap_clkctrl_reg_data omap4_l4_cfg_clkctrl_regs[]
__initconst = {
...
static const struct omap_clkctrl_reg_data omap4_l3_instr_clkctrl_regs[]
__initconst = {
...
static const char * const omap4_usb_host_hs_hsic480m_p1_clk_parents[]
__initconst = {
  "dpll_usb_m2_ck",
  NULL,
};
...
static const struct omap_clkctrl_bit_data omap4_usb_host_hs_bit_data[]
__initconst = {
...
static const struct omap_clkctrl_bit_data omap4_usb_otg_hs_bit_data[]
__initconst = {
...
static const struct omap_clkctrl_bit_data omap4_usb_tll_hs_bit_data[]
__initconst = {
...
static const struct omap_clkctrl_bit_data omap4_ocp2scp_usb_phy_bit_data[]
__initconst = {
...
__initconst = {
  ...
  { OMAP4_OCP2SCP_USB_PHY_CLKCTRL, omap4_ocp2scp_usb_phy_bit_data, CLKF_HW_SUP,
    "l3-init-clkctrl:00c0:8" },
  { 0 },
};
...
static const struct omap_clkctrl_reg_data omap4_l4_wkup_clkctrl_regs[]
__initconst = {
...
static const struct omap_clkctrl_div_data omap4_trace_clk_div_div_ck_data
    __initconst = {
...
static const struct omap_clkctrl_bit_data omap4_debugss_bit_data[] __initconst
  ...
  { 24, TI_CLK_DIVIDER, omap4_trace_clk_div_div_ck_parents,
    &omap4_trace_clk_div_div_ck_data },
  { 27, TI_CLK_DIVIDER, omap4_stm_clk_div_ck_parents,
    &omap4_stm_clk_div_ck_data },
  { 0 },
  };

static const struct omap_clkctrl_reg_data omap4_emu_sys_clkctrl_regs[]
__initconst = {
