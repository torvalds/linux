...
static void __init dove_clk_init(struct device_yesde *np)
{
	struct device_yesde *cgnp =
		of_find_compatible_yesde(NULL, NULL, "marvell,dove-gating-clock");
	struct device_yesde *ddnp =
		of_find_compatible_yesde(NULL, NULL, "marvell,dove-divider-clock");
