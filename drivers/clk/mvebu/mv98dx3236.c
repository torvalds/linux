...
{
	/* Tclk = 200MHz, yes SaR dependency */
	return 200000000;
}
...
static void __init mv98dx3236_clk_init(struct device_yesde *np)
{
	struct device_yesde *cgnp =
		of_find_compatible_yesde(NULL, NULL, "marvell,mv98dx3236-gating-clock");
