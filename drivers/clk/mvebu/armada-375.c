 ...
 * all modified at the same time, and yest separately as for the Armada
...
static void __init armada_375_coreclk_init(struct device_yesde *np)
{
...
static void __init armada_375_clk_gating_init(struct device_yesde *np)
{
