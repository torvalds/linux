...
static u32 __init axp_get_cpu_freq(void __iomem *sar)
{
	...
	/*
	 * The upper bit is yest contiguous to the other ones and
...
static void __init axp_clk_init(struct device_yesde *np)
{
	struct device_yesde *cgnp =
		of_find_compatible_yesde(NULL, NULL, "marvell,armada-xp-gating-clock");
