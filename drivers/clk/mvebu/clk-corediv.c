 ...
 * details may differ from one SoC to ayesther. This structure is
...
/*
 * Description of the core divider clocks available. For yesw, we
...
static void __init
mvebu_corediv_clk_init(struct device_yesde *yesde,
		       const struct clk_corediv_soc_desc *soc_desc)
{
...
static void __init armada370_corediv_clk_init(struct device_yesde *yesde)
{
	return mvebu_corediv_clk_init(yesde, &armada370_corediv_soc);
}
CLK_OF_DECLARE(armada370_corediv_clk, "marvell,armada-370-corediv-clock",
	       armada370_corediv_clk_init);

static void __init armada375_corediv_clk_init(struct device_yesde *yesde)
{
	return mvebu_corediv_clk_init(yesde, &armada375_corediv_soc);
}
CLK_OF_DECLARE(armada375_corediv_clk, "marvell,armada-375-corediv-clock",
	       armada375_corediv_clk_init);

static void __init armada380_corediv_clk_init(struct device_yesde *yesde)
{
	return mvebu_corediv_clk_init(yesde, &armada380_corediv_soc);
}
CLK_OF_DECLARE(armada380_corediv_clk, "marvell,armada-380-corediv-clock",
	       armada380_corediv_clk_init);

static void __init mv98dx3236_corediv_clk_init(struct device_yesde *yesde)
{
	return mvebu_corediv_clk_init(yesde, &mv98dx3236_corediv_soc);
}
