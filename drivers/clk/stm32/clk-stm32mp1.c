...
static struct clk_hw *_clk_hw_register_gate(struct device *dev,
    struct clk_hw_onecell_data *clk_data,
    void __iomem *base, spinlock_t *lock,
    const struct clock_config *cfg) {
...
static struct clk_hw *_clk_hw_register_fixed_factor(struct device *dev,
    struct clk_hw_onecell_data *clk_data,
    void __iomem *base, spinlock_t *lock,
    const struct clock_config *cfg) {
...
static struct clk_hw *_clk_hw_register_mux(struct device *dev,
    struct clk_hw_onecell_data *clk_data,
    void __iomem *base, spinlock_t *lock,
    const struct clock_config *cfg) {
...
static struct clk_hw *clk_stm32_register_gate_ops(struct device *dev,
    const char *name,
    const char *parent_name,
    const struct clk_parent_data *parent_data,
    unsigned long flags,
...
static struct clk_hw *clk_stm32_register_composite(struct device *dev,
...
static int clk_divider_rtc_determine_rate(struct clk_hw *hw,
...
static struct clk_hw *_clk_stm32_register_gate(struct device *dev,
    struct clk_hw_onecell_data *clk_data,
    void __iomem *base, spinlock_t *lock,
    const struct clock_config *cfg) {
...
static struct clk_hw *_clk_stm32_register_composite(struct device *dev,
    struct clk_hw_onecell_data *clk_data,
    void __iomem *base, spinlock_t *lock,
    const struct clock_config *cfg) {
...
static int stm32_rcc_clock_init(struct device *dev, void __iomem *base,
  ...
  return of_clk_add_hw_provider(dev_of_node(
