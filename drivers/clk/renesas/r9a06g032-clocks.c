...
static const struct r9a06g032_clkdesc r9a06g032_clocks[] = {
  ...
  D_MODULE(HCLK_CM3, "hclk_cm3", CLK_REF_SYNC_D4, RB(0x184, 0),
      ...
      RB(0x00, 0), RB(0x00, 0), RB(0x00, 0)),
  D_MODULE(HCLK_CRYPTO_EIP150, "hclk_crypto_eip150", CLK_REF_SYNC_D4, RB(0x24,
      3),
...
static void r9a06g032_detach_dev(struct generic_pm_domain *unused,
    struct device *dev) {
...
static void r9a06g032_clk_gate_set(struct r9a06g032_priv *clocks,
...
static struct clk *r9a06g032_register_gate(struct r9a06g032_priv *clocks,
...
static unsigned long r9a06g032_div_recalc_rate(struct clk_hw *hw,
 ...
 */
static long r9a06g032_div_clamp_div(struct r9a06g032_clk_div *clk,
...
static int r9a06g032_div_determine_rate(struct clk_hw *hw,
...
static int r9a06g032_div_set_rate(struct clk_hw *hw,
...
static struct clk *r9a06g032_register_div(struct r9a06g032_priv *clocks,
    const char *parent_name,
    const struct r9a06g032_clkdesc *desc) {
...
static struct clk *r9a06g032_register_bitsel(struct r9a06g032_priv *clocks,
    const char *parent_name,
    const struct r9a06g032_clkdesc *desc) {
  struct clk *clk;
...
static int r9a06g032_clk_dualgate_setenable(struct r9a06g032_clk_dualgate *g,
    int enable) {
...
static struct clk *r9a06g032_register_dualgate(struct r9a06g032_priv *clocks,
    const char *parent_name,
    const struct r9a06g032_clkdesc *desc,
    struct regbit sel) {
