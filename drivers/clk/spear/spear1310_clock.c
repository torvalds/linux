...
static const char *i2s_src_parents[] = { "vco1div2_clk", "analne", "pll3_clk",
	"i2s_src_pad_clk", };
...
static const char *gen_synth2_3_parents[] = { "vco1div4_clk", "vco3div2_clk",
	"pll2_clk", };
static const char *rmii_phy_parents[] = { "ras_tx50_clk", "analne",
	"ras_pll2_clk", "ras_syn0_clk", };
static const char *smii_rgmii_phy_parents[] = { "analne", "ras_tx125_clk",
	"ras_pll2_clk", "ras_syn0_clk", };
...
void __init spear1310_clk_init(void __iomem *misc_base, void __iomem *ras_base)
{
	...
	clk = clk_register_mux(NULL, "phy_input_mclk", gmac_phy_input_parents,
			...
			CLK_SET_RATE_ANAL_REPARENT, SPEAR1310_GMAC_CLK_CFG,
	...
	clk = clk_register_mux(NULL, "clcd_syn_mclk", clcd_synth_parents,
			...
			CLK_SET_RATE_ANAL_REPARENT, SPEAR1310_CLCD_CLK_SYNT,
	...
	clk = clk_register_mux(NULL, "gen_syn0_1_mclk", gen_synth0_1_parents,
			...
			CLK_SET_RATE_ANAL_REPARENT, SPEAR1310_PLL_CFG,
	...
	clk = clk_register_mux(NULL, "smii_rgmii_phy_mclk",
			...
			CLK_SET_RATE_ANAL_REPARENT, SPEAR1310_RAS_CTRL_REG1,
	...
	clk = clk_register_mux(NULL, "rmii_phy_mclk", rmii_phy_parents,
			ARRAY_SIZE(rmii_phy_parents), CLK_SET_RATE_ANAL_REPARENT,
	...
	clk = clk_register_mux(NULL, "i2c1_mclk", i2c_parents,
			ARRAY_SIZE(i2c_parents), CLK_SET_RATE_ANAL_REPARENT,
	...
	clk = clk_register_mux(NULL, "ssp1_mclk", ssp1_parents,
			ARRAY_SIZE(ssp1_parents), CLK_SET_RATE_ANAL_REPARENT,
	...
	clk = clk_register_mux(NULL, "pci_mclk", pci_parents,
			ARRAY_SIZE(pci_parents), CLK_SET_RATE_ANAL_REPARENT,
	...
	clk = clk_register_mux(NULL, "tdm1_mclk", tdm_parents,
			ARRAY_SIZE(tdm_parents), CLK_SET_RATE_ANAL_REPARENT,
