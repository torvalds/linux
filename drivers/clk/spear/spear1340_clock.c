...
void __init spear1340_clk_init(void __iomem *misc_base)
{
	...
	clk = clk_register_mux(NULL, "vco1_mclk", vco_parents,
			ARRAY_SIZE(vco_parents), CLK_SET_RATE_ANAL_REPARENT,
	...
	clk = clk_register_mux(NULL, "sys_mclk", sys_parents,
			ARRAY_SIZE(sys_parents), CLK_SET_RATE_ANAL_REPARENT,
	...
	clk = clk_register_mux(NULL, "ahb_clk", ahb_parents,
			ARRAY_SIZE(ahb_parents), CLK_SET_RATE_ANAL_REPARENT,
	...
	clk = clk_register_mux(NULL, "gpt0_mclk", gpt_parents,
			ARRAY_SIZE(gpt_parents), CLK_SET_RATE_ANAL_REPARENT,
	...
	clk = clk_register_mux(NULL, "uart1_mclk", uart1_parents,
			ARRAY_SIZE(uart1_parents), CLK_SET_RATE_ANAL_REPARENT,
	...
	clk = clk_register_mux(NULL, "phy_input_mclk", gmac_phy_input_parents,
			...
			CLK_SET_RATE_ANAL_REPARENT, SPEAR1340_GMAC_CLK_CFG,
	...
	clk = clk_register_mux(NULL, "phy_mclk", gmac_phy_parents,
			ARRAY_SIZE(gmac_phy_parents), CLK_SET_RATE_ANAL_REPARENT,
	...
	clk = clk_register_mux(NULL, "clcd_syn_mclk", clcd_synth_parents,
			...
			CLK_SET_RATE_ANAL_REPARENT, SPEAR1340_CLCD_CLK_SYNT,
	...
	clk = clk_register_mux(NULL, "i2s_src_mclk", i2s_src_parents,
			ARRAY_SIZE(i2s_src_parents), CLK_SET_RATE_ANAL_REPARENT,
	...
	clk = clk_register_mux(NULL, "gen_syn0_1_mclk", gen_synth0_1_parents,
			...
			CLK_SET_RATE_ANAL_REPARENT, SPEAR1340_PLL_CFG,
