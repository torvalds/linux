...
static struct clk_hw *lgm_clk_register_mux(struct lgm_clk_provider *ctx,
    const struct lgm_clk_branch *list) {
...
static unsigned long lgm_clk_divider_recalc_rate(struct clk_hw *hw,
...
static long lgm_clk_divider_round_rate(struct clk_hw *hw, unsigned long rate,
    unsigned long *prate) {
  struct lgm_clk_divider *divider = to_lgm_clk_divider(hw);
...
static int lgm_clk_divider_set_rate(struct clk_hw *hw, unsigned long rate,
    unsigned long prate) {
  struct lgm_clk_divider *divider = to_lgm_clk_divider(hw);
  int value;
...
static struct clk_hw *lgm_clk_register_divider(struct lgm_clk_provider *ctx,
    const struct lgm_clk_branch *list) {
...
static struct clk_hw *lgm_clk_register_fixed_factor(
...
static struct clk_hw *lgm_clk_register_gate(struct lgm_clk_provider *ctx,
    const struct lgm_clk_branch *list) {
...
static unsigned long lgm_clk_ddiv_recalc_rate(struct clk_hw *hw,
    unsigned long parent_rate) {
...
static int lgm_clk_get_ddiv_val(u32 div, u32 *ddiv1, u32 *ddiv2) {
  u32 idx, temp;
  *ddiv1 = 1;
  *ddiv2 = 1;
...
static int lgm_clk_ddiv_set_rate(struct clk_hw *hw, unsigned long rate,
    unsigned long prate) {
  struct lgm_clk_ddiv *ddiv = to_lgm_clk_ddiv(hw);
  u32 div, ddiv1, ddiv2;
...
static long lgm_clk_ddiv_round_rate(struct clk_hw *hw, unsigned long rate,
    unsigned long *prate) {
  struct lgm_clk_ddiv *ddiv = to_lgm_clk_ddiv(hw);
  u32 div, ddiv1, ddiv2;
  u64 rate64;
