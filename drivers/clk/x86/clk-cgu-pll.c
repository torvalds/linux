 ...
 */
static unsigned long lgm_pll_calc_rate(unsigned long prate, unsigned int mult,
...
static unsigned long lgm_pll_recalc_rate(struct clk_hw *hw,
    unsigned long prate) {
...
static struct clk_hw *lgm_clk_register_pll(struct lgm_clk_provider *ctx,
