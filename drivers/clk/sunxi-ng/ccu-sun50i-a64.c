...
static const char * const ths_parents[] = {
  "osc24M"
};
 ...
 */
static const char * const mmc_default_parents[] = {
...
static const char * const ts_parents[] = {
  "osc24M", "pll-periph0",
};
