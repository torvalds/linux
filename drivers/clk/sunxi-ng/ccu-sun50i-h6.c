...
static const char * const vp9_parents[] = {
...
static const char * const ir_tx_parents[] = {
  "osc32k", "osc24M"
};
...
static SUNXI_CCU_GATE(bus_audio_hub_clk, "bus-audio-hub", "apb1", 0xa6c, BIT(
    0), 0);
...
static SUNXI_CCU_GATE(usb_hsic_12m_clk, "usb-hsic-12M", "osc12M", 0xa7c, BIT(
    27), 0);
...
static const char * const hdmi_cec_parents[] = {
...
static const char * const tcon_tv0_parents[] = {
  "pll-video0",
  "pll-video0-4x",
  "pll-video1",
  "pll-video1-4x"
