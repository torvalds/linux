...
static SUNXI_CCU_MP_DATA_WITH_MUX(psi_ahb_clk, "psi-ahb", psi_ahb_parents,
    0x510,
    0, 2,   /* M */
    8, 2,   /* P */
    24, 2,  /* mux */
...
static SUNXI_CCU_MP_DATA_WITH_MUX_GATE(mmc0_clk, "mmc0", mmc0_mmc1_parents,
    0x830,
    0, 4,  /* M */
    8, 2,  /* P */
    24, 3, /* mux */
...
static SUNXI_CCU_MP_DATA_WITH_MUX_GATE(mmc1_clk, "mmc1", mmc0_mmc1_parents,
    0x834,
    0, 4,  /* M */
    8, 2,  /* P */
    24, 3, /* mux */
...
static SUNXI_CCU_MP_DATA_WITH_MUX_GATE(ir_tx_clk, "ir-tx", ir_tx_ledc_parents,
    0x9c0,
    0, 4,  /* M */
    8, 2,  /* P */
    24, 3, /* mux */
...
static SUNXI_CCU_MP_HW_WITH_MUX_GATE(i2s0_clk, "i2s0", i2s_spdif_tx_parents,
    0xa10,
    0, 5,  /* M */
    8, 2,  /* P */
    24, 3, /* mux */
...
static SUNXI_CCU_MP_HW_WITH_MUX_GATE(i2s1_clk, "i2s1", i2s_spdif_tx_parents,
    0xa14,
    0, 5,  /* M */
    8, 2,  /* P */
    24, 3, /* mux */
...
static SUNXI_CCU_MP_HW_WITH_MUX_GATE(i2s2_clk, "i2s2", i2s_spdif_tx_parents,
    0xa18,
    0, 5,  /* M */
    8, 2,  /* P */
    24, 3, /* mux */
...
static SUNXI_CCU_MP_HW_WITH_MUX_GATE(i2s2_asrc_clk, "i2s2-asrc",
...
static SUNXI_CCU_MP_HW_WITH_MUX_GATE(spdif_tx_clk, "spdif-tx",
...
static SUNXI_CCU_MP_HW_WITH_MUX_GATE(spdif_rx_clk, "spdif-rx", spdif_rx_parents,
    0xa28,
    0, 5,  /* M */
    8, 2,  /* P */
    24, 3, /* mux */
...
static SUNXI_CCU_MP_HW_WITH_MUX_GATE(dmic_clk, "dmic", dmic_codec_parents,
    0xa40,
    0, 5,  /* M */
    8, 2,  /* P */
    24, 3, /* mux */
...
static SUNXI_CCU_MP_HW_WITH_MUX_GATE(audio_dac_clk, "audio-dac",
...
static SUNXI_CCU_MP_HW_WITH_MUX_GATE(audio_adc_clk, "audio-adc",
...
static SUNXI_CCU_MP_HW_WITH_MUX_GATE(tcon_lcd0_clk, "tcon-lcd0",
...
static SUNXI_CCU_MP_HW_WITH_MUX_GATE(tcon_tv_clk, "tcon-tv", tcon_tve_parents,
    0xb80,
    0, 4,  /* M */
    8, 2,  /* P */
    24, 3, /* mux */
...
static SUNXI_CCU_MP_DATA_WITH_MUX_GATE(ledc_clk, "ledc", ir_tx_ledc_parents,
    0xbf0,
    0, 4,  /* M */
    8, 2,  /* P */
    24, 1, /* mux */
...
static SUNXI_CCU_M_DATA_WITH_MUX_GATE(csi_mclk_clk, "csi-mclk",
