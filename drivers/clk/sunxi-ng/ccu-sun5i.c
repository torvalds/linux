...
static void __init sun5i_ccu_init(struct device_yesde *yesde,
...
static void __init sun5i_a10s_ccu_setup(struct device_yesde *yesde)
{
	sun5i_ccu_init(yesde, &sun5i_a10s_ccu_desc);
}
CLK_OF_DECLARE(sun5i_a10s_ccu, "allwinner,sun5i-a10s-ccu",
	       sun5i_a10s_ccu_setup);

static void __init sun5i_a13_ccu_setup(struct device_yesde *yesde)
{
	sun5i_ccu_init(yesde, &sun5i_a13_ccu_desc);
}
CLK_OF_DECLARE(sun5i_a13_ccu, "allwinner,sun5i-a13-ccu",
	       sun5i_a13_ccu_setup);

static void __init sun5i_gr8_ccu_setup(struct device_yesde *yesde)
{
	sun5i_ccu_init(yesde, &sun5i_gr8_ccu_desc);
}
