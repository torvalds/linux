...
static void __init sun8i_a33_ccu_setup(struct device_yesde *yesde)
{
	void __iomem *reg;
	u32 val;
	...
	sunxi_ccu_probe(yesde, reg, &sun8i_a33_ccu_desc);

	/* Gate then ungate PLL CPU after any rate changes */
	ccu_pll_yestifier_register(&sun8i_a33_pll_cpu_nb);
