...
#define AICSR     (0x0008)  /* Application Subsystem Interrupt Control/Status
                             * Register */
...
#define ACCR_DDR_D0CS   (1 << 7)  /* DDR SDRAM clock frequency in D0CS (PXA31x
                                   * only) */

#define ACCR_SMCFS_MASK   (0x7 << 23) /* Static Memory Controller Frequency
                                       * Select */
#define ACCR_SFLFS_MASK   (0x3 << 18) /* Frequency Select for Internal Memory
                                       * Controller */
...
#define ACCR_DMCFS_MASK   (0x3 << 12) /* Dynamic Memory Controller Clock
                                       * Frequency Select */
...
PARENTS(pxa3xx_32Khz_bus) = {
  "osc_32_768khz", "osc_32_768khz"
};
PARENTS(pxa3xx_13MHz_bus) = {
  "osc_13mhz", "osc_13mhz"
};
