...
static inline struct clk_regmap_gate_data *clk_get_regmap_gate_data(
...
static inline struct clk_regmap_div_data *clk_get_regmap_div_data(
    struct clk_regmap *clk) {
...
static inline struct clk_regmap_mux_data *clk_get_regmap_mux_data(
    struct clk_regmap *clk) {
