...
static inline struct meson_clk_phase_data *meson_clk_phase_data(
 ...
 */
static inline struct meson_clk_triphase_data *meson_clk_triphase_data(
    struct clk_regmap *clk) {
 ...
 */
static inline struct meson_sclk_ws_inv_data *meson_sclk_ws_inv_data(
    struct clk_regmap *clk) {
