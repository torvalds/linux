...
static inline unsigned int sprd_pll_read(const struct sprd_pll *pll, u8 index) {
...
static inline void sprd_pll_write(const struct sprd_pll *pll, u8 index,
    u32 msk, u32 val) {
  const struct sprd_clk_common *common = &pll->common;
