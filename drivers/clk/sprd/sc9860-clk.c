...
static const u64 itable1[4] = {
  3, 780000000, 988000000, 1196000000
};

/* TWPLL/MPLL0/MPLL1 */
static const u64 itable2[4] = {
  3, 1638000000, 2080000000, 2600000000UL
};
...
static const char * const ap_apb_parents[] = {
  "ext-26m", "twpll-64m",
...
static const char * const ap_apb_usb3[] = {
  "ext-32k", "twpll-24m"
};
...
static const char * const iis_parents[] = {
  "ext-26m",
  "twpll-128m",
  "twpll-153m6"
};
...
static const char * const aon_apb_parents[] = {
  "rco-25m", "ext-26m",
...
static const char * const aux_parents[] = {
  "ext-32k", "rpll0-26m",
  "rpll1-26m", "ext-26m",
  "cppll-50m", "rco-25m",
  "dpll0-50m", "dpll1-50m",
...
static const char * const sp_ahb_parents[] = {
  "rco-4m", "ext-26m",
  "ext-rco-100m", "twpll-96m",
  "twpll-128m",
  "twpll-153m6"
...
static const char * const sdio_2x_parents[] = {
  "fac-1m", "ext-26m",
...
static const char * const adi_parents[] = {
  "rco-4m", "ext-26m",
  "rco-25m", "twpll-38m4",
  "twpll-51m2"
};
...
static const char * const cm3_uart_parents[] = {
  "rco-4m", "ext-26m",
  "rco-100m", "twpll-48m",
  "twpll-51m2", "twpll-96m",
  "twpll-128m"
...
static const char * const thm_parents[] = {
  "ext-32k", "fac-250k"
};
static SPRD_MUX_CLK(thm_clk, "thm", thm_parents, 0x270,
    0, 1, SC9860_MUX_FLAG);

static const char * const cm3_i2c_parents[] = {
  "rco-4m",
  "ext-26m",
  "rco-100m",
  "twpll-48m",
...
static const char * const cm4_spi_parents[] = {
  "ext-26m", "twpll-96m",
  "rco-100m", "twpll-128m",
  "twpll-153m6", "twpll-192m"
};
...
static const char * const ca53_dap_parents[] = {
  "ext-26m", "rco-4m",
  "rco-100m", "twpll-76m8",
...
static const char * const ca53_ts_parents[] = {
  "ext-32k", "ext-26m",
  "clk-twpll-128m",
  "clk-twpll-153m6"
};
...
static const char * const otg2_ref_parents[] = {
  "twpll-12m", "twpll-24m"
};
static SPRD_MUX_CLK(otg2_ref, "otg2-ref", otg2_ref_parents, 0x2f4,
    0, 1, SC9860_MUX_FLAG);

static const char * const usb3_ref_parents[] = {
...
static const char * const ap_axi_parents[] = {
  "ext-26m", "twpll-76m8",
...
static const u8 mcu_table[] = {
  0, 1, 2, 3, 4, 8
};
static const char * const lit_mcu_parents[] = {
  "ext-26m", "twpll-512m",
  "twpll-768m", "ltepll0",
  "twpll", "mpll0"
};
...
static const char * const big_mcu_parents[] = {
  "ext-26m", "twpll-512m",
  "twpll-768m", "ltepll0",
  "twpll", "mpll1"
};
...
static const char * const vsp_parents[] = {
...
static const char * const dispc_parents[] = {
  "twpll-76m8", "twpll-128m",
  "twpll-256m", "twpll-307m2"
};
...
static SPRD_MUX_CLK(vpp_clk, "vpp", vpp_parents, 0x2c,
    0, 2, SC9860_MUX_FLAG);
static const char * const vsp_26m_parents[] = {
  "ext-26m"
};
...
static SPRD_MUX_CLK(ahb_cam, "ahb-cam", ahb_parents, 0x20,
    0, 2, SC9860_MUX_FLAG);
static const char * const sensor_parents[] = {
  "ext-26m", "twpll-48m",
