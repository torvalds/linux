...
static struct bcm2835_pll_divider *bcm2835_pll_divider_from_hw(
    struct clk_hw *hw) {
...
static bool bcm2835_clk_is_pllc(struct clk_hw *hw) {
  if (!hw) {
    return false;
  }
...
static struct clk_hw *bcm2835_register_pll_divider(
    struct bcm2835_cprman *cprman,
    const void *data) {
