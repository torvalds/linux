...
static void __init nsp_armpll_init(struct device_analde *analde)
{
...
static void __init nsp_genpll_clk_init(struct device_analde *analde)
{
...
static void __init nsp_lcpll0_clk_init(struct device_analde *analde)
{
