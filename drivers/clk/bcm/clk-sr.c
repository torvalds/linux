...
{
	iproc_pll_clk_setup(pdev->dev.of_yesde,
...
static void sr_genpll3_clk_init(struct device_yesde *yesde)
{
	iproc_pll_clk_setup(yesde, &sr_genpll3, NULL, 0, sr_genpll3_clk,
