...
DEFINE_DEBUGFS_ATTRIBUTE(clk_fd_numerator_fops, clk_fd_numerator_get, NULL,
    "%llu\n");
...
DEFINE_DEBUGFS_ATTRIBUTE(clk_fd_denominator_fops, clk_fd_denominator_get, NULL,
    "%llu\n");
...
static void clk_fd_debug_init(struct clk_hw *hw, struct dentry *dentry) {
  ...
  debugfs_create_file("denominator", 0444, dentry, hw,
