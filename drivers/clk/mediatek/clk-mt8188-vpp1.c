...
#define GATE_VPP1_0(_id, _name, _parent, _shift)      \
  GATE_MTK(_id, _name, _parent, &vpp1_0_cg_regs, _shift, \
    &mtk_clk_gate_ops_setclr)

#define GATE_VPP1_1(_id, _name, _parent, _shift)      \
  GATE_MTK(_id, _name, _parent, &vpp1_1_cg_regs, _shift, \
    &mtk_clk_gate_ops_setclr)
...
static const struct mtk_gate vpp1_clks[] = {
  ...
  GATE_VPP1_0(CLK_VPP1_SVPP2_VDO0_DL_RELAY, "vpp1_svpp2_vdo0_dl_relay",
      "top_vpp", 15),
  ...
  GATE_VPP1_0(CLK_VPP1_SVPP3_VDO1_DL_RELAY, "vpp1_svpp3_vdo1_dl_relay",
      "top_vpp", 19),
  ...
  GATE_VPP1_1(CLK_VPP1_SVPP2_VDO1_DL_RELAY, "vpp1_svpp2_vdo1_dl_relay",
      "top_vpp", 8),
  GATE_VPP1_1(CLK_VPP1_SVPP3_VDO0_DL_RELAY, "vpp1_svpp3_vdo0_dl_relay",
      "top_vpp", 9),
