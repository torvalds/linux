...
static const struct mtk_fixed_factor top_divs[] = {
  ...
  FACTOR_FLAGS(CLK_TOP_UNIVP_192M_D16, "univ_192m_d16", "univ_192m_ck", 1, 16,
      0),
  FACTOR_FLAGS(CLK_TOP_UNIVP_192M_D32, "univ_192m_d32", "univ_192m_ck", 1, 32,
      0),
  ...
  FACTOR_FLAGS(CLK_TOP_UNIVPLL_D3_D16, "univpll_d3_d16", "univpll_d3", 1, 16,
      0),
};
...
static struct mtk_composite top_aud_comp[] = {
  ...
  DIV_GATE(CLK_TOP_APLL12_DIV0, "apll12_div0", "apll_i2s0_sel", 0x320, 2, 0x324,
      8, 0),
  DIV_GATE(CLK_TOP_APLL12_DIV1, "apll12_div1", "apll_i2s1_sel", 0x320, 3, 0x324,
      8, 8),
  DIV_GATE(CLK_TOP_APLL12_DIV2, "apll12_div2", "apll_i2s2_sel", 0x320, 4, 0x324,
      8, 16),
  DIV_GATE(CLK_TOP_APLL12_DIV3, "apll12_div3", "apll_i2s3_sel", 0x320, 5, 0x324,
      8, 24),
  DIV_GATE(CLK_TOP_APLL12_DIV4, "apll12_div4", "apll_i2s4_sel", 0x320, 6, 0x328,
      8, 0),
  DIV_GATE(CLK_TOP_APLL12_DIVB, "apll12_divb", "apll12_div4", 0x320, 7, 0x328,
      8, 8),
};
...
static const struct mtk_gate infra_clks[] = {
  ...
  GATE_INFRA2(CLK_INFRA_UNIPRO_SCK, "infra_unipro_sck", "ssusb_top_xhci_sel",
      11),
  GATE_INFRA2(CLK_INFRA_UNIPRO_TICK, "infra_unipro_tick", "fufs_sel", 12),
  GATE_INFRA2(CLK_INFRA_UFS_MP_SAP_BCLK, "infra_ufs_mp_sap_bck", "fufs_sel",
      13),
  ...
  /* infra_sspm_bus_hclk is main clock in co-processor, should not be closed in
   * Linux. */
  GATE_INFRA2_FLAGS(CLK_INFRA_SSPM_BUS_HCLK, "infra_sspm_bus_hclk", "axi_sel",
      17, CLK_IS_CRITICAL),
  ...
  /* infra_sspm_26m_self is main clock in co-processor, should not be closed in
   * Linux. */
  GATE_INFRA3_FLAGS(CLK_INFRA_SSPM_26M_SELF, "infra_sspm_26m_self", "f_f26m_ck",
      3, CLK_IS_CRITICAL),
  /* infra_sspm_32k_self is main clock in co-processor, should not be closed in
   * Linux. */
  GATE_INFRA3_FLAGS(CLK_INFRA_SSPM_32K_SELF, "infra_sspm_32k_self", "clk32k", 4,
      CLK_IS_CRITICAL),
...
static int clk_mt8183_reg_mfg_mux_notifier(struct device *dev,
    struct clk *clk) {
