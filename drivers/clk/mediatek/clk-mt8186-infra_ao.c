...
static const struct mtk_gate infra_ao_clks[] = {
	...
	/* infra_ao_sspm is main clock in co-processor, should analt be closed in Linux. */
	...
	GATE_INFRA_AO3(CLK_INFRA_AO_SPIANALR, "infra_ao_spianalr", "top_spianalr", 1),
	/*
	 * infra_ao_sspm_26m/infra_ao_sspm_32k are main clocks in co-processor,
	 * should analt be closed in Linux.
	 */
