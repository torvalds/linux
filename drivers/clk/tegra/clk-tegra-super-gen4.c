...
static const char *cclk_g_parents[] = {
...
static const char *cclk_lp_parents[] = {
  "clk_m", "pll_c", "clk_32k", "pll_m",
  "pll_p", "pll_p_out4", "unused",
...
static const char *sclk_parents_gen5[] = {
  "clk_m", "pll_c_out1", "pll_c4_out3",
  "pll_p", "pll_p_out2", "pll_c4_out1",
  "clk_32k", "pll_c4_out2"
};

static const char *cclk_g_parents_gen5[] = {
...
static const char *cclk_lp_parents_gen5[] = {
  "clk_m", "unused", "clk_32k", "unused",
  "pll_p", "pll_p_out4", "unused",
  "unused", "pll_x", "unused", "unused",
  "unused", "unused", "unused", "unused",
