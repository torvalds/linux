...
static struct tegra_clk tegra124_clks[tegra_clk_max] __initdata = {
  ...
  [tegra_clk_hda2codec_2x]
    = { .dt_id = TEGRA124_CLK_HDA2CODEC_2X, .present = true },
  ...
  [tegra_clk_hdmi_audio]
    = { .dt_id = TEGRA124_CLK_HDMI_AUDIO, .present = true },
  ...
  [tegra_clk_vi_sensor_8]
    = { .dt_id = TEGRA124_CLK_VI_SENSOR, .present = true },
  ...
  [tegra_clk_pll_c_out1]
    = { .dt_id = TEGRA124_CLK_PLL_C_OUT1, .present = true },
  ...
  [tegra_clk_pll_x_out0]
    = { .dt_id = TEGRA124_CLK_PLL_X_OUT0, .present = true },
  [tegra_clk_pll_re_vco]
    = { .dt_id = TEGRA124_CLK_PLL_RE_VCO, .present = true },
  [tegra_clk_pll_re_out]
    = { .dt_id = TEGRA124_CLK_PLL_RE_OUT, .present = true },
  [tegra_clk_spdif_in_sync]
    = { .dt_id = TEGRA124_CLK_SPDIF_IN_SYNC, .present = true },
  ...
  [tegra_clk_vimclk_sync]
    = { .dt_id = TEGRA124_CLK_VIMCLK_SYNC, .present = true },
  ...
  [tegra_clk_xusb_host_src]
    = { .dt_id = TEGRA124_CLK_XUSB_HOST_SRC, .present = true },
  [tegra_clk_xusb_falcon_src]
    = { .dt_id = TEGRA124_CLK_XUSB_FALCON_SRC, .present = true },
  [tegra_clk_xusb_fs_src]
    = { .dt_id = TEGRA124_CLK_XUSB_FS_SRC, .present = true },
  [tegra_clk_xusb_ss_src]
    = { .dt_id = TEGRA124_CLK_XUSB_SS_SRC, .present = true },
  [tegra_clk_xusb_ss_div2]
    = { .dt_id = TEGRA124_CLK_XUSB_SS_DIV2, .present = true },
  [tegra_clk_xusb_dev_src]
    = { .dt_id = TEGRA124_CLK_XUSB_DEV_SRC, .present = true },
  [tegra_clk_xusb_dev] = { .dt_id = TEGRA124_CLK_XUSB_DEV, .present = true },
  [tegra_clk_xusb_hs_src]
    = { .dt_id = TEGRA124_CLK_XUSB_HS_SRC, .present = true },
  ...
  [tegra_clk_vi_sensor2]
    = { .dt_id = TEGRA124_CLK_VI_SENSOR2, .present = true },
  [tegra_clk_pll_p_out5]
    = { .dt_id = TEGRA124_CLK_PLL_P_OUT5, .present = true },
  ...
  [tegra_clk_audio0_mux]
    = { .dt_id = TEGRA124_CLK_AUDIO0_MUX, .present = true },
  [tegra_clk_audio1_mux]
    = { .dt_id = TEGRA124_CLK_AUDIO1_MUX, .present = true },
  [tegra_clk_audio2_mux]
    = { .dt_id = TEGRA124_CLK_AUDIO2_MUX, .present = true },
  [tegra_clk_audio3_mux]
    = { .dt_id = TEGRA124_CLK_AUDIO3_MUX, .present = true },
  [tegra_clk_audio4_mux]
    = { .dt_id = TEGRA124_CLK_AUDIO4_MUX, .present = true },
