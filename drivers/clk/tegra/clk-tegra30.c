...
static struct tegra_devclk devclks[] = {
  ...
  { .con_id = "fuse_burn", .dev_id = "fuse-tegra",
    .dt_id = TEGRA30_CLK_FUSE_BURN },
  { .con_id = "apbif", .dev_id = "tegra30-ahub", .dt_id = TEGRA30_CLK_APBIF },
  { .con_id = "hda2hdmi", .dev_id = "tegra30-hda",
    .dt_id = TEGRA30_CLK_HDA2HDMI },
  ...
  { .con_id = "spdif_out", .dev_id = "tegra30-spdif",
    .dt_id = TEGRA30_CLK_SPDIF_OUT },
  { .con_id = "spdif_in", .dev_id = "tegra30-spdif",
    .dt_id = TEGRA30_CLK_SPDIF_IN },
  { .con_id = "d_audio", .dev_id = "tegra30-ahub",
    .dt_id = TEGRA30_CLK_D_AUDIO },
  ...
  { .con_id = "hda2codec_2x", .dev_id = "tegra30-hda",
    .dt_id = TEGRA30_CLK_HDA2CODEC_2X },
  ...
  { .con_id = "vi_sensor", .dev_id = "tegra_camera",
    .dt_id = TEGRA30_CLK_VI_SENSOR },
...
static struct tegra_clk tegra30_clks[tegra_clk_max] __initdata = {
  ...
  [tegra_clk_spdif_in_sync]
    = { .dt_id = TEGRA30_CLK_SPDIF_IN_SYNC, .present = true },
  ...
  [tegra_clk_vimclk_sync]
    = { .dt_id = TEGRA30_CLK_VIMCLK_SYNC, .present = true },
  ...
  [tegra_clk_hda2codec_2x]
    = { .dt_id = TEGRA30_CLK_HDA2CODEC_2X, .present = true },
...
static const char *pll_e_parents[] = {
  "pll_ref", "pll_p"
};
...
static const char *mux_pllpcm_clkm[] = {
...
static const char *mux_pllpmdacd2_clkm[] = {
...
static struct tegra_periph_init_data tegra_periph_clk_list[] = {
  TEGRA_INIT_DATA_MUX("spdif_out", spdif_out_parents, CLK_SOURCE_SPDIF_OUT, 10,
      TEGRA_PERIPH_ON_APB, TEGRA30_CLK_SPDIF_OUT),
  TEGRA_INIT_DATA_MUX("d_audio", mux_pllacp_clkm, CLK_SOURCE_D_AUDIO, 106, 0,
      TEGRA30_CLK_D_AUDIO),
  TEGRA_INIT_DATA_MUX("dam0", mux_pllacp_clkm, CLK_SOURCE_DAM0, 108, 0,
      TEGRA30_CLK_DAM0),
  TEGRA_INIT_DATA_MUX("dam1", mux_pllacp_clkm, CLK_SOURCE_DAM1, 109, 0,
      TEGRA30_CLK_DAM1),
  TEGRA_INIT_DATA_MUX("dam2", mux_pllacp_clkm, CLK_SOURCE_DAM2, 110, 0,
      TEGRA30_CLK_DAM2),
  TEGRA_INIT_DATA_INT("3d2", mux_pllmcpa, CLK_SOURCE_3D2, 98, 0,
      TEGRA30_CLK_GR3D2),
  TEGRA_INIT_DATA_INT("se", mux_pllpcm_clkm, CLK_SOURCE_SE, 127, 0,
      TEGRA30_CLK_SE),
  TEGRA_INIT_DATA_MUX8("hdmi", mux_pllpmdacd2_clkm, CLK_SOURCE_HDMI, 51, 0,
      TEGRA30_CLK_HDMI),
  TEGRA_INIT_DATA("pwm", NULL, NULL, pwm_parents, CLK_SOURCE_PWM, 28, 2, 0, 0,
      8, 1, 0, 17, TEGRA_PERIPH_ON_APB, TEGRA30_CLK_PWM),
};

static struct tegra_periph_init_data tegra_periph_nodiv_clk_list[] = {
  TEGRA_INIT_DATA_NODIV("dsib", mux_plld_out0_plld2_out0, CLK_SOURCE_DSIB, 25,
      1, 82, 0, TEGRA30_CLK_DSIB),
};
