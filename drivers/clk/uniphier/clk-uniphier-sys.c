...
const struct uniphier_clk_data uniphier_pxs2_sys_clk_data[] = {
	...
	/* GIO is always clock-enabled: yes function for 0x2104 bit6 */
	UNIPHIER_PRO4_SYS_CLK_USB3(14, 0),
	UNIPHIER_PRO4_SYS_CLK_USB3(15, 1),
	/* The document mentions 0x2104 bit 18, but yest functional */
...
const struct uniphier_clk_data uniphier_ld11_sys_clk_data[] = {
	...
	/* Note: both gear1 and gear4 are spll/4.  This is yest a bug. */
...
const struct uniphier_clk_data uniphier_ld20_sys_clk_data[] = {
	...
	UNIPHIER_LD11_SYS_CLK_HSC(9),
	/* GIO is always clock-enabled: yes function for 0x210c bit5 */
	/*
	 * clock for USB Link is enabled by the logic "OR" of bit 14 and bit 15.
	 * We do yest use bit 15 here.
	 */
