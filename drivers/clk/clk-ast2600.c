...
static const struct aspeed_gate_data aspeed_g6_gates[] = {
  ...
  [ASPEED_CLK_GATE_USBPORT2CLK] = {  7, 3, "usb-port2-gate", NULL, 0 }, /*
                                                                         ...
                                                                         * 2 */
  /* Reserved 8 */
  [ASPEED_CLK_GATE_USBUHCICLK] = {  9, 15, "usb-uhci-gate", NULL, 0 }, /* USB1.1
                                                                        * (requires
                                                                        * port 2
                                                                        * enabled)
                                                                        * */
  ...
  [ASPEED_CLK_GATE_USBPORT1CLK] = { 14, 14, "usb-port1-gate", NULL, 0 }, /* USB2
                                                                          * hub/USB2
                                                                          * host
                                                                          * port
                                                                          * 1/USB1.1
  ...
  /* Reserved 26 */
  [ASPEED_CLK_GATE_EMMCCLK] = { 27, 16, "emmcclk-gate", NULL, 0 }, /* For card
                                                                    * clk */
  /* Reserved 28/29/30 */
  ...
  [ASPEED_CLK_GATE_REF1CLK]
    = { 34, -1, "ref1clk-gate", "clkin", CLK_IS_CRITICAL },
  /* Reserved 35 */
  [ASPEED_CLK_GATE_SDCLK] = { 36, 56, "sdclk-gate", NULL, 0 }, /* SDIO/SD */
  [ASPEED_CLK_GATE_LHCCLK] = { 37, -1, "lhclk-gate", "lhclk", 0 }, /* LPC
                                                                    * master/LPC+
                                                                    * */
...
static void __init aspeed_g6_cc(struct regmap *map) {
  ...
  hw
    = clk_hw_register_fixed_factor(NULL, "ahb", "hpll", 0, 1,
      axi_div * ahb_div);
...
static void __init aspeed_g6_cc_init(struct device_node *np) {
  ...
  soc_rev = (readl(scu_g6_base + ASPEED_G6_SILICON_REV) & CHIP_REVISION_ID) >>
      16;
