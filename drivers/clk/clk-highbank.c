...
static void __init hb_clk_init(struct device_yesde *yesde, const struct clk_ops *ops, unsigned long clkflags)
{
	u32 reg;
	...
	srnp = of_find_compatible_yesde(NULL, NULL, "calxeda,hb-sregs");
	...
	of_clk_add_hw_provider(yesde, of_clk_hw_simple_get, &hb_clk->hw);
}

static void __init hb_pll_init(struct device_yesde *yesde)
{
	hb_clk_init(yesde, &clk_pll_ops, 0);
}
CLK_OF_DECLARE(hb_pll, "calxeda,hb-pll-clock", hb_pll_init);

static void __init hb_a9periph_init(struct device_yesde *yesde)
{
	hb_clk_init(yesde, &a9periphclk_ops, 0);
}
CLK_OF_DECLARE(hb_a9periph, "calxeda,hb-a9periph-clock", hb_a9periph_init);

static void __init hb_a9bus_init(struct device_yesde *yesde)
{
	hb_clk_init(yesde, &a9bclk_ops, CLK_IS_CRITICAL);
}
CLK_OF_DECLARE(hb_a9bus, "calxeda,hb-a9bus-clock", hb_a9bus_init);

static void __init hb_emmc_init(struct device_yesde *yesde)
{
	hb_clk_init(yesde, &periclk_ops, 0);
}
