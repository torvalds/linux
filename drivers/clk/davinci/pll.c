 ...
 * @base: The PLL memory region
 */
struct clk *davinci_pll_obsclk_register(struct device *dev,
 ...
 * @base: The PLL memory region
 */
struct clk *davinci_pll_sysclk_register(struct device *dev,
...
static struct davinci_pll_platform_data *davinci_pll_get_pdata(
    struct device *dev) {
