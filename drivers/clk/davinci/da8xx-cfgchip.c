...
static struct da8xx_cfgchip_gate_clk *__init da8xx_cfgchip_gate_clk_register(
    struct device *dev,
...
static int __init of_da8xx_cfgchip_gate_clk_init(struct device *dev,
    const struct da8xx_cfgchip_gate_clk_info *info,
    struct regmap *regmap) {
  struct da8xx_cfgchip_gate_clk *gate;
...
static struct da8xx_cfgchip_mux_clk *__init da8xx_cfgchip_mux_clk_register(
    struct device *dev,
    const struct da8xx_cfgchip_mux_clk_info *info,
    struct regmap *regmap) {
  const char * const parent_names[] = {
    info->parent0, info->parent1
  };
...
static int __init of_da8xx_cfgchip_init_mux_clock(struct device *dev,
    const struct da8xx_cfgchip_mux_clk_info *info,
    struct regmap *regmap) {
  struct da8xx_cfgchip_mux_clk *mux;
...
static int __init of_da850_async1_init(struct device *dev,
    struct regmap *regmap) {
  return of_da8xx_cfgchip_init_mux_clock(dev, &da850_async1_info, regmap);
}

static int __init of_da850_async3_init(struct device *dev,
    struct regmap *regmap) {
...
static struct da8xx_usb0_clk48 *da8xx_cfgchip_register_usb0_clk48(
    struct device *dev,
    struct regmap *regmap) {
  const char * const parent_names[] = {
 ...
 */
static struct da8xx_usb1_clk48 *da8xx_cfgchip_register_usb1_clk48(
    struct device *dev,
    struct regmap *regmap) {
  const char * const parent_names[] = {
...
static int of_da8xx_usb_phy_clk_init(struct device *dev,
    struct regmap *regmap) {
