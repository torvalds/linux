...
PNAME(mout_clkcmu_npu_bus_p) = {
  "dout_shared1_div2", "dout_shared2_div2",
...
PNAME(mout_fsys1_usbdrd_user_p) = {
  "oscclk", "dout_clkcmu_fsys1_usbdrd"
};
...
PNAME(mout_fsys2_bus_user_p) = {
  "oscclk", "dout_clkcmu_fsys2_bus"
};
PNAME(mout_fsys2_ufs_embd_user_p) = {
  "oscclk", "dout_clkcmu_fsys2_ufs_embd"
};
PNAME(mout_fsys2_ethernet_user_p) = {
  "oscclk", "dout_clkcmu_fsys2_ethernet"
};
...
PNAME(mout_peric1_bus_user_p) = {
  "oscclk", "dout_clkcmu_peric1_bus"
};
PNAME(mout_peric1_ip_user_p) = {
  "oscclk", "dout_clkcmu_peric1_ip"
};
PNAME(mout_peric1_usi_p) = {
  "oscclk", "mout_peric1_ip_user"
};
