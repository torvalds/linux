...
PNAME(mout_pll_shared2_p) = {
  "oscclk", "fout_shared2_pll"
};
PNAME(mout_pll_shared3_p) = {
  "oscclk", "fout_shared3_pll"
};
PNAME(mout_pll_spare_p) = {
  "oscclk", "fout_spare_pll"
};
...
PNAME(mout_cmu_bus1_bus_p) = {
  "dout_cmu_shared0_div3", "fout_shared3_pll",
...
PNAME(mout_cmu_cpucl0_switch_p) = {
  "fout_shared1_pll", "dout_cmu_shared0_div2",
...
PNAME(mout_cmu_hsi0_dpgtc_p) = {
  "oscclk", "dout_cmu_shared0_div4",
  "dout_cmu_shared2_div2", "fout_spare_pll"
};
PNAME(mout_cmu_hsi0_usb31drd_p) = {
  "oscclk", "dout_cmu_shared2_div2"
};
...
PNAME(mout_apm_func_p) = {
  "oscclk", "mout_apm_funcsrc",
  "pad_clk_apm", "oscclk"
};
PNAME(mout_apm_funcsrc_p) = {
  "pll_alv_div2_apm", "pll_alv_div4_apm",
  "pll_alv_div16_apm"
};
...
PNAME(mout_misc_bus_user_p) = {
  "oscclk", "dout_cmu_misc_bus"
};
PNAME(mout_misc_sss_user_p) = {
  "oscclk", "dout_cmu_misc_sss"
};
PNAME(mout_misc_gic_p) = {
  "dout_misc_gic", "oscclk"
};
...
PNAME(mout_peric1_bus_user_p) = {
  "oscclk", "dout_cmu_peric1_bus"
};
PNAME(mout_peric1_nonbususer_p) = {
  "oscclk", "dout_cmu_peric1_ip"
};
