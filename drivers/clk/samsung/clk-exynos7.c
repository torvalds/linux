...
PNAME(mout_topc_bus0_pll_ctrl_p) = {
  "fin_pll", "fout_bus0_pll"
};
PNAME(mout_topc_bus1_pll_ctrl_p) = {
  "fin_pll", "fout_bus1_pll"
};
...
PNAME(mout_top0_group4) = {
  "ioclk_audiocdclk1", "mout_top0_aud_pll_user",
...
static const struct samsung_fixed_factor_clock top0_fixed_factor_clks[]
__initconst = {
...
static const struct samsung_fixed_factor_clock top1_fixed_factor_clks[]
__initconst = {
...
PNAME(mout_sclk_ufsunipro20_user_p) = {
  "fin_pll", "sclk_ufsunipro20"
};
PNAME(mout_phyclk_ufs20_tx0_user_p) = {
  "fin_pll", "phyclk_ufs20_tx0_symbol"
};
PNAME(mout_phyclk_ufs20_rx0_user_p) = {
  "fin_pll", "phyclk_ufs20_rx0_symbol"
};
PNAME(mout_phyclk_ufs20_rx1_user_p) = {
  "fin_pll", "phyclk_ufs20_rx1_symbol"
};
...
PNAME(mout_aud_group_p) = {
  "dout_aud_cdclk", "ioclk_audiocdclk0"
};
