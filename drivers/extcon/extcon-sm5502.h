...
#define SM5502_REG_DEVICE_ID_VENDOR_MASK  (0x3 << \
    SM5502_REG_DEVICE_ID_VENDOR_SHIFT)
#define SM5502_REG_DEVICE_ID_VERSION_MASK (0x1f << \
...
#define SM5502_REG_CONTROL_MASK_INT_MASK  (0x1 << \
    SM5502_REG_CONTROL_MASK_INT_SHIFT)
#define SM5502_REG_CONTROL_WAIT_MASK    (0x1 << SM5502_REG_CONTROL_WAIT_SHIFT)
#define SM5502_REG_CONTROL_MANUAL_SW_MASK (0x1 << \
    SM5502_REG_CONTROL_MANUAL_SW_SHIFT)
#define SM5502_REG_CONTROL_RAW_DATA_MASK  (0x1 << \
    SM5502_REG_CONTROL_RAW_DATA_SHIFT)
#define SM5502_REG_CONTROL_SW_OPEN_MASK   (0x1 << \
    SM5502_REG_CONTROL_SW_OPEN_SHIFT)
...
#define SM5504_REG_CONTROL_CHGTYP_MASK    (0x1 << \
    SM5504_REG_CONTROL_CHGTYP_SHIFT)
#define SM5504_REG_CONTROL_USBCHDEN_MASK  (0x1 << \
    SM5504_REG_CONTROL_USBCHDEN_SHIFT)
#define SM5504_REG_CONTROL_ADC_EN_MASK    (0x1 << \
    SM5504_REG_CONTROL_ADC_EN_SHIFT)
...
#define SM5502_REG_INTM1_OVP_EVENT_MASK   (0x1 << \
    SM5502_REG_INTM1_OVP_EVENT_SHIFT)
#define SM5502_REG_INTM1_OCP_EVENT_MASK   (0x1 << \
    SM5502_REG_INTM1_OCP_EVENT_SHIFT)
#define SM5502_REG_INTM1_OVP_OCP_DIS_MASK (0x1 << \
    SM5502_REG_INTM1_OVP_OCP_DIS_SHIFT)
...
#define SM5502_REG_INTM2_VBUS_DET_MASK    (0x1 << \
    SM5502_REG_INTM2_VBUS_DET_SHIFT)
#define SM5502_REG_INTM2_REV_ACCE_MASK    (0x1 << \
    SM5502_REG_INTM2_REV_ACCE_SHIFT)
#define SM5502_REG_INTM2_ADC_CHG_MASK   (0x1 << SM5502_REG_INTM2_ADC_CHG_SHIFT)
#define SM5502_REG_INTM2_STUCK_KEY_MASK   (0x1 << \
    SM5502_REG_INTM2_STUCK_KEY_SHIFT)
#define SM5502_REG_INTM2_STUCK_KEY_RCV_MASK (0x1 << \
    SM5502_REG_INTM2_STUCK_KEY_RCV_SHIFT)
...
#define SM5504_REG_INTM1_OVP_EVENT_MASK   (0x1 << \
    SM5504_REG_INTM1_OVP_EVENT_SHIFT)
...
#define SM5504_REG_INTM2_OCP_LATCH_MASK   (0x1 << \
    SM5504_REG_INTM2_OCP_LATCH_SHIFT)
#define SM5504_REG_INTM2_OCP_EVENT_MASK   (0x1 << \
    SM5504_REG_INTM2_OCP_EVENT_SHIFT)
#define SM5504_REG_INTM2_OVP_OCP_EVENT_MASK (0x1 << \
    SM5504_REG_INTM2_OVP_OCP_EVENT_SHIFT)
...
#define SM5502_REG_TIMING_SET1_KEY_PRESS_MASK (0xf << \
    SM5502_REG_TIMING_SET1_KEY_PRESS_SHIFT)
...
#define SM5502_REG_TIMING_SET1_ADC_DET_MASK (0xf << \
    SM5502_REG_TIMING_SET1_ADC_DET_SHIFT)
...
#define SM5502_REG_TIMING_SET2_SW_WAIT_MASK (0xf << \
...
#define SM5502_REG_TIMING_SET2_LONG_KEY_MASK  (0xf << \
    SM5502_REG_TIMING_SET2_LONG_KEY_SHIFT)
...
#define SM5502_REG_DEV_TYPE1_AUDIO_TYPE1_MASK   (0x1 << \
    SM5502_REG_DEV_TYPE1_AUDIO_TYPE1_SHIFT)
#define SM5502_REG_DEV_TYPE1_AUDIO_TYPE1__MASK    (0x1 << \
    SM5502_REG_DEV_TYPE1_AUDIO_TYPE2_SHIFT)
#define SM5502_REG_DEV_TYPE1_USB_SDP_MASK   (0x1 << \
    SM5502_REG_DEV_TYPE1_USB_SDP_SHIFT)
#define SM5502_REG_DEV_TYPE1_UART_MASK      (0x1 << \
    SM5502_REG_DEV_TYPE1_UART_SHIFT)
#define SM5502_REG_DEV_TYPE1_CAR_KIT_CHARGER_MASK (0x1 << \
    SM5502_REG_DEV_TYPE1_CAR_KIT_CHARGER_SHIFT)
#define SM5502_REG_DEV_TYPE1_USB_CHG_MASK   (0x1 << \
    SM5502_REG_DEV_TYPE1_USB_CHG_SHIFT)
#define SM5502_REG_DEV_TYPE1_DEDICATED_CHG_MASK   (0x1 << \
    SM5502_REG_DEV_TYPE1_DEDICATED_CHG_SHIFT)
#define SM5502_REG_DEV_TYPE1_USB_OTG_MASK   (0x1 << \
    SM5502_REG_DEV_TYPE1_USB_OTG_SHIFT)

#define SM5504_REG_DEV_TYPE1_USB_OTG_SHIFT    0
#define SM5504_REG_DEV_TYPE1_USB_OTG_MASK   (0x1 << \
    SM5504_REG_DEV_TYPE1_USB_OTG_SHIFT)
...
#define SM5502_REG_DEV_TYPE2_JIG_USB_ON_MASK    (0x1 << \
    SM5502_REG_DEV_TYPE2_JIG_USB_ON_SHIFT)
#define SM5502_REG_DEV_TYPE2_JIG_USB_OFF_MASK   (0x1 << \
    SM5502_REG_DEV_TYPE2_JIG_USB_OFF_SHIFT)
#define SM5502_REG_DEV_TYPE2_JIG_UART_ON_MASK   (0x1 << \
    SM5502_REG_DEV_TYPE2_JIG_UART_ON_SHIFT)
#define SM5502_REG_DEV_TYPE2_JIG_UART_OFF_MASK    (0x1 << \
    SM5502_REG_DEV_TYPE2_JIG_UART_OFF_SHIFT)
#define SM5502_REG_DEV_TYPE2_PPD_MASK     (0x1 << \
    SM5502_REG_DEV_TYPE2_PPD_SHIFT)
#define SM5502_REG_DEV_TYPE2_TTY_MASK     (0x1 << \
    SM5502_REG_DEV_TYPE2_TTY_SHIFT)
#define SM5502_REG_DEV_TYPE2_AV_CABLE_MASK    (0x1 << \
    SM5502_REG_DEV_TYPE2_AV_CABLE_SHIFT)
...
#define SM5502_REG_MANUAL_SW1_VBUSIN_MASK (0x3 << \
    SM5502_REG_MANUAL_SW1_VBUSIN_SHIFT)
...
#define DM_DP_SWITCH_OPEN     ((DM_DP_CON_SWITCH_OPEN << \
    SM5502_REG_MANUAL_SW1_DP_SHIFT) \
...
#define DM_DP_SWITCH_AUDIO      ((DM_DP_CON_SWITCH_AUDIO << \
    SM5502_REG_MANUAL_SW1_DP_SHIFT) \
