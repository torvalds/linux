...
static int cht_wc_extcon_get_id(struct cht_wc_extcon_data *ext,
    int pwrsrc_sts) {
...
static int cht_wc_extcon_sw_control(struct cht_wc_extcon_data *ext,
    bool enable) {
  int ret, mask, val;
...
static int cht_wc_extcon_get_role_sw_and_regulator(
