...
#define RT8973A_REG_DEVICE_ID_VENDOR_MASK (0x7 << \
    RT8973A_REG_DEVICE_ID_VENDOR_SHIFT)
#define RT8973A_REG_DEVICE_ID_VERSION_MASK  (0x1f << \
...
#define RT8973A_REG_CONTROL1_INTM_MASK    (0x1 << \
    RT8973A_REG_CONTROL1_INTM_SHIFT)
#define RT8973A_REG_CONTROL1_AUTO_CONFIG_MASK (0x1 << \
    RT8973A_REG_CONTROL1_AUTO_CONFIG_SHIFT)
#define RT8973A_REG_CONTROL1_I2C_RST_EN_MASK  (0x1 << \
    RT8973A_REG_CONTROL1_I2C_RST_EN_SHIFT)
#define RT8973A_REG_CONTROL1_SWITCH_OPEN_MASK (0x1 << \
    RT8973A_REG_CONTROL1_SWITCH_OPEN_SHIFT)
#define RT8973A_REG_CONTROL1_CHGTYP_MASK  (0x1 << \
    RT8973A_REG_CONTROL1_CHGTYP_SHIFT)
#define RT8973A_REG_CONTROL1_USB_CHD_EN_MASK  (0x1 << \
    RT8973A_REG_CONTROL1_USB_CHD_EN_SHIFT)
#define RT8973A_REG_CONTROL1_ADC_EN_MASK  (0x1 << \
...
#define RT9873A_REG_INTM1_CONNECT_MASK    (0x1 <<  \
    RT9873A_REG_INTM1_CONNECT_SHIFT)
#define RT9873A_REG_INTM1_ADC_CHG_MASK    (0x1 <<  \
...
#define RT9873A_REG_INTM2_OTP_FET_MASK    (0x1 <<  \
    RT9873A_REG_INTM2_OTP_FET_SHIFT)
#define RT9873A_REG_INTM2_OVP_FET_MASK    (0x1 <<  \
    RT9873A_REG_INTM2_OVP_FET_SHIFT)
#define RT9873A_REG_INTM2_OCP_LATCH_MASK  (0x1 <<  \
    RT9873A_REG_INTM2_OCP_LATCH_SHIFT)
#define RT9873A_REG_INTM2_OCP_MASK    (0x1 << RT9873A_REG_INTM2_OCP_SHIFT)
#define RT9873A_REG_INTM2_OVP_OCP_MASK    (0x1 <<  \
...
#define RT8973A_REG_DEV1_CAR_KIT_TYPE1_MASK (0x1 << \
...
#define RT8973A_REG_DEV2_JIG_USB_ON_MASK  (0x1 << \
    RT8973A_REG_DEV2_JIG_USB_ON_SHIFT)
#define RT8973A_REG_DEV2_JIG_USB_OFF_MASK (0x1 << \
    RT8973A_REG_DEV2_JIG_USB_OFF_SHIFT)
#define RT8973A_REG_DEV2_JIG_UART_ON_MASK (0x1 << \
    RT8973A_REG_DEV2_JIG_UART_ON_SHIFT)
#define RT8973A_REG_DEV2_JIG_UART_OFF_MASK  (0x1 << \
    RT8973A_REG_DEV2_JIG_UART_OFF_SHIFT)

#define RT8973A_REG_MANUAL_SW1_DP_SHIFT   2
#define RT8973A_REG_MANUAL_SW1_DM_SHIFT   5
#define RT8973A_REG_MANUAL_SW1_DP_MASK    (0x7 << \
    RT8973A_REG_MANUAL_SW1_DP_SHIFT)
#define RT8973A_REG_MANUAL_SW1_DM_MASK    (0x7 << \
...
#define DM_DP_SWITCH_OPEN     ((DM_DP_CON_SWITCH_OPEN << \
    RT8973A_REG_MANUAL_SW1_DP_SHIFT) \
  | (DM_DP_CON_SWITCH_OPEN << RT8973A_REG_MANUAL_SW1_DM_SHIFT))
#define DM_DP_SWITCH_USB      ((DM_DP_CON_SWITCH_USB << \
    RT8973A_REG_MANUAL_SW1_DP_SHIFT) \
  | (DM_DP_CON_SWITCH_USB << RT8973A_REG_MANUAL_SW1_DM_SHIFT))
#define DM_DP_SWITCH_UART     ((DM_DP_CON_SWITCH_UART << \
    RT8973A_REG_MANUAL_SW1_DP_SHIFT) \
...
#define RT8973A_REG_MANUAL_SW2_FET_ON_MASK  (0x1 << \
    RT8973A_REG_MANUAL_SW2_FET_ON_SHIFT)
#define RT8973A_REG_MANUAL_SW2_JIG_ON_MASK  (0x1 << \
    RT8973A_REG_MANUAL_SW2_JIG_ON_SHIFT)
#define RT8973A_REG_MANUAL_SW2_BOOT_SW_MASK (0x1 << \
