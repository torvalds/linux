...
static inline void ax45mp_cpu_dcache_wb_range(unsigned long start,
    unsigned long end) {
...
static inline void ax45mp_cpu_dcache_inval_range(unsigned long start,
    unsigned long end) {
...
static int ax45mp_get_l2_line_size(struct device_node *np) {
  int ret;
  ret = of_property_read_u32(np, "cache-line-size",
