...
static struct c67x00_ep_data *c67x00_ep_data_alloc(struct c67x00_hcd *c67x00,
    struct urb *urb) {
 ...
 */
static void c67x00_giveback_urb(struct c67x00_hcd *c67x00, struct urb *urb,
    int status) {
  struct c67x00_urb_priv *urbp;
  if (!urb) {
    return;
 ...
 * Get TD from C67X00
 */
static inline void c67x00_parse_td(struct c67x00_hcd *c67x00,
    struct c67x00_td *td) {
...
static void c67x00_handle_isoc(struct c67x00_hcd *c67x00,
    struct c67x00_td *td) {
  struct urb *urb = td->urb;
  int cnt;
  if (!urb) {
