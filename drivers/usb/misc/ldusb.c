...
#define USB_DEVICE_ID_LD_CASSY    0x1000  /* USB Product ID of CASSY-S modules
                                           * with 8 bytes endpoint size */
#define USB_DEVICE_ID_LD_CASSY2   0x1001  /* USB Product ID of CASSY-S modules
                                           * with 64 bytes endpoint size */
#define USB_DEVICE_ID_LD_POCKETCASSY  0x1010  /* USB Product ID of Pocket-CASSY
                                               * */
#define USB_DEVICE_ID_LD_POCKETCASSY2 0x1011  /* USB Product ID of Pocket-CASSY
                                               * 2 (reserved) */
#define USB_DEVICE_ID_LD_MOBILECASSY  0x1020  /* USB Product ID of Mobile-CASSY
                                               * */
#define USB_DEVICE_ID_LD_MOBILECASSY2 0x1021  /* USB Product ID of Mobile-CASSY
                                               * 2 (reserved) */
#define USB_DEVICE_ID_LD_MICROCASSYVOLTAGE  0x1031  /* USB Product ID of
                                                     * Micro-CASSY Voltage */
#define USB_DEVICE_ID_LD_MICROCASSYCURRENT  0x1032  /* USB Product ID of
                                                     * Micro-CASSY Current */
#define USB_DEVICE_ID_LD_MICROCASSYTIME   0x1033  /* USB Product ID of
                                                   * Micro-CASSY Time (reserved)
                                                   * */
#define USB_DEVICE_ID_LD_MICROCASSYTEMPERATURE  0x1035  /* USB Product ID of
                                                         * Micro-CASSY
                                                         * Temperature */
#define USB_DEVICE_ID_LD_MICROCASSYPH   0x1038  /* USB Product ID of Micro-CASSY
                                                 * pH */
#define USB_DEVICE_ID_LD_POWERANALYSERCASSY 0x1040  /* USB Product ID of Power
                                                     * Analyser CASSY */
#define USB_DEVICE_ID_LD_CONVERTERCONTROLLERCASSY 0x1042  /* USB Product ID of
                                                           * Converter
                                                           * Controller CASSY */
#define USB_DEVICE_ID_LD_MACHINETESTCASSY 0x1043  /* USB Product ID of Machine
                                                   * Test CASSY */
#define USB_DEVICE_ID_LD_JWM    0x1080  /* USB Product ID of Joule and Wattmeter
                                         * */
#define USB_DEVICE_ID_LD_DMMP   0x1081  /* USB Product ID of Digital Multimeter
                                         * P (reserved) */
...
#define USB_DEVICE_ID_LD_XRAY   0x1100  /* USB Product ID of X-Ray Apparatus
                                         * 55481 */
#define USB_DEVICE_ID_LD_XRAY2    0x1101  /* USB Product ID of X-Ray Apparatus
                                           * 554800 */
#define USB_DEVICE_ID_LD_XRAYCT   0x1110  /* USB Product ID of X-Ray Apparatus
                                           * CT 554821*/
...
#define USB_DEVICE_ID_LD_TELEPORT 0x2010  /* USB Product ID of Terminal Adapter
                                           * */
#define USB_DEVICE_ID_LD_NETWORKANALYSER 0x2020 /* USB Product ID of Network
                                                 * Analyser */
#define USB_DEVICE_ID_LD_POWERCONTROL 0x2030  /* USB Product ID of Converter
                                               * Control Unit */
#define USB_DEVICE_ID_LD_MACHINETEST  0x2040  /* USB Product ID of Machine Test
                                               * System */
#define USB_DEVICE_ID_LD_MOSTANALYSER 0x2050  /* USB Product ID of MOST Protocol
                                               * Analyser */
#define USB_DEVICE_ID_LD_MOSTANALYSER2  0x2051  /* USB Product ID of MOST
                                                 * Protocol Analyser 2 */
#define USB_DEVICE_ID_LD_ABSESP   0x2060  /* USB Product ID of ABS ESP */
#define USB_DEVICE_ID_LD_AUTODATABUS  0x2070  /* USB Product ID of Automotive
                                               * Data Buses */
#define USB_DEVICE_ID_LD_MCT    0x2080  /* USB Product ID of Microcontroller
                                         * technique */
...
static void ld_usb_interrupt_in_callback(struct urb *urb) {
  ...
  if (urb->actual_length > 0) {
    ...
    if (next_ring_head != dev->ring_tail) {
      actual_buffer
        = (size_t *) (dev->ring_buffer + dev->ring_head
...
static ssize_t ld_usb_read(struct file *file, char __user *buffer, size_t count,
  ...
  actual_buffer
    = (size_t *) (dev->ring_buffer + dev->ring_tail
      * (sizeof(size_t) + dev->interrupt_in_endpoint_size));
...
static ssize_t ld_usb_write(struct file *file, const char __user *buffer,
  ...
  if (dev->interrupt_out_busy) {
    ...
    retval
      = wait_event_interruptible(dev->write_wait, !dev->interrupt_out_busy);
    if (retval < 0) {
      goto unlock_exit;
    }
  }
 ...
 */
static int ld_usb_probe(struct usb_interface *intf,
  ...
  dev->interrupt_out_endpoint_size
    = dev->interrupt_out_endpoint ? usb_endpoint_maxp(
      dev->interrupt_out_endpoint)
