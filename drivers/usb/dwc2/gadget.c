...
static inline void dwc2_clear_bit(struct dwc2_hsotg *hsotg, u32 offset,
    u32 val) {
  dwc2_writel(hsotg, dwc2_readl(hsotg, offset) & ~val, offset);
}
 ...
 */
static void dwc2_hsotg_txfifo_flush(struct dwc2_hsotg *hsotg,
    unsigned int idx) {
...
static void dwc2_gadget_set_speed(struct usb_gadget *g,
