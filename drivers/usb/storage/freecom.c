...
static int freecom_readdata(struct scsi_cmnd *srb, struct us_data *us,
...
static int freecom_writedata(struct scsi_cmnd *srb, struct us_data *us,
...
static int freecom_transport(struct scsi_cmnd *srb, struct us_data *us) {
  ...
  switch (srb->cmnd[0]) {
    case INQUIRY:
    case REQUEST_SENSE: /* 16 or 18 bytes? spec says 18, lots of devices only
                         * have 16 */
    case MODE_SENSE:
    case MODE_SENSE_10:
