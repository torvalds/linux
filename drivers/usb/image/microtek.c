...
#define MTS_INT_INIT() \
  struct mts_transfer_context *context \
    = (struct mts_transfer_context *) transfer->context; \
  MTS_DEBUG_INT(); \
...
static int mts_scsi_queuecommand(struct Scsi_Host *shost,
...
static void mts_build_transfer_context(struct scsi_cmnd *srb,
