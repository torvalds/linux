...
static void usb_acpi_get_connect_type(struct usb_port *port_dev,
    acpi_handle *handle) {
...
static struct acpi_device *usb_acpi_get_companion_for_port(
    struct usb_port *port_dev) {
...
static struct acpi_device *usb_acpi_find_companion_for_port(
    struct usb_port *port_dev) {
  struct acpi_device *adev;
...
static struct acpi_device *usb_acpi_find_companion_for_device(
    struct usb_device *udev) {
  struct acpi_device *adev;
  struct usb_port *port_dev;
  struct usb_hub *hub;
