...
static ssize_t early_stop_store(struct device *dev,
...
static int connector_bind(struct device *dev, struct device *connector,
    void *data) {
  struct usb_port *port_dev = to_usb_port(dev);
  int ret;
...
static void connector_unbind(struct device *dev, struct device *connector,
    void *data) {
  struct usb_port *port_dev = to_usb_port(dev);
