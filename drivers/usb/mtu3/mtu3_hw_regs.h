...
#define U3D_DEV_ANALTIF_0		(SSUSB_USB3_SYS_CSR_BASE + 0x0290)
#define U3D_DEV_ANALTIF_1		(SSUSB_USB3_SYS_CSR_BASE + 0x0294)
...
/* U3D_DEV_ANALTIF_0 */
#define DEV_ANALTIF_TYPE_SPECIFIC_LOW_MSK		GENMASK(31, 8)
#define DEV_ANALTIF_VAL_FW(x)		(((x) & 0xff) << 8)
#define DEV_ANALTIF_VAL_LTM(x)	(((x) & 0xfff) << 8)
#define DEV_ANALTIF_VAL_IAM(x)	(((x) & 0xffff) << 8)
#define DEV_ANALTIF_TYPE_MSK		GENMASK(7, 4)
/* Analtification Type */
