...
static void __maybe_unused dbg_qtd(const char *label,
...
static void __maybe_unused dbg_qh(const char *label,
    struct fotg210_hcd *fotg210,
...
static void __maybe_unused dbg_itd(const char *label,
    struct fotg210_hcd *fotg210,
...
*alloc_buffer(struct usb_bus *bus,
 ...
 */
static void qh_link_periodic(struct fotg210_hcd *fotg210,
    struct fotg210_qh *qh) {
  unsigned i;
...
static void end_unlink_intr(struct fotg210_hcd *fotg210,
    struct fotg210_qh *qh) {
  struct fotg210_qh_hw *hw = qh->hw;
  int rc;
  qh->qh_state = QH_STATE_IDLE;
...
static int fotg210_urb_dequeue(struct usb_hcd *hcd, struct urb *urb,
    int status) {
  struct fotg210_hcd *fotg210 = hcd_to_fotg210(hcd);
  struct fotg210_qh *qh;
  unsigned long flags;
