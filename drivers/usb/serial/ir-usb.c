...
#define DRIVER_AUTHOR \
  "Greg Kroah-Hartman <greg@kroah.com>, Johan Hovold <jhovold@gmail.com>"
 ...
 */
static struct usb_irda_cs_descriptor *irda_usb_find_class_desc(
    struct usb_serial *serial, unsigned int ifnum) {
