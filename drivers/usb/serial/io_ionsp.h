...
#define GET_INT_STATUS_SIZE(NumPorts) (sizeof(__u16) \
  + (sizeof(__u16) * (NumPorts)))
...
#define IOSP_GET_HDR_DATA_LEN(Byte1, \
      Byte2) ((__u16) (((__u16) ((Byte1) & 0x78)) << 5) | (Byte2))
...
#define IOSP_BUILD_DATA_HDR1(Port, \
      Len)   ((__u8) (((Port) | ((__u8) (((__u16) (Len)) >> 5) & 0x78))))
...
#define IOSP_BUILD_CMD_HDR1(Port, \
      Cmd)    ((__u8) (IOSP_CMD_STAT_BIT | (Port) | ((__u8) ((Cmd) << 3))))
...
#define IOSP_CMD_CHASE_PORT   0x02    // Wait for Edgeport TX buffers to empty.
                                      // (NO PARAM)
...
#define IOSP_CMD_RX_CHECK_REQ   0x07    // Request Edgeport to insert a
                                        // Checkpoint into
...
#define IOSP_TX_FLOW_XON_XOFF   0x08  // Edgeport stops Tx upon receiving XOFF
                                      // char.
...
#define IOSP_STATUS_LSR_DATA    0x08  // P1 is new value of LSR register (same
                                      // as STATUS_LSR)
...
#define IOSP_EXT_STATUS_CHASE_PASS  0 //  P2 = 0: All Tx data drained
                                      // successfully
#define IOSP_EXT_STATUS_CHASE_FAIL  1 //  P2 = 1: Timed out (stuck due to flow

//      control from remote device).

#define IOSP_EXT_STATUS_RX_CHECK_RSP  1 // Reply to RX_CHECK cmd. P2 is sequence
                                        // number
