...
struct keyspan_device_details {
  ...
  enum  {
    msg_usa26, msg_usa28, msg_usa49, msg_usa90, msg_usa67
  } msg_format;
...
static struct usb_endpoint_descriptor const *find_ep(
    struct usb_serial const *serial,
    int endpoint) {
