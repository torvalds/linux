...
// Product IDs - assigned to match middle digit of serial number (No longer
// true)

#define ION_DEVICE_ID_80251_NETCHIP 0x020 // This bit is set in the PID if this
                                          // edgeport hardware$
...
#define ION_DEVICE_ID_GENERATION_3  0x02  // Value for Texas Instruments
                                          // TUSB5052 chip
#define ION_DEVICE_ID_GENERATION_4  0x03  // Watchport Family of products
#define ION_GENERATION_MASK   0x03

#define ION_DEVICE_ID_HUB_MASK    0x0080  // This bit in the PID designates a
                                          // HUB device
// for example 8C would be a 421 4 port hub
// and 8D would be a 2 port embedded hub

#define EDGEPORT_DEVICE_ID_MASK     0x0ff // Not including OEM or GENERATION
                                          // fields
...
#define ION_DEVICE_ID_EDGEPORT_4T   0x004 // Edgeport/4 RS232 for Telxon (aka
                                          // "Fleetport")
...
#define ION_DEVICE_ID_EDGEPORT_8RR    0x008 // Edgeport with RJ45 with Data and
                                            // RTS/CTS only
...
// (Placeholder, used in middle digit of serial number only!)
#define ION_DEVICE_ID_EDGEPORT_PARALLEL_PORT  0x00B // Edgeport/(4)21 Parallel
                                                    // port (USS720)
...
#define ION_DEVICE_ID_EDGEPORT_2_DIN    0x010 // Edgeport/2 RS232 with Apple DIN
                                              // connector
#define ION_DEVICE_ID_EDGEPORT_4_DIN    0x011 // Edgeport/4 RS232 with Apple DIN
                                              // connector
#define ION_DEVICE_ID_EDGEPORT_16_DUAL_CPU  0x012 // Half of an Edgeport/16 (the
                                                  // kind with 2 EP/8s)
#define ION_DEVICE_ID_EDGEPORT_COMPATIBLE 0x013 // Edgeport Compatible, for NCR,
                                                // Axiohm etc. testing
...
#define ION_DEVICE_ID_EDGEPORT_22I    0x01A // Edgeport/22I is an Edgeport/4
                                            // with ports 1&2 RS422 and ports
                                            // 3&4 RS232

// Compact Form factor TI based devices  2c, 21c, 22c, 221c
#define ION_DEVICE_ID_EDGEPORT_2C   0x01B // Edgeport/2c is a TI based
                                          // Edgeport/2 - Small I2c
#define ION_DEVICE_ID_EDGEPORT_221C   0x01C // Edgeport/221c is a TI based
                                            // Edgeport/2 with lucent chip and
// 2 external hub ports - Large I2C
#define ION_DEVICE_ID_EDGEPORT_22C    0x01D // Edgeport/22c is a TI based
                                            // Edgeport/2 with
// 2 external hub ports - Large I2C
#define ION_DEVICE_ID_EDGEPORT_21C    0x01E // Edgeport/21c is a TI based
                                            // Edgeport/2 with lucent chip
// Small I2C
...
#define ION_DEVICE_ID_EDGEPORT_4S   0x042 // Edgeport/4s - software switchable
                                          // model
#define ION_DEVICE_ID_EDGEPORT_8S   0x043 // Edgeport/8s - software switchable
                                          // model
...
#define ION_DEVICE_ID_TI_EDGEPORT_421   0x020C  // Edgeport/421 4 hub 2 RS232 +
                                                // Parallel (lucent on a
                                                // different hub port)
#define ION_DEVICE_ID_TI_EDGEPORT_21    0x020D  // Edgeport/21 2 RS232 +
                                                // Parallel (lucent on a
                                                // different hub port)
...
#define ION_DEVICE_ID_TI_EDGEPORT_22I   0x021A  // Edgeport/22I is an Edgeport/4
                                                // with ports 1&2 RS422 and
                                                // ports 3&4 RS232
#define ION_DEVICE_ID_TI_EDGEPORT_2C    0x021B  // Edgeport/2c RS232
#define ION_DEVICE_ID_TI_EDGEPORT_221C    0x021C  // Edgeport/221c is a TI based
                                                  // Edgeport/2 with lucent chip
                                                  // and
// 2 external hub ports - Large I2C
#define ION_DEVICE_ID_TI_EDGEPORT_22C   0x021D  // Edgeport/22c is a TI based
                                                // Edgeport/2 with
// 2 external hub ports - Large I2C
#define ION_DEVICE_ID_TI_EDGEPORT_21C   0x021E  // Edgeport/21c is a TI based
                                                // Edgeport/2 with lucent chip
...
// Ti based software switchable RS232/RS422/RS485 devices
#define ION_DEVICE_ID_TI_EDGEPORT_4S    0x0242  // Edgeport/4s - software
                                                // switchable model
#define ION_DEVICE_ID_TI_EDGEPORT_8S    0x0243  // Edgeport/8s - software
                                                // switchable model
...
#define ION_DEVICE_ID_WP_UNSERIALIZED   0x300 // Watchport based on 3410 both
                                              // 1-wire and binary products
...
#define ION_DEVICE_ID_PLUS_PWR_HP4CD    0x30C // 5052 Plus Power HubPort/4CD+
                                              // (for Dell)
#define ION_DEVICE_ID_PLUS_PWR_HP4C   0x30D // 5052 Plus Power HubPort/4C+
#define ION_DEVICE_ID_PLUS_PWR_PCI    0x30E // 3410 Plus Power PCI Host
                                            // Controller 4 port
...
// TxCredits value below which driver won't bother sending (to prevent too many
// small writes).
// Send only if above 25%
#define EDGE_FW_GET_TX_CREDITS_SEND_THRESHOLD(InitialCredit, \
      MaxPacketSize) (max(((InitialCredit) / 4), (MaxPacketSize)))

#define EDGE_FW_BULK_MAX_PACKET_SIZE    64  // Max Packet Size for Bulk In
                                            // Endpoint (EP1)
#define EDGE_FW_BULK_READ_BUFFER_SIZE   1024  // Size to use for Bulk reads

#define EDGE_FW_INT_MAX_PACKET_SIZE   32  // Max Packet Size for Interrupt In
                                          // Endpoint
...
#define USB_REQUEST_ION_SEND_IOSP 10  // Send an IOSP command to the edgeport
                                      // over the control pipe
#define USB_REQUEST_ION_RECV_IOSP 11  // Receive an IOSP command from the
                                      // edgeport over the control pipe
...
struct edge_compatibility_bits {
  ...
  __u32 VendEnableSuspend :  1; // 0001 Set if device supports
                                // ION_ENABLE_SUSPEND
  ...
  __u32 IOSPSetBaudRate   :  1; // 0400 setting Baud rate (writes to LCR.80h and
                                // DLL/DLM register)
  __u32 IOSPDisableIntPipe  :  1; // 0800 Do not use the interrupt pipe for
                                  // TxCredits or RxButesAvailable
  __u32 IOSPRxDataAvail   :  1;   // 1000 Return status of RX Fifo (Data
                                  // available in Fifo)
  __u32 IOSPTxPurge   :  1; // 2000 Purge TXBuffer and/or Fifo in Edgeport
                            // hardware
...
#define EDGE_DOWNLOAD_FILE_INTERNAL 0xFF  // Download the file compiled into
                                          // driver (930 version)
#define EDGE_DOWNLOAD_FILE_I930   0xFF  // Download the file compiled into
                                        // driver (930 version)
#define EDGE_DOWNLOAD_FILE_80251  0xFE  // Download the file compiled into
                                        // driver (80251 version)
...
struct edge_manuf_descriptor {
  __u16 RootDescTable[0x10];      // C00 Root of descriptor tables (just a
                                  // placeholder)
  __u8 DescriptorArea[0x2E0];      // C20 Descriptors go here, up to 2E0h (just
                                   // a placeholder)
  ...
  __u8 DescDate[3];        // F09 MM/DD/YY when descriptor template was
                           // compiler,
...
#define MANUF_SERNUM_LENGTH   sizeof(((struct edge_manuf_descriptor *) 0)-> \
  SerialNumber)
#define MANUF_ASSYNUM_LENGTH    sizeof(((struct edge_manuf_descriptor *) 0)-> \
  AssemblyNumber)
#define MANUF_OEMASSYNUM_LENGTH   sizeof(((struct edge_manuf_descriptor *) 0)-> \
  OemAssyNumber)
#define MANUF_MANUFDATE_LENGTH    sizeof(((struct edge_manuf_descriptor *) 0)-> \
  ManufDate)

#define MANUF_ION_CONFIG_DIAG_NO_LOOP 0x20  // As below but no ext loopback test
#define MANUF_ION_CONFIG_DIAG   0x40  // 930 based device: 1=Run h/w diags,
                                      // 0=norm
// TIUMP Device    : 1=IONSERIAL needs to run Final Test
#define MANUF_ION_CONFIG_MASTER   0x80  // 930 based device:  1=Master mode,
                                        // 0=Normal
...
#define I2C_DESC_TYPE_WATCHPORT_VERSION 0x15  // firmware version number for
                                              // watchport
#define I2C_DESC_TYPE_WATCHPORT_CALIBRATION_DATA 0x16 // Watchport Calibration
                                                      // Data
...
struct edge_ti_manuf_descriptor {
  ...
  __u8 TotalPorts;  //  Total Number of Com Ports for the entire device (All
                    // UMPs)
