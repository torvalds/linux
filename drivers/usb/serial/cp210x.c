...
static const struct usb_device_id id_table[] = {
  ...
  { USB_DEVICE(0x0489, 0xE003) }, /* Pirelli Broadband S.p.A, DP-L10 SIP/GSM
                                   * Mobile */
  { USB_DEVICE(0x04BF, 0x1301) }, /* TDK Corporation NC0110013M - Network
                                   * Controller */
  { USB_DEVICE(0x04BF, 0x1303) }, /* TDK Corporation MM0110113M - i3 Micro
                                   * Module */
  { USB_DEVICE(0x0745, 0x1000) }, /* CipherLab USB CCD Barcode Scanner 1000 */
  { USB_DEVICE(0x0846, 0x1100) }, /* NetGear Managed Switch M4100 series, M5300
                                   * series, M7100 series */
  { USB_DEVICE(0x08e6, 0x5501) }, /* Gemalto Prox-PU/CU contactless smartcard
                                   * reader */
  ...
  { USB_DEVICE(0x10C4, 0x80C4) }, /* Cygnal Integrated Products, Inc., Optris
  ...
  { USB_DEVICE(0x10C4, 0x826B) }, /* Cygnal Integrated Products, Inc., Fasttrax
                                   * GPS demonstration module */
  { USB_DEVICE(0x10C4, 0x8281) }, /* Nanotec Plug & Drive */
  { USB_DEVICE(0x10C4, 0x8293) }, /* Telegesis ETRX2USB */
  { USB_DEVICE(0x10C4, 0x82AA) }, /* Silicon Labs IFS-USB-DATACABLE used with
                                   * Quint UPS */
  ...
  { USB_DEVICE(0x10C4, 0x89A4) }, /* CESINEL FTBC Flexible Thyristor Bridge
                                   * Controller */
  ...
  { USB_DEVICE(0x166A, 0x0201) }, /* Clipsal 5500PACA C-Bus Pascal Automation
                                   * Controller */
  { USB_DEVICE(0x166A, 0x0301) }, /* Clipsal 5800PC C-Bus Wireless PC Interface
                                   * */
  { USB_DEVICE(0x166A, 0x0303) }, /* Clipsal 5500PCU C-Bus USB interface */
  { USB_DEVICE(0x166A, 0x0304) }, /* Clipsal 5000CT2 C-Bus Black and White
                                   * Touchscreen */
  { USB_DEVICE(0x166A, 0x0305) }, /* Clipsal C-5000CT2 C-Bus Spectrum Colour
                                   * Touchscreen */
  { USB_DEVICE(0x166A, 0x0401) }, /* Clipsal L51xx C-Bus Architectural Dimmer */
  { USB_DEVICE(0x166A, 0x0101) }, /* Clipsal 5560884 C-Bus Multi-room Audio
                                   * Matrix Switcher */
  { USB_DEVICE(0x16C0, 0x09B0) }, /* Lunatico Seletek */
  { USB_DEVICE(0x16C0, 0x09B1) }, /* Lunatico Seletek */
  { USB_DEVICE(0x16D6, 0x0001) }, /* Jablotron serial interface */
  { USB_DEVICE(0x16DC, 0x0010) }, /* W-IE-NE-R Plein & Baus GmbH PL512 Power
                                   * Supply */
  { USB_DEVICE(0x16DC, 0x0011) }, /* W-IE-NE-R Plein & Baus GmbH RCM Remote
                                   * Control for MARATON Power Supply */
  { USB_DEVICE(0x16DC, 0x0012) }, /* W-IE-NE-R Plein & Baus GmbH MPOD Multi
                                   * Channel Power Supply */
  { USB_DEVICE(0x16DC, 0x0015) }, /* W-IE-NE-R Plein & Baus GmbH CML Control,
                                   * Monitoring and Data Logger */
  { USB_DEVICE(0x17A8, 0x0001) }, /* Kamstrup Optical Eye/3-wire */
  { USB_DEVICE(0x17A8, 0x0005) }, /* Kamstrup M-Bus Master MultiPort 250D */
  { USB_DEVICE(0x17A8, 0x0011) }, /* Kamstrup 444 MHz RF sniffer */
  { USB_DEVICE(0x17A8, 0x0013) }, /* Kamstrup 870 MHz RF sniffer */
  { USB_DEVICE(0x17A8, 0x0101) }, /* Kamstrup 868 MHz wM-Bus C-Mode Meter Reader
                                   * (Int Ant) */
  { USB_DEVICE(0x17A8, 0x0102) }, /* Kamstrup 868 MHz wM-Bus C-Mode Meter Reader
                                   * (Ext Ant) */
...
static void cp210x_process_lsr(struct usb_serial_port *port, unsigned char lsr,
    char *flag) {
...
static bool cp210x_process_char(struct usb_serial_port *port, unsigned char *ch,
    char *flag) {
  struct cp210x_port_private *port_priv = usb_get_serial_port_data(port);
...
static bool cp210x_termios_change(const struct ktermios *a,
