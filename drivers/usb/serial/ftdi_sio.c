...
#define DRIVER_AUTHOR \
  "Greg Kroah-Hartman <greg@kroah.com>, Bill Ryder <bryder@sgi.com>, Kuba Ober <kuba@mareimbrium.org>, Andreas Mohr, Johan Hovold <jhovold@gmail.com>"
...
struct ftdi_private {
  ...
  struct mutex cfg_lock; /* Avoid mess by parallel calls of config ioctl() and
                          * change_speed() */
...
static const struct usb_device_id id_table_combined[] = {
  ...
  { USB_DEVICE_INTERFACE_NUMBER(ACTEL_VID, MICROSEMI_ARROW_SF2PLUS_BOARD_PID,
      2) },
  ...
  /* Infineon Devices */
  { USB_DEVICE_INTERFACE_NUMBER(INFINEON_VID, INFINEON_TRIBOARD_TC1798_PID,
      1) },
...
static umode_t ftdi_is_visible(struct kobject *kobj, struct attribute *attr,
    int idx) {
...
static int ftdi_probe(struct usb_serial *serial,
