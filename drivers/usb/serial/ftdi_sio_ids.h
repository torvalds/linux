...
#define FTDI_FT4232HA_PID 0x6048 /* Quad channel automotive grade hi-speed
                                  * device */
...
#define FTDI_ELV_UMS100_PID 0xE0EB  /* ELV USB Master-Slave Schaltsteckdose UMS
                                     * 100 */
#define FTDI_ELV_TFD128_PID 0xE0EC  /* ELV Temperatur-Feuchte-Datenlogger TFD
                                     * 128 */
#define FTDI_ELV_FM3RX_PID  0xE0ED  /* ELV Messwertuebertragung FM3 RX */
#define FTDI_ELV_WS777_PID  0xE0EE  /* Conrad WS 777 */
#define FTDI_ELV_EM1010PC_PID 0xE0EF  /* Energy monitor EM 1010 PC */
#define FTDI_ELV_CSI8_PID 0xE0F0  /* Computer-Schalt-Interface (CSI 8) */
#define FTDI_ELV_EM1000DL_PID 0xE0F1  /* PC-Datenlogger fuer Energiemonitor (EM
                                       * 1000 DL) */
 ...
 */
#define FTDI_TERATRONIK_VCP_PID  0xEC88 /* Teratronik device (preferring VCP
                                         * driver on windows) */
#define FTDI_TERATRONIK_D2XX_PID 0xEC89 /* Teratronik device (preferring D2XX
                                         * driver on windows) */
...
#define BANDB_USOPTL4DR2_PID  0xAC18  /* USOPTL4R-2 2-port Isolated RS-232
                                       * Converter */
...
#define TELLDUS_TELLSTICK_PID   0x0C30  /* RF control dongle 433 MHz using
                                         * FT232RL */
...
#define RTSYSTEMS_USB_VX8_PID   0x9e50  /* USB-VX8 USB to 7 pin modular plug for
                                         * Yaesu VX-8 radio */
...
#define PI_E517_PID 0x1005  /* PI E-517 Digital Piezo Controller Operation
                             * Module */
...
#define BRAINBOXES_US_606_1_PID   0x2001 /* US-606 6 Port RS232 Serial Port 1
                                          * and 2 */
#define BRAINBOXES_US_606_2_PID   0x2002 /* US-606 6 Port RS232 Serial Port 3
                                          * and 4 */
#define BRAINBOXES_US_606_3_PID   0x2003 /* US-606 6 Port RS232 Serial Port 4
                                          * and 6 */
...
#define BRAINBOXES_US_279_4_PID   0x2024 /* US-279 8xRS422 1Mbaud Port 7 and 8
                                          * */
#define BRAINBOXES_US_346_1_PID   0x3011 /* US-346 4xRS422/485 1Mbaud Port 1 and
                                          * 2 */
#define BRAINBOXES_US_346_2_PID   0x3012 /* US-346 4xRS422/485 1Mbaud Port 3 and
                                          * 4 */
#define BRAINBOXES_US_257_PID   0x5001 /* US-257 2xRS232 1Mbaud */
#define BRAINBOXES_US_313_PID   0x6001 /* US-313 2xRS422/485 1Mbaud */
#define BRAINBOXES_US_357_PID   0x7001 /* US_357 1xRS232/422/485 */
#define BRAINBOXES_US_842_1_PID   0x8001 /* US-842 8xRS422/485 1Mbaud Port 1 and
                                          * 2 */
#define BRAINBOXES_US_842_2_PID   0x8002 /* US-842 8xRS422/485 1Mbaud Port 3 and
                                          * 4 */
#define BRAINBOXES_US_842_3_PID   0x8003 /* US-842 8xRS422/485 1Mbaud Port 5 and
                                          * 6 */
#define BRAINBOXES_US_842_4_PID   0x8004 /* US-842 8xRS422/485 1Mbaud Port 7 and
                                          * 8 */
...
#define BRAINBOXES_US_160_5_PID   0x9005 /* US-160 16xRS232 1Mbaud Port 9 and 10
                                          * */
#define BRAINBOXES_US_160_6_PID   0x9006 /* US-160 16xRS232 1Mbaud Port 11 and
                                          * 12 */
#define BRAINBOXES_US_160_7_PID   0x9007 /* US-160 16xRS232 1Mbaud Port 13 and
                                          * 14 */
#define BRAINBOXES_US_160_8_PID   0x9008 /* US-160 16xRS232 1Mbaud Port 15 and
                                          * 16 */
