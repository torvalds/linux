...
#define DRIVER_AUTHOR \
  "Greg Kroah-Hartman <greg@kroah.com>, Stuart MacDonald <stuartm@connecttech.com>"
...
static int whiteheat_firmware_download(struct usb_serial *serial,
  ...
  int response;
  response
    = ezusb_fx1_ihex_firmware_download(serial->dev, "whiteheat_loader.fw");
  if (response >= 0) {
