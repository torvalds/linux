...
#define BELKIN_OLD_PID  0x8007  /* Belkin's "old" single port serial converter's
                                 * id */
...
#define GOHUBS_PID  0x1000  /* GoHubs single port serial converter's id
                             * (identical to the Peracom device) */
#define HANDYLINK_PID 0x1200  /* HandyLink USB's id (identical to the Peracom
                               * device) */
...
#define BELKIN_SA_FLOW_IRTS   0x0010  /* use RTS output for input flow control
                                       * */
#define BELKIN_SA_FLOW_ORTS   0x0020  /* use RTS to indicate data available to
                                       * send */
#define BELKIN_SA_FLOW_ERRSUB   0x0040  /* ???? guess ???? substitute inline
                                         * errors */
