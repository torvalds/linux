...
static u8 const clock_table[] = {
  F81534_CLK_1_846_MHZ, F81534_CLK_14_77_MHZ,
...
static int f81534_set_spi_register(struct usb_serial *serial, u16 reg,
    u8 data) {
  int status;
...
static int f81534_set_port_config(struct usb_serial_port *port,
  ...
  u8 value;
  u32 baud_list[] = {
    baudrate, old_baudrate, F81534_DEFAULT_BAUD_RATE
  };
...
static void f81534_get_serial_info(struct tty_struct *tty,
