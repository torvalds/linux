...
#define DRIVER_AUTHOR \
  "sl@lineo.com, tbr@lineo.com, Johan Hovold <jhovold@gmail.com>"
...
static const struct usb_device_id id_table[] = {
  ...
  {MY_USB_DEVICE(0x4dd, 0x8002, CDC_DEVICE_CLASS, LINEO_INTERFACE_CLASS,
...
#define CRC10_FCS(fcs, \
      c) ((((fcs) << 8) & 0x3ff) ^ crc10_table[((fcs) >> 2) & 0xff] ^ (c))
