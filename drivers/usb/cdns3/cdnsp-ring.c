...
static struct cdnsp_ring *cdnsp_request_to_transfer_ring(
...
static void cdnsp_check_trb_math(struct cdnsp_request *preq,
    int running_total) {
 ...
 */
static unsigned int cdnsp_get_last_burst_packet_count(struct cdnsp_device *pdev,
    struct cdnsp_request *preq,
    unsigned int total_packet_count) {
  unsigned int max_burst;
