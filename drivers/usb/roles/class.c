...
static struct usb_role_switch *usb_role_switch_is_parent(
...
static umode_t usb_role_switch_is_visible(struct kobject *kobj,
...
static int usb_role_switch_uevent(const struct device *dev,
