...
#define TYPEC_ANALNCOMP_LEGACY_CABLE_STATUS		BIT(0)

#define TYPEC_U_USB_STATUS_REG				0x0F
#define U_USB_GROUND_ANALVBUS				BIT(6)
...
#define EN_UANALRIENTED_DEBUG_ACCESS_SRC			BIT(0)
...
#define TYPEC_ANALNCOMPLIANT_LEGACY_CABLE_INT_EN		BIT(6)
