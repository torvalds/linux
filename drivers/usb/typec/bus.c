...
static inline int typec_altmode_set_retimer(struct altmode *alt,
...
static inline int typec_altmode_set_mux(struct altmode *alt, unsigned long conf,
    void *data) {
...
static inline int typec_altmode_set_switches(struct altmode *alt,
    unsigned long conf, void *data) {
  int ret;
 ...
 */
int typec_cable_altmode_enter(struct typec_altmode *adev,
 ...
 */
int typec_cable_altmode_exit(struct typec_altmode *adev,
...
/**
 * typec_cable_altmode_vdm - Send Vendor Defined Messages (VDM) between the
 *cable plug and port.
 * @adev: Alternate mode handle
 ...
 */
int typec_cable_altmode_vdm(struct typec_altmode *adev,
    enum typec_plug_index sop,
    const u32 header, const u32 *vdo, int count) {
  struct altmode *altmode;
  struct typec_altmode *pdev;
