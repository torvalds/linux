...
#define TPS_FIELD_GET(_mask, \
      _reg) ((typeof(_mask))(((_reg) & (_mask)) >> __bf_shf(_mask)))
...
#define TPS_STATUS_CONN_STATE(x)    TPS_FIELD_GET(TPS_STATUS_CONN_STATE_MASK, \
    (x))
#define TPS_STATUS_PP_5V0_SWITCH_MASK   GENMASK(9, 8)
#define TPS_STATUS_PP_5V0_SWITCH(x)   TPS_FIELD_GET( \
    TPS_STATUS_PP_5V0_SWITCH_MASK, (x))
#define TPS_STATUS_PP_HV_SWITCH_MASK    GENMASK(11, 10)
#define TPS_STATUS_PP_HV_SWITCH(x)    TPS_FIELD_GET( \
    TPS_STATUS_PP_HV_SWITCH_MASK, (x))
#define TPS_STATUS_PP_EXT_SWITCH_MASK   GENMASK(13, 12)
#define TPS_STATUS_PP_EXT_SWITCH(x)   TPS_FIELD_GET( \
    TPS_STATUS_PP_EXT_SWITCH_MASK, (x))
#define TPS_STATUS_PP_CABLE_SWITCH_MASK   GENMASK(15, 14)
#define TPS_STATUS_PP_CABLE_SWITCH(x)   TPS_FIELD_GET( \
    TPS_STATUS_PP_CABLE_SWITCH_MASK, (x))
#define TPS_STATUS_POWER_SOURCE_MASK    GENMASK(19, 18)
#define TPS_STATUS_POWER_SOURCE(x)    TPS_FIELD_GET( \
    TPS_STATUS_POWER_SOURCE_MASK, (x))
#define TPS_STATUS_VBUS_STATUS_MASK   GENMASK(21, 20)
#define TPS_STATUS_VBUS_STATUS(x)   TPS_FIELD_GET(TPS_STATUS_VBUS_STATUS_MASK, \
    (x))
#define TPS_STATUS_USB_HOST_PRESENT_MASK  GENMASK(23, 22)
#define TPS_STATUS_USB_HOST_PRESENT(x)    TPS_FIELD_GET( \
    TPS_STATUS_USB_HOST_PRESENT_MASK, (x))
...
#define TPS_POWER_STATUS_PWROPMODE(p)     TPS_FIELD_GET( \
    TPS_POWER_STATUS_TYPEC_CURRENT_MASK, (p))
#define TPS_POWER_STATUS_BC12_STATUS_MASK   GENMASK(6, 5)
#define TPS_POWER_STATUS_BC12_STATUS(p)     TPS_FIELD_GET( \
    TPS_POWER_STATUS_BC12_STATUS_MASK, (p))
