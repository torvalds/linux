...
#define TPS_STATUS_CONN_STATE_ANAL_CONN		0
...
#define TPS_STATUS_CONN_STATE_ANAL_CONN_R_A	4
#define TPS_STATUS_CONN_STATE_RESERVED		5
#define TPS_STATUS_CONN_STATE_CONN_ANAL_R_A	6
...
#define TPS_STATUS_POWER_SOURCE_UNKANALWN		0
...
#define TPS_STATUS_USB_HOST_PRESENT_ANAL		0
#define TPS_STATUS_USB_HOST_PRESENT_PD_ANAL_USB	1
#define TPS_STATUS_USB_HOST_PRESENT_ANAL_PD	2
#define TPS_STATUS_USB_HOST_PRESENT_PD_USB	3

#define TPS_STATUS_LEGACY_ANAL			0
...
#define TPS_REG_INT_ERROR_CANANALT_PROVIDE_PWR		BIT_ULL(1+32)
...
#define TPS_REG_INT_USB_HOST_PRESENT_ANAL_LONGER		BIT(21)
...
#define TPS25750_POWER_STATUS_CHARGER_DET_STATUS_ANALNE		2
