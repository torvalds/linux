...
static ssize_t dual_role_power_show(struct device *dev,
...
static ssize_t usb_suspend_supported_show(struct device *dev,
...
static ssize_t higher_capability_show(struct device *dev,
    struct device_attribute *attr,
    char *buf) {
...
static ssize_t unconstrained_power_show(struct device *dev,
    struct device_attribute *attr,
    char *buf) {
...
static ssize_t usb_communication_capable_show(struct device *dev,
    struct device_attribute *attr,
    char *buf) {
...
static ssize_t dual_role_data_show(struct device *dev,
    struct device_attribute *attr, char *buf) {
...
static ssize_t unchunked_extended_messages_supported_show(struct device *dev,
    struct device_attribute *attr, char *buf) {
...
static ssize_t peak_current_show(struct device *dev,
    struct device_attribute *attr, char *buf) {
  return sysfs_emit(buf, "%u\n", (to_pdo(
      dev)->pdo >> PDO_FIXED_PEAK_CURR_SHIFT) & 3);
}

static DEVICE_ATTR_RO(peak_current);

static ssize_t fast_role_swap_current_show(struct device *dev,
    struct device_attribute *attr,
    char *buf) {
  return sysfs_emit(buf, "%u\n", (to_pdo(
      dev)->pdo >> PDO_FIXED_FRS_CURR_SHIFT) & 3);
}
...
static umode_t fixed_attr_is_visible(struct kobject *kobj,
...
static ssize_t maximum_voltage_show(struct device *dev,
    struct device_attribute *attr, char *buf) {
...
static ssize_t minimum_voltage_show(struct device *dev,
    struct device_attribute *attr, char *buf) {
...
static ssize_t maximum_power_show(struct device *dev,
    struct device_attribute *attr, char *buf) {
...
static ssize_t operational_power_show(struct device *dev,
    struct device_attribute *attr,
    char *buf) {
  return sysfs_emit(buf, "%umW\n", pdo_max_power(to_pdo(dev)->pdo));
}
...
static ssize_t pps_power_limited_show(struct device *dev,
    struct device_attribute *attr,
    char *buf) {
...
static ssize_t pps_max_voltage_show(struct device *dev,
    struct device_attribute *attr, char *buf) {
  return sysfs_emit(buf, "%umV\n", pdo_pps_apdo_max_voltage(to_pdo(dev)->pdo));
}

static ssize_t pps_min_voltage_show(struct device *dev,
    struct device_attribute *attr, char *buf) {
  return sysfs_emit(buf, "%umV\n", pdo_pps_apdo_min_voltage(to_pdo(dev)->pdo));
}

static ssize_t pps_max_current_show(struct device *dev,
    struct device_attribute *attr, char *buf) {
...
static int add_pdo(struct usb_power_delivery_capabilities *cap, u32 pdo,
    int position) {
...
static umode_t pd_attr_is_visible(struct kobject *kobj, struct attribute *attr,
    int n) {
