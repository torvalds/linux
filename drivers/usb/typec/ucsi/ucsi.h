...
#else
static inline int ucsi_register_port_psy(struct ucsi_connector *con) {
  return 0;
}
...
#else
static inline struct typec_altmode *ucsi_register_displayport(
...
static inline void ucsi_displayport_remove_partner(struct typec_altmode *adev) {
}
