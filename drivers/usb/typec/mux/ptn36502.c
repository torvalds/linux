...
static int ptn36502_sw_set(struct typec_switch_dev *sw,
    enum typec_orientation orientation) {
...
static int ptn36502_retimer_set(struct typec_retimer *retimer,
...
static int ptn36502_detect(struct ptn36502 *ptn) {
  ...
  dev_dbg(dev,
      "Chip revision: base layer version %lx, metal layer version %lx\n",
...
static int ptn36502_bridge_attach(struct drm_bridge *bridge,
  ...
  next_bridge = devm_drm_of_get_bridge(&ptn->client->dev,
