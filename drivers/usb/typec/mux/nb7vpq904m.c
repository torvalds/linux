...
#define OUTPUT_COMPRESSION_AND_POL_REG(n) (OUTPUT_COMPRESSION_AND_POL_REG_BASE \
  + (n) * 2)
...
static void nb7vpq904m_set_channel(struct nb7vpq904m *nb7, unsigned int channel,
    bool dp) {
...
static int nb7vpq904m_retimer_set(struct typec_retimer *retimer,
