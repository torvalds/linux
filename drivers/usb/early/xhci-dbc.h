...
#define XDBC_STRING_MANUFACTURER	"GNU/Linux Foundation"
#define XDBC_STRING_PRODUCT		"GNU/Linux USB GDB Target"
...
#define XDBC_VENDOR_ID		0x1d6b	/* GNU/Linux Foundation 0x1d6b */
