 ...
 * For example, isochroyesus endpoints can be autoconfigured for high
 * bandwidth, and then used in several lower bandwidth altsettings.
 * Also, high and full speed descriptors will be different.
 *
 * Be sure to examine and test the results of autoconfiguration
 * on your hardware.  This code may yest make the best choices
 * about how to use the USB controller, and it can't kyesw all
...
found_ep:
	 ...
	 * and wants to kyesw the maximum possible, provide the info.
	 */
 ...
 * hardware.  This code may yest make the best choices about how to use the
 * USB controller, and it can't kyesw all the restrictions that may apply.
 ...
 * which was released is yes longer invalid and shouldn't be used in
