...
DECLARE_EVENT_CLASS(udc_log_gadget,
	...
	TP_STRUCT__entry(
		...
		__field(unsigned, quirk_altset_yest_supp)
		__field(unsigned, quirk_stall_yest_supp)
		__field(unsigned, quirk_zlp_yest_supp)
	...
	TP_fast_assign(
		...
		__entry->quirk_altset_yest_supp = g->quirk_altset_yest_supp;
		__entry->quirk_stall_yest_supp = g->quirk_stall_yest_supp;
		__entry->quirk_zlp_yest_supp = g->quirk_zlp_yest_supp;
	...
	TP_printk("speed %d/%d state %d %dmA [%s%s%s%s%s%s%s%s%s%s%s%s%s%s] --> %d",
		...
		__entry->quirk_altset_yest_supp ? "yes_altset:" : "",
		__entry->quirk_stall_yest_supp ? "yes_stall:" : "",
		__entry->quirk_zlp_yest_supp ? "yes_zlp" : "",
...
DECLARE_EVENT_CLASS(udc_log_req,
	...
	TP_STRUCT__entry(
		...
		__field(unsigned, yes_interrupt)
		__field(unsigned, zero)
		__field(unsigned, short_yest_ok)
		__field(int, status)
		__field(int, ret)
	...
	TP_fast_assign(
		...
		__entry->yes_interrupt = req->yes_interrupt;
		__entry->zero = req->zero;
		__entry->short_yest_ok = req->short_yest_ok;
