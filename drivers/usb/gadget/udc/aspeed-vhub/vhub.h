...
#define AST_VHUB_EP_ACK_IER 0x10  /* Programmable Endpoint Pool ACK Interrupt
                                   * Enable Register */
#define AST_VHUB_EP_NACK_IER  0x14  /* Programmable Endpoint Pool NACK Interrupt
                                     * Enable Register  */
#define AST_VHUB_EP_ACK_ISR 0x18  /* Programmable Endpoint Pool ACK Interrupt
                                   * Status Register  */
#define AST_VHUB_EP_NACK_ISR  0x1C  /* Programmable Endpoint Pool NACK Interrupt
                                     * Status Register  */
...
#define AST_VHUB_EP_TOGGLE  0x28  /* Programmable Endpoint Pool Data Toggle
                                   * Value Set */
...
#define AST_VHUB_EP0_DATA 0x34  /* Base Address of Endpoint 0 In/OUT Data Buffer
                                 * Register */
