...
#define AST_UDC_EP_ACK_IER    0x10  /* Programmable ep Pool ACK Interrupt Enable
                                     * Reg */
#define AST_UDC_EP_NAK_IER    0x14  /* Programmable ep Pool NAK Interrupt Enable
                                     * Reg */
#define AST_UDC_EP_ACK_ISR    0x18  /* Programmable ep Pool ACK Interrupt Status
                                     * Reg */
#define AST_UDC_EP_NAK_ISR    0x1C  /* Programmable ep Pool NAK Interrupt Status
                                     * Reg */
#define AST_UDC_DEV_RESET   0x20  /* Device Controller Soft Reset Enable
                                   * Register */
#define AST_UDC_STS     0x24  /* USB Status Register */
#define AST_VHUB_EP_DATA    0x28  /* Programmable ep Pool Data Toggle Value Set
                                   * */
#define AST_VHUB_ISO_TX_FAIL    0x2C  /* Isochronous Transaction Fail
                                       * Accumulator */
#define AST_UDC_EP0_CTRL    0x30  /* Endpoint 0 Control/Status Register */
#define AST_UDC_EP0_DATA_BUFF   0x34  /* Base Address of ep0 IN/OUT Data Buffer
                                       * Reg */
...
#define AST_UDC_EP_DMA_CTRL   0x04  /* DMA Descriptor List Control/Status
                                     * Register */
#define AST_UDC_EP_DMA_BUFF   0x08  /* DMA Descriptor/Buffer Base Address */
#define AST_UDC_EP_DMA_STS    0x0C  /* DMA Descriptor List R/W Pointer and
                                     * Status */
...
#define AST_EP_DMA_DESC_MAX_LEN   (7680) /* Max packet length for trasmit in 1
                                          * desc */
...
static void ast_udc_epn_kick(struct ast_udc_ep *ep,
    struct ast_udc_request *req) {
  u32 tx_len;
  u32 last;
