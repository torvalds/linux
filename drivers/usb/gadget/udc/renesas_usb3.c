...
#define USB3_MAX_NUM_PIPES(p)   ((p)->is_rzv2m ? 16 : 6)  /* This includes PIPE
                                                           * 0 */
...
static u32 usb3_calc_rammap_val(struct renesas_usb3_ep *usb3_ep,
    const struct usb_endpoint_descriptor *desc) {
  int i;
  static const u32 max_packet_array[] = {
    8, 16, 32, 64, 512
  };
...
static int renesas_usb3_ep_dequeue(struct usb_ep *_ep,
    struct usb_request *_req) {
  struct renesas_usb3_ep *usb3_ep = usb_ep_to_usb3_ep(_ep);
  struct renesas_usb3_request *usb3_req = usb_req_to_usb3_req(_req);
  struct renesas_usb3 *usb3 = usb3_ep_to_usb3(usb3_ep);
...
static int renesas_usb3_set_selfpowered(struct usb_gadget *gadget,
    int is_self) {
