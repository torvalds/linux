...
#define     AT91_UDP_ENDBUSRES  (1 << 12) /* End of Bus Reset Interrupt Status
                                           * */
#define     AT91_UDP_WAKEUP (1 << 13) /* USB Wakeup Interrupt Status [AT91RM9200
                                       * only] */

#define AT91_UDP_ICR    0x20    /* Interrupt Clear Register */
#define AT91_UDP_RST_EP   0x28    /* Reset Endpoint Register */

#define AT91_UDP_CSR(n)   (0x30 + ((n) * 4))  /* Endpoint Control/Status
                                               * Registers 0-7 */
#define     AT91_UDP_TXCOMP (1 << 0) /* Generates IN packet with data previously
                                      * written in DPR */
#define     AT91_UDP_RX_DATA_BK0 (1 << 1)  /* Receive Data Bank 0 */
#define     AT91_UDP_RXSETUP  (1 << 2) /* Send STALL to the host */
#define     AT91_UDP_STALLSENT  (1 << 3) /* Stall Sent / Isochronous error
...
#define AT91_UDP_FDR(n)   (0x50 + ((n) * 4))  /* Endpoint FIFO Data Registers
                                               * 0-7 */
