...
#define     AT91_UDP_STALLSENT	(1 <<  3)	/* Stall Sent / Isochroyesus error (Isochroyesus endpoints) */
...
struct at91_udc_data {
	...
	u8	vbus_polled;		/* Use polling, yest interrupt */
	int	pullup_pin;		/* active == D+ pulled up */
	u8	pullup_active_low;	/* true == pullup_pin is active low */
};

/*
 * driver is yesn-SMP, and just blocks IRQs whenever it needs
