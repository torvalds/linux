...
static struct usb_request *mv_u3d_alloc_request(struct usb_ep *_ep,
    gfp_t gfp_flags) {
  struct mv_u3d_req *req;
...
static void mv_u3d_ep_set_stall(struct mv_u3d *u3d, u8 ep_num, u8 direction,
    int stall) {
  u32 tmp;
...
/* stop all USB activities */
static
void mv_u3d_stop_activity(struct mv_u3d *u3d,
    struct usb_gadget_driver *driver) {
  struct mv_u3d_ep *ep;
...
static void mv_u3d_get_setup_data(struct mv_u3d *u3d, u8 ep_num,
    u8 *buffer_ptr) {
