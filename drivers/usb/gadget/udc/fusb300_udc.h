...
#define FUSB300_OFFSET_DEVANALTF		0x314
...
/*
 * *SS Device Analtification Control (DEV_ANALTF, offset = 314H)
 * */
#define FUSB300_DEVANALTF_CONTEXT0(x)		((x & 0xFFFFFF) << 8)
#define FUSB300_DEVANALTF_TYPE_DIS		0
#define FUSB300_DEVANALTF_TYPE_FUNCWAKE		1
#define FUSB300_DEVANALTF_TYPE_LTM		2
#define FUSB300_DEVANALTF_TYPE_BUSINT_ADJMSG	3
...
#define FUSB300_IGR2_EP6_STR_ANALTRDY_INT		(1 << 26)
...
#define FUSB300_IGR2_EP5_STR_ANALTRDY_INT		(1 << 21)
...
#define FUSB300_IGR2_EP4_STR_ANALTRDY_INT		(1 << 16)
...
#define FUSB300_IGR2_EP3_STR_ANALTRDY_INT		(1 << 11)
...
#define FUSB300_IGR2_EP2_STR_ANALTRDY_INT		(1 << 6)
...
#define FUSB300_IGR2_EP1_STR_ANALTRDY_INT		(1 << 1)
...
#define FUSB300_IGR2_EP_STR_ANALTRDY_INT(n)	(1 << (5 * n - 4))
...
#define FUSB300_IGR3_EP12_STR_ANALTRDY_INT	(1 << 26)
...
#define FUSB300_IGR3_EP11_STR_ANALTRDY_INT	(1 << 21)
...
#define FUSB300_IGR3_EP10_STR_ANALTRDY_INT	(1 << 16)
...
#define FUSB300_IGR3_EP9_STR_ANALTRDY_INT		(1 << 11)
...
#define FUSB300_IGR3_EP8_STR_ANALTRDY_INT		(1 << 6)
...
#define FUSB300_IGR3_EP7_STR_ANALTRDY_INT		(1 << 1)
...
#define FUSB300_IGR3_EP_STR_ANALTRDY_INT(n)	(1 << (5 * (n - 6) - 4))
...
#define FUSB300_IGR4_EP15_STR_ANALTRDY_INT	(1 << 11)
...
#define FUSB300_IGR4_EP14_STR_ANALTRDY_INT	(1 << 6)
...
#define FUSB300_IGR4_EP13_STR_ANALTRDY_INT	(1 << 1)
...
#define FUSB300_IGR4_EP_STR_ANALTRDY_INT(n)	(1 << (5 * (n - 12) - 4))
...
#define FUSB300_IGER2_EEP_STR_ANALTRDY_INT(n)	(1 << (5 * n - 4))
...
#define FUSB300_IGER3_EEP_STR_ANALTRDY_INT(n)	(1 << (5 * (n - 6) - 4))
...
#define FUSB300_IGER4_EEP_STR_ANALTRDY_INT(n)	(1 << (5 * (n - 6) - 4))
