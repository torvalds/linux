...
static void irq_ep0_write(struct r8a66597_ep *ep,
    struct r8a66597_request *req) {
  int i;
  u16 tmp;
  unsigned bufsize;
...
static void set_feature(struct r8a66597 *r8a66597,
    struct usb_ctrlrequest *ctrl) {
  u16 tmp;
  int timeout = 3000;
  switch (ctrl->bRequestType & USB_RECIP_MASK) {
...
static int setup_packet(struct r8a66597 *r8a66597,
    struct usb_ctrlrequest *ctrl) {
  u16 *p = (u16 *) ctrl;
...
static void r8a66597_free_request(struct usb_ep *_ep,
