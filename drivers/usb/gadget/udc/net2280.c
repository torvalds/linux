...
static inline void queue_dma(struct net2280_ep *ep, struct net2280_request *req,
    int valid) {
...
static void done(struct net2280_ep *ep, struct net2280_request *req,
    int status) {
  struct net2280 *dev;
...
static int net2280_queue(struct usb_ep *_ep, struct usb_request *_req,
    gfp_t gfp_flags) {
  struct net2280_request *req;
  struct net2280_ep *ep;
  struct net2280 *dev;
...
static inline void dma_done(struct net2280_ep *ep, struct net2280_request *req,
    u32 dmacount,
    int status) {
...
static int net2280_set_halt_and_wedge(struct usb_ep *_ep, int value,
    int wedged) {
  struct net2280_ep *ep;
  unsigned long flags;
  int retval = 0;
...
static void usb_reinit_338x(struct net2280 *dev) {
  int i;
  u32 tmp, val;
  static const u32 ne[9] = {
    0, 1, 2, 3, 4, 1, 2, 3, 4
  };
  static const u32 ep_reg_addr[9] = {
...
static void defect7374_workaround(struct net2280 *dev,
