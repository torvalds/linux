...
static void __maybe_unused dump_udccr(const char *label) {
  u32 udccr = UDCCR;
...
static void __maybe_unused dump_udccs0(const char *label) {
  u32 udccs0 = UDCCS0;
...
static void __maybe_unused dump_state(struct pxa25x_udc *dev) {
  u32 tmp;
  unsigned i;
