 ...
 */
static struct usb_descriptor_header **function_descriptors(
 ...
 */
static struct usb_descriptor_header **next_desc(
    struct usb_descriptor_header **t, u8 desc_type) {
  for (; *t; t++) {
 ...
 */
int composite_setup(struct usb_gadget *gadget,
