...
static struct uvcg_format *find_format_by_index(struct uvc_device *uvc,
    int index) {
...
static int uvc_v4l2_try_format(struct file *file, void *fh,
    struct v4l2_format *fmt) {
  struct video_device *vdev = video_devdata(file);
  struct uvc_device *uvc = video_get_drvdata(vdev);
  struct uvc_video *video = &uvc->video;
...
static int uvc_v4l2_enum_format(struct file *file, void *fh,
...
static int uvc_v4l2_querybuf(struct file *file, void *fh,
