...
static void uac_cs_attr_sample_rate(struct usb_ep *ep,
...
static int in_rq_min(struct usb_function *fn,
    const struct usb_ctrlrequest *cr) {
  struct usb_request *req = fn->config->cdev->req;
  struct g_audio *audio = func_to_g_audio(fn);
  struct f_uac1_opts *opts = g_audio_to_uac1_opts(audio);
...
static int in_rq_max(struct usb_function *fn,
    const struct usb_ctrlrequest *cr) {
  struct usb_request *req = fn->config->cdev->req;
  struct g_audio *audio = func_to_g_audio(fn);
  struct f_uac1_opts *opts = g_audio_to_uac1_opts(audio);
...
static int in_rq_res(struct usb_function *fn,
    const struct usb_ctrlrequest *cr) {
  struct usb_request *req = fn->config->cdev->req;
  struct g_audio *audio = func_to_g_audio(fn);
  struct f_uac1_opts *opts = g_audio_to_uac1_opts(audio);
...
static int out_rq_cur(struct usb_function *fn,
    const struct usb_ctrlrequest *cr) {
  struct usb_request *req = fn->config->cdev->req;
  struct g_audio *audio = func_to_g_audio(fn);
  struct f_uac1_opts *opts = g_audio_to_uac1_opts(audio);
