...
static inline struct uvcg_control_header *to_uvcg_control_header(
    struct config_item *item) {
...
static inline struct uvcg_streaming_header *to_uvcg_streaming_header(
    struct config_item *item) {
...
static inline struct uvcg_uncompressed *to_uvcg_uncompressed(
    struct config_item *item) {
