...
static void raise_exception(struct fsg_common *common,
    enum fsg_state new_state) {
...
static bool start_in_transfer(struct fsg_common *common,
...
static bool start_out_transfer(struct fsg_common *common,
    struct fsg_buffhd *bh) {
  int rc;
  if (!fsg_is_set(common)) {
    return false;
...
static int do_read_capacity_16(struct fsg_common *common,
    struct fsg_buffhd *bh) {
  struct fsg_lun *curlun = common->curlun;
...
static int do_set_interface(struct fsg_common *common,
