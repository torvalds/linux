...
static int sourcesink_bind(struct usb_configuration *c,
...
static void sourcesink_free_func(struct usb_function *f) {
...
static ssize_t f_ss_opts_isoc_interval_show(struct config_item *item,
    char *page) {
  struct f_ss_opts *opts = to_f_ss_opts(item);
  int result;
  mutex_lock(&opts->lock);
...
static ssize_t f_ss_opts_isoc_maxpacket_show(struct config_item *item,
    char *page) {
  struct f_ss_opts *opts = to_f_ss_opts(item);
  int result;
  mutex_lock(&opts->lock);
...
static ssize_t f_ss_opts_isoc_maxburst_show(struct config_item *item,
    char *page) {
  struct f_ss_opts *opts = to_f_ss_opts(item);
  int result;
  mutex_lock(&opts->lock);
...
static ssize_t f_ss_opts_bulk_buflen_show(struct config_item *item,
    char *page) {
  struct f_ss_opts *opts = to_f_ss_opts(item);
  int result;
  mutex_lock(&opts->lock);
