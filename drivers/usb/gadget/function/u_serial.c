 ...
 */
static unsigned gs_send_packet(struct gs_port *port, char *packet,
    unsigned size) {
  unsigned len;
...
static void gs_console_complete_out(struct usb_ep *ep,
    struct usb_request *req) {
...
static int gs_port_alloc(unsigned port_num,
