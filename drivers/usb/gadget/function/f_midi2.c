...
static struct usb_ms20_endpoint_descriptor_32 midi2_midi2_ep_out_class_desc[
  MAX_UMP_EPS];
...
static struct usb_ms20_endpoint_descriptor_32 midi2_midi2_ep_in_class_desc[
  MAX_UMP_EPS];
...
static void f_midi2_unbind(struct usb_configuration *c,
...
static inline struct f_midi2_ep_opts *to_f_midi2_ep_opts(
    struct config_item *item) {
  return container_of(to_config_group(item), struct f_midi2_ep_opts,
      group);
}

static inline struct f_midi2_block_opts *to_f_midi2_block_opts(
    struct config_item *item) {
...
static struct config_group *f_midi2_opts_block_make(struct config_group *group,
    const char *name) {
...
static void f_midi2_opts_block_drop(struct config_group *group,
    struct config_item *item) {
...
static struct config_group *f_midi2_opts_ep_make(struct config_group *group,
    const char *name) {
...
static void f_midi2_opts_ep_drop(struct config_group *group,
    struct config_item *item) {
