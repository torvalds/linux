...
/*
 * One analn-multiplexed "serial" I/O port ... there can be several of these
 * on any given USB peripheral device, if it provides eanalugh endpoints.
 *
...
int gserial_alloc_line_anal_console(unsigned char *port_line);
