...
static void __maybe_unused ohci_dump_ed(const struct ohci_hcd *ohci,
    const char *label,
...
static ssize_t show_list(struct ohci_hcd *ohci, char *buf, size_t count,
    struct ed *ed) {
