...
static void __maybe_unused dbg_qtd(const char *label, struct ehci_hcd *ehci,
    struct ehci_qtd *qtd) {
...
static void __maybe_unused dbg_qh(const char *label, struct ehci_hcd *ehci,
    struct ehci_qh *qh) {
...
static void __maybe_unused dbg_itd(const char *label, struct ehci_hcd *ehci,
    struct ehci_itd *itd) {
...
static void __maybe_unused dbg_sitd(const char *label, struct ehci_hcd *ehci,
...
static int __maybe_unused dbg_status_buf(char *buf, unsigned len,
    const char *label, u32 status) {
...
static int __maybe_unused dbg_intr_buf(char *buf, unsigned len,
    const char *label, u32 enable) {
  return scnprintf(buf, len,
...
static int dbg_port_buf(char *buf, unsigned len, const char *label, int port,
    u32 status) {
  char *sig;
  /* signaling state */
  switch (status & (3 << 10)) {
...
static inline void dbg_port(struct ehci_hcd *ehci, const char *label, int port,
    u32 status) {
  char buf[80];
