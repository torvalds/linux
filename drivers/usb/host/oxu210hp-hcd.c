...
static int __attribute__((__unused__)) dbg_status_buf(char *buf, unsigned len,
    const char *label,
    u32 status) {
...
static int __attribute__((__unused__)) dbg_intr_buf(char *buf, unsigned len,
    const char *label,
    u32 enable) {
...
static inline int __attribute__((__unused__)) dbg_status_buf(char *buf,
    unsigned len,
    const char *label,
    u32 status) {
  return 0;
...
static inline int __attribute__((__unused__)) dbg_command_buf(char *buf,
    unsigned len,
    const char *label,
    u32 command) {
  return 0;
...
static inline int __attribute__((__unused__)) dbg_intr_buf(char *buf,
    unsigned len,
    const char *label,
    u32 enable) {
  return 0;
...
static inline int __attribute__((__unused__)) dbg_port_buf(char *buf,
    unsigned len,
    const char *label,
    int port,
    u32 status) {
...
static void oxu_configuration(struct platform_device *pdev,
    void __iomem *base) {
  u32 tmp;
