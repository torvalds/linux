...
static unsigned int dbc_send_packet(struct dbc_port *port, char *packet,
    unsigned int size) {
  unsigned int len;
...
static void dbc_read_complete(struct xhci_dbc *dbc, struct dbc_request *req) {
  unsigned long flags;
...
static int xhci_dbc_alloc_requests(struct xhci_dbc *dbc, unsigned int direction,
...
static void xhci_dbc_free_requests(struct list_head *head) {
  struct dbc_request *req;
...
static void xhci_dbc_tty_init_port(struct xhci_dbc *dbc,
    struct dbc_port *port) {
...
static void xhci_dbc_tty_exit_port(struct dbc_port *port) {
...
int xhci_dbc_tty_probe(struct device *dev, void __iomem *base,
