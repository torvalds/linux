...
static void set_pipe_reg_addr(struct r8a66597_pipe *pipe, u8 dma_ch) {
  ...
  const unsigned long fifoaddr[] = {
    D0FIFO, D1FIFO, CFIFO
  };
  const unsigned long fifosel[] = {
    D0FIFOSEL, D1FIFOSEL, CFIFOSEL
  };
  const unsigned long fifoctr[] = {
    D0FIFOCTR, D1FIFOCTR, CFIFOCTR
  };
...
static struct r8a66597_device *get_urb_to_r8a66597_dev(
    struct r8a66597 *r8a66597, struct urb *urb) {
...
static u16 r8a66597_get_pipenum(struct urb *urb,
...
static u16 get_urb_to_r8a66597_addr(struct r8a66597 *r8a66597,
    struct urb *urb) {
...
static void collect_usb_address_map(struct usb_device *udev,
    unsigned long *map) {
  int chix;
