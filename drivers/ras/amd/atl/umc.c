...
/*
 * MI300 systems report a DRAM address in MCA_ADDR for DRAM ECC errors. This
 * must
 * be converted to the intermediate normalized address (NA) before translating
 * to a
 ...
 *
 * Additionally, the PC and Bank bits may be hashed. This must be accounted for
 * before
