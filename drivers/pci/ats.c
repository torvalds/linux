...
int pci_enable_pri(struct pci_dev *pdev, u32 reqs)
{
	...
	/*
	 * VFs must yest implement the PRI Capability.  If their PF
...
int pci_enable_pasid(struct pci_dev *pdev, int features)
{
	...
	/*
	 * VFs must yest implement the PASID Capability, but if a PF
 ...
 * @pdev: PCI device structure
 *
 * Returns a negative value when yes PASI capability is present.
 ...
 * @pdev: PCI device structure
 *
 * Returns negative value when PASID capability is yest present.
