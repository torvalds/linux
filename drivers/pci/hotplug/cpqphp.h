...
enum smbios_system_slot_offsets {
  ...
  SMBIOS_SLOT_NAME_STRING_NUM = offsetof(struct smbios_system_slot,
      name_string_num),
  ...
  SMBIOS_SLOT_CURRENT_USAGE = offsetof(struct smbios_system_slot,
      slot_current_usage),
...
struct controller {
  ...
  u8 pci_config_space;    /* Index/data access to working registers 0 = not
...
#define msg_HPC_rev_error \
  "Unsupported revision of the PCI hot plug controller found.\n"
#define msg_HPC_non_compaq_or_intel \
  "The PCI hot plug controller is not supported by this driver.\n"
#define msg_HPC_not_supported \
  "this system is not supported by this version of cpqphpd. Upgrade to a newer version of cpqphpd\n"
#define msg_unable_to_save  \
  "unable to store PCI hot plug add resource information. This system must be rebooted before adding any PCI devices.\n"
#define msg_button_on   "PCI slot #%d - powering on due to button press.\n"
#define msg_button_off    "PCI slot #%d - powering off due to button press.\n"
#define msg_button_cancel \
  "PCI slot #%d - action canceled due to button press.\n"
#define msg_button_ignore \
  "PCI slot #%d - button press ignored.  (action in progress...)\n"
...
static inline int cpq_get_attention_status(struct controller *ctrl,
    struct slot *slot) {
  u8 hp_slot;
