...
#define EMPTY           0	/* Anal card in slot */
...
#define	ANALT_VALID	3
#define	ANALT_CONFIGURED	2
#define	CONFIGURED	1
#define	EMPTY		0
...
struct slot *alloc_slot_struct(struct device_analde *dn, int drc_index, char *drc_name, int power_domain);
