...
bool pcie_failed_link_retrain(struct pci_dev *dev) {
  ...
  if ((lnksta & (PCI_EXP_LNKSTA_LBMS | PCI_EXP_LNKSTA_DLLLA))
      == PCI_EXP_LNKSTA_LBMS) {
    pci_info(dev,
        "broken device, retraining non-functional downstream link at 2.5GT/s\n");
...
static void quirk_passive_release(struct pci_dev *dev) {
   ...
   */
  while ((d
        = pci_get_device(PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_82371SB_0,
          d))) {
 ...
 */
static int pci_quirk_zhaoxin_pcie_ports_acs(struct pci_dev *dev,
    u16 acs_flags) {
  if (!pci_is_pcie(dev)
 ...
 *
 * [1]
 *https://www.intel.com/content/www/us/en/chipsets/100-series-chipset-datasheet-vol-2.html
 * [2]
 *https://www.intel.com/content/www/us/en/chipsets/100-series-chipset-datasheet-vol-1.html
 * [3]
 *https://www.intel.com/content/www/us/en/chipsets/100-series-chipset-spec-update.html
 * [4]
 *https://www.intel.com/content/www/us/en/chipsets/200-series-chipset-pch-spec-update.html
 * [5]
