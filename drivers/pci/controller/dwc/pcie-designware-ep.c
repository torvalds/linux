...
struct dw_pcie_ep_func *dw_pcie_ep_get_func_from_ep(struct dw_pcie_ep *ep,
    u8 func_no) {
...
static const struct pci_epc_features *dw_pcie_ep_get_features(
...
static unsigned int dw_pcie_ep_find_ext_capability(struct dw_pcie *pci,
    int cap) {
  u32 header;
