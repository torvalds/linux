...
#define PCIE_CLIENT_DE_OUT_0		(PCIE_CLIENT_BASE + 0x3c)
#define   PCIE_CLIENT_DE_LTSSM_MASK		GENMASK(5, 0)
#define   PCIE_CLIENT_DE_LTSSM_L1		0x18
#define   PCIE_CLIENT_DE_LTSSM_L2		0x19
...
#define PCIE_LINK_IS_L2(x) \
	(((x) & PCIE_CLIENT_DE_LTSSM_MASK) == PCIE_CLIENT_DE_LTSSM_L2)
