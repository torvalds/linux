...
static void cdns_pcie_host_enable_ptm_response(struct cdns_pcie *pcie) {
  ...
  cdns_pcie_writel(pcie, CDNS_PCIE_LM_PTM_CTRL,
...
static enum cdns_pcie_rp_bar cdns_pcie_host_find_min_bar(
    struct cdns_pcie_rc *rc, u64 size) {
...
static enum cdns_pcie_rp_bar cdns_pcie_host_find_max_bar(
    struct cdns_pcie_rc *rc, u64 size) {
  enum cdns_pcie_rp_bar bar, sel_bar;
  sel_bar = RP_BAR_UNDEFINED;
  for (bar = RP_BAR0; bar <= RP_NO_BAR; bar++) {
