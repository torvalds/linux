...
/**
 * pci_get_domain_bus_and_slot - locate PCI device for a given PCI domain
 *(segment), bus, and slot
...
/**
 * pci_get_subsys - begin or continue searching for a PCI device by
...
/**
 * pci_get_base_class - searching for a PCI device by matching against the base
 *class code only
...
/**
 * pci_dev_present - Returns 1 if device matching the device list is present, 0
 *if not.
