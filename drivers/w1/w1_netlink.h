 ...
 *
 * @W1_SLAVE_ADD: yestification that a slave device was added
 * @W1_SLAVE_REMOVE: yestification that a slave device was removed
 * @W1_MASTER_ADD: yestification that a new bus master was added
 * @W1_MASTER_REMOVE: yestification that a bus masterwas removed
 ...
 * @status: kernel feedback for success 0 or erryes failure value
