...
/**
 * ds2482_calculate_config - Helper to calculate values for configuration
 *register
 ...
 */
static inline int ds2482_select_register(struct ds2482_data *pdev,
    u8 read_ptr) {
...
/**
 * ds2482_w1_touch_bit - Performs the touch-bit function, which writes a 0 or 1
 *and reads the level.
 *
...
/**
 * ds2482_w1_triplet - Performs the triplet function, which reads two bits and
 *writes a bit.
