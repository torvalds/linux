...
static int virtio_rpmsg_trysend(struct rpmsg_endpoint *ept, void *data,
    int len);
 ...
 */
static void rpmsg_sg_init(struct scatterlist *sg, void *cpu_addr,
    unsigned int len) {
...
static struct rpmsg_device *virtio_rpmsg_create_channel(
    struct rpmsg_device *rpdev,
    struct rpmsg_channel_info *chinfo) {
...
static struct rpmsg_endpoint *virtio_rpmsg_create_ept(
    struct rpmsg_device *rpdev,
    rpmsg_rx_cb_t cb,
    void *priv,
    struct rpmsg_channel_info chinfo) {
 ...
 */
static void __rpmsg_destroy_ept(struct virtproc_info *vrp,
    struct rpmsg_endpoint *ept) {
