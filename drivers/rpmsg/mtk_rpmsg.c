...
static struct rpmsg_endpoint *__mtk_create_ept(
    struct mtk_rpmsg_rproc_subdev *mtk_subdev,
...
static struct rpmsg_endpoint *mtk_rpmsg_create_ept(struct rpmsg_device *rpdev,
...
static struct device_node *mtk_rpmsg_match_device_subnode(
    struct device_node *node, const char *channel) {
