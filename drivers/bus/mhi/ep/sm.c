...
int mhi_ep_set_mhi_state(struct mhi_ep_cntrl *mhi_cntrl,
  ...
  mhi_ep_mmio_masked_write(mhi_cntrl, EP_MHISTATUS, MHISTATUS_MHISTATE_MASK,
      mhi_state);
...
int mhi_ep_set_ready_state(struct mhi_ep_cntrl *mhi_cntrl) {
  ...
  mhi_state = mhi_ep_mmio_masked_read(mhi_cntrl, EP_MHISTATUS,
      MHISTATUS_MHISTATE_MASK);
  is_ready = mhi_ep_mmio_masked_read(mhi_cntrl, EP_MHISTATUS,
