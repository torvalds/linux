...
int mhi_ep_ring_add_element(struct mhi_ep_ring *ring,
    struct mhi_ring_element *element);
...
void mhi_ep_mmio_get_mhi_state(struct mhi_ep_cntrl *mhi_cntrl,
    enum mhi_state *state,
    bool *mhi_reset);
...
bool mhi_ep_check_mhi_state(struct mhi_ep_cntrl *mhi_cntrl,
    enum mhi_state cur_mhi_state,
    enum mhi_state mhi_state);
int mhi_ep_set_mhi_state(struct mhi_ep_cntrl *mhi_cntrl,
    enum mhi_state mhi_state);
