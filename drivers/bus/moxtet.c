...
static struct moxtet_device *moxtet_alloc_device(struct moxtet *moxtet) {
...
static struct moxtet_device *of_register_moxtet_device(struct moxtet *moxtet,
...
static void moxtet_register_devices_from_topology(struct moxtet *moxtet) {
  struct moxtet_device *dev;
  int i, ret;
