...
static int sunxi_rsb_device_match(struct device *dev,
...
static int sunxi_rsb_device_modalias(const struct device *dev,
...
static struct sunxi_rsb_ctx *regmap_sunxi_rsb_init_ctx(
    struct sunxi_rsb_device *rdev,
