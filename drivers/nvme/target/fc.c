...
static inline u64 nvmet_fc_makeconnid(struct nvmet_fc_tgt_assoc *assoc,
    u16 qid) {
...
static inline struct nvmet_fc_tgtport *targetport_to_tgtport(
    struct nvmet_fc_target_port *targetport) {
  return container_of(targetport, struct nvmet_fc_tgtport,
      fc_target_port);
}

static inline struct nvmet_fc_fcp_iod *nvmet_req_to_fod(
    struct nvmet_req *nvme_req) {
...
static struct nvmet_fc_ls_iod *nvmet_fc_alloc_ls_iod(
    struct nvmet_fc_tgtport *tgtport) {
  struct nvmet_fc_ls_iod *iod;
  unsigned long flags;
  spin_lock_irqsave(&tgtport->lock, flags);
...
static struct nvmet_fc_fcp_iod *nvmet_fc_alloc_fcp_iod(
    struct nvmet_fc_tgt_queue *queue) {
  struct nvmet_fc_fcp_iod *fod;
...
static struct nvmet_fc_tgt_queue *nvmet_fc_alloc_target_queue(
    struct nvmet_fc_tgt_assoc *assoc,
    u16 qid, u16 sqsize) {
  struct nvmet_fc_tgt_queue *queue;
  int ret;
...
static struct nvmet_fc_hostport *nvmet_fc_match_hostport(
    struct nvmet_fc_tgtport *tgtport, void *hosthandle) {
...
static struct nvmet_fc_hostport *nvmet_fc_alloc_hostport(
    struct nvmet_fc_tgtport *tgtport, void *hosthandle) {
...
static void nvmet_fc_delete_assoc(struct nvmet_fc_tgt_assoc *assoc) {
...
static bool nvmet_fc_assoc_exits(struct nvmet_fc_tgtport *tgtport,
    u64 association_id) {
...
static struct nvmet_fc_tgt_assoc *nvmet_fc_alloc_target_assoc(
    struct nvmet_fc_tgtport *tgtport, void *hosthandle) {
  struct nvmet_fc_tgt_assoc *assoc;
  unsigned long flags;
  bool done;
...
static struct nvmet_fc_tgt_assoc *nvmet_fc_find_target_assoc(
    struct nvmet_fc_tgtport *tgtport,
    u64 association_id) {
  struct nvmet_fc_tgt_assoc *assoc;
