...
static inline struct nvmet_rdma_rsp *nvmet_rdma_get_rsp(
    struct nvmet_rdma_queue *queue) {
...
static inline void nvmet_rdma_put_rsp(struct nvmet_rdma_rsp *rsp) {
  unsigned long flags;
...
static struct nvmet_rdma_cmd *nvmet_rdma_alloc_cmds(
    struct nvmet_rdma_device *ndev,
...
static int nvmet_rdma_alloc_rsps(struct nvmet_rdma_queue *queue) {
...
static struct nvmet_rdma_srq *nvmet_rdma_init_srq(
    struct nvmet_rdma_device *ndev) {
...
static struct nvmet_rdma_device *nvmet_rdma_find_get_device(
    struct rdma_cm_id *cm_id) {
...
static int nvmet_rdma_parse_cm_connect_req(struct rdma_conn_param *conn,
    struct nvmet_rdma_queue *queue) {
...
static struct nvmet_rdma_queue *nvmet_rdma_alloc_queue(
    struct nvmet_rdma_device *ndev,
    struct rdma_cm_id *cm_id,
