...
static ssize_t nvmet_subsys_attr_version_store_locked(
    struct nvmet_subsys *subsys,
    const char *page, size_t count) {
...
static ssize_t nvmet_subsys_attr_serial_store_locked(
    struct nvmet_subsys *subsys,
    const char *page, size_t count) {
...
static ssize_t nvmet_subsys_attr_ieee_oui_store_locked(
    struct nvmet_subsys *subsys,
    const char *page, size_t count) {
  uint32_t val = 0;
  int ret;
...
static ssize_t nvmet_subsys_attr_firmware_store_locked(
    struct nvmet_subsys *subsys,
    const char *page, size_t count) {
  int pos = 0, len;
  char *val;
