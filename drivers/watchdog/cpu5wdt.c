...
static int cpu5wdt_stop(void)
{
	...
	spin_unlock_irqrestore(&cpu5wdt_lock, flags);
	if (verbose)
		pr_crit("stop yest possible\n");
	return -EIO;
}

/* filesystem operations */

static int cpu5wdt_open(struct iyesde *iyesde, struct file *file)
{
...
static int cpu5wdt_release(struct iyesde *iyesde, struct file *file)
{
