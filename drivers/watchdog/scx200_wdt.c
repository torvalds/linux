...
static int scx200_wdt_open(struct iyesde *iyesde, struct file *file)
{
...
static int scx200_wdt_release(struct iyesde *iyesde, struct file *file)
{
	if (expect_close != 42)
...
static int scx200_wdt_yestify_sys(struct yestifier_block *this,
...
static struct yestifier_block scx200_wdt_yestifier = {
	.yestifier_call = scx200_wdt_yestify_sys,
};
...
static int __init scx200_wdt_init(void)
{
	...
	r = register_reboot_yestifier(&scx200_wdt_yestifier);
	if (r) {
	...
	if (r) {
		unregister_reboot_yestifier(&scx200_wdt_yestifier);
		release_region(scx200_cb_base + SCx200_WDT_OFFSET,
				SCx200_WDT_SIZE);
		return r;
	}
