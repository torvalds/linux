...
#define CVMX_GSERX_SCRATCH(offset) (CVMX_ADD_IO_SEG(0x0001180090000020ull) \
  + ((offset) & 15) * 0x1000000ull)
...
static int __init octeon_wdt_init(void) {
  ...
  do {
    max_timeout_sec--;
    timeout_cnt = ((octeon_get_io_clock_rate() / divisor) * max_timeout_sec) >>
        8;
