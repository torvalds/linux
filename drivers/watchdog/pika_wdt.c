...
static inline void pikawdt_reset(void)
{
	 ...
	 *           Once enabled, it canyest be disabled. The watchdog can be
...
static void pikawdt_ping(struct timer_list *unused)
{
	if (time_before(jiffies, pikawdt_private.next_heartbeat) ||
			(!yeswayout && !pikawdt_private.open)) {
		pikawdt_reset();
 ...
 */
static int pikawdt_open(struct iyesde *iyesde, struct file *file)
{
 ...
 */
static int pikawdt_release(struct iyesde *iyesde, struct file *file)
{
	/* stop internal ping */
