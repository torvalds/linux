...
static void rdc321x_wdt_start(void)
{
	...
	/* if process dies, counter is yest decremented */
...
static int rdc321x_wdt_open(struct iyesde *iyesde, struct file *file)
{
...
static int rdc321x_wdt_release(struct iyesde *iyesde, struct file *file)
{
