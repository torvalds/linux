 ...
 *
 *	(c) Copyright 2005  Jose Goncalves <jose.goncalves@iyesv.pt>
 *
...
static int __init w83977f_wdt_init(void)
{
	...
	pr_info("initialized. timeout=%d sec (yeswayout=%d testmode=%d)\n",
...
MODULE_AUTHOR("Jose Goncalves <jose.goncalves@iyesv.pt>");
