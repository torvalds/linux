 ...
 */
static int sc27xx_fgu_get_boot_capacity(struct sc27xx_fgu_data *data,
    int *cap) {
...
static int sc27xx_fgu_cap_to_clbcnt(struct sc27xx_fgu_data *data,
    int capacity) {
  /*
  ...
  return DIV_ROUND_CLOSEST(
      cur_cap * 36 * data->cur_1000ma_adc * SC27XX_FGU_SAMPLE_HZ, 10);
}
