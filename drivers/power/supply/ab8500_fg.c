...
/**
 * ab8500_fg_load_comp_volt_to_capacity() - Load compensated voltage based
 * capacity
 * @di:   pointer to the ab8500_fg structure
 *
 ...
 */
static int ab8500_fg_convert_mah_to_permille(struct ab8500_fg *di,
    int cap_mah) {
...
static ssize_t ab8500_fg_show(struct kobject *kobj, struct attribute *attr,
    char *buf) {
...
static ssize_t ab8500_fg_store(struct kobject *kobj, struct attribute *attr,
    const char *buf,
    size_t count) {
  struct ab8500_fg_sysfs_entry *entry;
  struct ab8500_fg *di;
