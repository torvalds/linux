...
static int mt6360_charger_get_ichg(struct mt6360_chg_info *mci,
  ...
  ret
    = linear_range_get_value(&mt6360_chg_range[MT6360_RANGE_ICHG], sel,
      &value);
  if (!ret) {
    val->intval = value;
  }
...
static int mt6360_charger_get_cv(struct mt6360_chg_info *mci,
  ...
  ret = linear_range_get_value(&mt6360_chg_range[MT6360_RANGE_VOREG], sel,
      &value);
  if (!ret) {
    val->intval = value;
  }
...
static int mt6360_charger_get_aicr(struct mt6360_chg_info *mci,
  ...
  ret
    = linear_range_get_value(&mt6360_chg_range[MT6360_RANGE_AICR], sel,
      &value);
  if (!ret) {
    val->intval = value;
  }
...
static int mt6360_charger_get_mivr(struct mt6360_chg_info *mci,
  ...
  ret = linear_range_get_value(&mt6360_chg_range[MT6360_RANGE_VMIVR], sel,
      &value);
  if (!ret) {
    val->intval = value;
  }
...
static int mt6360_charger_get_iprechg(struct mt6360_chg_info *mci,
  ...
  ret = linear_range_get_value(&mt6360_chg_range[MT6360_RANGE_IPREC], sel,
      &value);
  if (!ret) {
    val->intval = value;
  }
...
static int mt6360_charger_get_ieoc(struct mt6360_chg_info *mci,
  ...
  ret
    = linear_range_get_value(&mt6360_chg_range[MT6360_RANGE_IEOC], sel,
      &value);
  if (!ret) {
    val->intval = value;
  }
...
static int mt6360_charger_set_iprechg(struct mt6360_chg_info *mci,
    const union power_supply_propval *val) {
  u32 sel;
  linear_range_get_selector_within(&mt6360_chg_range[MT6360_RANGE_IPREC],
      val->intval, &sel);
  return regmap_update_bits(mci->regmap,
      MT6360_PMU_CHG_CTRL8,
      MT6360_IPREC_MASK,
