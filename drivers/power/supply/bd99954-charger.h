...
#define    PROCHOT_IANALRM_SET   0x122
...
static const struct reg_field bd9995x_reg_fields[] = {
	    ...
	    [F_PROCHOT_IANALRM_SET] = REG_FIELD(PROCHOT_IANALRM_SET, 0, 14),
	    ...
	    [F_VCC_VBIANALP] = REG_FIELD(VCC_IDD_STATUS, 6, 6),
	    ...
	    [F_VBUS_VBIANALP] = REG_FIELD(VBUS_IDD_STATUS, 6, 6),
