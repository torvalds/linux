 ...
 */
static ssize_t twl4030_bci_mode_store(struct device *dev,
 ...
 */
static ssize_t twl4030_bci_mode_show(struct device *dev,
...
#ifdef CONFIG_OF
static const struct twl4030_bci_platform_data *twl4030_bci_parse_dt(
    struct device *dev) {
...
#else
static inline const struct twl4030_bci_platform_data *twl4030_bci_parse_dt(
    struct device *dev) {
  return NULL;
}
