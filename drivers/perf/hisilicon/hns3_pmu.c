...
static bool hns3_pmu_is_enabled_global_mode(struct perf_event *event,
    struct hns3_pmu_event_attr *pmu_event) {
...
static bool hns3_pmu_is_enabled_func_queue_mode(struct perf_event *event,
    struct hns3_pmu_event_attr *pmu_event) {
  u16 queue_id = hns3_pmu_get_queue(event);
  u16 bdf = hns3_pmu_get_bdf(event);
...
static bool hns3_pmu_is_enabled_port_tc_mode(struct perf_event *event,
    struct hns3_pmu_event_attr *pmu_event) {
  u8 tc_id = hns3_pmu_get_tc(event);
...
static bool hns3_pmu_is_enabled_func_intr_mode(struct perf_event *event,
    struct hns3_pmu *hns3_pmu,
    struct hns3_pmu_event_attr *pmu_event) {
  u16 bdf = hns3_pmu_get_bdf(event);
...
static int hns3_pmu_probe(struct pci_dev *pdev,
