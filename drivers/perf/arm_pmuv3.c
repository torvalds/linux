...
static ssize_t armv8pmu_events_sysfs_show(struct device *dev,
...
static struct attribute *armv8_pmuv3_event_attrs[] = {
  ...
  ARMV8_EVENT_ATTR(br_mis_pred_retired,
  ...
  ARMV8_EVENT_ATTR(mem_access_checked_rd,
      ARMV8_MTE_PERFCTR_MEM_ACCESS_CHECKED_RD),
  ARMV8_EVENT_ATTR(mem_access_checked_wr,
      ARMV8_MTE_PERFCTR_MEM_ACCESS_CHECKED_WR),
  NULL,
};

static umode_t armv8pmu_event_attr_is_visible(struct kobject *kobj,
