...
#define AXI_MASKING_REVERT  0xffff0000  /* AXI_MASKING(MSB 16bits) + AXI_ID(LSB
                                         * 16bits) */
...
#define DDR_CAP_AXI_ID_FILTER_ENHANCED    0x3     /* support enhanced AXI ID
                                                   * filter */
#define DDR_CAP_AXI_ID_PORT_CHANNEL_FILTER  0x4 /* support AXI ID PORT CHANNEL
                                                 * filter */
