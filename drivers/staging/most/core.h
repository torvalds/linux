 ...
 * is violated memory leaks will occur, since the core driver does _yest_ track
 * MBOs it is currently yest in control of.
 *
 */
struct mbo {
	void *context;
 ...
 * This structure is allocated and initialized in the HDM. MostCore may yest
 ...
 *   interface instance. May be zero if the instance of the interface is yest
 ...
 *   cancel all transfers and synchroyesusly or asynchroyesusly return
 ...
 * @list: list_head
 * @name: component name
 * @probe_channel: function for core to yestify driver about channel connection
...
void most_interface_register_yestify(const char *mdev_name);
#endif /* MOST_CORE_H_ */
