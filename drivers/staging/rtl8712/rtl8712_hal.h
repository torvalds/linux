...
struct fw_priv {   /*8-bytes alignment required*/
	...
	unsigned char low_power_mode;/* 0: yesrmal mode, 1: low power mode*/
	/*--- long word 2 ----*/
	unsigned char lbk_mode; /*0x00: yesrmal, 0x03: MACLBK, 0x01: PHYLBK*/
	unsigned char mp_mode; /* 1: for MP use, 0: for yesrmal driver */
