...
static char *translate_scan(struct _adapter *padapter,
  ...
  iwe.cmd = SIOCGIWFREQ;
  {
    ...
    if (dsconfig >= 1
        && dsconfig <= sizeof(ieee80211_wlan_frequencies) / sizeof(long)) {
  ...
  iwe.u.qual.updated
    = (u8) (IW_QUAL_QUAL_INVALID | IW_QUAL_LEVEL_UPDATED
...
static int r871x_wx_set_pmkid(struct net_device *dev, struct iw_request_info *a,
  ...
  u8 strZeroMacAddress[ETH_ALEN] = {
    0x00
  };
  u8 strIssueBssid[ETH_ALEN] = {
    0x00
  };
