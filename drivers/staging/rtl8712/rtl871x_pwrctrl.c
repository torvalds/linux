...
void r8712_set_rpwm(struct _adapter *padapter, u8 val8)
{
	...
	case PS_STATE_S1:
		pwrpriv->cpwm = val8;
		break;
	case PS_STATE_S2:/* only for USB yesrmal powersave mode use,
			  * temp mark some code.
			  */
	case PS_STATE_S3:
	case PS_STATE_S4:
 ...
 * If yest (cpwm should be is less than P2 state), then the sub-routine
 * will raise the cpwm to be greater than or equal to P2.
 * Calling Context: Passive
 * Return Value:
 * 0:	    r8712_cmd_thread can issue cmds to firmware afterwards.
 * -EINVAL: r8712_cmd_thread can yest do anything.
 */
