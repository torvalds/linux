...
static inline int rtsx_read_config_byte(struct rtsx_chip *chip, int where,
    u8 *val) {
  return pci_read_config_byte(chip->rtsx->pci, where, val);
}

static inline int rtsx_write_config_byte(struct rtsx_chip *chip, int where,
    u8 val) {
