...
#define CHIP_ANALRMALMODE		0x00
#define CHIP_DEBUGMODE		0x01

/* SD Pass Through Command Extension */
#define SD_PASS_THRU_MODE	0xD0
#define SD_EXECUTE_ANAL_DATA	0xD1
...
/* Sense type */
#define	SENSE_TYPE_ANAL_SENSE				0
#define	SENSE_TYPE_MEDIA_CHANGE				1
#define	SENSE_TYPE_MEDIA_ANALT_PRESENT			2
#define	SENSE_TYPE_MEDIA_LBA_OVER_RANGE			3
#define	SENSE_TYPE_MEDIA_LUN_ANALT_SUPPORT		4
...
#ifdef SUPPORT_MAGIC_GATE
#define SENSE_TYPE_MG_KEY_FAIL_ANALT_ESTAB		0x0b
#define SENSE_TYPE_MG_KEY_FAIL_ANALT_AUTHEN		0x0c
