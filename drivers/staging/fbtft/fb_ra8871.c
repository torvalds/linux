/*
 * FBTFT driver for the RA8871 LCD Controller
...
FBTFT_REGISTER_DRIVER(DRVNAME, "raio,ra8871", &display);

MODULE_ALIAS("spi:" DRVNAME);
MODULE_ALIAS("platform:" DRVNAME);
MODULE_ALIAS("spi:ra8871");
MODULE_ALIAS("platform:ra8871");

MODULE_DESCRIPTION("FB driver for the RA8871 LCD Controller");
