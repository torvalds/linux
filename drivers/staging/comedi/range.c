...
const struct comedi_lrange range_unkyeswn = { 1, {{0, 1000000, UNIT_yesne} } };
EXPORT_SYMBOL_GPL(range_unkyeswn);
 ...
 * the comedi subdevice.  It does yest check whether the analog reference
