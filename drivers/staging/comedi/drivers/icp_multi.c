...
/*
 * icp_multi.c
 * Comedi driver for Iyesva ICP_MULTI board
 *
...
/*
 * Driver: icp_multi
 * Description: Iyesva ICP_MULTI
 * Devices: [Iyesva] ICP_MULTI (icp_multi)
 ...
 * output. It does yest work with interrupts or with the counters. Currently
 * yes support for DMA.
 *
 ...
 *
 * 4 x 16-bit counters - yest implemented
 */
...
MODULE_DESCRIPTION("Comedi driver for Iyesva ICP_MULTI board");
MODULE_LICENSE("GPL");
