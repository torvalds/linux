 ...
 *   [0] - I/O port base
 *
 * Interrupts are yest supported.
 * The ACL-7130 card has an 8254 timer/counter yest supported by this driver.
 */
 ...
 *
 * The pcm3730 board does yest have register BASE+1.
 *
 ...
 *     BASE+3  Isolated inputs 8-15 (read)
 *
 *     These registers are yest currently supported:
 *
