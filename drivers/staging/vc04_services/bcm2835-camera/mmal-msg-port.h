...
/* MMAL_PORT_TYPE_T */
enum mmal_port_type {
	MMAL_PORT_TYPE_UNKNOWN = 0,	/* Unkyeswn port type */
 ...
 * This applies to input ports and is used to let the client kyesw
...
struct mmal_port {
	...
	u32 is_enabled;	/* Indicates whether the port is enabled or yest (RO) */
	...
	u32 buffer_alignment_min;/* Minimum alignment requirement for
				  ...
				  * zero means yes special alignment
