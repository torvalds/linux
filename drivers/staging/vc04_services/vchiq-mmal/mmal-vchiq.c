...
static struct mmal_msg_context *get_msg_context(
    struct vchiq_mmal_instance *instance) {
...
static struct mmal_msg_context *lookup_msg_context(
    struct vchiq_mmal_instance *instance, int handle) {
...
static int buffer_from_host(struct vchiq_mmal_instance *instance,
  ...
  vchiq_use_service(instance->vchiq_instance, instance->service_handle);
  ret = vchiq_queue_kernel_message(instance->vchiq_instance,
      instance->service_handle, &m,
...
static int service_callback(struct vchiq_instance *vchiq_instance,
  ...
  struct vchiq_mmal_instance *instance = vchiq_get_service_userdata(
      vchiq_instance, handle);
  u32 msg_len;
  struct mmal_msg *msg;
  struct mmal_msg_context *msg_context;
  if (!instance) {
...
static void port_to_mmal_msg(struct vchiq_mmal_port *port,
    struct mmal_port *p) {
...
release_msg:
  vchiq_release_message(instance->vchiq_instance, instance->service_handle,
      rmsg_handle);
  return ret;
}
...
int vchiq_mmal_finalise(struct vchiq_mmal_instance *instance) {
  ...
  vchiq_use_service(instance->vchiq_instance, instance->service_handle);
  status = vchiq_close_service(instance->vchiq_instance,
