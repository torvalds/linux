...
static int bcm2835_audio_send_msg_locked(
  ...
  status = vchiq_queue_kernel_message(
      instance->alsa_stream->chip->vchi_ctx->instance,
...
static int audio_vchi_callback(struct vchiq_instance *vchiq_instance,
  ...
  struct bcm2835_audio_instance *instance = vchiq_get_service_userdata(
      vchiq_instance,
      handle);
  struct vc_audio_msg *m;
...
static int vc_vchi_audio_init(struct vchiq_instance *vchiq_instance,
    struct bcm2835_audio_instance *instance) {
...
int bcm2835_new_vchi_ctx(struct device *dev,
...
int bcm2835_audio_write(struct bcm2835_alsa_stream *alsa_stream,
  ...
  if (!instance->max_packet) {
    ...
    status = vchiq_bulk_transmit(vchiq_instance, instance->service_handle, src,
        count,
