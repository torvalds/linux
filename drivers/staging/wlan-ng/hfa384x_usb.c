...
static int usbctlx_get_status(const struct hfa384x_usb_statusresp *cmdresp,
    struct hfa384x_cmdresult *result);

static void usbctlx_get_rridresult(const struct hfa384x_usb_rridresp *rridresp,
    struct hfa384x_rridresult *result);

/* ---------------------------------------------------
 * Low level req/resp CTLX formatters and submitters*/
static inline int hfa384x_docmd(struct hfa384x *hw,
    struct hfa384x_metacmd *cmd);

static int hfa384x_dorrid(struct hfa384x *hw,
    enum cmd_mode mode,
    u16 rid,
    void *riddata,
...
static int hfa384x_dowrid(struct hfa384x *hw,
    enum cmd_mode mode,
    u16 rid,
    void *riddata,
    unsigned int riddatalen,
...
static int hfa384x_dormem(struct hfa384x *hw,
    u16 page,
    u16 offset,
    void *data,
    unsigned int len);

static int hfa384x_dowmem(struct hfa384x *hw,
    u16 page,
    u16 offset,
    void *data,
    unsigned int len);
