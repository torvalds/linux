...
static struct gbaudio_data_connection *find_data(
...
static struct gbaudio_stream_params *find_dai_stream_params(
    struct gbaudio_codec_info *codec, int id, int stream) {
...
static int gbaudio_module_disable_tx(struct gbaudio_module_info *module,
    int id) {
  int ret;
...
static int gbaudio_module_disable_rx(struct gbaudio_module_info *module,
    int id) {
  int ret;
  u16 data_cport, cportid, i2s_port;
  int module_state;
