...
/* For temporal analise reduction DVS etc., format FRAME_FMT_YUV_LINE */
...
struct imgu_css_format {
	...
	u8 chroma_decim;	/* Chroma plane decimation, 0=anal chroma plane */
