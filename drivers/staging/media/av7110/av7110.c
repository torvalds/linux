...
static void init_av7110_av(struct av7110 *av7110) {
  ...
  ret
    = av7110_fw_cmd(av7110, COMTYPE_ENCODER, SetWSSConfig, 2, 3, wss_cfg_16_9);
  if (ret < 0) {
  ...
  if (dev->pci->subsystem_vendor == 0x13c2
  ...
  if (av7110->adac_type == DVB_ADAC_NONE
  ...
  if (dev->pci->subsystem_vendor == 0x13c2
      && dev->pci->subsystem_device == 0x000e) {
    ...
    case DATA_MPEG_VIDEO_EVENT:
      {
        ...
        av7110->video_size.w = irdebi(av7110, DEBINOSWAP, STATUS_MPEG_WIDTH, 0,
            2);
...
static int StartHWFilter(struct dvb_demux_filter *dvbdmxfilter) {
  ...
  if (ret != 0 || handle >= 32) {
    printk(
        KERN_ERR "dvb-ttpci: %s error  buf %04x %04x %04x %04x  ret %d  handle %04x\n",
...
static int StopHWFilter(struct dvb_demux_filter *dvbdmxfilter) {
  ...
  if (ret != 0 || answ[1] != handle) {
    printk(
        KERN_ERR "dvb-ttpci: %s error  cmd %04x %04x %04x  ret %x  resp %04x %04x  pid %d\n",
...
static int av7110_set_tone(struct dvb_frontend *fe,
...
static int get_firmware(struct av7110 *av7110) {
  ...
  if (ret) {
    if (ret == -ENOENT) {
      printk(
          KERN_ERR "dvb-ttpci: could not load firmware, file not found: dvb-ttpci-01.fw\n");
      printk(
          KERN_ERR "dvb-ttpci: usually this should be in /usr/lib/hotplug/firmware or /lib/firmware\n");
      printk(
          KERN_ERR "dvb-ttpci: and can be downloaded from https://linuxtv.org/download/dvb/firmware/\n");
    } else {
...
static int alps_tdlb7_request_firmware(struct dvb_frontend *fe,
...
static int nexusca_stv0297_tuner_set_params(struct dvb_frontend *fe) {
  ...
  u8 data[4];
  struct i2c_msg msg = {
    .addr = 0x63, .flags = 0, .buf = data, .len = sizeof(data)
  };
  struct i2c_msg readmsg = {
    .addr = 0x63, .flags = I2C_M_RD, .buf = data, .len = 1
  };
  int i;
...
static int av7110_fe_read_status(struct dvb_frontend *fe,
  ...
  if (!ret) {
    if (((*status ^ av7110->fe_status) & FE_HAS_LOCK)
        && (*status & FE_HAS_LOCK)) {
...
static int av7110_fe_dishnetwork_send_legacy_command(struct dvb_frontend *fe,
    unsigned long cmd) {
  struct av7110 *av7110 = fe->dvb->priv;
  int ret = av7110_fe_lock_fix(av7110, 0);
  if (!ret) {
...
static int frontend_init(struct av7110 *av7110) {
  ...
  if (av7110->dev->pci->subsystem_vendor == 0x110a) {
    ...
    switch (av7110->dev->pci->subsystem_device) {
      ...
      case 0x1002: // Hauppauge/TT WinTV DVB-S rev1.3SE
        ...
        av7110->fe = dvb_attach(ves1x93_attach, &alps_bsrv2_config,
            &av7110->i2c_adap);
        if (av7110->fe) {
        ...
        av7110->fe = dvb_attach(stv0299_attach, &alps_bsru6_config,
            &av7110->i2c_adap);
        if (av7110->fe) {
        ...
        av7110->fe = dvb_attach(tda8083_attach, &grundig_29504_451_config,
            &av7110->i2c_adap);
        if (av7110->fe) {
          av7110->fe->ops.tuner_ops.set_params
        ...
        switch (av7110->dev->pci->subsystem_device) {
          ...
          case 0x0003:
            ...
            av7110->fe = dvb_attach(ves1820_attach, &alps_tdbe2_config,
                &av7110->i2c_adap,
                read_pwm(av7110));
            if (av7110->fe) {
              av7110->fe->ops.tuner_ops.set_params
      ...
      case 0x0008: // Hauppauge/TT DVB-T
        // Grundig 29504-401
        av7110->fe = dvb_attach(l64781_attach, &grundig_29504_401_config,
            &av7110->i2c_adap);
        if (av7110->fe) {
          av7110->fe->ops.tuner_ops.set_params
      ...
      case 0x000A: // Hauppauge/TT Nexus-CA rev1.X
        av7110->fe = dvb_attach(stv0297_attach, &nexusca_stv0297_config,
            &av7110->i2c_adap);
        if (av7110->fe) {
          av7110->fe->ops.tuner_ops.set_params
          ...
          saa7146_setgpio(av7110->dev, 1, SAA7146_GPIO_OUTLO); // TDA9819
                                                               // pin9(STD)
          saa7146_setgpio(av7110->dev, 3, SAA7146_GPIO_OUTLO); // TDA9819
                                                               // pin30(VIF)
      ...
      case 0x000E: /* Hauppauge/TT Nexus-S rev 2.3 */
        /* ALPS BSBE1 */
        av7110->fe = dvb_attach(stv0299_attach, &alps_bsbe1_config,
            &av7110->i2c_adap);
        if (av7110->fe) {
          av7110->fe->ops.tuner_ops.set_params = alps_bsbe1_tuner_set_params;
          av7110->fe->tuner_priv = &av7110->i2c_adap;
          if (dvb_attach(lnbp21_attach, av7110->fe, &av7110->i2c_adap, 0,
              0) == NULL) {
  ...
  if (!av7110->fe) {
    ...
    FE_FUNC_OVERRIDE(av7110->fe->ops.set_tone, av7110->fe_set_tone,
        av7110_fe_set_tone);
    FE_FUNC_OVERRIDE(av7110->fe->ops.set_voltage, av7110->fe_set_voltage,
    ...
    FE_FUNC_OVERRIDE(av7110->fe->ops.set_frontend, av7110->fe_set_frontend,
...
#define RPS_IRQ 0
  ...
  saa7146_i2c_adapter_prepare(dev, &av7110->i2c_adap,
  ...
  if (i2c_readreg(av7110, 0xaa,
      0) == 0x4f && i2c_readreg(av7110, 0xaa, 1) == 0x45) {
  ...
  if (av7110->full_ts) {
    ...
    /* dma3 */
    saa7146_write(dev, PCI_BT_V1,
        0x001c0000 | (saa7146_read(dev, PCI_BT_V1) & ~0x001f0000));
...
static const struct pci_device_id pci_tbl[] = {
  ...
  /*  MAKE_EXTENSION_PCI(???, 0x13c2, 0x0005), UNDEFINED CARD */// Technisat
                                                                // SkyStar1
  /*  MAKE_EXTENSION_PCI(???, 0x13c2, 0x0009), UNDEFINED CARD */// TT/Hauppauge
                                                                // WinTV
                                                                // Nexus-CA
                                                                // v????
