...
#define SB_WIDE SAA7146_GPIO_OUTHI  /* SlowBlank 6V  (16/9-Mode) (not
                                     * implemented) */
 ...
 * single word writes*/
static inline void iwdebi(struct av7110 *av7110, u32 config, int addr, u32 val,
    unsigned int count) {
...
extern int av7110_diseqc_send(struct av7110 *av7110, int len, u8 *msg,
    unsigned long burst);
