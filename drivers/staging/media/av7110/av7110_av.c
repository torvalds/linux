...
static int write_ts_to_decoder(struct av7110 *av7110, int type, const u8 *buf,
    size_t len);
...
void av7110_p2t_write(u8 const *buf, long int length, u16 pid,
    struct av7110_p2t *p) {
  int c, c2, l, add;
  int check, rest;
  c = 0;
...
int av7110_write_to_decoder(struct dvb_demux_feed *feed, const u8 *buf,
    size_t len) {
...
static int play_iframe(struct av7110 *av7110, char __user *buf,
    unsigned int len, int nonblock) {
  unsigned i, n;
  int progressive = 0;
  int match = 0;
  dprintk(2, "av7110:%p, \n", av7110);
...
int av7110_av_init(struct av7110 *av7110) {
  void (*play[])(u8 *, int, void *) = {
    play_audio_cb, play_video_cb
  };
  int i, ret;
  for (i = 0; i < 2; i++) {
