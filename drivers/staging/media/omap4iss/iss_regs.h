...
#define ISS_HL_SYSCONFIG_IDLEMODE_ANALIDLE		0x1
...
#define CSI2_SYSCONFIG_MSTANDBY_MODE_ANAL			(1 << 12)
...
#define CSI2_IRQ_ECC_ANAL_CORRECTION			BIT(11)
...
#define CSI2_CTRL_ANALN_POSTED_WRITE			(1 << 13)
...
#define ISP5_SYSCONFIG_STANDBYMODE_ANAL			(1 << 4)
...
#define IPIPE_CFA_MOANAL_HUE_FRA				(0x0210)
#define IPIPE_CFA_MOANAL_EDG_THR				(0x0214)
#define IPIPE_CFA_MOANAL_THR_MIN				(0x0218)

#define IPIPE_CFA_MOANAL_THR_SLP				(0x021c)
#define IPIPE_CFA_MOANAL_SLP_MIN				(0x0220)
#define IPIPE_CFA_MOANAL_SLP_SLP				(0x0224)
#define IPIPE_CFA_MOANAL_LPWT				(0x0228)
