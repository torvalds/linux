...
static struct v4l2_mbus_framefmt *__ipipe_get_format(
 ...
 * @fmt: Format
 */
static void ipipe_try_format(struct iss_ipipe_device *ipipe,
    struct v4l2_subdev_state *sd_state,
    unsigned int pad,
 ...
 */
static int ipipe_init_formats(struct v4l2_subdev *sd,
