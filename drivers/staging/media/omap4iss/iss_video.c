...
static struct v4l2_subdev *iss_video_remote_subdev(struct iss_video *video,
    u32 *pad) {
...
static struct iss_video *iss_video_far_end(struct iss_video *video,
...
static int iss_video_check_format(struct iss_video *video,
    struct iss_video_fh *vfh) {
  struct v4l2_mbus_framefmt format;
...
static int iss_video_querycap(struct file *file, void *fh,
...
static int iss_video_enum_format(struct file *file, void *fh,
...
static int iss_video_get_format(struct file *file, void *fh,
...
static int iss_video_set_format(struct file *file, void *fh,
    struct v4l2_format *format) {
  struct iss_video_fh *vfh = to_iss_video_fh(fh);
  struct iss_video *video = video_drvdata(file);
...
static int iss_video_try_format(struct file *file, void *fh,
    struct v4l2_format *format) {
  struct iss_video *video = video_drvdata(file);
  struct v4l2_subdev_format fmt = {
    .which = V4L2_SUBDEV_FORMAT_ACTIVE,
...
static int iss_video_get_selection(struct file *file, void *fh,
...
static int iss_video_set_selection(struct file *file, void *fh,
    struct v4l2_selection *sel) {
  struct iss_video *video = video_drvdata(file);
  struct v4l2_subdev *subdev;
  struct v4l2_subdev_selection sdsel = {
...
static int iss_video_get_param(struct file *file, void *fh,
...
static int iss_video_set_param(struct file *file, void *fh,
    struct v4l2_streamparm *a) {
  struct iss_video_fh *vfh = to_iss_video_fh(fh);
  struct iss_video *video = video_drvdata(file);
  if (video->type != V4L2_BUF_TYPE_VIDEO_OUTPUT
...
static int iss_video_reqbufs(struct file *file, void *fh,
    struct v4l2_requestbuffers *rb) {
  struct iss_video_fh *vfh = to_iss_video_fh(fh);
  return vb2_reqbufs(&vfh->queue, rb);
}

static int iss_video_querybuf(struct file *file, void *fh,
    struct v4l2_buffer *b) {
  struct iss_video_fh *vfh = to_iss_video_fh(fh);
  return vb2_querybuf(&vfh->queue, b);
}

static int iss_video_qbuf(struct file *file, void *fh, struct v4l2_buffer *b) {
  struct iss_video *video = video_drvdata(file);
  struct iss_video_fh *vfh = to_iss_video_fh(fh);
  return vb2_qbuf(&vfh->queue, video->video.v4l2_dev->mdev, b);
}

static int iss_video_expbuf(struct file *file, void *fh,
    struct v4l2_exportbuffer *e) {
  struct iss_video_fh *vfh = to_iss_video_fh(fh);
  return vb2_expbuf(&vfh->queue, e);
}

static int iss_video_dqbuf(struct file *file, void *fh, struct v4l2_buffer *b) {
  struct iss_video_fh *vfh = to_iss_video_fh(fh);
 ...
 * not sleep.
 */
static int iss_video_streamon(struct file *file, void *fh,
...
static int iss_video_streamoff(struct file *file, void *fh,
    enum v4l2_buf_type type) {
  struct iss_video_fh *vfh = to_iss_video_fh(fh);
  struct iss_video *video = video_drvdata(file);
  struct iss_pipeline *pipe = to_iss_pipeline(&video->video.entity);
...
static int iss_video_enum_input(struct file *file, void *fh,
...
static int iss_video_g_input(struct file *file, void *fh, unsigned int *input) {
  *input = 0;
  return 0;
}

static int iss_video_s_input(struct file *file, void *fh, unsigned int input) {
