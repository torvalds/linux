 ...
 */
static inline struct list_head *to_pad_vdev_list(struct v4l2_subdev *sd,
    int pad_index) {
...
static inline const struct imx_media_pixfmt *imx_media_find_ipu_format(u32 code,
