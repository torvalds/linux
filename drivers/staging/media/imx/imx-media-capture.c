...
static const struct imx_media_pixfmt *capture_find_format(u32 code,
    u32 fourcc) {
...
static const struct imx_media_pixfmt *__capture_try_fmt(
    struct v4l2_pix_format *pixfmt, struct v4l2_rect *compose) {
...
static const struct imx_media_pixfmt *__capture_legacy_try_fmt(
...
struct imx_media_buffer *imx_media_capture_device_next_buf(
...
struct imx_media_video_dev *imx_media_capture_device_init(struct device *dev,
