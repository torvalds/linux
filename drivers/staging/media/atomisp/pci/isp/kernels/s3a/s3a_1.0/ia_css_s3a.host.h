...
void ia_css_s3a_configure(
  unsigned int raw_bit_depth);

void ia_css_s3a_encode(
...
void ia_css_s3a_dump(
  const struct sh_css_isp_s3a_params *s3a,
  unsigned int level);

void ia_css_s3a_debug_dtrace(
  const struct ia_css_3a_config *config,
  unsigned int level);
#endif

void ia_css_s3a_hmem_decode(
  struct ia_css_3a_statistics *host_stats,
  const struct ia_css_bh_table *hmem_buf);

void ia_css_s3a_dmem_decode(
  struct ia_css_3a_statistics *host_stats,
  const struct ia_css_3a_output *isp_stats);

void ia_css_s3a_vmem_decode(
  struct ia_css_3a_statistics *host_stats,
