 ...
 *  This structure describes the coefficients that are needed for the dvs
 *statistics.
 */
...
struct ia_css_dvs_coefficients {
  ...
  s16 *hor_coefs; /** the pointer to int16_t[grid.num_hor_coefs *
                   * IA_CSS_DVS_NUM_COEF_TYPES]
                   * containing the horizontal coefficients */
  s16 *ver_coefs; /** the pointer to int16_t[grid.num_ver_coefs *
                   * IA_CSS_DVS_NUM_COEF_TYPES]
                   * containing the vertical coefficients */
};

/* DVS 1.0 Statistics.
 *  This structure describes the statistics that are generated using the
...
struct ia_css_dvs_statistics {
  struct ia_css_dvs_grid_info
      grid; /** grid info contains the dimensions of the dvs grid */
  s32 *hor_proj;  /** the pointer to int16_t[grid.height *
                   * IA_CSS_DVS_NUM_COEF_TYPES]
                   * containing the horizontal projections */
  s32 *ver_proj;  /** the pointer to int16_t[grid.width *
                   * IA_CSS_DVS_NUM_COEF_TYPES]
