...
/* DVS 2.0 Coefficients. This structure describes the coefficients that are
 * needed for the dvs statistics.
 *  e.g. hor_coefs.odd_real is the pointer to int16_t[grid.num_hor_coefs]
 *containing the horizontal odd real
 *  coefficients.
 */
struct ia_css_dvs2_coefficients {
  ...
  struct ia_css_dvs2_coef_types
      hor_coefs; /** struct with pointers that contain the horizontal
                  * coefficients */
  struct ia_css_dvs2_coef_types
...
/* DVS 2.0 Statistics. This structure describes the statistics that are
 * generated using the provided coefficients.
 *  e.g. hor_prod.odd_real is the pointer to
 *int16_t[grid.aligned_height][grid.aligned_width] containing
 *  the horizontal odd real statistics. Valid statistics data area is
 *int16_t[0..grid.height-1][0..grid.width-1]
 */
