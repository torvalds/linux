...
#include "isp/kernels/ctc/ctc_1.0/ia_css_ctc_types.h"  /* FIXME: Needed for
                                                        * ia_css_vamem_type */
...
#define IA_CSS_VAMEM_1_GAMMA_TABLE_SIZE         BIT( \
    IA_CSS_VAMEM_1_GAMMA_TABLE_SIZE_LOG2)

/* Number of elements in the gamma table. */
#define IA_CSS_VAMEM_2_GAMMA_TABLE_SIZE_LOG2    8
#define IA_CSS_VAMEM_2_GAMMA_TABLE_SIZE         ((1U << \
      IA_CSS_VAMEM_2_GAMMA_TABLE_SIZE_LOG2) + 1)
