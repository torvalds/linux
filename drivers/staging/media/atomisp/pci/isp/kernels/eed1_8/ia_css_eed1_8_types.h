...
/* parameter list is based on ISP261 CSS API public parameter list_all.xlsx from
 * 28-01-2015 */
...
struct ia_css_eed1_8_config {
  ...
  s32 fcthres_0;  /** Threshold to prevent chroma coring due to noise or green
                   * disparity in dark region. */
  s32 fcthres_1;  /** Threshold to prevent chroma coring due to noise or green
                   * disparity in bright region. */
  s32 fc_sat_coef;  /** How much color saturation to maintain in high color
                     * saturation region. */
  s32 fc_coring_prm;  /** Chroma coring coefficient for tint color suppression.
                       * */

  s32 aerel_thres0; /** Threshold for Non-Directional Reliability at dark
                     * region. */
  s32 aerel_gain0;  /** Gain for Non-Directional Reliability at dark region. */
  s32 aerel_thres1; /** Threshold for Non-Directional Reliability at bright
                     * region. */
  ...
  s32 dew_enhance_seg_x[IA_CSS_NUMBER_OF_DEW_ENHANCE_SEGMENTS];   /** Segment
                                                                   * data for
                                                                   * directional
                                                                   * edge
                                                                   * weight: X.
                                                                   * */
  s32 dew_enhance_seg_y[IA_CSS_NUMBER_OF_DEW_ENHANCE_SEGMENTS];   /** Segment
                                                                   * data for
                                                                   * directional
                                                                   * edge
                                                                   * weight: Y.
