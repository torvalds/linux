...
struct ia_css_tdf_config {
  s32 thres_flat_table[64]; /** Final optimized strength table of NR for flat
                             * region. */
  s32 thres_detail_table[64]; /** Final optimized strength table of NR for
                               * detail region. */
  s32 epsilon_0;    /** Coefficient to control variance for dark area (for flat
                     * region). */
  s32 epsilon_1;    /** Coefficient to control variance for bright area (for
                     * flat region). */
