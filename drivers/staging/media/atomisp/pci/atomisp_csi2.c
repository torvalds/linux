...
static void atomisp_csi2_configure_isp2401(struct atomisp_sub_device *asd) {
   ...
   */
  static const short int coeff_clk_termen[] = {
    0, 0
  };
  static const short int coeff_clk_settle[] = {
    95, -8
  };
  static const short int coeff_dat_termen[] = {
    0, 0
  };
  static const short int coeff_dat_settle[] = {
    85, -2
  };
