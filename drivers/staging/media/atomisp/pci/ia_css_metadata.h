...
struct ia_css_metadata_config {
  enum atomisp_input_format data_type; /** Data type of CSI-2 embedded
                                        ...
                                        * ATOMISP_INPUT_FORMAT_EMBEDDED. For
                                        * certain sensors, user can choose
                                        * non-default data type for embedded
                                        * data. */
 ...
 * @param[in]   metadata_info Metadata info struct, contains details on metadata
 *buffers.
