...
enum ia_css_frame_format {
  ...
  IA_CSS_FRAME_FORMAT_NV12_TILEY, /** 12 bit YUV 420, Intel proprietary tiled
                                   * format, TileY */
...
/* NOTE: IA_CSS_FRAME_FORMAT_NUM was purposely defined outside of enum type
 *ia_css_frame_format,
 *       because of issues this would cause with the Clockwork code checking
 *tool.*/
