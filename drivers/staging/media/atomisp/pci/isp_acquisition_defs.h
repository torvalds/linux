...
#define _ISP_ACQUISITION_REG_ALIGN                4  /* assuming 32 bit control
                                                      * bus width */
...
#define ACQ_FSM_STATE_INFO_REG_WIDTH              ((MEM2STREAM_FSM_STATE_BITS \
  * 3) + (ACQ_SYNCHRONIZER_FSM_STATE_BITS * 3))
...
#define ACQ_TOKEN_WIDTH                           (ACQ_TOKEN_ID_MSB \
  - ACQ_TOKEN_ID_LSB + 1) // 4
...
#define ACQ_PACKET_MEM_REGION_ID_TOKEN_MSB        12    /* only for
                                                         * capt_end_of_packet_written
                                                         * */
#define ACQ_PACKET_MEM_REGION_ID_TOKEN_LSB        4   /* only for
                                                       * capt_end_of_packet_written
                                                       * */
...
#define ACQ_YUV420_10_DATA                      25   /* 01 1001  YUV420 10-bit
                                                      ...
                                                      *   
                                                      *                       */
#define ACQ_YUV420_8L_DATA                      26   /* 01 1010   YUV420 8-bit
                                                      * legacy
                                                      *   
                                                      *   
                                                      *   
...
#define ACQ_RAW14_DATA             45   /* 10 1101   RAW14
                                         ...
                                         *   
                                         *                                    */
#define ACQ_USR_DEF_1_DATA             48   /* 11 0000    JPEG [User Defined
                                             * 8-bit Data Type 1]            */
#define ACQ_USR_DEF_2_DATA             49   /* 11 0001    User Defined 8-bit
                                             * Data Type 2                   */
#define ACQ_USR_DEF_3_DATA             50   /* 11 0010    User Defined 8-bit
                                             * Data Type 3                   */
#define ACQ_USR_DEF_4_DATA             51   /* 11 0011    User Defined 8-bit
                                             * Data Type 4                   */
#define ACQ_USR_DEF_5_DATA             52   /* 11 0100    User Defined 8-bit
                                             * Data Type 5                   */
#define ACQ_USR_DEF_6_DATA             53   /* 11 0101    User Defined 8-bit
                                             * Data Type 6                   */
#define ACQ_USR_DEF_7_DATA             54   /* 11 0110    User Defined 8-bit
                                             * Data Type 7                   */
#define ACQ_USR_DEF_8_DATA             55   /* 11 0111    User Defined 8-bit
                                             * Data Type 8                   */
#define ACQ_Emb_DATA               18   /* 01 0010    embedded eight bit non
                                         * image data                */
...
#define ACQ_GEN_SH1_DATA             8   /* 00 1000  Generic Short Packet Code 1
                                          *                        */
#define ACQ_GEN_SH2_DATA             9   /* 00 1001    Generic Short Packet Code
                                          * 2                      */
#define ACQ_GEN_SH3_DATA             10   /* 00 1010    Generic Short Packet
                                           * Code 3                      */
#define ACQ_GEN_SH4_DATA             11   /* 00 1011    Generic Short Packet
                                           * Code 4                      */
#define ACQ_GEN_SH5_DATA             12   /* 00 1100    Generic Short Packet
                                           * Code 5                      */
#define ACQ_GEN_SH6_DATA             13   /* 00 1101    Generic Short Packet
                                           * Code 6                      */
#define ACQ_GEN_SH7_DATA             14   /* 00 1110    Generic Short Packet
                                           * Code 7                      */
#define ACQ_GEN_SH8_DATA             15   /* 00 1111    Generic Short Packet
                                           * Code 8                      */
#define ACQ_YUV420_8_CSPS_DATA           28   /* 01 1100   YUV420 8-bit (Chroma
                                               * Shifted Pixel Sampling)      */
#define ACQ_YUV420_10_CSPS_DATA          29   /* 01 1101   YUV420 10-bit (Chroma
                                               * Shifted Pixel Sampling)     */
