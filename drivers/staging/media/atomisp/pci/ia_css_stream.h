 ...
 *
 */
struct ia_css_binary *ia_css_stream_get_shading_correction_binary(
  const struct ia_css_stream *stream);

struct ia_css_binary *ia_css_stream_get_dvs_binary(
  const struct ia_css_stream *stream);

struct ia_css_binary *ia_css_stream_get_3a_binary(
  const struct ia_css_stream *stream);
...
const struct ia_css_fpn_table *ia_css_get_fpn_table(
  struct ia_css_stream *stream);
