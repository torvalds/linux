...
#define _REG_GP_TIMER_ENABLE_ID(timer_id)        HIVE_GP_TIMER_ENABLE_REG_IDX( \
    timer_id)
#define _REG_GP_TIMER_VALUE_ID(timer_id)   HIVE_GP_TIMER_VALUE_REG_IDX(timer_id, \
...
#define _REG_GP_TIMER_SIGNAL_SELECT_ID(timer_id) \
  HIVE_GP_TIMER_SIGNAL_SELECT_REG_IDX(timer_id, HIVE_GP_TIMER_NUM_COUNTERS)
...
#define _REG_GP_TIMER_IRQ_TIMER_SELECT_ID(irq_id)   \
  HIVE_GP_TIMER_IRQ_TIMER_SELECT_REG_IDX(irq_id, HIVE_GP_TIMER_NUM_COUNTERS, \
    HIVE_GP_TIMER_NUM_IRQS)
