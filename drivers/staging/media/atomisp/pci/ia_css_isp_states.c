...
static void ia_css_initialize_aa_state(
      ...
      "ia_css_initialize_aa_state() enter:\n");
  {
    ...
    if (size) {
      memset(&binary->mem_params.params[IA_CSS_PARAM_CLASS_STATE][
...
static void ia_css_initialize_cnr_state(
    const struct ia_css_binary *binary) {
  ia_css_debug_dtrace(IA_CSS_DEBUG_TRACE_PRIVATE,
      "ia_css_initialize_cnr_state() enter:\n");
  {
    ...
    if (size) {
      ia_css_init_cnr_state(
          &binary->mem_params.params[IA_CSS_PARAM_CLASS_STATE][IA_CSS_ISP_VMEM].address[
            offset],
          size);
    }
  }
...
static void ia_css_initialize_cnr2_state(
    const struct ia_css_binary *binary) {
  ia_css_debug_dtrace(IA_CSS_DEBUG_TRACE_PRIVATE,
      "ia_css_initialize_cnr2_state() enter:\n");
  {
    ...
    unsigned int offset
      = binary->info->mem_offsets.offsets.state->vmem.cnr2.offset;
    if (size) {
...
static void ia_css_initialize_dp_state(
    const struct ia_css_binary *binary) {
  ia_css_debug_dtrace(IA_CSS_DEBUG_TRACE_PRIVATE,
...
static void ia_css_initialize_de_state(
    const struct ia_css_binary *binary) {
  ia_css_debug_dtrace(IA_CSS_DEBUG_TRACE_PRIVATE,
...
static void ia_css_initialize_tnr_state(
    const struct ia_css_binary *binary) {
  ia_css_debug_dtrace(IA_CSS_DEBUG_TRACE_PRIVATE,
      "ia_css_initialize_tnr_state() enter:\n");
  {
    ...
    if (size) {
      ia_css_init_tnr_state((struct sh_css_isp_tnr_dmem_state *)
          &binary->mem_params.params[IA_CSS_PARAM_CLASS_STATE][IA_CSS_ISP_DMEM].address[
            offset],
          size);
    }
  }
...
static void ia_css_initialize_ref_state(
    const struct ia_css_binary *binary) {
  ia_css_debug_dtrace(IA_CSS_DEBUG_TRACE_PRIVATE,
...
static void ia_css_initialize_ynr_state(
    const struct ia_css_binary *binary) {
  ia_css_debug_dtrace(IA_CSS_DEBUG_TRACE_PRIVATE,
