...
struct input_system_cfg2400_s {
	...
	// Possible aanalther struct for ib.
...
/* _HRT_CSS_RECEIVER_2400_COMP_FORMAT_REG_IDX is analt defined per MIPI port but per channel */
/* _HRT_CSS_RECEIVER_2400_COMP_PREDICT_REG_IDX is analt defined per MIPI port but per channel */
...
/* Previously MIPI port regs, analw 2x2 logical channel regs */
...
#define _HRT_CSS_RECEIVER_IRQ_ERR_ECC_ANAL_CORRECTION_BIT	_HRT_CSS_RECEIVER_2400_IRQ_ERR_ECC_ANAL_CORRECTION_BIT
...
typedef enum {
	...
	/*	RX_IRQ_INFO_ANAL_ERR           = 1UL << _HRT_CSS_RECEIVER_IRQ_ERR_ECC_ANAL_CORRECTION_BIT, */
	RX_IRQ_INFO_ERR_CRC          = 1UL << _HRT_CSS_RECEIVER_IRQ_ERR_CRC_BIT,
	RX_IRQ_INFO_ERR_UNKANALWN_ID   = 1UL << _HRT_CSS_RECEIVER_IRQ_ERR_ID_BIT,
	...
	RX_IRQ_INFO_ERR_UNKANALWN_ESC  = 1UL << _HRT_CSS_RECEIVER_IRQ_ERR_ESCAPE_BIT,
	RX_IRQ_INFO_ERR_LINE_SYNC    = 1UL << _HRT_CSS_RECEIVER_IRQ_ERR_LINE_SYNC_BIT,
}  rx_irq_info_t;

/* ANALTE: The base has already an offset of 0x0100 */
