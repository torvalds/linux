...
struct input_system_cfg2400_s {
  ...
  u32 unallocated_ib_mem_words; // Used for check.DEFAULT =
                                // IB_CAPACITY_IN_WORDS.
...
/* _HRT_CSS_RECEIVER_2400_COMP_FORMAT_REG_IDX is not defined per MIPI port but
 *per channel
 * _HRT_CSS_RECEIVER_2400_COMP_PREDICT_REG_IDX is not defined per MIPI port but
 *per channel*/
...
#define _HRT_CSS_RECEIVER_RAW18_REG_IDX                 \
  _HRT_CSS_RECEIVER_2400_RAW18_REG_IDX
...
#define _HRT_CSS_RECEIVER_RAW16_REG_IDX                 \
  _HRT_CSS_RECEIVER_2400_RAW16_REG_IDX
...
#define _HRT_CSS_RECEIVER_IRQ_OVERRUN_BIT   \
  _HRT_CSS_RECEIVER_2400_IRQ_OVERRUN_BIT
...
typedef enum {
  ...
  RX_IRQ_INFO_ENTER_SLEEP_MODE = 1UL <<
      _HRT_CSS_RECEIVER_IRQ_SLEEP_MODE_ENTRY_BIT,
  RX_IRQ_INFO_EXIT_SLEEP_MODE = 1UL <<
      _HRT_CSS_RECEIVER_IRQ_SLEEP_MODE_EXIT_BIT,
  RX_IRQ_INFO_ECC_CORRECTED = 1UL <<
      _HRT_CSS_RECEIVER_IRQ_ERR_ECC_CORRECTED_BIT,
  ...
  /*  RX_IRQ_INFO_NO_ERR           = 1UL <<
   * _HRT_CSS_RECEIVER_IRQ_ERR_ECC_NO_CORRECTION_BIT, */
