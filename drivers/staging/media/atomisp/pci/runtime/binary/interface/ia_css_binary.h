...
#define NUM_PRIMARY_HQ_STAGES  6  /* number of primary stages for ISP2.6.1 high
                                   * quality pipe */
#define NUM_PRIMARY_STAGES     1  /* number of primary satges for ISP1/ISP2.2
                                   * pipe */
 ...
 * @param[in] required_bds_factor: The bayer downscaling factor required in the
 *pipe.
 ...
 *    The shading information related to ISP (but, not necessary as API) is
 *stored in the pipe_config.
 * @return  0 or error code upon error.
 *
 */
int ia_css_binary_get_shading_info(const struct ia_css_binary *binary,
...
void ia_css_binary_dvs_stat_grid_info(
