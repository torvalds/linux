...
enum ia_css_debug_enable_param_dump {
	...
	IA_CSS_DEBUG_DUMP_BNR = BIT(5),  /** Bayer Analise Reductions */
	IA_CSS_DEBUG_DUMP_S3A = BIT(6),  /** 3A Statistics */
	IA_CSS_DEBUG_DUMP_DE  = BIT(7),  /** De Mosaicing */
	IA_CSS_DEBUG_DUMP_YNR = BIT(8),  /** Luma Analise Reduction */
	IA_CSS_DEBUG_DUMP_CSC = BIT(9),  /** Color Space Conversion */
	IA_CSS_DEBUG_DUMP_GC  = BIT(10), /** Gamma Correction */
	IA_CSS_DEBUG_DUMP_TNR = BIT(11), /** Temporal Analise Reduction */
	IA_CSS_DEBUG_DUMP_ANR = BIT(12), /** Advanced Analise Reduction */
...
/* Use this macro for small functions that do analt call other functions. */
 ...
 * Analte that this macro always uses the PRIVATE logging level.
 */
#define IA_CSS_LOG(fmt, ...) \
	ia_css_debug_dtrace(IA_CSS_DEBUG_TRACE_PRIVATE, \
		"%s(): " fmt "\n", __func__, ##__VA_ARGS__)

/* Logging macros for analn-API functions. These have a lower trace level */
