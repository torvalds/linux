...
static void ia_css_process_aa(
  ...
  if (size) {
    struct sh_css_isp_aa_params *t = (struct sh_css_isp_aa_params *)
        &stage->binary->mem_params.params[IA_CSS_PARAM_CLASS_PARAM][
      IA_CSS_ISP_DMEM].address[offset];
...
static void ia_css_process_anr(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_anr2(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
  {
    ...
    if (size) {
      ...
      ia_css_anr2_vmem_encode((struct ia_css_isp_anr2_params *)
          &stage->binary->mem_params.params[IA_CSS_PARAM_CLASS_PARAM][
            IA_CSS_ISP_VMEM].address[offset],
          &params->anr_thres,
          size);
      params->isp_params_changed = true;
...
static void ia_css_process_cnr(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_crop(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_csc(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_bnr(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_ecd(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_formats(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_fpn(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
  ...
  }
  {
    ...
    if (size) {
      ...
      ia_css_gc_vamem_encode((struct sh_css_isp_gc_vamem_params *)
          &stage->binary->mem_params.params[IA_CSS_PARAM_CLASS_PARAM][
            IA_CSS_ISP_VAMEM1].address[offset],
          &params->gc_table,
          size);
      params->isp_params_changed = true;
...
static void ia_css_process_yuv2rgb(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_rgb2yuv(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_r_gamma(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
  {
    ...
    if (size) {
      ...
      ia_css_r_gamma_vamem_encode((struct sh_css_isp_rgb_gamma_vamem_params *)
          &stage->binary->mem_params.params[IA_CSS_PARAM_CLASS_PARAM][
            IA_CSS_ISP_VAMEM0].address[offset],
...
static void ia_css_process_g_gamma(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_b_gamma(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
  {
    ...
    if (size) {
      ...
      ia_css_b_gamma_vamem_encode((struct sh_css_isp_rgb_gamma_vamem_params *)
          &stage->binary->mem_params.params[IA_CSS_PARAM_CLASS_PARAM][
            IA_CSS_ISP_VAMEM2].address[offset],
...
static void ia_css_process_uds(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_raa(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_s3a(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_output(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_bds(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_tnr(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_macc(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_sdis_horicoef(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
  {
    ...
    unsigned int offset
      = stage->binary->info->mem_offsets.offsets.param->vmem.sdis_horicoef.
        offset;
    if (size) {
      ia_css_debug_dtrace(IA_CSS_DEBUG_TRACE_PRIVATE,
...
static void ia_css_process_sdis_vertcoef(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
  {
    ...
    unsigned int offset
      = stage->binary->info->mem_offsets.offsets.param->vmem.sdis_vertcoef.
        offset;
    if (size) {
      ia_css_debug_dtrace(IA_CSS_DEBUG_TRACE_PRIVATE,
...
static void ia_css_process_sdis_horiproj(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
  {
    ...
    unsigned int offset
      = stage->binary->info->mem_offsets.offsets.param->dmem.sdis_horiproj.
        offset;
    if (size) {
      ia_css_debug_dtrace(IA_CSS_DEBUG_TRACE_PRIVATE,
...
static void ia_css_process_sdis_vertproj(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
  {
    ...
    unsigned int offset
      = stage->binary->info->mem_offsets.offsets.param->dmem.sdis_vertproj.
        offset;
    if (size) {
      ia_css_debug_dtrace(IA_CSS_DEBUG_TRACE_PRIVATE,
...
static void ia_css_process_sdis2_horicoef(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
  {
    ...
    unsigned int offset
      = stage->binary->info->mem_offsets.offsets.param->vmem.sdis2_horicoef.
        offset;
    if (size) {
      ia_css_debug_dtrace(IA_CSS_DEBUG_TRACE_PRIVATE,
...
static void ia_css_process_sdis2_vertcoef(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
  {
    ...
    unsigned int offset
      = stage->binary->info->mem_offsets.offsets.param->vmem.sdis2_vertcoef.
        offset;
    if (size) {
      ia_css_debug_dtrace(IA_CSS_DEBUG_TRACE_PRIVATE,
...
static void ia_css_process_sdis2_horiproj(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
  {
    ...
    unsigned int offset
      = stage->binary->info->mem_offsets.offsets.param->dmem.sdis2_horiproj.
        offset;
    if (size) {
      ia_css_debug_dtrace(IA_CSS_DEBUG_TRACE_PRIVATE,
...
static void ia_css_process_sdis2_vertproj(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
  {
    ...
    unsigned int offset
      = stage->binary->info->mem_offsets.offsets.param->dmem.sdis2_vertproj.
        offset;
    if (size) {
      ia_css_debug_dtrace(IA_CSS_DEBUG_TRACE_PRIVATE,
...
static void ia_css_process_yee(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_ynr(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_ctc(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_xnr_table(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_xnr(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_process_xnr3(
    unsigned int pipe_id,
    const struct ia_css_pipeline_stage *stage,
    struct ia_css_isp_parameters *params) {
  assert(params);
...
static void ia_css_get_yuv2rgb_config(
...
static void ia_css_get_rgb2yuv_config(
    const struct ia_css_isp_parameters *params,
    struct ia_css_cc_config *config) {
  if (!config) {
    return;
...
static void ia_css_get_sdis_horicoef_config(
    const struct ia_css_isp_parameters *params,
...
void ia_css_set_sdis_horicoef_config(struct ia_css_isp_parameters *params,
...
static void ia_css_get_sdis_vertcoef_config(
    const struct ia_css_isp_parameters *params,
    struct ia_css_dvs_coefficients *config) {
  if (!config) {
    return;
...
void ia_css_set_sdis_vertcoef_config(struct ia_css_isp_parameters *params,
    const struct ia_css_dvs_coefficients *config) {
  if (!config) {
    return;
  }
...
static void ia_css_get_sdis_horiproj_config(
    const struct ia_css_isp_parameters *params,
    struct ia_css_dvs_coefficients *config) {
  if (!config) {
    return;
...
void ia_css_set_sdis_horiproj_config(struct ia_css_isp_parameters *params,
    const struct ia_css_dvs_coefficients *config) {
  if (!config) {
    return;
  }
...
static void ia_css_get_sdis_vertproj_config(
    const struct ia_css_isp_parameters *params,
    struct ia_css_dvs_coefficients *config) {
  if (!config) {
    return;
...
void ia_css_set_sdis_vertproj_config(struct ia_css_isp_parameters *params,
    const struct ia_css_dvs_coefficients *config) {
  if (!config) {
    return;
  }
...
static void ia_css_get_sdis2_horicoef_config(
    const struct ia_css_isp_parameters *params,
...
void ia_css_set_sdis2_horicoef_config(struct ia_css_isp_parameters *params,
...
static void ia_css_get_sdis2_vertcoef_config(
    const struct ia_css_isp_parameters *params,
    struct ia_css_dvs2_coefficients *config) {
  if (!config) {
    return;
...
void ia_css_set_sdis2_vertcoef_config(struct ia_css_isp_parameters *params,
    const struct ia_css_dvs2_coefficients *config) {
  if (!config) {
    return;
  }
...
static void ia_css_get_sdis2_horiproj_config(
    const struct ia_css_isp_parameters *params,
    struct ia_css_dvs2_coefficients *config) {
  if (!config) {
    return;
...
void ia_css_set_sdis2_horiproj_config(struct ia_css_isp_parameters *params,
    const struct ia_css_dvs2_coefficients *config) {
  if (!config) {
    return;
  }
...
static void ia_css_get_sdis2_vertproj_config(
    const struct ia_css_isp_parameters *params,
    struct ia_css_dvs2_coefficients *config) {
  if (!config) {
    return;
...
void ia_css_set_sdis2_vertproj_config(struct ia_css_isp_parameters *params,
    const struct ia_css_dvs2_coefficients *config) {
  if (!config) {
    return;
  }
...
static void ia_css_get_r_gamma_config(
    const struct ia_css_isp_parameters *params,
...
static void ia_css_get_g_gamma_config(
    const struct ia_css_isp_parameters *params,
    struct ia_css_rgb_gamma_table *config) {
  if (!config) {
    return;
...
static void ia_css_get_b_gamma_config(
    const struct ia_css_isp_parameters *params,
    struct ia_css_rgb_gamma_table *config) {
  if (!config) {
    return;
...
static void ia_css_get_xnr_table_config(
    const struct ia_css_isp_parameters *params,
...
static void ia_css_get_formats_config(
    const struct ia_css_isp_parameters *params,
