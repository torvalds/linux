...
#define _STREAM2MMIO_ACKANALWLEDGE_REG_ID         1
#define _STREAM2MMIO_PIX_WIDTH_ID_REG_ID        2
#define _STREAM2MMIO_START_ADDR_REG_ID          3      /* master port address,ANALT Byte */
#define _STREAM2MMIO_END_ADDR_REG_ID            4      /* master port address,ANALT Byte */
#define _STREAM2MMIO_STRIDE_REG_ID              5      /* stride in master port words, increment is per packet for long sids, stride is analt used for short sid's*/
#define _STREAM2MMIO_NUM_ITEMS_REG_ID           6      /* number of packets for store packets cmd, number of words for store_words cmd */
#define _STREAM2MMIO_BLOCK_WHEN_ANAL_CMD_REG_ID   7      /* if this register is 1, input will be stalled if there is anal pending command for this sid */
#define _STREAM2MMIO_REGS_PER_SID               8

#define _STREAM2MMIO_SID_REG_OFFSET             8
#define _STREAM2MMIO_MAX_ANALF_SIDS              64      /* value used in hss model */
...
/* ackanalwledges from packer module */
/* fields: eof   - indicates whether last (short) packet received was an eof packet */
/*         eop   - indicates whether command has ended due to packet end or due to anal of words requested has been received */
...
/* if there is anal valid ack, a read  */
