...
#define MIPI_BACKEND_REG_ALIGN                    4 // assuming 32 bit control
                                                    // bus width
...
#define _HRT_MIPI_BACKEND_NOF_REGISTERS                   32 // excluding the LP
                                                             // LUT entries
...
//#define _HRT_MIPI_BACKEND_MAX_NOF_LP_LUT_ENTRIES           16  // to satisfy
// hss model static array declaration
...
/* ***********************************************************************************************
 * Custom Decoding
 * These Custom Defs are defined based on design-time config in
 *"mipi_backend_pixel_formatter.chdl" !!
 *************************************************************************************************/
#define _HRT_MIPI_BACKEND_CUST_EN_IDX                     0     /* 2bits */
#define _HRT_MIPI_BACKEND_CUST_EN_DATAID_IDX              2     /* 6bits MIPI
                                                                 * DATA ID */
#define _HRT_MIPI_BACKEND_CUST_EN_HIGH_PREC_IDX           8     // 1 bit
#define _HRT_MIPI_BACKEND_CUST_EN_WIDTH                   9
#define _HRT_MIPI_BACKEND_CUST_MODE_ALL                   1     /* Enable Custom
                                                                 * Decoding for
                                                                 * all DATA IDs
                                                                 * */
#define _HRT_MIPI_BACKEND_CUST_MODE_ONE                   3     /* Enable Custom
                                                                 * Decoding for
                                                                 * ONE DATA ID,
                                                                 * programmed in
                                                                 * CUST_EN_DATA_ID
...
#define _HRT_MIPI_BACKEND_CUST_PIX_VALID_EOP_NOR_VALID_IDX 0    /* Normal (NO
                                                                 * less get_bits
                                                                 * case) Valid -
                                                                 * 1bits */
#define _HRT_MIPI_BACKEND_CUST_PIX_VALID_EOP_NOR_EOP_IDX   1    /* Normal (NO
                                                                 * less get_bits
                                                                 * case) EoP -
                                                                 * 1bits */
#define _HRT_MIPI_BACKEND_CUST_PIX_VALID_EOP_ESP_VALID_IDX 2    /* Especial
                                                                 * (less
                                                                 * get_bits
                                                                 * case) Valid -
                                                                 * 1bits */
#define _HRT_MIPI_BACKEND_CUST_PIX_VALID_EOP_ESP_EOP_IDX   3    /* Especial
                                                                 * (less
                                                                 * get_bits
                                                                 * case) EoP -
                                                                 * 1bits */
 ...
 * These parameters define the fields within the streaming bus. These should
 *also be used by the
 ...
 * In order to keep this configurability, below Macro's have these as a
 *parameter
 *************************************************************************************************/
...
#define HRT_MIPI_BACKEND_STREAM_PIX_VAL_BIT(sid_width, \
      p)    (HRT_MIPI_BACKEND_STREAM_CHID_MS_BIT(sid_width) + 1 + p)

#define HRT_MIPI_BACKEND_STREAM_PIX_LS_BIT(sid_width, ppc, pix_width, \
      p) (HRT_MIPI_BACKEND_STREAM_PIX_VAL_BIT(sid_width, \
    ppc) + ((pix_width) * p))
#define HRT_MIPI_BACKEND_STREAM_PIX_MS_BIT(sid_width, ppc, pix_width, \
      p) (HRT_MIPI_BACKEND_STREAM_PIX_LS_BIT(sid_width, ppc, pix_width, \
    p) + (pix_width) - 1)
...
#define HRT_MIPI_BACKEND_STREAM_BITS(sid_width, ppc, \
      pix_width)         (HRT_MIPI_BACKEND_STREAM_PIX_MS_BIT(sid_width, ppc, \
    pix_width, (ppc - 1)) + 1)
...
#define HRT_MIPI_BACKEND_LUT_SID_MS_BIT(sid_width)          ( \
    HRT_MIPI_BACKEND_LUT_SID_LS_BIT + (sid_width) - 1)                                             // 1
                                                                                                   // +
                                                                                                   // (4)
                                                                                                   // -
                                                                                                   // 1
 ...
 *             HRT_MIPI_BACKEND_LUT_MIPI_CH_ID_MS_BIT(sid_width) + 1
 *                                       // 7          */
...
// temp solution
//#define HRT_MIPI_BACKEND_STREAM_PIXA_VAL_BIT
//                HRT_MIPI_BACKEND_STREAM_CHID_MS_BIT  + 1
//                                    // 8
//#define HRT_MIPI_BACKEND_STREAM_PIXB_VAL_BIT
//                HRT_MIPI_BACKEND_STREAM_PIXA_VAL_BIT + 1
//                                    // 9
//#define HRT_MIPI_BACKEND_STREAM_PIXC_VAL_BIT
//                HRT_MIPI_BACKEND_STREAM_PIXB_VAL_BIT + 1
//                                    // 10
//#define HRT_MIPI_BACKEND_STREAM_PIXD_VAL_BIT
//                HRT_MIPI_BACKEND_STREAM_PIXC_VAL_BIT + 1
//                                    // 11
//#define HRT_MIPI_BACKEND_STREAM_PIXA_LS_BIT
//                 HRT_MIPI_BACKEND_STREAM_PIXD_VAL_BIT + 1
//                                    // 12
//#define HRT_MIPI_BACKEND_STREAM_PIXA_MS_BIT
//                 HRT_MIPI_BACKEND_STREAM_PIXA_LS_BIT  +
// HRT_MIPI_BACKEND_STREAM_PIX_BITS - 1 // 25
//#define HRT_MIPI_BACKEND_STREAM_PIXB_LS_BIT
//                 HRT_MIPI_BACKEND_STREAM_PIXA_MS_BIT + 1
//                                     // 26
//#define HRT_MIPI_BACKEND_STREAM_PIXB_MS_BIT
//                 HRT_MIPI_BACKEND_STREAM_PIXB_LS_BIT  +
// HRT_MIPI_BACKEND_STREAM_PIX_BITS - 1 // 39
//#define HRT_MIPI_BACKEND_STREAM_PIXC_LS_BIT
//                 HRT_MIPI_BACKEND_STREAM_PIXB_MS_BIT + 1
//                                     // 40
//#define HRT_MIPI_BACKEND_STREAM_PIXC_MS_BIT
//                 HRT_MIPI_BACKEND_STREAM_PIXC_LS_BIT  +
// HRT_MIPI_BACKEND_STREAM_PIX_BITS - 1 // 53
//#define HRT_MIPI_BACKEND_STREAM_PIXD_LS_BIT
//                 HRT_MIPI_BACKEND_STREAM_PIXC_MS_BIT + 1
//                                     // 54
//#define HRT_MIPI_BACKEND_STREAM_PIXD_MS_BIT
//                 HRT_MIPI_BACKEND_STREAM_PIXD_LS_BIT  +
// HRT_MIPI_BACKEND_STREAM_PIX_BITS - 1 // 67

// vc hidden in pixb data (passed as raw12 the pipe)
#define HRT_MIPI_BACKEND_STREAM_VC_LS_BIT(sid_width, ppc, \
      pix_width)  HRT_MIPI_BACKEND_STREAM_PIX_LS_BIT(sid_width, ppc, pix_width, \
    1) + 10  //HRT_MIPI_BACKEND_STREAM_PIXB_LS_BIT + 10 // 36
#define HRT_MIPI_BACKEND_STREAM_VC_MS_BIT(sid_width, ppc, \
      pix_width)  HRT_MIPI_BACKEND_STREAM_VC_LS_BIT(sid_width, ppc, \
    pix_width) + 1    // 37
