...
#define STREAM2MMIO_START_ADDR_REG_ID          3      /* master port address,NOT
                                                       * Byte */
#define STREAM2MMIO_END_ADDR_REG_ID            4      /* master port address,NOT
                                                       * Byte */
#define STREAM2MMIO_STRIDE_REG_ID              5      /* stride in master port
                                                       * words, increment is per
                                                       * packet for long sids,
                                                       * stride is not used for
                                                       * short sid's*/
#define STREAM2MMIO_NUM_ITEMS_REG_ID           6      /* number of packets for
                                                       * store packets cmd,
                                                       * number of words for
                                                       * store_words cmd */
#define STREAM2MMIO_BLOCK_WHEN_NO_CMD_REG_ID   7      /* if this register is 1,
                                                       * input will be stalled
                                                       * if there is no pending
                                                       * command for this sid */
