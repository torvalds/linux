...
/* one tracer item: major, minor and counter. The counter value can be used for
 * GP data */
struct trace_item_t {
  u8 major;
  u8 minor;
...
#define HDR_DEBUG_SIGNATURE_OFFSET  offsetof(struct trace_header_t, \
    debug_ptr_signature)
#define HDR_DEBUG_POINTER_OFFSET    offsetof(struct trace_header_t, \
    debug_ptr_value)
#define HDR_STATUS_OFFSET           offsetof(struct trace_header_t, \
    thr_status_byte)
#define HDR_STATUS_OFFSET_BYTE      offsetof(struct trace_header_t, \
    thr_status_byte)
#define HDR_STATUS_OFFSET_WORD      offsetof(struct trace_header_t, \
    thr_status_word)
#define HDR_STATUS_OFFSET_DWORD     offsetof(struct trace_header_t, \
    thr_status_dword)
#define HDR_STATUS_OFFSET_SCRATCH   offsetof(struct trace_header_t, \
    scratch_debug)
...
#define DEBUG_PTR_SIGNATURE     0xABCD  /* signature for the debug parameter
                                         * pointer */

/* command codes (1st byte) */
typedef enum {
  CMD_SET_ONE_MAJOR = 1,    /* mask in one major. 2nd byte in the command is the
                             * major code */
  CMD_UNSET_ONE_MAJOR = 2,  /* mask out one major. 2nd byte in the command is
                             * the major code */
  CMD_SET_ALL_MAJORS = 3,   /* set the major print mask. the full mask is in the
                             * data DWORD */
...
#define FIELD_VALUE_PACK(f)   FIELD_PACK(f, FIELD_VALUE_MASK, \
    FIELD_VALUE_OFFSET)
#define FIELD_VALUE_UNPACK(f)   FIELD_UNPACK(f, FIELD_VALUE_MASK, \
    FIELD_VALUE_OFFSET)
...
#define FIELD_MINOR_PACK(f)   FIELD_PACK(f, FIELD_MINOR_MASK, \
    FIELD_MINOR_OFFSET)
#define FIELD_MINOR_UNPACK(f)   FIELD_UNPACK(f, FIELD_MINOR_MASK, \
    FIELD_MINOR_OFFSET)
...
#define FIELD_MAJOR_PACK(f)   FIELD_PACK(f, FIELD_MAJOR_MASK, \
    FIELD_MAJOR_OFFSET)
#define FIELD_MAJOR_UNPACK(f)   FIELD_UNPACK(f, FIELD_MAJOR_MASK, \
    FIELD_MAJOR_OFFSET)
...
#define FIELD_FULL_MAJOR_PACK(f)  FIELD_PACK(f, FIELD_FULL_MAJOR_MASK, \
    FIELD_MAJOR_OFFSET)
...
#define FIELD_MAJOR_W_FMT_PACK(f) FIELD_PACK(f, FIELD_MAJOR_W_FMT_MASK, \
    FIELD_MAJOR_W_FMT_OFFSET)
#define FIELD_MAJOR_W_FMT_UNPACK(f) FIELD_UNPACK(f, FIELD_MAJOR_W_FMT_MASK, \
    FIELD_MAJOR_W_FMT_OFFSET)
...
#define FIELD_FORMAT_PACK(f)    FIELD_PACK(f, FIELD_FORMAT_MASK, \
    FIELD_FORMAT_OFFSET)
#define FIELD_FORMAT_UNPACK(f)    FIELD_UNPACK(f, FIELD_FORMAT_MASK, \
    FIELD_FORMAT_OFFSET)
...
#define FIELD_VALUE_24_PACK(f)    FIELD_PACK(f, FIELD_VALUE_24_MASK, \
    FIELD_VALUE_24_OFFSET)
#define FIELD_VALUE_24_UNPACK(f)  FIELD_UNPACK(f, FIELD_VALUE_24_MASK, \
    FIELD_VALUE_24_OFFSET)

#define PACK_TRACEPOINT(tid, major, minor, value) \
  (FIELD_TID_PACK(tid) | FIELD_MAJOR_PACK(major) | FIELD_MINOR_PACK(minor) \
  | FIELD_VALUE_PACK(value))
...
#define PACK_FORMATTED_TRACEPOINT(format, major, minor, value)  \
  (FIELD_TID_PACK(FIELD_TID_SEL_FORMAT_PAT) | FIELD_FORMAT_PACK(format) \
  | FIELD_MAJOR_PACK(major) | FIELD_MINOR_PACK(minor) \
  | FIELD_VALUE_PACK(value))
