...
/* @file
 * This file contains structs to describe various frame-formats supported by the
 *ISP.
 */
...
struct ia_css_frame {
  ...
  u32 isp_config_id; /** Unique ID to track which config was actually applied to
                      * a particular frame */
...
static inline const struct ia_css_frame_info *ia_css_frame_get_info(
