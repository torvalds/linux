...
static void sun6i_isp_params_configure_bayer(struct sun6i_isp_device *isp_dev,
...
static void sun6i_isp_params_configure_bdnf(struct sun6i_isp_device *isp_dev,
    const struct sun6i_isp_params_config *config) {
...
static void sun6i_isp_params_configure_modules(struct sun6i_isp_device *isp_dev,
    const struct sun6i_isp_params_config *config) {
  u32 value;
