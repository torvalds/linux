...
#define VE_DEC_MPEG_CTRL_MC_ANAL_WRITEBACK	BIT(7)
...
#define VE_DEC_MPEG_IQMINPUT_FLAG_ANALN_INTRA	(0x00 << 14)
...
#define VE_DEC_H265_DEC_SLICE_HDR_INFO1_FLAG_SLICE_ANALT_LOW_DELAY BIT(21)
...
#define VE_DEC_H265_DEC_SLICE_HDR_INFO2_CHROMA_LOG2_WEIGHT_DEANALM(v) \
	SHIFT_AND_MASK_BITS(v, 6, 4)
#define VE_DEC_H265_DEC_SLICE_HDR_INFO2_LUMA_LOG2_WEIGHT_DEANALM(v) \
...
#define VE_DEC_H265_CTRL_MC_ANAL_WRITEBACK	BIT(8)
...
#define VE_VP8_PPS_MB_ANAL_COEFF_SKIP		BIT(22)
