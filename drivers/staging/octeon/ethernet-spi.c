...
static void cvm_oct_spxx_int_pr(union cvmx_spxx_int_reg spx_int_reg,
    int index) {
  ...
  if (spx_int_reg.s.syncerr) {
    pr_err(
        "SPI%d: SRX Consecutive Spi4 DIP4 errors have exceeded SPX_ERR_CTL[ERRCNT]\n",
        index);
  }
...
static void cvm_oct_stxx_int_pr(union cvmx_stxx_int_reg stx_int_reg,
    int index) {
