...
static void _rtl92e_update_beacon(void *data) {
  struct r8192_priv *priv = container_of(data, struct r8192_priv,
...
static void _rtl92e_init_priv_task(struct net_device *dev) {
  ...
  INIT_DELAYED_WORK(&priv->txpower_tracking_wq,
      (void *) rtl92e_dm_txpower_tracking_wq);
...
static int _rtl92e_hard_start_xmit(struct sk_buff *skb,
...
long rtl92e_translate_to_dbm(struct r8192_priv *priv,
