...
static int ad5933_i2c_write(struct i2c_client *client, u8 reg, u8 len,
    u8 *data) {
  int ret;
  while (len--) {
...
static int ad5933_i2c_read(struct i2c_client *client, u8 reg, u8 len,
    u8 *data) {
  int ret;
  while (len--) {
