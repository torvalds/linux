...
#define IMR_GTINT4_8723B          BIT28   /*  When GTIMER4 expires, this bit is
                                           * set to 1 */
#define IMR_GTINT3_8723B          BIT27   /*  When GTIMER3 expires, this bit is
                                           * set to 1 */
#define IMR_TXBCN0ERR_8723B       BIT26   /*  Transmit Beacon0 Error */
#define IMR_TXBCN0OK_8723B        BIT25   /*  Transmit Beacon0 OK */
#define IMR_TSF_BIT32_TOGGLE_8723B    BIT24   /*  TSF Timer BIT32 toggle
...
#define IMR_HSISR_IND_ON_INT_8723B    BIT15   /*  HSISR Indicator (HSIMR & HSISR
                                               * is true, this bit is set to 1)
                                               * */
#define IMR_BCNDMAINT_E_8723B     BIT14   /*  Beacon DMA Interrupt Extension for
                                           * Win7 */
#define IMR_ATIMEND_8723B       BIT12   /*  CTWidnow End or ATIM Window End */
#define IMR_C2HCMD_8723B          BIT10   /*  CPU to Host Command INT Status,
                                           * Write 1 clear */
...
#define IMR_ATIMEND_E_8723B       BIT13   /*  ATIM Window End Extension for Win7
                                           * */
#define IMR_TXERR_8723B         BIT11   /*  Tx Error Flag Interrupt Status,
                                         * write 1 clear. */
#define IMR_RXERR_8723B         BIT10   /*  Rx Error Flag INT Status, Write 1
                                         * clear */
