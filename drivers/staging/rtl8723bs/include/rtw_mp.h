...
struct mpt_context {
   ...
   *  Event used to sync the case unloading driver and MptWorkItem is still in
   * progress.
  ...
  /*  SD3 Willis For 8192S to save 1T/2T RF table for ACUT  Only fro ACUT delete
   * later ~~~!
 ...
 * int free_mp_xmitframe(struct xmit_priv *pxmitpriv, struct mp_xmit_frame
 **pmp_xmitframe);*/
...
void _write_rfreg(struct adapter *padapter, u8 rfpath, u32 addr, u32 bitmask,
    u32 val);
