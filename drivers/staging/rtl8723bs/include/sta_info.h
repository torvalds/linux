...
struct sta_info {
  ...
  /* Notes:
   * STA_Mode:
   * curr_network(mlme_priv/security_priv/qos/ht) + sta_info: (STA & AP)
   * CAP/INFO
   * scan_q: AP CAP/INFO*/
  ...
  /* ODM_STA_INFO_T
  *  ================ODM Relative Info =======================
  *  Please be care, dont declare too much structure here. It will cost memory
  ** STA support num.
  *
  *
...
struct  sta_priv {
  ...
  u16 sta_dz_bitmap; /* only support for 15 stations, aid bitmap for sleeping
                      * stations. */
