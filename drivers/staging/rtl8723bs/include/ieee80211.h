...
enum network_type {
  ...
  WIRELESS_11BG = (WIRELESS_11B | WIRELESS_11G), /*  tx: cck & ofdm, rx: cck &
                                                  * ofdm & MCS, hw: cck & ofdm
                                                  * */
  WIRELESS_11G_24N = (WIRELESS_11G | WIRELESS_11_24N), /*  tx: ofdm & MCS, rx:
                                                        * ofdm & cck & MCS, hw:
                                                        * cck & ofdm */
  WIRELESS_11B_24N = (WIRELESS_11B | WIRELESS_11_24N), /*  tx: ofdm & cck & MCS,
                                                        * rx: ofdm & cck & MCS,
                                                        * hw: ofdm & cck */
  WIRELESS_11BG_24N = (WIRELESS_11B | WIRELESS_11G | WIRELESS_11_24N), /*  tx:
                                                                        * ofdm &
                                                                        * cck &
                                                                        * MCS,
                                                                        * rx:
...
#define SUPPORTED_24G_NETTYPE_MSK (WIRELESS_11B | WIRELESS_11G \
  | WIRELESS_11_24N)

#define is_legacy_only(net_type)  ((net_type) == ((net_type) & (WIRELESS_11BG)))

#define is_supported_24g(net_type) ((net_type) \
  & SUPPORTED_24G_NETTYPE_MSK ? true : false)

#define is_supported_tx_cck(net_type) (((net_type) \
  & (WIRELESS_11B)) ? true : false)
#define is_supported_ht(net_type) (((net_type) \
...
#define IS_CCK_RATE(_rate)        (MGN_1M == _rate || _rate == MGN_2M \
  || _rate == MGN_5_5M || _rate == MGN_11M)
...
enum {
  ...
  RTW_WLAN_CATEGORY_UNPROTECTED_WNM = 11, /*  add for CONFIG_IEEE80211W, none
                                           * 11w also can use */
  RTW_WLAN_CATEGORY_TDLS = 12,
  RTW_WLAN_CATEGORY_SELF_PROTECTED = 15, /*  add for CONFIG_IEEE80211W, none 11w
                                          * also can use */
