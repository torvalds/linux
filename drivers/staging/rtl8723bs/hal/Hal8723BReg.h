...
#define REG_FW_UPD_RDPTR_8723B      0x0284 /*  FW shall update this register
                                            * before FW write RXPKT_RELEASE_POLL
                                            * to 1 */
...
#define IDR0_8723B    REG_MACID_8723B   /*  MAC ID Register, Offset
                                         * 0x0050-0x0053 */
#define IDR4_8723B    (REG_MACID_8723B + 4) /*  MAC ID Register, Offset
                                             * 0x0054-0x0055 */
...
#define IMR_TSF_BIT32_TOGGLE_8723B  BIT24 /*  TSF Timer BIT32 toggle indication
                                           * interrupt */
#define IMR_BCNDMAINT0_8723B    BIT20 /*  Beacon DMA Interrupt 0 */
#define IMR_BCNDERR0_8723B    BIT16 /*  Beacon Queue DMA OK0 */
#define IMR_HSISR_IND_ON_INT_8723B  BIT15 /*  HSISR Indicator (HSIMR & HSISR is
...
#define IMR_C2HCMD_8723B    BIT10 /*  CPU to Host Command INT Status, Write 1
                                   * clear */
#define IMR_CPWM2_8723B     BIT9  /*  CPU power Mode exchange INT Status, Write
                                   * 1 clear */
#define IMR_CPWM_8723B      BIT8  /*  CPU power Mode exchange INT Status, Write
                                   * 1 clear */
...
#define IMR_TXERR_8723B     BIT11 /*  Tx Error Flag Interrupt Status, write 1
                                   * clear. */
