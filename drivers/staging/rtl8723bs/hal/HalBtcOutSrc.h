...
struct btc_board_info {
  ...
  u8 btdmAntPos;    /* Bryant Add to indicate Antenna Position for (pgAntNum =
                     * 2) && (btdmAntNum = 1)  (DPDT+1Ant case) */
...
#define BTC_RSSI_HIGH(_rssi_) ((_rssi_ == BTC_RSSI_STATE_HIGH \
  || _rssi_ == BTC_RSSI_STATE_STAY_HIGH) ? true : false)
#define BTC_RSSI_MEDIUM(_rssi_) ((_rssi_ == BTC_RSSI_STATE_MEDIUM \
  || _rssi_ == BTC_RSSI_STATE_STAY_MEDIUM) ? true : false)
#define BTC_RSSI_LOW(_rssi_)  ((_rssi_ == BTC_RSSI_STATE_LOW \
