...
void odm_NHMCounterStatisticsInit(void *pDM_VOID) {
  ...
  rtw_write16(pDM_Odm->Adapter, ODM_REG_NHM_TIMER_11N + 2, 0x2710); /*
                                                                     ...
                                                                     * 0x2710
                                                                     * =40ms */
  /* rtw_write16(pDM_Odm->Adapter, ODM_REG_NHM_TIMER_11N+2, 0x4e20);
   *  0x894[31:16]=
   * 0x4e20 Time duration for NHM unit: 4us, 0x4e20 =80ms */
  rtw_write16(pDM_Odm->Adapter, ODM_REG_NHM_TH9_TH10_11N + 2, 0xffff);  /*
                                                                         ...
                                                                         * th_10
                                                                         * */
  /* rtw_write32(pDM_Odm->Adapter, ODM_REG_NHM_TH3_TO_TH0_11N, 0xffffff5c);
   * 0x898
   * = 0xffffff5c   th_3, th_2, th_1, th_0 */
  ...
  PHY_SetBBReg(pDM_Odm->Adapter, ODM_REG_FPGA0_IQK_11N, bMaskByte0, 0xff);    /*
                                                                               ...
                                                                               *
                                                                               **/
  PHY_SetBBReg(pDM_Odm->Adapter, ODM_REG_NHM_TH9_TH10_11N, BIT10 | BIT9 | BIT8,
...
void odm_AdaptivityInit(void *pDM_VOID) {
  ...
  PHY_SetBBReg(pDM_Odm->Adapter, REG_RD_CTRL, BIT11, 1); /*  stop counting if
                                                          * EDCCA is asserted */
}
...
void ODM_Write_DIG(void *pDM_VOID, u8 CurrentIGI) {
  ...
  if (pDM_DigTable->CurIGValue != CurrentIGI) {
    ...
    /* 1 Set IGI value */
    PHY_SetBBReg(pDM_Odm->Adapter, ODM_REG(IGI_A, pDM_Odm), ODM_BIT(IGI,
        pDM_Odm),
        CurrentIGI);
    PHY_SetBBReg(pDM_Odm->Adapter, ODM_REG(IGI_B, pDM_Odm), ODM_BIT(IGI,
        pDM_Odm),
        CurrentIGI);
...
void odm_DIGInit(void *pDM_VOID) {
  ...
  pDM_DigTable->CurIGValue
    = (u8) PHY_QueryBBReg(pDM_Odm->Adapter, ODM_REG(IGI_A, pDM_Odm),
      ODM_BIT(IGI, pDM_Odm));
