...
static void halbtc8723b2ant_CoexTableWithType(
  ...
  switch (type) {
    case 0:
      halbtc8723b2ant_CoexTable(pBtCoexist, bForceExec, 0x55555555, 0x55555555,
          0xffff, 0x3);
      break;
    case 1:
      halbtc8723b2ant_CoexTable(pBtCoexist, bForceExec, 0x55555555, 0x5afa5afa,
          0xffff, 0x3);
      break;
    case 2:
      halbtc8723b2ant_CoexTable(pBtCoexist, bForceExec, 0x5a5a5a5a, 0x5a5a5a5a,
          0xffff, 0x3);
      break;
    case 3:
      halbtc8723b2ant_CoexTable(pBtCoexist, bForceExec, 0xaaaaaaaa, 0xaaaaaaaa,
          0xffff, 0x3);
      break;
    case 4:
      halbtc8723b2ant_CoexTable(pBtCoexist, bForceExec, 0xffffffff, 0xffffffff,
          0xffff, 0x3);
      break;
    case 5:
      halbtc8723b2ant_CoexTable(pBtCoexist, bForceExec, 0x5fff5fff, 0x5fff5fff,
          0xffff, 0x3);
      break;
    case 6:
      halbtc8723b2ant_CoexTable(pBtCoexist, bForceExec, 0x55ff55ff, 0x5a5a5a5a,
          0xffff, 0x3);
      break;
    case 7:
      halbtc8723b2ant_CoexTable(pBtCoexist, bForceExec, 0x55ff55ff, 0xfafafafa,
          0xffff, 0x3);
      break;
    case 8:
      halbtc8723b2ant_CoexTable(pBtCoexist, bForceExec, 0x5aea5aea, 0x5aea5aea,
          0xffff, 0x3);
      break;
    case 9:
      halbtc8723b2ant_CoexTable(pBtCoexist, bForceExec, 0x55ff55ff, 0x5aea5aea,
          0xffff, 0x3);
      break;
    case 10:
      halbtc8723b2ant_CoexTable(pBtCoexist, bForceExec, 0x55ff55ff, 0x5aff5aff,
          0xffff, 0x3);
      break;
    case 11:
      halbtc8723b2ant_CoexTable(pBtCoexist, bForceExec, 0x55ff55ff, 0x5a5f5a5f,
          0xffff, 0x3);
      break;
    case 12:
      halbtc8723b2ant_CoexTable(pBtCoexist, bForceExec, 0x55ff55ff, 0x5f5f5f5f,
          0xffff, 0x3);
      break;
    default:
      break;
...
static void halbtc8723b2ant_SetAntPath(
  ...
  if (bInitHwCfg) {
    ...
    pBtCoexist->fBtcSetRfReg(pBtCoexist, BTC_RF_A, 0x1, 0xfffff, 0x0); /* WiFi
                                                                        * TRx
                                                                        * Mask
                                                                        * off */
    pBtCoexist->fBtcSetBtReg(pBtCoexist, BTC_BT_REG_RF, 0x3c, 0x01); /* BT TRx
                                                                      * Mask off
                                                                      * */
  ...
  if (bUseExtSwitch) {
    ...
    switch (antPosType) {
      case BTC_ANT_WIFI_AT_MAIN:
        pBtCoexist->fBtcWrite1ByteBitMask(pBtCoexist, 0x92c, 0x3, 0x1); /*  ext
                                                                         * switch
                                                                         * main
                                                                         * at
                                                                         * wifi
      ...
      case BTC_ANT_WIFI_AT_AUX:
        pBtCoexist->fBtcWrite1ByteBitMask(pBtCoexist, 0x92c, 0x3, 0x2); /*  ext
                                                                         * switch
                                                                         * aux
                                                                         * at
                                                                         * wifi
    ...
    pBtCoexist->fBtcWrite1ByteBitMask(pBtCoexist, 0x64, 0x1, 0x0); /* fixed
                                                                    * external
                                                                    * switch
                                                                    * S1->Main,
                                                                    * S0->Aux */
    switch (antPosType) {
      case BTC_ANT_WIFI_AT_MAIN:
        ...
        break;
      case BTC_ANT_WIFI_AT_AUX:
        pBtCoexist->fBtcWrite4Byte(pBtCoexist, 0x948, 0x280); /*  fixed internal
                                                               * switch
                                                               * S0->WiFi,
                                                               * S1->BT */
        break;
...
static void halbtc8723b2ant_TdmaDurationAdjust(
    struct btc_coexist *pBtCoexist, bool bScoHid, bool bTxPause,
    u8 maxInterval) {
...
static void halbtc8723b2ant_ActionSco(struct btc_coexist *pBtCoexist) {
  ...
  halbtc8723b2ant_PsTdma(pBtCoexist, NORMAL_EXEC, false, 0); /* for voice
                                                             * quality */
  /*  sw mechanism */
...
static void halbtc8723b2ant_WifiOffHwCfg(struct btc_coexist *pBtCoexist) {
  ...
  if (!bIsInMpMode) {
    pBtCoexist->fBtcWrite1ByteBitMask(pBtCoexist, 0x67, 0x20, 0x0); /* BT select
                                                                     * s0/s1 is
                                                                     * controlled
                                                                     * by BT */
  } else {
...
static void halbtc8723b2ant_InitHwConfig(struct btc_coexist *pBtCoexist,
  ...
  pBtCoexist->fBtcWrite1Byte(pBtCoexist, 0x76e, 0xc); /* 0x76e[3] = 1, WLAN_Act
                                                       * control by PTA */
...
void EXhalbtc8723b2ant_BtInfoNotify(
  ...
  if (BT_INFO_SRC_8723B_2ANT_WIFI_FW != rspSource) {
    ...
    if (pCoexSta->bBtTxRxMask) {
      /* BT into is responded by BT FW and BT RF REG 0x3C != 0x01 => Need to
       * switch BT TRx Mask */
...
void EXhalbtc8723b2ant_HaltNotify(struct btc_coexist *pBtCoexist) {
  halbtc8723b2ant_WifiOffHwCfg(pBtCoexist);
  pBtCoexist->fBtcSetBtReg(pBtCoexist, BTC_BT_REG_RF, 0x3c, 0x15); /* BT goto
                                                                   * standby
                                                                   * while
                                                                   * GNT_BT
                                                                   * 1-->0 */
