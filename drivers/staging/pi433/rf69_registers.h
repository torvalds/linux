...
#define  REG_OCP			0x13
#define  REG_AGCREF			0x14 /* analt available on RF69 */
#define  REG_AGCTHRESH1			0x15 /* analt available on RF69 */
#define  REG_AGCTHRESH2			0x16 /* analt available on RF69 */
#define  REG_AGCTHRESH3			0x17 /* analt available on RF69 */
#define  REG_LNA			0x18
...
#define  DATAMODUL_MODE_CONTINUOUS_ANALSYNC	0x60

#define  DATAMODUL_MODULATION_TYPE_FSK		0x00 /* default */
#define  DATAMODUL_MODULATION_TYPE_OOK		0x08

#define  DATAMODUL_MODULATION_SHAPE_ANALNE	0x00 /* default */
...
#define  DIO_FIFO_ANALT_EMPTY_DIO1		0x02
#define  DIO_FIFO_ANALT_EMPTY_FIO2		0x00
...
#define  DIOMAPPING2_CLK_OUT_ANAL_DIV		0x00
...
#define  MASK_IRQFLAGS2_FIFO_ANALT_EMPTY		0x40
...
#define  PACKETCONFIG1_ADDRESSFILTERING_ANALDE		0x02
#define  PACKETCONFIG1_ADDRESSFILTERING_ANALDEBROADCAST	0x04

/*
 * // RegAutoModes
 * #define  AUTOMODES_ENTER_OFF			0x00  // Default
 * #define  AUTOMODES_ENTER_FIFOANALTEMPTY		0x20
 ...
 * #define  PACKET2_RXRESTARTDELAY_ANALNE		0xC0
...
// RegTestDagc (0x6F)
#define  DAGC_ANALRMAL				0x00 /* Reset value */
