 ...
 *	DCONLOAD connects to VX855_GPIO1 (yest SMBCK2)
 *	DCONBLANK connects to VX855_GPIO8 (yest SSPICLK)  unused in driver
 *	DCONSTAT0 connects to VX855_GPI10 (yest SSPISDI)
 *	DCONSTAT1 connects to VX855_GPI11 (yest nSSPISS)
