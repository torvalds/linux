...
{
	BUILD__ON(ARRAY_SIZE(max14577_supported_regulators) != MAX14577_REGULATOR_NUM);
	BUILD__ON(ARRAY_SIZE(max77836_supported_regulators) != MAX77836_REGULATOR_NUM);

	BUILD__ON(MAX77836_REGULATOR_LDO_VOLTAGE_MIN +
