...
static int s5m8767_pmic_dt_parse_pdata(struct platform_device *pdev,
  ...
  pdata->buck2_ramp_enable = of_property_read_bool(pmic_np,
      "s5m8767,pmic-buck2-ramp-enable");
  pdata->buck3_ramp_enable = of_property_read_bool(pmic_np,
      "s5m8767,pmic-buck3-ramp-enable");
  pdata->buck4_ramp_enable = of_property_read_bool(pmic_np,
