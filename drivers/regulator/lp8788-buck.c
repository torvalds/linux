...
static enum lp8788_dvs_mode lp8788_get_buck_dvs_ctrl_mode(
...
static int lp8788_init_dvs(struct platform_device *pdev,
  ...
  struct lp8788_platform_data *pdata = buck->lp->pdata;
  u8 mask[] = {
    LP8788_BUCK1_DVS_SEL_M, LP8788_BUCK2_DVS_SEL_M
  };
  u8 val[] = {
    LP8788_BUCK1_DVS_PIN, LP8788_BUCK2_DVS_PIN
  };
  u8 default_dvs_mode[] = {
    LP8788_BUCK1_DVS_I2C, LP8788_BUCK2_DVS_I2C
  };
  /* no dvs for buck3, 4 */
  if (id > BUCK2) {
    return 0;
