...
static inline struct regulator_state *regulator_get_suspend_state(
    struct regulator_dev *rdev, suspend_state_t state) {
...
static const struct regulator_state *regulator_get_suspend_state_check(
    struct regulator_dev *rdev, suspend_state_t state) {
...
/**
 * regulator_ena_gpio_ctrl - balance enable_count of each GPIO and actual GPIO
 * pin control
...
/**
 * regulator_list_hardware_vsel - get the HW-specific register value for a
 * selector
 * @regulator: regulator source
 * @selector: identify voltage to list
 *
...
static struct regulator_coupler *regulator_find_coupler(
    struct regulator_dev *rdev) {
