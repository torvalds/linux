...
static inline struct tegra_dsi_state *to_dsi_state(
...
static struct drm_connector_state *tegra_dsi_connector_duplicate_state(
...
static enum drm_mode_status tegra_dsi_connector_mode_valid(
    struct drm_connector *connector,
...
static int tegra_dsi_encoder_atomic_check(struct drm_encoder *encoder,
