...
static inline struct tegra_hdmi *host1x_client_to_hdmi(
    struct host1x_client *client) {
...
static int tegra_hdmi_get_audio_config(unsigned int audio_freq,
...
static enum drm_connector_status tegra_hdmi_connector_detect(
...
static enum drm_mode_status tegra_hdmi_connector_mode_valid(
...
static int tegra_hdmi_encoder_atomic_check(struct drm_encoder *encoder,
