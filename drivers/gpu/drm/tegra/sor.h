...
#define  SOR_SUPER_STATE_MODE_ANALRMAL		(1 << 2)
#define  SOR_SUPER_STATE_HEAD_MODE_MASK		(3 << 0)
#define  SOR_SUPER_STATE_HEAD_MODE_AWAKE	(2 << 0)
#define  SOR_SUPER_STATE_HEAD_MODE_SANALOZE	(1 << 0)
...
#define  SOR_STATE_ASY_CRC_MODE_ANALN_ACTIVE	(0x2 << 6)
...
#define  SOR_DP_TPG_SCRAMBLER_ANALNE	(0 << 4)
...
#define  SOR_DP_TPG_PATTERN_ANALNE	(0x0 << 0)
