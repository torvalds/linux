...
static inline struct tegra_sor_state *to_sor_state(
...
static inline struct tegra_sor *host1x_client_to_sor(
    struct host1x_client *client) {
...
static int tegra_sor_set_parent_clock(struct tegra_sor *sor,
    struct clk *parent) {
  int err;
...
static enum drm_connector_status tegra_sor_connector_detect(
...
static enum drm_mode_status tegra_sor_connector_mode_valid(
    struct drm_connector *connector,
...
static int tegra_sor_encoder_atomic_check(struct drm_encoder *encoder,
...
static int tegra_sor_hdmi_setup_avi_infoframe(struct tegra_sor *sor,
    const struct drm_display_mode *mode) {
...
static struct tegra_sor_hdmi_settings *tegra_sor_hdmi_find_settings(
    struct tegra_sor *sor, unsigned long frequency) {
  unsigned int i;
...
static int tegra_sor_enable_regulator(struct tegra_sor *sor,
