...
static const struct defs_reg32 tegra_dc_regs[] = {
	DEFS_REG32(DC_CMD_GENERAL_INCR_SYNCPT),
	DEFS_REG32(DC_CMD_GENERAL_INCR_SYNCPT_CNTRL),
	DEFS_REG32(DC_CMD_GENERAL_INCR_SYNCPT_ERROR),
	DEFS_REG32(DC_CMD_WIN_A_INCR_SYNCPT),
	DEFS_REG32(DC_CMD_WIN_A_INCR_SYNCPT_CNTRL),
	DEFS_REG32(DC_CMD_WIN_A_INCR_SYNCPT_ERROR),
	DEFS_REG32(DC_CMD_WIN_B_INCR_SYNCPT),
	DEFS_REG32(DC_CMD_WIN_B_INCR_SYNCPT_CNTRL),
	DEFS_REG32(DC_CMD_WIN_B_INCR_SYNCPT_ERROR),
	DEFS_REG32(DC_CMD_WIN_C_INCR_SYNCPT),
	DEFS_REG32(DC_CMD_WIN_C_INCR_SYNCPT_CNTRL),
	DEFS_REG32(DC_CMD_WIN_C_INCR_SYNCPT_ERROR),
	DEFS_REG32(DC_CMD_CONT_SYNCPT_VSYNC),
	DEFS_REG32(DC_CMD_DISPLAY_COMMAND_OPTION0),
	DEFS_REG32(DC_CMD_DISPLAY_COMMAND),
	DEFS_REG32(DC_CMD_SIGNAL_RAISE),
	DEFS_REG32(DC_CMD_DISPLAY_POWER_CONTROL),
	DEFS_REG32(DC_CMD_INT_STATUS),
	DEFS_REG32(DC_CMD_INT_MASK),
	DEFS_REG32(DC_CMD_INT_ENABLE),
	DEFS_REG32(DC_CMD_INT_TYPE),
	DEFS_REG32(DC_CMD_INT_POLARITY),
	DEFS_REG32(DC_CMD_SIGNAL_RAISE1),
	DEFS_REG32(DC_CMD_SIGNAL_RAISE2),
	DEFS_REG32(DC_CMD_SIGNAL_RAISE3),
	DEFS_REG32(DC_CMD_STATE_ACCESS),
	DEFS_REG32(DC_CMD_STATE_CONTROL),
	DEFS_REG32(DC_CMD_DISPLAY_WINDOW_HEADER),
	DEFS_REG32(DC_CMD_REG_ACT_CONTROL),
	DEFS_REG32(DC_COM_CRC_CONTROL),
	DEFS_REG32(DC_COM_CRC_CHECKSUM),
	DEFS_REG32(DC_COM_PIN_OUTPUT_ENABLE(0)),
	DEFS_REG32(DC_COM_PIN_OUTPUT_ENABLE(1)),
	DEFS_REG32(DC_COM_PIN_OUTPUT_ENABLE(2)),
	DEFS_REG32(DC_COM_PIN_OUTPUT_ENABLE(3)),
	DEFS_REG32(DC_COM_PIN_OUTPUT_POLARITY(0)),
	DEFS_REG32(DC_COM_PIN_OUTPUT_POLARITY(1)),
	DEFS_REG32(DC_COM_PIN_OUTPUT_POLARITY(2)),
	DEFS_REG32(DC_COM_PIN_OUTPUT_POLARITY(3)),
	DEFS_REG32(DC_COM_PIN_OUTPUT_DATA(0)),
	DEFS_REG32(DC_COM_PIN_OUTPUT_DATA(1)),
	DEFS_REG32(DC_COM_PIN_OUTPUT_DATA(2)),
	DEFS_REG32(DC_COM_PIN_OUTPUT_DATA(3)),
	DEFS_REG32(DC_COM_PIN_INPUT_ENABLE(0)),
	DEFS_REG32(DC_COM_PIN_INPUT_ENABLE(1)),
	DEFS_REG32(DC_COM_PIN_INPUT_ENABLE(2)),
	DEFS_REG32(DC_COM_PIN_INPUT_ENABLE(3)),
	DEFS_REG32(DC_COM_PIN_INPUT_DATA(0)),
	DEFS_REG32(DC_COM_PIN_INPUT_DATA(1)),
	DEFS_REG32(DC_COM_PIN_OUTPUT_SELECT(0)),
	DEFS_REG32(DC_COM_PIN_OUTPUT_SELECT(1)),
	DEFS_REG32(DC_COM_PIN_OUTPUT_SELECT(2)),
	DEFS_REG32(DC_COM_PIN_OUTPUT_SELECT(3)),
	DEFS_REG32(DC_COM_PIN_OUTPUT_SELECT(4)),
	DEFS_REG32(DC_COM_PIN_OUTPUT_SELECT(5)),
	DEFS_REG32(DC_COM_PIN_OUTPUT_SELECT(6)),
	DEFS_REG32(DC_COM_PIN_MISC_CONTROL),
	DEFS_REG32(DC_COM_PIN_PM0_CONTROL),
	DEFS_REG32(DC_COM_PIN_PM0_DUTY_CYCLE),
	DEFS_REG32(DC_COM_PIN_PM1_CONTROL),
	DEFS_REG32(DC_COM_PIN_PM1_DUTY_CYCLE),
	DEFS_REG32(DC_COM_SPI_CONTROL),
	DEFS_REG32(DC_COM_SPI_START_BYTE),
	DEFS_REG32(DC_COM_HSPI_WRITE_DATA_AB),
	DEFS_REG32(DC_COM_HSPI_WRITE_DATA_CD),
	DEFS_REG32(DC_COM_HSPI_CS_DC),
	DEFS_REG32(DC_COM_SCRATCH_REGISTER_A),
	DEFS_REG32(DC_COM_SCRATCH_REGISTER_B),
	DEFS_REG32(DC_COM_GPIO_CTRL),
	DEFS_REG32(DC_COM_GPIO_DEBOUNCE_COUNTER),
	DEFS_REG32(DC_COM_CRC_CHECKSUM_LATCHED),
	DEFS_REG32(DC_DISP_DISP_SIGNAL_OPTIONS0),
	DEFS_REG32(DC_DISP_DISP_SIGNAL_OPTIONS1),
	DEFS_REG32(DC_DISP_DISP_WIN_OPTIONS),
	DEFS_REG32(DC_DISP_DISP_MEM_HIGH_PRIORITY),
	DEFS_REG32(DC_DISP_DISP_MEM_HIGH_PRIORITY_TIMER),
	DEFS_REG32(DC_DISP_DISP_TIMING_OPTIONS),
	DEFS_REG32(DC_DISP_REF_TO_SYNC),
	DEFS_REG32(DC_DISP_SYNC_WIDTH),
	DEFS_REG32(DC_DISP_BACK_PORCH),
	DEFS_REG32(DC_DISP_ACTIVE),
	DEFS_REG32(DC_DISP_FRONT_PORCH),
	DEFS_REG32(DC_DISP_H_PULSE0_CONTROL),
	DEFS_REG32(DC_DISP_H_PULSE0_POSITION_A),
	DEFS_REG32(DC_DISP_H_PULSE0_POSITION_B),
	DEFS_REG32(DC_DISP_H_PULSE0_POSITION_C),
	DEFS_REG32(DC_DISP_H_PULSE0_POSITION_D),
	DEFS_REG32(DC_DISP_H_PULSE1_CONTROL),
	DEFS_REG32(DC_DISP_H_PULSE1_POSITION_A),
	DEFS_REG32(DC_DISP_H_PULSE1_POSITION_B),
	DEFS_REG32(DC_DISP_H_PULSE1_POSITION_C),
	DEFS_REG32(DC_DISP_H_PULSE1_POSITION_D),
	DEFS_REG32(DC_DISP_H_PULSE2_CONTROL),
	DEFS_REG32(DC_DISP_H_PULSE2_POSITION_A),
	DEFS_REG32(DC_DISP_H_PULSE2_POSITION_B),
	DEFS_REG32(DC_DISP_H_PULSE2_POSITION_C),
	DEFS_REG32(DC_DISP_H_PULSE2_POSITION_D),
	DEFS_REG32(DC_DISP_V_PULSE0_CONTROL),
	DEFS_REG32(DC_DISP_V_PULSE0_POSITION_A),
	DEFS_REG32(DC_DISP_V_PULSE0_POSITION_B),
	DEFS_REG32(DC_DISP_V_PULSE0_POSITION_C),
	DEFS_REG32(DC_DISP_V_PULSE1_CONTROL),
	DEFS_REG32(DC_DISP_V_PULSE1_POSITION_A),
	DEFS_REG32(DC_DISP_V_PULSE1_POSITION_B),
	DEFS_REG32(DC_DISP_V_PULSE1_POSITION_C),
	DEFS_REG32(DC_DISP_V_PULSE2_CONTROL),
	DEFS_REG32(DC_DISP_V_PULSE2_POSITION_A),
	DEFS_REG32(DC_DISP_V_PULSE3_CONTROL),
	DEFS_REG32(DC_DISP_V_PULSE3_POSITION_A),
	DEFS_REG32(DC_DISP_M0_CONTROL),
	DEFS_REG32(DC_DISP_M1_CONTROL),
	DEFS_REG32(DC_DISP_DI_CONTROL),
	DEFS_REG32(DC_DISP_PP_CONTROL),
	DEFS_REG32(DC_DISP_PP_SELECT_A),
	DEFS_REG32(DC_DISP_PP_SELECT_B),
	DEFS_REG32(DC_DISP_PP_SELECT_C),
	DEFS_REG32(DC_DISP_PP_SELECT_D),
	DEFS_REG32(DC_DISP_DISP_CLOCK_CONTROL),
	DEFS_REG32(DC_DISP_DISP_INTERFACE_CONTROL),
	DEFS_REG32(DC_DISP_DISP_COLOR_CONTROL),
	DEFS_REG32(DC_DISP_SHIFT_CLOCK_OPTIONS),
	DEFS_REG32(DC_DISP_DATA_ENABLE_OPTIONS),
	DEFS_REG32(DC_DISP_SERIAL_INTERFACE_OPTIONS),
	DEFS_REG32(DC_DISP_LCD_SPI_OPTIONS),
	DEFS_REG32(DC_DISP_BORDER_COLOR),
	DEFS_REG32(DC_DISP_COLOR_KEY0_LOWER),
	DEFS_REG32(DC_DISP_COLOR_KEY0_UPPER),
	DEFS_REG32(DC_DISP_COLOR_KEY1_LOWER),
	DEFS_REG32(DC_DISP_COLOR_KEY1_UPPER),
	DEFS_REG32(DC_DISP_CURSOR_FOREGROUND),
	DEFS_REG32(DC_DISP_CURSOR_BACKGROUND),
	DEFS_REG32(DC_DISP_CURSOR_START_ADDR),
	DEFS_REG32(DC_DISP_CURSOR_START_ADDR_NS),
	DEFS_REG32(DC_DISP_CURSOR_POSITION),
	DEFS_REG32(DC_DISP_CURSOR_POSITION_NS),
	DEFS_REG32(DC_DISP_INIT_SEQ_CONTROL),
	DEFS_REG32(DC_DISP_SPI_INIT_SEQ_DATA_A),
	DEFS_REG32(DC_DISP_SPI_INIT_SEQ_DATA_B),
	DEFS_REG32(DC_DISP_SPI_INIT_SEQ_DATA_C),
	DEFS_REG32(DC_DISP_SPI_INIT_SEQ_DATA_D),
	DEFS_REG32(DC_DISP_DC_MCCIF_FIFOCTRL),
	DEFS_REG32(DC_DISP_MCCIF_DISPLAY0A_HYST),
	DEFS_REG32(DC_DISP_MCCIF_DISPLAY0B_HYST),
	DEFS_REG32(DC_DISP_MCCIF_DISPLAY1A_HYST),
	DEFS_REG32(DC_DISP_MCCIF_DISPLAY1B_HYST),
	DEFS_REG32(DC_DISP_DAC_CRT_CTRL),
	DEFS_REG32(DC_DISP_DISP_MISC_CONTROL),
	DEFS_REG32(DC_DISP_SD_CONTROL),
	DEFS_REG32(DC_DISP_SD_CSC_COEFF),
	DEFS_REG32(DC_DISP_SD_LUT(0)),
	DEFS_REG32(DC_DISP_SD_LUT(1)),
	DEFS_REG32(DC_DISP_SD_LUT(2)),
	DEFS_REG32(DC_DISP_SD_LUT(3)),
	DEFS_REG32(DC_DISP_SD_LUT(4)),
	DEFS_REG32(DC_DISP_SD_LUT(5)),
	DEFS_REG32(DC_DISP_SD_LUT(6)),
	DEFS_REG32(DC_DISP_SD_LUT(7)),
	DEFS_REG32(DC_DISP_SD_LUT(8)),
	DEFS_REG32(DC_DISP_SD_FLICKER_CONTROL),
	DEFS_REG32(DC_DISP_DC_PIXEL_COUNT),
	DEFS_REG32(DC_DISP_SD_HISTOGRAM(0)),
	DEFS_REG32(DC_DISP_SD_HISTOGRAM(1)),
	DEFS_REG32(DC_DISP_SD_HISTOGRAM(2)),
	DEFS_REG32(DC_DISP_SD_HISTOGRAM(3)),
	DEFS_REG32(DC_DISP_SD_HISTOGRAM(4)),
	DEFS_REG32(DC_DISP_SD_HISTOGRAM(5)),
	DEFS_REG32(DC_DISP_SD_HISTOGRAM(6)),
	DEFS_REG32(DC_DISP_SD_HISTOGRAM(7)),
	DEFS_REG32(DC_DISP_SD_BL_TF(0)),
	DEFS_REG32(DC_DISP_SD_BL_TF(1)),
	DEFS_REG32(DC_DISP_SD_BL_TF(2)),
	DEFS_REG32(DC_DISP_SD_BL_TF(3)),
	DEFS_REG32(DC_DISP_SD_BL_CONTROL),
	DEFS_REG32(DC_DISP_SD_HW_K_VALUES),
	DEFS_REG32(DC_DISP_SD_MAN_K_VALUES),
	DEFS_REG32(DC_DISP_CURSOR_START_ADDR_HI),
	DEFS_REG32(DC_DISP_BLEND_CURSOR_CONTROL),
	DEFS_REG32(DC_WIN_WIN_OPTIONS),
	DEFS_REG32(DC_WIN_BYTE_SWAP),
	DEFS_REG32(DC_WIN_BUFFER_CONTROL),
	DEFS_REG32(DC_WIN_COLOR_DEPTH),
	DEFS_REG32(DC_WIN_POSITION),
	DEFS_REG32(DC_WIN_SIZE),
	DEFS_REG32(DC_WIN_PRESCALED_SIZE),
	DEFS_REG32(DC_WIN_H_INITIAL_DDA),
	DEFS_REG32(DC_WIN_V_INITIAL_DDA),
	DEFS_REG32(DC_WIN_DDA_INC),
	DEFS_REG32(DC_WIN_LINE_STRIDE),
	DEFS_REG32(DC_WIN_BUF_STRIDE),
	DEFS_REG32(DC_WIN_UV_BUF_STRIDE),
	DEFS_REG32(DC_WIN_BUFFER_ADDR_MODE),
	DEFS_REG32(DC_WIN_DV_CONTROL),
	DEFS_REG32(DC_WIN_BLEND_NOKEY),
	DEFS_REG32(DC_WIN_BLEND_1WIN),
	DEFS_REG32(DC_WIN_BLEND_2WIN_X),
	DEFS_REG32(DC_WIN_BLEND_2WIN_Y),
	DEFS_REG32(DC_WIN_BLEND_3WIN_XY),
	DEFS_REG32(DC_WIN_HP_FETCH_CONTROL),
	DEFS_REG32(DC_WINBUF_START_ADDR),
	DEFS_REG32(DC_WINBUF_START_ADDR_NS),
	DEFS_REG32(DC_WINBUF_START_ADDR_U),
	DEFS_REG32(DC_WINBUF_START_ADDR_U_NS),
	DEFS_REG32(DC_WINBUF_START_ADDR_V),
	DEFS_REG32(DC_WINBUF_START_ADDR_V_NS),
	DEFS_REG32(DC_WINBUF_ADDR_H_OFFSET),
	DEFS_REG32(DC_WINBUF_ADDR_H_OFFSET_NS),
	DEFS_REG32(DC_WINBUF_ADDR_V_OFFSET),
	DEFS_REG32(DC_WINBUF_ADDR_V_OFFSET_NS),
	DEFS_REG32(DC_WINBUF_UFLOW_STATUS),
	DEFS_REG32(DC_WINBUF_AD_UFLOW_STATUS),
	DEFS_REG32(DC_WINBUF_BD_UFLOW_STATUS),
	DEFS_REG32(DC_WINBUF_CD_UFLOW_STATUS),
};
...
#ifdef CONFIG_DE_FS
	root = crtc->defs_entry;
#else
	root = NULL;
#endif

	dc->defs_files = kmemdup(defs_files, sizeof(defs_files),
				    GFP_KERNEL);
	if (!dc->defs_files)
		return -ENOMEM;

	for (i = 0; i < count; i++)
		dc->defs_files[i].data = dc;

	err = drm_defs_create_files(dc->defs_files, count, root, minor);
	if (err < 0)
		goto free;
...
static void tegra_dc_early_unregister(struct drm_crtc *crtc)
{
	...
	drm_defs_remove_files(dc->defs_files, count, minor);
	kfree(dc->defs_files);
	dc->defs_files = NULL;
}
