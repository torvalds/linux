...
static inline int tegra_drm_get_streamid_offset_thi(
    struct tegra_drm_client *client, u32 *offset) {
  *offset = 0x30;
  return 0;
}
...
static inline struct tegra_drm_client *host1x_to_drm_client(
...
enum drm_connector_status tegra_output_connector_detect(
