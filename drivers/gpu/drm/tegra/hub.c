...
static unsigned int tegra_shared_plane_get_owner(struct tegra_plane *plane,
    struct tegra_dc *dc) {
  unsigned int offset
...
static struct drm_private_state *tegra_display_hub_duplicate_state(
...
static struct tegra_display_hub_state *tegra_display_hub_get_state(
