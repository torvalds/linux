...
static inline const struct vc4_vec_tv_mode *vc4_vec_tv_mode_lookup(
    unsigned int mode, u16 htotal) {
  unsigned int i;
...
static enum drm_connector_status vc4_vec_connector_detect(
...
static int vc4_vec_connector_set_property(struct drm_connector *connector,
...
static int vc4_vec_connector_get_property(struct drm_connector *connector,
