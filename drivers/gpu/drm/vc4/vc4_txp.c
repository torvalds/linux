...
static enum drm_mode_status vc4_txp_connector_mode_valid(
...
static void vc4_txp_connector_atomic_commit(struct drm_connector *conn,
  ...
  struct drm_connector_state *conn_state = drm_atomic_get_new_connector_state(
      state,
      conn);
...
static enum drm_connector_status vc4_txp_connector_detect(
