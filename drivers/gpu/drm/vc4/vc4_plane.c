...
static struct drm_plane_state *vc4_plane_duplicate_state(
...
static int vc4_plane_setup_clipping_and_scaling(struct drm_plane_state *state) {
  ...
  vc4_state->src_w[0]
    = DIV_ROUND_CLOSEST(state->src.x2, 1 << 16) - vc4_state->src_x;
  vc4_state->src_h[0]
    = DIV_ROUND_CLOSEST(state->src.y2, 1 << 16) - vc4_state->src_y;
