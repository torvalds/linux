...
#define VC4_HDMI_TX_PHY_PLL_CALIBRATION_CONFIG_1_MIN_LIMIT_MASK   VC4_MASK(27, \
    0)
#define VC4_HDMI_TX_PHY_PLL_CALIBRATION_CONFIG_1_MIN_LIMIT_SHIFT  0

#define VC4_HDMI_TX_PHY_PLL_CALIBRATION_CONFIG_2_MAX_LIMIT_MASK   VC4_MASK(27, \
    0)
#define VC4_HDMI_TX_PHY_PLL_CALIBRATION_CONFIG_2_MAX_LIMIT_SHIFT  0

#define VC4_HDMI_TX_PHY_PLL_CALIBRATION_CONFIG_4_STABLE_THRESHOLD_MASK  VC4_MASK( \
    31, 16)
#define VC4_HDMI_TX_PHY_PLL_CALIBRATION_CONFIG_4_STABLE_THRESHOLD_SHIFT 16
#define VC4_HDMI_TX_PHY_PLL_CALIBRATION_CONFIG_4_HOLD_THRESHOLD_MASK  VC4_MASK( \
    15, 0)
...
static unsigned long long phy_get_vco_freq(unsigned long long clock,
    u8 *vco_sel, u8 *vco_div) {
...
static const struct phy_lane_settings *phy_get_channel_settings(
    enum vc4_hdmi_phy_channel chan,
...
void vc5_hdmi_phy_init(struct vc4_hdmi *vc4_hdmi,
  ...
  HDMI_WRITE(HDMI_TX_PHY_PLL_CALIBRATION_CONFIG_4,
      VC4_SET_FIELD(0xe147,
      VC4_HDMI_TX_PHY_PLL_CALIBRATION_CONFIG_4_HOLD_THRESHOLD)
      | VC4_SET_FIELD(0xe14,
      VC4_HDMI_TX_PHY_PLL_CALIBRATION_CONFIG_4_STABLE_THRESHOLD));
