...
static void mgag200_handle_damage(struct mga_device *mdev,
...
const size_t mgag200_primary_plane_formats_size = ARRAY_SIZE(
...
static void mgag200_mode_config_helper_atomic_commit_tail(
    struct drm_atomic_state *state) {
...
static enum drm_mode_status mgag200_mode_config_mode_valid(
  ...
  if (info->max_mem_bandwidth) {
    uint32_t mode_bandwidth
      = mgag200_calculate_mode_bandwidth(mode, max_bpp * 8);
