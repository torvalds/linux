...
static int mgag200_g200se_04_pixpllc_atomic_check(struct drm_crtc *crtc,
  ...
  static const unsigned int pllreffreq = 25000;
  static const unsigned int pvalues_e4[] = {
...
static const struct drm_plane_helper_funcs
    mgag200_g200se_primary_plane_helper_funcs = {
...
static const struct drm_connector_helper_funcs
    mgag200_g200se_vga_connector_helper_funcs = {
...
struct mga_device *mgag200_g200se_device_create(struct pci_dev *pdev,
  ...
  int ret;
  g200se = devm_drm_dev_alloc(&pdev->dev, drv, struct mgag200_g200se_device,
      base.base);
  if (IS_ERR(g200se)) {
