...
static int mgag200_g200_pixpllc_atomic_check(struct drm_crtc *crtc,
...
static const struct drm_plane_helper_funcs
    mgag200_g200_primary_plane_helper_funcs = {
...
struct mga_device *mgag200_g200_device_create(struct pci_dev *pdev,
  ...
  int ret;
  g200 = devm_drm_dev_alloc(&pdev->dev, drv, struct mgag200_g200_device,
      base.base);
  if (IS_ERR(g200)) {
