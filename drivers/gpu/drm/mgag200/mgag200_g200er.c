...
static int mgag200_g200er_pixpllc_atomic_check(struct drm_crtc *crtc,
  ...
  static const unsigned int m_div_val[] = {
    1, 2, 4, 8
  };
  struct drm_crtc_state *new_crtc_state = drm_atomic_get_new_crtc_state(
      new_state, crtc);
  struct mgag200_crtc_state *new_mgag200_crtc_state = to_mgag200_crtc_state(
      new_crtc_state);
...
static void mgag200_g200er_pixpllc_atomic_update(struct drm_crtc *crtc,
  ...
  struct mgag200_crtc_state *mgag200_crtc_state = to_mgag200_crtc_state(
      crtc_state);
...
static const struct drm_plane_helper_funcs
    mgag200_g200er_primary_plane_helper_funcs = {
...
static const struct drm_connector_helper_funcs
    mgag200_g200er_vga_connector_helper_funcs = {
