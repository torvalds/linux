...
#define MCHBAR_CH0_CR_TC_PRE_0_0_0_MCHBAR_HIGH  _MMIO( \
    MCHBAR_MIRROR_BASE_SNB + 0x4004)
#define   DG1_DRAM_T_RCD_MASK     REG_GENMASK(15, 9)
#define   DG1_DRAM_T_RAS_MASK     REG_GENMASK(8, 1)

#define SKL_MAD_INTER_CHANNEL_0_0_0_MCHBAR_MCMAIN _MMIO( \
    MCHBAR_MIRROR_BASE_SNB + 0x5000)
...
#define SKL_MAD_DIMM_CH0_0_0_0_MCHBAR_MCMAIN  _MMIO( \
    MCHBAR_MIRROR_BASE_SNB + 0x500C)
#define SKL_MAD_DIMM_CH1_0_0_0_MCHBAR_MCMAIN  _MMIO( \
    MCHBAR_MIRROR_BASE_SNB + 0x5010)
...
#define PCU_PACKAGE_ENERGY_STATUS              _MMIO( \
    MCHBAR_MIRROR_BASE_SNB + 0x593c)
