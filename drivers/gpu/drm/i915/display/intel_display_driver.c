...
/**
 * intel_display_driver_enable_user_access - Enable display HW access for all
 *threads
...
/**
 * intel_display_driver_disable_user_access - Disable display HW access for user
 *threads
 * @i915: i915 device instance
 *
 ...
 * should be followed by calling either
 *intel_display_driver_enable_user_access()
...
/**
 * intel_display_driver_suspend_access - Suspend display HW access for all
 *threads
 * @i915: i915 device instance
 *
...
/**
 * intel_display_driver_resume_access - Resume display HW access for the resume
 *thread
 * @i915: i915 device instance
 *
...
/**
 * intel_display_driver_check_access - Check if the current thread has disaplay
 *HW access
 * @i915: i915 device instance
 *
