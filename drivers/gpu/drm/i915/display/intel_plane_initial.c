...
static bool initial_plane_phys_lmem(struct drm_i915_private *i915,
...
static bool initial_plane_phys_smem(struct drm_i915_private *i915,
    struct intel_initial_plane_config *plane_config) {
  struct intel_memory_region *mem;
  u32 base;
  base = round_down(plane_config->base, I915_GTT_MIN_ALIGNMENT);
...
static bool initial_plane_phys(struct drm_i915_private *i915,
    struct intel_initial_plane_config *plane_config) {
...
static struct i915_vma *initial_plane_vma(struct drm_i915_private *i915,
    struct intel_initial_plane_config *plane_config) {
  struct intel_memory_region *mem;
  ...
  if (IS_ENABLED(CONFIG_FRAMEBUFFER_CONSOLE)
    ...
    drm_dbg_kms(&i915->drm,
        "Initial FB size exceeds half of stolen, discarding\n");
    return NULL;
  }
