...
#define MBUS_DBOX_B2B_TRANSACTIONS_MAX(x) REG_FIELD_PREP( \
    MBUS_DBOX_B2B_TRANSACTIONS_MAX_MASK, x)
#define MBUS_DBOX_B2B_TRANSACTIONS_DELAY_MASK REG_GENMASK(19, 17) /* tgl+ */
#define MBUS_DBOX_B2B_TRANSACTIONS_DELAY(x) REG_FIELD_PREP( \
    MBUS_DBOX_B2B_TRANSACTIONS_DELAY_MASK, x)
...
#define MBUS_JOIN_PIPE_SELECT(pipe) REG_FIELD_PREP(MBUS_JOIN_PIPE_SELECT_MASK, \
    pipe)
...
#define PLANE_WM_SAGV_TRANS(pipe, plane) \
  _MMIO(_PLANE(plane, _PLANE_WM_SAGV_TRANS_1(pipe), _PLANE_WM_SAGV_TRANS_2( \
    pipe)))
...
#define  DBUF_TRACKER_STATE_SERVICE(x)    REG_FIELD_PREP( \
    DBUF_TRACKER_STATE_SERVICE_MASK, x)
#define  DBUF_MIN_TRACKER_STATE_SERVICE_MASK  REG_GENMASK(18, 16) /* ADL-P+ */
#define  DBUF_MIN_TRACKER_STATE_SERVICE(x)    REG_FIELD_PREP( \
    DBUF_MIN_TRACKER_STATE_SERVICE_MASK, x) /* ADL-P+ */
