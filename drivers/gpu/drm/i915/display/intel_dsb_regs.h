...
#define   DSB_MMIO_DEAD_CLOCKS_COUNT(x) REG_FIELD_PREP( \
    DSB_MMIO_DEAD_CLOCK_COUNT_MASK, (x))
...
#define   DSB_RM_CLAIM_TIMEOUT_COUNT(x) REG_FIELD_PREP( \
    DSB_RM_CLAIM_TIMEOUT_COUNT_MASK, (x)) /* clocks */
#define   DSB_RM_READY_TIMEOUT_VALUE_MASK REG_GENMASK(15, 0)
#define   DSB_RM_READY_TIMEOUT_VALUE(x) REG_FIELD_PREP( \
    DSB_RM_READY_TIMEOUT_VALUE, (x)) /* usec */
#define DSB_RMTIMEOUTREG_CAPTURE(pipe, id)  _MMIO(DSBSL_INSTANCE(pipe, \
    id) + 0x34)
...
#define   DSB_SCANLINE_FOR_DEWAKE(x)  REG_FIELD_PREP( \
    DSB_SCANLINE_FOR_DEWAKE_MASK, (x))
