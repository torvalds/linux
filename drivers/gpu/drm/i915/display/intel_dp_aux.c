...
static u32 intel_dp_aux_wait_done(struct intel_dp *intel_dp) {
...
static int intel_dp_aux_xfer(struct intel_dp *intel_dp,
...
static void intel_dp_aux_header(u8 txbuf[HEADER_SIZE],
...
static ssize_t intel_dp_aux_transfer(struct drm_dp_aux *aux,
...
static struct intel_encoder *get_encoder_by_aux_ch(
