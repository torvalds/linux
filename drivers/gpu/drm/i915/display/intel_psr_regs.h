...
#define   EDP_PSR_MIN_LINK_ENTRY_TIME_8_LINES REG_FIELD_PREP( \
    EDP_PSR_MIN_LINK_ENTRY_TIME_MASK, 0)
#define   EDP_PSR_MIN_LINK_ENTRY_TIME_4_LINES REG_FIELD_PREP( \
    EDP_PSR_MIN_LINK_ENTRY_TIME_MASK, 1)
#define   EDP_PSR_MIN_LINK_ENTRY_TIME_2_LINES REG_FIELD_PREP( \
    EDP_PSR_MIN_LINK_ENTRY_TIME_MASK, 2)
#define   EDP_PSR_MIN_LINK_ENTRY_TIME_0_LINES REG_FIELD_PREP( \
    EDP_PSR_MIN_LINK_ENTRY_TIME_MASK, 3)
#define   EDP_PSR_MAX_SLEEP_TIME_MASK   REG_GENMASK(24, 20)
#define   EDP_PSR_MAX_SLEEP_TIME(x)   REG_FIELD_PREP( \
    EDP_PSR_MAX_SLEEP_TIME_MASK, (x))
#define   LNL_EDP_PSR_ENTRY_SETUP_FRAMES_MASK REG_GENMASK(17, 16)
#define   LNL_EDP_PSR_ENTRY_SETUP_FRAMES(x) REG_FIELD_PREP( \
    LNL_EDP_PSR_ENTRY_SETUP_FRAMES_MASK, (x))
...
#define   EDP_PSR_TP2_TP3_TIME_500us    REG_FIELD_PREP( \
    EDP_PSR_TP2_TP3_TIME_MASK, 0)
#define   EDP_PSR_TP2_TP3_TIME_100us    REG_FIELD_PREP( \
    EDP_PSR_TP2_TP3_TIME_MASK, 1)
#define   EDP_PSR_TP2_TP3_TIME_2500us   REG_FIELD_PREP( \
    EDP_PSR_TP2_TP3_TIME_MASK, 2)
#define   EDP_PSR_TP2_TP3_TIME_0us    REG_FIELD_PREP(EDP_PSR_TP2_TP3_TIME_MASK, \
    3)
...
#define   EDP_PSR_IDLE_FRAMES(x)    REG_FIELD_PREP(EDP_PSR_IDLE_FRAMES_MASK, \
    (x))
...
#define   EDP_PSR_STATUS_STATE_IDLE   REG_FIELD_PREP(EDP_PSR_STATUS_STATE_MASK, \
    0)
#define   EDP_PSR_STATUS_STATE_SRDONACK   REG_FIELD_PREP( \
    EDP_PSR_STATUS_STATE_MASK, 1)
#define   EDP_PSR_STATUS_STATE_SRDENT   REG_FIELD_PREP( \
    EDP_PSR_STATUS_STATE_MASK, 2)
#define   EDP_PSR_STATUS_STATE_BUFOFF   REG_FIELD_PREP( \
    EDP_PSR_STATUS_STATE_MASK, 3)
#define   EDP_PSR_STATUS_STATE_BUFON    REG_FIELD_PREP( \
    EDP_PSR_STATUS_STATE_MASK, 4)
#define   EDP_PSR_STATUS_STATE_AUXACK   REG_FIELD_PREP( \
    EDP_PSR_STATUS_STATE_MASK, 5)
#define   EDP_PSR_STATUS_STATE_SRDOFFACK  REG_FIELD_PREP( \
    EDP_PSR_STATUS_STATE_MASK, 6)
#define   EDP_PSR_STATUS_LINK_MASK    REG_GENMASK(27, 26)
#define   EDP_PSR_STATUS_LINK_FULL_OFF    REG_FIELD_PREP( \
    EDP_PSR_STATUS_LINK_MASK, 0)
#define   EDP_PSR_STATUS_LINK_FULL_ON   REG_FIELD_PREP(EDP_PSR_STATUS_LINK_MASK, \
    1)
#define   EDP_PSR_STATUS_LINK_STANDBY   REG_FIELD_PREP(EDP_PSR_STATUS_LINK_MASK, \
    2)
...
#define   TGL_EDP_PSR2_BLOCK_COUNT_NUM_2  REG_FIELD_PREP( \
    TGL_EDP_PSR2_BLOCK_COUNT_MASK, 0)
#define   TGL_EDP_PSR2_BLOCK_COUNT_NUM_3  REG_FIELD_PREP( \
    TGL_EDP_PSR2_BLOCK_COUNT_MASK, 1)
...
#define   EDP_MAX_SU_DISABLE_TIME(t)    REG_FIELD_PREP(EDP_MAX_SU_DISABLE_TIME, \
    (t))
...
#define   TGL_EDP_PSR2_FAST_WAKE(lines)   REG_FIELD_PREP( \
...
#define   EDP_PSR2_FRAME_BEFORE_SU(a)   REG_FIELD_PREP( \
    EDP_PSR2_FRAME_BEFORE_SU_MASK, (a))
#define   EDP_PSR2_IDLE_FRAMES_MASK   REG_GENMASK(3, 0)
#define   EDP_PSR2_IDLE_FRAMES(x)   REG_FIELD_PREP(EDP_PSR2_IDLE_FRAMES_MASK, \
    (x))
...
#define EDP_PSR2_STATUS_STATE_DEEP_SLEEP  REG_FIELD_PREP( \
    EDP_PSR2_STATUS_STATE_MASK, 0x8)

#define _PSR2_SU_STATUS_A   0x60914
#define _PSR2_SU_STATUS_EDP   0x6f914
#define _PSR2_SU_STATUS(tran, index)  _MMIO_TRANS2(tran, \
...
#define  PSR2_MAN_TRK_CTL_SU_REGION_END_ADDR(val)   REG_FIELD_PREP( \
...
#define  ADLP_PSR2_MAN_TRK_CTL_SU_REGION_END_ADDR(val)    REG_FIELD_PREP( \
...
#define PLANE_SEL_FETCH_SIZE(pipe, \
      plane) _MMIO(_SEL_FETCH_PLANE_BASE(pipe, plane)   \
    + _SEL_FETCH_PLANE_SIZE_1_A   \
    - _SEL_FETCH_PLANE_BASE_1_A)

#define _SEL_FETCH_PLANE_OFFSET_1_A   0x7089C
#define PLANE_SEL_FETCH_OFFSET(pipe, \
      plane) _MMIO(_SEL_FETCH_PLANE_BASE(pipe, plane)   \
...
#define  ALPM_CTL_AUX_LESS_SLEEP_HOLD_TIME_50_SYMBOLS REG_FIELD_PREP( \
    ALPM_CTL_AUX_LESS_SLEEP_HOLD_TIME_MASK, 0)
#define  ALPM_CTL_AUX_LESS_SLEEP_HOLD_TIME_128_SYMBOLS  REG_FIELD_PREP( \
    ALPM_CTL_AUX_LESS_SLEEP_HOLD_TIME_MASK, 1)
#define  ALPM_CTL_AUX_LESS_SLEEP_HOLD_TIME_256_SYMBOLS  REG_FIELD_PREP( \
    ALPM_CTL_AUX_LESS_SLEEP_HOLD_TIME_MASK, 2)
#define  ALPM_CTL_AUX_LESS_SLEEP_HOLD_TIME_512_SYMBOLS  REG_FIELD_PREP( \
    ALPM_CTL_AUX_LESS_SLEEP_HOLD_TIME_MASK, 3)
#define  ALPM_CTL_AUX_WAKE_SLEEP_HOLD_ENABLE    REG_BIT(20)
#define  ALPM_CTL_ALPM_ENTRY_CHECK_MASK     REG_GENMASK(19, 16)
#define  ALPM_CTL_ALPM_ENTRY_CHECK(val)     REG_FIELD_PREP( \
    ALPM_CTL_ALPM_ENTRY_CHECK_MASK, val)
#define  ALPM_CTL_EXTENDED_FAST_WAKE_TIME_MASK    REG_GENMASK(13, 8)
#define  ALPM_CTL_EXTENDED_FAST_WAKE_MIN_LINES    5
#define  ALPM_CTL_EXTENDED_FAST_WAKE_TIME(lines)  REG_FIELD_PREP( \
    ALPM_CTL_EXTENDED_FAST_WAKE_TIME_MASK, \
    (lines) - ALPM_CTL_EXTENDED_FAST_WAKE_MIN_LINES)
#define  ALPM_CTL_AUX_LESS_WAKE_TIME_MASK   REG_GENMASK(5, 0)
#define  ALPM_CTL_AUX_LESS_WAKE_TIME(val)   REG_FIELD_PREP( \
    ALPM_CTL_AUX_LESS_WAKE_TIME_MASK, val)
...
#define  ALPM_CTL2_SWITCH_TO_ACTIVE_LATENCY(val)    REG_FIELD_PREP( \
    ALPM_CTL2_SWITCH_TO_ACTIVE_LATENCY_MASK, val)
#define  ALPM_CTL2_AUX_LESS_WAKE_TIME_EXTENSION_MASK    REG_GENMASK(19, 16)
#define  ALPM_CTL2_AUX_LESS_WAKE_TIME_EXTENSION(val)    REG_FIELD_PREP( \
    ALPM_CTL2_AUX_LESS_WAKE_TIME_EXTENSION_MASK, val)
#define  ALPM_CTL2_NUMBER_OF_LTTPR_MASK       REG_GENMASK(15, 12)
#define  ALPM_CTL2_NUMBER_OF_LTTPR(val)       REG_FIELD_PREP( \
    ALPM_CTL2_NUMBER_OF_LTTPR_MASK, val)
#define  ALPM_CTL2_LTTPR_AUX_LESS_SLEEP_HOLD_TIME_MASK    REG_GENMASK(10, 8)
#define  ALPM_CTL2_LTTPR_AUX_LESS_SLEEP_HOLD_TIME(val)    REG_FIELD_PREP( \
    ALPM_CTL2_LTTPR_AUX_LESS_SLEEP_HOLD_TIME_MASK, val)
#define  ALPM_CTL2_FEC_DECODE_EN_POSITION_AFTER_WAKE_SR   REG_BIT(4)
#define  ALPM_CTL2_NUMBER_AUX_LESS_ML_PHY_SLEEP_SEQUENCES_MASK  REG_GENMASK(2, \
    0)
#define  ALPM_CTL2_NUMBER_AUX_LESS_ML_PHY_SLEEP_SEQUENCES(val)  REG_FIELD_PREP( \
    ALPM_CTL2_NUMBER_AUX_LESS_ML_PHY_SLEEP_SEQUENCES_MASK, val)

#define _PORT_ALPM_CTL_A      0x16fa2c
#define PORT_ALPM_CTL(tran)     _MMIO_TRANS2(tran, _PORT_ALPM_CTL_A)
#define  PORT_ALPM_CTL_ALPM_AUX_LESS_ENABLE REG_BIT(31)
#define  PORT_ALPM_CTL_MAX_PHY_SWING_SETUP_MASK REG_GENMASK(23, 20)
#define  PORT_ALPM_CTL_MAX_PHY_SWING_SETUP(val) REG_FIELD_PREP( \
    PORT_ALPM_CTL_MAX_PHY_SWING_SETUP_MASK, val)
#define  PORT_ALPM_CTL_MAX_PHY_SWING_HOLD_MASK  REG_GENMASK(19, 16)
#define  PORT_ALPM_CTL_MAX_PHY_SWING_HOLD(val)  REG_FIELD_PREP( \
    PORT_ALPM_CTL_MAX_PHY_SWING_HOLD_MASK, val)
#define  PORT_ALPM_CTL_SILENCE_PERIOD_MASK  REG_GENMASK(7, 0)
#define  PORT_ALPM_CTL_SILENCE_PERIOD(val)  REG_FIELD_PREP( \
    PORT_ALPM_CTL_SILENCE_PERIOD_MASK, val)

#define _PORT_ALPM_LFPS_CTL_A         0x16fa30
#define PORT_ALPM_LFPS_CTL(tran)        _MMIO_TRANS2(tran, \
    _PORT_ALPM_LFPS_CTL_A)
