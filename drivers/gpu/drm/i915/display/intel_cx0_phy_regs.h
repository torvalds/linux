...
#define _XELPDP_PORT_M2P_MSGBUS_CTL(idx, \
      lane)    _MMIO(_PICK_EVEN_2RANGES(idx, PORT_TC1, \
...
#define   XELPDP_PORT_M2P_COMMAND_WRITE_COMMITTED REG_FIELD_PREP( \
    XELPDP_PORT_M2P_COMMAND_TYPE_MASK, 0x2)
#define   XELPDP_PORT_M2P_COMMAND_READ      REG_FIELD_PREP( \
    XELPDP_PORT_M2P_COMMAND_TYPE_MASK, 0x3)
#define   XELPDP_PORT_M2P_DATA_MASK     REG_GENMASK(23, 16)
#define   XELPDP_PORT_M2P_DATA(val)     REG_FIELD_PREP( \
    XELPDP_PORT_M2P_DATA_MASK, val)
#define   XELPDP_PORT_M2P_TRANSACTION_RESET   REG_BIT(15)
#define   XELPDP_PORT_M2P_ADDRESS_MASK      REG_GENMASK(11, 0)
#define   XELPDP_PORT_M2P_ADDRESS(val)      REG_FIELD_PREP( \
    XELPDP_PORT_M2P_ADDRESS_MASK, val)

#define _XELPDP_PORT_P2M_MSGBUS_STATUS(idx, \
      lane) _MMIO(_PICK_EVEN_2RANGES(idx, PORT_TC1, \
    _XELPDP_PORT_M2P_MSGBUS_CTL_LN0_A, \
    _XELPDP_PORT_M2P_MSGBUS_CTL_LN0_B, \
    _XELPDP_PORT_M2P_MSGBUS_CTL_LN0_USBC1, \
...
#define   XELPDP_PORT_P2M_DATA(val)     REG_FIELD_PREP( \
    XELPDP_PORT_P2M_DATA_MASK, val)
...
#define   XELPDP_PORT_BUF_PORT_DATA_10BIT   REG_FIELD_PREP( \
    XELPDP_PORT_BUF_PORT_DATA_WIDTH_MASK, 0)
#define   XELPDP_PORT_BUF_PORT_DATA_20BIT   REG_FIELD_PREP( \
    XELPDP_PORT_BUF_PORT_DATA_WIDTH_MASK, 1)
#define   XELPDP_PORT_BUF_PORT_DATA_40BIT   REG_FIELD_PREP( \
    XELPDP_PORT_BUF_PORT_DATA_WIDTH_MASK, 2)
...
#define   XELPDP_LANE_PIPE_RESET(lane)      _PICK(lane, REG_BIT(31), \
    REG_BIT(30))
#define   XELPDP_LANE_PHY_CURRENT_STATUS(lane)    _PICK(lane, REG_BIT( \
    29), REG_BIT(28))
#define   XELPDP_LANE_POWERDOWN_UPDATE(lane)    _PICK(lane, REG_BIT(25), REG_BIT( \
    24))
#define   _XELPDP_LANE0_POWERDOWN_NEW_STATE_MASK  REG_GENMASK(23, 20)
#define   _XELPDP_LANE0_POWERDOWN_NEW_STATE(val)  REG_FIELD_PREP( \
    _XELPDP_LANE0_POWERDOWN_NEW_STATE_MASK, val)
#define   _XELPDP_LANE1_POWERDOWN_NEW_STATE_MASK  REG_GENMASK(19, 16)
#define   _XELPDP_LANE1_POWERDOWN_NEW_STATE(val)  REG_FIELD_PREP( \
    _XELPDP_LANE1_POWERDOWN_NEW_STATE_MASK, val)
...
#define   XELPDP_POWER_STATE_READY(val)     REG_FIELD_PREP( \
    XELPDP_POWER_STATE_READY_MASK, val)
...
#define   XELPDP_PLL_LANE_STAGGERING_DELAY(val)   REG_FIELD_PREP( \
    XELPDP_PLL_LANE_STAGGERING_DELAY_MASK, val)
#define   XELPDP_POWER_STATE_ACTIVE_MASK    REG_GENMASK(3, 0)
#define   XELPDP_POWER_STATE_ACTIVE(val)    REG_FIELD_PREP( \
    XELPDP_POWER_STATE_ACTIVE_MASK, val)
...
#define _XELPDP_PORT_MSGBUS_TIMER(port, \
      lane)   _MMIO(_PICK_EVEN_2RANGES(port, PORT_TC1, \
...
#define   XELPDP_PORT_MSGBUS_TIMER_VAL      REG_FIELD_PREP( \
    XELPDP_PORT_MSGBUS_TIMER_VAL_MASK, 0xa000)
...
#define   XELPDP_DDI_CLOCK_SELECT(val)      REG_FIELD_PREP( \
...
#define   C10_VDR_CUSTOM_WIDTH_8_10    REG_FIELD_PREP(C10_VDR_CUSTOM_WIDTH_MASK, \
    0)
...
#define   PHY_C20_CUSTOM_SERDES(val)  REG_FIELD_PREP8( \
    PHY_C20_CUSTOM_SERDES_MASK, val)
#define PHY_C20_VDR_CUSTOM_WIDTH  0xD02
#define   PHY_C20_CUSTOM_WIDTH_MASK REG_GENMASK(1, 0)
#define   PHY_C20_CUSTOM_WIDTH(val) REG_FIELD_PREP8(PHY_C20_CUSTOM_WIDTH_MASK, \
    val)
...
#define C20_PHY_VSWING_PREEMPH(val) REG_FIELD_PREP8(C20_PHY_VSWING_PREEMPH_MASK, \
    val)
...
#define MPLL_DIV_MULTIPLIER(val)  REG_FIELD_PREP16(MPLL_DIV_MULTIPLIER_MASK, \
    val)
