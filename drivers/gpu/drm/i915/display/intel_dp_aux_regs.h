...
#define   DP_AUX_CH_CTL_TIME_OUT_400us    REG_FIELD_PREP( \
    DP_AUX_CH_CTL_TIME_OUT_MASK, 0)
#define   DP_AUX_CH_CTL_TIME_OUT_600us    REG_FIELD_PREP( \
    DP_AUX_CH_CTL_TIME_OUT_MASK, 1)
#define   DP_AUX_CH_CTL_TIME_OUT_800us    REG_FIELD_PREP( \
    DP_AUX_CH_CTL_TIME_OUT_MASK, 2)
#define   DP_AUX_CH_CTL_TIME_OUT_MAX    REG_FIELD_PREP( \
    DP_AUX_CH_CTL_TIME_OUT_MASK, 3) /* Varies per platform */
#define   DP_AUX_CH_CTL_RECEIVE_ERROR   REG_BIT(25)
#define   DP_AUX_CH_CTL_MESSAGE_SIZE_MASK REG_GENMASK(24, 20)
#define   DP_AUX_CH_CTL_MESSAGE_SIZE(x)   REG_FIELD_PREP( \
    DP_AUX_CH_CTL_MESSAGE_SIZE_MASK, (x))
#define   DP_AUX_CH_CTL_PRECHARGE_2US_MASK  REG_GENMASK(19, 16) /* pre-skl */
#define   DP_AUX_CH_CTL_PRECHARGE_2US(x)  REG_FIELD_PREP( \
    DP_AUX_CH_CTL_PRECHARGE_2US_MASK, (x))
...
#define   DP_AUX_CH_CTL_BIT_CLOCK_2X(x)   REG_FIELD_PREP( \
    DP_AUX_CH_CTL_BIT_CLOCK_2X_MASK, (x))
#define   DP_AUX_CH_CTL_FW_SYNC_PULSE_SKL_MASK  REG_GENMASK(9, 5) /* skl+ */
#define   DP_AUX_CH_CTL_FW_SYNC_PULSE_SKL(c)  REG_FIELD_PREP( \
    DP_AUX_CH_CTL_FW_SYNC_PULSE_SKL_MASK, (c) - 1)
#define   DP_AUX_CH_CTL_SYNC_PULSE_SKL_MASK REG_GENMASK(4, 0) /* skl+ */
#define   DP_AUX_CH_CTL_SYNC_PULSE_SKL(c) REG_FIELD_PREP( \
    DP_AUX_CH_CTL_SYNC_PULSE_SKL_MASK, (c) - 1)
...
#define VLV_DP_AUX_CH_DATA(aux_ch, \
      i) _MMIO(VLV_DISPLAY_BASE + _PORT(aux_ch, _DPA_AUX_CH_DATA1, \
    _DPB_AUX_CH_DATA1) + (i) * 4) /* 5 registers */
