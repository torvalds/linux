...
#define PREC_PIPEGCMAX(pipe, \
      i)        _MMIO(_PIPE(pipe, _PIPEAGCMAX, _PIPEBGCMAX) + (i) * 4) /* u1.16
                                                                        * */
...
#define  GAMMA_MODE_MODE_SPLIT      REG_FIELD_PREP(GAMMA_MODE_MODE_MASK, 3) /*
                                                                             * ivb-bdw
                                                                             * */
#define  GAMMA_MODE_MODE_12BIT_MULTI_SEG  REG_FIELD_PREP(GAMMA_MODE_MODE_MASK, \
    3) /* icl-tgl */
...
#define PIPE_CSC_COEFF_RY_GY(pipe)  _MMIO_PIPE(pipe, _PIPE_A_CSC_COEFF_RY_GY, \
    _PIPE_B_CSC_COEFF_RY_GY)
#define PIPE_CSC_COEFF_BY(pipe)   _MMIO_PIPE(pipe, _PIPE_A_CSC_COEFF_BY, \
    _PIPE_B_CSC_COEFF_BY)
#define PIPE_CSC_COEFF_RU_GU(pipe)  _MMIO_PIPE(pipe, _PIPE_A_CSC_COEFF_RU_GU, \
    _PIPE_B_CSC_COEFF_RU_GU)
#define PIPE_CSC_COEFF_BU(pipe)   _MMIO_PIPE(pipe, _PIPE_A_CSC_COEFF_BU, \
    _PIPE_B_CSC_COEFF_BU)
#define PIPE_CSC_COEFF_RV_GV(pipe)  _MMIO_PIPE(pipe, _PIPE_A_CSC_COEFF_RV_GV, \
    _PIPE_B_CSC_COEFF_RV_GV)
#define PIPE_CSC_COEFF_BV(pipe)   _MMIO_PIPE(pipe, _PIPE_A_CSC_COEFF_BV, \
...
#define PIPE_CSC_POSTOFF_HI(pipe) _MMIO_PIPE(pipe, _PIPE_A_CSC_POSTOFF_HI, \
    _PIPE_B_CSC_POSTOFF_HI)
#define PIPE_CSC_POSTOFF_ME(pipe) _MMIO_PIPE(pipe, _PIPE_A_CSC_POSTOFF_ME, \
    _PIPE_B_CSC_POSTOFF_ME)
#define PIPE_CSC_POSTOFF_LO(pipe) _MMIO_PIPE(pipe, _PIPE_A_CSC_POSTOFF_LO, \
...
#define PREC_PAL_DATA(pipe)   _MMIO_PIPE(pipe, _PAL_PREC_DATA_A, \
    _PAL_PREC_DATA_B)
#define PREC_PAL_GC_MAX(pipe, \
      i)  _MMIO(_PIPE(pipe, _PAL_PREC_GC_MAX_A, _PAL_PREC_GC_MAX_B) + (i) * 4) /*
                                                                                * u1.16
                                                                                * */
#define PREC_PAL_EXT_GC_MAX(pipe, \
      i)  _MMIO(_PIPE(pipe, _PAL_PREC_EXT_GC_MAX_A, \
    _PAL_PREC_EXT_GC_MAX_B) + (i) * 4) /* u3.16 */
#define PREC_PAL_EXT2_GC_MAX(pipe, \
      i) _MMIO(_PIPE(pipe, _PAL_PREC_EXT2_GC_MAX_A, \
    _PAL_PREC_EXT2_GC_MAX_B) + (i) * 4) /* glk+, u3.16 */
...
#define   PRE_CSC_GAMC_INDEX_VALUE(x) REG_FIELD_PREP( \
    PRE_CSC_GAMC_INDEX_VALUE_MASK, (x))
...
#define PRE_CSC_GAMC_DATA(pipe)   _MMIO_PIPE(pipe, _PRE_CSC_GAMC_DATA_A, \
    _PRE_CSC_GAMC_DATA_B)
...
#define   PAL_PREC_MULTI_SEG_INDEX_VALUE(x) REG_FIELD_PREP( \
    PAL_PREC_MULTI_SEG_INDEX_VALUE_MASK, (x))
...
#define CGM_PIPE_CSC_COEFF01(pipe)  _MMIO_PIPE(pipe, _CGM_PIPE_A_CSC_COEFF01, \
    _CGM_PIPE_B_CSC_COEFF01)
#define CGM_PIPE_CSC_COEFF23(pipe)  _MMIO_PIPE(pipe, _CGM_PIPE_A_CSC_COEFF23, \
    _CGM_PIPE_B_CSC_COEFF23)
#define CGM_PIPE_CSC_COEFF45(pipe)  _MMIO_PIPE(pipe, _CGM_PIPE_A_CSC_COEFF45, \
    _CGM_PIPE_B_CSC_COEFF45)
#define CGM_PIPE_CSC_COEFF67(pipe)  _MMIO_PIPE(pipe, _CGM_PIPE_A_CSC_COEFF67, \
    _CGM_PIPE_B_CSC_COEFF67)
#define CGM_PIPE_CSC_COEFF8(pipe) _MMIO_PIPE(pipe, _CGM_PIPE_A_CSC_COEFF8, \
    _CGM_PIPE_B_CSC_COEFF8)
#define CGM_PIPE_DEGAMMA(pipe, i, \
      w)  _MMIO(_PIPE(pipe, _CGM_PIPE_A_DEGAMMA, \
    _CGM_PIPE_B_DEGAMMA) + (i) * 8 + (w) * 4)
#define CGM_PIPE_GAMMA(pipe, i, \
      w)  _MMIO(_PIPE(pipe, _CGM_PIPE_A_GAMMA, \
