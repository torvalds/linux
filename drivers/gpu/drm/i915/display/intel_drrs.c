...
static void intel_drrs_set_refresh_rate_pipeconf(struct intel_crtc *crtc,
...
static void intel_drrs_set_refresh_rate_m_n(struct intel_crtc *crtc,
    enum drrs_refresh_rate refresh_rate) {
...
static unsigned int intel_drrs_frontbuffer_bits(
