...
static int intel_display_param_int_open(struct inode *inode,
    struct file *file) {
...
static int intel_display_param_uint_open(struct inode *inode,
    struct file *file) {
...
__maybe_unused static struct dentry *intel_display_debugfs_create_int(
...
__maybe_unused static struct dentry *intel_display_debugfs_create_uint(
    const char *name, umode_t mode,
