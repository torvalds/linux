...
static struct intel_global_state *intel_pmdemand_duplicate_state(
...
static struct intel_pmdemand_state *intel_atomic_get_pmdemand_state(
...
static struct intel_pmdemand_state *intel_atomic_get_new_pmdemand_state(
    struct intel_atomic_state *state) {
  struct drm_i915_private *i915 = to_i915(state->base.dev);
  struct intel_global_state *pmdemand_state
...
static void intel_pmdemand_update_max_ddiclk(struct drm_i915_private *i915,
    struct intel_atomic_state *state,
    struct intel_pmdemand_state *pmdemand_state) {
  int max_ddiclk = 0;
...
static void intel_pmdemand_update_connector_phys(struct drm_i915_private *i915,
    struct intel_atomic_state *state,
...
static void intel_pmdemand_update_active_non_tc_phys(
...
static bool intel_pmdemand_encoder_has_tc_phy(struct drm_i915_private *i915,
    struct intel_encoder *encoder) {
  enum phy phy;
  if (!encoder) {
    return false;
...
static bool intel_pmdemand_connector_needs_update(
    struct intel_atomic_state *state) {
  struct drm_i915_private *i915 = to_i915(state->base.dev);
  struct drm_connector_state *old_conn_state;
  struct drm_connector_state *new_conn_state;
...
static void intel_pmdemand_update_params(const struct intel_pmdemand_state *new,
...
static void intel_pmdemand_program_params(struct drm_i915_private *i915,
...
static bool intel_pmdemand_state_changed(const struct intel_pmdemand_state *new,
    const struct intel_pmdemand_state *old) {
