...
#define   DVO_ACT_DATA_ORDER_GBRG_ERRATA  REG_FIELD_PREP( \
    DVO_ACT_DATA_ORDER_MASK, 0)
#define   DVO_ACT_DATA_ORDER_RGGB_ERRATA  REG_FIELD_PREP( \
    DVO_ACT_DATA_ORDER_MASK, 1)
...
#define   DVO_SRCDIM_HORIZONTAL(x)    REG_FIELD_PREP(DVO_SRCDIM_HORIZONTAL_MASK, \
    (x))
#define   DVO_SRCDIM_VERTICAL_MASK    REG_GENMASK(10, 0)
#define   DVO_SRCDIM_VERTICAL(x)    REG_FIELD_PREP(DVO_SRCDIM_VERTICAL_MASK, \
    (x))
