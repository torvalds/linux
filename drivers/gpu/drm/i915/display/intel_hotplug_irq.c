...
static const u32 hpd_gen11[HPD_NUM_PINS] = {
  [HPD_PORT_TC1] = GEN11_TC_HOTPLUG(HPD_PORT_TC1) | GEN11_TBT_HOTPLUG(
      HPD_PORT_TC1),
  [HPD_PORT_TC2] = GEN11_TC_HOTPLUG(HPD_PORT_TC2) | GEN11_TBT_HOTPLUG(
      HPD_PORT_TC2),
  [HPD_PORT_TC3] = GEN11_TC_HOTPLUG(HPD_PORT_TC3) | GEN11_TBT_HOTPLUG(
      HPD_PORT_TC3),
  [HPD_PORT_TC4] = GEN11_TC_HOTPLUG(HPD_PORT_TC4) | GEN11_TBT_HOTPLUG(
      HPD_PORT_TC4),
  [HPD_PORT_TC5] = GEN11_TC_HOTPLUG(HPD_PORT_TC5) | GEN11_TBT_HOTPLUG(
      HPD_PORT_TC5),
  [HPD_PORT_TC6] = GEN11_TC_HOTPLUG(HPD_PORT_TC6) | GEN11_TBT_HOTPLUG(
      HPD_PORT_TC6),
};

static const u32 hpd_xelpdp[HPD_NUM_PINS] = {
  [HPD_PORT_TC1] = XELPDP_TBT_HOTPLUG(HPD_PORT_TC1) | XELPDP_DP_ALT_HOTPLUG(
      HPD_PORT_TC1),
  [HPD_PORT_TC2] = XELPDP_TBT_HOTPLUG(HPD_PORT_TC2) | XELPDP_DP_ALT_HOTPLUG(
      HPD_PORT_TC2),
  [HPD_PORT_TC3] = XELPDP_TBT_HOTPLUG(HPD_PORT_TC3) | XELPDP_DP_ALT_HOTPLUG(
      HPD_PORT_TC3),
  [HPD_PORT_TC4] = XELPDP_TBT_HOTPLUG(HPD_PORT_TC4) | XELPDP_DP_ALT_HOTPLUG(
      HPD_PORT_TC4),
};
...
void i9xx_hpd_irq_handler(struct drm_i915_private *dev_priv,
    u32 hotplug_status) {
...
void ibx_hpd_irq_handler(struct drm_i915_private *dev_priv,
    u32 hotplug_trigger) {
...
void xelpdp_pica_irq_handler(struct drm_i915_private *i915, u32 iir) {
  ...
  u32 hotplug_trigger = iir
      & (XELPDP_DP_ALT_HOTPLUG_MASK | XELPDP_TBT_HOTPLUG_MASK);
...
void icp_irq_handler(struct drm_i915_private *dev_priv, u32 pch_iir) {
  ...
  if (ddi_hotplug_trigger) {
    ...
    dig_hotplug_reg
      = intel_uncore_rmw(&dev_priv->uncore, SHOTPLUG_CTL_DDI, 0, 0);
  ...
  if (tc_hotplug_trigger) {
    u32 dig_hotplug_reg;
    dig_hotplug_reg
      = intel_uncore_rmw(&dev_priv->uncore, SHOTPLUG_CTL_TC, 0, 0);
    intel_get_hpd_pins(dev_priv, &pin_mask, &long_mask,
...
void spt_irq_handler(struct drm_i915_private *dev_priv, u32 pch_iir) {
  ...
  if (hotplug_trigger) {
    u32 dig_hotplug_reg;
    dig_hotplug_reg
      = intel_uncore_rmw(&dev_priv->uncore, PCH_PORT_HOTPLUG, 0, 0);
    intel_get_hpd_pins(dev_priv, &pin_mask, &long_mask,
        hotplug_trigger, dig_hotplug_reg,
        dev_priv->display.hotplug.pch_hpd,
  ...
  if (hotplug2_trigger) {
    u32 dig_hotplug_reg;
    dig_hotplug_reg = intel_uncore_rmw(&dev_priv->uncore, PCH_PORT_HOTPLUG2, 0,
        0);
    intel_get_hpd_pins(dev_priv, &pin_mask, &long_mask,
...
void ilk_hpd_irq_handler(struct drm_i915_private *dev_priv,
    u32 hotplug_trigger) {
  u32 dig_hotplug_reg, pin_mask = 0, long_mask = 0;
...
void bxt_hpd_irq_handler(struct drm_i915_private *dev_priv,
    u32 hotplug_trigger) {
  u32 dig_hotplug_reg, pin_mask = 0, long_mask = 0;
...
void gen11_hpd_irq_handler(struct drm_i915_private *dev_priv, u32 iir) {
  ...
  if (trigger_tc) {
    u32 dig_hotplug_reg;
    dig_hotplug_reg = intel_uncore_rmw(&dev_priv->uncore, GEN11_TC_HOTPLUG_CTL,
        0, 0);
    intel_get_hpd_pins(dev_priv, &pin_mask, &long_mask,
  ...
  if (trigger_tbt) {
    u32 dig_hotplug_reg;
    dig_hotplug_reg = intel_uncore_rmw(&dev_priv->uncore, GEN11_TBT_HOTPLUG_CTL,
        0, 0);
    intel_get_hpd_pins(dev_priv, &pin_mask, &long_mask,
...
static void gen11_hpd_irq_setup(struct drm_i915_private *dev_priv) {
  u32 hotplug_irqs, enabled_irqs;
  enabled_irqs
    = intel_hpd_enabled_irqs(dev_priv, dev_priv->display.hotplug.hpd);
  hotplug_irqs
    = intel_hpd_hotplug_irqs(dev_priv, dev_priv->display.hotplug.hpd);
