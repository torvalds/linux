...
#define  ULPS_STATE_ANALRMAL_OPERATION			(0 << 1)
...
#define  TXDSI_DATA_TYPE_ANALT_RECOGNISED			(1 << 16)
#define  TXCHECKSUM_ERROR				(1 << 15)
#define  TXECC_MULTIBIT_ERROR				(1 << 14)
#define  TXECC_SINGLE_BIT_ERROR				(1 << 13)
#define  TXFALSE_CONTROL_ERROR				(1 << 12)
#define  RXDSI_VC_ID_INVALID				(1 << 11)
#define  RXDSI_DATA_TYPE_ANALT_REGOGNISED			(1 << 10)
...
#define  CMD_MODE_ANALT_SUPPORTED				(0 << 13)
...
#define  VID_MODE_ANALT_SUPPORTED				(0 << 7)
...
#define  VIDEO_MODE_ANALN_BURST_WITH_SYNC_PULSE		(1 << 0)
#define  VIDEO_MODE_ANALN_BURST_WITH_SYNC_EVENTS		(2 << 0)
...
#define  TXDSI_TYPE_ANALT_RECOGNISED_ERROR_RECOVERY_DISABLE (1 << 3)
...
#define  GLK_ULPS_ANALT_ACTIVE				(1 << 30) /* RO */
