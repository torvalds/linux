...
TRACE_EVENT(intel_pipe_enable,
  ...
  __entry->scanline[it__->pipe] = intel_get_crtc_scanline(it__);
    ...
    TP_printk(
    "dev %s, pipe %c enable, pipe A: frame=%u, scanline=%u, pipe B: frame=%u, scanline=%u, pipe C: frame=%u, scanline=%u",
...
TRACE_EVENT(intel_pipe_disable,
  ...
  __entry->scanline[it__->pipe] = intel_get_crtc_scanline(it__);
    ...
    TP_printk(
    "dev %s, pipe %c disable, pipe A: frame=%u, scanline=%u, pipe B: frame=%u, scanline=%u, pipe C: frame=%u, scanline=%u",
    __get_str(dev), pipe_name(__entry->pipe),
    __entry->frame[PIPE_A], __entry->scanline[PIPE_A],
    __entry->frame[PIPE_B], __entry->scanline[PIPE_B],
    __entry->frame[PIPE_C], __entry->scanline[PIPE_C])
...
TRACE_EVENT(intel_pipe_crc,
    ...
    TP_printk(
    "dev %s, pipe %c, frame=%u, scanline=%u crc=%08x %08x %08x %08x %08x",
    __get_str(dev), pipe_name(__entry->pipe),
...
TRACE_EVENT(intel_memory_cxsr,
  ...
  __entry->scanline[crtc->pipe] = intel_get_crtc_scanline(crtc);
    ...
    TP_printk(
    "dev %s, cxsr %s->%s, pipe A: frame=%u, scanline=%u, pipe B: frame=%u, scanline=%u, pipe C: frame=%u, scanline=%u",
...
TRACE_EVENT(g4x_wm,
    ...
    TP_printk(
    "dev %s, pipe %c, frame=%u, scanline=%u, wm %d/%d/%d, sr %s/%d/%d/%d, hpll %s/%d/%d/%d, fbc %s",
    __get_str(dev), pipe_name(__entry->pipe),
    __entry->frame, __entry->scanline,
    __entry->primary, __entry->sprite, __entry->cursor,
    str_yes_no(__entry->cxsr), __entry->sr_plane, __entry->sr_cursor,
    __entry->sr_fbc,
    str_yes_no(__entry->hpll), __entry->hpll_plane, __entry->hpll_cursor,
    __entry->hpll_fbc,
...
TRACE_EVENT(vlv_wm,
    ...
    TP_printk(
    "dev %s, pipe %c, frame=%u, scanline=%u, level=%d, cxsr=%d, wm %d/%d/%d/%d, sr %d/%d",
    __get_str(dev), pipe_name(__entry->pipe),
    __entry->frame, __entry->scanline,
...
TRACE_EVENT(vlv_fifo_size,
    TP_PROTO(struct intel_crtc *crtc, u32 sprite0_start, u32 sprite1_start,
    u32 fifo_size),
