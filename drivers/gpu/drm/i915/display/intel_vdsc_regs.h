...
#define  SPLITTER_CONFIGURATION_2_SEGMENT REG_FIELD_PREP( \
    SPLITTER_CONFIGURATION_MASK, 0)
#define  SPLITTER_CONFIGURATION_4_SEGMENT REG_FIELD_PREP( \
    SPLITTER_CONFIGURATION_MASK, 1)
...
#define DSCA_PPS(pps)       _MMIO( \
    _DSCA_PPS_0 + ((pps) < 12 ? (pps) : (pps) + 12) * 4)
#define DSCC_PPS(pps)       _MMIO( \
    _DSCC_PPS_0 + ((pps) < 12 ? (pps) : (pps) + 12) * 4)
...
#define   DSC_PPS0_LINE_BUF_DEPTH(depth)  REG_FIELD_PREP( \
    DSC_PPS0_LINE_BUF_DEPTH_MASK, depth)
...
#define   DSC_PPS0_VER_MINOR(minor)   REG_FIELD_PREP(DSC_PPS0_VER_MINOR_MASK, \
    minor)
#define   DSC_PPS0_VER_MAJOR_MASK   REG_GENMASK(3, 0)
#define   DSC_PPS0_VER_MAJOR(major)   REG_FIELD_PREP(DSC_PPS0_VER_MAJOR_MASK, \
    major)
...
#define   DSC_PPS2_PIC_WIDTH(pic_width)   REG_FIELD_PREP( \
    DSC_PPS2_PIC_WIDTH_MASK, pic_width)
#define   DSC_PPS2_PIC_HEIGHT(pic_height) REG_FIELD_PREP( \
    DSC_PPS2_PIC_HEIGHT_MASK, pic_height)

/* PPS 3 */
#define   DSC_PPS3_SLICE_WIDTH_MASK   REG_GENMASK(31, 16)
#define   DSC_PPS3_SLICE_HEIGHT_MASK    REG_GENMASK(15, 0)
#define   DSC_PPS3_SLICE_WIDTH(slice_width) REG_FIELD_PREP( \
    DSC_PPS3_SLICE_WIDTH_MASK, slice_width)
#define   DSC_PPS3_SLICE_HEIGHT(slice_height) REG_FIELD_PREP( \
    DSC_PPS3_SLICE_HEIGHT_MASK, slice_height)

/* PPS 4 */
#define   DSC_PPS4_INITIAL_DEC_DELAY_MASK REG_GENMASK(31, 16)
#define   DSC_PPS4_INITIAL_XMIT_DELAY_MASK  REG_GENMASK(9, 0)
#define   DSC_PPS4_INITIAL_DEC_DELAY(dec_delay) REG_FIELD_PREP( \
    DSC_PPS4_INITIAL_DEC_DELAY_MASK, \
    dec_delay)
#define   DSC_PPS4_INITIAL_XMIT_DELAY(xmit_delay) REG_FIELD_PREP( \
    DSC_PPS4_INITIAL_XMIT_DELAY_MASK, \
    xmit_delay)

/* PPS 5 */
#define   DSC_PPS5_SCALE_DEC_INT_MASK   REG_GENMASK(27, 16)
#define   DSC_PPS5_SCALE_INC_INT_MASK   REG_GENMASK(15, 0)
#define   DSC_PPS5_SCALE_DEC_INT(scale_dec) REG_FIELD_PREP( \
    DSC_PPS5_SCALE_DEC_INT_MASK, scale_dec)
#define   DSC_PPS5_SCALE_INC_INT(scale_inc) REG_FIELD_PREP( \
    DSC_PPS5_SCALE_INC_INT_MASK, scale_inc)
...
#define   DSC_PPS6_FLATNESS_MAX_QP(max_qp)  REG_FIELD_PREP( \
    DSC_PPS6_FLATNESS_MAX_QP_MASK, max_qp)
#define   DSC_PPS6_FLATNESS_MIN_QP(min_qp)  REG_FIELD_PREP( \
    DSC_PPS6_FLATNESS_MIN_QP_MASK, min_qp)
#define   DSC_PPS6_FIRST_LINE_BPG_OFFSET(offset)  REG_FIELD_PREP( \
    DSC_PPS6_FIRST_LINE_BPG_OFFSET_MASK, \
    offset)
#define   DSC_PPS6_INITIAL_SCALE_VALUE(value) REG_FIELD_PREP( \
    DSC_PPS6_INITIAL_SCALE_VALUE_MASK, \
    value)

/* PPS 7 */
#define   DSC_PPS7_NFL_BPG_OFFSET_MASK    REG_GENMASK(31, 16)
#define   DSC_PPS7_SLICE_BPG_OFFSET_MASK  REG_GENMASK(15, 0)
#define   DSC_PPS7_NFL_BPG_OFFSET(bpg_offset) REG_FIELD_PREP( \
    DSC_PPS7_NFL_BPG_OFFSET_MASK, bpg_offset)
#define   DSC_PPS7_SLICE_BPG_OFFSET(bpg_offset) REG_FIELD_PREP( \
    DSC_PPS7_SLICE_BPG_OFFSET_MASK, \
    bpg_offset)
/* PPS 8 */
#define   DSC_PPS8_INITIAL_OFFSET_MASK    REG_GENMASK(31, 16)
#define   DSC_PPS8_FINAL_OFFSET_MASK    REG_GENMASK(15, 0)
#define   DSC_PPS8_INITIAL_OFFSET(initial_offset) REG_FIELD_PREP( \
    DSC_PPS8_INITIAL_OFFSET_MASK, \
    initial_offset)
#define   DSC_PPS8_FINAL_OFFSET(final_offset) REG_FIELD_PREP( \
    DSC_PPS8_FINAL_OFFSET_MASK, \
    final_offset)

/* PPS 9 */
#define   DSC_PPS9_RC_EDGE_FACTOR_MASK    REG_GENMASK(19, 16)
#define   DSC_PPS9_RC_MODEL_SIZE_MASK   REG_GENMASK(15, 0)
#define   DSC_PPS9_RC_EDGE_FACTOR(rc_edge_fact) REG_FIELD_PREP( \
    DSC_PPS9_RC_EDGE_FACTOR_MASK, \
    rc_edge_fact)
#define   DSC_PPS9_RC_MODEL_SIZE(rc_model_size) REG_FIELD_PREP( \
    DSC_PPS9_RC_MODEL_SIZE_MASK, \
    rc_model_size)
...
#define   DSC_PPS10_RC_TARGET_OFF_LOW(rc_tgt_off_low) REG_FIELD_PREP( \
    DSC_PPS10_RC_TGT_OFF_LOW_MASK, \
    rc_tgt_off_low)
#define   DSC_PPS10_RC_TARGET_OFF_HIGH(rc_tgt_off_high) REG_FIELD_PREP( \
    DSC_PPS10_RC_TGT_OFF_HIGH_MASK, \
    rc_tgt_off_high)
#define   DSC_PPS10_RC_QUANT_INC_LIMIT1(lim)  REG_FIELD_PREP( \
    DSC_PPS10_RC_QUANT_INC_LIMIT1_MASK, lim)
#define   DSC_PPS10_RC_QUANT_INC_LIMIT0(lim)  REG_FIELD_PREP( \
    DSC_PPS10_RC_QUANT_INC_LIMIT0_MASK, lim)
...
#define   DSC_PPS16_SLICE_ROW_PER_FRAME(slice_row_per_frame)  REG_FIELD_PREP( \
    DSC_PPS16_SLICE_ROW_PR_FRME_MASK, \
    slice_row_per_frame)
#define   DSC_PPS16_SLICE_PER_LINE(slice_per_line)    REG_FIELD_PREP( \
    DSC_PPS16_SLICE_PER_LINE_MASK, \
    slice_per_line)
#define   DSC_PPS16_SLICE_CHUNK_SIZE(slice_chunk_size)    REG_FIELD_PREP( \
    DSC_PPS16_SLICE_CHUNK_SIZE_MASK, \
    slice_chunk_size)

/* PPS 17 (MTL+) */
#define   DSC_PPS17_SL_BPG_OFFSET_MASK    REG_GENMASK(31, 27)
#define   DSC_PPS17_SL_BPG_OFFSET(offset) REG_FIELD_PREP( \
    DSC_PPS17_SL_BPG_OFFSET_MASK, offset)

/* PPS 18 (MTL+) */
#define   DSC_PPS18_NSL_BPG_OFFSET_MASK   REG_GENMASK(31, 16)
#define   DSC_PPS18_SL_OFFSET_ADJ_MASK    REG_GENMASK(15, 0)
#define   DSC_PPS18_NSL_BPG_OFFSET(offset)  REG_FIELD_PREP( \
    DSC_PPS18_NSL_BPG_OFFSET_MASK, offset)
#define   DSC_PPS18_SL_OFFSET_ADJ(offset) REG_FIELD_PREP( \
    DSC_PPS18_SL_OFFSET_ADJ_MASK, offset)
