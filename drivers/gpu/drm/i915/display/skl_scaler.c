...
static int skl_update_scaler(struct intel_crtc_state *crtc_state,
    bool force_detach,
...
static int intel_atomic_setup_scaler(
    struct intel_crtc_scaler_state *scaler_state,
...
static void skl_scaler_setup_filter(struct drm_i915_private *dev_priv,
    enum pipe pipe,
