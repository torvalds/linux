...
#define CPT_AUD_CNTL_ST(pipe)   _MMIO_PIPE(pipe, _CPT_AUD_CNTL_ST_A, \
    _CPT_AUD_CNTL_ST_B)
...
#define VLV_AUD_CNTL_ST(pipe)   _MMIO_PIPE(pipe, _VLV_AUD_CNTL_ST_A, \
    _VLV_AUD_CNTL_ST_B)
...
#define   AUD_CONFIG_N(n)     (REG_FIELD_PREP(AUD_CONFIG_UPPER_N_MASK, \
    (n) >> 12)   \
  | REG_FIELD_PREP(AUD_CONFIG_LOWER_N_MASK, (n) & 0xfff))
#define   AUD_CONFIG_PIXEL_CLOCK_HDMI_MASK  REG_GENMASK(19, 16)
#define   AUD_CONFIG_PIXEL_CLOCK_HDMI_25175 REG_FIELD_PREP( \
    AUD_CONFIG_PIXEL_CLOCK_HDMI_MASK, 0)
#define   AUD_CONFIG_PIXEL_CLOCK_HDMI_25200 REG_FIELD_PREP( \
    AUD_CONFIG_PIXEL_CLOCK_HDMI_MASK, 1)
#define   AUD_CONFIG_PIXEL_CLOCK_HDMI_27000 REG_FIELD_PREP( \
    AUD_CONFIG_PIXEL_CLOCK_HDMI_MASK, 2)
#define   AUD_CONFIG_PIXEL_CLOCK_HDMI_27027 REG_FIELD_PREP( \
    AUD_CONFIG_PIXEL_CLOCK_HDMI_MASK, 3)
#define   AUD_CONFIG_PIXEL_CLOCK_HDMI_54000 REG_FIELD_PREP( \
    AUD_CONFIG_PIXEL_CLOCK_HDMI_MASK, 4)
#define   AUD_CONFIG_PIXEL_CLOCK_HDMI_54054 REG_FIELD_PREP( \
    AUD_CONFIG_PIXEL_CLOCK_HDMI_MASK, 5)
#define   AUD_CONFIG_PIXEL_CLOCK_HDMI_74176 REG_FIELD_PREP( \
    AUD_CONFIG_PIXEL_CLOCK_HDMI_MASK, 6)
#define   AUD_CONFIG_PIXEL_CLOCK_HDMI_74250 REG_FIELD_PREP( \
    AUD_CONFIG_PIXEL_CLOCK_HDMI_MASK, 7)
#define   AUD_CONFIG_PIXEL_CLOCK_HDMI_148352  REG_FIELD_PREP( \
    AUD_CONFIG_PIXEL_CLOCK_HDMI_MASK, 8)
#define   AUD_CONFIG_PIXEL_CLOCK_HDMI_148500  REG_FIELD_PREP( \
    AUD_CONFIG_PIXEL_CLOCK_HDMI_MASK, 9)
#define   AUD_CONFIG_PIXEL_CLOCK_HDMI_296703  REG_FIELD_PREP( \
    AUD_CONFIG_PIXEL_CLOCK_HDMI_MASK, 10)
#define   AUD_CONFIG_PIXEL_CLOCK_HDMI_297000  REG_FIELD_PREP( \
    AUD_CONFIG_PIXEL_CLOCK_HDMI_MASK, 11)
#define   AUD_CONFIG_PIXEL_CLOCK_HDMI_593407  REG_FIELD_PREP( \
    AUD_CONFIG_PIXEL_CLOCK_HDMI_MASK, 12)
#define   AUD_CONFIG_PIXEL_CLOCK_HDMI_594000  REG_FIELD_PREP( \
    AUD_CONFIG_PIXEL_CLOCK_HDMI_MASK, 13)
...
#define HSW_AUD_MISC_CTRL(trans)  _MMIO_TRANS(trans, _HSW_AUD_MISC_CTRL_A, \
    _HSW_AUD_MISC_CTRL_B)

#define _HSW_AUD_M_CTS_ENABLE_A   0x65028
#define _HSW_AUD_M_CTS_ENABLE_B   0x65128
#define HSW_AUD_M_CTS_ENABLE(trans) _MMIO_TRANS(trans, _HSW_AUD_M_CTS_ENABLE_A, \
...
#define HSW_AUD_EDID_DATA(trans)  _MMIO_TRANS(trans, _HSW_AUD_EDID_DATA_A, \
...
#define AUD_DP_2DOT0_CTRL(trans)  _MMIO_TRANS(trans, _AUD_TCA_DP_2DOT0_CTRL, \
    _AUD_TCB_DP_2DOT0_CTRL)
