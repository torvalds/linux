...
#define I915_PW_DOMAINS(...) \
  ...
  __LIST(__LIST_INLINE_ELEMS(const enum intel_display_power_domain, \
    __VA_ARGS__))

#define I915_DECL_PW_DOMAINS(__name, ...) \
  static const struct i915_power_domain_list __name = I915_PW_DOMAINS( \
    __VA_ARGS__)
...
#define I915_PW_INSTANCES(...) \
  ...
  __LIST(__LIST_INLINE_ELEMS(const struct i915_power_well_instance, \
    __VA_ARGS__))
...
static const struct i915_power_well_desc skl_power_wells_main[] = {
  {
    ...
    .instances = &I915_PW_INSTANCES(
        I915_PW("DDI_IO_A_E", &skl_pwdoms_ddi_io_a_e,
        .hsw.idx = SKL_PW_CTL_IDX_DDI_A_E),
        I915_PW("DDI_IO_B", &skl_pwdoms_ddi_io_b,
        .hsw.idx = SKL_PW_CTL_IDX_DDI_B),
        I915_PW("DDI_IO_C", &skl_pwdoms_ddi_io_c,
...
static const struct i915_power_well_desc glk_power_wells_main[] = {
  {
    ...
    .instances = &I915_PW_INSTANCES(
        ...
        I915_PW("DDI_IO_A", &glk_pwdoms_ddi_io_a,
        .hsw.idx = GLK_PW_CTL_IDX_DDI_A),
        I915_PW("DDI_IO_B", &glk_pwdoms_ddi_io_b,
        .hsw.idx = SKL_PW_CTL_IDX_DDI_B),
        I915_PW("DDI_IO_C", &glk_pwdoms_ddi_io_c,
        .hsw.idx = SKL_PW_CTL_IDX_DDI_C),
        ),
    .ops = &hsw_power_well_ops,
  },
...
static const struct i915_power_well_desc icl_power_wells_main[] = {
  {
    ...
    .instances = &I915_PW_INSTANCES(
        ...
        I915_PW("DDI_IO_D", &icl_pwdoms_ddi_io_d,
        .hsw.idx = ICL_PW_CTL_IDX_DDI_D),
        I915_PW("DDI_IO_E", &icl_pwdoms_ddi_io_e,
        .hsw.idx = ICL_PW_CTL_IDX_DDI_E),
        I915_PW("DDI_IO_F", &icl_pwdoms_ddi_io_f,
    ...
    .instances = &I915_PW_INSTANCES(
        ...
        I915_PW("AUX_TBT2", &icl_pwdoms_aux_tbt2,
        .hsw.idx = ICL_PW_CTL_IDX_AUX_TBT2),
        I915_PW("AUX_TBT3", &icl_pwdoms_aux_tbt3,
        .hsw.idx = ICL_PW_CTL_IDX_AUX_TBT3),
        I915_PW("AUX_TBT4", &icl_pwdoms_aux_tbt4,
...
static const struct i915_power_well_desc tgl_power_wells_main[] = {
  {
    ...
    .instances = &I915_PW_INSTANCES(
        ...
        I915_PW("DDI_IO_TC2", &tgl_pwdoms_ddi_io_tc2,
        .hsw.idx = TGL_PW_CTL_IDX_DDI_TC2),
        I915_PW("DDI_IO_TC3", &tgl_pwdoms_ddi_io_tc3,
        .hsw.idx = TGL_PW_CTL_IDX_DDI_TC3),
        I915_PW("DDI_IO_TC4", &tgl_pwdoms_ddi_io_tc4,
        .hsw.idx = TGL_PW_CTL_IDX_DDI_TC4),
        I915_PW("DDI_IO_TC5", &tgl_pwdoms_ddi_io_tc5,
        .hsw.idx = TGL_PW_CTL_IDX_DDI_TC5),
        I915_PW("DDI_IO_TC6", &tgl_pwdoms_ddi_io_tc6,
...
static const struct i915_power_well_desc tgl_power_wells_aux[] = {
  {
    .instances = &I915_PW_INSTANCES(
        ...
        I915_PW("AUX_USBC5", &tgl_pwdoms_aux_usbc5,
        .hsw.idx = TGL_PW_CTL_IDX_AUX_TC5),
        I915_PW("AUX_USBC6", &tgl_pwdoms_aux_usbc6,
    ...
    .instances = &I915_PW_INSTANCES(
        ...
        I915_PW("AUX_TBT5", &tgl_pwdoms_aux_tbt5,
        .hsw.idx = TGL_PW_CTL_IDX_AUX_TBT5),
        I915_PW("AUX_TBT6", &tgl_pwdoms_aux_tbt6,
...
#define for_each_power_well_instance_in_desc_list(_desc_list, _desc_count, \
      _desc, _inst) \
  for ((_desc) = (_desc_list); (_desc) - (_desc_list) < (_desc_count); \
      (_desc)++) \
  for ((_inst) = (_desc)->instances->list; \
      (_inst) - (_desc)->instances->list < (_desc)->instances->count; \
      (_inst)++)

#define for_each_power_well_instance(_desc_list, _desc_count, _descs, _desc, \
      _inst) \
...
static int __set_power_wells(struct i915_power_domains *power_domains,
  ...
  int plt_idx = 0;
  for_each_power_well_instance(power_well_descs, power_well_descs_sz, desc_list,
      desc, inst)
  power_well_count++;
...
/**
 * intel_display_power_map_cleanup - clean up power domain -> power well
 *mappings
 * @power_domains: power domain state
 *
