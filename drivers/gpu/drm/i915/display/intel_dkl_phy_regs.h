...
#define DKL_REG_TC_PORT(__reg) \
  (TC_PORT_1 + ((__reg).reg - _DKL_PHY1_BASE) \
  / (_DKL_PHY2_BASE - _DKL_PHY1_BASE))
...
#define   DKL_PLL_DIV0_AFC_STARTUP(val)     REG_FIELD_PREP( \
    DKL_PLL_DIV0_AFC_STARTUP_MASK, (val))
...
#define   DKL_PLL_BIAS_FBDIV_FRAC_MASK      (0x3FFFFF << \
...
#define  DKL_TX_DPCNTL2_CFG_LOADGENSELECT_TX1(val)  REG_FIELD_PREP( \
    DKL_TX_DPCNTL2_CFG_LOADGENSELECT_TX1_MASK, (val))
#define  DKL_TX_DPCNTL2_CFG_LOADGENSELECT_TX2_MASK  REG_GENMASK(6, 5)
#define  DKL_TX_DPCNTL2_CFG_LOADGENSELECT_TX2(val)  REG_FIELD_PREP( \
    DKL_TX_DPCNTL2_CFG_LOADGENSELECT_TX2_MASK, (val))
