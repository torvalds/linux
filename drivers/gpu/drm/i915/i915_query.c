...
static int query_engine_info(struct drm_i915_private *i915,
    struct drm_i915_query_item *query_item) {
...
static int copy_perf_config_registers_or_number(
    const struct i915_oa_reg *kernel_regs,
    u32 kernel_n_regs,
    u64 user_regs_ptr,
    u32 *user_n_regs) {
...
static int query_guc_submission_version(struct drm_i915_private *i915,
...
int i915_query_ioctl(struct drm_device *dev, void *data,
