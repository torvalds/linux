...
static struct dentry *i915_debugfs_create_int(const char *name, umode_t mode,
...
static struct dentry *i915_debugfs_create_uint(const char *name, umode_t mode,
...
static struct dentry *i915_debugfs_create_charp(const char *name, umode_t mode,
...
struct dentry *i915_debugfs_params(struct drm_i915_private *i915) {
   ...
   */
#define REGISTER(T, x, unused, mode, ...) _i915_param_create_file(dir, #x, mode, \
      &params->x);
