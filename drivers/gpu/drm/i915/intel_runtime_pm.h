...
static inline int intel_rpm_raw_wakeref_count(int wakeref_count) {
  return wakeref_count & INTEL_RPM_RAW_WAKEREF_MASK;
}

static inline int intel_rpm_wakelock_count(int wakeref_count) {
...
static inline void __assert_rpm_raw_wakeref_held(struct intel_runtime_pm *rpm,
    int wakeref_count) {
...
static inline void __assert_rpm_wakelock_held(struct intel_runtime_pm *rpm,
    int wakeref_count) {
 ...
 */
static inline void disable_rpm_wakeref_asserts(struct intel_runtime_pm *rpm) {
 ...
 */
static inline void enable_rpm_wakeref_asserts(struct intel_runtime_pm *rpm) {
...
#else
static inline void intel_runtime_pm_put(struct intel_runtime_pm *rpm,
