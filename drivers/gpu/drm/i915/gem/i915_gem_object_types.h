...
#define I915_BO_ALLOC_PM_EARLY    BIT(5)
   ...
   *be
   * allocated in the non-mappable portion of lmem. This is merely a hint, and
   *if
   * dealing with userspace objects the CPU fault handler is free to ignore
   *this.
   */
...
static inline struct drm_i915_gem_object *to_intel_bo(
