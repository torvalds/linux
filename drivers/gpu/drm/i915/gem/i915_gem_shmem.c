...
static int shmem_truncate(struct drm_i915_gem_object *obj) {
  /*
...
static void shmem_put_pages(struct drm_i915_gem_object *obj,
    struct sg_table *pages) {
...
static int shmem_pwrite(struct drm_i915_gem_object *obj,
...
static int shmem_pread(struct drm_i915_gem_object *obj,
