...
static struct drm_i915_gem_object *huge_pages_object(
...
static struct drm_i915_gem_object *fake_huge_pages_object(
    struct drm_i915_private *i915, u64 size, bool single) {
  static struct lock_class_key lock_class;
  struct drm_i915_gem_object *obj;
  GEM_BUG_ON(!size);
...
static int igt_check_page_sizes(struct i915_vma *vma) {
  ...
  if (i915_gem_object_is_lmem(obj)
    ...
    pr_err(
        "gtt pages mismatch for LMEM, expected 2M GTT pages, sg(%u), gtt(%u)\n",
...
static int __cpu_check_shmem(struct drm_i915_gem_object *obj, u32 dword,
    u32 val) {
...
static int __cpu_check_vmap(struct drm_i915_gem_object *obj, u32 dword,
    u32 val) {
...
static struct drm_i915_gem_object *igt_create_shmem(
    struct drm_i915_private *i915, u32 size, u32 flags) {
...
static struct drm_i915_gem_object *igt_create_internal(
    struct drm_i915_private *i915, u32 size, u32 flags) {
  return i915_gem_object_create_internal(i915, size);
}

static struct drm_i915_gem_object *igt_create_system(
    struct drm_i915_private *i915, u32 size, u32 flags) {
  return huge_pages_object(i915, size, size);
}

static struct drm_i915_gem_object *igt_create_local(
    struct drm_i915_private *i915, u32 size, u32 flags) {
