...
static void flush_write_domain(struct drm_i915_gem_object *obj,
 ...
 * flushes to occur.
 */
int i915_gem_object_set_to_wc_domain(struct drm_i915_gem_object *obj,
    bool write) {
  int ret;
  assert_object_held(obj);
...
/**
 * i915_gem_object_set_cache_level - Changes the cache-level of an object across
 *all VMA.
 * @obj: object to act on
 ...
 */
struct i915_vma *i915_gem_object_pin_to_display_plane(
    struct drm_i915_gem_object *obj,
