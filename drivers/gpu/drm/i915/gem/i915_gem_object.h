...
struct drm_i915_gem_object *i915_gem_object_create_shmem_from_data(
  struct drm_i915_private *i915,
  const void *data, resource_size_t size);
struct drm_i915_gem_object *__i915_gem_object_create_user(
...
struct sg_table *__i915_gem_object_unset_pages(struct drm_i915_gem_object *obj);
 ...
 */
static inline struct drm_i915_gem_object *i915_gem_object_lookup_rcu(
...
static inline struct drm_i915_gem_object *i915_gem_object_get_rcu(
    struct drm_i915_gem_object *obj) {
...
static inline struct drm_i915_gem_object *i915_gem_object_lookup(
    struct drm_file *file, u32 handle) {
  struct drm_i915_gem_object *obj;
  rcu_read_lock();
...
static inline struct drm_i915_gem_object *i915_gem_object_get(
    struct drm_i915_gem_object *obj) {
...
__attribute__((nonnull))
static inline void i915_gem_object_put(struct drm_i915_gem_object *obj) {
 ...
 */
static inline void assert_object_held_shared(
...
static inline void i915_gem_object_set_readonly(struct drm_i915_gem_object *obj)
{
  obj->flags |= I915_BO_READONLY;
}

static inline bool i915_gem_object_is_readonly(
    const struct drm_i915_gem_object *obj) {
  return obj->flags & I915_BO_READONLY;
}

static inline bool i915_gem_object_is_contiguous(
    const struct drm_i915_gem_object *obj) {
  return obj->flags & I915_BO_ALLOC_CONTIGUOUS;
}

static inline bool i915_gem_object_is_volatile(
    const struct drm_i915_gem_object *obj) {
  return obj->flags & I915_BO_ALLOC_VOLATILE;
}

static inline void i915_gem_object_set_volatile(struct drm_i915_gem_object *obj)
{
  obj->flags |= I915_BO_ALLOC_VOLATILE;
}

static inline bool i915_gem_object_has_tiling_quirk(
    struct drm_i915_gem_object *obj) {
  return test_bit(I915_TILING_QUIRK_BIT, &obj->flags);
}

static inline void i915_gem_object_set_tiling_quirk(
    struct drm_i915_gem_object *obj) {
  set_bit(I915_TILING_QUIRK_BIT, &obj->flags);
}

static inline void i915_gem_object_clear_tiling_quirk(
    struct drm_i915_gem_object *obj) {
...
static inline bool i915_gem_object_type_has(
    const struct drm_i915_gem_object *obj,
    unsigned long flags) {
...
static inline bool i915_gem_object_is_shrinkable(
    const struct drm_i915_gem_object *obj) {
  return i915_gem_object_type_has(obj, I915_GEM_OBJECT_IS_SHRINKABLE);
}

static inline bool i915_gem_object_has_self_managed_shrink_list(
    const struct drm_i915_gem_object *obj) {
  return i915_gem_object_type_has(obj,
      I915_GEM_OBJECT_SELF_MANAGED_SHRINK_LIST);
}

static inline bool i915_gem_object_is_proxy(
    const struct drm_i915_gem_object *obj) {
  return i915_gem_object_type_has(obj, I915_GEM_OBJECT_IS_PROXY);
}

static inline bool i915_gem_object_never_mmap(
    const struct drm_i915_gem_object *obj) {
...
static inline unsigned int i915_gem_object_get_tiling(
    const struct drm_i915_gem_object *obj) {
  return obj->tiling_and_stride & TILING_MASK;
}

static inline bool i915_gem_object_is_tiled(
    const struct drm_i915_gem_object *obj) {
  return i915_gem_object_get_tiling(obj) != I915_TILING_NONE;
}

static inline unsigned int i915_gem_object_get_stride(
    const struct drm_i915_gem_object *obj) {
  return obj->tiling_and_stride & STRIDE_MASK;
}

static inline unsigned int i915_gem_tile_height(unsigned int tiling) {
  GEM_BUG_ON(!tiling);
  return tiling == I915_TILING_Y ? 32 : 8;
}

static inline unsigned int i915_gem_object_get_tile_height(
    const struct drm_i915_gem_object *obj) {
  return i915_gem_tile_height(i915_gem_object_get_tiling(obj));
}

static inline unsigned int i915_gem_object_get_tile_row_size(
    const struct drm_i915_gem_object *obj) {
 ...
 */
struct scatterlist *__i915_gem_object_page_iter_get_sg(
  struct drm_i915_gem_object *obj,
 ...
 */
static inline struct scatterlist *__i915_gem_object_get_sg(
    struct drm_i915_gem_object *obj, pgoff_t n,
    unsigned int *offset) {
 ...
 * pointer and the target page position using pgoff_t n input argument and
 * drm_i915_gem_object. It uses an internal DMA mapped scatterlist lookup
 *function
 * @obj: i915 GEM buffer object
 * @n: page offset
 * @offset: searched physical offset,
 ...
 * See also __i915_gem_object_page_iter_get_sg()
 */
static inline struct scatterlist *__i915_gem_object_get_sg_dma(
    struct drm_i915_gem_object *obj, pgoff_t n,
    unsigned int *offset) {
...
/**
 * __i915_gem_object_get_page - helper to find the target page with a page
 *offset
 * @obj: i915 GEM buffer object
 * @n: page offset
 *
 ...
 * See also __i915_gem_object_page_iter_get_sg()
 */
struct page *__i915_gem_object_get_page(struct drm_i915_gem_object *obj,
    pgoff_t n);
 ...
 * @n: page offset
 *
 * It works like i915_gem_object_get_page(), but it marks the returned page
 *dirty.
 *
 * Returns:
 * The target page pointer.
 ...
 *__i915_gem_object_get_page()
 */
struct page *__i915_gem_object_get_dirty_page(struct drm_i915_gem_object *obj,
    pgoff_t n);

/**
 * i915_gem_object_get_dirty_page - wrapper macro for
 ...
 *__i915_gem_object_get_sg_dma()
 */
dma_addr_t __i915_gem_object_get_dma_address_len(
  struct drm_i915_gem_object *obj, pgoff_t n,
  unsigned int *len);
 ...
 *__i915_gem_object_get_sg_dma()
 */
dma_addr_t __i915_gem_object_get_dma_address(struct drm_i915_gem_object *obj,
    pgoff_t n);
...
static inline int __must_check i915_gem_object_pin_pages(
    struct drm_i915_gem_object *obj) {
  assert_object_held(obj);
...
static inline bool i915_gem_object_has_pages(struct drm_i915_gem_object *obj) {
  return !IS_ERR_OR_NULL(READ_ONCE(obj->mm.pages));
}

static inline void __i915_gem_object_pin_pages(struct drm_i915_gem_object *obj)
{
  GEM_BUG_ON(!i915_gem_object_has_pages(obj));
  atomic_inc(&obj->mm.pages_pin_count);
}

static inline bool i915_gem_object_has_pinned_pages(
    struct drm_i915_gem_object *obj) {
  return atomic_read(&obj->mm.pages_pin_count);
}

static inline void __i915_gem_object_unpin_pages(
    struct drm_i915_gem_object *obj) {
  GEM_BUG_ON(!i915_gem_object_has_pages(obj));
...
void *__must_check i915_gem_object_pin_map_unlocked(
  struct drm_i915_gem_object *obj,
  enum i915_map_type type);
...
int __must_check i915_gem_object_set_to_wc_domain(
  struct drm_i915_gem_object *obj, bool write);
int __must_check i915_gem_object_set_to_gtt_domain(
  struct drm_i915_gem_object *obj, bool write);
int __must_check i915_gem_object_set_to_cpu_domain(
  struct drm_i915_gem_object *obj, bool write);
struct i915_vma *__must_check i915_gem_object_pin_to_display_plane(
  struct drm_i915_gem_object *obj,
  struct i915_gem_ww_ctx *ww,
  u32 alignment,
...
int i915_gem_object_read_from_page(struct drm_i915_gem_object *obj, u64 offset,
    void *dst, int size);
...
static inline int i915_gem_object_userptr_submit_init(
    struct drm_i915_gem_object *obj) {
  GEM_BUG_ON(1);
  return -ENODEV;
}

static inline int i915_gem_object_userptr_submit_done(
    struct drm_i915_gem_object *obj) {
  GEM_BUG_ON(1);
  return -ENODEV;
}

static inline int i915_gem_object_userptr_validate(
    struct drm_i915_gem_object *obj) {
  GEM_BUG_ON(1);
  return -ENODEV;
}
