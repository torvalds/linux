...
static inline bool __vma_matches(struct vm_area_struct *vma, struct file *filp,
...
static inline struct i915_gtt_view compute_partial_view(
...
static struct i915_mmap_offset *lookup_mmo(struct drm_i915_gem_object *obj,
...
static struct i915_mmap_offset *insert_mmo(struct drm_i915_gem_object *obj,
    struct i915_mmap_offset *mmo) {
  struct rb_node *rb, **p;
  spin_lock(&obj->mmo.lock);
  rb = NULL;
...
static int __assign_mmap_offset(struct drm_i915_gem_object *obj,
    enum i915_mmap_type mmap_type,
...
static int __assign_mmap_offset_handle(struct drm_file *file,
    u32 handle,
    enum i915_mmap_type mmap_type,
    u64 *offset) {
  struct drm_i915_gem_object *obj;
...
int i915_gem_dumb_mmap_offset(struct drm_file *file,
...
static int i915_gem_object_mmap(struct drm_i915_gem_object *obj,
    struct i915_mmap_offset *mmo,
    struct vm_area_struct *vma) {
  struct drm_i915_private *i915 = to_i915(obj->base.dev);
