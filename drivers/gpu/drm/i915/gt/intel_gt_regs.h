...
#define   HSW_SELECTIVE_WRITE_ADDRESS_MASK  (0x7 << \
...
#define   GEN8_SELECTIVE_WRITE_ADDRESS_MASK (0x3 << \
...
#define   GEN6_MBC_SNPCR_MIN      (3 << 21) /* only 1/16th of the cache is
                                             * shared */
...
#define   GEN11_HASH_CTRL_EXCL_BIT0   REG_FIELD_PREP(GEN11_HASH_CTRL_EXCL_MASK, \
    0x1)
...
#define   SCRUB_RATE_4B_PER_CLK     REG_FIELD_PREP(SCRUB_RATE_PER_BANK_MASK, \
    0x6)
...
#define   THREAD_EX_ARB_MODE_RR_AFTER_DEP REG_FIELD_PREP(THREAD_EX_ARB_MODE, \
    0x2)
...
#define PXVFREQ(fstart)       _MMIO(0x11110 + (fstart) * 4)  /* P[0-15]VIDFREQ
                                                              * (0x1114c)
                                                              * (Ironlake) */
...
#define   IMPROMOEN       (1 << 10) /* promo is immediate or delayed until next
                                     * idle interval (only for timeout method
                                     * above) */
