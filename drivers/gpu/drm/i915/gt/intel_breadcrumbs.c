...
__maybe_unused static bool check_signal_order(struct intel_context *ce,
...
static void __dma_fence_signal__timestamp(struct dma_fence *fence,
    ktime_t timestamp) {
...
static struct llist_node *slist_add(struct llist_node *node,
