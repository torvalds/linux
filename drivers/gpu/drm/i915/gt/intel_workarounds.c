...
static enum forcewake_domains wal_get_fw_for_rmw(struct intel_uncore *uncore,
...
static void wa_write_clr_set(struct i915_wa_list *wal, i915_reg_t reg,
    u32 clear, u32 set) {
  wa_add(wal, reg, clear, set, clear | set, false);
}

static void wa_mcr_write_clr_set(struct i915_wa_list *wal, i915_mcr_reg_t reg,
    u32 clear, u32 set) {
  wa_mcr_add(wal, reg, clear, set, clear | set, false);
}

static void wa_write(struct i915_wa_list *wal, i915_reg_t reg, u32 set) {
  wa_write_clr_set(wal, reg, ~0, set);
}

static void wa_mcr_write(struct i915_wa_list *wal, i915_mcr_reg_t reg,
    u32 set) {
  wa_mcr_write_clr_set(wal, reg, ~0, set);
}

static void wa_write_or(struct i915_wa_list *wal, i915_reg_t reg, u32 set) {
  wa_write_clr_set(wal, reg, set, set);
}

static void wa_mcr_write_or(struct i915_wa_list *wal, i915_mcr_reg_t reg,
    u32 set) {
  wa_mcr_write_clr_set(wal, reg, set, set);
}

static void wa_write_clr(struct i915_wa_list *wal, i915_reg_t reg, u32 clr) {
  wa_write_clr_set(wal, reg, clr, 0);
}

static void wa_mcr_write_clr(struct i915_wa_list *wal, i915_mcr_reg_t reg,
    u32 clr) {
...
static void wa_masked_en(struct i915_wa_list *wal, i915_reg_t reg, u32 val) {
  wa_add(wal, reg, 0, _MASKED_BIT_ENABLE(val), val, true);
}

static void wa_mcr_masked_en(struct i915_wa_list *wal, i915_mcr_reg_t reg,
    u32 val) {
...
static void wa_mcr_masked_dis(struct i915_wa_list *wal, i915_mcr_reg_t reg,
    u32 val) {
  wa_mcr_add(wal, reg, 0, _MASKED_BIT_DISABLE(val), val, true);
}

static void wa_masked_field_set(struct i915_wa_list *wal, i915_reg_t reg,
    u32 mask, u32 val) {
  wa_add(wal, reg, 0, _MASKED_FIELD(mask, val), mask, true);
}

static void wa_mcr_masked_field_set(struct i915_wa_list *wal,
    i915_mcr_reg_t reg,
    u32 mask, u32 val) {
 ...
 */
static void gen12_ctx_gt_fake_wa_init(struct intel_engine_cs *engine,
    struct i915_wa_list *wal) {
...
static void __intel_engine_init_ctx_wa(struct intel_engine_cs *engine,
    struct i915_wa_list *wal,
    const char *name) {
  struct drm_i915_private *i915 = engine->i915;
...
static void gen4_gt_workarounds_init(struct intel_gt *gt,
    struct i915_wa_list *wal) {
  /* WaDisable_RenderCache_OperationalFlush:gen4,ilk */
  wa_masked_dis(wal, CACHE_MODE_0, RC_OP_FLUSH_ENABLE);
}

static void g4x_gt_workarounds_init(struct intel_gt *gt,
    struct i915_wa_list *wal) {
...
static void ilk_gt_workarounds_init(struct intel_gt *gt,
    struct i915_wa_list *wal) {
  g4x_gt_workarounds_init(gt, wal);
  wa_masked_en(wal, _3D_CHICKEN2, _3D_CHICKEN2_WM_READ_PIPELINED);
}

static void snb_gt_workarounds_init(struct intel_gt *gt,
    struct i915_wa_list *wal) {
}

static void ivb_gt_workarounds_init(struct intel_gt *gt,
    struct i915_wa_list *wal) {
...
static void vlv_gt_workarounds_init(struct intel_gt *gt,
    struct i915_wa_list *wal) {
...
static void hsw_gt_workarounds_init(struct intel_gt *gt,
    struct i915_wa_list *wal) {
...
static void gen9_wa_init_mcr(struct drm_i915_private *i915,
    struct i915_wa_list *wal) {
...
static void gen9_gt_workarounds_init(struct intel_gt *gt,
    struct i915_wa_list *wal) {
...
static void skl_gt_workarounds_init(struct intel_gt *gt,
    struct i915_wa_list *wal) {
...
static void kbl_gt_workarounds_init(struct intel_gt *gt,
    struct i915_wa_list *wal) {
  gen9_gt_workarounds_init(gt, wal);
...
static void glk_gt_workarounds_init(struct intel_gt *gt,
    struct i915_wa_list *wal) {
  gen9_gt_workarounds_init(gt, wal);
}

static void cfl_gt_workarounds_init(struct intel_gt *gt,
    struct i915_wa_list *wal) {
  gen9_gt_workarounds_init(gt, wal);
...
static void icl_wa_init_mcr(struct intel_gt *gt, struct i915_wa_list *wal) {
...
static void xehp_init_mcr(struct intel_gt *gt, struct i915_wa_list *wal) {
  const struct sseu_dev_info *sseu = &gt->info.sseu;
...
static void pvc_init_mcr(struct intel_gt *gt, struct i915_wa_list *wal) {
  unsigned int dss;
  /*
...
static void icl_gt_workarounds_init(struct intel_gt *gt,
    struct i915_wa_list *wal) {
  struct drm_i915_private *i915 = gt->i915;
 ...
 */
static void wa_14011060649(struct intel_gt *gt, struct i915_wa_list *wal) {
...
static void gen12_gt_workarounds_init(struct intel_gt *gt,
    struct i915_wa_list *wal) {
  icl_wa_init_mcr(gt, wal);
...
static void dg1_gt_workarounds_init(struct intel_gt *gt,
    struct i915_wa_list *wal) {
...
static void xehpsdv_gt_workarounds_init(struct intel_gt *gt,
    struct i915_wa_list *wal) {
  struct drm_i915_private *i915 = gt->i915;
...
static void dg2_gt_workarounds_init(struct intel_gt *gt,
    struct i915_wa_list *wal) {
  xehp_init_mcr(gt, wal);
  /* Wa_14011060649:dg2 */
  wa_14011060649(gt, wal);
...
static void pvc_gt_workarounds_init(struct intel_gt *gt,
    struct i915_wa_list *wal) {
  pvc_init_mcr(gt, wal);
  /* Wa_14015795083 */
...
static void xelpg_gt_workarounds_init(struct intel_gt *gt,
    struct i915_wa_list *wal) {
...
static void wa_16021867713(struct intel_gt *gt, struct i915_wa_list *wal) {
  struct intel_engine_cs *engine;
  int id;
  for_each_engine(engine, gt, id)
  if (engine->class == VIDEO_DECODE_CLASS) {
...
static void xelpmp_gt_workarounds_init(struct intel_gt *gt,
    struct i915_wa_list *wal) {
...
static void gt_init_workarounds(struct intel_gt *gt, struct i915_wa_list *wal) {
  struct drm_i915_private *i915 = gt->i915;
...
static bool wa_verify(struct intel_gt *gt, const struct i915_wa *wa, u32 cur,
...
static void whitelist_reg_ext(struct i915_wa_list *wal, i915_reg_t reg,
    u32 flags) {
  struct i915_wa wa = {
    .reg = reg
  };
...
static void whitelist_mcr_reg_ext(struct i915_wa_list *wal, i915_mcr_reg_t reg,
    u32 flags) {
  struct i915_wa wa = {
    .mcr_reg = reg,
    .is_mcr = 1,
...
static void whitelist_reg(struct i915_wa_list *wal, i915_reg_t reg) {
  whitelist_reg_ext(wal, reg, RING_FORCE_TO_NONPRIV_ACCESS_RW);
}

static void whitelist_mcr_reg(struct i915_wa_list *wal, i915_mcr_reg_t reg) {
 ...
 */
static void engine_fake_wa_init(struct intel_engine_cs *engine,
    struct i915_wa_list *wal) {
  u8 mocs_w, mocs_r;
  /*
...
static void ccs_engine_wa_init(struct intel_engine_cs *engine,
    struct i915_wa_list *wal) {
 ...
 */
static void add_render_compute_tuning_settings(struct intel_gt *gt,
    struct i915_wa_list *wal) {
  struct drm_i915_private *i915 = gt->i915;
 ...
 */
static void general_render_compute_wa_init(struct intel_engine_cs *engine,
    struct i915_wa_list *wal) {
  struct drm_i915_private *i915 = engine->i915;
  struct intel_gt *gt = engine->gt;
...
static void engine_init_workarounds(struct intel_engine_cs *engine,
    struct i915_wa_list *wal) {
...
static int wa_list_srm(struct i915_request *rq,
    const struct i915_wa_list *wal,
    struct i915_vma *vma) {
