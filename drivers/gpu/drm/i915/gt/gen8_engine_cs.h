...
static inline u32 *__gen8_emit_pipe_control(u32 *batch, u32 bit_group_0,
...
static inline u32 *__gen8_emit_write_rcs(u32 *cs, u32 value, u32 offset,
    u32 flags0, u32 flags1) {
...
static inline u32 *gen8_emit_ggtt_write_rcs(u32 *cs, u32 value, u32 gtt_offset,
    u32 flags) {
...
static inline u32 *gen12_emit_ggtt_write_rcs(u32 *cs, u32 value, u32 gtt_offset,
    u32 flags0, u32 flags1) {
  /* We're using qword write, offset should be aligned to 8 bytes. */
  GEM_BUG_ON(!IS_ALIGNED(gtt_offset, 8));
  return __gen8_emit_write_rcs(cs,
...
static inline u32 *__gen8_emit_flush_dw(u32 *cs, u32 value, u32 gtt_offset,
    u32 flags) {
...
static inline u32 *gen8_emit_ggtt_write(u32 *cs, u32 value, u32 gtt_offset,
    u32 flags) {
