...
#define GFX_OP_SCISSOR_INFO    ((0x3 << \
      29) | (0x1d << 24) | (0x81 << 16) | (0x1))
...
#define GFX_OP_COLOR_FACTOR      ((0x3 << \
      29) | (0x1d << 24) | (0x1 << 16) | 0x0)
#define GFX_OP_STIPPLE           ((0x3 << 29) | (0x1d << 24) | (0x83 << 16))
#define GFX_OP_MAP_INFO          ((0x3 << 29) | (0x1d << 24) | 0x4)
#define GFX_OP_DESTBUFFER_VARS   ((0x3 << \
      29) | (0x1d << 24) | (0x85 << 16) | 0x0)
#define GFX_OP_DESTBUFFER_INFO   ((0x3 << 29) | (0x1d << 24) | (0x8e << 16) | 1)
#define GFX_OP_DRAWRECT_INFO     ((0x3 << \
      29) | (0x1d << 24) | (0x80 << 16) | (0x3))
...
#define GFX_OP_PIPE_CONTROL(len)  ((0x3 << \
      29) | (0x3 << 27) | (0x2 << 24) | ((len) - 2))
...
#define GPGPU_OBJECT                   ((0x3 << \
      29) | (0x2 << 27) | (0x1 << 24) | (0x4 << 16))
#define GPGPU_WALKER                   ((0x3 << \
      29) | (0x2 << 27) | (0x1 << 24) | (0x5 << 16))
