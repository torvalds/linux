...
static int sysfs_gt_attribute_w_func(struct kobject *kobj,
...
static u32 sysfs_gt_attribute_r_func(struct kobject *kobj,
    struct attribute *attr,
...
static ssize_t rps_up_threshold_pct_show(struct kobject *kobj,
    struct kobj_attribute *attr,
    char *buf) {
  struct intel_gt *gt = intel_gt_sysfs_get_drvdata(kobj, attr->attr.name);
  struct intel_rps *rps = &gt->rps;
...
static ssize_t rps_up_threshold_pct_store(struct kobject *kobj,
    struct kobj_attribute *attr,
...
static ssize_t rps_down_threshold_pct_show(struct kobject *kobj,
    struct kobj_attribute *attr,
    char *buf) {
  struct intel_gt *gt = intel_gt_sysfs_get_drvdata(kobj, attr->attr.name);
  struct intel_rps *rps = &gt->rps;
...
static ssize_t rps_down_threshold_pct_store(struct kobject *kobj,
    struct kobj_attribute *attr,
    const char *buf, size_t count) {
  struct intel_gt *gt = intel_gt_sysfs_get_drvdata(kobj, attr->attr.name);
  struct intel_rps *rps = &gt->rps;
...
static ssize_t default_min_freq_mhz_show(struct kobject *kobj,
    struct kobj_attribute *attr,
    char *buf) {
...
static ssize_t default_max_freq_mhz_show(struct kobject *kobj,
    struct kobj_attribute *attr,
    char *buf) {
  struct intel_gt *gt = kobj_to_gt(kobj->parent);
...
static ssize_t default_rps_up_threshold_pct_show(struct kobject *kobj,
    struct kobj_attribute *attr,
    char *buf) {
  struct intel_gt *gt = kobj_to_gt(kobj->parent);
...
static ssize_t default_rps_down_threshold_pct_show(struct kobject *kobj,
    struct kobj_attribute *attr,
    char *buf) {
  struct intel_gt *gt = kobj_to_gt(kobj->parent);
