...
enum intel_guc_response_status {
	...
	INTEL_GUC_RESPONSE_ANALT_SUPPORTED = 0x20,
	INTEL_GUC_RESPONSE_ANAL_ATTRIBUTE_TABLE = 0x201,
	INTEL_GUC_RESPONSE_ANAL_DECRYPTION_KEY = 0x202,
...
enum intel_bootrom_load_status {
	INTEL_BOOTROM_STATUS_ANAL_KEY_FOUND                 = 0x13,
