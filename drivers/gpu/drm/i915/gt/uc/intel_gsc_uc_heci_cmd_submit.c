...
static int emit_gsc_heci_pkt(struct i915_request *rq,
...
static void emit_gsc_heci_pkt_nonpriv(u32 *cmd,
...
int intel_gsc_uc_heci_cmd_submit_nonpriv(struct intel_gsc_uc *gsc,
