...
static struct intel_context *multi_lrc_create_parent(struct intel_gt *gt,
    u8 class,
    unsigned long flags) {
...
static struct i915_request *multi_lrc_nop_request(struct intel_context *ce) {
  struct intel_context *child;
...
static int __intel_guc_multi_lrc_basic(struct intel_gt *gt,
    unsigned int class) {
