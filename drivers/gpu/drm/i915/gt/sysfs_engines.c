...
static ssize_t class_show(struct kobject *kobj, struct kobj_attribute *attr,
    char *buf) {
...
static ssize_t mmio_show(struct kobject *kobj, struct kobj_attribute *attr,
    char *buf) {
...
static ssize_t __caps_show(struct intel_engine_cs *engine,
...
static ssize_t all_caps_show(struct kobject *kobj, struct kobj_attribute *attr,
    char *buf) {
...
static ssize_t max_spin_store(struct kobject *kobj, struct kobj_attribute *attr,
...
static ssize_t max_spin_show(struct kobject *kobj, struct kobj_attribute *attr,
    char *buf) {
  struct intel_engine_cs *engine = kobj_to_engine(kobj);
...
static ssize_t max_spin_default(struct kobject *kobj,
...
static ssize_t timeslice_store(struct kobject *kobj,
...
static ssize_t timeslice_show(struct kobject *kobj, struct kobj_attribute *attr,
    char *buf) {
  struct intel_engine_cs *engine = kobj_to_engine(kobj);
...
static ssize_t stop_show(struct kobject *kobj, struct kobj_attribute *attr,
    char *buf) {
  struct intel_engine_cs *engine = kobj_to_engine(kobj);
...
static ssize_t stop_default(struct kobject *kobj, struct kobj_attribute *attr,
    char *buf) {
  struct intel_engine_cs *engine = kobj_to_engine(kobj);
...
static ssize_t heartbeat_default(struct kobject *kobj,
    struct kobj_attribute *attr, char *buf) {
  struct intel_engine_cs *engine = kobj_to_engine(kobj);
...
static struct kobject *kobj_engine(struct kobject *dir,
    struct intel_engine_cs *engine) {
