...
static u32 gen11_gt_engine_identity(struct intel_gt *gt,
...
static void gen11_other_irq_handler(struct intel_gt *gt, const u8 instance,
    const u16 iir) {
...
static void gen11_gt_identity_handler(struct intel_gt *gt, const u32 identity) {
...
static void gen11_gt_bank_handler(struct intel_gt *gt,
