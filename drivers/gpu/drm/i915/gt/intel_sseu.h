...
static inline struct intel_sseu intel_sseu_from_device_info(
...
static inline bool intel_sseu_has_subslice(const struct sseu_dev_info *sseu,
    int slice,
    int subslice) {
 ...
 */
static inline unsigned int intel_sseu_find_first_xehp_dss(
    const struct sseu_dev_info *sseu, int groupsize,
    int groupnum) {
...
intel_sseu_ss_mask_t intel_sseu_get_compute_subslices(
  const struct sseu_dev_info *sseu);
