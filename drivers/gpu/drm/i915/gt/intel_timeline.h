...
struct intel_timeline *__intel_timeline_create(struct intel_gt *gt,
    struct i915_vma *global_hwsp,
    unsigned int offset);

static inline struct intel_timeline *intel_timeline_create(struct intel_gt *gt)
{
...
static inline struct intel_timeline *intel_timeline_get(
...
static inline bool intel_timeline_is_last(const struct intel_timeline *tl,
    const struct i915_request *rq) {
