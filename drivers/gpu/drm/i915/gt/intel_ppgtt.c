...
void free_px(struct i915_address_space *vm, struct i915_page_table *pt,
    int lvl) {
...
static void write_dma_entry(struct drm_i915_gem_object * const pdma,
...
void __set_pd_entry(struct i915_page_directory * const pd,
    const unsigned short idx,
...
void clear_pd_entry(struct i915_page_directory * const pd,
    const unsigned short idx,
...
bool release_pd_entry(struct i915_page_directory * const pd,
    const unsigned short idx,
...
static struct i915_ppgtt *__ppgtt_create(struct intel_gt *gt,
