...
static struct intel_engine_cs *find_sfc_paired_vecs_engine(
    struct intel_engine_cs *engine) {
  int vecs_id;
...
static int gen11_lock_sfc(struct intel_engine_cs *engine,
  ...
  if (!(intel_uncore_read_fw(uncore,
      sfc_lock.usage_reg) & sfc_lock.usage_bit)) {
...
static intel_engine_mask_t wa_14015076503_start(struct intel_gt *gt,
    intel_engine_mask_t engine_mask,
    bool first) {
...
static void wa_14015076503_end(struct intel_gt *gt,
    intel_engine_mask_t engine_mask) {
  if (!needs_wa_14015076503(gt, engine_mask)) {
    return;
  }
...
static void intel_gt_reset_global(struct intel_gt *gt,
  ...
  char *error_event[] = {
    I915_ERROR_UEVENT "=1", NULL
  };
  char *reset_event[] = {
    I915_RESET_UEVENT "=1", NULL
  };
  char *reset_done_event[] = {
    I915_ERROR_UEVENT "=0", NULL
  };
