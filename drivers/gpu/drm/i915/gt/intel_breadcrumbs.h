...
struct intel_breadcrumbs *intel_breadcrumbs_create(
...
static inline void intel_engine_signal_breadcrumbs(
...
static inline struct intel_breadcrumbs *intel_breadcrumbs_get(
    struct intel_breadcrumbs *b) {
  kref_get(&b->ref);
  return b;
}
