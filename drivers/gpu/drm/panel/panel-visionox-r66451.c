...
static inline struct visionox_r66451 *to_visionox_r66451(
    struct drm_panel *panel) {
...
static int visionox_r66451_on(struct visionox_r66451 *ctx) {
  ...
  mipi_dsi_dcs_write_seq(dsi, 0xb0, 0x80);
  mipi_dsi_dcs_write_seq(dsi, 0xe4, 0x34, 0xb4, 0x00, 0x00, 0x00, 0x39, 0x04,
      0x09, 0x34);
...
static struct backlight_device *visionox_r66451_create_backlight(
    struct mipi_dsi_device *dsi) {
  struct device *dev = &dsi->dev;
