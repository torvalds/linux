...
static int visionox_vtdr6130_on(struct visionox_vtdr6130 *ctx)
{
	...
	mipi_dsi_dcs_write_long_multi(&dsi_ctx,
				     MIPI_DCS_WRITE_CONTROL_DISPLAY, 0x20);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx,
				     MIPI_DCS_SET_DISPLAY_BRIGHTNESS, 0x00,
				     0x00);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0x59, 0x09);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0x6c, 0x01);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0x6d, 0x00);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0x6f, 0x01);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0x70, 0x12, 0x00, 0x00, 0xab,
	...
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xf0, 0xaa, 0x10);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xb1, 0x01, 0x38, 0x00, 0x14,
				     0x00, 0x1c, 0x00, 0x01, 0x66, 0x00, 0x14,
				     0x00, 0x14, 0x00, 0x01, 0x66, 0x00, 0x14,
				     0x05, 0xcc, 0x00);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xf0, 0xaa, 0x13);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xce, 0x09, 0x11, 0x09, 0x11,
				     0x08, 0xc1, 0x07, 0xfa, 0x05, 0xa4, 0x00,
				     0x3c, 0x00, 0x34, 0x00, 0x24, 0x00, 0x0c,
				     0x00, 0x0c, 0x04, 0x00, 0x35);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xf0, 0xaa, 0x14);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xb2, 0x03, 0x33);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xb4, 0x00, 0x33, 0x00, 0x00,
				     0x00, 0x3e, 0x00, 0x00, 0x00, 0x3e, 0x00,
				     0x00);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xb5, 0x00, 0x09, 0x09, 0x09,
				     0x09, 0x09, 0x09, 0x06, 0x01);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xb9, 0x00, 0x00, 0x08, 0x09,
				     0x09, 0x09);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xbc, 0x10, 0x00, 0x00, 0x06,
				     0x11, 0x09, 0x3b, 0x09, 0x47, 0x09, 0x47,
				     0x00);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xbe, 0x10, 0x10, 0x00, 0x08,
				     0x22, 0x09, 0x19, 0x09, 0x25, 0x09, 0x25,
				     0x00);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xff, 0x5a, 0x80);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0x65, 0x14);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xfa, 0x08, 0x08, 0x08);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xff, 0x5a, 0x81);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0x65, 0x05);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xf3, 0x0f);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xf0, 0xaa, 0x00);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xff, 0x5a, 0x82);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xf9, 0x00);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xff, 0x51, 0x83);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0x65, 0x04);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xf8, 0x00);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xff, 0x5a, 0x00);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0x65, 0x01);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xf4, 0x9a);
	mipi_dsi_dcs_write_long_multi(&dsi_ctx, 0xff, 0x5a, 0x00);
