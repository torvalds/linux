...
static struct v3d_job *to_v3d_job(struct drm_sched_job *sched_job) {
  return container_of(sched_job, struct v3d_job, base);
}

static struct v3d_bin_job *to_bin_job(struct drm_sched_job *sched_job) {
  return container_of(sched_job, struct v3d_bin_job, base.base);
}

static struct v3d_render_job *to_render_job(struct drm_sched_job *sched_job) {
  return container_of(sched_job, struct v3d_render_job, base.base);
}

static struct v3d_tfu_job *to_tfu_job(struct drm_sched_job *sched_job) {
  return container_of(sched_job, struct v3d_tfu_job, base.base);
}

static struct v3d_csd_job *to_csd_job(struct drm_sched_job *sched_job) {
  return container_of(sched_job, struct v3d_csd_job, base.base);
}

static struct v3d_cpu_job *to_cpu_job(struct drm_sched_job *sched_job) {
  return container_of(sched_job, struct v3d_cpu_job, base.base);
}

static void v3d_sched_job_free(struct drm_sched_job *sched_job) {
  struct v3d_job *job = to_v3d_job(sched_job);
  v3d_job_cleanup(job);
}

static void v3d_cpu_job_free(struct drm_sched_job *sched_job) {
...
static void v3d_switch_perfmon(struct v3d_dev *v3d, struct v3d_job *job) {
...
static struct dma_fence *v3d_tfu_job_run(struct drm_sched_job *sched_job) {
...
static struct dma_fence *v3d_csd_job_run(struct drm_sched_job *sched_job) {
...
static void v3d_rewrite_csd_job_wg_counts_from_indirect(struct v3d_cpu_job *job)
{
...
static void v3d_timestamp_query(struct v3d_cpu_job *job) {
  struct v3d_timestamp_query_info *timestamp_query = &job->timestamp_query;
  struct v3d_bo *bo = to_v3d_bo(job->base.bo[0]);
  u8 *value_addr;
  v3d_get_bo_vaddr(bo);
...
static void v3d_reset_timestamp_queries(struct v3d_cpu_job *job) {
  struct v3d_timestamp_query_info *timestamp_query = &job->timestamp_query;
...
static void write_to_buffer(void *dst, u32 idx, bool do_64bit, u64 value) {
  if (do_64bit) {
    u64 *dst64 = (u64 *) dst;
    dst64[idx] = value;
  } else {
...
static void v3d_copy_query_results(struct v3d_cpu_job *job) {
  struct v3d_timestamp_query_info *timestamp_query = &job->timestamp_query;
  struct v3d_timestamp_query *queries = timestamp_query->queries;
  struct v3d_bo *bo = to_v3d_bo(job->base.bo[0]);
...
static void v3d_reset_performance_queries(struct v3d_cpu_job *job) {
  struct v3d_performance_query_info *performance_query
    = &job->performance_query;
...
static void v3d_write_performance_query_result(struct v3d_cpu_job *job,
    void *data, u32 query) {
  struct v3d_performance_query_info *performance_query
    = &job->performance_query;
  struct v3d_copy_query_results_info *copy = &job->copy;
...
static void v3d_copy_performance_query(struct v3d_cpu_job *job) {
  struct v3d_performance_query_info *performance_query
    = &job->performance_query;
  struct v3d_copy_query_results_info *copy = &job->copy;
  struct v3d_bo *bo = to_v3d_bo(job->base.bo[0]);
...
static struct dma_fence *v3d_cpu_job_run(struct drm_sched_job *sched_job) {
  struct v3d_cpu_job *job = to_cpu_job(sched_job);
  struct v3d_dev *v3d = job->base.v3d;
  struct v3d_file_priv *file = job->base.file->driver_priv;
  u64 runtime;
...
static struct dma_fence *v3d_cache_clean_job_run(
...
static enum drm_gpu_sched_stat v3d_gpu_reset_for_timeout(struct v3d_dev *v3d,
    struct drm_sched_job *sched_job) {
  enum v3d_queue q;
 ...
 */
static enum drm_gpu_sched_stat v3d_cl_job_timedout(
    struct drm_sched_job *sched_job, enum v3d_queue q,
...
static enum drm_gpu_sched_stat v3d_bin_job_timedout(
    struct drm_sched_job *sched_job) {
  struct v3d_bin_job *job = to_bin_job(sched_job);
...
static enum drm_gpu_sched_stat v3d_render_job_timedout(
    struct drm_sched_job *sched_job) {
  struct v3d_render_job *job = to_render_job(sched_job);
...
static enum drm_gpu_sched_stat v3d_generic_job_timedout(
    struct drm_sched_job *sched_job) {
  struct v3d_job *job = to_v3d_job(sched_job);
  return v3d_gpu_reset_for_timeout(job->v3d, sched_job);
}

static enum drm_gpu_sched_stat v3d_csd_job_timedout(
    struct drm_sched_job *sched_job) {
  struct v3d_csd_job *job = to_csd_job(sched_job);
  struct v3d_dev *v3d = job->base.v3d;
