...
static int v3d_open(struct drm_device *dev, struct drm_file *file) {
  struct v3d_dev *v3d = to_v3d_dev(dev);
...
static void v3d_postclose(struct drm_device *dev, struct drm_file *file) {
...
static const struct drm_ioctl_desc v3d_drm_ioctls[] = {
  DRM_IOCTL_DEF_DRV(V3D_SUBMIT_CL, v3d_submit_cl_ioctl,
...
static int map_regs(struct v3d_dev *v3d, void __iomem **regs,
    const char *name) {
