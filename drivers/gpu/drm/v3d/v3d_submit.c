 ...
 */
static int v3d_lock_bo_reservations(struct v3d_job *job,
 ...
 */
static int v3d_lookup_bos(struct drm_device *dev,
...
static void v3d_job_free(struct kref *ref) {
...
static void v3d_render_job_free(struct kref *ref) {
...
static int v3d_job_allocate(void **container, size_t size) {
...
static void v3d_job_deallocate(void **container) {
  kfree(*container);
  *container = NULL;
}
...
static int v3d_job_init(struct v3d_dev *v3d, struct drm_file *file_priv,
  ...
  if (has_multisync) {
    ...
    ret
      = drm_sched_job_add_syncobj_dependency(&job->base, file_priv, in_sync,
        0);
    // TODO: Investigate why this was filtered out for the IOCTL.
    if (ret && ret != -ENOENT) {
      goto fail_deps;
...
static void v3d_attach_fences_and_unlock_reservation(struct drm_file *file_priv,
    struct v3d_job *job,
    struct ww_acquire_ctx *acquire_ctx,
    u32 out_sync,
...
static int v3d_setup_csd_jobs_and_bos(struct drm_file *file_priv,
    struct v3d_dev *v3d,
...
static int v3d_get_cpu_indirect_csd_params(struct drm_file *file_priv,
    struct drm_v3d_extension __user *ext,
...
static int v3d_get_cpu_timestamp_query_params(struct drm_file *file_priv,
    struct drm_v3d_extension __user *ext,
    struct v3d_cpu_job *job) {
...
static int v3d_get_cpu_reset_timestamp_params(struct drm_file *file_priv,
    struct drm_v3d_extension __user *ext,
    struct v3d_cpu_job *job) {
  u32 __user *syncs;
...
static int v3d_get_cpu_copy_query_results_params(struct drm_file *file_priv,
    struct drm_v3d_extension __user *ext,
    struct v3d_cpu_job *job) {
  u32 __user *offsets, *syncs;
...
static int v3d_get_cpu_reset_performance_params(struct drm_file *file_priv,
    struct drm_v3d_extension __user *ext,
    struct v3d_cpu_job *job) {
  u32 __user *syncs;
...
static int v3d_get_cpu_copy_performance_query_params(struct drm_file *file_priv,
    struct drm_v3d_extension __user *ext,
    struct v3d_cpu_job *job) {
  u32 __user *syncs;
  u64 __user *kperfmon_ids;
