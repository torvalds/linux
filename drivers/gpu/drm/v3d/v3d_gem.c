...
static void v3d_init_core(struct v3d_dev *v3d, int core) {
...
static void v3d_init_hw_state(struct v3d_dev *v3d) {
  v3d_init_core(v3d, 0);
}

static void v3d_idle_axi(struct v3d_dev *v3d, int core) {
...
static void v3d_idle_gca(struct v3d_dev *v3d) {
  if (v3d->ver >= 41) {
    return;
  }
...
static void v3d_reset_by_bridge(struct v3d_dev *v3d) {
...
static void v3d_reset_v3d(struct v3d_dev *v3d) {
  if (v3d->reset) {
...
static void v3d_flush_l3(struct v3d_dev *v3d) {
  if (v3d->ver < 41) {
 ...
 */
static void v3d_invalidate_l2c(struct v3d_dev *v3d, int core) {
  if (v3d->ver > 32) {
    return;
  }
...
static void v3d_flush_l2t(struct v3d_dev *v3d, int core) {
...
static void v3d_invalidate_slices(struct v3d_dev *v3d, int core) {
