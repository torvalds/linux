...
/* the bit 14:13 is used to select between the different reference clock for
 * Pipe A/B */
...
/* For the DPLL B, it will use the reference clk from DPLL A when using (2 <<
 * 13) */
