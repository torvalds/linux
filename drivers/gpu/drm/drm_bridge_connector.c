...
static void drm_bridge_connector_handle_hpd(
    struct drm_bridge_connector *drm_bridge_connector,
    enum drm_connector_status status) {
...
static void drm_bridge_connector_oob_hotplug_event(
...
static enum drm_connector_status drm_bridge_connector_detect(
