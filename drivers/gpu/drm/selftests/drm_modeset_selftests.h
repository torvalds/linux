...
selftest(damage_iter_yes_damage, igt_damage_iter_yes_damage)
selftest(damage_iter_yes_damage_fractional_src, igt_damage_iter_yes_damage_fractional_src)
selftest(damage_iter_yes_damage_src_moved, igt_damage_iter_yes_damage_src_moved)
selftest(damage_iter_yes_damage_fractional_src_moved, igt_damage_iter_yes_damage_fractional_src_moved)
selftest(damage_iter_yes_damage_yest_visible, igt_damage_iter_yes_damage_yest_visible)
selftest(damage_iter_yes_damage_yes_crtc, igt_damage_iter_yes_damage_yes_crtc)
selftest(damage_iter_yes_damage_yes_fb, igt_damage_iter_yes_damage_yes_fb)
...
selftest(damage_iter_damage_yest_visible, igt_damage_iter_damage_yest_visible)
