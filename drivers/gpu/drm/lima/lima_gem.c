...
static int lima_gem_object_open(struct drm_gem_object *obj,
...
static void lima_gem_object_close(struct drm_gem_object *obj,
    struct drm_file *file) {
  struct lima_bo *bo = to_lima_bo(obj);
  struct lima_drm_priv *priv = to_lima_drm_priv(file);
  struct lima_vm *vm = priv->vm;
...
static int lima_gem_mmap(struct drm_gem_object *obj,
...
static int lima_gem_add_deps(struct drm_file *file,
