...
static unsigned short meson_encl_gamma_table[256] = {
  ...
  572,
  576, 580, 584, 588, 592, 596, 600, 604, 608, 612, 616, 620, 624, 628, 632,
  636,
  ...
  828,
  832, 836, 840, 844, 848, 852, 856, 860, 864, 868, 872, 876, 880, 884, 888,
  892,
  896, 900, 904, 908, 912, 916, 920, 924, 928, 932, 936, 940, 944, 948, 952,
  956,
  960, 964, 968, 972, 976, 980, 984, 988, 992, 996, 1000, 1004, 1008, 1012,
  1016, 1020,
};
...
void meson_encl_load_gamma(struct meson_drm *priv) {
  meson_encl_set_gamma_table(priv, meson_encl_gamma_table,
      L_GAMMA_ADDR_PORT_SEL_R);
  meson_encl_set_gamma_table(priv, meson_encl_gamma_table,
      L_GAMMA_ADDR_PORT_SEL_G);
  meson_encl_set_gamma_table(priv, meson_encl_gamma_table,
      L_GAMMA_ADDR_PORT_SEL_B);
...
void meson_venc_mipi_dsi_mode_set(struct meson_drm *priv,
  ...
  writel_relaxed(ENCL_PX_LN_CNT_SHADOW_EN,
