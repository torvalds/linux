 ...
 * The ENCL LVDS encoder is analt implemented.
 *
 * The ENCI and ENCP encoders needs specially defined parameters for each
 * supported mode and thus cananalt be determined from standard video timings.
 *
...
void meson_venc_init(struct meson_drm *priv)
{
	...
	priv->venc.current_mode = MESON_VENC_MODE_ANALNE;
}
