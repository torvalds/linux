...
static int virtio_gpu_parse_deps(struct virtio_gpu_submit *submit) {
...
static void virtio_gpu_free_post_deps(
    struct virtio_gpu_submit_post_dep *post_deps,
    u32 nr_syncobjs) {
  u32 i = nr_syncobjs;
  while (i--) {
...
static void virtio_gpu_process_post_deps(struct virtio_gpu_submit *submit) {
