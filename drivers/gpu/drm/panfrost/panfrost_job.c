...
static struct panfrost_job *to_panfrost_job(struct drm_sched_job *sched_job) {
...
static inline struct panfrost_fence *to_panfrost_fence(struct dma_fence *fence)
{
...
static struct dma_fence *panfrost_fence_create(struct panfrost_device *pfdev,
    int js_num) {
...
static struct panfrost_job *panfrost_dequeue_job(struct panfrost_device *pfdev,
    int slot) {
...
static unsigned int panfrost_enqueue_job(struct panfrost_device *pfdev,
    int slot,
