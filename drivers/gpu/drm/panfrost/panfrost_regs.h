...
#define GPU_THREAD_MAX_THREADS    0x0A0 /* (RO) Maximum number of threads per
                                         * core */
#define GPU_THREAD_MAX_WORKGROUP_SIZE 0x0A4 /* (RO) Maximum workgroup size */
#define GPU_THREAD_MAX_BARRIER_SIZE 0x0A8 /* (RO) Maximum threads waiting at a
                                           * barrier */
...
#define GPU_SHADER_PRESENT_LO   0x100 /* (RO) Shader core present bitmap, low
                                       * word */
#define GPU_SHADER_PRESENT_HI   0x104 /* (RO) Shader core present bitmap, high
                                       * word */
#define GPU_TILER_PRESENT_LO    0x110 /* (RO) Tiler core present bitmap, low
                                       * word */
#define GPU_TILER_PRESENT_HI    0x114 /* (RO) Tiler core present bitmap, high
                                       * word */

#define GPU_L2_PRESENT_LO   0x120 /* (RO) Level 2 cache present bitmap, low word
                                   * */
#define GPU_L2_PRESENT_HI   0x124 /* (RO) Level 2 cache present bitmap, high
                                   * word */
...
#define GPU_STACK_PRESENT_LO    0xE00   /* (RO) Core stack present bitmap, low
                                         * word */
#define GPU_STACK_PRESENT_HI    0xE04   /* (RO) Core stack present bitmap, high
                                         * word */
...
#define STACK_PWRON_LO      0xE20   /* (RO) Core stack power on bitmap, low word
                                     * */
#define STACK_PWRON_HI      0xE24   /* (RO) Core stack power on bitmap, high
                                     * word */

#define SHADER_PWROFF_LO    0x1C0 /* (WO) Shader core power off bitmap, low word
                                   * */
#define SHADER_PWROFF_HI    0x1C4 /* (WO) Shader core power off bitmap, high
                                   * word */
...
#define L2_PWROFF_LO      0x1E0 /* (WO) Level 2 cache power off bitmap, low word
                                 * */
#define L2_PWROFF_HI      0x1E4 /* (WO) Level 2 cache power off bitmap, high
                                 * word */

#define STACK_PWROFF_LO     0xE30   /* (RO) Core stack power off bitmap, low
                                     * word */
#define STACK_PWROFF_HI     0xE34   /* (RO) Core stack power off bitmap, high
                                     * word */
...
#define L2_PWRTRANS_LO      0x220 /* (RO) Level 2 cache power transition bitmap,
                                   * low word */
#define L2_PWRTRANS_HI      0x224 /* (RO) Level 2 cache power transition bitmap,
                                   * high word */
...
#define GPU_JM_CONFIG     0xF00   /* (RW) Job Manager configuration register
                                   * (Implementation specific register) */
#define GPU_SHADER_CONFIG   0xF04 /* (RW) Shader core configuration settings
                                   * (Implementation specific register) */
#define GPU_TILER_CONFIG    0xF08   /* (RW) Tiler core configuration settings
                                     * (Implementation specific register) */
#define GPU_L2_MMU_CONFIG   0xF0C /* (RW) Configuration of the L2 cache and MMU
                                   * (Implementation specific register) */

/* L2_MMU_CONFIG register */
#define L2_MMU_CONFIG_ALLOW_SNOOP_DISPARITY_SHIFT 23
#define L2_MMU_CONFIG_ALLOW_SNOOP_DISPARITY   (0x1 << \
      L2_MMU_CONFIG_ALLOW_SNOOP_DISPARITY_SHIFT)
#define L2_MMU_CONFIG_LIMIT_EXTERNAL_READS_SHIFT  24
#define L2_MMU_CONFIG_LIMIT_EXTERNAL_READS    (0x3 << \
      L2_MMU_CONFIG_LIMIT_EXTERNAL_READS_SHIFT)
#define L2_MMU_CONFIG_LIMIT_EXTERNAL_READS_OCTANT (0x1 << \
      L2_MMU_CONFIG_LIMIT_EXTERNAL_READS_SHIFT)
#define L2_MMU_CONFIG_LIMIT_EXTERNAL_READS_QUARTER  (0x2 << \
      L2_MMU_CONFIG_LIMIT_EXTERNAL_READS_SHIFT)
#define L2_MMU_CONFIG_LIMIT_EXTERNAL_READS_HALF   (0x3 << \
      L2_MMU_CONFIG_LIMIT_EXTERNAL_READS_SHIFT)

#define L2_MMU_CONFIG_LIMIT_EXTERNAL_WRITES_SHIFT 26
#define L2_MMU_CONFIG_LIMIT_EXTERNAL_WRITES   (0x3 << \
      L2_MMU_CONFIG_LIMIT_EXTERNAL_WRITES_SHIFT)
#define L2_MMU_CONFIG_LIMIT_EXTERNAL_WRITES_OCTANT  (0x1 << \
      L2_MMU_CONFIG_LIMIT_EXTERNAL_WRITES_SHIFT)
#define L2_MMU_CONFIG_LIMIT_EXTERNAL_WRITES_QUARTER (0x2 << \
      L2_MMU_CONFIG_LIMIT_EXTERNAL_WRITES_SHIFT)
#define L2_MMU_CONFIG_LIMIT_EXTERNAL_WRITES_HALF  (0x3 << \
      L2_MMU_CONFIG_LIMIT_EXTERNAL_WRITES_SHIFT)

#define L2_MMU_CONFIG_3BIT_LIMIT_EXTERNAL_READS_SHIFT 12
#define L2_MMU_CONFIG_3BIT_LIMIT_EXTERNAL_READS   (0x7 << \
      L2_MMU_CONFIG_LIMIT_EXTERNAL_READS_SHIFT)

#define L2_MMU_CONFIG_3BIT_LIMIT_EXTERNAL_WRITES_SHIFT  15
#define L2_MMU_CONFIG_3BIT_LIMIT_EXTERNAL_WRITES  (0x7 << \
      L2_MMU_CONFIG_LIMIT_EXTERNAL_WRITES_SHIFT)
...
#define JS_COMMAND_SOFT_STOP_0    0x04  /* Execute SOFT_STOP if JOB_CHAIN_FLAG
                                         * is 0 */
#define JS_COMMAND_HARD_STOP_0    0x05  /* Execute HARD_STOP if JOB_CHAIN_FLAG
                                         * is 0 */
#define JS_COMMAND_SOFT_STOP_1    0x06  /* Execute SOFT_STOP if JOB_CHAIN_FLAG
                                         * is 1 */
#define JS_COMMAND_HARD_STOP_1    0x07  /* Execute HARD_STOP if JOB_CHAIN_FLAG
                                         * is 1 */
...
#define AS_COMMAND_UPDATE   0x01  /* Broadcasts the values in AS_TRANSTAB and
                                   * ASn_MEMATTR to all MMUs */
#define AS_COMMAND_LOCK     0x02  /* Issue a lock region command to all MMUs */
#define AS_COMMAND_UNLOCK   0x03  /* Issue a flush region command to all MMUs */
#define AS_COMMAND_FLUSH    0x04  /* Flush all L2 caches then issue a flush
                                   * region command to all MMUs
                                   * (deprecated - only for use with T60x) */
#define AS_COMMAND_FLUSH_PT   0x04  /* Flush all L2 caches then issue a flush
                                     * region command to all MMUs */
#define AS_COMMAND_FLUSH_MEM    0x05  /* Wait for memory accesses to complete,
                                       * flush all the L1s cache then
                                       * flush all L2 caches then issue a flush
                                       * region command to all MMUs */
...
#define AS_TRANSTAB_LO(as)    (MMU_AS(as) + 0x00) /* (RW) Translation Table Base
                                                   * Address for address space
                                                   * n, low word */
#define AS_TRANSTAB_HI(as)    (MMU_AS(as) + 0x04) /* (RW) Translation Table Base
                                                   * Address for address space
                                                   * n, high word */
#define AS_MEMATTR_LO(as)   (MMU_AS(as) + 0x08) /* (RW) Memory attributes for
                                                 * address space n, low word. */
#define AS_MEMATTR_HI(as)   (MMU_AS(as) + 0x0C) /* (RW) Memory attributes for
                                                 * address space n, high word.
                                                 * */
#define AS_LOCKADDR_LO(as)    (MMU_AS(as) + 0x10) /* (RW) Lock region address
                                                   * for address space n, low
                                                   * word */
#define AS_LOCKADDR_HI(as)    (MMU_AS(as) + 0x14) /* (RW) Lock region address
                                                   * for address space n, high
                                                   * word */
#define AS_COMMAND(as)      (MMU_AS(as) + 0x18) /* (WO) MMU command register for
                                                 * address space n */
#define AS_FAULTSTATUS(as)    (MMU_AS(as) + 0x1C) /* (RO) MMU fault status
                                                   * register for address space
                                                   * n */
#define AS_FAULTADDRESS_LO(as)    (MMU_AS(as) + 0x20) /* (RO) Fault Address for
                                                       * address space n, low
                                                       * word */
#define AS_FAULTADDRESS_HI(as)    (MMU_AS(as) + 0x24) /* (RO) Fault Address for
                                                       * address space n, high
                                                       * word */
#define AS_STATUS(as)     (MMU_AS(as) + 0x28) /* (RO) Status flags for address
                                               * space n */
/* Additional Bifrost AS registers */
#define AS_TRANSCFG_LO(as)    (MMU_AS(as) + 0x30) /* (RW) Translation table
                                                   * configuration for address
                                                   * space n, low word */
#define AS_TRANSCFG_HI(as)    (MMU_AS(as) + 0x34) /* (RW) Translation table
                                                   * configuration for address
                                                   * space n, high word */
#define AS_FAULTEXTRA_LO(as)    (MMU_AS(as) + 0x38) /* (RO) Secondary fault
                                                     * address for address space
                                                     * n, low word */
#define AS_FAULTEXTRA_HI(as)    (MMU_AS(as) + 0x3C) /* (RO) Secondary fault
                                                     * address for address space
                                                     * n, high word */
