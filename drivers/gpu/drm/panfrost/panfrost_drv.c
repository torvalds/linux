 ...
 */
static int panfrost_lookup_bos(struct drm_device *dev,
...
static int panfrost_ioctl_wait_bo(struct drm_device *dev, void *data,
    struct drm_file *file_priv) {
  long ret;
...
static void panfrost_postclose(struct drm_device *dev, struct drm_file *file) {
