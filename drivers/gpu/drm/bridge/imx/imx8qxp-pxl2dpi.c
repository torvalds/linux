...
static int imx8qxp_pxl2dpi_bridge_atomic_check(struct drm_bridge *bridge,
...
static void imx8qxp_pxl2dpi_bridge_mode_set(struct drm_bridge *bridge,
...
static u32 *imx8qxp_pxl2dpi_bridge_atomic_get_input_bus_fmts(
    struct drm_bridge *bridge,
    struct drm_bridge_state *bridge_state,
    struct drm_crtc_state *crtc_state,
    struct drm_connector_state *conn_state,
...
static u32 *imx8qxp_pxl2dpi_bridge_atomic_get_output_bus_fmts(
    struct drm_bridge *bridge,
    struct drm_bridge_state *bridge_state,
    struct drm_crtc_state *crtc_state,
    struct drm_connector_state *conn_state,
...
static struct device_node *imx8qxp_pxl2dpi_get_available_ep_from_port(
...
static struct drm_bridge *imx8qxp_pxl2dpi_find_next_bridge(
    struct imx8qxp_pxl2dpi *p2d) {
