...
static int dphy_pll_get_configure_from_opts(struct imx93_dsi *dsi,
...
static u8 dphy_pll_get_hsfreqrange(
    struct phy_configure_opts_mipi_dphy *dphy_opts) {
...
static int dphy_pll_configure(struct imx93_dsi *dsi,
...
static enum drm_mode_status imx93_dsi_validate_mode(struct imx93_dsi *dsi,
    const struct drm_display_mode *mode) {
...
static enum drm_mode_status imx93_dsi_validate_phy(struct imx93_dsi *dsi,
    const struct drm_display_mode *mode,
...
static enum drm_mode_status imx93_dsi_mode_valid(void *priv_data,
    const struct drm_display_mode *mode,
    unsigned long mode_flags, u32 lanes, u32 format) {
...
static int imx93_dsi_get_lane_mbps(void *priv_data,
    const struct drm_display_mode *mode,
    unsigned long mode_flags, u32 lanes, u32 format,
...
static int imx93_dsi_host_attach(void *priv_data,
