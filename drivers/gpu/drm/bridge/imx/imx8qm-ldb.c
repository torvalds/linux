...
static inline struct imx8qm_ldb_channel *base_to_imx8qm_ldb_channel(
    struct ldb_channel *base) {
...
static void imx8qm_ldb_bridge_mode_set(struct drm_bridge *bridge,
...
static u32 *imx8qm_ldb_bridge_atomic_get_input_bus_fmts(
...
static u32 *imx8qm_ldb_bridge_atomic_get_output_bus_fmts(
    struct drm_bridge *bridge,
    struct drm_bridge_state *bridge_state,
    struct drm_crtc_state *crtc_state,
    struct drm_connector_state *conn_state,
...
static enum drm_mode_status imx8qm_ldb_bridge_mode_valid(
    struct drm_bridge *bridge,
