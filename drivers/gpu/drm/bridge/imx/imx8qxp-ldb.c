...
static inline struct imx8qxp_ldb_channel *base_to_imx8qxp_ldb_channel(
    struct ldb_channel *base) {
...
static void imx8qxp_ldb_bridge_mode_set(struct drm_bridge *bridge,
...
static u32 *imx8qxp_ldb_bridge_atomic_get_input_bus_fmts(
...
static u32 *imx8qxp_ldb_bridge_atomic_get_output_bus_fmts(
    struct drm_bridge *bridge,
    struct drm_bridge_state *bridge_state,
    struct drm_crtc_state *crtc_state,
    struct drm_connector_state *conn_state,
...
static enum drm_mode_status imx8qxp_ldb_bridge_mode_valid(
    struct drm_bridge *bridge,
...
static int imx8qxp_ldb_check_chno_and_dual_link(struct ldb_channel *ldb_ch,
    int link) {
...
MODULE_DESCRIPTION(
    "i.MX8QXP LVDS Display Bridge(LDB)/Pixel Mapper bridge driver");
