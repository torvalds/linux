...
static enum drm_connector_status sii902x_connector_detect(
...
static enum drm_connector_status sii902x_bridge_detect(
    struct drm_bridge *bridge) {
  struct sii902x *sii902x = bridge_to_sii902x(bridge);
  return sii902x_detect(sii902x);
}

static const struct drm_edid *sii902x_bridge_edid_read(
    struct drm_bridge *bridge,
    struct drm_connector *connector) {
  struct sii902x *sii902x = bridge_to_sii902x(bridge);
