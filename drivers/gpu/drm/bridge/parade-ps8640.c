...
static int _ps8640_wait_hpd_asserted(struct ps8640 *ps_bridge,
...
static int ps8640_wait_hpd_asserted(struct drm_dp_aux *aux,
    unsigned long wait_us) {
...
static int ps8640_bridge_get_dsi_resources(struct device *dev,
