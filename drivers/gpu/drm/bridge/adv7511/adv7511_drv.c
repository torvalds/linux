...
static int adv7511_packet_disable(struct adv7511 *adv7511,
    unsigned int packet) {
  if (packet & 0xff) {
    regmap_update_bits(adv7511->regmap, ADV7511_REG_PACKET_ENABLE0,
        packet, 0x00);
...
static void adv7511_set_link_config(struct adv7511 *adv7511,
   ...
   */
  static const unsigned int input_styles[4] = {
    0, 2, 1, 3
  };
...
static enum drm_connector_status adv7511_detect(struct adv7511 *adv7511,
    struct drm_connector *connector) {
  enum drm_connector_status status;
  unsigned int val;
  bool hpd;
...
static enum drm_mode_status adv7511_connector_mode_valid(
    struct drm_connector *connector,
...
static enum drm_connector_status adv7511_connector_detect(
...
static enum drm_connector_status adv7511_bridge_detect(
    struct drm_bridge *bridge) {
  struct adv7511 *adv = bridge_to_adv7511(bridge);
  return adv7511_detect(adv, NULL);
}

static const struct drm_edid *adv7511_bridge_edid_read(
    struct drm_bridge *bridge,
    struct drm_connector *connector) {
  struct adv7511 *adv = bridge_to_adv7511(bridge);
...
static bool adv7511_cec_register_volatile(struct device *dev,
  ...
  switch (reg) {
    ...
    case ADV7511_REG_CEC_RX1_FRAME_DATA0 ... ADV7511_REG_CEC_RX1_FRAME_DATA0
      + 14:
    case ADV7511_REG_CEC_RX1_FRAME_LEN:
    case ADV7511_REG_CEC_RX2_FRAME_HDR:
    case ADV7511_REG_CEC_RX2_FRAME_DATA0 ... ADV7511_REG_CEC_RX2_FRAME_DATA0
      + 14:
    case ADV7511_REG_CEC_RX2_FRAME_LEN:
    case ADV7511_REG_CEC_RX3_FRAME_HDR:
    case ADV7511_REG_CEC_RX3_FRAME_DATA0 ... ADV7511_REG_CEC_RX3_FRAME_DATA0
      + 14:
