...
static inline struct display_connector *to_display_connector(
    struct drm_bridge *bridge) {
...
static enum drm_connector_status display_connector_detect(
    struct drm_bridge *bridge) {
...
static const struct drm_edid *display_connector_edid_read(
    struct drm_bridge *bridge,
