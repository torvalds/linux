...
static void anx7625_reduction_of_a_fraction(unsigned long *a,
    unsigned long *b) {
...
static int anx7625_register_audio(struct device *dev,
...
static enum drm_connector_status anx7625_bridge_detect(
...
static const struct drm_edid *anx7625_bridge_edid_read(
    struct drm_bridge *bridge,
    struct drm_connector *connector) {
  struct anx7625_data *ctx = bridge_to_anx7625(bridge);
  struct device *dev = ctx->dev;
