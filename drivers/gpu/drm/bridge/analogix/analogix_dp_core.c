...
static int analogix_dp_enable_rx_to_enhanced_mode(struct analogix_dp_device *dp,
    bool enable) {
  u8 data;
  int ret;
...
static void analogix_dp_set_lane_lane_pre_emphasis(
...
static unsigned char analogix_dp_get_adjust_request_voltage(
...
int analogix_dp_bind(struct analogix_dp_device *dp,
