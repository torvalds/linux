...
static enum drm_mode_status tc358768_bridge_mode_valid(
    struct drm_bridge *bridge,
...
static void tc358768_bridge_pre_enable(struct drm_bridge *bridge) {
  ...
  raw_val
    = tc358768_ns_to_cnt(60 + tc358768_ps_to_ns(2 * ui_ps), hsbyteclk_ps) - 5;
  ...
  raw_val
    = tc358768_ns_to_cnt(145 - tc358768_ps_to_ns(3 * ui_ps),
      hsbyteclk_ps) - 10;
...
static u32 *tc358768_atomic_get_input_bus_fmts(struct drm_bridge *bridge,
