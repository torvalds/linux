...
static void it6505_enable_audio_infoframe(struct it6505 *it6505) {
  struct device *dev = it6505->dev;
  u8 audio_info_ca[] = {
    0x00, 0x00, 0x01, 0x03, 0x07, 0x0B, 0x0F, 0x1F
  };
...
static bool step_train_lane_voltage_para_set(struct it6505 *it6505,
    struct it6505_step_train_para
...
static bool it6505_step_cr_train(struct it6505 *it6505,
...
static bool it6505_step_eq_train(struct it6505 *it6505,
    struct it6505_step_train_para *lane_voltage_pre_emphasis) {
  u8 loop_count = 0, i, link_status[DP_LINK_STATUS_SIZE] = {
    0
  };
  u8 lane_level_config[MAX_LANE_COUNT] = {
    0
...
static void __maybe_unused it6505_audio_shutdown(struct device *dev,
    void *data) {
...
static enum drm_mode_status it6505_bridge_mode_valid(struct drm_bridge *bridge,
...
static enum drm_connector_status it6505_bridge_detect(struct drm_bridge *bridge)
{
  struct it6505 *it6505 = bridge_to_it6505(bridge);
