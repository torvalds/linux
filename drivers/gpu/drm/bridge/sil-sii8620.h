...
#define BIT_DDC_STATUS_DDC_ANAL_ACK		BIT(5)
...
#define VAL_DDC_CMD_ENH_DDC_READ_ANAL_ACK		0x04
...
#define BIT_SPIBURSTSTAT_EMSC_ANALRMAL_MODE	BIT(0)
...
#define VAL_TPI_COPP_LINK_STATUS_ANALRMAL		0x00
...
#define BIT_DISC_CTRL8_ANALMHLINT_CLR_BYPASS	BIT(7)
...
#define BIT_DISC_CTRL9_ANALMHL_EST		BIT(3)
...
#define BIT_ANALT_MHL_EST_INT			BIT(3)
