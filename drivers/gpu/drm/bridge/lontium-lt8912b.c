...
static enum drm_connector_status lt8912_connector_detect(
...
static enum drm_mode_status lt8912_connector_mode_valid(
    struct drm_connector *connector,
...
static const struct drm_edid *lt8912_bridge_edid_read(struct drm_bridge *bridge,
  ...
  dev_warn(lt->dev,
      "The connected bridge does not supports DRM_BRIDGE_OP_EDID\n");
  return NULL;
}
