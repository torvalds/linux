...
static void shmob_drm_crtc_start_stop(struct shmob_drm_crtc *scrtc,
    bool start) {
...
static inline struct shmob_drm_connector *to_shmob_connector(
...
static struct drm_encoder *shmob_drm_connector_best_encoder(
    struct drm_connector *connector) {
  struct shmob_drm_connector *scon = to_shmob_connector(connector);
  return scon->encoder;
}
...
static struct drm_connector *shmob_drm_connector_init(
