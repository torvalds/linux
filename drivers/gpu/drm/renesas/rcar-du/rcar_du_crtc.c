...
static const struct rcar_du_format_info *plane_format(
...
static enum drm_mode_status rcar_du_crtc_mode_valid(struct drm_crtc *crtc,
    const struct drm_display_mode *mode) {
  struct rcar_du_crtc *rcrtc = to_rcar_crtc(crtc);
  struct rcar_du_device *rcdu = rcrtc->dev;
...
static struct drm_crtc_state *rcar_du_crtc_atomic_duplicate_state(
