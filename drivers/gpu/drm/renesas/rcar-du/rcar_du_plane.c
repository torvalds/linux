...
int rcar_du_atomic_check_planes(struct drm_device *dev,
  ...
  unsigned int group_freed_planes[RCAR_DU_MAX_GROUPS] = {
    0,
  };
  unsigned int group_free_planes[RCAR_DU_MAX_GROUPS] = {
    0,
  };
...
static struct drm_plane_state *rcar_du_plane_atomic_duplicate_state(
