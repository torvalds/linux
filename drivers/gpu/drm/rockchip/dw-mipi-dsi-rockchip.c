...
static inline void dsi_write(struct dw_mipi_dsi_rockchip *dsi, u32 reg,
    u32 val) {
...
static int dw_mipi_dsi_get_lane_mbps(void *priv_data,
...
static int dw_mipi_dsi_dphy_configure(struct phy *phy,
