...
static struct rockchip_dp_device *pdata_encoder_to_dp(
    struct analogix_dp_plat_data *plat_data) {
...
static bool rockchip_dp_drm_encoder_mode_fixup(struct drm_encoder *encoder,
...
static int rockchip_dp_drm_encoder_atomic_check(struct drm_encoder *encoder,
