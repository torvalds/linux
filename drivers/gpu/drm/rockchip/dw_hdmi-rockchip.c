...
static enum drm_mode_status dw_hdmi_rockchip_mode_valid(struct dw_hdmi *dw_hdmi,
    void *data,
...
static enum drm_connector_status dw_hdmi_rk3328_read_hpd(
    struct dw_hdmi *dw_hdmi, void *data) {
  struct rockchip_hdmi *hdmi = (struct rockchip_hdmi *) data;
