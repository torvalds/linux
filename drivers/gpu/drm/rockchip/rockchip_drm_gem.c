...
static struct rockchip_gem_object *rockchip_gem_alloc_object(
...
struct rockchip_gem_object *rockchip_gem_create_object(struct drm_device *drm,
    unsigned int size,
    bool alloc_kmap) {
  struct rockchip_gem_object *rk_obj;
  int ret;
...
static int rockchip_gem_iommu_map_sg(struct drm_device *drm,
...
static int rockchip_gem_dma_map_sg(struct drm_device *drm,
    struct dma_buf_attachment *attach,
    struct sg_table *sg,
    struct rockchip_gem_object *rk_obj) {
