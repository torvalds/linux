...
static enum drm_connector_status inno_hdmi_connector_detect(
...
static enum drm_mode_status inno_hdmi_connector_mode_valid(
    struct drm_connector *connector,
    struct drm_display_mode *mode) {
  struct inno_hdmi *hdmi = connector_to_inno_hdmi(connector);
...
static void inno_hdmi_connector_destroy_state(struct drm_connector *connector,
...
static struct drm_connector_state *inno_hdmi_connector_duplicate_state(
    struct drm_connector *connector) {
  struct inno_hdmi_connector_state *inno_conn_state;
