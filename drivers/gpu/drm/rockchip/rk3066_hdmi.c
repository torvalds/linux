...
static struct rk3066_hdmi *connector_to_rk3066_hdmi(
    struct drm_connector *connector) {
...
static int rk3066_hdmi_upload_frame(struct rk3066_hdmi *hdmi, int setup_rc,
...
static void rk3066_hdmi_phy_write(struct rk3066_hdmi *hdmi, u16 offset,
    u8 value) {
...
static int rk3066_hdmi_encoder_atomic_check(struct drm_encoder *encoder,
    struct drm_crtc_state *crtc_state,
    struct drm_connector_state *conn_state) {
...
static enum drm_connector_status rk3066_hdmi_connector_detect(
...
static enum drm_mode_status rk3066_hdmi_connector_mode_valid(
    struct drm_connector *connector,
    struct drm_display_mode *mode) {
...
static struct drm_encoder *rk3066_hdmi_connector_best_encoder(
    struct drm_connector *connector) {
  struct rk3066_hdmi *hdmi = connector_to_rk3066_hdmi(connector);
  return &hdmi->encoder.encoder;
}

static int rk3066_hdmi_probe_single_connector_modes(
    struct drm_connector *connector,
...
static int rk3066_hdmi_register(struct drm_device *drm,
...
static int rk3066_hdmi_i2c_read(struct rk3066_hdmi *hdmi,
    struct i2c_msg *msgs) {
  int length = msgs->len;
  u8 *buf = msgs->buf;
  int ret;
...
static int rk3066_hdmi_i2c_write(struct rk3066_hdmi *hdmi,
    struct i2c_msg *msgs) {
  /*
