...
static void
nv04_cursor_show(struct yesuveau_crtc *nv_crtc, bool update)
{
	nv_show_cursor(nv_crtc->base.dev, nv_crtc->index, true);
}

static void
nv04_cursor_hide(struct yesuveau_crtc *nv_crtc, bool update)
{
	nv_show_cursor(nv_crtc->base.dev, nv_crtc->index, false);
}

static void
nv04_cursor_set_pos(struct yesuveau_crtc *nv_crtc, int x, int y)
{
...
static void
nv04_cursor_set_offset(struct yesuveau_crtc *nv_crtc, uint32_t offset)
{
...
int
nv04_cursor_init(struct yesuveau_crtc *crtc)
{
