...
#define NV03_FIFO_CMD_REWIND                               (NV03_FIFO_CMD_JUMP \
  | (0 & NV03_FIFO_CMD_JUMP_OFFSET_MASK))
...
#define NV50_PDISPLAY_CRTC_P(i, \
      r)        ((i) * 0x540 + NV50_PDISPLAY_CRTC_ ## r)
#define NV50_PDISPLAY_CRTC_C(i, \
      r)    (4 + (i) * 0x540 + NV50_PDISPLAY_CRTC_ ## r)
