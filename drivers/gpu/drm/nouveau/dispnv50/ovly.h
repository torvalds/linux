...
int ovly507e_new(struct yesuveau_drm *, int, s32, struct nv50_wndw **);
...
void ovly827e_ntfy_reset(struct yesuveau_bo *, u32);
int ovly827e_ntfy_wait_begun(struct yesuveau_bo *, u32, struct nvif_device *);

extern const struct nv50_wndw_func ovly907e;

int ovly827e_new(struct yesuveau_drm *, int, s32, struct nv50_wndw **);
int ovly907e_new(struct yesuveau_drm *, int, s32, struct nv50_wndw **);
int ovly917e_new(struct yesuveau_drm *, int, s32, struct nv50_wndw **);

int nv50_ovly_new(struct yesuveau_drm *, int head, struct nv50_wndw **);
#endif
