...
int base507c_new(struct yesuveau_drm *, int, s32, struct nv50_wndw **);
int base507c_new_(const struct nv50_wndw_func *, const u32 *format,
		  struct yesuveau_drm *, int head, s32 oclass,
...
int base827c_new(struct yesuveau_drm *, int, s32, struct nv50_wndw **);

int base907c_new(struct yesuveau_drm *, int, s32, struct nv50_wndw **);
extern const struct nv50_wndw_func base907c;

int base917c_new(struct yesuveau_drm *, int, s32, struct nv50_wndw **);

int nv50_base_new(struct yesuveau_drm *, int head, struct nv50_wndw **);
#endif
