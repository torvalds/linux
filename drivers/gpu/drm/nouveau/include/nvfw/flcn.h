...
void loader_config_dump(struct nvkm_subdev *, const struct loader_config *);
...
void loader_config_v1_dump(struct nvkm_subdev *,
    const struct loader_config_v1 *);
...
void flcn_bl_dmem_desc_dump(struct nvkm_subdev *,
    const struct flcn_bl_dmem_desc *);
