...
static inline void nvkm_subdev_ctor(const struct nvkm_subdev_func *func,
    struct nvkm_device *device,
...
#define nvkm_printk__(s, l, p, f, a ...) nvkm_printk___((s), (s), (l), p, f, \
    ## a)
#define nvkm_printk_(s, l, p, f, a ...) nvkm_printk__((s), (l), p, " "f, ## a)
#define nvkm_printk(s, l, p, f, a ...) nvkm_printk_((s), NV_DBG_ ## l, p, f, \
    ## a)
