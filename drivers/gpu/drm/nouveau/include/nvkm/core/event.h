...
int __nvkm_event_init(const struct nvkm_event_func *func, struct nvkm_subdev *,
    int types_nr,
 ...
 */
static __always_inline int nvkm_event_init(const struct nvkm_event_func *func,
    struct nvkm_subdev *subdev,
...
void nvkm_event_ntfy_add(struct nvkm_event *, int id, u32 bits, bool wait,
    nvkm_event_func,
    struct nvkm_event_ntfy *);
...
int nvkm_uevent_new(const struct nvkm_oclass *, void *argv, u32 argc,
    struct nvkm_object **);
int nvkm_uevent_add(struct nvkm_uevent *, struct nvkm_event *, int id, u32 bits,
    nvkm_uevent_func);
#endif
