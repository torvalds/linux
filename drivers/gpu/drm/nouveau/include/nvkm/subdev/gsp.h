...
static inline bool nvkm_gsp_rm(struct nvkm_gsp *gsp) {
  return gsp && (gsp->fws.rm || gsp->fw.img);
}

static inline void *nvkm_gsp_rpc_get(struct nvkm_gsp *gsp, u32 fn, u32 argc) {
  return gsp->rm->rpc_get(gsp, fn, argc);
}

static inline void *nvkm_gsp_rpc_push(struct nvkm_gsp *gsp, void *argv,
    bool wait, u32 repc) {
  return gsp->rm->rpc_push(gsp, argv, wait, repc);
}

static inline void *nvkm_gsp_rpc_rd(struct nvkm_gsp *gsp, u32 fn, u32 argc) {
...
static inline int nvkm_gsp_rpc_wr(struct nvkm_gsp *gsp, void *argv, bool wait) {
...
static inline void nvkm_gsp_rpc_done(struct nvkm_gsp *gsp, void *repv) {
  gsp->rm->rpc_done(gsp, repv);
}

static inline void *nvkm_gsp_rm_ctrl_get(struct nvkm_gsp_object *object,
    u32 cmd, u32 argc) {
  return object->client->gsp->rm->rm_ctrl_get(object, cmd, argc);
}

static inline int nvkm_gsp_rm_ctrl_push(struct nvkm_gsp_object *object,
    void *argv, u32 repc) {
  return object->client->gsp->rm->rm_ctrl_push(object, argv, repc);
}

static inline void *nvkm_gsp_rm_ctrl_rd(struct nvkm_gsp_object *object, u32 cmd,
    u32 repc) {
...
static inline int nvkm_gsp_rm_ctrl_wr(struct nvkm_gsp_object *object,
    void *argv) {
...
static inline void nvkm_gsp_rm_ctrl_done(struct nvkm_gsp_object *object,
    void *repv) {
  object->client->gsp->rm->rm_ctrl_done(object, repv);
}

static inline void *nvkm_gsp_rm_alloc_get(struct nvkm_gsp_object *parent,
    u32 handle, u32 oclass, u32 argc,
    struct nvkm_gsp_object *object) {
...
static inline void *nvkm_gsp_rm_alloc_push(struct nvkm_gsp_object *object,
    void *argv, u32 repc) {
...
static inline int nvkm_gsp_rm_alloc_wr(struct nvkm_gsp_object *object,
    void *argv) {
...
static inline void nvkm_gsp_rm_alloc_done(struct nvkm_gsp_object *object,
    void *repv) {
  object->client->gsp->rm->rm_alloc_done(object, repv);
}

static inline int nvkm_gsp_rm_alloc(struct nvkm_gsp_object *parent, u32 handle,
    u32 oclass, u32 argc,
    struct nvkm_gsp_object *object) {
...
static inline int nvkm_gsp_rm_free(struct nvkm_gsp_object *object) {
  if (object->client) {
...
static inline int nvkm_gsp_client_ctor(struct nvkm_gsp *gsp,
    struct nvkm_gsp_client *client) {
  if (WARN_ON(!gsp->rm)) {
    return -ENOSYS;
  }
...
static inline void nvkm_gsp_client_dtor(struct nvkm_gsp_client *client) {
  if (client->gsp) {
    client->gsp->rm->client_dtor(client);
  }
}

static inline int nvkm_gsp_device_ctor(struct nvkm_gsp_client *client,
    struct nvkm_gsp_device *device) {
  return client->gsp->rm->device_ctor(client, device);
}

static inline void nvkm_gsp_device_dtor(struct nvkm_gsp_device *device) {
  if (device->object.client) {
    device->object.client->gsp->rm->device_dtor(device);
  }
}

static inline int nvkm_gsp_client_device_ctor(struct nvkm_gsp *gsp,
...
static inline int nvkm_gsp_device_event_ctor(struct nvkm_gsp_device *device,
    u32 handle, u32 id,
    nvkm_gsp_event_func func, struct nvkm_gsp_event *event) {
  return device->object.client->gsp->rm->event_ctor(device, handle, id, func,
      event);
}

static inline void nvkm_gsp_event_dtor(struct nvkm_gsp_event *event) {
...
int gv100_gsp_new(struct nvkm_device *, enum nvkm_subdev_type, int,
    struct nvkm_gsp **);
int tu102_gsp_new(struct nvkm_device *, enum nvkm_subdev_type, int,
    struct nvkm_gsp **);
int tu116_gsp_new(struct nvkm_device *, enum nvkm_subdev_type, int,
    struct nvkm_gsp **);
int ga100_gsp_new(struct nvkm_device *, enum nvkm_subdev_type, int,
    struct nvkm_gsp **);
int ga102_gsp_new(struct nvkm_device *, enum nvkm_subdev_type, int,
    struct nvkm_gsp **);
int ad102_gsp_new(struct nvkm_device *, enum nvkm_subdev_type, int,
    struct nvkm_gsp **);
#endif
