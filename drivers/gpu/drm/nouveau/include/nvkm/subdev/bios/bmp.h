...
static inline u16 bmp_version(struct nvkm_bios *bios) {
  if (bios->bmp_offset) {
...
static inline u16 bmp_mem_init_table(struct nvkm_bios *bios) {
...
static inline u16 bmp_sdr_seq_table(struct nvkm_bios *bios) {
  if (bmp_version(bios) >= 0x0300) {
...
static inline u16 bmp_ddr_seq_table(struct nvkm_bios *bios) {
  if (bmp_version(bios) >= 0x0300) {
