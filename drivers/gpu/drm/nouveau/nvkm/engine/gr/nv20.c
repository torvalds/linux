...
int nv20_gr_chan_init(struct nvkm_object *object) {
...
int nv20_gr_chan_fini(struct nvkm_object *object, bool suspend) {
  struct nv20_gr_chan *chan = nv20_gr_chan(object);
  struct nv20_gr *gr = chan->gr;
...
void *nv20_gr_chan_dtor(struct nvkm_object *object) {
  struct nv20_gr_chan *chan = nv20_gr_chan(object);
...
static int nv20_gr_chan_new(struct nvkm_gr *base, struct nvkm_chan *fifoch,
...
void nv20_gr_tile(struct nvkm_gr *base, int i, struct nvkm_fb_tile *tile) {
  struct nv20_gr *gr = nv20_gr(base);
  struct nvkm_device *device = gr->base.engine.subdev.device;
...
void nv20_gr_intr(struct nvkm_gr *base) {
  struct nv20_gr *gr = nv20_gr(base);
...
int nv20_gr_oneinit(struct nvkm_gr *base) {
  struct nv20_gr *gr = nv20_gr(base);
...
int nv20_gr_init(struct nvkm_gr *base) {
  struct nv20_gr *gr = nv20_gr(base);
  struct nvkm_device *device = gr->base.engine.subdev.device;
  u32 tmp, vramsz;
  int i;
...
int nv20_gr_new_(const struct nvkm_gr_func *func, struct nvkm_device *device,
...
int nv20_gr_new(struct nvkm_device *device, enum nvkm_subdev_type type,
