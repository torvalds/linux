...
static int nv30_gr_chan_new(struct nvkm_gr *base, struct nvkm_chan *fifoch,
...
int nv30_gr_init(struct nvkm_gr *base) {
  struct nv20_gr *gr = nv20_gr(base);
...
int nv30_gr_new(struct nvkm_device *device, enum nvkm_subdev_type type,
