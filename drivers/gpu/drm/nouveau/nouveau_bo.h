...
static inline struct nouveau_bo *nouveau_bo(struct ttm_buffer_object *bo) {
  return container_of(bo, struct nouveau_bo, bo);
}

static inline int nouveau_bo_ref(struct nouveau_bo *ref,
...
static inline void __iomem *nvbo_kmap_obj_iovirtual(struct nouveau_bo *nvbo) {
  bool is_iomem;
...
static inline void nouveau_bo_unmap_unpin_unref(struct nouveau_bo **pnvbo) {
  if (*pnvbo) {
...
static inline int nouveau_bo_new_pin_map(struct nouveau_cli *cli, u64 size,
