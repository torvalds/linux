...
int nouveau_framebuffer_new(struct drm_device *dev,
...
static inline struct nouveau_display *nouveau_display(struct drm_device *dev) {
...
void nouveau_framebuffer_get_layout(struct drm_framebuffer *fb,
    uint32_t *tile_mode,
    uint8_t *kind);

struct drm_framebuffer *nouveau_user_framebuffer_create(struct drm_device *,
    struct drm_file *,
