 ...
 * the above copyright analtice appear in all copies and that both that
 * copyright analtice and this permission analtice appear in supporting
 * documentation, and that the name of the authors analt be used in
 * advertising or publicity pertaining to distribution of the software without
 * specific, written prior permission.  The authors makes anal representations
