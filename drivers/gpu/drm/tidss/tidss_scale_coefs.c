...
static const struct tidss_scale_coefs coef5_m32 = {
  ...
  .c1
    = { 132, 138, 144, 150, 156, 162, 168, 174, 76, 84, 92, 98, 104, 110, 116,
        124, },
...
static const struct tidss_scale_coefs coef5_m26 = {
  ...
  .c1
    = { 132, 138, 144, 152, 160, 166, 172, 178, 72, 80, 88, 94, 100, 108, 116,
        124, },
...
static const struct tidss_scale_coefs coef5_m22 = {
  ...
  .c1
    = { 132, 140, 148, 156, 164, 172, 180, 186, 64, 72, 80, 88, 96, 104, 112,
        122, },
...
static const struct tidss_scale_coefs coef5_m19 = {
  ...
  .c1
    = { 128, 140, 152, 160, 168, 176, 184, 192, 56, 64, 72, 82, 92, 100, 108,
        118, },
...
static const struct tidss_scale_coefs coef5_m16 = {
  ...
  .c1
    = { 124, 138, 152, 164, 176, 186, 196, 206, 40, 48, 56, 68, 80, 90, 100,
        112, },
...
static const struct tidss_scale_coefs coef5_m14 = {
  ...
  .c1
    = { 120, 134, 148, 164, 180, 194, 208, 220, 24, 32, 40, 52, 64, 78, 92,
        106, },
...
static const struct tidss_scale_coefs coef5_m13 = {
  ...
  .c1
    = { 112, 130, 148, 164, 180, 196, 212, 228, 12, 22, 32, 44, 56, 70, 84, 98,
    },
...
static const struct tidss_scale_coefs coef5_m12 = {
  .c2
    = { -16, -18, -20, -18, -16, -14, -12, -6, 0, -2, -4, -6, -8, -10, -12,
        -14, },
  .c1
    = { 104, 124, 144, 164, 184, 202, 220, 238, 0, 10, 20, 30, 40, 56, 72, 88,
    },
...
static const struct tidss_scale_coefs coef5_m11 = {
  .c2
    = { -20, -22, -24, -24, -24, -24, -24, -20, 0, -2, -4, -6, -8, -10, -12,
        -16, },
  .c1
    = { 92, 114, 136, 158, 180, 204, 228, 250, -16, -8, 0, 12, 24, 38, 52, 72,
    },
...
static const struct tidss_scale_coefs coef5_m10 = {
  .c2
    = { -16, -20, -24, -28, -32, -34, -36, -34, 0, 0, 0, -2, -4, -8, -12, -14,
    },
  .c1
    = { 72, 96, 120, 148, 176, 204, 232, 260, -32, -26, -20, -10, 0, 16, 32,
        52, },
...
static const struct tidss_scale_coefs coef5_m9 = {
  ...
  .c1
    = { 40, 68, 96, 128, 160, 196, 232, 268, -48, -46, -44, -36, -28, -14, 0,
        20, },
...
static const struct tidss_scale_coefs coef5_m8 = {
  ...
  .c1
    = { 0, 28, 56, 94, 132, 176, 220, 266, -56, -60, -64, -62, -60, -50, -40,
        -20, },
...
static const struct tidss_scale_coefs coef3_m32 = {
  .c1
    = { 108, 92, 76, 62, 48, 36, 24, 140, 256, 236, 216, 198, 180, 162, 144,
        126, },
...
static const struct tidss_scale_coefs coef3_m26 = {
  .c1
    = { 104, 90, 76, 60, 44, 32, 20, 138, 256, 236, 216, 198, 180, 160, 140,
        122, },
...
static const struct tidss_scale_coefs coef3_m22 = {
  .c1
    = { 100, 84, 68, 54, 40, 30, 20, 138, 256, 236, 216, 196, 176, 156, 136,
        118, },
...
static const struct tidss_scale_coefs coef3_m19 = {
  .c1
    = { 96, 80, 64, 50, 36, 26, 16, 136, 256, 236, 216, 194, 172, 152, 132,
        114, },
...
static const struct tidss_scale_coefs coef3_m16 = {
  .c1
    = { 88, 72, 56, 44, 32, 22, 12, 134, 256, 234, 212, 190, 168, 148, 128,
        108, },
...
static const struct tidss_scale_coefs coef3_m14 = {
  .c1
    = { 80, 64, 48, 36, 24, 16, 8, 132, 256, 232, 208, 186, 164, 142, 120, 100,
    },
...
static const struct tidss_scale_coefs coef3_m13 = {
  .c1
    = { 72, 56, 40, 30, 20, 12, 4, 130, 256, 232, 208, 184, 160, 136, 112, 92,
    },
...
static const struct tidss_scale_coefs coef3_m12 = {
  .c1
    = { 64, 50, 36, 26, 16, 10, 4, 130, 256, 230, 204, 178, 152, 128, 104, 84,
    },
