...
static enum drm_mode_status malidp_mw_connector_mode_valid(
...
static enum drm_connector_status malidp_mw_connector_detect(
...
static struct drm_connector_state *malidp_mw_connector_duplicate_state(
    struct drm_connector *connector) {
...
static int malidp_mw_encoder_atomic_check(struct drm_encoder *encoder,
