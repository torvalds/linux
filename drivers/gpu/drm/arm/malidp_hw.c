...
static const struct malidp_format_id malidp500_de_formats[] = {
  ...
  { DRM_FORMAT_ARGB2101010,
    DE_VIDEO1 | DE_GRAPHICS1 | DE_GRAPHICS2 | SE_MEMWRITE, 0 },
  { DRM_FORMAT_ABGR2101010,
    DE_VIDEO1 | DE_GRAPHICS1 | DE_GRAPHICS2 | SE_MEMWRITE, 1 },
  { DRM_FORMAT_ARGB8888, DE_VIDEO1 | DE_GRAPHICS1 | DE_GRAPHICS2, 2 },
  { DRM_FORMAT_ABGR8888, DE_VIDEO1 | DE_GRAPHICS1 | DE_GRAPHICS2, 3 },
  { DRM_FORMAT_XRGB8888, DE_VIDEO1 | DE_GRAPHICS1 | DE_GRAPHICS2 | SE_MEMWRITE,
    4 },
  { DRM_FORMAT_XBGR8888, DE_VIDEO1 | DE_GRAPHICS1 | DE_GRAPHICS2 | SE_MEMWRITE,
    5 },
...
#define MALIDP_COMMON_FORMATS \
  /*    fourcc,   layers supporting the format,      internal id   */ \
  { DRM_FORMAT_ARGB2101010, DE_VIDEO1 | DE_GRAPHICS1 | DE_VIDEO2 | SE_MEMWRITE, \
    MALIDP_ID(0, 0) }, \
  { DRM_FORMAT_ABGR2101010, DE_VIDEO1 | DE_GRAPHICS1 | DE_VIDEO2 | SE_MEMWRITE, \
    MALIDP_ID(0, 1) }, \
  { DRM_FORMAT_RGBA1010102, DE_VIDEO1 | DE_GRAPHICS1 | DE_VIDEO2 | SE_MEMWRITE, \
    MALIDP_ID(0, 2) }, \
  { DRM_FORMAT_BGRA1010102, DE_VIDEO1 | DE_GRAPHICS1 | DE_VIDEO2 | SE_MEMWRITE, \
    MALIDP_ID(0, 3) }, \
  { DRM_FORMAT_ARGB8888, DE_VIDEO1 | DE_GRAPHICS1 | DE_VIDEO2 | DE_SMART, \
    MALIDP_ID(1, 0) }, \
  { DRM_FORMAT_ABGR8888, DE_VIDEO1 | DE_GRAPHICS1 | DE_VIDEO2 | DE_SMART, \
    MALIDP_ID(1, 1) }, \
  { DRM_FORMAT_RGBA8888, DE_VIDEO1 | DE_GRAPHICS1 | DE_VIDEO2 | DE_SMART, \
    MALIDP_ID(1, 2) }, \
  { DRM_FORMAT_BGRA8888, DE_VIDEO1 | DE_GRAPHICS1 | DE_VIDEO2 | DE_SMART, \
    MALIDP_ID(1, 3) }, \
  { DRM_FORMAT_XRGB8888, \
    DE_VIDEO1 | DE_GRAPHICS1 | DE_VIDEO2 | DE_SMART | SE_MEMWRITE, \
    MALIDP_ID(2, 0) }, \
  { DRM_FORMAT_XBGR8888, \
    DE_VIDEO1 | DE_GRAPHICS1 | DE_VIDEO2 | DE_SMART | SE_MEMWRITE, \
    MALIDP_ID(2, 1) }, \
  ...
  { DRM_FORMAT_BGRX8888, \
    DE_VIDEO1 | DE_GRAPHICS1 | DE_VIDEO2 | DE_SMART | SE_MEMWRITE, \
    MALIDP_ID(2, 3) }, \
  { DRM_FORMAT_RGB888, DE_VIDEO1 | DE_GRAPHICS1 | DE_VIDEO2 | SE_MEMWRITE, \
    MALIDP_ID(3, 0) }, \
  { DRM_FORMAT_BGR888, DE_VIDEO1 | DE_GRAPHICS1 | DE_VIDEO2 | SE_MEMWRITE, \
    MALIDP_ID(3, 1) }, \
...
static void malidp500_modeset(struct malidp_hw_device *hwdev,
...
static int malidp500_enable_memwrite(struct malidp_hw_device *hwdev,
  ...
  malidp_hw_setbits(hwdev, MALIDP_SCALE_ENGINE_EN,
  ...
  switch (num_planes) {
    case 2:
      malidp_hw_write(hwdev, lower_32_bits(
          addrs[1]), base + MALIDP_MW_P2_PTR_LOW);
      malidp_hw_write(hwdev, upper_32_bits(
          addrs[1]), base + MALIDP_MW_P2_PTR_HIGH);
      malidp_hw_write(hwdev, pitches[1], base + MALIDP_MW_P2_STRIDE);
      fallthrough;
    case 1:
      malidp_hw_write(hwdev, lower_32_bits(
          addrs[0]), base + MALIDP_MW_P1_PTR_LOW);
      malidp_hw_write(hwdev, upper_32_bits(
          addrs[0]), base + MALIDP_MW_P1_PTR_HIGH);
...
static void malidp550_modeset(struct malidp_hw_device *hwdev,
    struct videomode *mode) {
...
static int malidp550_enable_memwrite(struct malidp_hw_device *hwdev,
  ...
  malidp_hw_setbits(hwdev,
      MALIDP550_SE_MEMWRITE_ONESHOT | MALIDP_SE_MEMWRITE_EN,
