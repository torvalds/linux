...
enum rotation_features {
	ROTATE_NONE,		/* does yest support rotation at all */
...
struct malidp_hw {
	 ...
	 * after the end of the current buffer scayesut, and will igyesre
...
{
	/*
	 * only hardware that canyest do 8 bytes bus alignments have further
