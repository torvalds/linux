...
static bool malidp_verify_afbc_framebuffer_caps(struct drm_device *dev,
...
static bool malidp_verify_afbc_framebuffer_size(struct drm_device *dev,
...
static bool malidp_verify_afbc_framebuffer(struct drm_device *dev,
    struct drm_file *file,
    const struct drm_mode_fb_cmd2 *mode_cmd) {
...
static struct drm_framebuffer *malidp_fb_create(struct drm_device *dev,
    struct drm_file *file,
    const struct drm_mode_fb_cmd2 *mode_cmd) {
