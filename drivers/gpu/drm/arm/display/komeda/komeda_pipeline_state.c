...
static struct komeda_pipeline_state *komeda_pipeline_get_state(
...
struct komeda_pipeline_state *komeda_pipeline_get_old_state(
    struct komeda_pipeline *pipe,
    struct drm_atomic_state *state) {
  struct drm_private_state *priv_st;
...
static struct komeda_pipeline_state *komeda_pipeline_get_new_state(
    struct komeda_pipeline *pipe,
    struct drm_atomic_state *state) {
  struct drm_private_state *priv_st;
...
static struct komeda_pipeline_state *komeda_pipeline_get_state_and_set_crtc(
    struct komeda_pipeline *pipe,
    struct drm_atomic_state *state,
...
static struct komeda_component_state *komeda_component_get_state(
...
static struct komeda_component_state *komeda_component_get_old_state(
    struct komeda_component *c,
    struct drm_atomic_state *state) {
  struct drm_private_state *priv_st;
 ...
 */
static struct komeda_component_state *komeda_component_get_state_and_set_user(
    struct komeda_component *c,
    struct drm_atomic_state *state,
    void *user,
    struct drm_crtc *crtc) {
...
static void komeda_component_add_input(struct komeda_component_state *state,
...
static int komeda_component_check_input(struct komeda_component_state *state,
    struct komeda_component_output *input,
    int idx) {
  struct komeda_component *c = state->component;
...
static void komeda_component_set_output(struct komeda_component_output *output,
...
static int komeda_component_validate_private(struct komeda_component *c,
    struct komeda_component_state *st) {
  int err;
  if (!c->funcs->validate) {
    return 0;
...
static struct komeda_scaler *komeda_component_get_avail_scaler(
    struct komeda_component *c,
    struct drm_atomic_state *state) {
  struct komeda_pipeline_state *pipe_st;
  u32 avail_scalers;
...
static void komeda_rotate_data_flow(struct komeda_data_flow_cfg *dflow,
    u32 rot) {
...
static int komeda_layer_check_cfg(struct komeda_layer *layer,
...
static int komeda_layer_validate(struct komeda_layer *layer,
...
static int komeda_wb_layer_validate(struct komeda_layer *wb_layer,
...
static int komeda_scaler_check_cfg(struct komeda_scaler *scaler,
    struct komeda_crtc_state *kcrtc_st,
    struct komeda_data_flow_cfg *dflow) {
...
static int komeda_scaler_validate(void *user,
    struct komeda_crtc_state *kcrtc_st,
    struct komeda_data_flow_cfg *dflow) {
...
static int komeda_splitter_validate(struct komeda_splitter *splitter,
    struct drm_connector_state *conn_st,
    struct komeda_data_flow_cfg *dflow,
...
static int komeda_merger_validate(struct komeda_merger *merger,
    void *user,
    struct komeda_crtc_state *kcrtc_st,
...
static int komeda_compiz_set_input(struct komeda_compiz *compiz,
    struct komeda_crtc_state *kcrtc_st,
    struct komeda_data_flow_cfg *dflow) {
  struct drm_atomic_state *drm_st = kcrtc_st->base.state;
...
static int komeda_compiz_validate(struct komeda_compiz *compiz,
...
static int komeda_improc_validate(struct komeda_improc *improc,
    struct komeda_crtc_state *kcrtc_st,
    struct komeda_data_flow_cfg *dflow) {
...
static int komeda_timing_ctrlr_validate(struct komeda_timing_ctrlr *ctrlr,
    struct komeda_crtc_state *kcrtc_st,
    struct komeda_data_flow_cfg *dflow) {
  struct drm_crtc *crtc = kcrtc_st->base.crtc;
...
static int komeda_pipeline_unbound_components(struct komeda_pipeline *pipe,
