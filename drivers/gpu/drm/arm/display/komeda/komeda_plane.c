...
static int komeda_plane_init_data_flow(struct drm_plane_state *st,
 ...
 */
static int komeda_plane_atomic_check(struct drm_plane *plane,
 ...
 */
static void komeda_plane_atomic_update(struct drm_plane *plane,
    struct drm_atomic_state *state) {
}
...
static struct drm_plane_state *komeda_plane_atomic_duplicate_state(
...
static void komeda_plane_atomic_destroy_state(struct drm_plane *plane,
...
static void komeda_set_crtc_plane_mask(struct komeda_kms_dev *kms,
    struct komeda_pipeline *pipe,
    struct drm_plane *plane) {
