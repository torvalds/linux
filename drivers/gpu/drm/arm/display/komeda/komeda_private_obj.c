...
static void komeda_component_state_reset(struct komeda_component_state *st) {
...
static struct drm_private_state *komeda_layer_atomic_duplicate_state(
...
static void komeda_layer_atomic_destroy_state(struct drm_private_obj *obj,
...
static struct drm_private_state *komeda_scaler_atomic_duplicate_state(
    struct drm_private_obj *obj) {
...
static void komeda_scaler_atomic_destroy_state(struct drm_private_obj *obj,
    struct drm_private_state *state) {
...
static struct drm_private_state *komeda_compiz_atomic_duplicate_state(
    struct drm_private_obj *obj) {
...
static void komeda_compiz_atomic_destroy_state(struct drm_private_obj *obj,
    struct drm_private_state *state) {
...
static struct drm_private_state *komeda_splitter_atomic_duplicate_state(
    struct drm_private_obj *obj) {
...
static void komeda_splitter_atomic_destroy_state(struct drm_private_obj *obj,
    struct drm_private_state *state) {
...
static struct drm_private_state *komeda_merger_atomic_duplicate_state(
    struct drm_private_obj *obj) {
...
static struct drm_private_state *komeda_improc_atomic_duplicate_state(
    struct drm_private_obj *obj) {
...
static void komeda_improc_atomic_destroy_state(struct drm_private_obj *obj,
    struct drm_private_state *state) {
...
static struct drm_private_state *komeda_timing_ctrlr_atomic_duplicate_state(
    struct drm_private_obj *obj) {
...
static void komeda_timing_ctrlr_atomic_destroy_state(
    struct drm_private_obj *obj,
    struct drm_private_state *state) {
...
static struct drm_private_state *komeda_pipeline_atomic_duplicate_state(
    struct drm_private_obj *obj) {
...
static void komeda_pipeline_atomic_destroy_state(struct drm_private_obj *obj,
    struct drm_private_state *state) {
