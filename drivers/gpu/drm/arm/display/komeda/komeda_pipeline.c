...
static struct komeda_component **komeda_pipeline_get_component_pos(
...
static struct komeda_component *komeda_component_pickup_input(
...
static struct komeda_layer *komeda_get_layer_split_right_layer(
    struct komeda_pipeline *pipe,
