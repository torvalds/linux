...
static int komeda_wb_init_data_flow(struct komeda_layer *wb_layer,
...
static int komeda_wb_encoder_atomic_check(struct drm_encoder *encoder,
...
static int komeda_wb_connector_get_modes(struct drm_connector *connector) {
  return 0;
}

static enum drm_mode_status komeda_wb_connector_mode_valid(
...
static enum drm_connector_status komeda_wb_connector_detect(
    struct drm_connector *connector, bool force) {
  return connector_status_connected;
}

static int komeda_wb_connector_fill_modes(struct drm_connector *connector,
