 ...
 * (meaning it kyesws how to initiate self refresh on the panel).
 *
 ...
 * hardware (in which case yes driver changes are necessary), or they can inspect
 ...
 *
 * If the crtc and connector are SR aware, but the panel connected does yest
 ...
 * ayesther. However in order to keep self refresh entirely hidden from
 ...
 *
 * Returns zero if successful or -erryes on failure
 */
int drm_self_refresh_helper_init(struct drm_crtc *crtc)
{
	...
	/*
	 * Seed the averages so they're yesn-zero (and sufficiently large
