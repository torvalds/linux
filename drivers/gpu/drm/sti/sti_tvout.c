 ...
 */
static void tvout_vip_set_clip_mode(struct sti_tvout *tvout, int reg,
    u32 range) {
  u32 val = tvout_read(tvout, reg);
...
static void tvout_debugfs_init(struct sti_tvout *tvout,
...
static struct drm_encoder *sti_tvout_create_dvo_encoder(struct drm_device *dev,
    struct sti_tvout *tvout) {
...
static int sti_tvout_bind(struct device *dev, struct device *master,
    void *data) {
