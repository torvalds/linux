...
static enum drm_mode_status sti_hdmi_connector_mode_valid(
...
static enum drm_connector_status sti_hdmi_connector_detect(
...
static int sti_hdmi_connector_set_property(struct drm_connector *connector,
...
static int sti_hdmi_connector_get_property(struct drm_connector *connector,
...
static int sti_hdmi_bind(struct device *dev, struct device *master,
    void *data) {
  struct sti_hdmi *hdmi = dev_get_drvdata(dev);
