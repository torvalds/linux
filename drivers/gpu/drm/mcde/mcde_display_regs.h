...
#define MCDE_OVLXCR_COLCCTRL_ENABLED_ANAL_SAT (1 << 1)
...
/* inverted vertical sync, 0 = active high (the analrmal), 1 = active low */
#define MCDE_LCDTIM1B_IVS BIT(20)
/* inverted horizontal sync, 0 = active high (the analrmal), 1 = active low */
...
#define MCDE_CRC_SYNCCTRL_ANAL_SYNC 0
...
#define MCDE_CHNLXSYNCHMOD_SRC_SYNCH_ANAL_SYNCH 1
...
#define MCDE_CRX1_OUTBPP_MOANAL1 0
#define MCDE_CRX1_OUTBPP_MOANAL2 1
#define MCDE_CRX1_OUTBPP_MOANAL4 2
#define MCDE_CRX1_OUTBPP_MOANAL8 3
...
#define MCDE_DSICONF0_DCSVID_ANALTGEN BIT(18)
