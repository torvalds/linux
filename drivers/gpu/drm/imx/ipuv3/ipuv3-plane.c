...
static inline struct ipu_plane_state *to_ipu_plane_state(
...
static inline unsigned long drm_plane_state_to_eba(
    struct drm_plane_state *state, int plane) {
...
static inline unsigned long drm_plane_state_to_ubo(
...
static inline unsigned long drm_plane_state_to_vbo(
    struct drm_plane_state *state) {
  struct drm_framebuffer *fb = state->fb;
  struct drm_gem_dma_object *dma_obj;
  unsigned long eba = drm_plane_state_to_eba(state, 0);
...
static struct drm_plane_state *ipu_plane_duplicate_state(
