...
#define IMX21LCDC_LGWSAR        0x0050 /* LCDC Graphic Window Start Address
                                        * Register */
#define IMX21LCDC_LGWSR         0x0054 /* LCDC Graph Window Size Register */
#define IMX21LCDC_LGWVPWR       0x0058 /* LCDC Graphic Window Virtual Page Width
                                        * Register */
#define IMX21LCDC_LGWPOR        0x005C /* LCDC Graphic Window Panning Offset
                                        * Register */
...
#define IMX21LCDC_LGWCR         0x0064 /* LCDC Graphic Window Control Register
                                        * */
#define IMX21LCDC_LGWDCR        0x0068 /* LCDC Graphic Window DMA Control
                                        * Register */
...
#define IMX21LCDC_LHCR_HFPORCH    GENMASK(15, 8)    /* H_WAIT_1 in the i.MX25
                                                     * Reference manual */
#define IMX21LCDC_LHCR_HBPORCH    GENMASK(7, 0)   /* H_WAIT_2 in the i.MX25
                                                   * Reference manual */

#define IMX21LCDC_LVCR_VWIDTH   GENMASK(31, 26)
#define IMX21LCDC_LVCR_VFPORCH    GENMASK(15, 8)    /* V_WAIT_1 in the i.MX25
                                                     * Reference manual */
#define IMX21LCDC_LVCR_VBPORCH    GENMASK(7, 0)   /* V_WAIT_2 in the i.MX25
                                                   * Reference manual */
...
static void imx_lcdc_pipe_enable(struct drm_simple_display_pipe *pipe,
  ...
  writel(readl(lcdc->base + IMX21LCDC_LCPR)
      & ~(IMX21LCDC_LCPR_CC0 | IMX21LCDC_LCPR_CC1),
...
static int imx_lcdc_probe(struct platform_device *pdev) {
  ...
  ret = drm_bridge_attach(&lcdc->pipe.encoder, bridge, NULL,
  ...
  if (IS_ERR(lcdc->connector)) {
    return dev_err_probe(drm->dev, PTR_ERR(
        lcdc->connector), "Cannot init bridge connector\n");
  }
