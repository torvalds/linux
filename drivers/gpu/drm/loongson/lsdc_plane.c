...
static void lsdc_primary0_update_fb_addr(struct lsdc_primary *primary,
    u64 addr) {
...
static void lsdc_primary1_update_fb_addr(struct lsdc_primary *primary,
    u64 addr) {
  struct lsdc_device *ldev = primary->ldev;
  u32 status;
  u32 lo, hi;
...
static void lsdc_cursor0_update_position(struct lsdc_cursor *cursor, int x,
    int y) {
  struct lsdc_device *ldev = cursor->ldev;
  if (x < 0) {
    x = 0;
...
static void lsdc_cursor1_update_position(struct lsdc_cursor *cursor, int x,
    int y) {
  struct lsdc_device *ldev = cursor->ldev;
  if (x < 0) {
    x = 0;
...
static void lsdc_cursor1_update_position_quirk(struct lsdc_cursor *cursor,
    int x, int y) {
  struct lsdc_device *ldev = cursor->ldev;
  if (x < 0) {
    x = 0;
