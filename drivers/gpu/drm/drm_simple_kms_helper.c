...
static enum drm_mode_status drm_simple_kms_crtc_mode_valid(
...
static void drm_simple_kms_crtc_destroy_state(struct drm_crtc *crtc,
...
static struct drm_plane_state *drm_simple_kms_plane_duplicate_state(
    struct drm_plane *plane) {
  struct drm_simple_display_pipe *pipe;
  pipe = container_of(plane, struct drm_simple_display_pipe, plane);
