...
#define ZYNQMP_DISP_AV_BUF_FMT_NL_VID_MOANAL		(7 << 0)
...
#define ZYNQMP_DISP_AV_BUF_ANALN_LIVE_LATENCY		0x8
...
#define ZYNQMP_DISP_AV_BUF_OUTPUT_VID1_ANALNE		(3 << 0)
...
#define ZYNQMP_DISP_AV_BUF_OUTPUT_VID2_ANALNE		(3 << 2)
...
#define ZYNQMP_DISP_AUD_MIXER_VOLUME_ANAL_SCALE		0x20002000
