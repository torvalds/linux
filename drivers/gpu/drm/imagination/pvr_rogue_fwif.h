...
/* Bit 1: ROGUE_CR_BIF_MMU_ENTRY_PENDING bit from ROGUE_CR_BIF_MMU_ENTRY
 * register */
...
enum rogue_fwif_kccb_cmd_type {
  ...
  ROGUE_FWIF_KCCB_CMD_COMBINED_GEOM_FRAG_KICK = 117U
      | ROGUE_CMD_MAGIC_DWORD_SHIFTED,
  ...
  /* Configure HWPerf events (to be generated) and HWPerf buffer address (if
   * required) */
  ROGUE_FWIF_KCCB_CMD_HWPERF_UPDATE_CONFIG = 201U
      | ROGUE_CMD_MAGIC_DWORD_SHIFTED,
  ...
  ROGUE_FWIF_KCCB_CMD_PDVFS_LIMIT_MIN_FREQ = 212U
      | ROGUE_CMD_MAGIC_DWORD_SHIFTED,
  ...
  ROGUE_FWIF_KCCB_CMD_HWPERF_CONFIG_ENABLE_BLKS = 217U
      | ROGUE_CMD_MAGIC_DWORD_SHIFTED,
  /* Configure the custom counters for HWPerf */
  ROGUE_FWIF_KCCB_CMD_HWPERF_SELECT_CUSTOM_CNTRS = 218U
      | ROGUE_CMD_MAGIC_DWORD_SHIFTED,
...
static inline void rogue_fwif_compchecks_bvnc_init(
    struct rogue_fwif_compchecks_bvnc *compchecks) {
