...
struct pvr_free_list {
  ...
  /**
   * @lock: Mutex protecting modification of the free list. Must be held when
   *accessing any
...
static __always_inline struct pvr_free_list *pvr_free_list_get(
    struct pvr_free_list *free_list) {
  if (free_list) {
 ...
 */
static __always_inline struct pvr_free_list *pvr_free_list_lookup(
 ...
 */
static __always_inline struct pvr_free_list *pvr_free_list_lookup_id(
