...
/*
 * When adding new parameters to the stream definition, the new parameters must
 *go after the
 * existing parameters, to preserve order. As parameters are naturally aligned,
 *care must be taken
 * with respect to implicit padding in the stream; padding should be minimised
 *as much as possible.
 */
static const struct pvr_stream_def rogue_fwif_cmd_geom_stream[] = {
  ...
  PVR_STREAM_DEF_FEATURE(rogue_fwif_cmd_geom,
      regs.vdm_context_resume_task3_size, 32,
...
static const struct pvr_stream_def rogue_fwif_cmd_compute_stream[] = {
  ...
  PVR_STREAM_DEF_FEATURE(rogue_fwif_cmd_compute, regs.cdm_cb, 64,
      PVR_FEATURE_CDM_USER_MODE_QUEUE),
  PVR_STREAM_DEF_NOT_FEATURE(rogue_fwif_cmd_compute, regs.cdm_ctrl_stream_base,
      64,
      PVR_FEATURE_CDM_USER_MODE_QUEUE),
...
static const struct pvr_stream_def
    rogue_fwif_static_compute_context_state_stream[] = {
  ...
  PVR_STREAM_DEF(rogue_fwif_cdm_registers_cswitch, cdmreg_cdm_terminate_pds,
      64),
  PVR_STREAM_DEF(rogue_fwif_cdm_registers_cswitch, cdmreg_cdm_terminate_pds1,
      64),
  PVR_STREAM_DEF(rogue_fwif_cdm_registers_cswitch, cdmreg_cdm_resume_pds0, 64),
  PVR_STREAM_DEF(rogue_fwif_cdm_registers_cswitch, cdmreg_cdm_context_pds0_b,
      64),
  PVR_STREAM_DEF(rogue_fwif_cdm_registers_cswitch, cdmreg_cdm_resume_pds0_b,
      64),
};
