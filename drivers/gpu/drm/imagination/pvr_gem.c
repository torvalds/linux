...
static int pvr_gem_mmap(struct drm_gem_object *gem_obj,
 ...
 *  * %false otherwise.
 */
static bool pvr_gem_object_flags_validate(u64 flags) {
 ...
 *    pvr_gem_object_vmap()).
 */
static int pvr_gem_object_zero(struct pvr_gem_object *pvr_obj) {
  void *cpu_ptr;
