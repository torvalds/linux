...
/**
 * pvr_cccb_get_size_of_cmd_with_hdr() - Get the size of a command and its
 *header.
 * @cmd_size: Command size.
 *
 * Returns the size of the command and its header.
 */
static __always_inline u32 pvr_cccb_get_size_of_cmd_with_hdr(u32 cmd_size) {
 ...
 *  * false otherwise.
 */
static __always_inline bool pvr_cccb_cmdseq_can_fit(struct pvr_cccb *pvr_cccb,
    size_t size) {
