 ...
 *independent control is
 * provided in both X & Y axis.
 * This register needs to be set based on the ISP Samples Per Pixel a core
 *supports.
 *
...
/* Y2
 * Indicates 4xmsaa when X2 and Y2 are set to 1. This does not affect TE and is
 *only used within
 * TPW.
 */
 ...
 * X1 MacroTile boundary, left tile X for second column of macrotiles (16MT
 *mode) - 32 pixels across
 * tile
 */
#define ROGUE_CR_TE_MTILE1_X1_SHIFT 18
#define ROGUE_CR_TE_MTILE1_X1_CLRMSK 0xF803FFFF
/* X2 default: 0x00000008
 * X2 MacroTile boundary, left tile X for third(16MT) column of macrotiles - 32
 *pixels across tile
 */
#define ROGUE_CR_TE_MTILE1_X2_SHIFT 9U
#define ROGUE_CR_TE_MTILE1_X2_CLRMSK 0xFFFC01FF
/* X3 default: 0x0000000c
 * X3 MacroTile boundary, left tile X for fourth column of macrotiles (16MT) -
 *32 pixels across tile
 */
 ...
 * X1 MacroTile boundary, ltop tile Y for second column of macrotiles (16MT
 *mode) - 32 pixels tile
 * height
 */
 ...
 * X2 MacroTile boundary, top tile Y for third(16MT) column of macrotiles - 32
 *pixels tile height
 */
#define ROGUE_CR_TE_MTILE2_Y2_SHIFT 9
#define ROGUE_CR_TE_MTILE2_Y2_CLRMSK 0xFFFC01FF
/* Y3 default: 0x0000000c
 * X3 MacroTile boundary, top tile Y for fourth column of macrotiles (16MT) - 32
 *pixels tile height
 */
 ...
 * Maximum Y tile address visible on screen, 32 pixel tile height, 16Kx16K max
 *screen size
 */
#define ROGUE_CR_TE_SCREEN_YMAX_SHIFT 12
#define ROGUE_CR_TE_SCREEN_YMAX_CLRMSK 0xFFE00FFF
/* XMAX default: 0x00000010
 * Maximum X tile address visible on screen, 32 pixel tile width, 16Kx16K max
 *screen size
 */
 ...
 * In order to perform the tiling operation and generate the display list the
 *maximum screen size
 * must be configured in terms of the number of pixels in X & Y axis since this
 *may not be the same
