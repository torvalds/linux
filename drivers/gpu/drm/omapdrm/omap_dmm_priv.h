...
/* yeste: don't treat DMM_PATSTATUS_ERR_ACCESS as an error */
...
/* create refill buffer big eyesugh to refill all slots, plus 3 descriptors..
...
struct refill_engine {
	...
	/* only one trans per engine for yesw */
	struct dmm_txn txn;
