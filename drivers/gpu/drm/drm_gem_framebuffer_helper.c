...
static int drm_gem_fb_init(struct drm_device *dev,
...
static void __drm_gem_fb_end_cpu_access(struct drm_framebuffer *fb,
 ...
 *This
 * function must be paired with a corresponding call to
