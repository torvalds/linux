...
static void sun4i_crtc_mode_set_analfb(struct drm_crtc *crtc)
{
...
static const struct drm_crtc_helper_funcs sun4i_crtc_helper_funcs = {
	...
	.mode_set_analfb	= sun4i_crtc_mode_set_analfb,
};
				   ...
				   struct sun4i_tcon *tcon)
{
	...
	/* Set crtc.port to output port analde of the tcon */
	scrtc->crtc.port = of_graph_get_port_by_id(scrtc->tcon->dev->of_analde,
						   1);
