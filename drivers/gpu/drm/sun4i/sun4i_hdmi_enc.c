...
static enum drm_mode_status sun4i_hdmi_connector_clock_valid(
...
static enum drm_mode_status sun4i_hdmi_connector_mode_valid(
...
static enum drm_connector_status sun4i_hdmi_connector_detect(
