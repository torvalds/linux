 ...
 */
static inline void sunxi_engine_commit(struct sunxi_engine *engine) {
 ...
 * @engine: pointer to the engine
 */
static inline struct drm_plane **sunxi_engine_layers_init(
 ...
 */
static inline void sunxi_engine_apply_color_correction(
    struct sunxi_engine *engine) {
 ...
 */
static inline void sunxi_engine_disable_color_correction(
    struct sunxi_engine *engine) {
 ...
 */
static inline void sunxi_engine_mode_set(struct sunxi_engine *engine,
    const struct drm_display_mode *mode) {
