...
#define SUN4I_TCON0_CTL_CLK_DELAY(delay)    ((delay << \
      4) & SUN4I_TCON0_CTL_CLK_DELAY_MASK)
...
#define SUN4I_TCON1_CTL_CLK_DELAY(delay)    ((delay << \
      4) & SUN4I_TCON1_CTL_CLK_DELAY_MASK)
...
#define SUN4I_TCON0_CPU_TRI0_BLOCK_SPACE(space)   ((((space) - 1) & 0xfff) << \
      16)
...
struct sun4i_tcon_quirks {
  ...
  bool has_lvds_alt; /* Does the LVDS clock have a parent other than the TCON
                      * clock? */
  bool needs_de_be_mux; /* sun6i needs mux to select backend */
  bool needs_edp_reset; /* a80 edp reset needed for tcon0 access */
  bool supports_lvds;   /* Does the TCON support an LVDS output? */
  bool polarity_in_ch0; /* some tcon1 channels have polarity bits in tcon0 pol
                         * register */
