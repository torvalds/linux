...
static struct drm_framebuffer *mtk_drm_mode_fb_create(struct drm_device *dev,
...
static int mtk_drm_probe(struct platform_device *pdev) {
  ...
  for_each_child_of_node(phandle->parent, node) {
    ...
    /*
     * Currently only the AAL, CCORR, COLOR, GAMMA, MERGE, OVL, RDMA, DSI, and
     *DPI
