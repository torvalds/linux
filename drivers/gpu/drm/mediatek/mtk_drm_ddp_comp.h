...
static inline bool mtk_ddp_comp_remove(struct mtk_ddp_comp *comp,
    struct mtk_mutex *mutex) {
...
static inline bool mtk_ddp_comp_connect(struct mtk_ddp_comp *comp,
...
static inline bool mtk_ddp_comp_disconnect(struct mtk_ddp_comp *comp,
    struct device *mmsys_dev,
    unsigned int next) {
