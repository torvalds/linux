...
#define DISP_REG_OVL_HDR_PITCH(ovl, \
      n)    ((ovl)->data->addr + 0x20 * (n) + 0x08)
...
static void mtk_ovl_set_afbc(struct mtk_disp_ovl *ovl,
...
void mtk_ovl_layer_config(struct device *dev, unsigned int idx,
  ...
  mtk_ddp_write_relaxed(cmdq_pkt, overlay_pitch.split_pitch.lsb, &ovl->cmdq_reg,
      ovl->regs,
