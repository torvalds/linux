...
static void mtk_hdmi_hw_enable_notice(struct mtk_hdmi *hdmi,
    bool enable_notice) {
...
static enum drm_mode_status mtk_hdmi_bridge_mode_valid(
    struct drm_bridge *bridge,
...
static enum drm_connector_status mtk_hdmi_bridge_detect(
    struct drm_bridge *bridge) {
  struct mtk_hdmi *hdmi = hdmi_ctx_from_bridge(bridge);
  return mtk_hdmi_detect(hdmi);
}

static const struct drm_edid *mtk_hdmi_bridge_edid_read(
    struct drm_bridge *bridge,
...
static int mtk_hdmi_audio_mute(struct device *dev, void *data,
