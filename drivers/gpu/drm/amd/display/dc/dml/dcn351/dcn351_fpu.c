...
struct _vcs_dpi_ip_params_st dcn3_51_ip = {
  ...
  .dcc_supported = true,
  //  .config_return_buffer_segment_size_in_kbytes = 64;/*required, hard coded
  // in dml2_translate_ip_params*/
};
...
void dcn351_update_bw_bounding_box_fpu(struct dc *dc,
  ...
  if (dc->bb_overrides.sr_exit_z8_time_ns > 0) {
    dcn3_51_soc.sr_exit_z8_time_us = dc->bb_overrides.sr_exit_z8_time_ns
        / 1000.0;
  }
  ...
  dc->dml2_options.bbox_overrides.sr_exit_latency_us
    = dcn3_51_soc.sr_exit_time_us;
  dc->dml2_options.bbox_overrides.sr_enter_plus_exit_latency_us
    = dcn3_51_soc.sr_enter_plus_exit_time_us;
  dc->dml2_options.bbox_overrides.sr_exit_z8_time_us
    = dcn3_51_soc.sr_exit_z8_time_us;
  dc->dml2_options.bbox_overrides.sr_enter_plus_exit_z8_time_us
    = dcn3_51_soc.sr_enter_plus_exit_z8_time_us;
}
...
void dcn351_decide_zstate_support(struct dc *dc, struct dc_state *context) {
  ...
  if (context->stream_count == 0 || plane_count == 0) {
    ...
    /*for psr1/psr-su, we allow z8 and z10 based on latency, for replay with IPS
     * enabled, it will enter ips2*/
