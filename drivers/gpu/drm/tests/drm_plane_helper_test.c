...
static void check_src_eq(struct kunit *test,
...
static void check_crtc_eq(struct kunit *test,
    struct drm_plane_state *plane_state,
...
static void drm_test_check_plane_state(struct kunit *test) {
  ...
  check_src_eq(test, plane_state, params->src_expected.x,
      params->src_expected.y,
      params->src_expected.w, params->src_expected.h);
  check_crtc_eq(test, plane_state, params->crtc_expected.x,
      params->crtc_expected.y,
      params->crtc_expected.w, params->crtc_expected.h);
}

static void drm_check_plane_state_desc(
    const struct drm_check_plane_state_test *t,
    char *desc) {
...
KUNIT_ARRAY_PARAM(drm_check_plane_state, drm_check_plane_state_tests,
...
static const struct drm_check_plane_state_test
    drm_check_invalid_plane_state_tests[] = {
  {
...
KUNIT_ARRAY_PARAM(drm_check_invalid_plane_state,
    drm_check_invalid_plane_state_tests,
    drm_check_plane_state_desc);

static struct kunit_case drm_plane_helper_test[] = {
  KUNIT_CASE_PARAM(drm_test_check_plane_state,
      drm_check_plane_state_gen_params),
