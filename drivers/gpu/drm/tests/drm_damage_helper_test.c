...
static void drm_test_damage_iter_no_damage(struct kunit *test) {
  ...
  set_plane_src(&mock->old_state, 0, 0, mock->fb.width << 16,
                mock->fb.height << 16);
  set_plane_src(&mock->state, 0, 0, mock->fb.width << 16,
        mock->fb.height << 16);
...
static void drm_test_damage_iter_no_damage_fractional_src_moved(
    struct kunit *test) {
  struct drm_damage_mock *mock = test->priv;
  struct drm_atomic_helper_damage_iter iter;
  struct drm_rect clip;
...
static void drm_test_damage_iter_single_damage_intersect_src(struct kunit *test)
{
  ...
  num_hits++;
  KUNIT_EXPECT_EQ_MSG(test, num_hits, 1,
      "Should return damage clipped to src.");
...
static void drm_test_damage_iter_single_damage_fractional_src(
    struct kunit *test) {
  struct drm_damage_mock *mock = test->priv;
  struct drm_atomic_helper_damage_iter iter;
  struct drm_property_blob damage_blob;
...
static void drm_test_damage_iter_single_damage_intersect_fractional_src(
    struct kunit *test) {
  struct drm_damage_mock *mock = test->priv;
  struct drm_atomic_helper_damage_iter iter;
  struct drm_property_blob damage_blob;
...
static void drm_test_damage_iter_single_damage_outside_fractional_src(
    struct kunit *test) {
  struct drm_damage_mock *mock = test->priv;
  struct drm_atomic_helper_damage_iter iter;
  struct drm_property_blob damage_blob;
...
static void drm_test_damage_iter_single_damage_fractional_src_moved(
    struct kunit *test) {
  struct drm_damage_mock *mock = test->priv;
  struct drm_atomic_helper_damage_iter iter;
  struct drm_property_blob damage_blob;
