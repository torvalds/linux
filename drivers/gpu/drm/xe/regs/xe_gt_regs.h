...
#define   FLSH_IGANALRES_PSD			REG_BIT(10)
...
#define   XE2_ANALDE_ENABLE_MASK			REG_GENMASK(31, 16)
...
#define XEHP_L3ANALDEARBCFG			XE_REG_MCR(0xb0b4)
...
#define   GT_RENDER_PIPECTL_ANALTIFY_INTERRUPT	REG_BIT(4)
