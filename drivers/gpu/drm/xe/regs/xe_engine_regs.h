...
#define FF_SLICE_CS_CHICKEN2(base)    XE_REG((base) + 0xe4, \
    XE_REG_OPTION_MASKED)
...
#define   RING_FORCE_TO_NONPRIV_ACCESS_RW REG_FIELD_PREP( \
    RING_FORCE_TO_NONPRIV_ACCESS_MASK, 0)
#define   RING_FORCE_TO_NONPRIV_ACCESS_RD REG_FIELD_PREP( \
    RING_FORCE_TO_NONPRIV_ACCESS_MASK, 1)
#define   RING_FORCE_TO_NONPRIV_ACCESS_WR REG_FIELD_PREP( \
    RING_FORCE_TO_NONPRIV_ACCESS_MASK, 2)
#define   RING_FORCE_TO_NONPRIV_ACCESS_INVALID  REG_FIELD_PREP( \
    RING_FORCE_TO_NONPRIV_ACCESS_MASK, 3)
#define   RING_FORCE_TO_NONPRIV_ADDRESS_MASK  REG_GENMASK(25, 2)
#define   RING_FORCE_TO_NONPRIV_RANGE_MASK  REG_GENMASK(1, 0)
#define   RING_FORCE_TO_NONPRIV_RANGE_1   REG_FIELD_PREP( \
    RING_FORCE_TO_NONPRIV_RANGE_MASK, 0)
#define   RING_FORCE_TO_NONPRIV_RANGE_4   REG_FIELD_PREP( \
    RING_FORCE_TO_NONPRIV_RANGE_MASK, 1)
#define   RING_FORCE_TO_NONPRIV_RANGE_16  REG_FIELD_PREP( \
    RING_FORCE_TO_NONPRIV_RANGE_MASK, 2)
#define   RING_FORCE_TO_NONPRIV_RANGE_64  REG_FIELD_PREP( \
    RING_FORCE_TO_NONPRIV_RANGE_MASK, 3)
