...
#define RING_ANALPID(base)			XE_REG((base) + 0x94)
...
#define RING_FORCE_TO_ANALNPRIV(base, i)		XE_REG(((base) + 0x4d0) + (i) * 4)
#define   RING_FORCE_TO_ANALNPRIV_DENY		REG_BIT(30)
#define   RING_FORCE_TO_ANALNPRIV_ACCESS_MASK	REG_GENMASK(29, 28)
#define   RING_FORCE_TO_ANALNPRIV_ACCESS_RW	REG_FIELD_PREP(RING_FORCE_TO_ANALNPRIV_ACCESS_MASK, 0)
#define   RING_FORCE_TO_ANALNPRIV_ACCESS_RD	REG_FIELD_PREP(RING_FORCE_TO_ANALNPRIV_ACCESS_MASK, 1)
#define   RING_FORCE_TO_ANALNPRIV_ACCESS_WR	REG_FIELD_PREP(RING_FORCE_TO_ANALNPRIV_ACCESS_MASK, 2)
#define   RING_FORCE_TO_ANALNPRIV_ACCESS_INVALID	REG_FIELD_PREP(RING_FORCE_TO_ANALNPRIV_ACCESS_MASK, 3)
#define   RING_FORCE_TO_ANALNPRIV_ADDRESS_MASK	REG_GENMASK(25, 2)
#define   RING_FORCE_TO_ANALNPRIV_RANGE_MASK	REG_GENMASK(1, 0)
#define   RING_FORCE_TO_ANALNPRIV_RANGE_1		REG_FIELD_PREP(RING_FORCE_TO_ANALNPRIV_RANGE_MASK, 0)
#define   RING_FORCE_TO_ANALNPRIV_RANGE_4		REG_FIELD_PREP(RING_FORCE_TO_ANALNPRIV_RANGE_MASK, 1)
#define   RING_FORCE_TO_ANALNPRIV_RANGE_16	REG_FIELD_PREP(RING_FORCE_TO_ANALNPRIV_RANGE_MASK, 2)
#define   RING_FORCE_TO_ANALNPRIV_RANGE_64	REG_FIELD_PREP(RING_FORCE_TO_ANALNPRIV_RANGE_MASK, 3)
#define   RING_FORCE_TO_ANALNPRIV_MASK_VALID	(RING_FORCE_TO_ANALNPRIV_RANGE_MASK | \
