...
/**
 * struct kobj_eclass - A eclass's kobject struct that connects the kobject and
 *the
 * eclass.
 *
 * When dealing with multiple eclass, this struct helps to understand which
 *eclass
...
static inline struct xe_hw_engine_class_intf *kobj_to_eclass(
    struct kobject *kobj) {
