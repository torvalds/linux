...
#define GUC2PF_RELAY_FROM_VF_EVENT_MSG_MIN_LEN    (GUC_HXG_EVENT_MSG_MIN_LEN \
  + 2u)
 ...
 *
 * This H2G message is used by the Physical Function (PF) driver to send
 *embedded
...
#define PF2GUC_RELAY_TO_VF_REQUEST_MSG_MIN_LEN    (GUC_HXG_REQUEST_MSG_MIN_LEN \
  + 2u)
...
#define GUC2VF_RELAY_FROM_PF_EVENT_MSG_MIN_LEN    (GUC_HXG_EVENT_MSG_MIN_LEN \
  + 1u)
...
#define VF2GUC_RELAY_TO_PF_REQUEST_MSG_MIN_LEN    (GUC_HXG_REQUEST_MSG_MIN_LEN \
  + 1u)
