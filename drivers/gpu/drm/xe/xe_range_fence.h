...
struct xe_range_fence {
  ...
  /**
   * @cb: callback when fence signals to remove range fence free from interval
   *tree
   */
...
struct xe_range_fence *xe_range_fence_tree_first(
  struct xe_range_fence_tree *tree, u64 start,
  u64 last);

struct xe_range_fence *xe_range_fence_tree_next(struct xe_range_fence *rfence,
    u64 start, u64 last);
