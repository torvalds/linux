...
struct xe_pat_ops {
  void (*program_graphics)(struct xe_gt *gt,
      const struct xe_pat_table_entry table[],
      int n_entries);
  void (*program_media)(struct xe_gt *gt,
      const struct xe_pat_table_entry table[],
      int n_entries);
...
static void program_pat(struct xe_gt *gt,
    const struct xe_pat_table_entry table[],
    int n_entries) {
...
static void program_pat_mcr(struct xe_gt *gt,
    const struct xe_pat_table_entry table[],
    int n_entries) {
  for (int i = 0; i < n_entries; i++) {
...
static void xe2lpg_program_pat(struct xe_gt *gt,
    const struct xe_pat_table_entry table[],
    int n_entries) {
...
static void xe2lpm_program_pat(struct xe_gt *gt,
    const struct xe_pat_table_entry table[],
    int n_entries) {
