...
#define XE_HW_ENGINE_VCS_MASK GENMASK_ULL(XE_HW_ENGINE_VCS7, XE_HW_ENGINE_VCS0)
  ...
  XE_HW_ENGINE_VECS2,
  XE_HW_ENGINE_VECS3,
#define XE_HW_ENGINE_VECS_MASK  GENMASK_ULL(XE_HW_ENGINE_VECS3, \
      XE_HW_ENGINE_VECS0)
  XE_HW_ENGINE_CCS0,
  XE_HW_ENGINE_CCS1,
  XE_HW_ENGINE_CCS2,
...
#define XE_HW_ENGINE_CCS_MASK GENMASK_ULL(XE_HW_ENGINE_CCS3, XE_HW_ENGINE_CCS0)
  XE_HW_ENGINE_GSCCS0,
#define XE_HW_ENGINE_GSCCS_MASK GENMASK_ULL(XE_HW_ENGINE_GSCCS0, \
      XE_HW_ENGINE_GSCCS0)
  XE_NUM_HW_ENGINES,
};
...
struct xe_hw_engine_class_intf {
  ...
  struct {
    ...
    /** @sched_props.preempt_timeout_min: min preemption timeout in
     * micro-seconds */
    u32 preempt_timeout_min;
    /** @sched_props.preempt_timeout_max: max preemption timeout in
     * micro-seconds */
