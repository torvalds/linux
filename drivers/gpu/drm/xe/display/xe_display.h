...
static inline int xe_display_driver_probe_defer(struct pci_dev *pdev) {
  return 0;
}
...
static inline int xe_display_create(struct xe_device *xe) {
  return 0;
}
...
static inline int xe_display_init_nommio(struct xe_device *xe) {
  return 0;
}
...
static inline int xe_display_init_noaccel(struct xe_device *xe) {
  return 0;
}

static inline int xe_display_init(struct xe_device *xe) {
  return 0;
}
...
static inline void xe_display_irq_handler(struct xe_device *xe,
    u32 master_ctl) {
}

static inline void xe_display_irq_enable(struct xe_device *xe,
    u32 gu_misc_iir) {
}
