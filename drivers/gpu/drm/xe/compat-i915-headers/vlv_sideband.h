...
static inline void vlv_iosf_sb_get(struct drm_i915_private *i915,
    unsigned long ports) {
}

static inline u32 vlv_iosf_sb_read(struct drm_i915_private *i915, u8 port,
    u32 reg) {
  return 0;
}
...
static inline void vlv_iosf_sb_put(struct drm_i915_private *i915,
    unsigned long ports) {
}
...
static inline void vlv_bunit_write(struct drm_i915_private *i915, u32 reg,
    u32 val) {
}
...
static inline void vlv_cck_write(struct drm_i915_private *i915, u32 reg,
    u32 val) {
}
...
static inline void vlv_ccu_write(struct drm_i915_private *i915, u32 reg,
    u32 val) {
}
...
static inline u32 vlv_dpio_read(struct drm_i915_private *i915, int pipe,
    int reg) {
  return 0;
}
...
static inline void vlv_flisdsi_write(struct drm_i915_private *i915, u32 reg,
    u32 val) {
}
...
static inline int vlv_punit_write(struct drm_i915_private *i915, u32 addr,
    u32 val) {
  return 0;
}
