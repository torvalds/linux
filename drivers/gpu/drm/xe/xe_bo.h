...
struct xe_bo *___xe_bo_create_locked(struct xe_device *xe, struct xe_bo *bo,
    ...
    u32 flags);
struct xe_bo *xe_bo_create_locked_range(struct xe_device *xe,
...
struct xe_bo *xe_bo_create_pin_map(struct xe_device *xe, struct xe_tile *tile,
    struct xe_vm *vm, size_t size,
    enum ttm_bo_type type, u32 flags);
struct xe_bo *xe_bo_create_pin_map_at(struct xe_device *xe,
    struct xe_tile *tile,
...
int xe_managed_bo_reinit_in_vram(struct xe_device *xe, struct xe_tile *tile,
    struct xe_bo **src);
...
static inline dma_addr_t xe_bo_main_addr(struct xe_bo *bo, size_t page_size) {
  return xe_bo_addr(bo, 0, page_size);
}

static inline u32 xe_bo_ggtt_addr(struct xe_bo *bo) {
 ...
 * false otherwise.
 */
static inline bool xe_bo_put_deferred(struct xe_bo *bo,
