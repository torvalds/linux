 ...
 *for
 * each graphics device. Considering this, we need to add sysfs attributes at
 *device
 * level granularity.
...
static ssize_t vram_d3cold_threshold_show(struct device *dev,
...
static ssize_t vram_d3cold_threshold_store(struct device *dev,
