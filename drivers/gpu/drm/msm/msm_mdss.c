 ...
 *this data
 */
static const struct msm_mdss_data *msm_mdss_generate_mdp5_mdss_data(
...
static int mdp5_mdss_parse_clock(struct platform_device *pdev,
    struct clk_bulk_data **clocks) {
...
static struct msm_mdss *msm_mdss_init(struct platform_device *pdev,
  ...
  msm_mdss->mmio = devm_platform_ioremap_resource_byname(pdev,
      is_mdp5 ? "mdss_phys" : "mdss");
