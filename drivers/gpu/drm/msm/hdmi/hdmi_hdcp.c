...
static int msm_hdmi_hdcp_msleep(struct hdmi_hdcp_ctrl *hdcp_ctrl, u32 ms,
    u32 ev) {
  int rc;
...
static int msm_hdmi_hdcp_auth_part1_key_exchange(
...
static int msm_hdmi_hdcp_auth_part2_check_v_match(
    struct hdmi_hdcp_ctrl *hdcp_ctrl) {
  int rc = 0;
  struct hdmi *hdmi = hdcp_ctrl->hdmi;
  u32 link0_status;
