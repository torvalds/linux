...
static bool fw_block_mem(struct a6xx_gmu_bo *bo,
...
static void a6xx_gmu_set_initial_freq(struct msm_gpu *gpu,
    struct a6xx_gmu *gmu) {
...
int a6xx_gmu_init(struct a6xx_gpu *a6xx_gpu, struct device_node *node) {
  ...
  if (adreno_is_a650_family(adreno_gpu)
    ...
    /*
     * NOTE: when porting legacy ("pre-650-family") GPUs you may be tempted to
     *add a condition
     * to allocate icache/dcache here, as per downstream code flow, but it may
     *not actually be
     * necessary. If you omit this step and you don't get random pagefaults, you
     *are likely
