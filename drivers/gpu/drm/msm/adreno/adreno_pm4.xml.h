 ...
 *
 * - /home/robclark/src/mesa/mesa/src/freedreno/registers/adreno/adreno_pm4.xml
 *    (  85856 bytes, from Fri Feb 23 13:07:00 2024)
...
static inline uint32_t CP_LOAD_STATE_0_DST_OFF(uint32_t val) {
  return ((val) <<
      CP_LOAD_STATE_0_DST_OFF__SHIFT) & CP_LOAD_STATE_0_DST_OFF__MASK;
}
...
static inline uint32_t CP_LOAD_STATE_0_STATE_SRC(enum adreno_state_src val) {
  return ((val) <<
      CP_LOAD_STATE_0_STATE_SRC__SHIFT) & CP_LOAD_STATE_0_STATE_SRC__MASK;
}
...
{
  return ((val) <<
      CP_LOAD_STATE_0_STATE_BLOCK__SHIFT) & CP_LOAD_STATE_0_STATE_BLOCK__MASK;
}
...
static inline uint32_t CP_LOAD_STATE_0_NUM_UNIT(uint32_t val) {
  return ((val) <<
      CP_LOAD_STATE_0_NUM_UNIT__SHIFT) & CP_LOAD_STATE_0_NUM_UNIT__MASK;
}
...
static inline uint32_t CP_LOAD_STATE_1_STATE_TYPE(enum adreno_state_type val) {
  return ((val) <<
      CP_LOAD_STATE_1_STATE_TYPE__SHIFT) & CP_LOAD_STATE_1_STATE_TYPE__MASK;
}
...
static inline uint32_t CP_LOAD_STATE_1_EXT_SRC_ADDR(uint32_t val) {
  assert(!(val & 0x3));
  return (((val >> 2)) <<
      CP_LOAD_STATE_1_EXT_SRC_ADDR__SHIFT) & CP_LOAD_STATE_1_EXT_SRC_ADDR__MASK;
}
...
static inline uint32_t CP_LOAD_STATE4_0_DST_OFF(uint32_t val) {
  return ((val) <<
      CP_LOAD_STATE4_0_DST_OFF__SHIFT) & CP_LOAD_STATE4_0_DST_OFF__MASK;
}
...
static inline uint32_t CP_LOAD_STATE4_0_STATE_SRC(enum a4xx_state_src val) {
  return ((val) <<
      CP_LOAD_STATE4_0_STATE_SRC__SHIFT) & CP_LOAD_STATE4_0_STATE_SRC__MASK;
}
...
static inline uint32_t CP_LOAD_STATE4_0_STATE_BLOCK(enum a4xx_state_block val) {
  return ((val) <<
      CP_LOAD_STATE4_0_STATE_BLOCK__SHIFT) & CP_LOAD_STATE4_0_STATE_BLOCK__MASK;
}
...
static inline uint32_t CP_LOAD_STATE4_0_NUM_UNIT(uint32_t val) {
  return ((val) <<
      CP_LOAD_STATE4_0_NUM_UNIT__SHIFT) & CP_LOAD_STATE4_0_NUM_UNIT__MASK;
}
...
static inline uint32_t CP_LOAD_STATE4_1_STATE_TYPE(enum a4xx_state_type val) {
  return ((val) <<
      CP_LOAD_STATE4_1_STATE_TYPE__SHIFT) & CP_LOAD_STATE4_1_STATE_TYPE__MASK;
}
...
static inline uint32_t CP_LOAD_STATE6_0_DST_OFF(uint32_t val) {
  return ((val) <<
      CP_LOAD_STATE6_0_DST_OFF__SHIFT) & CP_LOAD_STATE6_0_DST_OFF__MASK;
}
...
static inline uint32_t CP_LOAD_STATE6_0_STATE_TYPE(enum a6xx_state_type val) {
  return ((val) <<
      CP_LOAD_STATE6_0_STATE_TYPE__SHIFT) & CP_LOAD_STATE6_0_STATE_TYPE__MASK;
}
...
static inline uint32_t CP_LOAD_STATE6_0_STATE_SRC(enum a6xx_state_src val) {
  return ((val) <<
      CP_LOAD_STATE6_0_STATE_SRC__SHIFT) & CP_LOAD_STATE6_0_STATE_SRC__MASK;
}
...
static inline uint32_t CP_LOAD_STATE6_0_STATE_BLOCK(enum a6xx_state_block val) {
  return ((val) <<
      CP_LOAD_STATE6_0_STATE_BLOCK__SHIFT) & CP_LOAD_STATE6_0_STATE_BLOCK__MASK;
}
...
static inline uint32_t CP_LOAD_STATE6_0_NUM_UNIT(uint32_t val) {
  return ((val) <<
      CP_LOAD_STATE6_0_NUM_UNIT__SHIFT) & CP_LOAD_STATE6_0_NUM_UNIT__MASK;
}
...
static inline uint32_t CP_DRAW_INDX_0_VIZ_QUERY(uint32_t val) {
  return ((val) <<
      CP_DRAW_INDX_0_VIZ_QUERY__SHIFT) & CP_DRAW_INDX_0_VIZ_QUERY__MASK;
}
...
static inline uint32_t CP_DRAW_INDX_1_PRIM_TYPE(enum pc_di_primtype val) {
  return ((val) <<
      CP_DRAW_INDX_1_PRIM_TYPE__SHIFT) & CP_DRAW_INDX_1_PRIM_TYPE__MASK;
}
...
static inline uint32_t CP_DRAW_INDX_1_SOURCE_SELECT(enum pc_di_src_sel val) {
  return ((val) <<
      CP_DRAW_INDX_1_SOURCE_SELECT__SHIFT) & CP_DRAW_INDX_1_SOURCE_SELECT__MASK;
}
...
static inline uint32_t CP_DRAW_INDX_1_VIS_CULL(enum pc_di_vis_cull_mode val) {
  return ((val) <<
      CP_DRAW_INDX_1_VIS_CULL__SHIFT) & CP_DRAW_INDX_1_VIS_CULL__MASK;
}
...
static inline uint32_t CP_DRAW_INDX_1_INDEX_SIZE(enum pc_di_index_size val) {
  return ((val) <<
      CP_DRAW_INDX_1_INDEX_SIZE__SHIFT) & CP_DRAW_INDX_1_INDEX_SIZE__MASK;
}
...
static inline uint32_t CP_DRAW_INDX_1_NUM_INSTANCES(uint32_t val) {
  return ((val) <<
      CP_DRAW_INDX_1_NUM_INSTANCES__SHIFT) & CP_DRAW_INDX_1_NUM_INSTANCES__MASK;
}
...
static inline uint32_t CP_DRAW_INDX_2_NUM_INDICES(uint32_t val) {
  return ((val) <<
      CP_DRAW_INDX_2_NUM_INDICES__SHIFT) & CP_DRAW_INDX_2_NUM_INDICES__MASK;
}
...
static inline uint32_t CP_DRAW_INDX_3_INDX_BASE(uint32_t val) {
  return ((val) <<
      CP_DRAW_INDX_3_INDX_BASE__SHIFT) & CP_DRAW_INDX_3_INDX_BASE__MASK;
}
...
static inline uint32_t CP_DRAW_INDX_4_INDX_SIZE(uint32_t val) {
  return ((val) <<
      CP_DRAW_INDX_4_INDX_SIZE__SHIFT) & CP_DRAW_INDX_4_INDX_SIZE__MASK;
}
...
static inline uint32_t CP_DRAW_INDX_2_0_VIZ_QUERY(uint32_t val) {
  return ((val) <<
      CP_DRAW_INDX_2_0_VIZ_QUERY__SHIFT) & CP_DRAW_INDX_2_0_VIZ_QUERY__MASK;
}
...
static inline uint32_t CP_DRAW_INDX_2_1_PRIM_TYPE(enum pc_di_primtype val) {
  return ((val) <<
      CP_DRAW_INDX_2_1_PRIM_TYPE__SHIFT) & CP_DRAW_INDX_2_1_PRIM_TYPE__MASK;
}
...
static inline uint32_t CP_DRAW_INDX_2_1_VIS_CULL(enum pc_di_vis_cull_mode val) {
  return ((val) <<
      CP_DRAW_INDX_2_1_VIS_CULL__SHIFT) & CP_DRAW_INDX_2_1_VIS_CULL__MASK;
}
...
static inline uint32_t CP_DRAW_INDX_2_1_INDEX_SIZE(enum pc_di_index_size val) {
  return ((val) <<
      CP_DRAW_INDX_2_1_INDEX_SIZE__SHIFT) & CP_DRAW_INDX_2_1_INDEX_SIZE__MASK;
}
...
static inline uint32_t CP_DRAW_INDX_2_2_NUM_INDICES(uint32_t val) {
  return ((val) <<
      CP_DRAW_INDX_2_2_NUM_INDICES__SHIFT) & CP_DRAW_INDX_2_2_NUM_INDICES__MASK;
}
...
static inline uint32_t CP_DRAW_INDX_OFFSET_0_VIS_CULL(
    enum pc_di_vis_cull_mode val) {
  return ((val) <<
...
static inline uint32_t CP_DRAW_INDX_OFFSET_0_INDEX_SIZE(
    enum a4xx_index_size val) {
  return ((val) <<
...
static inline uint32_t CP_DRAW_INDX_OFFSET_0_PATCH_TYPE(
    enum a6xx_patch_type val) {
  return ((val) <<
...
static inline uint32_t A4XX_CP_DRAW_INDIRECT_0_PRIM_TYPE(
    enum pc_di_primtype val) {
  return ((val) <<
...
static inline uint32_t A4XX_CP_DRAW_INDIRECT_0_SOURCE_SELECT(
    enum pc_di_src_sel val) {
  return ((val) <<
...
static inline uint32_t A4XX_CP_DRAW_INDIRECT_0_VIS_CULL(
    enum pc_di_vis_cull_mode val) {
  return ((val) <<
...
static inline uint32_t A4XX_CP_DRAW_INDIRECT_0_INDEX_SIZE(
    enum a4xx_index_size val) {
  return ((val) <<
...
static inline uint32_t A4XX_CP_DRAW_INDIRECT_0_PATCH_TYPE(
    enum a6xx_patch_type val) {
  return ((val) <<
...
static inline uint32_t A4XX_CP_DRAW_INDX_INDIRECT_0_PRIM_TYPE(
    enum pc_di_primtype val) {
  return ((val) <<
...
static inline uint32_t A4XX_CP_DRAW_INDX_INDIRECT_0_SOURCE_SELECT(
    enum pc_di_src_sel val) {
  return ((val) <<
...
static inline uint32_t A4XX_CP_DRAW_INDX_INDIRECT_0_VIS_CULL(
    enum pc_di_vis_cull_mode val) {
  return ((val) <<
...
static inline uint32_t A4XX_CP_DRAW_INDX_INDIRECT_0_INDEX_SIZE(
    enum a4xx_index_size val) {
  return ((val) <<
...
static inline uint32_t A4XX_CP_DRAW_INDX_INDIRECT_0_PATCH_TYPE(
    enum a6xx_patch_type val) {
  return ((val) <<
...
static inline uint32_t A6XX_CP_DRAW_INDIRECT_MULTI_0_PRIM_TYPE(
    enum pc_di_primtype val) {
  return ((val) <<
...
static inline uint32_t A6XX_CP_DRAW_INDIRECT_MULTI_0_VIS_CULL(
    enum pc_di_vis_cull_mode val) {
  return ((val) <<
...
static inline uint32_t A6XX_CP_DRAW_INDIRECT_MULTI_0_INDEX_SIZE(
    enum a4xx_index_size val) {
  return ((val) <<
...
static inline uint32_t A6XX_CP_DRAW_INDIRECT_MULTI_0_PATCH_TYPE(
    enum a6xx_patch_type val) {
  return ((val) <<
...
static inline uint32_t A6XX_CP_DRAW_INDIRECT_MULTI_1_OPCODE(
    enum a6xx_draw_indirect_opcode val) {
  return ((val) <<
...
static inline uint32_t CP_DRAW_AUTO_0_PRIM_TYPE(enum pc_di_primtype val) {
  return ((val) <<
      CP_DRAW_AUTO_0_PRIM_TYPE__SHIFT) & CP_DRAW_AUTO_0_PRIM_TYPE__MASK;
}
...
static inline uint32_t CP_DRAW_AUTO_0_SOURCE_SELECT(enum pc_di_src_sel val) {
  return ((val) <<
      CP_DRAW_AUTO_0_SOURCE_SELECT__SHIFT) & CP_DRAW_AUTO_0_SOURCE_SELECT__MASK;
}
...
static inline uint32_t CP_DRAW_AUTO_0_VIS_CULL(enum pc_di_vis_cull_mode val) {
  return ((val) <<
      CP_DRAW_AUTO_0_VIS_CULL__SHIFT) & CP_DRAW_AUTO_0_VIS_CULL__MASK;
}
...
static inline uint32_t CP_DRAW_AUTO_0_INDEX_SIZE(enum a4xx_index_size val) {
  return ((val) <<
      CP_DRAW_AUTO_0_INDEX_SIZE__SHIFT) & CP_DRAW_AUTO_0_INDEX_SIZE__MASK;
}
...
static inline uint32_t CP_DRAW_AUTO_0_PATCH_TYPE(enum a6xx_patch_type val) {
  return ((val) <<
      CP_DRAW_AUTO_0_PATCH_TYPE__SHIFT) & CP_DRAW_AUTO_0_PATCH_TYPE__MASK;
}
...
static inline uint32_t CP_DRAW_AUTO_1_NUM_INSTANCES(uint32_t val) {
  return ((val) <<
      CP_DRAW_AUTO_1_NUM_INSTANCES__SHIFT) & CP_DRAW_AUTO_1_NUM_INSTANCES__MASK;
}
...
static inline uint32_t CP_DRAW_PRED_SET_0_SRC(enum cp_draw_pred_src val) {
  return ((val) <<
      CP_DRAW_PRED_SET_0_SRC__SHIFT) & CP_DRAW_PRED_SET_0_SRC__MASK;
}
...
static inline uint32_t CP_DRAW_PRED_SET_0_TEST(enum cp_draw_pred_test val) {
  return ((val) <<
      CP_DRAW_PRED_SET_0_TEST__SHIFT) & CP_DRAW_PRED_SET_0_TEST__MASK;
}
...
static inline uint32_t CP_SET_DRAW_STATE__0_COUNT(uint32_t val) {
  return ((val) <<
      CP_SET_DRAW_STATE__0_COUNT__SHIFT) & CP_SET_DRAW_STATE__0_COUNT__MASK;
}
...
static inline uint32_t CP_SET_DRAW_STATE__1_ADDR_LO(uint32_t val) {
  return ((val) <<
      CP_SET_DRAW_STATE__1_ADDR_LO__SHIFT) & CP_SET_DRAW_STATE__1_ADDR_LO__MASK;
}
...
static inline uint32_t CP_SET_DRAW_STATE__2_ADDR_HI(uint32_t val) {
  return ((val) <<
      CP_SET_DRAW_STATE__2_ADDR_HI__SHIFT) & CP_SET_DRAW_STATE__2_ADDR_HI__MASK;
}
...
static inline uint32_t CP_SET_BIN_DATA5_0_VSC_SIZE(uint32_t val) {
  return ((val) <<
      CP_SET_BIN_DATA5_0_VSC_SIZE__SHIFT) & CP_SET_BIN_DATA5_0_VSC_SIZE__MASK;
}
...
static inline uint32_t CP_SET_BIN_DATA5_0_VSC_N(uint32_t val) {
  return ((val) <<
      CP_SET_BIN_DATA5_0_VSC_N__SHIFT) & CP_SET_BIN_DATA5_0_VSC_N__MASK;
}
...
static inline uint32_t CP_REG_TO_MEM_2_DEST_HI(uint32_t val) {
  return ((val) <<
      CP_REG_TO_MEM_2_DEST_HI__SHIFT) & CP_REG_TO_MEM_2_DEST_HI__MASK;
}
...
static inline uint32_t CP_MEM_TO_REG_2_SRC_HI(uint32_t val) {
  return ((val) <<
      CP_MEM_TO_REG_2_SRC_HI__SHIFT) & CP_MEM_TO_REG_2_SRC_HI__MASK;
}
...
static inline uint32_t CP_REG_TO_SCRATCH_0_REG(uint32_t val) {
  return ((val) <<
      CP_REG_TO_SCRATCH_0_REG__SHIFT) & CP_REG_TO_SCRATCH_0_REG__MASK;
}
...
static inline uint32_t CP_REG_TO_SCRATCH_0_SCRATCH(uint32_t val) {
  return ((val) <<
      CP_REG_TO_SCRATCH_0_SCRATCH__SHIFT) & CP_REG_TO_SCRATCH_0_SCRATCH__MASK;
}
...
static inline uint32_t CP_REG_TO_SCRATCH_0_CNT(uint32_t val) {
  return ((val) <<
      CP_REG_TO_SCRATCH_0_CNT__SHIFT) & CP_REG_TO_SCRATCH_0_CNT__MASK;
}
...
static inline uint32_t CP_SCRATCH_TO_REG_0_REG(uint32_t val) {
  return ((val) <<
      CP_SCRATCH_TO_REG_0_REG__SHIFT) & CP_SCRATCH_TO_REG_0_REG__MASK;
}
...
static inline uint32_t CP_SCRATCH_TO_REG_0_SCRATCH(uint32_t val) {
  return ((val) <<
      CP_SCRATCH_TO_REG_0_SCRATCH__SHIFT) & CP_SCRATCH_TO_REG_0_SCRATCH__MASK;
}
...
static inline uint32_t CP_SCRATCH_TO_REG_0_CNT(uint32_t val) {
  return ((val) <<
      CP_SCRATCH_TO_REG_0_CNT__SHIFT) & CP_SCRATCH_TO_REG_0_CNT__MASK;
}
...
static inline uint32_t CP_SCRATCH_WRITE_0_SCRATCH(uint32_t val) {
  return ((val) <<
      CP_SCRATCH_WRITE_0_SCRATCH__SHIFT) & CP_SCRATCH_WRITE_0_SCRATCH__MASK;
}
...
static inline uint32_t CP_MEM_WRITE_0_ADDR_LO(uint32_t val) {
  return ((val) <<
      CP_MEM_WRITE_0_ADDR_LO__SHIFT) & CP_MEM_WRITE_0_ADDR_LO__MASK;
}
...
static inline uint32_t CP_MEM_WRITE_1_ADDR_HI(uint32_t val) {
  return ((val) <<
      CP_MEM_WRITE_1_ADDR_HI__SHIFT) & CP_MEM_WRITE_1_ADDR_HI__MASK;
}
...
static inline uint32_t CP_COND_WRITE_0_FUNCTION(enum cp_cond_function val) {
  return ((val) <<
      CP_COND_WRITE_0_FUNCTION__SHIFT) & CP_COND_WRITE_0_FUNCTION__MASK;
}
...
static inline uint32_t CP_COND_WRITE_1_POLL_ADDR(uint32_t val) {
  return ((val) <<
      CP_COND_WRITE_1_POLL_ADDR__SHIFT) & CP_COND_WRITE_1_POLL_ADDR__MASK;
}
...
static inline uint32_t CP_COND_WRITE_4_WRITE_ADDR(uint32_t val) {
  return ((val) <<
      CP_COND_WRITE_4_WRITE_ADDR__SHIFT) & CP_COND_WRITE_4_WRITE_ADDR__MASK;
}
...
static inline uint32_t CP_COND_WRITE_5_WRITE_DATA(uint32_t val) {
  return ((val) <<
      CP_COND_WRITE_5_WRITE_DATA__SHIFT) & CP_COND_WRITE_5_WRITE_DATA__MASK;
}
...
static inline uint32_t CP_COND_WRITE5_0_FUNCTION(enum cp_cond_function val) {
  return ((val) <<
      CP_COND_WRITE5_0_FUNCTION__SHIFT) & CP_COND_WRITE5_0_FUNCTION__MASK;
}
...
static inline uint32_t CP_COND_WRITE5_7_WRITE_DATA(uint32_t val) {
  return ((val) <<
      CP_COND_WRITE5_7_WRITE_DATA__SHIFT) & CP_COND_WRITE5_7_WRITE_DATA__MASK;
}
...
static inline uint32_t CP_WAIT_MEM_GTE_0_RESERVED(uint32_t val) {
  return ((val) <<
      CP_WAIT_MEM_GTE_0_RESERVED__SHIFT) & CP_WAIT_MEM_GTE_0_RESERVED__MASK;
}
...
static inline uint32_t CP_WAIT_REG_MEM_0_FUNCTION(enum cp_cond_function val) {
  return ((val) <<
      CP_WAIT_REG_MEM_0_FUNCTION__SHIFT) & CP_WAIT_REG_MEM_0_FUNCTION__MASK;
}
...
static inline uint32_t CP_WAIT_REG_MEM_0_POLL(enum poll_memory_type val) {
  return ((val) <<
      CP_WAIT_REG_MEM_0_POLL__SHIFT) & CP_WAIT_REG_MEM_0_POLL__MASK;
}
...
static inline uint32_t CP_WAIT_REG_MEM_4_MASK(uint32_t val) {
  return ((val) <<
      CP_WAIT_REG_MEM_4_MASK__SHIFT) & CP_WAIT_REG_MEM_4_MASK__MASK;
}
...
static inline uint32_t CP_WAIT_TWO_REGS_0_REG0(uint32_t val) {
  return ((val) <<
      CP_WAIT_TWO_REGS_0_REG0__SHIFT) & CP_WAIT_TWO_REGS_0_REG0__MASK;
}
...
static inline uint32_t CP_WAIT_TWO_REGS_1_REG1(uint32_t val) {
  return ((val) <<
      CP_WAIT_TWO_REGS_1_REG1__SHIFT) & CP_WAIT_TWO_REGS_1_REG1__MASK;
}
...
static inline uint32_t CP_WAIT_TWO_REGS_2_REF(uint32_t val) {
  return ((val) <<
      CP_WAIT_TWO_REGS_2_REF__SHIFT) & CP_WAIT_TWO_REGS_2_REF__MASK;
}
...
static inline uint32_t CP_DISPATCH_COMPUTE_1_X(uint32_t val) {
  return ((val) <<
      CP_DISPATCH_COMPUTE_1_X__SHIFT) & CP_DISPATCH_COMPUTE_1_X__MASK;
}
...
static inline uint32_t CP_DISPATCH_COMPUTE_2_Y(uint32_t val) {
  return ((val) <<
      CP_DISPATCH_COMPUTE_2_Y__SHIFT) & CP_DISPATCH_COMPUTE_2_Y__MASK;
}
...
static inline uint32_t CP_DISPATCH_COMPUTE_3_Z(uint32_t val) {
  return ((val) <<
      CP_DISPATCH_COMPUTE_3_Z__SHIFT) & CP_DISPATCH_COMPUTE_3_Z__MASK;
}
...
static inline uint32_t CP_SET_RENDER_MODE_0_MODE(enum render_mode_cmd val) {
  return ((val) <<
      CP_SET_RENDER_MODE_0_MODE__SHIFT) & CP_SET_RENDER_MODE_0_MODE__MASK;
}
...
static inline uint32_t CP_EVENT_WRITE_0_EVENT(enum vgt_event_type val) {
  return ((val) <<
      CP_EVENT_WRITE_0_EVENT__SHIFT) & CP_EVENT_WRITE_0_EVENT__MASK;
}
...
static inline uint32_t CP_EVENT_WRITE_1_ADDR_0_LO(uint32_t val) {
  return ((val) <<
      CP_EVENT_WRITE_1_ADDR_0_LO__SHIFT) & CP_EVENT_WRITE_1_ADDR_0_LO__MASK;
}
...
static inline uint32_t CP_EVENT_WRITE_2_ADDR_0_HI(uint32_t val) {
  return ((val) <<
      CP_EVENT_WRITE_2_ADDR_0_HI__SHIFT) & CP_EVENT_WRITE_2_ADDR_0_HI__MASK;
}
...
static inline uint32_t CP_EVENT_WRITE7_0_EVENT(enum vgt_event_type val) {
  return ((val) <<
      CP_EVENT_WRITE7_0_EVENT__SHIFT) & CP_EVENT_WRITE7_0_EVENT__MASK;
}
...
static inline uint32_t CP_EVENT_WRITE7_0_WRITE_SRC(enum event_write_src val) {
  return ((val) <<
      CP_EVENT_WRITE7_0_WRITE_SRC__SHIFT) & CP_EVENT_WRITE7_0_WRITE_SRC__MASK;
}
...
static inline uint32_t CP_EVENT_WRITE7_0_WRITE_DST(enum event_write_dst val) {
  return ((val) <<
      CP_EVENT_WRITE7_0_WRITE_DST__SHIFT) & CP_EVENT_WRITE7_0_WRITE_DST__MASK;
}
...
static inline uint32_t EV_DST_ONCHIP_CP_EVENT_WRITE7_1_ONCHIP_ADDR_0(
    uint32_t val) {
  return ((val) <<
...
static inline uint32_t CP_EXEC_CS_1_NGROUPS_X(uint32_t val) {
  return ((val) <<
      CP_EXEC_CS_1_NGROUPS_X__SHIFT) & CP_EXEC_CS_1_NGROUPS_X__MASK;
}
...
static inline uint32_t CP_EXEC_CS_2_NGROUPS_Y(uint32_t val) {
  return ((val) <<
      CP_EXEC_CS_2_NGROUPS_Y__SHIFT) & CP_EXEC_CS_2_NGROUPS_Y__MASK;
}
...
static inline uint32_t CP_EXEC_CS_3_NGROUPS_Z(uint32_t val) {
  return ((val) <<
      CP_EXEC_CS_3_NGROUPS_Z__SHIFT) & CP_EXEC_CS_3_NGROUPS_Z__MASK;
}
...
static inline uint32_t A6XX_CP_SET_MARKER_0_MODE(enum a6xx_marker val) {
  return ((val) <<
      A6XX_CP_SET_MARKER_0_MODE__SHIFT) & A6XX_CP_SET_MARKER_0_MODE__MASK;
}
...
static inline uint32_t A6XX_CP_SET_MARKER_0_MARKER(enum a6xx_marker val) {
  return ((val) <<
      A6XX_CP_SET_MARKER_0_MARKER__SHIFT) & A6XX_CP_SET_MARKER_0_MARKER__MASK;
}
...
static inline uint32_t A6XX_CP_SET_PSEUDO_REG__1_LO(uint32_t val) {
  return ((val) <<
      A6XX_CP_SET_PSEUDO_REG__1_LO__SHIFT) & A6XX_CP_SET_PSEUDO_REG__1_LO__MASK;
}
...
static inline uint32_t A6XX_CP_SET_PSEUDO_REG__2_HI(uint32_t val) {
  return ((val) <<
      A6XX_CP_SET_PSEUDO_REG__2_HI__SHIFT) & A6XX_CP_SET_PSEUDO_REG__2_HI__MASK;
}
...
static inline uint32_t A6XX_CP_REG_TEST_0_REG(uint32_t val) {
  return ((val) <<
      A6XX_CP_REG_TEST_0_REG__SHIFT) & A6XX_CP_REG_TEST_0_REG__MASK;
}
...
static inline uint32_t A6XX_CP_REG_TEST_0_SOURCE(enum source_type val) {
  return ((val) <<
      A6XX_CP_REG_TEST_0_SOURCE__SHIFT) & A6XX_CP_REG_TEST_0_SOURCE__MASK;
}
...
static inline uint32_t A6XX_CP_REG_TEST_0_BIT(uint32_t val) {
  return ((val) <<
      A6XX_CP_REG_TEST_0_BIT__SHIFT) & A6XX_CP_REG_TEST_0_BIT__MASK;
}
...
static inline uint32_t A6XX_CP_REG_TEST_0_PRED_BIT(uint32_t val) {
  return ((val) <<
      A6XX_CP_REG_TEST_0_PRED_BIT__SHIFT) & A6XX_CP_REG_TEST_0_PRED_BIT__MASK;
}
...
static inline uint32_t CP_COND_REG_EXEC_0_REG0(uint32_t val) {
  return ((val) <<
      CP_COND_REG_EXEC_0_REG0__SHIFT) & CP_COND_REG_EXEC_0_REG0__MASK;
}
...
static inline uint32_t CP_COND_REG_EXEC_0_PRED_BIT(uint32_t val) {
  return ((val) <<
      CP_COND_REG_EXEC_0_PRED_BIT__SHIFT) & CP_COND_REG_EXEC_0_PRED_BIT__MASK;
}
...
static inline uint32_t CP_COND_REG_EXEC_0_MODE(enum compare_mode val) {
  return ((val) <<
      CP_COND_REG_EXEC_0_MODE__SHIFT) & CP_COND_REG_EXEC_0_MODE__MASK;
}
...
static inline uint32_t CP_COND_REG_EXEC_2_DWORDS(uint32_t val) {
  return ((val) <<
      CP_COND_REG_EXEC_2_DWORDS__SHIFT) & CP_COND_REG_EXEC_2_DWORDS__MASK;
}
...
static inline uint32_t CP_COND_EXEC_0_ADDR0_LO(uint32_t val) {
  return ((val) <<
      CP_COND_EXEC_0_ADDR0_LO__SHIFT) & CP_COND_EXEC_0_ADDR0_LO__MASK;
}
...
static inline uint32_t CP_COND_EXEC_1_ADDR0_HI(uint32_t val) {
  return ((val) <<
      CP_COND_EXEC_1_ADDR0_HI__SHIFT) & CP_COND_EXEC_1_ADDR0_HI__MASK;
}
...
static inline uint32_t CP_COND_EXEC_2_ADDR1_LO(uint32_t val) {
  return ((val) <<
      CP_COND_EXEC_2_ADDR1_LO__SHIFT) & CP_COND_EXEC_2_ADDR1_LO__MASK;
}
...
static inline uint32_t CP_COND_EXEC_3_ADDR1_HI(uint32_t val) {
  return ((val) <<
      CP_COND_EXEC_3_ADDR1_HI__SHIFT) & CP_COND_EXEC_3_ADDR1_HI__MASK;
}
...
static inline uint32_t CP_SET_CTXSWITCH_IB_2_DWORDS(uint32_t val) {
  return ((val) <<
      CP_SET_CTXSWITCH_IB_2_DWORDS__SHIFT) & CP_SET_CTXSWITCH_IB_2_DWORDS__MASK;
}
...
static inline uint32_t CP_SET_CTXSWITCH_IB_2_TYPE(enum ctxswitch_ib val) {
  return ((val) <<
      CP_SET_CTXSWITCH_IB_2_TYPE__SHIFT) & CP_SET_CTXSWITCH_IB_2_TYPE__MASK;
}
...
static inline uint32_t CP_REG_WRITE_0_TRACKER(enum reg_tracker val) {
  return ((val) <<
      CP_REG_WRITE_0_TRACKER__SHIFT) & CP_REG_WRITE_0_TRACKER__MASK;
}
...
static inline uint32_t CP_SMMU_TABLE_UPDATE_1_ASID(uint32_t val) {
  return ((val) <<
      CP_SMMU_TABLE_UPDATE_1_ASID__SHIFT) & CP_SMMU_TABLE_UPDATE_1_ASID__MASK;
}
...
static inline uint32_t CP_WAIT_TIMESTAMP_0_WAIT_VALUE_SRC(
    enum ts_wait_value_src val) {
  return ((val) <<
...
static inline uint32_t CP_WAIT_TIMESTAMP_0_WAIT_DST(enum ts_wait_type val) {
  return ((val) <<
      CP_WAIT_TIMESTAMP_0_WAIT_DST__SHIFT) & CP_WAIT_TIMESTAMP_0_WAIT_DST__MASK;
}
...
static inline uint32_t CP_BV_BR_COUNT_OPS_0_OP(enum pipe_count_op val) {
  return ((val) <<
      CP_BV_BR_COUNT_OPS_0_OP__SHIFT) & CP_BV_BR_COUNT_OPS_0_OP__MASK;
}
...
static inline uint32_t CP_MODIFY_TIMESTAMP_0_ADD(uint32_t val) {
  return ((val) <<
      CP_MODIFY_TIMESTAMP_0_ADD__SHIFT) & CP_MODIFY_TIMESTAMP_0_ADD__MASK;
}
...
static inline uint32_t CP_MODIFY_TIMESTAMP_0_OP(enum timestamp_op val) {
  return ((val) <<
      CP_MODIFY_TIMESTAMP_0_OP__SHIFT) & CP_MODIFY_TIMESTAMP_0_OP__MASK;
}
...
static inline uint32_t CP_MEM_TO_SCRATCH_MEM_0_CNT(uint32_t val) {
  return ((val) <<
      CP_MEM_TO_SCRATCH_MEM_0_CNT__SHIFT) & CP_MEM_TO_SCRATCH_MEM_0_CNT__MASK;
}
...
static inline uint32_t CP_MEM_TO_SCRATCH_MEM_2_SRC(uint32_t val) {
  return ((val) <<
      CP_MEM_TO_SCRATCH_MEM_2_SRC__SHIFT) & CP_MEM_TO_SCRATCH_MEM_2_SRC__MASK;
}
...
static inline uint32_t CP_THREAD_CONTROL_0_THREAD(enum cp_thread val) {
  return ((val) <<
      CP_THREAD_CONTROL_0_THREAD__SHIFT) & CP_THREAD_CONTROL_0_THREAD__MASK;
}
