...
static inline uint32_t AXXX_CP_RB_CNTL_BUF_SWAP(uint32_t val) {
  return ((val) <<
      AXXX_CP_RB_CNTL_BUF_SWAP__SHIFT) & AXXX_CP_RB_CNTL_BUF_SWAP__MASK;
}
...
static inline uint32_t AXXX_CP_RB_RPTR_ADDR_SWAP(uint32_t val) {
  return ((val) <<
      AXXX_CP_RB_RPTR_ADDR_SWAP__SHIFT) & AXXX_CP_RB_RPTR_ADDR_SWAP__MASK;
}
...
static inline uint32_t AXXX_CP_RB_RPTR_ADDR_ADDR(uint32_t val) {
  assert(!(val & 0x3));
  return (((val >> 2)) <<
      AXXX_CP_RB_RPTR_ADDR_ADDR__SHIFT) & AXXX_CP_RB_RPTR_ADDR_ADDR__MASK;
}
...
static inline uint32_t AXXX_CP_CSQ_AVAIL_RING(uint32_t val) {
  return ((val) <<
      AXXX_CP_CSQ_AVAIL_RING__SHIFT) & AXXX_CP_CSQ_AVAIL_RING__MASK;
}
...
static inline uint32_t AXXX_SCRATCH_UMSK_UMSK(uint32_t val) {
  return ((val) <<
      AXXX_SCRATCH_UMSK_UMSK__SHIFT) & AXXX_SCRATCH_UMSK_UMSK__MASK;
}
...
static inline uint32_t AXXX_SCRATCH_UMSK_SWAP(uint32_t val) {
  return ((val) <<
      AXXX_SCRATCH_UMSK_SWAP__SHIFT) & AXXX_SCRATCH_UMSK_SWAP__MASK;
}
...
static inline uint32_t AXXX_CP_CSQ_RB_STAT_RPTR(uint32_t val) {
  return ((val) <<
      AXXX_CP_CSQ_RB_STAT_RPTR__SHIFT) & AXXX_CP_CSQ_RB_STAT_RPTR__MASK;
}
...
static inline uint32_t AXXX_CP_CSQ_RB_STAT_WPTR(uint32_t val) {
  return ((val) <<
      AXXX_CP_CSQ_RB_STAT_WPTR__SHIFT) & AXXX_CP_CSQ_RB_STAT_WPTR__MASK;
}
...
static inline uint32_t AXXX_CP_CSQ_IB1_STAT_RPTR(uint32_t val) {
  return ((val) <<
      AXXX_CP_CSQ_IB1_STAT_RPTR__SHIFT) & AXXX_CP_CSQ_IB1_STAT_RPTR__MASK;
}
...
static inline uint32_t AXXX_CP_CSQ_IB1_STAT_WPTR(uint32_t val) {
  return ((val) <<
      AXXX_CP_CSQ_IB1_STAT_WPTR__SHIFT) & AXXX_CP_CSQ_IB1_STAT_WPTR__MASK;
}
...
static inline uint32_t AXXX_CP_CSQ_IB2_STAT_RPTR(uint32_t val) {
  return ((val) <<
      AXXX_CP_CSQ_IB2_STAT_RPTR__SHIFT) & AXXX_CP_CSQ_IB2_STAT_RPTR__MASK;
}
...
static inline uint32_t AXXX_CP_CSQ_IB2_STAT_WPTR(uint32_t val) {
  return ((val) <<
      AXXX_CP_CSQ_IB2_STAT_WPTR__SHIFT) & AXXX_CP_CSQ_IB2_STAT_WPTR__MASK;
}
