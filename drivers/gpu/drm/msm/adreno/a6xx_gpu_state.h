...
#define DEBUS(_id, _count) { .id = _id, .name = #_id, .count = _count }

static const struct a6xx_debus_block {
	const char *name;
	u32 id;
	u32 count;
} a6xx_debus_blocks[] = {
	DEBUS(A6XX_DBGBUS_CP, 0x100),
	DEBUS(A6XX_DBGBUS_RBBM, 0x100),
	DEBUS(A6XX_DBGBUS_HLSQ, 0x100),
	DEBUS(A6XX_DBGBUS_UCHE, 0x100),
	DEBUS(A6XX_DBGBUS_DPM, 0x100),
	DEBUS(A6XX_DBGBUS_TESS, 0x100),
	DEBUS(A6XX_DBGBUS_PC, 0x100),
	DEBUS(A6XX_DBGBUS_VFDP, 0x100),
	DEBUS(A6XX_DBGBUS_VPC, 0x100),
	DEBUS(A6XX_DBGBUS_TSE, 0x100),
	DEBUS(A6XX_DBGBUS_RAS, 0x100),
	DEBUS(A6XX_DBGBUS_VSC, 0x100),
	DEBUS(A6XX_DBGBUS_COM, 0x100),
	DEBUS(A6XX_DBGBUS_LRZ, 0x100),
	DEBUS(A6XX_DBGBUS_A2D, 0x100),
	DEBUS(A6XX_DBGBUS_CCUFCHE, 0x100),
	DEBUS(A6XX_DBGBUS_RBP, 0x100),
	DEBUS(A6XX_DBGBUS_DCS, 0x100),
	DEBUS(A6XX_DBGBUS_DBGC, 0x100),
	DEBUS(A6XX_DBGBUS_GMU_GX, 0x100),
	DEBUS(A6XX_DBGBUS_TPFCHE, 0x100),
	DEBUS(A6XX_DBGBUS_GPC, 0x100),
	DEBUS(A6XX_DBGBUS_LARC, 0x100),
	DEBUS(A6XX_DBGBUS_HLSQ_SPTP, 0x100),
	DEBUS(A6XX_DBGBUS_RB_0, 0x100),
	DEBUS(A6XX_DBGBUS_RB_1, 0x100),
	DEBUS(A6XX_DBGBUS_UCHE_WRAPPER, 0x100),
	DEBUS(A6XX_DBGBUS_CCU_0, 0x100),
	DEBUS(A6XX_DBGBUS_CCU_1, 0x100),
	DEBUS(A6XX_DBGBUS_VFD_0, 0x100),
	DEBUS(A6XX_DBGBUS_VFD_1, 0x100),
	DEBUS(A6XX_DBGBUS_VFD_2, 0x100),
	DEBUS(A6XX_DBGBUS_VFD_3, 0x100),
	DEBUS(A6XX_DBGBUS_SP_0, 0x100),
	DEBUS(A6XX_DBGBUS_SP_1, 0x100),
	DEBUS(A6XX_DBGBUS_TPL1_0, 0x100),
	DEBUS(A6XX_DBGBUS_TPL1_1, 0x100),
	DEBUS(A6XX_DBGBUS_TPL1_2, 0x100),
	DEBUS(A6XX_DBGBUS_TPL1_3, 0x100),
};

static const struct a6xx_debus_block a6xx_cx_debus_blocks[] = {
	DEBUS(A6XX_DBGBUS_GMU_CX, 0x100),
	DEBUS(A6XX_DBGBUS_CX, 0x100),
};
