...
static void put_iova_vmas(struct drm_gem_object *obj) {
  struct msm_gem_object *msm_obj = to_msm_bo(obj);
...
int msm_gem_pin_vma_locked(struct drm_gem_object *obj,
    struct msm_gem_vma *vma) {
  struct msm_gem_object *msm_obj = to_msm_bo(obj);
  struct page **pages;
  int prot = IOMMU_READ;
...
int msm_gem_get_and_pin_iova_range(struct drm_gem_object *obj,
  ...
  msm_gem_lock(obj);
  ret
    = get_and_pin_iova_range_locked(obj, aspace, iova, range_start, range_end);
  msm_gem_unlock(obj);
  return ret;
}
...
static int msm_gem_object_mmap(struct drm_gem_object *obj,
