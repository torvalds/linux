...
static int update_hw_cntrs(struct msm_gpu *gpu, uint32_t ncntrs,
    uint32_t *cntrs) {
...
struct msm_gem_address_space *msm_gpu_create_private_address_space(
    struct msm_gpu *gpu, struct task_struct *task) {
