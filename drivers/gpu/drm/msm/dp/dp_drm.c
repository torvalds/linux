 ...
 */
static int dp_bridge_get_modes(struct drm_bridge *bridge,
...
static void dp_bridge_debugfs_init(struct drm_bridge *bridge,
    struct dentry *root) {
...
static void edp_bridge_debugfs_init(struct drm_bridge *bridge,
    struct dentry *root) {
  struct msm_dp *dp = to_dp_bridge(bridge)->dp_display;
