  ...
  if (ret < 0) {
    ...
    switch (aux->aux_error_num) {
      case DP_AUX_ERR_NONE:
        ...
        msg->reply
          = aux->native ? DP_AUX_NATIVE_REPLY_ACK : DP_AUX_I2C_REPLY_ACK;
        break;
      case DP_AUX_ERR_DEFER:
        msg->reply
          = aux->native ? DP_AUX_NATIVE_REPLY_DEFER : DP_AUX_I2C_REPLY_DEFER;
        break;
      case DP_AUX_ERR_PHY:
      ...
      case DP_AUX_ERR_NACK_DEFER:
        msg->reply
          = aux->native ? DP_AUX_NATIVE_REPLY_NACK : DP_AUX_I2C_REPLY_NACK;
        break;
