...
static const struct msm_dp_desc sc7280_dp_descs[] = {
  ...
  { .io_start = 0x0aea0000, .id = MSM_DP_CONTROLLER_1,
    .connector_type = DRM_MODE_CONNECTOR_eDP, .wide_bus_supported = true },
  {}
};
...
static const struct msm_dp_desc sc8280xp_dp_descs[] = {
  ...
  { .io_start = 0x0ae9a000, .id = MSM_DP_CONTROLLER_2,
    .connector_type = DRM_MODE_CONNECTOR_DisplayPort,
    .wide_bus_supported = true },
  { .io_start = 0x0aea0000, .id = MSM_DP_CONTROLLER_3,
    .connector_type = DRM_MODE_CONNECTOR_DisplayPort,
    .wide_bus_supported = true },
  { .io_start = 0x22090000, .id = MSM_DP_CONTROLLER_0,
    .connector_type = DRM_MODE_CONNECTOR_DisplayPort,
    .wide_bus_supported = true },
  ...
  { .io_start = 0x2209a000, .id = MSM_DP_CONTROLLER_2,
    .connector_type = DRM_MODE_CONNECTOR_DisplayPort,
    .wide_bus_supported = true },
  { .io_start = 0x220a0000, .id = MSM_DP_CONTROLLER_3,
    .connector_type = DRM_MODE_CONNECTOR_DisplayPort,
    .wide_bus_supported = true },
  {}
};
...
static const struct msm_dp_desc *dp_display_get_desc(
...
void dp_display_debugfs_init(struct msm_dp *dp_display, struct dentry *root,
    bool is_edp) {
  struct dp_display_private *dp;
  struct device *dev;
  int rc;
...
void dp_bridge_mode_set(struct drm_bridge *drm_bridge,
  ...
  dp_display->ctrl->wide_bus_en
    = dp_display->dp_mode.out_fmt_is_yuv_420 ? false : dp_display->
      wide_bus_supported;
