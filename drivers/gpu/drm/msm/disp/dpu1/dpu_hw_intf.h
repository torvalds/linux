 ...
 * @enable_tearcheck:           Enables vsync generation and sets up init value
 *of read
 ...
 *                              Return: 1 if TE was originally connected, 0 if
 *not, or -ERROR
...
struct dpu_hw_intf_ops {
   ...
   */
  void (*disable_autorefresh)(struct dpu_hw_intf *intf, uint32_t encoder_id,
      u16 vdisplay);
