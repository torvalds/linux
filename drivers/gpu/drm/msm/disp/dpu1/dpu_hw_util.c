...
static void _dpu_hw_setup_scaler3lite_lut(struct dpu_hw_blk_reg_map *c,
  ...
  u32 *lut[QSEED3LITE_FILTERS] = {
    NULL, NULL
  };
  static const uint32_t off_tbl[QSEED3_FILTERS] = {
    0x000, 0x200
  };
  DPU_REG_WRITE(c, QSEED3LITE_DIR_FILTER_WEIGHT + offset,
      scaler3_cfg->dir_weight);
