...
#define MDP_INTF_REV_7xxx_INTR_EN(intf)     (MDP_INTF_REV_7xxx_OFF(intf) \
  + 0x1c0)
...
#define MDP_INTF_REV_7xxx_INTR_TEAR_EN(intf)    (MDP_INTF_REV_7xxx_TEAR_OFF( \
    intf) + 0x000)
#define MDP_INTF_REV_7xxx_INTR_TEAR_STATUS(intf)  (MDP_INTF_REV_7xxx_TEAR_OFF( \
    intf) + 0x004)
#define MDP_INTF_REV_7xxx_INTR_TEAR_CLEAR(intf)   (MDP_INTF_REV_7xxx_TEAR_OFF( \
    intf) + 0x008)
...
static inline struct dpu_hw_intr_entry *dpu_core_irq_get_entry(
...
static void dpu_core_irq_callback_handler(struct dpu_kms *dpu_kms,
    unsigned int irq_idx) {
  struct dpu_hw_intr_entry *irq_entry = dpu_core_irq_get_entry(dpu_kms->hw_intr,
      irq_idx);
...
int dpu_core_irq_register_callback(struct dpu_kms *dpu_kms,
  ...
  trace_dpu_core_irq_register_callback(DPU_IRQ_REG(irq_idx), DPU_IRQ_BIT(
      irq_idx), irq_cb);
