 ...
 */
struct mdp5_global_state *mdp5_get_existing_global_state(
...
static struct drm_private_state *mdp5_global_duplicate_state(
...
static int get_dsi_id_from_intf(const struct mdp5_cfg_hw *hw_cfg,
    int intf_num) {
...
static int modeset_init(struct mdp5_kms *mdp5_kms) {
  ...
  int i, ret, pi = 0, ci = 0;
  struct drm_plane *primary[MAX_BASES] = {
    NULL
  };
  struct drm_plane *cursor[MAX_BASES] = {
    NULL
  };
  struct drm_encoder *encoder;
