...
static void mdp5_plane_atomic_print_state(struct drm_printer *p,
...
static struct drm_plane_state *mdp5_plane_duplicate_state(
...
static int mdp5_plane_atomic_check(struct drm_plane *plane,
  ...
  struct drm_plane_state *old_plane_state = drm_atomic_get_old_plane_state(
      state,
      plane);
