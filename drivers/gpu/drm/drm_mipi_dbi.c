...
int mipi_dbi_buf_copy(void *dst, struct iosys_map *src,
  ...
  switch (fb->format->format) {
    ...
    case DRM_FORMAT_XRGB8888:
      drm_fb_xrgb8888_to_rgb565(&dst_map, NULL, src, fb, clip, fmtcnv_state,
          swap);
      break;
    default:
 ...
 *&drm_simple_display_pipe_funcs->mode_valid
 * callback.
 */
...
/**
 * mipi_dbi_dev_init_with_formats - MIPI DBI device initialization with custom
 *formats
