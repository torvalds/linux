...
static void armada_drm_overlay_plane_atomic_update(struct drm_plane *plane,
  ...
  DRM_DEBUG_KMS(
      "[PLANE:%d:%s] is on [CRTC:%d:%s] with [FB:%d] visible %u->%u\n",
      plane->base.id, plane->name,
...
static int armada_overlay_plane_update(struct drm_plane *plane,
...
static struct drm_plane_state *armada_overlay_duplicate_state(
