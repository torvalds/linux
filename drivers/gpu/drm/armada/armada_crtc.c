...
void armada_drm_crtc_update_regs(struct armada_crtc *dcrtc,
...
static int armada_drm_crtc_cursor_update(struct armada_crtc *dcrtc,
    bool reload) {
...
static int armada_lcd_bind(struct device *dev, struct device *master,
    void *data) {
...
static void armada_lcd_unbind(struct device *dev, struct device *master,
    void *data) {
