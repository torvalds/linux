...
static void bochs_hw_setmode(struct bochs_device *bochs,
...
static void bochs_hw_setbase(struct bochs_device *bochs, int x, int y,
    int stride, u64 addr) {
...
static struct drm_framebuffer *bochs_gem_fb_create(struct drm_device *dev,
