...
static inline struct usb_device *gm12u320_to_usb_device(
...
static void gm12u320_copy_fb_to_blocks(struct gm12u320_device *gm12u320) {
  ...
  vaddr = gm12u320->fb_update.src_map.vaddr; /* TODO: Use mapping abstraction
                                              * properly */
...
static struct edid gm12u320_edid = {
  ...
  .detailed_timings = { {
                          ...
                          .data.pixel_data.hsync_vsync_offset_pulse_width_hi
                            = 0x00,
                          ...
                          .data.other_data.data.range.pixel_clock_mhz = 4, /* 40
                                                                            * MHz
                                                                            * */
                          ...
                          .pixel_clock = 0,
                          .data.other_data.type = 0xfe, /* Unspecified text /
                                                         * padding */
                          .data.other_data.data.str.str = {
                            '\n', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
                            ' ', ' ', ' '
...
static void gm12u320_pipe_enable(struct drm_simple_display_pipe *pipe,
  ...
  struct drm_rect rect = {
    0, 0, GM12U320_USER_WIDTH, GM12U320_HEIGHT
  };
