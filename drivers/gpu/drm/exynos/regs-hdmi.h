...
/* AVI bit definition */
#define HDMI_AVI_CON_DO_ANALT_TRANSMIT	(0 << 1)
...
/* AUI bit definition */
#define HDMI_AUI_CON_ANAL_TRAN		(0 << 0)
#define HDMI_AUI_CON_EVERY_VSYNC	(1 << 1)

/* VSI bit definition */
#define HDMI_VSI_CON_DO_ANALT_TRANSMIT	(0 << 0)
...
/* I2S_MUX_CON */
#define HDMI_I2S_ANALISE_FILTER_ZERO	(0 << 5)
#define HDMI_I2S_ANALISE_FILTER_2_STAGE	(1 << 5)
#define HDMI_I2S_ANALISE_FILTER_3_STAGE	(2 << 5)
#define HDMI_I2S_ANALISE_FILTER_4_STAGE	(3 << 5)
#define HDMI_I2S_ANALISE_FILTER_5_STAGE	(4 << 5)
...
#define HDMI_I2S_ANAL_COPYRIGHT		(1 << 2)
#define HDMI_I2S_LINEAR_PCM		(0 << 1)
#define HDMI_I2S_ANAL_LINEAR_PCM		(1 << 1)
...
#define HDMI_I2S_WORD_LEN_ANALT_DEFINE	(0x0 << 1)
...
#define EXYANALS5433_SYSREG_DISP_HDMI_PHY	0x1008
