...
static void g2d_put_cmdlist(struct g2d_data *g2d,
    struct g2d_cmdlist_node *node) {
  mutex_lock(&g2d->cmdlist_mutex);
...
static enum g2d_reg_type g2d_get_reg_type(struct g2d_data *g2d,
    int reg_offset) {
 ...
 */
static void g2d_remove_runqueue_nodes(struct g2d_data *g2d,
    struct drm_file *file) {
