...
/* default phy config settings for exynos5410 */
static struct hdmiphy_config hdmiphy_5410_configs[] = {
	{
		.pixel_clock = 25200000,
		.conf = {
			0x52, 0x3F, 0x55, 0x40, 0x01, 0x00, 0xC8, 0x82,
	...
	},
	{
		...
		.conf = {
			0xD1, 0x1F, 0x10, 0x40, 0x5B, 0xEF, 0x08, 0x81,
			0xE8, 0xB9, 0xD8, 0x45, 0xA0, 0xAC, 0x80, 0x56,
			0x80, 0x09, 0x84, 0x05, 0x22, 0x24, 0x86, 0x54,
			0xA6, 0x24, 0x01, 0x00, 0x00, 0x01, 0x80,
		},
	...
	{
		.pixel_clock = 148352000,
		.conf = {
			0xD1, 0x1F, 0x00, 0x40, 0x5B, 0xEF, 0x08, 0x81,
	...
	},
	{
		.pixel_clock = 148500000,
		.conf = {
			0xD1, 0x1F, 0x00, 0x40, 0x40, 0xF0, 0x08, 0x81,
			0xe8, 0xBA, 0xD8, 0x45, 0xA0, 0xAC, 0x80, 0x66,
			0x80, 0x09, 0x84, 0x05, 0x22, 0x24, 0x86, 0x54,
			0x4B, 0x25, 0x03, 0x00, 0x00, 0x01, 0x80,
		},
...
static struct hdmiphy_drv_data exynos5410_hdmiphy_drv_data = {
	.confs = hdmiphy_5410_configs,
	.count = ARRAY_SIZE(hdmiphy_5410_configs)
};
...
static struct of_device_id hdmiphy_platform_device_match_types[] = {
	{
		...
		.data	= &exynos5410_hdmiphy_drv_data,
	}, {
		/* end node */
	}
};
