					   ...
					   struct output *o)
{
	...
	if (class == HOST1X_CLASS_HOST1X && offset == HOST1X_UCLASS_WAIT_SYNCPT)
		host1x_de_output(o, "waiting on syncpt\n");
	else
		host1x_de_output(o, "active class %02x, offset %04x\n",
				    class, offset);

	host1x_de_output(o, "DMAPUT %08x, DMAGET %08x, DMACTL %08x\n",
			    dmaput, dmaget, dmactrl);
	host1x_de_output(o, "CHANNELSTAT %02x\n", ch_stat);
					   ...
					   struct output *o)
{
	...
	host1x_de_output(o, "CMDFIFO_STAT %08x\n", val);
	...
	host1x_de_output(o, "CMDFIFO_RDATA %08x\n", val);
