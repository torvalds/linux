...
static int serdev_device_uevent(const struct device *dev,
...
/**
 * serdev_device_add() - add a device previously constructed via
 * serdev_device_alloc()
 ...
 */
int serdev_device_write_buf(struct serdev_device *serdev, const u8 *buf,
    size_t count) {
  struct serdev_controller *ctrl = serdev->ctrl;
 ...
 */
int __serdev_device_driver_register(struct serdev_device_driver *sdrv,
    struct module *owner) {
