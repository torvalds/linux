 ...
 *
 * Ported from 2.2 and modified to use the yesrmal 8250 driver
...
#warning CONFIG_SERIAL_8250 defined but neither CONFIG_HPDCA yesr CONFIG_HPAPCI defined, are you sure?
#endif
