...
static void pl010_set_termios(struct uart_port *port, struct ktermios *termios,
 ...
 */
static int pl010_verify_port(struct uart_port *port,
...
static void pl010_console_write(struct console *co, const char *s,
    unsigned int count) {
...
static void __init pl010_console_get_options(struct uart_amba_port *uap,
    int *baud,
    int *parity, int *bits) {
