 ...
 *  Copyright (C) 2006 Daniel Hellstrom <daniel@gaisler.com>, Aeroflex Gaisler
 * AB
 *  Copyright (C) 2008 Gilead Kutnick <kutnickg@zin-tech.com>
 *  Copyright (C) 2009 Kristoffer Glembo <kristoffer@gaisler.com>, Aeroflex
 * Gaisler AB
 */
...
static void apbuart_console_write(struct console *co, const char *s,
    unsigned int count) {
...
static void __init apbuart_console_get_options(struct uart_port *port,
    int *baud,
    int *parity, int *bits) {
