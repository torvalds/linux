...
#define SIFIVE_SERIAL_TXDATA_DATA_MASK    (0xff << \
    SIFIVE_SERIAL_TXDATA_DATA_SHIFT)

/* RXDATA */
#define SIFIVE_SERIAL_RXDATA_OFFS   0x4
#define SIFIVE_SERIAL_RXDATA_EMPTY_SHIFT  31
#define SIFIVE_SERIAL_RXDATA_EMPTY_MASK   (1 << \
    SIFIVE_SERIAL_RXDATA_EMPTY_SHIFT)
#define SIFIVE_SERIAL_RXDATA_DATA_SHIFT   0
#define SIFIVE_SERIAL_RXDATA_DATA_MASK    (0xff << \
    SIFIVE_SERIAL_RXDATA_DATA_SHIFT)

/* TXCTRL */
#define SIFIVE_SERIAL_TXCTRL_OFFS   0x8
#define SIFIVE_SERIAL_TXCTRL_TXCNT_SHIFT  16
#define SIFIVE_SERIAL_TXCTRL_TXCNT_MASK   (0x7 << \
    SIFIVE_SERIAL_TXCTRL_TXCNT_SHIFT)
#define SIFIVE_SERIAL_TXCTRL_NSTOP_SHIFT  1
#define SIFIVE_SERIAL_TXCTRL_NSTOP_MASK   (1 << \
    SIFIVE_SERIAL_TXCTRL_NSTOP_SHIFT)
...
#define SIFIVE_SERIAL_RXCTRL_RXCNT_MASK   (0x7 << \
    SIFIVE_SERIAL_TXCTRL_TXCNT_SHIFT)
...
/**
 * struct sifive_serial_port - driver-specific data extension to struct
 * uart_port
...
static void sifive_serial_set_mctrl(struct uart_port *port,
    unsigned int mctrl) {
...
static struct sifive_serial_port *sifive_serial_console_ports[
  SIFIVE_SERIAL_MAX_PORTS];

static void sifive_serial_console_putchar(struct uart_port *port,
    unsigned char ch) {
  struct sifive_serial_port *ssp = port_to_sifive_serial_port(port);
  __ssp_wait_for_xmitr(ssp);
  __ssp_transmit_char(ssp, ch);
