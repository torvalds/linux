...
#define ATMEL_US_TXFTHRES(thr)  FIELD_PREP(GENMASK(13, 8), (thr)) /* TX FIFO
                                                                   * Threshold
                                                                   * */
#define ATMEL_US_RXFTHRES(thr)  FIELD_PREP(GENMASK(21, 16), (thr))  /* RX FIFO
                                                                     * Threshold
                                                                     * */
#define ATMEL_US_RXFTHRES2(thr) FIELD_PREP(GENMASK(29, 24), (thr))  /* RX FIFO
                                                                     * Threshold2
                                                                     * */
