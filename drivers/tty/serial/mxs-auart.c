...
static void mxs_auart_console_putchar(struct uart_port *port,
    unsigned char ch) {
  struct mxs_auart_port *s = to_auart_port(port);
...
static void auart_console_write(struct console *co, const char *str,
    unsigned int count) {
...
static void __init auart_console_get_options(struct mxs_auart_port *s,
    int *baud,
    int *parity, int *bits) {
