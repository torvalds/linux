 ...
 * for Vietnamese.
 */
static void k_deadunicode(struct vc_data *vc, unsigned int value,
    char up_flag) {
  if (up_flag) {
    return;
  }
...
static void k_brlcommit(struct vc_data *vc, unsigned int pattern,
    char up_flag) {
...
static const unsigned short x86_keycodes[256] = {
  ...
  360, 261, 262, 263, 268, 376, 100, 101, 321, 316, 373, 286, 289, 102, 351,
  355,
  103, 104, 105, 275, 287, 279, 258, 106, 274, 107, 294, 364, 358, 363, 362,
  361,
  291, 108, 381, 281, 290, 272, 292, 305, 280, 99, 112, 257, 306, 359, 113, 114,
  264, 117, 271, 374, 379, 265, 266, 93, 94, 95, 85, 259, 375, 260, 90, 116,
  377, 109, 111, 277, 278, 282, 283, 295, 296, 297, 299, 300, 301, 293, 303,
  307,
  308, 310, 313, 314, 315, 317, 318, 319, 320, 357, 322, 323, 324, 325, 276,
  330,
...
static void kbd_keycode(unsigned int keycode, int down, bool hw_raw) {
  ...
  if ((raw_mode || kbd->kbdmode == VC_OFF) && type != KT_SPEC
      && type != KT_SHIFT) {
    return;
  }
