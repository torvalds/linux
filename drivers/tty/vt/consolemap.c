 ...
 *
 * Fix bug in inverse translation. Stanislav Voronyi
 *<stas@cnti.uanet.kharkov.ua>, Dec 1998
 *
...
static int con_insert_unipair(struct uni_pagedict *p, u_short unicode,
    u_short fontpos) {
  u16 **dir, *row;
  unsigned int n;
  n = UNI_DIR(unicode);
