 ...
 */
static int handle_data_ul(struct nozomi *dc, enum port_type port,
    u16 read_iir) {
 ...
 * Data is inserted into a fifo, which is then read and transferred to the
 * modem.
 */
