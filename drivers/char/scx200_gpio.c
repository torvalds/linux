...
#define MAX_PINS 32		/* 64 later, when kyeswn ok */
...
static int scx200_gpio_open(struct iyesde *iyesde, struct file *file)
{
...
static int scx200_gpio_release(struct iyesde *iyesde, struct file *file)
{
	return 0;
}
...
static int __init scx200_gpio_init(void)
{
	...
	if (!scx200_gpio_present()) {
		printk(KERN_ERR DRVNAME ": yes SCx200 gpio present\n");
		return -ENODEV;
	}
