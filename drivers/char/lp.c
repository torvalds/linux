...
#define w_ctr(x, y)  do { parport_write_control(lp_table[(x)].dev->port, (y)); \
} while (0)
#define w_dtr(x, y)  do { parport_write_data(lp_table[(x)].dev->port, (y)); \
} while (0)
