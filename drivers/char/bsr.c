...
static ssize_t bsr_size_show(struct device *dev, struct device_attribute *attr,
    char *buf) {
...
static ssize_t bsr_stride_show(struct device *dev,
...
static ssize_t bsr_length_show(struct device *dev,
    struct device_attribute *attr, char *buf) {
  struct bsr_dev *bsr_dev = dev_get_drvdata(dev);
