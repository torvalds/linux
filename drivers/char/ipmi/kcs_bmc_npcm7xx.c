...
static inline struct npcm7xx_kcs_bmc *to_npcm7xx_kcs_bmc(
    struct kcs_bmc_device *kcs_bmc) {
...
static void npcm7xx_kcs_enable_channel(struct kcs_bmc_device *kcs_bmc,
    bool enable) {
  struct npcm7xx_kcs_bmc *priv = to_npcm7xx_kcs_bmc(kcs_bmc);
...
static void npcm7xx_kcs_irq_mask_update(struct kcs_bmc_device *kcs_bmc, u8 mask,
    u8 state) {
  struct npcm7xx_kcs_bmc *priv = to_npcm7xx_kcs_bmc(kcs_bmc);
