...
int kcs_bmc_enable_device(struct kcs_bmc_device *kcs_bmc,
    struct kcs_bmc_client *client) {
  int rc;
...
void kcs_bmc_disable_device(struct kcs_bmc_device *kcs_bmc,
    struct kcs_bmc_client *client) {
  spin_lock_irq(&kcs_bmc->lock);
...
void kcs_bmc_update_event_mask(struct kcs_bmc_device *kcs_bmc, u8 mask,
    u8 events) {
