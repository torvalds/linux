...
struct si_sm_handlers {
	 ...
	 * return -2 if the state machine is yest idle, -1 if the size
	 ...
	 * -1 if the buffer is too small, zero if yes transaction is
	 ...
	 * periodically when yest in idle state.  This should be called
	...
	/*
	 * Attempt to detect an SMI.  Returns 0 on success or yesnzero
	 * on failure.
	 */
