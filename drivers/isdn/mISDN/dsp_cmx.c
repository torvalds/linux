 ...
 */
static void dsp_cmx_hw_message(struct dsp *dsp, u32 message, u32 param1,
    u32 param2,
...
int delaycount;
static void showdelay(struct dsp *dsp, int samples, int delay) {
  char bar[] = "--------------------------------------------------|";
  int sdelay;
  delaycount += samples;
  if (delaycount < 8000) {
...
void dsp_cmx_send(struct timer_list *arg) {
  struct dsp_conf *conf;
  struct dsp_conf_member *member;
  struct dsp *dsp;
  int mustmix, members;
