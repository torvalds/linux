...
static const struct capi_version driver_version = {
  2, 0, 1, 1 << 4
};
...
static inline struct capi_ctr *capi_ctr_get(struct capi_ctr *ctr) {
...
static inline void capi_ctr_put(struct capi_ctr *ctr) {
...
static void register_appl(struct capi_ctr *ctr, u16 applid,
