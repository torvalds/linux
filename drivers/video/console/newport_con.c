...
#define RENDER(regs, cp) do { \
    (regs)->go.zpattern = BMASK((cp)[0x0]); (regs)->go.zpattern = BMASK( \
    (cp)[0x1]); \
    (regs)->go.zpattern = BMASK((cp)[0x2]); (regs)->go.zpattern = BMASK( \
    (cp)[0x3]); \
    (regs)->go.zpattern = BMASK((cp)[0x4]); (regs)->go.zpattern = BMASK( \
    (cp)[0x5]); \
    (regs)->go.zpattern = BMASK((cp)[0x6]); (regs)->go.zpattern = BMASK( \
    (cp)[0x7]); \
    (regs)->go.zpattern = BMASK((cp)[0x8]); (regs)->go.zpattern = BMASK( \
    (cp)[0x9]); \
    (regs)->go.zpattern = BMASK((cp)[0xa]); (regs)->go.zpattern = BMASK( \
    (cp)[0xb]); \
    (regs)->go.zpattern = BMASK((cp)[0xc]); (regs)->go.zpattern = BMASK( \
    (cp)[0xd]); \
    (regs)->go.zpattern = BMASK((cp)[0xe]); (regs)->go.zpattern = BMASK( \
    (cp)[0xf]); \
} while (0)
