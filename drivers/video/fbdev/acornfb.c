 ...
 */
static int acornfb_setcolreg(u_int regno, u_int red, u_int green, u_int blue,
 ...
 */
static int acornfb_adjust_timing(struct fb_info *info,
    struct fb_var_screeninfo *var, u_int fontht) {
...
static int acornfb_validate_timing(struct fb_var_screeninfo *var,
...
static inline void acornfb_update_dma(struct fb_info *info,
...
static int acornfb_check_var(struct fb_var_screeninfo *var,
    struct fb_info *info) {
  u_int fontht;
  int err;
  /*
...
static int acornfb_pan_display(struct fb_var_screeninfo *var,
    struct fb_info *info) {
