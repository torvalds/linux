...
#define AP_ROP_1        isaIO2mem(AP_IOBASE + 2)  /* Raster Operation reg. Write
                                                   * Word */
#define AP_DIAG_MEM_REQ isaIO2mem(AP_IOBASE + 4)  /* Diagnostic Memory Request.
                                                   * Write Word */
#define AP_CONTROL_0    isaIO2mem(AP_IOBASE + 8)  /* Control Register 0.
                                                   *  Read/Write */
#define AP_CONTROL_1    isaIO2mem(AP_IOBASE + 0xa)  /* Control Register 1.
                                                     *  Read/Write */
#define AP_CONTROL_3A   isaIO2mem(AP_IOBASE + 0xe)  /* Control Register 3a.
                                                     * Read/Write */
#define AP_CONTROL_2    isaIO2mem(AP_IOBASE + 0xc)  /* Control Register 2.
                                                     * Read/Write */
...
#define S_DATA_1s   0x00 /* 00xx.xxxx */  /* set source to all 1's -- vector
                          * drawing */
#define S_DATA_PIX  0x40 /* 01xx.xxxx */  /* takes source from ls-bits and
                          * replicates over 16 bits */
#define S_DATA_PLN  0xC0 /* 11xx.xxxx */  /* normal, each data access =16-bits
                          * in
