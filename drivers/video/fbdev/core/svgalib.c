...
void svga_wcrt_multi(void __iomem *regbase, const struct vga_regset *regset,
    u32 value) {
...
void svga_wseq_multi(void __iomem *regbase, const struct vga_regset *regset,
    u32 value) {
  u8 regval, bitval, bitnum;
  while (regset->regnum != VGA_REGSET_END_VAL) {
...
void svga_set_textmode_vga_regs(void __iomem *regbase) {
  ...
  vga_wgfx(regbase, VGA_GFX_MISC, 0x0E); /* Misc graphics register - text mode
                                          * enable */
  vga_wgfx(regbase, VGA_GFX_COMPARE_MASK, 0x00);
  vga_r(regbase, 0x3DA);
  vga_w(regbase, VGA_ATT_W, 0x00);
  svga_wattr(regbase, 0x10, 0x0C);      /* Attribute Mode Control Register -
                                         * text mode, blinking and line graphics
                                         * */
...
void svga_tilecursor(void __iomem *regbase, struct fb_info *info,
