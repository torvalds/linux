...
static void bitfill_unaligned(struct fb_info *p, unsigned long *dst,
    int dst_idx,
 ...
 */
static void bitfill_aligned_rev(struct fb_info *p, unsigned long *dst,
    int dst_idx,
    unsigned long pat, unsigned n, int bits) {
...
static void bitfill_unaligned_rev(struct fb_info *p, unsigned long *dst,
    int dst_idx,
