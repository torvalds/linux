...
static struct page *fb_deferred_io_page(struct fb_info *info,
    unsigned long offs) {
...
static struct fb_deferred_io_pageref *fb_deferred_io_pageref_get(
    struct fb_info *info,
...
int fb_deferred_io_fsync(struct file *file, loff_t start, loff_t end,
    int datasync) {
