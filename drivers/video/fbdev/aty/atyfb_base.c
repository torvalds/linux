...
static unsigned long phys_vmembase[FB_MAX] = {
  0,
};
static unsigned long phys_size[FB_MAX] = {
  0,
};
static unsigned long phys_guiregbase[FB_MAX] = {
  0,
};
#endif
...
#define ATI_CHIP_264CT     (M64F_CT | M64F_INTEGRATED | M64F_CT_BUS \
  | M64F_MAGIC_FIFO)
#define ATI_CHIP_264ET     (M64F_CT | M64F_INTEGRATED | M64F_CT_BUS \
  | M64F_MAGIC_FIFO)

#define ATI_CHIP_264VT     (M64F_VT | M64F_INTEGRATED | M64F_VT_BUS \
  | M64F_MAGIC_FIFO)
#define ATI_CHIP_264GT     (M64F_GT | M64F_INTEGRATED | M64F_MAGIC_FIFO \
  | M64F_EXTRA_BRIGHT)

#define ATI_CHIP_264VTB    (M64F_VT | M64F_INTEGRATED | M64F_VT_BUS \
  | M64F_GTB_DSP)
#define ATI_CHIP_264VT3    (M64F_VT | M64F_INTEGRATED | M64F_VT_BUS \
...
/* make sets shorter */
#define ATI_MODERN_SET     (M64F_GT | M64F_INTEGRATED | M64F_GTB_DSP \
  | M64F_EXTRA_BRIGHT)
...
#define ATI_CHIP_264GT2C   (ATI_MODERN_SET | M64F_SDRAM_MAGIC_PLL \
  | M64F_HW_TRIPLE)
#define ATI_CHIP_264GTPRO  (ATI_MODERN_SET | M64F_SDRAM_MAGIC_PLL \
  | M64F_HW_TRIPLE | M64F_FIFO_32 | M64F_RESET_3D)
#define ATI_CHIP_264LTPRO  (ATI_MODERN_SET | M64F_HW_TRIPLE | M64F_FIFO_32 \
  | M64F_RESET_3D)

#define ATI_CHIP_264XL     (ATI_MODERN_SET | M64F_HW_TRIPLE | M64F_FIFO_32 \
  | M64F_RESET_3D | M64F_XL_DLL | M64F_MFB_FORCE_4 | M64F_XL_MEM)
#define ATI_CHIP_MOBILITY  (ATI_MODERN_SET | M64F_HW_TRIPLE | M64F_FIFO_32 \
  | M64F_RESET_3D | M64F_XL_DLL | M64F_MFB_FORCE_4 | M64F_XL_MEM \
  | M64F_MOBIL_BUS)
...
static struct {
  ...
  /* Mach64 GX */
  { PCI_CHIP_MACH64GX, "ATI888GX00 (Mach64 GX)", 135, 50, 50, 0,
    ATI_CHIP_88800GX },
  { PCI_CHIP_MACH64CX, "ATI888CX00 (Mach64 CX)", 135, 50, 50, 0,
    ATI_CHIP_88800CX },
  ...
  { PCI_CHIP_MACH64VT, "ATI264VT (Mach64 VT)", 170, 67, 67, 80,
    ATI_CHIP_264VT },
  { PCI_CHIP_MACH64GT, "3D RAGE (Mach64 GT)", 135, 63, 63, 80, ATI_CHIP_264GT },

  { PCI_CHIP_MACH64VU, "ATI264VT3 (Mach64 VU)", 200, 67, 67, 80,
    ATI_CHIP_264VT3 },
  { PCI_CHIP_MACH64GU, "3D RAGE II+ (Mach64 GU)", 200, 67, 67, 100,
    ATI_CHIP_264GTB },

  { PCI_CHIP_MACH64LG, "3D RAGE LT (Mach64 LG)", 230, 63, 63, 100,
    ATI_CHIP_264LTG | M64F_LT_LCD_REGS | M64F_G3_PB_1024x768 },

  { PCI_CHIP_MACH64VV, "ATI264VT4 (Mach64 VV)", 230, 83, 83, 100,
    ATI_CHIP_264VT4 },

  { PCI_CHIP_MACH64GV, "3D RAGE IIC (Mach64 GV, PCI)", 230, 83, 83, 100,
    ATI_CHIP_264GT2C },
  { PCI_CHIP_MACH64GW, "3D RAGE IIC (Mach64 GW, AGP)", 230, 83, 83, 100,
    ATI_CHIP_264GT2C },
  { PCI_CHIP_MACH64GY, "3D RAGE IIC (Mach64 GY, PCI)", 230, 83, 83, 100,
    ATI_CHIP_264GT2C },
  { PCI_CHIP_MACH64GZ, "3D RAGE IIC (Mach64 GZ, AGP)", 230, 83, 83, 100,
    ATI_CHIP_264GT2C },

  { PCI_CHIP_MACH64GB, "3D RAGE PRO (Mach64 GB, BGA, AGP)", 230, 100, 100, 125,
    ATI_CHIP_264GTPRO },
  { PCI_CHIP_MACH64GD, "3D RAGE PRO (Mach64 GD, BGA, AGP 1x)", 230, 100, 100,
    125, ATI_CHIP_264GTPRO },
  { PCI_CHIP_MACH64GI, "3D RAGE PRO (Mach64 GI, BGA, PCI)", 230, 100, 100, 125,
    ATI_CHIP_264GTPRO | M64F_MAGIC_VRAM_SIZE },
  { PCI_CHIP_MACH64GP, "3D RAGE PRO (Mach64 GP, PQFP, PCI)", 230, 100, 100, 125,
    ATI_CHIP_264GTPRO },
  { PCI_CHIP_MACH64GQ, "3D RAGE PRO (Mach64 GQ, PQFP, PCI, limited 3D)", 230,
    100, 100, 125, ATI_CHIP_264GTPRO },

  { PCI_CHIP_MACH64LB, "3D RAGE LT PRO (Mach64 LB, AGP)", 236, 75, 100, 135,
    ATI_CHIP_264LTPRO },
  { PCI_CHIP_MACH64LD, "3D RAGE LT PRO (Mach64 LD, AGP)", 230, 100, 100, 135,
    ATI_CHIP_264LTPRO },
  { PCI_CHIP_MACH64LI, "3D RAGE LT PRO (Mach64 LI, PCI)", 230, 100, 100, 135,
    ATI_CHIP_264LTPRO | M64F_G3_PB_1_1 | M64F_G3_PB_1024x768 },
  { PCI_CHIP_MACH64LP, "3D RAGE LT PRO (Mach64 LP, PCI)", 230, 100, 100, 135,
    ATI_CHIP_264LTPRO | M64F_G3_PB_1024x768 },
  { PCI_CHIP_MACH64LQ, "3D RAGE LT PRO (Mach64 LQ, PCI)", 230, 100, 100, 135,
    ATI_CHIP_264LTPRO },

  { PCI_CHIP_MACH64GM, "3D RAGE XL (Mach64 GM, AGP 2x)", 230, 83, 63, 135,
    ATI_CHIP_264XL },
  { PCI_CHIP_MACH64GN, "3D RAGE XC (Mach64 GN, AGP 2x)", 230, 83, 63, 135,
    ATI_CHIP_264XL },
  { PCI_CHIP_MACH64GO, "3D RAGE XL (Mach64 GO, PCI-66)", 230, 83, 63, 135,
    ATI_CHIP_264XL },
  { PCI_CHIP_MACH64GL, "3D RAGE XC (Mach64 GL, PCI-66)", 230, 83, 63, 135,
    ATI_CHIP_264XL },
  { PCI_CHIP_MACH64GR, "3D RAGE XL (Mach64 GR, PCI-33)", 230, 83, 63, 135,
    ATI_CHIP_264XL | M64F_SDRAM_MAGIC_PLL },
  { PCI_CHIP_MACH64GS, "3D RAGE XC (Mach64 GS, PCI-33)", 230, 83, 63, 135,
    ATI_CHIP_264XL },

  { PCI_CHIP_MACH64LM, "3D RAGE Mobility P/M (Mach64 LM, AGP 2x)", 230, 83, 125,
    135, ATI_CHIP_MOBILITY },
  { PCI_CHIP_MACH64LN, "3D RAGE Mobility L (Mach64 LN, AGP 2x)", 230, 83, 125,
    135, ATI_CHIP_MOBILITY },
  { PCI_CHIP_MACH64LR, "3D RAGE Mobility P/M (Mach64 LR, PCI)", 230, 83, 125,
    135, ATI_CHIP_MOBILITY },
  { PCI_CHIP_MACH64LS, "3D RAGE Mobility L (Mach64 LS, PCI)", 230, 83, 125, 135,
    ATI_CHIP_MOBILITY },
...
static int aty_var_to_crtc(const struct fb_info *info,
  ...
  u32 sync, vmode;
  u32 h_total, h_disp, h_sync_strt, h_sync_end, h_sync_dly, h_sync_wid,
      h_sync_pol;
  ...
  if (par->lcd_table != 0) {
    ...
    if (xres < par->lcd_width && crtc->lcd_gen_cntl & LCD_ON) {
      do {
        ...
        if ((!Remainder && ((nStretch > 2)))
          ...
          static const char StretchLoops[] = {
            10, 12, 13, 15, 16
          };
    ...
    if (vdisplay < par->lcd_height && crtc->lcd_gen_cntl & LCD_ON) {
      crtc->vert_stretching = (VERT_STRETCH_USE0 | VERT_STRETCH_EN
          | (((vdisplay * (VERT_STRETCH_RATIO0 + 1)) / par->lcd_height)
          & VERT_STRETCH_RATIO0));
      if (!M64_HAS(LT_LCD_REGS)
  ...
  if (!M64_HAS(INTEGRATED)) {
    ...
    if (M64_HAS(CT_BUS)) {
      ...
      aty_st_le32(BUS_CNTL,
          0x7b33a040 | (par->aux_start ? BUS_APER_REG_DIS : 0), par);
    } else {
      /* GT */
      aty_st_le32(DAC_CNTL, 0x86010102, par);
      aty_st_le32(BUS_CNTL,
          0x7b23a040 | (par->aux_start ? BUS_APER_REG_DIS : 0), par);
      aty_st_le32(EXT_MEM_CNTL, aty_ld_le32(EXT_MEM_CNTL, par) | 0x5000001,
          par);
    }
    aty_st_le32(MEM_CNTL, tmp, par);
  }
...
static int atyfb_setup_sparc(struct pci_dev *pdev, struct fb_info *info,
  ...
  if (dp == of_console_device) {
     ...
     */
    P
      = aty_postdividers[((pll_regs[VCLK_POST_DIV] >>
            ((clock_cntl & 3) << 1)) & 3)
...
static void aty_init_lcd(struct atyfb_par *par, u32 bios_base) {
  ...
  if (par->lcd_table != 0) {
    ...
    u16 *lcdmodeptr;
    u32 format;
    u8 lcd_refresh_rates[16] = {
      50, 56, 60, 67, 70, 72, 75, 76, 85,
