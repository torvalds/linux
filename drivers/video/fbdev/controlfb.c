...
static inline int PAR_EQUAL(struct fb_par_control *x,
 ...
 */
static int controlfb_check_var(struct fb_var_screeninfo *var,
    struct fb_info *info) {
  struct fb_par_control par;
  int err;
 ...
 */
static void __init control_init_info(struct fb_info *info,
    struct fb_info_control *p) {
  /* Fill fb_info */
  info->par = &p->par;
