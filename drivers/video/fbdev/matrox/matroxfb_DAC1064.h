...
#define     M1064_XCURCTRL_DIS    0x00  /* transparent, transparent,
...
#define      M1064_XMULCTRL_DEPTH_15BPP_1BPP  0x01  /* 15 bpp paletized + 1 bpp
                                                     * overlay */
#define      M1064_XMULCTRL_DEPTH_16BPP   0x02  /* 16 bpp paletized */
#define      M1064_XMULCTRL_DEPTH_24BPP   0x03  /* 24 bpp paletized */
#define      M1064_XMULCTRL_DEPTH_24BPP_8BPP  0x04  /* 24 bpp direct + 8 bpp
                                                     * overlay paletized */
#define      M1064_XMULCTRL_2G8V16    0x05  /* 15 bpp video direct, half xres,
                                             * 8bpp paletized */
#define      M1064_XMULCTRL_G16V16    0x06  /* 15 bpp video, 15bpp graphics, one
                                             * of them paletized */
#define      M1064_XMULCTRL_DEPTH_32BPP   0x07  /* 24 bpp paletized + 8 bpp
                                                 * unused */
...
enum POS1064 {
  ...
  POS1064_XCRCBITSEL,
  POS1064_XCOLKEYMASKL, POS1064_XCOLKEYMASKH, POS1064_XCOLKEYL,
  POS1064_XCOLKEYH,
