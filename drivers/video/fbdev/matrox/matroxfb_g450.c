...
{ { { V4L2_CID_BRIGHTNESS, V4L2_CTRL_TYPE_INTEGER,
      ...
      0, }, offsetof(struct matrox_fb_info, altout.tvo_params.brightness) },
  { { V4L2_CID_CONTRAST, V4L2_CTRL_TYPE_INTEGER,
      "contrast",
      0, 1023, 1, 127,
      0, }, offsetof(struct matrox_fb_info, altout.tvo_params.contrast) },
  { { V4L2_CID_SATURATION, V4L2_CTRL_TYPE_INTEGER,
      "saturation",
      0, 255, 1, 165,
      0, }, offsetof(struct matrox_fb_info, altout.tvo_params.saturation) },
  { { V4L2_CID_HUE, V4L2_CTRL_TYPE_INTEGER,
      "hue",
      0, 255, 1, 0,
      0, }, offsetof(struct matrox_fb_info, altout.tvo_params.hue) },
  { { MATROXFB_CID_TESTOUT, V4L2_CTRL_TYPE_BOOLEAN,
      "test output",
      0, 1, 1, 0,
      0, }, offsetof(struct matrox_fb_info, altout.tvo_params.testout) }, };
...
static inline int *get_ctrl_ptr(struct matrox_fb_info *minfo,
    unsigned int idx) {
...
static void cve2_init_TVdata(int norm, struct mavenregs *data,
  ...
  static const struct mavenregs palregs = { {
                                              0x2A, 0x09, 0x8A, 0xCB, /* 00:
                                                                       * chroma
                                                                       * subcarrier
                                                                       * */
                                              0x00,
                                              0x00, /* test */
                                              0xF9, /* modified by code (F9
                                                     * written...) */
                                              0x00, /* ? not written */
                                              0x7E, /* 08 */
                                              0x44, /* 09 */
...
static int matroxfb_g450_compute(void *md, struct my_timming *mt) {
  ...
  if (mt->crtc == MATROXFB_SRC_CRTC2
     ...
     * startup may fail */
    mt->mnp
      = matroxfb_g450_setclk(minfo, mt->pixclock,
        (mt->crtc
