...
enum {
  M_SYSTEM_PLL, M_PIXEL_PLL_A, M_PIXEL_PLL_B, M_PIXEL_PLL_C, M_VIDEO_PLL
};
...
enum mga_chip {
  MGA_2064, MGA_2164, MGA_1064, MGA_1164, MGA_G100, MGA_G200, MGA_G400,
  MGA_G450, MGA_G550
};
...
#define M_OPMODE_4BPP (M_OPMODE_DMA_LE | M_OPMODE_DIR_LE | M_OPMODE_DMA_BLIT) /*
                                                                               * TODO
                                                                               * */
#define M_OPMODE_8BPP (M_OPMODE_DMA_LE | M_OPMODE_DIR_BE_8BPP  \
  | M_OPMODE_DMA_BLIT)
#define M_OPMODE_16BPP  (M_OPMODE_DMA_LE | M_OPMODE_DIR_BE_16BPP \
  | M_OPMODE_DMA_BLIT)
#define M_OPMODE_24BPP  (M_OPMODE_DMA_LE | M_OPMODE_DIR_BE_8BPP  \
  | M_OPMODE_DMA_BLIT) /* TODO, ?32 */
#define M_OPMODE_32BPP  (M_OPMODE_DMA_LE | M_OPMODE_DIR_BE_32BPP \
  | M_OPMODE_DMA_BLIT)
#else
...
#define WaitTillIdle()  do { mga_inl(M_STATUS); \
...
#define matroxfb_DAC_lock_irqsave(flags)      spin_lock_irqsave( \
    &minfo->lock.DAC, flags)
#define matroxfb_DAC_unlock_irqrestore(flags) spin_unlock_irqrestore( \
    &minfo->lock.DAC, flags)
...
extern void matroxfb_var2my(struct fb_var_screeninfo *fvsi,
