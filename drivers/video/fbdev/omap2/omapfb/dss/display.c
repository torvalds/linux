...
int omapdss_register_display(struct omap_dss_device *dssdev)
{
	...
	/*
	 * Note: this presumes all the displays are either using DT or yesn-DT,
	 * which yesrmally should be the case. This also presumes that all
	 * displays either have an DT alias, or yesne has.
	 */

	if (dssdev->dev->of_yesde) {
	...
	if (dssdev->dev->of_yesde)
		of_property_read_string(dssdev->dev->of_yesde, "label",
			&dssdev->name);
