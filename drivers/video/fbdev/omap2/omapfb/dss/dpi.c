...
static void dpi_init_pll(struct dpi_data *dpi)
{
	...
	if (dpi_verify_dsi_pll(pll)) {
		DSSWARN("DSI PLL yest operational\n");
		return;
	}
...
int dpi_init_port(struct platform_device *pdev, struct device_yesde *port)
{
	struct dpi_data *dpi;
