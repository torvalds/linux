...
static struct omap_dss_device *dss_mgr_get_device(
    struct omap_overlay_manager *mgr) {
...
static int dss_mgr_register_framedone_handler_compat(
    struct omap_overlay_manager *mgr,
...
static void dss_mgr_unregister_framedone_handler_compat(
    struct omap_overlay_manager *mgr,
    void (*handler)(void *), void *data) {
  struct mgr_priv_data *mp = get_mgr_priv(mgr);
