...
#define VB_SISBRIDGE    (VB_301 | VB_301B | VB_301C | VB_302B | VB_301LV \
  | VB_302LV | VB_302ELV)
...
#define VB2_VIDEOBRIDGE   (VB2_SISBRIDGE | VB2_LVDS | VB2_CHRONTEL \
  | VB2_CONEXANT)
...
#define VB2_LCDOVER1280BRIDGE (VB2_301C | VB2_307T | VB2_302LV | VB2_302ELV \
  | VB2_307LV)
...
unsigned short SiS_GetModeID_LCD(int VGAEngine, unsigned int VBFlags,
    int HDisplay,
    int VDisplay, int Depth, bool FSTN,
    unsigned short CustomT, int LCDwith, int LCDheight,
    unsigned int VBFlags2);
unsigned short SiS_GetModeID_TV(int VGAEngine, unsigned int VBFlags,
    int HDisplay,
    int VDisplay, int Depth, unsigned int VBFlags2);
unsigned short SiS_GetModeID_VGA2(int VGAEngine, unsigned int VBFlags,
    int HDisplay,
    int VDisplay, int Depth, unsigned int VBFlags2);
...
unsigned short SiS_GetRefCRTVCLK(struct SiS_Private *SiS_Pr,
    unsigned short Index, int UseWide);
...
void SiS_GetFIFOThresholdIndex300(struct SiS_Private *SiS_Pr,
    unsigned short *idx1,
    unsigned short *idx2);
unsigned short SiS_GetFIFOThresholdB300(unsigned short idx1,
    unsigned short idx2);
unsigned short SiS_GetLatencyFactor630(struct SiS_Private *SiS_Pr,
...
extern unsigned short SiS_GetRatePtr(struct SiS_Private *SiS_Pr,
    unsigned short ModeNo,
    unsigned short ModeIdIndex);
extern void SiS_WaitRetrace1(struct SiS_Private *SiS_Pr);
extern unsigned short SiS_GetResInfo(struct SiS_Private *SiS_Pr,
    unsigned short ModeNo,
    unsigned short ModeIdIndex);
extern unsigned short SiS_GetCH700x(struct SiS_Private *SiS_Pr,
    unsigned short tempax);
extern unsigned short SiS_GetVCLK2Ptr(struct SiS_Private *SiS_Pr,
    unsigned short ModeNo,
    unsigned short ModeIdIndex, unsigned short RRTI);
...
#ifdef CONFIG_FB_SIS_300
extern unsigned int sisfb_read_nbridge_pci_dword(struct SiS_Private *SiS_Pr,
    int reg);
...
extern void sisfb_write_nbridge_pci_byte(struct SiS_Private *SiS_Pr, int reg,
    unsigned char val);
extern unsigned int sisfb_read_mio_pci_word(struct SiS_Private *SiS_Pr,
    int reg);
#endif
...
void sisfb_write_nbridge_pci_dword(struct SiS_Private *SiS_Pr, int reg,
    unsigned int val);
unsigned int sisfb_read_lpc_pci_dword(struct SiS_Private *SiS_Pr, int reg);
#endif
#ifdef CONFIG_FB_SIS_315
void sisfb_write_nbridge_pci_byte(struct SiS_Private *SiS_Pr, int reg,
    unsigned char val);
...
extern unsigned short SiS_GetModeID_LCD(int VGAEngine, unsigned int VBFlags,
    int HDisplay,
    int VDisplay, int Depth, bool FSTN, unsigned short CustomT,
    int LCDwith, int LCDheight, unsigned int VBFlags2);
extern unsigned short SiS_GetModeID_TV(int VGAEngine, unsigned int VBFlags,
    int HDisplay,
    int VDisplay, int Depth, unsigned int VBFlags2);
extern unsigned short SiS_GetModeID_VGA2(int VGAEngine, unsigned int VBFlags,
    int HDisplay,
    int VDisplay, int Depth, unsigned int VBFlags2);
...
extern bool sisfb_gettotalfrommode(struct SiS_Private *SiS_Pr,
    unsigned char modeno,
    int *htotal, int *vtotal, unsigned char rateindex);
extern int sisfb_mode_rate_to_dclock(struct SiS_Private *SiS_Pr,
    unsigned char modeno, unsigned char rateindex);
extern int sisfb_mode_rate_to_ddata(struct SiS_Private *SiS_Pr,
    unsigned char modeno,
