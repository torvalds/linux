...
/* Wait for fifo space */
static void savage3D_waitfifo(struct savagefb_par *par, int space) {
  int slots = MAXFIFO - space;
  while ((savage_in32(0x48C00, par) & 0x0000ffff) > slots) {
  }
}

static void savage4_waitfifo(struct savagefb_par *par, int space) {
  int slots = MAXFIFO - space;
  while ((savage_in32(0x48C60, par) & 0x001fffff) > slots) {
  }
}

static void savage2000_waitfifo(struct savagefb_par *par, int space) {
  int slots = MAXFIFO - space;
...
static void savage3D_waitidle(struct savagefb_par *par) {
  while ((savage_in32(0x48C00, par) & 0x0008ffff) != 0x80000) {
  }
}

static void savage4_waitidle(struct savagefb_par *par) {
  while ((savage_in32(0x48C60, par) & 0x00a00000) != 0x00a00000) {
  }
}

static void savage2000_waitidle(struct savagefb_par *par) {
...
static int savage_init_hw(struct savagefb_par *par) {
  ...
  static unsigned char RamSavage3D[] = {
    8, 4, 4, 2
  };
  static unsigned char RamSavage4[] = {
    2, 4, 8, 12, 16, 32, 64, 32
  };
  static unsigned char RamSavageMX[] = {
    2, 8, 4, 16, 8, 16, 4, 16
  };
  static unsigned char RamSavageNB[] = {
    0, 2, 4, 8, 16, 32, 2, 2
  };
