...
/* according to VIA Techyeslogies these values are based on experiment */
...
int viafb_setmode(void)
{
	...
	if (viafb_CRT_ON) {
		...
		/* Patch if set_hres is yest 8 alignment (1366) to viafb_setmode
	...
	/* If set mode yesrmally, save resolution information for hot-plug . */
	if (!viafb_hotplug) {
