...
//#define INTR_RESERVED0 		(0x0028)
//#define INTR_RESERVED1 		(0x002c)
...
#define v_WIN0_ACT_WIDTH(x)		(((x)&0x1fff)<<0)
#define v_WIN0_ACT_HEIGHT(x)		(((x)&0x1fff)<<16)
#define m_WIN0_ACT_WIDTH 		(0x1fff<<0)
#define m_WIN0_ACT_HEIGHT 		(0x1fff<<16)

#define WIN0_DSP_INFO 		(0x004c)
#define v_WIN0_DSP_WIDTH(x)		(((x)&0xfff)<<0)
#define v_WIN0_DSP_HEIGHT(x)		(((x)&0xfff)<<16)
...
#define v_WIN1_ACT_WIDTH(x)		(((x)&0x1fff)<<0)
#define v_WIN1_ACT_HEIGHT(x)		(((x)&0x1fff)<<16)
#define m_WIN1_ACT_WIDTH		(0x1fff<<0)
#define m_WIN1_ACT_HEIGHT		(0x1fff<<16)

#define WIN1_DSP_INFO 		(0x008c)
#define v_WIN1_DSP_WIDTH(x)		(((x)&0xfff)<<0)
#define v_WIN1_DSP_HEIGHT(x)		(((x)&0xfff)<<16)
...
#define v_WIN2_DSP_WIDTH0(x)		(((x)&0xfff)<<0)
#define v_WIN2_DSP_HEIGHT0(x)		(((x)&0xfff)<<16)
...
#define v_WIN2_DSP_WIDTH1(x)		(((x)&0xfff)<<0)
#define v_WIN2_DSP_HEIGHT1(x)		(((x)&0xfff)<<16)
...
#define v_WIN2_DSP_WIDTH2(x)		(((x)&0xfff)<<0)
#define v_WIN2_DSP_HEIGHT2(x)		(((x)&0xfff)<<16)
...
#define v_WIN2_DSP_WIDTH3(x)		(((x)&0xfff)<<0)
#define v_WIN2_DSP_HEIGHT3(x)		(((x)&0xfff)<<16)
...
#define v_WIN3_DSP_WIDTH0(x)		(((x)&0xfff)<<0)
#define v_WIN3_DSP_HEIGHT0(x)		(((x)&0xfff)<<16)
...
#define v_WIN3_DSP_WIDTH1(x)		(((x)&0xfff)<<0)
#define v_WIN3_DSP_HEIGHT1(x)		(((x)&0xfff)<<16)
...
#define v_WIN3_DSP_WIDTH2(x)		(((x)&0xfff)<<0)
#define v_WIN3_DSP_HEIGHT2(x)		(((x)&0xfff)<<16)
...
#define v_WIN3_DSP_WIDTH3(x)		(((x)&0xfff)<<0)
#define v_WIN3_DSP_HEIGHT3(x)		(((x)&0xfff)<<16)
...
//#define POST_SCL_FACTOR_CBR 	(0x017c)//reserved
