...
#define ADP8860_BLMX1 0x09 /* Backlight (Brightness Level 1-daylight) maximum
                            * current */
#define ADP8860_BLDM1 0x0A /* Backlight (Brightness Level 1-daylight) dim
                            * current */
#define ADP8860_BLMX2 0x0B /* Backlight (Brightness Level 2-office) maximum
                            * current */
#define ADP8860_BLDM2 0x0C /* Backlight (Brightness Level 2-office) dim current
                            * */
#define ADP8860_BLMX3 0x0D /* Backlight (Brightness Level 3-dark) maximum
                            * current */
...
#define ADP8860_PH1LEVL 0x21 /* First phototransistor ambient light level-low
                              * byte register */
#define ADP8860_PH1LEVH 0x22 /* First phototransistor ambient light level-high
                              * byte register */
#define ADP8860_PH2LEVL 0x23 /* Second phototransistor ambient light level-low
                              * byte register */
#define ADP8860_PH2LEVH 0x24 /* Second phototransistor ambient light level-high
                              * byte register */
...
#define BL_CFGR_VAL(law, \
      blv) ((((blv) & CFGR_BLV_MASK) << CFGR_BLV_SHIFT) | ((0x3 & (law)) << 1))
...
static int adp8860_set_bits(struct i2c_client *client, int reg,
    uint8_t bit_mask) {
...
static int adp8860_clr_bits(struct i2c_client *client, int reg,
    uint8_t bit_mask) {
  struct adp8860_bl *data = i2c_get_clientdata(client);
  uint8_t reg_val;
  int ret;
