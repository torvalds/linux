...
#define ADP8870_BLMX1 0x0A  /* Backlight (Brightness Level 1-daylight) maximum
                             * current */
#define ADP8870_BLDM1 0x0B  /* Backlight (Brightness Level 1-daylight) dim
                             * current */
#define ADP8870_BLMX2 0x0C  /* Backlight (Brightness Level 2-bright) maximum
                             * current */
#define ADP8870_BLDM2 0x0D  /* Backlight (Brightness Level 2-bright) dim current
                             * */
#define ADP8870_BLMX3 0x0E  /* Backlight (Brightness Level 3-office) maximum
                             * current */
#define ADP8870_BLDM3 0x0F  /* Backlight (Brightness Level 3-office) dim current
                             * */
#define ADP8870_BLMX4 0x10  /* Backlight (Brightness Level 4-indoor) maximum
                             * current */
#define ADP8870_BLDM4 0x11  /* Backlight (Brightness Level 4-indoor) dim current
                             * */
#define ADP8870_BLMX5 0x12  /* Backlight (Brightness Level 5-dark) maximum
                             * current */
...
#define ADP8870_ISC7  0x25  /* Independent Sink Current LED7 (Brightness Level
                             * 1-daylight) */
#define ADP8870_ISC7_L2 0x26  /* Independent Sink Current LED7 (Brightness Level
                               * 2-bright) */
#define ADP8870_ISC7_L3 0x27  /* Independent Sink Current LED7 (Brightness Level
                               * 3-office) */
#define ADP8870_ISC7_L4 0x28  /* Independent Sink Current LED7 (Brightness Level
                               * 4-indoor) */
#define ADP8870_ISC7_L5 0x29  /* Independent Sink Current LED7 (Brightness Level
                               * 5-dark) */
...
#define ADP8870_PH1LEVL 0x40  /* First phototransistor ambient light level-low
                               * byte register */
#define ADP8870_PH1LEVH 0x41  /* First phototransistor ambient light level-high
                               * byte register */
#define ADP8870_PH2LEVL 0x42  /* Second phototransistor ambient light level-low
                               * byte register */
#define ADP8870_PH2LEVH 0x43  /* Second phototransistor ambient light level-high
                               * byte register */

#define ADP8870_MANUFID   0x3  /* Analog Devices AD8870 Manufacturer and device
                                * ID */
...
static int adp8870_set_bits(struct i2c_client *client, int reg,
    uint8_t bit_mask) {
...
static int adp8870_clr_bits(struct i2c_client *client, int reg,
    uint8_t bit_mask) {
  struct adp8870_bl *data = i2c_get_clientdata(client);
  uint8_t reg_val;
  int ret;
