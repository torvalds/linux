...
static int sx9310_read_samp_freq(struct sx_common_data *data, int *val,
    int *val2) {
  unsigned int regval;
  int ret;
...
static int sx9310_set_samp_freq(struct sx_common_data *data, int val,
    int val2) {
  int i;
...
static const struct sx_common_reg_default *sx9310_get_default_reg(
