...
#define VCNL4040_ALS_CONF_PERS  GENMASK(3, 2) /* Ambient interrupt persistence
                                               * setting */
#define VCNL4040_PS_CONF1_PS_SHUTDOWN BIT(0)
#define VCNL4040_PS_CONF2_PS_IT GENMASK(3, 1) /* Proximity integration time */
#define VCNL4040_CONF1_PS_PERS  GENMASK(5, 4) /* Proximity interrupt persistence
                                               * setting */
...
static int vcnl4040_read_als_it(struct vcnl4000_data *data, int *val,
    int *val2) {
  int ret;
  ret = i2c_smbus_read_word_data(data->client, VCNL4200_AL_CONF);
  if (ret < 0) {
...
static ssize_t vcnl4040_read_als_period(struct vcnl4000_data *data, int *val,
    int *val2) {
  int ret, ret_pers, it;
  int64_t val_c;
  ret = i2c_smbus_read_word_data(data->client, VCNL4200_AL_CONF);
...
static ssize_t vcnl4040_write_als_period(struct vcnl4000_data *data, int val,
    int val2) {
  unsigned int i;
  int ret, it;
  u16 regval;
...
static ssize_t vcnl4040_read_ps_period(struct vcnl4000_data *data, int *val,
    int *val2) {
  int ret, ret_pers, it;
  ret = i2c_smbus_read_word_data(data->client, VCNL4200_PS_CONF1);
  if (ret < 0) {
...
static ssize_t vcnl4040_write_ps_period(struct vcnl4000_data *data, int val,
    int val2) {
  int ret, it, i;
  u16 regval;
  ret = i2c_smbus_read_word_data(data->client, VCNL4200_PS_CONF1);
...
static ssize_t vcnl4040_read_ps_oversampling_ratio(struct vcnl4000_data *data,
    int *val) {
  int ret;
  ret = i2c_smbus_read_word_data(data->client, VCNL4200_PS_CONF3);
  if (ret < 0) {
...
static ssize_t vcnl4040_write_ps_oversampling_ratio(struct vcnl4000_data *data,
    int val) {
  unsigned int i;
  int ret;
  u16 regval;
...
static ssize_t vcnl4040_read_ps_calibbias(struct vcnl4000_data *data, int *val,
    int *val2) {
  int ret;
  ret = i2c_smbus_read_word_data(data->client, VCNL4200_PS_CONF3);
  if (ret < 0) {
...
static ssize_t vcnl4040_write_ps_calibbias(struct vcnl4000_data *data,
    int val) {
  unsigned int i;
  int ret;
  u16 regval;
