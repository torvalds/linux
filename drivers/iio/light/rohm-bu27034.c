 ...
 * would not really be tied to the sensor toggling the valid bit. This would
 *also
...
static int bu27034_write_gain_sel(struct bu27034_data *data, int chan,
    int sel) {
 ...
 *  => (34.0736 * ch0 / gain0 / mt + 0.90624 * ch1 / gain1 / mt) *
 *     (-0.05 * 256 * 100 * ch1 / gain1 / mt / (256 * 100 * ch0 / gain0 / mt) +
 *1.1)
 *  => (34.0736 * ch0 / gain0 / mt + 0.90624 * ch1 / gain1 / mt) *
 *     (-1280 * ch1 / (gain1 * mt * 25600 * ch0 / gain0 / mt) + 1.1)
 *  => (34.0736 * ch0 * -1280 * ch1 * gain0 * mt /( gain0 * mt * gain1 * mt *
 *25600 * ch0)
