...
static const struct regmap_access_table hmc5843_readable_table = {
		.no_ranges = hmc5843_readable_ranges,
		.n_no_ranges = ARRAY_SIZE(hmc5843_readable_ranges),
};
...
static const struct regmap_access_table hmc5843_writable_table = {
		.no_ranges = hmc5843_writable_ranges,
		.n_no_ranges = ARRAY_SIZE(hmc5843_writable_ranges),
};
...
static const struct regmap_access_table hmc5843_volatile_table = {
		.no_ranges = hmc5843_volatile_ranges,
		.n_no_ranges = ARRAY_SIZE(hmc5843_volatile_ranges),
};
