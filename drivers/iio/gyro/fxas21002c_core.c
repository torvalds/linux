...
static int fxas21002c_odr_hz_from_value(struct fxas21002c_data *data,
    u8 value) {
...
static int fxas21002c_lpf_bw_from_value(struct fxas21002c_data *data,
    u8 value) {
...
static int fxas21002c_hpf_sel_from_value(struct fxas21002c_data *data,
    u8 value) {
...
static struct attribute *fxas21002c_attributes[] = {
  ...
  &iio_const_attr_in_anglvel_filter_low_pass_3db_frequency_available.dev_attr.
  attr,
  &iio_const_attr_in_anglvel_filter_high_pass_3db_frequency_available.dev_attr.
  attr,
