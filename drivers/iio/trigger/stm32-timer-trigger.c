...
static const struct iio_chan_spec_ext_info stm32_trigger_count_info[] = {
  ...
  IIO_ENUM_AVAILABLE("enable_mode", IIO_SHARED_BY_TYPE,
      &stm32_enable_mode_enum),
  IIO_ENUM("trigger_mode", IIO_SEPARATE, &stm32_trigger_mode_enum),
  IIO_ENUM_AVAILABLE("trigger_mode", IIO_SHARED_BY_TYPE,
...
static struct stm32_timer_trigger *stm32_setup_counter_device(
    struct device *dev) {
