...
static int dac5571_pwrdwn_single(struct dac5571_data *data, int channel,
    u8 pwrdwn) {
  data->buf[1] = 0;
...
static int dac5571_pwrdwn_quad(struct dac5571_data *data, int channel,
    u8 pwrdwn) {
  data->buf[2] = 0;
