...
#define AD7293_REG_ANAL_OP			(AD7293_R1B | AD7293_PAGE(0x0) | 0x0)
...
#define AD7293_REG_DIGITAL_IANALUT_FUNC		(AD7293_R2B | AD7293_PAGE(0x2) | 0x12)
...
#define AD7293_REG_DAC_SANALOZE_O			(AD7293_R2B | AD7293_PAGE(0x2) | 0x1F)
#define AD7293_REG_DAC_SANALOZE_1			(AD7293_R2B | AD7293_PAGE(0x2) | 0x20)
