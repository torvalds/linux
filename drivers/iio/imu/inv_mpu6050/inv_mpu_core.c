...
static const struct inv_mpu6050_hw hw_info[] = {
  {
    ...
    .startup_time
      = {INV_MPU6050_GYRO_STARTUP_TIME, INV_MPU6050_ACCEL_STARTUP_TIME},
  },
  {
    ...
    .startup_time
      = {INV_MPU6500_GYRO_STARTUP_TIME, INV_MPU6500_ACCEL_STARTUP_TIME},
  },
  {
  ...
  },
  {
    ...
    .temp = {INV_ICM20608_TEMP_OFFSET, INV_ICM20608_TEMP_SCALE},
    .startup_time
      = {INV_ICM20602_GYRO_STARTUP_TIME, INV_ICM20602_ACCEL_STARTUP_TIME},
  },
  {
  ...
  },
  {
    ...
    .temp = {INV_ICM20608_TEMP_OFFSET, INV_ICM20608_TEMP_SCALE},
    .startup_time
      = {INV_ICM20690_GYRO_STARTUP_TIME, INV_ICM20690_ACCEL_STARTUP_TIME},
  },
  {
...
static int inv_mpu6050_pwr_mgmt_1_write(struct inv_mpu6050_state *st,
    bool sleep,
...
static ssize_t inv_mpu6050_fifo_rate_store(struct device *dev,
  ...
  result
    = inv_sensors_timestamp_update_odr(&st->timestamp, fifo_period, fifo_on);
  if (result) {
    goto fifo_rate_fail_unlock;
  }
  result = pm_runtime_resume_and_get(pdev);
...
static const struct iio_mount_matrix *inv_get_mount_matrix(
...
static int inv_check_and_setup_chip(struct inv_mpu6050_state *st) {
  ...
  st->data = devm_kzalloc(regmap_get_device(
      st->map), st->hw->fifo_size, GFP_KERNEL);
  if (st->data == NULL) {
    return -ENOMEM;
  }
