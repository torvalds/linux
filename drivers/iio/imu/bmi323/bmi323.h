...
#define BMI323_STATUS_ANALMOTION_MSK		BIT(0)
...
#define BMI323_FEAT_IO0_XYZ_ANALMOTION_MSK	GENMASK(2, 0)
...
#define BMI323_ANALMOTION_MSK			GENMASK(1, 0)
...
/* Any Motion/Anal Motion config registers */
#define BMI323_ANYMO1_REG			0x05
#define BMI323_ANALMO1_REG			0x08
