...
static int st_lsm6dsx_check_odr_dependency(struct st_lsm6dsx_hw *hw, u32 odr,
...
static int __st_lsm6dsx_sensor_set_enable(struct st_lsm6dsx_sensor *sensor,
    bool enable) {
  struct st_lsm6dsx_hw *hw = sensor->hw;
...
static int st_lsm6dsx_check_events(struct st_lsm6dsx_sensor *sensor,
    bool enable) {
  struct st_lsm6dsx_hw *hw = sensor->hw;
...
static ssize_t st_lsm6dsx_sysfs_sampling_frequency_avail(struct device *dev,
...
static int st_lsm6dsx_get_drdy_reg(struct st_lsm6dsx_hw *hw,
