...
static inline int st_lsm6dsx_update_bits_locked(struct st_lsm6dsx_hw *hw,
    unsigned int addr,
...
static inline int st_lsm6dsx_read_locked(struct st_lsm6dsx_hw *hw,
    unsigned int addr,
...
static inline int st_lsm6dsx_write_locked(struct st_lsm6dsx_hw *hw,
    unsigned int addr,
    unsigned int val) {
  int err;
  mutex_lock(&hw->page_lock);
...
static inline const struct iio_mount_matrix *st_lsm6dsx_get_mount_matrix(
    const struct iio_dev *iio_dev,
    const struct iio_chan_spec *chan) {
...
static inline int st_lsm6dsx_device_set_enable(struct st_lsm6dsx_sensor *sensor,
    bool enable) {
