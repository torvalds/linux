...
static const unsigned int ad74115_dac_rate_step_tbl[][3] = {
  { AD74115_SLEW_MODE_DISABLED },
  { AD74115_SLEW_MODE_LINEAR, AD74115_SLEW_STEP_0_8_PERCENT,
    AD74115_SLEW_RATE_4KHZ },
  { AD74115_SLEW_MODE_LINEAR, AD74115_SLEW_STEP_1_5_PERCENT,
    AD74115_SLEW_RATE_4KHZ },
  { AD74115_SLEW_MODE_LINEAR, AD74115_SLEW_STEP_6_1_PERCENT,
    AD74115_SLEW_RATE_4KHZ },
  { AD74115_SLEW_MODE_LINEAR, AD74115_SLEW_STEP_22_2_PERCENT,
    AD74115_SLEW_RATE_4KHZ },
  { AD74115_SLEW_MODE_LINEAR, AD74115_SLEW_STEP_0_8_PERCENT,
    AD74115_SLEW_RATE_64KHZ },
  { AD74115_SLEW_MODE_LINEAR, AD74115_SLEW_STEP_1_5_PERCENT,
...
static int _ad74115_find_tbl_index(const unsigned int *tbl,
...
static int ad74115_reg_write(void *context, unsigned int reg,
    unsigned int val) {
...
static int ad74115_reg_read(void *context, unsigned int reg,
    unsigned int *val) {
  struct ad74115_state *st = context;
...
static int ad74115_gpio_config_set(struct ad74115_state *st,
    unsigned int offset,
...
static int ad74115_gpio_get_direction(struct gpio_chip *gc,
    unsigned int offset) {
  struct ad74115_state *st = gpiochip_get_data(gc);
  unsigned int val;
  int ret;
  ...
  return FIELD_GET(AD74115_GPIO_CONFIG_SELECT_MASK,
      val) == AD74115_GPIO_CONFIG_INPUT;
}

static int ad74115_gpio_direction_input(struct gpio_chip *gc,
    unsigned int offset) {
  struct ad74115_state *st = gpiochip_get_data(gc);
  return ad74115_gpio_config_set(st, offset, AD74115_GPIO_CONFIG_INPUT);
}

static int ad74115_gpio_direction_output(struct gpio_chip *gc,
    unsigned int offset,
    int value) {
  struct ad74115_state *st = gpiochip_get_data(gc);
  return ad74115_gpio_config_set(st, offset,
      AD74115_GPIO_CONFIG_OUTPUT_BUFFERED);
}
...
static void ad74115_gpio_set(struct gpio_chip *gc, unsigned int offset,
    int value) {
  struct ad74115_state *st = gpiochip_get_data(gc);
  struct device *dev = &st->spi->dev;
  int ret;
...
static int ad74115_set_comp_debounce(struct ad74115_state *st,
    unsigned int val) {
...
static const struct ad74115_channels ad74115_channels_map[AD74115_CH_FUNC_NUM]
  ...
  [AD74115_CH_FUNC_2_WIRE_RESISTANCE_INPUT] = AD74115_CHANNELS(
      2_wire_resistance_input),
  [AD74115_CH_FUNC_3_4_WIRE_RESISTANCE_INPUT] = AD74115_CHANNELS(
      3_4_wire_resistance_input),

  [AD74115_CH_FUNC_DIGITAL_INPUT_LOGIC] = AD74115_CHANNELS(digital_input_logic),

  [AD74115_CH_FUNC_DIGITAL_INPUT_LOOP_POWER] = AD74115_CHANNELS(
      digital_input_loop),
  };
