...
static int scd4x_write(struct scd4x_state *state, enum scd4x_cmd cmd,
    uint16_t arg) {
...
static int scd4x_read_avail(struct iio_dev *indio_dev,
...
static int scd4x_write_raw(struct iio_dev *indio_dev,
    struct iio_chan_spec const *chan,
...
static int scd4x_probe(struct i2c_client *client) {
  static const unsigned long scd4x_scan_masks[] = {
    0x07, 0x00
  };
