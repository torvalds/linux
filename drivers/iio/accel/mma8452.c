...
static int mma8452_get_scale_index(struct mma8452_data *data, int val,
    int val2) {
...
static int mma8452_read_hp_filter(struct mma8452_data *data, int *hz,
    int *uHz) {
  int j, i, ret;
...
static const struct iio_mount_matrix *mma8452_get_mount_matrix(
