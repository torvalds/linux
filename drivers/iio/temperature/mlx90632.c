...
#define MLX90632_MTYP_STATUS_EXTENDED MLX90632_MTYP_STATUS( \
...
#define MLX90632_MEAS_MAX_TIME 2000 /* Max measurement time in ms for the lowest
                                     * refresh rate */
...
/**
 * mlx90632_perform_measurement_burst() - Trigger and retrieve current
 *measurement
...
static int mlx90632_read_object_raw_extended(struct regmap *regmap,
    s16 *object_new_raw) {
  unsigned int read_tmp;
  s32 read;
  int ret;
...
static int mlx90632_read_all_channel_extended(struct mlx90632_data *data,
  ...
  ret = mlx90632_read_ambient_raw_extended(data->regmap, ambient_new_raw,
      ambient_old_raw);
read_unlock:
  mutex_unlock(&data->lock);
  return ret;
...
static s64 mlx90632_preprocess_temp_obj_extended(s16 object_new_raw,
    s16 ambient_new_raw,
    s16 ambient_old_raw, s16 Ka) {
  s64 VR_IR, kKa, tmp;
  kKa = ((s64) Ka * 1000LL) >> 10ULL;
...
static s32 mlx90632_calc_temp_object_extended(s64 object, s64 ambient,
    s64 reflected,
...
/**
 * mlx90632_pm_interraction_wakeup() - Measure time between user interactions to
 *change powermode
 ...
 *MLX90632_MEAS_MAX_TIME. Update the
...
MODULE_DESCRIPTION(
    "Melexis MLX90632 contactless Infra Red temperature sensor driver");
