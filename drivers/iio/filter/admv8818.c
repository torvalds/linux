...
static int __admv8818_read_hpf_freq(struct admv8818_state *st, u64 *hpf_freq) {
  ...
  *hpf_freq
    = div_u64(
      freq_range_hpf[hpf_band - 1][1] - freq_range_hpf[hpf_band - 1][0], 15);
...
static int __admv8818_read_lpf_freq(struct admv8818_state *st, u64 *lpf_freq) {
  ...
  *lpf_freq
    = div_u64(
      freq_range_lpf[lpf_band - 1][1] - freq_range_lpf[lpf_band - 1][0], 15);
...
static int admv8818_freq_change(struct notifier_block *nb, unsigned long action,
    void *data) {
