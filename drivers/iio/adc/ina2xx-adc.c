...
static const int ina226_conv_time_tab[] = {
...
/* Conversion times in uS. */
static const int ina219_conv_time_tab_subsample[] = {
  84, 148, 276, 532
};
static const int ina219_conv_time_tab_average[] = {
  532, 1060, 2130, 4260,
...
static const int ina219_vbus_range_tab[] = {
  1, 2
};
...
static const int ina219_vshunt_gain_tab[] = {
  125, 250, 500, 1000
};
...
static ssize_t ina2xx_shunt_resistor_show(struct device *dev,
  ...
  struct ina2xx_chip_info *chip = iio_priv(dev_to_iio_dev(dev));
  int vals[2] = {
    chip->shunt_resistor_uohm, 1000000
  };
