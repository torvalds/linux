...
static int ad7192_compute_f_order(struct ad7192_state *st, bool sinc3_en,
    bool chop_en) {
...
static int ad7192_read_raw(struct iio_dev *indio_dev,
  ...
  switch (m) {
    ...
    case IIO_CHAN_INFO_OVERSAMPLING_RATIO:
      *val
        = st->oversampling_ratio_avail[FIELD_GET(AD7192_MODE_AVG_MASK,
          st->mode)];
      return IIO_VAL_INT;
  }
  return -EINVAL;
...
static int ad7192_update_scan_mode(struct iio_dev *indio_dev,
