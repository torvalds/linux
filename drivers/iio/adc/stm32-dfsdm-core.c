 ...
 * @ipid: DFSDM identification number. Used only if hardware provides
 *identification registers
 * @num_filters: DFSDM number of filters. Unused if identification registers are
 *available
 * @num_channels: DFSDM number of channels. Unused if identification registers
 *are available
