...
static inline struct iio_chan_spec const *at91_adc_chan_get(
...
static void at91_adc_irq_mask(struct at91_adc_state *st, u32 *status,
    u32 *eoc) {
...
static u16 at91_adc_touch_x_pos(struct at91_adc_state *st) {
  st->touch_st.x_pos = at91_adc_touch_pos(st,
      st->soc_info.platform->layout->XPOSR);
...
static int at91_adc_read_position(struct at91_adc_state *st, int chan,
    u16 *val) {
  *val = 0;
