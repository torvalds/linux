 ...
 */
#define XOADC_CHAN(_dname, _presmux, _amux, _type, _prenum, _preden, _scale, \
      _amip) \
  {               \
...
static const struct xoadc_channel pm8038_xoadc_channels[] = {
  ...
  XOADC_CHAN(AMUX8, 0x00, 0x08, IIO_TEMP, 1, 1, SCALE_THERM_100K_PULLUP,
      AMUX_RSV2),
  ...
  XOADC_CHAN(INTERNAL, 0x00, 0x0c, IIO_VOLTAGE, 1, 1, SCALE_DEFAULT, AMUX_RSV1),
  XOADC_CHAN(125V, 0x00, 0x0d, IIO_VOLTAGE, 1, 1, SCALE_DEFAULT, AMUX_RSV1),
  XOADC_CHAN(INTERNAL_2, 0x00, 0x0e, IIO_VOLTAGE, 1, 1, SCALE_DEFAULT,
      AMUX_RSV1),
  XOADC_CHAN(MUXOFF, 0x00, 0x0f, IIO_TEMP, 1, 1, SCALE_XOTHERM, AMUX_RSV0),
  {}, /* Sentinel */
};
...
static const struct xoadc_channel pm8058_xoadc_channels[] = {
  ...
  XOADC_CHAN(INTERNAL_2, 0x00, 0x0e, IIO_VOLTAGE, 1, 1, SCALE_DEFAULT,
      AMUX_RSV1),
  XOADC_CHAN(MUXOFF, 0x00, 0x0f, IIO_TEMP, 1, 1, SCALE_XOTHERM, AMUX_RSV0),
  /* There are also "unity" and divided by 3 channels (prescaler) but noone is
   * using them */
  {}, /* Sentinel */
};

/*
 * The PM8921 has some pre-muxing on its channels, this comes from the vendor
 *tree
...
static const struct xoadc_channel pm8921_xoadc_channels[] = {
  ...
  XOADC_CHAN(BATT_THERM, 0x00, 0x08, IIO_TEMP, 1, 1, SCALE_THERM_100K_PULLUP,
      AMUX_RSV1),
  ...
  XOADC_CHAN(USB_SNS_DIV20, 0x01, 0x01, IIO_VOLTAGE, 1, 2, SCALE_DEFAULT,
      AMUX_RSV1),
  XOADC_CHAN(DCIN_SNS_DIV20, 0x01, 0x02, IIO_VOLTAGE, 1, 2, SCALE_DEFAULT,
      AMUX_RSV1),
  ...
  XOADC_CHAN(USB_SNS_DIV20_DIV3, 0x02, 0x01, IIO_VOLTAGE, 1, 6, SCALE_DEFAULT,
      AMUX_RSV1),
  XOADC_CHAN(DCIN_SNS_DIV20_DIV3, 0x02, 0x02, IIO_VOLTAGE, 1, 6, SCALE_DEFAULT,
      AMUX_RSV1),
  XOADC_CHAN(AMUX3_DIV3, 0x02, 0x03, IIO_VOLTAGE, 1, 3, SCALE_DEFAULT,
      AMUX_RSV1),
  XOADC_CHAN(AMUX4_DIV3, 0x02, 0x04, IIO_VOLTAGE, 1, 3, SCALE_DEFAULT,
      AMUX_RSV1),
  XOADC_CHAN(AMUX5_DIV3, 0x02, 0x05, IIO_VOLTAGE, 1, 3, SCALE_DEFAULT,
      AMUX_RSV1),
  XOADC_CHAN(AMUX6_DIV3, 0x02, 0x06, IIO_VOLTAGE, 1, 3, SCALE_DEFAULT,
      AMUX_RSV1),
  XOADC_CHAN(AMUX7_DIV3, 0x02, 0x07, IIO_VOLTAGE, 1, 3, SCALE_DEFAULT,
      AMUX_RSV1),
  XOADC_CHAN(AMUX8_DIV3, 0x02, 0x08, IIO_VOLTAGE, 1, 3, SCALE_DEFAULT,
      AMUX_RSV1),
  XOADC_CHAN(ATEST_1_DIV3, 0x02, 0x09, IIO_VOLTAGE, 1, 3, SCALE_DEFAULT,
      AMUX_RSV1),
  XOADC_CHAN(ATEST_2_DIV3, 0x02, 0x0a, IIO_VOLTAGE, 1, 3, SCALE_DEFAULT,
      AMUX_RSV1),
  XOADC_CHAN(ATEST_3_DIV3, 0x02, 0x0b, IIO_VOLTAGE, 1, 3, SCALE_DEFAULT,
      AMUX_RSV1),
  XOADC_CHAN(ATEST_4_DIV3, 0x02, 0x0c, IIO_VOLTAGE, 1, 3, SCALE_DEFAULT,
      AMUX_RSV1),
  XOADC_CHAN(ATEST_5_DIV3, 0x02, 0x0d, IIO_VOLTAGE, 1, 3, SCALE_DEFAULT,
      AMUX_RSV1),
  XOADC_CHAN(ATEST_6_DIV3, 0x02, 0x0e, IIO_VOLTAGE, 1, 3, SCALE_DEFAULT,
      AMUX_RSV1),
  XOADC_CHAN(ATEST_7_DIV3, 0x02, 0x0f, IIO_VOLTAGE, 1, 3, SCALE_DEFAULT,
      AMUX_RSV1),
  {}, /* Sentinel */
};
...
static struct pm8xxx_chan_info *pm8xxx_get_channel(struct pm8xxx_xoadc *adc,
    u8 chan) {
  int i;
...
static int pm8xxx_fwnode_xlate(struct iio_dev *indio_dev,
  ...
  if (iiospec->nargs != 2) {
    dev_err(&indio_dev->dev,
        "wrong number of arguments for %pfwP need 2 got %d\n",
        iiospec->fwnode,
        iiospec->nargs);
    return -EINVAL;
  }
