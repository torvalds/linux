...
static const int ms5637_samp_freq[6] = {
  960, 480, 240, 120, 60, 30
};

static ssize_t ms5637_show_samp_freq(struct device *dev,
...
static const struct ms_tp_data ms5805_data = {
  .name = "ms5805", .hw = &ms5637_hw_data
};

static const struct ms_tp_data ms5837_data = {
  .name = "ms5837", .hw = &ms5637_hw_data
};
...
MODULE_DESCRIPTION(
    "Measurement-Specialties ms5637 temperature & pressure driver");
