...
#define RPCIF_CMNCR_MOIIO(val)  (RPCIF_CMNCR_MOIIO0(val) \
...
#define RPCIF_PHYADD    0x0070  /* R/W available on R-Car E3/D3/V3M and
                                 * RZ/G2{E,L} */
...
#define RPCIF_PHYCNT_STRTIM(v)  (((v) & 0x7) << 15 | ((v) & 0x8) << 24) /* valid
                                                                         * for
                                                                         * R-Car
                                                                         * and
                                                                         * RZ/G2{E,H,M,N}
