...
struct tegra210_emc_table_register_offsets {
  ...
  struct tegra210_emc_per_channel_regs burst_per_channel[
    BURST_REGS_PER_CHANNEL_SIZE];
  struct tegra210_emc_per_channel_regs trim_per_channel[
    TRIM_REGS_PER_CHANNEL_SIZE];
  struct tegra210_emc_per_channel_regs vref_per_channel[
    VREF_REGS_PER_CHANNEL_SIZE];
};
