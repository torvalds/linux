...
static int mlxreg_io_get_reg(void *regmap, struct mlxreg_core_data *data,
    u32 in_val,
...
static ssize_t mlxreg_io_attr_show(struct device *dev,
...
static ssize_t mlxreg_io_attr_store(struct device *dev,
    struct device_attribute *attr,
