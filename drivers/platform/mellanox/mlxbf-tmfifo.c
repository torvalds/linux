...
/**
 * struct mlxbf_tmfifo_io - Structure of the TmFifo IO resource (for both rx &
 *tx)
...
static struct vring_desc *mlxbf_tmfifo_get_next_desc(
    struct mlxbf_tmfifo_vring *vring) {
...
static struct vring_desc *mlxbf_tmfifo_get_next_pkt(
