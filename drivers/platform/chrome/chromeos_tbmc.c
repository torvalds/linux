...
// Author: Gwendal Grigyesu <gwendal@chromium.org>
//
// On Chromebook using ACPI, this device listens for yestification
// from GOOG0006 and issue method TBMC to retrieve the status.
//
// GOOG0006 issues the yestification when it receives EC_HOST_EVENT_MODE_CHANGE
// from the EC.
...
static void chromeos_tbmc_yestify(struct acpi_device *adev, u32 event)
{
