...
/**
 * cros_ec_suspend_prepare() - Handle a suspend prepare operation for the
 *ChromeOS EC device.
...
/**
 * cros_ec_suspend_late() - Handle a suspend late operation for the ChromeOS EC
 *device.
 * @ec_dev: Device to suspend.
 *
...
/**
 * cros_ec_resume_complete() - Handle a resume complete operation for the
 *ChromeOS EC device.
...
/**
 * cros_ec_resume_early() - Handle a resume early operation for the ChromeOS EC
 *device.
 * @ec_dev: Device to resume.
 *
