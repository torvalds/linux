 ...
 * history.
 */
static void cros_ec_sensor_ring_ts_filter_update(struct cros_ec_sensors_ts_filter_state
    *state,
    s64 b,
    s64 c) {
  s64 x, y;
 ...
 */
static s64 cros_ec_sensor_ring_ts_filter(
 ...
 * add an offset.
 */
static void cros_ec_sensor_ring_fix_overflow(s64 *ts,
...
static void cros_ec_sensor_ring_check_for_past_timestamp(struct cros_ec_sensorhub
    *sensorhub,
 ...
 */
static bool cros_ec_sensor_ring_process_event(
    struct cros_ec_sensorhub *sensorhub,
