...
static enum led_brightness keyboard_led_get_brightness_acpi(
    struct led_classdev *cdev) {
...
static int keyboard_led_set_brightness_ec_pwm(struct led_classdev *cdev,
    enum led_brightness brightness) {
  struct {
  ...
  struct keyboard_led *keyboard_led = container_of(cdev, struct keyboard_led,
      cdev);
...
static enum led_brightness keyboard_led_get_brightness_ec_pwm(
    struct led_classdev *cdev) {
  struct {
    struct cros_ec_command msg;
...
static const __maybe_unused struct keyboard_led_drvdata
