...
int hp_alloc_string_data(void) {
  bioscfg_drv.string_instances_count = hp_get_instance_count(
...
static int hp_populate_string_elements_from_package(
    union acpi_object *string_obj,
...
static int hp_populate_string_elements_from_buffer(u8 *buffer_ptr,
    u32 *buffer_size,
    int instance_id) {
  int ret = 0;
  struct string_data *string_data = &bioscfg_drv.string_data[instance_id];
