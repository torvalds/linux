 ...
 * path. On MMIO gmux's, this seems to lead to us being unable to clear
 *interrupts,
 ...
 *
 * gmux ports can be accessed from userspace as a debugfs interface. For
 *example:
 *
...
get_version:
   ...
   * report 0x03ff, despite the firmware being happy to set 0xffff as the
   *brightness
   * at boot. Force 0xffff for all MMIO gmux's so they all have the correct
   *brightness
   * range.
   */
