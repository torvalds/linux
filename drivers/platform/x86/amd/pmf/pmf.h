...
struct amd_pmf_dev {
  ...
  bool amt_enabled;
  struct mutex update_mutex; /* protects race between ACPI handler and metrics
                              * thread */
  bool cnqf_enabled;
  bool cnqf_supported;
...
enum auto_mode_transition_priority {
  ...
  AUTO_TRANSITION_FROM_PERFORMANCE_TO_BALANCE, /* Performance Mode to Balance
                                                * Mode */
  AUTO_TRANSITION_MAX,
};
...
struct auto_mode_trans_params {
  ...
  u32 power_threshold;
  u32 timer; /* elapsed time. if timer > TimeThreshold, it will move to next
              * mode */
  u32 applied;
...
enum cnqf_trans_priority {
  ...
  CNQF_TRANSITION_FROM_BALANCE_TO_PERFORMANCE, /* quiet/balance to Performance
                                                * Mode */
  CNQF_TRANSITION_FROM_QUIET_TO_BALANCE, /* Quiet Mode to Balance Mode */
  CNQF_TRANSITION_TO_QUIET, /* Any other mode to Quiet Mode */
  CNQF_TRANSITION_FROM_PERFORMANCE_TO_BALANCE, /* Performance/Turbo to Balance
                                                * Mode */
...
int amd_pmf_send_cmd(struct amd_pmf_dev *dev, u8 message, bool get, u32 arg,
    u32 *data);
...
/* Auto Mode Layer */
int apmf_get_auto_mode_def(struct amd_pmf_dev *pdev,
    struct apmf_auto_mode *data);
void amd_pmf_init_auto_mode(struct amd_pmf_dev *dev);
void amd_pmf_deinit_auto_mode(struct amd_pmf_dev *dev);
void amd_pmf_trans_automode(struct amd_pmf_dev *dev, int socket_power,
    ktime_t time_elapsed_ms);
int apmf_get_sbios_requests(struct amd_pmf_dev *pdev,
    struct apmf_sbios_req *req);
int apmf_get_sbios_requests_v2(struct amd_pmf_dev *pdev,
...
/* CnQF Layer */
int apmf_get_dyn_slider_def_ac(struct amd_pmf_dev *pdev,
    struct apmf_dyn_slider_output *data);
int apmf_get_dyn_slider_def_dc(struct amd_pmf_dev *pdev,
    struct apmf_dyn_slider_output *data);
int amd_pmf_init_cnqf(struct amd_pmf_dev *dev);
void amd_pmf_deinit_cnqf(struct amd_pmf_dev *dev);
int amd_pmf_trans_cnqf(struct amd_pmf_dev *dev, int socket_power,
...
void amd_pmf_dump_ta_inputs(struct amd_pmf_dev *dev,
    struct ta_pmf_enact_table *in);
