 ...
 * large delays during resume when the IOMMU translation layer is enabled (the
 *default
 * behavior) for NVME devices:
 *
 * To avoid this firmware problem, skip the SMI handler on these machines before
 *the
