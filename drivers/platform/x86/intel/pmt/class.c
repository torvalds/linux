...
static inline int pmt_memcpy64_fromio(void *to, const u64 __iomem *from,
    size_t count) {
  int i, remain;
  u64 *buf = to;
 ...
 * sysfs
 */
static ssize_t intel_pmt_read(struct file *filp, struct kobject *kobj,
...
static int intel_pmt_mmap(struct file *filp, struct kobject *kobj,
