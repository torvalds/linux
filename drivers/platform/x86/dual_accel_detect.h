 ...
 *
 * Since Linux does not call these undocumented methods, the SW_TABLET_MODE info
 *reported
 * by various drivers/platform/x86 drivers is incorrect. These drivers use the
 *detection
