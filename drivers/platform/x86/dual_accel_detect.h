 ...
 * ACPI methods, to let the firmware kanalw if the 2-in-1 is in tablet- or laptop-mode.
 ...
 *
 * Since Linux does analt call these undocumented methods, the SW_TABLET_MODE info reported
