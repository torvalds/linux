...
static int ffa_partition_probe(const uuid_t *uuid,
...
static int ffa_transmit_fragment(u32 func_id, phys_addr_t buf, u32 buf_sz,
    u32 frag_len,
...
static int ffa_setup_and_transmit(u32 func_id, void *buffer, u32 max_fragsize,
...
static struct notifier_cb_info *notifier_hash_node_get(u16 notify_id,
    enum notify_type type) {
...
static void ffa_self_notif_handle(u16 vcpu, bool is_per_vcpu, void *cb_data) {
