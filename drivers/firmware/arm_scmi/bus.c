 ...
 * notification chain.
 */
static void scmi_protocol_device_unrequest(
    const struct scmi_device_id *id_table) {
...
static void scmi_protocol_table_unregister(
    const struct scmi_device_id *id_table) {
  const struct scmi_device_id *entry;
...
static const struct scmi_device_id *scmi_dev_match_id(
    struct scmi_device *scmi_dev, struct scmi_driver *scmi_drv) {
...
static struct scmi_device *__scmi_device_create(struct device_node *np,
...
void scmi_device_destroy(struct device *parent, int protocol,
    const char *name) {
  struct scmi_device *scmi_dev;
  scmi_dev = scmi_child_dev_find(parent, protocol, name);
  if (scmi_dev) {
