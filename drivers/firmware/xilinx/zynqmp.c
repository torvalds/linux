...
static noinline int do_fw_call_smc(u32 *ret_payload, u32 num_args, ...) {
  ...
  va_end(arg_list);
  arm_smccc_smc(args[0], args[1], args[2], args[3], args[4], args[5], args[6],
      args[7], &res);
  if (ret_payload) {
...
static noinline int do_fw_call_hvc(u32 *ret_payload, u32 num_args, ...) {
  ...
  va_end(arg_list);
  arm_smccc_hvc(args[0], args[1], args[2], args[3], args[4], args[5], args[6],
      args[7], &res);
  if (ret_payload) {
    ret_payload[0] = lower_32_bits(res.a0);
    ret_payload[1] = upper_32_bits(res.a0);
...
static int __do_feature_check_call(const u32 api_id, u32 *ret_payload) {
  ...
  smc_arg[0] = PM_SIP_SVC
      | FIELD_PREP(MODULE_ID_MASK, module_id) | feature_check_api_id;
...
int zynqmp_pm_invoke_fn(u32 pm_api_id, u32 *ret_payload, u32 num_args, ...) {
  ...
  return do_fw_call(ret_payload, 8, smc_arg[0], smc_arg[1], smc_arg[2],
      smc_arg[3],
...
int zynqmp_pm_register_sgi(u32 sgi_num, u32 reset) {
  ...
  return zynqmp_pm_invoke_fn(PM_IOCTL, NULL, 3, IOCTL_REGISTER_SGI, sgi_num,
      reset);
}
...
int zynqmp_pm_query_data(struct zynqmp_pm_query_data qdata, u32 *out) {
  int ret;
  ret = zynqmp_pm_invoke_fn(PM_QUERY_DATA, out, 4, qdata.qid, qdata.arg1,
      qdata.arg2,
      qdata.arg3);
  /*
...
int zynqmp_pm_set_pll_frac_mode(u32 clk_id, u32 mode) {
  return zynqmp_pm_invoke_fn(PM_IOCTL, NULL, 4, 0, IOCTL_SET_PLL_FRAC_MODE,
      clk_id, mode);
}
...
int zynqmp_pm_get_pll_frac_mode(u32 clk_id, u32 *mode) {
  return zynqmp_pm_invoke_fn(PM_IOCTL, mode, 3, 0, IOCTL_GET_PLL_FRAC_MODE,
      clk_id);
}
...
int zynqmp_pm_set_pll_frac_data(u32 clk_id, u32 data) {
  return zynqmp_pm_invoke_fn(PM_IOCTL, NULL, 4, 0, IOCTL_SET_PLL_FRAC_DATA,
      clk_id, data);
}
...
int zynqmp_pm_get_pll_frac_data(u32 clk_id, u32 *data) {
  return zynqmp_pm_invoke_fn(PM_IOCTL, data, 3, 0, IOCTL_GET_PLL_FRAC_DATA,
      clk_id);
}
...
int zynqmp_pm_set_sd_tapdelay(u32 node_id, u32 type, u32 value) {
  ...
  if (value) {
    return zynqmp_pm_invoke_fn(PM_IOCTL, NULL, 4, node_id,
        IOCTL_SET_SD_TAPDELAY, type,
        value);
  }
  /*
...
int zynqmp_pm_sd_dll_reset(u32 node_id, u32 type) {
  return zynqmp_pm_invoke_fn(PM_IOCTL, NULL, 3, node_id, IOCTL_SD_DLL_RESET,
      type);
}
...
int zynqmp_pm_ospi_mux_select(u32 dev_id, u32 select) {
  return zynqmp_pm_invoke_fn(PM_IOCTL, NULL, 3, dev_id, IOCTL_OSPI_MUX_SELECT,
      select);
}
...
int zynqmp_pm_write_ggs(u32 index, u32 value) {
  return zynqmp_pm_invoke_fn(PM_IOCTL, NULL, 4, 0, IOCTL_WRITE_GGS, index,
      value);
}
...
int zynqmp_pm_write_pggs(u32 index, u32 value) {
  return zynqmp_pm_invoke_fn(PM_IOCTL, NULL, 4, 0, IOCTL_WRITE_PGGS, index,
      value);
}
...
int zynqmp_pm_set_tapdelay_bypass(u32 index, u32 value) {
  return zynqmp_pm_invoke_fn(PM_IOCTL, NULL, 4, 0, IOCTL_SET_TAPDELAY_BYPASS,
      index, value);
}
...
int zynqmp_pm_set_boot_health_status(u32 value) {
  return zynqmp_pm_invoke_fn(PM_IOCTL, NULL, 3, 0, IOCTL_SET_BOOT_HEALTH_STATUS,
      value);
}
...
int zynqmp_pm_fpga_load(const u64 address, const u32 size, const u32 flags) {
  u32 ret_payload[PAYLOAD_ARG_CNT];
  int ret;
  ret = zynqmp_pm_invoke_fn(PM_FPGA_LOAD, ret_payload, 4, lower_32_bits(
      address),
...
int zynqmp_pm_pinctrl_get_config(const u32 pin, const u32 param,
  ...
  ret = zynqmp_pm_invoke_fn(PM_PINCTRL_CONFIG_PARAM_GET, ret_payload, 2, pin,
      param);
  *value = ret_payload[1];
  return ret;
}
...
int zynqmp_pm_pinctrl_set_config(const u32 pin, const u32 param,
  ...
  return zynqmp_pm_invoke_fn(PM_PINCTRL_CONFIG_PARAM_SET, NULL, 3, pin, param,
      value);
}
...
unsigned int zynqmp_pm_bootmode_read(u32 *ps_mode) {
  ...
  u32 ret_payload[PAYLOAD_ARG_CNT];
  ret
    = zynqmp_pm_invoke_fn(PM_MMIO_READ, ret_payload, 1, CRL_APB_BOOT_PIN_CTRL);
...
int zynqmp_pm_request_node(const u32 node, const u32 capabilities,
  ...
  return zynqmp_pm_invoke_fn(PM_REQUEST_NODE, NULL, 4, node, capabilities, qos,
      ack);
}
...
int zynqmp_pm_get_rpu_mode(u32 node_id, enum rpu_oper_mode *rpu_mode) {
  u32 ret_payload[PAYLOAD_ARG_CNT];
  int ret;
  ret = zynqmp_pm_invoke_fn(PM_IOCTL, ret_payload, 2, node_id,
...
int zynqmp_pm_set_rpu_mode(u32 node_id, enum rpu_oper_mode rpu_mode) {
  return zynqmp_pm_invoke_fn(PM_IOCTL, NULL, 3, node_id,
...
int zynqmp_pm_request_wake(const u32 node,
  ...
  return zynqmp_pm_invoke_fn(PM_REQUEST_WAKEUP, NULL, 4, node,
      address | set_addr,
      address >> 32, ack);
}
...
int zynqmp_pm_set_requirement(const u32 node, const u32 capabilities,
    const u32 qos,
    const enum zynqmp_pm_request_ack ack) {
  return zynqmp_pm_invoke_fn(PM_SET_REQUIREMENT, NULL, 4, node, capabilities,
      qos, ack);
}
...
int zynqmp_pm_aes_engine(const u64 address, u32 *out) {
  ...
  ret = zynqmp_pm_invoke_fn(PM_SECURE_AES, ret_payload, 2, upper_32_bits(
      address),
...
int zynqmp_pm_sha_hash(const u64 address, const u32 size, const u32 flags) {
  ...
  return zynqmp_pm_invoke_fn(PM_SECURE_SHA, NULL, 4, upper_addr, lower_addr,
      size, flags);
}
...
int zynqmp_pm_register_notifier(const u32 node, const u32 event,
  ...
  return zynqmp_pm_invoke_fn(PM_REGISTER_NOTIFIER, NULL, 4, node, event, wake,
      enable);
}
...
int zynqmp_pm_set_feature_config(enum pm_feature_config_id id, u32 value) {
  return zynqmp_pm_invoke_fn(PM_IOCTL, NULL, 4, 0, IOCTL_SET_FEATURE_CONFIG, id,
      value);
}
...
int zynqmp_pm_get_feature_config(enum pm_feature_config_id id,
    u32 *payload) {
  return zynqmp_pm_invoke_fn(PM_IOCTL, payload, 3, 0, IOCTL_GET_FEATURE_CONFIG,
      id);
}
...
int zynqmp_pm_set_sd_config(u32 node, enum pm_sd_config_type config,
    u32 value) {
  return zynqmp_pm_invoke_fn(PM_IOCTL, NULL, 4, node, IOCTL_SET_SD_CONFIG,
      config, value);
}
...
int zynqmp_pm_set_gem_config(u32 node, enum pm_gem_config_type config,
    u32 value) {
  return zynqmp_pm_invoke_fn(PM_IOCTL, NULL, 4, node, IOCTL_SET_GEM_CONFIG,
      config, value);
}
 ...
 */
static struct zynqmp_pm_shutdown_scope *zynqmp_pm_is_shutdown_scope_valid(
...
static int zynqmp_firmware_probe(struct platform_device *pdev) {
  ...
  if (pm_family_code == VERSAL_FAMILY_CODE) {
    em_dev = platform_device_register_data(&pdev->dev, "xlnx_event_manager",
        -1, NULL, 0);
    if (IS_ERR(em_dev)) {
      dev_err_probe(&pdev->dev, PTR_ERR(em_dev),
          "EM register fail with error\n");
    }
  }
