...
static __always_inline unsigned long __invoke_psci_fn_hvc(
...
static __always_inline unsigned long __invoke_psci_fn_smc(
    unsigned long function_id,
    unsigned long arg0, unsigned long arg1,
    unsigned long arg2) {
  struct arm_smccc_res res;
...
static __always_inline int __psci_cpu_suspend(u32 fn, u32 state,
...
static __always_inline int psci_0_1_cpu_suspend(u32 state,
    unsigned long entry_point) {
  return __psci_cpu_suspend(psci_0_1_function_ids.cpu_suspend,
      state, entry_point);
}

static __always_inline int psci_0_2_cpu_suspend(u32 state,
    unsigned long entry_point) {
