...
static struct firmware_map_entry *__meminit firmware_map_find_entry(u64 start,
    u64 end,
    const char *type);
...
static inline struct firmware_map_entry *to_memmap_entry(struct kobject *kobj) {
 ...
 */
static struct firmware_map_entry *__meminit firmware_map_find_entry_in_list(
...
/**
 * firmware_map_find_entry_bootmem() - Search memmap entry in
 *map_entries_bootmem.
 * @start: Start of the memory range.
 * @end:   End of the memory range (exclusive).
 * @type:  Type of the memory range.
 ...
 * Return: Pointer to the entry to be found on success, or NULL on failure.
 */
static struct firmware_map_entry *__meminit firmware_map_find_entry_bootmem(
    u64 start, u64 end, const char *type) {
