...
static void fill_wq_resume_args(struct arm_smccc_args *resume,
    u32 smc_call_ctx) {
...
int scm_get_wq_ctx(u32 *wq_ctx, u32 *flags, u32 *more_pending) {
  ...
  struct arm_smccc_args get_wq_ctx = {
    0
  };
...
static int __scm_smc_do_quirk_handle_waitq(struct device *dev,
    struct arm_smccc_args *waitq,
    struct arm_smccc_res *res) {
  int ret;
