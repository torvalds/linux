...
void efi_call_virt_check_flags(unsigned long flags, const void *caller) {
  ...
  pr_err_ratelimited(
      FW_BUG "IRQ flags corrupted (0x%08lx=>0x%08lx) by EFI call from %pS\n",
...
static efi_status_t virt_efi_set_variable_nb(efi_char16_t *name,
...
static efi_status_t virt_efi_query_variable_info_nb(u32 attr,
    u64 *storage_space,
...
efi_status_t efi_call_acpi_prm_handler(efi_status_t(__efiapi *handler_addr) (
    u64, void *),
