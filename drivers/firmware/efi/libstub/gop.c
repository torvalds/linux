...
static void setup_pixel_info(struct screen_info *si, u32 pixels_per_scan_line,
...
static efi_graphics_output_protocol_t *find_gop(efi_guid_t *proto,
    unsigned long size,
    void **handles) {
