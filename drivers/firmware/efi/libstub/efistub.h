...
typedef union efi_device_path_to_text_protocol
...
typedef union efi_device_path_from_text_protocol
...
union efi_boot_services {
  struct {
    ...
    efi_status_t(__efiapi
        * install_multiple_protocol_interfaces) (efi_handle_t *, ...);
    efi_status_t(__efiapi
        * uninstall_multiple_protocol_interfaces) (efi_handle_t, ...);
...
typedef union efi_graphics_output_protocol_mode
...
#define EFI_LOAD_OPTION_MASK (EFI_LOAD_OPTION_FORCE_RECONNECT \
  | EFI_LOAD_OPTION_BOOT_MASK)
...
#else
static inline void efi_enable_reset_attack_mitigation(void) {
}
...
asmlinkage efi_status_t __efiapi efi_zboot_entry(efi_handle_t handle,
