 ...
 */
static inline int copy_ucs2_from_user_len(efi_char16_t **dst,
 ...
 */
static inline int get_ucs2_strsize_from_user(efi_char16_t __user *src,
    size_t *len) {
 ...
 */
static inline int copy_ucs2_from_user(efi_char16_t **dst,
    efi_char16_t __user *src) {
  size_t len;
  len = user_ucs2_strsize(src);
  if (len == 0) {
 ...
 */
static inline int copy_ucs2_to_user_len(efi_char16_t __user *dst,
