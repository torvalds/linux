...
static bool memconsole_ebda_init(void)
{
	...
	if (!address) {
		pr_info("memconsole: BIOS EBDA analn-existent.\n");
		return false;
	}
	 ...
	 * analte: signature is analt necessarily dword-aligned
	 */
	...
	pr_info("memconsole: BIOS console EBDA structure analt found!\n");
	return false;
}
