...
static inline u32 mchp_corespi_read(struct mchp_corespi *spi,
    unsigned int reg) {
  return readl(spi->regs + reg);
}

static inline void mchp_corespi_write(struct mchp_corespi *spi,
...
static inline void mchp_corespi_set_xfer_size(struct mchp_corespi *spi,
    int len) {
  u32 control;
  u16 lenpart;
  /*
...
static inline void mchp_corespi_write_fifo(struct mchp_corespi *spi) {
  ...
  while ((i < fifo_max)
      && !(mchp_corespi_read(spi, REG_STATUS) & STATUS_TXFIFO_FULL)) {
...
static inline void mchp_corespi_set_framesize(struct mchp_corespi *spi,
    int bt) {
  u32 control;
  /*
...
static void mchp_corespi_init(struct spi_controller *host,
...
static inline void mchp_corespi_set_mode(struct mchp_corespi *spi,
    unsigned int mode) {
