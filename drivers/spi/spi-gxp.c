...
static int gxp_spi_read_reg(struct gxp_spi_chip *chip,
...
static int gxp_spi_write_reg(struct gxp_spi_chip *chip,
    const struct spi_mem_op *op) {
  int ret;
  struct gxp_spi *spifi = chip->spifi;
  void __iomem *reg_base = spifi->reg_base;
...
static ssize_t gxp_spi_read(struct gxp_spi_chip *chip,
    const struct spi_mem_op *op) {
  struct gxp_spi *spifi = chip->spifi;
...
static ssize_t gxp_spi_write(struct gxp_spi_chip *chip,
    const struct spi_mem_op *op) {
  struct gxp_spi *spifi = chip->spifi;
  void __iomem *reg_base = spifi->reg_base;
  u32 write_len;
...
static int do_gxp_exec_mem_op(struct spi_mem *mem,
    const struct spi_mem_op *op) {
