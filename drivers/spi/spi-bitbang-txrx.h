...
static inline u32 bitbang_txrx_be_cpha1(struct spi_device *spi,
    unsigned nsecs, unsigned cpol, unsigned flags,
    u32 word, u8 bits) {
...
static inline u32 bitbang_txrx_le_cpha0(struct spi_device *spi,
...
static inline u32 bitbang_txrx_le_cpha1(struct spi_device *spi,
    unsigned int nsecs, unsigned int cpol, unsigned int flags,
    u32 word, u8 bits) {
  /* if (cpol == 0) this is SPI_MODE_1; else this is SPI_MODE_3 */
  u8 rxbit = bits - 1;
