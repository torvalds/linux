...
#define DEFAULT_SSP_REG_CR0_ST ( \
    ...
    | GEN_MASK_BITS(SSP_MICROWIRE_CHANNEL_FULL_DUPLEX, SSP_CR0_MASK_HALFDUP_ST, \
    5)   \
    | GEN_MASK_BITS(SSP_CLK_POL_IDLE_LOW, SSP_CR0_MASK_SPO, 6)   \
    | GEN_MASK_BITS(SSP_CLK_SECOND_EDGE, SSP_CR0_MASK_SPH, 7)   \
    | GEN_MASK_BITS(SSP_DEFAULT_CLKRATE, SSP_CR0_MASK_SCR, 8)   \
...
static int pl022_transfer_one(struct spi_controller *host,
...
static void pl022_handle_err(struct spi_controller *ctlr,
...
static struct pl022_ssp_controller *pl022_platform_data_dt_get(
    struct device *dev) {
...
static void pl022_remove(struct amba_device *adev) {
