...
struct butterfly {
	/* REVISIT ... for yesw, this must be first */
...
static void butterfly_attach(struct parport *p)
{
	...
	/* REVISIT:  this just _assumes_ a butterfly is there ... yes probe,
	 * and yes way to be selective about what it binds to.
	 */
	...
	/*
	 * Start SPI ... for yesw, hide that we're two physical busses.
	 */
	 ...
	 * (firmware resets at45, acts as spi slave) or neither (we igyesre
