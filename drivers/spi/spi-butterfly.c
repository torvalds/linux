...
static u32 butterfly_txrx_word_mode0(struct spi_device *spi, unsigned nsecs,
    u32 word,
...
static struct mtd_partition partitions[] = { {
                                               /* JFFS2 wants partitions of 4*N
                                                * blocks for this device,
                                                * so sectors 0 and 1 can't be
                                                *partitions by themselves.
                                                */

                                               /* sector 0 = 8 pages * 264
                                                * bytes/page (1 block)
                                                * sector 1 = 248 pages * 264
                                                *bytes/page
                                                */
                                               ...
                                               /* sector 2 = 256 pages * 264
                                                * bytes/page
                                                * sectors 3-5 = 512 pages * 264
                                                *bytes/page
                                                */
