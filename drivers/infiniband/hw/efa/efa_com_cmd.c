...
int efa_com_get_stats(struct efa_com_dev *edev,
  ...
  switch (cmd.type) {
    ...
    case EFA_ADMIN_GET_STATS_TYPE_RDMA_READ:
      ...
      result->rdma_read_stats.read_resp_bytes
        = resp.u.rdma_read_stats.read_resp_bytes;
      break;
    case EFA_ADMIN_GET_STATS_TYPE_RDMA_WRITE:
      result->rdma_write_stats.write_wrs = resp.u.rdma_write_stats.write_wrs;
      result->rdma_write_stats.write_bytes
        = resp.u.rdma_write_stats.write_bytes;
      result->rdma_write_stats.write_wr_err
        = resp.u.rdma_write_stats.write_wr_err;
      result->rdma_write_stats.write_recv_bytes
        = resp.u.rdma_write_stats.write_recv_bytes;
      break;
  }
  return 0;
}
