...
static void free_srq_idx(struct hns_roce_dev *hr_dev,
    struct hns_roce_srq *srq) {
  struct hns_roce_idx_que *idx_que = &srq->idx_que;
...
static int alloc_srq_wrid(struct hns_roce_dev *hr_dev,
    struct hns_roce_srq *srq) {
...
static void free_srq_buf(struct hns_roce_dev *hr_dev,
    struct hns_roce_srq *srq) {
  free_srq_wrid(srq);
  free_srq_wqe_buf(hr_dev, srq);
  free_srq_idx(hr_dev, srq);
