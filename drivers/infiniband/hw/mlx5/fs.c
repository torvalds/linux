...
static struct mlx5_ib_flow_handler *create_leftovers_rule(
...
static struct mlx5_ib_flow_handler *_create_raw_flow_rule(
    struct mlx5_ib_dev *dev,
    struct mlx5_ib_flow_prio *ft_prio,
    struct mlx5_flow_destination *dst,
...
static int mlx5_ib_ft_type_to_namespace(
    enum mlx5_ib_uapi_flow_table_type table_type,
...
static int steering_anchor_create_fg_drop(struct mlx5_ib_flow_prio *ft_prio) {
...
static void steering_anchor_destroy_fg_drop(struct mlx5_ib_flow_prio *ft_prio) {
  if (ft_prio->anchor.fg_drop) {
...
static int steering_anchor_create_fg_goto_table(
    struct mlx5_ib_flow_prio *ft_prio) {
  int inlen = MLX5_ST_SZ_BYTES(create_flow_group_in);
  struct mlx5_flow_group *fg;
  void *flow_group_in;
...
static void steering_anchor_destroy_fg_goto_table(
    struct mlx5_ib_flow_prio *ft_prio) {
  if (ft_prio->anchor.fg_goto_table) {
...
static int steering_anchor_create_rule_drop(struct mlx5_ib_flow_prio *ft_prio) {
  struct mlx5_flow_act flow_act = {};
...
static int steering_anchor_create_rule_goto_table(
    struct mlx5_ib_flow_prio *ft_prio) {
...
static void steering_anchor_destroy_rule_goto_table(
    struct mlx5_ib_flow_prio *ft_prio) {
  if (ft_prio->anchor.rule_goto_table) {
...
static struct ib_flow_action *mlx5_ib_create_modify_header(
    struct mlx5_ib_dev *dev,
    enum mlx5_ib_uapi_flow_table_type ft_type,
