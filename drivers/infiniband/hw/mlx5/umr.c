 ...
 */
static void *mlx5r_umr_alloc_xlt(size_t *nents, size_t ent_size,
    gfp_t gfp_mask) {
...
static void mlx5r_umr_set_update_xlt_ctrl_seg(
...
static void mlx5r_umr_set_update_xlt_data_seg(
