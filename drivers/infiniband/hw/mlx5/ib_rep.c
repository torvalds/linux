...
static int mlx5_ib_set_vport_rep(struct mlx5_core_dev *dev,
...
static void mlx5_ib_num_ports_update(struct mlx5_core_dev *dev,
    u32 *num_ports) {
...
static int mlx5_ib_vport_rep_load(struct mlx5_core_dev *dev,
    struct mlx5_eswitch_rep *rep) {
...
static void mlx5_ib_vport_rep_unload(struct mlx5_eswitch_rep *rep) {
