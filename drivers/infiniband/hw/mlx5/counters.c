...
static int mlx5_ib_read_counters(struct ib_counters *counters,
  ...
  for (i = 0; i < mcounters->ncounters; i++) {
    read_attr->counters_buff[desc[i].index]
      += mread_attr.out[desc[i].description];
  }
err_read:
...
static struct rdma_hw_stats *mlx5_ib_alloc_hw_device_stats(
...
static struct rdma_hw_stats *mlx5_ib_alloc_hw_port_stats(
...
static struct rdma_hw_stats *mlx5_ib_counter_alloc_stats(
