...
static __always_inline unsigned long __mlx5_log_page_size_to_bitmap(
    unsigned int log_pgsz_bits,
...
static __always_inline unsigned long __mlx5_page_offset_to_bitmask(
    unsigned int page_offset_bits,
...
static inline struct mlx5_ib_ucontext *to_mucontext(
    struct ib_ucontext *ibucontext) {
...
static inline struct mlx5_ib_mcounters *to_mcounters(
    struct ib_counters *ibcntrs) {
...
static inline struct mlx5_ib_rwq_ind_table *to_mrwq_ind_table(
    struct ib_rwq_ind_table *ib_rwq_ind_tbl) {
...
static inline struct mlx5_ib_flow_action *to_mflow_act(
    struct ib_flow_action *ibact) {
  return container_of(ibact, struct mlx5_ib_flow_action, ib_action);
}

static inline struct mlx5_user_mmap_entry *to_mmmap(
    struct rdma_user_mmap_entry *rdma_entry) {
...
static inline int mlx5_ib_odp_init_one(struct mlx5_ib_dev *ibdev) {
  return 0;
}
...
static inline int mlx5_ib_odp_init(void) {
  return 0;
}
...
static inline int mlx5_ib_advise_mr_prefetch(struct ib_pd *pd,
...
static inline int get_uars_per_sys_page(struct mlx5_ib_dev *dev,
    bool lib_support) {
