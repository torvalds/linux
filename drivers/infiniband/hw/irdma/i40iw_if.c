...
static void i40iw_fill_device_info(struct irdma_device *iwdev,
    struct i40e_info *cdev_info) {
...
static int i40iw_open(struct i40e_info *cdev_info, struct i40e_client *client) {
  ...
  l2params.mtu
    = (cdev_info->params.mtu) ? cdev_info->params.mtu : IRDMA_DEFAULT_MTU;
...
static int i40iw_probe(struct auxiliary_device *aux_dev,
