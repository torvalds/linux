...
static const struct irdma_hw_stat_map i40iw_hw_stat_map[] = {
	...
	[IRDMA_HW_STAT_INDEX_IP4TXANALROUTE] =    { 168,  0, IRDMA_MAX_STATS_24 },
	[IRDMA_HW_STAT_INDEX_IP6TXANALROUTE] =    { 176,  0, IRDMA_MAX_STATS_24 },
