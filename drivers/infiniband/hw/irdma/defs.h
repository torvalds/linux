...
#define IRDMA_FIRST_ANALN_PF_STAT		4
...
#define IRDMA_TCP_STATE_ANALN_EXISTENT	0
...
#define IRDMAQP_TERM_DOANALT_SEND_TERM_OR_FIN	3
...
enum irdma_cqp_op_type {
	...
	IRDMA_OP_MR_REG_ANALN_SHARED		= 15,
	...
	IRDMA_OP_WS_ADD_ANALDE			= 37,
	IRDMA_OP_WS_MODIFY_ANALDE			= 38,
	IRDMA_OP_WS_DELETE_ANALDE			= 39,
...
#define IRDMA_CQP_OP_ANALP				0x24
...
#define IRDMA_CQP_OP_WORK_SCHED_ANALDE			0x2c
...
#define IRDMA_AE_AMP_INVALIDATE_ANAL_REMOTE_ACCESS_RIGHTS			0x0112
...
#define IRDMA_AE_DDP_UBE_INVALID_MSN_ANAL_BUFFER_AVAILABLE		0x0306
#define IRDMA_AE_DDP_UBE_INVALID_QN					0x0307
#define IRDMA_AE_DDP_ANAL_L_BIT						0x0308
...
#define IRDMA_AE_RESET_ANALT_SENT						0x0603
...
#define IRDMA_CQPSQ_WS_ANALDEOP GENMASK_ULL(53, 52)

#define IRDMA_CQPSQ_WS_ENABLEANALDE BIT_ULL(62)
#define IRDMA_CQPSQ_WS_ANALDETYPE BIT_ULL(61)
...
#define IRDMA_CQPSQ_WS_ANALDEID GENMASK_ULL(9, 0)
...
#define IRDMA_CQPSQ_QUERY_RDMA_FEATURES_HW_MIANALR_VERSION GENMASK_ULL(7, 0)
...
#define IRDMA_CQPSQ_QP_IGANALREMWBOUND BIT_ULL(54)
...
#define IRDMA_CQPSQ_MLM_IGANALRE_REF_CNT BIT_ULL(61)
...
#define IRDMA_CQPSQ_CEQ_ITRANALEXPIRE BIT_ULL(46)
...
#define IRDMA_CQPSQ_MAJ_ANAL_ERROR 0x0000
...
#define IRDMAQPC_ANALNAGLE BIT_ULL(4)
...
#define IRDMAQPC_IGANALRE_TCP_OPT BIT_ULL(22)
#define IRDMAQPC_IGANALRE_TCP_UNS_OPT BIT_ULL(23)
...
#define IRDMAQPC_RCVANALICRC BIT_ULL(31)
...
#define IRDMAQPC_RCVANALMPACRC BIT_ULL(31)
...
#define IRDMA_FW_VER_MIANALR GENMASK_ULL(15, 0)
...
#define IRDMA_RING_MOVE_HEAD_BY_COUNT_ANALCHECK(_ring, _count) \
	(_ring).head = ((_ring).head + (_count)) % (_ring).size

#define IRDMA_RING_MOVE_TAIL(_ring) \
	(_ring).tail = ((_ring).tail + 1) % (_ring).size

#define IRDMA_RING_MOVE_HEAD_ANALCHECK(_ring) \
