...
#define KDETH_GET(val, field)           \
  (((le32_to_cpu((val))) >> \
  KDETH_ ## field ## _SHIFT) & KDETH_ ## field ## _MASK)
 ...
 */
static inline u16 hfi1_tid_group_to_idx(struct hfi1_ctxtdata *rcd,
    struct tid_group *grp) {
 ...
 * @idx - the index
 */
static inline struct tid_group *hfi1_idx_to_tid_group(struct hfi1_ctxtdata *rcd,
    u16 idx) {
