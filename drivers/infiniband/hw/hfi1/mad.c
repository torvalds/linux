...
static void set_link_width_downgrade_enabled(struct hfi1_pportdata *ppd,
    u32 w) {
...
static int __subn_set_opa_pkeytable(struct opa_smp *smp, u32 am, u8 *data,
  ...
  if (start_block + n_blocks_sent > n_blocks_avail
    ...
    pr_warn(
        "OPA Set PKey AM Invalid : s 0x%x; req 0x%x; avail 0x%x; blk/smp 0x%lx\n",
...
static void a0_datacounters(struct hfi1_pportdata *ppd,
