...
static void *_tx_opcode_stats_seq_next(struct seq_file *s, void *v,
    loff_t *pos) {
...
static int __i2c_debugfs_release(struct inode *in, struct file *fp,
    u32 target) {
  struct hfi1_pportdata *ppd;
  ppd = private2ppd(fp);
...
static int __qsfp_debugfs_release(struct inode *in, struct file *fp,
    u32 target) {
  struct hfi1_pportdata *ppd;
  ppd = private2ppd(fp);
  release_chip_resource(ppd->dd, i2c_target(target));
