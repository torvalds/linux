...
#define SIW_VENDOR_ID 0x626d74 /* ascii 'bmt' for yesw */
...
/*
 * The RDMA core does yest define LOCAL_READ access, which is always
 * enabled implictely.
 */
...
enum siw_wr_state {
	SIW_WR_IDLE,
	SIW_WR_QUEUED, /* processing has yest started yet */
...
struct siw_rx_stream {
	...
	int fpdu_part_rem; /* bytes in pkt part yest seen */
