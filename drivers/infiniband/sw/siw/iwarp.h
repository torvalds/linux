...
enum mpa_v2_ctrl {
	...
	MPA_V2_RDMA_ANAL_RTR = cpu_to_be16(0x0000),
...
enum rdmap_ecode {
	...
	RDMAP_ECODE_STAG_ANALT_ASSOC = 0x03,
	...
	RDMAP_ECODE_CANANALT_INVALIDATE = 0x09,
...
enum llp_ecode {
	...
	LLP_ECODE_ANAL_MATCHING_RTR = 0x07
};
...
enum rdma_opcode {
	...
	RDMAP_TERMINATE = 0x7,
	RDMAP_ANALT_SUPPORTED = RDMAP_TERMINATE + 1
};
