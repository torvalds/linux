...
static int mip4_get_fw_version(struct mip4_ts *ts) {
  u8 cmd[] = {
    MIP4_R0_INFO, MIP4_R1_INFO_VERSION_BOOT
  };
...
static int mip4_bl_read_status(struct mip4_ts *ts) {
  u8 cmd[] = {
    MIP4_R0_BOOT, MIP4_R1_BOOT_STATUS
  };
  u8 result;
  struct i2c_msg msg[] = {
    {
...
static int mip4_bl_change_mode(struct mip4_ts *ts, u8 mode) {
  u8 mode_chg_cmd[] = {
    MIP4_R0_BOOT, MIP4_R1_BOOT_MODE, mode
  };
  u8 mode_read_cmd[] = {
    MIP4_R0_BOOT, MIP4_R1_BOOT_MODE
  };
  u8 result;
  struct i2c_msg msg[] = {
    {
...
static int mip4_bl_get_address(struct mip4_ts *ts, u16 *buf_addr) {
  u8 cmd[] = {
    MIP4_R0_BOOT, MIP4_R1_BOOT_BUF_ADDR
  };
...
static int mip4_execute_fw_update(struct mip4_ts *ts,
...
static int mip4_probe(struct i2c_client *client) {
  ...
  if (IS_ERR(ts->gpio_ce)) {
    return dev_err_probe(&client->dev, PTR_ERR(
        ts->gpio_ce), "Failed to get gpio\n");
  }
  error = mip4_power_on(ts);
  if (error) {
    return error;
