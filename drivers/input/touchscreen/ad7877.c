...
static int ad7877_process_data(struct ad7877 *ts) {
   ...
   * The combination of 'first conversion delay' and averaging provides a robust
   * solution,
   * discarding the spurious noise in the signal and keeping only the data of
   * interest.
   * The size of the averaging filter is programmable. (dev.platform_data, see
   * linux/spi/ad7877.h)
   * Other user-programmable conversion controls include variable acquisition
   * time,
