...
static int icn8505_write_prog_reg(struct icn8505_data *icn8505, int reg,
    u8 val) {
  return icn8505_write_xfer(icn8505->client, ICN8505_PROG_I2C_ADDR, reg,
...
static int icn8505_probe_acpi(struct icn8505_data *icn8505,
    struct device *dev) {
  const char *subsys;
  int error;
...
static DEFINE_SIMPLE_DEV_PM_OPS(icn8505_pm_ops, icn8505_suspend,
    icn8505_resume);
