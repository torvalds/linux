...
static int cobra_btn[] = {
  BTN_START, BTN_SELECT, BTN_TL, BTN_TR, BTN_X, BTN_Y, BTN_Z, BTN_A, BTN_B,
  BTN_C, BTN_TL2, BTN_TR2, 0
};
...
static unsigned char cobra_read_packet(struct gameport *gameport,
    unsigned int *data) {
  unsigned long flags;
  unsigned char u, v, w;
  __u64 buf[2];
...
static int cobra_connect(struct gameport *gameport,
