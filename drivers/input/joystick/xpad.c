...
static const struct xpad_device {
  ...
  { 0x045e, 0x0b0a, "Microsoft X-Box Adaptive Controller", MAP_PROFILE_BUTTON,
    XTYPE_XBOXONE },
  { 0x045e, 0x0b12, "Microsoft Xbox Series S|X Controller", MAP_SELECT_BUTTON,
    XTYPE_XBOXONE },
  ...
  { 0x12ab, 0x0303, "Mortal Kombat Klassic FightStick", MAP_TRIGGERS_TO_BUTTONS,
    XTYPE_XBOX360 },
  ...
  { 0x1bad, 0xf018, "Mad Catz Street Fighter IV SE Fighting Stick",
    MAP_TRIGGERS_TO_BUTTONS, XTYPE_XBOX360 },
  { 0x1bad, 0xf019, "Mad Catz Brawlstick for Xbox 360", MAP_TRIGGERS_TO_BUTTONS,
    XTYPE_XBOX360 },
 ...
 */
static void xpadone_process_packet(struct usb_xpad *xpad, u16 cmd,
    unsigned char *data) {
  struct input_dev *dev = xpad->dev;
  bool do_sync = false;
  ...
  } else if (data[0] == GIP_CMD_INPUT) { /* The main valid packet type for
                                          * inputs */
    /* menu/view buttons */
...
static void xpadone_ack_mode_report(struct usb_xpad *xpad, u8 seq_num) {
  ...
  static const u8 mode_report_ack[] = {
    GIP_CMD_ACK, GIP_OPT_INTERNAL, GIP_SEQ0, GIP_PL_LEN(9),
    0x00, GIP_CMD_VIRTUAL_KEY, GIP_OPT_INTERNAL, 0x02, 0x00, 0x00, 0x00, 0x00,
    0x00
  };
  spin_lock_irqsave(&xpad->odata_lock, flags);
