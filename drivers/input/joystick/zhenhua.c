...
/*
 * Driver to use 4CH RC transmitter using Zhen Hua 5-byte protocol (Walkera
 * Lama,
...
#define DRIVER_DESC \
  "RC transmitter with 5-byte Zhen Hua protocol joystick driver"
...
static irqreturn_t zhenhua_interrupt(struct serio *serio, unsigned char data,
    unsigned int flags) {
