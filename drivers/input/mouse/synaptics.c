...
static int synaptics_query_int(struct psmouse *psmouse, u8 query_cmd,
    u32 *val) {
  int error;
  union {
    __be32 be_val;
...
static void synaptics_report_mt_data(struct psmouse *psmouse,
  ...
  struct input_dev *dev = psmouse->dev;
  struct synaptics_data *priv = psmouse->private;
  const struct synaptics_hw_state *hw[2] = {
    sgm, &priv->agm
  };
...
static bool synaptics_validate_byte(struct psmouse *psmouse,
  ...
  static const u8 newabs_mask[] = {
    0xC8, 0x00, 0x00, 0xC8, 0x00
  };
  static const u8 newabs_rel_mask[] = {
    0xC0, 0x00, 0x00, 0xC0, 0x00
  };
  static const u8 newabs_rslt[] = {
    0x80, 0x00, 0x00, 0xC0, 0x00
  };
  static const u8 oldabs_mask[] = {
    0xC0, 0x60, 0x00, 0xC0, 0x60
  };
  static const u8 oldabs_rslt[] = {
...
static enum synaptics_pkt_type synaptics_detect_pkt_type(
...
static int __maybe_unused synaptics_setup_ps2(struct psmouse *psmouse,
    struct synaptics_device_info *info) {
  return -ENOSYS;
}
...
MODULE_PARM_DESC(synaptics_intertouch,
...
static int __maybe_unused synaptics_setup_intertouch(struct psmouse *psmouse,
    struct synaptics_device_info *info,
    bool leave_breadcrumbs) {
  return -ENOSYS;
}
