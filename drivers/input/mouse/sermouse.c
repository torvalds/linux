...
static void sermouse_process_ms(struct sermouse *sermouse, signed char data) {
  ...
  switch (sermouse->count) {
    ...
    case 1:
      ...
      break;
    case 2:
      /* Guessing the state of the middle button on 3-button MS-protocol mice -
       * ugly. */
      if ((sermouse->type == SERIO_MS) && !data && !buf[2]
          && !((buf[0] & 0xf0) ^ buf[1])) {
    ...
    case 3:
      ...
      break;
    case 4:
    case 6: /* MZ++ packet type. We can get these bytes for M++ too but we
             * ignore them later. */
      buf[1] = (data >> 2) & 0x0f;
      break;
    case 5:
    case 7: /* Ignore anything besides MZ++ */
      ...
      switch (buf[1]) {
        case 1: /* Extra mouse info */
          ...
          input_report_rel(dev, data & 0x80 ? REL_HWHEEL : REL_WHEEL,
              (data & 7) - (data & 8));
          break;
