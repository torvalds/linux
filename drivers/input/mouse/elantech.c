 ...
 */
static int elantech_read_reg_params(struct psmouse *psmouse, u8 reg,
    u8 *param) {
 ...
 */
static int elantech_write_reg_params(struct psmouse *psmouse, u8 reg,
    u8 *param) {
  if (elantech_ps2_command(psmouse, NULL, ETP_PS2_CUSTOM_COMMAND)
      || elantech_ps2_command(psmouse, NULL, ETP_REGISTER_READWRITE)
      || elantech_ps2_command(psmouse, NULL, ETP_PS2_CUSTOM_COMMAND)
    ...
    case 2:
      if (info->fw_version == 0x020800
        ...
        if (((info->fw_version >> 16) == 0x14) && fixed_dpi) {
          ...
          info->x_max = 819;
          info->y_max = 405;
        } else if (info->fw_version == 0x040219
            || info->fw_version == 0x040215) {
          info->x_max = 900;
          info->y_max = 500;
        } else {
...
MODULE_PARM_DESC(elantech_smbus,
