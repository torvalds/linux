...
#define ALPS_DUALPOINT_WITH_PRESSURE  0x400 /* device can report trackpoint
                                             * pressure */
...
static const struct alps_model_info alps_model_data[] = {
   ...
   */
  { { 0x20, 0x02, 0x0e },
    { ALPS_PROTO_V2, 0xf8, 0xf8, ALPS_PASS | ALPS_DUALPOINT } },

  { { 0x22, 0x02, 0x0a },
    { ALPS_PROTO_V2, 0xf8, 0xf8, ALPS_PASS | ALPS_DUALPOINT } },
  { { 0x22, 0x02, 0x14 },
    { ALPS_PROTO_V2, 0xff, 0xff, ALPS_PASS | ALPS_DUALPOINT } },  /* Dell
                                                                   * Latitude
                                                                   * D600 */
  { { 0x32, 0x02, 0x14 },
    { ALPS_PROTO_V2, 0xf8, 0xf8, ALPS_PASS | ALPS_DUALPOINT } },  /* Toshiba
                                                                   * Salellite
                                                                   * Pro M10 */
  ...
  { { 0x52, 0x01, 0x14 }, { ALPS_PROTO_V2, 0xff, 0xff,
                            ...
                            | ALPS_PS2_INTERLEAVED } },        /* Toshiba Tecra
                                                                * A11-11L */
  ...
  { { 0x62, 0x02, 0x14 }, { ALPS_PROTO_V2, 0xcf, 0xcf,
                            ALPS_PASS | ALPS_DUALPOINT
                            | ALPS_PS2_INTERLEAVED } },        /* Dell Latitude
                                                                * E5500, E6400,
                                                                * E6500,
                                                                * Precision
                                                                * M4400 */
  ...
  { { 0x63, 0x03, 0xc8 },
    { ALPS_PROTO_V2, 0xf8, 0xf8, ALPS_PASS | ALPS_DUALPOINT } },  /* Dell
                                                                   * Latitude
                                                                   * D800 */
...
static const struct alps_protocol_info alps_v3_rushmore_data = {
  ALPS_PROTO_V3_RUSHMORE, 0x8f, 0x8f,
  ALPS_DUALPOINT | ALPS_DUALPOINT_WITH_PRESSURE
};
