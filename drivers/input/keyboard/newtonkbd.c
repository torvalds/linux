...
static unsigned char nkbd_keycode[128] = {
  ...
  KEY_K, KEY_SEMICOLON, KEY_BACKSLASH, KEY_COMMA, KEY_SLASH, KEY_N, KEY_M,
  KEY_DOT,
  KEY_TAB, KEY_SPACE, KEY_GRAVE, KEY_DELETE, 0, 0, 0, KEY_LEFTMETA,
  KEY_LEFTSHIFT, KEY_CAPSLOCK, KEY_LEFTALT, KEY_LEFTCTRL, KEY_RIGHTSHIFT, 0, 0,
  0,
...
static irqreturn_t nkbd_interrupt(struct serio *serio,
  ...
  if (nkbd->keycode[data & NKBD_KEY]) {
    input_report_key(nkbd->dev, nkbd->keycode[data & NKBD_KEY],
        data & NKBD_PRESS);
    input_sync(nkbd->dev);
