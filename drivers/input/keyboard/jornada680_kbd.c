 ...
 *  Copyright (C) 2000 Yaegashi Takeshi (hp6xx kbd scan routine and translation
 * table)
...
static const unsigned short jornada_scancodes[] = {
  /* PTD1 */
  KEY_CAPSLOCK, KEY_MACRO, KEY_LEFTCTRL, 0, KEY_ESC, KEY_KP5, 0, 0,     /*  1
                                                                         *  -> 8
                                                                         *   */
  KEY_F1, KEY_F2, KEY_F3, KEY_F8, KEY_F7, KEY_F6, KEY_F4, KEY_F5,       /*  9
                                                                        *  ->
                                                                        * 16
                                                                        *  */
  ...
  /* PTD7 */ KEY_KP2, KEY_KP6, KEY_KP3, 0, 0, 0, 0, 0,           /*  33 -> 40
                                                                  *  */
  KEY_F10, KEY_RO, KEY_F9, KEY_KP4, KEY_NUMLOCK, KEY_SCROLLLOCK, KEY_LEFTALT,
  KEY_HANJA,  /*  41 -> 48  */
