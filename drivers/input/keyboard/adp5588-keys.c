...
#define CMP_CONFG_SENS2 0x32  /* L2 Light Sensor Reference Level, Output Falling
                               * for Sensor 1 */
#define CMP1_LVL2_TRIP 0x33 /* L2 Light Sensor Hysteresis (Active when Output
                             * Rising) for Sensor 1 */
#define CMP1_LVL2_HYS 0x34  /* L3 Light Sensor Reference Level, Output Falling
                             * For Sensor 1 */
#define CMP1_LVL3_TRIP 0x35 /* L3 Light Sensor Hysteresis (Active when Output
                             * Rising) For Sensor 1 */
#define CMP1_LVL3_HYS 0x36  /* Sensor 2 Comparator Configuration Register */
#define CMP2_LVL2_TRIP 0x37 /* L2 Light Sensor Reference Level, Output Falling
                             * for Sensor 2 */
#define CMP2_LVL2_HYS 0x38  /* L2 Light Sensor Hysteresis (Active when Output
                             * Rising) for Sensor 2 */
#define CMP2_LVL3_TRIP 0x39 /* L3 Light Sensor Reference Level, Output Falling
                             * For Sensor 2 */
#define CMP2_LVL3_HYS 0x3A  /* L3 Light Sensor Hysteresis (Active when Output
                             * Rising) For Sensor 2 */
...
static DEFINE_SIMPLE_DEV_PM_OPS(adp5588_dev_pm_ops, adp5588_suspend,
    adp5588_resume);
