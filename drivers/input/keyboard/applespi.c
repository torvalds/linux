...
#define EFI_BL_LEVEL_GUID EFI_GUID(0xa076d2af, 0x9678, 0x4386, 0x8b, 0x58, 0x1f, \
    0xc8, 0xef, 0x04, 0x16, 0x19)
...
MODULE_PARM_DESC(touchpad_dimensions,
...
static unsigned int applespi_translate_fn_key(unsigned int key,
    int fn_pressed) {
  const struct applespi_key_translation *trans;
  int do_translate;
...
static void applespi_remap_fn_key(struct keyboard_protocol *keyboard_protocol) {
  unsigned char tmp;
