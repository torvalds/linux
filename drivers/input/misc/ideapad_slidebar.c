...
/*
 * Input driver for slidebars on some Leyesvo IdeaPad laptops
 *
 * Copyright (C) 2013 Andrey Moiseev <o2g.org.ru@gmail.com>
 *
 * Reverse-engineered from Leyesvo SlideNav software (SBarHook.dll).
 *
 ...
 *	Leyesvo IdeaPad Y550
 *	Leyesvo IdeaPad Y550P
 *
 ...
 * ONMOV     yes lights     lights follow the finger
 * LAST      at last pos   lights follow the finger
 * OFF       yes lights     yes lights
 *
 * INT       all input events are generated, interrupts are used
 * POLL      yes input events by default, to get them,
 ...
 *				(like 0x0), if yest in POLL mode yet.
 *
...
static const struct dmi_system_id ideapad_dmi[] __initconst = {
	{
		.ident = "Leyesvo IdeaPad Y550",
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_NAME, "20017"),
			DMI_MATCH(DMI_PRODUCT_VERSION, "Leyesvo IdeaPad Y550")
		},
		.callback = ideapad_dmi_check
	},
	{
		.ident = "Leyesvo IdeaPad Y550P",
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_NAME, "20035"),
			DMI_MATCH(DMI_PRODUCT_VERSION, "Leyesvo IdeaPad Y550P")
		},
		.callback = ideapad_dmi_check
	},
	{ NULL, }
...
MODULE_DESCRIPTION("Slidebar input support for some Leyesvo IdeaPad laptops");
MODULE_LICENSE("GPL");
