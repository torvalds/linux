 ...
 * A remote's "channel" may be altered by pressing and holding the "PC" button
 * for
 * approximately 3 seconds, after which the button will slowly flash the count
 * of the
 * currently configured "channel", using the numeric keypad enter a number
 * between 1 and
 * 16 and then press the "PC" button again, the button will slowly flash the
 * count of the
...
static int ati_remote2_probe(struct usb_interface *interface,
