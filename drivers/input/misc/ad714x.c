...
static void ad714x_slider_cal_highest_stage(struct ad714x_chip *ad714x,
    int idx) {
  struct ad714x_slider_plat *hw = &ad714x->hw->slider[idx];
 ...
 */
static void ad714x_wheel_cal_highest_stage(struct ad714x_chip *ad714x,
    int idx) {
