...
static const struct resource tps6594_pfsm_resources[] = {
  ...
  DEFINE_RES_IRQ_NAMED(TPS6594_IRQ_NINT_READBACK,
      TPS6594_IRQ_NAME_NINT_READBACK),
  DEFINE_RES_IRQ_NAMED(TPS6594_IRQ_NRSTOUT_READBACK,
  ...
  DEFINE_RES_IRQ_NAMED(TPS6594_IRQ_EN_DRV_READBACK,
...
static const struct regmap_irq tps6594_irqs[] = {
  ...
  REGMAP_IRQ_REG(TPS6594_IRQ_NRSTOUT_READBACK, 10,
      TPS6594_BIT_NRSTOUT_READBACK_INT),
  ...
  REGMAP_IRQ_REG(TPS6594_IRQ_EN_DRV_READBACK, 14,
      TPS6594_BIT_EN_DRV_READBACK_INT),
...
static inline unsigned int tps6594_get_irq_reg(
...
static int tps6594_enable_crc(struct tps6594 *tps) {
   ...
   * If this mode is specified for primary PMIC, it will also be applied to
   *secondary PMICs
   * through SPMI serial interface.
   * In this multi-PMIC synchronization scheme, the primary PMIC is the
   *controller device
   * on the SPMI bus, and the secondary PMICs are the target devices on the SPMI
   *bus.
   */
