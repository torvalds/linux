...
static const struct resource vsc7512_miim0_resources[] = {
  DEFINE_RES_REG_NAMED(VSC7512_MIIM0_RES_START, VSC7512_MIIM_RES_SIZE,
      "gcb_miim0"),
  DEFINE_RES_REG_NAMED(VSC7512_PHY_RES_START, VSC7512_PHY_RES_SIZE, "gcb_phy"),
};

static const struct resource vsc7512_miim1_resources[] = {
  DEFINE_RES_REG_NAMED(VSC7512_MIIM1_RES_START, VSC7512_MIIM_RES_SIZE,
      "gcb_miim1"),
};
...
static const struct resource vsc7512_sgpio_resources[] = {
  DEFINE_RES_REG_NAMED(VSC7512_SIO_CTRL_RES_START, VSC7512_SIO_CTRL_RES_SIZE,
      "gcb_sio"),
};
...
int ocelot_core_init(struct device *dev) {
  ...
  return devm_mfd_add_devices(dev, PLATFORM_DEVID_AUTO, vsc7512_devs, ndevs,
      NULL, 0, NULL);
}
