...
static int cs42l43_mcu_disable(struct cs42l43 *cs42l43) {
  ...
  regmap_write(cs42l43->regmap, CS42L43_MCU_SW_INTERRUPT,
 ...
 */
static void cs42l43_mcu_load_firmware(const struct firmware *firmware,
    void *context) {
...
int cs42l43_dev_probe(struct cs42l43 *cs42l43) {
  ...
  regcache_cache_only(cs42l43->regmap, true);
  cs42l43->reset
    = devm_gpiod_get_optional(cs42l43->dev, "reset", GPIOD_OUT_LOW);
