 ...
 */
static struct spmi_device *qcom_pmic_get_base_usid(struct spmi_device *sdev,
...
static int pmic_spmi_get_base_revid(struct spmi_device *sdev,
    struct qcom_spmi_dev *ctx) {
 ...
 * @return: the struct qcom_spmi_pmic* pointer associated with the function
 *device
 */
