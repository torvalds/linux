...
#define I2C_PCF_START    (I2C_PCF_PIN | I2C_PCF_ESO | I2C_PCF_ENI \
  | I2C_PCF_STA | I2C_PCF_ACK)
...
static void set_device_claimage(struct bbc_i2c_bus *bp,
    struct platform_device *op, int val) {
  int i;
...
static struct bbc_i2c_bus *attach_one_i2c(struct platform_device *op,
    int index) {
