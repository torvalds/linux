...
static int getstrings(struct openpromio __user *info,
...
static int opromgetprop(void __user *argp, struct device_node *dp,
    struct openpromio *op, int bufsize) {
  const void *pval;
  int len;
  if (!dp
...
static int opromnxtprop(void __user *argp, struct device_node *dp,
    struct openpromio *op, int bufsize) {
...
static int opromsetopt(struct device_node *dp, struct openpromio *op,
    int bufsize) {
...
static int opromnext(void __user *argp, unsigned int cmd,
    struct device_node *dp, struct openpromio *op, int bufsize,
    DATA *data) {
  phandle ph;
...
static int oprompci2node(void __user *argp, struct device_node *dp,
    struct openpromio *op, int bufsize, DATA *data) {
  int err = -EINVAL;
...
static int oprompath2node(void __user *argp, struct device_node *dp,
    struct openpromio *op, int bufsize, DATA *data) {
  phandle ph = 0;
...
static int opromgetbootargs(void __user *argp, struct openpromio *op,
    int bufsize) {
