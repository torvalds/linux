...
enum fan_action {
  FAN_SLOWER, FAN_SAME, FAN_FASTER, FAN_FULLBLAST, FAN_STATE_MAX
};
...
extern struct bbc_i2c_client *bbc_i2c_attach(struct bbc_i2c_bus *bp,
...
extern int bbc_i2c_write_buf(struct bbc_i2c_client *, char *buf, int len,
    int off);
extern int bbc_i2c_read_buf(struct bbc_i2c_client *, char *buf, int len,
    int off);
