...
static int bluecard_write(unsigned int iobase, unsigned int offset, __u8 *buf,
    int len) {
  int i, actual;
...
static int bluecard_read(unsigned int iobase, unsigned int offset, __u8 *buf,
    int size) {
  int i, n, len;
...
static int bluecard_hci_set_baud_rate(struct hci_dev *hdev, int baud) {
  ...
  unsigned char cmd[] = {
    HCI_COMMAND_PKT, 0x09, 0xfc, 0x01, 0x03
  };
