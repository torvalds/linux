...
static unsigned char parport_atari_read_data(struct parport *p) {
  unsigned long flags;
  unsigned char data;
...
static void parport_atari_write_data(struct parport *p, unsigned char data) {
  unsigned long flags;
  local_irq_save(flags);
  sound_ym.rd_data_reg_sel = 15;
...
static unsigned char parport_atari_read_control(struct parport *p) {
  unsigned long flags;
...
static void parport_atari_write_control(struct parport *p,
...
static unsigned char parport_atari_frob_control(struct parport *p,
    unsigned char mask,
    unsigned char val) {
...
static unsigned char parport_atari_read_status(struct parport *p) {
  return (st_mfp.par_dt_reg & 1 ? 0 : PARPORT_STATUS_BUSY)
    | PARPORT_STATUS_SELECT | PARPORT_STATUS_ERROR;
}

static void parport_atari_init_state(struct pardevice *d,
    struct parport_state *s) {
}

static void parport_atari_save_state(struct parport *p,
    struct parport_state *s) {
}

static void parport_atari_restore_state(struct parport *p,
    struct parport_state *s) {
}

static void parport_atari_enable_irq(struct parport *p) {
  enable_irq(IRQ_MFP_BUSY);
}

static void parport_atari_disable_irq(struct parport *p) {
  disable_irq(IRQ_MFP_BUSY);
}

static void parport_atari_data_forward(struct parport *p) {
  unsigned long flags;
  local_irq_save(flags);
...
static void parport_atari_data_reverse(struct parport *p) {
}
