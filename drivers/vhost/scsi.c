...
static struct vhost_scsi_inflight *vhost_scsi_get_inflight(
    struct vhost_virtqueue *vq) {
  struct vhost_scsi_inflight *inflight;
  struct vhost_scsi_virtqueue *svq;
...
static void vhost_scsi_free_evt(struct vhost_scsi *vs,
...
static void vhost_scsi_do_evt_work(struct vhost_scsi *vs,
    struct vhost_scsi_evt *evt) {
  struct vhost_virtqueue *vq = &vs->vqs[VHOST_SCSI_VQ_EVT].vq;
...
static struct vhost_scsi_cmd *vhost_scsi_get_cmd(struct vhost_virtqueue *vq,
 ...
 */
static int vhost_scsi_map_to_sgl(struct vhost_scsi_cmd *cmd,
...
static int vhost_scsi_calc_sgls(struct iov_iter *iter, size_t bytes,
    int max_sgls) {
  int sgl_count = 0;
...
static int vhost_scsi_copy_iov_to_sgl(struct vhost_scsi_cmd *cmd,
    struct iov_iter *iter,
...
static int vhost_scsi_map_iov_to_sgl(struct vhost_scsi_cmd *cmd,
    struct iov_iter *iter,
...
static int vhost_scsi_mapal(struct vhost_scsi_cmd *cmd,
...
static int vhost_scsi_get_desc(struct vhost_scsi *vs,
    struct vhost_virtqueue *vq,
...
static int vhost_scsi_chk_size(struct vhost_virtqueue *vq,
    struct vhost_scsi_ctx *vc) {
...
static int vhost_scsi_get_req(struct vhost_virtqueue *vq,
    struct vhost_scsi_ctx *vc,
...
static void vhost_scsi_send_tmf_resp(struct vhost_scsi *vs,
    struct vhost_virtqueue *vq,
...
static void vhost_scsi_handle_tmf(struct vhost_scsi *vs,
    struct vhost_scsi_tpg *tpg,
    struct vhost_virtqueue *vq,
...
static void vhost_scsi_send_an_resp(struct vhost_scsi *vs,
    struct vhost_virtqueue *vq,
    struct vhost_scsi_ctx *vc) {
...
static void vhost_scsi_ctl_handle_vq(struct vhost_scsi *vs,
    struct vhost_virtqueue *vq) {
  struct vhost_scsi_tpg *tpg;
  union {
    __virtio32 type;
...
static void vhost_scsi_send_evt(struct vhost_scsi *vs,
    struct vhost_virtqueue *vq,
 ...
 */
static int vhost_scsi_set_endpoint(struct vhost_scsi *vs,
...
static int vhost_scsi_clear_endpoint(struct vhost_scsi *vs,
    struct vhost_scsi_target *t) {
  struct se_portal_group *se_tpg;
  struct vhost_scsi_tport *tv_tport;
  struct vhost_scsi_tpg *tpg;
...
static long vhost_scsi_ioctl(struct file *f,
    unsigned int ioctl,
    unsigned long arg) {
  struct vhost_scsi *vs = f->private_data;
...
static void vhost_scsi_do_plug(struct vhost_scsi_tpg *tpg,
...
static void vhost_scsi_hotunplug(struct vhost_scsi_tpg *tpg,
    struct se_lun *lun) {
...
static struct se_portal_group *vhost_scsi_make_tpg(struct se_wwn *wwn,
    const char *name) {
...
static struct se_wwn *vhost_scsi_make_tport(struct target_fabric_configfs *tf,
...
static ssize_t vhost_scsi_wwn_version_show(struct config_item *item,
    char *page) {
