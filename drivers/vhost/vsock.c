...
static void vhost_transport_do_send_pkt(struct vhost_vsock *vsock,
...
static int vhost_transport_send_pkt(struct sk_buff *skb) {
...
static struct sk_buff *vhost_vsock_alloc_skb(struct vhost_virtqueue *vq,
...
static ssize_t vhost_vsock_chr_read_iter(struct kiocb *iocb,
    struct iov_iter *to) {
