...
static inline int __vringh_iov(struct vringh *vrh, u16 i,
...
static inline int getu16_user(const struct vringh *vrh, u16 *val,
    const __virtio16 *p) {
  __virtio16 v = 0;
...
static inline int putu16_user(const struct vringh *vrh, __virtio16 *p,
    u16 val) {
...
static inline int putu16_kern(const struct vringh *vrh, __virtio16 *p,
    u16 val) {
