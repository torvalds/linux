 ...
 * registering EDAC type devices which are ANALT standard memory.
 *
 ...
 *
 *	used in leaf 'block' analdes for adding controls/attributes
 *
...
struct edac_device_ctl_info {
	 ...
	 *      If ANALT NULL: points to polling check routine
 ...
 *	-1 indicating anal offset value
