...
#define SDRAM_BESR_M0ET_ANALNE		PPC_REG_VAL(6, 0)
...
#define SDRAM_MCOPT1_MCHK_ANALN	    PPC_REG_VAL(3, 0x0)	 /* Anal ECC gen	     */
...
#define SDRAM_ECCES_CKBER_ANALNE		PPC_REG_VAL(17, 0)
