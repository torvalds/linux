...
static ssize_t __maybe_unused altr_edac_device_trig(struct file *file,
...
static ssize_t __maybe_unused altr_edac_a10_device_trig(struct file *file,
    const char __user *user_buf,
    size_t count, loff_t *ppos);
...
static ssize_t __maybe_unused altr_edac_a10_device_trig2(struct file *file,
    const char __user *user_buf,
    size_t count, loff_t *ppos);
 ...
 */
static int __maybe_unused altr_check_ecc_deps(
    struct altr_edac_device_dev *device) {
 ...
 */
static int __maybe_unused altr_init_memory_port(void __iomem *ioaddr,
    int port) {
...
static __init int __maybe_unused altr_init_a10_ecc_block(struct device_node *np,
    u32 irq_mask,
...
static int __maybe_unused altr_check_ocram_deps_init(
    struct altr_edac_device_dev *device) {
  void __iomem *base = device->base;
  int ret;
