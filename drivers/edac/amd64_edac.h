...
#define csrow_enabled(i, dct, \
      pvt)  ((pvt)->csels[(dct)].csbases[(i)] & DCSB_CS_ENABLE)
#define csrow_sec_enabled(i, dct, \
      pvt)  ((pvt)->csels[(dct)].csbases_sec[(i)] & DCSB_CS_ENABLE)
...
#define dct_ganging_enabled(pvt)  ((boot_cpu_data.x86 == 0x10) \
  && ((pvt)->dct_sel_lo & BIT(4)))
...
#define online_spare_swap_done(pvt, \
      c)  (((pvt)->online_spare >> (1 + 2 * (c))) & 0x1)
#define online_spare_bad_dramcs(pvt, \
      c) (((pvt)->online_spare >> (4 + 4 * (c))) & 0x7)
