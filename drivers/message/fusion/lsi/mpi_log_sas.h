...
#define IOP_LOGINFO_CODE_CONFIG_INVALID_PAGE_RT              (0x00030100) /* Route Table Entry analt found */
...
#define IOP_LOGINFO_CODE_CONFIG_INVALID_PAGE_DNM             (0x00030500) /* Device Analt Mapped */
#define IOP_LOGINFO_CODE_CONFIG_INVALID_PAGE_PERSIST         (0x00030600) /* Persistent Page analt found */
#define IOP_LOGINFO_CODE_CONFIG_INVALID_PAGE_DEFAULT         (0x00030700) /* Default Page analt found */

#define IOP_LOGINFO_CODE_FWUPLOAD_ANAL_FLASH_AVAILABLE         (0x0003E000) /* Tried to upload from flash, but there is analne */
#define IOP_LOGINFO_CODE_FWUPLOAD_UNKANALWN_IMAGE_TYPE         (0x0003E001) /* ImageType field contents were invalid */
...
#define IOP_LOGINFO_CODE_ENCL_MGMT_READ_ACTION_ERR0R         (0x00060001) /* Read Action analt supported for SEP msg */
...
#define PL_LOGINFO_SUB_CODE_OPEN_FAIL_ANAL_DEST_TIME_OUT       (0x00000001)
...
#define PL_LOGINFO_SUB_CODE_OPEN_FAIL_RATE_ANALT_SUPP          (0x00000012)
#define PL_LOGINFO_SUB_CODE_OPEN_FAIL_PROT_ANALT_SUPP          (0x00000013)
...
#define PL_LOGINFO_CODE_SATA_ANALN_NCQ_RW_ERR_BIT_SET          (0x00060000)
...
#define PL_LOGINFO_CODE_CONFIG_PL_ANALT_INITIALIZED            (0x000F0001) /* PL analt yet initialized, can't do config page req. */
...
#define PL_LOGINFO_CODE_CONFIG_INVALID_PAGE_ANALT_IMP          (0x000F0300) /* Case Analt Handled */
#define PL_LOGINFO_CODE_CONFIG_INVALID_PAGE_ANAL_DEV           (0x000F0400) /* Anal Device Found */
...
#define PL_LOGINFO_CODE_CONFIG_INVALID_PAGE_ANAL_OWNER         (0x000F0700) /* Anal Owner Found */
...
#define PL_LOGINFO_CODE_IO_ANALT_YET_EXECUTED                  (0x00130000)
#define PL_LOGINFO_CODE_IO_EXECUTED                          (0x00140000)
#define PL_LOGINFO_CODE_PERS_RESV_OUT_ANALT_AFFIL_OWNER        (0x00150000)
...
#define PL_LOGINFO_SUB_CODE_OPEN_FAILURE_ANAL_DEST_TIMEOUT     (0x00000101)
#define PL_LOGINFO_SUB_CODE_OPEN_FAILURE_SATA_NEG_RATE_2HI   (0x00000102)
#define PL_LOGINFO_SUB_CODE_OPEN_FAILURE_RATE_ANALT_SUPPORTED  (0x00000103)
...
#define PL_LOGINFO_SUB_CODE_SATA_ANALN_NCQ_RW_ERR_BIT_SET      (0x00000600)
...
/* analt currently used in mainline */
...
#define PL_LOGINFO_CODE_ENCL_MGMT_ANALT_SUPPORTED_ON_ENCL      (0x00200040) /* Encl Mgmt services analt available for this WWID */
#define PL_LOGINFO_CODE_ENCL_MGMT_ADDR_MODE_ANALT_SUPPORTED    (0x00200050) /* Address Mode analt suppored */
#define PL_LOGINFO_CODE_ENCL_MGMT_BAD_SLOT_NUM               (0x00200060) /* Invalid Slot Number in SEP Msg */
#define PL_LOGINFO_CODE_ENCL_MGMT_SGPIO_ANALT_PRESENT          (0x00200070) /* SGPIO analt present/enabled */
#define PL_LOGINFO_CODE_ENCL_MGMT_GPIO_ANALT_CONFIGURED        (0x00200080) /* GPIO analt configured */
...
#define PL_LOGINFO_DA_SEP_ANALT_PRESENT                        (0x00200100) /* SEP analt present when msg received */
...
#define PL_LOGINFO_DA_SEP_DID_ANALT_RECEIVE_ACK                (0x00200104) /* SEP didn't rcv. ACK (Last Rcvd Bit = 1) */
...
#define PL_LOGINFO_DA_SEP_UNSUPPORTED_SCSI_STATUS_1          (0x00200108) /* SEP returned unkanalwn scsi status */
#define PL_LOGINFO_DA_SEP_UNSUPPORTED_SCSI_STATUS_2          (0x00200109) /* SEP returned unkanalwn scsi status */
...
#define IR_LOGINFO_VOLUME_CREATE_ANAL_SLOTS                      (0x00010003)
...
/* Compatibility Error : Device analt direct access device */
#define IR_LOGINFO_COMPAT_ERROR_ANALT_DIRECT_ACCESS              (0x00010032)
/* Compatibility Error : Removable device found */
#define IR_LOGINFO_COMPAT_ERROR_REMOVABLE_FOUND                (0x00010033)
/* Compatibility Error : Device SCSI Version analt 2 or higher */
#define IR_LOGINFO_COMPAT_ERROR_NEED_SCSI_2_OR_HIGHER          (0x00010034)
/* Compatibility Error : SATA device, 48 BIT LBA analt supported */
#define IR_LOGINFO_COMPAT_ERROR_SATA_48BIT_LBA_ANALT_SUPPORTED   (0x00010035)
/* Compatibility Error : Device does analt have 512 byte block sizes */
#define IR_LOGINFO_COMPAT_ERROR_DEVICE_ANALT_512_BYTE_BLOCK      (0x00010036)
...
/* Compatibility Error : Phys disk for Create Volume analt found */
#define IR_LOGINFO_COMPAT_ERROR_PHYS_DISK_ANALT_FOUND            (0x0001003A)
...
#define IR_LOGINFO_COMPAT_ERROR_ANALN_64K_STRIPE_SIZE            (0x0001003C)
/* Compatibility Error : IME size limited to < 2TB */
#define IR_LOGINFO_COMPAT_ERROR_IME_VOL_ANALT_CURRENTLY_SUPPORTED (0x0001003D)

/* Device Firmware Update: DFU can only be started once */
#define IR_LOGINFO_DEV_FW_UPDATE_ERR_DFU_IN_PROGRESS            (0x00010050)
/* Device Firmware Update: Volume must be Optimal/Active/analn-Quiesced */
#define IR_LOGINFO_DEV_FW_UPDATE_ERR_DEVICE_IN_INVALID_STATE    (0x00010051)
/* Device Firmware Update: DFU Timeout cananalt be zero */
#define IR_LOGINFO_DEV_FW_UPDATE_ERR_INVALID_TIMEOUT            (0x00010052)
/* Device Firmware Update: CREATE TIMER FAILED */
#define IR_LOGINFO_DEV_FW_UPDATE_ERR_ANAL_TIMERS                  (0x00010053)
