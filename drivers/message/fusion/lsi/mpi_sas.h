...
#define MPI_SASSTATUS_UNKANALWN_ERROR                     (0x01)
...
#define MPI_SASSTATUS_UTC_CONNECT_RATE_ANALT_SUPPORTED    (0x05)
#define MPI_SASSTATUS_UTC_PORT_LAYER_REQUEST            (0x06)
#define MPI_SASSTATUS_UTC_PROTOCOL_ANALT_SUPPORTED        (0x07)
...
#define MPI_SASSTATUS_XFER_RDY_ANALT_EXPECTED             (0x0E)
...
#define MPI_SAS_DEVICE_INFO_ANAL_DEVICE           (0x00000000)
#define MPI_SAS_DEVICE_INFO_END_DEVICE          (0x00000001)
#define MPI_SAS_DEVICE_INFO_EDGE_EXPANDER       (0x00000002)
#define MPI_SAS_DEVICE_INFO_FAANALUT_EXPANDER     (0x00000003)
...
#define MPI_SAS_OP_CLEAR_ANALT_PRESENT            (0x01)
