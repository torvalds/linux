...
typedef struct _MPI_BOOT_DEVICE_ADAPTER_NUMBER {
  ...
  U32 Reserved14;                             /* 3Ch */
  U32 Reserved15;                             /* 40h */
} MPI_BOOT_DEVICE_ADAPTER_NUMBER,
...
typedef struct _MPI_BOOT_DEVICE_SLOT_NUMBER {
  ...
  U32 Reserved14;                             /* 3Ch */
  U32 Reserved15;                             /* 40h */
} MPI_BOOT_DEVICE_PCI_SLOT_NUMBER,
MPI_POINTER PTR_MPI_BOOT_DEVICE_PCI_SLOT_NUMBER;
...
#define MPI_FCPORTPAGE0_PORTSTATE_UNKNOWN               (0x01)      /*(SNIA)HBA_PORTSTATE_UNKNOWN
                                                                     ...
                                                                     * Unknown
                                                                     * */
#define MPI_FCPORTPAGE0_PORTSTATE_ONLINE                (0x02)      /*(SNIA)HBA_PORTSTATE_ONLINE
                                                                     *        2
                                                                     * Operational
                                                                     * */
#define MPI_FCPORTPAGE0_PORTSTATE_OFFLINE               (0x03)      /*(SNIA)HBA_PORTSTATE_OFFLINE
                                                                     ...
                                                                     * Offline
                                                                     * */
#define MPI_FCPORTPAGE0_PORTSTATE_BYPASSED              (0x04)      /*(SNIA)HBA_PORTSTATE_BYPASSED
                                                                     *      4
                                                                     * Bypassed
                                                                     * */
#define MPI_FCPORTPAGE0_PORTSTATE_DIAGNOST              (0x05)      /*(SNIA)HBA_PORTSTATE_DIAGNOSTICS
                                                                     *   5 In
                                                                     * diagnostics
                                                                     * mode */
#define MPI_FCPORTPAGE0_PORTSTATE_LINKDOWN              (0x06)      /*(SNIA)HBA_PORTSTATE_LINKDOWN
                                                                     *      6
                                                                     * Link Down
                                                                     * */
#define MPI_FCPORTPAGE0_PORTSTATE_ERROR                 (0x07)      /*(SNIA)HBA_PORTSTATE_ERROR
                                                                     *         7
                                                                     * Port
                                                                     * Error */
...
#define MPI_FCPORTPAGE1_FLAGS_PROT_FCP_INIT             ((U32) \
  MPI_PORTFACTS_PROTOCOL_INITIATOR << MPI_FCPORTPAGE1_FLAGS_PROT_SHIFT)
#define MPI_FCPORTPAGE1_FLAGS_PROT_FCP_TARG             ((U32) \
  MPI_PORTFACTS_PROTOCOL_TARGET << MPI_FCPORTPAGE1_FLAGS_PROT_SHIFT)
#define MPI_FCPORTPAGE1_FLAGS_PROT_LAN                  ((U32) \
  MPI_PORTFACTS_PROTOCOL_LAN << MPI_FCPORTPAGE1_FLAGS_PROT_SHIFT)
#define MPI_FCPORTPAGE1_FLAGS_PROT_LOGBUSADDR           ((U32) \
  MPI_PORTFACTS_PROTOCOL_LOGBUSADDR << MPI_FCPORTPAGE1_FLAGS_PROT_SHIFT)
...
typedef union _FC_PORT_PERSISTENT_PHYSICAL_ID {
  WWN_FORMAT WWN;
  U32 Did;
} FC_PORT_PERSISTENT_PHYSICAL_ID,
...
/* see mpi_sas.h for values for SAS IO Unit Page 1 ControllerPhyDeviceInfo
 * values */
