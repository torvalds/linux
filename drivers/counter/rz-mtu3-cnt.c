...
static inline struct rz_mtu3_channel *rz_mtu3_get_ch(
    struct counter_device *counter, int id) {
...
static int rz_mtu3_ext_input_phase_clock_select_get(
...
static int rz_mtu3_ext_input_phase_clock_select_set(
    struct counter_device *counter,
    u32 ext_input_phase_clock_select) {
  struct rz_mtu3_cnt * const priv = counter_priv(counter);
  int ret;
