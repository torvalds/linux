...
static void ufs_sprd_regmap_update(struct ufs_sprd_priv *priv,
    unsigned int index,
...
static int ufs_sprd_get_reset_ctrl(struct device *dev,
    struct ufs_sprd_rst *rci) {
...
static int ufs_sprd_get_syscon_reg(struct device *dev,
