...
static inline struct dw_hdma_v0_ch_regs __iomem *__dw_ch_regs(
    struct dw_edma *dw, enum dw_edma_dir dir, u16 ch) {
...
static irqreturn_t dw_hdma_v0_core_handle_int(struct dw_edma_irq *dw_irq,
