...
#define QDMA_SER_DISABLE	(8) /* yes yestification */
#define QDMA_SER_CTX		BIT(8) /* yestification by FQD_CTX[fqid] */
#define QDMA_SER_DEST		(2 << 8) /* yestification by destination desc */
#define QDMA_SER_BOTH		(3 << 8) /* soruce and dest yestification */
