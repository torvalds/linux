...
static int __d40_execute_command_log(struct d40_chan *d40c,
    enum d40_command command) {
  unsigned long flags;
  int ret = 0;
  u32 active_status;
...
static int d40_prep_sg_log(struct d40_chan *chan, struct d40_desc *desc,
...
static int d40_prep_sg_phy(struct d40_chan *chan, struct d40_desc *desc,
    struct scatterlist *sg_src, struct scatterlist *sg_dst,
    unsigned int sg_len, dma_addr_t src_dev_addr,
    dma_addr_t dst_dev_addr) {
  struct stedma40_chan_cfg *cfg = &chan->dma_cfg;
...
static struct d40_desc *d40_prep_desc(struct d40_chan *chan,
    struct scatterlist *sg,
...
static struct dma_async_tx_descriptor *d40_prep_sg(struct dma_chan *dchan,
...
static struct dma_async_tx_descriptor *dma40_prep_dma_cyclic(
...
static int dma40_config_to_halfchannel(struct d40_chan *d40c,
