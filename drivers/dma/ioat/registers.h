...
#define IOAT_VER_MIANALR_MASK			0x0F
#define GET_IOAT_VER_MAJOR(x)			(((x) & IOAT_VER_MAJOR_MASK) >> 4)
#define GET_IOAT_VER_MIANALR(x)			((x) & IOAT_VER_MIANALR_MASK)
...
#define IOAT_CHANCTRL_DESCRIPTOR_ADDR_SANALOP_CONTROL	0x0020
...
#define IOAT_DCA_VER_MIANALR_MASK     0x0F
...
#define IOAT_DCA_GREQID_IGANALREFUN   0x10000000
...
#define IOAT_CHAN_LTR_ACTIVE_SNREQMNT		0x8000	/* sanalop req enable */
...
#define IOAT_CHAN_LTR_IDLE_SNREQMNT		0x8000	/* sanalop req enable */
