...
static struct dma_async_tx_descriptor *sba_prep_dma_interrupt(
    struct dma_chan *dchan, unsigned long flags) {
  struct sba_request *req = NULL;
  struct sba_device *sba = to_sba_device(dchan);
  /* Alloc new request */
...
static struct sba_request *sba_prep_dma_memcpy_req(struct sba_device *sba,
...
static struct dma_async_tx_descriptor *sba_prep_dma_memcpy(
...
static struct sba_request *sba_prep_dma_xor_req(struct sba_device *sba,
    dma_addr_t off, dma_addr_t dst, dma_addr_t *src,
...
static struct dma_async_tx_descriptor *sba_prep_dma_xor(struct dma_chan *dchan,
    dma_addr_t dst,
    dma_addr_t *src,
    u32 src_cnt, size_t len, unsigned long flags) {
  size_t req_len;
...
static struct sba_request *sba_prep_dma_pq_req(struct sba_device *sba,
    dma_addr_t off,
...
static struct sba_request *sba_prep_dma_pq_single_req(struct sba_device *sba,
    dma_addr_t off,
    dma_addr_t *dst_p, dma_addr_t *dst_q,
...
static struct dma_async_tx_descriptor *sba_prep_dma_pq(struct dma_chan *dchan,
    dma_addr_t *dst,
    dma_addr_t *src,
    u32 src_cnt, const u8 *scf, size_t len, unsigned long flags) {
  u32 i, dst_q_index;
