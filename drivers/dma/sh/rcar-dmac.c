...
static void rcar_dmac_chan_write(struct rcar_dmac_chan *chan, u32 reg,
    u32 data) {
  if (reg == RCAR_DMARS) {
 ...
 */
static struct rcar_dmac_xfer_chunk *rcar_dmac_xfer_chunk_get(
    struct rcar_dmac_chan *chan) {
  struct rcar_dmac_xfer_chunk *chunk;
  unsigned long flags;
  int ret;
 ...
 */
static struct dma_async_tx_descriptor *rcar_dmac_chan_prep_sg(
    struct rcar_dmac_chan *chan, struct scatterlist *sgl,
...
static struct dma_async_tx_descriptor *rcar_dmac_prep_dma_memcpy(
...
static struct dma_async_tx_descriptor *rcar_dmac_prep_slave_sg(
...
static struct dma_async_tx_descriptor *rcar_dmac_prep_dma_cyclic(
