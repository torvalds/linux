...
static void idma64_chan_init(struct idma64 *idma64,
    struct idma64_chan *idma64c) {
...
static void idma64_chan_stop(struct idma64 *idma64,
    struct idma64_chan *idma64c) {
  channel_clear_bit(idma64, CH_EN, idma64c->mask);
}

static void idma64_chan_start(struct idma64 *idma64,
    struct idma64_chan *idma64c) {
  ...
  channel_writel(idma64c, CTL_LO,
      IDMA64C_CTLL_LLP_S_EN | IDMA64C_CTLL_LLP_D_EN);
