...
#define WQCFG_OFFSET(_idxd_dev, n, ofs) \
  ({ \
    ...
    (__idxd_dev)->wqcfg_offset + (n) * (__idxd_dev)->wqcfg_size + sizeof(u32) \
    * (ofs);  \
  })
...
#define GRPENGCFG_OFFSET(idxd_dev, \
      n) ((idxd_dev)->grpcfg_offset + (n) * GRPCFG_SIZE + 32)
#define GRPFLGCFG_OFFSET(idxd_dev, \
      n) ((idxd_dev)->grpcfg_offset + (n) * GRPCFG_SIZE + 40)
