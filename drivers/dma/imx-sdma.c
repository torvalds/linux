...
#define SDMA_H_CONFIG_RTD_PINS  BIT(11) /* indicates if Real-Time Debug pins are
                                         * enabled */
#define SDMA_H_CONFIG_ACR BIT(4)  /* indicates if AHB freq /core freq = 2 or 1
                                   * */
#define SDMA_H_CONFIG_CSM (3)       /* indicates which context switch mode is
                                     * selected*/
...
static int sdma_config(struct dma_chan *chan,
  ...
  if (dmaengine_cfg->peripheral_config) {
    ...
    if (dmaengine_cfg->peripheral_size
