...
static struct milbeaut_hdmac_chan *to_milbeaut_hdmac_chan(
    struct virt_dma_chan *vc) {
  return container_of(vc, struct milbeaut_hdmac_chan, vc);
}

static struct milbeaut_hdmac_desc *to_milbeaut_hdmac_desc(
    struct virt_dma_desc *vd) {
  return container_of(vd, struct milbeaut_hdmac_desc, vd);
}

/* mc->vc.lock must be held by caller */
static struct milbeaut_hdmac_desc *milbeaut_hdmac_next_desc(
...
static int milbeaut_hdmac_chan_config(struct dma_chan *chan,
    struct dma_slave_config *cfg) {
...
static struct dma_async_tx_descriptor *milbeaut_hdmac_prep_slave_sg(
...
static struct dma_chan *milbeaut_hdmac_xlate(struct of_phandle_args *dma_spec,
