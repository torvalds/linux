...
static struct pxad_desc_sw *pxad_alloc_desc(struct pxad_chan *chan,
...
static inline struct dma_async_tx_descriptor *pxad_tx_prep(
    struct virt_dma_chan *vc, struct virt_dma_desc *vd,
...
static struct dma_async_tx_descriptor *pxad_prep_memcpy(struct dma_chan *dchan,
...
static struct dma_async_tx_descriptor *pxad_prep_slave_sg(
...
static struct dma_async_tx_descriptor *pxad_prep_dma_cyclic(
