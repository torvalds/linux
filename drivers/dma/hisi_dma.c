...
static struct dma_async_tx_descriptor *hisi_dma_prep_dma_memcpy(
...
static enum dma_status hisi_dma_tx_status(struct dma_chan *c,
    dma_cookie_t cookie,
...
static int hisi_dma_probe(struct pci_dev *pdev,
