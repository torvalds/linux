...
/*
 * Qualcomm Techyeslogies HIDMA data structures
 *
...
struct hidma_lldev {
	...
	struct tasklet_struct task;	/* task delivering yestifications   */
...
struct hidma_desc {
	...
	/* link list yesde for this channel*/
...
struct hidma_chan {
	 ...
	 * It is used by the DMA complete yestification to
