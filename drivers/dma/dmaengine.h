 ...
 */
static inline void dmaengine_desc_get_callback(
 ...
 */
static inline void dmaengine_desc_callback_invoke(
    struct dmaengine_desc_callback *cb,
 ...
 * Locking is dependent on the driver.
 */
static inline void dmaengine_desc_get_callback_invoke(
    struct dma_async_tx_descriptor *tx,
    const struct dmaengine_result *result) {
  struct dmaengine_desc_callback cb;
 ...
 * No locking is required.
 */
static inline bool dmaengine_desc_callback_valid(
    struct dmaengine_desc_callback *cb) {
...
static inline struct dentry *dmaengine_get_debugfs_root(
