...
static struct mmp_pdma_desc_sw *mmp_pdma_alloc_descriptor(
...
static struct dma_async_tx_descriptor *mmp_pdma_prep_memcpy(
...
static struct dma_async_tx_descriptor *mmp_pdma_prep_slave_sg(
