...
static struct sun4i_dma_contract *to_sun4i_dma_contract(
    struct virt_dma_desc *vd) {
 ...
 */
static struct sun4i_dma_promise *generate_ndma_promise(struct dma_chan *chan,
    dma_addr_t src,
    dma_addr_t dest,
 ...
 * All linked promises will be freed when the corresponding contract is freed
 */
static struct sun4i_dma_promise *generate_ddma_promise(struct dma_chan *chan,
    dma_addr_t src,
    dma_addr_t dest,
    size_t len, struct dma_slave_config *sconfig) {
  struct sun4i_dma_promise *promise;
 ...
 */
static struct sun4i_dma_promise *get_next_cyclic_promise(
    struct sun4i_dma_contract *contract) {
  struct sun4i_dma_promise *promise;
...
static struct dma_async_tx_descriptor *sun4i_dma_prep_dma_memcpy(
...
static struct dma_async_tx_descriptor *sun4i_dma_prep_slave_sg(
