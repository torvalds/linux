...
static struct dma_async_tx_descriptor *sf_pdma_prep_dma_memcpy(
    struct dma_chan *dchan, dma_addr_t dest, dma_addr_t src,
...
static enum dma_status sf_pdma_tx_status(struct dma_chan *dchan,
    dma_cookie_t cookie,
...
static struct sf_pdma_desc *sf_pdma_get_first_pending_desc(
 ...
 */
static int sf_pdma_irq_init(struct platform_device *pdev,
    struct sf_pdma *pdma) {
  int irq, r, i;
  struct sf_pdma_chan *chan;
