...
/* Called with @edmac->lock held and interrupts disabled */
static struct ep93xx_dma_desc *ep93xx_dma_get_active(
...
static struct ep93xx_dma_desc *ep93xx_dma_desc_get(
    struct ep93xx_dma_chan *edmac) {
 ...
 */
static struct dma_async_tx_descriptor *ep93xx_dma_prep_dma_memcpy(
 ...
 * Returns a valid DMA descriptor or %NULL in case of failure.
 */
static struct dma_async_tx_descriptor *ep93xx_dma_prep_slave_sg(
 ...
 * Returns a valid DMA descriptor or %NULL in case of failure.
 */
static struct dma_async_tx_descriptor *ep93xx_dma_prep_dma_cyclic(
