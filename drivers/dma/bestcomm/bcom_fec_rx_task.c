...
u32 bcom_fec_rx_task[] = {
  ...
  /* Task descriptors */
  0x808220e3, /* LCD: idx0 = var1, idx1 = var4; idx1 <= var3; idx0 += inc4, idx1
               * += inc3 */
  0x10601010, /*   DRD1A: var4 = var2; FN=0 MORE init=3 WS=0 RS=0 */
  0xb8800264, /*   LCD: idx2 = *idx1, idx3 = var0; idx2 < var9; idx2 += inc4,
               * idx3 += inc4 */
  0x10001308, /*     DRD1A: var4 = idx1; FN=0 MORE init=0 WS=0 RS=0 */
  0x60140002, /*     DRD2A: EU0=0 EU1=0 EU2=0 EU3=2 EXT init=0 WS=2 RS=2 */
  0x0cccfcca, /*     DRD2B1: *idx3 = EU3(); EU3(*idx3,var10)  */
  0x80004000, /*   LCDEXT: idx2 = 0x00000000; ; */
  0xb8c58029, /*   LCD: idx3 = *(idx1 + var00000015); idx3 once var0; idx3 +=
               * inc5 */
  0x60000002, /*     DRD2A: EU0=0 EU1=0 EU2=0 EU3=2 EXT init=0 WS=0 RS=0 */
  0x088cf8cc, /*     DRD2B1: idx2 = EU3(); EU3(idx3,var12)  */
  0x991982f2, /*   LCD: idx2 = idx2, idx3 = idx3; idx2 > var11; idx2 += inc6,
               * idx3 += inc2 */
  ...
  0x99198341, /*   LCD: idx2 = idx2, idx3 = idx3; idx2 > var13; idx2 += inc0,
               * idx3 += inc1 */
  0x007ecf80, /*     DRD1A: *idx3 = *idx0; FN=0 init=3 WS=3 RS=3 */
  0x99198272, /*   LCD: idx2 = idx2, idx3 = idx3; idx2 > var9; idx2 += inc6,
               * idx3 += inc2 */
