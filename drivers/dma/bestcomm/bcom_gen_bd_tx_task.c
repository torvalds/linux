...
u32 bcom_gen_bd_tx_task[] = {
  ...
  /* Task descriptors */
  0x800220e3, /* LCD: idx0 = var0, idx1 = var4; idx1 <= var3; idx0 += inc4, idx1
               * += inc3 */
  0x13e01010, /*   DRD1A: var4 = var2; FN=0 MORE init=31 WS=0 RS=0 */
  0xb8808264, /*   LCD: idx2 = *idx1, idx3 = var1; idx2 < var9; idx2 += inc4,
               * idx3 += inc4 */
  ...
  0x9919826a, /*   LCD: idx2 = idx2, idx3 = idx3; idx2 > var9; idx2 += inc5,
               * idx3 += inc2 */
