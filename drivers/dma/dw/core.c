...
static inline void dwc_chan_disable(struct dw_dma *dw,
...
static void dwc_descriptor_complete(struct dw_dma_chan *dwc,
    struct dw_desc *desc,
...
static struct dma_async_tx_descriptor *dwc_prep_dma_memcpy(
...
static struct dma_async_tx_descriptor *dwc_prep_slave_sg(struct dma_chan *chan,
...
static u32 dwc_get_residue_and_status(struct dw_dma_chan *dwc,
    dma_cookie_t cookie,
...
static enum dma_status dwc_tx_status(struct dma_chan *chan,
    dma_cookie_t cookie,
