 ...
 */
static dma_cookie_t mv_xor_v2_tx_submit(struct dma_async_tx_descriptor *tx) {
  void *dest_hw_desc;
  dma_cookie_t cookie;
 ...
 */
static struct dma_async_tx_descriptor *mv_xor_v2_prep_dma_memcpy(
 ...
 */
static struct dma_async_tx_descriptor *mv_xor_v2_prep_dma_xor(
 ...
 */
static struct dma_async_tx_descriptor *mv_xor_v2_prep_dma_interrupt(
