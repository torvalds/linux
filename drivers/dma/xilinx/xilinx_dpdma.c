 ...
 */
static struct xilinx_dpdma_sw_desc *xilinx_dpdma_chan_alloc_sw_desc(
    struct xilinx_dpdma_chan *chan) {
  struct xilinx_dpdma_sw_desc *sw_desc;
  dma_addr_t dma_addr;
 ...
 */
static void xilinx_dpdma_chan_free_sw_desc(struct xilinx_dpdma_chan *chan,
    struct xilinx_dpdma_sw_desc *sw_desc) {
 ...
 */
static struct xilinx_dpdma_tx_desc *xilinx_dpdma_chan_alloc_tx_desc(
    struct xilinx_dpdma_chan *chan) {
  struct xilinx_dpdma_tx_desc *tx_desc;
 ...
 */
static struct xilinx_dpdma_tx_desc *xilinx_dpdma_chan_prep_interleaved_dma(
    struct xilinx_dpdma_chan *chan,
 ...
 */
static bool xilinx_dpdma_chan_err(struct xilinx_dpdma_chan *chan, u32 isr,
    u32 eisr) {
  if (!chan) {
    return false;
  }
...
static struct dma_async_tx_descriptor *xilinx_dpdma_prep_interleaved_dma(
