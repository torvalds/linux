...
/**
 * spmi_device_add() - add a device previously constructed via
 * spmi_device_alloc()
...
static inline int spmi_cmd(struct spmi_controller *ctrl, u8 opcode, u8 sid) {
  int ret;
...
static int spmi_drv_uevent(const struct device *dev,
