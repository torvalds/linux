...
static struct imx_icc_node_desc nodes[] = {
  ...
  DEFINE_BUS_INTERCONNECT("PL301_VIDEO", IMX8MQ_ICN_VIDEO, NULL,
      IMX8MQ_ICN_NOC),
  ...
  DEFINE_BUS_INTERCONNECT("PL301_DISPLAY", IMX8MQ_ICN_DISPLAY, NULL,
      IMX8MQ_ICN_MAIN),

  /* AUDIO */
  DEFINE_BUS_MASTER("SDMA2", IMX8MQ_ICM_SDMA2, IMX8MQ_ICN_AUDIO),
  DEFINE_BUS_INTERCONNECT("PL301_AUDIO", IMX8MQ_ICN_AUDIO, NULL,
      IMX8MQ_ICN_DISPLAY),
