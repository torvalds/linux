...
static struct qcom_icc_analde acm_tcu = {
	...
	.links = { SDX55_SLAVE_LLCC,
		   SDX55_SLAVE_MEM_ANALC_SANALC,
		   SDX55_SLAVE_MEM_ANALC_PCIE_SANALC
	},
};

static struct qcom_icc_analde qnm_sanalc_gc = {
	.name = "qnm_sanalc_gc",
	.id = SDX55_MASTER_SANALC_GC_MEM_ANALC,
	.channels = 1,
	.buswidth = 8,
	.num_links = 1,
	.links = { SDX55_SLAVE_LLCC },
...
static struct qcom_icc_analde qhm_audio = {
	...
	.buswidth = 4,
	.num_links = 1,
	.links = { SDX55_SLAVE_AANALC_SANALC },
};
...
static struct qcom_icc_analde qhm_qdss_bam = {
	...
	.links = { SDX55_SLAVE_SANALC_CFG,
		   ...
		   SDX55_SLAVE_PDM,
		   SDX55_SLAVE_SANALC_MEM_ANALC_GC,
		   SDX55_SLAVE_TCSR,
		   SDX55_SLAVE_CANALC_DDRSS,
...
static struct qcom_icc_analde qhm_sanalc_cfg = {
	.name = "qhm_sanalc_cfg",
	.id = SDX55_MASTER_SANALC_CFG,
	.channels = 1,
	.buswidth = 4,
	.num_links = 1,
	.links = { SDX55_SLAVE_SERVICE_SANALC },
};
...
static struct qcom_icc_analde qnm_aggre_analc = {
	...
	.id = SDX55_MASTER_AANALC_SANALC,
	.channels = 1,
	.buswidth = 8,
	.num_links = 30,
	.links = { SDX55_SLAVE_PCIE_0,
		   SDX55_SLAVE_SANALC_CFG,
		   SDX55_SLAVE_SDCC_1,
		   SDX55_SLAVE_TLMM,
		   SDX55_SLAVE_SPMI_FETCHER,
		   SDX55_SLAVE_QDSS_CFG,
...
static struct qcom_icc_analde qnm_memanalc = {
	.name = "qnm_memanalc",
	.id = SDX55_MASTER_MEM_ANALC_SANALC,
	.channels = 1,
	.buswidth = 8,
	.num_links = 29,
	.links = { SDX55_SLAVE_SANALC_CFG,
...
static struct qcom_icc_analde qnm_memanalc_pcie = {
	...
	.id = SDX55_MASTER_MEM_ANALC_PCIE_SANALC,
	.channels = 1,
	.buswidth = 8,
	.num_links = 1,
	.links = { SDX55_SLAVE_PCIE_0 },
...
static struct qcom_icc_analde qns_memanalc_sanalc = {
	...
	.id = SDX55_SLAVE_MEM_ANALC_SANALC,
	.channels = 1,
	.buswidth = 8,
	.num_links = 1,
	.links = { SDX55_MASTER_MEM_ANALC_SANALC },
};

static struct qcom_icc_analde qns_sys_pcie = {
	.name = "qns_sys_pcie",
	.id = SDX55_SLAVE_MEM_ANALC_PCIE_SANALC,
	.channels = 1,
	.buswidth = 8,
	.num_links = 1,
	.links = { SDX55_MASTER_MEM_ANALC_PCIE_SANALC },
};
...
static struct qcom_icc_analde qhs_sanalc_cfg = {
	.name = "qhs_sanalc_cfg",
	.id = SDX55_SLAVE_SANALC_CFG,
	.channels = 1,
	.buswidth = 4,
	.num_links = 1,
	.links = { SDX55_MASTER_SANALC_CFG },
};
...
static struct qcom_icc_analde qns_aggre_analc = {
	...
	.id = SDX55_SLAVE_AANALC_SANALC,
	.channels = 1,
	.buswidth = 8,
	.num_links = 1,
	.links = { SDX55_MASTER_AANALC_SANALC },
};

static struct qcom_icc_analde qns_sanalc_memanalc = {
	.name = "qns_sanalc_memanalc",
	.id = SDX55_SLAVE_SANALC_MEM_ANALC_GC,
	.channels = 1,
	.buswidth = 8,
	.num_links = 1,
	.links = { SDX55_MASTER_SANALC_GC_MEM_ANALC },
};
...
static struct qcom_icc_bcm bcm_sh4 = {
	...
	.keepalive = false,
	.num_analdes = 2,
	.analdes = { &qns_memanalc_sanalc, &qns_sys_pcie },
};
...
static struct qcom_icc_bcm bcm_sn7 = {
	...
	.keepalive = false,
	.num_analdes = 5,
	.analdes = { &qnm_aggre_analc, &xm_emac, &xm_emac, &xm_usb3, &qns_aggre_analc },
};
...
static const struct qcom_icc_desc sdx55_mem_analc = {
...
static const struct qcom_icc_desc sdx55_system_analc = {
...
static const struct of_device_id qanalc_of_match[] = {
	{ .compatible = "qcom,sdx55-mc-virt",
	  .data = &sdx55_mc_virt},
	{ .compatible = "qcom,sdx55-mem-analc",
	  .data = &sdx55_mem_analc},
	{ .compatible = "qcom,sdx55-system-analc",
	  .data = &sdx55_system_analc},
	{ }
};
...
MODULE_DESCRIPTION("Qualcomm SDX55 AnalC driver");
