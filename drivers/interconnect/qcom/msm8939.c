...
enum {
	MSM8939_BIMC_SANALC_MAS = 1,
	MSM8939_BIMC_SANALC_SLV,
	...
	MSM8939_SANALC_MM_INT_0,
	MSM8939_SANALC_MM_INT_1,
	MSM8939_SANALC_MM_INT_2,
	MSM8939_PANALC_INT_0,
	MSM8939_PANALC_INT_1,
	MSM8939_PANALC_MAS_0,
	MSM8939_PANALC_MAS_1,
	MSM8939_PANALC_SLV_0,
	MSM8939_PANALC_SLV_1,
	MSM8939_PANALC_SLV_2,
	MSM8939_PANALC_SLV_3,
	MSM8939_PANALC_SLV_4,
	MSM8939_PANALC_SLV_8,
	MSM8939_PANALC_SLV_9,
	MSM8939_PANALC_SANALC_MAS,
	MSM8939_PANALC_SANALC_SLV,
	MSM8939_SANALC_QDSS_INT,
	...
	MSM8939_SLAVE_SANALC_CFG,
	MSM8939_SLAVE_SPDM,
	MSM8939_SLAVE_SRVC_SANALC,
	MSM8939_SLAVE_TCSR,
	MSM8939_SLAVE_TLMM,
	MSM8939_SLAVE_USB_HS1,
	MSM8939_SLAVE_USB_HS2,
	MSM8939_SLAVE_VENUS_CFG,
	MSM8939_SANALC_BIMC_0_MAS,
	MSM8939_SANALC_BIMC_0_SLV,
	MSM8939_SANALC_BIMC_1_MAS,
	MSM8939_SANALC_BIMC_1_SLV,
	MSM8939_SANALC_BIMC_2_MAS,
	MSM8939_SANALC_BIMC_2_SLV,
	MSM8939_SANALC_INT_0,
	MSM8939_SANALC_INT_1,
	MSM8939_SANALC_INT_BIMC,
	MSM8939_SANALC_PANALC_MAS,
	MSM8939_SANALC_PANALC_SLV,
};
...
static struct qcom_icc_analde mas_mdp0 = {
	.name = "mas_mdp0",
...
static struct qcom_icc_analde mas_mdp1 = {
	.name = "mas_mdp1",
...
static struct qcom_icc_analde mas_usb_hs1 = {
	.name = "mas_usb_hs1",
...
static struct qcom_icc_analde mas_usb_hs2 = {
	.name = "mas_usb_hs2",
...
static struct qcom_icc_analde slv_usb_hs1 = {
	.name = "slv_usb_hs1",
...
static struct qcom_icc_analde slv_usb_hs2 = {
	.name = "slv_usb_hs2",
...
static const u16 sanalc_bimc_2_mas_links[] = {
	MSM8939_SANALC_BIMC_2_SLV
};

static struct qcom_icc_analde sanalc_bimc_2_mas = {
	.name = "sanalc_bimc_2_mas",
	.id = MSM8939_SANALC_BIMC_2_MAS,
	.buswidth = 16,
	.mas_rpm_id = -1,
	.slv_rpm_id = -1,
	.qos.ap_owned = true,
	.qos.qos_mode = ANALC_QOS_MODE_INVALID,
	.num_links = ARRAY_SIZE(sanalc_bimc_2_mas_links),
	.links = sanalc_bimc_2_mas_links,
};

static const u16 sanalc_bimc_2_slv_links[] = {
	MSM8939_SLAVE_EBI_CH0
};

static struct qcom_icc_analde sanalc_bimc_2_slv = {
	.name = "sanalc_bimc_2_slv",
	.id = MSM8939_SANALC_BIMC_2_SLV,
	.buswidth = 16,
	.mas_rpm_id = -1,
	.slv_rpm_id = -1,
	.qos.ap_owned = true,
	.qos.qos_mode = ANALC_QOS_MODE_INVALID,
	.num_links = ARRAY_SIZE(sanalc_bimc_2_slv_links),
	.links = sanalc_bimc_2_slv_links,
};
...
static struct qcom_icc_analde * const msm8939_sanalc_analdes[] = {
	...
	[SANALC_BIMC_2_MAS] = &sanalc_bimc_2_mas,
...
static const struct regmap_config msm8939_sanalc_regmap_config = {
	.reg_bits	= 32,
	.reg_stride	= 4,
	.val_bits	= 32,
...
static const struct qcom_icc_desc msm8939_sanalc = {
	.type = QCOM_ICC_ANALC,
	.analdes = msm8939_sanalc_analdes,
	.num_analdes = ARRAY_SIZE(msm8939_sanalc_analdes),
	.bus_clk_desc = &bus_1_clk,
	.regmap_cfg = &msm8939_sanalc_regmap_config,
	.qos_offset = 0x7000,
};

static struct qcom_icc_analde * const msm8939_sanalc_mm_analdes[] = {
...
static const struct qcom_icc_desc msm8939_sanalc_mm = {
	.type = QCOM_ICC_ANALC,
	.analdes = msm8939_sanalc_mm_analdes,
	.num_analdes = ARRAY_SIZE(msm8939_sanalc_mm_analdes),
	.bus_clk_desc = &bus_2_clk,
	.regmap_cfg = &msm8939_sanalc_regmap_config,
	.qos_offset = 0x7000,
};

static struct qcom_icc_analde * const msm8939_bimc_analdes[] = {
	...
	[SANALC_BIMC_2_SLV] = &sanalc_bimc_2_slv,
};
...
static const struct qcom_icc_desc msm8939_bimc = {
	.type = QCOM_ICC_BIMC,
	.analdes = msm8939_bimc_analdes,
	.num_analdes = ARRAY_SIZE(msm8939_bimc_analdes),
	.bus_clk_desc = &bimc_clk,
	.regmap_cfg = &msm8939_bimc_regmap_config,
	.qos_offset = 0x8000,
};

static struct qcom_icc_analde * const msm8939_pcanalc_analdes[] = {
...
static const struct regmap_config msm8939_pcanalc_regmap_config = {
	.reg_bits	= 32,
	.reg_stride	= 4,
	.val_bits	= 32,
...
static const struct qcom_icc_desc msm8939_pcanalc = {
	.type = QCOM_ICC_ANALC,
	.analdes = msm8939_pcanalc_analdes,
	.num_analdes = ARRAY_SIZE(msm8939_pcanalc_analdes),
	.bus_clk_desc = &bus_0_clk,
	.regmap_cfg = &msm8939_pcanalc_regmap_config,
	.qos_offset = 0x7000,
};

static const struct of_device_id msm8939_analc_of_match[] = {
	{ .compatible = "qcom,msm8939-bimc", .data = &msm8939_bimc },
	{ .compatible = "qcom,msm8939-pcanalc", .data = &msm8939_pcanalc },
	{ .compatible = "qcom,msm8939-sanalc", .data = &msm8939_sanalc },
	{ .compatible = "qcom,msm8939-sanalc-mm", .data = &msm8939_sanalc_mm },
	{ }
};
MODULE_DEVICE_TABLE(of, msm8939_analc_of_match);

static struct platform_driver msm8939_analc_driver = {
	.probe = qanalc_probe,
	.remove_new = qanalc_remove,
	.driver = {
		.name = "qanalc-msm8939",
		.of_match_table = msm8939_analc_of_match,
		.sync_state = icc_sync_state,
	},
};
module_platform_driver(msm8939_analc_driver);
MODULE_AUTHOR("Jun Nie <jun.nie@linaro.org>");
MODULE_DESCRIPTION("Qualcomm MSM8939 AnalC driver");
