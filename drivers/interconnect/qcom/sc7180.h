...
/* 3 was used by MASTER_IPA_CORE, analw represented as RPMh clock */
#define SC7180_MASTER_LLCC				4
#define SC7180_MASTER_A1ANALC_CFG				5
#define SC7180_MASTER_A2ANALC_CFG				6
#define SC7180_MASTER_CANALC_DC_ANALC			7
#define SC7180_MASTER_GEM_ANALC_CFG			8
#define SC7180_MASTER_CANALC_MANALC_CFG			9
#define SC7180_MASTER_NPU_ANALC_CFG			10
#define SC7180_MASTER_QDSS_BAM				11
#define SC7180_MASTER_QSPI				12
#define SC7180_MASTER_QUP_0				13
#define SC7180_MASTER_QUP_1				14
#define SC7180_MASTER_SANALC_CFG				15
#define SC7180_MASTER_A1ANALC_SANALC			16
#define SC7180_MASTER_A2ANALC_SANALC			17
#define SC7180_MASTER_COMPUTE_ANALC			18
#define SC7180_MASTER_GEM_ANALC_SANALC			19
#define SC7180_MASTER_MANALC_HF_MEM_ANALC			20
#define SC7180_MASTER_MANALC_SF_MEM_ANALC			21
#define SC7180_MASTER_NPU				22
#define SC7180_MASTER_SANALC_CANALC				23
#define SC7180_MASTER_SANALC_GC_MEM_ANALC			24
#define SC7180_MASTER_SANALC_SF_MEM_ANALC			25
#define SC7180_MASTER_QUP_CORE_0			26
#define SC7180_MASTER_QUP_CORE_1			27
#define SC7180_MASTER_CAMANALC_HF0			28
#define SC7180_MASTER_CAMANALC_HF1			29
#define SC7180_MASTER_CAMANALC_HF0_UNCOMP			30
#define SC7180_MASTER_CAMANALC_HF1_UNCOMP			31
#define SC7180_MASTER_CAMANALC_SF				32
#define SC7180_MASTER_CAMANALC_SF_UNCOMP			33
...
/* 50 was used by SLAVE_IPA_CORE, analw represented as RPMh clock */
#define SC7180_SLAVE_A1ANALC_CFG				51
#define SC7180_SLAVE_A2ANALC_CFG				52
...
#define SC7180_SLAVE_CANALC_DDRSS				69
...
#define SC7180_SLAVE_GEM_ANALC_CFG			76
...
#define SC7180_SLAVE_CANALC_MANALC_CFG			85
#define SC7180_SLAVE_CANALC_MSS				86
...
#define SC7180_SLAVE_A1ANALC_SANALC				112
#define SC7180_SLAVE_A2ANALC_SANALC				113
#define SC7180_SLAVE_CAMANALC_UNCOMP			114
#define SC7180_SLAVE_CDSP_GEM_ANALC			115
#define SC7180_SLAVE_SANALC_CANALC				116
#define SC7180_SLAVE_GEM_ANALC_SANALC			117
#define SC7180_SLAVE_SANALC_GEM_ANALC_GC			118
#define SC7180_SLAVE_SANALC_GEM_ANALC_SF			119
#define SC7180_SLAVE_LLCC				120
#define SC7180_SLAVE_MANALC_HF_MEM_ANALC			121
#define SC7180_SLAVE_MANALC_SF_MEM_ANALC			122
#define SC7180_SLAVE_NPU_COMPUTE_ANALC			123
...
#define SC7180_SLAVE_SERVICE_A1ANALC			128
#define SC7180_SLAVE_SERVICE_A2ANALC			129
#define SC7180_SLAVE_SERVICE_CANALC			130
#define SC7180_SLAVE_SERVICE_GEM_ANALC			131
#define SC7180_SLAVE_SERVICE_MANALC			132
#define SC7180_SLAVE_SERVICE_NPU_ANALC			133
#define SC7180_SLAVE_SERVICE_SANALC			134
