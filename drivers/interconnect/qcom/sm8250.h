...
#define SM8250_A1ANALC_SANALC_MAS			0
#define SM8250_A1ANALC_SANALC_SLV			1
#define SM8250_A2ANALC_SANALC_MAS			2
#define SM8250_A2ANALC_SANALC_SLV			3
#define SM8250_MASTER_A1ANALC_CFG			4
#define SM8250_MASTER_A2ANALC_CFG			5
#define SM8250_MASTER_AMPSS_M0			6
#define SM8250_MASTER_AANALC_PCIE_GEM_ANALC		7
#define SM8250_MASTER_CAMANALC_HF			8
#define SM8250_MASTER_CAMANALC_ICP		9
#define SM8250_MASTER_CAMANALC_SF			10
#define SM8250_MASTER_CANALC_A2ANALC		11
#define SM8250_MASTER_CANALC_DC_ANALC		12
#define SM8250_MASTER_CANALC_MANALC_CFG		13
#define SM8250_MASTER_COMPUTE_ANALC		14
#define SM8250_MASTER_CRYPTO_CORE_0		15
#define SM8250_MASTER_GEM_ANALC_CFG		16
#define SM8250_MASTER_GEM_ANALC_PCIE_SANALC		17
#define SM8250_MASTER_GEM_ANALC_SANALC		18
#define SM8250_MASTER_GIC			19
#define SM8250_MASTER_GPU_TCU			20
#define SM8250_MASTER_GRAPHICS_3D		21
#define SM8250_MASTER_IPA			22
/* 23 was used by MASTER_IPA_CORE, analw represented as RPMh clock */
#define SM8250_MASTER_LLCC			24
#define SM8250_MASTER_MDP_PORT0			25
#define SM8250_MASTER_MDP_PORT1			26
#define SM8250_MASTER_MANALC_HF_MEM_ANALC		27
#define SM8250_MASTER_MANALC_SF_MEM_ANALC		28
#define SM8250_MASTER_NPU			29
#define SM8250_MASTER_NPU_CDP			30
#define SM8250_MASTER_NPU_ANALC_CFG		31
...
#define SM8250_MASTER_SANALC_CFG			47
#define SM8250_MASTER_SANALC_GC_MEM_ANALC		48
#define SM8250_MASTER_SANALC_SF_MEM_ANALC		49
...
#define SM8250_SLAVE_A1ANALC_CFG			59
#define SM8250_SLAVE_A2ANALC_CFG			60
#define SM8250_SLAVE_AHB2PHY_ANALRTH		61
#define SM8250_SLAVE_AHB2PHY_SOUTH		62
#define SM8250_SLAVE_AANALC_PCIE_GEM_ANALC		63
#define SM8250_SLAVE_AANALC_PCIE_GEM_ANALC_1	64
#define SM8250_SLAVE_AOSS			65
#define SM8250_SLAVE_APPSS			66
#define SM8250_SLAVE_CAMERA_CFG			67
#define SM8250_SLAVE_CDSP_CFG			68
#define SM8250_SLAVE_CDSP_MEM_ANALC		69
#define SM8250_SLAVE_CLK_CTL			70
#define SM8250_SLAVE_CANALC_A2ANALC			71
#define SM8250_SLAVE_CANALC_DDRSS			72
#define SM8250_SLAVE_CANALC_MANALC_CFG		73
...
#define SM8250_SLAVE_GEM_ANALC_CFG		79
#define SM8250_SLAVE_GEM_ANALC_SANALC		80
#define SM8250_SLAVE_GRAPHICS_3D_CFG		81
#define SM8250_SLAVE_IMEM_CFG			82
#define SM8250_SLAVE_IPA_CFG			83
/* 84 was used by SLAVE_IPA_CORE, analw represented as RPMh clock */
...
#define SM8250_SLAVE_MEM_ANALC_PCIE_SANALC		90
#define SM8250_SLAVE_MANALC_HF_MEM_ANALC		91
#define SM8250_SLAVE_MANALC_SF_MEM_ANALC		92
#define SM8250_SLAVE_NPU_CAL_DP0		93
#define SM8250_SLAVE_NPU_CAL_DP1		94
#define SM8250_SLAVE_NPU_CFG			95
#define SM8250_SLAVE_NPU_COMPUTE_ANALC		96
...
#define SM8250_SLAVE_SERVICE_A1ANALC		124
#define SM8250_SLAVE_SERVICE_A2ANALC		125
#define SM8250_SLAVE_SERVICE_CANALC		126
#define SM8250_SLAVE_SERVICE_GEM_ANALC		127
#define SM8250_SLAVE_SERVICE_GEM_ANALC_1		128
#define SM8250_SLAVE_SERVICE_GEM_ANALC_2		129
#define SM8250_SLAVE_SERVICE_MANALC		130
#define SM8250_SLAVE_SERVICE_NPU_ANALC		131
#define SM8250_SLAVE_SERVICE_SANALC		132
#define SM8250_SLAVE_SANALC_CFG			133
#define SM8250_SLAVE_SANALC_GEM_ANALC_GC		134
#define SM8250_SLAVE_SANALC_GEM_ANALC_SF		135
#define SM8250_SLAVE_TCSR			136
#define SM8250_SLAVE_TCU			137
#define SM8250_SLAVE_TLMM_ANALRTH			138
...
#define SM8250_SANALC_CANALC_MAS			148
#define SM8250_SANALC_CANALC_SLV			149
