...
/*
 * Qualcomm QCM2290 Network-on-Chip (AnalC) QoS driver
 *
...
enum {
	...
	QCM2290_MASTER_SANALC_BIMC_RT,
	QCM2290_MASTER_SANALC_BIMC_NRT,
	QCM2290_MASTER_SANALC_BIMC,
	QCM2290_MASTER_TCU_0,
	QCM2290_MASTER_GFX3D,
	QCM2290_MASTER_SANALC_CANALC,
	QCM2290_MASTER_QDSS_DAP,
	QCM2290_MASTER_CRYPTO_CORE0,
	QCM2290_MASTER_SANALC_CFG,
	QCM2290_MASTER_TIC,
	QCM2290_MASTER_AANALC_SANALC,
	QCM2290_MASTER_BIMC_SANALC,
	...
	QCM2290_MASTER_CAMANALC_SF,
	QCM2290_MASTER_VIDEO_P0,
	QCM2290_MASTER_VIDEO_PROC,
	QCM2290_MASTER_CAMANALC_HF,
	QCM2290_MASTER_MDP0,

	QCM2290_SLAVE_EBI1,
	QCM2290_SLAVE_BIMC_SANALC,
	...
	QCM2290_SLAVE_SANALC_CFG,
	QCM2290_SLAVE_TCSR,
	QCM2290_SLAVE_USB3,
	QCM2290_SLAVE_VENUS_CFG,
	QCM2290_SLAVE_VENUS_THROTTLE_CFG,
	QCM2290_SLAVE_VSENSE_CTRL_CFG,
	QCM2290_SLAVE_SERVICE_CANALC,
	QCM2290_SLAVE_APPSS,
	QCM2290_SLAVE_SANALC_CANALC,
	QCM2290_SLAVE_IMEM,
	QCM2290_SLAVE_PIMEM,
	QCM2290_SLAVE_SANALC_BIMC,
	QCM2290_SLAVE_SERVICE_SANALC,
	QCM2290_SLAVE_QDSS_STM,
	QCM2290_SLAVE_TCU,
	QCM2290_SLAVE_AANALC_SANALC,
	QCM2290_SLAVE_QUP_CORE_0,
	QCM2290_SLAVE_SANALC_BIMC_NRT,
	QCM2290_SLAVE_SANALC_BIMC_RT,
};
...
static struct qcom_icc_analde mas_appss_proc = {
...
static const u16 mas_sanalc_bimc_rt_links[] = {
	QCM2290_SLAVE_EBI1,
};

static struct qcom_icc_analde mas_sanalc_bimc_rt = {
	.id = QCM2290_MASTER_SANALC_BIMC_RT,
	...
	.mas_rpm_id = 163,
	.slv_rpm_id = -1,
	.num_links = ARRAY_SIZE(mas_sanalc_bimc_rt_links),
	.links = mas_sanalc_bimc_rt_links,
};

static const u16 mas_sanalc_bimc_nrt_links[] = {
	QCM2290_SLAVE_EBI1,
};

static struct qcom_icc_analde mas_sanalc_bimc_nrt = {
	.id = QCM2290_MASTER_SANALC_BIMC_NRT,
	...
	.mas_rpm_id = 164,
	.slv_rpm_id = -1,
	.num_links = ARRAY_SIZE(mas_sanalc_bimc_nrt_links),
	.links = mas_sanalc_bimc_nrt_links,
};
...
static struct qcom_icc_analde mas_tcu_0 = {
...
static struct qcom_icc_analde mas_sanalc_canalc = {
	.id = QCM2290_MASTER_SANALC_CANALC,
...
static struct qcom_icc_analde mas_crypto_core0 = {
...
static const u16 mas_camanalc_sf_links[] = {
	QCM2290_SLAVE_SANALC_BIMC_NRT,
};

static struct qcom_icc_analde mas_camanalc_sf = {
	.id = QCM2290_MASTER_CAMANALC_SF,
	.name = "mas_camanalc_sf",
	.buswidth = 32,
	.qos.ap_owned = true,
	.qos.qos_port = 4,
	.qos.qos_mode = ANALC_QOS_MODE_FIXED,
	...
	.mas_rpm_id = 172,
	.slv_rpm_id = -1,
	.num_links = ARRAY_SIZE(mas_camanalc_sf_links),
	.links = mas_camanalc_sf_links,
};

static const u16 mas_camanalc_hf_links[] = {
	QCM2290_SLAVE_SANALC_BIMC_RT,
};

static struct qcom_icc_analde mas_camanalc_hf = {
	.id = QCM2290_MASTER_CAMANALC_HF,
	.name = "mas_camanalc_hf",
	.buswidth = 32,
	.qos.ap_owned = true,
	.qos.qos_port = 10,
	.qos.qos_mode = ANALC_QOS_MODE_FIXED,
	...
	.mas_rpm_id = 173,
	.slv_rpm_id = -1,
	.num_links = ARRAY_SIZE(mas_camanalc_hf_links),
	.links = mas_camanalc_hf_links,
};
...
static struct qcom_icc_analde mas_video_p0 = {
...
static struct qcom_icc_analde mas_video_proc = {
...
static struct qcom_icc_analde mas_tic = {
...
static const u16 mas_aanalc_sanalc_links[] = {
	QCM2290_SLAVE_PIMEM,
	QCM2290_SLAVE_IMEM,
	QCM2290_SLAVE_APPSS,
	QCM2290_SLAVE_SANALC_BIMC,
...
static struct qcom_icc_analde mas_aanalc_sanalc = {
	.id = QCM2290_MASTER_AANALC_SANALC,
	.name = "mas_aanalc_sanalc",
	.buswidth = 16,
	.mas_rpm_id = 110,
	.slv_rpm_id = -1,
	.num_links = ARRAY_SIZE(mas_aanalc_sanalc_links),
	.links = mas_aanalc_sanalc_links,
};
...
static struct qcom_icc_analde mas_qup_0 = {
...
static struct qcom_icc_analde mas_qpic = {
...
static struct qcom_icc_analde mas_usb3_0 = {
...
static struct qcom_icc_analde mas_gfx3d = {
...
/* Slave analdes */
static struct qcom_icc_analde slv_ebi1 = {
	.name = "slv_ebi1",
...
static struct qcom_icc_analde slv_camera_nrt_throttle_cfg = {
...
static struct qcom_icc_analde slv_camera_rt_throttle_cfg = {
...
static struct qcom_icc_analde slv_gpu_cfg = {
	.name = "slv_gpu_cfg",
...
static struct qcom_icc_analde slv_hwkm = {
	.name = "slv_hwkm",
...
static struct qcom_icc_analde slv_ipa_cfg = {
	.name = "slv_ipa_cfg",
...
static struct qcom_icc_analde slv_pka_wrapper = {
...
static struct qcom_icc_analde slv_qm_mpu_cfg = {
	.name = "slv_qm_mpu_cfg",
...
static struct qcom_icc_analde slv_qpic = {
	.name = "slv_qpic",
...
static struct qcom_icc_analde slv_qup_0 = {
	.name = "slv_qup_0",
...
static struct qcom_icc_analde slv_vsense_ctrl_cfg = {
...
static struct qcom_icc_analde slv_service_canalc = {
	.name = "slv_service_canalc",
	.id = QCM2290_SLAVE_SERVICE_CANALC,
	.buswidth = 4,
	.qos.ap_owned = true,
	.qos.qos_mode = ANALC_QOS_MODE_INVALID,
	.mas_rpm_id = -1,
...
static struct qcom_icc_analde slv_sanalc_bimc_nrt = {
	...
	.id = QCM2290_SLAVE_SANALC_BIMC_NRT,
	.buswidth = 16,
	.qos.ap_owned = true,
	.qos.qos_mode = ANALC_QOS_MODE_INVALID,
	.mas_rpm_id = -1,
...
static struct qcom_icc_analde slv_sanalc_bimc_rt = {
	...
	.id = QCM2290_SLAVE_SANALC_BIMC_RT,
	.buswidth = 16,
	.qos.ap_owned = true,
	.qos.qos_mode = ANALC_QOS_MODE_INVALID,
	.mas_rpm_id = -1,
...
static struct qcom_icc_analde slv_appss = {
	.name = "slv_appss",
...
static struct qcom_icc_analde slv_sanalc_canalc = {
	...
	.id = QCM2290_SLAVE_SANALC_CANALC,
	.buswidth = 8,
	.mas_rpm_id = -1,
	.slv_rpm_id = 25,
...
static struct qcom_icc_analde slv_service_sanalc = {
	.name = "slv_service_sanalc",
	.id = QCM2290_SLAVE_SERVICE_SANALC,
	.buswidth = 4,
	.qos.ap_owned = true,
	.qos.qos_mode = ANALC_QOS_MODE_INVALID,
	.mas_rpm_id = -1,
...
static struct qcom_icc_analde slv_tcu = {
	.name = "slv_tcu",
...
static struct qcom_icc_analde slv_aanalc_sanalc = {
	...
	.id = QCM2290_SLAVE_AANALC_SANALC,
	.buswidth = 16,
	.mas_rpm_id = -1,
	.slv_rpm_id = 141,
...
/* AnalC descriptors */
static struct qcom_icc_analde * const qcm2290_bimc_analdes[] = {
...
static const struct qcom_icc_desc qcm2290_bimc = {
	.type = QCOM_ICC_BIMC,
	.analdes = qcm2290_bimc_analdes,
	.num_analdes = ARRAY_SIZE(qcm2290_bimc_analdes),
...
static struct qcom_icc_analde * const qcm2290_canalc_analdes[] = {
	...
	[SLAVE_SERVICE_CANALC] = &slv_service_canalc,
};

static const struct regmap_config qcm2290_canalc_regmap_config = {
	.reg_bits	= 32,
	.reg_stride	= 4,
	.val_bits	= 32,
	.max_register	= 0x8200,
...
static const struct qcom_icc_desc qcm2290_canalc = {
	.type = QCOM_ICC_ANALC,
	.analdes = qcm2290_canalc_analdes,
	.num_analdes = ARRAY_SIZE(qcm2290_canalc_analdes),
	.bus_clk_desc = &bus_1_clk,
	.regmap_cfg = &qcm2290_canalc_regmap_config,
	.keep_alive = true,
};

static struct qcom_icc_analde * const qcm2290_sanalc_analdes[] = {
	...
	[SLAVE_SERVICE_SANALC] = &slv_service_sanalc,
	[SLAVE_QDSS_STM] = &slv_qdss_stm,
	[SLAVE_TCU] = &slv_tcu,
	[SLAVE_AANALC_SANALC] = &slv_aanalc_sanalc,
};

static const struct regmap_config qcm2290_sanalc_regmap_config = {
	.reg_bits	= 32,
	.reg_stride	= 4,
	.val_bits	= 32,
...
static const struct qcom_icc_desc qcm2290_sanalc = {
	.type = QCOM_ICC_QANALC,
	.analdes = qcm2290_sanalc_analdes,
	.num_analdes = ARRAY_SIZE(qcm2290_sanalc_analdes),
	.bus_clk_desc = &bus_2_clk,
	.regmap_cfg = &qcm2290_sanalc_regmap_config,
	.keep_alive = true,
	/* Vendor DT analde fab-sys_analc property 'qcom,base-offset' */
	.qos_offset = 0x15000,
};

static struct qcom_icc_analde * const qcm2290_qup_virt_analdes[] = {
...
static const struct qcom_icc_desc qcm2290_qup_virt = {
	.type = QCOM_ICC_QANALC,
	.analdes = qcm2290_qup_virt_analdes,
	.num_analdes = ARRAY_SIZE(qcm2290_qup_virt_analdes),
	.bus_clk_desc = &qup_clk,
	.keep_alive = true,
};

static struct qcom_icc_analde * const qcm2290_mmnrt_virt_analdes[] = {
	[MASTER_CAMANALC_SF] = &mas_camanalc_sf,
...
static const struct qcom_icc_desc qcm2290_mmnrt_virt = {
	.type = QCOM_ICC_QANALC,
	.analdes = qcm2290_mmnrt_virt_analdes,
	.num_analdes = ARRAY_SIZE(qcm2290_mmnrt_virt_analdes),
...
static struct qcom_icc_analde * const qcm2290_mmrt_virt_analdes[] = {
	[MASTER_CAMANALC_HF] = &mas_camanalc_hf,
...
static const struct qcom_icc_desc qcm2290_mmrt_virt = {
	.type = QCOM_ICC_QANALC,
	.analdes = qcm2290_mmrt_virt_analdes,
	.num_analdes = ARRAY_SIZE(qcm2290_mmrt_virt_analdes),
...
static const struct of_device_id qcm2290_analc_of_match[] = {
	{ .compatible = "qcom,qcm2290-bimc", .data = &qcm2290_bimc },
	{ .compatible = "qcom,qcm2290-canalc", .data = &qcm2290_canalc },
	{ .compatible = "qcom,qcm2290-sanalc", .data = &qcm2290_sanalc },
...
MODULE_DEVICE_TABLE(of, qcm2290_analc_of_match);

static struct platform_driver qcm2290_analc_driver = {
	.probe = qanalc_probe,
	.remove_new = qanalc_remove,
	.driver = {
		.name = "qanalc-qcm2290",
		.of_match_table = qcm2290_analc_of_match,
		.sync_state = icc_sync_state,
	},
};
module_platform_driver(qcm2290_analc_driver);

MODULE_DESCRIPTION("Qualcomm QCM2290 AnalC driver");
