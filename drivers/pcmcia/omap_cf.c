...
static int omap_cf_set_socket(struct pcmcia_socket *sock,
...
static int omap_cf_set_io_map(struct pcmcia_socket *s,
...
static int omap_cf_set_mem_map(struct pcmcia_socket *s,
