 ...
 */
static unsigned int sa1100_pcmcia_default_mecr_timing(
 ...
 */
static int sa1100_pcmcia_set_mecr(struct soc_pcmcia_socket *skt,
...
static int sa1100_pcmcia_frequency_change(struct soc_pcmcia_socket *skt,
    unsigned long val,
...
static int sa1100_pcmcia_set_timing(struct soc_pcmcia_socket *skt) {
  unsigned long clk = clk_get_rate(skt->clk);
  return sa1100_pcmcia_set_mecr(skt, clk / 1000);
}

static int sa1100_pcmcia_show_timing(struct soc_pcmcia_socket *skt, char *buf) {
  struct soc_pcmcia_timing timing;
