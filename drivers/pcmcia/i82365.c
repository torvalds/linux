...
static ssize_t show_info(struct class_device *class_dev, char *buf) {
  struct i82365_socket *s = container_of(class_dev, struct i82365_socket,
      socket.dev);
...
static int pcic_set_mem_map(struct pcmcia_socket *s,
