...
#define MTK_SOCINFO_ENTRY(_soc_name, _segment_name, _marketing_name, \
...
static struct socinfo_data socinfo_data_table[] = {
  ...
  MTK_SOCINFO_ENTRY("MT8183", "MT8183V/AZA", "Kompanio 500", 0x00010043,
      0x00000840),
  MTK_SOCINFO_ENTRY("MT8183", "MT8183V/AZA", "Kompanio 500", 0x00010043,
      0x00000940),
  MTK_SOCINFO_ENTRY("MT8186", "MT8186GV/AZA", "Kompanio 520", 0x81861001,
      CELL_NOT_USED),
  MTK_SOCINFO_ENTRY("MT8186T", "MT8186TV/AZA", "Kompanio 528", 0x81862001,
      CELL_NOT_USED),
  MTK_SOCINFO_ENTRY("MT8188", "MT8188GV/AZA", "Kompanio 830", 0x81880000,
      0x00000010),
  MTK_SOCINFO_ENTRY("MT8188", "MT8188GV/HZA", "Kompanio 830", 0x81880000,
      0x00000011),
  MTK_SOCINFO_ENTRY("MT8192", "MT8192V/AZA", "Kompanio 820", 0x00001100,
      0x00040080),
  MTK_SOCINFO_ENTRY("MT8192T", "MT8192V/ATZA", "Kompanio 828", 0x00000100,
      0x000400C0),
  MTK_SOCINFO_ENTRY("MT8195", "MT8195GV/EZA", "Kompanio 1200", 0x81950300,
      CELL_NOT_USED),
  MTK_SOCINFO_ENTRY("MT8195", "MT8195GV/EHZA", "Kompanio 1200", 0x81950304,
      CELL_NOT_USED),
  MTK_SOCINFO_ENTRY("MT8195", "MT8195TV/EZA", "Kompanio 1380", 0x81950400,
      CELL_NOT_USED),
  MTK_SOCINFO_ENTRY("MT8195", "MT8195TV/EHZA", "Kompanio 1380", 0x81950404,
      CELL_NOT_USED),
};
...
static int mtk_socinfo_create_socinfo_node(struct mtk_socinfo *mtk_socinfop) {
  ...
  snprintf(machine, sizeof(machine), "%s (%s)",
      mtk_socinfop->socinfo_data->marketing_name,
...
static int mtk_socinfo_probe(struct platform_device *pdev) {
  ...
  if (ret < 0) {
    return dev_err_probe(mtk_socinfop->dev, ret,
        "Failed to get socinfo data\n");
  }
