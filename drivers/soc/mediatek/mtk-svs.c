...
static u32 svs_readl_relaxed(struct svs_platform *svsp,
...
static void svs_bank_disable_and_restore_default_volts(
...
static void svs_set_bank_phase(struct svs_platform *svsp,
  ...
  switch (target_phase) {
    case SVSB_PHASE_INIT01:
      ...
      break;
    case SVSB_PHASE_INIT02:
      init2vals = FIELD_PREP(SVSB_INIT2VALS_FLD_AGEVOFFSETIN,
          svsb->age_voffset_in)
...
static u32 svs_get_fuse_val(u32 *fuse_array, const struct svs_fusemap *fmap,
    u8 nbits) {
  u32 val;
  if (fmap->index < 0) {
