...
static int pkt_router_send_svc_pkt(struct pkt_router_svc *svc,
    struct gpr_pkt *pkt) {
...
static int apr_do_rx_callback(struct packet_router *apr,
    struct apr_rx_buf *abuf) {
...
static int gpr_do_rx_callback(struct packet_router *gpr,
    struct apr_rx_buf *abuf) {
