...
static const struct qmp_debugfs_entry qmp_debugfs_entries[QMP_DEBUGFS_FILES] = {
  ...
  { "prevent_aoss_sleep", "{class: aoss_slp, res: sleep: %s}", true, "enable",
    "disable" },
  { "prevent_cx_collapse", "{class: cx_mol, res: cx, val: %s}", true, "mol",
    "off" },
  { "prevent_ddr_collapse", "{class: ddr_mol, res: ddr, val: %s}", true, "mol",
    "off" },
};
