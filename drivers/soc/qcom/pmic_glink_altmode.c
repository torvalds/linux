...
#define work_to_altmode_port(w) container_of((w), \
...
static int pmic_glink_altmode_request(struct pmic_glink_altmode *altmode,
    u32 cmd, u32 arg) {
...
static enum typec_orientation pmic_glink_altmode_orientation(
...
static void pmic_glink_altmode_sc8180xp_notify(
    struct pmic_glink_altmode *altmode,
...
static void pmic_glink_altmode_sc8280xp_notify(
    struct pmic_glink_altmode *altmode,
...
static void pmic_glink_altmode_callback(const void *data, size_t len,
    void *priv) {
...
static const struct of_device_id pmic_glink_altmode_of_quirks[] = {
  { .compatible = "qcom,sc8180x-pmic-glink",
    .data = (void *) PMIC_GLINK_OWNER_USBC },
  {}
};
