 ...
 */
static inline int qbman_swp_enqueue(struct qbman_swp *s,
    const struct qbman_eq_desc *d,
    const struct dpaa2_fd *fd) {
 ...
 */
static inline int qbman_swp_enqueue_multiple(struct qbman_swp *s,
    const struct qbman_eq_desc *d,
    const struct dpaa2_fd *fd,
    uint32_t *flags,
    int num_frames) {
 ...
 * Return the number of fd enqueued, or a negative error number.
 */
static inline int qbman_swp_enqueue_multiple_desc(struct qbman_swp *s,
    const struct qbman_eq_desc *d,
    const struct dpaa2_fd *fd,
    int num_frames) {
