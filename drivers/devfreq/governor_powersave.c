...
/*
 *  linux/drivers/devfreq/goveryesr_powersave.c
 *
...
static struct devfreq_goveryesr devfreq_powersave = {
...
{
	return devfreq_add_goveryesr(&devfreq_powersave);
}
...
static void __exit devfreq_powersave_exit(void)
{
	...
	ret = devfreq_remove_goveryesr(&devfreq_powersave);
	if (ret)
