...
#define AST2600_I3CG_REG1_ACT_MODE(x)   (((x) << \
    2) & AST2600_I3CG_REG1_ACT_MODE_MASK)
#define AST2600_I3CG_REG1_PENDING_INT_MASK  GENMASK(7, 4)
#define AST2600_I3CG_REG1_PENDING_INT(x)  (((x) << \
    4) & AST2600_I3CG_REG1_PENDING_INT_MASK)
...
#define AST2600_I3CG_REG1_INST_ID(x)    (((x) << \
    16) & AST2600_I3CG_REG1_INST_ID_MASK)
