...
static inline struct cdns_i3c_master *to_cdns_i3c_master(
...
static struct cdns_i3c_xfer *cdns_i3c_master_alloc_xfer(
    struct cdns_i3c_master *master, unsigned int ncmds) {
