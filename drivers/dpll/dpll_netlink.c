...
static int dpll_msg_add_dev_handle(struct sk_buff *msg,
...
static int dpll_msg_add_dev_parent_handle(struct sk_buff *msg, u32 id) {
...
static int dpll_msg_add_mode(struct sk_buff *msg, struct dpll_device *dpll,
...
static int dpll_msg_add_mode_supported(struct sk_buff *msg,
    struct dpll_device *dpll,
    struct netlink_ext_ack *extack) {
  const struct dpll_device_ops *ops = dpll_device_ops(dpll);
  enum dpll_mode mode;
...
static int dpll_msg_add_lock_status(struct sk_buff *msg,
    struct dpll_device *dpll,
    struct netlink_ext_ack *extack) {
  const struct dpll_device_ops *ops = dpll_device_ops(dpll);
...
static int dpll_msg_add_pin_prio(struct sk_buff *msg, struct dpll_pin *pin,
...
static int dpll_msg_add_pin_on_dpll_state(struct sk_buff *msg,
    struct dpll_pin *pin,
    struct dpll_pin_ref *ref,
    struct netlink_ext_ack *extack) {
  const struct dpll_pin_ops *ops = dpll_pin_ops(ref);
...
static int dpll_msg_add_pin_direction(struct sk_buff *msg, struct dpll_pin *pin,
    struct dpll_pin_ref *ref,
    struct netlink_ext_ack *extack) {
  const struct dpll_pin_ops *ops = dpll_pin_ops(ref);
  struct dpll_device *dpll = ref->dpll;
...
static int dpll_msg_add_pin_phase_adjust(struct sk_buff *msg,
    struct dpll_pin *pin,
    struct dpll_pin_ref *ref,
    struct netlink_ext_ack *extack) {
  const struct dpll_pin_ops *ops = dpll_pin_ops(ref);
...
static int dpll_msg_add_phase_offset(struct sk_buff *msg, struct dpll_pin *pin,
    struct dpll_pin_ref *ref,
    struct netlink_ext_ack *extack) {
  const struct dpll_pin_ops *ops = dpll_pin_ops(ref);
  struct dpll_device *dpll = ref->dpll;
...
static int dpll_msg_add_pin_freq(struct sk_buff *msg, struct dpll_pin *pin,
...
static int dpll_msg_add_pin_parents(struct sk_buff *msg, struct dpll_pin *pin,
...
static int dpll_msg_add_pin_dplls(struct sk_buff *msg, struct dpll_pin *pin,
    struct netlink_ext_ack *extack) {
  struct dpll_pin_ref *ref;
  struct nlattr *attr;
  unsigned long index;
...
static int dpll_cmd_pin_get_one(struct sk_buff *msg, struct dpll_pin *pin,
    struct netlink_ext_ack *extack) {
...
static int dpll_device_get_one(struct dpll_device *dpll, struct sk_buff *msg,
    struct netlink_ext_ack *extack) {
  int ret;
...
static int dpll_device_event_send(enum dpll_cmd event,
    struct dpll_device *dpll) {
  struct sk_buff *msg;
  int ret = -ENOMEM;
  void *hdr;
...
static int __dpll_device_change_ntf(struct dpll_device *dpll) {
...
static int dpll_pin_event_send(enum dpll_cmd event, struct dpll_pin *pin) {
  struct sk_buff *msg;
  int ret = -ENOMEM;
  void *hdr;
...
static int dpll_pin_freq_set(struct dpll_pin *pin, struct nlattr *a,
    struct netlink_ext_ack *extack) {
...
static int dpll_pin_on_pin_state_set(struct dpll_pin *pin, u32 parent_idx,
    enum dpll_pin_state state,
    struct netlink_ext_ack *extack) {
...
static int dpll_pin_state_set(struct dpll_device *dpll, struct dpll_pin *pin,
    enum dpll_pin_state state,
    struct netlink_ext_ack *extack) {
  const struct dpll_pin_ops *ops;
  struct dpll_pin_ref *ref;
...
static int dpll_pin_prio_set(struct dpll_device *dpll, struct dpll_pin *pin,
...
static int dpll_pin_direction_set(struct dpll_pin *pin,
    struct dpll_device *dpll,
    enum dpll_pin_direction direction,
    struct netlink_ext_ack *extack) {
  const struct dpll_pin_ops *ops;
...
static int dpll_pin_phase_adj_set(struct dpll_pin *pin,
...
static int dpll_pin_parent_device_set(struct dpll_pin *pin,
    struct nlattr *parent_nest,
    struct netlink_ext_ack *extack) {
...
static int dpll_pin_parent_pin_set(struct dpll_pin *pin,
    struct nlattr *parent_nest,
    struct netlink_ext_ack *extack) {
  struct nlattr *tb[DPLL_A_PIN_MAX + 1];
  u32 ppin_idx;
...
static int dpll_pin_set_from_nlattr(struct dpll_pin *pin,
...
static struct dpll_pin *dpll_pin_find(u64 clock_id,
    struct nlattr *mod_name_attr,
...
static struct dpll_device *dpll_device_find(u64 clock_id,
    struct nlattr *mod_name_attr,
...
static struct dpll_device *dpll_device_find_from_nlattr(struct genl_info *info)
{
...
int dpll_nl_device_get_dumpit(struct sk_buff *skb,
...
void dpll_unlock_doit(const struct genl_split_ops *ops, struct sk_buff *skb,
    struct genl_info *info) {
  mutex_unlock(&dpll_lock);
}
