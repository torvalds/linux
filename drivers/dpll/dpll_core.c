...
static struct dpll_pin_registration *dpll_pin_registration_find(
...
static int dpll_xa_ref_pin_add(struct xarray *xa_pins, struct dpll_pin *pin,
    const struct dpll_pin_ops *ops, void *priv) {
  struct dpll_pin_registration *reg;
  struct dpll_pin_ref *ref;
...
static int dpll_xa_ref_dpll_add(struct xarray *xa_dplls,
...
static void dpll_xa_ref_dpll_del(struct xarray *xa_dplls,
    struct dpll_device *dpll,
    const struct dpll_pin_ops *ops, void *priv) {
  struct dpll_pin_registration *reg;
  struct dpll_pin_ref *ref;
...
static struct dpll_device *dpll_device_alloc(const u64 clock_id, u32 device_idx,
 ...
 * * ERR_PTR(X) - error
 */
struct dpll_device *dpll_device_get(u64 clock_id, u32 device_idx,
    struct module *module) {
...
static struct dpll_pin *dpll_pin_alloc(u64 clock_id, u32 pin_idx,
    struct module *module,
...
static void dpll_netdev_pin_assign(struct net_device *dev,
 ...
 * * ERR_PTR(X) - error
 */
struct dpll_pin *dpll_pin_get(u64 clock_id, u32 pin_idx, struct module *module,
    const struct dpll_pin_properties *prop) {
...
static int __dpll_pin_register(struct dpll_device *dpll, struct dpll_pin *pin,
    const struct dpll_pin_ops *ops, void *priv) {
  int ret;
...
static void __dpll_pin_unregister(struct dpll_device *dpll,
    struct dpll_pin *pin,
    const struct dpll_pin_ops *ops, void *priv) {
...
static struct dpll_device_registration *dpll_device_registration_first(
    struct dpll_device *dpll) {
  struct dpll_device_registration *reg;
...
static struct dpll_pin_registration *dpll_pin_registration_first(
    struct dpll_pin_ref *ref) {
  struct dpll_pin_registration *reg;
