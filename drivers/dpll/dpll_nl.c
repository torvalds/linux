...
/* Common nested types */
const struct nla_policy dpll_pin_parent_device_nl_policy[DPLL_A_PIN_PHASE_OFFSET
    + 1] = {
...
static const struct nla_policy dpll_pin_id_get_nl_policy[DPLL_A_PIN_TYPE
    + 1] = {
...
static const struct nla_policy dpll_pin_get_dump_nl_policy[DPLL_A_PIN_ID
    + 1] = {
  [DPLL_A_PIN_ID] = { .type = NLA_U32, },
};
...
static const struct nla_policy dpll_pin_set_nl_policy[DPLL_A_PIN_PHASE_ADJUST
  ...
  [DPLL_A_PIN_PRIO] = { .type = NLA_U32, },
  [DPLL_A_PIN_STATE] = NLA_POLICY_RANGE(NLA_U32, 1, 3),
  [DPLL_A_PIN_PARENT_DEVICE] = NLA_POLICY_NESTED(
