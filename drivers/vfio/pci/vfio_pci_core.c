...
static int vfio_pci_get_irq_count(struct vfio_pci_core_device *vdev,
    int irq_type) {
...
static bool vfio_pci_dev_below_slot(struct pci_dev *pdev,
...
static int vfio_pci_ioctl_pci_hot_reset_groups(
    struct vfio_pci_core_device *vdev,
...
static int vfio_pci_zap_and_vma_lock(struct vfio_pci_core_device *vdev,
    bool try) {
 ...
 */
static struct pci_dev *vfio_pci_dev_set_resettable(
