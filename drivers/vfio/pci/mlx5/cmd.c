...
static int mlx5vf_cmd_get_vhca_id(struct mlx5_core_dev *mdev, u16 function_id,
    u16 *vhca_id);
static void _mlx5vf_free_page_tracker_resources(
...
static void mlx5vf_save_callback_complete(struct mlx5_vf_migration_file *migf,
...
static struct mlx5_vhca_qp *mlx5vf_create_rc_qp(struct mlx5_core_dev *mdev,
...
static void set_report_output(u32 size, int index, struct mlx5_vhca_qp *qp,
...
static void mlx5vf_rq_cqe(struct mlx5_vhca_qp *qp, struct mlx5_cqe64 *cqe,
...
static int mlx5vf_cq_poll_one(struct mlx5_vhca_cq *cq, struct mlx5_vhca_qp *qp,
    struct iova_bitmap *dirty, int *tracker_status) {
