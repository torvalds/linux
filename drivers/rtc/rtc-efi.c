 ...
 */
static inline int compute_yday(efi_time_t *eft) {
 ...
 */
static int compute_wday(efi_time_t *eft, int yday) {
...
static void convert_to_efi_time(struct rtc_time *wtime, efi_time_t *eft) {
...
static bool convert_from_efi_time(efi_time_t *eft, struct rtc_time *wtime) {
