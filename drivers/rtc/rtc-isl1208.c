...
/* block read */
static int isl1208_i2c_read_regs(struct i2c_client *client, u8 reg, u8 buf[],
    unsigned len) {
  int ret;
...
/* block write */
static int isl1208_i2c_set_regs(struct i2c_client *client, u8 reg,
    u8 const buf[],
    unsigned len) {
  int ret;
  WARN_ON(reg > ISL1219_REG_YRT);
...
static int isl1208_i2c_validate_client(struct i2c_client *client) {
  u8 regs[ISL1208_RTC_SECTION_LEN] = {
    0,
  };
...
static int isl1208_rtc_toggle_alarm(struct i2c_client *client, int enable) {
...
static int isl1208_i2c_read_alarm(struct i2c_client *client,
  ...
  u8 regs[ISL1208_ALARM_SECTION_LEN] = {
    0,
  };
...
static int isl1208_i2c_set_alarm(struct i2c_client *client,
    struct rtc_wkalrm *alarm) {
...
static int isl1208_rtc_read_alarm(struct device *dev,
    struct rtc_wkalrm *alarm) {
  return isl1208_i2c_read_alarm(to_i2c_client(dev), alarm);
}

static int isl1208_rtc_set_alarm(struct device *dev, struct rtc_wkalrm *alarm) {
...
static irqreturn_t isl1208_rtc_interrupt(int irq, void *data) {
...
static int isl1208_clk_present(struct i2c_client *client, const char *name) {
  struct clk *clk;
...
static int isl1208_probe(struct i2c_client *client) {
