...
static int imx_sc_rtc_alarm_yestify(struct yestifier_block *nb,
					unsigned long event, void *group)
{
	/* igyesre yesn-rtc irq */
...
static struct yestifier_block imx_sc_rtc_alarm_sc_yestifier = {
	.yestifier_call = imx_sc_rtc_alarm_yestify,
};
...
static int imx_sc_rtc_probe(struct platform_device *pdev)
{
	...
	imx_scu_irq_register_yestifier(&imx_sc_rtc_alarm_sc_yestifier);
