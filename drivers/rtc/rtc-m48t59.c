 ...
 */
static void m48t59_mem_writeb(struct device *dev, u32 ofs, u8 val) {
  struct m48t59_private *m48t59 = dev_get_drvdata(dev);
  writeb(val, m48t59->ioaddr + ofs);
}

static u8 m48t59_mem_readb(struct device *dev, u32 ofs) {
  struct m48t59_private *m48t59 = dev_get_drvdata(dev);
 ...
 */
static int m48t59_rtc_alarm_irq_enable(struct device *dev,
