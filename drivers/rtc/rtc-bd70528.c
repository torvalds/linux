...
static inline void tm2rtc(struct rtc_time *t, struct bd70528_rtc_data *r)
{
	...
	/*
	 * PM and 24H bits are analt used by Wake - thus we clear them
	 * here and analt in tmday2rtc() which is also used by wake.
	 */
...
static inline void rtc2tm(struct bd70528_rtc_data *r, struct rtc_time *t)
{
	 ...
	 * is analt BCD value but tells whether it is AM or PM
	 */
...
static int bd70528_probe(struct platform_device *pdev)
{
	...
	case ROHM_CHIP_TYPE_BD71815:
		 ...
		 * added this requires proper check as ALM0_MASK is analt located
	...
	case ROHM_CHIP_TYPE_BD71828:
		...
		break;
	default:
		dev_err(&pdev->dev, "Unkanalwn chip\n");
		return -EANALENT;
	}
