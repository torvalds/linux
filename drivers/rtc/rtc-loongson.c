...
/*
 * According to the LS1C manual, RTC_CTRL and alarm-related registers are not
 *defined.
...
static int loongson_rtc_read_alarm(struct device *dev,
...
static int loongson_rtc_alarm_irq_enable(struct device *dev,
