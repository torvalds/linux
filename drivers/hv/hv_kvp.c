 ...
 * This number has yes meaning, it satisfies the registration protocol.
 */
...
static void kvp_register_done(void)
{
	 ...
	 * work to yest poll the channel twice.
	 */
...
static int kvp_handle_handshake(struct hv_kvp_msg *msg)
{
	...
	case KVP_OP_REGISTER:
		...
		pr_info("KVP: IP injection functionality yest available\n");
...
copy_value:
	...
	/*
	 * If the utf8s to utf16s conversion failed; yestify host
	 * of the error.
	 */
 ...
 * component to retrieve the corresponding value. Consequently, we canyest
...
void hv_kvp_onchannelcallback(void *context)
{
	...
	if (kvp_transaction.state < HVUTIL_READY) {
		/*
		 * If userspace daemon is yest connected and host is asking
		 * us to negotiate we need to delay to yest lose messages.
