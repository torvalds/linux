...
static inline u32 hv_get_next_write_location(
...
static inline void hv_set_next_write_location(
    struct hv_ring_buffer_info *ring_info,
...
static inline u32 hv_get_ring_buffersize(
    const struct hv_ring_buffer_info *ring_info) {
  return ring_info->ring_datasize;
}

/* Get the read and write indices as u64 of the specified ring buffer. */
static inline u64 hv_get_ring_bufferindices(
    struct hv_ring_buffer_info *ring_info) {
 ...
 */
static void hv_get_ringbuffer_availbytes(const struct hv_ring_buffer_info *rbi,
    u32 *read, u32 *write) {
...
struct vmpacket_descriptor *hv_pkt_iter_first(struct vmbus_channel *channel) {
  ...
  desc
    = (struct vmpacket_descriptor *) (hv_get_ring_buffer(rbi)
      + rbi->priv_read_index);
  /*
 ...
 */
struct vmpacket_descriptor *__hv_pkt_iter_next(struct vmbus_channel *channel,
