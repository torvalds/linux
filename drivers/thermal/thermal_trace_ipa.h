...
TRACE_EVENT(thermal_power_allocator,
    ...
    TP_printk(
    "thermal_zone_id=%d total_req_power=%u total_granted_power=%u power_range=%u max_allocatable_power=%u current_temperature=%d delta_temperature=%d",
...
TRACE_EVENT(thermal_power_allocator_pid,
    ...
    TP_printk(
    "thermal_zone_id=%d err=%d err_integral=%d p=%lld i=%lld d=%lld output=%d",
