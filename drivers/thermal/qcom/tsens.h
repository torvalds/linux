...
/**
 * struct tsens_single_value - internal representation of a single field inside
...
/**
 * struct tsens_legacy_calibration_format - description of calibration data used
 * when parsing the legacy nvmem blob
...
struct tsens_legacy_calibration_format {
  ...
  /* on all platforms except 8974 invalid is the third bit of what downstream
   * calls 'mode' */
...
void compute_intercept_slope(struct tsens_priv *priv, u32 *pt1, u32 *pt2,
    u32 mode);
...
/* TSENS v0.1 targets */
extern struct tsens_plat_data data_8226, data_8909, data_8916, data_8939,
    data_8974, data_9607;
