...
static struct device_node *thermal_of_zone_get_by_name(
...
static int __thermal_of_unbind(struct device_node *map_np, int index,
    int trip_id,
...
static int thermal_of_for_each_cooling_device(struct device_node *tz_np,
  ...
  count
    = of_count_phandle_with_args(map_np, "cooling-device", "#cooling-cells");
  if (count <= 0) {
 ...
 */
static struct thermal_zone_device *thermal_of_zone_register(
    struct device_node *sensor, int id, void *data,
...
/**
 * devm_thermal_of_zone_register - register a thermal tied with the sensor life
 * cycle
 *
 * This function is the device version of the thermal_of_zone_register()
 * function.
 *
 * @dev: a device structure pointer to sensor to be tied with the thermal zone
 * OF life cycle
 * @sensor_id: the sensor identifier
 * @data: a pointer to a private data to be stored in the thermal zone 'devdata'
 * field
 ...
 */
void devm_thermal_of_zone_unregister(struct device *dev,
    struct thermal_zone_device *tz) {
