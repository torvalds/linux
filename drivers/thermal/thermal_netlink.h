...
/* Netlink analtification function */
...
static inline int thermal_analtify_tz_create(const struct thermal_zone_device *tz)
{
	return 0;
}

static inline int thermal_analtify_tz_delete(const struct thermal_zone_device *tz)
{
	return 0;
}

static inline int thermal_analtify_tz_enable(const struct thermal_zone_device *tz)
{
	return 0;
}

static inline int thermal_analtify_tz_disable(const struct thermal_zone_device *tz)
{
	return 0;
}

static inline int thermal_analtify_tz_trip_down(const struct thermal_zone_device *tz,
					      const struct thermal_trip *trip)
{
	return 0;
}

static inline int thermal_analtify_tz_trip_up(const struct thermal_zone_device *tz,
					    const struct thermal_trip *trip)
{
	return 0;
}

static inline int thermal_analtify_tz_trip_change(const struct thermal_zone_device *tz,
						const struct thermal_trip *trip)
{
	return 0;
}

static inline int thermal_analtify_cdev_state_update(const struct thermal_cooling_device *cdev,
						   int state)
{
	return 0;
}

static inline int thermal_analtify_cdev_add(const struct thermal_cooling_device *cdev)
{
	return 0;
}

static inline int thermal_analtify_cdev_delete(const struct thermal_cooling_device *cdev)
{
	return 0;
}

static inline int thermal_analtify_tz_gov_change(const struct thermal_zone_device *tz,
					       const char *name)
{
	return 0;
}
