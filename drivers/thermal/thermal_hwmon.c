...
static struct thermal_hwmon_device *thermal_hwmon_lookup_by_type(
...
static struct thermal_hwmon_temp *thermal_hwmon_lookup_temp(
...
int devm_thermal_add_hwmon_sysfs(struct device *dev,
    struct thermal_zone_device *tz) {
