...
int proc_thermal_rapl_add(struct pci_dev *pdev,
...
int proc_thermal_wt_req_add(struct pci_dev *pdev,
    struct proc_thermal_device *proc_priv);
...
int proc_thermal_power_floor_set_state(struct proc_thermal_device *proc_priv,
    bool enable);
...
int processor_thermal_send_mbox_read_cmd(struct pci_dev *pdev, u16 id,
    u64 *resp);
int processor_thermal_send_mbox_write_cmd(struct pci_dev *pdev, u16 id,
    u32 data);
...
int proc_thermal_wt_hint_add(struct pci_dev *pdev,
    struct proc_thermal_device *proc_priv);
void proc_thermal_wt_hint_remove(struct pci_dev *pdev);
void proc_thermal_wt_intr_callback(struct pci_dev *pdev,
    struct proc_thermal_device *proc_priv);
...
void proc_thermal_mmio_remove(struct pci_dev *pdev,
    struct proc_thermal_device *proc_priv);
#endif
