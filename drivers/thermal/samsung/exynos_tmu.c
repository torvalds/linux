 ...
 * @tmu_disable_low: SoC specific method to disable an interrupt (falling
 * threshold)
 * @tmu_disable_high: SoC specific method to disable an interrupt (rising
 * threshold)
...
static void exynos4210_tmu_set_high_temp(struct exynos_tmu_data *data,
    u8 temp) {
...
static void exynos4210_tmu_set_crit_temp(struct exynos_tmu_data *data,
    u8 temp) {
  /*
...
static void exynos4412_tmu_set_high_temp(struct exynos_tmu_data *data,
    u8 temp) {
...
static void exynos4412_tmu_set_crit_temp(struct exynos_tmu_data *data,
    u8 temp) {
...
static void exynos5433_tmu_set_high_temp(struct exynos_tmu_data *data,
    u8 temp) {
...
static void exynos5433_tmu_set_crit_temp(struct exynos_tmu_data *data,
    u8 temp) {
