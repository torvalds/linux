...
static void realtek_gpio_update_line_imr(struct realtek_gpio_ctrl *ctrl,
    unsigned int line) {
...
static inline void __iomem *realtek_gpio_irq_cpu_mask(
    struct realtek_gpio_ctrl *ctrl, int cpu) {
