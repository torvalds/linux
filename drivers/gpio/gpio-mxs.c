...
#define PINCTRL_DOUT(p)   ((is_imx23_gpio(p) ? 0x0500 : 0x0700) + (p->id) \
  * 0x10)
#define PINCTRL_DIN(p)    ((is_imx23_gpio(p) ? 0x0600 : 0x0900) + (p->id) \
  * 0x10)
#define PINCTRL_DOE(p)    ((is_imx23_gpio(p) ? 0x0700 : 0x0b00) + (p->id) \
  * 0x10)
#define PINCTRL_PIN2IRQ(p)  ((is_imx23_gpio(p) ? 0x0800 : 0x1000) + (p->id) \
  * 0x10)
#define PINCTRL_IRQEN(p)  ((is_imx23_gpio(p) ? 0x0900 : 0x1100) + (p->id) \
  * 0x10)
#define PINCTRL_IRQLEV(p) ((is_imx23_gpio(p) ? 0x0a00 : 0x1200) + (p->id) \
  * 0x10)
#define PINCTRL_IRQPOL(p) ((is_imx23_gpio(p) ? 0x0b00 : 0x1300) + (p->id) \
  * 0x10)
#define PINCTRL_IRQSTAT(p)  ((is_imx23_gpio(p) ? 0x0c00 : 0x1400) + (p->id) \
  * 0x10)
