...
static void f7188x_gpio_set(struct gpio_chip *chip, unsigned offset,
    int value) {
  int err;
  struct f7188x_gpio_bank *bank = gpiochip_get_data(chip);
  struct f7188x_sio *sio = bank->data->sio;
...
static int __init f7188x_gpio_device_add(const struct f7188x_sio *sio) {
  int err;
...
MODULE_DESCRIPTION(
    "GPIO driver for Super-I/O chips F71869, F71869A, F71882FG, F71889A, F71889F and F81866");
