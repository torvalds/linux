...
static int lp3943_gpio_direction_input(struct gpio_chip *chip,
    unsigned int offset) {
  struct lp3943_gpio *lp3943_gpio = gpiochip_get_data(chip);
...
static void lp3943_gpio_set(struct gpio_chip *chip, unsigned int offset,
    int value) {
  struct lp3943_gpio *lp3943_gpio = gpiochip_get_data(chip);
  u8 data;
  if (value) {
...
static int lp3943_gpio_direction_output(struct gpio_chip *chip,
    unsigned int offset,
    int value) {
  struct lp3943_gpio *lp3943_gpio = gpiochip_get_data(chip);
