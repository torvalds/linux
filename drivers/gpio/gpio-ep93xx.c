...
static struct ep93xx_gpio_irq_chip *to_ep93xx_gpio_irq_chip(
    struct gpio_chip *gc) {
...
#define EP93XX_GPIO_BANK(_label, _data, _dir, _irq, _base, _has_irq, _has_hier, \
      _irq_base) \
  {             \
    .label = _label,     \
    .data = _data,      \
...
static struct ep93xx_gpio_bank ep93xx_gpio_banks[] = {
  ...
  /* Bank F has 8 IRQs */
  EP93XX_GPIO_BANK("F", 0x30, 0x34, 0x4c, 16, false, true,
