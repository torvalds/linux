...
/**
 * struct gpio_array - Opaque descriptor for a structure of GPIO array
 *attributes
 *
...
#define FLAG_EVENT_CLOCK_REALTIME 18 /* GPIO CDEV reports REALTIME timestamps in
                                      * events */
#define FLAG_EVENT_CLOCK_HTE    19 /* GPIO CDEV reports hardware timestamps in
                                    * events */
...
static inline int gpiod_request_user(struct gpio_desc *desc,
    const char *label) {
  int ret;
