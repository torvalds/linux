...
static inline struct brcmstb_gpio_priv *brcmstb_gpio_gc_to_priv(
    struct gpio_chip *gc) {
  struct brcmstb_gpio_bank *bank = gpiochip_get_data(gc);
  return bank->parent_priv;
}

static unsigned long __brcmstb_gpio_get_active_irqs(
...
static unsigned long brcmstb_gpio_get_active_irqs(
    struct brcmstb_gpio_bank *bank) {
