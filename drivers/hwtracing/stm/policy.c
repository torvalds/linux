...
static inline struct stp_policy_node *to_stp_policy_node(
...
static ssize_t stp_policy_node_masters_show(struct config_item *item,
    char *page) {
...
static ssize_t stp_policy_node_masters_store(struct config_item *item,
    const char *page,
    size_t count) {
  struct stp_policy_node *policy_node = to_stp_policy_node(item);
...
static ssize_t stp_policy_node_channels_show(struct config_item *item,
    char *page) {
  struct stp_policy_node *policy_node = to_stp_policy_node(item);
  ssize_t count;
...
static ssize_t stp_policy_node_channels_store(struct config_item *item,
    const char *page,
    size_t count) {
  struct stp_policy_node *policy_node = to_stp_policy_node(item);
  unsigned int first, last;
...
static struct config_group *stp_policy_node_make(struct config_group *group,
    const char *name) {
...
static void stp_policy_node_drop(struct config_group *group,
    struct config_item *item) {
...
static struct config_group *stp_policy_make(struct config_group *group,
    const char *name) {
 ...
 */
static struct stp_policy_node *__stp_policy_node_lookup(
    struct stp_policy *policy, char *s) {
...
struct stp_policy_node *stp_policy_node_lookup(struct stm_device *stm,
    char *s) {
