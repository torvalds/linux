...
static ssize_t sys_t_policy_uuid_store(struct config_item *item,
    const char *page,
    size_t count) {
...
static ssize_t sys_t_policy_do_len_store(struct config_item *item,
    const char *page,
    size_t count) {
  struct mutex *mutexp = &item->ci_group->cg_subsys->su_mutex;
  struct sys_t_policy_node *pn = to_pdrv_policy_node(item);
...
static ssize_t sys_t_policy_ts_interval_store(struct config_item *item,
    const char *page,
    size_t count) {
  struct mutex *mutexp = &item->ci_group->cg_subsys->su_mutex;
  struct sys_t_policy_node *pn = to_pdrv_policy_node(item);
...
static ssize_t sys_t_policy_clocksync_interval_store(struct config_item *item,
...
static ssize_t sys_t_clock_sync(struct stm_data *data, unsigned int m,
    unsigned int c) {
