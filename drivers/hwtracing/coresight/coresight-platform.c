...
static struct device *coresight_find_device_by_fwnode(
...
static inline struct device_node *of_coresight_get_output_ports_node(
...
#else
static inline int of_get_coresight_platform_data(struct device *dev,
    struct coresight_platform_data *pdata) {
  return -ENOENT;
}
...
static const union acpi_object *acpi_get_dsd_graph(struct acpi_device *adev,
...
static inline bool acpi_validate_coresight_graph(
    const union acpi_object *cs_graph) {
  int nlinks;
 ...
 * returns NULL.
 */
static const union acpi_object *acpi_get_coresight_graph(
    struct acpi_device *adev, struct acpi_buffer *buf) {
...
static int acpi_get_coresight_platform_data(struct device *dev,
    struct coresight_platform_data *pdata) {
  struct acpi_device *adev;
...
static inline int acpi_get_coresight_platform_data(struct device *dev,
    struct coresight_platform_data *pdata) {
  return -ENOENT;
}
