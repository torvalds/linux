...
static struct coresight_connection *coresight_find_out_connection(
 ...
 */
static struct coresight_device *coresight_select_best_sink(
    struct coresight_device *sink, int *depth,
 ...
 */
static struct coresight_device *coresight_find_sink(
    struct coresight_device *csdev, int *depth) {
