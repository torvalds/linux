...
static int etm4_set_mode_exclude(struct etmv4_drvdata *drvdata, bool exclude) {
   ...
   */
  if (FIELD_GET(TRCACATRn_TYPE_MASK,
      config->addr_acc[idx]) == TRCACATRn_TYPE_ADDR) {
    if (idx % 2 != 0) {
      return -EINVAL;
    }
    /*
...
static ssize_t event_instren_store(struct device *dev,
  ...
  switch (drvdata->nr_event) {
    ...
    case 0x1:
      ...
      config->eventctrl1 |= val
          & (TRCEVENTCTL1R_INSTEN_0 | TRCEVENTCTL1R_INSTEN_1);
      break;
    case 0x2:
...
static inline bool etm4x_register_implemented(struct etmv4_drvdata *drvdata,
    u32 offset) {
  switch (offset) {
 ...
 * systems.
 */
static umode_t coresight_etm4x_attr_reg_implemented(struct kobject *kobj,
