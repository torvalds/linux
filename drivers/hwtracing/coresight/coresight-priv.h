...
struct coresight_device *coresight_find_default_sink(
...
#else
static inline int etm_readl_cp14(u32 off, unsigned int *val) {
  return 0;
}

static inline int etm_writel_cp14(u32 off, u32 val) {
  return 0;
}
...
struct coresight_device *coresight_find_csdev_by_fwnode(
