 ...
 *
 * Contains lists of the loaded configurations and features, plus a list of
 * CoreSight devices
 ...
 *
 * @dev:    The device.
 * @csdev_desc_list:  List of coresight devices registered with the
 * configuration manager.
 * @feat_desc_list: List of feature descriptors to load into registered devices.
 * @config_desc_list: List of system configuration descriptors to load into
 * registered devices.
 * @load_order_list:    Ordered list of owners for dynamically loaded
 * configurations.
 * @sys_active_cnt: Total number of active config descriptor references.
 * @cfgfs_subsys: configfs subsystem used to manage configurations.
 * @sysfs_active_config:Active config hash used if CoreSight controlled from
 * sysfs.
 * @sysfs_active_preset:Active preset index used if CoreSight controlled from
 * sysfs.
...
int cscfg_config_sysfs_activate(struct cscfg_config_desc *cfg_desc,
    bool activate);
