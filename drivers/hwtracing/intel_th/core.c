...
static struct intel_th_device *intel_th_device_alloc(struct intel_th *th,
    unsigned int type,
    const char *name,
    int id) {
...
static struct intel_th_device *intel_th_subdevice_alloc(struct intel_th *th,
 ...
 * @irq:  irq number
 */
struct intel_th *intel_th_alloc(struct device *dev,
