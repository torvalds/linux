 ...
 */
static inline struct resource *intel_th_device_get_resource(
    struct intel_th_device *thdev, unsigned int type,
    unsigned int num) {
  int i;
 ...
 */
static inline bool intel_th_output_assigned(struct intel_th_device *thdev) {
 ...
 */
static inline struct intel_th_device *to_intel_th_parent(
    const struct intel_th_device *thdev) {
...
static inline struct intel_th_device *to_intel_th_hub(
