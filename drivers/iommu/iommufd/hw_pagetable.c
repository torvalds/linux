...
static int iommufd_hwpt_paging_enforce_cc(
    struct iommufd_hwpt_paging *hwpt_paging) {
 ...
 * the returned hwpt.
 */
struct iommufd_hwpt_paging *iommufd_hwpt_paging_alloc(struct iommufd_ctx *ictx,
 ...
 * being a parent.
 */
static struct iommufd_hwpt_nested *iommufd_hwpt_nested_alloc(
