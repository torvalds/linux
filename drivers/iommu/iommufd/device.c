 ...
 */
bool iommufd_ctx_has_group(struct iommufd_ctx *ictx,
    struct iommu_group *group) {
...
struct iommufd_hw_pagetable *iommufd_hw_pagetable_detach(
    struct iommufd_device *idev) {
...
static struct iommufd_hw_pagetable *iommufd_device_do_attach(
    struct iommufd_device *idev,
...
static struct iommufd_hw_pagetable *iommufd_device_do_replace(
    struct iommufd_device *idev,
    struct iommufd_hw_pagetable *hwpt) {
...
static int iommufd_access_change_ioas_id(struct iommufd_access *access,
    u32 id) {
