...
static struct iommu_domain *__mock_domain_alloc_nested(
...
static inline struct iommufd_hw_pagetable *__get_md_pagetable(
    struct iommufd_ucmd *ucmd, u32 mockpt_id, u32 hwpt_type) {
  struct iommufd_object *obj;
...
static inline struct iommufd_hw_pagetable *get_md_pagetable(
    struct iommufd_ucmd *ucmd, u32 mockpt_id,
    struct mock_iommu_domain **mock) {
...
static inline struct iommufd_hw_pagetable *get_md_pagetable_nested(
    struct iommufd_ucmd *ucmd, u32 mockpt_id,
    struct mock_iommu_domain_nested **mock_nested) {
  struct iommufd_hw_pagetable *hwpt;
