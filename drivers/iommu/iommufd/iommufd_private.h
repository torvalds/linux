 ...
 */
static inline void iommufd_object_put_and_try_destroy(struct iommufd_ctx *ictx,
    struct iommufd_object *obj) {
...
static inline struct iommufd_hwpt_paging *to_hwpt_paging(
    struct iommufd_hw_pagetable *hwpt) {
  return container_of(hwpt, struct iommufd_hwpt_paging, common);
}

static inline struct iommufd_hwpt_paging *iommufd_get_hwpt_paging(
...
static inline struct iommufd_hw_pagetable *iommufd_get_hwpt_nested(
    struct iommufd_ucmd *ucmd, u32 id) {
  return container_of(iommufd_get_object(ucmd->ictx, id,
      IOMMUFD_OBJ_HWPT_NESTED),
...
static inline struct iommufd_device *iommufd_get_device(
    struct iommufd_ucmd *ucmd, u32 id) {
  return container_of(iommufd_get_object(ucmd->ictx, id,
      IOMMUFD_OBJ_DEVICE),
