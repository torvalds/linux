...
static void decr_user_locked_vm(struct iopt_pages *pages,
    unsigned long npages) {
...
static void iopt_area_unpin_domain(struct pfn_batch *batch,
    struct iopt_area *area,
...
static struct iopt_pages_access *iopt_pages_get_exact_access(
