...
static void apple_dart_hw_enable_translation(
...
static void apple_dart_hw_enable_bypass(
    struct apple_dart_stream_map *stream_map) {
  struct apple_dart *dart = stream_map->dart;
  int sid;
...
static void apple_dart_hw_clear_all_ttbrs(
    struct apple_dart_stream_map *stream_map) {
  int i;
...
static int apple_dart_t8020_hw_stream_command(
    struct apple_dart_stream_map *stream_map,
    u32 command) {
  unsigned long flags;
  int ret, i;
...
static int apple_dart_t8110_hw_tlb_command(
    struct apple_dart_stream_map *stream_map,
    u32 command) {
  struct apple_dart *dart = stream_map->dart;
  unsigned long flags;
...
static int apple_dart_t8020_hw_invalidate_tlb(
    struct apple_dart_stream_map *stream_map) {
  return apple_dart_t8020_hw_stream_command(
      stream_map, DART_T8020_STREAM_COMMAND_INVALIDATE);
}

static int apple_dart_t8110_hw_invalidate_tlb(
    struct apple_dart_stream_map *stream_map) {
...
static void apple_dart_setup_translation(struct apple_dart_domain *domain,
    struct apple_dart_stream_map *stream_map) {
  int i;
...
static int apple_dart_mod_streams(
    struct apple_dart_atomic_stream_map *domain_maps,
...
static int apple_dart_probe(struct platform_device *pdev) {
  ...
  switch (dart->hw->type) {
    ...
    case DART_T8110:
      ...
      dart->num_streams
        = FIELD_GET(DART_T8110_PARAMS4_NUM_SIDS, dart_params[3]);
      break;
  }
