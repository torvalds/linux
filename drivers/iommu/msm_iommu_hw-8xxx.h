 ...
 * CBACR_N*/
#define SET_RWVMID(b, n, v)   SET_GLOBAL_FIELD(b, (n << 2) | (CBACR_N), RWVMID, \
    v)
#define SET_RWE(b, n, v)      SET_GLOBAL_FIELD(b, (n << 2) | (CBACR_N), RWE, v)
#define SET_RWGE(b, n, v)     SET_GLOBAL_FIELD(b, (n << 2) | (CBACR_N), RWGE, v)
#define SET_CBVMID(b, n, v)   SET_GLOBAL_FIELD(b, (n << 2) | (CBACR_N), CBVMID, \
    v)
#define SET_IRPTNDX(b, n, v)  SET_GLOBAL_FIELD(b, (n << 2) | (CBACR_N), IRPTNDX, \
    v)

/* M2VCBR_N */
#define SET_VMID(b, n, v)     SET_GLOBAL_FIELD(b, (n << 2) | (M2VCBR_N), VMID, \
    v)
#define SET_CBNDX(b, n, v)    SET_GLOBAL_FIELD(b, (n << 2) | (M2VCBR_N), CBNDX, \
    v)
#define SET_BYPASSD(b, n, v)  SET_GLOBAL_FIELD(b, (n << 2) | (M2VCBR_N), \
    BYPASSD, v)
#define SET_BPRCOSH(b, n, v)  SET_GLOBAL_FIELD(b, (n << 2) | (M2VCBR_N), \
    BPRCOSH, v)
#define SET_BPRCISH(b, n, v)  SET_GLOBAL_FIELD(b, (n << 2) | (M2VCBR_N), \
    BPRCISH, v)
#define SET_BPRCNSH(b, n, v)  SET_GLOBAL_FIELD(b, (n << 2) | (M2VCBR_N), \
    BPRCNSH, v)
#define SET_BPSHCFG(b, n, v)  SET_GLOBAL_FIELD(b, (n << 2) | (M2VCBR_N), \
    BPSHCFG, v)
#define SET_NSCFG(b, n, v)    SET_GLOBAL_FIELD(b, (n << 2) | (M2VCBR_N), NSCFG, \
    v)
#define SET_BPMTCFG(b, n, v)  SET_GLOBAL_FIELD(b, (n << 2) | (M2VCBR_N), \
    BPMTCFG, v)
...
#define GET_BPMEMTYPE(b, n)  GET_GLOBAL_FIELD(b, (n << 2) | (M2VCBR_N), \
    BPMEMTYPE)
