...
static enum iommu_resv_type __maybe_unused iommu_resv_region_get_type(
    struct device *dev,
...
void of_iommu_get_resv_regions(struct device *dev, struct list_head *list) {
  ...
  of_for_each_phandle(&it, err, dev->of_node, "memory-region", NULL, 0) {
    ...
    /*
     * The "reg" property is optional and can be omitted by reserved-memory
     *regions
     * that represent reservations in the IOVA space, which are regions that
     *should
     * not be mapped.
     */
