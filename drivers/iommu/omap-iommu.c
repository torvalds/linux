...
static int iopgd_alloc_section(struct omap_iommu *obj, u32 da, u32 pa,
    u32 prot) {
...
static int iopgtable_store_entry_core(struct omap_iommu *obj,
    struct iotlb_entry *e) {
 ...
 * @e:    an iommu tlb entry info
 **/
static int omap_iopgtable_store_entry(struct omap_iommu *obj,
    struct iotlb_entry *e) {
  int err;
 ...
 **/
static void iopgtable_lookup_entry(struct omap_iommu *obj, u32 da, u32 **ppgd,
    u32 **ppte) {
