...
static struct arm_lpae_io_pgtable *arm_lpae_alloc_pgtable(
    struct io_pgtable_cfg *cfg) {
  struct arm_lpae_io_pgtable *data;
...
static struct io_pgtable *arm_32_lpae_alloc_pgtable_s1(
    struct io_pgtable_cfg *cfg, void *cookie) {
...
static struct io_pgtable *arm_mali_lpae_alloc_pgtable(
    struct io_pgtable_cfg *cfg, void *cookie) {
  struct arm_lpae_io_pgtable *data;
...
static void __init arm_lpae_dump_ops(struct io_pgtable_ops *ops) {
  ...
  pr_err(
      "data: %d levels, 0x%zx pgd_size, %u pg_shift, %u bits_per_level, pgd @ %p\n",
