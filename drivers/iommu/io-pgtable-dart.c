...
static dart_iopte *dart_get_l2(struct dart_io_pgtable *data,
    unsigned long iova) {
  dart_iopte pte, *ptep;
...
static struct dart_io_pgtable *dart_alloc_pgtable(struct io_pgtable_cfg *cfg) {
  struct dart_io_pgtable *data;
...
static struct io_pgtable *apple_dart_alloc_pgtable(struct io_pgtable_cfg *cfg,
    void *cookie) {
  struct dart_io_pgtable *data;
  int i;
