...
static void fq_ring_free_locked(struct iommu_dma_cookie *cookie,
    struct iova_fq *fq) {
...
static int iommu_dma_init_domain(struct iommu_domain *domain, dma_addr_t base,
  ...
  if (domain->type == IOMMU_DOMAIN_DMA_FQ
      && (!device_iommu_capable(dev,
          IOMMU_CAP_DEFERRED_FLUSH) || iommu_dma_init_fq(domain))) {
...
static void iommu_dma_unmap_sg_swiotlb(struct device *dev,
    struct scatterlist *sg,
