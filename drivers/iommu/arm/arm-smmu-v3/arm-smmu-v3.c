...
static void arm_smmu_page_response(struct device *dev,
...
static struct arm_smmu_master *arm_smmu_find_master(
...
static struct arm_smmu_ste *arm_smmu_get_step_for_sid(
    struct arm_smmu_device *smmu, u32 sid) {
  struct arm_smmu_strtab_cfg *cfg = &smmu->strtab_cfg;
...
static void arm_smmu_setup_msis(struct arm_smmu_device *smmu) {
  ...
  ret = platform_device_msi_init_and_alloc_irqs(dev, nvec,
