...
static inline struct pasid_entry *get_pasid_table_from_pde(
 ...
 * of a scalable mode PASID entry.
 */
static inline void pasid_set_translation_type(struct pasid_entry *pe,
    u64 value) {
 ...
 * PASID entry.
 */
static inline void pasid_set_pgsnp(struct pasid_entry *pe) {
