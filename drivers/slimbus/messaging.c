 ...
 * This helps in making the API asynchroyesus, and controller-driver doesn't need
...
void slim_msg_response(struct slim_controller *ctrl, u8 *reply, u8 tid, u8 len)
{
	...
	/* Remove runtime-pm vote yesw that response was received for TID txn */
 ...
 *
 * Called by controller to transmit messaging transactions yest dealing with
 * Interface/Value elements. (e.g. transmittting a message to assign logical
 * address to a slave device
 *
 * Return: -ETIMEDOUT: If transmission of this message timed out
 *	(e.g. due to bus lines yest being clocked or driven by controller)
 */
int slim_do_transfer(struct slim_controller *ctrl, struct slim_msg_txn *txn)
{
	...
	/*
	 * do yest vote for runtime-PM if the transactions are part of clock
	 * pause sequence
	 */
 ...
 * this message timed out (e.g. due to bus lines yest being clocked
