 ...
 * @minor_offset: address gap between 2 consecutive minor blocks of particular
 * type,
 *                e.g., offset between NIC0_UMR0_0 and NIC0_UMR1_0 is 0x20000.
 * @sub_minor_offset: address gap between 2 consecutive sub_minor blocks of
 * particular
 *                    type, e.g., offset between NIC0_UMR0_0 and NIC0_UMR0_1 is
 * 0x1000.
 *
 ...
 * NIC11_UMR1_14.
 *
 * Struct's formatted data is located in the SOL-based auto-generated protbits
 * headers.
 */
 ...
 *            This bit is meaningful if same bit in data_map is 0, otherwise
 * ignored.
 ...
 * @skip_block_hook: hook that will be called before initializing special
 * blocks.
 */
