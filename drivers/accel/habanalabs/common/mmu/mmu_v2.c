...
static int hl_mmu_v2_unmap(struct hl_ctx *ctx, u64 virt_addr,
    bool is_dram_addr) {
  u64 hop_addr[MMU_ARCH_6_HOPS] = {
    0
  }, hop_pte_addr[MMU_ARCH_6_HOPS] = {
    0
  }, curr_pte,
      scrambled_virt_addr;
...
static int hl_mmu_v2_get_tlb_info(struct hl_ctx *ctx, u64 virt_addr,
  ...
  hops->hop_info[0].hop_pte_addr = hl_mmu_get_hop_pte_phys_addr(ctx, mmu_prop,
      0,
