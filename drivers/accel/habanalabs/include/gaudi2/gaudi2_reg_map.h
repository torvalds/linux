...
/*
 *  Single scratchpad register used for all ARCs to notify dccm queue full event
 * to FW.
 *  So a new event would overwrite any unhandled previous event. In other words,
 * incase
 *  of multiple events before previous ones are handled, last one would be
 * considered.
 */
