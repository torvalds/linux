...
#define TPC_CFG_STALL_OFFSET    (mmDCORE0_TPC0_CFG_TPC_STALL \
  - mmDCORE0_TPC0_CFG_BASE)
#define TPC_CFG_STALL_ON_ERR_OFFSET (mmDCORE0_TPC0_CFG_STALL_ON_ERR \
  - mmDCORE0_TPC0_CFG_BASE)
#define TPC_CFG_TPC_INTR_MASK_OFFSET  (mmDCORE0_TPC0_CFG_TPC_INTR_MASK \
  - mmDCORE0_TPC0_CFG_BASE)
#define TPC_CFG_MSS_CONFIG_OFFSET (mmDCORE0_TPC0_CFG_MSS_CONFIG \
  - mmDCORE0_TPC0_CFG_BASE)
#define TPC_EML_CFG_DBG_CNT_OFFSET  (mmDCORE0_TPC0_EML_CFG_DBG_CNT \
  - mmDCORE0_TPC0_EML_CFG_BASE)

#define EDMA_CORE_CFG_STALL_OFFSET  (mmDCORE0_EDMA0_CORE_CFG_1 \
  - mmDCORE0_EDMA0_CORE_BASE)
#define MME_CTRL_LO_QM_STALL_OFFSET (mmDCORE0_MME_CTRL_LO_QM_STALL \
  - mmDCORE0_MME_CTRL_LO_BASE)
#define MME_ACC_INTR_MASK_OFFSET  (mmDCORE0_MME_ACC_INTR_MASK \
  - mmDCORE0_MME_ACC_BASE)
#define MME_ACC_WR_AXI_AGG_COUT0_OFFSET (mmDCORE0_MME_ACC_WR_AXI_AGG_COUT0 \
  - mmDCORE0_MME_ACC_BASE)
#define MME_ACC_WR_AXI_AGG_COUT1_OFFSET (mmDCORE0_MME_ACC_WR_AXI_AGG_COUT1 \
  - mmDCORE0_MME_ACC_BASE)
#define MME_ACC_AP_LFSR_POLY_OFFSET (mmDCORE0_MME_ACC_AP_LFSR_POLY \
  - mmDCORE0_MME_ACC_BASE)
#define MME_ACC_AP_LFSR_SEED_SEL_OFFSET (mmDCORE0_MME_ACC_AP_LFSR_SEED_SEL \
  - mmDCORE0_MME_ACC_BASE)
...
#define DMA_CORE_ERRMSG_ADDR_LO_OFFSET  (mmARC_FARM_KDMA_ERRMSG_ADDR_LO \
  - mmARC_FARM_KDMA_BASE)
#define DMA_CORE_ERRMSG_ADDR_HI_OFFSET  (mmARC_FARM_KDMA_ERRMSG_ADDR_HI \
  - mmARC_FARM_KDMA_BASE)
#define DMA_CORE_ERRMSG_WDATA_OFFSET  (mmARC_FARM_KDMA_ERRMSG_WDATA \
  - mmARC_FARM_KDMA_BASE)
...
#define QM_CP_MSG_BASE0_ADDR_LO_0_OFFSET (mmPDMA0_QM_CP_MSG_BASE0_ADDR_LO_0 \
  - mmPDMA0_QM_BASE)
#define QM_CP_MSG_BASE0_ADDR_HI_0_OFFSET (mmPDMA0_QM_CP_MSG_BASE0_ADDR_HI_0 \
  - mmPDMA0_QM_BASE)
#define QM_CP_MSG_BASE1_ADDR_LO_0_OFFSET (mmPDMA0_QM_CP_MSG_BASE1_ADDR_LO_0 \
  - mmPDMA0_QM_BASE)
#define QM_CP_MSG_BASE1_ADDR_HI_0_OFFSET (mmPDMA0_QM_CP_MSG_BASE1_ADDR_HI_0 \
  - mmPDMA0_QM_BASE)

#define QM_CP_CFG_OFFSET    (mmPDMA0_QM_CP_CFG - mmPDMA0_QM_BASE)
#define QM_PQC_HBW_BASE_LO_0_OFFSET (mmPDMA0_QM_PQC_HBW_BASE_LO_0 \
  - mmPDMA0_QM_BASE)
#define QM_PQC_HBW_BASE_HI_0_OFFSET (mmPDMA0_QM_PQC_HBW_BASE_HI_0 \
  - mmPDMA0_QM_BASE)
...
#define QM_PQC_LBW_BASE_LO_0_OFFSET (mmPDMA0_QM_PQC_LBW_BASE_LO_0 \
  - mmPDMA0_QM_BASE)
#define QM_PQC_LBW_BASE_HI_0_OFFSET (mmPDMA0_QM_PQC_LBW_BASE_HI_0 \
  - mmPDMA0_QM_BASE)
#define QM_GLBL_ERR_ADDR_LO_OFFSET  (mmPDMA0_QM_GLBL_ERR_ADDR_LO \
  - mmPDMA0_QM_BASE)
...
#define QM_GLBL_ERR_ADDR_HI_OFFSET  (mmPDMA0_QM_GLBL_ERR_ADDR_HI \
  - mmPDMA0_QM_BASE)
...
#define QM_ARB_SLV_CHOISE_WDT_OFFSET  (mmPDMA0_QM_ARB_SLV_CHOICE_WDT \
  - mmPDMA0_QM_BASE)
...
#define QM_ARC_CQ_TSIZE_STS_OFFSET  (mmPDMA0_QM_ARC_CQ_TSIZE_STS \
  - mmPDMA0_QM_BASE)
#define QM_ARC_CQ_PTR_LO_STS_OFFSET (mmPDMA0_QM_ARC_CQ_PTR_LO_STS \
  - mmPDMA0_QM_BASE)
#define QM_ARC_CQ_PTR_HI_STS_OFFSET (mmPDMA0_QM_ARC_CQ_PTR_HI_STS \
  - mmPDMA0_QM_BASE)
...
#define SFT_OFFSET    (mmSFT1_HBW_RTR_IF0_RTR_H3_BASE \
  - mmSFT0_HBW_RTR_IF0_RTR_H3_BASE)
#define SFT_IF_RTR_OFFSET (mmSFT0_HBW_RTR_IF1_RTR_H3_BASE \
  - mmSFT0_HBW_RTR_IF0_RTR_H3_BASE)

#define ARC_HALT_REQ_OFFSET (mmARC_FARM_ARC0_AUX_RUN_HALT_REQ \
  - mmARC_FARM_ARC0_AUX_BASE)
#define ARC_HALT_ACK_OFFSET (mmARC_FARM_ARC0_AUX_RUN_HALT_ACK \
  - mmARC_FARM_ARC0_AUX_BASE)

#define ARC_REGION_CFG_OFFSET(region) \
  (mmARC_FARM_ARC0_AUX_ARC_REGION_CFG_0 + (region * 4) \
  - mmARC_FARM_ARC0_AUX_BASE)
...
#define DCORE_MME_SBTE_OFFSET \
  (mmDCORE0_MME_SBTE1_MSTR_IF_RR_SHRD_HBW_BASE \
...
#define DCORE_RTR_OFFSET  \
  (mmDCORE0_RTR1_MSTR_IF_RR_SHRD_HBW_BASE \
  - mmDCORE0_RTR0_MSTR_IF_RR_SHRD_HBW_BASE)

#define DCORE_VDEC_OFFSET \
  (mmDCORE0_VDEC1_MSTR_IF_RR_SHRD_HBW_BASE \
...
#define MMU_DDR_RANGE_REG_ENABLE  MMU_OFFSET( \
    mmDCORE0_HMMU0_MMU_DDR_RANGE_REG_ENABLE)
#define MMU_RR_SEC_MIN_63_32_0_OFFSET MMU_OFFSET( \
    mmDCORE0_HMMU0_MMU_MMU_RR_SEC_MIN_63_32_0)
#define MMU_RR_SEC_MIN_31_0_0_OFFSET  MMU_OFFSET( \
    mmDCORE0_HMMU0_MMU_MMU_RR_SEC_MIN_31_0_0)
#define MMU_RR_SEC_MAX_63_32_0_OFFSET MMU_OFFSET( \
    mmDCORE0_HMMU0_MMU_MMU_RR_SEC_MAX_63_32_0)
#define MMU_RR_SEC_MAX_31_0_0_OFFSET  MMU_OFFSET( \
    mmDCORE0_HMMU0_MMU_MMU_RR_SEC_MAX_31_0_0)
#define MMU_RR_PRIV_MIN_63_32_0_OFFSET  MMU_OFFSET( \
    mmDCORE0_HMMU0_MMU_MMU_RR_PRIV_MIN_63_32_0)
#define MMU_RR_PRIV_MIN_31_0_0_OFFSET MMU_OFFSET( \
    mmDCORE0_HMMU0_MMU_MMU_RR_PRIV_MIN_31_0_0)
#define MMU_RR_PRIV_MAX_63_32_0_OFFSET  MMU_OFFSET( \
    mmDCORE0_HMMU0_MMU_MMU_RR_PRIV_MAX_63_32_0)
#define MMU_RR_PRIV_MAX_31_0_0_OFFSET MMU_OFFSET( \
    mmDCORE0_HMMU0_MMU_MMU_RR_PRIV_MAX_31_0_0)
...
#define STLB_HOP_CONFIGURATION_OFFSET STLB_OFFSET( \
    mmDCORE0_HMMU0_STLB_HOP_CONFIGURATION)
...
#define STLB_SET_THRESHOLD_HOP3_OFFSET  STLB_OFFSET( \
    mmDCORE0_HMMU0_STLB_SET_THRESHOLD_HOP3)
#define STLB_SET_THRESHOLD_HOP2_OFFSET  STLB_OFFSET( \
    mmDCORE0_HMMU0_STLB_SET_THRESHOLD_HOP2)
#define STLB_SET_THRESHOLD_HOP1_OFFSET  STLB_OFFSET( \
    mmDCORE0_HMMU0_STLB_SET_THRESHOLD_HOP1)
#define STLB_SET_THRESHOLD_HOP0_OFFSET  STLB_OFFSET( \
    mmDCORE0_HMMU0_STLB_SET_THRESHOLD_HOP0)
#define STLB_RANGE_INV_START_LSB_OFFSET STLB_OFFSET( \
    mmDCORE0_HMMU0_STLB_RANGE_INV_START_LSB)
#define STLB_RANGE_INV_START_MSB_OFFSET STLB_OFFSET( \
    mmDCORE0_HMMU0_STLB_RANGE_INV_START_MSB)
#define STLB_RANGE_INV_END_LSB_OFFSET STLB_OFFSET( \
    mmDCORE0_HMMU0_STLB_RANGE_INV_END_LSB)
#define STLB_RANGE_INV_END_MSB_OFFSET STLB_OFFSET( \
    mmDCORE0_HMMU0_STLB_RANGE_INV_END_MSB)
...
#define RTR_MSTR_IF_OFFSET  (mmDCORE0_RTR0_MSTR_IF_RR_SHRD_HBW_BASE \
...
#define RR_SHRD_HBW_AW_RAZWI_HI   \
  (mmDCORE0_RTR0_MSTR_IF_RR_SHRD_HBW_AW_RAZWI_HI \
  - mmDCORE0_RTR0_MSTR_IF_RR_SHRD_HBW_BASE)

/* RAZWI captured shared hbw aw addr low */
#define RR_SHRD_HBW_AW_RAZWI_LO   \
  (mmDCORE0_RTR0_MSTR_IF_RR_SHRD_HBW_AW_RAZWI_LO \
  - mmDCORE0_RTR0_MSTR_IF_RR_SHRD_HBW_BASE)
...
#define BRDG_CTRL_BLOCK_OFFSET (mmDCORE0_VDEC0_BRDG_CTRL_BASE \
  - mmDCORE0_DEC0_CMD_BASE)
#define SPECIAL_BLOCK_OFFSET (mmDCORE0_VDEC0_BRDG_CTRL_SPECIAL_BASE \
  - mmDCORE0_DEC0_CMD_BASE)
#define SFT_DCORE_OFFSET (mmSFT1_HBW_RTR_IF0_RTR_CTRL_BASE \
  - mmSFT0_HBW_RTR_IF0_RTR_CTRL_BASE)
#define SFT_IF_OFFSET (mmSFT0_HBW_RTR_IF1_RTR_CTRL_BASE \
  - mmSFT0_HBW_RTR_IF0_RTR_CTRL_BASE)
...
#define BRDG_CTRL_ABNRM_MSIX_LBW_AWADDR \
  (mmDCORE0_VDEC0_BRDG_CTRL_ABNRM_MSIX_LBW_AWADDR \
...
#define NIC_OFFSET    (mmNIC1_MSTR_IF_RR_SHRD_HBW_BASE \
  - mmNIC0_MSTR_IF_RR_SHRD_HBW_BASE)

#define NIC_UMR_OFFSET \
  (mmNIC0_UMR0_1_UNSECURE_DOORBELL0_BASE \
