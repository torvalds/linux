...
#define SPECIAL_GLBL_ERR_CAUSE_APB_PRIV_RD \
  PDMA0_CORE_SPECIAL_GLBL_ERR_CAUSE_APB_PRIV_RD_MASK
#define SPECIAL_GLBL_ERR_CAUSE_APB_SEC_RD \
  PDMA0_CORE_SPECIAL_GLBL_ERR_CAUSE_APB_SEC_RD_MASK
#define SPECIAL_GLBL_ERR_CAUSE_APB_PRIV_WR \
  PDMA0_CORE_SPECIAL_GLBL_ERR_CAUSE_APB_PRIV_WR_MASK
#define SPECIAL_GLBL_ERR_CAUSE_APB_SEC_WR \
  PDMA0_CORE_SPECIAL_GLBL_ERR_CAUSE_APB_SEC_WR_MASK
...
static const struct range gaudi2_pb_pdma0_arc_unsecured_regs[] = {
  ...
  {mmPDMA0_QM_ARC_AUX_CBU_EARLY_BRESP_EN,
   mmPDMA0_QM_ARC_AUX_CBU_EARLY_BRESP_EN},
  {mmPDMA0_QM_ARC_AUX_LBU_EARLY_BRESP_EN,
   mmPDMA0_QM_ARC_AUX_LBU_EARLY_BRESP_EN},
  {mmPDMA0_QM_ARC_AUX_DCCM_QUEUE_BASE_ADDR_0,
   mmPDMA0_QM_ARC_AUX_DCCM_QUEUE_ALERT_MSG},
  {mmPDMA0_QM_ARC_AUX_DCCM_Q_PUSH_FIFO_CNT,
   mmPDMA0_QM_ARC_AUX_QMAN_ARC_CQ_SHADOW_CI},
  {mmPDMA0_QM_ARC_AUX_ARC_AXI_ORDERING_WR_IF_CNT,
...
static const struct range gaudi2_pb_dcr0_edma0_arc_unsecured_regs[] = {
  {mmDCORE0_EDMA0_QM_ARC_AUX_RUN_HALT_REQ,
   mmDCORE0_EDMA0_QM_ARC_AUX_RUN_HALT_ACK},
  {mmDCORE0_EDMA0_QM_ARC_AUX_CLUSTER_NUM,
   mmDCORE0_EDMA0_QM_ARC_AUX_WAKE_UP_EVENT},
  {mmDCORE0_EDMA0_QM_ARC_AUX_ARC_RST_REQ,
   mmDCORE0_EDMA0_QM_ARC_AUX_CID_OFFSET_7},
  {mmDCORE0_EDMA0_QM_ARC_AUX_SCRATCHPAD_0,
   mmDCORE0_EDMA0_QM_ARC_AUX_INFLIGHT_LBU_RD_CNT},
...
static const struct range gaudi2_pb_dcr0_tpc0_arc_unsecured_regs[] = {
  {mmDCORE0_TPC0_QM_ARC_AUX_RUN_HALT_REQ,
   mmDCORE0_TPC0_QM_ARC_AUX_RUN_HALT_ACK},
  {mmDCORE0_TPC0_QM_ARC_AUX_CLUSTER_NUM,
   mmDCORE0_TPC0_QM_ARC_AUX_WAKE_UP_EVENT},
  {mmDCORE0_TPC0_QM_ARC_AUX_ARC_RST_REQ, mmDCORE0_TPC0_QM_ARC_AUX_CID_OFFSET_7},
  {mmDCORE0_TPC0_QM_ARC_AUX_SCRATCHPAD_0,
   mmDCORE0_TPC0_QM_ARC_AUX_INFLIGHT_LBU_RD_CNT},
  {mmDCORE0_TPC0_QM_ARC_AUX_CBU_EARLY_BRESP_EN,
   mmDCORE0_TPC0_QM_ARC_AUX_CBU_EARLY_BRESP_EN},
  {mmDCORE0_TPC0_QM_ARC_AUX_LBU_EARLY_BRESP_EN,
   mmDCORE0_TPC0_QM_ARC_AUX_LBU_EARLY_BRESP_EN},
...
static const struct range gaudi2_pb_dcr0_sm_glbl_unsecured_regs[] = {
  {mmDCORE0_SYNC_MNGR_GLBL_CQ_BASE_ADDR_L_1,
   mmDCORE0_SYNC_MNGR_GLBL_CQ_BASE_ADDR_L_63},
  {mmDCORE0_SYNC_MNGR_GLBL_CQ_BASE_ADDR_H_1,
   mmDCORE0_SYNC_MNGR_GLBL_CQ_BASE_ADDR_H_63},
  {mmDCORE0_SYNC_MNGR_GLBL_CQ_SIZE_LOG2_1,
   mmDCORE0_SYNC_MNGR_GLBL_CQ_SIZE_LOG2_63},
  ...
  {mmDCORE0_SYNC_MNGR_GLBL_CQ_INC_MODE_1,
   mmDCORE0_SYNC_MNGR_GLBL_CQ_INC_MODE_63},
};

static const struct range gaudi2_pb_dcr_x_sm_glbl_unsecured_regs[] = {
  {mmDCORE1_SYNC_MNGR_GLBL_CQ_BASE_ADDR_L_0,
   mmDCORE1_SYNC_MNGR_GLBL_CQ_BASE_ADDR_L_63},
  {mmDCORE1_SYNC_MNGR_GLBL_CQ_BASE_ADDR_H_0,
   mmDCORE1_SYNC_MNGR_GLBL_CQ_BASE_ADDR_H_63},
  {mmDCORE1_SYNC_MNGR_GLBL_CQ_SIZE_LOG2_0,
   mmDCORE1_SYNC_MNGR_GLBL_CQ_SIZE_LOG2_63},
  ...
  {mmDCORE1_SYNC_MNGR_GLBL_CQ_INC_MODE_0,
   mmDCORE1_SYNC_MNGR_GLBL_CQ_INC_MODE_63},
};
...
static const struct range gaudi2_pb_arc_sched_unsecured_regs[] = {
  ...
  {mmARC_FARM_ARC0_AUX_CBU_EARLY_BRESP_EN,
   mmARC_FARM_ARC0_AUX_CBU_EARLY_BRESP_EN},
  {mmARC_FARM_ARC0_AUX_LBU_EARLY_BRESP_EN,
   mmARC_FARM_ARC0_AUX_LBU_EARLY_BRESP_EN},
  {mmARC_FARM_ARC0_AUX_DCCM_QUEUE_BASE_ADDR_0,
   mmARC_FARM_ARC0_AUX_DCCM_QUEUE_ALERT_MSG},
  {mmARC_FARM_ARC0_AUX_DCCM_Q_PUSH_FIFO_CNT,
   mmARC_FARM_ARC0_AUX_QMAN_ARC_CQ_SHADOW_CI},
  {mmARC_FARM_ARC0_AUX_ARC_AXI_ORDERING_WR_IF_CNT,
  ...
  {mmARC_FARM_ARC0_DUP_ENG_AXUSER_HB_STRONG_ORDER,
   mmARC_FARM_ARC0_DUP_ENG_AXUSER_LB_OVRD},
...
static const struct range gaudi2_pb_nic0_qm_arc_aux0_unsecured_regs[] = {
  ...
  {mmNIC0_QM_ARC_AUX0_CBU_EARLY_BRESP_EN,
   mmNIC0_QM_ARC_AUX0_CBU_EARLY_BRESP_EN},
  {mmNIC0_QM_ARC_AUX0_LBU_EARLY_BRESP_EN,
   mmNIC0_QM_ARC_AUX0_LBU_EARLY_BRESP_EN},
  {mmNIC0_QM_ARC_AUX0_DCCM_QUEUE_BASE_ADDR_0,
   mmNIC0_QM_ARC_AUX0_DCCM_QUEUE_ALERT_MSG},
  {mmNIC0_QM_ARC_AUX0_DCCM_Q_PUSH_FIFO_CNT,
   mmNIC0_QM_ARC_AUX0_QMAN_ARC_CQ_SHADOW_CI},
  {mmNIC0_QM_ARC_AUX0_ARC_AXI_ORDERING_WR_IF_CNT,
...
static const struct range gaudi2_pb_rot0_arc_unsecured_regs[] = {
  ...
  {mmROT0_QM_ARC_AUX_DCCM_QUEUE_BASE_ADDR_0,
   mmROT0_QM_ARC_AUX_DCCM_QUEUE_ALERT_MSG},
  {mmROT0_QM_ARC_AUX_DCCM_Q_PUSH_FIFO_CNT,
   mmROT0_QM_ARC_AUX_QMAN_ARC_CQ_SHADOW_CI},
...
static const struct range gaudi2_pb_mme_qm_arc_acp_eng_unsecured_regs[] = {
  {mmDCORE0_MME_QM_ARC_ACP_ENG_ACP_PI_REG_0,
   mmDCORE0_MME_QM_ARC_ACP_ENG_ACP_DBG_REG},
};
...
static void gaudi2_config_tpcs_glbl_sec(struct hl_device *hdev, int dcore,
    int inst, u32 offset,
...
static int gaudi2_init_pb_tpc(struct hl_device *hdev) {
  ...
  glbl_sec = kcalloc(block_array_size, sizeof(struct hl_block_glbl_sec),
      GFP_KERNEL);
  if (!glbl_sec) {
    return -ENOMEM;
  }
  ...
  qm_tensor_stride = mmDCORE0_TPC0_CFG_QM_TENSOR_1_BASE
...
static void gaudi2_config_tpcs_pb_ranges(struct hl_device *hdev, int dcore,
    int inst, u32 offset,
    struct iterate_module_ctx *ctx) {
...
static void gaudi2_write_lbw_range_register(struct hl_device *hdev, u64 base,
    void *data) {
...
static void gaudi2_init_lbw_range_registers_secure(struct hl_device *hdev) {
   ...
   * - ranges 12,13: PSOC_CFG (excluding PSOC_TIMESTAMP, PSOC_EFUSE and
   * PSOC_GLOBAL_CONF)
   */
   ...
   * - range 2/3: used in soft reset to block access to several blocks and are
   * cleared here
   */
...
static void gaudi2_write_hbw_range_register(struct hl_device *hdev, u64 base,
    void *data) {
  u32 min_lo_reg_offset, min_hi_reg_offset, max_lo_reg_offset,
      max_hi_reg_offset;
  struct rr_config *rr_cfg = (struct rr_config *) data;
  u64 val_min, val_max;
  switch (rr_cfg->type) {
  ...
  /* Configure HBW RR:
   * SHORT RRs (0x1000_<36bits>000) - HI: address bits [47:44], LO: address bits
   *[43:12]
   * LONG  RRs (0x<52bits>000)      - HI: address bits [63:44], LO: address bits
   *[43:12]
   */
...
static void gaudi2_write_hbw_rr_to_all_mstr_if(struct hl_device *hdev,
    u8 rr_type, u32 rr_index,
...
static void gaudi2_init_hbw_range_registers(struct hl_device *hdev) {
   ...
   *
   * - short range 0:
   *  SPI Flash, ARC0/1 ICCM/DCCM, Secure Boot ROM, PSOC_FW/Scratchpad/PCIE_FW
   * SRAM
   */
  ...
  for (i = 0; i < ARRAY_SIZE(hbw_range_min_short); i++) {
    gaudi2_write_hbw_rr_to_all_mstr_if(hdev, RR_TYPE_SHORT, i,
        hbw_range_min_short[i],
...
static void gaudi2_init_mmu_range_registers(struct hl_device *hdev) {
  ...
  rr_cfg.max = hdev->asic_funcs->scramble_addr(hdev,
...
static int gaudi2_init_protection_bits(struct hl_device *hdev) {
  ...
  u8 i;
  /* SFT */
  instance_offset = mmSFT1_HBW_RTR_IF0_RTR_CTRL_BASE
      - mmSFT0_HBW_RTR_IF0_RTR_CTRL_BASE;
  ...
  rc |= hl_init_pb_with_mask(hdev, NUM_OF_DCORES, DCORE_OFFSET,
      ...
      NULL, HL_PB_NA, prop->hmmu_hif_enabled_mask);
  /* CPU.
   * Except for CPU_IF, skip when security is enabled in F/W, because the blocks
   * are protected
   * by privileged RR.
   */
  ...
  /* PSOC.
   * Except for PSOC_GLOBAL_CONF, skip when security is enabled in F/W, because
   * the blocks are
   * protected by privileged RR.
   * For PSOC_GLOBAL_CONF, need to un-secure the scratchpad register which is
   * used for engine
   * cores to raise events towards F/W.
   */
  engine_core_intr_reg
    = (u32) (hdev->asic_prop.engine_core_interrupt_reg_addr - CFG_BASE);
  ...
  rc |= hl_init_pb(hdev, HL_PB_SHARED, HL_PB_NA,
      ...
      NULL, HL_PB_NA);
  /* PLL.
   * Skip PSOC/XFT PLL when security is enabled in F/W, because these blocks are
   * protected by
   * privileged RR.
   */
  rc |= hl_init_pb(hdev, HL_PB_SHARED, HL_PB_NA,
  ...
  /* Thermal Sensor.
   * Skip when security is enabled in F/W, because the blocks are protected by
   * privileged RR.
   */
  if (!hdev->asic_prop.fw_security_enabled) {
...
static void gaudi2_ack_pb_tpc_config(struct hl_device *hdev, int dcore,
    int inst, u32 offset,
    struct iterate_module_ctx *ctx) {
...
void gaudi2_ack_protection_bits_errors(struct hl_device *hdev) {
  ...
  /* NIC */
  hl_ack_pb_with_mask(hdev, NIC_NUMBER_OF_MACROS, NIC_OFFSET,
      HL_PB_SINGLE_INSTANCE, HL_PB_NA,
      gaudi2_pb_nic0, ARRAY_SIZE(gaudi2_pb_nic0), hdev->nic_ports_mask);
  /* NIC QM and QPC */
  hl_ack_pb_with_mask(hdev, NIC_NUMBER_OF_MACROS, NIC_OFFSET,
      NIC_NUMBER_OF_QM_PER_MACRO,
