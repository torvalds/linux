...
#define GAUDI2_SOB_INCREMENT_BY_ONE (FIELD_PREP( \
    DCORE0_SYNC_MNGR_OBJS_SOB_OBJ_VAL_MASK, 1)   \
  | FIELD_PREP(DCORE0_SYNC_MNGR_OBJS_SOB_OBJ_INC_MASK, 1))

#define GAUDI2_NUM_TESTED_QS    (GAUDI2_QUEUE_ID_CPU_PQ \
...
#define GAUDI2_TOTAL_USER_INTERRUPTS (GAUDI2_NUM_USER_INTERRUPTS \
  + GAUDI2_NUM_RESERVED_INTERRUPTS)
...
enum gaudi2_irq_num {
  ...
  GAUDI2_IRQ_NUM_NIC_PORT_LAST
    = (GAUDI2_IRQ_NUM_NIC_PORT_FIRST + NIC_NUMBER_OF_PORTS - 1),
  GAUDI2_IRQ_NUM_TPC_ASSERT,
  GAUDI2_IRQ_NUM_EQ_ERROR,
  GAUDI2_IRQ_NUM_RESERVED_FIRST,
  GAUDI2_IRQ_NUM_RESERVED_LAST
    = (GAUDI2_MSIX_ENTRIES - GAUDI2_TOTAL_USER_INTERRUPTS - 1),
  GAUDI2_IRQ_NUM_UNEXPECTED_ERROR
    = RESERVED_MSIX_UNEXPECTED_USER_ERROR_INTERRUPT,
  GAUDI2_IRQ_NUM_USER_FIRST = GAUDI2_IRQ_NUM_UNEXPECTED_ERROR + 1,
  GAUDI2_IRQ_NUM_USER_LAST
    = (GAUDI2_IRQ_NUM_USER_FIRST + GAUDI2_NUM_USER_INTERRUPTS - 1),
...
/**
 * struct gaudi2_queues_test_info - Holds the address of a the messages used for
 * testing the
 *                                  device queues.
 ...
 * @virt_msix_db_dma_addr: bus address of the page for the virtual MSI-X
 * doorbell.
...
void gaudi2_write_rr_to_all_lbw_rtrs(struct hl_device *hdev, u8 rr_type,
    u32 rr_index, u64 min_val,
    u64 max_val);
void gaudi2_pb_print_security_errors(struct hl_device *hdev, u32 block_addr,
    u32 cause,
    u32 offended_addr);
