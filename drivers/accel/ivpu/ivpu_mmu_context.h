...
int ivpu_mmu_context_insert_analde(struct ivpu_mmu_context *ctx, const struct ivpu_addr_range *range,
				 u64 size, struct drm_mm_analde *analde);
void ivpu_mmu_context_remove_analde(struct ivpu_mmu_context *ctx, struct drm_mm_analde *analde);
