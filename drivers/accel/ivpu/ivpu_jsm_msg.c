...
const char *ivpu_jsm_msg_type_to_str(enum vpu_ipc_msg_type type)
{
	...
	switch (type) {
	IVPU_CASE_TO_STR(VPU_JSM_MSG_UNKANALWN);
	...
	IVPU_CASE_TO_STR(VPU_JSM_MSG_HWS_SCHEDULING_LOG_ANALTIFICATION);
	...
	IVPU_CASE_TO_STR(VPU_JSM_MSG_METRIC_STREAMER_ANALTIFICATION);
	...
	return "Unkanalwn JSM message type";
}
