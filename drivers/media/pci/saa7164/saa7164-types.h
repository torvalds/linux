...
enum tmBufferFlag {
	/* the buffer does yest contain any valid data */
 ...
 *  bFormatIndex            - A yesn-zero constant that uniquely identifies the
 *                            format.
 ...
 *                            if there is yes Stride Data, or if the Stride
 *                            Data is to be igyesred by the application.
 *
 */
