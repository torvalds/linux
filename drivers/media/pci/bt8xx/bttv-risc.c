...
static int bttv_risc_planar(struct bttv *btv, struct btcx_riscmem *risc,
    struct scatterlist *sglist,
...
static void bttv_calc_geo_old(struct bttv *btv, struct bttv_geometry *geo,
...
static void bttv_calc_geo(struct bttv *btv,
...
static void bttv_apply_geo(struct bttv *btv, struct bttv_geometry *geo,
    int odd) {
