...
static void cio2_queue_event_sof(struct cio2_device *cio2,
    struct cio2_queue *q) {
  /*
...
static int cio2_v4l2_try_fmt(struct file *file, void *fh,
...
static int cio2_video_enum_input(struct file *file, void *fh,
...
static int cio2_video_g_input(struct file *file, void *fh,
    unsigned int *input) {
  *input = 0;
  return 0;
}

static int cio2_video_s_input(struct file *file, void *fh, unsigned int input) {
...
static void cio2_fbpt_rearrange(struct cio2_device *cio2,
    struct cio2_queue *q) {
  unsigned int i, j;
