...
static void tw686x_reset_channels(struct tw686x_dev *dev,
...
MODULE_DESCRIPTION(
    "Driver for video frame grabber cards based on Intersil/Techwell TW686[4589]");
