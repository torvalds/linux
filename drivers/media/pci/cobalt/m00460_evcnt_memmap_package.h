...
#define M00460_CONTROL_BITMAP_ENABLE_MSK  (0x1 << \
      M00460_CONTROL_BITMAP_ENABLE_OFST)
#define M00460_CONTROL_BITMAP_CLEAR_OFST  (1)
#define M00460_CONTROL_BITMAP_CLEAR_MSK   (0x1 << \
      M00460_CONTROL_BITMAP_CLEAR_OFST)
