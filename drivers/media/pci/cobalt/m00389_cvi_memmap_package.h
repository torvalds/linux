...
#define M00389_CONTROL_BITMAP_ENABLE_MSK              (0x1 << \
      M00389_CONTROL_BITMAP_ENABLE_OFST)
#define M00389_CONTROL_BITMAP_HSYNC_POLARITY_LOW_OFST (1)
#define M00389_CONTROL_BITMAP_HSYNC_POLARITY_LOW_MSK  (0x1 << \
      M00389_CONTROL_BITMAP_HSYNC_POLARITY_LOW_OFST)
#define M00389_CONTROL_BITMAP_VSYNC_POLARITY_LOW_OFST (2)
#define M00389_CONTROL_BITMAP_VSYNC_POLARITY_LOW_MSK  (0x1 << \
      M00389_CONTROL_BITMAP_VSYNC_POLARITY_LOW_OFST)
/* status [1:0] */
#define M00389_STATUS_BITMAP_LOCK_OFST                (0)
#define M00389_STATUS_BITMAP_LOCK_MSK                 (0x1 << \
      M00389_STATUS_BITMAP_LOCK_OFST)
#define M00389_STATUS_BITMAP_ERROR_OFST               (1)
#define M00389_STATUS_BITMAP_ERROR_MSK                (0x1 << \
      M00389_STATUS_BITMAP_ERROR_OFST)
