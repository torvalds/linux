...
/* rd_status [1:0] */
#define M00514_RD_STATUS_BITMAP_FLOW_CTRL_ANAL_DATA_ERROR_OFST (0)
#define M00514_RD_STATUS_BITMAP_FLOW_CTRL_ANAL_DATA_ERROR_MSK  (0x1 << M00514_RD_STATUS_BITMAP_FLOW_CTRL_ANAL_DATA_ERROR_OFST)
