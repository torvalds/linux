...
#define M00514_CONTROL_BITMAP_SYNC_GENERATOR_LOAD_PARAM_MSK  (0x1 << \
      M00514_CONTROL_BITMAP_SYNC_GENERATOR_LOAD_PARAM_OFST)
#define M00514_CONTROL_BITMAP_SYNC_GENERATOR_ENABLE_OFST     (1)
#define M00514_CONTROL_BITMAP_SYNC_GENERATOR_ENABLE_MSK      (0x1 << \
      M00514_CONTROL_BITMAP_SYNC_GENERATOR_ENABLE_OFST)
#define M00514_CONTROL_BITMAP_FLOW_CTRL_OUTPUT_ENABLE_OFST   (2)
#define M00514_CONTROL_BITMAP_FLOW_CTRL_OUTPUT_ENABLE_MSK    (0x1 << \
      M00514_CONTROL_BITMAP_FLOW_CTRL_OUTPUT_ENABLE_OFST)
#define M00514_CONTROL_BITMAP_HSYNC_POLARITY_LOW_OFST        (3)
#define M00514_CONTROL_BITMAP_HSYNC_POLARITY_LOW_MSK         (0x1 << \
      M00514_CONTROL_BITMAP_HSYNC_POLARITY_LOW_OFST)
#define M00514_CONTROL_BITMAP_VSYNC_POLARITY_LOW_OFST        (4)
#define M00514_CONTROL_BITMAP_VSYNC_POLARITY_LOW_MSK         (0x1 << \
      M00514_CONTROL_BITMAP_VSYNC_POLARITY_LOW_OFST)
#define M00514_CONTROL_BITMAP_EVCNT_ENABLE_OFST              (5)
#define M00514_CONTROL_BITMAP_EVCNT_ENABLE_MSK               (0x1 << \
      M00514_CONTROL_BITMAP_EVCNT_ENABLE_OFST)
#define M00514_CONTROL_BITMAP_EVCNT_CLEAR_OFST               (6)
#define M00514_CONTROL_BITMAP_EVCNT_CLEAR_MSK                (0x1 << \
      M00514_CONTROL_BITMAP_EVCNT_CLEAR_OFST)
#define M00514_CONTROL_BITMAP_FORMAT_16_BPP_OFST             (7)
#define M00514_CONTROL_BITMAP_FORMAT_16_BPP_MSK              (0x1 << \
      M00514_CONTROL_BITMAP_FORMAT_16_BPP_OFST)
/* error_color [23:0] */
#define M00514_ERROR_COLOR_BITMAP_BLUE_OFST                  (0)
#define M00514_ERROR_COLOR_BITMAP_BLUE_MSK                   (0xff << \
      M00514_ERROR_COLOR_BITMAP_BLUE_OFST)
#define M00514_ERROR_COLOR_BITMAP_GREEN_OFST                 (8)
#define M00514_ERROR_COLOR_BITMAP_GREEN_MSK                  (0xff << \
      M00514_ERROR_COLOR_BITMAP_GREEN_OFST)
#define M00514_ERROR_COLOR_BITMAP_RED_OFST                   (16)
#define M00514_ERROR_COLOR_BITMAP_RED_MSK                    (0xff << \
      M00514_ERROR_COLOR_BITMAP_RED_OFST)
/* rd_status [1:0] */
#define M00514_RD_STATUS_BITMAP_FLOW_CTRL_NO_DATA_ERROR_OFST (0)
#define M00514_RD_STATUS_BITMAP_FLOW_CTRL_NO_DATA_ERROR_MSK  (0x1 << \
      M00514_RD_STATUS_BITMAP_FLOW_CTRL_NO_DATA_ERROR_OFST)
#define M00514_RD_STATUS_BITMAP_READY_BUFFER_FULL_OFST       (1)
#define M00514_RD_STATUS_BITMAP_READY_BUFFER_FULL_MSK        (0x1 << \
      M00514_RD_STATUS_BITMAP_READY_BUFFER_FULL_OFST)
