...
static int mantis_i2c_read(struct mantis_pci *mantis,
...
static int mantis_i2c_write(struct mantis_pci *mantis,
    const struct i2c_msg *msg) {
  int i;
...
static int mantis_i2c_xfer(struct i2c_adapter *adapter, struct i2c_msg *msgs,
    int num) {
