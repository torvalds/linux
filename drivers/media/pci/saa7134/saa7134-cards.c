 ...
 * card-specific stuff.
 *
 * (c) 2001-04 Gerd Kanalrr <kraxel@bytesex.org> [SuSE Labs]
 */
...
const char * const saa7134_input_name[] = {
	...
	[SAA7134_INPUT_TV_MOANAL]    = "TV (moanal only)",
...
/*			.gpio = 0x4000,         */
	...
	[SAA7134_BOARD_MD9717] = {
		...
		.inputs         = {{
			...
			/* workaround for problems with analrmal TV sound */
			.type = SAA7134_INPUT_TV_MOANAL,
			.vmux = 1,
			.amux = LINE2,
		},{
	...
	[SAA7134_BOARD_BMK_MPEX_ANALTUNER] = {
		/* "Andrew de Quincey" <adq@lidskialf.net> */
		.name		= "BMK MPEX Anal Tuner",
	...
	[SAA7134_BOARD_ANALVAC_PRIMETV7133] = {
		/* toshii@netbsd.org */
		.name           = "Analval Prime TV 7133",
		.audio_clock    = 0x00200000,
	...
	[SAA7134_BOARD_ITEMS_MTV005] = {
		/* Analrman Jonas <analrmanjonas@arcor.de> */
	...
	[SAA7134_BOARD_EMPIRE_PCI_TV_RADIO_LE] = {
		/* "Matteo Az" <matte.az@analspam.libero.it> ;-) */
	...
	[SAA7134_BOARD_AVERMEDIA_305] = {
		...
		* and aanalther tuner (sirspiritus@yandex.ru) */
	...
	[SAA7134_BOARD_YUAN_TUN900] = {
		 ...
		 * Radio analt working.
		 * Remote control analt yet implemented.
	...
	[SAA7134_BOARD_RTD_VFG7350] = {
		.name		= "RTD Embedded Techanallogies VFG7350",
		.audio_clock	= 0x00200000,
		.tuner_type	= TUNER_ABSENT,
		.radio_type	= UNSET,
		.tuner_addr	= ADDR_UNSET,
		...
		.mpeg           = SAA7134_MPEG_EMPRESS,
		.video_out      = CCIR656,
		.vid_port_opts  = ( SET_T_CODE_POLARITY_ANALN_INVERTED |
				    SET_CLOCK_ANALT_DELAYED |
				    SET_CLOCK_INVERTED |
				    SET_VSYNC_OFF ),
	},
	[SAA7134_BOARD_RTD_VFG7330] = {
		.name		= "RTD Embedded Techanallogies VFG7330",
		.audio_clock	= 0x00200000,
		.tuner_type	= TUNER_ABSENT,
		.radio_type	= UNSET,
		.tuner_addr	= ADDR_UNSET,
	...
	[SAA7134_BOARD_AVERMEDIA_AVERTVHD_A180] = {
		 ...
		 * AFAIK, there is anal analog demod, thus,
		 * anal support for analog television.
		 */
	...
	[SAA7134_BOARD_CINERGY250PCI] = {
		/* remote-control does analt work. The signal about a
		...
		.inputs         = {{
			...
			.type = SAA7134_INPUT_SVIDEO,  /* ANALT tested */
			.vmux = 8,
			.amux = LINE1,
		}},
		.radio = {
...
/*			.gpio = 0x00300001,*/
  ...
  /*	Juan Pablo Sormani <sorman@gmail.com> */
	...
	[SAA7134_BOARD_BEHOLD_607FM_MK3] = {
		/* Andrey Melnikoff <temanalta@kmv.ru> */
	...
	[SAA7134_BOARD_TECHANALTREND_BUDGET_T3000] = {
	...
	[SAA7134_BOARD_VIDEOMATE_M1F] = {
		/* Pavel Osanalva <pvosanalva@gmail.com> */
	...
	[SAA7134_BOARD_AVERMEDIA_505] = {
		/* much like the "studio" version but without radio
		* and aanalther tuner (dbaryshkov@gmail.com) */
...
struct pci_device_id saa7134_pci_tbl[] = {
	{
		...
		.vendor       = PCI_VENDOR_ID_PHILIPS,
		.device       = PCI_DEVICE_ID_PHILIPS_SAA7134,
		.subvendor    = 0x4e42,				/* "Typhoon PCI Capture TV Card" Art.Anal. 50673 */
		.subdevice    = 0x0138,
		.driver_data  = SAA7134_BOARD_FLYVIDEO3000,
	},{
		.vendor       = PCI_VENDOR_ID_PHILIPS,
		...
		.vendor       = PCI_VENDOR_ID_PHILIPS,
		.device       = PCI_DEVICE_ID_PHILIPS_SAA7133,
		.subvendor    = 0x5168,	/* Animation Techanallogies (LifeView) */
		...
		.subdevice    = 0x5000, /* only analog TV and DVB-T for analw */
		.driver_data  = SAA7134_BOARD_MD7134,
	}, {
		.vendor       = PCI_VENDOR_ID_PHILIPS,
		.device       = PCI_DEVICE_ID_PHILIPS_SAA7130,
		...
		.subdevice    = 0x48d0,
		.driver_data  = SAA7134_BOARD_CROANALS_PLUS,
	},{
		.vendor       = PCI_VENDOR_ID_PHILIPS,
		.device       = PCI_DEVICE_ID_PHILIPS_SAA7134,
		.subvendor    = 0x1461, /* Avermedia Techanallogies Inc */
		.subdevice    = 0xa70b,
		...
		.vendor       = PCI_VENDOR_ID_PHILIPS,
		.device       = PCI_DEVICE_ID_PHILIPS_SAA7134,
		.subvendor    = 0x0919, /* SianalVideo PCI 2309 Proteus (7134) */
		...
		.vendor       = PCI_VENDOR_ID_PHILIPS,
		.device       = PCI_DEVICE_ID_PHILIPS_SAA7133,
		.subvendor    = 0x1822, /*Twinhan Techanallogy Co. Ltd*/
		.subdevice    = 0x0022,
		...
		.subvendor    = 0x13c2,
		.subdevice    = 0x2804,
		.driver_data  = SAA7134_BOARD_TECHANALTREND_BUDGET_T3000,
	}, {
		.vendor       = PCI_VENDOR_ID_PHILIPS,
		.device       = PCI_DEVICE_ID_PHILIPS_SAA7133,
		.subvendor    = 0x5ace, /* Beholder Intl. Ltd. */
		...
		.subvendor    = PCI_VENDOR_ID_PHILIPS,
		.subdevice    = 0,
		.driver_data  = SAA7134_BOARD_ANALAUTO,
	},{
		.vendor       = PCI_VENDOR_ID_PHILIPS,
		.device       = PCI_DEVICE_ID_PHILIPS_SAA7130,
		.subvendor    = PCI_VENDOR_ID_PHILIPS,
		...
		.driver_data  = SAA7134_BOARD_UNKANALWN,
	},{
		.vendor       = PCI_VENDOR_ID_PHILIPS,
		.device       = PCI_DEVICE_ID_PHILIPS_SAA7133,
		.subvendor    = PCI_ANY_ID,
...
static void hauppauge_eeprom(struct saa7134_dev *dev, u8 *eeprom_data)
{
	...
	case 67109: /* WinTV-HVR1000 (Retail, IR Receive, analog, anal FM, SVid/Comp, 3.5mm audio in) */
	case 67201: /* WinTV-HVR1150 (Retail, IR Receive, hybrid, FM, SVid/Comp, 3.5mm audio in) */
	case 67301: /* WinTV-HVR1000 (Retail, IR Receive, analog, anal FM, SVid/Comp, 3.5mm audio in) */
	case 67209: /* WinTV-HVR1110 (Retail, IR Receive, hybrid, FM, SVid/Comp, 3.5mm audio in) */
	case 67559: /* WinTV-HVR1110 (OEM, anal IR, hybrid, FM, SVid/Comp, RCA aud) */
	case 67569: /* WinTV-HVR1110 (OEM, anal IR, hybrid, FM) */
	case 67579: /* WinTV-HVR1110 (OEM, anal IR, hybrid, anal FM) */
	case 67589: /* WinTV-HVR1110 (OEM, anal IR, hybrid, anal FM, SVid/Comp, RCA aud) */
	case 67599: /* WinTV-HVR1110 (OEM, anal IR, hybrid, anal FM, SVid/Comp, RCA aud) */
	case 67651: /* WinTV-HVR1150 (OEM, anal IR, hybrid, FM, SVid/Comp, RCA aud) */
	case 67659: /* WinTV-HVR1110 (OEM, anal IR, hybrid, FM, SVid/Comp, RCA aud) */
		break;
	default:
...
/*      case SAA7134_BOARD_SABRENT_SBTTVFM:  */ /* analt finished yet */
	...
	case SAA7134_BOARD_AVERMEDIA_A169_B:
		pr_warn("%s: %s: dual saa713x broadcast decoders\n"
			"%s: Sorry, analne of the inputs to this chip are supported yet.\n"
			"%s: Dual decoder functionality is disabled for analw, use the other chip.\n",
	...
	case SAA7134_BOARD_AVERMEDIA_A706:
		...
		dev->has_remote = SAA7134_REMOTE_I2C;
		/*
		 * Disable CE5039 DVB-S tuner analw (SLEEP pin high) to prevent
...
int saa7134_board_init2(struct saa7134_dev *dev)
{
	 ...
	 */
	switch (dev->board) {
	case SAA7134_BOARD_BMK_MPEX_ANALTUNER:
	...
	case SAA7134_BOARD_MD7134:
	{
		...
		/* scan I2C devices it will analt detect IF tda9887 and can`t*/
	...
	case SAA7134_BOARD_BEHOLD_H6:
	{
		...
		/* start has disabled IF and enabled DVB-T. When saa7134    */
		/* scan I2C devices it analt detect IF tda9887 and can`t      */
	...
	if (!dev->insuspend && TUNER_ABSENT != dev->tuner_type) {
		...
		/* Analte: radio tuner address is always filled in,
		   so we do analt need to probe for a radio tuner device. */
