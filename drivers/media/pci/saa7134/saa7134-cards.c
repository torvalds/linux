...
struct saa7134_board saa7134_boards[] = {
  ...
  [SAA7134_BOARD_FLYDVBTDUO] = {
     ...
     * "Nico Sabbi <nsabbi@tiscali.it>  Hartmut Hackmann
     *hartmut.hackmann@t-online.de*/
...
struct pci_device_id saa7134_pci_tbl[] = {
  {
    ...
    .vendor = PCI_VENDOR_ID_PHILIPS,
    .device = PCI_DEVICE_ID_PHILIPS_SAA7133,
    .subvendor = 0x0000, /* It shouldn't break anything, since subdevice id
                          * seems unique */
    .subdevice = 0x4091,
...
static void hauppauge_eeprom(struct saa7134_dev *dev, u8 *eeprom_data) {
  ...
  switch (tv.model) {
    case 67019: /* WinTV-HVR1110 (Retail, IR Blaster, hybrid, FM, SVid/Comp,
                 * 3.5mm audio in) */
    case 67109: /* WinTV-HVR1000 (Retail, IR Receive, analog, no FM, SVid/Comp,
                 * 3.5mm audio in) */
    case 67201: /* WinTV-HVR1150 (Retail, IR Receive, hybrid, FM, SVid/Comp,
                 * 3.5mm audio in) */
    case 67301: /* WinTV-HVR1000 (Retail, IR Receive, analog, no FM, SVid/Comp,
                 * 3.5mm audio in) */
    case 67209: /* WinTV-HVR1110 (Retail, IR Receive, hybrid, FM, SVid/Comp,
                 * 3.5mm audio in) */
        ...
        struct i2c_msg msg[]
          = {{.addr = 0x50, .flags = 0, .buf = &subaddr, .len = 1},
             {.addr = 0x50, .flags = I2C_M_RD, .buf = data, .len = 3}},
                  msg1 = {
          .addr = 0x61, .flags = 0, .buf = data1, .len = sizeof(data1)
        };
        subaddr = 0x14;
        tuner_t = 0;
    ...
    case SAA7134_BOARD_TECHNOTREND_BUDGET_T3000:
      {
        ...
        struct i2c_msg msg = {
          .addr = 0x08, .flags = 0, .buf = data, .len = sizeof(data)
        };
    ...
    case SAA7134_BOARD_FLYDVB_TRIO:
      {
        ...
        struct i2c_msg msg = {
          .addr = 0x09, .flags = 0, .buf = data, .len = sizeof(data)
        };
        i2c_transfer(&dev->i2c_adap, &msg, 1);
        /*
