...
static int saa7134_s_ctrl(struct v4l2_ctrl *ctrl) {
  struct saa7134_dev *dev = container_of(ctrl->handler, struct saa7134_dev,
      ctrl_handler);
  switch (ctrl->id) {
...
static int saa7134_g_selection(struct file *file, void *f,
...
static int saa7134_s_selection(struct file *file, void *f,
    struct v4l2_selection *sel) {
  struct saa7134_dev *dev = video_drvdata(file);
