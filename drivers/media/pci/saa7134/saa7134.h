...
#define card_has_radio(dev)   (SAA7134_NO_INPUT \
  != saa7134_boards[dev->board].radio.type)
...
#define card_is_go7007(dev)   (SAA7134_MPEG_GO7007  \
  == saa7134_boards[dev->board].mpeg)
#define card_has_mpeg(dev)    (SAA7134_MPEG_UNUSED  \
  != saa7134_boards[dev->board].mpeg)
...
void saa7134_stop_streaming(struct saa7134_dev *dev,
