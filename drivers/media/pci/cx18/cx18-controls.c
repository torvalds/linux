...
static int cx18_s_stream_vbi_fmt(struct cx2341x_handler *cxhdl, u32 fmt)
{
	...
	if (fmt != V4L2_MPEG_STREAM_VBI_FMT_IVTV ||
		...
		CX18_DE_INFO("disabled insertion of sliced VBI data into the MPEG stream\n");
		return 0;
	}
	...
	CX18_DE_INFO("enabled insertion of sliced VBI data into the MPEG PS,when sliced VBI is enabled\n");
