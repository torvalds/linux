...
static int cx18_s_audio(struct file *file, void *fh,
...
static int cx18_enum_input(struct file *file, void *fh,
...
int cx18_s_std(struct file *file, void *fh, v4l2_std_id std) {
   ...
   * UYUV YUV size is (Y=(h*720) + UV=(h*(720)))
   */
  if (cx->streams[CX18_ENC_STREAM_TYPE_YUV].pixelformat
...
static int cx18_s_tuner(struct file *file, void *fh,
