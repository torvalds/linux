...
/* NOTE: All ACK interrupts are in the SW2 register.  All yesn-ACK interrupts
...
/* If Firmware uses fixed memory map, it shall yest allocate the area
...
struct cx18_scb {
	...
	/* bit 0: 1/0 processor ready/yest ready. Set other bits to 0. */
	u32 cpu_state;
	u32 reserved1[7];
