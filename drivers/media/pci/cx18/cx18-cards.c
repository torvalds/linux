...
/* Compro VideoMate H900: yeste that this card is analog only! */
...
/* Yuan MPC718: yest working at the moment! */
...
/* Conexant Raptor PAL/SECAM: yeste that this card is analog only! */
...
int cx18_get_input(struct cx18 *cx, u16 index, struct v4l2_input *input)
{
	...
	input->audioset = (1 << cx->yesf_audio_inputs) - 1;
