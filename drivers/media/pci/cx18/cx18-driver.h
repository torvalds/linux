...
#define CX18_DEBUG_WARN(fmt, args ...)  CX18_DEBUG(CX18_DBGFLG_WARN, "warning", \
    fmt, ## args)
#define CX18_DEBUG_INFO(fmt, args ...)  CX18_DEBUG(CX18_DBGFLG_INFO, "info", \
    fmt, ## args)
#define CX18_DEBUG_API(fmt, args ...)   CX18_DEBUG(CX18_DBGFLG_API, "api", fmt, \
    ## args)
#define CX18_DEBUG_DMA(fmt, args ...)   CX18_DEBUG(CX18_DBGFLG_DMA, "dma", fmt, \
    ## args)
#define CX18_DEBUG_IOCTL(fmt, args ...) CX18_DEBUG(CX18_DBGFLG_IOCTL, "ioctl", \
    fmt, ## args)
#define CX18_DEBUG_FILE(fmt, args ...)  CX18_DEBUG(CX18_DBGFLG_FILE, "file", \
    fmt, ## args)
#define CX18_DEBUG_I2C(fmt, args ...)   CX18_DEBUG(CX18_DBGFLG_I2C, "i2c", fmt, \
    ## args)
#define CX18_DEBUG_IRQ(fmt, args ...)   CX18_DEBUG(CX18_DBGFLG_IRQ, "irq", fmt, \
    ## args)
...
#define CX18_DEBUG_HI_WARN(fmt, args ...)  CX18_DEBUG_HIGH_VOL(CX18_DBGFLG_WARN, \
    "warning", fmt, \
    ## args)
#define CX18_DEBUG_HI_INFO(fmt, args ...)  CX18_DEBUG_HIGH_VOL(CX18_DBGFLG_INFO, \
    "info", fmt, \
    ## args)
#define CX18_DEBUG_HI_API(fmt, args ...)   CX18_DEBUG_HIGH_VOL(CX18_DBGFLG_API, \
    "api", fmt, \
    ## args)
#define CX18_DEBUG_HI_DMA(fmt, args ...)   CX18_DEBUG_HIGH_VOL(CX18_DBGFLG_DMA, \
    "dma", fmt, \
    ## args)
#define CX18_DEBUG_HI_IOCTL(fmt, args ...) CX18_DEBUG_HIGH_VOL( \
    CX18_DBGFLG_IOCTL, "ioctl", fmt, ## args)
#define CX18_DEBUG_HI_FILE(fmt, args ...)  CX18_DEBUG_HIGH_VOL(CX18_DBGFLG_FILE, \
    "file", fmt, \
    ## args)
#define CX18_DEBUG_HI_I2C(fmt, args ...)   CX18_DEBUG_HIGH_VOL(CX18_DBGFLG_I2C, \
    "i2c", fmt, \
    ## args)
#define CX18_DEBUG_HI_IRQ(fmt, args ...)   CX18_DEBUG_HIGH_VOL(CX18_DBGFLG_IRQ, \
    "irq", fmt, \
    ## args)
...
#define CX18_F_S_INTERNAL_USE 5 /* this stream is used internally (sliced VBI
                                 * processing) */
#define CX18_F_S_STREAMOFF  7 /* signal end of stream EOS */
#define CX18_F_S_APPL_IO        8 /* this stream is used read/written by an
                                   * application */
...
struct cx18 {
  ...
  const struct cx18_card_tuner_i2c *card_i2c; /* i2c addresses to probe for
                                               * tuner */
  u8 is_50hz;
  u8 is_60hz;
