...
#define CPU_CMD_MASK_DE			(CPU_CMD_MASK | 0x00000000)
#define CPU_CMD_MASK_ACK			(CPU_CMD_MASK | 0x80000000)
#define CPU_CMD_MASK_CAPTURE			(CPU_CMD_MASK | 0x00020000)
#define CPU_CMD_MASK_TS				(CPU_CMD_MASK | 0x00040000)

#define EPU_CMD_MASK				0x02000000
#define EPU_CMD_MASK_DE			(EPU_CMD_MASK | 0x000000)
...
#define CX18_EPU_DE				(EPU_CMD_MASK_DE | 0x0003)

/* Reads memory/registers (32-bit)
   IN[0] - Address
   OUT[1] - Value */
#define CX18_CPU_DE_PEEK32			(CPU_CMD_MASK_DE | 0x0003)
