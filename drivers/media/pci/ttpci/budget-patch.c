 ...
 *
 * Special thanks to Holger Waechtler, Michael Huyesld, Marian Durkovic
 * and Metzlerbros
 *
...
#define HPS_SETUP 0
	...
	if(detected == 0)
		printk("budget-patch yest detected or saa7146 in yesn-default state.\n"
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Emard, Roberto Deza, Holger Waechtler, Michael Huyesld, others");
