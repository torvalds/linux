...
#define  MBIF_A_INT_MSTAT           0x040118  /* MBIF Int interrupt masked
                                               * status */
...
#define  MBIF_B_INT_MSTAT           0x040128  /* MBIF Int interrupt masked
                                               * status */
...
#define  GPIO_LO_OE                0x110018 /* Lower  of GPIO output enable
                                             * [31:0] */
#define  GPIO_HI_OE                0x11001C /* Upper word  of GPIO output enable
                                             * [47:32] */
...
/* *****************************************************************************
 * */
#define  TC_REQ                    0x040090 /* Rider PCI Express traFFic class
                                             * request */

/* *****************************************************************************
 * */
#define  TC_REQ_SET                0x040094 /* Rider PCI Express traFFic class
                                             * request set */
...
/* *****************************************************************************
 * */
#define  MBIST_CTRL                0x110050 /* SRAM memory built-in self test
                                             * control */

/* *****************************************************************************
 * */
#define  MBIST_STAT                0x110054 /* SRAM memory built-in self test
                                             * status */
