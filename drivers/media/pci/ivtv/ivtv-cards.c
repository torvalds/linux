...
static const struct ivtv_card ivtv_card_gotview_pci_dvd2 = {
  ...
  .gpio_audio_input
    = { .mask = 0x0800, .tuner = 0, .linein = 0, .radio = 0x0800 },
  .tuners = {
...
static const struct ivtv_card ivtv_card_asus_falcon2 = {
  ...
  .radio_input
    = { IVTV_CARD_INPUT_AUD_TUNER, CX25840_AUDIO_SERIAL, M52790_IN_TUNER },
  .tuners = {
    { .std = V4L2_STD_MN, .tuner = TUNER_PHILIPS_FM1236_MK3 },
  },
...
int ivtv_get_input(struct ivtv *itv, u16 index, struct v4l2_input *input) {
  const struct ivtv_card_video_input *card_input = itv->card->video_inputs
      + index;
...
int ivtv_get_audio_input(struct ivtv *itv, u16 index,
    struct v4l2_audio *audio) {
  const struct ivtv_card_audio_input *aud_input = itv->card->audio_inputs
      + index;
  static const char * const input_strs[] = {
    "Tuner 1",
    "Line In 1",
...
int ivtv_get_audio_output(struct ivtv *itv, u16 index,
    struct v4l2_audioout *aud_output) {
