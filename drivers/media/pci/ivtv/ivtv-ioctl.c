...
static void check_service_set(struct v4l2_sliced_vbi_format *fmt, int is_pal) {
  ...
  for (f = 0; f < 2; f++) {
    for (l = 0; l < 24; l++) {
      fmt->service_lines[f][l] = select_service_from_set(f, l,
          fmt->service_lines[f][l],
          is_pal);
    }
  }
}
...
void ivtv_set_osd_alpha(struct ivtv *itv) {
  ...
  ivtv_vapi(itv, CX2341X_OSD_SET_CHROMA_KEY, 2, itv->osd_chroma_key_state,
      itv->osd_chroma_key);
}
...
static int ivtv_g_fmt_sliced_vbi_out(struct file *file, void *fh,
...
static int ivtv_g_fmt_vid_cap(struct file *file, void *fh,
    struct v4l2_format *fmt) {
...
static int ivtv_g_fmt_vbi_cap(struct file *file, void *fh,
    struct v4l2_format *fmt) {
  struct ivtv *itv = fh2id(fh)->itv;
...
static int ivtv_g_fmt_sliced_vbi_cap(struct file *file, void *fh,
    struct v4l2_format *fmt) {
  struct v4l2_sliced_vbi_format *vbifmt = &fmt->fmt.sliced;
  struct ivtv_open_id *id = fh2id(fh);
  struct ivtv *itv = id->itv;
...
static int ivtv_g_fmt_vid_out(struct file *file, void *fh,
    struct v4l2_format *fmt) {
  struct ivtv_open_id *id = fh2id(fh);
  struct ivtv *itv = id->itv;
  struct v4l2_pix_format *pixfmt = &fmt->fmt.pix;
...
static int ivtv_g_fmt_vid_out_overlay(struct file *file, void *fh,
    struct v4l2_format *fmt) {
  struct ivtv *itv = fh2id(fh)->itv;
...
static int ivtv_try_fmt_sliced_vbi_out(struct file *file, void *fh,
    struct v4l2_format *fmt) {
  return ivtv_g_fmt_sliced_vbi_out(file, fh, fmt);
}

static int ivtv_try_fmt_vid_cap(struct file *file, void *fh,
    struct v4l2_format *fmt) {
  struct ivtv_open_id *id = fh2id(fh);
  struct ivtv *itv = id->itv;
...
static int ivtv_try_fmt_vbi_cap(struct file *file, void *fh,
    struct v4l2_format *fmt) {
  return ivtv_g_fmt_vbi_cap(file, fh, fmt);
}

static int ivtv_try_fmt_sliced_vbi_cap(struct file *file, void *fh,
    struct v4l2_format *fmt) {
  struct v4l2_sliced_vbi_format *vbifmt = &fmt->fmt.sliced;
  struct ivtv_open_id *id = fh2id(fh);
  struct ivtv *itv = id->itv;
...
static int ivtv_try_fmt_vid_out(struct file *file, void *fh,
    struct v4l2_format *fmt) {
  struct ivtv_open_id *id = fh2id(fh);
...
static int ivtv_try_fmt_vid_out_overlay(struct file *file, void *fh,
    struct v4l2_format *fmt) {
  struct ivtv *itv = fh2id(fh)->itv;
  struct ivtv_stream *s = &itv->streams[fh2id(fh)->type];
...
static int ivtv_s_fmt_sliced_vbi_out(struct file *file, void *fh,
    struct v4l2_format *fmt) {
  return ivtv_g_fmt_sliced_vbi_out(file, fh, fmt);
}

static int ivtv_s_fmt_vid_cap(struct file *file, void *fh,
    struct v4l2_format *fmt) {
  struct ivtv_open_id *id = fh2id(fh);
  struct ivtv *itv = id->itv;
  ...
  itv->cxhdl.width = w;
  itv->cxhdl.height = h;
  if (v4l2_ctrl_g_ctrl(itv->cxhdl.video_encoding)
...
static int ivtv_s_fmt_vbi_cap(struct file *file, void *fh,
    struct v4l2_format *fmt) {
  struct ivtv *itv = fh2id(fh)->itv;
...
static int ivtv_s_fmt_sliced_vbi_cap(struct file *file, void *fh,
    struct v4l2_format *fmt) {
  struct v4l2_sliced_vbi_format *vbifmt = &fmt->fmt.sliced;
  struct ivtv_open_id *id = fh2id(fh);
  struct ivtv *itv = id->itv;
...
static int ivtv_s_fmt_vid_out(struct file *file, void *fh,
    struct v4l2_format *fmt) {
  struct ivtv_open_id *id = fh2id(fh);
  struct ivtv *itv = id->itv;
...
static int ivtv_s_fmt_vid_out_overlay(struct file *file, void *fh,
    struct v4l2_format *fmt) {
  struct ivtv *itv = fh2id(fh)->itv;
...
static int ivtv_g_register(struct file *file, void *fh,
...
static int ivtv_s_register(struct file *file, void *fh,
...
static int ivtv_querycap(struct file *file, void *fh,
...
static int ivtv_s_audio(struct file *file, void *fh,
...
static int ivtv_enumaudout(struct file *file, void *fh,
...
static int ivtv_g_audout(struct file *file, void *fh,
    struct v4l2_audioout *vin) {
  struct ivtv *itv = fh2id(fh)->itv;
  vin->index = 0;
  return ivtv_get_audio_output(itv, vin->index, vin);
...
static int ivtv_s_audout(struct file *file, void *fh,
...
static int ivtv_enum_input(struct file *file, void *fh,
...
static int ivtv_enum_output(struct file *file, void *fh,
...
static int ivtv_enum_fmt_vid_cap(struct file *file, void *fh,
...
static int ivtv_enum_fmt_vid_out(struct file *file, void *fh,
    struct v4l2_fmtdesc *fmt) {
  static const struct v4l2_fmtdesc hm12 = {
...
static int ivtv_g_frequency(struct file *file, void *fh,
...
static int ivtv_s_tuner(struct file *file, void *fh,
...
static int ivtv_g_sliced_vbi_cap(struct file *file, void *fh,
...
static int ivtv_g_enc_index(struct file *file, void *fh,
  ...
  itv->pgm_info_read_idx = (itv->pgm_info_read_idx + idx->entries)
      % IVTV_MAX_PGM_INDEX;
  return 0;
}

static int ivtv_encoder_cmd(struct file *file, void *fh,
...
static int ivtv_try_encoder_cmd(struct file *file, void *fh,
    struct v4l2_encoder_cmd *enc) {
  struct ivtv *itv = fh2id(fh)->itv;
  switch (enc->cmd) {
    case V4L2_ENC_CMD_START:
...
static int ivtv_g_fbuf(struct file *file, void *fh,
...
static int ivtv_s_fbuf(struct file *file, void *fh,
  ...
  itv->osd_local_alpha_state
    = (fb->flags
      & (V4L2_FBUF_FLAG_LOCAL_ALPHA | V4L2_FBUF_FLAG_LOCAL_INV_ALPHA)) != 0;
...
static int ivtv_subscribe_event(struct v4l2_fh *fh,
...
static int ivtv_decoder_cmd(struct file *file, void *fh,
...
static int ivtv_try_decoder_cmd(struct file *file, void *fh,
    struct v4l2_decoder_cmd *dec) {
  struct ivtv_open_id *id = fh2id(file->private_data);
  struct ivtv *itv = id->itv;
