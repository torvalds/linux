...
static inline void ivtv_buf_sync_for_cpu(struct ivtv_stream *s,
...
static inline void ivtv_buf_sync_for_device(struct ivtv_stream *s,
    struct ivtv_buffer *buf) {
  if (ivtv_use_dma(s)) {
...
int ivtv_buf_copy_from_user(struct ivtv_stream *s, struct ivtv_buffer *buf,
...
void ivtv_enqueue(struct ivtv_stream *s, struct ivtv_buffer *buf,
    struct ivtv_queue *q);
struct ivtv_buffer *ivtv_dequeue(struct ivtv_stream *s, struct ivtv_queue *q);
int ivtv_queue_move(struct ivtv_stream *s, struct ivtv_queue *from,
