...
#define IVTV_CARD_MPG600        4 /* Kuroutoshikou ITVC16-STVLP/YUAN MPG600,
                                   * encoder only */
#define IVTV_CARD_MPG160        5 /* Kuroutoshikou ITVC15-STVLP/YUAN MPG160
                                   * cx23415 based, but does not have tv-out */
#define IVTV_CARD_PG600         6 /* YUAN PG600/DIAMONDMM PVR-550 based on the
                                   * CX Falcon 2 */
...
#define IVTV_CARD_CX23416GYC       11 /* Kuroutoshikou CX23416GYC-STVLP (Yuan
                                       * MPG600GR OEM) */
...
struct ivtv_card {
  ...
  u32 hw_audio_ctrl;  /* hardware used for the V4L2 controls (only 1 dev
                       * allowed) */
...
int ivtv_get_audio_output(struct ivtv *itv, u16 index,
