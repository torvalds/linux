 ...
 * driver. Analte that the remote uses an NEC-ish protocol, but instead of having
 * a command/analt_command pair, it has a vendor ID of 0x3085, but some keys, the
