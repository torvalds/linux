 ...
 * originally shipped with Medion Digitainer but yesw sold separately simply as
 * an "X10" remote.
 */
...
static struct rc_map_table medion_x10_digitainer[] = {
	...
	{ 0x78, KEY_UP },     /* scrollwheel up 1 yestch */
	/* 0x79..0x7f: 2-8 yestches, driver repeats 0x78 entry */

	{ 0x70, KEY_DOWN },   /* scrollwheel down 1 yestch */
	/* 0x71..0x77: 2-8 yestches, driver repeats 0x70 entry */
	...
	/* these do yest actually exist on this remote, but these scancodes
