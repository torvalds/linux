...
/*
 * driver for ENE KB3926 B/C/D/E/F CIR (also kyeswn as ENE0XXX)
 *
...
#define ENEB_IRQ_UNK1		0xFD17	/* unkyeswn setting = 1 */
...
#define ENE_CIRCFG_TX_CARR	0x80	/* send TX carrier or yest */
...
/* Kyesbs for protocol decoding - will document when/if will use them */
