...
MODULE_PARM_DESC(periods_measure_carrier,
...
static void redrat3_dump_fw_error(struct redrat3_dev *rr3, int code) {
  ...
  switch (code) {
    ...
    case 0x20:
      pr_cont(
          "Initial signal pulse not long enough to measure carrier frequency\n");
      break;
    case 0x21:
    ...
    case 0x28:
      pr_cont(
          "Insufficient memory available for IR signal data memory allocation\n");
      break;
    case 0x29:
      pr_cont(
          "Insufficient memory available for IrDa signal data memory allocation\n");
      break;
...
static void redrat3_read_packet_continue(struct redrat3_dev *rr3,
    unsigned len) {
...
static int redrat3_dev_suspend(struct usb_interface *intf,
