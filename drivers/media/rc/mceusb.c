...
static char DEVICE_RESUME[] = {
  MCE_CMD_NULL, MCE_CMD_PORT_SYS,
  MCE_CMD_RESUME
};
static char GET_REVISION[] = {
  MCE_CMD_PORT_SYS, MCE_CMD_G_REVISION
};
static char GET_EMVER[] = {
  MCE_CMD_PORT_SYS, MCE_CMD_GETEMVER
};
static char GET_WAKEVERSION[] = {
  MCE_CMD_PORT_SYS, MCE_CMD_GETWAKEVERSION
};
static char FLASH_LED[] = {
  MCE_CMD_PORT_SYS, MCE_CMD_FLASHLED
};
static char GET_UNKNOWN2[] = {
  MCE_CMD_PORT_IR, MCE_CMD_UNKNOWN2
};
static char GET_CARRIER_FREQ[] = {
  MCE_CMD_PORT_IR, MCE_CMD_GETIRCFS
};
static char GET_RX_TIMEOUT[] = {
  MCE_CMD_PORT_IR, MCE_CMD_GETIRTIMEOUT
};
static char GET_NUM_PORTS[] = {
  MCE_CMD_PORT_IR, MCE_CMD_GETIRNUMPORTS
};
static char GET_TX_BITMASK[] = {
  MCE_CMD_PORT_IR, MCE_CMD_GETIRTXPORTS
};
static char GET_RX_SENSOR[] = {
  MCE_CMD_PORT_IR, MCE_CMD_GETIRRXPORTEN
};
...
static int mce_write(struct mceusb_dev *ir, u8 *data, int size) {
  ...
  dev_dbg(dev,
      "tx done status = %d (wait = %lu, expire = %lu (%dms), urb->actual_length = %d, urb->status = %d)",
...
static int mceusb_tx_ir(struct rc_dev *dev, unsigned *txbuf, unsigned count) {
  ...
  u8 cmdbuf[3] = {
    MCE_CMD_PORT_IR, MCE_CMD_SETIRTXPORTS, 0x00
  };
...
static int mceusb_set_timeout(struct rc_dev *dev, unsigned int timeout) {
  u8 cmdbuf[4] = {
    MCE_CMD_PORT_IR, MCE_CMD_SETIRTIMEOUT, 0, 0
  };
  struct mceusb_dev *ir = dev->priv;
  unsigned int units;
...
static int mceusb_dev_suspend(struct usb_interface *intf,
