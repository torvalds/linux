 ...
 *  - Philips OM5610
 *(http://www-us.semiconductors.philips.com/acrobat/datasheets/OM5610_2.pdf)
 *  - Philips SAA6588
 *(http://www-us.semiconductors.philips.com/acrobat/datasheets/SAA6588_1.pdf)
...
MODULE_DESCRIPTION(
    "A driver for the TerraTec ActiveRadio Standalone radio card.");
MODULE_LICENSE("GPL");
...
static int terratec_s_mute_volume(struct radio_isa_card *isa, bool mute,
    int vol) {
  int i;
  if (mute) {
    vol = 0;
...
static const int terratec_ioports[] = {
  0x590
};
