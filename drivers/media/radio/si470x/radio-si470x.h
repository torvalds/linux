...
#define SYSCONFIG1_RDSIEN 0x8000  /* bits 15..15: RDS Interrupt Enable (Si4701
                                   * only) */
#define SYSCONFIG1_STCIEN 0x4000  /* bits 14..14: Seek/Tune Complete Interrupt
                                   * Enable */
...
#define SYSCONFIG3_SKCNT  0x000f  /* bits 03..00: Seek FM Impulse Detection
                                   * Threshold */
...
#define STATUSRSSI_RDSS   0x0800  /* bits 11..11: RDS Synchronized (Si4701 only)
                                   * */
#define STATUSRSSI_BLERA  0x0600  /* bits 10..09: RDS Block A Errors (Si4701
                                   * only) */
#define STATUSRSSI_ST   0x0100  /* bits 08..08: Stereo Indicator */
#define STATUSRSSI_RSSI   0x00ff  /* bits 07..00: RSSI (Received Signal Strength
                                   * Indicator) */

#define READCHAN    11  /* Read Channel */
#define READCHAN_BLERB    0xc000  /* bits 15..14: RDS Block D Errors (Si4701
                                   * only) */
#define READCHAN_BLERC    0x3000  /* bits 13..12: RDS Block C Errors (Si4701
                                   * only) */
#define READCHAN_BLERD    0x0c00  /* bits 11..10: RDS Block B Errors (Si4701
                                   * only) */
