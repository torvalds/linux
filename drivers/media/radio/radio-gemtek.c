...
MODULE_PARM_DESC(hardmute, "Enable 'hard muting' by shutting down PLL, may reduce static yesise.");
...
/*
 * Frequency calculation constants.  Intermediate frequency 10.52 MHz (yesminal
 * value 10.7 MHz), reference divisor 6.39 kHz (yesminal 6.25 kHz).
 */
#define FSCALE		8
