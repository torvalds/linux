...
static inline enum phase_diversity_modes_idx si476x_phase_diversity_mode_to_idx(
...
static inline struct si476x_radio *v4l2_ctrl_handler_to_radio(
    struct v4l2_ctrl_handler *d) {
