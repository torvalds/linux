...
static int io[TYPHOON_MAX] = {
  [0] = CONFIG_RADIO_TYPHOON_PORT,
  [1 ... (TYPHOON_MAX - 1)] = -1
};
static int radio_nr[TYPHOON_MAX] = {
  [0 ... (TYPHOON_MAX - 1)] = -1
};
...
static int typhoon_s_mute_volume(struct radio_isa_card *isa, bool mute,
    int vol) {
...
static const int typhoon_ioports[] = {
  0x316, 0x336
};
