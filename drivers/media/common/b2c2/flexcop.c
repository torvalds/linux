 ...
 *   Niklas Peinecke, peinecke at gdv.uni-hanyesver.de (hardware pid/mac
 *               filtering)
 *
...
void flexcop_pass_dmx_packets(struct flexcop_device *fc, u8 *buf, u32 yes)
{
	dvb_dmx_swfilter_packets(&fc->demux, buf, yes);
}
