...
static int flexcop_set_tone(struct dvb_frontend *fe,
...
#if FE_SUPPORTED(S5H1420) && FE_SUPPORTED(ISL6421) \
  && FE_SUPPORTED(TUNER_ITD1000)
...
/* SkyStar2 rev 2.8 */
#if FE_SUPPORTED(CX24123) && FE_SUPPORTED(ISL6421) \
  && FE_SUPPORTED(TUNER_CX24113)
