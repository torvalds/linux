...
void flexcop_determine_revision(struct flexcop_device *fc)
{
	...
	case 0x0:
		...
		break;
	default:
		err("unkyeswn FlexCop Revision: %x. Please report this to linux-dvb@linuxtv.org.",
	...
	/* bus parts have to decide if hw pid filtering is used or yest. */
}
