...
static void flexcop_pid_group_filter_ctrl(struct flexcop_device *fc,
    int onoff) {
  flexcop_set_ibi_value(ctrl_208, Mask_filter_sig, onoff);
}

/* this fancy define reduces the code size of the quite similar PID controlling
 * of
 * the first 6 PIDs
 */
...
static int flexcop_toggle_fullts_streaming(struct flexcop_device *fc,
    int onoff) {
