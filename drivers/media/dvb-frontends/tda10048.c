...
static int tda10048_read_status(struct dvb_frontend *fe,
...
static void tda10048_establish_defaults(struct dvb_frontend *fe) {
  ...
  if (config->dtv6_if_freq_khz == 0) {
    ...
    printk(
        KERN_WARNING "%s() tda10048_config.dtv6_if_freq_khz is not set (defaulting to %d)\n",
        __func__,
  ...
  if (config->dtv7_if_freq_khz == 0) {
    ...
    printk(
        KERN_WARNING "%s() tda10048_config.dtv7_if_freq_khz is not set (defaulting to %d)\n",
        __func__,
  ...
  if (config->dtv8_if_freq_khz == 0) {
    ...
    printk(
        KERN_WARNING "%s() tda10048_config.dtv8_if_freq_khz is not set (defaulting to %d)\n",
        __func__,
  ...
  if (config->clk_freq_khz == 0) {
    ...
    printk(
        KERN_WARNING "%s() tda10048_config.clk_freq_khz is not set (defaulting to %d)\n",
        __func__,
        config->clk_freq_khz);
  }
}
