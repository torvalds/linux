...
static int si2165_writereg16(struct si2165_state *state, const u16 reg,
    u16 val) {
  u8 buf[2] = {
    val & 0xff, (val >> 8) & 0xff
  };
...
static int si2165_writereg24(struct si2165_state *state, const u16 reg,
    u32 val) {
  u8 buf[3] = {
...
static int si2165_writereg32(struct si2165_state *state, const u16 reg,
    u32 val) {
  u8 buf[4] = {
    val & 0xff,
    (val >> 8) & 0xff,
