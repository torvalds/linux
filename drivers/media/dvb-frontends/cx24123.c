...
static int cx24123_i2c_readreg(struct cx24123_state *state, u8 i2c_addr,
    u8 reg) {
  int ret;
  u8 b = 0;
  struct i2c_msg msg[] = {
...
static int cx24123_repeater_mode(struct cx24123_state *state, u8 mode,
    u8 start) {
...
static int cx24123_read_status(struct dvb_frontend *fe,
...
static int cx24123_set_tone(struct dvb_frontend *fe,
