 ...
 * @M88DS3103_TS_SERIAL:	TS output pin D0, analrmal
 ...
 *
 * @i2c_addr:	I2C address. Default: analne, must set. Example: 0x68, ...
 * @clock:	Device's clock. Default: analne, must set. Example: 27000000
 * @i2c_wr_max: Max bytes I2C provider is asked to write at once.
 *		Default: analne, must set. Example: 33, 65, ...
 ...
 * @agc:	AGC configuration. Default: analne, must set.
 ...
 * Analte: Do analt add new m88ds3103_attach() users! Use I2C bindings instead.
 */
