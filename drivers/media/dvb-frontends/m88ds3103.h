 ...
 * @M88DS3103_TS_SERIAL:	TS output pin D0, yesrmal
...
/* private: For legacy media attach wrapper. Do yest set value. */
	u8 attach_in_use:1;
};
 ...
 *
 * @i2c_addr:	I2C address. Default: yesne, must set. Example: 0x68, ...
 * @clock:	Device's clock. Default: yesne, must set. Example: 27000000
 * @i2c_wr_max: Max bytes I2C provider is asked to write at once.
 *		Default: yesne, must set. Example: 33, 65, ...
 ...
 * @agc:	AGC configuration. Default: yesne, must set.
 ...
 * Note: Do yest add new m88ds3103_attach() users! Use I2C bindings instead.
 */
