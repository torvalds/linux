...
/* impulse yesise parameter */
/* 36 ??? */

static u16 dib3000mb_reg_impulse_yesise[] = { 10,11,12,15,36 };

enum dib3000mb_impulse_yesise_type {
...
static u16 dib3000mb_impulse_yesise_values[][5] = {
...
/* phase yesise */
/* 36 is set when setting the impulse yesise */
static u16 dib3000mb_reg_phase_yesise[] = { 33,34,35,37,38 };

static u16 dib3000mb_default_yesise_phase[] = { 2, 544, 0, 5, 4 };
 ...
 * either automatically detected or yest
 */
...
/* phase yesise compensation inhibition */
...
/*
 * pidfilter
 * it is yest a hardware pidfilter but a filter which drops all pids
 ...
 * used to calculate the signal/yesise - ratio
 */
