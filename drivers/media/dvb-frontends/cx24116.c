...
static int cx24116_writereg(struct cx24116_state *state, int reg, int data) {
  ...
  if (err != 1) {
    printk(
        KERN_ERR "%s: writereg error(err == %i, reg == 0x%02x, value == 0x%02x)\n",
 ...
 */
static int cx24116_cmd_execute(struct dvb_frontend *fe,
...
static int cx24116_read_status(struct dvb_frontend *fe,
