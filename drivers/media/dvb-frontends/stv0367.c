...
enum active_demod_state {
  demod_none, demod_ter, demod_cab
};
...
static const s32 stv0367cab_RF_LookUp1[RF_LOOKUP_TABLE_SIZE][
...
static const s32 stv0367cab_RF_LookUp2[RF_LOOKUP_TABLE2_SIZE][
...
static enum stv0367_ter_signal_type stv0367ter_lock_algo(
...
void stv0367cab_GetErrorCount(state, enum stv0367cab_mod QAMSize,
  ...
  stv0367cab_OptimiseNByteAndGetBER(state, QAMSize, symbol_rate,
      Monitor_results);
