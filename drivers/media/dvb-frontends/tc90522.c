...
static int reg_write(struct tc90522_state *state, const struct reg_val *regs,
    int num) {
  int i, ret;
  struct i2c_msg msg;
  ret = 0;
...
static int tc90522s_read_status(struct dvb_frontend *fe,
...
static int tc90522t_read_status(struct dvb_frontend *fe,
    enum fe_status *status) {
  struct tc90522_state *state;
  int ret;
  u8 reg;
...
static int tc90522_master_xfer(struct i2c_adapter *adap, struct i2c_msg *msgs,
    int num) {
  struct tc90522_state *state;
