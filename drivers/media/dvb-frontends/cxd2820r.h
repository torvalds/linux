 ...
 *		 Default: yesne, must set. Values: 0x6c, 0x6d.
 * @ts_mode:	TS output mode. Default: yesne, must set. Values: FIXME?
 ...
 *		    gpio base; if is yest set, use its value to
 *		    setup the GPIO pins.
 *
