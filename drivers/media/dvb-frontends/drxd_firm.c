...
#define ADDRESS(x)     ((x) & 0xFF), (((x) >> 8) & 0xFF), (((x) >> 16) & 0xFF), \
  (((x) >> 24) & 0xFF)
...
/*   WR16(B_FE_AG_REG_AG_AGC_SIO__A,(extAttr -> FeAgRegAgAgcSio), 0x0000
 *);*//*added HS 23-05-2005
...
u8 DRXD_StartDiversityFront[] = {
  ...
  WR16(B_EQ_REG_RC_SEL_CAR__A, B_EQ_REG_RC_SEL_CAR_PASS_B_CE    /* CE to PASS
                                                                 * mux */
      | B_EQ_REG_RC_SEL_CAR_LOCAL_B_CE | B_EQ_REG_RC_SEL_CAR_MEAS_B_CE),
...
u8 DRXD_StartDiversityEnd[] = {
  ...
  WR16(B_EQ_REG_RC_SEL_CAR__A, B_EQ_REG_RC_SEL_CAR_DIV_ON   /* org = 0x81
                                                             * combining enabled
                                                             * */
