...
extern int dib9000_i2c_enumeration(struct i2c_adapter *host, int yes_of_demods, u8 default_addr, u8 first_addr);
...
extern int dib9000_fw_pid_filter_ctrl(struct dvb_frontend *fe, u8 oyesff);
extern int dib9000_fw_pid_filter(struct dvb_frontend *fe, u8 id, u16 pid, u8 oyesff);
...
static inline int dib9000_i2c_enumeration(struct i2c_adapter *host, int yes_of_demods, u8 default_addr, u8 first_addr)
{
	printk(KERN_WARNING "%s: driver disabled by Kconfig\n", __func__);
	return -ENODEV;
}
...
static inline int dib9000_fw_pid_filter_ctrl(struct dvb_frontend *fe, u8 oyesff)
{
	printk(KERN_WARNING "%s: driver disabled by Kconfig\n", __func__);
	return -ENODEV;
}

static inline int dib9000_fw_pid_filter(struct dvb_frontend *fe, u8 id, u16 pid, u8 oyesff)
{
	printk(KERN_WARNING "%s: driver disabled by Kconfig\n", __func__);
	return -ENODEV;
}
