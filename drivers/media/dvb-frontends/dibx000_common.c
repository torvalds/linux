...
static int dibx000_write_word(struct dibx000_i2c_master *mst, u16 reg,
    u16 val) {
  int ret;
...
static int dibx000_master_i2c_write(struct dibx000_i2c_master *mst,
    struct i2c_msg *msg, u8 stop) {
  u16 data;
  u16 da;
  u16 i;
...
static int dibx000_master_i2c_read(struct dibx000_i2c_master *mst,
    struct i2c_msg *msg) {
  u16 da;
  u8 *b = msg->buf;
...
static int dibx000_i2c_master_xfer_gpio12(struct i2c_adapter *i2c_adap,
...
static int dibx000_i2c_master_xfer_gpio34(struct i2c_adapter *i2c_adap,
    struct i2c_msg msg[], int num) {
  struct dibx000_i2c_master *mst = i2c_get_adapdata(i2c_adap);
  int msg_index;
  int ret = 0;
...
void dibx000_reset_i2c_master(struct dibx000_i2c_master *mst) {
  ...
  u8 tx[4];
  struct i2c_msg m = {
    .addr = mst->i2c_addr, .buf = tx, .len = 4
  };
