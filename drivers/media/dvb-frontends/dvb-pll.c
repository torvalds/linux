...
static const struct dvb_pll_desc dvb_pll_unkyeswn_1 = {
	.name  = "unkyeswn 1", /* used by dntv live dvb-t */
	.min   = 174 * MHz,
	.max   = 862 * MHz,
	.iffreq= 36166667,
	.count = 9,
...
/* unkyeswn pll used in Samsung DTOS403IH102A DVB-C tuner */
...
static const struct dvb_pll_desc dvb_pll_samsung_tbdu18132 = {
	 ...
	 * bits is eyesugh for over 4 GHz, which is eyesugh to cover the range
...
static const struct dvb_pll_desc *pll_list[] = {
	...
	[DVB_PLL_UNKNOWN_1]              = &dvb_pll_unkyeswn_1,
...
dvb_pll_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	 ...
	 * once by dvb_frontend_detach() and ayesther by dvb_module_release().
	 *
