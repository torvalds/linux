...
static int i2c_readbytes(struct or51211_state *state, u8 reg, u8 *buf,
    int len) {
  int err;
  struct i2c_msg msg;
  msg.addr = reg;
...
static int or51211_read_status(struct dvb_frontend *fe,
...
static int or51211_read_signal_strength(struct dvb_frontend *fe,
    u16 *strength) {
