...
static int stv0288_set_tone(struct dvb_frontend *fe,
...
static int stv0288_read_status(struct dvb_frontend *fe,
...
static int stv0288_read_signal_strength(struct dvb_frontend *fe,
    u16 *strength) {
  struct stv0288_state *state = fe->demodulator_priv;
