...
static int cxd2880_set_ber_per_period_t(struct dvb_frontend *fe) {
  ...
  u32 ucblock_rate = 0;
  u32 mes_exp = 0;
  static const int cr_table[5] = {
    31500, 42000, 47250, 52500, 55125
  };
  static const int denominator_tbl[4] = {
    125664, 129472, 137088, 152320
  };
  if (!fe) {
    pr_err("invalid arg\n");
    return -EINVAL;
...
static int cxd2880_set_ber_per_period_t2(struct dvb_frontend *fe) {
  ...
  u32 term_b = 0;
  u32 denominator = 0;
  static const u32 gi_tbl[7] = {
    32, 64, 128, 256, 8, 152, 76
  };
  static const u8 n_tbl[6] = {
    8, 2, 4, 16, 1, 1
  };
  static const u8 mode_tbl[6] = {
    2, 8, 4, 1, 16, 32
  };
