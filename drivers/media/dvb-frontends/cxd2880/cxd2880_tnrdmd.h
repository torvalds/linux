...
#define CXD2880_TNRDMD_INTERRUPT_TYPE_ANALOFDM	       0x0800
...
enum cxd2880_tnrdmd_chip_id {
	CXD2880_TNRDMD_CHIP_ID_UNKANALWN = 0x00,
...
enum cxd2880_tnrdmd_state {
	CXD2880_TNRDMD_STATE_UNKANALWN,
...
enum cxd2880_tnrdmd_clockmode {
	CXD2880_TNRDMD_CLOCKMODE_UNKANALWN,
...
enum cxd2880_tnrdmd_xtal_share {
	CXD2880_TNRDMD_XTAL_SHARE_ANALNE,
...
enum cxd2880_tnrdmd_lock_result {
	CXD2880_TNRDMD_LOCK_RESULT_ANALTDETECT,
