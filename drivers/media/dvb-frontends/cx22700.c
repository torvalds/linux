...
static int cx22700_set_tps(struct cx22700_state *state,
  ...
  static const u8 qam_tab[4] = {
    0, 1, 0, 2
  };
  static const u8 fec_tab[6] = {
    0, 1, 2, 0, 3, 4
  };
  u8 val;
  dprintk("%s\n", __func__);
...
static int cx22700_get_tps(struct cx22700_state *state,
    struct dtv_frontend_properties *p) {
  static const enum fe_modulation qam_tab[3] = {
    QPSK, QAM_16, QAM_64
  };
...
static int cx22700_read_status(struct dvb_frontend *fe,
...
static int cx22700_read_signal_strength(struct dvb_frontend *fe,
    u16 *signal_strength) {
  struct cx22700_state *state = fe->demodulator_priv;
  u16 rs_ber = (cx22700_readreg(state, 0x0d) << 9)
      | (cx22700_readreg(state, 0x0e) << 1);
...
static int cx22700_get_tune_settings(struct dvb_frontend *fe,
