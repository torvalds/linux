...
static struct v4l2_rect vimc_scaler_get_crop_bound_sink(
...
static struct v4l2_mbus_framefmt *vimc_scaler_pad_format(
...
static struct v4l2_rect *vimc_scaler_pad_crop(
    struct vimc_scaler_device *vscaler,
    struct v4l2_subdev_state *sd_state,
    enum v4l2_subdev_format_whence which) {
  if (which == V4L2_SUBDEV_FORMAT_TRY) {
...
static void vimc_scaler_fill_src_frame(
    const struct vimc_scaler_device * const vscaler,
...
static void *vimc_scaler_process_frame(struct vimc_ent_device *ved,
  ...
  struct vimc_scaler_device *vscaler = container_of(ved,
      struct vimc_scaler_device,
      ved);
