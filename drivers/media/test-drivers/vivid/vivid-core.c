...
static int vidioc_enum_freq_bands(struct file *file, void *fh,
...
static int vidioc_s_tuner(struct file *file, void *fh,
...
static __poll_t vivid_radio_poll(struct file *file,
  ...
  if (dev->has_vid_out) {
    ...
    for (i = 0; i < cec_tx_bus_cnt; i++) {
      ...
      v4l2_info(&dev->v4l2_dev,
          "CEC adapter %s registered for HDMI output %d\n",
