...
static int vivid_fb_ioctl(struct fb_info *info, unsigned cmd,
    unsigned long arg) {
...
static int vivid_fb_set_var(struct vivid_dev *dev,
...
static int vivid_fb_get_fix(struct vivid_dev *dev,
...
static int _vivid_fb_check_var(struct fb_var_screeninfo *var,
...
static int vivid_fb_check_var(struct fb_var_screeninfo *var,
    struct fb_info *info) {
  struct vivid_dev *dev = (struct vivid_dev *) info->par;
  dprintk(dev, 1, "vivid_fb_check_var\n");
...
static int vivid_fb_pan_display(struct fb_var_screeninfo *var,
    struct fb_info *info) {
  return 0;
}
