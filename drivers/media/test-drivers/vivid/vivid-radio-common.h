...
enum {
  BAND_FM, BAND_AM, BAND_SW, TOT_BANDS
};

extern const struct v4l2_frequency_band vivid_radio_bands[TOT_BANDS];

int vivid_radio_g_frequency(struct file *file, const unsigned *freq,
    struct v4l2_frequency *vf);
int vivid_radio_s_frequency(struct file *file, unsigned *freq,
