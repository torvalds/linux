...
static enum v4l2_field vivid_field_cap(struct vivid_dev *dev,
...
int vivid_vid_cap_s_selection(struct file *file, void *fh,
...
int vivid_video_g_frequency(struct file *file, void *fh,
...
int vivid_video_s_frequency(struct file *file, void *fh,
...
int vivid_video_s_tuner(struct file *file, void *fh,
