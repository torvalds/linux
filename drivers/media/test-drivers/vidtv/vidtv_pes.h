...
#define PES_MAX_LEN 65536 /* Set 'length' to 0 if greater. Only possible for
                           * video. */
 ...
 * @access_unit_len: The size of _one_ access unit (with any headers it might
 *need)
 */
 ...
 * equal to the size of the access unit, since we need space for PES headers, TS
 *headers
