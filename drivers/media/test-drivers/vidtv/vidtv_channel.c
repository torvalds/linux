...
*vidtv_channel_s302m_init(struct vidtv_channel *head, u16 transport_stream_id) {
  ...
  s302m->service = vidtv_psi_sdt_service_init(NULL, s302m_service_id, false,
      true);
  if (!s302m->service) {
    goto free_name;
  }
...
static struct vidtv_psi_table_pat_program *vidtv_channel_pat_prog_cat_into_new(
    struct vidtv_mux *m) {
 ...
 * streams
 */
static void vidtv_channel_pmt_match_sections(struct vidtv_channel *channels,
...
static void vidtv_channel_destroy_service_list(
    struct vidtv_psi_desc_service_list_entry *e) {
