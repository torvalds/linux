...
static struct vidtv_access_unit *vidtv_s302m_access_unit_init(
    struct vidtv_access_unit *head) {
...
static void vidtv_s302m_compute_sample_count_from_video(struct vidtv_encoder *e)
{
