 ...
 * that driver and for libgphoto2 but shares yes code with them.
 *
...
/* The kyeswn modes, or registers. These go in the "value" slot. */

/* 00 is "yesne" obviously */
...
/* Any yesn-zero value in the bottom 2 bits of the 2nd byte of
...
#define SQ905_CONFIG  0x20	/* gets photo alloc. table, yest used here */
#define SQ905_DATA    0x30	/* accesses photo data, yest used here */
#define SQ905_CLEAR   0xa0	/* clear everything */
#define SQ905_CAPTURE_LOW  0x60	/* Starts capture at 160x120 */
#define SQ905_CAPTURE_MED  0x61	/* Starts capture at 320x240 */
#define SQ905_CAPTURE_HIGH 0x62	/* Starts capture at 640x480 (some cams only) */
/* yeste that the capture command also controls the output dimensions */
...
/*
 * Ackyeswledge the end of a frame - see warning on sq905_command.
 */
...
static void sq905_dostream(struct work_struct *work)
{
	...
	while (gspca_dev->present && gspca_dev->streaming) {
		...
		/* Note we do yest check for gspca_dev->streaming here, as
