...
static void stv06xx_pkt_scan(struct gspca_dev *gspca_dev,
  ...
  while (len) {
    ...
    if (len < chunk_len) {
      gspca_err(gspca_dev,
          "URB packet length is smaller than the specified chunk length\n");
...
static const struct usb_device_id device_table[] = {
  {USB_DEVICE(0x046d, 0x0840), .driver_info = BRIDGE_STV600 },  /* QuickCam
                                                                 * Express */
  {USB_DEVICE(0x046d, 0x0850), .driver_info = BRIDGE_STV610 },  /* LEGO cam /
                                                                 * QuickCam Web
                                                                 * */
  {USB_DEVICE(0x046d, 0x0870), .driver_info = BRIDGE_STV602 },  /* Dexxa WebCam
                                                                 * USB */
  {USB_DEVICE(0x046D, 0x08F0), .driver_info = BRIDGE_ST6422 },  /* QuickCam
                                                                 * Messenger */
  {USB_DEVICE(0x046D, 0x08F5), .driver_info = BRIDGE_ST6422 },  /* QuickCam
                                                                 * Communicate
                                                                 * */
  {USB_DEVICE(0x046D, 0x08F6), .driver_info = BRIDGE_ST6422 },  /* QuickCam
                                                                 * Messenger
                                                                 * (new) */
  {}
};
