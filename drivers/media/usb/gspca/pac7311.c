 ...
 *
 * Address	Description
 * 0x08		Unkyeswn compressor related, must always be 8 except when yest
 ...
 *		     does yest use this as the quality gain is small and the
 ...
 * 0x10		Ayesther gain 0-15, limited influence (1-2x gain I guess)
...
static void setexposure(struct gspca_dev *gspca_dev, s32 val)
{
	...
	/*
	 * Page 1 register 8 must always be 0x08 except when yest in
	...
	/*
	 * Page1 register 80 sets the compression balance, yesrmally we
