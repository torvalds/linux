...
MODULE_AUTHOR(
    "Kyle Guinn <elyk03@gmail.com>,Theodore Kilgore <kilgota@auburn.edu>");
...
static int cam_get_response16(struct gspca_dev *gspca_dev, u8 reg,
    int verbose) {
  int err_code;
...
static void setexposure(struct gspca_dev *gspca_dev, s32 expo,
    s32 min_clockdiv) {
  struct sd *sd = (struct sd *) gspca_dev;
