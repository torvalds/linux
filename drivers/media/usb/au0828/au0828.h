...
#else
static inline int au0828_rc_register(struct au0828_dev *dev) {
  return 0;
}
...
static inline int au0828_rc_suspend(struct au0828_dev *dev) {
  return 0;
}

static inline int au0828_rc_resume(struct au0828_dev *dev) {
  return 0;
}
