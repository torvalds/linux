...
static int mxl111sf_set_gpo_state(struct mxl111sf_state *state, u8 pin,
    u8 val) {
  int ret;
  u8 tmp;
...
static int mxl111sf_get_gpi_state(struct mxl111sf_state *state, u8 pin,
    u8 *val) {
  int ret;
  u8 tmp;
...
static int mxl111sf_hw_set_gpio(struct mxl111sf_state *state, int gpio,
    int val) {
