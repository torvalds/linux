 ...
 *
 */
#ifndef __PVRUSB2_DE_H
#define __PVRUSB2_DE_H

extern int pvrusb2_de;

#define pvr2_trace(msk, fmt, arg...) do {if (msk & pvrusb2_de) pr_info("pvrusb2: " fmt "\n", ##arg); } while (0)
...
#define PVR2_TRACE_I2C_CORE   (1 << 19) /* I2C core deging */
...
#define PVR2_TRACE_DEIFC   (1 << 26) /* De interface actions */
#define PVR2_TRACE_GPIO       (1 << 27) /* GPIO state bit changes */
#define PVR2_TRACE_DVB_FEED   (1 << 28) /* DVB transport feed de */
