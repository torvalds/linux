 ...
 */
static int pvr2_querycap(struct file *file, void *priv,
...
static int pvr2_enum_input(struct file *file, void *priv,
...
static int pvr2_enumaudio(struct file *file, void *priv,
...
static int pvr2_s_audio(struct file *file, void *priv,
...
static int pvr2_s_tuner(struct file *file, void *priv,
...
static int pvr2_s_frequency(struct file *file, void *priv,
...
static int pvr2_g_frequency(struct file *file, void *priv,
...
static int pvr2_enum_fmt_vid_cap(struct file *file, void *priv,
...
static int pvr2_g_fmt_vid_cap(struct file *file, void *priv,
...
static int pvr2_try_fmt_vid_cap(struct file *file, void *priv,
    struct v4l2_format *vf) {
  struct pvr2_v4l2_fh *fh = file->private_data;
  struct pvr2_hdw *hdw = fh->channel.mc_head->hdw;
  int lmin, lmax, ldef;
...
static int pvr2_s_fmt_vid_cap(struct file *file, void *priv,
    struct v4l2_format *vf) {
  struct pvr2_v4l2_fh *fh = file->private_data;
  struct pvr2_hdw *hdw = fh->channel.mc_head->hdw;
  struct pvr2_ctrl *hcp, *vcp;
...
static int pvr2_querymenu(struct file *file, void *priv,
...
static int pvr2_v4l2_release(struct file *file) {
  ...
  if (fhp->rhp) {
    ...
    if (sp) {
      pvr2_stream_set_callback(sp, NULL, NULL);
    }
...
static int pvr2_v4l2_iosetup(struct pvr2_v4l2_fh *fh) {
  ...
  if ((ret = pvr2_hdw_set_streaming(hdw, !0)) < 0) {
    return ret;
  }
