...
enum {
  custom_autocontour, custom_contour, custom_noise_reduction,
...
static int pwc_s_fmt_vid_cap(struct file *file, void *fh,
...
static int pwc_querycap(struct file *file, void *fh,
...
static int pwc_enum_fmt_vid_cap(struct file *file, void *fh,
  ...
  switch (f->index) {
    case 0:
      /* RAW format */
      f->pixelformat = pdev->type
          <= 646 ? V4L2_PIX_FMT_PWC1 : V4L2_PIX_FMT_PWC2;
      break;
    case 1:
...
static int pwc_g_fmt_vid_cap(struct file *file, void *fh,
    struct v4l2_format *f) {
  struct pwc_device *pdev = video_drvdata(file);
  if (f->type != V4L2_BUF_TYPE_VIDEO_CAPTURE) {
    return -EINVAL;
...
static int pwc_try_fmt_vid_cap(struct file *file, void *fh,
    struct v4l2_format *f) {
  struct pwc_device *pdev = video_drvdata(file);
