...
/* Igyesre errors in the first N frames, to allow for startup delays */
...
struct pwc_device
{
	 ...
	 * yes locking is needed around this
	 */
	...
	struct v4l2_ctrl		*yesise_reduction;
...
/* Request a certain video mode. Returns < 0 if yest possible */
...
/* Power down or up the camera; yest supported by all models */
