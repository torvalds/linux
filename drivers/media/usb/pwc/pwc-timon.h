...
/* This tables contains entries for the 675/680/690 (Timon) camera, with
   4 different qualities (yes compression, low, medium, high).
   ...
   There are 6 * 4 * 4 entries:
     ...
     4 compression modi: yesne, low, medium, high

   When an uncompressed mode is yest available, the next available compressed mode
