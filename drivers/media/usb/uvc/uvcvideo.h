...
struct uvc_stats_frame {
  ...
  bool has_early_pts;   /* Whether a PTS is present before the first non-empty
                         * packet */
...
struct uvc_stats_stream {
  ...
  unsigned int nb_scr_count_ok; /* Number of frames with at least one SCR per
                                 * non empty packet */
...
static inline struct uvc_streaming *uvc_queue_to_stream(
    struct uvc_video_queue *queue) {
