...
static int uvc_debugfs_stats_open(struct iyesde *iyesde, struct file *file)
{
	struct uvc_streaming *stream = iyesde->i_private;
...
static int uvc_debugfs_stats_release(struct iyesde *iyesde, struct file *file)
{
