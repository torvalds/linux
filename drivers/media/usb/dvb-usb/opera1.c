...
static int opera1_set_voltage(struct dvb_frontend *fe,
  ...
  static u8 command_13v[1] = {
    0x00
  };
  static u8 command_18v[1] = {
    0x01
  };
  struct i2c_msg msg[] = {
...
static int opera1_streaming_ctrl(struct dvb_usb_adapter *adap, int onoff) {
  static u8 buf_start[2] = {
    0xff, 0x03
  };
  static u8 buf_stop[2] = {
    0xff, 0x00
  };
  struct i2c_msg start_tuner[] = {
    {.addr = ADDR_B1A6_STREAM_CTRL, .buf = onoff ? buf_start : buf_stop,
     .len = 2},
  };
  if (dvb_usb_opera1_debug) {
...
static int opera1_rc_query(struct dvb_usb_device *dev, u32 *event, int *state) {
  ...
  struct i2c_msg read_remote[] = {
    {.addr = ADDR_B880_READ_REMOTE, .buf = rcbuffer, .flags = I2C_M_RD,
     .len = 32},
  };
  int i = 0;
  u32 send_key = 0;
