...
static int su3000_streaming_ctrl(struct dvb_usb_adapter *adap, int onoff) {
  static u8 command_start[] = {
    0x00
  };
  static u8 command_stop[] = {
    0x01
  };
  struct i2c_msg msg = {
...
static int dw210x_set_voltage(struct dvb_frontend *fe,
  ...
  static u8 command_13v[] = {
    0x00, 0x01
  };
  static u8 command_18v[] = {
    0x01, 0x01
  };
  static u8 command_off[] = {
    0x00, 0x00
  };
  struct i2c_msg msg = {
...
static int stv0288_frontend_attach(struct dvb_usb_adapter *d) {
  ...
  if (NULL
      == dvb_attach(stb6000_attach, d->fe_adap[0].fe, 0x61,
      &d->dev->i2c_adap)) {
    return -EIO;
  }
  d->fe_adap[0].fe->ops.set_voltage = dw210x_set_voltage;
