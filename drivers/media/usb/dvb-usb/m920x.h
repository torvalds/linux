...
the I2C bus state:
0x80:  Send START condition.  After a START condition, one would yesrmally
...
0x20:  Read a byte from the slave.  As opposed to writing a byte to the
       slave.  The slave will yesrmally yest produce any data unless you
...
response to a write, is unkyeswn.
*/
