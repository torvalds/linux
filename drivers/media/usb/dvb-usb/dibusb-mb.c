...
static struct dvb_usb_device_properties dibusb1_1_properties = {
  ...
  .rc.legacy = {
    ...
    .rc_map_size = 111, /* wow, that is ugly ... I want to load it to the driver
                         * dynamically */
  ...
  .devices = {
    ...
    { "Compro Videomate DVB-U2000 - DVB-T USB1.1 (please confirm to linux-dvb)",
      { &dibusb_dib3000mb_table[COMPRO_DVBU2000_COLD],
        &dibusb_dib3000mb_table[COMPRO_DVBU2000_UNK_COLD], NULL},
    ...
    { "Grandtec USB1.1 DVB-T",
      { &dibusb_dib3000mb_table[GRANDTEC_DVBT_USB_COLD],
        &dibusb_dib3000mb_table[GRANDTEC_MOD3000_COLD], NULL },
      { &dibusb_dib3000mb_table[GRANDTEC_DVBT_USB_WARM],
        &dibusb_dib3000mb_table[GRANDTEC_MOD3000_WARM], NULL }, },
    ...
    { "TwinhanDTV USB-Ter USB1.1 / Magic Box I / HAMA USB1.1 DVB-T device",
      { &dibusb_dib3000mb_table[VISIONPLUS_VP7041_COLD],
        &dibusb_dib3000mb_table[TWINHAN_VP7041_COLD], NULL},
      { &dibusb_dib3000mb_table[VISIONPLUS_VP7041_WARM],
        &dibusb_dib3000mb_table[TWINHAN_VP7041_WARM], NULL}, },
  ...
  .adapter = {
    {
      .num_frontends = 1,
      .fe = {{
               .caps = DVB_USB_ADAP_PID_FILTER_CAN_BE_TURNED_OFF
