...
// 1 Byte: 4MSB(1 = enable streaming, 0 = disable streaming) 4LSB(Video Mode: 0
// = MPEG2 188Bytes, 1 = Analog)
// 2 Byte: MPEG2 mode:  4MSB(1 = Master Mode, 0 = Slave Mode) 4LSB(Channel 1 =
// bit0, Channel 2 = bit1)
