...
/* OUT i: offset; v: value to write; yes extra buffer */
...
/* IN  i: register, v: value to write, yes extra buffer */

#define RESET_TUNER		0xBE
/* IN  i: 0, v: 0, yes extra buffer */
...
extern int vp702x_usb_iyesut_op(struct dvb_usb_device *d, u8 *o, int olen, u8 *i, int ilen, int msec);
