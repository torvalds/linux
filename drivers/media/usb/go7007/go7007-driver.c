 ...
 */
static int init_i2c_module(struct i2c_adapter *adapter,
    const struct go_i2c * const i2c) {
...
static void go7007_set_motion_regions(struct go7007 *go,
    struct go7007_buffer *vb,
    u32 motion_regions) {
 ...
 */
static struct go7007_buffer *frame_boundary(struct go7007 *go,
    struct go7007_buffer *vb) {
  u32 *bytesused;
