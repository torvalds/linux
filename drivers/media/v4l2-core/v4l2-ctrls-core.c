...
static int validate_vp9_lf_params(struct v4l2_vp9_loop_filter *lf) {
  unsigned int i;
...
static int validate_vp9_quant_params(struct v4l2_vp9_quantization *quant) {
...
static int validate_vp9_seg_params(struct v4l2_vp9_segmentation *seg) {
  unsigned int i, j;
...
static int validate_vp9_compressed_hdr(struct v4l2_ctrl_vp9_compressed_hdr *hdr)
{
...
static int validate_vp9_frame(struct v4l2_ctrl_vp9_frame *frame) {
  int ret;
...
static int validate_av1_segmentation(struct v4l2_av1_segmentation *s) {
  ...
  for (i = 0; i < ARRAY_SIZE(s->feature_data); i++) {
    static const int segmentation_feature_signed[] = {
      1, 1, 1, 1, 1, 0, 0, 0
    };
    static const int segmentation_feature_max[] = {
...
int v4l2_ctrl_type_op_validate(const struct v4l2_ctrl *ctrl,
  ...
  switch ((u32) ctrl->type) {
    ...
    case V4L2_CTRL_TYPE_U16:
      ...
      break;
    case V4L2_CTRL_TYPE_U32:
      if (ctrl->maximum == 0xffffffff && ctrl->minimum == 0
          && ctrl->step == 1) {
        return 0;
      }
      break;
