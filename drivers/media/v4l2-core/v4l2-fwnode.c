...
static const struct v4l2_fwnode_bus_conv *get_v4l2_fwnode_bus_conv_by_fwnode_bus(
    enum v4l2_fwnode_bus_type type) {
  unsigned int i;
...
static enum v4l2_mbus_type v4l2_fwnode_bus_type_to_mbus(
    enum v4l2_fwnode_bus_type type) {
...
static const char *v4l2_fwnode_bus_type_to_string(
    enum v4l2_fwnode_bus_type type) {
  const struct v4l2_fwnode_bus_conv *conv
    = get_v4l2_fwnode_bus_conv_by_fwnode_bus(type);
...
static const struct v4l2_fwnode_bus_conv *get_v4l2_fwnode_bus_conv_by_mbus(
...
static const char *v4l2_fwnode_mbus_type_to_string(enum v4l2_mbus_type type) {
  const struct v4l2_fwnode_bus_conv *conv
...
static void v4l2_fwnode_endpoint_parse_csi1_bus(struct fwnode_handle *fwnode,
    struct v4l2_fwnode_endpoint *vep,
    enum v4l2_mbus_type bus_type) {
...
static enum v4l2_connector_type v4l2_fwnode_string_to_connector_type(
    const char *con_str) {
  unsigned int i;
...
static void v4l2_fwnode_connector_parse_analog(struct fwnode_handle *fwnode,
...
static enum v4l2_connector_type v4l2_fwnode_get_connector_type(
    struct fwnode_handle *fwnode) {
 ...
 *     -ENOMEM if memory allocation failed
 */
static int v4l2_fwnode_reference_parse_int_props(struct device *dev,
    struct v4l2_async_notifier *notifier,
 ...
 *     -EINVAL if property parsing failed
 */
static int v4l2_async_nf_parse_fwnode_sensor(struct device *dev,
    struct v4l2_async_notifier *notifier) {
  static const char * const led_props[] = {
    "led"
  };
