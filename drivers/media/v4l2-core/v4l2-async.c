...
static bool match_fwnode_one(struct v4l2_async_notifier *notifier,
...
static struct v4l2_async_connection *v4l2_async_find_match(
...
static struct v4l2_device *v4l2_async_nf_find_v4l2_dev(
    struct v4l2_async_notifier *notifier) {
 ...
 */
static bool v4l2_async_nf_can_complete(struct v4l2_async_notifier *notifier) {
  struct v4l2_async_connection *asc;
 ...
 */
static int v4l2_async_nf_try_complete(struct v4l2_async_notifier *notifier) {
...
static int v4l2_async_nf_try_all_subdevs(struct v4l2_async_notifier *notifier);
...
static void v4l2_async_nf_unbind_all_subdevs(
    struct v4l2_async_notifier *notifier) {
...
static bool v4l2_async_nf_has_async_match_entry(
    struct v4l2_async_notifier *notifier,
    struct v4l2_async_match_desc *match) {
  struct v4l2_async_connection *asc;
  list_for_each_entry(asc, &notifier->waiting_list, asc_entry)
 ...
 * in a given notifier.
 */
static bool v4l2_async_nf_has_async_match(struct v4l2_async_notifier *notifier,
    struct v4l2_async_match_desc *match) {
  ...
  switch (match->type) {
    ...
    case V4L2_ASYNC_MATCH_TYPE_FWNODE:
      if (v4l2_async_nf_has_async_match(notifier, match)) {
        dev_dbg(dev,
            "v4l2-async: match descriptor already listed in a notifier\n");
        return -EEXIST;
      }
      break;
    default:
...
static void __v4l2_async_nf_unregister(struct v4l2_async_notifier *notifier) {
...
struct v4l2_async_connection *__v4l2_async_nf_add_i2c(
    struct v4l2_async_notifier *notifier, int adapter_id,
...
static const char *v4l2_async_nf_name(struct v4l2_async_notifier *notifier) {
  if (notifier->v4l2_dev) {
