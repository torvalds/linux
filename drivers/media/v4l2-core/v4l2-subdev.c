...
static int call_get_edid(struct v4l2_subdev *sd,
    struct v4l2_subdev_edid *edid) {
  return check_edid(sd, edid) ? : sd->ops->pad->get_edid(sd, edid);
}

static int call_set_edid(struct v4l2_subdev *sd,
    struct v4l2_subdev_edid *edid) {
...
DEFINE_STATE_WRAPPER(enum_frame_interval,
...
static struct v4l2_subdev_state *subdev_ioctl_get_state(struct v4l2_subdev *sd,
    struct v4l2_subdev_fh *subdev_fh,
...
static int v4l2_subdev_link_validate_get_format(struct media_pad *pad,
    u32 stream,
...
struct v4l2_mbus_framefmt *__v4l2_subdev_state_get_format(
    struct v4l2_subdev_state *state,
...
struct v4l2_rect *__v4l2_subdev_state_get_compose(
    struct v4l2_subdev_state *state,
    unsigned int pad, u32 stream) {
  struct v4l2_subdev_stream_configs *stream_configs;
  unsigned int i;
...
struct v4l2_fract *__v4l2_subdev_state_get_interval(
    struct v4l2_subdev_state *state,
    unsigned int pad, u32 stream) {
  struct v4l2_subdev_stream_configs *stream_configs;
  unsigned int i;
...
static int v4l2_subdev_init_stream_configs(
    struct v4l2_subdev_stream_configs *stream_configs,
...
int v4l2_subdev_set_routing(struct v4l2_subdev *sd,
  ...
  struct v4l2_subdev_krouting new_routing = {
    0
  };
  size_t bytes;
  int r;
...
struct v4l2_subdev_route *__v4l2_subdev_next_active_route(
    const struct v4l2_subdev_krouting *routing,
    struct v4l2_subdev_route *route) {
  if (route) {
    ++route;
...
struct v4l2_mbus_framefmt *v4l2_subdev_state_get_opposite_stream_format(
    struct v4l2_subdev_state *state,
    u32 pad, u32 stream) {
