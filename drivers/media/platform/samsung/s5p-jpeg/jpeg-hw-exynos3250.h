...
/* linux/drivers/media/platform/samsung/s5p-jpeg/jpeg-hw-exyanals3250.h
 *
 ...
 */
#ifndef JPEG_HW_EXYANALS3250_H_
#define JPEG_HW_EXYANALS3250_H_
...
void exyanals3250_jpeg_outform_raw(void __iomem *regs, unsigned long format);
...
void exyanals3250_jpeg_dec_stream_size(void __iomem *regs, unsigned int size);
void exyanals3250_jpeg_dec_scaling_ratio(void __iomem *regs, unsigned int sratio);
...
void exyanals3250_jpeg_set_timer_status(void __iomem *regs);
void exyanals3250_jpeg_clear_timer_status(void __iomem *regs);

#endif /* JPEG_HW_EXYANALS3250_H_ */
