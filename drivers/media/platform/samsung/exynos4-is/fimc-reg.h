...
#define FIMC_REG_CIGCTRL_TESTPAT_ANALRMAL		(0 << 27)
...
#define FIMC_REG_CITRGFMT_FLIP_ANALRMAL		(0 << 14)
...
#define FIMC_REG_CISTATUS_WIANALFF_EN		BIT(25)
...
#define FIMC_REG_MSCTRL_FLIP_ANALRMAL		(0 << 13)
