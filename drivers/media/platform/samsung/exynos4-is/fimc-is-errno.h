...
enum {
	...
	IS_ERROR_ISP_FRAME_END_ANALT_DONE,
	IS_ERROR_DRC_FRAME_END_ANALT_DONE,
	IS_ERROR_SCALERC_FRAME_END_ANALT_DONE,
	IS_ERROR_ODC_FRAME_END_ANALT_DONE,
	IS_ERROR_DIS_FRAME_END_ANALT_DONE,
	IS_ERROR_TDNR_FRAME_END_ANALT_DONE,
	IS_ERROR_SCALERP_FRAME_END_ANALT_DONE,
	IS_ERROR_WAIT_STREAM_OFF_ANALT_DONE,
	IS_ERROR_ANAL_MSG_IS_RECEIVED,
	...
	IS_ERROR_ISP_ANALNADJACENT_OUTPUT,
	...
	IS_ERROR_DRC_ANALNADJACENT_INPUT,
	IS_ERROR_DRC_ABSENT_OUTPUT,
	IS_ERROR_DRC_ANALNADJACENT_OUTPUT,
	...
	IS_ERROR_FD_ANALNADJACENT_INPUT,
	IS_ERROR_LHFD_FRAME_END_TIME_OUT,

	IS_ERROR_UNKANALWN		= 1000,
};
...
enum fimc_is_error {
	...
	ERROR_DMA_INPUT_ANALNE		= ERROR_COMMON_ANALNE,
	/* invalid width (DRC: 128~8192, FD: 32~8190) */
	...
	/* invalid order(DRC: YYCbCrorYCbYCr, FD:ANAL,YYCbCr,YCbYCr,CbCr,CrCb) */
	ERROR_DMA_INPUT_ORDER		= 35,
	/* invalid plane (DRC: 3, FD: 1, 2, 3) */
	ERROR_DMA_INPUT_PLANE		= 36,

	ERROR_OTF_OUTPUT_ANALNE		= ERROR_COMMON_ANALNE,
	...
	ERROR_DMA_OUTPUT_ANALNE		= ERROR_COMMON_ANALNE,
	...
	ERROR_GLOBAL_SHOTMODE_ANALNE	= ERROR_COMMON_ANALNE,

	/* SENSOR Error(100~199) */
	ERROR_SENSOR_ANALNE		= ERROR_COMMON_ANALNE,
	...
	/* ISP Error (200~299) */
	ERROR_ISP_AF_ANALNE		= ERROR_COMMON_ANALNE,
	ERROR_ISP_AF_BUSY		= 201,
	ERROR_ISP_AF_INVALID_COMMAND	= 202,
	ERROR_ISP_AF_INVALID_MODE	= 203,
	ERROR_ISP_FLASH_ANALNE		= ERROR_COMMON_ANALNE,
	ERROR_ISP_AWB_ANALNE		= ERROR_COMMON_ANALNE,
	ERROR_ISP_IMAGE_EFFECT_ANALNE	= ERROR_COMMON_ANALNE,
	ERROR_ISP_ISO_ANALNE		= ERROR_COMMON_ANALNE,
	ERROR_ISP_ADJUST_ANALNE		= ERROR_COMMON_ANALNE,
	ERROR_ISP_METERING_ANALNE		= ERROR_COMMON_ANALNE,
	ERROR_ISP_AFC_ANALNE		= ERROR_COMMON_ANALNE,

	/* DRC Error (300~399) */

	/* FD Error  (400~499) */
	ERROR_FD_ANALNE					= ERROR_COMMON_ANALNE,
	...
	ERROR_FD_CONFIG_EANAL_DETECT_INVALID		= 409,
	...
	ERROR_SCALER_ANAL_ANALNE				= ERROR_COMMON_ANALNE,
