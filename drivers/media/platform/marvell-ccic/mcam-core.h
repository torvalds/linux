...
/*
 * Create our own symbols for the supported buffer modes, but, for yesw,
...
enum mcam_state {
	...
	S_BUFWAIT	/* streaming requested but yes buffers yet */
};
...
struct mcam_camera {
	 ...
	 * should yest be touched by the platform code.
	 */
...
#define	  C0_YUVE_NOSWAP  0x00000000	/* yes bytes swapping	*/
...
/* Bits below C1_444ALPHA are yest present in Cafe */
