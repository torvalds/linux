...
static void mipi_csis_enable_interrupts(struct mipi_csis_device *csis,
    bool on) {
...
static void mipi_csis_log_counters(struct mipi_csis_device *csis,
    bool non_errors) {
...
static struct mipi_csis_device *mipi_notifier_to_csis_state(
