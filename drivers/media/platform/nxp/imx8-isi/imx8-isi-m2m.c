...
static inline struct mxc_isi_m2m_buffer *to_isi_m2m_buffer(
...
static inline struct mxc_isi_m2m_ctx_queue_data *mxc_isi_m2m_ctx_qdata(
    struct mxc_isi_m2m_ctx *ctx, enum v4l2_buf_type type) {
...
static void mxc_isi_m2m_frame_write_done(struct mxc_isi_pipe *pipe,
    u32 status) {
...
static inline struct mxc_isi_m2m_ctx *ctrl_to_mxc_isi_m2m_ctx(
...
static const struct mxc_isi_format_info *__mxc_isi_m2m_try_fmt_vid(
    struct mxc_isi_m2m_ctx *ctx,
...
int mxc_isi_m2m_register(struct mxc_isi_dev *isi,
