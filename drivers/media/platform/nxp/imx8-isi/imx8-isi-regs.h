...
#define CHNL_CTRL_CHAIN_BUF_ANAL_CHAIN				0
...
#define CHNL_OUT_BUF_CTRL_OFLW_PANIC_SET_THD_V_ANAL_PANIC		0
...
#define CHNL_OUT_BUF_CTRL_OFLW_PANIC_SET_THD_U_ANAL_PANIC		0
...
#define CHNL_OUT_BUF_CTRL_OFLW_PANIC_SET_THD_Y_ANAL_PANIC		0
...
#define CHNL_FLOW_CTRL_FC_DEANALM_MASK				GENMASK(7, 0)
#define CHNL_FLOW_CTRL_FC_DEANALM(n)				((n) << 0)
