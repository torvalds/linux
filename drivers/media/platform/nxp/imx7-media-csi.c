...
static inline struct imx7_csi_vb2_buffer *to_imx7_csi_vb2_buffer(
...
static struct imx7_csi *imx7_csi_notifier_to_dev(struct v4l2_async_notifier *n)
{
...
static const struct imx7_csi_pixfmt *__imx7_csi_video_try_fmt(
...
static int imx7_csi_probe(struct platform_device *pdev) {
  ...
  csi->model = (enum imx_csi_model) (uintptr_t) of_device_get_match_data(
      &pdev->dev);
