		...
		const struct isp2x_dpcc_cfg *arg)
{
	...
	value = rkisp_ioread32(params_vdev, ISP3X_DPCC0_MODE);
	value &= ISP_DPCC_EN;

	value |= (arg->stage1_enable & 0x01) << 2 |
		 (arg->grayscale_mode & 0x01) << 1;
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_MODE);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_MODE);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_MODE);
	...
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_OUTPUT_MODE);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_OUTPUT_MODE);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_OUTPUT_MODE);

	value = (arg->stage1_use_fix_set & 0x01) << 3 |
		(arg->stage1_use_set_3 & 0x01) << 2 |
		(arg->stage1_use_set_2 & 0x01) << 1 |
		(arg->stage1_use_set_1 & 0x01);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_SET_USE);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_SET_USE);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_SET_USE);
	...
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_METHODS_SET_1);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_METHODS_SET_1);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_METHODS_SET_1);
	...
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_METHODS_SET_2);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_METHODS_SET_2);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_METHODS_SET_2);
	...
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_METHODS_SET_3);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_METHODS_SET_3);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_METHODS_SET_3);

	value = ISP_PACK_4BYTE(arg->line_thr_1_g, arg->line_thr_1_rb,
				arg->sw_mindis1_g, arg->sw_mindis1_rb);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_LINE_THRESH_1);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_LINE_THRESH_1);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_LINE_THRESH_1);

	value = ISP_PACK_4BYTE(arg->line_mad_fac_1_g, arg->line_mad_fac_1_rb,
				arg->sw_dis_scale_max1, arg->sw_dis_scale_min1);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_LINE_MAD_FAC_1);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_LINE_MAD_FAC_1);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_LINE_MAD_FAC_1);

	value = ISP_PACK_4BYTE(arg->pg_fac_1_g, arg->pg_fac_1_rb, 0, 0);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_PG_FAC_1);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_PG_FAC_1);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_PG_FAC_1);

	value = ISP_PACK_4BYTE(arg->rnd_thr_1_g, arg->rnd_thr_1_rb, 0, 0);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_RND_THRESH_1);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_RND_THRESH_1);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_RND_THRESH_1);

	value = ISP_PACK_4BYTE(arg->rg_fac_1_g, arg->rg_fac_1_rb, 0, 0);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_RG_FAC_1);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_RG_FAC_1);
	...
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_LINE_THRESH_2);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_LINE_THRESH_2);

	value = ISP_PACK_4BYTE(arg->line_mad_fac_2_g, arg->line_mad_fac_2_rb,
				arg->sw_dis_scale_max2, arg->sw_dis_scale_min2);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_LINE_MAD_FAC_2);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_LINE_MAD_FAC_2);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_LINE_MAD_FAC_2);

	value = ISP_PACK_4BYTE(arg->pg_fac_2_g, arg->pg_fac_2_rb, 0, 0);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_PG_FAC_2);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_PG_FAC_2);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_PG_FAC_2);

	value = ISP_PACK_4BYTE(arg->rnd_thr_2_g, arg->rnd_thr_2_rb, 0, 0);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_RND_THRESH_2);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_RND_THRESH_2);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_RND_THRESH_2);

	value = ISP_PACK_4BYTE(arg->rg_fac_2_g, arg->rg_fac_2_rb, 0, 0);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_RG_FAC_2);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_RG_FAC_2);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_RG_FAC_2);

	value = ISP_PACK_4BYTE(arg->line_thr_3_g, arg->line_thr_3_rb,
				 arg->sw_mindis3_g, arg->sw_mindis3_rb);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_LINE_THRESH_3);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_LINE_THRESH_3);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_LINE_THRESH_3);

	value = ISP_PACK_4BYTE(arg->line_mad_fac_3_g, arg->line_mad_fac_3_rb,
				arg->sw_dis_scale_max3, arg->sw_dis_scale_min3);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_LINE_MAD_FAC_3);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_LINE_MAD_FAC_3);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_LINE_MAD_FAC_3);

	value = ISP_PACK_4BYTE(arg->pg_fac_3_g, arg->pg_fac_3_rb, 0, 0);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_PG_FAC_3);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_PG_FAC_3);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_PG_FAC_3);

	value = ISP_PACK_4BYTE(arg->rnd_thr_3_g, arg->rnd_thr_3_rb, 0, 0);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_RND_THRESH_3);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_RND_THRESH_3);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_RND_THRESH_3);

	value = ISP_PACK_4BYTE(arg->rg_fac_3_g, arg->rg_fac_3_rb, 0, 0);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_RG_FAC_3);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_RG_FAC_3);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_RG_FAC_3);
	...
	value = (arg->ro_lim_3_rb & 0x03) << 10 |
		...
		(arg->ro_lim_1_g & 0x03);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_RO_LIMITS);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_RO_LIMITS);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_RO_LIMITS);
	...
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_RND_OFFS);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_RND_OFFS);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_RND_OFFS);
	...
	value = (arg->bpt_rb_3x3 & 0x01) << 11 |
		...
		(arg->bpt_det_en & 0x01);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_BPT_CTRL);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_BPT_CTRL);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_BPT_CTRL);

	rkisp_iowrite32(params_vdev, arg->bp_number, ISP3X_DPCC0_BPT_NUMBER);
	rkisp_iowrite32(params_vdev, arg->bp_number, ISP3X_DPCC1_BPT_NUMBER);
	rkisp_iowrite32(params_vdev, arg->bp_number, ISP3X_DPCC2_BPT_NUMBER);
	rkisp_iowrite32(params_vdev, arg->bp_table_addr, ISP3X_DPCC0_BPT_ADDR);
	rkisp_iowrite32(params_vdev, arg->bp_table_addr, ISP3X_DPCC1_BPT_ADDR);
	rkisp_iowrite32(params_vdev, arg->bp_table_addr, ISP3X_DPCC2_BPT_ADDR);

	value = ISP_PACK_2SHORT(arg->bpt_h_addr, arg->bpt_v_addr);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_BPT_DATA);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_BPT_DATA);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_BPT_DATA);

	rkisp_iowrite32(params_vdev, arg->bp_cnt, ISP3X_DPCC0_BP_CNT);
	rkisp_iowrite32(params_vdev, arg->bp_cnt, ISP3X_DPCC1_BP_CNT);
	rkisp_iowrite32(params_vdev, arg->bp_cnt, ISP3X_DPCC2_BP_CNT);

	rkisp_iowrite32(params_vdev, arg->sw_pdaf_en, ISP3X_DPCC0_PDAF_EN);
	rkisp_iowrite32(params_vdev, arg->sw_pdaf_en, ISP3X_DPCC1_PDAF_EN);
	rkisp_iowrite32(params_vdev, arg->sw_pdaf_en, ISP3X_DPCC2_PDAF_EN);

	value = 0;
	for (i = 0; i < ISP3X_DPCC_PDAF_POINT_NUM; i++)
		value |= (arg->pdaf_point_en[i] & 0x01) << i;
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_PDAF_POINT_EN);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_PDAF_POINT_EN);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_PDAF_POINT_EN);

	value = ISP_PACK_2SHORT(arg->pdaf_offsetx, arg->pdaf_offsety);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_PDAF_OFFSET);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_PDAF_OFFSET);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_PDAF_OFFSET);

	value = ISP_PACK_2SHORT(arg->pdaf_wrapx, arg->pdaf_wrapy);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_PDAF_WRAP);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_PDAF_WRAP);
	rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_PDAF_WRAP);
	...
	for (i = 0; i < ISP3X_DPCC_PDAF_POINT_NUM / 2; i++) {
		...
		rkisp_iowrite32(params_vdev, value, ISP3X_DPCC0_PDAF_POINT_0 + 4 * i);
		rkisp_iowrite32(params_vdev, value, ISP3X_DPCC1_PDAF_POINT_0 + 4 * i);
		rkisp_iowrite32(params_vdev, value, ISP3X_DPCC2_PDAF_POINT_0 + 4 * i);
	}

	rkisp_iowrite32(params_vdev, arg->pdaf_forward_med, ISP3X_DPCC0_PDAF_FORWARD_MED);
	rkisp_iowrite32(params_vdev, arg->pdaf_forward_med, ISP3X_DPCC1_PDAF_FORWARD_MED);
	rkisp_iowrite32(params_vdev, arg->pdaf_forward_med, ISP3X_DPCC2_PDAF_FORWARD_MED);
}
	       ...
	       const struct isp21_bls_cfg *arg)
{
	...
	new_control = rkisp_ioread32(params_vdev, ISP3X_BLS_CTRL);
	...
	if (arg->bls1_en) {
		...
		case RAW_BGGR:
			rkisp_iowrite32(params_vdev, pval->r, ISP_BLS1_D_FIXED);
			rkisp_iowrite32(params_vdev, pval->gr, ISP_BLS1_C_FIXED);
			rkisp_iowrite32(params_vdev, pval->gb, ISP_BLS1_B_FIXED);
			rkisp_iowrite32(params_vdev, pval->b, ISP_BLS1_A_FIXED);
			break;
		case RAW_GBRG:
			rkisp_iowrite32(params_vdev, pval->r, ISP_BLS1_C_FIXED);
			rkisp_iowrite32(params_vdev, pval->gr, ISP_BLS1_D_FIXED);
			rkisp_iowrite32(params_vdev, pval->gb, ISP_BLS1_A_FIXED);
			rkisp_iowrite32(params_vdev, pval->b, ISP_BLS1_B_FIXED);
			break;
		case RAW_GRBG:
			rkisp_iowrite32(params_vdev, pval->r, ISP_BLS1_B_FIXED);
			rkisp_iowrite32(params_vdev, pval->gr, ISP_BLS1_A_FIXED);
			rkisp_iowrite32(params_vdev, pval->gb, ISP_BLS1_D_FIXED);
			rkisp_iowrite32(params_vdev, pval->b, ISP_BLS1_C_FIXED);
			break;
		case RAW_RGGB:
		default:
			rkisp_iowrite32(params_vdev, pval->r, ISP_BLS1_A_FIXED);
			rkisp_iowrite32(params_vdev, pval->gr, ISP_BLS1_B_FIXED);
			rkisp_iowrite32(params_vdev, pval->gb, ISP_BLS1_C_FIXED);
			rkisp_iowrite32(params_vdev, pval->b, ISP_BLS1_D_FIXED);
			break;
		}
	}
	...
	if (!arg->enable_auto) {
		switch (params_vdev->raw_type) {
		case RAW_BGGR:
			rkisp_iowrite32(params_vdev, pval->r, ISP_BLS_D_FIXED);
			rkisp_iowrite32(params_vdev, pval->gr, ISP_BLS_C_FIXED);
			rkisp_iowrite32(params_vdev, pval->gb, ISP_BLS_B_FIXED);
			rkisp_iowrite32(params_vdev, pval->b, ISP_BLS_A_FIXED);
			break;
		case RAW_GBRG:
			rkisp_iowrite32(params_vdev, pval->r, ISP_BLS_C_FIXED);
			rkisp_iowrite32(params_vdev, pval->gr, ISP_BLS_D_FIXED);
			rkisp_iowrite32(params_vdev, pval->gb, ISP_BLS_A_FIXED);
			rkisp_iowrite32(params_vdev, pval->b, ISP_BLS_B_FIXED);
			break;
		case RAW_GRBG:
			rkisp_iowrite32(params_vdev, pval->r, ISP_BLS_B_FIXED);
			rkisp_iowrite32(params_vdev, pval->gr, ISP_BLS_A_FIXED);
			rkisp_iowrite32(params_vdev, pval->gb, ISP_BLS_D_FIXED);
			rkisp_iowrite32(params_vdev, pval->b, ISP_BLS_C_FIXED);
			break;
		case RAW_RGGB:
		default:
			rkisp_iowrite32(params_vdev, pval->r, ISP_BLS_A_FIXED);
			rkisp_iowrite32(params_vdev, pval->gr, ISP_BLS_B_FIXED);
			rkisp_iowrite32(params_vdev, pval->gb, ISP_BLS_C_FIXED);
			rkisp_iowrite32(params_vdev, pval->b, ISP_BLS_D_FIXED);
			break;
		}
	} else {
		if (arg->en_windows & BIT(1)) {
			rkisp_iowrite32(params_vdev, arg->bls_window2.h_offs, ISP3X_BLS_H2_START);
			value = arg->bls_window2.h_offs + arg->bls_window2.h_size;
			rkisp_iowrite32(params_vdev, value, ISP3X_BLS_H2_STOP);
			rkisp_iowrite32(params_vdev, arg->bls_window2.v_offs, ISP3X_BLS_V2_START);
			value = arg->bls_window2.v_offs + arg->bls_window2.v_size;
			rkisp_iowrite32(params_vdev, value, ISP3X_BLS_V2_STOP);
			new_control |= ISP_BLS_WINDOW_2;
		}

		if (arg->en_windows & BIT(0)) {
			rkisp_iowrite32(params_vdev, arg->bls_window1.h_offs, ISP3X_BLS_H1_START);
			value = arg->bls_window1.h_offs + arg->bls_window1.h_size;
			rkisp_iowrite32(params_vdev, value, ISP3X_BLS_H1_STOP);
			rkisp_iowrite32(params_vdev, arg->bls_window1.v_offs, ISP3X_BLS_V1_START);
			value = arg->bls_window1.v_offs + arg->bls_window1.v_size;
			rkisp_iowrite32(params_vdev, value, ISP3X_BLS_V1_STOP);
			new_control |= ISP_BLS_WINDOW_1;
		}

		rkisp_iowrite32(params_vdev, arg->bls_samples, ISP3X_BLS_SAMPLES);

		new_control |= ISP_BLS_MODE_MEASURED;
	}
	rkisp_iowrite32(params_vdev, new_control, ISP3X_BLS_CTRL);
}
	       ...
	       const struct isp2x_sdg_cfg *arg)
{
	...
	rkisp_iowrite32(params_vdev, arg->xa_pnts.gamma_dx0, ISP3X_ISP_GAMMA_DX_LO);
	rkisp_iowrite32(params_vdev, arg->xa_pnts.gamma_dx1, ISP3X_ISP_GAMMA_DX_HI);
...
isp_lsc_matrix_cfg_sram(struct rkisp_isp_params_vdev *params_vdev,
			const struct isp3x_lsc_cfg *pconfig, bool is_direct)
{
	int i, j;
	...
	rkisp_write(params_vdev->dev, ISP3X_LSC_R_TABLE_ADDR, sram_addr, is_direct);
	rkisp_write(params_vdev->dev, ISP3X_LSC_GR_TABLE_ADDR, sram_addr, is_direct);
	rkisp_write(params_vdev->dev, ISP3X_LSC_GB_TABLE_ADDR, sram_addr, is_direct);
	rkisp_write(params_vdev->dev, ISP3X_LSC_B_TABLE_ADDR, sram_addr, is_direct);
	...
	for (i = 0; i < CIF_ISP_LSC_SECTORS_MAX * CIF_ISP_LSC_SECTORS_MAX;
		...
		for (j = 0; j < CIF_ISP_LSC_SECTORS_MAX - 1; j += 2) {
			...
			rkisp_write(params_vdev->dev, ISP3X_LSC_R_TABLE_DATA, data, is_direct);

			data = ISP_ISP_LSC_TABLE_DATA(
				pconfig->gr_data_tbl[i + j], pconfig->gr_data_tbl[i + j + 1]);
			rkisp_write(params_vdev->dev, ISP3X_LSC_GR_TABLE_DATA, data, is_direct);

			data = ISP_ISP_LSC_TABLE_DATA(
				pconfig->gb_data_tbl[i + j], pconfig->gb_data_tbl[i + j + 1]);
			rkisp_write(params_vdev->dev, ISP3X_LSC_GB_TABLE_DATA, data, is_direct);

			data = ISP_ISP_LSC_TABLE_DATA(
				pconfig->b_data_tbl[i + j], pconfig->b_data_tbl[i + j + 1]);
			rkisp_write(params_vdev->dev, ISP3X_LSC_B_TABLE_DATA, data, is_direct);
		}
		       ...
		       const struct isp3x_lsc_cfg *pconfig)
{
	...
	buf_idx = (priv_val->buf_lsclut_idx++) % ISP3X_LSC_LUT_BUF_NUM;
	...
	rkisp_iowrite32(params_vdev, data, ISP3X_MI_LUT_LSC_RD_BASE);
	rkisp_iowrite32(params_vdev, ISP3X_LSC_LUT_BUF_SIZE, ISP3X_MI_LUT_LSC_RD_WSIZE);
}
	       ...
	       const struct isp3x_lsc_cfg *arg)
{
	...
	lsc_ctrl = rkisp_ioread32(params_vdev, ISP3X_LSC_CTRL);
	isp_param_clear_bits(params_vdev, ISP3X_LSC_CTRL, ISP_LSC_EN);
	...
	for (i = 0; i < ISP3X_LSC_SIZE_TBL_SIZE / 4; i++) {
		...
		rkisp_iowrite32(params_vdev, data, ISP3X_LSC_XSIZE_01 + i * 4);
		data = CIF_ISP_LSC_SECT_SIZE(arg->x_size_tbl[i * 2 + 8],
					     arg->x_size_tbl[i * 2 + 9]);
		rkisp_iowrite32(params_vdev, data, ISP3X_LSC_XSIZE_89 + i * 4);

		/* program x grad tables */
		data = CIF_ISP_LSC_SECT_SIZE(arg->x_grad_tbl[i * 2],
					     arg->x_grad_tbl[i * 2 + 1]);
		rkisp_iowrite32(params_vdev, data, ISP3X_LSC_XGRAD_01 + i * 4);
		data = CIF_ISP_LSC_SECT_SIZE(arg->x_grad_tbl[i * 2 + 8],
					     arg->x_grad_tbl[i * 2 + 9]);
		rkisp_iowrite32(params_vdev, data, ISP3X_LSC_XGRAD_89 + i * 4);

		/* program y size tables */
		data = CIF_ISP_LSC_SECT_SIZE(arg->y_size_tbl[i * 2],
					     arg->y_size_tbl[i * 2 + 1]);
		rkisp_iowrite32(params_vdev, data, ISP3X_LSC_YSIZE_01 + i * 4);
		data = CIF_ISP_LSC_SECT_SIZE(arg->y_size_tbl[i * 2 + 8],
					     arg->y_size_tbl[i * 2 + 9]);
		rkisp_iowrite32(params_vdev, data, ISP3X_LSC_YSIZE_89 + i * 4);

		/* program y grad tables */
		data = CIF_ISP_LSC_SECT_SIZE(arg->y_grad_tbl[i * 2],
					     arg->y_grad_tbl[i * 2 + 1]);
		rkisp_iowrite32(params_vdev, data, ISP3X_LSC_YGRAD_01 + i * 4);
		data = CIF_ISP_LSC_SECT_SIZE(arg->y_grad_tbl[i * 2 + 8],
					     arg->y_grad_tbl[i * 2 + 9]);
		rkisp_iowrite32(params_vdev, data, ISP3X_LSC_YGRAD_89 + i * 4);
	}
	...
	if (lsc_ctrl & ISP_LSC_EN) {
		...
		isp_param_set_bits(params_vdev, ISP3X_LSC_CTRL, lsc_ctrl);
	}
...
isp_lsc_enable(struct rkisp_isp_params_vdev *params_vdev, bool en)
{
	...
	if (en) {
		isp_param_set_bits(params_vdev, ISP3X_LSC_CTRL, val);
	} else {
		isp_param_clear_bits(params_vdev, ISP3X_LSC_CTRL, ISP_LSC_EN);
		isp_param_clear_bits(params_vdev, ISP3X_GAIN_CTRL, BIT(8));
	}
}
		   ...
		   const struct isp2x_debayer_cfg *arg)
{
	...
	value = rkisp_ioread32(params_vdev, ISP3X_DEBAYER_CONTROL);
	value &= ISP_DEBAYER_EN;

	value |= (arg->filter_c_en & 0x01) << 8 |
		 (arg->filter_g_en & 0x01) << 4;
	rkisp_iowrite32(params_vdev, value, ISP3X_DEBAYER_CONTROL);
	...
	value = (arg->thed1 & 0x0F) << 12 |
		...
		(arg->clip_en & 0x01);
	rkisp_iowrite32(params_vdev, value, ISP3X_DEBAYER_G_INTERP);
	...
	rkisp_iowrite32(params_vdev, value, ISP3X_DEBAYER_G_INTERP_FILTER1);
	...
	rkisp_iowrite32(params_vdev, value, ISP3X_DEBAYER_G_INTERP_FILTER2);

	value = (arg->hf_offset & 0xFFFF) << 16 |
		(arg->gain_offset & 0x0F) << 8 |
		(arg->offset & 0x1F);
	rkisp_iowrite32(params_vdev, value, ISP3X_DEBAYER_OFFSET);

	value = (arg->shift_num & 0x03) << 16 |
		(arg->order_max & 0x1F) << 8 |
		(arg->order_min & 0x1F);
	rkisp_iowrite32(params_vdev, value, ISP3X_DEBAYER_C_FILTER);
}
...
{
	if (en)
		isp_param_set_bits(params_vdev, ISP3X_ISP_CTRL0,
				   CIF_ISP_CTRL_ISP_AWB_ENA);
	else
		isp_param_clear_bits(params_vdev, ISP3X_ISP_CTRL0,
				     CIF_ISP_CTRL_ISP_AWB_ENA);
}
	       ...
	       const struct isp21_ccm_cfg *arg)
{
	...
	value = rkisp_ioread32(params_vdev, ISP3X_CCM_CTRL);
	value &= ISP_CCM_EN;

	value |= (arg->highy_adjust_dis & 0x01) << 1;
	rkisp_iowrite32(params_vdev, value, ISP3X_CCM_CTRL);

	value = ISP_PACK_2SHORT(arg->coeff0_r, arg->coeff1_r);
	rkisp_iowrite32(params_vdev, value, ISP3X_CCM_COEFF0_R);

	value = ISP_PACK_2SHORT(arg->coeff2_r, arg->offset_r);
	rkisp_iowrite32(params_vdev, value, ISP3X_CCM_COEFF1_R);

	value = ISP_PACK_2SHORT(arg->coeff0_g, arg->coeff1_g);
	rkisp_iowrite32(params_vdev, value, ISP3X_CCM_COEFF0_G);

	value = ISP_PACK_2SHORT(arg->coeff2_g, arg->offset_g);
	rkisp_iowrite32(params_vdev, value, ISP3X_CCM_COEFF1_G);

	value = ISP_PACK_2SHORT(arg->coeff0_b, arg->coeff1_b);
	rkisp_iowrite32(params_vdev, value, ISP3X_CCM_COEFF0_B);

	value = ISP_PACK_2SHORT(arg->coeff2_b, arg->offset_b);
	rkisp_iowrite32(params_vdev, value, ISP3X_CCM_COEFF1_B);

	value = ISP_PACK_2SHORT(arg->coeff0_y, arg->coeff1_y);
	rkisp_iowrite32(params_vdev, value, ISP3X_CCM_COEFF0_Y);

	value = ISP_PACK_2SHORT(arg->coeff2_y, 0);
	rkisp_iowrite32(params_vdev, value, ISP3X_CCM_COEFF1_Y);

	for (i = 0; i < ISP3X_CCM_CURVE_NUM / 2; i++) {
		value = ISP_PACK_2SHORT(arg->alp_y[2 * i], arg->alp_y[2 * i + 1]);
		rkisp_iowrite32(params_vdev, value, ISP3X_CCM_ALP_Y0 + 4 * i);
	}
	value = ISP_PACK_2SHORT(arg->alp_y[2 * i], 0);
	rkisp_iowrite32(params_vdev, value, ISP3X_CCM_ALP_Y0 + 4 * i);

	value = arg->bound_bit & 0x0F;
	rkisp_iowrite32(params_vdev, value, ISP3X_CCM_BOUND_BIT);
}
...
{
	if (en)
		isp_param_set_bits(params_vdev, ISP3X_CCM_CTRL, ISP_CCM_EN);
	else
		isp_param_clear_bits(params_vdev, ISP3X_CCM_CTRL, ISP_CCM_EN);
}
	       ...
	       const struct isp3x_gammaout_cfg *arg)
{
	...
	value = rkisp_ioread32(params_vdev, ISP3X_GAMMA_OUT_CTRL);
	value &= ISP3X_GAMMA_OUT_EN;
	value |= (arg->equ_segm & 0x1) << 1 |
		(arg->finalx4_dense_en & 0x1) << 2;
	rkisp_iowrite32(params_vdev, value, ISP3X_GAMMA_OUT_CTRL);

	rkisp_iowrite32(params_vdev, arg->offset, ISP3X_GAMMA_OUT_OFFSET);
	for (i = 0; i < ISP3X_GAMMA_OUT_MAX_SAMPLES / 2; i++) {
		value = ISP_PACK_2SHORT(arg->gamma_y[2 * i],
					arg->gamma_y[2 * i + 1]);
		rkisp_iowrite32(params_vdev, value, ISP3X_GAMMA_OUT_Y0 + i * 4);
	}
	rkisp_iowrite32(params_vdev, arg->gamma_y[2 * i], ISP3X_GAMMA_OUT_Y0 + i * 4);
}
...
{
	if (en)
		isp_param_set_bits(params_vdev, ISP3X_GAMMA_OUT_CTRL,
				   ISP3X_GAMMA_OUT_EN);
	else
		isp_param_clear_bits(params_vdev, ISP3X_GAMMA_OUT_CTRL,
				     ISP3X_GAMMA_OUT_EN);
}
...
{
	struct isp3x_isp_other_cfg *cur_other_cfg =
		&params_vdev->isp3x_params->others;
	struct isp2x_ie_cfg *cur_ie_config = &cur_other_cfg->ie_cfg;
	u32 effect = cur_ie_config->effect;
	u32 quantization = params_vdev->quantization;

	rkisp_iowrite32(params_vdev, arg->contrast, ISP3X_CPROC_CONTRAST);
	rkisp_iowrite32(params_vdev, arg->hue, ISP3X_CPROC_HUE);
	rkisp_iowrite32(params_vdev, arg->sat, ISP3X_CPROC_SATURATION);
	rkisp_iowrite32(params_vdev, arg->brightness, ISP3X_CPROC_BRIGHTNESS);

	if (quantization != V4L2_QUANTIZATION_FULL_RANGE ||
	    effect != V4L2_COLORFX_NONE) {
		isp_param_clear_bits(params_vdev, ISP3X_CPROC_CTRL,
				     CIF_C_PROC_YOUT_FULL |
				     CIF_C_PROC_YIN_FULL |
				     CIF_C_PROC_COUT_FULL);
	} else {
		isp_param_set_bits(params_vdev, ISP3X_CPROC_CTRL,
				   CIF_C_PROC_YOUT_FULL |
				   CIF_C_PROC_YIN_FULL |
				   CIF_C_PROC_COUT_FULL);
	}
...
isp_cproc_enable(struct rkisp_isp_params_vdev *params_vdev, bool en)
{
	if (en)
		isp_param_set_bits(params_vdev,
			ISP3X_CPROC_CTRL, CIF_C_PROC_CTR_ENABLE);
	else
		isp_param_clear_bits(params_vdev,
			ISP3X_CPROC_CTRL, CIF_C_PROC_CTR_ENABLE);
}
	      ...
	      const struct isp2x_ie_cfg *arg)
{
	...
	eff_ctrl = rkisp_ioread32(params_vdev, ISP3X_IMG_EFF_CTRL);
	...
	case V4L2_COLORFX_SET_CBCR:
		rkisp_iowrite32(params_vdev, arg->eff_tint, ISP3X_IMG_EFF_TINT);
		eff_ctrl |= CIF_IMG_EFF_CTRL_MODE_SEPIA;
		break;
		/*
	...
	rkisp_iowrite32(params_vdev, eff_ctrl, ISP3X_IMG_EFF_CTRL);
}
...
{
	if (en) {
		isp_param_set_bits(params_vdev, ISP3X_IMG_EFF_CTRL,
			CIF_IMG_EFF_CTRL_CFG_UPD | CIF_IMG_EFF_CTRL_ENABLE);
	} else {
		isp_param_clear_bits(params_vdev, ISP3X_IMG_EFF_CTRL,
		 ...
		 const struct isp3x_rawaf_meas_cfg *arg)
{
	...
	rkisp_iowrite32(params_vdev, var, ISP3X_RAWAF_INT_LINE);

	var = rkisp_ioread32(params_vdev, ISP3X_RAWAF_THRES);
	var &= ~0xFFFF;
	var |= arg->afm_thres;
	rkisp_iowrite32(params_vdev, var, ISP3X_RAWAF_THRES);

	var = (arg->lum_var_shift[1] & 0x7) << 20 | (arg->lum_var_shift[0] & 0x7) << 16 |
		(arg->afm_var_shift[1] & 0x7) << 4 | (arg->afm_var_shift[0] & 0x7);
	rkisp_iowrite32(params_vdev, var, ISP3X_RAWAF_VAR_SHIFT);

	for (i = 0; i < ISP3X_RAWAF_GAMMA_NUM / 2; i++) {
		var = ISP_PACK_2SHORT(arg->gamma_y[2 * i], arg->gamma_y[2 * i + 1]);
		rkisp_iowrite32(params_vdev, var, ISP3X_RAWAF_GAMMA_Y0 + i * 4);
	}
	var = ISP_PACK_2SHORT(arg->gamma_y[16], 0);
	rkisp_iowrite32(params_vdev, var, ISP3X_RAWAF_GAMMA_Y8);

	var = (arg->v2iir_var_shift & 0x7) << 12 | (arg->v1iir_var_shift & 0x7) << 8 |
		(arg->h2iir_var_shift & 0x7) << 4 | (arg->h1iir_var_shift & 0x7);
	rkisp_iowrite32(params_vdev, var, ISP3X_RAWAF_HVIIR_VAR_SHIFT);

	var = ISP_PACK_2SHORT(arg->h_fv_thresh, arg->v_fv_thresh);
	rkisp_iowrite32(params_vdev, var, ISP3X_RAWAF_HIIR_THRESH);

	for (i = 0; i < ISP3X_RAWAF_VFIR_COE_NUM; i++) {
		var = ISP_PACK_2SHORT(arg->v1fir_coe[i], arg->v2fir_coe[i]);
		rkisp_iowrite32(params_vdev, var, ISP3X_RAWAF_V_FIR_COE0 + i * 4);
	}

	rkisp_iowrite32(params_vdev, arg->highlit_thresh, ISP3X_RAWAF_HIGHLIT_THRESH);

	ctrl = rkisp_ioread32(params_vdev, ISP3X_RAWAF_CTRL);
	ctrl &= ISP3X_RAWAF_EN;
	if (arg->hiir_en) {
		...
		for (i = 0; i < ISP3X_RAWAF_HIIR_COE_NUM / 2; i++) {
			...
			rkisp_iowrite32(params_vdev, var, ISP3X_RAWAF_H1_IIR1_COE01 + i * 4);
			var = ISP_PACK_2SHORT(arg->h1iir2_coe[i * 2], arg->h1iir2_coe[i * 2 + 1]);
			rkisp_iowrite32(params_vdev, var, ISP3X_RAWAF_H1_IIR2_COE01 + i * 4);
			var = ISP_PACK_2SHORT(arg->h2iir1_coe[i * 2], arg->h2iir1_coe[i * 2 + 1]);
			rkisp_iowrite32(params_vdev, var, ISP3X_RAWAF_H2_IIR1_COE01 + i * 4);
			var = ISP_PACK_2SHORT(arg->h2iir2_coe[i * 2], arg->h2iir2_coe[i * 2 + 1]);
			rkisp_iowrite32(params_vdev, var, ISP3X_RAWAF_H2_IIR2_COE01 + i * 4);
		}
	}
	if (arg->viir_en) {
		...
		for (i = 0; i < ISP3X_RAWAF_V2IIR_COE_NUM; i++) {
			...
			rkisp_iowrite32(params_vdev, var, ISP3X_RAWAF_V_IIR_COE0 + i * 4);
		}
	...
	ctrl |= (arg->y_mode & 0x1) << 13 |
		...
		(arg->gaus_en & 0x1) << 2 |
		(arg->gamma_en & 0x1) << 1;
	rkisp_iowrite32(params_vdev, ctrl, ISP3X_RAWAF_CTRL);

	ctrl = rkisp_ioread32(params_vdev, ISP3X_VI_ISP_PATH);
	ctrl &= ~(ISP3X_RAWAF_SEL(3));
	ctrl |= ISP3X_RAWAF_SEL(arg->rawaf_sel);
	rkisp_iowrite32(params_vdev, ctrl, ISP3X_VI_ISP_PATH);
}

static void
isp_rawaf_enable(struct rkisp_isp_params_vdev *params_vdev, bool en)
{
	u32 afm_ctrl = rkisp_ioread32(params_vdev, ISP3X_RAWAF_CTRL);
	...
	rkisp_iowrite32(params_vdev, afm_ctrl, ISP3X_RAWAF_CTRL);
}
		     ...
		     const struct isp2x_rawaelite_meas_cfg *arg)
{
	...
	value = rkisp_ioread32(params_vdev, ISP3X_RAWAE_LITE_CTRL);
	...
	rkisp_iowrite32(params_vdev, value, ISP3X_RAWAE_LITE_CTRL);
	...
	value = rkisp_ioread32(params_vdev, ISP3X_VI_ISP_PATH);
	value &= ~(ISP3X_RAWAE012_SEL(3));
	value |= ISP3X_RAWAE012_SEL(arg->rawae_sel);
	rkisp_iowrite32(params_vdev, value, ISP3X_VI_ISP_PATH);
}
...
isp_rawaelite_enable(struct rkisp_isp_params_vdev *params_vdev, bool en)
{
	...
	exp_ctrl = rkisp_ioread32(params_vdev, ISP3X_RAWAE_LITE_CTRL);
	...
	rkisp_iowrite32(params_vdev, exp_ctrl, ISP3X_RAWAE_LITE_CTRL);
}
		    ...
		    const struct isp2x_rawaebig_meas_cfg *arg, u32 blk_no)
{
	...
	value = rkisp_ioread32(params_vdev, addr + ISP3X_RAWAE_BIG_CTRL);
	...
	rkisp_iowrite32(params_vdev, value, addr + ISP3X_RAWAE_BIG_CTRL);
		    ...
		    bool en, u32 blk_no)
{
	...
	exp_ctrl = rkisp_ioread32(params_vdev, addr + ISP3X_RAWAE_BIG_CTRL);
	exp_ctrl &= ~ISP3X_REG_WR_MASK;
	if (en)
	...
	rkisp_iowrite32(params_vdev, exp_ctrl, addr + ISP3X_RAWAE_BIG_CTRL);
}
		  ...
		  const struct isp3x_rawawb_meas_cfg *arg)
{
	...
	rkisp_iowrite32(params_vdev,
			...
			ISP3X_RAWAWB_WEIGHT_CURVE_CTRL);
	...
	rkisp_iowrite32(params_vdev,
			...
			ISP3X_RAWAWB_MULTIWINDOW_EXC_CTRL);
	...
	/* avoid to override the old enable value */
	value = rkisp_ioread32(params_vdev, ISP3X_RAWAWB_CTRL);
...
isp_rawawb_enable(struct rkisp_isp_params_vdev *params_vdev, bool en)
{
	...
	awb_ctrl = rkisp_ioread32(params_vdev, ISP3X_RAWAWB_CTRL);
	...
	rkisp_iowrite32(params_vdev, awb_ctrl, ISP3X_RAWAWB_CTRL);
}
		      ...
		      const struct isp2x_rawhistlite_cfg *arg)
{
	...
	/* avoid to override the old enable value */
	hist_ctrl = rkisp_ioread32(params_vdev, ISP3X_RAWHIST_LITE_CTRL);
	...
	rkisp_iowrite32(params_vdev, hist_ctrl, ISP3X_RAWHIST_LITE_CTRL);
		     ...
		     const struct isp2x_rawhistbig_cfg *arg, u32 blk_no)
{
	...
	/* avoid to override the old enable value */
	hist_ctrl = rkisp_ioread32(params_vdev, addr + ISP3X_RAWHIST_BIG_CTRL);
	hist_ctrl &= ISP3X_RAWHIST_EN;
	hist_ctrl = hist_ctrl |
		    ISP3X_RAWHIST_MODE(arg->mode) |
		    ISP3X_RAWHIST_DATASEL(arg->data_sel) |
		    ...
		    ISP3X_RAWHIST_STEPSIZE(arg->stepsize);
	rkisp_iowrite32(params_vdev, hist_ctrl, addr + ISP3X_RAWHIST_BIG_CTRL);
	...
	rkisp_iowrite32(params_vdev, ISP3X_RAWHIST_RAM_EN, ISP3X_RAWHIST_BIG_WRAM_CTRL);
	hist_weight_num = ISP3X_RAWHISTBIG_WEIGHT_REG_SIZE;
		  ...
		  const struct isp3x_hdrmge_cfg *arg, enum rkisp_params_type type)
{
	...
	if (type == RKISP_PARAMS_SHD || type == RKISP_PARAMS_ALL) {
		...
		rkisp_iowrite32(params_vdev, value, ISP3X_HDRMGE_GAIN0);

		value = ISP_PACK_2SHORT(arg->gain1, arg->gain1_inv);
		rkisp_iowrite32(params_vdev, value, ISP3X_HDRMGE_GAIN1);

		value = arg->gain2;
		rkisp_iowrite32(params_vdev, value, ISP3X_HDRMGE_GAIN2);

		if (arg->s_base) {
			value = rkisp_read_reg_cache(params_vdev->dev, ISP3X_HDRMGE_CTRL);
			value |= BIT(1);
			rkisp_iowrite32(params_vdev, value, ISP3X_HDRMGE_CTRL);
		}
	}
	...
	if (type == RKISP_PARAMS_IMD || type == RKISP_PARAMS_ALL) {
		...
		rkisp_iowrite32(params_vdev, value, ISP3X_HDRMGE_LIGHTZ);
		value = (arg->ms_scl & 0x7ff) |
			(arg->ms_thd0 & 0x3ff) << 12 |
			(arg->ms_thd1 & 0x3ff) << 22;
		rkisp_iowrite32(params_vdev, value, ISP3X_HDRMGE_MS_DIFF);
		value = (arg->lm_scl & 0x7ff) |
			(arg->lm_thd0 & 0x3ff) << 12 |
			(arg->lm_thd1 & 0x3ff) << 22;
		rkisp_iowrite32(params_vdev, value, ISP3X_HDRMGE_LM_DIFF);

		for (i = 0; i < ISP3X_HDRMGE_L_CURVE_NUM; i++) {
			value = ISP_PACK_2SHORT(arg->curve.curve_0[i], arg->curve.curve_1[i]);
			rkisp_iowrite32(params_vdev, value, ISP3X_HDRMGE_DIFF_Y0 + 4 * i);
		}

		for (i = 0; i < ISP3X_HDRMGE_E_CURVE_NUM; i++) {
			value = arg->e_y[i];
			rkisp_iowrite32(params_vdev, value, ISP3X_HDRMGE_OVER_Y0 + 4 * i);
		}
	}
}
		  ...
		  const struct isp3x_drc_cfg *arg, enum rkisp_params_type type)
{
	...
	for (i = 0; i < ISP3X_DRC_Y_NUM / 2; i++) {
		value = ISP_PACK_2SHORT(arg->compres_y[2 * i],
					arg->compres_y[2 * i + 1]);
		rkisp_iowrite32(params_vdev, value, ISP3X_DRC_COMPRES_Y0 + 4 * i);
	}
	...
	for (i = 0; i < ISP3X_DRC_Y_NUM / 2; i++) {
		value = ISP_PACK_2SHORT(arg->scale_y[2 * i],
					arg->scale_y[2 * i + 1]);
		rkisp_iowrite32(params_vdev, value, ISP3X_DRC_SCALE_Y0 + 4 * i);
	}
	value = ISP_PACK_2SHORT(arg->scale_y[2 * i], 0);
	rkisp_iowrite32(params_vdev, value, ISP3X_DRC_SCALE_Y0 + 4 * i);

	value = ISP_PACK_2SHORT(arg->min_ogain, arg->iir_weight);
	rkisp_iowrite32(params_vdev, value, ISP3X_DRC_IIRWG_GAIN);
}
...
isp_hdrdrc_enable(struct rkisp_isp_params_vdev *params_vdev, bool en)
{
	...
	value = rkisp_ioread32(params_vdev, ISP3X_DRC_CTRL0);
	...
	if (en) {
		value |= ISP3X_MODULE_EN;
		rkisp_set_bits(params_vdev->dev, ISP3X_ISP_CTRL1,
			       ISP3X_ADRC_FST_FRAME, ISP3X_ADRC_FST_FRAME, false);
	} else {
		value = 0;
		isp_param_clear_bits(params_vdev, ISP3X_GAIN_CTRL, BIT(12));
	}
	rkisp_iowrite32(params_vdev, value, ISP3X_DRC_CTRL0);
}
	       ...
	       const struct isp21_gic_cfg *arg)
{
	...
	rkisp_iowrite32(params_vdev, value, ISP3X_GIC_DIFF_PARA1);

	value = (arg->regdarkthre & 0x07FF) << 21 |
		(arg->regmaxcorvboth & 0x03FF) << 11 |
		(arg->regdarktthrehi & 0x07FF);
	rkisp_iowrite32(params_vdev, value, ISP3X_GIC_DIFF_PARA2);
	...
	value = (arg->regkgrad2dark & 0x0F) << 28 |
		...
		(arg->reggbthre & 0x0F);
	rkisp_iowrite32(params_vdev, value, ISP3X_GIC_DIFF_PARA3);

	value = (arg->regmaxcorv & 0x03FF) << 20 |
		(arg->regmingradthr2 & 0x03FF) << 10 |
		(arg->regmingradthr1 & 0x03FF);
	rkisp_iowrite32(params_vdev, value, ISP3X_GIC_DIFF_PARA4);

	value = (arg->gr_ratio & 0x03) << 28 |
		(arg->noise_scale & 0x7F) << 12 |
		(arg->noise_base & 0xFFF);
	rkisp_iowrite32(params_vdev, value, ISP3X_GIC_NOISE_PARA1);

	rkisp_iowrite32(params_vdev, arg->diff_clip, ISP3X_GIC_NOISE_PARA2);

	for (i = 0; i < ISP3X_GIC_SIGMA_Y_NUM / 2; i++) {
		value = ISP_PACK_2SHORT(arg->sigma_y[2 * i], arg->sigma_y[2 * i + 1]);
		rkisp_iowrite32(params_vdev, value, ISP3X_GIC_SIGMA_VALUE0 + 4 * i);
	}
...
isp_gic_enable(struct rkisp_isp_params_vdev *params_vdev, bool en)
{
	...
	if (en)
		value |= ISP3X_MODULE_EN;
	rkisp_iowrite32(params_vdev, value, ISP3X_GIC_CONTROL);
}
		...
		const struct isp3x_dhaz_cfg *arg)
{
	...
	ctrl = rkisp_ioread32(params_vdev, ISP3X_DHAZ_CTRL);
	...
	for (i = 0; i < ISP3X_DHAZ_SIGMA_IDX_NUM / 4; i++) {
		...
		rkisp_iowrite32(params_vdev, value, ISP3X_DHAZ_GAIN_IDX0 + i * 4);
	}
	value = ISP_PACK_4BYTE(arg->sigma_idx[i * 4], arg->sigma_idx[i * 4 + 1],
	...
	for (i = 0; i < ISP3X_DHAZ_SIGMA_LUT_NUM / 2; i++) {
		...
		rkisp_iowrite32(params_vdev, value, ISP3X_DHAZ_GAIN_LUT0 + i * 4);
	}
...
isp_dhaz_enable(struct rkisp_isp_params_vdev *params_vdev, bool en)
{
	...
	value = rkisp_ioread32(params_vdev, ISP3X_DHAZ_CTRL);
	...
	if (en) {
		...
		rkisp_set_bits(params_vdev->dev, ISP3X_ISP_CTRL1,
			       ISP3X_DHAZ_FST_FRAME, ISP3X_DHAZ_FST_FRAME, false);
	} else {
		value &= ~ISP3X_DHAZ_ENMUX;
		isp_param_clear_bits(params_vdev, ISP3X_GAIN_CTRL, BIT(16));
	}

	rkisp_iowrite32(params_vdev, value, ISP3X_DHAZ_CTRL);
}
		 ...
		 const struct isp2x_3dlut_cfg *arg)
{
	...
	priv_val = (struct rkisp_isp_params_val_v3x *)params_vdev->priv_val;
	buf_idx = (priv_val->buf_3dlut_idx++) % ISP3X_3DLUT_BUF_NUM;
	...
	rkisp_iowrite32(params_vdev, value, ISP3X_MI_LUT_3D_RD_BASE);
	rkisp_iowrite32(params_vdev, arg->actual_size, ISP3X_MI_LUT_3D_RD_WSIZE);

	value = rkisp_ioread32(params_vdev, ISP3X_3DLUT_CTRL);
	value &= ISP3X_3DLUT_EN;

	if (value)
		isp_param_set_bits(params_vdev, ISP3X_3DLUT_UPDATE, 0x01);

	rkisp_iowrite32(params_vdev, value, ISP3X_3DLUT_CTRL);
}
...
isp_3dlut_enable(struct rkisp_isp_params_vdev *params_vdev, bool en)
{
	...
	if (en) {
		isp_param_set_bits(params_vdev, ISP3X_3DLUT_CTRL, 0x01);
		isp_param_set_bits(params_vdev, ISP3X_3DLUT_UPDATE, 0x01);
	} else {
		isp_param_clear_bits(params_vdev, ISP3X_3DLUT_CTRL, 0x01);
		isp_param_clear_bits(params_vdev, ISP3X_3DLUT_UPDATE, 0x01);
		isp_param_clear_bits(params_vdev, ISP3X_GAIN_CTRL, BIT(20));
	}
}
		...
		const struct isp2x_ldch_cfg *arg)
{
	...
	rkisp_iowrite32(params_vdev, value, ISP3X_MI_LUT_LDCH_RD_BASE);
	rkisp_iowrite32(params_vdev, arg->hsize, ISP3X_MI_LUT_LDCH_RD_H_WSIZE);
	rkisp_iowrite32(params_vdev, arg->vsize, ISP3X_MI_LUT_LDCH_RD_V_SIZE);
}
...
isp_ldch_enable(struct rkisp_isp_params_vdev *params_vdev, bool en)
{
	...
	if (en) {
		...
		isp_param_set_bits(params_vdev, ISP3X_LDCH_STS, 0x01);
	} else {
		isp_param_clear_bits(params_vdev, ISP3X_LDCH_STS, 0x01);
	}
}
	       ...
	       const struct isp3x_ynr_cfg *arg)
{
	...
	value = rkisp_ioread32(params_vdev, ISP3X_YNR_GLOBAL_CTRL);
	value &= ISP3X_MODULE_EN;
	...
	rkisp_iowrite32(params_vdev, value, ISP3X_YNR_GLOBAL_CTRL);

	value = ISP_PACK_2SHORT(arg->rnr_max_r, arg->local_gainscale);
	rkisp_iowrite32(params_vdev, value, ISP3X_YNR_RNR_MAX_R);

	value = ISP_PACK_2SHORT(arg->rnr_center_coorh, arg->rnr_center_coorv);
	rkisp_iowrite32(params_vdev, value, ISP3X_YNR_RNR_CENTER_COOR);

	value = ISP_PACK_2SHORT(arg->loclagain_adj_thresh, arg->localgain_adj);
	rkisp_iowrite32(params_vdev, value, ISP3X_YNR_LOCAL_GAIN_CTRL);

	value = ISP_PACK_2SHORT(arg->low_bf_inv0, arg->low_bf_inv1);
	rkisp_iowrite32(params_vdev, value, ISP3X_YNR_LOWNR_CTRL0);

	value = ISP_PACK_2SHORT(arg->low_thred_adj, arg->low_peak_supress);
	rkisp_iowrite32(params_vdev, value, ISP3X_YNR_LOWNR_CTRL1);

	value = ISP_PACK_2SHORT(arg->low_edge_adj_thresh, arg->low_dist_adj);
	rkisp_iowrite32(params_vdev, value, ISP3X_YNR_LOWNR_CTRL2);

	value = (arg->low_bi_weight & 0xFF) << 24 |
		(arg->low_weight & 0xFF) << 16 |
		(arg->low_center_weight & 0xFFFF);
	rkisp_iowrite32(params_vdev, value, ISP3X_YNR_LOWNR_CTRL3);
	...
	for (i = 0; i < ISP3X_YNR_XY_NUM / 2; i++) {
		value = ISP_PACK_2SHORT(arg->lsgm_y[2 * i],
					arg->lsgm_y[2 * i + 1]);
		rkisp_iowrite32(params_vdev, value, ISP3X_YNR_LSGM_Y_0_1 + 4 * i);
	}
	...
	for (i = 0; i < ISP3X_YNR_XY_NUM / 2; i++) {
		value = ISP_PACK_2SHORT(arg->hsgm_y[2 * i],
					arg->hsgm_y[2 * i + 1]);
		rkisp_iowrite32(params_vdev, value, ISP3X_YNR_HSGM_Y_0_1 + 4 * i);
	}
	...
	for (i = 0; i < ISP3X_YNR_XY_NUM / 4; i++) {
		...
		rkisp_iowrite32(params_vdev, value, ISP3X_YNR_RNR_STRENGTH03 + 4 * i);
	}
	       ...
	       bool en, const struct isp3x_ynr_cfg *arg)
{
	...
	ynr_ctrl = rkisp_ioread32(params_vdev, ISP3X_YNR_GLOBAL_CTRL);
	...
	if (en) {
		value |= ISP3X_MODULE_EN;
		rkisp_set_bits(params_vdev->dev, ISP3X_ISP_CTRL1,
			       ISP3X_YNR_FST_FRAME, ISP3X_YNR_FST_FRAME, false);
	}
	       ...
	       const struct isp3x_cnr_cfg *arg)
{
	...
	value = rkisp_ioread32(params_vdev, ISP3X_CNR_CTRL);
	value &= ISP3X_MODULE_EN;
	...
	rkisp_iowrite32(params_vdev, value, ISP3X_CNR_CTRL);

	value = (arg->global_gain & 0x3ff) |
		(arg->global_gain_alpha & 0xf) << 12;
	rkisp_iowrite32(params_vdev, value, ISP3X_CNR_EXGAIN);

	value = ISP_PACK_4BYTE(arg->gain_1sigma, arg->gain_offset,
				arg->gain_iso, 0);
	rkisp_iowrite32(params_vdev, value, ISP3X_CNR_GAIN_PARA);

	value = ISP_PACK_4BYTE(arg->gain_uvgain0, arg->gain_uvgain1, 0, 0);
	rkisp_iowrite32(params_vdev, value, ISP3X_CNR_GAIN_UV_PARA);

	rkisp_iowrite32(params_vdev, arg->lmed3_alpha, ISP3X_CNR_LMED3);

	value = ISP_PACK_4BYTE(arg->lbf5_gain_c, arg->lbf5_gain_y, 0, 0);
	rkisp_iowrite32(params_vdev, value, ISP3X_CNR_LBF5_GAIN);

	value = ISP_PACK_4BYTE(arg->lbf5_weit_d0, arg->lbf5_weit_d1,
				arg->lbf5_weit_d2, arg->lbf5_weit_d3);
	rkisp_iowrite32(params_vdev, value, ISP3X_CNR_LBF5_WEITD0_3);

	rkisp_iowrite32(params_vdev, arg->lbf5_weit_d4, ISP3X_CNR_LBF5_WEITD4);

	rkisp_iowrite32(params_vdev, arg->hmed3_alpha, ISP3X_CNR_HMED3);

	value = (arg->hbf5_weit_src & 0xFF) << 24 |
		(arg->hbf5_min_wgt & 0xFF) << 16 |
		(arg->hbf5_sigma & 0xFFFF);
	rkisp_iowrite32(params_vdev, value, ISP3X_CNR_HBF5);

	value = ISP_PACK_2SHORT(arg->lbf3_sigma, arg->lbf5_weit_src);
	rkisp_iowrite32(params_vdev, value, ISP3X_CNR_LBF3);
	...
	for (i = 0; i < ISP3X_CNR_SIGMA_Y_NUM / 4; i++) {
		...
		rkisp_iowrite32(params_vdev, value, ISP3X_CNR_SIGMA0 + i * 4);
	}
	       ...
	       bool en, const struct isp3x_cnr_cfg *arg)
{
	...
	cnr_ctrl = rkisp_ioread32(params_vdev, ISP3X_CNR_CTRL);
	...
	if (en) {
		value |= ISP3X_MODULE_EN;
		rkisp_set_bits(params_vdev->dev, ISP3X_ISP_CTRL1,
			       ISP3X_CNR_FST_FRAME, ISP3X_CNR_FST_FRAME, false);
	}
		 ...
		 const struct isp3x_sharp_cfg *arg)
{
	...
	value = rkisp_ioread32(params_vdev, ISP3X_SHARP_EN);
	value &= ISP3X_MODULE_EN;

	value |= (arg->bypass & 0x1) << 1 |
		 (arg->center_mode & 0x1) << 2 |
		 (arg->exgain_bypass & 0x1) << 3;
	rkisp_iowrite32(params_vdev, value, ISP3X_SHARP_EN);

	value = ISP_PACK_4BYTE(arg->pbf_ratio, arg->gaus_ratio,
				arg->bf_ratio, arg->sharp_ratio);
	rkisp_iowrite32(params_vdev, value, ISP3X_SHARP_RATIO);
		 ...
		 const struct isp3x_baynr_cfg *arg)
{
	...
	value = rkisp_ioread32(params_vdev, ISP3X_BAYNR_CTRL);
	value &= ISP3X_MODULE_EN;

	value |= (arg->lg2_mode & 0x3) << 12 |
		 (arg->gauss_en & 0x1) << 8 |
		 (arg->log_bypass & 0x1) << 4;
	rkisp_iowrite32(params_vdev, value, ISP3X_BAYNR_CTRL);

	value = ISP_PACK_2SHORT(arg->dgain0, arg->dgain1);
	rkisp_iowrite32(params_vdev, value, ISP3X_BAYNR_DGAIN0);

	rkisp_iowrite32(params_vdev, arg->dgain2, ISP3X_BAYNR_DGAIN1);
	rkisp_iowrite32(params_vdev, arg->pix_diff, ISP3X_BAYNR_PIXDIFF);

	value = ISP_PACK_2SHORT(arg->softthld, arg->diff_thld);
	rkisp_iowrite32(params_vdev, value, ISP3X_BAYNR_THLD);

	value = ISP_PACK_2SHORT(arg->reg_w1, arg->bltflt_streng);
	rkisp_iowrite32(params_vdev, value, ISP3X_BAYNR_W1_STRENG);

	for (i = 0; i < ISP3X_BAYNR_XY_NUM / 2; i++) {
		value = ISP_PACK_2SHORT(arg->sigma_x[2 * i], arg->sigma_x[2 * i + 1]);
		rkisp_iowrite32(params_vdev, value, ISP3X_BAYNR_SIGMAX01 + 4 * i);
	}

	for (i = 0; i < ISP3X_BAYNR_XY_NUM / 2; i++) {
		value = ISP_PACK_2SHORT(arg->sigma_y[2 * i], arg->sigma_y[2 * i + 1]);
		rkisp_iowrite32(params_vdev, value, ISP3X_BAYNR_SIGMAY01 + 4 * i);
	}

	value = (arg->weit_d2 & 0x3FF) << 20 |
		(arg->weit_d1 & 0x3FF) << 10 |
		(arg->weit_d0 & 0x3FF);
	rkisp_iowrite32(params_vdev, value, ISP3X_BAYNR_WRIT_D);

	value = ISP_PACK_2SHORT(arg->lg2_off, arg->lg2_lgoff);
	rkisp_iowrite32(params_vdev, value, ISP3X_BAYNR_LG_OFF);

	value = arg->dat_max & 0xfffff;
	rkisp_iowrite32(params_vdev, value, ISP3X_BAYNR_DAT_MAX);
}
		 ...
		 const struct isp3x_bay3d_cfg *arg)
{
	...
	value = rkisp_ioread32(params_vdev, ISP3X_BAY3D_CTRL);
	value &= ISP3X_MODULE_EN;
	...
	value |= (arg->loswitch_protect & 0x1) << 12 |
		 ...
		 (arg->bypass_en & 0x1) << 1;
	rkisp_iowrite32(params_vdev, value, ISP3X_BAY3D_CTRL);

	value = ISP_PACK_2SHORT(arg->softwgt, arg->hidif_th);
	rkisp_iowrite32(params_vdev, value, ISP3X_BAY3D_KALRATIO);

	rkisp_iowrite32(params_vdev, arg->glbpk2, ISP3X_BAY3D_GLBPK2);

	value = ISP_PACK_2SHORT(arg->wgtlmt, arg->wgtratio);
	rkisp_iowrite32(params_vdev, value, ISP3X_BAY3D_WGTLMT);

	for (i = 0; i < ISP3X_BAY3D_XY_NUM / 2; i++) {
		value = ISP_PACK_2SHORT(arg->sig0_x[2 * i],
					arg->sig0_x[2 * i + 1]);
		rkisp_iowrite32(params_vdev, value, ISP3X_BAY3D_SIG0_X0 + 4 * i);

		value = ISP_PACK_2SHORT(arg->sig1_x[2 * i],
					arg->sig1_x[2 * i + 1]);
		rkisp_iowrite32(params_vdev, value, ISP3X_BAY3D_SIG1_X0 + 4 * i);
	}

	for (i = 0; i < ISP3X_BAY3D_XY_NUM / 2; i++) {
		value = ISP_PACK_2SHORT(arg->sig0_y[2 * i],
					arg->sig0_y[2 * i + 1]);
		rkisp_iowrite32(params_vdev, value, ISP3X_BAY3D_SIG0_Y0 + 4 * i);

		value = ISP_PACK_2SHORT(arg->sig1_y[2 * i],
					arg->sig1_y[2 * i + 1]);
		rkisp_iowrite32(params_vdev, value, ISP3X_BAY3D_SIG1_Y0 + 4 * i);

		value = ISP_PACK_2SHORT(arg->sig2_y[2 * i],
					arg->sig2_y[2 * i + 1]);
		rkisp_iowrite32(params_vdev, value, ISP3X_BAY3D_SIG2_Y0 + 4 * i);
	}
}
...
isp_bay3d_enable(struct rkisp_isp_params_vdev *params_vdev, bool en)
{
	...
	priv_val = (struct rkisp_isp_params_val_v3x *)params_vdev->priv_val;
	bay3d_ctrl = rkisp_ioread32(params_vdev, ISP3X_BAY3D_CTRL);
	...
	if (en) {
		...
		rkisp_iowrite32(params_vdev, value, ISP3X_MI_BAY3D_IIR_WR_SIZE);
		value = priv_val->buf_3dnr_iir.dma_addr;
		rkisp_iowrite32(params_vdev, value, ISP3X_MI_BAY3D_IIR_WR_BASE);
		rkisp_iowrite32(params_vdev, value, ISP3X_MI_BAY3D_IIR_RD_BASE);

		value = priv_val->buf_3dnr_cur.size;
		rkisp_iowrite32(params_vdev, value, ISP3X_MI_BAY3D_CUR_WR_SIZE);
		value = priv_val->buf_3dnr_cur.dma_addr;
		rkisp_iowrite32(params_vdev, value, ISP3X_MI_BAY3D_CUR_WR_BASE);
		rkisp_iowrite32(params_vdev, value, ISP3X_MI_BAY3D_CUR_RD_BASE);

		value = priv_val->buf_3dnr_ds.size;
		rkisp_iowrite32(params_vdev, value, ISP3X_MI_BAY3D_DS_WR_SIZE);
		value = priv_val->buf_3dnr_ds.dma_addr;
		rkisp_iowrite32(params_vdev, value, ISP3X_MI_BAY3D_DS_WR_BASE);
		rkisp_iowrite32(params_vdev, value, ISP3X_MI_BAY3D_DS_RD_BASE);
		...
		rkisp_set_bits(params_vdev->dev, MI_WR_CTRL2, 0, value, false);
		...
		bay3d_ctrl &= ~ISP3X_MODULE_EN;
		isp_param_clear_bits(params_vdev, ISP3X_GAIN_CTRL, BIT(4));
	}

	rkisp_iowrite32(params_vdev, bay3d_ctrl, ISP3X_BAY3D_CTRL);
}
		...
		const struct isp3x_gain_cfg *arg)
{
	...
	val = arg->g0 & 0x3ffff;
	rkisp_iowrite32(params_vdev, val, ISP3X_GAIN_G0);
	val = ISP_PACK_2SHORT(arg->g1, arg->g2);
	rkisp_iowrite32(params_vdev, val, ISP3X_GAIN_G1_G2);
}
...
isp_gain_enable(struct rkisp_isp_params_vdev *params_vdev, bool en)
{
	...
	if (en) {
		val |= priv_val->lut3d_en << 20 |
			...
			priv_val->lsc_en << 8 |
			priv_val->bay3d_en << 4;
		if (rkisp_ioread32(params_vdev, ISP3X_HDRMGE_CTRL) & BIT(0))
			val |= BIT(1);
		if (val)
			val |= ISP3X_MODULE_EN;
	}
	rkisp_iowrite32(params_vdev, val, ISP3X_GAIN_CTRL);

	/* gain disable, using global gain for cnr */
	if (!val) {
		isp_param_set_bits(params_vdev, ISP3X_CNR_CTRL, BIT(1));
		val = rkisp_ioread32(params_vdev, ISP3X_CNR_EXGAIN) & 0x3ff;
		rkisp_iowrite32(params_vdev, val | 0x8000, ISP3X_CNR_EXGAIN);
	}
}
	       ...
	       const struct isp3x_cac_cfg *arg)
{
	...
	rkisp_iowrite32(params_vdev, val, ISP3X_MI_LUT_CAC_RD_BASE);
	rkisp_iowrite32(params_vdev, arg->hsize, ISP3X_MI_LUT_CAC_RD_H_WSIZE);
	rkisp_iowrite32(params_vdev, arg->vsize, ISP3X_MI_LUT_CAC_RD_V_SIZE);
	if (ctrl & ISP3X_CAC_EN)
		ctrl |= ISP3X_CAC_LUT_EN;
	rkisp_iowrite32(params_vdev, ctrl, ISP3X_CAC_CTRL);
}
...
isp_cac_enable(struct rkisp_isp_params_vdev *params_vdev, bool en)
{
	...
	val = rkisp_ioread32(params_vdev, ISP3X_CAC_CTRL);
	val &= ~ISP3X_CAC_EN;
	if (en)
		val |= ISP3X_CAC_EN | ISP3X_CAC_LUT_EN;
	rkisp_iowrite32(params_vdev, val, ISP3X_CAC_CTRL);
}
			...
			enum rkisp_params_type type)
{
	...
	if (module_en_update & ISP3X_MODULE_DPCC)
		ops->dpcc_enable(params_vdev, !!(module_ens & ISP3X_MODULE_DPCC));

	if (module_en_update & ISP3X_MODULE_BLS)
		ops->bls_enable(params_vdev, !!(module_ens & ISP3X_MODULE_BLS));

	if (module_en_update & ISP3X_MODULE_SDG)
		ops->sdg_enable(params_vdev, !!(module_ens & ISP3X_MODULE_SDG));

	if (module_en_update & ISP3X_MODULE_LSC) {
		ops->lsc_enable(params_vdev, !!(module_ens & ISP3X_MODULE_LSC));
		priv_val->lsc_en = !!(module_ens & ISP3X_MODULE_LSC);
	}

	if (module_en_update & ISP3X_MODULE_AWB_GAIN)
		ops->awbgain_enable(params_vdev, !!(module_ens & ISP3X_MODULE_AWB_GAIN));

	if (module_en_update & ISP3X_MODULE_DEBAYER)
		ops->debayer_enable(params_vdev, !!(module_ens & ISP3X_MODULE_DEBAYER));

	if (module_en_update & ISP3X_MODULE_CCM)
		ops->ccm_enable(params_vdev, !!(module_ens & ISP3X_MODULE_CCM));

	if (module_en_update & ISP3X_MODULE_GOC)
		ops->goc_enable(params_vdev, !!(module_ens & ISP3X_MODULE_GOC));

	if (module_en_update & ISP3X_MODULE_CPROC)
		ops->cproc_enable(params_vdev, !!(module_ens & ISP3X_MODULE_CPROC));

	if (module_en_update & ISP3X_MODULE_IE)
		ops->ie_enable(params_vdev, !!(module_ens & ISP3X_MODULE_IE));

	if (module_en_update & ISP3X_MODULE_HDRMGE) {
		ops->hdrmge_enable(params_vdev, !!(module_ens & ISP3X_MODULE_HDRMGE));
		priv_val->mge_en = !!(module_ens & ISP3X_MODULE_HDRMGE);
	}

	if (module_en_update & ISP3X_MODULE_DRC) {
		ops->hdrdrc_enable(params_vdev, !!(module_ens & ISP3X_MODULE_DRC));
		priv_val->drc_en = !!(module_ens & ISP3X_MODULE_DRC);
	}

	if (module_en_update & ISP3X_MODULE_GIC)
		ops->gic_enable(params_vdev, !!(module_ens & ISP3X_MODULE_GIC));

	if (module_en_update & ISP3X_MODULE_DHAZ) {
		ops->dhaz_enable(params_vdev, !!(module_ens & ISP3X_MODULE_DHAZ));
		priv_val->dhaz_en = !!(module_ens & ISP3X_MODULE_DHAZ);
	}

	if (module_en_update & ISP3X_MODULE_3DLUT) {
		ops->isp3dlut_enable(params_vdev, !!(module_ens & ISP3X_MODULE_3DLUT));
		priv_val->lut3d_en = !!(module_ens & ISP3X_MODULE_3DLUT);
	}

	if (module_en_update & ISP3X_MODULE_LDCH)
		ops->ldch_enable(params_vdev, !!(module_ens & ISP3X_MODULE_LDCH));
	...
	if (module_en_update & ISP3X_MODULE_SHARP)
		ops->sharp_enable(params_vdev, !!(module_ens & ISP3X_MODULE_SHARP));

	if (module_en_update & ISP3X_MODULE_BAYNR)
		ops->baynr_enable(params_vdev, !!(module_ens & ISP3X_MODULE_BAYNR));

	if (module_en_update & ISP3X_MODULE_BAY3D) {
		ops->bay3d_enable(params_vdev, !!(module_ens & ISP3X_MODULE_BAY3D));
		priv_val->bay3d_en = !!(module_ens & ISP3X_MODULE_BAY3D);
	}

	if (module_en_update & ISP3X_MODULE_CAC)
		ops->cac_enable(params_vdev, !!(module_ens & ISP3X_MODULE_CAC));

	if (module_en_update & ISP3X_MODULE_GAIN)
		ops->gain_enable(params_vdev, !!(module_ens & ISP3X_MODULE_GAIN));
}
		       ...
		       enum rkisp_params_type type)
{
	...
	if (module_en_update & ISP3X_MODULE_RAWAE0)
		ops->rawae0_enable(params_vdev, !!(module_ens & ISP3X_MODULE_RAWAE0));

	if (module_en_update & ISP3X_MODULE_RAWAE1)
		ops->rawae1_enable(params_vdev, !!(module_ens & ISP3X_MODULE_RAWAE1));

	if (module_en_update & ISP3X_MODULE_RAWAE2)
		ops->rawae2_enable(params_vdev, !!(module_ens & ISP3X_MODULE_RAWAE2));

	if (module_en_update & ISP3X_MODULE_RAWAE3)
		ops->rawae3_enable(params_vdev, !!(module_ens & ISP3X_MODULE_RAWAE3));

	if (module_en_update & ISP3X_MODULE_RAWHIST0)
		ops->rawhst0_enable(params_vdev, !!(module_ens & ISP3X_MODULE_RAWHIST0));

	if (module_en_update & ISP3X_MODULE_RAWHIST1)
		ops->rawhst1_enable(params_vdev, !!(module_ens & ISP3X_MODULE_RAWHIST1));

	if (module_en_update & ISP3X_MODULE_RAWHIST2)
		ops->rawhst2_enable(params_vdev, !!(module_ens & ISP3X_MODULE_RAWHIST2));

	if (module_en_update & ISP3X_MODULE_RAWHIST3)
		ops->rawhst3_enable(params_vdev, !!(module_ens & ISP3X_MODULE_RAWHIST3));

	if (module_en_update & ISP3X_MODULE_RAWAWB)
		ops->rawawb_enable(params_vdev, !!(module_ens & ISP3X_MODULE_RAWAWB));

	if (module_en_update & ISP3X_MODULE_RAWAF)
		ops->rawaf_enable(params_vdev, !!(module_ens & ISP3X_MODULE_RAWAF));
}
...
rkisp_params_first_cfg_v3x(struct rkisp_isp_params_vdev *params_vdev)
{
	...
	priv_val->mge_en = 0;
	priv_val->lut3d_en = 0;
	__isp_isr_other_config(params_vdev, params_vdev->isp3x_params, RKISP_PARAMS_ALL);
	__isp_isr_other_en(params_vdev, params_vdev->isp3x_params, RKISP_PARAMS_ALL);
	__isp_isr_meas_config(params_vdev, params_vdev->isp3x_params, RKISP_PARAMS_ALL);
	__isp_isr_meas_en(params_vdev, params_vdev->isp3x_params, RKISP_PARAMS_ALL);
	if ((width <= ISP3X_AUTO_BIGMODE_WIDTH && size > ISP3X_NOBIG_OVERFLOW_SIZE) || !hw->is_single)
		rkisp_set_bits(params_vdev->dev, ISP3X_ISP_CTRL1, 0,
...
rkisp_get_param_size_v3x(struct rkisp_isp_params_vdev *params_vdev,
			 unsigned int sizes[])
{
	sizes[0] = sizeof(struct isp3x_isp_params_cfg);
}
...
{
	rkisp_deinit_mesh_buf(params_vdev, ISP3X_MODULE_LDCH);
	rkisp_deinit_mesh_buf(params_vdev, ISP3X_MODULE_CAC);
}
...
module_data_abandon(struct rkisp_isp_params_vdev *params_vdev,
		    struct isp3x_isp_params_cfg *params)
{
	struct rkisp_isp_params_val_v3x *priv_val;
	struct isp2x_mesh_head *mesh_head;
	int i;
...
rkisp_params_clear_fstflg(struct rkisp_isp_params_vdev *params_vdev)
{
	...
	value = rkisp_ioread32(params_vdev, ISP3X_ISP_CTRL1);
...
int rkisp_init_params_vdev_v3x(struct rkisp_isp_params_vdev *params_vdev)
{
	...
	params_vdev->isp3x_params = vmalloc(sizeof(*params_vdev->isp3x_params));
	...
	for (i = 0; i < ISP3X_3DLUT_BUF_NUM; i++) {
		...
		priv_val->buf_3dlut[i].size = ISP3X_3DLUT_BUF_SIZE;
		ret = rkisp_alloc_buffer(params_vdev->dev, &priv_val->buf_3dlut[i]);
		if (ret) {
			dev_err(dev, "can not alloc 3dlut buffer\n");
			goto err;
		}
	}
	...
	for (i = 0; i < ISP3X_LSC_LUT_BUF_NUM; i++) {
		...
		priv_val->buf_lsclut[i].size = ISP3X_LSC_LUT_BUF_SIZE;
		ret = rkisp_alloc_buffer(params_vdev->dev, &priv_val->buf_lsclut[i]);
		if (ret) {
			dev_err(dev, "can not alloc lsclut buffer\n");
			goto err;
		}
	}
