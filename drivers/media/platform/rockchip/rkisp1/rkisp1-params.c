...
static inline void rkisp1_param_set_bits(struct rkisp1_params *params, u32 reg,
    u32 bit_mask) {
  u32 val;
...
static inline void rkisp1_param_clear_bits(struct rkisp1_params *params,
...
static void rkisp1_lsc_matrix_config_v10(struct rkisp1_params *params,
...
static void rkisp1_lsc_matrix_config_v12(struct rkisp1_params *params,
    const struct rkisp1_cif_isp_lsc_config *pconfig) {
  struct rkisp1_device *rkisp1 = params->rkisp1;
  u32 lsc_status, sram_addr, lsc_table_sel;
  unsigned int i, j;
...
static void rkisp1_awb_meas_enable_v10(struct rkisp1_params *params,
    const struct rkisp1_cif_isp_awb_meas_config *arg,
    bool en) {
...
static void rkisp1_awb_meas_enable_v12(struct rkisp1_params *params,
    const struct rkisp1_cif_isp_awb_meas_config *arg,
    bool en) {
...
static void rkisp1_awb_gain_config_v10(struct rkisp1_params *params,
...
static void rkisp1_awb_gain_config_v12(struct rkisp1_params *params,
    const struct rkisp1_cif_isp_awb_gain_config *arg) {
...
static void rkisp1_hst_enable_v10(struct rkisp1_params *params,
...
static void rkisp1_hst_enable_v12(struct rkisp1_params *params,
    const struct rkisp1_cif_isp_hst_config *arg, bool en) {
  if (en) {
...
static void rkisp1_dpf_strength_config(struct rkisp1_params *params,
...
static void rkisp1_isp_isr_other_config(struct rkisp1_params *params,
...
static void rkisp1_isp_isr_lsc_config(struct rkisp1_params *params,
    const struct rkisp1_params_cfg *new_params) {
  unsigned int module_en_update, module_cfg_update, module_ens;
  module_en_update = new_params->module_en_update;
  module_cfg_update = new_params->module_cfg_update;
...
static const struct rkisp1_cif_isp_awb_meas_config
    rkisp1_awb_params_default_config = {
  {
