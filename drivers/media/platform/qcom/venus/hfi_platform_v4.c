...
static const struct hfi_plat_caps caps[] = {
  {
    ...
    .num_caps = 10,
    .pl[0]
      = {HFI_HEVC_PROFILE_MAIN, HFI_HEVC_LEVEL_6 | HFI_HEVC_TIER_HIGH0 << 28},
    .pl[1]
      = {HFI_HEVC_PROFILE_MAIN10,
         HFI_HEVC_LEVEL_6 | HFI_HEVC_TIER_HIGH0 << 28},
    .num_pl = 2,
    .fmts[0] = {HFI_BUFFER_OUTPUT, HFI_COLOR_FORMAT_NV12_UBWC},
...
static const struct hfi_platform_codec_freq_data *get_codec_freq_data(
    u32 session_type, u32 pixfmt) {
