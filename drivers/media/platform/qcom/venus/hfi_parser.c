...
static void fill_buf_mode(struct hfi_plat_caps *cap, const void *data,
    unsigned int num) {
  const u32 *type = data;
...
static void parse_alloc_mode(struct venus_core *core, u32 codecs, u32 domain,
    void *data) {
...
static void parse_profile_level(struct venus_core *core, u32 codecs, u32 domain,
    void *data) {
...
static void fill_caps(struct hfi_plat_caps *cap, const void *data,
    unsigned int num) {
...
static void parse_caps(struct venus_core *core, u32 codecs, u32 domain,
    void *data) {
...
static void parse_raw_formats(struct venus_core *core, u32 codecs, u32 domain,
    void *data) {
...
static int hfi_platform_parser(struct venus_core *core,
