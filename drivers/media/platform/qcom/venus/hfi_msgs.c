...
static void event_session_error(struct venus_core *core,
    struct venus_inst *inst,
    struct hfi_msg_event_notify_pkt *pkt) {
...
static void sys_get_prop_image_version(struct venus_core *core,
...
static unsigned int session_get_prop_profile_level(
...
static unsigned int session_get_prop_buf_req(
    struct hfi_msg_session_property_info_pkt *pkt,
    struct hfi_buffer_requirements *bufreq) {
