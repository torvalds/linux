...
static inline struct hfi_plat_caps *venus_caps_by_codec(struct venus_core *core,
...
static inline bool is_fw_rev_or_newer(struct venus_core *core, u32 vmajor,
    u32 vminor, u32 vrev) {
...
static inline bool is_fw_rev_or_older(struct venus_core *core, u32 vmajor,
    u32 vminor, u32 vrev) {
  return (core)->venus_ver.major == vmajor
    && (core)->venus_ver.minor == vminor
    && (core)->venus_ver.rev <= vrev;
