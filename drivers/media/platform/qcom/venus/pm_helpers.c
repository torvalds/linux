...
static void vcodec_control_v3(struct venus_core *core, u32 session_type,
    bool enable) {
  void __iomem *ctrl;
...
static void min_loaded_core(struct venus_inst *inst, u32 *min_coreid,
    u32 *min_load, bool low_power) {
