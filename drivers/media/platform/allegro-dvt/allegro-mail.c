...
static ssize_t allegro_enc_init(u32 *dst, struct mcu_msg_init_request *msg) {
  unsigned int i = 0;
...
static ssize_t allegro_enc_create_channel(u32 *dst,
...
static ssize_t allegro_enc_destroy_channel(u32 *dst,
...
static ssize_t allegro_enc_push_buffers(u32 *dst,
...
static ssize_t allegro_enc_put_stream_buffer(u32 *dst,
...
static ssize_t allegro_enc_encode_frame(u32 *dst,
...
static ssize_t allegro_dec_init(struct mcu_msg_init_response *msg, u32 *src) {
  unsigned int i = 0;
  msg->reserved0 = src[i++];
  return i * sizeof(*src);
}

static ssize_t allegro_dec_create_channel(
    struct mcu_msg_create_channel_response *msg,
    u32 *src) {
  enum mcu_msg_version version = msg->header.version;
  unsigned int i = 0;
...
static ssize_t allegro_dec_destroy_channel(
...
static ssize_t allegro_dec_encode_frame(
    struct mcu_msg_encode_frame_response *msg, u32 *src) {
  enum mcu_msg_version version = msg->header.version;
  unsigned int i = 0;
  unsigned int j;
  msg->channel_id = src[i++];
