...
/**
 * nal_h264_transfer_characteristics() - Get transfer_characteristics for v4l2
 *xfer_func
 * @colorspace: the color space as &enum v4l2_colorspace
 ...
 */
static inline int nal_h264_transfer_characteristics(
...
/**
 * nal_h264_matrix_coeffs() - Get matrix_coefficients for v4l2
 *v4l2_ycbcr_encoding
 * @colorspace: the color space as &enum v4l2_colorspace
