...
#define TEGRA_CEC_HW_DE_RX	0x038
#define TEGRA_CEC_HW_DE_TX	0x03c
...
#define TEGRA_CEC_HW_DE_TX_DURATION_COUNT_SHIFT		0
#define TEGRA_CEC_HW_DE_TX_TXBIT_COUNT_SHIFT			17
#define TEGRA_CEC_HW_DE_TX_STATE_SHIFT			21
#define TEGRA_CEC_HW_DE_TX_FORCELOOUT			(1 << 25)
#define TEGRA_CEC_HW_DE_TX_TXDATABIT_SAMPLE_TIMER		(1 << 26)
