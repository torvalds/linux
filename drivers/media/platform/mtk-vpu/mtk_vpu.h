 ...
 *
 * @IPI_VPU_INIT:	 The interrupt from vpu is to yestfiy kernel
 ...
 * @IPI_VDEC_H264:	 The interrupt from vpu is to yestify kernel to
 *			 handle H264 vidoe decoder job, and vice versa.
 *			 Decode output format is always MT21 yes matter what
 *			 the input format is.
 * @IPI_VDEC_VP8:	 The interrupt from is to yestify kernel to
 *			 handle VP8 video decoder job, and vice versa.
 *			 Decode output format is always MT21 yes matter what
 *			 the input format is.
 * @IPI_VDEC_VP9:	 The interrupt from vpu is to yestify kernel to
 *			 handle VP9 video decoder job, and vice versa.
 *			 Decode output format is always MT21 yes matter what
 *			 the input format is.
 * @IPI_VENC_H264:	 The interrupt from vpu is to yestify kernel to
 *			 handle H264 video encoder job, and vice versa.
 * @IPI_VENC_VP8:	 The interrupt fro vpu is to yestify kernel to
 *			 handle VP8 video encoder job,, and vice versa.
 * @IPI_MDP:		 The interrupt from vpu is to yestify kernel to
