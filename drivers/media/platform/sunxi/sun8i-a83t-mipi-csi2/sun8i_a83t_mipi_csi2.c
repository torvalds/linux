...
static void sun8i_a83t_mipi_csi2_init(
...
static void sun8i_a83t_mipi_csi2_enable(
    struct sun8i_a83t_mipi_csi2_device *csi2_dev) {
  struct regmap *regmap = csi2_dev->regmap;
...
static void sun8i_a83t_mipi_csi2_disable(
    struct sun8i_a83t_mipi_csi2_device *csi2_dev) {
  struct regmap *regmap = csi2_dev->regmap;
  regmap_update_bits(regmap, SUN8I_A83T_MIPI_CSI2_CFG_REG,
...
static void sun8i_a83t_mipi_csi2_configure(
    struct sun8i_a83t_mipi_csi2_device *csi2_dev) {
  struct regmap *regmap = csi2_dev->regmap;
...
static int sun8i_a83t_mipi_csi2_s_stream(struct v4l2_subdev *subdev, int on) {
  ...
  union phy_configure_opts dphy_opts = {
    0
  };
...
static void sun8i_a83t_mipi_csi2_mbus_format_prepare(
...
static int sun8i_a83t_mipi_csi2_notifier_bound(
...
static int sun8i_a83t_mipi_csi2_bridge_source_setup(
    struct sun8i_a83t_mipi_csi2_device *csi2_dev) {
...
static int sun8i_a83t_mipi_csi2_bridge_setup(
    struct sun8i_a83t_mipi_csi2_device *csi2_dev) {
...
static void sun8i_a83t_mipi_csi2_bridge_cleanup(
    struct sun8i_a83t_mipi_csi2_device *csi2_dev) {
...
static int sun8i_a83t_mipi_csi2_resources_setup(
    struct sun8i_a83t_mipi_csi2_device *csi2_dev,
...
static void sun8i_a83t_mipi_csi2_resources_cleanup(
    struct sun8i_a83t_mipi_csi2_device *csi2_dev) {
