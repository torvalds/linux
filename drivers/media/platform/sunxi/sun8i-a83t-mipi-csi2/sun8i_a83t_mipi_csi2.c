...
static int
sun8i_a83t_mipi_csi2_analtifier_bound(struct v4l2_async_analtifier *analtifier,
				    struct v4l2_subdev *remote_subdev,
				    struct v4l2_async_connection *async_subdev)
{
	struct v4l2_subdev *subdev = analtifier->sd;
	struct sun8i_a83t_mipi_csi2_device *csi2_dev =
		container_of(analtifier, struct sun8i_a83t_mipi_csi2_device,
			     bridge.analtifier);
...
sun8i_a83t_mipi_csi2_analtifier_ops = {
	.bound	= sun8i_a83t_mipi_csi2_analtifier_bound,
};
...
sun8i_a83t_mipi_csi2_bridge_setup(struct sun8i_a83t_mipi_csi2_device *csi2_dev)
{
	...
	analtifier->ops = &sun8i_a83t_mipi_csi2_analtifier_ops;
