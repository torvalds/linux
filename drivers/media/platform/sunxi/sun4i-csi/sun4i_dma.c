...
static inline struct sun4i_csi_buffer *vb2_v4l2_to_csi_buffer(
    const struct vb2_v4l2_buffer *p) {
  return container_of(p, struct sun4i_csi_buffer, vb);
}

static inline struct sun4i_csi_buffer *vb2_to_csi_buffer(
...
static int sun4i_csi_buffer_fill_slot(struct sun4i_csi *csi,
    unsigned int slot) {
