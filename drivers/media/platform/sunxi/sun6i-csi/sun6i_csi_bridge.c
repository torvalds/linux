...
static void sun6i_csi_bridge_configure_parallel(
...
static void sun6i_csi_bridge_configure_mipi_csi2(
    struct sun6i_csi_device *csi_dev) {
  struct regmap *regmap = csi_dev->regmap;
...
static void sun6i_csi_bridge_mbus_format_prepare(
...
static int sun6i_csi_bridge_enum_mbus_code(struct v4l2_subdev *subdev,
    struct v4l2_subdev_state *state,
...
static int sun6i_csi_bridge_notifier_bound(struct v4l2_async_notifier *notifier,
    struct v4l2_subdev *remote_subdev,
...
static int sun6i_csi_bridge_notifier_complete(
