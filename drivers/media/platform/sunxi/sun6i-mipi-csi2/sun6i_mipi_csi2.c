...
static const struct sun6i_mipi_csi2_format *sun6i_mipi_csi2_format_find(
    u32 mbus_code) {
  unsigned int i;
...
static void sun6i_mipi_csi2_mbus_format_prepare(
...
static int sun6i_mipi_csi2_bridge_source_setup(
    struct sun6i_mipi_csi2_device *csi2_dev) {
...
static void sun6i_mipi_csi2_bridge_cleanup(
    struct sun6i_mipi_csi2_device *csi2_dev) {
...
static int sun6i_mipi_csi2_resources_setup(
    struct sun6i_mipi_csi2_device *csi2_dev,
...
static void sun6i_mipi_csi2_resources_cleanup(
    struct sun6i_mipi_csi2_device *csi2_dev) {
