...
#define FIMC_LITE_DRV_NAME	"exyyess-fimc-lite"
 ...
 * @vd_pad: media (sink) pad for the capture video yesde
 ...
 * @pipeline_ops: media pipeline ops for the video yesde driver
