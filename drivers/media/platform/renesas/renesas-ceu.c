...
static void ceu_write(struct ceu_device *priv, unsigned int reg_offs,
    u32 data) {
 ...
 */
static int __ceu_try_fmt(struct ceu_device *ceudev,
 ...
 */
static int ceu_try_fmt(struct ceu_device *ceudev,
    struct v4l2_format *v4l2_fmt) {
  u32 mbus_code;
 ...
 */
static int ceu_set_fmt(struct ceu_device *ceudev,
    struct v4l2_format *v4l2_fmt) {
  struct ceu_subdev *ceu_sd = ceudev->sd;
  struct v4l2_subdev *v4l2_sd = ceu_sd->v4l2_sd;
  u32 mbus_code;
 ...
 */
static int ceu_init_async_subdevs(struct ceu_device *ceudev,
    unsigned int n_sd) {
