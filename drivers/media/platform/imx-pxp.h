...
#define HW_PXP_DECTRL	(0x00000410)

#define BP_PXP_DECTRL_RSVD      12
#define BM_PXP_DECTRL_RSVD 0xFFFFF000
#define BF_PXP_DECTRL_RSVD(v) \
	(((v) << 12) & BM_PXP_DECTRL_RSVD)
#define BP_PXP_DECTRL_LUT_CLR_STAT_CNT      8
#define BM_PXP_DECTRL_LUT_CLR_STAT_CNT 0x00000F00
#define BF_PXP_DECTRL_LUT_CLR_STAT_CNT(v)  \
	(((v) << 8) & BM_PXP_DECTRL_LUT_CLR_STAT_CNT)
#define BV_PXP_DECTRL_LUT_CLR_STAT_CNT__NONE     0x0
#define BV_PXP_DECTRL_LUT_CLR_STAT_CNT__MISS_CNT 0x1
#define BV_PXP_DECTRL_LUT_CLR_STAT_CNT__HIT_CNT  0x2
#define BV_PXP_DECTRL_LUT_CLR_STAT_CNT__LAT_CNT  0x4
#define BV_PXP_DECTRL_LUT_CLR_STAT_CNT__MAX_LAT  0x8
#define BP_PXP_DECTRL_SELECT      0
#define BM_PXP_DECTRL_SELECT 0x000000FF
#define BF_PXP_DECTRL_SELECT(v)  \
	(((v) << 0) & BM_PXP_DECTRL_SELECT)
#define BV_PXP_DECTRL_SELECT__NONE	0x0
#define BV_PXP_DECTRL_SELECT__CTRL	0x1
#define BV_PXP_DECTRL_SELECT__PSBUF       0x2
#define BV_PXP_DECTRL_SELECT__PSBAX       0x3
#define BV_PXP_DECTRL_SELECT__PSBAY       0x4
#define BV_PXP_DECTRL_SELECT__ASBUF       0x5
#define BV_PXP_DECTRL_SELECT__ROTATION    0x6
#define BV_PXP_DECTRL_SELECT__OUTBUF0     0x7
#define BV_PXP_DECTRL_SELECT__OUTBUF1     0x8
#define BV_PXP_DECTRL_SELECT__OUTBUF2     0x9
#define BV_PXP_DECTRL_SELECT__LUT_STAT    0x10
#define BV_PXP_DECTRL_SELECT__LUT_MISS    0x11
#define BV_PXP_DECTRL_SELECT__LUT_HIT     0x12
#define BV_PXP_DECTRL_SELECT__LUT_LAT     0x13
#define BV_PXP_DECTRL_SELECT__LUT_MAX_LAT 0x14

#define HW_PXP_DE	(0x00000420)

#define BP_PXP_DE_DATA      0
#define BM_PXP_DE_DATA 0xFFFFFFFF
#define BF_PXP_DE_DATA(v)   (v)
