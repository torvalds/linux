...
static struct v4l2_subdev *isp_video_remote_subdev(struct isp_video *video,
    u32 *pad) {
...
static int __isp_video_get_format(struct isp_video *video,
...
static int isp_video_check_format(struct isp_video *video,
