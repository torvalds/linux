 ...
 */
static struct v4l2_mbus_framefmt *__ccp2_get_format(
    struct isp_ccp2_device *ccp2,
 ...
 */
static int ccp2_init_formats(struct v4l2_subdev *sd,
 ...
 */
static int ccp2_video_queue(struct isp_video *video,
    struct isp_buffer *buffer) {
