...
static inline struct isp_bus_cfg *v4l2_subdev_to_bus_cfg(struct v4l2_subdev *sd)
{
...
static inline enum v4l2_buf_type isp_pad_buffer_type(
    const struct v4l2_subdev *subdev, int pad) {
