...
static struct v4l2_mbus_framefmt *__ccdc_get_format(
...
static int ccdc_video_queue(struct isp_video *video,
    struct isp_buffer *buffer) {
...
static struct v4l2_rect *__ccdc_get_crop(struct isp_ccdc_device *ccdc,
    struct v4l2_subdev_state *sd_state,
 ...
 * @fmt: Format
 */
static void ccdc_try_format(struct isp_ccdc_device *ccdc,
    struct v4l2_subdev_state *sd_state,
