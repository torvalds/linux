...
static void cal_release_pix_proc(struct cal_dev *cal,
    unsigned int pix_proc_num) {
  spin_lock(&cal->v4l2_dev.lock);
...
static int cal_get_remote_frame_desc_entry(struct cal_ctx *ctx,
...
static inline struct cal_v4l2_async_subdev *to_cal_asd(
