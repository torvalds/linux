...
static int vpfe_ccdc_validate_param(struct vpfe_ccdc *ccdc,
...
static void vpfe_ccdc_update_raw_params(struct vpfe_ccdc *ccdc,
...
static void vpfe_ccdc_config_black_clamp(struct vpfe_ccdc *ccdc,
...
static void vpfe_ccdc_config_black_compense(struct vpfe_ccdc *ccdc,
...
static inline int vpfe_ccdc_set_buftype(struct vpfe_ccdc *ccdc,
...
static int vpfe_ccdc_set_image_window(struct vpfe_ccdc *ccdc,
...
static inline void vpfe_ccdc_get_image_window(struct vpfe_ccdc *ccdc,
...
static inline int vpfe_ccdc_set_frame_format(struct vpfe_ccdc *ccdc,
    enum ccdc_frmfmt frm_fmt) {
  if (ccdc->ccdc_cfg.if_type == VPFE_RAW_BAYER) {
...
static inline enum ccdc_frmfmt vpfe_ccdc_get_frame_format(
...
static inline void vpfe_set_sdr_addr(struct vpfe_ccdc *ccdc,
    unsigned long addr) {
...
static struct vpfe_config *vpfe_get_pdata(struct vpfe_device *vpfe) {
