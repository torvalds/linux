 ...
 * @inputs: Target yesde value for each input
 * @output: Target yesde value for entity output
 *
 * Each $vsp1_route entry describes routing configuration for the entity
 * specified by the entry's @type and @index. @reg indicates the register that
 * holds output routing configuration for the entity, and the @inputs array
 * store the target yesde value for each input of the entity. The @output field
 * stores the target yesde value of the entity output when used as a source for
 ...
 *			yest vary between frames (pipeline, formats). Note that
