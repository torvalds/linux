...
static int vidioc_venc_s_ctrl(struct v4l2_ctrl *ctrl) {
  ...
  switch (ctrl->id) {
    case V4L2_CID_MPEG_VIDEO_BITRATE_MODE:
      mtk_v4l2_venc_dbg(2, ctx, "V4L2_CID_MPEG_VIDEO_BITRATE_MODE val= %d",
          ctrl->val);
    ...
    case V4L2_CID_MPEG_VIDEO_BITRATE:
      mtk_v4l2_venc_dbg(2, ctx, "V4L2_CID_MPEG_VIDEO_BITRATE val = %d",
          ctrl->val);
      p->bitrate = ctrl->val;
      ctx->param_change |= MTK_ENCODE_PARAM_BITRATE;
      break;
    case V4L2_CID_MPEG_VIDEO_B_FRAMES:
      mtk_v4l2_venc_dbg(2, ctx, "V4L2_CID_MPEG_VIDEO_B_FRAMES val = %d",
          ctrl->val);
    ...
    case V4L2_CID_MPEG_VIDEO_H264_MAX_QP:
      mtk_v4l2_venc_dbg(2, ctx, "V4L2_CID_MPEG_VIDEO_H264_MAX_QP val = %d",
          ctrl->val);
      p->h264_max_qp = ctrl->val;
      break;
    case V4L2_CID_MPEG_VIDEO_HEADER_MODE:
      mtk_v4l2_venc_dbg(2, ctx, "V4L2_CID_MPEG_VIDEO_HEADER_MODE val = %d",
          ctrl->val);
      p->seq_hdr_mode = ctrl->val;
      break;
    case V4L2_CID_MPEG_VIDEO_MB_RC_ENABLE:
      mtk_v4l2_venc_dbg(2, ctx, "V4L2_CID_MPEG_VIDEO_MB_RC_ENABLE val = %d",
          ctrl->val);
      p->rc_mb = ctrl->val;
      break;
    case V4L2_CID_MPEG_VIDEO_H264_PROFILE:
      mtk_v4l2_venc_dbg(2, ctx, "V4L2_CID_MPEG_VIDEO_H264_PROFILE val = %d",
          ctrl->val);
      p->h264_profile = ctrl->val;
      break;
    case V4L2_CID_MPEG_VIDEO_H264_LEVEL:
      mtk_v4l2_venc_dbg(2, ctx, "V4L2_CID_MPEG_VIDEO_H264_LEVEL val = %d",
          ctrl->val);
      p->h264_level = ctrl->val;
      break;
    case V4L2_CID_MPEG_VIDEO_H264_I_PERIOD:
      mtk_v4l2_venc_dbg(2, ctx, "V4L2_CID_MPEG_VIDEO_H264_I_PERIOD val = %d",
          ctrl->val);
      p->intra_period = ctrl->val;
      ctx->param_change |= MTK_ENCODE_PARAM_INTRA_PERIOD;
      break;
    case V4L2_CID_MPEG_VIDEO_GOP_SIZE:
      mtk_v4l2_venc_dbg(2, ctx, "V4L2_CID_MPEG_VIDEO_GOP_SIZE val = %d",
          ctrl->val);
      p->gop_size = ctrl->val;
    ...
    case V4L2_CID_MPEG_VIDEO_VP8_PROFILE:
       ...
       */
      mtk_v4l2_venc_dbg(2, ctx, "V4L2_CID_MPEG_VIDEO_VP8_PROFILE val = %d",
          ctrl->val);
      break;
 ...
 */
static int vidioc_try_fmt_out(struct mtk_vcodec_enc_ctx *ctx,
...
static int m2mops_venc_job_ready(void *m2m_priv) {
  ...
  if (ctx->state == MTK_STATE_ABORT || ctx->state == MTK_STATE_FREE) {
    mtk_v4l2_venc_dbg(3, ctx, "[%d]Not ready: state=0x%x.", ctx->id,
        ctx->state);
    return 0;
  }
  return 1;
