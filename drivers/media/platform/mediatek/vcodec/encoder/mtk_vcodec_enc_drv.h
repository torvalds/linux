 ...
 * @empty_flush_buf: a fake size-0 capture buffer that indicates flush. Used for
 *encoder.
...
static inline void wake_up_enc_ctx(struct mtk_vcodec_enc_ctx *ctx,
...
#define mtk_v4l2_venc_err(ctx, fmt, args ...) mtk_v4l2_err((ctx)->dev->plat_dev, \
    fmt, ## args)
