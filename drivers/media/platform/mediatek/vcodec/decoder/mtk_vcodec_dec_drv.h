...
static inline void wake_up_dec_ctx(struct mtk_vcodec_dec_ctx *ctx,
    unsigned int reason, unsigned int hw_id) {
...
#define mtk_v4l2_vdec_err(ctx, fmt, args ...) mtk_v4l2_err((ctx)->dev->plat_dev, \
    fmt, ## args)
