...
static
int vdec_vp9_slice_setup_single_from_src_to_dst(
    struct vdec_vp9_slice_instance *instance) {
...
static int vdec_vp9_slice_update_prob(struct vdec_vp9_slice_instance *instance,
  ...
  if (!uh->frame_parallel_decoding_mode) {
    vdec_vp9_slice_counts_map_helper(&instance->counts_map, counts,
        counts_helper);
...
static int vdec_vp9_slice_update_single(
    struct vdec_vp9_slice_instance *instance,
    struct vdec_vp9_slice_pfc *pfc) {
  struct vdec_vp9_slice_vsi *vsi;
  vsi = &pfc->vsi;
...
static void vdec_vp9_slice_setup_single_buffer(
    struct vdec_vp9_slice_instance *instance,
    struct vdec_vp9_slice_pfc *pfc,
    struct vdec_vp9_slice_vsi *vsi,
    struct mtk_vcodec_mem *bs,
