...
static int vdec_vp8_slice_get_decode_parameters(
  ...
  u64 referenct_ts;
  int index;
  frame_header = vdec_vp8_slice_get_ctrl_ptr(inst->ctx,
...
static int vdec_vp8_slice_get_param(void *h_vdec, enum vdec_get_param_type type,
    void *out) {
  struct vdec_vp8_slice_inst *inst = h_vdec;
  switch (type) {
