...
int vpu_iface_check_memory_region(struct vpu_core *core, dma_addr_t addr,
    u32 size) {
...
static int vpu_rpc_receive_msg_buf(struct vpu_shared_addr *shared,
...
static struct vpu_iface_ops *vpu_get_iface(struct vpu_dev *vpu,
