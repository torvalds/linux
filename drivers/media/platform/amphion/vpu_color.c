...
static const u8 colortransfers[] = {
  ...
  0,                              /*SMPTE ST 428-1*/
  0                               /*Rec. ITU-R BT.2100-0 hybrid log-gamma
                                   * (HLG)*/
};
...
u32 vpu_color_cvrt_primaries_v2i(u32 primaries) {
  return vpu_helper_find_in_array_u8(colorprimaries, ARRAY_SIZE(
...
u32 vpu_color_cvrt_transfers_v2i(u32 transfers) {
  return vpu_helper_find_in_array_u8(colortransfers, ARRAY_SIZE(
      colortransfers), transfers);
}
...
u32 vpu_color_cvrt_matrix_v2i(u32 matrix) {
  return vpu_helper_find_in_array_u8(colormatrixcoefs,
      ARRAY_SIZE(colormatrixcoefs), matrix);
}
