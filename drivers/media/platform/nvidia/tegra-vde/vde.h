...
static inline struct tegra_m2m_buffer *vb_to_tegra_buf(struct vb2_buffer *vb) {
...
static __maybe_unused char const *tegra_vde_reg_base_name(struct tegra_vde *vde,
    void __iomem *base) {
  if (vde->sxe == base) {
    return "SXE";
  }
