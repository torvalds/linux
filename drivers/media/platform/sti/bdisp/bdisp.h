...
/*
 *  Max nb of yesdes in yesde-list:
 *   - 2 yesdes to handle wide 4K pictures
 *   - 2 yesdes to handle two planes (Y & CbCr) */
 ...
 * @yesde:       yesde array
 * @yesde_paddr: yesde physical address array
 * @fh:         v4l2 file handle
...
struct bdisp_ctx {
	...
	struct bdisp_yesde       *yesde[MAX_NB_NODE];
	dma_addr_t              yesde_paddr[MAX_NB_NODE];
	struct v4l2_fh          fh;
 ...
 *
 * @vdev:       video device yesde for v4l2 m2m mode
 ...
 * @copy_yesde:     array of last used yesdes
...
struct bdisp_dbg {
	...
	struct bdisp_yesde       *copy_yesde[MAX_NB_NODE];
