...
struct hantro_postproc_ops {
  ...
  int (*enum_framesizes)(struct hantro_ctx *ctx,
...
static inline size_t hantro_vp9_mv_size(unsigned int width,
    unsigned int height) {
  int num_ctbs;
  /*
...
static inline size_t hantro_h264_mv_size(unsigned int width,
    unsigned int height) {
  /*
...
static inline size_t hantro_hevc_mv_size(unsigned int width,
    unsigned int height) {
  /*
...
static inline size_t hantro_av1_mv_size(unsigned int width,
    unsigned int height) {
