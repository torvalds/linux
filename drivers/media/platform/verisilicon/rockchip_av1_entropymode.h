...
enum {
  SIMPLE_TRANSLATION, OBMC_CAUSAL, MOTION_MODE_COUNT
};
...
enum mb_prediction_mode {
  ...
  D45_PRED,   /* Directional 45 deg prediction  [anti-clockwise from 0 deg hor]
               * */
  D135_PRED,    /* Directional 135 deg prediction [anti-clockwise from 0 deg
                 * hor] */
  D117_PRED,    /* Directional 112 deg prediction [anti-clockwise from 0 deg
                 * hor] */
  D153_PRED,    /* Directional 157 deg prediction [anti-clockwise from 0 deg
                 * hor] */
...
struct av1cdfs {
  ...
  u16 inter_compound_mode_cdf[AV1_INTER_MODE_CONTEXTS][INTER_COMPOUND_MODES
      - 1];
  ...
  u16 coeff_base_eob_cdf[TX_SIZES][PLANE_TYPES][SIG_COEF_CONTEXTS_EOB][CDF_SIZE(
      3)];
