...
static struct v4l2_subdev *xvip_dma_remote_subdev(struct media_pad *local,
    u32 *pad) {
...
static int xvip_dma_queue_setup(struct vb2_queue *vq,
...
static int xvip_dma_querycap(struct file *file, void *fh,
 ...
 */
static int xvip_dma_enum_format(struct file *file, void *fh,
...
static int xvip_dma_get_format(struct file *file, void *fh,
...
static void __xvip_dma_try_format(struct xvip_dma *dma,
...
static int xvip_dma_try_format(struct file *file, void *fh,
    struct v4l2_format *format) {
  struct v4l2_fh *vfh = file->private_data;
  struct xvip_dma *dma = to_xvip_dma(vfh->vdev);
...
static int xvip_dma_set_format(struct file *file, void *fh,
    struct v4l2_format *format) {
  struct v4l2_fh *vfh = file->private_data;
  struct xvip_dma *dma = to_xvip_dma(vfh->vdev);
  const struct xvip_video_format *info;
