...
// Uncomment the #define below to enable spurs checking. The results where quite
// unconvincing.
// #define MT2060_SPURCHECK

/* This driver is based on the information available in the datasheet of the
 * "Comtech SDVBT-3K6M" tuner ( K1000737843.pdf ) which features the MT2060
 * register map :
 *
 * I2C Address : 0x60
 *
 * Reg.No |   B7   |   B6   |   B5   |   B4   |   B3   |   B2   |   B1   |   B0
 *   | ( defaults )
 * --------------------------------------------------------------------------------
 *     00 | [              PART             ] | [              REV
 *              ] | R  = 0x63
 ...
 *     02 | [                               DIV1
 *                                ] | RW = 0x74
 *     03 | FM1CA  | FM1SS  | [  NUM1(1:0)  ] | [              NUM2(3:0)
 *        ] | RW = 0x00
 *     04 |                                 NUM2(11:4)
 *                          ] | RW = 0x08
 *     05 | [                               DIV2                       ]
 * |NUM2(12)| RW = 0x93
 *     06 | L1LK   | [        TAD1          ] | L2LK   | [         TAD2
 *         ] | R
 *     07 | [                               FMF
 *                                 ] | R
 *     08 |   ?    | FMCAL  |   ?    |   ?    |   ?    |   ?    |   ?    | TEMP
 *   | R
 *     09 |   0    |   0    | [    FMGC     ] |   0    | GP02   | GP01   |   0
 *    | RW = 0x20
 *     0A | ??
 *     0B |   0    |   0    |   1    |   1    |   0    |   0    | [   VGAG
 *      ] | RW = 0x30
 *     0C | V1CSE  |   1    |   1    |   1    |   1    |   1    |   1    |   1
 *    | RW = 0xFF
 *     0D |   1    |   0    | [                      V1CS
 *                       ] | RW = 0xB0
 *     0E | ??
 ...
 *     NUM1 / DIV1 / NUM2 / DIV2 : Frequencies programming ( See code for
 * details )
...
#define PART_REV 0x63 // The current driver works only with PART=6 and REV=3
                      // chips
