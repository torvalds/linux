...
static int mxl5005s_SetRfFreqHz(struct dvb_frontend *fe,
...
static u16 MXL_TuneRF(struct dvb_frontend *fe, u32 RF_Freq) {
  ...
  E4 = (state->RF_LO * divider_val / 1000)
      / (2 * state->Fxtal * Kdbl_RF / 1000);
...
static u16 MXL_ControlWrite(struct dvb_frontend *fe, u16 ControlNum,
    u32 value) {
  u16 status = 0;
...
static u16 MXL_ControlRead(struct dvb_frontend *fe, u16 controlNum,
    u32 *value) {
  struct mxl5005s_state *state = fe->tuner_priv;
  u32 ctrlVal;
  u16 i, k;
