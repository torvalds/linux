...
MODULE_PARM_DESC(tuner_lock_debug,
    "if set, signal lock is briefly waited on after setting params");

/* execute firmware command */
static int si2157_cmd_execute(struct i2c_client *client,
...
static void si2157_stat_work(struct work_struct *work) {
  struct si2157_dev *dev
    = container_of(work, struct si2157_dev, stat_work.work);
...
MODULE_DESCRIPTION(
    "Silicon Labs Si2141/Si2146/2147/2148/2157/2158 silicon tuner driver");
