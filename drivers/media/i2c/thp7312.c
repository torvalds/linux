...
static const struct thp7312_mode_info *thp7312_find_mode(unsigned int width,
    unsigned int height,
    bool nearest) {
...
static const struct thp7312_frame_rate *thp7312_find_rate(
    const struct thp7312_mode_info *mode, unsigned int fps,
    bool nearest) {
...
static int thp7312_map_data_lanes(u8 *lane_remap, const u8 *lanes,
    u8 num_lanes) {
  u8 used_lanes = 0;
  u8 val = 0;
  unsigned int i;
...
static inline struct thp7312_device *to_thp7312_from_ctrl(
...
static const u8 thp7312_jedec_rdid[] = {
  SPINOR_OP_RDID, 0x00, 0x00, 0x00
};
static const u8 thp7312_jedec_rdsr[] = {
  SPINOR_OP_RDSR, 0x00, 0x00, 0x00
};
...
static enum fw_upload_err thp7312_fw_prepare_config(
...
static enum fw_upload_err thp7312_fw_prepare_check(
    struct thp7312_device *thp7312) {
  struct device *dev = thp7312->dev;
  u8 read_buf[3] = {
    0
...
static enum fw_upload_err thp7312_fw_prepare_reset(
    struct thp7312_device *thp7312) {
  struct device *dev = thp7312->dev;
  int ret;
...
static enum fw_upload_err thp7312_write_download_data_by_unit(
    struct thp7312_device *thp7312,
...
static enum fw_upload_err thp7312_fw_write_to_flash(
    struct thp7312_device *thp7312,
...
static enum fw_upload_err thp7312_fw_write(struct fw_upload *fw_upload,
  ...
  ret
    = thp7312_fw_load_to_ram(thp7312, data + THP7312_FW_RAM_SIZE, header_size);
  if (ret != FW_UPLOAD_ERR_NONE) {
    return ret;
  }
