...
static int mt9v032_update_aec_agc(struct mt9v032 *mt9v032, u16 which,
    int enable) {
...
static int mt9v032_update_hblank(struct mt9v032 *mt9v032) {
...
static struct v4l2_mbus_framefmt *__mt9v032_get_pad_format(
...
static struct v4l2_rect *__mt9v032_get_pad_crop(struct mt9v032 *mt9v032,
    struct v4l2_subdev_state *sd_state,
    unsigned int pad, enum v4l2_subdev_format_whence which) {
  switch (which) {
    case V4L2_SUBDEV_FORMAT_TRY:
...
static unsigned int mt9v032_calc_ratio(unsigned int input,
    unsigned int output) {
...
static int mt9v032_close(struct v4l2_subdev *subdev,
...
static struct mt9v032_platform_data *mt9v032_get_pdata(
...
static const struct of_device_id mt9v032_of_match[] = {
  { .compatible = "aptina,mt9v022",
    .data = &mt9v032_models[MT9V032_MODEL_V022_COLOR] },
  { .compatible = "aptina,mt9v022m",
    .data = &mt9v032_models[MT9V032_MODEL_V022_MONO] },
  { .compatible = "aptina,mt9v024",
    .data = &mt9v032_models[MT9V032_MODEL_V024_COLOR] },
  { .compatible = "aptina,mt9v024m",
    .data = &mt9v032_models[MT9V032_MODEL_V024_MONO] },
  { .compatible = "aptina,mt9v032",
    .data = &mt9v032_models[MT9V032_MODEL_V032_COLOR] },
  { .compatible = "aptina,mt9v032m",
    .data = &mt9v032_models[MT9V032_MODEL_V032_MONO] },
  { .compatible = "aptina,mt9v034",
    .data = &mt9v032_models[MT9V032_MODEL_V034_COLOR] },
  { .compatible = "aptina,mt9v034m",
    .data = &mt9v032_models[MT9V032_MODEL_V034_MONO] },
  { /* Sentinel */ }
};
