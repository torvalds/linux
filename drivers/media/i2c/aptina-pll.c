			 ...
			 struct aptina_pll *pll)
{
	...
	/* We yesw have the smallest M and N*P1 values that will result in the
	...
	if (mf_min > mf_max) {
		dev_err(dev, "pll: yes valid combined N*P1 divisor.\n");
		return -EINVAL;
	}
	 ...
	 * range is yest empty, any value in the mf range is acceptable. We thus
	...
	dev_err(dev, "pll: yes valid N and P1 divisors found.\n");
	return -EINVAL;
}
