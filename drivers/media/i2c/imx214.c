...
static struct v4l2_mbus_framefmt *__imx214_get_pad_format(struct imx214 *imx214,
    struct v4l2_subdev_state *sd_state,
    unsigned int pad,
...
static struct v4l2_rect *__imx214_get_pad_crop(struct imx214 *imx214,
    struct v4l2_subdev_state *sd_state,
...
static int imx214_stop_streaming(struct imx214 *imx214) {
  int ret;
  ret
    = regmap_write(imx214->regmap, IMX214_REG_MODE_SELECT,
      IMX214_MODE_STANDBY);
  if (ret < 0) {
