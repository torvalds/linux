...
struct saa711x_reg_descr saa711x_regs[] = {
  ...
  /* Video Decoder - Decoder part: R_06_H_SYNC_START to
  ...
  /* Component processing and interrupt masking part:  0x20h to
  ...
  /* X port, I port and the scaler part: R_80_GLOBAL_CNTL_1 to
   *R_EF_B_VERT_LUMA_PHASE_OFF_11
   * Task independent global settings: R_80_GLOBAL_CNTL_1 to
  ...
  /* Task A definition: R_90_A_TASK_HANDLING_CNTL to
  ...
  /* Task B definition: R_C0_B_TASK_HANDLING_CNTL to
   *R_EF_B_VERT_LUMA_PHASE_OFF_11
