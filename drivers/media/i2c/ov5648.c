...
static int ov5648_chip_id_check(struct ov5648_sensor *sensor) {
  u16 regs[] = {
    OV5648_CHIP_ID_H_REG, OV5648_CHIP_ID_L_REG
  };
  u8 values[] = {
    OV5648_CHIP_ID_H_VALUE, OV5648_CHIP_ID_L_VALUE
  };
  unsigned int i;
  u8 value;
  int ret;
...
static int ov5648_exposure_configure(struct ov5648_sensor *sensor,
    u32 exposure) {
...
static int ov5648_gain_auto_configure(struct ov5648_sensor *sensor,
    bool enable) {
  return ov5648_update_bits(sensor, OV5648_MANUAL_CTRL_REG,
...
static int ov5648_flip_vert_configure(struct ov5648_sensor *sensor,
    bool enable) {
...
static int ov5648_flip_horz_configure(struct ov5648_sensor *sensor,
    bool enable) {
