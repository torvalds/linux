...
static void wm8775_set_audio(struct v4l2_subdev *sd, int quietly) {
  ...
  wm8775_write(sd, R14, vol_l | 0x100); /* 0x100= Left channel ADC zero cross
                                         * enable */
  wm8775_write(sd, R15, vol_r | 0x100); /* 0x100= Right channel ADC zero cross
                                         * enable */
  /* Un-mute */
  if (!muted) {
...
static int wm8775_s_frequency(struct v4l2_subdev *sd,
