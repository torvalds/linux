...
int msp_reset(struct i2c_client *client) {
  ...
  static u8 reset_off[3] = {
    I2C_MSP_CONTROL, 0x80, 0x00
  };
  static u8 reset_on[3] = {
    I2C_MSP_CONTROL, 0x00, 0x00
  };
  static u8 write[3] = {
    I2C_MSP_DSP + 1, 0x00, 0x1e
  };
  u8 read[2];
...
static int msp_s_frequency(struct v4l2_subdev *sd,
