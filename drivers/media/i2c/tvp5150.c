...
static struct v4l2_rect *tvp5150_get_pad_crop(struct tvp5150 *decoder,
...
static int tvp5150_s_raw_fmt(struct v4l2_subdev *sd,
...
static int tvp5150_s_sliced_fmt(struct v4l2_subdev *sd,
...
static int tvp5150_g_sliced_fmt(struct v4l2_subdev *sd,
    struct v4l2_sliced_vbi_format *svbi) {
  int i, mask = 0;
...
static int tvp5150_g_register(struct v4l2_subdev *sd,
...
static int tvp5150_s_register(struct v4l2_subdev *sd,
...
static int tvp5150_parse_dt(struct tvp5150 *decoder, struct device_node *np) {
  ...
  if (ep_num < 2 || ep_num > 5) {
    dev_err(dev,
        "At least 1 input and 1 output must be connected to the device.\n");
    return -EINVAL;
  }
