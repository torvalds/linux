...
static int alvium_set_ctrl_red_balance_ratio(struct alvium_dev *alvium,
    int red) {
  struct device *dev = &alvium->i2c_client->dev;
  int ret;
...
static const struct alvium_pixfmt *alvium_code_to_pixfmt(
    struct alvium_dev *alvium, u32 code) {
  unsigned int i;
