...
static int ccs_data_parse_length_specifier(
    const struct __ccs_data_length_specifier *__len,
...
static u8 ccs_data_parse_format_version(const struct __ccs_data_block *block) {
...
static int ccs_data_parse_pdaf(struct bin_container *bin,
