...
const struct ccs_limit ccs_limits[] = {
  ...
  { CCS_R_ANALOG_EXPONENTIAL_GAIN_STEP_SIZE, 2, 0,
  ...
  { CCS_R_COARSE_INTEGRATION_TIME_MAX_MARGIN, 2, 0,
    "coarse_integration_time_max_margin" },
  { CCS_R_FINE_INTEGRATION_TIME_MIN, 2, 0, "fine_integration_time_min" },
  { CCS_R_FINE_INTEGRATION_TIME_MAX_MARGIN, 2, 0,
  ...
  { CCS_R_MIN_LINE_LENGTH_PCK_STEP_SIZE, 1, 0,
  ...
  { CCS_R_NON_FLEXIBLE_RESOLUTION_SUPPORT, 1, 0,
    "non_flexible_resolution_support" },
  ...
  { CCS_R_CSI_DPHY_LANE_MODE_CAPABILITY, 1, 0,
    "csi_dphy_lane_mode_capability" },
  { CCS_R_CSI_SIGNALING_MODE_CAPABILITY, 1, 0,
    "csi_signaling_mode_capability" },
  { CCS_R_FAST_STANDBY_CAPABILITY, 1, 0, "fast_standby_capability" },
  { CCS_R_CSI_ADDRESS_CONTROL_CAPABILITY, 1, 0,
    "csi_address_control_capability" },
  { CCS_R_DATA_TYPE_CAPABILITY, 1, 0, "data_type_capability" },
  { CCS_R_CSI_CPHY_LANE_MODE_CAPABILITY, 1, 0,
    "csi_cphy_lane_mode_capability" },
  { CCS_R_EMB_DATA_CAPABILITY, 1, 0, "emb_data_capability" },
  { CCS_R_MAX_PER_LANE_BITRATE_LANE_D_MODE_MBPS(0), 16, 0,
    "max_per_lane_bitrate_lane_d_mode_mbps 0" },
  { CCS_R_MAX_PER_LANE_BITRATE_LANE_D_MODE_MBPS(4), 16, CCS_L_FL_SAME_REG,
    "max_per_lane_bitrate_lane_d_mode_mbps 4" },
  { CCS_R_TEMP_SENSOR_CAPABILITY, 1, 0, "temp_sensor_capability" },
  { CCS_R_MAX_PER_LANE_BITRATE_LANE_C_MODE_MBPS(0), 16, 0,
    "max_per_lane_bitrate_lane_c_mode_mbps 0" },
  { CCS_R_MAX_PER_LANE_BITRATE_LANE_C_MODE_MBPS(4), 16, CCS_L_FL_SAME_REG,
    "max_per_lane_bitrate_lane_c_mode_mbps 4" },
  ...
  { CCS_R_CSI2_INTERFACE_CAPABILITY_MISC, 1, 0,
    "CSI2_interface_capability_misc" },
  ...
  { CCS_R_FINE_INTEGRATION_TIME_MIN_BIN, 2, 0,
    "fine_integration_time_min_bin" },
  { CCS_R_FINE_INTEGRATION_TIME_MAX_MARGIN_BIN, 2, 0,
    "fine_integration_time_max_margin_bin" },
  ...
  { CCS_R_BINNING_WEIGHTING_MONO_CAPABILITY, 1, 0,
    "binning_weighting_mono_capability" },
  ...
  { CCS_R_SHADING_CORRECTION_CAPABILITY, 1, 0,
    "shading_correction_capability" },
  { CCS_R_GREEN_IMBALANCE_CAPABILITY, 1, 0, "green_imbalance_capability" },
  { CCS_R_MODULE_SPECIFIC_CORRECTION_CAPABILITY, 1, 0,
    "module_specific_correction_capability" },
  { CCS_R_DEFECT_CORRECTION_CAPABILITY, 2, 0, "defect_correction_capability" },
  { CCS_R_DEFECT_CORRECTION_CAPABILITY_2, 2, 0,
    "defect_correction_capability_2" },
  ...
  { CCS_R_CFA_PATTERN_CONVERSION_CAPABILITY, 1, 0,
    "CFA_pattern_conversion_capability" },
