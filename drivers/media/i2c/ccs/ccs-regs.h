...
#define CCS_BUILD_BUG \
  BUILD_BUG_ON(~CCI_REG_PRIVATE_MASK \
    & (BIT(CCS_FL_BASE) | BIT(CCS_FL_BASE + 1)))
...
#define CCS_R_LANE_SEED_VALUE(seed, \
      lane)     CCI_REG16(0x0872 + (seed) * 16 + (lane) * 2)
...
#define CCS_R_MIN_EXT_CLK_FREQ_MHZ        (CCI_REG32(0x1100) \
  | CCS_FL_FLOAT_IREAL)
#define CCS_R_MAX_EXT_CLK_FREQ_MHZ        (CCI_REG32(0x1104) \
  | CCS_FL_FLOAT_IREAL)
#define CCS_R_MIN_PRE_PLL_CLK_DIV       CCI_REG16(0x1108)
#define CCS_R_MAX_PRE_PLL_CLK_DIV       CCI_REG16(0x110a)
#define CCS_R_MIN_PLL_IP_CLK_FREQ_MHZ       (CCI_REG32(0x110c) \
  | CCS_FL_FLOAT_IREAL)
#define CCS_R_MAX_PLL_IP_CLK_FREQ_MHZ       (CCI_REG32(0x1110) \
  | CCS_FL_FLOAT_IREAL)
#define CCS_R_MIN_PLL_MULTIPLIER        CCI_REG16(0x1114)
#define CCS_R_MAX_PLL_MULTIPLIER        CCI_REG16(0x1116)
#define CCS_R_MIN_PLL_OP_CLK_FREQ_MHZ       (CCI_REG32(0x1118) \
  | CCS_FL_FLOAT_IREAL)
#define CCS_R_MAX_PLL_OP_CLK_FREQ_MHZ       (CCI_REG32(0x111c) \
  | CCS_FL_FLOAT_IREAL)
#define CCS_R_MIN_VT_SYS_CLK_DIV        CCI_REG16(0x1120)
#define CCS_R_MAX_VT_SYS_CLK_DIV        CCI_REG16(0x1122)
#define CCS_R_MIN_VT_SYS_CLK_FREQ_MHZ       (CCI_REG32(0x1124) \
  | CCS_FL_FLOAT_IREAL)
#define CCS_R_MAX_VT_SYS_CLK_FREQ_MHZ       (CCI_REG32(0x1128) \
  | CCS_FL_FLOAT_IREAL)
#define CCS_R_MIN_VT_PIX_CLK_FREQ_MHZ       (CCI_REG32(0x112c) \
  | CCS_FL_FLOAT_IREAL)
#define CCS_R_MAX_VT_PIX_CLK_FREQ_MHZ       (CCI_REG32(0x1130) \
  | CCS_FL_FLOAT_IREAL)
...
#define CCS_R_MIN_OP_SYS_CLK_FREQ_MHZ       (CCI_REG32(0x1164) \
  | CCS_FL_FLOAT_IREAL)
#define CCS_R_MAX_OP_SYS_CLK_FREQ_MHZ       (CCI_REG32(0x1168) \
  | CCS_FL_FLOAT_IREAL)
#define CCS_R_MIN_OP_PIX_CLK_DIV        CCI_REG16(0x116c)
#define CCS_R_MAX_OP_PIX_CLK_DIV        CCI_REG16(0x116e)
#define CCS_R_MIN_OP_PIX_CLK_FREQ_MHZ       (CCI_REG32(0x1170) \
  | CCS_FL_FLOAT_IREAL)
#define CCS_R_MAX_OP_PIX_CLK_FREQ_MHZ       (CCI_REG32(0x1174) \
  | CCS_FL_FLOAT_IREAL)
...
#define CCS_R_MIN_OP_PLL_IP_CLK_FREQ_MHZ      (CCI_REG32(0x11a4) \
  | CCS_FL_FLOAT_IREAL)
#define CCS_R_MAX_OP_PLL_IP_CLK_FREQ_MHZ      (CCI_REG32(0x11a8) \
  | CCS_FL_FLOAT_IREAL)
#define CCS_R_MIN_OP_PLL_MULTIPLIER       CCI_REG16(0x11ac)
#define CCS_R_MAX_OP_PLL_MULTIPLIER       CCI_REG16(0x11ae)
#define CCS_R_MIN_OP_PLL_OP_CLK_FREQ_MHZ      (CCI_REG32(0x11b0) \
  | CCS_FL_FLOAT_IREAL)
#define CCS_R_MAX_OP_PLL_OP_CLK_FREQ_MHZ      (CCI_REG32(0x11b4) \
  | CCS_FL_FLOAT_IREAL)
...
#define CCS_R_MIN_OP_SYS_CLK_FREQ_REV_MHZ     (CCI_REG32(0x123c) \
  | CCS_FL_FLOAT_IREAL)
#define CCS_R_MAX_OP_SYS_CLK_FREQ_REV_MHZ     (CCI_REG32(0x1240) \
  | CCS_FL_FLOAT_IREAL)
#define CCS_R_MIN_OP_PIX_CLK_FREQ_REV_MHZ     (CCI_REG32(0x1244) \
  | CCS_FL_FLOAT_IREAL)
#define CCS_R_MAX_OP_PIX_CLK_FREQ_REV_MHZ     (CCI_REG32(0x1248) \
  | CCS_FL_FLOAT_IREAL)
...
#define CCS_R_MAX_PER_LANE_BITRATE_LANE_D_MODE_MBPS(n)    (CCI_REG32(0x1608 \
    + ((n) < 4 ? (n) * 4 : 0x32 + ((n) - 4) * 4)) | CCS_FL_IREAL)
...
#define CCS_R_MAX_PER_LANE_BITRATE_LANE_C_MODE_MBPS(n)    (CCI_REG32(0x161a \
    + ((n) < 4 ? (n) * 4 : 0x30 + ((n) - 4) * 4)) | CCS_FL_IREAL)
