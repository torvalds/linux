...
static int jt8ew9_post_poweron(struct ccs_sensor *sensor) {
  static const struct ccs_reg_8 regs[] = {
    ...
    { 0x30ae, 0x00 }, /* 0x0307 pll_multiplier maximum value on PLL input 9.6MHz
                       * ( 19.2MHz is divided on pre_pll_div) */
    { 0x30af, 0xd0 }, /* 0x0307 pll_multiplier maximum value on PLL input 9.6MHz
                       * ( 19.2MHz is divided on pre_pll_div) */
    { 0x322d, 0x04 }, /* Adjusting Processing Image Size to Scaler Toshiba
                       * Recommendation Setting */
    { 0x3255, 0x0f }, /* Horizontal Noise Reduction Control Toshiba
                       * Recommendation Setting */
    { 0x3256, 0x15 }, /* Horizontal Noise Reduction Control Toshiba
                       * Recommendation Setting */
    ...
    { 0x3302, 0x06 }, /* Pixel Reference Voltage Control Toshiba Recommendation
                       * Setting */
    { 0x3304, 0x00 }, /* Pixel Reference Voltage Control Toshiba Recommendation
                       * Setting */
    { 0x3307, 0x22 }, /* Pixel Reference Voltage Control Toshiba Recommendation
                       * Setting */
    { 0x3308, 0x8d }, /* Pixel Reference Voltage Control Toshiba Recommendation
                       * Setting */
    { 0x331e, 0x0f }, /* Black Hole Sun Correction Control Toshiba
                       * Recommendation Setting */
    { 0x3320, 0x30 }, /* Black Hole Sun Correction Control Toshiba
                       * Recommendation Setting */
    { 0x3321, 0x11 }, /* Black Hole Sun Correction Control Toshiba
                       * Recommendation Setting */
    { 0x3322, 0x98 }, /* Black Hole Sun Correction Control Toshiba
                       * Recommendation Setting */
    { 0x3323, 0x64 }, /* Black Hole Sun Correction Control Toshiba
                       * Recommendation Setting */
    ...
    { 0x333c, 0x01 }, /* Read Out Timing Control Toshiba Recommendation Setting
                       * */
    { 0x3345, 0x2f }, /* Black Hole Sun Correction Control Toshiba
                       * Recommendation Setting */
    { 0x33de, 0x38 }, /* Horizontal Noise Reduction Control Toshiba
                       * Recommendation Setting */
