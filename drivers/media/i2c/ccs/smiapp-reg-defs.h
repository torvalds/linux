...
#define SMIAPP_REG_U16_FRAME_FORMAT_DESCRIPTOR_2(n)   CCI_REG16(0x0042 \
    + ((n) << 1)) /* 0 <= n <= 14 */
#define SMIAPP_REG_U32_FRAME_FORMAT_DESCRIPTOR_4(n)   CCI_REG32(0x0060 \
    + ((n) << 2)) /* 0 <= n <= 7 */
...
#define SMIAPP_REG_U16_DATA_FORMAT_DESCRIPTOR(n)    CCI_REG16( \
    0x00c2 + ((n) << 1))
...
#define SMIAPP_REG_F32_MIN_EXT_CLK_FREQ_HZ      (CCI_REG32(0x1100) \
  | CCS_FL_FLOAT_IREAL)
#define SMIAPP_REG_F32_MAX_EXT_CLK_FREQ_HZ      (CCI_REG32(0x1104) \
  | CCS_FL_FLOAT_IREAL)
#define SMIAPP_REG_U16_MIN_PRE_PLL_CLK_DIV      CCI_REG16(0x1108)
#define SMIAPP_REG_U16_MAX_PRE_PLL_CLK_DIV      CCI_REG16(0x110a)
#define SMIAPP_REG_F32_MIN_PLL_IP_FREQ_HZ     (CCI_REG32(0x110c) \
  | CCS_FL_FLOAT_IREAL)
#define SMIAPP_REG_F32_MAX_PLL_IP_FREQ_HZ     (CCI_REG32(0x1110) \
  | CCS_FL_FLOAT_IREAL)
#define SMIAPP_REG_U16_MIN_PLL_MULTIPLIER     CCI_REG16(0x1114)
#define SMIAPP_REG_U16_MAX_PLL_MULTIPLIER     CCI_REG16(0x1116)
#define SMIAPP_REG_F32_MIN_PLL_OP_FREQ_HZ     (CCI_REG32(0x1118) \
  | CCS_FL_FLOAT_IREAL)
#define SMIAPP_REG_F32_MAX_PLL_OP_FREQ_HZ     (CCI_REG32(0x111c) \
  | CCS_FL_FLOAT_IREAL)
#define SMIAPP_REG_U16_MIN_VT_SYS_CLK_DIV     CCI_REG16(0x1120)
#define SMIAPP_REG_U16_MAX_VT_SYS_CLK_DIV     CCI_REG16(0x1122)
#define SMIAPP_REG_F32_MIN_VT_SYS_CLK_FREQ_HZ     (CCI_REG32(0x1124) \
  | CCS_FL_FLOAT_IREAL)
#define SMIAPP_REG_F32_MAX_VT_SYS_CLK_FREQ_HZ     (CCI_REG32(0x1128) \
  | CCS_FL_FLOAT_IREAL)
#define SMIAPP_REG_F32_MIN_VT_PIX_CLK_FREQ_HZ     (CCI_REG32(0x112c) \
  | CCS_FL_FLOAT_IREAL)
#define SMIAPP_REG_F32_MAX_VT_PIX_CLK_FREQ_HZ     (CCI_REG32(0x1130) \
  | CCS_FL_FLOAT_IREAL)
...
#define SMIAPP_REG_F32_MIN_OP_SYS_CLK_FREQ_HZ     (CCI_REG32(0x1164) \
  | CCS_FL_FLOAT_IREAL)
#define SMIAPP_REG_F32_MAX_OP_SYS_CLK_FREQ_HZ     (CCI_REG32(0x1168) \
  | CCS_FL_FLOAT_IREAL)
#define SMIAPP_REG_U16_MIN_OP_PIX_CLK_DIV     CCI_REG16(0x116c)
#define SMIAPP_REG_U16_MAX_OP_PIX_CLK_DIV     CCI_REG16(0x116e)
#define SMIAPP_REG_F32_MIN_OP_PIX_CLK_FREQ_HZ     (CCI_REG32(0x1170) \
  | CCS_FL_FLOAT_IREAL)
#define SMIAPP_REG_F32_MAX_OP_PIX_CLK_FREQ_HZ     (CCI_REG32(0x1174) \
  | CCS_FL_FLOAT_IREAL)
...
#define SMIAPP_REG_U8_BINNING_TYPE_n(n)       CCI_REG8(0x1713 + (n)) /* 1 <= n
                                                                      * <= 237
                                                                      * */
