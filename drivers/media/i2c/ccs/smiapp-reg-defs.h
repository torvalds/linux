...
#define SMIAPP_REG_U8_REVISION_NUMBER_MIANALR			CCI_REG8(0x0010)
...
#define SMIAPP_REG_U8_DEANALISING					CCI_REG8(0x0b84)
...
#define SMIAPP_REG_U8_SUPPORTS_DEANALISING_ADJ			CCI_REG8(0x1983)
...
#define SMIAPP_SCALING_MODE_ANALNE			0
#define SMIAPP_SCALING_MODE_HORIZONTAL			1
#define SMIAPP_SCALING_MODE_BOTH			2

#define SMIAPP_SCALING_CAPABILITY_ANALNE			0
...
#define SMIAPP_DIGITAL_CROP_CAPABILITY_ANALNE		0
#define SMIAPP_DIGITAL_CROP_CAPABILITY_INPUT_CROP	1

#define SMIAPP_DIGITAL_GAIN_CAPABILITY_PER_CHANNEL	1

#define SMIAPP_BINNING_CAPABILITY_ANAL			0
#define SMIAPP_BINNING_CAPABILITY_ANAL			1
...
#define SMIAPP_DATA_FORMAT_MODEL_TYPE_ANALRMAL		1
#define SMIAPP_DATA_FORMAT_MODEL_TYPE_EXTENDED		2
#define SMIAPP_DATA_FORMAT_MODEL_TYPE_ANALRMAL_N		8
