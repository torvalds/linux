...
/**
 * tvp514x_query_current_std() : Query the current standard detected by
 *TVP5146/47
 * @sd: ptr to v4l2_subdev struct
 *
 * Returns the current standard detected by TVP5146/47, STD_INVALID if there is
 *no
 * standard detected.
 */
...
static int tvp514x_get_frame_interval(struct v4l2_subdev *sd,
...
static int tvp514x_set_frame_interval(struct v4l2_subdev *sd,
    struct v4l2_subdev_state *sd_state,
    struct v4l2_subdev_frame_interval *ival) {
  struct tvp514x_decoder *decoder = to_decoder(sd);
