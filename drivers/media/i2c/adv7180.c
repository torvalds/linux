...
static int adv7180_g_pixelaspect(struct v4l2_subdev *sd,
...
static int adv7180_select_input(struct adv7180_state *state,
    unsigned int input) {
  int ret;
...
static int adv7182_select_input(struct adv7180_state *state,
    unsigned int input) {
