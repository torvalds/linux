...
static int upd64031a_s_frequency(struct v4l2_subdev *sd,
...
static int upd64031a_g_register(struct v4l2_subdev *sd,
...
static int upd64031a_s_register(struct v4l2_subdev *sd,
