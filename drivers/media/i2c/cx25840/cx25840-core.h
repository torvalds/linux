 ...
 * @volume:		audio volume V4L2 control (yesn-cx2583x devices only)
 * @mute:		audio mute V4L2 control (yesn-cx2583x devices only)
 ...
 *			the current mode is yesn-radio (that is, video)
 ...
 * @audmode:		currently set audio mode (when in yesn-radio mode)
