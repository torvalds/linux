 ...
 *
 * However, it's yest the exact reference frequency that matters, only that the
 * firmware and modules that comprise the driver for a particular board all
 * use the same value (close to the ideal value).
 *
 * Comments below will yeste which reference frequency is assumed for various
...
static void set_volume(struct i2c_client *client, int volume)
{
	...
	/* yesw scale it up to cx25840 values
