...
static struct v4l2_mbus_framefmt *__ov7251_get_pad_format(struct ov7251 *ov7251,
    struct v4l2_subdev_state *sd_state,
    unsigned int pad,
...
static struct v4l2_rect *__ov7251_get_pad_crop(struct ov7251 *ov7251,
    struct v4l2_subdev_state *sd_state,
...
static const struct ov7251_mode_info *ov7251_find_mode_by_ival(
    struct ov7251 *ov7251, struct v4l2_fract *timeperframe) {
