...
static struct v4l2_mbus_framefmt *__mt9p031_get_pad_format(
...
static struct v4l2_rect *__mt9p031_get_pad_crop(struct mt9p031 *mt9p031,
    struct v4l2_subdev_state *sd_state,
    unsigned int pad, u32 which) {
  switch (which) {
    case V4L2_SUBDEV_FORMAT_TRY:
...
static int mt9p031_close(struct v4l2_subdev *subdev,
...
static struct mt9p031_platform_data *mt9p031_get_pdata(
