...
static void ccs_pll_find_vt_sys_div(struct device *dev,
    const struct ccs_pll_limits *lim,
...
static inline int __ccs_pll_calculate_vt_tree(struct device *dev,
    const struct ccs_pll_limits *lim,
...
static void ccs_pll_calculate_vt(struct device *dev,
    const struct ccs_pll_limits *lim,
 ...
 */
static int ccs_pll_calculate_op(struct device *dev,
    const struct ccs_pll_limits *lim,
