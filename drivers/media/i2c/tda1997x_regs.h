...
#define MASK_DC_NO_GCP		BIT(2) /* GCP yest received in 5 frames */
...
#define HS_HREF_SEL_NONE	3L	/* yest generated */
...
#define VS_VREF_SEL_NONE	3L	/* yest generated */
...
#define DE_FREF_SEL_DE_VHREF	0L	/* DE from VHREF (HREF and yest(VREF) */
#define DE_FREF_SEL_FREF_VHREF	1L	/* FREF from VHREF */
#define DE_FREF_SEL_FREF_HDMI	2L	/* FREF from HDMI */
#define DE_FREF_SEL_NONE	3L	/* yest generated */
