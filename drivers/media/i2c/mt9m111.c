...
static int mt9m111_setup_geometry(struct mt9m111 *mt9m111,
...
static int mt9m111_set_selection(struct v4l2_subdev *sd,
  ...
  ret
    = mt9m111_setup_geometry(mt9m111, &rect, width, height,
      mt9m111->fmt->code);
  if (!ret) {
    mt9m111->rect = rect;
    mt9m111->width = width;
...
static const struct mt9m111_mode_info *mt9m111_find_mode(
...
static int mt9m111_probe_fw(struct i2c_client *client,
    struct mt9m111 *mt9m111) {
