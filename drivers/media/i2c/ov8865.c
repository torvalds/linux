...
static int ov8865_chip_id_check(struct ov8865_sensor *sensor) {
  u16 regs[] = {
    OV8865_CHIP_ID_HH_REG, OV8865_CHIP_ID_H_REG,
    OV8865_CHIP_ID_L_REG
  };
  u8 values[] = {
    OV8865_CHIP_ID_HH_VALUE, OV8865_CHIP_ID_H_VALUE,
...
static int ov8865_exposure_configure(struct ov8865_sensor *sensor,
    u32 exposure) {
  int ret;
...
static int ov8865_analog_gain_configure(struct ov8865_sensor *sensor,
    u32 gain) {
  int ret;
...
static int ov8865_flip_vert_configure(struct ov8865_sensor *sensor,
    bool enable) {
...
static int ov8865_flip_horz_configure(struct ov8865_sensor *sensor,
    bool enable) {
...
static void __ov8865_get_pad_crop(struct ov8865_sensor *sensor,
