...
static int ov5693_analog_gain_configure(struct ov5693_device *ov5693,
    u32 gain) {
  int ret = 0;
...
static int ov5693_test_pattern_configure(struct ov5693_device *ov5693,
    u32 idx) {
  int ret = 0;
...
static struct v4l2_mbus_framefmt *__ov5693_get_pad_format(
    struct ov5693_device *ov5693,
...
static struct v4l2_rect *__ov5693_get_pad_crop(struct ov5693_device *ov5693,
    struct v4l2_subdev_state *state,
    unsigned int pad, enum v4l2_subdev_format_whence which) {
  switch (which) {
    case V4L2_SUBDEV_FORMAT_TRY:
