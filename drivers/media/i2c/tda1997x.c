...
static unsigned int io_readn(struct v4l2_subdev *sd, u16 reg, u8 len,
    u8 *data) {
  int i;
  int sz = 0;
  int val;
 ...
 */
static void tda1997x_configure_csc(struct v4l2_subdev *sd) {
  struct tda1997x_state *state = to_state(sd);
  ...
  static const struct blanking_codes rgb_blanking = {
    64, 64, 64
  };
  static const struct blanking_codes yuv_blanking = {
    64, 512, 512
  };
...
static void tda1997x_configure_vhref(struct v4l2_subdev *sd) {
  struct tda1997x_state *state = to_state(sd);
...
static int tda1997x_configure_vidout(struct tda1997x_state *state) {
  struct v4l2_subdev *sd = &state->sd;
...
static int tda1997x_configure_audout(struct v4l2_subdev *sd,
...
static int tda1997x_hdmi_info_reset(struct v4l2_subdev *sd, u8 info_rst,
    bool reset_sus) {
  u8 reg;
...
static void set_rgb_quantization_range(struct tda1997x_state *state) {
  struct v4l2_hdmi_colorimetry *c = &state->colorimetry;
...
static unsigned int tda1997x_parse_infoframe(struct tda1997x_state *state,
    u16 addr) {
  struct v4l2_subdev *sd = &state->sd;
