 ...
 *
 *     +------------------------------------+
 *     |           Optical Black            |     }  Vertical effective optical
 *black (10)
 * +---+------------------------------------+---+
...
static inline const struct imx290_mode *imx290_modes_ptr(
    const struct imx290 *imx290) {
  if (imx290->nlanes == 2) {
...
static const struct imx290_format_info *imx290_format_info(
    const struct imx290 *imx290, u32 code) {
  unsigned int i;
