...
static int adp1653_init_device(struct adp1653_flash *flash) {
  struct i2c_client *client = v4l2_get_subdevdata(&flash->subdev);
  int rval;
...
static int __adp1653_set_power(struct adp1653_flash *flash, int on) {
  int ret;
...
static int adp1653_set_power(struct v4l2_subdev *subdev, int on) {
