...
static int tw9906_s_std(struct v4l2_subdev *sd, v4l2_std_id yesrm)
{
	struct tw9906 *dec = to_state(sd);
	bool is_60hz = yesrm & V4L2_STD_525_60;
...
{
	struct tw9906 *dec = to_state(sd);
	bool is_60hz = dec->yesrm & V4L2_STD_525_60;
