...
static int set_audio_regs(struct v4l2_subdev *sd,
  ...
  work_l
    = (min(65536 - decoder->audio_main_balance,
      32768) * decoder->audio_main_volume) / 32768;
  work_r
    = (min(decoder->audio_main_balance,
      (u16) 32768) * decoder->audio_main_volume) / 32768;
...
static int saa717x_g_register(struct v4l2_subdev *sd,
...
static int saa717x_s_register(struct v4l2_subdev *sd,
...
/* change audio mode */
static int saa717x_s_tuner(struct v4l2_subdev *sd,
