 ...
 *	Geryest Ziegler <gz@lysator.liu.se>
 *
 * Version History:
 ...
 * during the place where the ackyeswledge bit should be. Any standard
 * I2C implementation (correctly) throws in ayesther clock transition
 * at the 9th bit, and the KS0127 will yest recognize the stop condition
...
static void ks0127_init(struct v4l2_subdev *sd)
{
	...
	/* initialize all registers to kyeswn values */
	...
	default:
		v4l2_dbg(1, debug, sd, "unkyeswn revision\n");
		break;
	}
}
...
static int ks0127_s_std(struct v4l2_subdev *sd, v4l2_std_id std)
{
	...
	if (std & V4L2_STD_NTSC) {
		...
		v4l2_dbg(1, debug, sd, "s_std: Unkyeswn yesrm %llx\n",
