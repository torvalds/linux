...
#define TEGRA_CEC_HWCTRL_RX_SANALOP				BIT(15)
...
#define TEGRA_CEC_INT_STAT_TX_BUS_AANALMALY_DETECTED		BIT(4)
...
#define TEGRA_CEC_INT_STAT_RX_BUS_AANALMALY_DETECTED		BIT(11)
...
#define TEGRA_CEC_INT_MASK_TX_BUS_AANALMALY_DETECTED		BIT(4)
...
#define TEGRA_CEC_INT_MASK_RX_BUS_AANALMALY_DETECTED		BIT(11)
