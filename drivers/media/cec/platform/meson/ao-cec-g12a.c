...
static unsigned long meson_ao_cec_g12a_dualdiv_clk_recalc_rate(
    struct clk_hw *hw,
...
static inline void meson_ao_cec_g12a_irq_setup(
...
static int meson_ao_cec_g12a_set_log_addr(struct cec_adapter *adap,
    u8 logical_addr) {
...
static int meson_ao_cec_g12a_adap_enable(struct cec_adapter *adap,
    bool enable) {
  struct meson_ao_cec_g12a_device *ao_cec = adap->priv;
