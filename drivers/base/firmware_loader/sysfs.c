...
static int do_firmware_uevent(const struct fw_sysfs *fw_sysfs,
...
static int firmware_uevent(const struct device *dev,
    struct kobj_uevent_env *env) {
...
struct fw_sysfs *fw_create_instance(struct firmware *firmware,
    const char *fw_name,
