 ...
 */
static int br_trans_tx_prepare(struct spi_avmm_bridge *br, bool is_read,
    u32 reg,
...
static int regmap_spi_avmm_write(void *context, const void *data,
    size_t bytes) {
...
static struct spi_avmm_bridge *spi_avmm_bridge_ctx_gen(struct spi_device *spi) {
