...
static void remove_component(struct aggregate_device *adev,
    struct component *c) {
  size_t i;
...
/**
 * component_compare_dev_name - A common component compare function for device
 *name
 * @dev: component device
 * @data: @compare_data from component_match_add_release()
 *
