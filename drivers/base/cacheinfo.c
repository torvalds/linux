...
#else
static inline int cache_setup_of_node(unsigned int cpu) {
  return 0;
}
...
static umode_t cache_default_attrs_is_visible(struct kobject *kobj,
...
static const struct attribute_group **cache_get_attribute_groups(
    struct cacheinfo *this_leaf) {
