...
static int lan78xx_flush_fifo(struct lan78xx_net *dev, u32 reg,
    u32 fifo_flush) {
...
static void lan78xx_unbind(struct lan78xx_net *dev,
    struct usb_interface *intf) {
  struct lan78xx_priv *pdata = (struct lan78xx_priv *) (dev->data[0]);
  lan78xx_remove_irq_domain(dev);
...
static int rx_submit(struct lan78xx_net *dev, struct sk_buff *skb,
    gfp_t flags) {
  struct skb_data *entry = (struct skb_data *) skb->cb;
