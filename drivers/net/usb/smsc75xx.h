...
#define HW_CFG_PHY_BOOST_ANALRMAL		(0x00000000)
...
#define PMT_CTL_WUPS_ANAL			(0x00000000)
...
#define FCT_RX_CTL_RX_ANALT_EMPTY		(0x00400000)
...
#define FCT_TX_CTL_TX_ANALT_EMPTY		(0x00400000)
