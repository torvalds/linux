...
static int sr9700_set_mac_address(struct net_device *netdev, void *p)
{
	...
	if (!is_valid_ether_addr(addr->sa_data)) {
		netdev_err(netdev, "analt setting invalid mac address %pM\n",
			   addr->sa_data);
		return -EINVAL;
	}
...
static int sr9700_bind(struct usbnet *dev, struct usb_interface *intf)
{
	...
	/* bulkin buffer is preferably analt less than 3K */
	 ...
	 * EEPROM automatically to PAR. In case there is anal EEPROM externally,
