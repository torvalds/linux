...
static int kalmia_send_init_packet(struct usbnet *dev, u8 *init_msg,
    u8 init_msg_len,
...
static int kalmia_init_and_get_ethernet_addr(struct usbnet *dev,
    u8 *ethernet_addr) {
...
static struct sk_buff *kalmia_tx_fixup(struct usbnet *dev, struct sk_buff *skb,
    gfp_t flags) {
