...
static netdev_tx_t qmimux_start_xmit(struct sk_buff *skb,
...
static ssize_t mux_id_show(struct device *d, struct device_attribute *attr,
    char *buf) {
...
static ssize_t del_mux_show(struct device *d, struct device_attribute *attr,
    char *buf) {
...
static const struct usb_device_id products[] = {
  ...
  { /* Huawei E392, E398 and possibly others sharing both device id and more...
     * */
    USB_VENDOR_AND_INTERFACE_INFO(HUAWEI_VENDOR_ID, USB_CLASS_VENDOR_SPEC, 1,
        9),
    .driver_info = (unsigned long) &qmi_wwan_info,
  },
  ...
  { /* HUAWEI_INTERFACE_NDIS_CONTROL_QUALCOMM */
    USB_VENDOR_AND_INTERFACE_INFO(HUAWEI_VENDOR_ID, USB_CLASS_VENDOR_SPEC, 0x01,
        0x69),
    .driver_info = (unsigned long) &qmi_wwan_info,
  },
  ...
  {QMI_QUIRK_SET_DTR(0x05c6, 0x9025, 4)}, /* Alcatel-sbell ASB TL131 TDD LTE
                                           * (China Mobile) */
  ...
  {QMI_QUIRK_SET_DTR(0x1199, 0x68c0, 8)}, /* Sierra Wireless MC7304/MC7354,
                                           * WP76xx */
  ...
  {QMI_FIXED_INTF(0x1bbb, 0x011e, 4)},  /* Telekom Speedstick LTE II (Alcatel
                                         * One Touch L100V LTE) */
  ...
  {QMI_FIXED_INTF(0x1e2d, 0x0083, 4)},  /* Cinterion PHxx,PXxx (1 RmNet + USB
                                         * Audio)*/
  {QMI_QUIRK_SET_DTR(0x1e2d, 0x00b0, 4)}, /* Cinterion CLS8 */
  {QMI_FIXED_INTF(0x1e2d, 0x00b7, 0)},  /* Cinterion MV31 RmNet */
  {QMI_FIXED_INTF(0x1e2d, 0x00b9, 0)},  /* Cinterion MV31 RmNet based on new
                                         * baseline */
  {QMI_FIXED_INTF(0x1e2d, 0x00f3, 0)},  /* Cinterion MV32-W-A RmNet */
  {QMI_FIXED_INTF(0x1e2d, 0x00f4, 0)},  /* Cinterion MV32-W-B RmNet */
  {QMI_FIXED_INTF(0x413c, 0x81a2, 8)},  /* Dell Wireless 5806 Gobi(TM) 4G LTE
  ...
  {QMI_FIXED_INTF(0x413c, 0x81a4, 8)},  /* Dell Wireless 5570e HSPA+ (42Mbps)
                                         * Mobile Broadband Card */
  {QMI_FIXED_INTF(0x413c, 0x81a8, 8)},  /* Dell Wireless 5808 Gobi(TM) 4G LTE
                                         * Mobile Broadband Card */
  {QMI_FIXED_INTF(0x413c, 0x81a9, 8)},  /* Dell Wireless 5808e Gobi(TM) 4G LTE
                                         * Mobile Broadband Card */
  {QMI_FIXED_INTF(0x413c, 0x81b1, 8)},  /* Dell Wireless 5809e Gobi(TM) 4G LTE
                                         * Mobile Broadband Card */
  {QMI_FIXED_INTF(0x413c, 0x81b3, 8)},  /* Dell Wireless 5809e Gobi(TM) 4G LTE
  ...
  {QMI_FIXED_INTF(0x413c, 0x81d7, 1)},  /* Dell Wireless 5821e preproduction
                                         * config */
  {QMI_FIXED_INTF(0x413c, 0x81e0, 0)},  /* Dell Wireless 5821e with eSIM
                                         * support*/
  {QMI_FIXED_INTF(0x413c, 0x81e4, 0)},  /* Dell Wireless 5829e with eSIM
                                         * support*/
  {QMI_FIXED_INTF(0x413c, 0x81e6, 0)},  /* Dell Wireless 5829e */
  {QMI_FIXED_INTF(0x03f0, 0x4e1d, 8)},  /* HP lt4111 LTE/EV-DO/HSPA+ Gobi 4G
                                         * Module */
  ...
  {QMI_GOBI_DEVICE(0x413c, 0x8186)},  /* Dell Gobi 2000 Modem device (N0218,
                                       * VU936) */
  {QMI_GOBI_DEVICE(0x413c, 0x8194)},  /* Dell Gobi 3000 Composite */
  {QMI_GOBI_DEVICE(0x05c6, 0x920b)},  /* Generic Gobi 2000 Modem device */
  {QMI_GOBI_DEVICE(0x05c6, 0x9225)},  /* Sony Gobi 2000 Modem device (N0279,
                                       * VU730) */
  ...
  {QMI_GOBI_DEVICE(0x05c6, 0x9235)},  /* Top Global Gobi 2000 Modem device
                                       * (VR306) */
  {QMI_GOBI_DEVICE(0x05c6, 0x9275)},  /* iRex Technologies Gobi 2000 Modem
                                       * device (VR307) */
  {QMI_GOBI_DEVICE(0x0af0, 0x8120)},  /* Option GTM681W */
  {QMI_GOBI_DEVICE(0x1199, 0x68a5)},  /* Sierra Wireless Modem */
  {QMI_GOBI_DEVICE(0x1199, 0x68a9)},  /* Sierra Wireless Modem */
  {QMI_GOBI_DEVICE(0x1199, 0x9001)},  /* Sierra Wireless Gobi 2000 Modem device
                                       * (VT773) */
  {QMI_GOBI_DEVICE(0x1199, 0x9002)},  /* Sierra Wireless Gobi 2000 Modem device
                                       * (VT773) */
  {QMI_GOBI_DEVICE(0x1199, 0x9003)},  /* Sierra Wireless Gobi 2000 Modem device
                                       * (VT773) */
  {QMI_GOBI_DEVICE(0x1199, 0x9004)},  /* Sierra Wireless Gobi 2000 Modem device
                                       * (VT773) */
  {QMI_GOBI_DEVICE(0x1199, 0x9005)},  /* Sierra Wireless Gobi 2000 Modem device
                                       * (VT773) */
  {QMI_GOBI_DEVICE(0x1199, 0x9006)},  /* Sierra Wireless Gobi 2000 Modem device
                                       * (VT773) */
  {QMI_GOBI_DEVICE(0x1199, 0x9007)},  /* Sierra Wireless Gobi 2000 Modem device
                                       * (VT773) */
  {QMI_GOBI_DEVICE(0x1199, 0x9008)},  /* Sierra Wireless Gobi 2000 Modem device
                                       * (VT773) */
  {QMI_GOBI_DEVICE(0x1199, 0x9009)},  /* Sierra Wireless Gobi 2000 Modem device
                                       * (VT773) */
  {QMI_GOBI_DEVICE(0x1199, 0x900a)},  /* Sierra Wireless Gobi 2000 Modem device
                                       * (VT773) */
  {QMI_GOBI_DEVICE(0x1199, 0x9011)},  /* Sierra Wireless Gobi 2000 Modem device
                                       * (MC8305) */
  {QMI_GOBI_DEVICE(0x16d8, 0x8002)},  /* CMDTech Gobi 2000 Modem device (VU922)
                                       * */
  {QMI_GOBI_DEVICE(0x05c6, 0x9205)},  /* Gobi 2000 Modem device */
  {QMI_GOBI_DEVICE(0x1199, 0x9013)},  /* Sierra Wireless Gobi 3000 Modem device
                                       * (MC8355) */
