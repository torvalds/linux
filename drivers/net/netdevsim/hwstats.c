...
static struct list_head *nsim_dev_hwstats_get_list_head(
...
static struct nsim_dev_hwstats_netdev *nsim_dev_hwslist_find_hwsdev(
    struct list_head *hwsdev_list,
    int ifindex) {
  struct nsim_dev_hwstats_netdev *hwsdev;
  list_for_each_entry(hwsdev, hwsdev_list, list) {
...
static int nsim_dev_hwsdev_report_delta(struct nsim_dev_hwstats_netdev *hwsdev,
...
static void nsim_dev_hwsdev_report_used(struct nsim_dev_hwstats_netdev *hwsdev,
    struct netdev_notifier_offload_xstats_info *info) {
  if (hwsdev->enabled) {
...
static void __nsim_dev_hwstats_event_unregister(
    struct nsim_dev_hwstats *hwstats,
    struct net_device *dev,
    enum netdev_offload_xstats_type type) {
  struct nsim_dev_hwstats_netdev *hwsdev;
...
static int nsim_dev_hwstats_enable_ifindex(struct nsim_dev_hwstats *hwstats,
    int ifindex,
    enum netdev_offload_xstats_type type,
    struct list_head *hwsdev_list) {
  struct nsim_dev_hwstats_netdev *hwsdev;
...
static int nsim_dev_hwstats_disable_ifindex(struct nsim_dev_hwstats *hwstats,
    int ifindex,
    enum netdev_offload_xstats_type type,
    struct list_head *hwsdev_list) {
  struct nsim_dev_hwstats_netdev *hwsdev;
...
static int nsim_dev_hwstats_fail_ifindex(struct nsim_dev_hwstats *hwstats,
    int ifindex,
    enum netdev_offload_xstats_type type,
    struct list_head *hwsdev_list) {
  struct nsim_dev_hwstats_netdev *hwsdev;
...
static ssize_t nsim_dev_hwstats_do_write(struct file *file,
