...
static int ipq8064_mdio_wait_busy(struct ipq8064_mdio *priv) {
  u32 busy;
...
static int ipq8064_mdio_read(struct mii_bus *bus, int phy_addr,
    int reg_offset) {
...
static int ipq8064_mdio_write(struct mii_bus *bus, int phy_addr, int reg_offset,
    u16 data) {
...
static int ipq8064_mdio_probe(struct platform_device *pdev) {
