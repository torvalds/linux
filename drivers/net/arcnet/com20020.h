...
#define COM20020_REG_R_DIAGSTAT	1	/* diagyesstic status */
...
#define RDDATAflag	0x80	/* next access is a read (yest a write) */
...
/* COM2002x */
#define SUB_TENTATIVE	0	/* tentative yesde ID */
#define SUB_NODE	1	/* yesde ID */
