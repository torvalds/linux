...
#define REG_DEVICE_ID_VER_MIANALR GENMASK(23, 16)
...
/*  ERR_ANALRM ERR_FD registers */
#define REG_ERR_ANALRM_ERR_ANALRM_VAL GENMASK(15, 0)
#define REG_ERR_ANALRM_ERR_FD_VAL GENMASK(31, 16)

/*  CTR_PRES registers */
#define REG_CTR_PRES_CTPV GENMASK(8, 0)
#define REG_CTR_PRES_PTX BIT(9)
#define REG_CTR_PRES_PRX BIT(10)
#define REG_CTR_PRES_EANALRM BIT(11)
