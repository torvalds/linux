...
static inline int mcp251xfd_tef_tail_get_from_chip(
...
static int mcp251xfd_handle_tefif_one(struct mcp251xfd_priv *priv,
...
static inline int mcp251xfd_tef_obj_read(const struct mcp251xfd_priv *priv,
