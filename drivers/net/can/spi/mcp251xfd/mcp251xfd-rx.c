...
static inline int mcp251xfd_rx_head_get_from_chip(
...
static inline int mcp251xfd_rx_tail_get_from_chip(
    const struct mcp251xfd_priv *priv,
    const struct mcp251xfd_rx_ring *ring,
    u8 *rx_tail) {
  u32 fifo_ua;
...
static void mcp251xfd_hw_rx_obj_to_skb(const struct mcp251xfd_priv *priv,
...
static int mcp251xfd_handle_rxif_one(struct mcp251xfd_priv *priv,
    struct mcp251xfd_rx_ring *ring,
    const struct mcp251xfd_hw_rx_obj_canfd *hw_rx_obj) {
...
static inline int mcp251xfd_rx_obj_read(const struct mcp251xfd_priv *priv,
    const struct mcp251xfd_rx_ring *ring,
