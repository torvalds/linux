...
static inline u8 mcp251xfd_cmd_prepare_write_reg(
...
static void mcp251xfd_ring_init_tef(struct mcp251xfd_priv *priv, u16 *base) {
...
static void mcp251xfd_ring_init_tx(struct mcp251xfd_priv *priv, u16 *base,
    u8 *fifo_nr) {
...
static void mcp251xfd_ring_init_rx(struct mcp251xfd_priv *priv, u16 *base,
    u8 *fifo_nr) {
