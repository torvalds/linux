...
static ssize_t can_channel_id_show(struct device *dev,
 ...
 */
void peak_usb_get_ts_time(struct peak_time_ref *time_ref, u32 ts,
    ktime_t *time) {
...
/* Every CAN-USB device exports the dev_get_can_channel_id() operation. It is
 * used
...
/* Every CAN-USB device exports the
 * dev_get_can_channel_id()/dev_set_can_channel_id()
