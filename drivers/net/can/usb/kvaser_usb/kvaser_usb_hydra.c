...
static struct kvaser_usb_net_priv *kvaser_usb_hydra_net_priv_from_cmd(
    const struct kvaser_usb *dev,
    const struct kvaser_cmd *cmd) {
...
static ktime_t kvaser_usb_hydra_ktime_from_rx_cmd(
...
static int kvaser_usb_hydra_send_simple_cmd_async(
...
static void kvaser_usb_hydra_bus_status_to_can_state(
    const struct kvaser_usb_net_priv *priv,
    u8 bus_status,
...
static void kvaser_usb_hydra_error_frame(struct kvaser_usb_net_priv *priv,
...
static void kvaser_usb_hydra_rx_msg_std(const struct kvaser_usb *dev,
  ...
  can_frame_set_cc_len((struct can_frame *) cf, cmd->rx_can.dlc,
      priv->can.ctrlmode);
...
static void *kvaser_usb_hydra_frame_to_cmd_ext(
    const struct kvaser_usb_net_priv *priv,
...
static void *kvaser_usb_hydra_frame_to_cmd_std(
    const struct kvaser_usb_net_priv *priv,
    const struct sk_buff *skb, int *cmd_len,
    u16 transid) {
  struct kvaser_usb *dev = priv->dev;
...
static int kvaser_usb_hydra_get_nominal_busparams(
    struct kvaser_usb_net_priv *priv) {
  return kvaser_usb_hydra_get_busparams(priv,
...
static void *kvaser_usb_hydra_frame_to_cmd(
    const struct kvaser_usb_net_priv *priv,
    const struct sk_buff *skb, int *cmd_len,
    u16 transid) {
  void *buf;
