...
static void *kvaser_usb_leaf_frame_to_cmd(
...
static void kvaser_usb_leaf_rx_error_update_can_state(
    struct kvaser_usb_net_priv *priv,
 ...
 */
static void kvaser_usb_leaf_usbcan_conditionally_rx_error(
