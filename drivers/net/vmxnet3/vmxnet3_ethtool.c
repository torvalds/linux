...
void vmxnet3_get_stats64(struct net_device *netdev,
...
static void vmxnet3_get_drvinfo(struct net_device *netdev,
...
static void vmxnet3_get_strings(struct net_device *netdev, u32 stringset,
    u8 *buf) {
  struct vmxnet3_adapter *adapter = netdev_priv(netdev);
  int i, j;
...
static void vmxnet3_get_ethtool_stats(struct net_device *netdev,
 ...
 * --register-dump would be required.
 */
static void vmxnet3_get_regs(struct net_device *netdev,
...
static void vmxnet3_get_wol(struct net_device *netdev,
...
static int vmxnet3_set_wol(struct net_device *netdev,
    struct ethtool_wolinfo *wol) {
  struct vmxnet3_adapter *adapter = netdev_priv(netdev);
...
static int vmxnet3_get_link_ksettings(struct net_device *netdev,
...
static void vmxnet3_get_ringparam(struct net_device *netdev,
...
static int vmxnet3_set_ringparam(struct net_device *netdev,
    struct ethtool_ringparam *param,
    struct kernel_ethtool_ringparam *kernel_param,
    struct netlink_ext_ack *extack) {
  struct vmxnet3_adapter *adapter = netdev_priv(netdev);
...
static int vmxnet3_get_rss_hash_opts(struct vmxnet3_adapter *adapter,
...
static int vmxnet3_set_rss_hash_opt(struct net_device *netdev,
    struct vmxnet3_adapter *adapter,
...
static int vmxnet3_get_rxnfc(struct net_device *netdev,
    struct ethtool_rxnfc *info,
    u32 *rules) {
  struct vmxnet3_adapter *adapter = netdev_priv(netdev);
  int err = 0;
...
static int vmxnet3_set_rxnfc(struct net_device *netdev,
    struct ethtool_rxnfc *info) {
  struct vmxnet3_adapter *adapter = netdev_priv(netdev);
  int err = 0;
  if (!VMXNET3_VERSION_GE_4(adapter)) {
...
static int vmxnet3_get_rss(struct net_device *netdev,
...
static int vmxnet3_set_rss(struct net_device *netdev,
    struct ethtool_rxfh_param *rxfh,
    struct netlink_ext_ack *extack) {
  unsigned int i;
  unsigned long flags;
