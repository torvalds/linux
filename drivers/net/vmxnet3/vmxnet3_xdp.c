...
static void vmxnet3_xdp_exchange_program(struct vmxnet3_adapter *adapter,
    struct bpf_prog *prog) {
  rcu_assign_pointer(adapter->xdp_bpf_prog, prog);
}

static inline struct vmxnet3_tx_queue *vmxnet3_xdp_get_tq(
...
static int vmxnet3_xdp_set(struct net_device *netdev, struct netdev_bpf *bpf,
...
static int vmxnet3_xdp_xmit_frame(struct vmxnet3_adapter *adapter,
...
static int vmxnet3_xdp_xmit_back(struct vmxnet3_adapter *adapter,
    struct xdp_frame *xdpf) {
  struct vmxnet3_tx_queue *tq;
...
/* ndo_xdp_xmit */
int vmxnet3_xdp_xmit(struct net_device *dev,
...
static int vmxnet3_run_xdp(struct vmxnet3_rx_queue *rq, struct xdp_buff *xdp,
    struct bpf_prog *prog) {
  struct xdp_frame *xdpf;
  struct page *page;
  int err;
...
static struct sk_buff *vmxnet3_build_skb(struct vmxnet3_rx_queue *rq,
    struct page *page,
