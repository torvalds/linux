...
static int sb1000_probe_one(struct pnp_dev *pdev,
...
static int card_wait_for_busy_clear(const int ioaddr[], const char *name) {
  unsigned char a;
...
static int sb1000_wait_for_ready_clear(const int ioaddr[], const char *name) {
  unsigned long timeout;
  timeout = jiffies + Sb1000TimeOutJiffies;
  while (inb(ioaddr[1] + 6) & 0x80) {
    if (time_after_eq(jiffies, timeout)) {
...
static void sb1000_issue_read_command(const int ioaddr[], const char *name) {
  static const unsigned char Command0[6] = {
...
static inline int sb1000_start_get_set_command(const int ioaddr[],
    const char *name) {
  static const unsigned char Command0[6] = {
    0x80, 0x1b, 0x00, 0x00, 0x00, 0x00
  };
  unsigned char st[7];
  return card_send_command(ioaddr, name, Command0, st);
}

static int sb1000_end_get_set_command(const int ioaddr[], const char *name) {
  static const unsigned char Command0[6] = {
    0x80, 0x1b, 0x02, 0x00, 0x00, 0x00
  };
  static const unsigned char Command1[6] = {
...
static int sb1000_get_firmware_version(const int ioaddr[], const char *name,
    unsigned char version[], int do_end) {
  static const unsigned char Command0[6] = {
    0x80, 0x23, 0x00, 0x00, 0x00, 0x00
  };
  unsigned char st[7];
  int status;
...
static int sb1000_set_frequency(const int ioaddr[], const char *name,
  ...
  unsigned char st[7];
  int status;
  unsigned char Command0[6] = {
    0x80, 0x29, 0x00, 0x00, 0x00, 0x00
  };
...
/* get SB1000 PIDs */
static int sb1000_get_PIDs(const int ioaddr[], const char *name, short PID[]) {
  static const unsigned char Command0[6] = {
    0x80, 0x40, 0x00, 0x00, 0x00, 0x00
  };
  static const unsigned char Command1[6] = {
    0x80, 0x41, 0x00, 0x00, 0x00, 0x00
  };
  static const unsigned char Command2[6] = {
    0x80, 0x42, 0x00, 0x00, 0x00, 0x00
  };
  static const unsigned char Command3[6] = {
    0x80, 0x43, 0x00, 0x00, 0x00, 0x00
  };
  unsigned char st[7];
  int status;
  udelay(1000);
...
static int sb1000_set_PIDs(const int ioaddr[], const char *name,
    const short PID[]) {
  static const unsigned char Command4[6] = {
    0x80, 0x2e, 0x00, 0x00, 0x00, 0x00
  };
  unsigned char st[7];
  short p;
  int status;
  unsigned char Command0[6] = {
    0x80, 0x31, 0x00, 0x00, 0x00, 0x00
  };
  unsigned char Command1[6] = {
    0x80, 0x32, 0x00, 0x00, 0x00, 0x00
  };
  unsigned char Command2[6] = {
    0x80, 0x33, 0x00, 0x00, 0x00, 0x00
  };
  unsigned char Command3[6] = {
...
static void sb1000_print_status_buffer(const char *name, unsigned char st[],
...
static int sb1000_open(struct net_device *dev) {
  ...
  int ioaddr[2], status;
  struct sb1000_private *lp = netdev_priv(dev);
  const unsigned short FirmwareVersion[] = {
    0x01, 0x01
  };
  ioaddr[0] = dev->base_addr;
  /* mem_start holds the second I/O address */
