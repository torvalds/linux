...
static void pef2256_clrsetbits8(struct pef2256 *pef2256, int offset, u8 clr,
    u8 set) {
...
static int pef2256_setup_e1_line(struct pef2256 *pef2256) {
  ...
  pef2256_write8(pef2256, PEF2256_FMR0,
      PEF2256_FMR0_XC_HDB3 | PEF2256_FMR0_RC_HDB3);
...
static int pef2256_setup_e1_system(struct pef2256 *pef2256) {
  ...
  if (pef2256->is_tx_falling_edge) {
    ...
    pef2256_clrsetbits8(pef2256, PEF2256_SIC3, PEF2256_SIC3_RESX,
        PEF2256_SIC3_RESR);
  } else {
    /* rising edge sync pulse transmit, falling edge sync pulse receive */
    pef2256_clrsetbits8(pef2256, PEF2256_SIC3, PEF2256_SIC3_RESR,
        PEF2256_SIC3_RESX);
  }
...
static int pef2256_check_rates(struct pef2256 *pef2256,
    unsigned long sysclk_rate,
...
static int pef2556_of_parse(struct pef2256 *pef2256, struct device_node *np) {
  ...
  pef2256->is_tx_falling_edge = of_property_read_bool(np,
      "lantiq,clock-falling-edge");
  pef2256->channel_phase = 0;
  ret
    = of_property_read_u8(np, "lantiq,channel-phase", &pef2256->channel_phase);
  if (ret && ret != -EINVAL) {
...
static int pef2256_framer_get_status(struct framer *framer,
...
static int pef2256_framer_set_config(struct framer *framer,
...
static int pef2256_framer_get_config(struct framer *framer,
    struct framer_config *config) {
  struct pef2256 *pef2256 = framer_get_drvdata(framer);
  config->iface = FRAMER_IFACE_E1;
  config->clock_type
    = pef2256->is_subordinate ? FRAMER_CLOCK_EXT : FRAMER_CLOCK_INT;
...
static int pef2256_probe(struct platform_device *pdev) {
  ...
  pef2256->reset_gpio = devm_gpiod_get_optional(&pdev->dev, "reset",
      GPIOD_OUT_LOW);
  ...
  ret = devm_request_irq(pef2256->dev, irq, pef2256_irq_handler, 0, "pef2256",
      pef2256);
  if (ret < 0) {
    return ret;
  }
