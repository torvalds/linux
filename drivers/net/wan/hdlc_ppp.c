...
enum {
  IDX_LCP = 0, IDX_IPCP, IDX_IPV6CP, IDX_COUNT
};
enum {
  CP_CONF_REQ = 1, CP_CONF_ACK, CP_CONF_NAK, CP_CONF_REJ, CP_TERM_REQ,
...
enum {
  LCP_OPTION_MRU = 1, LCP_OPTION_ACCM, LCP_OPTION_MAGIC = 5
};
...
enum {
  CLOSED = 0, STOPPED, STOPPING, REQ_SENT, ACK_RECV, ACK_SENT, OPENED,
  STATES, STATE_MASK = 0xF
};
enum {
  START = 0, STOP, TO_GOOD, TO_BAD, RCR_GOOD, RCR_BAD, RCA, RCN, RTR, RTA,
  RUC, RXJ_GOOD, RXJ_BAD, EVENTS
};
enum {
  INV = 0x10, IRC = 0x20, ZRC = 0x40, SCR = 0x80, SCA = 0x100,
...
static void ppp_cp_parse_cr(struct net_device *dev, u16 pid, u8 id,
  ...
  static u8 const valid_accm[6] = {
    LCP_OPTION_ACCM, 6, 0, 0, 0, 0
  };
  const u8 *opt;
  u8 *out;
