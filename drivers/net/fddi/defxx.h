...
#define PFI_STATUS_M_PFI_ERROR     0X00000020   /* only valid in rev 1 or later
                                                 * PFI */
...
/* Define offsets into FDDI LLC or SMT receive frame buffers - used when
 * indicating frames */
...
/* Define offsets into FDDI LLC transmit frame buffers - used when sending
 * frames */
...
typedef struct DFX_board_tag {
  ...
  /* Link available flag needed to determine whether to drop outgoing packet
   * requests */
