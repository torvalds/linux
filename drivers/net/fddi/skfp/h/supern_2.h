...
union rx_descr {
	...
	unsigned int	rx_sfrmerr:1 ;	/* received frame yest valid */
...
#define RD_S_SFRMERR	0x01000000L	/* received frame yest valid */
...
union tx_descr {
	...
	unsigned int	tx_nfcs  :1 ;	/* yes frame check sequence */
...
#define TD_C_NFCS	0x02000000L	/* yes frame check sequence */
...
#define	FM_MRNNSAFNMA	(2<<8)		/* rec. yesn-NSA frames DA=MA&&SA!=MA */
#define	FM_MRNNSAF	(3<<8)		/* rec. yesn-NSA frames DA = MA */
...
#define FM_STECFRMA1	0x0040		/* transmit end of chain of asyn. q1 */
					/* SN3: STECMDA1 */
#define FM_STECMDA1	0x0040		/* SN3: 'yes description' */
...
#define FM_SESTRIPTK	0x0001		/* SN3: 'yes description' */
...
#define	FM_RCV1_NSMT	(3<<0)		/* rec yesn-SMT frames */
...
#define	FM_RCV2_NSMT	(3<<4)		/* rec yesn-SMT frames */
...
#define FM_INRTM	0x08		/* yesnrestricted token mode */
#define FM_IENTM	0x09		/* enter yesnrestricted token mode */
...
#define FM_ICLLS	0x11		/* clear synchroyesus queue lock */
#define FM_ICLLA0	0x12		/* clear asynchroyesus queue 0 lock */
#define FM_ICLLA1	0x14		/* clear asynchroyesus queue 1 lock */
#define FM_ICLLA2	0x18		/* clear asynchroyesus queue 2 lock */
					/* SN3: reserved */
 ...
 */
#define FM_ITRS		0x01		/* transmit synchroyesus queue */
					/* SN3: reserved */
#define FM_ITRA0	0x02		/* transmit asynchroyesus queue 0 */
					/* SN3: reserved */
#define FM_ITRA1	0x04		/* transmit asynchroyesus queue 1 */
					/* SN3: reserved */
#define FM_ITRA2	0x08		/* transmit asynchroyesus queue 2 */
					/* SN3: reserved */
...
#define PL_NS_MAX	0x0d		/* max. yesise time before break (r/w)*/
...
#define PL_TNE		0x13		/* time of yesise event [0.32 us] */
...
#define	QELM_WR_XBAR	0x87		/* Write the Crossbar yesw (write) */
...
#define	PL_NOISE_TIMER	0x4000		/* allows the yesise timing function */
...
#define	PL_PCM_NAF	(0)		/* state is yest affected */
...
#define	PL_NOLCT	(0<<5)		/* yes LCT is performed */
...
#define	PL_B_NOT	(0)		/* PCM SM has yest gone to BREAK state*/
 ...
 * It is used by the PLC to report events to the yesde processor.
 */
 ...
 */
#define	RQ_NOT		0		/* yest request */
#define	RQ_RES		1		/* reserved */
#define	RQ_SFW		2		/* special frame write */
#define	RQ_RRQ		3		/* read request: receive queue */
#define	RQ_WSQ		4		/* write request: synchroyesus queue */
#define	RQ_WA0		5		/* write requ.: asynchroyesus queue 0 */
#define	RQ_WA1		6		/* write requ.: asynchroyesus queue 1 */
#define	RQ_WA2		7		/* write requ.: asynchroyesus queue 2 */
