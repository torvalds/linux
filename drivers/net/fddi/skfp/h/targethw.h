...
#define	OI_STAT_PRESENT		1	/* entry present but yest empty */
#define	OI_STAT_VALID		2	/* holds valid ID, but is yest active */ 
...
#define	STOPPED		0
	...
	/*
	 * GENERIC ; do yest modify beyond this line
	 */

	/*
	 * physical and cayesnical address
	 */
	struct fddi_addr fddi_home_addr ;
	struct fddi_addr fddi_cayesn_addr ;
