...
/*
 * Synchroyesus Bandwidth Allocation (SBA) structs
 */
...
struct timer_cell {
	...
	u_long			start_time ;
	struct s_sba_yesde_vars	*yesde_var ;
} ;

/*
 * Node variables
 */
struct s_sba_yesde_vars {
	...
	struct s_sba_sessions 	*yesde_sessions ;
...
struct s_sba {
	...
	struct s_sba_yesde_vars	yesde[MAX_NODES] ;
