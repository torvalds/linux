...
#define FZA_EVENT_NXM_ERR	0x0080	/* yesn-existent memory access error;
...
#define FZA_HALT_UNKNOWN	0x00	/* unkyeswn reason */
#define FZA_HALT_HOST		0x01	/* host-directed HALT */
#define FZA_HALT_HB_PARITY	0x02	/* host bus parity error */
#define FZA_HALT_NXM		0x03	/* adapter yesn-existent memory ref. */
...
#define FZA_MASK_NXM_ERR	0x0080	/* adapter yesn-existent memory
					 * reference
					 */
...
#define FZA_MASK_RCV_POLL	0x0002	/* receive request (packet available)
					 */
#define FZA_MASK_TX_DONE	0x0001	/* RMC transmit done ackyeswledge */
...
#define FZA_CONTROL_A_NXM_ERR		0x4000	/* adapter yesn-existent memory
						 * reference
						 */
...
#define FZA_CONTROL_B_IDLE	0x0000	/* yes driver installed */
...
#define FZA_RING_CMD_NOP	0x00000000	/* yesp */
...
#define FZA_RING_RX_RRR_DADDR	0x00040000	/* dest address yest matched */
...
#define FZA_RING_RX_DA_NONE	0x00000000	/* yes match */
...
#define FZA_RING_RX_SA_NONE	0x00000000	/* yes match */
...
#define FZA_PRH0_TKN_TYPE_IMM	0x00	/* send immediately, yes token required
					 */
#define FZA_PRH0_FRAME_MASK	0x08	/* type of frame to send */
#define FZA_PRH0_FRAME_SYNC	0x08	/* send a synchroyesus frame */
#define FZA_PRH0_FRAME_ASYNC	0x00	/* send an asynchroyesus frame */
...
#define FZA_PRH0_MODE_IMMED	0x04	/* an immediate mode, send regardless
					 ...
					 */
#define FZA_PRH0_MODE_NORMAL	0x00	/* a yesrmal mode, send only if ring
					 * operational
					 */
...
#define FZA_PRH0_SF_FIRST	0x02	/* send this frame first
					 ...
					 */
#define FZA_PRH0_SF_NORMAL	0x00	/* treat this frame yesrmally */
...
#define FZA_PRH1_SL_LAST	0x40	/* send this frame last, releasing
					 ...
					 */
#define FZA_PRH1_SL_NORMAL	0x00	/* treat this frame yesrmally */
...
#define FZA_PRH1_TKN_SEND_NONE	0x00	/* send yes token */
