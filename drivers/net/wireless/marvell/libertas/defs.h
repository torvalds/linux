...
#define lbs_deb_main(fmt, args ...)      LBS_DEB_LL(LBS_DEB_MAIN, " main", fmt, \
    ## args)
#define lbs_deb_net(fmt, args ...)       LBS_DEB_LL(LBS_DEB_NET, " net", fmt, \
    ## args)
#define lbs_deb_mesh(fmt, args ...)      LBS_DEB_LL(LBS_DEB_MESH, " mesh", fmt, \
    ## args)
#define lbs_deb_wext(fmt, args ...)      LBS_DEB_LL(LBS_DEB_WEXT, " wext", fmt, \
    ## args)
#define lbs_deb_ioctl(fmt, args ...)     LBS_DEB_LL(LBS_DEB_IOCTL, " ioctl", \
    fmt, ## args)
#define lbs_deb_scan(fmt, args ...)      LBS_DEB_LL(LBS_DEB_SCAN, " scan", fmt, \
    ## args)
#define lbs_deb_assoc(fmt, args ...)     LBS_DEB_LL(LBS_DEB_ASSOC, " assoc", \
    fmt, ## args)
#define lbs_deb_join(fmt, args ...)      LBS_DEB_LL(LBS_DEB_JOIN, " join", fmt, \
    ## args)
#define lbs_deb_11d(fmt, args ...)       LBS_DEB_LL(LBS_DEB_11D, " 11d", fmt, \
    ## args)
#define lbs_deb_debugfs(fmt, args ...)   LBS_DEB_LL(LBS_DEB_DEBUGFS, " debugfs", \
    fmt, ## args)
#define lbs_deb_ethtool(fmt, args ...)   LBS_DEB_LL(LBS_DEB_ETHTOOL, " ethtool", \
    fmt, ## args)
#define lbs_deb_host(fmt, args ...)      LBS_DEB_LL(LBS_DEB_HOST, " host", fmt, \
    ## args)
#define lbs_deb_cmd(fmt, args ...)       LBS_DEB_LL(LBS_DEB_CMD, " cmd", fmt, \
    ## args)
#define lbs_deb_rx(fmt, args ...)        LBS_DEB_LL(LBS_DEB_RX, " rx", fmt, \
    ## args)
#define lbs_deb_tx(fmt, args ...)        LBS_DEB_LL(LBS_DEB_TX, " tx", fmt, \
    ## args)
#define lbs_deb_fw(fmt, args ...)        LBS_DEB_LL(LBS_DEB_FW, " fw", fmt, \
    ## args)
#define lbs_deb_usb(fmt, args ...)       LBS_DEB_LL(LBS_DEB_USB, " usb", fmt, \
    ## args)
#define lbs_deb_usbd(dev, fmt, args ...) LBS_DEB_LL(LBS_DEB_USB, " usbd", \
    "%s:" fmt, dev_name( \
    dev), ## args)
#define lbs_deb_cs(fmt, args ...)        LBS_DEB_LL(LBS_DEB_CS, " cs", fmt, \
    ## args)
#define lbs_deb_thread(fmt, args ...)    LBS_DEB_LL(LBS_DEB_THREAD, " thread", \
    fmt, ## args)
#define lbs_deb_sdio(fmt, args ...)      LBS_DEB_LL(LBS_DEB_SDIO, " sdio", fmt, \
    ## args)
#define lbs_deb_sysfs(fmt, args ...)     LBS_DEB_LL(LBS_DEB_SYSFS, " sysfs", \
    fmt, ## args)
#define lbs_deb_spi(fmt, args ...)       LBS_DEB_LL(LBS_DEB_SPI, " spi", fmt, \
    ## args)
#define lbs_deb_cfg80211(fmt, args ...)  LBS_DEB_LL(LBS_DEB_CFG80211, \
    " cfg80211", fmt, ## args)
