...
struct lbs_mesh_stats {
	...
	u32	fwd_drop_yesroute; 	/* Fwd: No route to Destination */
	u32	fwd_drop_yesbuf;		/* Fwd: Run out of internal buffers */
...
struct lbs_private {
	...
	/* Whether the scan was initiated internally and yest by cfg80211 */
	bool internal_scan;
