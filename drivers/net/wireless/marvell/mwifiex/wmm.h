 ...
 */
static inline int mwifiex_get_tid(struct mwifiex_ra_list_tbl *ptr) {
  struct sk_buff *skb;
 ...
 */
static inline u8 mwifiex_wmm_is_ra_list_empty(struct list_head *ra_list_hhead) {
...
struct mwifiex_ra_list_tbl *mwifiex_wmm_get_queue_raptr(
  struct mwifiex_private *priv, u8 tid,
  const u8 *ra_addr);
