 ...
 * circular buffer.
 */
static void mwifiex_11n_dispatch_pkt_until_start_win(
 ...
 * circular buffer.
 */
static void mwifiex_11n_scan_and_dispatch(struct mwifiex_private *priv,
    struct mwifiex_rx_reorder_tbl *tbl) {
  struct sk_buff_head list;
  struct sk_buff *skb;
  int i, j, xchg;
 ...
 */
static void mwifiex_del_rx_reorder_entry(struct mwifiex_private *priv,
    struct mwifiex_rx_reorder_tbl *tbl) {
  int start_win;
  if (!tbl) {
    return;
 ...
 */
static void mwifiex_flush_data(struct timer_list *t) {
 ...
 */
static void mwifiex_11n_create_rx_reorder_tbl(struct mwifiex_private *priv,
    u8 *ta,
...
static void mwifiex_11n_rxreorder_timer_restart(
    struct mwifiex_rx_reorder_tbl *tbl) {
  u32 min_flush_time;
 ...
 */
void mwifiex_del_ba_tbl(struct mwifiex_private *priv, int tid, u8 *peer_mac,
