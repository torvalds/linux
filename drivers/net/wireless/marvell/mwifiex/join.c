 ...
 */
static int mwifiex_cmd_append_generic_ie(struct mwifiex_private *priv,
    u8 **buffer) {
  int ret_len = 0;
 ...
 */
static int mwifiex_cmd_append_tsf_tlv(struct mwifiex_private *priv, u8 **buffer,
 ...
 */
static int mwifiex_setup_rates_from_bssdesc(struct mwifiex_private *priv,
    struct mwifiex_bssdescriptor *bss_desc,
 ...
 */
static int mwifiex_cmd_append_wps_ie(struct mwifiex_private *priv,
    u8 **buffer) {
  int retLen = 0;
  struct mwifiex_ie_types_header ie_header;
  if (!buffer || !*buffer) {
 ...
 */
static int mwifiex_cmd_append_wapi_ie(struct mwifiex_private *priv,
    u8 **buffer) {
  int retLen = 0;
  struct mwifiex_ie_types_header ie_header;
  /* Null Checks */
