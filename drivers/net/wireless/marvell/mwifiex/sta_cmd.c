 ...
 */
static int mwifiex_cmd_802_11_rssi_info(struct mwifiex_private *priv,
 ...
 */
static int mwifiex_set_keyparamset_wep(struct mwifiex_private *priv,
 ...
 *      - Ensuring correct endian-ness
 */
static int mwifiex_cmd_802_11_key_material_v2(struct mwifiex_private *priv,
    struct host_cmd_ds_command *cmd,
    u16 cmd_action, u32 cmd_oid,
    struct mwifiex_ds_encrypt_key *enc_key) {
  struct mwifiex_adapter *adapter = priv->adapter;
 ...
 *      - Ensuring correct endian-ness
 */
static int mwifiex_cmd_802_11_key_material_v1(struct mwifiex_private *priv,
    struct host_cmd_ds_command *cmd,
    u16 cmd_action, u32 cmd_oid,
    struct mwifiex_ds_encrypt_key *enc_key) {
 ...
 */
static int mwifiex_cmd_mem_access(struct host_cmd_ds_command *cmd,
    u16 cmd_action,
    void *pdata_buf) {
 ...
 *      - Ensuring correct endian-ness
 */
static int mwifiex_cmd_pcie_host_spec(struct mwifiex_private *priv,
 ...
 * every FW response.
 */
static int mwifiex_cmd_802_11_subsc_evt(struct mwifiex_private *priv,
    struct host_cmd_ds_command *cmd,
...
static int mwifiex_cmd_append_rpn_expression(struct mwifiex_private *priv,
...
static int mwifiex_cmd_mef_cfg(struct mwifiex_private *priv,
    struct host_cmd_ds_command *cmd,
...
static int mwifiex_cmd_set_mc_policy(struct mwifiex_private *priv,
    struct host_cmd_ds_command *cmd,
    u16 cmd_action, void *data_buf) {
...
static int mwifiex_cmd_coalesce_cfg(struct mwifiex_private *priv,
    struct host_cmd_ds_command *cmd,
    u16 cmd_action, void *data_buf) {
...
static int mwifiex_cmd_tdls_config(struct mwifiex_private *priv,
    struct host_cmd_ds_command *cmd,
    u16 cmd_action, void *data_buf) {
...
static int mwifiex_cmd_tdls_oper(struct mwifiex_private *priv,
    struct host_cmd_ds_command *cmd,
    void *data_buf) {
