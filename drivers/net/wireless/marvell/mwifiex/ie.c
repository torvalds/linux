 ...
 */
static int mwifiex_ie_index_used_by_other_intf(struct mwifiex_private *priv,
    u16 idx) {
  int i;
...
static int mwifiex_ie_get_autoidx(struct mwifiex_private *priv,
    u16 subtype_mask,
...
static int mwifiex_update_autoindex_ies(struct mwifiex_private *priv,
 ...
 */
static int mwifiex_update_uap_custom_ie(struct mwifiex_private *priv,
