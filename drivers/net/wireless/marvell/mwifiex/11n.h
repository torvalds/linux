...
static inline u8 mwifiex_is_station_ampdu_allowed(struct mwifiex_private *priv,
...
static inline u8 mwifiex_is_ampdu_allowed(struct mwifiex_private *priv,
    struct mwifiex_ra_list_tbl *ptr, int tid) {
 ...
 */
static inline u8 mwifiex_is_amsdu_allowed(struct mwifiex_private *priv,
    int tid) {
 ...
 */
static inline u8 mwifiex_find_stream_to_delete(struct mwifiex_private *priv,
    int ptr_tid,
    int *ptid, u8 *ra) {
  int tid;
  u8 ret = false;
...
static inline u8 mwifiex_tdls_peer_11n_enabled(struct mwifiex_private *priv,
    const u8 *ra) {
