 ...
 */
static void mwifiex_process_cmdresp_error(struct mwifiex_private *priv,
 ...
 */
static int mwifiex_get_power_level(struct mwifiex_private *priv,
    void *data_buf) {
...
static int mwifiex_ret_ver_ext(struct mwifiex_private *priv,
  ...
  if (test_and_clear_bit(MWIFIEX_IS_REQUESTING_FW_VEREXT,
 ...
 */
static int mwifiex_ret_remain_on_chan(struct mwifiex_private *priv,
    struct host_cmd_ds_command *resp,
 ...
 */
static int mwifiex_ret_p2p_mode_cfg(struct mwifiex_private *priv,
    struct host_cmd_ds_command *resp,
    void *data_buf) {
 ...
 */
static int mwifiex_ret_mem_access(struct mwifiex_private *priv,
...
static struct ieee80211_regdomain *mwifiex_create_custom_regdomain(
