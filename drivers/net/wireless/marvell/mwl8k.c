...
#define MWL8K_CMDNAME(x)  case MWL8K_CMD_ ## x: \
    do { \
 ...
 * Firmware loading.
 */
static int mwl8k_send_fw_load_cmd(struct mwl8k_priv *priv, void *data,
    int length) {
...
static void mwl8k_add_dma_header(struct mwl8k_priv *priv, struct sk_buff *skb,
 ...
 */
static inline int mwl8k_capture_bssid(struct mwl8k_priv *priv,
    struct ieee80211_hdr *wh) {
...
static int mwl8k_txq_reclaim(struct ieee80211_hw *hw, int index, int limit,
    int force) {
  struct mwl8k_priv *priv = hw->priv;
  struct mwl8k_tx_queue *txq = priv->txq + index;
  int processed;
...
static struct mwl8k_ampdu_stream *mwl8k_add_stream(struct ieee80211_hw *hw,
    struct ieee80211_sta *sta,
    u8 tid) {
...
static int mwl8k_start_stream(struct ieee80211_hw *hw,
    struct mwl8k_ampdu_stream *stream) {
  int ret;
...
static void mwl8k_remove_stream(struct ieee80211_hw *hw,
    struct mwl8k_ampdu_stream *stream) {
...
static struct mwl8k_ampdu_stream *mwl8k_lookup_stream(struct ieee80211_hw *hw,
    u8 *addr, u8 tid) {
  struct mwl8k_priv *priv = hw->priv;
  int i;
  for (i = 0; i < MWL8K_NUM_AMPDU_STREAMS; i++) {
...
static void mwl8k_txq_xmit(struct ieee80211_hw *hw,
    int index,
    struct ieee80211_sta *sta,
    struct sk_buff *skb) {
  struct mwl8k_priv *priv = hw->priv;
...
static void mwl8k_set_ht_caps(struct ieee80211_hw *hw,
...
static struct mwl8k_cmd_pkt *__mwl8k_cmd_mac_multicast_adr(
    struct ieee80211_hw *hw, int allmulti,
...
static int mwl8k_cmd_radio_control(struct ieee80211_hw *hw, bool enable,
    bool force) {
  struct mwl8k_priv *priv = hw->priv;
...
static int mwl8k_set_radio_preamble(struct ieee80211_hw *hw,
    bool short_preamble) {
  struct mwl8k_priv *priv = hw->priv;
...
static int mwl8k_cmd_rf_antenna(struct ieee80211_hw *hw, int antenna,
    int mask) {
...
static int mwl8k_cmd_bbp_reg_access(struct ieee80211_hw *hw,
    u16 action,
    u16 offset,
    u8 *value) {
...
static int mwl8k_cmd_set_post_scan(struct ieee80211_hw *hw, const __u8 *mac) {
...
static int mwl8k_cmd_set_rate(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
...
static int mwl8k_cmd_set_edca_params(struct ieee80211_hw *hw, __u8 qnum,
...
static int mwl8k_cmd_use_fixed_rate_ap(struct ieee80211_hw *hw, int mcast,
    int mgmt) {
...
static int mwl8k_check_ba(struct ieee80211_hw *hw,
    struct mwl8k_ampdu_stream *stream,
    struct ieee80211_vif *vif) {
...
static int mwl8k_create_ba(struct ieee80211_hw *hw,
    struct mwl8k_ampdu_stream *stream,
...
static void mwl8k_bss_info_changed_sta(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
...
static void mwl8k_bss_info_changed_ap(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
    struct ieee80211_bss_conf *info, u32 changed) {
  int rc;
  if (mwl8k_fw_lock(hw)) {
...
static int mwl8k_configure_filter_sniffer(struct ieee80211_hw *hw,
...
static int mwl8k_ampdu_action(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
