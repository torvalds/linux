...
int wsm_set_tx_queue_params(struct cw1200_common *priv,
  ...
  int ret;
  struct wsm_buf *buf = &priv->wsm_cmd_buf;
  static const u8 queue_id_to_wmm_aci[] = {
    3, 2, 0, 1
  };
  wsm_cmd_lock(priv);
...
static int wsm_startup_indication(struct cw1200_common *priv,
  ...
  priv->wsm_caps.fw_label[sizeof(priv->wsm_caps.fw_label) - 1] = 0; /* Do not
                                                                     * trust FW
                                                                     * too
                                                                     * much...
                                                                     * */
...
static int wsm_event_indication(struct cw1200_common *priv,
    struct wsm_buf *buf) {
  int first;
