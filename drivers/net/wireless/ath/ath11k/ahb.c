...
static int ath11k_ahb_get_msi_irq_wcn6750(struct ath11k_base *ab,
    unsigned int vector) {
  return ab->pci.msi.irqs[vector];
}

static inline u32 ath11k_ahb_get_window_start_wcn6750(struct ath11k_base *ab,
    u32 offset) {
  u32 window_start = 0;
...
static void ath11k_ahb_window_write32_wcn6750(struct ath11k_base *ab,
...
static u32 ath11k_ahb_window_read32_wcn6750(struct ath11k_base *ab,
    u32 offset) {
  u32 window_start;
  u32 val;
  /* WCN6750 uses static window based register access */
...
static inline void ath11k_ahb_write32(struct ath11k_base *ab, u32 offset,
    u32 value) {
...
static int ath11k_ahb_map_service_to_pipe(struct ath11k_base *ab,
    u16 service_id,
...
static int ath11k_ahb_setup_msi_resources(struct ath11k_base *ab) {
  ...
  ret
    = of_property_read_u32_index(ab->dev->of_node, "interrupts", 1, &int_prop);
  if (ret) {
    return ret;
  }
...
MODULE_DESCRIPTION(
    "Driver support for Qualcomm Technologies 802.11ax WLAN AHB devices");
