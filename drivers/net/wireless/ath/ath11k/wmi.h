...
static inline enum cc_setting_code ath11k_wmi_cc_setting_code_to_reg(
    enum wmi_reg_cc_setting_code status_code) {
  switch (status_code) {
...
static inline const char *ath11k_6ghz_ap_type_to_str(
    enum wmi_reg_6ghz_ap_type type) {
  switch (type) {
...
static inline const char *ath11k_6ghz_client_type_to_str(
    enum wmi_reg_6ghz_client_type type) {
  switch (type) {
...
static inline const char *ath11k_sub_reg_6ghz_to_str(
    enum reg_subdomains_6ghz sub_id) {
  switch (sub_id) {
    case EMPTY_6GHZ:
      return "N/A";
...
static inline const char *ath11k_super_reg_6ghz_to_str(
...
struct cur_regulatory_info {
  ...
  u8 domain_code_6ghz_client[WMI_REG_CURRENT_MAX_AP_TYPE][
