...
static inline void ath11k_hif_write32(struct ath11k_base *ab, u32 address,
    u32 data) {
...
static inline int ath11k_hif_map_service_to_pipe(struct ath11k_base *ab,
    u16 service_id,
    u8 *ul_pipe, u8 *dl_pipe) {
  return ab->hif.ops->map_service_to_pipe(ab, service_id, ul_pipe, dl_pipe);
}

static inline int ath11k_get_user_msi_vector(struct ath11k_base *ab,
    char *user_name,
    int *num_vectors, u32 *user_base_data,
    u32 *base_vector) {
...
static inline void ath11k_get_msi_address(struct ath11k_base *ab,
    u32 *msi_addr_lo,
    u32 *msi_addr_hi) {
