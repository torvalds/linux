...
static enum hal_tcl_encap_type ath11k_dp_tx_get_encap_type(
    struct ath11k_vif *arvif, struct sk_buff *skb) {
...
static void ath11k_dp_tx_htt_tx_complete_buf(struct ath11k_base *ab,
    struct dp_tx_ring *tx_ring,
...
static void ath11k_dp_tx_process_htt_tx_complete(struct ath11k_base *ab,
    void *desc, u8 mac_id,
...
void ath11k_dp_tx_completion_handler(struct ath11k_base *ab, int ring_id) {
  ...
  while (ATH11K_TX_COMPL_NEXT(tx_ring->tx_status_tail)
      != tx_ring->tx_status_head) {
...
static int ath11k_dp_tx_get_ring_id_type(struct ath11k_base *ab,
