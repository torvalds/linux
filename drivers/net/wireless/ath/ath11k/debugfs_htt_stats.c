...
static inline void htt_print_tx_pdev_stats_flush_tlv_v(const void *tag_buf,
  ...
  u32 buf_len = ATH11K_HTT_STATS_BUF_SIZE;
  u16 num_elems
    = min_t(u16, (tag_len >> 2), HTT_TX_PDEV_MAX_FLUSH_REASON_STATS);
  len
    += scnprintf(buf + len, buf_len - len, "HTT_TX_PDEV_STATS_FLUSH_TLV_V:\n");
...
static inline void htt_print_tx_pdev_stats_sifs_hist_tlv_v(const void *tag_buf,
  ...
  u16 num_elems = min_t(u16, (tag_len >> 2),
      HTT_TX_PDEV_MAX_SIFS_BURST_HIST_STATS);
  len += scnprintf(buf + len, buf_len - len,
...
static inline void htt_print_tx_pdev_stats_tx_ppdu_stats_tlv_v(
    const void *tag_buf,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_pdev_stats_tried_mpdu_cnt_hist_tlv_v(
    const void *tag_buf,
    u16 tag_len,
    struct debug_htt_stats_req *stats_req) {
  const struct htt_tx_pdev_stats_tried_mpdu_cnt_hist_tlv_v *htt_stats_buf
    = tag_buf;
  u8 *buf = stats_req->buf;
  u32 len = stats_req->buf_len;
  u32 buf_len = ATH11K_HTT_STATS_BUF_SIZE;
  ...
  len += scnprintf(buf + len, buf_len - len,
      "TRIED_MPDU_CNT_HIST_BIN_SIZE : %u\n",
...
static inline void htt_print_hw_stats_intr_misc_tlv(const void *tag_buf,
  ...
  len
    += scnprintf(buf + len, buf_len - len, "hw_intr_name = %s\n",
      hw_intr_name);
...
static inline void htt_print_hw_stats_wd_timeout_tlv(const void *tag_buf,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_hwq_mu_mimo_sch_stats_tlv(const void *tag_buf,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_hwq_stats_cmn_tlv(const void *tag_buf,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_hwq_difs_latency_stats_tlv_v(
    const void *tag_buf,
    u16 tag_len,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_hwq_tried_mpdu_cnt_hist_tlv_v(
    const void *tag_buf,
    u16 tag_len,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_hwq_txop_used_cnt_hist_tlv_v(
    const void *tag_buf,
    u16 tag_len,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_selfgen_cmn_stats_tlv(const void *tag_buf,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_selfgen_ac_stats_tlv(const void *tag_buf,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_selfgen_ax_stats_tlv(const void *tag_buf,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_selfgen_ac_err_stats_tlv(const void *tag_buf,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_selfgen_ax_err_stats_tlv(const void *tag_buf,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_pdev_mu_mimo_mpdu_stats_tlv(const void *tag_buf,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_sched_txq_sched_ineligibility_tlv_v(
    const void *tag_buf,
    u16 tag_len,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_pdev_stats_sched_per_txq_tlv(
    const void *tag_buf,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_tqm_list_mpdu_stats_tlv_v(const void *tag_buf,
  ...
  u32 buf_len = ATH11K_HTT_STATS_BUF_SIZE;
  u16 num_elems
    = min_t(u16, (tag_len >> 2), HTT_TX_TQM_MAX_LIST_MPDU_END_REASON);
  len += scnprintf(buf + len, buf_len - len,
...
static inline void htt_print_tx_tqm_pdev_stats_tlv_v(const void *tag_buf,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_de_eapol_packets_stats_tlv(const void *tag_buf,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_de_classify_failed_stats_tlv(
    const void *tag_buf,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_de_classify_stats_tlv(const void *tag_buf,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_de_classify_status_stats_tlv(
    const void *tag_buf,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_de_enqueue_packets_stats_tlv(
    const void *tag_buf,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_de_enqueue_discard_stats_tlv(
    const void *tag_buf,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_de_fw2wbm_ring_full_hist_tlv(
    const void *tag_buf,
    u16 tag_len,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_tx_de_cmn_stats_tlv(const void *tag_buf,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_rx_soc_fw_refill_ring_empty_tlv_v(
    const void *tag_buf,
    u16 tag_len,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_rx_soc_fw_refill_ring_num_rxdma_err_tlv_v(
    const void *tag_buf,
    u16 tag_len,
    struct debug_htt_stats_req *stats_req) {
...
static inline void htt_print_rx_soc_fw_refill_ring_num_reo_err_tlv_v(
    const void *tag_buf,
    u16 tag_len,
    struct debug_htt_stats_req *stats_req) {
  const struct htt_rx_soc_fw_refill_ring_num_reo_err_tlv_v *htt_stats_buf
    = tag_buf;
  u8 *buf = stats_req->buf;
  u32 len = stats_req->buf_len;
  u32 buf_len = ATH11K_HTT_STATS_BUF_SIZE;
...
static inline void htt_print_rx_reo_debug_stats_tlv_v(const void *tag_buf,
  ...
  u32 buf_len = ATH11K_HTT_STATS_BUF_SIZE;
  len
    += scnprintf(buf + len, buf_len - len, "HTT_RX_REO_RESOURCE_STATS_TLV:\n");
...
static inline void htt_print_rx_soc_fw_refill_ring_num_refill_tlv_v(
    const void *tag_buf,
    u16 tag_len,
    struct debug_htt_stats_req *stats_req) {
  const struct htt_rx_soc_fw_refill_ring_num_refill_tlv_v *htt_stats_buf
    = tag_buf;
  u8 *buf = stats_req->buf;
  u32 len = stats_req->buf_len;
  u32 buf_len = ATH11K_HTT_STATS_BUF_SIZE;
...
static inline void htt_print_pdev_stats_cca_counters_tlv(const void *tag_buf,
    struct debug_htt_stats_req *stats_req) {
...
void htt_print_phy_counters_tlv(const void *tag_buf,
  ...
  len += scnprintf(buf + len, buf_len - len,
      "rx_gain_adj_lstf_event_cnt = %u\n",
      htt_stats_buf->rx_gain_adj_lstf_event_cnt);
  len += scnprintf(buf + len, buf_len - len,
      "rx_gain_adj_non_legacy_cnt = %u\n",
