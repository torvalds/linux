...
static inline void ath11k_pci_select_window(struct ath11k_pci *ab_pci,
    u32 offset) {
...
static void ath11k_pci_window_write32(struct ath11k_base *ab, u32 offset,
    u32 value) {
  struct ath11k_pci *ab_pci = ath11k_pci_priv(ab);
  u32 window_start;
...
static inline void ath11k_pci_select_static_window(struct ath11k_pci *ab_pci) {
  ...
  u32 window;
  umac_window
    = FIELD_GET(ATH11K_PCI_WINDOW_VALUE_MASK, HAL_SEQ_WCSS_UMAC_OFFSET);
...
static void ath11k_pci_read_hw_version(struct ath11k_base *ab, u32 *major,
    u32 *minor) {
  u32 soc_hw_version;
...
MODULE_DESCRIPTION(
    "Driver support for Qualcomm Technologies PCIe 802.11ax WLAN devices");
