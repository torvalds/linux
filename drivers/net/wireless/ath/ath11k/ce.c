...
static struct sk_buff *ath11k_ce_completed_send_next(
...
static void ath11k_ce_srng_msi_ring_params_setup(struct ath11k_base *ab,
    u32 ce_id,
...
static struct ath11k_ce_ring *ath11k_ce_alloc_ring(struct ath11k_base *ab,
    int nentries, int desc_sz) {
  struct ath11k_ce_ring *ce_ring;
