...
static bool ath11k_hw_ipq8074_rx_desc_get_mpdu_seq_ctl_vld(
    struct hal_rx_desc *desc) {
  return !!FIELD_GET(RX_MPDU_START_INFO1_MPDU_SEQ_CTRL_VALID,
      __le32_to_cpu(desc->u.ipq8074.mpdu_start.info1));
}

static bool ath11k_hw_ipq8074_rx_desc_get_mpdu_fc_valid(
    struct hal_rx_desc *desc) {
  return !!FIELD_GET(RX_MPDU_START_INFO1_MPDU_FCTRL_VALID,
      __le32_to_cpu(desc->u.ipq8074.mpdu_start.info1));
}

static u16 ath11k_hw_ipq8074_rx_desc_get_mpdu_start_seq_no(
    struct hal_rx_desc *desc) {
...
static u32 ath11k_hw_ipq8074_rx_desc_get_mpdu_start_tag(
    struct hal_rx_desc *desc) {
...
static void ath11k_hw_ipq8074_rx_desc_set_msdu_len(struct hal_rx_desc *desc,
    u16 len) {
...
static
struct rx_attention *ath11k_hw_ipq8074_rx_desc_get_attention(
    struct hal_rx_desc *desc) {
...
static bool ath11k_hw_qcn9074_rx_desc_get_mpdu_seq_ctl_vld(
    struct hal_rx_desc *desc) {
  return !!FIELD_GET(RX_MPDU_START_INFO11_MPDU_SEQ_CTRL_VALID,
      __le32_to_cpu(desc->u.qcn9074.mpdu_start.info11));
}

static bool ath11k_hw_qcn9074_rx_desc_get_mpdu_fc_valid(
    struct hal_rx_desc *desc) {
  return !!FIELD_GET(RX_MPDU_START_INFO11_MPDU_FCTRL_VALID,
      __le32_to_cpu(desc->u.qcn9074.mpdu_start.info11));
}

static u16 ath11k_hw_qcn9074_rx_desc_get_mpdu_start_seq_no(
    struct hal_rx_desc *desc) {
...
static u32 ath11k_hw_qcn9074_rx_desc_get_mpdu_start_tag(
    struct hal_rx_desc *desc) {
  return FIELD_GET(HAL_TLV_HDR_TAG,
...
static void ath11k_hw_qcn9074_rx_desc_set_msdu_len(struct hal_rx_desc *desc,
    u16 len) {
...
static
struct rx_attention *ath11k_hw_qcn9074_rx_desc_get_attention(
    struct hal_rx_desc *desc) {
...
static bool ath11k_hw_wcn6855_rx_desc_get_mpdu_seq_ctl_vld(
    struct hal_rx_desc *desc) {
  return !!FIELD_GET(RX_MPDU_START_INFO1_MPDU_SEQ_CTRL_VALID,
      __le32_to_cpu(desc->u.wcn6855.mpdu_start.info1));
}

static bool ath11k_hw_wcn6855_rx_desc_get_mpdu_fc_valid(
    struct hal_rx_desc *desc) {
  return !!FIELD_GET(RX_MPDU_START_INFO1_MPDU_FCTRL_VALID,
      __le32_to_cpu(desc->u.wcn6855.mpdu_start.info1));
}

static u16 ath11k_hw_wcn6855_rx_desc_get_mpdu_start_seq_no(
    struct hal_rx_desc *desc) {
  return FIELD_GET(RX_MPDU_START_INFO1_MPDU_SEQ_NUM,
      __le32_to_cpu(desc->u.wcn6855.mpdu_start.info1));
}
...
static u32 ath11k_hw_wcn6855_rx_desc_get_mpdu_start_tag(
    struct hal_rx_desc *desc) {
  return FIELD_GET(HAL_TLV_HDR_TAG,
...
static void ath11k_hw_wcn6855_rx_desc_set_msdu_len(struct hal_rx_desc *desc,
    u16 len) {
...
static
struct rx_attention *ath11k_hw_wcn6855_rx_desc_get_attention(
    struct hal_rx_desc *desc) {
...
static u16 ath11k_hw_ipq8074_mpdu_info_get_peerid(
...
static u16 ath11k_hw_qcn9074_mpdu_info_get_peerid(
    struct hal_rx_mpdu_info *mpdu_info) {
  u16 peer_id = 0;
  peer_id = FIELD_GET(HAL_RX_MPDU_INFO_INFO0_PEERID,
...
static u16 ath11k_hw_wcn6855_mpdu_info_get_peerid(
    struct hal_rx_mpdu_info *mpdu_info) {
  u16 peer_id = 0;
