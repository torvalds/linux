...
static void __ath11k_pcic_write32(struct ath11k_base *ab, u32 offset,
    u32 value) {
...
void ath11k_pcic_get_ce_msi_idx(struct ath11k_base *ab, u32 ce_id,
    u32 *msi_idx) {
  u32 i, msi_data_idx;
...
static int ath11k_pcic_get_msi_irq(struct ath11k_base *ab,
    unsigned int vector) {
