...
static int ath12k_core_create_bus_type_board_name(struct ath12k_base *ab,
    char *name,
    size_t name_len) {
...
void ath12k_core_free_bdf(struct ath12k_base *ab,
...
int ath12k_core_fetch_bdf(struct ath12k_base *ab,
    struct ath12k_board_data *bd) {
...
MODULE_DESCRIPTION(
    "Core module for Qualcomm Atheros 802.11be wireless LAN cards.");
