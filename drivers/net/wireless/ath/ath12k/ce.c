...
static struct sk_buff *ath12k_ce_completed_send_next(
...
static void ath12k_ce_srng_msi_ring_params_setup(struct ath12k_base *ab,
    u32 ce_id,
...
static struct ath12k_ce_ring *ath12k_ce_alloc_ring(struct ath12k_base *ab,
