...
static void ath12k_dp_mon_rx_populate_byte_count(
    const struct hal_rx_ppdu_end_user_stats *stats,
    void *ppduinfo,
    struct hal_rx_user_status *rx_user_status) {
...
static void ath12k_dp_mon_rx_populate_mu_user_info(void *rx_tlv,
  ...
  memcpy(&rx_user_status->mpdu_fcs_ok_bitmap[0],
...
static void ath12k_dp_mon_parse_he_sig_b2_ofdma(u8 *tlv_data,
  ...
  ppdu_info->mcs
    = u32_get_bits(info0, HAL_RX_HE_SIG_B2_OFDMA_INFO_INFO0_STA_MCS);
...
static void ath12k_dp_mon_parse_he_sig_mu(u8 *tlv_data,
  ...
  ppdu_info->he_data3 = u32_get_bits(info0,
      HAL_RX_HE_SIG_A_MU_DL_INFO0_BSS_COLOR);
...
static void ath12k_dp_mon_parse_he_sig_su(u8 *tlv_data,
  ...
  ppdu_info->beamformed
    = u32_get_bits(info1, HAL_RX_HE_SIG_A_SU_INFO_INFO1_TXBF);
...
static enum hal_rx_mon_status ath12k_dp_mon_rx_parse_status_tlv(
...
static struct sk_buff *ath12k_dp_mon_rx_merg_msdus(struct ath12k *ar,
...
static void ath12k_dp_mon_rx_update_radiotap_he(
...
static void ath12k_dp_mon_rx_update_radiotap_he_mu(
    struct hal_rx_mon_ppdu_info *rx_status,
    u8 *rtap_buf) {
  u32 rtap_len = 0;
...
static void ath12k_dp_mon_rx_deliver_msdu(struct ath12k *ar,
...
static enum hal_rx_mon_status ath12k_dp_mon_parse_rx_dest(
    struct ath12k_base *ab, struct ath12k_mon_data *pmon,
    struct sk_buff *skb) {
  struct hal_rx_mon_ppdu_info *ppdu_info = &pmon->mon_ppdu_info;
...
static struct dp_mon_tx_ppdu_info *ath12k_dp_mon_tx_get_ppdu_info(
    struct ath12k_mon_data *pmon,
...
static struct dp_mon_tx_ppdu_info *ath12k_dp_mon_hal_tx_ppdu_info(
    struct ath12k_mon_data *pmon,
    u16 tlv_tag) {
  switch (tlv_tag) {
...
static int ath12k_dp_mon_tx_gen_cts2self_frame(
    struct dp_mon_tx_ppdu_info *tx_ppdu_info) {
  struct sk_buff *skb;
...
static int ath12k_dp_mon_tx_gen_rts_frame(
    struct dp_mon_tx_ppdu_info *tx_ppdu_info) {
  struct sk_buff *skb;
...
static int ath12k_dp_mon_tx_gen_3addr_qos_null_frame(
    struct dp_mon_tx_ppdu_info *tx_ppdu_info) {
  struct sk_buff *skb;
...
static int ath12k_dp_mon_tx_gen_4addr_qos_null_frame(
    struct dp_mon_tx_ppdu_info *tx_ppdu_info) {
  struct sk_buff *skb;
...
static int ath12k_dp_mon_tx_gen_ack_frame(
    struct dp_mon_tx_ppdu_info *tx_ppdu_info) {
  struct sk_buff *skb;
...
static int ath12k_dp_mon_tx_gen_prot_frame(
    struct dp_mon_tx_ppdu_info *tx_ppdu_info) {
  int ret = 0;
...
static enum dp_mon_tx_tlv_status ath12k_dp_mon_tx_parse_status_tlv(
    struct ath12k_base *ab,
    struct ath12k_mon_data *pmon,
...
static void ath12k_dp_mon_tx_process_ppdu_info(struct ath12k *ar, int mac_id,
    struct napi_struct *napi,
    struct dp_mon_tx_ppdu_info *tx_ppdu_info) {
...
static void ath12k_dp_mon_rx_update_peer_rate_table_stats(
...
static void ath12k_dp_mon_rx_update_user_stats(struct ath12k *ar,
    struct hal_rx_mon_ppdu_info *ppdu_info,
    u32 uid) {
...
static void ath12k_dp_mon_rx_update_peer_mu_stats(struct ath12k *ar,
    struct hal_rx_mon_ppdu_info *ppdu_info) {
  u32 num_users, i;
  num_users = ppdu_info->num_users;
  if (num_users > HAL_MAX_UL_MU_USERS) {
