...
#define HAL_REO1_SW_COOKIE_CFG0(ab) ((ab)->hw_params->regs-> \
  hal_reo1_sw_cookie_cfg0)
#define HAL_REO1_SW_COOKIE_CFG1(ab) ((ab)->hw_params->regs-> \
  hal_reo1_sw_cookie_cfg1)
#define HAL_REO1_QDESC_LUT_BASE0(ab)  ((ab)->hw_params->regs-> \
  hal_reo1_qdesc_lut_base0)
#define HAL_REO1_QDESC_LUT_BASE1(ab)  ((ab)->hw_params->regs-> \
  hal_reo1_qdesc_lut_base1)
#define HAL_REO1_RING_BASE_LSB(ab)  ((ab)->hw_params->regs-> \
  hal_reo1_ring_base_lsb)
#define HAL_REO1_RING_BASE_MSB(ab)  ((ab)->hw_params->regs-> \
  hal_reo1_ring_base_msb)
#define HAL_REO1_RING_ID(ab)    ((ab)->hw_params->regs->hal_reo1_ring_id)
#define HAL_REO1_RING_MISC(ab)    ((ab)->hw_params->regs->hal_reo1_ring_misc)
#define HAL_REO1_RING_HP_ADDR_LSB(ab) ((ab)->hw_params->regs-> \
  hal_reo1_ring_hp_addr_lsb)
#define HAL_REO1_RING_HP_ADDR_MSB(ab) ((ab)->hw_params->regs-> \
  hal_reo1_ring_hp_addr_msb)
...
#define HAL_REO1_RING_MSI1_DATA(ab) ((ab)->hw_params->regs-> \
  hal_reo1_ring_msi1_data)
#define HAL_REO2_RING_BASE_LSB(ab)  ((ab)->hw_params->regs->hal_reo2_ring_base)
#define HAL_REO1_AGING_THRESH_IX_0(ab)  ((ab)->hw_params->regs-> \
  hal_reo1_aging_thres_ix0)
#define HAL_REO1_AGING_THRESH_IX_1(ab)  ((ab)->hw_params->regs-> \
  hal_reo1_aging_thres_ix1)
#define HAL_REO1_AGING_THRESH_IX_2(ab)  ((ab)->hw_params->regs-> \
  hal_reo1_aging_thres_ix2)
#define HAL_REO1_AGING_THRESH_IX_3(ab)  ((ab)->hw_params->regs-> \
  hal_reo1_aging_thres_ix3)
 ...
 *  descriptor list, where the chip 0 WBM is chosen in case of a multi-chip
 * config
 * @HAL_RX_BUF_RBM_WBM_CHIP1_IDLE_DESC_LIST: Descriptor returned to WBM idle
 *  descriptor list, where the chip 1 WBM is chosen in case of a multi-chip
 * config
 * @HAL_RX_BUF_RBM_WBM_CHIP2_IDLE_DESC_LIST: Descriptor returned to WBM idle
 *  descriptor list, where the chip 2 WBM is chosen in case of a multi-chip
 * config
...
void ath12k_hal_ce_src_set_desc(struct hal_ce_srng_src_desc *desc,
    dma_addr_t paddr,
    u32 len, u32 id, u8 byte_swap_data);
void ath12k_hal_ce_dst_set_desc(struct hal_ce_srng_dest_desc *desc,
    dma_addr_t paddr);
u32 ath12k_hal_ce_dst_status_get_length(
