...
struct qmi_wlanfw_host_cap_req_msg_v01 {
  ...
  u8 ddr_range_valid;
  struct qmi_wlanfw_host_ddr_range ddr_range[
    QMI_WLANFW_MAX_HOST_DDR_RANGE_SIZE_V01];
...
struct qmi_wlanfw_respond_mem_req_msg_v01 {
  u32 mem_seg_len;
  struct qmi_wlanfw_mem_seg_resp_s_v01 mem_seg[
    ATH12K_QMI_WLANFW_MAX_NUM_MEM_SEG_V01];
};
...
struct qmi_wlanfw_cap_resp_msg_v01 {
  ...
  struct qmi_wlanfw_dev_mem_info_s_v01 dev_mem[
    ATH12K_QMI_WLFW_MAX_DEV_MEM_NUM_V01];
};
