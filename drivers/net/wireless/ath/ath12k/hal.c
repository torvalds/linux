...
static unsigned int ath12k_hal_reo1_ring_msi1_base_lsb_offset(
    struct ath12k_base *ab) {
  return HAL_REO1_RING_MSI1_BASE_LSB(ab) - HAL_REO1_RING_BASE_LSB(ab);
}

static unsigned int ath12k_hal_reo1_ring_msi1_base_msb_offset(
    struct ath12k_base *ab) {
  return HAL_REO1_RING_MSI1_BASE_MSB(ab) - HAL_REO1_RING_BASE_LSB(ab);
}

static unsigned int ath12k_hal_reo1_ring_msi1_data_offset(
    struct ath12k_base *ab) {
...
static unsigned int ath12k_hal_reo1_ring_producer_int_setup_offset(
    struct ath12k_base *ab) {
  return HAL_REO1_RING_PRODUCER_INT_SETUP(ab) - HAL_REO1_RING_BASE_LSB(ab);
}

static unsigned int ath12k_hal_reo1_ring_hp_addr_lsb_offset(
    struct ath12k_base *ab) {
  return HAL_REO1_RING_HP_ADDR_LSB(ab) - HAL_REO1_RING_BASE_LSB(ab);
}

static unsigned int ath12k_hal_reo1_ring_hp_addr_msb_offset(
    struct ath12k_base *ab) {
...
static bool ath12k_hw_qcn9274_rx_desc_get_mpdu_seq_ctl_vld(
    struct hal_rx_desc *desc) {
  return !!le32_get_bits(desc->u.qcn9274.mpdu_start.info4,
      RX_MPDU_START_INFO4_MPDU_SEQ_CTRL_VALID);
}

static bool ath12k_hw_qcn9274_rx_desc_get_mpdu_fc_valid(
    struct hal_rx_desc *desc) {
  return !!le32_get_bits(desc->u.qcn9274.mpdu_start.info4,
...
static void ath12k_hw_qcn9274_rx_desc_set_msdu_len(struct hal_rx_desc *desc,
    u16 len) {
...
static void ath12k_hw_qcn9274_rx_desc_get_crypto_hdr(struct hal_rx_desc *desc,
  ...
  crypto_hdr[4]
    = HAL_RX_MPDU_INFO_PN_GET_BYTE3(desc->u.qcn9274.mpdu_start.pn[0]);
  crypto_hdr[5]
    = HAL_RX_MPDU_INFO_PN_GET_BYTE4(desc->u.qcn9274.mpdu_start.pn[0]);
  crypto_hdr[6]
    = HAL_RX_MPDU_INFO_PN_GET_BYTE1(desc->u.qcn9274.mpdu_start.pn[1]);
  crypto_hdr[7]
    = HAL_RX_MPDU_INFO_PN_GET_BYTE2(desc->u.qcn9274.mpdu_start.pn[1]);
}

static u16 ath12k_hw_qcn9274_rx_desc_get_mpdu_frame_ctl(
    struct hal_rx_desc *desc) {
...
static int ath12k_hal_srng_create_config_qcn9274(struct ath12k_base *ab) {
  ...
  s->reg_start[0] = HAL_SEQ_WCSS_UMAC_REO_REG
      + HAL_REO_STATUS_RING_BASE_LSB(ab);
  ...
  s->reg_start[0] = HAL_SEQ_WCSS_UMAC_TCL_REG
      + HAL_TCL_STATUS_RING_BASE_LSB(ab);
...
static bool ath12k_hw_qcn9274_compact_rx_desc_get_first_msdu(
    struct hal_rx_desc *desc) {
  return !!le16_get_bits(desc->u.qcn9274_compact.msdu_end.info5,
      RX_MSDU_END_INFO5_FIRST_MSDU);
}

static bool ath12k_hw_qcn9274_compact_rx_desc_get_last_msdu(
    struct hal_rx_desc *desc) {
  return !!le16_get_bits(desc->u.qcn9274_compact.msdu_end.info5,
      RX_MSDU_END_INFO5_LAST_MSDU);
}

static u8 ath12k_hw_qcn9274_compact_rx_desc_get_l3_pad_bytes(
    struct hal_rx_desc *desc) {
  return le16_get_bits(desc->u.qcn9274_compact.msdu_end.info5,
      RX_MSDU_END_INFO5_L3_HDR_PADDING);
}

static bool ath12k_hw_qcn9274_compact_rx_desc_encrypt_valid(
    struct hal_rx_desc *desc) {
  return !!le32_get_bits(desc->u.qcn9274_compact.mpdu_start.info4,
      RX_MPDU_START_INFO4_ENCRYPT_INFO_VALID);
}

static u32 ath12k_hw_qcn9274_compact_rx_desc_get_encrypt_type(
    struct hal_rx_desc *desc) {
  return le32_get_bits(desc->u.qcn9274_compact.mpdu_start.info2,
      RX_MPDU_START_INFO2_ENC_TYPE);
}

static u8 ath12k_hw_qcn9274_compact_rx_desc_get_decap_type(
    struct hal_rx_desc *desc) {
  return le32_get_bits(desc->u.qcn9274_compact.msdu_end.info11,
      RX_MSDU_END_INFO11_DECAP_FORMAT);
}

static u8 ath12k_hw_qcn9274_compact_rx_desc_get_mesh_ctl(
    struct hal_rx_desc *desc) {
  return le32_get_bits(desc->u.qcn9274.msdu_end.info11,
      RX_MSDU_END_INFO11_MESH_CTRL_PRESENT);
}

static bool ath12k_hw_qcn9274_compact_rx_desc_get_mpdu_seq_ctl_vld(
    struct hal_rx_desc *desc) {
  return !!le32_get_bits(desc->u.qcn9274_compact.mpdu_start.info4,
      RX_MPDU_START_INFO4_MPDU_SEQ_CTRL_VALID);
}

static bool ath12k_hw_qcn9274_compact_rx_desc_get_mpdu_fc_valid(
    struct hal_rx_desc *desc) {
  return !!le32_get_bits(desc->u.qcn9274_compact.mpdu_start.info4,
      RX_MPDU_START_INFO4_MPDU_FCTRL_VALID);
}

static u16 ath12k_hw_qcn9274_compact_rx_desc_get_mpdu_start_seq_no(
    struct hal_rx_desc *desc) {
  return le32_get_bits(desc->u.qcn9274_compact.mpdu_start.info4,
      RX_MPDU_START_INFO4_MPDU_SEQ_NUM);
}
...
static u8 ath12k_hw_qcn9274_compact_rx_desc_get_msdu_sgi(
    struct hal_rx_desc *desc) {
  return le32_get_bits(desc->u.qcn9274_compact.msdu_end.info12,
      RX_MSDU_END_INFO12_SGI);
}

static u8 ath12k_hw_qcn9274_compact_rx_desc_get_msdu_rate_mcs(
    struct hal_rx_desc *desc) {
  return le32_get_bits(desc->u.qcn9274_compact.msdu_end.info12,
      RX_MSDU_END_INFO12_RATE_MCS);
}

static u8 ath12k_hw_qcn9274_compact_rx_desc_get_msdu_rx_bw(
    struct hal_rx_desc *desc) {
  return le32_get_bits(desc->u.qcn9274_compact.msdu_end.info12,
      RX_MSDU_END_INFO12_RECV_BW);
}

static u32 ath12k_hw_qcn9274_compact_rx_desc_get_msdu_freq(
    struct hal_rx_desc *desc) {
  return __le32_to_cpu(desc->u.qcn9274_compact.msdu_end.phy_meta_data);
}

static u8 ath12k_hw_qcn9274_compact_rx_desc_get_msdu_pkt_type(
    struct hal_rx_desc *desc) {
  return le32_get_bits(desc->u.qcn9274_compact.msdu_end.info12,
      RX_MSDU_END_INFO12_PKT_TYPE);
}
...
static u8 ath12k_hw_qcn9274_compact_rx_desc_get_mpdu_tid(
    struct hal_rx_desc *desc) {
  return le16_get_bits(desc->u.qcn9274_compact.msdu_end.info5,
      RX_MSDU_END_QCN9274_INFO5_TID);
}

static u16 ath12k_hw_qcn9274_compact_rx_desc_get_mpdu_peer_id(
    struct hal_rx_desc *desc) {
  return __le16_to_cpu(desc->u.qcn9274_compact.mpdu_start.sw_peer_id);
}

static void ath12k_hw_qcn9274_compact_rx_desc_copy_end_tlv(
    struct hal_rx_desc *fdesc,
    struct hal_rx_desc *ldesc) {
  fdesc->u.qcn9274_compact.msdu_end = ldesc->u.qcn9274_compact.msdu_end;
}

static u32 ath12k_hw_qcn9274_compact_rx_desc_get_mpdu_ppdu_id(
    struct hal_rx_desc *desc) {
  return __le16_to_cpu(desc->u.qcn9274_compact.mpdu_start.phy_ppdu_id);
}

static void ath12k_hw_qcn9274_compact_rx_desc_set_msdu_len(
    struct hal_rx_desc *desc, u16 len) {
...
static u8 *ath12k_hw_qcn9274_compact_rx_desc_get_msdu_payload(
    struct hal_rx_desc *desc) {
...
static bool ath12k_hw_qcn9274_compact_rx_desc_mac_addr2_valid(
    struct hal_rx_desc *desc) {
...
static bool ath12k_hw_qcn9274_compact_rx_desc_is_da_mcbc(
    struct hal_rx_desc *desc) {
  return __le32_to_cpu(desc->u.qcn9274_compact.mpdu_start.info6)
    & RX_MPDU_START_INFO6_MCAST_BCAST;
}

static void ath12k_hw_qcn9274_compact_rx_desc_get_dot11_hdr(
    struct hal_rx_desc *desc,
    struct ieee80211_hdr *hdr) {
...
static void ath12k_hw_qcn9274_compact_rx_desc_get_crypto_hdr(
    struct hal_rx_desc *desc,
    u8 *crypto_hdr,
    enum hal_encrypt_type enctype) {
  unsigned int key_id;
...
static bool ath12k_hw_qcn9274_compact_dp_rx_h_msdu_done(
    struct hal_rx_desc *desc) {
  return !!le32_get_bits(desc->u.qcn9274_compact.msdu_end.info14,
      RX_MSDU_END_INFO14_MSDU_DONE);
}

static bool ath12k_hw_qcn9274_compact_dp_rx_h_l4_cksum_fail(
    struct hal_rx_desc *desc) {
...
static bool ath12k_hw_qcn9274_compact_dp_rx_h_is_decrypted(
    struct hal_rx_desc *desc) {
  return le32_get_bits(desc->u.qcn9274_compact.msdu_end.info14,
      RX_MSDU_END_INFO14_DECRYPT_STATUS_CODE)
    == RX_DESC_DECRYPT_STATUS_CODE_OK;
...
static u8 ath12k_hw_qcn9274_compact_rx_desc_get_msdu_src_link(
    struct hal_rx_desc *desc) {
...
const struct hal_rx_ops hal_rx_qcn9274_compact_ops = {
  ...
  .rx_desc_get_l3_pad_bytes
    = ath12k_hw_qcn9274_compact_rx_desc_get_l3_pad_bytes,
  .rx_desc_encrypt_valid = ath12k_hw_qcn9274_compact_rx_desc_encrypt_valid,
  .rx_desc_get_encrypt_type
    = ath12k_hw_qcn9274_compact_rx_desc_get_encrypt_type,
  ...
  .rx_desc_get_msdu_rate_mcs
    = ath12k_hw_qcn9274_compact_rx_desc_get_msdu_rate_mcs,
  ...
  .rx_desc_get_msdu_pkt_type
    = ath12k_hw_qcn9274_compact_rx_desc_get_msdu_pkt_type,
  ...
  .rx_desc_mpdu_start_addr2
    = ath12k_hw_qcn9274_compact_rx_desc_mpdu_start_addr2,
...
static bool ath12k_hw_wcn7850_rx_desc_get_mpdu_seq_ctl_vld(
    struct hal_rx_desc *desc) {
  return !!le32_get_bits(desc->u.wcn7850.mpdu_start.info4,
      RX_MPDU_START_INFO4_MPDU_SEQ_CTRL_VALID);
}

static bool ath12k_hw_wcn7850_rx_desc_get_mpdu_fc_valid(
    struct hal_rx_desc *desc) {
  return !!le32_get_bits(desc->u.wcn7850.mpdu_start.info4,
      RX_MPDU_START_INFO4_MPDU_FCTRL_VALID);
}

static u16 ath12k_hw_wcn7850_rx_desc_get_mpdu_start_seq_no(
    struct hal_rx_desc *desc) {
  return le32_get_bits(desc->u.wcn7850.mpdu_start.info4,
      RX_MPDU_START_INFO4_MPDU_SEQ_NUM);
}
...
static u32 ath12k_hw_wcn7850_rx_desc_get_mpdu_start_tag(
    struct hal_rx_desc *desc) {
...
static void ath12k_hw_wcn7850_rx_desc_set_msdu_len(struct hal_rx_desc *desc,
    u16 len) {
...
static void ath12k_hw_wcn7850_rx_desc_get_crypto_hdr(struct hal_rx_desc *desc,
  ...
  crypto_hdr[3] = 0x20 | (key_id << 6);
  crypto_hdr[4]
    = HAL_RX_MPDU_INFO_PN_GET_BYTE3(desc->u.wcn7850.mpdu_start.pn[0]);
  crypto_hdr[5]
    = HAL_RX_MPDU_INFO_PN_GET_BYTE4(desc->u.wcn7850.mpdu_start.pn[0]);
  crypto_hdr[6]
    = HAL_RX_MPDU_INFO_PN_GET_BYTE1(desc->u.wcn7850.mpdu_start.pn[1]);
  crypto_hdr[7]
    = HAL_RX_MPDU_INFO_PN_GET_BYTE2(desc->u.wcn7850.mpdu_start.pn[1]);
}
...
const struct hal_rx_ops hal_rx_wcn7850_ops = {
  ...
  .rx_desc_get_mpdu_seq_ctl_vld
    = ath12k_hw_wcn7850_rx_desc_get_mpdu_seq_ctl_vld,
...
static void ath12k_hal_srng_dst_hw_init(struct ath12k_base *ab,
  ...
  ath12k_hif_write32(ab, reg_base + ath12k_hal_reo1_ring_base_msb_offset(
      ab), val);
...
void ath12k_hal_setup_link_idle_list(struct ath12k_base *ab,
  ...
  ath12k_hif_write32(ab,
      ...
      val);
  val = u32_encode_bits(
      ((u64) sbuf[nsbufs - 1].paddr >> HAL_ADDR_MSB_REG_SHIFT),
      HAL_WBM_SCATTERED_DESC_MSB_BASE_ADDR_39_32)
