...
static enum hal_tcl_encap_type ath12k_dp_tx_get_encap_type(
    struct ath12k_vif *arvif, struct sk_buff *skb) {
...
static struct ath12k_tx_desc_info *ath12k_dp_tx_assign_buffer(
    struct ath12k_dp *dp,
    u8 pool_id) {
...
static void ath12k_dp_tx_htt_tx_complete_buf(struct ath12k_base *ab,
    struct sk_buff *msdu,
    struct dp_tx_ring *tx_ring,
...
static void ath12k_dp_tx_process_htt_tx_complete(struct ath12k_base *ab,
    void *desc, u8 mac_id,
    struct sk_buff *msdu,
    struct dp_tx_ring *tx_ring) {
...
static int ath12k_dp_tx_get_ring_id_type(struct ath12k_base *ab,
...
int ath12k_dp_tx_htt_h2t_ext_stats_req(struct ath12k *ar, u8 type,
...
int ath12k_dp_tx_htt_tx_monitor_mode_ring_config(struct ath12k *ar,
    bool reset) {
  struct ath12k_base *ab = ar->ab;
  struct ath12k_dp *dp = &ab->dp;
