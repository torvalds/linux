...
static int ath10k_wmi_tlv_iter(struct ath10k *ar, const void *ptr, size_t len,
...
static const void **ath10k_wmi_tlv_parse_alloc(struct ath10k *ar,
    const void *ptr,
...
static int ath10k_wmi_tlv_parse_peer_stats_info(struct ath10k *ar, u16 tag,
    u16 len,
    const void *ptr, void *data) {
...
static int ath10k_wmi_tlv_op_pull_mgmt_tx_compl_ev(struct ath10k *ar,
    struct sk_buff *skb,
...
static int ath10k_wmi_tlv_mgmt_tx_bundle_compl_parse(struct ath10k *ar, u16 tag,
    u16 len,
    const void *ptr, void *data) {
...
static int ath10k_wmi_tlv_op_pull_vdev_start_ev(struct ath10k *ar,
    struct sk_buff *skb,
...
static int ath10k_wmi_tlv_op_pull_swba_ev(struct ath10k *ar,
    struct sk_buff *skb,
    struct wmi_swba_ev_arg *arg) {
  struct wmi_tlv_swba_parse swba = {
    .arg = arg
  };
  u32 map;
  size_t n_vdevs;
...
static int ath10k_wmi_tlv_parse_mem_reqs(struct ath10k *ar, u16 tag, u16 len,
    const void *ptr, void *data) {
...
static int ath10k_wmi_tlv_op_pull_wow_ev(struct ath10k *ar, struct sk_buff *skb,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_pdev_suspend(struct ath10k *ar,
    u32 opt) {
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_pdev_resume(struct ath10k *ar) {
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_pdev_set_rd(struct ath10k *ar,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_pdev_set_param(struct ath10k *ar,
    u32 param_id,
    u32 param_value) {
...
static void ath10k_wmi_tlv_put_host_mem_chunks(struct ath10k *ar,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_start_scan(struct ath10k *ar,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_stop_scan(struct ath10k *ar,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_vdev_create(struct ath10k *ar,
    u32 vdev_id,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_vdev_delete(struct ath10k *ar,
    u32 vdev_id) {
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_vdev_start(struct ath10k *ar,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_vdev_stop(struct ath10k *ar,
    u32 vdev_id) {
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_vdev_up(struct ath10k *ar,
    u32 vdev_id, u32 aid,
    const u8 *bssid) {
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_vdev_down(struct ath10k *ar,
    u32 vdev_id) {
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_vdev_set_param(struct ath10k *ar,
    u32 vdev_id,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_vdev_install_key(struct ath10k *ar,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_vdev_sta_uapsd(struct ath10k *ar,
    u32 vdev_id,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_vdev_wmm_conf(struct ath10k *ar,
    u32 vdev_id,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_sta_keepalive(struct ath10k *ar,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_peer_create(struct ath10k *ar,
    u32 vdev_id,
    const u8 peer_addr[ETH_ALEN],
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_peer_delete(struct ath10k *ar,
    u32 vdev_id,
    const u8 peer_addr[ETH_ALEN]) {
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_peer_flush(struct ath10k *ar,
    u32 vdev_id,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_peer_set_param(struct ath10k *ar,
    u32 vdev_id,
    const u8 *peer_addr,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_peer_assoc(struct ath10k *ar,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_set_psmode(struct ath10k *ar,
    u32 vdev_id,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_set_sta_ps(struct ath10k *ar,
    u32 vdev_id,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_set_ap_ps(struct ath10k *ar,
    u32 vdev_id,
    const u8 *mac,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_scan_chan_list(struct ath10k *ar,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_scan_prob_req_oui(
    struct ath10k *ar, u32 prob_req_oui) {
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_beacon_dma(struct ath10k *ar,
    u32 vdev_id,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_pdev_set_wmm(struct ath10k *ar,
    const struct wmi_wmm_params_all_arg *arg) {
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_request_stats(struct ath10k *ar,
    u32 stats_mask) {
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_request_peer_stats_info(
    struct ath10k *ar,
    u32 vdev_id,
...
static int ath10k_wmi_tlv_op_cleanup_mgmt_tx_send(struct ath10k *ar,
    struct sk_buff *msdu) {
...
static int ath10k_wmi_mgmt_tx_alloc_msdu_id(struct ath10k *ar,
    struct sk_buff *skb,
    dma_addr_t paddr) {
  struct ath10k_wmi *wmi = &ar->wmi;
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_mgmt_tx_send(struct ath10k *ar,
    struct sk_buff *msdu,
    dma_addr_t paddr) {
  struct ath10k_skb_cb *cb = ATH10K_SKB_CB(msdu);
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_force_fw_hang(struct ath10k *ar,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_dbglog_cfg(struct ath10k *ar,
    u64 module_enable,
    u32 log_level) {
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_pktlog_enable(struct ath10k *ar,
    u32 filter) {
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_pdev_get_temperature(
    struct ath10k *ar) {
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_pktlog_disable(struct ath10k *ar) {
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_bcn_tmpl(struct ath10k *ar,
    u32 vdev_id,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_prb_tmpl(struct ath10k *ar,
    u32 vdev_id,
    struct sk_buff *prb) {
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_p2p_go_bcn_ie(struct ath10k *ar,
    u32 vdev_id,
    const u8 *p2p_ie) {
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_update_fw_tdls_state(
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_tdls_peer_update(struct ath10k *ar,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_pdev_set_quiet_mode(
    struct ath10k *ar, u32 period,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_wow_enable(struct ath10k *ar) {
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_wow_add_wakeup_event(
    struct ath10k *ar,
    u32 vdev_id,
...
static struct sk_buff *ath10k_wmi_tlv_gen_wow_host_wakeup_ind(struct ath10k *ar)
{
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_wow_add_pattern(struct ath10k *ar,
    u32 vdev_id,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_wow_del_pattern(struct ath10k *ar,
    u32 vdev_id,
    u32 pattern_id) {
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_config_pno_start(struct ath10k *ar,
    u32 vdev_id,
  ...
  cmd->flags
    = __cpu_to_le32(WMI_NLO_CONFIG_START | WMI_NLO_CONFIG_SSID_HIDE_EN);
  ...
  ptr += __le32_to_cpu(cmd->no_of_ssids)
      * sizeof(struct nlo_configured_parameters);
  /* copy channel info */
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_config_pno(struct ath10k *ar,
    u32 vdev_id,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_adaptive_qcs(struct ath10k *ar,
    bool enable) {
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_echo(struct ath10k *ar,
    u32 value) {
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_vdev_spectral_conf(
    struct ath10k *ar,
...
static struct sk_buff *ath10k_wmi_tlv_op_gen_vdev_spectral_enable(
    struct ath10k *ar, u32 vdev_id,
