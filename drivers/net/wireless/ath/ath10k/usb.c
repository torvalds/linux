...
static inline enum ath10k_htc_ep_id eid_from_htc_hdr(
...
/* pipe/urb operations */
static struct ath10k_urb_context *ath10k_usb_alloc_urb_from_pipe(
...
MODULE_DESCRIPTION(
    "Driver support for Qualcomm Atheros USB 802.11ac WLAN devices");
