...
static inline void wmi_tlv_svc_map(const __le32 *in, unsigned long *out,
    size_t len) {
...
static inline void wmi_tlv_svc_map_ext(const __le32 *in, unsigned long *out,
    size_t len) {
...
struct wmi_tlv_wow_nlo_config_cmd {
   ...
   * cnlo_bss_band_rssi_pref[num_cnlo_band_pref];
   */
} __packed;
