...
static inline struct ath10k_fw_crash_data *ath10k_coredump_new(
    struct ath10k *ar) {
  return NULL;
}
...
static inline const struct ath10k_hw_mem_layout *ath10k_coredump_get_mem_layout(
    struct ath10k *ar) {
  return NULL;
}

static inline const struct ath10k_hw_mem_layout *_ath10k_coredump_get_mem_layout(
    struct ath10k *ar) {
  return NULL;
}
