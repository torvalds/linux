...
static inline int ath10k_tx_data_rssi_get_pad_bytes(struct ath10k_hw_params *hw,
    struct htt_resp *htt) {
...
static inline int ath10k_is_rssi_enable(struct ath10k_hw_params *hw,
...
#define SOC_RESET_CONTROL_SI0_RST_MASK    ar->regs-> \
