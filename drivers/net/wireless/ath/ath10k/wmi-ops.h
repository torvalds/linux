...
struct wmi_ops {
  ...
  struct sk_buff *(*gen_pdev_bss_chan_info_req)(struct ath10k *ar,
      enum wmi_bss_survey_req_type type);
  struct sk_buff *(*gen_echo)(struct ath10k *ar, u32 value);
  struct sk_buff *(*gen_pdev_get_tpc_table_cmdid)(struct ath10k *ar,
      u32 param);
  struct sk_buff *(*gen_bb_timing)(struct ath10k *ar,
...
static inline int ath10k_wmi_rx(struct ath10k *ar, struct sk_buff *skb) {
...
static inline int ath10k_wmi_map_svc(struct ath10k *ar, const __le32 *in,
    unsigned long *out,
    size_t len) {
...
static inline int ath10k_wmi_map_svc_ext(struct ath10k *ar, const __le32 *in,
    unsigned long *out,
    size_t len) {
...
static inline int ath10k_wmi_pull_scan(struct ath10k *ar, struct sk_buff *skb,
    struct wmi_scan_ev_arg *arg) {
...
static inline int ath10k_wmi_pull_mgmt_tx_compl(struct ath10k *ar,
    struct sk_buff *skb,
    struct wmi_tlv_mgmt_tx_compl_ev_arg *arg) {
...
static inline int ath10k_wmi_pull_mgmt_tx_bundle_compl(struct ath10k *ar,
    struct sk_buff *skb,
    struct wmi_tlv_mgmt_tx_bundle_compl_ev_arg *arg) {
...
static inline int ath10k_wmi_pull_mgmt_rx(struct ath10k *ar,
    struct sk_buff *skb,
    struct wmi_mgmt_rx_ev_arg *arg) {
...
static inline int ath10k_wmi_pull_ch_info(struct ath10k *ar,
    struct sk_buff *skb,
    struct wmi_ch_info_ev_arg *arg) {
...
static inline int ath10k_wmi_pull_vdev_start(struct ath10k *ar,
    struct sk_buff *skb,
    struct wmi_vdev_start_ev_arg *arg) {
...
static inline int ath10k_wmi_pull_peer_kick(struct ath10k *ar,
    struct sk_buff *skb,
    struct wmi_peer_kick_ev_arg *arg) {
...
static inline int ath10k_wmi_pull_swba(struct ath10k *ar, struct sk_buff *skb,
    struct wmi_swba_ev_arg *arg) {
...
static inline int ath10k_wmi_pull_phyerr_hdr(struct ath10k *ar,
    struct sk_buff *skb,
    struct wmi_phyerr_hdr_arg *arg) {
...
static inline int ath10k_wmi_pull_phyerr(struct ath10k *ar,
...
static inline int ath10k_wmi_pull_svc_rdy(struct ath10k *ar,
    struct sk_buff *skb,
    struct wmi_svc_rdy_ev_arg *arg) {
...
static inline int ath10k_wmi_pull_rdy(struct ath10k *ar, struct sk_buff *skb,
    struct wmi_rdy_ev_arg *arg) {
...
static inline int ath10k_wmi_pull_svc_avail(struct ath10k *ar,
    struct sk_buff *skb,
    struct wmi_svc_avail_ev_arg *arg) {
...
static inline int ath10k_wmi_pull_fw_stats(struct ath10k *ar,
    struct sk_buff *skb,
    struct ath10k_fw_stats *stats) {
...
static inline int ath10k_wmi_pull_roam_ev(struct ath10k *ar,
    struct sk_buff *skb,
    struct wmi_roam_ev_arg *arg) {
...
static inline int ath10k_wmi_pull_wow_event(struct ath10k *ar,
    struct sk_buff *skb,
    struct wmi_wow_ev_arg *arg) {
...
static inline int ath10k_wmi_pull_echo_ev(struct ath10k *ar,
    struct sk_buff *skb,
    struct wmi_echo_ev_arg *arg) {
...
static inline int ath10k_wmi_pull_dfs_status(struct ath10k *ar,
    struct sk_buff *skb,
    struct wmi_dfs_status_ev_arg *arg) {
...
static inline enum wmi_txbf_conf ath10k_wmi_get_txbf_conf_scheme(
    struct ath10k *ar) {
...
static inline int ath10k_wmi_cleanup_mgmt_tx_send(struct ath10k *ar,
    struct sk_buff *msdu) {
...
static inline int ath10k_wmi_mgmt_tx_send(struct ath10k *ar,
    struct sk_buff *msdu,
    dma_addr_t paddr) {
  struct sk_buff *skb;
  int ret;
...
static inline int ath10k_wmi_mgmt_tx(struct ath10k *ar, struct sk_buff *msdu) {
...
static inline int ath10k_wmi_pdev_set_regdomain(struct ath10k *ar, u16 rd,
    u16 rd2g, u16 rd5g,
    u16 ctl2g, u16 ctl5g,
    enum wmi_dfs_region dfs_reg) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_pdev_set_base_macaddr(struct ath10k *ar,
    const u8 macaddr[ETH_ALEN]) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_pdev_suspend_target(struct ath10k *ar,
    u32 suspend_opt) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_pdev_resume_target(struct ath10k *ar) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_pdev_set_param(struct ath10k *ar, u32 id,
    u32 value) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_cmd_init(struct ath10k *ar) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_start_scan(struct ath10k *ar,
    const struct wmi_start_scan_arg *arg) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_stop_scan(struct ath10k *ar,
    const struct wmi_stop_scan_arg *arg) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_vdev_create(struct ath10k *ar, u32 vdev_id,
    enum wmi_vdev_type type,
    enum wmi_vdev_subtype subtype,
    const u8 macaddr[ETH_ALEN]) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_vdev_delete(struct ath10k *ar, u32 vdev_id) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_vdev_start(struct ath10k *ar,
    const struct wmi_vdev_start_request_arg *arg) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_vdev_restart(struct ath10k *ar,
    const struct wmi_vdev_start_request_arg *arg) {
  struct sk_buff *skb;
  if (!ar->wmi.ops->gen_vdev_start) {
    return -EOPNOTSUPP;
...
static inline int ath10k_wmi_vdev_stop(struct ath10k *ar, u32 vdev_id) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_vdev_up(struct ath10k *ar, u32 vdev_id, u32 aid,
    const u8 *bssid) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_vdev_down(struct ath10k *ar, u32 vdev_id) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_vdev_set_param(struct ath10k *ar, u32 vdev_id,
    u32 param_id,
    u32 param_value) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_vdev_install_key(struct ath10k *ar,
    const struct wmi_vdev_install_key_arg *arg) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_vdev_spectral_conf(struct ath10k *ar,
    const struct wmi_vdev_spectral_conf_arg *arg) {
  struct sk_buff *skb;
  u32 cmd_id;
...
static inline int ath10k_wmi_vdev_spectral_enable(struct ath10k *ar,
    u32 vdev_id, u32 trigger,
    u32 enable) {
  struct sk_buff *skb;
  u32 cmd_id;
...
static inline int ath10k_wmi_vdev_sta_uapsd(struct ath10k *ar, u32 vdev_id,
    const u8 peer_addr[ETH_ALEN],
    const struct wmi_sta_uapsd_auto_trig_arg *args,
    u32 num_ac) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_vdev_wmm_conf(struct ath10k *ar, u32 vdev_id,
    const struct wmi_wmm_params_all_arg *arg) {
  struct sk_buff *skb;
  u32 cmd_id;
...
static inline int ath10k_wmi_peer_create(struct ath10k *ar, u32 vdev_id,
    const u8 peer_addr[ETH_ALEN],
    enum wmi_peer_type peer_type) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_peer_delete(struct ath10k *ar, u32 vdev_id,
    const u8 peer_addr[ETH_ALEN]) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_peer_flush(struct ath10k *ar, u32 vdev_id,
...
static inline int ath10k_wmi_peer_set_param(struct ath10k *ar, u32 vdev_id,
    const u8 *peer_addr,
...
static inline int ath10k_wmi_set_psmode(struct ath10k *ar, u32 vdev_id,
    enum wmi_sta_ps_mode psmode) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_set_sta_ps_param(struct ath10k *ar, u32 vdev_id,
...
static inline int ath10k_wmi_set_ap_ps_param(struct ath10k *ar, u32 vdev_id,
    const u8 *mac,
...
static inline int ath10k_wmi_scan_chan_list(struct ath10k *ar,
    const struct wmi_scan_chan_list_arg *arg) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_scan_prob_req_oui(struct ath10k *ar,
...
static inline int ath10k_wmi_peer_assoc(struct ath10k *ar,
    const struct wmi_peer_assoc_complete_arg *arg) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_beacon_send_ref_nowait(struct ath10k *ar,
    u32 vdev_id,
    const void *bcn, size_t bcn_len,
    u32 bcn_paddr, bool dtim_zero,
    bool deliver_cab) {
...
static inline int ath10k_wmi_pdev_set_wmm_params(struct ath10k *ar,
    const struct wmi_wmm_params_all_arg *arg) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_request_stats(struct ath10k *ar, u32 stats_mask) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_request_peer_stats_info(struct ath10k *ar,
    u32 vdev_id,
...
static inline int ath10k_wmi_force_fw_hang(struct ath10k *ar,
...
static inline int ath10k_wmi_dbglog_cfg(struct ath10k *ar, u64 module_enable,
    u32 log_level) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_pdev_pktlog_enable(struct ath10k *ar, u32 filter) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_pdev_pktlog_disable(struct ath10k *ar) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_pdev_set_quiet_mode(struct ath10k *ar, u32 period,
    u32 duration,
...
static inline int ath10k_wmi_pdev_get_temperature(struct ath10k *ar) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_addba_clear_resp(struct ath10k *ar, u32 vdev_id,
    const u8 *mac) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_addba_send(struct ath10k *ar, u32 vdev_id,
    const u8 *mac,
...
static inline int ath10k_wmi_addba_set_resp(struct ath10k *ar, u32 vdev_id,
    const u8 *mac,
    u32 tid, u32 status) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_delba_send(struct ath10k *ar, u32 vdev_id,
    const u8 *mac,
...
static inline int ath10k_wmi_bcn_tmpl(struct ath10k *ar, u32 vdev_id,
    u32 tim_ie_offset,
...
static inline int ath10k_wmi_prb_tmpl(struct ath10k *ar, u32 vdev_id,
    struct sk_buff *prb) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_p2p_go_bcn_ie(struct ath10k *ar, u32 vdev_id,
    const u8 *p2p_ie) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_sta_keepalive(struct ath10k *ar,
    const struct wmi_sta_keepalive_arg *arg) {
  struct sk_buff *skb;
  u32 cmd_id;
...
static inline int ath10k_wmi_wow_enable(struct ath10k *ar) {
  struct sk_buff *skb;
  u32 cmd_id;
...
static inline int ath10k_wmi_wow_add_wakeup_event(struct ath10k *ar,
    u32 vdev_id,
    enum wmi_wow_wakeup_event event,
    u32 enable) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_wow_host_wakeup_ind(struct ath10k *ar) {
  struct sk_buff *skb;
  u32 cmd_id;
...
static inline int ath10k_wmi_wow_add_pattern(struct ath10k *ar, u32 vdev_id,
    u32 pattern_id,
...
static inline int ath10k_wmi_wow_del_pattern(struct ath10k *ar, u32 vdev_id,
    u32 pattern_id) {
  struct sk_buff *skb;
  u32 cmd_id;
...
static inline int ath10k_wmi_wow_config_pno(struct ath10k *ar, u32 vdev_id,
    struct wmi_pno_scan_req *pno_scan) {
  struct sk_buff *skb;
  u32 cmd_id;
...
static inline int ath10k_wmi_update_fw_tdls_state(struct ath10k *ar,
    u32 vdev_id,
    enum wmi_tdls_state state) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_tdls_peer_update(struct ath10k *ar,
    const struct wmi_tdls_peer_update_cmd_arg *arg,
    const struct wmi_tdls_peer_capab_arg *cap,
    const struct wmi_channel_arg *chan) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_adaptive_qcs(struct ath10k *ar, bool enable) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_pdev_get_tpc_config(struct ath10k *ar, u32 param) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_fw_stats_fill(struct ath10k *ar,
    struct ath10k_fw_stats *fw_stats,
    char *buf) {
...
static inline int ath10k_wmi_pdev_enable_adaptive_cca(struct ath10k *ar,
    u8 enable,
...
static inline int ath10k_wmi_ext_resource_config(struct ath10k *ar,
    enum wmi_host_platform_type type,
    u32 fw_feature_bitmap) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_get_vdev_subtype(struct ath10k *ar,
    enum wmi_vdev_subtype subtype) {
...
static inline int ath10k_wmi_pdev_bss_chan_info_request(struct ath10k *ar,
    enum wmi_bss_survey_req_type type) {
...
static inline int ath10k_wmi_echo(struct ath10k *ar, u32 value) {
  struct ath10k_wmi *wmi = &ar->wmi;
  struct sk_buff *skb;
  if (!wmi->ops->gen_echo) {
    return -EOPNOTSUPP;
...
static inline int ath10k_wmi_pdev_get_tpc_table_cmdid(struct ath10k *ar,
    u32 param) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_report_radar_found(struct ath10k *ar,
    const struct ath10k_radar_found_info *arg) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_pdev_bb_timing(struct ath10k *ar,
    const struct wmi_bb_timing_cfg_arg *arg) {
  struct sk_buff *skb;
...
static inline int ath10k_wmi_set_per_peer_per_tid_cfg(struct ath10k *ar,
    const struct wmi_per_peer_per_tid_cfg_arg *arg) {
  struct sk_buff *skb;
