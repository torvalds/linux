				...
				size_t bin_len, u64 tsf)
{
	...
	case 80:
		 ...
		 * yest match with the other samples at all. Until the reason
	...
	fft_sample->yesise = __cpu_to_be16(phyerr->nf_chains[chain_idx]);
				       ...
				       enum ath10k_spectral_mode mode)
{
	...
	arg.scan_yesise_floor_ref = WMI_SPECTRAL_NOISE_FLOOR_REF_DEFAULT;
