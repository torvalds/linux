...
/**
 * wmi_addr_remap - return AHB address for given firmware internal (linker)
 * address
 * @x: internal address
 ...
 */
void __iomem *wmi_buffer_block(struct wil6210_priv *wil, __le32 ptr_,
    u32 size) {
  u32 off;
 ...
 */
static void wmi_evt_eapol_rx(struct wil6210_vif *vif, int id, void *d,
    int len) {
  struct wil6210_priv *wil = vif_to_wil(vif);
  struct net_device *ndev = vif_to_ndev(vif);
...
static void wmi_evt_sched_scan_result(struct wil6210_vif *vif, int id, void *d,
    int len) {
  struct wil6210_priv *wil = vif_to_wil(vif);
...
static void wmi_evt_link_stats(struct wil6210_vif *vif, int id, void *d,
    int len) {
  struct wil6210_priv *wil = vif_to_wil(vif);
...
static void wmi_evt_auth_status(struct wil6210_vif *vif, int id, void *d,
    int len) {
  struct wil6210_priv *wil = vif_to_wil(vif);
  struct net_device *ndev = vif_to_ndev(vif);
...
static void wmi_evt_reassoc_status(struct wil6210_vif *vif, int id, void *d,
    int len) {
  struct wil6210_priv *wil = vif_to_wil(vif);
  struct net_device *ndev = vif_to_ndev(vif);
  struct wiphy *wiphy = wil_to_wiphy(wil);
...
static void wmi_evt_link_monitor(struct wil6210_vif *vif, int id, void *d,
    int len) {
  struct wil6210_priv *wil = vif_to_wil(vif);
  struct net_device *ndev = vif_to_ndev(vif);
...
static void wmi_sched_scan_set_ssids(struct wil6210_priv *wil,
...
static void wmi_sched_scan_set_channels(struct wil6210_priv *wil,
    struct wmi_start_sched_scan_cmd *cmd,
    u32 n_channels,
...
static void wmi_sched_scan_set_plans(struct wil6210_priv *wil,
    struct wmi_start_sched_scan_cmd *cmd,
...
int wmi_link_stats_cfg(struct wil6210_vif *vif, u32 type, u8 cid,
    u32 interval) {
  struct wil6210_priv *wil = vif_to_wil(vif);
