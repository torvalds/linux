 ...
 */
static int wil_fw_verify(struct wil6210_priv *wil, const u8 *data,
    size_t size) {
...
static int fw_handle_capabilities(struct wil6210_priv *wil, const void *data,
    size_t size) {
...
static int fw_handle_brd_file(struct wil6210_priv *wil, const void *data,
    size_t size) {
...
static int fw_handle_concurrency(struct wil6210_priv *wil, const void *data,
    size_t size) {
