...
static inline struct wireless_dev *vif_to_radio_wdev(struct wil6210_priv *wil,
...
#define wil_info(wil, fmt, arg ...) __wil_info(wil, "%s: " fmt, __func__, \
    ## arg)
...
#else
static inline int wil6210_debugfs_init(struct wil6210_priv *wil) {
  return 0;
}
