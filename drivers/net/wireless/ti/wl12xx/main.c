...
static void wl12xx_set_tx_desc_blocks(struct wl1271 *wl,
...
static void wl12xx_set_tx_desc_data_len(struct wl1271 *wl,
    struct wl1271_tx_hw_descr *desc,
    struct sk_buff *skb) {
...
static enum wl_rx_buf_align wl12xx_get_rx_buf_align(struct wl1271 *wl,
    u32 rx_desc) {
