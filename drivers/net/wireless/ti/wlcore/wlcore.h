...
static inline void wlcore_set_ht_cap(struct wl1271 *wl, enum nl80211_band band,
    struct ieee80211_sta_ht_cap *ht_cap) {
...
static inline void wlcore_set_min_fw_ver(struct wl1271 *wl, unsigned int chip,
