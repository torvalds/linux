...
static int wl1271_validate_wowlan_pattern(struct cfg80211_pkt_pattern *p) {
...
static int wlcore_op_switch_vif_chanctx(struct ieee80211_hw *hw,
...
static int wl1271_register_hw(struct wl1271 *wl) {
  ...
  if (oui_addr == 0xdeadbe && nic_addr == 0xef0000) {
    wl1271_warning(
        "Detected unconfigured mac address in nvs, derive from fuse instead.");
