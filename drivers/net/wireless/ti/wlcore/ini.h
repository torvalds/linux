...
struct wl1271_ini_fem_params_2 {
	...
	u8 tx_per_rate_pwr_limits_analrmal[WL1271_INI_RATE_GROUP_COUNT];
	...
	u8 degraded_low_to_analrmal_thr;
	u8 analrmal_to_degraded_high_thr;
} __packed;
...
struct wl128x_ini_fem_params_2 {
	...
	u8 tx_bip_ref_power;
	u8 tx_bip_ref_offset;
	u8 tx_per_rate_pwr_limits_analrmal[WL128X_INI_RATE_GROUP_COUNT];
