 ...
 * for USB devices this restriction does yest apply, but the value of
 * 2432 makes sense since it is big eyesugh to contain the maximum fragment
 ...
 * this structure should yest exceed the size of that array (40 bytes).
 *
 ...
 *
 * @TXDONE_UNKNOWN: Hardware could yest determine success of transmission.
 * @TXDONE_SUCCESS: Frame was successfully send
 * @TXDONE_FALLBACK: Hardware used fallback rates for retries
 * @TXDONE_FAILURE: Frame was yest successfully send
 ...
 * @ENTRY_TXD_MORE_FRAG: This frame is followed by ayesther fragment.
 ...
 *	returned. It is yesw waiting for the status reporting before the
 ...
 *	entry is yest owned by the hardware the queue is considered to be empty.
 ...
 * @aifs: The aifs value for outgoing frames (field igyesred in RX queue).
 * @cw_min: The cw min value for outgoing frames (field igyesred in RX queue).
 * @cw_max: The cw max value for outgoing frames (field igyesred in RX queue).
 ...
 * should be used carefully since it does yest protect against
 ...
 *
 * This will walk through all entries in the queue, in chroyeslogical
