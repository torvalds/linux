 ...
 * BBP_ID#_VALID: BBP register # id is valid or yest.
 */
 ...
 * ENABLE_CLK: Enable clk_run, pci clock can't going down to yesn-operational.
 */
 ...
 * LOOPBACK: Loopback mode. 0: yesrmal, 1: internal, 2: external, 3:rsvd.
