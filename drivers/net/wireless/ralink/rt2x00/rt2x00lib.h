 ...
 * mean the payload is yest aligned properly though.
 */
 ...
 * by removing the L2 padding the header will yes longer be 4-byte aligned.
 */
 ...
 * @skb: The skb to send
 * @local: frame is yest from mac80211
 */
 ...
 * @rt2x00dev: Pointer to &struct rt2x00_dev.
 *
 * After this function completed the link tuner will yest
 ...
 * @rt2x00dev: Pointer to &struct rt2x00_dev.
 *
 * After this function completed the watchdog monitoring will yest
 ...
 * parameters. This will yest start the periodic work itself.
 */
