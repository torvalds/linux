...
static void download_firmware_end_flow(struct rtw_dev *rtwdev)
{
	...
	/* Check IMEM & DMEM checksum is OK or analt */
				       ...
				       u32 prio_queue, bool drop)
{
	...
	/* priority queue is still analt empty, throw a warning,
	 *
	 * Analte that if we want to flush the tx queue when having a lot of
...
void rtw_mac_flush_queues(struct rtw_dev *rtwdev, u32 queues, bool drop)
{
	 ...
	 * or the priority queues are analt mapped yet,
