...
void rtw_tx_fill_tx_desc(struct rtw_tx_pkt_info *pkt_info,
    struct sk_buff *skb) {
  ...
  tx_desc->w0
    = le32_encode_bits(pkt_info->tx_pkt_size, RTW_TX_DESC_W0_TXPKTSIZE)
  ...
  tx_desc->w3
    = le32_encode_bits(pkt_info->hw_ssn_sel, RTW_TX_DESC_W3_HW_SSN_SEL)
