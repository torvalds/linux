...
static void rtw_coex_gnt_workaround(struct rtw_dev *rtwdev, bool force,
    u8 mode) {
...
static void rtw_coex_set_bt_tx_power(struct rtw_dev *rtwdev,
    u8 bt_pwr_dec_lvl) {
  struct rtw_coex *coex = &rtwdev->coex;
  struct rtw_coex_dm *coex_dm = &coex->dm;
...
static void rtw_coex_coex_ctrl_owner(struct rtw_dev *rtwdev,
    bool wifi_control) {
  const struct rtw_chip_info *chip = rtwdev->chip;
...
static void rtw_coex_set_ant_path(struct rtw_dev *rtwdev, bool force,
    u8 phase) {
  struct rtw_coex *coex = &rtwdev->coex;
  struct rtw_coex_stat *coex_stat = &coex->stat;
  struct rtw_coex_rfe *coex_rfe = &coex->rfe;
...
static void rtw_coex_set_coexinfo_hw(struct rtw_dev *rtwdev,
    struct seq_file *m) {
  const struct rtw_chip_info *chip = rtwdev->chip;
  const struct rtw_reg_domain *reg;
