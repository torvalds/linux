...
static inline int rtw_hci_write_data_rsvd_page(struct rtw_dev *rtwdev, u8 *buf,
    u32 size) {
  return rtwdev->hci.ops->write_data_rsvd_page(rtwdev, buf, size);
}

static inline int rtw_hci_write_data_h2c(struct rtw_dev *rtwdev, u8 *buf,
    u32 size) {
...
static inline u32 rtw_read_rf(struct rtw_dev *rtwdev, enum rtw_rf_path rf_path,
    u32 addr, u32 mask) {
  u32 val;
...
static inline void rtw_write_rf(struct rtw_dev *rtwdev,
...
static inline u32 rtw_read32_mask(struct rtw_dev *rtwdev, u32 addr, u32 mask) {
...
static inline u16 rtw_read16_mask(struct rtw_dev *rtwdev, u32 addr, u32 mask) {
  u32 shift = __ffs(mask);
  u32 orig;
  u32 ret;
...
static inline u8 rtw_read8_mask(struct rtw_dev *rtwdev, u32 addr, u32 mask) {
  u32 shift = __ffs(mask);
  u32 orig;
  u32 ret;
...
static inline void rtw_write32_mask(struct rtw_dev *rtwdev, u32 addr, u32 mask,
    u32 data) {
  u32 shift = __ffs(mask);
  u32 orig;
  u32 set;
...
static inline void rtw_write8_mask(struct rtw_dev *rtwdev, u32 addr, u32 mask,
    u8 data) {
  u32 shift;
  u8 orig, set;
  mask &= 0xff;
