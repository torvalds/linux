...
u8 rtw_cck_rates[] = {
  DESC_RATE1M, DESC_RATE2M, DESC_RATE5_5M, DESC_RATE11M
};
u8 rtw_ofdm_rates[] = {
...
static bool rtw_phy_dig_check_damping(struct rtw_dm_info *dm_info) {
...
void rtw_parse_tbl_phy_cond(struct rtw_dev *rtwdev,
...
static void rtw_phy_get_rate_values_of_txpwr_by_rate(struct rtw_dev *rtwdev,
...
static void rtw_phy_store_tx_power_by_rate(struct rtw_dev *rtwdev,
  ...
  u8 rate_num = 0;
  u8 rate;
  u8 rates[RTW_RF_PATH_MAX] = {
    0
  };
  s8 offset;
  s8 pwr_by_rate[RTW_RF_PATH_MAX] = {
    0
  };
  int i;
...
static void rtw_xref_5g_txpwr_lmt(struct rtw_dev *rtwdev, u8 regd,
...
static void rtw_xref_txpwr_lmt_by_rs(struct rtw_dev *rtwdev, u8 regd, u8 bw,
    u8 ch_idx) {
...
static void rtw_xref_5g_txpwr_lmt_by_ch(struct rtw_dev *rtwdev, u8 regd,
    u8 bw) {
  u8 ch_idx;
...
static void rtw_xref_txpwr_lmt_by_bw(struct rtw_dev *rtwdev, u8 regd) {
  u8 bw;
...
static void __cfg_txpwr_lmt_by_alt(struct rtw_hal *hal, u8 regd, u8 regd_alt,
    u8 bw, u8 rs) {
  u8 ch;
...
static void rtw_cfg_txpwr_lmt_by_alt(struct rtw_dev *rtwdev, u8 regd,
    u8 regd_alt) {
  u8 bw, rs;
...
static void rtw_phy_tx_power_by_rate_config_by_path(struct rtw_hal *hal,
    u8 path,
...
static void __rtw_phy_tx_power_limit_config(struct rtw_hal *hal, u8 regd, u8 bw,
    u8 rs) {
  s8 base;
  u8 ch;
  for (ch = 0; ch < RTW_MAX_CHANNEL_NUM_2G; ch++) {
