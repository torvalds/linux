...
static void rtw_dynamic_csi_rate(struct rtw_dev *rtwdev,
    struct rtw_vif *rtwvif) {
...
int rtw_core_start(struct rtw_dev *rtwdev) {
  ...
  rtwdev->lps_conf.wow_deep_mode = rtw_update_lps_deep_mode(rtwdev,
      &rtwdev->wow_fw);
...
static u16 rtw_get_max_scan_ie_len(struct rtw_dev *rtwdev) {
  ...
  } else if (rtw_fw_feature_ext_check(&rtwdev->fw,
...
static void rtw_load_firmware_cb(const struct firmware *firmware,
    void *context) {
