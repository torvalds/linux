...
static const struct usb_device_id rtw_8822bu_id_table[] = {
  { USB_DEVICE_AND_INTERFACE_INFO(RTW_USB_VENDOR_ID_REALTEK, 0xb812, 0xff, 0xff,
      0xff),
    .driver_info = (kernel_ulong_t) &(rtw8822b_hw_spec) },
  { USB_DEVICE_AND_INTERFACE_INFO(RTW_USB_VENDOR_ID_REALTEK, 0xb82c, 0xff, 0xff,
      0xff),
    .driver_info = (kernel_ulong_t) &(rtw8822b_hw_spec) },
  { USB_DEVICE_AND_INTERFACE_INFO(RTW_USB_VENDOR_ID_REALTEK, 0x2102, 0xff, 0xff,
      0xff),
  ...
  { USB_DEVICE_AND_INTERFACE_INFO(0x7392, 0xf822, 0xff, 0xff, 0xff),
    .driver_info = (kernel_ulong_t) &(rtw8822b_hw_spec) }, /* Edimax EW-7822UAD
                                                            * */
  { USB_DEVICE_AND_INTERFACE_INFO(RTW_USB_VENDOR_ID_REALTEK, 0xb81a, 0xff, 0xff,
      0xff),
    .driver_info = (kernel_ulong_t) &(rtw8822b_hw_spec) }, /* Default ID */
  { USB_DEVICE_AND_INTERFACE_INFO(0x0b05, 0x1841, 0xff, 0xff, 0xff),
    .driver_info = (kernel_ulong_t) &(rtw8822b_hw_spec) }, /* ASUS AC1300
                                                            * USB-AC55 B1 */
  ...
  { USB_DEVICE_AND_INTERFACE_INFO(0x0B05, 0x19aa, 0xff, 0xff, 0xff),
    .driver_info = (kernel_ulong_t) &(rtw8822b_hw_spec) }, /* ASUS - USB-AC58
                                                            * rev A1 */
  ...
  { USB_DEVICE_AND_INTERFACE_INFO(0x2001, 0x331c, 0xff, 0xff, 0xff),
    .driver_info = (kernel_ulong_t) &(rtw8822b_hw_spec) }, /* Dlink - DWA-182 -
                                                            * D1 */
  ...
  { USB_DEVICE_AND_INTERFACE_INFO(0x13b1, 0x0045, 0xff, 0xff, 0xff),
    .driver_info = (kernel_ulong_t) &(rtw8822b_hw_spec) }, /* Linksys WUSB3600
                                                            * v2 */
  { USB_DEVICE_AND_INTERFACE_INFO(0x2357, 0x012d, 0xff, 0xff, 0xff),
    .driver_info = (kernel_ulong_t) &(rtw8822b_hw_spec) }, /* TP-Link Archer T3U
                                                            * v1 */
  { USB_DEVICE_AND_INTERFACE_INFO(0x2357, 0x0138, 0xff, 0xff, 0xff),
    .driver_info = (kernel_ulong_t) &(rtw8822b_hw_spec) }, /* TP-Link Archer T3U
                                                            * Plus v1 */
  { USB_DEVICE_AND_INTERFACE_INFO(0x2357, 0x0115, 0xff, 0xff, 0xff),
    .driver_info = (kernel_ulong_t) &(rtw8822b_hw_spec) }, /* TP-Link Archer T4U
                                                            * V3 */
  ...
  { USB_DEVICE_AND_INTERFACE_INFO(0x20f4, 0x808a, 0xff, 0xff, 0xff),
    .driver_info = (kernel_ulong_t) &(rtw8822b_hw_spec) }, /* TRENDnet
                                                            * TEW-808UBM */
  {},
};
