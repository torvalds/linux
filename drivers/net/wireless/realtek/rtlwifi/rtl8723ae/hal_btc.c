...
static void rtl8723e_dm_bt_set_hw_pta_mode(struct ieee80211_hw *hw,
    bool b_mode) {
  struct rtl_priv *rtlpriv = rtl_priv(hw);
...
static void rtl8723e_dm_bt_btdm_structure_reload_all_off(
    struct ieee80211_hw *hw,
    struct btdm_8723 *btdm) {
...
static void rtl8723e_dm_bt_set_fw_wlan_act(struct ieee80211_hw *hw,
  ...
  struct rtl_priv *rtlpriv = rtl_priv(hw);
  u8 h2c_parameter_hi[1] = {
    0
  };
  u8 h2c_parameter_lo[1] = {
    0
  };
