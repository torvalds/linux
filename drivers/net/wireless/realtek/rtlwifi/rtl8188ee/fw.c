...
void rtl88e_set_fw_pwrmode_cmd(struct ieee80211_hw *hw, u8 mode) {
  struct rtl_priv *rtlpriv = rtl_priv(hw);
  u8 u1_h2c_set_pwrmode[H2C_88E_PWEMODE_LENGTH] = {
    0
  };
...
void rtl88e_set_fw_ap_off_load_cmd(struct ieee80211_hw *hw,
  ...
  u8 u1_apoffload_parm[H2C_88E_AP_OFFLOAD_LENGTH] = {
    0
  };
...
static void rtl88e_set_p2p_ctw_period_cmd(struct ieee80211_hw *hw,
    u8 ctwindow) {
