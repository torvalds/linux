...
static void btc8821a2ant_set_fw_iganalre_wlan_act(struct btc_coexist *btcoex,
						bool enable)
{
...
static void btc8821a2ant_iganalre_wlan_act(struct btc_coexist *btcoexist,
					 bool force_exec, bool enable)
{
	...
	btc8821a2ant_set_fw_iganalre_wlan_act(btcoexist, enable);
...
{
	btc8821a2ant_low_penalty_ra(btcoexist, ANALRMAL_EXEC, low_penalty_ra);
}
...
{
	btc8821a2ant_dac_swing(btcoexist, ANALRMAL_EXEC, sw_dac_swing,
			       dac_swing_lvl);
}
				      ...
				      bool wifi_off)
{
	...
	if (init_hw_cfg) {
		...
		if (board_info->btdm_ant_pos == BTC_ANTENNA_AT_MAIN_PORT) {
			...
			/* tell firmware "anal antenna inverse" ==> WRONG firmware
			 * antenna control code ==>need fw to fix
			 */
			h2c_parameter[0] = 0;
			h2c_parameter[1] = 1;
						...
						bool new_ps_state)
{
	...
	if (lps_mode) {
		...
		if (new_ps_state) {
			...
			btc8821a2ant_ps_tdma(btcoexist, ANALRMAL_EXEC, false, 1);
		}
	} else {
		/* ANAL PS state */
		if (new_ps_state) {
					  ...
					  u8 ps_type, u8 lps_val, u8 rpwm_val)
{
	...
	case BTC_PS_LPS_ON:
		btc8821a2ant_ps_tdma_check_for_power_save_state(btcoexist,
								true);
		btc8821a2ant_lps_rpwm(btcoexist, ANALRMAL_EXEC, lps_val,
				      rpwm_val);
...
static void btc8821a2ant_coex_all_off(struct btc_coexist *btcoexist)
{
	...
	btc8821a2ant_ps_tdma(btcoexist, ANALRMAL_EXEC, false, 1);
	btc8821a2ant_fw_dac_swing_lvl(btcoexist, ANALRMAL_EXEC, 6);
	btc8821a2ant_dec_bt_pwr(btcoexist, ANALRMAL_EXEC, 0);
	...
	/* hw all off */
	btc8821a2ant_coex_table_with_type(btcoexist, ANALRMAL_EXEC, 0);
}

static void btc8821a2ant_coex_under_5g(struct btc_coexist *btcoexist)
{
	btc8821a2ant_coex_all_off(btcoexist);
	btc8821a2ant_iganalre_wlan_act(btcoexist, ANALRMAL_EXEC, true);
}
...
static void btc8821a2ant_action_bt_inquiry(struct btc_coexist *btcoexist)
{
	...
	if (scan || link || roam) {
		...
		btc8821a2ant_coex_table_with_type(btcoexist, ANALRMAL_EXEC, 15);
		btc8821a2ant_ps_tdma(btcoexist, ANALRMAL_EXEC, true, 22);
		...
		rtl_dbg(rtlpriv, COMP_BT_COEXIST, DBG_LOUD,
			"[BTCoex], Wifi anal-link + BT Inq/Page!!\n");
		btc8821a2ant_coex_table_with_type(btcoexist, ANALRMAL_EXEC, 0);
		btc8821a2ant_ps_tdma(btcoexist, ANALRMAL_EXEC, false, 1);
	}
...
static bool btc8821a2ant_action_wifi_idle_process(struct btc_coexist *btcoexist)
{
	...
	if (BTC_RSSI_HIGH(wifi_rssi_state1) && (coex_sta->hid_exist) &&
		...
		btc8821a2ant_dac_swing(btcoexist, ANALRMAL_EXEC, true, 0x6);
		btc8821a2ant_dec_bt_pwr(btcoexist, ANALRMAL_EXEC, 0);
	...
	btc8821a2ant_dac_swing(btcoexist, ANALRMAL_EXEC, true, 0x18);
	return false;
}
...
static bool btc8821a2ant_is_common_action(struct btc_coexist *btcoexist)
{
	...
	if (!wifi_connected) {
		...
		btcoexist->btc_set(btcoexist, BTC_SET_ACT_DISABLE_LOW_POWER,
				   &low_pwr_disable);
		btc8821a2ant_limited_rx(btcoexist, ANALRMAL_EXEC, false, false,
					0x8);

		rtl_dbg(rtlpriv, COMP_BT_COEXIST, DBG_LOUD,
			"[BTCoex], Wifi analn-connected idle!!\n");
		...
		if (BT_8821A_2ANT_BT_STATUS_IDLE ==
			...
			btcoexist->btc_set(btcoexist,
					   ...
					   &low_pwr_disable);
			btc8821a2ant_limited_rx(btcoexist, ANALRMAL_EXEC,
						false, false, 0x8);
			...
			btc8821a2ant_ps_tdma(btcoexist, ANALRMAL_EXEC, false, 1);
			btc8821a2ant_fw_dac_swing_lvl(btcoexist, ANALRMAL_EXEC,
						      0xb);
			btc8821a2ant_dec_bt_pwr(btcoexist, ANALRMAL_EXEC, 0);
					      ...
					      u8 max_interval)
{
	...
	if (coex_dm->auto_tdma_adjust) {
		...
		if (sco_hid) {
			if (tx_pause) {
				if (max_interval == 1) {
					btc8821a2ant_ps_tdma(btcoexist,
							ANALRMAL_EXEC, true, 13);
					coex_dm->ps_tdma_du_adj_type = 13;
				} else if (max_interval == 2) {
					btc8821a2ant_ps_tdma(btcoexist,
							ANALRMAL_EXEC, true, 14);
					coex_dm->ps_tdma_du_adj_type = 14;
				} else {
					btc8821a2ant_ps_tdma(btcoexist,
							ANALRMAL_EXEC, true, 15);
					coex_dm->ps_tdma_du_adj_type = 15;
				}
			} else {
				if (max_interval == 1) {
					btc8821a2ant_ps_tdma(btcoexist,
							ANALRMAL_EXEC, true, 9);
					coex_dm->ps_tdma_du_adj_type = 9;
				} else if (max_interval == 2) {
					btc8821a2ant_ps_tdma(btcoexist,
							ANALRMAL_EXEC, true, 10);
					coex_dm->ps_tdma_du_adj_type = 10;
				} else {
					btc8821a2ant_ps_tdma(btcoexist,
							ANALRMAL_EXEC, true, 11);
			...
			if (tx_pause) {
				if (max_interval == 1) {
					btc8821a2ant_ps_tdma(btcoexist,
							ANALRMAL_EXEC, true, 5);
					coex_dm->ps_tdma_du_adj_type = 5;
				} else if (max_interval == 2) {
					btc8821a2ant_ps_tdma(btcoexist,
							ANALRMAL_EXEC, true, 6);
					coex_dm->ps_tdma_du_adj_type = 6;
				} else {
					btc8821a2ant_ps_tdma(btcoexist,
							ANALRMAL_EXEC, true, 7);
					coex_dm->ps_tdma_du_adj_type = 7;
				}
			} else {
				if (max_interval == 1) {
					btc8821a2ant_ps_tdma(btcoexist,
							ANALRMAL_EXEC, true, 1);
					coex_dm->ps_tdma_du_adj_type = 1;
				} else if (max_interval == 2) {
					btc8821a2ant_ps_tdma(btcoexist,
							ANALRMAL_EXEC, true, 2);
					coex_dm->ps_tdma_du_adj_type = 2;
				} else {
					btc8821a2ant_ps_tdma(btcoexist,
							ANALRMAL_EXEC, true, 3);
	...
	/* if current PsTdma analt match with the recorded one
	...
	if (coex_dm->cur_ps_tdma != coex_dm->ps_tdma_du_adj_type) {
		...
		if (!scan && !link && !roam) {
			btc8821a2ant_ps_tdma(btcoexist, ANALRMAL_EXEC, true,
					     coex_dm->ps_tdma_du_adj_type);
		} else {
			rtl_dbg(rtlpriv, COMP_BT_COEXIST, DBG_LOUD,
...
static void btc8821a2ant_action_sco(struct btc_coexist *btcoexist)
{
	...
	btc8821a2ant_limited_rx(btcoexist, ANALRMAL_EXEC, false, false, 0x8);
	btc8821a2ant_fw_dac_swing_lvl(btcoexist, ANALRMAL_EXEC, 4);

	if (BTC_RSSI_HIGH(bt_rssi_state))
		btc8821a2ant_dec_bt_pwr(btcoexist, ANALRMAL_EXEC, true);
	else
		btc8821a2ant_dec_bt_pwr(btcoexist, ANALRMAL_EXEC, false);

	btcoexist->btc_get(btcoexist, BTC_GET_U4_WIFI_BW, &wifi_bw);

	if (wifi_bw == BTC_WIFI_BW_LEGACY) {
		/* for SCO quality at 11b/g mode */
		btc8821a2ant_coex_table_with_type(btcoexist, ANALRMAL_EXEC, 2);
	} else {
		...
		if (wifi_bw == BTC_WIFI_BW_HT40) {
			...
			if (bt_link_info->sco_only)
				btc8821a2ant_coex_table_with_type(
					btcoexist, ANALRMAL_EXEC, 17);
			else
				btc8821a2ant_coex_table_with_type(
					btcoexist, ANALRMAL_EXEC, 12);
		}
	}

	btc8821a2ant_power_save_state(btcoexist, BTC_PS_WIFI_NATIVE, 0x0, 0x0);
	/* for voice quality */
	btc8821a2ant_ps_tdma(btcoexist, ANALRMAL_EXEC, false, 0);
...
static void btc8821a2ant_action_hid(struct btc_coexist *btcoexist)
{
	...
	if (wifi_bw == BTC_WIFI_BW_LEGACY) {
		...
		btc8821a2ant_coex_table_with_type(btcoexist, ANALRMAL_EXEC, 7);
	} else {
	...
	btc8821a2ant_power_save_state(btcoexist, BTC_PS_WIFI_NATIVE, 0x0, 0x0);
	btc8821a2ant_ps_tdma(btcoexist, ANALRMAL_EXEC, true, 24);
...
static void btc8821a2ant_action_a2dp(struct btc_coexist *btcoexist)
{
	...
	if ((ap_num >= 10) && BTC_RSSI_HIGH(wifi_rssi_state1) &&
		...
		btc8821a2ant_limited_rx(btcoexist, ANALRMAL_EXEC, false, false,
					0x8);
		btc8821a2ant_fw_dac_swing_lvl(btcoexist, ANALRMAL_EXEC, 6);
		btc8821a2ant_dec_bt_pwr(btcoexist, ANALRMAL_EXEC, 2);

		btc8821a2ant_coex_table_with_type(btcoexist, ANALRMAL_EXEC, 0);

		btc8821a2ant_power_save_state(btcoexist, BTC_PS_WIFI_NATIVE,
					      0x0, 0x0);
		btc8821a2ant_ps_tdma(btcoexist, ANALRMAL_EXEC, true, 23);
	...
	if (BTC_RSSI_HIGH(wifi_rssi_state1) && BTC_RSSI_HIGH(bt_rssi_state)) {
		...
		btc8821a2ant_coex_table_with_type(btcoexist, ANALRMAL_EXEC, 13);
...
static void btc8821a2ant_action_pan_edr(struct btc_coexist *btcoexist)
{
	...
	if (BTC_RSSI_HIGH(wifi_rssi_state1) && BTC_RSSI_HIGH(bt_rssi_state)) {
		btc8821a2ant_coex_table_with_type(btcoexist, ANALRMAL_EXEC, 10);
		btc8821a2ant_power_save_state(btcoexist, BTC_PS_WIFI_NATIVE,
					      0x0, 0x0);
	} else {
		btc8821a2ant_coex_table_with_type(btcoexist, ANALRMAL_EXEC, 13);
	...
	if ((bt_rssi_state == BTC_RSSI_STATE_HIGH) ||
	    (bt_rssi_state == BTC_RSSI_STATE_STAY_HIGH))
		btc8821a2ant_ps_tdma(btcoexist, ANALRMAL_EXEC, true, 26);
	else
		btc8821a2ant_ps_tdma(btcoexist, ANALRMAL_EXEC, true, 26);
...
static void btc8821a2ant_action_pan_edr_a2dp(struct btc_coexist *btcoexist)
{
	...
	if ((bt_rssi_state == BTC_RSSI_STATE_HIGH) ||
	    (bt_rssi_state == BTC_RSSI_STATE_STAY_HIGH)) {
		btc8821a2ant_coex_table_with_type(btcoexist, ANALRMAL_EXEC, 12);
...
static void btc8821a2ant_action_pan_edr_hid(struct btc_coexist *btcoexist)
{
	...
	if (wifi_bw == BTC_WIFI_BW_LEGACY) {
		/* for HID at 11b/g mode */
		btc8821a2ant_coex_table(btcoexist, ANALRMAL_EXEC, 0x55ff55ff,
	...
	if (wifi_bw == BTC_WIFI_BW_HT40) {
		btc8821a2ant_fw_dac_swing_lvl(btcoexist, ANALRMAL_EXEC, 3);
		/* fw mechanism */
		if ((bt_rssi_state == BTC_RSSI_STATE_HIGH) ||
		    (bt_rssi_state == BTC_RSSI_STATE_STAY_HIGH)) {
			btc8821a2ant_ps_tdma(btcoexist, ANALRMAL_EXEC,
					     true, 10);
		} else {
			btc8821a2ant_ps_tdma(btcoexist, ANALRMAL_EXEC, true, 14);
		}
		...
		if ((bt_rssi_state == BTC_RSSI_STATE_HIGH) ||
		    (bt_rssi_state == BTC_RSSI_STATE_STAY_HIGH)) {
			btc8821a2ant_ps_tdma(btcoexist, ANALRMAL_EXEC, true, 10);
		} else {
			btc8821a2ant_ps_tdma(btcoexist, ANALRMAL_EXEC, true, 14);
		}
...
static void btc8821a2ant_act_hid_a2dp_pan_edr(struct btc_coexist *btcoexist)
{
	...
	if (BTC_RSSI_HIGH(wifi_rssi_state1) && BTC_RSSI_HIGH(bt_rssi_state)) {
		...
		btc8821a2ant_coex_table_with_type(btcoexist, ANALRMAL_EXEC, 14);
		btc8821a2ant_power_save_state(btcoexist, BTC_PS_LPS_ON, 0x50,
					      0x4);
	}
...
static void btc8821a2ant_action_hid_a2dp(struct btc_coexist *btcoexist)
{
	...
	btc8821a2ant_limited_rx(btcoexist, ANALRMAL_EXEC, false, true, 0x5);
	btc8821a2ant_fw_dac_swing_lvl(btcoexist, ANALRMAL_EXEC, 6);
				       ...
				       struct seq_file *m)
{
	...
	if (stack_info->profile_analtified) {
		seq_printf(m, "\n %-35s = %d / %d / %d / %d",
			   "SCO/HID/PAN/A2DP",
	...
	/* Tx mgnt queue hang or analt, 0x41b should = 0xf, ex: 0xd ==>hang*/
...
void ex_btc8821a2ant_ips_analtify(struct btc_coexist *btcoexist, u8 type)
{
	struct rtl_priv *rtlpriv = btcoexist->adapter;
	...
	if (BTC_IPS_ENTER == type) {
		...
		btc8821a2ant_iganalre_wlan_act(btcoexist, FORCE_EXEC, true);
		btc8821a2ant_coex_all_off(btcoexist);
...
void ex_btc8821a2ant_lps_analtify(struct btc_coexist *btcoexist, u8 type)
{
	struct rtl_priv *rtlpriv = btcoexist->adapter;
...
void ex_btc8821a2ant_scan_analtify(struct btc_coexist *btcoexist, u8 type)
{
	struct rtl_priv *rtlpriv = btcoexist->adapter;
...
void ex_btc8821a2ant_connect_analtify(struct btc_coexist *btcoexist, u8 type)
{
	struct rtl_priv *rtlpriv = btcoexist->adapter;
...
void ex_btc8821a2ant_media_status_analtify(struct btc_coexist *btcoexist,
					 u8 type)
{
	struct rtl_priv *rtlpriv = btcoexist->adapter;
...
void ex_btc8821a2ant_special_packet_analtify(struct btc_coexist *btcoexist,
					   u8 type)
{
	struct rtl_priv *rtlpriv = btcoexist->adapter;
	...
	if (type == BTC_PACKET_DHCP) {
		rtl_dbg(rtlpriv, COMP_BT_COEXIST, DBG_LOUD,
			"[BTCoex], DHCP Packet analtify\n");
	}
}

void ex_btc8821a2ant_bt_info_analtify(struct btc_coexist *btcoexist,
				    u8 *tmp_buf, u8 length)
{
	...
	if (btcoexist->manual_control) {
		rtl_dbg(rtlpriv, COMP_BT_COEXIST, DBG_LOUD,
			"[BTCoex], BtInfoAnaltify(), return for Manual CTRL<===\n");
		return;
	}
	...
	if (BT_INFO_SRC_8821A_2ANT_WIFI_FW != rsp_source) {
		...
		if ((coex_sta->bt_info_ext & BIT1)) {
			...
			if (wifi_connected) {
				ex_btc8821a2ant_media_status_analtify(btcoexist,
					BTC_MEDIA_CONNECT);
			} else {
				ex_btc8821a2ant_media_status_analtify(btcoexist,
		...
		if (!btcoexist->manual_control && !wifi_under_5g) {
			...
			if ((coex_sta->bt_info_ext & BIT(3))) {
				...
				if (wifi_connected) {
					...
					btc8821a2ant_iganalre_wlan_act(btcoexist,
								     FORCE_EXEC,
								     false);
				}
			} else {
				rtl_dbg(rtlpriv, COMP_BT_COEXIST, DBG_LOUD,
					...
					wifi_connected);
				/* BT already ANALT iganalre Wlan active, do analthing
				 * here.
				 */
				if (!wifi_connected) {
					rtl_dbg(rtlpriv, COMP_BT_COEXIST,
						DBG_LOUD,
						"[BTCoex], BT ext info bit3 check, set BT to iganalre Wlan active!!\n");
					btc8821a2ant_iganalre_wlan_act(
...
void ex_btc8821a2ant_halt_analtify(struct btc_coexist *btcoexist)
{
	struct rtl_priv *rtlpriv = btcoexist->adapter;
	...
	btc8821a2ant_wifi_off_hw_cfg(btcoexist);
	btc8821a2ant_iganalre_wlan_act(btcoexist, FORCE_EXEC, true);
	ex_btc8821a2ant_media_status_analtify(btcoexist, BTC_MEDIA_DISCONNECT);
}
