 ...
 *===========================================
 */
void ex_btc8821a2ant_init_hwconfig(
  struct btc_coexist *btcoexist);
void ex_btc8821a2ant_init_coex_dm(
  struct btc_coexist *btcoexist);
void ex_btc8821a2ant_ips_notify(
  struct btc_coexist *btcoexist,
  u8 type);
void ex_btc8821a2ant_lps_notify(
  struct btc_coexist *btcoexist,
  u8 type);
void ex_btc8821a2ant_scan_notify(
  struct btc_coexist *btcoexist,
  u8 type);
void ex_btc8821a2ant_connect_notify(
  struct btc_coexist *btcoexist,
  u8 type);
void ex_btc8821a2ant_media_status_notify(
  struct btc_coexist *btcoexist,
  u8 type);
void ex_btc8821a2ant_special_packet_notify(
  struct btc_coexist *btcoexist,
  u8 type);
void ex_btc8821a2ant_bt_info_notify(
  ...
  u8 *tmp_buf,
  u8 length);
void ex_btc8821a2ant_halt_notify(
  struct btc_coexist *btcoexist);
void ex_btc8821a2ant_periodical(
  struct btc_coexist *btcoexist);
