...
u32 rtl92ee_phy_query_bb_reg(struct ieee80211_hw *hw, u32 regaddr,
    u32 bitmask) {
...
static void phy_set_txpower_index_by_rate_section(struct ieee80211_hw *hw,
  ...
  if (section == CCK) {
    ...
    u8 ht_rates2t[] = {
      DESC92C_RATEMCS8, DESC92C_RATEMCS9,
...
static u8 _rtl92ee_phy_path_a_rx_iqk(struct ieee80211_hw *hw,
    bool config_pathb) {
...
static u8 _rtl92ee_phy_path_b_rx_iqk(struct ieee80211_hw *hw,
    bool config_pathb) {
  struct rtl_priv *rtlpriv = rtl_priv(hw);
