...
void rtl8188f_set_tx_power(struct rtl8xxxu_priv *priv, int channel, bool ht40) {
  u32 val32, ofdm, mcs;
...
static void rtl8188f_spur_calibration(struct rtl8xxxu_priv *priv, u8 channel) {
  ...
  if (channel <= 14 && frequencies[channel] > 0) {
    ...
    if (hw_ctrl_s1 || sw_ctrl_s1) {
      ...
      /* Start PSD */
      rtl8xxxu_write32(priv, REG_FPGA0_PSD_FUNC,
          0x400000 | frequencies[channel]);
      msleep(30);
...
static s8 rtl8188f_cck_rssi(struct rtl8xxxu_priv *priv,
