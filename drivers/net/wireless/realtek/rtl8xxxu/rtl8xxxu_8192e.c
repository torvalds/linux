...
static void rtl8192e_set_tx_power(struct rtl8xxxu_priv *priv, int channel,
    bool ht40) {
  u32 val32, ofdm, mcs;
...
static s8 rtl8192e_cck_rssi(struct rtl8xxxu_priv *priv,
    struct rtl8723au_phy_stats *phy_stats) {
  static const s8 lna_gain_table_0[8] = {
    15, 9, -10, -21, -23, -27, -43, -44
  };
  static const s8 lna_gain_table_1[8] = {
    24, 18, 13, -4, -11, -18, -31, -36
  };
