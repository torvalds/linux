...
static void rtl8192f_set_tx_power(struct rtl8xxxu_priv *priv, int channel,
    bool ht40) {
...
static void rtl8192fu_config_kfree(struct rtl8xxxu_priv *priv, u8 channel) {
  u8 bb_gain[3] = {
    EFUSE_UNDEFINED, EFUSE_UNDEFINED, EFUSE_UNDEFINED
  };
  u8 bb_gain_path_mask[2] = {
    0x0f, 0xf0
  };
...
static void rtl8192fu_phy_iq_calibrate(struct rtl8xxxu_priv *priv) {
  ...
  if (candidate >= 0) {
    ...
    dev_dbg(dev,
        "%s: e94=%x e9c=%x ea4=%x eac=%x eb4=%x ebc=%x ec4=%x ecc=%c\n",
...
static void rtl8192f_set_crystal_cap(struct rtl8xxxu_priv *priv,
    u8 crystal_cap) {
...
static s8 rtl8192f_cck_rssi(struct rtl8xxxu_priv *priv,
