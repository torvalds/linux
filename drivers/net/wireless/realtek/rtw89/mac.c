...
int rtw89_mac_dle_dfi_cfg(struct rtw89_dev *rtwdev,
  ...
  ret = read_poll_timeout_atomic(rtw89_read32, val,
      !(val & B_AX_WDE_DFI_ACTIVE),
...
static void rtw89_mac_dump_qta_lost_ax(struct rtw89_dev *rtwdev) {
  ...
  for (not_empty = ~qempty.qempty, i = 0; not_empty != 0;
      not_empty >>= 1, i++) {
    if (!(not_empty & BIT(0))) {
      continue;
    }
...
static int hfc_reset_param(struct rtw89_dev *rtwdev) {
  ...
  struct rtw89_hfc_param_ini param_ini = {
    NULL
  };
...
static enum rtw89_rpwm_req_pwr_state rtw89_mac_get_req_pwr_state(
...
static int cmac_func_en_ax(struct rtw89_dev *rtwdev, u8 mac_idx, bool en) {
  ...
  u32 c1pc_en = 0;
  u32 addrl_func_en[] = {
    R_AX_CMAC_FUNC_EN, R_AX_CMAC_FUNC_EN_C1
  };
  u32 addrl_ck_en[] = {
    R_AX_CK_EN, R_AX_CK_EN_C1
  };
...
static int dle_mix_cfg_ax(struct rtw89_dev *rtwdev,
    const struct rtw89_dle_mem *cfg) {
...
static void dle_quota_cfg(struct rtw89_dev *rtwdev,
    ...
    u16 ext_wde_min_qt_wcpu) {
  const struct rtw89_mac_gen_def *mac = rtwdev->chip->mac_def;
  mac->wde_quota_cfg(rtwdev, cfg->wde_min_qt, cfg->wde_max_qt,
      ext_wde_min_qt_wcpu);
...
static int preload_init_set(struct rtw89_dev *rtwdev,
  ...
  rtw89_write32_mask(rtwdev, reg, B_AX_B0_PRELD_NXT_TXENDWIN_MASK,
      PRELD_NEXT_WND);
  rtw89_write32_mask(rtwdev, reg, B_AX_B0_PRELD_NXT_RSVMINSZ_MASK,
      min_rsvd_size);
  return 0;
}
...
static int rx_fltr_init_ax(struct rtw89_dev *rtwdev, u8 mac_idx) {
  ...
  rtw89_write32(rtwdev, rtw89_mac_reg_by_idx(rtwdev, R_AX_RX_FLTR_OPT, mac_idx),
      mac_ftlr);
  rtw89_write16(rtwdev, rtw89_mac_reg_by_idx(rtwdev, R_AX_PLCP_HDR_FLTR,
      mac_idx),
      plcp_ftlr);
  return 0;
}
...
static int nav_ctrl_init_ax(struct rtw89_dev *rtwdev) {
  ...
  rtw89_write32_mask(rtwdev, R_AX_WMAC_NAV_CTL, B_AX_WMAC_NAV_UPPER_MASK,
      NAV_25MS);
  return 0;
}
...
static int tmac_init_ax(struct rtw89_dev *rtwdev, u8 mac_idx) {
  ...
  rtw89_write32_mask(rtwdev, reg, B_AX_TXDFIFO_HIGH_MCS_THRE_MASK,
      TXDFIFO_HIGH_MCS_THRE);
  rtw89_write32_mask(rtwdev, reg, B_AX_TXDFIFO_LOW_MCS_THRE_MASK,
...
int rtw89_mac_resume_sch_tx_v1(struct rtw89_dev *rtwdev, u8 mac_idx,
    u32 tx_en) {
  int ret;
...
static int dle_buf_req_ax(struct rtw89_dev *rtwdev, u16 buf_len, bool wd,
    u16 *pkt_id) {
  u32 val, reg;
  int ret;
...
static void rtw89_mac_bcn_drop(struct rtw89_dev *rtwdev,
  ...
  rtw89_write32_port_mask(rtwdev, rtwvif, p->tbtt_prohib, B_AX_TBTT_SETUP_MASK,
      1);
  rtw89_write32_port_mask(rtwdev, rtwvif, p->bcn_area, B_AX_BCN_MSK_AREA_MASK,
      0);
  rtw89_write32_port_mask(rtwdev, rtwvif, p->tbtt_prohib, B_AX_TBTT_HOLD_MASK,
      0);
...
static void rtw89_mac_port_cfg_func_sw(struct rtw89_dev *rtwdev,
  ...
  if (chip->chip_id == RTL8852A) {
    rtw89_write32_port_clr(rtwdev, rtwvif, p->tbtt_prohib,
...
static void rtw89_mac_port_cfg_bcn_intv(struct rtw89_dev *rtwdev,
  ...
  struct ieee80211_vif *vif = rtwvif_to_vif(rtwvif);
  u16 bcn_int
    = vif->bss_conf.beacon_int ? vif->bss_conf.beacon_int : BCN_INTERVAL;
...
static void rtw89_mac_c2h_macid_pause(struct rtw89_dev *rtwdev,
...
static void rtw89_mac_c2h_scanofld_rsp(struct rtw89_dev *rtwdev,
    struct sk_buff *skb,
    u32 len) {
...
static void rtw89_mac_bcn_fltr_rpt(struct rtw89_dev *rtwdev,
    struct rtw89_vif *rtwvif,
    struct sk_buff *skb) {
...
static void rtw89_mac_c2h_bcn_fltr_rpt(struct rtw89_dev *rtwdev,
    struct sk_buff *c2h,
    u32 len) {
  struct rtw89_vif *rtwvif;
  rtw89_for_each_rtwvif(rtwdev, rtwvif)
...
static void rtw89_mac_c2h_rec_ack(struct rtw89_dev *rtwdev, struct sk_buff *c2h,
    u32 len) {
...
static void rtw89_mac_c2h_done_ack(struct rtw89_dev *rtwdev,
    struct sk_buff *skb_c2h, u32 len) {
  /* N.B. This will run in interrupt context. */
...
static void rtw89_mac_c2h_log(struct rtw89_dev *rtwdev, struct sk_buff *c2h,
    u32 len) {
  rtw89_fw_log_dump(rtwdev, c2h->data, len);
}

static void rtw89_mac_c2h_bcn_cnt(struct rtw89_dev *rtwdev, struct sk_buff *c2h,
    u32 len) {
}

static void rtw89_mac_c2h_pkt_ofld_rsp(struct rtw89_dev *rtwdev,
    struct sk_buff *skb_c2h,
    u32 len) {
...
static void rtw89_mac_c2h_tsf32_toggle_rpt(struct rtw89_dev *rtwdev,
    struct sk_buff *c2h,
    u32 len) {
  rtw89_queue_chanctx_change(rtwdev, RTW89_CHANCTX_TSF32_TOGGLE_CHANGE);
}

static void rtw89_mac_c2h_mcc_rcv_ack(struct rtw89_dev *rtwdev,
    struct sk_buff *c2h, u32 len) {
...
static void rtw89_mac_c2h_mcc_req_ack(struct rtw89_dev *rtwdev,
    struct sk_buff *c2h, u32 len) {
...
static void rtw89_mac_c2h_mcc_tsf_rpt(struct rtw89_dev *rtwdev,
    struct sk_buff *c2h, u32 len) {
...
static void rtw89_mac_c2h_mcc_status_rpt(struct rtw89_dev *rtwdev,
    struct sk_buff *c2h, u32 len) {
...
static void rtw89_mac_c2h_mrc_tsf_rpt(struct rtw89_dev *rtwdev,
    struct sk_buff *c2h, u32 len) {
...
static void rtw89_mac_c2h_mrc_status_rpt(struct rtw89_dev *rtwdev,
    struct sk_buff *c2h, u32 len) {
  struct rtw89_wait_info *wait = &rtwdev->mcc.wait;
...
static
int rtw89_mac_cfg_ppdu_status_ax(struct rtw89_dev *rtwdev, u8 mac_idx,
    bool enable) {
...
static
int rtw89_mac_cfg_plt_ax(struct rtw89_dev *rtwdev,
...
static int rtw89_mac_init_bfee_ax(struct rtw89_dev *rtwdev, u8 mac_idx) {
  ...
  reg = rtw89_mac_reg_by_idx(rtwdev, R_AX_BFMEE_RESP_OPTION, mac_idx);
  val32
    = FIELD_PREP(B_AX_BFMEE_NDP_RX_STANDBY_TIMER_MASK, NDP_RX_STANDBY_TIMER);
  rtw89_write32(rtwdev, reg, val32);
...
void rtw89_mac_bf_set_gid_table(struct rtw89_dev *rtwdev,
  ...
  rtw89_write32(rtwdev, rtw89_mac_reg_by_idx(rtwdev, R_AX_GID_POSITION0,
      mac_idx),
      le32_to_cpu(p[0]));
  rtw89_write32(rtwdev, rtw89_mac_reg_by_idx(rtwdev, R_AX_GID_POSITION1,
      mac_idx),
      le32_to_cpu(p[1]));
  rtw89_write32(rtwdev, rtw89_mac_reg_by_idx(rtwdev, R_AX_GID_POSITION2,
      mac_idx),
      le32_to_cpu(p[2]));
  rtw89_write32(rtwdev, rtw89_mac_reg_by_idx(rtwdev, R_AX_GID_POSITION3,
      mac_idx),
      le32_to_cpu(p[3]));
}
...
static int __rtw89_mac_set_tx_time(struct rtw89_dev *rtwdev,
...
static
int rtw89_mac_write_xtal_si_ax(struct rtw89_dev *rtwdev, u8 offset, u8 val,
    u8 mask) {
  u32 val32;
  int ret;
  ...
  ret
    = read_poll_timeout(rtw89_read32, val32,
      !(val32 & B_AX_WL_XTAL_SI_CMD_POLL),
...
void rtw89_mac_pkt_drop_sta(struct rtw89_dev *rtwdev,
  ...
  struct rtw89_pkt_drop_params params = {
    0
  };
  int i;
...
void rtw89_mac_pkt_drop_vif(struct rtw89_dev *rtwdev,
    struct rtw89_vif *rtwvif) {
  ieee80211_iterate_stations_atomic(rtwdev->hw,
