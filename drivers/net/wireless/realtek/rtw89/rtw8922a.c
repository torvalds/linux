...
static const struct rtw89_reg_imr rtw8922a_imr_dmac_regs[] = {
  ...
  {R_BE_INTERRUPT_MASK_REG, B_BE_INTERRUPT_MASK_REG_CLR,
   B_BE_INTERRUPT_MASK_REG_SET},
  ...
  {R_BE_BBRPT_DFS_ERR_IMR, B_BE_BBRPT_DFS_ERR_IMR_CLR,
   B_BE_BBRPT_DFS_ERR_IMR_SET},
  {R_BE_LA_ERRFLAG_IMR, B_BE_LA_ERRFLAG_IMR_CLR, B_BE_LA_ERRFLAG_IMR_SET},
  {R_BE_CH_INFO_DBGFLAG_IMR, B_BE_CH_INFO_DBGFLAG_IMR_CLR,
   B_BE_CH_INFO_DBGFLAG_IMR_SET},
...
static const struct rtw89_reg_imr rtw8922a_imr_cmac_regs[] = {
  ...
  {R_BE_RX_ERROR_FLAG_IMR, B_BE_RX_ERROR_FLAG_IMR_CLR,
   B_BE_RX_ERROR_FLAG_IMR_SET},
  {R_BE_TX_ERROR_FLAG_IMR, B_BE_TX_ERROR_FLAG_IMR_CLR,
   B_BE_TX_ERROR_FLAG_IMR_SET},
  {R_BE_RX_ERROR_FLAG_IMR_1, B_BE_TX_ERROR_FLAG_IMR_1_CLR,
   B_BE_TX_ERROR_FLAG_IMR_1_SET},
  ...
  {R_BE_PHYINFO_ERR_IMR_V1, B_BE_PHYINFO_ERR_IMR_V1_CLR,
   B_BE_PHYINFO_ERR_IMR_V1_SET},
};
...
static int rtw8922a_pwr_on_func(struct rtw89_dev *rtwdev) {
  ...
  ret
    = read_poll_timeout(rtw89_read32, val32,
...
static void rtw8922a_efuse_parsing_tssi(struct rtw89_dev *rtwdev,
  ...
  struct rtw8922a_tssi_offset *ofst[] = {
    &map->path_a_tssi, &map->path_b_tssi
  };
  u8 *bw40_1s_tssi_6g_ofst[] = {
...
static void rtw8922a_phycap_parsing_thermal_trim(struct rtw89_dev *rtwdev,
    u8 *phycap_map) {
  static const u32 thm_trim_addr[RF_PATH_NUM_8922A] = {
    0x1706, 0x1733
  };
...
static void rtw8922a_phycap_parsing_pa_bias_trim(struct rtw89_dev *rtwdev,
    u8 *phycap_map) {
  static const u32 pabias_trim_addr[RF_PATH_NUM_8922A] = {
    0x1707, 0x1734
  };
...
static void rtw8922a_phycap_parsing_pad_bias_trim(struct rtw89_dev *rtwdev,
    u8 *phycap_map) {
  static const u32 pad_bias_trim_addr[RF_PATH_NUM_8922A] = {
    0x1708, 0x1735
  };
  struct rtw89_power_trim_info *info = &rtwdev->pwr_trim;
  u32 addr = rtwdev->chip->phycap_addr;
...
static void rtw8922a_set_rx_gain_normal_ofdm(struct rtw89_dev *rtwdev,
    const struct rtw89_chan *chan,
    enum rtw89_rf_path path) {
  static const u32 rssi_tb_bias_comp[2] = {
    0x41f8, 0x45f8
  };
  static const u32 rssi_tb_ext_comp[2] = {
    0x4208, 0x4608
  };
  static const u32 rssi_ofst_addr[2] = {
    0x40c8, 0x44c8
  };
  static const u32 rpl_bias_comp[2] = {
    0x41e8, 0x45e8
  };
  static const u32 rpl_ext_comp[2] = {
    0x41f8, 0x45f8
  };
  struct rtw89_phy_efuse_gain *gain = &rtwdev->efuse_gain;
  ...
  rtw89_phy_write32_mask(rtwdev, rssi_ofst_addr[path], 0xff000000,
      value + 0xF8);
  value *= -4;
...
static void rtw8922a_ctrl_ch(struct rtw89_dev *rtwdev,
  ...
  rtw89_phy_write32_idx(rtwdev, R_MAC_PIN_SEL, B_CH_IDX_SEG0, chan_idx,
      phy_idx);
}

static void rtw8922a_ctrl_bw(struct rtw89_dev *rtwdev, u8 pri_sb, u8 bw,
    enum rtw89_phy_idx phy_idx) {
  switch (bw) {
...
static void rtw8922a_ctrl_afe_dac(struct rtw89_dev *rtwdev,
...
static void rtw8922a_bbmcu_cr_init(struct rtw89_dev *rtwdev,
    enum rtw89_phy_idx phy_idx) {
...
static const u32 dmac_sys_mask[2] = {
  B_BE_DMAC_BB_PHY0_MASK, B_BE_DMAC_BB_PHY1_MASK
};
static const u32 bbrst_mask[2] = {
  B_BE_FEN_BBPLAT_RSTB, B_BE_FEN_BB1PLAT_RSTB
};
static const u32 glbrst_mask[2] = {
  B_BE_FEN_BB_IP_RSTN, B_BE_FEN_BB1_IP_RSTN
};
static const u32 mcu_bootrdy_mask[2] = {
  B_BE_BOOT_RDY0, B_BE_BOOT_RDY1
};

static void rtw8922a_bb_preinit(struct rtw89_dev *rtwdev,
    enum rtw89_phy_idx phy_idx) {
  u32 rdy = 0;
  if (phy_idx == RTW89_PHY_1) {
    rdy = 1;
  }
  rtw89_write32_mask(rtwdev, R_BE_DMAC_SYS_CR32B, dmac_sys_mask[phy_idx],
      0x7FF9);
  ...
  rtw89_write32_mask(rtwdev, R_BE_FEN_RST_ENABLE, mcu_bootrdy_mask[phy_idx],
      rdy);
...
static void rtw8922a_bb_postinit(struct rtw89_dev *rtwdev,
    enum rtw89_phy_idx phy_idx) {
  if (phy_idx == RTW89_PHY_0) {
...
static void rtw8922a_bb_reset(struct rtw89_dev *rtwdev,
    enum rtw89_phy_idx phy_idx) {
}
...
static int rtw8922a_ctrl_mlo(struct rtw89_dev *rtwdev,
...
static void rtw8922a_set_channel_help(struct rtw89_dev *rtwdev, bool enter,
  ...
  rtw8922a_hal_reset(rtwdev, phy_idx, mac_idx, chan->band_type, &p->tx_en,
      enter);
  if (!enter) {
...
static u8 rtw8922a_get_thermal(struct rtw89_dev *rtwdev,
...
static
void rtw8922a_set_trx_mask(struct rtw89_dev *rtwdev, u8 path, u8 group,
    u32 val) {
