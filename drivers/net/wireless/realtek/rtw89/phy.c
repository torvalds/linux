...
static u64 rtw89_phy_ra_mask_rssi(struct rtw89_dev *rtwdev, u8 rssi,
    u8 ratr_state) {
  u8 rssi_lv_t[RA_FLOOR_TABLE_SIZE] = {
    30, 44, 48, 52, 56, 60, 100
  };
  u8 rssi_lv = 0;
  u8 i;
  rssi >>= 1;
...
void rtw89_phy_rate_pattern_vif(struct rtw89_dev *rtwdev,
  ...
  struct rtw89_phy_rate_pattern next_pattern = {
    0
  };
  const struct rtw89_chan *chan = rtw89_chan_get(rtwdev,
      rtwvif->sub_entity_idx);
...
static void rtw89_phy_ra_updata_sta_iter(void *data,
    struct ieee80211_sta *sta) {
...
static u32 rtw89_phy_read_full_rf_v2_a(struct rtw89_dev *rtwdev,
  ...
  static const u16 r_addr_ofst[2] = {
    0x2C24, 0x2D24
  };
  static const u16 addr_ofst[2] = {
    0x2ADC, 0x2BDC
  };
  bool busy, done;
  int ret;
...
static
bool rtw89_phy_write_full_rf_v2_a(struct rtw89_dev *rtwdev,
    enum rtw89_rf_path rf_path,
    u32 addr, u32 data) {
  static const u32 addr_is_idle[2] = {
    0x2C24, 0x2D24
  };
  static const u32 addr_ofst[2] = {
    0x2AE0, 0x2BE0
  };
  bool busy;
  u32 val;
...
static
bool rtw89_phy_write_rf_a_v2(struct rtw89_dev *rtwdev,
    enum rtw89_rf_path rf_path,
    u32 addr, u32 mask, u32 data) {
  u32 val;
  if (mask == RFREG_MASK) {
...
static void rtw89_phy_cfg_bb_gain_error(struct rtw89_dev *rtwdev,
...
static void rtw89_phy_cfg_bb_rpl_ofst(struct rtw89_dev *rtwdev,
    union rtw89_phy_bb_gain_arg arg, u32 data) {
  struct rtw89_phy_bb_gain_info *gain = &rtwdev->bb_gain.ax;
...
static void rtw89_phy_cfg_bb_gain_bypass(struct rtw89_dev *rtwdev,
    union rtw89_phy_bb_gain_arg arg, u32 data) {
  struct rtw89_phy_bb_gain_info *gain = &rtwdev->bb_gain.ax;
  u8 type = arg.type;
  u8 path = arg.path;
...
static void rtw89_phy_cfg_bb_gain_op1db(struct rtw89_dev *rtwdev,
    union rtw89_phy_bb_gain_arg arg, u32 data) {
  struct rtw89_phy_bb_gain_info *gain = &rtwdev->bb_gain.ax;
  u8 type = arg.type;
  u8 path = arg.path;
...
static void rtw89_phy_cofig_rf_reg_store(struct rtw89_dev *rtwdev,
    const struct rtw89_reg2_def *reg,
    enum rtw89_rf_path rf_path,
...
static void rtw89_phy_fill_txpwr_limit_ru_20m_ax(struct rtw89_dev *rtwdev,
...
static void rtw89_phy_fill_txpwr_limit_ru_40m_ax(struct rtw89_dev *rtwdev,
    struct rtw89_txpwr_limit_ru_ax *lmt_ru,
    u8 band, u8 ntx, u8 ch) {
  lmt_ru->ru26[0] = rtw89_phy_read_txpwr_limit_ru(rtwdev, band,
      RTW89_RU26,
...
static void rtw89_phy_fill_txpwr_limit_ru_80m_ax(struct rtw89_dev *rtwdev,
    struct rtw89_txpwr_limit_ru_ax *lmt_ru,
    u8 band, u8 ntx, u8 ch) {
  lmt_ru->ru26[0] = rtw89_phy_read_txpwr_limit_ru(rtwdev, band,
      RTW89_RU26,
...
static void rtw89_phy_fill_txpwr_limit_ru_160m_ax(struct rtw89_dev *rtwdev,
    struct rtw89_txpwr_limit_ru_ax *lmt_ru,
    u8 band, u8 ntx, u8 ch) {
  static const int ofst[] = {
    -14, -10, -6, -2, 2, 6, 10, 14
  };
  int i;
...
static void rtw89_phy_c2h_ra_rpt_iter(void *data, struct ieee80211_sta *sta) {
  struct rtw89_phy_iter_ra_data *ra_data
    = (struct rtw89_phy_iter_ra_data *) data;
...
static void rtw89_phy_c2h_ra_rpt(struct rtw89_dev *rtwdev, struct sk_buff *c2h,
    u32 len) {
  struct rtw89_phy_iter_ra_data ra_data;
...
static void rtw89_phy_c2h_rfk_rpt_log(struct rtw89_dev *rtwdev,
  ...
  switch (func) {
    ...
    case RTW89_PHY_C2H_RFK_LOG_FUNC_DACK:
      ...
      rtw89_debug(rtwdev, RTW89_DBG_RFK,
          "[DACK]S0 ADC_GAINK ic = 0x%x, qc = 0x%x\n",
          dack->adgaink_d[0][0], dack->adgaink_d[0][1]);
      rtw89_debug(rtwdev, RTW89_DBG_RFK,
          "[DACK]S1 ADC_GAINK ic = 0x%x, qc = 0x%x\n",
...
static void rtw89_phy_c2h_rfk_log_iqk(struct rtw89_dev *rtwdev,
    struct sk_buff *c2h, u32 len) {
  rtw89_phy_c2h_rfk_log(rtwdev, c2h, len,
      RTW89_PHY_C2H_RFK_LOG_FUNC_IQK, "IQK");
}

static void rtw89_phy_c2h_rfk_log_dpk(struct rtw89_dev *rtwdev,
    struct sk_buff *c2h, u32 len) {
  rtw89_phy_c2h_rfk_log(rtwdev, c2h, len,
      RTW89_PHY_C2H_RFK_LOG_FUNC_DPK, "DPK");
}

static void rtw89_phy_c2h_rfk_log_dack(struct rtw89_dev *rtwdev,
    struct sk_buff *c2h, u32 len) {
  rtw89_phy_c2h_rfk_log(rtwdev, c2h, len,
      RTW89_PHY_C2H_RFK_LOG_FUNC_DACK, "DACK");
}

static void rtw89_phy_c2h_rfk_log_rxdck(struct rtw89_dev *rtwdev,
    struct sk_buff *c2h, u32 len) {
  rtw89_phy_c2h_rfk_log(rtwdev, c2h, len,
      RTW89_PHY_C2H_RFK_LOG_FUNC_RXDCK, "RX_DCK");
}

static void rtw89_phy_c2h_rfk_log_tssi(struct rtw89_dev *rtwdev,
    struct sk_buff *c2h, u32 len) {
  rtw89_phy_c2h_rfk_log(rtwdev, c2h, len,
      RTW89_PHY_C2H_RFK_LOG_FUNC_TSSI, "TSSI");
}

static void rtw89_phy_c2h_rfk_log_txgapk(struct rtw89_dev *rtwdev,
    struct sk_buff *c2h, u32 len) {
  rtw89_phy_c2h_rfk_log(rtwdev, c2h, len,
...
static void rtw89_phy_c2h_rfk_report_state(struct rtw89_dev *rtwdev,
    struct sk_buff *c2h, u32 len) {
...
static void rtw89_phy_antdiv_sts_instance_add(struct rtw89_dev *rtwdev,
  ...
  if (rtw89_get_data_rate_mode(rtwdev,
...
static u8 rtw89_phy_antdiv_sts_instance_get_rssi(
    struct rtw89_antdiv_stats *stats) {
...
static u8 rtw89_phy_antdiv_sts_instance_get_evm(
    struct rtw89_antdiv_stats *stats) {
...
static void rtw89_phy_stat_rssi_update_iter(void *data,
  ...
  } else if (abs((int) rtwsta->prev_rssi - (int) rssi_curr)
      > (3 << RSSI_FACTOR)) {
    rtwsta->prev_rssi = rssi_curr;
...
static void rtw89_phy_ccx_top_setting_init(struct rtw89_dev *rtwdev) {
  ...
  rtw89_phy_set_phy_regs(rtwdev, ccx->setting_addr, ccx->measurement_trig_mask,
      1);
...
static bool rtw89_phy_ifs_clm_th_update_check(struct rtw89_dev *rtwdev,
  ...
  u32 ifs_th_h_us[RTW89_IFS_CLM_NUM] = {
    0
  };
  if (!is_update) {
...
static void rtw89_phy_ifs_clm_setting_init(struct rtw89_dev *rtwdev) {
  ...
  rtw89_phy_set_phy_regs(rtwdev, ccx->ifs_cnt_addr, ccx->ifs_collect_en_mask,
      true);
...
static void rtw89_phy_ccx_trigger(struct rtw89_dev *rtwdev) {
  ...
  struct rtw89_env_monitor_info *env = &rtwdev->env_monitor;
  const struct rtw89_ccx_regs *ccx = phy->ccx;
  rtw89_phy_set_phy_regs(rtwdev, ccx->ifs_cnt_addr, ccx->ifs_clm_cnt_clear_mask,
      0);
  rtw89_phy_set_phy_regs(rtwdev, ccx->setting_addr, ccx->measurement_trig_mask,
      0);
  rtw89_phy_set_phy_regs(rtwdev, ccx->ifs_cnt_addr, ccx->ifs_clm_cnt_clear_mask,
...
static void rtw89_phy_tx_path_div_sta_iter(void *data,
    struct ieee80211_sta *sta) {
  struct rtw89_sta *rtwsta = (struct rtw89_sta *) sta->drv_priv;
...
static void _rfk_write_rf(struct rtw89_dev *rtwdev,
    const struct rtw89_reg5_def *def) {
  rtw89_write_rf(rtwdev, def->path, def->addr, def->mask, def->data);
}

static void _rfk_write32_mask(struct rtw89_dev *rtwdev,
    const struct rtw89_reg5_def *def) {
  rtw89_phy_write32_mask(rtwdev, def->addr, def->mask, def->data);
}

static void _rfk_write32_set(struct rtw89_dev *rtwdev,
    const struct rtw89_reg5_def *def) {
  rtw89_phy_write32_set(rtwdev, def->addr, def->mask);
}

static void _rfk_write32_clr(struct rtw89_dev *rtwdev,
    const struct rtw89_reg5_def *def) {
  rtw89_phy_write32_clr(rtwdev, def->addr, def->mask);
}

static void _rfk_delay(struct rtw89_dev *rtwdev,
    const struct rtw89_reg5_def *def) {
  udelay(def->data);
}

static void
(*_rfk_handler[])(struct rtw89_dev *rtwdev,
    const struct rtw89_reg5_def *def) = {
...
static const struct rtw89_reg_def rtw89_tssi_fastmode_regs_level[
  RTW89_TSSI_FAST_MODE_NUM] = {
  {0xD930, 0xff0000},
  {0xD930, 0xff000000},
  {0xD934, 0xff},
...
static const struct rtw89_reg_def rtw89_tssi_bandedge_regs_flat[
  RTW89_TSSI_SBW_NUM] = {
  {0xD91C, 0xff000000},
  {0xD920, 0xff},
  {0xD920, 0xff00},
...
void rtw89_decode_chan_idx(struct rtw89_dev *rtwdev, u8 chan_idx,
  ...
  *band = idx
      <= RTW89_CH_BASE_IDX_5G_LAST ? NL80211_BAND_5GHZ : NL80211_BAND_6GHZ;
