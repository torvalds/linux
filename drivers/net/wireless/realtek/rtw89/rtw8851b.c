...
static const u8 rtw89_btc_8851b_bt_rssi_thres[BTC_BT_RSSI_THMAX] = {
  50, 40, 30, 20
};
...
static void rtw8851b_efuse_parsing_tssi(struct rtw89_dev *rtwdev,
  ...
  struct rtw8851b_tssi_offset *ofst[] = {
    &map->path_a_tssi
  };
  u8 i, j;
...
static void rtw8851b_phycap_parsing_tssi(struct rtw89_dev *rtwdev,
    u8 *phycap_map) {
  struct rtw89_tssi_info *tssi = &rtwdev->tssi;
  static const u32 tssi_trim_addr[RF_PATH_NUM_8851B] = {
    0x5D6
  };
...
static void rtw8851b_phycap_parsing_thermal_trim(struct rtw89_dev *rtwdev,
  ...
  static const u32 thm_trim_addr[RF_PATH_NUM_8851B] = {
    0x5DF
  };
  u32 addr = rtwdev->chip->phycap_addr;
  u8 i;
...
static void rtw8851b_phycap_parsing_gain_comp(struct rtw89_dev *rtwdev,
    u8 *phycap_map) {
...
static void rtw8851b_set_bb_gpio(struct rtw89_dev *rtwdev, u8 gpio_idx,
    bool inv,
    u8 src_sel) {
  u32 addr, mask;
  if (gpio_idx >= 32) {
...
static void rtw8851b_set_gain_offset(struct rtw89_dev *rtwdev,
  ...
  static const u32 rssi_ofst_addr[] = {
    R_PATH0_G_TIA1_LNA6_OP1DB_V1
  };
  static const u32 gain_err_addr[] = {
    R_P0_AGC_RSVD
  };
...
static
void rtw8851b_set_rxsc_rpl_comp(struct rtw89_dev *rtwdev,
    enum rtw89_subband subband) {
  const struct rtw89_phy_bb_gain_info *gain = &rtwdev->bb_gain.ax;
  ...
  val
    = u32_encode_bits(gain->rpl_ofst_40[band][RF_PATH_A][2], B_P0_RTL2_42_MASK)
  ...
  val
    = u32_encode_bits(gain->rpl_ofst_80[band][RF_PATH_A][2], B_P0_RTL3_82_MASK)
...
static void rtw8851b_set_cfr(struct rtw89_dev *rtwdev,
    const struct rtw89_chan *chan) {
...
static void rtw8851b_5m_mask(struct rtw89_dev *rtwdev,
    const struct rtw89_chan *chan,
    enum rtw89_phy_idx phy_idx) {
...
static void rtw8851b_bb_reset_all(struct rtw89_dev *rtwdev,
    enum rtw89_phy_idx phy_idx) {
...
static void rtw8851b_set_channel_bb(struct rtw89_dev *rtwdev,
    const struct rtw89_chan *chan,
    enum rtw89_phy_idx phy_idx) {
...
static void rtw8851b_set_txpwr_ref(struct rtw89_dev *rtwdev,
    enum rtw89_phy_idx phy_idx) {
  static const u32 addr[RF_PATH_NUM_8851B] = {
    0x5800
  };
...
static int rtw8851b_init_txpwr_unit(struct rtw89_dev *rtwdev,
    enum rtw89_phy_idx phy_idx) {
  int ret;
...
static u8 rtw8851b_get_thermal(struct rtw89_dev *rtwdev,
...
static
void rtw8851b_set_trx_mask(struct rtw89_dev *rtwdev, u8 path, u8 group,
    u32 val) {
...
static void rtw8851b_btc_set_wl_txpwr_ctrl(struct rtw89_dev *rtwdev,
    u32 txpwr_val) {
  union rtw8851b_btc_wl_txpwr_ctrl arg = {
    .txpwr_val = txpwr_val
  };
  s32 val;
