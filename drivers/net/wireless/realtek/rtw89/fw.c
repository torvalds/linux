...
static const u8 mss_signature[] = {
  0x4D, 0x53, 0x53, 0x4B, 0x50, 0x4F, 0x4F, 0x4C
};
...
static int rtw89_fw_hdr_parser_v0(struct rtw89_dev *rtwdev, const u8 *fw,
    u32 len,
...
static int rtw89_fw_hdr_parser_v1(struct rtw89_dev *rtwdev, const u8 *fw,
    u32 len,
    struct rtw89_fw_bin_info *info) {
...
static int rtw89_fw_update_ver(struct rtw89_dev *rtwdev,
  ...
  const struct rtw89_fw_hdr_v1 *v1
    = (const struct rtw89_fw_hdr_v1 *) fw_suit->data;
  if (type == RTW89_FW_LOGFMT) {
    return 0;
  }
  fw_suit->type = type;
...
static enum rtw89_fwdl_check_type rtw89_fw_get_fwdl_chk_type_from_suit(
...
static int rtw89_fw_download_suit(struct rtw89_dev *rtwdev,
  ...
  if (rtwdev->chip->chip_id == RTL8922A
      && (fw_suit->type == RTW89_FW_NORMAL
      || fw_suit->type == RTW89_FW_WOWLAN)) {
...
int rtw89_fw_h2c_cam(struct rtw89_dev *rtwdev, struct rtw89_vif *rtwvif,
  ...
  rtw89_cam_fill_addr_cam_info(rtwdev, rtwvif, rtwsta, scan_mac_addr,
      skb->data);
...
static void __get_sta_he_pkt_padding(struct rtw89_dev *rtwdev,
  ...
  ru_bitmap
    = FIELD_GET(IEEE80211_PPE_THRES_RU_INDEX_BITMASK_MASK, ppe_thres_hdr);
...
int rtw89_fw_h2c_assoc_cmac_tbl(struct rtw89_dev *rtwdev,
  ...
  if (chip->h2c_cctl_func_id == H2C_FUNC_MAC_CCTLINFO_UD_V1) {
    ...
    SET_CMC_TBL_NOMINAL_PKT_PADDING40_V1(skb->data,
        pads[RTW89_CHANNEL_WIDTH_40]);
    SET_CMC_TBL_NOMINAL_PKT_PADDING80_V1(skb->data,
        pads[RTW89_CHANNEL_WIDTH_80]);
    SET_CMC_TBL_NOMINAL_PKT_PADDING160_V1(skb->data,
        pads[RTW89_CHANNEL_WIDTH_160]);
    ...
    SET_CMC_TBL_NOMINAL_PKT_PADDING160(skb->data,
        pads[RTW89_CHANNEL_WIDTH_160]);
  }
  if (sta) {
...
int rtw89_fw_h2c_update_beacon_be(struct rtw89_dev *rtwdev,
  ...
  h2c->w0 = le32_encode_bits(rtwvif->port, RTW89_H2C_BCN_UPD_BE_W0_PORT)
      ...
      | le32_encode_bits(tim_offset | BIT(
      7), RTW89_H2C_BCN_UPD_BE_W0_GRP_IE_OFST);
  h2c->w1 = le32_encode_bits(rtwvif->mac_id, RTW89_H2C_BCN_UPD_BE_W1_MACID)
      ...
      | le32_encode_bits(RTW89_MGMT_HW_SEQ_MODE,
      RTW89_H2C_BCN_UPD_BE_W1_SSN_MODE)
...
static enum rtw89_fw_sta_type rtw89_fw_get_sta_type(struct rtw89_dev *rtwdev,
    struct rtw89_vif *rtwvif,
    struct rtw89_sta *rtwsta) {
...
int rtw89_fw_h2c_set_ofld_cfg(struct rtw89_dev *rtwdev) {
  static const u8 cfg[] = {
    0x09, 0x00, 0x00, 0x00, 0x5e, 0x00, 0x00, 0x00
  };
  struct sk_buff *skb;
  int ret;
...
int rtw89_fw_h2c_tp_offload(struct rtw89_dev *rtwdev,
    struct rtw89_vif *rtwvif) {
...
csi:
  ...
  h2c->w3 |= le32_encode_bits(ra->band_num, RTW89_H2C_RA_W3_BAND_NUM)
      ...
      | le32_encode_bits(ra->fixed_csi_rate_en,
      RTW89_H2C_RA_W3_FIXED_CSI_RATE_EN)
      | le32_encode_bits(ra->ra_csi_rate_en, RTW89_H2C_RA_W3_RA_CSI_RATE_EN)
      | le32_encode_bits(ra->csi_mcs_ss_idx,
      RTW89_H2C_RA_W3_FIXED_CSI_MCS_SS_IDX)
...
int rtw89_fw_h2c_add_pkt_offload(struct rtw89_dev *rtwdev, u8 *id,
  ...
  *id = alloc_id;
  skb
    = rtw89_fw_h2c_alloc_skb_with_hdr(rtwdev,
...
int rtw89_fw_h2c_scan_offload_be(struct rtw89_dev *rtwdev,
  ...
  h2c->w1 = le32_encode_bits(option->num_macc_role,
      RTW89_H2C_SCANOFLD_BE_W1_NUM_MACC_ROLE)
  ...
  h2c->w3 = le32_encode_bits(0, RTW89_H2C_SCANOFLD_BE_W3_NUM_SSID)
      ...
      | le32_encode_bits(probe_id[NL80211_BAND_2GHZ],
      RTW89_H2C_SCANOFLD_BE_W3_PROBEID);
  ...
  h2c->w5
    = le32_encode_bits(option->mlo_mode, RTW89_H2C_SCANOFLD_BE_W5_MLO_MODE);
...
int rtw89_fw_h2c_rf_rxdck(struct rtw89_dev *rtwdev,
    enum rtw89_phy_idx phy_idx) {
  const struct rtw89_chan *chan = rtw89_chan_get(rtwdev,
      RTW89_SUB_ENTITY_0);
...
static bool fw_txpwr_byrate_entry_valid(
    const struct rtw89_fw_txpwr_byrate_entry *e,
    const void *cursor,
...
static bool fw_txpwr_lmt_2ghz_entry_valid(
    const struct rtw89_fw_txpwr_lmt_2ghz_entry *e,
    const void *cursor,
    const struct rtw89_txpwr_conf *conf) {
  if (!__fw_txpwr_entry_acceptable(e, cursor, conf->ent_sz)) {
    return false;
...
static bool fw_txpwr_lmt_5ghz_entry_valid(
    const struct rtw89_fw_txpwr_lmt_5ghz_entry *e,
    const void *cursor,
    const struct rtw89_txpwr_conf *conf) {
  if (!__fw_txpwr_entry_acceptable(e, cursor, conf->ent_sz)) {
    return false;
...
static bool fw_txpwr_lmt_6ghz_entry_valid(
    const struct rtw89_fw_txpwr_lmt_6ghz_entry *e,
    const void *cursor,
    const struct rtw89_txpwr_conf *conf) {
  if (!__fw_txpwr_entry_acceptable(e, cursor, conf->ent_sz)) {
    return false;
...
static bool fw_txpwr_lmt_ru_2ghz_entry_valid(
    const struct rtw89_fw_txpwr_lmt_ru_2ghz_entry *e,
    const void *cursor,
    const struct rtw89_txpwr_conf *conf) {
  if (!__fw_txpwr_entry_acceptable(e, cursor, conf->ent_sz)) {
    return false;
...
static bool fw_txpwr_lmt_ru_5ghz_entry_valid(
    const struct rtw89_fw_txpwr_lmt_ru_5ghz_entry *e,
    const void *cursor,
    const struct rtw89_txpwr_conf *conf) {
  if (!__fw_txpwr_entry_acceptable(e, cursor, conf->ent_sz)) {
    return false;
...
static bool fw_txpwr_lmt_ru_6ghz_entry_valid(
    const struct rtw89_fw_txpwr_lmt_ru_6ghz_entry *e,
    const void *cursor,
    const struct rtw89_txpwr_conf *conf) {
  if (!__fw_txpwr_entry_acceptable(e, cursor, conf->ent_sz)) {
    return false;
...
static bool fw_tx_shape_lmt_entry_valid(
    const struct rtw89_fw_tx_shape_lmt_entry *e,
    const void *cursor,
    const struct rtw89_txpwr_conf *conf) {
  if (!__fw_txpwr_entry_acceptable(e, cursor, conf->ent_sz)) {
    return false;
...
static bool fw_tx_shape_lmt_ru_entry_valid(
    const struct rtw89_fw_tx_shape_lmt_ru_entry *e,
    const void *cursor,
    const struct rtw89_txpwr_conf *conf) {
  if (!__fw_txpwr_entry_acceptable(e, cursor, conf->ent_sz)) {
    return false;
