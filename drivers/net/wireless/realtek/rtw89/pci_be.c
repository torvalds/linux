...
static void rtw89_pci_ldo_low_pwr_be(struct rtw89_dev *rtwdev) {
  ...
  rtw89_write32_clr(rtwdev, R_BE_L1_2_CTRL_HCILDO,
      B_BE_PCIE_DIS_L1_2_CTRL_HCILDO);
}
...
static void rtw89_pci_pcie_setting_be(struct rtw89_dev *rtwdev) {
  ...
  rtw89_write32_set(rtwdev, R_BE_EFUSE_CTRL_2_V1,
      B_BE_R_SYM_AUTOLOAD_WITH_PMC_SEL);
...
static void rtw89_pci_ctrl_txdma_fw_ch_be(struct rtw89_dev *rtwdev,
    bool enable) {
