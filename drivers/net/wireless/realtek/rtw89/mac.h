...
struct rtw89_mac_gen_def {
  ...
  int (*dle_buf_req)(struct rtw89_dev *rtwdev, u16 buf_len, bool wd,
      u16 *pkt_id);
...
static inline
u32 rtw89_mac_reg_by_port(struct rtw89_dev *rtwdev, u32 base, u8 port,
    u8 mac_idx) {
  return rtw89_mac_reg_by_idx(rtwdev, base + port * 0x40, mac_idx);
}

static inline u32 rtw89_read32_port(struct rtw89_dev *rtwdev,
    struct rtw89_vif *rtwvif, u32 base) {
  u32 reg;
  reg = rtw89_mac_reg_by_port(rtwdev, base, rtwvif->port, rtwvif->mac_idx);
  return rtw89_read32(rtwdev, reg);
}

static inline u32 rtw89_read32_port_mask(struct rtw89_dev *rtwdev,
    struct rtw89_vif *rtwvif,
    u32 base, u32 mask) {
  u32 reg;
  reg = rtw89_mac_reg_by_port(rtwdev, base, rtwvif->port, rtwvif->mac_idx);
...
static inline void rtw89_write32_port(struct rtw89_dev *rtwdev,
    struct rtw89_vif *rtwvif, u32 base,
    u32 data) {
  u32 reg;
  reg = rtw89_mac_reg_by_port(rtwdev, base, rtwvif->port, rtwvif->mac_idx);
...
static inline void rtw89_write32_port_mask(struct rtw89_dev *rtwdev,
    struct rtw89_vif *rtwvif,
...
static inline void rtw89_write16_port_mask(struct rtw89_dev *rtwdev,
    struct rtw89_vif *rtwvif,
...
static inline void rtw89_write32_port_clr(struct rtw89_dev *rtwdev,
    struct rtw89_vif *rtwvif,
    u32 base, u32 bit) {
  u32 reg;
  reg = rtw89_mac_reg_by_port(rtwdev, base, rtwvif->port, rtwvif->mac_idx);
...
static inline void rtw89_write16_port_clr(struct rtw89_dev *rtwdev,
    struct rtw89_vif *rtwvif,
    u32 base, u16 bit) {
  u32 reg;
  reg = rtw89_mac_reg_by_port(rtwdev, base, rtwvif->port, rtwvif->mac_idx);
...
static inline void rtw89_write32_port_set(struct rtw89_dev *rtwdev,
    struct rtw89_vif *rtwvif,
    u32 base, u32 bit) {
  u32 reg;
  reg = rtw89_mac_reg_by_port(rtwdev, base, rtwvif->port, rtwvif->mac_idx);
...
int rtw89_mac_dle_dfi_cfg(struct rtw89_dev *rtwdev,
...
static inline
int rtw89_mac_cfg_ppdu_status(struct rtw89_dev *rtwdev, u8 mac_idx,
    bool enable) {
  const struct rtw89_mac_gen_def *mac = rtwdev->chip->mac_def;
...
int rtw89_mac_coex_init(struct rtw89_dev *rtwdev,
...
void rtw89_mac_bf_disassoc(struct rtw89_dev *rtwdev, struct ieee80211_vif *vif,
    struct ieee80211_sta *sta);
void rtw89_mac_bf_set_gid_table(struct rtw89_dev *rtwdev,
    struct ieee80211_vif *vif,
...
static inline
int rtw89_mac_write_xtal_si(struct rtw89_dev *rtwdev, u8 offset, u8 val,
    u8 mask) {
  const struct rtw89_mac_gen_def *mac = rtwdev->chip->mac_def;
...
int rtw89_mac_dle_quota_change(struct rtw89_dev *rtwdev,
    enum rtw89_qta_mode mode,
    bool band1_en);
