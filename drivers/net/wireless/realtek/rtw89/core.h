...
struct rtw89_hci_ops {
  int (*tx_write)(struct rtw89_dev *rtwdev,
...
static inline void rtw89_hci_switch_mode(struct rtw89_dev *rtwdev,
    bool low_power) {
...
static inline u32 rtw89_hci_check_and_reclaim_tx_resource(
    struct rtw89_dev *rtwdev, u8 txch) {
...
static inline void rtw89_hci_ctrl_txdma_ch(struct rtw89_dev *rtwdev,
    bool enable) {
...
static inline void rtw89_hci_ctrl_txdma_fw_ch(struct rtw89_dev *rtwdev,
    bool enable) {
...
static inline void rtw89_hci_ctrl_trxhci(struct rtw89_dev *rtwdev,
    bool enable) {
...
static inline void rtw89_hci_clear(struct rtw89_dev *rtwdev,
    struct pci_dev *pdev) {
...
static inline void rtw89_write8_set(struct rtw89_dev *rtwdev, u32 addr,
    u8 bit) {
  u8 val;
...
static inline void rtw89_write16_set(struct rtw89_dev *rtwdev, u32 addr,
    u16 bit) {
  u16 val;
...
static inline void rtw89_write32_set(struct rtw89_dev *rtwdev, u32 addr,
    u32 bit) {
  u32 val;
...
static inline void rtw89_write8_clr(struct rtw89_dev *rtwdev, u32 addr,
    u8 bit) {
  u8 val;
  val = rtw89_read8(rtwdev, addr);
  rtw89_write8(rtwdev, addr, val & ~bit);
...
static inline void rtw89_write16_clr(struct rtw89_dev *rtwdev, u32 addr,
    u16 bit) {
  u16 val;
  val = rtw89_read16(rtwdev, addr);
  rtw89_write16(rtwdev, addr, val & ~bit);
...
static inline void rtw89_write32_clr(struct rtw89_dev *rtwdev, u32 addr,
    u32 bit) {
  u32 val;
  val = rtw89_read32(rtwdev, addr);
  rtw89_write32(rtwdev, addr, val & ~bit);
...
static inline u32 rtw89_read32_mask(struct rtw89_dev *rtwdev, u32 addr,
    u32 mask) {
...
static inline u16 rtw89_read16_mask(struct rtw89_dev *rtwdev, u32 addr,
    u32 mask) {
  u32 shift = __ffs(mask);
  u32 orig;
  u32 ret;
...
static inline u8 rtw89_read8_mask(struct rtw89_dev *rtwdev, u32 addr,
    u32 mask) {
  u32 shift = __ffs(mask);
  u32 orig;
  u32 ret;
...
static inline void rtw89_write8_mask(struct rtw89_dev *rtwdev, u32 addr,
    u32 mask, u8 data) {
  u32 shift;
  u8 orig, set;
  mask &= 0xff;
...
static inline u32 rtw89_read_rf(struct rtw89_dev *rtwdev,
    enum rtw89_rf_path rf_path,
    u32 addr, u32 mask) {
  u32 val;
...
static inline void rtw89_write_rf(struct rtw89_dev *rtwdev,
    enum rtw89_rf_path rf_path,
    u32 addr, u32 mask, u32 data) {
  mutex_lock(&rtwdev->rf_mutex);
...
void rtw89_regd_notifier(struct wiphy *wiphy,
    struct regulatory_request *request);
