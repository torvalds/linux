...
static inline void SET_CMC_TBL_DATA_RTY_LOWEST_RATE(void *table, u32 val) {
  ...
  le32p_replace_bits((__le32 *) (table) + 10,
      SET_CMC_TBL_MASK_DATA_RTY_LOWEST_RATE,
      GENMASK(8, 0));
}
...
static inline void SET_CMC_TBL_RTS_RTY_LOWEST_RATE(void *table, u32 val) {
  ...
  le32p_replace_bits((__le32 *) (table) + 10,
      SET_CMC_TBL_MASK_RTS_RTY_LOWEST_RATE,
      GENMASK(31, 28));
}
...
static inline void SET_CMC_TBL_DATA_TXCNT_LMT_SEL(void *table, u32 val) {
  ...
  le32p_replace_bits((__le32 *) (table) + 11,
      SET_CMC_TBL_MASK_DATA_TXCNT_LMT_SEL,
      BIT(6));
}
...
static inline void SET_CMC_TBL_RTS_DROP_DATA_MODE(void *table, u32 val) {
  ...
  le32p_replace_bits((__le32 *) (table) + 11,
      SET_CMC_TBL_MASK_RTS_DROP_DATA_MODE,
      GENMASK(14, 13));
}
...
static inline void SET_CMC_TBL_BSR_QUEUE_SIZE_FORMAT(void *table, u32 val) {
  ...
  le32p_replace_bits((__le32 *) (table) + 14,
      SET_CMC_TBL_MASK_BSR_QUEUE_SIZE_FORMAT,
      BIT(13));
}
...
static inline void SET_CMC_TBL_NOMINAL_PKT_PADDING_V1(void *table, u32 val) {
  ...
  le32p_replace_bits((__le32 *) (table) + 15,
...
static inline void SET_CMC_TBL_NOMINAL_PKT_PADDING160(void *table, u32 val) {
  ...
  le32p_replace_bits((__le32 *) (table) + 16,
      SET_CMC_TBL_MASK_NOMINAL_PKT_PADDING,
      GENMASK(29, 28));
}
...
static inline void SET_DCTL_HW_EXSEQ_MACID_V1(void *table, u32 val) {
  ...
  le32p_replace_bits((__le32 *) (table) + 9,
      SET_DCTL_MASK_SET_DCTL_HW_EXSEQ_MACID,
      GENMASK(14, 8));
}
...
static inline void RTW89_SET_FWCMD_PKT_DROP_ROLE_A_INFO_TF_TRS(void *cmd,
    u32 val) {
  le32p_replace_bits((__le32 *) cmd + 1, val, GENMASK(15, 8));
}

static inline void RTW89_SET_FWCMD_PKT_DROP_MACID_BAND_SEL_0(void *cmd,
    u32 val) {
  le32p_replace_bits((__le32 *) cmd + 2, val, GENMASK(31, 0));
}

static inline void RTW89_SET_FWCMD_PKT_DROP_MACID_BAND_SEL_1(void *cmd,
    u32 val) {
  le32p_replace_bits((__le32 *) cmd + 3, val, GENMASK(31, 0));
}

static inline void RTW89_SET_FWCMD_PKT_DROP_MACID_BAND_SEL_2(void *cmd,
    u32 val) {
  le32p_replace_bits((__le32 *) cmd + 4, val, GENMASK(31, 0));
}

static inline void RTW89_SET_FWCMD_PKT_DROP_MACID_BAND_SEL_3(void *cmd,
    u32 val) {
...
static inline void RTW89_SET_DISCONNECT_DETECT_TRYOK_BCNFAIL_COUNT_EN(void *h2c,
    u32 val) {
...
static inline void RTW89_SET_DISCONNECT_DETECT_CHECK_PERIOD(void *h2c,
    u32 val) {
  le32p_replace_bits((__le32 *) h2c, val, GENMASK(23, 16));
}

static inline void RTW89_SET_DISCONNECT_DETECT_TRY_PKT_COUNT(void *h2c,
    u32 val) {
  le32p_replace_bits((__le32 *) h2c, val, GENMASK(31, 24));
}

static inline void RTW89_SET_DISCONNECT_DETECT_TRYOK_BCNFAIL_COUNT_LIMIT(
    void *h2c, u32 val) {
  le32p_replace_bits((__le32 *) (h2c) + 1, val, GENMASK(7, 0));
}
...
static inline void RTW89_SET_WOW_GLOBAL_RX_PARSE_AFTER_WAKE(void *h2c,
    u32 val) {
  le32p_replace_bits((__le32 *) h2c, val, BIT(2));
}
...
static inline void RTW89_SET_WOW_GLOBAL_REMOTECTRL_INFO_CONTENT(void *h2c,
    u32 val) {
  le32p_replace_bits((__le32 *) (h2c) + 1, val, GENMASK(31, 0));
}

static inline void RTW89_SET_WOW_WAKEUP_CTRL_PATTERN_MATCH_ENABLE(void *h2c,
    u32 val) {
  le32p_replace_bits((__le32 *) h2c, val, BIT(0));
}
...
static inline void RTW89_SET_WOW_WAKEUP_CTRL_HW_UNICAST_ENABLE(void *h2c,
    u32 val) {
  le32p_replace_bits((__le32 *) h2c, val, BIT(2));
}

static inline void RTW89_SET_WOW_WAKEUP_CTRL_FW_UNICAST_ENABLE(void *h2c,
    u32 val) {
  le32p_replace_bits((__le32 *) h2c, val, BIT(3));
}
...
static inline void RTW89_SET_WOW_WAKEUP_CTRL_ALL_DATA_ENABLE(void *h2c,
    u32 val) {
...
static inline void RTW89_SET_WOW_CAM_UPD_NEGATIVE_PATTERN_MATCH(void *h2c,
    u32 val) {
...
static inline void RTW89_SET_FWCMD_CXROLE_ROLE_ADHOC_MASTER(void *cmd,
    u16 val) {
...
static inline void RTW89_SET_FWCMD_CXROLE_ACT_CONNECTED(void *cmd, u8 val,
    int n, u8 offset) {
...
static inline void RTW89_SET_FWCMD_CXROLE_ACT_CLIENT_PS(void *cmd, u8 val,
    int n, u8 offset) {
...
static inline void RTW89_SET_FWCMD_CXROLE_ACT_TX_LVL(void *cmd, u16 val, int n,
    u8 offset) {
  le16p_replace_bits((__le16 *) ((u8 *) cmd + (10 + (12 + offset) * n)), val, GENMASK(
      15,
      0));
}
...
static inline void RTW89_SET_FWCMD_CXROLE_ACT_RX_LVL(void *cmd, u16 val, int n,
    u8 offset) {
  le16p_replace_bits((__le16 *) ((u8 *) cmd + (12 + (12 + offset) * n)), val, GENMASK(
      15,
      0));
}
...
static inline void RTW89_SET_FWCMD_CXROLE_ACT_TX_RATE(void *cmd, u16 val, int n,
    u8 offset) {
  le16p_replace_bits((__le16 *) ((u8 *) cmd + (14 + (12 + offset) * n)), val, GENMASK(
      15,
      0));
}
...
static inline void RTW89_SET_FWCMD_CXROLE_ACT_RX_RATE(void *cmd, u16 val, int n,
    u8 offset) {
  le16p_replace_bits((__le16 *) ((u8 *) cmd + (16 + (12 + offset) * n)), val, GENMASK(
      15,
      0));
}

static inline void RTW89_SET_FWCMD_CXROLE_ACT_NOA_DUR(void *cmd, u32 val, int n,
    u8 offset) {
  le32p_replace_bits((__le32 *) ((u8 *) cmd + (20 + (12 + offset) * n)), val, GENMASK(
      31,
      0));
}

static inline void RTW89_SET_FWCMD_CXROLE_ACT_CONNECTED_V2(void *cmd, u8 val,
    int n, u8 offset) {
  u8p_replace_bits((u8 *) cmd + (6 + (12 + offset) * n), val, BIT(0));
}

static inline void RTW89_SET_FWCMD_CXROLE_ACT_PID_V2(void *cmd, u8 val, int n,
    u8 offset) {
  u8p_replace_bits((u8 *) cmd + (6 + (12 + offset) * n), val, GENMASK(3, 1));
}

static inline void RTW89_SET_FWCMD_CXROLE_ACT_PHY_V2(void *cmd, u8 val, int n,
    u8 offset) {
  u8p_replace_bits((u8 *) cmd + (6 + (12 + offset) * n), val, BIT(4));
}

static inline void RTW89_SET_FWCMD_CXROLE_ACT_NOA_V2(void *cmd, u8 val, int n,
    u8 offset) {
  u8p_replace_bits((u8 *) cmd + (6 + (12 + offset) * n), val, BIT(5));
}

static inline void RTW89_SET_FWCMD_CXROLE_ACT_BAND_V2(void *cmd, u8 val, int n,
    u8 offset) {
  u8p_replace_bits((u8 *) cmd + (6 + (12 + offset) * n), val, GENMASK(7, 6));
}

static inline void RTW89_SET_FWCMD_CXROLE_ACT_CLIENT_PS_V2(void *cmd, u8 val,
    int n, u8 offset) {
  u8p_replace_bits((u8 *) cmd + (7 + (12 + offset) * n), val, BIT(0));
}

static inline void RTW89_SET_FWCMD_CXROLE_ACT_BW_V2(void *cmd, u8 val, int n,
    u8 offset) {
  u8p_replace_bits((u8 *) cmd + (7 + (12 + offset) * n), val, GENMASK(7, 1));
}

static inline void RTW89_SET_FWCMD_CXROLE_ACT_ROLE_V2(void *cmd, u8 val, int n,
    u8 offset) {
  u8p_replace_bits((u8 *) cmd + (8 + (12 + offset) * n), val, GENMASK(7, 0));
}

static inline void RTW89_SET_FWCMD_CXROLE_ACT_CH_V2(void *cmd, u8 val, int n,
    u8 offset) {
  u8p_replace_bits((u8 *) cmd + (9 + (12 + offset) * n), val, GENMASK(7, 0));
}

static inline void RTW89_SET_FWCMD_CXROLE_ACT_NOA_DUR_V2(void *cmd, u32 val,
    int n, u8 offset) {
  le32p_replace_bits((__le32 *) ((u8 *) cmd + (10 + (12 + offset) * n)), val, GENMASK(
      31,
      0));
}

static inline void RTW89_SET_FWCMD_CXROLE_MROLE_TYPE(void *cmd, u32 val,
    u8 offset) {
  le32p_replace_bits((__le32 *) ((u8 *) cmd + offset), val, GENMASK(31, 0));
}

static inline void RTW89_SET_FWCMD_CXROLE_MROLE_NOA(void *cmd, u32 val,
    u8 offset) {
  le32p_replace_bits((__le32 *) ((u8 *) cmd + offset + 4), val, GENMASK(31, 0));
}

static inline void RTW89_SET_FWCMD_CXROLE_DBCC_EN(void *cmd, u32 val,
    u8 offset) {
  le32p_replace_bits((__le32 *) ((u8 *) cmd + offset + 8), val, BIT(0));
}

static inline void RTW89_SET_FWCMD_CXROLE_DBCC_CHG(void *cmd, u32 val,
    u8 offset) {
  le32p_replace_bits((__le32 *) ((u8 *) cmd + offset + 8), val, BIT(1));
}

static inline void RTW89_SET_FWCMD_CXROLE_DBCC_2G_PHY(void *cmd, u32 val,
    u8 offset) {
  le32p_replace_bits((__le32 *) ((u8 *) cmd + offset + 8), val, GENMASK(3, 2));
}

static inline void RTW89_SET_FWCMD_CXROLE_LINK_MODE_CHG(void *cmd, u32 val,
    u8 offset) {
...
static inline void RTW89_SET_FWCMD_START_MCC_OLD_GROUP_ACTION(void *cmd,
    u32 val) {
...
static inline void RTW89_SET_FWCMD_START_MCC_NOTIFY_RXDBG_EN(void *cmd,
    u32 val) {
  le32p_replace_bits((__le32 *) cmd, val, BIT(21));
}
...
static inline void RTW89_SET_FWCMD_DEL_MCC_GROUP_PREV_GROUPS(void *cmd,
    u32 val) {
  le32p_replace_bits((__le32 *) cmd, val, BIT(2));
}
...
static inline void RTW89_SET_FWCMD_MCC_MACID_BITMAP_BITMAP_LENGTH(void *cmd,
    u32 val) {
  le32p_replace_bits((__le32 *) cmd, val, GENMASK(23, 16));
}
...
static inline void RTW89_SET_FWCMD_MCC_SET_DURATION_MACID_X(void *cmd,
    u32 val) {
  le32p_replace_bits((__le32 *) cmd, val, GENMASK(23, 16));
}

static inline void RTW89_SET_FWCMD_MCC_SET_DURATION_MACID_Y(void *cmd,
    u32 val) {
  le32p_replace_bits((__le32 *) cmd, val, GENMASK(31, 24));
}
...
static
inline void RTW89_SET_FWCMD_MCC_SET_DURATION_START_TSF_HIGH(void *cmd,
    u32 val) {
  le32p_replace_bits((__le32 *) cmd + 2, val, GENMASK(31, 0));
}
...
static_assert(sizeof(struct rtw89_mac_mcc_tsf_rpt)
...
static_assert(sizeof(struct rtw89_mac_mrc_tsf_rpt)
    <= RTW89_COMPLETION_BUF_SIZE);
...
#define RTW89_SCANOFLD_WAIT_COND_ADD_CH RTW89_FW_OFLD_WAIT_COND(0, \
    H2C_FUNC_ADD_SCANOFLD_CH)

#define RTW89_SCANOFLD_WAIT_COND_START RTW89_FW_OFLD_WAIT_COND(0, \
    H2C_FUNC_SCANOFLD)
#define RTW89_SCANOFLD_WAIT_COND_STOP RTW89_FW_OFLD_WAIT_COND(1, \
    H2C_FUNC_SCANOFLD)
#define RTW89_SCANOFLD_BE_WAIT_COND_START RTW89_FW_OFLD_WAIT_COND(0, \
    H2C_FUNC_SCANOFLD_BE)
#define RTW89_SCANOFLD_BE_WAIT_COND_STOP RTW89_FW_OFLD_WAIT_COND(1, \
    H2C_FUNC_SCANOFLD_BE)
...
int rtw89_fw_check_rdy(struct rtw89_dev *rtwdev,
    enum rtw89_fwdl_check_type type);
int rtw89_fw_recognize(struct rtw89_dev *rtwdev);
int rtw89_fw_recognize_elements(struct rtw89_dev *rtwdev);
const struct firmware *rtw89_early_fw_feature_recognize(struct device *device,
...
int rtw89_fw_h2c_rf_txgapk(struct rtw89_dev *rtwdev,
    enum rtw89_phy_idx phy_idx);
...
void rtw89_fw_release_general_pkt_list(struct rtw89_dev *rtwdev,
    bool notify_fw);
...
int rtw89_fw_h2c_lps_ch_info(struct rtw89_dev *rtwdev,
    struct rtw89_vif *rtwvif);
struct sk_buff *rtw89_fw_h2c_alloc_skb_with_hdr(struct rtw89_dev *rtwdev,
    u32 len);
struct sk_buff *rtw89_fw_h2c_alloc_skb_no_hdr(struct rtw89_dev *rtwdev,
    u32 len);
