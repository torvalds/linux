...
static const u32 rtw8851b_backup_bb_regs[] = {
  0xc0d4, 0xc0d8, 0xc0c4, 0xc0ec, 0xc0e8
};
...
static void _rxbb_ofst_swap(struct rtw89_dev *rtwdev, enum rtw89_rf_path path,
    u8 rf_mode) {
  u32 val, val_i, val_q;
...
static void _set_rx_dck(struct rtw89_dev *rtwdev, enum rtw89_rf_path path,
    u8 rf_mode) {
  u32 val;
  int ret;
...
static void _dpk_kset_query(struct rtw89_dev *rtwdev, enum rtw89_rf_path path) {
  ...
  dpk->cur_k_set
    = rtw89_phy_read32_mask(rtwdev, R_RPT_PER + (path << 8),
      B_RPT_PER_KSET) - 1;
}
...
static void _dpk_rf_setting(struct rtw89_dev *rtwdev, enum rtw89_rf_path path,
    u8 kidx) {
  struct rtw89_dpk_info *dpk = &rtwdev->dpk;
...
static void _dpk_gain_normalize(struct rtw89_dev *rtwdev,
