...
static inline struct rtw89_pci_rx_bd_32 *RTW89_PCI_RX_BD(
    struct rtw89_pci_rx_ring *rx_ring, u32 idx) {
...
static inline void rtw89_pci_rxbd_increase(struct rtw89_pci_rx_ring *rx_ring,
    u32 cnt) {
  struct rtw89_pci_dma_ring *bd_ring = &rx_ring->bd_ring;
  bd_ring->wp += cnt;
...
static inline struct rtw89_pci_tx_bd_32 *rtw89_pci_get_next_txbd(
...
static inline struct rtw89_pci_tx_wd *rtw89_pci_dequeue_txwd(
    struct rtw89_pci_tx_ring *tx_ring) {
...
static inline void rtw89_pci_enqueue_txwd(struct rtw89_pci_tx_ring *tx_ring,
    struct rtw89_pci_tx_wd *txwd) {
  struct rtw89_pci_tx_wd_ring *wd_ring = &tx_ring->wd_ring;
...
static inline
void rtw89_chip_enable_intr(struct rtw89_dev *rtwdev,
    struct rtw89_pci *rtwpci) {
  const struct rtw89_pci_info *info = rtwdev->pci_info;
...
static inline
void rtw89_chip_disable_intr(struct rtw89_dev *rtwdev,
    struct rtw89_pci *rtwpci) {
  const struct rtw89_pci_info *info = rtwdev->pci_info;
...
static inline void rtw89_pci_ctrl_txdma_ch(struct rtw89_dev *rtwdev,
    bool enable) {
  const struct rtw89_pci_info *info = rtwdev->pci_info;
  const struct rtw89_pci_gen_def *gen_def = info->gen_def;
...
static inline void rtw89_pci_ctrl_txdma_fw_ch(struct rtw89_dev *rtwdev,
    bool enable) {
  const struct rtw89_pci_info *info = rtwdev->pci_info;
  const struct rtw89_pci_gen_def *gen_def = info->gen_def;
