...
static void rtw8852a_efuse_parsing_tssi(struct rtw89_dev *rtwdev,
  ...
  struct rtw8852a_tssi_offset *ofst[] = {
...
static void rtw8852a_phycap_parsing_tssi(struct rtw89_dev *rtwdev,
    u8 *phycap_map) {
  struct rtw89_tssi_info *tssi = &rtwdev->tssi;
  static const u32 tssi_trim_addr[RF_PATH_NUM_8852A] = {
    0x5D6, 0x5AB
  };
...
static void rtw8852a_phycap_parsing_thermal_trim(struct rtw89_dev *rtwdev,
  ...
  static const u32 thm_trim_addr[RF_PATH_NUM_8852A] = {
    0x5DF, 0x5DC
  };
  u32 addr = rtwdev->chip->phycap_addr;
  u8 i;
...
static void rtw8852a_phycap_parsing_pa_bias_trim(struct rtw89_dev *rtwdev,
    u8 *phycap_map) {
  struct rtw89_power_trim_info *info = &rtwdev->pwr_trim;
  static const u32 pabias_trim_addr[RF_PATH_NUM_8852A] = {
    0x5DE, 0x5DB
  };
  u32 addr = rtwdev->chip->phycap_addr;
  u8 i;
...
static void rtw8852a_ctrl_bw(struct rtw89_dev *rtwdev, u8 pri_ch, u8 bw,
    enum rtw89_phy_idx phy_idx) {
  /* Switch bandwidth */
  switch (bw) {
    case RTW89_CHANNEL_WIDTH_5:
...
static void rtw8852a_set_txpwr_ref(struct rtw89_dev *rtwdev,
    enum rtw89_phy_idx phy_idx) {
  static const u32 addr[RF_PATH_NUM_8852A] = {
    0x5800, 0x7800
  };
...
static int rtw8852a_init_txpwr_unit(struct rtw89_dev *rtwdev,
    enum rtw89_phy_idx phy_idx) {
  int ret;
...
static u8 rtw8852a_get_thermal(struct rtw89_dev *rtwdev,
...
static
void rtw8852a_set_trx_mask(struct rtw89_dev *rtwdev, u8 path, u8 group,
    u32 val) {
...
static void rtw8852a_btc_set_wl_txpwr_ctrl(struct rtw89_dev *rtwdev,
    u32 txpwr_val) {
