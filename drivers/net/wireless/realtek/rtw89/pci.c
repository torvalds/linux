...
static void rtw89_pci_ctrl_txdma_fw_ch_ax(struct rtw89_dev *rtwdev,
    bool enable) {
  const struct rtw89_pci_info *info = rtwdev->pci_info;
  const struct rtw89_reg_def *dma_stop1 = &info->dma_stop1;
  if (enable) {
...
static bool rtw89_skb_put_rx_data(struct rtw89_dev *rtwdev, bool fs, bool ls,
    struct sk_buff *new,
...
static u32 rtw89_pci_rxbd_deliver_skbs(struct rtw89_dev *rtwdev,
  ...
  ret
    = rtw89_pci_sync_skb_for_device_and_validate_rx_info(rtwdev, rx_ring, skb);
  if (ret) {
  ...
  if (fs) {
    ...
    if (desc_info->ready) {
      rtw89_warn(rtwdev,
          "desc info should not be ready before first segment start\n");
      goto err_sync_device;
    }
  ...
  if (!rtw89_skb_put_rx_data(rtwdev, fs, ls, new, skb, offset, rx_info,
      desc_info)) {
    goto err_sync_device;
  }
...
static void rtw89_pci_reclaim_txbd(struct rtw89_dev *rtwdev,
    struct rtw89_pci_tx_ring *tx_ring) {
...
void rtw89_pci_recognize_intrs(struct rtw89_dev *rtwdev,
  ...
  isrs->halt_c2h_isrs
    = rtw89_read32(rtwdev, R_AX_HISR0) & rtwpci->halt_c2h_intrs;
...
void rtw89_pci_recognize_intrs_v1(struct rtw89_dev *rtwdev,
    ...
    struct rtw89_pci_isrs *isrs) {
  isrs->ind_isrs
    = rtw89_read32(rtwdev, R_AX_PCIE_HISR00_V1) & rtwpci->ind_intrs;
...
void rtw89_pci_disable_intr(struct rtw89_dev *rtwdev,
    struct rtw89_pci *rtwpci) {
...
void rtw89_pci_enable_intr_v1(struct rtw89_dev *rtwdev,
    struct rtw89_pci *rtwpci) {
...
void rtw89_pci_disable_intr_v1(struct rtw89_dev *rtwdev,
    struct rtw89_pci *rtwpci) {
...
void rtw89_pci_enable_intr_v2(struct rtw89_dev *rtwdev,
    struct rtw89_pci *rtwpci) {
...
void rtw89_pci_disable_intr_v2(struct rtw89_dev *rtwdev,
    struct rtw89_pci *rtwpci) {
...
static void __rtw89_pci_tx_kick_off(struct rtw89_dev *rtwdev,
    struct rtw89_pci_tx_ring *tx_ring) {
  struct rtw89_pci *rtwpci = (struct rtw89_pci *) rtwdev->priv;
  struct rtw89_pci_dma_ring *bd_ring = &tx_ring->bd_ring;
  u32 host_idx, addr;
...
static void rtw89_pci_tx_bd_ring_update(struct rtw89_dev *rtwdev,
    struct rtw89_pci_tx_ring *tx_ring,
    int n_txbd) {
  struct rtw89_pci_dma_ring *bd_ring = &tx_ring->bd_ring;
  u32 host_idx, len;
...
static int rtw89_pci_tx_write(struct rtw89_dev *rtwdev,
    struct rtw89_core_tx_request *tx_req,
    u8 txch) {
  struct rtw89_pci *rtwpci = (struct rtw89_pci *) rtwdev->priv;
  struct rtw89_pci_tx_ring *tx_ring;
...
static int rtw89_pci_ops_tx_write(struct rtw89_dev *rtwdev,
    struct rtw89_core_tx_request *tx_req) {
  struct rtw89_tx_desc_info *desc_info = &tx_req->desc_info;
  int ret;
...
static void rtw89_pci_ops_switch_mode(struct rtw89_dev *rtwdev,
    bool low_power) {
...
static void rtw89_pci_ops_write16(struct rtw89_dev *rtwdev, u32 addr,
    u16 data) {
  struct rtw89_pci *rtwpci = (struct rtw89_pci *) rtwdev->priv;
  writew(data, rtwpci->mmap + addr);
}

static void rtw89_pci_ops_write32(struct rtw89_dev *rtwdev, u32 addr,
    u32 data) {
  struct rtw89_pci *rtwpci = (struct rtw89_pci *) rtwdev->priv;
...
static int rtw89_pci_check_mdio(struct rtw89_dev *rtwdev, u8 addr, u8 speed,
    u16 rw_bit) {
  u16 val;
...
static int rtw89_read16_mdio(struct rtw89_dev *rtwdev, u8 addr, u8 speed,
    u16 *val) {
  int ret;
...
static int rtw89_write16_mdio(struct rtw89_dev *rtwdev, u8 addr, u16 data,
    u8 speed) {
  int ret;
...
static int rtw89_write16_mdio_mask(struct rtw89_dev *rtwdev, u8 addr, u16 mask,
    u16 data, u8 speed) {
  u32 shift;
  int ret;
  u16 val;
...
static int rtw89_write16_mdio_set(struct rtw89_dev *rtwdev, u8 addr, u16 mask,
    u8 speed) {
  int ret;
  u16 val;
  ret = rtw89_read16_mdio(rtwdev, addr, speed, &val);
...
static int rtw89_write16_mdio_clr(struct rtw89_dev *rtwdev, u8 addr, u16 mask,
    u8 speed) {
  int ret;
  u16 val;
  ret = rtw89_read16_mdio(rtwdev, addr, speed, &val);
...
static int __get_target(struct rtw89_dev *rtwdev, u16 *target,
...
static int rtw89_pci_auto_refclk_cal(struct rtw89_dev *rtwdev, bool autook_en) {
  ...
  rtw89_debug(rtwdev, RTW89_DBG_HCI,
      "[TRACE]target = 0x%X, div = 0x%X, margin = 0x%X\n",
      tar, div_set, mgn_set);
  ...
  /* Enable function */
  ret
    = rtw89_write16_mdio_set(rtwdev, RAC_CTRL_PPR_V1, B_AX_CALIB_EN, phy_rate);
  if (ret) {
    rtw89_err(rtwdev, "[ERR]mdio_w16_pcie %X\n", RAC_CTRL_PPR_V1);
    goto end;
  }
...
static void rtw89_pci_set_io_rcy(struct rtw89_dev *rtwdev) {
  ...
  if (info->io_rcy_en == MAC_AX_PCIE_ENABLE) {
    ...
    rtw89_write32_set(rtwdev, R_AX_PCIE_IO_RCY_M1,
        B_AX_PCIE_IO_RCY_WDT_MODE_M1);
    rtw89_write32_set(rtwdev, R_AX_PCIE_IO_RCY_M2,
        B_AX_PCIE_IO_RCY_WDT_MODE_M2);
    rtw89_write32_set(rtwdev, R_AX_PCIE_IO_RCY_E0,
        B_AX_PCIE_IO_RCY_WDT_MODE_E0);
  } else {
    rtw89_write32_clr(rtwdev, R_AX_PCIE_IO_RCY_M1,
        B_AX_PCIE_IO_RCY_WDT_MODE_M1);
    rtw89_write32_clr(rtwdev, R_AX_PCIE_IO_RCY_M2,
        B_AX_PCIE_IO_RCY_WDT_MODE_M2);
    rtw89_write32_clr(rtwdev, R_AX_PCIE_IO_RCY_E0,
        B_AX_PCIE_IO_RCY_WDT_MODE_E0);
  }
...
static int rtw89_pci_mode_op(struct rtw89_dev *rtwdev) {
  ...
  if (chip_id == RTL8852A || chip_id == RTL8852B) {
    rtw89_write32_mask(rtwdev, R_AX_PCIE_INIT_CFG1, B_AX_PCIE_MAX_TXDMA_MASK,
        tx_burst);
    rtw89_write32_mask(rtwdev, R_AX_PCIE_INIT_CFG1, B_AX_PCIE_MAX_RXDMA_MASK,
        rx_burst);
  } else if (chip_id == RTL8852C) {
    rtw89_write32_mask(rtwdev, R_AX_HAXI_INIT_CFG1, B_AX_HAXI_MAX_TXDMA_MASK,
        tx_burst);
    rtw89_write32_mask(rtwdev, R_AX_HAXI_INIT_CFG1, B_AX_HAXI_MAX_RXDMA_MASK,
        rx_burst);
  }
  if (chip_id == RTL8852A || chip_id == RTL8852B) {
...
static int rtw89_pci_napi_poll(struct napi_struct *napi, int budget) {
  ...
  int work_done;
  rtwdev->napi_budget_countdown = budget;
  rtw89_write32(rtwdev, gen_def->isr_clear_rpq.addr,
      gen_def->isr_clear_rpq.data);
  work_done = rtw89_pci_poll_rpq_dma(rtwdev, rtwpci,
      rtwdev->napi_budget_countdown);
  if (work_done == budget) {
    return budget;
  }
  rtw89_write32(rtwdev, gen_def->isr_clear_rxq.addr,
      gen_def->isr_clear_rxq.data);
  work_done += rtw89_pci_poll_rxq_dma(rtwdev, rtwpci,
      rtwdev->napi_budget_countdown);
