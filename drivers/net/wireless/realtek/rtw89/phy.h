...
static inline
enum rtw89_gain_offset rtw89_subband_to_gain_offset_band_of_ofdm(
...
static inline
enum rtw89_phy_bb_gain_band rtw89_subband_to_bb_gain_band(
    enum rtw89_subband subband) {
  switch (subband) {
    default:
    case RTW89_CH_2G:
...
static inline
enum rtw89_phy_gain_band_be rtw89_subband_to_gain_band_be(
    enum rtw89_subband subband) {
  switch (subband) {
    default:
    case RTW89_CH_2G:
...
void rtw89_rfk_parser(struct rtw89_dev *rtwdev,
...
void rtw89_phy_ra_updata_sta(struct rtw89_dev *rtwdev,
