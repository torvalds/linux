...
static void rtw89_phy_cfg_bb_gain_error_be(struct rtw89_dev *rtwdev,
...
static void rtw89_phy_cfg_bb_rpl_ofst_be(struct rtw89_dev *rtwdev,
    union rtw89_phy_bb_gain_arg_be arg, u32 data) {
  struct rtw89_phy_bb_gain_info_be *gain = &rtwdev->bb_gain.be;
...
static void rtw89_phy_cfg_bb_gain_op1db_be(struct rtw89_dev *rtwdev,
    union rtw89_phy_bb_gain_arg_be arg, u32 data) {
  struct rtw89_phy_bb_gain_info_be *gain = &rtwdev->bb_gain.be;
  u8 bw_type = u8_get_bits(arg.path_bw, BB_GAIN_BW_BE);
  u8 path = u8_get_bits(arg.path_bw, BB_GAIN_PATH_BE);
...
static void rtw89_phy_config_bb_gain_be(struct rtw89_dev *rtwdev,
  ...
  union rtw89_phy_bb_gain_arg_be arg = {
    .addr = reg->addr
  };
...
static void rtw89_phy_bb_wrap_tpu_set_all(struct rtw89_dev *rtwdev,
  ...
  for (addr = R_BE_PWR_RATE_OFST_CTRL; addr <= R_BE_PWR_RATE_OFST_END;
      addr += 4) {
    rtw89_write32(rtwdev, addr, 0);
  }
...
static void rtw89_phy_ch_info_init_be(struct rtw89_dev *rtwdev) {
  ...
  rtw89_phy_set_phy_regs(rtwdev, R_CHINFO_ELM_SRC, B_CHINFO_ELM_BITMAP,
      0x40303);
...
static void fill_limit_nonbf_bf(struct rtw89_dev *rtwdev,
    s8 (*ptr)[RTW89_BF_NUM],
...
static void fill_limit_nonbf_bf_min(struct rtw89_dev *rtwdev,
    s8 (*ptr)[RTW89_BF_NUM],
