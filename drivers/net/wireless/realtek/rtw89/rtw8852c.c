...
static int rtw8852c_pwr_on_func(struct rtw89_dev *rtwdev) {
  ...
  rtw89_write32_mask(rtwdev, R_AX_LED1_FUNC_SEL,
      B_AX_PINMUX_EESK_FUNC_SEL_V1_MASK,
...
static void rtw8852c_efuse_parsing_tssi(struct rtw89_dev *rtwdev,
  ...
  struct rtw8852c_tssi_offset *ofst[] = {
...
static void rtw8852c_phycap_parsing_tssi(struct rtw89_dev *rtwdev,
    u8 *phycap_map) {
  struct rtw89_tssi_info *tssi = &rtwdev->tssi;
  static const u32 tssi_trim_addr[RF_PATH_NUM_8852C] = {
    0x5D6, 0x5AB
  };
  static const u32 tssi_trim_addr_6g[RF_PATH_NUM_8852C] = {
    0x5CE, 0x5A3
  };
...
static void rtw8852c_phycap_parsing_thermal_trim(struct rtw89_dev *rtwdev,
  ...
  static const u32 thm_trim_addr[RF_PATH_NUM_8852C] = {
    0x5DF, 0x5DC
  };
  u32 addr = rtwdev->chip->phycap_addr;
  u8 i;
...
static void rtw8852c_phycap_parsing_pa_bias_trim(struct rtw89_dev *rtwdev,
    u8 *phycap_map) {
  struct rtw89_power_trim_info *info = &rtwdev->pwr_trim;
  static const u32 pabias_trim_addr[RF_PATH_NUM_8852C] = {
    0x5DE, 0x5DB
  };
  u32 addr = rtwdev->chip->phycap_addr;
  u8 i;
...
static void rtw8852c_set_gain_offset(struct rtw89_dev *rtwdev,
  ...
  static const u32 rssi_ofst_addr[2] = {
    R_PATH0_G_TIA0_LNA6_OP1DB_V1,
    R_PATH1_G_TIA0_LNA6_OP1DB_V1
  };
  static const u32 rpl_mask[2] = {
    B_RPL_PATHA_MASK, B_RPL_PATHB_MASK
  };
  static const u32 rpl_tb_mask[2] = {
    B_RSSI_M_PATHA_MASK, B_RSSI_M_PATHB_MASK
  };
  ...
  rtw89_phy_write32_idx(rtwdev, R_RPL_PATHAB, rpl_mask[path], tmp & 0xff,
      phy_idx);
  rtw89_phy_write32_idx(rtwdev, R_RSSI_M_PATHAB, rpl_tb_mask[path], tmp & 0xff,
      phy_idx);
}
...
static void rtw8852c_ctrl_bw(struct rtw89_dev *rtwdev, u8 pri_ch, u8 bw,
    enum rtw89_phy_idx phy_idx) {
  u8 mod_sbw = 0;
  switch (bw) {
    case RTW89_CHANNEL_WIDTH_5:
...
static void rtw8852c_set_csi_tone_idx(struct rtw89_dev *rtwdev,
  ...
  rtw89_phy_write32_idx(rtwdev, R_SEG0CSI, B_SEG0CSI_IDX, csi_tone_idx,
      phy_idx);
...
static void rtw8852c_5m_mask(struct rtw89_dev *rtwdev,
  ...
  if (!mask_5m_en) {
    ...
    rtw89_phy_write32_idx(rtwdev, R_ASSIGN_SBD_OPT, B_ASSIGN_SBD_OPT_EN, 0x1,
        phy_idx);
  }
}
...
void rtw8852c_bb_gpio_trsw(struct rtw89_dev *rtwdev, enum rtw89_rf_path path,
  ...
  static const u32 path_cr_bases[] = {
    0x5868, 0x7868
  };
  u32 mask_ofst = 16;
  u32 cr;
  ...
  rtw89_phy_write32_mask(rtwdev, cr, (B_P0_TRSW_A | B_P0_TRSW_B) << mask_ofst,
        val);
}
...
static void rtw8852c_set_channel_bb(struct rtw89_dev *rtwdev,
    const struct rtw89_chan *chan,
    enum rtw89_phy_idx phy_idx) {
  static const u32 ru_alloc_msk[2] = {
    B_P80_AT_HIGH_FREQ_RU_ALLOC_PHY0,
...
static void rtw8852c_set_txpwr_ref(struct rtw89_dev *rtwdev,
    enum rtw89_phy_idx phy_idx) {
  static const u32 addr[RF_PATH_NUM_8852C] = {
    0x5800, 0x7800
  };
...
static void rtw8852c_init_tssi_ctrl(struct rtw89_dev *rtwdev,
    enum rtw89_phy_idx phy_idx) {
...
static int rtw8852c_init_txpwr_unit(struct rtw89_dev *rtwdev,
    enum rtw89_phy_idx phy_idx) {
  int ret;
...
static u8 rtw8852c_get_thermal(struct rtw89_dev *rtwdev,
...
static
void rtw8852c_set_trx_mask(struct rtw89_dev *rtwdev, u8 path, u8 group,
    u32 val) {
...
static void rtw8852c_btc_set_wl_txpwr_ctrl(struct rtw89_dev *rtwdev,
    u32 txpwr_val) {
  union rtw8852c_btc_wl_txpwr_ctrl arg = {
    .txpwr_val = txpwr_val
  };
  s32 val;
