...
static ssize_t rtw89_debug_priv_read_reg_select(struct file *filp,
...
static ssize_t rtw89_debug_priv_read_rf_select(struct file *filp,
    const char __user *user_buf,
    size_t count, loff_t *loff) {
  struct seq_file *m = (struct seq_file *) filp->private_data;
  struct rtw89_debugfs_priv *debugfs_priv = m->private;
...
static unsigned int __print_txpwr_ent(struct seq_file *m,
    const struct txpwr_ent *ent,
...
static ssize_t rtw89_debug_priv_mac_reg_dump_select(struct file *filp,
    const char __user *user_buf,
    size_t count, loff_t *loff) {
  struct seq_file *m = (struct seq_file *) filp->private_data;
  struct rtw89_debugfs_priv *debugfs_priv = m->private;
...
static ssize_t rtw89_debug_priv_mac_mem_dump_select(struct file *filp,
    const char __user *user_buf,
    size_t count, loff_t *loff) {
  struct seq_file *m = (struct seq_file *) filp->private_data;
  struct rtw89_debugfs_priv *debugfs_priv = m->private;
...
static int rtw89_debug_priv_mac_mem_dump_get(struct seq_file *m, void *v) {
  struct rtw89_debugfs_priv *debugfs_priv = m->private;
  struct rtw89_dev *rtwdev = debugfs_priv->rtwdev;
...
static ssize_t rtw89_debug_priv_mac_dbg_port_dump_select(struct file *filp,
    const char __user *user_buf,
    size_t count, loff_t *loff) {
  struct seq_file *m = (struct seq_file *) filp->private_data;
  struct rtw89_debugfs_priv *debugfs_priv = m->private;
...
static int rtw89_debug_priv_mac_dbg_port_dump_get(struct seq_file *m, void *v) {
  struct rtw89_debugfs_priv *debugfs_priv = m->private;
  struct rtw89_dev *rtwdev = debugfs_priv->rtwdev;
...
static int rtw89_debug_priv_early_h2c_get(struct seq_file *m, void *v) {
  struct rtw89_debugfs_priv *debugfs_priv = m->private;
  struct rtw89_dev *rtwdev = debugfs_priv->rtwdev;
...
static ssize_t rtw89_debug_priv_early_h2c_set(struct file *filp,
    const char __user *user_buf,
    size_t count, loff_t *loff) {
  struct seq_file *m = (struct seq_file *) filp->private_data;
  struct rtw89_debugfs_priv *debugfs_priv = m->private;
...
static int rtw89_debug_priv_fw_crash_get(struct seq_file *m, void *v) {
  struct rtw89_debugfs_priv *debugfs_priv = m->private;
  struct rtw89_dev *rtwdev = debugfs_priv->rtwdev;
  seq_printf(m, "%d\n",
...
static ssize_t rtw89_debug_priv_fw_crash_set(struct file *filp,
    const char __user *user_buf,
    size_t count, loff_t *loff) {
  struct seq_file *m = (struct seq_file *) filp->private_data;
  struct rtw89_debugfs_priv *debugfs_priv = m->private;
...
static void rtw89_debug_append_rx_rate(struct seq_file *m,
...
#define FIRST_RATE_ENUM(rate) {RTW89_HW_RATE_ ## rate, \
                               RTW89_HW_RATE_V1_ ## rate}
...
__printf(3, 4)
static void rtw89_dump_pkt_offload(struct seq_file *m,
...
static int rtw89_debug_priv_disable_dm_get(struct seq_file *m, void *v) {
  struct rtw89_debugfs_priv *debugfs_priv = m->private;
  struct rtw89_dev *rtwdev = debugfs_priv->rtwdev;
...
static ssize_t rtw89_debug_priv_disable_dm_set(struct file *filp,
    const char __user *user_buf,
    size_t count, loff_t *loff) {
  struct seq_file *m = (struct seq_file *) filp->private_data;
  struct rtw89_debugfs_priv *debugfs_priv = m->private;
