...
static void mt76_mac_process_tx_rate(struct ieee80211_tx_rate *txrate,
    u16 rate) {
...
void mt7601u_mac_set_short_preamble(struct mt7601u_dev *dev,
    bool short_preamb) {
  if (short_preamb) {
...
void mt7601u_mac_config_tsf(struct mt7601u_dev *dev, bool enable,
    int interval) {
...
static void mt76_mac_process_rate(struct ieee80211_rx_status *status,
    u16 rate) {
...
static void mt7601u_rx_monitor_beacon(struct mt7601u_dev *dev,
...
static enum mt76_cipher_type mt76_mac_get_key_info(
