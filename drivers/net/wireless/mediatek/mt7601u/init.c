...
static void mt7601u_set_wlan_state(struct mt7601u_dev *dev, u32 val,
    bool enable) {
  int i;
...
static void mt7601u_chip_onoff(struct mt7601u_dev *dev, bool enable,
    bool reset) {
  u32 val;
...
static int mt76_init_sband(struct mt7601u_dev *dev,
