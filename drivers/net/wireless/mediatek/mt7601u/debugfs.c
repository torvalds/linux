...
static int mt7601u_ampdu_stat_show(struct seq_file *file, void *data) {
...
static int mt7601u_eeprom_param_show(struct seq_file *file, void *data) {
  struct mt7601u_dev *dev = file->private;
