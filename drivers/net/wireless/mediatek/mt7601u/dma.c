...
static unsigned int ieee80211_get_hdrlen_from_buf(const u8 *data,
    unsigned len) {
...
static struct sk_buff *mt7601u_rx_skb_from_seg(struct mt7601u_dev *dev,
...
static void mt7601u_rx_process_entry(struct mt7601u_dev *dev,
...
static struct mt7601u_dma_buf_rx *mt7601u_rx_get_pending_entry(
