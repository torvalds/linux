...
static int mt7601u_efuse_read(struct mt7601u_dev *dev, u16 addr, u8 *data,
...
static void mt7601u_set_power_rate(struct power_per_rate *rate, s8 delta,
    u8 value) {
...
static void mt7601u_config_tx_power_per_rate(struct mt7601u_dev *dev,
    u8 *eeprom) {
  u32 val;
  s8 bw40_delta;
  int i;
