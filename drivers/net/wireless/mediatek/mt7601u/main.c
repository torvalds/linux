...
static void mt76_configure_filter(struct ieee80211_hw *hw,
...
static void mt7601u_bss_info_changed(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
...
static int mt7601u_sta_add(struct ieee80211_hw *hw, struct ieee80211_vif *vif,
...
static int mt7601u_sta_remove(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
    struct ieee80211_sta *sta) {
  struct mt7601u_dev *dev = hw->priv;
  struct mt76_sta *msta = (struct mt76_sta *) sta->drv_priv;
...
static void mt7601u_sta_notify(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
    enum sta_notify_cmd cmd, struct ieee80211_sta *sta) {
}

static void mt7601u_sw_scan(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
    const u8 *mac_addr) {
  struct mt7601u_dev *dev = hw->priv;
...
static void mt7601u_sw_scan_complete(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif) {
  struct mt7601u_dev *dev = hw->priv;
...
static int mt7601u_set_key(struct ieee80211_hw *hw, enum set_key_cmd cmd,
...
static void mt76_sta_rate_tbl_update(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
    struct ieee80211_sta *sta) {
  struct mt7601u_dev *dev = hw->priv;
  struct mt76_sta *msta = (struct mt76_sta *) sta->drv_priv;
