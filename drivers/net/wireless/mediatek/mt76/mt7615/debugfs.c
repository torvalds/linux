...
static int mt7615_reg_set(void *data, u64 val) {
...
static int mt7615_reg_get(void *data, u64 *val) {
  struct mt7615_dev *dev = data;
  mt7615_mutex_acquire(dev);
...
static int mt7615_radar_pattern_set(void *data, u64 val) {
  struct mt7615_dev *dev = data;
  int err;
...
static int mt7615_scs_set(void *data, u64 val) {
  struct mt7615_dev *dev = data;
...
static int mt7615_scs_get(void *data, u64 *val) {
  struct mt7615_dev *dev = data;
  *val = dev->phy.scs_en;
  return 0;
}
...
static int mt7615_pm_set(void *data, u64 val) {
  struct mt7615_dev *dev = data;
...
static int mt7615_pm_get(void *data, u64 *val) {
  struct mt7615_dev *dev = data;
  *val = dev->pm.enable;
  return 0;
}
...
static int mt7615_pm_stats(struct seq_file *s, void *data) {
...
static int mt7615_pm_idle_timeout_set(void *data, u64 val) {
  struct mt7615_dev *dev = data;
  dev->pm.idle_timeout = msecs_to_jiffies(val);
  return 0;
}

static int mt7615_pm_idle_timeout_get(void *data, u64 *val) {
  struct mt7615_dev *dev = data;
...
static int mt7615_dbdc_set(void *data, u64 val) {
  struct mt7615_dev *dev = data;
  if (!mt7615_wait_for_mcu_init(dev)) {
    return 0;
  }
...
static int mt7615_dbdc_get(void *data, u64 *val) {
  struct mt7615_dev *dev = data;
...
static int mt7615_fw_debug_set(void *data, u64 val) {
  struct mt7615_dev *dev = data;
  if (!mt7615_wait_for_mcu_init(dev)) {
    return 0;
  }
...
static int mt7615_fw_debug_get(void *data, u64 *val) {
  struct mt7615_dev *dev = data;
  *val = dev->fw_debug;
  return 0;
}
...
static int mt7615_reset_test_set(void *data, u64 val) {
  struct mt7615_dev *dev = data;
  struct sk_buff *skb;
  if (!mt7615_wait_for_mcu_init(dev)) {
    return 0;
...
static void mt7615_ampdu_stat_read_phy(struct mt7615_phy *phy,
...
static int mt7615_ampdu_stat_show(struct seq_file *file, void *data) {
  struct mt7615_dev *dev = file->private;
  mt7615_mutex_acquire(dev);
...
static void mt7615_radio_read_phy(struct mt7615_phy *phy, struct seq_file *s) {
  struct mt7615_dev *dev = dev_get_drvdata(s->private);
...
static int mt7615_radio_read(struct seq_file *s, void *data) {
  struct mt7615_dev *dev = dev_get_drvdata(s->private);
...
static int mt7615_queues_acq(struct seq_file *s, void *data) {
  struct mt7615_dev *dev = dev_get_drvdata(s->private);
  int i;
  mt7615_mutex_acquire(dev);
  for (i = 0; i < 16; i++) {
...
static int mt7615_queues_read(struct seq_file *s, void *data) {
  struct mt7615_dev *dev = dev_get_drvdata(s->private);
  struct {
    struct mt76_queue *q;
    char *queue;
...
static int mt7615_rf_reg_set(void *data, u64 val) {
  struct mt7615_dev *dev = data;
  mt7615_rf_wr(dev, dev->debugfs_rf_wf, dev->debugfs_rf_reg, val);
  return 0;
}

static int mt7615_rf_reg_get(void *data, u64 *val) {
  struct mt7615_dev *dev = data;
...
static ssize_t mt7615_ext_mac_addr_read(struct file *file, char __user *userbuf,
...
static ssize_t mt7615_ext_mac_addr_write(struct file *file,
  ...
  mt76_rmw_field(dev, MT_WF_RMAC_MORE(
      0), MT_WF_RMAC_MORE_MUAR_MODE, !!dev->muar_mask);
  return count;
}
...
static int mt7663s_sched_quota_read(struct seq_file *s, void *data) {
  struct mt7615_dev *dev = dev_get_drvdata(s->private);
