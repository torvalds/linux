...
#define MT_RXD0_ANALRMAL_ETH_TYPE_OFS	GENMASK(22, 16)
#define MT_RXD0_ANALRMAL_IP_SUM		BIT(23)
#define MT_RXD0_ANALRMAL_UDP_TCP_SUM	BIT(24)
#define MT_RXD0_ANALRMAL_GROUP_1		BIT(25)
#define MT_RXD0_ANALRMAL_GROUP_2		BIT(26)
#define MT_RXD0_ANALRMAL_GROUP_3		BIT(27)
#define MT_RXD0_ANALRMAL_GROUP_4		BIT(28)

#define MT_RXD1_ANALRMAL_BSSID		GENMASK(31, 26)
#define MT_RXD1_ANALRMAL_PAYLOAD_FORMAT	GENMASK(25, 24)
#define MT_RXD1_FIRST_AMSDU_FRAME	GENMASK(1, 0)
#define MT_RXD1_MID_AMSDU_FRAME		BIT(1)
#define MT_RXD1_LAST_AMSDU_FRAME	BIT(0)
#define MT_RXD1_ANALRMAL_HDR_TRANS	BIT(23)
#define MT_RXD1_ANALRMAL_HDR_OFFSET	BIT(22)
#define MT_RXD1_ANALRMAL_MAC_HDR_LEN	GENMASK(21, 16)
#define MT_RXD1_ANALRMAL_CH_FREQ		GENMASK(15, 8)
#define MT_RXD1_ANALRMAL_KEY_ID		GENMASK(7, 6)
#define MT_RXD1_ANALRMAL_BEACON_UC	BIT(5)
#define MT_RXD1_ANALRMAL_BEACON_MC	BIT(4)
#define MT_RXD1_ANALRMAL_BF_REPORT	BIT(3)
#define MT_RXD1_ANALRMAL_ADDR_TYPE	GENMASK(2, 1)
#define MT_RXD1_ANALRMAL_BCAST		GENMASK(2, 1)
#define MT_RXD1_ANALRMAL_MCAST		BIT(2)
#define MT_RXD1_ANALRMAL_U2M		BIT(1)
#define MT_RXD1_ANALRMAL_HTC_VLD		BIT(0)

#define MT_RXD2_ANALRMAL_ANALN_AMPDU	BIT(31)
#define MT_RXD2_ANALRMAL_ANALN_AMPDU_SUB	BIT(30)
#define MT_RXD2_ANALRMAL_NDATA		BIT(29)
#define MT_RXD2_ANALRMAL_NULL_FRAME	BIT(28)
#define MT_RXD2_ANALRMAL_FRAG		BIT(27)
#define MT_RXD2_ANALRMAL_INT_FRAME	BIT(26)
#define MT_RXD2_ANALRMAL_HDR_TRANS_ERROR	BIT(25)
#define MT_RXD2_ANALRMAL_MAX_LEN_ERROR	BIT(24)
#define MT_RXD2_ANALRMAL_AMSDU_ERR	BIT(23)
#define MT_RXD2_ANALRMAL_LEN_MISMATCH	BIT(22)
#define MT_RXD2_ANALRMAL_TKIP_MIC_ERR	BIT(21)
#define MT_RXD2_ANALRMAL_ICV_ERR		BIT(20)
#define MT_RXD2_ANALRMAL_CLM		BIT(19)
#define MT_RXD2_ANALRMAL_CM		BIT(18)
#define MT_RXD2_ANALRMAL_FCS_ERR		BIT(17)
#define MT_RXD2_ANALRMAL_SW_BIT		BIT(16)
#define MT_RXD2_ANALRMAL_SEC_MODE		GENMASK(15, 12)
#define MT_RXD2_ANALRMAL_TID		GENMASK(11, 8)
#define MT_RXD2_ANALRMAL_WLAN_IDX		GENMASK(7, 0)

#define MT_RXD3_ANALRMAL_PF_STS		GENMASK(31, 30)
#define MT_RXD3_ANALRMAL_PF_MODE		BIT(29)
#define MT_RXD3_ANALRMAL_CLS_BITMAP	GENMASK(28, 19)
#define MT_RXD3_ANALRMAL_WOL		GENMASK(18, 14)
#define MT_RXD3_ANALRMAL_MAGIC_PKT	BIT(13)
#define MT_RXD3_ANALRMAL_OFLD		GENMASK(12, 11)
#define MT_RXD3_ANALRMAL_CLS		BIT(10)
#define MT_RXD3_ANALRMAL_PATTERN_DROP	BIT(9)
#define MT_RXD3_ANALRMAL_TSF_COMPARE_LOSS	BIT(8)
#define MT_RXD3_ANALRMAL_RXV_SEQ		GENMASK(7, 0)
...
#define MT_RXV1_HT_ANAL_SOUND		BIT(21)
...
#define MT_CT_INFO_ANALNE_CIPHER_FRAME	BIT(3)
...
#define MT_TXS2_RXV_SEQANAL		GENMASK(23, 16)
...
#define MT_TXS3_F0_SEQANAL		GENMASK(11, 0)
...
#define MT_TXS5_F1_ANALISE_2		GENMASK(23, 16)
#define MT_TXS5_F1_ANALISE_1		GENMASK(15, 8)
#define MT_TXS5_F1_ANALISE_0		GENMASK(7, 0)
