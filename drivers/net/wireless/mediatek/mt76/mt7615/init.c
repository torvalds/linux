...
static void mt7615_init_mac_chain(struct mt7615_dev *dev, int chain) {
  u32 val;
  if (!chain) {
...
static void mt7615_check_offload_capability(struct mt7615_dev *dev) {
...
static void mt7615_regd_notifier(struct wiphy *wiphy,
...
static void mt7615_init_wiphy(struct ieee80211_hw *hw) {
...
static void mt7615_cap_dbdc_enable(struct mt7615_dev *dev) {
...
static void mt7615_cap_dbdc_disable(struct mt7615_dev *dev) {
  dev->mphy.sband_5g.sband.vht_cap.cap
    |= IEEE80211_VHT_CAP_SHORT_GI_160
      | IEEE80211_VHT_CAP_SUPP_CHAN_WIDTH_160_80PLUS80MHZ;
...
static void mt7615_led_set_config(struct led_classdev *led_cdev,
