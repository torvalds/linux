...
static int mt7615_mcu_send_message(struct mt76_dev *mdev, struct sk_buff *skb,
    int cmd, int *seq) {
...
static void mt7615_mcu_csa_finish(void *priv, u8 *mac,
...
static void mt7615_mcu_rx_csa_notify(struct mt7615_dev *dev,
    struct sk_buff *skb) {
...
static void mt7615_mcu_rx_radar_detected(struct mt7615_dev *dev,
    struct sk_buff *skb) {
  struct mt76_phy *mphy = &dev->mt76.phy;
...
static void mt7615_mcu_rx_log_message(struct mt7615_dev *dev,
    struct sk_buff *skb) {
...
static void mt7615_mcu_rx_ext_event(struct mt7615_dev *dev,
    struct sk_buff *skb) {
  struct mt7615_mcu_rxd *rxd = (struct mt7615_mcu_rxd *) skb->data;
  switch (rxd->ext_eid) {
...
static void mt7615_mcu_scan_event(struct mt7615_dev *dev, struct sk_buff *skb) {
...
static void mt7615_mcu_roc_event(struct mt7615_dev *dev, struct sk_buff *skb) {
...
static void mt7615_mcu_beacon_loss_event(struct mt7615_dev *dev,
    struct sk_buff *skb) {
...
static void mt7615_mcu_bss_event(struct mt7615_dev *dev, struct sk_buff *skb) {
...
static void mt7615_mcu_rx_unsolicited_event(struct mt7615_dev *dev,
    struct sk_buff *skb) {
  struct mt7615_mcu_rxd *rxd = (struct mt7615_mcu_rxd *) skb->data;
  switch (rxd->eid) {
    case MCU_EVENT_EXT:
...
static int mt7615_mcu_muar_config(struct mt7615_dev *dev,
    struct ieee80211_vif *vif,
...
static int mt7615_mcu_add_dev(struct mt7615_phy *phy, struct ieee80211_vif *vif,
    bool enable) {
  struct mt7615_vif *mvif = (struct mt7615_vif *) vif->drv_priv;
...
static int mt7615_mcu_add_beacon_offload(struct mt7615_dev *dev,
...
static int mt7615_mcu_ctrl_pm_state(struct mt7615_dev *dev, int band,
    int state) {
  return mt76_connac_mcu_set_pm(&dev->mt76, band, state);
}

static int mt7615_mcu_add_bss(struct mt7615_phy *phy, struct ieee80211_vif *vif,
...
static int mt7615_mcu_wtbl_tx_ba(struct mt7615_dev *dev,
...
static int mt7615_mcu_wtbl_rx_ba(struct mt7615_dev *dev,
    struct ieee80211_ampdu_params *params,
    bool enable) {
  struct mt7615_sta *msta = (struct mt7615_sta *) params->sta->drv_priv;
  struct mt7615_vif *mvif = msta->vif;
...
static int mt7615_mcu_wtbl_sta_add(struct mt7615_phy *phy,
    struct ieee80211_vif *vif,
    struct ieee80211_sta *sta, bool enable) {
  struct mt7615_vif *mvif = (struct mt7615_vif *) vif->drv_priv;
...
static int mt7615_mcu_wtbl_update_hdr_trans(struct mt7615_dev *dev,
    struct ieee80211_vif *vif,
...
static int mt7615_mcu_sta_ba(struct mt7615_dev *dev,
    struct ieee80211_ampdu_params *params,
    bool enable, bool tx) {
  struct mt7615_sta *msta = (struct mt7615_sta *) params->sta->drv_priv;
  struct mt7615_vif *mvif = msta->vif;
...
static int mt7615_mcu_sta_tx_ba(struct mt7615_dev *dev,
    struct ieee80211_ampdu_params *params,
    bool enable) {
  return mt7615_mcu_sta_ba(dev, params, enable, true);
}

static int mt7615_mcu_sta_rx_ba(struct mt7615_dev *dev,
    struct ieee80211_ampdu_params *params,
    bool enable) {
  return mt7615_mcu_sta_ba(dev, params, enable, false);
}

static int __mt7615_mcu_add_sta(struct mt76_phy *phy, struct ieee80211_vif *vif,
...
static int mt7615_mcu_add_sta(struct mt7615_phy *phy, struct ieee80211_vif *vif,
    struct ieee80211_sta *sta, bool enable) {
  return __mt7615_mcu_add_sta(phy->mt76, vif, sta, enable,
      MCU_EXT_CMD(STA_REC_UPDATE), false);
}

static int mt7615_mcu_sta_update_hdr_trans(struct mt7615_dev *dev,
    struct ieee80211_vif *vif,
    struct ieee80211_sta *sta) {
...
static int mt7615_mcu_uni_ctrl_pm_state(struct mt7615_dev *dev, int band,
    int state) {
  return 0;
}

static int mt7615_mcu_uni_add_beacon_offload(struct mt7615_dev *dev,
    struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
    bool enable) {
  struct mt7615_vif *mvif = (struct mt7615_vif *) vif->drv_priv;
...
static int mt7615_mcu_uni_add_dev(struct mt7615_phy *phy,
    struct ieee80211_vif *vif,
    bool enable) {
  struct mt7615_vif *mvif = (struct mt7615_vif *) vif->drv_priv;
...
static int mt7615_mcu_uni_add_bss(struct mt7615_phy *phy,
    struct ieee80211_vif *vif,
    struct ieee80211_sta *sta, bool enable) {
  struct mt7615_vif *mvif = (struct mt7615_vif *) vif->drv_priv;
...
static inline int mt7615_mcu_uni_add_sta(struct mt7615_phy *phy,
    struct ieee80211_vif *vif,
    struct ieee80211_sta *sta, bool enable) {
  return __mt7615_mcu_add_sta(phy->mt76, vif, sta, enable,
...
static int mt7615_mcu_uni_tx_ba(struct mt7615_dev *dev,
    struct ieee80211_ampdu_params *params,
    bool enable) {
...
static int mt7615_mcu_uni_rx_ba(struct mt7615_dev *dev,
    struct ieee80211_ampdu_params *params,
    bool enable) {
  struct mt7615_sta *msta = (struct mt7615_sta *) params->sta->drv_priv;
  struct mt7615_vif *mvif = msta->vif;
...
static int mt7615_mcu_sta_uni_update_hdr_trans(struct mt7615_dev *dev,
    struct ieee80211_vif *vif,
    struct ieee80211_sta *sta) {
  struct mt7615_sta *msta = (struct mt7615_sta *) sta->drv_priv;
  return mt76_connac_mcu_sta_update_hdr_trans(&dev->mt76,
...
static int mt7615_load_patch(struct mt7615_dev *dev, u32 addr,
    const char *name) {
...
static int mt7615_mcu_send_ram_firmware(struct mt7615_dev *dev,
...
static int mt7663_load_rom_patch(struct mt7615_dev *dev,
