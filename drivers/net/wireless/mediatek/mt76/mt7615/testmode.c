...
static int mt7615_tm_set_tx_power(struct mt7615_phy *phy) {
...
static void mt7615_tm_reg_backup_restore(struct mt7615_phy *phy) {
  struct mt7615_dev *dev = phy->dev;
...
static void mt7615_tm_init(struct mt7615_phy *phy) {
  struct mt7615_dev *dev = phy->dev;
...
static void mt7615_tm_set_rx_enable(struct mt7615_dev *dev, bool en) {
...
static void mt7615_tm_set_tx_antenna(struct mt7615_phy *phy, bool en) {
  struct mt7615_dev *dev = phy->dev;
...
static void mt7615_tm_set_tx_frames(struct mt7615_phy *phy, bool en) {
  struct mt7615_dev *dev = phy->dev;
...
static void mt7615_tm_update_params(struct mt7615_phy *phy, u32 changed) {
  struct mt7615_dev *dev = phy->dev;
  struct mt76_testmode_data *td = &phy->mt76->test;
...
static int mt7615_tm_set_state(struct mt76_phy *mphy,
...
static int mt7615_tm_set_params(struct mt76_phy *mphy, struct nlattr **tb,
...
static int mt7615_tm_dump_stats(struct mt76_phy *mphy, struct sk_buff *msg) {
  struct mt7615_phy *phy = mphy->priv;
  void *rx, *rssi;
  int i;
  ...
  if (nla_put_s32(msg, MT76_TM_RX_ATTR_FREQ_OFFSET,
      phy->test.last_freq_offset)) {
    return -ENOMEM;
  }
