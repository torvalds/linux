...
static void mt7615_write_fw_txp(struct mt7615_dev *dev,
...
static void mt7615_hif_int_event_trigger(struct mt7615_dev *dev, u8 event) {
...
static bool mt7615_wait_reset_state(struct mt7615_dev *dev, u32 state) {
  bool ret;
...
static void mt7615_update_vif_beacon(void *priv, u8 *mac,
...
static void mt7615_update_beacons(struct mt7615_dev *dev) {
