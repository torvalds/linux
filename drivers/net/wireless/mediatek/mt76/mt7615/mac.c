...
static enum mt76_cipher_type mt7615_mac_get_cipher(int cipher) {
  switch (cipher) {
...
static void mt7615_get_status_freq_info(struct mt7615_dev *dev,
...
static void mt7615_mac_update_rate_desc(struct mt7615_phy *phy,
    struct mt7615_sta *sta,
...
static int mt7615_mac_queue_rate_update(struct mt7615_phy *phy,
    struct mt7615_sta *sta,
    struct ieee80211_tx_rate *probe_rate,
    struct ieee80211_tx_rate *rates) {
  struct mt7615_dev *dev = phy->dev;
...
static int mt7615_mac_wtbl_update_key(struct mt7615_dev *dev,
    struct mt76_wcid *wcid,
    struct ieee80211_key_conf *key,
...
static int mt7615_mac_wtbl_update_pk(struct mt7615_dev *dev,
    struct mt76_wcid *wcid,
    enum mt76_cipher_type cipher, u16 cipher_mask,
    int keyidx) {
...
static void mt7615_mac_wtbl_update_cipher(struct mt7615_dev *dev,
    struct mt76_wcid *wcid,
    enum mt76_cipher_type cipher, u16 cipher_mask) {
...
static void mt7615_txwi_free(struct mt7615_dev *dev,
...
static void mt7615_mac_tx_free_token(struct mt7615_dev *dev, u16 token) {
  struct mt76_dev *mdev = &dev->mt76;
  struct mt76_txwi_cache *txwi;
...
static void mt7615_mac_set_sensitivity(struct mt7615_phy *phy, int val,
    bool ofdm) {
  struct mt7615_dev *dev = phy->dev;
  bool ext_phy = phy != &dev->phy;
...
static void mt7615_mac_set_default_sensitivity(struct mt7615_phy *phy) {
  /* ofdm */
...
static void mt7615_mac_adjust_sensitivity(struct mt7615_phy *phy,
...
static void mt7615_mac_scs_check(struct mt7615_phy *phy) {
  struct mt7615_dev *dev = phy->dev;
...
static u8 mt7615_phy_get_nf(struct mt7615_dev *dev, int idx) {
...
static void mt7615_phy_update_channel(struct mt76_phy *mphy, int idx) {
...
static void mt7615_mac_update_mib_stats(struct mt7615_phy *phy) {
  struct mt7615_dev *dev = phy->dev;
  struct mib_stats *mib = &phy->mib;
  bool ext_phy = phy != &dev->phy;
  int i, aggr = 0;
...
static int mt7615_dfs_init_radar_specs(struct mt7615_phy *phy) {
