...
static int mt7615_conf_tx(struct ieee80211_hw *hw, struct ieee80211_vif *vif,
...
static void mt7615_update_mu_group(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
...
static void mt7615_channel_switch_beacon(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
...
static int mt7615_ampdu_action(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
...
static int mt7615_get_stats(struct ieee80211_hw *hw,
...
static u64 mt7615_get_tsf(struct ieee80211_hw *hw, struct ieee80211_vif *vif) {
  struct mt7615_vif *mvif = (struct mt7615_vif *) vif->drv_priv;
  struct mt7615_dev *dev = mt7615_hw_dev(hw);
  union {
    u64 t64;
...
static void mt7615_set_tsf(struct ieee80211_hw *hw, struct ieee80211_vif *vif,
    u64 timestamp) {
  struct mt7615_vif *mvif = (struct mt7615_vif *) vif->drv_priv;
  struct mt7615_dev *dev = mt7615_hw_dev(hw);
  union {
...
static void mt7615_offset_tsf(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
    s64 timestamp) {
  struct mt7615_vif *mvif = (struct mt7615_vif *) vif->drv_priv;
  struct mt7615_dev *dev = mt7615_hw_dev(hw);
...
static void mt7615_set_coverage_class(struct ieee80211_hw *hw,
    s16 coverage_class) {
  struct mt7615_phy *phy = mt7615_hw_phy(hw);
  struct mt7615_dev *dev = phy->dev;
  mt7615_mutex_acquire(dev);
...
static int mt7615_set_antenna(struct ieee80211_hw *hw, u32 tx_ant, u32 rx_ant) {
  struct mt7615_dev *dev = mt7615_hw_dev(hw);
  struct mt7615_phy *phy = mt7615_hw_phy(hw);
...
static int mt7615_hw_scan(struct ieee80211_hw *hw, struct ieee80211_vif *vif,
...
static void mt7615_cancel_hw_scan(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif) {
  struct mt7615_dev *dev = mt7615_hw_dev(hw);
  struct mt76_phy *mphy = hw->priv;
  mt7615_mutex_acquire(dev);
...
static int mt7615_start_sched_scan(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
...
static int mt7615_stop_sched_scan(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif) {
  struct mt7615_dev *dev = mt7615_hw_dev(hw);
  struct mt76_phy *mphy = hw->priv;
  int err;
