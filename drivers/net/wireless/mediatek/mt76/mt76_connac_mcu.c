...
int mt76_connac_mcu_set_vif_ps(struct mt76_dev *dev,
...
static void mt76_connac_mcu_sta_amsdu_tlv(struct sk_buff *skb,
    struct ieee80211_sta *sta,
    struct ieee80211_vif *vif) {
  struct mt76_wcid *wcid = (struct mt76_wcid *) sta->drv_priv;
...
static void mt76_connac_mcu_sta_he_tlv(struct sk_buff *skb,
    struct ieee80211_sta *sta) {
...
static void mt76_connac_mcu_uni_bss_he_tlv(struct mt76_phy *phy,
    struct ieee80211_vif *vif,
    struct tlv *tlv) {
...
static void mt76_connac_mcu_build_sku(struct mt76_dev *dev, s8 *sku,
...
static int mt76_connac_mcu_rate_txpower_band(struct mt76_phy *phy,
    enum nl80211_band band) {
  struct mt76_dev *dev = phy->dev;
...
static void mt76_connac_mcu_key_iter(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
    struct ieee80211_sta *sta,
...
static int mt76_connac_mcu_set_arp_filter(struct mt76_dev *dev,
    struct ieee80211_vif *vif,
    bool suspend) {
  struct mt76_vif *mvif = (struct mt76_vif *) vif->drv_priv;
  struct {
...
static int mt76_connac_mcu_set_wow_pattern(struct mt76_dev *dev,
    struct ieee80211_vif *vif,
...
static int mt76_connac_mcu_sta_key_tlv(
...
static int mt76_connac_mcu_send_ram_firmware(struct mt76_dev *dev,
