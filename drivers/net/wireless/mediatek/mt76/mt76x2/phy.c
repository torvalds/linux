...
static void mt76x2_adjust_high_lna_gain(struct mt76x02_dev *dev, int reg,
    s8 offset) {
  s8 gain;
...
static void mt76x2_adjust_agc_gain(struct mt76x02_dev *dev, int reg,
    s8 offset) {
  s8 gain;
...
static int mt76x2_get_min_rate_power(struct mt76x02_rate_power *r) {
  int i;
  s8 ret = 0;
...
static void mt76x2_phy_set_gain_val(struct mt76x02_dev *dev) {
  u32 val;
  u8 gain_val[2];
