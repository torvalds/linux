...
static int mt76x2_eeprom_get_macaddr(struct mt76x02_dev *dev) {
  void *src = dev->mt76.eeprom.data + MT_EE_MAC_ADDR;
  memcpy(dev->mphy.macaddr, src, ETH_ALEN);
  return 0;
}

static bool mt76x2_has_cal_free_data(struct mt76x02_dev *dev, u8 *efuse) {
...
static void mt76x2_apply_cal_free_data(struct mt76x02_dev *dev, u8 *efuse) {
#define GROUP_5G(_id)                \
...
static int mt76x2_eeprom_load(struct mt76x02_dev *dev) {
  void *efuse;
  bool found;
  int ret;
...
static void mt76x2_set_rx_gain_group(struct mt76x02_dev *dev, u8 val) {
...
static void mt76x2_set_rssi_offset(struct mt76x02_dev *dev, int chain, u8 val) {
...
static enum mt76x2_cal_channel_group mt76x2_get_cal_channel_group(int channel) {
...
static u8 mt76x2_get_5g_rx_gain(struct mt76x02_dev *dev, u8 channel) {
...
static void mt76x2_get_power_info_2g(struct mt76x02_dev *dev,
...
static void mt76x2_get_power_info_5g(struct mt76x02_dev *dev,
    struct mt76x2_tx_power_info *t,
    struct ieee80211_channel *chan,
    int chain, int offset) {
  int channel = chan->hw_value;
