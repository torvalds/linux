...
static void mt7603_mac_stuck_beacon_recovery(struct mt7603_dev *dev) {
...
static void mt7603_update_beacon_iter(void *priv, u8 *mac,
...
static void mt7603_add_buffered_bc(void *priv, u8 *mac,
    struct ieee80211_vif *vif) {
