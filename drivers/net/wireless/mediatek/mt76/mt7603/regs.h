...
#define MT_WPDMA_DE			MT_HIF(0x244)
#define MT_WPDMA_DE_VALUE		GENMASK(17, 0)
#define MT_WPDMA_DE_SEL		BIT(27)
#define MT_WPDMA_DE_IDX		GENMASK(31, 28)
...
#define MT_MCU_DE_RESET		MT_PSE(0x16c)
#define MT_MCU_DE_RESET_PSE		BIT(0)
#define MT_MCU_DE_RESET_PSE_S	BIT(1)
#define MT_MCU_DE_RESET_QUEUES	GENMASK(6, 2)
