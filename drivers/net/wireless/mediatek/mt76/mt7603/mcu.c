...
static int mt7603_mcu_parse_response(struct mt76_dev *mdev, int cmd,
...
static int mt7603_mcu_skb_send_msg(struct mt76_dev *mdev, struct sk_buff *skb,
...
static int mt7603_mcu_init_download(struct mt7603_dev *dev, u32 addr, u32 len) {
  struct {
    __le32 addr;
    __le32 len;
    __le32 mode;
...
static int mt7603_mcu_start_firmware(struct mt7603_dev *dev, u32 addr) {
  struct {
    __le32 override;
    __le32 addr;
  } req = {
...
static int mt7603_mcu_restart(struct mt76_dev *dev) {
