...
static int mt7603_start(struct ieee80211_hw *hw) {
...
static void mt7603_stop(struct ieee80211_hw *hw) {
  struct mt7603_dev *dev = hw->priv;
...
static int mt7603_add_interface(struct ieee80211_hw *hw,
...
static void mt7603_remove_interface(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif) {
  struct mt7603_vif *mvif = (struct mt7603_vif *) vif->drv_priv;
...
static int mt7603_set_channel(struct ieee80211_hw *hw,
...
static int mt7603_config(struct ieee80211_hw *hw, u32 changed) {
  struct mt7603_dev *dev = hw->priv;
  int ret = 0;
...
static void mt7603_configure_filter(struct ieee80211_hw *hw,
...
static void mt7603_bss_info_changed(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
...
static void mt7603_ps_tx_list(struct mt7603_dev *dev,
...
static void mt7603_ps_set_more_data(struct sk_buff *skb) {
  struct ieee80211_hdr *hdr;
  hdr = (struct ieee80211_hdr *) &skb->data[MT_TXD_SIZE];
  hdr->frame_control |= cpu_to_le16(IEEE80211_FCTL_MOREDATA);
}

static void mt7603_release_buffered_frames(struct ieee80211_hw *hw,
    struct ieee80211_sta *sta,
...
static int mt7603_set_key(struct ieee80211_hw *hw, enum set_key_cmd cmd,
...
static int mt7603_conf_tx(struct ieee80211_hw *hw, struct ieee80211_vif *vif,
...
static void mt7603_flush(struct ieee80211_hw *hw, struct ieee80211_vif *vif,
    u32 queues, bool drop) {
}

static int mt7603_ampdu_action(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
...
static void mt7603_sta_rate_tbl_update(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
    struct ieee80211_sta *sta) {
  struct mt7603_dev *dev = hw->priv;
  struct mt7603_sta *msta = (struct mt7603_sta *) sta->drv_priv;
