...
static int mt7603_efuse_read(struct mt7603_dev *dev, u32 base, u16 addr,
    u8 *data) {
  u32 val;
  int i;
...
static int mt7603_efuse_init(struct mt7603_dev *dev) {
...
static bool mt7603_has_cal_free_data(struct mt7603_dev *dev, u8 *efuse) {
...
static void mt7603_apply_cal_free_data(struct mt7603_dev *dev, u8 *efuse) {
...
static int mt7603_eeprom_load(struct mt7603_dev *dev) {
  int ret;
