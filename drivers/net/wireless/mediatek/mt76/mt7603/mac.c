...
static u32 mt7603_ac_queue_mask0(u32 mask) {
  u32 ret = 0;
...
static void mt76_stop_tx_ac(struct mt7603_dev *dev, u32 mask) {
  mt76_set(dev, MT_WF_ARB_TX_STOP_0, mt7603_ac_queue_mask0(mask));
}

static void mt76_start_tx_ac(struct mt7603_dev *dev, u32 mask) {
...
static void mt7603_wtbl_update(struct mt7603_dev *dev, int idx, u32 mask) {
  mt76_rmw(dev, MT_WTBL_UPDATE, MT_WTBL_UPDATE_WLAN_IDX,
      FIELD_PREP(MT_WTBL_UPDATE_WLAN_IDX, idx) | mask);
  mt76_poll(dev, MT_WTBL_UPDATE, MT_WTBL_UPDATE_BUSY, 0, 5000);
}

static u32 mt7603_wtbl1_addr(int idx) {
  return MT_WTBL1_BASE + idx * MT_WTBL1_SIZE;
}

static u32 mt7603_wtbl2_addr(int idx) {
  /* Mapped to WTBL2 */
  return MT_PCIE_REMAP_BASE_1 + idx * MT_WTBL2_SIZE;
}

static u32 mt7603_wtbl3_addr(int idx) {
  u32 base = mt7603_wtbl2_addr(MT7603_WTBL_SIZE);
  return base + idx * MT_WTBL3_SIZE;
}

static u32 mt7603_wtbl4_addr(int idx) {
...
static void mt7603_wtbl_set_skip_tx(struct mt7603_dev *dev, int idx,
    bool enabled) {
  u32 addr = mt7603_wtbl1_addr(idx);
...
void mt7603_filter_tx(struct mt7603_dev *dev, int mac_idx, int idx,
    bool abort) {
  u32 flush_mask;
  int i, port, queue;
  if (abort) {
...
static struct mt76_wcid *mt7603_rx_get_wcid(struct mt7603_dev *dev, u8 idx,
    bool unicast) {
...
static u16 mt7603_mac_tx_rate_val(struct mt7603_dev *dev,
...
static enum mt76_cipher_type mt7603_mac_get_key_info(
...
static int mt7603_mac_write_txwi(struct mt7603_dev *dev, __le32 *txwi,
...
static bool mt7603_fill_txs(struct mt7603_dev *dev, struct mt7603_sta *sta,
...
static bool mt7603_mac_add_txs_skb(struct mt7603_dev *dev,
    struct mt7603_sta *sta, int pid,
    __le32 *txs_data) {
...
static bool wait_for_wpdma(struct mt7603_dev *dev) {
...
static bool mt7603_watchdog_check(struct mt7603_dev *dev, u8 *counter,
...
static void mt7603_edcca_check(struct mt7603_dev *dev) {
...
static void mt7603_adjust_sensitivity(struct mt7603_dev *dev) {
...
static void mt7603_false_cca_check(struct mt7603_dev *dev) {
