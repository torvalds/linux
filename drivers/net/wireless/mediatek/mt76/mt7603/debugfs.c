...
static int mt7603_reset_read(struct seq_file *s, void *data) {
...
static int mt7603_radio_read(struct seq_file *s, void *data) {
  struct mt7603_dev *dev = dev_get_drvdata(s->private);
...
static int mt7603_edcca_set(void *data, u64 val) {
...
static int mt7603_edcca_get(void *data, u64 *val) {
  struct mt7603_dev *dev = data;
...
static int mt7603_ampdu_stat_show(struct seq_file *file, void *data) {
