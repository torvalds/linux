...
static int mt7915_tm_set_tx_power(struct mt7915_phy *phy) {
...
static int mt7915_tm_set_freq_offset(struct mt7915_phy *phy, bool en, u32 val) {
  struct mt7915_dev *dev = phy->dev;
...
static int mt7915_tm_mode_ctrl(struct mt7915_dev *dev, bool enable) {
  struct {
    u8 format_id;
    bool enable;
    u8 rsv[2];
...
static int mt7915_tm_set_trx(struct mt7915_phy *phy, int type, bool en) {
  struct mt7915_dev *dev = phy->dev;
  struct mt7915_tm_cmd req = {
    .testmode_en = 1,
...
static int mt7915_tm_clean_hwq(struct mt7915_phy *phy, u8 wcid) {
  struct mt7915_dev *dev = phy->dev;
  struct mt7915_tm_cmd req = {
    .testmode_en = 1,
...
static int mt7915_tm_set_slot_time(struct mt7915_phy *phy, u8 slot_time,
    u8 sifs) {
  struct mt7915_dev *dev = phy->dev;
  struct mt7915_tm_cmd req = {
...
static int mt7915_tm_set_tam_arb(struct mt7915_phy *phy, bool enable, bool mu) {
  struct mt7915_dev *dev = phy->dev;
  u32 op_mode;
  if (!enable) {
...
static int mt7915_tm_set_wmm_qid(struct mt7915_phy *phy, u8 qid, u8 aifs,
    u8 cw_min,
    u16 cw_max, u16 txop) {
...
static int mt7915_tm_set_ipg_params(struct mt7915_phy *phy, u32 ipg, u8 mode) {
...
static int mt7915_tm_set_tx_len(struct mt7915_phy *phy, u32 tx_time) {
  struct mt76_phy *mphy = phy->mt76;
...
static void mt7915_tm_reg_backup_restore(struct mt7915_phy *phy) {
...
static void mt7915_tm_init(struct mt7915_phy *phy, bool en) {
  struct mt7915_dev *dev = phy->dev;
...
static void mt7915_tm_update_channel(struct mt7915_phy *phy) {
...
static void mt7915_tm_set_tx_frames(struct mt7915_phy *phy, bool en) {
...
static void mt7915_tm_set_rx_frames(struct mt7915_phy *phy, bool en) {
  mt7915_tm_set_trx(phy, TM_MAC_RX_RXV, false);
  if (en) {
    struct mt7915_dev *dev = phy->dev;
    mt7915_tm_update_channel(phy);
...
static int mt7915_tm_rf_switch_mode(struct mt7915_dev *dev, u32 oper) {
...
static int mt7915_tm_set_tx_cont(struct mt7915_phy *phy, bool en) {
...
static void mt7915_tm_update_params(struct mt7915_phy *phy, u32 changed) {
  struct mt76_testmode_data *td = &phy->mt76->test;
...
static int mt7915_tm_set_state(struct mt76_phy *mphy,
...
static int mt7915_tm_set_params(struct mt76_phy *mphy, struct nlattr **tb,
...
static int mt7915_tm_dump_stats(struct mt76_phy *mphy, struct sk_buff *msg) {
  struct mt7915_phy *phy = mphy->priv;
  struct mt7915_dev *dev = phy->dev;
  enum mt76_rxq_id q;
  void *rx, *rssi;
