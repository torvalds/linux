...
static int mt76_wmac_spi_read(struct mt7915_dev *dev, u8 adie, u32 addr,
    u32 *val) {
  int ret;
  u32 cur;
...
static int mt76_wmac_spi_write(struct mt7915_dev *dev, u8 adie, u32 addr,
    u32 val) {
  int ret;
  u32 cur;
  ret = read_poll_timeout(mt76_rr, cur, !(cur & MT_TOP_SPI_POLLING_BIT),
...
static int mt76_wmac_spi_rmw(struct mt7915_dev *dev, u8 adie,
...
static int mt7986_wmac_adie_efuse_read(struct mt7915_dev *dev, u8 adie,
    u32 addr, u32 *data) {
  int ret, temp;
  u32 val, mask;
...
static int mt7986_read_efuse_xo_trim_7976(struct mt7915_dev *dev, u8 adie,
...
static int mt7986_read_efuse_xo_trim_7975(struct mt7915_dev *dev, u8 adie,
    u32 addr, u32 *result) {
  int ret;
  u32 data;
  ret = mt7986_wmac_adie_efuse_read(dev, adie, addr, &data);
