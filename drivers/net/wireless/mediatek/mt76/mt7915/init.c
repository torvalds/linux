...
static int mt7915_thermal_get_max_throttle_state(
...
static int mt7915_thermal_get_cur_throttle_state(
    struct thermal_cooling_device *cdev,
    unsigned long *state) {
...
static int mt7915_thermal_set_cur_throttle_state(
    struct thermal_cooling_device *cdev,
    unsigned long state) {
  struct mt7915_phy *phy = cdev->devdata;
...
static void mt7915_regd_notifier(struct wiphy *wiphy,
...
static void mt7915_init_wiphy(struct mt7915_phy *phy) {
...
static void mt7915_mac_init_band(struct mt7915_dev *dev, u8 band) {
  u32 mask, set;
...
static void mt7915_init_led_mux(struct mt7915_dev *dev) {
  if (!IS_ENABLED(CONFIG_MT76_LEDS)) {
    return;
  }
  if (dev->dbdc_support) {
...
static struct mt7915_phy *mt7915_alloc_ext_phy(struct mt7915_dev *dev) {
...
static int mt7915_init_he_caps(struct mt7915_phy *phy, enum nl80211_band band,
