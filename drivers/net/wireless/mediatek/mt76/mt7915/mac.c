...
static void mt7915_wed_check_ppe(struct mt7915_dev *dev, struct mt76_queue *q,
...
static int mt7915_mac_fill_rx(struct mt7915_dev *dev, struct sk_buff *skb,
...
static void mt7915_mac_fill_rx_vector(struct mt7915_dev *dev,
    struct sk_buff *skb) {
...
static void mt7915_mac_write_txwi_tm(struct mt7915_phy *phy, __le32 *txwi,
    struct sk_buff *skb) {
#ifdef CONFIG_NL80211_TESTMODE
...
static void mt7915_mac_tx_free_prepare(struct mt7915_dev *dev) {
...
static void mt7915_mac_tx_free_done(struct mt7915_dev *dev,
...
static void mt7915_mac_tx_free(struct mt7915_dev *dev, void *data, int len) {
...
static void mt7915_mac_tx_free_v0(struct mt7915_dev *dev, void *data, int len) {
  struct mt76_connac_tx_free *free = data;
...
static u8 mt7915_phy_get_nf(struct mt7915_phy *phy, int idx) {
...
static bool mt7915_wait_reset_state(struct mt7915_dev *dev, u32 state) {
  bool ret;
...
static void mt7915_update_vif_beacon(void *priv, u8 *mac,
    struct ieee80211_vif *vif) {
...
static void mt7915_update_beacons(struct mt7915_dev *dev) {
...
static int mt7915_mac_restart(struct mt7915_dev *dev) {
...
static void mt7915_mac_full_reset(struct mt7915_dev *dev) {
  struct mt76_phy *ext_phy;
  int i;
  ext_phy = dev->mt76.phys[MT_BAND1];
...
static int mt7915_dfs_init_radar_specs(struct mt7915_phy *phy) {
...
static int mt7915_mac_twt_duration_align(int duration) {
  return duration << 8;
}

static u64 mt7915_mac_twt_sched_list_add(struct mt7915_dev *dev,
...
static bool mt7915_mac_twt_param_equal(struct mt7915_sta *msta,
    struct ieee80211_twt_params *twt_agrt) {
