...
static inline int mt7915_get_channel_group_5g(int channel, bool is_7976) {
  if (is_7976) {
    if (channel <= 64) {
      return 0;
    }
...
static inline int mt7915_get_channel_group_6g(int channel) {
  if (channel <= 29) {
    return 0;
  }
...
static inline bool mt7915_tssi_enabled(struct mt7915_dev *dev,
