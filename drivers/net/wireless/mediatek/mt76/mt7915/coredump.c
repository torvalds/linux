...
const struct mt7915_mem_region *mt7915_coredump_get_mem_layout(
    struct mt7915_dev *dev, u32 *num) {
...
static void mt7915_coredump_fw_state(struct mt7915_dev *dev,
...
static void mt7915_coredump_fw_trace(struct mt7915_dev *dev,
    struct mt7915_coredump *dump,
    bool exception) {
...
static void mt7915_coredump_fw_stack(struct mt7915_dev *dev,
    struct mt7915_coredump *dump,
    bool exception) {
  u32 oldest, i, idx;
...
static void mt7915_coredump_fw_task(struct mt7915_dev *dev,
    struct mt7915_coredump *dump) {
...
static void mt7915_coredump_fw_context(struct mt7915_dev *dev,
    struct mt7915_coredump *dump) {
  u32 count, idx, id;
