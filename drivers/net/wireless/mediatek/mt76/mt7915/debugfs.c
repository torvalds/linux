...
static int mt7915_implicit_txbf_set(void *data, u64 val) {
...
static int mt7915_implicit_txbf_get(void *data, u64 *val) {
  struct mt7915_dev *dev = data;
  *val = dev->ibf;
  return 0;
}
...
static ssize_t mt7915_sys_recovery_set(struct file *file,
...
static ssize_t mt7915_sys_recovery_get(struct file *file, char __user *user_buf,
    size_t count, loff_t *ppos) {
  struct mt7915_phy *phy = file->private_data;
  struct mt7915_dev *dev = phy->dev;
  char *buff;
...
static int mt7915_radar_trigger(void *data, u64 val) {
  struct mt7915_dev *dev = data;
  if (val > MT_RX_SEL2) {
    return -EINVAL;
  }
...
static int mt7915_muru_debug_set(void *data, u64 val) {
  struct mt7915_dev *dev = data;
  dev->muru_debug = val;
...
static int mt7915_muru_debug_get(void *data, u64 *val) {
  struct mt7915_dev *dev = data;
  *val = dev->muru_debug;
  return 0;
}
...
static int mt7915_rdd_monitor(struct seq_file *s, void *data) {
...
static int mt7915_fw_debug_wm_set(void *data, u64 val) {
  struct mt7915_dev *dev = data;
  enum {
    DEBUG_TXCMD = 62,
    DEBUG_CMD_RPT_TX,
...
static int mt7915_fw_debug_wm_get(void *data, u64 *val) {
  struct mt7915_dev *dev = data;
  *val = dev->fw.debug_wm;
  return 0;
}
...
static int mt7915_fw_debug_wa_set(void *data, u64 val) {
  struct mt7915_dev *dev = data;
  int ret;
...
static int mt7915_fw_debug_wa_get(void *data, u64 *val) {
  struct mt7915_dev *dev = data;
  *val = dev->fw.debug_wa;
  return 0;
}
...
static int mt7915_fw_debug_bin_set(void *data, u64 val) {
...
static int mt7915_fw_debug_bin_get(void *data, u64 *val) {
  struct mt7915_dev *dev = data;
...
static int mt7915_fw_util_wm_show(struct seq_file *file, void *data) {
...
static int mt7915_fw_util_wa_show(struct seq_file *file, void *data) {
  struct mt7915_dev *dev = file->private;
...
static void mt7915_ampdu_stat_read_phy(struct mt7915_phy *phy,
...
static void mt7915_txbf_stat_read_phy(struct mt7915_phy *phy,
    struct seq_file *s) {
...
static int mt7915_tx_stats_show(struct seq_file *file, void *data) {
  struct mt7915_phy *phy = file->private;
  struct mt7915_dev *dev = phy->dev;
  struct mt76_mib_stats *mib = &phy->mib;
  int i;
...
static void mt7915_hw_queue_read(struct seq_file *s, u32 size,
...
static void mt7915_sta_hw_queue_read(void *data, struct ieee80211_sta *sta) {
...
static int mt7915_hw_queues_show(struct seq_file *file, void *data) {
  struct mt7915_phy *phy = file->private;
  struct mt7915_dev *dev = phy->dev;
...
static int mt7915_xmit_queues_show(struct seq_file *file, void *data) {
  struct mt7915_phy *phy = file->private;
  struct mt7915_dev *dev = phy->dev;
  struct {
    struct mt76_queue *q;
...
static ssize_t mt7915_rate_txpower_get(struct file *file, char __user *user_buf,
    size_t count, loff_t *ppos) {
  struct mt7915_phy *phy = file->private_data;
  struct mt7915_dev *dev = phy->dev;
...
static ssize_t mt7915_rate_txpower_set(struct file *file,
    const char __user *user_buf,
    size_t count, loff_t *ppos) {
  struct mt7915_phy *phy = file->private_data;
  struct mt7915_dev *dev = phy->dev;
...
static int mt7915_twt_stats(struct seq_file *s, void *data) {
  struct mt7915_dev *dev = dev_get_drvdata(s->private);
 ...
 */
static int mt7915_rf_regval_get(void *data, u64 *val) {
  struct mt7915_dev *dev = data;
  u32 regval;
  int ret;
...
static int mt7915_rf_regval_set(void *data, u64 val) {
  struct mt7915_dev *dev = data;
  u32 val32 = val;
...
static void mt7915_debugfs_write_fwlog(struct mt7915_dev *dev, const void *hdr,
    int hdrlen,
...
void mt7915_debugfs_rx_fw_monitor(struct mt7915_dev *dev, const void *data,
    int len) {
  struct {
    __le32 magic;
    __le32 timestamp;
...
static int mt7915_queues_show(struct seq_file *s, void *data) {
