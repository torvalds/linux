...
static int mt76_init_sband(struct mt76_phy *phy, struct mt76_sband *msband,
...
static int mt76_init_sband_2g(struct mt76_phy *phy,
...
static int mt76_init_sband_5g(struct mt76_phy *phy,
    struct ieee80211_rate *rates,
...
static int mt76_init_sband_6g(struct mt76_phy *phy,
    struct ieee80211_rate *rates,
    int n_rates) {
...
static void mt76_check_sband(struct mt76_phy *phy, struct mt76_sband *msband,
...
static int mt76_phy_init(struct mt76_phy *phy, struct ieee80211_hw *hw) {
  struct mt76_dev *dev = phy->dev;
...
static struct mt76_channel_state *mt76_channel_state(struct mt76_phy *phy,
...
static void mt76_rx_convert(struct mt76_dev *dev, struct sk_buff *skb,
    struct ieee80211_hw **hw,
...
static void mt76_check_ccmp_pn(struct sk_buff *skb) {
  struct mt76_rx_status *status = (struct mt76_rx_status *) skb->cb;
...
static void mt76_airtime_report(struct mt76_dev *dev,
...
static void mt76_airtime_flush_ampdu(struct mt76_dev *dev) {
...
static void mt76_airtime_check(struct mt76_dev *dev, struct sk_buff *skb) {
  struct mt76_rx_status *status = (struct mt76_rx_status *) skb->cb;
  struct mt76_wcid *wcid = status->wcid;
  if (!(dev->drv->drv_flags & MT_DRV_SW_RX_AIRTIME)) {
    return;
...
static void mt76_check_sta(struct mt76_dev *dev, struct sk_buff *skb) {
  struct mt76_rx_status *status = (struct mt76_rx_status *) skb->cb;
  struct ieee80211_hdr *hdr = mt76_skb_get_hdr(skb);
  struct ieee80211_sta *sta;
  struct ieee80211_hw *hw;
...
static int mt76_sta_add(struct mt76_phy *phy, struct ieee80211_vif *vif,
    struct ieee80211_sta *sta) {
...
static void mt76_sta_remove(struct mt76_dev *dev, struct ieee80211_vif *vif,
    struct ieee80211_sta *sta) {
  mutex_lock(&dev->mutex);
...
static void __mt76_csa_finish(void *priv, u8 *mac, struct ieee80211_vif *vif) {
...
static void __mt76_csa_check(void *priv, u8 *mac, struct ieee80211_vif *vif) {
...
struct mt76_queue *mt76_init_queue(struct mt76_dev *dev, int qid, int idx,
    int n_desc,
