...
static inline void *mt76_connac_txwi_to_txp(struct mt76_dev *dev,
...
static inline bool mt76_connac_pm_ref(struct mt76_phy *phy,
    struct mt76_connac_pm *pm) {
  bool ret = false;
...
static inline void mt76_connac_pm_unref(struct mt76_phy *phy,
    struct mt76_connac_pm *pm) {
  spin_lock_bh(&pm->wake.lock);
...
static inline bool mt76_connac_skip_fw_pmctrl(struct mt76_phy *phy,
    struct mt76_connac_pm *pm) {
...
static inline void mt76_connac_mutex_acquire(struct mt76_dev *dev,
    struct mt76_connac_pm *pm)
...
static inline void mt76_connac_mutex_release(struct mt76_dev *dev,
    struct mt76_connac_pm *pm)
