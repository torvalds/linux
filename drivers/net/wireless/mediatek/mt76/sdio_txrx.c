...
static struct sk_buff *mt76s_build_rx_skb(void *data, int data_len,
    int buf_len) {
...
static int mt76s_tx_pick_quota(struct mt76_sdio *sdio, bool mcu, int buf_sz,
...
static void mt76s_tx_update_quota(struct mt76_sdio *sdio, bool mcu,
    int pse_size,
    int ple_size) {
  if (mcu) {
