...
static void mt76x02u_multiple_mcu_reads(struct mt76_dev *dev, u8 *data,
    int len) {
...
static int __mt76x02u_mcu_send_msg(struct mt76_dev *dev, struct sk_buff *skb,
...
static int mt76x02u_mcu_send_msg(struct mt76_dev *dev, int cmd,
    const void *data,
...
static int mt76x02u_mcu_wr_rp(struct mt76_dev *dev, u32 base,
...
static int mt76x02u_mcu_rd_rp(struct mt76_dev *dev, u32 base,
...
static int __mt76x02u_mcu_fw_send_data(struct mt76x02_dev *dev, u8 *data,
