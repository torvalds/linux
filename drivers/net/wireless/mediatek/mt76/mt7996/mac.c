...
static int mt7996_mac_fill_rx_rate(struct mt7996_dev *dev,
...
static void mt7996_wed_check_ppe(struct mt7996_dev *dev, struct mt76_queue *q,
...
static void mt7996_mac_write_txwi_8023(struct mt7996_dev *dev, __le32 *txwi,
...
static void mt7996_mac_write_txwi_80211(struct mt7996_dev *dev, __le32 *txwi,
...
static void mt7996_tx_check_aggr(struct ieee80211_sta *sta,
    struct sk_buff *skb) {
  struct mt7996_sta *msta;
  struct ieee80211_tx_info *info = IEEE80211_SKB_CB(skb);
  bool is_8023 = info->flags & IEEE80211_TX_CTL_HW_80211_ENCAP;
...
static void mt7996_txwi_free(struct mt7996_dev *dev, struct mt76_txwi_cache *t,
...
static bool mt7996_mac_add_txs_skb(struct mt7996_dev *dev,
    struct mt76_wcid *wcid,
...
static u8 mt7996_phy_get_nf(struct mt7996_phy *phy, u8 band_idx) {
  static const u8 nf_power[] = {
...
static void mt7996_update_vif_beacon(void *priv, u8 *mac,
    struct ieee80211_vif *vif) {
...
static void mt7996_update_beacons(struct mt7996_dev *dev) {
...
static int mt7996_mac_restart(struct mt7996_dev *dev) {
...
static void mt7996_mac_full_reset(struct mt7996_dev *dev) {
  struct mt7996_phy *phy2, *phy3;
  int i;
  phy2 = mt7996_phy2(dev);
  phy3 = mt7996_phy3(dev);
...
static int mt7996_dfs_init_radar_specs(struct mt7996_phy *phy) {
...
static int mt7996_mac_twt_duration_align(int duration) {
  return duration << 8;
}

static u64 mt7996_mac_twt_sched_list_add(struct mt7996_dev *dev,
...
static bool mt7996_mac_twt_param_equal(struct mt7996_sta *msta,
    struct ieee80211_twt_params *twt_agrt) {
