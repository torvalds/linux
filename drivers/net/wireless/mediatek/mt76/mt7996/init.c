...
static int mt7996_thermal_get_max_throttle_state(
...
static int mt7996_thermal_get_cur_throttle_state(
    struct thermal_cooling_device *cdev,
    unsigned long *state) {
...
static int mt7996_thermal_set_cur_throttle_state(
    struct thermal_cooling_device *cdev,
    unsigned long state) {
  struct mt7996_phy *phy = cdev->devdata;
...
static void mt7996_regd_notifier(struct wiphy *wiphy,
...
static void mt7996_init_wiphy(struct ieee80211_hw *hw,
...
static void mt7996_mac_init_band(struct mt7996_dev *dev, u8 band) {
  u32 mask, set;
...
static void mt7996_unregister_phy(struct mt7996_phy *phy,
    enum mt76_band_id band) {
  struct mt76_phy *mphy;
  if (!phy) {
    return;
...
static int mt7996_init_hardware(struct mt7996_dev *dev) {
  ...
  if (is_mt7992(&dev->mt76)) {
    mt76_rmw(dev, MT_AFE_CTL_BAND_PLL_03(
        MT_BAND0), MT_AFE_CTL_BAND_PLL_03_MSB_EN, 0);
    mt76_rmw(dev, MT_AFE_CTL_BAND_PLL_03(
        MT_BAND1), MT_AFE_CTL_BAND_PLL_03_MSB_EN, 0);
  }
...
static void mt7996_set_stream_he_txbf_caps(struct mt7996_phy *phy,
...
static void mt7996_init_he_caps(struct mt7996_phy *phy, enum nl80211_band band,
...
static void mt7996_init_eht_caps(struct mt7996_phy *phy, enum nl80211_band band,
    struct ieee80211_sband_iftype_data *data,
    enum nl80211_iftype iftype) {
...
static void __mt7996_set_stream_he_eht_caps(struct mt7996_phy *phy,
    struct ieee80211_supported_band *sband,
