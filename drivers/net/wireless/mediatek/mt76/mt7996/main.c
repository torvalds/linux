...
static int mt7996_conf_tx(struct ieee80211_hw *hw, struct ieee80211_vif *vif,
...
static void mt7996_update_bss_color(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
...
static u8 mt7996_get_rates_table(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
...
static void mt7996_update_mu_group(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
...
static void mt7996_channel_switch_beacon(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
...
static int mt7996_ampdu_action(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
...
static int mt7996_sta_add(struct ieee80211_hw *hw, struct ieee80211_vif *vif,
    struct ieee80211_sta *sta) {
  return mt76_sta_state(hw, vif, sta, IEEE80211_STA_NOTEXIST,
      IEEE80211_STA_NONE);
}

static int mt7996_sta_remove(struct ieee80211_hw *hw, struct ieee80211_vif *vif,
    struct ieee80211_sta *sta) {
  return mt76_sta_state(hw, vif, sta, IEEE80211_STA_NONE,
      IEEE80211_STA_NOTEXIST);
}

static int mt7996_get_stats(struct ieee80211_hw *hw,
...
static u64 mt7996_get_tsf(struct ieee80211_hw *hw, struct ieee80211_vif *vif) {
  struct mt7996_vif *mvif = (struct mt7996_vif *) vif->drv_priv;
  struct mt7996_dev *dev = mt7996_hw_dev(hw);
  u64 ret;
  mutex_lock(&dev->mt76.mutex);
...
static void mt7996_set_tsf(struct ieee80211_hw *hw, struct ieee80211_vif *vif,
    u64 timestamp) {
  struct mt7996_vif *mvif = (struct mt7996_vif *) vif->drv_priv;
  struct mt7996_dev *dev = mt7996_hw_dev(hw);
  struct mt7996_phy *phy = mt7996_hw_phy(hw);
...
static void mt7996_offset_tsf(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
    s64 timestamp) {
  struct mt7996_vif *mvif = (struct mt7996_vif *) vif->drv_priv;
  struct mt7996_dev *dev = mt7996_hw_dev(hw);
...
static void mt7996_set_coverage_class(struct ieee80211_hw *hw,
    s16 coverage_class) {
  struct mt7996_phy *phy = mt7996_hw_phy(hw);
  struct mt7996_dev *dev = phy->dev;
  mutex_lock(&dev->mt76.mutex);
...
static int mt7996_set_antenna(struct ieee80211_hw *hw, u32 tx_ant, u32 rx_ant) {
  struct mt7996_dev *dev = mt7996_hw_dev(hw);
  struct mt7996_phy *phy = mt7996_hw_phy(hw);
...
static int mt7996_set_bitrate_mask(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
...
static void mt7996_twt_teardown_request(struct ieee80211_hw *hw,
    struct ieee80211_sta *sta,
    u8 flowid) {
  struct mt7996_sta *msta = (struct mt7996_sta *) sta->drv_priv;
  struct mt7996_dev *dev = mt7996_hw_dev(hw);
...
static int mt7996_set_radar_background(struct ieee80211_hw *hw,
    struct cfg80211_chan_def *chandef) {
  struct mt7996_phy *phy = mt7996_hw_phy(hw);
  struct mt7996_dev *dev = phy->dev;
  int ret = -EINVAL;
...
static int mt7996_net_fill_forward_path(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
    struct ieee80211_sta *sta,
