...
static void mt76x02_dfs_set_capture_mode_ctrl(struct mt76x02_dev *dev,
    u8 enable) {
  u32 data;
  data = (1 << 1) | enable;
...
static struct mt76x02_dfs_sequence *mt76x02_dfs_seq_pool_get(
...
static void mt76x02_dfs_set_domain(struct mt76x02_dev *dev,
