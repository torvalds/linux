...
/**
 * struct mt76_connac2_mcu_uni_txd - mcu command descriptor for connac2 and
 * connac3
...
static inline enum mcu_cipher_type mt76_connac_mcu_get_cipher(int cipher) {
  switch (cipher) {
...
static inline u32 mt76_connac_mcu_gen_dl_mode(struct mt76_dev *dev,
...
static inline void mt76_connac_mcu_get_wlan_idx(struct mt76_dev *dev,
    struct mt76_wcid *wcid,
...
struct sk_buff *__mt76_connac_mcu_alloc_sta_req(struct mt76_dev *dev,
    struct mt76_vif *mvif,
    struct mt76_wcid *wcid, int len);
static inline struct sk_buff *mt76_connac_mcu_alloc_sta_req(
    struct mt76_dev *dev, struct mt76_vif *mvif,
    struct mt76_wcid *wcid) {
  return __mt76_connac_mcu_alloc_sta_req(dev, mvif, wcid,
      MT76_CONNAC_STA_UPDATE_MAX_SIZE);
}

struct wtbl_req_hdr *mt76_connac_mcu_alloc_wtbl_req(struct mt76_dev *dev,
    struct mt76_wcid *wcid,
    int cmd, void *sta_wtbl, struct sk_buff **skb);
struct tlv *mt76_connac_mcu_add_nested_tlv(struct sk_buff *skb, int tag,
    int len, void *sta_ntlv,
    void *sta_wtbl);
static inline struct tlv *mt76_connac_mcu_add_tlv(struct sk_buff *skb, int tag,
    int len) {
...
void mt76_connac_mcu_sta_he_tlv_v2(struct sk_buff *skb,
    struct ieee80211_sta *sta);
...
int mt76_connac_mcu_set_gtk_rekey(struct mt76_dev *dev,
    struct ieee80211_vif *vif,
    bool suspend);
int mt76_connac_mcu_set_wow_ctrl(struct mt76_phy *phy,
    struct ieee80211_vif *vif,
...
const struct ieee80211_sta_he_cap *mt76_connac_get_he_phy_cap(
  struct mt76_phy *phy, struct ieee80211_vif *vif);
