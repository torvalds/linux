...
static int mt792x_acpi_read(struct mt792x_dev *dev, u8 *method, u8 **tbl,
    u32 *len) {
...
static int mt792x_asar_acpi_read_mtcl(struct mt792x_dev *dev, u8 **table,
    u8 *version) {
  int ret;
...
static int mt792x_asar_acpi_read_mtds(struct mt792x_dev *dev, u8 **table,
    u8 version) {
...
static int mt792x_asar_acpi_read_mtgs(struct mt792x_dev *dev, u8 **table,
    u8 version) {
  int len, ret, sarlen, prelen, tblcnt;
...
/* MTFG : Flag Table */
static int mt792x_asar_acpi_read_mtfg(struct mt792x_dev *dev, u8 **table) {
  int len, ret;
...
static s8 mt792x_asar_get_geo_pwr(struct mt792x_phy *phy,
...
static s8 mt792x_asar_range_pwr(struct mt792x_phy *phy,
...
static u8 mt792x_acpi_get_mtcl_map(int row, int column,
