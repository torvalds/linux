...
static int mt7921_mcu_set_ipv6_ns_filter(struct mt76_dev *dev,
...
static void mt7921_mcu_uni_roc_event(struct mt792x_dev *dev,
    struct sk_buff *skb) {
...
static void mt7921_mcu_scan_event(struct mt792x_dev *dev, struct sk_buff *skb) {
...
static void mt7921_mcu_connection_loss_iter(void *priv, u8 *mac,
    struct ieee80211_vif *vif) {
...
static void mt7921_mcu_connection_loss_event(struct mt792x_dev *dev,
    struct sk_buff *skb) {
...
static void mt7921_mcu_debug_msg_event(struct mt792x_dev *dev,
    struct sk_buff *skb) {
...
static void mt7921_mcu_low_power_event(struct mt792x_dev *dev,
    struct sk_buff *skb) {
...
static void mt7921_mcu_tx_done_event(struct mt792x_dev *dev,
    struct sk_buff *skb) {
...
static void mt7921_mcu_rx_unsolicited_event(struct mt792x_dev *dev,
    struct sk_buff *skb) {
  struct mt76_connac2_mcu_rxd *rxd;
  rxd = (struct mt76_connac2_mcu_rxd *) skb->data;
  switch (rxd->eid) {
...
static void mt7921_mcu_uni_rx_unsolicited_event(struct mt792x_dev *dev,
    struct sk_buff *skb) {
  struct mt76_connac2_mcu_rxd *rxd;
  rxd = (struct mt76_connac2_mcu_rxd *) skb->data;
  switch (rxd->eid) {
...
static int mt7921_mcu_uni_bss_bcnft(struct mt792x_dev *dev,
    struct ieee80211_vif *vif,
    bool enable) {
  struct mt792x_vif *mvif = (struct mt792x_vif *) vif->drv_priv;
  struct {
