...
static int mt7921_mac_fill_rx(struct mt792x_dev *dev, struct sk_buff *skb) {
...
static void mt7921_vif_connect_iter(void *priv, u8 *mac,
    struct ieee80211_vif *vif) {
...
/* usb_sdio */
static void mt7921_usb_sdio_write_txwi(struct mt792x_dev *dev,
    struct mt76_wcid *wcid,
