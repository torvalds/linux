...
static int mt7921_reg_set(void *data, u64 val) {
...
static int mt7921_reg_get(void *data, u64 *val) {
  struct mt792x_dev *dev = data;
  mt792x_mutex_acquire(dev);
...
DEFINE_DEBUGFS_ATTRIBUTE(fops_regval, mt7921_reg_get, mt7921_reg_set,
    "0x%08llx\n");
static int mt7921_fw_debug_set(void *data, u64 val) {
  struct mt792x_dev *dev = data;
  mt792x_mutex_acquire(dev);
  dev->fw_debug = (u8) val;
...
static int mt7921_fw_debug_get(void *data, u64 *val) {
  struct mt792x_dev *dev = data;
  *val = dev->fw_debug;
  return 0;
}
...
static int mt7921_txpwr(struct seq_file *s, void *data) {
...
static int mt7921_pm_set(void *data, u64 val) {
  struct mt792x_dev *dev = data;
...
static int mt7921_pm_get(void *data, u64 *val) {
  struct mt792x_dev *dev = data;
...
static int mt7921_deep_sleep_set(void *data, u64 val) {
  struct mt792x_dev *dev = data;
  struct mt76_connac_pm *pm = &dev->pm;
...
static int mt7921_deep_sleep_get(void *data, u64 *val) {
  struct mt792x_dev *dev = data;
...
static int mt7921s_sched_quota_read(struct seq_file *s, void *data) {
  struct mt792x_dev *dev = dev_get_drvdata(s->private);
