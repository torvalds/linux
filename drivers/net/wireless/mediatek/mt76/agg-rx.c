...
static void mt76_aggr_release(struct mt76_rx_tid *tid,
    struct sk_buff_head *frames, int idx) {
  struct sk_buff *skb;
...
static void mt76_rx_aggr_release_frames(struct mt76_rx_tid *tid,
...
static void mt76_rx_aggr_release_head(struct mt76_rx_tid *tid,
    struct sk_buff_head *frames) {
...
static void mt76_rx_aggr_check_release(struct mt76_rx_tid *tid,
    struct sk_buff_head *frames) {
...
static void mt76_rx_aggr_reorder_work(struct work_struct *work) {
...
static void mt76_rx_aggr_check_ctl(struct sk_buff *skb,
    struct sk_buff_head *frames) {
...
static void mt76_rx_aggr_shutdown(struct mt76_dev *dev,
    struct mt76_rx_tid *tid) {
  u16 size = tid->size;
  int i;
  spin_lock_bh(&tid->lock);
