...
static int mt76x02_ampdu_stat_show(struct seq_file *file, void *data) {
...
static int mt76x02_dfs_stat_show(struct seq_file *file, void *data) {
  struct mt76x02_dev *dev = file->private;
...
static int mt76_edcca_set(void *data, u64 val) {
...
static int mt76_edcca_get(void *data, u64 *val) {
  struct mt76x02_dev *dev = data;
