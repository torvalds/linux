...
static const __be32 *mt76_get_of_array(struct device_node *np, char *name,
    size_t *len, int min) {
...
static s8 mt76_get_txs_delta(struct device_node *np, u8 nss) {
  const __be32 *val;
  size_t len;
...
static void mt76_apply_array_limit(s8 *pwr, size_t pwr_len, const __be32 *data,
...
static void mt76_apply_multi_array_limit(s8 *pwr, size_t pwr_len, s8 pwr_num,
