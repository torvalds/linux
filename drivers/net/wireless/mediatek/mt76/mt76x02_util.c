...
static void mt76x02_led_set_config(struct mt76_phy *mphy, u8 delay_on,
    u8 delay_off) {
...
static int mt76x02_led_set_blink(struct led_classdev *led_cdev,
...
static void mt76x02_led_set_brightness(struct led_classdev *led_cdev,
...
static void mt76x02_vif_init(struct mt76x02_dev *dev, struct ieee80211_vif *vif,
    unsigned int idx) {
  struct mt76x02_vif *mvif = (struct mt76x02_vif *) vif->drv_priv;
...
int mt76x02_add_interface(struct ieee80211_hw *hw, struct ieee80211_vif *vif) {
  struct mt76x02_dev *dev = hw->priv;
  unsigned int idx = 0;
