...
#ifdef CONFIG_PM
static int mt7925_connac_mcu_set_wow_ctrl(struct mt76_phy *phy,
...
static int mt7925_mcu_set_wow_pattern(struct mt76_dev *dev,
    struct ieee80211_vif *vif,
...
static void mt7925_mcu_connection_loss_iter(void *priv, u8 *mac,
    struct ieee80211_vif *vif) {
  struct mt76_vif *mvif = (struct mt76_vif *) vif->drv_priv;
...
static void mt7925_mcu_connection_loss_event(struct mt792x_dev *dev,
    struct sk_buff *skb) {
...
static void mt7925_mcu_roc_iter(void *priv, u8 *mac,
    struct ieee80211_vif *vif) {
  struct mt76_vif *mvif = (struct mt76_vif *) vif->drv_priv;
...
static void mt7925_mcu_uni_roc_event(struct mt792x_dev *dev,
    struct sk_buff *skb) {
...
static void mt7925_mcu_tx_done_event(struct mt792x_dev *dev,
    struct sk_buff *skb) {
...
static void mt7925_mcu_uni_debug_msg_event(struct mt792x_dev *dev,
    struct sk_buff *skb) {
...
static void mt7925_mcu_uni_rx_unsolicited_event(struct mt792x_dev *dev,
    struct sk_buff *skb) {
  struct mt7925_mcu_rxd *rxd;
  rxd = (struct mt7925_mcu_rxd *) skb->data;
  switch (rxd->eid) {
...
static int mt7925_mcu_sta_ba(struct mt76_dev *dev, struct mt76_vif *mvif,
...
static void mt7925_mcu_parse_phy_cap(struct mt792x_dev *dev, char *data) {
  struct mt76_phy *mphy = &dev->mt76.phy;
...
static void mt7925_mcu_sta_hdr_trans_tlv(struct sk_buff *skb,
    struct ieee80211_vif *vif,
...
static int mt7925_mcu_sta_key_tlv(struct mt76_wcid *wcid,
...
static int mt7925_mcu_uni_bss_bcnft(struct mt792x_dev *dev,
    struct ieee80211_vif *vif,
    bool enable) {
  struct mt792x_vif *mvif = (struct mt792x_vif *) vif->drv_priv;
  struct {
...
static void mt7925_mcu_sta_he_tlv(struct sk_buff *skb,
    struct ieee80211_sta *sta) {
...
static void mt7925_mcu_sta_he_6g_tlv(struct sk_buff *skb,
    struct ieee80211_sta *sta) {
...
static void mt7925_mcu_sta_eht_tlv(struct sk_buff *skb,
    struct ieee80211_sta *sta) {
...
static void mt7925_mcu_sta_ht_tlv(struct sk_buff *skb,
    struct ieee80211_sta *sta) {
...
static void mt7925_mcu_sta_vht_tlv(struct sk_buff *skb,
    struct ieee80211_sta *sta) {
...
static void mt7925_mcu_sta_amsdu_tlv(struct sk_buff *skb,
...
static void mt7925_mcu_sta_phy_tlv(struct sk_buff *skb,
    struct ieee80211_vif *vif, struct ieee80211_sta *sta) {
  struct mt792x_vif *mvif = (struct mt792x_vif *) vif->drv_priv;
...
static void mt7925_mcu_sta_state_v2_tlv(struct mt76_phy *mphy,
    struct sk_buff *skb,
    struct ieee80211_sta *sta,
    struct ieee80211_vif *vif,
...
static void mt7925_mcu_sta_rate_ctrl_tlv(struct sk_buff *skb,
    struct ieee80211_vif *vif, struct ieee80211_sta *sta) {
  struct mt792x_vif *mvif = (struct mt792x_vif *) vif->drv_priv;
  struct cfg80211_chan_def *chandef = &mvif->mt76.ctx->def;
...
static void mt7925_mcu_sta_mld_tlv(struct sk_buff *skb,
    struct ieee80211_vif *vif, struct ieee80211_sta *sta) {
...
static int mt7925_mcu_sta_cmd(struct mt76_phy *phy,
...
static struct sk_buff *__mt7925_mcu_alloc_bss_req(struct mt76_dev *dev,
...
static u8 mt7925_get_phy_mode_ext(struct mt76_phy *phy,
    struct ieee80211_vif *vif,
...
static void mt7925_mcu_bss_basic_tlv(struct sk_buff *skb,
    struct ieee80211_vif *vif,
    struct ieee80211_sta *sta,
    struct ieee80211_chanctx_conf *ctx,
...
static void mt7925_mcu_bss_sec_tlv(struct sk_buff *skb,
    struct ieee80211_vif *vif) {
  struct mt76_vif *mvif = (struct mt76_vif *) vif->drv_priv;
  struct bss_sec_tlv {
    __le16 tag;
...
static void mt7925_mcu_bss_bmc_tlv(struct sk_buff *skb, struct mt792x_phy *phy,
    struct ieee80211_chanctx_conf *ctx,
    struct ieee80211_vif *vif,
    struct ieee80211_sta *sta) {
...
static void mt7925_mcu_bss_mld_tlv(struct sk_buff *skb,
    struct ieee80211_vif *vif,
    struct ieee80211_sta *sta) {
  struct mt792x_vif *mvif = (struct mt792x_vif *) vif->drv_priv;
...
static void mt7925_mcu_bss_qos_tlv(struct sk_buff *skb,
    struct ieee80211_vif *vif) {
...
static void mt7925_mcu_bss_he_tlv(struct sk_buff *skb,
    struct ieee80211_vif *vif,
...
static void mt7925_mcu_bss_color_tlv(struct sk_buff *skb,
    struct ieee80211_vif *vif,
    bool enable) {
...
static void mt7925_mcu_bss_ifs_tlv(struct sk_buff *skb,
    struct ieee80211_vif *vif) {
  struct mt792x_vif *mvif = (struct mt792x_vif *) vif->drv_priv;
...
static int __mt7925_mcu_set_clc(struct mt792x_dev *dev, u8 *alpha2,
...
static void mt7925_mcu_build_sku(struct mt76_dev *dev, s8 *sku,
...
static int mt7925_mcu_rate_txpower_band(struct mt76_phy *phy,
    enum nl80211_band band) {
