...
static int mt7925_mac_fill_rx_rate(struct mt792x_dev *dev,
...
static int mt7925_mac_fill_rx(struct mt792x_dev *dev, struct sk_buff *skb) {
...
static void mt7925_mac_write_txwi_8023(__le32 *txwi, struct sk_buff *skb,
...
static void mt7925_mac_write_txwi_80211(struct mt76_dev *dev, __le32 *txwi,
    struct sk_buff *skb,
...
static bool mt7925_mac_add_txs_skb(struct mt792x_dev *dev,
    struct mt76_wcid *wcid,
...
static void mt7925_mac_tx_free(struct mt792x_dev *dev, void *data, int len) {
...
static void mt7925_vif_connect_iter(void *priv, u8 *mac,
    struct ieee80211_vif *vif) {
...
/* usb_sdio */
static void mt7925_usb_sdio_write_txwi(struct mt792x_dev *dev,
    struct mt76_wcid *wcid,
