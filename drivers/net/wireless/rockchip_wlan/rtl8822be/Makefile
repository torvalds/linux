...
#include $(TopDIR)/drivers/net/wireless/rockchip_wlan/rtl8822be/rtl8822b.mk
...
ARCH := arm64
CROSS_COMPILE := /home1/xiaoyao/rk3399/7.1/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android-
KSRC := /home1/xiaoyao/rk3399/7.1/kernel
MODULE_NAME := 8822be
endif
...
EXTRA_CFLAGS += -DCONFIG_LITTLE_ENDIAN -DCONFIG_CONCURRENT_MODE
EXTRA_CFLAGS += -DRTK_129X_PLATFORM -DCONFIG_RF4CE_COEXIST
EXTRA_CFLAGS += -DCONFIG_TRAFFIC_PROTECT
# default setting for Android 4.1, 4.2
#EXTRA_CFLAGS += -DCONFIG_CONCURRENT_MODE
EXTRA_CFLAGS += -DCONFIG_IOCTL_CFG80211 -DRTW_USE_CFG80211_STA_EVENT
