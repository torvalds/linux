...
u8 halbtcoutsrc_IsRF4CEConnected(PADAPTER padapter)
{
...
u8 halbtcoutsrc_Get(void *pBtcContext, u8 getType, void *pOutBuf)
{
	...
	case BTC_GET_BL_RF4CE_CONNECTED:
		*pu8 = halbtcoutsrc_IsRF4CEConnected(padapter);
		break;
...
void halbtcoutsrc_DisplayWifiStatus(PBTC_COEXIST pBtCoexist)
{
	...
	BOOLEAN bRf4CEConnected = _FALSE;
...
#ifdef CONFIG_RF4CE_COEXIST
	/* RF4CE ZigBee Status */
	pBtCoexist->btc_get(pBtCoexist, BTC_GET_BL_RF4CE_CONNECTED, &bRf4CEConnected);
...
void EXhalbtcoutsrc_set_rf4ce_voice_state(u8 state)
{
	GLBtCoexist.rf4ce_info.voice_state = state;
}

u8 EXhalbtcoutsrc_get_rf4ce_voice_state(void)
{
	return GLBtCoexist.rf4ce_info.voice_state;
}
#endif
...
{
	EXhalbtcoutsrc_set_rf4ce_voice_state(state);
}

u8 hal_btcoex_get_rf4ce_voice_state(void)
{
	return EXhalbtcoutsrc_get_rf4ce_voice_state();
}
