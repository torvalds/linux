/*
** $Id: //Department/DaVinci/BRANCHES/MT662X_593X_WIFI_DRIVER_V2_3/os/linux/gl_init.c#3 $
*/
...
** enable checksum offloading configuration as default
** 
** 09 04 2012 cp.wu
** [WCXRP00001269] [MT6620 Wi-Fi][Driver] cfg80211 porting merge back to DaVinci
...
extern int mt5931_power_off(void); 
    ...
    )
{
    ...
    printk(KERN_ALERT DRV_NAME "Not support WIPHY_FLAG_SUPPORTS_FW_ROAM\n");
#endif
