    ...
    )
{
    ...
    // not implemented yet
/* for AOSP wpa_supplicant2.0 return 0
    return -EINVAL;
*/
	return 0;
}
...
//    P_IE_SSID_T prSsidIE = (P_IE_SSID_T)NULL;
    ...
    do {
        ...
        DBGLOG(P2P, STATE, ("mtk_p2p_cfg80211_start_ap.\n"));
        prGlueInfo = *((P_GLUE_INFO_T *) wiphy_priv(wiphy));
    ...
    )
{
    ...
    do {
        ...
        DBGLOG(P2P, STATE, ("mtk_p2p_cfg80211_change_beacon.\n"));
        prGlueInfo = *((P_GLUE_INFO_T *) wiphy_priv(wiphy));
    ...
    )
{
    ...
    do {
        ...
        DBGLOG(P2P, STATE, ("mtk_p2p_cfg80211_add_set_beacon.\n"));
        prGlueInfo = *((P_GLUE_INFO_T *) wiphy_priv(wiphy));
	...
	/* the len of ssid may be random value and will cause memcopy error if we don't call kalMemZero.*/
    ...
    )
{
    ...
    do {
        ...
        DBGLOG(P2P, STATE, ("mtk_p2p_cfg80211_del_station.\n"));
    ...
    )
{
    ...
    do {
        ...
        DBGLOG(P2P, STATE, ("mtk_p2p_cfg80211_connect.\n"));
    ...
    )
{
    ...
    do {
        ...
        DBGLOG(P2P, STATE, ("mtk_p2p_cfg80211_disconnect.\n"));
    ...
    )
{
    ...
    do {
        ...
        DBGLOG(P2P, STATE, ("mtk_p2p_cfg80211_change_iface.\n"));
