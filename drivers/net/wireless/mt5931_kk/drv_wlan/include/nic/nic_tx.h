/*
** $Id: //Department/DaVinci/BRANCHES/MT662X_593X_WIFI_DRIVER_V2_3/include/nic/nic_tx.h#2 $
*/
...
#define PRINT_PKT_PROFILE(_pkt_profile, _note) \
    { \
        if(!(_pkt_profile)->fgIsPrinted) { \
            kalPrint("X[%lu] E[%lu] D[%lu] HD[%lu] IP[%d] RTP[%d] %s\n", \
