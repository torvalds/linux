    ...
    do {
        ...
        if (prP2pConnInfo) {
...
#ifdef CFG_DUAL_ANTENNA
            wifi2bwcs_connection_event_ind_handler(prGlueInfo, WIFI_EVENT_P2P_GC_CONN_NEW);
#endif
        }
        else {
            ...
            cfg80211_disconnected(prGlueP2pInfo->prDevHandler, //struct net_device * dev,
                                    ...
                                    GFP_KERNEL);
#ifdef CFG_DUAL_ANTENNA
            wifi2bwcs_connection_event_ind_handler(prGlueInfo, WIFI_EVENT_P2P_GC_CONN_DEL);
#endif
        }
