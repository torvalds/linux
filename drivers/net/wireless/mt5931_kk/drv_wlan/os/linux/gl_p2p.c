...
static struct cfg80211_ops mtk_p2p_config_ops = {
    ...
    .set_beacon = mtk_p2p_cfg80211_add_set_beacon_1,
...
#if LINUX_VERSION_CODE > KERNEL_VERSION(3, 2, 0)
	prGlueInfo->prP2PInfo->wdev.wiphy->flags = WIPHY_FLAG_CUSTOM_REGULATORY | WIPHY_FLAG_HAS_REMAIN_ON_CHANNEL | WIPHY_FLAG_HAVE_AP_SME | WIPHY_FLAG_OFFCHAN_TX;
#else
	prGlueInfo->prP2PInfo->wdev.wiphy->flags = WIPHY_FLAG_CUSTOM_REGULATORY | WIPHY_FLAG_HAVE_AP_SME;
//	printk(KERN_ALERT DRV_NAME "Not support WIPHY_FLAG_HAS_REMAIN_ON_CHANNEL | WIPHY_FLAG_HAVE_AP_SME | WIPHY_FLAG_OFFCHAN_TX\n");
#endif
