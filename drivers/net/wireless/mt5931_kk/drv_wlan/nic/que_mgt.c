/*
** $Id: //Department/DaVinci/BRANCHES/MT662X_593X_WIFI_DRIVER_V2_3/nic/que_mgt.c#1 $
*/
...
** $Log: que_mgt.c $
**
** 01 04 2013 tsaiyuan.hsu
** [WCXRP00001271] [MT6620] add timeout mechanism for RX BA to avoid unsynced scoreboard with TX

** fix msec systemtime conversion.
 *
 * 03 02 2012 terry.wu
 * NULL
