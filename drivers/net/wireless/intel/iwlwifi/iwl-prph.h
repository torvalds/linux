...
#define SCD_QUEUE_CTX_REG1_VAL(_n, _v)    FIELD_PREP(SCD_QUEUE_CTX_REG1_ ## _n, \
    _v)

#define SCD_QUEUE_CTX_REG2_WIN_SIZE   (0x0000007F)
#define SCD_QUEUE_CTX_REG2_FRAME_LIMIT    (0x007F0000)
#define SCD_QUEUE_CTX_REG2_VAL(_n, _v)    FIELD_PREP(SCD_QUEUE_CTX_REG2_ ## _n, \
    _v)
...
#define WFPM_OTP_CFG1_IS_JACKET(_val)   (((_val) & 0x00000020) >> \
  WFPM_OTP_BZ_BNJ_JACKET_BIT)
#define WFPM_OTP_CFG1_IS_CDB(_val)      (((_val) & 0x00000010) >> \
