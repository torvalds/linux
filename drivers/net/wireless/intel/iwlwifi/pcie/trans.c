...
static void iwl_trans_pcie_write_shr(struct iwl_trans *trans, u32 reg,
    u32 val) {
...
void iwl_trans_pcie_free_pnvm_dram_regions(
...
static u32 iwl_trans_pci_dump_marbh_monitor(struct iwl_trans *trans,
...
static u32 iwl_trans_pcie_dump_monitor(struct iwl_trans *trans,
    struct iwl_fw_error_dump_data **data,
    u32 monitor_len) {
  struct iwl_dram_data *fw_mon = &trans->dbg.fw_mon;
  u32 len = 0;
...
static struct iwl_trans_dump_data *iwl_trans_pcie_dump_data(
    struct iwl_trans *trans,
    u32 dump_mask,
