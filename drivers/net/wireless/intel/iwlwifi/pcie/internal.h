 ...
 * @used_bd_dma: physical address of buffer of used receive buffer descriptors
 *(rbd)
...
static inline struct iwl_trans_pcie *IWL_TRANS_GET_PCIE_TRANS(
    struct iwl_trans *trans) {
...
static inline struct iwl_trans *iwl_trans_pcie_get_trans(
...
static inline void iwl_enable_hw_int_msk_msix(struct iwl_trans *trans,
    u32 msk) {
  struct iwl_trans_pcie *trans_pcie = IWL_TRANS_GET_PCIE_TRANS(trans);
...
static inline void iwl_enable_fh_int_msk_msix(struct iwl_trans *trans,
    u32 msk) {
  struct iwl_trans_pcie *trans_pcie = IWL_TRANS_GET_PCIE_TRANS(trans);
