...
#define RXON_FLG_CHANNEL_MODE_LEGACY  cpu_to_le32( \
    CHANNEL_MODE_LEGACY << RXON_FLG_CHANNEL_MODE_POS)
#define RXON_FLG_CHANNEL_MODE_PURE_40 cpu_to_le32( \
    CHANNEL_MODE_PURE_40 << RXON_FLG_CHANNEL_MODE_POS)
#define RXON_FLG_CHANNEL_MODE_MIXED cpu_to_le32( \
    CHANNEL_MODE_MIXED << RXON_FLG_CHANNEL_MODE_POS)
