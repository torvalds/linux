 ...
 * @IWL_UCODE_TLV_API_NO_HOST_DISABLE_TX: Firmware offloaded the station disable
 * tx
 *  logic.
 ...
 * @IWL_UCODE_TLV_CAPA_DUMP_COMPLETE_SUPPORT: Support for indicating dump
 * collection
 *  complete to FW.
...
enum iwl_ucode_tlv_capa {
  ...
  IWL_UCODE_TLV_CAPA_TXPOWER_INSERTION_SUPPORT
    = (__force iwl_ucode_tlv_capa_t) 8,
  ...
  IWL_UCODE_TLV_CAPA_TEMP_THS_REPORT_SUPPORT
    = (__force iwl_ucode_tlv_capa_t) 75,
  ...
  IWL_UCODE_TLV_CAPA_MCC_UPDATE_11AX_SUPPORT
    = (__force iwl_ucode_tlv_capa_t) 89,
  IWL_UCODE_TLV_CAPA_CSI_REPORTING = (__force iwl_ucode_tlv_capa_t) 90,
  IWL_UCODE_TLV_CAPA_DBG_SUSPEND_RESUME_CMD_SUPP
    = (__force iwl_ucode_tlv_capa_t) 92,
  ...
  IWL_UCODE_TLV_CAPA_PPAG_CHINA_BIOS_SUPPORT
    = (__force iwl_ucode_tlv_capa_t) 112,
  ...
  IWL_UCODE_TLV_CAPA_SNIFF_VALIDATE_SUPPORT
    = (__force iwl_ucode_tlv_capa_t) 116,
