...
static inline struct iwl_fw_dbg_trigger_tlv *_iwl_fw_dbg_get_trigger(
    const struct iwl_fw *fw, enum iwl_fw_dbg_trigger id) {
...
static inline bool iwl_fw_dbg_trigger_vif_match(
...
static inline bool iwl_fw_dbg_trigger_stop_conf_match(
...
static inline bool iwl_fw_dbg_no_trig_window(struct iwl_fw_runtime *fwrt,
    u32 id, u32 dis_usec) {
