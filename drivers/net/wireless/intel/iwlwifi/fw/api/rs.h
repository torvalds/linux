...
#define RATE_MCS_CHAN_WIDTH_20    (RATE_MCS_CHAN_WIDTH_20_VAL << \
    RATE_MCS_CHAN_WIDTH_POS)
#define RATE_MCS_CHAN_WIDTH_40_VAL  1
#define RATE_MCS_CHAN_WIDTH_40    (RATE_MCS_CHAN_WIDTH_40_VAL << \
    RATE_MCS_CHAN_WIDTH_POS)
#define RATE_MCS_CHAN_WIDTH_80_VAL  2
#define RATE_MCS_CHAN_WIDTH_80    (RATE_MCS_CHAN_WIDTH_80_VAL << \
    RATE_MCS_CHAN_WIDTH_POS)
#define RATE_MCS_CHAN_WIDTH_160_VAL 3
#define RATE_MCS_CHAN_WIDTH_160   (RATE_MCS_CHAN_WIDTH_160_VAL << \
    RATE_MCS_CHAN_WIDTH_POS)
#define RATE_MCS_CHAN_WIDTH_320_VAL 4
#define RATE_MCS_CHAN_WIDTH_320   (RATE_MCS_CHAN_WIDTH_320_VAL << \
    RATE_MCS_CHAN_WIDTH_POS)
