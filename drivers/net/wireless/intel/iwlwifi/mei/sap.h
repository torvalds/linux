...
/**
 * enum iwl_sap_notif_host_suspends_bitmap - used for
 *%SAP_MSG_NOTIF_HOST_SUSPENDS
 * @SAP_OFFER_NIC: TBD
...
/**
 * enum iwl_sap_notif_link_down_type - used in &struct
 * iwl_sap_notif_host_link_down
...
/**
 * struct iwl_sap_notif_host_link_down - payload for
 *%SAP_MSG_NOTIF_HOST_LINK_DOWN
 * @hdr: The SAP header
