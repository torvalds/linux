...
static int _iwl_dbgfs_inject_beacon_ie(struct iwl_mvm *mvm, char *bin,
    int len) {
  struct ieee80211_vif *vif;
  struct iwl_mvm_vif *mvmvif;
...
static ssize_t _iwl_dbgfs_link_sta_wrap_write(ssize_t (*real)(
...
static ssize_t _iwl_dbgfs_link_sta_wrap_read(ssize_t (*real)(
    struct ieee80211_link_sta *,
    struct iwl_mvm_sta *,
    struct iwl_mvm *,
    struct iwl_mvm_link_sta *,
...
static ssize_t iwl_dbgfs_prph_reg_read(struct file *file,
    char __user *user_buf,
    size_t count, loff_t *ppos) {
  struct iwl_mvm *mvm = file->private_data;
  int pos = 0;
...
static ssize_t iwl_dbgfs_ltr_config_write(struct iwl_mvm *mvm,
