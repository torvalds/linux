...
static void iwl_mvm_frob_mem(void *ctx, u32 mem_addr, void *mem,
    size_t buflen) {
...
static void iwl_mvm_me_conn_status(void *priv,
...
static struct iwl_op_mode *iwl_op_mode_mvm_start(struct iwl_trans *trans,
...
static bool iwl_mvm_set_hw_rfkill_state(struct iwl_op_mode *op_mode,
    bool state) {
  struct iwl_mvm *mvm = IWL_OP_MODE_GET_MVM(op_mode);
