...
static void iwl_mvm_bar_check_trigger(struct iwl_mvm *mvm, const u8 *addr,
    u16 tid, u16 ssn) {
 ...
 */
static struct iwl_device_tx_cmd *iwl_mvm_set_tx_params(struct iwl_mvm *mvm,
    struct sk_buff *skb,
...
static int iwl_mvm_tx_tso_segment(struct sk_buff *skb,
...
#ifdef CONFIG_IWLWIFI_DEBUG
#define AGG_TX_STATE_(x) case AGG_TX_STATE_ ## x: \
    return #x
