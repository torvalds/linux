...
static int iwl_ftm_range_request_status_to_err(
    enum iwl_tof_range_request_status s) {
  switch (s) {
...
static int iwl_mvm_ftm_target_chandef_v1(struct iwl_mvm *mvm,
...
static int iwl_mvm_ftm_target_chandef_v2(struct iwl_mvm *mvm,
    struct cfg80211_pmsr_request_peer *peer,
...
static int iwl_mvm_ftm_put_target_v2(struct iwl_mvm *mvm,
    struct cfg80211_pmsr_request_peer *peer,
...
static void iwl_mvm_ftm_put_target_common(struct iwl_mvm *mvm,
    struct cfg80211_pmsr_request_peer *peer,
...
static int iwl_mvm_ftm_put_target_v3(struct iwl_mvm *mvm,
    struct cfg80211_pmsr_request_peer *peer,
...
static int iwl_mvm_ftm_send_cmd(struct iwl_mvm *mvm,
...
static void iwl_mvm_ftm_set_secured_ranging(struct iwl_mvm *mvm,
    struct ieee80211_vif *vif,
...
static int iwl_mvm_ftm_put_target_v7(struct iwl_mvm *mvm,
    struct ieee80211_vif *vif,
    struct cfg80211_pmsr_request_peer *peer,
    struct iwl_tof_range_req_ap_entry_v7 *target) {
...
static void iwl_mvm_ftm_set_ndp_params(struct iwl_mvm *mvm,
...
static int iwl_mvm_ftm_put_target_v8(struct iwl_mvm *mvm,
    struct ieee80211_vif *vif,
    struct cfg80211_pmsr_request_peer *peer,
    struct iwl_tof_range_req_ap_entry_v8 *target) {
  u32 flags;
...
static void iwl_mvm_ftm_pasn_update_pn(struct iwl_mvm *mvm,
