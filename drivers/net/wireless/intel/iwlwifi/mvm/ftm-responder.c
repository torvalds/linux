...
static void iwl_mvm_ftm_responder_set_ndp(struct iwl_mvm *mvm,
...
static int iwl_mvm_ftm_responder_dyn_cfg_v2(struct iwl_mvm *mvm,
    struct ieee80211_vif *vif,
  ...
  u8 data[IWL_LCI_CIVIC_IE_MAX_SIZE] = {
    0
  };
...
static int iwl_mvm_ftm_responder_dyn_cfg_v3(struct iwl_mvm *mvm,
    struct ieee80211_vif *vif,
    struct ieee80211_ftm_responder_params *params,
...
static int iwl_mvm_ftm_responder_dyn_cfg_cmd(struct iwl_mvm *mvm,
    struct ieee80211_vif *vif,
    struct ieee80211_ftm_responder_params *params) {
  int ret;
