...
struct iwl_mvm_vif {
  ...
  unsigned long tentative_addrs[BITS_TO_LONGS(
...
struct iwl_mvm {
  ...
  struct ieee80211_bss_conf __rcu *link_id_to_link_conf[IWL_MVM_FW_MAX_LINK_ID
      + 1];
...
static inline struct ieee80211_vif *iwl_mvm_rcu_dereference_vif_id(
    struct iwl_mvm *mvm, u8 vif_id, bool rcu) {
...
static inline struct ieee80211_bss_conf *iwl_mvm_rcu_fw_link_id_to_link_conf(
    struct iwl_mvm *mvm, u8 link_id, bool rcu) {
...
#else
static inline const char *iwl_mvm_get_tx_fail_reason(u32 status) {
  return "";
}
...
void iwl_mvm_handle_rx_system_oper_part1_stats(struct iwl_mvm *mvm,
    struct iwl_rx_cmd_buffer *rxb);
static inline void iwl_mvm_handle_rx_system_end_stats_notif(struct iwl_mvm *mvm,
    struct iwl_rx_cmd_buffer *rxb) {
}
...
void iwl_mvm_vif_add_debugfs(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif);
...
static inline void iwl_mvm_vif_dbgfs_add_link(struct iwl_mvm *mvm,
    struct ieee80211_vif *vif) {
}

static inline void iwl_mvm_vif_dbgfs_rm_link(struct iwl_mvm *mvm,
    struct ieee80211_vif *vif) {
}
...
struct iwl_mcc_update_resp_v8 *iwl_mvm_update_mcc(struct iwl_mvm *mvm,
    const char *alpha2,
...
static inline void iwl_mvm_set_chan_info_chandef(struct iwl_mvm *mvm,
    struct iwl_fw_channel_info *ci,
    const struct cfg80211_chan_def *chandef) {
...
void iwl_mvm_mac_sta_notify(struct ieee80211_hw *hw, struct ieee80211_vif *vif,
    ...
    struct ieee80211_sta *sta);
void iwl_mvm_mac_allow_buffered_frames(struct ieee80211_hw *hw,
    struct ieee80211_sta *sta, u16 tids,
    int num_frames,
    enum ieee80211_frame_release_type reason,
    bool more_data);
void iwl_mvm_mac_release_buffered_frames(struct ieee80211_hw *hw,
    struct ieee80211_sta *sta, u16 tids,
    int num_frames,
    enum ieee80211_frame_release_type reason,
    bool more_data);
...
int iwl_mvm_mac_get_ftm_responder_stats(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
...
static inline struct cfg80211_chan_def *iwl_mvm_chanctx_def(struct iwl_mvm *mvm,
    struct ieee80211_chanctx_conf *ctx) {
