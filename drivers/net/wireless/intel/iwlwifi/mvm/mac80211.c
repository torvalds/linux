...
static void iwl_mvm_ampdu_check_trigger(struct iwl_mvm *mvm,
    struct ieee80211_vif *vif,
...
static u8 iwl_mvm_chandef_get_primary_80(struct cfg80211_chan_def *chandef) {
  int data_start;
  int control_start;
  int bw;
...
static int iwl_mvm_set_pkt_ext_from_nominal_padding(
    struct iwl_he_pkt_ext_v2 *pkt_ext,
    u8 nominal_padding) {
  int low_th = -1;
  int high_th = -1;
...
bool iwl_mvm_is_nic_ack_enabled(struct iwl_mvm *mvm,
    struct ieee80211_vif *vif) {
...
static void iwl_mvm_bss_info_changed_ap_ibss(struct iwl_mvm *mvm,
    struct ieee80211_vif *vif,
    struct ieee80211_bss_conf *bss_conf,
    u64 changes) {
  struct iwl_mvm_vif *mvmvif = iwl_mvm_vif_from_mac80211(vif);
...
static void iwl_mvm_tdls_check_trigger(struct iwl_mvm *mvm,
...
static int iwl_mvm_sta_state_notexist_to_none(struct iwl_mvm *mvm,
    struct ieee80211_vif *vif,
    struct ieee80211_sta *sta,
...
static int iwl_mvm_sta_state_auth_to_assoc(struct ieee80211_hw *hw,
    struct iwl_mvm *mvm,
    struct ieee80211_vif *vif,
    struct ieee80211_sta *sta,
    const struct iwl_mvm_sta_state_ops *callbacks) {
...
static int iwl_mvm_sta_state_assoc_to_authorized(struct iwl_mvm *mvm,
    struct ieee80211_vif *vif,
    struct ieee80211_sta *sta,
    const struct iwl_mvm_sta_state_ops *callbacks) {
  struct iwl_mvm_vif *mvmvif = iwl_mvm_vif_from_mac80211(vif);
...
static int iwl_mvm_sta_state_authorized_to_assoc(struct iwl_mvm *mvm,
    struct ieee80211_vif *vif,
    struct ieee80211_sta *sta,
    const struct iwl_mvm_sta_state_ops *callbacks) {
  struct iwl_mvm_vif *mvmvif = iwl_mvm_vif_from_mac80211(vif);
