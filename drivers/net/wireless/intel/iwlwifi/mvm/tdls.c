...
static void iwl_mvm_tdls_config(struct iwl_mvm *mvm,
...
static int iwl_mvm_tdls_check_action(struct iwl_mvm *mvm,
...
static int iwl_mvm_tdls_config_channel_switch(struct iwl_mvm *mvm,
    struct ieee80211_vif *vif,
    enum iwl_tdls_channel_switch_type type,
