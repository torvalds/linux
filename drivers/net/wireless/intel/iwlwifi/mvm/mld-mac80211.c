...
static void iwl_mvm_mld_link_info_changed_ap_ibss(struct iwl_mvm *mvm,
    struct ieee80211_vif *vif,
    struct ieee80211_bss_conf *link_conf,
    u64 changes) {
  struct iwl_mvm_vif *mvmvif = iwl_mvm_vif_from_mac80211(vif);
...
static int iwl_mvm_mld_switch_vif_chanctx(struct ieee80211_hw *hw,
...
static int iwl_mvm_mld_mac_conf_tx(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
...
static int iwl_mvm_mld_roc_link(struct iwl_mvm *mvm,
    struct ieee80211_vif *vif) {
  int ret;
...
static int iwl_mvm_mld_change_vif_links(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
...
static int iwl_mvm_mld_change_sta_links(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
    struct ieee80211_sta *sta,
    u16 old_links, u16 new_links) {
  struct iwl_mvm *mvm = IWL_MAC80211_GET_MVM(hw);
...
static enum ieee80211_neg_ttlm_res iwl_mvm_mld_can_neg_ttlm(
