...
static int iwl_mvm_get_wowlan_config(struct iwl_mvm *mvm,
    struct cfg80211_wowlan *wowlan,
...
static int iwl_mvm_wowlan_config(struct iwl_mvm *mvm,
    struct cfg80211_wowlan *wowlan,
    struct iwl_wowlan_config_cmd *wowlan_config_cmd,
    struct ieee80211_vif *vif, struct iwl_mvm_vif *mvmvif,
    struct iwl_mvm_vif_link_info *mvm_link,
...
static int iwl_mvm_netdetect_config(struct iwl_mvm *mvm,
    struct cfg80211_wowlan *wowlan,
...
static void iwl_mvm_le64_to_aes_seq(__le64 le_pn,
    struct ieee80211_key_seq *seq) {
...
static void iwl_mvm_le64_to_tkip_seq(__le64 le_pn,
    struct ieee80211_key_seq *seq) {
  u64 pn = le64_to_cpu(le_pn);
...
static void iwl_mvm_convert_key_counters_v5_gtk_seq(
    struct iwl_wowlan_status_data *status,
...
static void iwl_mvm_convert_key_counters_v5(
    struct iwl_wowlan_status_data *status,
    struct iwl_wowlan_all_rsc_tsc_v5 *sc) {
  int i, tid;
  BUILD_BUG_ON(IWL_MAX_TID_COUNT > IWL_MAX_TID_COUNT);
...
static void iwl_mvm_d3_set_igtk_bigtk_ipn(
    const struct iwl_multicast_key_data *key,
...
static void iwl_mvm_d3_update_igtk_bigtk(struct iwl_wowlan_status_data *status,
    struct ieee80211_key_conf *key,
...
static bool iwl_mvm_d3_igtk_bigtk_rekey_add(
    struct iwl_wowlan_status_data *status,
...
static void iwl_mvm_parse_wowlan_info_notif_v2(struct iwl_mvm *mvm,
...
static struct iwl_wowlan_status_data *iwl_mvm_send_wowlan_get_status(
 ...
 */
static bool iwl_mvm_choose_query_wakeup_reasons(struct iwl_mvm *mvm,
    struct ieee80211_vif *vif,
    struct iwl_d3_data *d3_data) {
  lockdep_assert_held(&mvm->mutex);
...
static int iwl_mvm_wowlan_store_wake_pkt(struct iwl_mvm *mvm,
  ...
  if (WARN_ON(!status)) {
    IWL_ERR(mvm,
        "Got wake packet notification but wowlan status data is NULL\n");
    return -EIO;
  }
