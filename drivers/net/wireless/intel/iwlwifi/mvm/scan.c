...
static enum iwl_mvm_traffic_load iwl_mvm_get_traffic_load_band(
    struct iwl_mvm *mvm, enum nl80211_band band) {
...
static int iwl_ssid_exist(u8 *ssid, u8 ssid_len,
    struct iwl_ssid_ie *ssid_list) {
  int i;
...
static void iwl_mvm_scan_set_legacy_probe_req(
    struct iwl_scan_probe_req_v1 *p_req,
...
static void iwl_mvm_scan_umac_dwell_v11(struct iwl_mvm *mvm,
...
static void iwl_mvm_umac_scan_cfg_channels(struct iwl_mvm *mvm,
    struct ieee80211_channel **channels,
...
static void iwl_mvm_umac_scan_cfg_channels_v4(struct iwl_mvm *mvm,
    struct ieee80211_channel **channels,
...
static void iwl_mvm_umac_scan_cfg_channels_v7(struct iwl_mvm *mvm,
    struct ieee80211_channel **channels,
...
static void iwl_mvm_umac_scan_fill_6g_chan_list(struct iwl_mvm *mvm,
    struct iwl_mvm_scan_params *params,
...
static u32 iwl_mvm_umac_scan_cfg_channels_v7_6g(struct iwl_mvm *mvm,
    struct iwl_mvm_scan_params *params,
    u32 n_channels,
    struct iwl_scan_probe_params_v4 *pp,
    struct iwl_scan_channel_params_v7 *cp,
...
static int iwl_mvm_fill_scan_sched_params(struct iwl_mvm_scan_params *params,
...
static void iwl_mvm_scan_umac_fill_general_p_v12(struct iwl_mvm *mvm,
    struct iwl_mvm_scan_params *params,
    struct ieee80211_vif *vif,
...
static void iwl_mvm_scan_umac_fill_probe_p_v3(
    struct iwl_mvm_scan_params *params,
...
static void iwl_mvm_scan_umac_fill_probe_p_v4(
    struct iwl_mvm_scan_params *params,
    struct iwl_scan_probe_params_v4 *pp,
    u32 *bitmap_ssid) {
  pp->preq = params->preq;
...
static void iwl_mvm_scan_umac_fill_ch_p_v4(struct iwl_mvm *mvm,
    struct iwl_mvm_scan_params *params,
    struct ieee80211_vif *vif,
    struct iwl_scan_channel_params_v4 *cp,
...
static void iwl_mvm_scan_umac_fill_ch_p_v7(struct iwl_mvm *mvm,
    struct iwl_mvm_scan_params *params,
    struct ieee80211_vif *vif,
    struct iwl_scan_channel_params_v7 *cp,
    u32 channel_cfg_flags,
