...
*
* Called by libipw_rx */
static int libipw_rx_frame_mgmt(struct libipw_device *ieee, struct sk_buff *skb,
...
static int libipw_rx_frame_decrypt(struct libipw_device *ieee,
    struct sk_buff *skb,
...
/* Called only as a tasklet (software IRQ), by libipw_rx */
static int libipw_rx_frame_decrypt_msdu(struct libipw_device *ieee,
...
#define MFIE_STRING(x) case WLAN_EID_ ## x: \
    return #x
