...
static u8 il3945_get_rate_idx_by_rssi(s32 rssi, enum nl80211_band band) {
  u32 idx = 0;
  u32 table_size = 0;
...
static void il3945_bg_rate_scale_flush(struct timer_list *t) {
...
static void *il3945_rs_alloc(struct ieee80211_hw *hw) {
  return hw->priv;
}
...
static void *il3945_rs_alloc_sta(void *il_priv, struct ieee80211_sta *sta,
    gfp_t gfp) {
  struct il3945_rs_sta *rs_sta;
 ...
 */
static void il3945_rs_tx_status(void *il_rate,
    struct ieee80211_supported_band *sband,
...
static u16 il3945_get_adjacent_rate(struct il3945_rs_sta *rs_sta, u8 idx,
    u16 rate_mask,
