			   ...
			   size_t count, loff_t *ppos)
{
	...
	int bufsz =
	    ...
	    sizeof(struct stats_rx_yesn_phy) * 40 +
	...
	struct stats_rx_yesn_phy *general, *accum_general;
	struct stats_rx_yesn_phy *delta_general, *max_general;
	 ...
	 * the last stats yestification from uCode
	...
	pos +=
	    scnprintf(buf + pos, bufsz - pos, fmt_table, "yesn_bssid_frames:",
	...
	pos +=
	    scnprintf(buf + pos, bufsz - pos, fmt_table, "yesn_channel_beacons:",
			   ...
			   size_t count, loff_t *ppos)
{
	...
	pos +=
	    scnprintf(buf + pos, bufsz - pos, fmt_table, "agg frame_yest_ready:",
