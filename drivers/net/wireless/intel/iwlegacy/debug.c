...
static void il_clear_traffic_stats(struct il_priv *il) {
...
static const char *il_get_mgmt_string(int cmd) {
  switch (cmd) {
...
static const char *il_get_ctrl_string(int cmd) {
  switch (cmd) {
...
static ssize_t il_dbgfs_tx_stats_read(struct file *file, char __user *user_buf,
    size_t count,
    loff_t *ppos) {
...
static ssize_t il_dbgfs_clear_traffic_stats_write(struct file *file,
...
static ssize_t il_dbgfs_rx_stats_read(struct file *file, char __user *user_buf,
    size_t count,
    loff_t *ppos) {
  struct il_priv *il = file->private_data;
  char *buf;
...
static ssize_t il_dbgfs_sram_read(struct file *file, char __user *user_buf,
    size_t count,
    loff_t *ppos) {
  u32 val;
  char *buf;
...
static ssize_t il_dbgfs_stations_read(struct file *file, char __user *user_buf,
    size_t count,
    loff_t *ppos) {
  struct il_priv *il = file->private_data;
...
static ssize_t il_dbgfs_nvm_read(struct file *file, char __user *user_buf,
    size_t count,
    loff_t *ppos) {
  ssize_t ret;
  struct il_priv *il = file->private_data;
...
static ssize_t il_dbgfs_channels_read(struct file *file, char __user *user_buf,
    size_t count,
    loff_t *ppos) {
  struct il_priv *il = file->private_data;
...
static ssize_t il_dbgfs_status_read(struct file *file, char __user *user_buf,
    size_t count,
    loff_t *ppos) {
  struct il_priv *il = file->private_data;
  char buf[512];
...
static ssize_t il_dbgfs_interrupt_read(struct file *file, char __user *user_buf,
    size_t count,
    loff_t *ppos) {
  struct il_priv *il = file->private_data;
  int pos = 0;
...
static ssize_t il_dbgfs_qos_read(struct file *file, char __user *user_buf,
    size_t count,
    loff_t *ppos) {
  struct il_priv *il = file->private_data;
  int pos = 0, i;
...
static ssize_t il_dbgfs_tx_queue_read(struct file *file, char __user *user_buf,
    size_t count,
    loff_t *ppos) {
  struct il_priv *il = file->private_data;
...
static ssize_t il_dbgfs_rx_queue_read(struct file *file, char __user *user_buf,
    size_t count,
    loff_t *ppos) {
  struct il_priv *il = file->private_data;
...
static ssize_t il_dbgfs_fh_reg_read(struct file *file, char __user *user_buf,
    size_t count,
    loff_t *ppos) {
  struct il_priv *il = file->private_data;
  char *buf;
