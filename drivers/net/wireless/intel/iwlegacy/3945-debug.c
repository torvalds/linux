			   ...
			   size_t count, loff_t *ppos)
{
	...
	int bufsz =
	    ...
	    sizeof(struct iwl39_stats_rx_yesn_phy) * 40 + 400;
	ssize_t ret;
	struct iwl39_stats_rx_phy *ofdm, *accum_ofdm, *delta_ofdm, *max_ofdm;
	struct iwl39_stats_rx_phy *cck, *accum_cck, *delta_cck, *max_cck;
	struct iwl39_stats_rx_yesn_phy *general, *accum_general;
	struct iwl39_stats_rx_yesn_phy *delta_general, *max_general;
