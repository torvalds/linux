 ...
 */
static void il4965_rs_tl_rm_old_stats(struct il_traffic_load *tl,
    u32 curr_time) {
...
static u16 il4965_rs_get_adjacent_rate(struct il_priv *il, u8 idx,
    u16 rate_mask,
    int rate_type) {
 ...
 */
static void il4965_rs_tx_status(void *il_r,
 ...
 */
static void il4965_rs_update_rate_tbl(struct il_priv *il,
    struct il_lq_sta *lq_sta,
...
static void il4965_rs_get_rate(void *il_r, struct ieee80211_sta *sta,
    void *il_sta,
...
static void *il4965_rs_alloc(struct ieee80211_hw *hw) {
  return hw->priv;
}
 ...
 */
static void il4965_rs_rate_init_stub(void *il_r,
    struct ieee80211_supported_band *sband,
