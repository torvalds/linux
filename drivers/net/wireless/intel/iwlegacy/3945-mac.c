 ...
 */
static int il3945_tx_skb(struct il_priv *il,
...
static void il3945_irq_tasklet(struct tasklet_struct *t) {
 ...
 */
static int il3945_verify_inst_sparse(struct il_priv *il, __le32 *image,
    u32 len) {
  u32 val;
  int rc = 0;
  u32 errcnt = 0;
...
static void il3945_mac_tx(struct ieee80211_hw *hw,
...
static int il3945_setup_deferred_work(struct il_priv *il) {
...
static int il3945_pci_probe(struct pci_dev *pdev,
