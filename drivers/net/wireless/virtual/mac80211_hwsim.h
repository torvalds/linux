 ...
 *  to provide details about peer measurement request
 ...
 * @HWSIM_RATE_INFO_ATTR_HE_RU_ALLOC:  HE RU allocation (from &enum
 * nl80211_he_ru_alloc,
 ...
 * @HWSIM_RATE_INFO_ATTR_EHT_RU_ALLOC: EHT RU allocation (from &enum
