...
void wlc_phy_txpower_sromlimit(struct brcms_phy_pub *ppi, uint channel,
    u8 *min_pwr,
...
void wlc_phy_txpower_boardlimit_band(struct brcms_phy_pub *ppi, uint bandunit,
...
void wlc_phy_stf_chain_get(struct brcms_phy_pub *pih, u8 *txchain,
    u8 *rxchain) {
  struct brcms_phy *pi = container_of(pih, struct brcms_phy, pubpi_ro);
