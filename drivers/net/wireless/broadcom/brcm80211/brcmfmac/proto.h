...
static inline void brcmf_proto_configure_addr_mode(struct brcmf_pub *drvr,
    int ifidx,
    enum proto_addr_mode addr_mode) {
...
static inline void brcmf_proto_rxreorder(struct brcmf_if *ifp,
    struct sk_buff *skb) {
  ifp->drvr->proto->rxreorder(ifp, skb);
}

static inline void brcmf_proto_add_if(struct brcmf_pub *drvr,
    struct brcmf_if *ifp) {
...
static inline void brcmf_proto_del_if(struct brcmf_pub *drvr,
    struct brcmf_if *ifp) {
...
static inline void brcmf_proto_reset_if(struct brcmf_pub *drvr,
    struct brcmf_if *ifp) {
...
static inline void brcmf_proto_debugfs_create(struct brcmf_pub *drvr) {
