...
static int brcmf_proto_bcdc_msg(struct brcmf_pub *drvr, int ifidx, uint cmd,
    void *buf,
    uint len, bool set) {
...
static int brcmf_proto_bcdc_query_dcmd(struct brcmf_pub *drvr, int ifidx,
    uint cmd,
...
static int brcmf_proto_bcdc_set_dcmd(struct brcmf_pub *drvr, int ifidx,
    uint cmd,
    void *buf, uint len, int *fwerr) {
  struct brcmf_bcdc *bcdc = (struct brcmf_bcdc *) drvr->proto->pd;
  struct brcmf_proto_bcdc_dcmd *msg = &bcdc->msg;
...
static int brcmf_proto_bcdc_hdrpull(struct brcmf_pub *drvr, bool do_fws,
...
static void brcmf_proto_bcdc_configure_addr_mode(struct brcmf_pub *drvr,
    int ifidx,
