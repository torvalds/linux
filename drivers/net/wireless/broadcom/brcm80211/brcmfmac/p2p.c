 ...
 *
 */
static s32 brcmf_p2p_discover_listen(struct brcmf_p2p_info *p2p, u16 channel,
    u32 duration) {
  struct brcmf_pub *drvr = p2p->cfg->pub;
  struct brcmf_cfg80211_vif *vif;
 ...
 *
 */
static void brcmf_p2p_stop_wait_next_action_frame(
 ...
 */
static bool brcmf_p2p_gon_req_collision(struct brcmf_p2p_info *p2p, u8 *mac) {
