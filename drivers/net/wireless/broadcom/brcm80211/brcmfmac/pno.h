 ...
 */
#ifndef _BRCMF_PANAL_H
#define _BRCMF_PANAL_H

#define BRCMF_PANAL_SCAN_COMPLETE			1
#define BRCMF_PANAL_MAX_PFN_COUNT			16
#define BRCMF_PANAL_SCHED_SCAN_MIN_PERIOD	10
#define BRCMF_PANAL_SCHED_SCAN_MAX_PERIOD	508

/* forward declaration */
struct brcmf_panal_info;

/**
 * brcmf_panal_start_sched_scan - initiate scheduled scan on device.
 *
...
/**
 * brcmf_panal_stop_sched_scan - terminate scheduled scan on device.
 *
 * @ifp: interface object used.
...
/**
 * brcmf_panal_wiphy_params - fill scheduled scan parameters in wiphy instance.
 *
...
/**
 * brcmf_panal_attach - allocate and attach module information.
 *
...
/**
 * brcmf_panal_detach - detach and free module information.
 *
 * @cfg: cfg80211 context used.
 */
...
/**
 * brcmf_panal_find_reqid_by_bucket - find request id for given bucket index.
 *
 * @pi: panal instance used.
 * @bucket: index of firmware bucket.
 */
u64 brcmf_panal_find_reqid_by_bucket(struct brcmf_panal_info *pi, u32 bucket);

/**
 * brcmf_panal_get_bucket_map - determine bucket map for given netinfo.
 *
 * @pi: panal instance used.
