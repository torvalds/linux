...
#define B43legacy_PHY_CLASSCTL    B43legacy_PHY_EXTG(0x02)  /* Classify control
                                                             * */
#define B43legacy_PHY_GTABCTL   B43legacy_PHY_EXTG(0x03)  /* G-PHY table control
                                                           * (see below) */
...
#define B43legacy_PHY_GTABDATA    B43legacy_PHY_EXTG(0x04)  /* G-PHY table data
                                                             * */
#define B43legacy_PHY_LO_MASK   B43legacy_PHY_EXTG(0x0F)  /* Local Oscillator
                                                           * control mask */
#define B43legacy_PHY_LO_CTL    B43legacy_PHY_EXTG(0x10)  /* Local Oscillator
                                                           * control */
...
#define B43legacy_PHY_VERSION_OFDM  B43legacy_PHY_OFDM(0x00)  /* Versioning
                                                               * register for
                                                               * A-PHY */
...
#define  B43legacy_PHY_ANTDWELL_AUTODIV1  0x0100      /* Automatic RX diversity
                                                       * start antenna */
#define B43legacy_PHY_ENCORE    B43legacy_PHY_OFDM(0x49)  /* "Encore" (RangeMax
                                                           * / BroadRange) */
...
#define B43legacy_PHY_OTABLECTL   B43legacy_PHY_OFDM(0x72)  /* OFDM table
                                                             * control (see
                                                             * below) */
...
#define B43legacy_PHY_OTABLEQ   B43legacy_PHY_OFDM(0x74)  /* OFDM table data Q
                                                           * */
#define B43legacy_PHY_HPWR_TSSICTL  B43legacy_PHY_OFDM(0x78)  /* Hardware power
                                                              * TSSI control */
...
#define B43legacy_PHY_ANTWRSETT   B43legacy_PHY_OFDM(0x8C)  /* Antenna WR settle
                                                             * */
#define  B43legacy_PHY_ANTWRSETT_ARXDIV 0x2000        /* Automatic RX diversity
                                                       * enabled */
#define B43legacy_PHY_CLIPPWRDOWNT  B43legacy_PHY_OFDM(0x93)  /* Clip powerdown
                                                               * threshold */
...
#define B43legacy_PHY_DIVSRCHIDX  B43legacy_PHY_OFDM(0xA8)  /* Divider search
                                                             * gain/index */
...
#define B43legacy_PHY_DIVSRCHGAINBACK B43legacy_PHY_OFDM(0xAD)  /* Divider
                                                                 * search gain
                                                                 * back */
#define B43legacy_PHY_DIVSRCHGAINCHNG B43legacy_PHY_OFDM(0xAE)  /* Divider
                                                                 * search gain
                                                                 * change */
#define B43legacy_PHY_CRSTHRES1_R1  B43legacy_PHY_OFDM(0xC0)  /* CRS Threshold 1
                                                               * (rev 1 only) */
#define B43legacy_PHY_CRSTHRES2_R1  B43legacy_PHY_OFDM(0xC1)  /* CRS Threshold 2
                                                               * (rev 1 only) */
#define B43legacy_PHY_TSSIP_LTBASE  B43legacy_PHY_OFDM(0x380) /* TSSI power
                                                               * lookup table
                                                               * base */
#define B43legacy_PHY_DC_LTBASE   B43legacy_PHY_OFDM(0x3A0) /* DC lookup table
                                                             * base */
#define B43legacy_PHY_GAIN_LTBASE B43legacy_PHY_OFDM(0x3C0) /* Gain lookup table
                                                             * base */
