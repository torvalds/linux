...
void b43legacy_nrssi_hw_write(struct b43legacy_wldev *dev, u16 offset,
    s16 val) {
...
static void b43legacy_radio_interference_mitigation_enable(
...
static void b43legacy_radio_interference_mitigation_disable(
    struct b43legacy_wldev *dev,
    int mode) {
  struct b43legacy_phy *phy = &dev->phy;
  u32 tmp32;
