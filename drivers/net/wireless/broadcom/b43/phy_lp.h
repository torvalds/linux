...
#define B43_LPPHY_B_FOURWIRE_ADDR   B43_PHY_CCK(0x0B) /* B PHY Fourwire Address
                                                       * */
#define B43_LPPHY_B_FOURWIRE_DATA_HI    B43_PHY_CCK(0x0C) /* B PHY Fourwire Data
                                                           * Hi */
#define B43_LPPHY_B_FOURWIRE_DATA_LO    B43_PHY_CCK(0x0D) /* B PHY Fourwire Data
                                                           * Lo */
...
#define B43_LPPHY_DETECTOR_DELAY_ADJUST   B43_PHY_OFDM(0x2A) /* Detector Delay
                                                              * Adjust */
#define B43_LPPHY_REDUCED_DETECTOR_DELAY  B43_PHY_OFDM(0x2B) /* Reduced Detector
                                                              * Delay */
#define B43_LPPHY_DATA_TO     B43_PHY_OFDM(0x2C) /* data Timeout */
#define B43_LPPHY_CORRELATOR_DIS_DELAY    B43_PHY_OFDM(0x2D) /* correlator Dis
                                                              * Delay */
...
#define B43_LPPHY_GAIN_MISMATCH_LIMIT   B43_PHY_OFDM(0x31) /* gain Mismatch
                                                            * Limit */
...
#define B43_LPPHY_RADAR_BLANK_INT   B43_PHY_OFDM(0x41) /* Radar blank Interval
                                                        * */
#define B43_LPPHY_RADAR_MIN_FM_INT    B43_PHY_OFDM(0x42) /* Radar min fm
                                                          * Interval */
...
#define B43_LPPHY_RADAR_DETECT_FM_CTL   B43_PHY_OFDM(0x45) /* Radar detect FM
                                                            * Control */
...
#define B43_LPPHY_IQLO_CAL_CMD_N_NUM    B43_PHY_OFDM(0x52) /* iqlo Cal Cmd N num
                                                            * */
#define B43_LPPHY_IQLO_CAL_CMD_G_CTL    B43_PHY_OFDM(0x53) /* iqlo Cal Cmd G
                                                            * control */
#define B43_LPPHY_MACINT_DBG_REGISTER   B43_PHY_OFDM(0x54) /* macint Debug
                                                            * Register */
...
#define B43_LPPHY_PHY_CRS_ENABLE_ADDR   B43_PHY_OFDM(0x58) /* phy CRS Enable
                                                            * Address */
...
#define B43_LPPHY_IDLETIME_CRS_ON_HI    B43_PHY_OFDM(0x5B) /* Idletime CRS On Hi
                                                            * */
#define B43_LPPHY_IDLETIME_MEAS_TIME_LO   B43_PHY_OFDM(0x5C) /* Idletime Meas
                                                              * Time Lo */
#define B43_LPPHY_IDLETIME_MEAS_TIME_HI   B43_PHY_OFDM(0x5D) /* Idletime Meas
                                                              * Time Hi */
#define B43_LPPHY_RESET_LEN_OFDM_TX_ADDR  B43_PHY_OFDM(0x5E) /* Reset len Ofdm
                                                              * TX Address */
#define B43_LPPHY_RESET_LEN_OFDM_RX_ADDR  B43_PHY_OFDM(0x5F) /* Reset len Ofdm
                                                              * RX Address */
#define B43_LPPHY_REG_CRS_ENABLE    B43_PHY_OFDM(0x60) /* reg crs enable */
#define B43_LPPHY_PLCP_TMT_STR0_CTR_MIN   B43_PHY_OFDM(0x61) /* PLCP Tmt Str0
                                                              * Ctr Min */
#define B43_LPPHY_PKT_FSM_RESET_LEN_VAL   B43_PHY_OFDM(0x62) /* Pkt fsm Reset
                                                              * Len Value */
#define B43_LPPHY_READSYM2RESET_CTL   B43_PHY_OFDM(0x63) /* readsym2reset
                                                          * Control */
#define B43_LPPHY_DC_FILTER_DELAY1    B43_PHY_OFDM(0x64) /* Dc filter delay1 */
#define B43_LPPHY_PACKET_RX_ACTIVE_TO   B43_PHY_OFDM(0x65) /* packet rx Active
                                                            * timeout */
...
#define B43_LPPHY_OFDM_TX_PHY_CRS_DELAY_VAL B43_PHY_OFDM(0x69) /* ofdm tx phy
                                                                * CRS Delay
                                                                * Value */
#define B43_LPPHY_CCK_TX_PHY_CRS_DELAY_VAL  B43_PHY_OFDM(0x6A) /* cck tx phy CRS
                                                                * Delay Value */
#define B43_LPPHY_ED_ON_CONFIRM_TIMER_VAL B43_PHY_OFDM(0x6B) /* Ed on confirm
                                                             * Timer Value */
#define B43_LPPHY_ED_OFFSET_CONFIRM_TIMER_VAL B43_PHY_OFDM(0x6C) /* Ed offset
                                                                  * confirm
                                                                  * Timer Value
                                                                  * */
#define B43_LPPHY_PHY_CRS_OFFSET_TIMER_VAL  B43_PHY_OFDM(0x6D) /* phy CRS offset
                                                                * Timer Value */
#define B43_LPPHY_ADC_COMPENSATION_CTL    B43_PHY_OFDM(0x70) /* ADC Compensation
                                                              * Control */
...
#define B43_LPPHY_STR_COLLMAX_SMPL_ADDR   B43_PHY_OFDM(0x7E) /* Str Collmax
                                                              * Sample Address
                                                              * */
#define B43_LPPHY_MAX_SMPL_COARSE_FINE_ADDR B43_PHY_OFDM(0x7F) /* Max Sample
                                                                * Coarse/Fine
                                                                * Address */
#define B43_LPPHY_MAX_SMPL_COARSE_STR0CTR_ADDR  B43_PHY_OFDM(0x80) /* Max Sample
                                                                    * Coarse/Str0Ctr
                                                                    * Address */
#define B43_LPPHY_IQ_ENABLE_WAIT_TIME_ADDR  B43_PHY_OFDM(0x81) /* IQ Enable Wait
                                                                * Time Address
                                                                * */
#define B43_LPPHY_IQ_NUM_SMPLS_ADDR   B43_PHY_OFDM(0x82) /* IQ Num Samples
                                                          * Address */
...
#define B43_LPPHY_IQ_I_PWR_ACC_HI_ADDR    B43_PHY_OFDM(0x85) /* IQ I PWR Acc Hi
                                                              * Address */
#define B43_LPPHY_IQ_I_PWR_ACC_LO_ADDR    B43_PHY_OFDM(0x86) /* IQ I PWR Acc Lo
                                                              * Address */
#define B43_LPPHY_IQ_Q_PWR_ACC_HI_ADDR    B43_PHY_OFDM(0x87) /* IQ Q PWR Acc Hi
                                                              * Address */
#define B43_LPPHY_IQ_Q_PWR_ACC_LO_ADDR    B43_PHY_OFDM(0x88) /* IQ Q PWR Acc Lo
                                                              * Address */
...
#define B43_LPPHY_ADVANCEDRETARDROTOR_ADDR  B43_PHY_OFDM(0x8B) /*
                                                                * AdvancedRetardRotor
                                                                * Address */
#define B43_LPPHY_RSSIADCDELAY_CTL_ADDR   B43_PHY_OFDM(0x8D) /* rssiAdcdelay
                                                              * Control Address
                                                              * */
#define B43_LPPHY_TSSISTAT_ADDR     B43_PHY_OFDM(0x8E) /* tssiStatus Address */
#define B43_LPPHY_TEMPSENSESTAT_ADDR    B43_PHY_OFDM(0x8F) /* tempsenseStatus
                                                            * Address */
#define B43_LPPHY_TEMPSENSE_CTL_ADDR    B43_PHY_OFDM(0x90) /* tempsense Control
                                                            * Address */
...
#define B43_LPPHY_COARSEESTIM_ADDR    B43_PHY_OFDM(0x96) /* Coarseestim Address
                                                          * */
#define B43_LPPHY_STATE_TRANSITION_ADDR   B43_PHY_OFDM(0x97) /* state Transition
                                                              * Address */
...
#define B43_LPPHY_VITERBI_OFFSET_ADDR   B43_PHY_OFDM(0x9A) /* Viterbi Offset
                                                            * Address */
#define B43_LPPHY_SMPL_COLLECT_WAIT_ADDR  B43_PHY_OFDM(0x9B) /* Sample collect
                                                             * wait Address */
#define B43_LPPHY_A_PHY_CTL_ADDR    B43_PHY_OFDM(0x9C) /* A PHY Control Address
                                                        * */
#define B43_LPPHY_NUM_PASS_THROUGH_ADDR   B43_PHY_OFDM(0x9D) /* Num Pass Through
                                                              * Address */
...
#define B43_LPPHY_SMPL_PLAY_BUFFER_CTL    B43_PHY_OFDM(0xA1) /* Sample play
                                                              * Buffer Control
                                                              * */
...
#define   B43_LPPHY_TX_PWR_CTL_CMD_MODE_SW  0x8000 /* TX power control is
                                                    * SOFTWARE */
#define   B43_LPPHY_TX_PWR_CTL_CMD_MODE_HW  0xE000 /* TX power control is
                                                    * HARDWARE */
#define B43_LPPHY_TX_PWR_CTL_NNUM   B43_PHY_OFDM(0xA5) /* TX Power Control Nnum
                                                        * */
#define B43_LPPHY_TX_PWR_CTL_IDLETSSI   B43_PHY_OFDM(0xA6) /* TX Power Control
                                                            * IdleTssi */
#define B43_LPPHY_TX_PWR_CTL_TARGETPWR    B43_PHY_OFDM(0xA7) /* TX Power Control
                                                              * TargetPower */
#define B43_LPPHY_TX_PWR_CTL_DELTAPWR_LIMIT B43_PHY_OFDM(0xA8) /* TX Power
                                                                * Control
                                                                * DeltaPower
                                                                * Limit */
#define B43_LPPHY_TX_PWR_CTL_BASEINDEX    B43_PHY_OFDM(0xA9) /* TX Power Control
                                                              * BaseIndex */
#define B43_LPPHY_TX_PWR_CTL_PWR_INDEX    B43_PHY_OFDM(0xAA) /* TX Power Control
                                                              * Power Index */
#define B43_LPPHY_TX_PWR_CTL_STAT   B43_PHY_OFDM(0xAB) /* TX Power Control
                                                        * Status */
#define B43_LPPHY_LP_RF_SIGNAL_LUT    B43_PHY_OFDM(0xAC) /* LP RF signal LUT */
#define B43_LPPHY_RX_RADIO_CTL_FILTER_STATE B43_PHY_OFDM(0xAD) /* RX Radio
                                                                * Control Filter
                                                                * State */
...
#define B43_LPPHY_PS_CTL_OVERRIDE_VAL0    B43_PHY_OFDM(0xB2) /* PS Control
                                                              * override val0 */
#define B43_LPPHY_PS_CTL_OVERRIDE_VAL1    B43_PHY_OFDM(0xB3) /* PS Control
                                                              * override val1 */
#define B43_LPPHY_PS_CTL_OVERRIDE_VAL2    B43_PHY_OFDM(0xB4) /* PS Control
                                                              * override val2 */
#define B43_LPPHY_TX_GAIN_CTL_OVERRIDE_VAL  B43_PHY_OFDM(0xB5) /* TX gain
                                                                * Control
                                                                * override val
                                                                * */
#define B43_LPPHY_RX_GAIN_CTL_OVERRIDE_VAL  B43_PHY_OFDM(0xB6) /* RX gain
                                                                * Control
                                                                * override val
                                                                * */
#define B43_LPPHY_AFE_DDFS      B43_PHY_OFDM(0xB7) /* AFE DDFS */
#define B43_LPPHY_AFE_DDFS_POINTER_INIT   B43_PHY_OFDM(0xB8) /* AFE DDFS pointer
                                                              * init */
...
#define B2062_N_IQ_CALIB_CTL0     B43_LP_NORTH(0x05A) /* IQ Calibration Control
                                                       * 0 (north) */
#define B2062_N_IQ_CALIB_CTL1     B43_LP_NORTH(0x05B) /* IQ Calibration Control
                                                       * 1 (north) */
#define B2062_N_IQ_CALIB_CTL2     B43_LP_NORTH(0x05C) /* IQ Calibration Control
                                                       * 2 (north) */
#define B2062_N_CALIB_TS      B43_LP_NORTH(0x05D) /* Calibration TS (north) */
#define B2062_N_CALIB_CTL0      B43_LP_NORTH(0x05E) /* Calibration Control 0
                                                     * (north) */
#define B2062_N_CALIB_CTL1      B43_LP_NORTH(0x05F) /* Calibration Control 1
                                                     * (north) */
#define B2062_N_CALIB_CTL2      B43_LP_NORTH(0x060) /* Calibration Control 2
                                                     * (north) */
#define B2062_N_CALIB_CTL3      B43_LP_NORTH(0x061) /* Calibration Control 3
                                                     * (north) */
#define B2062_N_CALIB_CTL4      B43_LP_NORTH(0x062) /* Calibration Control 4
                                                     * (north) */
#define B2062_N_CALIB_DBG0      B43_LP_NORTH(0x063) /* Calibration Debug 0
                                                     * (north) */
#define B2062_N_CALIB_DBG1      B43_LP_NORTH(0x064) /* Calibration Debug 1
                                                     * (north) */
#define B2062_N_CALIB_DBG2      B43_LP_NORTH(0x065) /* Calibration Debug 2
                                                     * (north) */
#define B2062_N_CALIB_DBG3      B43_LP_NORTH(0x066) /* Calibration Debug 3
                                                     * (north) */
...
#define B2062_S_REFPLL_CTL9     B43_LP_SOUTH(0x02C) /* REFPLL Control 09 (south)
                                                     * */
#define B2062_S_REFPLL_CTL10      B43_LP_SOUTH(0x02D) /* REFPLL Control 10
                                                       * (south) */
#define B2062_S_REFPLL_CTL11      B43_LP_SOUTH(0x02E) /* REFPLL Control 11
                                                       * (south) */
#define B2062_S_REFPLL_CTL12      B43_LP_SOUTH(0x02F) /* REFPLL Control 12
                                                       * (south) */
#define B2062_S_REFPLL_CTL13      B43_LP_SOUTH(0x030) /* REFPLL Control 13
                                                       * (south) */
#define B2062_S_REFPLL_CTL14      B43_LP_SOUTH(0x031) /* REFPLL Control 14
                                                       * (south) */
#define B2062_S_REFPLL_CTL15      B43_LP_SOUTH(0x032) /* REFPLL Control 15
                                                       * (south) */
#define B2062_S_REFPLL_CTL16      B43_LP_SOUTH(0x033) /* REFPLL Control 16
                                                       * (south) */
...
#define B2063_RC_CALIB_CTL9     B43_LP_RADIO(0x062) /* RC Calibration Control 9
                                                     * */
#define B2063_RC_CALIB_CTL10      B43_LP_RADIO(0x063) /* RC Calibration Control
                                                       * 10 */
...
#define B2063_PLL_JTAG_PLL_CTL1     B43_LP_RADIO(0x06B) /* PLL JTAG PLL Control
                                                         * 1 */
...
#define B2063_PLL_JTAG_PLL_VCO_CALIB1   B43_LP_RADIO(0x077) /* PLL JTAG PLL VCO
                                                             * Calibration 1 */
#define B2063_PLL_JTAG_PLL_VCO_CALIB2   B43_LP_RADIO(0x078) /* PLL JTAG PLL VCO
                                                             * Calibration 2 */
#define B2063_PLL_JTAG_PLL_VCO_CALIB3   B43_LP_RADIO(0x079) /* PLL JTAG PLL VCO
                                                             * Calibration 3 */
#define B2063_PLL_JTAG_PLL_VCO_CALIB4   B43_LP_RADIO(0x07A) /* PLL JTAG PLL VCO
                                                             * Calibration 4 */
#define B2063_PLL_JTAG_PLL_VCO_CALIB5   B43_LP_RADIO(0x07B) /* PLL JTAG PLL VCO
                                                             * Calibration 5 */
#define B2063_PLL_JTAG_PLL_VCO_CALIB6   B43_LP_RADIO(0x07C) /* PLL JTAG PLL VCO
                                                             * Calibration 6 */
#define B2063_PLL_JTAG_PLL_VCO_CALIB7   B43_LP_RADIO(0x07D) /* PLL JTAG PLL VCO
                                                             * Calibration 7 */
#define B2063_PLL_JTAG_PLL_VCO_CALIB8   B43_LP_RADIO(0x07E) /* PLL JTAG PLL VCO
                                                             * Calibration 8 */
#define B2063_PLL_JTAG_PLL_VCO_CALIB9   B43_LP_RADIO(0x07F) /* PLL JTAG PLL VCO
                                                             * Calibration 9 */
#define B2063_PLL_JTAG_PLL_VCO_CALIB10    B43_LP_RADIO(0x080) /* PLL JTAG PLL
                                                               * VCO Calibration
                                                               * 10 */
#define B2063_PLL_JTAG_PLL_XTAL_12    B43_LP_RADIO(0x081) /* PLL JTAG PLL XTAL 1
                                                           * 2 */
...
#define B2063_LO_CALIB_CTL3     B43_LP_RADIO(0x08B) /* LO Calibration Control 3
                                                     * */
#define B2063_LO_CALIB_WAITCNT      B43_LP_RADIO(0x08C) /* LO Calibration
                                                         * WAITCNT */
...
#define B2063_LO_CALIB_OVAL7      B43_LP_RADIO(0x095) /* LO Calibration OVAL 7
                                                       * */
#define B2063_LO_CALIB_CALVLD1      B43_LP_RADIO(0x096) /* LO Calibration CALVLD
                                                         * 1 */
#define B2063_LO_CALIB_CALVLD2      B43_LP_RADIO(0x097) /* LO Calibration CALVLD
                                                         * 2 */
