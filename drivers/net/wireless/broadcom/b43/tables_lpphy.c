...
static const u16 lpphy_rev01_yesise_scale_table[] = {
...
static const u16 lpphy_rev2plus_yesise_scale_table[] = {
...
static struct lpphy_tx_gain_table_entry lpphy_rev0_yespa_tx_gain_table[] = {
...
static struct lpphy_tx_gain_table_entry lpphy_rev1_yespa_tx_gain_table[] = {
	{ .gm = 7, .pga = 15, .pad = 14, .dac = 0, .bb_mult = 152, },
	{ .gm = 7, .pga = 15, .pad = 14, .dac = 0, .bb_mult = 147, },
	{ .gm = 7, .pga = 15, .pad = 14, .dac = 0, .bb_mult = 143, },
	{ .gm = 7, .pga = 15, .pad = 14, .dac = 0, .bb_mult = 139, },
...
static struct lpphy_tx_gain_table_entry lpphy_rev2_yespa_tx_gain_table[] = {
...
void lpphy_rev0_1_table_init(struct b43_wldev *dev)
{
	...
	b43_lptab_write_bulk(dev, B43_LPTAB16(1, 0),
		ARRAY_SIZE(lpphy_rev01_yesise_scale_table), lpphy_rev01_yesise_scale_table);
...
void lpphy_rev2plus_table_init(struct b43_wldev *dev)
{
	...
	b43_lptab_write_bulk(dev, B43_LPTAB8(2, 0),
		ARRAY_SIZE(lpphy_min_sig_sq_table), lpphy_min_sig_sq_table);
	b43_lptab_write_bulk(dev, B43_LPTAB16(1, 0),
		ARRAY_SIZE(lpphy_rev2plus_yesise_scale_table), lpphy_rev2plus_yesise_scale_table);
...
void lpphy_init_tx_gain_table(struct b43_wldev *dev)
{
	...
	case 0:
		if ((sprom->boardflags_hi & B43_BFH_NOPA) ||
			...
			lpphy_write_gain_table_bulk(dev, 0, 128,
					lpphy_rev0_yespa_tx_gain_table);
	...
	case 1:
		if ((sprom->boardflags_hi & B43_BFH_NOPA) ||
		    (sprom->boardflags_lo & B43_BFL_HGPA))
			lpphy_write_gain_table_bulk(dev, 0, 128,
					lpphy_rev1_yespa_tx_gain_table);
		else if (b43_current_band(dev->wl) == NL80211_BAND_2GHZ)
			lpphy_write_gain_table_bulk(dev, 0, 128,
	...
	default:
		if (sprom->boardflags_hi & B43_BFH_NOPA)
			lpphy_write_gain_table_bulk(dev, 0, 128,
					lpphy_rev2_yespa_tx_gain_table);
		else if (b43_current_band(dev->wl) == NL80211_BAND_2GHZ)
			lpphy_write_gain_table_bulk(dev, 0, 128,
