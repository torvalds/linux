...
#define  B43_PHY_HT_TXPCTL_CMD_C1_COEFF   0x2000  /* Power control coefficients
                                                   * */
#define  B43_PHY_HT_TXPCTL_CMD_C1_HWPCTLEN  0x4000  /* Hardware TX power control
                                                     * enable */
...
#define B43_PHY_HT_TXPCTL_IDLE_TSSI2    B43_PHY_EXTG(0x165) /* TX power control
                                                             * idle TSSI */
#define  B43_PHY_HT_TXPCTL_IDLE_TSSI2_C3  0x003F
#define  B43_PHY_HT_TXPCTL_IDLE_TSSI2_C3_SHIFT  0
#define B43_PHY_HT_TXPCTL_TARG_PWR2   B43_PHY_EXTG(0x166) /* TX power control
                                                           * target power */
