...
#define B43_PHY_VERSION_OFDM    B43_PHY_OFDM(0x00)  /* Versioning register for
                                                     * A-PHY */
#define B43_PHY_BBANDCFG    B43_PHY_OFDM(0x01)  /* Baseband config */
#define  B43_PHY_BBANDCFG_RXANT   0x180 /* RX Antenna selection */
#define  B43_PHY_BBANDCFG_RXANT_SHIFT 7
#define B43_PHY_PWRDOWN     B43_PHY_OFDM(0x03)  /* Powerdown */
#define B43_PHY_CRSTHRES1_R1    B43_PHY_OFDM(0x06)  /* CRS Threshold 1 (phy.rev
                                                     * 1 only) */
...
#define  B43_PHY_ANTDWELL_AUTODIV1  0x0100  /* Automatic RX diversity start
                                             * antenna */
#define B43_PHY_ENCORE      B43_PHY_OFDM(0x49)  /* "Encore" (RangeMax /
                                                 * BroadRange) */
...
#define B43_PHY_OTABLECTL   B43_PHY_OFDM(0x72)  /* OFDM table control (see
                                                 * below) */
...
#define B43_PHY_HPWR_TSSICTL    B43_PHY_OFDM(0x78)  /* Hardware power TSSI
                                                     * control */
...
#define B43_PHY_CCKSHIFTBITS_WA   B43_PHY_OFDM(0xA5)  /* CCK shiftbits
                                                       * workaround, FIXME
                                                       * rename */
...
#define B43_PHY_DIVSRCHGAINBACK   B43_PHY_OFDM(0xAD)  /* Divider search gain
                                                       * back */
#define B43_PHY_DIVSRCHGAINCHNG   B43_PHY_OFDM(0xAE)  /* Divider search gain
                                                       * change */
#define B43_PHY_CRSTHRES1   B43_PHY_OFDM(0xC0)  /* CRS Threshold 1 (phy.rev >= 2
                                                 * only) */
#define B43_PHY_CRSTHRES2   B43_PHY_OFDM(0xC1)  /* CRS Threshold 2 (phy.rev >= 2
                                                 * only) */
#define B43_PHY_TSSIP_LTBASE    B43_PHY_OFDM(0x380) /* TSSI power lookup table
                                                     * base */
...
#define B43_OFDMTAB(number, \
      offset) (((number) << B43_PHY_OTABLENR_SHIFT) | (offset))
