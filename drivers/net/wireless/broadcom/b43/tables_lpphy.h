...
#define B43_LPTAB16(table, \
      offset)  (((table) << 10) | (offset) | B43_LPTAB_16BIT)
#define B43_LPTAB32(table, \
      offset)  (((table) << 10) | (offset) | B43_LPTAB_32BIT)

/* Table definitions */
#define B43_LPTAB_TXPWR_R2PLUS    B43_LPTAB32(0x07, 0) /* TX power lookup table
                                                        * (rev >= 2) */
#define B43_LPTAB_TXPWR_R0_1    B43_LPTAB32(0xA0, 0) /* TX power lookup table
                                                      * (rev < 2) */
