...
static void b43_radio_2059_channel_setup(struct b43_wldev *dev,
  ...
  static const u16 routing[] = {
    R2059_C1, R2059_C2, R2059_C3,
  };
  u16 r;
  int core;
...
static void b43_phy_ht_pa_override(struct b43_wldev *dev, bool enable) {
  ...
  static const u16 regs[3] = {
    B43_PHY_HT_RF_CTL_INT_C1,
...
static void b43_phy_ht_read_clip_detection(struct b43_wldev *dev,
    u16 *clip_st) {
...
static void b43_phy_ht_run_samples(struct b43_wldev *dev, u16 samps, u16 loops,
  ...
  for (i = 0; i < 3; i++) {
    if (phy_ht->bb_mult_save[i] < 0) {
      phy_ht->bb_mult_save[i] = b43_httab_read(dev, B43_HTTAB16(13,
          0x63 + i * 4));
    }
  }
...
static enum b43_txpwr_result b43_phy_ht_op_recalc_txpower(struct b43_wldev *dev,
    bool ignore_tssi) {
