...
#define B43_BFL_AIRLINEMODE   0x0004  /* implements GPIO 13 radio disable
                                       * indication */
...
#define B43_BFL2_APLL_WAR   0x0002  /* alternative A-band PLL settings
                                     * implemented */
...
#define B43_BFL2_SPUR_WAR   0x0200  /* has a workaround for clock-harmonic spurs
                                     * */
#define B43_BFL2_GPLL_WAR   0x0400  /* altenative G-band PLL settings
                                     * implemented */
...
#define B43_SHM_SH_FWCAPA   0x0042  /* Firmware capabilities (Opensource
                                     * firmware only) */
...
#define B43_SHM_SH_PHYTXNOI   0x006E  /* PHY noise directly after TX (lower 8bit
                                       * only) */
...
#define B43_SHM_SH_MACHW_L    0x00C0  /* Location where the ucode expects the
                                       * MAC capabilities */
#define B43_SHM_SH_MACHW_H    0x00C2  /* Location where the ucode expects the
                                       * MAC capabilities */
#define B43_SHM_SH_HOSTF5   0x00D4  /* Hostflags 5 for ucode options */
#define B43_SHM_SH_BCMCFIFOID   0x0108  /* Last posted cookie to the bcast/mcast
                                         * FIFO */
/* TSSI information */
...
#define B43_SHM_SH_SIZE01   0x0098  /* TX FIFO size for FIFO 0 (low) and 1
                                     * (high) */
...
#define B43_SHM_SH_NRRXTRANS    0x003E  /* # of soft RX transmitter addresses
                                         * (max 8) */
#define B43_SHM_SH_KTP      0x0056  /* Key table pointer */
#define B43_SHM_SH_TKIPTSCTTAK    0x0318
#define B43_SHM_SH_KEYIDXBLOCK    0x05D4  /* Key index/algorithm block (v4
                                           * firmware) */
#define B43_SHM_SH_PSM      0x05F4  /* PSM transmitter address match block (rev
                                     * < 5) */
...
#define B43_SHM_SH_BEACPHYCTL   0x0054  /* Beacon PHY TX control word (see PHY
                                         * TX control) */
#define B43_SHM_SH_EXTNPHYCTL   0x00B0  /* Extended bytes for beacon PHY control
                                         * (N) */
#define B43_SHM_SH_BCN_LI   0x00B6  /* beacon listen interval */
/* SHM_SHARED ACK/CTS control */
#define B43_SHM_SH_ACKCTSPHYCTL   0x0022  /* ACK/CTS PHY control word (see PHY
                                           * TX control) */
...
#define B43_SHM_SC_SCFB     0x0017  /* Short frame transmit count threshold for
                                     * rate fallback */
#define B43_SHM_SC_LCFB     0x0018  /* Long frame transmit count threshold for
                                     * rate fallback */
...
#define B43_HF_CCKBOOST   0x000000000008ULL /* 4dB CCK power boost (exclusive
                                             * with OFDM boost) */
#define B43_HF_BTCOEX   0x000000000010ULL /* Bluetooth coexistance */
#define B43_HF_GDCW   0x000000000020ULL /* G-PHY DC canceller filter bw
                                         * workaround */
...
#define B43_HF_TSSIRPSMW  0x000000000200ULL /* TSSI reset PSM ucode workaround
                                             * */
#define B43_HF_20IN40IQW  0x000000000200ULL /* 20 in 40 MHz I/Q workaround (rev
                                             * >= 13 only) */
#define B43_HF_DSCRQ    0x000000000400ULL /* Disable slow clock request in ucode
                                           * */
#define B43_HF_ACIW   0x000000000800ULL /* ACI workaround: shift bits by 2 on
                                         * PHY CRS */
...
#define B43_HF_BT4PRIOCOEX  0x000000010000ULL /* Bluetooth 4-priority
                                               * coexistance */
#define B43_HF_FWKUP    0x000000020000ULL /* Fast wake-up ucode */
#define B43_HF_VCORECALC  0x000000040000ULL /* Force VCO recalculation when
                                             * powering up synthpu */
#define B43_HF_PCISCW   0x000000080000ULL /* PCI slow clock workaround */
#define B43_HF_4318TSSI   0x000000200000ULL /* 4318 TSSI */
#define B43_HF_FBCMCFIFO  0x000000400000ULL /* Flush bcast/mcast FIFO
                                             * immediately */
#define B43_HF_HWPCTL   0x000000800000ULL /* Enable hardwarre power control */
#define B43_HF_BTCOEXALT  0x000001000000ULL /* Bluetooth coexistance in
                                             * alternate pins */
#define B43_HF_TXBTCHECK  0x000002000000ULL /* Bluetooth check during
                                             * transmission */
#define B43_HF_SKCFPUP    0x000004000000ULL /* Skip CFP update */
#define B43_HF_N40W   0x000008000000ULL /* N PHY 40 MHz workaround (rev >= 13
                                         * only) */
#define B43_HF_ANTSEL   0x000020000000ULL /* Antenna selection (for testing
                                           * antenna div.) */
#define B43_HF_BT3COEXT   0x000020000000ULL /* Bluetooth 3-wire coexistence (rev
                                             * >= 13 only) */
#define B43_HF_BTCANT   0x000040000000ULL /* Bluetooth coexistence (antenna
                                           * mode) (rev >= 13 only) */
#define B43_HF_ANTSELEN   0x000100000000ULL /* Antenna selection enabled (rev >=
                                             * 13 only) */
#define B43_HF_ANTSELMODE 0x000200000000ULL /* Antenna selection mode (rev >= 13
                                             * only) */
#define B43_HF_MLADVW   0x001000000000ULL /* N PHY ML ADV workaround (rev >= 13
                                           * only) */
#define B43_HF_PR45960W   0x080000000000ULL /* PR 45960 workaround (rev >= 13
                                             * only) */
...
#define B43_MACCMD_BEACON0_VALID  0x00000001  /* Beacon 0 in template RAM is
                                               * busy/valid */
#define B43_MACCMD_BEACON1_VALID  0x00000002  /* Beacon 1 in template RAM is
                                               * busy/valid */
#define B43_MACCMD_DFQ_VALID    0x00000004  /* Directed frame queue valid (IBSS
                                             * PS mode, ATIM) */
...
#define B43_BCMA_IOCTL_PLLREFSEL  0x00000020  /* PLL Frequency Reference Select
                                               * */
#define B43_BCMA_IOCTL_PHY_BW   0x000000C0  /* PHY band width and clock speed
                                             * mask (N-PHY+ only?) */
#define  B43_BCMA_IOCTL_PHY_BW_10MHZ  0x00000000  /* 10 MHz bandwidth, 40 MHz
                                                   * PHY */
#define  B43_BCMA_IOCTL_PHY_BW_20MHZ  0x00000040  /* 20 MHz bandwidth, 80 MHz
                                                   * PHY */
#define  B43_BCMA_IOCTL_PHY_BW_40MHZ  0x00000080  /* 40 MHz bandwidth, 160 MHz
                                                   * PHY */
...
#define B43_TMSLOW_PHY_BANDWIDTH  0x00C00000  /* PHY band width and clock speed
                                               * mask (N-PHY only) */
#define  B43_TMSLOW_PHY_BANDWIDTH_10MHZ 0x00000000  /* 10 MHz bandwidth, 40 MHz
                                                     * PHY */
#define  B43_TMSLOW_PHY_BANDWIDTH_20MHZ 0x00400000  /* 20 MHz bandwidth, 80 MHz
                                                     * PHY */
#define  B43_TMSLOW_PHY_BANDWIDTH_40MHZ 0x00800000  /* 40 MHz bandwidth, 160 MHz
                                                     * PHY */
#define B43_TMSLOW_PLLREFSEL    0x00200000  /* PLL Frequency Reference Select
                                             * (rev >= 5) */
#define B43_TMSLOW_MACPHYCLKEN    0x00100000  /* MAC PHY Clock Control Enable
                                               * (rev >= 5) */
...
#define B43_TMSHIGH_HAVE_5GHZ_PHY 0x00020000  /* 5 GHz PHY available (rev >= 5)
                                               * */
#define B43_TMSHIGH_HAVE_2GHZ_PHY 0x00010000  /* 2.4 GHz PHY available (rev >=
                                               * 5) */
...
struct b43_firmware_file {
   ...
   * If you want to check for proprietary vs opensource, use (struct
   * b43_firmware)->opensource
   * instead! The (struct b43_firmware)->opensource flag is derived from the
   * actual firmware
