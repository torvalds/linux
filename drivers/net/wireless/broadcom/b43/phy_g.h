...
#define B43_PHY_VERSION_CCK   B43_PHY_CCK(0x00) /* Versioning register for B-PHY
                                                 * */
#define B43_PHY_CCKBBANDCFG   B43_PHY_CCK(0x01) /* Contains antenna 0/1 control
                                                 * bit */
...
#define B43_PHY_GTABCTL     B43_PHY_EXTG(0x03)  /* G-PHY table control (see
                                                 * below) */
...
#define   B43_PHY_RFOVERVAL_BW_LBW  0x0002  /* Low Bandwidth (when set), high
                                             * when unset */
...
#define B43_GTAB(number, \
      offset)  (((number) << B43_PHY_GTABNR_SHIFT) | (offset))
