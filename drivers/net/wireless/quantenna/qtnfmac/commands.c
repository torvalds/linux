...
int qtnf_cmd_send_register_mgmt(struct qtnf_vif *vif, u16 frame_type,
    bool reg) {
  struct sk_buff *cmd_skb;
...
static void qtnf_sta_info_parse_rate(struct rate_info *rate_dst,
...
static void qtnf_sta_info_parse_flags(struct nl80211_sta_flag_update *dst,
...
static void qtnf_cmd_sta_info_parse(struct station_info *sinfo, const u8 *data,
    size_t resp_size) {
...
static void qtnf_parse_wowlan_info(struct qtnf_wmac *mac,
...
static int qtnf_cmd_resp_proc_mac_info(struct qtnf_wmac *mac,
...
static int qtnf_cmd_resp_fill_band_info(struct ieee80211_supported_band *band,
...
static int qtnf_cmd_resp_proc_chan_stat_info(struct survey_info *survey,
...
int qtnf_cmd_get_channel(struct qtnf_vif *vif,
