...
static int qtnf_event_handle_sta_assoc(struct qtnf_wmac *mac,
    struct qtnf_vif *vif,
...
static int qtnf_event_handle_sta_deauth(struct qtnf_wmac *mac,
    struct qtnf_vif *vif,
...
static int qtnf_event_handle_bss_join(struct qtnf_vif *vif,
...
static int qtnf_event_handle_bss_leave(struct qtnf_vif *vif,
...
static int qtnf_event_handle_scan_complete(struct qtnf_wmac *mac,
...
static int qtnf_event_handle_freq_change(struct qtnf_wmac *mac,
...
static int qtnf_event_handle_external_auth(struct qtnf_vif *vif,
...
static int qtnf_event_handle_mic_failure(struct qtnf_vif *vif,
...
static int qtnf_event_handle_update_owe(struct qtnf_vif *vif,
