...
static struct host_if_msg *wilc_alloc_work(struct wilc_vif *vif, void (*work_fun)(
    struct work_struct *),
    bool is_sync) {
...
struct wilc_join_bss_param *wilc_parse_join_bss_param(struct cfg80211_bss *bss,
