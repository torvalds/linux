...
int wfx_hif_read_mib(struct wfx_dev *wdev, int vif_id, u16 mib_id, void *val,
    size_t val_len) {
  int ret;
  struct wfx_hif_msg *hif;
...
int wfx_hif_write_mib(struct wfx_dev *wdev, int vif_id, u16 mib_id, void *val,
    size_t val_len) {
  int ret;
  struct wfx_hif_msg *hif;
...
int wfx_hif_scan(struct wfx_vif *wvif, struct cfg80211_scan_request *req,
  ...
  int ret, i;
  struct wfx_hif_msg *hif;
  size_t buf_len = sizeof(struct wfx_hif_req_start_scan_alt) + chan_num
      * sizeof(u8);
  struct wfx_hif_req_start_scan_alt *body = wfx_alloc_hif(buf_len, &hif);
...
int wfx_hif_set_edca_queue_params(struct wfx_vif *wvif, u16 queue,
  ...
  int ret;
  struct wfx_hif_msg *hif;
  struct wfx_hif_req_edca_queue_params *body
