...
static inline void debugfs_init(struct ser_device *ser,
    struct tty_struct *tty) {
...
static inline void debugfs_rx(struct ser_device *ser, const u8 *data,
    int size) {
...
static inline void debugfs_tx(struct ser_device *ser, const u8 *data,
    int size) {
