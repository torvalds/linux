...
#define PTP_TXTS                  0x001c /* PTP Transmit Timestamp Register, in
                                          * four 16-bit reads */
#define PTP_RXTS                  0x001d /* PTP Receive Timestamp Register, in
                                          * six? 16-bit reads */
...
#define PTP_TXCFG0                0x0016 /* PTP Transmit Configuration Register
                                          * 0 */
#define PTP_TXCFG1                0x0017 /* PTP Transmit Configuration Register
                                          * 1 */
#define PSF_CFG0                  0x0018 /* PHY Status Frame Configuration
                                          * Register 0 */
...
#define PTP_RXCFG4                0x001d /* PTP Receive Configuration Register 4
                                          * */
#define PTP_TRDL                  0x001e /* PTP Temporary Rate Duration Low
                                          * Register */
#define PTP_TRDH                  0x001f /* PTP Temporary Rate Duration High
                                          * Register */

#define PAGE6                     0x0006
#define PTP_COC                   0x0014 /* PTP Clock Output Control Register */
#define PSF_CFG1                  0x0015 /* PHY Status Frame Configuration
                                          * Register 1 */
#define PSF_CFG2                  0x0016 /* PHY Status Frame Configuration
                                          * Register 2 */
#define PSF_CFG3                  0x0017 /* PHY Status Frame Configuration
                                          * Register 3 */
#define PSF_CFG4                  0x0018 /* PHY Status Frame Configuration
                                          * Register 4 */
...
#define TXTS_IE                   (1 << 3)  /* Transmit Timestamp Interrupt
                                             * Enable */
#define RXTS_IE                   (1 << 2)  /* Receive Timestamp Interrupt
                                             * Enable */
...
#define EVNT_TS_LEN_SHIFT         (6)     /* Indicates length of the Timestamp
                                           * field in 16-bit words minus 1 */
#define EVNT_TS_LEN_MASK          (0x3)
#define EVNT_RF                   (1 << 5)  /* Indicates whether the event is a
                                             * rise or falling event */
#define EVNT_NUM_SHIFT            (2)     /* Indicates Event Timestamp Unit
                                           * which detected an event */
#define EVNT_NUM_MASK             (0x7)
#define MULT_EVNT                 (1 << 1)  /* Indicates multiple events were
...
#define TRIG_PULSE                (1 << 15) /* generate a Pulse rather than a
                                             * single edge */
#define TRIG_PER                  (1 << 14) /* generate a periodic signal */
#define TRIG_IF_LATE              (1 << 13) /* trigger immediately if already
                                             * past */
...
#define EVNT_SINGLE               (1 << 12) /* enable single event capture
                                             * operation */
...
#define SYNC_1STEP                (1 << 15) /* insert timestamp into transmit
                                             * Sync Messages */
#define DR_INSERT                 (1 << 13) /* Insert Delay_Req Timestamp in
                                             * Delay_Resp (dangerous) */
#define NTP_TS_EN                 (1 << 12) /* Enable Timestamping of NTP
                                             * Packets */
#define IGNORE_2STEP              (1 << 11) /* Ignore Two_Step flag for One-Step
                                             * operation */
#define CRC_1STEP                 (1 << 10) /* Disable checking of CRC for
                                             * One-Step operation */
#define CHK_1STEP                 (1 << 9)  /* Enable UDP Checksum correction
                                             * for One-Step Operation */
#define IP1588_EN                 (1 << 8)  /* Enable IEEE 1588 defined IP
                                             * address filter */
...
#define TX_PTP_VER_SHIFT          (1)     /* Enable Timestamp capture for IEEE
                                           * 1588 version X */
#define TX_PTP_VER_MASK           (0xf)
#define TX_TS_EN                  (1 << 0)  /* Transmit Timestamp Enable */

/* Bit definitions for the PTP_TXCFG1 register */
#define BYTE0_MASK_SHIFT          (8)     /* Bit mask to be used for matching
                                           * Byte0 of the PTP Message */
#define BYTE0_MASK_MASK           (0xff)
#define BYTE0_DATA_SHIFT          (0)     /* Data to be used for matching Byte0
                                           * of the PTP Message */
...
#define PSF_PCF_RD                (1 << 5)  /* Control Frame Read PHY Status
                                             * Frame Enable */
#define PSF_ERR_EN                (1 << 4)  /* Error PHY Status Frame Enable */
#define PSF_TXTS_EN               (1 << 3)  /* Transmit Timestamp PHY Status
                                             * Frame Enable */
#define PSF_RXTS_EN               (1 << 2)  /* Receive Timestamp PHY Status
                                             * Frame Enable */
...
#define ALT_MAST_DIS              (1 << 14) /* Alternate Master Timestamp
                                             * Disable */
#define USER_IP_SEL               (1 << 13) /* Selects portion of IP address
                                             * accessible thru PTP_RXCFG2 */
#define USER_IP_EN                (1 << 12) /* Enable User-programmed IP address
                                             * filter */
#define RX_SLAVE                  (1 << 11) /* Receive Slave Only */
#define IP1588_EN_SHIFT           (8)     /* Enable IEEE 1588 defined IP address
                                           * filters */
...
#define RX_PTP_VER_SHIFT          (1)     /* Enable Timestamp capture for IEEE
                                           * 1588 version X */
...
#define ACC_UDP                   (1 << 11) /* Record Timestamp if UDP Checksum
                                             * Error */
...
#define RXTS_NS_OFF_SHIFT         (6)     /* Receive Timestamp Nanoseconds
                                           * offset */
...
#define TRANSPORT_SPECIFIC_SHIFT  (4)     /* PTP v2 Header transportSpecific
                                           * field */
...
#define PTP_OFFSET_SHIFT          (0)     /* PTP Message offset from preceding
                                           * header */
