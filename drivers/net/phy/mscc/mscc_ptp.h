...
#define ANA_ETH1_NTX_PROT_SIG_OFF(x)    (((x) << \
    16) & ANA_ETH1_NTX_PROT_SIG_OFF_MASK)
...
#define ANA_ETH1_NTX_PROT_VLAN_TPID(x)    (((x) << \
    16) & ANA_ETH1_NTX_PROT_VLAN_TPID_MASK)
...
#define PTP_ANA_EGR_ENCAP_FLOW_MODE(x)    (((x) << \
    20) & PTP_ANA_EGR_ENCAP_FLOW_MODE_MASK)
#define PTP_ANA_INGR_ENCAP_FLOW_MODE_MASK GENMASK(18, 16)
#define PTP_ANA_INGR_ENCAP_FLOW_MODE(x)   (((x) << \
    16) & PTP_ANA_INGR_ENCAP_FLOW_MODE_MASK)
#define PTP_ANALYZER_MODE_EGR_ENA_MASK    GENMASK(6, 4)
#define PTP_ANALYZER_MODE_EGR_ENA(x)    (((x) << \
    4) & PTP_ANALYZER_MODE_EGR_ENA_MASK)
...
#define ANA_ETH1_NXT_PROT_ETYPE_MATCH(x)  ((x) \
  & ANA_ETH1_NXT_PROT_ETYPE_MATCH_MASK)
...
#define ETH1_FLOW_ENA_CHANNEL_MASK(x)   (((x) << \
    8) & ETH1_FLOW_ENA_CHANNEL_MASK_MASK)
...
#define ANA_ETH1_FLOW_MATCH_VLAN_TAG(x)   (((x) << \
    6) & ANA_ETH1_FLOW_MATCH_VLAN_TAG_MASK)
...
#define PTP_INGR_REWRITER_FLAG_BIT_OFF(x) ((x) \
  & PTP_INGR_REWRITER_FLAG_BIT_OFF_M)
...
#define PTP_EGR_FIFO_LEVEL_LAST_READ(x)   (((x) \
  & PTP_EGR_FIFO_LEVEL_LAST_READ_MASK) >> 12)
...
#define PTP_EGR_REWRITER_FLAG_BIT_OFF(x)  ((x) \
  & PTP_EGR_REWRITER_FLAG_BIT_OFF_M)
...
#define ANA_ETH2_NXT_PROT_ETYPE_MATCH(x)  ((x) \
  & ANA_ETH2_NXT_PROT_ETYPE_MATCH_MASK)

#define MSCC_ANA_ETH2_FLOW_ENA(x)   (0x00a0 + ((x) << 4))
#define ETH2_FLOW_ENA_CHANNEL_MASK_MASK   GENMASK(9, 8)
#define ETH2_FLOW_ENA_CHANNEL_MASK(x)   (((x) << \
    8) & ETH2_FLOW_ENA_CHANNEL_MASK_MASK)
...
#define MPLS_FLOW_CTRL_CHANNEL_MASK(x)    (((x) << \
    24) & MPLS_FLOW_CTRL_CHANNEL_MASK_MASK)
...
#define ANA_IP1_NXT_PROT_NXT_COMP_BYTES_HDR(x)  (((x) << \
    8) & ANA_IP1_NXT_PROT_NXT_COMP_BYTES_HDR_MASK)
...
#define ANA_IP1_NXT_PROT_IP_MATCH1_PROT_OFF(x)  (((x) << \
    16) & ANA_IP1_NXT_PROT_IP_MATCH1_PROT_OFF_MASK)
#define ANA_IP1_NXT_PROT_IP_MATCH1_PROT_MASK_MASK GENMASK(15, 8)
#define ANA_IP1_NXT_PROT_IP_MATCH1_PROT_MASK(x) (((x) << \
    15) & ANA_IP1_NXT_PROT_IP_MATCH1_PROT_MASK_MASK)
#define ANA_IP1_NXT_PROT_IP_MATCH1_PROT_MATCH_MASK  GENMASK(7, 0)
#define ANA_IP1_NXT_PROT_IP_MATCH1_PROT_MATCH(x)  ((x) \
  & ANA_IP1_NXT_PROT_IP_MATCH1_PROT_MATCH_MASK)
...
#define IP1_NXT_PROT_UDP_CHKSUM_OFF(x)    (((x) << \
    8) & IP1_NXT_PROT_UDP_CHKSUM_OFF_MASK)
#define IP1_NXT_PROT_UDP_CHKSUM_WIDTH_MASK  GENMASK(5, 4)
#define IP1_NXT_PROT_UDP_CHKSUM_WIDTH(x)  (((x) << \
    4) & IP1_NXT_PROT_UDP_CHKSUM_WIDTH_MASK)
...
#define IP1_FLOW_ENA_CHANNEL_MASK(x)    (((x) << \
    4) & IP1_FLOW_ENA_CHANNEL_MASK_MASK)
...
#define ANA_IP2_NXT_PROT_NXT_COMP_BYTES_HDR(x)  (((x) << \
    8) & ANA_IP2_NXT_PROT_NXT_COMP_BYTES_HDR_MASK)
...
#define IP2_NXT_PROT_UDP_CHKSUM_OFF(x)    (((x) << \
    8) & IP2_NXT_PROT_UDP_CHKSUM_OFF_MASK)
#define IP2_NXT_PROT_UDP_CHKSUM_WIDTH_MASK  GENMASK(5, 4)
#define IP2_NXT_PROT_UDP_CHKSUM_WIDTH(x)  (((x) << \
    4) & IP2_NXT_PROT_UDP_CHKSUM_WIDTH_MASK)

#define MSCC_ANA_IP2_FLOW_ENA(x)    (0x0250 + ((x) << 4))
#define IP2_FLOW_ENA_CHANNEL_MASK_MASK    GENMASK(5, 4)
#define IP2_FLOW_ENA_CHANNEL_MASK(x)    (((x) << \
    4) & IP2_FLOW_ENA_CHANNEL_MASK_MASK)
...
#define PTP_FLOW_ENA_CHANNEL_MASK(x)    (((x) << \
    4) & PTP_FLOW_ENA_CHANNEL_MASK_MASK)
...
#define PTP_FLOW_PTP_ACTION_MOD_FRAME_STATUS_BYTE_OFFSET(x) (((x) << \
    24) & PTP_FLOW_PTP_ACTION_MOD_FRAME_STATUS_BYTE_OFFSET_MASK)
#define PTP_FLOW_PTP_ACTION_PTP_CMD_MASK  GENMASK(3, 0)
#define PTP_FLOW_PTP_ACTION_PTP_CMD(x)    ((x) \
  & PTP_FLOW_PTP_ACTION_PTP_CMD_MASK)
...
#define PTP_FLOW_PTP_ACTION_TIME_OFFSET(x)  (((x) << \
    10) & PTP_FLOW_PTP_ACTION_TIME_OFFSET_MASK)
#define PTP_FLOW_PTP_ACTION_CORR_OFFSET_MASK  GENMASK(9, 5)
#define PTP_FLOW_PTP_ACTION_CORR_OFFSET(x)  (((x) << \
    5) & PTP_FLOW_PTP_ACTION_CORR_OFFSET_MASK)
...
#define PTP_FLOW_PTP_ACTION2_REWRITE_OFFSET(x)  (((x) << \
    8) & PTP_FLOW_PTP_ACTION2_REWRITE_OFFSET_MASK)
#define PTP_FLOW_PTP_ACTION2_REWRITE_BYTES_MASK GENMASK(3, 0)
#define PTP_FLOW_PTP_ACTION2_REWRITE_BYTES(x) ((x) \
  & PTP_FLOW_PTP_ACTION2_REWRITE_BYTES_MASK)
...
#define PTP_FLOW_PTP_0_FIELD_OFFSET(x)    (((x) << \
    8) & PTP_FLOW_PTP_0_FIELD_OFFSET_MASK)
