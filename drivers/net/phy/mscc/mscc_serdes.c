...
static int vsc85xx_sd6g_gp_cfg_wr(struct phy_device *phydev,
...
int vsc85xx_sd6g_config_v2(struct phy_device *phydev) {
  ...
  ib_rtrm_adj = 13;
  ret
    = vsc85xx_sd6g_ib_cfg0_wr(phydev, ib_rtrm_adj, ib_sig_det_clk_sel_mm, 0,
      0);
  if (ret) {
    return ret;
  }
  ...
  ret = vsc85xx_sd6g_ib_cfg0_wr(phydev, ib_rtrm_adj, ib_sig_det_clk_sel_cal, 0,
      0);
  if (ret) {
    return ret;
  }
