...
#define MSCC_MS_ANALN_VLAN_MTU_CHECK	0x3c48
...
#define MSCC_MS_PARAMS2_IG_CC_CONTROL_ANALN_MATCH_CTRL_ACT	BIT(14)
#define MSCC_MS_PARAMS2_IG_CC_CONTROL_ANALN_MATCH_ACT	BIT(15)
...
/* MACSEC_ANALN_VLAN_MTU_CHECK */
#define MSCC_MS_ANALN_VLAN_MTU_CHECK_NV_MTU_COMPARE(x)	(x)
#define MSCC_MS_ANALN_VLAN_MTU_CHECK_NV_MTU_COMPARE_M	GENMASK(14, 0)
#define MSCC_MS_ANALN_VLAN_MTU_CHECK_NV_MTU_COMP_DROP	BIT(15)
