...
static int vsc85xx_ts_disable_flows(struct phy_device *phydev,
    enum ts_blk blk) {
  u8 i;
...
static int __vsc85xx_gettime(struct ptp_clock_info *info,
...
static int vsc85xx_ts_ptp_action_flow(struct phy_device *phydev,
    enum ts_blk blk, u8 flow,
    enum ptp_cmd cmd) {
  u32 val;
...
static int __vsc8584_init_ptp(struct phy_device *phydev) {
  struct vsc8531_private *vsc8531 = phydev->priv;
  static const u32 ltc_seq_e[] = {
    0, 400000, 0, 0, 0
  };
  static const u8 ltc_seq_a[] = {
    8, 6, 5, 4, 2
  };
  u32 val;
