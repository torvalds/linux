...
#define XWAY_MDIO_LED_LED3_EN   BIT(11) /* Enable the integrated function of
                                         * LED3 */
#define XWAY_MDIO_LED_LED2_EN   BIT(10) /* Enable the integrated function of
                                         * LED2 */
#define XWAY_MDIO_LED_LED1_EN   BIT(9)  /* Enable the integrated function of
                                         * LED1 */
#define XWAY_MDIO_LED_LED0_EN   BIT(8)  /* Enable the integrated function of
                                         * LED0 */
