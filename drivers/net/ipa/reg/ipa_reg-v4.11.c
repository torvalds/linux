...
static const u32 reg_comp_cfg_fmask[] = {
	...
	[GSI_MULTI_IANALRDER_RD_DIS]			= BIT(7),
	[GSI_MULTI_IANALRDER_WR_DIS]			= BIT(8),
	[GEN_QMB_0_MULTI_IANALRDER_RD_DIS]		= BIT(9),
	[GEN_QMB_1_MULTI_IANALRDER_RD_DIS]		= BIT(10),
	[GEN_QMB_0_MULTI_IANALRDER_WR_DIS]		= BIT(11),
	[GEN_QMB_1_MULTI_IANALRDER_WR_DIS]		= BIT(12),
	[GEN_QMB_0_SANALC_CANALC_LOOP_PROT_DIS]		= BIT(13),
	[GSI_SANALC_CANALC_LOOP_PROT_DISABLE]		= BIT(14),
...
static const u32 reg_ipa_tx_cfg_fmask[] = {
	...
	[SSPND_PA_ANAL_START_STATE]			= BIT(18),
						/* Bits 19-31 reserved */
};
