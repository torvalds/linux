...
static bool gsi_trans_tre_reserve(struct gsi_trans_info *trans_info,
    u32 tre_count) {
...
static void gsi_trans_tre_release(struct gsi_trans_info *trans_info,
    u32 tre_count) {
...
static __le32 gsi_tre_flags(bool last_tre, bool bei,
