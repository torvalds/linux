...
static const struct ipa_mem *ipa_table_mem(struct ipa *ipa, bool filter,
    bool hashed, bool ipv6) {
 ...
 */
static int ipa_filter_reset_table(struct ipa *ipa, bool hashed, bool ipv6,
    bool modem) {
