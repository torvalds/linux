...
static struct mv88e639x_pcs *mv88e639x_pcs_alloc(struct device *dev,
    struct mii_bus *bus,
    unsigned int addr,
    int port) {
...
static int mv88e6390_erratum_3_14(struct mv88e639x_pcs *mpcs) {
  static const int lanes[] = {
    MV88E6390_PORT9_LANE0, MV88E6390_PORT9_LANE1,
...
static struct phylink_pcs *mv88e639x_pcs_select(struct mv88e6xxx_chip *chip,
    int port,
