...
static void sja1105et_vl_lookup_cmd_packing(void *buf,
...
static void sja1105pqrs_vl_lookup_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
...
static void sja1110_vl_lookup_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
...
static void sja1110_vl_policing_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
  u8 *p = buf + SJA1105_SIZE_VL_LOOKUP_ENTRY;
  const int size = SJA1105_SIZE_DYN_CMD;
...
static void sja1105pqrs_common_l2_lookup_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
...
static void sja1105pqrs_l2_lookup_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
...
static void sja1110_l2_lookup_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
 ...
 * command buffer.
 */
static size_t sja1105pqrs_dyn_l2_lookup_entry_packing(void *buf,
    void *entry_ptr,
    enum packing_op op) {
...
static void sja1105et_l2_lookup_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
...
static void sja1105et_mgmt_route_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
  u8 *p = buf + SJA1105ET_SIZE_L2_LOOKUP_ENTRY;
  u64 mgmtroute = 1;
...
static void sja1105pqrs_mgmt_route_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
  u8 *p = buf + SJA1105PQRS_SIZE_L2_LOOKUP_ENTRY;
  u64 mgmtroute = 1;
 ...
 */
static void sja1105_vlan_lookup_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
...
static void sja1110_vlan_lookup_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
...
static void sja1105_l2_forwarding_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
...
static void sja1110_l2_forwarding_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
  u8 *p = buf + SJA1105_SIZE_L2_FORWARDING_ENTRY;
  const int size = SJA1105_SIZE_DYN_CMD;
...
static void sja1105et_mac_config_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
  const int size = SJA1105_SIZE_DYN_CMD;
...
static void sja1105pqrs_mac_config_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
  const int size = SJA1105ET_SIZE_MAC_CONFIG_DYN_ENTRY;
...
static void sja1110_mac_config_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
  u8 *p = buf + SJA1105PQRS_SIZE_MAC_CONFIG_ENTRY;
  const int size = SJA1105_SIZE_DYN_CMD;
...
static void sja1105et_l2_lookup_params_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
...
static void sja1105pqrs_l2_lookup_params_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
...
static void sja1110_l2_lookup_params_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
...
static void sja1105et_general_params_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
...
static void sja1105pqrs_general_params_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
...
static void sja1110_general_params_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
...
static void sja1105pqrs_avb_params_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
...
static void sja1105_retagging_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
...
static void sja1110_retagging_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
  u8 *p = buf + SJA1105_SIZE_RETAGGING_ENTRY;
  const int size = SJA1105_SIZE_DYN_CMD;
...
static void sja1110_l2_policing_cmd_packing(void *buf,
    struct sja1105_dyn_cmd *cmd,
    enum packing_op op) {
...
static int sja1105_dynamic_config_poll_valid(struct sja1105_private *priv,
 ...
 */
static int sja1105_dynamic_config_wait_complete(struct sja1105_private *priv,
    const struct sja1105_dynamic_table_ops *ops,
    void *entry, bool check_valident,
    bool check_errors) {
  int err, rc;
