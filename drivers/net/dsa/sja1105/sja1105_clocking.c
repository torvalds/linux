...
static int sja1105_cgu_idiv_config(struct sja1105_private *priv, int port,
  ...
  u8 packed_buf[SJA1105_SIZE_CGU_CMD] = {
    0
  };
...
static void sja1105_cgu_mii_control_packing(void *buf,
    struct sja1105_cgu_mii_ctrl *cmd,
    enum packing_op op) {
  const int size = 4;
...
static int sja1105_cgu_mii_rx_clk_config(struct sja1105_private *priv,
    int port) {
  const struct sja1105_regs *regs = priv->info->regs;
...
static int sja1105_cgu_mii_ext_tx_clk_config(struct sja1105_private *priv,
    int port) {
  const struct sja1105_regs *regs = priv->info->regs;
...
static int sja1105_cgu_mii_ext_rx_clk_config(struct sja1105_private *priv,
    int port) {
  const struct sja1105_regs *regs = priv->info->regs;
...
static void sja1105_cgu_pll_control_packing(void *buf,
    struct sja1105_cgu_pll_ctrl *cmd,
    enum packing_op op) {
  const int size = 4;
...
/* AGU */
static void sja1105_cfg_pad_mii_packing(void *buf,
    struct sja1105_cfg_pad_mii *cmd,
    enum packing_op op) {
  const int size = 4;
...
static void sja1105_cfg_pad_mii_id_packing(void *buf,
    struct sja1105_cfg_pad_mii_id *cmd,
    enum packing_op op) {
...
static void sja1110_cfg_pad_mii_id_packing(void *buf,
    struct sja1105_cfg_pad_mii_id *cmd,
    enum packing_op op) {
  const int size = SJA1105_SIZE_CGU_CMD;
  u64 range = 4;
...
static int sja1105_cgu_rmii_ext_tx_clk_config(struct sja1105_private *priv,
    int port) {
  const struct sja1105_regs *regs = priv->info->regs;
...
static void sja1110_cgu_outclk_packing(void *buf,
    struct sja1110_cgu_outclk *outclk,
    enum packing_op op) {
  const int size = 4;
