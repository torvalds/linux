...
static const struct rtl8365mb_extint *rtl8365mb_get_port_extint(
    struct realtek_priv *priv, int port) {
...
static enum dsa_tag_protocol rtl8365mb_get_tag_protocol(struct dsa_switch *ds,
    int port,
...
static void rtl8365mb_get_ethtool_stats(struct dsa_switch *ds, int port,
    u64 *data) {
  struct realtek_priv *priv = ds->priv;
  struct rtl8365mb *mb;
  int ret;
...
static void rtl8365mb_get_strings(struct dsa_switch *ds, int port,
...
static int rtl8365mb_get_and_clear_status_reg(struct realtek_priv *priv,
    u32 reg,
    u32 *val) {
  int ret;
...
static int rtl8365mb_get_chip_id_and_ver(struct regmap *map, u32 *id,
    u32 *ver) {
  int ret;
