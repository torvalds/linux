...
#define   QCA8K_MASK_CTRL_REV_ID(x)     FIELD_GET(QCA8K_MASK_CTRL_REV_ID_MASK, \
    x)
#define   QCA8K_MASK_CTRL_DEVICE_ID_MASK    GENMASK(15, 8)
#define   QCA8K_MASK_CTRL_DEVICE_ID(x)      FIELD_GET( \
    QCA8K_MASK_CTRL_DEVICE_ID_MASK, x)
...
#define   QCA8K_PORT_PAD_RGMII_TX_DELAY(x)    FIELD_PREP( \
    QCA8K_PORT_PAD_RGMII_TX_DELAY_MASK, x)
#define   QCA8K_PORT_PAD_RGMII_RX_DELAY_MASK    GENMASK(21, 20)
#define   QCA8K_PORT_PAD_RGMII_RX_DELAY(x)    FIELD_PREP( \
    QCA8K_PORT_PAD_RGMII_RX_DELAY_MASK, x)
...
#define   QCA8K_MDIO_MASTER_PHY_ADDR(x)     FIELD_PREP( \
    QCA8K_MDIO_MASTER_PHY_ADDR_MASK, x)
#define   QCA8K_MDIO_MASTER_REG_ADDR_MASK   GENMASK(20, 16)
#define   QCA8K_MDIO_MASTER_REG_ADDR(x)     FIELD_PREP( \
    QCA8K_MDIO_MASTER_REG_ADDR_MASK, x)
#define   QCA8K_MDIO_MASTER_DATA_MASK     GENMASK(15, 0)
#define   QCA8K_MDIO_MASTER_DATA(x)     FIELD_PREP(QCA8K_MDIO_MASTER_DATA_MASK, \
    x)
...
#define QCA8K_LED_COUNT         ((QCA8K_NUM_PORTS - QCA8K_NUM_CPU_PORTS) \
  * QCA8K_LED_PORT_COUNT)
#define QCA8K_LED_RULE_COUNT        6
#define QCA8K_LED_RULE_MAX        11
#define QCA8K_LED_PORT_INDEX(_phy, \
      _led)    (((_phy) * QCA8K_LED_PORT_COUNT) + (_led))

#define QCA8K_LED_PHY123_PATTERN_EN_SHIFT(_phy, \
      _led) ((((_phy) - 1) * 6) + 8 + (2 * (_led)))
...
#define   QCA8K_SGMII_MODE_CTRL(x)      FIELD_PREP(QCA8K_SGMII_MODE_CTRL_MASK, \
    x)
...
#define   QCA8K_VTU_FUNC0_EG_MODE_PORT_MASK(_i)   (GENMASK(1, \
    0) << QCA8K_VTU_FUNC0_EG_MODE_PORT_SHIFT(_i))
#define   QCA8K_VTU_FUNC0_EG_MODE_UNMOD     FIELD_PREP( \
    QCA8K_VTU_FUNC0_EG_MODE_MASK, 0x0)
#define   QCA8K_VTU_FUNC0_EG_MODE_PORT_UNMOD(_i)  (QCA8K_VTU_FUNC0_EG_MODE_UNMOD \
    << QCA8K_VTU_FUNC0_EG_MODE_PORT_SHIFT(_i))
#define   QCA8K_VTU_FUNC0_EG_MODE_UNTAG     FIELD_PREP( \
    QCA8K_VTU_FUNC0_EG_MODE_MASK, 0x1)
#define   QCA8K_VTU_FUNC0_EG_MODE_PORT_UNTAG(_i)  (QCA8K_VTU_FUNC0_EG_MODE_UNTAG \
    << QCA8K_VTU_FUNC0_EG_MODE_PORT_SHIFT(_i))
#define   QCA8K_VTU_FUNC0_EG_MODE_TAG     FIELD_PREP( \
    QCA8K_VTU_FUNC0_EG_MODE_MASK, 0x2)
#define   QCA8K_VTU_FUNC0_EG_MODE_PORT_TAG(_i)    (QCA8K_VTU_FUNC0_EG_MODE_TAG \
    << QCA8K_VTU_FUNC0_EG_MODE_PORT_SHIFT(_i))
#define   QCA8K_VTU_FUNC0_EG_MODE_NOT     FIELD_PREP( \
    QCA8K_VTU_FUNC0_EG_MODE_MASK, 0x3)
#define   QCA8K_VTU_FUNC0_EG_MODE_PORT_NOT(_i)    (QCA8K_VTU_FUNC0_EG_MODE_NOT \
    << QCA8K_VTU_FUNC0_EG_MODE_PORT_SHIFT(_i))
...
#define   QCA8K_PORT_LOOKUP_VLAN_MODE(x)    FIELD_PREP( \
    QCA8K_PORT_LOOKUP_VLAN_MODE_MASK, x)
#define   QCA8K_PORT_LOOKUP_VLAN_MODE_NONE    QCA8K_PORT_LOOKUP_VLAN_MODE(0x0)
#define   QCA8K_PORT_LOOKUP_VLAN_MODE_FALLBACK    QCA8K_PORT_LOOKUP_VLAN_MODE( \
    0x1)
...
#define   QCA8K_PORT_LOOKUP_STATE(x)      FIELD_PREP( \
    QCA8K_PORT_LOOKUP_STATE_MASK, x)
...
#define QCA8K_REG_GOL_TRUNK_EN(_i)      (QCA8K_REG_GOL_TRUNK_EN_MASK << \
    QCA8K_REG_GOL_TRUNK_SHIFT(_i))
#define QCA8K_REG_GOL_TRUNK_MEMBER_MASK     GENMASK(6, 0)
#define QCA8K_REG_GOL_TRUNK_MEMBER(_i)      (QCA8K_REG_GOL_TRUNK_MEMBER_MASK << \
    QCA8K_REG_GOL_TRUNK_SHIFT(_i))
...
#define QCA8K_REG_GOL_TRUNK_ID_MEM_ID_SHIFT(_i, \
      _j) (QCA8K_REG_GOL_MEM_ID_SHIFT(_j) + QCA8K_REG_GOL_TRUNK_ID_SHIFT(_i))
#define QCA8K_REG_GOL_TRUNK_ID_MEM_ID_EN(_i, \
      _j)  (QCA8K_REG_GOL_TRUNK_ID_MEM_ID_EN_MASK << \
    QCA8K_REG_GOL_TRUNK_ID_MEM_ID_SHIFT(_i, _j))
#define QCA8K_REG_GOL_TRUNK_ID_MEM_ID_PORT(_i, \
      _j)  (QCA8K_REG_GOL_TRUNK_ID_MEM_ID_PORT_MASK << \
    QCA8K_REG_GOL_TRUNK_ID_MEM_ID_SHIFT(_i, _j))

#define QCA8K_REG_GLOBAL_FC_THRESH      0x800
#define   QCA8K_GLOBAL_FC_GOL_XON_THRES_MASK    GENMASK(24, 16)
#define   QCA8K_GLOBAL_FC_GOL_XON_THRES(x)    FIELD_PREP( \
    QCA8K_GLOBAL_FC_GOL_XON_THRES_MASK, x)
#define   QCA8K_GLOBAL_FC_GOL_XOFF_THRES_MASK   GENMASK(8, 0)
#define   QCA8K_GLOBAL_FC_GOL_XOFF_THRES(x)   FIELD_PREP( \
    QCA8K_GLOBAL_FC_GOL_XOFF_THRES_MASK, x)

#define QCA8K_REG_PORT_HOL_CTRL0(_i)      (0x970 + (_i) * 0x8)
#define   QCA8K_PORT_HOL_CTRL0_EG_PRI0_BUF_MASK   GENMASK(3, 0)
#define   QCA8K_PORT_HOL_CTRL0_EG_PRI0(x)   FIELD_PREP( \
    QCA8K_PORT_HOL_CTRL0_EG_PRI0_BUF_MASK, x)
#define   QCA8K_PORT_HOL_CTRL0_EG_PRI1_BUF_MASK   GENMASK(7, 4)
#define   QCA8K_PORT_HOL_CTRL0_EG_PRI1(x)   FIELD_PREP( \
    QCA8K_PORT_HOL_CTRL0_EG_PRI1_BUF_MASK, x)
#define   QCA8K_PORT_HOL_CTRL0_EG_PRI2_BUF_MASK   GENMASK(11, 8)
#define   QCA8K_PORT_HOL_CTRL0_EG_PRI2(x)   FIELD_PREP( \
    QCA8K_PORT_HOL_CTRL0_EG_PRI2_BUF_MASK, x)
#define   QCA8K_PORT_HOL_CTRL0_EG_PRI3_BUF_MASK   GENMASK(15, 12)
#define   QCA8K_PORT_HOL_CTRL0_EG_PRI3(x)   FIELD_PREP( \
    QCA8K_PORT_HOL_CTRL0_EG_PRI3_BUF_MASK, x)
#define   QCA8K_PORT_HOL_CTRL0_EG_PRI4_BUF_MASK   GENMASK(19, 16)
#define   QCA8K_PORT_HOL_CTRL0_EG_PRI4(x)   FIELD_PREP( \
    QCA8K_PORT_HOL_CTRL0_EG_PRI4_BUF_MASK, x)
#define   QCA8K_PORT_HOL_CTRL0_EG_PRI5_BUF_MASK   GENMASK(23, 20)
#define   QCA8K_PORT_HOL_CTRL0_EG_PRI5(x)   FIELD_PREP( \
    QCA8K_PORT_HOL_CTRL0_EG_PRI5_BUF_MASK, x)
#define   QCA8K_PORT_HOL_CTRL0_EG_PORT_BUF_MASK   GENMASK(29, 24)
#define   QCA8K_PORT_HOL_CTRL0_EG_PORT(x)   FIELD_PREP( \
    QCA8K_PORT_HOL_CTRL0_EG_PORT_BUF_MASK, x)

#define QCA8K_REG_PORT_HOL_CTRL1(_i)      (0x974 + (_i) * 0x8)
#define   QCA8K_PORT_HOL_CTRL1_ING_BUF_MASK   GENMASK(3, 0)
#define   QCA8K_PORT_HOL_CTRL1_ING(x)     FIELD_PREP( \
    QCA8K_PORT_HOL_CTRL1_ING_BUF_MASK, x)
...
#define QCA8K_EGREES_VLAN_PORT_MASK(_i)     (GENMASK(11, \
    0) << QCA8K_EGREES_VLAN_PORT_SHIFT(_i))
#define QCA8K_EGREES_VLAN_PORT(_i, \
      x)     ((x) << QCA8K_EGREES_VLAN_PORT_SHIFT(_i))
