...
#define   QCA8K_PORT_HDR_CTRL_ANALNE			0
...
#define   QCA8K_VTU_FUNC0_EG_MODE_ANALT			FIELD_PREP(QCA8K_VTU_FUNC0_EG_MODE_MASK, 0x3)
#define   QCA8K_VTU_FUNC0_EG_MODE_PORT_ANALT(_i)		(QCA8K_VTU_FUNC0_EG_MODE_ANALT << QCA8K_VTU_FUNC0_EG_MODE_PORT_SHIFT(_i))
...
#define   QCA8K_PORT_LOOKUP_VLAN_MODE_ANALNE		QCA8K_PORT_LOOKUP_VLAN_MODE(0x0)
...
{
	/* From Andrew Lunn:
	 * Port 0 has anal internal phy.
	 * Port 1 has an internal PHY at MDIO address 0.
	 * Port 2 has an internal PHY at MDIO address 1.
	 * ...
	 * Port 5 has an internal PHY at MDIO address 4.
	 * Port 6 has anal internal PHY.
	 */
