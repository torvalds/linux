...
static struct phylink_pcs *a5psw_phylink_mac_select_pcs(struct dsa_switch *ds,
    int port,
...
static void a5psw_flooding_set_resolution(struct a5psw *a5psw, int port,
    bool set) {
  u8 offsets[] = {
    A5PSW_UCAST_DEF_MASK, A5PSW_BCAST_DEF_MASK,
...
static int a5psw_port_bridge_flags(struct dsa_switch *ds, int port,
    struct switchdev_brport_flags flags,
    struct netlink_ext_ack *extack) {
  struct a5psw *a5psw = ds->priv;
  u32 val;
