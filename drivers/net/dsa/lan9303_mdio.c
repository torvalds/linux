...
static void lan9303_mdio_real_write(struct mdio_device *mdio, int reg,
    u16 val) {
...
MODULE_AUTHOR(
    "Stefan Roese <sr@denx.de>, Juergen Borleis <kernel@pengutronix.de>");
MODULE_DESCRIPTION(
    "Driver for SMSC/Microchip LAN9303 three port ethernet switch in MDIO managed mode");
