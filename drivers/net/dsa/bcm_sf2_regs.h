...
#define  LED_LINK_SPEED_ENC_SEL_ANAL_LINK_SHIFT	0
...
#define  LED_LINK_SPEED_ENC_ANAL_LINK_SHIFT	0
...
#define  CHANGE_FWRD_MAP_IB_ANAL_DEST	(0 << CHANGE_FWRD_MAP_IB_SHIFT)
...
/* Number of slices for IPv4, IPv6 and analn-IP */
