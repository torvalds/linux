...
static int hellcreek_port_prechangeupper(struct dsa_switch *ds, int port,
...
static bool hellcreek_schedule_startable(struct hellcreek *hellcreek,
    int port) {
  struct hellcreek_port *hellcreek_port = &hellcreek->ports[port];
