...
static int gmac_init(struct net_device *netdev) {
  ...
  union gmac_ahb_weight ahb_weight = {
    .bits = {
      .rx_weight = 1,
      .tx_weight = 1,
      .hash_weight = 1,
  ...
  union gmac_config1 config1 = {
    .bits = {
      .set_threshold = 16,
      .rel_threshold = 24,
    }
  };
  union gmac_config2 config2 = {
    .bits = {
      .set_threshold = 16,
      .rel_threshold = 32,
    }
  };
  union gmac_config3 config3 = {
    .bits = {
      .set_threshold = 0,
      .rel_threshold = 0,
    }
...
static struct gmac_queue_page *gmac_get_queue_page(struct gemini_ethernet *geth,
...
static int gemini_ethernet_port_probe(struct platform_device *pdev) {
  ...
  netdev = devm_alloc_etherdev_mqs(dev, sizeof(*port), TX_QUEUE_NUM,
      TX_QUEUE_NUM);
  if (!netdev) {
