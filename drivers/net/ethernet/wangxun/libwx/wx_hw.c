...
static int wx_phy_read_reg_mdi(struct mii_bus *bus, int phy_addr, int devnum,
    int regnum) {
...
int wx_disable_pcie_master(struct wx *wx) {
  ...
  status = read_poll_timeout(rd32, val, !val, 100,
      WX_PCI_MASTER_DISABLE_TIMEOUT,
 ...
 **/
int wx_get_pcie_msix_counts(struct wx *wx, u16 *msix_count,
    u16 max_msix_count) {
  struct pci_dev *pdev = wx->pdev;
