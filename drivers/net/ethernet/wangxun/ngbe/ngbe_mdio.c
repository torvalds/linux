...
static int ngbe_phy_read_reg_internal(struct mii_bus *bus, int phy_addr,
    int regnum) {
...
static int ngbe_phy_write_reg_internal(struct mii_bus *bus, int phy_addr,
...
static int ngbe_phy_read_reg_c22(struct mii_bus *bus, int phy_addr,
    int regnum) {
  struct wx *wx = bus->priv;
  u16 phy_data;
