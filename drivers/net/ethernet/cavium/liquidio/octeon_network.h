...
static inline int recv_buffer_recycle(struct octeon_device *oct, void *buf) {
...
static inline void recv_buffer_destroy(void *buffer,
    struct octeon_skb_page_info *pg_info) {
...
static inline u64 lio_map_ring(void *buf) {
  dma_addr_t dma_addr;
...
static inline void lio_unmap_ring(struct pci_dev *pci_dev,
    u64 buf_ptr) {
