...
static void cn23xx_bar1_idx_write(struct octeon_device *oct, u32 idx,
    u32 mask) {
...
static void cn23xx_enable_pf_interrupt(struct octeon_device *oct,
    u8 intr_flag) {
  struct octeon_cn23xx_pf *cn23xx = (struct octeon_cn23xx_pf *) oct->chip;
  u64 intr_val = 0;
...
static void cn23xx_disable_pf_interrupt(struct octeon_device *oct,
    u8 intr_flag) {
  struct octeon_cn23xx_pf *cn23xx = (struct octeon_cn23xx_pf *) oct->chip;
  u64 intr_val = 0;
  /* Disable Interrupts */
...
static void cn23xx_get_vf_stats_callback(struct octeon_device *oct,
