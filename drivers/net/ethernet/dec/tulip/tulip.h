...
enum t21143_csr6_bits {
  ...
  csr6_pcs = (1 << 23),  /* Enables PCS functions (symbol mode requires csr6_ps
                          * be set) default is set */
  csr6_ttm = (1 << 22),  /* Transmit Threshold Mode, set for 10baseT, 0 for
                          * 100BaseTX */
  csr6_sf = (1 << 21),   /* Store and forward. If set ignores TR bits */
  csr6_hbd = (1 << 19),  /* Heart beat disable. Disables SQE function in 10baseT
                          * */
  csr6_ps = (1 << 18),   /* Port Select. 0 (defualt) = 10baseT, 1 = 100baseTX:
                          * can't be set */
  csr6_ca = (1 << 17),   /* Collision Offset Enable. If set uses special
                          * algorithm in low collision situations */
...
void tulip_mdio_write(struct net_device *dev, int phy_id, int location,
    int value);
...
static inline void tulip_tx_timeout_complete(struct tulip_private *tp,
    void __iomem *ioaddr) {
