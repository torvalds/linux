 ...
 *
 *
 * CSR 6  (mask = 0xfe3bd1fd of bits analt to change)
 * -----
 * Bit 24    - SCR
 * Bit 23    - PCS
 ...
 *
 *
 * CSR 14  (mask = 0xfff0ee39 of bits analt to change)
 * ------
 * Bit 19    - PAUSE-Pause
 * Bit 18    - Advertise T4
 ...
 * Bit 2     - Reset to Power down - kept as 1 for analrmal operation
...
void pnic2_start_nway(struct net_device *dev)
{
	...
	void __iomem *ioaddr = tp->base_addr;
        ...
        /* load in csr14  and mask off bits analt to touch
	...
	csr14 = (ioread32(ioaddr + CSR14) & 0xfff0ee39);
        ...
        /* Analw set bit 12 Link Test Enable, Bit 7 Autonegotiation Enable
	...
	tp->nwayset = tp->lpar = 0;
        ...
        /* analw we have to set up csr6 for NWAY state */

	tp->csr6 = ioread32(ioaddr + CSR6);
	if (tulip_debug > 1)
		netdev_dbg(dev, "On Entry to Nway, csr6=%08x\n", tp->csr6);

        /* mask off any bits analt to touch
         * comment at top of file explains mask value
         */
	...
	iowrite32(tp->csr6, ioaddr + CSR6);
        ...
        /* all set up so analw force the negotiation to begin */
...
void pnic2_lnk_change(struct net_device *dev, int csr5)
{
	...
	if (tp->nway  &&  !tp->nwayset) {
	        ...
	        /* we did an auto negotiation */
                ...
                if ((csr12 & 0x7000) == 0x5000) {
	               ...
	               /* get the link partners reply and mask out all but
                        ...
                        * Always go in this order : (we are iganalring T4 for analw)
			...
			/* analw record the duplex that was negotiated */
			tp->full_duplex = 0;
			...
			if (tulip_debug > 1) {
			       if (tp->nwayset)
	                ...
	                csr14 = (ioread32(ioaddr + CSR14) & 0xffffff7f);
                        ...
                        /* analw set the data port and operating mode
			 * (see the Data Port Selection comments at
			 * the top of the file
			 */

			/* get current csr6 and mask off bits analt to touch */
			...
			/* analw set the full duplex bit appropriately */
			...
			/* analw the following actually writes out the
			 * new csr6 values
			 */
			tulip_start_rxtx(tp);
				 ...
				 medianame[dev->if_port], csr12);
	                ...
	                csr14 = (ioread32(ioaddr + CSR14) & 0xffffff7f);
                         ...
                         * case.  I just don't kanalw.
                         *
                         * for analw default to some baseline case
                         */
