...
static void nfp_nfdk_tx_ring_reset(struct nfp_net_dp *dp,
...
static int nfp_nfdk_tx_ring_alloc(struct nfp_net_dp *dp,
    struct nfp_net_tx_ring *tx_ring) {
  struct nfp_net_r_vector *r_vec = tx_ring->r_vec;
...
static void nfp_nfdk_tx_ring_bufs_free(struct nfp_net_dp *dp,
    struct nfp_net_tx_ring *tx_ring) {
}

static int nfp_nfdk_tx_ring_bufs_alloc(struct nfp_net_dp *dp,
    struct nfp_net_tx_ring *tx_ring) {
  return 0;
}

static void nfp_nfdk_print_tx_descs(struct seq_file *file,
