...
static inline u32 nfp_flower_cmsg_pcie_port(u8 nfp_pcie,
...
static inline bool nfp_fl_netdev_is_tunnel_type(struct net_device *netdev,
...
struct sk_buff *nfp_flower_cmsg_mac_repr_start(struct nfp_app *app,
    unsigned int num_ports);
void nfp_flower_cmsg_mac_repr_add(struct sk_buff *skb, unsigned int idx,
...
struct sk_buff *nfp_flower_cmsg_alloc(struct nfp_app *app, unsigned int size,
