...
static struct nfp_flower_cmsg_hdr *nfp_flower_cmsg_get_hdr(struct sk_buff *skb)
{
...
static bool nfp_flower_process_mtu_ack(struct nfp_app *app,
    struct sk_buff *skb) {
...
static void nfp_flower_cmsg_portmod_rx(struct nfp_app *app,
    struct sk_buff *skb) {
  struct nfp_flower_cmsg_portmod *msg;
...
static void nfp_flower_cmsg_portreify_rx(struct nfp_app *app,
    struct sk_buff *skb) {
...
static void nfp_flower_cmsg_merge_hint_rx(struct nfp_app *app,
    struct sk_buff *skb) {
...
static void nfp_flower_cmsg_process_one_rx(struct nfp_app *app,
    struct sk_buff *skb) {
  struct nfp_flower_priv *app_priv = app->priv;
...
static void nfp_flower_queue_ctl_msg(struct nfp_app *app, struct sk_buff *skb,
    int type) {
  struct nfp_flower_priv *priv = app->priv;
