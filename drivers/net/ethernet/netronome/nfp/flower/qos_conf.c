...
static int nfp_flower_install_rate_limiter(struct nfp_app *app,
...
static int nfp_flower_remove_rate_limiter(struct nfp_app *app,
    struct net_device *netdev,
    struct tc_cls_matchall_offload *flow,
    struct netlink_ext_ack *extack) {
  struct nfp_flower_priv *fl_priv = app->priv;
...
static void nfp_flower_stats_rlim_request(struct nfp_flower_priv *fl_priv,
    u32 id, bool ingress) {
  struct nfp_police_cfg_head *head;
  struct sk_buff *skb;
...
static void nfp_flower_stats_rlim_request_all(struct nfp_flower_priv *fl_priv) {
...
static int nfp_flower_stats_rate_limiter(struct nfp_app *app,
    struct net_device *netdev,
    struct tc_cls_matchall_offload *flow,
    struct netlink_ext_ack *extack) {
  struct nfp_flower_priv *fl_priv = app->priv;
...
static struct nfp_meter_entry *nfp_flower_add_meter_entry(struct nfp_app *app,
    u32 meter_id) {
...
static int nfp_act_install_actions(struct nfp_app *app,
...
static int nfp_act_remove_actions(struct nfp_app *app,
    struct flow_offload_action *fl_act,
    struct netlink_ext_ack *extack) {
  struct nfp_meter_entry *meter_entry = NULL;
  struct nfp_police_config *config;
...
static int nfp_act_stats_actions(struct nfp_app *app,
    struct flow_offload_action *fl_act,
    struct netlink_ext_ack *extack) {
  struct nfp_flower_priv *fl_priv = app->priv;
  struct nfp_meter_entry *meter_entry = NULL;
