...
static void nfp_flower_compile_meta_tci(struct nfp_flower_meta_tci *ext,
    struct nfp_flower_meta_tci *msk,
...
static int nfp_flower_compile_mac_mpls(struct nfp_flower_mac_mpls *ext,
    struct nfp_flower_mac_mpls *msk,
    struct flow_rule *rule,
    struct netlink_ext_ack *extack) {
...
static void nfp_flower_compile_ip_ext(struct nfp_flower_ip_ext *ext,
...
static void nfp_flower_fill_vlan(struct flow_match_vlan *match,
...
static void nfp_flower_compile_tun_ipv4_addrs(struct nfp_flower_tun_ipv4 *ext,
...
static void nfp_flower_compile_tun_ipv6_addrs(struct nfp_flower_tun_ipv6 *ext,
...
static void nfp_flower_compile_tun_ip_ext(struct nfp_flower_tun_ip_ext *ext,
...
static void nfp_flower_compile_tun_udp_key(__be32 *key, __be32 *key_msk,
    struct flow_rule *rule) {
...
static void nfp_flower_compile_tun_gre_key(__be32 *key, __be32 *key_msk,
    __be16 *flags,
