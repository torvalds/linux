...
static inline int nfp_app_repr_open(struct nfp_app *app,
...
static inline int nfp_app_repr_stop(struct nfp_app *app,
    struct nfp_repr *repr) {
...
static inline int nfp_app_repr_init(struct nfp_app *app,
...
static inline void nfp_app_repr_preclean(struct nfp_app *app,
    struct net_device *netdev) {
...
static inline void nfp_app_repr_clean(struct nfp_app *app,
    struct net_device *netdev) {
...
static inline int nfp_app_check_mtu(struct nfp_app *app,
...
static inline int nfp_app_repr_change_mtu(struct nfp_app *app,
    struct net_device *netdev,
    int new_mtu) {
...
static inline void nfp_app_ctrl_rx_raw(struct nfp_app *app, const void *data,
    unsigned int len) {
...
struct nfp_reprs *nfp_reprs_get_locked(struct nfp_app *app,
    enum nfp_repr_type type);
struct nfp_reprs *nfp_app_reprs_set(struct nfp_app *app,
    enum nfp_repr_type type,
