...
static void nfp_eth_calc_port_geometry(struct nfp_cpp *cpp,
...
static void nfp_eth_calc_port_type(struct nfp_cpp *cpp,
    struct nfp_eth_table_port *entry) {
...
static void nfp_eth_read_media(struct nfp_cpp *cpp, struct nfp_nsp *nsp,
    struct nfp_eth_table_port *entry) {
