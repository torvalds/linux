...
static void __resource_add(struct list_head *head,
    struct nfp_cpp_resource *res) {
 ...
 */
struct nfp_cpp_area *nfp_cpp_area_alloc_with_name(struct nfp_cpp *cpp, u32 dest,
    const char *name,
 ...
 * Return: NFP CPP Area handle, or NULL
 */
struct nfp_cpp_area *nfp_cpp_area_alloc(struct nfp_cpp *cpp, u32 dest,
    unsigned long long address, unsigned long size) {
...
static struct nfp_cpp_area_cache *area_cache_get(struct nfp_cpp *cpp, u32 id,
 ...
 * Return: 0, or -ERRNO
 */
int nfp_cpp_explicit_get(struct nfp_cpp_explicit *expl, void *buff,
    size_t len) {
