 ...
 */
static void nfp_net_rx_ring_bufs_free(struct nfp_net_dp *dp,
 ...
 * @rx_ring:  RX ring to remove buffers from
 */
static int nfp_net_rx_ring_bufs_alloc(struct nfp_net_dp *dp,
    struct nfp_net_rx_ring *rx_ring) {
 ...
 */
static int nfp_net_rx_ring_alloc(struct nfp_net_dp *dp,
    struct nfp_net_rx_ring *rx_ring) {
...
void nfp_net_rx_ring_hw_cfg_write(struct nfp_net *nn,
...
void nfp_net_tx_ring_hw_cfg_write(struct nfp_net *nn,
