...
static int nfp_devlink_param_u8_get(struct devlink *devlink, u32 id,
...
static int nfp_devlink_param_u8_set(struct devlink *devlink, u32 id,
    struct devlink_param_gset_ctx *ctx) {
  const struct nfp_devlink_param_u8_arg *arg;
  struct nfp_pf *pf = devlink_priv(devlink);
  struct nfp_nsp *nsp;
...
static int nfp_devlink_param_u8_validate(struct devlink *devlink, u32 id,
