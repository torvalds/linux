...
static int nfp_bpf_xdp_offload(struct nfp_app *app, struct nfp_net *nn,
...
static int nfp_bpf_vnic_alloc(struct nfp_app *app, struct nfp_net *nn,
    unsigned int id) {
...
static int nfp_bpf_check_mtu(struct nfp_app *app, struct net_device *netdev,
    int new_mtu) {
  struct nfp_net *nn = netdev_priv(netdev);
  struct nfp_bpf_vnic *bv;
...
static int nfp_bpf_parse_cap_adjust_head(struct nfp_app_bpf *bpf,
    void __iomem *value,
    u32 length) {
...
static int nfp_bpf_parse_cap_func(struct nfp_app_bpf *bpf, void __iomem *value,
    u32 length) {
...
static int nfp_bpf_parse_cap_maps(struct nfp_app_bpf *bpf, void __iomem *value,
    u32 length) {
...
static int nfp_bpf_parse_cap_random(struct nfp_app_bpf *bpf,
    void __iomem *value,
    u32 length) {
...
static int nfp_bpf_parse_cap_qsel(struct nfp_app_bpf *bpf, void __iomem *value,
    u32 length) {
  bpf->queue_select = true;
  return 0;
}

static int nfp_bpf_parse_cap_adjust_tail(struct nfp_app_bpf *bpf,
    void __iomem *value,
    u32 length) {
...
static int nfp_bpf_parse_cap_cmsg_multi_ent(struct nfp_app_bpf *bpf,
    void __iomem *value,
    u32 length) {
...
static int nfp_bpf_parse_cap_abi_version(struct nfp_app_bpf *bpf,
    void __iomem *value,
    u32 length) {
  if (length < 4) {
