...
static void nfp_record_adjust_head(struct nfp_app_bpf *bpf,
...
static int nfp_bpf_stack_arg_ok(const char *fname, struct bpf_verifier_env *env,
...
static bool nfp_bpf_map_call_ok(const char *fname, struct bpf_verifier_env *env,
    struct nfp_insn_meta *meta,
...
static int nfp_bpf_check_helper_call(struct nfp_prog *nfp_prog,
...
static int nfp_bpf_check_exit(struct nfp_prog *nfp_prog,
    struct bpf_verifier_env *env) {
...
static int nfp_bpf_check_stack_access(struct nfp_prog *nfp_prog,
    struct nfp_insn_meta *meta,
    const struct bpf_reg_state *reg,
    struct bpf_verifier_env *env) {
  s32 old_off, new_off;
...
static int nfp_bpf_map_mark_used_one(struct bpf_verifier_env *env,
    struct nfp_bpf_map *nfp_map,
...
static int nfp_bpf_map_mark_used(struct bpf_verifier_env *env,
    struct nfp_insn_meta *meta,
    const struct bpf_reg_state *reg,
...
static int nfp_bpf_check_ptr(struct nfp_prog *nfp_prog,
    struct nfp_insn_meta *meta,
...
static int nfp_bpf_check_store(struct nfp_prog *nfp_prog,
    struct nfp_insn_meta *meta,
    struct bpf_verifier_env *env) {
...
static int nfp_bpf_check_atomic(struct nfp_prog *nfp_prog,
    struct nfp_insn_meta *meta,
    struct bpf_verifier_env *env) {
...
static int nfp_bpf_check_alu(struct nfp_prog *nfp_prog,
    struct nfp_insn_meta *meta,
    struct bpf_verifier_env *env) {
...
static int nfp_assign_subprog_idx_and_regs(struct bpf_verifier_env *env,
    struct nfp_prog *nfp_prog) {
  struct nfp_insn_meta *meta;
  int index = 0;
