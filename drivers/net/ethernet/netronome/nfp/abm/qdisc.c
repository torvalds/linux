...
static bool nfp_abm_qdisc_child_valid(struct nfp_qdisc *qdisc,
    unsigned int id) {
...
static void nfp_abm_stats_propagate(struct nfp_alink_stats *parent,
...
static void nfp_abm_stats_update_red(struct nfp_abm_link *alink,
...
static void nfp_abm_stats_update_mq(struct nfp_abm_link *alink,
    struct nfp_qdisc *qdisc) {
  unsigned int i;
...
static void nfp_abm_qdisc_unlink_children(struct nfp_qdisc *qdisc,
...
static void nfp_abm_qdisc_offload_stop(struct nfp_abm_link *alink,
    struct nfp_qdisc *qdisc) {
  unsigned int i;
...
static int __nfp_abm_stats_init(struct nfp_abm_link *alink, unsigned int band,
...
static int nfp_abm_stats_init(struct nfp_abm_link *alink,
    struct nfp_qdisc *qdisc,
    unsigned int queue) {
  unsigned int i;
  int err;
...
static void nfp_abm_offload_compile_red(struct nfp_abm_link *alink,
    struct nfp_qdisc *qdisc,
    unsigned int queue) {
...
static void nfp_abm_offload_compile_mq(struct nfp_abm_link *alink,
    struct nfp_qdisc *qdisc) {
  unsigned int i;
...
static void nfp_abm_qdisc_clear_mq(struct net_device *netdev,
...
static void nfp_abm_qdisc_free(struct net_device *netdev,
    struct nfp_abm_link *alink,
    struct nfp_qdisc *qdisc) {
...
static struct nfp_qdisc *nfp_abm_qdisc_alloc(struct net_device *netdev,
    struct nfp_abm_link *alink,
...
static struct nfp_qdisc *nfp_abm_qdisc_find(struct nfp_abm_link *alink,
    u32 handle) {
  return radix_tree_lookup(&alink->qdiscs, TC_H_MAJ(handle));
}

static int nfp_abm_qdisc_replace(struct net_device *netdev,
    struct nfp_abm_link *alink,
    enum nfp_qdisc_type type, u32 parent_handle, u32 handle,
...
static void nfp_abm_qdisc_destroy(struct net_device *netdev,
    struct nfp_abm_link *alink,
    u32 handle) {
  struct nfp_qdisc *qdisc;
  qdisc = nfp_abm_qdisc_find(alink, handle);
...
static int nfp_abm_qdisc_graft(struct nfp_abm_link *alink, u32 handle,
    u32 child_handle,
    unsigned int id) {
...
static void nfp_abm_stats_calculate(struct nfp_alink_stats *new,
...
static void nfp_abm_stats_red_calculate(struct nfp_alink_xstats *new,
...
static int nfp_abm_gred_stats(struct nfp_abm_link *alink, u32 handle,
...
static bool nfp_abm_gred_check_params(struct nfp_abm_link *alink,
...
static int nfp_abm_gred_replace(struct net_device *netdev,
    struct nfp_abm_link *alink,
    struct tc_gred_qopt_offload *opt) {
  struct nfp_qdisc *qdisc;
  unsigned int i;
...
static int nfp_abm_red_xstats(struct nfp_abm_link *alink,
...
static int nfp_abm_red_stats(struct nfp_abm_link *alink, u32 handle,
...
static bool nfp_abm_red_check_params(struct nfp_abm_link *alink,
    struct tc_red_qopt_offload *opt) {
  struct nfp_cpp *cpp = alink->abm->app->cpp;
  struct nfp_abm *abm = alink->abm;
...
static int nfp_abm_red_replace(struct net_device *netdev,
    struct nfp_abm_link *alink,
    struct tc_red_qopt_offload *opt) {
  struct nfp_qdisc *qdisc;
  int ret;
...
static int nfp_abm_mq_create(struct net_device *netdev,
    struct nfp_abm_link *alink,
...
static int nfp_abm_mq_stats(struct nfp_abm_link *alink, u32 handle,
    struct tc_qopt_offload_stats *stats) {
