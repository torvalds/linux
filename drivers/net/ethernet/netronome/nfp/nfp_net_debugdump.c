...
static int nfp_traverse_tlvs(struct nfp_pf *pf, void *data, u32 data_length,
    void *param,
...
struct nfp_dumpspec *nfp_net_dump_load_dumpspec(struct nfp_cpp *cpp,
...
static int nfp_calc_hwinfo_field_sz(struct nfp_pf *pf,
...
static int nfp_calc_rtsym_dump_sz(struct nfp_pf *pf, struct nfp_dump_tl *spec) {
...
static int nfp_add_tlv_size(struct nfp_pf *pf, struct nfp_dump_tl *tl,
    void *param) {
...
static int nfp_calc_specific_level_size(struct nfp_pf *pf,
    struct nfp_dump_tl *dump_level,
    void *param) {
...
static int nfp_add_tlv(u32 type, u32 total_tlv_sz,
...
static int nfp_dump_error_tlv(struct nfp_dump_tl *spec, int error,
    struct nfp_dump_state *dump) {
...
static int nfp_dump_hwinfo(struct nfp_pf *pf, struct nfp_dump_tl *spec,
    struct nfp_dump_state *dump) {
  struct nfp_dump_tl *dump_header = dump->p;
...
static int nfp_dump_csr_range(struct nfp_pf *pf,
    struct nfp_dumpspec_csr *spec_csr,
    struct nfp_dump_state *dump) {
 ...
 * from IndCtxStatus.
 */
static int nfp_read_indirect_csr(struct nfp_cpp *cpp,
...
static int nfp_read_all_indirect_csr_ctx(struct nfp_cpp *cpp,
...
static int nfp_dump_indirect_csr_range(struct nfp_pf *pf,
    struct nfp_dumpspec_csr *spec_csr,
    struct nfp_dump_state *dump) {
  struct nfp_dump_csr *dump_header = dump->p;
  u32 reg_sz, header_size, total_size;
...
static int nfp_dump_single_rtsym(struct nfp_pf *pf,
    struct nfp_dumpspec_rtsym *spec,
    struct nfp_dump_state *dump) {
...
static int nfp_dump_for_tlv(struct nfp_pf *pf, struct nfp_dump_tl *tl,
    void *param) {
  struct nfp_dumpspec_rtsym *spec_rtsym;
...
static int nfp_dump_specific_level(struct nfp_pf *pf,
    struct nfp_dump_tl *dump_level,
    void *param) {
  struct nfp_dump_state *dump = param;
