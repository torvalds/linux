 ...
 * extra careful here.
 */
static void nfp_nfd3_tx_ring_stop(struct netdev_queue *nd_q,
 ...
 */
static void nfp_nfd3_tx_tso(struct nfp_net_r_vector *r_vec,
 ...
 */
static void nfp_nfd3_tx_csum(struct nfp_net_dp *dp,
...
static void *nfp_nfd3_napi_alloc_one(struct nfp_net_dp *dp,
    dma_addr_t *dma_addr) {
  void *frag;
  if (!dp->xdp_prog) {
 ...
 */
static void nfp_nfd3_rx_give_one(const struct nfp_net_dp *dp,
...
static void nfp_nfd3_set_hash(struct net_device *netdev,
...
static void nfp_nfd3_set_hash_desc(struct net_device *netdev,
    struct nfp_meta_parsed *meta,
...
static void nfp_nfd3_rx_drop(const struct nfp_net_dp *dp,
    struct nfp_net_r_vector *r_vec,
...
static bool nfp_nfd3_tx_xdp_buf(struct nfp_net_dp *dp,
    struct nfp_net_rx_ring *rx_ring,
    struct nfp_net_tx_ring *tx_ring,
