...
void nfp_nfd3_rx_csum(const struct nfp_net_dp *dp,
    struct nfp_net_r_vector *r_vec,
    const struct nfp_net_rx_desc *rxd,
    const struct nfp_meta_parsed *meta, struct sk_buff *skb);
bool nfp_nfd3_parse_meta(struct net_device *netdev,
...
bool nfp_nfd3_ctrl_tx_one(struct nfp_net *nn, struct nfp_net_r_vector *r_vec,
...
static inline void nfp_nfd3_ipsec_tx(struct nfp_nfd3_tx_desc *txd,
    struct sk_buff *skb) {
}
