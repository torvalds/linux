...
struct atl1c_hw_stats {
  ...
  unsigned long rx_ctrl;    /* The number of Control packet received other than
                             * Pause frame. */
  unsigned long rx_fcs_err; /* The number of packets with bad FCS. */
  unsigned long rx_len_err; /* The number of packets with mismatch of length
                             * field and actual size. */
  unsigned long rx_byte_cnt;  /* The number of bytes of good packet received.
                               * FCS is NOT included. */
  unsigned long rx_runt;    /* The number of packets received that are less than
                             * 64 byte long and with good FCS. */
  unsigned long rx_frag;    /* The number of packets received that are less than
                             * 64 byte long and with bad FCS. */
  unsigned long rx_sz_64;   /* The number of good and bad packets received that
                             * are 64 byte long. */
  unsigned long rx_sz_65_127; /* The number of good and bad packets received
                               * that are between 65 and 127-byte long. */
  unsigned long rx_sz_128_255;  /* The number of good and bad packets received
                                 * that are between 128 and 255-byte long. */
  unsigned long rx_sz_256_511;  /* The number of good and bad packets received
                                 * that are between 256 and 511-byte long. */
  unsigned long rx_sz_512_1023; /* The number of good and bad packets received
                                 * that are between 512 and 1023-byte long. */
  unsigned long rx_sz_1024_1518;  /* The number of good and bad packets received
                                   * that are between 1024 and 1518-byte long.
                                   * */
  unsigned long rx_sz_1519_max; /* The number of good and bad packets received
                                 * that are between 1519-byte and MTU. */
  unsigned long rx_sz_ov;   /* The number of good and bad packets received that
                             * are more than MTU size truncated by Selene. */
  unsigned long rx_rxf_ov;  /* The number of frame dropped due to occurrence of
                             * RX FIFO overflow. */
  unsigned long rx_rrd_ov;  /* The number of frame dropped due to occurrence of
                             * RRD overflow. */
  unsigned long rx_align_err; /* Alignment Error */
  unsigned long rx_bcast_byte_cnt; /* The byte count of broadcast packet
                                    * received, excluding FCS. */
  unsigned long rx_mcast_byte_cnt; /* The byte count of multicast packet
                                    * received, excluding FCS. */
  unsigned long rx_err_addr;  /* The number of packets dropped due to address
                               * filtering. */
  ...
  unsigned long tx_exc_defer; /* The number of packets transmitted with
                               * excessive deferral. */
  unsigned long tx_ctrl;    /* The number of packets transmitted is a control
                             * frame, excluding Pause frame. */
  unsigned long tx_defer;   /* The number of packets transmitted that is
                             * deferred. */
  unsigned long tx_byte_cnt;  /* The number of bytes of data transmitted. FCS is
                               * NOT included. */
  unsigned long tx_sz_64;   /* The number of good and bad packets transmitted
                             * that are 64 byte long. */
  unsigned long tx_sz_65_127; /* The number of good and bad packets transmitted
                               * that are between 65 and 127-byte long. */
  unsigned long tx_sz_128_255;  /* The number of good and bad packets
                                 * transmitted that are between 128 and 255-byte
                                 * long. */
  unsigned long tx_sz_256_511;  /* The number of good and bad packets
                                 * transmitted that are between 256 and 511-byte
                                 * long. */
  unsigned long tx_sz_512_1023; /* The number of good and bad packets
                                 * transmitted that are between 512 and
                                 * 1023-byte long. */
  unsigned long tx_sz_1024_1518;  /* The number of good and bad packets
                                   * transmitted that are between 1024 and
                                   * 1518-byte long. */
  unsigned long tx_sz_1519_max; /* The number of good and bad packets
                                 * transmitted that are between 1519-byte and
                                 * MTU. */
  unsigned long tx_1_col;   /* The number of packets subsequently transmitted
                             * successfully with a single prior collision. */
  unsigned long tx_2_col;   /* The number of packets subsequently transmitted
                            * successfully with multiple prior collisions. */
  unsigned long tx_late_col;  /* The number of packets transmitted with late
                               * collisions. */
  unsigned long tx_abort_col; /* The number of transmit packets aborted due to
                               * excessive collisions. */
  unsigned long tx_underrun;  /* The number of transmit packets aborted due to
                               * transmit FIFO underrun, or TRD FIFO underrun */
  unsigned long tx_rd_eop;  /* The number of times that read beyond the EOP into
                             * the next frame area when TRD was not written
                             * timely */
  unsigned long tx_len_err; /* The number of transmit packets with length field
                             * does NOT match the actual frame size. */
  unsigned long tx_trunc;   /* The number of transmit packets truncated due to
                             * size exceeding MTU. */
  unsigned long tx_bcast_byte;  /* The byte count of broadcast packet
                                 * transmitted, excluding FCS. */
  unsigned long tx_mcast_byte;  /* The byte count of multicast packet
                                 * transmitted, excluding FCS. */
};
