...
static inline void rocker_tlv_parse_desc(const struct rocker_tlv **tb,
    int maxtype,
...
static inline struct rocker_tlv *rocker_tlv_start(
...
static inline struct rocker_tlv *rocker_tlv_nest_start(
    struct rocker_desc_info *desc_info, int attrtype) {
