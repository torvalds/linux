...
MODULE_PARM_DESC(qcaspi_clkspeed,
...
MODULE_PARM_DESC(qcaspi_burst_len,
...
static netdev_tx_t qcaspi_netdev_xmit(struct sk_buff *skb,
...
static void qca_spi_remove(struct spi_device *spi) {
