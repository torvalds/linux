...
unsigned long ax88796c_no_regs_mask[AX88796C_REGDUMP_LEN
...
static int ax88796c_check_free_pages(struct ax88796c_device *ax_local,
    u8 need_pages) {
  u8 free_pages;
  u16 tmp;
  lockdep_assert_held(&ax_local->spi_lock);
...
static struct sk_buff *ax88796c_tx_fixup(struct net_device *ndev,
...
static netdev_tx_t ax88796c_start_xmit(struct sk_buff *skb,
...
static void ax88796c_skb_return(struct ax88796c_device *ax_local,
...
static void ax88796c_rx_fixup(struct ax88796c_device *ax_local,
...
static int ax88796c_open(struct net_device *ndev) {
  struct ax88796c_device *ax_local = to_ax88796c_device(ndev);
...
static int ax88796c_close(struct net_device *ndev) {
  struct ax88796c_device *ax_local = to_ax88796c_device(ndev);
...
static int ax88796c_set_features(struct net_device *ndev,
