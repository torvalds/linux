...
static void ultra_get_8390_hdr(struct net_device *dev,
...
static int __init ultra_probe1(struct net_device *dev, int ioaddr) {
  ...
  ei_status.mem
    = ioremap(dev->mem_start, (ei_status.stop_page - START_PG) * 256);
  if (!ei_status.mem) {
...
static int ultra_open(struct net_device *dev) {
  ...
  unsigned char irq2reg[] = {
    0, 0, 0x04, 0x08, 0, 0x0C, 0, 0x40,
