...
static const char gve_gstrings_rx_stats[][ETH_GSTRING_LEN] = {
  ...
  "rx_xdp_alloc_fails[%u]",
};

static const char gve_gstrings_tx_stats[][ETH_GSTRING_LEN] = {
  "tx_posted_desc[%u]", "tx_completed_desc[%u]", "tx_consumed_desc[%u]",
  "tx_bytes[%u]",
  "tx_wake[%u]", "tx_stop[%u]", "tx_event_counter[%u]",
  "tx_dma_mapping_error[%u]", "tx_xsk_wakeup[%u]",
  "tx_xsk_done[%u]", "tx_xsk_sent[%u]", "tx_xdp_xmit[%u]",
  "tx_xdp_xmit_errors[%u]"
};
...
static void gve_get_strings(struct net_device *netdev, u32 stringset,
    u8 *data) {
  struct gve_priv *priv = netdev_priv(netdev);
  char *s = (char *) data;
  int num_tx_queues;
...
static void gve_get_ethtool_stats(struct net_device *netdev,
