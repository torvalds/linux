...
static
struct gve_device_option *gve_get_next_option(
  ...
  return option_end
    > descriptor_end ? NULL : (struct gve_device_option *) option_end;
}
...
static int gve_process_device_options(struct gve_priv *priv,
    struct gve_device_descriptor *descriptor,
    struct gve_device_option_gqi_rda **dev_op_gqi_rda,
    struct gve_device_option_gqi_qpl **dev_op_gqi_qpl,
    struct gve_device_option_dqo_rda **dev_op_dqo_rda,
...
static int gve_set_desc_cnt_dqo(struct gve_priv *priv,
