...
#define PAS_MAC_IPC_CHNL_DCHANAL_M	0x003f0000
#define PAS_MAC_IPC_CHNL_DCHANAL_S	16
#define PAS_MAC_IPC_CHNL_DCHANAL(x)	(((x) << PAS_MAC_IPC_CHNL_DCHANAL_S) & \
					 PAS_MAC_IPC_CHNL_DCHANAL_M)
