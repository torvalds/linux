...
static int dpaa2_switch_acl_entry_remove(
...
static int dpaa2_switch_acl_entry_add_to_list(
    struct dpaa2_switch_filter_block *block,
    struct dpaa2_switch_acl_entry *entry) {
...
static struct dpaa2_switch_acl_entry *dpaa2_switch_acl_entry_get_by_index(
    struct dpaa2_switch_filter_block *block,
    int index) {
  struct dpaa2_switch_acl_entry *tmp;
  int i = 0;
...
static int dpaa2_switch_acl_entry_set_precedence(
    struct dpaa2_switch_filter_block *block,
    struct dpaa2_switch_acl_entry *entry,
    int precedence) {
  int err;
...
static int dpaa2_switch_acl_tbl_add_entry(
    struct dpaa2_switch_filter_block *block,
    struct dpaa2_switch_acl_entry *entry) {
  struct dpaa2_switch_acl_entry *tmp;
...
static struct dpaa2_switch_acl_entry *dpaa2_switch_acl_tbl_find_entry_by_cookie(
    struct dpaa2_switch_filter_block *block,
...
static int dpaa2_switch_acl_entry_get_index(
    struct dpaa2_switch_filter_block *block,
    struct dpaa2_switch_acl_entry *entry) {
  struct dpaa2_switch_acl_entry *tmp, *n;
  int index = 0;
...
static int dpaa2_switch_acl_tbl_remove_entry(
    struct dpaa2_switch_filter_block *block,
    struct dpaa2_switch_acl_entry *entry) {
  struct dpaa2_switch_acl_entry *tmp;
  int index, i, precedence, err;
...
static int dpaa2_switch_block_add_mirror(
    struct dpaa2_switch_filter_block *block,
...
static int dpaa2_switch_block_remove_mirror(
    struct dpaa2_switch_filter_block *block,
    struct dpaa2_switch_mirror_entry *entry) {
...
static int dpaa2_switch_cls_flower_replace_acl(
    struct dpaa2_switch_filter_block *block,
...
static int dpaa2_switch_cls_flower_replace_mirror(
    struct dpaa2_switch_filter_block *block,
    struct flow_cls_offload *cls) {
  struct netlink_ext_ack *extack = cls->common.extack;
...
static int dpaa2_switch_cls_matchall_replace_acl(
    struct dpaa2_switch_filter_block *block,
...
static int dpaa2_switch_cls_matchall_replace_mirror(
    struct dpaa2_switch_filter_block *block,
    struct tc_cls_matchall_offload *cls) {
  struct netlink_ext_ack *extack = cls->common.extack;
  struct dpaa2_switch_mirror_entry *mirror_entry;
