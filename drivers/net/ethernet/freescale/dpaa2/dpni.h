...
/**
 * DPNI_BUF_LAYOUT_OPT_PRIVATE_DATA_SIZE - Select to modify the
 * private-data-size setting
 */
...
/**
 * DPNI_BUF_LAYOUT_OPT_DATA_HEAD_ROOM - Select to modify the data-head-room
 * setting
 */
#define DPNI_BUF_LAYOUT_OPT_DATA_HEAD_ROOM  0x00000020
/**
 * DPNI_BUF_LAYOUT_OPT_DATA_TAIL_ROOM - Select to modify the data-tail-room
 * setting
 */
...
int dpni_get_api_version(struct fsl_mc_io *mc_io,
    ...
    u16 *minor_ver);
/**
 * struct dpni_tx_shaping_cfg - Structure representing DPNI tx shaping
 * configuration
