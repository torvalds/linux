...
int dpsw_if_set_link_cfg(struct fsl_mc_io *mc_io, u32 cmd_flags, u16 token,
    u16 if_id,
...
int dpsw_if_set_tci(struct fsl_mc_io *mc_io, u32 cmd_flags, u16 token,
    u16 if_id,
    const struct dpsw_tci_cfg *cfg);

int dpsw_if_get_tci(struct fsl_mc_io *mc_io, u32 cmd_flags, u16 token,
    u16 if_id,
...
int dpsw_if_set_stp(struct fsl_mc_io *mc_io, u32 cmd_flags, u16 token,
    u16 if_id,
...
int dpsw_if_enable(struct fsl_mc_io *mc_io, u32 cmd_flags, u16 token,
    u16 if_id);

int dpsw_if_disable(struct fsl_mc_io *mc_io, u32 cmd_flags, u16 token,
    u16 if_id);
...
int dpsw_if_set_max_frame_length(struct fsl_mc_io *mc_io, u32 cmd_flags,
    u16 token,
...
int dpsw_vlan_remove_if_untagged(struct fsl_mc_io *mc_io, u32 cmd_flags,
    u16 token,
    u16 vlan_id, const struct dpsw_vlan_if_cfg *cfg);
...
int dpsw_fdb_remove(struct fsl_mc_io *mc_io, u32 cmd_flags, u16 token,
    u16 fdb_id);
