...
static int dpaa2_switch_get_link_ksettings(struct net_device *netdev,
...
static int dpaa2_switch_set_link_ksettings(struct net_device *netdev,
...
static int dpaa2_switch_ethtool_get_sset_count(struct net_device *netdev,
    int sset) {
  switch (sset) {
    case ETH_SS_STATS:
