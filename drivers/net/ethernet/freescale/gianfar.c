...
static void gfar_get_stats64(struct net_device *dev,
...
static int gfar_of_init(struct platform_device *ofdev,
...
static bool gfar_new_page(struct gfar_priv_rx_q *rxq,
 ...
 */
static netdev_tx_t gfar_start_xmit(struct sk_buff *skb,
...
static void gfar_clear_exact_match(struct net_device *dev) {
  int idx;
  static const u8 zero_arr[ETH_ALEN] = {
    0, 0, 0, 0, 0, 0
  };
