...
static void enetc_get_strings(struct net_device *ndev, u32 stringset,
    u8 *data) {
  struct enetc_ndev_priv *priv = netdev_priv(ndev);
  u8 *p = data;
  int i, j;
...
static int enetc_set_rxnfc(struct net_device *ndev,
...
static int enetc_get_mm(struct net_device *ndev,
