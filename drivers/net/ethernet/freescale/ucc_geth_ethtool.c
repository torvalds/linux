...
static int uec_get_ksettings(struct net_device *netdev,
...
static int uec_set_ksettings(struct net_device *netdev,
...
static void uec_get_pauseparam(struct net_device *netdev,
...
static int uec_set_pauseparam(struct net_device *netdev,
    struct ethtool_pauseparam *pause) {
  struct ucc_geth_private *ugeth = netdev_priv(netdev);
  int ret = 0;
...
static uint32_t uec_get_msglevel(struct net_device *netdev) {
  struct ucc_geth_private *ugeth = netdev_priv(netdev);
  return ugeth->msg_enable;
}

static void uec_set_msglevel(struct net_device *netdev, uint32_t data) {
  struct ucc_geth_private *ugeth = netdev_priv(netdev);
  ugeth->msg_enable = data;
}

static int uec_get_regs_len(struct net_device *netdev) {
  return sizeof(struct ucc_geth);
}

static void uec_get_regs(struct net_device *netdev,
...
static void uec_get_ringparam(struct net_device *netdev,
...
static int uec_set_ringparam(struct net_device *netdev,
    struct ethtool_ringparam *ring,
    struct kernel_ethtool_ringparam *kernel_ring,
    struct netlink_ext_ack *extack) {
  struct ucc_geth_private *ugeth = netdev_priv(netdev);
...
static void uec_get_drvinfo(struct net_device *netdev,
...
static void uec_get_wol(struct net_device *netdev,
