...
static inline void jme_reset_phy_processor(struct jme_adapter *jme) {
  u32 val;
...
static inline void jme_mac_rxclk_off(struct jme_adapter *jme) {
  jme->reg_gpreg1 |= GPREG1_RXCLKOFF;
  jwrite32f(jme, JME_GPREG1, jme->reg_gpreg1);
}

static inline void jme_mac_rxclk_on(struct jme_adapter *jme) {
  jme->reg_gpreg1 &= ~GPREG1_RXCLKOFF;
  jwrite32f(jme, JME_GPREG1, jme->reg_gpreg1);
}

static inline void jme_mac_txclk_off(struct jme_adapter *jme) {
  jme->reg_ghc &= ~(GHC_TO_CLK_SRC | GHC_TXMAC_CLK_SRC);
  jwrite32f(jme, JME_GHC, jme->reg_ghc);
}

static inline void jme_mac_txclk_on(struct jme_adapter *jme) {
...
static inline void jme_reset_ghc_speed(struct jme_adapter *jme) {
  jme->reg_ghc &= ~(GHC_SPEED | GHC_DPX);
  jwrite32f(jme, JME_GHC, jme->reg_ghc);
}

static inline void jme_reset_250A2_workaround(struct jme_adapter *jme) {
  jme->reg_gpreg1 &= ~(GPREG1_HALFMODEPATCH
      | GPREG1_RSSPATCH);
  jwrite32(jme, JME_GPREG1, jme->reg_gpreg1);
}

static inline void jme_assert_ghc_reset(struct jme_adapter *jme) {
  jme->reg_ghc |= GHC_SWRST;
  jwrite32f(jme, JME_GHC, jme->reg_ghc);
}

static inline void jme_clear_ghc_reset(struct jme_adapter *jme) {
  jme->reg_ghc &= ~GHC_SWRST;
  jwrite32f(jme, JME_GHC, jme->reg_ghc);
}

static void jme_reset_mac_processor(struct jme_adapter *jme) {
  static const u32 mask[WAKEUP_FRAME_MASK_DWNR] = {
    0, 0, 0, 0
  };
  u32 crc = 0xCDCDCDCD;
  u32 gpreg0;
...
static inline void jme_clear_pm_enable_wol(struct jme_adapter *jme) {
  jwrite32(jme, JME_PMCS, PMCS_STMASK | jme->reg_pmcs);
}

static inline void jme_clear_pm_disable_wol(struct jme_adapter *jme) {
...
static inline void jme_set_rx_pcc(struct jme_adapter *jme, int p) {
  switch (p) {
    case PCC_OFF:
...
static inline void jme_stop_irq(struct jme_adapter *jme) {
  /*
   * Disable Interrupts
   */
...
static inline void jme_set_phyfifo_5level(struct jme_adapter *jme) {
  jme_mdio_write(jme->dev, jme->mii_if.phy_id, 27, 0x0004);
}

static inline void jme_set_phyfifo_8level(struct jme_adapter *jme) {
...
static inline void jme_enable_tx_engine(struct jme_adapter *jme) {
  /*
   * Select Queue 0
   */
...
static inline void jme_disable_tx_engine(struct jme_adapter *jme) {
  int i;
  u32 val;
  /*
   * Disable TX Engine
...
static inline void jme_enable_rx_engine(struct jme_adapter *jme) {
  /*
   * Select Queue 0
   */
...
static inline void jme_restart_rx_engine(struct jme_adapter *jme) {
  /*
   * Start RX Engine
   */
  jwrite32(jme, JME_RXCS, jme->reg_rxcs
...
static inline void jme_disable_rx_engine(struct jme_adapter *jme) {
  int i;
  u32 val;
  /*
   * Disable RX Engine
...
static int jme_rxsum_ok(struct jme_adapter *jme, u16 flags,
    struct sk_buff *skb) {
...
static inline void jme_stop_pcc_timer(struct jme_adapter *jme) {
...
static inline void jme_polling_mode(struct jme_adapter *jme) {
  jme_set_rx_pcc(jme, PCC_OFF);
}

static inline void jme_interrupt_mode(struct jme_adapter *jme) {
  jme_set_rx_pcc(jme, PCC_P1);
}

static inline int jme_pseudo_hotplug_enabled(struct jme_adapter *jme) {
  u32 apmc;
...
static int jme_poll(JME_NAPI_HOLDER(holder), JME_NAPI_WEIGHT(budget)) {
...
static inline void jme_new_phy_on(struct jme_adapter *jme) {
  u32 reg;
...
static inline void jme_new_phy_off(struct jme_adapter *jme) {
  u32 reg;
  reg = jread32(jme, JME_PHY_PWR);
  reg |= PHY_PWR_DWN1SEL | PHY_PWR_DWN1SW
      | PHY_PWR_DWN2 | PHY_PWR_CLKSEL;
...
static inline void jme_phy_on(struct jme_adapter *jme) {
  u32 bmcr;
  bmcr = jme_mdio_read(jme->dev, jme->mii_if.phy_id, MII_BMCR);
  bmcr &= ~BMCR_PDOWN;
  jme_mdio_write(jme->dev, jme->mii_if.phy_id, MII_BMCR, bmcr);
...
static inline void jme_phy_off(struct jme_adapter *jme) {
  u32 bmcr;
  bmcr = jme_mdio_read(jme->dev, jme->mii_if.phy_id, MII_BMCR);
  bmcr |= BMCR_PDOWN;
  jme_mdio_write(jme->dev, jme->mii_if.phy_id, MII_BMCR, bmcr);
...
static void jme_phy_specreg_write(struct jme_adapter *jme, u32 ext_reg,
    u32 phy_data) {
  u32 phy_addr;
...
static int jme_fill_tx_map(struct pci_dev *pdev,
...
static int jme_map_tx_skb(struct jme_adapter *jme, struct sk_buff *skb,
    int idx) {
  struct jme_ring *txring = &(jme->txring[0]);
...
static void jme_tx_csum(struct jme_adapter *jme, struct sk_buff *skb,
    u8 *flags) {
...
static inline void jme_tx_vlan(struct sk_buff *skb, __le16 *vlan, u8 *flags) {
...
static int jme_fill_tx_desc(struct jme_adapter *jme, struct sk_buff *skb,
    int idx) {
  struct jme_ring *txring = &(jme->txring[0]);
  struct txdesc *txdesc;
  struct jme_buffer_info *txbi;
...
static netdev_tx_t jme_start_xmit(struct sk_buff *skb,
...
static void jme_tx_timeout(struct net_device *netdev, unsigned int txqueue) {
  struct jme_adapter *jme = netdev_priv(netdev);
  jme->phylink = 0;
  jme_reset_phy_processor(jme);
  if (test_bit(JME_FLAG_SSET, &jme->flags)) {
...
static void jme_get_regs(struct net_device *netdev, struct ethtool_regs *regs,
    void *p) {
  struct jme_adapter *jme = netdev_priv(netdev);
  u32 *p32 = (u32 *) p;
...
static void jme_get_pauseparam(struct net_device *netdev,
...
static int jme_set_pauseparam(struct net_device *netdev,
    struct ethtool_pauseparam *ecmd) {
  struct jme_adapter *jme = netdev_priv(netdev);
  u32 val;
...
static void jme_get_wol(struct net_device *netdev,
...
static int jme_set_wol(struct net_device *netdev,
    struct ethtool_wolinfo *wol) {
  struct jme_adapter *jme = netdev_priv(netdev);
...
static int jme_get_link_ksettings(struct net_device *netdev,
...
static netdev_features_t jme_fix_features(struct net_device *netdev,
...
static int jme_set_features(struct net_device *netdev,
    netdev_features_t features) {
  struct jme_adapter *jme = netdev_priv(netdev);
  spin_lock_bh(&jme->rxmcs_lock);
...
static int jme_get_eeprom(struct net_device *netdev,
...
static int jme_set_eeprom(struct net_device *netdev,
    struct ethtool_eeprom *eeprom, u8 *data) {
  struct jme_adapter *jme = netdev_priv(netdev);
  int i, offset = eeprom->offset, len = eeprom->len;
...
static inline void jme_phy_init(struct jme_adapter *jme) {
  u16 reg26;
  reg26 = jme_mdio_read(jme->dev, jme->mii_if.phy_id, 26);
  jme_mdio_write(jme->dev, jme->mii_if.phy_id, 26, reg26 | 0x1000);
}

static inline void jme_check_hw_ver(struct jme_adapter *jme) {
  u32 chipmode;
