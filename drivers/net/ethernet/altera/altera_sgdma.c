...
static dma_addr_t sgdma_txphysaddr(struct altera_tse_private *priv,
    struct sgdma_descrip __iomem *desc);

static dma_addr_t sgdma_rxphysaddr(struct altera_tse_private *priv,
    struct sgdma_descrip __iomem *desc);
...
static void queue_tx(struct altera_tse_private *priv,
    struct tse_buffer *buffer);

static void queue_rx(struct altera_tse_private *priv,
    struct tse_buffer *buffer);
