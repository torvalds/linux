...
#define TX_DMA_PLEN0(x)   (((x) & eth->soc->txrx.dma_max_len) << \
...
#define RX_DMA_PREP_PLEN0(x)  (((x) & eth->soc->txrx.dma_max_len) << \
    eth->soc->txrx.dma_len_offset)
#define RX_DMA_GET_PLEN0(x) (((x) >> \
  eth->soc->txrx.dma_len_offset) & eth->soc->txrx.dma_max_len)
