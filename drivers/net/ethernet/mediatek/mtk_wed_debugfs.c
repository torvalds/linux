...
#define DUMP_WPDMA_TX_RING(_n) DUMP_RING("WPDMA_TX" #_n, 0, DUMP_TYPE_WPDMA_TX, \
    _n)
#define DUMP_WPDMA_TXFREE_RING DUMP_RING("WPDMA_RX1", 0, DUMP_TYPE_WPDMA_TXFREE)
#define DUMP_WPDMA_RX_RING(_n)  DUMP_RING("WPDMA_RX" #_n, 0, DUMP_TYPE_WPDMA_RX, \
    _n)
#define DUMP_WED_RRO_RING(_base) DUMP_RING("WED_RRO_MIOD", MTK_ ## _base, \
    DUMP_TYPE_WED_RRO)
#define DUMP_WED_RRO_FDBK(_base) DUMP_RING("WED_RRO_FDBK", MTK_ ## _base, \
    DUMP_TYPE_WED_RRO)

static void print_reg_val(struct seq_file *s, const char *name, u32 val) {
  seq_printf(s, "%-32s %08x\n", name, val);
}

static void dump_wed_regs(struct seq_file *s, struct mtk_wed_device *dev,
...
static int wed_txinfo_show(struct seq_file *s, void *data) {
...
static int wed_rxinfo_show(struct seq_file *s, void *data) {
...
static int wed_amsdu_show(struct seq_file *s, void *data) {
  static const struct reg_dump regs[] = {
...
static int wed_rtqm_show(struct seq_file *s, void *data) {
  static const struct reg_dump regs[] = {
...
static int wed_rro_show(struct seq_file *s, void *data) {
  static const struct reg_dump regs[] = {
...
static int mtk_wed_reg_set(void *data, u64 val) {
  struct mtk_wed_hw *hw = data;
  regmap_write(hw->regs, hw->debugfs_reg, val);
  return 0;
}

static int mtk_wed_reg_get(void *data, u64 *val) {
  struct mtk_wed_hw *hw = data;
  unsigned int regval;
  int ret;
