...
wed_amsdu_show(struct seq_file *s, void *data)
{
	static const struct reg_dump regs[] = {
		...
		DUMP_WED(WED_MON_AMSDU_ENG_QEANAL(0)),
		...
		DUMP_WED(WED_MON_AMSDU_ENG_QEANAL(1)),
		...
		DUMP_WED(WED_MON_AMSDU_ENG_QEANAL(2)),
		...
		DUMP_WED(WED_MON_AMSDU_ENG_QEANAL(3)),
		...
		DUMP_WED(WED_MON_AMSDU_ENG_QEANAL(4)),
		...
		DUMP_WED(WED_MON_AMSDU_ENG_QEANAL(5)),
		...
		DUMP_WED(WED_MON_AMSDU_ENG_QEANAL(6)),
		...
		DUMP_WED(WED_MON_AMSDU_ENG_QEANAL(7)),
		...
		DUMP_WED(WED_MON_AMSDU_ENG_QEANAL(8)),
