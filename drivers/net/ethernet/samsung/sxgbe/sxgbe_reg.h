...
#define SXGBE_CORE_DE_REG		0x0114
...
#define SXGBE_MTL_DE_CTL_REG		(SXGBE_MTL_BASE_REG + 0x0008)
#define SXGBE_MTL_DE_STATUS_REG	(SXGBE_MTL_BASE_REG + 0x000C)
#define SXGBE_MTL_FIFO_DEDATA_REG	(SXGBE_MTL_BASE_REG + 0x0010)
...
#define SXGBE_MTL_TXQ_DE_REG(qnum)				\
...
#define SXGBE_MTL_RXQ_DE_REG(qnum)				\
...
#define SXGBE_DMA_DE_STATUS0_REG	(SXGBE_DMA_BASE_REG + 0x0020)
#define SXGBE_DMA_DE_STATUS1_REG	(SXGBE_DMA_BASE_REG + 0x0024)
#define SXGBE_DMA_DE_STATUS2_REG	(SXGBE_DMA_BASE_REG + 0x0028)
#define SXGBE_DMA_DE_STATUS3_REG	(SXGBE_DMA_BASE_REG + 0x002C)
#define SXGBE_DMA_DE_STATUS4_REG	(SXGBE_DMA_BASE_REG + 0x0030)
#define SXGBE_DMA_DE_STATUS5_REG	(SXGBE_DMA_BASE_REG + 0x0034)
...
#define SXGBE_HW_FEAT_DE_MEM_IFACE(cap)	((cap & 0x00080000) >> 19)
