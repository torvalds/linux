...
static inline void bfa_wc_up(struct bfa_wc *wc) {
  wc->wc_count++;
}

static inline void bfa_wc_down(struct bfa_wc *wc) {
  wc->wc_count--;
  if (wc->wc_count == 0) {
...
static inline void bfa_wc_init(struct bfa_wc *wc, bfa_wc_resume_t wc_resume,
    void *wc_cbarg) {
...
static inline void bfa_wc_wait(struct bfa_wc *wc) {
  bfa_wc_down(wc);
}
