...
static void cmdq_sm_init_wait(struct bfa_msgq_cmdq *cmdq,
...
static void cmdq_sm_dbell_wait(struct bfa_msgq_cmdq *cmdq,
    enum cmdq_event event) {
  switch (event) {
    case CMDQ_E_STOP:
    case CMDQ_E_FAIL:
...
static void __cmd_copy(struct bfa_msgq_cmdq *cmdq,
...
static void bfa_msgq_cmdq_ci_update(struct bfa_msgq_cmdq *cmdq,
    struct bfi_mbmsg *mb) {
...
static void bfa_msgq_cmdq_copy_req(struct bfa_msgq_cmdq *cmdq,
    struct bfi_mbmsg *mb) {
...
static void bfa_msgq_cmdq_attach(struct bfa_msgq_cmdq *cmdq,
...
static void rspq_sm_init_wait(struct bfa_msgq_rspq *rspq,
...
static void rspq_sm_dbell_wait(struct bfa_msgq_rspq *rspq,
    enum rspq_event event) {
  switch (event) {
    case RSPQ_E_STOP:
    case RSPQ_E_FAIL:
...
static void bfa_msgq_rspq_pi_update(struct bfa_msgq_rspq *rspq,
    struct bfi_mbmsg *mb) {
  struct bfi_msgq_i2h_db *dbell = (struct bfi_msgq_i2h_db *) mb;
...
static void bfa_msgq_rspq_attach(struct bfa_msgq_rspq *rspq,
    struct bfa_msgq *msgq) {
...
static void bfa_msgq_init_rsp(struct bfa_msgq *msgq,
    struct bfi_mbmsg *mb) {
