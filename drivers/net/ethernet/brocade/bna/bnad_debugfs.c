...
static ssize_t bnad_debugfs_read(struct file *file, char __user *buf,
...
static ssize_t bnad_debugfs_read_regrd(struct file *file, char __user *buf,
    size_t nbytes, loff_t *pos) {
...
static ssize_t bnad_debugfs_write_regrd(struct file *file,
...
static ssize_t bnad_debugfs_write_regwr(struct file *file,
    const char __user *buf,
    size_t nbytes, loff_t *ppos) {
  struct bnad_debug_info *debug = file->private_data;
