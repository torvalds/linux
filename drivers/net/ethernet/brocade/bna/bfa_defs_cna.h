...
struct bfa_port_fc_stats {
	...
	u64	err_enc_out;	/*!< Encoding err yesnframe_8b10b */
...
struct bfa_port_eth_stats {
	...
	u64	rx_unkyeswn_opcode; /*!< Rx unkyeswn opcode	*/
...
enum bfa_cee_lls {
	/* LLS is down because the TLV yest sent by the peer */
