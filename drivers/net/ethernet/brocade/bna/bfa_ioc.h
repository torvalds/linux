...
void bfa_nw_ioc_de_memclaim(struct bfa_ioc *ioc, void *dbg_fwsave);
int bfa_nw_ioc_de_fwtrc(struct bfa_ioc *ioc, void *trcdata, int *trclen);
int bfa_nw_ioc_de_fwsave(struct bfa_ioc *ioc, void *trcdata, int *trclen);
