...
static void bfa_ioc_ct_set_cur_ioc_fwstate(struct bfa_ioc *ioc,
...
static void bfa_ioc_ct_set_alt_ioc_fwstate(struct bfa_ioc *ioc,
    enum bfi_ioc_state fwstate) {
...
static void bfa_ioc_ct2_sclk_init(void __iomem *rb) {
  u32 r32;
  /*
...
static void bfa_ioc_ct2_lclk_init(void __iomem *rb) {
  u32 r32;
  /*
...
static void bfa_ioc_ct2_mem_init(void __iomem *rb) {
  u32 r32;
  r32 = readl(rb + PSS_CTL_REG);
  r32 &= ~__PSS_LMEM_RESET;
  writel(r32, rb + PSS_CTL_REG);
...
static void bfa_ioc_ct2_mac_reset(void __iomem *rb) {
  volatile u32 r32;
...
static bool bfa_ioc_ct2_nfc_halted(void __iomem *rb) {
  volatile u32 r32;
...
static void bfa_ioc_ct2_nfc_resume(void __iomem *rb) {
  volatile u32 r32;
  int i;
