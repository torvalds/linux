...
static int lan966x_vcap_is1_get_port_keysets(struct net_device *ndev,
    int lookup,
...
static int lan966x_vcap_is2_get_port_keysets(struct net_device *dev, int lookup,
    struct vcap_keyset_list *keysetlist,
    u16 l3_proto) {
...
static enum vcap_keyfield_set lan966x_vcap_validate_keyset(
...
static struct vcap_admin *lan966x_vcap_admin_alloc(struct lan966x *lan966x,
