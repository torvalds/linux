...
static void lan966x_vlan_port_add_vlan_mask(struct lan966x_port *port,
    u16 vid) {
...
static void lan966x_vlan_port_del_vlan_mask(struct lan966x_port *port,
    u16 vid) {
  struct lan966x *lan966x = port->lan966x;
  u8 p = port->chip_port;
  lan966x->vlan_mask[vid] &= ~BIT(p);
...
static void lan966x_vlan_cpu_add_cpu_vlan_mask(struct lan966x *lan966x,
    u16 vid) {
