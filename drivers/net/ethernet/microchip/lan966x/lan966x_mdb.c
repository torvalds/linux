...
static struct lan966x_mdb_entry *lan966x_mdb_entry_get(struct lan966x *lan966x,
...
static struct lan966x_mdb_entry *lan966x_mdb_entry_add(struct lan966x *lan966x,
...
static struct lan966x_pgid_entry *lan966x_pgid_entry_add(
    struct lan966x *lan966x, int index, u16 ports) {
...
static struct lan966x_pgid_entry *lan966x_pgid_entry_get(
...
static enum macaccess_entry_type lan966x_mdb_classify(const unsigned char *mac)
{
