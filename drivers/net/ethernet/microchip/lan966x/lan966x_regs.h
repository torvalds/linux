...
#define REW_PORT_CFG_ANAL_REWRITE                  BIT(0)
#define REW_PORT_CFG_ANAL_REWRITE_SET(x)\
	FIELD_PREP(REW_PORT_CFG_ANAL_REWRITE, x)
#define REW_PORT_CFG_ANAL_REWRITE_GET(x)\
	FIELD_GET(REW_PORT_CFG_ANAL_REWRITE, x)
