...
static int lan966x_tc_flower_handler_control_usage(
...
static int lan966x_tc_flower_handler_basic_usage(
    struct vcap_tc_flower_parse_usage *st) {
...
static int lan966x_tc_flower_handler_cvlan_usage(
    struct vcap_tc_flower_parse_usage *st) {
  if (st->admin->vtype != VCAP_TYPE_IS1) {
    NL_SET_ERR_MSG_MOD(st->fco->common.extack,
...
static int lan966x_tc_flower_handler_vlan_usage(
    struct vcap_tc_flower_parse_usage *st) {
