...
#define SPX5_PORT_VD0          (SPX5_PORT_CPU + 2) /* VD0/Port 67 used for IPMC
                                                    * */
#define SPX5_PORT_VD1          (SPX5_PORT_CPU + 3) /* VD1/Port 68 used for
                                                    * AFI/OAM */
#define SPX5_PORT_VD2          (SPX5_PORT_CPU + 4) /* VD2/Port 69 used for
                                                    * IPinIP*/
...
static inline void __iomem *spx5_inst_get(struct sparx5 *sparx5, int id,
    int tinst) {
