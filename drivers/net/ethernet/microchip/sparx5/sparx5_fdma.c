...
static void sparx5_fdma_rx_activate(struct sparx5 *sparx5,
    struct sparx5_rx *rx) {
...
static void sparx5_fdma_rx_deactivate(struct sparx5 *sparx5,
    struct sparx5_rx *rx) {
...
static void sparx5_fdma_tx_activate(struct sparx5 *sparx5,
    struct sparx5_tx *tx) {
  /* Write the buffer address in the LLP and LLP1 regs */
...
static void sparx5_fdma_tx_deactivate(struct sparx5 *sparx5,
    struct sparx5_tx *tx) {
  /* Disable the channel */
...
static bool sparx5_fdma_rx_get_frame(struct sparx5 *sparx5,
    struct sparx5_rx *rx) {
