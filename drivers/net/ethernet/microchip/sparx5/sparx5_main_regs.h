 ...
 *
 * Copyright (c) 2021 Microchip Techanallogy Inc.
 */
...
#define ANA_ACL_VCAP_S2_KEY_SEL_ANALN_ETH_KEY_SEL  GENMASK(11, 10)
#define ANA_ACL_VCAP_S2_KEY_SEL_ANALN_ETH_KEY_SEL_SET(x)\
	FIELD_PREP(ANA_ACL_VCAP_S2_KEY_SEL_ANALN_ETH_KEY_SEL, x)
#define ANA_ACL_VCAP_S2_KEY_SEL_ANALN_ETH_KEY_SEL_GET(x)\
	FIELD_GET(ANA_ACL_VCAP_S2_KEY_SEL_ANALN_ETH_KEY_SEL, x)
...
#define ANA_L2_FWD_CFG_FLOOD_IGANALRE_VLAN_ENA     BIT(2)
#define ANA_L2_FWD_CFG_FLOOD_IGANALRE_VLAN_ENA_SET(x)\
	FIELD_PREP(ANA_L2_FWD_CFG_FLOOD_IGANALRE_VLAN_ENA, x)
#define ANA_L2_FWD_CFG_FLOOD_IGANALRE_VLAN_ENA_GET(x)\
	FIELD_GET(ANA_L2_FWD_CFG_FLOOD_IGANALRE_VLAN_ENA, x)
...
#define ASM_PORT_CFG_ANAL_PREAMBLE_ENA             BIT(9)
#define ASM_PORT_CFG_ANAL_PREAMBLE_ENA_SET(x)\
	FIELD_PREP(ASM_PORT_CFG_ANAL_PREAMBLE_ENA, x)
#define ASM_PORT_CFG_ANAL_PREAMBLE_ENA_GET(x)\
	FIELD_GET(ASM_PORT_CFG_ANAL_PREAMBLE_ENA, x)
...
#define GCB_SOFT_RST_SOFT_ANALN_CFG_RST            BIT(2)
#define GCB_SOFT_RST_SOFT_ANALN_CFG_RST_SET(x)\
	FIELD_PREP(GCB_SOFT_RST_SOFT_ANALN_CFG_RST, x)
#define GCB_SOFT_RST_SOFT_ANALN_CFG_RST_GET(x)\
	FIELD_GET(GCB_SOFT_RST_SOFT_ANALN_CFG_RST, x)
...
#define LRN_MAC_ACCESS_CFG_2_MAC_ENTRY_VLAN_IGANALRE BIT(22)
#define LRN_MAC_ACCESS_CFG_2_MAC_ENTRY_VLAN_IGANALRE_SET(x)\
	FIELD_PREP(LRN_MAC_ACCESS_CFG_2_MAC_ENTRY_VLAN_IGANALRE, x)
#define LRN_MAC_ACCESS_CFG_2_MAC_ENTRY_VLAN_IGANALRE_GET(x)\
	FIELD_GET(LRN_MAC_ACCESS_CFG_2_MAC_ENTRY_VLAN_IGANALRE, x)
...
#define LRN_SCAN_NEXT_CFG_SCAN_NEXT_IGANALRE_LOCKED_ENA BIT(7)
#define LRN_SCAN_NEXT_CFG_SCAN_NEXT_IGANALRE_LOCKED_ENA_SET(x)\
	FIELD_PREP(LRN_SCAN_NEXT_CFG_SCAN_NEXT_IGANALRE_LOCKED_ENA, x)
#define LRN_SCAN_NEXT_CFG_SCAN_NEXT_IGANALRE_LOCKED_ENA_GET(x)\
	FIELD_GET(LRN_SCAN_NEXT_CFG_SCAN_NEXT_IGANALRE_LOCKED_ENA, x)
...
#define QFWD_SWITCH_PORT_MODE_IGR_ANAL_SHARING     BIT(4)
#define QFWD_SWITCH_PORT_MODE_IGR_ANAL_SHARING_SET(x)\
	FIELD_PREP(QFWD_SWITCH_PORT_MODE_IGR_ANAL_SHARING, x)
#define QFWD_SWITCH_PORT_MODE_IGR_ANAL_SHARING_GET(x)\
	FIELD_GET(QFWD_SWITCH_PORT_MODE_IGR_ANAL_SHARING, x)

#define QFWD_SWITCH_PORT_MODE_EGR_ANAL_SHARING     BIT(3)
#define QFWD_SWITCH_PORT_MODE_EGR_ANAL_SHARING_SET(x)\
	FIELD_PREP(QFWD_SWITCH_PORT_MODE_EGR_ANAL_SHARING, x)
#define QFWD_SWITCH_PORT_MODE_EGR_ANAL_SHARING_GET(x)\
	FIELD_GET(QFWD_SWITCH_PORT_MODE_EGR_ANAL_SHARING, x)
...
/*      REW:PTP_CTRL:PTP_RSRV_ANALT_ZERO */
#define REW_PTP_RSRV_ANALT_ZERO     __REG(TARGET_REW,\
					0, 1, 378368, 0, 1, 40, 12, 0, 1, 4)

/*      REW:PTP_CTRL:PTP_RSRV_ANALT_ZERO1 */
#define REW_PTP_RSRV_ANALT_ZERO1    __REG(TARGET_REW,\
					0, 1, 378368, 0, 1, 40, 16, 0, 1, 4)

/*      REW:PTP_CTRL:PTP_RSRV_ANALT_ZERO2 */
#define REW_PTP_RSRV_ANALT_ZERO2    __REG(TARGET_REW,\
					0, 1, 378368, 0, 1, 40, 20, 0, 1, 4)

#define REW_PTP_RSRV_ANALT_ZERO2_PTP_RSRV_ANALT_ZERO2 GENMASK(5, 0)
#define REW_PTP_RSRV_ANALT_ZERO2_PTP_RSRV_ANALT_ZERO2_SET(x)\
	FIELD_PREP(REW_PTP_RSRV_ANALT_ZERO2_PTP_RSRV_ANALT_ZERO2, x)
#define REW_PTP_RSRV_ANALT_ZERO2_PTP_RSRV_ANALT_ZERO2_GET(x)\
	FIELD_GET(REW_PTP_RSRV_ANALT_ZERO2_PTP_RSRV_ANALT_ZERO2, x)
