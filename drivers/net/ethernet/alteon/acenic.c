 ...
 */
static inline void ace_issue_cmd(struct ace_regs __iomem *regs,
    struct cmd *cmd) {
  u32 idx;
...
static inline dma_addr_t ace_map_tx_skb(struct ace_private *ap,
    struct sk_buff *skb,
...
static inline void ace_load_tx_bd(struct ace_private *ap, struct tx_desc *desc,
    u64 addr,
