...
int be_cmd_if_destroy(struct be_adapter *adapter, int interface_id,
    u32 domain) {
  struct be_mcc_wrb wrb = {
    0
  };
...
static int __be_cmd_rx_filter(struct be_adapter *adapter, u32 flags,
    u32 value) {
  struct be_mcc_wrb *wrb;
...
/* Uses sycn mcc */
int be_cmd_get_flow_control(struct be_adapter *adapter, u32 *tx_fc,
    u32 *rx_fc) {
  struct be_mcc_wrb *wrb;
