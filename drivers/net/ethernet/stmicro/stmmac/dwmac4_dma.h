...
#define DMA_CHAN_TX_BASE_ADDR_HI(addrs, \
      x)  (dma_chanx_base_addr(addrs, x) + 0x10)
#define DMA_CHAN_TX_BASE_ADDR(addrs, x) (dma_chanx_base_addr(addrs, x) + 0x14)
#define DMA_CHAN_RX_BASE_ADDR_HI(addrs, \
      x)  (dma_chanx_base_addr(addrs, x) + 0x18)
...
#define DMA_CHAN_SLOT_CTRL_STATUS(addrs, \
      x) (dma_chanx_base_addr(addrs, x) + 0x3c)
#define DMA_CHAN_CUR_TX_DESC(addrs, x)  (dma_chanx_base_addr(addrs, x) + 0x44)
#define DMA_CHAN_CUR_RX_DESC(addrs, x)  (dma_chanx_base_addr(addrs, x) + 0x4c)
#define DMA_CHAN_CUR_TX_BUF_ADDR(addrs, \
      x)  (dma_chanx_base_addr(addrs, x) + 0x54)
