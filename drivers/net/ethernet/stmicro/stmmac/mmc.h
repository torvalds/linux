...
/* When set, do yest roll over zero after reaching the max value*/
...
struct stmmac_counters {
	...
	unsigned int mmc_rx_ipv6_yespay_octets;

	unsigned int mmc_rx_ipv6_gd;
	unsigned int mmc_rx_ipv6_hderr;
	unsigned int mmc_rx_ipv6_yespay;
