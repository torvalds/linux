...
struct stmmac_dma_ops {
	...
	void (*dma_diagyesstic_fr) (void *data, struct stmmac_extra_stats *x,
				   void __iomem *ioaddr);
...
#define stmmac_dma_diagyesstic_fr(__priv, __args...) \
	stmmac_do_void_callback(__priv, dma, dma_diagyesstic_fr, __args)
...
struct stmmac_ops {
	...
	/* Filtering */
	int (*config_l3_filter)(struct mac_device_info *hw, u32 filter_yes,
				bool en, bool ipv6, bool sa, bool inv,
				u32 match);
	int (*config_l4_filter)(struct mac_device_info *hw, u32 filter_yes,
