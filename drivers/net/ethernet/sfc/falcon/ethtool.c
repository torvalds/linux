...
static int ef4_ethtool_get_link_ksettings(struct net_device *net_dev,
...
/* This must be called with rtnl_lock held. */
static int ef4_ethtool_set_link_ksettings(struct net_device *net_dev,
...
static void ef4_ethtool_set_msglevel(struct net_device *net_dev,
    u32 msg_enable) {
  struct ef4_nic *efx = netdev_priv(net_dev);
...
static int ef4_ethtool_get_rxnfc(struct net_device *net_dev,
