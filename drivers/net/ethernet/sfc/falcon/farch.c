 ...
 */
static void ef4_init_special_buffer(struct ef4_nic *efx,
...
static void ef4_fini_special_buffer(struct ef4_nic *efx,
    struct ef4_special_buffer *buffer) {
...
static void ef4_free_special_buffer(struct ef4_nic *efx,
    struct ef4_special_buffer *buffer) {
  if (!buffer->buf.addr) {
    return;
  }
...
static inline void ef4_farch_build_rx_desc(struct ef4_rx_queue *rx_queue,
    unsigned index) {
 ...
 */
static int ef4_farch_handle_tx_event(struct ef4_channel *channel,
    ef4_qword_t *event) {
 ...
 * serious.
 */
static bool ef4_farch_handle_rx_bad_index(struct ef4_rx_queue *rx_queue,
    unsigned index) {
  struct ef4_channel *channel = ef4_rx_queue_channel(rx_queue);
  struct ef4_nic *efx = rx_queue->efx;
 ...
 */
static void ef4_farch_handle_rx_event(struct ef4_channel *channel,
    const ef4_qword_t *event) {
 ...
 */
static void ef4_farch_handle_tx_flush_done(struct ef4_nic *efx,
    ef4_qword_t *event) {
  struct ef4_tx_queue *tx_queue;
  int qid;
 ...
 */
static void ef4_farch_handle_rx_flush_done(struct ef4_nic *efx,
    ef4_qword_t *event) {
  struct ef4_channel *channel;
  struct ef4_rx_queue *rx_queue;
  int qid;
...
static void ef4_farch_handle_driver_event(struct ef4_channel *channel,
    ef4_qword_t *event) {
  struct ef4_nic *efx = channel->efx;
...
static void ef4_farch_filter_table_clear_entry(struct ef4_nic *efx,
...
static enum ef4_farch_filter_table_id ef4_farch_filter_spec_table_id(
...
static int ef4_farch_filter_from_gen_spec(struct ef4_farch_filter_spec *spec,
...
static void ef4_farch_filter_to_gen_spec(struct ef4_filter_spec *gen_spec,
    const struct ef4_farch_filter_spec *spec) {
  bool is_full = false;
...
static void ef4_farch_filter_init_rx_auto(struct ef4_nic *efx,
    struct ef4_farch_filter_spec *spec) {
...
static inline u32 ef4_farch_filter_make_id(
    const struct ef4_farch_filter_spec *spec,
    unsigned int index) {
  unsigned int range;
...
static inline enum ef4_farch_filter_table_id ef4_farch_filter_id_table_id(
    u32 id) {
...
static void ef4_farch_filter_table_clear(struct ef4_nic *efx,
    enum ef4_farch_filter_table_id table_id,
    enum ef4_filter_priority priority) {
  struct ef4_farch_filter_state *state = efx->filter_state;
