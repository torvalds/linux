 ...
 */
static void ef4_update_irq_mod(struct ef4_nic *efx,
...
static struct ef4_channel *ef4_alloc_channel(struct ef4_nic *efx, int i,
    struct ef4_channel *old_channel) {
  struct ef4_channel *channel;
  struct ef4_rx_queue *rx_queue;
  struct ef4_tx_queue *tx_queue;
  int j;
 ...
 */
static struct ef4_channel *ef4_copy_channel(
    const struct ef4_channel *old_channel) {
  struct ef4_channel *channel;
  struct ef4_rx_queue *rx_queue;
  struct ef4_tx_queue *tx_queue;
  int j;
...
static void ef4_get_channel_name(struct ef4_channel *channel, char *buf,
    size_t len) {
  struct ef4_nic *efx = channel->efx;
  const char *type;
  int number;
...
int ef4_realloc_channels(struct ef4_nic *efx, u32 rxq_entries,
    u32 txq_entries) {
...
static ssize_t phy_type_show(struct device *dev, struct device_attribute *attr,
    char *buf) {
