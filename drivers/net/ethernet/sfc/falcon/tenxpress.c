...
static int sfx7101_run_tests(struct ef4_nic *efx, int *results,
    unsigned flags) {
  int rc;
...
static void tenxpress_get_link_ksettings(struct ef4_nic *efx,
...
static int tenxpress_set_link_ksettings(struct ef4_nic *efx,
