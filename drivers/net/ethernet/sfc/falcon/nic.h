 ...
 * @erase_command:	Erase command (or 0 if sector erase yest needed).
...
enum {
	...
	FALCON_STAT_rx_yesdesc_drop_cnt,
	FALCON_STAT_COUNT
};
...
static inline void ef4_nic_yestify_rx_desc(struct ef4_rx_queue *rx_queue)
{
...
void ef4_nic_fix_yesdesc_drop_stat(struct ef4_nic *efx, u64 *stat);
