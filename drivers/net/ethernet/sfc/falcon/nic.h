 ...
 */
static inline ef4_qword_t *ef4_tx_desc(struct ef4_tx_queue *tx_queue,
    unsigned int index) {
  return ((ef4_qword_t *) (tx_queue->txd.buf.addr)) + index;
}

/* Get partner of a TX queue, seen as part of the same net core queue */
static inline struct ef4_tx_queue *ef4_tx_queue_partner(
...
static inline ef4_qword_t *ef4_rx_desc(struct ef4_rx_queue *rx_queue,
    unsigned int index) {
...
static inline int ef4_nic_process_eventq(struct ef4_channel *channel,
    int quota) {
