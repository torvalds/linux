 ...
 */
static inline int efx_filter_set_ipv4_local(struct efx_filter_spec *spec,
    u8 proto,
 ...
 * @port: Local port (network byte order)
 */
static inline int efx_filter_set_ipv6_local(struct efx_filter_spec *spec,
    u8 proto,
 ...
 */
static inline int efx_filter_set_ipv4_full(struct efx_filter_spec *spec,
    u8 proto,
