 ...
 */
void efx_rx_packet_gro(struct efx_channel *channel,
    struct efx_rx_buffer *rx_buf,
...
struct efx_rss_context *efx_find_rss_context_entry(struct efx_nic *efx,
    u32 id) {
  struct list_head *head = &efx->rss_context.list;
...
static void efx_filter_rfs_work(struct work_struct *data) {
  struct efx_async_filter_insertion *req = container_of(data,
