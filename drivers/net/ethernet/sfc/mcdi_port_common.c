...
void efx_mcdi_phy_get_link_ksettings(struct efx_nic *efx,
...
int efx_mcdi_phy_set_link_ksettings(struct efx_nic *efx,
  ...
  if (cmd->base.autoneg) {
    ...
    switch (cmd->base.speed) {
      ...
      case 40000:
        ...
        break;
      case 100000:
        caps = 1 << MC_CMD_PHY_CAP_100000FDX_LBN;
        break;
      case 25000:
        caps = 1 << MC_CMD_PHY_CAP_25000FDX_LBN;
        break;
      case 50000:
        caps = 1 << MC_CMD_PHY_CAP_50000FDX_LBN;
        break;
      default:
        return -EINVAL;
    }
