...
/* RX_RSS_IPV6_REG3: IPv6 RSS Toeplitz hash key upper bytes and IPv6 RSS
 * settings */
...
/* BUF_HALF_TBL_KER: Buffer table in half buffer table mode direct access by
 * driver */
...
/* BUF_FULL_TBL_KER: Buffer table in full buffer table mode direct access by
 * driver */
