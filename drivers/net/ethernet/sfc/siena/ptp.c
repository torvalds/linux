 ...
 */
static ktime_t efx_ptp_mac_nic_to_ktime_correction(struct efx_nic *efx,
 ...
 */
static void efx_ptp_process_events(struct efx_nic *efx,
...
static inline void efx_ptp_process_rx(struct efx_nic *efx,
    struct sk_buff *skb) {
  local_bh_disable();
  netif_receive_skb(skb);
  local_bh_enable();
