...
#else
void efx_siena_set_interrupt_affinity(struct efx_nic *efx __always_unused) {
}

void efx_siena_clear_interrupt_affinity(struct efx_nic *efx __always_unused) {
}
...
static void efx_update_irq_mod(struct efx_nic *efx,
    struct efx_channel *channel) {
