 ...
 */
static inline efx_qword_t *efx_tx_desc(struct efx_tx_queue *tx_queue,
    unsigned int index) {
...
static inline efx_qword_t *efx_rx_desc(struct efx_rx_queue *rx_queue,
    unsigned int index) {
...
static inline int efx_nic_process_eventq(struct efx_channel *channel,
    int quota) {
