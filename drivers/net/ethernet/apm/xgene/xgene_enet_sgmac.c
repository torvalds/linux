...
static void xgene_sgmac_set_frame_size(struct xgene_enet_pdata *pdata,
    int size) {
...
static void xgene_sgmac_flowctl_rx(struct xgene_enet_pdata *pdata,
    bool enable) {
...
static void xgene_sgmac_enable_tx_pause(struct xgene_enet_pdata *p,
    bool enable) {
