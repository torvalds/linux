...
static int aq_ethtool_set_link_ksettings(struct net_device *ndev,
...
static int aq_ethtool_get_eee(struct net_device *ndev,
...
static int aq_ethtool_set_eee(struct net_device *ndev,
    struct ethtool_keee *eee) {
  struct aq_nic_s *aq_nic = netdev_priv(ndev);
  u32 rate, supported_rates;
  struct aq_nic_cfg_s *cfg;
