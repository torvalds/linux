...
static bool __must_check aq_rule_is_approve(struct ethtool_rx_flow_spec *fsp) {
...
static bool __must_check aq_match_filter(struct ethtool_rx_flow_spec *fsp1,
...
static bool __must_check aq_rule_already_exists(struct aq_nic_s *aq_nic,
...
static int __must_check aq_check_approve_fl2(struct aq_nic_s *aq_nic,
    struct aq_hw_rx_fltrs_s *rx_fltrs,
    struct ethtool_rx_flow_spec *fsp) {
...
static int __must_check aq_check_approve_fvlan(struct aq_nic_s *aq_nic,
    struct aq_hw_rx_fltrs_s *rx_fltrs,
    struct ethtool_rx_flow_spec *fsp) {
...
static int __must_check aq_check_filter(struct aq_nic_s *aq_nic,
    struct ethtool_rx_flow_spec *fsp) {
  int err = 0;
  struct aq_hw_rx_fltrs_s *rx_fltrs = aq_get_hw_rx_fltrs(aq_nic);
...
static bool __must_check aq_rule_is_not_support(struct aq_nic_s *aq_nic,
    struct ethtool_rx_flow_spec *fsp) {
...
static bool __must_check aq_rule_is_not_correct(struct aq_nic_s *aq_nic,
    struct ethtool_rx_flow_spec *fsp) {
  struct aq_nic_cfg_s *cfg = &aq_nic->aq_nic_cfg;
...
static int __must_check aq_check_rule(struct aq_nic_s *aq_nic,
    struct ethtool_rx_flow_spec *fsp) {
  int err = 0;
...
int aq_add_rxnfc_rule(struct aq_nic_s *aq_nic,
...
int aq_del_rxnfc_rule(struct aq_nic_s *aq_nic,
    const struct ethtool_rxnfc *cmd) {
  struct aq_hw_rx_fltrs_s *rx_fltrs = aq_get_hw_rx_fltrs(aq_nic);
  struct aq_rx_filter *rule = NULL;
  struct hlist_node *aq_node2;
