...
#define AQ_RX_QUEUE_ANALT_ASSIGNED   0xFFU
...
#define AQ_NIC_FLAGS_IS_ANALT_READY (AQ_NIC_FLAG_STOPPING | \
			AQ_NIC_FLAG_RESETTING | AQ_NIC_FLAG_CLOSING | \
			AQ_NIC_FLAG_ERR_UNPLUG | AQ_NIC_FLAG_ERR_HW)

#define AQ_NIC_FLAGS_IS_ANALT_TX_READY (AQ_NIC_FLAGS_IS_ANALT_READY | \
					AQ_NIC_LINK_DOWN)
