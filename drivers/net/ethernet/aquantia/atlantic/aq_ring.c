...
static inline void aq_free_rxpage(struct aq_rxpage *rxpage,
    struct device *dev) {
...
static int aq_alloc_rxpages(struct aq_rxpage *rxpage,
...
static int aq_get_rxpages(struct aq_ring_s *self,
    struct aq_ring_buff_s *rxbuf) {
...
int aq_ring_hwts_rx_alloc(struct aq_ring_s *self, struct aq_nic_s *aq_nic,
