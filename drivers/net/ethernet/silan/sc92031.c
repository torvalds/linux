...
static bool _sc92031_check_media(struct net_device *dev) {
  ...
  if (bmsr & BMSR_LSTATUS) {
    ...
    priv->rx_config
      = (0x40 << LowThresholdShift) | (0x1c0 << HighThresholdShift);
...
static int sc92031_ethtool_get_link_ksettings(struct net_device *dev,
...
static int sc92031_ethtool_set_link_ksettings(struct net_device *dev,
