...
static void lance_piocopy_to_skb(struct sk_buff *skb, void __iomem *piobuf,
    int len) {
...
static void lance_piocopy_from_skb(void __iomem *dest, unsigned char *src,
    int len) {
...
/* Ethtool support... */
static void sparc_lance_get_drvinfo(struct net_device *dev,
