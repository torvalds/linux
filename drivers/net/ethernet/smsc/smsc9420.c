...
static inline void smsc9420_reg_write(struct smsc9420_pdata *pd, u32 offset,
    u32 value) {
...
static void smsc9420_ethtool_getregs(struct net_device *dev,
...
static void smsc9420_tx_update_stats(struct net_device *dev, u32 status,
    u32 length) {
...
static int smsc9420_probe(struct pci_dev *pdev,
