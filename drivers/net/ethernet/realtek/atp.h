...
static inline void write_reg(short port, unsigned char reg,
    unsigned char value) {
...
static inline void write_reg_high(short port, unsigned char reg,
    unsigned char value) {
...
static inline void write_reg_byte(short port, unsigned char reg,
    unsigned char value) {
  unsigned char outval;
