...
#define TSNEP_COALESCE_USECS_MAX     ((ECM_INT_DELAY_MASK >> \
  ECM_INT_DELAY_SHIFT)   \
...
#define TSNEP_TX_TYPE_SKB_FRAG_MAP_PAGE (TSNEP_TX_TYPE_SKB_FRAG \
  | TSNEP_TX_TYPE_MAP_PAGE)
#define TSNEP_TX_TYPE_SKB_FRAG_INLINE (TSNEP_TX_TYPE_SKB_FRAG \
  | TSNEP_TX_TYPE_INLINE)
#define TSNEP_TX_TYPE_XDP_TX    BIT(10)
#define TSNEP_TX_TYPE_XDP_NDO   BIT(11)
#define TSNEP_TX_TYPE_XDP_NDO_MAP_PAGE  (TSNEP_TX_TYPE_XDP_NDO \
  | TSNEP_TX_TYPE_MAP_PAGE)
...
static struct tsnep_tx *tsnep_xdp_get_tx(struct tsnep_adapter *adapter,
    u32 cpu) {
