...
#define OCELOT_FDMA_SKBFRAG_OVR   (4 \
  + SKB_DATA_ALIGN(sizeof(struct skb_shared_info)))
#define OCELOT_FDMA_RXB_SIZE    ALIGN_DOWN( \
    OCELOT_FDMA_RX_SIZE - OCELOT_FDMA_SKBFRAG_OVR, 4)
#define OCELOT_FDMA_SKBFRAG_SIZE  (OCELOT_FDMA_RXB_SIZE \
  + OCELOT_FDMA_SKBFRAG_OVR)
