...
#define QS_XTR_GRP_CFG_MODE(x)                            (((x) << \
    2) & GENMASK(3, 2))
#define QS_XTR_GRP_CFG_MODE_M                             GENMASK(3, 2)
#define QS_XTR_GRP_CFG_MODE_X(x)                          (((x) \
  & GENMASK(3, 2)) >> 2)
...
#define QS_XTR_CFG_DP_WM(x)                               (((x) << \
    5) & GENMASK(7, 5))
#define QS_XTR_CFG_DP_WM_M                                GENMASK(7, 5)
#define QS_XTR_CFG_DP_WM_X(x)                             (((x) \
  & GENMASK(7, 5)) >> 5)
#define QS_XTR_CFG_SCH_WM(x)                              (((x) << \
    2) & GENMASK(4, 2))
#define QS_XTR_CFG_SCH_WM_M                               GENMASK(4, 2)
#define QS_XTR_CFG_SCH_WM_X(x)                            (((x) \
  & GENMASK(4, 2)) >> 2)
...
#define QS_INJ_GRP_CFG_MODE(x)                            (((x) << \
    2) & GENMASK(3, 2))
#define QS_INJ_GRP_CFG_MODE_M                             GENMASK(3, 2)
#define QS_INJ_GRP_CFG_MODE_X(x)                          (((x) \
  & GENMASK(3, 2)) >> 2)
...
#define QS_INJ_CTRL_GAP_SIZE(x)                           (((x) << \
    21) & GENMASK(24, 21))
#define QS_INJ_CTRL_GAP_SIZE_M                            GENMASK(24, 21)
#define QS_INJ_CTRL_GAP_SIZE_X(x)                         (((x) \
  & GENMASK(24, 21)) >> 21)
#define QS_INJ_CTRL_ABORT                                 BIT(20)
#define QS_INJ_CTRL_EOF                                   BIT(19)
#define QS_INJ_CTRL_SOF                                   BIT(18)
#define QS_INJ_CTRL_VLD_BYTES(x)                          (((x) << \
    16) & GENMASK(17, 16))
#define QS_INJ_CTRL_VLD_BYTES_M                           GENMASK(17, 16)
#define QS_INJ_CTRL_VLD_BYTES_X(x)                        (((x) \
  & GENMASK(17, 16)) >> 16)

#define QS_INJ_STATUS_WMARK_REACHED(x)                    (((x) << \
    4) & GENMASK(5, 4))
#define QS_INJ_STATUS_WMARK_REACHED_M                     GENMASK(5, 4)
#define QS_INJ_STATUS_WMARK_REACHED_X(x)                  (((x) \
  & GENMASK(5, 4)) >> 4)
#define QS_INJ_STATUS_FIFO_RDY(x)                         (((x) << \
    2) & GENMASK(3, 2))
#define QS_INJ_STATUS_FIFO_RDY_M                          GENMASK(3, 2)
#define QS_INJ_STATUS_FIFO_RDY_X(x)                       (((x) \
  & GENMASK(3, 2)) >> 2)
