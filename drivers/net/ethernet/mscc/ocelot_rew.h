...
#define REW_PORT_VLAN_CFG_PORT_TPID(x)                    (((x) << \
    16) & GENMASK(31, 16))
#define REW_PORT_VLAN_CFG_PORT_TPID_M                     GENMASK(31, 16)
#define REW_PORT_VLAN_CFG_PORT_TPID_X(x)                  (((x) \
  & GENMASK(31, 16)) >> 16)
#define REW_PORT_VLAN_CFG_PORT_DEI                        BIT(15)
#define REW_PORT_VLAN_CFG_PORT_PCP(x)                     (((x) << \
    12) & GENMASK(14, 12))
#define REW_PORT_VLAN_CFG_PORT_PCP_M                      GENMASK(14, 12)
#define REW_PORT_VLAN_CFG_PORT_PCP_X(x)                   (((x) \
  & GENMASK(14, 12)) >> 12)
...
#define REW_TAG_CFG_TAG_CFG(x)                            (((x) << \
    7) & GENMASK(8, 7))
#define REW_TAG_CFG_TAG_CFG_M                             GENMASK(8, 7)
#define REW_TAG_CFG_TAG_CFG_X(x)                          (((x) \
  & GENMASK(8, 7)) >> 7)
#define REW_TAG_CFG_TAG_TPID_CFG(x)                       (((x) << \
    5) & GENMASK(6, 5))
#define REW_TAG_CFG_TAG_TPID_CFG_M                        GENMASK(6, 5)
#define REW_TAG_CFG_TAG_TPID_CFG_X(x)                     (((x) \
  & GENMASK(6, 5)) >> 5)
#define REW_TAG_CFG_TAG_VID_CFG                           BIT(4)
#define REW_TAG_CFG_TAG_PCP_CFG(x)                        (((x) << \
    2) & GENMASK(3, 2))
#define REW_TAG_CFG_TAG_PCP_CFG_M                         GENMASK(3, 2)
#define REW_TAG_CFG_TAG_PCP_CFG_X(x)                      (((x) \
  & GENMASK(3, 2)) >> 2)
...
#define REW_PORT_CFG_FCS_UPDATE_NONCPU_CFG(x)             (((x) << \
    3) & GENMASK(4, 3))
#define REW_PORT_CFG_FCS_UPDATE_NONCPU_CFG_M              GENMASK(4, 3)
#define REW_PORT_CFG_FCS_UPDATE_NONCPU_CFG_X(x)           (((x) \
  & GENMASK(4, 3)) >> 3)
...
#define REW_PTP_CFG_GP_CFG_UNUSED(x)                      (((x) << \
    3) & GENMASK(6, 3))
#define REW_PTP_CFG_GP_CFG_UNUSED_M                       GENMASK(6, 3)
#define REW_PTP_CFG_GP_CFG_UNUSED_X(x)                    (((x) \
  & GENMASK(6, 3)) >> 3)
