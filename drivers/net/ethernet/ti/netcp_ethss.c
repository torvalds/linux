...
struct gbenu_hw_stats {
	...
	u32	__rsvd_0[3];
	u32	ale_unkyeswn_ucast;
	u32	ale_unkyeswn_ucast_bytes;
	u32	ale_unkyeswn_mcast;
	u32	ale_unkyeswn_mcast_bytes;
	u32	ale_unkyeswn_bcast;
	u32	ale_unkyeswn_bcast_bytes;
	u32	ale_pol_match;
...
static const struct netcp_ethtool_stat gbenu_et_stats[] = {
	...
	GBENU_STATS_HOST(ale_unkyeswn_ucast),
	GBENU_STATS_HOST(ale_unkyeswn_ucast_bytes),
	GBENU_STATS_HOST(ale_unkyeswn_mcast),
	GBENU_STATS_HOST(ale_unkyeswn_mcast_bytes),
	GBENU_STATS_HOST(ale_unkyeswn_bcast),
	GBENU_STATS_HOST(ale_unkyeswn_bcast_bytes),
	...
	GBENU_STATS_P1(ale_unkyeswn_ucast),
	GBENU_STATS_P1(ale_unkyeswn_ucast_bytes),
	GBENU_STATS_P1(ale_unkyeswn_mcast),
	GBENU_STATS_P1(ale_unkyeswn_mcast_bytes),
	GBENU_STATS_P1(ale_unkyeswn_bcast),
	GBENU_STATS_P1(ale_unkyeswn_bcast_bytes),
	...
	GBENU_STATS_P2(ale_unkyeswn_ucast),
	GBENU_STATS_P2(ale_unkyeswn_ucast_bytes),
	GBENU_STATS_P2(ale_unkyeswn_mcast),
	GBENU_STATS_P2(ale_unkyeswn_mcast_bytes),
	GBENU_STATS_P2(ale_unkyeswn_bcast),
	GBENU_STATS_P2(ale_unkyeswn_bcast_bytes),
	...
	GBENU_STATS_P3(ale_unkyeswn_ucast),
	GBENU_STATS_P3(ale_unkyeswn_ucast_bytes),
	GBENU_STATS_P3(ale_unkyeswn_mcast),
	GBENU_STATS_P3(ale_unkyeswn_mcast_bytes),
	GBENU_STATS_P3(ale_unkyeswn_bcast),
	GBENU_STATS_P3(ale_unkyeswn_bcast_bytes),
	...
	GBENU_STATS_P4(ale_unkyeswn_ucast),
	GBENU_STATS_P4(ale_unkyeswn_ucast_bytes),
	GBENU_STATS_P4(ale_unkyeswn_mcast),
	GBENU_STATS_P4(ale_unkyeswn_mcast_bytes),
	GBENU_STATS_P4(ale_unkyeswn_bcast),
	GBENU_STATS_P4(ale_unkyeswn_bcast_bytes),
	...
	GBENU_STATS_P5(ale_unkyeswn_ucast),
	GBENU_STATS_P5(ale_unkyeswn_ucast_bytes),
	GBENU_STATS_P5(ale_unkyeswn_mcast),
	GBENU_STATS_P5(ale_unkyeswn_mcast_bytes),
	GBENU_STATS_P5(ale_unkyeswn_bcast),
	GBENU_STATS_P5(ale_unkyeswn_bcast_bytes),
	...
	GBENU_STATS_P6(ale_unkyeswn_ucast),
	GBENU_STATS_P6(ale_unkyeswn_ucast_bytes),
	GBENU_STATS_P6(ale_unkyeswn_mcast),
	GBENU_STATS_P6(ale_unkyeswn_mcast_bytes),
	GBENU_STATS_P6(ale_unkyeswn_bcast),
	GBENU_STATS_P6(ale_unkyeswn_bcast_bytes),
	...
	GBENU_STATS_P7(ale_unkyeswn_ucast),
	GBENU_STATS_P7(ale_unkyeswn_ucast_bytes),
	GBENU_STATS_P7(ale_unkyeswn_mcast),
	GBENU_STATS_P7(ale_unkyeswn_mcast_bytes),
	GBENU_STATS_P7(ale_unkyeswn_bcast),
	GBENU_STATS_P7(ale_unkyeswn_bcast_bytes),
	...
	GBENU_STATS_P8(ale_unkyeswn_ucast),
	GBENU_STATS_P8(ale_unkyeswn_ucast_bytes),
	GBENU_STATS_P8(ale_unkyeswn_mcast),
	GBENU_STATS_P8(ale_unkyeswn_mcast_bytes),
	GBENU_STATS_P8(ale_unkyeswn_bcast),
	GBENU_STATS_P8(ale_unkyeswn_bcast_bytes),
...
static int gbe_slave_open(struct gbe_intf *gbe_intf)
{
	...
	if (slave->link_interface == SGMII_LINK_MAC_PHY) {
		...
		has_phy = true;
		err = of_get_phy_mode(slave->yesde, &phy_mode);
		/* if phy-mode is yest present, default to
	...
	if (has_phy) {
		...
		slave->phy = of_phy_connect(gbe_intf->ndev,
					    ...
					    phy_mode);
		if (!slave->phy) {
			dev_err(priv->dev, "phy yest found on slave %d\n",
				slave->slave_num);
			return -ENODEV;
		}
...
static int gbe_add_addr(void *intf_priv, struct netcp_addr *naddr)
{
	...
	case ADDR_DEV:
		...
		break;
	case ADDR_ANY:
		/* yesthing to do for promiscuous */
	default:
		break;
	}
...
static int gbe_set_rx_mode(void *intf_priv, bool promisc)
{
	...
	/* Make sure it is yest a false timeout */
...
static void netcp_ethss_timer(struct timer_list *t)
{
	...
	/* A timer runs as a BH, yes need to block them */
		      ...
		      struct device_yesde *yesde)
{
	...
	if (of_property_read_u32(yesde, "slave-port", &slave->slave_num)) {
		dev_err(gbe_dev->dev, "missing slave-port parameter\n");
		return -EINVAL;
	}

	if (of_property_read_u32(yesde, "link-interface",
				 &slave->link_interface)) {
	...
	if ((slave->link_interface == SGMII_LINK_MAC_PHY) ||
	    (slave->link_interface == RGMII_LINK_MAC_PHY) ||
	    (slave->link_interface == XGMII_LINK_MAC_PHY))
		slave->phy_yesde = of_parse_phandle(yesde, "phy-handle", 0);
	...
	/* Emac regs memmap are contiguous but port regs are yest */
	...
	if (IS_SS_ID_VER_14(gbe_dev)) {
		...
		dev_err(gbe_dev->dev, "unkyeswn ethss(0x%x)\n",
			gbe_dev->ss_version);
		return -EINVAL;
	}
				 ...
				 struct device_yesde *yesde)
{
	...
	for_each_child_of_yesde(yesde, port) {
	...
	for_each_sec_slave(slave, gbe_dev) {
		...
		slave->phy =
			of_phy_connect(gbe_dev->dummy_ndev,
				       ...
				       0, phy_mode);
		if (!slave->phy) {
			dev_err(dev, "phy yest found for slave %d\n",
				slave->slave_num);
		} else {
				 ...
				 struct device_yesde *yesde)
{
	...
	ret = of_address_to_resource(yesde, XGBE_SS_REG_INDEX, &res);
	if (ret) {
		dev_err(gbe_dev->dev,
			"Can't xlate xgbe of yesde(%pOFn) ss address at %d\n",
			yesde, XGBE_SS_REG_INDEX);
		return ret;
	}
	...
	ret = of_address_to_resource(yesde, XGBE_SM_REG_INDEX, &res);
	if (ret) {
		dev_err(gbe_dev->dev,
			"Can't xlate xgbe of yesde(%pOFn) sm address at %d\n",
			yesde, XGBE_SM_REG_INDEX);
		return ret;
	}
	...
	ret = of_address_to_resource(yesde, XGBE_SERDES_REG_INDEX, &res);
	if (ret) {
		dev_err(gbe_dev->dev,
			"Can't xlate xgbe serdes of yesde(%pOFn) address at %d\n",
			yesde, XGBE_SERDES_REG_INDEX);
		return ret;
	}
				    ...
				    struct device_yesde *yesde)
{
	...
	ret = of_address_to_resource(yesde, GBE_SS_REG_INDEX, &res);
	if (ret) {
		dev_err(gbe_dev->dev,
			"Can't translate of yesde(%pOFn) of gbe ss address at %d\n",
			yesde, GBE_SS_REG_INDEX);
		return ret;
	}
				...
				struct device_yesde *yesde)
{
	...
	ret = of_address_to_resource(yesde, GBE_SGMII34_REG_INDEX, &res);
	if (ret) {
		dev_err(gbe_dev->dev,
			"Can't translate of gbe yesde(%pOFn) address at index %d\n",
			yesde, GBE_SGMII34_REG_INDEX);
		return ret;
	}
	...
	ret = of_address_to_resource(yesde, GBE_SM_REG_INDEX, &res);
	if (ret) {
		dev_err(gbe_dev->dev,
			"Can't translate of gbe yesde(%pOFn) address at index %d\n",
			yesde, GBE_SM_REG_INDEX);
		return ret;
	}
				...
				struct device_yesde *yesde)
{
	...
	ret = of_address_to_resource(yesde, GBENU_SM_REG_INDEX, &res);
	if (ret) {
		dev_err(gbe_dev->dev,
			"Can't translate of gbenu yesde(%pOFn) addr at index %d\n",
			yesde, GBENU_SM_REG_INDEX);
		return ret;
	}
	...
	/* For NU only.  2U does yest need tx_pri_map.
...
static int gbe_probe(struct netcp_device *netcp_device, struct device *dev,
		     struct device_yesde *yesde, void **inst_priv)
{
	struct device_yesde *interfaces, *interface, *cpts_yesde;
	struct device_yesde *secondary_ports;
	...
	if (of_device_is_compatible(yesde, "ti,netcp-gbe-5") ||
	    of_device_is_compatible(yesde, "ti,netcp-gbe")) {
		gbe_dev->max_num_slaves = 4;
	} else if (of_device_is_compatible(yesde, "ti,netcp-gbe-9")) {
		gbe_dev->max_num_slaves = 8;
	} else if (of_device_is_compatible(yesde, "ti,netcp-gbe-2")) {
		gbe_dev->max_num_slaves = 1;
		gbe_module.set_rx_mode = gbe_set_rx_mode;
	} else if (of_device_is_compatible(yesde, "ti,netcp-xgbe")) {
		gbe_dev->max_num_slaves = 2;
	} else {
		dev_err(dev, "device tree yesde for unkyeswn device\n");
		return -EINVAL;
	}
	...
	if (of_find_property(yesde, "enable-ale", NULL)) {
	...
	ret = of_property_read_u32(yesde, "tx-queue",
				   &gbe_dev->tx_queue_id);
	if (ret < 0) {
	...
	ret = of_property_read_string(yesde, "tx-channel",
	...
	if (of_yesde_name_eq(yesde, "gbe")) {
		ret = get_gbe_resource_version(gbe_dev, yesde);
		if (ret)
			return ret;
		...
		if (IS_SS_ID_VER_14(gbe_dev))
			ret = set_gbe_ethss14_priv(gbe_dev, yesde);
		else if (IS_SS_ID_MU(gbe_dev))
			ret = set_gbenu_ethss_priv(gbe_dev, yesde);
		else
			ret = -ENODEV;

	} else if (of_yesde_name_eq(yesde, "xgbe")) {
		ret = set_xgbe_ethss10_priv(gbe_dev, yesde);
		if (ret)
			return ret;
		ret = netcp_xgbe_serdes_init(gbe_dev->xgbe_serdes_regs,
					     gbe_dev->ss_regs);
	} else {
		dev_err(dev, "unkyeswn GBE yesde(%pOFn)\n", yesde);
		ret = -ENODEV;
	}
	...
	interfaces = of_get_child_by_name(yesde, "interfaces");
	if (!interfaces)
		dev_err(dev, "could yest find interfaces\n");
	...
	for_each_child_of_yesde(interfaces, interface) {
	...
	secondary_ports = of_get_child_by_name(yesde, "secondary-slave-ports");
	...
	cpts_yesde = of_get_child_by_name(yesde, "cpts");
	if (!cpts_yesde)
		cpts_yesde = of_yesde_get(yesde);

	gbe_dev->cpts = cpts_create(gbe_dev->dev, gbe_dev->cpts_reg, cpts_yesde);
		      ...
		      struct device_yesde *yesde, void **intf_priv)
{
	...
	if (!yesde) {
		dev_err(gbe_dev->dev, "interface yesde yest available\n");
		return -ENODEV;
	}
	...
	if (init_slave(gbe_dev, gbe_intf->slave, yesde)) {
		ret = -ENODEV;
		goto fail;
	}
