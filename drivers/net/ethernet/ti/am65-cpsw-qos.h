...
int am65_cpsw_qos_ndo_tx_p0_set_maxrate(struct net_device *ndev, int queue,
    u32 rate_mbps);
...
static inline void am65_cpsw_qos_tx_p0_rate_init(
    struct am65_cpsw_common *common) {
}

static inline void am65_cpsw_iet_commit_preemptible_tcs(
...
#define AM65_CPSW_PN_IET_MAC_SET_ADDFRAGSIZE(n) (((n) << \
    AM65_CPSW_PN_IET_MAC_MAC_ADDFRAGSIZE_OFFSET)   \
  & AM65_CPSW_PN_IET_MAC_MAC_ADDFRAGSIZE_MASK)
#define AM65_CPSW_PN_IET_MAC_GET_ADDFRAGSIZE(n) (((n) \
  & AM65_CPSW_PN_IET_MAC_MAC_ADDFRAGSIZE_MASK) >> \
  AM65_CPSW_PN_IET_MAC_MAC_ADDFRAGSIZE_OFFSET)
#define AM65_CPSW_PN_IET_MAC_SET_PREEMPT(n) (((n) << \
    AM65_CPSW_PN_IET_MAC_PREMPT_OFFSET)   \
  & AM65_CPSW_PN_IET_MAC_PREMPT_MASK)
#define AM65_CPSW_PN_IET_MAC_GET_PREEMPT(n) (((n) \
  & AM65_CPSW_PN_IET_MAC_PREMPT_MASK) >> \
  AM65_CPSW_PN_IET_MAC_PREMPT_OFFSET)
...
#define AM65_CPSW_PN_MAC_GET_VERIFY_CNT(n)  ((n) \
