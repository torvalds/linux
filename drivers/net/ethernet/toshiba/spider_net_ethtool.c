...
static int spider_net_ethtool_get_link_ksettings(struct net_device *netdev,
...
static void spider_net_ethtool_get_drvinfo(struct net_device *netdev,
...
static void spider_net_ethtool_get_wol(struct net_device *netdev,
...
static u32 spider_net_ethtool_get_msglevel(struct net_device *netdev) {
  struct spider_net_card *card;
  card = netdev_priv(netdev);
  return card->msg_enable;
}

static void spider_net_ethtool_set_msglevel(struct net_device *netdev,
    u32 level) {
  struct spider_net_card *card;
  card = netdev_priv(netdev);
...
static int spider_net_ethtool_nway_reset(struct net_device *netdev) {
...
static void spider_net_ethtool_get_ringparam(struct net_device *netdev,
