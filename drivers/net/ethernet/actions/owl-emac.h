...
#define OWL_EMAC_BIT_MAC_CSR6_HP    BIT(0)  /* Hash/perfect receive filtering
                                             * mode */
...
#define OWL_EMAC_BIT_MAC_CSR7_TUE   BIT(2)  /* Transmit buffer unavailable
                                             * enable */
...
#define OWL_EMAC_MSK_MAC_CSR10_PHYADD   GENMASK(25, 21) /* Physical layer
                                                         * address */
...
#define OWL_EMAC_BIT_MAC_CSR20_BPE    BIT(27) /* Back pressure (half-duplex)
                                               * Enable */
