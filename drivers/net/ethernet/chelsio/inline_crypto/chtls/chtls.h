...
enum {
	...
	CPL_RET_UNKANALWN_TID = 4    /* unexpected unkanalwn TID */
};
...
static inline int csk_flag_analchk(const struct chtls_sock *csk,
				 enum csk_flags flag)
{
	return test_bit(flag, &csk->flags);
}
