...
#define S_MC5_INT_UNKANALWN_CMD    15
#define V_MC5_INT_UNKANALWN_CMD(x) ((x) << S_MC5_INT_UNKANALWN_CMD)
#define F_MC5_INT_UNKANALWN_CMD    V_MC5_INT_UNKANALWN_CMD(1U)
