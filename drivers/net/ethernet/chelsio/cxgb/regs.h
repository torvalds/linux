...
#define G_INTERRUPT_TIMER_COUNT(x) (((x) >> \
  S_INTERRUPT_TIMER_COUNT) & M_INTERRUPT_TIMER_COUNT)
...
#define G_READ_TO_WRITE_DELAY(x) (((x) >> \
  S_READ_TO_WRITE_DELAY) & M_READ_TO_WRITE_DELAY)

#define S_WRITE_TO_READ_DELAY    5
#define M_WRITE_TO_READ_DELAY    0x7
#define V_WRITE_TO_READ_DELAY(x) ((x) << S_WRITE_TO_READ_DELAY)
#define G_WRITE_TO_READ_DELAY(x) (((x) >> \
  S_WRITE_TO_READ_DELAY) & M_WRITE_TO_READ_DELAY)
...
#define G_ACTIVE_TO_PRECHARGE_DELAY(x) (((x) >> \
  S_ACTIVE_TO_PRECHARGE_DELAY) & M_ACTIVE_TO_PRECHARGE_DELAY)
...
#define G_WRITE_RECOVERY_DELAY(x) (((x) >> \
  S_WRITE_RECOVERY_DELAY) & M_WRITE_RECOVERY_DELAY)
...
#define G_MC3_EXTENDED_MODE(x) (((x) >> \
  S_MC3_EXTENDED_MODE) & M_MC3_EXTENDED_MODE)
...
#define G_MASTER_DLL_TAP_COUNT(x) (((x) >> \
  S_MASTER_DLL_TAP_COUNT) & M_MASTER_DLL_TAP_COUNT)
...
#define G_SLAVE_DELAY_LINE_MANUAL_TAP_COUNT(x) (((x) >> \
  S_SLAVE_DELAY_LINE_MANUAL_TAP_COUNT) \
  & M_SLAVE_DELAY_LINE_MANUAL_TAP_COUNT)
...
#define G_SLAVE_DELAY_LINE_TAP_COUNT(x) (((x) >> \
  S_SLAVE_DELAY_LINE_TAP_COUNT) & M_SLAVE_DELAY_LINE_TAP_COUNT)
...
#define G_CORRECTABLE_ERROR_COUNT(x) (((x) >> \
  S_CORRECTABLE_ERROR_COUNT) & M_CORRECTABLE_ERROR_COUNT)
...
#define G_UNCORRECTABLE_ERROR_COUNT(x) (((x) >> \
  S_UNCORRECTABLE_ERROR_COUNT) & M_UNCORRECTABLE_ERROR_COUNT)
...
#define G_MC4_EXTENDED_MODE(x) (((x) >> \
  S_MC4_EXTENDED_MODE) & M_MC4_EXTENDED_MODE)
...
#define G_MC4_BACK_DOOR_ADDR(x) (((x) >> \
  S_MC4_BACK_DOOR_ADDR) & M_MC4_BACK_DOOR_ADDR)
...
#define V_TP_OUT_ESPI_GENERATE_TCP_CSUM(x) ((x) << \
    S_TP_OUT_ESPI_GENERATE_TCP_CSUM)
...
#define G_TCAM_SERVER_REGION_USAGE(x) (((x) >> \
  S_TCAM_SERVER_REGION_USAGE) & M_TCAM_SERVER_REGION_USAGE)
...
#define G_SYN_COOKIE_PARAMETER(x) (((x) >> \
  S_SYN_COOKIE_PARAMETER) & M_SYN_COOKIE_PARAMETER)
...
#define G_DACK_MSS_SELECTOR(x) (((x) >> \
  S_DACK_MSS_SELECTOR) & M_DACK_MSS_SELECTOR)

#define S_DACK_BYTE_THRESHOLD    5
#define M_DACK_BYTE_THRESHOLD    0xfffff
#define V_DACK_BYTE_THRESHOLD(x) ((x) << S_DACK_BYTE_THRESHOLD)
#define G_DACK_BYTE_THRESHOLD(x) (((x) >> \
  S_DACK_BYTE_THRESHOLD) & M_DACK_BYTE_THRESHOLD)
...
#define G_TP_ACCESS_LATENCY(x) (((x) >> \
  S_TP_ACCESS_LATENCY) & M_TP_ACCESS_LATENCY)
...
#define G_RECEIVE_BUFFER_SIZE(x) (((x) >> \
  S_RECEIVE_BUFFER_SIZE) & M_RECEIVE_BUFFER_SIZE)
...
#define G_MAX_REORDER_FRAGMENTS(x) (((x) >> \
  S_MAX_REORDER_FRAGMENTS) & M_MAX_REORDER_FRAGMENTS)
...
#define G_GENERIC_TIMER_RESOLUTION(x) (((x) >> \
  S_GENERIC_TIMER_RESOLUTION) & M_GENERIC_TIMER_RESOLUTION)
...
#define G_RETRANSMIT_TIMER_MIN(x) (((x) >> \
  S_RETRANSMIT_TIMER_MIN) & M_RETRANSMIT_TIMER_MIN)
...
#define G_RETRANSMIT_TIMER_MAX(x) (((x) >> \
  S_RETRANSMIT_TIMER_MAX) & M_RETRANSMIT_TIMER_MAX)
...
#define G_PERSIST_TIMER_MIN(x) (((x) >> \
  S_PERSIST_TIMER_MIN) & M_PERSIST_TIMER_MIN)
...
#define G_PERSIST_TIMER_MAX(x) (((x) >> \
  S_PERSIST_TIMER_MAX) & M_PERSIST_TIMER_MAX)
...
#define G_KEEP_ALIVE_IDLE_TIME(x) (((x) >> \
  S_KEEP_ALIVE_IDLE_TIME) & M_KEEP_ALIVE_IDLE_TIME)
...
#define G_KEEP_ALIVE_INTERVAL_TIME(x) (((x) >> \
  S_KEEP_ALIVE_INTERVAL_TIME) & M_KEEP_ALIVE_INTERVAL_TIME)
...
#define G_FAST_FINWAIT2_TIME(x) (((x) >> \
  S_FAST_FINWAIT2_TIME) & M_FAST_FINWAIT2_TIME)
...
#define G_RETRANSMISSION_MAX(x) (((x) >> \
  S_RETRANSMISSION_MAX) & M_RETRANSMISSION_MAX)
...
#define G_CM_MEMMGR_MAX_PSTRUCT(x) (((x) >> \
  S_CM_MEMMGR_MAX_PSTRUCT) & M_CM_MEMMGR_MAX_PSTRUCT)
...
#define G_MODULATION_TIMER_SEPARATOR(x) (((x) >> \
  S_MODULATION_TIMER_SEPARATOR) & M_MODULATION_TIMER_SEPARATOR)
...
#define G_GLOBAL_TIMER_SEPARATOR(x) (((x) >> \
  S_GLOBAL_TIMER_SEPARATOR) & M_GLOBAL_TIMER_SEPARATOR)
...
#define G_ROUTE_TABLE_INDEX(x) (((x) >> \
  S_ROUTE_TABLE_INDEX) & M_ROUTE_TABLE_INDEX)
...
#define G_CSPI_TRAIN_DATA_MAXT(x) (((x) >> \
  S_CSPI_TRAIN_DATA_MAXT) & M_CSPI_TRAIN_DATA_MAXT)
...
#define G_RXFIFOPARITYERROR(x) (((x) >> \
  S_RXFIFOPARITYERROR) & M_RXFIFOPARITYERROR)

#define S_TXFIFOPARITYERROR    10
#define M_TXFIFOPARITYERROR    0x3ff
#define V_TXFIFOPARITYERROR(x) ((x) << S_TXFIFOPARITYERROR)
#define G_TXFIFOPARITYERROR(x) (((x) >> \
  S_TXFIFOPARITYERROR) & M_TXFIFOPARITYERROR)
...
#define G_DIP4ERRORCNTSHADOW(x) (((x) >> \
  S_DIP4ERRORCNTSHADOW) & M_DIP4ERRORCNTSHADOW)
...
#define G_OUT_OF_SYNC_COUNT(x) (((x) >> \
  S_OUT_OF_SYNC_COUNT) & M_OUT_OF_SYNC_COUNT)
...
#define G_DIP2_PARITY_ERR_THRES(x) (((x) >> \
  S_DIP2_PARITY_ERR_THRES) & M_DIP2_PARITY_ERR_THRES)
...
#define G_MONITORED_PORT_NUM(x) (((x) >> \
  S_MONITORED_PORT_NUM) & M_MONITORED_PORT_NUM)
...
#define G_TRANSACTION_TIMER(x) (((x) >> \
  S_TRANSACTION_TIMER) & M_TRANSACTION_TIMER)
...
#define G_START_OF_ROUTING_TABLE(x) (((x) >> \
  S_START_OF_ROUTING_TABLE) & M_START_OF_ROUTING_TABLE)
...
#define G_START_OF_SERVER_INDEX(x) (((x) >> \
  S_START_OF_SERVER_INDEX) & M_START_OF_SERVER_INDEX)
...
#define G_LOCAL_IP_RAM_ADDR(x) (((x) >> \
  S_LOCAL_IP_RAM_ADDR) & M_LOCAL_IP_RAM_ADDR)
...
#define G_SEARCH_RESPONSE_LATENCY(x) (((x) >> \
  S_SEARCH_RESPONSE_LATENCY) & M_SEARCH_RESPONSE_LATENCY)
...
#define G_LEARN_RESPONSE_LATENCY(x) (((x) >> \
  S_LEARN_RESPONSE_LATENCY) & M_LEARN_RESPONSE_LATENCY)
...
#define F_MC5_INT_HIT_IN_ACTIVE_REGION_ERR    V_MC5_INT_HIT_IN_ACTIVE_REGION_ERR( \
    1U)
...
#define G_DBGI_RSP_ERR_REASON(x) (((x) >> \
  S_DBGI_RSP_ERR_REASON) & M_DBGI_RSP_ERR_REASON)
...
#define G_PCI_MODE_PCIX_INITPAT(x) (((x) >> \
  S_PCI_MODE_PCIX_INITPAT) & M_PCI_MODE_PCIX_INITPAT)
