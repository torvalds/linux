...
#define V_IESPI0_FIFO2X_RX_FRAMING_ERROR(x) ((x) << \
...
#define V_IESPI1_FIFO2X_RX_FRAMING_ERROR(x) ((x) << \
...
#define V_OCSPI0_OFIFO2X_TX_FRAMING_ERROR(x) ((x) << \
    S_OCSPI0_OFIFO2X_TX_FRAMING_ERROR)
#define F_OCSPI0_OFIFO2X_TX_FRAMING_ERROR    V_OCSPI0_OFIFO2X_TX_FRAMING_ERROR( \
    1U)

#define S_OCSPI1_OFIFO2X_TX_FRAMING_ERROR    6
#define V_OCSPI1_OFIFO2X_TX_FRAMING_ERROR(x) ((x) << \
    S_OCSPI1_OFIFO2X_TX_FRAMING_ERROR)
#define F_OCSPI1_OFIFO2X_TX_FRAMING_ERROR    V_OCSPI1_OFIFO2X_TX_FRAMING_ERROR( \
    1U)
...
#define V_ICSPI0_FIFO2X_RX_FRAMING_ERROR(x) ((x) << \
...
#define V_ICSPI1_FIFO2X_RX_FRAMING_ERROR(x) ((x) << \
...
#define V_OESPI0_OFIFO2X_TX_FRAMING_ERROR(x) ((x) << \
    S_OESPI0_OFIFO2X_TX_FRAMING_ERROR)
#define F_OESPI0_OFIFO2X_TX_FRAMING_ERROR    V_OESPI0_OFIFO2X_TX_FRAMING_ERROR( \
    1U)

#define S_OESPI1_OFIFO2X_TX_FRAMING_ERROR    6
#define V_OESPI1_OFIFO2X_TX_FRAMING_ERROR(x) ((x) << \
    S_OESPI1_OFIFO2X_TX_FRAMING_ERROR)
#define F_OESPI1_OFIFO2X_TX_FRAMING_ERROR    V_OESPI1_OFIFO2X_TX_FRAMING_ERROR( \
    1U)
