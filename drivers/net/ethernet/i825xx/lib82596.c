...
static inline dma_addr_t virt_to_dma(struct i596_private *lp,
    volatile void *v) {
...
static inline int wait_istat(struct net_device *dev, struct i596_dma *dma,
    int delcnt, char *str) {
...
static inline int wait_cmd(struct net_device *dev, struct i596_dma *dma,
    int delcnt, char *str) {
...
static inline void i596_cleanup_cmd(struct net_device *dev,
