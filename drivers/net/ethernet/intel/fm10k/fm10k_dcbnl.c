 ...
 **/
static int fm10k_dcbnl_ieee_getets(struct net_device *dev,
    struct ieee_ets *ets) {
  int i;
 ...
 **/
static int fm10k_dcbnl_ieee_setets(struct net_device *dev,
    struct ieee_ets *ets) {
  u8 num_tc = 0;
  int i;
 ...
 **/
static int fm10k_dcbnl_ieee_getpfc(struct net_device *dev,
    struct ieee_pfc *pfc) {
 ...
 **/
static int fm10k_dcbnl_ieee_setpfc(struct net_device *dev,
    struct ieee_pfc *pfc) {
  struct fm10k_intfc *interface = netdev_priv(dev);
