 ...
 **/
void i40e_notify_client_of_vf_msg(struct i40e_vsi *vsi, u32 vf_id, u8 *msg,
    u16 len) {
...
static int i40e_register_auxiliary_dev(struct i40e_info *ldev,
    const char *name) {
  struct i40e_auxiliary_device *i40e_aux_dev;
...
void i40e_client_device_register(struct i40e_info *ldev,
    struct i40e_client *client) {
  struct i40e_pf *pf = ldev->pf;
