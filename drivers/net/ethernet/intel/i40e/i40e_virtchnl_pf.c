 ...
 **/
static u32 i40e_vc_link_speed2mbps(enum i40e_aq_link_speed link_speed) {
  switch (link_speed) {
 ...
 **/
static inline bool i40e_vc_isvalid_vector_id(struct i40e_vf *vf,
    u32 vector_id) {
  struct i40e_pf *pf = vf->pf;
 ...
 **/
static int i40e_config_rdma_qvlist(struct i40e_vf *vf,
 ...
 **/
static int i40e_set_vsi_promisc(struct i40e_vf *vf, u16 seid, bool multi_enable,
 ...
 **/
static u8 i40e_vc_ether_addr_type(struct virtchnl_ether_addr *vc_ether_addr) {
 ...
 **/
static bool i40e_is_vc_addr_legacy(struct virtchnl_ether_addr *vc_ether_addr) {
 ...
 **/
static bool i40e_is_vc_addr_primary(struct virtchnl_ether_addr *vc_ether_addr) {
  return i40e_vc_ether_addr_type(vc_ether_addr)
 ...
 **/
static void i40e_update_vf_mac_addr(struct i40e_vf *vf,
 ...
 **/
int i40e_ndo_set_vf_spoofchk(struct net_device *netdev, int vf_id,
    bool enable) {
  struct i40e_netdev_priv *np = netdev_priv(netdev);
  struct i40e_vsi *vsi = np->vsi;
  struct i40e_pf *pf = vsi->back;
