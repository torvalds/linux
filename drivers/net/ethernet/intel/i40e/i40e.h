 ...
 **/
static __always_inline struct i40e_vsi *__i40e_pf_next_vsi(struct i40e_pf *pf,
    int *idx) {
 ...
 **/
static __always_inline struct i40e_veb *__i40e_pf_next_veb(struct i40e_pf *pf,
    int *idx) {
 ...
 **/
static inline void i40e_info_nvm_ver(struct i40e_hw *hw, char *buf,
    size_t len) {
 ...
 **/
static inline void i40e_info_eetrack(struct i40e_hw *hw, char *buf,
    size_t len) {
  struct i40e_nvm_info *nvm = &hw->nvm;
  buf[0] = '\0';
  if (nvm->eetrack != I40E_OEM_EETRACK_ID) {
 ...
 * different from I40E_OEM_EETRACK_ID or empty string.
 **/
static inline void i40e_info_civd_ver(struct i40e_hw *hw, char *buf,
    size_t len) {
  struct i40e_nvm_info *nvm = &hw->nvm;
  buf[0] = '\0';
  if (nvm->eetrack != I40E_OEM_EETRACK_ID) {
 ...
 **/
static inline struct i40e_vsi *i40e_find_vsi_by_type(struct i40e_pf *pf,
    u16 type) {
  struct i40e_vsi *vsi;
  int i;
 ...
 **/
static inline struct i40e_vsi *i40e_pf_get_vsi_by_seid(struct i40e_pf *pf,
    u16 seid) {
  struct i40e_vsi *vsi;
  int i;
  i40e_pf_for_each_vsi(pf, i, vsi)
 ...
 * @seid: SEID of the VSI
 **/
static inline struct i40e_veb *i40e_pf_get_veb_by_seid(struct i40e_pf *pf,
    u16 seid) {
  struct i40e_veb *veb;
  int i;
