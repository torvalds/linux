...
static const char i40e_copyright[]
 ...
 * @stat: ptr to the stat
 **/
static void i40e_stat_update_and_clear32(struct i40e_hw *hw, u32 reg,
    u64 *stat) {
 ...
 **/
static int i40e_update_filter_state(int count,
 ...
 **/
static int i40e_aqc_broadcast_filter(struct i40e_vsi *vsi, const char *vsi_name,
    struct i40e_mac_filter *f) {
...
static int i40e_vsi_config_tc(struct i40e_vsi *vsi, u8 enabled_tc) {
  u8 bw_share[I40E_MAX_TRAFFIC_CLASS] = {
    0
  };
  struct i40e_pf *pf = vsi->back;
  struct i40e_hw *hw = &pf->hw;
...
int i40e_hw_dcb_config(struct i40e_pf *pf, struct i40e_dcbx_config *new_cfg) {
  ...
  u8 prio_type[I40E_MAX_TRAFFIC_CLASS] = {
    0
  };
 ...
 **/
static inline void i40e_set_cld_element(struct i40e_cloud_filter *filter,
 ...
 * firmware.
 **/
static void i40e_get_platform_mac_addr(struct pci_dev *pdev,
    struct i40e_pf *pf) {
  ...
  if (!test_bit(I40E_HW_CAP_NO_PCI_LINK_CHECK, pf->hw.caps)) {
    ...
    switch (hw->bus.speed) {
      case i40e_bus_speed_8000:
        strscpy(speed, "8.0", PCI_SPEED_SIZE);
        break;
      case i40e_bus_speed_5000:
        strscpy(speed, "5.0", PCI_SPEED_SIZE);
        break;
      case i40e_bus_speed_2500:
        strscpy(speed, "2.5", PCI_SPEED_SIZE);
        break;
      default:
        break;
    }
    switch (hw->bus.width) {
      case i40e_bus_width_pcie_x8:
        strscpy(width, "8", PCI_WIDTH_SIZE);
        break;
      case i40e_bus_width_pcie_x4:
        strscpy(width, "4", PCI_WIDTH_SIZE);
        break;
      case i40e_bus_width_pcie_x2:
        strscpy(width, "2", PCI_WIDTH_SIZE);
        break;
      case i40e_bus_width_pcie_x1:
        strscpy(width, "1", PCI_WIDTH_SIZE);
        break;
      default:
        break;
    }
