...
static noinline_for_stack int i40e_set_fc_status(struct i40e_hw *hw,
    struct i40e_aq_get_phy_abilities_resp *abilities,
    bool atomic_restart) {
  struct i40e_aq_set_phy_config config;
 ...
 **/
static u16 i40e_prepare_add_macvlan(
 ...
 * return NULL.
 **/
struct i40e_generic_seg_header *i40e_find_segment_in_package(u32 segment_type,
 ...
 * return NULL.
 **/
struct i40e_profile_section_header *i40e_find_section_in_profile(
    u32 section_type,
 ...
 */
static int i40e_validate_profile(struct i40e_hw *hw,
    struct i40e_profile_segment *profile,
 ...
 */
int i40e_write_profile(struct i40e_hw *hw, struct i40e_profile_segment *profile,
    u32 track_id) {
  struct i40e_profile_section_header *sec = NULL;
 ...
 */
int i40e_rollback_profile(struct i40e_hw *hw,
    struct i40e_profile_segment *profile,
    u32 track_id) {
  struct i40e_profile_section_header *sec = NULL;
  struct i40e_section_table *sec_tbl;
 ...
 */
int i40e_add_pinfo_to_list(struct i40e_hw *hw,
    struct i40e_profile_segment *profile,
 ...
 *
 **/
int i40e_aq_add_cloud_filters(struct i40e_hw *hw, u16 seid,
 ...
 *
 **/
int i40e_aq_rem_cloud_filters(struct i40e_hw *hw, u16 seid,
    struct i40e_aqc_cloud_filters_element_data *filters,
    u8 filter_count) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_add_remove_cloud_filters *cmd
