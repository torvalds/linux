 ...
 **/
static void iavf_force_wb(struct iavf_vsi *vsi,
...
static unsigned int iavf_virtchnl_itr_multiplier(
    enum virtchnl_link_speed speed_virtchnl) {
 ...
 **/
static bool iavf_cleanup_headers(struct iavf_ring *rx_ring,
    struct sk_buff *skb) {
