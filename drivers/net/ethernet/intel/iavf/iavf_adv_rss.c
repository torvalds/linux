 ...
 */
static void iavf_fill_adv_rss_ip4_hdr(struct virtchnl_proto_hdr *hdr,
    u64 hash_flds) {
 ...
 * @hash_flds: the RSS configuration protocol hash fields
 */
static void iavf_fill_adv_rss_ip6_hdr(struct virtchnl_proto_hdr *hdr,
    u64 hash_flds) {
 ...
 * @hash_flds: the RSS configuration protocol hash fields
 */
static void iavf_fill_adv_rss_tcp_hdr(struct virtchnl_proto_hdr *hdr,
    u64 hash_flds) {
 ...
 * @hash_flds: the RSS configuration protocol hash fields
 */
static void iavf_fill_adv_rss_udp_hdr(struct virtchnl_proto_hdr *hdr,
    u64 hash_flds) {
 ...
 * @hash_flds: the RSS configuration protocol hash fields
 */
static void iavf_fill_adv_rss_sctp_hdr(struct virtchnl_proto_hdr *hdr,
    u64 hash_flds) {
 ...
 */
int iavf_fill_adv_rss_cfg_msg(struct virtchnl_rss_cfg *rss_cfg,
 ...
 */
struct iavf_adv_rss *iavf_find_adv_rss_cfg_by_hdrs(struct iavf_adapter *adapter,
    u32 packet_hdrs) {
 ...
 **/
void iavf_print_adv_rss_cfg(struct iavf_adapter *adapter,
    struct iavf_adv_rss *rss,
