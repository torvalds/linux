 ...
 */
static int iavf_poll_virtchnl_msg(struct iavf_hw *hw,
 ...
 **/
static void iavf_set_mac_addr_type(
 ...
 */
static int iavf_set_vc_offload_ethertype(struct iavf_adapter *adapter,
 ...
 */
static void iavf_clear_offload_v2_aq_required(struct iavf_adapter *adapter,
    u16 tpid,
    enum virtchnl_ops offload_op) {
  switch (offload_op) {
    case VIRTCHNL_OP_ENABLE_VLAN_STRIPPING_V2:
 ...
 */
static void iavf_send_vlan_offload_v2(struct iavf_adapter *adapter, u16 tpid,
    enum virtchnl_ops offload_op) {
 ...
 **/
static bool iavf_get_vpe_link_status(struct iavf_adapter *adapter,
 ...
 **/
static void iavf_set_adapter_link_speed_from_vpe(struct iavf_adapter *adapter,
    struct virtchnl_pf_event *vpe) {
  if (ADV_LINK_SUPPORT(adapter)) {
