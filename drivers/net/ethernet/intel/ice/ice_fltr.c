 ...
 */
static int ice_fltr_add_entry_to_list(struct device *dev,
 ...
 */
int ice_fltr_set_vlan_vsi_promisc(struct ice_hw *hw, struct ice_vsi *vsi,
    u8 promisc_mask) {
 ...
 */
int ice_fltr_clear_vlan_vsi_promisc(struct ice_hw *hw, struct ice_vsi *vsi,
    u8 promisc_mask) {
  struct ice_pf *pf = hw->back;
  int result;
 ...
 */
int ice_fltr_clear_vsi_promisc(struct ice_hw *hw, u16 vsi_handle,
    u8 promisc_mask,
    u16 vid) {
  struct ice_pf *pf = hw->back;
  int result;
 ...
 */
int ice_fltr_set_vsi_promisc(struct ice_hw *hw, u16 vsi_handle, u8 promisc_mask,
    u16 vid) {
  struct ice_pf *pf = hw->back;
  int result;
 ...
 * @list: list of filters
 */
static int ice_fltr_remove_vlan_list(struct ice_vsi *vsi,
    struct list_head *list) {
 ...
 * @list: list of filters
 */
static int ice_fltr_remove_eth_list(struct ice_vsi *vsi,
    struct list_head *list) {
 ...
 */
int ice_fltr_add_mac_to_list(struct ice_vsi *vsi, struct list_head *list,
 ...
 */
static int ice_fltr_add_vlan_to_list(struct ice_vsi *vsi,
    struct list_head *list,
 ...
 * @action: filter action
 */
static int ice_fltr_add_eth_to_list(struct ice_vsi *vsi, struct list_head *list,
 ...
 */
static int ice_fltr_prepare_mac(struct ice_vsi *vsi, const u8 *mac,
    enum ice_sw_fwd_act_type action,
 ...
 * @mac_action: pointer to add or remove MAC function
 */
static int ice_fltr_prepare_mac_and_broadcast(struct ice_vsi *vsi,
    const u8 *mac,
    enum ice_sw_fwd_act_type action,
    int(*mac_action)
 ...
 */
static int ice_fltr_prepare_vlan(struct ice_vsi *vsi, struct ice_vlan *vlan,
 ...
 */
static int ice_fltr_prepare_eth(struct ice_vsi *vsi, u16 ethertype, u16 flag,
    enum ice_sw_fwd_act_type action,
 ...
 * @action: action to be performed on filter match
 */
int ice_fltr_add_mac_and_broadcast(struct ice_vsi *vsi, const u8 *mac,
    enum ice_sw_fwd_act_type action) {
