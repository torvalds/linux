 ...
 */
static struct ice_generic_seg_hdr *ice_get_pkg_seg_by_idx(
 ...
 */
static bool ice_is_signing_seg_type_at_idx(struct ice_pkg_hdr *pkg_hdr, u32 idx,
 ...
 */
static bool ice_is_last_download_buffer(struct ice_buf_hdr *buf, u32 idx,
    u32 count) {
 ...
 */
static enum ice_ddp_state ice_dwnld_cfg_bufs_no_lock(struct ice_hw *hw,
    struct ice_buf *bufs,
    u32 start,
 ...
 */
static enum ice_ddp_state ice_download_pkg_sig_seg(struct ice_hw *hw,
    struct ice_sign_seg *seg) {
 ...
 */
static enum ice_ddp_state ice_download_pkg_config_seg(struct ice_hw *hw,
 ...
 */
static enum ice_ddp_state ice_dwnld_sign_and_cfg_segs(struct ice_hw *hw,
    struct ice_pkg_hdr *pkg_hdr,
    u32 idx) {
 ...
 * @sign_type: signing type
 */
static bool ice_match_signing_seg(struct ice_pkg_hdr *pkg_hdr, u32 seg_id,
    u32 sign_type) {
  u32 i;
 ...
 * @hw: pointer to the hardware structure
 */
static enum ice_ddp_state ice_post_dwnld_pkg_actions(struct ice_hw *hw) {
  int status;
 ...
 */
static enum ice_ddp_state ice_download_pkg_with_sig_seg(struct ice_hw *hw,
    struct ice_pkg_hdr *pkg_hdr) {
 ...
 */
static enum ice_ddp_state ice_download_pkg_without_sig_seg(struct ice_hw *hw,
    struct ice_seg *ice_seg) {
 ...
 * return NULL.
 */
static struct ice_generic_seg_hdr *ice_find_seg_in_pkg(struct ice_hw *hw,
    u32 seg_type,
    struct ice_pkg_hdr *pkg_hdr) {
  u32 i;
 ...
 */
static bool ice_has_signing_seg(struct ice_hw *hw,
    struct ice_pkg_hdr *pkg_hdr) {
...
#define ICE_PKG_FLAG_COUNT 4
    char flags[ICE_PKG_FLAG_COUNT + 1] = {
      0
    };
    u8 place = 0;
