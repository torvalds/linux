 ...
 */
static void ice_unmap_and_free_tx_buf(struct ice_tx_ring *ring,
 ...
 * underlying arch
 */
static unsigned int ice_rx_frame_truesize(struct ice_rx_ring *rx_ring,
 ...
 */
static void ice_run_xdp(struct ice_rx_ring *rx_ring, struct xdp_buff *xdp,
 ...
 */
bool ice_alloc_rx_bufs(struct ice_rx_ring *rx_ring,
 ...
 */
static int ice_add_xdp_frag(struct ice_rx_ring *rx_ring, struct xdp_buff *xdp,
 ...
 */
static void ice_reuse_rx_page(struct ice_rx_ring *rx_ring,
 ...
 * for use by the CPU.
 */
static struct ice_rx_buf *ice_get_rx_buf(struct ice_rx_ring *rx_ring,
    const unsigned int size,
 ...
 */
static struct sk_buff *ice_build_skb(struct ice_rx_ring *rx_ring,
    struct xdp_buff *xdp) {
 ...
 * skb correctly.
 */
static struct sk_buff *ice_construct_skb(struct ice_rx_ring *rx_ring,
    struct xdp_buff *xdp) {
 ...
 */
static void ice_put_rx_buf(struct ice_rx_ring *rx_ring,
    struct ice_rx_buf *rx_buf) {
  if (!rx_buf) {
    return;
  }
 ...
 */
static void ice_tx_map(struct ice_tx_ring *tx_ring, struct ice_tx_buf *first,
 ...
 */
static void ice_tx_prepare_vlan_flags(struct ice_tx_ring *tx_ring,
 ...
 */
static void ice_tstamp(struct ice_tx_ring *tx_ring, struct sk_buff *skb,
