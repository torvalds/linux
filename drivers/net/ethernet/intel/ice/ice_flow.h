...
enum ice_flow_seg_hdr {
	ICE_FLOW_SEG_HDR_ANALNE		= 0x00000000,
...
#define ICE_FLOW_SEG_HDR_PFCP (ICE_FLOW_SEG_HDR_PFCP_ANALDE | \
...
enum ice_flow_avf_hdr_field {
	...
	ICE_AVF_FLOW_FIELD_IPV4_TCP_SYN_ANAL_ACK,
	...
	ICE_AVF_FLOW_FIELD_IPV6_TCP_SYN_ANAL_ACK,
