 ...
 */
static void ice_dump_phy_type(struct ice_hw *hw, u64 low, u64 high,
    const char *prefix) {
 ...
 * called.
 */
static int ice_aq_manage_mac_read(struct ice_hw *hw, void *buf, u16 buf_size,
    struct ice_sq_cd *cd) {
 ...
 */
static int ice_aq_get_link_topo_handle(struct ice_port_info *pi, u8 node_type,
    struct ice_sq_cd *cd) {
...
int ice_init_hw(struct ice_hw *hw) {
  ...
  if (status) {
    dev_warn(ice_hw_to_dev(
        hw), "Get PHY capabilities failed status = %d, continuing anyway\n",
        status);
  }
 ...
 */
static int ice_copy_rxq_ctx_to_hw(struct ice_hw *hw, u8 *ice_rxq_ctx,
    u32 rxq_index) {
  u8 i;
  if (!ice_rxq_ctx) {
    return -EINVAL;
 ...
 */
static int ice_sbq_send_cmd(struct ice_hw *hw, struct ice_sbq_cmd_desc *desc,
 ...
 */
static int ice_sq_send_cmd_retry(struct ice_hw *hw, struct ice_ctl_q_info *cq,
 ...
 */
int ice_aq_send_cmd(struct ice_hw *hw, struct ice_aq_desc *desc, void *buf,
 ...
 */
static int ice_aq_req_res(struct ice_hw *hw, enum ice_aq_res_ids res,
 ...
 */
static int ice_aq_release_res(struct ice_hw *hw, enum ice_aq_res_ids res,
    u8 sdp_number,
    struct ice_sq_cd *cd) {
 ...
 */
static void ice_parse_vf_func_caps(struct ice_hw *hw,
 ...
 */
static void ice_parse_vf_dev_caps(struct ice_hw *hw,
    struct ice_hw_dev_caps *dev_p,
    struct ice_aqc_list_caps_elem *cap) {
  u32 number = le32_to_cpu(cap->number);
 ...
 * enabled sensors.
 */
static void ice_parse_sensor_reading_cap(struct ice_hw *hw,
    struct ice_hw_dev_caps *dev_p,
    struct ice_aqc_list_caps_elem *cap) {
...
bool ice_is_pf_c827(struct ice_hw *hw) {
  ...
  if (node_handle == E810C_QSFP_C827_0_HANDLE
      || node_handle == E810C_QSFP_C827_1_HANDLE) {
    return true;
  }
  return false;
}
 ...
 * for later use.
 */
static int ice_discover_func_caps(struct ice_hw *hw,
 ...
 */
static int __ice_aq_get_set_rss_lut(struct ice_hw *hw,
 ...
 * flow.
 */
static int ice_aq_add_lan_txq(struct ice_hw *hw, u8 num_qgrps,
 ...
 */
static int ice_aq_dis_lan_txq(struct ice_hw *hw, u8 num_qgrps,
 ...
 */
static int ice_aq_add_rdma_qsets(struct ice_hw *hw, u8 num_qset_grps,
 ...
 */
static int ice_cfg_vsi_qs(struct ice_port_info *pi, u16 vsi_handle,
    u8 tc_bitmap,
    u16 *maxqs, u8 owner) {
  int status = 0;
  u8 i;
