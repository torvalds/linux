 ...
 */
static int ice_tc_count_lkups(u32 flags,
...
static enum ice_protocol_type ice_proto_type_from_tunnel(
...
static enum ice_sw_tunnel_type ice_sw_type_from_tunnel(
    enum ice_tunnel_type type) {
  switch (type) {
    case TNL_VXLAN:
...
static int ice_tc_fill_tunnel_outer(u32 flags, struct ice_tc_flower_fltr *fltr,
 ...
 */
static int ice_tc_fill_rules(struct ice_hw *hw, u32 flags,
...
static int ice_tc_setup_drop_action(struct net_device *filter_dev,
    struct ice_tc_flower_fltr *fltr) {
...
static int ice_eswitch_add_tc_fltr(struct ice_vsi *vsi,
    struct ice_tc_flower_fltr *fltr) {
...
static struct ice_rx_ring *ice_locate_rx_ring_using_queue(struct ice_vsi *vsi,
    struct ice_tc_flower_fltr *tc_fltr) {
 ...
 */
static struct ice_vsi *ice_tc_forward_action(struct ice_vsi *vsi,
    struct ice_tc_flower_fltr *tc_fltr) {
 ...
 * by OS package.
 */
static int ice_add_tc_flower_adv_fltr(struct ice_vsi *vsi,
    struct ice_tc_flower_fltr *tc_fltr) {
  struct ice_tc_flower_lyr_2_4_hdrs *headers = &tc_fltr->outer_headers;
  struct ice_adv_rule_info rule_info = {
    0
  ...
  switch (tc_fltr->action.fltr_act) {
    ...
    case ICE_FWD_TO_Q:
      ...
      rule_info.sw_act.src = hw->pf_id;
      dev_dbg(dev,
          "add switch rule action to forward to queue:%u (HW queue %u), lkups_cnt:%u\n",
          tc_fltr->action.fwd.q.queue,
  ...
  switch (tc_fltr->action.fltr_act) {
    case ICE_FWD_TO_VSI:
      dev_dbg(dev,
          "added switch rule (lkups_cnt %u, flags 0x%x), action is forward to TC %u, rid %u, rule_id %u, vsi_idx %u\n",
          lkups_cnt, flags,
    ...
    case ICE_FWD_TO_Q:
      dev_dbg(dev,
          "added switch rule (lkups_cnt %u, flags 0x%x), action is forward to queue: %u (HW queue %u)     , rid %u, rule_id %u\n",
    ...
    case ICE_DROP_PACKET:
      dev_dbg(dev,
          "added switch rule (lkups_cnt %u, flags 0x%x), action is drop, rid %u, rule_id %u\n",
 ...
 */
static u16 ice_tc_set_pppoe(struct flow_match_pppoe *match,
    struct ice_tc_flower_fltr *fltr,
    struct ice_tc_flower_lyr_2_4_hdrs *headers) {
 ...
 */
static int ice_tc_set_ipv4(struct flow_match_ipv4_addrs *match,
    struct ice_tc_flower_fltr *fltr,
 ...
 */
static int ice_tc_set_ipv6(struct flow_match_ipv6_addrs *match,
    struct ice_tc_flower_fltr *fltr,
    struct ice_tc_flower_lyr_2_4_hdrs *headers, bool is_encap) {
  struct ice_tc_l3_hdr *l3_key, *l3_mask;
 ...
 */
static void ice_tc_set_tos_ttl(struct flow_match_ip *match,
    struct ice_tc_flower_fltr *fltr,
    struct ice_tc_flower_lyr_2_4_hdrs *headers,
    bool is_encap) {
  if (match->mask->tos) {
 ...
 */
static int ice_tc_set_port(struct flow_match_ports match,
    struct ice_tc_flower_fltr *fltr,
    struct ice_tc_flower_lyr_2_4_hdrs *headers, bool is_encap) {
  if (match.key->dst) {
    if (is_encap) {
...
static struct net_device *ice_get_tunnel_device(struct net_device *dev,
 ...
 * not specified).
 */
static int ice_parse_gtp_type(struct flow_match_ports match,
    struct ice_tc_flower_fltr *fltr) {
  u16 dst_port;
  if (match.key->dst) {
...
static int ice_parse_tunnel_attr(struct net_device *dev, struct flow_rule *rule,
    struct ice_tc_flower_fltr *fltr) {
  struct ice_tc_flower_lyr_2_4_hdrs *headers = &fltr->outer_headers;
 ...
 * @fltr: Pointer to filter structure
 */
static int ice_parse_cls_flower(struct net_device *filter_dev,
    struct ice_vsi *vsi,
 ...
 */
static int ice_add_switch_fltr(struct ice_vsi *vsi,
    struct ice_tc_flower_fltr *fltr) {
 ...
 */
static int ice_prep_adq_filter(struct ice_vsi *vsi,
    struct ice_tc_flower_fltr *fltr) {
 ...
 */
static int ice_handle_tclass_action(struct ice_vsi *vsi,
...
static int ice_tc_forward_to_queue(struct ice_vsi *vsi,
    struct ice_tc_flower_fltr *fltr,
    struct flow_action_entry *act) {
...
static int ice_tc_parse_action(struct ice_vsi *vsi,
    struct ice_tc_flower_fltr *fltr,
    struct flow_action_entry *act) {
  switch (act->id) {
 ...
 */
static int ice_del_tc_fltr(struct ice_vsi *vsi,
    struct ice_tc_flower_fltr *fltr) {
 ...
 * and adds a filter.
 */
static int ice_add_tc_fltr(struct net_device *netdev, struct ice_vsi *vsi,
    struct flow_cls_offload *f,
 ...
 */
static struct ice_tc_flower_fltr *ice_find_tc_flower_fltr(struct ice_pf *pf,
