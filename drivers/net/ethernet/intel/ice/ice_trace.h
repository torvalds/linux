...
DECLARE_EVENT_CLASS(ice_rx_dim_template,
    ...
    TP_printk(
    "netdev: %s Rx-Q: %d dim-state: %d dim-profile: %d dim-tune: %d dim-st-right: %d dim-st-left: %d dim-tired: %d",
    __get_str(devname),
...
DECLARE_EVENT_CLASS(ice_tx_dim_template,
    ...
    TP_printk(
    "netdev: %s Tx-Q: %d dim-state: %d dim-profile: %d dim-tune: %d dim-st-right: %d dim-st-left: %d dim-tired: %d",
    __get_str(devname),
...
#define TRACE_INCLUDE_FILE ../../ drivers / net / ethernet / intel / ice \
  / ice_trace
