 ...
 */
static void ice_arfs_update_active_fltr_cntrs(struct ice_vsi *vsi,
  ...
  switch (entry->fltr_info.flow_type) {
    ...
    default:
      dev_err(ice_pf_to_dev(
          vsi->back), "aRFS: Failed to update filter counters, invalid filter type %d\n",
 ...
 */
static void ice_arfs_del_flow_rules(struct ice_vsi *vsi,
 ...
 * hash table.
 */
static void ice_arfs_add_flow_rules(struct ice_vsi *vsi,
 ...
 */
static bool ice_arfs_is_flow_expired(struct ice_vsi *vsi,
 ...
 */
static void ice_arfs_update_flow_rules(struct ice_vsi *vsi, u16 idx,
 ...
 */
static struct ice_arfs_entry *ice_arfs_build_entry(struct ice_vsi *vsi,
 ...
 * Director.
 */
static bool ice_arfs_is_perfect_flow_set(struct ice_hw *hw, __be16 l3_proto,
    u8 l4_proto) {
