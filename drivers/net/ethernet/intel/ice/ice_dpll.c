 ...
 */
static bool ice_dpll_is_reset(struct ice_pf *pf,
 ...
 */
static int ice_dpll_pin_freq_set(struct ice_pf *pf, struct ice_dpll_pin *pin,
 ...
 */
static int ice_dpll_frequency_set(const struct dpll_pin *pin, void *pin_priv,
 ...
 * * negative - error pin not found or couldn't set in hw
 */
static int ice_dpll_input_frequency_set(const struct dpll_pin *pin,
    void *pin_priv,
    const struct dpll_device *dpll, void *dpll_priv,
 ...
 * * negative - error pin not found or couldn't set in hw
 */
static int ice_dpll_output_frequency_set(const struct dpll_pin *pin,
    void *pin_priv,
    const struct dpll_device *dpll, void *dpll_priv,
    u64 frequency, struct netlink_ext_ack *extack) {
  return ice_dpll_frequency_set(pin, pin_priv, dpll, dpll_priv, frequency,
 ...
 */
static int ice_dpll_frequency_get(const struct dpll_pin *pin, void *pin_priv,
    const struct dpll_device *dpll, void *dpll_priv,
    u64 *frequency, struct netlink_ext_ack *extack,
    enum ice_dpll_pin_type pin_type) {
  struct ice_dpll_pin *p = pin_priv;
 ...
 * * negative - error pin not found or couldn't get from hw
 */
static int ice_dpll_input_frequency_get(const struct dpll_pin *pin,
    void *pin_priv,
    const struct dpll_device *dpll, void *dpll_priv,
    u64 *frequency, struct netlink_ext_ack *extack) {
 ...
 * * negative - error pin not found or couldn't get from hw
 */
static int ice_dpll_output_frequency_get(const struct dpll_pin *pin,
    void *pin_priv,
    const struct dpll_device *dpll, void *dpll_priv,
    u64 *frequency, struct netlink_ext_ack *extack) {
  return ice_dpll_frequency_get(pin, pin_priv, dpll, dpll_priv, frequency,
 ...
 * * negative - error
 */
static int ice_dpll_pin_enable(struct ice_hw *hw, struct ice_dpll_pin *pin,
 ...
 * * negative - error
 */
static int ice_dpll_pin_disable(struct ice_hw *hw, struct ice_dpll_pin *pin,
    enum ice_dpll_pin_type pin_type,
    struct netlink_ext_ack *extack) {
  u8 flags = 0;
  int ret;
 ...
 * * negative - error
 */
static int ice_dpll_pin_state_update(struct ice_pf *pf,
 ...
 * * negative - failure
 */
static int ice_dpll_hw_input_prio_set(struct ice_pf *pf, struct ice_dpll *dpll,
 ...
 * * negative - error
 */
static int ice_dpll_pin_state_set(const struct dpll_pin *pin, void *pin_priv,
    const struct dpll_device *dpll, void *dpll_priv,
 ...
 */
static int ice_dpll_output_state_set(const struct dpll_pin *pin, void *pin_priv,
    const struct dpll_device *dpll, void *dpll_priv,
 ...
 * * negative - failed to enable mode
 */
static int ice_dpll_input_state_set(const struct dpll_pin *pin, void *pin_priv,
    const struct dpll_device *dpll, void *dpll_priv,
    enum dpll_pin_state state,
    struct netlink_ext_ack *extack) {
 ...
 */
static int ice_dpll_pin_state_get(const struct dpll_pin *pin, void *pin_priv,
    const struct dpll_device *dpll, void *dpll_priv,
    enum dpll_pin_state *state,
    struct netlink_ext_ack *extack,
    enum ice_dpll_pin_type pin_type) {
 ...
 * * negative - failed to get state
 */
static int ice_dpll_output_state_get(const struct dpll_pin *pin, void *pin_priv,
    const struct dpll_device *dpll, void *dpll_priv,
    enum dpll_pin_state *state,
    struct netlink_ext_ack *extack) {
 ...
 * * negative - failed to get state
 */
static int ice_dpll_input_state_get(const struct dpll_pin *pin, void *pin_priv,
    const struct dpll_device *dpll, void *dpll_priv,
    enum dpll_pin_state *state,
    struct netlink_ext_ack *extack) {
  return ice_dpll_pin_state_get(pin, pin_priv, dpll, dpll_priv, state,
 ...
 * * negative - failure
 */
static int ice_dpll_input_prio_get(const struct dpll_pin *pin, void *pin_priv,
    const struct dpll_device *dpll, void *dpll_priv,
 ...
 * * negative - failure
 */
static int ice_dpll_input_prio_set(const struct dpll_pin *pin, void *pin_priv,
    const struct dpll_device *dpll, void *dpll_priv,
    u32 prio, struct netlink_ext_ack *extack) {
  struct ice_dpll_pin *p = pin_priv;
  struct ice_dpll *d = dpll_priv;
 ...
 * * 0 - success
 */
static int ice_dpll_input_direction(const struct dpll_pin *pin, void *pin_priv,
    const struct dpll_device *dpll, void *dpll_priv,
 ...
 * * 0 - success
 */
static int ice_dpll_output_direction(const struct dpll_pin *pin, void *pin_priv,
    const struct dpll_device *dpll, void *dpll_priv,
    enum dpll_pin_direction *direction,
    struct netlink_ext_ack *extack) {
 ...
 * * negative - error
 */
static int ice_dpll_pin_phase_adjust_get(const struct dpll_pin *pin,
    void *pin_priv,
    const struct dpll_device *dpll, void *dpll_priv,
    s32 *phase_adjust,
    struct netlink_ext_ack *extack) {
 ...
 * * negative - error
 */
static int ice_dpll_pin_phase_adjust_set(const struct dpll_pin *pin,
    void *pin_priv,
    const struct dpll_device *dpll, void *dpll_priv,
    s32 phase_adjust,
    struct netlink_ext_ack *extack,
 ...
 * * negative - error
 */
static int ice_dpll_input_phase_adjust_set(const struct dpll_pin *pin,
    void *pin_priv,
    const struct dpll_device *dpll, void *dpll_priv,
    s32 phase_adjust,
    struct netlink_ext_ack *extack) {
 ...
 * * negative - error
 */
static int ice_dpll_output_phase_adjust_set(const struct dpll_pin *pin,
    void *pin_priv,
    const struct dpll_device *dpll, void *dpll_priv,
    s32 phase_adjust,
    struct netlink_ext_ack *extack) {
 ...
 * * negative - error
 */
static int ice_dpll_phase_offset_get(const struct dpll_pin *pin, void *pin_priv,
    const struct dpll_device *dpll, void *dpll_priv,
 ...
 * * negative - AQ failure
 */
static int ice_dpll_update_state(struct ice_pf *pf, struct ice_dpll *d,
    bool init) {
 ...
 */
static int ice_dpll_get_pins(struct ice_pf *pf, struct ice_dpll_pin *pins,
 ...
 * dpll subsystem.
 */
static void ice_dpll_unregister_pins(struct dpll_device *dpll,
 ...
 */
static int ice_dpll_register_pins(struct dpll_device *dpll,
    struct ice_dpll_pin *pins,
    const struct dpll_pin_ops *ops, int count) {
  int ret, i;
  for (i = 0; i < count; i++) {
 ...
 */
static void ice_dpll_deinit_direct_pins(bool cgu, struct ice_dpll_pin *pins,
    int count,
 ...
 * * negative - registration failure reason
 */
static int ice_dpll_init_direct_pins(struct ice_pf *pf, bool cgu,
 ...
 * * negative - registration failure reason
 */
static int ice_dpll_init_rclk_pins(struct ice_pf *pf, struct ice_dpll_pin *pin,
 ...
 */
static void ice_dpll_deinit_dpll(struct ice_pf *pf, struct ice_dpll *d,
    bool cgu) {
  if (cgu) {
 ...
 * * negative - initialization failure reason
 */
static int ice_dpll_init_dpll(struct ice_pf *pf, struct ice_dpll *d, bool cgu,
    enum dpll_type type) {
 ...
 */
static int ice_dpll_init_info_direct_pins(struct ice_pf *pf,
    enum ice_dpll_pin_type pin_type) {
 ...
 * * negative - init failure reason
 */
static int ice_dpll_init_pins_info(struct ice_pf *pf,
    enum ice_dpll_pin_type pin_type) {
  switch (pin_type) {
    case ICE_DPLL_PIN_TYPE_INPUT:
    case ICE_DPLL_PIN_TYPE_OUTPUT:
