 ...
 */
static int ice_aq_get_lldp_mib(struct ice_hw *hw, u8 bridge_type, u8 mib_type,
    void *buf,
 ...
 */
static int ice_aq_cfg_lldp_mib_change(struct ice_hw *hw, bool ena_update,
    struct ice_sq_cd *cd) {
 ...
 */
int ice_aq_stop_lldp(struct ice_hw *hw, bool shutdown_lldp_agent, bool persist,
    struct ice_sq_cd *cd) {
 ...
 */
int ice_aq_get_dcb_cfg(struct ice_hw *hw, u8 mib_type, u8 bridgetype,
    struct ice_dcbx_cfg *dcbcfg) {
  u8 *lldpmib;
  int ret;
  /* Allocate the LLDPDU */
 ...
 */
int ice_aq_start_stop_dcbx(struct ice_hw *hw, bool start_dcbx_agent,
 ...
 */
static int ice_aq_get_cee_dcb_cfg(struct ice_hw *hw,
 ...
 */
static void ice_dcb_cfg_to_lldp(u8 *lldpmib, u16 *miblen,
    struct ice_dcbx_cfg *dcbcfg) {
 ...
 */
static int ice_aq_query_port_ets(struct ice_port_info *pi,
 ...
 */
static int ice_update_port_tc_tree_cfg(struct ice_port_info *pi,
 ...
 */
int ice_query_port_ets(struct ice_port_info *pi,
    struct ice_aqc_port_ets_elem *buf, u16 buf_size,
    struct ice_sq_cd *cd) {
  int status;
