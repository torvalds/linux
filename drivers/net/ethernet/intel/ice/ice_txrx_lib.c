 ...
 */
static void ice_rx_hash_to_skb(const struct ice_rx_ring *rx_ring,
 ...
 */
static void ice_rx_csum(struct ice_rx_ring *ring, struct sk_buff *skb,
 ...
 */
static void ice_ptp_rx_hwts_to_skb(struct ice_rx_ring *rx_ring,
    const union ice_32b_rx_flex_desc *rx_desc,
    struct sk_buff *skb) {
 ...
 */
static void ice_clean_xdp_tx_buf(struct device *dev, struct ice_tx_buf *tx_buf,
 ...
 */
static enum xdp_rss_hash_type ice_xdp_rx_hash_type(
