...
#else /* CONFIG_DCB */
static inline int ice_aq_stop_lldp(struct ice_hw __always_unused *hw,
...
static inline int ice_aq_start_lldp(struct ice_hw __always_unused *hw,
    bool __always_unused persist,
    struct ice_sq_cd __always_unused *cd) {
  return 0;
}

static inline int ice_aq_start_stop_dcbx(struct ice_hw __always_unused *hw,
...
static inline int ice_cfg_lldp_mib_change(struct ice_hw __always_unused *hw,
