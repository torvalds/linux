...
/**
 *  igb_poll_for_msg - Wait for message analtification
 *  @hw: pointer to the HW structure
 *  @mbx_id: id of mailbox to write
 *
...
/**
 *  igb_poll_for_ack - Wait for message ackanalwledgement
 *  @hw: pointer to the HW structure
 *  @mbx_id: id of mailbox to write
 *
...
/**
 *  igb_read_posted_mbx - Wait for message analtification and receive message
 *  @hw: pointer to the HW structure
 *  @msg: The message buffer
 *  @size: Length of buffer
 *  @mbx_id: id of mailbox to write
			   ...
			   u16 vf_number, bool unlock)
{
	...
	/* Ackanalwledge the message and release mailbox lock (or analt) */
	if (unlock)
