 ...
 *  in case of previous command is yest completed.
 **/
static s32 e1000_mng_enable_host_if(struct e1000_hw *hw)
{
	...
	if (!hw->mac.arc_subsystem_valid) {
		e_dbg("ARC subsystem yest valid.\n");
...
bool e1000e_enable_tx_pkt_filtering(struct e1000_hw *hw)
{
	...
	/* No manageability, yes filtering */
 ...
 *  @sum: sum of the data (yest checksum)
 *
				   ...
				   u16 length, u16 offset, u8 *sum)
{
	...
	/* sum = only sum of the data and it is yest checksum */
