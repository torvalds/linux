...
/**
 *  ixgbe_poll_for_msg - Wait for message yestification
 *  @hw: pointer to the HW structure
 *  @mbx_id: id of mailbox to write
 *
...
/**
 *  ixgbe_poll_for_ack - Wait for message ackyeswledgement
 *  @hw: pointer to the HW structure
 *  @mbx_id: id of mailbox to write
 *
...
/**
 *  ixgbe_read_posted_mbx - Wait for message yestification and receive message
 *  @hw: pointer to the HW structure
 *  @msg: The message buffer
 *  @size: Length of buffer
 *  @mbx_id: id of mailbox to write
			     ...
			     u16 vf_number)
{
	...
	/* Ackyeswledge the message and release buffer */
