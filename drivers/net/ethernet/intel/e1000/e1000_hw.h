...
struct e1000_host_mng_command_info {
  struct e1000_host_mng_command_header command_header;  /* Command Head/Command
                                                         * Result Head has 4
                                                         * bytes */
...
#define E1000_ICR_RXD_FIFO_PAR0 0x00100000  /* queue 0 Rx descriptor FIFO parity
                                             * error */
#define E1000_ICR_TXD_FIFO_PAR0 0x00200000  /* queue 0 Tx descriptor FIFO parity
                                             * error */
#define E1000_ICR_HOST_ARB_PAR  0x00400000  /* host arb read buffer parity error
                                             * */
#define E1000_ICR_PB_PAR        0x00800000  /* packet buffer parity error */
#define E1000_ICR_RXD_FIFO_PAR1 0x01000000  /* queue 1 Rx descriptor FIFO parity
                                             * error */
#define E1000_ICR_TXD_FIFO_PAR1 0x02000000  /* queue 1 Tx descriptor FIFO parity
                                             * error */
#define E1000_ICR_ALL_PARITY    0x03F00000  /* all parity error bits */
#define E1000_ICR_DSW           0x00000020  /* FW changed the status of DISSW
                                             * bit in the FWSM */
#define E1000_ICR_PHYINT        0x00001000  /* LAN connected device generates an
                                             * interrupt */
...
#define E1000_ICS_RXD_FIFO_PAR0 E1000_ICR_RXD_FIFO_PAR0 /* queue 0 Rx descriptor
                                                         * FIFO parity error */
#define E1000_ICS_TXD_FIFO_PAR0 E1000_ICR_TXD_FIFO_PAR0 /* queue 0 Tx descriptor
                                                         * FIFO parity error */
#define E1000_ICS_HOST_ARB_PAR  E1000_ICR_HOST_ARB_PAR  /* host arb read buffer
                                                         * parity error */
#define E1000_ICS_PB_PAR        E1000_ICR_PB_PAR  /* packet buffer parity error
                                                   * */
#define E1000_ICS_RXD_FIFO_PAR1 E1000_ICR_RXD_FIFO_PAR1 /* queue 1 Rx descriptor
                                                         * FIFO parity error */
#define E1000_ICS_TXD_FIFO_PAR1 E1000_ICR_TXD_FIFO_PAR1 /* queue 1 Tx descriptor
                                                         * FIFO parity error */
...
#define E1000_IMS_RXD_FIFO_PAR0 E1000_ICR_RXD_FIFO_PAR0 /* queue 0 Rx descriptor
                                                         * FIFO parity error */
#define E1000_IMS_TXD_FIFO_PAR0 E1000_ICR_TXD_FIFO_PAR0 /* queue 0 Tx descriptor
                                                         * FIFO parity error */
#define E1000_IMS_HOST_ARB_PAR  E1000_ICR_HOST_ARB_PAR  /* host arb read buffer
                                                         * parity error */
#define E1000_IMS_PB_PAR        E1000_ICR_PB_PAR  /* packet buffer parity error
                                                   * */
#define E1000_IMS_RXD_FIFO_PAR1 E1000_ICR_RXD_FIFO_PAR1 /* queue 1 Rx descriptor
                                                         * FIFO parity error */
#define E1000_IMS_TXD_FIFO_PAR1 E1000_ICR_TXD_FIFO_PAR1 /* queue 1 Tx descriptor
                                                         * FIFO parity error */
...
#define E1000_IMC_RXD_FIFO_PAR0 E1000_ICR_RXD_FIFO_PAR0 /* queue 0 Rx descriptor
                                                         * FIFO parity error */
#define E1000_IMC_TXD_FIFO_PAR0 E1000_ICR_TXD_FIFO_PAR0 /* queue 0 Tx descriptor
                                                         * FIFO parity error */
#define E1000_IMC_HOST_ARB_PAR  E1000_ICR_HOST_ARB_PAR  /* host arb read buffer
                                                         * parity error */
#define E1000_IMC_PB_PAR        E1000_ICR_PB_PAR  /* packet buffer parity error
                                                   * */
#define E1000_IMC_RXD_FIFO_PAR1 E1000_ICR_RXD_FIFO_PAR1 /* queue 1 Rx descriptor
                                                         * FIFO parity error */
#define E1000_IMC_TXD_FIFO_PAR1 E1000_ICR_TXD_FIFO_PAR1 /* queue 1 Tx descriptor
                                                         * FIFO parity error */
...
#define IGP02E1000_PM_D3_LPLU                     0x0004  /* Enable LPLU in
                                                           * non-D0a modes */
#define IGP02E1000_PM_D0_LPLU                     0x0002  /* Enable LPLU in D0a
                                                           * mode */
...
#define IGP3_CAP_AMT_CB              0x0200 /* Support active manageability and
                                             * circuit breaker */
...
#define IFE_PHY_RCV_FALSE_CARRIER         0x13  /* 100BaseTx Receive False
                                                 * Carrier Counter */
#define IFE_PHY_RCV_DISCONNECT            0x14  /* 100BaseTx Receive Disconnect
                                                 * Counter */
#define IFE_PHY_RCV_ERROT_FRAME           0x15  /* 100BaseTx Receive Error Frame
                                                 * Counter */
#define IFE_PHY_RCV_SYMBOL_ERR            0x16  /* Receive Symbol Error Counter
                                                 * */
#define IFE_PHY_PREM_EOF_ERR              0x17  /* 100BaseTx Receive Premature
                                                 * End Of Frame Error Counter */
#define IFE_PHY_RCV_EOF_ERR               0x18  /* 10BaseT Receive End Of Frame
                                                 * Error Counter */
...
#define IFE_PESC_REDUCED_POWER_DOWN_DISABLE  0x2000 /* Default 1 = Disable auto
                                                     * reduced power down */
#define IFE_PESC_100BTX_POWER_DOWN           0x0400 /* Indicates the power state
                                                     * of 100BASE-TX */
#define IFE_PESC_10BTX_POWER_DOWN            0x0200 /* Indicates the power state
                                                     * of 10BASE-T */
...
#define IFE_PESC_SPEED                       0x0002 /* Auto-negotiation speed
                                                     ...
                                                     * */
#define IFE_PESC_DUPLEX                      0x0001 /* Auto-negotiation duplex
                                                    * result 1=Full, 0=Half */
#define IFE_PESC_POLARITY_REVERSED_SHIFT     8

#define IFE_PSC_DISABLE_DYNAMIC_POWER_DOWN   0x0100 /* 1 = Dynamic Power Down
                                                     * disabled */
#define IFE_PSC_FORCE_POLARITY               0x0020 /* 1=Reversed Polarity,
                                                     * 0=Normal */
#define IFE_PSC_AUTO_POLARITY_DISABLE        0x0010 /* 1=Auto Polarity Disabled,
                                                     * 0=Enabled */
...
#define IFE_PMC_AUTO_MDIX                    0x0080 /* 1=enable MDI/MDI-X
                                                     * feature, default
                                                     * 0=disabled */
#define IFE_PMC_FORCE_MDIX                   0x0040 /* 1=force MDIX-X, 0=force
                                                     * MDI */
#define IFE_PMC_MDIX_STATUS                  0x0020 /* 1=MDI-X, 0=MDI */
#define IFE_PMC_AUTO_MDIX_COMPLETE           0x0010 /* Resolution algorithm is
                                                     * completed */
...
#define IFE_PHC_ABILITY_CHECK                0x4000 /* 1= Test Passed, 0=failed
                                                     * */
#define IFE_PHC_TEST_EXEC                    0x2000 /* PHY launch test pulses on
                                                     * the wire */
#define IFE_PHC_HIGHZ                        0x0200 /* 1 = Open Circuit */
#define IFE_PHC_LOWZ                         0x0400 /* 1 = Short Circuit */
#define IFE_PHC_LOW_HIGH_Z_MASK              0x0600 /* Mask for indication type
                                                    * of problem on the line */
#define IFE_PHC_DISTANCE_MASK                0x01FF /* Mask for distance to the
                                                     * cable problem, in 80cm
                                                     * granularity */
...
#define ICH_FLASH_ERASE_TIMEOUT              3000000  /* Up to 3 seconds - worst
                                                       * case */
