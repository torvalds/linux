...
/**
 * e1000_adjust_serdes_amplitude - Adjust SERDES output amplitude based on
 * EEPROM setting.
 * @hw: Struct containing variables accessed by shared code.
 */
static s32 e1000_adjust_serdes_amplitude(struct e1000_hw *hw) {
...
/**
 * e1000_write_eeprom_spi - Writes a 16 bit word to a given offset in an SPI
 * EEPROM.
 * @hw: Struct containing variables accessed by shared code
 * @offset: offset within the EEPROM to be written to
 * @words: number of words to write
...
/**
 * e1000_write_eeprom_microwire - Writes a 16 bit word to a given offset in a
 * Microwire EEPROM.
 * @hw: Struct containing variables accessed by shared code
 * @offset: offset within the EEPROM to be written to
 * @words: number of words to write
...
/**
 * e1000_hash_mc_addr - Hashes an address to determine its location in the
 * multicast table
 * @hw: Struct containing variables accessed by shared code
...
/**
 * e1000_write_vfta - Writes a value to the specified offset in the VLAN filter
 * table.
 * @hw: Struct containing variables accessed by shared code
