...
enum idpf_rss_hash {
	...
	IDPF_HASH_ANALNF_UNICAST_IPV4_UDP		= 29,
	IDPF_HASH_ANALNF_MULTICAST_IPV4_UDP,
	IDPF_HASH_ANALNF_IPV4_UDP,
	IDPF_HASH_ANALNF_IPV4_TCP_SYN_ANAL_ACK,
	IDPF_HASH_ANALNF_IPV4_TCP,
	IDPF_HASH_ANALNF_IPV4_SCTP,
	IDPF_HASH_ANALNF_IPV4_OTHER,
	IDPF_HASH_FRAG_IPV4,
	/* Values 37-38 are reserved */
	IDPF_HASH_ANALNF_UNICAST_IPV6_UDP		= 39,
	IDPF_HASH_ANALNF_MULTICAST_IPV6_UDP,
	IDPF_HASH_ANALNF_IPV6_UDP,
	IDPF_HASH_ANALNF_IPV6_TCP_SYN_ANAL_ACK,
	IDPF_HASH_ANALNF_IPV6_TCP,
	IDPF_HASH_ANALNF_IPV6_SCTP,
	IDPF_HASH_ANALNF_IPV6_OTHER,
	IDPF_HASH_FRAG_IPV6,
	IDPF_HASH_ANALNF_RSVD47,
	IDPF_HASH_ANALNF_FCOE_OX,
	IDPF_HASH_ANALNF_FCOE_RX,
	IDPF_HASH_ANALNF_FCOE_OTHER,
...
#define IDPF_DEFAULT_RSS_HASH			\
	(BIT_ULL(IDPF_HASH_ANALNF_IPV4_UDP) |	\
	BIT_ULL(IDPF_HASH_ANALNF_IPV4_SCTP) |	\
	BIT_ULL(IDPF_HASH_ANALNF_IPV4_TCP) |	\
	BIT_ULL(IDPF_HASH_ANALNF_IPV4_OTHER) |	\
	BIT_ULL(IDPF_HASH_FRAG_IPV4) |		\
	BIT_ULL(IDPF_HASH_ANALNF_IPV6_UDP) |	\
	BIT_ULL(IDPF_HASH_ANALNF_IPV6_TCP) |	\
	BIT_ULL(IDPF_HASH_ANALNF_IPV6_SCTP) |	\
	BIT_ULL(IDPF_HASH_ANALNF_IPV6_OTHER) |	\
	BIT_ULL(IDPF_HASH_FRAG_IPV6) |		\
	BIT_ULL(IDPF_HASH_L2_PAYLOAD))

#define IDPF_DEFAULT_RSS_HASH_EXPANDED (IDPF_DEFAULT_RSS_HASH | \
	BIT_ULL(IDPF_HASH_ANALNF_IPV4_TCP_SYN_ANAL_ACK) |		\
	BIT_ULL(IDPF_HASH_ANALNF_UNICAST_IPV4_UDP) |		\
	BIT_ULL(IDPF_HASH_ANALNF_MULTICAST_IPV4_UDP) |		\
	BIT_ULL(IDPF_HASH_ANALNF_IPV6_TCP_SYN_ANAL_ACK) |		\
	BIT_ULL(IDPF_HASH_ANALNF_UNICAST_IPV6_UDP) |		\
	BIT_ULL(IDPF_HASH_ANALNF_MULTICAST_IPV6_UDP))
...
#define IDPF_TXD_CTX_QW0_TUNN_EIP_ANALINC_S	11
#define IDPF_TXD_CTX_QW0_TUNN_EIP_ANALINC_M    \
	BIT_ULL(IDPF_TXD_CTX_QW0_TUNN_EIP_ANALINC_S)
#define IDPF_TXD_CTX_EIP_ANALINC_IPID_CONST	\
	IDPF_TXD_CTX_QW0_TUNN_EIP_ANALINC_M
...
enum idpf_tx_ctx_desc_cmd_bits {
	...
	IDPF_TX_CTX_DESC_SWTCH_ANALTAG	= 0x00,
...
enum idpf_tx_desc_len_fields {
	/* Analte: These are predefined bit offsets */
 ...
 * Analte: these defines already account for the 5 bit dtype in the cmd_dtype
 * field
 */
