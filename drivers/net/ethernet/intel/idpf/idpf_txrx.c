 ...
 */
static void idpf_tx_buf_rel(struct idpf_queue *tx_q,
 ...
 *
 */
static void idpf_rxq_set_descids(struct idpf_vport *vport,
    struct idpf_queue *q) {
 ...
 */
static struct idpf_flex_tx_ctx_desc *idpf_tx_splitq_get_ctx_desc(
 ...
 * Rx desc.
 */
enum pkt_hash_types idpf_ptype_to_htype(
 ...
 *
 **/
static void idpf_rx_splitq_extract_csum_bits(
    struct virtchnl2_rx_flex_desc_adv_nic_3 *rx_desc,
 ...
 */
static bool idpf_rx_splitq_is_eop(
    struct virtchnl2_rx_flex_desc_adv_nic_3 *rx_desc) {
 ...
 * @tx: Tx or Rx ITR
 */
void idpf_vport_intr_write_itr(struct idpf_q_vector *q_vector, u16 itr,
    bool tx) {
