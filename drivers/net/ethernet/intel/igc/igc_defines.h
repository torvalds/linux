...
#define IGC_AUX_IO_TIMER_SEL_SYSTIM0  (0u << 30) /* Select SYSTIM0 for auxiliary
                                                  * time stamp */
#define IGC_AUX_IO_TIMER_SEL_SYSTIM1  (1u << 30) /* Select SYSTIM1 for auxiliary
                                                  * time stamp */
#define IGC_AUX_IO_TIMER_SEL_SYSTIM2  (2u << 30) /* Select SYSTIM2 for auxiliary
                                                  * time stamp */
#define IGC_AUX_IO_TIMER_SEL_SYSTIM3  (3u << 30) /* Select SYSTIM3 for auxiliary
                                                  * time stamp */
#define IGC_TT_IO_TIMER_SEL_SYSTIM0 (0u << 30) /* Select SYSTIM0 for target time
                                                * stamp */
#define IGC_TT_IO_TIMER_SEL_SYSTIM1 (1u << 30) /* Select SYSTIM1 for target time
                                                * stamp */
#define IGC_TT_IO_TIMER_SEL_SYSTIM2 (2u << 30) /* Select SYSTIM2 for target time
                                                * stamp */
#define IGC_TT_IO_TIMER_SEL_SYSTIM3 (3u << 30) /* Select SYSTIM3 for target time
                                                * stamp */
...
#define IGC_PTM_STAT_BAD_PTM_RES  BIT(2) /* PTM Response msg instead of PTM
                                          * Response Data */
#define IGC_PTM_STAT_T4M1_OVFL    BIT(3) /* T4 minus T1 overflow */
#define IGC_PTM_STAT_ADJUST_1ST   BIT(4) /* 1588 timer adjusted during 1st PTM
                                          * cycle */
#define IGC_PTM_STAT_ADJUST_CYC   BIT(5) /* 1588 timer adjusted during non-1st
                                          * PTM cycle */

/* PCIe PTM Cycle Control */
#define IGC_PTM_CYCLE_CTRL_CYC_TIME(msec) ((msec) & 0x3ff) /* PTM Cycle Time
                                                            * (msec) */
