...
static void igc_pin_perout(struct igc_adapter *igc, int chan, int pin,
    int freq) {
...
static void igc_ptm_log_error(struct igc_adapter *adapter, u32 ptm_stat) {
  ...
  switch (ptm_stat) {
    ...
    case IGC_PTM_STAT_BAD_PTM_RES:
      netdev_err(netdev,
          "PTM Error: Bad response, PTM Response Data expected\n");
      break;
    ...
    case IGC_PTM_STAT_ADJUST_1ST:
      netdev_err(netdev,
          "PTM Error: 1588 timer adjusted during first PTM cycle\n");
      break;
    case IGC_PTM_STAT_ADJUST_CYC:
      netdev_err(netdev,
          "PTM Error: 1588 timer adjusted during non-first PTM cycle\n");
      break;
    default:
