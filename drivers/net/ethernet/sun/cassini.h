...
#define    INTR_TX_INTME               0x00000001  /* frame w/ INT ME desc bit
                                                    * set
                                                    * xferred from host queue to
                                                    * TX FIFO */
#define    INTR_TX_ALL                 0x00000002  /* all xmit frames xferred
                                                    * into
                                                    * TX FIFO. i.e.,
                                                    * TX Kick == TX complete. if
                                                    * PACED_MODE set, then TX
                                                    * FIFO
                                                    * also empty */
...
#define    INTR_RX_LEN_MISMATCH        0x00000400  /* len field from MAC !=
                                                    ...
                                                    * MAC packet size.
                                                    * FATAL ERROR */
#define    INTR_SUMMARY                0x00001000  /* summary interrupt bit.
                                                    * this
                                                    * bit will be set if an
                                                    * interrupt
                                                    * generated on the pci bus.
                                                    * useful
                                                    * when driver is polling for
                                                    * interrupts */
#define    INTR_PCS_STATUS             0x00002000  /* PCS interrupt status
                                                    * register */
#define    INTR_TX_MAC_STATUS          0x00004000  /* TX MAC status register has
                                                    * at
                                                    * least 1 unmasked interrupt
                                                    * set */
#define    INTR_RX_MAC_STATUS          0x00008000  /* RX MAC status register has
                                                    * at
                                                    * least 1 unmasked interrupt
                                                    * set */
#define    INTR_MAC_CTRL_STATUS        0x00010000  /* MAC control status
                                                    * register has
                                                    * at least 1 unmasked
                                                    * interrupt
                                                    * set */
#define    INTR_MIF_STATUS             0x00020000  /* MIF status register has at
                                                    * least
                                                    * 1 unmasked interrupt set
                                                    * */
#define    INTR_PCI_ERROR_STATUS       0x00040000  /* PCI error status register
                                                    * in the
                                                    * BIF has at least 1
                                                    * unmasked
                                                    * interrupt set */
...
/* top level interrupt bits that are cleared during read of
...
#define    PCI_ERR_BADACK              0x01    /* reserved in Cassini+.
                                                * set if no ACK64# during ABS64
                                                * cycle
                                                * in Cassini. */
#define    PCI_ERR_DTRTO               0x02    /* delayed xaction timeout. set
                                                * if
                                                *  no read retry after 2^15
                                                * clocks */
#define    PCI_ERR_OTHER               0x04    /* other PCI errors */
#define    PCI_ERR_BIM_DMA_WRITE       0x08    /* BIM received 0 count DMA write
                                                * req.
                                                * unused in Cassini. */
#define    PCI_ERR_BIM_DMA_READ        0x10    /* BIM received 0 count DMA read
                                                * req.
                                                * unused in Cassini. */
#define    PCI_ERR_BIM_DMA_TIMEOUT     0x20    /* BIM received 255 retries
                                                * during
...
#define    SW_RESET_TX                 0x00000001  /* reset TX DMA engine. poll
                                                    * until
                                                    * cleared to 0.  */
#define    SW_RESET_RX                 0x00000002  /* reset RX DMA engine. poll
                                                    * until
                                                    * cleared to 0. */
#define    SW_RESET_RSTOUT             0x00000004  /* force RSTOUT# pin active
                                                    * (low).
                                                    * resets PHY and anything
                                                    * else
                                                    * connected to RSTOUT#.
                                                    * RSTOUT#
                                                    * is also activated by local
                                                    * PCI
                                                    * reset when hot-swap is
                                                    * being
                                                    * done. */
#define    SW_RESET_BLOCK_PCS_SLINK    0x00000008  /* if a global reset is done
                                                    * with
                                                    * this bit set, PCS and
                                                    * SLINK
                                                    * modules won't be reset.
                                                    * i.e., link won't drop. */
#define    SW_RESET_BREQ_SM_MASK       0x00007F00  /* breq state machine [6:0]
                                                    * */
#define    SW_RESET_PCIARB_SM_MASK     0x00070000  /* pci arbitration state
                                                    * bits:
                                                    * 0b000: ARB_IDLE1
                                                    * 0b001: ARB_IDLE2
                                                    * 0b010: ARB_WB_ACK
...
#define    SW_RESET_RDPCI_SM_MASK      0x00300000  /* read pci state bits:
                                                    ...
                                                    * 0b01: RD_PCI_RDY
                                                    * 0b11: RD_PCI_ACK */
#define    SW_RESET_RDARB_SM_MASK      0x00C00000  /* read arbitration state
                                                    * bits:
                                                    * 0b00: AD_IDL_RX
                                                    * 0b01: AD_ACK_RX
                                                    * 0b10: AD_ACK_TX
...
#define    SW_RESET_WRPCI_SM_MASK      0x06000000  /* write pci state bits
                                                    ...
                                                    * 0b01: WR_PCI_RDY
                                                    * 0b11: WR_PCI_ACK */
#define    SW_RESET_WRARB_SM_MASK      0x38000000  /* write arbitration state
                                                    * bits:
                                                    * 0b000: ARB_IDLE1
                                                    * 0b001: ARB_IDLE2
                                                    * 0b010: ARB_TX_ACK
...
#define    BIM_LOCAL_DEV_EXT           0x04    /* secondary local bus device
                                                * chip
...
#define    BIM_LOCAL_DEV_HW_RESET      0x20    /* internal hw reset. Cassini+
                                                * only. */

/* access 24 entry BIM read and write buffers. put address in
 * REG_BIM_BUFFER_ADDR
...
#define    BIM_RAM_BIST_RD_START       0x01    /* start BIST for BIM read buffer
                                                * */
#define    BIM_RAM_BIST_WR_START       0x02    /* start BIST for BIM write
                                                * buffer.
                                                * Cassini only. reserved in
                                                * Cassini+. */
#define    BIM_RAM_BIST_RD_PASS        0x04    /* summary BIST pass status for
                                                * read
                                                * buffer. */
#define    BIM_RAM_BIST_WR_PASS        0x08    /* summary BIST pass status for
                                                * write
 ...
 * 0x0: internal probe[7:0] (pci arb state, wtc empty w, wtc full w, wtc empty
 * w,
 ...
 * 0x2: internal probe[23:16] (txdma rd req, txdma rd ack, txdma rd rdy, rxdma
 * rd,
...
#define    PROBE_MUX_EN                0x80000000 /* allow probe signals to be
                                                   ...
                                                   * P_A[15:0]
                                                   * for debugging */
#define    PROBE_MUX_SUB_MUX_MASK      0x0000FF00 /* select sub module probe
                                                   * signals:
                                                   * 0x03 = mac[1:0]
                                                   * 0x0C = rx[1:0]
                                                   * 0x30 = tx[1:0]
                                                   * 0xC0 = hp[1:0] */
#define    PROBE_MUX_SEL_HI_MASK       0x000000F0 /* select which module to
                                                   * appear
                                                   * on P_A[15:8]. see above for
                                                   * values. */
#define    PROBE_MUX_SEL_LOW_MASK      0x0000000F /* select which module to
                                                   * appear
...
#define  REG_PLUS_INTR_STATUS_1        0x103C /* Cassini+: interrupt status
                                               * register 2 for INTB. default:
                                               * 0x1F */
#define  REG_PLUS_INTRN_STATUS(x)       (REG_PLUS_INTR_STATUS_1 + ((x) - 1) \
  * 16)
#define    INTR_STATUS_ALT_INTX_EN     0x80   /* generate INTX when one of the
                                               * flags are set. enables desc
                                               * ring. */
...
#define  REG_PLUS_INTRN_STATUS_ALIAS(x) (REG_PLUS_INTR_STATUS_ALIAS_1 \
  + ((x) - 1) * 16)
...
#define    TX_CFG_DMA_EN               0x00000001  /* enable TX DMA. if cleared,
                                                    * DMA
                                                    * will stop after xfer of
                                                    * current
...
#define    TX_CFG_COMPWB_Q1            0x02000000  /* completion writeback
                                                    * happens at
                                                    * the end of every packet
                                                    * kicked
                                                    * through Q1. */
#define    TX_CFG_COMPWB_Q2            0x04000000  /* completion writeback
                                                    * happens at
                                                    * the end of every packet
                                                    * kicked
                                                    * through Q2. */
#define    TX_CFG_COMPWB_Q3            0x08000000  /* completion writeback
                                                    * happens at
                                                    * the end of every packet
                                                    * kicked
                                                    * through Q3 */
#define    TX_CFG_COMPWB_Q4            0x10000000  /* completion writeback
                                                    * happens at
                                                    * the end of every packet
                                                    * kicked
                                                    * through Q4 */
#define    TX_CFG_INTR_COMPWB_DIS      0x20000000  /* disable pre-interrupt
                                                    * completion
                                                    * writeback */
...
#define    TX_SM_1_FIFO_UNLOAD_MASK    0x003C0000   /* FIFO unload state machine
                                                     * */
#define    TX_SM_1_CACHE_MASK          0x03C00000   /* desc. prefetch cache
                                                     * controller
                                                     * state machine */
...
#define  REG_TX_FIFO_SIZE              0x2118  /* (ro) TX FIFO size = 0x090 =
                                                * 9KB */
...
#define    RX_CFG_COMP_RING_MASK        0x000001E0 /* # desc entries in RX
                                                    * complete
                                                    * ring. def: 0x8 = 32k */
...
#define    RX_DEBUG_LOAD_STATE_MASK        0x0000000F /* load state machine w/
                                                       * MAC:
                                                       * 0x0 = idle,   0x1 =
                                                       * load_bop
                                                       * 0x2 = load 1, 0x3 =
                                                       ...
                                                       * 0x6 = last detect
                                                       * 0x7 = wait req
                                                       * 0x8 = wait req statuss
                                                       * 1st
                                                       * 0x9 = load st
                                                       * 0xa = bubble mac
                                                       * 0xb = error */
#define    RX_DEBUG_LM_STATE_MASK          0x00000070 /* load state machine w/
                                                       * HP and
                                                       * RX FIFO:
                                                       * 0x0 = idle,   0x1 = hp
                                                       * xfr
                                                       ...
                                                       * 0x6 = csum ready
                                                       * 0x7 = error */
#define    RX_DEBUG_FC_STATE_MASK          0x000000180 /* flow control state
                                                        * machine
                                                        * w/ MAC:
                                                        * 0x0 = idle
                                                        * 0x1 = wait xoff ack
                                                        * 0x2 = wait xon
                                                        * 0x3 = wait xon ack */
#define    RX_DEBUG_DATA_STATE_MASK        0x000001E00 /* unload data state
                                                        * machine
                                                        * states:
                                                        * 0x0 = idle data
                                                        * 0x1 = header begin
                                                        ...
                                                        * 0xe = error
                                                        * 0xf = bubble idle */
#define    RX_DEBUG_DESC_STATE_MASK        0x0001E000 /* unload desc state
                                                       * machine
                                                       * states:
                                                       * 0x0 = idle desc
                                                       * 0x1 = wait ack
                                                       ...
                                                       * 0x6 = post batch
                                                       * 0x7 = xfr done */
#define    RX_DEBUG_INTR_READ_PTR_MASK     0x30000000 /* interrupt read ptr of
                                                       * the
                                                       * interrupt queue */
...
#define  REG_RX_BLANK                      0x4044  /* RX blanking register
                                                    * for ISR read */
#define    RX_BLANK_INTR_PKT_MASK          0x000001FF /* RX_DONE intr asserted
                                                       * if
                                                       * this many sets of
                                                       * completion
                                                       * writebacks (up to 2
                                                       * packets)
                                                       * occur since the last
                                                       * time
                                                       * the ISR was read. 0 =
                                                       * no
                                                       * packet blanking */
#define    RX_BLANK_INTR_PKT_SHIFT         0
#define    RX_BLANK_INTR_TIME_MASK         0x3FFFF000 /* RX_DONE interrupt
                                                       * asserted
                                                       * if that many clocks
                                                       * were
                                                       * counted since last time
                                                       * the
                                                       * ISR was read.
 ...
 * DEFAULT: 0x00000000
 */
#define  REG_RX_RED                      0x404C  /* RX random early detect
                                                  * enable */
...
static cas_hp_inst_t cas_prog_encryptiontab[] = {
  ...
  //0x1000, 0x1000, OP_EQ,  0, S1_DROP,  1, S1_8023,  CL_REG, 0x000,  0, 0x0,
  // 0x00
  00,
#endif
  ...
  { "TCP64?",
#if 0
    //@@@0xff00, 0x0600, OP_EQ, 18, S1_TCPSQ, 0, S1_ESP6,  LD_LEN, 0x03f,  1,
    // 0x0, 0xffff,
#endif
...
#if 0
    //@@@0x00ff, 0x0032, OP_EQ,  0, S1_CLNP2, 0, S1_AH6, IM_CTL, 0x021, 1,  0x0,
    // 0xffff,
#endif
...
#if 0
    //@@@0x00ff, 0x0033, OP_EQ,  0, S1_CLNP2, 0, S1_CLNP, IM_CTL, 0x021, 1,
    //  0x0, 0xffff,
#endif
