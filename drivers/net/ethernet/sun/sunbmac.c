...
#define MGMT_CLKON  (MGMT_PAL_INT_MDIO | MGMT_PAL_EXT_MDIO | MGMT_PAL_OENAB \
  | MGMT_PAL_DCLOCK)
...
static void bigmac_is_medium_rare(struct bigmac *bp, u32 qec_status,
    u32 bmac_status) {
...
static netdev_tx_t bigmac_start_xmit(struct sk_buff *skb,
...
/* Ethtool support... */
static void bigmac_get_drvinfo(struct net_device *dev,
