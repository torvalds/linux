...
#define MVPP22_FLOW_TCP4  (MVPP22_FLOW_ETHER_BIT | MVPP22_FLOW_IP4_BIT \
  | MVPP22_FLOW_TCP_BIT)
#define MVPP22_FLOW_TCP6  (MVPP22_FLOW_ETHER_BIT | MVPP22_FLOW_IP6_BIT \
  | MVPP22_FLOW_TCP_BIT)
#define MVPP22_FLOW_UDP4  (MVPP22_FLOW_ETHER_BIT | MVPP22_FLOW_IP4_BIT \
  | MVPP22_FLOW_UDP_BIT)
#define MVPP22_FLOW_UDP6  (MVPP22_FLOW_ETHER_BIT | MVPP22_FLOW_IP6_BIT \
  | MVPP22_FLOW_UDP_BIT)
...
#define MVPP2_CLS_FLT_C2_RSS_ENTRY(id)    (MVPP2_CLS_FLT_C2_RFS(MVPP2_MAX_PORTS, \
    id, 0))
#define MVPP2_CLS_FLT_HASH_ENTRY(port, \
      id)  (MVPP2_CLS_FLT_C2_RSS_ENTRY(id) + 1 + (port))
