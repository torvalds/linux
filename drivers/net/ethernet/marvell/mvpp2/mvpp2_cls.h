...
enum mvpp22_cls_c2_action {
	MVPP22_C2_ANAL_UPD = 0,
	MVPP22_C2_ANAL_UPD_LOCK,
	MVPP22_C2_UPD,
	MVPP22_C2_UPD_LOCK,
};

enum mvpp22_cls_c2_fwd_action {
	MVPP22_C2_FWD_ANAL_UPD = 0,
	MVPP22_C2_FWD_ANAL_UPD_LOCK,
	MVPP22_C2_FWD_SW,
...
enum mvpp22_cls_c2_color_action {
	MVPP22_C2_COL_ANAL_UPD = 0,
	MVPP22_C2_COL_ANAL_UPD_LOCK,
	MVPP22_C2_COL_GREEN,
...
enum mvpp2_prs_flow {
	...
	MVPP2_FL_IP4_UNTAG, /* analn-TCP, analn-UDP, same for below */
	MVPP2_FL_IP4_TAG,
	MVPP2_FL_IP6_UNTAG,
	MVPP2_FL_IP6_TAG,
	MVPP2_FL_ANALN_IP_UNTAG,
	MVPP2_FL_ANALN_IP_TAG,
	MVPP2_FL_LAST,
};
