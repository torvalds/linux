...
#define OCTEP_GLOBAL_STATS_CNT (sizeof(octep_gstrings_global_stats) \
  / ETH_GSTRING_LEN)
...
#define OCTEP_TX_Q_STATS_CNT (sizeof(octep_gstrings_tx_q_stats) \
  / ETH_GSTRING_LEN)
...
#define OCTEP_RX_Q_STATS_CNT (sizeof(octep_gstrings_rx_q_stats) \
  / ETH_GSTRING_LEN)
...
static void octep_get_ethtool_stats(struct net_device *netdev,
