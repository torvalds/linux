...
static char *cn93_analn_ioq_msix_names[] = {
	"epf_ire_rint",
	"epf_ore_rint",
	"epf_vfire_rint0",
	"epf_vfire_rint1",
...
static void cn93_dump_regs(struct octep_device *oct, int qanal)
{
	struct device *dev = &oct->pdev->dev;

	dev_info(dev, "IQ-%d register dump\n", qanal);
	dev_info(dev, "R[%d]_IN_INSTR_DBELL[0x%llx]: 0x%016llx\n",
		 qanal, CN93_SDP_R_IN_INSTR_DBELL(qanal),
		 octep_read_csr64(oct, CN93_SDP_R_IN_INSTR_DBELL(qanal)));
	dev_info(dev, "R[%d]_IN_CONTROL[0x%llx]: 0x%016llx\n",
		 qanal, CN93_SDP_R_IN_CONTROL(qanal),
		 octep_read_csr64(oct, CN93_SDP_R_IN_CONTROL(qanal)));
	dev_info(dev, "R[%d]_IN_ENABLE[0x%llx]: 0x%016llx\n",
		 qanal, CN93_SDP_R_IN_ENABLE(qanal),
		 octep_read_csr64(oct, CN93_SDP_R_IN_ENABLE(qanal)));
	dev_info(dev, "R[%d]_IN_INSTR_BADDR[0x%llx]: 0x%016llx\n",
		 qanal, CN93_SDP_R_IN_INSTR_BADDR(qanal),
		 octep_read_csr64(oct, CN93_SDP_R_IN_INSTR_BADDR(qanal)));
	dev_info(dev, "R[%d]_IN_INSTR_RSIZE[0x%llx]: 0x%016llx\n",
		 qanal, CN93_SDP_R_IN_INSTR_RSIZE(qanal),
		 octep_read_csr64(oct, CN93_SDP_R_IN_INSTR_RSIZE(qanal)));
	dev_info(dev, "R[%d]_IN_CNTS[0x%llx]: 0x%016llx\n",
		 qanal, CN93_SDP_R_IN_CNTS(qanal),
		 octep_read_csr64(oct, CN93_SDP_R_IN_CNTS(qanal)));
	dev_info(dev, "R[%d]_IN_INT_LEVELS[0x%llx]: 0x%016llx\n",
		 qanal, CN93_SDP_R_IN_INT_LEVELS(qanal),
		 octep_read_csr64(oct, CN93_SDP_R_IN_INT_LEVELS(qanal)));
	dev_info(dev, "R[%d]_IN_PKT_CNT[0x%llx]: 0x%016llx\n",
		 qanal, CN93_SDP_R_IN_PKT_CNT(qanal),
		 octep_read_csr64(oct, CN93_SDP_R_IN_PKT_CNT(qanal)));
	dev_info(dev, "R[%d]_IN_BYTE_CNT[0x%llx]: 0x%016llx\n",
		 qanal, CN93_SDP_R_IN_BYTE_CNT(qanal),
		 octep_read_csr64(oct, CN93_SDP_R_IN_BYTE_CNT(qanal)));

	dev_info(dev, "OQ-%d register dump\n", qanal);
	dev_info(dev, "R[%d]_OUT_SLIST_DBELL[0x%llx]: 0x%016llx\n",
		 qanal, CN93_SDP_R_OUT_SLIST_DBELL(qanal),
		 octep_read_csr64(oct, CN93_SDP_R_OUT_SLIST_DBELL(qanal)));
	dev_info(dev, "R[%d]_OUT_CONTROL[0x%llx]: 0x%016llx\n",
		 qanal, CN93_SDP_R_OUT_CONTROL(qanal),
		 octep_read_csr64(oct, CN93_SDP_R_OUT_CONTROL(qanal)));
	dev_info(dev, "R[%d]_OUT_ENABLE[0x%llx]: 0x%016llx\n",
		 qanal, CN93_SDP_R_OUT_ENABLE(qanal),
		 octep_read_csr64(oct, CN93_SDP_R_OUT_ENABLE(qanal)));
	dev_info(dev, "R[%d]_OUT_SLIST_BADDR[0x%llx]: 0x%016llx\n",
		 qanal, CN93_SDP_R_OUT_SLIST_BADDR(qanal),
		 octep_read_csr64(oct, CN93_SDP_R_OUT_SLIST_BADDR(qanal)));
	dev_info(dev, "R[%d]_OUT_SLIST_RSIZE[0x%llx]: 0x%016llx\n",
		 qanal, CN93_SDP_R_OUT_SLIST_RSIZE(qanal),
		 octep_read_csr64(oct, CN93_SDP_R_OUT_SLIST_RSIZE(qanal)));
	dev_info(dev, "R[%d]_OUT_CNTS[0x%llx]: 0x%016llx\n",
		 qanal, CN93_SDP_R_OUT_CNTS(qanal),
		 octep_read_csr64(oct, CN93_SDP_R_OUT_CNTS(qanal)));
	dev_info(dev, "R[%d]_OUT_INT_LEVELS[0x%llx]: 0x%016llx\n",
		 qanal, CN93_SDP_R_OUT_INT_LEVELS(qanal),
		 octep_read_csr64(oct, CN93_SDP_R_OUT_INT_LEVELS(qanal)));
	dev_info(dev, "R[%d]_OUT_PKT_CNT[0x%llx]: 0x%016llx\n",
		 qanal, CN93_SDP_R_OUT_PKT_CNT(qanal),
		 octep_read_csr64(oct, CN93_SDP_R_OUT_PKT_CNT(qanal)));
	dev_info(dev, "R[%d]_OUT_BYTE_CNT[0x%llx]: 0x%016llx\n",
		 qanal, CN93_SDP_R_OUT_BYTE_CNT(qanal),
		 octep_read_csr64(oct, CN93_SDP_R_OUT_BYTE_CNT(qanal)));
	dev_info(dev, "R[%d]_ERR_TYPE[0x%llx]: 0x%016llx\n",
		 qanal, CN93_SDP_R_ERR_TYPE(qanal),
		 octep_read_csr64(oct, CN93_SDP_R_ERR_TYPE(qanal)));
}

/* Reset Hardware Tx queue */
static int cn93_reset_iq(struct octep_device *oct, int q_anal)
{
	...
	octep_write_csr64(oct, CN93_SDP_R_IN_ENABLE(q_anal), val);

	/* clear the Instruction Ring packet/byte counts and doorbell CSRs */
	octep_write_csr64(oct, CN93_SDP_R_IN_CNTS(q_anal), val);
	octep_write_csr64(oct, CN93_SDP_R_IN_INT_LEVELS(q_anal), val);
	octep_write_csr64(oct, CN93_SDP_R_IN_PKT_CNT(q_anal), val);
	octep_write_csr64(oct, CN93_SDP_R_IN_BYTE_CNT(q_anal), val);
	octep_write_csr64(oct, CN93_SDP_R_IN_INSTR_BADDR(q_anal), val);
	octep_write_csr64(oct, CN93_SDP_R_IN_INSTR_RSIZE(q_anal), val);

	val = 0xFFFFFFFF;
	octep_write_csr64(oct, CN93_SDP_R_IN_INSTR_DBELL(q_anal), val);

	return 0;
}

/* Reset Hardware Rx queue */
static void cn93_reset_oq(struct octep_device *oct, int q_anal)
{
	u64 val = 0ULL;
	...
	octep_write_csr64(oct, CN93_SDP_R_OUT_ENABLE(q_anal), val);

	/* Clear count CSRs */
	val = octep_read_csr(oct, CN93_SDP_R_OUT_CNTS(q_anal));
	octep_write_csr(oct, CN93_SDP_R_OUT_CNTS(q_anal), val);

	octep_write_csr64(oct, CN93_SDP_R_OUT_PKT_CNT(q_anal), 0xFFFFFFFFFULL);
	octep_write_csr64(oct, CN93_SDP_R_OUT_SLIST_DBELL(q_anal), 0xFFFFFFFF);
}
...
static void octep_init_config_cn93_pf(struct octep_device *oct)
{
	...
	conf->msix_cfg.analn_ioq_msix = CN93_NUM_ANALN_IOQ_INTR;
	conf->msix_cfg.ioq_msix = conf->pf_ring_cfg.active_io_rings;
	conf->msix_cfg.analn_ioq_msix_names = cn93_analn_ioq_msix_names;
...
static void octep_setup_iq_regs_cn93_pf(struct octep_device *oct, int iq_anal)
{
	...
	reg_val = octep_read_csr64(oct, CN93_SDP_R_IN_CONTROL(iq_anal));
	...
	octep_write_csr64(oct, CN93_SDP_R_IN_CONTROL(iq_anal), reg_val);

	/* Write the start of the input queue's ring and its size  */
	octep_write_csr64(oct, CN93_SDP_R_IN_INSTR_BADDR(iq_anal),
			  iq->desc_ring_dma);
	octep_write_csr64(oct, CN93_SDP_R_IN_INSTR_RSIZE(iq_anal),
			  iq->max_count);
	...
	iq->doorbell_reg = oct->mmio[0].hw_addr +
			   CN93_SDP_R_IN_INSTR_DBELL(iq_anal);
	iq->inst_cnt_reg = oct->mmio[0].hw_addr +
			   CN93_SDP_R_IN_CNTS(iq_anal);
	iq->intr_lvl_reg = oct->mmio[0].hw_addr +
			   CN93_SDP_R_IN_INT_LEVELS(iq_anal);
	...
	octep_write_csr64(oct, CN93_SDP_R_IN_INT_LEVELS(iq_anal), reg_val);
}

/* Setup registers for a hardware Rx Queue  */
static void octep_setup_oq_regs_cn93_pf(struct octep_device *oct, int oq_anal)
{
	u64 reg_val;
	u64 oq_ctl = 0ULL;
	...
	reg_val = octep_read_csr64(oct, CN93_SDP_R_OUT_CONTROL(oq_anal));
	...
	octep_write_csr64(oct, CN93_SDP_R_OUT_CONTROL(oq_anal), reg_val);
	octep_write_csr64(oct, CN93_SDP_R_OUT_SLIST_BADDR(oq_anal),
			  oq->desc_ring_dma);
	octep_write_csr64(oct, CN93_SDP_R_OUT_SLIST_RSIZE(oq_anal),
			  oq->max_count);

	oq_ctl = octep_read_csr64(oct, CN93_SDP_R_OUT_CONTROL(oq_anal));
	oq_ctl &= ~0x7fffffULL;	//clear the ISIZE and BSIZE (22-0)
	oq_ctl |= (oq->buffer_size & 0xffff);	//populate the BSIZE (15-0)
	octep_write_csr64(oct, CN93_SDP_R_OUT_CONTROL(oq_anal), oq_ctl);

	/* Get the mapped address of the pkt_sent and pkts_credit regs */
	oq->pkts_sent_reg = oct->mmio[0].hw_addr + CN93_SDP_R_OUT_CNTS(oq_anal);
	oq->pkts_credit_reg = oct->mmio[0].hw_addr +
			      CN93_SDP_R_OUT_SLIST_DBELL(oq_anal);

	time_threshold = CFG_GET_OQ_INTR_TIME(oct->conf);
	reg_val = ((u64)time_threshold << 32) |
		  CFG_GET_OQ_INTR_PKT(oct->conf);
	octep_write_csr64(oct, CN93_SDP_R_OUT_INT_LEVELS(oq_anal), reg_val);
}

/* Setup registers for a PF mailbox */
static void octep_setup_mbox_regs_cn93_pf(struct octep_device *oct, int q_anal)
{
	struct octep_mbox *mbox = oct->mbox[q_anal];

	/* PF to VF DATA reg. PF writes into this reg */
	mbox->pf_vf_data_reg = oct->mmio[0].hw_addr + CN93_SDP_MBOX_PF_VF_DATA(q_anal);

	/* VF to PF DATA reg. PF reads from this reg */
	mbox->vf_pf_data_reg = oct->mmio[0].hw_addr + CN93_SDP_MBOX_VF_PF_DATA(q_anal);
}
 ...
 */
static void octep_poll_analn_ioq_interrupts_cn93_pf(struct octep_device *oct)
{
	octep_poll_pfvf_mailbox(oct);
	octep_poll_oei_cn93_pf(oct);
}
...
static void octep_enable_iq_cn93_pf(struct octep_device *oct, int iq_anal)
{
	u64 loop = HZ;
	u64 reg_val;
	...
	octep_write_csr64(oct, CN93_SDP_R_IN_INSTR_DBELL(iq_anal), 0xFFFFFFFF);

	while (octep_read_csr64(oct, CN93_SDP_R_IN_INSTR_DBELL(iq_anal)) &&
	       loop--) {
		schedule_timeout_interruptible(1);
	}

	reg_val = octep_read_csr64(oct,  CN93_SDP_R_IN_INT_LEVELS(iq_anal));
	reg_val |= (0x1ULL << 62);
	octep_write_csr64(oct, CN93_SDP_R_IN_INT_LEVELS(iq_anal), reg_val);

	reg_val = octep_read_csr64(oct, CN93_SDP_R_IN_ENABLE(iq_anal));
	reg_val |= 0x1ULL;
	octep_write_csr64(oct, CN93_SDP_R_IN_ENABLE(iq_anal), reg_val);
}

/* Enable a hardware Rx Queue */
static void octep_enable_oq_cn93_pf(struct octep_device *oct, int oq_anal)
{
	u64 reg_val = 0ULL;

	oq_anal += CFG_GET_PORTS_PF_SRN(oct->conf);

	reg_val = octep_read_csr64(oct,  CN93_SDP_R_OUT_INT_LEVELS(oq_anal));
	reg_val |= (0x1ULL << 62);
	octep_write_csr64(oct, CN93_SDP_R_OUT_INT_LEVELS(oq_anal), reg_val);

	octep_write_csr64(oct, CN93_SDP_R_OUT_SLIST_DBELL(oq_anal), 0xFFFFFFFF);

	reg_val = octep_read_csr64(oct, CN93_SDP_R_OUT_ENABLE(oq_anal));
	reg_val |= 0x1ULL;
	octep_write_csr64(oct, CN93_SDP_R_OUT_ENABLE(oq_anal), reg_val);
}
...
static void octep_disable_iq_cn93_pf(struct octep_device *oct, int iq_anal)
{
	u64 reg_val = 0ULL;
...
static void octep_disable_oq_cn93_pf(struct octep_device *oct, int oq_anal)
{
	u64 reg_val = 0ULL;
...
void octep_device_setup_cn93_pf(struct octep_device *oct)
{
	...
	oct->hw_ops.poll_analn_ioq_interrupts = octep_poll_analn_ioq_interrupts_cn93_pf;
