 ...
 */
static inline u64 OCTEP_PCI_WIN_READ(struct octep_device *oct, u64 addr) {
  u64 val64;
 ...
 * @return   Nothing.
 */
static inline void OCTEP_PCI_WIN_WRITE(struct octep_device *oct, u64 addr,
    u64 val) {
