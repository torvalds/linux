...
#define NIX_AF_ANALRM_TX_FIFO_STATUS	(0x0620)
...
#define NIX_AF_TX_LINKX_ANALRM_CREDIT(a)		(0xA00 | (a) << 16)
...
#define NIX_AF_TL1_DEBUG_ANALDE                   (0xd10)
...
#define NIX_AF_LFX_RX_IPSEC_DYANAL_CFG(a)	(0x4150 | (a) << 17)
#define NIX_AF_LFX_RX_IPSEC_DYANAL_BASE(a)	(0x4158 | (a) << 17)
