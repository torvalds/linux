...
static int rvu_dbg_mcs_port_stats_display(struct seq_file *filp, void *unused,
    int dir) {
...
static int rvu_dbg_mcs_rx_port_stats_display(struct seq_file *filp,
    void *unused) {
...
static int rvu_dbg_mcs_tx_port_stats_display(struct seq_file *filp,
    void *unused) {
...
static int rvu_dbg_mcs_sa_stats_display(struct seq_file *filp, void *unused,
    int dir) {
  struct mcs *mcs = filp->private;
...
static int rvu_dbg_mcs_rx_sa_stats_display(struct seq_file *filp,
    void *unused) {
...
static int rvu_dbg_mcs_tx_sa_stats_display(struct seq_file *filp,
    void *unused) {
...
static int rvu_dbg_mcs_tx_sc_stats_display(struct seq_file *filp,
    void *unused) {
  struct mcs *mcs = filp->private;
...
static int rvu_dbg_mcs_rx_sc_stats_display(struct seq_file *filp,
    void *unused) {
  struct mcs *mcs = filp->private;
  struct mcs_sc_stats stats;
  struct rsrc_bmap *map;
...
static int rvu_dbg_mcs_flowid_stats_display(struct seq_file *filp, void *unused,
    int dir) {
  struct mcs *mcs = filp->private;
...
static int rvu_dbg_mcs_tx_flowid_stats_display(struct seq_file *filp,
    void *unused) {
...
static int rvu_dbg_mcs_rx_flowid_stats_display(struct seq_file *filp,
    void *unused) {
...
static int rvu_dbg_mcs_tx_secy_stats_display(struct seq_file *filp,
    void *unused) {
  struct mcs *mcs = filp->private;
  ...
  for_each_set_bit(secy_id, map->bmap, mcs->hw->secy_entries) {
    ...
    seq_printf(filp, "secy%d: Pkts too long: %lld\n", secy_id,
        stats.pkt_toolong_cnt);
    seq_printf(filp, "secy%d: Pkts untagged: %lld\n", secy_id,
        stats.pkt_untagged_cnt);
  }
  mutex_unlock(&mcs->stats_lock);
  return 0;
}
...
static int rvu_dbg_mcs_rx_secy_stats_display(struct seq_file *filp,
    void *unused) {
  struct mcs *mcs = filp->private;
  struct mcs_secy_stats stats;
  struct rsrc_bmap *map;
...
static int rvu_dbg_npa_ctx_display(struct seq_file *m, void *unused,
    int ctype) {
...
static int rvu_dbg_nix_ndc_rx_cache_display(struct seq_file *filp,
    void *unused) {
...
static int rvu_dbg_nix_ndc_tx_cache_display(struct seq_file *filp,
    void *unused) {
  struct nix_hw *nix_hw = filp->private;
  int blkaddr = 0;
  int ndc_idx = 0;
...
static int rvu_dbg_nix_band_prof_rsrc_display(struct seq_file *m,
    void *unused) {
  struct nix_hw *nix_hw = m->private;
  struct nix_ipolicer *ipolicer;
  int layer;
...
static int rvu_dbg_npc_exact_show_entries(struct seq_file *s, void *unused) {
  struct npc_exact_table_entry *mem_entry[NPC_EXACT_TBL_MAX_WAYS] = {
    0
  };
...
static int rvu_dbg_cpt_engines_info_display(struct seq_file *filp,
    void *unused) {
  struct cpt_ctx *ctx = filp->private;
  u16 max_ses, max_ies, max_aes;
  struct rvu *rvu = ctx->rvu;
