...
static void otx2_mbox_msg_send_data(struct otx2_mbox *mbox, int devid,
    u64 data) {
  struct otx2_mbox_dev *mdev = &mbox->dev[devid];
  struct mbox_hdr *tx_hdr, *rx_hdr;
  void *hw_mbase = mdev->hwbase;
...
int otx2_reply_invalid_msg(struct otx2_mbox *mbox, int devid, u16 pcifunc,
    u16 id) {
  struct msg_rsp *rsp;
  rsp = (struct msg_rsp *)
...
const char *otx2_mbox_id2name(u16 id) {
  switch (id) {
#define M(_name, _id, _1, _2, _3) case _id: \
    return # _name;
    MBOX_MESSAGES
#undef M
    default:
