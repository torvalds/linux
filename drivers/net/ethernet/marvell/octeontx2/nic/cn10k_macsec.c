...
static int cn10k_mcs_secy_tx_cfg(struct otx2_nic *pfvf,
    struct macsec_secy *secy,
    struct cn10k_mcs_txsc *txsc,
...
static void cn10k_mcs_sync_stats(struct otx2_nic *pfvf,
    struct macsec_secy *secy,
    struct cn10k_mcs_txsc *txsc) {
  struct cn10k_mcs_cfg *cfg = pfvf->macsec_cfg;
  struct mcs_secy_stats rx_rsp = {
    0
  };
  struct mcs_sc_stats sc_rsp = {
    0
  };
  struct cn10k_mcs_rxsc *rxsc;
...
void cn10k_handle_mcs_event(struct otx2_nic *pfvf,
