...
static void prestera_vr_put(struct prestera_switch *sw,
    struct prestera_vr *vr) {
...
static int __prestera_rif_entry_key_copy(
    const struct prestera_rif_entry_key *in,
...
static struct prestera_nh_neigh *__prestera_nh_neigh_create(
...
static struct prestera_nexthop_group *__prestera_nexthop_group_create(
    struct prestera_switch *sw,
...
static void __prestera_nexthop_group_destroy(struct prestera_switch *sw,
    struct prestera_nexthop_group *nh_grp) {
  struct prestera_nh_neigh *nh_neigh;
  int nh_cnt;
...
static struct prestera_nexthop_group *__prestera_nexthop_group_find(
    struct prestera_switch *sw,
    struct prestera_nexthop_group_key *key) {
  struct prestera_nexthop_group *nh_grp;
...
static struct prestera_nexthop_group *prestera_nexthop_group_get(
    struct prestera_switch *sw,
    struct prestera_nexthop_group_key *key) {
  struct prestera_nexthop_group *nh_grp;
