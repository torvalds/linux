...
static struct prestera_trap_item *prestera_get_trap_item_by_cpu_code(
    struct prestera_switch *sw, u8 cpu_code) {
...
static struct prestera_trap_item *prestera_devlink_trap_item_lookup(
    struct prestera_switch *sw, u16 trap_id) {
  struct prestera_trap_data *trap_data = sw->trap_data;
  int i;
