...
static struct prestera_acl_ruleset *prestera_acl_ruleset_create(
    struct prestera_acl *acl,
    struct prestera_flow_block *block,
    u32 chain_index) {
...
static struct prestera_acl_ruleset *__prestera_acl_ruleset_lookup(
    struct prestera_acl *acl,
    struct prestera_flow_block *block,
    u32 chain_index) {
  struct prestera_acl_ruleset_ht_key ht_key;
...
struct prestera_acl_ruleset *prestera_acl_ruleset_lookup(
    struct prestera_acl *acl,
    struct prestera_flow_block *block,
    u32 chain_index) {
  struct prestera_acl_ruleset *ruleset;
...
struct prestera_acl_ruleset *prestera_acl_ruleset_get(struct prestera_acl *acl,
    struct prestera_flow_block *block,
    u32 chain_index) {
  struct prestera_acl_ruleset *ruleset;
  ruleset = __prestera_acl_ruleset_lookup(acl, block, chain_index);
...
static void prestera_acl_ruleset_block_unbind(
    struct prestera_acl_ruleset *ruleset,
    struct prestera_flow_block *block) {
  struct prestera_flow_block_binding *binding;
  list_for_each_entry(binding, &block->binding_list, list)
...
static void prestera_acl_ruleset_prio_refresh(struct prestera_acl *acl,
    struct prestera_acl_ruleset *ruleset) {
...
void prestera_acl_rule_keymask_pcl_id_set(struct prestera_acl_rule *rule,
    u16 pcl_id) {
...
struct prestera_acl_rule *prestera_acl_rule_lookup(
    struct prestera_acl_ruleset *ruleset,
...
struct prestera_acl_rule *prestera_acl_rule_create(
    struct prestera_acl_ruleset *ruleset,
...
static void prestera_acl_ruleset_prio_update(
    struct prestera_acl_ruleset *ruleset,
    u32 prio) {
...
struct prestera_acl_rule_entry *prestera_acl_rule_entry_find(
    struct prestera_acl *acl,
    struct prestera_acl_rule_entry_key *key) {
...
static void __prestera_acl_rule_entry_act_destruct(struct prestera_switch *sw,
    struct prestera_acl_rule_entry *e) {
  /* counter */
...
static int __prestera_acl_rule_entry_act_construct(struct prestera_switch *sw,
    struct prestera_acl_rule_entry *e,
...
struct prestera_acl_rule_entry *prestera_acl_rule_entry_create(
    struct prestera_acl *acl,
    struct prestera_acl_rule_entry_key *key,
    struct prestera_acl_rule_entry_arg *arg) {
  struct prestera_acl_rule_entry *e;
