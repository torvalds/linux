...
static void prestera_util_fen_info2fib_cache_key(struct fib_notifier_info *info,
    struct prestera_kern_fib_cache_key *key) {
...
static void prestera_util_nc_key2nh_key(
...
static bool prestera_util_nhc_eq_n_cache_key(struct prestera_switch *sw,
    struct fib_nh_common *nhc,
    struct prestera_kern_neigh_cache_key *nk) {
...
static int prestera_util_neigh2nc_key(struct prestera_switch *sw,
    struct neighbour *n,
    struct prestera_kern_neigh_cache_key *key) {
  memset(key, 0, sizeof(*key));
...
static bool __prestera_util_kern_n_is_reachable_v4(u32 tb_id, __be32 *addr,
    struct net_device *dev) {
  struct fib_nh_common *fib_nhc;
...
static bool prestera_util_kern_n_is_reachable(u32 tb_id,
    struct prestera_ip_addr *addr,
    struct net_device *dev) {
...
static void prestera_util_kern_set_nh_offload(struct fib_nh_common *nhc,
...
static struct fib_nh_common *prestera_kern_fib_info_nhc(
    struct fib_notifier_info *info, int n) {
  struct fib6_entry_notifier_info *fen6_info;
  struct fib_entry_notifier_info *fen4_info;
...
static unsigned char prestera_kern_fib_info_type(struct fib_notifier_info *info)
{
  struct fib6_entry_notifier_info *fen6_info;
  struct fib_entry_notifier_info *fen4_info;
  if (info->family == AF_INET) {
...
static bool prestera_fib_node_util_is_neighbour(
...
static int prestera_neigh_iface_init(struct prestera_switch *sw,
...
static struct prestera_kern_neigh_cache *prestera_kern_neigh_cache_find(
...
static void __prestera_kern_neigh_cache_destroy(struct prestera_switch *sw,
    struct prestera_kern_neigh_cache *n_cache) {
...
static struct prestera_kern_neigh_cache *__prestera_kern_neigh_cache_create(
    struct prestera_switch *sw,
    struct prestera_kern_neigh_cache_key *key) {
  struct prestera_kern_neigh_cache *n_cache;
  int err;
...
static struct prestera_kern_neigh_cache *prestera_kern_neigh_cache_get(
    struct prestera_switch *sw,
    struct prestera_kern_neigh_cache_key *key) {
  struct prestera_kern_neigh_cache *n_cache;
...
static struct prestera_kern_neigh_cache *prestera_kern_neigh_cache_put(
    struct prestera_switch *sw,
    struct prestera_kern_neigh_cache *n_cache) {
...
static struct prestera_kern_fib_cache *prestera_kern_fib_cache_find(
    struct prestera_switch *sw,
    struct prestera_kern_fib_cache_key *key) {
...
static void prestera_kern_fib_cache_destroy(struct prestera_switch *sw,
    struct prestera_kern_fib_cache *fib_cache) {
...
static int __prestera_kern_fib_cache_create_nhs(struct prestera_switch *sw,
 ...
 */
static struct prestera_kern_fib_cache *prestera_kern_fib_cache_create(
    struct prestera_switch *sw,
    struct prestera_kern_fib_cache_key *key,
...
static void __prestera_k_arb_fib_nh_offload_set(struct prestera_switch *sw,
...
static void __prestera_k_arb_n_offload_set(struct prestera_switch *sw,
    struct prestera_kern_neigh_cache *nc,
    bool offloaded) {
  struct neighbour *n;
...
static void __prestera_k_arb_fib_lpm_offload_set(struct prestera_switch *sw,
    struct prestera_kern_fib_cache *fc,
...
static void __prestera_k_arb_nc_kern_fib_fetch(struct prestera_switch *sw,
    struct prestera_kern_neigh_cache *nc) {
...
static void __prestera_k_arb_nc_kern_n_fetch(struct prestera_switch *sw,
    struct prestera_kern_neigh_cache *nc) {
  struct neighbour *n;
  int err;
...
static void __prestera_k_arb_nc_apply(struct prestera_switch *sw,
    struct prestera_kern_neigh_cache *nc) {
...
static int __prestera_pr_k_arb_fc_lpm_info_calc(struct prestera_switch *sw,
    struct prestera_kern_fib_cache *fc) {
  struct fib_nh_common *nhc;
  int nh_cnt;
...
static struct prestera_kern_fib_cache *__prestera_k_arb_util_fib_overlaps(
    struct prestera_switch *sw,
    struct prestera_kern_fib_cache *fc) {
  struct prestera_kern_fib_cache_key fc_key;
...
static struct prestera_kern_fib_cache *__prestera_k_arb_util_fib_overlapped(
    struct prestera_switch *sw,
    struct prestera_kern_fib_cache *fc) {
  struct prestera_kern_fib_cache_key fc_key;
  struct prestera_kern_fib_cache *rfc;
