...
static bool prestera_counter_is_ready(struct prestera_counter_block *block,
    u32 id) {
...
static struct prestera_counter_block *prestera_counter_block_lookup_not_full(
...
static struct prestera_counter_block *prestera_counter_block_get(
    struct prestera_counter *counter, u32 client) {
  struct prestera_counter_block *block;
  int err;
...
static struct prestera_counter_block *prestera_counter_block_get_by_idx(
    struct prestera_counter *counter, u32 idx) {
