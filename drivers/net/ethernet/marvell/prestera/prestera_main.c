...
void prestera_queue_delayed_work(struct delayed_work *work,
    unsigned long delay) {
...
static void prestera_port_mac_state_cache_read(struct prestera_port *port,
...
static void prestera_port_mac_state_cache_write(struct prestera_port *port,
    struct prestera_port_mac_state *state) {
  spin_lock(&port->state_mac_lock);
...
static struct phylink_pcs *prestera_mac_select_pcs(
...
static void prestera_pcs_an_restart(struct phylink_pcs *pcs) {
   ...
   * (Currently FW has no support for 1000baseX AN restart, but it will in the
   * future,
...
struct prestera_mdb_entry *prestera_mdb_entry_create(struct prestera_switch *sw,
...
struct prestera_flood_domain *prestera_flood_domain_create(
...
void prestera_flood_domain_port_destroy(struct prestera_flood_domain_port *port)
{
...
struct prestera_flood_domain_port *prestera_flood_domain_port_find(
    struct prestera_flood_domain *flood_domain,
