...
static struct prestera_flow_block *prestera_flow_block_create(
...
static bool prestera_flow_block_is_bound(
    const struct prestera_flow_block *block) {
  return block->ruleset_zero;
}

static struct prestera_flow_block_binding *prestera_flow_block_lookup(
    struct prestera_flow_block *block,
...
static struct prestera_flow_block *prestera_flow_block_get(
    struct prestera_switch *sw,
