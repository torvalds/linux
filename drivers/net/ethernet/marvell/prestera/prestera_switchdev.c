...
static struct prestera_bridge *prestera_bridge_find(
...
static struct prestera_bridge_port *__prestera_bridge_port_find(
    const struct prestera_bridge *bridge,
...
static struct prestera_bridge_port *prestera_bridge_port_find(
    struct prestera_switch *sw,
...
static void prestera_br_port_flags_reset(struct prestera_bridge_port *br_port,
    struct prestera_port *port) {
...
static struct prestera_bridge_vlan *prestera_bridge_vlan_create(
...
static struct prestera_bridge_vlan *prestera_bridge_vlan_by_vid(
    struct prestera_bridge_port *br_port, u16 vid) {
  struct prestera_bridge_vlan *br_vlan;
...
static struct prestera_port_vlan *prestera_port_vlan_by_vid(
    struct prestera_port *port, u16 vid) {
...
static struct prestera_port_vlan *prestera_port_vlan_create(
    struct prestera_port *port, u16 vid, bool untagged) {
  struct prestera_port_vlan *port_vlan;
  int err;
...
static void prestera_mdb_port_del(struct prestera_mdb_entry *mdb,
...
static void prestera_br_mdb_entry_put(struct prestera_br_mdb_entry *br_mdb) {
  struct prestera_bridge_port *br_port;
...
static void prestera_br_mdb_port_del(struct prestera_br_mdb_entry *br_mdb,
    struct prestera_bridge_port *br_port) {
...
static void prestera_mdb_flush_bridge_port(struct prestera_bridge_port *br_port)
{
...
static void prestera_port_vlan_bridge_leave(
    struct prestera_port_vlan *port_vlan) {
...
static struct prestera_bridge *prestera_bridge_create(
    struct prestera_switchdev *swdev, struct net_device *dev) {
...
static struct prestera_bridge_port *__prestera_bridge_port_by_dev(
    struct prestera_bridge *bridge,
    struct net_device *dev) {
  struct prestera_bridge_port *br_port;
  list_for_each_entry(br_port, &bridge->port_list, head) {
...
static struct prestera_bridge_port *prestera_bridge_port_by_dev(
    struct prestera_switchdev *swdev,
    struct net_device *dev) {
...
static struct prestera_bridge_port *prestera_bridge_port_create(
    struct prestera_bridge *bridge,
    struct net_device *dev) {
  struct prestera_bridge_port *br_port;
...
static void prestera_bridge_port_destroy(struct prestera_bridge_port *br_port) {
...
static struct prestera_bridge_port *prestera_bridge_port_add(
    struct prestera_bridge *bridge, struct net_device *dev) {
  struct prestera_bridge_port *br_port;
...
static int prestera_bridge_1d_port_join(struct prestera_bridge_port *br_port) {
...
static int prestera_br_port_lag_mdb_mc_enable_sync(
    struct prestera_bridge_port *br_port,
    bool enabled) {
...
static bool prestera_br_mdb_port_is_member(struct prestera_br_mdb_entry *br_mdb,
    struct net_device *orig_dev) {
...
static int prestera_mdb_port_add(struct prestera_mdb_entry *mdb,
    struct net_device *orig_dev,
...
static int prestera_mdb_enable_set(struct prestera_br_mdb_entry *br_mdb,
    bool enable) {
  int err;
...
static int prestera_br_mdb_enable_set(struct prestera_bridge *br_dev,
    bool enable) {
  struct prestera_br_mdb_entry *br_mdb;
  int err;
  list_for_each_entry(br_mdb, &br_dev->br_mdb_entry_list,
...
static bool prestera_bridge_mdb_mc_mrouter_exists(
    struct prestera_bridge *br_dev) {
  struct prestera_bridge_port *br_port;
  list_for_each_entry(br_port, &br_dev->port_list, head)
  if (br_port->mrouter) {
...
static int prestera_port_attr_mrouter_set(struct prestera_port *port,
    struct net_device *orig_dev,
...
static void prestera_fdb_offload_notify(struct prestera_port *port,
...
static int prestera_port_vlan_bridge_join(struct prestera_port_vlan *port_vlan,
    struct prestera_bridge_port *br_port) {
  struct prestera_port *port = port_vlan->port;
  struct prestera_bridge_vlan *br_vlan;
  u16 vid = port_vlan->vid;
...
static int prestera_bridge_port_vlan_add(struct prestera_port *port,
    struct prestera_bridge_port *br_port,
...
static void prestera_bridge_port_vlan_del(struct prestera_port *port,
    struct prestera_bridge_port *br_port, u16 vid) {
...
static struct prestera_br_mdb_entry *prestera_br_mdb_entry_create(
    struct prestera_switch *sw,
    struct prestera_bridge *br_dev,
...
static struct prestera_br_mdb_entry *prestera_br_mdb_entry_find(
    struct prestera_bridge *br_dev,
    const unsigned char *addr, u16 vid) {
  struct prestera_br_mdb_entry *br_mdb;
  list_for_each_entry(br_mdb, &br_dev->br_mdb_entry_list,
...
static struct prestera_br_mdb_entry *prestera_br_mdb_entry_get(
    struct prestera_switch *sw,
    struct prestera_bridge *br_dev,
    const unsigned char *addr, u16 vid) {
  struct prestera_br_mdb_entry *br_mdb;
...
static int prestera_mdb_port_addr_obj_add(
...
static int prestera_mdb_port_addr_obj_del(struct prestera_port *port,
    const struct switchdev_obj_port_mdb *mdb) {
  struct prestera_br_mdb_entry *br_mdb;
  struct prestera_bridge_port *br_port;
  struct prestera_bridge *br_dev;
