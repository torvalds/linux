 ...
 * Bit 0 : read_cycle => 1:perform single read cycle, 0:yes-op
 * Bit 1 : scan_cycle => 1:perform continuous read cycles, 0:yes-op
 */
 ...
 * Bit 2 : yestvalid => :mgmt result data yest yet valid, 0:idle
 */
#define netxen_get_gb_mii_mgmt_busy(config_word)	\
		_netxen_crb_get_bit(config_word, 0)
#define netxen_get_gb_mii_mgmt_scanning(config_word)	\
		_netxen_crb_get_bit(config_word, 1)
#define netxen_get_gb_mii_mgmt_yestvalid(config_word)	\
 ...
 * Bit 4 : soft_reset => 1:reset the MAC , 0:yes-op
