...
static int qede_get_rss_flags(struct qede_dev *edev,
...
static int qede_set_rss_flags(struct qede_dev *edev,
    struct ethtool_rxnfc *info) {
...
static int qede_selftest_run_loopback(struct qede_dev *edev,
    u32 loopback_mode) {
  struct qed_link_params link_params;
