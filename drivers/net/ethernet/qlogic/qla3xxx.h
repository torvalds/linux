...
enum {
  QL_RESET_DONE = 1, /* Reset finished. */
...
struct ql3_adapter {
  ...
  /* 4022 specific */
  u32 mac_index;    /* Driver's MAC number can be 0 or 1 for first and second
                     * networking functions respectively */
