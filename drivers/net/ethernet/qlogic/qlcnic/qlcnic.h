...
static inline void qlcnic_process_rcv_ring_diag(
...
static inline int qlcnic_config_rss(struct qlcnic_adapter *adapter,
    int enable) {
...
static inline int qlcnic_clear_lb_mode(struct qlcnic_adapter *adapter,
    u8 mode) {
...
static inline irqreturn_t qlcnic_clear_legacy_intr(
    struct qlcnic_adapter *adapter) {
...
static inline void qlcnic_82xx_enable_tx_intr(struct qlcnic_adapter *adapter,
    struct qlcnic_host_tx_ring *tx_ring) {
...
static inline void qlcnic_82xx_disable_tx_intr(struct qlcnic_adapter *adapter,
    struct qlcnic_host_tx_ring *tx_ring) {
  if (qlcnic_check_multi_tx(adapter)
      && !adapter->ahw->diag_test) {
...
static inline void qlcnic_83xx_enable_sds_intr(struct qlcnic_adapter *adapter,
    struct qlcnic_host_sds_ring *sds_ring) {
  writel(0, sds_ring->crb_intr_mask);
}

/* Disable MSI-x and INT-x interrupts */
static inline void qlcnic_83xx_disable_sds_intr(struct qlcnic_adapter *adapter,
    struct qlcnic_host_sds_ring *sds_ring) {
 ...
 */
static inline void qlcnic_82xx_disable_sds_intr(struct qlcnic_adapter *adapter,
    struct qlcnic_host_sds_ring *sds_ring) {
  if (qlcnic_check_multi_tx(adapter)
      && !adapter->ahw->diag_test
...
static inline void qlcnic_disable_sds_intr(struct qlcnic_adapter *adapter,
    struct qlcnic_host_sds_ring *sds_ring) {
 ...
 */
static inline void qlcnic_82xx_enable_sds_intr(struct qlcnic_adapter *adapter,
    struct qlcnic_host_sds_ring *sds_ring) {
  if (qlcnic_check_multi_tx(adapter)
      && !adapter->ahw->diag_test
      && (adapter->flags & QLCNIC_MSIX_ENABLED)) {
