...
static int qlcnic_sriov_alloc_bc_mbx_args(struct qlcnic_cmd_args *mbx,
    u32 type) {
...
static int qlcnic_sriov_channel_cfg_cmd(struct qlcnic_adapter *adapter,
    u8 cmd_op) {
  struct qlcnic_cmd_args cmd;
...
static struct qlcnic_async_cmd *qlcnic_sriov_alloc_async_cmd(
    struct qlcnic_back_channel *bc,
    struct qlcnic_cmd_args *cmd) {
...
static int qlcnic_sriov_vf_idc_need_quiescent_state(
