...
static inline void qlcnic_83xx_clear_legacy_intr_mask(
    struct qlcnic_adapter *adapter) {
  writel(0, adapter->tgt_mask_reg);
}

static inline void qlcnic_83xx_set_legacy_intr_mask(
    struct qlcnic_adapter *adapter) {
...
static inline void qlcnic_83xx_notify_cmd_completion(
    struct qlcnic_adapter *adapter,
    struct qlcnic_cmd_args *cmd) {
