...
static struct qlcnic_rx_buffer *qlcnic_process_rcv(
    struct qlcnic_adapter *adapter,
...
static struct qlcnic_rx_buffer *qlcnic_process_lro(
    struct qlcnic_adapter *adapter,
...
static struct qlcnic_rx_buffer *qlcnic_83xx_process_rcv(
    struct qlcnic_adapter *adapter,
    struct qlcnic_host_sds_ring *sds_ring,
...
static struct qlcnic_rx_buffer *qlcnic_83xx_process_lro(
    struct qlcnic_adapter *adapter,
    u8 ring, u64 sts_data[]) {
  struct net_device *netdev = adapter->netdev;
  struct qlcnic_recv_context *recv_ctx = adapter->recv_ctx;
...
static int qlcnic_83xx_msix_sriov_vf_poll(struct napi_struct *napi,
    int budget) {
  int tx_complete;
  int work_done;
  struct qlcnic_host_sds_ring *sds_ring;
