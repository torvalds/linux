...
static int qed_mfw_get_gen_tlv_value(struct qed_drv_tlv_hdr *p_tlv,
...
static int qed_mfw_get_eth_tlv_value(struct qed_drv_tlv_hdr *p_tlv,
...
static int qed_mfw_get_tlv_time_value(struct qed_mfw_tlv_time *p_time,
    struct qed_tlv_parsed_buf *p_buf) {
  if (!p_time->b_set) {
    return -1;
  }
...
static int qed_mfw_get_fcoe_tlv_value(struct qed_drv_tlv_hdr *p_tlv,
...
static int qed_mfw_get_iscsi_tlv_value(struct qed_drv_tlv_hdr *p_tlv,
