...
static int qed_ll2_handle_slowpath(struct qed_hwfn *p_hwfn,
    struct qed_ll2_info *p_ll2_conn,
    union core_rx_cqe_union *p_cqe,
...
static int qed_ll2_rxq_handle_completion(struct qed_hwfn *p_hwfn,
    struct qed_ll2_info *p_ll2_conn,
    union core_rx_cqe_union *p_cqe,
...
static bool qed_ll2_lb_rxq_handler_slowpath(struct qed_hwfn *p_hwfn,
...
static void qed_ooo_submit_tx_buffers(struct qed_hwfn *p_hwfn,
    struct qed_ll2_info *p_ll2_conn) {
...
static void qed_ooo_submit_rx_buffers(struct qed_hwfn *p_hwfn,
    struct qed_ll2_info *p_ll2_conn) {
  struct qed_ooo_buffer *p_buffer;
  int rc;
...
static int qed_ll2_acquire_connection_rx(struct qed_hwfn *p_hwfn,
...
static int qed_ll2_acquire_connection_ooo(struct qed_hwfn *p_hwfn,
...
static int qed_ll2_set_cbs(struct qed_ll2_info *p_ll2_info,
...
static enum core_error_handle qed_ll2_get_error_choice(
    enum qed_ll2_error_handle err) {
  switch (err) {
...
static void qed_ll2_establish_connection_ooo(struct qed_hwfn *p_hwfn,
    struct qed_ll2_info *p_ll2_conn) {
  if (p_ll2_conn->input.conn_type != QED_LL2_TYPE_OOO) {
    return;
  }
...
static void qed_ll2_post_rx_buffer_notify_fw(struct qed_hwfn *p_hwfn,
  ...
  struct core_ll2_rx_prod rx_prod = {
    0, 0
  };
