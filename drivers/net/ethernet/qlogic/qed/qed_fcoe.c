...
static int qed_sp_fcoe_func_start(struct qed_hwfn *p_hwfn,
...
static int qed_sp_fcoe_conn_offload(struct qed_hwfn *p_hwfn,
...
static int qed_sp_fcoe_conn_destroy(struct qed_hwfn *p_hwfn,
    struct qed_fcoe_conn *p_conn,
    enum spq_mode comp_mode,
    struct qed_spq_comp_cb *p_comp_addr) {
...
static int qed_sp_fcoe_func_stop(struct qed_hwfn *p_hwfn,
...
static int qed_fcoe_allocate_connection(struct qed_hwfn *p_hwfn,
...
static int qed_fcoe_acquire_connection(struct qed_hwfn *p_hwfn,
