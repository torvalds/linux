 ...
 * for their VFs.
 */
static struct qed_queue_cid *_qed_eth_queue_to_cid(struct qed_hwfn *p_hwfn,
    u16 opaque_fid,
    u32 cid,
...
static struct qed_queue_cid *qed_eth_queue_to_cid_pf(struct qed_hwfn *p_hwfn,
    u16 opaque_fid,
    bool b_is_rx,
    struct qed_queue_start_common_params *p_params) {
...
static int qed_sp_vport_update_rss(struct qed_hwfn *p_hwfn,
...
static void qed_sp_update_accept_mode(struct qed_hwfn *p_hwfn,
    struct vport_update_ramrod_data *p_ramrod,
...
static void qed_sp_vport_update_sge_tpa(struct qed_hwfn *p_hwfn,
    struct vport_update_ramrod_data *p_ramrod,
...
static void qed_sp_update_mcast_bin(struct qed_hwfn *p_hwfn,
    struct vport_update_ramrod_data *p_ramrod,
...
static int qed_vf_pf_accept_flags(struct qed_hwfn *p_hwfn,
...
static int qed_eth_pf_rx_queue_start(struct qed_hwfn *p_hwfn,
    struct qed_queue_cid *p_cid,
    u16 bd_max_bytes,
    dma_addr_t bd_chain_phys_addr,
...
static int qed_eth_rx_queue_start(struct qed_hwfn *p_hwfn,
    u16 opaque_fid,
    struct qed_queue_start_common_params *p_params,
    u16 bd_max_bytes,
    dma_addr_t bd_chain_phys_addr,
...
static int qed_eth_pf_rx_queue_stop(struct qed_hwfn *p_hwfn,
    struct qed_queue_cid *p_cid,
...
int qed_eth_txq_start_ramrod(struct qed_hwfn *p_hwfn,
    struct qed_queue_cid *p_cid,
...
static int qed_eth_pf_tx_queue_start(struct qed_hwfn *p_hwfn,
    struct qed_queue_cid *p_cid,
    u8 tc,
    dma_addr_t pbl_addr,
...
static int qed_eth_tx_queue_start(struct qed_hwfn *p_hwfn,
    u16 opaque_fid,
    struct qed_queue_start_common_params *p_params,
    u8 tc,
    dma_addr_t pbl_addr,
...
static int qed_eth_pf_tx_queue_stop(struct qed_hwfn *p_hwfn,
    struct qed_queue_cid *p_cid) {
  struct qed_spq_entry *p_ent = NULL;
  struct qed_sp_init_data init_data;
  int rc;
...
static int qed_filter_ucast_common(struct qed_hwfn *p_hwfn,
    u16 opaque_fid,
...
static int qed_sp_eth_filter_mcast(struct qed_hwfn *p_hwfn,
    u16 opaque_fid,
...
static noinline_for_stack void __qed_get_vport_pstats(struct qed_hwfn *p_hwfn,
...
static noinline_for_stack void __qed_get_vport_tstats(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt,
    struct qed_eth_stats *p_stats, u16 statistics_bin) {
...
static noinline_for_stack void __qed_get_vport_mstats(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt,
    struct qed_eth_stats *p_stats, u16 statistics_bin) {
...
static noinline_for_stack void __qed_get_vport_port_stats(
...
static enum gft_profile_type qed_arfs_mode_to_hsi(
...
int qed_configure_rfs_ntuple_filter(struct qed_hwfn *p_hwfn,
...
static void qed_arfs_sp_response_handler(struct qed_hwfn *p_hwfn,
    void *cookie,
...
static int qed_ntuple_arfs_filter_config(struct qed_dev *cdev,
    void *cookie,
