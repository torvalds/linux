...
static struct qed_queue_cid *qed_iov_get_vf_rx_queue_cid(
...
static int qed_iov_enable_vf_access_msix(struct qed_hwfn *p_hwfn,
...
static void qed_iov_vf_mbx_acquire_resc_cids(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt,
    struct qed_vf_info *p_vf,
...
static int qed_iov_reconfigure_unicast_shadow(struct qed_hwfn *p_hwfn,
...
static void qed_iov_pf_update_tun_response(
...
static void __qed_iov_pf_update_tun_param(
...
static void qed_iov_pf_update_tun_param(
    struct vfpf_update_tunn_param_tlv *p_req,
    struct qed_tunn_update_type *p_tun,
...
static bool qed_iov_pf_validate_tunn_param(
    struct vfpf_update_tunn_param_tlv *p_req) {
...
static int qed_pf_validate_modify_tunn_config(struct qed_hwfn *p_hwfn,
...
static void qed_iov_vp_update_act_param(struct qed_hwfn *p_hwfn,
...
static void qed_iov_vp_update_vlan_param(struct qed_hwfn *p_hwfn,
    struct qed_sp_vport_update_params *p_data,
    struct qed_vf_info *p_vf,
    struct qed_iov_vf_mbx *p_mbx, u16 *tlvs_mask) {
...
static void qed_iov_vp_update_tx_switch(struct qed_hwfn *p_hwfn,
    struct qed_sp_vport_update_params *p_data,
    struct qed_iov_vf_mbx *p_mbx, u16 *tlvs_mask) {
...
static void qed_iov_vp_update_mcast_bin_param(struct qed_hwfn *p_hwfn,
    struct qed_sp_vport_update_params *p_data,
    struct qed_iov_vf_mbx *p_mbx, u16 *tlvs_mask) {
...
static void qed_iov_vp_update_accept_flag(struct qed_hwfn *p_hwfn,
    struct qed_sp_vport_update_params *p_data,
    struct qed_iov_vf_mbx *p_mbx, u16 *tlvs_mask) {
...
static void qed_iov_vp_update_accept_any_vlan(struct qed_hwfn *p_hwfn,
    struct qed_sp_vport_update_params *p_data,
    struct qed_iov_vf_mbx *p_mbx, u16 *tlvs_mask) {
...
static void qed_iov_vp_update_rss_param(struct qed_hwfn *p_hwfn,
    struct qed_vf_info *vf,
    struct qed_sp_vport_update_params *p_data,
...
static void qed_iov_vp_update_sge_tpa_param(struct qed_hwfn *p_hwfn,
    struct qed_vf_info *vf,
    struct qed_sp_vport_update_params *p_data,
...
static int qed_iov_vf_flr_poll_dorq(struct qed_hwfn *p_hwfn,
...
static int qed_iov_vf_flr_poll_pbf(struct qed_hwfn *p_hwfn,
    struct qed_vf_info *p_vf, struct qed_ptt *p_ptt) {
...
static int qed_iov_execute_vf_flr_cleanup(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt,
...
static int qed_iov_vf_flr_cleanup(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt) {
...
static int qed_iov_vf_pf_bulletin_update_mac(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt,
    struct qed_vf_info *p_vf) {
...
static int qed_iov_bulletin_set_mac(struct qed_hwfn *p_hwfn, u8 *mac,
    int vfid) {
  struct qed_vf_info *vf_info;
  u64 feature;
  vf_info = qed_iov_get_vf_info(p_hwfn, (u16) vfid, true);
...
static int qed_iov_configure_min_tx_rate(struct qed_dev *cdev, int vfid,
    u32 rate) {
  struct qed_vf_info *vf;
  u8 vport_id;
  int i;
