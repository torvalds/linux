...
static void qed_dcbx_dp_protocol(struct qed_hwfn *p_hwfn,
...
static void qed_dcbx_set_params(struct qed_dcbx_results *p_data,
...
static void qed_dcbx_update_app_info(struct qed_dcbx_results *p_data,
    struct qed_hwfn *p_hwfn, struct qed_ptt *p_ptt,
    bool app_tlv, bool enable, u8 prio, u8 tc,
    enum dcbx_protocol_type type) {
  enum qed_pci_personality personality;
...
static bool qed_dcbx_get_app_protocol_type(struct qed_hwfn *p_hwfn,
    u32 app_prio_bitmap,
 ...
 */
static int qed_dcbx_process_tlv(struct qed_hwfn *p_hwfn, struct qed_ptt *p_ptt,
    struct qed_dcbx_results *p_data,
...
static int qed_dcbx_copy_mib(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt,
...
static void qed_dcbx_get_priority_info(struct qed_hwfn *p_hwfn,
...
static void qed_dcbx_get_app_data(struct qed_hwfn *p_hwfn,
    struct dcbx_app_priority_feature *p_app,
    struct dcbx_app_priority_entry *p_tbl,
...
static void qed_dcbx_get_pfc_data(struct qed_hwfn *p_hwfn,
...
static void qed_dcbx_get_ets_data(struct qed_hwfn *p_hwfn,
    struct dcbx_ets_feature *p_ets,
...
static void qed_dcbx_get_common_params(struct qed_hwfn *p_hwfn,
    struct dcbx_app_priority_feature *p_app,
    struct dcbx_app_priority_entry *p_tbl,
    struct dcbx_ets_feature *p_ets,
...
static void qed_dcbx_get_local_params(struct qed_hwfn *p_hwfn,
...
static void qed_dcbx_get_remote_params(struct qed_hwfn *p_hwfn,
    struct qed_dcbx_get *params) {
  struct dcbx_features *p_feat;
...
static void qed_dcbx_get_operational_params(struct qed_hwfn *p_hwfn,
    struct qed_dcbx_get *params) {
...
static int qed_dcbx_get_params(struct qed_hwfn *p_hwfn,
...
static int qed_dcbx_read_local_lldp_mib(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt) {
...
static int qed_dcbx_read_remote_lldp_mib(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt,
    enum qed_mib_read_type type) {
  struct qed_dcbx_mib_meta_data data;
  int rc = 0;
...
static int qed_dcbx_read_operational_mib(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt,
    enum qed_mib_read_type type) {
  struct qed_dcbx_mib_meta_data data;
  int rc = 0;
...
static int qed_dcbx_read_remote_mib(struct qed_hwfn *p_hwfn,
...
static int qed_dcbx_read_local_mib(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt) {
  struct qed_dcbx_mib_meta_data data;
  memset(&data, 0, sizeof(data));
  data.addr = p_hwfn->mcp_info->port_addr
 ...
 * change is detected.
 */
int qed_dcbx_mib_update_event(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt, enum qed_mib_read_type type) {
  int rc = 0;
...
static void qed_dcbx_set_pfc_data(struct qed_hwfn *p_hwfn,
    u32 *pfc, struct qed_dcbx_params *p_params) {
  u8 pfc_map = 0;
  int i;
...
static void qed_dcbx_set_ets_data(struct qed_hwfn *p_hwfn,
    struct dcbx_ets_feature *p_ets,
    struct qed_dcbx_params *p_params) {
  __be32 bw_map[2], tsa_map[2];
  u32 val;
...
static void qed_dcbx_set_app_data(struct qed_hwfn *p_hwfn,
    struct dcbx_app_priority_feature *p_app,
    struct qed_dcbx_params *p_params, bool ieee) {
  u32 *entry;
  int i;
...
static void qed_dcbx_set_local_params(struct qed_hwfn *p_hwfn,
...
static void qed_dcbnl_getpgbwgcfgtx(struct qed_dev *cdev, int pgid,
    u8 *bw_pct) {
  struct qed_hwfn *hwfn = QED_LEADING_HWFN(cdev);
  struct qed_dcbx_get *dcbx_info;
  *bw_pct = 0;
...
static void qed_dcbnl_setpfccfg(struct qed_dev *cdev, int priority,
    u8 setting) {
  struct qed_hwfn *hwfn = QED_LEADING_HWFN(cdev);
  struct qed_dcbx_set dcbx_set;
  struct qed_ptt *ptt;
