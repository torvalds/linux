...
static int qed_llh_shadow_search_filter(struct qed_dev *cdev,
    u8 ppfid,
...
static int qed_llh_shadow_get_free_idx(struct qed_dev *cdev, u8 ppfid,
    u8 *p_filter_idx) {
  struct qed_llh_info *p_llh_info = cdev->p_llh_info;
  struct qed_llh_filter_info *p_filters;
  int rc;
...
static int __qed_llh_shadow_add_filter(struct qed_dev *cdev,
    u8 ppfid,
    u8 filter_idx,
    enum qed_llh_filter_type type,
...
static int qed_llh_shadow_add_filter(struct qed_dev *cdev,
    u8 ppfid,
    enum qed_llh_filter_type type,
...
static int __qed_llh_shadow_remove_filter(struct qed_dev *cdev,
...
static int qed_llh_shadow_remove_filter(struct qed_dev *cdev,
    u8 ppfid,
    union qed_llh_filter *p_filter,
    u8 *p_filter_idx, u32 *p_ref_cnt) {
  int rc;
...
static int qed_llh_set_engine_affin(struct qed_hwfn *p_hwfn,
...
int qed_llh_set_ppfid_affinity(struct qed_dev *cdev, u8 ppfid,
    enum qed_eng eng) {
...
static int qed_llh_access_filter(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt,
    u8 abs_ppfid,
    u8 filter_idx,
...
static int qed_llh_add_filter(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt,
    u8 abs_ppfid,
...
static int qed_llh_remove_filter(struct qed_hwfn *p_hwfn,
...
static int qed_llh_protocol_filter_stringify(struct qed_dev *cdev,
    enum qed_llh_prot_filter_type_t type,
    u16 source_port_or_eth_type,
...
static int qed_llh_protocol_filter_to_hilo(struct qed_dev *cdev,
    enum qed_llh_prot_filter_type_t type,
    u16 source_port_or_eth_type,
...
static int qed_hw_init_dpi_size(struct qed_hwfn *p_hwfn,
...
static int qed_hw_init_pf_doorbell_bar(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt) {
...
static void qed_fill_load_req_params(struct qed_load_req_params *p_load_req,
...
static void qed_pglueb_clear_err(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt) {
...
static int __qed_hw_set_soft_resc_size(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt,
...
static int qed_hw_set_soft_resc_size(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt) {
...
static void qed_hw_info_port_num(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt) {
...
static int qed_get_hw_info(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt,
