...
static void __qed_vf_prep_tunn_req_tlv(struct vfpf_update_tunn_param_tlv *p_req,
...
static void qed_vf_prep_tunn_req_tlv(struct vfpf_update_tunn_param_tlv *p_req,
    struct qed_tunn_update_type *p_src,
...
static void __qed_vf_update_tunn_param(struct qed_tunn_update_type *p_tun,
...
static bool qed_vf_handle_vp_update_is_needed(struct qed_hwfn *p_hwfn,
...
static void qed_vf_handle_vp_update_tlvs_resp(struct qed_hwfn *p_hwfn,
    struct qed_sp_vport_update_params *p_data) {
  struct qed_vf_iov *p_iov = p_hwfn->vf_iov_info;
...
int qed_vf_pf_bulletin_update_mac(struct qed_hwfn *p_hwfn,
    const u8 *p_mac) {
  struct qed_vf_iov *p_iov = p_hwfn->vf_iov_info;
...
static void qed_vf_bulletin_get_udp_ports(struct qed_hwfn *p_hwfn,
