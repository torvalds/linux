...
/* Must be called while cmd_lock is acquired */
static int qed_mcp_update_pending_cmd(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt) {
  struct qed_mcp_mb_params *p_mb_params;
  struct qed_mcp_cmd_elem *p_cmd_elem;
  u32 mcp_resp;
...
static int _qed_mcp_cmd_and_union(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt,
    struct qed_mcp_mb_params *p_mb_params,
...
static bool qed_mcp_can_force_load(u8 drv_role,
    u8 exist_drv_role,
...
static int __qed_mcp_load_req(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt,
...
int qed_mcp_set_link(struct qed_hwfn *p_hwfn, struct qed_ptt *p_ptt,
    bool b_up) {
...
static void qed_mcp_update_stag(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt) {
  struct public_func shmem_info;
  u32 resp = 0, param = 0;
  qed_mcp_get_shmem_func(p_hwfn, p_ptt, &shmem_info, MCP_PF_ID(p_hwfn));
...
static int qed_mcp_mdump_cmd(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt,
...
static int qed_mcp_handle_ufp_event(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt) {
...
static void qed_mcp_get_shmem_proto_legacy(struct qed_hwfn *p_hwfn,
...
static int qed_mcp_get_shmem_proto_mfw(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt,
    enum qed_pci_personality *p_proto) {
  u32 resp = 0, param = 0;
  int rc;
...
static int qed_mcp_get_shmem_proto(struct qed_hwfn *p_hwfn,
...
static int qed_mcp_config_vf_msix_bb(struct qed_hwfn *p_hwfn,
...
static int qed_mcp_config_vf_msix_ah(struct qed_hwfn *p_hwfn,
...
static int qed_mcp_resc_allocation_msg(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt,
...
static int __qed_mcp_resc_lock(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt,
...
static int __qed_mcp_send_debug_data(struct qed_hwfn *p_hwfn,
...
static int qed_mcp_send_debug_data(struct qed_hwfn *p_hwfn,
    struct qed_ptt *p_ptt,
...
int qed_mcp_get_esl_status(struct qed_hwfn *p_hwfn, struct qed_ptt *p_ptt,
  ...
  u32 resp = 0, param = 0;
  int rc;
  rc = qed_mcp_cmd(p_hwfn, p_ptt, DRV_MSG_CODE_GET_MANAGEMENT_STATUS, 0, &resp,
      &param);
  if (rc) {
