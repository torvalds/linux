...
static int qed_iwarp_modify_fw(struct qed_hwfn *p_hwfn,
    struct qed_rdma_qp *qp) {
...
static enum qed_roce_qp_state qed_iwarp2roce_state(
    enum qed_iwarp_qp_state state) {
  switch (state) {
...
int qed_iwarp_modify_qp(struct qed_hwfn *p_hwfn,
    struct qed_rdma_qp *qp,
...
static int qed_iwarp_create_ep(struct qed_hwfn *p_hwfn,
    struct qed_iwarp_ep **ep_out) {
  struct qed_iwarp_ep *ep;
  int rc;
...
static void qed_iwarp_print_tcp_ramrod(struct qed_hwfn *p_hwfn,
...
static int qed_iwarp_tcp_offload(struct qed_hwfn *p_hwfn,
    struct qed_iwarp_ep *ep) {
...
static void qed_iwarp_mpa_received(struct qed_hwfn *p_hwfn,
    struct qed_iwarp_ep *ep) {
  struct qed_iwarp_info *iwarp_info = &p_hwfn->p_rdma_info->iwarp;
...
static int qed_iwarp_mpa_offload(struct qed_hwfn *p_hwfn,
    struct qed_iwarp_ep *ep) {
...
static void qed_iwarp_return_ep(struct qed_hwfn *p_hwfn,
    struct qed_iwarp_ep *ep) {
  ep->state = QED_IWARP_EP_INIT;
  if (ep->qp) {
    ep->qp->ep = NULL;
...
static void qed_iwarp_parse_private_data(struct qed_hwfn *p_hwfn,
    struct qed_iwarp_ep *ep) {
...
static void qed_iwarp_mpa_reply_arrived(struct qed_hwfn *p_hwfn,
    struct qed_iwarp_ep *ep) {
  struct qed_iwarp_cm_event_params params;
  if (ep->connect_mode == TCP_CONNECT_PASSIVE) {
    DP_NOTICE(p_hwfn,
 ...
 */
static void qed_iwarp_mpa_complete(struct qed_hwfn *p_hwfn,
...
static void qed_iwarp_mpa_v2_set_private(struct qed_hwfn *p_hwfn,
 ...
 */
static int qed_iwarp_wait_cid_map_cleared(struct qed_hwfn *p_hwfn,
...
static void qed_iwarp_print_cm_info(struct qed_hwfn *p_hwfn,
...
static int qed_iwarp_ll2_post_rx(struct qed_hwfn *p_hwfn,
...
static bool qed_iwarp_ep_exists(struct qed_hwfn *p_hwfn,
    struct qed_iwarp_cm_info *cm_info) {
  struct qed_iwarp_ep *ep = NULL;
  bool found = false;
...
static struct qed_iwarp_listener *qed_iwarp_get_listener(
    struct qed_hwfn *p_hwfn,
    struct qed_iwarp_cm_info *cm_info) {
  struct qed_iwarp_listener *listener = NULL;
  static const u32 ip_zero[4] = {
    0, 0, 0, 0
  };
  bool found = false;
...
static int qed_iwarp_parse_rx_pkt(struct qed_hwfn *p_hwfn,
    struct qed_iwarp_cm_info *cm_info,
    void *buf,
    u8 *remote_mac_addr,
    u8 *local_mac_addr,
...
static int qed_iwarp_recycle_pkt(struct qed_hwfn *p_hwfn,
    struct qed_iwarp_fpdu *fpdu,
    struct qed_iwarp_ll2_buff *buf);

static enum qed_iwarp_mpa_pkt_type qed_iwarp_mpa_classify(
    struct qed_hwfn *p_hwfn,
    struct qed_iwarp_fpdu *fpdu,
...
static void qed_iwarp_init_fpdu(struct qed_iwarp_ll2_buff *buf,
    struct qed_iwarp_fpdu *fpdu,
...
static int qed_iwarp_cp_pkt(struct qed_hwfn *p_hwfn,
    struct qed_iwarp_fpdu *fpdu,
    struct unaligned_opaque_data *pkt_data,
...
static void qed_iwarp_update_fpdu_length(struct qed_hwfn *p_hwfn,
...
static int qed_iwarp_win_right_edge(struct qed_hwfn *p_hwfn,
    struct qed_iwarp_fpdu *fpdu) {
  struct qed_ll2_tx_pkt_info tx_pkt;
  u8 ll2_handle;
  int rc;
...
static int qed_iwarp_send_fpdu(struct qed_hwfn *p_hwfn,
    struct qed_iwarp_fpdu *fpdu,
...
static void qed_iwarp_mpa_get_data(struct qed_hwfn *p_hwfn,
    struct unaligned_opaque_data *curr_pkt,
 ...
 */
static int qed_iwarp_process_mpa_pkt(struct qed_hwfn *p_hwfn,
...
static void qed_iwarp_ll2_comp_mpa_pkt(void *cxt,
...
static void qed_iwarp_ll2_comp_syn_pkt(void *cxt,
    struct qed_ll2_comp_rx_data *data) {
 ...
 */
static void qed_iwarp_ll2_slowpath(void *cxt,
...
static int qed_iwarp_ll2_alloc_buffers(struct qed_hwfn *p_hwfn,
...
static int qed_iwarp_ll2_start(struct qed_hwfn *p_hwfn,
...
static void qed_iwarp_tcp_connect_unsuccessful(struct qed_hwfn *p_hwfn,
    struct qed_iwarp_ep *ep, u8 fw_return_code) {
  struct qed_iwarp_cm_event_params params;
...
static void qed_iwarp_connect_complete(struct qed_hwfn *p_hwfn,
    struct qed_iwarp_ep *ep, u8 fw_return_code) {
...
static inline bool qed_iwarp_check_ep_ok(struct qed_hwfn *p_hwfn,
    struct qed_iwarp_ep *ep) {
...
int qed_iwarp_create_listen(void *rdma_cxt,
