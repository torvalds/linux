...
static void qed_set_pf_update_tunn_mode(struct qed_tunnel_info *p_tun,
...
static void __qed_set_ramrod_tunnel_param(u8 *p_tunn_cls,
    struct qed_tunn_update_type *tun_type) {
  *p_tunn_cls = tun_type->tun_cls;
}

static void qed_set_ramrod_tunnel_param(u8 *p_tunn_cls,
    struct qed_tunn_update_type *tun_type,
    u8 *p_update_port,
    __le16 *p_port,
...
static void qed_tunn_set_pf_update_params(struct qed_hwfn *p_hwfn,
    struct qed_tunnel_info *p_src,
...
static void qed_tunn_set_pf_start_params(struct qed_hwfn *p_hwfn,
    struct qed_tunnel_info *p_src,
