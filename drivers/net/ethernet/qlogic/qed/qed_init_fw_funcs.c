...
static int qed_tx_pq_map_rt_init(struct qed_hwfn *p_hwfn,
  ...
  u32 tx_pq_vf_mask[MAX_QM_TX_QUEUES / QM_PF_QUEUE_GROUP_SIZE] = {
    0
  };
...
bool qed_send_qm_stop_cmd(struct qed_hwfn *p_hwfn,
  ...
  u32 cmd_arr[QM_CMD_STRUCT_SIZE(QM_STOP_CMD)] = {
    0
  };
...
void qed_gft_disable(struct qed_hwfn *p_hwfn, struct qed_ptt *p_ptt,
    u16 pf_id) {
