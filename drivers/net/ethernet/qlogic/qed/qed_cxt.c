...
static int qed_cxt_t2_alloc_pages(struct qed_hwfn *p_hwfn,
...
static int qed_cid_map_alloc_single(struct qed_hwfn *p_hwfn,
    u32 type,
    u32 cid_start,
 ...
 * will want this feature we'll need to modify the function to be more generic
 */
static int qed_cxt_free_ilt_range(struct qed_hwfn *p_hwfn,
