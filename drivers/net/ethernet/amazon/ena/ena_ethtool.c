...
static void ena_update_tx_rings_nonadaptive_intr_moderation(
...
static void ena_update_rx_rings_nonadaptive_intr_moderation(
    struct ena_adapter *adapter) {
  unsigned int val;
  int i;
...
static int ena_set_rxnfc(struct net_device *netdev,
