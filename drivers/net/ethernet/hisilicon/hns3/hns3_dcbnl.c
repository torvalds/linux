...
static int hns3_dcbnl_ieee_getets(struct net_device *ndev,
    struct ieee_ets *ets) {
...
static int hns3_dcbnl_ieee_setets(struct net_device *ndev,
    struct ieee_ets *ets) {
  struct hnae3_handle *h = hns3_get_handle(ndev);
  if (hns3_nic_resetting(ndev)) {
    return -EBUSY;
...
static int hns3_dcbnl_ieee_getpfc(struct net_device *ndev,
    struct ieee_pfc *pfc) {
  struct hnae3_handle *h = hns3_get_handle(ndev);
  if (hns3_nic_resetting(ndev)) {
    return -EBUSY;
...
static int hns3_dcbnl_ieee_setpfc(struct net_device *ndev,
    struct ieee_pfc *pfc) {
  struct hnae3_handle *h = hns3_get_handle(ndev);
  if (hns3_nic_resetting(ndev)) {
    return -EBUSY;
...
static int hns3_dcbnl_ieee_setapp(struct net_device *ndev,
    struct dcb_app *app) {
  struct hnae3_handle *h = hns3_get_handle(ndev);
  if (hns3_nic_resetting(ndev)) {
    return -EBUSY;
...
static int hns3_dcbnl_ieee_delapp(struct net_device *ndev,
    struct dcb_app *app) {
  struct hnae3_handle *h = hns3_get_handle(ndev);
  if (hns3_nic_resetting(ndev)) {
    return -EBUSY;
