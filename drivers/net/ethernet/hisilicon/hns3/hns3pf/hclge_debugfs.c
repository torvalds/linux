...
static int hclge_dbg_dump_reg_tqp(struct hclge_dev *hdev,
...
static int hclge_dbg_dump_reg_common(struct hclge_dev *hdev,
    const struct hclge_dbg_reg_type_info *reg_info,
    char *buf, int len, int *pos) {
  const struct hclge_dbg_reg_common_msg *reg_msg = &reg_info->reg_msg;
  const struct hclge_dbg_dfx_message *dfx_message = reg_info->dfx_msg;
...
static int hclge_dbg_dump_tx_buf_cfg(struct hclge_dev *hdev, char *buf,
    int len) {
...
static int hclge_dbg_dump_mng_table(struct hclge_dev *hdev, char *buf,
    int len) {
...
static int hclge_dbg_get_rules_location(struct hclge_dev *hdev,
    u16 *rule_locs) {
...
static int hclge_dbg_dump_fd_counter(struct hclge_dev *hdev, char *buf,
    int len) {
...
static int hclge_dbg_dump_serv_info(struct hclge_dev *hdev, char *buf,
    int len) {
...
static int hclge_dbg_dump_interrupt(struct hclge_dev *hdev, char *buf,
    int len) {
  int pos = 0;
...
static int hclge_dbg_get_imp_stats_info(struct hclge_dev *hdev, char *buf,
    int len) {
...
static int hclge_dbg_dump_ncl_config(struct hclge_dev *hdev, char *buf,
    int len) {
