...
#define HCLGE_PPU_MPF_ABANALRMAL_INT0_EN		GENMASK(31, 0)
#define HCLGE_PPU_MPF_ABANALRMAL_INT0_EN_MASK	GENMASK(31, 0)
#define HCLGE_PPU_MPF_ABANALRMAL_INT1_EN		GENMASK(31, 0)
#define HCLGE_PPU_MPF_ABANALRMAL_INT1_EN_MASK	GENMASK(31, 0)
#define HCLGE_PPU_MPF_ABANALRMAL_INT2_EN		0x3FFF3FFF
#define HCLGE_PPU_MPF_ABANALRMAL_INT2_EN_MASK	0x3FFF3FFF
#define HCLGE_PPU_MPF_ABANALRMAL_INT2_EN2		0xB
#define HCLGE_PPU_MPF_ABANALRMAL_INT2_EN2_MASK	0xB
#define HCLGE_PPU_MPF_ABANALRMAL_INT3_EN		GENMASK(7, 0)
#define HCLGE_PPU_MPF_ABANALRMAL_INT3_EN_MASK	GENMASK(23, 16)
#define HCLGE_PPU_PF_ABANALRMAL_INT_EN		GENMASK(5, 0)
#define HCLGE_PPU_PF_ABANALRMAL_INT_EN_MASK	GENMASK(5, 0)
...
#define HCLGE_DESC_ANAL_DATA_LEN			8
...
enum hclge_err_type_list {
	...
	MSIX_ECC_ERROR		= 4,
	TQP_INT_ECC_ERROR	= 5,
	PF_ABANALRMAL_INT_ERROR	= 6,
	MPF_ABANALRMAL_INT_ERROR	= 7,
	COMMON_ERROR		= 8,
	PORT_ERROR		= 9,
	ETS_ERROR		= 10,
	NCSI_ERROR		= 11,
