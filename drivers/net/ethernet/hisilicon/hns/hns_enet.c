...
static void hns_nic_alloc_rx_buffers(struct hns_nic_ring_data *ring_data,
    int cleand_count) {
  int i, ret;
...
static int hns_nic_uc_sync(struct net_device *netdev,
...
static u16 hns_nic_select_queue(struct net_device *ndev, struct sk_buff *skb,
