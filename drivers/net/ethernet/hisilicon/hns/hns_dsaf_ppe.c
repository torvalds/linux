...
static u8 __iomem *hns_ppe_common_get_ioaddr(struct ppe_common_cb *ppe_common) {
 ...
 */
static int hns_ppe_common_get_cfg(struct dsaf_device *dsaf_dev,
    int comm_index) {
...
static void hns_ppe_common_free_cfg(struct dsaf_device *dsaf_dev,
    u32 comm_index) {
