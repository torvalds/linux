...
MODULE_AUTHOR(
    "David S. Miller <davem@redhat.com> and Jeff Garzik <jgarzik@pobox.com>");
...
static int tg3_get_ts_info(struct net_device *dev,
...
static void tg3_get_drvinfo(struct net_device *dev,
...
static void tg3_get_pauseparam(struct net_device *dev,
...
static int tg3_get_rxfh(struct net_device *dev,
