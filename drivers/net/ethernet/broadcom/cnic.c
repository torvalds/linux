...
static char version[]
  = "QLogic " CNIC_MODULE_NAME "Driver v" CNIC_MODULE_VERSION " ("
    CNIC_MODULE_RELDATE ")\n";
...
static void cnic_cm_process_offld_pg(struct cnic_dev *dev,
    struct l4_kcq *kcqe) {
  struct cnic_local *cp = dev->cnic_priv;
...
static void cnic_process_fcoe_term_conn(struct cnic_dev *dev,
    struct kcqe *kcqe) {
  struct cnic_local *cp = dev->cnic_priv;
