...
#define  BGMAC_IRL_FC_SHIFT     24    /* Shift the number of interrupts
                                      * triggered per received frame */
...
static inline void bgmac_umac_write(struct bgmac *bgmac, u16 offset,
    u32 value) {
...
static inline void bgmac_umac_maskset(struct bgmac *bgmac, u16 offset, u32 mask,
    u32 set) {
