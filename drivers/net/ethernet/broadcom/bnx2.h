...
#define BNX2_MISC_DE_VECTOR_SEL			0x000008b0
#define BNX2_MISC_DE_VECTOR_SEL_0			 (0xfffL<<0)
#define BNX2_MISC_DE_VECTOR_SEL_1			 (0xfffL<<12)
#define BNX2_MISC_DE_VECTOR_SEL_1_XI			 (0xfffL<<15)
...
#define BNX2_MISC_OTP_CMD1_DE			 (1L<<31)
...
#define BNX2_DMA_DE_VECT_PEEK			0x00000c2c
#define BNX2_DMA_DE_VECT_PEEK_1_VALUE		 (0x7ffL<<0)
#define BNX2_DMA_DE_VECT_PEEK_1_PEEK_EN		 (1L<<11)
#define BNX2_DMA_DE_VECT_PEEK_1_SEL			 (0xfL<<12)
#define BNX2_DMA_DE_VECT_PEEK_2_VALUE		 (0x7ffL<<16)
#define BNX2_DMA_DE_VECT_PEEK_2_PEEK_EN		 (1L<<27)
#define BNX2_DMA_DE_VECT_PEEK_2_SEL			 (0xfL<<28)
...
#define BNX2_EMAC_RXMAC_DE0				0x0000155c
#define BNX2_EMAC_RXMAC_DE1				0x00001560
#define BNX2_EMAC_RXMAC_DE1_LENGTH_NE_BYTE_COUNT	 (1L<<0)
#define BNX2_EMAC_RXMAC_DE1_LENGTH_OUT_RANGE		 (1L<<1)
#define BNX2_EMAC_RXMAC_DE1_BAD_CRC			 (1L<<2)
#define BNX2_EMAC_RXMAC_DE1_RX_ERROR			 (1L<<3)
#define BNX2_EMAC_RXMAC_DE1_ALIGN_ERROR		 (1L<<4)
#define BNX2_EMAC_RXMAC_DE1_LAST_DATA		 (1L<<5)
#define BNX2_EMAC_RXMAC_DE1_ODD_BYTE_START		 (1L<<6)
#define BNX2_EMAC_RXMAC_DE1_BYTE_COUNT		 (0xffffL<<7)
#define BNX2_EMAC_RXMAC_DE1_SLOT_TIME		 (0xffL<<23)

#define BNX2_EMAC_RXMAC_DE2				0x00001564
#define BNX2_EMAC_RXMAC_DE2_SM_STATE			 (0x7L<<0)
#define BNX2_EMAC_RXMAC_DE2_SM_STATE_IDLE		 (0x0L<<0)
#define BNX2_EMAC_RXMAC_DE2_SM_STATE_SFD		 (0x1L<<0)
#define BNX2_EMAC_RXMAC_DE2_SM_STATE_DATA		 (0x2L<<0)
#define BNX2_EMAC_RXMAC_DE2_SM_STATE_SKEEP		 (0x3L<<0)
#define BNX2_EMAC_RXMAC_DE2_SM_STATE_EXT		 (0x4L<<0)
#define BNX2_EMAC_RXMAC_DE2_SM_STATE_DROP		 (0x5L<<0)
#define BNX2_EMAC_RXMAC_DE2_SM_STATE_SDROP		 (0x6L<<0)
#define BNX2_EMAC_RXMAC_DE2_SM_STATE_FC		 (0x7L<<0)
#define BNX2_EMAC_RXMAC_DE2_IDI_STATE		 (0xfL<<3)
#define BNX2_EMAC_RXMAC_DE2_IDI_STATE_IDLE		 (0x0L<<3)
#define BNX2_EMAC_RXMAC_DE2_IDI_STATE_DATA0		 (0x1L<<3)
#define BNX2_EMAC_RXMAC_DE2_IDI_STATE_DATA1		 (0x2L<<3)
#define BNX2_EMAC_RXMAC_DE2_IDI_STATE_DATA2		 (0x3L<<3)
#define BNX2_EMAC_RXMAC_DE2_IDI_STATE_DATA3		 (0x4L<<3)
#define BNX2_EMAC_RXMAC_DE2_IDI_STATE_ABORT		 (0x5L<<3)
#define BNX2_EMAC_RXMAC_DE2_IDI_STATE_WAIT		 (0x6L<<3)
#define BNX2_EMAC_RXMAC_DE2_IDI_STATE_STATUS		 (0x7L<<3)
#define BNX2_EMAC_RXMAC_DE2_IDI_STATE_LAST		 (0x8L<<3)
#define BNX2_EMAC_RXMAC_DE2_BYTE_IN			 (0xffL<<7)
#define BNX2_EMAC_RXMAC_DE2_FALSEC			 (1L<<15)
#define BNX2_EMAC_RXMAC_DE2_TAGGED			 (1L<<16)
#define BNX2_EMAC_RXMAC_DE2_PAUSE_STATE		 (1L<<18)
#define BNX2_EMAC_RXMAC_DE2_PAUSE_STATE_IDLE		 (0L<<18)
#define BNX2_EMAC_RXMAC_DE2_PAUSE_STATE_PAUSED	 (1L<<18)
#define BNX2_EMAC_RXMAC_DE2_SE_COUNTER		 (0xfL<<19)
#define BNX2_EMAC_RXMAC_DE2_QUANTA			 (0x1fL<<23)

#define BNX2_EMAC_RXMAC_DE3				0x00001568
#define BNX2_EMAC_RXMAC_DE3_PAUSE_CTR		 (0xffffL<<0)
#define BNX2_EMAC_RXMAC_DE3_TMP_PAUSE_CTR		 (0xffffL<<16)

#define BNX2_EMAC_RXMAC_DE4				0x0000156c
#define BNX2_EMAC_RXMAC_DE4_TYPE_FIELD		 (0xffffL<<0)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE		 (0x3fL<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_IDLE		 (0x0L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_UMAC2		 (0x1L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_UMAC3		 (0x2L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_UNI		 (0x3L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_MMAC3		 (0x5L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_PSA1		 (0x6L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_MMAC2		 (0x7L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_PSA2		 (0x7L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_PSA3		 (0x8L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_MC2		 (0x9L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_MC3		 (0xaL<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_MWAIT1	 (0xeL<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_MWAIT2	 (0xfL<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_MCHECK	 (0x10L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_MC		 (0x11L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_BC2		 (0x12L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_BC3		 (0x13L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_BSA1		 (0x14L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_BSA2		 (0x15L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_BSA3		 (0x16L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_BTYPE		 (0x17L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_BC		 (0x18L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_PTYPE		 (0x19L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_CMD		 (0x1aL<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_MAC		 (0x1bL<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_LATCH		 (0x1cL<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_XOFF		 (0x1dL<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_XON		 (0x1eL<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_PAUSED	 (0x1fL<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_NPAUSED	 (0x20L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_TTYPE		 (0x21L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_TVAL		 (0x22L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_USA1		 (0x23L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_USA2		 (0x24L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_USA3		 (0x25L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_UTYPE		 (0x26L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_UTTYPE	 (0x27L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_UTVAL		 (0x28L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_MTYPE		 (0x29L<<16)
#define BNX2_EMAC_RXMAC_DE4_FILT_STATE_DROP		 (0x2aL<<16)
#define BNX2_EMAC_RXMAC_DE4_DROP_PKT			 (1L<<22)
#define BNX2_EMAC_RXMAC_DE4_SLOT_FILLED		 (1L<<23)
#define BNX2_EMAC_RXMAC_DE4_FALSE_CARRIER		 (1L<<24)
#define BNX2_EMAC_RXMAC_DE4_LAST_DATA		 (1L<<25)
#define BNX2_EMAC_RXMAC_DE4_SFD_FOUND		 (1L<<26)
#define BNX2_EMAC_RXMAC_DE4_ADVANCE			 (1L<<27)
#define BNX2_EMAC_RXMAC_DE4_START			 (1L<<28)

#define BNX2_EMAC_RXMAC_DE5				0x00001570
#define BNX2_EMAC_RXMAC_DE5_PS_IDISM			 (0x7L<<0)
#define BNX2_EMAC_RXMAC_DE5_PS_IDISM_IDLE		 (0L<<0)
#define BNX2_EMAC_RXMAC_DE5_PS_IDISM_WAIT_EOF	 (1L<<0)
#define BNX2_EMAC_RXMAC_DE5_PS_IDISM_WAIT_STAT	 (2L<<0)
#define BNX2_EMAC_RXMAC_DE5_PS_IDISM_SET_EOF4FCRC	 (3L<<0)
#define BNX2_EMAC_RXMAC_DE5_PS_IDISM_SET_EOF4RDE	 (4L<<0)
#define BNX2_EMAC_RXMAC_DE5_PS_IDISM_SET_EOF4ALL	 (5L<<0)
#define BNX2_EMAC_RXMAC_DE5_PS_IDISM_1WD_WAIT_STAT	 (6L<<0)
#define BNX2_EMAC_RXMAC_DE5_CCODE_BUF1		 (0x7L<<4)
#define BNX2_EMAC_RXMAC_DE5_CCODE_BUF1_VDW		 (0x0L<<4)
#define BNX2_EMAC_RXMAC_DE5_CCODE_BUF1_STAT		 (0x1L<<4)
#define BNX2_EMAC_RXMAC_DE5_CCODE_BUF1_AEOF		 (0x2L<<4)
#define BNX2_EMAC_RXMAC_DE5_CCODE_BUF1_NEOF		 (0x3L<<4)
#define BNX2_EMAC_RXMAC_DE5_CCODE_BUF1_SOF		 (0x4L<<4)
#define BNX2_EMAC_RXMAC_DE5_CCODE_BUF1_SAEOF		 (0x6L<<4)
#define BNX2_EMAC_RXMAC_DE5_CCODE_BUF1_SNEOF		 (0x7L<<4)
#define BNX2_EMAC_RXMAC_DE5_EOF_DETECTED		 (1L<<7)
#define BNX2_EMAC_RXMAC_DE5_CCODE_BUF0		 (0x7L<<8)
#define BNX2_EMAC_RXMAC_DE5_RPM_IDI_FIFO_FULL	 (1L<<11)
#define BNX2_EMAC_RXMAC_DE5_LOAD_CCODE		 (1L<<12)
#define BNX2_EMAC_RXMAC_DE5_LOAD_DATA		 (1L<<13)
#define BNX2_EMAC_RXMAC_DE5_LOAD_STAT		 (1L<<14)
#define BNX2_EMAC_RXMAC_DE5_CLR_STAT			 (1L<<15)
#define BNX2_EMAC_RXMAC_DE5_IDI_RPM_CCODE		 (0x3L<<16)
#define BNX2_EMAC_RXMAC_DE5_IDI_RPM_ACCEPT		 (1L<<19)
#define BNX2_EMAC_RXMAC_DE5_FMLEN			 (0xfffL<<20)
...
#define BNX2_EMAC_TXMAC_DE0				0x00001658
#define BNX2_EMAC_TXMAC_DE1				0x0000165c
#define BNX2_EMAC_TXMAC_DE1_ODI_STATE		 (0xfL<<0)
#define BNX2_EMAC_TXMAC_DE1_ODI_STATE_IDLE		 (0x0L<<0)
#define BNX2_EMAC_TXMAC_DE1_ODI_STATE_START0		 (0x1L<<0)
#define BNX2_EMAC_TXMAC_DE1_ODI_STATE_DATA0		 (0x4L<<0)
#define BNX2_EMAC_TXMAC_DE1_ODI_STATE_DATA1		 (0x5L<<0)
#define BNX2_EMAC_TXMAC_DE1_ODI_STATE_DATA2		 (0x6L<<0)
#define BNX2_EMAC_TXMAC_DE1_ODI_STATE_DATA3		 (0x7L<<0)
#define BNX2_EMAC_TXMAC_DE1_ODI_STATE_WAIT0		 (0x8L<<0)
#define BNX2_EMAC_TXMAC_DE1_ODI_STATE_WAIT1		 (0x9L<<0)
#define BNX2_EMAC_TXMAC_DE1_CRS_ENABLE		 (1L<<4)
#define BNX2_EMAC_TXMAC_DE1_BAD_CRC			 (1L<<5)
#define BNX2_EMAC_TXMAC_DE1_SE_COUNTER		 (0xfL<<6)
#define BNX2_EMAC_TXMAC_DE1_SEND_PAUSE		 (1L<<10)
#define BNX2_EMAC_TXMAC_DE1_LATE_COLLISION		 (1L<<11)
#define BNX2_EMAC_TXMAC_DE1_MAX_DEFER		 (1L<<12)
#define BNX2_EMAC_TXMAC_DE1_DEFERRED			 (1L<<13)
#define BNX2_EMAC_TXMAC_DE1_ONE_BYTE			 (1L<<14)
#define BNX2_EMAC_TXMAC_DE1_IPG_TIME			 (0xfL<<15)
#define BNX2_EMAC_TXMAC_DE1_SLOT_TIME		 (0xffL<<19)

#define BNX2_EMAC_TXMAC_DE2				0x00001660
#define BNX2_EMAC_TXMAC_DE2_BACK_OFF			 (0x3ffL<<0)
#define BNX2_EMAC_TXMAC_DE2_BYTE_COUNT		 (0xffffL<<10)
#define BNX2_EMAC_TXMAC_DE2_COL_COUNT		 (0x1fL<<26)
#define BNX2_EMAC_TXMAC_DE2_COL_BIT			 (1L<<31)

#define BNX2_EMAC_TXMAC_DE3				0x00001664
#define BNX2_EMAC_TXMAC_DE3_SM_STATE			 (0xfL<<0)
#define BNX2_EMAC_TXMAC_DE3_SM_STATE_IDLE		 (0x0L<<0)
#define BNX2_EMAC_TXMAC_DE3_SM_STATE_PRE1		 (0x1L<<0)
#define BNX2_EMAC_TXMAC_DE3_SM_STATE_PRE2		 (0x2L<<0)
#define BNX2_EMAC_TXMAC_DE3_SM_STATE_SFD		 (0x3L<<0)
#define BNX2_EMAC_TXMAC_DE3_SM_STATE_DATA		 (0x4L<<0)
#define BNX2_EMAC_TXMAC_DE3_SM_STATE_CRC1		 (0x5L<<0)
#define BNX2_EMAC_TXMAC_DE3_SM_STATE_CRC2		 (0x6L<<0)
#define BNX2_EMAC_TXMAC_DE3_SM_STATE_EXT		 (0x7L<<0)
#define BNX2_EMAC_TXMAC_DE3_SM_STATE_STATB		 (0x8L<<0)
#define BNX2_EMAC_TXMAC_DE3_SM_STATE_STATG		 (0x9L<<0)
#define BNX2_EMAC_TXMAC_DE3_SM_STATE_JAM		 (0xaL<<0)
#define BNX2_EMAC_TXMAC_DE3_SM_STATE_EJAM		 (0xbL<<0)
#define BNX2_EMAC_TXMAC_DE3_SM_STATE_BJAM		 (0xcL<<0)
#define BNX2_EMAC_TXMAC_DE3_SM_STATE_SWAIT		 (0xdL<<0)
#define BNX2_EMAC_TXMAC_DE3_SM_STATE_BACKOFF		 (0xeL<<0)
#define BNX2_EMAC_TXMAC_DE3_FILT_STATE		 (0x7L<<4)
#define BNX2_EMAC_TXMAC_DE3_FILT_STATE_IDLE		 (0x0L<<4)
#define BNX2_EMAC_TXMAC_DE3_FILT_STATE_WAIT		 (0x1L<<4)
#define BNX2_EMAC_TXMAC_DE3_FILT_STATE_UNI		 (0x2L<<4)
#define BNX2_EMAC_TXMAC_DE3_FILT_STATE_MC		 (0x3L<<4)
#define BNX2_EMAC_TXMAC_DE3_FILT_STATE_BC2		 (0x4L<<4)
#define BNX2_EMAC_TXMAC_DE3_FILT_STATE_BC3		 (0x5L<<4)
#define BNX2_EMAC_TXMAC_DE3_FILT_STATE_BC		 (0x6L<<4)
#define BNX2_EMAC_TXMAC_DE3_CRS_DONE			 (1L<<7)
#define BNX2_EMAC_TXMAC_DE3_XOFF			 (1L<<8)
#define BNX2_EMAC_TXMAC_DE3_SE_COUNTER		 (0xfL<<9)
#define BNX2_EMAC_TXMAC_DE3_QUANTA_COUNTER		 (0x1fL<<13)

#define BNX2_EMAC_TXMAC_DE4				0x00001668
#define BNX2_EMAC_TXMAC_DE4_PAUSE_COUNTER		 (0xffffL<<0)
#define BNX2_EMAC_TXMAC_DE4_PAUSE_STATE		 (0xfL<<16)
#define BNX2_EMAC_TXMAC_DE4_PAUSE_STATE_IDLE		 (0x0L<<16)
#define BNX2_EMAC_TXMAC_DE4_PAUSE_STATE_MCA1		 (0x2L<<16)
#define BNX2_EMAC_TXMAC_DE4_PAUSE_STATE_MCA2		 (0x3L<<16)
#define BNX2_EMAC_TXMAC_DE4_PAUSE_STATE_SRC3		 (0x4L<<16)
#define BNX2_EMAC_TXMAC_DE4_PAUSE_STATE_SRC2		 (0x5L<<16)
#define BNX2_EMAC_TXMAC_DE4_PAUSE_STATE_MCA3		 (0x6L<<16)
#define BNX2_EMAC_TXMAC_DE4_PAUSE_STATE_SRC1		 (0x7L<<16)
#define BNX2_EMAC_TXMAC_DE4_PAUSE_STATE_CRC1		 (0x8L<<16)
#define BNX2_EMAC_TXMAC_DE4_PAUSE_STATE_CRC2		 (0x9L<<16)
#define BNX2_EMAC_TXMAC_DE4_PAUSE_STATE_TIME		 (0xaL<<16)
#define BNX2_EMAC_TXMAC_DE4_PAUSE_STATE_TYPE		 (0xcL<<16)
#define BNX2_EMAC_TXMAC_DE4_PAUSE_STATE_WAIT		 (0xdL<<16)
#define BNX2_EMAC_TXMAC_DE4_PAUSE_STATE_CMD		 (0xeL<<16)
#define BNX2_EMAC_TXMAC_DE4_STATS0_VALID		 (1L<<20)
#define BNX2_EMAC_TXMAC_DE4_APPEND_CRC		 (1L<<21)
#define BNX2_EMAC_TXMAC_DE4_SLOT_FILLED		 (1L<<22)
#define BNX2_EMAC_TXMAC_DE4_MAX_DEFER		 (1L<<23)
#define BNX2_EMAC_TXMAC_DE4_SEND_EXTEND		 (1L<<24)
#define BNX2_EMAC_TXMAC_DE4_SEND_PADDING		 (1L<<25)
#define BNX2_EMAC_TXMAC_DE4_EOF_LOC			 (1L<<26)
#define BNX2_EMAC_TXMAC_DE4_COLLIDING		 (1L<<27)
#define BNX2_EMAC_TXMAC_DE4_COL_IN			 (1L<<28)
#define BNX2_EMAC_TXMAC_DE4_BURSTING			 (1L<<29)
#define BNX2_EMAC_TXMAC_DE4_ADVANCE			 (1L<<30)
#define BNX2_EMAC_TXMAC_DE4_GO			 (1L<<31)
...
#define BNX2_RPM_DE0					0x00001984
#define BNX2_RPM_DE0_FM_BCNT				 (0xffffL<<0)
#define BNX2_RPM_DE0_T_DATA_OFST_VLD			 (1L<<16)
#define BNX2_RPM_DE0_T_UDP_OFST_VLD			 (1L<<17)
#define BNX2_RPM_DE0_T_TCP_OFST_VLD			 (1L<<18)
#define BNX2_RPM_DE0_T_IP_OFST_VLD			 (1L<<19)
#define BNX2_RPM_DE0_IP_MORE_FRGMT			 (1L<<20)
#define BNX2_RPM_DE0_T_IP_NO_TCP_UDP_HDR		 (1L<<21)
#define BNX2_RPM_DE0_LLC_SNAP			 (1L<<22)
#define BNX2_RPM_DE0_FM_STARTED			 (1L<<23)
#define BNX2_RPM_DE0_DONE				 (1L<<24)
#define BNX2_RPM_DE0_WAIT_4_DONE			 (1L<<25)
#define BNX2_RPM_DE0_USE_TPBUF_CKSUM			 (1L<<26)
#define BNX2_RPM_DE0_RX_NO_PSD_HDR_CKSUM		 (1L<<27)
#define BNX2_RPM_DE0_IGNORE_VLAN			 (1L<<28)
#define BNX2_RPM_DE0_RP_ENA_ACTIVE			 (1L<<31)

#define BNX2_RPM_DE1					0x00001988
#define BNX2_RPM_DE1_FSM_CUR_ST			 (0xffffL<<0)
#define BNX2_RPM_DE1_FSM_CUR_ST_IDLE			 (0L<<0)
#define BNX2_RPM_DE1_FSM_CUR_ST_ETYPE_B6_ALL		 (1L<<0)
#define BNX2_RPM_DE1_FSM_CUR_ST_ETYPE_B2_IPLLC	 (2L<<0)
#define BNX2_RPM_DE1_FSM_CUR_ST_ETYPE_B6_IP		 (4L<<0)
#define BNX2_RPM_DE1_FSM_CUR_ST_ETYPE_B2_IP		 (8L<<0)
#define BNX2_RPM_DE1_FSM_CUR_ST_IP_START		 (16L<<0)
#define BNX2_RPM_DE1_FSM_CUR_ST_IP			 (32L<<0)
#define BNX2_RPM_DE1_FSM_CUR_ST_TCP			 (64L<<0)
#define BNX2_RPM_DE1_FSM_CUR_ST_UDP			 (128L<<0)
#define BNX2_RPM_DE1_FSM_CUR_ST_AH			 (256L<<0)
#define BNX2_RPM_DE1_FSM_CUR_ST_ESP			 (512L<<0)
#define BNX2_RPM_DE1_FSM_CUR_ST_ESP_PAYLOAD		 (1024L<<0)
#define BNX2_RPM_DE1_FSM_CUR_ST_DATA			 (2048L<<0)
#define BNX2_RPM_DE1_FSM_CUR_ST_ADD_CARRY		 (0x2000L<<0)
#define BNX2_RPM_DE1_FSM_CUR_ST_ADD_CARRYOUT		 (0x4000L<<0)
#define BNX2_RPM_DE1_FSM_CUR_ST_LATCH_RESULT		 (0x8000L<<0)
#define BNX2_RPM_DE1_HDR_BCNT			 (0x7ffL<<16)
#define BNX2_RPM_DE1_UNKNOWN_ETYPE_D			 (1L<<28)
#define BNX2_RPM_DE1_VLAN_REMOVED_D2			 (1L<<29)
#define BNX2_RPM_DE1_VLAN_REMOVED_D1			 (1L<<30)
#define BNX2_RPM_DE1_EOF_0XTRA_WD			 (1L<<31)

#define BNX2_RPM_DE2					0x0000198c
#define BNX2_RPM_DE2_CMD_HIT_VEC			 (0xffffL<<0)
#define BNX2_RPM_DE2_IP_BCNT				 (0xffL<<16)
#define BNX2_RPM_DE2_THIS_CMD_M4			 (1L<<24)
#define BNX2_RPM_DE2_THIS_CMD_M3			 (1L<<25)
#define BNX2_RPM_DE2_THIS_CMD_M2			 (1L<<26)
#define BNX2_RPM_DE2_THIS_CMD_M1			 (1L<<27)
#define BNX2_RPM_DE2_IPIPE_EMPTY			 (1L<<28)
#define BNX2_RPM_DE2_FM_DISCARD			 (1L<<29)
#define BNX2_RPM_DE2_LAST_RULE_IN_FM_D2		 (1L<<30)
#define BNX2_RPM_DE2_LAST_RULE_IN_FM_D1		 (1L<<31)

#define BNX2_RPM_DE3					0x00001990
#define BNX2_RPM_DE3_AVAIL_MBUF_PTR			 (0x1ffL<<0)
#define BNX2_RPM_DE3_RDE_RLUPQ_WR_REQ_INT		 (1L<<9)
#define BNX2_RPM_DE3_RDE_RBUF_WR_LAST_INT		 (1L<<10)
#define BNX2_RPM_DE3_RDE_RBUF_WR_REQ_INT		 (1L<<11)
#define BNX2_RPM_DE3_RDE_RBUF_FREE_REQ		 (1L<<12)
#define BNX2_RPM_DE3_RDE_RBUF_ALLOC_REQ		 (1L<<13)
#define BNX2_RPM_DE3_DFSM_MBUF_NOTAVAIL		 (1L<<14)
#define BNX2_RPM_DE3_RBUF_RDE_SOF_DROP		 (1L<<15)
#define BNX2_RPM_DE3_DFIFO_VLD_ENTRY_CT		 (0xfL<<16)
#define BNX2_RPM_DE3_RDE_SRC_FIFO_ALMFULL		 (1L<<21)
#define BNX2_RPM_DE3_DROP_NXT_VLD			 (1L<<22)
#define BNX2_RPM_DE3_DROP_NXT			 (1L<<23)
#define BNX2_RPM_DE3_FTQ_FSM				 (0x3L<<24)
#define BNX2_RPM_DE3_FTQ_FSM_IDLE			 (0x0L<<24)
#define BNX2_RPM_DE3_FTQ_FSM_WAIT_ACK		 (0x1L<<24)
#define BNX2_RPM_DE3_FTQ_FSM_WAIT_FREE		 (0x2L<<24)
#define BNX2_RPM_DE3_MBWRITE_FSM			 (0x3L<<26)
#define BNX2_RPM_DE3_MBWRITE_FSM_WAIT_SOF		 (0x0L<<26)
#define BNX2_RPM_DE3_MBWRITE_FSM_GET_MBUF		 (0x1L<<26)
#define BNX2_RPM_DE3_MBWRITE_FSM_DMA_DATA		 (0x2L<<26)
#define BNX2_RPM_DE3_MBWRITE_FSM_WAIT_DATA		 (0x3L<<26)
#define BNX2_RPM_DE3_MBWRITE_FSM_WAIT_EOF		 (0x4L<<26)
#define BNX2_RPM_DE3_MBWRITE_FSM_WAIT_MF_ACK		 (0x5L<<26)
#define BNX2_RPM_DE3_MBWRITE_FSM_WAIT_DROP_NXT_VLD	 (0x6L<<26)
#define BNX2_RPM_DE3_MBWRITE_FSM_DONE		 (0x7L<<26)
#define BNX2_RPM_DE3_MBFREE_FSM			 (1L<<29)
#define BNX2_RPM_DE3_MBFREE_FSM_IDLE			 (0L<<29)
#define BNX2_RPM_DE3_MBFREE_FSM_WAIT_ACK		 (1L<<29)
#define BNX2_RPM_DE3_MBALLOC_FSM			 (1L<<30)
#define BNX2_RPM_DE3_MBALLOC_FSM_ET_MBUF		 (0x0L<<30)
#define BNX2_RPM_DE3_MBALLOC_FSM_IVE_MBUF		 (0x1L<<30)
#define BNX2_RPM_DE3_CCODE_EOF_ERROR			 (1L<<31)

#define BNX2_RPM_DE4					0x00001994
#define BNX2_RPM_DE4_DFSM_MBUF_CLUSTER		 (0x1ffffffL<<0)
#define BNX2_RPM_DE4_DFIFO_CUR_CCODE			 (0x7L<<25)
#define BNX2_RPM_DE4_MBWRITE_FSM			 (0x7L<<28)
#define BNX2_RPM_DE4_DFIFO_EMPTY			 (1L<<31)

#define BNX2_RPM_DE5					0x00001998
#define BNX2_RPM_DE5_RDROP_WPTR			 (0x1fL<<0)
#define BNX2_RPM_DE5_RDROP_ACPI_RPTR			 (0x1fL<<5)
#define BNX2_RPM_DE5_RDROP_MC_RPTR			 (0x1fL<<10)
#define BNX2_RPM_DE5_RDROP_RC_RPTR			 (0x1fL<<15)
#define BNX2_RPM_DE5_RDROP_ACPI_EMPTY		 (1L<<20)
#define BNX2_RPM_DE5_RDROP_MC_EMPTY			 (1L<<21)
#define BNX2_RPM_DE5_RDROP_AEOF_VEC_AT_RDROP_MC_RPTR	 (1L<<22)
#define BNX2_RPM_DE5_HOLDREG_WOL_DROP_INT		 (1L<<23)
#define BNX2_RPM_DE5_HOLDREG_DISCARD			 (1L<<24)
#define BNX2_RPM_DE5_HOLDREG_MBUF_NOTAVAIL		 (1L<<25)
#define BNX2_RPM_DE5_HOLDREG_MC_EMPTY		 (1L<<26)
#define BNX2_RPM_DE5_HOLDREG_RC_EMPTY		 (1L<<27)
#define BNX2_RPM_DE5_HOLDREG_FC_EMPTY		 (1L<<28)
#define BNX2_RPM_DE5_HOLDREG_ACPI_EMPTY		 (1L<<29)
#define BNX2_RPM_DE5_HOLDREG_FULL_T			 (1L<<30)
#define BNX2_RPM_DE5_HOLDREG_RD			 (1L<<31)

#define BNX2_RPM_DE6					0x0000199c
#define BNX2_RPM_DE6_ACPI_VEC			 (0xffffL<<0)
#define BNX2_RPM_DE6_VEC				 (0xffffL<<16)

#define BNX2_RPM_DE7					0x000019a0
#define BNX2_RPM_DE7_RPM_DBG7_LAST_CRC		 (0xffffffffL<<0)

#define BNX2_RPM_DE8					0x000019a4
#define BNX2_RPM_DE8_PS_ACPI_FSM			 (0xfL<<0)
#define BNX2_RPM_DE8_PS_ACPI_FSM_IDLE		 (0L<<0)
#define BNX2_RPM_DE8_PS_ACPI_FSM_SOF_W1_ADDR		 (1L<<0)
#define BNX2_RPM_DE8_PS_ACPI_FSM_SOF_W2_ADDR		 (2L<<0)
#define BNX2_RPM_DE8_PS_ACPI_FSM_SOF_W3_ADDR		 (3L<<0)
#define BNX2_RPM_DE8_PS_ACPI_FSM_SOF_WAIT_THBUF	 (4L<<0)
#define BNX2_RPM_DE8_PS_ACPI_FSM_W3_DATA		 (5L<<0)
#define BNX2_RPM_DE8_PS_ACPI_FSM_W0_ADDR		 (6L<<0)
#define BNX2_RPM_DE8_PS_ACPI_FSM_W1_ADDR		 (7L<<0)
#define BNX2_RPM_DE8_PS_ACPI_FSM_W2_ADDR		 (8L<<0)
#define BNX2_RPM_DE8_PS_ACPI_FSM_W3_ADDR		 (9L<<0)
#define BNX2_RPM_DE8_PS_ACPI_FSM_WAIT_THBUF		 (10L<<0)
#define BNX2_RPM_DE8_COMPARE_AT_W0			 (1L<<4)
#define BNX2_RPM_DE8_COMPARE_AT_W3_DATA		 (1L<<5)
#define BNX2_RPM_DE8_COMPARE_AT_SOF_WAIT		 (1L<<6)
#define BNX2_RPM_DE8_COMPARE_AT_SOF_W3		 (1L<<7)
#define BNX2_RPM_DE8_COMPARE_AT_SOF_W2		 (1L<<8)
#define BNX2_RPM_DE8_EOF_W_LTEQ6_VLDBYTES		 (1L<<9)
#define BNX2_RPM_DE8_EOF_W_LTEQ4_VLDBYTES		 (1L<<10)
#define BNX2_RPM_DE8_NXT_EOF_W_12_VLDBYTES		 (1L<<11)
#define BNX2_RPM_DE8_EOF_DET				 (1L<<12)
#define BNX2_RPM_DE8_SOF_DET				 (1L<<13)
#define BNX2_RPM_DE8_WAIT_4_SOF			 (1L<<14)
#define BNX2_RPM_DE8_ALL_DONE			 (1L<<15)
#define BNX2_RPM_DE8_THBUF_ADDR			 (0x7fL<<16)
#define BNX2_RPM_DE8_BYTE_CTR			 (0xffL<<24)

#define BNX2_RPM_DE9					0x000019a8
#define BNX2_RPM_DE9_OUTFIFO_COUNT			 (0x7L<<0)
#define BNX2_RPM_DE9_RDE_ACPI_RDY			 (1L<<3)
#define BNX2_RPM_DE9_VLD_RD_ENTRY_CT			 (0x7L<<4)
#define BNX2_RPM_DE9_OUTFIFO_OVERRUN_OCCURRED	 (1L<<28)
#define BNX2_RPM_DE9_INFIFO_OVERRUN_OCCURRED		 (1L<<29)
#define BNX2_RPM_DE9_ACPI_MATCH_INT			 (1L<<30)
#define BNX2_RPM_DE9_ACPI_ENABLE_SYN			 (1L<<31)
#define BNX2_RPM_DE9_BEMEM_R_XI			 (0x1fL<<0)
#define BNX2_RPM_DE9_EO_XI				 (1L<<5)
#define BNX2_RPM_DE9_AEOF_DE_XI			 (1L<<6)
#define BNX2_RPM_DE9_SO_XI				 (1L<<7)
#define BNX2_RPM_DE9_WD64_CT_XI			 (0x1fL<<8)
#define BNX2_RPM_DE9_EOF_VLDBYTE_XI			 (0x7L<<13)
#define BNX2_RPM_DE9_ACPI_RDE_PAT_ID_XI		 (0xfL<<16)
#define BNX2_RPM_DE9_CALCRC_RESULT_XI		 (0x3ffL<<20)
#define BNX2_RPM_DE9_DATA_IN_VL_XI			 (1L<<30)
#define BNX2_RPM_DE9_CALCRC_BUFFER_VLD_XI		 (1L<<31)
...
#define BNX2_RPM_ACPI_BYTE_ENABLE_CTRL_DERD		 (1L<<28)
...
#define BNX2_RV2P_PROC1_GRC_DE			0x00002840
#define BNX2_RV2P_PROC2_GRC_DE			0x00002844
#define BNX2_RV2P_GRC_PROC_DE			0x00002848
#define BNX2_RV2P_DE_VECT_PEEK			0x0000284c
#define BNX2_RV2P_DE_VECT_PEEK_1_VALUE		 (0x7ffL<<0)
#define BNX2_RV2P_DE_VECT_PEEK_1_PEEK_EN		 (1L<<11)
#define BNX2_RV2P_DE_VECT_PEEK_1_SEL			 (0xfL<<12)
#define BNX2_RV2P_DE_VECT_PEEK_2_VALUE		 (0x7ffL<<16)
#define BNX2_RV2P_DE_VECT_PEEK_2_PEEK_EN		 (1L<<27)
#define BNX2_RV2P_DE_VECT_PEEK_2_SEL			 (0xfL<<28)
...
#define BNX2_TBDR_DE_VECT_PEEK			0x0000500c
#define BNX2_TBDR_DE_VECT_PEEK_1_VALUE		 (0x7ffL<<0)
#define BNX2_TBDR_DE_VECT_PEEK_1_PEEK_EN		 (1L<<11)
#define BNX2_TBDR_DE_VECT_PEEK_1_SEL			 (0xfL<<12)
#define BNX2_TBDR_DE_VECT_PEEK_2_VALUE		 (0x7ffL<<16)
#define BNX2_TBDR_DE_VECT_PEEK_2_PEEK_EN		 (1L<<27)
#define BNX2_TBDR_DE_VECT_PEEK_2_SEL			 (0xfL<<28)
...
#define BNX2_TDMA_BD_IF_DE				0x00005c94
#define BNX2_TDMA_DMAD_IF_DE				0x00005c98
#define BNX2_TDMA_CTX_IF_DE				0x00005c9c
#define BNX2_TDMA_TPBUF_IF_DE			0x00005ca0
#define BNX2_TDMA_DR_IF_DE				0x00005ca4
#define BNX2_TDMA_TPATQ_IF_DE			0x00005ca8
...
#define BNX2_HC_DE_VECT_PEEK				0x00006910
#define BNX2_HC_DE_VECT_PEEK_1_VALUE			 (0x7ffL<<0)
#define BNX2_HC_DE_VECT_PEEK_1_PEEK_EN		 (1L<<11)
#define BNX2_HC_DE_VECT_PEEK_1_SEL			 (0xfL<<12)
#define BNX2_HC_DE_VECT_PEEK_2_VALUE			 (0x7ffL<<16)
#define BNX2_HC_DE_VECT_PEEK_2_PEEK_EN		 (1L<<27)
#define BNX2_HC_DE_VECT_PEEK_2_SEL			 (0xfL<<28)
...
#define BNX2_TXP_CPU_DE_VECT_PEEK			0x00045038
#define BNX2_TXP_CPU_DE_VECT_PEEK_1_VALUE		 (0x7ffL<<0)
#define BNX2_TXP_CPU_DE_VECT_PEEK_1_PEEK_EN		 (1L<<11)
#define BNX2_TXP_CPU_DE_VECT_PEEK_1_SEL		 (0xfL<<12)
#define BNX2_TXP_CPU_DE_VECT_PEEK_2_VALUE		 (0x7ffL<<16)
#define BNX2_TXP_CPU_DE_VECT_PEEK_2_PEEK_EN		 (1L<<27)
#define BNX2_TXP_CPU_DE_VECT_PEEK_2_SEL		 (0xfL<<28)
...
#define BNX2_TPAT_CPU_DE_VECT_PEEK			0x00085038
#define BNX2_TPAT_CPU_DE_VECT_PEEK_1_VALUE		 (0x7ffL<<0)
#define BNX2_TPAT_CPU_DE_VECT_PEEK_1_PEEK_EN		 (1L<<11)
#define BNX2_TPAT_CPU_DE_VECT_PEEK_1_SEL		 (0xfL<<12)
#define BNX2_TPAT_CPU_DE_VECT_PEEK_2_VALUE		 (0x7ffL<<16)
#define BNX2_TPAT_CPU_DE_VECT_PEEK_2_PEEK_EN		 (1L<<27)
#define BNX2_TPAT_CPU_DE_VECT_PEEK_2_SEL		 (0xfL<<28)
...
#define BNX2_RXP_CPU_DE_VECT_PEEK			0x000c5038
#define BNX2_RXP_CPU_DE_VECT_PEEK_1_VALUE		 (0x7ffL<<0)
#define BNX2_RXP_CPU_DE_VECT_PEEK_1_PEEK_EN		 (1L<<11)
#define BNX2_RXP_CPU_DE_VECT_PEEK_1_SEL		 (0xfL<<12)
#define BNX2_RXP_CPU_DE_VECT_PEEK_2_VALUE		 (0x7ffL<<16)
#define BNX2_RXP_CPU_DE_VECT_PEEK_2_PEEK_EN		 (1L<<27)
#define BNX2_RXP_CPU_DE_VECT_PEEK_2_SEL		 (0xfL<<28)
...
#define BNX2_COM_CPU_DE_VECT_PEEK			0x00105038
#define BNX2_COM_CPU_DE_VECT_PEEK_1_VALUE		 (0x7ffL<<0)
#define BNX2_COM_CPU_DE_VECT_PEEK_1_PEEK_EN		 (1L<<11)
#define BNX2_COM_CPU_DE_VECT_PEEK_1_SEL		 (0xfL<<12)
#define BNX2_COM_CPU_DE_VECT_PEEK_2_VALUE		 (0x7ffL<<16)
#define BNX2_COM_CPU_DE_VECT_PEEK_2_PEEK_EN		 (1L<<27)
#define BNX2_COM_CPU_DE_VECT_PEEK_2_SEL		 (0xfL<<28)
...
#define BNX2_CP_CPU_DE_VECT_PEEK			0x00185038
#define BNX2_CP_CPU_DE_VECT_PEEK_1_VALUE		 (0x7ffL<<0)
#define BNX2_CP_CPU_DE_VECT_PEEK_1_PEEK_EN		 (1L<<11)
#define BNX2_CP_CPU_DE_VECT_PEEK_1_SEL		 (0xfL<<12)
#define BNX2_CP_CPU_DE_VECT_PEEK_2_VALUE		 (0x7ffL<<16)
#define BNX2_CP_CPU_DE_VECT_PEEK_2_PEEK_EN		 (1L<<27)
#define BNX2_CP_CPU_DE_VECT_PEEK_2_SEL		 (0xfL<<28)
...
#define BNX2_MCP_CPU_DE_VECT_PEEK			0x00145038
#define BNX2_MCP_CPU_DE_VECT_PEEK_1_VALUE		 (0x7ffL<<0)
#define BNX2_MCP_CPU_DE_VECT_PEEK_1_PEEK_EN		 (1L<<11)
#define BNX2_MCP_CPU_DE_VECT_PEEK_1_SEL		 (0xfL<<12)
#define BNX2_MCP_CPU_DE_VECT_PEEK_2_VALUE		 (0x7ffL<<16)
#define BNX2_MCP_CPU_DE_VECT_PEEK_2_PEEK_EN		 (1L<<27)
#define BNX2_MCP_CPU_DE_VECT_PEEK_2_SEL		 (0xfL<<28)
...
#define BNX2_BC_STATE_DE_CMD			0x1dc
...
#define DP_SHMEM_LINE(bp, offset)					\
	netdev_err(bp->dev, "DE: %08x: %08x %08x %08x %08x\n",	\
		   offset,						\
