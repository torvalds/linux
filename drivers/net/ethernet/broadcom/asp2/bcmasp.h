...
#define   ASP_CTRL_CLOCK_CTRL_ASP_RGMII_MASK  (0x7 << \
    ASP_CTRL_CLOCK_CTRL_ASP_RGMII_SHIFT)
#define   ASP_CTRL_CLOCK_CTRL_ASP_RGMII_DIS(x)  BIT( \
    ASP_CTRL_CLOCK_CTRL_ASP_RGMII_SHIFT + (x))
