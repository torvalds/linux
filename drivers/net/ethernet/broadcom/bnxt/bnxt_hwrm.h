...
enum bnxt_hwrm_ctx_flags {
  /* Update the HWRM_API_FLAGS right below for any new non-internal bit added
   * here */
...
enum bnxt_hwrm_chnl {
  BNXT_HWRM_CHNL_CHIMP, BNXT_HWRM_CHNL_KONG
};
 ...
 */
static inline int bnxt_hwrm_func_cfg_short_req_init(struct bnxt *bp,
