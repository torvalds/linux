...
#define VER_GET_RESP_DEV_CAPS_CFG_KONG_MB_CHNL_SUPPORTED                   \
  0x10UL
#define VER_GET_RESP_DEV_CAPS_CFG_FLOW_HANDLE_64BIT_SUPPORTED              \
  0x20UL
#define VER_GET_RESP_DEV_CAPS_CFG_L2_FILTER_TYPES_ROCE_OR_L2_SUPPORTED     \
  0x40UL
#define VER_GET_RESP_DEV_CAPS_CFG_VIRTIO_VSWITCH_OFFLOAD_SUPPORTED         \
  0x80UL
#define VER_GET_RESP_DEV_CAPS_CFG_TRUSTED_VF_SUPPORTED                     \
  0x100UL
#define VER_GET_RESP_DEV_CAPS_CFG_FLOW_AGING_SUPPORTED                     \
  0x200UL
#define VER_GET_RESP_DEV_CAPS_CFG_ADV_FLOW_COUNTERS_SUPPORTED              \
  0x400UL
#define VER_GET_RESP_DEV_CAPS_CFG_CFA_EEM_SUPPORTED                        \
  0x800UL
#define VER_GET_RESP_DEV_CAPS_CFG_CFA_ADV_FLOW_MGNT_SUPPORTED              \
  0x1000UL
#define VER_GET_RESP_DEV_CAPS_CFG_CFA_TFLIB_SUPPORTED                      \
  0x2000UL
#define VER_GET_RESP_DEV_CAPS_CFG_CFA_TRUFLOW_SUPPORTED                    \
  0x4000UL
#define VER_GET_RESP_DEV_CAPS_CFG_SECURE_BOOT_CAPABLE                      \
  0x8000UL
  u8 roce_fw_maj_8b;
  u8 roce_fw_min_8b;
  u8 roce_fw_bld_8b;
...
#define VER_GET_RESP_CHIP_PLATFORM_TYPE_LAST     \
...
#define ASYNC_EVENT_CMPL_TYPE_LAST             \
...
#define ASYNC_EVENT_CMPL_EVENT_ID_LAST                           \
...
#define ASYNC_EVENT_CMPL_LINK_STATUS_CHANGE_TYPE_LAST             \
...
#define ASYNC_EVENT_CMPL_LINK_STATUS_CHANGE_EVENT_ID_LAST              \
...
#define ASYNC_EVENT_CMPL_LINK_STATUS_CHANGE_EVENT_DATA1_LINK_CHANGE_LAST \
...
#define ASYNC_EVENT_CMPL_LINK_STATUS_CHANGE_EVENT_DATA1_PF_ID_MASK      \
  0xff00000UL
...
#define ASYNC_EVENT_CMPL_PORT_CONN_NOT_ALLOWED_TYPE_LAST             \
  ASYNC_EVENT_CMPL_PORT_CONN_NOT_ALLOWED_TYPE_HWRM_ASYNC_EVENT
  __le16 event_id;
#define ASYNC_EVENT_CMPL_PORT_CONN_NOT_ALLOWED_EVENT_ID_PORT_CONN_NOT_ALLOWED \
  0x4UL
#define ASYNC_EVENT_CMPL_PORT_CONN_NOT_ALLOWED_EVENT_ID_LAST                 \
...
#define ASYNC_EVENT_CMPL_PORT_CONN_NOT_ALLOWED_EVENT_DATA1_PORT_ID_MASK                 \
  0xffffUL
#define ASYNC_EVENT_CMPL_PORT_CONN_NOT_ALLOWED_EVENT_DATA1_PORT_ID_SFT                  \
  0
#define \
...
#define ASYNC_EVENT_CMPL_LINK_SPEED_CFG_CHANGE_TYPE_LAST             \
  ...
  __le16 event_id;
#define ASYNC_EVENT_CMPL_LINK_SPEED_CFG_CHANGE_EVENT_ID_LINK_SPEED_CFG_CHANGE \
  0x6UL
#define ASYNC_EVENT_CMPL_LINK_SPEED_CFG_CHANGE_EVENT_ID_LAST                 \
...
#define ASYNC_EVENT_CMPL_LINK_SPEED_CFG_CHANGE_OPAQUE_SFT 1
  ...
  __le16 timestamp_hi;
  __le32 event_data1;
#define ASYNC_EVENT_CMPL_LINK_SPEED_CFG_CHANGE_EVENT_DATA1_PORT_ID_MASK                     \
  0xffffUL
#define ASYNC_EVENT_CMPL_LINK_SPEED_CFG_CHANGE_EVENT_DATA1_PORT_ID_SFT                      \
  0
#define \
...
#define ASYNC_EVENT_CMPL_RESET_NOTIFY_OPAQUE_SFT 1
  ...
  __le16 timestamp_hi;
  __le32 event_data1;
#define ASYNC_EVENT_CMPL_RESET_NOTIFY_EVENT_DATA1_DRIVER_ACTION_MASK                  \
  0xffUL
#define ASYNC_EVENT_CMPL_RESET_NOTIFY_EVENT_DATA1_DRIVER_ACTION_SFT                   \
  0
#define \
  ASYNC_EVENT_CMPL_RESET_NOTIFY_EVENT_DATA1_DRIVER_ACTION_DRIVER_STOP_TX_QUEUE    \
  0x1UL
#define ASYNC_EVENT_CMPL_RESET_NOTIFY_EVENT_DATA1_DRIVER_ACTION_DRIVER_IFDOWN           \
  0x2UL
#define ASYNC_EVENT_CMPL_RESET_NOTIFY_EVENT_DATA1_DRIVER_ACTION_LAST                   \
  ASYNC_EVENT_CMPL_RESET_NOTIFY_EVENT_DATA1_DRIVER_ACTION_DRIVER_IFDOWN
#define ASYNC_EVENT_CMPL_RESET_NOTIFY_EVENT_DATA1_REASON_CODE_MASK                    \
  0xff00UL
#define ASYNC_EVENT_CMPL_RESET_NOTIFY_EVENT_DATA1_REASON_CODE_SFT                     \
  8
#define \
  ASYNC_EVENT_CMPL_RESET_NOTIFY_EVENT_DATA1_REASON_CODE_MANAGEMENT_RESET_REQUEST  ( \
    0x1UL << 8)
#define ASYNC_EVENT_CMPL_RESET_NOTIFY_EVENT_DATA1_REASON_CODE_FW_EXCEPTION_FATAL        ( \
    0x2UL << 8)
#define \
  ASYNC_EVENT_CMPL_RESET_NOTIFY_EVENT_DATA1_REASON_CODE_FW_EXCEPTION_NON_FATAL    ( \
    0x3UL << 8)
#define ASYNC_EVENT_CMPL_RESET_NOTIFY_EVENT_DATA1_REASON_CODE_FAST_RESET                ( \
    0x4UL << 8)
#define ASYNC_EVENT_CMPL_RESET_NOTIFY_EVENT_DATA1_REASON_CODE_FW_ACTIVATION             ( \
    0x5UL << 8)
#define ASYNC_EVENT_CMPL_RESET_NOTIFY_EVENT_DATA1_REASON_CODE_LAST                     \
  ASYNC_EVENT_CMPL_RESET_NOTIFY_EVENT_DATA1_REASON_CODE_FW_ACTIVATION
#define ASYNC_EVENT_CMPL_RESET_NOTIFY_EVENT_DATA1_DELAY_IN_100MS_TICKS_MASK           \
  0xffff0000UL
#define ASYNC_EVENT_CMPL_RESET_NOTIFY_EVENT_DATA1_DELAY_IN_100MS_TICKS_SFT            \
  16
};
...
#define ASYNC_EVENT_CMPL_ERROR_RECOVERY_TYPE_LAST             \
...
#define ASYNC_EVENT_CMPL_ERROR_RECOVERY_EVENT_ID_LAST          \
...
#define ASYNC_EVENT_CMPL_ERROR_RECOVERY_OPAQUE_SFT 1
  ...
  __le16 timestamp_hi;
  __le32 event_data1;
#define ASYNC_EVENT_CMPL_ERROR_RECOVERY_EVENT_DATA1_FLAGS_MASK                 \
  0xffUL
#define ASYNC_EVENT_CMPL_ERROR_RECOVERY_EVENT_DATA1_FLAGS_SFT                  0
#define ASYNC_EVENT_CMPL_ERROR_RECOVERY_EVENT_DATA1_FLAGS_MASTER_FUNC           \
  0x1UL
#define ASYNC_EVENT_CMPL_ERROR_RECOVERY_EVENT_DATA1_FLAGS_RECOVERY_ENABLED      \
  0x2UL
};
...
#define ASYNC_EVENT_CMPL_RING_MONITOR_MSG_TYPE_LAST             \
  ASYNC_EVENT_CMPL_RING_MONITOR_MSG_TYPE_HWRM_ASYNC_EVENT
  __le16 event_id;
#define ASYNC_EVENT_CMPL_RING_MONITOR_MSG_EVENT_ID_RING_MONITOR_MSG 0xaUL
#define ASYNC_EVENT_CMPL_RING_MONITOR_MSG_EVENT_ID_LAST            \
  ASYNC_EVENT_CMPL_RING_MONITOR_MSG_EVENT_ID_RING_MONITOR_MSG
  __le32 event_data2;
...
#define ASYNC_EVENT_CMPL_RING_MONITOR_MSG_EVENT_DATA2_DISABLE_RING_TYPE_TX    \
  0x0UL
#define ASYNC_EVENT_CMPL_RING_MONITOR_MSG_EVENT_DATA2_DISABLE_RING_TYPE_RX    \
  0x1UL
#define ASYNC_EVENT_CMPL_RING_MONITOR_MSG_EVENT_DATA2_DISABLE_RING_TYPE_CMPL  \
  0x2UL
#define ASYNC_EVENT_CMPL_RING_MONITOR_MSG_EVENT_DATA2_DISABLE_RING_TYPE_LAST \
  ASYNC_EVENT_CMPL_RING_MONITOR_MSG_EVENT_DATA2_DISABLE_RING_TYPE_CMPL
  u8 opaque_v;
...
#define ASYNC_EVENT_CMPL_VF_CFG_CHANGE_TYPE_LAST             \
  ASYNC_EVENT_CMPL_VF_CFG_CHANGE_TYPE_HWRM_ASYNC_EVENT
  __le16 event_id;
#define ASYNC_EVENT_CMPL_VF_CFG_CHANGE_EVENT_ID_VF_CFG_CHANGE 0x33UL
#define ASYNC_EVENT_CMPL_VF_CFG_CHANGE_EVENT_ID_LAST         \
...
#define ASYNC_EVENT_CMPL_VF_CFG_CHANGE_OPAQUE_SFT 1
  ...
  __le16 timestamp_hi;
  __le32 event_data1;
#define ASYNC_EVENT_CMPL_VF_CFG_CHANGE_EVENT_DATA1_MTU_CHANGE                \
  0x1UL
#define ASYNC_EVENT_CMPL_VF_CFG_CHANGE_EVENT_DATA1_MRU_CHANGE                \
  0x2UL
#define ASYNC_EVENT_CMPL_VF_CFG_CHANGE_EVENT_DATA1_DFLT_MAC_ADDR_CHANGE      \
  0x4UL
#define ASYNC_EVENT_CMPL_VF_CFG_CHANGE_EVENT_DATA1_DFLT_VLAN_CHANGE          \
  0x8UL
#define ASYNC_EVENT_CMPL_VF_CFG_CHANGE_EVENT_DATA1_TRUSTED_VF_CFG_CHANGE     \
  0x10UL
#define ASYNC_EVENT_CMPL_VF_CFG_CHANGE_EVENT_DATA1_TF_OWNERSHIP_RELEASE      \
  0x20UL
};
...
#define ASYNC_EVENT_CMPL_DEFAULT_VNIC_CHANGE_TYPE_LAST             \
...
#define ASYNC_EVENT_CMPL_DEFAULT_VNIC_CHANGE_UNUSED1_SFT          6
  __le16 event_id;
#define ASYNC_EVENT_CMPL_DEFAULT_VNIC_CHANGE_EVENT_ID_ALLOC_FREE_NOTIFICATION \
  0x35UL
#define ASYNC_EVENT_CMPL_DEFAULT_VNIC_CHANGE_EVENT_ID_LAST                   \
...
#define ASYNC_EVENT_CMPL_DEFAULT_VNIC_CHANGE_OPAQUE_SFT 1
  ...
  __le16 timestamp_hi;
  __le32 event_data1;
#define ASYNC_EVENT_CMPL_DEFAULT_VNIC_CHANGE_EVENT_DATA1_DEF_VNIC_STATE_MASK          \
  0x3UL
#define ASYNC_EVENT_CMPL_DEFAULT_VNIC_CHANGE_EVENT_DATA1_DEF_VNIC_STATE_SFT           \
  0
#define \
...
#define \
  ...
  0x2UL
#define ASYNC_EVENT_CMPL_DEFAULT_VNIC_CHANGE_EVENT_DATA1_DEF_VNIC_STATE_LAST           \
  ASYNC_EVENT_CMPL_DEFAULT_VNIC_CHANGE_EVENT_DATA1_DEF_VNIC_STATE_DEF_VNIC_FREE
#define ASYNC_EVENT_CMPL_DEFAULT_VNIC_CHANGE_EVENT_DATA1_PF_ID_MASK                   \
  0x3fcUL
#define ASYNC_EVENT_CMPL_DEFAULT_VNIC_CHANGE_EVENT_DATA1_PF_ID_SFT                    \
  2
#define ASYNC_EVENT_CMPL_DEFAULT_VNIC_CHANGE_EVENT_DATA1_VF_ID_MASK                   \
  0x3fffc00UL
...
#define ASYNC_EVENT_CMPL_HW_FLOW_AGED_OPAQUE_SFT 1
  ...
  __le16 timestamp_hi;
  __le32 event_data1;
#define ASYNC_EVENT_CMPL_HW_FLOW_AGED_EVENT_DATA1_FLOW_ID_MASK       \
  0x7fffffffUL
#define ASYNC_EVENT_CMPL_HW_FLOW_AGED_EVENT_DATA1_FLOW_ID_SFT        0
#define ASYNC_EVENT_CMPL_HW_FLOW_AGED_EVENT_DATA1_FLOW_DIRECTION     \
  0x80000000UL
#define ASYNC_EVENT_CMPL_HW_FLOW_AGED_EVENT_DATA1_FLOW_DIRECTION_RX    (0x0UL << \
    31)
#define ASYNC_EVENT_CMPL_HW_FLOW_AGED_EVENT_DATA1_FLOW_DIRECTION_TX    (0x1UL << \
    31)
#define ASYNC_EVENT_CMPL_HW_FLOW_AGED_EVENT_DATA1_FLOW_DIRECTION_LAST \
...
#define ASYNC_EVENT_CMPL_EEM_CACHE_FLUSH_REQ_TYPE_LAST             \
...
#define ASYNC_EVENT_CMPL_EEM_CACHE_FLUSH_REQ_EVENT_ID_LAST               \
...
#define ASYNC_EVENT_CMPL_EEM_CACHE_FLUSH_DONE_TYPE_LAST             \
  ASYNC_EVENT_CMPL_EEM_CACHE_FLUSH_DONE_TYPE_HWRM_ASYNC_EVENT
  __le16 event_id;
#define ASYNC_EVENT_CMPL_EEM_CACHE_FLUSH_DONE_EVENT_ID_EEM_CACHE_FLUSH_DONE \
  0x39UL
#define ASYNC_EVENT_CMPL_EEM_CACHE_FLUSH_DONE_EVENT_ID_LAST                \
...
#define ASYNC_EVENT_CMPL_DEFERRED_RESPONSE_TYPE_LAST             \
  ASYNC_EVENT_CMPL_DEFERRED_RESPONSE_TYPE_HWRM_ASYNC_EVENT
  __le16 event_id;
#define ASYNC_EVENT_CMPL_DEFERRED_RESPONSE_EVENT_ID_DEFERRED_RESPONSE 0x40UL
#define ASYNC_EVENT_CMPL_DEFERRED_RESPONSE_EVENT_ID_LAST             \
  ASYNC_EVENT_CMPL_DEFERRED_RESPONSE_EVENT_ID_DEFERRED_RESPONSE
  __le32 event_data2;
...
#define ASYNC_EVENT_CMPL_ECHO_REQUEST_TYPE_LAST             \
  ASYNC_EVENT_CMPL_ECHO_REQUEST_TYPE_HWRM_ASYNC_EVENT
  __le16 event_id;
#define ASYNC_EVENT_CMPL_ECHO_REQUEST_EVENT_ID_ECHO_REQUEST 0x42UL
#define ASYNC_EVENT_CMPL_ECHO_REQUEST_EVENT_ID_LAST        \
...
#define ASYNC_EVENT_CMPL_PHC_UPDATE_TYPE_LAST             \
  ASYNC_EVENT_CMPL_PHC_UPDATE_TYPE_HWRM_ASYNC_EVENT
  __le16 event_id;
#define ASYNC_EVENT_CMPL_PHC_UPDATE_EVENT_ID_PHC_UPDATE 0x43UL
#define ASYNC_EVENT_CMPL_PHC_UPDATE_EVENT_ID_LAST      \
  ASYNC_EVENT_CMPL_PHC_UPDATE_EVENT_ID_PHC_UPDATE
  __le32 event_data2;
...
#define ASYNC_EVENT_CMPL_PHC_UPDATE_EVENT_DATA1_FLAGS_LAST           \
...
#define ASYNC_EVENT_CMPL_PPS_TIMESTAMP_TYPE_LAST             \
...
#define ASYNC_EVENT_CMPL_PPS_TIMESTAMP_EVENT_ID_LAST         \
  ASYNC_EVENT_CMPL_PPS_TIMESTAMP_EVENT_ID_PPS_TIMESTAMP
  __le32 event_data2;
#define ASYNC_EVENT_CMPL_PPS_TIMESTAMP_EVENT_DATA2_EVENT_TYPE              0x1UL
#define ASYNC_EVENT_CMPL_PPS_TIMESTAMP_EVENT_DATA2_EVENT_TYPE_INTERNAL       \
  0x0UL
#define ASYNC_EVENT_CMPL_PPS_TIMESTAMP_EVENT_DATA2_EVENT_TYPE_EXTERNAL       \
  0x1UL
...
#define ASYNC_EVENT_CMPL_PPS_TIMESTAMP_EVENT_DATA2_PPS_TIMESTAMP_UPPER_MASK \
  0xffff0UL
...
#define ASYNC_EVENT_CMPL_PPS_TIMESTAMP_OPAQUE_SFT 1
  ...
  __le16 timestamp_hi;
  __le32 event_data1;
#define ASYNC_EVENT_CMPL_PPS_TIMESTAMP_EVENT_DATA1_PPS_TIMESTAMP_LOWER_MASK \
  0xffffffffUL
...
#define ASYNC_EVENT_CMPL_ERROR_REPORT_TYPE_LAST             \
  ASYNC_EVENT_CMPL_ERROR_REPORT_TYPE_HWRM_ASYNC_EVENT
  __le16 event_id;
#define ASYNC_EVENT_CMPL_ERROR_REPORT_EVENT_ID_ERROR_REPORT 0x45UL
#define ASYNC_EVENT_CMPL_ERROR_REPORT_EVENT_ID_LAST        \
  ASYNC_EVENT_CMPL_ERROR_REPORT_EVENT_ID_ERROR_REPORT
  __le32 event_data2;
  u8 opaque_v;
...
#define ASYNC_EVENT_CMPL_HWRM_ERROR_EVENT_DATA2_SEVERITY_LAST     \
...
#define ASYNC_EVENT_CMPL_ERROR_REPORT_BASE_TYPE_LAST             \
...
#define ASYNC_EVENT_CMPL_ERROR_REPORT_BASE_EVENT_ID_LAST        \
  ASYNC_EVENT_CMPL_ERROR_REPORT_BASE_EVENT_ID_ERROR_REPORT
  __le32 event_data2;
  u8 opaque_v;
...
#define ASYNC_EVENT_CMPL_ERROR_REPORT_BASE_OPAQUE_SFT 1
  ...
  __le16 timestamp_hi;
  __le32 event_data1;
#define ASYNC_EVENT_CMPL_ERROR_REPORT_BASE_EVENT_DATA1_ERROR_TYPE_MASK                   \
  0xffUL
#define ASYNC_EVENT_CMPL_ERROR_REPORT_BASE_EVENT_DATA1_ERROR_TYPE_SFT                    \
  0
#define ASYNC_EVENT_CMPL_ERROR_REPORT_BASE_EVENT_DATA1_ERROR_TYPE_RESERVED                 \
  0x0UL
#define ASYNC_EVENT_CMPL_ERROR_REPORT_BASE_EVENT_DATA1_ERROR_TYPE_PAUSE_STORM              \
  0x1UL
#define ASYNC_EVENT_CMPL_ERROR_REPORT_BASE_EVENT_DATA1_ERROR_TYPE_INVALID_SIGNAL           \
  0x2UL
#define ASYNC_EVENT_CMPL_ERROR_REPORT_BASE_EVENT_DATA1_ERROR_TYPE_NVM                      \
  0x3UL
#define \
  ASYNC_EVENT_CMPL_ERROR_REPORT_BASE_EVENT_DATA1_ERROR_TYPE_DOORBELL_DROP_THRESHOLD  \
  0x4UL
#define \
  ASYNC_EVENT_CMPL_ERROR_REPORT_BASE_EVENT_DATA1_ERROR_TYPE_THERMAL_THRESHOLD        \
  0x5UL
#define ASYNC_EVENT_CMPL_ERROR_REPORT_BASE_EVENT_DATA1_ERROR_TYPE_LAST                    \
  ASYNC_EVENT_CMPL_ERROR_REPORT_BASE_EVENT_DATA1_ERROR_TYPE_THERMAL_THRESHOLD
};
...
#define ASYNC_EVENT_CMPL_ERROR_REPORT_PAUSE_STORM_TYPE_LAST             \
  ASYNC_EVENT_CMPL_ERROR_REPORT_PAUSE_STORM_TYPE_HWRM_ASYNC_EVENT
  __le16 event_id;
...
#define ASYNC_EVENT_CMPL_ERROR_REPORT_PAUSE_STORM_OPAQUE_SFT 1
  ...
  __le16 timestamp_hi;
  __le32 event_data1;
#define ASYNC_EVENT_CMPL_ERROR_REPORT_PAUSE_STORM_EVENT_DATA1_ERROR_TYPE_MASK       \
  0xffUL
#define ASYNC_EVENT_CMPL_ERROR_REPORT_PAUSE_STORM_EVENT_DATA1_ERROR_TYPE_SFT        \
  0
#define \
  ASYNC_EVENT_CMPL_ERROR_REPORT_PAUSE_STORM_EVENT_DATA1_ERROR_TYPE_PAUSE_STORM  \
  0x1UL
#define ASYNC_EVENT_CMPL_ERROR_REPORT_PAUSE_STORM_EVENT_DATA1_ERROR_TYPE_LAST        \
  ASYNC_EVENT_CMPL_ERROR_REPORT_PAUSE_STORM_EVENT_DATA1_ERROR_TYPE_PAUSE_STORM
};
...
#define ASYNC_EVENT_CMPL_ERROR_REPORT_INVALID_SIGNAL_TYPE_HWRM_ASYNC_EVENT  \
  0x2eUL
#define ASYNC_EVENT_CMPL_ERROR_REPORT_INVALID_SIGNAL_TYPE_LAST             \
  ...
  __le16 event_id;
#define ASYNC_EVENT_CMPL_ERROR_REPORT_INVALID_SIGNAL_EVENT_ID_ERROR_REPORT \
  0x45UL
#define ASYNC_EVENT_CMPL_ERROR_REPORT_INVALID_SIGNAL_EVENT_ID_LAST        \
  ASYNC_EVENT_CMPL_ERROR_REPORT_INVALID_SIGNAL_EVENT_ID_ERROR_REPORT
  __le32 event_data2;
#define ASYNC_EVENT_CMPL_ERROR_REPORT_INVALID_SIGNAL_EVENT_DATA2_PIN_ID_MASK \
  0xffUL
...
#define ASYNC_EVENT_CMPL_ERROR_REPORT_INVALID_SIGNAL_EVENT_DATA1_ERROR_TYPE_MASK          \
  0xffUL
#define ASYNC_EVENT_CMPL_ERROR_REPORT_INVALID_SIGNAL_EVENT_DATA1_ERROR_TYPE_SFT           \
  0
#define \
  ASYNC_EVENT_CMPL_ERROR_REPORT_INVALID_SIGNAL_EVENT_DATA1_ERROR_TYPE_INVALID_SIGNAL  \
  0x2UL
#define ASYNC_EVENT_CMPL_ERROR_REPORT_INVALID_SIGNAL_EVENT_DATA1_ERROR_TYPE_LAST           \
  ASYNC_EVENT_CMPL_ERROR_REPORT_INVALID_SIGNAL_EVENT_DATA1_ERROR_TYPE_INVALID_SIGNAL
};
...
#define ASYNC_EVENT_CMPL_ERROR_REPORT_NVM_TYPE_LAST             \
...
#define ASYNC_EVENT_CMPL_ERROR_REPORT_NVM_EVENT_ID_LAST        \
  ASYNC_EVENT_CMPL_ERROR_REPORT_NVM_EVENT_ID_ERROR_REPORT
  __le32 event_data2;
...
#define ASYNC_EVENT_CMPL_ERROR_REPORT_NVM_EVENT_DATA1_ERROR_TYPE_NVM_ERROR  \
  0x3UL
#define ASYNC_EVENT_CMPL_ERROR_REPORT_NVM_EVENT_DATA1_ERROR_TYPE_LAST      \
  ASYNC_EVENT_CMPL_ERROR_REPORT_NVM_EVENT_DATA1_ERROR_TYPE_NVM_ERROR
#define ASYNC_EVENT_CMPL_ERROR_REPORT_NVM_EVENT_DATA1_NVM_ERR_TYPE_MASK   \
  0xff00UL
...
#define ASYNC_EVENT_CMPL_ERROR_REPORT_NVM_EVENT_DATA1_NVM_ERR_TYPE_WRITE    ( \
    0x1UL << 8)
#define ASYNC_EVENT_CMPL_ERROR_REPORT_NVM_EVENT_DATA1_NVM_ERR_TYPE_ERASE    ( \
    0x2UL << 8)
#define ASYNC_EVENT_CMPL_ERROR_REPORT_NVM_EVENT_DATA1_NVM_ERR_TYPE_LAST    \
...
struct hwrm_async_event_cmpl_error_report_doorbell_drop_threshold {
  __le16 type;
#define ASYNC_EVENT_CMPL_ERROR_REPORT_DOORBELL_DROP_THRESHOLD_TYPE_MASK            \
  0x3fUL
#define ASYNC_EVENT_CMPL_ERROR_REPORT_DOORBELL_DROP_THRESHOLD_TYPE_SFT             \
  0
#define \
  ASYNC_EVENT_CMPL_ERROR_REPORT_DOORBELL_DROP_THRESHOLD_TYPE_HWRM_ASYNC_EVENT  \
  0x2eUL
#define ASYNC_EVENT_CMPL_ERROR_REPORT_DOORBELL_DROP_THRESHOLD_TYPE_LAST             \
  ASYNC_EVENT_CMPL_ERROR_REPORT_DOORBELL_DROP_THRESHOLD_TYPE_HWRM_ASYNC_EVENT
  __le16 event_id;
#define \
  ASYNC_EVENT_CMPL_ERROR_REPORT_DOORBELL_DROP_THRESHOLD_EVENT_ID_ERROR_REPORT \
  0x45UL
#define ASYNC_EVENT_CMPL_ERROR_REPORT_DOORBELL_DROP_THRESHOLD_EVENT_ID_LAST        \
  ASYNC_EVENT_CMPL_ERROR_REPORT_DOORBELL_DROP_THRESHOLD_EVENT_ID_ERROR_REPORT
  __le32 event_data2;
  u8 opaque_v;
...
#define ASYNC_EVENT_CMPL_ERROR_REPORT_DOORBELL_DROP_THRESHOLD_OPAQUE_SFT 1
  ...
  __le32 event_data1;
#define \
  ASYNC_EVENT_CMPL_ERROR_REPORT_DOORBELL_DROP_THRESHOLD_EVENT_DATA1_ERROR_TYPE_MASK                   \
  0xffUL
#define \
  ASYNC_EVENT_CMPL_ERROR_REPORT_DOORBELL_DROP_THRESHOLD_EVENT_DATA1_ERROR_TYPE_SFT                    \
  0
#define \
  ASYNC_EVENT_CMPL_ERROR_REPORT_DOORBELL_DROP_THRESHOLD_EVENT_DATA1_ERROR_TYPE_DOORBELL_DROP_THRESHOLD  \
  0x4UL
#define \
  ASYNC_EVENT_CMPL_ERROR_REPORT_DOORBELL_DROP_THRESHOLD_EVENT_DATA1_ERROR_TYPE_LAST                    \
  ASYNC_EVENT_CMPL_ERROR_REPORT_DOORBELL_DROP_THRESHOLD_EVENT_DATA1_ERROR_TYPE_DOORBELL_DROP_THRESHOLD
#define \
  ASYNC_EVENT_CMPL_ERROR_REPORT_DOORBELL_DROP_THRESHOLD_EVENT_DATA1_EPOCH_MASK                        \
  0xffffff00UL
#define \
...
#define ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_TYPE_LAST             \
...
#define ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_ID_LAST        \
  ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_ID_ERROR_REPORT
  __le32 event_data2;
#define ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_DATA2_CURRENT_TEMP_MASK  \
  0xffUL
#define ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_DATA2_CURRENT_TEMP_SFT   0
#define ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_DATA2_THRESHOLD_TEMP_MASK \
  0xff00UL
...
#define ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_OPAQUE_SFT 1
  ...
  __le16 timestamp_hi;
  __le32 event_data1;
#define ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_DATA1_ERROR_TYPE_MASK          \
  0xffUL
#define ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_DATA1_ERROR_TYPE_SFT           \
  0
#define \
  ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_DATA1_ERROR_TYPE_THERMAL_EVENT   \
  0x5UL
#define ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_DATA1_ERROR_TYPE_LAST           \
  ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_DATA1_ERROR_TYPE_THERMAL_EVENT
#define ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_DATA1_THRESHOLD_TYPE_MASK      \
  0x700UL
#define ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_DATA1_THRESHOLD_TYPE_SFT       \
  8
#define ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_DATA1_THRESHOLD_TYPE_WARN        ( \
    0x0UL << 8)
#define \
  ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_DATA1_THRESHOLD_TYPE_CRITICAL    ( \
    0x1UL << 8)
#define ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_DATA1_THRESHOLD_TYPE_FATAL       ( \
    0x2UL << 8)
#define \
  ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_DATA1_THRESHOLD_TYPE_SHUTDOWN    ( \
    0x3UL << 8)
#define ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_DATA1_THRESHOLD_TYPE_LAST       \
  ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_DATA1_THRESHOLD_TYPE_SHUTDOWN
#define ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_DATA1_TRANSITION_DIR           \
  0x800UL
#define \
  ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_DATA1_TRANSITION_DIR_DECREASING  ( \
    0x0UL << 11)
#define \
  ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_DATA1_TRANSITION_DIR_INCREASING  ( \
    0x1UL << 11)
#define ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_DATA1_TRANSITION_DIR_LAST       \
  ASYNC_EVENT_CMPL_ERROR_REPORT_THERMAL_EVENT_DATA1_TRANSITION_DIR_INCREASING
};
...
#define FUNC_RESET_REQ_FUNC_RESET_LEVEL_LAST         \
  FUNC_RESET_REQ_FUNC_RESET_LEVEL_RESETVF
  u8 unused_0;
};
...
#define FUNC_QCAPS_RESP_FLAGS_DBG_QCAPS_CMD_SUPPORTED               0x80000000UL
  ...
  __le16 max_msix_vfs;
  __le32 flags_ext;
#define FUNC_QCAPS_RESP_FLAGS_EXT_ECN_MARK_SUPPORTED                          \
  0x1UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_ECN_STATS_SUPPORTED                         \
  0x2UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_EXT_HW_STATS_SUPPORTED                      \
  0x4UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_HOT_RESET_IF_SUPPORT                        \
  0x8UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_PROXY_MODE_SUPPORT                          \
  0x10UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_TX_PROXY_SRC_INTF_OVERRIDE_SUPPORT          \
  0x20UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_SCHQ_SUPPORTED                              \
  0x40UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_PPP_PUSH_MODE_SUPPORTED                     \
  0x80UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_EVB_MODE_CFG_NOT_SUPPORTED                  \
  0x100UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_SOC_SPD_SUPPORTED                           \
  0x200UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_FW_LIVEPATCH_SUPPORTED                      \
  0x400UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_FAST_RESET_CAPABLE                          \
  0x800UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_TX_METADATA_CFG_CAPABLE                     \
  0x1000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_NVM_OPTION_ACTION_SUPPORTED                 \
  0x2000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_BD_METADATA_SUPPORTED                       \
  0x4000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_ECHO_REQUEST_SUPPORTED                      \
  0x8000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_NPAR_1_2_SUPPORTED                          \
  0x10000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_PTP_PTM_SUPPORTED                           \
  0x20000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_PTP_PPS_SUPPORTED                           \
  0x40000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_VF_CFG_ASYNC_FOR_PF_SUPPORTED               \
  0x80000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_PARTITION_BW_SUPPORTED                      \
  0x100000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_DFLT_VLAN_TPID_PCP_SUPPORTED                \
  0x200000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_KTLS_SUPPORTED                              \
  0x400000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_EP_RATE_CONTROL                             \
  0x800000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_MIN_BW_SUPPORTED                            \
  0x1000000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_TX_COAL_CMPL_CAP                            \
  0x2000000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_BS_V2_SUPPORTED                             \
  0x4000000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_BS_V2_REQUIRED                              \
  0x8000000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_PTP_64BIT_RTC_SUPPORTED                     \
  0x10000000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT_DBR_PACING_SUPPORTED                        \
  0x20000000UL
...
#define FUNC_QCAPS_RESP_FLAGS_EXT2_STEERING_TAG_SUPPORTED                \
  0x1000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT2_ENHANCED_VF_SCALE_SUPPORTED           \
  0x2000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT2_KEY_XID_PARTITION_SUPPORTED           \
  0x4000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT2_CONCURRENT_KTLS_QUIC_SUPPORTED        \
  0x8000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT2_SCHQ_CROSS_TC_CAP_SUPPORTED           \
  0x10000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT2_SCHQ_PER_TC_CAP_SUPPORTED             \
  0x20000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT2_SCHQ_PER_TC_RESERVATION_SUPPORTED     \
  0x40000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT2_DB_ERROR_STATS_SUPPORTED              \
  0x80000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT2_ROCE_VF_RESOURCE_MGMT_SUPPORTED       \
  0x100000UL
#define FUNC_QCAPS_RESP_FLAGS_EXT2_UDCC_SUPPORTED                        \
  0x200000UL
...
#define FUNC_QCFG_RESP_PORT_PARTITION_TYPE_LAST   \
  FUNC_QCFG_RESP_PORT_PARTITION_TYPE_UNKNOWN
  u8 port_pf_cnt;
...
#define FUNC_QCFG_RESP_MIN_BW_SCALE_LAST                 \
  FUNC_QCFG_RESP_MIN_BW_SCALE_BYTES
...
#define FUNC_QCFG_RESP_MIN_BW_BW_VALUE_UNIT_LAST         \
...
#define FUNC_QCFG_RESP_MAX_BW_SCALE_LAST                 \
  FUNC_QCFG_RESP_MAX_BW_SCALE_BYTES
...
#define FUNC_QCFG_RESP_MAX_BW_BW_VALUE_UNIT_LAST         \
  FUNC_QCFG_RESP_MAX_BW_BW_VALUE_UNIT_INVALID
  u8 evb_mode;
...
#define FUNC_QCFG_RESP_OPTIONS_LINK_ADMIN_STATE_LAST        \
...
#define FUNC_QCFG_RESP_PARTITION_MIN_BW_SCALE_BITS                  (0x0UL << \
    28)
#define FUNC_QCFG_RESP_PARTITION_MIN_BW_SCALE_BYTES                 (0x1UL << \
    28)
#define FUNC_QCFG_RESP_PARTITION_MIN_BW_SCALE_LAST                 \
...
#define FUNC_QCFG_RESP_PARTITION_MIN_BW_BW_VALUE_UNIT_PERCENT1_100  (0x1UL << \
    29)
#define FUNC_QCFG_RESP_PARTITION_MIN_BW_BW_VALUE_UNIT_LAST         \
  FUNC_QCFG_RESP_PARTITION_MIN_BW_BW_VALUE_UNIT_PERCENT1_100
...
#define FUNC_QCFG_RESP_PARTITION_MAX_BW_SCALE_BITS                  (0x0UL << \
    28)
#define FUNC_QCFG_RESP_PARTITION_MAX_BW_SCALE_BYTES                 (0x1UL << \
    28)
#define FUNC_QCFG_RESP_PARTITION_MAX_BW_SCALE_LAST                 \
...
#define FUNC_QCFG_RESP_PARTITION_MAX_BW_BW_VALUE_UNIT_PERCENT1_100  (0x1UL << \
    29)
#define FUNC_QCFG_RESP_PARTITION_MAX_BW_BW_VALUE_UNIT_LAST         \
  FUNC_QCFG_RESP_PARTITION_MAX_BW_BW_VALUE_UNIT_PERCENT1_100
  __le16 host_mtu;
  u8 unused_3[2];
  u8 unused_4[2];
  u8 port_kdnet_mode;
...
#define FUNC_QCFG_RESP_PORT_KDNET_MODE_LAST    \
  FUNC_QCFG_RESP_PORT_KDNET_MODE_ENABLED
...
#define FUNC_CFG_REQ_MIN_BW_SCALE_LAST                 \
  FUNC_CFG_REQ_MIN_BW_SCALE_BYTES
...
#define FUNC_CFG_REQ_MIN_BW_BW_VALUE_UNIT_LAST         \
  FUNC_CFG_REQ_MIN_BW_BW_VALUE_UNIT_INVALID
  __le32 max_bw;
...
#define FUNC_CFG_REQ_MAX_BW_SCALE_LAST                 \
  FUNC_CFG_REQ_MAX_BW_SCALE_BYTES
...
#define FUNC_CFG_REQ_MAX_BW_BW_VALUE_UNIT_LAST         \
  FUNC_CFG_REQ_MAX_BW_BW_VALUE_UNIT_INVALID
  __le16 async_event_cr;
...
#define FUNC_CFG_REQ_VLAN_ANTISPOOF_MODE_LAST                   \
  FUNC_CFG_REQ_VLAN_ANTISPOOF_MODE_INSERT_OR_OVERRIDE_VLAN
...
#define FUNC_CFG_REQ_OPTIONS_CACHE_LINESIZE_LAST          \
...
#define FUNC_CFG_REQ_OPTIONS_LINK_ADMIN_STATE_LAST        \
  FUNC_CFG_REQ_OPTIONS_LINK_ADMIN_STATE_AUTO
...
#define FUNC_CFG_REQ_PARTITION_MIN_BW_SCALE_LAST                 \
  FUNC_CFG_REQ_PARTITION_MIN_BW_SCALE_BYTES
...
#define FUNC_CFG_REQ_PARTITION_MIN_BW_BW_VALUE_UNIT_LAST         \
  FUNC_CFG_REQ_PARTITION_MIN_BW_BW_VALUE_UNIT_PERCENT1_100
  __le32 partition_max_bw;
...
#define FUNC_CFG_REQ_PARTITION_MAX_BW_SCALE_LAST                 \
  FUNC_CFG_REQ_PARTITION_MAX_BW_SCALE_BYTES
...
#define FUNC_CFG_REQ_PARTITION_MAX_BW_BW_VALUE_UNIT_LAST         \
  FUNC_CFG_REQ_PARTITION_MAX_BW_BW_VALUE_UNIT_PERCENT1_100
  __be16 tpid;
  __le16 host_mtu;
  __le32 flags2;
...
#define FUNC_CFG_REQ_PORT_KDNET_MODE_LAST    \
  FUNC_CFG_REQ_PORT_KDNET_MODE_ENABLED
  u8 db_page_size;
...
#define FUNC_CFG_CMD_ERR_CODE_LAST                        \
  FUNC_CFG_CMD_ERR_CODE_PARTITION_BW_PERCENT
  u8 unused_0[7];
};
...
#define FUNC_BUF_RGTR_REQ_REQ_BUF_PAGE_SIZE_LAST \
  FUNC_BUF_RGTR_REQ_REQ_BUF_PAGE_SIZE_1G
  __le16 req_buf_len;
  __le16 resp_buf_len;
  u8 unused_0[2];
...
#define FUNC_RESOURCE_QCAPS_RESP_VF_RESERVATION_STRATEGY_LAST          \
  FUNC_RESOURCE_QCAPS_RESP_VF_RESERVATION_STRATEGY_MINIMAL_STATIC
...
#define FUNC_BACKING_STORE_CFG_REQ_QPC_LVL_LAST       \
...
#define FUNC_BACKING_STORE_CFG_REQ_QPC_PG_SIZE_LAST   \
...
#define FUNC_BACKING_STORE_CFG_REQ_SRQ_LVL_LAST       \
...
#define FUNC_BACKING_STORE_CFG_REQ_SRQ_PG_SIZE_LAST   \
...
#define FUNC_BACKING_STORE_CFG_REQ_CQ_LVL_LAST       \
...
#define FUNC_BACKING_STORE_CFG_REQ_CQ_PG_SIZE_LAST   \
  FUNC_BACKING_STORE_CFG_REQ_CQ_PG_SIZE_PG_1G
...
#define FUNC_BACKING_STORE_CFG_REQ_VNIC_LVL_LAST       \
...
#define FUNC_BACKING_STORE_CFG_REQ_VNIC_PG_SIZE_LAST   \
  FUNC_BACKING_STORE_CFG_REQ_VNIC_PG_SIZE_PG_1G
...
#define FUNC_BACKING_STORE_CFG_REQ_STAT_LVL_LAST       \
  FUNC_BACKING_STORE_CFG_REQ_STAT_LVL_LVL_2
...
#define FUNC_BACKING_STORE_CFG_REQ_STAT_PG_SIZE_LAST   \
  FUNC_BACKING_STORE_CFG_REQ_STAT_PG_SIZE_PG_1G
...
#define FUNC_BACKING_STORE_CFG_REQ_TQM_SP_LVL_LAST       \
  FUNC_BACKING_STORE_CFG_REQ_TQM_SP_LVL_LVL_2
...
#define FUNC_BACKING_STORE_CFG_REQ_TQM_SP_PG_SIZE_LAST   \
  FUNC_BACKING_STORE_CFG_REQ_TQM_SP_PG_SIZE_PG_1G
...
#define FUNC_BACKING_STORE_CFG_REQ_TQM_RING0_LVL_LAST       \
  FUNC_BACKING_STORE_CFG_REQ_TQM_RING0_LVL_LVL_2
...
#define FUNC_BACKING_STORE_CFG_REQ_TQM_RING1_LVL_LAST       \
  FUNC_BACKING_STORE_CFG_REQ_TQM_RING1_LVL_LVL_2
...
#define FUNC_BACKING_STORE_CFG_REQ_TQM_RING1_PG_SIZE_LAST   \
  FUNC_BACKING_STORE_CFG_REQ_TQM_RING1_PG_SIZE_PG_1G
...
#define FUNC_BACKING_STORE_CFG_REQ_TQM_RING2_LVL_LAST       \
  FUNC_BACKING_STORE_CFG_REQ_TQM_RING2_LVL_LVL_2
...
#define FUNC_BACKING_STORE_CFG_REQ_TQM_RING2_PG_SIZE_LAST   \
  FUNC_BACKING_STORE_CFG_REQ_TQM_RING2_PG_SIZE_PG_1G
...
#define FUNC_BACKING_STORE_CFG_REQ_TQM_RING3_LVL_LAST       \
...
#define FUNC_BACKING_STORE_CFG_REQ_TQM_RING3_PG_SIZE_LAST   \
  FUNC_BACKING_STORE_CFG_REQ_TQM_RING3_PG_SIZE_PG_1G
...
#define FUNC_BACKING_STORE_CFG_REQ_TQM_RING4_LVL_LAST       \
  FUNC_BACKING_STORE_CFG_REQ_TQM_RING4_LVL_LVL_2
...
#define FUNC_BACKING_STORE_CFG_REQ_TQM_RING4_PG_SIZE_LAST   \
  FUNC_BACKING_STORE_CFG_REQ_TQM_RING4_PG_SIZE_PG_1G
...
#define FUNC_BACKING_STORE_CFG_REQ_TQM_RING5_LVL_LAST       \
  FUNC_BACKING_STORE_CFG_REQ_TQM_RING5_LVL_LVL_2
...
#define FUNC_BACKING_STORE_CFG_REQ_TQM_RING6_LVL_LAST       \
  FUNC_BACKING_STORE_CFG_REQ_TQM_RING6_LVL_LVL_2
...
#define FUNC_BACKING_STORE_CFG_REQ_TQM_RING7_LVL_LAST       \
  FUNC_BACKING_STORE_CFG_REQ_TQM_RING7_LVL_LVL_2
...
#define FUNC_BACKING_STORE_CFG_REQ_TQM_RING7_PG_SIZE_LAST   \
  FUNC_BACKING_STORE_CFG_REQ_TQM_RING7_PG_SIZE_PG_1G
...
#define FUNC_BACKING_STORE_CFG_REQ_MRAV_LVL_LAST       \
  FUNC_BACKING_STORE_CFG_REQ_MRAV_LVL_LVL_2
...
#define FUNC_BACKING_STORE_CFG_REQ_MRAV_PG_SIZE_LAST   \
  FUNC_BACKING_STORE_CFG_REQ_MRAV_PG_SIZE_PG_1G
...
#define FUNC_BACKING_STORE_CFG_REQ_TIM_LVL_LAST       \
  FUNC_BACKING_STORE_CFG_REQ_TIM_LVL_LVL_2
...
#define FUNC_BACKING_STORE_CFG_REQ_TIM_PG_SIZE_LAST   \
  FUNC_BACKING_STORE_CFG_REQ_TIM_PG_SIZE_PG_1G
  __le64 qpc_page_dir;
  __le64 srq_page_dir;
  __le64 cq_page_dir;
...
#define FUNC_BACKING_STORE_CFG_REQ_RING8_TQM_RING_LVL_LAST       \
...
#define FUNC_BACKING_STORE_CFG_REQ_RING9_TQM_RING_LVL_LAST       \
  FUNC_BACKING_STORE_CFG_REQ_RING9_TQM_RING_LVL_LVL_2
...
#define FUNC_BACKING_STORE_CFG_REQ_RING10_TQM_RING_LVL_LAST       \
...
#define FUNC_BACKING_STORE_CFG_REQ_RING10_TQM_RING_PG_SIZE_LAST   \
...
#define FUNC_BACKING_STORE_CFG_REQ_TKC_LVL_LAST       \
  FUNC_BACKING_STORE_CFG_REQ_TKC_LVL_LVL_2
...
#define FUNC_BACKING_STORE_CFG_REQ_TKC_PG_SIZE_LAST   \
  FUNC_BACKING_STORE_CFG_REQ_TKC_PG_SIZE_PG_1G
...
#define FUNC_BACKING_STORE_CFG_REQ_RKC_LVL_LAST       \
...
#define FUNC_BACKING_STORE_CFG_REQ_RKC_PG_SIZE_LAST   \
  FUNC_BACKING_STORE_CFG_REQ_RKC_PG_SIZE_PG_1G
...
#define ERROR_RECOVERY_QCFG_RESP_FW_HEALTH_STATUS_REG_ADDR_SPACE_LAST     \
...
#define ERROR_RECOVERY_QCFG_RESP_FW_HEARTBEAT_REG_ADDR_SPACE_LAST     \
...
#define ERROR_RECOVERY_QCFG_RESP_FW_RESET_CNT_REG_ADDR_SPACE_LAST     \
  ERROR_RECOVERY_QCFG_RESP_FW_RESET_CNT_REG_ADDR_SPACE_BAR1
#define ERROR_RECOVERY_QCFG_RESP_FW_RESET_CNT_REG_ADDR_MASK          \
  0xfffffffcUL
...
#define ERROR_RECOVERY_QCFG_RESP_RESET_INPROGRESS_REG_ADDR_SPACE_LAST     \
  ERROR_RECOVERY_QCFG_RESP_RESET_INPROGRESS_REG_ADDR_SPACE_BAR1
#define ERROR_RECOVERY_QCFG_RESP_RESET_INPROGRESS_REG_ADDR_MASK          \
  0xfffffffcUL
...
#define ERROR_RECOVERY_QCFG_RESP_RESET_REG_ADDR_SPACE_LAST     \
...
#define ERROR_RECOVERY_QCFG_RESP_ERR_RECOVERY_CNT_REG_ADDR_SPACE_LAST     \
  ERROR_RECOVERY_QCFG_RESP_ERR_RECOVERY_CNT_REG_ADDR_SPACE_BAR1
#define ERROR_RECOVERY_QCFG_RESP_ERR_RECOVERY_CNT_REG_ADDR_MASK          \
  0xfffffffcUL
...
#define FUNC_PTP_PIN_QCFG_RESP_PIN0_USAGE_LAST    \
  FUNC_PTP_PIN_QCFG_RESP_PIN0_USAGE_SYNC_OUT
  u8 pin1_usage;
...
#define FUNC_PTP_PIN_QCFG_RESP_PIN1_USAGE_LAST    \
...
#define FUNC_PTP_PIN_QCFG_RESP_PIN2_USAGE_LAST                     \
  FUNC_PTP_PIN_QCFG_RESP_PIN2_USAGE_SYNCE_SECONDARY_CLOCK_OUT
  u8 pin3_usage;
...
#define FUNC_PTP_PIN_QCFG_RESP_PIN3_USAGE_LAST                     \
  FUNC_PTP_PIN_QCFG_RESP_PIN3_USAGE_SYNCE_SECONDARY_CLOCK_OUT
  u8 unused_0;
  u8 valid;
};
...
#define FUNC_PTP_PIN_CFG_REQ_PIN0_STATE_LAST    \
  FUNC_PTP_PIN_CFG_REQ_PIN0_STATE_ENABLED
  u8 pin0_usage;
...
#define FUNC_PTP_PIN_CFG_REQ_PIN0_USAGE_LAST    \
  FUNC_PTP_PIN_CFG_REQ_PIN0_USAGE_SYNC_OUT
  u8 pin1_state;
#define FUNC_PTP_PIN_CFG_REQ_PIN1_STATE_DISABLED 0x0UL
#define FUNC_PTP_PIN_CFG_REQ_PIN1_STATE_ENABLED  0x1UL
#define FUNC_PTP_PIN_CFG_REQ_PIN1_STATE_LAST    \
  FUNC_PTP_PIN_CFG_REQ_PIN1_STATE_ENABLED
  u8 pin1_usage;
...
#define FUNC_PTP_PIN_CFG_REQ_PIN1_USAGE_LAST    \
...
#define FUNC_PTP_PIN_CFG_REQ_PIN2_STATE_LAST    \
  FUNC_PTP_PIN_CFG_REQ_PIN2_STATE_ENABLED
  u8 pin2_usage;
...
#define FUNC_PTP_PIN_CFG_REQ_PIN2_USAGE_LAST                     \
  FUNC_PTP_PIN_CFG_REQ_PIN2_USAGE_SYNCE_SECONDARY_CLOCK_OUT
  u8 pin3_state;
#define FUNC_PTP_PIN_CFG_REQ_PIN3_STATE_DISABLED 0x0UL
#define FUNC_PTP_PIN_CFG_REQ_PIN3_STATE_ENABLED  0x1UL
#define FUNC_PTP_PIN_CFG_REQ_PIN3_STATE_LAST    \
  FUNC_PTP_PIN_CFG_REQ_PIN3_STATE_ENABLED
  u8 pin3_usage;
...
#define FUNC_PTP_PIN_CFG_REQ_PIN3_USAGE_LAST                     \
  FUNC_PTP_PIN_CFG_REQ_PIN3_USAGE_SYNCE_SECONDARY_CLOCK_OUT
  u8 unused_0[4];
};
...
#define FUNC_PTP_CFG_REQ_PTP_FREQ_ADJ_DLL_SOURCE_LAST   \
...
#define FUNC_PTP_CFG_REQ_PTP_FREQ_ADJ_DLL_PHASE_LAST \
  FUNC_PTP_CFG_REQ_PTP_FREQ_ADJ_DLL_PHASE_25M
  u8 unused_0[3];
...
#define FUNC_PTP_EXT_CFG_REQ_PHC_SEC_MODE_LAST   \
  FUNC_PTP_EXT_CFG_REQ_PHC_SEC_MODE_PF_ONLY
  u8 unused_0;
...
#define FUNC_BACKING_STORE_CFG_V2_REQ_TYPE_LAST         \
  FUNC_BACKING_STORE_CFG_V2_REQ_TYPE_INVALID
  __le16 instance;
  __le32 flags;
...
#define FUNC_BACKING_STORE_CFG_V2_REQ_PBL_LEVEL_LAST   \
  FUNC_BACKING_STORE_CFG_V2_REQ_PBL_LEVEL_LVL_2
...
#define FUNC_BACKING_STORE_CFG_V2_REQ_PAGE_SIZE_LAST   \
  FUNC_BACKING_STORE_CFG_V2_REQ_PAGE_SIZE_PG_1G
...
#define FUNC_BACKING_STORE_QCFG_V2_REQ_TYPE_LAST               \
  FUNC_BACKING_STORE_QCFG_V2_REQ_TYPE_INVALID
  __le16 instance;
  u8 rsvd[4];
};
...
#define FUNC_BACKING_STORE_QCFG_V2_RESP_TYPE_LAST         \
  FUNC_BACKING_STORE_QCFG_V2_RESP_TYPE_INVALID
  __le16 instance;
  __le32 flags;
  __le64 page_dir;
  __le32 num_entries;
...
#define FUNC_BACKING_STORE_QCFG_V2_RESP_PBL_LEVEL_LAST   \
  FUNC_BACKING_STORE_QCFG_V2_RESP_PBL_LEVEL_LVL_2
...
#define FUNC_BACKING_STORE_QCFG_V2_RESP_PAGE_SIZE_LAST   \
  FUNC_BACKING_STORE_QCFG_V2_RESP_PAGE_SIZE_PG_1G
  u8 subtype_valid_cnt;
  u8 rsvd[2];
  __le32 split_entry_0;
  __le32 split_entry_1;
...
#define FUNC_BACKING_STORE_QCAPS_V2_REQ_TYPE_LAST         \
  FUNC_BACKING_STORE_QCAPS_V2_REQ_TYPE_INVALID
  u8 rsvd[6];
};
...
#define FUNC_BACKING_STORE_QCAPS_V2_RESP_TYPE_LAST         \
  FUNC_BACKING_STORE_QCAPS_V2_RESP_TYPE_INVALID
  __le16 entry_size;
  __le32 flags;
#define FUNC_BACKING_STORE_QCAPS_V2_RESP_FLAGS_ENABLE_CTX_KIND_INIT            \
  0x1UL
#define FUNC_BACKING_STORE_QCAPS_V2_RESP_FLAGS_TYPE_VALID                      \
  0x2UL
#define FUNC_BACKING_STORE_QCAPS_V2_RESP_FLAGS_DRIVER_MANAGED_MEMORY           \
  0x4UL
#define FUNC_BACKING_STORE_QCAPS_V2_RESP_FLAGS_ROCE_QP_PSEUDO_STATIC_ALLOC     \
  0x8UL
...
#define FUNC_BACKING_STORE_QCAPS_V2_RESP_EXACT_CNT_BIT_MAP_SPLIT_ENTRY_0_EXACT     \
  0x1UL
#define FUNC_BACKING_STORE_QCAPS_V2_RESP_EXACT_CNT_BIT_MAP_SPLIT_ENTRY_1_EXACT     \
  0x2UL
#define FUNC_BACKING_STORE_QCAPS_V2_RESP_EXACT_CNT_BIT_MAP_SPLIT_ENTRY_2_EXACT     \
  0x4UL
#define FUNC_BACKING_STORE_QCAPS_V2_RESP_EXACT_CNT_BIT_MAP_SPLIT_ENTRY_3_EXACT     \
  0x8UL
#define FUNC_BACKING_STORE_QCAPS_V2_RESP_EXACT_CNT_BIT_MAP_UNUSED_MASK             \
  0xf0UL
#define FUNC_BACKING_STORE_QCAPS_V2_RESP_EXACT_CNT_BIT_MAP_UNUSED_SFT              \
  4
  __le32 split_entry_0;
  __le32 split_entry_1;
  __le32 split_entry_2;
...
#define FUNC_DBR_PACING_QCFG_RESP_DBR_STAT_DB_FIFO_REG_ADDR_SPACE_PCIE_CFG  \
  0x0UL
#define FUNC_DBR_PACING_QCFG_RESP_DBR_STAT_DB_FIFO_REG_ADDR_SPACE_GRC       \
  0x1UL
#define FUNC_DBR_PACING_QCFG_RESP_DBR_STAT_DB_FIFO_REG_ADDR_SPACE_BAR0      \
  0x2UL
#define FUNC_DBR_PACING_QCFG_RESP_DBR_STAT_DB_FIFO_REG_ADDR_SPACE_BAR1      \
  0x3UL
...
#define FUNC_DBR_PACING_QCFG_RESP_DBR_STAT_DB_FIFO_REG_ADDR_MASK          \
  0xfffffffcUL
...
#define FUNC_DBR_PACING_QCFG_RESP_DBR_THROTTLING_AEQ_ARM_REG_ADDR_SPACE_MASK    \
  0x3UL
#define FUNC_DBR_PACING_QCFG_RESP_DBR_THROTTLING_AEQ_ARM_REG_ADDR_SPACE_SFT     \
  0
#define FUNC_DBR_PACING_QCFG_RESP_DBR_THROTTLING_AEQ_ARM_REG_ADDR_SPACE_PCIE_CFG  \
  0x0UL
#define FUNC_DBR_PACING_QCFG_RESP_DBR_THROTTLING_AEQ_ARM_REG_ADDR_SPACE_GRC       \
  0x1UL
#define FUNC_DBR_PACING_QCFG_RESP_DBR_THROTTLING_AEQ_ARM_REG_ADDR_SPACE_BAR0      \
  0x2UL
#define FUNC_DBR_PACING_QCFG_RESP_DBR_THROTTLING_AEQ_ARM_REG_ADDR_SPACE_BAR1      \
  0x3UL
...
#define FUNC_DBR_PACING_QCFG_RESP_DBR_THROTTLING_AEQ_ARM_REG_ADDR_MASK          \
  0xfffffffcUL
#define FUNC_DBR_PACING_QCFG_RESP_DBR_THROTTLING_AEQ_ARM_REG_ADDR_SFT           \
  2
...
#define PORT_PHY_CFG_REQ_FORCE_LINK_SPEED_LAST \
...
#define PORT_PHY_CFG_REQ_AUTO_MODE_LAST        \
...
#define PORT_PHY_CFG_REQ_AUTO_LINK_SPEED_LAST \
...
#define PORT_PHY_CFG_REQ_FORCE_PAM4_LINK_SPEED_LAST \
...
#define PORT_PHY_CFG_REQ_FORCE_LINK_SPEEDS2_LAST          \
...
#define PORT_PHY_QCFG_RESP_SIGNAL_MODE_LAST                 \
...
#define PORT_PHY_QCFG_RESP_ACTIVE_FEC_LAST                  \
...
#define PORT_PHY_QCFG_RESP_PHY_TYPE_LAST            \
  PORT_PHY_QCFG_RESP_PHY_TYPE_400G_BASEER4
  u8 media_type;
...
#define PORT_PHY_QCFG_RESP_FORCE_PAM4_LINK_SPEED_LAST \
  PORT_PHY_QCFG_RESP_FORCE_PAM4_LINK_SPEED_200GB
...
#define PORT_PHY_QCFG_RESP_FORCE_LINK_SPEEDS2_LAST          \
  PORT_PHY_QCFG_RESP_FORCE_LINK_SPEEDS2_800GB_PAM4_112
...
#define PORT_MAC_CFG_REQ_PTP_LOAD_CONTROL_LAST     \
  PORT_MAC_CFG_REQ_PTP_LOAD_CONTROL_PPS_EVENT
...
#define PORT_TS_QUERY_REQ_FLAGS_PATH_LAST         \
...
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_FORCE_MODE_1GB                \
  0x1UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_FORCE_MODE_10GB               \
  0x2UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_FORCE_MODE_25GB               \
  0x4UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_FORCE_MODE_40GB               \
  0x8UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_FORCE_MODE_50GB               \
  0x10UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_FORCE_MODE_100GB              \
  0x20UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_FORCE_MODE_50GB_PAM4_56       \
  0x40UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_FORCE_MODE_100GB_PAM4_56      \
  0x80UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_FORCE_MODE_200GB_PAM4_56      \
  0x100UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_FORCE_MODE_400GB_PAM4_56      \
  0x200UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_FORCE_MODE_100GB_PAM4_112     \
  0x400UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_FORCE_MODE_200GB_PAM4_112     \
  0x800UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_FORCE_MODE_400GB_PAM4_112     \
  0x1000UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_FORCE_MODE_800GB_PAM4_112     \
  0x2000UL
...
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_AUTO_MODE_50GB               \
  0x10UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_AUTO_MODE_100GB              \
  0x20UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_AUTO_MODE_50GB_PAM4_56       \
  0x40UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_AUTO_MODE_100GB_PAM4_56      \
  0x80UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_AUTO_MODE_200GB_PAM4_56      \
  0x100UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_AUTO_MODE_400GB_PAM4_56      \
  0x200UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_AUTO_MODE_100GB_PAM4_112     \
  0x400UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_AUTO_MODE_200GB_PAM4_112     \
  0x800UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_AUTO_MODE_400GB_PAM4_112     \
  0x1000UL
#define PORT_PHY_QCAPS_RESP_SUPPORTED_SPEEDS2_AUTO_MODE_800GB_PAM4_112     \
  0x2000UL
  u8 unused_1[3];
  u8 valid;
};
...
#define PORT_LED_CFG_REQ_LED0_COLOR_LAST      \
...
#define PORT_LED_CFG_REQ_LED1_COLOR_LAST      \
...
#define PORT_LED_CFG_REQ_LED2_COLOR_LAST      \
...
#define PORT_LED_CFG_REQ_LED3_COLOR_LAST      \
...
#define PORT_LED_QCFG_RESP_LED0_TYPE_LAST    \
...
#define PORT_LED_QCFG_RESP_LED0_STATE_LAST    \
...
#define PORT_LED_QCFG_RESP_LED0_COLOR_LAST      \
...
#define PORT_LED_QCFG_RESP_LED1_TYPE_LAST    \
...
#define PORT_LED_QCFG_RESP_LED1_STATE_LAST    \
...
#define PORT_LED_QCFG_RESP_LED1_COLOR_LAST      \
...
#define PORT_LED_QCFG_RESP_LED2_STATE_LAST    \
...
#define PORT_LED_QCFG_RESP_LED2_COLOR_LAST      \
...
#define PORT_LED_QCFG_RESP_LED3_TYPE_LAST    \
...
#define PORT_LED_QCFG_RESP_LED3_STATE_LAST    \
...
#define PORT_LED_QCAPS_RESP_LED0_TYPE_LAST    \
...
#define PORT_LED_QCAPS_RESP_LED1_TYPE_LAST    \
...
#define PORT_LED_QCAPS_RESP_LED2_TYPE_LAST    \
...
#define PORT_LED_QCAPS_RESP_LED3_TYPE_LAST    \
...
#define QUEUE_QPORTCFG_REQ_DRV_QMAP_CAP_LAST    \
...
#define QUEUE_QPORTCFG_RESP_QUEUE_ID0_SERVICE_PROFILE_LAST          \
...
#define QUEUE_QPORTCFG_RESP_QUEUE_ID1_SERVICE_PROFILE_LAST          \
...
#define QUEUE_QPORTCFG_RESP_QUEUE_ID2_SERVICE_PROFILE_LAST          \
...
#define QUEUE_QPORTCFG_RESP_QUEUE_ID3_SERVICE_PROFILE_LAST          \
...
#define QUEUE_QPORTCFG_RESP_QUEUE_ID4_SERVICE_PROFILE_LAST          \
...
#define QUEUE_QPORTCFG_RESP_QUEUE_ID5_SERVICE_PROFILE_LAST          \
...
#define QUEUE_QPORTCFG_RESP_QUEUE_ID6_SERVICE_PROFILE_LAST          \
...
#define QUEUE_QPORTCFG_RESP_QUEUE_ID7_SERVICE_PROFILE_LAST          \
...
#define QUEUE_QCFG_RESP_SERVICE_PROFILE_LAST    \
  QUEUE_QCFG_RESP_SERVICE_PROFILE_UNKNOWN
  u8 queue_cfg_info;
...
#define QUEUE_CFG_REQ_SERVICE_PROFILE_LAST    \
...
#define QUEUE_PRI2COS_CFG_REQ_FLAGS_PATH_LAST  \
...
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MIN_BW_BW_VALUE_MASK             \
  0xfffffffUL
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MIN_BW_BW_VALUE_SFT              0
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MIN_BW_SCALE                     \
  0x10000000UL
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MIN_BW_SCALE_BITS                  ( \
    0x0UL << 28)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MIN_BW_SCALE_BYTES                 ( \
    0x1UL << 28)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MIN_BW_SCALE_LAST                 \
  QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MIN_BW_SCALE_BYTES
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MIN_BW_BW_VALUE_UNIT_MASK        \
  0xe0000000UL
...
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MIN_BW_BW_VALUE_UNIT_MEGA          ( \
    0x0UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MIN_BW_BW_VALUE_UNIT_KILO          ( \
    0x2UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MIN_BW_BW_VALUE_UNIT_BASE          ( \
    0x4UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MIN_BW_BW_VALUE_UNIT_GIGA          ( \
    0x6UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MIN_BW_BW_VALUE_UNIT_PERCENT1_100  ( \
    0x1UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MIN_BW_BW_VALUE_UNIT_INVALID       ( \
    0x7UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MIN_BW_BW_VALUE_UNIT_LAST         \
  QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MIN_BW_BW_VALUE_UNIT_INVALID
  __le32 queue_id0_max_bw;
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MAX_BW_BW_VALUE_MASK             \
  0xfffffffUL
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MAX_BW_BW_VALUE_SFT              0
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MAX_BW_SCALE                     \
  0x10000000UL
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MAX_BW_SCALE_BITS                  ( \
    0x0UL << 28)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MAX_BW_SCALE_BYTES                 ( \
    0x1UL << 28)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MAX_BW_SCALE_LAST                 \
  QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MAX_BW_SCALE_BYTES
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MAX_BW_BW_VALUE_UNIT_MASK        \
  0xe0000000UL
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MAX_BW_BW_VALUE_UNIT_SFT         29
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MAX_BW_BW_VALUE_UNIT_MEGA          ( \
    0x0UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MAX_BW_BW_VALUE_UNIT_KILO          ( \
    0x2UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MAX_BW_BW_VALUE_UNIT_BASE          ( \
    0x4UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MAX_BW_BW_VALUE_UNIT_GIGA          ( \
    0x6UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MAX_BW_BW_VALUE_UNIT_PERCENT1_100  ( \
    0x1UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MAX_BW_BW_VALUE_UNIT_INVALID       ( \
    0x7UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID0_MAX_BW_BW_VALUE_UNIT_LAST         \
...
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MIN_BW_BW_VALUE_MASK             \
  0xfffffffUL
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MIN_BW_BW_VALUE_SFT              0
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MIN_BW_SCALE                     \
  0x10000000UL
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MIN_BW_SCALE_BITS                  ( \
    0x0UL << 28)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MIN_BW_SCALE_BYTES                 ( \
    0x1UL << 28)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MIN_BW_SCALE_LAST                 \
  QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MIN_BW_SCALE_BYTES
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MIN_BW_BW_VALUE_UNIT_MASK        \
  0xe0000000UL
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MIN_BW_BW_VALUE_UNIT_SFT         29
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MIN_BW_BW_VALUE_UNIT_MEGA          ( \
    0x0UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MIN_BW_BW_VALUE_UNIT_KILO          ( \
    0x2UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MIN_BW_BW_VALUE_UNIT_BASE          ( \
    0x4UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MIN_BW_BW_VALUE_UNIT_GIGA          ( \
    0x6UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MIN_BW_BW_VALUE_UNIT_PERCENT1_100  ( \
    0x1UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MIN_BW_BW_VALUE_UNIT_INVALID       ( \
    0x7UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MIN_BW_BW_VALUE_UNIT_LAST         \
  QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MIN_BW_BW_VALUE_UNIT_INVALID
    __le32 queue_id_max_bw;
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MAX_BW_BW_VALUE_MASK             \
  0xfffffffUL
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MAX_BW_BW_VALUE_SFT              0
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MAX_BW_SCALE                     \
  0x10000000UL
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MAX_BW_SCALE_BITS                  ( \
    0x0UL << 28)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MAX_BW_SCALE_BYTES                 ( \
    0x1UL << 28)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MAX_BW_SCALE_LAST                 \
...
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MAX_BW_BW_VALUE_UNIT_MEGA          ( \
    0x0UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MAX_BW_BW_VALUE_UNIT_KILO          ( \
    0x2UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MAX_BW_BW_VALUE_UNIT_BASE          ( \
    0x4UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MAX_BW_BW_VALUE_UNIT_GIGA          ( \
    0x6UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MAX_BW_BW_VALUE_UNIT_PERCENT1_100  ( \
    0x1UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MAX_BW_BW_VALUE_UNIT_INVALID       ( \
    0x7UL << 29)
#define QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MAX_BW_BW_VALUE_UNIT_LAST         \
  QUEUE_COS2BW_QCFG_RESP_QUEUE_ID_MAX_BW_BW_VALUE_UNIT_INVALID
...
#define QUEUE_COS2BW_CFG_REQ_ENABLES_COS_QUEUE_ID7_VALID     0x80UL
  ...
  u8 unused_0;
  __le32 queue_id0_min_bw;
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MIN_BW_BW_VALUE_MASK             \
  0xfffffffUL
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MIN_BW_BW_VALUE_SFT              0
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MIN_BW_SCALE                     \
  0x10000000UL
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MIN_BW_SCALE_BITS                  (0x0UL \
    << 28)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MIN_BW_SCALE_BYTES                 (0x1UL \
    << 28)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MIN_BW_SCALE_LAST                 \
  QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MIN_BW_SCALE_BYTES
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MIN_BW_BW_VALUE_UNIT_MASK        \
  0xe0000000UL
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MIN_BW_BW_VALUE_UNIT_SFT         29
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MIN_BW_BW_VALUE_UNIT_MEGA          (0x0UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MIN_BW_BW_VALUE_UNIT_KILO          (0x2UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MIN_BW_BW_VALUE_UNIT_BASE          (0x4UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MIN_BW_BW_VALUE_UNIT_GIGA          (0x6UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MIN_BW_BW_VALUE_UNIT_PERCENT1_100  (0x1UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MIN_BW_BW_VALUE_UNIT_INVALID       (0x7UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MIN_BW_BW_VALUE_UNIT_LAST         \
  QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MIN_BW_BW_VALUE_UNIT_INVALID
  __le32 queue_id0_max_bw;
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MAX_BW_BW_VALUE_MASK             \
  0xfffffffUL
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MAX_BW_BW_VALUE_SFT              0
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MAX_BW_SCALE                     \
  0x10000000UL
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MAX_BW_SCALE_BITS                  (0x0UL \
    << 28)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MAX_BW_SCALE_BYTES                 (0x1UL \
    << 28)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MAX_BW_SCALE_LAST                 \
...
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MAX_BW_BW_VALUE_UNIT_MEGA          (0x0UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MAX_BW_BW_VALUE_UNIT_KILO          (0x2UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MAX_BW_BW_VALUE_UNIT_BASE          (0x4UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MAX_BW_BW_VALUE_UNIT_GIGA          (0x6UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MAX_BW_BW_VALUE_UNIT_PERCENT1_100  (0x1UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MAX_BW_BW_VALUE_UNIT_INVALID       (0x7UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_MAX_BW_BW_VALUE_UNIT_LAST         \
...
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID0_TSA_ASSIGN_RESERVED_LAST  0xffUL
  ...
  struct {
    u8 queue_id;
    __le32 queue_id_min_bw;
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MIN_BW_BW_VALUE_MASK             \
  0xfffffffUL
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MIN_BW_BW_VALUE_SFT              0
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MIN_BW_SCALE                     \
  0x10000000UL
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MIN_BW_SCALE_BITS                  (0x0UL \
    << 28)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MIN_BW_SCALE_BYTES                 (0x1UL \
    << 28)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MIN_BW_SCALE_LAST                 \
  QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MIN_BW_SCALE_BYTES
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MIN_BW_BW_VALUE_UNIT_MASK        \
  0xe0000000UL
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MIN_BW_BW_VALUE_UNIT_SFT         29
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MIN_BW_BW_VALUE_UNIT_MEGA          (0x0UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MIN_BW_BW_VALUE_UNIT_KILO          (0x2UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MIN_BW_BW_VALUE_UNIT_BASE          (0x4UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MIN_BW_BW_VALUE_UNIT_GIGA          (0x6UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MIN_BW_BW_VALUE_UNIT_PERCENT1_100  (0x1UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MIN_BW_BW_VALUE_UNIT_INVALID       (0x7UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MIN_BW_BW_VALUE_UNIT_LAST         \
  QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MIN_BW_BW_VALUE_UNIT_INVALID
    __le32 queue_id_max_bw;
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MAX_BW_BW_VALUE_MASK             \
  0xfffffffUL
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MAX_BW_BW_VALUE_SFT              0
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MAX_BW_SCALE                     \
  0x10000000UL
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MAX_BW_SCALE_BITS                  (0x0UL \
    << 28)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MAX_BW_SCALE_BYTES                 (0x1UL \
    << 28)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MAX_BW_SCALE_LAST                 \
  QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MAX_BW_SCALE_BYTES
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MAX_BW_BW_VALUE_UNIT_MASK        \
  0xe0000000UL
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MAX_BW_BW_VALUE_UNIT_SFT         29
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MAX_BW_BW_VALUE_UNIT_MEGA          (0x0UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MAX_BW_BW_VALUE_UNIT_KILO          (0x2UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MAX_BW_BW_VALUE_UNIT_BASE          (0x4UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MAX_BW_BW_VALUE_UNIT_GIGA          (0x6UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MAX_BW_BW_VALUE_UNIT_PERCENT1_100  (0x1UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MAX_BW_BW_VALUE_UNIT_INVALID       (0x7UL \
    << 29)
#define QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MAX_BW_BW_VALUE_UNIT_LAST         \
  QUEUE_COS2BW_CFG_REQ_QUEUE_ID_MAX_BW_BW_VALUE_UNIT_INVALID
    u8 queue_id_tsa_assign;
...
#define VNIC_QCAPS_RESP_FLAGS_RSS_IPSEC_ESP_SPI_IPV6_CAP              \
  0x1000000UL
#define VNIC_QCAPS_RESP_FLAGS_OUTERMOST_RSS_TRUSTED_VF_CAP            \
  0x2000000UL
#define VNIC_QCAPS_RESP_FLAGS_PORTCOS_MAPPING_MODE                    \
  0x4000000UL
#define VNIC_QCAPS_RESP_FLAGS_RSS_PROF_TCAM_MODE_ENABLED              \
  0x8000000UL
#define VNIC_QCAPS_RESP_FLAGS_VNIC_RSS_HASH_MODE_CAP                  \
  0x10000000UL
#define VNIC_QCAPS_RESP_FLAGS_HW_TUNNEL_TPA_CAP                       \
  0x20000000UL
...
#define VNIC_RSS_CFG_REQ_RING_SELECT_MODE_LAST             \
  VNIC_RSS_CFG_REQ_RING_SELECT_MODE_TOEPLITZ_CHECKSUM
  u8 unused_1[4];
};
...
#define VNIC_RSS_CFG_CMD_ERR_CODE_LAST               \
  VNIC_RSS_CFG_CMD_ERR_CODE_INTERFACE_NOT_READY
  u8 unused_0[7];
};
...
#define VNIC_RSS_QCFG_RESP_RING_SELECT_MODE_LAST             \
  VNIC_RSS_QCFG_RESP_RING_SELECT_MODE_TOEPLITZ_CHECKSUM
  u8 unused_1[5];
  u8 valid;
};
...
#define RING_ALLOC_REQ_CMPL_COAL_CNT_LAST    \
  RING_ALLOC_REQ_CMPL_COAL_CNT_COAL_MAX
  __le16 flags;
...
#define RING_ALLOC_REQ_RING_ARB_CFG_ARB_POLICY_LAST       \
...
#define RING_ALLOC_REQ_MAX_BW_BW_VALUE_UNIT_LAST         \
...
#define RING_ALLOC_REQ_MPC_CHNLS_TYPE_LAST   \
  RING_ALLOC_REQ_MPC_CHNLS_TYPE_PRIMATE
  u8 unused_4[2];
  __le64 cq_handle;
};
...
#define RING_ALLOC_RESP_PUSH_BUFFER_INDEX_LAST       \
  RING_ALLOC_RESP_PUSH_BUFFER_INDEX_PONG_BUFFER
  u8 unused_0[2];
  u8 valid;
};
...
#define RING_FREE_REQ_FLAGS_LAST             \
  RING_FREE_REQ_FLAGS_VIRTIO_RING_VALID
  __le16 ring_id;
  __le32 prod_idx;
  __le32 opaque;
  __le32 unused_1;
...
#define RING_RESET_RESP_PUSH_BUFFER_INDEX_LAST       \
  RING_RESET_RESP_PUSH_BUFFER_INDEX_PONG_BUFFER
  u8 unused_0[3];
  u8 consumer_idx[3];
  u8 valid;
};
...
struct hwrm_ring_aggint_qcaps_output {
  ...
  __le16 resp_len;
  __le32 cmpl_params;
#define RING_AGGINT_QCAPS_RESP_CMPL_PARAMS_INT_LAT_TMR_MIN                  \
  0x1UL
#define RING_AGGINT_QCAPS_RESP_CMPL_PARAMS_INT_LAT_TMR_MAX                  \
  0x2UL
#define RING_AGGINT_QCAPS_RESP_CMPL_PARAMS_TIMER_RESET                      \
  0x4UL
#define RING_AGGINT_QCAPS_RESP_CMPL_PARAMS_RING_IDLE                        \
  0x8UL
#define RING_AGGINT_QCAPS_RESP_CMPL_PARAMS_NUM_CMPL_DMA_AGGR                \
  0x10UL
#define RING_AGGINT_QCAPS_RESP_CMPL_PARAMS_NUM_CMPL_DMA_AGGR_DURING_INT     \
  0x20UL
#define RING_AGGINT_QCAPS_RESP_CMPL_PARAMS_CMPL_AGGR_DMA_TMR                \
  0x40UL
#define RING_AGGINT_QCAPS_RESP_CMPL_PARAMS_CMPL_AGGR_DMA_TMR_DURING_INT     \
  0x80UL
...
#define RING_CMPL_RING_CFG_AGGINT_PARAMS_REQ_FLAGS_IS_NQ           0x4UL
  ...
  __le16 num_cmpl_aggr_int;
  __le16 enables;
#define RING_CMPL_RING_CFG_AGGINT_PARAMS_REQ_ENABLES_NUM_CMPL_DMA_AGGR                \
  0x1UL
#define \
  RING_CMPL_RING_CFG_AGGINT_PARAMS_REQ_ENABLES_NUM_CMPL_DMA_AGGR_DURING_INT     \
  0x2UL
#define RING_CMPL_RING_CFG_AGGINT_PARAMS_REQ_ENABLES_CMPL_AGGR_DMA_TMR                \
  0x4UL
#define RING_CMPL_RING_CFG_AGGINT_PARAMS_REQ_ENABLES_INT_LAT_TMR_MIN                  \
  0x8UL
#define RING_CMPL_RING_CFG_AGGINT_PARAMS_REQ_ENABLES_INT_LAT_TMR_MAX                  \
  0x10UL
#define RING_CMPL_RING_CFG_AGGINT_PARAMS_REQ_ENABLES_NUM_CMPL_AGGR_INT                \
  0x20UL
  u8 unused_0[4];
};
...
#define CFA_L2_FILTER_ALLOC_REQ_FLAGS_PATH_LAST          \
...
#define CFA_L2_FILTER_ALLOC_REQ_SRC_TYPE_LAST \
...
#define CFA_L2_FILTER_ALLOC_REQ_TUNNEL_TYPE_LAST        \
...
#define CFA_L2_FILTER_ALLOC_REQ_PRI_HINT_LAST        \
...
#define CFA_L2_FILTER_ALLOC_RESP_FLOW_ID_TYPE_LAST  \
...
#define CFA_L2_FILTER_ALLOC_RESP_FLOW_ID_DIR_LAST   \
...
#define CFA_L2_FILTER_CFG_REQ_FLAGS_PATH_LAST          \
...
#define CFA_L2_FILTER_CFG_REQ_FLAGS_TRAFFIC_LAST       \
...
#define CFA_L2_SET_RX_MASK_CMD_ERR_CODE_LAST                      \
...
#define CFA_TUNNEL_FILTER_ALLOC_REQ_TUNNEL_TYPE_LAST        \
  CFA_TUNNEL_FILTER_ALLOC_REQ_TUNNEL_TYPE_ANYTUNNEL
  u8 tunnel_flags;
#define CFA_TUNNEL_FILTER_ALLOC_REQ_TUNNEL_FLAGS_TUN_FLAGS_OAM_CHECKSUM_EXPLHDR     \
  0x1UL
#define CFA_TUNNEL_FILTER_ALLOC_REQ_TUNNEL_FLAGS_TUN_FLAGS_CRITICAL_OPT_S1          \
  0x2UL
#define CFA_TUNNEL_FILTER_ALLOC_REQ_TUNNEL_FLAGS_TUN_FLAGS_EXTHDR_SEQNUM_S0         \
  0x4UL
  __le32 vni;
  __le32 dst_vnic_id;
...
#define CFA_TUNNEL_FILTER_ALLOC_RESP_FLOW_ID_TYPE_LAST  \
...
#define CFA_TUNNEL_FILTER_ALLOC_RESP_FLOW_ID_DIR_LAST   \
...
#define VXLAN_IPV6_HDR_VER_TC_FLOW_LABEL_LAST           \
...
#define CFA_ENCAP_RECORD_ALLOC_REQ_ENCAP_TYPE_LAST        \
  CFA_ENCAP_RECORD_ALLOC_REQ_ENCAP_TYPE_VXLAN_GPE
  u8 unused_0[3];
...
#define CFA_NTUPLE_FILTER_ALLOC_REQ_TUNNEL_TYPE_LAST        \
...
#define CFA_NTUPLE_FILTER_ALLOC_REQ_PRI_HINT_LAST     \
...
#define CFA_NTUPLE_FILTER_ALLOC_RESP_FLOW_ID_TYPE_LAST  \
...
#define CFA_NTUPLE_FILTER_ALLOC_RESP_FLOW_ID_DIR_LAST   \
...
#define CFA_NTUPLE_FILTER_ALLOC_CMD_ERR_CODE_LAST                     \
...
#define CFA_DECAP_FILTER_ALLOC_REQ_TUNNEL_TYPE_LAST        \
...
#define CFA_DECAP_FILTER_ALLOC_REQ_IP_ADDR_TYPE_LAST   \
...
#define CFA_DECAP_FILTER_ALLOC_REQ_IP_PROTOCOL_LAST   \
...
#define CFA_FLOW_ALLOC_REQ_FLAGS_FLOWTYPE_LAST           \
...
#define CFA_FLOW_ALLOC_REQ_TUNNEL_TYPE_LAST        \
...
#define CFA_FLOW_ALLOC_RESP_FLOW_ID_TYPE_LAST  \
...
#define CFA_FLOW_ALLOC_CMD_ERR_CODE_LAST           \
...
#define CFA_FLOW_INFO_REQ_FLOW_HANDLE_LAST         \
...
struct hwrm_cfa_eem_qcaps_output {
  ...
  __le16 resp_len;
  __le32 flags;
#define CFA_EEM_QCAPS_RESP_FLAGS_PATH_TX                                         \
  0x1UL
#define CFA_EEM_QCAPS_RESP_FLAGS_PATH_RX                                         \
  0x2UL
#define CFA_EEM_QCAPS_RESP_FLAGS_CENTRALIZED_MEMORY_MODEL_SUPPORTED              \
  0x4UL
#define CFA_EEM_QCAPS_RESP_FLAGS_DETACHED_CENTRALIZED_MEMORY_MODEL_SUPPORTED     \
  0x8UL
  __le32 unused_0;
  __le32 supported;
...
struct hwrm_cfa_adv_flow_mgnt_qcaps_output {
  ...
  __le16 resp_len;
  __le32 flags;
#define CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_FLOW_HND_16BIT_SUPPORTED                     \
  0x1UL
#define CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_FLOW_HND_64BIT_SUPPORTED                     \
  0x2UL
#define CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_FLOW_BATCH_DELETE_SUPPORTED                  \
  0x4UL
#define CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_FLOW_RESET_ALL_SUPPORTED                     \
  0x8UL
#define CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_NTUPLE_FLOW_DEST_FUNC_SUPPORTED              \
  0x10UL
#define CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_TX_EEM_FLOW_SUPPORTED                        \
  0x20UL
#define CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_RX_EEM_FLOW_SUPPORTED                        \
  0x40UL
#define CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_FLOW_COUNTER_ALLOC_SUPPORTED                 \
  0x80UL
#define CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_RFS_RING_TBL_IDX_SUPPORTED                   \
  0x100UL
#define CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_UNTAGGED_VLAN_SUPPORTED                      \
  0x200UL
#define CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_XDP_SUPPORTED                                \
  0x400UL
#define CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_L2_HEADER_SOURCE_FIELDS_SUPPORTED            \
  0x800UL
#define CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_NTUPLE_FLOW_RX_ARP_SUPPORTED                 \
  0x1000UL
#define CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_RFS_RING_TBL_IDX_V2_SUPPORTED                \
  0x2000UL
#define CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_NTUPLE_FLOW_RX_ETHERTYPE_IP_SUPPORTED        \
  0x4000UL
#define CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_TRUFLOW_CAPABLE                              \
  0x8000UL
#define \
  CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_L2_FILTER_TRAFFIC_TYPE_L2_ROCE_SUPPORTED     \
  0x10000UL
#define CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_LAG_SUPPORTED                                \
  0x20000UL
#define CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_NTUPLE_FLOW_NO_L2CTX_SUPPORTED               \
  0x40000UL
#define CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_NIC_FLOW_STATS_SUPPORTED                     \
  0x80000UL
#define CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_NTUPLE_FLOW_RX_EXT_IP_PROTO_SUPPORTED        \
  0x100000UL
#define CFA_ADV_FLOW_MGNT_QCAPS_RESP_FLAGS_RFS_RING_TBL_IDX_V3_SUPPORTED                \
  0x200000UL
  u8 unused_0[3];
  u8 valid;
};
...
#define TUNNEL_DST_PORT_QUERY_REQ_TUNNEL_TYPE_LAST        \
  TUNNEL_DST_PORT_QUERY_REQ_TUNNEL_TYPE_GRE
...
#define TUNNEL_DST_PORT_ALLOC_REQ_TUNNEL_TYPE_LAST        \
  TUNNEL_DST_PORT_ALLOC_REQ_TUNNEL_TYPE_GRE
  u8 tunnel_next_proto;
  __be16 tunnel_dst_port_val;
  u8 unused_0[4];
};
...
#define TUNNEL_DST_PORT_ALLOC_RESP_ERROR_INFO_LAST           \
  TUNNEL_DST_PORT_ALLOC_RESP_ERROR_INFO_ERR_ENABLED
  u8 upar_in_use;
...
#define TUNNEL_DST_PORT_FREE_REQ_TUNNEL_TYPE_LAST        \
  TUNNEL_DST_PORT_FREE_REQ_TUNNEL_TYPE_GRE
  u8 tunnel_next_proto;
  __le16 tunnel_dst_port_id;
  u8 unused_0[4];
};
...
#define TUNNEL_DST_PORT_FREE_RESP_ERROR_INFO_LAST             \
  TUNNEL_DST_PORT_FREE_RESP_ERROR_INFO_ERR_NOT_ALLOCATED
  u8 unused_1[6];
  u8 valid;
};
...
#define FW_RESET_REQ_EMBEDDED_PROC_TYPE_LAST                 \
  FW_RESET_REQ_EMBEDDED_PROC_TYPE_IMPACTLESS_ACTIVATION
  u8 selfrst_status;
#define FW_RESET_REQ_SELFRST_STATUS_SELFRSTNONE      0x0UL
#define FW_RESET_REQ_SELFRST_STATUS_SELFRSTASAP      0x1UL
#define FW_RESET_REQ_SELFRST_STATUS_SELFRSTPCIERST   0x2UL
#define FW_RESET_REQ_SELFRST_STATUS_SELFRSTIMMEDIATE 0x3UL
#define FW_RESET_REQ_SELFRST_STATUS_LAST            \
  FW_RESET_REQ_SELFRST_STATUS_SELFRSTIMMEDIATE
  u8 host_idx;
  u8 flags;
...
#define FW_RESET_RESP_SELFRST_STATUS_LAST            \
  FW_RESET_RESP_SELFRST_STATUS_SELFRSTIMMEDIATE
  u8 unused_0[6];
  u8 valid;
};
...
#define FW_QSTATUS_REQ_EMBEDDED_PROC_TYPE_LAST   \
...
#define FW_QSTATUS_RESP_SELFRST_STATUS_LAST          \
  FW_QSTATUS_RESP_SELFRST_STATUS_SELFRSTPOWER
...
#define FW_QSTATUS_RESP_NVM_OPTION_ACTION_STATUS_LAST                  \
  FW_QSTATUS_RESP_NVM_OPTION_ACTION_STATUS_NVMOPT_ACTION_COLDBOOT
  u8 unused_0[5];
  u8 valid;
};
...
#define STRUCT_DATA_DCBX_APP_PROTOCOL_SELECTOR_LAST        \
...
#define FW_SET_STRUCTURED_DATA_CMD_ERR_CODE_LAST       \
...
#define FW_GET_STRUCTURED_DATA_REQ_SUBTYPE_LAST                   \
...
#define FW_GET_STRUCTURED_DATA_CMD_ERR_CODE_LAST   \
  FW_GET_STRUCTURED_DATA_CMD_ERR_CODE_BAD_ID
  u8 unused_0[7];
};
...
#define FW_LIVEPATCH_QUERY_REQ_FW_TARGET_LAST     \
  FW_LIVEPATCH_QUERY_REQ_FW_TARGET_SECURE_FW
  u8 unused_0[7];
};
...
#define FW_LIVEPATCH_REQ_LOADTYPE_LAST         \
  FW_LIVEPATCH_REQ_LOADTYPE_MEMORY_DIRECT
  u8 flags;
  __le32 patch_len;
  __le64 host_addr;
};
...
#define FW_LIVEPATCH_CMD_ERR_CODE_LAST           \
...
#define WOL_FILTER_ALLOC_REQ_WOL_TYPE_LAST    \
  WOL_FILTER_ALLOC_REQ_WOL_TYPE_INVALID
  u8 unused_0[5];
  u8 mac_address[6];
...
#define WOL_FILTER_QCFG_RESP_WOL_TYPE_LAST    \
...
#define WOL_REASON_QCFG_RESP_WOL_REASON_LAST    \
...
#define DBG_QCFG_REQ_FLAGS_CRASHDUMP_SIZE_FOR_DEST_LAST          \
...
#define DBG_CRASHDUMP_MEDIUM_CFG_REQ_LVL_LAST       \
  DBG_CRASHDUMP_MEDIUM_CFG_REQ_LVL_LVL_2
...
#define DBG_CRASHDUMP_MEDIUM_CFG_REQ_PG_SIZE_LAST   \
  DBG_CRASHDUMP_MEDIUM_CFG_REQ_PG_SIZE_PG_1G
...
#define NVM_FIND_DIR_ENTRY_REQ_OPT_ORDINAL_LAST \
  NVM_FIND_DIR_ENTRY_REQ_OPT_ORDINAL_GT
  u8 unused_0[3];
};
...
#define NVM_INSTALL_UPDATE_REQ_INSTALL_TYPE_LAST  \
  NVM_INSTALL_UPDATE_REQ_INSTALL_TYPE_ALL
  __le16 flags;
...
#define NVM_INSTALL_UPDATE_RESP_RESULT_LAST                        \
  NVM_INSTALL_UPDATE_RESP_RESULT_ITEM_LOCKED
  u8 problem_item;
#define NVM_INSTALL_UPDATE_RESP_PROBLEM_ITEM_NONE    0x0UL
#define NVM_INSTALL_UPDATE_RESP_PROBLEM_ITEM_PACKAGE 0xffUL
#define NVM_INSTALL_UPDATE_RESP_PROBLEM_ITEM_LAST   \
  NVM_INSTALL_UPDATE_RESP_PROBLEM_ITEM_PACKAGE
  u8 reset_required;
...
#define NVM_INSTALL_UPDATE_RESP_RESET_REQUIRED_LAST \
  NVM_INSTALL_UPDATE_RESP_RESET_REQUIRED_POWER
  u8 unused_0[4];
  u8 valid;
};
...
#define NVM_INSTALL_UPDATE_CMD_ERR_CODE_LAST              \
  NVM_INSTALL_UPDATE_CMD_ERR_CODE_NO_VOLTREG_SUPPORT
  u8 unused_0[7];
};
...
#define NVM_GET_VARIABLE_REQ_OPTION_NUM_LAST     \
  NVM_GET_VARIABLE_REQ_OPTION_NUM_RSVD_FFFF
  __le16 dimensions;
  __le16 index_0;
  __le16 index_1;
  __le16 index_2;
...
#define NVM_GET_VARIABLE_RESP_OPTION_NUM_LAST     \
...
#define NVM_GET_VARIABLE_CMD_ERR_CODE_LAST         \
...
#define NVM_SET_VARIABLE_REQ_OPTION_NUM_LAST     \
  NVM_SET_VARIABLE_REQ_OPTION_NUM_RSVD_FFFF
  __le16 dimensions;
  __le16 index_0;
  __le16 index_1;
  __le16 index_2;
...
#define NVM_SET_VARIABLE_REQ_FLAGS_ENCRYPT_MODE_LAST           \
  NVM_SET_VARIABLE_REQ_FLAGS_ENCRYPT_MODE_HMAC_SHA1_AUTH
...
#define NVM_SET_VARIABLE_CMD_ERR_CODE_LAST         \
  NVM_SET_VARIABLE_CMD_ERR_CODE_CORRUPT_VAR
  u8 unused_0[7];
};
...
#define SELFTEST_QLIST_RESP_EYESCOPE_TARGET_BER_SUPPORT_LAST              \
