...
static int bnxt_fill_l2_rewrite_fields(struct bnxt_tc_actions *actions,
...
static int bnxt_tc_parse_pedit(struct bnxt *bp, struct bnxt_tc_actions *actions,
...
static struct bnxt_tc_l2_node *bnxt_tc_get_l2_node(struct bnxt *bp,
 ...
 */
static int bnxt_tc_get_ref_flow_handle(struct bnxt *bp,
    struct bnxt_tc_flow *flow,
    struct bnxt_tc_flow_node *flow_node,
    __le16 *ref_flow_handle) {
  struct bnxt_tc_info *tc_info = bp->tc_info;
 ...
 * hash table.
 */
static struct bnxt_tc_tunnel_node *bnxt_tc_get_tunnel_node(struct bnxt *bp,
    struct rhashtable *tunnel_table,
    struct rhashtable_params *ht_params,
...
static int bnxt_hwrm_cfa_flow_stats_get(struct bnxt *bp, int num_flows,
...
static int bnxt_tc_flow_stats_batch_update(struct bnxt *bp, int num_flows,
    struct bnxt_tc_stats_batch stats_batch[]) {
  struct bnxt_tc_info *tc_info = bp->tc_info;
  int rc, i;
...
static int bnxt_tc_flow_stats_batch_prep(struct bnxt *bp,
    struct bnxt_tc_stats_batch stats_batch[],
    int *num_flows) {
  struct bnxt_tc_info *tc_info = bp->tc_info;
...
static struct bnxt_flower_indr_block_cb_priv *bnxt_tc_indr_block_cb_lookup(
    struct bnxt *bp, struct net_device *netdev) {
...
static int bnxt_tc_setup_indr_block(struct net_device *netdev,
    struct Qdisc *sch, struct bnxt *bp,
...
static int bnxt_tc_setup_indr_cb(struct net_device *netdev, struct Qdisc *sch,
    void *cb_priv,
