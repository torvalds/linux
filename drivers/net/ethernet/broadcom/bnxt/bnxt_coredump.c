...
static void bnxt_fill_coredump_seg_hdr(struct bnxt *bp,
...
static void bnxt_fill_coredump_record(struct bnxt *bp,
    struct bnxt_coredump_record *record,
...
int bnxt_get_coredump(struct bnxt *bp, u16 dump_type, void *buf,
    u32 *dump_len) {
...
static int bnxt_hwrm_get_dump_len(struct bnxt *bp, u16 dump_type,
    u32 *dump_len) {
