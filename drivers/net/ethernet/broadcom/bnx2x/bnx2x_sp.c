...
static bool bnx2x_get_cam_offset_mac(struct bnx2x_vlan_mac_obj *o,
    int *offset) {
...
static bool bnx2x_get_cam_offset_vlan(struct bnx2x_vlan_mac_obj *o,
    int *offset) {
...
static bool bnx2x_put_cam_offset_vlan(struct bnx2x_vlan_mac_obj *o,
    int offset) {
  struct bnx2x_credit_pool_obj *vp = o->vlans_pool;
...
/* check_del() callbacks */
static struct bnx2x_vlan_mac_registry_elem *bnx2x_check_mac_del(
    struct bnx2x *bp,
    struct bnx2x_vlan_mac_obj *o,
    union bnx2x_classification_ramrod_data *data) {
  struct bnx2x_vlan_mac_registry_elem *pos;
...
static struct bnx2x_vlan_mac_registry_elem *bnx2x_check_vlan_del(
    struct bnx2x *bp,
    struct bnx2x_vlan_mac_obj *o,
    union bnx2x_classification_ramrod_data *data) {
  struct bnx2x_vlan_mac_registry_elem *pos;
...
static struct bnx2x_vlan_mac_registry_elem *bnx2x_check_vlan_mac_del(
    struct bnx2x *bp,
    struct bnx2x_vlan_mac_obj *o,
    union bnx2x_classification_ramrod_data *data) {
  struct bnx2x_vlan_mac_registry_elem *pos;
 ...
 */
static inline int bnx2x_mcast_get_next_bin(struct bnx2x_mcast_obj *o,
    int last) {
...
static void bnx2x_mcast_hdl_pending_set_e2_convert(struct bnx2x *bp,
    struct bnx2x_mcast_obj *o,
...
static void bnx2x_mcast_hdl_pending_set_e2(struct bnx2x *bp,
    struct bnx2x_mcast_obj *o,
    struct bnx2x_pending_mcast_cmd *cmd_pos,
    int *cnt) {
  union bnx2x_mcast_config_data cfg_data = {
