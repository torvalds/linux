...
static void bnx2x_dcbx_get_ets_feature(struct bnx2x *bp,
    ...
    u32 error) {
  int i = 0;
  u32 pg_pri_orginal_spread[DCBX_MAX_NUM_PG_BW_ENTRIES] = {
    0
  };
...
static void bnx2x_dcbx_print_cos_params(struct bnx2x *bp,
...
static int bnx2x_set_admin_app_up(struct bnx2x *bp, u8 idtype, u16 idval,
    u8 up) {
  int i, ff;
