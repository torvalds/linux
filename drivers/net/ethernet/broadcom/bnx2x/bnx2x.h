...
#define CHIP_IS_E3A0(bp)    (CHIP_IS_E3(bp)    \
   ...
   * 1. In the early stages of nic_load, to know if to configure Parser /
   * Searcher
   ...
   * registered for this port (which means that the user wants storage
   * services).
...
#define ILT_MAX_LINES   256
  /*
   * Maximum supported number of RSS queues: number of IGU SBs minus one that
   * goes
   * to CNIC.
   */
