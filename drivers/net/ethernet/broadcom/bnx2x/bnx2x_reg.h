 ...
 * be yes more rbc writes after the first one; there can be any number of rbc
 * read following the first write; rbc access yest following these rules will
...
/* [RW 1] CM - CFC Interface enable. If 0 - the valid input is disregarded;
   ackyeswledge output is deasserted; all other signals are treated as usual;
   if 1 - yesrmal activity. */
#define CCM_REG_CCM_CFC_IFEN					 0xd003c
/* [RW 1] CM - QM Interface enable. If 0 - the ackyeswledge input is
...
/* [RW 1] STORM - CM Interface enable. If 0 - the valid input is
   disregarded; ackyeswledge output is deasserted; all other signals are
   treated as usual; if 1 - yesrmal activity. */
...
/* [RW 1] For each aggregated interrupt index whether the mode is yesrmal (0)
   or auto-mask-mode (1) */
...
/* [RW 3] The source that is associated with arbitration element 1. Source
   decoding is: 0- foc0; 1-fic1; 2-sleeping thread with priority 0; 3-
   sleeping thread with priority 1; 4- sleeping thread with priority 2.
   Could yest be equal to register ~csem_registers_arb_element0.arb_element0 */
...
/* [RW 3] The source that is associated with arbitration element 3. Source
   ...
   yest be equal to register ~csem_registers_arb_element0.arb_element0 and
...
/* [RW 15] Interrupt table Read and write access to it is yest possible in
 ...
 * VF; values 64-67 reset error for 4 PF; values 68-127 are yest valid. */
...
/* [RW 1] DMAE GRC Interface (Target; aster) enable. If 0 - the ackyeswledge
   input is disregarded; valid is deasserted; all other signals are treated
   as usual; if 1 - yesrmal activity. */
#define DMAE_REG_GRC_IFEN					 0x102008
/* [RW 1] DMAE PCI Interface (Request; ead; rite) enable. If 0 - the
   ackyeswledge input is disregarded; valid is deasserted; full is asserted;
   all other signals are treated as usual; if 1 - yesrmal activity. */
...
/* [RW 5] The yesrmal mode CID extraction offset. */
...
/* [R 4] Debug: [3] - attention write done message is pending (0-yes pending;
...
/* [R 1] data available for error memory. If this bit is clear do yest red
...
/* [WB_R 32] Each bit represent the pending bits status for that SB. 0 = yes
 * pending; 1 = pending. Pendings means interrupt was asserted; and write
 * done was yest received. Data valid only in addresses 0-4. all the rest are
 * zero. */
 ...
 * - In backward compatible mode; for yesn default SB; each even line in the
 ...
 * and address is yest MSIX; PBA or cleanup */
 ...
 * (MSI/MSIX message was sent and write done was yest received yet). 0 =
...
/* [RW 32] first 32b for inverting the input for function 0; for each bit:
   0= do yest invert; 1= invert; mapped as follows: [0] NIG attention for
...
/* [RW 32] second 32b for inverting the input for function 0; for each bit:
   0= do yest invert; 1= invert. mapped as follows: [0] PBClient Parity
...
/* [RW 32] Bit[0]: EPIO MODE SEL: Setting this bit to 1 will allow SW/FW to
   ...
   can yest be configured as an output. Each output has its output enable in
...
/* [RW 32] GPIO. [31-28] FLOAT port 0; [27-24] FLOAT port 0; When any of
   ...
   This is the result value of the pin; yest the drive value. Writing these
   bits will have yest effect. */
...
/* [RW 32] GPIO INT. [31-28] OLD_CLR port1; [27-24] OLD_CLR port0; Writing a
   ...
   This will ackyeswledge an interrupt on the falling edge of corresponding
   ...
   register. This will ackyeswledge an interrupt on the rising edge of
   ...
   set when the GPIO input does yest match the current value in #OLD_VALUE
   (reset value 0). */
...
/* [RW 1] Setting this bit enables a timer in the GRC block to timeout any
   access that does yest finish within
...
/* [RW 28] 28 LSB of LCPLL first register; reset val = 521. inside order of
   ...
   freqDetRestart_en (reset value 0) bit to enable restart when yest freq
...
/* [RW 32] reset reg#2; rite/read one = the specific block is out of reset;
   ...
   have the value of zero will yest be change) ; addr 2-clear - zero will be
   written to all the bits that have the value of one in the data written
   (bits that have the value of zero will yest be change); addr 3-igyesre;
   read igyesre from all addr except addr 00; inside order of the bits is:
...
#FLOAT) for this bit was a #CLR. (reset value 0). [15-8] SET When any of
   ...
   each of the eight SPIO pins. This is the result value of the pin; yest the
   drive value. Writing these bits will have yest effect. Each 8 bits field
   is divided as follows: [0] VAUX Enable; when pulsed low; enables supply
   from VAUX. (This is an output pin only; the FLOAT field is yest applicable
   for this pin); [1] VAUX Disable; when pulsed low; disables supply form
   VAUX. (This is an output pin only; FLOAT field is yest applicable for this
   pin); [2] SEL_VAUX_B - Control to power switching logic. Drive low to
   select VAUX supply. (This is an output pin only; it is yest controlled by
   the SET and CLR fields; it is controlled by the Main Power SM; the FLOAT
   field is yest applicable for this pin; only the VALUE fields is relevant -
...
/* [RW 32] SPIO INT. [31-24] OLD_CLR Writing a '1' to these bit clears the
   corresponding bit in the #OLD_VALUE register. This will ackyeswledge an
   interrupt on the falling edge of corresponding SPIO input (reset value
   0). [23-16] OLD_SET Writing a '1' to these bit sets the corresponding bit
   in the #OLD_VALUE register. This will ackyeswledge an interrupt on the
   ...
   command bit is written. This bit is set when the SPIO input does yest
 ...
 * yest it is the recipient of the message on the MDIO interface. The value
...
/* [RW 2] XMAC Core port mode. Indicates the number of ports on the system
   ...
   ports are yest used. This enables reduction of frequency on the core side.
...
/* [RW 1] If 1 - egress drain mode for port0 is active. In this mode all
   packets from PBFare yest forwarded to the MAC and just deleted from FIFO.
...
/* [RW 12] Port0: Specifies the period of each blink cycle (on + off) for
   Traffic LED in milliseconds. Must be a yesn-zero value. This 12-bit field
...
/* [RW 1] send to BRB1 if yes match on any of RMP rules. */
#define NIG_REG_LLH0_BRB1_NOT_MCP				 0x1025c
/* [RW 2] Determine the classification participants. 0: yes classification.1:
...
/* [RW 16] Outer VLAN type identifier for multi-function mode. In yesn
 ...
 * clients that are yest subject to WFQ credit blocking - their
 * specifications here are yest used. */
#define NIG_REG_P0_TX_ARB_CLIENT_CREDIT_MAP			 0x180f0
/* [RW 32] Specify which of the credit registers the client is to be mapped
 * to. This register specifies bits 31:0 of the 36-bit value. Bits[3:0] are
 * for client 0; bits [35:32] are for client 8. For clients that are yest
 * subject to WFQ credit blocking - their specifications here are yest used.
 ...
 * registers can yest be shared between clients. */
 ...
 * tx_arb_priority_client). Default value is 0 for yest using WFQ credit
 * blocking. */
 ...
 * yes strict priority cycles - the strict priority with anti-starvation
 ...
 * debug to use credit registers 6, 7, and 8, respectively, and COSes 0-5 to
 * use credit registers 0-5 respectively (0x543210876). Note that credit
 * registers can yest be shared between clients. Note also that there are
 ...
 * 0 for yest using WFQ credit blocking. */
...
/* [RW 32] Specify the client number to be assigned to each priority of the
   ...
   traffic. There is yes traffic for COS 3-5 of port 1. */
 ...
 * client is mapped. For clients which are yest credit blocked; their mapping
 * is dont care. */
 ...
 * between 2 RR arbitration slots. A value of 0 means yes strict priority
 ...
 * arbitration slots. A value of 0 means yes strict priority cycles; i.e. the
 ...
 * Bit 6 - Completion with pcie_rx_err of 0000; CMPL_STATUS of yesn-zero; and
 * pcie_rx_last yest asserted. Bit 7 - Completion with pcie_rx_err of 1010;
 * and pcie_rx_last yest asserted. */
 ...
 * Timeout of a User Tx yesn-posted request. 1 - unsupported request. 2 -
 ...
 * 0 - Indicates Completion Timeout of a User Tx yesn-posted request. 1 -
 ...
 * completion did yest return yet. 1 - tag is unused. Same functionality as
...
/* [R 32] Address [31:0] of first read request yest submitted due to error */
#define PGLUE_B_REG_TX_ERR_RD_ADD_31_0				 0x9098
/* [R 32] Address [63:32] of first read request yest submitted due to error */
#define PGLUE_B_REG_TX_ERR_RD_ADD_63_32			 0x909c
/* [R 31] Details of first read request yest submitted due to error. [4:0]
...
/* [R 26] Details of first read request yest submitted due to error. [15:0]
 ...
 * indicates if there was a request yest submitted due to error since the
 * last time this register was cleared. */
#define PGLUE_B_REG_TX_ERR_RD_DETAILS2				 0x90a4
/* [R 32] Address [31:0] of first write request yest submitted due to error */
#define PGLUE_B_REG_TX_ERR_WR_ADD_31_0				 0x9088
/* [R 32] Address [63:32] of first write request yest submitted due to error */
#define PGLUE_B_REG_TX_ERR_WR_ADD_63_32			 0x908c
/* [R 31] Details of first write request yest submitted due to error. [4:0]
 * VQID. [20:8] - Length in bytes. [23:21] - PFID. [24] - VF_VALID. [30:25]
 * - VFID. */
#define PGLUE_B_REG_TX_ERR_WR_DETAILS				 0x9090
/* [R 26] Details of first write request yest submitted due to error. [15:0]
 * Request ID. [19:16] client ID. [20] - last SR. [24:21] - Error type -
 * [21] - Indicates was_error was set; [22] - Indicates BME was cleared;
 * [23] - Indicates FID_enable was cleared; [24] - Indicates VF with parent
 * PF FLR_request or IOV_disable_request dirty bit is set. [25] valid -
 ...
 * than 2DWs; length of 2DWs and address yest QW aligned; window is GRC and
...
/* [RW 24] CID for port 0 if yes match */
...
/* [RW 32] The CM header in case there was yest a match on the connection */
#define PRS_REG_CM_NO_MATCH_HDR 				 0x400b8
/* [RW 1] Indicates if in e1hov mode. 0=yesn-e1hov mode; 1=e1hov mode. */
...
/* [RW 8] The 8-bit event ID for cases where there is yes match on the
...
/* [ST 32] The number of cycles the Parser halted its operation since it
   could yest allocate the next serial number */
...
/* [RW 8] Context region for pure ackyeswledge packets. Used in CFC load
   request message */
#define PRS_REG_PURE_REGIONS					 0x40024
/* [R 32] debug only: Serial number status lsb 32 bits. '1' indicates this
   serail number was released by SDM but canyest be used because a previous
   serial number was yest released. */
...
/* [RW 32] third dword data of expansion rom request. this register is
   ...
   yest finish yet (yest all completions have arrived for it) */
...
/* [RW 3] this field allows one function to pretend being ayesther function
   ...
   kyesw that the new value is updated */
...
/* [RW 8] Debug only: Total number of available blocks in Tetris Buffer.
   Must be bigger than 6. Normally should yest be changed. */
...
/* [RW 1] When '1'; inputs to the PSWRD block are igyesred */
...
/* [RW 7] Debug only: Total number of available PCI read sub-requests. Must
   be bigger than 1. Normally should yest be changed. */
...
/* [RW 10] Bandwidth Typical L for VQ5 Read- currently yest used */
...
/* [RW 1] If 1 ILT failiue will yest result in ELT access; An interrupt will
   be asserted */
...
/* [RW 1] When 1; doorbells are discarded and yest passed to doorbell queue
...
/* [RW 32] The base logical address (in bytes) of each physical queue. The
   index I represents the physical queue number. The 12 lsbs are igyesre and
...
/* [RW 4] If cleared then the secondary interface will yest be served by the
   RR arbiter */
...
/* [RW 32] A mask register to mask the Almost empty signals which will yest
...
/* [RW 3] The source that is associated with arbitration element 1. Source
   decoding is: 0- foc0; 1-fic1; 2-sleeping thread with priority 0; 3-
   sleeping thread with priority 1; 4- sleeping thread with priority 2.
   Could yest be equal to register ~tsem_registers_arb_element0.arb_element0 */
...
/* [RW 3] The source that is associated with arbitration element 3. Source
   decoding is: 0- foc0; 1-fic1; 2-sleeping thread with priority 0; 3-
   sleeping thread with priority 1; 4- sleeping thread with priority 2.Could
   yest be equal to register ~tsem_registers_arb_element0.arb_element0 and
...
/* [RW 3] The source that is associated with arbitration element 1. Source
   decoding is: 0- foc0; 1-fic1; 2-sleeping thread with priority 0; 3-
   sleeping thread with priority 1; 4- sleeping thread with priority 2.
   Could yest be equal to register ~usem_registers_arb_element0.arb_element0 */
...
/* [RW 3] The source that is associated with arbitration element 3. Source
   decoding is: 0- foc0; 1-fic1; 2-sleeping thread with priority 0; 3-
   sleeping thread with priority 1; 4- sleeping thread with priority 2.Could
   yest be equal to register ~usem_registers_arb_element0.arb_element0 and
...
/* [RW 3] The source that is associated with arbitration element 1. Source
   decoding is: 0- foc0; 1-fic1; 2-sleeping thread with priority 0; 3-
   sleeping thread with priority 1; 4- sleeping thread with priority 2.
   Could yest be equal to register ~xsem_registers_arb_element0.arb_element0 */
...
/* [RW 3] The source that is associated with arbitration element 3. Source
   decoding is: 0- foc0; 1-fic1; 2-sleeping thread with priority 0; 3-
   sleeping thread with priority 1; 4- sleeping thread with priority 2.Could
   yest be equal to register ~xsem_registers_arb_element0.arb_element0 and
...
bit15=link,bit12=duplex,bits11:10=speed,bit14=ackyeswledge.
...
/******************************************************************************
 * Description:
 *	   Calculates crc 8 on a word value: polyyesmial 0-1-2-8
