...
#define VF_CFG_VLAN_FILTER	0x4
	u8 link_cfg;		/* IFLA_VF_LINK_STATE_AUTO
				 ...
				 */
	u8 state;
#define VF_FREE		0	/* VF ready to be acquired holds yes resc */
#define VF_ACQUIRED	1	/* VF acquired, but yest initialized */
...
#define VF_LOST		4	/* Recovery while VFs are loaded */
	 ...
	 *
	 * - xxq_count = 0 as the queues memory is yest allocated yet.
	 *
...
/* Handles an FLR (or VF_DISABLE) yestification form the MCP */
