...
static inline u8 vfq_qzone_id(struct bnx2x_virtf *vf,
...
static inline int bnx2x_iov_init_ilt(struct bnx2x *bp, u16 line) {
  return line;
}
...
static inline int bnx2x_iov_alloc_mem(struct bnx2x *bp) {
  return 0;
}
...
static inline int bnx2x_iov_chip_cleanup(struct bnx2x *bp) {
  return 0;
}
...
static inline int bnx2x_enable_sriov(struct bnx2x *bp) {
  return 0;
}
...
static inline int bnx2x_vfpf_acquire(struct bnx2x *bp,
    u8 tx_count, u8 rx_count) {
  return 0;
}

static inline int bnx2x_vfpf_release(struct bnx2x *bp) {
  return 0;
}

static inline int bnx2x_vfpf_init(struct bnx2x *bp) {
  return 0;
}
...
static inline int bnx2x_vfpf_setup_q(struct bnx2x *bp,
    struct bnx2x_fastpath *fp,
    bool is_leading) {
  return 0;
}
...
static inline int bnx2x_vfpf_set_mcast(struct net_device *dev) {
  return 0;
}
...
static inline int bnx2x_iov_nic_init(struct bnx2x *bp) {
  return 0;
}
...
static inline enum sample_bulletin_result bnx2x_sample_bulletin(
    struct bnx2x *bp) {
...
static inline int bnx2x_vf_pci_alloc(struct bnx2x *bp) {
  return 0;
}
...
static inline int bnx2x_sriov_configure(struct pci_dev *dev, int num_vfs) {
  return 0;
}
...
static inline void bnx2x_schedule_iov_task(struct bnx2x *bp,
...
static inline int bnx2x_iov_link_update_vf(struct bnx2x *bp, int idx) {
  return 0;
}
...
static inline void bnx2x_vf_bulletin_finalize(
    struct pf_vf_bulletin_content *bulletin,
    bool support_long) {
}

static inline int bnx2x_vfpf_update_vlan(struct bnx2x *bp, u16 vid, u8 vf_qid,
    bool add) {
  return 0;
}
