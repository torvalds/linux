...
#define  ENET_DMA_CH_CFG_PKT_HALT     0x00000002  /* idle after an EOP flag is
                                                   * detected */
#define  ENET_DMA_CH_CFG_BURST_HALT     0x00000004  /* idle after finish current
                                                     * memory burst */
...
#define  ENET_DMA_CH_CFG_INT_RX_ERROR     0x00000008  /* rxdma detect client
                                                       * protocol error */
#define ENET_DMA_CH_CFG_MAX_BURST     0x0c    /* max burst length permitted */
#define  ENET_DMA_CH_CFG_MAX_BURST_DESCSIZE_SEL   0x00040000  /* DMA Descriptor
                                                               * Size Selection
                                                               * */
#define ENET_DMA_CH_CFG_SIZE        0x10

#define ENET_DMA_CH_STATE_RAM_BASE_DESC_PTR   0x00    /* descriptor ring start
                                                       * address */
#define ENET_DMA_CH_STATE_RAM_STATE_DATA    0x04    /* state/bytes done/ring
                                                     * offset */
#define ENET_DMA_CH_STATE_RAM_DESC_LEN_STATUS   0x08    /* buffer descriptor
                                                         * status and len */
#define ENET_DMA_CH_STATE_RAM_DESC_BASE_BUFPTR    0x0c    /* buffer descrpitor
                                                           * current processing
                                                           * */
