...
static inline void mlxsw_i2c_convert_mbox(struct mlxsw_i2c *mlxsw_i2c,
    u8 *buf) {
  u32 tmp;
...
static int mlxsw_i2c_write_init_cmd(struct i2c_client *client,
...
static int mlxsw_i2c_write(struct device *dev, size_t in_mbox_size, u8 *in_mbox,
    int num,
    u8 *p_status) {
...
static int mlxsw_i2c_cmd(struct device *dev, u16 opcode, u32 in_mod,
    size_t in_mbox_size,
...
static int mlxsw_i2c_init(void *bus_priv, struct mlxsw_core *mlxsw_core,
