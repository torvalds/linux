...
static bool mlxsw_sp_acl_ruleset_is_singular(
    const struct mlxsw_sp_acl_ruleset *ruleset) {
...
static int mlxsw_sp_acl_ruleset_block_bind(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_acl_ruleset *ruleset,
    struct mlxsw_sp_flow_block *block) {
  struct mlxsw_sp_flow_block_binding *binding;
  int err;
...
static struct mlxsw_sp_acl_ruleset *mlxsw_sp_acl_ruleset_create(
    struct mlxsw_sp *mlxsw_sp,
...
static struct mlxsw_sp_acl_ruleset *__mlxsw_sp_acl_ruleset_lookup(
...
struct mlxsw_sp_acl_ruleset *mlxsw_sp_acl_ruleset_lookup(
    struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_flow_block *block, u32 chain_index,
...
struct mlxsw_sp_acl_ruleset *mlxsw_sp_acl_ruleset_get(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_flow_block *block, u32 chain_index,
    enum mlxsw_sp_acl_profile profile,
    struct mlxsw_afk_element_usage *tmplt_elusage) {
  const struct mlxsw_sp_acl_profile_ops *ops;
...
#define MLXSW_SP_ACL_MANGLE_ACTION_TCP(_offset, _mask, _shift, _field) \
  MLXSW_SP_ACL_MANGLE_ACTION(FLOW_ACT_MANGLE_HDR_TYPE_TCP, _offset, _mask, \
    _shift, _field)

#define MLXSW_SP_ACL_MANGLE_ACTION_UDP(_offset, _mask, _shift, _field) \
  MLXSW_SP_ACL_MANGLE_ACTION(FLOW_ACT_MANGLE_HDR_TYPE_UDP, _offset, _mask, \
    _shift, _field)
...
static int mlxsw_sp_acl_rulei_act_mangle_field(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_acl_rule_info *rulei,
...
static int mlxsw_sp2_acl_rulei_act_mangle_field_ip_odd(
    struct mlxsw_sp_acl_rule_info *rulei,
    enum mlxsw_sp_acl_mangle_field field,
    u32 val, struct netlink_ext_ack *extack) {
  if (!rulei->ipv6_valid) {
...
static int mlxsw_sp2_acl_rulei_act_mangle_field(struct mlxsw_sp *mlxsw_sp,
  ...
  switch (mact->field) {
    case MLXSW_SP_ACL_MANGLE_FIELD_IP_SPORT:
      return mlxsw_afa_block_append_l4port(rulei->act_block, false, val,
          extack);
...
struct mlxsw_sp_acl_rule *mlxsw_sp_acl_rule_lookup(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_acl_ruleset *ruleset,
    unsigned long cookie) {
...
struct mlxsw_sp_acl_rule_info *mlxsw_sp_acl_rule_rulei(
    struct mlxsw_sp_acl_rule *rule) {
  return rule->rulei;
}
