...
static struct mlxsw_sp_mall_entry *mlxsw_sp_mall_entry_find(
    struct mlxsw_sp_flow_block *block, unsigned long cookie) {
...
static int mlxsw_sp_mall_port_mirror_add(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_mall_entry *mall_entry,
...
static void mlxsw_sp_mall_port_mirror_del(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_mall_entry *mall_entry) {
  struct mlxsw_sp *mlxsw_sp = mlxsw_sp_port->mlxsw_sp;
  struct mlxsw_sp_span_trigger_parms parms;
  enum mlxsw_sp_span_trigger trigger;
...
static void mlxsw_sp_mall_port_sample_del(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_mall_entry *mall_entry) {
  struct mlxsw_sp *mlxsw_sp = mlxsw_sp_port->mlxsw_sp;
  struct mlxsw_sp_sample_trigger trigger;
  if (mall_entry->ingress) {
...
static int mlxsw_sp_mall_port_rule_add(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_mall_entry *mall_entry,
    struct netlink_ext_ack *extack) {
...
static void mlxsw_sp_mall_port_rule_del(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_mall_entry *mall_entry) {
  switch (mall_entry->type) {
    case MLXSW_SP_MALL_ACTION_TYPE_MIRROR:
...
int mlxsw_sp_mall_replace(struct mlxsw_sp *mlxsw_sp,
  ...
  if (mlxsw_sp_flow_block_is_mixed_bound(block)) {
    NL_SET_ERR_MSG(f->common.extack,
        "Only not mixed bound blocks are supported");
    return -EOPNOTSUPP;
  }
  ...
  if (protocol != htons(ETH_P_ALL)) {
    NL_SET_ERR_MSG(f->common.extack,
        "matchall rules only supported with 'all' protocol");
    return -EOPNOTSUPP;
  }
  ...
  if (flower_prio_valid && mall_entry->ingress
    ...
    NL_SET_ERR_MSG(f->common.extack,
        "Failed to add behind existing flower rules");
    err = -EOPNOTSUPP;
    goto errout;
  }
  if (flower_prio_valid && !mall_entry->ingress
    ...
    NL_SET_ERR_MSG(f->common.extack,
        "Failed to add in front of existing flower rules");
    err = -EOPNOTSUPP;
    goto errout;
  }
