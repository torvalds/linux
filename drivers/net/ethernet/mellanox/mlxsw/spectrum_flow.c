...
struct mlxsw_sp_flow_block *mlxsw_sp_flow_block_create(
    struct mlxsw_sp *mlxsw_sp, struct net *net) {
...
static struct mlxsw_sp_flow_block_binding *mlxsw_sp_flow_block_lookup(
    struct mlxsw_sp_flow_block *block,
...
static bool mlxsw_sp_flow_block_ruleset_bound(
