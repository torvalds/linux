...
int mlxsw_env_get_module_eeprom_by_page(struct mlxsw_core *mlxsw_core,
...
int mlxsw_env_get_module_power_mode(struct mlxsw_core *mlxsw_core,
    u8 slot_index,
    u8 module,
    struct ethtool_module_power_mode_params *params,
    struct netlink_ext_ack *extack);

int mlxsw_env_set_module_power_mode(struct mlxsw_core *mlxsw_core,
    u8 slot_index,
    u8 module,
    enum ethtool_module_power_mode_policy policy,
    struct netlink_ext_ack *extack);

int mlxsw_env_module_overheat_counter_get(struct mlxsw_core *mlxsw_core,
    u8 slot_index,
