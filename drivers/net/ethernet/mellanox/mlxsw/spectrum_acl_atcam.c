...
static bool mlxsw_sp_acl_atcam_is_centry(
    const struct mlxsw_sp_acl_atcam_entry *aentry) {
  return mlxsw_sp_acl_erp_mask_is_ctcam(aentry->erp_mask);
}

static int mlxsw_sp_acl_atcam_region_generic_init(
...
static void mlxsw_sp_acl_atcam_region_generic_fini(
    struct mlxsw_sp_acl_atcam_region *aregion) {
  kfree(aregion->priv);
}

static struct mlxsw_sp_acl_atcam_lkey_id *mlxsw_sp_acl_atcam_generic_lkey_id_get(
    struct mlxsw_sp_acl_atcam_region *aregion,
    char *enc_key, u8 erp_id) {
  struct mlxsw_sp_acl_atcam_region_generic *region_generic;
...
static void mlxsw_sp_acl_atcam_generic_lkey_id_put(
    struct mlxsw_sp_acl_atcam_region *aregion,
    struct mlxsw_sp_acl_atcam_lkey_id *lkey_id) {
}
...
static int mlxsw_sp_acl_atcam_region_12kb_init(
    struct mlxsw_sp_acl_atcam_region *aregion) {
...
static void mlxsw_sp_acl_atcam_region_12kb_fini(
    struct mlxsw_sp_acl_atcam_region *aregion) {
...
static struct mlxsw_sp_acl_atcam_lkey_id *mlxsw_sp_acl_atcam_lkey_id_create(
    struct mlxsw_sp_acl_atcam_region *aregion,
    struct mlxsw_sp_acl_atcam_lkey_id_ht_key *ht_key) {
  struct mlxsw_sp_acl_atcam_region_12kb *region_12kb = aregion->priv;
  struct mlxsw_sp_acl_atcam_lkey_id *lkey_id;
...
static void mlxsw_sp_acl_atcam_lkey_id_destroy(
    struct mlxsw_sp_acl_atcam_region *aregion,
    struct mlxsw_sp_acl_atcam_lkey_id *lkey_id) {
  struct mlxsw_sp_acl_atcam_region_12kb *region_12kb = aregion->priv;
  u32 id = lkey_id->id;
...
static struct mlxsw_sp_acl_atcam_lkey_id *mlxsw_sp_acl_atcam_12kb_lkey_id_get(
    struct mlxsw_sp_acl_atcam_region *aregion,
    char *enc_key, u8 erp_id) {
  struct mlxsw_sp_acl_atcam_region_12kb *region_12kb = aregion->priv;
...
static void mlxsw_sp_acl_atcam_12kb_lkey_id_put(
    struct mlxsw_sp_acl_atcam_region *aregion,
    struct mlxsw_sp_acl_atcam_lkey_id *lkey_id) {
...
static void mlxsw_sp_acl_atcam_region_type_init(
    struct mlxsw_sp_acl_atcam_region *aregion) {
  struct mlxsw_sp_acl_tcam_region *region = aregion->region;
...
static int mlxsw_sp_acl_atcam_region_entry_insert(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_acl_atcam_region *aregion,
...
static void mlxsw_sp_acl_atcam_region_entry_remove(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_acl_atcam_region *aregion,
    struct mlxsw_sp_acl_atcam_entry *aentry) {
...
static int mlxsw_sp_acl_atcam_region_entry_action_replace(
...
static int __mlxsw_sp_acl_atcam_entry_add(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_acl_atcam_region *aregion,
    struct mlxsw_sp_acl_atcam_entry *aentry,
    struct mlxsw_sp_acl_rule_info *rulei) {
  struct mlxsw_sp_acl_tcam_region *region = aregion->region;
...
static void __mlxsw_sp_acl_atcam_entry_del(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_acl_atcam_region *aregion,
    struct mlxsw_sp_acl_atcam_entry *aentry) {
...
static int __mlxsw_sp_acl_atcam_entry_action_replace(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_acl_atcam_region *aregion,
    struct mlxsw_sp_acl_atcam_entry *aentry,
    struct mlxsw_sp_acl_rule_info *rulei) {
