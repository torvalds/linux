...
static int mlxsw_sp_bridge_mdb_mc_enable_sync(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_bridge_device
    *bridge_device, bool mc_enabled);

static void mlxsw_sp_port_mrouter_update_mdb(
  struct mlxsw_sp_port *mlxsw_sp_port,
  struct mlxsw_sp_bridge_port *bridge_port,
  bool add);

static struct mlxsw_sp_bridge_device *mlxsw_sp_bridge_device_find(
    const struct mlxsw_sp_bridge *bridge,
...
static struct mlxsw_sp_bridge_device *mlxsw_sp_bridge_device_create(
...
static void mlxsw_sp_bridge_device_destroy(struct mlxsw_sp_bridge *bridge,
    struct mlxsw_sp_bridge_device *bridge_device) {
...
static struct mlxsw_sp_bridge_device *mlxsw_sp_bridge_device_get(
    struct mlxsw_sp_bridge *bridge,
    struct net_device *br_dev,
    struct netlink_ext_ack *extack) {
  struct mlxsw_sp_bridge_device *bridge_device;
...
static void mlxsw_sp_bridge_device_put(struct mlxsw_sp_bridge *bridge,
    struct mlxsw_sp_bridge_device *bridge_device) {
...
static struct mlxsw_sp_bridge_port *__mlxsw_sp_bridge_port_find(
...
static int mlxsw_sp_bridge_port_replay_switchdev_objs(struct notifier_block *nb,
...
static int mlxsw_sp_bridge_port_unreplay_switchdev_objs(
...
static struct mlxsw_sp_bridge_port *mlxsw_sp_bridge_port_create(
    struct mlxsw_sp_bridge_device *bridge_device,
    struct net_device *brport_dev,
    struct netlink_ext_ack *extack) {
  struct mlxsw_sp_bridge_port *bridge_port;
...
static void mlxsw_sp_bridge_port_destroy(
    struct mlxsw_sp_bridge_port *bridge_port) {
...
static struct mlxsw_sp_bridge_port *mlxsw_sp_bridge_port_get(
    struct mlxsw_sp_bridge *bridge,
    struct net_device *brport_dev,
    struct netlink_ext_ack *extack) {
  struct net_device *br_dev = netdev_master_upper_dev_get(brport_dev);
...
static struct mlxsw_sp_port_vlan *mlxsw_sp_port_vlan_find_by_bridge(
    struct mlxsw_sp_port *mlxsw_sp_port,
...
static struct mlxsw_sp_port_vlan *mlxsw_sp_port_vlan_find_by_fid(
    struct mlxsw_sp_port *mlxsw_sp_port,
    u16 fid_index) {
  struct mlxsw_sp_port_vlan *mlxsw_sp_port_vlan;
  list_for_each_entry(mlxsw_sp_port_vlan, &mlxsw_sp_port->vlans_list,
...
static struct mlxsw_sp_bridge_vlan *mlxsw_sp_bridge_vlan_find(
    const struct mlxsw_sp_bridge_port *bridge_port,
    u16 vid) {
...
static struct mlxsw_sp_bridge_vlan *mlxsw_sp_bridge_vlan_create(
...
static void mlxsw_sp_bridge_vlan_destroy(
    struct mlxsw_sp_bridge_vlan *bridge_vlan) {
...
static struct mlxsw_sp_bridge_vlan *mlxsw_sp_bridge_vlan_get(
    struct mlxsw_sp_bridge_port *bridge_port, u16 vid) {
  struct mlxsw_sp_bridge_vlan *bridge_vlan;
...
static int mlxsw_sp_port_bridge_vlan_stp_set(
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_bridge_vlan *bridge_vlan,
    u8 state) {
  struct mlxsw_sp_port_vlan *mlxsw_sp_port_vlan;
...
static int mlxsw_sp_port_bridge_vlan_flood_set(
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_bridge_vlan *bridge_vlan,
...
static int mlxsw_sp_bridge_port_flood_table_set(
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_bridge_port *bridge_port,
    enum mlxsw_sp_flood_type packet_type,
    bool member) {
...
static int mlxsw_sp_bridge_vlans_flood_set(
    struct mlxsw_sp_bridge_vlan *bridge_vlan,
    enum mlxsw_sp_flood_type packet_type,
    bool member) {
  struct mlxsw_sp_port_vlan *mlxsw_sp_port_vlan;
...
static int mlxsw_sp_bridge_ports_flood_table_set(
    struct mlxsw_sp_bridge_port *bridge_port,
    enum mlxsw_sp_flood_type packet_type,
    bool member) {
  struct mlxsw_sp_bridge_vlan *bridge_vlan;
...
static int mlxsw_sp_port_bridge_vlan_learning_set(
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_bridge_vlan *bridge_vlan,
    bool set) {
  struct mlxsw_sp_port_vlan *mlxsw_sp_port_vlan;
...
static int mlxsw_sp_bridge_port_learning_set(
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_bridge_port *bridge_port,
    bool set) {
  struct mlxsw_sp_bridge_vlan *bridge_vlan;
...
static int mlxsw_sp_port_attr_br_pre_flags_set(
    struct mlxsw_sp_port *mlxsw_sp_port,
  ...
  if ((flags.mask & BR_PORT_LOCKED) && vlan_uses_dev(orig_dev)) {
    NL_SET_ERR_MSG_MOD(extack,
        "Locked flag cannot be set on a bridge port that has VLAN uppers");
    return -EINVAL;
  }
  return 0;
}
...
static int mlxsw_sp_port_attr_br_vlan_proto_set(
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct net_device *orig_dev,
    u16 vlan_proto) {
  struct mlxsw_sp *mlxsw_sp = mlxsw_sp_port->mlxsw_sp;
  ...
  netdev_err(bridge_device->dev,
      "VLAN protocol can't be changed on existing bridge\n");
  return -EINVAL;
}
...
static struct mlxsw_sp_mdb_entry_port *mlxsw_sp_mdb_entry_port_lookup(
...
static struct mlxsw_sp_mdb_entry_port *mlxsw_sp_mdb_entry_port_get(
    struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_mdb_entry *mdb_entry,
    u16 local_port) {
  struct mlxsw_sp_mdb_entry_port *mdb_entry_port;
...
static void mlxsw_sp_mdb_entry_port_put(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_mdb_entry *mdb_entry,
...
static __always_unused void mlxsw_sp_mdb_entry_mrouter_port_put(
    struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_mdb_entry *mdb_entry,
    u16 local_port) {
  struct mlxsw_sp_mdb_entry_port *mdb_entry_port;
...
static void mlxsw_sp_bridge_mrouter_update_mdb(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_bridge_device *bridge_device,
    bool add) {
...
static int mlxsw_sp_port_attr_br_mrouter_set(
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct net_device *orig_dev,
    bool is_mrouter) {
  struct mlxsw_sp *mlxsw_sp = mlxsw_sp_port->mlxsw_sp;
...
static int mlxsw_sp_port_vlan_fid_join(
    struct mlxsw_sp_port_vlan *mlxsw_sp_port_vlan,
    struct mlxsw_sp_bridge_port *bridge_port,
    struct netlink_ext_ack *extack) {
...
static void mlxsw_sp_port_vlan_fid_leave(
    struct mlxsw_sp_port_vlan *mlxsw_sp_port_vlan) {
  struct mlxsw_sp_port *mlxsw_sp_port = mlxsw_sp_port_vlan->mlxsw_sp_port;
  struct mlxsw_sp_fid *fid = mlxsw_sp_port_vlan->fid;
  u16 local_port = mlxsw_sp_port->local_port;
...
static u16 mlxsw_sp_port_pvid_determine(
...
static int mlxsw_sp_port_vlan_bridge_join(
    struct mlxsw_sp_port_vlan *mlxsw_sp_port_vlan,
    struct mlxsw_sp_bridge_port *bridge_port,
    struct netlink_ext_ack *extack) {
  struct mlxsw_sp_port *mlxsw_sp_port = mlxsw_sp_port_vlan->mlxsw_sp_port;
...
void mlxsw_sp_port_vlan_bridge_leave(
    struct mlxsw_sp_port_vlan *mlxsw_sp_port_vlan) {
  struct mlxsw_sp_port *mlxsw_sp_port = mlxsw_sp_port_vlan->mlxsw_sp_port;
  struct mlxsw_sp_fid *fid = mlxsw_sp_port_vlan->fid;
  struct mlxsw_sp_bridge_vlan *bridge_vlan;
...
static int mlxsw_sp_bridge_port_vlan_add(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_bridge_port *bridge_port,
...
static int mlxsw_sp_br_rif_pvid_change(struct mlxsw_sp *mlxsw_sp,
    struct net_device *br_dev,
...
static int mlxsw_sp_port_fdb_tun_uc_op4(struct mlxsw_sp *mlxsw_sp, bool dynamic,
...
static int mlxsw_sp_port_fdb_tun_uc_op6(struct mlxsw_sp *mlxsw_sp,
    const char *mac,
...
static int mlxsw_sp_port_fdb_set(struct mlxsw_sp_port *mlxsw_sp_port,
...
static void mlxsw_sp_bridge_port_get_ports_bitmap(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_bridge_port *bridge_port,
...
static void mlxsw_sp_mc_get_mrouters_bitmap(
    struct mlxsw_sp_ports_bitmap *flood_bm,
    struct mlxsw_sp_bridge_device *bridge_device,
    struct mlxsw_sp *mlxsw_sp) {
  struct mlxsw_sp_bridge_port *bridge_port;
  list_for_each_entry(bridge_port, &bridge_device->ports_list, list) {
...
static int mlxsw_sp_mc_mdb_mrouters_set(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_bridge_device *bridge_device,
...
static struct mlxsw_sp_mdb_entry *mlxsw_sp_mc_mdb_entry_init(
    struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_bridge_device *bridge_device,
...
static void mlxsw_sp_mc_mdb_entry_fini(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_mdb_entry *mdb_entry,
    struct mlxsw_sp_bridge_device *bridge_device,
    u16 local_port, bool force) {
...
static struct mlxsw_sp_mdb_entry *mlxsw_sp_mc_mdb_entry_get(
    struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_bridge_device *bridge_device,
    const unsigned char *addr, u16 fid, u16 local_port) {
  struct mlxsw_sp_mdb_entry_key key = {};
...
static bool mlxsw_sp_mc_mdb_entry_remove(struct mlxsw_sp_mdb_entry *mdb_entry,
...
static void mlxsw_sp_mc_mdb_entry_put(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_bridge_device *bridge_device,
...
static void mlxsw_sp_bridge_port_vlan_del(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_bridge_port *bridge_port, u16 vid) {
...
static int mlxsw_sp_bridge_port_replay(struct mlxsw_sp_bridge_port *bridge_port,
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct netlink_ext_ack *extack) {
  struct mlxsw_sp_bridge_port_replay_switchdev_objs rso = {
...
static int mlxsw_sp_bridge_vlan_aware_port_join(
    struct mlxsw_sp_bridge_port *bridge_port,
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct netlink_ext_ack *extack) {
...
static int mlxsw_sp_bridge_8021q_port_join(
    struct mlxsw_sp_bridge_device *bridge_device,
    struct mlxsw_sp_bridge_port *bridge_port,
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct netlink_ext_ack *extack) {
...
static void mlxsw_sp_bridge_vlan_aware_port_leave(
    struct mlxsw_sp_port *mlxsw_sp_port) {
...
static void mlxsw_sp_bridge_8021q_port_leave(
    struct mlxsw_sp_bridge_device *bridge_device,
    struct mlxsw_sp_bridge_port *bridge_port,
    struct mlxsw_sp_port *mlxsw_sp_port) {
...
static int mlxsw_sp_bridge_vlan_aware_vxlan_join(
    struct mlxsw_sp_bridge_device *bridge_device,
...
static int mlxsw_sp_bridge_8021q_vxlan_join(
    struct mlxsw_sp_bridge_device *bridge_device,
    const struct net_device *vxlan_dev, u16 vid,
    struct netlink_ext_ack *extack) {
...
static struct net_device *mlxsw_sp_bridge_8021q_vxlan_dev_find(
...
static struct mlxsw_sp_fid *mlxsw_sp_bridge_8021q_fid_get(
    struct mlxsw_sp_bridge_device *bridge_device,
    u16 vid, struct netlink_ext_ack *extack) {
  struct mlxsw_sp *mlxsw_sp = mlxsw_sp_lower_get(bridge_device->dev);
...
static struct mlxsw_sp_fid *mlxsw_sp_bridge_8021q_fid_lookup(
    struct mlxsw_sp_bridge_device *bridge_device,
    u16 vid) {
  struct mlxsw_sp *mlxsw_sp = mlxsw_sp_lower_get(bridge_device->dev);
...
static u16 mlxsw_sp_bridge_8021q_fid_vid(
    struct mlxsw_sp_bridge_device *bridge_device,
    const struct mlxsw_sp_fid *fid) {
...
static bool mlxsw_sp_port_is_br_member(
    const struct mlxsw_sp_port *mlxsw_sp_port,
    const struct net_device *br_dev) {
  struct mlxsw_sp_port_vlan *mlxsw_sp_port_vlan;
  list_for_each_entry(mlxsw_sp_port_vlan, &mlxsw_sp_port->vlans_list,
...
static int mlxsw_sp_bridge_8021d_port_join(
    struct mlxsw_sp_bridge_device *bridge_device,
    struct mlxsw_sp_bridge_port *bridge_port,
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct netlink_ext_ack *extack) {
...
static void mlxsw_sp_bridge_8021d_port_leave(
    struct mlxsw_sp_bridge_device *bridge_device,
    struct mlxsw_sp_bridge_port *bridge_port,
    struct mlxsw_sp_port *mlxsw_sp_port) {
  struct mlxsw_sp_port_vlan *mlxsw_sp_port_vlan;
...
static int mlxsw_sp_bridge_8021d_vxlan_join(
    struct mlxsw_sp_bridge_device *bridge_device,
    const struct net_device *vxlan_dev, u16 vid,
    struct netlink_ext_ack *extack) {
  struct mlxsw_sp *mlxsw_sp = mlxsw_sp_lower_get(bridge_device->dev);
...
static struct mlxsw_sp_fid *mlxsw_sp_bridge_8021d_fid_get(
    struct mlxsw_sp_bridge_device *bridge_device,
    u16 vid, struct netlink_ext_ack *extack) {
  struct mlxsw_sp *mlxsw_sp = mlxsw_sp_lower_get(bridge_device->dev);
...
static struct mlxsw_sp_fid *mlxsw_sp_bridge_8021d_fid_lookup(
    struct mlxsw_sp_bridge_device *bridge_device,
    u16 vid) {
  struct mlxsw_sp *mlxsw_sp = mlxsw_sp_lower_get(bridge_device->dev);
...
static u16 mlxsw_sp_bridge_8021d_fid_vid(
    struct mlxsw_sp_bridge_device *bridge_device,
    const struct mlxsw_sp_fid *fid) {
  return 0;
}
...
static int mlxsw_sp_bridge_8021ad_port_join(
    struct mlxsw_sp_bridge_device *bridge_device,
    struct mlxsw_sp_bridge_port *bridge_port,
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct netlink_ext_ack *extack) {
...
static void mlxsw_sp_bridge_8021ad_port_leave(
    struct mlxsw_sp_bridge_device *bridge_device,
    struct mlxsw_sp_bridge_port *bridge_port,
    struct mlxsw_sp_port *mlxsw_sp_port) {
  mlxsw_sp_bridge_vlan_aware_port_leave(mlxsw_sp_port);
...
static int mlxsw_sp_bridge_8021ad_vxlan_join(
    struct mlxsw_sp_bridge_device *bridge_device,
    const struct net_device *vxlan_dev, u16 vid,
    struct netlink_ext_ack *extack) {
  return mlxsw_sp_bridge_vlan_aware_vxlan_join(bridge_device, vxlan_dev,
...
static int mlxsw_sp2_bridge_8021ad_port_join(
    struct mlxsw_sp_bridge_device *bridge_device,
    struct mlxsw_sp_bridge_port *bridge_port,
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct netlink_ext_ack *extack) {
...
static void mlxsw_sp2_bridge_8021ad_port_leave(
    struct mlxsw_sp_bridge_device *bridge_device,
    struct mlxsw_sp_bridge_port *bridge_port,
    struct mlxsw_sp_port *mlxsw_sp_port) {
...
static void mlxsw_sp_switchdev_vxlan_addr_convert(
    const union vxlan_addr *vxlan_addr,
    enum mlxsw_sp_l3proto *proto,
...
static void mlxsw_sp_switchdev_addr_vxlan_convert(enum mlxsw_sp_l3proto proto,
    const union mlxsw_sp_l3addr *addr,
...
static void mlxsw_sp_fdb_call_notifiers(enum switchdev_notifier_type type,
...
static int __mlxsw_sp_fdb_notify_mac_uc_tunnel_process(
    struct mlxsw_sp *mlxsw_sp,
    const struct mlxsw_sp_fid *fid,
    bool adding,
...
static void mlxsw_sp_switchdev_bridge_vxlan_fdb_event(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_switchdev_event_work *
    switchdev_work,
...
static void mlxsw_sp_switchdev_bridge_nve_fdb_event(struct mlxsw_sp_switchdev_event_work *
    switchdev_work) {
  struct mlxsw_sp_bridge_device *bridge_device;
  struct net_device *dev = switchdev_work->dev;
  struct net_device *br_dev;
...
static void mlxsw_sp_switchdev_vxlan_fdb_add(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_switchdev_event_work *
    switchdev_work) {
  struct switchdev_notifier_vxlan_fdb_info *vxlan_fdb_info;
  struct mlxsw_sp_bridge_device *bridge_device;
...
static void mlxsw_sp_switchdev_vxlan_fdb_del(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_switchdev_event_work *
    switchdev_work) {
  struct switchdev_notifier_vxlan_fdb_info *vxlan_fdb_info;
  struct mlxsw_sp_bridge_device *bridge_device;
...
static int mlxsw_sp_switchdev_vxlan_work_prepare(struct mlxsw_sp_switchdev_event_work *
    switchdev_work,
  ...
  if (vxlan_fdb_info->remote_port != cfg->dst_port) {
    NL_SET_ERR_MSG_MOD(extack,
        "VxLAN: FDB: Non-default remote port is not supported");
    return -EOPNOTSUPP;
  }
  ...
  if (is_multicast_ether_addr(vxlan_fdb_info->eth_addr)) {
    NL_SET_ERR_MSG_MOD(extack,
        "VxLAN: FDB: Multicast MAC addresses not supported");
    return -EOPNOTSUPP;
  }
  if (vxlan_addr_multicast(&vxlan_fdb_info->remote_ip)) {
    NL_SET_ERR_MSG_MOD(extack,
        "VxLAN: FDB: Multicast destination IP is not supported");
    return -EOPNOTSUPP;
  }
...
static int mlxsw_sp_switchdev_vxlan_vlan_add(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_bridge_device *bridge_device,
    const struct net_device *vxlan_dev, u16 vid,
...
static void mlxsw_sp_switchdev_vxlan_vlan_del(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_bridge_device *bridge_device,
    const struct net_device *vxlan_dev, u16 vid) {
  struct vxlan_dev *vxlan = netdev_priv(vxlan_dev);
  __be32 vni = vxlan->cfg.vni;
...
static int mlxsw_sp_switchdev_vxlan_vlans_add(struct net_device *vxlan_dev,
...
static void mlxsw_sp_switchdev_vxlan_vlans_del(struct net_device *vxlan_dev,
    struct switchdev_notifier_port_obj_info *
    port_obj_info) {
  struct switchdev_obj_port_vlan *vlan
    = SWITCHDEV_OBJ_PORT_VLAN(port_obj_info->obj);
...
static int mlxsw_sp_switchdev_handle_vxlan_obj_add(struct net_device *vxlan_dev,
    struct switchdev_notifier_port_obj_info *
    port_obj_info) {
  int err = 0;
...
static void mlxsw_sp_switchdev_handle_vxlan_obj_del(
