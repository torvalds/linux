...
static struct mlxsw_sp1_ptp_state *mlxsw_sp1_ptp_state(
    struct mlxsw_sp *mlxsw_sp) {
  return container_of(mlxsw_sp->ptp_state, struct mlxsw_sp1_ptp_state,
      common);
}

static struct mlxsw_sp2_ptp_state *mlxsw_sp2_ptp_state(
    struct mlxsw_sp *mlxsw_sp) {
  return container_of(mlxsw_sp->ptp_state, struct mlxsw_sp2_ptp_state,
      common);
}

static struct mlxsw_sp1_ptp_clock *mlxsw_sp1_ptp_clock(
...
static int mlxsw_sp_ptp_phc_adjfreq(struct mlxsw_sp_ptp_clock *clock,
    int freq_adj) {
...
static int mlxsw_sp1_ptp_phc_settime(struct mlxsw_sp1_ptp_clock *clock,
    u64 nsec) {
  struct mlxsw_core *mlxsw_core = clock->common.core;
...
static int mlxsw_sp2_ptp_phc_settime(struct mlxsw_sp_ptp_clock *clock,
    u64 nsec) {
  struct mlxsw_core *mlxsw_core = clock->core;
  char mtutc_pl[MLXSW_REG_MTUTC_LEN];
  u32 sec, nsec_rem;
 ...
 * error.
 */
static int mlxsw_sp1_ptp_unmatched_save(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp1_ptp_key key,
    struct sk_buff *skb,
    u64 timestamp) {
...
static struct mlxsw_sp1_ptp_unmatched *mlxsw_sp1_ptp_unmatched_lookup(
    struct mlxsw_sp *mlxsw_sp,
...
static int mlxsw_sp1_ptp_unmatched_remove(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp1_ptp_unmatched *unmatched) {
  struct mlxsw_sp1_ptp_state *ptp_state = mlxsw_sp1_ptp_state(mlxsw_sp);
...
static void mlxsw_sp1_ptp_unmatched_finish(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp1_ptp_unmatched *unmatched) {
...
static void mlxsw_sp1_ptp_ht_gc_collect(struct mlxsw_sp1_ptp_state *ptp_state,
    struct mlxsw_sp1_ptp_unmatched *unmatched) {
...
static int mlxsw_sp1_ptp_get_message_types(const struct hwtstamp_config *config,
...
static int mlxsw_sp1_ptp_port_shaper_set(struct mlxsw_sp_port *mlxsw_sp_port,
    bool enable) {
  struct mlxsw_sp *mlxsw_sp = mlxsw_sp_port->mlxsw_sp;
...
static int mlxsw_sp2_ptp_get_message_types(const struct hwtstamp_config *config,
    u16 *p_ing_types, u16 *p_egr_types,
    enum hwtstamp_rx_filters *p_rx_filter) {
  enum hwtstamp_rx_filters rx_filter = config->rx_filter;
  enum hwtstamp_tx_types tx_type = config->tx_type;
