...
static union mlxsw_sp_l3addr mlxsw_sp_ipip_parms4_saddr(
    const struct ip_tunnel_parm *parms) {
  return (union mlxsw_sp_l3addr) {
      .addr4 = parms->iph.saddr
  };
}

static union mlxsw_sp_l3addr mlxsw_sp_ipip_parms6_saddr(
...
static union mlxsw_sp_l3addr mlxsw_sp_ipip_parms4_daddr(
    const struct ip_tunnel_parm *parms) {
  return (union mlxsw_sp_l3addr) {
      .addr4 = parms->iph.daddr
  };
}

static union mlxsw_sp_l3addr mlxsw_sp_ipip_parms6_daddr(
    const struct __ip6_tnl_parm *parms) {
  return (union mlxsw_sp_l3addr) {
      .addr6 = parms->raddr
  };
...
static union mlxsw_sp_l3addr mlxsw_sp_ipip_netdev_daddr(
...
static struct mlxsw_sp_ipip_parms mlxsw_sp_ipip_netdev_parms_init_gre4(
    const struct net_device *ol_dev) {
...
static int mlxsw_sp_ipip_nexthop_update_gre4(struct mlxsw_sp *mlxsw_sp,
    u32 adj_index,
...
static int mlxsw_sp_ipip_decap_config_gre4(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_ipip_entry *ipip_entry,
    u32 tunnel_index) {
  u16 rif_index = mlxsw_sp_ipip_lb_rif_index(ipip_entry->ol_lb);
...
static struct mlxsw_sp_rif_ipip_lb_config mlxsw_sp_ipip_ol_loopback_config_gre4(
...
static int mlxsw_sp_ipip_ol_netdev_change_gre(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_ipip_entry *ipip_entry,
...
static int mlxsw_sp_ipip_ol_netdev_change_gre4(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_ipip_entry *ipip_entry,
    struct netlink_ext_ack *extack) {
...
static int mlxsw_sp_ipip_rem_addr_set_gre4(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_ipip_entry *ipip_entry) {
  return 0;
}

static void mlxsw_sp_ipip_rem_addr_unset_gre4(struct mlxsw_sp *mlxsw_sp,
...
static struct mlxsw_sp_ipip_parms mlxsw_sp_ipip_netdev_parms_init_gre6(
    const struct net_device *ol_dev) {
...
static int mlxsw_sp_ipip_nexthop_update_gre6(struct mlxsw_sp *mlxsw_sp,
    u32 adj_index,
    struct mlxsw_sp_ipip_entry *ipip_entry,
    bool force, char *ratr_pl) {
  u16 rif_index = mlxsw_sp_ipip_lb_rif_index(ipip_entry->ol_lb);
...
static int mlxsw_sp_ipip_decap_config_gre6(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_ipip_entry *ipip_entry,
    u32 tunnel_index) {
  u16 rif_index = mlxsw_sp_ipip_lb_rif_index(ipip_entry->ol_lb);
  u16 ul_rif_id = mlxsw_sp_ipip_lb_ul_rif_id(ipip_entry->ol_lb);
...
static struct mlxsw_sp_rif_ipip_lb_config mlxsw_sp_ipip_ol_loopback_config_gre6(
    struct mlxsw_sp *mlxsw_sp,
    const struct net_device *ol_dev) {
  struct __ip6_tnl_parm parms = mlxsw_sp_ipip_netdev_parms6(ol_dev);
  enum mlxsw_reg_ritr_loopback_ipip_type lb_ipipt;
...
static int mlxsw_sp_ipip_ol_netdev_change_gre6(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_ipip_entry *ipip_entry,
    struct netlink_ext_ack *extack) {
  struct mlxsw_sp_ipip_parms new_parms;
...
static int mlxsw_sp_ipip_rem_addr_set_gre6(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_ipip_entry *ipip_entry) {
...
static void mlxsw_sp_ipip_rem_addr_unset_gre6(struct mlxsw_sp *mlxsw_sp,
    const struct mlxsw_sp_ipip_entry *ipip_entry) {
