...
static bool mlxsw_sp_qdisc_compare(struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
    u32 handle) {
  return mlxsw_sp_qdisc->ops && mlxsw_sp_qdisc->handle == handle;
}

static struct mlxsw_sp_qdisc *mlxsw_sp_qdisc_walk(struct mlxsw_sp_qdisc *qdisc,
...
static struct mlxsw_sp_qdisc *mlxsw_sp_qdisc_walk_cb_find(
    struct mlxsw_sp_qdisc *qdisc, void *data) {
  u32 parent = *(u32 *) data;
...
static struct mlxsw_sp_qdisc *mlxsw_sp_qdisc_find(
    struct mlxsw_sp_port *mlxsw_sp_port, u32 parent) {
...
static struct mlxsw_sp_qdisc *mlxsw_sp_qdisc_walk_cb_find_by_handle(
    struct mlxsw_sp_qdisc *qdisc, void *data) {
  u32 handle = *(u32 *) data;
...
static struct mlxsw_sp_qdisc *mlxsw_sp_qdisc_find_by_handle(
    struct mlxsw_sp_port *mlxsw_sp_port, u32 handle) {
  struct mlxsw_sp_qdisc_state *qdisc_state = mlxsw_sp_port->qdisc;
  if (!qdisc_state) {
    return NULL;
  }
...
static void mlxsw_sp_qdisc_reduce_parent_backlog(
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc) {
  struct mlxsw_sp_qdisc *tmp;
...
static int mlxsw_sp_qdisc_destroy(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc) {
...
static int mlxsw_sp_qdisc_tree_validate_children(
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
    struct mlxsw_sp_qdisc_tree_validate validate) {
  unsigned int i;
  int err;
...
static int mlxsw_sp_qdisc_change(struct mlxsw_sp_port *mlxsw_sp_port,
    u32 handle,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc, void *params) {
...
static int mlxsw_sp_qdisc_replace(struct mlxsw_sp_port *mlxsw_sp_port,
    u32 handle,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
    struct mlxsw_sp_qdisc_ops *ops, void *params) {
...
static int mlxsw_sp_qdisc_get_stats(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
    struct tc_qopt_offload_stats *stats_ptr) {
...
static int mlxsw_sp_qdisc_get_xstats(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
    void *xstats_ptr) {
  if (mlxsw_sp_qdisc && mlxsw_sp_qdisc->ops
...
static u64 mlxsw_sp_xstats_backlog(struct mlxsw_sp_port_xstats *xstats,
    int tclass_num) {
  return xstats->backlog[tclass_num]
    + xstats->backlog[tclass_num + 8];
}

static u64 mlxsw_sp_xstats_tail_drop(struct mlxsw_sp_port_xstats *xstats,
    int tclass_num) {
  return xstats->tail_drop[tclass_num]
    + xstats->tail_drop[tclass_num + 8];
}

static void mlxsw_sp_qdisc_bstats_per_priority_get(
...
static void mlxsw_sp_qdisc_collect_tc_stats(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
...
static void mlxsw_sp_qdisc_update_stats(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
...
static void mlxsw_sp_qdisc_get_tc_stats(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
    struct tc_qopt_offload_stats *stats_ptr) {
  u64 tx_packets = 0;
  u64 tx_bytes = 0;
...
static int mlxsw_sp_tclass_congestion_enable(
...
static int mlxsw_sp_tclass_congestion_disable(
    struct mlxsw_sp_port *mlxsw_sp_port,
    int tclass_num) {
  struct mlxsw_sp *mlxsw_sp = mlxsw_sp_port->mlxsw_sp;
  char cwtpm_cmd[MLXSW_REG_CWTPM_LEN];
...
static int mlxsw_sp_qdisc_red_destroy(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc) {
...
static int mlxsw_sp_qdisc_red_check_params(struct mlxsw_sp_port *mlxsw_sp_port,
    void *params) {
  struct mlxsw_sp *mlxsw_sp = mlxsw_sp_port->mlxsw_sp;
...
static int mlxsw_sp_qdisc_future_fifo_replace(
  struct mlxsw_sp_port *mlxsw_sp_port,
  u32 handle, unsigned int band,
  struct mlxsw_sp_qdisc *child_qdisc);
static void mlxsw_sp_qdisc_future_fifos_init(
  struct mlxsw_sp_port *mlxsw_sp_port,
  u32 handle);
...
static void mlxsw_sp_qdisc_leaf_unoffload(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
...
static struct mlxsw_sp_qdisc *mlxsw_sp_qdisc_leaf_find_class(
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
    u32 parent) {
...
static void mlxsw_sp_setup_tc_qdisc_leaf_clean_stats(
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc) {
  u64 backlog_cells = 0;
  u64 tx_packets = 0;
...
static enum mlxsw_reg_qeec_hr mlxsw_sp_qdisc_tbf_hr(
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc) {
...
static int mlxsw_sp_qdisc_tbf_destroy(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc) {
...
static int mlxsw_sp_qdisc_tbf_bs(struct mlxsw_sp_port *mlxsw_sp_port,
...
static u32 mlxsw_sp_qdisc_tbf_max_size(u8 bs) {
  return (1U << bs) * 64;
}

static u64 mlxsw_sp_qdisc_tbf_rate_kbps(
    struct tc_tbf_qopt_offload_replace_params *p) {
...
static int mlxsw_sp_qdisc_tbf_check_params(struct mlxsw_sp_port *mlxsw_sp_port,
    void *params) {
...
static int mlxsw_sp_qdisc_get_tbf_stats(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
    struct tc_qopt_offload_stats *stats_ptr) {
...
static int mlxsw_sp_qdisc_fifo_replace(struct mlxsw_sp_port *mlxsw_sp_port,
    u32 handle,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
    void *params) {
  return 0;
...
static int mlxsw_sp_qdisc_get_fifo_stats(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
    struct tc_qopt_offload_stats *stats_ptr) {
  mlxsw_sp_qdisc_get_tc_stats(mlxsw_sp_port, mlxsw_sp_qdisc,
      stats_ptr);
...
static int __mlxsw_sp_qdisc_ets_check_params(unsigned int nbands) {
...
static struct mlxsw_sp_qdisc *mlxsw_sp_qdisc_walk_cb_clean_stats(
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
    void *mlxsw_sp_port) {
  u64 backlog;
  if (mlxsw_sp_qdisc->ops) {
...
static int mlxsw_sp_qdisc_prio_replace(struct mlxsw_sp_port *mlxsw_sp_port,
    ...
    void *params) {
  struct tc_prio_qopt_offload_params *p = params;
  unsigned int zeroes[TCQ_ETS_MAX_BANDS] = {
    0
  };
...
static void __mlxsw_sp_qdisc_ets_unoffload(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
    struct gnet_stats_queue *qstats) {
  u64 backlog;
  backlog = mlxsw_sp_cells_bytes(mlxsw_sp_port->mlxsw_sp,
...
static void mlxsw_sp_qdisc_prio_unoffload(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
    void *params) {
  struct tc_prio_qopt_offload_params *p = params;
...
static int mlxsw_sp_qdisc_get_prio_stats(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
    struct tc_qopt_offload_stats *stats_ptr) {
...
static void mlxsw_sp_setup_tc_qdisc_prio_clean_stats(
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc) {
  struct mlxsw_sp_qdisc_stats *stats_base;
  struct mlxsw_sp_port_xstats *xstats;
...
static struct mlxsw_sp_qdisc *mlxsw_sp_qdisc_prio_find_class(
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
    u32 parent) {
...
static struct mlxsw_sp_qdisc_ets_band *mlxsw_sp_qdisc_ets_get_band(
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
    struct mlxsw_sp_qdisc *child) {
...
static u8 mlxsw_sp_qdisc_ets_get_prio_bitmap(
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
    struct mlxsw_sp_qdisc *child) {
  return mlxsw_sp_qdisc_ets_get_band(mlxsw_sp_qdisc, child)->prio_bitmap;
}

static int mlxsw_sp_qdisc_ets_get_tclass_num(
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
    struct mlxsw_sp_qdisc *child) {
...
static int mlxsw_sp_qdisc_ets_check_params(struct mlxsw_sp_port *mlxsw_sp_port,
    void *params) {
...
static void mlxsw_sp_qdisc_ets_unoffload(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc,
    void *params) {
  struct tc_ets_qopt_offload_replace_params *p = params;
  __mlxsw_sp_qdisc_ets_unoffload(mlxsw_sp_port, mlxsw_sp_qdisc,
...
static int mlxsw_sp_qdisc_ets_destroy(struct mlxsw_sp_port *mlxsw_sp_port,
    struct mlxsw_sp_qdisc *mlxsw_sp_qdisc) {
  return __mlxsw_sp_qdisc_ets_destroy(mlxsw_sp_port, mlxsw_sp_qdisc);
}
...
static int mlxsw_sp_qevent_entry_configure(struct mlxsw_sp *mlxsw_sp,
  ...
  switch (mall_entry->type) {
    ...
    case MLXSW_SP_MALL_ACTION_TYPE_TRAP:
      return mlxsw_sp_qevent_trap_configure(mlxsw_sp, mall_entry,
          qevent_binding);
    default:
  ...
  switch (mall_entry->type) {
    case MLXSW_SP_MALL_ACTION_TYPE_MIRROR:
      return mlxsw_sp_qevent_mirror_deconfigure(mlxsw_sp, mall_entry,
          qevent_binding);
    case MLXSW_SP_MALL_ACTION_TYPE_TRAP:
      return mlxsw_sp_qevent_trap_deconfigure(mlxsw_sp, mall_entry,
          qevent_binding);
    default:
      WARN_ON(1);
      return;
...
static int mlxsw_sp_qevent_binding_configure(
...
err_entry_configure:
  list_for_each_entry_continue_reverse(mall_entry,
      &qevent_block->mall_entry_list, list)
  mlxsw_sp_qevent_entry_deconfigure(qevent_block->mlxsw_sp, mall_entry,
      qevent_binding);
  return err;
}

static void mlxsw_sp_qevent_binding_deconfigure(
    struct mlxsw_sp_qevent_block *qevent_block,
    struct mlxsw_sp_qevent_binding *qevent_binding) {
  struct mlxsw_sp_mall_entry *mall_entry;
  list_for_each_entry(mall_entry, &qevent_block->mall_entry_list, list)
...
static int mlxsw_sp_qevent_block_configure(
    struct mlxsw_sp_qevent_block *qevent_block,
    struct netlink_ext_ack *extack) {
  struct mlxsw_sp_qevent_binding *qevent_binding;
  int err;
...
err_binding_configure:
  list_for_each_entry_continue_reverse(qevent_binding,
      &qevent_block->binding_list, list)
  mlxsw_sp_qevent_binding_deconfigure(qevent_block, qevent_binding);
  return err;
}

static void mlxsw_sp_qevent_block_deconfigure(
    struct mlxsw_sp_qevent_block *qevent_block) {
  struct mlxsw_sp_qevent_binding *qevent_binding;
  list_for_each_entry(qevent_binding, &qevent_block->binding_list, list)
  mlxsw_sp_qevent_binding_deconfigure(qevent_block, qevent_binding);
...
static struct mlxsw_sp_mall_entry *mlxsw_sp_qevent_mall_entry_find(
    struct mlxsw_sp_qevent_block *block, unsigned long cookie) {
  struct mlxsw_sp_mall_entry *mall_entry;
...
static void mlxsw_sp_qevent_mall_destroy(
    struct mlxsw_sp_qevent_block *qevent_block,
    struct tc_cls_matchall_offload *f) {
  struct mlxsw_sp_mall_entry *mall_entry;
...
static int mlxsw_sp_qevent_block_mall_cb(
    struct mlxsw_sp_qevent_block *qevent_block,
    struct tc_cls_matchall_offload *f) {
...
static int mlxsw_sp_qevent_block_cb(enum tc_setup_type type, void *type_data,
    void *cb_priv) {
...
static void mlxsw_sp_qevent_block_destroy(
    struct mlxsw_sp_qevent_block *qevent_block) {
...
static struct mlxsw_sp_qevent_binding *mlxsw_sp_qevent_binding_create(
    struct mlxsw_sp_port *mlxsw_sp_port, u32 handle, int tclass_num,
    enum mlxsw_sp_span_trigger span_trigger,
    unsigned int action_mask) {
...
static void mlxsw_sp_qevent_binding_destroy(
    struct mlxsw_sp_qevent_binding *binding) {
  kfree(binding);
}

static struct mlxsw_sp_qevent_binding *mlxsw_sp_qevent_binding_lookup(
    struct mlxsw_sp_qevent_block *block,
    struct mlxsw_sp_port *mlxsw_sp_port,
    u32 handle,
    enum mlxsw_sp_span_trigger span_trigger) {
  struct mlxsw_sp_qevent_binding *qevent_binding;
...
static int mlxsw_sp_setup_tc_block_qevent_bind(
    struct mlxsw_sp_port *mlxsw_sp_port,
  ...
  if (!block_cb) {
    ...
    block_cb = flow_block_cb_alloc(mlxsw_sp_qevent_block_cb, mlxsw_sp,
        qevent_block,
...
static void mlxsw_sp_setup_tc_block_qevent_unbind(
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct flow_block_offload *f,
    enum mlxsw_sp_span_trigger span_trigger) {
  struct mlxsw_sp *mlxsw_sp = mlxsw_sp_port->mlxsw_sp;
  ...
  qevent_block = flow_block_cb_priv(block_cb);
  qevent_binding = mlxsw_sp_qevent_binding_lookup(qevent_block, mlxsw_sp_port,
      f->sch->handle,
      span_trigger);
  if (!qevent_binding) {
    return;
