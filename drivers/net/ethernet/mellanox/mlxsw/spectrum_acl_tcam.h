...
const struct mlxsw_sp_acl_profile_ops *mlxsw_sp_acl_tcam_profile_ops(
...
int mlxsw_sp_acl_ctcam_entry_action_replace(struct mlxsw_sp *mlxsw_sp,
    ...
    struct mlxsw_sp_acl_ctcam_entry *centry,
    struct mlxsw_sp_acl_rule_info *rulei);
static inline unsigned int mlxsw_sp_acl_ctcam_entry_offset(
    struct mlxsw_sp_acl_ctcam_entry *centry) {
...
static inline struct mlxsw_sp_acl_atcam_entry *mlxsw_sp_acl_tcam_centry_aentry(
    struct mlxsw_sp_acl_ctcam_entry *centry) {
...
void mlxsw_sp_acl_atcam_fini(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_acl_atcam *atcam);
void *mlxsw_sp_acl_atcam_rehash_hints_get(
  struct mlxsw_sp_acl_atcam_region *aregion);
...
bool mlxsw_sp_acl_erp_mask_is_ctcam(
  const struct mlxsw_sp_acl_erp_mask *erp_mask);
u8 mlxsw_sp_acl_erp_mask_erp_id(const struct mlxsw_sp_acl_erp_mask *erp_mask);
const struct mlxsw_sp_acl_erp_delta *mlxsw_sp_acl_erp_delta(
  const struct mlxsw_sp_acl_erp_mask *erp_mask);
struct mlxsw_sp_acl_erp_mask *mlxsw_sp_acl_erp_mask_get(
  struct mlxsw_sp_acl_atcam_region *aregion,
...
void mlxsw_sp_acl_erp_bf_remove(struct mlxsw_sp *mlxsw_sp,
    ...
    struct mlxsw_sp_acl_erp_mask *erp_mask,
    struct mlxsw_sp_acl_atcam_entry *aentry);
void *mlxsw_sp_acl_erp_rehash_hints_get(
  struct mlxsw_sp_acl_atcam_region *aregion);
...
void mlxsw_sp_acl_bf_entry_del(struct mlxsw_sp *mlxsw_sp,
    ...
    unsigned int erp_bank,
    struct mlxsw_sp_acl_atcam_entry *aentry);
struct mlxsw_sp_acl_bf *mlxsw_sp_acl_bf_init(struct mlxsw_sp *mlxsw_sp,
