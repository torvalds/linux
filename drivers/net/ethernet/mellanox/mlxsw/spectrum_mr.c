...
static bool mlxsw_sp_mr_route_ivif_in_evifs(
    const struct mlxsw_sp_mr_route *mr_route) {
  vifi_t ivif = mr_route->mfc->mfc_parent;
  return mr_route->mfc->mfc_un.res.ttls[ivif] != 255;
}

static int mlxsw_sp_mr_route_valid_evifs_num(
    const struct mlxsw_sp_mr_route *mr_route) {
...
static enum mlxsw_sp_mr_route_action mlxsw_sp_mr_route_action(
    const struct mlxsw_sp_mr_route *mr_route) {
  struct mlxsw_sp_mr_route_vif_entry *rve;
...
static enum mlxsw_sp_mr_route_prio mlxsw_sp_mr_route_prio(
    const struct mlxsw_sp_mr_route *mr_route) {
...
static void mlxsw_sp_mr_route_evif_unlink(
    struct mlxsw_sp_mr_route_vif_entry *rve) {
...
static int mlxsw_sp_mr_route_info_create(struct mlxsw_sp_mr_table *mr_table,
    struct mlxsw_sp_mr_route *mr_route,
...
static void mlxsw_sp_mr_route_info_destroy(
    struct mlxsw_sp_mr_route_info *route_info) {
...
static struct mlxsw_sp_mr_route *mlxsw_sp_mr_route_create(
...
static int mlxsw_sp_mr_route_ivif_resolve(struct mlxsw_sp_mr_table *mr_table,
    struct mlxsw_sp_mr_route_vif_entry *rve) {
  struct mlxsw_sp *mlxsw_sp = mr_table->mlxsw_sp;
  enum mlxsw_sp_mr_route_action route_action;
  struct mlxsw_sp_mr *mr = mlxsw_sp->mr;
...
static void mlxsw_sp_mr_route_ivif_unresolve(struct mlxsw_sp_mr_table *mr_table,
    struct mlxsw_sp_mr_route_vif_entry *rve) {
  struct mlxsw_sp *mlxsw_sp = mr_table->mlxsw_sp;
  struct mlxsw_sp_mr *mr = mlxsw_sp->mr;
...
static int mlxsw_sp_mr_route_evif_resolve(struct mlxsw_sp_mr_table *mr_table,
    struct mlxsw_sp_mr_route_vif_entry *rve) {
  struct mlxsw_sp *mlxsw_sp = mr_table->mlxsw_sp;
  enum mlxsw_sp_mr_route_action route_action;
  struct mlxsw_sp_mr *mr = mlxsw_sp->mr;
...
static void mlxsw_sp_mr_route_evif_unresolve(struct mlxsw_sp_mr_table *mr_table,
    struct mlxsw_sp_mr_route_vif_entry *rve) {
  struct mlxsw_sp *mlxsw_sp = mr_table->mlxsw_sp;
  enum mlxsw_sp_mr_route_action route_action;
  struct mlxsw_sp_mr *mr = mlxsw_sp->mr;
...
static struct mlxsw_sp_mr_vif *mlxsw_sp_mr_dev_vif_lookup(
    struct mlxsw_sp_mr_table *mr_table,
    const struct mlxsw_sp_rif *rif) {
  vifi_t vif_index;
...
static bool mlxsw_sp_mr_route4_validate(
    const struct mlxsw_sp_mr_table *mr_table,
...
static bool mlxsw_sp_mr_route6_validate(
    const struct mlxsw_sp_mr_table *mr_table,
    const struct mr_mfc *c) {
