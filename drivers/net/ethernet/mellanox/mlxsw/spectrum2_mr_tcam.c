...
static struct mlxsw_sp_acl_ruleset *mlxsw_sp2_mr_tcam_proto_ruleset(
    struct mlxsw_sp2_mr_tcam *mr_tcam,
...
static void mlxsw_sp2_mr_tcam_rule_parse4(struct mlxsw_sp_acl_rule_info *rulei,
...
static void mlxsw_sp2_mr_tcam_rule_parse6(struct mlxsw_sp_acl_rule_info *rulei,
    struct mlxsw_sp_mr_route_key *key) {
...
static void mlxsw_sp2_mr_tcam_rule_parse(struct mlxsw_sp_acl_rule *rule,
    struct mlxsw_sp_mr_route_key *key,
...
static int mlxsw_sp2_mr_tcam_route_create(struct mlxsw_sp *mlxsw_sp, void *priv,
    void *route_priv,
    struct mlxsw_sp_mr_route_key *key,
...
static int mlxsw_sp2_mr_tcam_route_update(struct mlxsw_sp *mlxsw_sp,
    void *route_priv,
    struct mlxsw_sp_mr_route_key *key,
    struct mlxsw_afa_block *afa_block) {
  struct mlxsw_sp2_mr_route *mr_route = route_priv;
