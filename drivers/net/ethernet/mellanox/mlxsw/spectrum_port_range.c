...
static int mlxsw_sp_port_range_reg_configure(struct mlxsw_sp *mlxsw_sp,
...
static struct mlxsw_sp_port_range_reg *mlxsw_sp_port_range_reg_create(
...
static struct mlxsw_sp_port_range_reg *mlxsw_sp_port_range_reg_find(
    struct mlxsw_sp *mlxsw_sp,
    const struct mlxsw_sp_port_range *range) {
  struct mlxsw_sp_port_range_core *pr_core = mlxsw_sp->pr_core;
  struct mlxsw_sp_port_range_reg *prr;
