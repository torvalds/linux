...
struct mlxsw_sp_ptp_clock *mlxsw_sp2_ptp_clock_init(struct mlxsw_sp *mlxsw_sp,
    struct device *dev);
...
static inline struct mlxsw_sp_ptp_clock *mlxsw_sp1_ptp_clock_init(
    struct mlxsw_sp *mlxsw_sp, struct device *dev) {
  return NULL;
}
...
static inline struct mlxsw_sp_ptp_state *mlxsw_sp1_ptp_init(
...
static inline void mlxsw_sp1_ptp_got_timestamp(struct mlxsw_sp *mlxsw_sp,
    bool ingress,
    u16 local_port, u8 message_type,
    u8 domain_number,
...
static inline int mlxsw_sp1_ptp_hwtstamp_get(
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct hwtstamp_config *config) {
  return -EOPNOTSUPP;
}

static inline int mlxsw_sp1_ptp_hwtstamp_set(
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct hwtstamp_config *config) {
  return -EOPNOTSUPP;
}
...
static inline int mlxsw_sp_ptp_txhdr_construct(struct mlxsw_core *mlxsw_core,
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct sk_buff *skb,
    const struct mlxsw_tx_info *tx_info) {
  return -EOPNOTSUPP;
...
static inline struct mlxsw_sp_ptp_clock *mlxsw_sp2_ptp_clock_init(
    struct mlxsw_sp *mlxsw_sp, struct device *dev) {
  return NULL;
}
...
static inline struct mlxsw_sp_ptp_state *mlxsw_sp2_ptp_init(
    struct mlxsw_sp *mlxsw_sp) {
  return NULL;
}
...
static inline int mlxsw_sp2_ptp_hwtstamp_get(
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct hwtstamp_config *config) {
  return -EOPNOTSUPP;
}

static inline int mlxsw_sp2_ptp_hwtstamp_set(
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct hwtstamp_config *config) {
  return -EOPNOTSUPP;
}
...
static inline int mlxsw_sp2_ptp_txhdr_construct(struct mlxsw_core *mlxsw_core,
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct sk_buff *skb,
    const struct mlxsw_tx_info *tx_info) {
  return -EOPNOTSUPP;
