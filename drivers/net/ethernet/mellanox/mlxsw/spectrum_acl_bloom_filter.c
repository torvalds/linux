 ...
 */
static const u8 chunk_key_offsets[MLXSW_BLOOM_KEY_CHUNKS] = {
  2, 20, 38
};
...
static void __mlxsw_sp_acl_bf_key_encode(
...
static void mlxsw_sp2_acl_bf_key_encode(
    struct mlxsw_sp_acl_atcam_region *aregion,
    struct mlxsw_sp_acl_atcam_entry *aentry,
    char *output, u8 *len) {
...
static unsigned int mlxsw_sp2_acl_bf_index_get(struct mlxsw_sp_acl_bf *bf,
    struct mlxsw_sp_acl_atcam_region *aregion,
    struct mlxsw_sp_acl_atcam_entry *aentry) {
...
static void mlxsw_sp4_acl_bf_key_encode(
    struct mlxsw_sp_acl_atcam_region *aregion,
    struct mlxsw_sp_acl_atcam_entry *aentry,
    char *output, u8 *len) {
  struct mlxsw_afk_key_info *key_info = aregion->region->key_info;
...
static unsigned int mlxsw_sp4_acl_bf_index_get(struct mlxsw_sp_acl_bf *bf,
    struct mlxsw_sp_acl_atcam_region *aregion,
    struct mlxsw_sp_acl_atcam_entry *aentry) {
...
static unsigned int mlxsw_sp_acl_bf_rule_count_index_get(
