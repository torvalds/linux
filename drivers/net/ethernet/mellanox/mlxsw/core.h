...
enum mlxsw_cmd_mbox_config_profile_lag_mode mlxsw_core_lag_mode(
  struct mlxsw_core *mlxsw_core);
enum mlxsw_cmd_mbox_config_profile_flood_mode mlxsw_core_flood_mode(
  struct mlxsw_core *mlxsw_core);
...
bool mlxsw_core_fw_rev_minor_subminor_validate(const struct mlxsw_fw_rev *rev,
...
struct devlink_port *mlxsw_core_port_devlink_port_get(
  struct mlxsw_core *mlxsw_core,
  u16 local_port);
struct mlxsw_linecard *mlxsw_core_port_linecard_get(
  struct mlxsw_core *mlxsw_core,
  u16 local_port);
...
static inline struct mlxsw_linecard *mlxsw_linecard_get(
    struct mlxsw_linecards *linecards, u8 slot_index) {
