...
static inline int mlxsw_sp_port_bitmap_init(struct mlxsw_sp *mlxsw_sp,
...
static inline void mlxsw_sp_port_bitmap_fini(
    struct mlxsw_sp_ports_bitmap *ports_bm) {
...
static inline struct net_device *mlxsw_sp_bridge_vxlan_dev_find(
...
static inline int mlxsw_sp_vxlan_mapped_vid(const struct net_device *vxlan_dev,
    u16 *p_vid) {
...
static inline bool mlxsw_sp_port_is_pause_en(
    const struct mlxsw_sp_port *mlxsw_sp_port) {
  return mlxsw_sp_port->link.tx_pause || mlxsw_sp_port->link.rx_pause;
}

static inline struct mlxsw_sp_port *mlxsw_sp_port_lagged_get(
    struct mlxsw_sp *mlxsw_sp, u16 lag_id, u8 port_index) {
  struct mlxsw_sp_port *mlxsw_sp_port;
  u16 local_port;
...
static inline bool mlxsw_sp_local_port_is_valid(struct mlxsw_sp *mlxsw_sp,
    u16 local_port) {
...
struct mlxsw_sp_sample_params *mlxsw_sp_sample_trigger_params_lookup(
  struct mlxsw_sp *mlxsw_sp,
  const struct mlxsw_sp_sample_trigger *trigger);
int mlxsw_sp_sample_trigger_params_set(struct mlxsw_sp *mlxsw_sp,
    const struct mlxsw_sp_sample_trigger *trigger,
    const struct mlxsw_sp_sample_params *params,
    struct netlink_ext_ack *extack);
void mlxsw_sp_sample_trigger_params_unset(struct mlxsw_sp *mlxsw_sp,
    const struct mlxsw_sp_sample_trigger *trigger);
int mlxsw_sp_ipv6_addr_kvdl_index_get(struct mlxsw_sp *mlxsw_sp,
    const struct in6_addr *addr6,
    u32 *p_kvdl_index);
void mlxsw_sp_ipv6_addr_put(struct mlxsw_sp *mlxsw_sp,
    const struct in6_addr *addr6);
...
int mlxsw_sp_port_pvid_set(struct mlxsw_sp_port *mlxsw_sp_port, u16 vid,
    u16 ethtype);
struct mlxsw_sp_port_vlan *mlxsw_sp_port_vlan_create(
...
static inline unsigned int mlxsw_sp_kvdl_entry_size(
...
static inline struct mlxsw_sp *mlxsw_sp_flow_block_mlxsw_sp(
    struct mlxsw_sp_flow_block *block) {
  return block->mlxsw_sp;
}

static inline unsigned int mlxsw_sp_flow_block_rule_count(
    const struct mlxsw_sp_flow_block *block) {
  return block ? block->rule_count : 0;
}

static inline void mlxsw_sp_flow_block_disable_inc(
    struct mlxsw_sp_flow_block *block) {
  if (block) {
    block->disable_count++;
  }
...
static inline void mlxsw_sp_flow_block_disable_dec(
    struct mlxsw_sp_flow_block *block) {
  if (block) {
    block->disable_count--;
  }
...
static inline bool mlxsw_sp_flow_block_disabled(
    const struct mlxsw_sp_flow_block *block) {
  return block->disable_count;
}

static inline bool mlxsw_sp_flow_block_is_egress_bound(
    const struct mlxsw_sp_flow_block *block) {
  return block->egress_binding_count;
}

static inline bool mlxsw_sp_flow_block_is_ingress_bound(
    const struct mlxsw_sp_flow_block *block) {
  return block->ingress_binding_count;
}

static inline bool mlxsw_sp_flow_block_is_mixed_bound(
    const struct mlxsw_sp_flow_block *block) {
  return block->ingress_binding_count && block->egress_binding_count;
}

struct mlxsw_sp_flow_block *mlxsw_sp_flow_block_create(
  struct mlxsw_sp *mlxsw_sp,
  struct net *net);
...
static inline const struct flow_action_cookie *mlxsw_sp_acl_act_cookie_lookup(
    struct mlxsw_sp *mlxsw_sp, u32 cookie_index) {
...
int mlxsw_sp_setup_tc_block_qevent_early_drop(
  struct mlxsw_sp_port *mlxsw_sp_port,
  struct flow_block_offload *f);
...
enum mlxsw_sp_rif_type mlxsw_sp_fid_type_rif_type(
...
int mlxsw_sp_trap_policer_counter_get(struct mlxsw_core *mlxsw_core,
    const struct devlink_trap_policer *policer,
    u64 *p_drops);
