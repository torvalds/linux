...
static struct mlxsw_sp_pgt_entry_port *mlxsw_sp_pgt_entry_port_lookup(
...
static struct mlxsw_sp_pgt_entry *mlxsw_sp_pgt_entry_create(
    struct mlxsw_sp_pgt *pgt, u16 mid, u16 smpe) {
  struct mlxsw_sp_pgt_entry *pgt_entry;
  void *ret;
  int err;
...
static struct mlxsw_sp_pgt_entry *mlxsw_sp_pgt_entry_get(
    struct mlxsw_sp_pgt *pgt, u16 mid, u16 smpe) {
  struct mlxsw_sp_pgt_entry *pgt_entry;
...
static int mlxsw_sp_pgt_entry_port_write(struct mlxsw_sp *mlxsw_sp,
...
static struct mlxsw_sp_pgt_entry_port *mlxsw_sp_pgt_entry_port_create(
...
static void mlxsw_sp_pgt_entry_port_destroy(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_pgt_entry *pgt_entry,
    struct mlxsw_sp_pgt_entry_port *pgt_entry_port) {
