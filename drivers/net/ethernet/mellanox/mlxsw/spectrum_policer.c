...
struct mlxsw_sp_policer_family_ops {
  ...
  struct mlxsw_sp_policer *(*policer_index_free)(struct mlxsw_sp_policer_family
      *family,
      u16 policer_index);
...
static int mlxsw_sp_policer_single_rate_family_init(
...
static void mlxsw_sp_policer_single_rate_family_fini(
    struct mlxsw_sp_policer_family *family) {
...
static int mlxsw_sp_policer_single_rate_index_alloc(
    struct mlxsw_sp_policer_family *family,
    struct mlxsw_sp_policer *policer) {
  int id;
...
static struct mlxsw_sp_policer *mlxsw_sp_policer_single_rate_index_free(
    struct mlxsw_sp_policer_family *family,
    u16 policer_index) {
  struct mlxsw_sp_policer *policer;
...
static int mlxsw_sp_policer_single_rate_init(
    struct mlxsw_sp_policer_family *family,
    const struct mlxsw_sp_policer *policer) {
...
static int mlxsw_sp_policer_single_rate_params_check(
    const struct mlxsw_sp_policer_family *family,
    const struct mlxsw_sp_policer_params *params,
    struct netlink_ext_ack *extack) {
  ...
  if (!params->bytes) {
    NL_SET_ERR_MSG_MOD(extack,
        "Only bandwidth policing is currently supported by single rate policers");
    return -EINVAL;
  }
...
static int mlxsw_sp_policer_family_register(struct mlxsw_sp *mlxsw_sp,
...
static void mlxsw_sp_policer_family_unregister(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_policer_family *family) {
  family->ops->fini(family);
  mutex_destroy(&family->lock);
...
static int mlxsw_sp1_policer_core_init(
    struct mlxsw_sp_policer_core *policer_core) {
...
static int mlxsw_sp2_policer_core_init(
    struct mlxsw_sp_policer_core *policer_core) {
