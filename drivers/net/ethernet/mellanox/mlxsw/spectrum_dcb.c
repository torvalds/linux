...
static u8 mlxsw_sp_port_dcb_app_default_prio(
...
static void mlxsw_sp_port_dcb_app_dscp_prio_map(
    struct mlxsw_sp_port *mlxsw_sp_port,
    u8 default_prio,
...
static bool mlxsw_sp_port_dcb_app_prio_dscp_map(
    struct mlxsw_sp_port *mlxsw_sp_port,
...
static int mlxsw_sp_port_dcb_app_update_qpts(
    struct mlxsw_sp_port *mlxsw_sp_port,
...
static int mlxsw_sp_port_dcb_app_update_qrwe(
    struct mlxsw_sp_port *mlxsw_sp_port,
    bool rewrite_dscp) {
  struct mlxsw_sp *mlxsw_sp = mlxsw_sp_port->mlxsw_sp;
...
static int mlxsw_sp_port_dcb_toggle_trust(struct mlxsw_sp_port *mlxsw_sp_port,
    enum mlxsw_reg_qpts_trust_state ts) {
...
static int mlxsw_sp_port_dcb_app_update_qpdp(
    struct mlxsw_sp_port *mlxsw_sp_port,
    u8 default_prio) {
  struct mlxsw_sp *mlxsw_sp = mlxsw_sp_port->mlxsw_sp;
...
static int mlxsw_sp_port_dcb_app_update_qpdsm(
    struct mlxsw_sp_port *mlxsw_sp_port,
    struct dcb_ieee_app_prio_map *map) {
  struct mlxsw_sp *mlxsw_sp = mlxsw_sp_port->mlxsw_sp;
...
static int mlxsw_sp_dcbnl_getbuffer(struct net_device *dev,
    struct dcbnl_buffer *buf) {
  struct mlxsw_sp_port *mlxsw_sp_port = netdev_priv(dev);
...
static int mlxsw_sp_dcbnl_setbuffer(struct net_device *dev,
    struct dcbnl_buffer *buf) {
  struct mlxsw_sp_port *mlxsw_sp_port = netdev_priv(dev);
  struct mlxsw_sp *mlxsw_sp = mlxsw_sp_port->mlxsw_sp;
  struct mlxsw_sp_hdroom hdroom;
  ...
  if (hdroom.mode != MLXSW_SP_HDROOM_MODE_TC) {
    netdev_err(dev,
        "The use of dcbnl_setbuffer is only allowed if egress is configured using TC\n");
    return -EINVAL;
  }
  for (prio = 0; prio < IEEE_8021Q_MAX_PRIORITIES; prio++) {
