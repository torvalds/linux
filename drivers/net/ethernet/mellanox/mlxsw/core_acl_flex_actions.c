...
int mlxsw_afa_block_activity_get(struct mlxsw_afa_block *block,
    bool *activity) {
...
static struct mlxsw_afa_fwd_entry *mlxsw_afa_fwd_entry_create(
    struct mlxsw_afa *mlxsw_afa, u16 local_port) {
...
static struct mlxsw_afa_fwd_entry *mlxsw_afa_fwd_entry_get(
    struct mlxsw_afa *mlxsw_afa, u16 local_port) {
  struct mlxsw_afa_fwd_entry_ht_key ht_key = {
    0
  };
...
static void mlxsw_afa_fwd_entry_ref_destroy(struct mlxsw_afa_block *block,
...
static void mlxsw_afa_fwd_entry_ref_destructor(struct mlxsw_afa_block *block,
    struct mlxsw_afa_resource *resource) {
  struct mlxsw_afa_fwd_entry_ref *fwd_entry_ref;
...
static struct mlxsw_afa_fwd_entry_ref *mlxsw_afa_fwd_entry_ref_create(
    struct mlxsw_afa_block *block, u16 local_port) {
  struct mlxsw_afa_fwd_entry_ref *fwd_entry_ref;
  struct mlxsw_afa_fwd_entry *fwd_entry;
  int err;
...
static void mlxsw_afa_counter_destroy(struct mlxsw_afa_block *block,
...
static void mlxsw_afa_counter_destructor(struct mlxsw_afa_block *block,
    struct mlxsw_afa_resource *resource) {
  struct mlxsw_afa_counter *counter;
...
static struct mlxsw_afa_counter *mlxsw_afa_counter_create(
    struct mlxsw_afa_block *block) {
  struct mlxsw_afa_counter *counter;
  int err;
...
static struct mlxsw_afa_cookie *mlxsw_afa_cookie_create(
    struct mlxsw_afa *mlxsw_afa,
...
static struct mlxsw_afa_cookie *mlxsw_afa_cookie_get(
    struct mlxsw_afa *mlxsw_afa,
    const struct flow_action_cookie *fa_cookie) {
  struct mlxsw_afa_cookie *cookie;
...
static void mlxsw_afa_cookie_ref_destroy(struct mlxsw_afa_block *block,
...
static void mlxsw_afa_cookie_ref_destructor(struct mlxsw_afa_block *block,
    struct mlxsw_afa_resource *resource) {
  struct mlxsw_afa_cookie_ref *cookie_ref;
...
static struct mlxsw_afa_cookie_ref *mlxsw_afa_cookie_ref_create(
    struct mlxsw_afa_block *block,
    const struct flow_action_cookie *fa_cookie) {
  struct mlxsw_afa_cookie_ref *cookie_ref;
  struct mlxsw_afa_cookie *cookie;
...
static struct mlxsw_afa_policer *mlxsw_afa_policer_create(
    struct mlxsw_afa *mlxsw_afa, u32 fa_index,
...
static struct mlxsw_afa_policer *mlxsw_afa_policer_get(
    struct mlxsw_afa *mlxsw_afa, u32 fa_index,
    u64 rate_bytes_ps, u32 burst,
    struct netlink_ext_ack *extack) {
  struct mlxsw_afa_policer *policer;
...
static void mlxsw_afa_policer_ref_destroy(struct mlxsw_afa_block *block,
...
static void mlxsw_afa_policer_ref_destructor(struct mlxsw_afa_block *block,
    struct mlxsw_afa_resource *resource) {
  struct mlxsw_afa_policer_ref *policer_ref;
...
static struct mlxsw_afa_policer_ref *mlxsw_afa_policer_ref_create(
    struct mlxsw_afa_block *block, u32 fa_index,
    u64 rate_bytes_ps, u32 burst,
    struct netlink_ext_ack *extack) {
  struct mlxsw_afa_policer_ref *policer_ref;
  struct mlxsw_afa_policer *policer;
...
static bool mlxsw_afa_block_need_split(const struct mlxsw_afa_block *block,
...
static inline void mlxsw_afa_vlan_pack(char *payload,
...
static inline void mlxsw_afa_trap_pack(char *payload,
...
static inline void mlxsw_afa_trapwu_pack(char *payload,
    enum mlxsw_afa_trap_trap_action trap_action,
    enum mlxsw_afa_trap_forward_action forward_action,
...
static inline void mlxsw_afa_trap_mirror_pack(char *payload, bool mirror_enable,
    u8 mirror_agent) {
...
static int mlxsw_afa_block_append_drop_with_cookie(
    struct mlxsw_afa_block *block,
    bool ingress,
    const struct flow_action_cookie *fa_cookie,
    struct netlink_ext_ack *extack) {
...
static void mlxsw_afa_mirror_destroy(struct mlxsw_afa_block *block,
...
static void mlxsw_afa_mirror_destructor(struct mlxsw_afa_block *block,
    struct mlxsw_afa_resource *resource) {
  struct mlxsw_afa_mirror *mirror;
...
static struct mlxsw_afa_mirror *mlxsw_afa_mirror_create(
    struct mlxsw_afa_block *block, u16 local_in_port,
...
static int mlxsw_afa_block_append_allocated_mirror(
    struct mlxsw_afa_block *block,
    u8 mirror_agent) {
  char *act = mlxsw_afa_block_append_action_trap(block,
      MLXSW_AFA_TRAP_CODE,
...
static inline void mlxsw_afa_qos_switch_prio_pack(char *payload,
...
static inline void mlxsw_afa_forward_pack(char *payload,
...
static inline void mlxsw_afa_polcnt_pack(char *payload,
...
static inline void mlxsw_afa_mcrouter_pack(char *payload,
 ...
 * packet, e.g. for NAT.
 * If (the L4 is TCP) or if (the L4 is UDP and checksum field!=0) then the L4
 * checksum is updated.
 */
...
static int mlxsw_afa_block_append_allocated_sampler(
    struct mlxsw_afa_block *block,
