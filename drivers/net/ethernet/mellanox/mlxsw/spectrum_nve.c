...
static int mlxsw_sp_nve_mc_record_ipv4_entry_add(
...
static void mlxsw_sp_nve_mc_record_ipv4_entry_del(
    const struct mlxsw_sp_nve_mc_record *mc_record,
    const struct mlxsw_sp_nve_mc_entry *mc_entry) {
}

static void mlxsw_sp_nve_mc_record_ipv4_entry_set(
    const struct mlxsw_sp_nve_mc_record *mc_record,
    const struct mlxsw_sp_nve_mc_entry *mc_entry,
    char *tnumt_pl, unsigned int entry_index) {
...
static bool mlxsw_sp_nve_mc_record_ipv4_entry_compare(
    const struct mlxsw_sp_nve_mc_record *mc_record,
    const struct mlxsw_sp_nve_mc_entry *mc_entry,
    const union mlxsw_sp_l3addr *addr) {
...
static int mlxsw_sp_nve_mc_record_ipv6_entry_add(
    struct mlxsw_sp_nve_mc_record *mc_record,
    struct mlxsw_sp_nve_mc_entry *mc_entry,
    const union mlxsw_sp_l3addr *addr) {
  u32 kvdl_index;
...
static void mlxsw_sp_nve_mc_record_ipv6_entry_del(
    const struct mlxsw_sp_nve_mc_record *mc_record,
    const struct mlxsw_sp_nve_mc_entry *mc_entry) {
...
static void mlxsw_sp_nve_mc_record_ipv6_entry_set(
    const struct mlxsw_sp_nve_mc_record *mc_record,
    const struct mlxsw_sp_nve_mc_entry *mc_entry,
    char *tnumt_pl, unsigned int entry_index) {
...
static bool mlxsw_sp_nve_mc_record_ipv6_entry_compare(
    const struct mlxsw_sp_nve_mc_record *mc_record,
    const struct mlxsw_sp_nve_mc_entry *mc_entry,
    const union mlxsw_sp_l3addr *addr) {
...
static struct mlxsw_sp_nve_mc_list *mlxsw_sp_nve_mc_list_find(
    struct mlxsw_sp *mlxsw_sp,
...
static struct mlxsw_sp_nve_mc_list *mlxsw_sp_nve_mc_list_create(
    struct mlxsw_sp *mlxsw_sp,
    const struct mlxsw_sp_nve_mc_list_key *key) {
  struct mlxsw_sp_nve *nve = mlxsw_sp->nve;
  struct mlxsw_sp_nve_mc_list *mc_list;
...
static struct mlxsw_sp_nve_mc_list *mlxsw_sp_nve_mc_list_get(
    struct mlxsw_sp *mlxsw_sp,
    const struct mlxsw_sp_nve_mc_list_key *key) {
  struct mlxsw_sp_nve_mc_list *mc_list;
...
static void mlxsw_sp_nve_mc_list_put(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_nve_mc_list *mc_list) {
...
static struct mlxsw_sp_nve_mc_record *mlxsw_sp_nve_mc_record_create(
    struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_nve_mc_list *mc_list,
    enum mlxsw_sp_l3proto proto) {
...
static void mlxsw_sp_nve_mc_record_destroy(
    struct mlxsw_sp_nve_mc_record *mc_record) {
...
static struct mlxsw_sp_nve_mc_record *mlxsw_sp_nve_mc_record_get(
    struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_nve_mc_list *mc_list,
    enum mlxsw_sp_l3proto proto) {
  struct mlxsw_sp_nve_mc_record *mc_record;
...
static void mlxsw_sp_nve_mc_record_put(struct mlxsw_sp_nve_mc_record *mc_record)
{
...
static struct mlxsw_sp_nve_mc_entry *mlxsw_sp_nve_mc_free_entry_find(
    struct mlxsw_sp_nve_mc_record *mc_record) {
...
static int mlxsw_sp_nve_mc_record_refresh(
    struct mlxsw_sp_nve_mc_record *mc_record) {
...
static bool mlxsw_sp_nve_mc_record_is_first(
    struct mlxsw_sp_nve_mc_record *mc_record) {
  struct mlxsw_sp_nve_mc_list *mc_list = mc_record->mc_list;
...
static struct mlxsw_sp_nve_mc_entry *mlxsw_sp_nve_mc_entry_find(
    struct mlxsw_sp_nve_mc_record *mc_record,
    union mlxsw_sp_l3addr *addr) {
  struct mlxsw_sp_nve *nve = mc_record->mlxsw_sp->nve;
  unsigned int num_max_entries;
...
static int mlxsw_sp_nve_mc_record_ip_add(
    struct mlxsw_sp_nve_mc_record *mc_record,
    union mlxsw_sp_l3addr *addr) {
...
static void mlxsw_sp_nve_mc_record_entry_del(
    struct mlxsw_sp_nve_mc_record *mc_record,
    struct mlxsw_sp_nve_mc_entry *mc_entry) {
  struct mlxsw_sp_nve_mc_list *mc_list = mc_record->mc_list;
  mc_entry->valid = false;
...
static struct mlxsw_sp_nve_mc_record *mlxsw_sp_nve_mc_record_find(
    struct mlxsw_sp_nve_mc_list *mc_list,
    enum mlxsw_sp_l3proto proto,
    union mlxsw_sp_l3addr *addr,
    struct mlxsw_sp_nve_mc_entry **mc_entry) {
...
static int mlxsw_sp_nve_fid_flood_index_set(struct mlxsw_sp_fid *fid,
    struct mlxsw_sp_nve_mc_list *mc_list) {
  struct mlxsw_sp_nve_mc_record *mc_record;
...
static void mlxsw_sp_nve_fid_flood_index_clear(struct mlxsw_sp_fid *fid,
    struct mlxsw_sp_nve_mc_list *mc_list) {
  struct mlxsw_sp_nve_mc_record *mc_record;
...
static void mlxsw_sp_nve_mc_record_delete(
    struct mlxsw_sp_nve_mc_record *mc_record) {
  struct mlxsw_sp_nve *nve = mc_record->mlxsw_sp->nve;
  unsigned int num_max_entries;
  int i;
...
static struct mlxsw_sp_nve_ipv6_ht_node *mlxsw_sp_nve_ipv6_ht_node_lookup(
...
static void mlxsw_sp_nve_ipv6_ht_remove(struct mlxsw_sp *mlxsw_sp,
    struct mlxsw_sp_nve_ipv6_ht_node *ipv6_ht_node) {
  struct mlxsw_sp_nve *nve = mlxsw_sp->nve;
