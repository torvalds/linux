...
const struct flow_action_cookie *mlxsw_afa_cookie_lookup(
  struct mlxsw_afa *mlxsw_afa, u32 cookie_index);
...
int mlxsw_afa_block_append_ip(struct mlxsw_afa_block *block, bool is_dip,
    ...
    struct netlink_ext_ack *extack);
int mlxsw_afa_block_append_l4port(struct mlxsw_afa_block *block, bool is_dport,
    u16 l4_port,
    struct netlink_ext_ack *extack);
int mlxsw_afa_block_append_police(struct mlxsw_afa_block *block,
    ...
    u16 *p_policer_index,
    struct netlink_ext_ack *extack);
int mlxsw_afa_block_append_sampler(struct mlxsw_afa_block *block,
    u16 local_port,
