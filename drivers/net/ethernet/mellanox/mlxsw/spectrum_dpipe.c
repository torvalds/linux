...
static void mlxsw_sp_erif_match_action_prepare(
    struct devlink_dpipe_match *match,
    struct devlink_dpipe_action *action) {
  action->type = DEVLINK_DPIPE_ACTION_TYPE_FIELD_MODIFY;
  action->header = &mlxsw_sp_dpipe_header_metadata;
...
static int mlxsw_sp_dpipe_table_erif_entries_dump(void *priv,
    bool counters_enabled,
...
static int mlxsw_sp_dpipe_table_host_matches_dump(struct sk_buff *skb,
    int type) {
  struct devlink_dpipe_match match = {
    0
  };
...
static int mlxsw_sp_dpipe_table_host4_matches_dump(void *priv,
    struct sk_buff *skb) {
  return mlxsw_sp_dpipe_table_host_matches_dump(skb, AF_INET);
}

static int mlxsw_sp_dpipe_table_host_actions_dump(void *priv,
    struct sk_buff *skb) {
  struct devlink_dpipe_action action = {
    0
  };
...
static void mlxsw_sp_dpipe_table_host_match_action_prepare(
...
static void __mlxsw_sp_dpipe_table_host_entry_fill(
    struct devlink_dpipe_entry *entry,
    struct mlxsw_sp_rif *rif,
...
static void mlxsw_sp_dpipe_table_host4_entry_fill(
    struct devlink_dpipe_entry *entry,
...
static void mlxsw_sp_dpipe_table_host6_entry_fill(
    struct devlink_dpipe_entry *entry,
    struct mlxsw_sp_neigh_entry *neigh_entry,
    struct mlxsw_sp_rif *rif) {
  struct in6_addr *dip;
...
static void mlxsw_sp_dpipe_table_host_entry_fill(struct mlxsw_sp *mlxsw_sp,
    struct devlink_dpipe_entry *entry,
    struct mlxsw_sp_neigh_entry *neigh_entry,
    struct mlxsw_sp_rif *rif,
    int type) {
...
static int mlxsw_sp_dpipe_table_host_entries_get(struct mlxsw_sp *mlxsw_sp,
    struct devlink_dpipe_entry *entry,
    bool counters_enabled,
    struct devlink_dpipe_dump_ctx *dump_ctx,
    int type) {
...
static int mlxsw_sp_dpipe_table_host_entries_dump(struct mlxsw_sp *mlxsw_sp,
    bool counters_enabled,
    struct devlink_dpipe_dump_ctx *dump_ctx,
    int type) {
...
static int mlxsw_sp_dpipe_table_host4_entries_dump(void *priv,
    bool counters_enabled,
    struct devlink_dpipe_dump_ctx *dump_ctx) {
  struct mlxsw_sp *mlxsw_sp = priv;
...
static void mlxsw_sp_dpipe_table_host_counters_update(struct mlxsw_sp *mlxsw_sp,
...
static u64 mlxsw_sp_dpipe_table_host_size_get(struct mlxsw_sp *mlxsw_sp,
    int type) {
  u64 size = 0;
  int i;
  mutex_lock(&mlxsw_sp->router->lock);
...
static int mlxsw_sp_dpipe_table_host6_matches_dump(void *priv,
    struct sk_buff *skb) {
  return mlxsw_sp_dpipe_table_host_matches_dump(skb, AF_INET6);
}

static int mlxsw_sp_dpipe_table_host6_entries_dump(void *priv,
    bool counters_enabled,
    struct devlink_dpipe_dump_ctx *dump_ctx) {
  struct mlxsw_sp *mlxsw_sp = priv;
  return mlxsw_sp_dpipe_table_host_entries_dump(mlxsw_sp,
...
static void mlxsw_sp_dpipe_table_adj_match_action_prepare(
    struct devlink_dpipe_match *matches,
...
static int mlxsw_sp_dpipe_table_adj_entry_prepare(
    struct devlink_dpipe_entry *entry,
    struct devlink_dpipe_value *match_values,
    struct devlink_dpipe_match *matches,
...
static void __mlxsw_sp_dpipe_table_adj_entry_fill(
    struct devlink_dpipe_entry *entry,
...
static int mlxsw_sp_dpipe_table_adj_entries_get(struct mlxsw_sp *mlxsw_sp,
    struct devlink_dpipe_entry *entry,
    bool counters_enabled,
    struct devlink_dpipe_dump_ctx *dump_ctx) {
  struct mlxsw_sp_nexthop *nh;
...
static int mlxsw_sp_dpipe_table_adj_entries_dump(void *priv,
    bool counters_enabled,
    struct devlink_dpipe_dump_ctx *dump_ctx) {
...
static u64 mlxsw_sp_dpipe_table_adj_size_get(void *priv) {
  struct mlxsw_sp *mlxsw_sp = priv;
  u64 size;
  mutex_lock(&mlxsw_sp->router->lock);
