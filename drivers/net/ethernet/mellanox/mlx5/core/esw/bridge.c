...
static void mlx5_esw_bridge_fdb_offload_notify(struct net_device *dev,
...
static void mlx5_esw_bridge_fdb_del_notify(
    struct mlx5_esw_bridge_fdb_entry *entry) {
  if (!(entry->flags
      & (MLX5_ESW_BRIDGE_FLAG_ADDED_BY_USER | MLX5_ESW_BRIDGE_FLAG_PEER))) {
...
static bool mlx5_esw_bridge_pkt_reformat_vlan_pop_supported(
    struct mlx5_eswitch *esw) {
  return BIT(MLX5_CAP_ESW_FLOWTABLE_FDB(esw->dev, reformat_remove))
    && MLX5_CAP_GEN_2(esw->dev,
      max_reformat_remove_size) >= sizeof(struct vlan_hdr)
    && MLX5_CAP_GEN_2(esw->dev, max_reformat_remove_offset)
    >= offsetof(struct vlan_ethhdr, h_vlan_proto);
}

static struct mlx5_pkt_reformat *mlx5_esw_bridge_pkt_reformat_vlan_pop_create(
    struct mlx5_eswitch *esw) {
...
static struct mlx5_flow_group *mlx5_esw_bridge_ingress_vlan_proto_fg_create(
...
static struct mlx5_flow_group *mlx5_esw_bridge_ingress_vlan_fg_create(
    struct mlx5_eswitch *esw,
    struct mlx5_flow_table *ingress_ft) {
  ...
  return mlx5_esw_bridge_ingress_vlan_proto_fg_create(from, to, ETH_P_8021Q,
      esw, ingress_ft);
}

static struct mlx5_flow_group *mlx5_esw_bridge_ingress_qinq_fg_create(
    struct mlx5_eswitch *esw,
    struct mlx5_flow_table *ingress_ft) {
  ...
  return mlx5_esw_bridge_ingress_vlan_proto_fg_create(from, to, ETH_P_8021AD,
      esw,
      ingress_ft);
}

static struct mlx5_flow_group *
mlx5_esw_bridge_ingress_vlan_proto_filter_fg_create(unsigned int from,
    unsigned int to,
...
static struct mlx5_flow_group *mlx5_esw_bridge_ingress_vlan_filter_fg_create(
    struct mlx5_eswitch *esw,
    struct mlx5_flow_table *ingress_ft) {
  ...
  return mlx5_esw_bridge_ingress_vlan_proto_filter_fg_create(from, to,
      ETH_P_8021Q, esw,
      ingress_ft);
}

static struct mlx5_flow_group *mlx5_esw_bridge_ingress_qinq_filter_fg_create(
    struct mlx5_eswitch *esw,
    struct mlx5_flow_table *ingress_ft) {
...
static struct mlx5_flow_group *mlx5_esw_bridge_ingress_mac_fg_create(
    struct mlx5_eswitch *esw, struct mlx5_flow_table *ingress_ft) {
  int inlen = MLX5_ST_SZ_BYTES(create_flow_group_in);
  struct mlx5_flow_group *fg;
  u32 *in, *match;
  in = kvzalloc(inlen, GFP_KERNEL);
...
static struct mlx5_flow_group *mlx5_esw_bridge_egress_vlan_proto_fg_create(
    unsigned int from, unsigned int to, u16 vlan_proto,
    struct mlx5_eswitch *esw,
...
static struct mlx5_flow_group *mlx5_esw_bridge_egress_vlan_fg_create(
    struct mlx5_eswitch *esw, struct mlx5_flow_table *egress_ft) {
  ...
  return mlx5_esw_bridge_egress_vlan_proto_fg_create(from, to, ETH_P_8021Q, esw,
      egress_ft);
}

static struct mlx5_flow_group *mlx5_esw_bridge_egress_qinq_fg_create(
    struct mlx5_eswitch *esw,
    struct mlx5_flow_table *egress_ft) {
  ...
  return mlx5_esw_bridge_egress_vlan_proto_fg_create(from, to, ETH_P_8021AD,
      esw, egress_ft);
}

static struct mlx5_flow_group *mlx5_esw_bridge_egress_mac_fg_create(
    struct mlx5_eswitch *esw, struct mlx5_flow_table *egress_ft) {
  int inlen = MLX5_ST_SZ_BYTES(create_flow_group_in);
  struct mlx5_flow_group *fg;
  u32 *in, *match;
...
static struct mlx5_flow_group *mlx5_esw_bridge_egress_miss_fg_create(
    struct mlx5_eswitch *esw, struct mlx5_flow_table *egress_ft) {
  int inlen = MLX5_ST_SZ_BYTES(create_flow_group_in);
  struct mlx5_flow_group *fg;
  u32 *in, *match;
  ...
  match = MLX5_ADDR_OF(create_flow_group_in, in, match_criteria);
  MLX5_SET(fte_match_param, match, misc_parameters_2.metadata_reg_c_1,
      ESW_TUN_MASK);
  MLX5_SET(create_flow_group_in, in, start_flow_index,
...
static int mlx5_esw_bridge_ingress_table_init(
    struct mlx5_esw_bridge_offloads *br_offloads) {
  struct mlx5_flow_group *mac_fg, *qinq_filter_fg, *qinq_fg, *vlan_filter_fg,
      *vlan_fg;
  ...
  vlan_filter_fg
    = mlx5_esw_bridge_ingress_vlan_filter_fg_create(esw, ingress_ft);
  ...
  qinq_filter_fg
    = mlx5_esw_bridge_ingress_qinq_filter_fg_create(esw, ingress_ft);
...
static void mlx5_esw_bridge_ingress_table_cleanup(
    struct mlx5_esw_bridge_offloads *br_offloads) {
...
static struct mlx5_flow_handle *mlx5_esw_bridge_egress_miss_flow_create(
  struct mlx5_flow_table *egress_ft,
  struct mlx5_flow_table *skip_ft,
  struct mlx5_pkt_reformat *pkt_reformat);

static int mlx5_esw_bridge_egress_table_init(
    struct mlx5_esw_bridge_offloads *br_offloads,
...
static void mlx5_esw_bridge_egress_table_cleanup(struct mlx5_esw_bridge *bridge)
{
...
static struct mlx5_flow_handle *mlx5_esw_bridge_ingress_flow_with_esw_create(
    u16 vport_num, const unsigned char *addr,
  ...
  handle = mlx5_add_flow_rules(br_offloads->ingress_ft, rule_spec, &flow_act,
      dests,
      ARRAY_SIZE(dests));
  kvfree(rule_spec);
  return handle;
...
static struct mlx5_flow_handle *mlx5_esw_bridge_ingress_flow_create(
    u16 vport_num, const unsigned char *addr,
    struct mlx5_esw_bridge_vlan *vlan, u32 counter_id,
    struct mlx5_esw_bridge *bridge) {
  return mlx5_esw_bridge_ingress_flow_with_esw_create(vport_num, addr, vlan,
      counter_id,
      bridge, bridge->br_offloads->esw);
}

static struct mlx5_flow_handle *mlx5_esw_bridge_ingress_flow_peer_create(
  ...
  handle = mlx5_esw_bridge_ingress_flow_with_esw_create(vport_num, addr, vlan,
      counter_id,
      bridge, peer_esw);
out:
...
static struct mlx5_flow_handle *mlx5_esw_bridge_ingress_filter_flow_create(
    u16 vport_num, const unsigned char *addr,
    struct mlx5_esw_bridge *bridge) {
  struct mlx5_esw_bridge_offloads *br_offloads = bridge->br_offloads;
...
static struct mlx5_flow_handle *mlx5_esw_bridge_egress_flow_create(
    u16 vport_num, u16 esw_owner_vhca_id, const unsigned char *addr,
  ...
  handle
    = mlx5_add_flow_rules(bridge->egress_ft, rule_spec, &flow_act, &dest, 1);
  kvfree(rule_spec);
  return handle;
}
...
static struct mlx5_esw_bridge *mlx5_esw_bridge_create(
...
static struct mlx5_esw_bridge *mlx5_esw_bridge_lookup(
    struct net_device *br_netdev,
    struct mlx5_esw_bridge_offloads *br_offloads) {
  struct mlx5_esw_bridge *bridge;
  ASSERT_RTNL();
...
static unsigned long mlx5_esw_bridge_port_key_from_data(u16 vport_num,
    u16 esw_owner_vhca_id) {
  return vport_num | (unsigned long) esw_owner_vhca_id <<
    sizeof(vport_num) * BITS_PER_BYTE;
}

unsigned long mlx5_esw_bridge_port_key(struct mlx5_esw_bridge_port *port) {
  return mlx5_esw_bridge_port_key_from_data(port->vport_num,
      port->esw_owner_vhca_id);
}

static int mlx5_esw_bridge_port_insert(struct mlx5_esw_bridge_port *port,
    struct mlx5_esw_bridge_offloads *br_offloads) {
  return xa_insert(&br_offloads->ports, mlx5_esw_bridge_port_key(
      port), port, GFP_KERNEL);
}

static struct mlx5_esw_bridge_port *mlx5_esw_bridge_port_lookup(u16 vport_num,
    u16 esw_owner_vhca_id,
    struct mlx5_esw_bridge_offloads *br_offloads) {
  return xa_load(&br_offloads->ports,
      mlx5_esw_bridge_port_key_from_data(vport_num,
      esw_owner_vhca_id));
}
...
static struct mlx5_esw_bridge *mlx5_esw_bridge_from_port_lookup(u16 vport_num,
    u16 esw_owner_vhca_id,
    struct mlx5_esw_bridge_offloads *br_offloads) {
...
static void mlx5_esw_bridge_fdb_entry_refresh(
    struct mlx5_esw_bridge_fdb_entry *entry) {
...
static void mlx5_esw_bridge_fdb_entry_cleanup(
    struct mlx5_esw_bridge_fdb_entry *entry,
    struct mlx5_esw_bridge *bridge) {
...
static void mlx5_esw_bridge_fdb_entry_notify_and_cleanup(
    struct mlx5_esw_bridge_fdb_entry *entry,
    struct mlx5_esw_bridge *bridge) {
...
static struct mlx5_esw_bridge_vlan *mlx5_esw_bridge_vlan_lookup(u16 vid,
    struct mlx5_esw_bridge_port *port) {
  return xa_load(&port->vlans, vid);
}

static int mlx5_esw_bridge_vlan_push_create(u16 vlan_proto,
    struct mlx5_esw_bridge_vlan *vlan,
    struct mlx5_eswitch *esw) {
  struct {
    __be16 h_vlan_proto;
    ...
    htons(vlan_proto), htons(vlan->vid)
  };
  struct mlx5_pkt_reformat_params reformat_params = {};
  struct mlx5_pkt_reformat *pkt_reformat;
...
static void mlx5_esw_bridge_vlan_push_cleanup(struct mlx5_esw_bridge_vlan *vlan,
    struct mlx5_eswitch *esw) {
  mlx5_packet_reformat_dealloc(esw->dev, vlan->pkt_reformat_push);
  vlan->pkt_reformat_push = NULL;
}

static int mlx5_esw_bridge_vlan_pop_create(struct mlx5_esw_bridge_vlan *vlan,
    struct mlx5_eswitch *esw) {
  struct mlx5_pkt_reformat *pkt_reformat;
  if (!mlx5_esw_bridge_pkt_reformat_vlan_pop_supported(esw)) {
...
static void mlx5_esw_bridge_vlan_pop_cleanup(struct mlx5_esw_bridge_vlan *vlan,
    struct mlx5_eswitch *esw) {
...
static int mlx5_esw_bridge_vlan_push_mark_create(
  ...
  pkt_mod_hdr = mlx5_modify_header_alloc(esw->dev, MLX5_FLOW_NAMESPACE_FDB, 1,
      action);
...
static void mlx5_esw_bridge_vlan_push_mark_cleanup(
    struct mlx5_esw_bridge_vlan *vlan, struct mlx5_eswitch *esw) {
  mlx5_modify_header_dealloc(esw->dev, vlan->pkt_mod_hdr_push_mark);
  vlan->pkt_mod_hdr_push_mark = NULL;
}

static int mlx5_esw_bridge_vlan_push_pop_fhs_create(u16 vlan_proto,
    struct mlx5_esw_bridge_port *port,
    struct mlx5_esw_bridge_vlan *vlan) {
  return mlx5_esw_bridge_vlan_mcast_init(vlan_proto, port, vlan);
}

static void mlx5_esw_bridge_vlan_push_pop_fhs_cleanup(
    struct mlx5_esw_bridge_vlan *vlan) {
  mlx5_esw_bridge_vlan_mcast_cleanup(vlan);
}

static int mlx5_esw_bridge_vlan_push_pop_create(u16 vlan_proto, u16 flags,
    struct mlx5_esw_bridge_port *port,
    struct mlx5_esw_bridge_vlan *vlan, struct mlx5_eswitch *esw) {
  int err;
...
static struct mlx5_esw_bridge_vlan *mlx5_esw_bridge_vlan_create(u16 vlan_proto,
    u16 vid,
    u16 flags,
    struct mlx5_esw_bridge_port *port,
    struct mlx5_eswitch *esw) {
  ...
  err
    = mlx5_esw_bridge_vlan_push_pop_create(vlan_proto, flags, port, vlan, esw);
  if (err) {
...
static int mlx5_esw_bridge_port_vlans_recreate(
    struct mlx5_esw_bridge_port *port,
    struct mlx5_esw_bridge *bridge) {
  struct mlx5_esw_bridge_offloads *br_offloads = bridge->br_offloads;
  struct mlx5_esw_bridge_vlan *vlan;
  ...
  xa_for_each(&port->vlans, i, vlan) {
    mlx5_esw_bridge_vlan_flush(port, vlan, bridge);
    err = mlx5_esw_bridge_vlan_push_pop_create(bridge->vlan_proto, vlan->flags,
        port,
...
static int mlx5_esw_bridge_vlans_recreate(struct mlx5_esw_bridge *bridge) {
  struct mlx5_esw_bridge_offloads *br_offloads = bridge->br_offloads;
  struct mlx5_esw_bridge_port *port;
  unsigned long i;
  int err;
...
static struct mlx5_esw_bridge_vlan *mlx5_esw_bridge_port_vlan_lookup(u16 vid,
    u16 vport_num, u16 esw_owner_vhca_id,
...
static struct mlx5_esw_bridge_fdb_entry *mlx5_esw_bridge_fdb_lookup(
    struct mlx5_esw_bridge *bridge,
...
static struct mlx5_esw_bridge_fdb_entry *mlx5_esw_bridge_fdb_entry_init(
  ...
  if (bridge->flags & MLX5_ESW_BRIDGE_VLAN_FILTERING_FLAG && vid) {
    vlan = mlx5_esw_bridge_port_vlan_lookup(vid, vport_num, esw_owner_vhca_id,
        bridge,
        esw);
    if (IS_ERR(vlan)) {
  ...
  if (IS_ERR(handle)) {
    err = PTR_ERR(handle);
    esw_warn(esw->dev,
        "Failed to create ingress flow(vport=%u,err=%d,peer=%d)\n",
        vport_num, err, peer);
  ...
  if (bridge->flags & MLX5_ESW_BRIDGE_VLAN_FILTERING_FLAG) {
    handle
      = mlx5_esw_bridge_ingress_filter_flow_create(vport_num, addr, bridge);
    if (IS_ERR(handle)) {
      err = PTR_ERR(handle);
  ...
  handle = mlx5_esw_bridge_egress_flow_create(vport_num, esw_owner_vhca_id,
      addr, vlan,
      bridge);
  if (IS_ERR(handle)) {
    err = PTR_ERR(handle);
...
int mlx5_esw_bridge_vlan_proto_set(u16 vport_num, u16 esw_owner_vhca_id,
  ...
  if (proto != ETH_P_8021Q && proto != ETH_P_8021AD) {
    esw_warn(br_offloads->esw->dev, "Can't set unsupported VLAN protocol %x",
        proto);
    return -EOPNOTSUPP;
  }
  mlx5_esw_bridge_fdb_flush(bridge);
...
static int mlx5_esw_bridge_vport_cleanup(
    struct mlx5_esw_bridge_offloads *br_offloads,
    struct mlx5_esw_bridge_port *port) {
...
static int mlx5_esw_bridge_vport_link_with_flags(struct net_device *br_netdev,
    u16 vport_num,
  ...
  err = mlx5_esw_bridge_vport_init(vport_num, esw_owner_vhca_id, flags,
      br_offloads, bridge);
  if (err) {
...
int mlx5_esw_bridge_vport_link(struct net_device *br_netdev, u16 vport_num,
    ...
    struct mlx5_esw_bridge_offloads *br_offloads,
    struct netlink_ext_ack *extack) {
  return mlx5_esw_bridge_vport_link_with_flags(br_netdev, vport_num,
      esw_owner_vhca_id, 0,
      br_offloads, extack);
}
...
int mlx5_esw_bridge_vport_peer_unlink(struct net_device *br_netdev,
    ...
    struct mlx5_esw_bridge_offloads *br_offloads,
    struct netlink_ext_ack *extack) {
  return mlx5_esw_bridge_vport_unlink(br_netdev, vport_num, esw_owner_vhca_id,
      br_offloads,
      extack);
}
...
void mlx5_esw_bridge_fdb_create(struct net_device *dev, u16 vport_num,
  ...
  bridge = port->bridge;
  entry = mlx5_esw_bridge_fdb_entry_init(dev, vport_num, esw_owner_vhca_id,
      fdb_info->addr,
...
int mlx5_esw_bridge_port_mdb_add(struct net_device *dev, u16 vport_num,
  ...
  if (err) {
    NL_SET_ERR_MSG_FMT_MOD(extack,
        "Failed to add MDB (MAC=%pM,vid=%u,vport=%u)\n",
        addr, vid, vport_num);
    return err;
  }
  return 0;
