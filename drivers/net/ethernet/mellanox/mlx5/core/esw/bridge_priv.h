...
#define MLX5_ESW_BRIDGE_MCAST_TABLE_QINQ_GRP_SIZE \
  MLX5_ESW_BRIDGE_MCAST_TABLE_VLAN_GRP_SIZE
...
int mlx5_esw_bridge_port_mdb_attach(struct net_device *dev,
    struct mlx5_esw_bridge_port *port,
    const unsigned char *addr, u16 vid);
void mlx5_esw_bridge_port_mdb_detach(struct net_device *dev,
    struct mlx5_esw_bridge_port *port,
    const unsigned char *addr, u16 vid);
...
void mlx5_esw_bridge_debugfs_offloads_init(
  struct mlx5_esw_bridge_offloads *br_offloads);
void mlx5_esw_bridge_debugfs_offloads_cleanup(
  struct mlx5_esw_bridge_offloads *br_offloads);
void mlx5_esw_bridge_debugfs_init(struct net_device *br_netdev,
    struct mlx5_esw_bridge *bridge);
