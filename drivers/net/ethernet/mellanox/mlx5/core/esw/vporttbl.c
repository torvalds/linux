...
static void esw_vport_tbl_init(struct mlx5_eswitch *esw,
    struct esw_vport_tbl_namespace *ns) {
...
static struct mlx5_flow_table *esw_vport_tbl_create(struct mlx5_eswitch *esw,
...
static struct mlx5_vport_table *esw_vport_tbl_lookup(struct mlx5_eswitch *esw,
