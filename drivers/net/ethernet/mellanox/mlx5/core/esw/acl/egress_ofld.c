...
static bool esw_acl_egress_needed(struct mlx5_eswitch *esw, u16 vport_num) {
  return mlx5_eswitch_is_vf_vport(esw, vport_num) || mlx5_esw_is_sf_vport(esw,
      vport_num);
}
...
int mlx5_esw_acl_egress_vport_bond(struct mlx5_eswitch *esw,
  ...
  struct mlx5_vport *passive_vport = mlx5_eswitch_get_vport(esw,
      passive_vport_num);
  struct mlx5_vport *active_vport
    = mlx5_eswitch_get_vport(esw, active_vport_num);
  struct mlx5_flow_destination fwd_dest = {};
