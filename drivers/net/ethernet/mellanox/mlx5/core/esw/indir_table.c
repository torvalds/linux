...
struct mlx5_esw_indir_table *mlx5_esw_indir_table_init(void) {
...
void mlx5_esw_indir_table_destroy(struct mlx5_esw_indir_table *indir) {
  mutex_destroy(&indir->lock);
  kvfree(indir);
}

bool mlx5_esw_indir_table_needed(struct mlx5_eswitch *esw,
...
u16 mlx5_esw_indir_table_decap_vport(struct mlx5_flow_attr *attr) {
  struct mlx5_esw_flow_attr *esw_attr = attr->esw_attr;
...
static int mlx5_esw_indir_table_rule_get(struct mlx5_eswitch *esw,
  ...
  data = mlx5_eswitch_get_vport_metadata_for_set(esw,
      esw_attr->rx_tun_attr->decap_vport);
  ...
  flow_act.modify_hdr = mlx5_modify_header_alloc(esw->dev,
...
static int mlx5_create_indir_recirc_group(struct mlx5_esw_indir_table_entry *e)
{
  ...
  MLX5_SET(create_flow_group_in, in, end_flow_index,
      MLX5_ESW_INDIR_TABLE_RECIRC_IDX);
...
static struct mlx5_esw_indir_table_entry *mlx5_esw_indir_table_entry_create(
    struct mlx5_eswitch *esw, struct mlx5_flow_attr *attr,
...
static struct mlx5_esw_indir_table_entry *mlx5_esw_indir_table_entry_lookup(
    struct mlx5_eswitch *esw, u16 vport) {
  struct mlx5_esw_indir_table_entry *e;
  u32 key = vport << 16;
