...
static void mlx5_crypto_destroy_dek_key(struct mlx5_core_dev *mdev,
    u32 key_id) {
...
static struct mlx5_crypto_dek_bulk *mlx5_crypto_dek_bulk_create(
...
static struct mlx5_crypto_dek_bulk *mlx5_crypto_dek_pool_add_bulk(
    struct mlx5_crypto_dek_pool *pool) {
  struct mlx5_crypto_dek_bulk *bulk;
...
static struct mlx5_crypto_dek_bulk *mlx5_crypto_dek_pool_pop(
    struct mlx5_crypto_dek_pool *pool, u32 *obj_offset) {
  struct mlx5_crypto_dek_bulk *bulk;
  int pos;
...
static void mlx5_crypto_dek_pool_splice_destroy_list(
    struct mlx5_crypto_dek_pool *pool,
...
static void mlx5_crypto_dek_pool_free_wait_keys(
    struct mlx5_crypto_dek_pool *pool) {
...
struct mlx5_crypto_dek *mlx5_crypto_dek_create(
...
struct mlx5_crypto_dek_pool *mlx5_crypto_dek_pool_create(
    struct mlx5_core_dev *mdev, int key_purpose) {
  struct mlx5_crypto_dek_pool *pool;
...
struct mlx5_crypto_dek_priv *mlx5_crypto_dek_init(struct mlx5_core_dev *mdev) {
  ...
  mlx5_core_dbg(mdev,
      "Crypto DEK enabled, %d deks per alloc (max %d), total %d\n",
