...
#define MLX5_MACSEC_METADATA_MARKER(metadata)  ((((metadata) >> 30) & 0x3)  \
  == 0x1)
#define MLX5_MACSEC_RX_METADAT_HANDLE(metadata)  ((metadata) \
  & MLX5_MACSEC_RX_FS_ID_MASK)
...
struct mlx5_macsec_fs *mlx5_macsec_fs_init(struct mlx5_core_dev *mdev);

union mlx5_macsec_rule *mlx5_macsec_fs_add_rule(
...
void mlx5_macsec_fs_get_stats_fill(struct mlx5_macsec_fs *macsec_fs,
    void *macsec_stats);
struct mlx5_macsec_stats *mlx5_macsec_fs_get_stats(
  struct mlx5_macsec_fs *macsec_fs);
u32 mlx5_macsec_fs_get_fs_id_from_hashtable(struct mlx5_macsec_fs *macsec_fs,
    sci_t *sci);
