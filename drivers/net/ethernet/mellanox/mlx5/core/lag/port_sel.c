...
static struct mlx5_flow_group *mlx5_create_hash_flow_group(
...
static struct mlx5_lag_definer *mlx5_lag_create_definer(struct mlx5_lag *ldev,
    enum netdev_lag_hash hash,
...
static int mlx5_lag_modify_definers_destinations(struct mlx5_lag *ldev,
