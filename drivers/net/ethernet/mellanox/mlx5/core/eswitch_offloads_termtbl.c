...
static u32 mlx5_eswitch_termtbl_hash(struct mlx5_flow_act *flow_act,
    struct mlx5_flow_destination *dest) {
  u32 hash;
...
static int mlx5_eswitch_termtbl_cmp(struct mlx5_flow_act *flow_act1,
...
static int mlx5_eswitch_termtbl_create(struct mlx5_core_dev *dev,
...
static struct mlx5_termtbl_handle *mlx5_eswitch_termtbl_get_create(
...
static void mlx5_eswitch_termtbl_actions_move(struct mlx5_flow_act *src,
...
bool mlx5_eswitch_termtbl_required(struct mlx5_eswitch *esw,
  ...
  if (!MLX5_CAP_ESW_FLOWTABLE_FDB(esw->dev, termination_table)
      ...
      || (!mlx5_eswitch_offload_is_uplink_port(esw,
          spec) && !esw_attr->int_port)) {
    return false;
  }
  /* push vlan on RX */
