...
enum dr_ste_v1_action_insert_ptr_attr {
  DR_STE_V1_ACTION_INSERT_PTR_ATTR_NONE = 0,  /* Regular push header (e.g. push
                                               * vlan) */
...
static void dr_ste_v1_set_encap(u8 *hw_ste_p, u8 *d_action,
  ...
  MLX5_SET(ste_double_action_insert_with_ptr_v1, d_action, pointer,
      reformat_id);
...
static void dr_ste_v1_set_insert_hdr(u8 *hw_ste_p, u8 *d_action,
  ...
  MLX5_SET(ste_double_action_insert_with_ptr_v1, d_action, start_anchor,
      anchor);
  /* The hardware expects here size and offset in words (2 byte) */
  MLX5_SET(ste_double_action_insert_with_ptr_v1, d_action, size, size / 2);
  MLX5_SET(ste_double_action_insert_with_ptr_v1, d_action, start_offset,
      offset / 2);
  MLX5_SET(ste_double_action_insert_with_ptr_v1, d_action, pointer,
      reformat_id);
  MLX5_SET(ste_double_action_insert_with_ptr_v1, d_action, attributes,
...
static void dr_ste_v1_set_remove_hdr(u8 *hw_ste_p, u8 *s_action,
  ...
  MLX5_SET(ste_single_action_remove_header_size_v1, s_action, start_anchor,
      anchor);
  /* The hardware expects here size and offset in words (2 byte) */
  MLX5_SET(ste_single_action_remove_header_size_v1, s_action, remove_size,
      size / 2);
  MLX5_SET(ste_single_action_remove_header_size_v1, s_action, start_offset,
      offset / 2);
  dr_ste_v1_set_reparse(hw_ste_p);
}
...
static void dr_ste_v1_set_encap_l3(u8 *hw_ste_p,
  ...
  MLX5_SET(ste_double_action_insert_with_ptr_v1, scnd_d_action, pointer,
      reformat_id);
...
void dr_ste_v1_set_action_set(u8 *d_action,
  ...
  MLX5_SET(ste_double_action_set_v1, d_action, action_id,
      DR_STE_V1_ACTION_ID_SET);
  MLX5_SET(ste_double_action_set_v1, d_action, destination_dw_offset, hw_field);
  MLX5_SET(ste_double_action_set_v1, d_action, destination_left_shifter,
      shifter);
...
void dr_ste_v1_set_action_add(u8 *d_action,
    ...
    u32 data) {
  shifter += MLX5_MODIFY_HEADER_V1_QW_OFFSET;
  MLX5_SET(ste_double_action_add_v1, d_action, action_id,
      DR_STE_V1_ACTION_ID_ADD);
  MLX5_SET(ste_double_action_add_v1, d_action, destination_dw_offset, hw_field);
  MLX5_SET(ste_double_action_add_v1, d_action, destination_left_shifter,
      shifter);
...
void dr_ste_v1_set_action_copy(u8 *d_action,
  ...
  MLX5_SET(ste_double_action_copy_v1, d_action, action_id,
      DR_STE_V1_ACTION_ID_COPY);
  MLX5_SET(ste_double_action_copy_v1, d_action, destination_dw_offset,
      dst_hw_field);
  MLX5_SET(ste_double_action_copy_v1, d_action, destination_left_shifter,
      dst_shifter);
  ...
  MLX5_SET(ste_double_action_copy_v1, d_action, source_right_shifter,
      src_shifter);
}
...
static void dr_ste_v1_build_eth_l2_src_dst_bit_mask(
...
static int dr_ste_v1_build_eth_l3_ipv4_5_tuple_tag(
    ...
    u8 *tag) {
  struct mlx5dr_match_spec *spec = sb->inner ? &value->inner : &value->outer;
  DR_STE_SET_TAG(eth_l3_ipv4_5_tuple_v1, tag, destination_address, spec,
      dst_ip_31_0);
  DR_STE_SET_TAG(eth_l3_ipv4_5_tuple_v1, tag, source_address, spec,
      src_ip_31_0);
  DR_STE_SET_TAG(eth_l3_ipv4_5_tuple_v1, tag, destination_port, spec,
      tcp_dport);
  DR_STE_SET_TAG(eth_l3_ipv4_5_tuple_v1, tag, destination_port, spec,
      udp_dport);
...
static void dr_ste_v1_build_eth_l2_src_or_dst_bit_mask(
    struct mlx5dr_match_param *value,
    bool inner, u8 *bit_mask) {
  struct mlx5dr_match_spec *mask = inner ? &value->inner : &value->outer;
...
static int dr_ste_v1_build_eth_l2_src_or_dst_tag(
    struct mlx5dr_match_param *value,
    bool inner, u8 *tag) {
  ...
  if (inner) {
    ...
    DR_STE_SET_TAG(eth_l2_src_v1, tag, second_vlan_id, misc_spec,
        inner_second_vid);
    DR_STE_SET_TAG(eth_l2_src_v1, tag, second_cfi, misc_spec, inner_second_cfi);
    DR_STE_SET_TAG(eth_l2_src_v1, tag, second_priority, misc_spec,
        inner_second_prio);
  } else {
...
static void dr_ste_v1_build_eth_l2_src_bit_mask(
    struct mlx5dr_match_param *value,
    bool inner, u8 *bit_mask) {
  struct mlx5dr_match_spec *mask = inner ? &value->inner : &value->outer;
...
static void dr_ste_v1_build_eth_l2_dst_bit_mask(
    struct mlx5dr_match_param *value,
    bool inner, u8 *bit_mask) {
  struct mlx5dr_match_spec *mask = inner ? &value->inner : &value->outer;
...
static void dr_ste_v1_build_eth_l2_tnl_bit_mask(
    struct mlx5dr_match_param *value,
    bool inner, u8 *bit_mask) {
  struct mlx5dr_match_spec *mask = inner ? &value->inner : &value->outer;
...
static int dr_ste_v1_build_eth_l3_ipv4_misc_tag(
    struct mlx5dr_match_param *value,
    struct mlx5dr_ste_build *sb,
    u8 *tag) {
  struct mlx5dr_match_spec *spec = sb->inner ? &value->inner : &value->outer;
...
static int dr_ste_v1_build_tnl_mpls_over_udp_tag(
    struct mlx5dr_match_param *value,
    struct mlx5dr_ste_build *sb,
    u8 *tag) {
  struct mlx5dr_match_misc2 *misc2 = &value->misc2;
...
static int dr_ste_v1_build_tnl_mpls_over_gre_tag(
    struct mlx5dr_match_param *value,
    struct mlx5dr_ste_build *sb,
    u8 *tag) {
  struct mlx5dr_match_misc2 *misc2 = &value->misc2;
...
static int dr_ste_v1_build_flex_parser_tnl_vxlan_gpe_tag(
    struct mlx5dr_match_param *value,
    struct mlx5dr_ste_build *sb,
    u8 *tag) {
  struct mlx5dr_match_misc3 *misc3 = &value->misc3;
...
static int dr_ste_v1_build_flex_parser_tnl_geneve_tag(
    struct mlx5dr_match_param *value,
    struct mlx5dr_ste_build *sb,
    u8 *tag) {
  struct mlx5dr_match_misc *misc = &value->misc;
...
static void dr_ste_v1_build_src_gvmi_qpn_bit_mask(
    struct mlx5dr_match_param *value,
    u8 *bit_mask) {
  struct mlx5dr_match_misc *misc_mask = &value->misc;
  DR_STE_SET_ONES(src_gvmi_qp_v1, bit_mask, source_gvmi, misc_mask,
      source_port);
...
static int dr_ste_v1_build_flex_parser_tnl_geneve_tlv_opt_tag(
    struct mlx5dr_match_param *value,
    struct mlx5dr_ste_build *sb,
    u8 *tag) {
  struct mlx5dr_match_misc3 *misc3 = &value->misc3;
...
void dr_ste_v1_build_flex_parser_tnl_geneve_tlv_opt_exist_init(
  ...
  dr_ste_v1_build_flex_parser_tnl_geneve_tlv_opt_exist_tag(mask, sb,
      sb->bit_mask);
  sb->byte_mask = mlx5dr_ste_conv_bit_to_byte_mask(sb->bit_mask);
  sb->ste_build_tag_func
    = &dr_ste_v1_build_flex_parser_tnl_geneve_tlv_opt_exist_tag;
}

static int dr_ste_v1_build_flex_parser_tnl_gtpu_tag(
    struct mlx5dr_match_param *value,
    struct mlx5dr_ste_build *sb,
    u8 *tag) {
  struct mlx5dr_match_misc3 *misc3 = &value->misc3;
  DR_STE_SET_TAG(flex_parser_tnl_gtpu, tag, gtpu_msg_flags, misc3,
      gtpu_msg_flags);
  DR_STE_SET_TAG(flex_parser_tnl_gtpu, tag, gtpu_msg_type, misc3,
      gtpu_msg_type);
...
static int dr_ste_v1_build_tnl_gtpu_flex_parser_0_tag(
    struct mlx5dr_match_param *value,
    struct mlx5dr_ste_build *sb,
    u8 *tag) {
...
static int dr_ste_v1_build_tnl_gtpu_flex_parser_1_tag(
    struct mlx5dr_match_param *value,
    struct mlx5dr_ste_build *sb,
    u8 *tag) {
