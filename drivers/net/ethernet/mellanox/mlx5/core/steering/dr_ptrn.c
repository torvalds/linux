...
static struct mlx5dr_ptrn_obj *dr_ptrn_find_cached_pattern(
...
static struct mlx5dr_ptrn_obj *dr_ptrn_alloc_pattern(
    struct mlx5dr_ptrn_mgr *mgr,
...
static void dr_ptrn_free_pattern(struct mlx5dr_ptrn_obj *pattern) {
