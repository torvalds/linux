...
static struct mlx5dr_dbg_dump_buff *mlx5dr_dbg_dump_data_init_new_buff(
...
static struct mlx5dr_dbg_dump_data *mlx5dr_dbg_create_dump_data(void) {
  struct mlx5dr_dbg_dump_data *dump_data;
...
static void mlx5dr_dbg_destroy_dump_data(struct mlx5dr_dbg_dump_data *dump_data)
{
...
static int mlx5dr_dbg_dump_data_print(struct seq_file *file, char *str,
    u32 size) {
...
static void dr_dump_hex_print(char hex[DR_HEX_SIZE], char *src, u32 size) {
...
static int dr_dump_rule_action_mem(struct seq_file *file, const u64 rule_id,
...
static int dr_dump_rule_mem(struct seq_file *file, struct mlx5dr_ste *ste,
...
static int dr_dump_rule_rx_tx(struct seq_file *file,
...
static int dr_dump_matcher_mask(struct seq_file *file,
...
static int dr_dump_matcher_builder(struct seq_file *file,
...
static int dr_dump_matcher_rx_tx(struct seq_file *file, bool is_rx,
  ...
  e_icm_addr
    = mlx5dr_icm_pool_get_chunk_icm_addr(matcher_rx_tx->e_anchor->chunk);
  ret = snprintf(buff, MLX5DR_DEBUG_DUMP_BUFF_LENGTH,
...
static int dr_dump_matcher(struct seq_file *file,
...
static int dr_dump_matcher_all(struct seq_file *file,
    struct mlx5dr_matcher *matcher) {
...
static int dr_dump_table_rx_tx(struct seq_file *file, bool is_rx,
...
static int dr_dump_send_ring(struct seq_file *file,
...
static noinline_for_stack int dr_dump_domain_info_flex_parser(
...
static noinline_for_stack int dr_dump_domain_info_caps(struct seq_file *file,
...
static int dr_dump_domain_info(struct seq_file *file,
...
static noinline_for_stack int dr_dump_domain(struct seq_file *file,
...
static int dr_dump_domain_all(struct seq_file *file,
    struct mlx5dr_domain *dmn) {
...
static void *dr_dump_start(struct seq_file *file, loff_t *pos) {
  struct mlx5dr_domain *dmn = file->private;
  struct mlx5dr_dbg_dump_data *dump_data;
...
static void *dr_dump_next(struct seq_file *file, void *v, loff_t *pos) {
  struct mlx5dr_domain *dmn = file->private;
  struct mlx5dr_dbg_dump_data *dump_data;
  dump_data = dmn->dump_info.dump_data;
...
static void dr_dump_stop(struct seq_file *file, void *v) {
  struct mlx5dr_domain *dmn = file->private;
  struct mlx5dr_dbg_dump_data *dump_data;
  if (v && IS_ERR(v)) {
    return;
...
static int dr_dump_show(struct seq_file *file, void *v) {
