...
static void fill_static_params(struct mlx5_wqe_tls_static_params_seg *params,
...
void mlx5e_ktls_build_static_params(struct mlx5e_set_tls_static_params_wqe *wqe,
    u16 pc, u32 sqn,
    union mlx5e_crypto_info *crypto_info,
...
#define STATIC_PARAMS_DS_CNT DIV_ROUND_UP(sizeof(*wqe), MLX5_SEND_WQE_DS)
  cseg->opmod_idx_opcode
    = cpu_to_be32((pc << 8) | MLX5_OPCODE_UMR | (opmod << 24));
...
static void fill_progress_params(
    struct mlx5_wqe_tls_progress_params_seg *params, u32 tis_tir_num,
...
void mlx5e_ktls_build_progress_params(
