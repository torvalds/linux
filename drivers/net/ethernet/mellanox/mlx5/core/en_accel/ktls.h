...
struct mlx5e_ktls_resync_resp *mlx5e_ktls_rx_resync_create_resp_list(void);
void mlx5e_ktls_rx_resync_destroy_resp_list(
...
static inline int mlx5e_ktls_set_feature_rx(struct net_device *netdev,
    bool enable) {
...
static inline void mlx5e_ktls_rx_resync_destroy_resp_list(
    struct mlx5e_ktls_resync_resp *resp_list) {
}
...
static inline int mlx5e_ktls_init(struct mlx5e_priv *priv) {
  return 0;
}
...
static inline int mlx5e_ktls_get_count(struct mlx5e_priv *priv) {
  return 0;
}

static inline int mlx5e_ktls_get_strings(struct mlx5e_priv *priv,
    uint8_t *data) {
  return 0;
}
