...
struct mlx5_flow_handle *mlx5e_tc_rule_offload(struct mlx5e_priv *priv,
    struct mlx5_flow_spec *spec,
    struct mlx5_flow_attr *attr);

void mlx5e_tc_rule_unoffload(struct mlx5e_priv *priv,
    struct mlx5_flow_handle *rule,
    struct mlx5_flow_attr *attr);

u8 mlx5e_tc_get_ip_version(struct mlx5_flow_spec *spec, bool outer);

struct mlx5_flow_handle *mlx5e_tc_offload_fdb_rules(struct mlx5_eswitch *esw,
    struct mlx5e_tc_flow *flow,
    struct mlx5_flow_spec *spec,
    struct mlx5_flow_attr *attr);

struct mlx5_flow_attr *mlx5e_tc_get_encap_attr(struct mlx5e_tc_flow *flow);
...
static inline void __flow_flag_set(struct mlx5e_tc_flow *flow,
    unsigned long flag) {
...
#define flow_flag_set(flow, flag) __flow_flag_set(flow, \
...
static inline void __flow_flag_clear(struct mlx5e_tc_flow *flow,
    unsigned long flag) {
...
static inline bool __flow_flag_test(struct mlx5e_tc_flow *flow,
    unsigned long flag) {
...
void mlx5e_tc_unoffload_from_slow_path(struct mlx5_eswitch *esw,
    struct mlx5e_tc_flow *flow);
struct mlx5_flow_handle *mlx5e_tc_offload_to_slow_path(struct mlx5_eswitch *esw,
    struct mlx5e_tc_flow *flow,
    struct mlx5_flow_spec *spec);
...
struct mlx5e_tc_int_port_priv *mlx5e_get_int_port_priv(struct mlx5e_priv *priv);
