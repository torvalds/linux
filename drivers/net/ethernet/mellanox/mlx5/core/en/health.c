...
int mlx5e_reporter_cq_diagyesse(struct mlx5e_cq *cq, struct devlink_fmsg *fmsg)
{
...
int mlx5e_reporter_cq_common_diagyesse(struct mlx5e_cq *cq, struct devlink_fmsg *fmsg)
{
	u8 cq_log_stride;
	u32 cq_sz;
	int err;
