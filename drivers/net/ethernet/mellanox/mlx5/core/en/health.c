...
void mlx5e_health_fmsg_named_obj_nest_start(struct devlink_fmsg *fmsg,
    char *name) {
...
void mlx5e_health_cq_common_diag_fmsg(struct mlx5e_cq *cq,
...
void mlx5e_health_eq_diag_fmsg(struct mlx5_eq_comp *eq,
    struct devlink_fmsg *fmsg) {
...
int mlx5e_health_sq_to_ready(struct mlx5_core_dev *mdev, struct net_device *dev,
    u32 sqn) {
...
int mlx5e_health_channel_eq_recover(struct net_device *dev,
...
int mlx5e_health_rsc_fmsg_dump(struct mlx5e_priv *priv,
