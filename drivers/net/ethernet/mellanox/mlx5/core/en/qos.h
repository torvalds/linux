...
void mlx5e_reactivate_qos_sq(struct mlx5e_priv *priv, u16 qid,
...
/* HTB API */
int mlx5e_htb_setup_tc(struct mlx5e_priv *priv,
    struct tc_htb_qopt_offload *htb);
...
int mlx5e_mqprio_rl_get_node_hw_id(struct mlx5e_mqprio_rl *rl, int tc,
    u32 *hw_id);
#endif
