...
static bool tc_act_can_offload_police(
...
static int fill_meter_params_from_act(const struct flow_action_entry *act,
...
static int tc_act_parse_police(struct mlx5e_tc_act_parse_state *parse_state,
    const struct flow_action_entry *act,
    struct mlx5e_priv *priv,
    struct mlx5_flow_attr *attr) {
  enum mlx5_flow_namespace_type ns
    = mlx5e_get_flow_namespace(parse_state->flow);
...
static bool tc_act_is_multi_table_act_police(struct mlx5e_priv *priv,
    const struct flow_action_entry *act,
    struct mlx5_flow_attr *attr) {
  return true;
}

static int tc_act_police_offload(struct mlx5e_priv *priv,
...
static int tc_act_police_destroy(struct mlx5e_priv *priv,
    struct flow_offload_action *fl_act) {
  struct mlx5e_flow_meter_params params = {};
  struct mlx5e_flow_meter_handle *meter;
...
static int tc_act_police_stats(struct mlx5e_priv *priv,
    struct flow_offload_action *fl_act) {
  struct mlx5e_flow_meter_params params = {};
  struct mlx5e_flow_meter_handle *meter;
...
static bool tc_act_police_get_branch_ctrl(const struct flow_action_entry *act,
