...
static struct mlx5_flow_table *mlx5e_post_meter_table_create(
...
static int mlx5e_post_meter_rate_fg_create(struct mlx5e_priv *priv,
    struct mlx5e_post_meter_priv *post_meter) {
...
static struct mlx5_flow_handle *mlx5e_post_meter_add_rule(
    struct mlx5e_priv *priv,
    struct mlx5e_post_meter_priv *post_meter,
...
static int mlx5e_post_meter_rate_rules_create(struct mlx5e_priv *priv,
    struct mlx5e_post_meter_priv *post_meter,
...
static void mlx5e_post_meter_rate_rules_destroy(struct mlx5_eswitch *esw,
    struct mlx5e_post_meter_priv *post_meter) {
  struct mlx5e_post_meter_rate_table *rate_table
    = &post_meter->rate_steering_table;
  mlx5_eswitch_del_offloaded_rule(esw, rate_table->red_rule,
      rate_table->red_attr);
  mlx5_eswitch_del_offloaded_rule(esw, rate_table->green_rule,
      rate_table->green_attr);
}

static void mlx5e_post_meter_rate_fg_destroy(
    struct mlx5e_post_meter_priv *post_meter) {
  mlx5_destroy_flow_group(post_meter->rate_steering_table.fg);
}

static void mlx5e_post_meter_rate_table_destroy(
    struct mlx5e_post_meter_priv *post_meter) {
  mlx5_destroy_flow_table(post_meter->rate_steering_table.ft);
}

static void mlx5e_post_meter_mtu_rules_destroy(
    struct mlx5e_post_meter_priv *post_meter) {
...
static void mlx5e_post_meter_mtu_fg_destroy(
    struct mlx5e_post_meter_priv *post_meter) {
  struct mlx5e_post_meter_mtu_tables *mtu_tables = &post_meter->mtu_tables;
...
static void mlx5e_post_meter_mtu_table_destroy(
    struct mlx5e_post_meter_priv *post_meter) {
  struct mlx5e_post_meter_mtu_tables *mtu_tables = &post_meter->mtu_tables;
...
static int mlx5e_post_meter_rate_create(struct mlx5e_priv *priv,
    enum mlx5_flow_namespace_type ns_type,
    struct mlx5e_post_act *post_act,
    struct mlx5_fc *act_counter,
    struct mlx5_fc *drop_counter,
...
static int mlx5e_post_meter_create_mtu_table(struct mlx5e_priv *priv,
    enum mlx5_flow_namespace_type ns_type,
...
static int mlx5e_post_meter_mtu_create(struct mlx5e_priv *priv,
    enum mlx5_flow_namespace_type ns_type,
    struct mlx5e_post_act *post_act,
    struct mlx5_fc *act_counter,
    struct mlx5_fc *drop_counter,
  ...
  err = mlx5e_post_meter_create_mtu_table(priv, ns_type,
      &mtu_tables->green_table);
  if (err) {
    goto err_green_ft;
  }
  ...
  err
    = mlx5e_post_meter_create_mtu_table(priv, ns_type, &mtu_tables->red_table);
  if (err) {
    goto err_red_ft;
  }
...
static void mlx5e_post_meter_rate_destroy(struct mlx5_eswitch *esw,
    struct mlx5e_post_meter_priv *post_meter) {
...
static void mlx5e_post_meter_mtu_destroy(
    struct mlx5e_post_meter_priv *post_meter) {
