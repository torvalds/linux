...
static bool tc_act_can_offload_goto(
...
static int tc_act_parse_goto(struct mlx5e_tc_act_parse_state *parse_state,
    const struct flow_action_entry *act,
...
static int tc_act_post_parse_goto(struct mlx5e_tc_act_parse_state *parse_state,
    struct mlx5e_priv *priv,
    struct mlx5_flow_attr *attr) {
