...
#define pedit_header(_ph, \
      _htype) ((void *) (_ph) + pedit_header_offsets[_htype])
...
int mlx5e_tc_act_pedit_parse_action(struct mlx5e_priv *priv,
...
static int tc_act_parse_pedit(struct mlx5e_tc_act_parse_state *parse_state,
