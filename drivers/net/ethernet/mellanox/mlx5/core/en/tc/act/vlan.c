...
static int add_vlan_prio_tag_rewrite_action(struct mlx5e_priv *priv,
...
static int tc_act_parse_vlan(struct mlx5e_tc_act_parse_state *parse_state,
    const struct flow_action_entry *act,
  ...
  if (act->id == FLOW_ACTION_VLAN_PUSH
    ...
    attr->action &= ~MLX5_FLOW_CONTEXT_ACTION_VLAN_POP;
    err = mlx5e_tc_act_vlan_add_rewrite_action(priv, MLX5_FLOW_NAMESPACE_FDB,
        act,
...
static int tc_act_post_parse_vlan(struct mlx5e_tc_act_parse_state *parse_state,
    struct mlx5e_priv *priv,
    struct mlx5_flow_attr *attr) {
