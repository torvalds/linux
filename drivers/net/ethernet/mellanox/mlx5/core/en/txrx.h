...
#define INL_HDR_START_SZ (sizeof(((struct mlx5_wqe_eth_seg *) NULL)->inline_hdr. \
  start))
...
static inline
ktime_t mlx5e_cqe_ts_to_ns(cqe_ts_to_ns func, struct mlx5_clock *clock,
    u64 cqe_ts) {
...
static inline void mlx5e_eseg_swp_offsets_add_vlan(
...
static inline u16 mlx5e_stop_room_for_wqe(struct mlx5_core_dev *mdev,
    u16 wqe_size) {
  WARN_ON_ONCE(PAGE_SIZE / MLX5_SEND_WQE_BB < (u16) mlx5e_get_max_sq_wqebbs(
      mdev));
