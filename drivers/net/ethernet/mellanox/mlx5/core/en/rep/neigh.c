...
static struct mlx5e_neigh_hash_entry *mlx5e_get_next_nhe(
...
static void mlx5e_release_neigh_update_work(
...
static struct neigh_update_work *mlx5e_alloc_neigh_update_work(
