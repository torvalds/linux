...
static struct mlx5e_rep_bond_metadata *mlx5e_lookup_rep_bond_metadata(
...
static struct mlx5e_rep_bond_slave_entry *mlx5e_lookup_rep_bond_slave_entry(
...
static void mlx5e_rep_bond_metadata_release(
    struct mlx5e_rep_bond_metadata *mdata) {
...
static void mlx5e_rep_changelowerstate_event(struct net_device *netdev,
    void *ptr) {
