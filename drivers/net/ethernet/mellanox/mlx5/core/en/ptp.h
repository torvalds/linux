...
static inline void mlx5e_ptp_metadata_fifo_push(
    struct mlx5e_ptp_metadata_fifo *fifo, u8 metadata) {
  fifo->data[fifo->mask & fifo->pc++] = metadata;
}

static inline u8 mlx5e_ptp_metadata_fifo_pop(
    struct mlx5e_ptp_metadata_fifo *fifo) {
  return fifo->data[fifo->mask & fifo->cc++];
}

static inline void mlx5e_ptp_metadata_map_put(
...
static inline bool mlx5e_ptpsq_metadata_freelist_empty(
