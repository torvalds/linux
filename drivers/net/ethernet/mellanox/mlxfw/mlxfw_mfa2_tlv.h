...
static inline const struct mlxfw_mfa2_tlv *mlxfw_mfa2_tlv_get(
    const struct mlxfw_mfa2_file *mfa2_file, const void *ptr) {
...
static inline const void *mlxfw_mfa2_tlv_payload_get(
