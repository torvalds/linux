...
static int mcr20a_set_hw_addr_filt(struct ieee802154_hw *hw,
...
static int mcr20a_set_cca_mode(struct ieee802154_hw *hw,
...
static int mcr20a_set_promiscuous_mode(struct ieee802154_hw *hw,
    const bool on) {
  struct mcr20a_local *lp = hw->priv;
  int ret;
