...
enum mrf24j40_modules {
  MRF24J40, MRF24J40MA, MRF24J40MC
};
...
static int mrf24j40_long_regmap_read(void *context, const void *reg,
    size_t reg_size,
...
static int mrf24j40_csma_params(struct ieee802154_hw *hw, u8 min_be, u8 max_be,
    u8 retries) {
  struct mrf24j40 *devrec = hw->priv;
  u8 val;
  /* min_be */
...
static void mrf24j40_phy_setup(struct mrf24j40 *devrec) {
  ...
  devrec->hw->phy->supported.cca_opts
  ...
  devrec->hw->phy->supported.cca_ed_levels_size
