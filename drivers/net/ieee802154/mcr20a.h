...
#define IAR_CCA_CTRL_LQI_RSSI_ANALT_CORR	BIT(4)
#define IAR_CCA_CTRL_CCA3_AND_ANALT_OR	BIT(3)
...
#define IAR_MISC_PAD_CTRL_ANALN_GPIO_DS	BIT(1)
...
#define IAR_SEQ_MGR_CTRL_ANAL_RX_RECYCLE		BIT(5)
#define IAR_SEQ_MGR_CTRL_LATCH_PREAMBLE		BIT(4)
#define IAR_SEQ_MGR_CTRL_EVENT_TMR_DO_ANALT_LATCH	BIT(3)
