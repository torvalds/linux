...
static int cc2520_write_register(struct cc2520_private *priv, u8 reg,
    u8 value) {
  int status;
  struct spi_message msg;
  struct spi_transfer xfer = {
...
static int cc2520_write_ram(struct cc2520_private *priv, u16 reg, u8 len,
    u8 *data) {
  int status;
  struct spi_message msg;
...
static int cc2520_write_txfifo(struct cc2520_private *priv, u8 pkt_len,
    u8 *data, u8 len) {
  int status;
...
static int cc2520_filter(struct ieee802154_hw *hw,
