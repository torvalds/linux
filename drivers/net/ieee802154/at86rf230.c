...
static void at86rf230_async_state_change(struct at86rf230_local *lp,
    struct at86rf230_state_change *ctx,
    const u8 state, void (*complete)(void *context));

static inline void at86rf230_sleep(struct at86rf230_local *lp) {
  if (lp->slp_tr) {
...
static inline void at86rf230_awake(struct at86rf230_local *lp) {
  if (lp->slp_tr) {
...
static inline int __at86rf230_write(struct at86rf230_local *lp,
...
static inline int __at86rf230_read(struct at86rf230_local *lp,
    unsigned int addr, unsigned int *data) {
  bool sleep = lp->sleep;
  int ret;
  /* awake for register setting if sleep */
...
static inline int at86rf230_read_subreg(struct at86rf230_local *lp,
...
static inline int at86rf230_write_subreg(struct at86rf230_local *lp,
    unsigned int addr, unsigned int mask,
    unsigned int shift, unsigned int data) {
  bool sleep = lp->sleep;
  int ret;
...
static inline void at86rf230_slp_tr_rising_edge(struct at86rf230_local *lp) {
  gpiod_set_value(lp->slp_tr, 1);
  udelay(1);
  gpiod_set_value(lp->slp_tr, 0);
}
...
static inline void at86rf230_async_error(struct at86rf230_local *lp,
...
static void at86rf230_async_read_reg(struct at86rf230_local *lp, u8 reg,
    struct at86rf230_state_change *ctx,
    void (*complete)(void *context)) {
  int rc;
  u8 *tx_buf = ctx->buf;
...
static void at86rf230_async_write_reg(struct at86rf230_local *lp, u8 reg,
    u8 val,
    struct at86rf230_state_change *ctx,
    void (*complete)(void *context)) {
  int rc;
 ...
 */
static int at86rf230_sync_state_change(struct at86rf230_local *lp,
    unsigned int state) {
  unsigned long rc;
...
static int at86rf23x_set_channel(struct at86rf230_local *lp, u8 page,
    u8 channel) {
...
static inline int at86rf212_update_cca_ed_level(struct at86rf230_local *lp,
    int rssi_base_val) {
...
static int at86rf212_set_channel(struct at86rf230_local *lp, u8 page,
    u8 channel) {
  int rc;
  if (channel == 0) {
...
static int at86rf230_set_hw_addr_filt(struct ieee802154_hw *hw,
...
static int at86rf230_set_cca_mode(struct ieee802154_hw *hw,
...
static int at86rf230_set_csma_params(struct ieee802154_hw *hw, u8 min_be,
    u8 max_be,
    u8 retries) {
  struct at86rf230_local *lp = hw->priv;
  int rc;
...
static int at86rf230_set_promiscuous_mode(struct ieee802154_hw *hw,
    const bool on) {
  struct at86rf230_local *lp = hw->priv;
  int rc;
  if (on) {
