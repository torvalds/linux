...
#define EQ_STA_BIT(index)   (BIT((index) + EQ_STA_BIT_OFFSET) \
  & EMPTY_STATUS_BITMASK)
...
void t7xx_cldma_hw_irq_en_txrx(struct t7xx_cldma_hw *hw_info, unsigned int qno,
    enum mtk_txrx tx_rx);
void t7xx_cldma_hw_irq_en_eq(struct t7xx_cldma_hw *hw_info, unsigned int qno,
    enum mtk_txrx tx_rx);
unsigned int t7xx_cldma_hw_queue_status(struct t7xx_cldma_hw *hw_info,
    unsigned int qno,
    enum mtk_txrx tx_rx);
...
void t7xx_cldma_hw_stop_all_qs(struct t7xx_cldma_hw *hw_info,
    enum mtk_txrx tx_rx);
...
unsigned int t7xx_cldma_hw_int_status(struct t7xx_cldma_hw *hw_info,
