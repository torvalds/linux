 ...
 *         +------------------+
 */
static void t7xx_cldma_exception(struct cldma_ctrl *md_ctrl,
...
static int t7xx_prepare_device_rt_data(struct t7xx_sys_info *core,
    struct device *dev,
    void *data) {
...
static int t7xx_parse_host_rt_data(struct t7xx_fsm_ctl *ctl,
    struct t7xx_sys_info *core,
...
static void t7xx_core_hk_handler(struct t7xx_modem *md,
    struct t7xx_sys_info *core_info,
    struct t7xx_fsm_ctl *ctl,
...
static void t7xx_md_hk_wq(struct work_struct *work) {
  ...
  t7xx_core_hk_handler(md, &md->core_md, ctl, FSM_EVENT_MD_HS2,
...
static void t7xx_ap_hk_wq(struct work_struct *work) {
  ...
  t7xx_core_hk_handler(md, &md->core_ap, ctl, FSM_EVENT_AP_HS2,
...
void t7xx_md_exit(struct t7xx_pci_dev *t7xx_dev) {
  ...
  if (mode != T7XX_RESET && mode != T7XX_UNKNOWN) {
    t7xx_fsm_append_cmd(md->fsm_ctl, FSM_CMD_PRE_STOP,
