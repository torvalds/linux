...
bool t7xx_cldma_tx_addr_is_set(struct t7xx_cldma_hw *hw_info,
    unsigned int qno) {
...
void t7xx_cldma_hw_tx_done(struct t7xx_cldma_hw *hw_info,
...
void t7xx_cldma_hw_rx_done(struct t7xx_cldma_hw *hw_info,
    unsigned int bitmask) {
  unsigned int ch_id;
