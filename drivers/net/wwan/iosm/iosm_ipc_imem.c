...
static int ipc_imem_msg_send_device_sleep(struct iosm_imem *ipc_imem,
    u32 state) {
...
static enum hrtimer_restart ipc_imem_fast_update_timer_cb(
...
static enum hrtimer_restart ipc_imem_adb_timer_cb(struct hrtimer *hr_timer) {
  struct iosm_imem *ipc_imem
...
static enum hrtimer_restart ipc_imem_td_update_timer_cb(
    struct hrtimer *hr_timer) {
  struct iosm_imem *ipc_imem
...
void ipc_imem_td_update_timer_suspend(struct iosm_imem *ipc_imem,
    bool suspend) {
