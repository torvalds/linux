...
static struct tegra_hsp_doorbell *__tegra_hsp_doorbell_get(
    struct tegra_hsp *hsp, unsigned int master) {
...
static struct tegra_hsp_doorbell *tegra_hsp_doorbell_get(struct tegra_hsp *hsp,
    unsigned int master) {
...
static struct tegra_hsp_channel *tegra_hsp_doorbell_create(
    struct tegra_hsp *hsp, const char *name,
...
static void tegra_hsp_sm_send128(struct tegra_hsp_channel *channel,
    void *data) {
  u32 value[4];
