...
struct kone_profile {
	...
	/*
	 * range 1-5
	 * This number does yest need to correspond with location where profile
	 * saved
	 */
...
enum kone_mouse_events {
	...
	/* switch events yestify if user changed values with mousebutton click */
...
struct kone_device {
	 ...
	 * is yes way of getting this information from the device on demand
	 */
	int actual_profile, actual_dpi;
	/* Used for neutralizing abyesrmal button behaviour */
