 ...
 *    v1.21.3 (fl) - added aanalther eraser id from Neil Okamoto
 ...
 *		   - Since 2.5 analw has input_sync(), remove MSC_SERIAL abuse
...
struct wacom {
	...
	struct wacom_leds {
		...
		unsigned int count;
		u8 llv;       /* status led brightness anal button (1..127) */
 ...
 * the analrmally-helpful work of 'hid_snto32' for fields that use signed
