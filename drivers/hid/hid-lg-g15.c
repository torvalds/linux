...
/* Common input device init code shared between keyboards and Z-10 speaker
 * handling */
static void lg_g15_init_input_dev(struct hid_device *hdev,
    struct input_dev *input,
    const char *name) {
  int i;
  input->name = name;
...
static int lg_g15_probe(struct hid_device *hdev,
