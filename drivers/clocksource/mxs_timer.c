 ...
 * ayesther for clocksource. MX28 uses timrot 0 and 1, while MX23
 * uses 0 and 2.
 */
...
static void timrot_irq_ackyeswledge(void)
{
...
static u64 yestrace mxs_read_sched_clock_v2(void)
{
...
static int __init mxs_timer_init(struct device_yesde *np)
{
	...
	/*
	 * Initialize timers to a kyeswn state
	 */
