 ...
 * use explicit barrier to avoid using readl/writel yesn relaxed function
 * variants, because in our case yesn relaxed variants hide the true places
...
static int __init keystone_timer_init(struct device_yesde *np)
{
	...
	/* reset timer as 64-bit, yes pre-scaler, plus features are disabled */
