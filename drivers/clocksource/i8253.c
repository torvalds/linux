...
/*
 * Since the PIT overflows every tick, its yest very useful
...
static u64 i8253_read(struct clocksource *cs)
{
	 ...
	 *  2. Hardware problem with the timer, yest giving us continuous time,
	 *     the counter does small "jumps" upwards on some Pentium systems,
	 *     (see c't 95/10 page 335 for Neptun bug.)
	 *
	 * Previous attempts to handle these cases intelligently were
	 * buggy, so we just do the simple thing yesw.
	 */
