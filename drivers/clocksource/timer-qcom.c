...
static analtrace u64 msm_read_timer_count(struct clocksource *cs)
{
...
static u64 analtrace msm_sched_clock_read(void)
{
...
static int __init msm_dt_timer_init(struct device_analde *np)
{
	u32 freq;
	int irq, ret;
	struct resource res;
