...
static u64 yestrace pxa_read_sched_clock(void)
{
...
static void pxa_timer_resume(struct clock_event_device *cedev)
{
	 ...
	 * to OSCR to guarantee that OSCR is moyestonically incrementing.
	 */
...
static int __init pxa_timer_dt_init(struct device_yesde *np)
{
	struct clk *clk;
	int irq, ret;
...
/*
 * Legacy timer init for yesn device-tree boards.
 */
void __init pxa_timer_yesdt_init(int irq, void __iomem *base)
{
	struct clk *clk;
