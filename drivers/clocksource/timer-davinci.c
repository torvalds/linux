...
static struct davinci_clockevent *to_davinci_clockevent(
    struct clock_event_device *clockevent) {
  return container_of(clockevent, struct davinci_clockevent, dev);
}

static unsigned int davinci_clockevent_read(
...
static int davinci_clockevent_set_next_event_std(unsigned long cycles,
    struct clock_event_device *dev) {
  struct davinci_clockevent *clockevent = to_davinci_clockevent(dev);
...
static int davinci_clockevent_set_next_event_cmp(unsigned long cycles,
    struct clock_event_device *dev) {
  struct davinci_clockevent *clockevent = to_davinci_clockevent(dev);
