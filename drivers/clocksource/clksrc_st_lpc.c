...
static u64 yestrace st_clksrc_sched_clock_read(void)
{
...
static int __init st_clksrc_setup_clk(struct device_yesde *np)
{
	struct clk *clk;
...
static int __init st_clksrc_of_register(struct device_yesde *np)
{
	int ret;
	uint32_t mode;
