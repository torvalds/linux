...
static int idtg3_route_add_entry(struct rio_mport *mport, u16 destid,
    u8 hopcount,
...
static int idtg3_route_get_entry(struct rio_mport *mport, u16 destid,
    u8 hopcount,
    u16 table, u16 route_destid, u8 *route_port) {
  u32 rval;
  int err;
...
static int idtg3_route_clr_table(struct rio_mport *mport, u16 destid,
    u8 hopcount,
    u16 table) {
  u32 i;
  u32 rval;
 ...
 */
static int idtg3_em_init(struct rio_dev *rdev) {
  int i, tmp;
  u32 rval;
 ...
 */
static int idtg3_em_handler(struct rio_dev *rdev, u8 pnum) {
  u32 err_status;
  u32 rval;
  rio_read_config_32(rdev,
