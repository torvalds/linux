...
static int idtg2_route_add_entry(struct rio_mport *mport, u16 destid,
    u8 hopcount,
...
static int idtg2_route_get_entry(struct rio_mport *mport, u16 destid,
    u8 hopcount,
    u16 table, u16 route_destid, u8 *route_port) {
  u32 result;
  /*
...
static int idtg2_route_clr_table(struct rio_mport *mport, u16 destid,
    u8 hopcount,
    u16 table) {
  u32 i;
  /*
...
static int idtg2_set_domain(struct rio_mport *mport, u16 destid, u8 hopcount,
    u8 sw_domain) {
  /*
...
static int idtg2_get_domain(struct rio_mport *mport, u16 destid, u8 hopcount,
    u8 *sw_domain) {
  u32 regval;
  /*
   * Switch domain configuration operates only at global level
...
static int idtg2_em_init(struct rio_dev *rdev) {
  u32 regval;
  int i, tmp;
  /*
...
static int idtg2_em_handler(struct rio_dev *rdev, u8 portnum) {
...
static ssize_t idtg2_show_errlog(struct device *dev,
