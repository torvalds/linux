 ...
 * Returns: %0
 */
static int tsi721_pw_handler(struct tsi721_device *priv) {
  u32 pw_stat;
 ...
 * Returns: %0
 */
static int tsi721_dbell_handler(struct tsi721_device *priv) {
  u32 regval;
...
static int tsi721_obw_alloc(struct tsi721_device *priv,
...
static void tsi721_imsg_interrupt_enable(struct tsi721_device *priv, int ch,
    u32 inte_mask) {
  u32 rval;
  if (!inte_mask) {
    return;
...
static void tsi721_imsg_interrupt_disable(struct tsi721_device *priv, int ch,
    u32 inte_mask) {
  u32 rval;
  if (!inte_mask) {
    return;
...
static void tsi721_omsg_interrupt_enable(struct tsi721_device *priv, int ch,
    u32 inte_mask) {
  u32 rval;
  if (!inte_mask) {
    return;
...
static void tsi721_omsg_interrupt_disable(struct tsi721_device *priv, int ch,
    u32 inte_mask) {
  u32 rval;
  if (!inte_mask) {
    return;
 ...
 * Returns: %0 on success or -errno value on failure.
 */
static int tsi721_add_outb_message(struct rio_mport *mport,
