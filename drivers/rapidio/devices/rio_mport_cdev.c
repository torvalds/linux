 ...
 */
static int rio_mport_create_outbound_mapping(struct mport_dev *md,
    struct file *filp,
...
static int rio_mport_get_outbound_mapping(struct mport_dev *md,
    struct file *filp,
    u16 rioid, u64 raddr, u32 size,
    dma_addr_t *paddr) {
  struct rio_mport_mapping *map;
...
static int rio_mport_create_inbound_mapping(struct mport_dev *md,
    struct file *filp,
    u64 raddr, u64 size,
...
static int rio_mport_get_inbound_mapping(struct mport_dev *md,
    struct file *filp,
    u64 raddr, u64 size,
    struct rio_mport_mapping **mapping) {
  struct rio_mport_mapping *map;
...
static int rio_mport_del_riodev(struct mport_cdev_priv *priv,
    void __user *arg) {
  struct rio_rdev_info dev_info;
