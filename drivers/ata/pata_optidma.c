...
static void optiplus_set_pio_mode(struct ata_port *ap,
...
static void optiplus_set_dma_mode(struct ata_port *ap,
    struct ata_device *adev) {
...
static int optidma_set_mode(struct ata_link *link,
...
static int optidma_init_one(struct pci_dev *dev,
