...
const char *libata_trace_parse_status(struct trace_seq *p,
...
const char *libata_trace_parse_host_stat(struct trace_seq *p,
...
const char *libata_trace_parse_eh_action(struct trace_seq *p,
...
const char *libata_trace_parse_eh_err_mask(struct trace_seq *p,
...
const char *libata_trace_parse_qc_flags(struct trace_seq *p,
...
const char *libata_trace_parse_tf_flags(struct trace_seq *p,
...
const char *libata_trace_parse_subcmd(struct trace_seq *p, unsigned char cmd,
