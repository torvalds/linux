...
static unsigned long pacpi_discover_modes(struct ata_port *ap,
...
static unsigned int pacpi_mode_filter(struct ata_device *adev,
    unsigned int mask) {
...
static int pacpi_init_one(struct pci_dev *pdev,
...
static const struct pci_device_id pacpi_pci_tbl[] = {
  { PCI_ANY_ID, PCI_ANY_ID, PCI_ANY_ID, PCI_ANY_ID, PCI_CLASS_STORAGE_IDE << 8,
      0xFFFFFF00UL, 1},
  {} /* terminate list */
};
