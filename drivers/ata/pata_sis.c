...
static void sis_old_set_piomode(struct ata_port *ap, struct ata_device *adev) {
  ...
  static const u8 active[] = {
    0x00, 0x07, 0x04, 0x03, 0x01
  };
  static const u8 recovery[] = {
...
static void sis_133_early_set_dmamode(struct ata_port *ap,
...
static void sis_133_set_dmamode(struct ata_port *ap, struct ata_device *adev) {
  ...
  if (adev->dma_mode < XFER_UDMA_0) {
    ...
    static const u32 timing_u100[] = {
      0x19154000, 0x06072000, 0x04062000
    };
    static const u32 timing_u133[] = {
...
static unsigned int sis_133_mode_filter(struct ata_device *adev,
    unsigned int mask) {
  struct ata_port *ap = adev->link->ap;
  struct pci_dev *pdev = to_pci_dev(ap->host->dev);
