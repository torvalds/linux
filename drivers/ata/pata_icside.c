 ...
 */
static void pata_icside_irqenable_arcin_v5(struct expansion_card *ec,
    int irqnr) {
 ...
 */
static void pata_icside_irqdisable_arcin_v5(struct expansion_card *ec,
    int irqnr) {
  struct pata_icside_state *state = ec->irq_data;
 ...
 * Purpose  : enable interrupts from card
 */
static void pata_icside_irqenable_arcin_v6(struct expansion_card *ec,
    int irqnr) {
  struct pata_icside_state *state = ec->irq_data;
...
/* Prototype: pata_icside_irqdisable_arcin_v6 (struct expansion_card *ec, int
 * irqnr)
 * Purpose  : disable interrupts from card
 */
static void pata_icside_irqdisable_arcin_v6(struct expansion_card *ec,
    int irqnr) {
  struct pata_icside_state *state = ec->irq_data;
 ...
 *  MW2 70  25  25  120 C
 */
static void pata_icside_set_dmamode(struct ata_port *ap,
...
static void pata_icside_postreset(struct ata_link *link,
