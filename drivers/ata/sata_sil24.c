...
enum {
  ...
  PORT_CERR_SGT_PCIPERR = 19, /* PLD ecode 11 - PCI parity err while fetching
                               * SGT */
  PORT_CERR_CMD_BOUNDARY = 24, /* ctrl[15:13] 001 - PRB not on qword boundary */
  PORT_CERR_CMD_TGTABRT = 25, /* ctrl[15:13] 010 - target abort */
  PORT_CERR_CMD_MSTABRT = 26, /* ctrl[15:13] 100 - master abort */
  PORT_CERR_CMD_PCIPERR = 27, /* ctrl[15:13] 110 - PCI parity err while fetching
                               * PRB */
...
static int sil24_init_one(struct pci_dev *pdev,
...
static void sil24_read_tf(struct ata_port *ap, int tag,
