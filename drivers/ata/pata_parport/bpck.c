...
static void bpck_write_regr(struct pi_adapter *pi, int cont, int regr,
    int val) {
  int r;
  r = regr + cont_map[cont];
  switch (pi->mode) {
...
MODULE_DESCRIPTION(
    "MicroSolutions BACKPACK parallel port IDE adapter protocol driver");
