...
static int acard_ahci_init_one(struct pci_dev *pdev,
    const struct pci_device_id *ent);

#ifdef CONFIG_PM_SLEEP
static int acard_ahci_pci_device_suspend(struct pci_dev *pdev,
    pm_message_t mesg);
...
static unsigned int acard_ahci_fill_sg(struct ata_queued_cmd *qc,
    void *cmd_tbl) {
