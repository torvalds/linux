...
static unsigned int serverworks_osb4_filter(struct ata_device *adev,
    unsigned int mask) {
 ...
 */
static void serverworks_set_piomode(struct ata_port *ap,
    struct ata_device *adev) {
  static const u8 pio_mode[] = {
...
static void serverworks_set_dmamode(struct ata_port *ap,
    struct ata_device *adev) {
  static const u8 dma_mode[] = {
    0x77, 0x21, 0x20
  };
  int offset = 1 + 2 * ap->port_no - adev->devno;
...
static int serverworks_init_one(struct pci_dev *pdev,
