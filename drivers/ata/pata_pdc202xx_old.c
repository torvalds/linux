...
static void pdc202xx_configure_piomode(struct ata_port *ap,
    struct ata_device *adev, int pio) {
  struct pci_dev *pdev = to_pci_dev(ap->host->dev);
...
/**
 *  pdc2026x_check_atapi_dma - Check whether ATAPI DMA can be supported for this
 * command
