...
static void ahci_intel_pcs_quirk(struct pci_dev *pdev,
...
static const struct pci_device_id ahci_pci_tbl[] = {
  ...
  { PCI_VDEVICE(INTEL, 0x9dd3), board_ahci_pcs_quirk }, /* Cannon Lake PCH-LP
                                                         * AHCI */
  ...
  { PCI_VDEVICE(INTEL, 0x2823), board_ahci_pcs_quirk }, /* Wellsburg/Lewisburg
                                                         * AHCI*/
  ...
  { PCI_VDEVICE(INTEL, 0x43d4), board_ahci_pcs_quirk }, /* Rocket Lake PCH-H
                                                         * RAID */
  { PCI_VDEVICE(INTEL, 0x43d5), board_ahci_pcs_quirk }, /* Rocket Lake PCH-H
                                                         * RAID */
  { PCI_VDEVICE(INTEL, 0x43d6), board_ahci_pcs_quirk }, /* Rocket Lake PCH-H
                                                         * RAID */
  { PCI_VDEVICE(INTEL, 0x43d7), board_ahci_pcs_quirk }, /* Rocket Lake PCH-H
                                                         * RAID */
  ...
  { PCI_VDEVICE(INTEL, 0xa356), board_ahci_pcs_quirk }, /* Cannon Lake PCH-H
                                                         * RAID */
  ...
  { PCI_VDEVICE(INTEL, 0x0f23), board_ahci_pcs_quirk_no_devslp }, /* Bay Trail
                                                                   * AHCI */
  ...
  { PCI_VDEVICE(INTEL, 0x02d7), board_ahci_pcs_quirk }, /* Comet Lake PCH RAID
                                                         * */
  /* Elkhart Lake IDs 0x4b60 & 0x4b62 https://sata-io.org/product/8803 not
   * tested yet */
  ...
  { PCI_VDEVICE(AMD, 0x7801), board_ahci_no_debounce_delay }, /* AMD Hudson-2
                                                               * (AHCI mode) */
