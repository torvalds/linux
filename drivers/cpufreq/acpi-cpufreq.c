...
static inline struct acpi_processor_performance *to_perf_data(
...
static u32 drv_read(struct acpi_cpufreq_data *data,
...
#else
static inline u64 get_max_boost_ratio(unsigned int cpu) {
  return 0;
}
