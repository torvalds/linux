...
static int pas_cpufreq_cpu_init(struct cpufreq_policy *policy)
{
	...
	dn = of_find_compatible_yesde(NULL, NULL, "1682m-sdc");
	if (!dn)
		dn = of_find_compatible_yesde(NULL, NULL,
	...
	dn = of_find_compatible_yesde(NULL, NULL, "1682m-gizmo");
	if (!dn)
		dn = of_find_compatible_yesde(NULL, NULL,
