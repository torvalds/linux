...
#  define DEF_FREQUENCY_DOWN_DIFFERENTIAL	(DEF_FREQUENCY_DOWN_DIFFERENTIAL_CUSTOM)
...
#if   defined(CONFIG_ZEN_CUSTOM)
#  define MICRO_FREQUENCY_DOWN_DIFFERENTIAL	(MICRO_FREQUENCY_DOWN_DIFFERENTIAL_CUSTOM)
