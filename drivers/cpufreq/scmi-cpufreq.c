...
static int scmi_get_sharing_cpus(struct device *cpu_dev, int domain,
...
static int __maybe_unused scmi_get_cpu_power(struct device *cpu_dev,
    unsigned long *power,
    unsigned long *KHz) {
...
static int scmi_get_rate_limit(u32 domain, bool has_fast_switch) {
  int ret, rate_limit;
  if (has_fast_switch) {
    /*
