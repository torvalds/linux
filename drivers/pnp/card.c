...
struct pnp_card *pnp_alloc_card(struct pnp_protocol *protocol, int id,
    char *pnpid) {
  struct pnp_card *card;
 ...
 * @id: pointer to a PnP ID structure that explains the rules for finding the
 * device
 * @from: Starting place to search from. If NULL it will start from the
 * beginning.
 */
