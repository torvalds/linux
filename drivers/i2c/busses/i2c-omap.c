...
static void omap_i2c_resize_fifo(struct omap_i2c_dev *omap, u8 size,
    bool is_rx) {
  u16 buf;
 ...
 */
static int omap_i2c_xfer_common(struct i2c_adapter *adap, struct i2c_msg msgs[],
    int num,
    bool polling) {
  struct omap_i2c_dev *omap = i2c_get_adapdata(adap);
  int i;
...
static int omap_i2c_xfer_irq(struct i2c_adapter *adap, struct i2c_msg msgs[],
    int num) {
  return omap_i2c_xfer_common(adap, msgs, num, false);
}

static int omap_i2c_xfer_polling(struct i2c_adapter *adap,
...
static inline void omap_i2c_complete_cmd(struct omap_i2c_dev *omap, u16 err) {
  omap->cmd_err |= err;
  complete(&omap->cmd_complete);
}

static inline void omap_i2c_ack_stat(struct omap_i2c_dev *omap, u16 stat) {
...
static irqreturn_t omap_i2c_omap1_isr(int this_irq, void *dev_id) {
