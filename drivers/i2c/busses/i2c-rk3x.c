...
/**
 * rk3x_i2c_start - Generate a START condition, which triggers a REG_INT_START
 *interrupt.
...
/**
 * rk3x_i2c_stop - Generate a STOP condition, which triggers a REG_INT_STOP
 *interrupt.
 * @i2c: target controller data
 ...
 *
 * Return: %0 on success, -%EINVAL if the goal SCL rate is too slow. In that
 *case
...
/**
 * rk3x_i2c_setup - Setup I2C registers for an I2C operation specified by msgs,
 *num.
 * @i2c: target controller data
