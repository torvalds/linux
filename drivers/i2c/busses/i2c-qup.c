 ...
 */
static void qup_i2c_write_blk_data(struct qup_i2c_dev *qup, u8 **data,
    unsigned int *len) {
  struct qup_i2c_block *blk = &qup->blk;
  unsigned int j;
 ...
 */
static int qup_i2c_conf_xfer_v2(struct qup_i2c_dev *qup, bool is_rx,
    bool is_first,
 ...
 */
static int qup_i2c_determine_mode_v2(struct qup_i2c_dev *qup,
