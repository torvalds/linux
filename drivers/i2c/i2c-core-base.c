...
static int i2c_device_uevent(const struct device *dev,
...
static int i2c_dev_or_parent_fwnode_match(struct device *dev,
    const void *data) {
 ...
 */
const struct i2c_device_id *i2c_client_get_device_id(
    const struct i2c_client *client) {
