...
static int pca_xfer(struct i2c_adapter *i2c_adap,
  ...
  while (curmsg < num) {
    ...
    switch (state) {
      ...
      case 0x28: /* Data byte in I2CDAT has been transmitted; ACK has been
                  * received */
        if (numbytes < msg->len) {
      ...
      case 0x48: /* SLA+R has been transmitted; NOT ACK has been received */
        ...
        ret = -ENXIO;
        goto out;
      case 0x30: /* Data byte in I2CDAT has been transmitted; NOT ACK has been
                  * received */
      ...
      case 0x90: /* Bus error - SCL stuck low (PCA9564) */
        ...
        pca_reset(adap);
        goto out;
      case 0x00: /* Bus error during master or slave mode due to illegal START
                  * or STOP condition */
