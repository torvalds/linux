...
/**
 *  dio_match_device - Tell if a DIO device structure has a matching DIO device
 * id structure
...
static const struct dio_device_id *dio_match_device(
    const struct dio_device_id *ids,
...
/**
 *  dio_bus_match - Tell if a DIO device structure has a matching DIO device id
 * structure
 *  @dev: the DIO device structure to match against
 *  @drv: the &device_driver that points to the array of DIO device id
