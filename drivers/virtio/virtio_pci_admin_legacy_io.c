 ...
 * of a member device
 * @dev: VF pci_dev
 * @offset: starting byte offset within the common configuration area to write
 * to
 ...
 * of a member device
 * @dev: VF pci_dev
 * @offset: starting byte offset within the device configuration area to write
 * to
 * @size: size of the data to write
 * @buf: buffer which holds the data
 *
 ...
 * a member device
 * @dev: VF pci_dev
 * @offset: starting byte offset within the device configuration area to read
 * from
 ...
 * a member device
 * @dev: VF pci_dev
 * @offset: starting byte offset within the common configuration area to read
 * from
 * @size: size of the data to be read
 * @buf: buffer to hold the returned data
 *
