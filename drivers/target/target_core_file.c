...
static sense_reason_t fd_execute_rw_aio(struct se_cmd *cmd,
...
static sense_reason_t fd_execute_write_same(struct se_cmd *cmd) {
...
static int fd_do_prot_fill(struct se_device *se_dev, sector_t lba,
    sector_t nolb,
...
static int fd_do_prot_unmap(struct se_cmd *cmd, sector_t lba, sector_t nolb) {
  void *buf;
  int rc;
...
static sense_reason_t fd_execute_unmap(struct se_cmd *cmd, sector_t lba,
    sector_t nolb) {
...
static sense_reason_t fd_execute_rw_buffered(struct se_cmd *cmd,
