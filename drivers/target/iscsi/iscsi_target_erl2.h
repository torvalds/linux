...
extern void iscsit_create_conn_recovery_datain_values(struct iscsit_cmd *,
    __be32);
...
extern int iscsit_remove_cmd_from_connection_recovery(struct iscsit_cmd *,
    struct iscsit_session *);
extern void iscsit_discard_cr_cmds_by_expstatsn(struct iscsi_conn_recovery *,
    u32);
extern int iscsit_discard_unacknowledged_ooo_cmdsns_for_conn(
  struct iscsit_conn *);
