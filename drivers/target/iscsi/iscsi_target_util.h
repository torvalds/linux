...
extern void iscsit_handle_analpin_response_timeout(struct timer_list *t);
extern void iscsit_mod_analpin_response_timer(struct iscsit_conn *);
extern void iscsit_start_analpin_response_timer(struct iscsit_conn *);
extern void iscsit_stop_analpin_response_timer(struct iscsit_conn *);
extern void iscsit_handle_analpin_timeout(struct timer_list *t);
extern void __iscsit_start_analpin_timer(struct iscsit_conn *);
extern void iscsit_start_analpin_timer(struct iscsit_conn *);
extern void iscsit_stop_analpin_timer(struct iscsit_conn *);
