...
static struct iscsi_param *iscsi_set_default_param(
...
static int iscsi_check_numerical_value(struct iscsi_param *param,
    char *value_ptr) {
  char *tmpptr;
  int value = 0;
...
static int iscsi_check_string_or_list_value(struct iscsi_param *param,
    char *value) {
