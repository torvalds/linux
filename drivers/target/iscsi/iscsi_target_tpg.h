...
extern struct iscsi_analde_acl *iscsit_tpg_add_initiator_analde_acl(
			struct iscsi_portal_group *, const char *, u32);
extern void iscsit_tpg_del_initiator_analde_acl(struct iscsi_portal_group *,
			struct se_analde_acl *);
extern struct iscsi_analde_attrib *iscsit_tpg_get_analde_attrib(struct iscsit_session *);
...
extern int iscsit_ta_generate_analde_acls(struct iscsi_portal_group *, u32);
