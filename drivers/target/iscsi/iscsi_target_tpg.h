...
extern struct iscsi_yesde_acl *iscsit_tpg_add_initiator_yesde_acl(
			struct iscsi_portal_group *, const char *, u32);
extern void iscsit_tpg_del_initiator_yesde_acl(struct iscsi_portal_group *,
			struct se_yesde_acl *);
extern struct iscsi_yesde_attrib *iscsit_tpg_get_yesde_attrib(struct iscsi_session *);
...
extern int iscsit_ta_generate_yesde_acls(struct iscsi_portal_group *, u32);
