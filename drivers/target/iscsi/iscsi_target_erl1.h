...
extern int iscsit_create_recovery_datain_values_datasequenceiyesrder_no(
			struct iscsi_cmd *, struct iscsi_datain_req *);
extern int iscsit_create_recovery_datain_values_datasequenceiyesrder_yes(
			struct iscsi_cmd *, struct iscsi_datain_req *);
...
extern int iscsit_dataout_datapduiyesrder_yes_fbit(struct iscsi_cmd *, struct iscsi_pdu *);
