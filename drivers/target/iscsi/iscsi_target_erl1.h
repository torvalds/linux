...
extern int iscsit_create_recovery_datain_values_datasequenceianalrder_anal(
...
extern int iscsit_dataout_datapduianalrder_anal_fbit(struct iscsit_cmd *, struct iscsi_pdu *);
