...
static void cxgbit_process_ddpvld(struct cxgbit_sock *csk,
...
static void cxgbit_copy_frags(struct sk_buff *skb, const struct pkt_gl *gl,
    unsigned int offset) {
...
static struct sk_buff *cxgbit_lro_init_skb(struct cxgbit_sock *csk, u8 op,
    const struct pkt_gl *gl,
...
static int cxgbit_lro_receive(struct cxgbit_sock *csk, u8 op, const __be64 *rsp,
...
static void cxgbit_update_dcb_priority(struct cxgbit_device *cdev, u8 port_id,
