...
static struct sk_buff *__cxgbit_alloc_skb(struct cxgbit_sock *csk, u32 len,
    bool iso) {
...
static void cxgbit_cpl_tx_data_iso(struct sk_buff *skb,
...
static void cxgbit_tx_data_wr(struct cxgbit_sock *csk, struct sk_buff *skb,
    u32 dlen,
...
static int cxgbit_map_skb(struct iscsit_cmd *cmd, struct sk_buff *skb,
    u32 data_offset,
    u32 data_length) {
...
static int cxgbit_tx_datain_iso(struct cxgbit_sock *csk, struct iscsit_cmd *cmd,
...
static int cxgbit_tx_datain(struct cxgbit_sock *csk, struct iscsit_cmd *cmd,
...
static int cxgbit_xmit_datain_pdu(struct iscsit_conn *conn,
...
static int cxgbit_xmit_nondatain_pdu(struct iscsit_conn *conn,
    struct iscsit_cmd *cmd,
...
int cxgbit_xmit_pdu(struct iscsit_conn *conn, struct iscsit_cmd *cmd,
...
int cxgbit_put_login_tx(struct iscsit_conn *conn, struct iscsi_login *login,
    u32 length) {
  struct cxgbit_sock *csk = conn->context;
  struct sk_buff *skb;
  u32 padding_buf = 0;
...
static void cxgbit_skb_copy_to_sg(struct sk_buff *skb, struct scatterlist *sg,
...
static int cxgbit_handle_immediate_data(struct iscsit_cmd *cmd,
...
static int cxgbit_get_immediate_data(struct iscsit_cmd *cmd,
    struct iscsi_scsi_req *hdr,
    bool dump_payload) {
  struct iscsit_conn *conn = cmd->conn;
...
static int cxgbit_handle_scsi_cmd(struct cxgbit_sock *csk,
    struct iscsit_cmd *cmd) {
  struct iscsit_conn *conn = csk->conn;
  struct cxgbit_lro_pdu_cb *pdu_cb = cxgbit_rx_pdu_cb(csk->skb);
...
static int cxgbit_handle_nop_out(struct cxgbit_sock *csk,
    struct iscsit_cmd *cmd) {
  struct iscsit_conn *conn = csk->conn;
  struct cxgbit_lro_pdu_cb *pdu_cb = cxgbit_rx_pdu_cb(csk->skb);
...
static int cxgbit_handle_text_cmd(struct cxgbit_sock *csk,
    struct iscsit_cmd *cmd) {
  struct iscsit_conn *conn = csk->conn;
  struct cxgbit_lro_pdu_cb *pdu_cb = cxgbit_rx_pdu_cb(csk->skb);
...
static void cxgbit_lro_skb_merge(struct cxgbit_sock *csk, struct sk_buff *skb,
    u8 pdu_idx) {
