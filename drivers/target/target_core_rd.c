...
static u32 rd_release_sgl_table(struct rd_dev *rd_dev,
 ...
 *
 */
static int rd_allocate_sgl_table(struct rd_dev *rd_dev,
    struct rd_dev_sg_table *sg_table,
...
static struct rd_dev_sg_table *rd_get_sg_table(struct rd_dev *rd_dev,
    u32 page) {
  struct rd_dev_sg_table *sg_table;
...
static sense_reason_t rd_execute_rw(struct se_cmd *cmd, struct scatterlist *sgl,
    u32 sgl_nents,
...
static sense_reason_t rd_parse_cdb(struct se_cmd *cmd) {
