...
static struct rapl_if_priv rapl_msr_priv_intel = {
  ...
  .regs[RAPL_DOMAIN_PACKAGE][RAPL_DOMAIN_REG_STATUS].msr
  ...
  .regs[RAPL_DOMAIN_PLATFORM][RAPL_DOMAIN_REG_LIMIT].msr
    = MSR_PLATFORM_POWER_LIMIT,
  .regs[RAPL_DOMAIN_PLATFORM][RAPL_DOMAIN_REG_STATUS].msr
...
static struct rapl_if_priv rapl_msr_priv_amd = {
  ...
  .regs[RAPL_DOMAIN_PP0][RAPL_DOMAIN_REG_STATUS].msr
