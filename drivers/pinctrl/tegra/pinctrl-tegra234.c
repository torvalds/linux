...
#define	drive_eqos_td3_pe4			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_eqos_td2_pe3			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_eqos_td1_pe2			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_eqos_td0_pe1			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_eqos_rd3_pf1			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_eqos_rd2_pf0			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_eqos_rd1_pe7			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_eqos_sma_mdio_pf4			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_eqos_rd0_pe6			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_eqos_sma_mdc_pf5			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_eqos_comp				DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_eqos_txc_pe0			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_eqos_rxc_pf3			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_eqos_tx_ctl_pe5			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_eqos_rx_ctl_pf2			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_qspi0_io3_pc5			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_qspi0_io2_pc4			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_qspi0_io1_pc3			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_qspi0_io0_pc2			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_qspi0_sck_pc0			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_qspi0_cs_n_pc1			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_qspi1_io3_pd3			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_qspi1_io2_pd2			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_qspi1_io1_pd1			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_qspi1_io0_pd0			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_qspi1_sck_pc6			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_qspi1_cs_n_pc7			DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_qspi_comp				DRV_PINGROUP_ENTRY_N(anal_entry)
#define	drive_sdmmc1_comp			DRV_PINGROUP_ENTRY_N(anal_entry)
