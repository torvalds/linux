...
#define drive_soc_gpio33_pt0            DRV_PINGROUP_ENTRY_Y(0x1004, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio32_ps7            DRV_PINGROUP_ENTRY_Y(0x100c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio31_ps6            DRV_PINGROUP_ENTRY_Y(0x1014, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio30_ps5            DRV_PINGROUP_ENTRY_Y(0x101c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_aud_mclk_ps4              DRV_PINGROUP_ENTRY_Y(0x1024, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_dap1_fs_ps3               DRV_PINGROUP_ENTRY_Y(0x102c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_dap1_din_ps2              DRV_PINGROUP_ENTRY_Y(0x1034, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_dap1_dout_ps1             DRV_PINGROUP_ENTRY_Y(0x103c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_dap1_sclk_ps0             DRV_PINGROUP_ENTRY_Y(0x1044, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_dap3_fs_pt4               DRV_PINGROUP_ENTRY_Y(0x104c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_dap3_din_pt3              DRV_PINGROUP_ENTRY_Y(0x1054, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_dap3_dout_pt2             DRV_PINGROUP_ENTRY_Y(0x105c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_dap3_sclk_pt1             DRV_PINGROUP_ENTRY_Y(0x1064, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_dap5_fs_pu0               DRV_PINGROUP_ENTRY_Y(0x106c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_dap5_din_pt7              DRV_PINGROUP_ENTRY_Y(0x1074, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_dap5_dout_pt6             DRV_PINGROUP_ENTRY_Y(0x107c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_dap5_sclk_pt5             DRV_PINGROUP_ENTRY_Y(0x1084, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_dap6_fs_pa3               DRV_PINGROUP_ENTRY_Y(0x2004, 28, 2, 30, \
    2, -1, -1, -1, -1, \
    0)
#define drive_dap6_din_pa2              DRV_PINGROUP_ENTRY_Y(0x200c, 28, 2, 30, \
    2, -1, -1, -1, -1, \
    0)
#define drive_dap6_dout_pa1             DRV_PINGROUP_ENTRY_Y(0x2014, 28, 2, 30, \
    2, -1, -1, -1, -1, \
    0)
#define drive_dap6_sclk_pa0             DRV_PINGROUP_ENTRY_Y(0x201c, 28, 2, 30, \
    2, -1, -1, -1, -1, \
    0)
#define drive_dap4_fs_pa7               DRV_PINGROUP_ENTRY_Y(0x2024, 28, 2, 30, \
    2, -1, -1, -1, -1, \
    0)
#define drive_dap4_din_pa6              DRV_PINGROUP_ENTRY_Y(0x202c, 28, 2, 30, \
    2, -1, -1, -1, -1, \
    0)
#define drive_dap4_dout_pa5             DRV_PINGROUP_ENTRY_Y(0x2034, 28, 2, 30, \
    2, -1, -1, -1, -1, \
    0)
#define drive_dap4_sclk_pa4             DRV_PINGROUP_ENTRY_Y(0x203c, 28, 2, 30, \
    2, -1, -1, -1, -1, \
    0)
#define drive_extperiph2_clk_pp1        DRV_PINGROUP_ENTRY_Y(0x0004, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_extperiph1_clk_pp0        DRV_PINGROUP_ENTRY_Y(0x000c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_cam_i2c_sda_pp3           DRV_PINGROUP_ENTRY_Y(0x0014, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_cam_i2c_scl_pp2           DRV_PINGROUP_ENTRY_Y(0x001c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio40_pq4            DRV_PINGROUP_ENTRY_Y(0x0024, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio41_pq5            DRV_PINGROUP_ENTRY_Y(0x002c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio42_pq6            DRV_PINGROUP_ENTRY_Y(0x0034, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio43_pq7            DRV_PINGROUP_ENTRY_Y(0x003c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio44_pr0            DRV_PINGROUP_ENTRY_Y(0x0044, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio45_pr1            DRV_PINGROUP_ENTRY_Y(0x004c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio20_pq0            DRV_PINGROUP_ENTRY_Y(0x0054, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio21_pq1            DRV_PINGROUP_ENTRY_Y(0x005c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio22_pq2            DRV_PINGROUP_ENTRY_Y(0x0064, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio23_pq3            DRV_PINGROUP_ENTRY_Y(0x006c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio04_pp4            DRV_PINGROUP_ENTRY_Y(0x0074, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio05_pp5            DRV_PINGROUP_ENTRY_Y(0x007c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio06_pp6            DRV_PINGROUP_ENTRY_Y(0x0084, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio07_pp7            DRV_PINGROUP_ENTRY_Y(0x008c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_uart1_cts_pr5             DRV_PINGROUP_ENTRY_Y(0x0094, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_uart1_rts_pr4             DRV_PINGROUP_ENTRY_Y(0x009c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_uart1_rx_pr3              DRV_PINGROUP_ENTRY_Y(0x00a4, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_uart1_tx_pr2              DRV_PINGROUP_ENTRY_Y(0x00ac, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_dap2_din_pi1              DRV_PINGROUP_ENTRY_Y(0x4004, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_dap2_dout_pi0             DRV_PINGROUP_ENTRY_Y(0x400c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_dap2_fs_pi2               DRV_PINGROUP_ENTRY_Y(0x4014, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_dap2_sclk_ph7             DRV_PINGROUP_ENTRY_Y(0x401c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_uart4_cts_ph6             DRV_PINGROUP_ENTRY_Y(0x4024, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_uart4_rts_ph5             DRV_PINGROUP_ENTRY_Y(0x402c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_uart4_rx_ph4              DRV_PINGROUP_ENTRY_Y(0x4034, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_uart4_tx_ph3              DRV_PINGROUP_ENTRY_Y(0x403c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio03_pg3            DRV_PINGROUP_ENTRY_Y(0x4044, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio02_pg2            DRV_PINGROUP_ENTRY_Y(0x404c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio01_pg1            DRV_PINGROUP_ENTRY_Y(0x4054, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio00_pg0            DRV_PINGROUP_ENTRY_Y(0x405c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_gen1_i2c_scl_pi3          DRV_PINGROUP_ENTRY_Y(0x4064, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_gen1_i2c_sda_pi4          DRV_PINGROUP_ENTRY_Y(0x406c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio08_pg4            DRV_PINGROUP_ENTRY_Y(0x4074, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio09_pg5            DRV_PINGROUP_ENTRY_Y(0x407c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio10_pg6            DRV_PINGROUP_ENTRY_Y(0x4084, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio11_pg7            DRV_PINGROUP_ENTRY_Y(0x408c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio12_ph0            DRV_PINGROUP_ENTRY_Y(0x4094, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio13_ph1            DRV_PINGROUP_ENTRY_Y(0x409c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio14_ph2            DRV_PINGROUP_ENTRY_Y(0x40a4, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio50_pm5            DRV_PINGROUP_ENTRY_Y(0x10004, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio51_pm6            DRV_PINGROUP_ENTRY_Y(0x1000c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio52_pm7            DRV_PINGROUP_ENTRY_Y(0x10014, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio53_pn0            DRV_PINGROUP_ENTRY_Y(0x1001c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio54_pn1            DRV_PINGROUP_ENTRY_Y(0x10024, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_gpio55_pn2            DRV_PINGROUP_ENTRY_Y(0x1002c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_dp_aux_ch0_hpd_pm0        DRV_PINGROUP_ENTRY_Y(0x10034, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_dp_aux_ch1_hpd_pm1        DRV_PINGROUP_ENTRY_Y(0x1003c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_dp_aux_ch2_hpd_pm2        DRV_PINGROUP_ENTRY_Y(0x10044, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_dp_aux_ch3_hpd_pm3        DRV_PINGROUP_ENTRY_Y(0x1004c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_hdmi_cec_pm4              DRV_PINGROUP_ENTRY_Y(0x10054, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_pex_l2_clkreq_n_pk4       DRV_PINGROUP_ENTRY_Y(0x7004, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_pex_wake_n_pl2            DRV_PINGROUP_ENTRY_Y(0x700c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_pex_l1_clkreq_n_pk2       DRV_PINGROUP_ENTRY_Y(0x7014, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_pex_l1_rst_n_pk3          DRV_PINGROUP_ENTRY_Y(0x701c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_pex_l0_clkreq_n_pk0       DRV_PINGROUP_ENTRY_Y(0x7024, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_pex_l0_rst_n_pk1          DRV_PINGROUP_ENTRY_Y(0x702c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_pex_l2_rst_n_pk5          DRV_PINGROUP_ENTRY_Y(0x7034, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_pex_l3_clkreq_n_pk6       DRV_PINGROUP_ENTRY_Y(0x703c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_pex_l3_rst_n_pk7          DRV_PINGROUP_ENTRY_Y(0x7044, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_pex_l4_clkreq_n_pl0       DRV_PINGROUP_ENTRY_Y(0x704c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_pex_l4_rst_n_pl1          DRV_PINGROUP_ENTRY_Y(0x7054, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_sata_dev_slp_pl3          DRV_PINGROUP_ENTRY_Y(0x705c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_pex_l5_clkreq_n_pgg0      DRV_PINGROUP_ENTRY_Y(0x14004, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_pex_l5_rst_n_pgg1         DRV_PINGROUP_ENTRY_Y(0x1400c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_cpu_pwr_req_1_pb1         DRV_PINGROUP_ENTRY_Y(0x16004, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_cpu_pwr_req_0_pb0         DRV_PINGROUP_ENTRY_Y(0x1600c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_sdmmc1_clk_pj0            DRV_PINGROUP_ENTRY_Y(0x8004, -1, -1, -1, \
    -1, 28, 2, 30, 2,  \
    0)
#define drive_sdmmc1_cmd_pj1            DRV_PINGROUP_ENTRY_Y(0x800c, -1, -1, -1, \
    -1, 28, 2, 30, 2,  \
    0)
#define drive_sdmmc1_dat3_pj5           DRV_PINGROUP_ENTRY_Y(0x801c, -1, -1, -1, \
    -1, 28, 2, 30, 2,  \
    0)
#define drive_sdmmc1_dat2_pj4           DRV_PINGROUP_ENTRY_Y(0x8024, -1, -1, -1, \
    -1, 28, 2, 30, 2,  \
    0)
#define drive_sdmmc1_dat1_pj3           DRV_PINGROUP_ENTRY_Y(0x802c, -1, -1, -1, \
    -1, 28, 2, 30, 2,  \
    0)
#define drive_sdmmc1_dat0_pj2           DRV_PINGROUP_ENTRY_Y(0x8034, -1, -1, -1, \
    -1, 28, 2, 30, 2,  \
    0)
#define drive_sdmmc3_dat3_po5           DRV_PINGROUP_ENTRY_Y(0xa004, -1, -1, -1, \
    -1, 28, 2, 30, 2,  \
    0)
#define drive_sdmmc3_dat2_po4           DRV_PINGROUP_ENTRY_Y(0xa00c, -1, -1, -1, \
    -1, 28, 2, 30, 2,  \
    0)
#define drive_sdmmc3_dat1_po3           DRV_PINGROUP_ENTRY_Y(0xa014, -1, -1, -1, \
    -1, 28, 2, 30, 2,  \
    0)
#define drive_sdmmc3_dat0_po2           DRV_PINGROUP_ENTRY_Y(0xa01c, -1, -1, -1, \
    -1, 28, 2, 30, 2,  \
    0)
#define drive_sdmmc3_cmd_po1            DRV_PINGROUP_ENTRY_Y(0xa02c, -1, -1, -1, \
    -1, 28, 2, 30, 2,  \
    0)
#define drive_sdmmc3_clk_po0            DRV_PINGROUP_ENTRY_Y(0xa034, -1, -1, -1, \
    -1, 28, 2, 30, 2,  \
    0)
#define drive_gpu_pwr_req_px0           DRV_PINGROUP_ENTRY_Y(0xD004, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_spi3_miso_py1             DRV_PINGROUP_ENTRY_Y(0xD00c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_spi1_cs0_pz6              DRV_PINGROUP_ENTRY_Y(0xD014, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_spi3_cs0_py3              DRV_PINGROUP_ENTRY_Y(0xD01c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_spi1_miso_pz4             DRV_PINGROUP_ENTRY_Y(0xD024, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_spi3_cs1_py4              DRV_PINGROUP_ENTRY_Y(0xD02c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_gp_pwm3_px3               DRV_PINGROUP_ENTRY_Y(0xD034, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_gp_pwm2_px2               DRV_PINGROUP_ENTRY_Y(0xD03c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_spi1_sck_pz3              DRV_PINGROUP_ENTRY_Y(0xD044, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_spi3_sck_py0              DRV_PINGROUP_ENTRY_Y(0xD04c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_spi1_cs1_pz7              DRV_PINGROUP_ENTRY_Y(0xD054, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_spi1_mosi_pz5             DRV_PINGROUP_ENTRY_Y(0xD05c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_spi3_mosi_py2             DRV_PINGROUP_ENTRY_Y(0xD064, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_cv_pwr_req_px1            DRV_PINGROUP_ENTRY_Y(0xD06c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_uart2_tx_px4              DRV_PINGROUP_ENTRY_Y(0xD074, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_uart2_rx_px5              DRV_PINGROUP_ENTRY_Y(0xD07c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_uart2_rts_px6             DRV_PINGROUP_ENTRY_Y(0xD084, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_uart2_cts_px7             DRV_PINGROUP_ENTRY_Y(0xD08c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_uart5_rx_py6              DRV_PINGROUP_ENTRY_Y(0xD094, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_uart5_tx_py5              DRV_PINGROUP_ENTRY_Y(0xD09c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_uart5_rts_py7             DRV_PINGROUP_ENTRY_Y(0xD0a4, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_uart5_cts_pz0             DRV_PINGROUP_ENTRY_Y(0xD0ac, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_usb_vbus_en0_pz1          DRV_PINGROUP_ENTRY_Y(0xD0b4, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_usb_vbus_en1_pz2          DRV_PINGROUP_ENTRY_Y(0xD0bc, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_ufs0_rst_pff1             DRV_PINGROUP_ENTRY_Y(0x11004, 12, 9, 24, \
    8, -1, -1, -1, -1, \
    0)
#define drive_ufs0_ref_clk_pff0         DRV_PINGROUP_ENTRY_Y(0x1100c, 12, 9, 24, \
    8, -1, -1, -1, -1, \
    0)
...
#define drive_shutdown_n                DRV_PINGROUP_ENTRY_Y(0x1004, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_pmu_int_n                 DRV_PINGROUP_ENTRY_Y(0x100c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_safe_state_pee0           DRV_PINGROUP_ENTRY_Y(0x1014, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_vcomp_alert_pee1          DRV_PINGROUP_ENTRY_Y(0x101c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_soc_pwr_req               DRV_PINGROUP_ENTRY_Y(0x1024, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_batt_oc_pee3              DRV_PINGROUP_ENTRY_Y(0x102c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_clk_32k_in                DRV_PINGROUP_ENTRY_Y(0x1034, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_power_on_pee4             DRV_PINGROUP_ENTRY_Y(0x103c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_pwr_i2c_scl_pee5          DRV_PINGROUP_ENTRY_Y(0x1044, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_pwr_i2c_sda_pee6          DRV_PINGROUP_ENTRY_Y(0x104c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_ao_retention_n_pee2       DRV_PINGROUP_ENTRY_Y(0x1064, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_touch_clk_pcc4            DRV_PINGROUP_ENTRY_Y(0x2004, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_uart3_rx_pcc6             DRV_PINGROUP_ENTRY_Y(0x200c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_uart3_tx_pcc5             DRV_PINGROUP_ENTRY_Y(0x2014, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_gen8_i2c_sda_pdd2         DRV_PINGROUP_ENTRY_Y(0x201c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_gen8_i2c_scl_pdd1         DRV_PINGROUP_ENTRY_Y(0x2024, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_spi2_mosi_pcc2            DRV_PINGROUP_ENTRY_Y(0x202c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_gen2_i2c_scl_pcc7         DRV_PINGROUP_ENTRY_Y(0x2034, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_spi2_cs0_pcc3             DRV_PINGROUP_ENTRY_Y(0x203c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_gen2_i2c_sda_pdd0         DRV_PINGROUP_ENTRY_Y(0x2044, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_spi2_sck_pcc0             DRV_PINGROUP_ENTRY_Y(0x204c, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_spi2_miso_pcc1            DRV_PINGROUP_ENTRY_Y(0x2054, 12, 5, 20, \
    5, -1, -1, -1, -1, \
    0)
#define drive_can1_dout_paa0            DRV_PINGROUP_ENTRY_Y(0x3004, 28, 2, 30, \
    2, -1, -1, -1, -1, \
    0)
#define drive_can1_din_paa1             DRV_PINGROUP_ENTRY_Y(0x300c, 28, 2, 30, \
    2, -1, -1, -1, -1, \
    0)
#define drive_can0_dout_paa2            DRV_PINGROUP_ENTRY_Y(0x3014, 28, 2, 30, \
    2, -1, -1, -1, -1, \
    0)
#define drive_can0_din_paa3             DRV_PINGROUP_ENTRY_Y(0x301c, 28, 2, 30, \
    2, -1, -1, -1, -1, \
    0)
#define drive_can0_stb_paa4             DRV_PINGROUP_ENTRY_Y(0x3024, 28, 2, 30, \
    2, -1, -1, -1, -1, \
    0)
#define drive_can0_en_paa5              DRV_PINGROUP_ENTRY_Y(0x302c, 28, 2, 30, \
    2, -1, -1, -1, -1, \
    0)
#define drive_can0_wake_paa6            DRV_PINGROUP_ENTRY_Y(0x3034, 28, 2, 30, \
    2, -1, -1, -1, -1, \
    0)
#define drive_can0_err_paa7             DRV_PINGROUP_ENTRY_Y(0x303c, 28, 2, 30, \
    2, -1, -1, -1, -1, \
    0)
#define drive_can1_stb_pbb0             DRV_PINGROUP_ENTRY_Y(0x3044, 28, 2, 30, \
    2, -1, -1, -1, -1, \
    0)
#define drive_can1_en_pbb1              DRV_PINGROUP_ENTRY_Y(0x304c, 28, 2, 30, \
    2, -1, -1, -1, -1, \
    0)
#define drive_can1_wake_pbb2            DRV_PINGROUP_ENTRY_Y(0x3054, 28, 2, 30, \
    2, -1, -1, -1, -1, \
    0)
#define drive_can1_err_pbb3             DRV_PINGROUP_ENTRY_Y(0x305c, 28, 2, 30, \
    2, -1, -1, -1, -1, \
    0)
...
static const struct tegra_pingroup tegra194_groups[] = {
  PINGROUP(soc_gpio33_pt0, RSVD0, SPDIF, RSVD2, RSVD3, 0x1000, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_audio"),
  PINGROUP(soc_gpio32_ps7, RSVD0, SPDIF, RSVD2, RSVD3, 0x1008, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_audio"),
  PINGROUP(soc_gpio31_ps6, RSVD0, SDMMC1, RSVD2, RSVD3, 0x1010, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_audio"),
  PINGROUP(soc_gpio30_ps5, RSVD0, RSVD1, RSVD2, RSVD3, 0x1018, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_audio"),
  PINGROUP(aud_mclk_ps4, AUD, RSVD1, RSVD2, RSVD3, 0x1020, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_audio"),
  PINGROUP(dap1_fs_ps3, I2S1, RSVD1, RSVD2, RSVD3, 0x1028, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_audio"),
  PINGROUP(dap1_din_ps2, I2S1, RSVD1, RSVD2, RSVD3, 0x1030, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_audio"),
  PINGROUP(dap1_dout_ps1, I2S1, RSVD1, RSVD2, RSVD3, 0x1038, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_audio"),
  PINGROUP(dap1_sclk_ps0, I2S1, RSVD1, RSVD2, RSVD3, 0x1040, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_audio"),
  PINGROUP(dap3_fs_pt4, I2S3, DMIC2, RSVD2, RSVD3, 0x1048, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_audio"),
  PINGROUP(dap3_din_pt3, I2S3, DMIC2, RSVD2, RSVD3, 0x1050, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_audio"),
  PINGROUP(dap3_dout_pt2, I2S3, DMIC1, RSVD2, RSVD3, 0x1058, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_audio"),
  PINGROUP(dap3_sclk_pt1, I2S3, DMIC1, RSVD2, RSVD3, 0x1060, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_audio"),
  PINGROUP(dap5_fs_pu0, I2S5, DMIC4, DSPK1, RSVD3, 0x1068, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_audio"),
  PINGROUP(dap5_din_pt7, I2S5, DMIC4, DSPK1, RSVD3, 0x1070, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_audio"),
  PINGROUP(dap5_dout_pt6, I2S5, DSPK0, RSVD2, RSVD3, 0x1078, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_audio"),
  PINGROUP(dap5_sclk_pt5, I2S5, DSPK0, RSVD2, RSVD3, 0x1080, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_audio"),
  PINGROUP(dap6_fs_pa3, I2S6, IQC1, RSVD2, RSVD3, 0x2000, 0, Y, -1, -1, 6, -1,
      9, 10, -1, 12, Y, -1, -1, Y, "vddio_audio_hv"),
  PINGROUP(dap6_din_pa2, I2S6, IQC1, RSVD2, RSVD3, 0x2008, 0, Y, -1, -1, 6, -1,
      9, 10, -1, 12, Y, -1, -1, Y, "vddio_audio_hv"),
  PINGROUP(dap6_dout_pa1, I2S6, IQC1, RSVD2, RSVD3, 0x2010, 0, Y, -1, -1, 6, -1,
      9, 10, -1, 12, Y, -1, -1, Y, "vddio_audio_hv"),
  PINGROUP(dap6_sclk_pa0, I2S6, IQC1, RSVD2, RSVD3, 0x2018, 0, Y, -1, -1, 6, -1,
      9, 10, -1, 12, Y, -1, -1, Y, "vddio_audio_hv"),
  PINGROUP(dap4_fs_pa7, I2S4, IQC2, RSVD2, RSVD3, 0x2020, 0, Y, -1, -1, 6, -1,
      9, 10, -1, 12, Y, -1, -1, Y, "vddio_audio_hv"),
  PINGROUP(dap4_din_pa6, I2S4, IQC2, RSVD2, RSVD3, 0x2028, 0, Y, -1, -1, 6, -1,
      9, 10, -1, 12, Y, -1, -1, Y, "vddio_audio_hv"),
  PINGROUP(dap4_dout_pa5, I2S4, IQC2, RSVD2, RSVD3, 0x2030, 0, Y, -1, -1, 6, -1,
      9, 10, -1, 12, Y, -1, -1, Y, "vddio_audio_hv"),
  PINGROUP(dap4_sclk_pa4, I2S4, IQC2, RSVD2, RSVD3, 0x2038, 0, Y, -1, -1, 6, -1,
      9, 10, -1, 12, Y, -1, -1, Y, "vddio_audio_hv"),
  PINGROUP(extperiph2_clk_pp1, EXTPERIPH2, RSVD1, RSVD2, RSVD3, 0x0000, 0, Y,
      -1, -1, 6, 8, -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(extperiph1_clk_pp0, EXTPERIPH1, RSVD1, RSVD2, RSVD3, 0x0008, 0, Y,
      -1, -1, 6, 8, -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(cam_i2c_sda_pp3, I2C3, RSVD1, RSVD2, RSVD3, 0x0010, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(cam_i2c_scl_pp2, I2C3, RSVD1, RSVD2, RSVD3, 0x0018, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(soc_gpio40_pq4, VGP1, SLVS, RSVD2, RSVD3, 0x0020, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(soc_gpio41_pq5, VGP2, EXTPERIPH3, RSVD2, RSVD3, 0x0028, 0, Y, 5, -1,
      6, 8, -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(soc_gpio42_pq6, VGP3, EXTPERIPH4, RSVD2, RSVD3, 0x0030, 0, Y, 5, -1,
      6, 8, -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(soc_gpio43_pq7, VGP4, SLVS, RSVD2, RSVD3, 0x0038, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(soc_gpio44_pr0, VGP5, GP, RSVD2, RSVD3, 0x0040, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(soc_gpio45_pr1, VGP6, RSVD1, RSVD2, RSVD3, 0x0048, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(soc_gpio20_pq0, RSVD0, RSVD1, RSVD2, RSVD3, 0x0050, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(soc_gpio21_pq1, RSVD0, RSVD1, RSVD2, RSVD3, 0x0058, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(soc_gpio22_pq2, RSVD0, NV, RSVD2, RSVD3, 0x0060, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(soc_gpio23_pq3, RSVD0, WDT, RSVD2, RSVD3, 0x0068, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(soc_gpio04_pp4, RSVD0, RSVD1, RSVD2, RSVD3, 0x0070, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(soc_gpio05_pp5, RSVD0, IGPU, RSVD2, RSVD3, 0x0078, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(soc_gpio06_pp6, RSVD0, RSVD1, RSVD2, RSVD3, 0x0080, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(soc_gpio07_pp7, RSVD0, SATA, SOC, RSVD3, 0x0088, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(uart1_cts_pr5, UARTA, RSVD1, RSVD2, RSVD3, 0x0090, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(uart1_rts_pr4, UARTA, RSVD1, RSVD2, RSVD3, 0x0098, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(uart1_rx_pr3, UARTA, RSVD1, RSVD2, RSVD3, 0x00a0, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(uart1_tx_pr2, UARTA, RSVD1, RSVD2, RSVD3, 0x00a8, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_cam"),
  PINGROUP(dap2_din_pi1, I2S2, RSVD1, RSVD2, RSVD3, 0x4000, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_conn"),
  PINGROUP(dap2_dout_pi0, I2S2, RSVD1, RSVD2, RSVD3, 0x4008, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_conn"),
  PINGROUP(dap2_fs_pi2, I2S2, RSVD1, RSVD2, RSVD3, 0x4010, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_conn"),
  PINGROUP(dap2_sclk_ph7, I2S2, RSVD1, RSVD2, RSVD3, 0x4018, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_conn"),
  PINGROUP(uart4_cts_ph6, UARTD, RSVD1, RSVD2, RSVD3, 0x4020, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_conn"),
  PINGROUP(uart4_rts_ph5, UARTD, RSVD1, RSVD2, RSVD3, 0x4028, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_conn"),
  PINGROUP(uart4_rx_ph4, UARTD, RSVD1, RSVD2, RSVD3, 0x4030, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_conn"),
  PINGROUP(uart4_tx_ph3, UARTD, RSVD1, RSVD2, RSVD3, 0x4038, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_conn"),
  PINGROUP(soc_gpio03_pg3, RSVD0, RSVD1, RSVD2, RSVD3, 0x4040, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_conn"),
  PINGROUP(soc_gpio02_pg2, RSVD0, RSVD1, RSVD2, RSVD3, 0x4048, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_conn"),
  PINGROUP(soc_gpio01_pg1, RSVD0, RSVD1, RSVD2, RSVD3, 0x4050, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_conn"),
  PINGROUP(soc_gpio00_pg0, RSVD0, RSVD1, RSVD2, RSVD3, 0x4058, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_conn"),
  PINGROUP(gen1_i2c_scl_pi3, I2C1, RSVD1, RSVD2, RSVD3, 0x4060, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_conn"),
  PINGROUP(gen1_i2c_sda_pi4, I2C1, RSVD1, RSVD2, RSVD3, 0x4068, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_conn"),
  PINGROUP(soc_gpio08_pg4, RSVD0, CCLA, RSVD2, RSVD3, 0x4070, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_conn"),
  PINGROUP(soc_gpio09_pg5, RSVD0, RSVD1, RSVD2, RSVD3, 0x4078, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_conn"),
  PINGROUP(soc_gpio10_pg6, GP, RSVD1, RSVD2, RSVD3, 0x4080, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_conn"),
  PINGROUP(soc_gpio11_pg7, RSVD0, SDMMC1, RSVD2, RSVD3, 0x4088, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_conn"),
  PINGROUP(soc_gpio12_ph0, RSVD0, GP, RSVD2, RSVD3, 0x4090, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_conn"),
  PINGROUP(soc_gpio13_ph1, RSVD0, GP, RSVD2, RSVD3, 0x4098, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_conn"),
  PINGROUP(soc_gpio14_ph2, RSVD0, SDMMC1, RSVD2, RSVD3, 0x40a0, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_conn"),
  PINGROUP(directdc1_out7_pw1, DIRECTDC1, RSVD1, RSVD2, RSVD3, 0x5008, 0, Y, -1,
      -1, 6, -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_debug"),
  PINGROUP(directdc1_out6_pw0, DIRECTDC1, RSVD1, RSVD2, RSVD3, 0x5010, 0, Y, -1,
      -1, 6, -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_debug"),
  PINGROUP(directdc1_out5_pv7, DIRECTDC1, RSVD1, RSVD2, RSVD3, 0x5018, 0, Y, -1,
      -1, 6, -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_debug"),
  PINGROUP(directdc1_out4_pv6, DIRECTDC1, RSVD1, RSVD2, RSVD3, 0x5020, 0, Y, -1,
      -1, 6, -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_debug"),
  PINGROUP(directdc1_out3_pv5, DIRECTDC1, RSVD1, RSVD2, RSVD3, 0x5028, 0, Y, -1,
      -1, 6, -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_debug"),
  PINGROUP(directdc1_out2_pv4, DIRECTDC1, RSVD1, RSVD2, RSVD3, 0x5030, 0, Y, -1,
      -1, 6, -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_debug"),
  PINGROUP(directdc1_out1_pv3, DIRECTDC1, RSVD1, RSVD2, RSVD3, 0x5038, 0, Y, -1,
      -1, 6, -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_debug"),
  PINGROUP(directdc1_out0_pv2, DIRECTDC1, RSVD1, RSVD2, RSVD3, 0x5040, 0, Y, -1,
      -1, 6, -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_debug"),
  PINGROUP(directdc1_in_pv1, DIRECTDC1, RSVD1, RSVD2, RSVD3, 0x5048, 0, Y, -1,
      -1, 6, -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_debug"),
  PINGROUP(directdc1_clk_pv0, DIRECTDC1, RSVD1, RSVD2, RSVD3, 0x5050, 0, Y, -1,
      -1, 6, -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_debug"),
  PINGROUP(directdc_comp, DIRECTDC, RSVD1, RSVD2, RSVD3, 0x5058, 0, N, -1, -1,
      -1, -1, -1, -1, -1, -1, Y, -1, -1, Y, "vddio_debug"),
  PINGROUP(soc_gpio50_pm5, RSVD0, DCA, RSVD2, RSVD3, 0x10000, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_edp"),
  PINGROUP(soc_gpio51_pm6, RSVD0, DCA, RSVD2, RSVD3, 0x10008, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_edp"),
  PINGROUP(soc_gpio52_pm7, RSVD0, DCB, DGPU, RSVD3, 0x10010, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_edp"),
  PINGROUP(soc_gpio53_pn0, RSVD0, DCB, RSVD2, RSVD3, 0x10018, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_edp"),
  PINGROUP(soc_gpio54_pn1, RSVD0, SDMMC3, GP, RSVD3, 0x10020, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_edp"),
  PINGROUP(soc_gpio55_pn2, RSVD0, SDMMC3, RSVD2, RSVD3, 0x10028, 0, Y, -1, -1,
      6, 8, -1, 10, 11, 12, N, -1, -1, N, "vddio_edp"),
  PINGROUP(dp_aux_ch0_hpd_pm0, DP, RSVD1, RSVD2, RSVD3, 0x10030, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_edp"),
  PINGROUP(dp_aux_ch1_hpd_pm1, DP, RSVD1, RSVD2, RSVD3, 0x10038, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_edp"),
  PINGROUP(dp_aux_ch2_hpd_pm2, DP, DISPLAYA, RSVD2, RSVD3, 0x10040, 0, Y, 5, -1,
      6, 8, -1, 10, 11, 12, N, -1, -1, N, "vddio_edp"),
  PINGROUP(dp_aux_ch3_hpd_pm3, DP, DISPLAYB, RSVD2, RSVD3, 0x10048, 0, Y, 5, -1,
      6, 8, -1, 10, 11, 12, N, -1, -1, N, "vddio_edp"),
  PINGROUP(hdmi_cec_pm4, HDMI, RSVD1, RSVD2, RSVD3, 0x10050, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_edp"),
  PINGROUP(eqos_td3_pe4, EQOS, RSVD1, RSVD2, RSVD3, 0x15000, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_eqos"),
  PINGROUP(eqos_td2_pe3, EQOS, RSVD1, RSVD2, RSVD3, 0x15008, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_eqos"),
  PINGROUP(eqos_td1_pe2, EQOS, RSVD1, RSVD2, RSVD3, 0x15010, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_eqos"),
  PINGROUP(eqos_td0_pe1, EQOS, RSVD1, RSVD2, RSVD3, 0x15018, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_eqos"),
  PINGROUP(eqos_rd3_pf1, EQOS, RSVD1, RSVD2, RSVD3, 0x15020, 0, Y, -1, 5, 6, -1,
      9, 10, -1, 12, Y, 15, 17, Y, "vddio_eqos"),
  PINGROUP(eqos_rd2_pf0, EQOS, RSVD1, RSVD2, RSVD3, 0x15028, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_eqos"),
  PINGROUP(eqos_rd1_pe7, EQOS, RSVD1, RSVD2, RSVD3, 0x15030, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_eqos"),
  PINGROUP(eqos_sma_mdio_pf4, EQOS, RSVD1, RSVD2, RSVD3, 0x15038, 0, Y, -1, -1,
      6, -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_eqos"),
  PINGROUP(eqos_rd0_pe6, EQOS, RSVD1, RSVD2, RSVD3, 0x15040, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_eqos"),
  PINGROUP(eqos_sma_mdc_pf5, EQOS, RSVD1, RSVD2, RSVD3, 0x15048, 0, Y, -1, -1,
      6, -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_eqos"),
  PINGROUP(eqos_comp, EQOS, RSVD1, RSVD2, RSVD3, 0x15050, 0, N, -1, -1, -1, -1,
      -1, -1, -1, -1, Y, -1, -1, Y, "vddio_eqos"),
  PINGROUP(eqos_txc_pe0, EQOS, RSVD1, RSVD2, RSVD3, 0x15058, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_eqos"),
  PINGROUP(eqos_rxc_pf3, EQOS, RSVD1, RSVD2, RSVD3, 0x15060, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_eqos"),
  PINGROUP(eqos_tx_ctl_pe5, EQOS, RSVD1, RSVD2, RSVD3, 0x15068, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_eqos"),
  PINGROUP(eqos_rx_ctl_pf2, EQOS, RSVD1, RSVD2, RSVD3, 0x15070, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_eqos"),
  PINGROUP(pex_l2_clkreq_n_pk4, PE2, RSVD1, RSVD2, RSVD3, 0x7000, 0, Y, 5, -1,
      6, 8, -1, 10, 11, 12, N, -1, -1, N, "vddio_pex_ctl"),
  PINGROUP(pex_wake_n_pl2, RSVD0, RSVD1, RSVD2, RSVD3, 0x7008, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_pex_ctl"),
  PINGROUP(pex_l1_clkreq_n_pk2, PE1, RSVD1, RSVD2, RSVD3, 0x7010, 0, Y, 5, -1,
      6, 8, -1, 10, 11, 12, N, -1, -1, N, "vddio_pex_ctl"),
  PINGROUP(pex_l1_rst_n_pk3, PE1, RSVD1, RSVD2, RSVD3, 0x7018, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_pex_ctl"),
  PINGROUP(pex_l0_clkreq_n_pk0, PE0, RSVD1, RSVD2, RSVD3, 0x7020, 0, Y, 5, -1,
      6, 8, -1, 10, 11, 12, N, -1, -1, N, "vddio_pex_ctl"),
  PINGROUP(pex_l0_rst_n_pk1, PE0, RSVD1, RSVD2, RSVD3, 0x7028, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_pex_ctl"),
  PINGROUP(pex_l2_rst_n_pk5, PE2, RSVD1, RSVD2, RSVD3, 0x7030, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_pex_ctl"),
  PINGROUP(pex_l3_clkreq_n_pk6, PE3, RSVD1, RSVD2, RSVD3, 0x7038, 0, Y, 5, -1,
      6, 8, -1, 10, 11, 12, N, -1, -1, N, "vddio_pex_ctl"),
  PINGROUP(pex_l3_rst_n_pk7, PE3, RSVD1, RSVD2, RSVD3, 0x7040, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_pex_ctl"),
  PINGROUP(pex_l4_clkreq_n_pl0, PE4, RSVD1, RSVD2, RSVD3, 0x7048, 0, Y, 5, -1,
      6, 8, -1, 10, 11, 12, N, -1, -1, N, "vddio_pex_ctl"),
  PINGROUP(pex_l4_rst_n_pl1, PE4, RSVD1, RSVD2, RSVD3, 0x7050, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_pex_ctl"),
  PINGROUP(sata_dev_slp_pl3, SATA, RSVD1, RSVD2, RSVD3, 0x7058, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_pex_ctl"),
  PINGROUP(pex_l5_clkreq_n_pgg0, PE5, RSVD1, RSVD2, RSVD3, 0x14000, 0, Y, 5, -1,
      6, 8, -1, 10, 11, 12, N, -1, -1, N, "vddio_pex_ctl_2"),
  PINGROUP(pex_l5_rst_n_pgg1, PE5, RSVD1, RSVD2, RSVD3, 0x14008, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_pex_ctl_2"),
  PINGROUP(cpu_pwr_req_1_pb1, RSVD0, RSVD1, RSVD2, RSVD3, 0x16000, 0, Y, -1, -1,
      6, 8, -1, 10, 11, 12, N, -1, -1, N, "vddio_pwr_ctl"),
  PINGROUP(cpu_pwr_req_0_pb0, RSVD0, RSVD1, RSVD2, RSVD3, 0x16008, 0, Y, -1, -1,
      6, 8, -1, 10, 11, 12, N, -1, -1, N, "vddio_pwr_ctl"),
  PINGROUP(qspi0_io3_pc5, QSPI0, RSVD1, RSVD2, RSVD3, 0xB000, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_qspi"),
  PINGROUP(qspi0_io2_pc4, QSPI0, RSVD1, RSVD2, RSVD3, 0xB008, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_qspi"),
  PINGROUP(qspi0_io1_pc3, QSPI0, RSVD1, RSVD2, RSVD3, 0xB010, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_qspi"),
  PINGROUP(qspi0_io0_pc2, QSPI0, RSVD1, RSVD2, RSVD3, 0xB018, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_qspi"),
  PINGROUP(qspi0_sck_pc0, QSPI0, RSVD1, RSVD2, RSVD3, 0xB020, 0, Y, -1, 5, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_qspi"),
  PINGROUP(qspi0_cs_n_pc1, QSPI0, RSVD1, RSVD2, RSVD3, 0xB028, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_qspi"),
  PINGROUP(qspi1_io3_pd3, QSPI1, RSVD1, RSVD2, RSVD3, 0xB030, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_qspi"),
  PINGROUP(qspi1_io2_pd2, QSPI1, RSVD1, RSVD2, RSVD3, 0xB038, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_qspi"),
  PINGROUP(qspi1_io1_pd1, QSPI1, RSVD1, RSVD2, RSVD3, 0xB040, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_qspi"),
  PINGROUP(qspi1_io0_pd0, QSPI1, RSVD1, RSVD2, RSVD3, 0xB048, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_qspi"),
  PINGROUP(qspi1_sck_pc6, QSPI1, RSVD1, RSVD2, RSVD3, 0xB050, 0, Y, -1, 5, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_qspi"),
  PINGROUP(qspi1_cs_n_pc7, QSPI1, RSVD1, RSVD2, RSVD3, 0xB058, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_qspi"),
  PINGROUP(qspi_comp, QSPI, RSVD1, RSVD2, RSVD3, 0xB060, 0, N, -1, -1, -1, -1,
      -1, -1, -1, -1, Y, -1, -1, Y, "vddio_qspi"),
  PINGROUP(sdmmc1_clk_pj0, SDMMC1, RSVD1, MIPI, RSVD3, 0x8000, 0, Y, -1, 5, 6,
      -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_sdmmc1_hv"),
  PINGROUP(sdmmc1_cmd_pj1, SDMMC1, RSVD1, MIPI, RSVD3, 0x8008, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_sdmmc1_hv"),
  PINGROUP(sdmmc1_comp, SDMMC1, RSVD1, RSVD2, RSVD3, 0x8010, 0, N, -1, -1, -1,
      -1, -1, -1, -1, -1, N, -1, -1, N, "vddio_sdmmc1_hv"),
  PINGROUP(sdmmc1_dat3_pj5, SDMMC1, RSVD1, MIPI, RSVD3, 0x8018, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_sdmmc1_hv"),
  PINGROUP(sdmmc1_dat2_pj4, SDMMC1, RSVD1, MIPI, RSVD3, 0x8020, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_sdmmc1_hv"),
  PINGROUP(sdmmc1_dat1_pj3, SDMMC1, RSVD1, MIPI, RSVD3, 0x8028, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_sdmmc1_hv"),
  PINGROUP(sdmmc1_dat0_pj2, SDMMC1, RSVD1, MIPI, RSVD3, 0x8030, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_sdmmc1_hv"),
  PINGROUP(sdmmc3_dat3_po5, SDMMC3, RSVD1, RSVD2, RSVD3, 0xA000, 0, Y, -1, -1,
      6, -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_sdmmc3_hv"),
  PINGROUP(sdmmc3_dat2_po4, SDMMC3, RSVD1, RSVD2, RSVD3, 0xA008, 0, Y, -1, -1,
      6, -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_sdmmc3_hv"),
  PINGROUP(sdmmc3_dat1_po3, SDMMC3, RSVD1, RSVD2, RSVD3, 0xA010, 0, Y, -1, -1,
      6, -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_sdmmc3_hv"),
  PINGROUP(sdmmc3_dat0_po2, SDMMC3, RSVD1, RSVD2, RSVD3, 0xA018, 0, Y, -1, -1,
      6, -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_sdmmc3_hv"),
  PINGROUP(sdmmc3_comp, SDMMC3, RSVD1, RSVD2, RSVD3, 0xA020, 0, N, -1, -1, -1,
      -1, -1, -1, -1, -1, N, -1, -1, N, "vddio_sdmmc3_hv"),
  PINGROUP(sdmmc3_cmd_po1, SDMMC3, RSVD1, RSVD2, RSVD3, 0xA028, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_sdmmc3_hv"),
  PINGROUP(sdmmc3_clk_po0, SDMMC3, RSVD1, RSVD2, RSVD3, 0xA030, 0, Y, -1, 5, 6,
      -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_sdmmc3_hv"),
  PINGROUP(sdmmc4_clk, SDMMC4, RSVD1, RSVD2, RSVD3, 0x6008, 0, Y, -1, 5, 6, -1,
      -1, -1, -1, -1, Y, -1, -1, N, "vddio_sdmmc4"),
  PINGROUP(sdmmc4_cmd, SDMMC4, RSVD1, RSVD2, RSVD3, 0x6010, 0, Y, -1, -1, 6, -1,
      -1, -1, -1, -1, Y, -1, -1, N, "vddio_sdmmc4"),
  PINGROUP(sdmmc4_dqs, SDMMC4, RSVD1, RSVD2, RSVD3, 0x6018, 0, Y, -1, -1, 6, -1,
      -1, -1, -1, -1, N, -1, -1, N, "vddio_sdmmc4"),
  PINGROUP(sdmmc4_dat7, SDMMC4, RSVD1, RSVD2, RSVD3, 0x6020, 0, Y, -1, -1, 6,
      -1, -1, -1, -1, -1, Y, -1, -1, N, "vddio_sdmmc4"),
  PINGROUP(sdmmc4_dat6, SDMMC4, RSVD1, RSVD2, RSVD3, 0x6028, 0, Y, -1, -1, 6,
      -1, -1, -1, -1, -1, Y, -1, -1, N, "vddio_sdmmc4"),
  PINGROUP(sdmmc4_dat5, SDMMC4, RSVD1, RSVD2, RSVD3, 0x6030, 0, Y, -1, -1, 6,
      -1, -1, -1, -1, -1, Y, -1, -1, N, "vddio_sdmmc4"),
  PINGROUP(sdmmc4_dat4, SDMMC4, RSVD1, RSVD2, RSVD3, 0x6038, 0, Y, -1, -1, 6,
      -1, -1, -1, -1, -1, Y, -1, -1, N, "vddio_sdmmc4"),
  PINGROUP(sdmmc4_dat3, SDMMC4, RSVD1, RSVD2, RSVD3, 0x6040, 0, Y, -1, -1, 6,
      -1, -1, -1, -1, -1, Y, -1, -1, N, "vddio_sdmmc4"),
  PINGROUP(sdmmc4_dat2, SDMMC4, RSVD1, RSVD2, RSVD3, 0x6048, 0, Y, -1, -1, 6,
      -1, -1, -1, -1, -1, Y, -1, -1, N, "vddio_sdmmc4"),
  PINGROUP(sdmmc4_dat1, SDMMC4, RSVD1, RSVD2, RSVD3, 0x6050, 0, Y, -1, -1, 6,
      -1, -1, -1, -1, -1, Y, -1, -1, N, "vddio_sdmmc4"),
  PINGROUP(sdmmc4_dat0, SDMMC4, RSVD1, RSVD2, RSVD3, 0x6058, 0, Y, -1, -1, 6,
      -1, -1, -1, -1, -1, Y, -1, -1, N, "vddio_sdmmc4"),
  PINGROUP(gpu_pwr_req_px0, RSVD0, RSVD1, RSVD2, RSVD3, 0xD000, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(spi3_miso_py1, SPI3, RSVD1, RSVD2, RSVD3, 0xD008, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(spi1_cs0_pz6, SPI1, RSVD1, RSVD2, RSVD3, 0xD010, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(spi3_cs0_py3, SPI3, RSVD1, RSVD2, RSVD3, 0xD018, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(spi1_miso_pz4, SPI1, RSVD1, RSVD2, RSVD3, 0xD020, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(spi3_cs1_py4, SPI3, RSVD1, RSVD2, RSVD3, 0xD028, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(gp_pwm3_px3, GP, RSVD1, RSVD2, RSVD3, 0xD030, 0, Y, -1, -1, 6, 8, -1,
      10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(gp_pwm2_px2, GP, RSVD1, RSVD2, RSVD3, 0xD038, 0, Y, -1, -1, 6, 8, -1,
      10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(spi1_sck_pz3, SPI1, RSVD1, RSVD2, RSVD3, 0xD040, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(spi3_sck_py0, SPI3, RSVD1, RSVD2, RSVD3, 0xD048, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(spi1_cs1_pz7, SPI1, RSVD1, RSVD2, RSVD3, 0xD050, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(spi1_mosi_pz5, SPI1, RSVD1, RSVD2, RSVD3, 0xD058, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(spi3_mosi_py2, SPI3, RSVD1, RSVD2, RSVD3, 0xD060, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(cv_pwr_req_px1, RSVD0, RSVD1, RSVD2, RSVD3, 0xD068, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(uart2_tx_px4, UARTB, RSVD1, RSVD2, RSVD3, 0xD070, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(uart2_rx_px5, UARTB, RSVD1, RSVD2, RSVD3, 0xD078, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(uart2_rts_px6, UARTB, RSVD1, RSVD2, RSVD3, 0xD080, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(uart2_cts_px7, UARTB, RSVD1, RSVD2, RSVD3, 0xD088, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(uart5_rx_py6, UARTE, RSVD1, RSVD2, RSVD3, 0xD090, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(uart5_tx_py5, UARTE, RSVD1, RSVD2, RSVD3, 0xD098, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(uart5_rts_py7, UARTE, RSVD1, RSVD2, RSVD3, 0xD0a0, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(uart5_cts_pz0, UARTE, RSVD1, RSVD2, RSVD3, 0xD0a8, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(usb_vbus_en0_pz1, USB, RSVD1, RSVD2, RSVD3, 0xD0b0, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(usb_vbus_en1_pz2, USB, RSVD1, RSVD2, RSVD3, 0xD0b8, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_uart"),
  PINGROUP(ufs0_rst_pff1, UFS0, RSVD1, RSVD2, RSVD3, 0x11000, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_ufs"),
  PINGROUP(ufs0_ref_clk_pff0, UFS0, RSVD1, RSVD2, RSVD3, 0x11008, 0, Y, -1, -1,
      6, -1, 9, 10, -1, 12, Y, 15, 17, Y, "vddio_ufs"),
};
...
static const struct tegra_pingroup tegra194_aon_groups[] = {
  PINGROUP(shutdown_n, RSVD0, RSVD1, RSVD2, RSVD3, 0x1000, 0, Y, 5, -1, 6, 8,
      -1, -1, -1, 12, N, -1, -1, N, "vddio_sys"),
  PINGROUP(pmu_int_n, RSVD0, RSVD1, RSVD2, RSVD3, 0x1008, 0, Y, -1, -1, 6, 8,
      -1, -1, -1, 12, N, -1, -1, N, "vddio_sys"),
  PINGROUP(safe_state_pee0, SCE, RSVD1, RSVD2, RSVD3, 0x1010, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_sys"),
  PINGROUP(vcomp_alert_pee1, SOC, RSVD1, RSVD2, RSVD3, 0x1018, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_sys"),
  PINGROUP(soc_pwr_req, RSVD0, RSVD1, RSVD2, RSVD3, 0x1020, 0, Y, -1, -1, 6, 8,
      -1, -1, -1, 12, N, -1, -1, N, "vddio_sys"),
  PINGROUP(batt_oc_pee3, SOC, RSVD1, RSVD2, RSVD3, 0x1028, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_sys"),
  PINGROUP(clk_32k_in, RSVD0, RSVD1, RSVD2, RSVD3, 0x1030, 0, Y, -1, -1, -1, 8,
      -1, -1, -1, 12, N, -1, -1, N, "vddio_sys"),
  PINGROUP(power_on_pee4, RSVD0, RSVD1, RSVD2, RSVD3, 0x1038, 0, Y, -1, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_sys"),
  PINGROUP(pwr_i2c_scl_pee5, I2C5, RSVD1, RSVD2, RSVD3, 0x1040, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_sys"),
  PINGROUP(pwr_i2c_sda_pee6, I2C5, RSVD1, RSVD2, RSVD3, 0x1048, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_sys"),
  PINGROUP(ao_retention_n_pee2, GPIO, RSVD1, RSVD2, RSVD3, 0x1060, 0, Y, 5, -1,
      6, 8, -1, 10, 11, 12, N, -1, -1, N, "vddio_sys"),
  PINGROUP(touch_clk_pcc4, GP, TOUCH, RSVD2, RSVD3, 0x2000, 0, Y, -1, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_ao"),
  PINGROUP(uart3_rx_pcc6, UARTC, RSVD1, RSVD2, RSVD3, 0x2008, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_ao"),
  PINGROUP(uart3_tx_pcc5, UARTC, RSVD1, RSVD2, RSVD3, 0x2010, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_ao"),
  PINGROUP(gen8_i2c_sda_pdd2, I2C8, RSVD1, RSVD2, RSVD3, 0x2018, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_ao"),
  PINGROUP(gen8_i2c_scl_pdd1, I2C8, RSVD1, RSVD2, RSVD3, 0x2020, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_ao"),
  PINGROUP(spi2_mosi_pcc2, SPI2, UARTG, RSVD2, RSVD3, 0x2028, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_ao"),
  PINGROUP(gen2_i2c_scl_pcc7, I2C2, RSVD1, RSVD2, RSVD3, 0x2030, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_ao"),
  PINGROUP(spi2_cs0_pcc3, SPI2, UARTG, RSVD2, RSVD3, 0x2038, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_ao"),
  PINGROUP(gen2_i2c_sda_pdd0, I2C2, RSVD1, RSVD2, RSVD3, 0x2040, 0, Y, 5, -1, 6,
      8, -1, 10, 11, 12, N, -1, -1, N, "vddio_ao"),
  PINGROUP(spi2_sck_pcc0, SPI2, UARTG, RSVD2, RSVD3, 0x2048, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_ao"),
  PINGROUP(spi2_miso_pcc1, SPI2, UARTG, RSVD2, RSVD3, 0x2050, 0, Y, 5, -1, 6, 8,
      -1, 10, 11, 12, N, -1, -1, N, "vddio_ao"),
  PINGROUP(can1_dout_paa0, CAN1, RSVD1, RSVD2, RSVD3, 0x3000, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_ao_hv"),
  PINGROUP(can1_din_paa1, CAN1, RSVD1, RSVD2, RSVD3, 0x3008, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_ao_hv"),
  PINGROUP(can0_dout_paa2, CAN0, RSVD1, RSVD2, RSVD3, 0x3010, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_ao_hv"),
  PINGROUP(can0_din_paa3, CAN0, RSVD1, RSVD2, RSVD3, 0x3018, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_ao_hv"),
  PINGROUP(can0_stb_paa4, RSVD0, WDT, RSVD2, RSVD3, 0x3020, 0, Y, -1, -1, 6, -1,
      9, 10, -1, 12, Y, -1, -1, Y, "vddio_ao_hv"),
  PINGROUP(can0_en_paa5, RSVD0, RSVD1, RSVD2, RSVD3, 0x3028, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_ao_hv"),
  PINGROUP(can0_wake_paa6, RSVD0, RSVD1, RSVD2, RSVD3, 0x3030, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_ao_hv"),
  PINGROUP(can0_err_paa7, RSVD0, RSVD1, RSVD2, RSVD3, 0x3038, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_ao_hv"),
  PINGROUP(can1_stb_pbb0, RSVD0, DMIC3, DMIC5, RSVD3, 0x3040, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_ao_hv"),
  PINGROUP(can1_en_pbb1, RSVD0, DMIC3, DMIC5, RSVD3, 0x3048, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_ao_hv"),
  PINGROUP(can1_wake_pbb2, RSVD0, RSVD1, RSVD2, RSVD3, 0x3050, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_ao_hv"),
  PINGROUP(can1_err_pbb3, RSVD0, RSVD1, RSVD2, RSVD3, 0x3058, 0, Y, -1, -1, 6,
      -1, 9, 10, -1, 12, Y, -1, -1, Y, "vddio_ao_hv"),
};
