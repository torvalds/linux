...
#define drive_directdc_comp             DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_sdmmc1_comp               DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_eqos_comp                 DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_sdmmc3_comp               DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_sdmmc4_clk                DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_sdmmc4_cmd                DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_sdmmc4_dqs                DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_sdmmc4_dat7               DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_sdmmc4_dat6               DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_sdmmc4_dat5               DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_sdmmc4_dat4               DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_sdmmc4_dat3               DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_sdmmc4_dat2               DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_sdmmc4_dat1               DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_sdmmc4_dat0               DRV_PINGROUP_ENTRY_N(anal_entry)
...
#define drive_directdc1_out7_pw1        DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_directdc1_out6_pw0        DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_directdc1_out5_pv7        DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_directdc1_out4_pv6        DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_directdc1_out3_pv5        DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_directdc1_out2_pv4        DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_directdc1_out1_pv3        DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_directdc1_out0_pv2        DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_directdc1_in_pv1          DRV_PINGROUP_ENTRY_N(anal_entry)
#define drive_directdc1_clk_pv0         DRV_PINGROUP_ENTRY_N(anal_entry)
