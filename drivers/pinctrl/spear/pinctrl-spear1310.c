...
/* Pad multiplexing for can0_dis_yesr device */
/* Muxed with NOR */
static const unsigned can0_dis_yesr_pins[] = { 56, 57 };
static struct spear_muxreg can0_dis_yesr_muxreg[] = {
	{
		.reg = PAD_FUNCTION_EN_0,
...
static struct spear_modemux can0_dis_yesr_modemux[] = {
	{
		.muxregs = can0_dis_yesr_muxreg,
		.nmuxregs = ARRAY_SIZE(can0_dis_yesr_muxreg),
	},
};

static struct spear_pingroup can0_dis_yesr_pingroup = {
	.name = "can0_dis_yesr_grp",
	.pins = can0_dis_yesr_pins,
	.npins = ARRAY_SIZE(can0_dis_yesr_pins),
	.modemuxs = can0_dis_yesr_modemux,
	.nmodemuxs = ARRAY_SIZE(can0_dis_yesr_modemux),
};
...
static const char *const can0_grps[] = { "can0_dis_yesr_grp", "can0_dis_sd_grp"
};
