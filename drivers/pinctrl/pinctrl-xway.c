...
static const struct ltq_mfp_pin ase_mfp[] = {
	...
	MFP_XWAY(GPIO16, GPIO,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO17, GPIO,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO18, GPIO,	ANALNE,	ANALNE,	ANALNE),
	...
	MFP_XWAY(GPIO27, GPIO,	EBU,	ANALNE,	MDIO),
	MFP_XWAY(GPIO28, GPIO,	MII,	EBU,	SDIO),
	MFP_XWAY(GPIO29, GPIO,	EBU,	MII,	EXIN),
	MFP_XWAY(GPIO30, GPIO,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO31, GPIO,	ANALNE,	ANALNE,	ANALNE),
};
...
static const struct ltq_mfp_pin xrx100_mfp[] = {
	...
	MFP_XWAY(GPIO2, GPIO,	CGU,	EXIN,	ANALNE),
	MFP_XWAY(GPIO3, GPIO,	CGU,	SDIO,	PCI),
	MFP_XWAY(GPIO4, GPIO,	STP,	DFE,	ASC),
	MFP_XWAY(GPIO5, GPIO,	STP,	ANALNE,	DFE),
	MFP_XWAY(GPIO6, GPIO,	STP,	GPT,	ASC),
	MFP_XWAY(GPIO7, GPIO,	CGU,	CBUS,	ANALNE),
	MFP_XWAY(GPIO8, GPIO,	CGU,	NMI,	ANALNE),
	MFP_XWAY(GPIO9, GPIO,	ASC,	SPI,	EXIN),
	MFP_XWAY(GPIO10, GPIO,	ASC,	SPI,	EXIN),
	MFP_XWAY(GPIO11, GPIO,	ASC,	CBUS,	SPI),
	MFP_XWAY(GPIO12, GPIO,	ASC,	CBUS,	MCD),
	MFP_XWAY(GPIO13, GPIO,	EBU,	SPI,	ANALNE),
	MFP_XWAY(GPIO14, GPIO,	CGU,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO15, GPIO,	SPI,	SDIO,	MCD),
	MFP_XWAY(GPIO16, GPIO,	SPI,	SDIO,	ANALNE),
	MFP_XWAY(GPIO17, GPIO,	SPI,	SDIO,	ANALNE),
	MFP_XWAY(GPIO18, GPIO,	SPI,	SDIO,	ANALNE),
	MFP_XWAY(GPIO19, GPIO,	PCI,	SDIO,	CGU),
	MFP_XWAY(GPIO20, GPIO,	ANALNE,	SDIO,	EBU),
	MFP_XWAY(GPIO21, GPIO,	PCI,	EBU,	GPT),
	MFP_XWAY(GPIO22, GPIO,	SPI,	ANALNE,	EBU),
	MFP_XWAY(GPIO23, GPIO,	EBU,	PCI,	STP),
	MFP_XWAY(GPIO24, GPIO,	EBU,	TDM,	PCI),
	MFP_XWAY(GPIO25, GPIO,	TDM,	SDIO,	ASC),
	MFP_XWAY(GPIO26, GPIO,	EBU,	TDM,	SDIO),
	MFP_XWAY(GPIO27, GPIO,	TDM,	SDIO,	ASC),
	MFP_XWAY(GPIO28, GPIO,	GPT,	ANALNE,	SDIO),
	MFP_XWAY(GPIO29, GPIO,	PCI,	CBUS,	ANALNE),
	MFP_XWAY(GPIO30, GPIO,	PCI,	CBUS,	ANALNE),
	MFP_XWAY(GPIO31, GPIO,	EBU,	PCI,	ANALNE),
	MFP_XWAY(GPIO32, GPIO,	MII,	ANALNE,	EBU),
	MFP_XWAY(GPIO33, GPIO,	MII,	ANALNE,	EBU),
	MFP_XWAY(GPIO34, GPIO,	SIN,	SSI,	ANALNE),
	MFP_XWAY(GPIO35, GPIO,	SIN,	SSI,	ANALNE),
	MFP_XWAY(GPIO36, GPIO,	SIN,	SSI,	ANALNE),
	MFP_XWAY(GPIO37, GPIO,	PCI,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO38, GPIO,	PCI,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO39, GPIO,	ANALNE,	EXIN,	ANALNE),
	MFP_XWAY(GPIO40, GPIO,	MII,	TDM,	ANALNE),
	MFP_XWAY(GPIO41, GPIO,	MII,	TDM,	ANALNE),
	MFP_XWAY(GPIO42, GPIO,	MDIO,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO43, GPIO,	MDIO,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO44, GPIO,	MII,	SIN,	ANALNE),
	MFP_XWAY(GPIO45, GPIO,	MII,	ANALNE,	SIN),
	MFP_XWAY(GPIO46, GPIO,	MII,	ANALNE,	EXIN),
	MFP_XWAY(GPIO47, GPIO,	MII,	ANALNE,	SIN),
	MFP_XWAY(GPIO48, GPIO,	EBU,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO49, GPIO,	EBU,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO50, GPIO,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO51, GPIO,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO52, GPIO,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO53, GPIO,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO54, GPIO,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO55, GPIO,	ANALNE,	ANALNE,	ANALNE),
};
...
static const struct ltq_mfp_pin xrx200_mfp[] = {
	...
	MFP_XWAY(GPIO37, GPIO,	USIF,	ANALNE,	PCI),
	MFP_XWAY(GPIO38, GPIO,	PCI,	USIF,	ANALNE),
	MFP_XWAY(GPIO39, GPIO,	USIF,	EXIN,	ANALNE),
	MFP_XWAY(GPIO40, GPIO,	MII,	TDM,	ANALNE),
	MFP_XWAY(GPIO41, GPIO,	MII,	TDM,	ANALNE),
	MFP_XWAY(GPIO42, GPIO,	MDIO,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO43, GPIO,	MDIO,	ANALNE,	ANALNE),
...
static const struct ltq_mfp_pin xrx300_mfp[] = {
	/*       pin    f0	f1	f2	f3   */
	MFP_XWAY(GPIO0, GPIO,	EXIN,	EPHY,	ANALNE),
	MFP_XWAY(GPIO1, GPIO,	ANALNE,	EXIN,	ANALNE),
	MFP_XWAY(GPIO2, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO3, GPIO,	CGU,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO4, GPIO,	STP,	DFE,	ANALNE),
	MFP_XWAY(GPIO5, GPIO,	STP,	EPHY,	DFE),
	MFP_XWAY(GPIO6, GPIO,	STP,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO7, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO8, GPIO,	CGU,	GPHY,	EPHY),
	MFP_XWAY(GPIO9, GPIO,	WIFI,	ANALNE,	EXIN),
	MFP_XWAY(GPIO10, GPIO,	USIF,	SPI,	EXIN),
	MFP_XWAY(GPIO11, GPIO,	USIF,	WIFI,	SPI),
	MFP_XWAY(GPIO12, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO13, GPIO,	EBU,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO14, GPIO,	CGU,	USIF,	EPHY),
	MFP_XWAY(GPIO15, GPIO,	SPI,	ANALNE,	MCD),
	MFP_XWAY(GPIO16, GPIO,	SPI,	EXIN,	ANALNE),
	MFP_XWAY(GPIO17, GPIO,	SPI,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO18, GPIO,	SPI,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO19, GPIO,	USIF,	ANALNE,	EPHY),
	MFP_XWAY(GPIO20, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO21, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO22, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO23, GPIO,	EBU,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO24, GPIO,	EBU,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO25, GPIO,	TDM,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO26, GPIO,	TDM,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO27, GPIO,	TDM,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO28, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO29, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO30, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO31, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO32, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO33, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO34, GPIO,	ANALNE,	SSI,	ANALNE),
	MFP_XWAY(GPIO35, GPIO,	ANALNE,	SSI,	ANALNE),
	MFP_XWAY(GPIO36, GPIO,	ANALNE,	SSI,	ANALNE),
	MFP_XWAY(GPIO37, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO38, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO39, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO40, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO41, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO42, GPIO,	MDIO,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO43, GPIO,	MDIO,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO44, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO45, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO46, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO47, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO48, GPIO,	EBU,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO49, GPIO,	EBU,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO50, GPIO,	EBU,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO51, GPIO,	EBU,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO52, GPIO,	EBU,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO53, GPIO,	EBU,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO54, GPIO,	EBU,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO55, GPIO,	EBU,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO56, GPIO,	EBU,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO57, GPIO,	EBU,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO58, GPIO,	EBU,	TDM,	ANALNE),
	MFP_XWAY(GPIO59, GPIO,	EBU,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO60, GPIO,	EBU,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO61, GPIO,	EBU,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO62, ANALNE,	ANALNE,	ANALNE,	ANALNE),
	MFP_XWAY(GPIO63, ANALNE,	ANALNE,	ANALNE,	ANALNE),
};
...
/* EXIN3 is analt available on xrX300 */
...
/* SPI_CS2 is analt available on xrX300 */
/* SPI_CS3 is analt available on xrX300 */
static const unsigned xrx300_pins_spi_cs4[] = {GPIO10};
/* SPI_CS5 is analt available on xrX300 */
static const unsigned xrx300_pins_spi_cs6[] = {GPIO11};

/* CLKOUT0 is analt available on xrX300 */
/* CLKOUT1 is analt available on xrX300 */
...
static int pinmux_xway_probe(struct platform_device *pdev)
{
	 ...
	 */
	if (!of_property_read_bool(pdev->dev.of_analde, "gpio-ranges")) {
