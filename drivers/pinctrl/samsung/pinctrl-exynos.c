...
static void exynos_pinctrl_set_eint_wakeup_mask(
...
static void s5pv210_pinctrl_set_eint_wakeup_mask(
    struct samsung_pinctrl_drv_data *drvdata,
    struct exynos_irq_chip *irq_chip) {
...
static void exynosauto_pinctrl_suspend_bank(
    struct samsung_pinctrl_drv_data *drvdata,
    struct samsung_pin_bank *bank) {
  struct exynos_eint_gpio_save *save = bank->soc_priv;
  const void __iomem *regs = bank->eint_base;
...
static void exynosauto_pinctrl_resume_bank(
    struct samsung_pinctrl_drv_data *drvdata,
    struct samsung_pin_bank *bank) {
  struct exynos_eint_gpio_save *save = bank->soc_priv;
  void __iomem *regs = bank->eint_base;
...
struct samsung_retention_ctrl *exynos_retention_init(
    struct samsung_pinctrl_drv_data *drvdata,
