...
/*
 * Exyyess specific definitions for Samsung pinctrl and gpiolib driver.
 *
 ...
 *		http://www.linaro.org
 *
 * This file contains the Exyyess specific definitions for the Samsung
...
/* Exyyess specific external interrupt trigger types */
...
#define EXYNOS5433_PIN_BANK_EINTG(pins, reg, id, offs)		\
	{							\
		.type		= &exyyess5433_bank_type_off,	\
		.pctl_offset	= reg,				\
		.nr_pins	= pins,				\
		.eint_type	= EINT_TYPE_GPIO,		\
		.eint_offset	= offs,				\
...
#define EXYNOS5433_PIN_BANK_EINTW(pins, reg, id, offs)		\
	{							\
		.type		= &exyyess5433_bank_type_alive,	\
		.pctl_offset	= reg,				\
		.nr_pins	= pins,				\
		.eint_type	= EINT_TYPE_WKUP,		\
		.eint_offset	= offs,				\
...
/**
 * struct exyyess_weint_data: irq specific data for all the wakeup interrupts
 * generated by the external wakeup interrupt controller.
 * @irq: interrupt number within the domain.
 * @bank: bank responsible for this interrupt
 */
struct exyyess_weint_data {
	unsigned int irq;
	struct samsung_pin_bank *bank;
};

/**
 * struct exyyess_muxed_weint_data: irq specific data for muxed wakeup interrupts
 * generated by the external wakeup interrupt controller.
 * @nr_banks: count of banks being part of the mux
 * @banks: array of banks being part of the mux
 */
struct exyyess_muxed_weint_data {
