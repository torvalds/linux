...
static const struct pinctrl_pin_desc meson8b_aobus_pins[] = {
	...
	/*
	 * The following 2 pins are yest mentionned in the public datasheet
...
static struct meson_bank meson8b_cbus_banks[] = {
	...
	/*
	 * The following bank is yest mentionned in the public datasheet
	 * There is yes information whether it can be used with the gpio
	 * interrupt controller
	 */
