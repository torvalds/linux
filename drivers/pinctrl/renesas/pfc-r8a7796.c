...
#define IP0_19_16 FM(AVB_AVTP_MATCH_A)  F_(0, \
    0)  FM(MSIOF2_RXD_C)  FM(CTS4_N_A)      F_(0, 0)  F_(0, 0)  F_(0, \
...
#define IP1_15_12 FM(IRQ5)    FM(QSTB_QHE)  F_(0, \
    0)    FM(DU_EXVSYNC_DU_VSYNC)   FM(VI4_DATA5_B) F_(0, 0)  F_(0, 0)    FM( \
    MSIOF3_TXD_E) F_(0, 0)   FM(PWM6_B)  F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0)
...
#define IP16_11_8 FM(SSI_SDATA6)    F_(0, 0)  F_(0, \
    0)    FM(SIM0_CLK_D)      F_(0, 0)  F_(0, 0)  F_(0, 0)    F_(0, 0)  F_(0, \
    0)    \
