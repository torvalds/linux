...
#define CPU_ALL_GP(fn, sfx) \
  PORT_GP_CFG_22(0, fn, sfx, \
    SH_PFC_PIN_CFG_IO_VOLTAGE_18_33 | SH_PFC_PIN_CFG_PULL_UP_DOWN),  \
  PORT_GP_CFG_28(1, fn, sfx, SH_PFC_PIN_CFG_PULL_UP_DOWN),  \
  PORT_GP_CFG_30(2, fn, sfx, \
    SH_PFC_PIN_CFG_IO_VOLTAGE_18_33 | SH_PFC_PIN_CFG_PULL_UP_DOWN),  \
  PORT_GP_CFG_17(3, fn, sfx, \
    SH_PFC_PIN_CFG_IO_VOLTAGE_18_33 | SH_PFC_PIN_CFG_PULL_UP_DOWN), \
 ...
 *   /*
 * 6 - F */
#define IP0_3_0   FM(DU_DR2)      FM(SCK4)    FM(GETHER_RMII_CRS_DV)  FM(A0)    \
  F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0_7_4   FM(DU_DR3)      FM(RX4)     FM(GETHER_RMII_RX_ER) FM(A1)    F_( \
    0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_( \
    0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0_11_8  FM(DU_DR4)      FM(TX4)     FM(GETHER_RMII_RXD0)  FM(A2)    F_( \
    0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_( \
    0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0_15_12 FM(DU_DR5)      FM(CTS4_N)    FM(GETHER_RMII_RXD1)  FM(A3)    \
  F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0_19_16 FM(DU_DR6)      FM(RTS4_N)    FM(GETHER_RMII_TXD_EN)  FM(A4)    \
  F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0_23_20 FM(DU_DR7)      F_(0, \
    0)    FM(GETHER_RMII_TXD0)  FM(A5)    F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0_27_24 FM(DU_DG2)      F_(0, \
    0)    FM(GETHER_RMII_TXD1)  FM(A6)    F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0_31_28 FM(DU_DG3)      FM(CPG_CPCKOUT)   FM(GETHER_RMII_REFCLK)  FM( \
    A7)    FM(PWMFSW0) F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1_3_0   FM(DU_DG4)      FM(SCL5)    F_(0, 0)    FM(A8)    F_(0, \
    0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1_7_4   FM(DU_DG5)      FM(SDA5)    FM(GETHER_MDC_B)  FM(A9)    F_(0, \
    0)  \
  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1_11_8  FM(DU_DG6)      FM(SCIF_CLK_A)    FM(GETHER_MDIO_B) FM(A10)   \
  F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1_15_12 FM(DU_DG7)      FM(HRX0_A)    F_(0, 0)    FM(A11)   F_(0, \
    0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1_19_16 FM(DU_DB2)      FM(HSCK0_A)   F_(0, \
    0)    FM(A12)   FM(IRQ1)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1_23_20 FM(DU_DB3)      FM(HRTS0_N_A)   F_(0, \
    0)    FM(A13)   FM(IRQ2)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1_27_24 FM(DU_DB4)      FM(HCTS0_N_A)   F_(0, \
    0)    FM(A14)   FM(IRQ3)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1_31_28 FM(DU_DB5)      FM(HTX0_A)    FM(PWM0_A)    FM(A15)   F_(0, \
    0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0)
#define IP2_3_0   FM(DU_DB6)      FM(MSIOF3_RXD)    F_(0, 0)    FM(A16)   F_(0, \
    0)  \
  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP2_7_4   FM(DU_DB7)      FM(MSIOF3_TXD)    F_(0, 0)    FM(A17)   F_(0, \
    0)  \
  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP2_11_8  FM(DU_DOTCLKOUT)    FM(MSIOF3_SS1)    FM(GETHER_LINK_B) FM(A18)   \
  F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP2_15_12 FM(DU_EXHSYNC_DU_HSYNC)   FM(MSIOF3_SS2)    FM( \
    GETHER_PHY_INT_B)  FM(A19)   FM(FXR_TXENA_N) F_(0, 0)  F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP2_19_16 FM(DU_EXVSYNC_DU_VSYNC)   FM(MSIOF3_SCK)    F_(0, 0)    F_(0, \
    0)  \
  FM(FXR_TXENB_N) F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_( \
    0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP2_23_20 FM(DU_EXODDF_DU_ODDF_DISP_CDE)  FM(MSIOF3_SYNC)   F_(0, \
    0)    F_(0, 0)  F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP2_27_24 FM(IRQ0)      F_(0, 0)    F_(0, 0)    F_(0, 0)  F_(0, 0)  F_( \
    0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_( \
    0, 0) F_(0, 0) F_(0, 0)
#define IP2_31_28 FM(VI0_CLK)     FM(MSIOF2_SCK)    FM(SCK3)    F_(0, 0)  FM( \
    HSCK3) F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_( \
    0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP3_3_0   FM(VI0_CLKENB)      FM(MSIOF2_RXD)    FM(RX3)     FM(RD_WR_N) \
  FM(HCTS3_N) F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP3_7_4   FM(VI0_HSYNC_N)     FM(MSIOF2_TXD)    FM(TX3)     F_(0, \
    0)  FM(HRTS3_N) F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_( \
    0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP3_11_8  FM(VI0_VSYNC_N)     FM(MSIOF2_SYNC)   FM(CTS3_N)    F_(0, \
    0)  FM(HTX3)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP3_15_12 FM(VI0_DATA0)     FM(MSIOF2_SS1)    FM(RTS3_N)    F_(0, \
    0)  FM(HRX3)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP3_19_16 FM(VI0_DATA1)     FM(MSIOF2_SS2)    FM(SCK1)    F_(0, 0)  FM( \
    SPEEDIN_A) F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP3_23_20 FM(VI0_DATA2)     FM(AVB_AVTP_PPS)  F_(0, 0)    F_(0, 0)  F_( \
    0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_( \
    0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP3_27_24 FM(VI0_DATA3)     FM(HSCK1)   F_(0, 0)    F_(0, 0)  F_(0, \
    0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0)
#define IP3_31_28 FM(VI0_DATA4)     FM(HRTS1_N)   FM(RX1_A)   F_(0, 0)  F_(0, \
    0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0)
#define IP4_3_0   FM(VI0_DATA5)     FM(HCTS1_N)   FM(TX1_A)   F_(0, 0)  F_(0, \
    0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0)
#define IP4_7_4   FM(VI0_DATA6)     FM(HTX1)    FM(CTS1_N)    F_(0, 0)  F_(0, \
    0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0)
#define IP4_11_8  FM(VI0_DATA7)     FM(HRX1)    FM(RTS1_N)    F_(0, 0)  F_(0, \
    0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0)
#define IP4_15_12 FM(VI0_DATA8)     FM(HSCK2)   F_(0, 0)    F_(0, 0)  F_(0, \
    0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0)
#define IP4_19_16 FM(VI0_DATA9)     FM(HCTS2_N)   FM(PWM1_A)    F_(0, 0)  F_(0, \
    0)  \
  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP4_23_20 FM(VI0_DATA10)      FM(HRTS2_N)   FM(PWM2_A)    F_(0, 0)  F_( \
    0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_( \
    0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP4_27_24 FM(VI0_DATA11)      FM(HTX2)    FM(PWM3_A)    F_(0, 0)  F_(0, \
    0)  \
  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP4_31_28 FM(VI0_FIELD)     FM(HRX2)    FM(PWM4_A)    FM(CS1_N) F_(0, \
    0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0)
#define IP5_3_0   FM(VI1_CLK)     FM(MSIOF1_RXD)    F_(0, 0)    FM(CS0_N) F_(0, \
    0)  \
  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP5_7_4   FM(VI1_CLKENB)      FM(MSIOF1_TXD)    F_(0, \
    0)    FM(D0)    F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP5_11_8  FM(VI1_HSYNC_N)     FM(MSIOF1_SCK)    F_(0, \
    0)    FM(D1)    F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP5_15_12 FM(VI1_VSYNC_N)     FM(MSIOF1_SYNC)   F_(0, \
    0)    FM(D2)    F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP5_19_16 FM(VI1_DATA0)     FM(MSIOF1_SS1)    F_(0, 0)    FM(D3)    FM( \
    MMC_WP)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP5_23_20 FM(VI1_DATA1)     FM(MSIOF1_SS2)    F_(0, 0)    FM(D4)    FM( \
    MMC_CD)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP5_27_24 FM(VI1_DATA2)     FM(CANFD0_TX_B)   F_(0, 0)    FM(D5)    FM( \
    MMC_DS)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP5_31_28 FM(VI1_DATA3)     FM(CANFD0_RX_B)   F_(0, 0)    FM(D6)    FM( \
    MMC_CMD) F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP6_3_0   FM(VI1_DATA4)     FM(CANFD_CLK_B)   F_(0, 0)    FM(D7)    FM( \
    MMC_D0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP6_7_4   FM(VI1_DATA5)     F_(0, 0)    F_(0, \
    0)    FM(D8)    FM(MMC_D1)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP6_11_8  FM(VI1_DATA6)     F_(0, 0)    F_(0, \
    0)    FM(D9)    FM(MMC_D2)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP6_15_12 FM(VI1_DATA7)     F_(0, 0)    F_(0, \
    0)    FM(D10)   FM(MMC_D3)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP6_19_16 FM(VI1_DATA8)     F_(0, 0)    F_(0, \
    0)    FM(D11)   FM(MMC_CLK) F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP6_23_20 FM(VI1_DATA9)     FM(TCLK1_A)   F_(0, 0)    FM(D12)   FM( \
    MMC_D4)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP6_27_24 FM(VI1_DATA10)      FM(TCLK2_A)   F_(0, 0)    FM(D13)   FM( \
    MMC_D5)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP6_31_28 FM(VI1_DATA11)      FM(SCL4)    F_(0, 0)    FM(D14)   FM( \
    MMC_D6)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP7_3_0   FM(VI1_FIELD)     FM(SDA4)    F_(0, \
    0)    FM(D15)   FM(MMC_D7)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP7_7_4   FM(SCL0)      F_(0, 0)    F_(0, 0)    FM(CLKOUT)  F_(0, \
    0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0)
#define IP7_11_8  FM(SDA0)      F_(0, 0)    F_(0, 0)    FM(BS_N)  FM(SCK0)  FM( \
    HSCK0_B) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP7_15_12 FM(SCL1)      F_(0, \
    0)    FM(TPU0TO2)   FM(RD_N)  FM(CTS0_N)  FM(HCTS0_N_B) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP7_19_16 FM(SDA1)      F_(0, \
    0)    FM(TPU0TO3)   FM(WE0_N) FM(RTS0_N)  FM(HRTS0_N_B) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP7_23_20 FM(SCL2)      F_(0, 0)    F_(0, 0)    FM(WE1_N) FM(RX0)   FM( \
    HRX0_B)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP7_27_24 FM(SDA2)      F_(0, 0)    F_(0, \
    0)    FM(EX_WAIT0)  FM(TX0)   FM(HTX0_B)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP7_31_28 FM(AVB_AVTP_MATCH)    FM(TPU0TO0)   F_(0, 0)    F_(0, 0)  F_( \
    0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_( \
    0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP8_3_0   FM(AVB_AVTP_CAPTURE)    FM(TPU0TO1)   F_(0, 0)    F_(0, \
    0)  F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP8_7_4   FM(CANFD0_TX_A)     FM(FXR_TXDA)    FM(PWM0_B)    FM(DU_DISP) \
  F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP8_11_8  FM(CANFD0_RX_A)     FM(RXDA_EXTFXR)   FM(PWM1_B)    FM(DU_CDE)  \
  F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP8_15_12 FM(CANFD1_TX)     FM(FXR_TXDB)    FM(PWM2_B)    FM(TCLK1_B) FM( \
    TX1_B) F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_( \
    0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP8_19_16 FM(CANFD1_RX)     FM(RXDB_EXTFXR)   FM(PWM3_B)    FM(TCLK2_B) \
  FM(RX1_B) F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP8_23_20 FM(CANFD_CLK_A)     FM(CLK_EXTFXR)    FM(PWM4_B)    FM( \
    SPEEDIN_B) FM(SCIF_CLK_B)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP8_27_24 FM(DIGRF_CLKIN)     FM(DIGRF_CLKEN_IN)  F_(0, 0)    F_(0, \
    0)  F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP8_31_28 FM(DIGRF_CLKOUT)    FM(DIGRF_CLKEN_OUT) F_(0, 0)    F_(0, \
    0)  F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP9_3_0   FM(IRQ4)      F_(0, 0)    F_(0, 0)    FM(VI0_DATA12)  F_(0, \
    0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0)
#define IP9_7_4   FM(IRQ5)      F_(0, 0)    F_(0, 0)    FM(VI0_DATA13)  F_(0, \
    0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0)
#define IP9_11_8  FM(MSIOF0_RXD)      FM(DU_DR0)    F_(0, \
    0)    FM(VI0_DATA14)  F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP9_15_12 FM(MSIOF0_TXD)      FM(DU_DR1)    F_(0, \
    0)    FM(VI0_DATA15)  F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP9_19_16 FM(MSIOF0_SCK)      FM(DU_DG0)    F_(0, \
    0)    FM(VI0_DATA16)  F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP9_23_20 FM(MSIOF0_SYNC)     FM(DU_DG1)    F_(0, \
    0)    FM(VI0_DATA17)  F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP9_27_24 FM(MSIOF0_SS1)      FM(DU_DB0)    FM(TCLK3)   FM(VI0_DATA18)  \
  F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP9_31_28 FM(MSIOF0_SS2)      FM(DU_DB1)    FM(TCLK4)   FM(VI0_DATA19)  \
  F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP10_3_0  FM(SCL3)      F_(0, 0)    F_(0, 0)    FM(VI0_DATA20)  F_(0, \
    0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0)
#define IP10_7_4  FM(SDA3)      F_(0, 0)    F_(0, 0)    FM(VI0_DATA21)  F_(0, \
    0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0)
#define IP10_11_8 FM(FSO_CFE_0_N)     F_(0, 0)    F_(0, \
    0)    FM(VI0_DATA22)  F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP10_15_12  FM(FSO_CFE_1_N)     F_(0, 0)    F_(0, \
    0)    FM(VI0_DATA23)  F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP10_19_16  FM(FSO_TOE_N)     F_(0, 0)    F_(0, 0)    F_(0, 0)  F_(0, \
    0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0)
...
#define PINMUX_IPSR \
\
  FM(IP0_3_0) IP0_3_0 FM(IP1_3_0) IP1_3_0 FM(IP2_3_0) IP2_3_0 FM(IP3_3_0) \
  IP3_3_0 \
  FM(IP0_7_4) IP0_7_4 FM(IP1_7_4) IP1_7_4 FM(IP2_7_4) IP2_7_4 FM(IP3_7_4) \
  IP3_7_4 \
  FM(IP0_11_8)  IP0_11_8 FM(IP1_11_8)  IP1_11_8 FM(IP2_11_8)  IP2_11_8 FM( \
    IP3_11_8)  IP3_11_8 \
  FM(IP0_15_12) IP0_15_12 FM(IP1_15_12) IP1_15_12 FM(IP2_15_12) IP2_15_12 FM( \
    IP3_15_12) IP3_15_12 \
  FM(IP0_19_16) IP0_19_16 FM(IP1_19_16) IP1_19_16 FM(IP2_19_16) IP2_19_16 FM( \
    IP3_19_16) IP3_19_16 \
  FM(IP0_23_20) IP0_23_20 FM(IP1_23_20) IP1_23_20 FM(IP2_23_20) IP2_23_20 FM( \
    IP3_23_20) IP3_23_20 \
  FM(IP0_27_24) IP0_27_24 FM(IP1_27_24) IP1_27_24 FM(IP2_27_24) IP2_27_24 FM( \
    IP3_27_24) IP3_27_24 \
  FM(IP0_31_28) IP0_31_28 FM(IP1_31_28) IP1_31_28 FM(IP2_31_28) IP2_31_28 FM( \
    IP3_31_28) IP3_31_28 \
\
  FM(IP4_3_0) IP4_3_0 FM(IP5_3_0) IP5_3_0 FM(IP6_3_0) IP6_3_0 FM(IP7_3_0) \
  IP7_3_0 \
  FM(IP4_7_4) IP4_7_4 FM(IP5_7_4) IP5_7_4 FM(IP6_7_4) IP6_7_4 FM(IP7_7_4) \
  IP7_7_4 \
  FM(IP4_11_8)  IP4_11_8 FM(IP5_11_8)  IP5_11_8 FM(IP6_11_8)  IP6_11_8 FM( \
    IP7_11_8)  IP7_11_8 \
  FM(IP4_15_12) IP4_15_12 FM(IP5_15_12) IP5_15_12 FM(IP6_15_12) IP6_15_12 FM( \
    IP7_15_12) IP7_15_12 \
  FM(IP4_19_16) IP4_19_16 FM(IP5_19_16) IP5_19_16 FM(IP6_19_16) IP6_19_16 FM( \
    IP7_19_16) IP7_19_16 \
  FM(IP4_23_20) IP4_23_20 FM(IP5_23_20) IP5_23_20 FM(IP6_23_20) IP6_23_20 FM( \
    IP7_23_20) IP7_23_20 \
  FM(IP4_27_24) IP4_27_24 FM(IP5_27_24) IP5_27_24 FM(IP6_27_24) IP6_27_24 FM( \
    IP7_27_24) IP7_27_24 \
  FM(IP4_31_28) IP4_31_28 FM(IP5_31_28) IP5_31_28 FM(IP6_31_28) IP6_31_28 FM( \
    IP7_31_28) IP7_31_28 \
\
