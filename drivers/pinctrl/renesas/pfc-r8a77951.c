...
#define IP15_31_28  FM(SSI_SDATA4)    FM(HSCK2_A) FM(MSIOF1_RXD_A)  F_(0, \
    ...
    0, 0)
#define IP16_3_0  FM(SSI_SCK6)    FM(USB2_PWEN) F_(0, \
    0)    FM(SIM0_RST_D)      F_(0, 0)  F_(0, 0)  F_(0, 0)    F_(0, 0)  F_(0, \
    0)    \
  F_(0, 0)  F_(0, 0)  F_(0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP16_7_4  FM(SSI_WS6)   FM(USB2_OVC)  F_(0, 0)    FM(SIM0_D_D)      F_( \
    0, 0)  F_(0, 0)  F_(0, 0)    F_(0, 0)  F_(0, 0)    F_(0, 0)  F_(0, 0)  F_( \
    0, 0)  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
#define IP18_3_0  FM(USB2_CH3_PWEN) F_(0, 0)  F_(0, \
    0)    FM(AUDIO_CLKOUT2_B)   FM(SSI_SCK9_B)  FM(TS_SDEN0_E)  FM( \
    STP_ISEN_0_E)  F_(0, 0)  FM(RIF2_D0_B)   F_(0, 0)  F_(0, \
    0)  FM(TPU0TO2) FM(FMCLK_C) FM(FMCLK_D) F_(0, 0) F_(0, 0)
#define IP18_7_4  FM(USB2_CH3_OVC)  F_(0, 0)  F_(0, \
    0)    FM(AUDIO_CLKOUT3_B)   FM(SSI_WS9_B) FM(TS_SPSYNC0_E) FM( \
    STP_ISSYNC_0_E)  F_(0, 0)  FM(RIF2_D1_B)   F_(0, 0)  F_(0, \
