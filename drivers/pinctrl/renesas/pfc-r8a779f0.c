...
/* IP0SR0 */    /* 0 */     /* 1 */     /* 2 */     /* 3 */     /* 4 */   /* 5
 * */     /* 6 */     /* 7 - F */
#define IP0SR0_3_0  FM(SCIF_CLK)    F_(0, 0)    F_(0, 0)    F_(0, 0)    F_(0, \
    0)  F_(0, 0)    F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR0_7_4  FM(HSCK0)   FM(SCK3)    FM(MSIOF3_SCK)    F_(0, 0)    F_(0, \
    0)  \
  FM(TSN0_AVTP_CAPTURE_A) F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR0_11_8 FM(HRX0)    FM(RX3)     FM(MSIOF3_RXD)    F_(0, 0)    F_(0, \
    0)  \
  FM(TSN0_AVTP_MATCH_A) F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_( \
    0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR0_15_12  FM(HTX0)    FM(TX3)     FM(MSIOF3_TXD)    F_(0, 0)    F_( \
    0, 0)  F_(0, 0)    F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR0_19_16  FM(HCTS0_N)   FM(CTS3_N)    FM(MSIOF3_SS1)    F_(0, \
    0)    F_(0, 0)  FM(TSN0_MDC_A)    F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR0_23_20  FM(HRTS0_N)   FM(RTS3_N)    FM(MSIOF3_SS2)    F_(0, \
    0)    F_(0, 0)  FM(TSN0_MDIO_A)   F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR0_27_24  FM(RX0)     FM(HRX1)    F_(0, 0)    FM(MSIOF1_RXD)    F_( \
    0, 0)  FM(TSN1_AVTP_MATCH_A) F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR0_31_28  FM(TX0)     FM(HTX1)    F_(0, 0)    FM(MSIOF1_TXD)    F_( \
    0, 0)  FM(TSN1_AVTP_CAPTURE_A) F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_( \
    0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
/* IP1SR0 */    /* 0 */     /* 1 */     /* 2 */     /* 3 */     /* 4 */   /* 5
 * */     /* 6 */     /* 7 - F */
#define IP1SR0_3_0  FM(SCK0)    FM(HSCK1)   F_(0, 0)    FM(MSIOF1_SCK)    F_(0, \
    0)  \
  F_(0, 0)    F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR0_7_4  FM(RTS0_N)    FM(HRTS1_N)   FM(MSIOF3_SYNC)   F_(0, \
    0)    F_(0, 0)  FM(TSN1_MDIO_A)   F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR0_11_8 FM(CTS0_N)    FM(HCTS1_N)   F_(0, \
    0)    FM(MSIOF1_SYNC)   F_(0, 0)  FM(TSN1_MDC_A)    F_(0, 0)    F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR0_15_12  FM(MSIOF0_SYNC)   FM(HCTS3_N)   FM(CTS1_N)    FM(IRQ4)    \
  F_(0, 0)  FM(TSN0_LINK_A)   F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR0_19_16  FM(MSIOF0_RXD)    FM(HRX3)    FM(RX1)     F_(0, 0)    F_( \
    0, 0)  F_(0, 0)    F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR0_23_20  FM(MSIOF0_TXD)    FM(HTX3)    FM(TX1)     F_(0, 0)    F_( \
    0, 0)  F_(0, 0)    F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR0_27_24  FM(MSIOF0_SCK)    FM(HSCK3)   FM(SCK1)    F_(0, 0)    F_( \
    0, 0)  F_(0, 0)    F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR0_31_28  FM(MSIOF0_SS1)    FM(HRTS3_N)   FM(RTS1_N)    FM(IRQ5)    \
  F_(0, 0)  FM(TSN1_LINK_A)   F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
/* IP2SR0 */    /* 0 */     /* 1 */     /* 2 */     /* 3 */     /* 4 */   /* 5
 * */     /* 6 */     /* 7 - F */
#define IP2SR0_3_0  FM(MSIOF0_SS2)    F_(0, 0)    F_(0, 0)    F_(0, 0)    F_(0, \
    0)  \
  FM(TSN2_LINK_A)   F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP2SR0_7_4  FM(IRQ0)    F_(0, 0)    F_(0, 0)    FM(MSIOF1_SS1)    F_(0, \
    0)  \
  FM(TSN0_MAGIC_A)  F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP2SR0_11_8 FM(IRQ1)    F_(0, 0)    F_(0, 0)    FM(MSIOF1_SS2)    F_(0, \
    0)  \
  FM(TSN0_PHY_INT_A)  F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP2SR0_15_12  FM(IRQ2)    F_(0, 0)    F_(0, 0)    F_(0, 0)    F_(0, \
    0)  FM(TSN1_PHY_INT_A)  F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP2SR0_19_16  FM(IRQ3)    F_(0, 0)    F_(0, 0)    F_(0, 0)    F_(0, \
    0)  FM(TSN2_PHY_INT_A)  F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)

/* IP0SR1 */    /* 0 */     /* 1 */     /* 2 */     /* 3 */     /* 4 */   /* 5
 * */     /* 6 */     /* 7 - F */
#define IP0SR1_3_0  FM(GP1_00)    FM(TCLK1)   FM(HSCK2)   F_(0, 0)    F_(0, \
    0)  F_(0, 0)    F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR1_7_4  FM(GP1_01)    FM(TCLK4)   FM(HRX2)    F_(0, 0)    F_(0, \
    0)  F_(0, 0)    F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR1_11_8 FM(GP1_02)    F_(0, 0)    FM(HTX2)    FM(MSIOF2_SS1)    F_( \
    0, 0)  FM(TSN2_MDC_A)    F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR1_15_12  FM(GP1_03)    FM(TCLK2)   FM(HCTS2_N)   FM(MSIOF2_SS2)    \
  FM(CTS4_N)  FM(TSN2_MDIO_A)   F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) \
  F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR1_19_16  FM(GP1_04)    FM(TCLK3)   FM(HRTS2_N)   FM(MSIOF2_SYNC)   \
  FM(RTS4_N)  F_(0, 0)    F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR1_23_20  FM(GP1_05)    FM(MSIOF2_SCK)    FM(SCK4)    F_(0, \
    0)    F_(0, 0)  F_(0, 0)    F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR1_27_24  FM(GP1_06)    FM(MSIOF2_RXD)    FM(RX4)     F_(0, \
    0)    F_(0, 0)  F_(0, 0)    F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR1_31_28  FM(GP1_07)    FM(MSIOF2_TXD)    FM(TX4)     F_(0, \
    0)    F_(0, 0)  F_(0, 0)    F_(0, 0)    F_(0, 0) F_(0, 0) F_(0, 0) F_(0, \
    0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
\
  ...
  IP2SR0_11_8 \
  FM(IP0SR0_15_12)  IP0SR0_15_12 FM(IP1SR0_15_12)  IP1SR0_15_12 FM(IP2SR0_15_12)  \
  IP2SR0_15_12  \
  FM(IP0SR0_19_16)  IP0SR0_19_16 FM(IP1SR0_19_16)  IP1SR0_19_16 FM(IP2SR0_19_16)  \
  IP2SR0_19_16  \
