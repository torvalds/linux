 ...
 *        Pin   FUNC0    FUNC1     FUNC2      FUNC3     FUNC4     FUNC5
 *     FUNC6    FUNC7*/
...
LAN966X_P(46, GPIO, FC1_c, OB_TRG_b, IB_TRG_b, IRQ_OUT_a, FC_SHRD4, IRQ_IN_a,
    R);
LAN966X_P(47, GPIO, FC1_c, OB_TRG_b, IB_TRG_b, IRQ_OUT_a, FC_SHRD5, IRQ_IN_a,
    R);
LAN966X_P(48, GPIO, FC1_c, OB_TRG_b, IB_TRG_b, IRQ_OUT_a, FC_SHRD6, IRQ_IN_a,
    R);
LAN966X_P(49, GPIO, FC_SHRD7, OB_TRG_b, IB_TRG_b, IRQ_OUT_a, TWI_SLC_GATE,
    IRQ_IN_a, R);
LAN966X_P(50, GPIO, FC_SHRD16, OB_TRG_b, IB_TRG_b, IRQ_OUT_a, TWI_SLC_GATE,
    NONE, R);
...
LAN966X_P(54, GPIO, FC_SHRD8, OB_TRG_b, IB_TRG_c, IRQ_OUT_b, TWI_SLC_GATE,
    IRQ_IN_b, R);
LAN966X_P(55, GPIO, FC_SHRD9, OB_TRG_b, IB_TRG_c, IRQ_OUT_b, TWI_SLC_GATE,
    IRQ_IN_b, R);
LAN966X_P(56, GPIO, FC4_b, OB_TRG_b, IB_TRG_c, IRQ_OUT_b, FC_SHRD10, IRQ_IN_b,
    R);
LAN966X_P(57, GPIO, FC4_b, TWI_SLC_GATE, IB_TRG_c, IRQ_OUT_b, FC_SHRD11,
    IRQ_IN_b, R);
LAN966X_P(58, GPIO, FC4_b, TWI_SLC_GATE, IB_TRG_c, IRQ_OUT_b, FC_SHRD12,
    IRQ_IN_b, R);
...
#define REG_ALT(msb, info, \
      p) (OCELOT_GPIO_ALT0 * (info)->stride + 4 \
  * ((msb) + ((info)->stride * ((p) / 32))))
...
static void ocelot_irq_work(struct work_struct *work) {
  struct ocelot_irq_work *w = container_of(work, struct ocelot_irq_work,
      irq_work);
