...
static struct s32_pinctrl_mem_region *s32_get_region(
...
static inline int s32_regmap_update(struct pinctrl_dev *pctldev,
    unsigned int pin,
...
static int s32_pconf_group_set(struct pinctrl_dev *pctldev,
    unsigned int selector,
