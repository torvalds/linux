...
static struct sunxi_pinctrl_group *sunxi_pinctrl_find_group_by_name(
    struct sunxi_pinctrl *pctl, const char *group) {
  int i;
...
static struct sunxi_pinctrl_function *sunxi_pinctrl_find_function_by_name(
...
static struct sunxi_desc_function *sunxi_pinctrl_desc_find_function_by_name(
    struct sunxi_pinctrl *pctl,
    const char *pin_name,
...
static struct sunxi_desc_function *sunxi_pinctrl_desc_find_function_by_pin(
    struct sunxi_pinctrl *pctl,
    const u16 pin_num,
    const char *func_name) {
  int i;
...
static int sunxi_pinctrl_get_debounce_div(struct clk *clk, int freq,
    int *diff) {
