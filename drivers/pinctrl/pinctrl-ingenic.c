...
static bool is_soc_or_above(const struct ingenic_pinctrl *jzpc,
    enum jz_version version) {
...
static const char *jz4760_ssi1_groups[] = {
  "ssi1-dt-b-9", "ssi1-dt-b-21", "ssi1-dt-d-12", "ssi1-dt-d-21", "ssi1-dt-e",
  "ssi1-dt-f",
  "ssi1-dr-b-6", "ssi1-dr-b-20", "ssi1-dr-d-13", "ssi1-dr-d-20", "ssi1-dr-e",
  "ssi1-dr-f",
  "ssi1-clk-b-7", "ssi1-clk-b-28", "ssi1-clk-d", "ssi1-clk-e-7",
  "ssi1-clk-e-15", "ssi1-clk-f",
  "ssi1-gpc-b", "ssi1-gpc-d", "ssi1-gpc-e",
  "ssi1-ce0-b-8", "ssi1-ce0-b-29", "ssi1-ce0-d", "ssi1-ce0-e-6",
  "ssi1-ce0-e-16", "ssi1-ce0-f",
...
static const u32 jz4775_pull_ups[7] = {
  0x28ff00ff, 0xf030f3fc, 0x0fffffff, 0xfffe4000, 0xf0f0000c, 0x0000f00f,
  0x0000f3c0,
};

static const u32 jz4775_pull_downs[7] = {
  0x00000000, 0x00030c03, 0x00000000, 0x00008000, 0x00000403, 0x00000ff0,
  0x00030c00,
};
...
static const char *jz4780_ssi0_groups[] = {
  "ssi0-dt-a-19", "ssi0-dt-a-21", "ssi0-dt-a-28", "ssi0-dt-b", "ssi0-dt-d",
  "ssi0-dt-e",
...
static const char *x1000_uart2_groups[] = {
  "uart2-data-a", "uart2-data-d",
};
static const char *x1000_sfc_groups[] = {
  "sfc-data", "sfc-clk", "sfc-ce",
};
...
static const char *x2000_uart5_groups[] = {
  "uart5-data-a", "uart5-data-c",
};
static const char *x2000_uart6_groups[] = {
  "uart6-data-a", "uart6-data-c",
};
static const char *x2000_uart7_groups[] = {
  "uart7-data-a", "uart7-data-c",
};
...
static inline void jz4730_config_pin_function(struct ingenic_pinctrl *jzpc,
  ...
  unsigned int mask = GENMASK(1, 0) << idx * 2;
  unsigned int offt = pin / PINS_PER_GPIO_CHIP;
  u8 reg = (pin % PINS_PER_GPIO_CHIP)
      < JZ4730_PINS_PER_PAIRED_REG ? reg_lower : reg_upper;
...
static void ingenic_gpio_irq_print_chip(struct irq_data *data,
    struct seq_file *p) {
  struct gpio_chip *gpio_chip = irq_data_get_irq_chip_data(data);
...
static int ingenic_pinmux_set_pin_fn(struct ingenic_pinctrl *jzpc,
  ...
  if (is_soc_or_above(jzpc, ID_X1000)) {
    ...
    jz4730_config_pin_function(jzpc, pin, JZ4730_GPIO_GPAUR, JZ4730_GPIO_GPALR,
        func);
  }
  return 0;
}
...
static int __init ingenic_pinctrl_probe(struct platform_device *pdev) {
  ...
  for (i = 0; i < chip_info->num_groups; i++) {
    ...
    err = pinctrl_generic_add_group(jzpc->pctl, grp->name, grp->pins,
        grp->npins,
        group->data);
    if (err < 0) {
