...
#define PINGROUP(pingrp_name, grp_fn_name, grp_pins) \
	{ .name = #pingrp_name, .fn_name = #grp_fn_name, \
	  .pins = grp_pins, .npins = ARRAY_SIZE(grp_pins) }

static struct aspeed_g7_soc1_pingroup aspeed_g7_soc1_pingroups[] = {
	PINGROUP(ESPI0, ESPI0, espi0_pins),
	PINGROUP(ESPI1, ESPI1, espi1_pins),
	PINGROUP(LPC0, LPC0, lpc0_pins),
	PINGROUP(LPC1, LPC1, lpc1_pins),
	PINGROUP(SD, SD, sd_pins),
	PINGROUP(VPI, VPI, vpi_pins),
	PINGROUP(OSCCLK, OSCCLK, oscclk_pins),
	PINGROUP(TACH0, TACH0, tach0_pins),
	PINGROUP(TACH1, TACH1, tach1_pins),
	PINGROUP(TACH2, TACH2, tach2_pins),
	PINGROUP(TACH3, TACH3, tach3_pins),
	PINGROUP(THRU0, THRU0, thru0_pins),
	PINGROUP(THRU1, THRU1, thru1_pins),
	PINGROUP(TACH4, TACH4, tach4_pins),
	PINGROUP(TACH5, TACH5, tach5_pins),
	PINGROUP(TACH6, TACH6, tach6_pins),
	PINGROUP(TACH7, TACH7, tach7_pins),
	PINGROUP(NTCS5, NTCS5, ntcs5_pins),
	PINGROUP(NDCD5, NDCD5, ndcd5_pins),
	PINGROUP(NDSR5, NDSR5, ndsr5_pins),
	PINGROUP(NRI5, NRI5, nri5_pins),
	PINGROUP(SALT12, SALT12, salt12_pins),
	PINGROUP(SALT13, SALT13, salt13_pins),
	PINGROUP(SALT14, SALT14, salt14_pins),
	PINGROUP(SALT15, SALT15, salt15_pins),
	PINGROUP(NDTR5, NDTR5, ndtr5_pins),
	PINGROUP(NRTS5, NRTS5, nrts5_pins),
	PINGROUP(NCTS6, NCTS6, ncts6_pins),
	PINGROUP(NDCD6, NDCD6, ndcd6_pins),
	PINGROUP(NDSR6, NDSR6, ndsr6_pins),
	PINGROUP(NRI6, NRI6, nri6_pins),
	PINGROUP(NDTR6, NDTR6, ndtr6_pins),
	PINGROUP(NRTS6, NRTS6, nrts6_pins),
	PINGROUP(TACH8, TACH8, tach8_pins),
	PINGROUP(TACH9, TACH9, tach9_pins),
	PINGROUP(TACH10, TACH10, tach10_pins),
	PINGROUP(TACH11, TACH11, tach11_pins),
	PINGROUP(TACH12, TACH12, tach12_pins),
	PINGROUP(TACH13, TACH13, tach13_pins),
	PINGROUP(TACH14, TACH14, tach14_pins),
	PINGROUP(TACH15, TACH15, tach15_pins),
	PINGROUP(SPIM0, SPIM0, spim0_pins),
	PINGROUP(PWM0, PWM0, pwm0_pins),
	PINGROUP(PWM1, PWM1, pwm1_pins),
	PINGROUP(PWM2, PWM2, pwm2_pins),
	PINGROUP(PWM3, PWM3, pwm3_pins),
	PINGROUP(PWM4, PWM4, pwm4_pins),
	PINGROUP(PWM5, PWM5, pwm5_pins),
	PINGROUP(PWM6, PWM6, pwm6_pins),
	PINGROUP(PWM7, PWM7, pwm7_pins),
	PINGROUP(SIOPBON0, SIOPBON0, siopbon0_pins),
	PINGROUP(SIOPBIN0, SIOPBIN0, siopbin0_pins),
	PINGROUP(SIOSCIN0, SIOSCIN0, sioscin0_pins),
	PINGROUP(SIOS3N0, SIOS3N0, sios3n0_pins),
	PINGROUP(SIOS5N0, SIOS5N0, sios5n0_pins),
	PINGROUP(SIOPWREQN0, SIOPWREQN0, siopwreqn0_pins),
	PINGROUP(SIOONCTRLN0, SIOONCTRLN0, sioonctrln0_pins),
	PINGROUP(SIOPWRGD0, SIOPWRGD0, siopwrgd0_pins),
	PINGROUP(NCTS0, NCTS0, ncts0_pins),
	PINGROUP(NDCD0, NDCD0, ndcd0_pins),
	PINGROUP(NDSR0, NDSR0, ndsr0_pins),
	PINGROUP(NRI0, NRI0, nri0_pins),
	PINGROUP(NDTR0, NDTR0, ndtr0_pins),
	PINGROUP(NRTS0, NRTS0, nrts0_pins),
	PINGROUP(UART0, UART0, uart0_pins),
	PINGROUP(NCTS1, NCTS1, ncts1_pins),
	PINGROUP(NDCD1, NDCD1, ndcd1_pins),
	PINGROUP(NDSR1, NDSR1, ndsr1_pins),
	PINGROUP(NRI1, NRI1, nri1_pins),
	PINGROUP(NDTR1, NDTR1, ndtr1_pins),
	PINGROUP(NRTS1, NRTS1, nrts1_pins),
	PINGROUP(UART1, UART1, uart1_pins),
	PINGROUP(UART2, UART2, uart2_pins),
	PINGROUP(UART3, UART3, uart3_pins),
	PINGROUP(UART5, UART5, uart5_pins),
	PINGROUP(UART6, UART6, uart6_pins),
	PINGROUP(UART7, UART7, uart7_pins),
	PINGROUP(SPIM1, SPIM1, spim1_pins),
	PINGROUP(WDTRST0N, WDTRST0N, wdtrst0n_pins),
	PINGROUP(WDTRST1N, WDTRST1N, wdtrst1n_pins),
	PINGROUP(WDTRST2N, WDTRST2N, wdtrst2n_pins),
	PINGROUP(WDTRST3N, WDTRST3N, wdtrst3n_pins),
	PINGROUP(WDTRST4N, WDTRST4N, wdtrst4n_pins),
	PINGROUP(WDTRST5N, WDTRST5N, wdtrst5n_pins),
	PINGROUP(WDTRST6N, WDTRST6N, wdtrst6n_pins),
	PINGROUP(WDTRST7N, WDTRST7N, wdtrst7n_pins),
	PINGROUP(PWM8, PWM8, pwm8_pins),
	PINGROUP(PWM9, PWM9, pwm9_pins),
	PINGROUP(PWM10, PWM10, pwm10_pins),
	PINGROUP(PWM11, PWM11, pwm11_pins),
	PINGROUP(PWM12, PWM12, pwm12_pins),
	PINGROUP(PWM13, PWM13, pwm13_pins),
	PINGROUP(PWM14, PWM14, pwm14_pins),
	PINGROUP(PWM15, PWM15, pwm15_pins),
	PINGROUP(SALT0, SALT0, salt0_pins),
	PINGROUP(SALT1, SALT1, salt1_pins),
	PINGROUP(SALT2, SALT2, salt2_pins),
	PINGROUP(SALT3, SALT3, salt3_pins),
	PINGROUP(FSI0, FSI0, fsi0_pins),
	PINGROUP(FSI1, FSI1, fsi1_pins),
	PINGROUP(FSI2, FSI2, fsi2_pins),
	PINGROUP(FSI3, FSI3, fsi3_pins),
	PINGROUP(SPIM2, SPIM2, spim2_pins),
	PINGROUP(SALT4, SALT4, salt4_pins),
	PINGROUP(SALT5, SALT5, salt5_pins),
	PINGROUP(SALT6, SALT6, salt6_pins),
	PINGROUP(SALT7, SALT7, salt7_pins),
	PINGROUP(SALT8, SALT8, salt8_pins),
	PINGROUP(SALT9, SALT9, salt9_pins),
	PINGROUP(SALT10, SALT10, salt10_pins),
	PINGROUP(SALT11, SALT11, salt11_pins),
	PINGROUP(ADC0, ADC0, adc0_pins),
	PINGROUP(ADC1, ADC1, adc1_pins),
	PINGROUP(ADC2, ADC2, adc2_pins),
	PINGROUP(ADC3, ADC3, adc3_pins),
	PINGROUP(ADC4, ADC4, adc4_pins),
	PINGROUP(ADC5, ADC5, adc5_pins),
	PINGROUP(ADC6, ADC6, adc6_pins),
	PINGROUP(ADC7, ADC7, adc7_pins),
	PINGROUP(ADC8, ADC8, adc8_pins),
	PINGROUP(ADC9, ADC9, adc9_pins),
	PINGROUP(ADC10, ADC10, adc10_pins),
	PINGROUP(ADC11, ADC11, adc11_pins),
	PINGROUP(ADC12, ADC12, adc12_pins),
	PINGROUP(ADC13, ADC13, adc13_pins),
	PINGROUP(ADC14, ADC14, adc14_pins),
	PINGROUP(ADC15, ADC15, adc15_pins),
	PINGROUP(AUXPWRGOOD0, AUXPWRGOOD0, auxpwrgood0_pins),
	PINGROUP(AUXPWRGOOD1, AUXPWRGOOD1, auxpwrgood1_pins),
	PINGROUP(SGPM0, SGPM0, sgpm0_pins),
	PINGROUP(SGPM1, SGPM1, sgpm1_pins),
	PINGROUP(I2C0, I2C0, i2c0_pins),
	PINGROUP(I2C1, I2C1, i2c1_pins),
	PINGROUP(I2C2, I2C2, i2c2_pins),
	PINGROUP(I2C3, I2C3, i2c3_pins),
	PINGROUP(I2C4, I2C4, i2c4_pins),
	PINGROUP(I2C5, I2C5, i2c5_pins),
	PINGROUP(I2C6, I2C6, i2c6_pins),
	PINGROUP(I2C7, I2C7, i2c7_pins),
	PINGROUP(I2C8, I2C8, i2c8_pins),
	PINGROUP(I2C9, I2C9, i2c9_pins),
	PINGROUP(I2C10, I2C10, i2c10_pins),
	PINGROUP(I2C11, I2C11, i2c11_pins),
	PINGROUP(I2C12, I2C12, i2c12_pins),
	PINGROUP(I2C13, I2C13, i2c13_pins),
	PINGROUP(I2C14, I2C14, i2c14_pins),
	PINGROUP(I2C15, I2C15, i2c15_pins),
	PINGROUP(DI2C8, DI2C8, di2c8_pins),
	PINGROUP(DI2C9, DI2C9, di2c9_pins),
	PINGROUP(DI2C10, DI2C10, di2c10_pins),
	PINGROUP(DI2C13, DI2C13, di2c13_pins),
	PINGROUP(DI2C14, DI2C14, di2c14_pins),
	PINGROUP(DI2C15, DI2C15, di2c15_pins),
	PINGROUP(SIOPBON1, SIOPBON1, siopbon1_pins),
	PINGROUP(SIOPBIN1, SIOPBIN1, siopbin1_pins),
	PINGROUP(SIOSCIN1, SIOSCIN1, sioscin1_pins),
	PINGROUP(SIOS3N1, SIOS3N1, sios3n1_pins),
	PINGROUP(SIOS5N1, SIOS5N1, sios5n1_pins),
	PINGROUP(SIOPWREQN1, SIOPWREQN1, siopwreqn1_pins),
	PINGROUP(SIOONCTRLN1, SIOONCTRLN1, sioonctrln1_pins),
	PINGROUP(SIOPWRGD1, SIOPWRGD1, siopwrgd1_pins),
	PINGROUP(HVI3C0, HVI3C0, hvi3c0_pins),
	PINGROUP(HVI3C1, HVI3C1, hvi3c1_pins),
	PINGROUP(HVI3C2, HVI3C2, hvi3c2_pins),
	PINGROUP(HVI3C3, HVI3C3, hvi3c3_pins),
	PINGROUP(HVI3C4, HVI3C4, hvi3c4_pins),
	PINGROUP(HVI3C5, HVI3C5, hvi3c5_pins),
	PINGROUP(HVI3C6, HVI3C6, hvi3c6_pins),
	PINGROUP(HVI3C7, HVI3C7, hvi3c7_pins),
	PINGROUP(HVI3C10, HVI3C10, hvi3c10_pins),
	PINGROUP(HVI3C11, HVI3C11, hvi3c11_pins),
	PINGROUP(I3C4, I3C4, i3c4_pins),
	PINGROUP(I3C5, I3C5, i3c5_pins),
	PINGROUP(I3C6, I3C6, i3c6_pins),
	PINGROUP(I3C7, I3C7, i3c7_pins),
	PINGROUP(I3C8, I3C8, i3c8_pins),
	PINGROUP(I3C9, I3C9, i3c9_pins),
	PINGROUP(I3C10, I3C10, i3c10_pins),
	PINGROUP(I3C11, I3C11, i3c11_pins),
	PINGROUP(I3C0, I3C0, i3c0_pins),
	PINGROUP(I3C1, I3C1, i3c1_pins),
	PINGROUP(I3C2, I3C2, i3c2_pins),
	PINGROUP(I3C3, I3C3, i3c3_pins),
	PINGROUP(LTPI, LTPI, ltpi_pins),
	PINGROUP(SPI0, SPI0, spi0_pins),
	PINGROUP(QSPI0, QSPI0, qspi0_pins),
	PINGROUP(SPI0CS1, SPI0CS1, spi0cs1_pins),
	PINGROUP(SPI0ABR, SPI0ABR, spi0abr_pins),
	PINGROUP(SPI0WPN, SPI0WPN, spi0wpn_pins),
	PINGROUP(SPI1, SPI1, spi1_pins),
	PINGROUP(QSPI1, QSPI1, qspi1_pins),
	PINGROUP(SPI1CS1, SPI1CS1, spi1cs1_pins),
	PINGROUP(SPI1ABR, SPI1ABR, spi1abr_pins),
	PINGROUP(SPI1WPN, SPI1WPN, spi1wpn_pins),
	PINGROUP(SPI2, SPI2, spi2_pins),
	PINGROUP(QSPI2, QSPI2, qspi2_pins),
	PINGROUP(SPI2CS1, SPI2CS1, spi2cs1_pins),
	PINGROUP(THRU2, THRU2, thru2_pins),
	PINGROUP(THRU3, THRU3, thru3_pins),
	PINGROUP(JTAGM1, JTAGM1, jtagm1_pins),
	PINGROUP(MDIO0, MDIO0, mdio0_pins),
	PINGROUP(MDIO1, MDIO1, mdio1_pins),
	PINGROUP(MDIO2, MDIO2, mdio2_pins),
	PINGROUP(FWQSPI, FWQSPI, fwqspi_pins),
	PINGROUP(FWSPIABR, FWSPIABR, fwspiabr_pins),
	PINGROUP(FWSPIWPN, FWSPIWPN, fwspiwpn_pins),
	PINGROUP(RGMII0, RGMII0, rgmii0_pins),
	PINGROUP(RGMII1, RGMII1, rgmii1_pins),
	PINGROUP(RMII0, RMII0, rmii0_pins),
	PINGROUP(RMII1, RMII1, rmii1_pins),
	PINGROUP(VGA, VGA, vga_pins),
	PINGROUP(DSGPM1, DSGPM1, dsgpm1_pins),
	PINGROUP(SGPS, SGPS, sgps_pins),
	PINGROUP(I2CF0, I2CF0, i2cf0_pins),
	PINGROUP(I2CF1, I2CF1, i2cf1_pins),
	PINGROUP(I2CF2, I2CF2, i2cf2_pins),
	PINGROUP(CANBUS, CANBUS, canbus_pins),
	PINGROUP(USBUART, USBUART, usbuart_pins),
	PINGROUP(HBLED, HBLED, hbled_pins),
	PINGROUP(MACLINK0, MACLINK0, maclink0_pins),
	PINGROUP(MACLINK1, MACLINK1, maclink1_pins),
	PINGROUP(MACLINK2, MACLINK2, maclink2_pins),
	PINGROUP(NCTS2, NCTS2, ncts2_pins),
	PINGROUP(NDCD2, NDCD2, ndcd2_pins),
	PINGROUP(NDSR2, NDSR2, ndsr2_pins),
	PINGROUP(NRI2, NRI2, nri2_pins),
	PINGROUP(NDTR2, NDTR2, ndtr2_pins),
	PINGROUP(NRTS2, NRTS2, nrts2_pins),
	PINGROUP(SMON0, SMON0, smon0_pins),
	PINGROUP(SMON1, SMON1, smon1_pins)
};
...
#define IO_FUNC(fn_name, fn_group) \
		{ .name = #fn_name, .ngroups = ARRAY_SIZE(fn_group), .groups = fn_group }

static struct aspeed_g7_soc1_func aspeed_g7_soc1_funcs[] = {
	IO_FUNC(ESPI0, espi0_grp),
	IO_FUNC(ESPI1, espi1_grp),
	IO_FUNC(LPC0, lpc0_grp),
	IO_FUNC(LPC1, lpc1_grp),
	IO_FUNC(VPI, vpi_grp),
	IO_FUNC(SD, sd_grp),
	IO_FUNC(OSCCLK, oscclk_grp),
	IO_FUNC(HVI3C0, hvi3c0_grp),
	IO_FUNC(HVI3C1, hvi3c1_grp),
	IO_FUNC(HVI3C2, hvi3c2_grp),
	IO_FUNC(HVI3C3, hvi3c3_grp),
	IO_FUNC(HVI3C4, hvi3c4_grp),
	IO_FUNC(HVI3C5, hvi3c5_grp),
	IO_FUNC(HVI3C6, hvi3c6_grp),
	IO_FUNC(HVI3C7, hvi3c7_grp),
	IO_FUNC(HVI3C10, hvi3c10_grp),
	IO_FUNC(HVI3C11, hvi3c11_grp),
	IO_FUNC(TACH0, tach0_grp),
	IO_FUNC(TACH1, tach1_grp),
	IO_FUNC(TACH2, tach2_grp),
	IO_FUNC(TACH3, tach3_grp),
	IO_FUNC(TACH4, tach4_grp),
	IO_FUNC(TACH5, tach5_grp),
	IO_FUNC(TACH6, tach6_grp),
	IO_FUNC(TACH7, tach7_grp),
	IO_FUNC(THRU0, thru0_grp),
	IO_FUNC(THRU1, thru1_grp),
	IO_FUNC(NTCS5, ntcs5_grp),
	IO_FUNC(NTCS5, ndcd5_grp),
	IO_FUNC(NDSR5, ndsr5_grp),
	IO_FUNC(NRI5, nri5_grp),
	IO_FUNC(NRI5, nri5_grp),
	IO_FUNC(SALT12, salt12_grp),
	IO_FUNC(SALT13, salt13_grp),
	IO_FUNC(SALT14, salt14_grp),
	IO_FUNC(SALT15, salt15_grp),
	IO_FUNC(NDTR5, ndtr5_grp),
	IO_FUNC(NRTS5, nrts5_grp),
	IO_FUNC(NCTS6, ncts6_grp),
	IO_FUNC(NDCD6, ndcd6_grp),
	IO_FUNC(NDSR6, ndsr6_grp),
	IO_FUNC(NRI6, nri6_grp),
	IO_FUNC(NDTR6, ndtr6_grp),
	IO_FUNC(NRTS6, nrts6_grp),
	IO_FUNC(TACH8, tach8_grp),
	IO_FUNC(TACH9, tach9_grp),
	IO_FUNC(TACH10, tach10_grp),
	IO_FUNC(TACH11, tach11_grp),
	IO_FUNC(TACH12, tach12_grp),
	IO_FUNC(TACH13, tach13_grp),
	IO_FUNC(TACH14, tach14_grp),
	IO_FUNC(TACH15, tach15_grp),
	IO_FUNC(SPIM0, spim0_grp),
	IO_FUNC(PWM0, pwm0_grp),
	IO_FUNC(PWM1, pwm1_grp),
	IO_FUNC(PWM2, pwm2_grp),
	IO_FUNC(PWM3, pwm3_grp),
	IO_FUNC(PWM4, pwm4_grp),
	IO_FUNC(PWM5, pwm5_grp),
	IO_FUNC(PWM6, pwm6_grp),
	IO_FUNC(PWM7, pwm7_grp),
	IO_FUNC(SIOPBON0, siopbon0_grp),
	IO_FUNC(SIOPBIN0, siopbin0_grp),
	IO_FUNC(SIOSCIN0, sioscin0_grp),
	IO_FUNC(SIOS3N0, sios3n0_grp),
	IO_FUNC(SIOS5N0, sios5n0_grp),
	IO_FUNC(SIOPWREQN0, siopwreqn0_grp),
	IO_FUNC(SIOONCTRLN0, sioonctrln0_grp),
	IO_FUNC(SIOPWRGD0, siopwrgd0_grp),
	IO_FUNC(NCTS0, ncts0_grp),
	IO_FUNC(NDCD0, ndcd0_grp),
	IO_FUNC(NDSR0, ndsr0_grp),
	IO_FUNC(NRI0, nri0_grp),
	IO_FUNC(NDTR0, ndtr0_grp),
	IO_FUNC(NRTS0, nrts0_grp),
	IO_FUNC(UART0, uart0_grp),
	IO_FUNC(NCTS1, ncts1_grp),
	IO_FUNC(NDCD1, ndcd1_grp),
	IO_FUNC(NDSR1, ndsr1_grp),
	IO_FUNC(NRI1, nri1_grp),
	IO_FUNC(NDTR1, ndtr1_grp),
	IO_FUNC(NRTS1, nrts1_grp),
	IO_FUNC(UART1, uart1_grp),
	IO_FUNC(UART2, uart2_grp),
	IO_FUNC(UART3, uart3_grp),
	IO_FUNC(UART5, uart5_grp),
	IO_FUNC(UART6, uart6_grp),
	IO_FUNC(UART7, uart7_grp),
	IO_FUNC(SPIM1, spim1_grp),
	IO_FUNC(PWM7, pwm7_grp),
	IO_FUNC(PWM8, pwm8_grp),
	IO_FUNC(PWM9, pwm9_grp),
	IO_FUNC(PWM10, pwm10_grp),
	IO_FUNC(PWM11, pwm11_grp),
	IO_FUNC(PWM12, pwm12_grp),
	IO_FUNC(PWM13, pwm13_grp),
	IO_FUNC(PWM14, pwm14_grp),
	IO_FUNC(PWM15, pwm15_grp),
	IO_FUNC(WDTRST0N, wdtrst0n_grp),
	IO_FUNC(WDTRST1N, wdtrst1n_grp),
	IO_FUNC(WDTRST2N, wdtrst2n_grp),
	IO_FUNC(WDTRST3N, wdtrst3n_grp),
	IO_FUNC(WDTRST4N, wdtrst4n_grp),
	IO_FUNC(WDTRST5N, wdtrst5n_grp),
	IO_FUNC(WDTRST6N, wdtrst6n_grp),
	IO_FUNC(WDTRST7N, wdtrst7n_grp),
	IO_FUNC(FSI0, fsi0_grp),
	IO_FUNC(FSI1, fsi1_grp),
	IO_FUNC(FSI2, fsi2_grp),
	IO_FUNC(FSI3, fsi3_grp),
	IO_FUNC(SALT4, salt4_grp),
	IO_FUNC(SALT5, salt5_grp),
	IO_FUNC(SALT6, salt6_grp),
	IO_FUNC(SALT7, salt7_grp),
	IO_FUNC(SALT8, salt8_grp),
	IO_FUNC(SALT9, salt9_grp),
	IO_FUNC(SALT10, salt10_grp),
	IO_FUNC(SALT11, salt11_grp),
	IO_FUNC(ADC0, adc0_grp),
	IO_FUNC(ADC1, adc1_grp),
	IO_FUNC(ADC2, adc2_grp),
	IO_FUNC(ADC3, adc3_grp),
	IO_FUNC(ADC4, adc4_grp),
	IO_FUNC(ADC5, adc5_grp),
	IO_FUNC(ADC6, adc6_grp),
	IO_FUNC(ADC7, adc7_grp),
	IO_FUNC(ADC8, adc8_grp),
	IO_FUNC(ADC9, adc9_grp),
	IO_FUNC(ADC10, adc10_grp),
	IO_FUNC(ADC11, adc11_grp),
	IO_FUNC(ADC12, adc12_grp),
	IO_FUNC(ADC13, adc13_grp),
	IO_FUNC(ADC14, adc14_grp),
	IO_FUNC(ADC15, adc15_grp),
	IO_FUNC(AUXPWRGOOD0, auxpwrgood0_grp),
	IO_FUNC(AUXPWRGOOD1, auxpwrgood1_grp),
	IO_FUNC(SGPM0, sgpm0_grp),
	IO_FUNC(SGPM1, sgpm1_grp),
	IO_FUNC(SPIM2, spim2_grp),
	IO_FUNC(I2C0, i2c0_grp),
	IO_FUNC(I2C1, i2c1_grp),
	IO_FUNC(I2C2, i2c2_grp),
	IO_FUNC(I2C3, i2c3_grp),
	IO_FUNC(I2C4, i2c4_grp),
	IO_FUNC(I2C5, i2c5_grp),
	IO_FUNC(I2C6, i2c6_grp),
	IO_FUNC(I2C7, i2c7_grp),
	IO_FUNC(I2C8, i2c8_grp),
	IO_FUNC(I2C9, i2c9_grp),
	IO_FUNC(I2C10, i2c10_grp),
	IO_FUNC(I2C11, i2c11_grp),
	IO_FUNC(I2C12, i2c12_grp),
	IO_FUNC(I2C13, i2c13_grp),
	IO_FUNC(I2C14, i2c14_grp),
	IO_FUNC(I2C15, i2c15_grp),
	IO_FUNC(DI2C8, di2c8_grp),
	IO_FUNC(DI2C9, di2c9_grp),
	IO_FUNC(DI2C10, di2c10_grp),
	IO_FUNC(DI2C13, di2c13_grp),
	IO_FUNC(DI2C14, di2c14_grp),
	IO_FUNC(DI2C15, di2c15_grp),
	IO_FUNC(SIOPBON1, siopbon1_grp),
	IO_FUNC(SIOPBIN1, siopbin1_grp),
	IO_FUNC(SIOSCIN1, sioscin1_grp),
	IO_FUNC(SIOS3N1, sios3n1_grp),
	IO_FUNC(SIOS5N1, sios5n1_grp),
	IO_FUNC(SIOPWREQN1, siopwreqn1_grp),
	IO_FUNC(SIOONCTRLN1, sioonctrln1_grp),
	IO_FUNC(SIOPWRGD1, siopwrgd1_grp),
	IO_FUNC(I3C0, i3c0_grp),
	IO_FUNC(I3C1, i3c1_grp),
	IO_FUNC(I3C2, i3c2_grp),
	IO_FUNC(I3C3, i3c3_grp),
	IO_FUNC(I3C4, i3c4_grp),
	IO_FUNC(I3C5, i3c5_grp),
	IO_FUNC(I3C6, i3c6_grp),
	IO_FUNC(I3C7, i3c7_grp),
	IO_FUNC(I3C8, i3c8_grp),
	IO_FUNC(I3C9, i3c9_grp),
	IO_FUNC(I3C10, i3c10_grp),
	IO_FUNC(I3C11, i3c11_grp),
	IO_FUNC(LTPI, ltpi_grp),
	IO_FUNC(SPI0, spi0_grp),
	IO_FUNC(QSPI0, qspi0_grp),
	IO_FUNC(SPI0CS1, spi0cs1_grp),
	IO_FUNC(SPI0ABR, spi0abr_grp),
	IO_FUNC(SPI0WPN, spi0wpn_grp),
	IO_FUNC(SPI1, spi1_grp),
	IO_FUNC(QSPI1, qspi1_grp),
	IO_FUNC(SPI1CS1, spi1cs1_grp),
	IO_FUNC(SPI1ABR, spi1abr_grp),
	IO_FUNC(SPI1WPN, spi1wpn_grp),
	IO_FUNC(SPI2, spi2_grp),
	IO_FUNC(QSPI2, qspi2_grp),
	IO_FUNC(SPI2CS1, spi2cs1_grp),
	IO_FUNC(THRU2, thru2_grp),
	IO_FUNC(THRU3, thru3_grp),
	IO_FUNC(JTAGM1, jtagm1_grp),
	IO_FUNC(MDIO0, mdio0_grp),
	IO_FUNC(MDIO1, mdio1_grp),
	IO_FUNC(MDIO2, mdio2_grp),
	IO_FUNC(FWQSPI, fwqspi_grp),
	IO_FUNC(FWSPIABR, fwspiabr_grp),
	IO_FUNC(FWSPIWPN, fwspiwpn_grp),
	IO_FUNC(RGMII0, rgmii0_grp),
	IO_FUNC(RGMII1, rgmii1_grp),
	IO_FUNC(RMII0, rmii0_grp),
	IO_FUNC(RMII1, rmii1_grp),
	IO_FUNC(VGA, vga_grp),
	IO_FUNC(DSGPM1, dsgpm1_grp),
	IO_FUNC(SGPS, sgps_grp),
	IO_FUNC(I2CF0, i2cf0_grp),
	IO_FUNC(I2CF1, i2cf1_grp),
	IO_FUNC(I2CF2, i2cf2_grp),
	IO_FUNC(CANBUS, canbus_grp),
	IO_FUNC(USBUART, usbuart_grp),
	IO_FUNC(HBLED, hbled_grp),
	IO_FUNC(MACLINK0, maclink0_grp),
	IO_FUNC(MACLINK1, maclink1_grp),
	IO_FUNC(MACLINK2, maclink2_grp),
	IO_FUNC(NCTS2, ncts2_grp),
	IO_FUNC(NDCD2, ndcd2_grp),
	IO_FUNC(NDSR2, ndsr2_grp),
	IO_FUNC(NRI2, nri2_grp),
	IO_FUNC(NDTR2, ndtr2_grp),
	IO_FUNC(NRTS2, nrts2_grp),
	IO_FUNC(SMON0, smon0_grp),
	IO_FUNC(SMON1, smon1_grp),
};
