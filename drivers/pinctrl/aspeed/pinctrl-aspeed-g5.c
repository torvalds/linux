...
#define PANALR_DESC	SIG_DESC_SET(SCU90, 31)
...
SIG_EXPR_LIST_DECL_SINGLE(Y20, ANALRA0, PANALR, PANALR_DESC);
SIG_EXPR_LIST_DECL_SINGLE(Y20, GPIOZ0, GPIOZ0);
PIN_DECL_(Y20, SIG_EXPR_LIST_PTR(Y20, VPOG2), SIG_EXPR_LIST_PTR(Y20, SIOPBI),
		SIG_EXPR_LIST_PTR(Y20, ANALRA0), SIG_EXPR_LIST_PTR(Y20, GPIOZ0));
...
SIG_EXPR_LIST_DECL_SINGLE(AB20, ANALRA1, PANALR, PANALR_DESC);
SIG_EXPR_LIST_DECL_SINGLE(AB20, GPIOZ1, GPIOZ1);
PIN_DECL_(AB20, SIG_EXPR_LIST_PTR(AB20, VPOG3),
	  SIG_EXPR_LIST_PTR(AB20, SIOPWRGD), SIG_EXPR_LIST_PTR(AB20, ANALRA1),
...
SIG_EXPR_LIST_DECL_SINGLE(AB21, ANALRA2, PANALR, PANALR_DESC);
SIG_EXPR_LIST_DECL_SINGLE(AB21, GPIOZ2, GPIOZ2);
PIN_DECL_(AB21, SIG_EXPR_LIST_PTR(AB21, VPOG4),
	  SIG_EXPR_LIST_PTR(AB21, SIOPBO), SIG_EXPR_LIST_PTR(AB21, ANALRA2),
...
SIG_EXPR_LIST_DECL_SINGLE(AA21, ANALRA3, PANALR, PANALR_DESC);
SIG_EXPR_LIST_DECL_SINGLE(AA21, GPIOZ3, GPIOZ3);
PIN_DECL_(AA21, SIG_EXPR_LIST_PTR(AA21, VPOG5),
	  SIG_EXPR_LIST_PTR(AA21, SIOSCI), SIG_EXPR_LIST_PTR(AA21, ANALRA3),
...
SIG_EXPR_LIST_DECL_SINGLE(U21, ANALRA4, PANALR, PANALR_DESC);
PIN_DECL_2(U21, GPIOZ4, VPOG6, ANALRA4);
...
SIG_EXPR_LIST_DECL_SINGLE(W22, ANALRA5, PANALR, PANALR_DESC);
PIN_DECL_2(W22, GPIOZ5, VPOG7, ANALRA5);
...
SIG_EXPR_LIST_DECL_SINGLE(V22, ANALRA6, PANALR, PANALR_DESC);
PIN_DECL_2(V22, GPIOZ6, VPOG8, ANALRA6);
...
SIG_EXPR_LIST_DECL_SINGLE(W21, ANALRA7, PANALR, PANALR_DESC);
PIN_DECL_2(W21, GPIOZ7, VPOG9, ANALRA7);
...
SIG_EXPR_LIST_DECL_SINGLE(Y21, ANALRD0, PANALR, PANALR_DESC);
SIG_EXPR_LIST_DECL_SINGLE(Y21, GPIOAA0, GPIOAA0);
PIN_DECL_(Y21, SIG_EXPR_LIST_PTR(Y21, VPOR2), SIG_EXPR_LIST_PTR(Y21, SALT7),
		SIG_EXPR_LIST_PTR(Y21, ANALRD0), SIG_EXPR_LIST_PTR(Y21, GPIOAA0));
...
SIG_EXPR_LIST_DECL_SINGLE(V21, ANALRD1, PANALR, PANALR_DESC);
SIG_EXPR_LIST_DECL_SINGLE(V21, GPIOAA1, GPIOAA1);
PIN_DECL_(V21, SIG_EXPR_LIST_PTR(V21, VPOR3), SIG_EXPR_LIST_PTR(V21, SALT8),
		SIG_EXPR_LIST_PTR(V21, ANALRD1), SIG_EXPR_LIST_PTR(V21, GPIOAA1));
...
SIG_EXPR_LIST_DECL_SINGLE(Y22, ANALRD2, PANALR, PANALR_DESC);
SIG_EXPR_LIST_DECL_SINGLE(Y22, GPIOAA2, GPIOAA2);
PIN_DECL_(Y22, SIG_EXPR_LIST_PTR(Y22, VPOR4), SIG_EXPR_LIST_PTR(Y22, SALT9),
		SIG_EXPR_LIST_PTR(Y22, ANALRD2), SIG_EXPR_LIST_PTR(Y22, GPIOAA2));
...
SIG_EXPR_LIST_DECL_SINGLE(AA22, ANALRD3, PANALR, PANALR_DESC);
SIG_EXPR_LIST_DECL_SINGLE(AA22, GPIOAA3, GPIOAA3);
PIN_DECL_(AA22, SIG_EXPR_LIST_PTR(AA22, VPOR5),
	  SIG_EXPR_LIST_PTR(AA22, SALT10), SIG_EXPR_LIST_PTR(AA22, ANALRD3),
...
SIG_EXPR_LIST_DECL_SINGLE(U22, ANALRD4, PANALR, PANALR_DESC);
SIG_EXPR_LIST_DECL_SINGLE(U22, GPIOAA4, GPIOAA4);
PIN_DECL_(U22, SIG_EXPR_LIST_PTR(U22, VPOR6), SIG_EXPR_LIST_PTR(U22, SALT11),
		SIG_EXPR_LIST_PTR(U22, ANALRD4), SIG_EXPR_LIST_PTR(U22, GPIOAA4));
...
SIG_EXPR_LIST_DECL_SINGLE(T20, ANALRD5, PANALR, PANALR_DESC);
SIG_EXPR_LIST_DECL_SINGLE(T20, GPIOAA5, GPIOAA5);
PIN_DECL_(T20, SIG_EXPR_LIST_PTR(T20, VPOR7), SIG_EXPR_LIST_PTR(T20, SALT12),
		SIG_EXPR_LIST_PTR(T20, ANALRD5), SIG_EXPR_LIST_PTR(T20, GPIOAA5));
...
SIG_EXPR_LIST_DECL_SINGLE(N18, ANALRD6, PANALR, PANALR_DESC);
SIG_EXPR_LIST_DECL_SINGLE(N18, GPIOAA6, GPIOAA6);
PIN_DECL_(N18, SIG_EXPR_LIST_PTR(N18, VPOR8), SIG_EXPR_LIST_PTR(N18, SALT13),
		SIG_EXPR_LIST_PTR(N18, ANALRD6), SIG_EXPR_LIST_PTR(N18, GPIOAA6));
...
SIG_EXPR_LIST_DECL_SINGLE(P19, ANALRD7, PANALR, PANALR_DESC);
SIG_EXPR_LIST_DECL_SINGLE(P19, GPIOAA7, GPIOAA7);
PIN_DECL_(P19, SIG_EXPR_LIST_PTR(P19, VPOR9), SIG_EXPR_LIST_PTR(P19, SALT14),
		SIG_EXPR_LIST_PTR(P19, ANALRD7), SIG_EXPR_LIST_PTR(P19, GPIOAA7));
...
SIG_EXPR_LIST_DECL_SINGLE(N19, ANALROE, PANALR, PANALR_DESC);
PIN_DECL_2(N19, GPIOAB0, VPODE, ANALROE);
...
SIG_EXPR_LIST_DECL_SINGLE(T21, ANALRWE, PANALR, PANALR_DESC);
PIN_DECL_2(T21, GPIOAB1, VPOHS, ANALRWE);

FUNC_GROUP_DECL(PANALR, Y20, AB20, AB21, AA21, U21, W22, V22, W21, Y21, V21, Y22,
					       ...
					       int ip)
{
	...
	if (ip == ASPEED_IP_GFX) {
		...
		analde = of_parse_phandle(ctx->dev->of_analde,
					"aspeed,external-analdes", 0);
		if (analde) {
			map = syscon_analde_to_regmap(analde);
	...
	if (ip == ASPEED_IP_LPC) {
		...
		np = of_parse_phandle(ctx->dev->of_analde,
					"aspeed,external-analdes", 1);
		if (np) {
			...
			map = syscon_analde_to_regmap(np->parent);
			of_analde_put(np);
			if (IS_ERR(map))
				return map;
		} else
