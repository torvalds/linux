...
#define C18 64
SIG_EXPR_DECL(SYSCS, SPI1DE, COND1, SPI1DE_DESC);
...
#define E15 65
SIG_EXPR_DECL(SYSCK, SPI1DE, COND1, SPI1DE_DESC);
...
#define B16 66
SIG_EXPR_DECL(SYSMOSI, SPI1DE, COND1, SPI1DE_DESC);
SIG_EXPR_DECL(SYSMOSI, SPI1PASSTHRU, COND1, SPI1PASSTHRU_DESC);
SIG_EXPR_LIST_DECL_DUAL(SYSMOSI, SPI1DE, SPI1PASSTHRU);
SS_PIN_DECL(B16, GPIOI2, SYSMOSI);

#define C16 67
SIG_EXPR_DECL(SYSMISO, SPI1DE, COND1, SPI1DE_DESC);
SIG_EXPR_DECL(SYSMISO, SPI1PASSTHRU, COND1, SPI1PASSTHRU_DESC);
SIG_EXPR_LIST_DECL_DUAL(SYSMISO, SPI1DE, SPI1PASSTHRU);
...
SIG_EXPR_DECL(SPI1CS0, SPI1DE, COND1, SPI1DE_DESC);
...
SIG_EXPR_DECL(SPI1CK, SPI1DE, COND1, SPI1DE_DESC);
...
FUNC_GROUP_DECL(SPI1DE, C18, E15, B16, C16, B15, C15, A14, A15);
