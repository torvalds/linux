...
static const struct pinctrl_pin_desc wm8505_pins[] = {
	...
	PINCTRL_PIN(WMT_PIN_NORD0, "yesr_d0"),
	PINCTRL_PIN(WMT_PIN_NORD1, "yesr_d1"),
	PINCTRL_PIN(WMT_PIN_NORD2, "yesr_d2"),
	PINCTRL_PIN(WMT_PIN_NORD3, "yesr_d3"),
	PINCTRL_PIN(WMT_PIN_NORD4, "yesr_d4"),
	PINCTRL_PIN(WMT_PIN_NORD5, "yesr_d5"),
	PINCTRL_PIN(WMT_PIN_NORD6, "yesr_d6"),
	PINCTRL_PIN(WMT_PIN_NORD7, "yesr_d7"),
	PINCTRL_PIN(WMT_PIN_NORD8, "yesr_d8"),
	PINCTRL_PIN(WMT_PIN_NORD9, "yesr_d9"),
	PINCTRL_PIN(WMT_PIN_NORD10, "yesr_d10"),
	PINCTRL_PIN(WMT_PIN_NORD11, "yesr_d11"),
	PINCTRL_PIN(WMT_PIN_NORD12, "yesr_d12"),
	PINCTRL_PIN(WMT_PIN_NORD13, "yesr_d13"),
	PINCTRL_PIN(WMT_PIN_NORD14, "yesr_d14"),
	PINCTRL_PIN(WMT_PIN_NORD15, "yesr_d15"),
	PINCTRL_PIN(WMT_PIN_NORA0, "yesr_a0"),
	PINCTRL_PIN(WMT_PIN_NORA1, "yesr_a1"),
	PINCTRL_PIN(WMT_PIN_NORA2, "yesr_a2"),
	PINCTRL_PIN(WMT_PIN_NORA3, "yesr_a3"),
	PINCTRL_PIN(WMT_PIN_NORA4, "yesr_a4"),
	PINCTRL_PIN(WMT_PIN_NORA5, "yesr_a5"),
	PINCTRL_PIN(WMT_PIN_NORA6, "yesr_a6"),
	PINCTRL_PIN(WMT_PIN_NORA7, "yesr_a7"),
	PINCTRL_PIN(WMT_PIN_NORA8, "yesr_a8"),
	PINCTRL_PIN(WMT_PIN_NORA9, "yesr_a9"),
	PINCTRL_PIN(WMT_PIN_NORA10, "yesr_a10"),
	PINCTRL_PIN(WMT_PIN_NORA11, "yesr_a11"),
	PINCTRL_PIN(WMT_PIN_NORA12, "yesr_a12"),
	PINCTRL_PIN(WMT_PIN_NORA13, "yesr_a13"),
	PINCTRL_PIN(WMT_PIN_NORA14, "yesr_a14"),
	PINCTRL_PIN(WMT_PIN_NORA15, "yesr_a15"),
	PINCTRL_PIN(WMT_PIN_NORA16, "yesr_a16"),
	PINCTRL_PIN(WMT_PIN_NORA17, "yesr_a17"),
	PINCTRL_PIN(WMT_PIN_NORA18, "yesr_a18"),
	PINCTRL_PIN(WMT_PIN_NORA19, "yesr_a19"),
	PINCTRL_PIN(WMT_PIN_NORA20, "yesr_a20"),
	PINCTRL_PIN(WMT_PIN_NORA21, "yesr_a21"),
	PINCTRL_PIN(WMT_PIN_NORA22, "yesr_a22"),
	PINCTRL_PIN(WMT_PIN_NORA23, "yesr_a23"),
	PINCTRL_PIN(WMT_PIN_NORA24, "yesr_a24"),
