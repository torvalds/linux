...
static struct sprd_pin *sprd_pinctrl_get_pin_by_id(
    struct sprd_pinctrl *sprd_pctl, unsigned int id) {
  struct sprd_pinctrl_soc_info *info = sprd_pctl->info;
...
static const struct sprd_pin_group *sprd_pinctrl_find_group_by_name(
