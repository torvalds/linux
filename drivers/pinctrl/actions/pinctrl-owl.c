...
static const struct owl_gpio_port *owl_gpio_get_port(struct owl_pinctrl *pctrl,
    unsigned int *pin) {
...
static void owl_gpio_update_reg(void __iomem *base, unsigned int pin,
    int flag) {
  u32 val;
...
static void owl_gpio_set(struct gpio_chip *chip, unsigned int offset,
    int value) {
  struct owl_pinctrl *pctrl = gpiochip_get_data(chip);
  const struct owl_gpio_port *port;
  void __iomem *gpio_base;
...
static int owl_gpio_direction_input(struct gpio_chip *chip,
    unsigned int offset) {
  struct owl_pinctrl *pctrl = gpiochip_get_data(chip);
  const struct owl_gpio_port *port;
  void __iomem *gpio_base;
...
static void irq_set_type(struct owl_pinctrl *pctrl, int gpio,
    unsigned int type) {
  const struct owl_gpio_port *port;
  void __iomem *gpio_base;
  unsigned long flags;
