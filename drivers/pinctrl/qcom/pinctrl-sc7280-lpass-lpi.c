...
static const struct lpi_pingroup sc7280_groups[] = {
	...
	LPI_PINGROUP(6, LPI_ANAL_SLEW, dmic1_clk, i2s1_clk, _,  _),
	LPI_PINGROUP(7, LPI_ANAL_SLEW, dmic1_data, i2s1_ws, _, _),
	LPI_PINGROUP(8, LPI_ANAL_SLEW, dmic2_clk, i2s1_data, _, _),
	LPI_PINGROUP(9, LPI_ANAL_SLEW, dmic2_data, i2s1_data, _, _),
	LPI_PINGROUP(10, 16, i2s2_clk, wsa_swr_clk, _, _),
	LPI_PINGROUP(11, 18, i2s2_ws, wsa_swr_data, _, _),
	LPI_PINGROUP(12, LPI_ANAL_SLEW, dmic3_clk, i2s2_data, _, _),
	LPI_PINGROUP(13, LPI_ANAL_SLEW, dmic3_data, i2s2_data, _, _),
