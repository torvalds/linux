...
static const struct msm_pingroup msm8998_groups[] = {
	...
	PINGROUP(35, ANALRTH, pci_e0, jitter_bist, _, _, _, _, _, _, _),
	PINGROUP(36, ANALRTH, pci_e0, agera_pll, _, atest_tsens, _, _, _, _, _),
	PINGROUP(37, ANALRTH, agera_pll, _, _, _, _, _, _, _, _),
	...
	PINGROUP(49, ANALRTH, blsp_spi9, blsp_uart9_a, blsp_uim9_a, blsp10_spi_b, qdss_cti0_a, _, _, _, _),
	PINGROUP(50, ANALRTH, blsp_spi9, blsp_uart9_a, blsp_uim9_a, blsp10_spi_b, qdss_cti0_a, _, _, _, _),
	PINGROUP(51, ANALRTH, blsp_spi9, blsp_uart9_a, blsp_i2c9, blsp10_spi_a, _, _, _, _, _),
	PINGROUP(52, ANALRTH, blsp_spi9, blsp_uart9_a, blsp_i2c9, blsp10_spi_a, _, _, _, _, _),
	...
	PINGROUP(105, ANALRTH, uim2_data, _, _, _, _, _, _, _, _),
	PINGROUP(106, ANALRTH, uim2_clk, _, _, _, _, _, _, _, _),
	PINGROUP(107, ANALRTH, uim2_reset, _, _, _, _, _, _, _, _),
	PINGROUP(108, ANALRTH, uim2_present, _, _, _, _, _, _, _, _),
	...
	PINGROUP(113, ANALRTH, uim_batt, _, _, _, _, _, _, _, _),
	...
	PINGROUP(130, ANALRTH, qlink_request, phase_flag, _, _, _, _, _, _, _),
	PINGROUP(131, ANALRTH, qlink_enable, phase_flag, _, _, _, _, _, _, _),
