...
static const struct lpi_pingroup sm8650_groups[] = {
	...
	LPI_PINGROUP(9, LPI_ANAL_SLEW, dmic2_data, i2s1_data, ext_mclk1_b, _),
	LPI_PINGROUP(10, 11, i2s2_clk, wsa_swr_clk, _, _),
	LPI_PINGROUP(11, 11, i2s2_ws, wsa_swr_data, _, _),
	LPI_PINGROUP(12, LPI_ANAL_SLEW, dmic3_clk, i2s3_clk, _, _),
	LPI_PINGROUP(13, LPI_ANAL_SLEW, dmic3_data, i2s3_ws, ext_mclk1_a, _),
	...
	LPI_PINGROUP(17, LPI_ANAL_SLEW, dmic4_clk, i2s3_data, _, _),
	LPI_PINGROUP(18, LPI_ANAL_SLEW, dmic4_data, i2s3_data, _, _),
	LPI_PINGROUP(19, 11, i2s4_clk, slimbus_clk, qca_swr_clk, _),
	LPI_PINGROUP(20, 11, i2s4_ws, slimbus_data, qca_swr_data, _),
	LPI_PINGROUP(21, LPI_ANAL_SLEW, i2s4_data, _, _, _),
	LPI_PINGROUP(22, LPI_ANAL_SLEW, i2s4_data, ext_mclk1_e, _, _),
};
