...
static const char * const cci_i2c_groups[] = {
  "gpio110", "gpio111", "gpio112", "gpio113", "gpio114", "gpio115", "gpio208",
  "gpio209",
};
...
static const char * const phase_flag_groups[] = {
  ...
  "gpio14", "gpio15", "gpio16", "gpio17", "gpio18", "gpio19", "gpio25",
  "gpio26",
  "gpio76", "gpio77", "gpio78", "gpio79", "gpio81", "gpio82", "gpio83",
  "gpio92",
...
static const char * const qdss_gpio_groups[] = {
  "gpio100", "gpio101", "gpio102", "gpio103", "gpio104", "gpio105", "gpio106",
  "gpio107",
  "gpio110", "gpio111", "gpio112", "gpio113", "gpio114", "gpio115", "gpio117",
  "gpio118",
  "gpio119", "gpio120", "gpio188", "gpio189", "gpio190", "gpio191", "gpio192",
  "gpio193",
  "gpio194", "gpio195", "gpio196", "gpio197", "gpio198", "gpio199", "gpio200",
  "gpio201",
...
static const struct msm_pingroup sm8450_groups[] = {
  ...
  [86] = PINGROUP(86, mdp_vsync, mdp_vsync0, mdp_vsync1, gcc_gp1, atest_char, _,
      _, _, _),
  [87] = PINGROUP(87, mdp_vsync, mdp_vsync2, mdp_vsync3, gcc_gp2, atest_char, _,
      _, _, _),
...
static const struct msm_gpio_wakeirq_map sm8450_pdc_map[] = {
  ...
  { 155, 49 }, { 156, 64 }, { 159, 50 }, { 162, 51 }, { 166, 111 },
  { 169, 114 },
