...
static const struct msm_pingroup msm8909_groups[] = {
  ...
  PINGROUP(4, blsp_spi1, blsp_uart1, blsp_uim1, blsp_spi3_cs3, dmic0_clk, _, _,
      _, _),
  PINGROUP(5, blsp_spi1, blsp_uart1, blsp_uim1, blsp_spi2_cs3, dmic0_data, _, _,
      _, _),
  ...
  PINGROUP(14, blsp_spi4, blsp_i2c4, gcc_gp1_clk_b, _, _, _, _, _,
      qdss_tracedata_b),
  ...
  PINGROUP(20, uim3_data, blsp_spi2, blsp_uart2, blsp_uim2, _,
      qdss_cti_trig_in_a0, _, _, _),
  PINGROUP(21, uim3_present, blsp_spi2, blsp_uart2, blsp_uim2, _,
      qdss_cti_trig_in_b0, _, _, _),
  ...
  PINGROUP(43, wcss_wlan, prng_rosc, qdss_tracedata_a, _, atest_combodac, _, _,
      _, _),
  PINGROUP(44, wcss_wlan, _, atest_combodac, _, _, _, _, _, _),
  PINGROUP(45, wcss_fm, ext_lpass, qdss_tracectl_a, _, atest_combodac, _, _, _,
      _),
  ...
  PINGROUP(51, uim2_reset, gcc_gp3_clk_a, qdss_cti_trig_out_b1, _, _, _, _, _,
      _),
  ...
  PINGROUP(59, cdc_pdm0, pri_mi2s_mclk_a, atest_char3, _, _, _, _, _,
      bimc_dte0),
  ...
  PINGROUP(65, blsp_spi3_cs2, blsp_spi1_cs3, qdss_tracedata_a, _, atest_gpsadc0,
      _, _, _, _),
  ...
  PINGROUP(94, pri_mi2s_sck_b, pwr_modem_enabled_b, qdss_tracedata_a, _,
      atest_combodac, _, _, _, _),
  PINGROUP(95, blsp_spi3_cs1, pri_mi2s_data0_b, ebi2_lcd, m_voc,
      pwr_nav_enabled_b, _, atest_combodac, _, _),
  PINGROUP(96, pri_mi2s_data1_b, _, pwr_crypto_enabled_b, qdss_tracedata_a, _,
      atest_wlan0, _, _, _),
  PINGROUP(97, blsp_spi1_cs1, qdss_tracedata_a, _, atest_wlan1, _, _, _, _, _),
  PINGROUP(98, sec_mi2s, pri_mi2s_mclk_b, blsp_spi2_cs1, ldo_update, _, _, _, _,
      _),
