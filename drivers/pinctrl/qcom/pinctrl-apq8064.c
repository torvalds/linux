...
#define DECLARE_APQ_GPIO_PINS(pin) static const unsigned int gpio ## pin ## \
  _pins[] = { pin }
...
static const struct msm_pingroup apq8064_groups[] = {
  ...
  PINGROUP(31, mi2s, NA, gsbi5_spi_cs2, gsbi6_spi_cs2, gsbi7_spi_cs2, NA, NA,
      NA, NA, NA),
  ...
  PINGROUP(47, spkr_i2s, gsbi5_spi_cs1, gsbi6_spi_cs1, gsbi7_spi_cs1, NA, NA,
      NA, NA, NA, NA),
