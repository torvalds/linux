...
static const unsigned int hsic_strobe_pins[] = {
  152
};
static const unsigned int hsic_data_pins[] = {
  153
};
...
static const char * const hsic_ctl_groups[] = {
...
static const struct msm_pingroup msm8x74_groups[] = {
  ...
  PINGROUP(26, cci_timer3, cci_async_in1, blsp_spi5, blsp_uart5, blsp_i2c5,
      gp0_clk, NA),
  PINGROUP(27, cci_timer4, cci_async_in2, blsp_spi6, blsp_uart6, blsp_i2c6,
      gp1_clk, NA),
  ...
  PINGROUP(54, blsp_spi10, blsp_uart10, blsp_uim10, blsp_spi2_cs2, gp_pdm0, NA,
      NA),
  ...
  PINGROUP(81, sec_mi2s, blsp_spi11, blsp_uart11, blsp_uim11, gcc_gp_clk2, NA,
      NA),
  PINGROUP(82, sec_mi2s, blsp_spi11, blsp_uart11, blsp_uim11, gcc_gp_clk3, NA,
      NA),
