...
static const char * const phase_flag_groups[] = {
  ...
  "gpio63", "gpio64", "gpio65", "gpio67", "gpio68", "gpio69", "gpio75",
  "gpio76",
  "gpio77", "gpio79", "gpio80", "gpio81", "gpio92", "gpio83", "gpio94",
  "gpio95",
  "gpio96", "gpio97", "gpio98", "gpio99", "gpio116", "gpio117", "gpio119",
  "gpio120",
};
...
static const struct msm_pingroup sm8550_groups[] = {
  [0] = PINGROUP(0, cci_i2c_sda, qup2_se0_l0_mirb, ibi_i3c, phase_flag, _, _, _,
      _, _),
  ...
  [11]
    = PINGROUP(11, i2chub0_se7, usb_phy, qdss_cti, phase_flag, _, _, _, _, _),
  ...
  [40] = PINGROUP(40, qup1_se3, qup1_se2, ddr_bist_complete, _, ddr_pxi1, _, _,
      _, _),
  [41]
    = PINGROUP(41, qup1_se3, qup1_se2, ddr_bist_stop, _, ddr_pxi1, _, _, _,
      _),
  ...
  [50] = PINGROUP(50, qup1_se6, qspi_clk, sdc4_clk, tsense_pwm1, tsense_pwm2,
      tsense_pwm3, _, _, _),
  ...
  [59]
    = PINGROUP(59, qup2_se0_l3_mira, phase_flag, _, qdss_gpio, _, _, _, _, _),
  ...
  [64] = PINGROUP(64, qup2_se2, tb_trig_sdc2, phase_flag, tgu_ch0_trigout, _,
      qdss_gpio, _, _, _),
  ...
  [67] = PINGROUP(67, qup2_se2, qup2_se0, phase_flag, tgu_ch3_trigout, _, _, _,
      _, _),
  ...
  [75]
    = PINGROUP(75, cci_i2c_scl, qup2_se7, qdss_cti, phase_flag, _, _, _, _,
      _),
  ...
  [86] = PINGROUP(86, mdp_vsync, mdp_vsync0_out, mdp_vsync1_out, gcc_gp1, _, _,
      _, _, _),
  [87] = PINGROUP(87, mdp_vsync, mdp_vsync2_out, mdp_vsync3_out, gcc_gp2, _, _,
      _, _, _),
  ...
  [95]
    = PINGROUP(95, pcie0_clk_req_n, phase_flag, tmess_prng2, _, _, _, _, _,
      _),
  ...
  [107] = PINGROUP(107, cam_mclk, qup2_se0_l3_mirb, pll_clk_aux, _, _, _, _, _,
      _),
  ...
  [124] = PINGROUP(124, i2s1_data1, audio_ext_mclk1, audio_ref_clk, _, _, _, _,
      _, _),
