...
static const struct msm_pingroup x1e80100_groups[] = {
  ...
  [34] = PINGROUP(34, qup1_se0, qup1_se3, tsense_pwm1, tsense_pwm2, tsense_pwm3,
      tsense_pwm4, _, _, _),
  ...
  [38] = PINGROUP(38, qup1_se1, vsense_trigger, atest_usb, ddr_pxi0, _, _, _, _,
      _),
  ...
  [42]
    = PINGROUP(42, qup1_se2, jitter_bist, atest_usb, ddr_pxi2, _, _, _, _, _),
  ...
  [51] = PINGROUP(51, qup1_se4, qup1_se2, dbg_out, atest_usb, ddr_pxi6, _, _, _,
      _),
  ...
  [111] = PINGROUP(111, cci_timer2, cci_async, mdp_vsync6, qdss_gpio, _, _, _,
      _, _),
  [112] = PINGROUP(112, cci_timer3, cci_async, mdp_vsync7, qdss_gpio, _, _, _,
      _, _),
  [113] = PINGROUP(113, cci_timer4, cci_async, mdp_vsync8, qdss_gpio, _, _, _,
      _, _),
  ...
  [181] = PINGROUP(181, usb2_sbrx, prng_rosc3, phase_flag, _, atest_char, _, _,
      _, _),
  [182] = PINGROUP(182, usb2_sbtx, prng_rosc2, phase_flag, _, atest_char3, _, _,
      _, _),
...
static const struct msm_gpio_wakeirq_map x1e80100_pdc_map[] = {
  ...
  { 151, 103 }, { 153, 104 }, { 156, 105 }, { 157, 107 }, { 163, 98 },
  { 166, 112 },
  { 172, 99 }, { 181, 101 }, { 184, 116 }, { 193, 40 }, { 193, 117 },
  { 196, 108 },
  { 203, 133 }, { 212, 120 }, { 213, 150 }, { 214, 121 }, { 215, 118 },
  { 217, 109 },
