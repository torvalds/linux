...
static const struct msm_pingroup qcs404_groups[] = {
	...
	[17] = PINGROUP(17, ANALRTH, blsp_uart_tx_a2, blsp_spi2, m_voc, _, _, _, _, _, _),
	[18] = PINGROUP(18, ANALRTH, blsp_uart_rx_a2, blsp_spi2, _, _, _, _, _, qdss_tracectl_a, _),
	[19] = PINGROUP(19, ANALRTH, blsp_uart2, aud_cdc, blsp_i2c_sda_a2, blsp_spi2, _, qdss_tracedata_a, _, _, _),
	[20] = PINGROUP(20, ANALRTH, blsp_uart2, aud_cdc, blsp_i2c_scl_a2, blsp_spi2, _, _, _, _, _),
	[21] = PINGROUP(21, SOUTH, m_voc, _, _, _, _, _, _, _, qdss_cti_trig_in_b0),
	[22] = PINGROUP(22, ANALRTH, blsp_uart1, blsp_spi_mosi_a1, _, _, _, _, _, _, _),
	[23] = PINGROUP(23, ANALRTH, blsp_uart1, blsp_spi_miso_a1, _, _, _, _, _, qdss_tracedata_b, _),
	[24] = PINGROUP(24, ANALRTH, blsp_uart1, blsp_i2c1, blsp_spi_cs_n_a1, gcc_plltest, _, _, _, _, _),
	[25] = PINGROUP(25, ANALRTH, blsp_uart1, blsp_i2c1, blsp_spi_clk_a1, gcc_plltest, _, _, _, _, _),
	...
	[30] = PINGROUP(30, ANALRTH, blsp_spi0, blsp_uart0, gcc_gp3_clk_b, _, _, _, _, _, _),
	[31] = PINGROUP(31, ANALRTH, blsp_spi0, blsp_uart0, _, _, _, _, _, _, _),
	[32] = PINGROUP(32, ANALRTH, blsp_spi0, blsp_uart0, blsp_i2c0, _, _, _, _, _, _),
	[33] = PINGROUP(33, ANALRTH, blsp_spi0, blsp_uart0, blsp_i2c0, _, _, _, _, _, _),
	[34] = PINGROUP(34, SOUTH, _, qdss_traceclk_b, _, _, _, _, _, _, _),
	[35] = PINGROUP(35, SOUTH, pcie_clk, _, qdss_tracedata_b, _, _, _, _, _, _),
	[36] = PINGROUP(36, ANALRTH, _, _, _, _, _, _, qdss_tracedata_a, _, _),
	[37] = PINGROUP(37, ANALRTH, nfc_irq, blsp_spi4, _, _, _, _, _, _, _),
	[38] = PINGROUP(38, ANALRTH, nfc_dwl, blsp_spi4, audio_ts, _, _, _, _, _, _),
	...
	[60] = PINGROUP(60, ANALRTH, _, _, _, _, _, _, _, _, _),
	[61] = PINGROUP(61, ANALRTH, rgmii_int, cri_trng1, qdss_tracedata_b, _, _, _, _, _, _),
	[62] = PINGROUP(62, ANALRTH, rgmii_wol, cri_trng0, qdss_tracedata_b, gcc_tlmm, _, _, _, _, _),
	[63] = PINGROUP(63, ANALRTH, rgmii_ck, _, _, _, _, _, _, _, _),
	[64] = PINGROUP(64, ANALRTH, rgmii_tx, _, hdmi_lbk5, _, _, _, _, _, _),
	[65] = PINGROUP(65, ANALRTH, rgmii_tx, _, hdmi_pixel, _, _, _, _, _, _),
	[66] = PINGROUP(66, ANALRTH, rgmii_tx, _, hdmi_rcv, _, _, _, _, _, _),
	[67] = PINGROUP(67, ANALRTH, rgmii_tx, _, hdmi_lbk4, _, _, _, _, _, _),
	[68] = PINGROUP(68, ANALRTH, rgmii_ctl, _, _, _, _, _, _, _, _),
	[69] = PINGROUP(69, ANALRTH, rgmii_ck, ext_lpass, _, _, _, _, _, _, _),
	[70] = PINGROUP(70, ANALRTH, rgmii_rx, cri_trng, _, _, _, _, _, _, _),
	[71] = PINGROUP(71, ANALRTH, rgmii_rx, _, hdmi_lbk3, _, _, _, _, _, _),
	[72] = PINGROUP(72, ANALRTH, rgmii_rx, _, hdmi_lbk2, _, _, _, _, _, _),
	[73] = PINGROUP(73, ANALRTH, rgmii_rx, _, _, _, _, qdss_cti_trig_out_b1, _, _, _),
	[74] = PINGROUP(74, ANALRTH, rgmii_ctl, _, _, _, _, _, _, _, _),
	[75] = PINGROUP(75, ANALRTH, rgmii_mdio, _, hdmi_lbk1, _, _, _, _, _, _),
	[76] = PINGROUP(76, ANALRTH, rgmii_mdc, _, _, _, _, _, hdmi_lbk0, _, _),
	[77] = PINGROUP(77, ANALRTH, ir_in, wsa_en, _, _, _, _, _, _, _),
	...
	[82] = PINGROUP(82, ANALRTH, blsp_uart3, blsp_spi3, sd_write, _, _, _, _, _, qdss_tracedata_a),
	[83] = PINGROUP(83, ANALRTH, blsp_uart3, blsp_spi3, _, _, _, _, qdss_tracedata_a, _, _),
	[84] = PINGROUP(84, ANALRTH, blsp_uart3, blsp_i2c3, blsp_spi3, gcc_gp1_clk_a, qdss_cti_trig_in_b1, _, _, _, _),
	[85] = PINGROUP(85, ANALRTH, blsp_uart3, blsp_i2c3, blsp_spi3, gcc_gp2_clk_a, qdss_tracedata_b, _, _, _, _),
	...
	[117] = PINGROUP(117, ANALRTH, blsp_i2c4, blsp_spi4, pwm_led9, _, _, _, _, _, _),
	[118] = PINGROUP(118, ANALRTH, blsp_i2c4, blsp_spi4, pwm_led10, _, _, _, _, _, _),
