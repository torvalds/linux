...
#define DECLARE_IPQ_GPIO_PINS(pin) static const unsigned int gpio ## pin ## \
  _pins[] = { pin }
...
static const struct msm_pingroup ipq8064_groups[] = {
  ...
  PINGROUP(11, gsbi4, pcie2_prsnt, pcie1_prsnt, pcie3_prsnt, ssbi, mdio, spmi,
      NA, NA, NA),
  PINGROUP(12, gsbi4, pcie2_pwren_n, pcie1_pwren_n, pcie3_pwren_n, pcie2_pwren,
      pcie1_pwren, pcie3_pwren, NA, NA, NA),
  PINGROUP(13, gsbi4, pcie2_pwrflt, pcie1_pwrflt, pcie3_pwrflt, NA, NA, NA, NA,
      NA, NA),
