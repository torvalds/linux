...
static const char * const qdss_gpio_groups[] = {
  "gpio100", "gpio101", "gpio102", "gpio103", "gpio104", "gpio105", "gpio106",
  "gpio107",
  "gpio108", "gpio109", "gpio110", "gpio111", "gpio112", "gpio113", "gpio114",
  "gpio115",
  "gpio116", "gpio117", "gpio183", "gpio184", "gpio185", "gpio186", "gpio187",
  "gpio188",
  "gpio189", "gpio190", "gpio191", "gpio192", "gpio193", "gpio194", "gpio195",
  "gpio196",
...
static const struct msm_pingroup sm8350_groups[] = {
  ...
  [87] = PINGROUP(87, dp_hot, mdp_vsync2, mdp_vsync3, qdss_cti, atest_char, _,
      _, _, _),
  ...
  [115]
    = PINGROUP(115, cci_timer, gcc_gp1, qdss_gpio, atest_char, _, _, _, _, _),
  [116] = PINGROUP(116, cci_timer, gcc_gp2, qdss_gpio, _, _, _, _, _, _),
  [117]
    = PINGROUP(117, cci_timer, gcc_gp3, qdss_gpio, atest_char, _, _, _, _, _),
