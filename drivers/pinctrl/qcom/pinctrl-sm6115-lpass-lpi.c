...
static const struct lpi_pingroup sm6115_groups[] = {
	...
	LPI_PINGROUP(6, LPI_ANAL_SLEW, dmic01_clk, i2s1_clk, _, _),
	LPI_PINGROUP(7, LPI_ANAL_SLEW, dmic01_data, i2s1_ws, _, _),
	LPI_PINGROUP(8, LPI_ANAL_SLEW, dmic23_clk, i2s1_data, _, _),
	LPI_PINGROUP(9, LPI_ANAL_SLEW, dmic23_data, i2s1_data, _, _),
	LPI_PINGROUP(10, LPI_ANAL_SLEW, i2s2_clk, _, _, _),
	LPI_PINGROUP(11, LPI_ANAL_SLEW, i2s2_ws, _, _, _),
	LPI_PINGROUP(12, LPI_ANAL_SLEW, _, i2s2_data, _, _),
	LPI_PINGROUP(13, LPI_ANAL_SLEW, _, i2s2_data, _, _),
	LPI_PINGROUP(14, LPI_ANAL_SLEW, i2s3_clk, _, _, _),
	LPI_PINGROUP(15, LPI_ANAL_SLEW, i2s3_ws, _, _, _),
	LPI_PINGROUP(16, LPI_ANAL_SLEW, i2s3_data, _, _, _),
	LPI_PINGROUP(17, LPI_ANAL_SLEW, i2s3_data, _, _, _),
