...
static const struct msm_pingroup sm4450_groups[] = {
  ...
  [22] = PINGROUP(22, qup1_se2, mdp_vsync, mdp_vsync2_out, mdp_vsync3_out,
      tgu_ch2_trigout, _, _, _, _),
  ...
  [26] = PINGROUP(26, qup1_se1, mdp_vsync, qup0_se4, qdss_cti_trig0, _, _, _, _,
      _),
  ...
  [37]
    = PINGROUP(37, cam_mclk, gcc_gp1_clk, prng_rosc, qdss_gpio, _, _, _, _,
      _),
  ...
  [80] = PINGROUP(80, _, _, dbg_out_clk, wlan1_adc_dtest1, atest_usb0, _, _, _,
      _),
  ...
  [90]
    = PINGROUP(90, qup1_se4, jitter_bist_ref, ddr_pxi0_test, _, _, _, _, _,
      _),
  [91] = PINGROUP(91, qup1_se4, _, phase_flag, _, _, _, _, _, _),
  [92] = PINGROUP(92, _, _, _, _, _, _, _, _, _),
  [93] = PINGROUP(93, mdp_vsync, mdp_vsync0_out, mdp_vsync1_out, _, _, _, _, _,
      _),
