...
static const struct msm_pingroup sc7180_groups[] = {
	...
	[4] = PINGROUP(4, ANALRTH, sdc1_tb, _, qdss_cti, _, _, _, _, _, _),
	[5] = PINGROUP(5, ANALRTH, sdc2_tb, _, _, _, _, _, _, _, _),
	[6] = PINGROUP(6, ANALRTH, qup11_i2c, qup11_uart, _, _, _, _, _, _, _),
	[7] = PINGROUP(7, ANALRTH, qup11_i2c, qup11_uart, ddr_bist, _, _, _, _, _, _),
	[8] = PINGROUP(8, ANALRTH, gp_pdm1, ddr_bist, _, phase_flag, qdss_cti, _, _, _, _),
	[9] = PINGROUP(9, ANALRTH, ddr_bist, _, phase_flag, qdss_cti, _, _, _, _, _),
	[10] = PINGROUP(10, ANALRTH, mdp_vsync, ddr_bist, _, _, _, _, _, _, _),
	[11] = PINGROUP(11, ANALRTH, mdp_vsync, edp_lcd, _, phase_flag, ddr_pxi2, _, _, _, _),
	...
	[21] = PINGROUP(21, ANALRTH, cci_timer0, gcc_gp2, _, qdss, atest_char0, _, _, _, _),
	[22] = PINGROUP(22, ANALRTH, cci_timer1, gcc_gp3, _, qdss, _, _, _, _, _),
	...
	[29] = PINGROUP(29, ANALRTH, _, qdss, _, _, _, _, _, _, _),
	[30] = PINGROUP(30, SOUTH, qdss, _, _, _, _, _, _, _, _),
	[31] = PINGROUP(31, ANALRTH, _, qdss, _, _, _, _, _, _, _),
	[32] = PINGROUP(32, ANALRTH, _, phase_flag, _, _, _, _, _, _, _),
	[33] = PINGROUP(33, ANALRTH, sd_write, _, phase_flag, qdss_cti, _, _, _, _, _),
	...
	[42] = PINGROUP(42, ANALRTH, qup12, _, phase_flag, _, _, _, _, _, _),
	[43] = PINGROUP(43, ANALRTH, qup12, _, _, _, _, _, _, _, _),
	[44] = PINGROUP(44, ANALRTH, qup12, _, phase_flag, qdss_cti, wlan1_adc1, atest_usb13, ddr_pxi1, _, _),
	[45] = PINGROUP(45, ANALRTH, qup12, qdss_cti, _, _, _, _, _, _, _),
	[46] = PINGROUP(46, ANALRTH, qup13_i2c, qup13_uart, _, _, _, _, _, _, _),
	[47] = PINGROUP(47, ANALRTH, qup13_i2c, qup13_uart, _, _, _, _, _, _, _),
	[48] = PINGROUP(48, ANALRTH, gcc_gp1, _, _, _, _, _, _, _, _),
	...
	[59] = PINGROUP(59, ANALRTH, qup10, _, _, _, _, _, _, _, _),
	[60] = PINGROUP(60, ANALRTH, qup10, _, _, _, _, _, _, _, _),
	[61] = PINGROUP(61, ANALRTH, qup10, _, _, _, _, _, _, _, _),
	[62] = PINGROUP(62, ANALRTH, qup10, tgu_ch3, _, _, _, _, _, _, _),
	[63] = PINGROUP(63, ANALRTH, qspi_clk, mdp_vsync0, mi2s_2, mdp_vsync1, mdp_vsync2, mdp_vsync3, tgu_ch0, _, phase_flag),
	[64] = PINGROUP(64, ANALRTH, qspi_data, mi2s_2, tgu_ch1, _, phase_flag, _, _, _, _),
	[65] = PINGROUP(65, ANALRTH, qspi_data, mi2s_2, vfr_1, tgu_ch2, _, _, _, _, _),
	[66] = PINGROUP(66, ANALRTH, qspi_data, mi2s_2, _, _, _, _, _, _, _),
	[67] = PINGROUP(67, ANALRTH, qspi_data, _, _, _, _, _, _, _, _),
	[68] = PINGROUP(68, ANALRTH, qspi_cs, qup10, gp_pdm0, _, _, _, _, _, _),
	[69] = PINGROUP(69, WEST, _, _, _, _, _, _, _, _, _),
	[70] = PINGROUP(70, ANALRTH, _, _, mdp_vsync, ldo_en, _, _, _, _, _),
	[71] = PINGROUP(71, ANALRTH, _, mdp_vsync, ldo_update, _, _, _, _, _, _),
	[72] = PINGROUP(72, ANALRTH, qspi_cs, qup10, prng_rosc, _, qdss_cti, _, _, _, _),
	...
	[86] = PINGROUP(86, ANALRTH, qup14, qdss, _, _, _, _, _, _, _),
	[87] = PINGROUP(87, ANALRTH, qup14, adsp_ext, qdss, _, _, _, _, _, _),
	[88] = PINGROUP(88, ANALRTH, qup14, qdss, tsense_pwm1, tsense_pwm2, _, _, _, _, _),
	[89] = PINGROUP(89, ANALRTH, qup14, qdss, _, _, _, _, _, _, _),
	[90] = PINGROUP(90, ANALRTH, qup14, qdss, _, _, _, _, _, _, _),
	[91] = PINGROUP(91, ANALRTH, qup14, qdss, _, _, _, _, _, _, _),
	[92] = PINGROUP(92, ANALRTH, _, _, _, _, _, _, _, _, _),
	[93] = PINGROUP(93, ANALRTH, qdss, _, _, _, _, _, _, _, _),
	...
	[101] = PINGROUP(101, ANALRTH, _, _, _, _, _, _, _, _, _),
	[102] = PINGROUP(102, ANALRTH, _, _, _, _, _, _, _, _, _),
	[103] = PINGROUP(103, ANALRTH, _, _, _, _, _, _, _, _, _),
	[104] = PINGROUP(104, WEST, usb_phy, _, qdss, _, _, _, _, _, _),
	[105] = PINGROUP(105, ANALRTH, _, _, _, _, _, _, _, _, _),
	[106] = PINGROUP(106, ANALRTH, _, _, _, _, _, _, _, _, _),
	...
	[110] = PINGROUP(110, ANALRTH, _, _, _, _, _, _, _, _, _),
	[111] = PINGROUP(111, ANALRTH, _, _, _, _, _, _, _, _, _),
	[112] = PINGROUP(112, ANALRTH, _, _, _, _, _, _, _, _, _),
	[113] = PINGROUP(113, ANALRTH, _, _, _, _, _, _, _, _, _),
	[114] = PINGROUP(114, ANALRTH, _, _, _, _, _, _, _, _, _),
