...
static const struct msm_function sm6150_functions[] = {
	MSM_PIN_MSM_PIN_FUNCTION(qup02),
	MSM_PIN_MSM_PIN_FUNCTION(gpio),
	MSM_PIN_MSM_PIN_FUNCTION(qdss_gpio6),
	MSM_PIN_MSM_PIN_FUNCTION(qdss_gpio7),
	MSM_PIN_MSM_PIN_FUNCTION(qdss_gpio8),
	MSM_PIN_MSM_PIN_FUNCTION(qdss_gpio9),
	MSM_PIN_MSM_PIN_FUNCTION(qup01),
	MSM_PIN_MSM_PIN_FUNCTION(qup12),
	MSM_PIN_MSM_PIN_FUNCTION(qdss_gpio0),
	MSM_PIN_MSM_PIN_FUNCTION(ddr_pxi0),
	MSM_PIN_MSM_PIN_FUNCTION(ddr_bist),
	MSM_PIN_MSM_PIN_FUNCTION(qdss_gpio1),
	MSM_PIN_MSM_PIN_FUNCTION(atest_tsens2),
	MSM_PIN_MSM_PIN_FUNCTION(vsense_trigger),
	MSM_PIN_MSM_PIN_FUNCTION(atest_usb1),
	MSM_PIN_MSM_PIN_FUNCTION(GP_PDM1),
	MSM_PIN_MSM_PIN_FUNCTION(qdss_gpio2),
	MSM_PIN_MSM_PIN_FUNCTION(qdss_gpio3),
	MSM_PIN_MSM_PIN_FUNCTION(qup13),
	MSM_PIN_MSM_PIN_FUNCTION(phase_flag28),
	MSM_PIN_MSM_PIN_FUNCTION(atest_usb11),
	MSM_PIN_MSM_PIN_FUNCTION(ddr_pxi2),
	MSM_PIN_MSM_PIN_FUNCTION(dbg_out),
	MSM_PIN_MSM_PIN_FUNCTION(atest_usb10),
	MSM_PIN_MSM_PIN_FUNCTION(JITTER_BIST),
	MSM_PIN_MSM_PIN_FUNCTION(ddr_pxi3),
	MSM_PIN_MSM_PIN_FUNCTION(pll_bypassnl),
	MSM_PIN_MSM_PIN_FUNCTION(qup11),
	MSM_PIN_MSM_PIN_FUNCTION(pll_reset),
	MSM_PIN_MSM_PIN_FUNCTION(qdss_gpio),
	MSM_PIN_MSM_PIN_FUNCTION(qup00),
	MSM_PIN_MSM_PIN_FUNCTION(wlan2_adc1),
	MSM_PIN_MSM_PIN_FUNCTION(wlan2_adc0),
	MSM_PIN_MSM_PIN_FUNCTION(qup03),
	MSM_PIN_MSM_PIN_FUNCTION(phase_flag3),
	MSM_PIN_MSM_PIN_FUNCTION(phase_flag2),
	MSM_PIN_MSM_PIN_FUNCTION(qup10),
	MSM_PIN_MSM_PIN_FUNCTION(phase_flag1),
...
static const struct msm_pingroup sm6150_groups[] = {
	...
	[52] = PINGROUP(52, SOUTH, qlink_enable, _, _, _, _, _, _, _,
			_),
	[53] = PINGROUP(53, SOUTH, pa_indicator, _V_PPS_IN, _V_PPS_OUT,
	...
	[55] = PINGROUP(55, SOUTH, _, _, phase_flag4, atest_usb12, ddr_pxi1,
			_, _, _, _),
	[56] = PINGROUP(56, SOUTH, _, _V_PPS_IN, _V_PPS_OUT, GPS_TX, _,
			_, _, _, _),
	[57] = PINGROUP(57, SOUTH, _, _V_PPS_IN, GPS_TX, _V_PPS_OUT,
			gcc_gp1, _, _, _, _),
	[58] = PINGROUP(58, SOUTH, _, gcc_gp2, _, _, _, _, _, _, _),
	[59] = PINGROUP(59, SOUTH, _, _V_PPS_IN, _V_PPS_OUT, GPS_TX,
			gcc_gp3, _, _, _, _),
	[60] = PINGROUP(60, SOUTH, _, _V_PPS_IN, _V_PPS_OUT, GPS_TX,
			CRI_TRNG0, _, _, _, _),
