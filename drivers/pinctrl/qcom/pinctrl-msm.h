 ...
 * @ctl_reg:              Offset of the register holding control bits for this
 * group.
 * @io_reg:               Offset of the register holding input/output bits for
 * this group.
 * @intr_cfg_reg:         Offset of the register holding interrupt configuration
 * bits.
 * @intr_status_reg:      Offset of the register holding the status bits for
 * this group.
 * @intr_target_reg:      Offset of the register specifying routing of the
 * interrupts
 *                        from this group.
 ...
 * @intr_enable_bit:      Offset in @intr_cfg_reg for enabling the interrupt for
 * this group.
 * @intr_status_bit:      Offset in @intr_status_reg for reading and acking the
 * interrupt
 *                        status.
 * @intr_wakeup_present_bit: Offset in @intr_target_reg specifying the GPIO can
 * generate
 *        wakeup events.
 * @intr_wakeup_enable_bit: Offset in @intr_target_reg to enable wakeup events
 * for the GPIO.
 * @intr_target_bit:      Offset in @intr_target_reg for configuring the
 * interrupt routing.
 * @intr_target_width:    Number of bits used for specifying interrupt routing
 * target.
 * @intr_target_kpss_val: Value in @intr_target_bit for specifying that the
 * interrupt from
 *                        this gpio should get routed to the KPSS processor.
 * @intr_raw_status_bit:  Offset in @intr_cfg_reg for the raw status bit.
 * @intr_polarity_bit:    Offset in @intr_cfg_reg for specifying polarity of the
 * interrupt.
 * @intr_detection_bit:   Offset in @intr_cfg_reg for specifying interrupt type.
 * @intr_detection_width: Number of bits used for specifying interrupt type,
 *                        Should be 2 for SoCs that can detect both edges in
 * hardware,
 *                        otherwise 1.
 */
struct msm_pingroup {
