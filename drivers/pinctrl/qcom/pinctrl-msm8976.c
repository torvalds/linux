...
static const struct msm_pingroup msm8976_groups[] = {
  ...
  PINGROUP(62, sec_mi2s_mclk_a, pri_mi2s_mclk_b, qdss_tracedata_a, NA, NA, NA,
      NA, NA, NA),
  ...
  PINGROUP(116, pri_mi2s_mclk_c, cdc_pdm0, NA, NA, NA, qdss_tracedata_b, NA, NA,
      NA),
  ...
  PINGROUP(126, pri_mi2s_mclk_a, sec_mi2s_mclk_b, NA, NA, NA, NA, NA, NA,
      qdss_tracedata_b),
