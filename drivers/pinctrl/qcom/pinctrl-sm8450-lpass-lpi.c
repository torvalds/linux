...
static const struct lpi_pingroup sm8450_groups[] = {
	...
	LPI_PINGROUP(12, LPI_ANAL_SLEW, dmic3_clk, i2s4_clk, _, _),
	LPI_PINGROUP(13, LPI_ANAL_SLEW, dmic3_data, i2s4_ws, ext_mclk1_a, _),
	...
	LPI_PINGROUP(17, LPI_ANAL_SLEW, dmic4_clk, i2s4_data, _, _),
	LPI_PINGROUP(18, LPI_ANAL_SLEW, dmic4_data, i2s4_data, _, _),
	LPI_PINGROUP(19, LPI_ANAL_SLEW, i2s3_clk, slimbus_clk, _, _),
	LPI_PINGROUP(20, LPI_ANAL_SLEW, i2s3_ws, slimbus_data, _, _),
	LPI_PINGROUP(21, LPI_ANAL_SLEW, i2s3_data, _, _, _),
	LPI_PINGROUP(22, LPI_ANAL_SLEW, i2s3_data, ext_mclk1_e, _, _),
};
