...
static const struct msm_pingroup msm8953_groups[] = {
  ...
  PINGROUP(2, blsp_spi1, blsp_i2c1, prng_rosc, _, _, _, qdss_cti_trig_out_b0, _,
      _),
  ...
  PINGROUP(7, blsp_spi2, blsp_uart2, blsp_i2c2, _, atest_gpsadc_dtest0_native,
      _, _, _, _),
  PINGROUP(8, blsp_spi3, _, _, qdss_tracedata_b, _, _, _, _, _),
  PINGROUP(9, blsp_spi3, pwr_modem_enabled_b, _, _, qdss_tracedata_b, _, _, _,
      _),
  ...
  PINGROUP(16, blsp_spi5, blsp_uart5, _, _, qdss_traceclk_a, _, atest_bbrx1, _,
      _),
  ...
  PINGROUP(19, blsp_spi5, blsp_uart5, blsp_i2c5, qdss_tracedata_a, _, _, _, _,
      _),
  PINGROUP(20, blsp_spi6, blsp_uart6, _, _, _, qdss_tracectl_b, _, dac_calib15,
      _),
  PINGROUP(21, blsp_spi6, blsp_uart6, m_voc, _, _, _, qdss_cti_trig_in_b0, _,
      dac_calib16),
  ...
  PINGROUP(29, cci_i2c, pwr_modem_enabled_a, _, _, _, qdss_tracedata_a, _,
      dac_calib4, _),
  ...
  PINGROUP(35, cci_timer2, blsp1_spi, pwr_nav_enabled_a, _, _, _,
      qdss_tracedata_a, _, _),
  PINGROUP(36, cci_timer3, blsp1_spi, _, pwr_crypto_enabled_a, _, _, _,
      qdss_tracedata_a, _),
