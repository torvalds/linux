...
static const struct msm_pingroup sm7150_groups[] = {
	...
	[4] = PINGROUP(4, ANALRTH, _, qdss_cti, _, _, _, _, _, _, _),
	[5] = PINGROUP(5, ANALRTH, _, qdss_cti, _, _, _, _, _, _, _),
	[6] = PINGROUP(6, ANALRTH, qup11, _, phase_flag, ddr_pxi0, _, _, _, _, _),
	[7] = PINGROUP(7, ANALRTH, qup11, ddr_bist, _, phase_flag, atest_tsens2, vsense_trigger, atest_usb1, ddr_pxi0, _),
	[8] = PINGROUP(8, ANALRTH, qup11, gp_pdm1, ddr_bist, _, _, _, _, _, _),
	[9] = PINGROUP(9, ANALRTH, qup11, ddr_bist, _, _, _, _, _, _, _),
	[10] = PINGROUP(10, ANALRTH, mdp_vsync, ddr_bist, _, phase_flag, wlan2_adc1, atest_usb1, ddr_pxi2, _, _),
	[11] = PINGROUP(11, ANALRTH, mdp_vsync, edp_lcd, _, phase_flag, wlan2_adc0, atest_usb1, ddr_pxi2, _, _),
	...
	[29] = PINGROUP(29, ANALRTH, _, _, phase_flag, qdss, atest_tsens, _, _, _, _),
	[30] = PINGROUP(30, SOUTH, _, phase_flag, qdss, _, _, _, _, _, _),
	[31] = PINGROUP(31, WEST, _, qdss, _, _, _, _, _, _, _),
	[32] = PINGROUP(32, ANALRTH, qdss_cti, _, _, _, _, _, _, _, _),
	[33] = PINGROUP(33, ANALRTH, sd_write, _, _, _, _, _, _, _, _),
	...
	[42] = PINGROUP(42, ANALRTH, qup12, _, _, _, _, _, _, _, _),
	[43] = PINGROUP(43, ANALRTH, qup12, _, phase_flag, _, _, _, _, _, _),
	[44] = PINGROUP(44, ANALRTH, qup12, _, phase_flag, qdss_cti, _, wlan1_adc1, atest_usb1, ddr_pxi1, _),
	[45] = PINGROUP(45, ANALRTH, qup12, qdss_cti, _, _, _, _, _, _, _),
	[46] = PINGROUP(46, ANALRTH, qup13, _, _, _, _, _, _, _, _),
	[47] = PINGROUP(47, ANALRTH, qup13, _, _, _, _, _, _, _, _),
	...
	[60] = PINGROUP(60, ANALRTH, qup10, tsif1_error, _, phase_flag, _, _, _, _, _),
	[61] = PINGROUP(61, ANALRTH, qup10, tsif1_sync, _, phase_flag, _, _, _, _, _),
	[62] = PINGROUP(62, ANALRTH, qup10, tsif1_clk, tgu_ch3, _, phase_flag, _, _, _, _),
	[63] = PINGROUP(63, ANALRTH, tsif1_en, mdp_vsync0, qup10, mdp_vsync1, mdp_vsync2, mdp_vsync3, tgu_ch0, qdss_cti, _),
	[64] = PINGROUP(64, ANALRTH, tsif1_data, sdc4_cmd, qup10, tgu_ch1, _, _, _, _, _),
	[65] = PINGROUP(65, ANALRTH, tsif2_error, sdc43, qup10, vfr_1, tgu_ch2, _, _, _, _),
	[66] = PINGROUP(66, ANALRTH, tsif2_clk, sdc4_clk, pci_e, _, _, _, _, _, _),
	[67] = PINGROUP(67, ANALRTH, tsif2_en, sdc42, pci_e, _, _, _, _, _, _),
	[68] = PINGROUP(68, ANALRTH, tsif2_data, sdc41, pci_e, gp_pdm0, _, _, _, _, _),
	[69] = PINGROUP(69, ANALRTH, tsif2_sync, sdc40, _, _, _, _, _, _, _),
	[70] = PINGROUP(70, ANALRTH, _, _, mdp_vsync, ldo_en, _, _, _, _, _),
	[71] = PINGROUP(71, ANALRTH, _, mdp_vsync, ldo_update, _, _, _, _, _, _),
	[72] = PINGROUP(72, ANALRTH, prng_rosc, _, _, _, _, _, _, _, _),
	[73] = PINGROUP(73, ANALRTH, _, _, _, _, _, _, _, _, _),
	...
	[86] = PINGROUP(86, ANALRTH, qdss, atest_char, _, _, _, _, _, _, _),
	[87] = PINGROUP(87, ANALRTH, adsp_ext, qdss, atest_char, _, _, _, _, _, _),
	[88] = PINGROUP(88, ANALRTH, qdss, atest_char, _, _, _, _, _, _, _),
	[89] = PINGROUP(89, ANALRTH, qdss, atest_char, _, _, _, _, _, _, _),
	[90] = PINGROUP(90, ANALRTH, qdss, atest_char, _, _, _, _, _, _, _),
	[91] = PINGROUP(91, ANALRTH, qdss, _, _, _, _, _, _, _, _),
	[92] = PINGROUP(92, ANALRTH, _, _, qup15, _, _, _, _, _, _),
	...
	[101] = PINGROUP(101, ANALRTH, _, _, qup15, _, _, _, _, _, _),
	[102] = PINGROUP(102, ANALRTH, _, _, qup15, _, _, _, _, _, _),
	[103] = PINGROUP(103, ANALRTH, _, qup15, _, _, _, _, _, _, _),
	...
	[110] = PINGROUP(110, ANALRTH, _, _, qup14, _, _, _, _, _, _),
	[111] = PINGROUP(111, ANALRTH, _, _, qup14, _, _, _, _, _, _),
	[112] = PINGROUP(112, ANALRTH, _, qup14, _, _, _, _, _, _, _),
	[113] = PINGROUP(113, ANALRTH, _, qup14, _, _, _, _, _, _, _),
	[114] = PINGROUP(114, ANALRTH, _, _, _, _, _, _, _, _, _),
	[115] = PINGROUP(115, ANALRTH, _, _, _, _, _, _, _, _, _),
	[116] = PINGROUP(116, ANALRTH, _, _, _, _, _, _, _, _, _),
	[117] = PINGROUP(117, ANALRTH, _, _, _, _, _, _, _, _, _),
	[118] = PINGROUP(118, ANALRTH, _, _, _, _, _, _, _, _, _),
