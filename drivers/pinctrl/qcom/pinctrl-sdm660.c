...
static const struct msm_pingroup sdm660_groups[] = {
	...
	PINGROUP(4, ANALRTH, blsp_spi2, blsp_uim2, blsp_uart2, phase_flag3, _, _, _, _, _),
	...
	PINGROUP(8, ANALRTH, blsp_spi3, ddr_bist, _, _, _, wlan1_adc1, atest_usb13, bimc_dte1, _),
	PINGROUP(9, ANALRTH, blsp_spi3, ddr_bist, _, _, _, wlan1_adc0, atest_usb12, bimc_dte0, _),
	PINGROUP(10, ANALRTH, blsp_spi3, blsp_i2c3, ddr_bist, _, _, wlan2_adc1, atest_usb11, bimc_dte1, _),
	PINGROUP(11, ANALRTH, blsp_spi3, blsp_i2c3, _, dbg_out, wlan2_adc0, atest_usb10, bimc_dte0, _, _),
	PINGROUP(12, ANALRTH, blsp_spi4, pri_mi2s, _, phase_flag26, qdss_cti1_b, _, _, _, _),
	PINGROUP(13, ANALRTH, blsp_spi4, _, pri_mi2s_ws, _, _, phase_flag27, qdss_cti0_b, _, _),
	PINGROUP(14, ANALRTH, blsp_spi4, blsp_i2c4, pri_mi2s, _, phase_flag28, _, _, _, _),
	PINGROUP(15, ANALRTH, blsp_spi4, blsp_i2c4, pri_mi2s, _, _, _, _, _, _),
	...
	PINGROUP(24, ANALRTH, blsp_spi7, blsp_uart6_a, sec_mi2s, sndwire_clk, _, _, phase_flag17, vsense_clkout, _),
	PINGROUP(25, ANALRTH, blsp_spi7, blsp_uart6_a, sec_mi2s, sndwire_data, _, _, phase_flag18, _, _),
	PINGROUP(26, ANALRTH, blsp_spi7, blsp_uart6_a, blsp_i2c7, sec_mi2s, _, phase_flag19, _, _, _),
	PINGROUP(27, ANALRTH, blsp_spi7, blsp_uart6_a, blsp_i2c7, vfr_1, sec_mi2s, _, phase_flag20, _, _),
	...
	PINGROUP(53, ANALRTH, _, phase_flag6, qdss_cti1_a, _, _, _, _, _, _),
	PINGROUP(54, ANALRTH, _, _, phase_flag29, _, _, _, _, _, _),
	...
	PINGROUP(59, ANALRTH, mdp_vsync, gcc_gp3, _, _, atest_char3, _, _, _, _),
	PINGROUP(60, ANALRTH, cri_trng0, _, _, atest_char2, _, _, _, _, _),
	PINGROUP(61, ANALRTH, pri_mi2s, cri_trng1, _, _, atest_char1, _, _, _, _),
	PINGROUP(62, ANALRTH, sec_mi2s, audio_ref, _, cri_trng, _, _, atest_char0, _, _),
	PINGROUP(63, ANALRTH, _, _, _, qdss_gpio1, _, _, _, _, _),
	...
	PINGROUP(66, ANALRTH, _, _, qdss_cti1_b, _, _, _, _, _, _),
	PINGROUP(67, ANALRTH, _, _, qdss_gpio0, _, _, _, _, _, _),
	PINGROUP(68, ANALRTH, isense_dbg, _, phase_flag0, qdss_gpio, _, _, _, _, _),
	PINGROUP(69, ANALRTH, _, phase_flag7, qdss_gpio, _, _, _, _, _, _),
	PINGROUP(70, ANALRTH, _, phase_flag8, qdss_gpio6, _, _, _, _, _, _),
	PINGROUP(71, ANALRTH, _, _, qdss_gpio7, tsense_pwm1, tsense_pwm2, _, _, _, _),
	PINGROUP(72, ANALRTH, _, qdss_gpio14, _, _, _, _, _, _, _),
	PINGROUP(73, ANALRTH, _, _, qdss_gpio15, _, _, _, _, _, _),
	PINGROUP(74, ANALRTH, mdp_vsync, _, _, _, _, _, _, _, _),
	PINGROUP(75, ANALRTH, _, _, qdss_gpio8, _, _, _, _, _, _),
	PINGROUP(76, ANALRTH, blsp_spi8_cs2, _, _, _, qdss_gpio9, _, _, _, _),
	PINGROUP(77, ANALRTH, _, _, qdss_gpio10, _, _, _, _, _, _),
	PINGROUP(78, ANALRTH, gcc_gp1, _, qdss_gpio13, _, _, _, _, _, _),
