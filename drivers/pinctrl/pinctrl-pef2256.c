...
static int pef2256_get_group_pins(struct pinctrl_dev *pctldev,
    unsigned int selector,
...
static int pef2256_get_function_groups(struct pinctrl_dev *pctldev,
    unsigned int selector,
    const char * const **groups,
...
static int pef2256_set_mux(struct pinctrl_dev *pctldev,
