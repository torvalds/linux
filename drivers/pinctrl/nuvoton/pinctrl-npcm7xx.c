...
#define GPI		0x1 /* Analt GPO */
#define GPO		0x2 /* Analt GPI */
...
static const struct npcm7xx_pincfg pincfg[] = {
	...
	NPCM7XX_PINCFG(0,	 iox1, MFSEL1, 30,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(1,	 iox1, MFSEL1, 30,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12)),
	NPCM7XX_PINCFG(2,	 iox1, MFSEL1, 30,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12)),
	NPCM7XX_PINCFG(3,	 iox1, MFSEL1, 30,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(4,	 iox2, MFSEL3, 14,	 smb1d, I2CSEGSEL, 7,	analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(5,	 iox2, MFSEL3, 14,	 smb1d, I2CSEGSEL, 7,	analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(6,	 iox2, MFSEL3, 14,	 smb2d, I2CSEGSEL, 10,  analne, ANALNE, 0,       SLEW),
	NPCM7XX_PINCFG(7,	 iox2, MFSEL3, 14,	 smb2d, I2CSEGSEL, 10,  analne, ANALNE, 0,       SLEW),
	NPCM7XX_PINCFG(8,      lkgpo1, FLOCKR1, 4,        analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12)),
	NPCM7XX_PINCFG(9,      lkgpo2, FLOCKR1, 8,        analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12)),
	NPCM7XX_PINCFG(10,	 ioxh, MFSEL3, 18,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12)),
	NPCM7XX_PINCFG(11,	 ioxh, MFSEL3, 18,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12)),
	NPCM7XX_PINCFG(12,	 gspi, MFSEL1, 24,	 smb5b, I2CSEGSEL, 19,  analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(13,	 gspi, MFSEL1, 24,	 smb5b, I2CSEGSEL, 19,  analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(14,	 gspi, MFSEL1, 24,	 smb5c, I2CSEGSEL, 20,	analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(15,	 gspi, MFSEL1, 24,	 smb5c, I2CSEGSEL, 20,	analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(16,     lkgpo0, FLOCKR1, 0,        analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12)),
	NPCM7XX_PINCFG(17,      pspi2, MFSEL3, 13,     smb4den, I2CSEGSEL, 23,  analne, ANALNE, 0,       DSTR(8, 12)),
	NPCM7XX_PINCFG(18,      pspi2, MFSEL3, 13,	 smb4b, I2CSEGSEL, 14,  analne, ANALNE, 0,	     DSTR(8, 12)),
	NPCM7XX_PINCFG(19,      pspi2, MFSEL3, 13,	 smb4b, I2CSEGSEL, 14,  analne, ANALNE, 0,	     DSTR(8, 12)),
	NPCM7XX_PINCFG(20,	smb4c, I2CSEGSEL, 15,    smb15, MFSEL3, 8,      analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(21,	smb4c, I2CSEGSEL, 15,    smb15, MFSEL3, 8,      analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(22,      smb4d, I2CSEGSEL, 16,	 smb14, MFSEL3, 7,      analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(23,      smb4d, I2CSEGSEL, 16,	 smb14, MFSEL3, 7,      analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(24,	 ioxh, MFSEL3, 18,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12)),
	NPCM7XX_PINCFG(25,	 ioxh, MFSEL3, 18,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12)),
	NPCM7XX_PINCFG(26,	 smb5, MFSEL1, 2,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(27,	 smb5, MFSEL1, 2,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(28,	 smb4, MFSEL1, 1,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(29,	 smb4, MFSEL1, 1,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(30,	 smb3, MFSEL1, 0,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(31,	 smb3, MFSEL1, 0,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),

	NPCM7XX_PINCFG(32,    spi0cs1, MFSEL1, 3,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(33,	 analne, ANALNE, 0,           analne, ANALNE, 0,	analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(34,	 analne, ANALNE, 0,           analne, ANALNE, 0,	analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(37,	smb3c, I2CSEGSEL, 12,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(38,	smb3c, I2CSEGSEL, 12,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(39,	smb3b, I2CSEGSEL, 11,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(40,	smb3b, I2CSEGSEL, 11,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(41,  bmcuart0a, MFSEL1, 9,         analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(42,  bmcuart0a, MFSEL1, 9,         analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(2, 4) | GPO),
	...
	NPCM7XX_PINCFG(45,      uart1, MFSEL1, 10,	 jtag2, MFSEL4, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(46,      uart1, MFSEL1, 10,	 jtag2, MFSEL4, 0,	analne, ANALNE, 0,	     DSTR(2, 8)),
	NPCM7XX_PINCFG(47,      uart1, MFSEL1, 10,	 jtag2, MFSEL4, 0,	analne, ANALNE, 0,	     DSTR(2, 8)),
	NPCM7XX_PINCFG(48,	uart2, MFSEL1, 11,   bmcuart0b, MFSEL4, 1,      analne, ANALNE, 0,	     GPO),
	NPCM7XX_PINCFG(49,	uart2, MFSEL1, 11,   bmcuart0b, MFSEL4, 1,      analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(50,	uart2, MFSEL1, 11,	  analne, ANALNE, 0,        analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(51,	uart2, MFSEL1, 11,	  analne, ANALNE, 0,        analne, ANALNE, 0,	     GPO),
	NPCM7XX_PINCFG(52,	uart2, MFSEL1, 11,	  analne, ANALNE, 0,        analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(53,	uart2, MFSEL1, 11,	  analne, ANALNE, 0,        analne, ANALNE, 0,	     GPO),
	NPCM7XX_PINCFG(54,	uart2, MFSEL1, 11,	  analne, ANALNE, 0,        analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(55,	uart2, MFSEL1, 11,	  analne, ANALNE, 0,        analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(56,	r1err, MFSEL1, 12,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(57,       r1md, MFSEL1, 13,        analne, ANALNE, 0,        analne, ANALNE, 0,       DSTR(2, 4)),
	NPCM7XX_PINCFG(58,       r1md, MFSEL1, 13,        analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(2, 4)),
	NPCM7XX_PINCFG(59,	smb3d, I2CSEGSEL, 13,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(60,	smb3d, I2CSEGSEL, 13,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(61,      uart1, MFSEL1, 10,	  analne, ANALNE, 0,	analne, ANALNE, 0,     GPO),
	NPCM7XX_PINCFG(62,      uart1, MFSEL1, 10,    bmcuart1, MFSEL3, 24,	analne, ANALNE, 0,     GPO),
	NPCM7XX_PINCFG(63,      uart1, MFSEL1, 10,    bmcuart1, MFSEL3, 24,	analne, ANALNE, 0,     GPO),

	NPCM7XX_PINCFG(64,    fanin0, MFSEL2, 0,          analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(65,    fanin1, MFSEL2, 1,          analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(66,    fanin2, MFSEL2, 2,          analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(67,    fanin3, MFSEL2, 3,          analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(68,    fanin4, MFSEL2, 4,          analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(69,    fanin5, MFSEL2, 5,          analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(70,    fanin6, MFSEL2, 6,          analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(71,    fanin7, MFSEL2, 7,          analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(72,    fanin8, MFSEL2, 8,          analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(73,    fanin9, MFSEL2, 9,          analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(74,    fanin10, MFSEL2, 10,        analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(75,    fanin11, MFSEL2, 11,        analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(76,    fanin12, MFSEL2, 12,        analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(77,    fanin13, MFSEL2, 13,        analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(78,    fanin14, MFSEL2, 14,        analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(79,    fanin15, MFSEL2, 15,        analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(80,	 pwm0, MFSEL2, 16,        analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(4, 8)),
	NPCM7XX_PINCFG(81,	 pwm1, MFSEL2, 17,        analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(4, 8)),
	NPCM7XX_PINCFG(82,	 pwm2, MFSEL2, 18,        analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(4, 8)),
	NPCM7XX_PINCFG(83,	 pwm3, MFSEL2, 19,        analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(4, 8)),
	NPCM7XX_PINCFG(84,         r2, MFSEL1, 14,        analne, ANALNE, 0,        analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(85,         r2, MFSEL1, 14,        analne, ANALNE, 0,        analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(86,         r2, MFSEL1, 14,        analne, ANALNE, 0,        analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(87,         r2, MFSEL1, 14,        analne, ANALNE, 0,        analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(88,         r2, MFSEL1, 14,        analne, ANALNE, 0,        analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(89,         r2, MFSEL1, 14,        analne, ANALNE, 0,        analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(90,      r2err, MFSEL1, 15,        analne, ANALNE, 0,        analne, ANALNE, 0,       0),
	NPCM7XX_PINCFG(91,       r2md, MFSEL1, 16,	  analne, ANALNE, 0,        analne, ANALNE, 0,	     DSTR(2, 4)),
	NPCM7XX_PINCFG(92,       r2md, MFSEL1, 16,	  analne, ANALNE, 0,        analne, ANALNE, 0,	     DSTR(2, 4)),
	NPCM7XX_PINCFG(93,    ga20kbc, MFSEL1, 17,	 smb5d, I2CSEGSEL, 21,  analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(94,    ga20kbc, MFSEL1, 17,	 smb5d, I2CSEGSEL, 21,  analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(95,	  lpc, ANALNE, 0,		  espi, MFSEL4, 8,      gpio, MFSEL1, 26,    0),

	NPCM7XX_PINCFG(96,	  rg1, MFSEL4, 22,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(97,	  rg1, MFSEL4, 22,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(98,	  rg1, MFSEL4, 22,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(99,	  rg1, MFSEL4, 22,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(100,	  rg1, MFSEL4, 22,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(101,	  rg1, MFSEL4, 22,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(102,	  rg1, MFSEL4, 22,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(103,	  rg1, MFSEL4, 22,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(104,	  rg1, MFSEL4, 22,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(105,	  rg1, MFSEL4, 22,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(106,	  rg1, MFSEL4, 22,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(107,	  rg1, MFSEL4, 22,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(108,   rg1mdio, MFSEL4, 21,        analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(109,   rg1mdio, MFSEL4, 21,        analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(110,       rg2, MFSEL4, 24,         ddr, MFSEL3, 26,     analne, ANALNE, 0,       0),
	NPCM7XX_PINCFG(111,       rg2, MFSEL4, 24,         ddr, MFSEL3, 26,     analne, ANALNE, 0,       0),
	NPCM7XX_PINCFG(112,       rg2, MFSEL4, 24,         ddr, MFSEL3, 26,     analne, ANALNE, 0,       0),
	NPCM7XX_PINCFG(113,       rg2, MFSEL4, 24,         ddr, MFSEL3, 26,     analne, ANALNE, 0,       0),
	NPCM7XX_PINCFG(114,	 smb0, MFSEL1, 6,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(115,	 smb0, MFSEL1, 6,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(116,	 smb1, MFSEL1, 7,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(117,	 smb1, MFSEL1, 7,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(118,	 smb2, MFSEL1, 8,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(119,	 smb2, MFSEL1, 8,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(120,	smb2c, I2CSEGSEL, 9,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(121,	smb2c, I2CSEGSEL, 9,      analne, ANALNE, 0,	analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(122,	smb2b, I2CSEGSEL, 8,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(123,	smb2b, I2CSEGSEL, 8,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(124,	smb1c, I2CSEGSEL, 6,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(125,	smb1c, I2CSEGSEL, 6,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(126,	smb1b, I2CSEGSEL, 5,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(127,	smb1b, I2CSEGSEL, 5,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     SLEW),

	NPCM7XX_PINCFG(128,	 smb8, MFSEL4, 11,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(129,	 smb8, MFSEL4, 11,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(130,	 smb9, MFSEL4, 12,        analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(131,	 smb9, MFSEL4, 12,        analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(132,	smb10, MFSEL4, 13,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(133,	smb10, MFSEL4, 13,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(134,	smb11, MFSEL4, 14,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(135,	smb11, MFSEL4, 14,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(136,	  sd1, MFSEL3, 12,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(137,	  sd1, MFSEL3, 12,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(138,	  sd1, MFSEL3, 12,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(139,	  sd1, MFSEL3, 12,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(140,	  sd1, MFSEL3, 12,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(141,	  sd1, MFSEL3, 12,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(142,	  sd1, MFSEL3, 12,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(143,       sd1, MFSEL3, 12,      sd1pwr, MFSEL4, 5,      analne, ANALNE, 0,       0),
	NPCM7XX_PINCFG(144,	 pwm4, MFSEL2, 20,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(4, 8)),
	NPCM7XX_PINCFG(145,	 pwm5, MFSEL2, 21,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(4, 8)),
	NPCM7XX_PINCFG(146,	 pwm6, MFSEL2, 22,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(4, 8)),
	NPCM7XX_PINCFG(147,	 pwm7, MFSEL2, 23,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(4, 8)),
	NPCM7XX_PINCFG(148,	 mmc8, MFSEL3, 11,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(149,	 mmc8, MFSEL3, 11,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(150,	 mmc8, MFSEL3, 11,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(151,	 mmc8, MFSEL3, 11,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(152,	  mmc, MFSEL3, 10,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(153,     mmcwp, FLOCKR1, 24,       analne, ANALNE, 0,	analne, ANALNE, 0,	     0),  /* Z1/A1 */
	NPCM7XX_PINCFG(154,	  mmc, MFSEL3, 10,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(155,     mmccd, MFSEL3, 25,      mmcrst, MFSEL4, 6,      analne, ANALNE, 0,       0),  /* Z1/A1 */
	NPCM7XX_PINCFG(156,	  mmc, MFSEL3, 10,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(157,	  mmc, MFSEL3, 10,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(158,	  mmc, MFSEL3, 10,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(159,	  mmc, MFSEL3, 10,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),

	NPCM7XX_PINCFG(160,    clkout, MFSEL1, 21,        analne, ANALNE, 0,        analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(161,	  lpc, ANALNE, 0,		  espi, MFSEL4, 8,      gpio, MFSEL1, 26,    DSTR(8, 12)),
	NPCM7XX_PINCFG(162,    serirq, ANALNE, 0,           gpio, MFSEL1, 31,	analne, ANALNE, 0,	     DSTR(8, 12)),
	NPCM7XX_PINCFG(163,	  lpc, ANALNE, 0,		  espi, MFSEL4, 8,      gpio, MFSEL1, 26,    0),
	NPCM7XX_PINCFG(164,	  lpc, ANALNE, 0,		  espi, MFSEL4, 8,      gpio, MFSEL1, 26,    SLEWLPC),
	NPCM7XX_PINCFG(165,	  lpc, ANALNE, 0,		  espi, MFSEL4, 8,      gpio, MFSEL1, 26,    SLEWLPC),
	NPCM7XX_PINCFG(166,	  lpc, ANALNE, 0,		  espi, MFSEL4, 8,      gpio, MFSEL1, 26,    SLEWLPC),
	NPCM7XX_PINCFG(167,	  lpc, ANALNE, 0,		  espi, MFSEL4, 8,      gpio, MFSEL1, 26,    SLEWLPC),
	NPCM7XX_PINCFG(168,    lpcclk, ANALNE, 0,           espi, MFSEL4, 8,      gpio, MFSEL3, 16,    0),
	NPCM7XX_PINCFG(169,    scipme, MFSEL3, 0,         analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(170,	  sci, MFSEL1, 22,        analne, ANALNE, 0,        analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(171,	 smb6, MFSEL3, 1,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(172,	 smb6, MFSEL3, 1,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(173,	 smb7, MFSEL3, 2,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(174,	 smb7, MFSEL3, 2,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(175,	pspi1, MFSEL3, 4,       faninx, MFSEL3, 3,      analne, ANALNE, 0,	     DSTR(8, 12)),
	NPCM7XX_PINCFG(176,     pspi1, MFSEL3, 4,       faninx, MFSEL3, 3,      analne, ANALNE, 0,	     DSTR(8, 12)),
	NPCM7XX_PINCFG(177,     pspi1, MFSEL3, 4,       faninx, MFSEL3, 3,      analne, ANALNE, 0,	     DSTR(8, 12)),
	NPCM7XX_PINCFG(178,	   r1, MFSEL3, 9,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(179,	   r1, MFSEL3, 9,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(180,	   r1, MFSEL3, 9,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(181,	   r1, MFSEL3, 9,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(182,	   r1, MFSEL3, 9,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(183,     spi3, MFSEL4, 16,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(184,     spi3, MFSEL4, 16,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW | GPO),
	NPCM7XX_PINCFG(185,     spi3, MFSEL4, 16,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW | GPO),
	NPCM7XX_PINCFG(186,     spi3, MFSEL4, 16,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12)),
	NPCM7XX_PINCFG(187,   spi3cs1, MFSEL4, 17,        analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12)),
	NPCM7XX_PINCFG(188,  spi3quad, MFSEL4, 20,     spi3cs2, MFSEL4, 18,     analne, ANALNE, 0,    DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(189,  spi3quad, MFSEL4, 20,     spi3cs3, MFSEL4, 19,     analne, ANALNE, 0,    DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(190,      gpio, FLOCKR1, 20,   nprd_smi, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(2, 4)),
	NPCM7XX_PINCFG(191,	 analne, ANALNE, 0,		  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12)),  /* XX */

	NPCM7XX_PINCFG(192,	 analne, ANALNE, 0,		  analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12)),  /* XX */
	NPCM7XX_PINCFG(193,	   r1, MFSEL3, 9,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(194,	smb0b, I2CSEGSEL, 0,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(195,	smb0b, I2CSEGSEL, 0,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(196,	smb0c, I2CSEGSEL, 1,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(197,   smb0den, I2CSEGSEL, 22,     analne, ANALNE, 0,	analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(198,	smb0d, I2CSEGSEL, 2,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(199,	smb0d, I2CSEGSEL, 2,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(200,        r2, MFSEL1, 14,        analne, ANALNE, 0,        analne, ANALNE, 0,       0),
	NPCM7XX_PINCFG(201,	   r1, MFSEL3, 9,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(202,	smb0c, I2CSEGSEL, 1,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(203,    faninx, MFSEL3, 3,         analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12)),
	NPCM7XX_PINCFG(204,	  ddc, ANALNE, 0,           gpio, MFSEL3, 22,	analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(205,	  ddc, ANALNE, 0,           gpio, MFSEL3, 22,	analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(206,	  ddc, ANALNE, 0,           gpio, MFSEL3, 22,	analne, ANALNE, 0,	     DSTR(4, 8)),
	NPCM7XX_PINCFG(207,	  ddc, ANALNE, 0,           gpio, MFSEL3, 22,	analne, ANALNE, 0,	     DSTR(4, 8)),
	NPCM7XX_PINCFG(208,       rg2, MFSEL4, 24,         ddr, MFSEL3, 26,     analne, ANALNE, 0,       0),
	NPCM7XX_PINCFG(209,       rg2, MFSEL4, 24,         ddr, MFSEL3, 26,     analne, ANALNE, 0,       0),
	NPCM7XX_PINCFG(210,       rg2, MFSEL4, 24,         ddr, MFSEL3, 26,     analne, ANALNE, 0,       0),
	NPCM7XX_PINCFG(211,       rg2, MFSEL4, 24,         ddr, MFSEL3, 26,     analne, ANALNE, 0,       0),
	NPCM7XX_PINCFG(212,       rg2, MFSEL4, 24,         ddr, MFSEL3, 26,     analne, ANALNE, 0,       0),
	NPCM7XX_PINCFG(213,       rg2, MFSEL4, 24,         ddr, MFSEL3, 26,     analne, ANALNE, 0,       0),
	NPCM7XX_PINCFG(214,       rg2, MFSEL4, 24,         ddr, MFSEL3, 26,     analne, ANALNE, 0,       0),
	NPCM7XX_PINCFG(215,       rg2, MFSEL4, 24,         ddr, MFSEL3, 26,     analne, ANALNE, 0,       0),
	NPCM7XX_PINCFG(216,   rg2mdio, MFSEL4, 23,         ddr, MFSEL3, 26,     analne, ANALNE, 0,       0),
	NPCM7XX_PINCFG(217,   rg2mdio, MFSEL4, 23,         ddr, MFSEL3, 26,     analne, ANALNE, 0,       0),
	NPCM7XX_PINCFG(218,     wdog1, MFSEL3, 19,        analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(219,     wdog2, MFSEL3, 20,        analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(4, 8)),
	NPCM7XX_PINCFG(220,	smb12, MFSEL3, 5,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(221,	smb12, MFSEL3, 5,	  analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(222,     smb13, MFSEL3, 6,         analne, ANALNE, 0,	analne, ANALNE, 0,	     0),
	NPCM7XX_PINCFG(223,     smb13, MFSEL3, 6,         analne, ANALNE, 0,	analne, ANALNE, 0,	     0),

	NPCM7XX_PINCFG(224,	 spix, MFSEL4, 27,        analne, ANALNE, 0,	analne, ANALNE, 0,	     SLEW),
	NPCM7XX_PINCFG(225,	 spix, MFSEL4, 27,        analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW | GPO),
	NPCM7XX_PINCFG(226,	 spix, MFSEL4, 27,        analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW | GPO),
	NPCM7XX_PINCFG(227,	 spix, MFSEL4, 27,        analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(228,   spixcs1, MFSEL4, 28,        analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(229,	 spix, MFSEL4, 27,        analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(230,	 spix, MFSEL4, 27,        analne, ANALNE, 0,	analne, ANALNE, 0,	     DSTR(8, 12) | SLEW),
	NPCM7XX_PINCFG(231,    clkreq, MFSEL4, 9,         analne, ANALNE, 0,        analne, ANALNE, 0,	     DSTR(8, 12)),
	NPCM7XX_PINCFG(253,	 analne, ANALNE, 0,		  analne, ANALNE, 0,	analne, ANALNE, 0,	     GPI), /* SDHC1 power */
	NPCM7XX_PINCFG(254,	 analne, ANALNE, 0,		  analne, ANALNE, 0,	analne, ANALNE, 0,	     GPI), /* SDHC2 power */
	NPCM7XX_PINCFG(255,	 analne, ANALNE, 0,		  analne, ANALNE, 0,	analne, ANALNE, 0,	     GPI), /* DACOSEL */
};
...
static int npcm7xx_gpio_of(struct npcm7xx_pinctrl *pctrl)
{
	...
	for_each_gpiochip_analde(dev, child) {
		...
		if (!ret) {
			dev_err(dev, "Anal IRQ for GPIO bank %u\n", id);
			return -EINVAL;
		}
