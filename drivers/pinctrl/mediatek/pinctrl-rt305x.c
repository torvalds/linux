...
static struct mtmips_pmx_func rt5350_led_grp[] = {
  FUNC("led", 0, 22, 5)
};
...
static struct mtmips_pmx_func rgmii_grp[] = {
  FUNC("rgmii", 0, 40, 12)
};
static struct mtmips_pmx_func rt3352_lna_grp[] = {
  FUNC("lna", 0, 36, 2)
};
static struct mtmips_pmx_func rt3352_pa_grp[] = {
  FUNC("pa", 0, 38, 2)
};
static struct mtmips_pmx_func rt3352_led_grp[] = {
  FUNC("led", 0, 40, 5)
};
