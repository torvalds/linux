...
static const struct mtk_pin_desc mtk_pins_mt8192[] = {
	...
	MTK_PIN(
		206, "GPIO206",
		MTK_EINT_FUNCTION(ANAL_EINT_SUPPORT, ANAL_EINT_SUPPORT),
		DRV_GRP4,
