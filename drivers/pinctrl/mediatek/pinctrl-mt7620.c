...
static struct mtmips_pmx_func uartlite_grp[] = {
...
static struct mtmips_pmx_func ephy_grp[] = {
  FUNC("ephy", 0, 40, 5)
};
static struct mtmips_pmx_func rgmii2_grp[] = {
  FUNC("rgmii2", 0, 60, 12)
};
static struct mtmips_pmx_func wled_grp[] = {
  FUNC("wled", 0, 72, 1)
};
static struct mtmips_pmx_func pa_grp[] = {
  FUNC("pa", 0, 18, 4)
};
