...
static const struct mtk_pin_desc mtk_pins_mt8188[] = {
	...
	MTK_PIN(
		...
		MTK_FUNCTION(2, "B0_SPIANALR_IO0"),
		MTK_FUNCTION(3, "B0_TDMIN_LRCK"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(2, "B0_SPIANALR_IO1"),
		MTK_FUNCTION(3, "I0_TDMIN_DI"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(2, "B0_SPIANALR_IO2"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(2, "B0_SPIANALR_IO3"),
