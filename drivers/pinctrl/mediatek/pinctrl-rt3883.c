...
#define RT3883_GPIO_MODE_PCI    (RT3883_GPIO_MODE_PCI_MASK << \
...
#define RT3883_GPIO_MODE_LNA_A    _RT3883_GPIO_MODE_LNA_A( \
...
#define RT3883_GPIO_MODE_LNA_G    _RT3883_GPIO_MODE_LNA_G( \
...
static struct mtmips_pmx_func lna_a_grp[] = {
  FUNC("lna a", 0, 32, 3)
};
static struct mtmips_pmx_func lna_g_grp[] = {
  FUNC("lna g", 0, 35, 3)
};
...
static struct mtmips_pmx_func ge1_grp[] = {
  FUNC("ge1", 0, 72, 12)
};
static struct mtmips_pmx_func ge2_grp[] = {
  FUNC("ge2", 0, 84, 12)
};
