...
static const char * const led_10_groups[] = {
  "led_10_grp_a", "led_10_grp_b"
};
static const char * const led_11_groups[] = {
  "led_11_grp_a", "led_11_grp_b"
};
static const char * const led_12_groups[] = {
  "led_12_grp_a", "led_12_grp_b"
};
...
static int bcm4908_pinctrl_probe(struct platform_device *pdev) {
  ...
  /* Register */
  bcm4908_pinctrl->pctldev = devm_pinctrl_register(dev, pctldesc,
      bcm4908_pinctrl);
  ...
  for (i = 0; i < ARRAY_SIZE(bcm4908_pinctrl_functions); i++) {
    const struct bcm4908_pinctrl_function *function
      = &bcm4908_pinctrl_functions[i];
