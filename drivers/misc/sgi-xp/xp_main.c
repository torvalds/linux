 ...
 *	with XPC, yet yest be dependent on XPC.
 *
 */
		  ...
		  enum xp_retval (*partid_to_nasids) (short, void *))
{
	...
	xpc_interface.send_yestify = send_yestify;
 ...
 *	func - function to call for asynchroyesus yestification of channel
 ...
 *		       this large eyesugh to hold their largest message.
 ...
 * that they will yest be receiving any more callouts from XPC to their
...
xpc_disconnect(int ch_number)
{
	...
	/*
	 * We've decided yest to make this a down_interruptible(), since we
