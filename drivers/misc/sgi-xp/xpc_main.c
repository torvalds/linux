 ...
 */
static void xpc_timeout_partition_disengage(struct timer_list *t) {
 ...
 */
static void xpc_hb_beater(struct timer_list *unused) {
 ...
 */
static void xpc_kthread_waitmsgs(struct xpc_partition *part,
    struct xpc_channel *ch) {
 ...
 * partition.
 */
void xpc_create_kthreads(struct xpc_channel *ch, int needed,
 ...
 */
static int xpc_system_reboot(struct notifier_block *nb, unsigned long event,
    void *unused) {
 ...
 */
static int xpc_system_die(struct notifier_block *nb, unsigned long event,
    void *_die_args) {
