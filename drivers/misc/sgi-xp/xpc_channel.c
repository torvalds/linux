 ...
 */
static void xpc_process_connect(struct xpc_channel *ch,
 ...
 */
static void xpc_process_disconnect(struct xpc_channel *ch,
    unsigned long *irq_flags) {
 ...
 */
static void xpc_process_openclose_chctl_flags(struct xpc_partition *part,
    int ch_number,
    u8 chctl_flags) {
  unsigned long irq_flags;
 ...
 */
void xpc_disconnect_channel(const int line, struct xpc_channel *ch,
 ...
 */
enum xp_retval xpc_initiate_send(short partid, int ch_number, u32 flags,
    void *payload,
    u16 payload_size) {
