...
static inline enum xp_retval xpc_send(short partid, int ch_number, u32 flags,
    void *payload,
    u16 payload_size) {
...
static inline enum xp_retval xpc_send_notify(short partid, int ch_number,
...
static inline void xpc_received(short partid, int ch_number, void *payload) {
  if (xpc_interface.received) {
    xpc_interface.received(partid, ch_number, payload);
  }
}

static inline enum xp_retval xpc_partid_to_nasids(short partid, void *nasids) {
