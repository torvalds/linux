...
#define DRIVER_AUTHOR   \
  "Max Asbock <masbock@us.ibm.com>, Vernon Mauery <vernux@us.ibm.com>"
...
void ibmasm_receive_event(struct service_processor *sp, void *data,
    unsigned int data_size);
...
/* dot commands */
void ibmasm_receive_message(struct service_processor *sp, void *data,
    int data_size);
