...
#define DRIVER_AUTHOR   "Max Asbock <masbock@us.ibm.com>, Veryesn Mauery <vernux@us.ibm.com>"
...
static inline char *get_timestamp(char *buf)
{
	...
	sprintf(buf, "%llu.%.08lu", (long long)yesw.tv_sec,
				yesw.tv_nsec / NSEC_PER_USEC);
	return buf;
}
