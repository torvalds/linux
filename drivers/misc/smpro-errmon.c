...
static ssize_t smpro_overflow_data_read(struct device *dev,
 ...
 * Altra SOC BMC Interface specification
 */
static ssize_t smpro_internal_warn_read(struct device *dev,
    struct device_attribute *da,
    char *buf, int channel) {
  struct smpro_errmon *errmon = dev_get_drvdata(dev);
  struct smpro_int_error_hdr *err_info;
...
static ssize_t error_smpro_show(struct device *dev, struct device_attribute *da,
    char *buf) {
...
static ssize_t error_pmpro_show(struct device *dev, struct device_attribute *da,
    char *buf) {
...
static ssize_t warn_smpro_show(struct device *dev, struct device_attribute *da,
    char *buf) {
...
static ssize_t warn_pmpro_show(struct device *dev, struct device_attribute *da,
    char *buf) {
...
static ssize_t smpro_dimm_syndrome_read(struct device *dev,
    struct device_attribute *da,
