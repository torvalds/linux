 ...
 *              swap operation to ensure that there are yes races when
 ...
 * of one queue entry to ayesther with the software in the chip.
 */
 ...
 *   16 compare and swap operation is yest supported. Therefore
