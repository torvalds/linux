 ...
 * datagram queues. It is allocated in yesn-paged memory, as the
 ...
 * the datagram in the yesn-paged queue entry as this size is used
...
/* Datagram API for yesn-public use. */
