...
static int gru_try_dropin(struct gru_state *gru,
  ...
  if (unlikely(cbe) && pageshift == PAGE_SHIFT) {
    gru_preload_tlb(gru, gts, atomic, vaddr, asid, write, tlb_preload_count,
        tfh, cbe);
...
again:
  ...
  gru_dbg(grudev, "address 0x%lx, gid %d, gts 0x%p\n", cb,
      gts->ts_gru ? gts->ts_gru->gs_gid : -1, gts);
...
int gru_get_exception_detail(unsigned long arg) {
  ...
  gru_dbg(grudev,
      ...
      excdet.cb, excdet.opc, excdet.exopc, excdet.cbrstate,
      excdet.cbrexecstatus,
      excdet.ecause, excdet.exceptdet0,
      excdet.exceptdet1);
