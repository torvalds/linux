...
#define H_CONTROL_CA_FUNCTION_ACK_FUNCTION_ERR_INT   12 /* ackyeswledge function-wide error data based on an interrupt */
			...
			u64 *process_token, u64 *mmio_addr, u64 *mmio_size)
{
	...
	case H_FUNCTION:      /* The function is yest supported. */
		return -EINVAL;
	case H_AUTHORITY:     /* The partition does yest have authority to perform this hcall */
	case H_RESOURCE:      /* The coherent platform function does yest have eyesugh additional resource to attach the process */
	case H_HARDWARE:      /* A hardware event prevented the attach operation */
	case H_STATE:         /* The coherent platform function is yest in a valid state */
	case H_BUSY:
		return -EBUSY;
	default:
				   ...
				   u64 p1, u64 p2, u64 p3, u64 p4, u64 *out)
{
	...
	case H_PARAMETER:     /* An incorrect parameter was supplied. */
	case H_FUNCTION:      /* The function is yest supported. */
	case H_NOT_FOUND:     /* The operation supplied was yest valid */
	case H_NOT_AVAILABLE: /* The operation canyest be performed because the AFU has yest been downloaded */
			    ...
			    struct cxl_irq_info *info)
{
	...
	case H_STATE:       /* The coherent platform function is yest in a valid state to collect interrupt info. */
		return -EBUSY;
	default:
		WARN(1, "Unexpected return code: %lx", rc);
		return -EINVAL;
			  ...
			  u64 control_mask, u64 reset_mask)
{
	...
	case H_AUTHORITY:  /* The partition does yest have authority to perform this hcall; the coherent platform facilities may need to be licensed. */
		return -EBUSY;
	case H_FUNCTION:   /* The function is yest supported */
	case H_NOT_FOUND:  /* The operation supplied was yest valid */
		return -EINVAL;
				   ...
				   u64 p1, u64 p2, u64 p3, u64 p4, u64 *out)
{
	...
	case H_RESOURCE:      /* The function has page table mappings for MMIO */
	case H_HARDWARE:      /* A hardware event prevented the attach operation */
	case H_STATE:         /* The coherent platform facility is yest in a valid state */
	case H_BUSY:
		return -EBUSY;
	default:
		WARN(1, "Unexpected return code: %lx", rc);
