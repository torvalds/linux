 ...
 */
static int mei_hdcp_initiate_session(struct device *dev,
 ...
 * Return: 0 on Success, <0 on Failure
 */
static int mei_hdcp_verify_receiver_cert_prepare_km(struct device *dev,
    struct hdcp_port_data *data,
 ...
 * Return: 0 on Success, <0 on Failure
 */
static int mei_hdcp_verify_hprime(struct device *dev,
    struct hdcp_port_data *data,
 ...
 * Return: 0 on Success, <0 on Failure
 */
static int mei_hdcp_store_pairing_info(struct device *dev,
    struct hdcp_port_data *data,
 ...
 * Return: 0 on Success, <0 on Failure
 */
static int mei_hdcp_initiate_locality_check(struct device *dev,
    struct hdcp_port_data *data,
 ...
 * Return: 0 on Success, <0 on Failure
 */
static int mei_hdcp_verify_lprime(struct device *dev,
    struct hdcp_port_data *data,
 ...
 * Return: 0 on Success, <0 on Failure
 */
static int mei_hdcp_repeater_check_flow_prepare_ack(struct device *dev,
    struct hdcp_port_data *data,
 ...
 * Return: 0 on Success, <0 on Failure
 */
static int mei_hdcp_close_session(struct device *dev,
    struct hdcp_port_data *data) {
