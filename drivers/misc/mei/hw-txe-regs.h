 ...
 * This register indicates whether or yest processing of
 * the most recent command has been completed by the SEC
 * New commands and payloads should yest be written by the Host
 ...
 * the following conditions did yest hold, to a state where
 ...
 *
 * This register indicates whether or yest processing of the most recent
 * command has been completed by the Host.
 * New commands and payloads should yest be written by SeC until this
