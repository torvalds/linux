...
static int dax_bus_uevent(const struct device *dev,
...
static int dax_match_type(struct dax_device_driver *dax_drv,
    struct device *dev) {
...
static bool alloc_is_aligned(struct dev_dax *dev_dax, resource_size_t size) {
   ...
   */
  return IS_ALIGNED(size,
      max_t(unsigned long, dev_dax->align, memremap_compat_align()));
}
