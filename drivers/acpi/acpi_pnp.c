...
static const struct acpi_device_id acpi_pnp_device_ids[] = {
  ...
  {"NIC2700"},
  /* serial */
  {"AAC000F"},    /* Archtek America Corp. Archtek SmartLink Modem 3334BT Plug &
                   * Play */
  {"ADC0001"},    /* Anchor Datacomm BV. SXPro 144 External Data Fax Modem Plug
                   * & Play */
  ...
  {"ROK0030"},    /* Rockwell 33.6 DPF Internal PnP, Modular Technology 33.6
                   * Internal PnP */
  {"ROK0100"},    /* KORTEX 14400 Externe PnP */
  {"ROK4120"},    /* Rockwell 28.8 */
  {"ROK4920"},    /* Viking 28.8 INTERNAL Fax+Data+Voice PnP */
  {"RSS00A0"},    /* Rockwell 33.6 DPF External PnP, BT Prologue 33.6 External
                   * PnP, Modular Technology 33.6 External PnP */
  ...
  {"LTS0001"},    /* LG C1 EXPRESS DUAL (C1-PB11A3) touch screen (actually a
                   * FUJ02E6 in disguise) */
  {"WCI0003"},    /* Rockwell's (PORALiNK) 33600 INT PNP */
  {"WEC1022"},    /* Winbond CIR port, should not be probed. We should keep
                   * track of it to prevent the legacy serial driver from
                   * probing it */
  /* scl200wdt */
  ...
  {"CSC0110"},
  {"CSC0000"},
  {"GIM0100"},    /* Guillemot Turtlebeach something appears to be cs4232
                   * compatible */
  /* es18xx-pnpbios */
  {"ESS1869"},
  {"ESS1879"},
...
static bool acpi_pnp_match(const char *idstr,
