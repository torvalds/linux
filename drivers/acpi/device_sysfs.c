 ...
 */
static int create_pnp_modalias(const struct acpi_device *acpi_dev,
    char *modalias,
    int size) {
  int len;
  int count;
 ...
 * ACPI/PNP IDs.
 */
static int create_of_modalias(const struct acpi_device *acpi_dev,
    char *modalias,
    int size) {
 ...
 */
int acpi_device_uevent_modalias(const struct device *dev,
    struct kobj_uevent_env *env) {
...
static int __acpi_device_modalias(const struct acpi_device *adev, char *buf,
    int size) {
  int len, count;
  if (!adev) {
    return -ENODEV;
...
static ssize_t eject_store(struct device *d, struct device_attribute *attr,
...
static ssize_t hid_show(struct device *dev, struct device_attribute *attr,
    char *buf) {
...
static ssize_t sun_show(struct device *dev, struct device_attribute *attr,
    char *buf) {
  struct acpi_device *acpi_dev = to_acpi_device(dev);
  acpi_status status;
...
static ssize_t hrv_show(struct device *dev, struct device_attribute *attr,
    char *buf) {
  struct acpi_device *acpi_dev = to_acpi_device(dev);
  acpi_status status;
