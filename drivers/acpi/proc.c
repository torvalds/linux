...
static int acpi_system_wakeup_device_seq_show(struct seq_file *seq,
    void *offset) {
...
static ssize_t acpi_system_write_wakeup_device(struct file *file,
...
static int acpi_system_wakeup_device_open_fs(struct inode *inode,
    struct file *file) {
