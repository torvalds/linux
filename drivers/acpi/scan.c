...
/* List of HIDs for which we honor deps of matching ACPI devs, when checking
 * _DEP lists. */
static const char * const acpi_honor_dep_ids[] = {
  "INT3472", /* Camera sensor PMIC / clk and regulator info */
  "INTC1059", /* IVSC (TGL) driver must be loaded to allow i2c access to camera
               * sensors */
  "INTC1095", /* IVSC (ADL) driver must be loaded to allow i2c access to camera
               * sensors */
  "INTC100A", /* IVSC (RPL) driver must be loaded to allow i2c access to camera
               * sensors */
  "INTC10CF", /* IVSC (MTL) driver must be loaded to allow i2c access to camera
               * sensors */
  NULL
};
...
static acpi_status acpi_backlight_cap_match(acpi_handle handle, u32 level,
    void *context,
    void **return_value) {
  long *cap = context;
...
static acpi_status acpi_scan_check_crs_csi2_cb(acpi_handle handle, u32 a,
    void *b, void **c) {
...
static int acpi_dev_get_next_consumer_dev_cb(struct acpi_dep_data *dep,
    void *data) {
