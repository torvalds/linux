...
static inline bool __acpi_aml_readable(struct circ_buf *circ,
    unsigned long flag) {
  /*
...
static inline bool __acpi_aml_writable(struct circ_buf *circ,
    unsigned long flag) {
  /*
 ...
 */
static int acpi_aml_create_thread(acpi_osd_exec_callback function,
    void *context) {
