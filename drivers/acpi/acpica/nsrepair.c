...
acpi_status acpi_ns_simple_repair(struct acpi_evaluate_info *info,
    u32 expected_btypes,
    u32 package_index,
...
acpi_status acpi_ns_repair_null_element(struct acpi_evaluate_info *info,
    u32 expected_btypes,
    u32 package_index,
    union acpi_operand_object **return_object_ptr) {
  union acpi_operand_object *return_object = *return_object_ptr;
...
void acpi_ns_remove_null_elements(struct acpi_evaluate_info *info,
    u8 package_type,
...
acpi_status acpi_ns_wrap_with_package(struct acpi_evaluate_info *info,
