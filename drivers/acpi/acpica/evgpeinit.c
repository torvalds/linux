 ...
 * and to inform ACPICA of these GPEs via the acpi_setup_gpe_for_wake interface.
 * This
...
#else
#define ACPI_FADT_GPE_BLOCK_ADDRESS(N)  acpi_gbl_FADT.xgpe ## N ## _block. \
  address
 ...
 *
 * If walk_info->execute_by_owner_id is TRUE, we only execute examine GPE
 * methods
 * with that owner.
 *
 ******************************************************************************/
