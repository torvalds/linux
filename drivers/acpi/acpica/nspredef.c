 ...
 * at the time they are evaluated (via acpi_evaluate_object). The purpose of
 * this
 ...
 ******************************************************************************/
/* Local prototypes */
static acpi_status acpi_ns_check_reference(struct acpi_evaluate_info *info,
...
acpi_status acpi_ns_check_return_value(struct acpi_namespace_node *node,
...
acpi_status acpi_ns_check_object_type(struct acpi_evaluate_info *info,
    union acpi_operand_object **return_object_ptr,
