...
acpi_status acpi_ut_copy_isimple_to_isimple(
  union acpi_operand_object *source_obj,
  union acpi_operand_object *dest_obj);

acpi_status acpi_ut_copy_iobject_to_iobject(
...
void acpi_ut_debug_dump_buffer(u8 *buffer, u32 count, u32 display,
    u32 component_id);

void acpi_ut_dump_buffer(u8 *buffer, u32 count, u32 display, u32 offset);

#ifdef ACPI_APPLICATION
void acpi_ut_dump_buffer_to_file(ACPI_FILE file,
    u8 *buffer,
...
acpi_status acpi_ut_short_multiply(u64 in_multiplicand, u32 multiplier,
    u64 *outproduct);
...
void acpi_ut_free_and_track(void *address,
    u32 component, const char *module, u32 line);
...
acpi_status acpi_ut_create_list(const char *list_name,
