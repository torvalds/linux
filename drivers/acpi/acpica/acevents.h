...
ACPI_HW_DEPENDENT_RETURN_OK(acpi_status acpi_ev_acquire_global_lock(u16 timeout))
...
ACPI_HW_DEPENDENT_RETURN_OK(acpi_status acpi_ev_delete_gpe_block(struct acpi_gpe_block_info
    *gpe_block))
...
ACPI_HW_DEPENDENT_RETURN_VOID(void acpi_ev_update_gpes(
