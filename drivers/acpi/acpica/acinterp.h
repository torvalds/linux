...
#define ACPI_EXD_NSOFFSET(f)        (u8) ACPI_OFFSET (struct acpi_namespace_yesde,f)
 ...
 */
acpi_status
acpi_ex_system_do_yestify_op(union acpi_operand_object *value,
			    union acpi_operand_object *obj_desc);
...
/*
 * exresnte - resolve namespace yesde
 */
acpi_status
acpi_ex_resolve_yesde_to_value(struct acpi_namespace_yesde **stack_ptr,
			      struct acpi_walk_state *walk_state);
