...
/* Local Prototypes */
static acpi_status acpi_ex_convert_to_object_type_string(
...
acpi_status acpi_ex_do_concatenate(union acpi_operand_object *operand0,
...
static acpi_status acpi_ex_convert_to_object_type_string(
  ...
  return_desc
    = acpi_ut_create_string_object(((acpi_size) strlen(type_string) + 9)); /* 9
                                                                            * For
                                                                            * "[
                                                                            * Object]"
                                                                            * */
...
acpi_status acpi_ex_concat_template(union acpi_operand_object *operand0,
    union acpi_operand_object *operand1,
    union acpi_operand_object **actual_return_desc,
    struct acpi_walk_state *walk_state) {
  acpi_status status;
