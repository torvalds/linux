...
/* Local prototypes */
static acpi_status acpi_tb_check_duplication(struct acpi_table_desc *table_desc,
    u32 *table_index);

static u8 acpi_tb_compare_tables(struct acpi_table_desc *table_desc,
    u32 table_index);
...
void acpi_tb_release_table(struct acpi_table_header *table,
    u32 table_length, u8 table_flags) {
...
acpi_status acpi_tb_acquire_temp_table(struct acpi_table_desc *table_desc,
    acpi_physical_address address,
    u8 flags, struct acpi_table_header *table) {
...
acpi_status acpi_tb_load_table(u32 table_index,
...
acpi_status acpi_tb_install_and_load_table(acpi_physical_address address,
    u8 flags,
    struct acpi_table_header *table,
