...
acpi_status ac_get_all_tables_from_file(char *filename,
 ...
 * adwalk
 */
void acpi_dm_cross_reference_namespace(union acpi_parse_object *parse_tree_root,
...
void acpi_dm_finish_namespace_load(union acpi_parse_object *parse_tree_root,
    struct acpi_namespace_node *namespace_root,
    acpi_owner_id owner_id);

void acpi_dm_convert_parse_objects(union acpi_parse_object *parse_tree_root,
    struct acpi_namespace_node *namespace_root);
...
acpi_status fl_split_input_pathname(char *input_path,
...
void ad_write_table(struct acpi_table_header *table,
