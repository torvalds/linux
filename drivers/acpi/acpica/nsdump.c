...
static acpi_status acpi_ns_dump_one_device(acpi_handle obj_handle,
    u32 level, void *context, void **return_value);
#endif

#if defined(ACPI_DEBUG_OUTPUT) || defined(ACPI_DEBUGGER)

static acpi_status acpi_ns_dump_one_object_path(acpi_handle obj_handle,
    u32 level, void *context, void **return_value);

static acpi_status acpi_ns_get_max_depth(acpi_handle obj_handle,
    u32 level, void *context, void **return_value);
 ...
 *              This procedure is a user_function called by
 ...
 *              acpi_ns_walk_namespace in conjunction with
 ...
 * RETURN:      Status
 *
 * DESCRIPTION: Dump the full pathname to a namespace object.
 * acp_ns_get_max_depth
 *              computes the maximum nesting depth in the namespace tree, in
 *              order to simplify formatting in acpi_ns_dump_one_object_path.
 *              These procedures are user_functions called by
 * acpi_ns_walk_namespace.
 *
 ******************************************************************************/
