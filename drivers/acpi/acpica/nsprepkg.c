		      ...
		      union acpi_operand_object **return_object_ptr)
{
	...
	if (!count) {
		...
		ACPI_WARN_PREDEFINED((AE_INFO, info->full_pathname,
				      info->yesde_flags,
				      "Return Package has yes elements (empty)"));
	 ...
	 *
	 * PTYPE1 packages contain yes subpackages
	...
	case ACPI_PTYPE1_FIXED:
		/*
		 * The package count is fixed and there are yes subpackages
		 *
	...
	case ACPI_PTYPE1_VAR:
		/*
		 * The package count is variable, there are yes subpackages, and all
	...
	case ACPI_PTYPE1_OPTION:
		/*
		 * The package count is variable, there are yes subpackages. There are
	...
	case ACPI_PTYPE2_PKG_COUNT:
		...
		/*
		 * Count canyest be larger than the parent package length, but allow it
	...
	case ACPI_PTYPE2_FIX_VAR:
		 ...
		 *
		 * First, ensure that the first element is a subpackage. If yest,
	...
	default:
		...
		/* Should yest get here if predefined info table is correct */
			   ...
			   union acpi_operand_object **elements, u32 count)
{
	...
	for (i = 0; i < count; i++) {
		...
		case ACPI_PTYPE2_COUNT:
			...
			/*
			 * Make sure package is large eyesugh for the Count and is
		...
		default:	/* Should yest get here, type was validated by caller */
