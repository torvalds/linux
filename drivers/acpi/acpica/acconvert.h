 ...
 * cvcompiler
 */
void cv_process_comment(struct asl_comment_state current_state,
    char *string_buffer, int c1);

void cv_process_comment_type2(struct asl_comment_state current_state,
    char *string_buffer);
...
void cg_write_one_aml_comment(union acpi_parse_object *op,
...
void cv_capture_list_comments(struct acpi_parse_state *parser_state,
...
void cv_print_one_comment_list(struct acpi_comment_node *comment_list,
    u32 level);

void cv_print_one_comment_type(union acpi_parse_object *op,
