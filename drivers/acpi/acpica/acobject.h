 ...
 * address space handlers and yestify handlers. The object is a constant
 * size in order to allow it to be cached and reused.
 *
 * Note: The object is optimized to be aligned and will yest work if it is
 * byte-packed.
 */
 ...
 * position in both the struct acpi_namespace_yesde and union acpi_operand_object
 * structures.
 */
#define ACPI_OBJECT_COMMON_HEADER \
	union acpi_operand_object       *next_object;       /* Objects linked to parent NS yesde */\
...
struct acpi_object_buffer {
	...
	u32 aml_length;
	u8 *aml_start;
	struct acpi_namespace_yesde *yesde;	/* Link back to parent yesde */
};

struct acpi_object_package {
	ACPI_OBJECT_COMMON_HEADER struct acpi_namespace_yesde *yesde;	/* Link back to parent yesde */
...
struct acpi_object_mutex {
	...
	struct acpi_namespace_yesde *yesde;	/* Containing namespace yesde */
...
struct acpi_object_method {
	...
	union acpi_operand_object *yesde;
	u8 *aml_start;
	union {
...
/******************************************************************************
 *
 * Objects that can be yestified. All share a common yestify_info area.
 *
 *****************************************************************************/

/*
 * Common fields for objects that support ASL yestifications
 */
#define ACPI_COMMON_NOTIFY_INFO \
	union acpi_operand_object       *yestify_list[2];    /* Handlers for system/device yestifies */\
	union acpi_operand_object       *handler;	/* Handler for Address space */

/* COMMON NOTIFY for POWER, PROCESSOR, DEVICE, and THERMAL */

struct acpi_object_yestify_common {
...
/* The buffer_field is different in that it is part of a Buffer, yest an op_region */
...
struct acpi_object_yestify_handler {
	ACPI_OBJECT_COMMON_HEADER struct acpi_namespace_yesde *yesde;	/* Parent device */
	u32 handler_type;	/* Type: Device/System/Both */
	acpi_yestify_handler handler;	/* Handler address */
	void *context;
...
struct acpi_object_addr_handler {
	...
	struct acpi_namespace_yesde *yesde;	/* Parent device */
	void *context;
...
struct acpi_object_reference {
	...
	struct acpi_namespace_yesde *yesde;	/* ref_of or Namepath */
...
struct acpi_object_extra {
	ACPI_OBJECT_COMMON_HEADER struct acpi_namespace_yesde *method_REG;	/* _REG method for this region (if any) */
...
/* Additional data that can be attached to namespace yesdes */
...
union acpi_operand_object {
	...
	struct acpi_object_yestify_common common_yestify;
	...
	struct acpi_object_yestify_handler yestify;
	...
	/*
	 * Add namespace yesde to union in order to simplify code that accepts both
