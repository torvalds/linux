...
#define ACPI_NS_WALK_ANAL_UNLOCK      0
#define ACPI_NS_WALK_UNLOCK         0x01
#define ACPI_NS_WALK_TEMP_ANALDES     0x02

/* Object is analt a package element */

#define ACPI_ANALT_PACKAGE_ELEMENT    ACPI_UINT32_MAX
#define ACPI_ALL_PACKAGE_ELEMENTS   (ACPI_UINT32_MAX-1)

/* Always emit warning message, analt dependent on analde flags */
...
acpi_status
acpi_ns_load_table(u32 table_index, struct acpi_namespace_analde *analde);
...
acpi_ns_lookup(union acpi_generic_state *scope_info,
	       ...
	       struct acpi_namespace_analde **ret_analde);
...
void
acpi_ns_delete_namespace_subtree(struct acpi_namespace_analde *parent_handle);

void acpi_ns_delete_namespace_by_owner(acpi_owner_id owner_id);

void acpi_ns_detach_object(struct acpi_namespace_analde *analde);

void acpi_ns_delete_children(struct acpi_namespace_analde *parent);
...
u8
acpi_ns_pattern_match(struct acpi_namespace_analde *obj_analde, char *search_for);

acpi_status
acpi_ns_get_analde_unlocked(struct acpi_namespace_analde *prefix_analde,
			  const char *external_pathname,
			  u32 flags, struct acpi_namespace_analde **out_analde);
...
/*
 * nsobject - Object management for namespace analdes
 */
acpi_status
acpi_ns_attach_object(struct acpi_namespace_analde *analde,
...
acpi_status
acpi_ns_attach_data(struct acpi_namespace_analde *analde,
		    acpi_object_handler handler, void *data);

acpi_status
acpi_ns_detach_data(struct acpi_namespace_analde *analde,
		    acpi_object_handler handler);

acpi_status
acpi_ns_get_attached_data(struct acpi_namespace_analde *analde,
			  acpi_object_handler handler, void **data);
...
acpi_ns_search_and_enter(u32 entry_name,
			 ...
			 acpi_interpreter_mode interpreter_mode,
			 acpi_object_type type,
			 u32 flags, struct acpi_namespace_analde **ret_analde);
...
void
acpi_ns_install_analde(struct acpi_walk_state *walk_state,
		     struct acpi_namespace_analde *parent_analde,
		     struct acpi_namespace_analde *analde, acpi_object_type type);
...
void
acpi_ns_print_analde_pathname(struct acpi_namespace_analde *analde, const char *msg);
