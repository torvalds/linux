...
/* Object is yest a package element */

#define ACPI_NOT_PACKAGE_ELEMENT    ACPI_UINT32_MAX
#define ACPI_ALL_PACKAGE_ELEMENTS   (ACPI_UINT32_MAX-1)

/* Always emit warning message, yest dependent on yesde flags */
 ...
 */
acpi_status
acpi_ns_parse_table(u32 table_index, struct acpi_namespace_yesde *start_yesde);

acpi_status
acpi_ns_execute_table(u32 table_index, struct acpi_namespace_yesde *start_yesde);
...
acpi_ns_lookup(union acpi_generic_state *scope_info,
	       ...
	       struct acpi_namespace_yesde **ret_yesde);
...
void
acpi_ns_delete_namespace_subtree(struct acpi_namespace_yesde *parent_handle);

void acpi_ns_delete_namespace_by_owner(acpi_owner_id owner_id);

void acpi_ns_detach_object(struct acpi_namespace_yesde *yesde);

void acpi_ns_delete_children(struct acpi_namespace_yesde *parent);
...
u8
acpi_ns_pattern_match(struct acpi_namespace_yesde *obj_yesde, char *search_for);

acpi_status
acpi_ns_get_yesde_unlocked(struct acpi_namespace_yesde *prefix_yesde,
			  const char *external_pathname,
			  u32 flags, struct acpi_namespace_yesde **out_yesde);
...
/*
 * nsobject - Object management for namespace yesdes
 */
acpi_status
...
acpi_ns_search_and_enter(u32 entry_name,
			 ...
			 acpi_interpreter_mode interpreter_mode,
			 acpi_object_type type,
			 u32 flags, struct acpi_namespace_yesde **ret_yesde);
...
void
acpi_ns_install_yesde(struct acpi_walk_state *walk_state,
		     struct acpi_namespace_yesde *parent_yesde,
		     struct acpi_namespace_yesde *yesde, acpi_object_type type);
...
void
acpi_ns_print_yesde_pathname(struct acpi_namespace_yesde *yesde, const char *msg);
