...
/* These macros reverse the bytes during the move, converting little-endian to
 * big endian */
...
#define ACPI_MOVE_32_TO_16(d, s)        ACPI_MOVE_16_TO_16(d, s)  /* Truncate to
                                                                   * 16 */

#define ACPI_MOVE_32_TO_32(d, \
      s)        {((u8 *) (void *) (d))[0] = ((u8 *) (void *) (s))[3]; \
                 ((u8 *) (void *) (d))[1] \
                   = ((u8 *) (void *) (s))[2]; \
                 ((u8 *) (void *) (d))[2] \
                   = ((u8 *) (void *) (s))[1]; \
...
#define ACPI_MOVE_64_TO_16(d, s)        ACPI_MOVE_16_TO_16(d, s)  /* Truncate to
                                                                   * 16 */

#define ACPI_MOVE_64_TO_32(d, s)        ACPI_MOVE_32_TO_32(d, s)  /* Truncate to
                                                                   * 32 */

#define ACPI_MOVE_64_TO_64(d, \
      s)        {((u8 *) (void *) (d))[0] = ((u8 *) (void *) (s))[7]; \
                 ((u8 *) (void *) (d))[1] \
                   = ((u8 *) (void *) (s))[6]; \
                 ((u8 *) (void *) (d))[2] \
                   = ((u8 *) (void *) (s))[5]; \
...
#define ACPI_MOVE_16_TO_16(d, \
      s)        *(u16 *) (void *) (d) = *(u16 *) (void *) (s)
#define ACPI_MOVE_16_TO_32(d, \
      s)        *(u32 *) (void *) (d) = *(u16 *) (void *) (s)
#define ACPI_MOVE_16_TO_64(d, \
      s)        *(u64 *) (void *) (d) = *(u16 *) (void *) (s)
...
#define ACPI_MOVE_32_TO_16(d, s)        ACPI_MOVE_16_TO_16(d, s)  /* Truncate to
                                                                   * 16 */
#define ACPI_MOVE_32_TO_32(d, \
      s)        *(u32 *) (void *) (d) = *(u32 *) (void *) (s)
#define ACPI_MOVE_32_TO_64(d, \
      s)        *(u64 *) (void *) (d) = *(u32 *) (void *) (s)
...
#define ACPI_ROUND_DOWN_TO_NATIVE_WORD(a)   ACPI_ROUND_DOWN(a, \
    sizeof(acpi_size))
...
#define ACPI_ROUND_UP_TO(value, \
      boundary)   (((value) + ((boundary) - 1)) / (boundary))
...
#define ACPI_FIND_FIRST_BIT_8(a)            ((a) ? __ACPI_FIND_FIRST_BIT_8(a, \
    1) : 0)
#define ACPI_FIND_FIRST_BIT_16(a)           ((a) ? __ACPI_FIND_FIRST_BIT_16(a, \
    1)   \
  : 0)
#define ACPI_FIND_FIRST_BIT_32(a)           ((a) ? __ACPI_FIND_FIRST_BIT_32(a, \
    1)   \
  : 0)
#define ACPI_FIND_FIRST_BIT_64(a)           ((a) ? __ACPI_FIND_FIRST_BIT_64(a, \
    1)   \
  : 0)
 ...
 */
#define ACPI_MASK_BITS_ABOVE(position)      (~((ACPI_UINT64_MAX) << \
    ((u32) (position))))
#define ACPI_MASK_BITS_BELOW(position)      ((ACPI_UINT64_MAX) << \
    ((u32) (position)))
...
#define ACPI_EXTRACT_1BIT_FLAG(field, \
      position)     (ACPI_GET_1BIT_FLAG((field) >> position))
#define ACPI_EXTRACT_2BIT_FLAG(field, \
      position)     (ACPI_GET_2BIT_FLAG((field) >> position))
#define ACPI_EXTRACT_3BIT_FLAG(field, \
      position)     (ACPI_GET_3BIT_FLAG((field) >> position))
#define ACPI_EXTRACT_4BIT_FLAG(field, \
      position)     (ACPI_GET_4BIT_FLAG((field) >> position))
 ...
 */
#define ACPI_GET_DESCRIPTOR_PTR(d)      (((union acpi_descriptor *) (void *) (d)) \
  ->common.common_pointer)
#define ACPI_SET_DESCRIPTOR_PTR(d, \
      p)   (((union acpi_descriptor *) (void *) (d))->common.common_pointer \
    = (p))
#define ACPI_GET_DESCRIPTOR_TYPE(d)     (((union acpi_descriptor *) (void *) (d)) \
  ->common.descriptor_type)
#define ACPI_SET_DESCRIPTOR_TYPE(d, \
      t)  (((union acpi_descriptor *) (void *) (d))->common.descriptor_type \
    = (t))
...
#define ARGI_LIST4(a, b, c, \
      d)          (ARG_1(d) | ARG_2(c) | ARG_3(b) | ARG_4(a))
#define ARGI_LIST5(a, b, c, d, \
      e)       (ARG_1(e) | ARG_2(d) | ARG_3(c) | ARG_4(b) | ARG_5(a))
#define ARGI_LIST6(a, b, c, d, e, \
      f)    (ARG_1(f) | ARG_2(e) | ARG_3(d) | ARG_4(c) | ARG_5(b) | ARG_6(a))

#define ARGP_LIST1(a)                   (ARG_1(a))
#define ARGP_LIST2(a, b)                (ARG_1(a) | ARG_2(b))
#define ARGP_LIST3(a, b, c)             (ARG_1(a) | ARG_2(b) | ARG_3(c))
#define ARGP_LIST4(a, b, c, \
      d)          (ARG_1(a) | ARG_2(b) | ARG_3(c) | ARG_4(d))
#define ARGP_LIST5(a, b, c, d, \
      e)       (ARG_1(a) | ARG_2(b) | ARG_3(c) | ARG_4(d) | ARG_5(e))
#define ARGP_LIST6(a, b, c, d, e, \
      f)    (ARG_1(a) | ARG_2(b) | ARG_3(c) | ARG_4(d) | ARG_5(e) | ARG_6(f))
 ...
 */
#define ACPI_ERROR_NAMESPACE(s, p, e)       acpi_ut_prefixed_namespace_error( \
    AE_INFO, s, p, e);
#define ACPI_ERROR_METHOD(s, n, p, e)       acpi_ut_method_error(AE_INFO, s, n, \
    p, e);
...
#define ACPI_IS_OCTAL_DIGIT(d)              (((char) (d) >= '0') \
  && ((char) (d) <= '7'))
...
#define ASL_CV_PRINT_ONE_COMMENT(a, b, c, d) cv_print_one_comment_type(a, b, c, \
    d);
