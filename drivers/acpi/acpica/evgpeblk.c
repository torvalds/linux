...
/* Local prototypes */
static acpi_status acpi_ev_install_gpe_block(
  struct acpi_gpe_block_info *gpe_block,
  u32 interrupt_number);

static acpi_status acpi_ev_create_gpe_info_blocks(
  struct acpi_gpe_block_info *gpe_block);
 ...
 * RETURN:      Status
 *
 * DESCRIPTION: Create the register_info and event_info blocks for this GPE
 * block
 *
 ******************************************************************************/
...
acpi_status acpi_ev_initialize_gpe_block(
