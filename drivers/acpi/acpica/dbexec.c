...
static acpi_status acpi_db_execute_method(struct acpi_db_method_info *info,
...
static acpi_status acpi_db_execution_walk(acpi_handle obj_handle,
...
void acpi_db_execute(char *name, char **args, acpi_object_type *types,
    u32 flags) {
  acpi_status status;
  struct acpi_buffer return_obj;
  char *name_string;
...
void acpi_db_create_execution_thread(char *method_name_arg,
...
void acpi_db_create_execution_threads(char *num_threads_arg,
