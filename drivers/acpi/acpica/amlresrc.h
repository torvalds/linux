...
#define ACPI_RESTAG_DMATYPE                     "_TYP"  /* Compatible(0), A(1),
                                                         * B(2), F(3) */
...
#define ACPI_RESTAG_INTERRUPTLEVEL              "_LL_"  /* active_lo(1),
                                                         * active_hi(0) */
#define ACPI_RESTAG_INTERRUPTSHARE              "_SHR"  /* Shareable(1),
                                                        * no_share(0) */
...
#define ACPI_RESTAG_MEMATTRIBUTES               "_MTP"  /* Memory(0),
                                                         * Reserved(1), ACPI(2),
                                                         * NVS(3) */
#define ACPI_RESTAG_MEMTYPE                     "_MEM"  /* non_cache(0),
                                                         * Cacheable(1)
                                                         * Cache+combine(2),
                                                         * Cache+prefetch(3) */
...
#define ACPI_RESTAG_READWRITETYPE               "_RW_"  /* read_only(0),
                                                         * Writeable (1) */
...
#define ACPI_RESTAG_TRANSTYPE                   "_TRS"  /* Sparse(1), Dense(0)
                                                         * */
#define ACPI_RESTAG_TYPE                        "_TTP"  /* Translation(1),
                                                         * Static (0) */
#define ACPI_RESTAG_XFERTYPE                    "_SIZ"  /* 8(0), 8And16(1),
                                                         * 16(2) */
...
struct asl_resource_info {
  union acpi_parse_object *descriptor_type_op;  /* Resource descriptor parse
                                                 * node */
...
#define ACPI_AML_SIZE_LARGE(r)      (sizeof(r) \
  - sizeof(struct aml_resource_large_header))
#define ACPI_AML_SIZE_SMALL(r)      (sizeof(r) \
...
#define AML_RESOURCE_VENDOR_SERIALBUSTYPE       192 /* Vendor defined is
                                                     * 0xC0-0xFF (NOT SUPPORTED)
                                                     * */
...
void mp_save_gpio_info(union acpi_parse_object *op,
    union aml_resource *resource,
    u32 pin_count, u16 *pin_list, char *device_name);

void mp_save_serial_info(union acpi_parse_object *op,
