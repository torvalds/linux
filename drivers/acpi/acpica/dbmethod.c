...
/* Local prototypes */
static acpi_status acpi_db_walk_for_execute(acpi_handle obj_handle,
...
void acpi_db_set_method_breakpoint(char *location,
...
static acpi_status acpi_db_walk_for_execute_all(acpi_handle obj_handle,
    u32 nesting_level,
