...
/* Local prototypes */
static acpi_status acpi_ds_detect_named_opcodes(
  struct acpi_walk_state *walk_state,
  union acpi_parse_object **out_op);

static acpi_status acpi_ds_create_method_mutex(
...
acpi_status acpi_ds_auto_serialize_method(struct acpi_namespace_node *node,
...
acpi_status acpi_ds_begin_method_execution(
