...
#define METHOD_GET_NEXT_TYPE(arg_list)  (((arg_list) >>= METHOD_ARG_BIT_WIDTH) \
  & METHOD_ARG_MASK)
...
#define METHOD_3ARGS(a1, a2, \
      a3)          (3 | (a1 << 3) | (a2 << 6) | (a3 << 9))
#define METHOD_4ARGS(a1, a2, a3, \
      a4)       (4 | (a1 << 3) | (a2 << 6) | (a3 << 9) | (a4 << 12))
#define METHOD_5ARGS(a1, a2, a3, a4, \
      a5)    (5 | (a1 << 3) | (a2 << 6) | (a3 << 9) | (a4 << 12) | (a5 << 15))

#define METHOD_RETURNS(type)            (type)
#define METHOD_NO_RETURN_VALUE          0

#define PACKAGE_INFO(a, b, c, d, e, \
      f)       {{{(a), (b), (c), (d)}, ((((u16) (f)) << 8) | (e)), 0}}
...
const union acpi_predefined_info acpi_gbl_predefined_methods[] = {
  ...
  {{"_ALR", METHOD_0ARGS,
    METHOD_RETURNS(ACPI_RTYPE_PACKAGE)}}, /* Variable-length (Pkgs) each 2
                                           * (Ints) */
  ...
  {{"_ART", METHOD_0ARGS,
    METHOD_RETURNS(ACPI_RTYPE_PACKAGE)}}, /* Variable-length (1 Int(rev), n Pkg
                                           * (2 Ref/11 Int) */
  ...
  {{"_CST", METHOD_0ARGS,
    METHOD_RETURNS(ACPI_RTYPE_PACKAGE)}}, /* Variable-length (1 Int(n), n Pkg (1
                                           * Buf/3 Int) */
  ...
  {{"_DLM", METHOD_0ARGS,
    METHOD_RETURNS(ACPI_RTYPE_PACKAGE)}}, /* Variable-length (Pkgs) each (1 Ref,
                                           * 0/1 Optional Buf/Ref) */
  ...
  {{"_DSD", METHOD_0ARGS, /* ACPI 6.0 */
    METHOD_RETURNS(ACPI_RTYPE_PACKAGE)}}, /* Variable-length (Pkgs) each: 1 Buf,
                                           * 1 Pkg */
  ...
  {{"_DSM",
    METHOD_4ARGS(ACPI_TYPE_BUFFER, ACPI_TYPE_INTEGER, ACPI_TYPE_INTEGER,
        ACPI_TYPE_PACKAGE),
    METHOD_RETURNS(ACPI_RTYPE_ALL)}}, /* Must return a value, but it can be of
                                       * any type */
  ...
  {{"_ERR",
    ...
    METHOD_RETURNS(ACPI_RTYPE_INTEGER)}}, /* Internal use only, used by ACPICA
                                           * test suites */
   ...
   */
  {{"_HPX", METHOD_0ARGS,
    METHOD_RETURNS(ACPI_RTYPE_PACKAGE)}}, /* Variable-length (Pkgs) each (var
                                           * Ints) */
  ...
  {{"_LPI", METHOD_0ARGS, /* ACPI 6.0 */
    METHOD_RETURNS(ACPI_RTYPE_PACKAGE)}}, /* Variable-length (3 Int, n Pkg (10
                                           * Int/Buf) */
  ...
  {{"_MLS", METHOD_0ARGS,
    METHOD_RETURNS(ACPI_RTYPE_PACKAGE)}}, /* Variable-length (Pkgs) each (1
                                           * Str/1 Buf) */
   ...
   */
  {{"_PRT", METHOD_0ARGS,
    METHOD_RETURNS(ACPI_RTYPE_PACKAGE)}}, /* Variable-length (Pkgs) each (4):
                                           * Int,Int,Int/Ref,Int */
  ...
  {{"_PRW", METHOD_0ARGS,
    METHOD_RETURNS(ACPI_RTYPE_PACKAGE)}}, /* Variable-length (Pkgs) each:
                                           * Pkg/Int,Int,[Variable-length Refs]
                                           * (Pkg is Ref/Int) */
  ...
  {{"_RDI", METHOD_0ARGS, /* ACPI 6.0 */
    METHOD_RETURNS(ACPI_RTYPE_PACKAGE)}}, /* Variable-length (1 Int, n Pkg (m
                                           * Ref)) */
  ...
  {{"_TRT", METHOD_0ARGS,
    METHOD_RETURNS(ACPI_RTYPE_PACKAGE)}}, /* Variable-length (Pkgs) each 2 Ref/6
                                           * Int */
  ...
  /* Acpi 1.0 defined _WAK with no return value. Later, it was changed to return
   * a package */
