...
/* Local prototypes */
static acpi_status acpi_ds_execute_arguments(struct acpi_namespace_node *node,
...
acpi_status acpi_ds_get_buffer_field_arguments(
...
acpi_status acpi_ds_get_bank_field_arguments(
    union acpi_operand_object *obj_desc) {
  union acpi_operand_object *extra_desc;
  struct acpi_namespace_node *node;
  acpi_status status;
