...
static void acpi_ev_execute_orphan_reg_method(
  struct acpi_namespace_node *device_node,
  acpi_adr_space_type space_id);

static acpi_status acpi_ev_reg_run(acpi_handle obj_handle,
...
void acpi_ev_execute_reg_methods(struct acpi_namespace_node *node,
