...
#define AML_FIRST_LOCAL_OP          (u16) 0x60  /* Used for Local op #
                                                 * calculations */
...
#define AML_FIRST_ARG_OP            (u16) 0x68  /* Used for Arg op #
                                                 * calculations */
 ...
 * Each field in the arg_types u32 is 5 bits, allowing for a maximum of 6
 * arguments.
...
#define ARGI_SIMPLE_TARGET          0x11  /* Name, Local, Arg -- no implicit
                                           * conversion */
#define ARGI_STORE_TARGET           0x12  /* Target for store is TARGETREF +
                                           * package objects */

/* Multiple/complex types */

#define ARGI_DATAOBJECT             0x13  /* Buffer, String, package or
                                           * reference to a node - Used only by
                                           * size_of operator */
#define ARGI_COMPLEXOBJ             0x14  /* Buffer, String, or package (Used by
                                           * INDEX op only) */
#define ARGI_REF_OR_STRING          0x15  /* Reference or String (Used by
                                           * DEREFOF op only) */
...
#define AML_FLAGS_EXEC_1A_1T_1R     AML_HAS_ARGS | AML_HAS_TARGET \
  | AML_HAS_RETVAL  /* monadic2_r */
#define AML_FLAGS_EXEC_2A_0T_0R     AML_HAS_ARGS  /* Dyadic1   */
#define AML_FLAGS_EXEC_2A_0T_1R     AML_HAS_ARGS | AML_HAS_RETVAL  /* Dyadic2
                                                                    *   */
#define AML_FLAGS_EXEC_2A_1T_1R     AML_HAS_ARGS | AML_HAS_TARGET \
  | AML_HAS_RETVAL  /* dyadic2_r  */
#define AML_FLAGS_EXEC_2A_2T_1R     AML_HAS_ARGS | AML_HAS_TARGET \
  | AML_HAS_RETVAL
#define AML_FLAGS_EXEC_3A_0T_0R     AML_HAS_ARGS
#define AML_FLAGS_EXEC_3A_1T_1R     AML_HAS_ARGS | AML_HAS_TARGET \
  | AML_HAS_RETVAL
