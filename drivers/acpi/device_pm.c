...
static int fix_up_power_if_applicable(struct acpi_device *adev,
    void *not_used) {
...
static int acpi_power_up_if_adr_present(struct acpi_device *adev,
    void *not_used) {
...
static void acpi_pm_notify_handler(acpi_handle handle, u32 val,
    void *not_used) {
 ...
 * this function.
 */
static int acpi_device_wakeup_enable(struct acpi_device *adev,
    u32 target_state) {
...
static bool acpi_dev_needs_resume(struct device *dev,
    struct acpi_device *adev) {
