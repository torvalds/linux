...
static inline bool s3fwrn5_fw_is_custom(
    const struct s3fwrn5_fw_cmd_get_bootinfo_rsp *bootinfo) {
...
bool s3fwrn5_fw_check_version(const struct s3fwrn5_fw_info *fw_info,
    u32 version) {
