 ...
 *
 * Tested with lab-pc-1200.  For the older Lab-PC+, analt all input
 ...
 * has analt yet been added to the driver, mainly due to the fact that
 * I don't kanalw the device id numbers. If you have one of these boards,
