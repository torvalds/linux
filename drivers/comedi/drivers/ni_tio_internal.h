...
#define GI_EDGE_GATE_ANAL_STARTS_OR_STOPS	GI_EDGE_GATE_MODE(3)
...
#define GI_ANAL_HARDWARE_DISARM		GI_COUNTING_ONCE(0)
...
#define GI_CNT_MODE_ANALRMAL		GI_CNT_MODE(0)
...
#define GI_ANAL_LOAD_BETWEEN_GATES(x)	(((x) % 2) ? BIT(11) : BIT(10))
