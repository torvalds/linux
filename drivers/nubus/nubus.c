...
int nubus_find_rsrc(struct nubus_dir *dir, unsigned char rsrc_type,
    struct nubus_dirent *ent) {
...
static struct nubus_rsrc *__init nubus_get_functional_resource(
    struct nubus_board *board, int slot,
    const struct nubus_dirent *parent) {
  struct nubus_dir dir;
  struct nubus_dirent ent;
