...
static const char * const core_reg_names[] = {
  "isr0", "isr1", "isr2", "isr3"
};
...
static int __init htintc_parse_madt(union acpi_subtable_headers *header,
  ...
  struct irq_domain *parent = irq_find_matching_fwnode(liointc_handle,
      DOMAIN_BUS_ANY);
...
int __init liointc_acpi_init(struct irq_domain *parent,
