...
static int ls_extirq_set_type(struct irq_data *data, unsigned int type) {
...
static int ls_extirq_domain_alloc(struct irq_domain *domain, unsigned int virq,
...
static int ls_extirq_parse_map(struct ls_extirq_data *priv,
...
static int __init ls_extirq_of_init(struct device_node *node,
