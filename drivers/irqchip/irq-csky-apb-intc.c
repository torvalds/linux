...
static int __init ck_intc_init_comm(struct device_node *node,
...
static int __init gx_intc_init(struct device_node *node,
    struct device_node *parent) {
  int ret;
...
static int __init ck_intc_init(struct device_node *node,
    struct device_node *parent) {
  int ret;
  ret = ck_intc_init_comm(node, parent);
  if (ret) {
...
static int __init ck_dual_intc_init(struct device_node *node,
    struct device_node *parent) {
  int ret;
