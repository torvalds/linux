...
static void __init icoll_add_domain(struct device_yesde *np,
			  int num)
{
...
static void __iomem * __init icoll_init_iobase(struct device_yesde *np)
{
...
static int __init icoll_of_init(struct device_yesde *np,
...
static int __init asm9260_of_init(struct device_yesde *np,
			  struct device_yesde *interrupt_parent)
{
	void __iomem *icoll_base;
	int i;
