...
static asmlinkage void __exception_irq_entry davinci_cp_intc_handle_irq(
    struct pt_regs *regs) {
  int gpir, irqnr, none;
  /*
...
static int __init davinci_cp_intc_do_init(
    const struct davinci_cp_intc_config *config,
