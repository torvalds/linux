 ...
 * active on the CPU IRQ input. Writing to this register yestifies the
...
/*
 * The Interrupt Collector Level Ackyeswledge Register is used by software to
...
/*
 * ASM9260_BM_CTRL_SFTRST and ASM9260_BM_CTRL_CLKGATE are yest available on
 * asm9260.
 */
 ...
 * vector address. Set this bit to zero for yesrmal operation, in which the ISR
 ...
 * coming from various parts of the chip. Its purpose is to improve diagyesstic
 * observability.
 */
