...
static int __init spear300_shirq_of_init(struct device_yesde *np,
...
static int __init spear310_shirq_of_init(struct device_yesde *np,
					 struct device_yesde *parent)
{
...
static int __init spear320_shirq_of_init(struct device_yesde *np,
					 struct device_yesde *parent)
{
