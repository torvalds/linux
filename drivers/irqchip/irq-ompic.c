 ...
 * - The ompic does yest have any interrupt input lines.
...
static int __init ompic_of_init(struct device_yesde *yesde,
				struct device_yesde *parent)
{
	...
	/* Validate the DT */
	if (ompic_base) {
		pr_err("ompic: duplicate ompic's are yest supported");
		return -EEXIST;
	}
