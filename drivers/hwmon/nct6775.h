...
enum kinds {
  nct6106 = 1, nct6116, nct6775, nct6776, nct6779, nct6791, nct6792,
  nct6793, nct6795, nct6796, nct6797, nct6798, nct6799
};
enum pwm_enable {
  off, manual, thermal_cruise, speed_cruise, sf3, sf4
};
...
static inline int nct6775_read_value(struct nct6775_data *data, u16 reg,
    u16 *value) {
  unsigned int tmp;
...
static inline int nct6775_write_value(struct nct6775_data *data, u16 reg,
    u16 value) {
...
ssize_t nct6775_show_alarm(struct device *dev, struct device_attribute *attr,
    char *buf);
ssize_t nct6775_show_beep(struct device *dev, struct device_attribute *attr,
    char *buf);
ssize_t nct6775_store_beep(struct device *dev, struct device_attribute *attr,
    const char *buf,
    size_t count);

static inline int nct6775_write_temp(struct nct6775_data *data, u16 reg,
    u16 value) {
...
static inline umode_t nct6775_attr_mode(struct nct6775_data *data,
    struct attribute *attr) {
  return data->read_only ? (attr->mode & ~0222) : attr->mode;
}

static inline int nct6775_add_attr_group(struct nct6775_data *data,
