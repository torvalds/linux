...
static int aspeed_pwm_cz_get_max_state(struct thermal_cooling_device *tcdev,
    unsigned long *state) {
...
static int aspeed_pwm_cz_get_cur_state(struct thermal_cooling_device *tcdev,
    unsigned long *state) {
  struct aspeed_cooling_device *cdev = tcdev->devdata;
...
static int aspeed_pwm_cz_set_cur_state(struct thermal_cooling_device *tcdev,
    unsigned long state) {
  struct aspeed_cooling_device *cdev = tcdev->devdata;
