...
static int lm83_regmap_reg_read(void *context, unsigned int reg,
    unsigned int *val) {
 ...
 */
static int lm83_regmap_reg_write(void *context, unsigned int reg,
    unsigned int val) {
  struct i2c_client *client = context;
  switch (reg) {
...
static int lm83_temp_read(struct device *dev, u32 attr, int channel,
    long *val) {
...
static int lm83_temp_write(struct device *dev, u32 attr, int channel,
    long val) {
  struct lm83_data *data = dev_get_drvdata(dev);
  unsigned int regval;
  int err;
...
static int lm83_chip_read(struct device *dev, u32 attr, int channel,
    long *val) {
  struct lm83_data *data = dev_get_drvdata(dev);
  unsigned int regval;
  int err;
