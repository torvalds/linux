...
static int numeric_sensor_is_connected(
...
static int populate_numeric_sensor_from_wobj(struct device *dev,
    struct hp_wmi_numeric_sensor *nsensor,
...
static void update_numeric_sensor_from_wobj(struct device *dev,
    struct hp_wmi_numeric_sensor *nsensor,
...
static int populate_platform_events_from_wobj(struct device *dev,
