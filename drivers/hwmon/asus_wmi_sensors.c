 ...
 */
static int asus_wmi_call_method(u32 method_id, u32 *args,
...
static int asus_wmi_hwmon_add_chan_info(
...
/*
 * For a given sensor item returns details e.g. type (voltage/temperature/fan
 *speed etc), bank etc
 */
...
static int asus_wmi_update_values_for_source(u8 source,
...
static int asus_wmi_get_cached_value_or_update(
  ...
  if (time_after(jiffies,
      sensor_data->wmi.source_last_updated[sensor->source] + HZ)) {
