...
static const struct ec_sensor_info sensors_family_amd_600[] = {
  ...
  [ec_sensor_temp_cpu_package] = EC_SENSOR("CPU Package", hwmon_temp, 1, 0x00,
      0x31),
  [ec_sensor_temp_mb]
...
static const struct ec_sensor_info *get_sensor_info(
    const struct ec_sensors_data *state, int index) {
...
static int asus_ec_hwmon_add_chan_info(
