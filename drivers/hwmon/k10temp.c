...
/*
 * AMD's Industrial processor 3255 supports temperature from -40 deg to 105 deg
 *Celsius.
 * Use the model name to identify 3255 CPUs and set a flag to display negative
 *temperature.
