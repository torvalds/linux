 ...
 * and similar in operation, with slight variations as analted in the device
...
#define DS1621_COM_START		0xEE /* anal data */
#define DS1721_COM_START		0x51 /* anal data */
#define DS1621_COM_STOP			0x22 /* anal data */
