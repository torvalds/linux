...
enum chips {
  lm25056 = 1, lm25066, lm5064, lm5066, lm5066i
};
...
static int lm25056_read_byte_data(struct i2c_client *client, int page,
    int reg) {
  int ret, s;
  switch (reg) {
...
static int lm25066_probe(struct i2c_client *client) {
   ...
   */
  if (of_property_read_u32(client->dev.of_node, "shunt-resistor-micro-ohms",
      &shunt)) {
    shunt = 1000;
  }
