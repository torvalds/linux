...
#define to_psu(x, y) container_of((x), struct q54sj108a2_data, \
    debugfs_entries[(y)])
...
static ssize_t q54sj108a2_debugfs_read(struct file *file, char __user *buf,
  ...
  char data[I2C_SMBUS_BLOCK_MAX + 2] = {
    0
  };
  char data_char[I2C_SMBUS_BLOCK_MAX + 2] = {
    0
  };
  char *res;
  switch (idx) {
...
static ssize_t q54sj108a2_debugfs_write(struct file *file,
  ...
  switch (idx) {
    ...
    case Q54SJ108A2_DEBUGFS_STOREDEFAULT:
      ...
      flash_key[2] = 0xDC;
      flash_key[3] = 0x42;
      rc = i2c_smbus_write_block_data(psu->client, PMBUS_FLASH_KEY_WRITE, 4,
          flash_key);
      if (rc < 0) {
        return rc;
      }
    ...
    case Q54SJ108A2_DEBUGFS_VOOV_RESPONSE:
      ...
      rc = i2c_smbus_write_byte_data(psu->client, PMBUS_VOUT_OV_FAULT_RESPONSE,
          dst_data);
      if (rc < 0) {
        return rc;
      }
    ...
    case Q54SJ108A2_DEBUGFS_IOOC_RESPONSE:
      ...
      rc = i2c_smbus_write_byte_data(psu->client, PMBUS_IOUT_OC_FAULT_RESPONSE,
          dst_data);
      if (rc < 0) {
        return rc;
      }
    ...
    case Q54SJ108A2_DEBUGFS_BLACKBOX_SET_OFFSET:
      ...
      rc = i2c_smbus_write_byte_data(psu->client, SET_HISTORY_EVENT_OFFSET,
          dst_data);
      if (rc < 0) {
        return rc;
      }
