...
static int pim4328_read_byte_data(struct i2c_client *client, int page,
    int reg) {
...
MODULE_DESCRIPTION(
    "PMBus driver for PIM4006, PIM4328, PIM4820 power interface modules");
MODULE_LICENSE("GPL");
