...
static int mp2856_read_word_helper(struct i2c_client *client, int page,
    int phase, u8 reg,
    u16 mask) {
...
static int mp2856_read_vout(struct i2c_client *client, struct mp2856_data *data,
    int page,
    int phase, u8 reg) {
  int ret;
...
static int mp2856_read_phase(struct i2c_client *client,
...
static int mp2856_read_phases(struct i2c_client *client,
    struct mp2856_data *data,
    int page, int phase) {
  int ret;
  if (page == 0) {
...
static int mp2856_identify_multiphase(struct i2c_client *client, u8 reg,
    u8 max_phase,
    u16 mask) {
  int ret;
...
static int mp2856_identify_multiphase_rail1(struct i2c_client *client,
    struct mp2856_data *data) {
  int ret, i;
...
static int mp2856_current_sense_gain_get(struct i2c_client *client,
    struct mp2856_data *data) {
  int i, ret;
  /*
...
static int mp2856_identify_vout_format(struct i2c_client *client,
    struct mp2856_data *data) {
  int i, ret;
  for (i = 0; i < data->info.pages; i++) {
    ret = i2c_smbus_write_byte_data(client, PMBUS_PAGE, i);
...
static bool mp2856_is_rail2_active(struct i2c_client *client) {
  int ret;
  ret = i2c_smbus_write_byte_data(client, PMBUS_PAGE, 2);
  if (ret < 0) {
    return true;
