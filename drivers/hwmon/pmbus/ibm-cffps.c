...
static ssize_t ibm_cffps_debugfs_read_input_history(struct file *file,
    char __user *buf,
...
static int ibm_cffps_probe(struct i2c_client *client) {
  ...
  if (vs == cffps_unknown) {
    ...
    char mfg_id[I2C_SMBUS_BLOCK_MAX + 2] = {
      0
    };
    if (ccin > 0) {
  ...
  debugfs_create_file("input_history", 0444, debugfs, psu,
