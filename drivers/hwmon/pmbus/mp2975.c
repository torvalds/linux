...
static int mp2975_read_word_helper(struct i2c_client *client, int page,
    int phase, u8 reg,
    u16 mask) {
...
static int mp2975_read_phase(struct i2c_client *client,
...
static int mp2975_read_phases(struct i2c_client *client,
    struct mp2975_data *data,
    int page, int phase) {
  int ret;
  if (page) {
...
static int mp2975_identify_multiphase(struct i2c_client *client,
    struct mp2975_data *data,
    struct pmbus_driver_info *info) {
  int num_phases2, ret;
  ret = i2c_smbus_write_byte_data(client, PMBUS_PAGE, 2);
...
static int mp2975_identify_vid(struct i2c_client *client,
    struct mp2975_data *data,
...
static int mp2975_identify_rails_vid(struct i2c_client *client,
    struct mp2975_data *data,
    struct pmbus_driver_info *info) {
  int ret;
  ret = i2c_smbus_write_byte_data(client, PMBUS_PAGE, 2);
...
static int mp2973_identify_rails_vid(struct i2c_client *client,
    struct mp2975_data *data,
    struct pmbus_driver_info *info) {
  int ret;
  ret = i2c_smbus_write_byte_data(client, PMBUS_PAGE, 2);
...
static int mp2975_vref_offset_get(struct i2c_client *client,
    struct mp2975_data *data,
    int page) {
  int ret;
...
static int mp2975_vout_max_get(struct i2c_client *client,
    struct mp2975_data *data,
...
static int mp2975_set_vout_format(struct i2c_client *client,
...
static int mp2975_vout_ov_scale_get(struct i2c_client *client,
    struct mp2975_data *data,
    struct pmbus_driver_info *info) {
...
static int mp2975_probe(struct i2c_client *client) {
  ...
  if (client->dev.of_node) {
    data->chip_id = (enum chips) (unsigned long) of_device_get_match_data(
        &client->dev);
  } else {
