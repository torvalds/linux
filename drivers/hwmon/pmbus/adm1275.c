...
enum chips {
  adm1075, adm1272, adm1275, adm1276, adm1278, adm1293, adm1294
};
...
#define ADM1278_PMON_DEFCONFIG    (ADM1278_VOUT_EN | ADM1278_TEMP1_EN \
  | ADM1278_TSFILT)
...
static int adm1275_read_byte_data(struct i2c_client *client, int page,
    int reg) {
  const struct pmbus_driver_info *info = pmbus_get_driver_info(client);
  const struct adm1275_data *data = to_adm1275_data(info);
  int mfr_status, ret;
