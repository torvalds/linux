...
enum chips {
  ucd9000, ucd90120, ucd90124, ucd90160, ucd90320, ucd9090,
  ucd90910
};
...
static int ucd90320_read_byte_data(struct i2c_client *client, int page,
    int reg) {
  const struct pmbus_driver_info *info = pmbus_get_driver_info(client);
  struct ucd9000_data *data = to_ucd9000_data(info);
  ucd90320_wait(data);
...
static int ucd9000_read_byte_data(struct i2c_client *client, int page,
    int reg) {
  int ret = 0;
  int fan_config;
  switch (reg) {
