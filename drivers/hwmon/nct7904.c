...
static umode_t nct7904_fan_is_visible(const void *_data, u32 attr,
    int channel) {
...
static umode_t nct7904_temp_is_visible(const void *_data, u32 attr,
    int channel) {
  const struct nct7904_data *data = _data;
  switch (attr) {
    case hwmon_temp_input:
...
static umode_t nct7904_pwm_is_visible(const void *_data, u32 attr,
    int channel) {
  switch (attr) {
    case hwmon_pwm_input:
    case hwmon_pwm_enable:
