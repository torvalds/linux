...
static umode_t powr1220_is_visible(const void *data,
...
static int powr1220_read_string(struct device *dev,
...
static int powr1220_read(struct device *dev, enum hwmon_sensor_types type, u32
