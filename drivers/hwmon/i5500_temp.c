...
static umode_t i5500_is_visible(const void *drvdata,
    enum hwmon_sensor_types type, u32 attr,
    int channel) {
  return 0444;
}

static int i5500_read(struct device *dev, enum hwmon_sensor_types type,
...
static int i5500_temp_probe(struct pci_dev *pdev,
  ...
  hwmon_dev = devm_hwmon_device_register_with_info(&pdev->dev, "intel5500",
      NULL,
