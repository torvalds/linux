...
static struct attribute_group *nct6683_create_attr_group(struct device *dev,
 ...
 */
static ssize_t show_in_label(struct device *dev, struct device_attribute *attr,
    char *buf) {
...
static ssize_t show_in_reg(struct device *dev, struct device_attribute *attr,
    char *buf) {
...
static ssize_t show_fan_pulses(struct device *dev,
...
static ssize_t show_temp8(struct device *dev, struct device_attribute *attr,
    char *buf) {
  struct sensor_device_attribute_2 *sattr = to_sensor_dev_attr_2(attr);
  struct nct6683_data *data = nct6683_update_device(dev);
  int index = sattr->index;
...
static ssize_t show_temp16(struct device *dev, struct device_attribute *attr,
    char *buf) {
  struct sensor_device_attribute *sattr = to_sensor_dev_attr(attr);
  struct nct6683_data *data = nct6683_update_device(dev);
  int index = sattr->index;
