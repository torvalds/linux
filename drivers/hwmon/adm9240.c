...
static int adm9240_write_fan_div(struct adm9240_data *data, int channel,
    u8 fan_div) {
 ...
 */
static int adm9240_fan_min_write(struct adm9240_data *data, int channel,
    long val) {
  u8 new_div;
  u8 fan_min;
  int err;
...
static int adm9240_in_read(struct device *dev, u32 attr, int channel,
    long *val) {
  struct adm9240_data *data = dev_get_drvdata(dev);
  unsigned int regval;
  int reg;
...
static int adm9240_in_write(struct device *dev, u32 attr, int channel,
    long val) {
  struct adm9240_data *data = dev_get_drvdata(dev);
  int reg;
  switch (attr) {
...
static int adm9240_fan_read(struct device *dev, u32 attr, int channel,
    long *val) {
  struct adm9240_data *data = dev_get_drvdata(dev);
  unsigned int regval;
  int err;
...
static int adm9240_fan_write(struct device *dev, u32 attr, int channel,
    long val) {
  struct adm9240_data *data = dev_get_drvdata(dev);
  int err;
  switch (attr) {
...
static int adm9240_temp_read(struct device *dev, u32 attr, int channel,
    long *val) {
  struct adm9240_data *data = dev_get_drvdata(dev);
  unsigned int regval;
  int err, temp;
...
static int adm9240_temp_write(struct device *dev, u32 attr, int channel,
    long val) {
  struct adm9240_data *data = dev_get_drvdata(dev);
  int reg;
  switch (attr) {
...
static int adm9240_read(struct device *dev, enum hwmon_sensor_types type,
    u32 attr,
...
static int adm9240_write(struct device *dev, enum hwmon_sensor_types type,
    u32 attr,
    int channel, long val) {
  switch (type) {
    case hwmon_intrusion:
...
static umode_t adm9240_is_visible(const void *_data,
