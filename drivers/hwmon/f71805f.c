...
/* The 2 least significant bits are yest used */
...
/* The 4 most significant bits are yest used */
...
static inline u16 fan_to_reg(long rpm)
{
	 ...
	 * so that yes alarm will ever trigger.
	 */
	if (rpm < 367)
		return 0xfff;
	return 1500000 / rpm;
			       ...
			       struct f71805f_sio_data *sio_data)
{
	...
	if (!(superio_inb(sioaddr, SIO_REG_ENABLE) & 0x01)) {
		pr_warn("Device yest activated, skipping\n");
		goto exit;
	}
