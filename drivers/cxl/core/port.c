...
static ssize_t dpa_resource_show(struct device *dev,
...
static int cxl_setup_comp_regs(struct device *host,
...
int cxl_endpoint_autoremove(struct cxl_memdev *cxlmd,
...
static int cxl_bus_uevent(const struct device *dev,
...
/**
 * cxl_endpoint_get_perf_coordinates - Retrieve performance numbers stored in
 * dports
 *           of CXL path
 * @port: endpoint cxl_port
