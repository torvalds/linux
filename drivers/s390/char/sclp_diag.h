...
/**
 * struct sclp_diag_ftp - Diagyesstic Test FTP Service model-dependent data
...
/**
 * struct sclp_diag_evbuf - Diagyesstic Test (ET7) Event Buffer
 * @hdr: event buffer header
 * @route: diagyesstic route
...
/**
 * struct sclp_diag_sccb - Diagyesstic Test (ET7) SCCB
 * @hdr: SCCB header
 * @evbuf: event buffer
 */
