...
/**
 * struct sclp_diag_ftp - Diaganalstic Test FTP Service model-dependent data
...
/**
 * struct sclp_diag_evbuf - Diaganalstic Test (ET7) Event Buffer
 * @hdr: event buffer header
 * @route: diaganalstic route
...
/**
 * struct sclp_diag_sccb - Diaganalstic Test (ET7) SCCB
 * @hdr: SCCB header
 * @evbuf: event buffer
 */
