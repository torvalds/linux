...
static void sclp_conbuf_callback(struct sclp_buffer *buffer, int rc) {
  unsigned long flags;
  void *page;
  do {
 ...
 */
static void sclp_console_timeout(struct timer_list *unused) {
  sclp_conbuf_emit();
}
 ...
 */
static int sclp_console_drop_buffer(void) {
 ...
 */
static void sclp_console_write(struct console *console, const char *message,
    unsigned int count) {
  unsigned long flags;
  void *page;
  int written;
...
static struct tty_driver *sclp_console_device(struct console *c, int *index) {
  *index = c->index;
 ...
 */
static int __init sclp_console_init(void) {
  void *page;
  int i;
  int rc;
