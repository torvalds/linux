 ...
 */
static void sclp_vt220_process_queue(struct sclp_vt220_request *request) {
  unsigned long flags;
  void *page;
  do {
 ...
 * SCLP.
 */
static void sclp_vt220_callback(struct sclp_req *request, void *data) {
...
static inline unsigned int sclp_vt220_space_left(
    struct sclp_vt220_request *request) {
  struct sclp_vt220_sccb *sccb;
...
static inline unsigned int sclp_vt220_chars_stored(
    struct sclp_vt220_request *request) {
  struct sclp_vt220_sccb *sccb;
  sccb = (struct sclp_vt220_sccb *) request->sclp_req.sccb;
 ...
 * added.
 */
static int sclp_vt220_add_msg(struct sclp_vt220_request *request,
 ...
 */
static void sclp_vt220_timeout(struct timer_list *unused) {
  sclp_vt220_emit_current();
}
 ...
 */
static int sclp_vt220_drop_buffer(void) {
  struct list_head *list;
  struct sclp_vt220_request *request;
  void *page;
 ...
 * of bytes written.
 */
static int __sclp_vt220_write(const unsigned char *buf, int count,
    int do_schedule,
 ...
 */
static ssize_t sclp_vt220_write(struct tty_struct *tty, const u8 *buf,
    size_t count) {
 ...
 */
static int sclp_vt220_open(struct tty_struct *tty, struct file *filp) {
  if (tty->count == 1) {
 ...
 */
static void sclp_vt220_close(struct tty_struct *tty, struct file *filp) {
  if (tty->count == 1) {
 ...
 */
static int sclp_vt220_put_char(struct tty_struct *tty, u8 ch) {
 ...
 * control is acted.
 */
static unsigned int sclp_vt220_write_room(struct tty_struct *tty) {
  unsigned long flags;
  struct list_head *l;
  unsigned int count;
  spin_lock_irqsave(&sclp_vt220_lock, flags);
 ...
 */
static unsigned int sclp_vt220_chars_in_buffer(struct tty_struct *tty) {
  unsigned long flags;
  struct list_head *l;
...
static void sclp_vt220_con_write(struct console *con, const char *buf,
    unsigned int count) {
  __sclp_vt220_write((const unsigned char *) buf, count, 1, 1, 0);
}

static struct tty_driver *sclp_vt220_con_device(struct console *c, int *index) {
  *index = 0;
 ...
 */
static int sclp_vt220_notify(struct notifier_block *self,
...
static int __init sclp_vt220_con_init(void) {
  int rc;
