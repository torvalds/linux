...
static int tapechar_check_idalbuffer(struct tape_device *device,
    size_t block_size) {
 ...
 */
static ssize_t tapechar_read(struct file *filp, char __user *data, size_t count,
    loff_t *ppos) {
 ...
 */
static ssize_t tapechar_write(struct file *filp, const char __user *data,
 ...
 */
static int tapechar_open(struct inode *inode, struct file *filp) {
  struct tape_device *device;
  int minor, rc;
...
static int tapechar_release(struct inode *inode, struct file *filp) {
  struct tape_device *device;
 ...
 */
static int __tapechar_ioctl(struct tape_device *device,
...
static long tapechar_ioctl(struct file *filp, unsigned int no,
    unsigned long data) {
  struct tape_device *device;
  long rc;
...
#ifdef CONFIG_COMPAT
static long tapechar_compat_ioctl(struct file *filp, unsigned int no,
    unsigned long data) {
