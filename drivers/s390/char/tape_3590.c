 ...
 * Disable encryption
 */
static struct tape_request *__tape_3592_disable_crypt(
 ...
 * 3590 IOCTL Overload
 */
static int tape_3590_ioctl(struct tape_device *device, unsigned int cmd,
    unsigned long arg) {
  switch (cmd) {
 ...
 */
static int tape_3590_mtseek(struct tape_device *device, int count) {
  struct tape_request *request;
 ...
 */
static void tape_3590_read_opposite(struct tape_device *device,
    struct tape_request *request) {
...
static void tape_3590_work_handler(struct work_struct *work) {
...
static int tape_3590_schedule_work(struct tape_device *device,
    enum tape_op op) {
  struct work_handler_data *p;
 ...
 * process
 */
static int tape_3590_done(struct tape_device *device,
    struct tape_request *request) {
 ...
 */
static inline int tape_3590_erp_succeeded(struct tape_device *device,
    struct tape_request *request) {
 ...
 */
static inline int tape_3590_erp_failed(struct tape_device *device,
    struct tape_request *request,
 ...
 */
static inline int tape_3590_erp_retry(struct tape_device *device,
    struct tape_request *request,
    struct irb *irb) {
  DBF_EVENT(2, "Retry: %s\n", tape_op_verbose[request->op]);
  tape_dump_sense_dbf(device, request, irb);
 ...
 */
static int tape_3590_unsolicited_irq(struct tape_device *device,
    struct irb *irb) {
 ...
 */
static int tape_3590_erp_basic(struct tape_device *device,
    struct tape_request *request,
    struct irb *irb, int rc) {
 ...
 */
static int tape_3590_erp_read_buf_log(struct tape_device *device,
 ...
 *  SWAP: Swap Devices
 */
static int tape_3590_erp_swap(struct tape_device *device,
    struct tape_request *request,
    struct irb *irb) {
  /*
 ...
 *  LBY: Long Busy
 */
static int tape_3590_erp_long_busy(struct tape_device *device,
    struct tape_request *request, struct irb *irb) {
 ...
 */
static int tape_3590_erp_special_interrupt(struct tape_device *device,
    struct tape_request *request, struct irb *irb) {
  return tape_3590_erp_basic(device, request, irb, -EIO);
}
 ...
 *  RDA: Read Alternate
 */
static int tape_3590_erp_read_alternate(struct tape_device *device,
    struct tape_request *request, struct irb *irb) {
  struct tape_3590_disc_data *data;
  /*
 ...
 */
static int tape_3590_erp_read_opposite(struct tape_device *device,
    struct tape_request *request, struct irb *irb) {
  switch (request->op) {
    case TO_RFO:
      /*
 ...
 */
static void tape_3590_print_mim_msg_f0(struct tape_device *device,
    struct irb *irb) {
  struct tape_3590_sense *sense;
 ...
 */
static void tape_3590_print_io_sim_msg_f1(struct tape_device *device,
    struct irb *irb) {
  struct tape_3590_sense *sense;
  char *exception, *service;
  exception = kmalloc(BUFSIZE, GFP_ATOMIC);
 ...
 */
static void tape_3590_print_dev_sim_msg_f2(struct tape_device *device,
    struct irb *irb) {
  struct tape_3590_sense *sense;
  char *exception, *service;
  exception = kmalloc(BUFSIZE, GFP_ATOMIC);
 ...
 */
static void tape_3590_print_era_msg(struct tape_device *device,
    struct irb *irb) {
  struct tape_3590_sense *sense;
  sense = (struct tape_3590_sense *) irb->ecw;
  if (sense->mc == 0) {
 ...
 */
static int tape_3590_unit_check(struct tape_device *device,
    struct tape_request *request,
    struct irb *irb) {
  struct tape_3590_sense *sense;
  sense = (struct tape_3590_sense *) irb->ecw;
 ...
 */
static int tape_3590_irq(struct tape_device *device,
    struct tape_request *request,
    struct irb *irb) {
  if (request == NULL) {
 ...
 */
static int tape_3590_setup_device(struct tape_device *device) {
  int rc;
  struct tape_3590_disc_data *data;
  struct tape_3590_rdc_data *rdc_data;
 ...
 */
static void tape_3590_cleanup_device(struct tape_device *device) {
...
static int tape_3590_online(struct ccw_device *cdev) {
 ...
 */
static int tape_3590_init(void) {
  int rc;
...
static void tape_3590_exit(void) {
