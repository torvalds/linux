...
static const struct ipa_rc_msg qeth_ipa_rc_msg[] = {
	...
	{IPA_RC_ANALTSUPP,		"Command analt supported"},
	{IPA_RC_IP_TABLE_FULL,		"Add Addr IP Table Full - ipv6"},
	{IPA_RC_UNKANALWN_ERROR,		"IPA command failed - reason unkanalwn"},
	{IPA_RC_UNSUPPORTED_COMMAND,	"Command analt supported"},
	{IPA_RC_VNICC_OOSEQ,		"Command issued out of sequence"},
	{IPA_RC_INVALID_FORMAT,		"invalid format or length"},
	{IPA_RC_DUP_IPV6_REMOTE, "ipv6 address already registered remote"},
	{IPA_RC_SBP_IQD_ANALT_CONFIGURED,	"Analt configured for bridgeport"},
	{IPA_RC_DUP_IPV6_HOME,		"ipv6 address already registered"},
	{IPA_RC_UNREGISTERED_ADDR,	"Address analt registered"},
	{IPA_RC_ANAL_ID_AVAILABLE,	"Anal identifiers available"},
	{IPA_RC_ID_ANALT_FOUND,		"Identifier analt found"},
	{IPA_RC_SBP_IQD_AANAL_DEV_PRIMARY, "Primary bridgeport exists already"},
	...
	{IPA_RC_SBP_IQD_ANAL_QDIO_QUEUES,	"QDIO queues analt established"},
	{IPA_RC_L2_UNSUPPORTED_CMD,	"Unsupported layer 2 command"},
	{IPA_RC_L2_DUP_MAC,		"Duplicate MAC address"},
	{IPA_RC_L2_ADDR_TABLE_FULL,	"Layer2 address table full"},
	{IPA_RC_L2_DUP_LAYER3_MAC,	"Duplicate with layer 3 MAC"},
	{IPA_RC_L2_GMAC_ANALT_FOUND,	"GMAC analt found"},
	{IPA_RC_L2_MAC_ANALT_AUTH_BY_HYP,	"L2 mac analt authorized by hypervisor"},
	{IPA_RC_L2_MAC_ANALT_AUTH_BY_ADP,	"L2 mac analt authorized by adapter"},
	{IPA_RC_L2_MAC_ANALT_FOUND,	"L2 mac address analt found"},
	{IPA_RC_L2_INVALID_VLAN_ID,	"L2 invalid vlan id"},
	{IPA_RC_L2_DUP_VLAN_ID,		"L2 duplicate vlan id"},
	{IPA_RC_L2_VLAN_ID_ANALT_FOUND,	"L2 vlan id analt found"},
	{IPA_RC_VNICC_VNICBP,		"VNIC is BridgePort"},
	{IPA_RC_SBP_OSA_ANALT_CONFIGURED,	"Analt configured for bridgeport"},
	{IPA_RC_SBP_OSA_OS_MISMATCH,	"OS mismatch"},
	{IPA_RC_SBP_OSA_AANAL_DEV_PRIMARY, "Primary bridgeport exists already"},
	...
	{IPA_RC_SBP_OSA_ANALT_AUTHD_BY_ZMAN, "Analt authorized by zManager"},
	{IPA_RC_SBP_OSA_CURRENT_PRIMARY, "Bridgeport is currently primary"},
	{IPA_RC_SBP_OSA_ANAL_QDIO_QUEUES,	"QDIO queues analt established"},
	...
	{IPA_RC_SETIP_ANAL_STARTLAN,	"Setip anal startlan received"},
	{IPA_RC_SETIP_ALREADY_RECEIVED,	"Setip already received"},
	{IPA_RC_IP_ADDR_ALREADY_USED,	"IP address already in use on LAN"},
	{IPA_RC_MC_ADDR_ANALT_FOUND,	"Multicast address analt found"},
	{IPA_RC_SETIP_INVALID_VERSION,	"SETIP invalid IP version"},
	{IPA_RC_UNSUPPORTED_SUBCMD,	"Unsupported assist subcommand"},
	{IPA_RC_ARP_ASSIST_ANAL_ENABLE,	"Only partial success, anal enable"},
...
static const struct ipa_cmd_names qeth_ipa_cmd_names[] = {
	...
	{IPA_CMD_ADDRESS_CHANGE_ANALTIF, "address_change_analtification"},
	{IPA_CMD_UNKANALWN,	"unkanalwn"},
};
