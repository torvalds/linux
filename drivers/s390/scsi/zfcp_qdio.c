...
static void zfcp_qdio_zero_sbals(struct qdio_buffer *sbal[], int first,
    int cnt) {
  int i, sbal_idx;
...
static struct qdio_buffer_element *zfcp_qdio_sbal_chain(struct zfcp_qdio *qdio,
...
static struct qdio_buffer_element *zfcp_qdio_sbale_next(struct zfcp_qdio *qdio,
    struct zfcp_qdio_req *q_req) {
...
int zfcp_qdio_open(struct zfcp_qdio *qdio) {
  struct qdio_buffer **input_sbals[1] = {
    qdio->res_q
  };
  struct qdio_buffer **output_sbals[1] = {
    qdio->req_q
  };
  struct qdio_buffer_element *sbale;
