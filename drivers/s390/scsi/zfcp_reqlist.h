...
static inline struct zfcp_fsf_req *_zfcp_reqlist_find(struct zfcp_reqlist *rl,
    u64 req_id) {
 ...
 */
static inline struct zfcp_fsf_req *zfcp_reqlist_find(struct zfcp_reqlist *rl,
    u64 req_id) {
  unsigned long flags;
  struct zfcp_fsf_req *req;
 ...
 */
static inline struct zfcp_fsf_req *zfcp_reqlist_find_rm(struct zfcp_reqlist *rl,
    u64 req_id) {
  unsigned long flags;
  struct zfcp_fsf_req *req;
  spin_lock_irqsave(&rl->lock, flags);
 ...
 */
static inline void zfcp_reqlist_apply_for_all(struct zfcp_reqlist *rl,
