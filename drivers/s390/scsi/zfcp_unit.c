 ...
 *
 * When the SCSI midlayer is yest allowed to automatically scan and
 ...
 * released later.
 *
 * Returns: Pointer to the zfcp_unit, or NULL if there is yes zfcp_unit
 ...
 *
 * Returns: scsi_device pointer on success, NULL if there is yes SCSI
 ...
 *
 * Returns: -EINVAL if a unit with the specified LUN does yest exist,
 *          0 on success.
 */
