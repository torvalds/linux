...
static void format_node_data(char *params, char *id,
    struct node_descriptor *nd) {
...
static void chsc_process_sei_chp_config(struct chsc_sei_nt0_area *sei_area) {
  ...
  int num;
  char *events[3] = {
    "configure", "deconfigure", "cancel deconfigure"
  };
...
static void chsc_initialize_cmg_chars(struct channel_path *chp, u8 cmcv,
