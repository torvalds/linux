 ...
 */
static void ccw_device_msg_control_check(struct ccw_device *cdev,
    struct irb *irb) {
 ...
 */
static void ccw_device_accumulate_ecw(struct ccw_device *cdev,
    struct irb *irb) {
  /*
 ...
 */
static int ccw_device_accumulate_esw_valid(struct irb *irb) {
 ...
 */
static void ccw_device_accumulate_esw(struct ccw_device *cdev,
    struct irb *irb) {
  struct irb *cdev_irb;
 ...
 */
void ccw_device_accumulate_irb(struct ccw_device *cdev, struct irb *irb) {
  struct irb *cdev_irb;
  /*
 ...
 * Do a basic sense.
 */
int ccw_device_do_sense(struct ccw_device *cdev, struct irb *irb) {
  struct subchannel *sch;
 ...
 */
void ccw_device_accumulate_basic_sense(struct ccw_device *cdev,
    struct irb *irb) {
  /*
   * Check if the status pending bit is set in stctl.
   * If not, the remaining bit have no meaning and we must ignore them.
