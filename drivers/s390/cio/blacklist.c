...
static int __init blacklist_setup(char *str) {
 ...
 */
int is_blacklisted(int ssid, int devno) {
...
static void *cio_ignore_proc_seq_start(struct seq_file *s, loff_t *offset) {
...
static void cio_ignore_proc_seq_stop(struct seq_file *s, void *it) {
}

static void *cio_ignore_proc_seq_next(struct seq_file *s, void *it,
    loff_t *offset) {
...
static int cio_ignore_proc_seq_show(struct seq_file *s, void *it) {
  struct ccwdev_iter *iter;
  iter = it;
...
static ssize_t cio_ignore_write(struct file *file, const char __user *user_buf,
