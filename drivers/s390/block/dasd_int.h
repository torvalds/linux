 ...
 */
static inline void dasd_get_device(struct dasd_device *device) {
  atomic_inc(&device->ref_count);
}

static inline void dasd_put_device(struct dasd_device *device) {
...
static inline void dasd_init_chunklist(struct list_head *chunk_list, void *mem,
    unsigned long size) {
...
static inline void *dasd_alloc_chunk(struct list_head *chunk_list,
    unsigned long size) {
...
static inline void dasd_free_chunk(struct list_head *chunk_list, void *mem) {
  struct dasd_mchunk *chunk, *tmp;
 ...
 */
static inline int dasd_check_blocksize(int bsize) {
 ...
 */
static inline int dasd_path_is_operational(struct dasd_device *device,
    int chp) {
...
static inline int dasd_path_is_nonpreferred(struct dasd_device *device,
    int chp) {
