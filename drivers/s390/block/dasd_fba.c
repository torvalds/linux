...
static int dasd_fba_set_online(struct ccw_device *cdev) {
...
static void define_extent(struct ccw1 *ccw, struct DE_fba_data *data, int rw,
...
static void locate_record(struct ccw1 *ccw, struct LO_fba_data *data, int rw,
...
static int dasd_fba_check_characteristics(struct dasd_device *device) {
...
static dasd_erp_fn_t dasd_fba_erp_action(struct dasd_ccw_req *cqr) {
  return dasd_default_erp_action;
}

static dasd_erp_fn_t dasd_fba_erp_postaction(struct dasd_ccw_req *cqr) {
...
static int dasd_fba_free_cp(struct dasd_ccw_req *cqr, struct request *req) {
...
static int dasd_fba_fill_info(struct dasd_device *device,
...
static void dasd_fba_dump_sense_dbf(struct dasd_device *device, struct irb *irb,
    char *reason) {
  u64 *sense;
...
static void dasd_fba_dump_sense(struct dasd_device *device,
...
static int __init dasd_fba_init(void) {
  int ret;
...
static void __exit dasd_fba_cleanup(void) {
