 ...
 * case of error.
 */
int tb_port_alloc_out_hopid(struct tb_port *port, int min_hopid,
    int max_hopid) {
...
static int tb_switch_uevent(const struct device *dev,
...
static int tb_switch_asym_enable(struct tb_switch *sw,
    enum tb_link_width width) {
 ...
 */
static int tb_switch_pcie_bridge_write(struct tb_switch *sw,
    unsigned int bridge,
