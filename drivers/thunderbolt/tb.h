 ...
 * @TB_SWITCH_TMU_MODE_MEDRES_ENHANCED_UNI: Enhanced Uni-directional, MedRes
 * mode
 *
 ...
 */
static inline bool tb_port_path_direction_downstream(const struct tb_port *src,
...
/**
 * tb_for_each_upstream_port_on_path() - Iterate over each upstreamm port on
 * path
 * @src: Source port
 * @dst: Destination port
 * @p: Port used as iterator
...
int usb4_port_asym_set_link_width(struct tb_port *port,
...
#else
static inline bool tb_acpi_add_links(struct tb_nhi *nhi) {
  return false;
}

static inline bool tb_acpi_is_native(void) {
  return true;
}

static inline bool tb_acpi_may_tunnel_usb3(void) {
  return true;
}

static inline bool tb_acpi_may_tunnel_dp(void) {
  return true;
}

static inline bool tb_acpi_may_tunnel_pcie(void) {
  return true;
}

static inline bool tb_acpi_is_xdomain_allowed(void) {
  return true;
}

static inline int tb_acpi_init(void) {
  return 0;
}
...
static inline int tb_acpi_power_on_retimers(struct tb_port *port) {
  return 0;
}

static inline int tb_acpi_power_off_retimers(struct tb_port *port) {
  return 0;
}
