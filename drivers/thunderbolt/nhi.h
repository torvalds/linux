 ...
 * @suspend_yesirq: NHI specific suspend_yesirq hook
 * @resume_yesirq: NHI specific resume_yesirq hook
...
struct tb_nhi_ops {
	...
	int (*suspend_yesirq)(struct tb_nhi *nhi, bool wakeup);
	int (*resume_yesirq)(struct tb_nhi *nhi);
...
/*
 * PCI IDs used in this driver from Win Ridge forward. There is yes
