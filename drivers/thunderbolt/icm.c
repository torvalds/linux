...
static const struct intel_vss *parse_intel_vss(const void *ep_name,
    size_t size) {
...
static int pci2cio_wait_completion(struct icm *icm,
...
static int icm_fr_driver_ready(struct tb *tb,
    enum tb_security_level *security_level,
    u8 *proto_version, size_t *nboot_acl, bool *rpm) {
...
static void icm_fr_device_connected(struct tb *tb,
    const struct icm_pkg_header *hdr) {
...
static void icm_fr_device_disconnected(struct tb *tb,
    const struct icm_pkg_header *hdr) {
...
static void icm_fr_xdomain_connected(struct tb *tb,
    const struct icm_pkg_header *hdr) {
...
static void icm_fr_xdomain_disconnected(struct tb *tb,
    const struct icm_pkg_header *hdr) {
...
static int icm_tr_driver_ready(struct tb *tb,
    enum tb_security_level *security_level,
    u8 *proto_version, size_t *nboot_acl, bool *rpm) {
...
static void __icm_tr_device_connected(struct tb *tb,
    const struct icm_pkg_header *hdr,
    bool force_rtd3) {
...
static void icm_tr_device_connected(struct tb *tb,
    const struct icm_pkg_header *hdr) {
  __icm_tr_device_connected(tb, hdr, false);
}

static void icm_tr_device_disconnected(struct tb *tb,
    const struct icm_pkg_header *hdr) {
...
static void icm_tr_xdomain_connected(struct tb *tb,
    const struct icm_pkg_header *hdr) {
...
static void icm_tr_xdomain_disconnected(struct tb *tb,
    const struct icm_pkg_header *hdr) {
...
static int icm_ar_driver_ready(struct tb *tb,
    enum tb_security_level *security_level,
    u8 *proto_version, size_t *nboot_acl, bool *rpm) {
...
static int icm_icl_driver_ready(struct tb *tb,
    enum tb_security_level *security_level,
    u8 *proto_version, size_t *nboot_acl, bool *rpm) {
  struct icm_tr_pkg_driver_ready_response reply;
  struct icm_pkg_driver_ready request = {
...
static void icm_icl_device_connected(struct tb *tb,
    const struct icm_pkg_header *hdr) {
...
static int __icm_driver_ready(struct tb *tb,
    enum tb_security_level *security_level,
    u8 *proto_version, size_t *nboot_acl, bool *rpm) {
  struct icm *icm = tb_priv(tb);
