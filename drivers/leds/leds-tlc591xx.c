...
static int tlc591xx_set_mode(struct regmap *regmap, u8 mode) {
  int err;
  u8 val;
...
static int tlc591xx_set_ledout(struct tlc591xx_priv *priv,
...
static int tlc591xx_set_pwm(struct tlc591xx_priv *priv,
    struct tlc591xx_led *led,
    u8 brightness) {
...
static int tlc591xx_brightness_set(struct led_classdev *led_cdev,
...
static int tlc591xx_probe(struct i2c_client *client) {
