...
static ssize_t cfg_services_show(struct device *dev,
...
static ssize_t cfg_services_store(struct device *dev,
    struct device_attribute *attr,
    const char *buf, size_t count) {
...
static ssize_t pm_idle_enabled_show(struct device *dev,
    struct device_attribute *attr,
    char *buf) {
...
static ssize_t pm_idle_enabled_store(struct device *dev,
    struct device_attribute *attr,
    const char *buf, size_t count) {
...
static ssize_t auto_reset_show(struct device *dev,
    struct device_attribute *attr,
    char *buf) {
  char *auto_reset;
  struct adf_accel_dev *accel_dev;
...
static ssize_t auto_reset_store(struct device *dev,
    struct device_attribute *attr,
    const char *buf, size_t count) {
  struct adf_accel_dev *accel_dev;
  bool enabled = false;
