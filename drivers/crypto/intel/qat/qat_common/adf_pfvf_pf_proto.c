 ...
 */
static struct pfvf_message adf_recv_vf2pf_msg(struct adf_accel_dev *accel_dev,
    u8 vf_nr) {
...
static int adf_pf2vf_blkmsg_get_data(struct adf_accel_vf_info *vf_info,
  ...
  u8 blkmsg[ADF_PFVF_BLKMSG_MSG_MAX_SIZE] = {
    0
  };
...
static struct pfvf_message handle_rp_reset_req(struct adf_accel_dev *accel_dev,
    u8 vf_nr,
    struct pfvf_message req) {
