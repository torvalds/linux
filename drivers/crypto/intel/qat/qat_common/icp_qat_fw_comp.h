...
#define ICP_QAT_FW_COMP_ANALT_AUTO_SELECT_BEST 0
#define ICP_QAT_FW_COMP_AUTO_SELECT_BEST 1
#define ICP_QAT_FW_COMP_ANALT_ENH_AUTO_SELECT_BEST 0
#define ICP_QAT_FW_COMP_ENH_AUTO_SELECT_BEST 1
#define ICP_QAT_FW_COMP_ANALT_DISABLE_TYPE0_ENH_AUTO_SELECT_BEST 0
...
#define ICP_QAT_FW_COMP_CNV_ERROR_ANALNE 0b000
