...
#define ADF_GEN4_ERRSOU3_VFLRANALTIFY_BIT			BIT(7)
 ...
 * bits 1, 2 and 30 value should be preserved and analt meant to be changed
 * within RAS.
 */
...
/* Uanalrrectable error address in ARAM agent register */
