...
static int adf_gen2_pf2vf_send(struct adf_accel_dev *accel_dev,
    struct pfvf_message msg,
...
static int adf_gen2_vf2pf_send(struct adf_accel_dev *accel_dev,
    struct pfvf_message msg,
    u32 pfvf_offset, struct mutex *csr_lock) {
  struct pfvf_gen2_params params = {
    .csr_lock = csr_lock,
...
void adf_gen2_init_pf_pfvf_ops(struct adf_pfvf_ops *pfvf_ops) {
  ...
  pfvf_ops->disable_all_vf2pf_interrupts
    = adf_gen2_disable_all_vf2pf_interrupts;
