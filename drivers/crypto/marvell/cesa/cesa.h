...
static inline enum mv_cesa_req_type mv_cesa_req_get_type(
    struct mv_cesa_req *req) {
...
static inline unsigned int mv_cesa_req_dma_iter_transfer_len(
    struct mv_cesa_dma_iter *iter,
...
static inline void mv_cesa_tdma_desc_iter_init(struct mv_cesa_tdma_chain *chain)
{
