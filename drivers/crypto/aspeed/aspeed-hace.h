...
#define ASPEED_HACE_DEST    0x04  /* Crypto Data Destination Base Address
                                   * Register */
#define ASPEED_HACE_CONTEXT   0x08  /* Crypto Context Buffer Base Address
                                     * Register */
...
/* G6 */
#define ASPEED_HACE_GCM_ADD_LEN   0x14  /* Crypto AES-GCM Additional Data Length
                                         * Register */
#define ASPEED_HACE_GCM_TAG_BASE_ADDR 0x18  /* Crypto AES-GCM Tag Write Buff
                                             * Base Address Reg */
...
#define ASPEED_HACE_HASH_SRC    0x20  /* Hash Data Source Base Address Register
                                       * */
#define ASPEED_HACE_HASH_DIGEST_BUFF  0x24  /* Hash Digest Write Buffer Base
                                             * Address Register */
#define ASPEED_HACE_HASH_KEY_BUFF 0x28  /* Hash HMAC Key Buffer Base Address
                                         * Register */
