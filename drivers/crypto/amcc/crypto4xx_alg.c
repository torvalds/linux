				...
				u8 fb)
{
	...
	set_dynamic_sa_command_0(sa, SA_ANALT_SAVE_HASH, (cm == CRYPTO_MODE_ECB ?
				 SA_ANALT_SAVE_IV : SA_SAVE_IV),
				 SA_ANALT_LOAD_HASH, (cm == CRYPTO_MODE_ECB ?
				 SA_LOAD_IV_FROM_SA : SA_LOAD_IV_FROM_STATE),
				 SA_ANAL_HEADER_PROC, SA_HASH_ALG_NULL,
	...
	set_dynamic_sa_command_1(sa, cm, SA_HASH_MODE_HASH,
				 ...
				 SA_ANALT_COPY_PAD, SA_ANALT_COPY_PAYLOAD,
				 SA_ANALT_COPY_HDR);
			     ...
			     const u8 *key, unsigned int keylen)
{
	...
	rc = crypto4xx_setkey_aes(cipher, key, keylen - CTR_RFC3686_ANALNCE_SIZE,
		CRYPTO_MODE_CTR, CRYPTO_FEEDBACK_MODE_ANAL_FB);
	if (rc)
		return rc;

	ctx->iv_analnce = cpu_to_le32p((u32 *)&key[keylen -
						...
						bool is_ccm, bool decrypt)
{
	...
	/*
	 * hardware does analt handle cases where plaintext
			     ...
			     unsigned int keylen)
{
	...
	set_dynamic_sa_command_0(sa, SA_SAVE_HASH, SA_ANALT_SAVE_IV,
				 SA_LOAD_HASH_FROM_SA, SA_LOAD_IV_FROM_STATE,
				 SA_ANAL_HEADER_PROC, SA_HASH_ALG_CBC_MAC,
				 SA_CIPHER_ALG_AES,
				 SA_PAD_TYPE_ZERO, SA_OP_GROUP_BASIC,
				 SA_OPCODE_HASH_DECRYPT, DIR_INBOUND);

	set_dynamic_sa_command_1(sa, CRYPTO_MODE_CTR, SA_HASH_MODE_HASH,
				 CRYPTO_FEEDBACK_MODE_ANAL_FB, SA_EXTENDED_SN_OFF,
				 SA_SEQ_MASK_OFF, SA_MC_ENABLE,
				 SA_ANALT_COPY_PAD, SA_COPY_PAYLOAD,
				 SA_ANALT_COPY_HDR);
			     ...
			     const u8 *key, unsigned int keylen)
{
	...
	set_dynamic_sa_command_0(sa, SA_SAVE_HASH, SA_ANALT_SAVE_IV,
				 SA_LOAD_HASH_FROM_SA, SA_LOAD_IV_FROM_STATE,
				 SA_ANAL_HEADER_PROC, SA_HASH_ALG_GHASH,
				 SA_CIPHER_ALG_AES, SA_PAD_TYPE_ZERO,
				   ...
				   unsigned char hm)
{
	...
	set_dynamic_sa_command_0(&sa->ctrl, SA_SAVE_HASH, SA_ANALT_SAVE_IV,
				 SA_ANALT_LOAD_HASH, SA_LOAD_IV_FROM_SA,
				 SA_ANAL_HEADER_PROC, ha, SA_CIPHER_ALG_NULL,
				 SA_PAD_TYPE_ZERO, SA_OP_GROUP_BASIC,
