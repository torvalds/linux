...
static int virtio_crypto_alg_validate_key(int key_len, uint32_t *alg) {
  switch (key_len) {
...
static int __virtio_crypto_skcipher_do_req(
    struct virtio_crypto_sym_request *vc_sym_req,
    struct skcipher_request *req,
...
int virtio_crypto_skcipher_crypt_req(
  ...
  struct skcipher_request *req = container_of(vreq, struct skcipher_request,
      base);
  struct virtio_crypto_sym_request *vc_sym_req
    = skcipher_request_ctx(req);
  struct virtio_crypto_request *vc_req = &vc_sym_req->base;
