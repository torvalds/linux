 ...
 *   < 0 if an error
 */
static int spu_skcipher_rx_sg_create(struct brcm_message *mssg,
 ...
 *   < 0 if an error
 */
static int spu_skcipher_tx_sg_create(struct brcm_message *mssg,
    struct iproc_reqctx_s *rctx,
 ...
 *   < 0 if an error
 */
static int spu_ahash_rx_sg_create(struct brcm_message *mssg,
    struct iproc_reqctx_s *rctx,
 ...
 *   < 0 if an error
 */
static int spu_ahash_tx_sg_create(struct brcm_message *mssg,
    struct iproc_reqctx_s *rctx,
    u8 tx_frag_num,
    u32 spu_hdr_len,
