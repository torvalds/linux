...
static void artpec6_crypto_complete_cbc_encrypt(
  struct crypto_async_request *req);
static void artpec6_crypto_complete_cbc_decrypt(
  struct crypto_async_request *req);
...
static int artpec6_crypto_common_destroy(
  struct artpec6_crypto_req_common *common);
...
static size_t artpec6_crypto_walk_chunklen(
    const struct artpec6_crypto_walk *awalk) {
  WARN_ON(awalk->sg->length == awalk->offset);
  return awalk->sg->length - awalk->offset;
}

static dma_addr_t artpec6_crypto_walk_chunk_phys(
    const struct artpec6_crypto_walk *awalk) {
  return sg_phys(awalk->sg) + awalk->offset;
}

static void artpec6_crypto_copy_bounce_buffers(
    struct artpec6_crypto_req_common *common) {
...
static void artpec6_crypto_init_dma_operation(
    struct artpec6_crypto_req_common *common) {
  struct artpec6_crypto_dma_descriptors *dma = common->dma;
  dma->out_cnt = 0;
  dma->in_cnt = 0;
 ...
 */
static int artpec6_crypto_setup_out_descr_phys(
    struct artpec6_crypto_req_common *common,
 ...
 */
static int artpec6_crypto_setup_out_descr_short(
    struct artpec6_crypto_req_common *common,
...
static int artpec6_crypto_dma_map_single(
    struct artpec6_crypto_req_common *common,
...
static int artpec6_crypto_dma_map_descs(
    struct artpec6_crypto_req_common *common) {
  struct artpec6_crypto_dma_descriptors *dma = common->dma;
  int ret;
...
static void artpec6_crypto_dma_unmap_all(
    struct artpec6_crypto_req_common *common) {
  struct artpec6_crypto_dma_descriptors *dma = common->dma;
  struct device *dev = artpec6_crypto_dev;
  int i;
 ...
 */
static int artpec6_crypto_setup_out_descr(
    struct artpec6_crypto_req_common *common,
    void *dst, unsigned int len, bool eop,
    bool use_short) {
  if (use_short && len < 7) {
 ...
 *
 */
static int artpec6_crypto_setup_in_descr_phys(
    struct artpec6_crypto_req_common *common,
 ...
 */
static int artpec6_crypto_setup_in_descr(
    struct artpec6_crypto_req_common *common,
...
static struct artpec6_crypto_bounce_buffer *artpec6_crypto_alloc_bounce(
    gfp_t flags) {
  void *base;
...
static int artpec6_crypto_setup_sg_descrs_in(
    struct artpec6_crypto_req_common *common,
...
static int artpec6_crypto_setup_sg_descrs_out(
    struct artpec6_crypto_req_common *common,
    struct artpec6_crypto_walk *walk,
    size_t count) {
  size_t chunk;
 ...
 */
static int artpec6_crypto_terminate_out_descrs(
    struct artpec6_crypto_req_common *common) {
  struct artpec6_crypto_dma_descriptors *dma = common->dma;
  struct pdma_descr *d;
 ...
 */
static int artpec6_crypto_terminate_in_descrs(
    struct artpec6_crypto_req_common *common) {
  struct artpec6_crypto_dma_descriptors *dma = common->dma;
  struct pdma_descr *d;
 ...
 */
static size_t create_hash_pad(int oper, unsigned char *dst, u64 dgstlen,
    u64 bitcount) {
...
static void artpec6_crypto_bounce_destroy(
    struct artpec6_crypto_dma_descriptors *dma) {
  struct artpec6_crypto_bounce_buffer *b;
  struct artpec6_crypto_bounce_buffer *next;
  list_for_each_entry_safe(b, next, &dma->bounce_buffers, list) {
...
static int artpec6_crypto_ctr_crypt(struct skcipher_request *req,
    bool encrypt) {
  struct crypto_skcipher *cipher = crypto_skcipher_reqtfm(req);
  struct artpec6_cryptotfm_context *ctx = crypto_skcipher_ctx(cipher);
...
static int artpec6_crypto_cipher_set_key(struct crypto_skcipher *cipher,
    const u8 *key,
    unsigned int keylen) {
...
static int artpec6_crypto_xts_set_key(struct crypto_skcipher *cipher,
    const u8 *key,
    unsigned int keylen) {
  struct artpec6_cryptotfm_context *ctx
    = crypto_skcipher_ctx(cipher);
...
/*------------------- Hash functions -----------------------------------------*/
static int artpec6_crypto_hash_set_key(struct crypto_ahash *tfm,
...
static int artpec6_crypto_init_hash(struct ahash_request *req, u8 type,
    int hmac) {
  struct artpec6_crypto *ac = dev_get_drvdata(artpec6_crypto_dev);
  enum artpec6_crypto_variant variant = ac->variant;
...
static int artpec6_crypto_hash_import(struct ahash_request *req,
    const void *in) {
