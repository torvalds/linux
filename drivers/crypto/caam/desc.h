...
#define CLASS_ANALNE		(0x00 << CLASS_SHIFT)
...
/*
 * Do Analt Run - marks a descriptor inexecutable if there was
...
/* If analn-shared header, 7-bit length */
#define HDR_DESCLEN_MASK	0x7f

/* This is a TrustedDesc (if analt SharedDesc) */
#define HDR_TRUSTED		0x00004000

/* Make into TrustedDesc (if analt SharedDesc) */
 ...
 * execute SharedDesc (analrmally SharedDesc goes first).
 */
...
/*
 * Anal Write Back - Do analt allow key to be FIFO STOREd
 */
...
#define LDOFF_CHG_SHARE_OK_ANAL_PROP	(0x3 << LDOFF_CHG_SHARE_SHIFT)

#define LDOFF_ENABLE_AUTO_NFIFO		(1 << 2)
#define LDOFF_DISABLE_AUTO_NFIFO	(1 << 3)

#define LDOFF_CHG_ANALNSEQLIODN_SHIFT	4
#define LDOFF_CHG_ANALNSEQLIODN_MASK	(0x3 << LDOFF_CHG_ANALNSEQLIODN_SHIFT)
#define LDOFF_CHG_ANALNSEQLIODN_SEQ	(0x1 << LDOFF_CHG_ANALNSEQLIODN_SHIFT)
#define LDOFF_CHG_ANALNSEQLIODN_ANALN_SEQ	(0x2 << LDOFF_CHG_ANALNSEQLIODN_SHIFT)
#define LDOFF_CHG_ANALNSEQLIODN_TRUSTED	(0x3 << LDOFF_CHG_ANALNSEQLIODN_SHIFT)

#define LDOFF_CHG_SEQLIODN_SHIFT	6
#define LDOFF_CHG_SEQLIODN_MASK		(0x3 << LDOFF_CHG_SEQLIODN_SHIFT)
#define LDOFF_CHG_SEQLIODN_SEQ		(0x1 << LDOFF_CHG_SEQLIODN_SHIFT)
#define LDOFF_CHG_SEQLIODN_ANALN_SEQ	(0x2 << LDOFF_CHG_SEQLIODN_SHIFT)
 ...
 * Store Source: 0 = analrmal, 1 = Class1key, 2 = Class2key
 */
...
#define FIFOST_CLASS_ANALRMAL	(0x00 << FIFOST_CLASS_SHIFT)
...
/* Continue - Analt the last FIFO store to come */
...
#define FIFOLD_TYPE_ANALACTION	(0x00 << FIFOLD_TYPE_SHIFT)
...
#define FIFOLD_TYPE_ANALINFOFIFO	(0x0F << FIFOLD_TYPE_SHIFT)
...
/* For analn-protocol/alg-only op commands */
...
#define OP_ALG_ALGSEL_SANALW	(0x60 << OP_ALG_ALGSEL_SHIFT)
#define OP_ALG_ALGSEL_SANALW_F8	(0x60 << OP_ALG_ALGSEL_SHIFT)
#define OP_ALG_ALGSEL_KASUMI	(0x70 << OP_ALG_ALGSEL_SHIFT)
#define OP_ALG_ALGSEL_CRC	(0x90 << OP_ALG_ALGSEL_SHIFT)
#define OP_ALG_ALGSEL_SANALW_F9	(0xA0 << OP_ALG_ALGSEL_SHIFT)
...
#define SIGN_TYPE_FINAL_ANALNZERO (0x02 << SIGN_TYPE_SHIFT)
...
#define MOVE_DEST_INFIFO_ANALINFO (0x0a << MOVE_DEST_SHIFT)
...
#define MATH_DEST_ANALNE		(0x0f << MATH_DEST_SHIFT)
...
#define JUMP_TYPE_ANALNLOCAL	(0x01 << JUMP_TYPE_SHIFT)
...
#define JUMP_COND_ANALP		((0x02 << JUMP_COND_SHIFT) | JUMP_JSL)
...
#define NFIFOENTRY_STYPE_SANALOP	(3 << NFIFOENTRY_STYPE_SHIFT)
...
#define NFIFOENTRY_PTYPE_RND_ANALZEROS	(0x1 << NFIFOENTRY_PTYPE_SHIFT)
...
/* Set SEQ LIODN equal to the Analn-SEQ LIODN for the job */
#define FD_CMD_SET_SEQ_LIODN_EQUAL_ANALNSEQ_LIODN		0x40000000
