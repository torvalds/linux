...
static inline struct atmel_aes_ctr_ctx *atmel_aes_ctr_ctx_cast(
    struct atmel_aes_base_ctx *ctx) {
...
static inline struct atmel_aes_gcm_ctx *atmel_aes_gcm_ctx_cast(
    struct atmel_aes_base_ctx *ctx) {
...
static inline struct atmel_aes_xts_ctx *atmel_aes_xts_ctx_cast(
    struct atmel_aes_base_ctx *ctx) {
...
static int atmel_aes_xts_process_data(struct atmel_aes_dev *dd) {
  ...
  static const __le32 one[AES_BLOCK_SIZE / sizeof(u32)] = {
    cpu_to_le32(1),
  };
