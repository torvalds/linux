...
static void ccp_update_sg_workarea(struct ccp_sg_workarea *wa,
    unsigned int len) {
...
static noinline_for_stack int ccp_run_aes_cmac_cmd(struct ccp_cmd_queue *cmd_q,
    struct ccp_cmd *cmd) {
...
static noinline_for_stack int ccp_run_aes_gcm_cmd(struct ccp_cmd_queue *cmd_q,
    struct ccp_cmd *cmd) {
  struct ccp_aes_engine *aes = &cmd->u.aes;
...
static noinline_for_stack int ccp_run_aes_cmd(struct ccp_cmd_queue *cmd_q,
    struct ccp_cmd *cmd) {
  struct ccp_aes_engine *aes = &cmd->u.aes;
  struct ccp_dm_workarea key, ctx;
  struct ccp_data src, dst;
...
static noinline_for_stack int ccp_run_xts_aes_cmd(struct ccp_cmd_queue *cmd_q,
    struct ccp_cmd *cmd) {
...
static noinline_for_stack int ccp_run_des3_cmd(struct ccp_cmd_queue *cmd_q,
    struct ccp_cmd *cmd) {
...
static noinline_for_stack int ccp_run_sha_cmd(struct ccp_cmd_queue *cmd_q,
    struct ccp_cmd *cmd) {
...
static noinline_for_stack int ccp_run_rsa_cmd(struct ccp_cmd_queue *cmd_q,
    struct ccp_cmd *cmd) {
...
static noinline_for_stack int ccp_run_passthru_cmd(struct ccp_cmd_queue *cmd_q,
    struct ccp_cmd *cmd) {
...
static noinline_for_stack int ccp_run_passthru_nomap_cmd(
    struct ccp_cmd_queue *cmd_q,
    struct ccp_cmd *cmd) {
...
static int ccp_run_ecc_mm_cmd(struct ccp_cmd_queue *cmd_q,
    struct ccp_cmd *cmd) {
...
static int ccp_run_ecc_pm_cmd(struct ccp_cmd_queue *cmd_q,
    struct ccp_cmd *cmd) {
  struct ccp_ecc_engine *ecc = &cmd->u.ecc;
  struct ccp_dm_workarea src, dst;
  struct ccp_op op;
...
static noinline_for_stack int ccp_run_ecc_cmd(struct ccp_cmd_queue *cmd_q,
    struct ccp_cmd *cmd) {
  struct ccp_ecc_engine *ecc = &cmd->u.ecc;
  ecc->ecc_result = 0;
  if (!ecc->mod
