 ...
 *             byte should have a value of COMMAND for yesrmal operation.
 ...
 * @i2c_client_list_yesde: part of i2c_client_list
 ...
 * more than this number of bytes will cause the device to yest ACK those bytes.
...
struct atmel_i2c_client_priv {
	...
	struct list_head i2c_client_list_yesde;
	struct mutex lock;
