...
unsigned int __init intc_get_mask_handle(struct intc_desc *desc,
    struct intc_desc_int *d,
...
unsigned int __init intc_get_prio_handle(struct intc_desc *desc,
    struct intc_desc_int *d,
    intc_enum enum_id, int do_grps) {
  unsigned int i = 0;
  unsigned int j = 0;
...
unsigned int __init intc_get_sense_handle(struct intc_desc *desc,
    struct intc_desc_int *d,
    intc_enum enum_id) {
