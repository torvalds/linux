...
enum {
  MODE_ENABLE_REG = 0, /* Bit(s) set -> interrupt enabled */
...
static inline void intc_set_dist_handle(unsigned int irq,
...
void intc_irq_xlate_set(unsigned int irq, intc_enum id,
    struct intc_desc_int *d);
