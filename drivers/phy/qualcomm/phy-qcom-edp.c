...
static int qcom_edp_set_voltages(struct qcom_edp *edp,
...
static int qcom_edp_phy_configure(struct phy *phy,
...
static int qcom_edp_configure_pll(const struct qcom_edp *edp) {
  ...
  writel(div_frac_start2_mode0,
      edp->pll + QSERDES_V4_COM_DIV_FRAC_START2_MODE0);
  writel(div_frac_start3_mode0,
      edp->pll + QSERDES_V4_COM_DIV_FRAC_START3_MODE0);
...
static unsigned long qcom_edp_dp_pixel_clk_recalc_rate(struct clk_hw *hw,
...
static unsigned long qcom_edp_dp_link_clk_recalc_rate(struct clk_hw *hw,
    unsigned long parent_rate) {
...
static int qcom_edp_clks_register(struct qcom_edp *edp,
