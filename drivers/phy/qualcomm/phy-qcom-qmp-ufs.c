...
static void qmp_ufs_serdes_init(struct qmp_ufs *qmp,
    const struct qmp_phy_cfg_tbls *tbls) {
  void __iomem *serdes = qmp->serdes;
  qmp_configure(serdes, tbls->serdes, tbls->serdes_num);
}

static void qmp_ufs_lanes_init(struct qmp_ufs *qmp,
    const struct qmp_phy_cfg_tbls *tbls) {
...
static void qmp_ufs_pcs_init(struct qmp_ufs *qmp,
    const struct qmp_phy_cfg_tbls *tbls) {
  void __iomem *pcs = qmp->pcs;
  qmp_configure(pcs, tbls->pcs, tbls->pcs_num);
}

static int qmp_ufs_get_gear_overlay(struct qmp_ufs *qmp,
    const struct qmp_phy_cfg *cfg) {
...
static void qmp_ufs_init_registers(struct qmp_ufs *qmp,
    const struct qmp_phy_cfg *cfg) {
  int i;
...
static int qmp_ufs_register_clocks(struct qmp_ufs *qmp,
...
static int qmp_ufs_parse_dt_legacy(struct qmp_ufs *qmp,
    struct device_node *np) {
