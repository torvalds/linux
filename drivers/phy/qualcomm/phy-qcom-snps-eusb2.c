...
static int qcom_snps_eusb2_hsphy_set_mode(struct phy *p, enum phy_mode mode,
    int submode) {
...
static int qcom_snps_eusb2_hsphy_init(struct phy *p) {
  ...
  qcom_snps_eusb2_hsphy_write_mask(phy->base, UTMI_PHY_CMN_CTRL0, TESTBURNIN,
      0);
  ...
  qcom_snps_eusb2_hsphy_write_mask(phy->base, USB_PHY_HS_PHY_CTRL2,
      ...
      USB2_SUSPEND_N_SEL | USB2_SUSPEND_N);
  qcom_snps_eusb2_hsphy_write_mask(phy->base, USB_PHY_UTMI_CTRL0, SLEEPM,
      SLEEPM);
  qcom_snps_eusb2_hsphy_write_mask(phy->base, USB_PHY_HS_PHY_CTRL_COMMON0,
      SIDDQ_SEL, SIDDQ_SEL);
  qcom_snps_eusb2_hsphy_write_mask(phy->base, USB_PHY_HS_PHY_CTRL_COMMON0,
