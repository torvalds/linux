...
static int qmp_pcie_msm8996_vreg_init(struct device *dev,
    const struct qmp_phy_cfg *cfg) {
...
static int qmp_pcie_msm8996_reset_init(struct device *dev,
    const struct qmp_phy_cfg *cfg) {
  struct qcom_qmp *qmp = dev_get_drvdata(dev);
  int i;
  int ret;
...
static int qmp_pcie_msm8996_clk_init(struct device *dev,
    const struct qmp_phy_cfg *cfg) {
  struct qcom_qmp *qmp = dev_get_drvdata(dev);
...
static int qmp_pcie_msm8996_create(struct device *dev, struct device_node *np,
    int id,
