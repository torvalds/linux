...
static struct device_node *tegra_xusb_find_pad_node(
    struct tegra_xusb_padctl *padctl, const char *name) {
...
static struct device_node *tegra_xusb_pad_find_phy_node(
    struct tegra_xusb_pad *pad, unsigned int index) {
...
static struct tegra_xusb_pad *tegra_xusb_pad_create(
    struct tegra_xusb_padctl *padctl,
...
static struct device_node *tegra_xusb_find_port_node(
    struct tegra_xusb_padctl *padctl, const char *type,
    unsigned int index) {
