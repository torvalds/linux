...
static inline struct tegra124_xusb_padctl *to_tegra124_xusb_padctl(
...
static struct tegra_xusb_lane *tegra124_usb2_lane_probe(
    struct tegra_xusb_pad *pad, struct device_node *np,
    unsigned int index) {
...
static struct tegra_xusb_pad *tegra124_usb2_pad_probe(
    struct tegra_xusb_padctl *padctl,
...
static struct tegra_xusb_lane *tegra124_ulpi_lane_probe(
    struct tegra_xusb_pad *pad, struct device_node *np,
    unsigned int index) {
...
static struct tegra_xusb_pad *tegra124_ulpi_pad_probe(
    struct tegra_xusb_padctl *padctl,
    const struct tegra_xusb_pad_soc *soc,
    struct device_node *np) {
...
static struct tegra_xusb_lane *tegra124_hsic_lane_probe(
    struct tegra_xusb_pad *pad, struct device_node *np,
    unsigned int index) {
...
static struct tegra_xusb_pad *tegra124_hsic_pad_probe(
    struct tegra_xusb_padctl *padctl,
    const struct tegra_xusb_pad_soc *soc,
    struct device_node *np) {
...
static struct tegra_xusb_lane *tegra124_pcie_lane_probe(
    struct tegra_xusb_pad *pad, struct device_node *np,
    unsigned int index) {
...
static struct tegra_xusb_pad *tegra124_pcie_pad_probe(
    struct tegra_xusb_padctl *padctl,
    const struct tegra_xusb_pad_soc *soc,
    struct device_node *np) {
...
static struct tegra_xusb_lane *tegra124_sata_lane_probe(
    struct tegra_xusb_pad *pad, struct device_node *np,
    unsigned int index) {
...
static struct tegra_xusb_pad *tegra124_sata_pad_probe(
    struct tegra_xusb_padctl *padctl,
    const struct tegra_xusb_pad_soc *soc,
    struct device_node *np) {
...
static struct tegra_xusb_lane *tegra124_usb2_port_map(
...
static struct tegra_xusb_lane *tegra124_ulpi_port_map(
    struct tegra_xusb_port *port) {
...
static struct tegra_xusb_lane *tegra124_hsic_port_map(
    struct tegra_xusb_port *port) {
...
static struct tegra_xusb_lane *tegra124_usb3_port_map(
    struct tegra_xusb_port *port) {
...
static int tegra124_xusb_read_fuse_calibration(
    struct tegra124_xusb_fuse_calibration *fuse) {
  unsigned int i;
  int err;
  u32 value;
...
static struct tegra_xusb_padctl *tegra124_xusb_padctl_probe(struct device *dev,
