...
static inline struct tegra_xusb_usb3_lane *to_usb3_lane(
...
static inline struct tegra_xusb_usb2_lane *to_usb2_lane(
    struct tegra_xusb_lane *lane) {
...
static inline struct tegra_xusb_ulpi_lane *to_ulpi_lane(
    struct tegra_xusb_lane *lane) {
...
static inline struct tegra_xusb_hsic_lane *to_hsic_lane(
    struct tegra_xusb_lane *lane) {
...
static inline struct tegra_xusb_pcie_lane *to_pcie_lane(
    struct tegra_xusb_lane *lane) {
...
static inline struct tegra_xusb_sata_lane *to_sata_lane(
    struct tegra_xusb_lane *lane) {
...
struct tegra_xusb_lane_ops {
  ...
  int (*enable_phy_sleepwalk)(struct tegra_xusb_lane *lane,
...
static inline struct tegra_xusb_usb3_pad *to_usb3_pad(
    struct tegra_xusb_pad *pad) {
...
static inline struct tegra_xusb_usb2_pad *to_usb2_pad(
    struct tegra_xusb_pad *pad) {
...
static inline struct tegra_xusb_hsic_pad *to_hsic_pad(
    struct tegra_xusb_pad *pad) {
...
static inline struct tegra_xusb_pcie_pad *to_pcie_pad(
    struct tegra_xusb_pad *pad) {
...
static inline struct tegra_xusb_sata_pad *to_sata_pad(
    struct tegra_xusb_pad *pad) {
...
struct tegra_xusb_lane *tegra_xusb_port_find_lane(struct tegra_xusb_port *port,
    const struct tegra_xusb_lane_map *map,
    const char *function);

struct tegra_xusb_port *tegra_xusb_find_port(struct tegra_xusb_padctl *padctl,
    const char *type,
    unsigned int index);
...
static inline struct tegra_xusb_usb2_port *to_usb2_port(
    struct tegra_xusb_port *port) {
  return container_of(port, struct tegra_xusb_usb2_port, base);
}

struct tegra_xusb_usb2_port *tegra_xusb_find_usb2_port(
  struct tegra_xusb_padctl *padctl,
  unsigned int index);
...
static inline struct tegra_xusb_ulpi_port *to_ulpi_port(
    struct tegra_xusb_port *port) {
...
static inline struct tegra_xusb_hsic_port *to_hsic_port(
    struct tegra_xusb_port *port) {
...
static inline struct tegra_xusb_usb3_port *to_usb3_port(
    struct tegra_xusb_port *port) {
  return container_of(port, struct tegra_xusb_usb3_port, base);
}

struct tegra_xusb_usb3_port *tegra_xusb_find_usb3_port(
  struct tegra_xusb_padctl *padctl,
  unsigned int index);
