...
static void u3_phy_instance_init(struct mtk_tphy *tphy,
  ...
  mtk_phy_update_field(phyd + U3P_U3_PHYD_RXDET2, P3D_RG_RXDET_STB2_SET_P3,
      0x10);
...
static void pcie_phy_instance_init(struct mtk_tphy *tphy,
  ...
  /* SSC delta -5000ppm */
  mtk_phy_update_field(phya + U3P_U3_PHYA_DA_REG20, P3A_RG_PLL_DELTA1_PE2H,
      0x3c);
  mtk_phy_update_field(phya + U3P_U3_PHYA_DA_REG25, P3A_RG_PLL_DELTA_PE2H,
      0x36);
  /* change pll BW 0.6M */
...
static void sata_phy_instance_init(struct mtk_tphy *tphy,
  ...
  mtk_phy_update_field(phyd + ANA_EQ_EYE_CTRL_SIGNAL4, RG_CDR_BIRLTD0_GEN1_MSK,
      0x18);
  mtk_phy_update_field(phyd + ANA_EQ_EYE_CTRL_SIGNAL5, RG_CDR_BIRLTD0_GEN3_MSK,
      0x06);
...
static void phy_parse_property(struct mtk_tphy *tphy,
  ...
  if (instance->type == PHY_TYPE_USB3) {
    instance->type_force_mode = device_property_read_bool(dev,
        "mediatek,force-mode");
  }
...
static int phy_efuse_get(struct mtk_tphy *tphy,
    struct mtk_phy_instance *instance) {
  struct device *dev = &instance->phy->dev;
  int ret = 0;
