...
#define SB_REG(n)     HDTPX_REG(n, 0100, 012 9)
#define LNTOP_REG(n)      HDTPX_REG(n, 0200, 022 9)
...
static const struct reg_sequence rk_hdtpx_common_cmn_init_seq[] = {
  ...
  REG_SEQ0(CMN_REG(001 8), 0x04),
  REG_SEQ0(CMN_REG(001 9), 0x48),
  ...
  REG_SEQ0(CMN_REG(003 8), 0x00),
  REG_SEQ0(CMN_REG(003 9), 0x00),
  ...
  REG_SEQ0(CMN_REG(004 8), 0x44),
  REG_SEQ0(CMN_REG(004 9), 0xfa),
  ...
  REG_SEQ0(CMN_REG(007 8), 0x0c),
  REG_SEQ0(CMN_REG(007 9), 0x00),
  ...
  REG_SEQ0(CMN_REG(00 80), 0x00),
  REG_SEQ0(CMN_REG(00 81), 0x09),
  REG_SEQ0(CMN_REG(00 82), 0x04),
  REG_SEQ0(CMN_REG(00 83), 0x24),
  REG_SEQ0(CMN_REG(00 84), 0x20),
  REG_SEQ0(CMN_REG(00 85), 0x03),
  REG_SEQ0(CMN_REG(00 86), 0x01),
  REG_SEQ0(CMN_REG(00 87), 0x0c),
  REG_SEQ0(CMN_REG(00 8a), 0x55),
  REG_SEQ0(CMN_REG(00 8b), 0x25),
  REG_SEQ0(CMN_REG(00 8c), 0x2c),
  REG_SEQ0(CMN_REG(00 8d), 0x22),
  REG_SEQ0(CMN_REG(00 8e), 0x14),
  REG_SEQ0(CMN_REG(00 8f), 0x20),
  REG_SEQ0(CMN_REG(00 90), 0x00),
  REG_SEQ0(CMN_REG(00 91), 0x00),
  REG_SEQ0(CMN_REG(00 92), 0x00),
  REG_SEQ0(CMN_REG(00 93), 0x00),
  REG_SEQ0(CMN_REG(00 9a), 0x11),
  REG_SEQ0(CMN_REG(00 9b), 0x10),
};

static const struct reg_sequence rk_hdtpx_tmds_cmn_init_seq[] = {
  REG_SEQ0(CMN_REG(000 8), 0x00),
  ...
  REG_SEQ0(CMN_REG(00 81), 0x01),
  REG_SEQ0(CMN_REG(00 87), 0x04),
  REG_SEQ0(CMN_REG(00 89), 0x00),
  REG_SEQ0(CMN_REG(00 95), 0x00),
  REG_SEQ0(CMN_REG(00 97), 0x02),
  REG_SEQ0(CMN_REG(00 99), 0x04),
  REG_SEQ0(CMN_REG(00 9b), 0x00),
};
...
static int rk_hdptx_ropll_tmds_cmn_config(struct rk_hdptx_phy *hdptx,
  ...
  regmap_write(hdptx->regmap, CMN_REG(005 9),
  ...
  regmap_update_bits(hdptx->regmap, CMN_REG(006 9), ROPLL_SDC_N_RBR_MASK,
  ...
  regmap_update_bits(hdptx->regmap, CMN_REG(00 86), PLL_PCG_POSTDIV_SEL_MASK,
      FIELD_PREP(PLL_PCG_POSTDIV_SEL_MASK, cfg->pms_sdiv));
  regmap_update_bits(hdptx->regmap, CMN_REG(00 86), PLL_PCG_CLK_EN,
      PLL_PCG_CLK_EN);
