...
static int mvebu_a3700_comphy_set_phy_selector(
...
static int mvebu_a3700_comphy_sata_power_on(
    struct mvebu_a3700_comphy_lane *lane) {
...
static int mvebu_a3700_comphy_ethernet_power_on(
    struct mvebu_a3700_comphy_lane *lane) {
...
static int mvebu_a3700_comphy_usb3_power_on(
    struct mvebu_a3700_comphy_lane *lane) {
...
static int mvebu_a3700_comphy_pcie_power_on(
    struct mvebu_a3700_comphy_lane *lane) {
  u32 mask, data, ref_clk;
  int ret;
...
static void mvebu_a3700_comphy_sata_power_off(
    struct mvebu_a3700_comphy_lane *lane) {
...
static void mvebu_a3700_comphy_ethernet_power_off(
    struct mvebu_a3700_comphy_lane *lane) {
  u32 mask, data;
...
static void mvebu_a3700_comphy_pcie_power_off(
    struct mvebu_a3700_comphy_lane *lane) {
  /* Power off PLL, Tx, Rx */
  comphy_lane_reg_set(lane, COMPHY_POWER_PLL_CTRL,
      0x0, PU_PLL_BIT | PU_RX_BIT | PU_TX_BIT);
...
static void mvebu_a3700_comphy_usb3_power_off(
    struct mvebu_a3700_comphy_lane *lane) {
  /*
