 ...
 * the hardware.
 */
static void r8a779f0_eth_serdes_write32(void __iomem *addr, u32 offs, u32 bank,
    u32 data) {
  iowrite32(bank, addr + R8A779F0_ETH_SERDES_BANK_SELECT);
  iowrite32(data, addr + offs);
}

static int r8a779f0_eth_serdes_reg_wait(
...
static int r8a779f0_eth_serdes_common_init_ram(
    struct r8a779f0_eth_serdes_drv_data *dd) {
  struct r8a779f0_eth_serdes_channel *channel;
  int i, ret;
...
static int r8a779f0_eth_serdes_common_setting(
    struct r8a779f0_eth_serdes_channel *channel) {
...
static int r8a779f0_eth_serdes_chan_setting(
    struct r8a779f0_eth_serdes_channel *channel) {
  int ret;
  switch (channel->phy_interface) {
    case PHY_INTERFACE_MODE_SGMII:
...
static int r8a779f0_eth_serdes_chan_speed(
    struct r8a779f0_eth_serdes_channel *channel) {
  int ret;
  switch (channel->phy_interface) {
    case PHY_INTERFACE_MODE_SGMII:
...
static int r8a779f0_eth_serdes_monitor_linkup(
    struct r8a779f0_eth_serdes_channel *channel) {
  int i, ret;
...
static int r8a779f0_eth_serdes_hw_init(
    struct r8a779f0_eth_serdes_channel *channel) {
  struct r8a779f0_eth_serdes_drv_data *dd = channel->dd;
  int i, ret;
  if (dd->initialized) {
  ...
  return r8a779f0_eth_serdes_reg_wait(&dd->channel[0], 0x0000, 0x380, BIT(15),
      0);
}
