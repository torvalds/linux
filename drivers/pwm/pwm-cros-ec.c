...
static inline struct cros_ec_pwm_device *pwm_to_cros_ec_pwm(
...
static int cros_ec_pwm_get_duty(struct cros_ec_device *ec, bool use_pwm_type,
    u8 index) {
  struct {
    struct cros_ec_command msg;
    union {
...
static struct pwm_device *cros_ec_pwm_xlate(struct pwm_chip *chip,
