...
static void ssb_pmu0_pllinit_r0(struct ssb_chipcommon *cc,
  ...
  if (((pmuctl & SSB_CHIPCO_PMU_CTL_XTALFREQ) >>
      SSB_CHIPCO_PMU_CTL_XTALFREQ_SHIFT) == e->xf) {
    /* We're already there... */
    return;
  }
  ...
  pllctl
    |= ((u32) e->wb_int <<
      SSB_PMU0_PLLCTL1_WILD_IMSK_SHIFT) & SSB_PMU0_PLLCTL1_WILD_IMSK;
  pllctl
    |= ((u32) e->wb_frac <<
      SSB_PMU0_PLLCTL1_WILD_FMSK_SHIFT) & SSB_PMU0_PLLCTL1_WILD_FMSK;
  if (e->wb_frac == 0) {
    pllctl |= SSB_PMU0_PLLCTL1_STOPMOD;
  }
  ...
  pllctl
    |= (((u32) e->wb_int >> 4) <<
      SSB_PMU0_PLLCTL2_WILD_IMSKHI_SHIFT) & SSB_PMU0_PLLCTL2_WILD_IMSKHI;
  ...
  pmuctl
    |= ((u32) e->xf <<
      SSB_CHIPCO_PMU_CTL_XTALFREQ_SHIFT) & SSB_CHIPCO_PMU_CTL_XTALFREQ;
...
static const struct pmu1_plltab_entry pmu1_plltab[] = {
  { .freq = 12000, .xf = 1, .p1div = 3, .p2div = 22, .ndiv_int = 0x9,
    .ndiv_frac = 0xFFFFEF, },
  { .freq = 13000, .xf = 2, .p1div = 1, .p2div = 6, .ndiv_int = 0xb,
    .ndiv_frac = 0x483483, },
  { .freq = 14400, .xf = 3, .p1div = 1, .p2div = 10, .ndiv_int = 0xa,
    .ndiv_frac = 0x1C71C7, },
  { .freq = 15360, .xf = 4, .p1div = 1, .p2div = 5, .ndiv_int = 0xb,
    .ndiv_frac = 0x755555, },
  { .freq = 16200, .xf = 5, .p1div = 1, .p2div = 10, .ndiv_int = 0x5,
    .ndiv_frac = 0x6E9E06, },
  { .freq = 16800, .xf = 6, .p1div = 1, .p2div = 10, .ndiv_int = 0x5,
    .ndiv_frac = 0x3CF3CF, },
  { .freq = 19200, .xf = 7, .p1div = 1, .p2div = 9, .ndiv_int = 0x5,
    .ndiv_frac = 0x17B425, },
  { .freq = 19800, .xf = 8, .p1div = 1, .p2div = 11, .ndiv_int = 0x4,
    .ndiv_frac = 0xA57EB, },
  { .freq = 20000, .xf = 9, .p1div = 1, .p2div = 11, .ndiv_int = 0x4,
    .ndiv_frac = 0, },
  { .freq = 24000, .xf = 10, .p1div = 3, .p2div = 11, .ndiv_int = 0xa,
    .ndiv_frac = 0, },
  { .freq = 25000, .xf = 11, .p1div = 5, .p2div = 16, .ndiv_int = 0xb,
    .ndiv_frac = 0, },
  { .freq = 26000, .xf = 12, .p1div = 1, .p2div = 2, .ndiv_int = 0x10,
    .ndiv_frac = 0xEC4EC4, },
  { .freq = 30000, .xf = 13, .p1div = 3, .p2div = 8, .ndiv_int = 0xb,
    .ndiv_frac = 0, },
  { .freq = 38400, .xf = 14, .p1div = 1, .p2div = 5, .ndiv_int = 0x4,
    .ndiv_frac = 0x955555, },
  { .freq = 40000, .xf = 15, .p1div = 1, .p2div = 2, .ndiv_int = 0xb,
    .ndiv_frac = 0, },
};
...
static void ssb_pmu1_pllinit_r0(struct ssb_chipcommon *cc,
  ...
  pllctl
    |= ((u32) e->p1div <<
      SSB_PMU1_PLLCTL0_P1DIV_SHIFT) & SSB_PMU1_PLLCTL0_P1DIV;
  pllctl
    |= ((u32) e->p2div <<
      SSB_PMU1_PLLCTL0_P2DIV_SHIFT) & SSB_PMU1_PLLCTL0_P2DIV;
  ...
  pllctl
    |= ((u32) e->ndiv_frac <<
      SSB_PMU1_PLLCTL3_NDIVFRAC_SHIFT) & SSB_PMU1_PLLCTL3_NDIVFRAC;
  ...
  if (buffer_strength) {
    ...
    pllctl
      |= (buffer_strength <<
        SSB_PMU1_PLLCTL5_CLKDRV_SHIFT) & SSB_PMU1_PLLCTL5_CLKDRV;
  ...
  pmuctl
    |= ((((u32) e->freq + 127) / 128 - 1) << SSB_CHIPCO_PMU_CTL_ILP_DIV_SHIFT)
      & SSB_CHIPCO_PMU_CTL_ILP_DIV;
  pmuctl
    |= ((u32) e->xf <<
      SSB_CHIPCO_PMU_CTL_XTALFREQ_SHIFT) & SSB_CHIPCO_PMU_CTL_XTALFREQ;
...
void ssb_pmu_set_ldo_paref(struct ssb_chipcommon *cc, bool on) {
  ...
  chipco_read32(cc, SSB_CHIPCO_PMU_MINRES_MSK); //SPEC FIXME found via mmiotrace
                                                // - dummy read?
}
