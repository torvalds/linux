...
static void dummy_send_response(struct fw_card *card,
...
/**
 * fw_card_read_cycle_time: read from Isochronous Cycle Timer Register of 1394
 * OHCI in MMIO region
 *          for controller card.
 * @card: The instance of card for 1394 OHCI controller.
 * @cycle_time: The mutual reference to value of cycle time for the read
 * operation.
 *
 * Read value from Isochronous Cycle Timer Register of 1394 OHCI in MMIO region
 * for the given
 * controller card. This function accesses the region without any lock
 * primitives or IRQ mask.
 * When returning successfully, the content of @value argument has value aligned
 * to host endianness,
...
int fw_card_read_cycle_time(struct fw_card *card, u32 *cycle_time) {
  ...
  // It's possible to switch to dummy driver between the above and the below.
  // This is the best
