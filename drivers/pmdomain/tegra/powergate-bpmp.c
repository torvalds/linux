...
static inline struct tegra_powergate *to_tegra_powergate(
    struct generic_pm_domain *genpd) {
...
static struct tegra_powergate *tegra_powergate_add(struct tegra_bpmp *bpmp,
...
static int tegra_bpmp_probe_powergates(struct tegra_bpmp *bpmp,
...
static struct generic_pm_domain *tegra_powergate_xlate(
