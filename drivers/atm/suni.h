...
#define SUNI_TSOP_DIAG		0x15	/* TSOP Diagyesstic */
			     /* 0x16-0x17 reserved */
...
#define SUNI_TLOP_DIAG		0x21	/* TLOP Diagyesstic */
			     /* 0x22-0x27 reserved */
...
#define SUNI_RPOP_RC		0x3D	/* RPOP Ring Control (PM5355) */
			     /* 0x3E-0x3F reserved */
#define SUNI_TPOP_CD		0x40	/* TPOP Control/Diagyesstic */
...
#define SUNI_MCM_DLE		0x10	/* diagyesstic loopback (PM5355) */

/* MCT is reg 5 */
#define SUNI_MCT_LOOPT		0x01	/* RW, timing source, 0: from
					   TRCLK+/- */
#define SUNI_MCT_DLE		0x02	/* RW, diagyesstic loopback */
...
#define SUNI_TACP_CS_HCAADD	0x04	/* RW, add coset polyyesmial to HCS */
