...
MODULE_DESCRIPTION(
    "ATM NIC driver for IDT 77201/77211 \"NICStAR\" and Fore ForeRunnerLE.");
MODULE_LICENSE("GPL");
...
static int ns_init_card(int i, struct pci_dev *pcidev) {
  ...
  writel(NS_CMD_WRITE_UTILITY | 0x00000100, card->membase + CMD); /* Sync UTOPIA
                                                                   * with SAR
                                                                   * clock */
  NS_DELAY;
  /* Detect PHY type */
...
#error NS_MAX_RCTSIZE must be either 4096 or 16384 in nicstar.c
  ...
  ns_write_sram(card, NS_VRSCD2, u32d, 4);  /* but are initialized, just in
                                             * case... */
  ...
  writel(NS_CFG_RXPATH | NS_CFG_SMBUFSIZE | NS_CFG_LGBUFSIZE | NS_CFG_EFBIE | NS_CFG_RSQSIZE | NS_CFG_VPIBITS | ns_cfg_rctsize | NS_CFG_RXINT_NODELAY | NS_CFG_RAWIE    /*
                                                                                                                                                                         ...
                                                                                                                                                                         *
                                                                                                                                                                         **/
      | NS_CFG_RSQAFIE | NS_CFG_TXEN | NS_CFG_TXIE | NS_CFG_TSQFIE_OPT   /* Only
                                                                          * enabled
                                                                          * if
                                                                          * ENABLE_TSQFIE
                                                                          * */
