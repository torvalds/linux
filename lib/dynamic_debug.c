...
static struct ddebug_class_map *ddebug_find_valid_class(
    struct ddebug_table const *dt,
...
static int param_set_dyndbg_classnames(const char *instr,
...
static const char *ddebug_class_name(struct ddebug_iter *iter,
    struct _ddebug *dp) {
  struct ddebug_class_map *map;
