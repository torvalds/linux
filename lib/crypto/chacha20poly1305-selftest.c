 ...
 */
static void __init chacha20poly1305_encrypt_bignonce(u8 *dst, const u8 *src,
...
static void __init chacha20poly1305_selftest_encrypt(u8 *dst, const u8 *src,
    const size_t src_len,
    const u8 *ad, const size_t ad_len,
...
bool __init chacha20poly1305_selftest(void) {
  ...
  for (total_len = POLY1305_DIGEST_SIZE;
