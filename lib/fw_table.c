...
static unsigned long __init_or_fwtbl_lib acpi_get_entry_type(
...
static unsigned long __init_or_fwtbl_lib acpi_get_entry_length(
    struct acpi_subtable_entry *entry) {
  switch (entry->type) {
    case ACPI_SUBTABLE_COMMON:
...
static unsigned long __init_or_fwtbl_lib acpi_get_subtable_header_length(
    struct acpi_subtable_entry *entry) {
  switch (entry->type) {
    case ACPI_SUBTABLE_COMMON:
...
static enum acpi_subtable_type __init_or_fwtbl_lib acpi_get_subtable_type(
    char *id) {
...
static unsigned long __init_or_fwtbl_lib acpi_table_get_length(
    enum acpi_subtable_type type,
 ...
 */
int __init_or_fwtbl_lib acpi_parse_entries_array(char *id,
...
int __init_or_fwtbl_lib cdat_table_parse(enum acpi_cdat_type type,
