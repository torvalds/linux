...
static void __init mtree_erase_index(struct maple_tree *mt,
    unsigned long index) {
...
static void __init *mtree_test_load(struct maple_tree *mt,
    unsigned long index) {
  return mtree_load(mt, index);
}

static void __init *mtree_test_erase(struct maple_tree *mt,
    unsigned long index) {
...
static noinline void __init next_prev_test(struct maple_tree *mt) {
  ...
  static const unsigned long level2_64[] = {
    707, 1000, 710, 715, 720,
    725
  };
  static const unsigned long level2_32[] = {
    1747, 2000, 1750, 1755,
    1760, 1765
  };
