...
static inline unsigned long get_slot_offset(
    const struct radix_tree_node *parent, void __rcu **slot) {
 ...
 */
static __always_inline unsigned long radix_tree_find_next_bit(
 ...
 */
static struct radix_tree_node *radix_tree_node_alloc(gfp_t gfp_mask,
