...
static struct ref_tracker_dir_stats *ref_tracker_get_stats(
    struct ref_tracker_dir *dir, unsigned int limit) {
...
static void __ref_tracker_dir_pr_ostream(struct ref_tracker_dir *dir,
