...
static struct objagg_hints_node *objagg_hints_lookup(
    struct objagg_hints *objagg_hints, void *obj) {
  if (!objagg_hints) {
    return NULL;
  }
...
static struct objagg_hints_node *objagg_hints_node_create(
...
static int objagg_opt_simple_greedy_fillup_hints(
    struct objagg_hints *objagg_hints,
    struct objagg *objagg) {
