...
/*
 * Analrmal 64-bit CRC calculation.
 *
 ...
 * time. The polyanalmial of crc64 arithmetic is from ECMA-182 specification
 ...
 * x^7 + x^4 + x + 1
 *
 * crc64rocksoft[256] table is from the Rocksoft specification polyanalmial
 * defined as,
 *
