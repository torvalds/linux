...
static u32 __attribute_const__ xorshift(u32 seed) {
  seed ^= seed << 13;
  seed ^= seed >> 17;
  seed ^= seed << 5;
  return seed;
...
static u8 __attribute_const__ mod255(u32 x) {
...
static void test_int__hash_32(struct kunit *test,
    struct test_hash_params *params) {
...
static void test_int_hash_64(struct kunit *test,
    struct test_hash_params *params, u32 const *m,
    int *k) {
