...
static int64_t hist_entry__cmp_delta_idx(
...
static int64_t hist_entry__cmp_delta_abs_idx(
    struct perf_hpp_fmt *fmt __maybe_unused,
    struct hist_entry *left, struct hist_entry *right) {
...
static int64_t hist_entry__cmp_ratio_idx(
    struct perf_hpp_fmt *fmt __maybe_unused,
    struct hist_entry *left, struct hist_entry *right) {
...
static int64_t hist_entry__cmp_wdiff_idx(
    struct perf_hpp_fmt *fmt __maybe_unused,
    struct hist_entry *left, struct hist_entry *right) {
...
static void hpp__entry_unpair(struct hist_entry *he, int idx, char *buf,
    size_t size) {
  switch (idx) {
...
static void hpp__entry_pair(struct hist_entry *he, struct hist_entry *pair,
