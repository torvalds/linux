...
/*
 * dlfilter-test-api-v0.c: test original (v0) API for perf --dlfilter shared
 * object
...
struct perf_dlfilter_fns {
   ...
   */
  __s32 (*resolve_address)(void *ctx, __u64 address,
      struct perf_dlfilter_al *al);
...
static int check_sample(struct filter_data *d,
...
static int check_address_al(void *ctx,
    const struct perf_dlfilter_sample *sample) {
...
static int check_object_code(void *ctx,
    const struct perf_dlfilter_sample *sample) {
  __u8 buf[15];
...
static int do_checks(void *data, const struct perf_dlfilter_sample *sample,
    void *ctx, bool early) {
