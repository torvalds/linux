...
NO_TAIL_CALL_ATTRIBUTE noinline int test_dwarf_unwind__krava_3(
    struct thread *thread) {
  struct thread *array[2] = {
    thread, thread
  };
  void *fp = &bsearch;
  /*
...
NO_TAIL_CALL_ATTRIBUTE noinline int test_dwarf_unwind__krava_2(
    struct thread *thread) {
  int ret;
...
NO_TAIL_CALL_ATTRIBUTE noinline int test_dwarf_unwind__krava_1(
    struct thread *thread) {
  int ret;
