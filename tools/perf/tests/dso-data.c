...
static int test__dso_data(struct test_suite *test __maybe_unused,
...
static int test__dso_data_cache(struct test_suite *test __maybe_unused,
    int subtest __maybe_unused) {
  struct machine machine;
...
static int test__dso_data_reopen(struct test_suite *test __maybe_unused,
    int subtest __maybe_unused) {
  struct machine machine;
