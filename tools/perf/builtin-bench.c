...
static const struct option bench_options[] = {
  OPT_STRING('f', "format", &bench_format_str, "default|simple",
      "Specify the output formatting style"),
  OPT_UINTEGER('r', "repeat", &bench_repeat,
 ...
 */
static int run_bench(const char *coll_name, const char *bench_name,
    bench_fn_t fn,
