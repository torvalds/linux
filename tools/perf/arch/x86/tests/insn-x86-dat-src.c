...
int main(void) {
  ...
  asm volatile ("callq *0x12345678(%rax,%rcx,8)");   /* Expecting: call indirect
                                                      * 0 */
  asm volatile ("callq *0x12345678(%r8,%rcx,8)");    /* Expecting: call indirect
                                                      * 0 */
  ...
  asm volatile ("bnd callq *0x12345678(%rax,%rcx,8)"); /* Expecting: call
                                                        * indirect 0 */
  asm volatile ("bnd callq *0x12345678(%r8,%rcx,8)");  /* Expecting: call
                                                        * indirect 0 */
  ...
  asm volatile ("notrack callq *(0x12345678)");    /* Expecting: call indirect 0
                                                    * */
  asm volatile ("notrack callq *0x12345678(%rax,%rcx,8)"); /* Expecting: call
                                                            * indirect 0 */
  asm volatile ("notrack callq *0x12345678(%r8,%rcx,8)");  /* Expecting: call
                                                            * indirect 0 */
  asm volatile ("notrack bnd callq *%rax");    /* Expecting: call indirect 0 */
  asm volatile ("notrack bnd callq *(%rax)");    /* Expecting: call indirect 0
                                                  * */
  asm volatile ("notrack bnd callq *(%r8)");   /* Expecting: call indirect 0 */
  asm volatile ("notrack bnd callq *(0x12345678)");  /* Expecting: call indirect
                                                      * 0 */
  asm volatile ("notrack bnd callq *0x12345678(%rax,%rcx,8)"); /* Expecting:
                                                                * call indirect
                                                                * 0 */
  asm volatile ("notrack bnd callq *0x12345678(%r8,%rcx,8)");  /* Expecting:
                                                                * call indirect
                                                                * 0 */
  ...
  asm volatile ("jmpq *0x12345678(%rax,%rcx,8)");    /* Expecting: jmp indirect
                                                      * 0 */
  ...
  asm volatile ("bnd jmpq *0x12345678(%rax,%rcx,8)");  /* Expecting: jmp
                                                        * indirect 0 */
  asm volatile ("bnd jmpq *0x12345678(%r8,%rcx,8)"); /* Expecting: jmp indirect
                                                      * 0 */
  ...
  asm volatile ("notrack jmpq *0x12345678(%rax,%rcx,8)");  /* Expecting: jmp
                                                            * indirect 0 */
  asm volatile ("notrack jmpq *0x12345678(%r8,%rcx,8)"); /* Expecting: jmp
                                                          * indirect 0 */
  asm volatile ("notrack bnd jmpq *%rax");     /* Expecting: jmp indirect 0 */
  asm volatile ("notrack bnd jmpq *(%rax)");   /* Expecting: jmp indirect 0 */
  asm volatile ("notrack bnd jmpq *(%r8)");    /* Expecting: jmp indirect 0 */
  asm volatile ("notrack bnd jmpq *(0x12345678)");   /* Expecting: jmp indirect
                                                      * 0 */
  asm volatile ("notrack bnd jmpq *0x12345678(%rax,%rcx,8)");  /* Expecting: jmp
                                                                * indirect 0 */
  asm volatile ("notrack bnd jmpq *0x12345678(%r8,%rcx,8)"); /* Expecting: jmp
                                                              * indirect 0 */
  /* AMX */
  ...
  asm volatile ("call *0x12345678(%eax,%ecx,8)");    /* Expecting: call indirect
                                                      * 0 */
  asm volatile ("bnd call *%eax");       /* Expecting: call indirect 0 */
  asm volatile ("bnd call *(%eax)");     /* Expecting: call indirect 0 */
  asm volatile ("bnd call *(0x12345678)");     /* Expecting: call indirect 0 */
  asm volatile ("bnd call *0x12345678(%eax,%ecx,8)");  /* Expecting: call
                                                        * indirect 0 */
  asm volatile ("notrack call *%eax");     /* Expecting: call indirect 0 */
  asm volatile ("notrack call *(%eax)");     /* Expecting: call indirect 0 */
  asm volatile ("notrack call *(0x12345678)");   /* Expecting: call indirect 0
                                                  * */
  asm volatile ("notrack call *0x12345678(%eax,%ecx,8)");  /* Expecting: call
                                                            * indirect 0 */
  asm volatile ("notrack bnd call *%eax");     /* Expecting: call indirect 0 */
  asm volatile ("notrack bnd call *(%eax)");   /* Expecting: call indirect 0 */
  asm volatile ("notrack bnd call *(0x12345678)");   /* Expecting: call indirect
                                                      * 0 */
  asm volatile ("notrack bnd call *0x12345678(%eax,%ecx,8)"); /* Expecting: call
                                                               * indirect 0 */
  /* jmp with/without notrack prefix */
  ...
  asm volatile ("bnd jmp *0x12345678(%eax,%ecx,8)"); /* Expecting: jmp indirect
                                                      * 0 */
  asm volatile ("notrack jmp *%eax");      /* Expecting: jmp indirect 0 */
  asm volatile ("notrack jmp *(%eax)");      /* Expecting: jmp indirect 0 */
  asm volatile ("notrack jmp *(0x12345678)");    /* Expecting: jmp indirect 0 */
  asm volatile ("notrack jmp *0x12345678(%eax,%ecx,8)"); /* Expecting: jmp
                                                          * indirect 0 */
  asm volatile ("notrack bnd jmp *%eax");      /* Expecting: jmp indirect 0 */
  asm volatile ("notrack bnd jmp *(%eax)");    /* Expecting: jmp indirect 0 */
  asm volatile ("notrack bnd jmp *(0x12345678)");    /* Expecting: jmp indirect
                                                      * 0 */
  asm volatile ("notrack bnd jmp *0x12345678(%eax,%ecx,8)"); /* Expecting: jmp
                                                              * indirect 0 */
  /* AVX512-FP16 */
  asm volatile ("vaddph %zmm3, %zmm2, %zmm1");
  asm volatile ("vaddph 0x12345678(%eax,%ecx,8), %zmm2, %zmm1");
