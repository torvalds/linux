...
static size_t move_mount__scnprintf_flags(unsigned long flags, char *bf,
...
#include "trace/beauty/generated/move_mount_flags_array.c"
  ...
  return strarray__scnprintf_flags(&strarray__move_mount_flags, bf, size,
      show_prefix, flags);
}

size_t syscall_arg__scnprintf_move_mount_flags(char *bf, size_t size,
