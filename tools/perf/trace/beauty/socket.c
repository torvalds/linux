...
static size_t socket__scnprintf_ipproto(int protocol, char *bf, size_t size,
  ...
  return strarray__scnprintf(&strarray__socket_ipproto, bf, size, "%d",
      show_prefix, protocol);
}
...
static size_t socket__scnprintf_level(int level, char *bf, size_t size,
    bool show_prefix) {
  ...
  return strarray__scnprintf(&strarray__socket_level, bf, size, "%d",
      show_prefix, level);
}
