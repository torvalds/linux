...
/*
 * Support for s390 CPU measurement counter set diagyesstic facility
 *
...
#define	S390_CPUMCF_DIAG_DEF	0xfeef	/* Counter diagyesstic entry ID */
...
#define	CPUMF_CTR_SET_MT_DIAG	4	/* MT-diagyesstic Counter Set */
#endif
