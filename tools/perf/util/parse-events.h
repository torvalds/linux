...
int parse_events_option_new_evlist(const struct option *opt, const char *str,
    int unset);
...
static inline int parse_events(struct evlist *evlist, const char *str,
  ...
  return __parse_events(evlist, str, /*pmu_filter=*/ NULL, err,
      /*fake_pmu=*/ NULL,
...
int parse_events_terms(struct parse_events_terms *terms, const char *str,
    FILE *input);
int parse_events_terms__to_strbuf(const struct parse_events_terms *terms,
    struct strbuf *sb);
