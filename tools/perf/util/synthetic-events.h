...
int perf_event__synthesize_attr(struct perf_tool *tool,
    ...
    perf_event__handler_t process);
int perf_event__synthesize_build_id(struct perf_tool *tool, struct dso *pos,
    u16 misc, perf_event__handler_t process,
    struct machine *machine);
int perf_event__synthesize_cpu_map(struct perf_tool *tool,
    const struct perf_cpu_map *cpus,
    perf_event__handler_t process,
    struct machine *machine);
...
int perf_event__synthesize_id_index(struct perf_tool *tool,
    ...
    struct evlist *evlist,
    struct machine *machine);
int __perf_event__synthesize_id_index(struct perf_tool *tool,
    perf_event__handler_t process,
    struct evlist *evlist,
    struct machine *machine, size_t from);
int perf_event__synthesize_id_sample(__u64 *array, u64 type,
...
int perf_event__synthesize_stat_events(struct perf_stat_config *config,
    ...
    perf_event__handler_t process,
    bool attrs);
int perf_event__synthesize_stat_round(struct perf_tool *tool, u64 time,
    u64 type, perf_event__handler_t process,
    struct machine *machine);
int perf_event__synthesize_stat(struct perf_tool *tool, struct perf_cpu cpu,
    u32 thread, u64 id,
...
int perf_event__synthesize_thread_map(struct perf_tool *tool,
    struct perf_thread_map *threads,
    perf_event__handler_t process,
    struct machine *machine, bool needs_mmap,
    bool mmap_data);
...
static inline int perf_event__synthesize_auxtrace_info(
