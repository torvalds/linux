 ...
 */
int die_walk_lines(Dwarf_Die *rt_die, line_walk_callback_t callback,
    void *data);
...
static inline Dwarf_Die *die_find_variable_by_reg(
    Dwarf_Die *sc_die __maybe_unused,
...
static inline Dwarf_Die *die_find_variable_by_addr(
    Dwarf_Die *sc_die __maybe_unused,
    Dwarf_Addr pc __maybe_unused,
...
static inline int die_get_cfa(Dwarf *dwarf __maybe_unused,
    u64 pc __maybe_unused,
