...
static int write_buildid(const char *name, size_t name_len,
    struct build_id *bid,
...
int build_id_cache__add(const char *sbuild_id, const char *name,
    const char *realname,
...
static int machines__for_each_dso(struct machines *machines, machine__dso_t fn,
    void *priv) {
