...
static int perf_mmap__aio_bind(struct mmap *map, int idx, struct perf_cpu cpu,
    int affinity) {
  void *data;
  size_t mmap_len;
...
static int perf_mmap__aio_bind(struct mmap *map __maybe_unused,
    int idx __maybe_unused,
...
static int perf_mmap__setup_affinity_mask(struct mmap *map,
...
int perf_mmap__push(struct mmap *md, void *to,
  ...
  if ((md->core.start & md->core.mask) + size
      != (md->core.end & md->core.mask)) {
