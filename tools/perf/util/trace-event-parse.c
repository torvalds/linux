...
static struct tep_print_arg_field *find_arg_field(
    struct tep_format_field *prev_state_field, struct tep_print_arg *arg) {
...
static struct tep_print_flag_sym *test_flags(
    struct tep_format_field *prev_state_field, struct tep_print_arg *arg) {
  struct tep_print_arg_field *field;
...
static struct tep_print_flag_sym *search_op(
    struct tep_format_field *prev_state_field, struct tep_print_arg *arg) {
...
int parse_ftrace_file(struct tep_handle *pevent, char *buf,
    unsigned long size) {
