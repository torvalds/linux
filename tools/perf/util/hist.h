...
static inline int res_sample_browse(
    struct res_sample *res_samples __maybe_unused,
...
struct option;
int parse_filter_percentage(const struct option *opt, const char *arg,
    int unset);
...
static inline int hists__scnprintf_title(struct hists *hists, char *bf,
    size_t size) {
