...
static inline struct rw_semaphore *thread__namespaces_lock(
    struct thread *thread) {
...
static inline void thread__set_ts(struct thread *thread,
    struct thread_stack *ts) {
...
static inline void thread__set_filter_entry_depth(struct thread *thread,
    int depth) {
...
static inline void thread__set_lbr_stitch_enable(struct thread *thread,
    bool en) {
...
static inline void thread__set_lbr_stitch(struct thread *thread,
    struct lbr_stitch *lbrs) {
