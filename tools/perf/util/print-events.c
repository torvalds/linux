...
void print_tracepoint_events(
  ...
  for (int i = 0; i < sys_items; i++) {
    ...
    evt_items = scandirat(events_fd, sys_dirent->d_name, &evt_namelist, NULL,
        alphasort);
...
void print_sdt_events(const struct print_callbacks *print_cb,
    void *print_state) {
...
int print_hwcache_events(const struct print_callbacks *print_cb,
    void *print_state) {
  struct perf_pmu *pmu = NULL;
  const char *event_type_descriptor
...
void print_tool_events(const struct print_callbacks *print_cb,
    void *print_state) {
...
void print_symbol_events(const struct print_callbacks *print_cb,
    void *print_state,
