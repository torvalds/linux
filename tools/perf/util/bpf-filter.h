...
#ifdef HAVE_BPF_SKEL
struct perf_bpf_filter_expr *perf_bpf_filter_expr__new(
  unsigned long sample_flags, int part,
  enum perf_bpf_filter_op op,
  unsigned long val);
...
static inline int perf_bpf_filter__parse(
    struct list_head *expr_head __maybe_unused,
...
static inline u64 perf_bpf_filter__lost_count(
