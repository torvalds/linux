...
void arch_perf_parse_sample_weight(struct perf_sample *data, const __u64 *array,
    u64 type);
...
static inline bool perf_event_header__misc_is_guest(u16 misc) {
  return perf_event_header__cpumode_is_guest(
      misc & PERF_RECORD_MISC_CPUMODE_MASK);
}

static inline bool perf_event_header__is_guest(
