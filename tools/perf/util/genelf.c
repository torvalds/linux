...
#ifdef BUILD_ID_MD5
static void gen_build_id(struct buildid_note *note, unsigned long load_addr,
...
static int jit_add_eh_frame_info(Elf *e, void *unwinding,
 ...
 */
int jit_write_elf(int fd, uint64_t load_addr, const char *sym,
