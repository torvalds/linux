...
__my_reassemble_comp_words_by_ref()
{
	...
	for ((i=0, j=0; i < ${#COMP_WORDS[@]}; i++, j++)); do
		# Append each yesnempty word consisting of just
...
complete -o bashdefault -o default -o yesspace -F _perf perf 2>/dev/null \
	|| complete -o default -o yesspace -F _perf perf
