...
#define SET_PSTATE(x, \
      r)    __emit_inst(0xd500401f | PSTATE_ ## r | ((!!x) << PSTATE_Imm_shift))
...
.macro mrs_s, rt, sreg __emit_inst(0xd5200000 | (\ sreg) | (.L__gpr_num_ \ rt))
.endm

.macro msr_s, sreg, rt __emit_inst(0xd5000000 | (\ sreg) | (.L__gpr_num_ \ rt))
.endm
