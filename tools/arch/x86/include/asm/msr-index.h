...
#define MSR_TEST_CTRL_SPLIT_LOCK_DETECT   BIT( \
    MSR_TEST_CTRL_SPLIT_LOCK_DETECT_BIT)

#define MSR_IA32_SPEC_CTRL    0x00000048 /* Speculation Control */
#define SPEC_CTRL_IBRS      BIT(0)     /* Indirect Branch Restricted Speculation
                                        * */
#define SPEC_CTRL_STIBP_SHIFT   1    /* Single Thread Indirect Branch Predictor
                                      * (STIBP) bit */
...
#define MSR_PLATFORM_INFO_CPUID_FAULT   BIT_ULL( \
...
#define MSR_IA32_CORE_CAPS_INTEGRITY_CAPS   BIT( \
    MSR_IA32_CORE_CAPS_INTEGRITY_CAPS_BIT)
#define MSR_IA32_CORE_CAPS_SPLIT_LOCK_DETECT_BIT  5
#define MSR_IA32_CORE_CAPS_SPLIT_LOCK_DETECT    BIT( \
...
#define ARCH_CAP_SSB_NO     BIT(4)  /*
                                     * Not susceptible to Speculative Store
                                     * Bypass
...
#define ARCH_CAP_PSCHANGE_MC_NO   BIT(6)   /*
                                            * The processor is not susceptible
                                            * to a
                                            * machine check error due to
                                            * modifying the
                                            * code page size along with either
                                            * the
...
#define MSR_INTEGRITY_CAPS_ARRAY_BIST          BIT( \
    MSR_INTEGRITY_CAPS_ARRAY_BIST_BIT)
#define MSR_INTEGRITY_CAPS_PERIODIC_BIST_BIT  4
#define MSR_INTEGRITY_CAPS_PERIODIC_BIST  BIT( \
...
#define LBR_INFO_BR_CNTR_FULL_MASK  GENMASK_ULL( \
    LBR_INFO_BR_CNTR_NUM * LBR_INFO_BR_CNTR_BITS - 1, 0)
...
#define MSR_AMD64_DE_CFG_LFENCE_SERIALIZE BIT_ULL( \
...
#define MSR_IA32_MISC_ENABLE_BTS_UNAVAIL    (1ULL << \
    MSR_IA32_MISC_ENABLE_BTS_UNAVAIL_BIT)
#define MSR_IA32_MISC_ENABLE_PEBS_UNAVAIL_BIT   12
#define MSR_IA32_MISC_ENABLE_PEBS_UNAVAIL   (1ULL << \
    MSR_IA32_MISC_ENABLE_PEBS_UNAVAIL_BIT)
#define MSR_IA32_MISC_ENABLE_ENHANCED_SPEEDSTEP_BIT 16
#define MSR_IA32_MISC_ENABLE_ENHANCED_SPEEDSTEP   (1ULL << \
...
#define MSR_IA32_MISC_ENABLE_XD_DISABLE     (1ULL << \
    MSR_IA32_MISC_ENABLE_XD_DISABLE_BIT)

/* MISC_ENABLE bits: model-specific, meaning may vary from core to core */
#define MSR_IA32_MISC_ENABLE_X87_COMPAT_BIT   2
#define MSR_IA32_MISC_ENABLE_X87_COMPAT     (1ULL << \
    MSR_IA32_MISC_ENABLE_X87_COMPAT_BIT)
#define MSR_IA32_MISC_ENABLE_TM1_BIT      3
#define MSR_IA32_MISC_ENABLE_TM1      (1ULL << MSR_IA32_MISC_ENABLE_TM1_BIT)
#define MSR_IA32_MISC_ENABLE_SPLIT_LOCK_DISABLE_BIT 4
#define MSR_IA32_MISC_ENABLE_SPLIT_LOCK_DISABLE   (1ULL << \
    MSR_IA32_MISC_ENABLE_SPLIT_LOCK_DISABLE_BIT)
#define MSR_IA32_MISC_ENABLE_L3CACHE_DISABLE_BIT  6
#define MSR_IA32_MISC_ENABLE_L3CACHE_DISABLE    (1ULL << \
    MSR_IA32_MISC_ENABLE_L3CACHE_DISABLE_BIT)
#define MSR_IA32_MISC_ENABLE_SUPPRESS_LOCK_BIT    8
#define MSR_IA32_MISC_ENABLE_SUPPRESS_LOCK    (1ULL << \
    MSR_IA32_MISC_ENABLE_SUPPRESS_LOCK_BIT)
#define MSR_IA32_MISC_ENABLE_PREFETCH_DISABLE_BIT 9
#define MSR_IA32_MISC_ENABLE_PREFETCH_DISABLE   (1ULL << \
...
#define MSR_IA32_MISC_ENABLE_ADJ_PREF_DISABLE   (1ULL << \
    MSR_IA32_MISC_ENABLE_ADJ_PREF_DISABLE_BIT)
#define MSR_IA32_MISC_ENABLE_SPEEDSTEP_LOCK_BIT   20
#define MSR_IA32_MISC_ENABLE_SPEEDSTEP_LOCK   (1ULL << \
    MSR_IA32_MISC_ENABLE_SPEEDSTEP_LOCK_BIT)
#define MSR_IA32_MISC_ENABLE_L1D_CONTEXT_BIT    24
#define MSR_IA32_MISC_ENABLE_L1D_CONTEXT    (1ULL << \
    MSR_IA32_MISC_ENABLE_L1D_CONTEXT_BIT)
#define MSR_IA32_MISC_ENABLE_DCU_PREF_DISABLE_BIT 37
#define MSR_IA32_MISC_ENABLE_DCU_PREF_DISABLE   (1ULL << \
    MSR_IA32_MISC_ENABLE_DCU_PREF_DISABLE_BIT)
#define MSR_IA32_MISC_ENABLE_TURBO_DISABLE_BIT    38
#define MSR_IA32_MISC_ENABLE_TURBO_DISABLE    (1ULL << \
...
#define MSR_MISC_FEATURES_ENABLES_CPUID_FAULT   BIT_ULL( \
