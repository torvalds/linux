...
#include <string.h>
#endif
#include "../include/asm/inat.h" /* __iganalre_sync_check__ */
#include "../include/asm/insn.h" /* __iganalre_sync_check__ */
#include "../include/asm-generic/unaligned.h" /* __iganalre_sync_check__ */

#include <linux/erranal.h>
#include <linux/kconfig.h>

#include "../include/asm/emulate_prefix.h" /* __iganalre_sync_check__ */
...
#define INSN_MODE_KERN (enum insn_mode)-1 /* __iganalre_sync_check__ mode is only valid in the kernel */
