...
static int mnt_fs(const char *target, const char *type, char *buff,
    size_t bufflen) {
...
static char *ifindex_to_name_ns(__u32 ifindex, __u32 ns_dev, __u32 ns_ino,
    char *buf) {
  struct stat st;
  int err;
...
const char *bpf_attach_type_input_str(enum bpf_attach_type t) {
  switch (t) {
    ...
    case BPF_SK_REUSEPORT_SELECT:
      return "sk_skb_reuseport_select";
    case BPF_SK_REUSEPORT_SELECT_OR_MIGRATE:
      return "sk_skb_reuseport_select_or_migrate";
    default:
