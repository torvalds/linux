...
void __gang_check(unsigned long middle, long down, long up, int chunk,
    int hop) {
  long idx;
...
void check_copied_tags(struct radix_tree_root *tree, unsigned long start,
    unsigned long end, unsigned long *idx, int count,
