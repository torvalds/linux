 ...
 */
static inline int futex_wait(futex_t *uaddr, futex_t val,
 ...
 */
static inline int futex_wake(futex_t *uaddr, int nr_wake, int opflags) {
 ...
 */
static inline int futex_wait_bitset(futex_t *uaddr, futex_t val,
 ...
 */
static inline int futex_wake_bitset(futex_t *uaddr, int nr_wake,
    u_int32_t bitset, int opflags) {
 ...
 */
static inline int futex_lock_pi(futex_t *uaddr, struct timespec *timeout,
    int detect,
    int opflags) {
 ...
 */
static inline int futex_unlock_pi(futex_t *uaddr, int opflags) {
 ...
 */
static inline int futex_wake_op(futex_t *uaddr, futex_t *uaddr2, int nr_wake,
    int nr_wake2,
 ...
 */
static inline int futex_requeue(futex_t *uaddr, futex_t *uaddr2, int nr_wake,
    int nr_requeue,
    int opflags) {
 ...
 * @nr_requeue: requeue up to this many tasks
 */
static inline int futex_cmp_requeue(futex_t *uaddr, futex_t val,
    futex_t *uaddr2, int nr_wake,
 ...
 */
static inline int futex_wait_requeue_pi(futex_t *uaddr, futex_t val,
    futex_t *uaddr2,
    struct timespec *timeout, int opflags) {
 ...
 * @nr_requeue: requeue up to this many tasks
 */
static inline int futex_cmp_requeue_pi(futex_t *uaddr, futex_t val,
    futex_t *uaddr2, int nr_wake,
    int nr_requeue, int opflags) {
 ...
 */
static inline u_int32_t futex_cmpxchg(futex_t *uaddr, u_int32_t oldval,
    u_int32_t newval) {
 ...
 */
static inline u_int32_t futex_dec(futex_t *uaddr) {
 ...
 * Return the new futex value.
 */
static inline u_int32_t futex_inc(futex_t *uaddr) {
 ...
 * Return the new futex value.
 */
static inline u_int32_t futex_set(futex_t *uaddr, u_int32_t newval) {
  *uaddr = newval;
  return newval;
}
