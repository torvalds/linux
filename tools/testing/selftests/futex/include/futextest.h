...
/* Define the newer op codes if the system header file is yest up to date. */
 ...
 * @detect:	whether (1) or yest (0) to perform deadlock detection
 */
static inline int
