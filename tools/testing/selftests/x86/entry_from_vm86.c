...
static bool do_test(struct vm86plus_struct *v86, unsigned long eip,
  ...
  if (rettype == -1
    ...
    printf(
        "[FAIL]\tIncorrect return reason (started at eip = 0x%lx, ended at eip = 0x%lx)\n", eip,
        v86->regs.eip);
    nerrs++;
  }
  return true;
...
void do_umip_tests(struct vm86plus_struct *vm86, unsigned char *test_mem) {
  ...
  struct table_desc gdt1 = {
    .base = 0x3c3c3c3c, .limit = 0x9999
  };
  struct table_desc gdt2 = {
    .base = 0x1a1a1a1a, .limit = 0xaeae
  };
  struct table_desc idt1 = {
    .base = 0x7b7b7b7b, .limit = 0xf1f1
  };
  struct table_desc idt2 = {
    .base = 0x89898989, .limit = 0x1313
  };
...
int main(void) {
  ...
  v86.regs.eflags = X86_EFLAGS_VIP;
  v86.regs.eax = 0;
  do_test(&v86, vmcode_popf_hlt - vmcode, VM86_UNKNOWN, 0,
      "POPF with VIP set and IF clear");
  /* POPF with VIP set and IF set: should trap */
  v86.regs.eflags = X86_EFLAGS_VIP;
  v86.regs.eax = X86_EFLAGS_IF;
  do_test(&v86, vmcode_popf_hlt - vmcode, VM86_STI, 0,
      "POPF with VIP and IF set");
  /* POPF with VIP clear and IF set: should not trap */
  v86.regs.eflags = 0;
  v86.regs.eax = X86_EFLAGS_IF;
  do_test(&v86, vmcode_popf_hlt - vmcode, VM86_UNKNOWN, 0,
      "POPF with VIP clear and IF set");
  v86.regs.eflags = 0;
