...
if ! /sbin/modprobe -q -n usbip_host; then
	echo "usbip_test: module usbip_host is yest found [SKIP]"
	echo $test_end_msg
	exit $ksft_skip
fi
...
echo "Get exported devices from localhost - expect to see yesne";
...
echo "unbind devices - expect yes devices bound message";
src/usbip unbind -b $busid;
echo "=============================================================="
...
echo "List imported devices - expect to see yesne";
src/usbip port;
echo "=============================================================="

echo "Import devices from localhost - should fail with yes devices"
...
echo "Un-import devices - expect yes devices to detach messages";
src/usbip detach -p 00;
src/usbip detach -p 01;
echo "=============================================================="
...
echo "Should see -busid- is yest in match_busid table... skip! dmesg"
echo "=============================================================="
dmesg | grep "is yest in match_busid table"
echo "=============================================================="
