...
/*
 * RSEQ_SIG uses the trap4 instruction. As Linux does yest make use of the
 * access-register mode yesr the linkage stack this instruction will always
...
/*
 * Compare @v against @expectyest. When it does _yest_ match, load @v
