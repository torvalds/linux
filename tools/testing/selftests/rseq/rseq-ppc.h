...
#define RSEQ_LOAD_INT(arg)  "lwz%U[" __rseq_str(arg) "]%X[" __rseq_str(arg) "] "  /*
                                                                                   ...
                                                                                   *
                                                                                   **/
#define RSEQ_LOADX_LONG   "ldx "              /* From base register ("b"
                                               * constraint) */
...
#define RSEQ_STORE_LONG(arg)  "stw%U[" __rseq_str(arg) "]%X[" __rseq_str(arg) \
  "] "  /* To memory ("m" constraint) */
#define RSEQ_STORE_INT(arg) RSEQ_STORE_LONG(arg)          /* To memory ("m"
                                                           * constraint) */
#define RSEQ_LOAD_LONG(arg) "lwz%U[" __rseq_str(arg) "]%X[" __rseq_str(arg) "] "  /*
                                                                                   ...
                                                                                   *
                                                                                   **/
#define RSEQ_LOAD_INT(arg)  RSEQ_LOAD_LONG(arg)         /* From memory ("m"
                                                         * constraint) */
#define RSEQ_LOADX_LONG   "lwzx "             /* From base register ("b"
                                               * constraint) */
...
#define __RSEQ_ASM_DEFINE_TABLE(label, version, flags,        \
  ...
  ".long 0x0, " __rseq_str(start_ip) ", 0x0, " __rseq_str(post_commit_offset) \
