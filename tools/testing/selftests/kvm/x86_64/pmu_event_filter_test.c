...
#define PMU_EVENT_FILTER_INVALID_FLAGS      (KVM_PMU_EVENT_FLAGS_VALID_MASK << \
    1)
#define PMU_EVENT_FILTER_INVALID_NEVENTS    (KVM_PMU_EVENT_FILTER_MAX_EVENTS \
  + 1)
 ...
 */
kvm_static_assert(
    INTEL_ARCH_INSTRUCTIONS_RETIRED == AMD_ZEN_INSTRUCTIONS_RETIRED);
...
static void test_filter_ioctl(struct kvm_vcpu *vcpu) {
  uint8_t nr_fixed_counters = kvm_cpu_property(
