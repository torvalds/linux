...
#define nmi_stage_inc() atomic_fetch_add_explicit(&nmi_stage, 1, \
...
static void l1_guest_code(struct svm_test_data *svm, uint64_t is_nmi,
    uint64_t idt_alt) {
#define L2_GUEST_STACK_SIZE 64
  ...
  vmcb->control.event_inj = BP_VECTOR | SVM_EVTINJ_VALID
