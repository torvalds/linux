...
#define X86_FEATURE_TSCRATEMSR          KVM_X86_CPU_FEATURE(0x8000000A, 0, EDX, \
    4)
#define X86_FEATURE_PAUSEFILTER         KVM_X86_CPU_FEATURE(0x8000000A, 0, EDX, \
    10)
#define X86_FEATURE_PFTHRESHOLD         KVM_X86_CPU_FEATURE(0x8000000A, 0, EDX, \
    12)
...
#define X86_FEATURE_KVM_ASYNC_PF_VMEXIT KVM_X86_CPU_FEATURE(0x40000001, 0, EAX, \
    10)
#define X86_FEATURE_KVM_PV_SEND_IPI KVM_X86_CPU_FEATURE(0x40000001, 0, EAX, 11)
#define X86_FEATURE_KVM_POLL_CONTROL  KVM_X86_CPU_FEATURE(0x40000001, 0, EAX, \
    12)
#define X86_FEATURE_KVM_PV_SCHED_YIELD  KVM_X86_CPU_FEATURE(0x40000001, 0, EAX, \
    13)
#define X86_FEATURE_KVM_ASYNC_PF_INT  KVM_X86_CPU_FEATURE(0x40000001, 0, EAX, \
    14)
#define X86_FEATURE_KVM_MSI_EXT_DEST_ID KVM_X86_CPU_FEATURE(0x40000001, 0, EAX, \
    15)
#define X86_FEATURE_KVM_HC_MAP_GPA_RANGE  KVM_X86_CPU_FEATURE(0x40000001, 0, \
    EAX, 16)
#define X86_FEATURE_KVM_MIGRATION_CONTROL KVM_X86_CPU_FEATURE(0x40000001, 0, \
    EAX, 17)
...
#define X86_PROPERTY_PMU_NR_GP_COUNTERS   KVM_X86_CPU_PROPERTY(0xa, 0, EAX, 8, \
    15)
#define X86_PROPERTY_PMU_GP_COUNTERS_BIT_WIDTH  KVM_X86_CPU_PROPERTY(0xa, 0, \
    EAX, 16, \
    23)
#define X86_PROPERTY_PMU_EBX_BIT_VECTOR_LENGTH  KVM_X86_CPU_PROPERTY(0xa, 0, \
    EAX, 24, \
    31)
#define X86_PROPERTY_PMU_EVENTS_MASK    KVM_X86_CPU_PROPERTY(0xa, 0, EBX, 0, 7)
#define X86_PROPERTY_PMU_FIXED_COUNTERS_BITMASK KVM_X86_CPU_PROPERTY(0xa, 0, \
    ECX, 0, 31)
#define X86_PROPERTY_PMU_NR_FIXED_COUNTERS  KVM_X86_CPU_PROPERTY(0xa, 0, EDX, 0, \
    4)
#define X86_PROPERTY_PMU_FIXED_COUNTERS_BIT_WIDTH KVM_X86_CPU_PROPERTY(0xa, 0, \
    EDX, 5, \
    12)

#define X86_PROPERTY_SUPPORTED_XCR0_LO    KVM_X86_CPU_PROPERTY(0xd, 0, EAX, 0, \
    31)
#define X86_PROPERTY_XSTATE_MAX_SIZE_XCR0 KVM_X86_CPU_PROPERTY(0xd, 0, EBX, 0, \
    31)
#define X86_PROPERTY_XSTATE_MAX_SIZE    KVM_X86_CPU_PROPERTY(0xd, 0, ECX, 0, 31)
#define X86_PROPERTY_SUPPORTED_XCR0_HI    KVM_X86_CPU_PROPERTY(0xd, 0, EDX, 0, \
    31)

#define X86_PROPERTY_XSTATE_TILE_SIZE   KVM_X86_CPU_PROPERTY(0xd, 18, EAX, 0, \
    31)
#define X86_PROPERTY_XSTATE_TILE_OFFSET   KVM_X86_CPU_PROPERTY(0xd, 18, EBX, 0, \
    31)
#define X86_PROPERTY_AMX_MAX_PALETTE_TABLES KVM_X86_CPU_PROPERTY(0x1d, 0, EAX,  \
    0, 31)
#define X86_PROPERTY_AMX_TOTAL_TILE_BYTES KVM_X86_CPU_PROPERTY(0x1d, 1, EAX, 0, \
    15)
#define X86_PROPERTY_AMX_BYTES_PER_TILE   KVM_X86_CPU_PROPERTY(0x1d, 1, EAX, 16, \
    31)
#define X86_PROPERTY_AMX_BYTES_PER_ROW    KVM_X86_CPU_PROPERTY(0x1d, 1, EBX, 0,  \
    15)
#define X86_PROPERTY_AMX_NR_TILE_REGS   KVM_X86_CPU_PROPERTY(0x1d, 1, EBX, 16, \
    31)
#define X86_PROPERTY_AMX_MAX_ROWS   KVM_X86_CPU_PROPERTY(0x1d, 1, ECX, 0, 15)

#define X86_PROPERTY_MAX_KVM_LEAF   KVM_X86_CPU_PROPERTY(0x40000000, 0, EAX, 0, \
    31)

#define X86_PROPERTY_MAX_EXT_LEAF   KVM_X86_CPU_PROPERTY(0x80000000, 0, EAX, 0, \
    31)
#define X86_PROPERTY_MAX_PHY_ADDR   KVM_X86_CPU_PROPERTY(0x80000008, 0, EAX, 0, \
    7)
#define X86_PROPERTY_MAX_VIRT_ADDR    KVM_X86_CPU_PROPERTY(0x80000008, 0, EAX, \
    8, 15)
#define X86_PROPERTY_SEV_C_BIT      KVM_X86_CPU_PROPERTY(0x8000001F, 0, EBX, 0, \
    5)
#define X86_PROPERTY_PHYS_ADDR_REDUCTION  KVM_X86_CPU_PROPERTY(0x8000001F, 0, \
    EBX, 6, 11)

#define X86_PROPERTY_MAX_CENTAUR_LEAF   KVM_X86_CPU_PROPERTY(0xC0000000, 0, EAX, \
    0, 31)
...
static inline struct kvm_cpuid_entry2 *__vcpu_get_cpuid_entry(
...
static inline struct kvm_cpuid_entry2 *vcpu_get_cpuid_entry(
    struct kvm_vcpu *vcpu,
    uint32_t function) {
...
int _vcpu_set_msr(struct kvm_vcpu *vcpu, uint64_t msr_index,
    uint64_t msr_value);
...
#define vcpu_set_msr(vcpu, msr, val)              \
  do {                      \
    ...
    TEST_ASSERT_MSR(r == v, "Set %s to '0x%lx', got back '0x%lx'", msr, #msr, v, \
    r); \
  } while (0)
