  ...
  {             \
    switch (num) {          \
      case 0:           \
        ...
        break;          \
      case 1:           \
        write_sysreg(val, reg_name ## 1_el 1); \
        break;          \
      case 2:           \
        write_sysreg(val, reg_name ## 2_el 1); \
        break;          \
      case 3:           \
        write_sysreg(val, reg_name ## 3_el 1); \
        break;          \
      case 4:           \
        write_sysreg(val, reg_name ## 4_el 1); \
        break;          \
      case 5:           \
        write_sysreg(val, reg_name ## 5_el 1); \
        break;          \
      case 6:           \
        write_sysreg(val, reg_name ## 6_el 1); \
        break;          \
      case 7:           \
        write_sysreg(val, reg_name ## 7_el 1); \
        break;          \
      case 8:           \
        write_sysreg(val, reg_name ## 8_el 1); \
        break;          \
      case 9:           \
        write_sysreg(val, reg_name ## 9_el 1); \
        break;          \
      case 10:          \
        write_sysreg(val, reg_name ## 10_el 1);  \
        break;          \
      case 11:          \
        write_sysreg(val, reg_name ## 11_el 1);  \
        break;          \
      case 12:          \
        write_sysreg(val, reg_name ## 12_el 1);  \
        break;          \
      case 13:          \
        write_sysreg(val, reg_name ## 13_el 1);  \
        break;          \
      case 14:          \
        write_sysreg(val, reg_name ## 14_el 1);  \
        break;          \
      case 15:          \
        write_sysreg(val, reg_name ## 15_el 1);  \
        break;          \
      default:          \
        GUEST_ASSERT(0);      \
    }           \
...
static void test_guest_debug_exceptions(uint8_t bpn, uint8_t wpn,
    uint8_t ctx_bpn) {
...
void test_guest_debug_exceptions_all(uint64_t aa64dfr0) {
  ...
  ctx_brp_num
    = FIELD_GET(ARM64_FEATURE_MASK(ID_AA64DFR0_EL1_CTX_CMPs), aa64dfr0) + 1;
