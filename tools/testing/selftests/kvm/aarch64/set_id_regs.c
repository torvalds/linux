...
#define REG_FTR_BITS(type, reg, field, safe_val) \
  __REG_FTR_BITS(reg ## _ ## field, FTR_UNSIGNED, type, \
    reg ## _ ## field ## _SHIFT, \
    reg ## _ ## field ## _MASK, safe_val)

#define S_REG_FTR_BITS(type, reg, field, safe_val) \
  __REG_FTR_BITS(reg ## _ ## field, FTR_SIGNED, type, \
    reg ## _ ## field ## _SHIFT, \
    reg ## _ ## field ## _MASK, safe_val)
...
static const struct reg_ftr_bits ftr_id_aa64dfr0_el1[] = {
  ...
  REG_FTR_BITS(FTR_LOWER_SAFE, ID_AA64DFR0_EL1, DebugVer,
      ID_AA64DFR0_EL1_DebugVer_IMP),
  REG_FTR_END,
};

static const struct reg_ftr_bits ftr_id_dfr0_el1[] = {
  S_REG_FTR_BITS(FTR_LOWER_SAFE, ID_DFR0_EL1, PerfMon,
