...
static void ca_write_cmsg_u32(char *cbuf, size_t cbuf_sz, size_t *cmsg_len,
...
static void cs_write_cmsg(int fd, struct msghdr *msg, char *cbuf,
    size_t cbuf_sz) {
  struct cmsghdr *cmsg;
  size_t cmsg_len;
...
static void cs_read_cmsg(int fd, struct msghdr *msg, char *cbuf,
    size_t cbuf_sz) {
