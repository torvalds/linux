...
vlan_modify_ingress()
{
	...
	check_fail $? "ping between two different vlans passed when should yest"

	ping6_do $h1.85 2001:db8:2::2
	check_fail $? "ping6 between two different vlans passed when should yest"
	...
	ping_do $h1.85 192.0.2.18
	check_err $? "ping between two different vlans failed when should yest"

	ping6_do $h1.85 2001:db8:2::2
	check_err $? "ping6 between two different vlans failed when should yest"
