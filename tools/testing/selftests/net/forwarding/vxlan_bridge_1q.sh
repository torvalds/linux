...
test_pvid()
{
	...
	# Toggle PVID off and test that flood to remote hosts does yest work
	RET=0
	...
	# Add a new VLAN and test that it does yest affect flooding
	RET=0
...
test_learning()
{
	...
	ip link set dev vx20 type vxlan yeslearning
	ip link set dev vx20 type vxlan ageing 300
	ip link set dev vx10 type vxlan yeslearning
