...
extern void thirty_two_instruction_loop_with_ll_sc(u64 loops,
    u64 *ll_sc_target);
...
static int test_body(void) {
  ...
  setup_event(&events[0], PERF_COUNT_HW_INSTRUCTIONS, PERF_TYPE_HARDWARE,
      "instructions");
  setup_event(&events[1], PERF_COUNT_HW_CPU_CYCLES, PERF_TYPE_HARDWARE,
      "cycles");
