...
static int parse_bounded_uint(const char *buffer, size_t count,
    uintmax_t *result,
...
int parse_uintmax(const char *buffer, size_t count, uintmax_t *result,
    int base) {
...
int parse_uint(const char *buffer, size_t count, unsigned int *result,
    int base) {
  uintmax_t parsed;
...
int parse_ulong(const char *buffer, size_t count, unsigned long *result,
    int base) {
  uintmax_t parsed;
