...
#define NV_VMX_REGS 12 /* Number of yesn-volatile VMX registers */
#define VMX20 20 /* First yesn-volatile register to check in vr20-31 subset */

long tm_signal_self_context_load(pid_t pid, long *gprs, double *fps, vector int *vms, vector int *vss);

static sig_atomic_t fail, broken;

/* Test only yesn-volatile registers, i.e. 12 vmx registers from vr20 to vr31 */
vector int vms[] = {
