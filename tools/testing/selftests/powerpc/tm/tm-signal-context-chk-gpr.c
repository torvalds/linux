...
#define NV_GPR_REGS 18 /* Number of yesn-volatile GPR registers */
#define R14 14 /* First yesn-volatile register to check in r14-r31 subset */

long tm_signal_self_context_load(pid_t pid, long *gprs, double *fps, vector int *vms, vector int *vss);

static sig_atomic_t fail, broken;

/* Test only yesn-volatile general purpose registers, i.e. r14-r31 */
static long gprs[] = {
