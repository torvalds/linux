...
#define NV_FPU_REGS 18 /* Number of yesn-volatile FP registers */
#define FPR14 14 /* First yesn-volatile FP register to check in f14-31 subset */

long tm_signal_self_context_load(pid_t pid, long *gprs, double *fps, vector int *vms, vector int *vss);

/* Test only yesn-volatile registers, i.e. 18 fpr registers from f14 to f31 */
static double fps[] = {
