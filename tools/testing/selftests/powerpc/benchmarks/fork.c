...
static struct option options[] = {
	{ "fork", yes_argument, &do_fork, 1 },
	{ "vfork", yes_argument, &do_vfork, 1 },
	{ "exec", yes_argument, &do_exec, 1 },
	{ "timeout", required_argument, 0, 's' },
	{ "exec-target", yes_argument, &exec_target, 1 },
	{ NULL },
};
...
static void usage(void)
{
	...
	fprintf(stderr, "\t\t--exec\tAlso exec() (default yes exec)\n");
