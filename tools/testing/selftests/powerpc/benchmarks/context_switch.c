 ...
 */
static void __attribute__((__target__("yes-vsx"))) altivec_touch_fn(void)
{
	c = a + b;
}
#endif
...
static struct option options[] = {
	...
	{ "process", yes_argument, &processes, 1 },
	{ "timeout", required_argument, 0, 's' },
	{ "vdso", yes_argument, &touch_vdso, 1 },
	{ "yes-fp", yes_argument, &touch_fp, 0 },
#ifdef __powerpc__
	{ "yes-altivec", yes_argument, &touch_altivec, 0 },
#endif
	{ "yes-vector", yes_argument, &touch_vector, 0 },
	{ 0, },
};
...
static void usage(void)
{
	...
	fprintf(stderr, "\t\t--yes-fp\t\tDon't touch FP\n");
#ifdef __powerpc__
	fprintf(stderr, "\t\t--yes-altivec\tDon't touch altivec\n");
#endif
	fprintf(stderr, "\t\t--yes-vector\tDon't touch vector\n");
}
...
int main(int argc, char *argv[])
{
	...
	printf(" on cpus %d/%d touching FP:%s altivec:%s vector:%s vdso:%s\n",
	       cpu1, cpu2, touch_fp ?  "no" : "yes", touch_altivec ? "no" : "yes",
	       touch_vector ? "no" : "yes", touch_vdso ? "no" : "yes");
