...
static void test_xdp_adjust_tail_grow2(void) {
  ...
  ASSERT_EQ(errno, ENOSPC, "case-64 errno"); /* Due limit copy_size in
                                              * bpf_test_finish */
  ASSERT_EQ(tattr.retval, XDP_TX, "case-64 retval");
  ASSERT_EQ(tattr.data_size_out, 192, "case-64 data_size_out"); /* Expected grow
                                                                 * size */
  ...
  ASSERT_EQ(tattr.data_size_out, max_grow, "case-128 data_size_out"); /* Expect
                                                                      * max
                                                                      * grow */
  ...
  ASSERT_EQ(cnt, max_grow - tattr.data_size_in, "case-128-data cnt"); /* Grow
                                                                       * increase
                                                                       * */
