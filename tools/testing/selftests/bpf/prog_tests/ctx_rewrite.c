...
static struct test_case test_cases[] = {
  ...
  },
  {
    ...
    .read
      = "$dst = *(u16 *)($ctx + $(sk_buff::cb + qdisc_skb_cb::tc_classid));",
    .write
...
static int find_field_offset_aux(struct btf *btf, int btf_id, char *field_name,
    int off) {
...
static int find_field_offset(struct btf *btf, char *pattern,
    regmatch_t *matches) {
 ...
 */
static bool match_pattern(struct btf *btf, char *pattern, char *text,
    char *reg_map[][2]) {
