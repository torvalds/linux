...
void test_test_profiler(void) {
  ...
  if (CHECK(!profiler1_skel, "profiler1_skel_load",
      "profiler1 skeleton failed\n")) {
    goto cleanup;
  }
  ...
  if (CHECK(!profiler2_skel, "profiler2_skel_load",
      "profiler2 skeleton failed\n")) {
    goto cleanup;
  }
  ...
  if (CHECK(!profiler3_skel, "profiler3_skel_load",
      "profiler3 skeleton failed\n")) {
    goto cleanup;
  }
