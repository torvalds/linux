...
static void test_insert_invalid(
    struct test_sockmap_listen *skel __always_unused,
...
static void test_delete_after_insert(
    struct test_sockmap_listen *skel __always_unused,
    int family, int sotype, int mapfd) {
  u64 value;
  u32 key;
...
static void test_delete_after_close(
    struct test_sockmap_listen *skel __always_unused,
    int family, int sotype, int mapfd) {
  int err, s;
  u64 value;
...
static void test_lookup_after_insert(
    struct test_sockmap_listen *skel __always_unused,
    int family, int sotype, int mapfd) {
  u64 cookie, value;
  socklen_t len;
...
static void test_lookup_after_delete(
    struct test_sockmap_listen *skel __always_unused,
    int family, int sotype, int mapfd) {
  int err, s;
  u64 value;
...
static void test_lookup_32_bit_value(
    struct test_sockmap_listen *skel __always_unused,
    int family, int sotype, int mapfd) {
  u32 key, value32;
  int err, s;
 ...
 */
static void test_clone_after_delete(
    struct test_sockmap_listen *skel __always_unused,
    int family, int sotype, int mapfd) {
  struct sockaddr_storage addr;
  socklen_t len;
 ...
 */
static void test_accept_after_delete(
    struct test_sockmap_listen *skel __always_unused,
    int family, int sotype, int mapfd) {
  struct sockaddr_storage addr;
  const u32 zero = 0;
 ...
 */
static void test_accept_before_delete(
    struct test_sockmap_listen *skel __always_unused,
    int family, int sotype, int mapfd) {
  struct sockaddr_storage addr;
...
static void test_syn_recv_insert_delete(
    struct test_sockmap_listen *skel __always_unused,
    int family, int sotype, int mapfd) {
...
static void test_race_insert_listen(
    struct test_sockmap_listen *skel __always_unused,
...
static void redir_partial(int family, int sotype, int sock_map,
    int parser_map) {
...
static void pairs_redir_to_connected(int cli0, int peer0, int cli1, int peer1,
  ...
  n = recv_timeout(mode == REDIR_INGRESS ? peer0 : cli0, &b, 1, 0,
      IO_TIMEOUT_SEC);
  if (n < 0) {
    FAIL_ERRNO("%s: recv_timeout", log_prefix);
  }
...
static void test_unix_redir(struct test_sockmap_listen *skel,
    struct bpf_map *map,
    int sotype) {
  const char *family_name, *map_name;
  char s[MAX_TEST_NAME];
...
static void test_vsock_redir(struct test_sockmap_listen *skel,
    struct bpf_map *map) {
  const char *family_name, *map_name;
  char s[MAX_TEST_NAME];
...
static void test_udp_redir(struct test_sockmap_listen *skel,
    struct bpf_map *map,
    int family) {
  const char *family_name, *map_name;
  char s[MAX_TEST_NAME];
...
static void test_udp_unix_redir(struct test_sockmap_listen *skel,
    struct bpf_map *map,
    int family) {
  const char *family_name, *map_name;
  char s[MAX_TEST_NAME];
