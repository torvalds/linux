...
static void do_test_file(unsigned int test_num) {
  ...
  err
    = (bpf_map__btf_key_type_id(map) == 0
      || bpf_map__btf_value_type_id(map) == 0)
...
static struct btf_raw_test pprint_test_template[] = {
  {
    ...
    BTF_STR_SEC(
        "\0unsigned char\0unsigned short\0unsigned int\0int\0unsigned long long\0uint8_t\0uint16_t\0uint32_t\0int32_t\0uint64_t\0ui64\0ui8a\0ENUM_ZERO\0ENUM_ONE\0ENUM_TWO\0ENUM_THREE\0pprint_mapv\0ui32\0ui16\0si32\0unused_bits2a\0bits28\0unused_bits2b\0aenum\0ui32b\0bits2c\0si8_4"),
...

  {
    ...
    .raw_types = {
      ...
      BTF_MEMBER_ENC(NAME_TBD, 11, BTF_MEMBER_OFFSET(0, 224)),  /* uint32_t
                                                                 * ui32b */
...

  {
    ...
    BTF_STR_SEC(
        "\0unsigned char\0unsigned short\0unsigned int\0int\0unsigned long long\0uint8_t\0uint16_t\0uint32_t\0int32_t\0uint64_t\0ui64\0ui8a\0ENUM_ZERO\0ENUM_ONE\0ENUM_TWO\0ENUM_THREE\0pprint_mapv\0ui32\0ui16\0si32\0unused_bits2a\0bits28\0unused_bits2b\0aenum\0ui32b\0bits2c\0___int\0si8_4"),
    .key_size = sizeof(unsigned int),
    .value_size = sizeof(struct pprint_mapv),
    .key_type_id = 3, /* unsigned int */
    .value_type_id = 16,  /* struct pprint_mapv */
...
#ifdef __SIZEOF_INT128__
  {
    ...
    BTF_STR_SEC(
        "\0unsigned int\0__int128\0unsigned __int128\0pprint_mapv_int128\0si128a\0si128b\0bits3\0bits80\0ui128"),
    .key_size = sizeof(unsigned int),
...
static struct prog_info_raw_test {
...

  {
    ...
    BTF_STR_SEC(
        "\0int\0x\0sub\0main\0int a=1+1;\0return func(a);\0b+=1;\0return b;"),
    .insns = {
      BPF_MOV64_IMM(BPF_REG_2, 1),
      BPF_ALU64_IMM(BPF_ADD, BPF_REG_2, 1),
      BPF_MOV64_REG(BPF_REG_1, BPF_REG_2),
...

  {
    ...
    BTF_STR_SEC(
        "\0int\0/* dead jmp */\0int a=1;\0int b=2;\0return a + b;\0return a + b;"),
    .insns = {
...

  {
    ...
    BTF_STR_SEC(
        "\0int\0int a=1;\0int b=2;\0return a + b;\0/* dead jmp */\0return a + b;\0/* dead exit */"),
    .insns = {
      BPF_MOV64_IMM(BPF_REG_0, 1),
      BPF_MOV64_IMM(BPF_REG_1, 2),
      BPF_ALU64_REG(BPF_ADD, BPF_REG_0, BPF_REG_1),
  ...
  },
  {
    ...
    .input = {
      .raw_types = {
        ...
        BTF_TYPE_ENC(NAME_TBD, BTF_INFO_ENC(BTF_KIND_ENUM, 0, 2), 4), /* [2]
                                                                       * enum */
        BTF_ENUM_ENC(NAME_TBD, 0),
        BTF_ENUM_ENC(NAME_TBD, 1),
        ...
        BTF_TYPE_ENC(NAME_TBD, BTF_INFO_ENC(BTF_KIND_ENUM64, 0, 2), 8), /* [19]
                                                                         * enum64
                                                                         * */
        BTF_ENUM64_ENC(NAME_TBD, 0, 0),
        BTF_ENUM64_ENC(NAME_TBD, 1, 1),
      ...
      BTF_STR_SEC(
          "\0A\0B\0C\0D\0E\0F\0G\0H\0I\0J\0K\0L\0M\0N\0O\0P\0Q\0R\0S\0T\0U"),
    },
    .expect = {
      .raw_types = {
        BTF_TYPE_INT_ENC(NAME_TBD, BTF_INT_SIGNED, 0, 32, 8),   /* [1] int */
