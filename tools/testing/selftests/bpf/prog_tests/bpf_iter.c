...
static void do_dummy_read_opts(struct bpf_program *prog,
...
static void do_read_map_iter_fd(struct bpf_object_skeleton **skel,
...
static void test_task_common(struct bpf_iter_attach_opts *opts, int num_unknown,
    int num_known) {
...
static void test_task_vma_offset_common(struct bpf_iter_attach_opts *opts,
    bool one_proc) {
  ...
  skel->links.get_vma_offset = bpf_program__attach_iter(
      skel->progs.get_vma_offset, opts);
