...
void test_skeleton(void) {
  ...
  ASSERT_STREQ(bpf_map__name(
      skel->maps.rodata_dyn), ".rodata.dyn", "rodata_dyn_name");
  ASSERT_STREQ(bpf_map__name(skel->maps.data_dyn), ".data.dyn",
      "data_dyn_name");
  ...
  ASSERT_EQ(bpf_map__map_flags(
      skel->maps.data_non_mmapable), 0, "non_mmap_flags");
