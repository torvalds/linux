...
},
{
  ...
  .result = REJECT,
  .errstr
    = "R1 doesn't have constant offset. kptr has to be at the constant offset",
},
{
...
/* Tests for unreferened PTR_TO_BTF_ID */
{
  ...
  .errstr
    =
      "invalid kptr access, R1 type=untrusted_ptr_prog_test_ref_kfunc expected=ptr_prog_test",
},
{
...
},
{
  ...
  .errstr
    =
      "invalid kptr access, R2 type=ptr_prog_test_ref_kfunc expected=ptr_prog_test_member",
},
{
