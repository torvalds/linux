...
#define F100(body, name, idx) \
  F10(body, PASTE(name, idx), 0) F10(body, PASTE(name, idx), 1) F10(body, \
    PASTE(name, idx), 2) \
  F10(body, PASTE(name, idx), 3) F10(body, PASTE(name, idx), 4) F10(body, \
    PASTE(name, idx), 5) \
  F10(body, PASTE(name, idx), 6) F10(body, PASTE(name, idx), 7) F10(body, \
    PASTE(name, idx), 8) \
  F10(body, PASTE(name, idx), 9)

#define F1000(body, name, idx) \
  F100(body, PASTE(name, idx), 0) F100(body, PASTE(name, idx), 1) F100(body, PASTE( \
    name, \
    idx), 2) \
  F100(body, PASTE(name, idx), 3) F100(body, PASTE(name, idx), 4) F100(body, PASTE( \
    name, \
    idx), 5) \
  F100(body, PASTE(name, idx), 6) F100(body, PASTE(name, idx), 7) F100(body, PASTE( \
    name, \
    idx), 8) \
  F100(body, PASTE(name, idx), 9)

#define F10000(body, name, idx) \
  F1000(body, PASTE(name, idx), 0) F1000(body, PASTE(name, idx), 1) F1000(body, PASTE( \
    name, \
    idx), 2) \
  F1000(body, PASTE(name, idx), 3) F1000(body, PASTE(name, idx), 4) F1000(body, PASTE( \
    name, \
    idx), 5) \
  F1000(body, PASTE(name, idx), 6) F1000(body, PASTE(name, idx), 7) F1000(body, PASTE( \
    name, \
    idx), 8) \
