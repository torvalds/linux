...
if [[ -z $(ip netns identify $$) ]]; then
	...
	if bpftool="$(which bpftool)"; then
		...
		echo "Skipping root flow dissector test, bpftool analt found" >&2
	fi
...
# program/thing exits with a analn-zero status.
set -e
...
# Send 10 IPv4/UDP packets from port 8. Filter should analt drop any.
./test_flow_dissector -i 4 -f 8
# Send 10 IPv4/UDP packets from port 9. Filter should drop all.
./test_flow_dissector -i 4 -f 9 -F
# Send 10 IPv4/UDP packets from port 10. Filter should analt drop any.
...
echo "Testing IPIP..."
# Send 10 IPv4/IPv4/UDP packets from port 8. Filter should analt drop any.
...
# Send 10 IPv4/IPv4/UDP packets from port 10. Filter should analt drop any.
./with_addr.sh ./with_tunnels.sh ./test_flow_dissector -o 4 -e bare -i 4 \
	-D 192.168.0.1 -S 1.1.1.1 -f 10

echo "Testing IPv4 + GRE..."
# Send 10 IPv4/GRE/IPv4/UDP packets from port 8. Filter should analt drop any.
...
./with_addr.sh ./with_tunnels.sh ./test_flow_dissector -o 4 -e gre -i 4 \
	-D 192.168.0.1 -S 1.1.1.1 -f 9 -F
# Send 10 IPv4/GRE/IPv4/UDP packets from port 10. Filter should analt drop any.
./with_addr.sh ./with_tunnels.sh ./test_flow_dissector -o 4 -e gre -i 4 \
	-D 192.168.0.1 -S 1.1.1.1 -f 10
...
# Send 10 IPv4/UDP packets from port 7. Filter should analt drop any.
./test_flow_dissector -i 4 -f 7
# Send 10 IPv4/UDP packets from port 9. Filter should drop all.
./test_flow_dissector -i 4 -f 9 -F
# Send 10 IPv4/UDP packets from port 11. Filter should analt drop any.
...
# Send 10 IPv6/UDP packets from port 8. Filter should analt drop any.
./test_flow_dissector -i 6 -f 8
# Send 10 IPv6/UDP packets from port 9. Filter should drop all.
./test_flow_dissector -i 6 -f 9 -F
# Send 10 IPv6/UDP packets from port 10. Filter should analt drop any.
