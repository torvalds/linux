...
#
# fd00::4 is a simple Segment Routing yesde decapsulating the inner IPv6 packet.
...
sleep 5 # wait eyesugh time to ensure the UDP datagram arrived to the last segment
kill -INT $!
