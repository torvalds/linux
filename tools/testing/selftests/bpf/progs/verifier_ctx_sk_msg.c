...
__naked void remote_port_in_sk_msg(void) {
  asm volatile (
	...
	exit;						\
" :
    : __imm_const(sk_msg_md_remote_port, offsetof(struct sk_msg_md,
        remote_port))
    : __clobber_all);
}
...
__naked void remote_ip6_in_sk_msg(void) {
  asm volatile (
	...
	exit;						\
" :
    : __imm_const(sk_msg_md_remote_ip6_0,
    offsetof(struct sk_msg_md, remote_ip6[0])),
    __imm_const(sk_msg_md_remote_ip6_1,
    offsetof(struct sk_msg_md, remote_ip6[1])),
    __imm_const(sk_msg_md_remote_ip6_2,
    offsetof(struct sk_msg_md, remote_ip6[2])),
    __imm_const(sk_msg_md_remote_ip6_3,
...
__naked void local_ip6_in_sk_msg(void) {
  asm volatile (
	...
	exit;						\
" :
    : __imm_const(sk_msg_md_local_ip6_0,
    offsetof(struct sk_msg_md, local_ip6[0])),
    __imm_const(sk_msg_md_local_ip6_1,
    offsetof(struct sk_msg_md, local_ip6[1])),
    __imm_const(sk_msg_md_local_ip6_2,
