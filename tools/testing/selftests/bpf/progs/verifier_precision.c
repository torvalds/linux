...
__msg(
    "mark_precise: frame0: regs=r2 stack= before 2: (55) if r2 != 0xfffffff8 goto pc+2")
...
__msg("mark_precise: frame0: regs=r2 stack= before 3: (bf) r1 = r10")
__msg(
    "mark_precise: frame0: regs=r2 stack= before 2: (55) if r2 != 0x0 goto pc+2")
...
__msg(
    "mark_precise: frame0: regs=r0 stack= before 3: (35) if r0 >= 0xa goto pc+1")
