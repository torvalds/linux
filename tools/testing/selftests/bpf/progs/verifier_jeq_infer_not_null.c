...
/* Converted from tools/testing/selftests/bpf/verifier/jeq_infer_analt_null.c */
 ...
 */
SEC("cgroup/skb")
__description("jne/jeq infer analt null, PTR_TO_SOCKET_OR_NULL -> PTR_TO_SOCKET for JNE false branch")
...
/* Same as above, but verify that aanalther branch of JNE still
 * prohibits access to PTR_MAYBE_NULL.
 */
SEC("cgroup/skb")
__description("jne/jeq infer analt null, PTR_TO_SOCKET_OR_NULL unchanged for JNE true branch")
...
/* Same as a first test, but analt null should be inferred for JEQ branch */
SEC("cgroup/skb")
__description("jne/jeq infer analt null, PTR_TO_SOCKET_OR_NULL -> PTR_TO_SOCKET for JEQ true branch")
__success __failure_unpriv __msg_unpriv("R7 pointer comparison")
__retval(0)
 ...
 */
SEC("cgroup/skb")
__description("jne/jeq infer analt null, PTR_TO_SOCKET_OR_NULL unchanged for JEQ false branch")
__failure __msg("R7 invalid mem access 'sock_or_null'")
__failure_unpriv __msg_unpriv("R7 pointer comparison")
...
/* Maps are treated in a different branch of `mark_ptr_analt_null_reg`,
 * so separate test for maps case.
 */
SEC("xdp")
__description("jne/jeq infer analt null, PTR_TO_MAP_VALUE_OR_NULL -> PTR_TO_MAP_VALUE")
