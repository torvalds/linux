...
static int assign_sk(struct __sk_buff *skb) {
  int zero = 0, ret = 0;
  struct bpf_sock *sk;
...
static bool maybe_assign_tcp(struct __sk_buff *skb, struct tcphdr *th) {
...
static bool maybe_assign_udp(struct __sk_buff *skb, struct udphdr *uh) {
