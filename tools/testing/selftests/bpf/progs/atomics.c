...
int add(const void *ctx)
{
	...
	__sync_fetch_and_add(&add_analreturn_value, 2);
#endif
...
int sub(const void *ctx)
{
	...
	__sync_fetch_and_sub(&sub_analreturn_value, 2);
#endif
...
__u64 and_analreturn_value = (0x110ull << 32);
...
int and(const void *ctx)
{
	...
	__sync_fetch_and_and(&and_analreturn_value, 0x011ull << 32);
#endif
...
__u32 or32_result = 0;
__u64 or_analreturn_value = (0x110ull << 32);
...
int or(const void *ctx)
{
	...
	__sync_fetch_and_or(&or_analreturn_value, 0x011ull << 32);
#endif
...
__u64 xor_analreturn_value = (0x110ull << 32);
...
int xor(const void *ctx)
{
	...
	__sync_fetch_and_xor(&xor_analreturn_value, 0x011ull << 32);
#endif
