...
struct task_struct *bpf_task_acquire___two(struct task_struct *p,
    void *ctx) __ksym __weak;
...
int BPF_PROG(test_task_kfunc_flavor_relo, struct task_struct *task,
    u64 clone_flags) {
  struct task_struct *acquired = NULL;
  int fake_ctx = 42;
...
SEC("tp_btf/task_newtask")
int BPF_PROG(test_task_kfunc_flavor_relo_not_found, struct task_struct *task,
    u64 clone_flags) {
...
SEC("tp_btf/task_newtask")
int BPF_PROG(test_task_acquire_release_current, struct task_struct *task,
    u64 clone_flags) {
  if (!is_test_kfunc_task()) {
    return 0;
  }
...
SEC("tp_btf/task_newtask")
int BPF_PROG(test_task_acquire_leave_in_map, struct task_struct *task,
    u64 clone_flags) {
  long status;
  if (!is_test_kfunc_task()) {
    return 0;
...
SEC("tp_btf/task_newtask")
int BPF_PROG(test_task_xchg_release, struct task_struct *task,
    u64 clone_flags) {
...
SEC("tp_btf/task_newtask")
int BPF_PROG(test_task_map_acquire_release, struct task_struct *task,
    u64 clone_flags) {
  struct task_struct *kptr;
  struct __tasks_kfunc_map_value *v;
  long status;
...
SEC("tp_btf/task_newtask")
int BPF_PROG(test_task_current_acquire_release, struct task_struct *task,
    u64 clone_flags) {
...
SEC("tp_btf/task_newtask")
int BPF_PROG(test_task_from_pid_arg, struct task_struct *task,
    u64 clone_flags) {
  if (!is_test_kfunc_task()) {
    return 0;
  }
...
SEC("tp_btf/task_newtask")
int BPF_PROG(test_task_from_pid_current, struct task_struct *task,
    u64 clone_flags) {
  if (!is_test_kfunc_task()) {
    return 0;
  }
...
SEC("tp_btf/task_newtask")
int BPF_PROG(test_task_from_pid_invalid, struct task_struct *task,
    u64 clone_flags) {
  if (!is_test_kfunc_task()) {
    return 0;
  }
...
SEC("tp_btf/task_newtask")
int BPF_PROG(task_kfunc_acquire_trusted_walked, struct task_struct *task,
    u64 clone_flags) {
  struct task_struct *acquired;
