...
int list_push_pop(struct bpf_spin_lock *lock, struct bpf_list_head *head,
    bool leave_in_map) {
...
static __always_inline
int list_push_pop_multiple(struct bpf_spin_lock *lock,
...
static __always_inline
int list_in_list(struct bpf_spin_lock *lock, struct bpf_list_head *head,
    bool leave_in_map) {
  struct bpf_list_node *n;
  struct bar *ba[8], *b;
  struct foo *f;
...
static __always_inline
int test_list_push_pop_multiple(struct bpf_spin_lock *lock,
