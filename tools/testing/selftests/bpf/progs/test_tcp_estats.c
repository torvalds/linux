...
#define _(P) ({typeof(P) val = 0; bpf_probe_read_kernel(&val, sizeof(val), &P); \
               val;})
...
static __always_inline void conn_id_ipv4_init(
    struct tcp_estats_conn_id *conn_id,
...
static __always_inline void conn_id_ipv6_init(
    struct tcp_estats_conn_id *conn_id,
    __be32 *saddr, __be32 *daddr) {
...
static __always_inline void tcp_estats_conn_id_init(
    struct tcp_estats_conn_id *conn_id,
    struct sock *sk) {
