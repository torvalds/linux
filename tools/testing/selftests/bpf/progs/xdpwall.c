...
static __always_inline void filter_src_dst_ip(struct pkt_info *info,
...
static __always_inline void *get_transport_hdr(__u16 offset, void *data,
    void *data_end) {
...
static __always_inline bool parse_tcp(struct pkt_info *info,
    void *transport_hdr, void *data_end) {
...
static __always_inline bool parse_udp(struct pkt_info *info,
    void *transport_hdr, void *data_end) {
...
static __always_inline bool filter_transport_hdr(void *transport_hdr,
    void *data_end,
...
static __always_inline __u8 parse_gue_v6(struct pkt_info *info,
