...
SEC("socket")
__description(
    "check deducing bounds from non-const, jmp64, <non_const> == <const>, 1")
...
SEC("socket")
__description(
    "check deducing bounds from non-const, jmp64, <non_const> == <const>, 2")
__success __retval(0)
...
SEC("socket")
__description(
    "check deducing bounds from non-const, jmp32, <non_const> == <const>, 1")
__success __retval(0)
...
SEC("socket")
__description(
    "check deducing bounds from non-const, jmp32, <non_const> == <const>, 2")
__success __retval(0)
...
SEC("socket")
__description(
    "check deducing bounds from non-const, jmp64, <const> > <non_const>, 1")
__success __retval(0)
...
SEC("socket")
__description(
    "check deducing bounds from non-const, jmp64, <const> > <non_const>, 2")
__success __retval(0)
...
SEC("socket")
__description(
    "check deducing bounds from non-const, jmp64, <const> >= <non_const>")
__success __retval(0)
...
SEC("socket")
__description(
    "check deducing bounds from non-const, jmp64, <const> s> <non_const>")
__success __retval(0)
...
SEC("socket")
__description(
    "check deducing bounds from non-const, jmp32, <const> > <non_const>, 1")
__success __retval(0)
...
SEC("socket")
__description(
    "check deducing bounds from non-const, jmp32, <const> > <non_const>, 2")
__success __retval(0)
...
SEC("socket")
__description(
    "check deducing bounds from non-const, jmp32, <const> >= <non_const>")
__success __retval(0)
...
SEC("socket")
__description(
    "check deducing bounds from non-const, jmp32, <const> s> <non_const>")
__success __retval(0)
