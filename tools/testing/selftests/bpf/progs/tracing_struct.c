...
int BPF_PROG2(test_struct_arg_1, struct bpf_testmod_struct_arg_2, a, int, b,
    int, c) {
  t1_a_a = a.a;
  t1_a_b = a.b;
  t1_b = b;
...
int BPF_PROG2(test_struct_arg_2, struct bpf_testmod_struct_arg_2, a, int, b,
    int, c, int, ret) {
...
int BPF_PROG2(test_struct_arg_3, int, a, struct bpf_testmod_struct_arg_2, b,
    int, c) {
  t2_a = a;
  t2_b_a = b.a;
  t2_b_b = b.b;
...
int BPF_PROG2(test_struct_arg_4, int, a, struct bpf_testmod_struct_arg_2, b,
    int, c, int, ret) {
  t2_ret = ret;
  return 0;
}
...
int BPF_PROG2(test_struct_arg_5, int, a, int, b,
    struct bpf_testmod_struct_arg_2, c) {
  t3_a = a;
  t3_b = b;
  t3_c_a = c.a;
  t3_c_b = c.b;
...
int BPF_PROG2(test_struct_arg_6, int, a, int, b,
    struct bpf_testmod_struct_arg_2, c, int, ret) {
  t3_ret = ret;
  return 0;
}
