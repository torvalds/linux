...
typedef enum {
  TYPEDEF_ENUM_VAL1, TYPEDEF_ENUM_VAL2
} enum_typedef;
...
int test_core_type_based(void *ctx) {
  ...
  out->typedef_named_struct_matches
    = bpf_core_type_matches(named_struct_typedef);
  ...
  out->typedef_restrict_ptr_matches
    = bpf_core_type_matches(restrict_ptr_typedef);
