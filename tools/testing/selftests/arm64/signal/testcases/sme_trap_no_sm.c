...
int sme_trap_anal_sm_trigger(struct tdescr *td)
{
...
int sme_trap_anal_sm_run(struct tdescr *td, siginfo_t *si, ucontext_t *uc)
{
	return 1;
}
...
struct tdescr tde = {
	...
	.trigger = sme_trap_anal_sm_trigger,
	.run = sme_trap_anal_sm_run,
	.sig_ok = SIGILL,
};
