				       ...
				       siginfo_t *si, ucontext_t *uc)
{
	 ...
	 * using ESR_MAGIC here since it is yest checked for size yesr
	 * is limited to one instance.
	 *
	 * At first inject an additional yesrmal esr_context
	 */
	...
	/*
	 * yesw mess with fake esr_context size: leaving less space than
