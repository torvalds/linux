...
static int check_clear_prot_mte_flag(int mem_type, int mode, int mapping) {
  ...
  for (run = 0; run < total; run++) {
    ...
    ptr = (char *) mte_allocate_file_memory_tag_range(sizes[run], mem_type,
        mapping,
...
int main(int argc, char *argv[]) {
  ...
  evaluate_test(check_anonymous_memory_mapping(USE_MMAP, MTE_NONE_ERR,
      MAP_PRIVATE,
      TAG_CHECK_OFF),
      "Check anonymous memory with private mapping, no error mode, mmap memory and tag check off\n");
  evaluate_test(check_file_memory_mapping(USE_MPROTECT, MTE_NONE_ERR,
      MAP_PRIVATE,
      TAG_CHECK_OFF),
  ...
  evaluate_test(check_anonymous_memory_mapping(USE_MPROTECT, MTE_SYNC_ERR,
      MAP_PRIVATE,
      TAG_CHECK_ON),
  ...
  evaluate_test(check_anonymous_memory_mapping(USE_MMAP, MTE_ASYNC_ERR,
      MAP_PRIVATE,
      TAG_CHECK_ON),
      "Check anonymous memory with private mapping, async error mode, mmap memory and tag check on\n");
  evaluate_test(check_anonymous_memory_mapping(USE_MPROTECT, MTE_ASYNC_ERR,
      MAP_PRIVATE,
      TAG_CHECK_ON),
  ...
  evaluate_test(check_file_memory_mapping(USE_MMAP, MTE_SYNC_ERR, MAP_PRIVATE,
      TAG_CHECK_ON),
  ...
  evaluate_test(check_file_memory_mapping(USE_MMAP, MTE_SYNC_ERR, MAP_SHARED,
      TAG_CHECK_ON),
  ...
  evaluate_test(check_file_memory_mapping(USE_MMAP, MTE_ASYNC_ERR, MAP_PRIVATE,
      TAG_CHECK_ON),
      "Check file memory with private mapping, async error mode, mmap memory and tag check on\n");
  evaluate_test(check_file_memory_mapping(USE_MPROTECT, MTE_ASYNC_ERR,
      MAP_PRIVATE,
      TAG_CHECK_ON),
      "Check file memory with private mapping, async error mode, mmap/mprotect memory and tag check on\n");
  evaluate_test(check_file_memory_mapping(USE_MMAP, MTE_ASYNC_ERR, MAP_SHARED,
      TAG_CHECK_ON),
  ...
  evaluate_test(check_clear_prot_mte_flag(USE_MMAP, MTE_SYNC_ERR,
      MAP_PRIVATE),
      "Check clear PROT_MTE flags with private mapping, sync error mode and mmap memory\n");
  evaluate_test(check_clear_prot_mte_flag(USE_MPROTECT, MTE_SYNC_ERR,
      MAP_PRIVATE),
