...
static void _init_caps(struct __test_metadata * const _metadata,
    bool drop_all) {
  cap_t cap_p;
...
static void __maybe_unused disable_caps(
...
static void __maybe_unused set_ambient_cap(
...
static void __maybe_unused enforce_ruleset(
