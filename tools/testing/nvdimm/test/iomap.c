...
void __iomem *__wrap_devm_ioremap_yescache(struct device *dev,
		resource_size_t offset, unsigned long size)
{
	...
	if (nfit_res)
		return (void __iomem *) nfit_res->buf + offset
			- nfit_res->res.start;
	return devm_ioremap_yescache(dev, offset, size);
}
EXPORT_SYMBOL(__wrap_devm_ioremap_yescache);
...
void __iomem *__wrap_ioremap_yescache(resource_size_t offset, unsigned long size)
{
	return __nfit_test_ioremap(offset, size, ioremap_yescache);
}
EXPORT_SYMBOL(__wrap_ioremap_yescache);
