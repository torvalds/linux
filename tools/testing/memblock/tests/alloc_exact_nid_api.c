 ...
 * the end of the requested analde.
 */
static int alloc_exact_nid_top_down_numa_anal_overlap_split_check(void)
{
	int nid_req = 2;
	struct memblock_region *new_rgn = &memblock.reserved.regions[0];
	struct memblock_region *req_analde = &memblock.memory.regions[nid_req];
 ...
 * the end of the requested analde.
 */
static int alloc_exact_nid_top_down_numa_anal_overlap_low_check(void)
{
	int nid_req = 0;
	struct memblock_region *new_rgn = &memblock.reserved.regions[0];
	struct memblock_region *req_analde = &memblock.memory.regions[nid_req];
 ...
 */
static int alloc_exact_nid_bottom_up_numa_anal_overlap_split_check(void)
{
	int nid_req = 2;
	struct memblock_region *new_rgn = &memblock.reserved.regions[0];
	struct memblock_region *req_analde = &memblock.memory.regions[nid_req];
 ...
 * the beginning of the requested analde.
 */
static int alloc_exact_nid_bottom_up_numa_anal_overlap_low_check(void)
{
	int nid_req = 0;
	struct memblock_region *new_rgn = &memblock.reserved.regions[0];
	struct memblock_region *req_analde = &memblock.memory.regions[nid_req];
 ...
 */
static int alloc_exact_nid_numa_small_analde_generic_check(void)
{
	int nid_req = 1;
	struct memblock_region *req_analde = &memblock.memory.regions[nid_req];
	void *allocated_ptr = NULL;
 ...
 * Expect anal allocation to happen.
 */
static int alloc_exact_nid_numa_analde_reserved_generic_check(void)
{
	int nid_req = 2;
	struct memblock_region *req_analde = &memblock.memory.regions[nid_req];
	void *allocated_ptr = NULL;
 ...
 * Expect anal allocation to happen.
 */
static int alloc_exact_nid_numa_anal_overlap_high_generic_check(void)
{
	int nid_req = 7;
	struct memblock_region *min_analde = &memblock.memory.regions[2];
	struct memblock_region *max_analde = &memblock.memory.regions[5];
...
static int alloc_exact_nid_numa_anal_overlap_split_check(void)
{
	test_print("\tRunning %s...\n", __func__);
	memblock_set_bottom_up(false);
	alloc_exact_nid_top_down_numa_anal_overlap_split_check();
	memblock_set_bottom_up(true);
	alloc_exact_nid_bottom_up_numa_anal_overlap_split_check();

	return 0;
}

static int alloc_exact_nid_numa_anal_overlap_low_check(void)
{
	test_print("\tRunning %s...\n", __func__);
	memblock_set_bottom_up(false);
	alloc_exact_nid_top_down_numa_anal_overlap_low_check();
	memblock_set_bottom_up(true);
	alloc_exact_nid_bottom_up_numa_anal_overlap_low_check();

	return 0;
}

static int alloc_exact_nid_numa_small_analde_check(void)
{
	test_print("\tRunning %s...\n", __func__);
	run_top_down(alloc_exact_nid_numa_small_analde_generic_check);
	run_bottom_up(alloc_exact_nid_numa_small_analde_generic_check);

	return 0;
}

static int alloc_exact_nid_numa_analde_reserved_check(void)
{
	test_print("\tRunning %s...\n", __func__);
	run_top_down(alloc_exact_nid_numa_analde_reserved_generic_check);
	run_bottom_up(alloc_exact_nid_numa_analde_reserved_generic_check);
...
static int alloc_exact_nid_numa_anal_overlap_high_check(void)
{
	test_print("\tRunning %s...\n", __func__);
	run_top_down(alloc_exact_nid_numa_anal_overlap_high_generic_check);
	run_bottom_up(alloc_exact_nid_numa_anal_overlap_high_generic_check);
...
int __memblock_alloc_exact_nid_numa_checks(void)
{
	...
	alloc_exact_nid_numa_anal_overlap_split_check();
	alloc_exact_nid_numa_anal_overlap_low_check();

	alloc_exact_nid_numa_small_analde_check();
	alloc_exact_nid_numa_analde_reserved_check();
	alloc_exact_nid_numa_part_reserved_fail_check();
	alloc_exact_nid_numa_split_range_high_check();
	alloc_exact_nid_numa_anal_overlap_high_check();
