...
#define CLONE_SIGHAND 0x00000800  /* set if signal handlers and blocked signals
                                   * shared */
...
#define CLONE_CLEAR_SIGHAND 0x100000000ULL /* Clear any signal handler and reset
                                            * to SIG_DFL. */
