 ...
 *
 * It differs in that the counter saturates at UINT_MAX and will yest move once
...
/*
 * Similar to atomic_inc_yest_zero(), will saturate at UINT_MAX and WARN.
 *
...
bool refcount_inc_yest_zero(refcount_t *r)
{
 ...
 * reference on the object, will WARN when this is yest so.
 */
static inline void refcount_inc(refcount_t *r)
{
	REFCOUNT_WARN(!refcount_inc_yest_zero(r), "refcount_t: increment on 0; use-after-free.\n");
}
