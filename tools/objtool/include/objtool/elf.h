...
struct symbol *find_symbol_containing(const struct section *sec,
    unsigned long offset);
int find_symbol_hole_containing(const struct section *sec,
    unsigned long offset);
struct reloc *find_reloc_by_dest(const struct elf *elf, struct section *sec,
    unsigned long offset);
struct reloc *find_reloc_by_dest_range(const struct elf *elf,
    struct section *sec,
    unsigned long offset, unsigned int len);
...
static inline void set_reloc_offset(struct elf *elf, struct reloc *reloc,
    u64 offset) {
...
static inline void set_reloc_addend(struct elf *elf, struct reloc *reloc,
    s64 addend) {
...
static inline void set_reloc_sym(struct elf *elf, struct reloc *reloc,
    unsigned int sym) {
...
static inline void set_reloc_type(struct elf *elf, struct reloc *reloc,
    unsigned int type) {
  u64 info = is_32bit_reloc(reloc)
