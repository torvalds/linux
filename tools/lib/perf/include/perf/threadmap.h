...
LIBPERF_API struct perf_thread_map *perf_thread_map__new_array(int nr_threads,
    pid_t *array);

LIBPERF_API void perf_thread_map__set_pid(struct perf_thread_map *map, int idx,
    pid_t pid);
...
LIBPERF_API struct perf_thread_map *perf_thread_map__get(
