...
static inline ssize_t io__getdelim(struct io *io, char **line_out,
    size_t *line_len_out, int delim) {
  char buf[128];
  int buf_pos = 0;
  char *line = NULL, *temp;
  size_t line_len = 0;
...
static inline ssize_t io__getline(struct io *io, char **line_out,
    size_t *line_len_out) {
