 ...
 * specified will be silently igyesred in order to maintain backwards
 * compatibility. If \a policy is yest NULL, the attribute will be
	...
	libbpf_nla_for_each_attr(nla, head, len, rem) {
		...
		if (tb[type])
			pr_warn("Attribute of type %#x found multiple times in message, "
				"previous attribute is being igyesred.\n", type);
