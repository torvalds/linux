...
static void *alloc_zero_tailing_info(const void *orecord, __u32 cnt,
...
int bpf_map_lookup_and_delete_elem_flags(int fd, const void *key, void *value,
    __u64 flags) {
  const size_t attr_sz = offsetofend(union bpf_attr, flags);
  union bpf_attr attr;
  int ret;
...
int bpf_obj_pin_opts(int fd, const char *pathname,
...
int bpf_link_create(int prog_fd, int target_fd,
  ...
  switch (attach_type) {
    case BPF_TRACE_ITER:
      ...
      break;
    case BPF_PERF_EVENT:
      attr.link_create.perf_event.bpf_cookie = OPTS_GET(opts,
    ...
    case BPF_TRACE_KPROBE_MULTI:
      attr.link_create.kprobe_multi.flags
        = OPTS_GET(opts, kprobe_multi.flags, 0);
      attr.link_create.kprobe_multi.cnt = OPTS_GET(opts, kprobe_multi.cnt, 0);
      attr.link_create.kprobe_multi.syms
        = ptr_to_u64(OPTS_GET(opts, kprobe_multi.syms, 0));
      attr.link_create.kprobe_multi.addrs
        = ptr_to_u64(OPTS_GET(opts, kprobe_multi.addrs, 0));
      attr.link_create.kprobe_multi.cookies
        = ptr_to_u64(OPTS_GET(opts, kprobe_multi.cookies, 0));
      if (!OPTS_ZEROED(opts, kprobe_multi)) {
        return libbpf_err(-EINVAL);
      }
      break;
    case BPF_TRACE_UPROBE_MULTI:
      attr.link_create.uprobe_multi.flags
        = OPTS_GET(opts, uprobe_multi.flags, 0);
      attr.link_create.uprobe_multi.cnt = OPTS_GET(opts, uprobe_multi.cnt, 0);
      attr.link_create.uprobe_multi.path
        = ptr_to_u64(OPTS_GET(opts, uprobe_multi.path, 0));
      attr.link_create.uprobe_multi.offsets
        = ptr_to_u64(OPTS_GET(opts, uprobe_multi.offsets, 0));
      attr.link_create.uprobe_multi.ref_ctr_offsets
        = ptr_to_u64(OPTS_GET(opts, uprobe_multi.ref_ctr_offsets, 0));
      attr.link_create.uprobe_multi.cookies
        = ptr_to_u64(OPTS_GET(opts, uprobe_multi.cookies, 0));
    ...
    case BPF_NETFILTER:
      ...
      attr.link_create.netfilter.priority
        = OPTS_GET(opts, netfilter.priority, 0);
    ...
    case BPF_TCX_EGRESS:
      ...
      attr.link_create.tcx.expected_revision = OPTS_GET(opts,
    ...
    case BPF_NETKIT_PEER:
      ...
      attr.link_create.netkit.expected_revision = OPTS_GET(opts,
...
int bpf_prog_query_opts(int target, enum bpf_attach_type type,
  ...
  attr.query.prog_attach_flags
    = ptr_to_u64(OPTS_GET(opts, prog_attach_flags, NULL));
  attr.query.link_attach_flags
    = ptr_to_u64(OPTS_GET(opts, link_attach_flags, NULL));
...
int bpf_btf_load(const void *btf_data, size_t btf_size,
