...
#define __ulong(name, \
      val) enum { ___bpf_concat(__unique_value, __COUNTER__) = val } name
...
#define ___bpf_fill10(arr, p, x, args ...) arr[p] = x; ___bpf_fill9(arr, p + 1, \
    args)
#define ___bpf_fill11(arr, p, x, args ...) arr[p] = x; ___bpf_fill10(arr, p + 1, \
    args)
#define ___bpf_fill12(arr, p, x, args ...) arr[p] = x; ___bpf_fill11(arr, p + 1, \
    args)
...
#define bpf_for(i, start, end) for (                \
    /* initialize and define destructor */              \
    struct bpf_iter_num ___it __attribute__((aligned(8), /* enforce, just in
                                                          * case */  \
