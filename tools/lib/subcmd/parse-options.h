...
#define check_vtype(v, \
      type) (BUILD_BUG_ON_ZERO(!__builtin_types_compatible_p(typeof(v), \
    type)) + v)

#define OPT_END()                   { .type = OPTION_END }
#define OPT_PARENT(p)               { .type = OPTION_END, .parent = (p) }
#define OPT_ARGUMENT(l, h)          { .type = OPTION_ARGUMENT, .long_name = (l), \
                                      .help = (h) }
#define OPT_GROUP(h)                { .type = OPTION_GROUP, .help = (h) }
#define OPT_BIT(s, l, v, h, b)      { .type = OPTION_BIT, .short_name = (s), \
                                      .long_name = (l), .value = check_vtype(v, \
    int *), \
                                      .help = (h), \
                                      .defval = (b) }
#define OPT_BOOLEAN(s, l, v, h)     { .type = OPTION_BOOLEAN, .short_name = (s), \
                                      .long_name = (l), .value = check_vtype(v, \
    bool *), \
                                      .help = (h) }
...
#define OPT_INCR(s, l, v, h)        { .type = OPTION_INCR, .short_name = (s), \
    ...
    int *), \
                                      .help = (h) }
#define OPT_SET_UINT(s, l, v, h, i)  { .type = OPTION_SET_UINT, \
                                       .short_name = (s), .long_name = (l), \
                                       .value = check_vtype(v, \
    unsigned int *), \
                                       .help = (h), .defval = (i) }
#define OPT_SET_PTR(s, l, v, h, p)  { .type = OPTION_SET_PTR, .short_name = (s), \
                                      .long_name = (l), .value = (v), \
                                      .help = (h), .defval = (p) }
#define OPT_INTEGER(s, l, v, h)     { .type = OPTION_INTEGER, .short_name = (s), \
                                      .long_name = (l), .value = check_vtype(v, \
    int *), \
                                      .help = (h) }
#define OPT_UINTEGER(s, l, v, h)    { .type = OPTION_UINTEGER, \
    ...
    unsigned int *), \
                                      .help = (h) }
#define OPT_UINTEGER_OPTARG(s, l, v, d, h)    { .type = OPTION_UINTEGER, \
                                                .short_name = (s), \
                                                .long_name = (l), \
                                                .value = check_vtype(v, \
    unsigned int *), \
...
#define OPT_LONG(s, l, v, h)        { .type = OPTION_LONG, .short_name = (s), \
    ...
    long *), \
                                      .help = (h) }
#define OPT_ULONG(s, l, v, h)        { .type = OPTION_ULONG, .short_name = (s), \
                                       .long_name = (l), .value = check_vtype(v, \
    unsigned long *), \
                                       .help = (h) }
#define OPT_U64(s, l, v, h)         { .type = OPTION_U64, .short_name = (s), \
    ...
    u64 *), \
                                      .help = (h) }
#define OPT_STRING(s, l, v, a, h)   { .type = OPTION_STRING, .short_name = (s), \
                                      .long_name = (l), .value = check_vtype(v, \
    const char **), \
                                      .argh = (a), \
                                      .help = (h) }
...
#define OPT_STRING_NOEMPTY(s, l, v, a, h)   { .type = OPTION_STRING,  \
    ...
    const char **), \
                                              .argh = (a), .help = (h), \
                                              .flags = PARSE_OPT_NOEMPTY}
#define OPT_DATE(s, l, v, h) \
  { .type = OPTION_CALLBACK, .short_name = (s), .long_name = (l), .value = (v), \
    .argh = "time", .help = (h), .callback = parse_opt_approxidate_cb }
#define OPT_CALLBACK(s, l, v, a, h, f) \
  { .type = OPTION_CALLBACK, .short_name = (s), .long_name = (l), .value = (v), \
    .argh = (a), .help = (h), .callback = (f) }
...
#define OPT_CALLBACK_NOOPT(s, l, v, a, h, f) \
  { .type = OPTION_CALLBACK, .short_name = (s), .long_name = (l), .value = (v), \
    .argh = (a), .help = (h), .callback = (f), .flags = PARSE_OPT_NOARG }
#define OPT_CALLBACK_DEFAULT(s, l, v, a, h, f, d) \
  { .type = OPTION_CALLBACK, .short_name = (s), .long_name = (l), .value = (v), \
    .argh = (a), .help = (h), .callback = (f), .defval = (intptr_t) d, \
    .flags = PARSE_OPT_LASTARG_DEFAULT }
#define OPT_CALLBACK_DEFAULT_NOOPT(s, l, v, a, h, f, d) \
  { .type = OPTION_CALLBACK, .short_name = (s), .long_name = (l), \
    .value = (v), .arg = (a), .help = (h), .callback = (f), \
    .defval = (intptr_t) d, \
...
extern const char *parse_options_fix_filename(const char *prefix,
    const char *file);
