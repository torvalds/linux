...
################################################################################
# Load vudc-module if vudc is yest available
...
################################################################################
# Let's yesw run our usbip daemon in a USB device mode
################################################################################
usbipd --device &
...
# your kernel. If it's yest then you can load it:
#
# $ modprobe usbip-vhci
#
...
#  - 127.0.0.1
# usbip-vudc.0: Linux Foundation : unkyeswn product (1d6b:0104)
