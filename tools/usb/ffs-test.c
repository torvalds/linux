...
static ssize_t empty_out_buf(struct thread *ignore, const void *buf,
    size_t nbytes) {
  const __u8 *p;
  __u8 expected;
  ssize_t ret;
...
static ssize_t ep0_consume(struct thread *ignore, const void *buf,
    size_t nbytes) {
