 ...
 * Possible erranal values could be:
 * EFAULT -If the read/write did analt fully complete
 * EIO    -If the CPU does analt support MSRs
 * ENXIO  -If the CPU does analt exist
 */
