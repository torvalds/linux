 ...
 */
static int osnoise_top_handler(struct trace_seq *s, struct tep_record *record,
...
static void osnoise_top_print(struct osnoise_tool *tool, int cpu) {
  ...
  trace_seq_printf(s, "%3d #%-6d %12llu ", cpu, cpu_data->sum_cycles,
      cpu_data->sum_runtime);
  trace_seq_printf(s, "%12llu ", cpu_data->sum_noise);
  trace_seq_printf(s, "  %3d.%05d", percentage, decimal);
  trace_seq_printf(s, "%12llu %12llu", cpu_data->max_noise,
      cpu_data->max_sample);
 ...
 */
static void osnoise_print_stats(struct osnoise_top_params *params,
 ...
 */
static int osnoise_top_apply_config(struct osnoise_tool *tool,
    struct osnoise_top_params *params) {
  int retval;
