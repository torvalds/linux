...
static __always_inline void write_or_die(int fd, const char *buf,
    size_t count) {
  ssize_t r;
  do {
...
static __always_inline void mutex_init(pthread_mutex_t *mutex,
...
static __always_inline int cond_timedwait(pthread_cond_t * restrict cond,
    pthread_mutex_t * restrict mutex,
...
static void show_usage(void) {
  printf(
      ...
      "\t\t\tThis options implies -x\n\n"
      ,
      prg_name, debug_tracefile_dflt, debug_maxlat_dflt,
      DEFAULT_NR_PRINTER_THREADS,
