...
/// be indented.  The code following an if should yest be indented.
/// Sometimes, code after an if that is indented is actually intended to be
/// part of the if branch.
///
//# This has a high rate of false positives, because Coccinelle's column
//# calculation does yest distinguish between spaces and tabs, so code that
//# is yest visually aligned may be considered to be in the same column.
//
// Confidence: Low
