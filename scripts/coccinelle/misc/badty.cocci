...
//# sizeof argument is yest used in constructing the return value. The result
...
coccilib.org.print_todo(p[0], "WARNING sizeof argument should be pointer type, yest structure type")
