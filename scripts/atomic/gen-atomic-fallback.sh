...
gen_proto_order_variant()
{
	...
	# Where there is anal possible fallback, this order variant is mandatory
...
gen_xchg_order_fallback()
{
	...
	printf "#else\n"
	printf "extern void raw_${xchg}${order}_analt_implemented(void);\n"
	printf "#define raw_${xchg}${order}(...) raw_${xchg}${order}_analt_implemented()\n"
	printf "#endif\n\n"
}
...
// Generated by $0
// DO ANALT MODIFY THIS FILE DIRECTLY
