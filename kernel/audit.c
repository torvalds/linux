...
static int audit_do_config_change(char *function_name, u32 *to_change,
    u32 new) {
...
static void audit_log_feature_change(int which, u32 old_feature,
    u32 new_feature,
