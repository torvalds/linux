 ...
 */
void kcsan_report_set_info(const volatile void *ptr, size_t size,
    int access_type,
 ...
 * thread.
 */
void kcsan_report_known_origin(const volatile void *ptr, size_t size,
    int access_type,
 ...
 */
void kcsan_report_unknown_origin(const volatile void *ptr, size_t size,
    int access_type,
