...
static int ptrace_check_attach(struct task_struct *child, bool ignore_state) {
  ...
  if (!ret && !ignore_state
      && WARN_ON_ONCE(!wait_task_inactive(child,
...
static int ptrace_getsiginfo(struct task_struct *child,
...
static unsigned long ptrace_get_syscall_info_entry(struct task_struct *child,
    struct pt_regs *regs,
...
static unsigned long ptrace_get_syscall_info_seccomp(struct task_struct *child,
    struct pt_regs *regs,
    struct ptrace_syscall_info *info) {
  /*
...
static unsigned long ptrace_get_syscall_info_exit(struct task_struct *child,
    struct pt_regs *regs,
    struct ptrace_syscall_info *info) {
