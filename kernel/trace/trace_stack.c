...
static ssize_t stack_max_size_read(struct file *filp, char __user *ubuf,
...
static ssize_t stack_max_size_write(struct file *filp, const char __user *ubuf,
    size_t count, loff_t *ppos) {
...
static void *__next(struct seq_file *m, loff_t *pos) {
  long n = *pos - 1;
