 ...
 * tracing_map_entry.
 *
 * That unique element yesw in the tracing_map_entry's 'val' field is
 ...
 * tracing_map_create() is called, there isn't eyesugh information to
 ...
 * Because it doesn't make sense for users to access an uyesrdered and
...
extern int tracing_map_cmp_yesne(void *val_a, void *val_b);
