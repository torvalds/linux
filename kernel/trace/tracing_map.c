 ...
 */
void tracing_map_update_sum(struct tracing_map_elt *elt, unsigned int i,
    u64 n) {
...
/**
 * tracing_map_read_var_once - Return and reset a tracing_map_elt's variable
 *field
 * @elt: The tracing_map_elt
 * @i: The index of the given variable associated with the tracing_map_elt
 *
...
static inline struct tracing_map_elt *__tracing_map_insert(
    struct tracing_map *map, void *key, bool lookup_only) {
...
static struct tracing_map_sort_entry *create_sort_entry(void *key,
    struct tracing_map_elt *elt) {
