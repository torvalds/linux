...
static nokprobe_inline struct trace_uprobe *trace_uprobe_primary_from_call(
...
static int append_trace_uprobe(struct trace_uprobe *tu,
...
static enum print_line_t print_uprobe_event(struct trace_iterator *iter,
    int flags,
...
static bool __uprobe_perf_filter(struct trace_uprobe_filter *filter,
    struct mm_struct *mm) {
...
static inline bool trace_uprobe_filter_event(struct trace_uprobe_filter *filter,
    struct perf_event *event) {
...
static int trace_uprobe_register(struct trace_event_call *event,
    enum trace_reg type,
    void *data) {
...
#ifdef CONFIG_PERF_EVENTS
struct trace_event_call *create_local_trace_uprobe(char *name,
    unsigned long offs,
