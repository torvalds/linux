 ...
 */
#undef __stack_array
#define __stack_array(type, item, size, \
      field)    type item[] __counted_by(field);
...
static inline bool still_need_pid_events(int type,
...
extern u64 tracing_event_time_stamp(struct trace_buffer *buffer,
...
static inline struct ring_buffer_iter *trace_buffer_iter(
...
struct ring_buffer_event *trace_buffer_lock_reserve(struct trace_buffer *buffer,
    int type,
    unsigned long len,
...
extern int trace_array_vprintk(struct trace_array *tr,
...
struct ftrace_func_entry *ftrace_lookup_ip(struct ftrace_hash *hash,
    unsigned long ip);
...
extern enum print_line_t print_graph_function_flags(struct trace_iterator *iter,
    u32 flags);
extern void print_graph_headers_flags(struct seq_file *s, u32 flags);
extern void trace_print_graph_duration(unsigned long long duration,
    struct trace_seq *s);
...
static inline enum print_line_t print_graph_function_flags(
...
static inline int ftrace_is_dead(void) {
  return 0;
}

static inline int ftrace_create_function_files(struct trace_array *tr,
    struct dentry *parent) {
  return 0;
}
...
static inline __init void ftrace_init_global_array_ops(struct trace_array *tr) {
}

static inline void ftrace_reset_array_ops(struct trace_array *tr) {
}

static inline void ftrace_init_tracefs(struct trace_array *tr,
    struct dentry *d) {
}
...
extern int register_ftrace_function_probe(char *glob, struct trace_array *tr,
    struct ftrace_probe_ops *ops, void *data);
extern int unregister_ftrace_function_probe_func(char *glob,
    struct trace_array *tr,
    struct ftrace_probe_ops *ops);
...
static inline __init int register_ftrace_command(
    struct ftrace_func_command *cmd) {
  return -EINVAL;
}
...
static inline void __trace_event_discard_commit(struct trace_buffer *buffer,
    struct ring_buffer_event *event) {
 ...
 */
static inline bool __event_trigger_test_discard(struct trace_event_file *file,
    struct trace_buffer *buffer,
    struct ring_buffer_event *event,
    void *entry,
 ...
 */
static inline void event_trigger_unlock_commit(struct trace_event_file *file,
    struct trace_buffer *buffer,
    struct ring_buffer_event *event,
...
extern enum regex_type filter_parse_regex(char *buff, int len, char **search,
    int *not);
...
struct ftrace_event_field *trace_find_event_field(struct trace_event_call *call,
    char *name);
...
extern int event_trace_add_tracer(struct dentry *parent,
    struct trace_array *tr);
...
#else
static inline int register_trigger_hist_cmd(void) {
  return 0;
}
...
extern void set_named_trigger_data(struct event_trigger_data *data,
    struct event_trigger_data *named_data);
extern struct event_trigger_data *get_named_trigger_data(
  struct event_trigger_data *data);
...
extern struct event_trigger_data *event_trigger_alloc(
  struct event_command *cmd_ops,
  char *cmd,
  char *param,
  void *private_data);
...
extern int tracing_snapshot_cond_enable(struct trace_array *tr, void *cond_data,
    cond_update_fn_t update);
...
static inline void trace_event_eval_update(struct trace_eval_map **map,
    int len) {
}
...
static inline int tracing_arm_snapshot(struct trace_array *tr) {
  return 0;
}
