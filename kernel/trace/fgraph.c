...
static int ftrace_push_return_trace(unsigned long ret, unsigned long func,
 ...
 */
static int ftrace_suspend_notifier_call(struct notifier_block *bl,
    unsigned long state,
    void *unused) {
  switch (state) {
 ...
 */
static unsigned long __ftrace_return_to_handler(
...
static void ftrace_graph_probe_sched_switch(void *ignore, bool preempt,
...
static void graph_init_task(struct task_struct *t,
