...
/*
 * stop_stop_kthread - Inform the hardware latency sampling/detector kthread to
 *stop
 *
...
/*
 * start_single_kthread - Kick off the hardware latency sampling/detector
 *kthread
 *
...
/*
 * stop_per_cpu_kthreads - Inform the hardware latency sampling/detector kthread
 *to stop
 *
