...
static nokprobe_inline void __fentry_trace_func(struct trace_fprobe *tf,
...
static void fentry_trace_func(struct trace_fprobe *tf, unsigned long entry_ip,
    struct pt_regs *regs) {
...
static nokprobe_inline void __fexit_trace_func(struct trace_fprobe *tf,
    unsigned long entry_ip,
    unsigned long ret_ip, struct pt_regs *regs,
...
static void fexit_trace_func(struct trace_fprobe *tf, unsigned long entry_ip,
...
static void fexit_perf_func(struct trace_fprobe *tf, unsigned long entry_ip,
    unsigned long ret_ip, struct pt_regs *regs,
    void *entry_data) {
  struct trace_event_call *call = trace_probe_event_call(&tf->tp);
  struct fexit_trace_entry_head *entry;
...
static enum print_line_t print_fentry_event(struct trace_iterator *iter,
    int flags,
...
static enum print_line_t print_fexit_event(struct trace_iterator *iter,
    int flags,
    struct trace_event *event) {
...
static int append_trace_fprobe(struct trace_fprobe *tf,
    struct trace_fprobe *to) {
  int ret;
