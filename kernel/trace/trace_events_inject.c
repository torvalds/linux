...
static int trace_inject_entry(struct trace_event_file *file, void *rec,
    int len) {
...
static int parse_field(char *str, struct trace_event_call *call,
...
static int parse_entry(char *str, struct trace_event_call *call,
    void **pentry) {
  struct ftrace_event_field *field;
  void *entry = NULL;
  int entry_size;
...
static ssize_t event_inject_write(struct file *filp, const char __user *ubuf,
    size_t cnt,
    loff_t *ppos) {
...
static ssize_t event_inject_read(struct file *file, char __user *buf,
    size_t size,
    loff_t *ppos) {
  return -EPERM;
}
