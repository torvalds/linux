 ...
 * any trigger that should be deferred, ETT_NONE if nothing to defer.
 */
enum event_trigger_type event_triggers_call(struct trace_event_file *file,
 ...
 * Called from tracepoint handlers (with rcu_read_lock_sched() held).
 */
void event_triggers_post_call(struct trace_event_file *file,
...
static ssize_t event_trigger_write(struct file *filp, const char __user *ubuf,
    size_t cnt, loff_t *ppos) {
  return event_trigger_regex_write(filp, ubuf, cnt, ppos);
}

static int event_trigger_open(struct inode *inode, struct file *filp) {
  /* Checks for tracefs lockdown */
  return event_trigger_regex_open(inode, filp);
}

static int event_trigger_release(struct inode *inode, struct file *file) {
 ...
 */
static int event_trigger_print(const char *name, struct seq_file *m,
 ...
 * implementations.
 */
static void event_trigger_free(struct event_trigger_data *data) {
 ...
 * @param_and_filter: The param and filter portion of the string used to
...
struct event_trigger_data *get_named_trigger_data(
    struct event_trigger_data *data) {
  return data->named_data;
}

static void traceon_trigger(struct event_trigger_data *data,
    struct trace_buffer *buffer, void *rec,
    struct ring_buffer_event *event) {
...
static void traceon_count_trigger(struct event_trigger_data *data,
    struct trace_buffer *buffer, void *rec,
    struct ring_buffer_event *event) {
  struct trace_event_file *file = data->private_data;
  if (file) {
...
static void traceoff_trigger(struct event_trigger_data *data,
    struct trace_buffer *buffer, void *rec,
    struct ring_buffer_event *event) {
  struct trace_event_file *file = data->private_data;
  if (file) {
...
static void traceoff_count_trigger(struct event_trigger_data *data,
    struct trace_buffer *buffer, void *rec,
    struct ring_buffer_event *event) {
  struct trace_event_file *file = data->private_data;
  if (file) {
...
static int traceon_trigger_print(struct seq_file *m,
    struct event_trigger_data *data) {
  return event_trigger_print("traceon", m, (void *) data->count,
      data->filter_str);
}

static int traceoff_trigger_print(struct seq_file *m,
    struct event_trigger_data *data) {
...
static struct event_trigger_ops *onoff_get_trigger_ops(char *cmd, char *param) {
...
static void snapshot_trigger(struct event_trigger_data *data,
    struct trace_buffer *buffer, void *rec,
    struct ring_buffer_event *event) {
  struct trace_event_file *file = data->private_data;
  if (file) {
...
static void snapshot_count_trigger(struct event_trigger_data *data,
    struct trace_buffer *buffer, void *rec,
    struct ring_buffer_event *event) {
  if (!data->count) {
    return;
...
static int register_snapshot_trigger(char *glob,
    struct event_trigger_data *data,
    struct trace_event_file *file) {
...
static int snapshot_trigger_print(struct seq_file *m,
    struct event_trigger_data *data) {
...
static struct event_trigger_ops *snapshot_get_trigger_ops(char *cmd,
    char *param) {
...
static void stacktrace_trigger(struct event_trigger_data *data,
    struct trace_buffer *buffer, void *rec,
    struct ring_buffer_event *event) {
  struct trace_event_file *file = data->private_data;
  if (file) {
...
static void stacktrace_count_trigger(struct event_trigger_data *data,
    struct trace_buffer *buffer, void *rec,
    struct ring_buffer_event *event) {
  if (!data->count) {
    return;
...
static int stacktrace_trigger_print(struct seq_file *m,
    struct event_trigger_data *data) {
...
static struct event_trigger_ops *stacktrace_get_trigger_ops(char *cmd,
    char *param) {
...
static void event_enable_trigger(struct event_trigger_data *data,
    struct trace_buffer *buffer, void *rec,
    struct ring_buffer_event *event) {
...
static void event_enable_count_trigger(struct event_trigger_data *data,
    struct trace_buffer *buffer, void *rec,
    struct ring_buffer_event *event) {
  struct enable_trigger_data *enable_data = data->private_data;
  if (!data->count) {
  ...
  if (enable_data->enable
      == !(enable_data->file->flags & EVENT_FILE_FL_SOFT_DISABLED)) {
    return;
  }
  if (data->count != -1) {
    (data->count)--;
...
static struct event_trigger_ops *event_enable_get_trigger_ops(char *cmd,
    char *param) {
  struct event_trigger_ops *ops;
  bool enable;
#ifdef CONFIG_HIST_TRIGGERS
