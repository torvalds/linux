 ...
 */
const char *trace_print_hex_seq(struct trace_seq *p, const unsigned char *buf,
    int buf_len,
    bool concatenate) {
  int i;
  const char *ret = trace_seq_buffer_ptr(p);
...
const char *trace_print_array_seq(struct trace_seq *p, const void *buf,
    int count,
    size_t el_size) {
  const char *ret = trace_seq_buffer_ptr(p);
  const char *prefix = "";
...
const char *trace_print_hex_dump_seq(struct trace_seq *p,
...
void trace_seq_print_sym(struct trace_seq *s, unsigned long address,
    bool offset) {
...
int seq_print_ip_sym(struct trace_seq *s, unsigned long ip,
...
static int lat_print_generic(struct trace_seq *s, struct trace_entry *entry,
    int cpu) {
...
static int lat_print_timestamp(struct trace_iterator *iter, u64 next_ts) {
...
static void print_fields(struct trace_iterator *iter,
...
/* TRACE_HWLAT */
static enum print_line_t trace_hwlat_print(struct trace_iterator *iter,
    int flags,
    struct trace_event *event) {
  struct trace_entry *entry = iter->ent;
  struct trace_seq *s = &iter->seq;
...
/* TRACE_OSNOISE */
static enum print_line_t trace_osnoise_print(struct trace_iterator *iter,
    int flags,
    struct trace_event *event) {
  struct trace_entry *entry = iter->ent;
  struct trace_seq *s = &iter->seq;
...
static enum print_line_t trace_osnoise_raw(struct trace_iterator *iter,
    int flags,
    struct trace_event *event) {
  struct osnoise_entry *field;
  struct trace_seq *s = &iter->seq;
...
static enum print_line_t trace_timerlat_print(struct trace_iterator *iter,
    int flags,
    struct trace_event *event) {
  struct trace_entry *entry = iter->ent;
  struct trace_seq *s = &iter->seq;
...
static enum print_line_t trace_timerlat_raw(struct trace_iterator *iter,
    int flags,
    struct trace_event *event) {
  struct timerlat_entry *field;
  struct trace_seq *s = &iter->seq;
...
/* TRACE_BPUTS */
static enum print_line_t trace_bputs_print(struct trace_iterator *iter,
    int flags,
    struct trace_event *event) {
  struct trace_entry *entry = iter->ent;
  struct trace_seq *s = &iter->seq;
...
static enum print_line_t trace_bputs_raw(struct trace_iterator *iter, int flags,
    struct trace_event *event) {
  struct bputs_entry *field;
  struct trace_seq *s = &iter->seq;
  trace_assign_type(field, iter->ent);
...
/* TRACE_BPRINT */
static enum print_line_t trace_bprint_print(struct trace_iterator *iter,
    int flags,
    struct trace_event *event) {
  struct trace_entry *entry = iter->ent;
  struct trace_seq *s = &iter->seq;
...
static enum print_line_t trace_bprint_raw(struct trace_iterator *iter,
    int flags,
    struct trace_event *event) {
  struct bprint_entry *field;
  struct trace_seq *s = &iter->seq;
...
static enum print_line_t trace_func_repeats_raw(struct trace_iterator *iter,
    int flags,
    struct trace_event *event) {
...
static enum print_line_t trace_func_repeats_print(struct trace_iterator *iter,
    int flags,
    struct trace_event *event) {
  struct func_repeats_entry *field;
  struct trace_seq *s = &iter->seq;
