 ...
 */
static const char **find_next_mod_format(int start_index, void *v,
...
#else /* !CONFIG_MODULES */
__init static int module_trace_bprintk_format_notify(
    struct notifier_block *self,
    unsigned long val, void *data) {
  return NOTIFY_OK;
}

static inline const char **find_next_mod_format(int start_index, void *v,
    const char **fmt, loff_t *pos) {
  return NULL;
}
...
static int ftrace_formats_open(struct inode *inode, struct file *file) {
  int ret;
