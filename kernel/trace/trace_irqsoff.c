...
static inline int preempt_trace(int pc) {
...
static inline int irq_trace(void) {
 ...
 */
static void irqsoff_tracer_call(unsigned long ip, unsigned long parent_ip,
...
static void __trace_function(struct trace_array *tr,
...
static void check_critical_timing(struct trace_array *tr,
    struct trace_array_cpu *data,
...
static nokprobe_inline void start_critical_timing(unsigned long ip,
    unsigned long parent_ip) {
  int cpu;
  struct trace_array *tr = irqsoff_trace;
  struct trace_array_cpu *data;
...
static nokprobe_inline void stop_critical_timing(unsigned long ip,
    unsigned long parent_ip) {
  int cpu;
  struct trace_array *tr = irqsoff_trace;
  struct trace_array_cpu *data;
...
static int register_irqsoff_function(struct trace_array *tr, int graph,
    int set) {
  int ret;
...
static inline int irqsoff_function_set(struct trace_array *tr, u32 mask,
    int set) {
  return 0;
}
