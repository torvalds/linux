...
static struct bpf_local_storage_data *task_storage_lookup(
    struct task_struct *task, struct bpf_map *map,
    bool cacheit_lockit) {
...
BPF_CALL_5(bpf_task_storage_get_recur, struct bpf_map *, map,
    struct task_struct *,
...
BPF_CALL_2(bpf_task_storage_delete_recur, struct bpf_map *, map,
    struct task_struct *,
    task)
{
  bool nobusy;
...
BTF_ID_LIST_GLOBAL_SINGLE(bpf_local_storage_map_btf_id, struct,
