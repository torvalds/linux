...
static inline bool bpf_iter_target_support_resched(
...
static const struct bpf_iter_seq_info *__get_seq_info(
...
const struct bpf_func_proto *bpf_iter_get_func_proto(enum bpf_func_id func_id,
...
__bpf_kfunc int bpf_iter_num_new(struct bpf_iter_num *it, int start, int end) {
  ...
  BUILD_BUG_ON(__alignof__(struct bpf_iter_num_kern)
