...
static struct dentry *bpf_lookup(struct inode *dir, struct dentry *dentry,
    unsigned flags) {
...
static struct bpf_prog *__get_prog_inode(struct inode *inode,
...
static bool find_btf_enum_const(const struct btf *btf,
