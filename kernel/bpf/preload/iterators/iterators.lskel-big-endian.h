...
static inline int iterators_bpf__dump_bpf_map__attach(
...
static inline int iterators_bpf__dump_bpf_prog__attach(
    struct iterators_bpf *skel) {
...
static inline int iterators_bpf__attach(struct iterators_bpf *skel) {
  int ret = 0;
...
static inline void iterators_bpf__detach(struct iterators_bpf *skel) {
  skel_closenz(skel->links.dump_bpf_map_fd);
  skel_closenz(skel->links.dump_bpf_prog_fd);
}

static void iterators_bpf__destroy(struct iterators_bpf *skel) {
  if (!skel) {
    return;
  }
...
static inline struct iterators_bpf *iterators_bpf__open(void) {
  struct iterators_bpf *skel;
...
static inline int iterators_bpf__load(struct iterators_bpf *skel) {
...
static inline struct iterators_bpf *iterators_bpf__open_and_load(void) {
  struct iterators_bpf *skel;
...
__attribute__((unused)) static void iterators_bpf__assert(struct iterators_bpf *s __attribute__(
      (unused))) {
#ifdef __cplusplus
