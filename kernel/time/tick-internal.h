...
static inline enum clock_event_state clockevent_get_state(
...
static inline bool tick_resume_check_broadcast(void) {
  return false;
}
...
static inline bool tick_oneshot_possible(void) {
  return true;
}
