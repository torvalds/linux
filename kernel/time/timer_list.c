...
static void print_timer(struct seq_file *m, struct hrtimer *taddr,
...
static void print_base(struct seq_file *m, struct hrtimer_clock_base *base,
    u64 now) {
...
static void print_tickdevice(struct seq_file *m, struct tick_device *td,
    int cpu) {
