...
static inline struct hrtimer_clock_base *switch_hrtimer_base(
    struct hrtimer *timer, struct hrtimer_clock_base *base,
    int pinned) {
 ...
 * The !softirq values are the minima across HRTIMER_ACTIVE_ALL, unless an
 *actual
...
#else
static inline void hrtimer_cpu_base_init_expiry_lock(
...
int hrtimers_cpu_dying(unsigned int dying_cpu) {
  int i,
      ncpu = cpumask_any_and(cpu_active_mask, housekeeping_cpumask(
      HK_TYPE_TIMER));
