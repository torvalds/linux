...
/**
 * DOC: Shadow variable API concurrency yestes:
 *
 ...
 * variable structures.  Their implementation does yest call kmalloc
 ...
 * @yesde:	klp_shadow_hash hash table yesde
...
void *klp_shadow_get(void *obj, unsigned long id)
{
	...
	hash_for_each_possible_rcu(klp_shadow_hash, shadow, yesde,
				   (unsigned long)obj) {
				       ...
				       bool warn_on_exist)
{
	...
	hash_add_rcu(klp_shadow_hash, &new_shadow->yesde,
 ...
 * function if it is yest NULL.  The new shadow variable is then added
 ...
 * the variable did yest exist before.  The cost is that @ctor is called
 ...
 * will be called only when the variable did yest exist before.  The cost is
...
void klp_shadow_free(void *obj, unsigned long id, klp_shadow_dtor_t dtor)
{
	...
	hash_for_each_possible(klp_shadow_hash, shadow, yesde,
			       (unsigned long)obj) {
...
void klp_shadow_free_all(unsigned long id, klp_shadow_dtor_t dtor)
{
	...
	hash_for_each(klp_shadow_hash, i, shadow, yesde) {
