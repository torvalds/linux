 ...
 * system state.
 *
 * The same system state can be modified by more yesn-cumulative
 ...
 *	installed livepatches, NULL when yest found.
 */
...
/*
 * Check that the new livepatch will yest break the existing system states.
