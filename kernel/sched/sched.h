 ...
 */
static inline bool sched_cpu_cookie_match(struct rq *rq,
...
static inline bool sched_core_cookie_match(struct rq *rq,
    struct task_struct *p) {
  bool idle_core = true;
  int cpu;
  /* Ignore cookie match if core scheduler is not enabled on the CPU. */
 ...
 */
static inline void double_rq_clock_clear_update(struct rq *rq1,
    struct rq *rq2) {
