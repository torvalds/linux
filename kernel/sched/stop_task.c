...
static int balance_stop(struct rq *rq, struct task_struct *prev,
    struct rq_flags *rf) {
...
static void wakeup_preempt_stop(struct rq *rq, struct task_struct *p,
    int flags) {
 ...
 * parameters.
 */
static void task_tick_stop(struct rq *rq, struct task_struct *curr,
    int queued) {
}
