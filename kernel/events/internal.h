...
extern struct perf_buffer *rb_alloc(int nr_pages, long watermark, int cpu,
    int flags);
...
extern struct page *perf_mmap_to_page(struct perf_buffer *rb,
    unsigned long pgoff);
...
static inline unsigned long __output_custom(struct perf_output_handle *handle,
...
static inline unsigned long memcpy_common(void *dst, const void *src,
    unsigned long n) {
  memcpy(dst, src, n);
  return 0;
}
...
static inline unsigned long memcpy_skip(void *dst, const void *src,
    unsigned long n) {
  return 0;
}
...
static inline unsigned long arch_perf_out_copy_user(void *dst, const void *src,
    unsigned long n) {
  unsigned long ret;
  pagefault_disable();
