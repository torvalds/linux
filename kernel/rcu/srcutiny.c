 ...
 *	tiny version for yesn-preemptible single-CPU use.
 *
...
void srcu_drive_gp(struct work_struct *wp)
{
	...
	if (ssp->srcu_gp_running || !READ_ONCE(ssp->srcu_cb_head))
		return; /* Already running or yesthing to do. */
 ...
 * initiating grace-period processing if it is yest already running.
 */
