...
static inline bool rcu_segcblist_completely_offloaded(
 ...
 */
static inline bool rcu_segcblist_restempty(struct rcu_segcblist *rsclp,
    int seg) {
 ...
 * empty of callbacks?
 */
static inline bool rcu_segcblist_segempty(struct rcu_segcblist *rsclp,
    int seg) {
