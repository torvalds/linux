 ...
 */
static inline bool __mutex_trylock_or_handoff(struct mutex *lock,
    bool handoff) {
...
static inline bool __mutex_waiter_is_first(struct mutex *lock,
  ...
  return list_first_entry(&lock->wait_list, struct mutex_waiter,
      list) == waiter;
}
 ...
 */
static __always_inline int __sched __mutex_lock_common(struct mutex *lock,
    unsigned int state,
...
static int __sched __ww_mutex_lock(struct mutex *lock, unsigned int state,
    unsigned int subclass,
...
static noinline int __sched __mutex_lock_interruptible_slowpath(
  struct mutex *lock);
