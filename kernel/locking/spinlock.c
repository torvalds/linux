...
noinline void __lockfunc _raw_read_unlock_irqrestore(rwlock_t *lock,
    unsigned long flags) {
...
#define __raw_write_lock_nested(lock, \
      subclass) __raw_write_lock(((void) (subclass), (lock)))
#endif
...
noinline void __lockfunc _raw_write_unlock_irqrestore(rwlock_t *lock,
    unsigned long flags) {
