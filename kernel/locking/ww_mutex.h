...
static inline struct mutex_waiter *__ww_waiter_first(struct mutex *lock) {
...
static inline struct mutex_waiter *__ww_waiter_next(struct mutex *lock,
    struct mutex_waiter *w) {
...
static inline struct mutex_waiter *__ww_waiter_prev(struct mutex *lock,
    struct mutex_waiter *w) {
...
static inline struct mutex_waiter *__ww_waiter_last(struct mutex *lock) {
  struct mutex_waiter *w;
...
static inline void __ww_waiter_add(struct mutex *lock,
...
static inline struct task_struct *__ww_mutex_owner(struct mutex *lock) {
  return __mutex_owner(lock);
}

static inline bool __ww_mutex_has_waiters(struct mutex *lock) {
...
static inline struct rt_mutex_waiter *__ww_waiter_first(struct rt_mutex *lock) {
...
static inline struct rt_mutex_waiter *__ww_waiter_next(struct rt_mutex *lock,
...
static inline struct rt_mutex_waiter *__ww_waiter_prev(struct rt_mutex *lock,
    struct rt_mutex_waiter *w) {
...
static inline struct rt_mutex_waiter *__ww_waiter_last(struct rt_mutex *lock) {
...
static inline void __ww_waiter_add(struct rt_mutex *lock,
    struct rt_mutex_waiter *waiter,
    struct rt_mutex_waiter *pos) {
  /* RT unconditionally adds the waiter first and then removes it on error */
}

static inline struct task_struct *__ww_mutex_owner(struct rt_mutex *lock) {
  return rt_mutex_owner(&lock->rtmutex);
}

static inline bool __ww_mutex_has_waiters(struct rt_mutex *lock) {
 ...
 */
static inline bool __ww_ctx_less(struct ww_acquire_ctx *a,
 ...
 */
static void __ww_mutex_check_waiters(struct MUTEX *lock,
    struct ww_acquire_ctx *ww_ctx) {
...
static __always_inline int __ww_mutex_kill(struct MUTEX *lock,
    struct ww_acquire_ctx *ww_ctx) {
 ...
 */
static inline int __ww_mutex_check_kill(struct MUTEX *lock,
    struct MUTEX_WAITER *waiter,
    struct ww_acquire_ctx *ctx) {
 ...
 */
static inline int __ww_mutex_add_waiter(struct MUTEX_WAITER *waiter,
    struct MUTEX *lock,
    struct ww_acquire_ctx *ww_ctx) {
