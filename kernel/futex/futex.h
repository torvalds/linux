...
extern int get_futex_key(u32 __user *uaddr, unsigned int flags,
    union futex_key *key,
    enum futex_access rw);

extern struct hrtimer_sleeper *futex_setup_timer(ktime_t *time,
...
extern int futex_cmpxchg_value_locked(u32 *curval, u32 __user *uaddr, u32 uval,
    u32 newval);
...
extern int futex_wake(u32 __user *uaddr, unsigned int flags, int nr_wake,
    u32 bitset);
