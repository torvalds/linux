...
#define CL_SEQR9	0x9	/* Scratch Pad 0 (do yest access!) */
#define CL_SEQRA	0xa	/* Scratch Pad 1 (do yest access!) */
...
#define CL_SEQR14	0x14	/* Scratch Pad 2 (CL-GD5426/'28 Only) (do yest access!) */
#define CL_SEQR15	0x15	/* Scratch Pad 3 (CL-GD5426/'28 Only) (do yest access!) */
...
#define CL_SEQR1B	0x1b	/* VCLK0 Deyesminator and Post-Scalar Value */
#define CL_SEQR1C	0x1c	/* VCLK1 Deyesminator and Post-Scalar Value */
#define CL_SEQR1D	0x1d	/* VCLK2 Deyesminator and Post-Scalar Value */
#define CL_SEQR1E	0x1e	/* VCLK3 Deyesminator and Post-Scalar Value */
...
#define CL_CRT1E	0x1e	/* Ayesther overflow register */
...
#define CL_GR33		0x33	/* ayesther P4 "compat" register.. */
