...
#define S1DREG_LCD_CLK_CNF    0x0014  /* LCD Pixel Clock Configuration Register
                                       * */
#define S1DREG_CRT_CLK_CNF    0x0018  /* CRT/TV Pixel Clock Configuration
                                       * Register */
#define S1DREG_MPLUG_CLK_CNF    0x001C  /* MediaPlug Clock Configuration
                                         * Register */
#define S1DREG_CPU2MEM_WST_SEL    0x001E  /* CPU To Memory Wait State Select
                                           * Register */
...
#define S1DREG_LCD_NDISP_HPER   0x0034  /* LCD Horizontal Non-Display Period
                                         * Register: ((val)+1)*8)=NDpix/line */
...
#define S1DREG_LCD_DISP_VHEIGHT1  0x0039  /* LCD Vertical Display Height
                                           * Register 1 */
#define S1DREG_LCD_NDISP_VPER   0x003A  /* LCD Vertical Non-Display Period
                                         * Register: (val)+1=NDlines */
...
#define S1DREG_LCD_DISP_START0    0x0042  /* LCD Display Start Address Register
                                           * 0 */
#define S1DREG_LCD_DISP_START1    0x0043  /* LCD Display Start Address Register
                                           * 1 */
#define S1DREG_LCD_DISP_START2    0x0044  /* LCD Display Start Address Register
                                           * 2 */
...
#define S1DREG_LCD_DISP_FIFO_HTC  0x004A  /* LCD Display FIFO High Threshold
                                           * Control Register */
#define S1DREG_LCD_DISP_FIFO_LTC  0x004B  /* LCD Display FIFO Low Threshold
                                           * Control Register */
#define S1DREG_CRT_DISP_HWIDTH    0x0050  /* CRT/TV Horizontal Display Width
                                           * Register: ((val)+1)*8)=pix/line */
#define S1DREG_CRT_NDISP_HPER   0x0052  /* CRT/TV Horizontal Non-Display Period
                                         * Register */
...
#define S1DREG_CRT_DISP_VHEIGHT0  0x0056  /* CRT/TV Vertical Display Height
                                           * Register 0 */
#define S1DREG_CRT_DISP_VHEIGHT1  0x0057  /* CRT/TV Vertical Display Height
                                           * Register 1 */
#define S1DREG_CRT_NDISP_VPER   0x0058  /* CRT/TV Vertical Non-Display Period
                                         * Register */
...
#define S1DREG_CRT_DISP_FIFO_HTC  0x006A  /* CRT/TV Display FIFO High Threshold
                                           * Control Register */
#define S1DREG_CRT_DISP_FIFO_LTC  0x006B  /* CRT/TV Display FIFO Low Threshold
                                           * Control Register */
...
#define S1DREG_LCD_CUR_RCTL1    0x007C  /* LCD Ink/Cursor Red Color 1 Register
                                         * */
#define S1DREG_LCD_CUR_FIFO_HTC   0x007E  /* LCD Ink/Cursor FIFO High Threshold
                                           * Register */
#define S1DREG_CRT_CUR_CTL    0x0080  /* CRT/TV Ink/Cursor Control Register */
#define S1DREG_CRT_CUR_START    0x0081  /* CRT/TV Ink/Cursor Start Address
                                         * Register */
...
#define S1DREG_CRT_CUR_YPOS1    0x0085  /* CRT/TV Cursor Y Position Register 1
                                         * */
#define S1DREG_CRT_CUR_BCTL0    0x0086  /* CRT/TV Ink/Cursor Blue Color 0
                                         * Register */
#define S1DREG_CRT_CUR_GCTL0    0x0087  /* CRT/TV Ink/Cursor Green Color 0
                                         * Register */
#define S1DREG_CRT_CUR_RCTL0    0x0088  /* CRT/TV Ink/Cursor Red Color 0
                                         * Register */
#define S1DREG_CRT_CUR_BCTL1    0x008A  /* CRT/TV Ink/Cursor Blue Color 1
                                         * Register */
#define S1DREG_CRT_CUR_GCTL1    0x008B  /* CRT/TV Ink/Cursor Green Color 1
                                         * Register */
#define S1DREG_CRT_CUR_RCTL1    0x008C  /* CRT/TV Ink/Cursor Red Color 1
                                         * Register */
#define S1DREG_CRT_CUR_FIFO_HTC   0x008E  /* CRT/TV Ink/Cursor FIFO High
                                           * Threshold Register */
...
#define S1DREG_BBLT_SRC_START2    0x0106  /* BitBLT Source Start Address
                                           * Register 2 */
#define S1DREG_BBLT_DST_START0    0x0108  /* BitBLT Destination Start Address
                                           * Register 0 */
#define S1DREG_BBLT_DST_START1    0x0109  /* BitBLT Destination Start Address
                                           * Register 1 */
#define S1DREG_BBLT_DST_START2    0x010A  /* BitBLT Destination Start Address
                                           * Register 2 */
#define S1DREG_BBLT_MEM_OFF0    0x010C  /* BitBLT Memory Address Offset Register
                                         * 0 */
#define S1DREG_BBLT_MEM_OFF1    0x010D  /* BitBLT Memory Address Offset Register
                                         * 1 */
...
#define S1DREG_CPU2MEM_WDOGT    0x01F4  /* CPU-to-Memory Access Watchdog Timer
                                         * Register */
