 ...
 *
 * ipu_image_convert_run must be dynamically allocated (_yest_ as a local
...
/**
 * ipu_image_convert() - asynchroyesus image conversion request
 *
 ...
 * the context when yes more conversion requests are needed.
 */
struct ipu_image_convert_run *
...
/**
 * ipu_image_convert_sync() - synchroyesus single image conversion request
 *
 * @ipu:	the IPU handle to use for the conversion
 * @ic_task:	the IC task to use for the conversion
 * @in:		input image format
