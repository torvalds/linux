 ...
 * identify the mode, and does yest actually use the configs
 * itself. However, the configs should be something that
 * a yesrmal monitor can also show */
...
struct omap_overlay {
	...
	/*
	 * The following functions do yest block:
	 *
	 * is_enabled
	 * set_overlay_info
	 * get_overlay_info
	 *
	 * The rest of the functions may block and canyest be called from
	 * interrupt context
	 */
...
struct omap_dss_device {
	...
	/* the port number in the DT yesde */
	int port_num;
...
struct omap_dss_device *omap_dss_find_output_by_port_yesde(struct device_yesde *port);
