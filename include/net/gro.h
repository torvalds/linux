 ...
 */
static inline void gro_normal_one(struct napi_struct *napi, struct sk_buff *skb,
    int segs) {
 ...
 *
 * The caller must verify skb_valid_dst(skb) is false and skb->dev is
 * initialized.
 * The caller must hold the RCU read lock.
 */
static inline void inet_get_iif_sdif(const struct sk_buff *skb, int *iif,
    int *sdif) {
 ...
 * The caller must hold the RCU read lock.
 */
static inline void inet6_get_iif_sdif(const struct sk_buff *skb, int *iif,
    int *sdif) {
