...
static inline struct net_device *dsa_port_bridge_dev_get(
    const struct dsa_port *dp) {
...
static inline bool dsa_port_offloads_bridge_dev(struct dsa_port *dp,
...
static inline bool dsa_tree_offloads_bridge_dev(struct dsa_switch_tree *dst,
    const struct net_device *bridge_dev) {
  struct dsa_port *dp;
  list_for_each_entry(dp, &dst->ports, list)
