...
static inline bool dissector_uses_key(
    const struct flow_dissector *flow_dissector,
    enum flow_dissector_key_id key_id) {
  return flow_dissector->used_keys & (1ULL << key_id);
}

static inline void *skb_flow_dissector_target(
...
static inline void flow_dissector_init_keys(
