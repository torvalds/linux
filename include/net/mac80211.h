 ...
 *  Greenfield mode.
 * @IEEE80211_TX_RC_40_MHZ_WIDTH: Indicates if the Channel Width should be 40
 * MHz.
...
static inline u8 ieee80211_rate_get_vht_mcs(
    const struct ieee80211_tx_rate *rate) {
  return rate->idx & 0xF;
}

static inline u8 ieee80211_rate_get_vht_nss(
    const struct ieee80211_tx_rate *rate) {
  return (rate->idx >> 4) + 1;
}
...
static inline u16 ieee80211_info_set_tx_time_est(struct ieee80211_tx_info *info,
    u16 tx_time_est) {
...
static inline u16 ieee80211_info_get_tx_time_est(struct ieee80211_tx_info *info)
{
  return info->tx_time_est << 2;
}
...
static inline u32 ieee80211_rx_status_to_khz(
...
static inline struct ieee80211_rate *ieee80211_get_tx_rate(
...
static inline struct ieee80211_rate *ieee80211_get_rts_cts_rate(
    const struct ieee80211_hw *hw,
    const struct ieee80211_tx_info *c) {
...
static inline struct ieee80211_rate *ieee80211_get_alt_retry_rate(
    const struct ieee80211_hw *hw,
 ...
 * @add_twt_setup: Update hw with TWT agreement parameters received from the
 * peer.
 ...
 */
static inline const char *ieee80211_create_tpt_led_trigger(
 ...
 */
struct sk_buff *ieee80211_beacon_get_template_ema_index(struct ieee80211_hw *hw,
    struct ieee80211_vif *vif,
    struct ieee80211_mutable_offsets *offs,
 ...
 *  %NULL on error.
 */
struct ieee80211_ema_beacons *ieee80211_beacon_get_template_ema_list(
...
/**
 * ieee80211_beacon_update_cntdwn - request mac80211 to decrement the beacon
 * countdown
 * @vif: &struct ieee80211_vif pointer from the add_interface callback.
 ...
 * @hw: pointer obtained from ieee80211_alloc_hw().
 * @vif: &struct ieee80211_vif pointer from the add_interface callback.
 * @frame: pointer to the frame that is going to be protected by the
 * CTS-to-self.
 * @frame_len: the frame length (in octets).
 * @frame_txctl: &struct ieee80211_tx_info of the frame.
 ...
 * @hw: pointer obtained from ieee80211_alloc_hw().
 * @vif: &struct ieee80211_vif pointer from the add_interface callback.
 * @frame_len: the length of the frame that is going to be protected by the
 * CTS-to-self.
 * @frame_txctl: &struct ieee80211_tx_info of the frame.
 *
 ...
 * @data: first argument of the iterator function
 */
static inline void ieee80211_iterate_active_interfaces(struct ieee80211_hw *hw,
    u32 iter_flags,
    void (*iterator)(void *data, u8 *mac,
    struct ieee80211_vif *vif),
    void *data) {
 ...
 */
struct ieee80211_sta *ieee80211_find_sta_by_link_addrs(struct ieee80211_hw *hw,
    const u8 *addr,
    const u8 *localaddr,
    unsigned int *link_id);
 ...
 * switch can request to block the tx and so, we need to make sure we do not
 * send
...
static inline bool conf_is_ht20(struct ieee80211_conf *conf) {
  return conf->chandef.width == NL80211_CHAN_WIDTH_20;
}

static inline bool conf_is_ht40_minus(struct ieee80211_conf *conf) {
  return conf->chandef.width == NL80211_CHAN_WIDTH_40
    && conf->chandef.center_freq1 < conf->chandef.chan->center_freq;
}

static inline bool conf_is_ht40_plus(struct ieee80211_conf *conf) {
  return conf->chandef.width == NL80211_CHAN_WIDTH_40
    && conf->chandef.center_freq1 > conf->chandef.chan->center_freq;
}

static inline bool conf_is_ht40(struct ieee80211_conf *conf) {
  return conf->chandef.width == NL80211_CHAN_WIDTH_40;
}

static inline bool conf_is_ht(struct ieee80211_conf *conf) {
...
static inline enum nl80211_iftype ieee80211_vif_type_p2p(
    struct ieee80211_vif *vif) {
 ...
 */
static inline const struct ieee80211_sta_he_cap *ieee80211_get_he_iftype_cap_vif(
 ...
 */
static inline __le16 ieee80211_get_he_6ghz_capa_vif(
    const struct ieee80211_supported_band *sband,
    struct ieee80211_vif *vif) {
 ...
 */
struct sk_buff *ieee80211_get_unsol_bcast_probe_resp_tmpl(
  struct ieee80211_hw *hw,
  struct ieee80211_vif *vif);
