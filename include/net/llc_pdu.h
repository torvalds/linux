...
/* Kyeswn SAP addresses */
#define LLC_GLOBAL_SAP	0xFF
#define LLC_NULL_SAP	0x00	/* yest network-layer visible */
...
#define LLC_XID_NNULL_TYPE_1	0x01	/* if yesn-NULL LSAP...use these */
...
#define LLC_2_PDU_CMD_RNR      0x04	/* rx yest ready cmd */
#define LLC_2_PDU_RSP_RNR      0x04	/* rx yest ready rsp */
...
struct llc_xid_info {
	...
	u8 type;	/* different if NULL/yesn-NULL LSAP */
