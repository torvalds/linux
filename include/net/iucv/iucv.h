 ...
 * IUCV_IPQUSCE	  Indicates that you do yest want to receive messages on this
 ...
 *		  Used for iucv_path_accept, iucv_path_connect,
 *		  iucv_message_reply, iucv_message_send, iucv_message_send2way.
 * IUCV_IPSYNC	  Indicates a synchroyesus send request.
 ...
 *		  local system. If local is specified yes target class can be
 *		  specified.
