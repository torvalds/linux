...
static inline struct inet_hashinfo *tcp_or_dccp_get_hashinfo(
...
static inline struct inet_listen_hashbucket *inet_lhash2_bucket(
    struct inet_hashinfo *h, u32 hash) {
...
struct inet_bind2_bucket *inet_bind2_bucket_find(
  const struct inet_bind_hashbucket *head,
...
static inline struct inet_bind_hashbucket *inet_bhashfn_portaddr(
    const struct inet_hashinfo *hinfo, const struct sock *sk,
    const struct net *net, unsigned short port) {
  u32 hash;
#if IS_ENABLED(CONFIG_IPV6)
...
struct inet_bind_hashbucket *inet_bhash2_addr_any_hashbucket(
...
#define INET_COMBINED_PORTS(__sport, __dport) \
  ((__force __portpair) (((__force __u32) (__be16) (__sport) << \
    16) | (__u32) (__dport)))
#else /* __LITTLE_ENDIAN */
#define INET_COMBINED_PORTS(__sport, __dport) \
  ((__force __portpair) (((__u32) (__dport) << \
    16) | (__force __u32) (__be16) (__sport)))
#endif
