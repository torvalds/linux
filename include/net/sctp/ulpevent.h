 ...
 * growing this structure as it is at the maximum limit yesw.
 *
...
int sctp_ulpevent_is_yestification(const struct sctp_ulpevent *);
					    ...
					    __u16 subscribe)
{
	...
	sn_type = sctp_ulpevent_get_yestification_type(event);
