 ...
 */
static inline void ieee802154_be64_to_le64(void *le64_dst,
    const void *be64_src) {
 ...
 */
static inline void ieee802154_le64_to_be64(void *be64_dst,
    const void *le64_src) {
 ...
 */
static inline void ieee802154_le16_to_be16(void *be16_dst,
    const void *le16_src) {
 ...
 */
static inline void ieee802154_be16_to_le16(void *le16_dst,
    const void *be16_src) {
 ...
 *                            because of a hardware error (bus error, timeout,
 * etc)
 *
 * @hw: pointer as obtained from ieee802154_alloc_hw().
 * @skb: buffer for transmission
