 ...
 */
static inline void _ieee80211_set_sband_iftype_data(
 ...
 */
static inline const struct ieee80211_sta_he_cap *ieee80211_get_he_iftype_cap(
    const struct ieee80211_supported_band *sband,
    u8 iftype) {
  const struct ieee80211_sband_iftype_data *data
 ...
 */
static inline __le16 ieee80211_get_he_6ghz_capa(
    const struct ieee80211_supported_band *sband,
 ...
 */
static inline const struct ieee80211_sta_eht_cap *ieee80211_get_eht_iftype_cap(
    const struct ieee80211_supported_band *sband,
    enum nl80211_iftype iftype) {
  const struct ieee80211_sband_iftype_data *data
    = ieee80211_get_sband_iftype_data(sband, iftype);
 ...
 */
static inline bool cfg80211_chandef_identical(
    const struct cfg80211_chan_def *chandef1,
 ...
 */
static inline enum ieee80211_rate_flags ieee80211_chanwidth_rate_flags(
    enum nl80211_chan_width width) {
  switch (width) {
 ...
 */
static inline enum ieee80211_rate_flags ieee80211_chandef_rate_flags(
...
static inline void get_random_mask_addr(u8 *buf, const u8 *addr,
    const u8 *mask) {
  int i;
 ...
 * Return: The channel struct from @wiphy at @freq.
 */
static inline struct ieee80211_channel *ieee80211_get_channel(
    struct wiphy *wiphy, int freq) {
 ...
 * byte array to match.
 */
static inline const u8 *cfg80211_find_ie_match(u8 eid, const u8 *ies,
    unsigned int len,
    const u8 *match, unsigned int match_len,
    unsigned int match_offset) {
 ...
 * having to fit into the given data.
 */
static inline const struct element *cfg80211_find_ext_elem(u8 ext_eid,
    const u8 *ies,
    int len) {
 ...
 * having to fit into the given data.
 */
static inline const u8 *cfg80211_find_ext_ie(u8 ext_eid, const u8 *ies,
    int len) {
...
/**
 * cfg80211_sched_scan_stopped_locked - notify that the scheduled scan has
 * stopped
 *
 * @wiphy: the wiphy on which the scheduled scan stopped
 * @reqid: identifier for the related scheduled scan request
 ...
 * Or %NULL on error.
 */
struct cfg80211_bss *__must_check cfg80211_inform_bss_data(struct wiphy *wiphy,
    struct cfg80211_inform_bss *data,
...
static inline struct cfg80211_bss *__must_check cfg80211_inform_bss(
    struct wiphy *wiphy,
    struct ieee80211_channel *rx_channel,
    enum cfg80211_bss_frame_type ftype,
    const u8 *bssid, u64 tsf, u16 capability,
 ...
 */
static inline struct cfg80211_bss *cfg80211_get_bss(struct wiphy *wiphy,
    struct ieee80211_channel *channel,
...
static inline struct cfg80211_bss *cfg80211_get_ibss(struct wiphy *wiphy,
    struct ieee80211_channel *channel,
    const u8 *ssid, size_t ssid_len) {
 ...
 */
static inline struct sk_buff *cfg80211_vendor_cmd_alloc_reply_skb(
 ...
 * Return: An allocated and pre-filled skb. %NULL if any errors happen.
 */
static inline struct sk_buff *cfg80211_vendor_event_alloc(struct wiphy *wiphy,
    struct wireless_dev *wdev,
 ...
 * Return: An allocated and pre-filled skb. %NULL if any errors happen.
 */
static inline struct sk_buff *cfg80211_testmode_alloc_reply_skb(
    struct wiphy *wiphy, int approxlen) {
 ...
 * Return: An allocated and pre-filled skb. %NULL if any errors happen.
 */
static inline struct sk_buff *cfg80211_testmode_alloc_event_skb(
    struct wiphy *wiphy, int approxlen, gfp_t gfp) {
 ...
 */
static inline void cfg80211_connect_bss(struct net_device *dev, const u8 *bssid,
 ...
 * cfg80211_connect_timeout(), and cfg80211_connect_done() should be called.
 */
static inline void cfg80211_connect_timeout(struct net_device *dev,
    const u8 *bssid,
...
static inline void cfg80211_radar_event(struct wiphy *wiphy,
    struct cfg80211_chan_def *chandef,
    gfp_t gfp) {
  __cfg80211_radar_event(wiphy, chandef, false, gfp);
}

static inline void cfg80211_background_radar_event(struct wiphy *wiphy,
    struct cfg80211_chan_def *chandef,
    gfp_t gfp) {
...
/**
 * cfg80211_background_cac_abort - Channel Availability Check offchan abort
 * event
 * @wiphy: the wiphy
 *
 ...
 */
static inline u32 ieee80211_chandef_to_khz(
    const struct cfg80211_chan_def *chandef) {
