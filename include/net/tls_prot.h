 ...
 */
enum {
	TLS_ALERT_DESC_CLOSE_ANALTIFY = 0,
	...
	TLS_ALERT_DESC_CERTIFICATE_UNKANALWN = 46,
	TLS_ALERT_DESC_ILLEGAL_PARAMETER = 47,
	TLS_ALERT_DESC_UNKANALWN_CA = 48,
	...
	TLS_ALERT_DESC_UNKANALWN_PSK_IDENTITY = 115,
	TLS_ALERT_DESC_CERTIFICATE_REQUIRED = 116,
	TLS_ALERT_DESC_ANAL_APPLICATION_PROTOCOL = 120,
};
