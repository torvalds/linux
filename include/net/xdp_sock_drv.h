...
static inline u32 xsk_buff_alloc_batch(struct xsk_buff_pool *pool,
...
static inline void *xsk_buff_raw_get_data(struct xsk_buff_pool *pool,
    u64 addr) {
...
static inline struct xsk_tx_metadata *xsk_buff_get_metadata(
    struct xsk_buff_pool *pool, u64 addr) {
...
static inline void xsk_tx_completed(struct xsk_buff_pool *pool,
    u32 nb_entries) {
}
...
static inline u32 xsk_tx_peek_release_desc_batch(struct xsk_buff_pool *pool,
    u32 max) {
  return 0;
}
...
static inline struct xsk_buff_pool *xsk_get_pool_from_qid(
