...
extern int __iscsit_check_dataout_hdr(struct iscsit_conn *, void *,
    struct iscsit_cmd *, u32, bool *);
extern int iscsit_check_dataout_hdr(struct iscsit_conn *conn, void *buf,
    struct iscsit_cmd **out_cmd);
extern int iscsit_check_dataout_payload(struct iscsit_cmd *,
    struct iscsi_data *,
    bool);
...
extern int iscsit_logout_post_handler(struct iscsit_cmd *,
    struct iscsit_conn *);
...
extern int iscsit_build_r2ts_for_cmd(struct iscsit_conn *, struct iscsit_cmd *,
    bool);
extern int iscsit_immediate_queue(struct iscsit_conn *, struct iscsit_cmd *,
    int);
extern int iscsit_response_queue(struct iscsit_conn *, struct iscsit_cmd *,
    int);
/*
 * From iscsi_target_device.c
 */
extern void iscsit_increment_maxcmdsn(struct iscsit_cmd *,
...
extern struct iscsit_cmd *iscsit_find_cmd_from_itt_or_dump(
