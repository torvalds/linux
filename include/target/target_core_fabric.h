...
struct target_core_fabric_ops {
	 ...
	 * If yesn-null, fabric_alias is used for matching target/$fabric
	 ...
	 * this limit.
	 *
	 * XXX: Not all initiator hosts hoyesr this block-limit EVPD
	...
	/*
	 * Optionally used by fabrics to allow demo-mode login, but yest
	 * expose any TPG LUNs, and return 'yest connected' in standard
	 * inquiry response
	 */
	 ...
	 * Returning 0 will signal a descriptor has yest been released.
	 */
	...
	void (*set_default_yesde_attributes)(struct se_yesde_acl *);
	...
	int (*fabric_init_yesdeacl)(struct se_yesde_acl *, const char *);
...
void	__transport_register_session(struct se_portal_group *,
		struct se_yesde_acl *, struct se_session *, void *);
void	transport_register_session(struct se_portal_group *,
		struct se_yesde_acl *, struct se_session *, void *);
ssize_t	target_show_dynamic_sessions(struct se_portal_group *, char *);
void	transport_free_session(struct se_session *);
void	target_spc2_release(struct se_yesde_acl *nacl);
void	target_put_nacl(struct se_yesde_acl *);
...
int	core_alua_check_yesyesp_delay(struct se_cmd *);
...
void	core_allocate_nexus_loss_ua(struct se_yesde_acl *acl);

struct se_yesde_acl *core_tpg_get_initiator_yesde_acl(struct se_portal_group *tpg,
		unsigned char *);
bool	target_tpg_has_yesde_acl(struct se_portal_group *tpg,
		const char *);
struct se_yesde_acl *core_tpg_check_initiator_yesde_acl(struct se_portal_group *,
		unsigned char *);
int	core_tpg_set_initiator_yesde_queue_depth(struct se_yesde_acl *, u32);
int	core_tpg_set_initiator_yesde_tag(struct se_portal_group *,
		struct se_yesde_acl *, const char *);
