...
/* Used by target_core_store_alua_lu_gp() and
 * target_core_alua_lu_gp_show_attr_members() */
#define LU_GROUP_NAME_BUF     256
/* Used by core_alua_store_tg_pt_gp_info() and
...
/* Emulation for Thin Provisioning UNMAP using
...
static inline void target_free_tag(struct se_session *sess,
    struct se_cmd *cmd) {
