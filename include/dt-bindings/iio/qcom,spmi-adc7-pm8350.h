...
/* 100k pull-up2 */
#define PM8350_ADC7_AMUX_THM1_100K_PU(sid)    ((sid) << \
    8 | ADC7_AMUX_THM1_100K_PU)
#define PM8350_ADC7_AMUX_THM2_100K_PU(sid)    ((sid) << \
    8 | ADC7_AMUX_THM2_100K_PU)
#define PM8350_ADC7_AMUX_THM3_100K_PU(sid)    ((sid) << \
    8 | ADC7_AMUX_THM3_100K_PU)
#define PM8350_ADC7_AMUX_THM4_100K_PU(sid)    ((sid) << \
    8 | ADC7_AMUX_THM4_100K_PU)
#define PM8350_ADC7_AMUX_THM5_100K_PU(sid)    ((sid) << \
...
/* 400k pull-up3 */
#define PM8350_ADC7_AMUX_THM1_400K_PU(sid)    ((sid) << \
    8 | ADC7_AMUX_THM1_400K_PU)
#define PM8350_ADC7_AMUX_THM2_400K_PU(sid)    ((sid) << \
    8 | ADC7_AMUX_THM2_400K_PU)
#define PM8350_ADC7_AMUX_THM3_400K_PU(sid)    ((sid) << \
    8 | ADC7_AMUX_THM3_400K_PU)
#define PM8350_ADC7_AMUX_THM4_400K_PU(sid)    ((sid) << \
    8 | ADC7_AMUX_THM4_400K_PU)
#define PM8350_ADC7_AMUX_THM5_400K_PU(sid)    ((sid) << \
