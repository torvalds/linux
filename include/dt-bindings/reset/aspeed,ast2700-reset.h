...
#define ASPEED_RESET_PCIE1RST		(18)
#define ASPEED_RESET_PCIE1RSTOE		(19)
#define ASPEED_RESET_PCIE0RST		(20)
#define ASPEED_RESET_PCIE0RSTOE		(21)
...
#define ASPEED_RESET_P1_PHY3		(36)
