...
#define IMX8MQ_RESET_HDMI_PHY_APB_RESET   30  /* i.MX8MM/i.MX8MN does NOT
                                               * support */
...
#define IMX8MQ_RESET_PCIE2_CTRL_APPS_EN   36  /* i.MX8MM/i.MX8MN does NOT
                                               * support */
#define IMX8MQ_RESET_PCIE2_CTRL_APPS_TURNOFF  37  /* i.MX8MM/i.MX8MN does NOT
                                                   * support */
#define IMX8MQ_RESET_MIPI_CSI1_CORE_RESET 38  /* i.MX8MM/i.MX8MN does NOT
                                               * support */
#define IMX8MQ_RESET_MIPI_CSI1_PHY_REF_RESET  39  /* i.MX8MM/i.MX8MN does NOT
                                                   * support */
#define IMX8MQ_RESET_MIPI_CSI1_ESC_RESET  40  /* i.MX8MM/i.MX8MN does NOT
                                               * support */
#define IMX8MQ_RESET_MIPI_CSI2_CORE_RESET 41  /* i.MX8MM/i.MX8MN does NOT
                                               * support */
#define IMX8MQ_RESET_MIPI_CSI2_PHY_REF_RESET  42  /* i.MX8MM/i.MX8MN does NOT
                                                   * support */
#define IMX8MQ_RESET_MIPI_CSI2_ESC_RESET  43  /* i.MX8MM/i.MX8MN does NOT
                                               * support */
