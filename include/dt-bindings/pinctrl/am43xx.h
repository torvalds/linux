...
#define DS0_PIN_OUTPUT_PULLUP (DS0_FORCE_OFF_MODE | DS0_PULL_UP_DOWN_EN \
  | DS0_PULL_UP_SEL)
#define DS0_PIN_OUTPUT_PULLDOWN (DS0_FORCE_OFF_MODE | DS0_PULL_UP_DOWN_EN)
#define DS0_PIN_INPUT   (DS0_FORCE_OFF_MODE | DS0_INPUT)
#define DS0_PIN_INPUT_PULLUP  (DS0_FORCE_OFF_MODE | DS0_INPUT \
  | DS0_PULL_UP_DOWN_EN | DS0_PULL_UP_SEL)
#define DS0_PIN_INPUT_PULLDOWN  (DS0_FORCE_OFF_MODE | DS0_INPUT \
  | DS0_PULL_UP_DOWN_EN)
