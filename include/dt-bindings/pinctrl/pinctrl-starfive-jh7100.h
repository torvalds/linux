...
#define GPO_SDIO0_PAD_CDATA_OEN_BIT0    (GPO_SDIO0_PAD_CDATA_OE_BIT0 \
  | GPO_REVERSE)
#define GPO_SDIO0_PAD_CDATA_OE_BIT1   58
#define GPO_SDIO0_PAD_CDATA_OEN_BIT1    (GPO_SDIO0_PAD_CDATA_OE_BIT1 \
  | GPO_REVERSE)
#define GPO_SDIO0_PAD_CDATA_OE_BIT2   59
#define GPO_SDIO0_PAD_CDATA_OEN_BIT2    (GPO_SDIO0_PAD_CDATA_OE_BIT2 \
  | GPO_REVERSE)
#define GPO_SDIO0_PAD_CDATA_OE_BIT3   60
#define GPO_SDIO0_PAD_CDATA_OEN_BIT3    (GPO_SDIO0_PAD_CDATA_OE_BIT3 \
  | GPO_REVERSE)
#define GPO_SDIO0_PAD_CDATA_OE_BIT4   61
#define GPO_SDIO0_PAD_CDATA_OEN_BIT4    (GPO_SDIO0_PAD_CDATA_OE_BIT4 \
  | GPO_REVERSE)
#define GPO_SDIO0_PAD_CDATA_OE_BIT5   62
#define GPO_SDIO0_PAD_CDATA_OEN_BIT5    (GPO_SDIO0_PAD_CDATA_OE_BIT5 \
  | GPO_REVERSE)
#define GPO_SDIO0_PAD_CDATA_OE_BIT6   63
#define GPO_SDIO0_PAD_CDATA_OEN_BIT6    (GPO_SDIO0_PAD_CDATA_OE_BIT6 \
  | GPO_REVERSE)
#define GPO_SDIO0_PAD_CDATA_OE_BIT7   64
#define GPO_SDIO0_PAD_CDATA_OEN_BIT7    (GPO_SDIO0_PAD_CDATA_OE_BIT7 \
  | GPO_REVERSE)
...
#define GPO_SDIO1_PAD_CDATA_OEN_BIT0    (GPO_SDIO1_PAD_CDATA_OE_BIT0 \
  | GPO_REVERSE)
...
#define GPO_SDIO1_PAD_CDATA_OEN_BIT2    (GPO_SDIO1_PAD_CDATA_OE_BIT2 \
  | GPO_REVERSE)
#define GPO_SDIO1_PAD_CDATA_OE_BIT3   81
#define GPO_SDIO1_PAD_CDATA_OEN_BIT3    (GPO_SDIO1_PAD_CDATA_OE_BIT3 \
  | GPO_REVERSE)
#define GPO_SDIO1_PAD_CDATA_OE_BIT4   82
#define GPO_SDIO1_PAD_CDATA_OEN_BIT4    (GPO_SDIO1_PAD_CDATA_OE_BIT4 \
  | GPO_REVERSE)
#define GPO_SDIO1_PAD_CDATA_OE_BIT5   83
#define GPO_SDIO1_PAD_CDATA_OEN_BIT5    (GPO_SDIO1_PAD_CDATA_OE_BIT5 \
  | GPO_REVERSE)
#define GPO_SDIO1_PAD_CDATA_OE_BIT6   84
#define GPO_SDIO1_PAD_CDATA_OEN_BIT6    (GPO_SDIO1_PAD_CDATA_OE_BIT6 \
  | GPO_REVERSE)
#define GPO_SDIO1_PAD_CDATA_OE_BIT7   85
#define GPO_SDIO1_PAD_CDATA_OEN_BIT7    (GPO_SDIO1_PAD_CDATA_OE_BIT7 \
  | GPO_REVERSE)
