 ...
 *
 * Device Tree binding constants for Exyyess4 clock controller.
 */
...
#define CLK_MOUT_MPLL_USER_T	17 /* Exyyess4x12 only */
#define CLK_MOUT_MPLL_USER_C	18 /* Exyyess4x12 only */
...
#define CLK_SCLK_MDNIE0		141 /* Exyyess4412 only */
...
#define CLK_SCLK_SATA		150 /* Exyyess4210 only */
...
#define CLK_SCLK_FIMD1		163 /* Exyyess4210 only */
#define CLK_SCLK_MIPI1		164 /* Exyyess4210 only */
#define CLK_SCLK_PCM1		165
#define CLK_SCLK_PCM2		166
#define CLK_SCLK_I2S1		167
#define CLK_SCLK_I2S2		168
#define CLK_SCLK_MIPIHSI	169 /* Exyyess4412 only */
#define CLK_SCLK_MFC		170
#define CLK_SCLK_PCM0		171
#define CLK_SCLK_G3D		172
#define CLK_SCLK_PWM_ISP	173 /* Exyyess4x12 only */
#define CLK_SCLK_SPI0_ISP	174 /* Exyyess4x12 only */
#define CLK_SCLK_SPI1_ISP	175 /* Exyyess4x12 only */
#define CLK_SCLK_UART_ISP	176 /* Exyyess4x12 only */
...
#define CLK_TVENC		270 /* Exyyess4210 only */
#define CLK_HDMI		271
...
#define CLK_MIE0		284
#define CLK_MDNIE0		285 /* Exyyess4412 only */
#define CLK_DSIM0		286
#define CLK_SMMU_FIMD0		287
#define CLK_FIMD1		288 /* Exyyess4210 only */
#define CLK_MIE1		289 /* Exyyess4210 only */
#define CLK_DSIM1		290 /* Exyyess4210 only */
#define CLK_SMMU_FIMD1		291 /* Exyyess4210 only */
#define CLK_PDMA0		292
#define CLK_PDMA1		293
#define CLK_PCIE_PHY		294
#define CLK_SATA_PHY		295 /* Exyyess4210 only */
#define CLK_TSI			296
...
#define CLK_SATA		302 /* Exyyess4210 only */
...
#define CLK_MIPI_HSI		349 /* Exyyess4210 only */
#define CLK_PIXELASYNCM0	351
#define CLK_PIXELASYNCM1	352
#define CLK_ASYNC_G3D		353 /* Exyyess4x12 only */
#define CLK_PWM_ISP_SCLK	379 /* Exyyess4x12 only */
#define CLK_SPI0_ISP_SCLK	380 /* Exyyess4x12 only */
#define CLK_SPI1_ISP_SCLK	381 /* Exyyess4x12 only */
#define CLK_UART_ISP_SCLK	382 /* Exyyess4x12 only */
...
#define CLK_ACLK400_MCUISP	395 /* Exyyess4x12 only */
...
#define CLK_PPMULCD1		409 /* Exyyess4210 only */
...
/* div clocks */
#define CLK_DIV_ACLK200		454 /* Exyyess4x12 only */
#define CLK_DIV_ACLK400_MCUISP	455 /* Exyyess4x12 only */
#define CLK_DIV_ACP		456
#define CLK_DIV_DMC		457
#define CLK_DIV_C2C		458 /* Exyyess4x12 only */
