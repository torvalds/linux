...
/** @brief CLK_RST_CONTROLLER_MAUDCLK_OUT_SWITCH_DIVIDER switch divider output
 * (maudclk) */
...
/** @brief CLK_RST_CONTROLLER_HUBCLK_OUT_SWITCH_DIVIDER switch divider output
 * (hubclk) */
#define TEGRA234_CLK_HUB      84U
/** @brief CLK_RST_CONTROLLER_DISPCLK_SWITCH_DIVIDER switch divider output
 * (dispclk) */
...
/** @brief Output of mux controlled by disp_2clk_sor0_pll_ref_clk_safe signal
 * (sor0_ref_clk) */
...
/** @brief Output of mux controlled by disp_2clk_sor1_pll_ref_clk_safe signal
 * (sor1_ref_clk) */
...
/** @brief Output of mux controlled by disp_2clk_h0_dsi_sel signal in sf0_clk
 * path */
...
/** @brief CLK_RST_CONTROLLER_CLK_SOURCE_UARTI switch divider output
 * (uarti_r_clk) */
#define TEGRA234_CLK_UARTI      188U
/** @brief CLK_RST_CONTROLLER_CLK_SOURCE_UARTJ switch divider output
 * (uartj_r_clk) */
 ...
 * CLK_RST_CONTROLLER_CLK_SOURCE_QSPI0 (qspi0_pm_clk) */
#define TEGRA234_CLK_QSPI0_PM     194U
/** @brief output of the divider QSPI_CLK_DIV2_SEL in
 * CLK_RST_CONTROLLER_CLK_SOURCE_QSPI1 (qspi1_pm_clk) */
...
/** @brief CLK_RST_CONTROLLER_CLK_SOURCE_DBGAPB_0 switch divider output
 * (dbgapb_clk) */
...
/** @brief CLK_RST_CONTROLLER_CLK_SOURCE_PEX_SATA_USB_RX_BYP switch divider
 * output */
#define TEGRA234_CLK_PEX_SATA_USB_RX_BYP  254U
/** @brief CLK_RST_CONTROLLER_CLK_SOURCE_PEX_USB_PAD_PLL0_MGMT switch divider
 * output */
#define TEGRA234_CLK_PEX_USB_PAD_PLL0_MGMT  255U
/** @brief CLK_RST_CONTROLLER_CLK_SOURCE_PEX_USB_PAD_PLL1_MGMT switch divider
 * output */
#define TEGRA234_CLK_PEX_USB_PAD_PLL1_MGMT  256U
/** @brief CLK_RST_CONTROLLER_CLK_SOURCE_PEX_USB_PAD_PLL2_MGMT switch divider
 * output */
#define TEGRA234_CLK_PEX_USB_PAD_PLL2_MGMT  257U
/** @brief CLK_RST_CONTROLLER_CLK_SOURCE_PEX_USB_PAD_PLL3_MGMT switch divider
 * output */
...
/** @brief NVHS PLL hardware power sequencer (overrides 'manual' programming of
 * PLL) */
...
/** @brief output of mem pll A sync mux controlled by
 * CLK_RST_CONTROLLER_CLK_SOURCE_EMC */
#define TEGRA234_CLK_EMCSA_MPLL     310U
/** @brief output of mem pll B sync mux controlled by
 * CLK_RST_CONTROLLER_CLK_SOURCE_EMCSB */
#define TEGRA234_CLK_EMCSB_MPLL     311U
/** @brief output of mem pll C sync mux controlled by
 * CLK_RST_CONTROLLER_CLK_SOURCE_EMCSC */
#define TEGRA234_CLK_EMCSC_MPLL     312U
/** @brief output of mem pll D sync mux controlled by
 * CLK_RST_CONTROLLER_CLK_SOURCE_EMCSD */
...
/** @brief output of SW_MPHY_L0_TX_HS_SYMB divider in
 * CLK_RST_CONTROLLER_MPHY_L0_TX_CLK_CTRL_0 */
#define TEGRA234_CLK_MPHY_L0_TX_HS_SYMB_DIV 347U
/** @brief output of SW_MPHY_L0_TX_LS_3XBIT divider in
 * CLK_RST_CONTROLLER_MPHY_L0_TX_CLK_CTRL_0 */
#define TEGRA234_CLK_MPHY_L0_TX_LS_3XBIT_DIV  348U
/** @brief LS/HS divider mux SW_MPHY_L0_TX_LS_HS_SEL in
 * CLK_RST_CONTROLLER_MPHY_L0_TX_CLK_CTRL_0 */
...
/** @brief output of SW_MPHY_L0_RX_HS_SYMB divider in
 * CLK_RST_CONTROLLER_MPHY_L0_RX_CLK_CTRL_0 */
#define TEGRA234_CLK_MPHY_L0_RX_HS_SYMB_DIV 352U
/** @brief output of SW_MPHY_L0_RX_LS_BIT divider in
 *  CLK_RST_CONTROLLER_MPHY_L0_RX_CLK_CTRL_0 */
#define TEGRA234_CLK_MPHY_L0_RX_LS_BIT_DIV  353U
/** @brief LS/HS divider mux SW_MPHY_L0_RX_LS_HS_SEL in
 * CLK_RST_CONTROLLER_MPHY_L0_RX_CLK_CTRL_0 */
...
/** @brief CLK_RST_CONTROLLER_DSI_LP_SWITCH_DIVIDER switch divider output
 * (dsi_lp_clk) */
#define TEGRA234_CLK_DSI_LP     456U
/** @brief CLK_RST_CONTROLLER_AZA2XBITCLK_OUT_SWITCH_DIVIDER switch divider
 * output (aza_2xbitclk) */
#define TEGRA234_CLK_AZA_2XBIT      457U
/** @brief aza_2xbitclk / 2 (aza_bitclk) */
#define TEGRA234_CLK_AZA_BIT      458U
/** @brief SWITCH_DSI_CORE_PIXEL_MISC_DSI_CORE_CLK_SRC switch output
 * (dsi_core_clk) */
#define TEGRA234_CLK_DSI_CORE     459U
/** @brief Output of mux controlled by pkt_wr_fifo_signal from dsi
 * (dsi_pixel_clk) */
