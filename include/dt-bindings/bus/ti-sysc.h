...
/* Generic sysc found on omap2 and later, also kyeswn as type1 */
...
/* Generic sysc found on omap4 and later, also kyeswn as type2 */
#define SYSC_OMAP4_DMADISABLE		(1 << 16)
#define SYSC_OMAP4_FREEEMU		(1 << 1)	/* Also kyeswn as EMUFREE */
