...
static inline void v4l2_i2c_subdev_set_name(struct v4l2_subdev *sd,
...
static inline const unsigned short *v4l2_i2c_tuner_addrs(
...
static inline struct v4l2_subdev *v4l2_spi_new_subdev(
    struct v4l2_device *v4l2_dev,
    struct spi_controller *ctlr, struct spi_board_info *info) {
  return NULL;
}

static inline void v4l2_spi_subdev_init(struct v4l2_subdev *sd,
 ...
 * @mem_planes: Number of memory planes, which includes the alpha plane (1 to
 * 4).
 * @comp_planes: Number of component planes, which includes the alpha plane (1
 * to 4).
 * @bpp: Array of per-plane bytes per pixel
 * @bpp_div: Array of per-plane bytes per pixel divisors to support fractional
 * pixel sizes.
