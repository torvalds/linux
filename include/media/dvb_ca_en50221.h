 ...
 *			DVB_CA_FLAG_EN50221_IRQ_CAMCHANGE is yest set.
 * @data:		private data, used by caller.
 * @private:		Opaque data used by the dvb_ca core. Do yest modify!
 *
 * NOTE: the read_*, write_* and poll_slot_status functions will be
 * called for different slots concurrently and need to use locks where
 * and if appropriate. There will be yes concurrent access to one slot.
 */
