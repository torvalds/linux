 ...
 * @p_vp9_compressed_hdr_probs: Pointer to a VP9 frame compressed header probs
 * structure.
 ...
 * @is_dyn_array: If set, then this control contains a dynamically sized
 * 1-dimensional array.
...
/**
 *__v4l2_ctrl_modify_dimensions() - Unlocked variant of
 ...
 * This function is for string type controls only.
 */
static inline int v4l2_ctrl_s_ctrl_string(struct v4l2_ctrl *ctrl,
    const char *s) {
  int rval;
  v4l2_ctrl_lock(ctrl);
