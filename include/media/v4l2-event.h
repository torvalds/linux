 ...
 * @list:	List yesde for the v4l2_fh->available list.
 ...
 *		event.
 *
 * @list:	List yesde for the v4l2_fh->subscribed list.
 * @type:	Event type.
 * @id:	Associated object ID (e.g. control ID). 0 if there isn't any.
 * @flags:	Copy of v4l2_event_subscription->flags.
 * @fh:	Filehandle that subscribed to this event.
 * @yesde:	List yesde that hooks into the object's event list
 *		(if there is one).
 ...
 * @yesnblocking: if yest zero, waits for an event to arrive
 */
