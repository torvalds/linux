...
static inline void tpg_s_pattern(struct tpg_data *tpg,
    enum tpg_pattern pattern) {
...
static inline unsigned tpg_g_twopixelsize(const struct tpg_data *tpg,
    unsigned plane) {
...
static inline unsigned tpg_g_bytesperline(const struct tpg_data *tpg,
    unsigned plane) {
...
static inline unsigned tpg_g_line_width(const struct tpg_data *tpg,
    unsigned plane) {
  unsigned w = 0;
  unsigned p;
  if (tpg->buffers > 1) {
...
static inline enum tpg_video_aspect tpg_g_video_aspect(
...
static inline void tpg_update_mv_count(struct tpg_data *tpg,
    bool frame_is_field) {
