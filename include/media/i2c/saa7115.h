...
#define SAA7115_COMPOSITE4 4 /* yest available for the saa7111/3 */
#define SAA7115_COMPOSITE5 5 /* yest available for the saa7111/3 */
 ...
 * RTS1 [Bit 4..7] Defaults to DOT_IN. (This value can yest be set for RTS0)
