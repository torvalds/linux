 ...
 * @intensity:			yesn-flash strobe constraints for the LED
 ...
 * @fwn:	fwyesde_handle of the LED, may be NULL if the same as device's
 ...
 * references are held to config yesr its contents once this function
 * has returned.
 *
...
struct v4l2_flash *v4l2_flash_init(
	struct device *dev, struct fwyesde_handle *fwn,
	struct led_classdev_flash *fled_cdev,
