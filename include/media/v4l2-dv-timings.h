 ...
 * hardware capabilities and the callback function (if yesn-NULL), returns
 * false otherwise.
 */
 ...
 * timings, filtering out any timings that are yest supported based on the
 * hardware capabilities and the callback function (if yesn-NULL).
 *
 ...
 * that are yest supported based on the hardware capabilities and the callback
 * function (if yesn-NULL).
 *
