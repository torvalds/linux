...
#define AK4114_REG_QSUB_SIZE  ((AK4114_REG_QSUB_ABSFRM - AK4114_REG_QSUB_ADDR) \
  + 1)
...
#define AK4114_RST    (1 << 0)  /* 0 = reset & initialize (except this
                                 * register), 1 = normal operation */

/* AK4114_REQ_FORMAT bits */
#define AK4114_MONO   (1 << 7)  /* Double Sampling Frequency Mode: 0 = stereo, 1
                                 * = mono */
...
#define AK4114_DIF_24R    (AK4114_DIF1 | AK4114_DIF0) /* STDO: 24-bit, right
                                                       * justified */
#define AK4114_DIF_24L    (AK4114_DIF2)     /* STDO: 24-bit, left justified */
#define AK4114_DIF_24I2S  (AK4114_DIF2 | AK4114_DIF0) /* STDO: I2S */
#define AK4114_DIF_I24L   (AK4114_DIF2 | AK4114_DIF1) /* STDO: 24-bit, left
                                                       * justified; LRCLK, BICK
                                                       * = Input */
#define AK4114_DIF_I24I2S (AK4114_DIF2 | AK4114_DIF1 | AK4114_DIF0) /* STDO:
                                                                     * I2S;
                                                                     *  LRCLK,
                                                                     * BICK =
                                                                     * Input */
...
#define AK4114_UDIT   (1 << 5)  /* U-bit Control for DIT (0 = fixed '0', 1 =
                                 * recovered) */
#define AK4114_TLR    (1 << 4)  /* Double Sampling Frequency Select for DIT (0 =
                                 * L channel, 1 = R channel) */
#define AK4114_DIT    (1 << 3)  /* TX1 out: 0 = Through Data (RX data), 1 =
                                 * Transmit Data (DAUX data) */
...
/* AK4114_REG_RCS0 */
#define AK4114_QINT   (1 << 7)  /* Q-subcode buffer interrupt, 0 = no change, 1
                                 * = changed */
#define AK4114_AUTO   (1 << 6)  /* Non-PCM or DTS stream auto detection, 0 = no
                                 * detect, 1 = detect */
#define AK4114_CINT   (1 << 5)  /* channel status buffer interrupt, 0 = no
                                 * change, 1 = change */
...
#define AK4114_AUDION   (1 << 1)  /* audio bit output, 0 = audio, 1 = non-audio
                                   * */
#define AK4114_PAR    (1 << 0)  /* parity error or biphase error status, 0 = no
                                 * error, 1 = error */
...
#define AK4114_V    (1 << 3)  /* Validity of Channel Status, 0 = Valid, 1 =
                               * Invalid */
#define AK4114_QCRC   (1 << 1)  /* CRC for Q-subcode, 0 = no error, 1 = error */
#define AK4114_CCRC   (1 << 0)  /* CRC for channel status, 0 = no error, 1 =
                                 * error */
...
typedef void (ak4114_write_t)(void *private_data, unsigned char addr,
    unsigned char data);
...
struct ak4114 {
  ...
  void (*change_callback)(struct ak4114 *ak4114, unsigned char c0,
      unsigned char c1);
};
...
void snd_ak4114_reg_write(struct ak4114 *ak4114, unsigned char reg,
