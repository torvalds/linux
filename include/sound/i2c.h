...
struct snd_i2c_bit_ops {
  ...
  void (*direction)(struct snd_i2c_bus *bus, int clock, int data);  /* set line
                                                                     * direction
                                                                     * (0 =
                                                                     * write, 1
                                                                     * = read)
...
struct snd_i2c_ops {
  int (*sendbytes)(struct snd_i2c_device *device, unsigned char *bytes,
      int count);
  int (*readbytes)(struct snd_i2c_device *device, unsigned char *bytes,
      int count);
...
int snd_i2c_sendbytes(struct snd_i2c_device *device, unsigned char *bytes,
    int count);
int snd_i2c_readbytes(struct snd_i2c_device *device, unsigned char *bytes,
    int count);
