...
#define IEC958_AES0_PRO_FREQ_UNLOCKED (1 << 5)  /* source sample frequency: 0 =
                                                 * locked, 1 = unlocked */
...
#define IEC958_AES0_CON_NOT_COPYRIGHT (1 << 2)  /* 0 = copyright, 1 = not
                                                 * copyright */
...
#define IEC958_AES1_PRO_MODE_STEREOPHONIC (2 << 0) /* stereophonic - ch A is
                                                    * left */
...
#define IEC958_AES1_CON_ADC_COPYRIGHT_OTHER (IEC958_AES1_CON_ADC_COPYRIGHT_ID \
  | 0x60)
...
#define IEC958_AES1_CON_ORIGINAL  (1 << 7)  /* this bits depends on the category
                                             * code */
...
#define IEC958_AES5_CON_CGMSA_COPYFREELY (0 << 0) /* copying is permitted
                                                   * without restriction */
#define IEC958_AES5_CON_CGMSA_COPYONCE  (1 << 0)  /* one generation of copies
                                                   * may be made */
...
#define CEA861_AUDIO_INFOFRAME_DB1CT_MPEG2_MULTICH (5 << 4) /* MPEG2
                                                             * Multichannel */
...
#define CEA861_AUDIO_INFOFRAME_DB5_DM_INH (1 << 7) /* mask - inhibit downmixing
                                                    * */
#define CEA861_AUDIO_INFOFRAME_DB5_DM_INH_PERMITTED (0 << 7) /* stereo downmix
                                                              * permitted */
#define CEA861_AUDIO_INFOFRAME_DB5_DM_INH_PROHIBITED (1 << 7) /* stereo downmis
                                                               * prohibited */
#define CEA861_AUDIO_INFOFRAME_DB5_LSV    (0xf << 3) /* mask - level-shift
                                                      * values */
