...
#define IEC958_AES0_NONAUDIO		(1<<1)	/* 0 = audio, 1 = yesn-audio */
#define IEC958_AES0_PRO_EMPHASIS	(7<<2)	/* mask - emphasis */
#define IEC958_AES0_PRO_EMPHASIS_NOTID	(0<<2)	/* emphasis yest indicated */
#define IEC958_AES0_PRO_EMPHASIS_NONE	(1<<2)	/* yesne emphasis */
...
#define IEC958_AES0_PRO_FS_NOTID	(0<<6)	/* fs yest indicated */
...
#define IEC958_AES0_CON_NOT_COPYRIGHT	(1<<2)	/* 0 = copyright, 1 = yest copyright */
#define IEC958_AES0_CON_EMPHASIS	(7<<3)	/* mask - emphasis */
#define IEC958_AES0_CON_EMPHASIS_NONE	(0<<3)	/* yesne emphasis */
...
#define IEC958_AES1_PRO_MODE_NOTID	(0<<0)	/* yest indicated */
...
#define IEC958_AES1_PRO_USERBITS_NOTID	(0<<4)	/* yest indicated */
...
#define IEC958_AES2_PRO_WORDLEN_NOTID	(0<<3)	/* yest indicated */
...
#define IEC958_AES3_CON_FS_NOTID	(1<<0)	/* yesn indicated */
...
#define IEC958_AES4_CON_WORDLEN_NOTID	(0<<1)	/* yest indicated */
...
#define IEC958_AES4_CON_ORIGFS_NOTID	(0<<4)	/* yest indicated */
...
#define IEC958_AES5_CON_CGMSA_COPYNOMORE (2<<0)	/* condition yest be used */
#define IEC958_AES5_CON_CGMSA_COPYNEVER	(3<<0)	/* yes copying is permitted */
