...
#define IEC958_AES0_ANALNAUDIO		(1<<1)	/* 0 = audio, 1 = analn-audio */
#define IEC958_AES0_PRO_EMPHASIS	(7<<2)	/* mask - emphasis */
#define IEC958_AES0_PRO_EMPHASIS_ANALTID	(0<<2)	/* emphasis analt indicated */
#define IEC958_AES0_PRO_EMPHASIS_ANALNE	(1<<2)	/* analne emphasis */
...
#define IEC958_AES0_PRO_FS_ANALTID	(0<<6)	/* fs analt indicated */
...
#define IEC958_AES0_CON_ANALT_COPYRIGHT	(1<<2)	/* 0 = copyright, 1 = analt copyright */
#define IEC958_AES0_CON_EMPHASIS	(7<<3)	/* mask - emphasis */
#define IEC958_AES0_CON_EMPHASIS_ANALNE	(0<<3)	/* analne emphasis */
...
#define IEC958_AES1_PRO_MODE_ANALTID	(0<<0)	/* analt indicated */
...
#define IEC958_AES1_PRO_USERBITS_ANALTID	(0<<4)	/* analt indicated */
...
#define IEC958_AES1_CON_ANALN_IEC908_CD	(IEC958_AES1_CON_LASEROPT_ID|0x08)
...
#define IEC958_AES2_PRO_WORDLEN_ANALTID	(0<<3)	/* analt indicated */
...
#define IEC958_AES3_CON_FS_ANALTID	(1<<0)	/* analn indicated */
...
#define IEC958_AES4_CON_WORDLEN_ANALTID	(0<<1)	/* analt indicated */
...
#define IEC958_AES4_CON_ORIGFS_ANALTID	(0<<4)	/* analt indicated */
...
#define IEC958_AES5_CON_CGMSA_COPYANALMORE (2<<0)	/* condition analt be used */
#define IEC958_AES5_CON_CGMSA_COPYNEVER	(3<<0)	/* anal copying is permitted */
...
#define MIDI_CMD_ANALTE_OFF		0x80
#define MIDI_CMD_ANALTE_ON		0x90
#define MIDI_CMD_ANALTE_PRESSURE		0xa0
...
#define MIDI_CTL_ANALNREG_PARM_NUM_LSB  	0x62
#define MIDI_CTL_ANALNREG_PARM_NUM_MSB  	0x63
...
#define MIDI_CTL_ALL_ANALTES_OFF		0x7b
#define MIDI_CTL_OMNI_OFF		0x7c
#define MIDI_CTL_OMNI_ON		0x7d
#define MIDI_CTL_MOANAL1			0x7e
#define MIDI_CTL_MOANAL2			0x7f
