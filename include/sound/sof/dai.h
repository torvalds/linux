...
/*
 * DAI_CONFIG flags. The 4 LSB bits are used for the commands, HW_PARAMS,
 * HW_FREE and PAUSE
 * representing when the IPC is sent. The 4 MSB bits are used to add quirks
 * along with the above
 * commands.
 */
#define SOF_DAI_CONFIG_FLAGS_CMD_MASK 0xF
#define SOF_DAI_CONFIG_FLAGS_NONE 0 /**< DAI_CONFIG sent without stage
                                     * information */
#define SOF_DAI_CONFIG_FLAGS_HW_PARAMS  BIT(0) /**< DAI_CONFIG sent during
                                                * hw_params stage */
#define SOF_DAI_CONFIG_FLAGS_HW_FREE  BIT(1) /**< DAI_CONFIG sent during hw_free
                                              * stage */
...
#define SOF_DAI_CONFIG_FLAGS_QUIRK_MASK  (0xF << \
    SOF_DAI_CONFIG_FLAGS_QUIRK_SHIFT)
/*
 * This should be used along with the SOF_DAI_CONFIG_FLAGS_HW_PARAMS to indicate
 * that pipeline
 * stop/pause and DAI DMA stop/pause should happen in two steps. This change is
 * only available
 * ABI 3.20 onwards.
 */
