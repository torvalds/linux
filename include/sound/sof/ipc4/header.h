...
#define SOF_IPC4_GLB_PIPE_INSTANCE_ID(x)  ((x) << \
    SOF_IPC4_GLB_PIPE_INSTANCE_SHIFT)

#define SOF_IPC4_GLB_PIPE_PRIORITY_SHIFT  11
#define SOF_IPC4_GLB_PIPE_PRIORITY_MASK   GENMASK(15, 11)
#define SOF_IPC4_GLB_PIPE_PRIORITY(x)   ((x) << \
    SOF_IPC4_GLB_PIPE_PRIORITY_SHIFT)

#define SOF_IPC4_GLB_PIPE_MEM_SIZE_SHIFT  0
#define SOF_IPC4_GLB_PIPE_MEM_SIZE_MASK   GENMASK(10, 0)
#define SOF_IPC4_GLB_PIPE_MEM_SIZE(x)   ((x) << \
    SOF_IPC4_GLB_PIPE_MEM_SIZE_SHIFT)
...
#define SOF_IPC4_GLB_PIPE_EXT_CORE_ID(x)  ((x) << \
    SOF_IPC4_GLB_PIPE_EXT_CORE_ID_SHIFT)

/* pipeline set state ipc msg */
#define SOF_IPC4_GLB_PIPE_STATE_ID_SHIFT    16
#define SOF_IPC4_GLB_PIPE_STATE_ID_MASK   GENMASK(23, 16)
#define SOF_IPC4_GLB_PIPE_STATE_ID(x)   ((x) << \
    SOF_IPC4_GLB_PIPE_STATE_ID_SHIFT)
...
#define SOF_IPC4_GLB_LOAD_LIBRARY_LIB_ID(x) ((x) << \
...
#define SOF_IPC4_GLB_CHAIN_DMA_HOST_ID(x) (((x) << \
...
#define SOF_IPC4_GLB_CHAIN_DMA_LINK_ID(x) (((x) << \
...
#define SOF_IPC4_GLB_CHAIN_DMA_ALLOCATE(x)  (((x) & 1) << \
    SOF_IPC4_GLB_CHAIN_DMA_ALLOCATE_SHIFT)

#define SOF_IPC4_GLB_CHAIN_DMA_ENABLE_SHIFT 17
#define SOF_IPC4_GLB_CHAIN_DMA_ENABLE_MASK  BIT(17)
#define SOF_IPC4_GLB_CHAIN_DMA_ENABLE(x)  (((x) & 1) << \
    SOF_IPC4_GLB_CHAIN_DMA_ENABLE_SHIFT)

#define SOF_IPC4_GLB_CHAIN_DMA_SCS_SHIFT  18
#define SOF_IPC4_GLB_CHAIN_DMA_SCS_MASK   BIT(18)
#define SOF_IPC4_GLB_CHAIN_DMA_SCS(x)   (((x) & 1) << \
    SOF_IPC4_GLB_CHAIN_DMA_SCS_SHIFT)
...
#define SOF_IPC4_MOD_EXT_PARAM_SIZE(x)    ((x) << \
    SOF_IPC4_MOD_EXT_PARAM_SIZE_SHIFT)
...
#define SOF_IPC4_MOD_EXT_MSG_PARAM_ID(x)  ((x) << \
...
#define SOF_IPC4_MOD_EXT_MSG_LAST_BLOCK(x)  ((x) << \
...
#define SOF_IPC4_MOD_EXT_MSG_FIRST_BLOCK(x) ((x) << \
...
#define SOF_IPC4_NOTIFICATION_TYPE_GET(x) (((x) \
 ...
 * The event_data contains the struct sof_ipc4_control_msg_payload of the
 * control
