...
#define SNDRV_EMUX_ST_STANDBY (0x08 | SNDRV_EMUX_ST_ON) /* Waiting to be
                                                         * triggered */
#define SNDRV_EMUX_ST_PENDING   (0x10 | SNDRV_EMUX_ST_ON) /* Note will be
                                                           * released */
...
int snd_emux_register(struct snd_emux *emu, struct snd_card *card, int index,
    char *name);
