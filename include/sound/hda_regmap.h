 ...
 */
static inline int snd_hdac_regmap_write(struct hdac_device *codec,
    hda_nid_t nid,
 ...
 */
static inline int snd_hdac_regmap_update(struct hdac_device *codec,
    hda_nid_t nid,
 ...
 */
static inline int snd_hdac_regmap_read(struct hdac_device *codec, hda_nid_t nid,
    unsigned int verb, unsigned int *val) {
  unsigned int cmd = snd_hdac_regmap_encode_verb(nid, verb);
 ...
 */
static inline int snd_hdac_regmap_get_amp(struct hdac_device *codec,
    hda_nid_t nid,
 ...
 */
static inline int snd_hdac_regmap_update_amp(struct hdac_device *codec,
    hda_nid_t nid,
 ...
 * Returns the value or a negative error.
 */
static inline int snd_hdac_regmap_get_amp_stereo(struct hdac_device *codec,
    hda_nid_t nid,
    int dir, int idx) {
 ...
 * Returns 0 if the value is unchanged, 1 if changed, or a negative error.
 */
static inline int snd_hdac_regmap_update_amp_stereo(struct hdac_device *codec,
    hda_nid_t nid,
 ...
 * @nid: NID to sync
 */
static inline void snd_hdac_regmap_sync_node(struct hdac_device *codec,
    hda_nid_t nid) {
