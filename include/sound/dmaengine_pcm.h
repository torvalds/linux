 ...
 */
static inline enum dma_transfer_direction snd_pcm_substream_to_dma_direction(
...
static inline struct dmaengine_pcm *soc_component_to_pcm(
    struct snd_soc_component *p) {
