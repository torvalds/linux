 ...
 * configuration and catch corner cases that are yest already handled in
 * the ALSA core.
 */
 ...
 * @maxburst: Maximum number of words(yeste: words, as in units of the
 * src_addr_width member, yest bytes) that can be send to or received from the
 * DAI in one burst.
 ...
 * @flags: PCM_DAI flags, only SND_DMAENGINE_PCM_DAI_FLAG_PACK for yesw
 */
 ...
 *   which do yest use devicetree.
 * @process: Callback used to apply processing on samples transferred from/to
 *   user space.
 * @compat_filter_fn: Will be used as the filter function when requesting a
 *  channel for platforms which do yest use devicetree. The filter parameter
 ...
 * compat_filter_fn will be igyesred. Otherwise the channel will be requested
