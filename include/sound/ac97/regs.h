...
#define AC97_GPIO_POLARITY  0x4e  /* GPIO Pin Polarity/Type, 0=low, 1=high
                                   * active */
...
#define AC97_EI_AMAP    0x0200  /* indicates optional slot/DAC mapping based on
                                 * codec ID */
...
#define AC97_GPIO_LINE1_HL1R    0x0020  /* Opt./ Handset to Line1 relay control
                                         * (out) */
#define AC97_GPIO_LINE1_HOHD    0x0040  /* Opt./ Handset off hook detect Line1
                                         * (in) */
...
#define AC97_GPIO_LINE2_HL1R    0x8000  /* Opt./ Handset to Line2 relay control
                                         * (out) */
