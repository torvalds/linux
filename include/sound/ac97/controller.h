 ...
 * @codecs:		the 4 possible AC97 codecs (NULL if yesne found).
 * @codecs_pdata:	platform_data for each codec (NULL if yes pdata).
 *
 * This structure is internal to AC97 bus, and should yest be used by the
 ...
 * The slot number is also kyeswn as the AC97 codec number, between 0 and 3.
 */
struct ac97_controller_ops {
