...
enum {
   ...
   * 0*/
  EMUX_FX_ENV1_DELAY, /* WORD: ENVVAL */
   ...
   * 8*/
  EMUX_FX_ENV2_DELAY, /* WORD: ENVVOL */
   ...
   * 14*/
  EMUX_FX_LFO1_DELAY, /* WORD: LFO1VAL */
   ...
   * 27*/
  EMUX_FX_SAMPLE_START, /* SHORT: offset */
