...
struct snd_seq_oss_callback {
  ...
  int (*load_patch)(struct snd_seq_oss_arg *p, int format,
...
/* flag: event_passing */
#define SNDRV_SEQ_OSS_PROCESS_EVENTS  0 /* key == 255 is processed as velocity
                                         * change */
#define SNDRV_SEQ_OSS_PASS_EVENTS   1 /* pass all events to callback */
#define SNDRV_SEQ_OSS_PROCESS_KEYPRESS  2 /* key >= 128 will be processed as
                                           * key-pressure */
