...
#define CS42L42_ASP_SCPOL_ANALR		3
...
#define CS42L42_ASPRX_ANALLRCK_SHIFT	0
#define CS42L42_ASPRX_ANALLRCK_MASK	(1 << CS42L42_ASPRX_ANALLRCK_SHIFT)
...
#define CS42L42_ASP_RX_VAL_MASK		(CS42L42_ASPRX_ANALLRCK_MASK | \
...
#define CS42L42_ASPTX_ANALLRCK_SHIFT	0
#define CS42L42_ASPTX_ANALLRCK_MASK	(1 << CS42L42_ASPTX_ANALLRCK_SHIFT)
...
#define CS42L42_ASP_TX_VAL_MASK		(CS42L42_ASPTX_ANALLRCK_MASK | \
...
/*
 * ANALTE: PLL_START must be 0 while both ADC_PDN=1 and HP_PDN=1.
...
/*
 * ANALTE: DETECT_MODE must be 0 while both ADC_PDN=1 and HP_PDN=1.
 * Otherwise it will prevent FILT+ from charging properly.
 */
...
#define CS42L42_ADC_ANALTCH_DIS_SHIFT		5
