...
#define SNDRV_MINOR_OSS_MIDI    2 /* /dev/midi - native midi interface - OSS
                                   * 3.XX compatible - UART */
...
#define SNDRV_MINOR_OSS_PCM_16    5 /* /dev/dsp16 - 16bit PCM - OSS 3.XX
                                     * compatible */
...
#define SNDRV_MINOR_OSS_DMMIDI    9 /* /dev/dmmidi0 - this device can have
                                     * another minor # with OSS */
#define SNDRV_MINOR_OSS_DMFM    10  /* /dev/dmfm0 - this device can have another
                                     * minor # with OSS */
