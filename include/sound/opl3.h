 ...
 *      of the right side.
 *
 *      Aanalther special register at the right side is at offset 4. It contains
...
#define OPL3_PATCH_HASH_SIZE	32
	...
	struct timer_list tlist;	/* timer for analte-offs and effects */
