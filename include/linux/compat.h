 ...
 */
static inline int put_compat_sigset(compat_sigset_t __user *compat,
    const sigset_t *set,
    unsigned int size) {
...
asmlinkage long compat_sys_waitid(int, compat_pid_t,
    ...
    struct compat_rusage __user *);
asmlinkage long compat_sys_set_robust_list(
  struct compat_robust_list_head __user *head,
  compat_size_t len);
asmlinkage long compat_sys_get_robust_list(int pid,
...
asmlinkage long compat_sys_rt_sigpending(compat_sigset_t __user *uset,
    compat_size_t sigsetsize);
asmlinkage long compat_sys_rt_sigtimedwait_time32(
...
asmlinkage long compat_sys_recvmmsg_time64(int fd,
    ...
    struct __kernel_timespec __user *timeout);
asmlinkage long compat_sys_recvmmsg_time32(int fd,
    struct compat_mmsghdr __user *mmsg,
    unsigned vlen, unsigned int flags,
    struct old_timespec32 __user *timeout);
...
asmlinkage long compat_sys_truncate64(const char __user *pathname,
    compat_arg_u64(len));
#endif
...
asmlinkage long compat_sys_pread64(unsigned int fd, char __user *buf,
    size_t count,
    compat_arg_u64(pos));
#endif

#ifdef __ARCH_WANT_COMPAT_PWRITE64
asmlinkage long compat_sys_pwrite64(unsigned int fd, const char __user *buf,
    size_t count,
    compat_arg_u64(pos));
#endif
...
asmlinkage long compat_sys_readahead(int fd, compat_arg_u64(offset),
    size_t count);
#endif
