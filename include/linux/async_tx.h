...
static inline struct dma_chan *async_tx_find_channel(
 ...
 */
static inline void async_tx_sync_epilog(struct async_submit_ctl *submit) {
  if (submit->cb_fn) {
...
static inline void init_async_submit(struct async_submit_ctl *args,
    enum async_tx_flags flags,
...
struct dma_async_tx_descriptor *async_xor_offs(struct page *dest,
    unsigned int offset,
...
struct dma_async_tx_descriptor *async_xor_val_offs(struct page *dest,
    unsigned int offset,
    struct page **src_list, unsigned int *src_offset,
    int src_cnt, size_t len, enum sum_check_flags *result,
    struct async_submit_ctl *submit);
...
struct dma_async_tx_descriptor *async_trigger_callback(
  struct async_submit_ctl *submit);
...
struct dma_async_tx_descriptor *async_raid6_2data_recov(int src_num,
    size_t bytes, int faila,
    int failb,
    struct page **ptrs, unsigned int *offs,
    struct async_submit_ctl *submit);

struct dma_async_tx_descriptor *async_raid6_datap_recov(int src_num,
    size_t bytes, int faila,
    struct page **ptrs, unsigned int *offs,
    struct async_submit_ctl *submit);
