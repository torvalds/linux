...
#define   AT91RM9200_PMC_UDP  (1 << 1)   /* USB Devcice Port Clock [AT91RM9200
                                          * only] */
#define   AT91RM9200_PMC_MCKUDP (1 << 2)   /* USB Device Port Master Clock
                                            * Automatic Disable on Suspend
                                            * [AT91RM9200 only] */
#define   AT91RM9200_PMC_UHP  (1 << 4)   /* USB Host Port Clock [AT91RM9200
                                          * only] */
#define   AT91SAM926x_PMC_UHP (1 << 6)   /* USB Host Port Clock [AT91SAM926x
                                          * only] */
#define   AT91SAM926x_PMC_UDP (1 << 7)   /* USB Devcice Port Clock [AT91SAM926x
                                          * only] */
...
#define AT91_PMC_PLL_ACR  0x18      /* PLL Analog Control Register [for SAM9X60]
                                     * */
#define   AT91_PMC_PLL_ACR_DEFAULT_UPLL UL(0x12020010)  /* Default PLL ACR value
                                                         * for UPLL */
#define   AT91_PMC_PLL_ACR_DEFAULT_PLLA UL(0x00020010)  /* Default PLL ACR value
                                                         * for PLLA */
...
#define   AT91_PMC_MOSCRCEN (1 << 3)    /* Main On-Chip RC Oscillator Enable
                                         * [some SAM9] */
#define   AT91_PMC_OSCOUNT  (0xff << 8)    /* Main Oscillator Start-up Time */
#define   AT91_PMC_KEY_MASK (0xff << 16)
#define   AT91_PMC_KEY    (0x37 << 16)    /* MOR Writing Key */
#define   AT91_PMC_MOSCSEL  (1 << 24)    /* Main Oscillator Selection [some
                                          * SAM9] */
#define   AT91_PMC_CFDEN    (1 << 25)    /* Clock Failure Detector Enable [some
                                          * SAM9] */
...
#define AT91_PMC_RATIO    0x2c      /* Processor clock ratio register [SAMA7G5
                                     * only] */
...
#define   AT91_PMC_ALT_PRES (7 << PMC_ALT_PRES_OFFSET)   /* Master Clock
                                                          * Prescaler [alternate
                                                          * location] */
...
#define   AT91_PMC_PDIV   (1 << 12)   /* Processor Clock Division [some SAM9
                                       * only] */
...
#define AT91_PMC_XTALF    0x34      /* Main XTAL Frequency Register [SAMA7G5
                                     * only] */
...
#define AT91_PMC_PCKR(n)  (0x40 + ((n) * 4))  /* Programmable Clock 0-N
                                               * Registers */
#define   AT91_PMC_ALT_PCKR_CSS (0x7 << 0)   /* Programmable Clock Source
                                              * Selection [alternate length] */
...
#define   AT91_PMC_CFDEV    (1 << 18)   /* Clock Failure Detector Event [some
                                         * SAM9] */
...
#define AT91_PMC_PLL_ISR0 0xEC      /* PLL Interrupt Status Register 0 [SAM9X60
                                     * only] */

#define AT91_PMC_PCER1    0x100     /* Peripheral Clock Enable Register 1 [SAMA5
                                     * only]*/
#define AT91_PMC_PCDR1    0x104     /* Peripheral Clock Enable Register 1 */
#define AT91_PMC_PCSR1    0x108     /* Peripheral Clock Enable Register 1 */

#define AT91_PMC_PCR    0x10c     /* Peripheral Control Register [some SAM9 and
                                   * SAMA5] */
...
#define   AT91_PMC_AUDIO_PLL_QDPMC_MASK (0x7f << \
...
#define   AT91_PMC_AUDIO_PLL_QDPAD_MASK   (0x7f << \
...
#define   AT91_PMC_AUDIO_PLL_QDPAD_DIV_MASK (0x3 << \
    AT91_PMC_AUDIO_PLL_QDPAD_DIV_OFFSET)
#define   AT91_PMC_AUDIO_PLL_QDPAD_DIV(n)   ((n) << \
    AT91_PMC_AUDIO_PLL_QDPAD_DIV_OFFSET)
...
#define   AT91_PMC_AUDIO_PLL_QDPAD_EXTDIV(n)  ((n) << \
    AT91_PMC_AUDIO_PLL_QDPAD_EXTDIV_OFFSET)
