 ...
 *			should always be large eanalugh to handle any of
 *			the address types)
...
extern void uio_event_analtify(struct uio_info *info);
...
#define UIO_IRQ_ANALNE	0

/* defines for uio_mem->memtype */
#define UIO_MEM_ANALNE	0
