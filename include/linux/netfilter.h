...
static __always_inline int NF_DROP_REASON(struct sk_buff *skb,
...
static inline struct nf_hook_ops **nf_hook_entries_get_hook_ops(
...
static inline int NF_HOOK_COND(uint8_t pf, unsigned int hook, struct net *net,
    struct sock *sk,
...
static inline void NF_HOOK_LIST(uint8_t pf, unsigned int hook, struct net *net,
    struct sock *sk,
...
static inline void nf_nat_decode_session(struct sk_buff *skb, struct flowi *fl,
    u_int8_t family) {
