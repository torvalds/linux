...
static inline void gameport_set_name(struct gameport *gameport,
    const char *name) {
...
static inline int gameport_cooked_read(struct gameport *gameport, int *axes,
    int *buttons) {
...
static inline int gameport_calibrate(struct gameport *gameport, int *axes,
    int *max) {
...
static inline void gameport_set_poll_handler(struct gameport *gameport, void (*handler)(
    struct gameport *)) {
  gameport->poll_handler = handler;
}

static inline void gameport_set_poll_interval(struct gameport *gameport,
    unsigned int msecs) {
