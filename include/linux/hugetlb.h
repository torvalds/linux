...
static inline bool isolate_hugetlb(struct folio *folio,
...
unsigned long generic_hugetlb_get_unmapped_area(struct file *file,
    unsigned long addr,
    unsigned long len, unsigned long pgoff,
    unsigned long flags);
...
static inline struct hugepage_subpool *hugetlb_folio_subpool(
    struct folio *folio) {
...
static inline struct folio *alloc_hugetlb_folio_nodemask(struct hstate *h,
    int preferred_nid,
    nodemask_t *nmask, gfp_t gfp_mask) {
  return NULL;
}
...
static inline void hugetlb_report_usage(struct seq_file *f,
    struct mm_struct *m) {
}
 ...
 */
static inline pte_t *hugetlb_walk(struct vm_area_struct *vma,
    unsigned long addr, unsigned long sz) {
