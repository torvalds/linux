...
extern int amd_iommu_update_ga(int cpu, bool is_run, void *data);
...
static inline int amd_iommu_register_ga_log_notifier(int (*notifier)(u32)) {
  return 0;
}

static inline int amd_iommu_update_ga(int cpu, bool is_run, void *data) {
  return 0;
}
...
#else
static inline int amd_iommu_snp_disable(void) {
  return 0;
}
