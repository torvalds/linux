...
static inline int mempool_init_slab_pool(mempool_t *pool, int min_nr,
...
static inline int mempool_init_kvmalloc_pool(mempool_t *pool, int min_nr,
    size_t size) {
  return mempool_init(pool, min_nr, mempool_kvmalloc, mempool_kvfree,
      (void *) size);
}
...
static inline int mempool_init_page_pool(mempool_t *pool, int min_nr,
    int order) {
