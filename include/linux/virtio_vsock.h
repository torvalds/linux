...
static inline void virtio_vsock_skb_queue_head(struct sk_buff_head *list,
    struct sk_buff *skb) {
...
static inline void virtio_vsock_skb_queue_tail(struct sk_buff_head *list,
    struct sk_buff *skb) {
  spin_lock_bh(&list->lock);
...
static inline struct sk_buff *virtio_vsock_skb_dequeue(
