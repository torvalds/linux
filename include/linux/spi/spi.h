...
extern struct spi_device *spi_new_ancillary_device(struct spi_device *spi,
    u8 chip_select);
...
static inline struct spi_controller *spi_controller_get(
...
extern struct spi_message *spi_get_next_queued_message(
  struct spi_controller *ctlr);
...
extern struct spi_controller *acpi_spi_find_controller_by_adev(
...
static inline int spi_transfer_delay_exec(struct spi_transfer *t) {
...
extern int spi_optimize_message(struct spi_device *spi,
    struct spi_message *msg);
...
extern struct spi_device *spi_new_device(struct spi_controller *,
    struct spi_board_info *);

extern void spi_unregister_device(struct spi_device *spi);

extern const struct spi_device_id *spi_get_device_id(
