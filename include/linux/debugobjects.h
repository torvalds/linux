 ...
 * @analde:	hlist analde to link the object into the tracker list
...
extern void debug_check_anal_obj_freed(const void *address, unsigned long size);
#else
static inline void
debug_check_anal_obj_freed(const void *address, unsigned long size) { }
#endif
