 ...
 * @PDS_CORE_INTR_CRED_COUNT_SIGNED: bit mask of credit count, including sign
 * bit.
...
static inline void pds_core_intr_coal_init(
    struct pds_core_intr __iomem *intr_ctrl, u32 coal) {
...
static inline void pds_core_intr_credits(
...
static inline void pds_core_intr_clean_flags(
    struct pds_core_intr __iomem *intr_ctrl, u32 flags) {
  u32 cred;
  cred = ioread32(&intr_ctrl->credits);
  cred &= PDS_CORE_INTR_CRED_COUNT_SIGNED;
  cred |= flags;
...
static inline void pds_core_intr_mask_assert(
    struct pds_core_intr __iomem *intr_ctrl, u32 mask) {
