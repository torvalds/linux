...
int __must_check devm_regulator_bulk_get_exclusive(struct device *dev,
    int num_consumers,
    struct regulator_bulk_data *consumers);
...
static inline struct regulator *__must_check devm_regulator_get(
...
static inline struct regulator *__must_check devm_regulator_get_exclusive(
    struct device *dev, const char *id) {
  return ERR_PTR(-ENODEV);
}

static inline int devm_regulator_get_enable(struct device *dev,
    const char *id) {
  return -ENODEV;
}
...
static inline struct regulator *__must_check regulator_get_optional(
    struct device *dev, const char *id) {
  return ERR_PTR(-ENODEV);
}

static inline struct regulator *__must_check devm_regulator_get_optional(
    struct device *dev, const char *id) {
  return ERR_PTR(-ENODEV);
}
...
static inline void devm_regulator_bulk_put(
    struct regulator_bulk_data *consumers) {
}
...
static inline int of_regulator_bulk_get_all(struct device *dev,
    struct device_node *np,
    struct regulator_bulk_data **consumers) {
  return 0;
}
...
static inline unsigned int regulator_get_linear_step(
...
static inline int regulator_get_hardware_vsel_register(
    struct regulator *regulator,
    unsigned *vsel_reg,
    unsigned *vsel_mask) {
  return -EOPNOTSUPP;
...
static inline int devm_regulator_unregister_notifier(
    struct regulator *regulator,
    struct notifier_block *nb) {
  return 0;
}
...
static inline void regulator_bulk_set_supply_names(
    struct regulator_bulk_data *consumers,
    const char * const *supply_names,
    unsigned int num_supplies) {
}

static inline bool regulator_is_equal(struct regulator *reg1,
...
static inline int regulator_is_supported_voltage_tol(
    struct regulator *regulator,
