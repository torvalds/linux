...
#define __SC_LONG(t, \
      a) __typeof(__builtin_choose_expr(__TYPE_IS_LL(t), 0LL, 0L)) a
#define __SC_CAST(t, a) (__force t) a
#define __SC_TYPE(t, a) t
#define __SC_ARGS(t, a) a
#define __SC_TEST(t, a) (void) BUILD_BUG_ON_ZERO(!__TYPE_IS_LL( \
    t) && sizeof(t) > sizeof(long))
...
asmlinkage long sys_mq_timedreceive(mqd_t mqdes, char __user *msg_ptr,
    size_t msg_len,
