...
#define SSCR0_Motorola  (0x0 << 4)  /* Motorola's Serial Peripheral Interface
                                     * (SPI) */
#define SSCR0_TI  (0x1 << 4)  /* Texas Instruments' Synchronous Serial Protocol
                               * (SSP) */
...
#define QUARK_X1000_SSCR0_Motorola  (0x0 << 5)  /* Motorola's Serial Peripheral
                                                 * Interface (SPI) */
...
#define SFIFOTT_TxThresh(x) (((x) - 1) << 0)  /* TX FIFO trigger threshold /
                                               * level */
#define SFIFOTT_RFT   GENMASK(31, 16) /* Receive FIFO Threshold (mask) */
#define SFIFOTT_RxThresh(x) (((x) - 1) << 16) /* RX FIFO trigger threshold /
                                               * level */
