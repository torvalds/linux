...
#ifdef CONFIG_NUMA
/*
 * XXX: node aware allocation can't work well to get new node's memory at this
 * time.
...
extern void mhp_deinit_memmap_on_memory(unsigned long pfn,
...
static inline void pgdat_resize_unlock(struct pglist_data *p,
    unsigned long *f) {
}
