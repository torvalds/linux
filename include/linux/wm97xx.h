...
#define WM97XX_PRP_DET		0x8000	/* detect on, digitise off, yes wake */
...
/* The pen is down (RC_VALID implies RC_PENDOWN, but sometimes it is helpful
   to tell the handler that the pen is down but we don't kyesw yet his coords,
   so the handler should yest sleep or wait for pendown irq) */
...
struct wm97xx_mach_ops {
	...
	/* pre and post sample - can be used to minimise any analog yesise */
...
/*
 * Codec GPIO access (yest supported on WM9705)
