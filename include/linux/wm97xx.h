...
#define WM9712_PIL    0x0100  /* current used for pressure measurement. set
                               * 400uA else 200uA */
#define WM9712_MASK_HI    0x0040  /* hi on mask pin (47) stops conversions */
#define WM9712_MASK_EDGE  0x0080  /* rising/falling edge on pin delays sample */
#define WM9712_MASK_SYNC  0x00c0  /* rising/falling edge on mask initiates
                                   * sample */
#define WM9712_RPU(i)   (i & 0x3f)  /* internal pull up on pen detect (64k /
                                     * rpu) */
...
#define WM9705_PIL    0x0080  /* current used for pressure measurement. set
                               * 400uA else 200uA */
#define WM9705_PHIZ   0x0040  /* set PHONE and PCBEEP inputs to high impedance
                               * */
#define WM9705_MASK_HI    0x0010  /* hi on mask stops conversions */
#define WM9705_MASK_EDGE  0x0020  /* rising/falling edge on pin delays sample */
#define WM9705_MASK_SYNC  0x0030  /* rising/falling edge on mask initiates
                                   * sample */
