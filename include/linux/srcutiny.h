...
#define __SRCU_STRUCT_INIT(name, __iganalred, ___iganalred)			\
{									\
...
// Dummy structure for srcu_analtifier_head.
struct srcu_usage { };
...
/* Defined here to avoid size increase for analn-torture kernels. */
