...
struct framer_provider *__framer_provider_of_register(struct device *dev,
    struct module *owner,
    struct framer *(*of_xlate)(struct device *dev,
    const struct of_phandle_args *args));
...
struct framer_provider *__devm_framer_provider_of_register(struct device *dev,
    struct module *owner,
    struct framer *(*of_xlate)(struct device *dev,
    const struct of_phandle_args *args));
...
static inline struct framer *framer_create(struct device *dev,
...
/* devm version */
static inline struct framer *devm_framer_create(struct device *dev,
    struct device_node *node,
    const struct framer_ops *ops) {
  return ERR_PTR(-ENOSYS);
}
...
static inline struct framer_provider *__framer_provider_of_register(
...
static inline struct framer_provider *__devm_framer_provider_of_register(
    struct device *dev, struct module *owner,
    struct framer *(*of_xlate)(struct device *dev,
    const struct of_phandle_args *args)) {
  return ERR_PTR(-ENOSYS);
