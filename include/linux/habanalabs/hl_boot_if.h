...
#define CPU_BOOT_ERR0_DEVICE_UNUSABLE_FAIL  (1 << \
    CPU_BOOT_ERR_DEVICE_UNUSABLE_FAIL)
#define CPU_BOOT_ERR0_BOOT_FW_CRIT_ERR    (1 << CPU_BOOT_ERR_BOOT_FW_CRIT_ERR)
#define CPU_BOOT_ERR0_BINNING_FAIL    (1 << CPU_BOOT_ERR_BINNING_FAIL)
#define CPU_BOOT_ERR0_TPM_FAIL      (1 << CPU_BOOT_ERR_TPM_FAIL)
#define CPU_BOOT_ERR0_TMP_THRESH_INIT_FAIL  (1 << \
    CPU_BOOT_ERR_TMP_THRESH_INIT_FAIL)
#define CPU_BOOT_ERR0_EEPROM_FAIL   (1 << CPU_BOOT_ERR_EEPROM_FAIL)
#define CPU_BOOT_ERR0_ENG_ARC_MEM_SCRUB_FAIL  (1 << \
    CPU_BOOT_ERR_ENG_ARC_MEM_SCRUB_FAIL)
...
#define CPU_BOOT_DEV_STS0_FW_IATU_CONF_EN (1 << \
    CPU_BOOT_DEV_STS_FW_IATU_CONF_EN)
...
#define CPU_BOOT_DEV_STS0_GIC_PRIVILEGED_EN (1 << \
    CPU_BOOT_DEV_STS_GIC_PRIVILEGED_EN)
#define CPU_BOOT_DEV_STS0_EQ_INDEX_EN   (1 << CPU_BOOT_DEV_STS_EQ_INDEX_EN)
#define CPU_BOOT_DEV_STS0_MULTI_IRQ_POLL_EN (1 << \
    CPU_BOOT_DEV_STS_MULTI_IRQ_POLL_EN)
#define CPU_BOOT_DEV_STS0_FW_NIC_STAT_XPCS91_EN (1 << \
    CPU_BOOT_DEV_STS_FW_NIC_STAT_XPCS91_EN)
#define CPU_BOOT_DEV_STS0_FW_NIC_STAT_EXT_EN  (1 << \
    CPU_BOOT_DEV_STS_FW_NIC_STAT_EXT_EN)
#define CPU_BOOT_DEV_STS0_IS_IDLE_CHECK_EN  (1 << \
    CPU_BOOT_DEV_STS_IS_IDLE_CHECK_EN)
...
enum cpu_boot_status {
  ...
  /* FW component is preparing to shutdown and communication with host is not
   * available */
