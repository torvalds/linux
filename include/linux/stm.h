 ...
 * @hw_override:	masters in the STP stream will yest match the ones
 ...
 *   2) therefore, if it sent a packet that does yest have payload (like FLAG),
 *      it must return zero;
 *   3) if it does yest support the requested packet type/flag combination,
 *      it must return -ENOTSUPP.
 *
 * The @unlink callback is called when there are yes more active writers so
...
int yestrace stm_source_write(struct stm_source_data *data, unsigned int chan,
