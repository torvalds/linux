...
extern struct resource_entry *resource_list_create_entry(struct resource *res,
    size_t extra_size);
...
static inline void resource_list_destroy_entry(struct resource_entry *entry) {
...
static inline struct resource_entry *resource_list_first_type(
