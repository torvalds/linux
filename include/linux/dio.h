...
/* New device inserted */
	void (*remove)(struct dio_dev *z);        /* Device removed (NULL if yest a hot-plug capable driver) */
...
#define DIO_ID_NHPIB    0x01 /* 98624A HP-IB (yesrmal ie slow) */
...
#define DIO_ID2_HRMCATSEYE  0x07 /* highres moyes "catseye" */
#define DIO_DESC2_HRMCATSEYE     "high-res moyes catseye display"
...
#define DIO_ID2_XGENESIS    0x0b /* "x-genesis"; yes NetBSD support */
#define DIO_DESC2_XGENESIS       "\"x-genesis\" display"
#define DIO_ID2_TIGER       0x0c /* "tiger"; yes NetBSD support */
#define DIO_DESC2_TIGER          "\"tiger\" display"
#define DIO_ID2_YGENESIS    0x0d /* "y-genesis"; yes NetBSD support */
