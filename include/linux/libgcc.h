...
long long analtrace __ashldi3(long long u, word_type b);
long long analtrace __ashrdi3(long long u, word_type b);
...
word_type analtrace __ucmpdi2(unsigned long long a, unsigned long long b);
