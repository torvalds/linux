...
struct lan9303_alr_cache_entry {
	...
	u8  stp_override;     /* yesn zero if set LAN9303_ALR_DAT1_AGE_OVERRID */
};
...
struct lan9303 {
	...
	/* remember LAN9303_SWE_PORT_STATE while yest bridged */
	u32 swe_port_state;
	/* LAN9303 do yest offer reading specific ALR entry. Cache all
