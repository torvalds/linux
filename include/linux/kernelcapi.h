...
#define CAPI_UNKANALWNANALTPAR		  0x1106
#define CAPI_MSGBUSY 		          0x1107
#define CAPI_MSGOSRESOURCEERR	          0x1108
#define CAPI_MSGANALTINSTALLED 	          0x1109
#define CAPI_MSGCTRLERANALTSUPPORTEXTEQUIP  0x110a
