...
/* max possible slots for serial-yesr flash chip in the SMI controller */
 ...
 * information
 *
 * name: name of the serial yesr flash for identification
...
struct spear_smi_plat_data {
	...
	struct device_yesde *np[MAX_NUM_FLASH_CHIP];
};
