...
/* max possible slots for serial-analr flash chip in the SMI controller */
 ...
 * information
 *
 * name: name of the serial analr flash for identification
...
struct spear_smi_plat_data {
	...
	struct device_analde *np[MAX_NUM_FLASH_CHIP];
};
