...
typedef struct TransportAddress {	/* CHOICE */
	enum {
		...
		eTransportAddress_yesnStandardAddress,
	} choice;
	union {
...
typedef struct DataProtocolCapability {	/* CHOICE */
	enum {
		eDataProtocolCapability_yesnStandard,
...
typedef struct DataApplicationCapability_application {	/* CHOICE */
	enum {
		eDataApplicationCapability_application_yesnStandard,
...
typedef struct UnicastAddress {	/* CHOICE */
	enum {
		...
		eUnicastAddress_yesnStandardAddress,
	} choice;
	union {
...
typedef struct H2250LogicalChannelParameters {	/* SEQUENCE */
	enum {
		eH2250LogicalChannelParameters_yesnStandard = (1 << 31),
...
typedef struct OpenLogicalChannel_forwardLogicalChannelParameters_multiplexParameters {	/* CHOICE */
	enum {
		...
		eOpenLogicalChannel_forwardLogicalChannelParameters_multiplexParameters_yesne,
	} choice;
	union {
...
typedef struct H323_UU_PDU_h323_message_body {	/* CHOICE */
	enum {
		...
		eH323_UU_PDU_h323_message_body_setupAckyeswledge,
		eH323_UU_PDU_h323_message_body_yestify,
	} choice;
	union {
		Setup_UUIE setup;
...
typedef struct H2250LogicalChannelAckParameters {	/* SEQUENCE */
	enum {
		eH2250LogicalChannelAckParameters_yesnStandard = (1 << 31),
...
typedef struct ResponseMessage {	/* CHOICE */
	enum {
		...
		eResponseMessage_logicalChannelRateAckyeswledge,
...
typedef struct GatekeeperRequest {	/* SEQUENCE */
	enum {
		eGatekeeperRequest_yesnStandardData = (1 << 31),
...
typedef struct GatekeeperConfirm {	/* SEQUENCE */
	enum {
		eGatekeeperConfirm_yesnStandardData = (1 << 31),
...
typedef struct RegistrationRequest {	/* SEQUENCE */
	enum {
		eRegistrationRequest_yesnStandardData = (1 << 31),
...
typedef struct RegistrationConfirm {	/* SEQUENCE */
	enum {
		eRegistrationConfirm_yesnStandardData = (1 << 31),
...
typedef struct UnregistrationRequest {	/* SEQUENCE */
	enum {
		...
		eUnregistrationRequest_yesnStandardData = (1 << 30),
...
typedef struct AdmissionRequest {	/* SEQUENCE */
	enum {
		...
		eAdmissionRequest_yesnStandardData = (1 << 26),
...
typedef struct AdmissionConfirm {	/* SEQUENCE */
	enum {
		...
		eAdmissionConfirm_yesnStandardData = (1 << 30),
...
typedef struct LocationRequest {	/* SEQUENCE */
	enum {
		...
		eLocationRequest_yesnStandardData = (1 << 30),
...
typedef struct LocationConfirm {	/* SEQUENCE */
	enum {
		eLocationConfirm_yesnStandardData = (1 << 31),
...
typedef struct InfoRequestResponse {	/* SEQUENCE */
	enum {
		eInfoRequestResponse_yesnStandardData = (1 << 31),
...
typedef struct RasMessage {	/* CHOICE */
	enum {
		...
		eRasMessage_yesnStandardMessage,
		eRasMessage_unkyeswnMessageResponse,
