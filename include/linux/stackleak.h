 ...
 */
static __always_inline unsigned long stackleak_task_low_bound(
 ...
 * can plausibly erase.
 */
static __always_inline unsigned long stackleak_task_high_bound(
    const struct task_struct *tsk) {
  /*
 ...
 */
static __always_inline unsigned long stackleak_find_top_of_poison(
    const unsigned long low, const unsigned long high) {
