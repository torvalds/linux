...
#define   SSB_CHIPCO_CAP_UARTCLK_INT  0x00000008  /* UARTs are driven by
...
#define  SSB_CHIPCO_CORECTL_UARTCLK0  0x00000001  /* Drive UART with internal
                                                   * clock */
#define  SSB_CHIPCO_CORECTL_SE    0x00000002  /* sync clk out enable (corerev >=
                                               * 3) */
#define  SSB_CHIPCO_CORECTL_UARTCLKEN 0x00000008  /* UART clock enable (rev >=
                                                   * 21) */
...
#define   SSB_CHIPCO_SLOWCLKCTL_SRC_LPO   0x00000000  /* source of slow clock is
                                                       * LPO */
#define   SSB_CHIPCO_SLOWCLKCTL_SRC_XTAL  0x00000001  /* source of slow clock is
                                                       * crystal */
#define   SSB_CHIPCO_SLOECLKCTL_SRC_PCI   0x00000002  /* source of slow clock is
                                                       * PCI */
#define  SSB_CHIPCO_SLOWCLKCTL_LPOFREQ  0x00000200  /* LPOFreqSel, 1: 160Khz, 0:
                                                     * 32KHz */
#define  SSB_CHIPCO_SLOWCLKCTL_LPOPD  0x00000400  /* LPOPowerDown, 1: LPO is
                                                   * disabled, 0: LPO is enabled
                                                   * */
#define  SSB_CHIPCO_SLOWCLKCTL_FSLOW  0x00000800  /* ForceSlowClk, 1: sb/cores
                                                   * running on slow clock, 0:
                                                   * power logic control */
#define  SSB_CHIPCO_SLOWCLKCTL_IPLL 0x00001000  /* IgnorePllOffReq, 1/0: power
                                                 * logic ignores/honors PLL
                                                 * clock disable requests from
                                                 * core */
#define  SSB_CHIPCO_SLOWCLKCTL_ENXTAL 0x00002000  /* XtalControlEn, 1/0: power
                                                   * logic does/doesn't disable
                                                   * crystal when appropriate */
#define  SSB_CHIPCO_SLOWCLKCTL_XTALPU 0x00004000  /* XtalPU (RO), 1/0: crystal
                                                   * running/disabled */
#define  SSB_CHIPCO_SLOWCLKCTL_CLKDIV 0xFFFF0000  /* ClockDivider (SlowClk =
                                                   * 1/(4+divisor)) */
#define  SSB_CHIPCO_SLOWCLKCTL_CLKDIV_SHIFT 16
#define SSB_CHIPCO_SYSCLKCTL    0x00C0    /* Rev >= 3 only */
#define  SSB_CHIPCO_SYSCLKCTL_IDLPEN  0x00000001  /* ILPen: Enable Idle Low
                                                   * Power */
#define  SSB_CHIPCO_SYSCLKCTL_ALPEN 0x00000002  /* ALPen: Enable Active Low
                                                 * Power */
#define  SSB_CHIPCO_SYSCLKCTL_PLLEN 0x00000004  /* ForcePLLOn */
#define  SSB_CHIPCO_SYSCLKCTL_FORCEALP  0x00000008  /* Force ALP (or HT if ALPen
                                                     * is not set */
#define  SSB_CHIPCO_SYSCLKCTL_FORCEHT 0x00000010  /* Force HT */
#define  SSB_CHIPCO_SYSCLKCTL_CLKDIV  0xFFFF0000  /* ClkDiv  (ILP =
                                                   * 1/(4+divisor)) */
...
#define  SSB_CHIPCO_CLKCTLST_4328A0_HAVEHT  0x00010000 /* 4328a0 has reversed
                                                        * bits */
#define  SSB_CHIPCO_CLKCTLST_4328A0_HAVEALP 0x00020000 /* 4328a0 has reversed
                                                        * bits */
...
#define  SSB_PMU0_PLLCTL2_WILD_IMSKHI   0x0000000F /* Wild int mask (high
                                                    * nibble) */
...
#define SSB_CHIPCO_CHST_4325_DEFCIS_SEL   0 /* OTP is powered up, use def. CIS,
                                             * no SPROM */
#define SSB_CHIPCO_CHST_4325_SPROM_SEL    1 /* OTP is powered up, SPROM is
                                             * present */
#define SSB_CHIPCO_CHST_4325_OTP_SEL    2 /* OTP is powered up, no SPROM */
#define SSB_CHIPCO_CHST_4325_OTP_PWRDN    3 /* OTP is powered down, SPROM is
                                             * present */
