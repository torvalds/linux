...
#define SSB_PCI_DMA_SZ    0x40000000U /* Client Mode sb2pcitranslation2 size in
                                       * bytes */
#define SSB_PCIE_DMA_L32  0x00000000U /* PCIE Client Mode sb2pcitranslation2 (2
                                       * ZettaBytes), low 32 bits */
#define SSB_PCIE_DMA_H32  0x80000000U /* PCIE Client Mode sb2pcitranslation2 (2
                                       * ZettaBytes), high 32 bits */
...
#define SSB_GPIO_OUT_ENABLE 0xB8  /* GPIO Output Enable/Disable (pcirev >= 3
                                   * only) */
#define  SSB_GPIO_SCS   0x10  /* PCI config space bit 4 for 4306c0 slow clock
                               * source */
...
#define  SSB_IPSFLAG_IRQ1 0x0000003F /* which sbflags get routed to mips
                                      * interrupt 1 */
#define  SSB_IPSFLAG_IRQ1_SHIFT 0
#define  SSB_IPSFLAG_IRQ2 0x00003F00 /* which sbflags get routed to mips
                                      * interrupt 2 */
#define  SSB_IPSFLAG_IRQ2_SHIFT 8
#define  SSB_IPSFLAG_IRQ3 0x003F0000 /* which sbflags get routed to mips
                                      * interrupt 3 */
#define  SSB_IPSFLAG_IRQ3_SHIFT 16
#define  SSB_IPSFLAG_IRQ4 0x3F000000 /* which sbflags get routed to mips
                                      * interrupt 4 */
...
#define SSB_SPROM3_OFDMAPO    0x002C  /* A-PHY OFDM Mid Power Offset (4 bytes,
                                       * BigEndian) */
#define SSB_SPROM3_OFDMALPO   0x0030  /* A-PHY OFDM Low Power Offset (4 bytes,
                                       * BigEndian) */
#define SSB_SPROM3_OFDMAHPO   0x0034  /* A-PHY OFDM High Power Offset (4 bytes,
                                       * BigEndian) */
#define SSB_SPROM3_GPIOLDC    0x0042  /* GPIO LED Powersave Duty Cycle (4 bytes,
                                       * BigEndian) */
...
#define  SSB_SPROM3_OFDMGPO   0x107A  /* G-PHY OFDM Power Offset (4 bytes,
                                       * BigEndian) */
...
#define SSB_BFL_AIRLINEMODE   0x0004  /* implements GPIO 13 radio disable
                                       * indication */
...
#define SSB_BFH_3TSWITCH    0x0008  /* uses a triple throw switch shared with
                                     * bluetooth */
#define SSB_BFH_PHASESHIFT    0x0010  /* can support phase shifter */
#define SSB_BFH_BUCKBOOST   0x0020  /* has buck/booster */
#define SSB_BFH_FEM_BT      0x0040  /* has FEM and switch to share antenna with
                                     * bluetooth */

/* Values for boardflags2_lo read from SPROM */
#define SSB_BFL2_RXBB_INT_REG_DIS 0x0001  /* external RX BB regulator present */
#define SSB_BFL2_APLL_WAR   0x0002  /* alternative A-band PLL settings
                                     * implemented */
...
#define SSB_BFL2_SPUR_WAR   0x0200  /* has a workaround for clock-harmonic spurs
                                     * */
#define SSB_BFL2_GPLL_WAR   0x0400  /* altenative G-band PLL settings
                                     * implemented */
