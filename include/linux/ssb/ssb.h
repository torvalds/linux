...
/* Devicetype specific user data. This is per device-type (yest per device) */
...
struct ssb_bus {
	...
	/* The following structure elements are yest available in early
	...
	/* Internal-only stuff follows. Do yest touch. */
 ...
 * If yes device-specific flags are available, use 0. */
...
static inline void __cold __ssb_dma_yest_implemented(struct ssb_device *dev)
{
