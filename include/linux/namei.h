...
extern struct dentry *user_path_locked_at(int, const char __user *,
    struct path *);
...
extern struct dentry *lookup_positive_unlocked(const char *, struct dentry *,
    int);
struct dentry *lookup_one(struct mnt_idmap *, const char *, struct dentry *,
    int);
 ...
 * Returns: mode
 */
static inline umode_t __must_check mode_strip_umask(const struct inode *dir,
    umode_t mode) {
