...
int device_property_read_u8_array(const struct device *dev,
    const char *propname,
    u8 *val, size_t nval);
int device_property_read_u16_array(const struct device *dev,
    const char *propname,
    u16 *val, size_t nval);
int device_property_read_u32_array(const struct device *dev,
    const char *propname,
    u32 *val, size_t nval);
int device_property_read_u64_array(const struct device *dev,
    const char *propname,
    u64 *val, size_t nval);
int device_property_read_string_array(const struct device *dev,
    const char *propname,
...
static inline bool fwnode_device_is_big_endian(
...
static inline
bool fwnode_device_is_compatible(const struct fwnode_handle *fwnode,
    const char *compat) {
...
/**
 * device_is_compatible - match 'compatible' property of the device with a given
 * string
 * @dev: Pointer to the struct device
 ...
 */
static inline bool device_is_compatible(const struct device *dev,
    const char *compat) {
...
int device_property_match_property_string(const struct device *dev,
    const char *propname,
    const char * const *array, size_t n) {
  return fwnode_property_match_property_string(dev_fwnode(
      dev), propname, array, n);
}
...
static inline int device_property_count_u8(const struct device *dev,
    const char *propname) {
  return device_property_read_u8_array(dev, propname, NULL, 0);
}

static inline int device_property_count_u16(const struct device *dev,
    const char *propname) {
...
static inline int device_property_count_u64(const struct device *dev,
    const char *propname) {
...
static inline int fwnode_property_string_array_count(
    const struct fwnode_handle *fwnode,
    const char *propname) {
