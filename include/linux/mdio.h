...
static inline struct mdio_driver_common *to_mdio_common_driver(
...
static inline struct mdio_driver *to_mdio_driver(
    const struct device_driver *driver) {
 ...
 */
static inline void mii_t1_adv_l_mod_linkmode_t(unsigned long *advertising,
    u32 lpa) {
 ...
 * Other bits in advertising aren't changed.
 */
static inline void mii_t1_adv_m_mod_linkmode_t(unsigned long *advertising,
    u32 lpa) {
 ...
 */
static inline void mii_eee_cap2_mod_linkmode_sup_t(unsigned long *adv,
    u32 val) {
  linkmode_mod_bit(ETHTOOL_LINK_MODE_2500baseT_Full_BIT,
 ...
 */
static inline void mii_eee_cap2_mod_linkmode_adv_t(unsigned long *adv,
    u32 val) {
  linkmode_mod_bit(ETHTOOL_LINK_MODE_2500baseT_Full_BIT,
      adv, val & MDIO_EEE_2_5GT);
  linkmode_mod_bit(ETHTOOL_LINK_MODE_5000baseT_Full_BIT,
 ...
 */
static inline void mii_10base_t1_adv_mod_linkmode_t(unsigned long *adv,
    u16 val) {
  linkmode_mod_bit(ETHTOOL_LINK_MODE_10baseT1L_Full_BIT,
