...
#define BCMA_PCI_GPIO_OUT_ENABLE  0xB8  /* GPIO Output Enable/Disable (pcirev >=
                                         * 3 only) */
#define  BCMA_PCI_GPIO_SCS    0x10  /* PCI config space bit 4 for 4306c0 slow
                                     * clock source */
#define  BCMA_PCI_GPIO_HWRAD    0x20  /* PCI config space GPIO 13 for hw radio
                                       * disable */
#define  BCMA_PCI_GPIO_XTAL   0x40  /* PCI config space GPIO 14 for Xtal powerup
                                     * */
#define  BCMA_PCI_GPIO_PLL    0x80  /* PCI config space GPIO 15 for PLL
                                     * powerdown */
...
#define BCMA_SOC_PCI_DMA2   0x80000000U /* Client Mode sb2pcitranslation2 (1 GB)
                                         * */
#define BCMA_SOC_PCI_DMA_SZ   0x40000000U /* Client Mode sb2pcitranslation2 size
                                           * in bytes */
#define BCMA_SOC_PCIE_DMA_L32   0x00000000U /* PCIE Client Mode
                                             * sb2pcitranslation2
...
#define BCMA_SOC_PCI1_CFG   0x44000000U /* Host Mode sb2pcitranslation1 (64 MB)
                                         * */
#define BCMA_SOC_PCIE1_DMA_H32    0xc0000000U /* PCIE Client Mode
                                               * sb2pcitranslation2
                                               * (2 ZettaBytes), high 32 bits
                                               */
...
#define BCMA_SOC_FLASH2     0x1c000000  /* Flash Region 2 (region 1 shadowed
                                         * here) */
