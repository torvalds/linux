...
#define  BCMA_CORE_PCI_CTL_CLK      0x00000008 /* Gate for clock driven out to
                                                * pin */
...
#define  BCMA_CORE_PCI_ARBCTL_PARKID    0x00000006 /* Mask, selects which agent
                                                    * is parked on an idle bus
                                                    * */
...
#define BCMA_CORE_PCI_SBTOPCI0      0x0100  /* Backplane to PCI translation 0
                                             * (sbtopci0) */
#define  BCMA_CORE_PCI_SBTOPCI0_MASK    0xFC000000
#define BCMA_CORE_PCI_SBTOPCI1      0x0104  /* Backplane to PCI translation 1
                                             * (sbtopci1) */
#define  BCMA_CORE_PCI_SBTOPCI1_MASK    0xFC000000
#define BCMA_CORE_PCI_SBTOPCI2      0x0108  /* Backplane to PCI translation 2
                                             * (sbtopci2) */
...
#define  BCMA_CORE_PCI_MDIODATA_REGADDR_SHF_OLD 18  /* Regaddr shift (rev < 10)
                                                     * */
#define  BCMA_CORE_PCI_MDIODATA_REGADDR_MASK_OLD  0x003c0000 /* Regaddr Mask
                                                             * (rev < 10) */
#define  BCMA_CORE_PCI_MDIODATA_DEVADDR_SHF_OLD 22  /* Physmedia devaddr shift
                                                     * (rev < 10) */
#define  BCMA_CORE_PCI_MDIODATA_DEVADDR_MASK_OLD  0x0fc00000 /* Physmedia
                                                              * devaddr Mask
                                                              * (rev < 10) */
#define  BCMA_CORE_PCI_MDIODATA_REGADDR_SHF 18  /* Regaddr shift */
#define  BCMA_CORE_PCI_MDIODATA_REGADDR_MASK  0x007c0000 /* Regaddr Mask */
#define  BCMA_CORE_PCI_MDIODATA_DEVADDR_SHF 23  /* Physmedia devaddr shift */
#define  BCMA_CORE_PCI_MDIODATA_DEVADDR_MASK  0x0f800000 /* Physmedia devaddr
                                                          * Mask */
...
#define BCMA_CORE_PCI_PCIEIND_ADDR    0x0130  /* indirect access to the internal
                                               * register */
#define BCMA_CORE_PCI_PCIEIND_DATA    0x0134  /* Data to/from the internal
                                               * register */
...
#define BCMA_CORE_PCI_SPROM(wordoffset)   (0x0800 + ((wordoffset) * 2)) /* SPROM
                                                                         * shadow
                                                                         * area
                                                                         * (72
                                                                         * bytes)
...
#define   BCMA_CORE_PCI_SPROM_CLKREQ_OFFSET_REV5  20  /* word 20 for srom rev <=
                                                       * 5 */
...
#define  BCMA_CORE_PCI_PLP_POLARITYINV_STAT 0x10  /* Status reg
                                                   * PCIE_PLP_STATUSREG */
...
#define  BCMA_CORE_PCI_ASPMTIMER_EXTEND   0x01000000 /* > rev7: enable extend
                                                      * ASPM timer */
