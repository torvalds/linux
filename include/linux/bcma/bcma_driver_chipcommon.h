...
#define   BCMA_CC_CAP_UARTCLK_INT 0x00000008  /* UARTs are driven by internal
                                               * divided clock */
...
#define  BCMA_CC_CAP_NFLASH   0x80000000  /* NAND flash present (rev >= 35 or
                                           * BCM4706?) */
...
#define  BCMA_CC_OTPS_GU_PROG_IND 0x00000F00  /* General Use programmed
                                               * indication */
...
#define  BCMA_CC_CHIPST_4706_PKG_OPTION   BIT(0) /* 0: full-featured package 1:
                                                  * low-cost package */
#define  BCMA_CC_CHIPST_4706_SFLASH_PRESENT BIT(1) /* 0: parallel, 1: serial
                                                    * flash is present */
#define  BCMA_CC_CHIPST_4706_SFLASH_TYPE  BIT(2) /* 0: 8b-p/ST-s flash, 1:
                                                  * 16b-p/Atmal-s flash */
#define  BCMA_CC_CHIPST_4706_MIPS_BENDIAN BIT(3) /* 0: little, 1: big endian */
#define  BCMA_CC_CHIPST_4706_PCIE1_DISABLE  BIT(5) /* PCIE1 enable strap pin */
#define  BCMA_CC_CHIPST_5357_NAND_BOOT    BIT(4) /* NAND boot, valid for CC rev
                                                  * 38 and/or BCM5357 */
...
#define   BCMA_CC_SLOWCLKCTL_SRC_LPO  0x00000000  /* source of slow clock is LPO
                                                   * */
#define   BCMA_CC_SLOWCLKCTL_SRC_XTAL 0x00000001  /* source of slow clock is
                                                   * crystal */
#define   BCMA_CC_SLOECLKCTL_SRC_PCI  0x00000002  /* source of slow clock is PCI
                                                   * */
#define  BCMA_CC_SLOWCLKCTL_LPOFREQ 0x00000200  /* LPOFreqSel, 1: 160Khz, 0:
                                                 * 32KHz */
#define  BCMA_CC_SLOWCLKCTL_LPOPD 0x00000400  /* LPOPowerDown, 1: LPO is
                                               * disabled, 0: LPO is enabled */
#define  BCMA_CC_SLOWCLKCTL_FSLOW 0x00000800  /* ForceSlowClk, 1: sb/cores
                                               * running on slow clock, 0: power
                                               * logic control */
#define  BCMA_CC_SLOWCLKCTL_IPLL  0x00001000  /* IgnorePllOffReq, 1/0: power
                                               * logic ignores/honors PLL clock
                                               * disable requests from core */
#define  BCMA_CC_SLOWCLKCTL_ENXTAL  0x00002000  /* XtalControlEn, 1/0: power
                                                 * logic does/doesn't disable
                                                 * crystal when appropriate */
#define  BCMA_CC_SLOWCLKCTL_XTALPU  0x00004000  /* XtalPU (RO), 1/0: crystal
                                                 * running/disabled */
#define  BCMA_CC_SLOWCLKCTL_CLKDIV  0xFFFF0000  /* ClockDivider (SlowClk =
                                                 * 1/(4+divisor)) */
...
#define  BCMA_CC_SYSCLKCTL_FORCEALP 0x00000008  /* Force ALP (or HT if ALPen is
                                                 * not set */
...
#define  BCMA_CC_4706_FLASHSCFG_SF1_TYPE  0x00000004  /* 2nd serial flash type :
                                                       * 0 : ST, 1 : Atmel */
...
#define BCMA_CHIPCTL_4331_SECI      BIT(1)  /* 0 SECI is disabled (JATG
                                             * functional) */
#define BCMA_CHIPCTL_4331_EXT_LNA   BIT(2)  /* 0 disable */
#define BCMA_CHIPCTL_4331_SPROM_GPIO13_15 BIT(3)  /* sprom/gpio13-15 mux */
#define BCMA_CHIPCTL_4331_EXTPA_EN    BIT(4)  /* 0 ext pa disable, 1 ext pa
                                               * enabled */
#define BCMA_CHIPCTL_4331_GPIOCLK_ON_SPROMCS  BIT(5)  /* set drive out GPIO_CLK
                                                       * on sprom_cs pin */
#define BCMA_CHIPCTL_4331_PCIE_MDIO_ON_SPROMCS  BIT(6)  /* use sprom_cs pin as
                                                         * PCIE mdio interface
                                                         * */
#define BCMA_CHIPCTL_4331_EXTPA_ON_GPIO2_5  BIT(7)  /* aband extpa will be at
                                                     * gpio2/5 and sprom_dout */
#define BCMA_CHIPCTL_4331_OVR_PIPEAUXCLKEN  BIT(8)  /* override core control on
                                                     * pipe_AuxClkEnable */
#define BCMA_CHIPCTL_4331_OVR_PIPEAUXPWRDOWN  BIT(9)  /* override core control
                                                       * on pipe_AuxPowerDown */
#define BCMA_CHIPCTL_4331_PCIE_AUXCLKEN   BIT(10) /* pcie_auxclkenable */
#define BCMA_CHIPCTL_4331_PCIE_PIPE_PLLDOWN BIT(11) /* pcie_pipe_pllpowerdown */
#define BCMA_CHIPCTL_4331_EXTPA_EN2   BIT(12) /* 0 ext pa disable, 1 ext pa
                                               * enabled */
...
#define BCMA_CCTRL_43224_GPIO_TOGGLE    0x8000    /* gpio[3:0] pins as btcoex or
                                                   * s/w gpio */
#define BCMA_CCTRL_43224A0_12MA_LED_DRIVE 0x00F000F0  /* 12 mA drive strength */
#define BCMA_CCTRL_43224B0_12MA_LED_DRIVE 0xF0    /* 12 mA drive strength for
                                                   * later 43224s */

/* 4313 Chip specific ChipControl register bits */
#define BCMA_CCTRL_4313_12MA_LED_DRIVE    0x00000007  /* 12 mA drive strengh for
                                                       * later 4313 */
