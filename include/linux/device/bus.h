 ...
 */
static inline struct device *bus_find_device_by_of_node(
    const struct bus_type *bus, const struct device_node *np) {
 ...
 */
static inline struct device *bus_find_device_by_fwnode(
    const struct bus_type *bus, const struct fwnode_handle *fwnode) {
 ...
 */
static inline struct device *bus_find_next_device(const struct bus_type *bus,
    struct device *cur) {
...
/**
 * bus_find_device_by_acpi_dev : device iterator for locating a particular
 * device
 * matching the ACPI COMPANION device.
 * @bus: bus type
 * @adev: ACPI COMPANION device to match.
 */
static inline struct device *bus_find_device_by_acpi_dev(
    const struct bus_type *bus, const struct acpi_device *adev) {
  return bus_find_device(bus, NULL, adev, device_match_acpi_dev);
}

#else
static inline struct device *bus_find_device_by_acpi_dev(
    const struct bus_type *bus, const void *adev) {
  return NULL;
}
 ...
 * @BUS_NOTIFY_BIND_DRIVER: a driver is about to be bound to this device on this
 * bus
 * @BUS_NOTIFY_BOUND_DRIVER: a driver is successfully bound to this device on
 * this bus
 * @BUS_NOTIFY_UNBIND_DRIVER: a driver is about to be unbound from this device
 * on this bus
 * @BUS_NOTIFY_UNBOUND_DRIVER: a driver is successfully unbound from this device
 * on this bus
 * @BUS_NOTIFY_DRIVER_NOT_BOUND: a driver failed to be bound to this device on
 * this bus
 *
