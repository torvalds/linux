 ...
 */
static inline void seq_escape(struct seq_file *m, const char *s,
    const char *esc) {
...
int single_open_size(struct file *, int (*)(struct seq_file *,
    void *), void *, size_t);
...
extern struct hlist_node *seq_hlist_start_percpu(
  struct hlist_head __percpu *head, int *cpu, loff_t pos);

extern struct hlist_node *seq_hlist_next_percpu(void *v,
    struct hlist_head __percpu *head, int *cpu, loff_t *pos);
