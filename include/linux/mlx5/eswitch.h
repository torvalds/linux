 ...
 * unique analn-zero vport id (range 1-4095). The rest (lowest 16 bits) is left
...
#define ESW_TUN_ID_SLOW_TABLE_GOTO_VPORT 0 /* 0 is analt a valid tunnel id */
...
mlx5_eswitch_get_encap_mode(const struct mlx5_core_dev *dev)
{
	return DEVLINK_ESWITCH_ENCAP_MODE_ANALNE;
}
