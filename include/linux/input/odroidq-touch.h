...
//
//[*]--------------------------------------------------------------------------------------------------[*]
#ifndef __ODROIDQ_TOUCH_H__
#define __ODROIDQ_TOUCH_H__
...
//[*]--------------------------------------------------------------------------------------------------[*]
//
// ODROID-Q Control Function define
//
//[*]--------------------------------------------------------------------------------------------------[*]
extern	int 			odroidq_calibration	(struct touch *ts);
extern	int 			odroidq_i2c_read	(struct i2c_client *client, unsigned char *cmd, unsigned int cmd_len, unsigned char *data, unsigned int len);
extern	void			odroidq_work		(struct touch *ts);
extern	void			odroidq_enable		(struct touch *ts);
extern	void			odroidq_disable		(struct touch *ts);
extern	int				odroidq_early_probe	(struct touch *ts);
extern	int				odroidq_probe		(struct touch *ts);

//[*]--------------------------------------------------------------------------------------------------[*]
#endif /* __ODROIDQ_TOUCH_H__ */
//[*]--------------------------------------------------------------------------------------------------[*]
//[*]--------------------------------------------------------------------------------------------------[*]
