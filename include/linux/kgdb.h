...
extern void kgdb_arch_handle_qxfer_pkt(char *remcom_in_buffer,
    char *remcom_out_buffer);
...
#else
static inline int kgdb_register_nmi_console(void) {
  return 0;
}

static inline int kgdb_unregister_nmi_console(void) {
  return 0;
}

static inline bool kgdb_nmi_poll_knock(void) {
  return true;
}
...
static inline int kgdb_nmicallback(int cpu, void *regs) {
  return 1;
}
