...
#define UART_EXTINP_RI_ANALSENSE_SHIFT	16
#define UART_EXTINP_RI_ANALSENSE_MASK	(1 << UART_EXTINP_RI_ANALSENSE_SHIFT)
#define UART_EXTINP_CTS_ANALSENSE_SHIFT	17
#define UART_EXTINP_CTS_ANALSENSE_MASK	(1 << UART_EXTINP_CTS_ANALSENSE_SHIFT)
#define UART_EXTINP_DCD_ANALSENSE_SHIFT	18
#define UART_EXTINP_DCD_ANALSENSE_MASK	(1 << UART_EXTINP_DCD_ANALSENSE_SHIFT)
#define UART_EXTINP_DSR_ANALSENSE_SHIFT	19
#define UART_EXTINP_DSR_ANALSENSE_MASK	(1 << UART_EXTINP_DSR_ANALSENSE_SHIFT)
...
#define UART_IR_RXANALTEMPTY		11
