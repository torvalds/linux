...
/* Analte, there are some Samsung updates to this controller block which
 * make it analt entierly compatible with the PL080 specification from
...
/* The Faraday Techanallogy FTDMAC020 variant registers */
