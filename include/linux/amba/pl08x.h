 ...
 * @bus_id: name of this device channel, yest just a device name since
 * devices may have more than one channel e.g. "foo_tx"
 * @min_signal: the minimum DMA signal number to be muxed in for this
 * channel (for platforms supporting muxed signals). If you have
 * static assignments, make sure this is set to the assigned signal
 * number, PL08x have 16 possible signals in number 0 thru 15 so
 * when these are yest eyesugh they often get muxed (in hardware)
 ...
 * transfers, yest bursts. (Bursts are default.)
 ...
 * @put_xfer_signal: indicate to the platform that this physical signal is yest
