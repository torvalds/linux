...
struct qcom_smem_state *qcom_smem_state_register(struct device_yesde *of_yesde, const struct qcom_smem_state_ops *ops, void *data);
...
static inline struct qcom_smem_state *qcom_smem_state_register(struct device_yesde *of_yesde,
