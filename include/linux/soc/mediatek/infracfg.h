...
#define MT8195_TOP_AXI_PROT_EN_MM_2_VPPSYS0_2ND   (GENMASK(1, \
    0) | BIT(4) | BIT(11))
...
#define MT8188_TOP_AXI_PROT_EN_INFRA_VDNR_PEXTP_MAC_P0_STEP2  (BIT(8) \
  | BIT(18) | BIT(30))
...
#define MT8188_TOP_AXI_PROT_EN_2_ADSP_INFRA_STEP1   (GENMASK(16, 14) | BIT(23)   \
  | BIT(27))
#define MT8188_TOP_AXI_PROT_EN_2_ADSP_INFRA_STEP2   (GENMASK(19, \
    17) | GENMASK(26, 25))
...
#define MT8188_TOP_AXI_PROT_EN_MM_VDOSYS0_STEP1     (GENMASK(18, \
    17) | GENMASK(21, 20))
