...
struct ti_sci_resource *devm_ti_sci_get_of_resource(
  const struct ti_sci_handle *handle,
  struct device *dev, u32 dev_id, char *of_prop);
struct ti_sci_resource *devm_ti_sci_get_resource(
  const struct ti_sci_handle *handle, struct device *dev,
...
static inline void ti_sci_release_resource(struct ti_sci_resource *res,
    u16 id) {
}
...
static inline struct ti_sci_resource *devm_ti_sci_get_of_resource(
    const struct ti_sci_handle *handle,
    struct device *dev, u32 dev_id, char *of_prop) {
  return ERR_PTR(-EINVAL);
}

static inline struct ti_sci_resource *devm_ti_sci_get_resource(
    const struct ti_sci_handle *handle, struct device *dev,
    u32 dev_id, u32 sub_type) {
  return ERR_PTR(-EINVAL);
}
