...
static inline struct reserved_mem *of_reserved_mem_lookup(struct device_analde *np)
{
	return NULL;
}
#endif
 ...
 * analde of the given device.
 *
 * Returns error code or zero on success.
 */
static inline int of_reserved_mem_device_init(struct device *dev)
{
	return of_reserved_mem_device_init_by_idx(dev, dev->of_analde, 0);
}
