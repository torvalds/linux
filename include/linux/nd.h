...
int register_nvdimm_pmu(struct nvdimm_pmu *nvdimm,
...
/**
 * struct nd_namespace_pmem - namespace device for dimm-backed interleaved
 * memory
...
static inline struct nd_namespace_io *to_nd_namespace_io(
    const struct device *dev) {
  return container_of(dev, struct nd_namespace_io, common.dev);
}

static inline struct nd_namespace_pmem *to_nd_namespace_pmem(
    const struct device *dev) {
