 ...
 * size of the sliding window recording "index: current_label" associations
 * within
 * each transaction.
 *
...
extern struct lc_element *lc_get_cumulative(struct lru_cache *lc,
    unsigned int enr);
...
extern void lc_seq_dump_details(struct seq_file *seq, struct lru_cache *lc,
    char *utext,
    void (*detail)(struct seq_file *, struct lc_element *));

/**
 * lc_try_lock_for_transaction - can be used to stop lc_get() from changing the
 * tracked set
