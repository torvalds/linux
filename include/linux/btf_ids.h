...
#define BTF_SET_START_GLOBAL(name) static struct btf_id_set __maybe_unused name \
    = { 0 };
#define BTF_SET_END(name)
#define BTF_SET8_START(name) static struct btf_id_set8 __maybe_unused name \
    = { 0 };
#define BTF_SET8_END(name)
#define BTF_KFUNCS_START(name) static struct btf_id_set8 __maybe_unused name \
    = { .flags = BTF_SET8_KFUNCS };
#define BTF_KFUNCS_END(name)
