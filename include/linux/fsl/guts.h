 ...
 * you are expected to kyesw whether a given register actually exists on your
...
#define CCSR_GUTS_PMUXCR_DBGDRV		0x00000200	/* Signals yest driven */
 ...
 * channels 0 and 3.  Any other channels are igyesred.
 *
 * guts: Pointer to GUTS structure
 * co: The DMA controller (0 or 1)
 * ch: The channel on the DMA controller (0, 1, 2, or 3)
