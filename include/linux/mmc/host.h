...
#define MMC_CAP_DONE_COMPLETE (1 << 27) /* RW reqs can be completed within
                                         * mmc_request_done() */
...
#define MMC_CAP2_NO_WRITE_PROTECT (1 << 18) /* No physical write protect pin,
                                             * assume that card is always
                                             * read-write */
#define MMC_CAP2_NO_SDIO  (1 << 19) /* Do not send SDIO commands during
                                     * initialization */
...
#define MMC_CAP2_MERGE_CAPABLE  (1 << 26) /* Host can merge a segment over the
                                           * segment size */
...
#endif
#define MMC_CAP2_ALT_GPT_TEGRA  (1 << 28) /* Host with eMMC that has GPT entry
