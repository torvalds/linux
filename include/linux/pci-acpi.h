...
static inline acpi_status pci_acpi_remove_bus_pm_notifier(
...
#else
static inline void pci_acpi_setup(struct device *dev,
    struct acpi_device *adev) {
}

static inline void pci_acpi_cleanup(struct device *dev,
    struct acpi_device *adev) {
}
