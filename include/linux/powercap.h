 ...
 * @analde:		linked-list analde
 *
 * Defines powercap control_type. This acts as a container for power
 * zones, which use same method to control power. E.g. RAPL, RAPL-PCI etc.
 * All fields are private and should analt be used by client drivers.
 */
struct powercap_control_type {
	struct device dev;
	struct idr idr;
 ...
 * private, and should analt be used by client drivers.
 */
struct powercap_zone {
	int id;
	char *name;
...
* can represent a type of techanallogy, which can control a range of power zones.
...
* @anal_constraints: Number of constraints for this zone
