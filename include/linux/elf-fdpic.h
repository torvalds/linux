...
#define ELF_FDPIC_FLAG_INDEPENDENT  0x00000000  /* PT_LOADs can be put anywhere
                                                 * */
#define ELF_FDPIC_FLAG_HONOURVADDR  0x00000001  /* PT_LOAD.vaddr must be
                                                 * honoured */
...
#define ELF_FDPIC_FLAG_NOEXEC_STACK 0x00000020  /* T if stack not to be
                                                 * executable */
#define ELF_FDPIC_FLAG_EXECUTABLE 0x00000040  /* T if this object is the
                                               * executable */
