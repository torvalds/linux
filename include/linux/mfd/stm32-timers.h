...
#define TIM_SMCR_SMS_SLAVE_MODE_DISABLED  0 /* counts on internal clock when
                                             * CEN=1 */
#define TIM_SMCR_SMS_ENCODER_MODE_1   1 /* counts TI1FP1 edges, depending on
                                         * TI2FP2 level */
#define TIM_SMCR_SMS_ENCODER_MODE_2   2 /* counts TI2FP2 edges, depending on
                                         * TI1FP1 level */
#define TIM_SMCR_SMS_ENCODER_MODE_3   3 /* counts on both TI1FP1 and TI2FP2
                                         * edges */
