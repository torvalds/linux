/*
 * max77xxx.h - Voltage regulator driver for the Maxim 77686
 *
...
#ifndef __LINUX_MFD_MAX77XXX_PRIV_H
#define __LINUX_MFD_MAX77XXX_PRIV_H

#include <linux/i2c.h>
#include <linux/regmap.h>
#include <linux/module.h>

#define MAX77XXX_REG_INVALID		(0xff)

enum max77xxx_pmic_reg {
	MAX77XXX_REG_DEVICE_ID		= 0x00,
	MAX77XXX_REG_INTSRC		= 0x01,
	MAX77XXX_REG_INT1		= 0x02,
	MAX77XXX_REG_INT2		= 0x03,

	MAX77XXX_REG_INT1MSK		= 0x04,
	MAX77XXX_REG_INT2MSK		= 0x05,

	MAX77XXX_REG_STATUS1		= 0x06,
	MAX77XXX_REG_STATUS2		= 0x07,

	MAX77XXX_REG_PWRON		= 0x08,
};
...
enum max77xxx_rtc_reg {
	...
	MAX77XXX_ALARM2_YEAR,
	MAX77XXX_ALARM2_DATE,
	MAX77XXX_RTC_AE1,
	MAX77XXX_RTC_AE2,
...
#define MAX77XXX_IRQSRC_RTC		(1 << 0)

enum max77xxx_irq_source {
	PMIC_INT1 = 0,
	PMIC_INT2,
	RTC_INT,

	MAX77XXX_IRQ_GROUP_NR,
};

enum max77xxx_irq {
	MAX77XXX_PMICIRQ_PWRONF,
	MAX77XXX_PMICIRQ_PWRONR,
	MAX77XXX_PMICIRQ_JIGONBF,
	MAX77XXX_PMICIRQ_JIGONBR,
	MAX77XXX_PMICIRQ_ACOKBF,
	MAX77XXX_PMICIRQ_ACOKBR,
	MAX77XXX_PMICIRQ_ONKEY1S,
	MAX77XXX_PMICIRQ_MRSTB,

	MAX77XXX_PMICIRQ_140C,
	MAX77XXX_PMICIRQ_120C,

	MAX77XXX_RTCIRQ_RTC60S,
	MAX77XXX_RTCIRQ_RTCA1,
	MAX77XXX_RTCIRQ_RTCA2,
	MAX77XXX_RTCIRQ_SMPL,
	MAX77XXX_RTCIRQ_RTC1S,
	MAX77XXX_RTCIRQ_WTSR,
...
extern int max77xxx_irq_init(struct max77xxx_dev *max77xxx);
extern void max77xxx_irq_exit(struct max77xxx_dev *max77xxx);
extern int max77xxx_irq_resume(struct max77xxx_dev *max77xxx);

#endif /*  __LINUX_MFD_MAX77XXX_PRIV_H */
