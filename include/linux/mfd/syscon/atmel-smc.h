 ...
 * @setup: NCS/NWE/NRD setup timings (yest applicable to at91rm9200)
 * @pulse: NCS/NWE/NRD pulse timings (yest applicable to at91rm9200)
 * @cycle: NWE/NRD cycle timings (yest applicable to at91rm9200)
