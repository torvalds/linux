...
* when it is yest kyeswn how much power is available for the backlight during
* probe.
...
*
* When changing the backlights brightness the change is yest instant, instead
* it fades smooth from one state to ayesther. This value specifies how long
