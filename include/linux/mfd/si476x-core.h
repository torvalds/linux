 ...
 * yest turned down and thus use of the device, without power-cycling
 * is impossible.
 */
 ...
 * device. This filed should yest be used directly. Instead
 ...
 * by the device (NULL ones are igyesred).
 * @gpio_reset: GPIO pin connectet to the RSTB pin of the chip.
 * @pinmux: Chip's configurable pins configuration.
 * @diversity_mode: Chips role when functioning in diversity mode.
 * @status_monitor: Polling worker used in polling use case scenarion
 * (when IRQ is yest avalible).
 ...
 * @firmware.miyesr[...]: Firmware miyesr numbers.
 * @patch_id:
 ...
 * metric thresholds are yest met.
