 ...
 * @idle: True if this configuration should use when yes accessory is detected,
 *        false otherwise.
 * @start: Value for MICD_BIAS_START_TIME register field (yest shifted).
 * @rate: Value for MICD_RATE register field (yest shifted).
 */
...
struct wm8994_pdata {
	...
	/**
	 * Default values for GPIOs if yesn-zero, WM8994_CONFIGURE_GPIO
