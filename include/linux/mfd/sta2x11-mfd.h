...
extern u32 __sta2x11_mfd_mask(struct pci_dev *, u32, u32, u32,
    enum sta2x11_mfd_plat_dev);
 ...
 */
static inline u32 sta2x11_apbreg_mask(struct pci_dev *pdev, u32 reg, u32 mask,
    u32 val) {
 ...
 */
static inline
u32 sta2x11_apb_soc_regs_mask(struct pci_dev *pdev, u32 reg, u32 mask,
    u32 val) {
