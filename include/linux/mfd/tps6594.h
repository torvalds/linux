...
#define TPS6594_REG_GPIOX_OUT(gpio_inst)    (TPS6594_REG_GPIO_OUT_1 \
  + (gpio_inst) / 8)
#define TPS6594_REG_GPIOX_IN(gpio_inst)     (TPS6594_REG_GPIO_IN_1 \
  + (gpio_inst) / 8)
...
#define TPS6594_BIT_GPIOX_FSM_MASK_POL(gpio_inst) BIT(((gpio_inst) << \
      1) % 8 + 1)
...
#define TPS6594_BIT_BUCKX_ILIM_MASK(buck_inst)    BIT(((buck_inst) << \
      2) % 8 + 3)
...
#define TPS6594_BIT_BUCKX_ILIM_STAT(buck_inst)    BIT(((buck_inst) << \
      2) % 8 + 3)
