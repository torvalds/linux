...
void __read_overflow2(void) __compiletime_error(
    "detected read beyond size of object (2nd parameter)");
void __read_overflow2_field(size_t avail, size_t wanted) __compiletime_warning(
...
void __write_overflow_field(size_t avail, size_t wanted) __compiletime_warning(
...
extern void *__underlying_memchr(const void *p, int c,
    __kernel_size_t size) __RENAME(memchr);
...
extern void *__underlying_memcpy(void *p, const void *q,
    __kernel_size_t size) __RENAME(memcpy);
extern void *__underlying_memmove(void *p, const void *q,
    __kernel_size_t size) __RENAME(memmove);
extern void *__underlying_memset(void *p, int c, __kernel_size_t size) __RENAME(
    memset);
extern char *__underlying_strcat(char *p, const char *q) __RENAME(strcat);
extern char *__underlying_strcpy(char *p, const char *q) __RENAME(strcpy);
extern __kernel_size_t __underlying_strlen(const char *p) __RENAME(strlen);
extern char *__underlying_strncat(char *p, const char *q,
    __kernel_size_t count) __RENAME(strncat);
extern char *__underlying_strncpy(char *p, const char *q,
    __kernel_size_t size) __RENAME(strncpy);
#else
...
extern __kernel_size_t __real_strnlen(const char *, __kernel_size_t) __RENAME(
    strnlen);
/**
 ...
 *
 */
__FORTIFY_INLINE __kernel_size_t strnlen(const char * const POS p,
...
extern ssize_t __real_strscpy(char *, const char *, size_t) __RENAME(
    sized_strscpy);
__FORTIFY_INLINE ssize_t sized_strscpy(char * const POS p,
    const char * const POS q, size_t size) {
...
extern size_t __real_strlcat(char *p, const char *q, size_t avail) __RENAME(
    strlcat);
/**
...
size_t strlcat(char * const POS p, const char * const POS q, size_t avail) {
  ...
  if (p_size <= p_len) {
    fortify_panic(FORTIFY_FUNC_strlcat, FORTIFY_READ, p_size, p_len + 1,
        wanted);
  }
  if (actual >= avail) {
  ...
  if (p_size <= actual) {
    fortify_panic(FORTIFY_FUNC_strlcat, FORTIFY_WRITE, p_size, actual + 1,
        wanted);
  }
...
__FORTIFY_INLINE void *memscan(void * const POS0 p, int c,
...
__FORTIFY_INLINE void *memchr_inv(const void * const POS0 p, int c,
    size_t size) {
  const size_t p_size = __struct_size(p);
  if (__compiletime_lessthan(p_size, size)) {
    __read_overflow();
...
extern void *__real_kmemdup(const void *src, size_t len, gfp_t gfp) __RENAME(
    kmemdup)
__realloc_size(2);
__FORTIFY_INLINE void *kmemdup(const void * const POS0 p, size_t size,
    gfp_t gfp) {
  const size_t p_size = __struct_size(p);
  if (__compiletime_lessthan(p_size, size)) {
    __read_overflow();
