...
static inline int vlan_get_rx_ctag_filter_info(struct net_device *dev) {
  ...
  return notifier_to_errno(call_netdevice_notifiers(
      NETDEV_CVLAN_FILTER_PUSH_INFO, dev));
}
...
#else
static inline struct net_device *__vlan_find_dev_deep_rcu(
    struct net_device *real_dev,
    __be16 vlan_proto, u16 vlan_id) {
  return NULL;
}

static inline int vlan_for_each(struct net_device *dev,
 ...
 */
static inline void __vlan_hwaccel_copy_tag(struct sk_buff *dst,
