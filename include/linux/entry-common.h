...
/**
 * arch_enter_from_user_mode - Architecture specific sanity check for user mode
 * regs
 ...
 */
static __always_inline long syscall_enter_from_user_mode_work(
...
#define irqentry_exit_cond_resched_dynamic_enabled  \
