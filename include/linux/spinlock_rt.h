...
extern void rt_spin_lock_nest_lock(spinlock_t *lock,
 ...
 */
#define __spin_lock_nested(lock, \
      subclass) spin_lock(((void) (subclass), (lock)))
#define __spin_lock_nest_lock(lock, \
      subclass)  spin_lock(((void) (subclass), (lock)))
#define __spin_lock_irqsave_nested(lock, flags, subclass)  \
