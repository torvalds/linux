...
struct phy_configure_opts_mipi_dphy {
	 ...
	 * should igyesre any Clock Lane HS transitions, starting from
	 ...
	 *
	 * Time interval, in picoseconds, during which the HS receiver
	 * shall igyesre any Data Lane HS transitions, starting from
	 ...
	 * should igyesre any transitions on the Data Lane, following a
