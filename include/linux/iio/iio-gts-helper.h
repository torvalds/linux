...
static inline const struct iio_itime_sel_mul *iio_gts_find_itime_by_time(
...
static inline const struct iio_itime_sel_mul *iio_gts_find_itime_by_sel(
    struct iio_gts *gts, int sel) {
  int i;
  for (i = 0; i < gts->num_itime; i++) {
