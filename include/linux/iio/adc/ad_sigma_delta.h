...
/**
 * struct ad_sigma_delta_info - Sigma Delta driver specific callbacks and
 * options
 * @set_channel: Will be called to select the current channel, may be NULL.
 * @append_status: Will be called to enable status append at the end of the
 * sample, may be NULL.
...
static inline int ad_sigma_delta_append_status(struct ad_sigma_delta *sd,
    bool append) {
  int ret;
...
int devm_ad_sd_setup_buffer_and_trigger(struct device *dev,
