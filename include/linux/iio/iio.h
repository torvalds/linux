 ...
 * @INDIO_BUFFER_HARDWARE: For specific hardware, if unsure do not use this
 * mode.
 ...
 * @fwnode_xlate: fwnode based function pointer to obtain channel specifier
 * index.
 ...
 */
DEFINE_GUARD(iio_claim_direct, struct iio_dev *, iio_device_claim_direct_mode(
    _T),
 ...
 */
static inline void iio_device_set_drvdata(struct iio_dev *indio_dev,
    void *data) {
