...
static inline
struct assoc_array_node *assoc_array_ptr_to_node(
    const struct assoc_array_ptr *x) {
  return (struct assoc_array_node *) __assoc_array_ptr_to_meta(x);
}

static inline
struct assoc_array_shortcut *assoc_array_ptr_to_shortcut(
    const struct assoc_array_ptr *x) {
...
static inline
struct assoc_array_ptr *assoc_array_node_to_ptr(
...
static inline
struct assoc_array_ptr *assoc_array_shortcut_to_ptr(
