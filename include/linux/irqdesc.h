...
/**
 * irq_set_chip_handler_name_locked - Set chip, handler and name from a locked
 * region
 ...
 */
static inline void irq_set_chip_handler_name_locked(struct irq_data *data,
...
static inline void irq_set_lockdep_class(unsigned int irq,
    struct lock_class_key *lock_class,
    struct lock_class_key *request_class) {
