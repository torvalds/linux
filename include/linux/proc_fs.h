...
struct proc_dir_entry *proc_create_net_data_write(const char *name,
    ...
    proc_write_t write,
    unsigned int state_size, void *data);
struct proc_dir_entry *proc_create_net_single_write(const char *name,
    umode_t mode,
    struct proc_dir_entry *parent,
...
void arch_proc_pid_thread_features(struct seq_file *m,
...
static inline void *proc_get_parent_data(const struct inode *inode) {
  BUG();
  return NULL;
}
...
#define proc_create_net_data(name, mode, parent, ops, state_size, \
      data) ({NULL;})
#define proc_create_net_data_write(name, mode, parent, ops, write, state_size, \
      data) ({NULL;})
#define proc_create_net(name, mode, parent, state_size, ops) ({NULL;})
#define proc_create_net_single(name, mode, parent, show, data) ({NULL;})
#define proc_create_net_single_write(name, mode, parent, show, write, \
      data) ({NULL;})
