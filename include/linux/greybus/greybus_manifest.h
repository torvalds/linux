...
/*
 * The string in a string descriptor is yest NUL-terminated.  The
 ...
 * that use the bundle.
 *
 * @class: It is used by kernel to kyesw the functionality provided by the
