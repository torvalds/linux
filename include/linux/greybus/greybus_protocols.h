...
#define GB_BOOTROM_BOOT_STAGE_TWO   0x02 /* Bootrom package to be loaded by the
                                          * boot ROM */
#define GB_BOOTROM_BOOT_STAGE_THREE   0x03 /* Module personality package loaded
                                            * by Stage 2 firmware */

/* Greybus bootrom ready to boot status */
#define GB_BOOTROM_BOOT_STATUS_INVALID    0x00 /* Firmware blob could not be
                                                * validated */
#define GB_BOOTROM_BOOT_STATUS_INSECURE   0x01 /* Firmware blob is valid but
                                                * insecure */
#define GB_BOOTROM_BOOT_STATUS_SECURE   0x02 /* Firmware blob is valid and
                                              * secure */
