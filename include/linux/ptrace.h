 ...
 */
#define is_syscall_success(regs) (!IS_ERR_VALUE((unsigned long) ( \
...
extern int task_current_syscall(struct task_struct *target,
    struct syscall_info *info);

extern void sigaction_compat_abi(struct k_sigaction *act,
