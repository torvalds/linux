...
struct vc_data {
  ...
  /* fonts */
  unsigned short vc_hi_font_mask;  /* [#] Attribute set for upper 256 chars of
                                    * font or 0 if not supported */
  ...
  struct vc_data **vc_display_fg;   /* [!] Ptr to var holding fg console for
                                     * this display */
