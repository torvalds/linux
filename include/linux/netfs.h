...
struct netfs_io_request {
  ...
  refcount_t ref;
  unsigned long flags;
#define NETFS_RREQ_INCOMPLETE_IO  0 /* Some ioreqs terminated short or with
                                     * error */
#define NETFS_RREQ_COPY_TO_CACHE  1 /* Need to write to the cache */
#define NETFS_RREQ_NO_UNLOCK_FOLIO  2 /* Don't unlock no_unlock_folio on
                                       * completion */
...
ssize_t netfs_buffered_write_iter_locked(struct kiocb *iocb,
