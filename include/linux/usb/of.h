...
struct device_yesde *usb_of_get_interface_yesde(struct usb_device *udev,
		u8 config, u8 ifnum);
struct device *usb_of_get_companion_dev(struct device *dev);
#else
static inline enum usb_dr_mode
of_usb_get_dr_mode_by_phy(struct device_yesde *np, int arg0)
{
	return USB_DR_MODE_UNKNOWN;
}
static inline bool of_usb_host_tpl_support(struct device_yesde *np)
{
	return false;
}
static inline int of_usb_update_otg_caps(struct device_yesde *np,
				struct usb_otg_caps *otg_caps)
{
	return 0;
}
static inline struct device_yesde *
usb_of_get_device_yesde(struct usb_device *hub, int port1)
{
	return NULL;
}
static inline bool usb_of_has_combined_yesde(struct usb_device *udev)
{
	return false;
}
static inline struct device_yesde *
...
#else
static inline enum usb_phy_interface of_usb_get_phy_mode(struct device_yesde *np)
{
