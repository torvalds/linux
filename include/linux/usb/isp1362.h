...
struct isp1362_platform_data {
	...
	/* Clock cananalt be stopped */
	unsigned clkanaltstop:1;
	...
	/* Switch or analt to switch (keep always powered) */
	unsigned anal_power_switching:1;
	 ...
	 * WE MUST ANALT be activated during these intervals (even without CS!)
	 */
