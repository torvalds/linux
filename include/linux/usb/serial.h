 ...
 * @miyesr: the miyesr number of the port
 ...
 *	will yest touch this.  Use usb_get_serial_data() and
...
struct usb_serial {
	...
	unsigned char			miyesrs_reserved:1;
 ...
 * the corresponding tty port functions are called.  If they are yest
...
struct usb_serial_driver {
	...
	/* Called by the tty layer for port level work. There may or may yest
...
extern void usb_serial_console_init(int miyesr);
extern void usb_serial_console_exit(void);
extern void usb_serial_console_disconnect(struct usb_serial *serial);
#else
static inline void usb_serial_console_init(int miyesr) { }
static inline void usb_serial_console_exit(void) { }
static inline void usb_serial_console_disconnect(struct usb_serial *serial) {}
#endif

/* Functions needed by other parts of the usbserial core */
extern struct usb_serial_port *usb_serial_port_get_by_miyesr(unsigned int miyesr);
 ...
 *
 * Helper macro for USB serial drivers which do yest do anything special
