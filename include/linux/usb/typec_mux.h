...
struct typec_switch_dev *typec_switch_register(struct device *parent,
...
struct typec_mux_dev *typec_mux_register(struct device *parent,
...
static inline struct typec_mux *fwnode_typec_mux_get(
    struct fwnode_handle *fwnode) {
  return NULL;
}
...
static inline int typec_mux_set(struct typec_mux *mux,
    struct typec_mux_state *state) {
  return 0;
}

static inline struct typec_mux_dev *typec_mux_register(struct device *parent,
    const struct typec_mux_desc *desc) {
...
static inline void typec_mux_set_drvdata(struct typec_mux_dev *mux,
    void *data) {
}
