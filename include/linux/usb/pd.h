...
#define PDO_FIXED_UNCHUNK_EXT   BIT(24) /* Unchunked Extended Message supported
                                         * (Source) */
...
/**
 * usb_power_delivery_capabilities_desc - Description of USB Power Delivery
...
struct usb_power_delivery_capabilities *usb_power_delivery_register_capabilities(
  struct usb_power_delivery *pd,
  struct usb_power_delivery_capabilities_desc *desc);
void usb_power_delivery_unregister_capabilities(
...
int usb_power_delivery_link_device(struct usb_power_delivery *pd,
    struct device *dev);
void usb_power_delivery_unlink_device(struct usb_power_delivery *pd,
    struct device *dev);
