...
int typec_retimer_set(struct typec_retimer *retimer,
    struct typec_retimer_state *state);
...
struct typec_retimer *typec_retimer_register(struct device *parent,
    const struct typec_retimer_desc *desc);
