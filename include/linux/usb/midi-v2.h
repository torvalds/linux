...
#define USB_MS_MIDI_PROTO_1_0_64_JRTS 0x02 /* MIDI 1.0, UMP up to 64bits, Jitter
                                            * Reduction Timestamps */
#define USB_MS_MIDI_PROTO_1_0_128 0x03 /* MIDI 1.0, UMP up to 128bits */
#define USB_MS_MIDI_PROTO_1_0_128_JRTS  0x04 /* MIDI 1.0, UMP up to 128bits,
                                              * Jitter Reduction Timestamps */
#define USB_MS_MIDI_PROTO_2_0   0x11 /* MIDI 2.0 */
#define USB_MS_MIDI_PROTO_2_0_JRTS  0x12 /* MIDI 2.0, Jitter Reduction
                                          * Timestamps */
