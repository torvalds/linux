...
/**
 * llist_for_each_entry - iterate over some deleted entries of lock-less list of
 * given type
...
/**
 * llist_for_each_entry_safe - iterate over some deleted entries of lock-less
 * list of given type
 *             safe against removal of list entry
 * @pos:  the type * to use as a loop cursor.
...
static inline bool __llist_add(struct llist_node *new,
    struct llist_head *head) {
...
/**
 * llist_del_first_init - delete first entry from lock-list and mark is as being
 * off-list
 * @head: the head of lock-less list to delete from.
 *
 * This behave the same as llist_del_first() except that llist_init_node() is
 * called
