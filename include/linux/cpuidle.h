...
static inline int cpuidle_play_dead(void) {
  return -ENODEV;
}
...
#else
static inline void cpuidle_coupled_parallel_barrier(struct cpuidle_device *dev,
    atomic_t *a) {
}
...
#define CPU_PM_CPU_IDLE_ENTER_RETENTION_PARAM_RCU(low_level_idle_enter, idx, \
      state) \
