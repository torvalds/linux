...
static inline void xdr_buf_init(struct xdr_buf *buf, void *start, size_t len) {
...
static inline __be32 *xdr_encode_array(__be32 *p, const void *s,
    unsigned int len) {
...
static inline __be32 *xdr_decode_opaque_fixed(__be32 *p, void *ptr,
    unsigned int len) {
  memcpy(ptr, p, len);
 ...
 */
static inline int xdr_adjust_iovec(struct kvec *iov, __be32 *p) {
...
extern int read_bytes_from_xdr_buf(const struct xdr_buf *, unsigned int, void *,
    unsigned int);
extern int write_bytes_to_xdr_buf(const struct xdr_buf *, unsigned int, void *,
    unsigned int);
...
extern int xdr_process_buf(const struct xdr_buf *buf, unsigned int offset,
    unsigned int len, int (*actor)(struct scatterlist *,
    void *), void *data);
extern void xdr_set_pagelen(struct xdr_stream *, unsigned int len);
extern bool xdr_stream_subsegment(struct xdr_stream *xdr,
    struct xdr_buf *subbuf,
    unsigned int len);
extern unsigned int xdr_stream_move_subsegment(struct xdr_stream *xdr,
    unsigned int offset,
 ...
 */
static inline size_t xdr_stream_remaining(const struct xdr_stream *xdr) {
  return xdr->nwords << 2;
}
 ...
 */
static inline size_t xdr_align_size(size_t n) {
 ...
 *   %-EMSGSIZE on XDR buffer overflow
 */
static inline ssize_t xdr_stream_encode_u32(struct xdr_stream *xdr, __u32 n) {
 ...
 *   %-EMSGSIZE on XDR buffer overflow
 */
static inline ssize_t xdr_stream_encode_be32(struct xdr_stream *xdr, __be32 n) {
  const size_t len = sizeof(n);
  __be32 *p = xdr_reserve_space(xdr, len);
  if (unlikely(!p)) {
    return -EMSGSIZE;
 ...
 *   %-EMSGSIZE on XDR buffer overflow
 */
static inline ssize_t xdr_stream_encode_u64(struct xdr_stream *xdr, __u64 n) {
  const size_t len = sizeof(n);
  __be32 *p = xdr_reserve_space(xdr, len);
  if (unlikely(!p)) {
    return -EMSGSIZE;
 ...
 *   %-EMSGSIZE on XDR buffer overflow
 */
static inline ssize_t xdr_stream_encode_opaque_inline(struct xdr_stream *xdr,
    void **ptr, size_t len) {
 ...
 *   %-EMSGSIZE on XDR buffer overflow
 */
static inline ssize_t xdr_stream_encode_opaque_fixed(struct xdr_stream *xdr,
    const void *ptr,
    size_t len) {
  __be32 *p = xdr_reserve_space(xdr, len);
  if (unlikely(!p)) {
 ...
 *   %-EMSGSIZE on XDR buffer overflow
 */
static inline ssize_t xdr_stream_encode_opaque(struct xdr_stream *xdr,
 ...
 *   %-EMSGSIZE on XDR buffer overflow
 */
static inline ssize_t xdr_stream_encode_uint32_array(struct xdr_stream *xdr,
 ...
 */
static inline ssize_t xdr_stream_decode_bool(struct xdr_stream *xdr,
    __u32 *ptr) {
 ...
 *   %-EBADMSG on XDR buffer overflow
 */
static inline ssize_t xdr_stream_decode_u32(struct xdr_stream *xdr,
    __u32 *ptr) {
  const size_t count = sizeof(*ptr);
  __be32 *p = xdr_inline_decode(xdr, count);
  if (unlikely(!p)) {
 ...
 *   %-EBADMSG on XDR buffer overflow
 */
static inline ssize_t xdr_stream_decode_u64(struct xdr_stream *xdr,
    __u64 *ptr) {
  const size_t count = sizeof(*ptr);
  __be32 *p = xdr_inline_decode(xdr, count);
  if (unlikely(!p)) {
 ...
 *   %-EBADMSG on XDR buffer overflow
 */
static inline ssize_t xdr_stream_decode_opaque_fixed(struct xdr_stream *xdr,
    void *ptr, size_t len) {
 ...
 */
static inline ssize_t xdr_stream_decode_opaque_inline(struct xdr_stream *xdr,
    void **ptr,
    size_t maxlen) {
  __be32 *p;
  __u32 len;
 ...
 */
static inline ssize_t xdr_stream_decode_uint32_array(struct xdr_stream *xdr,
