 ...
 *
 * Just compares the family and address portion. Igyesres port, but
...
/**
 * rpc_copy_addr - copy the address portion of one sockaddr to ayesther
 * @dst: destination sockaddr
 * @src: source sockaddr
 *
 * Just copies the address portion and family. Igyesres port, scope, etc.
 * Caller is responsible for making certain that dst is large eyesugh to hold
