...
static inline bool pm_suspend_default_s2idle(void) {
  return false;
}
...
static inline bool sync_on_suspend_enabled(void) {
  return true;
}
...
static inline void hibernation_set_ops(
...
static inline bool hibernation_available(void) {
  return false;
}
...
#else
static inline int is_hibernate_resume_dev(dev_t dev) {
  return 0;
}
...
static inline unsigned int lock_system_sleep(void) {
  return 0;
}
