...
#ifdef CONFIG_PM
#define _EXPORT_DEV_PM_OPS(name, license, ns)   _EXPORT_PM_OPS(name, license, \
    ns)
#define EXPORT_PM_FN_GPL(name)        EXPORT_SYMBOL_GPL(name)
#define EXPORT_PM_FN_NS_GPL(name, ns)     EXPORT_SYMBOL_NS_GPL(name, ns)
#else
#define _EXPORT_DEV_PM_OPS(name, license, ns)   _DISCARD_PM_OPS(name, license, \
    ns)
...
#ifdef CONFIG_PM_SLEEP
#define _EXPORT_DEV_SLEEP_PM_OPS(name, license, ns) _EXPORT_PM_OPS(name, \
    license, ns)
#else
#define _EXPORT_DEV_SLEEP_PM_OPS(name, license, ns) _DISCARD_PM_OPS(name, \
    license, ns)
#endif
...
#define EXPORT_NS_GPL_DEV_PM_OPS(name, ns)    _EXPORT_DEV_PM_OPS(name, "GPL", \
    #ns)

#define EXPORT_DEV_SLEEP_PM_OPS(name)     _EXPORT_DEV_SLEEP_PM_OPS(name, "", "")
#define EXPORT_GPL_DEV_SLEEP_PM_OPS(name)   _EXPORT_DEV_SLEEP_PM_OPS(name, \
    "GPL", "")
#define EXPORT_NS_DEV_SLEEP_PM_OPS(name, ns)    _EXPORT_DEV_SLEEP_PM_OPS(name, \
    "", \
    #ns)
#define EXPORT_NS_GPL_DEV_SLEEP_PM_OPS(name, ns)  _EXPORT_DEV_SLEEP_PM_OPS(name, \
    "GPL", \
    #ns)
...
extern void __suspend_report_result(const char *function, struct device *dev,
    void *fn, int ret);
