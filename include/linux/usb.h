...
int __must_check usb_find_common_endpoints(struct usb_host_interface *alt,
    struct usb_endpoint_descriptor **bulk_in,
    struct usb_endpoint_descriptor **bulk_out,
    struct usb_endpoint_descriptor **int_in,
    struct usb_endpoint_descriptor **int_out);

int __must_check usb_find_common_endpoints_reverse(
...
static inline int __must_check usb_find_bulk_in_endpoint(
    struct usb_host_interface *alt,
    struct usb_endpoint_descriptor **bulk_in) {
  return usb_find_common_endpoints(alt, bulk_in, NULL, NULL, NULL);
}

static inline int __must_check usb_find_bulk_out_endpoint(
    struct usb_host_interface *alt,
    struct usb_endpoint_descriptor **bulk_out) {
...
static inline int __must_check usb_find_int_out_endpoint(
    struct usb_host_interface *alt,
    struct usb_endpoint_descriptor **int_out) {
  return usb_find_common_endpoints(alt, NULL, NULL, NULL, int_out);
}

static inline int __must_check usb_find_last_bulk_in_endpoint(
    struct usb_host_interface *alt,
    struct usb_endpoint_descriptor **bulk_in) {
  return usb_find_common_endpoints_reverse(alt, bulk_in, NULL, NULL, NULL);
}

static inline int __must_check usb_find_last_bulk_out_endpoint(
    struct usb_host_interface *alt,
    struct usb_endpoint_descriptor **bulk_out) {
...
static inline int __must_check usb_find_last_int_out_endpoint(
    struct usb_host_interface *alt,
    struct usb_endpoint_descriptor **int_out) {
...
#define to_usb_interface(__dev) container_of_const(__dev, struct usb_interface, \
    dev)
...
static inline const struct usb_device *__intf_to_usbdev_const(
...
#define usb_lock_device_interruptible(udev) device_lock_interruptible( \
    &(udev)->dev)
...
static inline bool usb_acpi_power_manageable(struct usb_device *hdev,
    int index) {
  return true;
}
...
/**
 * USB_DEVICE_INTERFACE_CLASS - describe a usb device with a specific interface
 * class
 * @vend: the 16 bit USB Vendor ID
 * @prod: the 16 bit USB Product ID
...
/**
 * USB_DEVICE_INTERFACE_NUMBER - describe a usb device with a specific interface
 * number
 * @vend: the 16 bit USB Vendor ID
 * @prod: the 16 bit USB Product ID
...
/**
 * struct usb_class_driver - identifies a USB driver that wants to use the USB
 * major number
...
static inline struct usb_host_endpoint *usb_pipe_endpoint(
