...
#define SWP_DEVICE_READ (MAX_SWAPFILES + SWP_HWPOISON_NUM + SWP_MIGRATION_NUM \
  + 1)
#define SWP_DEVICE_EXCLUSIVE_WRITE (MAX_SWAPFILES + SWP_HWPOISON_NUM \
  + SWP_MIGRATION_NUM + 2)
#define SWP_DEVICE_EXCLUSIVE_READ (MAX_SWAPFILES + SWP_HWPOISON_NUM \
  + SWP_MIGRATION_NUM + 3)
#else
...
static inline int swap_swapcount(struct swap_info_struct *si,
    swp_entry_t entry) {
  return 0;
}
...
extern void __mem_cgroup_uncharge_swap(swp_entry_t entry,
