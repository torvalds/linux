...
struct journal_head {
	 ...
	 * NOTE: We *canyest* combine this with b_modified into a bitfield
	...
	/*
	 * Pointer to a saved copy of the buffer containing yes uncommitted
	 ...
	 * Either of these locks is eyesugh for reading, both are needed for
	 * changes.
	 */
