...
#else
static inline void dpll_netdev_pin_set(struct net_device *dev,
...
static inline int dpll_netdev_add_pin_handle(struct sk_buff *msg,
    const struct net_device *dev) {
  return 0;
}
...
struct dpll_device *dpll_device_get(u64 clock_id, u32 dev_driver_id,
...
struct dpll_pin *dpll_pin_get(u64 clock_id, u32 dev_driver_id,
    struct module *module,
