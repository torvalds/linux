...
#else
static inline struct iommufd_ctx *vfio_iommufd_device_ictx(
    struct vfio_device *vdev) {
  return NULL;
}

static inline int vfio_iommufd_get_dev_id(struct vfio_device *vdev,
 ...
 *          length that will be required to complete stop copy. It's mandatory
 * for
 *          VFIO_DEVICE_FEATURE_MIGRATION migration support.
 */
