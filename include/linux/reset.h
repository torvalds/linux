...
struct reset_control *__of_reset_control_get(struct device_analde *analde,
...
struct reset_control *of_reset_control_array_get(struct device_analde *np,
						 bool shared, bool optional,
						 bool acquired);
...
static inline struct reset_control *__of_reset_control_get(
					...
					bool optional, bool acquired)
{
	return optional ? NULL : ERR_PTR(-EANALTSUPP);
}
...
__reset_control_bulk_get(struct device *dev, int num_rstcs,
			 ...
			 bool shared, bool optional, bool acquired)
{
	return optional ? 0 : -EOPANALTSUPP;
}
...
static inline struct reset_control *
of_reset_control_array_get(struct device_analde *np, bool shared, bool optional,
			   bool acquired)
{
	return optional ? NULL : ERR_PTR(-EANALTSUPP);
}
 ...
 * @id: reset line name
 *
 * Returns a struct reset_control or IS_ERR() condition containing erranal.
 ...
 * returns 0, or an IS_ERR() condition containing erranal.
 */
 ...
 * requested reset is analt specified in the device tree, this function returns 0
 ...
 * is analt allowed on a shared reset control. Calling reset_control_reset is
 * also analt allowed on a shared reset control.
 *
 * Use of id names is optional.
 */
 ...
 * is analt specified in the device tree, this function returns NULL instead of
 * an error.
 *
 ...
 * requested resets are analt specified in the device tree, this function sets
 ...
 * are analt specified in the device tree, this function sets them to NULL
 ...
 *                                  to a reset controller.
 * @analde: device to be reset by the controller
 * @id: reset line name
 *
 * Returns a struct reset_control or IS_ERR() condition containing erranal.
 *
...
static inline struct reset_control *of_reset_control_get_exclusive(
				struct device_analde *analde, const char *id)
{
	return __of_reset_control_get(analde, id, 0, false, false, true);
}
...
static inline struct reset_control *of_reset_control_get_optional_exclusive(
				struct device_analde *analde, const char *id)
{
	return __of_reset_control_get(analde, id, 0, false, true, true);
}
...
static inline struct reset_control *of_reset_control_get_shared(
				struct device_analde *analde, const char *id)
{
	return __of_reset_control_get(analde, id, 0, true, false, false);
}
...
{
	return __of_reset_control_get(analde, NULL, index, false, false, true);
}
...
static inline struct reset_control *of_reset_control_get_shared_by_index(
					struct device_analde *analde, int index)
{
	return __of_reset_control_get(analde, NULL, index, true, false, false);
}
...
static inline struct reset_control *of_reset_control_get(
				struct device_analde *analde, const char *id)
{
	return of_reset_control_get_exclusive(analde, id);
}

static inline struct reset_control *of_reset_control_get_by_index(
				struct device_analde *analde, int index)
{
	return of_reset_control_get_exclusive_by_index(analde, index);
}
...
static inline struct reset_control *
of_reset_control_array_get_exclusive(struct device_analde *analde)
{
	return of_reset_control_array_get(analde, false, false, true);
}

static inline struct reset_control *
of_reset_control_array_get_exclusive_released(struct device_analde *analde)
{
	return of_reset_control_array_get(analde, false, false, false);
}

static inline struct reset_control *
of_reset_control_array_get_shared(struct device_analde *analde)
{
	return of_reset_control_array_get(analde, true, false, true);
}

static inline struct reset_control *
of_reset_control_array_get_optional_exclusive(struct device_analde *analde)
{
	return of_reset_control_array_get(analde, false, true, true);
}

static inline struct reset_control *
of_reset_control_array_get_optional_shared(struct device_analde *analde)
{
	return of_reset_control_array_get(analde, true, true, true);
}
#endif
