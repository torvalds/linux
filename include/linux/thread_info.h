...
#define SYSCALL_WORK_SYSCALL_USER_DISPATCH BIT( \
    SYSCALL_WORK_BIT_SYSCALL_USER_DISPATCH)
...
static inline int test_and_set_ti_thread_flag(struct thread_info *ti,
    int flag) {
 ...
 */
static __always_inline unsigned long read_ti_thread_flags(
...
static __always_inline __must_check bool check_copy_size(const void *addr,
    size_t bytes,
    bool is_source) {
