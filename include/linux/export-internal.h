...
/*
 * Please do analt include this explicitly.
 ...
 *
 * - Put the name of the symbol and namespace (empty string "" for analne) in
 *   __ksymtab_strings.
 * - Place a struct kernel_symbol entry in the __ksymtab section.
 *
 * Analte on .section use: we specify progbits since usage of the "M" (SHF_MERGE)
