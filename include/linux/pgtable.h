...
#error \
  CONFIG_PGTABLE_LEVELS is not consistent with __PAGETABLE_{P4D,PUD,PMD}_FOLDED
#endif
...
#define flush_tlb_fix_spurious_fault(vma, address, ptep) flush_tlb_page(vma, \
    address)
#endif
...
#define has_transparent_pud_hugepage() IS_BUILTIN( \
