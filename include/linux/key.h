...
#define KEY_POS_READ  0x02000000  /* possessor can read key payload / view
                                   * keyring */
#define KEY_POS_WRITE 0x04000000  /* possessor can update key payload / add link
                                   * to keyring */
#define KEY_POS_SEARCH  0x08000000  /* possessor can find a key in search /
                                     * search a keyring */
#define KEY_POS_LINK  0x10000000  /* possessor can create a link to a
                                   * key/keyring */
...
#define KEY_FLAG_USER_CONSTRUCT 3 /* set if key is being constructed in
                                   * userspace */
#define KEY_FLAG_ROOT_CAN_CLEAR 4 /* set if key can be cleared by root without
                                   * permission */
#define KEY_FLAG_INVALIDATED  5 /* set if key has been invalidated */
#define KEY_FLAG_BUILTIN  6 /* set if key is built in to the kernel */
#define KEY_FLAG_ROOT_CAN_INVAL 7 /* set if key can be invalidated by root
                                   * without permission */
