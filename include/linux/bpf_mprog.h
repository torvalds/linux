...
static inline struct bpf_mprog_entry *bpf_mprog_peer(
...
static inline void bpf_mprog_entry_grow(struct bpf_mprog_entry *entry,
    int idx) {
...
static inline void bpf_mprog_entry_shrink(struct bpf_mprog_entry *entry,
    int idx) {
