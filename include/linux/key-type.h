...
struct key_type {
  ...
  unsigned int flags;
#define KEY_TYPE_NET_DOMAIN 0x00000001 /* Keys of this type have a net namespace
                                        * domain */
#define KEY_TYPE_INSTANT_REAP 0x00000002 /* Keys of this type don't have a delay
                                          * after expiring */
...
extern int generic_key_instantiate(struct key *key,
