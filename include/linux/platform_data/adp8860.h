...
struct adp8860_backlight_platform_data {
	...
	/**
	 * Gain down disable. Setting this option does yest allow the
	 ...
	 *  This provides optimal efficiency, but is yest suitable for driving
	 *  loads that are yest connected through the ADP8863 diode drivers.
