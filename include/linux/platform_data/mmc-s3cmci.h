 ...
 * @yes_wprotect: Set this to indicate there is yes write-protect switch.
 * @yes_detect: Set this if there is yes detect switch.
 ...
 * @ocr_avail: The mask of the available power states, yesn-zero to use.
 * @set_power: Callback to control the power mode.
 *
 * The @gpio_detect is used for card detection when @yes_wprotect is unset,
 ...
 * protected if @yes_wprotect is yest set. A 0 returned from gpio_get_value()
 ...
 * to a yesn-zero value, otherwise the default of 3.2-3.4V is used.
 */
struct s3c24xx_mci_pdata {
	unsigned int	yes_wprotect:1;
	unsigned int	yes_detect:1;
