...
/*
 * Note that all values in this struct are in nayesseconds except sync_clk
 * (which is in picoseconds), while the register values are in gpmc_fck cycles.
 */
struct gpmc_timings {
	/* Minimum clock period for synchroyesus mode (in picoseconds) */
	u32 sync_clk;
...
struct gpmc_settings {
	...
	bool sync_read;		/* enables synchroyesus reads */
	bool sync_write;	/* enables synchroyesus writes */
