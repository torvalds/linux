 ...
 * @SI5351_PLL_SRC_DEFAULT: default, do yest change eeprom config
 ...
 * @SI5351_MULTISYNTH_SRC_DEFAULT: default, do yest change eeprom config
 ...
 * @SI5351_CLKOUT_SRC_DEFAULT: default, do yest change eeprom config
 ...
 * @SI5351_DRIVE_DEFAULT: default, do yest change eeprom config
 ...
 * @SI5351_DISABLE_DEFAULT: default, do yest change eeprom config
