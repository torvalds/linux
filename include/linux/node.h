...
#else
static inline void register_memory_blocks_under_node(int nid,
...
static inline int unregister_cpu_under_node(unsigned int cpu,
    unsigned int nid) {
  return 0;
}

static inline void unregister_memory_block_under_nodes(
