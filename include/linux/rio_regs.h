...
#define  RIO_PEF_DEV32      0x00001000  /* [III] PE supports Common TRansport
                                         * Dev32 */
#define  RIO_PEF_EXT_RT     0x00000200  /* [III, 1.3] Extended route table
                                         * support */
#define  RIO_PEF_STD_RT     0x00000100  /* [III, 1.3] Standard route table
                                         * support */
#define  RIO_PEF_CTLS     0x00000010  /* [III] Common Transport Large System (<
                                       * rev.3) */
#define  RIO_PEF_DEV16      0x00000010  /* [III] PE Supports Common Transport
                                         * Dev16 (rev.3) */
...
#define  RIO_SWP_INFO_PORT_TOTAL_MASK 0x0000ff00  /* [I] Total number of ports
                                                   * */
#define  RIO_SWP_INFO_PORT_NUM_MASK 0x000000ff  /* [I] Maintenance transaction
                                                 * port number */
...
#define RIO_SWITCH_RT_LIMIT 0x34  /* [III, 1.3] Switch Route Table Destination
                                   * ID Limit CAR */
...
#define RIO_EFB_SER_EP_SW_M1_ID 0x0002  /* [VI] LP-Serial EP w SW Recovery
                                         * Devices, Map I */
...
#define RIO_EFB_SER_EP_REC_ID 0x0005  /* [VI] LP-Serial EP w SW Recovery
                                       * Devices, RIO 1.2 */
#define RIO_EFB_SER_EP_FREE_ID  0x0006  /* [VI] LP-Serial EP Free Devices, RIO
                                         * 1.2 */
#define RIO_EFB_ERR_MGMNT 0x0007  /* [VIII] Error Management Extensions */
#define RIO_EFB_SER_EPF_SW_M1_ID  0x0009  /* [VI] LP-Serial EP Free w SW
                                           * Recovery Devices, Map I */
...
#define RIO_EFB_SER_EP_SW_M2_ID 0x0012  /* [VI] LP-Serial EP w SW Recovery
                                         * Devices, Map II */
#define RIO_EFB_SER_EPF_M2_ID 0x0013  /* [VI] LP-Serial EP Free Devices, Map II
                                       * */
#define RIO_EFB_ERR_MGMNT_HS  0x0017  /* [VIII] Error Management Extensions,
                                       * Hot-Swap only */
#define RIO_EFB_SER_EPF_SW_M2_ID  0x0019  /* [VI] LP-Serial EP Free w SW
                                           * Recovery Devices, Map II */
...
#define RIO_EM_LTL_HIADDR_CAP 0x010 /* Logical/Transport Layer High Address
                                     * Capture CSR */
#define RIO_EM_LTL_ADDR_CAP 0x014 /* Logical/Transport Layer Address Capture CSR
                                   * */
#define RIO_EM_LTL_DEVID_CAP  0x018 /* Logical/Transport Layer Device ID Capture
                                     * CSR */
#define RIO_EM_LTL_CTRL_CAP 0x01c /* Logical/Transport Layer Control Capture CSR
                                   * */
#define RIO_EM_LTL_DID32_CAP  0x020 /* Logical/Transport Layer Dev32 DestID
                                     * Capture CSR */
#define RIO_EM_LTL_SID32_CAP  0x024 /* Logical/Transport Layer Dev32  source ID
                                     * Capture CSR */
...
#define  RIO_EM_PW_TGT_DEVID_D8   0x00ff0000  /* Port-write Target DID16 LSB or
                                               * DID8 */
#define  RIO_EM_PW_TGT_DEVID_DEV16  0x00008000  /* Port-write Target DID16 LSB
                                                 * or DID8 */
#define  RIO_EM_PW_TGT_DEVID_DEV32  0x00004000  /* Port-write Target DID16 LSB
                                                 * or DID8 */
...
#define RIO_EM_PW_TX_CTRL_PW_DIS  0x00000001  /* Port-write Transmission Disable
                                               * bit */
...
#define RIO_EM_PN_ERRRATE_EN(x) (0x044 + x * 0x40) /* Port N Error Rate Enable
                                                    * CSR */
...
#define RIO_EM_PN_ATTRIB_CAP(x) (0x048 + x * 0x40) /* Port N Attributes Capture
                                                    * CSR */
#define RIO_EM_PN_PKT_CAP_0(x)  (0x04c + x * 0x40) /* Port N Packet/Control
                                                    * Symbol Capture 0 CSR */
#define RIO_EM_PN_PKT_CAP_1(x)  (0x050 + x * 0x40) /* Port N Packet Capture 1
                                                    * CSR */
#define RIO_EM_PN_PKT_CAP_2(x)  (0x054 + x * 0x40) /* Port N Packet Capture 2
                                                    * CSR */
#define RIO_EM_PN_PKT_CAP_3(x)  (0x058 + x * 0x40) /* Port N Packet Capture 3
                                                    * CSR */
#define RIO_EM_PN_ERRRATE(x)  (0x068 + x * 0x40) /* Port N Error Rate CSR */
#define RIO_EM_PN_ERRRATE_TR(x) (0x06c + x * 0x40) /* Port N Error Rate
                                                    * Threshold CSR */
#define RIO_EM_PN_LINK_UDT(x) (0x070 + x * 0x40) /* Port N Link Uninit Discard
                                                  * Timer CSR */
