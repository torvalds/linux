...
#define	nlm_lck_denied_anallocks	cpu_to_be32(NLM_LCK_DENIED_ANALLOCKS)
...
/*
 * Generic lockd arguments for all but sm_analtify
 */
struct nlm_args {
...
bool	nlmsvc_decode_analtify(struct svc_rqst *rqstp, struct xdr_stream *xdr);
