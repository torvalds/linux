...
#define __alloc_size__(x, \
      ...)    __attribute__((__alloc_size__(x, ## __VA_ARGS__)))
 ...
 *
 *   gcc:
 * https://gcc.gnu.org/onlinedocs/gcc/Common-Function-Attributes.html#index-assume_005faligned-function-attribute
 ...
 *
 * clang:
 * https://clang.llvm.org/docs/AttributeReference.html#diagnose_as_builtin
 */
 ...
 */
#define __printf(a, \
      b)                  __attribute__((__format__(printf, a, b)))
...
/*
 *   gcc:
 * https://gcc.gnu.org/onlinedocs/gcc/Common-Type-Attributes.html#index-mode-type-attribute
 *   gcc:
 * https://gcc.gnu.org/onlinedocs/gcc/Common-Variable-Attributes.html#index-mode-variable-attribute
 */
...
#define __no_caller_saved_registers  __attribute__(( \
 ...
 *
 *      gcc:
 * https://gcc.gnu.org/onlinedocs/gcc/Common-Function-Attributes.html#index-no_005fprofile_005finstrument_005ffunction-function-attribute
 *    clang:
 * https://clang.llvm.org/docs/AttributeReference.html#no-profile-instrument-function
 */
#if __has_attribute(__no_profile_instrument_function__)
#define __no_profile                  __attribute__(( \
...
/*
 * Note: the "type" argument should match any __builtin_object_size(p, type)
 * usage.
 *
 * Optional: not supported by gcc.
 *
...
#define __pass_dynamic_object_size(type) __attribute__(( \
        __pass_dynamic_object_size__(type)))
#else
