 ...
 * and termination current will yest be possible.
 *
 * For automode support is needed to provide name of power supply device
 * in value yestify_device. Device driver must immediately report property
...
enum bq2415x_mode {
	...
	BQ2415X_MODE_NONE,		/* unkyeswn charger (100mA) */
...
struct bq2415x_platform_data {
	...
	const char *yestify_device;	/* name */
};
