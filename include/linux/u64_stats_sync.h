...
static inline unsigned int __u64_stats_fetch_begin(
...
static inline unsigned long u64_stats_update_begin_irqsave(
...
static inline unsigned int u64_stats_fetch_begin(
    const struct u64_stats_sync *syncp) {
