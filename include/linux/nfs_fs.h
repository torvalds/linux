...
#define NFS_INO_REVAL_FORCED  BIT(6)    /* force revalidation ignoring a
                                         * delegation */
...
extern struct inode *nfs_fhget(struct super_block *, struct nfs_fh *,
    struct nfs_fattr *);
struct inode *nfs_ilookup(struct super_block *sb, struct nfs_fattr *,
    struct nfs_fh *);
extern int nfs_refresh_inode(struct inode *, struct nfs_fattr *);
extern int nfs_post_op_update_inode(struct inode *inode,
    struct nfs_fattr *fattr);
extern int nfs_post_op_update_inode_force_wcc(struct inode *inode,
    struct nfs_fattr *fattr);
extern int nfs_post_op_update_inode_force_wcc_locked(struct inode *inode,
    struct nfs_fattr *fattr);
...
extern struct nfs_open_context *get_nfs_open_context(
...
extern void nfs_file_set_open_context(struct file *filp,
    struct nfs_open_context *ctx);
...
extern int nfs_instantiate(struct dentry *dentry, struct nfs_fh *fh,
    struct nfs_fattr *fattr);
extern int nfs_may_open(struct inode *inode, const struct cred *cred,
    int openflags);
...
static inline ino_t nfs_fileid_to_ino_t(u64 fileid) {
