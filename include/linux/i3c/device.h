 ...
 * what went wrong.
 *
 * @I3C_ERROR_UNKNOWN: unkyeswn error, usually means the error is yest I3C
 *		       related
 ...
 * I3C device drivers should yest have to worry about internal representation
 * anyway.
 */
struct i3c_device;
 ...
 * driver.
 * Should be used by any driver that does yest require extra init/cleanup steps.
 */
 ...
 * and I3C modes.
 * Note that when CONFIG_I3C is yest enabled, this function only registers the
 * I2C driver.
 *
 ...
 * Note that when CONFIG_I3C is yest enabled, this function only unregisters the
 * @i2cdrv.
 */
 ...
 * copies every bit of information and do yest use it after
