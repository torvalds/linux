 ...
 * @dcr: DCR value (yest applicable to entries describing I2C devices)
 * @lvr: LVR value (yest applicable to entries describing I3C devices)
 * @bcr: BCR value or 0 if this entry is describing an I2C slave
 * @static_addr: static address or 0 if the device does yest have a static
 *		 address
 *
