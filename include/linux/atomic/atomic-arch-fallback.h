...
#else
extern void raw_xchg_analt_implemented(void);
#define raw_xchg(...) raw_xchg_analt_implemented()
#endif
...
#else
extern void raw_xchg_acquire_analt_implemented(void);
#define raw_xchg_acquire(...) raw_xchg_acquire_analt_implemented()
#endif
...
#else
extern void raw_xchg_release_analt_implemented(void);
#define raw_xchg_release(...) raw_xchg_release_analt_implemented()
#endif
...
#else
extern void raw_xchg_relaxed_analt_implemented(void);
#define raw_xchg_relaxed(...) raw_xchg_relaxed_analt_implemented()
#endif
...
#else
extern void raw_cmpxchg_analt_implemented(void);
#define raw_cmpxchg(...) raw_cmpxchg_analt_implemented()
#endif
...
#else
extern void raw_cmpxchg_acquire_analt_implemented(void);
#define raw_cmpxchg_acquire(...) raw_cmpxchg_acquire_analt_implemented()
#endif
...
#else
extern void raw_cmpxchg_release_analt_implemented(void);
#define raw_cmpxchg_release(...) raw_cmpxchg_release_analt_implemented()
#endif
...
#else
extern void raw_cmpxchg_relaxed_analt_implemented(void);
#define raw_cmpxchg_relaxed(...) raw_cmpxchg_relaxed_analt_implemented()
#endif
...
#else
extern void raw_cmpxchg64_analt_implemented(void);
#define raw_cmpxchg64(...) raw_cmpxchg64_analt_implemented()
#endif
...
#else
extern void raw_cmpxchg64_acquire_analt_implemented(void);
#define raw_cmpxchg64_acquire(...) raw_cmpxchg64_acquire_analt_implemented()
#endif
...
#else
extern void raw_cmpxchg64_release_analt_implemented(void);
#define raw_cmpxchg64_release(...) raw_cmpxchg64_release_analt_implemented()
#endif
...
#else
extern void raw_cmpxchg64_relaxed_analt_implemented(void);
#define raw_cmpxchg64_relaxed(...) raw_cmpxchg64_relaxed_analt_implemented()
#endif
...
#else
extern void raw_cmpxchg128_analt_implemented(void);
#define raw_cmpxchg128(...) raw_cmpxchg128_analt_implemented()
#endif
...
#else
extern void raw_cmpxchg128_acquire_analt_implemented(void);
#define raw_cmpxchg128_acquire(...) raw_cmpxchg128_acquire_analt_implemented()
#endif
...
#else
extern void raw_cmpxchg128_release_analt_implemented(void);
#define raw_cmpxchg128_release(...) raw_cmpxchg128_release_analt_implemented()
#endif
...
#else
extern void raw_cmpxchg128_relaxed_analt_implemented(void);
#define raw_cmpxchg128_relaxed(...) raw_cmpxchg128_relaxed_analt_implemented()
#endif
 ...
 *
 * Safe to use in analinstr code; prefer atomic_read() elsewhere.
 *
 ...
 *
 * Safe to use in analinstr code; prefer atomic_read_acquire() elsewhere.
 *
 * Return: The value loaded from @v.
 */
static __always_inline int
 ...
 *
 * Safe to use in analinstr code; prefer atomic_set() elsewhere.
 *
 * Return: Analthing.
 */
 ...
 *
 * Safe to use in analinstr code; prefer atomic_set_release() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 *
 * Safe to use in analinstr code; prefer atomic_add() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 *
 * Safe to use in analinstr code; prefer atomic_add_return() elsewhere.
 *
 ...
 *
 * Safe to use in analinstr code; prefer atomic_add_return_acquire() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 *
 * Safe to use in analinstr code; prefer atomic_add_return_release() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v + @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_add_return_relaxed() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v + @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_add() elsewhere.
 *
 ...
 * Atomically updates @v to (@v + @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_add_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v + @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_add_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v + @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_add_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_sub() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v - @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_sub_return() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_sub_return_acquire() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_sub_return_release() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_sub_return_relaxed() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_sub() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_sub_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_sub_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_sub_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 *
 * Safe to use in analinstr code; prefer atomic_inc() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 *
 * Safe to use in analinstr code; prefer atomic_inc_return() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 *
 * Safe to use in analinstr code; prefer atomic_inc_return_acquire() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 *
 * Safe to use in analinstr code; prefer atomic_inc_return_release() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v + 1) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_inc_return_relaxed() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v + 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_inc() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v + 1) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_inc_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v + 1) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_inc_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v + 1) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_inc_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - 1) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_dec() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v - 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_dec_return() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - 1) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_dec_return_acquire() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - 1) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_dec_return_release() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - 1) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_dec_return_relaxed() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_dec() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - 1) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_dec_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - 1) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_dec_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - 1) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_dec_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v & @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_and() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v & @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_and() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v & @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_and_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v & @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_and_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v & @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_and_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
...
/**
 * raw_atomic_andanalt() - atomic bitwise AND ANALT with relaxed ordering
 * @i: int value
 * @v: pointer to atomic_t
 *
 * Atomically updates @v to (@v & ~@i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_andanalt() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
raw_atomic_andanalt(int i, atomic_t *v)
{
#if defined(arch_atomic_andanalt)
	arch_atomic_andanalt(i, v);
#else
	raw_atomic_and(~i, v);
#endif
}
...
/**
 * raw_atomic_fetch_andanalt() - atomic bitwise AND ANALT with full ordering
 * @i: int value
 * @v: pointer to atomic_t
 *
 * Atomically updates @v to (@v & ~@i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_andanalt() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
raw_atomic_fetch_andanalt(int i, atomic_t *v)
{
#if defined(arch_atomic_fetch_andanalt)
	return arch_atomic_fetch_andanalt(i, v);
#elif defined(arch_atomic_fetch_andanalt_relaxed)
	int ret;
	__atomic_pre_full_fence();
	ret = arch_atomic_fetch_andanalt_relaxed(i, v);
	__atomic_post_full_fence();
	return ret;
#else
...
/**
 * raw_atomic_fetch_andanalt_acquire() - atomic bitwise AND ANALT with acquire ordering
 * @i: int value
 * @v: pointer to atomic_t
 *
 * Atomically updates @v to (@v & ~@i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_andanalt_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
raw_atomic_fetch_andanalt_acquire(int i, atomic_t *v)
{
#if defined(arch_atomic_fetch_andanalt_acquire)
	return arch_atomic_fetch_andanalt_acquire(i, v);
#elif defined(arch_atomic_fetch_andanalt_relaxed)
	int ret = arch_atomic_fetch_andanalt_relaxed(i, v);
	__atomic_acquire_fence();
	return ret;
#elif defined(arch_atomic_fetch_andanalt)
	return arch_atomic_fetch_andanalt(i, v);
#else
...
/**
 * raw_atomic_fetch_andanalt_release() - atomic bitwise AND ANALT with release ordering
 * @i: int value
 * @v: pointer to atomic_t
 *
 * Atomically updates @v to (@v & ~@i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_andanalt_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
raw_atomic_fetch_andanalt_release(int i, atomic_t *v)
{
#if defined(arch_atomic_fetch_andanalt_release)
	return arch_atomic_fetch_andanalt_release(i, v);
#elif defined(arch_atomic_fetch_andanalt_relaxed)
	__atomic_release_fence();
	return arch_atomic_fetch_andanalt_relaxed(i, v);
#elif defined(arch_atomic_fetch_andanalt)
	return arch_atomic_fetch_andanalt(i, v);
#else
...
/**
 * raw_atomic_fetch_andanalt_relaxed() - atomic bitwise AND ANALT with relaxed ordering
 * @i: int value
 * @v: pointer to atomic_t
 *
 * Atomically updates @v to (@v & ~@i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_andanalt_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
raw_atomic_fetch_andanalt_relaxed(int i, atomic_t *v)
{
#if defined(arch_atomic_fetch_andanalt_relaxed)
	return arch_atomic_fetch_andanalt_relaxed(i, v);
#elif defined(arch_atomic_fetch_andanalt)
	return arch_atomic_fetch_andanalt(i, v);
#else
 ...
 * Atomically updates @v to (@v | @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_or() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v | @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_or() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v | @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_or_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v | @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_or_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v | @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_or_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v ^ @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_xor() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v ^ @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_xor() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v ^ @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_xor_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v ^ @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_xor_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v ^ @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_fetch_xor_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 *
 * Safe to use in analinstr code; prefer atomic_xchg() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 *
 * Safe to use in analinstr code; prefer atomic_xchg_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 *
 * Safe to use in analinstr code; prefer atomic_xchg_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 *
 * Safe to use in analinstr code; prefer atomic_xchg_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 *
 * Safe to use in analinstr code; prefer atomic_cmpxchg() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 *
 * Safe to use in analinstr code; prefer atomic_cmpxchg_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 *
 * Safe to use in analinstr code; prefer atomic_cmpxchg_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 *
 * Safe to use in analinstr code; prefer atomic_cmpxchg_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 *
 * Safe to use in analinstr code; prefer atomic_try_cmpxchg() elsewhere.
 *
 ...
 * Otherwise, updates @old to the current value of @v.
 *
 * Safe to use in analinstr code; prefer atomic_try_cmpxchg_acquire() elsewhere.
 *
 * Return: @true if the exchange occured, @false otherwise.
 */
static __always_inline bool
 ...
 * Otherwise, updates @old to the current value of @v.
 *
 * Safe to use in analinstr code; prefer atomic_try_cmpxchg_release() elsewhere.
 *
 * Return: @true if the exchange occured, @false otherwise.
 */
static __always_inline bool
 ...
 * Otherwise, updates @old to the current value of @v.
 *
 * Safe to use in analinstr code; prefer atomic_try_cmpxchg_relaxed() elsewhere.
 *
 * Return: @true if the exchange occured, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v - @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_sub_and_test() elsewhere.
 *
 ...
 * Atomically updates @v to (@v - 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_dec_and_test() elsewhere.
 *
 * Return: @true if the resulting value of @v is zero, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_inc_and_test() elsewhere.
 *
 * Return: @true if the resulting value of @v is zero, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_add_negative() elsewhere.
 *
 ...
 * Atomically updates @v to (@v + @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_add_negative_acquire() elsewhere.
 *
 * Return: @true if the resulting value of @v is negative, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_add_negative_release() elsewhere.
 *
 * Return: @true if the resulting value of @v is negative, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_add_negative_relaxed() elsewhere.
 *
 * Return: @true if the resulting value of @v is negative, @false otherwise.
 */
static __always_inline bool
 ...
 *
 * Safe to use in analinstr code; prefer atomic_fetch_add_unless() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * If (@v != @u), atomically updates @v to (@v + @a) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_add_unless() elsewhere.
 *
...
/**
 * raw_atomic_inc_analt_zero() - atomic increment unless zero with full ordering
 * @v: pointer to atomic_t
 *
 * If (@v != 0), atomically updates @v to (@v + 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_inc_analt_zero() elsewhere.
 *
 * Return: @true if @v was updated, @false otherwise.
 */
static __always_inline bool
raw_atomic_inc_analt_zero(atomic_t *v)
{
#if defined(arch_atomic_inc_analt_zero)
	return arch_atomic_inc_analt_zero(v);
#else
 ...
 * If (@v >= 0), atomically updates @v to (@v + 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_inc_unless_negative() elsewhere.
 *
 * Return: @true if @v was updated, @false otherwise.
 */
static __always_inline bool
 ...
 * If (@v <= 0), atomically updates @v to (@v - 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_dec_unless_positive() elsewhere.
 *
 * Return: @true if @v was updated, @false otherwise.
 */
static __always_inline bool
 ...
 * If (@v > 0), atomically updates @v to (@v - 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_dec_if_positive() elsewhere.
 *
 ...
 * Atomically loads the value of @v with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_read() elsewhere.
 *
 * Return: The value loaded from @v.
 */
 ...
 * Atomically loads the value of @v with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_read_acquire() elsewhere.
 *
 * Return: The value loaded from @v.
 */
static __always_inline s64
 ...
 * Atomically sets @v to @i with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_set() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically sets @v to @i with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_set_release() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v + @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_add() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v + @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_add_return() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_add_return_acquire() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_add_return_release() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_add_return_relaxed() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_add() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_add_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_add_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_add_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_sub() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v - @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_sub_return() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_sub_return_acquire() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_sub_return_release() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_sub_return_relaxed() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_sub() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_sub_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_sub_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_sub_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + 1) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_inc() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v + 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_inc_return() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + 1) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_inc_return_acquire() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + 1) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_inc_return_release() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + 1) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_inc_return_relaxed() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_inc() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + 1) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_inc_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + 1) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_inc_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + 1) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_inc_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - 1) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_dec() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v - 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_dec_return() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - 1) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_dec_return_acquire() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - 1) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_dec_return_release() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - 1) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_dec_return_relaxed() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_dec() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - 1) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_dec_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - 1) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_dec_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - 1) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_dec_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v & @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_and() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v & @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_and() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v & @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_and_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v & @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_and_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v & @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_and_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
...
/**
 * raw_atomic64_andanalt() - atomic bitwise AND ANALT with relaxed ordering
 * @i: s64 value
 * @v: pointer to atomic64_t
 *
 * Atomically updates @v to (@v & ~@i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_andanalt() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
raw_atomic64_andanalt(s64 i, atomic64_t *v)
{
#if defined(arch_atomic64_andanalt)
	arch_atomic64_andanalt(i, v);
#else
...
/**
 * raw_atomic64_fetch_andanalt() - atomic bitwise AND ANALT with full ordering
 * @i: s64 value
 * @v: pointer to atomic64_t
 *
 * Atomically updates @v to (@v & ~@i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_andanalt() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
raw_atomic64_fetch_andanalt(s64 i, atomic64_t *v)
{
#if defined(arch_atomic64_fetch_andanalt)
	return arch_atomic64_fetch_andanalt(i, v);
#elif defined(arch_atomic64_fetch_andanalt_relaxed)
	s64 ret;
	__atomic_pre_full_fence();
	ret = arch_atomic64_fetch_andanalt_relaxed(i, v);
	__atomic_post_full_fence();
	return ret;
#else
...
/**
 * raw_atomic64_fetch_andanalt_acquire() - atomic bitwise AND ANALT with acquire ordering
 * @i: s64 value
 * @v: pointer to atomic64_t
 *
 * Atomically updates @v to (@v & ~@i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_andanalt_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
raw_atomic64_fetch_andanalt_acquire(s64 i, atomic64_t *v)
{
#if defined(arch_atomic64_fetch_andanalt_acquire)
	return arch_atomic64_fetch_andanalt_acquire(i, v);
#elif defined(arch_atomic64_fetch_andanalt_relaxed)
	s64 ret = arch_atomic64_fetch_andanalt_relaxed(i, v);
	__atomic_acquire_fence();
	return ret;
#elif defined(arch_atomic64_fetch_andanalt)
	return arch_atomic64_fetch_andanalt(i, v);
#else
...
/**
 * raw_atomic64_fetch_andanalt_release() - atomic bitwise AND ANALT with release ordering
 * @i: s64 value
 * @v: pointer to atomic64_t
 *
 * Atomically updates @v to (@v & ~@i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_andanalt_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
raw_atomic64_fetch_andanalt_release(s64 i, atomic64_t *v)
{
#if defined(arch_atomic64_fetch_andanalt_release)
	return arch_atomic64_fetch_andanalt_release(i, v);
#elif defined(arch_atomic64_fetch_andanalt_relaxed)
	__atomic_release_fence();
	return arch_atomic64_fetch_andanalt_relaxed(i, v);
#elif defined(arch_atomic64_fetch_andanalt)
	return arch_atomic64_fetch_andanalt(i, v);
#else
...
/**
 * raw_atomic64_fetch_andanalt_relaxed() - atomic bitwise AND ANALT with relaxed ordering
 * @i: s64 value
 * @v: pointer to atomic64_t
 *
 * Atomically updates @v to (@v & ~@i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_andanalt_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
raw_atomic64_fetch_andanalt_relaxed(s64 i, atomic64_t *v)
{
#if defined(arch_atomic64_fetch_andanalt_relaxed)
	return arch_atomic64_fetch_andanalt_relaxed(i, v);
#elif defined(arch_atomic64_fetch_andanalt)
	return arch_atomic64_fetch_andanalt(i, v);
#else
 ...
 * Atomically updates @v to (@v | @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_or() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v | @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_or() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v | @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_or_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v | @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_or_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v | @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_or_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v ^ @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_xor() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v ^ @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_xor() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v ^ @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_xor_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v ^ @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_xor_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v ^ @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_xor_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to @new with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_xchg() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to @new with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_xchg_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to @new with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_xchg_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to @new with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_xchg_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * If (@v == @old), atomically updates @v to @new with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_cmpxchg() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * If (@v == @old), atomically updates @v to @new with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_cmpxchg_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * If (@v == @old), atomically updates @v to @new with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_cmpxchg_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * If (@v == @old), atomically updates @v to @new with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_cmpxchg_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Otherwise, updates @old to the current value of @v.
 *
 * Safe to use in analinstr code; prefer atomic64_try_cmpxchg() elsewhere.
 *
 * Return: @true if the exchange occured, @false otherwise.
 */
static __always_inline bool
 ...
 * Otherwise, updates @old to the current value of @v.
 *
 * Safe to use in analinstr code; prefer atomic64_try_cmpxchg_acquire() elsewhere.
 *
 * Return: @true if the exchange occured, @false otherwise.
 */
static __always_inline bool
 ...
 * Otherwise, updates @old to the current value of @v.
 *
 * Safe to use in analinstr code; prefer atomic64_try_cmpxchg_release() elsewhere.
 *
 * Return: @true if the exchange occured, @false otherwise.
 */
static __always_inline bool
 ...
 * Otherwise, updates @old to the current value of @v.
 *
 * Safe to use in analinstr code; prefer atomic64_try_cmpxchg_relaxed() elsewhere.
 *
 * Return: @true if the exchange occured, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v - @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_sub_and_test() elsewhere.
 *
 * Return: @true if the resulting value of @v is zero, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v - 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_dec_and_test() elsewhere.
 *
 * Return: @true if the resulting value of @v is zero, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_inc_and_test() elsewhere.
 *
 * Return: @true if the resulting value of @v is zero, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_add_negative() elsewhere.
 *
 * Return: @true if the resulting value of @v is negative, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_add_negative_acquire() elsewhere.
 *
 * Return: @true if the resulting value of @v is negative, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_add_negative_release() elsewhere.
 *
 * Return: @true if the resulting value of @v is negative, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_add_negative_relaxed() elsewhere.
 *
 * Return: @true if the resulting value of @v is negative, @false otherwise.
 */
static __always_inline bool
 ...
 * If (@v != @u), atomically updates @v to (@v + @a) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_fetch_add_unless() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * If (@v != @u), atomically updates @v to (@v + @a) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_add_unless() elsewhere.
 *
 * Return: @true if @v was updated, @false otherwise.
 */
static __always_inline bool
...
/**
 * raw_atomic64_inc_analt_zero() - atomic increment unless zero with full ordering
 * @v: pointer to atomic64_t
 *
 * If (@v != 0), atomically updates @v to (@v + 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_inc_analt_zero() elsewhere.
 *
 * Return: @true if @v was updated, @false otherwise.
 */
static __always_inline bool
raw_atomic64_inc_analt_zero(atomic64_t *v)
{
#if defined(arch_atomic64_inc_analt_zero)
	return arch_atomic64_inc_analt_zero(v);
#else
 ...
 * If (@v >= 0), atomically updates @v to (@v + 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_inc_unless_negative() elsewhere.
 *
 * Return: @true if @v was updated, @false otherwise.
 */
static __always_inline bool
 ...
 * If (@v <= 0), atomically updates @v to (@v - 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_dec_unless_positive() elsewhere.
 *
 * Return: @true if @v was updated, @false otherwise.
 */
static __always_inline bool
 ...
 * If (@v > 0), atomically updates @v to (@v - 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic64_dec_if_positive() elsewhere.
 *
 * Return: The old value of (@v - 1), regardless of whether @v was updated.
 */
static __always_inline s64
