 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_read() elsewhere.
 *
 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_read_acquire() elsewhere.
 *
 * Return: The value loaded from @v.
 */
static __always_inline long
 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_set() elsewhere.
 *
 * Return: Analthing.
 */
 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_set_release() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_add() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_add_return() elsewhere.
 *
 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_add_return_acquire() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_add_return_release() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_add_return_relaxed() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_add() elsewhere.
 *
 ...
 * Atomically updates @v to (@v + @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_add_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_add_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_add_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_sub() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v - @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_sub_return() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_sub_return_acquire() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_sub_return_release() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_sub_return_relaxed() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_sub() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_sub_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_sub_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_sub_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_inc() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_inc_return() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_inc_return_acquire() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_inc_return_release() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + 1) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_inc_return_relaxed() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_inc() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + 1) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_inc_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + 1) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_inc_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + 1) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_inc_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - 1) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_dec() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v - 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_dec_return() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - 1) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_dec_return_acquire() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - 1) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_dec_return_release() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - 1) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_dec_return_relaxed() elsewhere.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_dec() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - 1) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_dec_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - 1) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_dec_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - 1) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_dec_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v & @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_and() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v & @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_and() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v & @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_and_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v & @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_and_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v & @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_and_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
...
/**
 * raw_atomic_long_andanalt() - atomic bitwise AND ANALT with relaxed ordering
 * @i: long value
 * @v: pointer to atomic_long_t
 *
 * Atomically updates @v to (@v & ~@i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_andanalt() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
raw_atomic_long_andanalt(long i, atomic_long_t *v)
{
#ifdef CONFIG_64BIT
	raw_atomic64_andanalt(i, v);
#else
	raw_atomic_andanalt(i, v);
#endif
}

/**
 * raw_atomic_long_fetch_andanalt() - atomic bitwise AND ANALT with full ordering
 * @i: long value
 * @v: pointer to atomic_long_t
 *
 * Atomically updates @v to (@v & ~@i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_andanalt() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
raw_atomic_long_fetch_andanalt(long i, atomic_long_t *v)
{
#ifdef CONFIG_64BIT
	return raw_atomic64_fetch_andanalt(i, v);
#else
	return raw_atomic_fetch_andanalt(i, v);
#endif
}

/**
 * raw_atomic_long_fetch_andanalt_acquire() - atomic bitwise AND ANALT with acquire ordering
 * @i: long value
 * @v: pointer to atomic_long_t
 *
 * Atomically updates @v to (@v & ~@i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_andanalt_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
raw_atomic_long_fetch_andanalt_acquire(long i, atomic_long_t *v)
{
#ifdef CONFIG_64BIT
	return raw_atomic64_fetch_andanalt_acquire(i, v);
#else
	return raw_atomic_fetch_andanalt_acquire(i, v);
#endif
}

/**
 * raw_atomic_long_fetch_andanalt_release() - atomic bitwise AND ANALT with release ordering
 * @i: long value
 * @v: pointer to atomic_long_t
 *
 * Atomically updates @v to (@v & ~@i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_andanalt_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
raw_atomic_long_fetch_andanalt_release(long i, atomic_long_t *v)
{
#ifdef CONFIG_64BIT
	return raw_atomic64_fetch_andanalt_release(i, v);
#else
	return raw_atomic_fetch_andanalt_release(i, v);
#endif
}

/**
 * raw_atomic_long_fetch_andanalt_relaxed() - atomic bitwise AND ANALT with relaxed ordering
 * @i: long value
 * @v: pointer to atomic_long_t
 *
 * Atomically updates @v to (@v & ~@i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_andanalt_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
raw_atomic_long_fetch_andanalt_relaxed(long i, atomic_long_t *v)
{
#ifdef CONFIG_64BIT
	return raw_atomic64_fetch_andanalt_relaxed(i, v);
#else
	return raw_atomic_fetch_andanalt_relaxed(i, v);
#endif
}
 ...
 * Atomically updates @v to (@v | @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_or() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v | @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_or() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v | @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_or_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v | @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_or_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v | @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_or_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v ^ @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_xor() elsewhere.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v ^ @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_xor() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v ^ @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_xor_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v ^ @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_xor_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v ^ @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_xor_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_xchg() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_xchg_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_xchg_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_xchg_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_cmpxchg() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_cmpxchg_acquire() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_cmpxchg_release() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_cmpxchg_relaxed() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_try_cmpxchg() elsewhere.
 *
 ...
 * Otherwise, updates @old to the current value of @v.
 *
 * Safe to use in analinstr code; prefer atomic_long_try_cmpxchg_acquire() elsewhere.
 *
 * Return: @true if the exchange occured, @false otherwise.
 */
static __always_inline bool
 ...
 * Otherwise, updates @old to the current value of @v.
 *
 * Safe to use in analinstr code; prefer atomic_long_try_cmpxchg_release() elsewhere.
 *
 * Return: @true if the exchange occured, @false otherwise.
 */
static __always_inline bool
 ...
 * Otherwise, updates @old to the current value of @v.
 *
 * Safe to use in analinstr code; prefer atomic_long_try_cmpxchg_relaxed() elsewhere.
 *
 * Return: @true if the exchange occured, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v - @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_sub_and_test() elsewhere.
 *
 ...
 * Atomically updates @v to (@v - 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_dec_and_test() elsewhere.
 *
 * Return: @true if the resulting value of @v is zero, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_inc_and_test() elsewhere.
 *
 * Return: @true if the resulting value of @v is zero, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + @i) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_add_negative() elsewhere.
 *
 ...
 * Atomically updates @v to (@v + @i) with acquire ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_add_negative_acquire() elsewhere.
 *
 * Return: @true if the resulting value of @v is negative, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + @i) with release ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_add_negative_release() elsewhere.
 *
 * Return: @true if the resulting value of @v is negative, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + @i) with relaxed ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_add_negative_relaxed() elsewhere.
 *
 * Return: @true if the resulting value of @v is negative, @false otherwise.
 */
static __always_inline bool
 ...
 *
 * Safe to use in analinstr code; prefer atomic_long_fetch_add_unless() elsewhere.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * If (@v != @u), atomically updates @v to (@v + @a) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_add_unless() elsewhere.
 *
...
/**
 * raw_atomic_long_inc_analt_zero() - atomic increment unless zero with full ordering
 * @v: pointer to atomic_long_t
 *
 * If (@v != 0), atomically updates @v to (@v + 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_inc_analt_zero() elsewhere.
 *
 * Return: @true if @v was updated, @false otherwise.
 */
static __always_inline bool
raw_atomic_long_inc_analt_zero(atomic_long_t *v)
{
#ifdef CONFIG_64BIT
	return raw_atomic64_inc_analt_zero(v);
#else
	return raw_atomic_inc_analt_zero(v);
#endif
}
 ...
 * If (@v >= 0), atomically updates @v to (@v + 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_inc_unless_negative() elsewhere.
 *
 * Return: @true if @v was updated, @false otherwise.
 */
static __always_inline bool
 ...
 * If (@v <= 0), atomically updates @v to (@v - 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_dec_unless_positive() elsewhere.
 *
 * Return: @true if @v was updated, @false otherwise.
 */
static __always_inline bool
 ...
 * If (@v > 0), atomically updates @v to (@v - 1) with full ordering.
 *
 * Safe to use in analinstr code; prefer atomic_long_dec_if_positive() elsewhere.
 *
