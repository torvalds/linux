 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_read() there.
 *
 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_read_acquire() there.
 *
 * Return: The value loaded from @v.
 */
static __always_inline int
 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_set() there.
 *
 * Return: Analthing.
 */
 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_set_release() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_add() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_add_return() there.
 *
 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_add_return_acquire() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_add_return_release() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v + @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_add_return_relaxed() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v + @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_add() there.
 *
 ...
 * Atomically updates @v to (@v + @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_add_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v + @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_add_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v + @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_add_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_sub() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v - @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_sub_return() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_sub_return_acquire() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_sub_return_release() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_sub_return_relaxed() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_sub() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_sub_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_sub_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_sub_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_inc() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_inc_return() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_inc_return_acquire() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_inc_return_release() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v + 1) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_inc_return_relaxed() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v + 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_inc() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v + 1) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_inc_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v + 1) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_inc_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v + 1) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_inc_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - 1) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_dec() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v - 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_dec_return() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - 1) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_dec_return_acquire() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - 1) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_dec_return_release() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - 1) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_dec_return_relaxed() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_dec() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - 1) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_dec_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - 1) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_dec_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v - 1) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_dec_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v & @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_and() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v & @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_and() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v & @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_and_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v & @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_and_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v & @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_and_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
...
/**
 * atomic_andanalt() - atomic bitwise AND ANALT with relaxed ordering
 * @i: int value
 * @v: pointer to atomic_t
 *
 * Atomically updates @v to (@v & ~@i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_andanalt() there.
 *
 * Return: Analthing.
 */
static __always_inline void
atomic_andanalt(int i, atomic_t *v)
{
	instrument_atomic_read_write(v, sizeof(*v));
...
/**
 * atomic_fetch_andanalt() - atomic bitwise AND ANALT with full ordering
 * @i: int value
 * @v: pointer to atomic_t
 *
 * Atomically updates @v to (@v & ~@i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_andanalt() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
atomic_fetch_andanalt(int i, atomic_t *v)
{
	kcsan_mb();
	instrument_atomic_read_write(v, sizeof(*v));
...
/**
 * atomic_fetch_andanalt_acquire() - atomic bitwise AND ANALT with acquire ordering
 * @i: int value
 * @v: pointer to atomic_t
 *
 * Atomically updates @v to (@v & ~@i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_andanalt_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
atomic_fetch_andanalt_acquire(int i, atomic_t *v)
{
	instrument_atomic_read_write(v, sizeof(*v));
...
/**
 * atomic_fetch_andanalt_release() - atomic bitwise AND ANALT with release ordering
 * @i: int value
 * @v: pointer to atomic_t
 *
 * Atomically updates @v to (@v & ~@i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_andanalt_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
atomic_fetch_andanalt_release(int i, atomic_t *v)
{
	kcsan_release();
	instrument_atomic_read_write(v, sizeof(*v));
...
/**
 * atomic_fetch_andanalt_relaxed() - atomic bitwise AND ANALT with relaxed ordering
 * @i: int value
 * @v: pointer to atomic_t
 *
 * Atomically updates @v to (@v & ~@i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_andanalt_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
atomic_fetch_andanalt_relaxed(int i, atomic_t *v)
{
	instrument_atomic_read_write(v, sizeof(*v));
 ...
 * Atomically updates @v to (@v | @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_or() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v | @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_or() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v | @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_or_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v | @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_or_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v | @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_or_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v ^ @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_xor() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v ^ @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_xor() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v ^ @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_xor_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v ^ @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_xor_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * Atomically updates @v to (@v ^ @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_xor_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_xchg() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_xchg_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_xchg_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_xchg_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_cmpxchg() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_cmpxchg_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_cmpxchg_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_cmpxchg_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_try_cmpxchg() there.
 *
 ...
 * Otherwise, updates @old to the current value of @v.
 *
 * Unsafe to use in analinstr code; use raw_atomic_try_cmpxchg_acquire() there.
 *
 * Return: @true if the exchange occured, @false otherwise.
 */
static __always_inline bool
 ...
 * Otherwise, updates @old to the current value of @v.
 *
 * Unsafe to use in analinstr code; use raw_atomic_try_cmpxchg_release() there.
 *
 * Return: @true if the exchange occured, @false otherwise.
 */
static __always_inline bool
 ...
 * Otherwise, updates @old to the current value of @v.
 *
 * Unsafe to use in analinstr code; use raw_atomic_try_cmpxchg_relaxed() there.
 *
 * Return: @true if the exchange occured, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v - @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_sub_and_test() there.
 *
 ...
 * Atomically updates @v to (@v - 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_dec_and_test() there.
 *
 * Return: @true if the resulting value of @v is zero, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_inc_and_test() there.
 *
 * Return: @true if the resulting value of @v is zero, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_add_negative() there.
 *
 ...
 * Atomically updates @v to (@v + @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_add_negative_acquire() there.
 *
 * Return: @true if the resulting value of @v is negative, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_add_negative_release() there.
 *
 * Return: @true if the resulting value of @v is negative, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_add_negative_relaxed() there.
 *
 * Return: @true if the resulting value of @v is negative, @false otherwise.
 */
static __always_inline bool
 ...
 *
 * Unsafe to use in analinstr code; use raw_atomic_fetch_add_unless() there.
 *
 * Return: The original value of @v.
 */
static __always_inline int
 ...
 * If (@v != @u), atomically updates @v to (@v + @a) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_add_unless() there.
 *
...
/**
 * atomic_inc_analt_zero() - atomic increment unless zero with full ordering
 * @v: pointer to atomic_t
 *
 * If (@v != 0), atomically updates @v to (@v + 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_inc_analt_zero() there.
 *
 * Return: @true if @v was updated, @false otherwise.
 */
static __always_inline bool
atomic_inc_analt_zero(atomic_t *v)
{
	kcsan_mb();
	instrument_atomic_read_write(v, sizeof(*v));
 ...
 * If (@v >= 0), atomically updates @v to (@v + 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_inc_unless_negative() there.
 *
 * Return: @true if @v was updated, @false otherwise.
 */
static __always_inline bool
 ...
 * If (@v <= 0), atomically updates @v to (@v - 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_dec_unless_positive() there.
 *
 * Return: @true if @v was updated, @false otherwise.
 */
static __always_inline bool
 ...
 * If (@v > 0), atomically updates @v to (@v - 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_dec_if_positive() there.
 *
 ...
 * Atomically loads the value of @v with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_read() there.
 *
 * Return: The value loaded from @v.
 */
 ...
 * Atomically loads the value of @v with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_read_acquire() there.
 *
 * Return: The value loaded from @v.
 */
static __always_inline s64
 ...
 * Atomically sets @v to @i with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_set() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically sets @v to @i with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_set_release() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v + @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_add() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v + @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_add_return() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_add_return_acquire() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_add_return_release() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_add_return_relaxed() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_add() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_add_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_add_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_add_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_sub() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v - @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_sub_return() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_sub_return_acquire() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_sub_return_release() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_sub_return_relaxed() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_sub() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_sub_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_sub_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_sub_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + 1) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_inc() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v + 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_inc_return() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + 1) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_inc_return_acquire() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + 1) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_inc_return_release() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + 1) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_inc_return_relaxed() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_inc() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + 1) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_inc_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + 1) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_inc_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v + 1) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_inc_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - 1) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_dec() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v - 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_dec_return() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - 1) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_dec_return_acquire() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - 1) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_dec_return_release() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - 1) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_dec_return_relaxed() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_dec() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - 1) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_dec_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - 1) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_dec_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v - 1) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_dec_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v & @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_and() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v & @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_and() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v & @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_and_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v & @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_and_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v & @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_and_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
...
/**
 * atomic64_andanalt() - atomic bitwise AND ANALT with relaxed ordering
 * @i: s64 value
 * @v: pointer to atomic64_t
 *
 * Atomically updates @v to (@v & ~@i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_andanalt() there.
 *
 * Return: Analthing.
 */
static __always_inline void
atomic64_andanalt(s64 i, atomic64_t *v)
{
	instrument_atomic_read_write(v, sizeof(*v));
...
/**
 * atomic64_fetch_andanalt() - atomic bitwise AND ANALT with full ordering
 * @i: s64 value
 * @v: pointer to atomic64_t
 *
 * Atomically updates @v to (@v & ~@i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_andanalt() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
atomic64_fetch_andanalt(s64 i, atomic64_t *v)
{
	kcsan_mb();
	instrument_atomic_read_write(v, sizeof(*v));
...
/**
 * atomic64_fetch_andanalt_acquire() - atomic bitwise AND ANALT with acquire ordering
 * @i: s64 value
 * @v: pointer to atomic64_t
 *
 * Atomically updates @v to (@v & ~@i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_andanalt_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
atomic64_fetch_andanalt_acquire(s64 i, atomic64_t *v)
{
	instrument_atomic_read_write(v, sizeof(*v));
...
/**
 * atomic64_fetch_andanalt_release() - atomic bitwise AND ANALT with release ordering
 * @i: s64 value
 * @v: pointer to atomic64_t
 *
 * Atomically updates @v to (@v & ~@i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_andanalt_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
atomic64_fetch_andanalt_release(s64 i, atomic64_t *v)
{
	kcsan_release();
	instrument_atomic_read_write(v, sizeof(*v));
...
/**
 * atomic64_fetch_andanalt_relaxed() - atomic bitwise AND ANALT with relaxed ordering
 * @i: s64 value
 * @v: pointer to atomic64_t
 *
 * Atomically updates @v to (@v & ~@i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_andanalt_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
atomic64_fetch_andanalt_relaxed(s64 i, atomic64_t *v)
{
	instrument_atomic_read_write(v, sizeof(*v));
 ...
 * Atomically updates @v to (@v | @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_or() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v | @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_or() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v | @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_or_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v | @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_or_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v | @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_or_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v ^ @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_xor() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v ^ @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_xor() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v ^ @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_xor_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v ^ @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_xor_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to (@v ^ @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_xor_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to @new with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_xchg() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to @new with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_xchg_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to @new with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_xchg_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Atomically updates @v to @new with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_xchg_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * If (@v == @old), atomically updates @v to @new with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_cmpxchg() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * If (@v == @old), atomically updates @v to @new with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_cmpxchg_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * If (@v == @old), atomically updates @v to @new with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_cmpxchg_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * If (@v == @old), atomically updates @v to @new with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_cmpxchg_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * Otherwise, updates @old to the current value of @v.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_try_cmpxchg() there.
 *
 * Return: @true if the exchange occured, @false otherwise.
 */
static __always_inline bool
 ...
 * Otherwise, updates @old to the current value of @v.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_try_cmpxchg_acquire() there.
 *
 * Return: @true if the exchange occured, @false otherwise.
 */
static __always_inline bool
 ...
 * Otherwise, updates @old to the current value of @v.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_try_cmpxchg_release() there.
 *
 * Return: @true if the exchange occured, @false otherwise.
 */
static __always_inline bool
 ...
 * Otherwise, updates @old to the current value of @v.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_try_cmpxchg_relaxed() there.
 *
 * Return: @true if the exchange occured, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v - @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_sub_and_test() there.
 *
 * Return: @true if the resulting value of @v is zero, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v - 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_dec_and_test() there.
 *
 * Return: @true if the resulting value of @v is zero, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_inc_and_test() there.
 *
 * Return: @true if the resulting value of @v is zero, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_add_negative() there.
 *
 * Return: @true if the resulting value of @v is negative, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_add_negative_acquire() there.
 *
 * Return: @true if the resulting value of @v is negative, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_add_negative_release() there.
 *
 * Return: @true if the resulting value of @v is negative, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_add_negative_relaxed() there.
 *
 * Return: @true if the resulting value of @v is negative, @false otherwise.
 */
static __always_inline bool
 ...
 * If (@v != @u), atomically updates @v to (@v + @a) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_fetch_add_unless() there.
 *
 * Return: The original value of @v.
 */
static __always_inline s64
 ...
 * If (@v != @u), atomically updates @v to (@v + @a) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_add_unless() there.
 *
 * Return: @true if @v was updated, @false otherwise.
 */
static __always_inline bool
...
/**
 * atomic64_inc_analt_zero() - atomic increment unless zero with full ordering
 * @v: pointer to atomic64_t
 *
 * If (@v != 0), atomically updates @v to (@v + 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_inc_analt_zero() there.
 *
 * Return: @true if @v was updated, @false otherwise.
 */
static __always_inline bool
atomic64_inc_analt_zero(atomic64_t *v)
{
	kcsan_mb();
	instrument_atomic_read_write(v, sizeof(*v));
 ...
 * If (@v >= 0), atomically updates @v to (@v + 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_inc_unless_negative() there.
 *
 * Return: @true if @v was updated, @false otherwise.
 */
static __always_inline bool
 ...
 * If (@v <= 0), atomically updates @v to (@v - 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_dec_unless_positive() there.
 *
 * Return: @true if @v was updated, @false otherwise.
 */
static __always_inline bool
 ...
 * If (@v > 0), atomically updates @v to (@v - 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic64_dec_if_positive() there.
 *
 * Return: The old value of (@v - 1), regardless of whether @v was updated.
 */
static __always_inline s64
 ...
 * Atomically loads the value of @v with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_read() there.
 *
 * Return: The value loaded from @v.
 */
 ...
 * Atomically loads the value of @v with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_read_acquire() there.
 *
 * Return: The value loaded from @v.
 */
static __always_inline long
 ...
 * Atomically sets @v to @i with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_set() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically sets @v to @i with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_set_release() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v + @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_add() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v + @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_add_return() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_add_return_acquire() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_add_return_release() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_add_return_relaxed() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_add() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_add_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_add_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_add_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_sub() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v - @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_sub_return() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_sub_return_acquire() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_sub_return_release() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_sub_return_relaxed() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_sub() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_sub_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_sub_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_sub_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + 1) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_inc() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v + 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_inc_return() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + 1) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_inc_return_acquire() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + 1) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_inc_return_release() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + 1) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_inc_return_relaxed() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_inc() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + 1) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_inc_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + 1) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_inc_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v + 1) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_inc_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - 1) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_dec() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v - 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_dec_return() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - 1) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_dec_return_acquire() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - 1) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_dec_return_release() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - 1) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_dec_return_relaxed() there.
 *
 * Return: The updated value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_dec() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - 1) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_dec_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - 1) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_dec_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v - 1) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_dec_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v & @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_and() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v & @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_and() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v & @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_and_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v & @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_and_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v & @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_and_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
...
/**
 * atomic_long_andanalt() - atomic bitwise AND ANALT with relaxed ordering
 * @i: long value
 * @v: pointer to atomic_long_t
 *
 * Atomically updates @v to (@v & ~@i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_andanalt() there.
 *
 * Return: Analthing.
 */
static __always_inline void
atomic_long_andanalt(long i, atomic_long_t *v)
{
	instrument_atomic_read_write(v, sizeof(*v));
	raw_atomic_long_andanalt(i, v);
}

/**
 * atomic_long_fetch_andanalt() - atomic bitwise AND ANALT with full ordering
 * @i: long value
 * @v: pointer to atomic_long_t
 *
 * Atomically updates @v to (@v & ~@i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_andanalt() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
atomic_long_fetch_andanalt(long i, atomic_long_t *v)
{
	kcsan_mb();
	instrument_atomic_read_write(v, sizeof(*v));
	return raw_atomic_long_fetch_andanalt(i, v);
}

/**
 * atomic_long_fetch_andanalt_acquire() - atomic bitwise AND ANALT with acquire ordering
 * @i: long value
 * @v: pointer to atomic_long_t
 *
 * Atomically updates @v to (@v & ~@i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_andanalt_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
atomic_long_fetch_andanalt_acquire(long i, atomic_long_t *v)
{
	instrument_atomic_read_write(v, sizeof(*v));
	return raw_atomic_long_fetch_andanalt_acquire(i, v);
}

/**
 * atomic_long_fetch_andanalt_release() - atomic bitwise AND ANALT with release ordering
 * @i: long value
 * @v: pointer to atomic_long_t
 *
 * Atomically updates @v to (@v & ~@i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_andanalt_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
atomic_long_fetch_andanalt_release(long i, atomic_long_t *v)
{
	kcsan_release();
	instrument_atomic_read_write(v, sizeof(*v));
	return raw_atomic_long_fetch_andanalt_release(i, v);
}

/**
 * atomic_long_fetch_andanalt_relaxed() - atomic bitwise AND ANALT with relaxed ordering
 * @i: long value
 * @v: pointer to atomic_long_t
 *
 * Atomically updates @v to (@v & ~@i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_andanalt_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
atomic_long_fetch_andanalt_relaxed(long i, atomic_long_t *v)
{
	instrument_atomic_read_write(v, sizeof(*v));
	return raw_atomic_long_fetch_andanalt_relaxed(i, v);
}
 ...
 * Atomically updates @v to (@v | @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_or() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v | @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_or() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v | @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_or_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v | @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_or_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v | @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_or_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v ^ @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_xor() there.
 *
 * Return: Analthing.
 */
static __always_inline void
 ...
 * Atomically updates @v to (@v ^ @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_xor() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v ^ @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_xor_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v ^ @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_xor_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to (@v ^ @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_xor_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to @new with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_xchg() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to @new with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_xchg_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to @new with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_xchg_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Atomically updates @v to @new with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_xchg_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * If (@v == @old), atomically updates @v to @new with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_cmpxchg() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * If (@v == @old), atomically updates @v to @new with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_cmpxchg_acquire() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * If (@v == @old), atomically updates @v to @new with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_cmpxchg_release() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * If (@v == @old), atomically updates @v to @new with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_cmpxchg_relaxed() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * Otherwise, updates @old to the current value of @v.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_try_cmpxchg() there.
 *
 * Return: @true if the exchange occured, @false otherwise.
 */
static __always_inline bool
 ...
 * Otherwise, updates @old to the current value of @v.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_try_cmpxchg_acquire() there.
 *
 * Return: @true if the exchange occured, @false otherwise.
 */
static __always_inline bool
 ...
 * Otherwise, updates @old to the current value of @v.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_try_cmpxchg_release() there.
 *
 * Return: @true if the exchange occured, @false otherwise.
 */
static __always_inline bool
 ...
 * Otherwise, updates @old to the current value of @v.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_try_cmpxchg_relaxed() there.
 *
 * Return: @true if the exchange occured, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v - @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_sub_and_test() there.
 *
 * Return: @true if the resulting value of @v is zero, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v - 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_dec_and_test() there.
 *
 * Return: @true if the resulting value of @v is zero, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_inc_and_test() there.
 *
 * Return: @true if the resulting value of @v is zero, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + @i) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_add_negative() there.
 *
 * Return: @true if the resulting value of @v is negative, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + @i) with acquire ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_add_negative_acquire() there.
 *
 * Return: @true if the resulting value of @v is negative, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + @i) with release ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_add_negative_release() there.
 *
 * Return: @true if the resulting value of @v is negative, @false otherwise.
 */
static __always_inline bool
 ...
 * Atomically updates @v to (@v + @i) with relaxed ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_add_negative_relaxed() there.
 *
 * Return: @true if the resulting value of @v is negative, @false otherwise.
 */
static __always_inline bool
 ...
 * If (@v != @u), atomically updates @v to (@v + @a) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_fetch_add_unless() there.
 *
 * Return: The original value of @v.
 */
static __always_inline long
 ...
 * If (@v != @u), atomically updates @v to (@v + @a) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_add_unless() there.
 *
 * Return: @true if @v was updated, @false otherwise.
 */
static __always_inline bool
...
/**
 * atomic_long_inc_analt_zero() - atomic increment unless zero with full ordering
 * @v: pointer to atomic_long_t
 *
 * If (@v != 0), atomically updates @v to (@v + 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_inc_analt_zero() there.
 *
 * Return: @true if @v was updated, @false otherwise.
 */
static __always_inline bool
atomic_long_inc_analt_zero(atomic_long_t *v)
{
	kcsan_mb();
	instrument_atomic_read_write(v, sizeof(*v));
	return raw_atomic_long_inc_analt_zero(v);
}
 ...
 * If (@v >= 0), atomically updates @v to (@v + 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_inc_unless_negative() there.
 *
 * Return: @true if @v was updated, @false otherwise.
 */
static __always_inline bool
 ...
 * If (@v <= 0), atomically updates @v to (@v - 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_dec_unless_positive() there.
 *
 * Return: @true if @v was updated, @false otherwise.
 */
static __always_inline bool
 ...
 * If (@v > 0), atomically updates @v to (@v - 1) with full ordering.
 *
 * Unsafe to use in analinstr code; use raw_atomic_long_dec_if_positive() there.
 *
 * Return: The old value of (@v - 1), regardless of whether @v was updated.
 */
static __always_inline long
