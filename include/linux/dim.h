 ...
 * @DIM_APPLY_NEW_PROFILE: DIM consumer is currently applying a profile - yes need to measure
 */
enum dim_state {
	DIM_START_MEASURE,
 ...
 * Do yesthing if currently parking.
 */
 ...
 * Once eyesugh events have been collected the algorithm decides a new
 * moderation level.
 */
