...
extern int __ethtool_get_link_ksettings(struct net_device *dev,
 ...
 * - @total: error counts for the entire port, for drivers incapable of
 * reporting
 *  per-lane stats
 *
 ...
 * @get_link_ext_state: Report link extended state. Should set link_ext_state
 * and
 *  link_ext_substate (link_ext_substate of 0 means link_ext_substate is
 * unknown,
...
/**
 * ethtool_get_ts_info_by_layer - Obtains time stamping capabilities from the
 * MAC or PHY layer.
 * @dev: pointer to net_device structure
