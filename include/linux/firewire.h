...
typedef void (*fw_transaction_callback_t)(struct fw_card *card, int rcode,
    ...
    void *callback_data);
typedef void (*fw_transaction_callback_with_tstamp_t)(struct fw_card *card,
    int rcode,
 ...
 *
 * The callback is responsible that fw_send_response() is called on the
 *@request, except for FCP
...
void __fw_send_request(struct fw_card *card, struct fw_transaction *t,
    int tcode,
...
/**
 * fw_send_request() - submit a request packet for transmission to generate
 ...
 *
 * A variation of __fw_send_request() to generate callback for response
 * subaction without time
 * stamp.
 */
static inline void fw_send_request(struct fw_card *card,
    struct fw_transaction *t, int tcode,
  ...
  __fw_send_request(card, t, tcode, destination_id, generation, speed, offset,
      payload,
      length, cb, false, callback_data);
}

/**
 * fw_send_request_with_tstamp() - submit a request packet for transmission to
 * generate callback for
 ...
 */
static inline void fw_send_request_with_tstamp(struct fw_card *card,
    struct fw_transaction *t,
    int tcode, int destination_id, int generation, int speed,
    unsigned long long offset,
    void *payload, size_t length,
    fw_transaction_callback_with_tstamp_t callback,
    void *callback_data) {
  union fw_transaction_callback cb = {
...
static inline int fw_stream_packet_destination_id(int tag, int channel,
    int sy) {
