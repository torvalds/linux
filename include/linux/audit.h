...
static inline void audit_set_context(struct task_struct *task,
...
extern void __audit_mq_sendrecv(mqd_t mqdes, size_t msg_len,
...
static inline void audit_mq_open(int oflag, umode_t mode,
    struct mq_attr *attr) {
  if (unlikely(!audit_dummy_context())) {
