...
/**
 * struct cs_dsp_alg_region - Describes a logical algorithm region in DSP
 * address space
 ...
 * @pre_run:    Called under the pwr_lock by cs_dsp_run() before the core is
 * started
 * @post_run:   Called under the pwr_lock by cs_dsp_run() after the core is
 * started
 * @pre_stop:   Called under the pwr_lock by cs_dsp_stop() before the core is
 * stopped
 * @post_stop:    Called under the pwr_lock by cs_dsp_stop() after the core is
 * stopped
 ...
 */
static inline bool cs_dsp_chunk_valid_addr(struct cs_dsp_chunk *ch,
    void *addr) {
