...
/* NVMe TCP connection offload params passed by driver to FW in NVMeTCP offload
 * ramrod */
...
/* NVMe TCP and TCP connection offload params passed by driver to FW in NVMeTCP
 * offload ramrod. */
...
/* NVMeTCP connection update params passed by driver to FW in NVMETCP update
 * ramrod. */
...
struct nvmetcp_db_data {
  u8 params;
#define NVMETCP_DB_DATA_DEST_MASK 0x3 /* destination of doorbell (use enum
                                       * db_dest) */
#define NVMETCP_DB_DATA_DEST_SHIFT 0
#define NVMETCP_DB_DATA_AGG_CMD_MASK 0x3 /* aggregative command to CM (use enum
                                          * db_agg_cmd_sel) */
