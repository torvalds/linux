...
#define __INIT_WORK_KEY(_work, _func, _onstack, _key)     \
  do {                \
    ...
    lockdep_init_map(&(_work)->lockdep_map, "(work_completion)"#_work, (_key), \
    0); \
 ...
 * for reasons and steps for converting system-wide workqueues into local
 * workqueues.
 */
extern void __warn_flushing_systemwide_wq(void)
__compiletime_warning("Please avoid flushing system-wide workqueues.");

/* Please stop using this function, for this function will be removed in near
 * future. */
