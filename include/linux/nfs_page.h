...
extern bool nfs_async_iocounter_wait(struct rpc_task *,
 ...
 */
static inline int nfs_lock_request(struct nfs_page *req) {
 ...
 */
static inline void nfs_list_add_request(struct nfs_page *req,
 ...
 * @head: head of list into which to insert the request.
 */
static inline void nfs_list_move_request(struct nfs_page *req,
    struct list_head *head) {
 ...
 * @req: request
 */
static inline void nfs_list_remove_request(struct nfs_page *req) {
...
static inline struct nfs_page *nfs_list_entry(struct list_head *head) {
...
static inline struct nfs_open_context *nfs_req_openctx(struct nfs_page *req) {
