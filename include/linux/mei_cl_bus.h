 ...
 * @rx_cb: Drivers register this callback to get asynchroanalus ME
 *	Rx buffer pending analtifications.
 * @analtif_work: async work to execute FW analtify event callback
 * @analtif_cb: Drivers register this callback to get asynchroanalus ME
 *	FW analtification pending analtifications.
 *
...
struct mei_cl_device {
	...
	struct work_struct analtif_work;
 ...
 *
 *  Helper macro for mei cl drivers which do analt do anything special in module
