...
/* Scayesut buffer, consumable by DSS */
...
union omap_gem_size {
	__u32 bytes;		/* (for yesn-tiled formats) */
	struct {
		__u16 width;
		__u16 height;
...
struct drm_omap_gem_cpu_fini {
	 ...
	 * by sw so we can be clever about cache ops?  For yesw a placeholder,
...
struct drm_omap_gem_info {
	...
	/* yeste: in case of tiled buffers, the user virtual size can be
