...
#define DRM_IOCTL_PANFROST_GET_BO_OFFSET  DRM_IOWR( \
    DRM_COMMAND_BASE + DRM_PANFROST_GET_BO_OFFSET, \
...
#define DRM_IOCTL_PANFROST_PERFCNT_ENABLE DRM_IOW( \
    DRM_COMMAND_BASE + DRM_PANFROST_PERFCNT_ENABLE, \
    struct drm_panfrost_perfcnt_enable)
#define DRM_IOCTL_PANFROST_PERFCNT_DUMP   DRM_IOW( \
    DRM_COMMAND_BASE + DRM_PANFROST_PERFCNT_DUMP, \
 ...
 */
#define PANFROST_MADV_WILLNEED 0  /* backing pages are needed, status returned
                                   * in 'retained' */
