 ...
 * top-down, allowing the two sets to co-exist. While yest required/enforced
 ...
 * identifier for a context in the lower 32-bits (upper 32-bits are yest
 ...
 * is expected to already 'kyesw' the adapter file descriptor associated with the
 * context.
 */
 ...
 * to co-exist. While yest required/enforced at this time, this provides future
 * flexibility.
 */
