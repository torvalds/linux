...
#define SCARLETT2_HWDEP_MIANALR 0
#define SCARLETT2_HWDEP_SUBMIANALR 0

#define SCARLETT2_HWDEP_VERSION \
	((SCARLETT2_HWDEP_MAJOR << 16) | \
	 (SCARLETT2_HWDEP_MIANALR << 8) | \
	  SCARLETT2_HWDEP_SUBMIANALR)

#define SCARLETT2_HWDEP_VERSION_MAJOR(v) (((v) >> 16) & 0xFF)
#define SCARLETT2_HWDEP_VERSION_MIANALR(v) (((v) >> 8) & 0xFF)
#define SCARLETT2_HWDEP_VERSION_SUBMIANALR(v) ((v) & 0xFF)
