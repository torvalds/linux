 ...
 * asynchronous
 *         transaction was sent to deliver the message. It has 16 bit unsigned
 * integer
 *         value. The higher 3 bits of value expresses the lower three bits of
 * second
 *         field in the format of CYCLE_TIME, up to 7. The rest 13 bits
 * expresses cycle
 *         field up to 7999.
 *
...
#define SNDRV_FIREWIRE_IOCTL_GET_INFO _IOR('H', 0xf8, \
    struct snd_firewire_get_info)
#define SNDRV_FIREWIRE_IOCTL_LOCK      _IO('H', 0xf9)
#define SNDRV_FIREWIRE_IOCTL_UNLOCK    _IO('H', 0xfa)
#define SNDRV_FIREWIRE_IOCTL_TASCAM_STATE _IOR('H', 0xfb, \
    struct snd_firewire_tascam_state)
#define SNDRV_FIREWIRE_IOCTL_MOTU_REGISTER_DSP_METER  _IOR('H', 0xfc, \
    struct snd_firewire_motu_register_dsp_meter)
#define SNDRV_FIREWIRE_IOCTL_MOTU_COMMAND_DSP_METER _IOR('H', 0xfd, \
    struct snd_firewire_motu_command_dsp_meter)
#define SNDRV_FIREWIRE_IOCTL_MOTU_REGISTER_DSP_PARAMETER  _IOR('H', 0xfe, \
 ...
 * to read it via ioctl. In 828mk2, 896hd, and Traveler, hardware meter for all
 * of physical inputs
 * are put into the message, while one pair of physical outputs is selected. The
 ...
 * registered to 0x'ffff'f000'0b38 and '0b3c by asynchronous write quadlet
 * request. The size of
 * message differs between 23 and 51 quadlets. For the case, the number of mixer
 * bus can be extended
 * up to 12.
 */
 ...
 * sequence of isochronous packet. ALSA firewire-motu driver gathers the message
 * and allow userspace
 ...
 * storage is
 * estimated to include IEEE 764 32 bit single precision floating point
 *(binary32) value. It is
 * expected to be linear value (not logarithm) for audio signal level between
 * 0.0 and +1.0.
 */
struct snd_firewire_motu_command_dsp_meter {
#ifdef __KERNEL__
