 ...
 * firmware. Core will igyesre this data.
 */
...
struct snd_soc_tplg_hw_config {
	...
	__u8 invert_bclk;	/* 1 for inverted BCLK, 0 for yesrmal */
	__u8 invert_fsync;	/* 1 for inverted frame clock, 0 for yesrmal */
...
struct snd_soc_tplg_dapm_widget {
	...
	__le32 reg;		/* negative reg = yes direct dapm */
	__le32 shift;		/* bits to shift */
	__le32 mask;		/* yesn-shifted mask */
	__le32 subseq;		/* sort within widget type */
	__le32 invert;		/* invert the power bit */
	__le32 igyesre_suspend;	/* kept enabled over suspend */
	__le16 event_flags;
	__le16 event_type;
