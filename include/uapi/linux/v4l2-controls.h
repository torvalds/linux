...
#define V4L2_CID_MPEG_AUDIO_DEC_MULTILINGUAL_PLAYBACK (V4L2_CID_CODEC_BASE \
  + 113)
...
#define V4L2_CID_MPEG_VIDEO_DECODER_SLICE_INTERFACE   (V4L2_CID_CODEC_BASE \
  + 212)
#define V4L2_CID_MPEG_VIDEO_DECODER_MPEG4_DEBLOCK_FILTER  (V4L2_CID_CODEC_BASE \
  + 213)
#define V4L2_CID_MPEG_VIDEO_CYCLIC_INTRA_REFRESH_MB   (V4L2_CID_CODEC_BASE \
  + 214)
...
#define V4L2_CID_MPEG_VIDEO_INTRA_REFRESH_PERIOD_TYPE (V4L2_CID_CODEC_BASE \
  + 237)
...
#define V4L2_CID_MPEG_VIDEO_H264_SEI_FRAME_PACKING    (V4L2_CID_CODEC_BASE \
  + 368)
#define V4L2_CID_MPEG_VIDEO_H264_SEI_FP_CURRENT_FRAME_0   (V4L2_CID_CODEC_BASE \
  + 369)
#define V4L2_CID_MPEG_VIDEO_H264_SEI_FP_ARRANGEMENT_TYPE  (V4L2_CID_CODEC_BASE \
  + 370)
...
#define V4L2_CID_MPEG_VIDEO_H264_FMO_CHANGE_DIRECTION (V4L2_CID_CODEC_BASE \
  + 374)
...
#define V4L2_CID_MPEG_VIDEO_H264_HIERARCHICAL_CODING    (V4L2_CID_CODEC_BASE \
  + 379)
#define V4L2_CID_MPEG_VIDEO_H264_HIERARCHICAL_CODING_TYPE (V4L2_CID_CODEC_BASE \
  + 380)
enum v4l2_mpeg_video_h264_hierarchical_coding_type {
  V4L2_MPEG_VIDEO_H264_HIERARCHICAL_CODING_B = 0,
  V4L2_MPEG_VIDEO_H264_HIERARCHICAL_CODING_P = 1,
};
#define V4L2_CID_MPEG_VIDEO_H264_HIERARCHICAL_CODING_LAYER  (V4L2_CID_CODEC_BASE \
  + 381)
...
#define V4L2_CID_MPEG_VIDEO_H264_CHROMA_QP_INDEX_OFFSET   (V4L2_CID_CODEC_BASE \
  + 384)
...
#define V4L2_CID_MPEG_VIDEO_VPX_GOLDEN_FRAME_REF_PERIOD (V4L2_CID_CODEC_BASE \
  + 505)
...
#define V4L2_CID_MPEG_VIDEO_HEVC_FRAME_RATE_RESOLUTION  (V4L2_CID_CODEC_BASE \
  + 617)
...
#define V4L2_CID_MPEG_VIDEO_HEVC_MAX_PARTITION_DEPTH  (V4L2_CID_CODEC_BASE \
  + 619)
...
#define V4L2_CID_MPEG_VIDEO_HEVC_LF_BETA_OFFSET_DIV2  (V4L2_CID_CODEC_BASE \
  + 621)
...
#define V4L2_CID_MPEG_VIDEO_HEVC_MAX_NUM_MERGE_MV_MINUS1  (V4L2_CID_CODEC_BASE \
  + 631)
...
#define V4L2_CID_MPEG_VIDEO_HEVC_SIZE_OF_LENGTH_FIELD (V4L2_CID_CODEC_BASE \
  + 635)
...
#define V4L2_CID_MPEG_VIDEO_HEVC_I_FRAME_MIN_QP        (V4L2_CID_CODEC_BASE \
  + 647)
#define V4L2_CID_MPEG_VIDEO_HEVC_I_FRAME_MAX_QP        (V4L2_CID_CODEC_BASE \
  + 648)
#define V4L2_CID_MPEG_VIDEO_HEVC_P_FRAME_MIN_QP        (V4L2_CID_CODEC_BASE \
  + 649)
#define V4L2_CID_MPEG_VIDEO_HEVC_P_FRAME_MAX_QP        (V4L2_CID_CODEC_BASE \
  + 650)
#define V4L2_CID_MPEG_VIDEO_HEVC_B_FRAME_MIN_QP        (V4L2_CID_CODEC_BASE \
  + 651)
#define V4L2_CID_MPEG_VIDEO_HEVC_B_FRAME_MAX_QP        (V4L2_CID_CODEC_BASE \
  + 652)
...
#define V4L2_CID_MPEG_MFC51_VIDEO_FRAME_SKIP_MODE     (V4L2_CID_CODEC_MFC51_BASE \
  + 2)
...
#define V4L2_CID_MPEG_MFC51_VIDEO_PADDING_YUV       (V4L2_CID_CODEC_MFC51_BASE \
  + 5)
...
#define V4L2_CID_CODEC_STATELESS_BASE          (V4L2_CTRL_CLASS_CODEC_STATELESS \
  | 0x900)
#define V4L2_CID_CODEC_STATELESS_CLASS         (V4L2_CTRL_CLASS_CODEC_STATELESS \
  | 1)
...
#define V4L2_CID_STATELESS_H264_SCALING_MATRIX  (V4L2_CID_CODEC_STATELESS_BASE \
  + 4)
/**
...
#define V4L2_CID_STATELESS_H264_PRED_WEIGHTS  (V4L2_CID_CODEC_STATELESS_BASE \
  + 5)
/**
...
#define V4L2_CID_STATELESS_H264_SLICE_PARAMS  (V4L2_CID_CODEC_STATELESS_BASE \
  + 6)
/**
...
#define V4L2_CID_STATELESS_MPEG2_QUANTISATION (V4L2_CID_CODEC_STATELESS_BASE \
  + 222)
/**
...
#define V4L2_CID_COLORIMETRY_HDR10_CLL_INFO (V4L2_CID_COLORIMETRY_CLASS_BASE \
  + 0)
 ...
 * the
 * chosen mode. If this syntax element is not present in the bitstream, users
 * should
 * pass its last value.
 ...
 * expressed in
 * pixels. This is not used during the decoding process but might be used by HW
 * scalers
 ...
 * which is
 * not capable of parsing the compressed header itself. Only drivers which need
 * it will
 * implement it.
 */
...
#define V4L2_CID_STATELESS_AV1_TILE_GROUP_ENTRY (V4L2_CID_CODEC_STATELESS_BASE \
  + 501)
/**
...
struct v4l2_av1_loop_restoration {
  ...
  __u8 lr_uv_shift;
  __u8 reserved;
  enum v4l2_av1_frame_restoration_type frame_restoration_type[
