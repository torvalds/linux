...
#define RXRPC_SECURITY_KEYRING    2 /* [srvr] set ring of server security keys
                                     * */
#define RXRPC_EXCLUSIVE_CONNECTION  3 /* Deprecated; use RXRPC_EXCLUSIVE_CALL
                                       * instead */
...
#define RXKADBADTICKET    19270407  /* security object was passed a bad ticket
                                     * */
#define RXKADUNKNOWNKEY   19270408  /* ticket contained unknown key version
                                     * number */
#define RXKADEXPIRED    19270409  /* authentication expired */
#define RXKADSEALEDINCON  19270410  /* sealed data inconsistent */
#define RXKADDATALEN    19270411  /* user data too long */
#define RXKADILLEGALLEVEL 19270412  /* caller not authorised to use encrypted
                                     * conns */
