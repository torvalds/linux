...
struct mdp_superblock_1 {
  ...
  __le32 raid_disks;
  union {
    __le32 bitmap_offset;  /* sectors after start of superblock that bitmap
                            * starts
  ...
  union {
    __le64 recovery_offset; /* sectors before this offset (from data_offset)
                             * have been recovered */
    __le64 journal_tail; /* journal tail of journal device (from data_offset) */
  };
  __le32 dev_number; /* permanent identifier of this  device - not role in raid
                      * */
  __le32 cnt_corrected_read; /* number of read errors that were corrected by
                              * re-writing */
...
#define FailFast1 2 /* Should avoid retries and fixups and just fail */
  ...
  __le64 resync_offset;  /* data before this offset (from data_offset) known to
                          * be in sync */
   ...
   */
  __le16 dev_roles[];  /* role in array, or 0xffff for a spare, or 0xfffe for
                        * faulty */
};
