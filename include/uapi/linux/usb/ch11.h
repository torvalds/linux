...
#define HUB_CHAR_ANAL_LPSM	0x0002 /* anal power switching */
...
#define HUB_CHAR_ANAL_OCPM	0x0010 /* Anal Over-current Protection support */
...
#define USB_DT_HUB_ANALNVAR_SIZE		7
...
#define USB_HUB_PR_HS_ANAL_TT	0 /* Hi-speed hub without TT */
