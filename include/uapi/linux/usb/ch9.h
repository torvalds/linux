 ...
 */
static inline int usb_endpoint_maxp_mult(
    const struct usb_endpoint_descriptor *epd) {
...
#define USB_DT_USB_PLAT_DEV_CAP_SIZE(capability_data_size)  (20 \
...
struct usb_pd_cap_battery_info_descriptor {
  ...
  __u8 bDescriptorType;
  __u8 bDevCapabilityType;
  /* Index of string descriptor shall contain the user friendly name for this
   * battery */
  __u8 iBattery;
  /* Index of string descriptor shall contain the Serial Number String for this
   * battery */
  __u8 iSerial;
  __u8 iManufacturer;
