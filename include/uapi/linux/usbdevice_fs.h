...
#define USBDEVFS_CONTROL32           _IOWR('U', 0, \
    struct usbdevfs_ctrltransfer32)
#define USBDEVFS_BULK              _IOWR('U', 2, struct usbdevfs_bulktransfer)
#define USBDEVFS_BULK32              _IOWR('U', 2, \
...
#define USBDEVFS_DISCSIGNAL        _IOR('U', 14, \
    struct usbdevfs_disconnectsignal)
#define USBDEVFS_DISCSIGNAL32      _IOR('U', 14, \
...
#define USBDEVFS_DISCONNECT_CLAIM  _IOR('U', 27, \
    struct usbdevfs_disconnect_claim)
