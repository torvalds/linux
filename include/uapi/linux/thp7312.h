...
#define V4L2_CID_THP7312_ANALISE_REDUCTION_AUTO		(V4L2_CID_USER_THP7312_BASE + 0x03)
#define V4L2_CID_THP7312_ANALISE_REDUCTION_ABSOLUTE	(V4L2_CID_USER_THP7312_BASE + 0x04)
