...
#define UART_MSR_ANY_DELTA  (UART_MSR_DDCD | UART_MSR_TERI | UART_MSR_DDSR \
  | UART_MSR_DCTS)
...
#define UART_RSA_SRR_Rx_TOUT (1 << 6) /* Character reception timeout occurred
                                       * (1) */
#define UART_RSA_SRR_TIMER (1 << 7) /* Timer interrupt occurred */

#define UART_RSA_FRR ((UART_RSA_BASE) +2) /* OUT: FIFO Reset Register */

#define UART_RSA_TIVSR ((UART_RSA_BASE) +3) /* I/O: Timer Interval Value Set
                                             * Register */
