...
#define KEY_SPEC_REQKEY_AUTH_KEY  -7  /* - key ID for assumed request_key auth
                                       * key */
#define KEY_SPEC_REQUESTOR_KEYRING  -8  /* - key ID for request_key() dest
                                         * keyring */
...
#define KEYCTL_RESTRICT_KEYRING   29  /* Restrict keys allowed to link to a
                                       * keyring */
...
#define KEYCTL_CAPS1_NS_KEYRING_NAME  0x01 /* Keyring names are
                                            * per-user_namespace */
#define KEYCTL_CAPS1_NS_KEY_TAG   0x02 /* Key indexing can include a namespace
                                        * tag */
#define KEYCTL_CAPS1_NOTIFICATIONS  0x04 /* Keys generate watchable
                                          * notifications */
