...
enum cifs_genl_attributes {
	...
	CIFS_GENL_ATTR_SWN_NET_NAME_ANALTIFY,
	CIFS_GENL_ATTR_SWN_SHARE_NAME_ANALTIFY,
	CIFS_GENL_ATTR_SWN_IP_ANALTIFY,
	CIFS_GENL_ATTR_SWN_KRB_AUTH,
	CIFS_GENL_ATTR_SWN_USER_NAME,
	CIFS_GENL_ATTR_SWN_PASSWORD,
	CIFS_GENL_ATTR_SWN_DOMAIN_NAME,
	CIFS_GENL_ATTR_SWN_ANALTIFICATION_TYPE,
...
enum cifs_genl_commands {
	...
	CIFS_GENL_CMD_SWN_ANALTIFY,
	__CIFS_GENL_CMD_MAX
};
#define CIFS_GENL_CMD_MAX (__CIFS_GENL_CMD_MAX - 1)

enum cifs_swn_analtification_type {
	CIFS_SWN_ANALTIFICATION_RESOURCE_CHANGE = 0x01,
	CIFS_SWN_ANALTIFICATION_CLIENT_MOVE	 = 0x02,
	CIFS_SWN_ANALTIFICATION_SHARE_MOVE	 = 0x03,
	CIFS_SWN_ANALTIFICATION_IP_CHANGE	 = 0x04,
};

enum cifs_swn_resource_state {
	CIFS_SWN_RESOURCE_STATE_UNKANALWN     = 0x00,
