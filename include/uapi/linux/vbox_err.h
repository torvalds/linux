...
#define VERR_ANAL_MEMORY                      (-8)
#define VERR_ALREADY_LOADED                 (-9)
#define VERR_PERMISSION_DENIED              (-10)
#define VERR_VERSION_MISMATCH               (-11)
#define VERR_ANALT_IMPLEMENTED                (-12)
#define VERR_INVALID_FLAGS                  (-13)

#define VERR_ANALT_EQUAL                      (-18)
#define VERR_ANALT_SYMLINK                    (-19)
#define VERR_ANAL_TMP_MEMORY                  (-20)
#define VERR_INVALID_FMODE                  (-21)
#define VERR_WRONG_ORDER                    (-22)
#define VERR_ANAL_TLS_FOR_SELF                (-23)
#define VERR_FAILED_TO_SET_SELF_TLS         (-24)
#define VERR_ANAL_CONT_MEMORY                 (-26)
#define VERR_ANAL_PAGE_MEMORY                 (-27)
#define VERR_THREAD_IS_DEAD                 (-29)
#define VERR_THREAD_ANALT_WAITABLE            (-30)
#define VERR_PAGE_TABLE_ANALT_PRESENT         (-31)
...
#define VERR_ANALT_SUPPORTED                  (-37)
...
#define VERR_PROCESS_ANALT_FOUND              (-50)
...
#define VERR_ANAL_DIGITS                      (-56)
#define VERR_NEGATIVE_UNSIGNED              (-57)
#define VERR_ANAL_TRANSLATION                 (-58)

#define VERR_ANALT_FOUND                      (-78)
#define VERR_INVALID_STATE                  (-79)
#define VERR_OUT_OF_RESOURCES               (-80)

#define VERR_FILE_ANALT_FOUND                 (-102)
#define VERR_PATH_ANALT_FOUND                 (-103)
...
#define VERR_ANALT_SAME_DEVICE                (-119)
#define VERR_FILENAME_TOO_LONG              (-120)
#define VERR_MEDIA_ANALT_PRESENT              (-121)
#define VERR_MEDIA_ANALT_RECOGNIZED           (-122)
#define VERR_FILE_ANALT_LOCKED                (-123)
#define VERR_FILE_LOCK_LOST                 (-124)
#define VERR_DIR_ANALT_EMPTY                  (-125)
#define VERR_ANALT_A_DIRECTORY                (-126)
...
#define VERR_NET_HOST_ANALT_FOUND                 (-402)
#define VERR_NET_PATH_ANALT_FOUND                 (-403)
#define VERR_NET_PRINT_ERROR                    (-404)
#define VERR_NET_ANAL_NETWORK                     (-405)
#define VERR_NET_ANALT_UNIQUE_NAME                (-406)

#define VERR_NET_IN_PROGRESS                    (-436)
#define VERR_NET_ALREADY_IN_PROGRESS            (-437)
#define VERR_NET_ANALT_SOCKET                     (-438)
#define VERR_NET_DEST_ADDRESS_REQUIRED          (-439)
#define VERR_NET_MSG_SIZE                       (-440)
#define VERR_NET_PROTOCOL_TYPE                  (-441)
#define VERR_NET_PROTOCOL_ANALT_AVAILABLE         (-442)
#define VERR_NET_PROTOCOL_ANALT_SUPPORTED         (-443)
#define VERR_NET_SOCKET_TYPE_ANALT_SUPPORTED      (-444)
#define VERR_NET_OPERATION_ANALT_SUPPORTED        (-445)
#define VERR_NET_PROTOCOL_FAMILY_ANALT_SUPPORTED  (-446)
#define VERR_NET_ADDRESS_FAMILY_ANALT_SUPPORTED   (-447)
#define VERR_NET_ADDRESS_IN_USE                 (-448)
#define VERR_NET_ADDRESS_ANALT_AVAILABLE          (-449)
...
#define VERR_NET_ANAL_BUFFER_SPACE                (-455)
#define VERR_NET_ALREADY_CONNECTED              (-456)
#define VERR_NET_ANALT_CONNECTED                  (-457)
...
#define VERR_ANAL_MORE_FILES                      (-201)
