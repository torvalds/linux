...
#define DEVLINK_FLASH_OVERWRITE_SETTINGS _BITUL( \
    DEVLINK_FLASH_OVERWRITE_SETTINGS_BIT)
#define DEVLINK_FLASH_OVERWRITE_IDENTIFIERS _BITUL( \
    DEVLINK_FLASH_OVERWRITE_IDENTIFIERS_BIT)
...
#define DEVLINK_PORT_FN_CAP_IPSEC_CRYPTO _BITUL( \
    DEVLINK_PORT_FN_ATTR_CAP_IPSEC_CRYPTO_BIT)
#define DEVLINK_PORT_FN_CAP_IPSEC_PACKET _BITUL( \
    DEVLINK_PORT_FN_ATTR_CAP_IPSEC_PACKET_BIT)
