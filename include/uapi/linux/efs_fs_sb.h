...
struct efs_super {
	...
	__be16		fs_cgisize;     /* bb's of iyesdes per cylinder group */
	...
	__be32		fs_tiyesde;      /* total free iyesdes */
	__be32		fs_bmblock;     /* bitmap location. */
	__be32		fs_replsb;      /* Location of replicated superblock. */
	__be32		fs_lastialloc;  /* last allocated iyesde */
...
struct efs_sb_info {
	...
	__u32	iyesde_free;	/* # of free iyesdes */
	__u16	iyesde_blocks;	/* # of blocks used for iyesdes in every grp */
