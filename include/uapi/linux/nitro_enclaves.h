...
/**
 * NE_ERR_MEM_REGION_ALREADY_USED - The user space memory region is already
 * used.
 */
...
/**
 * NE_ERR_INVALID_VCPU - The provided vCPU is out of range of the available
 * CPUs.
 */
...
/**
 * NE_ERR_INVALID_PAGE_SIZE - The user space memory region is not backed by
 * pages
 *            multiple of 2 MiB.
 */
...
/**
 * struct ne_enclave_start_info - Setup info necessary for enclave start (in /
 * out).
