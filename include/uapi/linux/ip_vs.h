...
#define IP_VS_SO_GET_DEST	(IP_VS_BASE_CTL+5)	/* yest used yesw */
...
#define IP_VS_CONN_F_LOCALNODE	0x0001		/* local yesde */
#define IP_VS_CONN_F_TUNNEL	0x0002		/* tunneling */
#define IP_VS_CONN_F_DROUTE	0x0003		/* direct routing */
#define IP_VS_CONN_F_BYPASS	0x0004		/* cache bypass */
#define IP_VS_CONN_F_SYNC	0x0020		/* entry created by sync */
#define IP_VS_CONN_F_HASHED	0x0040		/* hashed entry */
#define IP_VS_CONN_F_NOOUTPUT	0x0080		/* yes output packets */
#define IP_VS_CONN_F_INACTIVE	0x0100		/* yest established */
#define IP_VS_CONN_F_OUT_SEQ	0x0200		/* must do output seq adjust */
#define IP_VS_CONN_F_IN_SEQ	0x0400		/* must do input seq adjust */
#define IP_VS_CONN_F_SEQ_MASK	0x0600		/* in/out sequence mask */
#define IP_VS_CONN_F_NO_CPORT	0x0800		/* yes client port set yet */
#define IP_VS_CONN_F_TEMPLATE	0x1000		/* template, yest connection */
...
/* Flags that are yest sent to backup server start from bit 16 */
