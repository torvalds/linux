...
static inline void cec_msg_set_stream_path(struct cec_msg *msg,
    __u16 phys_addr) {
  msg->len = 4;
  msg->msg[0] |= 0xf; /* broadcast */
...
static inline void cec_msg_device_vendor_id(struct cec_msg *msg,
    __u32 vendor_id) {
  msg->len = 5;
  msg->msg[0] |= 0xf; /* broadcast */
...
static inline void cec_msg_reply_feature_abort(struct cec_msg *msg,
    __u8 reason) {
...
static inline void cec_ops_report_short_audio_descriptor(
...
static inline void cec_ops_request_short_audio_descriptor(
    const struct cec_msg *msg,
    __u8 *num_descriptors,
...
static inline void cec_ops_cdc_hec_request_deactivation(
    const struct cec_msg *msg,
    __u16 *phys_addr,
    __u16 *phys_addr1,
    __u16 *phys_addr2,
