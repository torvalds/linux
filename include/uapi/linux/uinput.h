 ...
 * old kernel that does yest support this ioctl.
 *
 * This ioctl may fail with -EINVAL if it is yest supported or if you passed
 * incorrect values, -ENOMEM if the kernel runs out of memory or -EFAULT if the
 * passed uinput_setup object canyest be read/written.
 ...
 *                  specified axis. If the axis is yest enabled via
