...
/* ivtv kanalws several distinct output modes: MPEG streaming,
   ...
   While in one mode, you cananalt use aanalther mode (EBUSY is returned).
   ...
   but for analw we have to do it this way. */
...
/* Select the passthrough mode (if the argument is analn-zero). In the passthrough
