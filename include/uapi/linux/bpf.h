 ...
 * user-space
 *    process is still processing a previous payload, then no notification is
 * needed
 ...
 *
 *    long (\*callback_fn)(struct bpf_map \*map, const void \*key, void \*value,
 * void \*ctx);
 *
 ...
 * This
 *    still holds true for cgroup/bind{4,6} which supports extra 'return 3'
 * success case.
 *
 *  Return
 *    0 on success, or a negative error in case of failure.
