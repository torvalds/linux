...
#define	PPP_ESCAPE	0x7d	/* Asynchroyesus Control Escape */
#define	PPP_TRANS	0x20	/* Asynchroyesus transparency modifier */
...
struct pppstat	{
    ...
    __u32	ppp_ioctects;	/* bytes received yest in error */
...
struct vjstat {
    ...
    __u32	vjs_errorin;	/* inbound unkyeswn type packets */
...
struct compstat {
    ...
    double	ratio;		/* yest computed in kernel. */
};
