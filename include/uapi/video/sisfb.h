...
#define VB_SINGLE_MODE    0x20000000  /* CRT1 or CRT2; determined by
                                       * DISPTYPE_CRTx */
#define VB_MIRROR_MODE    0x40000000  /* CRT1 + CRT2 identical (mirror mode) */
#define VB_DUALVIEW_MODE  0x80000000  /* CRT1 + CRT2 independent (dual head
                                       * mode) */

/* Aliases: */
#define CRT2_ENABLE   (CRT2_LCD | CRT2_TV | CRT2_VGA)
#define TV_STANDARD   (TV_NTSC | TV_PAL | TV_PALM | TV_PALN | TV_NTSCJ)
#define TV_INTERFACE    (TV_AVIDEO | TV_SVIDEO | TV_SCART | TV_HIVISION \
  | TV_YPBPR | TV_CHSCART | TV_CHYPBPR525I)
...
#define SISFB_ID    0x53495346    /* Identify myself with 'SISF' */
  ...
  __u8 sisfb_was_boot_device;  /* This card was the boot video device (ie is
                                * primary) */
...
#define SISFB_CMD_ERR_EARLY 0x80000002  /* request before sisfb took over gfx
                                         * system */
#define SISFB_CMD_ERR_NOVB  0x80000003  /* No video bridge */
#define SISFB_CMD_ERR_NOCRT2  0x80000004  /* can't change CRT1 status, CRT2
                                           * disabled */
/* more to come */
