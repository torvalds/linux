...
static inline struct drm_rect drm_plane_state_src(
...
static inline struct drm_rect drm_plane_state_dest(
    const struct drm_plane_state *state) {
...
/**
 * drmm_universal_plane_alloc - Allocate and initialize an universal plane
 * object
 * @dev: DRM device
 ...
 */
#define drmm_universal_plane_alloc(dev, type, member, possible_crtcs, funcs, \
      formats, \
