...
#define to_mipi_dsi_device(__dev) container_of_const(__dev, \
    struct mipi_dsi_device, \
    dev)
...
struct mipi_dsi_device *mipi_dsi_device_register_full(
  struct mipi_dsi_host *host,
  const struct mipi_dsi_device_info *info);
void mipi_dsi_device_unregister(struct mipi_dsi_device *dsi);
struct mipi_dsi_device *devm_mipi_dsi_device_register_full(struct device *dev,
    struct mipi_dsi_host *host,
    const struct mipi_dsi_device_info *info);
...
static inline struct mipi_dsi_driver *to_mipi_dsi_driver(
    struct device_driver *driver) {
...
static inline void mipi_dsi_set_drvdata(struct mipi_dsi_device *dsi,
    void *data) {
