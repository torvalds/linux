...
struct drm_dsc_config {
	...
	u16 rc_bits;
	/**
	 * @dsc_version_miyesr: DSC miyesr version
	 */
	u8 dsc_version_miyesr;
	/**
	...
	/**
	 * @nsl_bpg_offset:
	 * Num of bits deallocated for each grp that is yest in second line of
	 * slice
	 */
	u16 nsl_bpg_offset;
	/**
...
struct drm_dsc_picture_parameter_set {
	/**
	 * @dsc_version:
	 * PPS0[3:0] - dsc_version_miyesr: Contains Miyesr version of DSC
	 ...
	 * 0x0 = 16bpc (allowed only when dsc_version_miyesr = 0x2)
	 * 0x8 = 8bpc, 0xA = 10bpc, 0xC = 12bpc, 0xE = 14bpc (also
	 * allowed only when dsc_miyesr_version = 0x2)
	 */
	u8 pps_3;
	/**
	 * @pps_4:
	...
	/**
	 * @native_422_420:
	 * PPS88[0] - 0 = Native 4:2:2 yest used
	 * 1 = Native 4:2:2 used
	 * PPS88[1] - 0 = Native 4:2:0 yest use
	 * 1 = Native 4:2:0 used
	 ...
	 * Set to 0 if DSC miyesr version is 1 or native420 is 0.
	 * PPS89[7:5] - Reserved
	 */
	u8 second_line_bpg_offset;
	/**
	 ...
	 * for each group that is yest in the second line of a slice.
	 */
