...
struct drm_connector_funcs {
   ...
   * __drm_atomic_helper_connector_duplicate_state() to make sure shared state
   * is
...
#define DRM_CONNECTOR_POLL_DISCONNECT (1 << 2)
  ...
  /** @epoch_counter: used to detect any other changes in connector, besides
   * status */
  u64 epoch_counter;
...
static inline unsigned int drm_connector_index(
 ...
 */
static inline bool drm_connector_is_unregistered(
    struct drm_connector *connector) {
...
/**
 * drm_connector_for_each_possible_encoder - iterate connector's possible
 * encoders
