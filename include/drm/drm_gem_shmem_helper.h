...
static inline bool drm_gem_shmem_is_purgeable(
...
/**
 * drm_gem_shmem_object_print_info() - Print &drm_gem_shmem_object info for
 * debugfs
 * @p: DRM printer
 * @indent: Tab indentation level
 * @obj: GEM object
 *
 * This function wraps drm_gem_shmem_print_info(). Drivers that employ the shmem
 * helpers should
 * use this function as their &drm_gem_object_funcs.print_info handler.
 */
static inline void drm_gem_shmem_object_print_info(struct drm_printer *p,
    unsigned int indent,
...
/**
 * drm_gem_shmem_object_get_sg_table - GEM object function for
 * drm_gem_shmem_get_sg_table()
 * @obj: GEM object
 *
 * This function wraps drm_gem_shmem_get_sg_table(). Drivers that employ the
 * shmem helpers should
 ...
 * failure.
 */
static inline struct sg_table *drm_gem_shmem_object_get_sg_table(
 ...
 * store.
 *
 * This function wraps drm_gem_shmem_vmap(). Drivers that employ the shmem
 * helpers should
 ...
 *
 * This function wraps drm_gem_shmem_vunmap(). Drivers that employ the shmem
 * helpers should
 ...
 * 0 on success or a negative error code on failure.
 */
static inline int drm_gem_shmem_object_mmap(struct drm_gem_object *obj,
    struct vm_area_struct *vma) {
  struct drm_gem_shmem_object *shmem = to_drm_gem_shmem_obj(obj);
