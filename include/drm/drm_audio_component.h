...
/**
 * struct drm_audio_component_ops - Ops implemented by DRM driver, called by hda
 * driver
 */
...
/**
 * struct drm_audio_component_audio_ops - Ops implemented by hda driver, called
 * by DRM driver
 */
...
/**
 * struct drm_audio_component - Used for direct communication between DRM and
 * hda drivers
 */
struct drm_audio_component {
  /**
