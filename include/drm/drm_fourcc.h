 ...
 */
static inline bool drm_format_info_is_yuv_packed(
 ...
 */
static inline bool drm_format_info_is_yuv_semiplanar(
    const struct drm_format_info *info) {
 ...
 */
static inline bool drm_format_info_is_yuv_planar(
    const struct drm_format_info *info) {
 ...
 * sub-sampling.
 */
static inline bool drm_format_info_is_yuv_sampling_410(
    const struct drm_format_info *info) {
 ...
 * sub-sampling.
 */
static inline bool drm_format_info_is_yuv_sampling_411(
    const struct drm_format_info *info) {
 ...
 * sub-sampling.
 */
static inline bool drm_format_info_is_yuv_sampling_420(
    const struct drm_format_info *info) {
 ...
 * sub-sampling.
 */
static inline bool drm_format_info_is_yuv_sampling_422(
    const struct drm_format_info *info) {
 ...
 * sub-sampling.
 */
static inline bool drm_format_info_is_yuv_sampling_444(
    const struct drm_format_info *info) {
