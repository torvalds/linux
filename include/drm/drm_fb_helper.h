...
static inline struct drm_fb_helper *drm_fb_helper_from_client(
    struct drm_client_dev *client) {
...
static inline int drm_fb_helper_restore_fbdev_mode_unlocked(
    struct drm_fb_helper *fb_helper) {
  return 0;
}

static inline struct fb_info *drm_fb_helper_alloc_info(
    struct drm_fb_helper *fb_helper) {
  return NULL;
}
...
static inline void drm_fb_helper_unregister_info(
    struct drm_fb_helper *fb_helper) {
}

static inline void drm_fb_helper_fill_info(struct fb_info *info,
    struct drm_fb_helper *fb_helper,
    struct drm_fb_helper_surface_size *sizes) {
}
...
static inline void drm_fb_helper_set_suspend_unlocked(
    struct drm_fb_helper *fb_helper, bool suspend) {
}
