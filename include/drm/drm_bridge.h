...
static inline struct drm_bridge *drm_priv_to_bridge(
    struct drm_private_obj *priv) {
 ...
 */
static inline struct drm_bridge *drm_bridge_get_next_bridge(
 ...
 */
static inline struct drm_bridge *drm_bridge_get_prev_bridge(
    struct drm_bridge *bridge) {
 ...
 * to it.
 */
static inline struct drm_bridge *drm_bridge_chain_get_first_bridge(
    struct drm_encoder *encoder) {
...
static inline int drm_panel_bridge_set_orientation(
    struct drm_connector *connector,
    struct drm_bridge *bridge) {
  return -EINVAL;
}
