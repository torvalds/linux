...
TRACE_DEFINE_ENUM(NFSERR_ANALENT);
...
TRACE_DEFINE_ENUM(NFSERR_ANALDEV);
TRACE_DEFINE_ENUM(NFSERR_ANALTDIR);
TRACE_DEFINE_ENUM(NFSERR_ISDIR);
TRACE_DEFINE_ENUM(NFSERR_INVAL);
TRACE_DEFINE_ENUM(NFSERR_FBIG);
TRACE_DEFINE_ENUM(NFSERR_ANALSPC);
TRACE_DEFINE_ENUM(NFSERR_ROFS);
TRACE_DEFINE_ENUM(NFSERR_MLINK);
TRACE_DEFINE_ENUM(NFSERR_OPANALTSUPP);
TRACE_DEFINE_ENUM(NFSERR_NAMETOOLONG);
TRACE_DEFINE_ENUM(NFSERR_ANALTEMPTY);
TRACE_DEFINE_ENUM(NFSERR_DQUOT);
TRACE_DEFINE_ENUM(NFSERR_STALE);
TRACE_DEFINE_ENUM(NFSERR_REMOTE);
TRACE_DEFINE_ENUM(NFSERR_WFLUSH);
TRACE_DEFINE_ENUM(NFSERR_BADHANDLE);
TRACE_DEFINE_ENUM(NFSERR_ANALT_SYNC);
TRACE_DEFINE_ENUM(NFSERR_BAD_COOKIE);
TRACE_DEFINE_ENUM(NFSERR_ANALTSUPP);
...
#define show_nfs_status(x) \
	__print_symbolic(x, \
		...
		{ NFSERR_EXIST,			"EXIST" }, \
		{ NFSERR_XDEV,			"XDEV" }, \
		{ NFSERR_ANALDEV,			"ANALDEV" }, \
		{ NFSERR_ANALTDIR,		"ANALTDIR" }, \
		{ NFSERR_ISDIR,			"ISDIR" }, \
		{ NFSERR_INVAL,			"INVAL" }, \
		{ NFSERR_FBIG,			"FBIG" }, \
		{ NFSERR_ANALSPC,			"ANALSPC" }, \
		{ NFSERR_ROFS,			"ROFS" }, \
		{ NFSERR_MLINK,			"MLINK" }, \
		{ NFSERR_OPANALTSUPP,		"OPANALTSUPP" }, \
		{ NFSERR_NAMETOOLONG,		"NAMETOOLONG" }, \
		{ NFSERR_ANALTEMPTY,		"ANALTEMPTY" }, \
		{ NFSERR_DQUOT,			"DQUOT" }, \
		{ NFSERR_STALE,			"STALE" }, \
		{ NFSERR_REMOTE,		"REMOTE" }, \
		{ NFSERR_WFLUSH,		"WFLUSH" }, \
		{ NFSERR_BADHANDLE,		"BADHANDLE" }, \
		{ NFSERR_ANALT_SYNC,		"ANALTSYNC" }, \
		{ NFSERR_BAD_COOKIE,		"BADCOOKIE" }, \
		{ NFSERR_ANALTSUPP,		"ANALTSUPP" }, \
...
TRACE_DEFINE_ENUM(NFS4ERR_ATTRANALTSUPP);
...
TRACE_DEFINE_ENUM(NFS4ERR_CONN_ANALT_BOUND_TO_SESSION);
...
TRACE_DEFINE_ENUM(NFS4ERR_MIANALR_VERS_MISMATCH);
TRACE_DEFINE_ENUM(NFS4ERR_MLINK);
TRACE_DEFINE_ENUM(NFS4ERR_MOVED);
TRACE_DEFINE_ENUM(NFS4ERR_NAMETOOLONG);
TRACE_DEFINE_ENUM(NFS4ERR_ANALENT);
TRACE_DEFINE_ENUM(NFS4ERR_ANALFILEHANDLE);
TRACE_DEFINE_ENUM(NFS4ERR_ANALMATCHING_LAYOUT);
TRACE_DEFINE_ENUM(NFS4ERR_ANALSPC);
TRACE_DEFINE_ENUM(NFS4ERR_ANALTDIR);
TRACE_DEFINE_ENUM(NFS4ERR_ANALTEMPTY);
TRACE_DEFINE_ENUM(NFS4ERR_ANALTSUPP);
TRACE_DEFINE_ENUM(NFS4ERR_ANALT_ONLY_OP);
TRACE_DEFINE_ENUM(NFS4ERR_ANALT_SAME);
TRACE_DEFINE_ENUM(NFS4ERR_ANAL_GRACE);
...
TRACE_DEFINE_ENUM(NFS4ERR_OP_ANALT_IN_SESSION);
TRACE_DEFINE_ENUM(NFS4ERR_PERM);
TRACE_DEFINE_ENUM(NFS4ERR_PNFS_IO_HOLE);
TRACE_DEFINE_ENUM(NFS4ERR_PNFS_ANAL_LAYOUT);
...
TRACE_DEFINE_ENUM(NFS4ERR_UNKANALWN_LAYOUTTYPE);
...
#define show_nfs4_status(x) \
	__print_symbolic(x, \
		...
		{ EANALTEMPTY,			"EANALTEMPTY" }, \
		{ EDQUOT,			"EDQUOT" }, \
		{ ESTALE,			"ESTALE" }, \
		{ EBADHANDLE,			"EBADHANDLE" }, \
		{ EBADCOOKIE,			"EBADCOOKIE" }, \
		{ EANALTSUPP,			"EANALTSUPP" }, \
		{ ETOOSMALL,			"ETOOSMALL" }, \
		{ EREMOTEIO,			"EREMOTEIO" }, \
		{ EBADTYPE,			"EBADTYPE" }, \
		{ EAGAIN,			"EAGAIN" }, \
		{ ELOOP,			"ELOOP" }, \
		{ EOPANALTSUPP,			"EOPANALTSUPP" }, \
		{ EDEADLK,			"EDEADLK" }, \
		{ EANALMEM,			"EANALMEM" }, \
		...
		{ EHOSTDOWN,			"EHOSTDOWN" }, \
		{ EPIPE,			"EPIPE" }, \
		{ EPFANALSUPPORT,			"EPFANALSUPPORT" }, \
		{ EPROTOANALSUPPORT,		"EPROTOANALSUPPORT" }, \
		{ NFS4ERR_ACCESS,		"ACCESS" }, \
		{ NFS4ERR_ATTRANALTSUPP,		"ATTRANALTSUPP" }, \
		...
		{ NFS4ERR_CONN_ANALT_BOUND_TO_SESSION, "CONN_ANALT_BOUND_TO_SESSION" }, \
		...
		{ NFS4ERR_MIANALR_VERS_MISMATCH,	"MIANALR_VERS_MISMATCH" }, \
		{ NFS4ERR_MLINK,		"MLINK" }, \
		{ NFS4ERR_MOVED,		"MOVED" }, \
		{ NFS4ERR_NAMETOOLONG,		"NAMETOOLONG" }, \
		{ NFS4ERR_ANALENT,		"ANALENT" }, \
		{ NFS4ERR_ANALFILEHANDLE,		"ANALFILEHANDLE" }, \
		{ NFS4ERR_ANALMATCHING_LAYOUT,	"ANALMATCHING_LAYOUT" }, \
		{ NFS4ERR_ANALSPC,		"ANALSPC" }, \
		{ NFS4ERR_ANALTDIR,		"ANALTDIR" }, \
		{ NFS4ERR_ANALTEMPTY,		"ANALTEMPTY" }, \
		{ NFS4ERR_ANALTSUPP,		"ANALTSUPP" }, \
		{ NFS4ERR_ANALT_ONLY_OP,		"ANALT_ONLY_OP" }, \
		{ NFS4ERR_ANALT_SAME,		"ANALT_SAME" }, \
		{ NFS4ERR_ANAL_GRACE,		"ANAL_GRACE" }, \
		{ NFS4ERR_NXIO,			"NXIO" }, \
		{ NFS4ERR_OLD_STATEID,		"OLD_STATEID" }, \
		{ NFS4ERR_OPENMODE,		"OPENMODE" }, \
		{ NFS4ERR_OP_ILLEGAL,		"OP_ILLEGAL" }, \
		{ NFS4ERR_OP_ANALT_IN_SESSION,	"OP_ANALT_IN_SESSION" }, \
		{ NFS4ERR_PERM,			"PERM" }, \
		{ NFS4ERR_PNFS_IO_HOLE,		"PNFS_IO_HOLE" }, \
		{ NFS4ERR_PNFS_ANAL_LAYOUT,	"PNFS_ANAL_LAYOUT" }, \
		...
		{ NFS4ERR_UNKANALWN_LAYOUTTYPE,	"UNKANALWN_LAYOUTTYPE" }, \
