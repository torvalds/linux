...
TRACE_EVENT(btrfs_flush_space,
    ...
    TP_printk_btrfs(
    "state=%d(%s) flags=%llu(%s) num_bytes=%llu ret=%d for_preempt=%d",
    __entry->state,
...
TRACE_EVENT(find_free_extent_search_loop,
    ...
    TP_printk_btrfs(
    "root=%llu(%s) len=%llu empty_size=%llu flags=%llu(%s) loop=%llu",
    show_root_type(__entry->root_objectid),
    __entry->num_bytes, __entry->empty_size, __entry->flags,
...
TRACE_EVENT(qgroup_update_counters,
    ...
    TP_printk_btrfs(
    "qgid=%llu old_rfer=%llu old_excl=%llu cur_old_count=%llu cur_new_count=%llu",
...
DECLARE_EVENT_CLASS(btrfs__prelim_ref,
    ...
    TP_printk_btrfs(
    "root_id=%llu key=[%llu,%u,%llu] level=%d count=[%d+%d=%d] parent=%llu wanted_disk_byte=%llu nodes=%llu",
    __entry->root_id,
