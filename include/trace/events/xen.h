...
DECLARE_EVENT_CLASS(xen_mmu__set_pte,
    ...
    __entry->ptep,
    (int) sizeof(pteval_t) * 2,
    (unsigned long long) pte_val(native_make_pte(__entry->pteval)),
...
TRACE_EVENT(xen_mmu_set_pmd,
    ...
    __entry->pmdp,
    (int) sizeof(pmdval_t) * 2,
    (unsigned long long) pmd_val(native_make_pmd(__entry->pmdval)),
...
TRACE_EVENT(xen_mmu_set_pud,
    ...
    __entry->pudp,
    (int) sizeof(pudval_t) * 2,
    (unsigned long long) pud_val(native_make_pud(__entry->pudval)),
...
TRACE_EVENT(xen_mmu_set_p4d,
    ...
    (int) sizeof(p4dval_t) * 2,
    (unsigned long long) pgd_val(native_make_pgd(__entry->p4dval)),
...
TRACE_EVENT(xen_mmu_set_pud,
    ...
    __entry->pudp,
    (int) sizeof(pudval_t) * 2,
    (unsigned long long) pgd_val(native_make_pgd(__entry->pudval)),
    (int) sizeof(pudval_t) * 2, (unsigned long long) __entry->pudval)
    );
