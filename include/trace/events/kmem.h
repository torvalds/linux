...
TRACE_EVENT(kmem_cache_alloc,
    ...
    TP_printk(
    "call_site=%pS ptr=%p bytes_req=%zu bytes_alloc=%zu gfp_flags=%s node=%d accounted=%s",
...
TRACE_EVENT(kmalloc,
    ...
    && (__entry->gfp_flags
    & (__force unsigned long) __GFP_ACCOUNT)) ? "true" : "false")
    );
...
TRACE_EVENT(mm_page_alloc_extfrag,
    ...
    TP_printk(
    "page=%p pfn=0x%lx alloc_order=%d fallback_order=%d pageblock_order=%d alloc_migratetype=%d fallback_migratetype=%d fragmenting=%d change_ownership=%d",
    pfn_to_page(__entry->pfn),
    __entry->pfn,
    __entry->alloc_order,
...
TRACE_EVENT(mm_alloc_contig_migrate_range_info,
    ...
    TP_printk(
    "start=0x%lx end=0x%lx migratetype=%d nr_migrated=%lu nr_reclaimed=%lu nr_mapped=%lu",
    __entry->start,
    __entry->end,
    __entry->migratetype,
    __entry->nr_migrated,
