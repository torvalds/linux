...
DECLARE_EVENT_CLASS(irq_matrix_global_update,
    ...
    TP_printk(
    "bit=%d online_maps=%d global_avl=%u, global_rsvd=%u, total_alloc=%u",
...
DECLARE_EVENT_CLASS(irq_matrix_cpu,
    ...
    TP_printk(
    "bit=%d cpu=%u online=%d avl=%u alloc=%u managed=%u online_maps=%u global_avl=%u, global_rsvd=%u, total_alloc=%u",
