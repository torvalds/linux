...
TRACE_EVENT(sock_exceed_buf_limit,
    ...
    TP_printk(
    "proto:%s sysctl_mem=%ld,%ld,%ld allocated=%ld sysctl_rmem=%d rmem_alloc=%d sysctl_wmem=%d wmem_alloc=%d wmem_queued=%d kind=%s",
    __entry->name,
...
#endif
{
  ...
  ipv6_addr_set_v4mapped(inet->inet_daddr, pin6);
    ...
    TP_printk(
    "family=%s protocol=%s sport=%hu dport=%hu saddr=%pI4 daddr=%pI4 saddrv6=%pI6c daddrv6=%pI6c oldstate=%s newstate=%s",
...
#endif
{
  ...
  ipv6_addr_set_v4mapped(inet->inet_daddr, pin6);
    ...
    TP_printk(
    "family=%s protocol=%s sport=%hu dport=%hu saddr=%pI4 daddr=%pI4 saddrv6=%pI6c daddrv6=%pI6c error=%d",
    show_family_name(__entry->family),
    show_inet_protocol_name(__entry->protocol),
    __entry->sport, __entry->dport,
    __entry->saddr, __entry->daddr,
...
DECLARE_EVENT_CLASS(sock_msg_length,
    ...
    TP_printk(
    "sk address = %p, family = %s protocol = %s, length = %d, error = %d, flags = 0x%x",
