...
TRACE_EVENT(fsi_master_acf_send_request,
    TP_PROTO(const struct fsi_master_acf *master, const struct fsi_msg *cmd,
    u8 rbits),
...
TRACE_EVENT(fsi_master_acf_copro_response,
    TP_PROTO(const struct fsi_master_acf *master, u8 rtag, u8 rcrc,
    __be32 rdata, bool crc_ok),
