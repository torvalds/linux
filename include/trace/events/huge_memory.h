...
TRACE_EVENT(mm_khugepaged_scan_pmd,
    ...
    TP_printk(
    "mm=%p, scan_pfn=0x%lx, writable=%d, referenced=%d, none_or_zero=%d, status=%s, unmapped=%d",
    __entry->mm,
    __entry->pfn,
    __entry->writable,
    __entry->referenced,
...
TRACE_EVENT(mm_collapse_huge_page_isolate,
    ...
    TP_printk(
    "scan_pfn=0x%lx, none_or_zero=%d, referenced=%d, writable=%d, status=%s",
    __entry->pfn,
    __entry->none_or_zero,
    __entry->referenced,
    __entry->writable,
...
TRACE_EVENT(mm_khugepaged_scan_file,
    ...
    TP_printk(
    "mm=%p, scan_pfn=0x%lx, filename=%s, present=%d, swap=%d, result=%s",
    __entry->mm,
    __entry->pfn,
    __get_str(filename),
    __entry->present,
...
TRACE_EVENT(mm_khugepaged_collapse_file,
    ...
    TP_printk(
    "mm=%p, hpage_pfn=0x%lx, index=%ld, addr=%ld, is_shmem=%d, filename=%s, nr=%d, result=%s",
    __entry->mm,
    __entry->hpfn,
    __entry->index,
    __entry->addr,
