...
#define AT91_SFRBU_PSWBU      (0x00)    /* SFRBU Power Switch BU Control
                                         * Register */
#define   AT91_SFRBU_PSWBU_PSWKEY   (0x4BD20C << 8) /* Specific value mandatory
                                                     * to allow writing of other
                                                     * register bits */
#define   AT91_SFRBU_PSWBU_STATE    (1 << 2)  /* Power switch BU state */
#define   AT91_SFRBU_PSWBU_SOFTSWITCH (1 << 1)  /* Power switch BU source
                                                 * selection */
#define   AT91_SFRBU_PSWBU_CTRL   (1 << 0)  /* Power switch BU control */

#define AT91_SFRBU_25LDOCR      (0x0C)    /* SFRBU 2.5V LDO Control Register */
#define   AT91_SFRBU_25LDOCR_LDOANAKEY  (0x3B6E18 << 8) /* Specific value
                                                         * mandatory to allow
                                                         * writing of other
                                                         * register bits. */
