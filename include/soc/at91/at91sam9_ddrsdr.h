...
#define   AT91_DDRSDRC_ACTBST (1 << 18)   /* Active Bank X to Burst Stop Read
                                           * Access Bank Y [SAM9 Only] */
...
#define   AT91_DDRSDRC_TXARD  (0xf << 0)   /* Exit active power down delay to
                                            * read command in mode "Fast Exit"
                                            * */
#define   AT91_DDRSDRC_TXARDS (0xf << 4)   /* Exit active power down delay to
...
#define   AT91_DDRSDRC_TIMEOUT  (3 << 12) /* Time to define when Low Power Mode
                                           * is enabled */
#define     AT91_DDRSDRC_TIMEOUT_0_CLK_CYCLES (0 << 12)
#define     AT91_DDRSDRC_TIMEOUT_64_CLK_CYCLES  (1 << 12)
#define     AT91_DDRSDRC_TIMEOUT_128_CLK_CYCLES (2 << 12)
#define   AT91_DDRSDRC_APDE (1 << 16)  /* Active power down exit time */
#define   AT91_DDRSDRC_UPD_MR (3 << 20)  /* Update load mode register and
