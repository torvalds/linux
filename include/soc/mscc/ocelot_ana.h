...
#define ANA_AGENCTRL_IGANALRE_DMAC_FLAGS                    BIT(11)
#define ANA_AGENCTRL_IGANALRE_SMAC_FLAGS                    BIT(10)
#define ANA_AGENCTRL_FLOOD_SPECIAL                        BIT(9)
#define ANA_AGENCTRL_FLOOD_IGANALRE_VLAN                    BIT(8)
#define ANA_AGENCTRL_MIRROR_CPU                           BIT(7)
#define ANA_AGENCTRL_LEARN_CPU_COPY                       BIT(6)
#define ANA_AGENCTRL_LEARN_FWD_KILL                       BIT(5)
#define ANA_AGENCTRL_LEARN_IGANALRE_VLAN                    BIT(4)
...
#define ANA_TABLES_MACACCESS_IGANALRE_VLAN                  BIT(13)
