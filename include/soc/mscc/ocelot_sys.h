...
#define SYS_STAT_CFG_STAT_CLEAR_SHOT(x)                   (((x) << \
    10) & GENMASK(16, 10))
#define SYS_STAT_CFG_STAT_CLEAR_SHOT_M                    GENMASK(16, 10)
#define SYS_STAT_CFG_STAT_CLEAR_SHOT_X(x)                 (((x) \
  & GENMASK(16, 10)) >> 10)
...
#define SYS_MAC_FC_CFG_FC_LINK_SPEED(x)                   (((x) << \
    26) & GENMASK(27, 26))
#define SYS_MAC_FC_CFG_FC_LINK_SPEED_M                    GENMASK(27, 26)
#define SYS_MAC_FC_CFG_FC_LINK_SPEED_X(x)                 (((x) \
  & GENMASK(27, 26)) >> 26)
#define SYS_MAC_FC_CFG_FC_LATENCY_CFG(x)                  (((x) << \
    20) & GENMASK(25, 20))
#define SYS_MAC_FC_CFG_FC_LATENCY_CFG_M                   GENMASK(25, 20)
#define SYS_MAC_FC_CFG_FC_LATENCY_CFG_X(x)                (((x) \
  & GENMASK(25, 20)) >> 20)
...
#define SYS_EVENTS_DIF_EV_DRX(x)                          (((x) << \
    6) & GENMASK(8, 6))
#define SYS_EVENTS_DIF_EV_DRX_M                           GENMASK(8, 6)
#define SYS_EVENTS_DIF_EV_DRX_X(x)                        (((x) \
  & GENMASK(8, 6)) >> 6)
...
#define SYS_PTP_STATUS_PTP_MESS_ID(x)                     (((x) << \
    21) & GENMASK(26, 21))
#define SYS_PTP_STATUS_PTP_MESS_ID_M                      GENMASK(26, 21)
#define SYS_PTP_STATUS_PTP_MESS_ID_X(x)                   (((x) \
  & GENMASK(26, 21)) >> 21)
#define SYS_PTP_STATUS_PTP_MESS_TXPORT(x)                 (((x) << \
    16) & GENMASK(20, 16))
#define SYS_PTP_STATUS_PTP_MESS_TXPORT_M                  GENMASK(20, 16)
#define SYS_PTP_STATUS_PTP_MESS_TXPORT_X(x)               (((x) \
  & GENMASK(20, 16)) >> 16)
...
#define SYS_PTP_CFG_PTP_STAMP_WID(x)                      (((x) << \
    2) & GENMASK(7, 2))
#define SYS_PTP_CFG_PTP_STAMP_WID_M                       GENMASK(7, 2)
#define SYS_PTP_CFG_PTP_STAMP_WID_X(x)                    (((x) \
  & GENMASK(7, 2)) >> 2)
