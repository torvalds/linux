 ...
 */
#define OCELOT_VCAP_ES0_TAG_8021Q_RXVLAN(ocelot, port, \
      upstream) ((upstream) << 16 | (port))
#define OCELOT_VCAP_IS1_TAG_8021Q_TXVLAN(ocelot, port)    (port)
#define OCELOT_VCAP_IS2_TAG_8021Q_TXVLAN(ocelot, port)    (port)
#define OCELOT_VCAP_IS2_MRP_REDIRECT(ocelot, \
      port)    ((ocelot)->num_phys_ports + (port))
#define OCELOT_VCAP_IS2_MRP_TRAP(ocelot)      ((ocelot)->num_phys_ports * 2)
#define OCELOT_VCAP_IS2_L2_PTP_TRAP(ocelot)     ((ocelot)->num_phys_ports * 2 \
  + 1)
#define OCELOT_VCAP_IS2_IPV4_GEN_PTP_TRAP(ocelot)   ((ocelot)->num_phys_ports \
  * 2 + 2)
#define OCELOT_VCAP_IS2_IPV4_EV_PTP_TRAP(ocelot)    ((ocelot)->num_phys_ports \
  * 2 + 3)
#define OCELOT_VCAP_IS2_IPV6_GEN_PTP_TRAP(ocelot)   ((ocelot)->num_phys_ports \
  * 2 + 4)
#define OCELOT_VCAP_IS2_IPV6_EV_PTP_TRAP(ocelot)    ((ocelot)->num_phys_ports \
  * 2 + 5)
...
struct ocelot_vcap_filter *ocelot_vcap_block_find_filter_by_id(
