 ...
 * the wrong signature.
 */
#define ACPI_SIG_AGDI           "AGDI"  /* Arm Generic Diagnostic Dump and Reset
                                         * Device Interface */
...
#define ACPI_IORT_NODE_COHERENT         0x00000001  /* The device node is fully
                                                     * coherent */
#define ACPI_IORT_NODE_NOT_COHERENT     0x00000000  /* The device node is not
                                                     * coherent */
...
#define ACPI_IORT_PRI_SUPPORTED         (1 << 1)  /* The root complex PRI
                                                   * support */
#define ACPI_IORT_PASID_FWD_SUPPORTED   (1 << 2)  /* The root complex PASID
                                                   * forward support */
...
#define ACPI_IORT_SMMU_V3_HISILICON_HI161X  0x00000001  /* hi_silicon Hi161x
                                                         * SMMUv3 */
...
#define ACPI_IVRS_VIRTUAL_SIZE      0x003F8000  /* 7 bits, virtual address size
                                                 * */
#define ACPI_IVRS_ATS_RESERVED      0x00400000  /* ATS address translation range
                                                 * reserved */
...
#define ACPI_MADT_VGIC_IRQ_MODE         (1 << 2)  /* 02: VGIC Maintenance
                                                   * Interrupt mode */
#define ACPI_MADT_GICC_ONLINE_CAPABLE   (1 << 3)  /* 03: Processor is online
                                                   * capable  */
#define ACPI_MADT_GICC_NON_COHERENT     (1 << 4)  /* 04: GIC redistributor is
                                                   * not coherent */
...
struct acpi_madt_multiproc_wakeup_mailbox {
  ...
  u8 reserved_firmware[ACPI_MULTIPROC_WAKEUP_MB_FIRMWARE_SIZE]; /* reserved for
                                                                 * firmware use
                                                                 * */
};
...
#define ACPI_NFIT_PROXIMITY_VALID       (1 << 1)  /* 01: Proximity Domain Valid
                                                   * */
#define ACPI_NFIT_LOCATION_COOKIE_VALID (1 << 2)  /* 02: SPA location cookie
                                                   * valid (ACPI 6.4) */
...
#define ACPI_NFIT_MEM_SAVE_FAILED       (1) /* 00: Last SAVE to Memory Device
                                             * failed */
...
#define ACPI_NFIT_CONTROL_MFG_INFO_VALID    (1) /* Manufacturing fields are
                                                 * valid */
...
#define ACPI_PPTT_CACHE_READ_ALLOCATE       (0x0) /* Cache line is allocated on
                                                   * read */
...
#define ACPI_PPTT_CACHE_RW_ALLOCATE         (0x02)  /* Cache line is allocated
                                                     * on read and write */
#define ACPI_PPTT_CACHE_RW_ALLOCATE_ALT     (0x03)  /* Alternate representation
                                                     * of above */
