...
#define AE_CODE_PROGRAMMER              0x1000  /* External ACPICA interface
                                                 * caller */
 ...
 */
#define EXCEP_ENV(code)                 ((acpi_status) (code \
  | AE_CODE_ENVIRONMENTAL))
#define EXCEP_PGM(code)                 ((acpi_status) (code \
  | AE_CODE_PROGRAMMER))
#define EXCEP_TBL(code)                 ((acpi_status) (code \
  | AE_CODE_ACPI_TABLES))
