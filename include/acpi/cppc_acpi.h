...
extern unsigned int cppc_perf_to_khz(struct cppc_perf_caps *caps,
    unsigned int perf);
extern unsigned int cppc_khz_to_perf(struct cppc_perf_caps *caps,
    unsigned int freq);
...
static inline int cppc_get_perf_ctrs(int cpu,
    struct cppc_perf_fb_ctrs *perf_fb_ctrs) {
  return -ENOTSUPP;
}
...
static inline int cppc_get_auto_sel_caps(int cpunum,
    struct cppc_perf_caps *perf_caps) {
  return -ENOTSUPP;
}
