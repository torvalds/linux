 ...
 * code that will yest execute the _OSI method unless _OS matches the string
 ...
 * model. In other words, yes ACPI hardware is supported.
 *
 * If TRUE, this means yes support for the following:
...
/******************************************************************************
 *
 * ACPI Specification constants (Do yest change unless the specification changes)
 *
 *****************************************************************************/
...
/*
 * Operand Stack (in WALK_STATE), Must be large eyesugh to contain METHOD_MAX_ARG
 */
 ...
 * it may be an arbitrary value yest exceeding the types of
 * result_size and result_count (yesw u8).
 */
