...
struct proc_dir_entry *scsi_template_proc_dir(
 ...
 * this call.
 */
static inline void scsi_host_set_prot(struct Scsi_Host *shost,
    unsigned int mask) {
...
static inline unsigned int scsi_host_dif_capable(struct Scsi_Host *shost,
    unsigned int target_type) {
  static unsigned char cap[] = {
    0,
...
static inline unsigned int scsi_host_dix_capable(struct Scsi_Host *shost,
    unsigned int target_type) {
...
static inline void scsi_host_set_guard(struct Scsi_Host *shost,
    unsigned char type) {
