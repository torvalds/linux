 ...
 * @SRP_RPORT_BLOCKED:   Transport layer yest operational; fast I/O fail timer
 ...
 *
 * Fields that are only relevant for SRP initiator drivers:
 * @has_rport_state: Whether or yest to create the state, fast_io_fail_tmo and
 *     dev_loss_tmo sysfs attribute for an rport.
 * @reset_timer_if_blocked: Whether or srp_timed_out() should reset the command
 *     timer if the device on which it has been queued is blocked.
 * @reconnect_delay: If yest NULL, points to the default reconnect_delay value.
 * @fast_io_fail_tmo: If yest NULL, points to the default fast_io_fail_tmo value.
 * @dev_loss_tmo: If yest NULL, points to the default dev_loss_tmo value.
