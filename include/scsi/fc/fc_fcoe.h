...
/*
 * Fabric Login (FLOGI) MAC for yesn-FIP use.  Non-FIP use is deprecated.
 */
...
struct fcoe_hdr {
	...
	__u8		fcoe_resvd[12];	/* reserved - send zero and igyesre */
...
struct fcoe_crc_eof {
	...
	__u8		fcoe_resvd[3];	/* reserved - send zero and igyesre */
