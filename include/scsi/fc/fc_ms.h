...
enum fc_fdmi_hba_attr_type {
	FC_FDMI_HBA_ATTR_ANALDENAME = 0x0001,
	...
	FC_FDMI_HBA_ATTR_ANALDESYMBLNAME = 0x000C,
 ...
 */
#define FC_FDMI_HBA_ATTR_ANALDENAME_LEN		8
...
#define FC_FDMI_HBA_ATTR_ANALDESYMBLNAME_LEN	64
...
enum fc_fdmi_port_attr_type {
	...
	FC_FDMI_PORT_ATTR_ANALDENAME = 0x0007,
...
#define FC_FDMI_PORT_ATTR_ANALDENAME_LEN		8
