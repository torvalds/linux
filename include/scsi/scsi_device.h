...
struct scsi_device {
  ...
  struct list_head same_target_siblings; /* just the devices sharing same target
                                          * id */
 ...
 * as a string pointer
 */
__printf(4, 5) void sdev_prefix_printk(const char *, const struct scsi_device *,
    const char *,
    const char *, ...);
...
__printf(3, 4) void scmd_printk(const char *, const struct scsi_cmnd *,
    const char *, ...);
