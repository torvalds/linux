 ...
 * fr_flags.
 */
#define	FCPHF_CRC_UNCHECKED	0x01	/* CRC yest computed, still appended */
...
{
	return !skb_is_yesnlinear(fp_skb(fp));
}
 ...
 * of the buffer for received data.  This may yest be appropriate to use for
