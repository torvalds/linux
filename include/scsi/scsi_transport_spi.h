...
/* accessor functions */
#define spi_period(x) (((struct spi_transport_attrs *) &(x)->starget_data)-> \
  period)
#define spi_min_period(x) (((struct spi_transport_attrs *) &(x)->starget_data)-> \
  min_period)
#define spi_offset(x) (((struct spi_transport_attrs *) &(x)->starget_data)-> \
  offset)
#define spi_max_offset(x) (((struct spi_transport_attrs *) &(x)->starget_data)-> \
  max_offset)
#define spi_width(x)  (((struct spi_transport_attrs *) &(x)->starget_data)-> \
  width)
#define spi_max_width(x) (((struct spi_transport_attrs *) &(x)->starget_data)-> \
  max_width)
#define spi_iu(x) (((struct spi_transport_attrs *) &(x)->starget_data)->iu)
#define spi_max_iu(x) (((struct spi_transport_attrs *) &(x)->starget_data)-> \
  max_iu)
#define spi_dt(x) (((struct spi_transport_attrs *) &(x)->starget_data)->dt)
#define spi_qas(x)  (((struct spi_transport_attrs *) &(x)->starget_data)->qas)
#define spi_max_qas(x)  (((struct spi_transport_attrs *) &(x)->starget_data)-> \
  max_qas)
#define spi_wr_flow(x)  (((struct spi_transport_attrs *) &(x)->starget_data)-> \
  wr_flow)
#define spi_rd_strm(x)  (((struct spi_transport_attrs *) &(x)->starget_data)-> \
  rd_strm)
#define spi_rti(x)  (((struct spi_transport_attrs *) &(x)->starget_data)->rti)
#define spi_pcomp_en(x) (((struct spi_transport_attrs *) &(x)->starget_data)-> \
  pcomp_en)
#define spi_hold_mcs(x) (((struct spi_transport_attrs *) &(x)->starget_data)-> \
  hold_mcs)
#define spi_initial_dv(x) (((struct spi_transport_attrs *) &(x)->starget_data)-> \
  initial_dv)
#define spi_dv_pending(x) (((struct spi_transport_attrs *) &(x)->starget_data)-> \
  dv_pending)

#define spi_support_sync(x) (((struct spi_transport_attrs *) &(x)->starget_data) \
  ->support_sync)
#define spi_support_wide(x) (((struct spi_transport_attrs *) &(x)->starget_data) \
  ->support_wide)
#define spi_support_dt(x) (((struct spi_transport_attrs *) &(x)->starget_data)-> \
  support_dt)
#define spi_support_dt_only(x)  (((struct spi_transport_attrs *) &(x)-> \
  starget_data)->support_dt_only)
#define spi_support_ius(x)  (((struct spi_transport_attrs *) &(x)->starget_data) \
  ->support_ius)
#define spi_support_qas(x)  (((struct spi_transport_attrs *) &(x)->starget_data) \
  ->support_qas)

#define spi_flags(x)  (((struct spi_transport_attrs *) &(x)->starget_data)-> \
  flags)
...
struct scsi_transport_template *spi_attach_transport(
  struct spi_function_template *);
