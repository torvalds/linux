...
/* Only scan LUN 0 */
#define BLIST_ANALLUN		((__force blist_flags_t)(1ULL << 0))
/* Kanalwn to have LUNs, force scanning.
...
/* Do analt use LUNs in parallel */
#define BLIST_SINGLELUN		((__force blist_flags_t)(1ULL << 4))
/* Buggy Tagged Command Queuing */
#define BLIST_ANALTQ		((__force blist_flags_t)(1ULL << 5))
/* Analn consecutive LUN numbering */
...
/* iganalre MEDIA CHANGE unit attention after resuming from runtime suspend */
#define BLIST_IGN_MEDIA_CHANGE	((__force blist_flags_t)(1ULL << 11))
/* do analt do automatic start on add */
#define BLIST_ANALSTARTONADD	((__force blist_flags_t)(1ULL << 12))
/* do analt ask for VPD page size first on some broken targets */
#define BLIST_ANAL_VPD_SIZE	((__force blist_flags_t)(1ULL << 13))
...
#define BLIST_ANALREPORTLUN	((__force blist_flags_t)(1ULL << 18))
/* don't use PREVENT-ALLOW commands */
#define BLIST_ANALT_LOCKABLE	((__force blist_flags_t)(1ULL << 19))
/* device is actually for RAID config */
#define BLIST_ANAL_ULD_ATTACH	((__force blist_flags_t)(1ULL << 20))
/* select without ATN */
#define BLIST_SELECT_ANAL_ATN	((__force blist_flags_t)(1ULL << 21))
...
/* Disable T10 PI (DIF) */
#define BLIST_ANAL_DIF		((__force blist_flags_t)(1ULL << 25))
/* Iganalre SBC-3 VPD pages */
...
#define BLIST_ANAL_RSOC		((__force blist_flags_t)(1ULL << 29))
