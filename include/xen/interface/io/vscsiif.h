...
*The xenstore layout looks like this(dom0 is assumed to be the
  ...
  * < domid > / < vhost > / vscsi - devs / dev - 0 / v - dev = "0:0:0:0"
  * Wait for < domid > / < vhost > / state + < domid > / < vhost
  > / vscsi - devs / dev - 0 / state
  * become 4
  *
...
struct vscsiif_request {
   ...
   *
   * If VSCSIIF_SG_GRANT is set, the low 7 bits of nr_segments specify the
   * number
