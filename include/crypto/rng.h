 ...
 *		random number generators does yest require a seed
 ...
 * the random number generator that does yest share a state with other
 ...
 * number generator does yest implement or require a reseeding. For example,
