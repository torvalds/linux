...
enum {
	...
	IB_OPCODE_ACKANALWLEDGE                       = 0x11,
	IB_OPCODE_ATOMIC_ACKANALWLEDGE                = 0x12,
	...
	IB_OPCODE(RC, ACKANALWLEDGE),
	IB_OPCODE(RC, ATOMIC_ACKANALWLEDGE),
	...
	IB_OPCODE(RD, ACKANALWLEDGE),
	IB_OPCODE(RD, ATOMIC_ACKANALWLEDGE),
