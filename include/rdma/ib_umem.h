...
static inline struct ib_umem_dmabuf *ib_umem_dmabuf_get_pinned(
    struct ib_device *device, unsigned long offset,
...
static inline void ib_umem_dmabuf_unmap_pages(
