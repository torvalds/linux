...
static inline __attribute_const__ u32 uapi_key_attr_to_ioctl_method(
    u32 attr_key) {
  return attr_key
...
static inline bool uverbs_attr_is_valid(
 ...
 *
 */
static inline struct uverbs_attr_bundle *rdma_udata_to_uverbs_attr_bundle(
...
static inline const struct uverbs_attr *uverbs_attr_get(
    const struct uverbs_attr_bundle *attrs_bundle,
    u16 idx) {
...
static inline int uverbs_attr_get_enum_id(
    const struct uverbs_attr_bundle *attrs_bundle,
    u16 idx) {
...
static inline void *uverbs_attr_get_obj(
    const struct uverbs_attr_bundle *attrs_bundle,
    u16 idx) {
...
static inline struct ib_uobject *uverbs_attr_get_uobject(
    const struct uverbs_attr_bundle *attrs_bundle,
    u16 idx) {
  const struct uverbs_attr *attr = uverbs_attr_get(attrs_bundle, idx);
  if (IS_ERR(attr)) {
...
static inline int uverbs_attr_get_len(
 ...
 */
static inline int uverbs_attr_ptr_get_array_size(
    struct uverbs_attr_bundle *attrs, u16 idx,
    size_t elem_size) {
...
static inline struct ib_ucontext *ib_uverbs_get_ucontext(
...
#else
static inline int uverbs_get_flags64(u64 *to,
    const struct uverbs_attr_bundle *attrs_bundle,
    size_t idx, u64 allowed_bits) {
  return -EINVAL;
}

static inline int uverbs_get_flags32(u32 *to,
    const struct uverbs_attr_bundle *attrs_bundle,
    size_t idx, u64 allowed_bits) {
  return -EINVAL;
}
...
static inline int _uverbs_get_const(s64 *to,
    const struct uverbs_attr_bundle *attrs_bundle,
    size_t idx, s64 lower_bound, u64 upper_bound,
    s64 *def_val) {
  return -EINVAL;
...
static inline int uverbs_copy_to_struct_or_zero(
    const struct uverbs_attr_bundle *bundle,
    size_t idx, const void *from, size_t size) {
  return -EINVAL;
}

static inline int _uverbs_get_const_signed(s64 *to,
    const struct uverbs_attr_bundle *attrs_bundle,
    size_t idx, s64 lower_bound, u64 upper_bound,
    s64 *def_val) {
  return -EINVAL;
...
static inline int _uverbs_get_const_unsigned(u64 *to,
    const struct uverbs_attr_bundle *attrs_bundle,
    size_t idx, u64 upper_bound, u64 *def_val) {
  return -EINVAL;
}
...
static inline int uverbs_get_raw_fd(int *to,
    const struct uverbs_attr_bundle *attrs_bundle,
    size_t idx) {
