...
#error \
  "Please #define UVERBS_MODULE_NAME before including rdma/uverbs_named_ioctl.h"
#endif
...
#define UVERBS_OBJECT_METHODS(object_id) _UVERBS_NAME( \
    _object_methods_ ## object_id, __LINE__)
