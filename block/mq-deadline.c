 ...
 */
static inline struct request *deadline_earlier_request(struct request *rq) {
...
static void deadline_add_rq_rb(struct dd_per_prio *per_prio,
    struct request *rq) {
 ...
 */
static bool deadline_is_seq_write(struct deadline_data *dd,
    struct request *rq) {
