...
/**
 * tomoyo_str_starts - Check whether the given string starts with the given
 * keyword.
 *
...
/**
 * tomoyo_correct_path2 - Check whether the given pathname follows the naming
 * rules.
 *
...
/**
 * tomoyo_correct_domain - Check whether the given domainname follows the naming
 * rules.
 *
...
/**
 * tomoyo_const_part_length - Evaluate the initial length without a pattern in a
 * token.
 *
...
/**
 * tomoyo_file_matches_pattern2 - Pattern matching without '/' character and
 *"\-" pattern.
 *
...
/**
 * tomoyo_path_matches_pattern - Check whether the given filename matches the
 * given pattern.
 *
  ...
  list_for_each_entry_rcu(ptr, &domain->acl_info_list, list,
    ...
    switch (ptr->type) {
      ...
      case TOMOYO_TYPE_PATH2_ACL:
        perm
          = data_race(container_of(ptr, struct tomoyo_path2_acl, head)->perm);
        break;
      ...
      case TOMOYO_TYPE_MKDEV_ACL:
        perm
          = data_race(container_of(ptr, struct tomoyo_mkdev_acl, head)->perm);
        break;
