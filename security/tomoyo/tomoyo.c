 ...
 * Returns 0 on success, negative value otherwise.
 */
static int tomoyo_path_unlink(const struct path *parent,
    struct dentry *dentry) {
  struct path path = {
    .mnt = parent->mnt, .dentry = dentry
  };
 ...
 * Returns 0 on success, negative value otherwise.
 */
static int tomoyo_path_link(struct dentry *old_dentry,
...
static int tomoyo_path_rename(const struct path *old_parent,
  ...
  struct path path1 = {
    .mnt = old_parent->mnt, .dentry = old_dentry
  };
  struct path path2 = {
    .mnt = new_parent->mnt, .dentry = new_dentry
  };
 ...
 * Returns 0 on success, negative value otherwise.
 */
static int tomoyo_sb_pivotroot(const struct path *old_path,
