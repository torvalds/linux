...
/**
 * tomoyo_same_transition_control - Check for duplicated "struct
 * tomoyo_transition_control" entry.
 *
...
/**
 * tomoyo_write_transition_control - Write "struct tomoyo_transition_control"
 * list.
 *
 * @param: Pointer to "struct tomoyo_acl_param".
...
int tomoyo_write_transition_control(struct tomoyo_acl_param *param,
    const u8 type) {
  struct tomoyo_transition_control e = {
    .type = type
  };
  int error = param->is_delete ? -ENOENT : -ENOMEM;
 ...
 * Caller holds tomoyo_read_lock().
 */
static inline bool tomoyo_scan_transition(const struct list_head *list,
...
/**
 * tomoyo_same_aggregator - Check for duplicated "struct tomoyo_aggregator"
 * entry.
 *
 * @a: Pointer to "struct tomoyo_acl_head".
 * @b: Pointer to "struct tomoyo_acl_head".
