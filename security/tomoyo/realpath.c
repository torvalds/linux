...
/**
 * tomoyo_get_absolute_path - Get the path of a dentry but ignores chroot'ed
 * root.
 *
 ...
 */
static char *tomoyo_get_absolute_path(const struct path *path,
    char * const buffer,
    const int buflen) {
...
/**
 * tomoyo_realpath_from_path - Returns realpath(3) of the given pathname but
 * ignores chroot'ed root.
 *
 * @path: Pointer to "struct path".
 *
