...
/**
 * tomoyo_struct_used_by_io_buffer - Check whether the list element is used by
 */
sys / kernel / security / tomoyo / users or not.
*
*@element:
...
/**
 * tomoyo_name_used_by_io_buffer - Check whether the string is used by
 */
sys / kernel / security / tomoyo / users or not.
*
*@string:
...
/**
 * tomoyo_del_transition_control - Delete members in "struct
