...
/**
 * tomoyo_same_path_group - Check for duplicated "struct tomoyo_path_group"
 * entry.
 *
...
/**
 * tomoyo_same_number_group - Check for duplicated "struct tomoyo_number_group"
 * entry.
 *
 * @a: Pointer to "struct tomoyo_acl_head".
 * @b: Pointer to "struct tomoyo_acl_head".
...
/**
 * tomoyo_same_address_group - Check for duplicated "struct
 * tomoyo_address_group" entry.
 *
 * @a: Pointer to "struct tomoyo_acl_head".
 * @b: Pointer to "struct tomoyo_acl_head".
 *
...
/**
 * tomoyo_write_group - Write "struct tomoyo_path_group"/"struct
...
/**
 * tomoyo_path_matches_group - Check whether the given pathname matches members
 * of the given pathname group.
 *
...
/**
 * tomoyo_number_matches_group - Check whether the given number matches members
 * of the given number group.
 *
 * @min:   Min number.
 * @max:   Max number.
...
/**
 * tomoyo_address_matches_group - Check whether the given address matches
 * members of the given address group.
 *
