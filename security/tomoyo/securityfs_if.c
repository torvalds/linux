...
/**
 * tomoyo_write_self - write() for /sys/kernel/security/tomoyo/self_domain
 * interface.
 *
...
/**
 * tomoyo_read_self - read() for /sys/kernel/security/tomoyo/self_domain
 * interface.
 *
 * @file:  Pointer to "struct file".
...
/**
 * tomoyo_create_entry - Create interface files under
 */
