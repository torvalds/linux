...
void key_set_index_key(struct keyring_index_key *index_key) {
  static struct key_tag default_domain_tag = {
...
static unsigned long keyring_get_object_key_chunk(const void *object,
    int level) {
 ...
 */
static int search_keyring(struct key *keyring,
...
#define STATE_CHECKS (KEYRING_SEARCH_NO_STATE_CHECK \
