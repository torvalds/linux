 ...
 */
static void ima_post_path_mknod(struct mnt_idmap *idmap,
  ...
  switch (id) {
    case LOADING_KEXEC_IMAGE:
      if (IS_ENABLED(CONFIG_KEXEC_SIG)
        ...
        pr_err(
            "impossible to appraise a kernel image without a file descriptor; try using kexec_file_load syscall.\n");
        return -EACCES;
      }
    ...
    case LOADING_MODULE:
      ...
      if (ima_enforce && (!sig_enforce
        ...
        pr_err(
            "impossible to appraise a module without a file descriptor. sig_enforce kernel parameter might help\n");
        return -EACCES; /* INTEGRITY_UNKNOWN */
      }
      break;
    default:
