...
enum ima_show_type {
  IMA_SHOW_BINARY, IMA_SHOW_BINARY_NO_FIELD_LEN,
  IMA_SHOW_BINARY_OLD_STRING_FMT, IMA_SHOW_ASCII
};
enum tpm_pcrs {
  TPM_PCR0 = 0, TPM_PCR8 = 8, TPM_PCR10 = 10
};
...
static inline struct ima_iint_cache *ima_inode_get_iint(
...
static inline bool ima_should_queue_key(void) {
  return false;
}
...
static inline enum integrity_status ima_get_cache_status(
    struct ima_iint_cache *iint, enum ima_hooks func) {
  return INTEGRITY_UNKNOWN;
}

static inline enum hash_algo ima_get_hash_algo(
    struct evm_ima_xattr_data *xattr_value, int xattr_len) {
