...
static inline void landlock_add_net_access_mask(
    struct landlock_ruleset * const ruleset,
...
static inline access_mask_t landlock_get_raw_fs_access_mask(
    const struct landlock_ruleset * const ruleset,
    const u16 layer_level) {
...
static inline access_mask_t landlock_get_fs_access_mask(
    const struct landlock_ruleset * const ruleset,
    const u16 layer_level) {
...
static inline access_mask_t landlock_get_net_access_mask(
    const struct landlock_ruleset * const ruleset,
    const u16 layer_level) {
  return (ruleset->access_masks[layer_level] >>
