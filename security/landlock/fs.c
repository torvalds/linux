...
static bool is_access_to_paths_allowed(
	...
	struct rule_flags_masks *const rule_flags_masks_parent1,
	struct landlock_request *const log_request_parent1,
	struct dentry *const dentry_child1,
	const access_mask_t access_request_parent2,
	layer_mask_t (*const layer_masks_parent2)[LANDLOCK_NUM_ACCESS_FS],
	struct rule_flags_masks *const rule_flags_masks_parent2,
	...
	while (true) {
		...
		allowed_parent1 = allowed_parent1 ||
				  landlock_unmask_layers(
					  ...
					  rule_flags_masks_parent1);
		allowed_parent2 = allowed_parent2 ||
				  landlock_unmask_layers(
					  rule, access_masked_parent2,
					  layer_masks_parent2,
					  ARRAY_SIZE(*layer_masks_parent2),
					  rule_flags_masks_parent2);
				     ...
				     access_mask_t access_request)
{
	...
	layer_mask_t layer_masks[LANDLOCK_NUM_ACCESS_FS] = {};
	struct rule_flags_masks rule_flags_masks = {};
	...
	if (is_access_to_paths_allowed(subject->domain, path, access_request,
				       &layer_masks, &rule_flags_masks,
				       &request, NULL, 0, NULL, NULL, NULL,
				       NULL))
		return 0;

	landlock_log_denial(subject, &request, &rule_flags_masks);
	return -EACCES;
}
	...
	struct rule_flags_masks *const rule_flags_masks)
{
	...
	while (true) {
		...
		if (landlock_unmask_layers(
			    ...
			    ARRAY_SIZE(*layer_masks_dom), rule_flags_masks)) {
			/*
				    ...
				    const bool removable, const bool exchange)
{
	...
	struct rule_flags_masks rule_flags_masks_parent1 = {},
				rule_flags_masks_parent2 = {};
	...
	if (old_dentry->d_parent == new_dir->dentry) {
		...
		if (is_access_to_paths_allowed(
			    ...
			    &layer_masks_parent1, &rule_flags_masks_parent1,
			    &request1, NULL, 0, NULL, NULL, NULL, NULL))
			return 0;

		landlock_log_denial(subject, &request1, &rule_flags_masks_parent1);
		return -EACCES;
	}
	...
	if (is_access_to_paths_allowed(
		    ...
		    &layer_masks_parent1, &rule_flags_masks_parent1, &request1, old_dentry,
		    access_request_parent2, &layer_masks_parent2, &rule_flags_masks_parent2, &request2,
...
static int hook_file_open(struct file *const file)
{
	...
	if (is_access_to_paths_allowed(
		    ...
		    landlock_init_layer_masks(subject->domain,
					      ...
					      LANDLOCK_KEY_INODE),
		    &layer_masks, &rule_flags_masks, &request, NULL, 0, NULL,
		    NULL, NULL, NULL)) {
	...
	landlock_file(file)->deny_masks = landlock_get_deny_masks(
		...
		ARRAY_SIZE(layer_masks), &rule_flags_masks);
#endif /* CONFIG_AUDIT */
