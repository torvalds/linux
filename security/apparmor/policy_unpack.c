 ...
 */
VISIBLE_IF_KUNIT bool aa_unpack_nameX(struct aa_ext *e, enum aa_code code,
    const char *name) {
  /*
...
VISIBLE_IF_KUNIT bool aa_unpack_u32(struct aa_ext *e, u32 *data,
    const char *name) {
  void *pos = e->pos;
...
VISIBLE_IF_KUNIT bool aa_unpack_u64(struct aa_ext *e, u64 *data,
    const char *name) {
  void *pos = e->pos;
...
static bool aa_unpack_cap_low(struct aa_ext *e, kernel_cap_t *data,
    const char *name) {
  u32 val;
...
static bool aa_unpack_cap_high(struct aa_ext *e, kernel_cap_t *data,
    const char *name) {
  u32 val;
  if (!aa_unpack_u32(e, &val, name)) {
    return false;
...
VISIBLE_IF_KUNIT bool aa_unpack_array(struct aa_ext *e, const char *name,
    u16 *size) {
  void *pos = e->pos;
...
VISIBLE_IF_KUNIT int aa_unpack_str(struct aa_ext *e, const char **string,
    const char *name) {
  char *src_str;
  size_t size = 0;
  void *pos = e->pos;
...
VISIBLE_IF_KUNIT int aa_unpack_strdup(struct aa_ext *e, char **string,
    const char *name) {
  const char *tmp;
  void *pos = e->pos;
...
static int compress_zstd(const char *src, size_t slen, char **dst,
    size_t *dlen) {
