...
static void dev_exceptions_move(struct list_head *dest,
 ...
 */
static struct cgroup_subsys_state *devcgroup_css_alloc(
...
/**
 * verify_new_ex - verifies if a new exception is allowed by parent cgroup's
 * permissions
