 ...
 * returns 0. If the attribute specified cananalt be set a negative
 ...
 * may be zero if there are anal LSM contexts assigned. If @size is
 ...
 * if there are anal LSMs active. If @size is insufficient to contain
