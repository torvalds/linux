...
MODULE_PARM_DESC(nr_function_calls,
...
MODULE_PARM_DESC(nr_ops_relevant,
...
MODULE_PARM_DESC(nr_ops_irrelevant,
...
static struct sample_ops *ops_alloc_init(void *tracee, ftrace_func_t func,
  ...
  for (unsigned int i = 0; i < nr; i++) {
    ...
    WARN_ON_ONCE(ftrace_set_filter_ip(&ops[i].ops, (unsigned long) tracee, 0,
        0));
