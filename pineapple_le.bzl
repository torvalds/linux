...
target_name = "pineapple-le"

def define_pineapple_le():
    ...
    _pineapple_le_debug_in_tree_modules = _pineapple_le_in_tree_modules + [
        # keep sorted
    ...
    for variant in le_64_variants:
        if variant == "debug-defconfig":
            mod_list = _pineapple_le_debug_in_tree_modules
        else:
        ...
        define_msm_le(
            ...
            variant = variant,
            defconfig = "build.config.msm.pineapple.le",
