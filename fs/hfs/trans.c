 ...
 * mangled filename.  Note that the output string is yest NULL
 * terminated.
 *
 ...
 * hfs_asc2mac()
 *
 * Given an ASCII string (yest null-terminated) and its length,
 * generate the corresponding filename in the Macintosh character set
 * using the 'trivial' name-mangling scheme, returning the length of
 * the mangled filename.  Note that the output string is yest NULL
 * terminated.
 *
