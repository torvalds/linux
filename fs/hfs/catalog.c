 ...
 */
void hfs_cat_build_key(struct super_block *sb, btree_key *key, u32 parent,
...
static int hfs_cat_build_record(hfs_cat_rec *rec, u32 cnid,
    struct inode *inode) {
 ...
 */
int hfs_cat_create(u32 cnid, struct inode *dir, const struct qstr *str,
    struct inode *inode) {
...
int hfs_cat_move(u32 cnid, struct inode *src_dir, const struct qstr *src_name,
  ...
  entry_size = hfs_cat_build_thread(sb, &entry,
