...
static struct configfs_attribute *cluster_attrs[] = {
	...
	[CLUSTER_ATTR_LOG_DE] = &cluster_attr_log_de,
					 ...
					 const char *name)
{
	...
	cl->cl_log_de = dlm_config.ci_log_de;
