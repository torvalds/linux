...
static void __dlm_master_lookup(struct dlm_ls *ls, struct dlm_rsb *r,
    int our_nodeid,
...
static int find_lkb(struct dlm_ls *ls, uint32_t lkid,
...
static int set_unlock_args(uint32_t flags, void *astarg,
    struct dlm_args *args) {
...
static int receive_request_args(struct dlm_ls *ls, struct dlm_lkb *lkb,
  ...
  lkb->lkb_bastfn
    = (ms->m_asts & cpu_to_le32(DLM_CB_BAST)) ? &fake_bastfn : NULL;
