 ...
 */
static struct kernfs_open_node *kernfs_deref_open_node_locked(
 ...
 * bin files.
 */
static ssize_t kernfs_file_read_iter(struct kiocb *iocb,
 ...
 * back.
 */
static ssize_t kernfs_fop_write_iter(struct kiocb *iocb,
    struct iov_iter *iter) {
  struct kernfs_open_file *of = kernfs_of(iocb->ki_filp);
