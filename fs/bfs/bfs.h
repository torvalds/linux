 ...
 * inclusive.
 * In actual fact, attempting to create the 512th inode (i.e. inode No. 513 or
 * file No. 511)
 * will fail with ENOSPC in bfs_add_entry(): the root directory cannot contain
 * so many entries, counting '..'.
