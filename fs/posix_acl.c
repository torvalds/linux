 ...
 */
int posix_acl_valid(struct user_namespace *user_ns,
...
int __posix_acl_create(struct posix_acl **acl, gfp_t gfp, umode_t *mode_p) {
 ...
 */
int posix_acl_chmod(struct mnt_idmap *idmap, struct dentry *dentry,
    umode_t mode) {
...
int set_posix_acl(struct mnt_idmap *idmap, struct dentry *dentry,
