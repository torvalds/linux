 ...
 */
static int adfs_get_block(struct inode *inode, sector_t block,
 ...
 */
static umode_t adfs_atts2mode(struct super_block *sb, struct inode *inode) {
 ...
 */
static void adfs_adfs2unix_time(struct timespec64 *tv, struct inode *inode) {
