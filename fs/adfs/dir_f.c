 ...
 * of them.
 */
static u8 adfs_dir_checkbyte(const struct adfs_dir *dir) {
  ...
  return (dircheck
    ^ (dircheck >> 8) ^ (dircheck >> 16) ^ (dircheck >> 24)) & 0xff;
}
 ...
 */
static inline void adfs_dir2obj(struct adfs_dir *dir, struct object_info *obj,
 ...
 */
static inline void adfs_obj2dir(struct adfs_direntry *de,
 ...
 */
static int __adfs_dir_get(struct adfs_dir *dir, int pos,
    struct object_info *obj) {
  struct adfs_direntry de;
  int ret;
...
static int adfs_f_setpos(struct adfs_dir *dir, unsigned int fpos) {
...
static int adfs_f_getnext(struct adfs_dir *dir, struct object_info *obj) {
  unsigned int ret;
