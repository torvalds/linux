...
static inline struct fanotify_fh *fanotify_info_dir_fh(
...
static inline struct fanotify_fh *fanotify_info_dir2_fh(
    struct fanotify_info *info) {
...
static inline struct fanotify_fh *fanotify_info_file_fh(
    struct fanotify_info *info) {
...
static inline struct fanotify_fid_event *FANOTIFY_FE(
...
static inline struct fanotify_name_event *FANOTIFY_NE(
    struct fanotify_event *event) {
...
static inline struct fanotify_error_event *FANOTIFY_EE(
    struct fanotify_event *event) {
...
static inline struct fanotify_path_event *FANOTIFY_PE(
    struct fanotify_event *event) {
...
static inline struct fanotify_perm_event *FANOTIFY_PERM(
    struct fanotify_event *event) {
...
static inline const struct path *fanotify_event_path(
    struct fanotify_event *event) {
