...
struct ATTR_STD_INFO5 {
  ...
  __le32 security_id; // 0x34: The Security Id is a key in the $SII Index and
                      // $SDS.
  __le64 quota_charge;  // 0x38:
  __le64 usn;   // 0x40: Last Update Sequence Number of the file. This is a
                // direct
...
struct NTFS_DUP_INFO {
  ...
  __le64 c_time;    // 0x10: Last time any attribute was modified.
  __le64 a_time;    // 0x18: File last access time.
  __le64 alloc_size;  // 0x20: Data attribute allocated size, multiple of
                      // cluster size.
...
struct INDEX_HDR {
  ...
  __le32 total; // 0x08: The allocated size of for this structure plus all
                // entries.
...
#define IsReparseTagNameSurrogate(_tag) (((_tag) \
