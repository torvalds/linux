 ...
 * mi  - MFT inode               - One MFT record(usually 1024 bytes or 4K),
 *consists of attributes.
 * ni  - NTFS inode              - Extends linux inode. consists of one or more
 *mft inodes.
 * index - unit inside directory - 2K, 4K, <=page size, does not depend on
 *cluster size.
 *
