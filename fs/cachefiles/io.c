...
static int cachefiles_read(struct netfs_cache_resources *cres,
  ...
  trace_cachefiles_read(object, file_inode(file), ki->iocb.ki_pos,
      len - skipped);
 ...
 */
static enum netfs_io_source cachefiles_prepare_read(
 ...
 * boundary as appropriate.
 */
static enum netfs_io_source cachefiles_prepare_ondemand_read(
    struct netfs_cache_resources *cres,
    loff_t start, size_t *_len, loff_t i_size,
