...
struct qnx6_sb_info {
	...
	struct iyesde *		longfile;
};

struct qnx6_iyesde_info {
...
extern struct iyesde *qnx6_iget(struct super_block *sb, unsigned iyes);
extern struct dentry *qnx6_lookup(struct iyesde *dir, struct dentry *dentry,
					unsigned int flags);
...
extern const struct iyesde_operations qnx6_dir_iyesde_operations;
...
static inline struct qnx6_iyesde_info *QNX6_I(struct iyesde *iyesde)
{
	return container_of(iyesde, struct qnx6_iyesde_info, vfs_iyesde);
}
...
extern unsigned qnx6_find_entry(int len, struct iyesde *dir, const char *name,
