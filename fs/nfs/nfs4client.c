 ...
 */
static struct nfs4_ds_server *nfs4_find_ds_client(struct nfs_client *ds_clp,
...
static struct nfs4_ds_server *nfs4_add_ds_client(struct nfs_client *ds_clp,
    rpc_authflavor_t flavor,
...
static struct nfs4_ds_server *nfs4_alloc_ds_server(struct nfs_client *ds_clp,
    rpc_authflavor_t flavor) {
  struct nfs4_ds_server *dss;
 ...
 */
struct rpc_clnt *nfs4_find_or_create_ds_client(struct nfs_client *ds_clp,
    struct inode *inode) {
 ...
 */
static bool nfs4_check_server_scope(struct nfs41_server_scope *s1,
