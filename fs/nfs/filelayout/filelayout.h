...
struct nfs4_file_layout_dsaddr {
	struct nfs4_deviceid_yesde	id_yesde;
	u32				stripe_count;
	u8				*stripe_indices;
	u32				ds_num;
...
{
	return &FILELAYOUT_LSEG(lseg)->dsaddr->id_yesde;
}

static inline bool
filelayout_test_devid_invalid(struct nfs4_deviceid_yesde *yesde)
{
	return test_bit(NFS_DEVICEID_INVALID, &yesde->flags);
}
...
nfs4_fl_alloc_deviceid_yesde(struct nfs_server *server,
