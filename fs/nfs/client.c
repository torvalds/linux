 ...
 * that is supplied.
 */
static struct nfs_client *nfs_match_client(
    const struct nfs_client_initdata *data) {
  struct nfs_client *clp;
 ...
 */
static struct nfs_client *nfs_found_client(
...
/*
 * set up the iterator to start reading from the volume list and return the
 *first item
 */
