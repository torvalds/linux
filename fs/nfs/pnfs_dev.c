...
#ifdef NFS_DEBUG
void nfs4_print_deviceid(const struct nfs4_deviceid *id) {
  u32 *p = (u32 *) id;
...
static inline u32 nfs4_deviceid_hash(const struct nfs4_deviceid *id) {
...
static struct nfs4_deviceid_node *_lookup_deviceid(
...
static struct nfs4_deviceid_node *nfs4_get_device_info(
 ...
 */
static struct nfs4_deviceid_node *__nfs4_find_get_deviceid(
    struct nfs_server *server,
...
struct nfs4_deviceid_node *nfs4_find_get_deviceid(struct nfs_server *server,
...
static void _deviceid_purge_client(const struct nfs_client *clp, long hash) {
  struct nfs4_deviceid_node *d;
  HLIST_HEAD(tmp);
  spin_lock(&nfs4_deviceid_lock);
  rcu_read_lock();
