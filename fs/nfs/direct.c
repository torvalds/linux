...
static void nfs_direct_handle_truncated(struct nfs_direct_req *dreq,
...
static void nfs_direct_count_bytes(struct nfs_direct_req *dreq,
    const struct nfs_pgio_header *hdr) {
...
static void nfs_direct_write_scan_commit_list(struct inode *inode,
...
static void nfs_direct_write_complete(struct nfs_direct_req *dreq) {
  ...
  queue_work(nfsiod_workqueue, &dreq->work); /* Calls
...
/**
 * nfs_destroy_directcache - destroy the slab cache for nfs_direct_req
 *structures
 *
 */
