...
static void nfs42_offload_cancel_prepare(struct rpc_task *task,
    void *calldata) {
...
static void nfs42_layoutstat_prepare(struct rpc_task *task, void *calldata) {
...
static void nfs42_layoutstat_done(struct rpc_task *task, void *calldata) {
  struct nfs42_layoutstat_data *data = calldata;
  struct inode *inode = data->inode;
  struct pnfs_layout_hdr *lo;
...
static void nfs42_layoutstat_release(void *calldata) {
  struct nfs42_layoutstat_data *data = calldata;
...
static struct nfs42_layouterror_data *nfs42_alloc_layouterror_data(
    struct pnfs_layout_segment *lseg, gfp_t gfp_flags) {
...
static void nfs42_free_layouterror_data(struct nfs42_layouterror_data *data) {
  pnfs_put_lseg(data->lseg);
  nfs_iput_and_deactive(data->inode);
  kfree(data);
}

static void nfs42_layouterror_prepare(struct rpc_task *task, void *calldata) {
...
static void nfs42_layouterror_done(struct rpc_task *task, void *calldata) {
  struct nfs42_layouterror_data *data = calldata;
  struct inode *inode = data->inode;
  struct pnfs_layout_hdr *lo = data->lseg->pls_layout;
  if (!nfs4_sequence_done(task, &data->res.seq_res)) {
...
static void nfs42_layouterror_release(void *calldata) {
  struct nfs42_layouterror_data *data = calldata;
