...
struct nfs4_ff_layout_ds *nfs4_ff_alloc_deviceid_node(struct nfs_server *server,
...
static int ff_ds_error_match(const struct nfs4_ff_layout_ds_err *e1,
...
static void ff_layout_add_ds_error_locked(struct nfs4_flexfile_layout *flo,
...
static const struct cred *ff_layout_get_mirror_cred(
    struct nfs4_ff_layout_mirror *mirror, u32 iomode) {
...
struct nfs_fh *nfs4_ff_layout_select_ds_fh(struct nfs4_ff_layout_mirror *mirror)
{
  /* FIXME: For now assume there is only 1 version available for the DS */
  return &mirror->fh_versions[0];
}

void nfs4_ff_layout_select_ds_stateid(
    const struct nfs4_ff_layout_mirror *mirror,
...
static bool ff_layout_init_mirror_ds(struct pnfs_layout_hdr *lo,
 ...
 */
struct nfs4_pnfs_ds *nfs4_ff_layout_prepare_ds(struct pnfs_layout_segment *lseg,
    struct nfs4_ff_layout_mirror *mirror,
    bool fail_return) {
 ...
 */
struct rpc_clnt *nfs4_ff_find_or_create_ds_client(
    struct nfs4_ff_layout_mirror *mirror,
...
int ff_layout_encode_ds_ioerr(struct xdr_stream *xdr,
