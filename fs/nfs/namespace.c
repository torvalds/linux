...
static int nfs_namespace_getattr(struct mnt_idmap *idmap,
...
static int nfs_namespace_setattr(struct mnt_idmap *idmap, struct dentry *dentry,
    struct iattr *attr) {
...
static int param_set_nfs_timeout(const char *val,
