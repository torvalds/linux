...
static __be32 decode_delegation_stateid(struct xdr_stream *xdr,
...
#if defined(CONFIG_NFS_V4_1)
static __be32 decode_layout_stateid(struct xdr_stream *xdr,
    nfs4_stateid *stateid) {
...
static __be32 decode_lockowner(struct xdr_stream *xdr,
...
#endif /* CONFIG_NFS_V4_2 */
static __be32 encode_string(struct xdr_stream *xdr, unsigned int len,
    const char *str) {
...
static __be32 encode_attr_bitmap(struct xdr_stream *xdr, const uint32_t *bitmap,
    size_t sz) {
...
static __be32 encode_attr_change(struct xdr_stream *xdr, const uint32_t *bitmap,
    uint64_t change) {
  __be32 *p;
...
static __be32 encode_attr_size(struct xdr_stream *xdr, const uint32_t *bitmap,
    uint64_t size) {
  __be32 *p;
...
static __be32 encode_attr_time(struct xdr_stream *xdr,
...
static __be32 encode_attr_ctime(struct xdr_stream *xdr, const uint32_t *bitmap,
    const struct timespec64 *time) {
...
static __be32 encode_attr_mtime(struct xdr_stream *xdr, const uint32_t *bitmap,
    const struct timespec64 *time) {
...
static __be32 encode_compound_hdr_res(struct xdr_stream *xdr,
...
static __be32 preprocess_nfs41_op(int nop, unsigned int op_nr,
...
#ifdef CONFIG_NFS_V4_2
static __be32 preprocess_nfs42_op(int nop, unsigned int op_nr,
    struct callback_op **op) {
...
static __be32 preprocess_nfs4_op(unsigned int op_nr, struct callback_op **op) {
  switch (op_nr) {
    case OP_CB_GETATTR:
    case OP_CB_RECALL:
      *op = &callback_ops[op_nr];
...
static int nfs_callback_dispatch(struct svc_rqst *rqstp) {
