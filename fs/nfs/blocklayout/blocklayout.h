...
struct pnfs_block_extent {
	union {
		struct rb_yesde	be_yesde;
		struct list_head be_list;
	};
	struct nfs4_deviceid_yesde *be_device;
...
/* dev.c */
struct nfs4_deviceid_yesde *bl_alloc_deviceid_yesde(struct nfs_server *server,
		struct pnfs_device *pdev, gfp_t gfp_mask);
void bl_free_deviceid_yesde(struct nfs4_deviceid_yesde *d);
