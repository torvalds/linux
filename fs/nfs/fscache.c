 ...
 */
int nfs_fscache_get_super_cookie(struct super_block *sb, const char *uniq,
    int ulen) {
...
static int nfs_netfs_init_request(struct netfs_io_request *rreq,
    struct file *file) {
...
static struct nfs_netfs_io_data *nfs_netfs_alloc(
