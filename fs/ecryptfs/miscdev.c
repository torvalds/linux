 ...
 */
static __poll_t ecryptfs_miscdev_poll(struct file *file, poll_table *pt) {
 ...
 */
static ssize_t ecryptfs_miscdev_read(struct file *file, char __user *buf,
    size_t count,
    loff_t *ppos) {
  struct ecryptfs_daemon *daemon = file->private_data;
...
/**
 * ecryptfs_miscdev_response - miscdevess response to message previously sent to
 *daemon
 * @daemon: eCryptfs daemon object
 ...
 */
static ssize_t ecryptfs_miscdev_write(struct file *file, const char __user *buf,
