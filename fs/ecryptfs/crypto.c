...
static int ecryptfs_write_metadata_to_contents(struct inode *ecryptfs_inode,
 ...
 * Returns zero on success; non-zero otherwise
 */
static int ecryptfs_encrypt_filename(struct ecryptfs_filename *filename,
    struct ecryptfs_mount_crypt_stat *mount_crypt_stat) {
  int rc = 0;
 ...
 */
static int ecryptfs_process_key_cipher(struct crypto_skcipher **key_tfm,
...
/**
 * ecryptfs_encrypt_and_encode_filename - converts a plaintext file name to
 *cipher text
 * @encoded_name: The encrypted name
 * @encoded_name_size: Length of the encrypted name
 * @mount_crypt_stat: The crypt_stat struct associated with the file name to
 *encode
...
/**
 * ecryptfs_decode_and_decrypt_filename - converts the encoded cipher text name
 *to decoded plaintext
