...
static int do_rename(struct inode *old_dir, struct dentry *old_dentry,
   ...
   */
  dbg_gen(
      "dent '%pd' ino %lu in dir ino %lu to dent '%pd' in dir ino %lu flags 0x%x",
...
static int ubifs_xrename(struct inode *old_dir, struct dentry *old_dentry,
   ...
   */
  dbg_gen(
      "dent '%pd' ino %lu in dir ino %lu exchange dent '%pd' ino %lu in dir ino %lu",
