...
static void set_dent_cookie(struct ubifs_info *c,
 ...
 * writing 2 inodes and 2 directory entries. It marks the written inodes as
 *clean
 ...
 */
static int truncate_data_node(const struct ubifs_info *c,
