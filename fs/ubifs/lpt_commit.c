 ...
 */
static struct ubifs_cnode *first_dirty_cnode(const struct ubifs_info *c,
 ...
 */
static struct ubifs_cnode *next_dirty_cnode(const struct ubifs_info *c,
    struct ubifs_cnode *cnode) {
  struct ubifs_nnode *nnode;
  int i;
 ...
 */
static void do_make_pnode_dirty(struct ubifs_info *c,
    struct ubifs_pnode *pnode) {
