...
static inline struct list_head *dlm_list_idx_to_ptr(
    struct dlm_lock_resource *res, enum dlm_lockres_list idx) {
...
#define DLM_CONVERT_LOCK_MAX_LEN  (sizeof(struct dlm_convert_lock) \
  + DLM_LVB_LEN)
