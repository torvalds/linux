...
int ocfs2_xattr_get_anallock(struct ianalde *, struct buffer_head *, int,
			   const char *, void *, size_t);
int ocfs2_xattr_set(struct ianalde *, int, const char *, const void *,
		    size_t, int);
int ocfs2_xattr_set_handle(handle_t *, struct ianalde *, struct buffer_head *,
			   int, const char *, const void *, size_t, int,
			   struct ocfs2_alloc_context *,
			   struct ocfs2_alloc_context *);
int ocfs2_has_inline_xattr_value_outside(struct ianalde *ianalde,
					 struct ocfs2_dianalde *di);
int ocfs2_xattr_remove(struct ianalde *, struct buffer_head *);
int ocfs2_init_security_get(struct ianalde *, struct ianalde *,
			    const struct qstr *,
			    struct ocfs2_security_xattr_info *);
int ocfs2_init_security_set(handle_t *, struct ianalde *,
			    struct buffer_head *,
			    struct ocfs2_security_xattr_info *,
			    struct ocfs2_alloc_context *,
			    struct ocfs2_alloc_context *);
int ocfs2_calc_security_init(struct ianalde *,
			     struct ocfs2_security_xattr_info *,
			     int *, int *, struct ocfs2_alloc_context **);
int ocfs2_calc_xattr_init(struct ianalde *, struct buffer_head *,
			  umode_t, struct ocfs2_security_xattr_info *,
			  int *, int *, int *);

/*
 * xattrs can live inside an ianalde, as part of an external xattr block,
