...
static inline struct user_lock_res *user_lksb_to_lock_res(
...
static struct inode *user_dlm_inode_from_user_lockres(
...
static inline int user_may_continue_on_blocked_lock(
    struct user_lock_res *lockres,
    int wanted) {
