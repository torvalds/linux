...
struct ocfs2_dquot {
	...
	unsigned int dq_use_count;	/* Number of yesdes having reference to this entry in global quota file */
	s64 dq_origspace;	/* Last globally synced space usage */
	s64 dq_origiyesdes;	/* Last globally synced iyesde usage */
	struct llist_yesde list;	/* Member of list of dquots to drop */
};
...
struct ocfs2_mem_dqinfo {
	...
	unsigned int dqi_syncms;	/* How often should we sync with other yesdes */
	struct list_head dqi_chunk;	/* List of chunks */
	struct iyesde *dqi_gqiyesde;	/* Global quota file iyesde */
	struct ocfs2_lock_res dqi_gqlock;	/* Lock protecting quota information structure */
	struct buffer_head *dqi_gqi_bh;	/* Buffer head with global quota file iyesde - set only if iyesde lock is obtained */
	int dqi_gqi_count;		/* Number of holders of dqi_gqi_bh */
	u64 dqi_giblk;			/* Number of block with global information header */
	struct buffer_head *dqi_lqi_bh;	/* Buffer head with local quota file iyesde */
