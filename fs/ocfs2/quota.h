...
struct ocfs2_dquot {
  ...
  unsigned int dq_use_count;  /* Number of nodes having reference to this entry
                               * in global quota file */
...
struct ocfs2_mem_dqinfo {
  ...
  struct ocfs2_lock_res dqi_gqlock; /* Lock protecting quota information
                                     * structure */
  struct buffer_head *dqi_gqi_bh; /* Buffer head with global quota file inode -
                                   * set only if inode lock is obtained */
