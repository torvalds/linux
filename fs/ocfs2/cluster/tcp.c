...
static int o2net_prep_nsw(struct o2net_node *nn,
...
static struct o2net_msg_handler *o2net_handler_tree_lookup(u32 msg_type,
    u32 key,
...
static void o2net_init_msg(struct o2net_msg *msg, u16 data_len, u16 msg_type,
    u32 key) {
