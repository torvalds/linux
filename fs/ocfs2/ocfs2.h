 ...
 * uses it.
 */
struct super_block *ocfs2_metadata_cache_get_super(
...
enum ocfs2_mount_options {
  ...
  OCFS2_MOUNT_ERRORS_CONT = 1 << 16, /* Return EIO to the calling process on
                                      * error */
...
#define ocfs2_clear_bit(bit, addr) _ocfs2_clear_bit((bit), \
    (unsigned long *) (addr))
