...
#define OCFS2_DIRSYNC_FL    FS_DIRSYNC_FL /* dirsync behaviour (directories
                                           * only) */
...
static struct ocfs2_system_inode_info ocfs2_system_inodes[NUM_SYSTEM_INODES] = {
  ...
  [GLOBAL_INODE_ALLOC_SYSTEM_INODE]
    = { "global_inode_alloc", OCFS2_BITMAP_FL | OCFS2_CHAIN_FL,
        S_IFREG | 0644 },

  /* These are used by the running filesystem */
  [SLOT_MAP_SYSTEM_INODE] = { "slot_map", 0, S_IFREG | 0644 },
  [HEARTBEAT_SYSTEM_INODE]
    = { "heartbeat", OCFS2_HEARTBEAT_FL, S_IFREG | 0644 },
  [GLOBAL_BITMAP_SYSTEM_INODE] = { "global_bitmap", 0, S_IFREG | 0644 },
  [USER_QUOTA_SYSTEM_INODE] = { "aquota.user", OCFS2_QUOTA_FL, S_IFREG | 0644 },
  [GROUP_QUOTA_SYSTEM_INODE]
    = { "aquota.group", OCFS2_QUOTA_FL, S_IFREG | 0644 },

  /* Slot-specific system inodes (one copy per slot) */
  [ORPHAN_DIR_SYSTEM_INODE] = { "orphan_dir:%04d", 0, S_IFDIR | 0755 },
  [EXTENT_ALLOC_SYSTEM_INODE]
    = { "extent_alloc:%04d", OCFS2_BITMAP_FL | OCFS2_CHAIN_FL,
        S_IFREG | 0644 },
  [INODE_ALLOC_SYSTEM_INODE]
    = { "inode_alloc:%04d", OCFS2_BITMAP_FL | OCFS2_CHAIN_FL,
        S_IFREG | 0644 },
  [JOURNAL_SYSTEM_INODE] = { "journal:%04d", OCFS2_JOURNAL_FL, S_IFREG | 0644 },
  [LOCAL_ALLOC_SYSTEM_INODE]
    = { "local_alloc:%04d", OCFS2_BITMAP_FL | OCFS2_LOCAL_ALLOC_FL,
        S_IFREG | 0644 },
  [TRUNCATE_LOG_SYSTEM_INODE]
    = { "truncate_log:%04d", OCFS2_DEALLOC_FL, S_IFREG | 0644 },
  [LOCAL_USER_QUOTA_SYSTEM_INODE]
    = { "aquota.user:%04d", OCFS2_QUOTA_FL, S_IFREG | 0644 },
  [LOCAL_GROUP_QUOTA_SYSTEM_INODE]
    = { "aquota.group:%04d", OCFS2_QUOTA_FL, S_IFREG | 0644 },
};
...
struct ocfs2_block_check {
  /*00*/
  __le32 bc_crc32e; /* 802.3 Ethernet II CRC32 */
...
struct ocfs2_extent_rec {
  /*00*/
  __le32 e_cpos;    /* Offset into the file, in clusters */
  union {
...
struct ocfs2_extent_list {
  /*00*/
  __le16 l_tree_depth;          /* Extent tree depth from this
...
struct ocfs2_chain_list {
  /*00*/
  __le16 cl_cpg;      /* Clusters per Block Group */
...
struct ocfs2_truncate_log {
  /*00*/
  __le16 tl_count;    /* Total records in this log */
...
struct ocfs2_extent_block {
  /*00*/
  __u8 h_signature[8];    /* Signature for verification */
...
struct ocfs2_local_alloc {
  /*00*/
  __le32 la_bm_off; /* Starting bit offset in main bitmap */
...
struct ocfs2_inline_data {
  /*00*/
  __le16 id_count;        /* Number of bytes that can be used
...
struct ocfs2_dir_block_trailer {
  /*00*/
  __le64 db_compat_inode;  /* Always zero. Was inode */
...
struct ocfs2_group_desc {
  /*00*/
  __u8 bg_signature[8];        /* Signature for validation */
...
struct ocfs2_refcount_rec {
  /*00*/
  __le64 r_cpos;    /* Physical offset, in clusters */
...
struct ocfs2_refcount_list {
  /*00*/
  __le16 rl_count;        /* Maximum number of entries possible
                           * in rl_records */
...
struct ocfs2_refcount_block {
  /*00*/
  __u8 rf_signature[8];   /* Signature for verification */
...
struct ocfs2_xattr_value_root {
  /*00*/
  __le32 xr_clusters;              /* clusters covered by xattr value. */
  __le32 xr_reserved0;
...
struct ocfs2_xattr_tree_root {
  /*00*/
  __le32 xt_clusters;              /* clusters covered by xattr. */
  __le32 xt_reserved0;
...
struct ocfs2_xattr_block {
  /*00*/
  __u8 xb_signature[8];     /* Signature for verification */
...
static inline void ocfs2_xattr_set_type(struct ocfs2_xattr_entry *xe,
    int type) {
...
struct ocfs2_global_disk_dqinfo {
  /*00*/
  __le32 dqi_bgrace;  /* Grace time for space softlimit excess */
...
struct ocfs2_local_disk_dqblk {
  /*00*/
  __le64 dqb_id;    /* id this quota applies to */
...
struct ocfs2_disk_dqtrailer {
  /*00*/
  struct ocfs2_block_check dq_check;  /* Error checking */
...
static inline u32 ocfs2_get_ref_rec_low_cpos(
    const struct ocfs2_refcount_rec *rec) {
