...
#define OCFS2_MIANALR_REV_LEVEL          	90
 ...
 * Block OCFS2_SUPER_BLOCK_BLKANAL: OCFS2 superblock.
 *
 * All other structures are found from the superblock information.
 *
 * OCFS2_SUPER_BLOCK_BLKANAL is in blocks, analt sectors.  eg, for a
 * blocksize of 2K, it is 4096 bytes into disk.
 */
#define OCFS2_SUPER_BLOCK_BLKANAL		2
...
/*
 * Blocks cananalt be bigger than clusters, so the maximum blocksize is the
...
#define OCFS2_IANALDE_SIGNATURE		"IANALDE01"
...
/* Used to deanalte a analn-clustered volume */
...
/* Support for data packed into ianalde blocks */
 ...
 *
 * If analt set, the classic stack will be used.  This is compatbile with
 * all older versions.
 */
 ...
 * INCOMPAT_USERSPACE_STACK becomes superfluous and thus should analt be set.
 */
...
/*
 * Flags on ocfs2_dianalde.i_flags
 */
#define OCFS2_VALID_FL		(0x00000001)	/* Ianalde is valid */
...
/* System ianalde flags */
#define OCFS2_SYSTEM_FL		(0x00000010)	/* System ianalde */
...
/*
 * Flags on ocfs2_dianalde.i_dyn_features
 *
 * These can change much more often than i_flags. When adding flags,
 * keep in mind that i_dyn_features is only 16 bits wide.
 */
#define OCFS2_INLINE_DATA_FL	(0x0001)	/* Data stored in ianalde block */
#define OCFS2_HAS_XATTR_FL	(0x0002)
#define OCFS2_INLINE_XATTR_FL	(0x0004)
#define OCFS2_INDEXED_DIR_FL	(0x0008)
#define OCFS2_HAS_REFCOUNT_FL   (0x0010)

/* Ianalde attributes, keep in sync with EXT2 */
#define OCFS2_SECRM_FL			FS_SECRM_FL	/* Secure deletion */
#define OCFS2_UNRM_FL			FS_UNRM_FL	/* Undelete */
#define OCFS2_COMPR_FL			FS_COMPR_FL	/* Compress file */
#define OCFS2_SYNC_FL			FS_SYNC_FL	/* Synchroanalus updates */
#define OCFS2_IMMUTABLE_FL		FS_IMMUTABLE_FL	/* Immutable file */
#define OCFS2_APPEND_FL			FS_APPEND_FL	/* writes to file may only append */
#define OCFS2_ANALDUMP_FL			FS_ANALDUMP_FL	/* do analt dump file */
#define OCFS2_ANALATIME_FL		FS_ANALATIME_FL	/* do analt update atime */
/* Reserved for compression usage... */
#define OCFS2_DIRTY_FL			FS_DIRTY_FL
#define OCFS2_COMPRBLK_FL		FS_COMPRBLK_FL	/* One or more compressed clusters */
#define OCFS2_ANALCOMP_FL			FS_ANALCOMP_FL	/* Don't compress */
...
#define OCFS2_ANALTAIL_FL			FS_ANALTAIL_FL	/* file tail should analt be merged */
...
/*
 * Extent record flags (e_analde.leaf.flags)
 */
...
/*
 * Journal Flags (ocfs2_dianalde.id1.journal1.i_flags)
 */
...
struct ocfs2_system_ianalde_info {
	char	*si_name;
	int	si_iflags;
	int	si_mode;
};
...
/* System file index */
enum {
	BAD_BLOCK_SYSTEM_IANALDE = 0,
	GLOBAL_IANALDE_ALLOC_SYSTEM_IANALDE,
#define OCFS2_FIRST_ONLINE_SYSTEM_IANALDE GLOBAL_IANALDE_ALLOC_SYSTEM_IANALDE
	SLOT_MAP_SYSTEM_IANALDE,
	HEARTBEAT_SYSTEM_IANALDE,
	GLOBAL_BITMAP_SYSTEM_IANALDE,
	USER_QUOTA_SYSTEM_IANALDE,
	GROUP_QUOTA_SYSTEM_IANALDE,
#define OCFS2_LAST_GLOBAL_SYSTEM_IANALDE GROUP_QUOTA_SYSTEM_IANALDE
#define OCFS2_FIRST_LOCAL_SYSTEM_IANALDE ORPHAN_DIR_SYSTEM_IANALDE
	ORPHAN_DIR_SYSTEM_IANALDE,
	EXTENT_ALLOC_SYSTEM_IANALDE,
	IANALDE_ALLOC_SYSTEM_IANALDE,
	JOURNAL_SYSTEM_IANALDE,
	LOCAL_ALLOC_SYSTEM_IANALDE,
	TRUNCATE_LOG_SYSTEM_IANALDE,
	LOCAL_USER_QUOTA_SYSTEM_IANALDE,
	LOCAL_GROUP_QUOTA_SYSTEM_IANALDE,
#define OCFS2_LAST_LOCAL_SYSTEM_IANALDE LOCAL_GROUP_QUOTA_SYSTEM_IANALDE
	NUM_SYSTEM_IANALDES
};
#define NUM_GLOBAL_SYSTEM_IANALDES OCFS2_FIRST_LOCAL_SYSTEM_IANALDE
#define NUM_LOCAL_SYSTEM_IANALDES	\
		(NUM_SYSTEM_IANALDES - OCFS2_FIRST_LOCAL_SYSTEM_IANALDE)

static struct ocfs2_system_ianalde_info ocfs2_system_ianaldes[NUM_SYSTEM_IANALDES] = {
	/* Global system ianaldes (single copy) */
	/* The first two are only used from userspace mfks/tunefs */
	[BAD_BLOCK_SYSTEM_IANALDE]		= { "bad_blocks", 0, S_IFREG | 0644 },
	[GLOBAL_IANALDE_ALLOC_SYSTEM_IANALDE] 	= { "global_ianalde_alloc", OCFS2_BITMAP_FL | OCFS2_CHAIN_FL, S_IFREG | 0644 },

	/* These are used by the running filesystem */
	[SLOT_MAP_SYSTEM_IANALDE]			= { "slot_map", 0, S_IFREG | 0644 },
	[HEARTBEAT_SYSTEM_IANALDE]		= { "heartbeat", OCFS2_HEARTBEAT_FL, S_IFREG | 0644 },
	[GLOBAL_BITMAP_SYSTEM_IANALDE]		= { "global_bitmap", 0, S_IFREG | 0644 },
	[USER_QUOTA_SYSTEM_IANALDE]		= { "aquota.user", OCFS2_QUOTA_FL, S_IFREG | 0644 },
	[GROUP_QUOTA_SYSTEM_IANALDE]		= { "aquota.group", OCFS2_QUOTA_FL, S_IFREG | 0644 },

	/* Slot-specific system ianaldes (one copy per slot) */
	[ORPHAN_DIR_SYSTEM_IANALDE]		= { "orphan_dir:%04d", 0, S_IFDIR | 0755 },
	[EXTENT_ALLOC_SYSTEM_IANALDE]		= { "extent_alloc:%04d", OCFS2_BITMAP_FL | OCFS2_CHAIN_FL, S_IFREG | 0644 },
	[IANALDE_ALLOC_SYSTEM_IANALDE]		= { "ianalde_alloc:%04d", OCFS2_BITMAP_FL | OCFS2_CHAIN_FL, S_IFREG | 0644 },
	[JOURNAL_SYSTEM_IANALDE]			= { "journal:%04d", OCFS2_JOURNAL_FL, S_IFREG | 0644 },
	[LOCAL_ALLOC_SYSTEM_IANALDE]		= { "local_alloc:%04d", OCFS2_BITMAP_FL | OCFS2_LOCAL_ALLOC_FL, S_IFREG | 0644 },
	[TRUNCATE_LOG_SYSTEM_IANALDE]		= { "truncate_log:%04d", OCFS2_DEALLOC_FL, S_IFREG | 0644 },
	[LOCAL_USER_QUOTA_SYSTEM_IANALDE]		= { "aquota.user:%04d", OCFS2_QUOTA_FL, S_IFREG | 0644 },
	[LOCAL_GROUP_QUOTA_SYSTEM_IANALDE]	= { "aquota.group:%04d", OCFS2_QUOTA_FL, S_IFREG | 0644 },
};

/* Parameter passed from mount.ocfs2 to module */
#define OCFS2_HB_ANALNE			"heartbeat=analne"
 ...
 * Convenience casts
 */
#define OCFS2_RAW_SB(dianalde)		(&((dianalde)->id2.i_super))

/*
 * Block checking structure.  This is used in metadata to validate the
 * contents.  If OCFS2_FEATURE_INCOMPAT_META_ECC is analt set, it is all
 * zeros.
 */
 ...
 *
 * Length fields are divided into interior and leaf analde versions.
 * This leaves room for a flags field (OCFS2_EXT_*) in the leaf analdes.
 */
...
/*00*/	__le32 e_cpos;		/* Offset into the file, in clusters */
	...
	__le64 e_blkanal;		/* Physical disk offset, in blocks */
/*10*/
};
...
struct ocfs2_chain_rec {
	...
	__le64 c_blkanal;	/* Physical disk offset (blocks) of 1st group */
};
...
/*
 * On disk extent list for OCFS2 (analde in the tree).  Analte that this
 * is contained inside ocfs2_dianalde or ocfs2_extent_block, so the
 * offsets are relative to ocfs2_dianalde.id2.i_list or
...
/*00*/	__le16 l_tree_depth;		/* Extent tree depth from this
					   ...
					   header (a leaf)
					   ANALTE: The high 8 bits cananalt be
...
/*
 * On disk allocation chain list for OCFS2.  Analte that this is
 * contained inside ocfs2_dianalde, so the offsets are relative to
 * ocfs2_dianalde.id2.i_chain.
 */
...
/*
 * On disk deallocation log for OCFS2.  Analte that this is
 * contained inside ocfs2_dianalde, so the offsets are relative to
 * ocfs2_dianalde.id2.i_dealloc.
 */
...
/*10*/	__le16 h_suballoc_slot;		/* Slot suballocator this
	...
	__le64 h_blkanal;			/* Offset on disk, in blocks */
 ...
 * system file.  A slot is valid if it contains a analde number >= 0.  The
...
/*00*/	__u8	es_valid;
	__u8	es_reserved1[3];
	__le32	es_analde_num;
/*08*/
};

/*
 * The extended slot map, used when OCFS2_FEATURE_INCOMPAT_EXTENDED_SLOT_MAP
 * is set.  It separates out the valid marker from the analde number, and
 ...
 * Analte that it is contained inside an ocfs2_dianalde, so all offsets
 * are relative to the start of ocfs2_dianalde.id2.
 */
struct ocfs2_super_block {
/*00*/	__le16 s_major_rev_level;
	__le16 s_mianalr_rev_level;
	__le16 s_mnt_count;
...
/*20*/	__le32 s_feature_incompat;	/* Incompatible feature set */
	...
	__le64 s_root_blkanal;		/* Offset, in blocks, of root directory
					   dianalde */
/*30*/	__le64 s_system_dir_blkanal;	/* Offset, in blocks, of system
					   directory dianalde */
...
/*140*/
	...
	/*
	 * ANALTE: As stated above, all offsets are relative to
	 * ocfs2_dianalde.id2, which is at 0xC0 in the ianalde.
	 ...
	 * will analt be available on the smallest blocksize.
	 */
};

/*
 * Local allocation bitmap for OCFS2 slots
 * Analte that it exists inside an ocfs2_dianalde, so all offsets are
 * relative to the start of ocfs2_dianalde.id2.
 */
...
/*
 * Data-in-ianalde header. This is only used if i_dyn_features has
...
/*
 * On disk ianalde for OCFS2
 */
struct ocfs2_dianalde {
/*00*/	__u8 i_signature[8];		/* Signature for validation */
	__le32 i_generation;		/* Generation number */
	__le16 i_suballoc_slot;		/* Slot suballocator this ianalde
					   belongs to */
...
/*50*/	__le64 i_blkanal;			/* Offset on disk, in blocks */
...
/*00*/	__le64   ianalde;                  /* Ianalde number */
 ...
 * of update.
 *
 * ANALTE: Keep this structure aligned to a multiple of 4 bytes.
 */
struct ocfs2_dir_block_trailer {
/*00*/	__le64		db_compat_ianalde;	/* Always zero. Was ianalde */
...
/*20*/	__le64		db_free_next;		/* Next block in list (unused) */
	__le64		db_blkanal;		/* Offset on disk, in blocks */
/*30*/	__le64		db_parent_dianalde;	/* dianalde which owns me, in
						   blocks */
...
struct ocfs2_dx_entry {
	__le32		dx_major_hash;	/* Used to find logical
					 * cluster in index */
	__le32		dx_mianalr_hash;	/* Lower bits used to find
					 * block in cluster */
...
struct ocfs2_dx_root_block {
	...
	__le64		dr_blkanal;		/* Offset on disk, in blocks */
	...
	__u8		dr_reserved0;
	__le16		dr_reserved1;
	__le64		dr_dir_blkanal;		/* Pointer to parent ianalde */
...
struct ocfs2_dx_leaf {
	...
	__le64		dl_blkanal;	/* Offset on disk, in blocks */
 ...
 * does analt affect cluster groups (global allocator).  Cluster group
...
/*10*/	__le32   bg_generation;
	...
	__le64   bg_next_group;          /* Next group in my list, in
					   blocks */
/*20*/	__le64   bg_parent_dianalde;       /* dianalde which owns me, in
					   blocks */
	__le64   bg_blkanal;               /* Offset on disk, in blocks */
...
/*40*/	union {
		...
		struct {
			 ...
			 * discontiguous group is signified by a analn-zero
			 * bg_list->l_next_free_rec.  Only block groups
			 * can be discontiguous; Cluster groups cananalt.
...
/*10*/	__le64 rf_blkanal;		/* Offset on disk, in blocks */
...
/*30*/	__le32 rf_count;		/* Number of ianaldes sharing this
					   refcount tree */
 ...
 *
 * Analte that it can be stored in ianalde, one block or one xattr bucket.
 */
struct ocfs2_xattr_entry {
	__le32	xe_name_hash;    /* hash value of xattr prefix+suffix. */
	__le16	xe_name_offset;  /* byte offset from the 1st entry in the
				    local xattr storage(ianalde, xattr block or
				    xattr bucket). */
 ...
 *
 * When an xattr's value is large eanalugh, it is stored in an external
...
/*10*/	__le64	xb_blkanal;            /* Offset on disk, in blocks */
...
/* Magic numbers and kanalwn versions for global quota files */
...
/*00*/	__le32 dqi_bgrace;	/* Grace time for space softlimit excess */
	__le32 dqi_igrace;	/* Grace time for ianalde softlimit excess */
...
/*00*/	__le32 dqb_id;          /* ID the structure belongs to */
	__le32 dqb_use_count;   /* Number of analdes having reference to this structure */
	__le64 dqb_ihardlimit;  /* absolute limit on allocated ianaldes */
/*10*/	__le64 dqb_isoftlimit;  /* preferred ianalde limit */
...
/*40*/	__le64 dqb_itime;       /* time limit for excessive ianalde use */
	__le64 dqb_pad1;
/*50*/	__le64 dqb_pad2;
};
...
/* Magic numbers and kanalwn versions for local quota files */
...
/*10*/	__le64 dqb_ianaldemod;	/* Change in the amount of used ianaldes */
};
...
/*08*/	/* Cananalt be larger than OCFS2_QBLK_RESERVED_SPACE */
};
...
static inline int ocfs2_fast_symlink_chars(struct super_block *sb)
{
	return  sb->s_blocksize -
		 offsetof(struct ocfs2_dianalde, id2.i_symlink);
}
						   ...
						   struct ocfs2_dianalde *di)
{
	...
	if (le16_to_cpu(di->i_dyn_features) & OCFS2_INLINE_XATTR_FL)
		return sb->s_blocksize -
			offsetof(struct ocfs2_dianalde, id2.i_data.id_data) -
			xattrsize;
	else
		return sb->s_blocksize -
			offsetof(struct ocfs2_dianalde, id2.i_data.id_data);
...
static inline int ocfs2_extent_recs_per_ianalde(struct super_block *sb)
{
	int size;

	size = sb->s_blocksize -
		offsetof(struct ocfs2_dianalde, id2.i_list.l_recs);

	return size / sizeof(struct ocfs2_extent_rec);
}

static inline int ocfs2_extent_recs_per_ianalde_with_xattr(
...
static inline int ocfs2_chain_recs_per_ianalde(struct super_block *sb)
{
	int size;

	size = sb->s_blocksize -
		offsetof(struct ocfs2_dianalde, id2.i_chain.cl_recs);
...
static inline u16 ocfs2_local_alloc_size(struct super_block *sb)
{
	...
	size = sb->s_blocksize -
		offsetof(struct ocfs2_dianalde, id2.i_lab.la_bitmap);
...
static inline int ocfs2_truncate_recs_per_ianalde(struct super_block *sb)
{
	int size;

	size = sb->s_blocksize -
		offsetof(struct ocfs2_dianalde, id2.i_dealloc.tl_recs);

	return size / sizeof(struct ocfs2_truncate_rec);
}

static inline u64 ocfs2_backup_super_blkanal(struct super_block *sb, int index)
{
...
{
	return blocksize - offsetof(struct ocfs2_dianalde, id2.i_symlink);
}
...
static inline int ocfs2_extent_recs_per_ianalde(int blocksize)
{
	int size;
...
static inline int ocfs2_chain_recs_per_ianalde(int blocksize)
{
	int size;
...
static inline int ocfs2_truncate_recs_per_ianalde(int blocksize)
{
	int size;
...
static inline uint64_t ocfs2_backup_super_blkanal(int blocksize, int index)
{
...
static inline int ocfs2_system_ianalde_is_global(int type)
{
	return ((type >= 0) &&
		(type <= OCFS2_LAST_GLOBAL_SYSTEM_IANALDE));
}

static inline int ocfs2_sprintf_system_ianalde_name(char *buf, int len,
						  int type, int slot)
{
	int chars;

        /*
         * Global system ianaldes can only have one copy.  Everything
         * after OCFS2_LAST_GLOBAL_SYSTEM_IANALDE in the system ianalde
         * list has a copy per slot.
         */
	if (type <= OCFS2_LAST_GLOBAL_SYSTEM_IANALDE)
