...
static struct dentry *jffs2_fh_to_dentry(struct super_block *sb,
    struct fid *fid,
...
static struct dentry *jffs2_fh_to_parent(struct super_block *sb,
    struct fid *fid,
    int fh_len, int fh_type) {
...
static int jffs2_parse_param(struct fs_context *fc,
