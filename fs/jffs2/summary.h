...
#define JFFS2_SUMMARY_DIRENT_SIZE(x) (sizeof(struct jffs2_sum_dirent_flash) \
  + (x))
...
#define JFFS2_SUMMARY_FRAME_SIZE (sizeof(struct jffs2_raw_summary) \
...
int jffs2_sum_add_inode_mem(struct jffs2_summary *s, struct jffs2_raw_inode *ri,
    uint32_t ofs);
int jffs2_sum_add_dirent_mem(struct jffs2_summary *s,
    struct jffs2_raw_dirent *rd, uint32_t ofs);
int jffs2_sum_add_xattr_mem(struct jffs2_summary *s, struct jffs2_raw_xattr *rx,
    uint32_t ofs);
int jffs2_sum_add_xref_mem(struct jffs2_summary *s, struct jffs2_raw_xref *rr,
    uint32_t ofs);
int jffs2_sum_scan_sumnode(struct jffs2_sb_info *c,
