...
#else
static inline int jffs2_rubinmips_init(void) {
  return 0;
}
...
static inline int jffs2_dynrubin_init(void) {
  return 0;
}
...
#else
static inline int jffs2_rtime_init(void) {
  return 0;
}
...
#else
static inline int jffs2_zlib_init(void) {
  return 0;
}
...
#else
static inline int jffs2_lzo_init(void) {
  return 0;
}
