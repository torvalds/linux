 ...
 */
static struct jffs2_node_frag *new_fragment(struct jffs2_full_dnode *fn,
    uint32_t ofs, uint32_t size) {
...
/*
 * Called when there is no overlapping fragment exist. Inserts a hole before the
 *new
...
static int jffs2_add_frag_to_fragtree(struct jffs2_sb_info *c,
  ...
  /* OK. 'this' is pointing at the first frag that newfrag->ofs at least
   * partially obsoletes,
...
struct jffs2_raw_node_ref *jffs2_link_node_ref(struct jffs2_sb_info *c,
  ...
  } else if (unlikely(ref_offset(ref)
