...
#define JFFS2_INODE_INFO(i) (container_of(i, struct jffs2_inode_info, \
    vfs_inode))
...
#define jffs2_flash_write(c, ofs, len, retlen, buf) jffs2_flash_direct_write(c, \
    ofs, len, retlen, \
    buf)
#define jffs2_flash_read(c, ofs, len, retlen, \
      buf) (mtd_read((c)->mtd, ofs, len, retlen, buf))
#define jffs2_flush_wbuf_pad(c) ({ do {} while (0); (void) (c), 0; })
#define jffs2_flush_wbuf_gc(c, \
      i) ({ do {} while (0); (void) (c), (void) i, 0; })
#define jffs2_write_nand_badblock(c, jeb, bad_offset) (1)
#define jffs2_nand_flash_setup(c) (0)
#define jffs2_nand_flash_cleanup(c) do {} while (0)
#define jffs2_wbuf_dirty(c) (0)
#define jffs2_flash_writev(a, b, c, d, e, f) jffs2_flash_direct_writev(a, b, c, \
    d, e)
...
/* wbuf.c */
int jffs2_flash_writev(struct jffs2_sb_info *c, const struct kvec *vecs,
...
int jffs2_check_oob_empty(struct jffs2_sb_info *c, struct jffs2_eraseblock *jeb,
    int mode);
...
#define jffs2_nor_wbuf_flash(c) (c->mtd->type == MTD_NORFLASH \
  && !(c->mtd->flags & MTD_BIT_WRITEABLE))
