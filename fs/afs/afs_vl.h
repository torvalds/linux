...
#define AFS_VLSF_ROVOL    0x0002  /* this server holds a R/O instance of the
                                   * volume */
#define AFS_VLSF_RWVOL    0x0004  /* this server holds a R/W instance of the
                                   * volume */
#define AFS_VLSF_BACKVOL  0x0008  /* this server holds a backup instance of the
                                   * volume */
