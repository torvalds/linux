...
static int afs_show_options(struct seq_file *m, struct dentry *root) {
  ...
  switch (as->flock_mode) {
    case afs_flock_mode_unset:
      break;
    case afs_flock_mode_local:
      p = "local";
      break;
    case afs_flock_mode_openafs:
      p = "openafs";
      break;
    case afs_flock_mode_strict:
      p = "strict";
      break;
    case afs_flock_mode_write:
      p = "write";
      break;
  }
  if (p) {
...
static int afs_dynroot_test_super(struct super_block *sb,
