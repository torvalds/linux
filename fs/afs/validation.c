 ...
 */
static bool __afs_is_server_excluded(struct afs_operation *op,
 ...
 */
static int afs_is_server_excluded(struct afs_operation *op,
    struct afs_volume *volume) {
  int ret;
 ...
 */
static int afs_update_volume_creation_time(struct afs_operation *op,
    struct afs_volume *volume) {
  unsigned int snap;
 ...
 */
static void afs_update_volume_update_time(struct afs_operation *op,
    struct afs_volume *volume) {
...
static int afs_update_volume_times(struct afs_operation *op,
    struct afs_volume *volume) {
  int ret = 0;
