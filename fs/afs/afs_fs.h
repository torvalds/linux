...
enum AFS_FS_Operations {
  ...
  FSINLINEBULKSTATUS = 65536, /* AFS Fetch multiple file statuses with inline
                               * errors */
  FSFETCHDATA64 = 65537, /* AFS Fetch file data */
  FSSTOREDATA64 = 65538, /* AFS Store file data */
  FSGIVEUPALLCALLBACKS = 65539, /* AFS Give up all outstanding callbacks on a
                                 * server */
...
enum AFS_FS_Errors {
  ...
  VOFFLINE = 106,  /* volume is currently offline (more info available
                    * [VVL-spec]) */
