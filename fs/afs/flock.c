...
static inline void afs_set_lock_state(struct afs_vnode *vnode,
...
int afs_lock(struct file *file, int cmd, struct file_lock *fl) {
  ...
  switch (ret) {
    case 0:
      op = afs_flock_op_return_ok;
      break;
    case -EAGAIN:
      op = afs_flock_op_return_eagain;
      break;
    case -EDEADLK:
      op = afs_flock_op_return_edeadlk;
      break;
    default:
      op = afs_flock_op_return_error;
      break;
  }
