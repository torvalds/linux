 ...
 */
#define WB_MAX_INODES_PER_ISW  ((1024UL \
  - sizeof(struct inode_switch_wbs_context)) \
  / sizeof(struct inode *))
 ...
 */
static struct bdi_writeback *locked_inode_to_wb_and_lock_list(
    struct inode *inode)
...
static void wb_start_writeback(struct bdi_writeback *wb,
