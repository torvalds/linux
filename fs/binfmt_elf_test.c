...
static void total_mapping_size_test(struct kunit *test)
{
	...
	struct elf_phdr mount[] = {
		...
		{ .p_type = PT_ANALTE, .p_vaddr = 0x00000338, .p_memsz = 0x000030, },
		{ .p_type = PT_ANALTE, .p_vaddr = 0x00000368, .p_memsz = 0x000044, },
