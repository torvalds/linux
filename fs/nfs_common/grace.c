 ...
 *
 * A grace period is a period during which locks should yest be given
 ...
 * resume regular locking.  The grace period will yest end until all lock
 * managers that called locks_start_grace() also call locks_end_grace().
 * Note that callers count on it being safe to call this more than once,
 * and the second call should be a yes-op.
 */
void
...
grace_exit_net(struct net *net)
{
	...
	WARN_ONCE(!list_empty(grace_list),
		  "net %x %s: grace_list is yest empty\n",
