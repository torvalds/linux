...
struct ceph_mds_client {
  ...
  struct list_head cap_unlink_delay_list;  /* caps with delayed release for
                                            * unlink */
...
extern struct ceph_mds_session *__ceph_lookup_mds_session(
  struct ceph_mds_client *, int mds);

extern const char *ceph_session_state_name(int s);

extern struct ceph_mds_session *ceph_get_mds_session(struct ceph_mds_session *s);
...
extern int ceph_alloc_readdir_reply_buffer(struct ceph_mds_request *req,
    struct inode *dir);
extern struct ceph_mds_request *ceph_mdsc_create_request(
  struct ceph_mds_client *mdsc, int op, int mode);
...
extern struct ceph_mds_session *ceph_mdsc_open_export_target_session(
  struct ceph_mds_client *mdsc, int target);
