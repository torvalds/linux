...
int bch2_btree_insert_trans(struct btree_trans *, enum btree_id,
    struct bkey_i *,
...
int bch2_btree_bit_mod_buffered(struct btree_trans *, enum btree_id,
    struct bpos, bool);
...
struct jset_entry *__bch2_trans_jset_entry_alloc(struct btree_trans *,
    unsigned);

static inline struct jset_entry *btree_trans_journal_entries_top(
    struct btree_trans *trans) {
  return (void *) ((u64 *) trans->journal_entries
    + trans->journal_entries_u64s);
}

static inline struct jset_entry *bch2_trans_jset_entry_alloc(
    struct btree_trans *trans, unsigned u64s) {
...
int bch2_btree_insert_clone_trans(struct btree_trans *, enum btree_id,
    struct bkey_i *);

static inline int __must_check bch2_trans_update_buffered(
    struct btree_trans *trans,
    enum btree_id btree,
    struct bkey_i *k) {
  ...
  struct jset_entry *e
    = bch2_trans_jset_entry_alloc(trans, jset_u64s(k->k.u64s));
...
static inline struct bkey_i *__bch2_bkey_make_mut_noupdate(
    struct btree_trans *trans, struct bkey_s_c k,
...
static inline struct bkey_i *bch2_bkey_make_mut_noupdate(
    struct btree_trans *trans, struct bkey_s_c k) {
...
static inline struct bkey_i *__bch2_bkey_make_mut(struct btree_trans *trans,
    struct btree_iter *iter,
    struct bkey_s_c *k, unsigned flags,
    unsigned type, unsigned min_bytes) {
  struct bkey_i *mut
    = __bch2_bkey_make_mut_noupdate(trans, *k, type, min_bytes);
  int ret;
  if (IS_ERR(mut)) {
    return mut;
  }
...
static inline struct bkey_i *__bch2_bkey_get_mut_noupdate(
    struct btree_trans *trans,
    struct btree_iter *iter,
...
static inline struct bkey_i *bch2_bkey_get_mut_noupdate(
    struct btree_trans *trans,
    struct btree_iter *iter,
    unsigned btree_id, struct bpos pos,
    unsigned flags) {
...
static inline struct bkey_i *bch2_bkey_get_mut_minsize(
    struct btree_trans *trans,
    struct btree_iter *iter,
    unsigned btree_id, struct bpos pos,
...
static inline struct bkey_i *__bch2_bkey_alloc(struct btree_trans *trans,
    struct btree_iter *iter,
