...
#define bch2_pagecache_add_put(i) bch2_two_state_unlock(&i->ei_pagecache_lock, \
    0)
#define bch2_pagecache_add_tryget(i)  bch2_two_state_trylock( \
    &i->ei_pagecache_lock, 0)
#define bch2_pagecache_add_get(i) bch2_two_state_lock(&i->ei_pagecache_lock, 0)

#define bch2_pagecache_block_put(i) bch2_two_state_unlock(&i->ei_pagecache_lock, \
    1)
#define bch2_pagecache_block_get(i) bch2_two_state_lock(&i->ei_pagecache_lock, \
    1)
...
struct bch_inode_info *__bch2_create(struct mnt_idmap *,
    struct bch_inode_info *,
...
#define bch2_inode_update_after_write(_trans, _inode, _inode_u, \
      _fields)  ({ do {} while (0); })
...
static inline int bch2_vfs_init(void) {
  return 0;
}
