...
static inline struct bch_replicas_entry_v1 *cpu_replicas_entry(
    struct bch_replicas_cpu *r, unsigned i) {
...
static inline struct replicas_delta *replicas_delta_next(
