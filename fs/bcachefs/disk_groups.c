...
const struct bch_devs_mask *bch2_target_to_mask(struct bch_fs *c,
    unsigned target) {
...
void bch2_disk_path_to_text(struct printbuf *out, struct bch_fs *c,
    unsigned v) {
...
void bch2_disk_path_to_text_sb(struct printbuf *out, struct bch_sb *sb,
    unsigned v) {
  struct bch_sb_field_disk_groups *groups
...
int __bch2_dev_group_set(struct bch_fs *c, struct bch_dev *ca,
    const char *name) {
