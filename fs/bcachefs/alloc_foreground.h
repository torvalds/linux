...
static inline void bch2_open_bucket_put(struct bch_fs *c,
    struct open_bucket *ob) {
...
static inline void bch2_alloc_sectors_done_inlined(struct bch_fs *c,
...
static inline bool bch2_bucket_is_open(struct bch_fs *c, unsigned dev,
    u64 bucket) {
...
static inline bool bch2_bucket_is_open_safe(struct bch_fs *c, unsigned dev,
    u64 bucket) {
  bool ret;
 ...
 */
static inline void bch2_alloc_sectors_append_ptrs_inlined(struct bch_fs *c,
    struct write_point *wp,
...
static inline struct write_point_specifier writepoint_hashed(unsigned long v) {
  return (struct write_point_specifier) {
      .v = v | 1
  };
}

static inline struct write_point_specifier writepoint_ptr(
    struct write_point *wp) {
  return (struct write_point_specifier) {
      .v = (unsigned long) wp
  };
