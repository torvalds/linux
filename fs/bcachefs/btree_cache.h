...
struct btree *bch2_btree_node_get_noiter(struct btree_trans *,
    const struct bkey_i *,
...
static inline struct btree_root *bch2_btree_id_root(struct bch_fs *c,
    unsigned id) {
...
void bch2_btree_pos_to_text(struct printbuf *, struct bch_fs *,
    const struct btree *);
