...
void bch2_backpointer_k_to_text(struct printbuf *, struct bch_fs *,
    struct bkey_s_c);
...
static inline int bch2_bucket_backpointer_mod(struct btree_trans *trans,
  ...
  if (unlikely(bch2_backpointers_no_use_write_buffer)) {
    return bch2_bucket_backpointer_mod_nowritebuffer(trans, bucket, bp, orig_k,
        insert);
  }
...
static inline enum bch_data_type bkey_ptr_data_type(enum btree_id btree_id,
    unsigned level,
