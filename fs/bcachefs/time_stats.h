...
/*
 * bch2_time_stats - collect statistics on events that have a duration, with
 *nicely
 ...
 *
 * Only enabled if bch2_time_stats->quantiles_enabled has been manually set -
 *don't
 * use in new code.
 */
...
static inline struct quantiles *time_stats_to_quantiles(
    struct bch2_time_stats *stats) {
...
void __bch2_time_stats_clear_buffer(struct bch2_time_stats *,
    struct time_stat_buffer *);
 ...
 */
static inline void bch2_time_stats_update(struct bch2_time_stats *stats,
    u64 start) {
...
static inline void bch2_time_stats_quantiles_exit(
    struct bch2_time_stats_quantiles *statq) {
  bch2_time_stats_exit(&statq->stats);
}

static inline void bch2_time_stats_quantiles_init(
    struct bch2_time_stats_quantiles *statq) {
