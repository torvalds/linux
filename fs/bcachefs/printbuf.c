...
/**
 * bch2_printbuf_exit() - exit a printbuf, freeing memory it owns and poisoning
 *it
...
/*
 * bch2_printbuf_tabstop_set() - add a tabstop, n spaces from the previous
 *tabstop
 *
...
/**
 * bch2_prt_bytes_indented() - Print an array of chars, handling embedded
 *control characters
 *
 * @out:  output printbuf
 * @str:  string to print
 ...
 */
void bch2_prt_bytes_indented(struct printbuf *out, const char *str,
    unsigned count) {
