...
static struct bch_sb_field_quota *bch2_sb_get_or_create_quota(
...
int bch2_fs_quota_read(struct bch_fs *c) {
  ...
  struct bch_sb_field_quota *sb_quota
    = bch2_sb_get_or_create_quota(&c->disk_sb);
  if (!sb_quota) {
 ...
 * numbers etc.
 */
static int bch2_quota_get_state(struct super_block *sb,
