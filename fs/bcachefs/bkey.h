...
static inline void bkey_p_copy(struct bkey_packed *dst,
...
enum bkey_pack_pos_ret bch2_bkey_pack_pos_lossy(struct bkey_packed *,
    struct bpos,
    const struct btree *);
...
static inline void __bkey_unpack_key_format_checked(const struct btree *b,
    struct bkey *dst,
    const struct bkey_packed *src) {
...
static inline struct bkey bkey_unpack_key_format_checked(const struct btree *b,
    const struct bkey_packed *src) {
  struct bkey dst;
...
static inline struct bpos bkey_unpack_pos_format_checked(const struct btree *b,
    const struct bkey_packed *src) {
...
static inline void __bkey_format_add(struct bkey_format_state *s,
 ...
 */
static inline void bch2_bkey_format_add_key(struct bkey_format_state *s,
    const struct bkey *k) {
