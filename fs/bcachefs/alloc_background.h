...
static inline struct bpos alloc_freespace_pos(struct bpos pos,
    struct bch_alloc_v4 a) {
...
struct bkey_i_alloc_v4 *bch2_trans_start_alloc_update(struct btree_trans *,
    struct btree_iter *,
    struct bpos);
...
struct bkey_i_alloc_v4 *bch2_alloc_to_v4_mut(struct btree_trans *,
    struct bkey_s_c);
...
int bch2_bucket_gens_invalid(struct bch_fs *, struct bkey_s_c,
    enum bkey_invalid_flags, struct printbuf *);
void bch2_bucket_gens_to_text(struct printbuf *, struct bch_fs *,
    struct bkey_s_c);
...
static inline struct bch_backpointer *alloc_v4_backpointers(
    struct bch_alloc_v4 *a) {
  return (void *) ((u64 *) &a->v
...
static inline const struct bch_backpointer *alloc_v4_backpointers_c(
