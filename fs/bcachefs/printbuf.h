 ...
 *
 * printbuf_indent_push() and printbuf_indent_pop() increase and decrease the
 *current indent
 * level, respectively.
 *
...
__printf(2, 0) void bch2_prt_vprintf(struct printbuf *out, const char *fmt,
    va_list);
...
static inline void __prt_chars_reserved(struct printbuf *out, char c,
    unsigned n) {
