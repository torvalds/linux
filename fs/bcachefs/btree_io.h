...
static inline void set_btree_node_dirty_acct(struct bch_fs *c,
    struct btree *b) {
...
static inline void clear_btree_node_dirty_acct(struct bch_fs *c,
    struct btree *b) {
...
static inline bool bch2_maybe_compact_whiteouts(struct bch_fs *c,
    struct btree *b) {
  struct bset_tree *t;
  for_each_bset(b, t)
...
static inline struct nonce btree_nonce(struct bset *i, unsigned offset) {
  return (struct nonce) {{
                           ...
                           [1] = ((__le32 *) &i->seq)[0],
                           [2] = ((__le32 *) &i->seq)[1],
                           [3] = ((__le32 *) &i->journal_seq)[0]
                               ^ BCH_NONCE_BTREE,
                         }};
}

static inline int bset_encrypt(struct bch_fs *c, struct bset *i,
    unsigned offset) {
