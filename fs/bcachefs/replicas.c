...
static struct bch_replicas_cpu cpu_replicas_add_entry(struct bch_fs *c,
...
static int __bch2_sb_replicas_to_cpu_replicas(
...
static int __bch2_sb_replicas_v0_to_cpu_replicas(
...
static int bch2_sb_replicas_v0_validate(struct bch_sb *sb,
    struct bch_sb_field *f,
    struct printbuf *err) {
