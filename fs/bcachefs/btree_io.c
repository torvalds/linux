...
static bool btree_node_has_extra_bsets(struct bch_fs *c, unsigned offset,
    void *data) {
  struct btree_node *bn = data;
  struct btree_node_entry *bne;
  if (!offset) {
 ...
 */
static int btree_node_read_all_replicas(struct bch_fs *c, struct btree *b,
    bool sync) {
