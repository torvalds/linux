...
static inline struct nocow_lock_bucket *bucket_nocow_lock(
...
void bch2_bucket_nocow_unlock(struct bucket_nocow_lock_table *, struct bpos,
    int);
...
void bch2_nocow_locks_to_text(struct printbuf *,
