...
DECLARE_EVENT_CLASS(bpos,
    ...
    TP_printk("%llu:%llu:%u", __entry->p_inode, __entry->p_offset,
    __entry->p_snapshot)
    );
...
DECLARE_EVENT_CLASS(fs_str,
    ...
    TP_printk("%d,%d\n%s", MAJOR(__entry->dev), MINOR(__entry->dev),
    __get_str(str))
    );
...
TRACE_EVENT(journal_reclaim_start,
    ...
    TP_printk(
    "%d,%d direct %u kicked %u min %llu key cache %llu btree cache %llu/%llu key cache %llu/%llu",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->direct,
    __entry->kicked,
    __entry->min_nr,
...
TRACE_EVENT(btree_path_relock_fail,
  ...
  scnprintf(__entry->node, sizeof(__entry->node), "%px", b);
    ...
    TP_printk(
    "%s %pS btree %s pos %llu:%llu:%u level %u node %s held %u:%u lock count %u:%u iter seq %u lock seq %u",
    __entry->trans_fn,
    (void *) __entry->caller_ip,
    bch2_btree_id_str(__entry->btree_id),
    __entry->pos_inode,
...
TRACE_EVENT(btree_path_upgrade_fail,
    ...
    TP_printk(
    "%s %pS btree %s pos %llu:%llu:%u level %u locked %u held %u:%u lock count %u:%u iter seq %u lock seq %u",
    __entry->trans_fn,
    (void *) __entry->caller_ip,
    bch2_btree_id_str(__entry->btree_id),
    __entry->pos_inode,
...
DECLARE_EVENT_CLASS(bucket_alloc,
    ...
    TP_printk(
    "reserve %s bucket %u:%llu free %llu avail %llu copygc_wait %llu/%lli seen %llu open %llu need_journal_commit %llu nouse %llu nocow %llu nonblocking %u err %s",
    __entry->reserve,
    __entry->dev,
    __entry->bucket,
    __entry->free,
...
TRACE_EVENT(discard_buckets,
    ...
    TP_printk(
    "%d%d seen %llu open %llu need_journal_commit %llu discarded %llu err %s",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->seen,
    __entry->open,
    __entry->need_journal_commit,
...
TRACE_EVENT(copygc,
    ...
    TP_printk(
    "%d,%d sectors moved %llu remain %llu buckets moved %llu remain %llu",
    MAJOR(__entry->dev), MINOR(__entry->dev),
...
TRACE_EVENT(trans_restart_upgrade,
    ...
    TP_printk(
    "%s %pS btree %s pos %llu:%llu:%u locks_want %u -> %u level %u path seq %u node seq %u",
    __entry->trans_fn,
    (void *) __entry->caller_ip,
    bch2_btree_id_str(__entry->btree_id),
    __entry->pos_inode,
