...
static inline bool bch2_version_compatible(u16 version) {
  return BCH_VERSION_MAJOR(version) <= BCH_VERSION_MAJOR(
...
struct bch_sb_field *bch2_sb_field_get_id(struct bch_sb *,
...
#define bch2_sb_field_resize(_sb, _name, _u64s)       \
  field_to_type(bch2_sb_field_resize_id(_sb, BCH_SB_FIELD_ ## _name, \
    _u64s), _name)

struct bch_sb_field *bch2_sb_field_get_minsize_id(struct bch_sb_handle *,
    enum bch_sb_field_type, unsigned);
#define bch2_sb_field_get_minsize(_sb, _name, _u64s)        \
  field_to_type(bch2_sb_field_get_minsize_id(_sb, BCH_SB_FIELD_ ## _name, \
    _u64s), _name)
...
int bch2_read_super_silent(const char *, struct bch_opts *,
