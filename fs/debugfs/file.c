...
static ssize_t debugfs_attr_write_xsigned(struct file *file,
...
/**
 * debugfs_create_size_t - create a debugfs file that is used to read and write
 *an size_t value
 * @name: a pointer to a string containing the name of the file to create.
 * @mode: the permission that the file should have
 * @parent: a pointer to the parent dentry for this file.  This should be a
...
/**
 * debugfs_create_bool - create a debugfs file that is used to read and write a
 *boolean value
 * @name: a pointer to a string containing the name of the file to create.
 * @mode: the permission that the file should have
 * @parent: a pointer to the parent dentry for this file.  This should be a
...
static ssize_t debugfs_write_file_str(struct file *file,
...
struct dentry *debugfs_create_blob(const char *name, umode_t mode,
  ...
  return debugfs_create_file_unsafe(name, mode & 0644, parent, blob,
      &fops_blob);
}
