 ...
 */
STATIC void xfs_bui_item_format(
    struct xfs_log_item *lip,
 ...
 */
STATIC void xfs_bui_item_unpin(
    struct xfs_log_item *lip,
    int remove) {
  struct xfs_bui_log_item *buip = BUI_ITEM(lip);
 ...
 */
STATIC void xfs_bui_item_release(
    struct xfs_log_item *lip) {
 ...
 */
STATIC struct xfs_bui_log_item *xfs_bui_init(
    struct xfs_mount *mp) {
  struct xfs_bui_log_item *buip;
 ...
 */
STATIC void xfs_bud_item_format(
    struct xfs_log_item *lip,
    struct xfs_log_vec *lv) {
 ...
 * BUD.
 */
STATIC void xfs_bud_item_release(
    struct xfs_log_item *lip) {
  struct xfs_bud_log_item *budp = BUD_ITEM(lip);
...
static struct xfs_log_item *xfs_bud_item_intent(
    struct xfs_log_item *lip) {
...
static int xfs_bmap_update_diff_items(
    void *priv,
...
STATIC void xfs_bmap_update_log_item(
    struct xfs_trans *tp,
    struct xfs_bui_log_item *buip,
...
static struct xfs_log_item *xfs_bmap_update_create_done(
    struct xfs_trans *tp,
...
static inline void xfs_bmap_update_get_group(
    struct xfs_mount *mp,
    struct xfs_bmap_intent *bi) {
  xfs_agnumber_t agno;
  if (xfs_ifork_is_realtime(bi->bi_owner, bi->bi_whichfork)) {
...
static inline void xfs_bmap_update_put_group(
    struct xfs_bmap_intent *bi) {
  if (xfs_ifork_is_realtime(bi->bi_owner, bi->bi_whichfork)) {
    return;
  }
...
STATIC void xfs_bmap_update_cancel_item(
...
STATIC int xfs_bmap_update_finish_item(
    struct xfs_trans *tp,
...
STATIC void xfs_bmap_update_abort_intent(
    struct xfs_log_item *intent) {
  xfs_bui_release(BUI_ITEM(intent));
}

/* Is this recovered BUI ok? */
static inline bool xfs_bui_validate(
    struct xfs_mount *mp,
    struct xfs_bui_log_item *buip) {
  struct xfs_map_extent *map;
...
static inline struct xfs_bmap_intent *xfs_bui_recover_work(
    struct xfs_mount *mp,
 ...
 */
STATIC int xfs_bmap_recover_work(
    struct xfs_defer_pending *dfp,
...
static struct xfs_log_item *xfs_bmap_relog_intent(
    struct xfs_trans *tp,
    struct xfs_log_item *intent,
...
STATIC bool xfs_bui_item_match(
    struct xfs_log_item *lip,
    uint64_t intent_id) {
...
static inline void xfs_bui_copy_format(
 ...
 * LSN.
 */
STATIC int xlog_recover_bui_commit_pass2(
    struct xlog *log,
 ...
 */
STATIC int xlog_recover_bud_commit_pass2(
    struct xlog *log,
    struct list_head *buffer_list,
    struct xlog_recover_item *item,
    xfs_lsn_t lsn) {
