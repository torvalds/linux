...
STATIC void xchk_rmapbt_xref_refc(
    struct xfs_scrub *sc,
 ...
 * flags.
 */
STATIC void xchk_rmapbt_check_unwritten_in_keyflags(
...
static inline bool xchk_rmapbt_is_shareable(
    struct xfs_scrub *sc,
...
STATIC void xchk_rmapbt_check_overlapping(
    struct xchk_btree *bs,
    struct xchk_rmap *cr,
    const struct xfs_rmap_irec *irec) {
...
static inline bool xchk_rmap_mergeable(
    struct xchk_rmap *cr,
...
STATIC void xchk_rmapbt_check_mergeable(
    struct xchk_btree *bs,
    struct xchk_rmap *cr,
    const struct xfs_rmap_irec *irec) {
  if (bs->sc->sm->sm_flags & XFS_SCRUB_OFLAG_CORRUPT) {
...
STATIC int xchk_rmapbt_mark_bitmap(
    struct xchk_btree *bs,
    struct xchk_rmap *cr,
    const struct xfs_rmap_irec *irec) {
  struct xfs_scrub *sc = bs->sc;
...
STATIC int xchk_rmapbt_walk_agfl(
    struct xfs_mount *mp,
    xfs_agblock_t agbno,
    void *priv) {
 ...
 * XCORRUPT.
 */
STATIC int xchk_rmapbt_walk_ag_metadata(
    struct xfs_scrub *sc,
    struct xchk_rmap *cr) {
 ...
 */
STATIC void xchk_rmapbt_check_bitmaps(
    struct xfs_scrub *sc,
    struct xchk_rmap *cr) {
...
void xchk_xref_is_only_owned_by(
    struct xfs_scrub *sc,
    xfs_agblock_t bno,
    xfs_extlen_t len,
...
void xchk_xref_is_not_owned_by(
    struct xfs_scrub *sc,
    xfs_agblock_t bno,
    xfs_extlen_t len,
    const struct xfs_owner_info *oinfo) {
