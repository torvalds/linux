 ...
 * metadata.
 */
STATIC int xchk_fscount_warmup(
    struct xfs_scrub *sc) {
...
static inline int xchk_fsfreeze(
    struct xfs_scrub *sc) {
  int error;
 ...
 */
STATIC int xchk_fscounters_freeze(
    struct xfs_scrub *sc) {
...
STATIC void xchk_fscounters_cleanup(
    void *buf) {
...
static int xchk_fscount_btreeblks(
    struct xfs_scrub *sc,
    struct xchk_fscounters *fsc,
    xfs_agnumber_t agno) {
  xfs_extlen_t blocks;
 ...
 * adjusted.
 */
STATIC int xchk_fscount_aggregate_agcounts(
    struct xfs_scrub *sc,
    struct xchk_fscounters *fsc) {
  struct xfs_mount *mp = sc->mp;
...
#ifdef CONFIG_XFS_RT
STATIC int xchk_fscount_add_frextent(
    struct xfs_mount *mp,
    struct xfs_trans *tp,
...
STATIC int xchk_fscount_count_frextents(
    struct xfs_scrub *sc,
    struct xchk_fscounters *fsc) {
  struct xfs_mount *mp = sc->mp;
  int error;
 ...
 */
static inline bool xchk_fscount_within_range(
    struct xfs_scrub *sc,
