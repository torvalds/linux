...
STATIC int xrep_refc_check_ext(
    struct xfs_scrub *sc,
...
STATIC int xrep_refc_stash_cow(
    struct xrep_refc *rr,
    xfs_agblock_t agbno,
    xfs_extlen_t len) {
...
static inline bool xrep_refc_rmap_shareable(
    struct xfs_mount *mp,
 ...
 * a shared extent.
 */
STATIC int xrep_refc_walk_rmaps(
    struct xrep_refc *rr,
...
static inline uint32_t xrep_refc_encode_startblock(
...
static int xrep_refc_extent_cmp(
    const void *a,
    const void *b) {
 ...
 */
STATIC int xrep_refc_sort_records(
    struct xrep_refc *rr) {
  struct xfs_refcount_irec irec;
  xfarray_idx_t cur;
 ...
 */
static int xrep_refc_push_rmaps_at(
    struct xrep_refc *rr,
...
STATIC int xrep_refc_find_refcounts(
    struct xrep_refc *rr) {
  struct xfs_scrub *sc = rr->sc;
  struct rcbag *rcstack;
...
STATIC int xrep_refc_get_records(
...
STATIC int xrep_refc_claim_block(
    struct xfs_btree_cur *cur,
...
STATIC int xrep_refc_reset_counters(
    struct xrep_refc *rr) {
  struct xfs_scrub *sc = rr->sc;
 ...
 */
STATIC int xrep_refc_build_new_tree(
    struct xrep_refc *rr) {
  struct xfs_scrub *sc = rr->sc;
 ...
 */
STATIC int xrep_refc_remove_old_tree(
    struct xrep_refc *rr) {
  struct xfs_scrub *sc = rr->sc;
  struct xfs_perag *pag = sc->sa.pag;
  int error;
