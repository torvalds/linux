...
xfs_dqtype_t xchk_quota_to_dqtype(
    struct xfs_scrub *sc) {
...
STATIC int xchk_quota_item_bmap(
    struct xfs_scrub *sc,
    struct xfs_dquot *dq,
...
static inline void xchk_quota_item_timer(
    struct xfs_scrub *sc,
    xfs_fileoff_t offset,
...
STATIC int xchk_quota_data_fork(
    struct xfs_scrub *sc) {
  struct xfs_bmbt_irec irec = {
    0
  };
