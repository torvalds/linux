...
STATIC int xrep_abt_check_free_ext(
    struct xfs_scrub *sc,
 ...
 */
static int xrep_bnobt_extent_cmp(
    const void *a,
    const void *b) {
 ...
 * physical space.
 */
STATIC int xrep_bnobt_sort_records(
    struct xrep_abt *ra) {
  struct xfs_alloc_rec_incore arec;
 ...
 * block number.
 */
static int xrep_cntbt_extent_cmp(
    const void *a,
    const void *b) {
  const struct xfs_alloc_rec_incore *ap = a;
  const struct xfs_alloc_rec_incore *bp = b;
 ...
 */
STATIC int xrep_cntbt_sort_records(
    struct xrep_abt *ra,
    bool is_resort) {
 ...
 */
STATIC int xrep_abt_find_freespace(
    struct xrep_abt *ra) {
  struct xfs_scrub *sc = ra->sc;
 ...
 */
STATIC int xrep_abt_reserve_space(
    struct xrep_abt *ra,
...
STATIC int xrep_abt_dispose_one(
    struct xrep_abt *ra,
 ...
 * (deferred) means.
 */
STATIC void xrep_abt_dispose_reservations(
    struct xrep_abt *ra,
    int error) {
...
STATIC int xrep_abt_get_records(
    struct xfs_btree_cur *cur,
    unsigned int idx,
...
STATIC int xrep_abt_claim_block(
    struct xfs_btree_cur *cur,
 ...
 */
STATIC int xrep_abt_reset_counters(
    struct xrep_abt *ra) {
  struct xfs_scrub *sc = ra->sc;
  struct xfs_perag *pag = sc->sa.pag;
  struct xfs_agf *agf = sc->sa.agf_bp->b_addr;
 ...
 */
STATIC int xrep_abt_build_new_trees(
    struct xrep_abt *ra) {
  struct xfs_scrub *sc = ra->sc;
  struct xfs_btree_cur *bno_cur;
  struct xfs_btree_cur *cnt_cur;
 ...
 */
STATIC int xrep_abt_remove_old_trees(
    struct xrep_abt *ra) {
