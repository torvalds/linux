 ...
 */
STATIC int xchk_inobt_xref_finobt(
    struct xfs_scrub *sc,
 ...
 */
STATIC void xchk_inobt_chunk_xref_finobt(
    struct xfs_scrub *sc,
    struct xfs_inobt_rec_incore *irec,
    xfs_agino_t agino,
 ...
 */
STATIC int xchk_finobt_xref_inobt(
    struct xfs_scrub *sc,
    struct xfs_inobt_rec_incore *frec,
    xfs_agino_t agino,
    bool ffree,
 ...
 */
STATIC void xchk_finobt_chunk_xref_inobt(
    struct xfs_scrub *sc,
    struct xfs_inobt_rec_incore *frec,
    xfs_agino_t agino,
    unsigned int nr_inodes) {
...
STATIC bool xchk_iallocbt_chunk(
 ...
 */
STATIC int xchk_iallocbt_check_cluster_ifree(
    struct xchk_btree *bs,
    struct xfs_inobt_rec_incore *irec,
 ...
 */
STATIC int xchk_iallocbt_check_cluster(
    struct xchk_btree *bs,
    struct xfs_inobt_rec_incore *irec,
 ...
 */
STATIC void xchk_iallocbt_rec_alignment(
    struct xchk_btree *bs,
    struct xfs_inobt_rec_incore *irec) {
 ...
 */
STATIC void xchk_iallocbt_xref_rmap_btreeblks(
    struct xfs_scrub *sc) {
 ...
 */
STATIC void xchk_iallocbt_xref_rmap_inodes(
    struct xfs_scrub *sc,
    unsigned long long inodes) {
  xfs_filblks_t blocks;
...
static inline void xchk_xref_inode_check(
    struct xfs_scrub *sc,
    xfs_agblock_t agbno,
    xfs_extlen_t len,
...
void xchk_xref_is_not_inode_chunk(
    struct xfs_scrub *sc,
    xfs_agblock_t agbno,
    xfs_extlen_t len) {
