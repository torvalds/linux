...
static inline int xrep_trans_commit(
    struct xfs_scrub *sc) {
...
static inline xfs_extlen_t xrep_calc_ag_resblks(
    struct xfs_scrub *sc) {
  return 0;
}

static inline int xrep_reset_perag_resv(
    struct xfs_scrub *sc) {
...
static inline int xrep_setup_nothing(
    struct xfs_scrub *sc) {
  return 0;
}
