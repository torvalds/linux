 ...
 */
STATIC int xrep_cow_mark_file_range(
    struct xrep_cow *xc,
 ...
 * result in @dst.
 */
static inline void xrep_cow_trim_refcount(
    struct xrep_cow *xc,
...
STATIC int xrep_cow_mark_shared_staging(
 ...
 */
STATIC int xrep_cow_mark_missing_staging(
    struct xfs_btree_cur *cur,
    const struct xfs_refcount_irec *rec,
    void *priv) {
  struct xrep_cow *xc = priv;
 ...
 */
STATIC int xrep_cow_mark_missing_staging_rmap(
    struct xfs_btree_cur *cur,
 ...
 */
STATIC int xrep_cow_find_bad(
    struct xrep_cow *xc) {
  struct xfs_refcount_irec rc_low = {
    0
  };
  struct xfs_refcount_irec rc_high = {
    0
  };
  struct xfs_rmap_irec rm_low = {
    0
  };
  struct xfs_rmap_irec rm_high = {
    0
  };
 ...
 */
static inline int xrep_cow_find_mapping(
    struct xrep_cow *xc,
 ...
 */
static inline void xrep_cow_replace_mapping(
    struct xfs_inode *ip,
    struct xfs_iext_cursor *icur,
 ...
 */
STATIC int xrep_cow_replace_range(
    struct xrep_cow *xc,
    xfs_fileoff_t startoff,
