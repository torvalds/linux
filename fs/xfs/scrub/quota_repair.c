 ...
 */
STATIC int xrep_quota_item_fill_bmap_hole(
    struct xfs_scrub *sc,
    struct xfs_dquot *dq,
...
STATIC int xrep_quota_item_bmap(
    struct xfs_scrub *sc,
    struct xfs_dquot *dq,
    bool *dirty) {
  struct xfs_bmbt_irec irec;
...
static inline void xrep_quota_item_timer(
    struct xfs_scrub *sc,
...
STATIC void xrep_quota_fix_timer(
    struct xfs_mount *mp,
 ...
 * joined.
 */
STATIC int xrep_quota_data_fork(
    struct xfs_scrub *sc,
    xfs_dqtype_t dqtype) {
  struct xfs_bmbt_irec irec = {
    0
 ...
 */
STATIC int xrep_quota_problems(
    struct xfs_scrub *sc,
    xfs_dqtype_t dqtype) {
