...
STATIC void rcbagbt_init_key_from_rec(
...
STATIC void rcbagbt_init_rec_from_cur(
...
STATIC int64_t rcbagbt_key_diff(
    struct xfs_btree_cur *cur,
...
STATIC int64_t rcbagbt_diff_two_keys(
    struct xfs_btree_cur *cur,
...
STATIC int rcbagbt_keys_inorder(
    struct xfs_btree_cur *cur,
    const union xfs_btree_key *k1,
    const union xfs_btree_key *k2) {
  const struct rcbag_key *kp1 = (const struct rcbag_key *) k1;
...
STATIC int rcbagbt_recs_inorder(
    struct xfs_btree_cur *cur,
...
static xfs_failaddr_t rcbagbt_verify(
    struct xfs_buf *bp) {
...
struct xfs_btree_cur *rcbagbt_mem_cursor(
    struct xfs_mount *mp,
    struct xfs_trans *tp,
...
static inline unsigned int rcbagbt_block_maxrecs(
...
unsigned long long rcbagbt_calc_size(
