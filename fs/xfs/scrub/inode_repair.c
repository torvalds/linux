 ...
 */
STATIC void xrep_dinode_buf_core(
    struct xfs_scrub *sc,
    struct xfs_buf *bp,
...
STATIC void xrep_dinode_header(
    struct xfs_scrub *sc,
 ...
 */
STATIC int xrep_dinode_findmode_dirent(
    struct xfs_scrub *sc,
    struct xfs_inode *dp,
 ...
 * scrub target inode.
 */
STATIC int xrep_dinode_findmode_walk_directory(
    struct xrep_inode *ri,
    struct xfs_inode *dp) {
 ...
 */
STATIC int xrep_dinode_find_mode(
    struct xrep_inode *ri,
    uint16_t *mode) {
  struct xfs_scrub *sc = ri->sc;
  struct xfs_inode *dp;
 ...
 */
STATIC void xrep_dinode_zap_symlink(
    struct xrep_inode *ri,
    struct xfs_dinode *dip) {
  struct xfs_scrub *sc = ri->sc;
  char *p;
 ...
 * dentry cache.
 */
STATIC void xrep_dinode_zap_dir(
    struct xrep_inode *ri,
    struct xfs_dinode *dip) {
  struct xfs_scrub *sc = ri->sc;
  struct xfs_mount *mp = sc->mp;
...
STATIC void xrep_dinode_extsize_hints(
    struct xfs_scrub *sc,
    struct xfs_dinode *dip) {
  struct xfs_mount *mp = sc->mp;
  uint64_t flags2 = be64_to_cpu(dip->di_flags2);
...
STATIC int xrep_dinode_walk_rmap(
...
STATIC int xrep_dinode_count_ag_rmaps(
    struct xrep_inode *ri,
...
STATIC int xrep_dinode_count_rmaps(
    struct xrep_inode *ri) {
  struct xfs_perag *pag;
  xfs_agnumber_t agno;
  int error;
...
STATIC bool xrep_dinode_bad_extents_fork(
    struct xfs_scrub *sc,
    struct xfs_dinode *dip,
...
STATIC bool xrep_dinode_bad_bmbt_fork(
    struct xfs_scrub *sc,
    struct xfs_dinode *dip,
    unsigned int dfork_size,
    int whichfork) {
 ...
 * ifork formatters.
 */
STATIC bool xrep_dinode_check_dfork(
    struct xfs_scrub *sc,
    struct xfs_dinode *dip,
    uint16_t mode) {
  void *dfork_ptr;
...
static void xrep_dinode_set_data_nextents(
    struct xfs_dinode *dip,
...
static void xrep_dinode_set_attr_nextents(
    struct xfs_dinode *dip,
    xfs_extnum_t nextents) {
  if (xfs_dinode_has_large_extent_counts(dip)) {
...
STATIC void xrep_dinode_zap_dfork(
    struct xrep_inode *ri,
    struct xfs_dinode *dip,
    uint16_t mode) {
  struct xfs_scrub *sc = ri->sc;
 ...
 * ifork formatters.
 */
STATIC bool xrep_dinode_check_afork(
    struct xfs_scrub *sc,
    struct xfs_dinode *dip) {
 ...
 */
STATIC void xrep_dinode_zap_afork(
    struct xrep_inode *ri,
    struct xfs_dinode *dip,
    uint16_t mode) {
  struct xfs_scrub *sc = ri->sc;
...
STATIC void xrep_dinode_ensure_forkoff(
    struct xrep_inode *ri,
    struct xfs_dinode *dip,
    uint16_t mode) {
 ...
 */
STATIC void xrep_dinode_zap_forks(
    struct xrep_inode *ri,
    struct xfs_dinode *dip) {
  struct xfs_scrub *sc = ri->sc;
  xfs_extnum_t data_extents;
...
STATIC int xrep_dinode_problems(
    struct xrep_inode *ri) {
  struct xfs_scrub *sc = ri->sc;
  int error;
...
STATIC int xrep_inode_blockcounts(
    struct xfs_scrub *sc) {
...
static inline void xrep_clamp_timestamp(
    struct xfs_inode *ip,
...
STATIC void xrep_inode_timestamps(
    struct xfs_inode *ip) {
 ...
 * up that mess.
 */
STATIC void xrep_inode_blockdir_size(
    struct xfs_scrub *sc) {
...
STATIC void xrep_inode_sfdir_size(
    struct xfs_scrub *sc) {
  struct xfs_ifork *ifp;
 ...
 */
STATIC void xrep_inode_dir_size(
    struct xfs_scrub *sc) {
...
STATIC void xrep_inode_extsize(
    struct xfs_scrub *sc) {
...
STATIC int xrep_inode_problems(
    struct xfs_scrub *sc) {
  int error;
