...
STATIC int xrep_agf_walk_allocbt(
...
STATIC int xrep_agf_check_agfl_block(
    struct xfs_mount *mp,
    xfs_agblock_t agbno,
    void *priv) {
...
static inline bool xrep_check_btree_root(
    struct xfs_scrub *sc,
 ...
 */
STATIC int xrep_agf_find_btrees(
    struct xfs_scrub *sc,
 ...
 */
STATIC void xrep_agf_init_header(
    struct xfs_scrub *sc,
    struct xfs_buf *agf_bp,
...
STATIC void xrep_agf_set_roots(
    struct xfs_scrub *sc,
    struct xfs_agf *agf,
    struct xrep_find_ag_btree *fab) {
...
STATIC int xrep_agf_calc_from_btrees(
    struct xfs_scrub *sc,
    struct xfs_buf *agf_bp) {
  struct xrep_agf_allocbt raa = {
    .sc = sc
  };
...
STATIC int xrep_agf_commit_new(
    struct xfs_scrub *sc,
    struct xfs_buf *agf_bp) {
...
STATIC int xrep_agfl_walk_rmap(
    struct xfs_btree_cur *cur,
...
STATIC int xrep_agfl_check_extent(
    uint32_t agbno,
    uint32_t len,
    void *priv) {
  struct xrep_agfl *ra = priv;
 ...
 */
STATIC int xrep_agfl_collect_blocks(
    struct xfs_scrub *sc,
    struct xfs_buf *agf_bp,
...
STATIC void xrep_agfl_update_agf(
    struct xfs_scrub *sc,
    struct xfs_buf *agf_bp,
    xfs_agblock_t flcount) {
  struct xfs_agf *agf = agf_bp->b_addr;
...
STATIC int xrep_agfl_init_header(
    struct xfs_scrub *sc,
    struct xfs_buf *agfl_bp,
    struct xagb_bitmap *agfl_extents,
    xfs_agblock_t flcount) {
 ...
 */
STATIC int xrep_agi_find_btrees(
    struct xfs_scrub *sc,
    struct xrep_find_ag_btree *fab) {
  struct xfs_buf *agf_bp;
  struct xfs_mount *mp = sc->mp;
 ...
 * that we know which in-core state needs to be reinitialized.
 */
STATIC void xrep_agi_init_header(
    struct xfs_scrub *sc,
...
STATIC void xrep_agi_set_roots(
    struct xfs_scrub *sc,
    struct xfs_agi *agi,
    struct xrep_find_ag_btree *fab) {
...
STATIC int xrep_agi_calc_from_btrees(
    struct xfs_scrub *sc,
    struct xfs_buf *agi_bp) {
  struct xfs_btree_cur *cur;
  struct xfs_agi *agi = agi_bp->b_addr;
...
STATIC int xrep_agi_commit_new(
    struct xfs_scrub *sc,
    struct xfs_buf *agi_bp) {
  struct xfs_perag *pag;
  struct xfs_agi *agi = agi_bp->b_addr;
