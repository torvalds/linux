...
static void xqcheck_dqacct_free(
    void *ptr,
    void *arg) {
...
static int xqcheck_update_incore_counts(
    struct xqcheck *xqc,
...
static int xqcheck_dqacct_obj_cmpfn(
...
STATIC struct xqcheck_dqtrx *xqcheck_get_dqtrx(
 ...
 */
static int xqcheck_mod_live_ino_dqtrx(
 ...
 */
static int xqcheck_apply_live_dqtrx(
    struct notifier_block *nb,
    unsigned long action,
    void *data) {
...
STATIC int xqcheck_collect_inode(
    struct xqcheck *xqc,
    struct xfs_inode *ip) {
...
STATIC int xqcheck_collect_counts(
    struct xqcheck *xqc) {
 ...
 * lock.
 */
STATIC int xqcheck_compare_dquot(
    struct xqcheck *xqc,
    xfs_dqtype_t dqtype,
    struct xfs_dquot *dq) {
  struct xqcheck_dquot xcdq;
 ...
 */
STATIC int xqcheck_walk_observations(
    struct xqcheck *xqc,
    xfs_dqtype_t dqtype) {
  struct xqcheck_dquot xcdq;
  struct xfs_dquot *dq;
...
STATIC int xqcheck_compare_dqtype(
    struct xqcheck *xqc,
    xfs_dqtype_t dqtype) {
...
static void xqcheck_teardown_scan(
    void *priv) {
