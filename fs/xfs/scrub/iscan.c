 ...
 */
STATIC void xchk_iscan_mask_skipino(
 ...
 */
STATIC int xchk_iscan_find_next(
    struct xchk_iscan *iscan,
 ...
 */
static inline void xchk_iscan_move_cursor(
    struct xchk_iscan *iscan,
    xfs_agnumber_t agno,
    xfs_agino_t agino) {
  struct xfs_scrub *sc = iscan->sc;
 ...
 */
static inline void xchk_iscan_finish(
    struct xchk_iscan *iscan) {
  mutex_lock(&iscan->lock);
 ...
 */
STATIC int xchk_iscan_iget_retry(
    struct xchk_iscan *iscan,
    bool wait) {
 ...
 * scanned.
 */
STATIC void xchk_iscan_finish_batch(
    struct xchk_iscan *iscan) {
 ...
 */
STATIC int xchk_iscan_iter_batch(
    struct xchk_iscan *iscan) {
  struct xfs_scrub *sc = iscan->sc;
  int ret;
...
static inline xfs_ino_t xchk_iscan_rotor(
    struct xfs_mount *mp) {
 ...
 */
static inline bool xchk_iscan_skipped(
 ...
 */
bool xchk_iscan_want_live_update(
    struct xchk_iscan *iscan,
    xfs_ino_t ino) {
  bool ret = false;
  if (xchk_iscan_aborted(iscan)) {
