...
static xfarray_idx_t xfarray_idx(
...
static inline bool xfarray_is_unset(
    struct xfarray *array,
    loff_t pos) {
 ...
 * necessary.
 */
static inline int xfarray_find_data(
    struct xfarray *array,
    xfarray_idx_t *cur,
    loff_t *pos) {
...
static inline int xfarray_sort_load(
...
static inline int xfarray_sort_store(
    struct xfarray_sortinfo *si,
    xfarray_idx_t idx,
    void *ptr) {
...
static inline int xfarray_sort_cmp(
    struct xfarray_sortinfo *si,
    const void *a,
    const void *b) {
...
static inline bool xfarray_sort_terminated(
    struct xfarray_sortinfo *si,
    int *error) {
  /*
...
static inline bool xfarray_want_isort(
    struct xfarray_sortinfo *si,
    xfarray_idx_t start,
    xfarray_idx_t end) {
  /*
...
static inline xfarray_idx_t *xfarray_pivot_array_idx(
    void *pa,
    size_t pa_recsz,
    unsigned int pa_idx) {
 ...
 */
STATIC int xfarray_qsort_pivot(
    struct xfarray_sortinfo *si,
    xfarray_idx_t lo,
    xfarray_idx_t hi) {
 ...
 */
static inline int xfarray_qsort_push(
    struct xfarray_sortinfo *si,
    xfarray_idx_t *si_lo,
    xfarray_idx_t *si_hi,
    xfarray_idx_t lo,
...
static inline void xfarray_sort_scan_done(
    struct xfarray_sortinfo *si) {
  if (si->folio) {
 ...
 */
static inline int xfarray_sort_scan(
    struct xfarray_sortinfo *si,
    xfarray_idx_t idx,
    void **ptrp) {
