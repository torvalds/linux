 ...
 */
STATIC void xchk_allocbt_xref_other(
    struct xfs_scrub *sc,
    xfs_agblock_t agbno,
    xfs_extlen_t len) {
...
STATIC void xchk_allocbt_mergeable(
