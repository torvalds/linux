 ...
 */
static inline bool xchk_should_terminate(
    struct xfs_scrub *sc,
    int *error) {
  /*
...
#else
static inline int xchk_setup_rtbitmap(struct xfs_scrub *sc) {
  return -ENOENT;
}

static inline int xchk_setup_rtsummary(struct xfs_scrub *sc) {
  return -ENOENT;
}
...
#else
static inline int xchk_ino_dqattach(struct xfs_scrub *sc) {
  return 0;
}

static inline int xchk_setup_quota(struct xfs_scrub *sc) {
  return -ENOENT;
}

static inline int xchk_setup_quotacheck(struct xfs_scrub *sc) {
  return -ENOENT;
}
 ...
 */
static inline int xchk_ag_init_existing(
    struct xfs_scrub *sc,
    xfs_agnumber_t agno,
    struct xchk_ag *sa) {
 ...
 */
static inline int xchk_iget_safe(struct xfs_scrub *sc, xfs_ino_t inum,
