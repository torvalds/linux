 ...
 */
static bool __xchk_btree_process_error(
    struct xfs_scrub *sc,
...
bool xchk_btree_xref_process_error(
    struct xfs_scrub *sc,
    struct xfs_btree_cur *cur,
    int level,
    int *error) {
...
static void __xchk_btree_set_corrupt(
    struct xfs_scrub *sc,
    struct xfs_btree_cur *cur,
    int level,
    __u32 errflag,
...
void xchk_btree_xref_set_corrupt(
    struct xfs_scrub *sc,
    struct xfs_btree_cur *cur,
    int level) {
...
STATIC int xchk_btree_block_check_sibling(
    struct xchk_btree *bs,
    int level,
    int direction,
...
STATIC int xchk_btree_block_check_siblings(
    struct xchk_btree *bs,
    struct xfs_btree_block *block) {
  struct xfs_btree_cur *cur = bs->cur;
 ...
 */
STATIC int xchk_btree_check_block_owner(
    struct xchk_btree *bs,
    int level,
    xfs_daddr_t daddr) {
  xfs_agnumber_t agno;
...
STATIC int xchk_btree_check_owner(
    struct xchk_btree *bs,
    int level,
    struct xfs_buf *bp) {
  struct xfs_btree_cur *cur = bs->cur;
...
static inline bool xchk_btree_check_iroot_minrecs(
    struct xchk_btree *bs) {
  /*
 ...
 */
STATIC void xchk_btree_check_minrecs(
    struct xchk_btree *bs,
    int level,
    struct xfs_btree_block *block) {
  struct xfs_btree_cur *cur = bs->cur;
 ...
 */
STATIC void xchk_btree_block_check_keys(
    struct xchk_btree *bs,
    int level,
    struct xfs_btree_block *block) {
 ...
 */
STATIC int xchk_btree_get_block(
    struct xchk_btree *bs,
    int level,
    union xfs_btree_ptr *pp,
    struct xfs_btree_block **pblock,
