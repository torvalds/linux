...
static void xchk_xattr_buf_cleanup(
    void *priv) {
 ...
 */
static inline bool xchk_xattr_want_freemap(
    struct xfs_scrub *sc) {
 ...
 */
static int xchk_setup_xattr_buf(
    struct xfs_scrub *sc,
    size_t value_size) {
  size_t bmp_sz;
 ...
 */
static void xchk_xattr_listent(
    struct xfs_attr_list_context *context,
    int flags,
    unsigned char *name,
    int namelen,
 ...
 */
STATIC bool xchk_xattr_set_map(
    struct xfs_scrub *sc,
    unsigned long *map,
    unsigned int start,
    unsigned int len) {
 ...
 */
STATIC bool xchk_xattr_check_freemap(
    struct xfs_scrub *sc,
...
STATIC int xchk_xattr_check_sf(
    struct xfs_scrub *sc) {
  struct xchk_xattr_buf *ab = sc->buf;
