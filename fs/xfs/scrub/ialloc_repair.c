 ...
 */
STATIC int xrep_ibt_check_ifree(
    struct xrep_ibt *ri,
 ...
 */
STATIC int xrep_ibt_cluster_record(
    struct xrep_ibt *ri,
 ...
 */
STATIC int xrep_ibt_process_cluster(
    struct xrep_ibt *ri,
...
STATIC int xrep_ibt_check_inode_ext(
    struct xfs_scrub *sc,
    xfs_agblock_t agbno,
    xfs_extlen_t len) {
  struct xfs_mount *mp = sc->mp;
...
STATIC int xrep_ibt_record_old_btree_blocks(
    struct xrep_ibt *ri,
...
STATIC int xrep_ibt_record_inode_blocks(
    struct xrep_ibt *ri,
    const struct xfs_rmap_irec *rec) {
 ...
 * wrong.
 */
STATIC int xrep_ibt_find_inodes(
    struct xrep_ibt *ri) {
  struct xfs_scrub *sc = ri->sc;
  int error;
  ri->rie.ir_startino = NULLAGINO;
...
STATIC int xrep_ibt_reset_counters(
    struct xrep_ibt *ri) {
  struct xfs_scrub *sc = ri->sc;
...
STATIC int xrep_fibt_get_records(
    struct xfs_btree_cur *cur,
    unsigned int idx,
...
STATIC int xrep_ibt_get_records(
    struct xfs_btree_cur *cur,
    unsigned int idx,
    struct xfs_btree_block *block,
    unsigned int nr_wanted,
...
STATIC int xrep_ibt_claim_block(
    struct xfs_btree_cur *cur,
...
STATIC int xrep_fibt_claim_block(
    struct xfs_btree_cur *cur,
    union xfs_btree_ptr *ptr,
    void *priv) {
  struct xrep_ibt *ri = priv;
...
STATIC int xrep_ibt_check_overlap(
    struct xrep_ibt *ri) {
...
STATIC int xrep_ibt_build_new_trees(
    struct xrep_ibt *ri) {
  struct xfs_scrub *sc = ri->sc;
 ...
 */
STATIC int xrep_ibt_remove_old_trees(
    struct xrep_ibt *ri) {
  struct xfs_scrub *sc = ri->sc;
  int error;
  /*
