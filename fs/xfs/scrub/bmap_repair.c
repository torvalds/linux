...
STATIC int xrep_bmap_discover_shared(
    struct xrep_bmap *rb,
...
STATIC int xrep_bmap_from_rmap(
    struct xrep_bmap *rb,
...
STATIC int xrep_bmap_check_fork_rmap(
    struct xrep_bmap *rb,
...
STATIC int xrep_bmap_walk_rmap(
    struct xfs_btree_cur *cur,
    const struct xfs_rmap_irec *rec,
    void *priv) {
 ...
 * file offset.
 */
static int xrep_bmap_extent_cmp(
    const void *a,
    const void *b) {
 ...
 */
STATIC int xrep_bmap_sort_records(
    struct xrep_bmap *rb) {
  struct xfs_bmbt_irec irec;
...
STATIC int xrep_bmap_find_delalloc(
    struct xrep_bmap *rb) {
  struct xfs_bmbt_irec irec;
 ...
 * anything goes wrong.
 */
STATIC int xrep_bmap_find_mappings(
    struct xrep_bmap *rb) {
  struct xfs_scrub *sc = rb->sc;
  struct xfs_perag *pag;
  xfs_agnumber_t agno;
...
STATIC int xrep_bmap_get_records(
    struct xfs_btree_cur *cur,
    unsigned int idx,
...
STATIC int xrep_bmap_claim_block(
    struct xfs_btree_cur *cur,
...
STATIC size_t xrep_bmap_iroot_size(
    struct xfs_btree_cur *cur,
    unsigned int level,
...
STATIC int xrep_bmap_reset_counters(
    struct xrep_bmap *rb) {
  struct xfs_scrub *sc = rb->sc;
 ...
 */
STATIC int xrep_bmap_extents_load(
    struct xrep_bmap *rb) {
  struct xfs_iext_cursor icur;
  struct xfs_bmbt_irec irec;
 ...
 */
STATIC int xrep_bmap_btree_load(
    struct xrep_bmap *rb,
 ...
 */
STATIC int xrep_bmap_build_new_fork(
    struct xrep_bmap *rb) {
 ...
 */
STATIC int xrep_bmap_remove_old_tree(
    struct xrep_bmap *rb) {
  struct xfs_scrub *sc = rb->sc;
  struct xfs_owner_info oinfo;
...
STATIC int xrep_bmap_check_inputs(
    struct xfs_scrub *sc,
    int whichfork) {
...
static inline enum reflink_scan_state xrep_bmap_init_reflink_scan(
    struct xfs_scrub *sc,
    int whichfork) {
