...
static inline int xfsum_copyout(
    struct xfs_scrub *sc,
    xfs_rtsumoff_t sumoff,
    union xfs_suminfo_raw *rawinfo,
...
static inline xfs_suminfo_t xchk_rtsum_inc(
    struct xfs_mount *mp,
...
STATIC int xchk_rtsum_record_free(
    struct xfs_mount *mp,
    struct xfs_trans *tp,
