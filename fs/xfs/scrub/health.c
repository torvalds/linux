...
unsigned int xchk_health_mask_for_scrub_type(
    __u32 scrub_type) {
 ...
 */
void xchk_mark_healthy_if_clean(
    struct xfs_scrub *sc,
    unsigned int mask) {
 ...
 * healthy again.
 */
STATIC void xchk_mark_all_healthy(
    struct xfs_mount *mp) {
...
void xchk_ag_btree_del_cursor_if_sick(
    struct xfs_scrub *sc,
