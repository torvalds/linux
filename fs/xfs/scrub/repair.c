 ...
 */
xfs_extlen_t xrep_calc_ag_resblks(
    struct xfs_scrub *sc) {
...
STATIC int xrep_findroot_agfl_walk(
    struct xfs_mount *mp,
    xfs_agblock_t bno,
    void *priv) {
...
STATIC int xrep_findroot_block(
 ...
 */
int xrep_ino_ensure_extent_count(
    struct xfs_scrub *sc,
    int whichfork,
...
STATIC int xrep_metadata_inode_subtype(
    struct xfs_scrub *sc,
 ...
 */
int xrep_trans_alloc_hook_dummy(
    struct xfs_mount *mp,
    void **cookiep,
