 ...
 */
STATIC int xchk_refcountbt_rmap_check(
 ...
 */
STATIC void xchk_refcountbt_process_rmap_fragments(
...
STATIC void xchk_refcountbt_xref_rmap(
    struct xfs_scrub *sc,
...
STATIC void xchk_refcountbt_xref(
    struct xfs_scrub *sc,
    const struct xfs_refcount_irec *irec) {
...
STATIC int xchk_refcountbt_rmap_check_gap(
    struct xfs_btree_cur *cur,
    const struct xfs_rmap_irec *rec,
    void *priv) {
 ...
 */
static inline void xchk_refcountbt_xref_gaps(
    struct xfs_scrub *sc,
...
static inline bool xchk_refcount_mergeable(
    struct xchk_refcbt_records *rrc,
...
STATIC void xchk_refcountbt_check_mergeable(
...
STATIC int xchk_refcountbt_rec(
    struct xchk_btree *bs,
...
STATIC void xchk_refcount_xref_rmap(
    struct xfs_scrub *sc,
...
void xchk_xref_is_not_cow_staging(
    struct xfs_scrub *sc,
    xfs_agblock_t agbno,
    xfs_extlen_t len) {
  enum xbtree_recpacking outcome;
