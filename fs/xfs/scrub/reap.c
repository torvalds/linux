...
STATIC void xreap_agextent_binval(
 ...
 * a time.
 */
STATIC int xreap_agextent_select(
    struct xreap_state *rs,
    xfs_agblock_t agbno,
 ...
 */
STATIC int xreap_agextent_iter(
    struct xreap_state *rs,
    xfs_agblock_t agbno,
    xfs_extlen_t *aglenp,
    bool crosslinked) {
 ...
 */
STATIC int xreap_agmeta_extent(
    uint32_t agbno,
    uint32_t len,
    void *priv) {
 ...
 */
STATIC int xreap_fsmeta_extent(
    uint64_t fsbno,
    uint64_t len,
    void *priv) {
  struct xreap_state *rs = priv;
