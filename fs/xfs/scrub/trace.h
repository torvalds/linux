...
TRACE_EVENT(xchk_file_op_error,
    ...
    TP_printk(
    "dev %d:%d ino 0x%llx fork %s type %s fileoff 0x%llx error %d ret_ip %pS",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->ino,
...
DECLARE_EVENT_CLASS(xchk_dqiter_class,
    ...
    TP_printk(
    "dev %d:%d dquot type %s ino 0x%llx cursor_id 0x%llx startoff 0x%llx startblock 0x%llx blockcount 0x%llx state %u id 0x%llx",
    MAJOR(__entry->dev), MINOR(__entry->dev),
...
TRACE_EVENT(xchk_btree_op_error,
    ...
    TP_printk(
    "dev %d:%d type %s %sbt level %d ptr %d agno 0x%x agbno 0x%x error %d ret_ip %pS",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __print_symbolic(__entry->type, XFS_SCRUB_TYPE_STRINGS),
    __get_str(name),
    __entry->level,
...
TRACE_EVENT(xchk_ifork_btree_op_error,
    ...
    TP_printk(
    "dev %d:%d ino 0x%llx fork %s type %s %sbt level %d ptr %d agno 0x%x agbno 0x%x error %d ret_ip %pS",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->ino,
    __print_symbolic(__entry->whichfork, XFS_WHICHFORK_STRINGS),
    __print_symbolic(__entry->type, XFS_SCRUB_TYPE_STRINGS),
...
TRACE_EVENT(xchk_btree_error,
    ...
    TP_printk(
    "dev %d:%d type %s %sbt level %d ptr %d agno 0x%x agbno 0x%x ret_ip %pS",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __print_symbolic(__entry->type, XFS_SCRUB_TYPE_STRINGS),
    __get_str(name),
    __entry->level,
...
TRACE_EVENT(xchk_ifork_btree_error,
    ...
    TP_printk(
    "dev %d:%d ino 0x%llx fork %s type %s %sbt level %d ptr %d agno 0x%x agbno 0x%x ret_ip %pS",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->ino,
    __print_symbolic(__entry->whichfork, XFS_WHICHFORK_STRINGS),
    __print_symbolic(__entry->type, XFS_SCRUB_TYPE_STRINGS),
...
DECLARE_EVENT_CLASS(xchk_sbtree_class,
    ...
    TP_printk(
    "dev %d:%d type %s %sbt agno 0x%x agbno 0x%x level %d nlevels %d ptr %d",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __print_symbolic(__entry->type, XFS_SCRUB_TYPE_STRINGS),
    __get_str(name),
    __entry->agno,
...
TRACE_EVENT(xchk_iallocbt_check_cluster,
    ...
    TP_printk(
    "dev %d:%d agno 0x%x startino 0x%x daddr 0x%llx bbcount 0x%x chunkino 0x%x nr_inodes %u cluster_mask 0x%x holemask 0x%x cluster_ino 0x%x",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->agno,
    __entry->startino,
    __entry->map_daddr,
...
TRACE_EVENT(xchk_fscounters_calc,
    ...
    TP_printk(
    "dev %d:%d icount %lld:%llu ifree %lld::%llu fdblocks %lld::%llu delalloc %llu",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->icount_sb,
...
TRACE_EVENT(xchk_refcount_incorrect,
    ...
    TP_printk(
    "dev %d:%d agno 0x%x dom %s agbno 0x%x fsbcount 0x%x refcount %u seen %u",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->agno,
...
DECLARE_EVENT_CLASS(xfile_class,
    ...
    TP_printk(
    "xfino 0x%lx mem_bytes 0x%llx pos 0x%llx bytecount 0x%llx isize 0x%llx",
    __entry->ino,
    __entry->bytes_used,
    __entry->pos,
    __entry->bytecount,
...
TRACE_EVENT(xfarray_sort_scan,
  ...
  __entry->last_idx = 0;
    ...
    TP_printk(
    "xfino 0x%lx nr %llu objsz %zu idx %llu folio_pos 0x%llx folio_bytes 0x%lx first_idx %llu last_idx %llu",
    __entry->ino,
    __entry->nr,
    __entry->obj_size,
    __entry->idx,
...
TRACE_EVENT(xchk_rtsum_record_free,
    ...
    TP_printk(
    "dev %d:%d rtdev %d:%d rtx 0x%llx rtxcount 0x%llx log %u rsumpos 0x%llx sumcount %u",
    MAJOR(__entry->dev), MINOR(__entry->dev),
...
DECLARE_EVENT_CLASS(xchk_iscan_ino_class,
    ...
    TP_printk(
    "dev %d:%d iscan start 0x%llx cursor 0x%llx visited 0x%llx ino 0x%llx",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->startino,
    __entry->cursor,
    __entry->visited,
...
TRACE_EVENT(xchk_iscan_iget_batch,
    ...
    TP_printk(
    "dev %d:%d iscan cursor 0x%llx visited 0x%llx batchino 0x%llx skipmask 0x%llx nr %u avail %u unavail %u",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->cursor,
    __entry->visited,
    __entry->batch_ino,
...
TRACE_EVENT(xchk_iscan_iget_retry_wait,
    ...
    TP_printk(
    "dev %d:%d iscan cursor 0x%llx visited 0x%llx remaining %lu timeout %u delay %u",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->cursor,
    __entry->visited,
    __entry->remaining,
...
DECLARE_EVENT_CLASS(xchk_nlinks_diff_class,
    ...
    TP_printk(
    "dev %d:%d ino 0x%llx ftype %s nlink %u parents %u backrefs %u children %u",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->ino,
...
DECLARE_EVENT_CLASS(xrep_rmap_class,
    ...
    TP_printk(
    "dev %d:%d agno 0x%x agbno 0x%x fsbcount 0x%x owner 0x%llx fileoff 0x%llx flags 0x%x",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->agno,
    __entry->agbno,
    __entry->len,
...
TRACE_EVENT(xrep_ibt_found,
    ...
    TP_printk(
    "dev %d:%d agno 0x%x agino 0x%x holemask 0x%x count 0x%x freecount 0x%x freemask 0x%llx",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->agno,
    __entry->startino,
    __entry->holemask,
...
TRACE_EVENT(xrep_bmap_found,
    ...
    TP_printk(
    "dev %d:%d ino 0x%llx whichfork %s fileoff 0x%llx fsbcount 0x%llx startblock 0x%llx state %d",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->ino,
    __print_symbolic(__entry->whichfork, XFS_WHICHFORK_STRINGS),
    __entry->lblk,
...
DECLARE_EVENT_CLASS(xrep_dinode_class,
    ...
    TP_printk(
    "dev %d:%d ino 0x%llx mode 0x%x version %u format %u uid %u gid %u disize 0x%llx nblocks 0x%llx extsize %u nextents %u anextents %u forkoff 0x%x aformat %u flags 0x%x gen 0x%x flags2 0x%llx cowextsize %u",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->ino,
    __entry->mode,
    __entry->version,
...
DECLARE_EVENT_CLASS(xrep_inode_class,
    ...
    TP_printk(
    "dev %d:%d ino 0x%llx disize 0x%llx nblocks 0x%llx flags 0x%x flags2 0x%llx nextents %u format %u anextents %u aformat %u",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->ino,
    __entry->size,
    __entry->nblocks,
...
TRACE_EVENT(xrep_dinode_count_rmaps,
    ...
    TP_printk(
    "dev %d:%d ino 0x%llx dblocks 0x%llx rtblocks 0x%llx ablocks 0x%llx dextents %llu rtextents %llu aextents %u",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->ino,
    __entry->data_blocks,
    __entry->rt_blocks,
...
TRACE_EVENT(xrep_dinode_findmode_dirent_inval,
    ...
    TP_printk(
    "dev %d:%d ino 0x%llx parent_ino 0x%llx ftype '%s' found_ftype '%s'",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->ino,
    __entry->parent_ino,
    __print_symbolic(__entry->ftype, XFS_DIR3_FTYPE_STR),
...
TRACE_EVENT(xrep_cow_mark_file_range,
    ...
    TP_printk(
    "dev %d:%d ino 0x%llx fileoff 0x%llx startblock 0x%llx fsbcount 0x%llx",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->ino,
    __entry->startoff,
    __entry->startblock,
...
TRACE_EVENT(xrep_cow_replace_mapping,
    ...
    TP_printk(
    "dev %d:%d ino 0x%llx startoff 0x%llx startblock 0x%llx fsbcount 0x%llx state 0x%x new_startblock 0x%llx new_fsbcount 0x%x",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->ino,
    __entry->startoff,
    __entry->startblock,
...
TRACE_EVENT(xrep_rmap_live_update,
  ...
  __entry->flags |= XFS_RMAP_UNWRITTEN;
    ...
    TP_printk(
    "dev %d:%d agno 0x%x op %d agbno 0x%x fsbcount 0x%x owner 0x%llx fileoff 0x%llx flags 0x%x",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->agno,
    __entry->op,
    __entry->agbno,
