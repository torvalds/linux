...
STATIC int xrep_rmap_check_mapping(
    struct xfs_scrub *sc,
...
static inline int xrep_rmap_stash(
    struct xrep_rmap *rr,
 ...
 */
STATIC int xrep_rmap_stash_bitmap(
    struct xrep_rmap *rr,
...
STATIC int xrep_rmap_stash_accumulated(
...
STATIC int xrep_rmap_visit_bmbt(
...
STATIC int xrep_rmap_visit_iroot_btree_block(
    struct xfs_btree_cur *cur,
    int level,
    void *priv) {
  struct xrep_rmap_ifork *rf = priv;
 ...
 */
STATIC int xrep_rmap_scan_iroot_btree(
    struct xrep_rmap_ifork *rf,
    struct xfs_btree_cur *cur) {
...
static inline bool is_rt_data_fork(
    struct xfs_inode *ip,
    int whichfork) {
 ...
 */
STATIC int xrep_rmap_scan_bmbt(
    struct xrep_rmap_ifork *rf,
    struct xfs_inode *ip,
    bool *mappings_done) {
  struct xrep_rmap *rr = rf->rr;
 ...
 */
STATIC int xrep_rmap_scan_iext(
    struct xrep_rmap_ifork *rf,
    struct xfs_ifork *ifp) {
  struct xfs_bmbt_irec rec;
...
STATIC int xrep_rmap_scan_ifork(
    struct xrep_rmap *rr,
    struct xfs_inode *ip,
    int whichfork) {
  struct xrep_rmap_ifork rf = {
...
STATIC int xrep_rmap_scan_inode(
    struct xrep_rmap *rr,
    struct xfs_inode *ip) {
...
STATIC int xrep_rmap_walk_inobt(
    struct xfs_btree_cur *cur,
...
STATIC int xrep_rmap_find_inode_rmaps(
    struct xrep_rmap *rr) {
...
STATIC int xrep_rmap_walk_cowblocks(
    struct xfs_btree_cur *cur,
 ...
 * staging extents.
 */
STATIC int xrep_rmap_find_refcount_rmaps(
    struct xrep_rmap *rr) {
...
STATIC int xrep_rmap_find_agheader_rmaps(
    struct xrep_rmap *rr) {
  struct xfs_scrub *sc = rr->sc;
...
STATIC int xrep_rmap_find_log_rmaps(
    struct xrep_rmap *rr) {
  struct xfs_scrub *sc = rr->sc;
...
STATIC int xrep_rmap_check_record(
    struct xfs_btree_cur *cur,
    const struct xfs_rmap_irec *rec,
    void *priv) {
 ...
 */
STATIC int xrep_rmap_find_rmaps(
    struct xrep_rmap *rr) {
  struct xfs_scrub *sc = rr->sc;
...
STATIC int xrep_rmap_walk_agfl(
    struct xfs_mount *mp,
    xfs_agblock_t agbno,
    void *priv) {
 ...
 * true.
 */
STATIC int xrep_rmap_try_reserve(
    struct xrep_rmap *rr,
 ...
 */
STATIC int xrep_rmap_reserve_space(
    struct xrep_rmap *rr,
    struct xfs_btree_cur *rmap_cur) {
...
STATIC int xrep_rmap_reset_counters(
    struct xrep_rmap *rr) {
  struct xfs_scrub *sc = rr->sc;
...
STATIC int xrep_rmap_get_records(
    struct xfs_btree_cur *cur,
    unsigned int idx,
...
STATIC int xrep_rmap_claim_block(
    struct xfs_btree_cur *cur,
...
STATIC int xrep_rmap_alloc_vextent(
    struct xfs_scrub *sc,
...
STATIC int xrep_rmap_count_records(
    struct xfs_btree_cur *cur,
 ...
 * above.
 */
STATIC int xrep_rmap_build_new_tree(
    struct xrep_rmap *rr) {
  struct xfs_scrub *sc = rr->sc;
  struct xfs_perag *pag = sc->sa.pag;
  struct xfs_agf *agf = sc->sa.agf_bp->b_addr;
...
STATIC int xrep_rmap_find_gaps(
    struct xfs_btree_cur *cur,
    const struct xfs_rmap_irec *rec,
    void *priv) {
  struct xrep_rmap_find_gaps *rfg = priv;
 ...
 */
STATIC int xrep_rmap_remove_old_tree(
    struct xrep_rmap *rr) {
...
static inline bool xrep_rmapbt_want_live_update(
    struct xchk_iscan *iscan,
 ...
 * that we change.
 */
static int xrep_rmapbt_live_update(
...
STATIC int xrep_rmap_setup_scan(
    struct xrep_rmap *rr) {
  struct xfs_scrub *sc = rr->sc;
  int error;
  mutex_init(&rr->lock);
...
STATIC void xrep_rmap_teardown(
    struct xrep_rmap *rr) {
  struct xfs_scrub *sc = rr->sc;
  xchk_iscan_abort(&rr->iscan);
