 ...
 */
static inline void careful_add(
    xfs_nlink_t *nlinkp,
    int delta) {
...
STATIC int xchk_nlinks_update_incore(
 ...
 */
STATIC int xchk_nlinks_live_update(
...
STATIC int xchk_nlinks_collect_dirent(
    struct xfs_scrub *sc,
    struct xfs_inode *dp,
...
STATIC int xchk_nlinks_collect_dir(
    struct xchk_nlink_ctrs *xnc,
    struct xfs_inode *dp) {
...
static inline int xchk_nlinks_collect_metafile(
    struct xchk_nlink_ctrs *xnc,
    xfs_ino_t ino) {
...
STATIC int xchk_nlinks_collect_metafiles(
    struct xchk_nlink_ctrs *xnc) {
...
static inline int xchk_nlinks_collect_file(
    struct xchk_nlink_ctrs *xnc,
    struct xfs_inode *ip) {
...
STATIC int xchk_nlinks_comparison_read(
    struct xchk_nlink_ctrs *xnc,
    xfs_ino_t ino,
...
STATIC int xchk_nlinks_compare_inode(
    struct xchk_nlink_ctrs *xnc,
    struct xfs_inode *ip) {
  struct xchk_nlink obs;
  struct xfs_scrub *sc = xnc->sc;
 ...
 */
STATIC int xchk_nlinks_compare_inum(
    struct xchk_nlink_ctrs *xnc,
    xfs_ino_t ino) {
  struct xchk_nlink obs;
  struct xfs_mount *mp = xnc->sc->mp;
 ...
 * the second part.
 */
static int xchk_nlinks_compare_iter(
    struct xchk_nlink_ctrs *xnc,
...
STATIC int xchk_nlinks_compare(
    struct xchk_nlink_ctrs *xnc) {
  struct xchk_nlink nl;
  struct xfs_scrub *sc = xnc->sc;
  struct xfs_inode *ip;
...
static void xchk_nlinks_teardown_scan(
    void *priv) {
  struct xchk_nlink_ctrs *xnc = priv;
 ...
 */
STATIC int xchk_nlinks_setup_scan(
    struct xfs_scrub *sc,
    struct xchk_nlink_ctrs *xnc) {
