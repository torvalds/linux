...
STATIC void xchk_dir_check_ftype(
    struct xfs_scrub *sc,
 ...
 */
STATIC void xchk_directory_check_free_entry(
    struct xfs_scrub *sc,
    xfs_dablk_t lblk,
...
STATIC int xchk_directory_data_bestfree(
    struct xfs_scrub *sc,
    xfs_dablk_t lblk,
    bool is_block) {
  struct xfs_dir2_data_unused *dup;
 ...
 * array is in order.
 */
STATIC void xchk_directory_check_freesp(
    struct xfs_scrub *sc,
    xfs_dablk_t lblk,
    struct xfs_buf *dbp,
    unsigned int len) {
...
STATIC int xchk_directory_leaf1_bestfree(
    struct xfs_scrub *sc,
...
STATIC int xchk_directory_free_bestfree(
    struct xfs_scrub *sc,
    struct xfs_da_args *args,
    xfs_dablk_t lblk) {
...
STATIC int xchk_directory_blocks(
    struct xfs_scrub *sc) {
