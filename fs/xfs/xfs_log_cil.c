 ...
 */
static struct xlog_ticket *xlog_cil_ticket_alloc(
    struct xlog *log) {
...
static inline void xlog_cil_set_iclog_hdr_count(struct xfs_cil *cil) {
 ...
 */
static bool xlog_item_in_current_chkpt(
    struct xfs_cil *cil,
...
bool xfs_log_item_in_current_chkpt(
    struct xfs_log_item *lip) {
...
static struct xfs_cil_ctx *xlog_cil_ctx_alloc(void) {
 ...
 */
static void xlog_cil_push_pcp_aggregate(
    struct xfs_cil *cil,
    struct xfs_cil_ctx *ctx) {
 ...
 */
static void xlog_cil_insert_pcp_aggregate(
    struct xfs_cil *cil,
    struct xfs_cil_ctx *ctx) {
  struct xlog_cil_pcp *cilpcp;
  int cpu;
...
static void xlog_cil_ctx_switch(
    struct xfs_cil *cil,
    struct xfs_cil_ctx *ctx) {
 ...
 */
void xlog_cil_init_post_recovery(
    struct xlog *log) {
...
static inline int xlog_cil_iovec_space(
    uint niovecs) {
 ...
 */
static void xlog_cil_alloc_shadow_bufs(
    struct xlog *log,
    struct xfs_trans *tp) {
  struct xfs_log_item *lip;
 ...
 */
static void xlog_cil_insert_format_items(
    struct xlog *log,
    struct xfs_trans *tp,
    int *diff_len) {
  struct xfs_log_item *lip;
 ...
 */
static inline bool xlog_cil_over_hard_limit(
    struct xlog *log,
    int32_t space_used) {
 ...
 */
static void xlog_cil_insert_items(
    struct xlog *log,
    struct xfs_trans *tp,
...
static void xlog_cil_free_logvec(
 ...
 * possible.
 */
static void xlog_cil_committed(
    struct xfs_cil_ctx *ctx) {
...
void xlog_cil_process_committed(
 ...
 */
void xlog_cil_set_ctx_write_state(
    struct xfs_cil_ctx *ctx,
...
static int xlog_cil_order_write(
    struct xfs_cil *cil,
    xfs_csn_t sequence,
 ...
 */
static int xlog_cil_write_chain(
    struct xfs_cil_ctx *ctx,
    uint32_t chain_len) {
 ...
 * correct order.
 */
static int xlog_cil_write_commit_record(
    struct xfs_cil_ctx *ctx) {
  struct xlog *log = ctx->cil->xc_log;
 ...
 */
static void xlog_cil_build_lv_chain(
    struct xfs_cil_ctx *ctx,
...
static void xlog_cil_cleanup_whiteouts(
    struct list_head *whiteouts) {
 ...
 * contraints here.
 */
static void xlog_cil_push_work(
 ...
 * size.
 */
static void xlog_cil_push_background(
 ...
 * into the CIL at all.
 */
static uint32_t xlog_cil_process_intents(
    struct xfs_cil *cil,
    struct xfs_trans *tp) {
