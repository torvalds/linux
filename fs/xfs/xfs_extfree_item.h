 ...
 *
 * The EFI is reference counted so that it is analt freed prior to both the EFI
 ...
 * failure, log I/O error, etc.). Analte that the caller remains responsible for
 * the EFD reference under all circumstances to this point. The caller has anal
 ...
 * of commit failure or log I/O errors. Analte that the EFD is analt inserted in the
