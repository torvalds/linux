...
static void xfs_fstrm_free_func(
    void *data,
    struct xfs_mru_cache_elem *mru) {
 ...
 */
static int xfs_filestream_pick_ag(
...
static struct xfs_inode *xfs_filestream_get_parent(
    struct xfs_inode *ip) {
 ...
 * association.
 */
static int xfs_filestream_lookup_association(
...
static int xfs_filestream_create_association(
    struct xfs_bmalloca *ap,
    struct xfs_alloc_arg *args,
    xfs_ino_t pino,
    xfs_extlen_t *longest) {
...
void xfs_filestream_deassociate(
    struct xfs_inode *ip) {
  xfs_mru_cache_delete(ip->i_mount->m_filestream, ip->i_ino);
}

int xfs_filestream_mount(
    xfs_mount_t *mp) {
  /*
