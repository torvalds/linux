 ...
 */
static int xfs_reflink_find_shared(
 ...
 */
int xfs_reflink_trim_around_shared(
    struct xfs_inode *ip,
...
static int xfs_reflink_convert_unwritten(
    struct xfs_inode *ip,
    struct xfs_bmbt_irec *imap,
    struct xfs_bmbt_irec *cmap,
    bool convert_now) {
...
static int xfs_reflink_fill_cow_hole(
    struct xfs_inode *ip,
    struct xfs_bmbt_irec *imap,
    struct xfs_bmbt_irec *cmap,
    bool *shared,
...
static int xfs_reflink_fill_delalloc(
    struct xfs_inode *ip,
    struct xfs_bmbt_irec *imap,
    struct xfs_bmbt_irec *cmap,
    bool *shared,
 ...
 */
int xfs_reflink_cancel_cow_blocks(
    struct xfs_inode *ip,
 ...
 * inode; if cancel_real is false, real extents are not cleared.
 */
int xfs_reflink_cancel_cow_range(
    struct xfs_inode *ip,
    xfs_off_t offset,
    xfs_off_t count,
    bool cancel_real) {
 ...
 */
STATIC int xfs_reflink_end_cow_extent(
    struct xfs_inode *ip,
    xfs_fileoff_t *offset_fsb,
    xfs_fileoff_t end_fsb) {
  struct xfs_iext_cursor icur;
 ...
 */
STATIC int xfs_reflink_set_inode_flag(
 ...
 * btree reserves.
 */
static int xfs_reflink_ag_has_free_space(
    struct xfs_mount *mp,
    xfs_agnumber_t agno) {
  struct xfs_perag *pag;
  int error = 0;
 ...
 */
STATIC int xfs_reflink_remap_extent(
    struct xfs_inode *ip,
 ...
 */
static int xfs_reflink_zero_posteof(
    struct xfs_inode *ip,
    loff_t pos) {
...
int xfs_reflink_inode_has_shared_extents(
    struct xfs_trans *tp,
    struct xfs_inode *ip,
    bool *has_shared) {
  struct xfs_bmbt_irec got;
 ...
 */
int xfs_reflink_clear_inode_flag(
    struct xfs_inode *ip,
    struct xfs_trans **tpp) {
  bool needs_flag;
  int error = 0;
 ...
 * hasn't changed.
 */
STATIC int xfs_reflink_try_clear_inode_flag(
    struct xfs_inode *ip) {
  struct xfs_mount *mp = ip->i_mount;
  struct xfs_trans *tp;
  int error = 0;
