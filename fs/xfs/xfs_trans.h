...
static inline int xfs_trans_get_buf(
    struct xfs_trans *tp,
...
static inline int xfs_trans_read_buf(
    struct xfs_mount *mp,
    struct xfs_trans *tp,
    struct xfs_buftarg *target,
    xfs_daddr_t blkno,
...
static inline void xfs_trans_set_context(
    struct xfs_trans *tp) {
...
static inline void xfs_trans_clear_context(
    struct xfs_trans *tp) {
...
static inline void xfs_trans_switch_context(
