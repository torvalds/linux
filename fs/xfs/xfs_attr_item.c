...
static inline struct xfs_attri_log_nameval *xfs_attri_log_nameval_get(
...
static inline void xfs_attri_log_nameval_put(
    struct xfs_attri_log_nameval *nv) {
  if (!nv) {
    return;
  }
...
static inline struct xfs_attri_log_nameval *xfs_attri_log_nameval_alloc(
    const void *name,
...
STATIC void xfs_attri_item_free(
 ...
 */
STATIC void xfs_attri_item_format(
    struct xfs_log_item *lip,
 ...
 * it.
 */
STATIC void xfs_attri_item_unpin(
    struct xfs_log_item *lip,
    int remove) {
  xfs_attri_release(ATTRI_ITEM(lip));
}

STATIC void xfs_attri_item_release(
    struct xfs_log_item *lip) {
  xfs_attri_release(ATTRI_ITEM(lip));
}
 ...
 */
STATIC struct xfs_attri_log_item *xfs_attri_init(
    struct xfs_mount *mp,
    struct xfs_attri_log_nameval *nv) {
  struct xfs_attri_log_item *attrip;
...
STATIC void xfs_attrd_item_free(struct xfs_attrd_log_item *attrdp) {
  kvfree(attrdp->attrd_item.li_lv_shadow);
  kmem_cache_free(xfs_attrd_cache, attrdp);
}

STATIC void xfs_attrd_item_size(
    struct xfs_log_item *lip,
    int *nvecs,
    int *nbytes) {
  *nvecs += 1;
 ...
 */
STATIC void xfs_attrd_item_format(
    struct xfs_log_item *lip,
    struct xfs_log_vec *lv) {
 ...
 * ATTRD.
 */
STATIC void xfs_attrd_item_release(
    struct xfs_log_item *lip) {
  struct xfs_attrd_log_item *attrdp = ATTRD_ITEM(lip);
...
static struct xfs_log_item *xfs_attrd_item_intent(
    struct xfs_log_item *lip) {
  return &ATTRD_ITEM(lip)->attrd_attrip->attri_item;
}

/* Log an attr to the intent item. */
STATIC void xfs_attr_log_item(
    struct xfs_trans *tp,
    struct xfs_attri_log_item *attrip,
...
/* Get an ATTRI. */
static struct xfs_log_item *xfs_attr_create_intent(
    struct xfs_trans *tp,
...
static inline void xfs_attr_free_item(
    struct xfs_attr_intent *attr) {
...
/* Process an attr. */
STATIC int xfs_attr_finish_item(
    struct xfs_trans *tp,
...
STATIC void xfs_attr_abort_intent(
    struct xfs_log_item *intent) {
  xfs_attri_release(ATTRI_ITEM(intent));
}

/* Cancel an attr */
STATIC void xfs_attr_cancel_item(
    struct list_head *item) {
  struct xfs_attr_intent *attr = attri_entry(item);
  xfs_attr_free_item(attr);
}

STATIC bool xfs_attri_item_match(
    struct xfs_log_item *lip,
    uint64_t intent_id) {
...
static inline bool xfs_attri_validate(
    struct xfs_mount *mp,
    struct xfs_attri_log_format *attrp) {
...
static inline struct xfs_attr_intent *xfs_attri_recover_work(
    struct xfs_mount *mp,
 ...
 */
STATIC int xfs_attr_recover_work(
    struct xfs_defer_pending *dfp,
...
static struct xfs_log_item *xfs_attr_relog_intent(
    struct xfs_trans *tp,
    struct xfs_log_item *intent,
...
static struct xfs_log_item *xfs_attr_create_done(
    struct xfs_trans *tp,
    struct xfs_log_item *intent,
    unsigned int count) {
  struct xfs_attri_log_item *attrip;
...
STATIC int xlog_recover_attri_commit_pass2(
    struct xlog *log,
 ...
 */
STATIC int xlog_recover_attrd_commit_pass2(
    struct xlog *log,
    struct list_head *buffer_list,
    struct xlog_recover_item *item,
    xfs_lsn_t lsn) {
