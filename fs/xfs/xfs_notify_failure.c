...
static pgoff_t xfs_failure_pgoff(
    struct xfs_mount *mp,
...
static unsigned long xfs_failure_pgcnt(
    struct xfs_mount *mp,
    const struct xfs_rmap_irec *rec,
    const struct xfs_failure_info *notify) {
...
static int xfs_dax_notify_ddev_failure(
    struct xfs_mount *mp,
    xfs_daddr_t daddr,
    xfs_daddr_t bblen,
    int mf_flags) {
...
static int xfs_dax_notify_failure(
