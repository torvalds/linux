...
STATIC int xfs_compat_ioc_fsgeometry_v1(
    struct xfs_mount *mp,
...
STATIC int xfs_compat_growfs_data_copyin(
...
STATIC int xfs_compat_growfs_rt_copyin(
...
STATIC int xfs_fsinumbers_fmt_compat(
...
STATIC int xfs_ioctl32_bstime_copyin(
    xfs_bstime_t *bstime,
 ...
 * everywhere
 */
STATIC int xfs_ioctl32_bstat_copyin(
...
STATIC int xfs_fsbulkstat_one_fmt_compat(
    struct xfs_ibulk *breq,
...
STATIC int xfs_compat_ioc_fsbulkstat(
    struct file *file,
    unsigned int cmd,
...
STATIC int xfs_compat_handlereq_copyin(
...
STATIC struct dentry *xfs_compat_handlereq_to_dentry(
    struct file *parfilp,
...
STATIC int xfs_compat_attrlist_by_handle(
    struct file *parfilp,
...
STATIC int xfs_compat_attrmulti_by_handle(
    struct file *parfilp,
    void __user *arg) {
  int error;
