 ...
 * return NULL.
 */
static struct xfs_log_item *xfs_ail_max(
    struct xfs_ail *ailp) {
  if (list_empty(&ailp->ail_head)) {
    return NULL;
  }
 ...
 */
static struct xfs_log_item *xfs_ail_next(
    struct xfs_ail *ailp,
    struct xfs_log_item *lip) {
 ...
 * item in the AIL.
 */
static xfs_lsn_t __xfs_ail_min_lsn(
    struct xfs_ail *ailp) {
 ...
 */
static xfs_lsn_t xfs_ail_max_lsn(
    struct xfs_ail *ailp) {
  xfs_lsn_t lsn = 0;
  struct xfs_log_item *lip;
  spin_lock(&ailp->ail_lock);
 ...
 */
STATIC void xfs_trans_ail_cursor_init(
    struct xfs_ail *ailp,
 ...
 */
struct xfs_log_item *xfs_trans_ail_cursor_next(
    struct xfs_ail *ailp,
    struct xfs_ail_cursor *cur) {
 ...
 */
STATIC void xfs_trans_ail_cursor_clear(
    struct xfs_ail *ailp,
    struct xfs_log_item *lip) {
  struct xfs_ail_cursor *cur;
 ...
 */
struct xfs_log_item *xfs_trans_ail_cursor_first(
    struct xfs_ail *ailp,
    struct xfs_ail_cursor *cur,
    xfs_lsn_t lsn) {
  struct xfs_log_item *lip;
...
static struct xfs_log_item *__xfs_trans_ail_cursor_last(
    struct xfs_ail *ailp,
    xfs_lsn_t lsn) {
  struct xfs_log_item *lip;
 ...
 */
struct xfs_log_item *xfs_trans_ail_cursor_last(
    struct xfs_ail *ailp,
    struct xfs_ail_cursor *cur,
    xfs_lsn_t lsn) {
  xfs_trans_ail_cursor_init(ailp, cur);
 ...
 */
static inline int xfsaild_resubmit_item(
    struct xfs_log_item *lip,
...
static inline uint xfsaild_push_item(
    struct xfs_ail *ailp,
    struct xfs_log_item *lip) {
  /*
 ...
 * before returning.
 */
void xfs_trans_ail_update_bulk(
    struct xfs_ail *ailp,
    struct xfs_ail_cursor *cur,
