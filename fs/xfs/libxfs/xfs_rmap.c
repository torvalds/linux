...
xfs_failaddr_t xfs_rmap_btrec_to_irec(
...
xfs_failaddr_t xfs_rmap_check_irec(
...
static inline xfs_failaddr_t xfs_rmap_check_btrec(
    struct xfs_btree_cur *cur,
    const struct xfs_rmap_irec *irec) {
...
static inline int xfs_rmap_complain_bad_rec(
    struct xfs_btree_cur *cur,
    xfs_failaddr_t fa,
    const struct xfs_rmap_irec *irec) {
  ...
  if (xfs_btree_is_mem_rmap(cur->bc_ops)) {
    xfs_warn(mp,
        "In-Memory Reverse Mapping BTree record corruption detected at %pS!",
        fa);
  } else {
    xfs_warn(mp,
...
STATIC int xfs_rmap_find_left_neighbor_helper(
    struct xfs_btree_cur *cur,
 ...
 * block ranges.
 */
STATIC int xfs_rmap_find_left_neighbor(
    struct xfs_btree_cur *cur,
    xfs_agblock_t bno,
    uint64_t owner,
    uint64_t offset,
...
/* For each rmap given, figure out if it matches the key we want. */
STATIC int xfs_rmap_lookup_le_range_helper(
    struct xfs_btree_cur *cur,
    const struct xfs_rmap_irec *rec,
    void *priv) {
  struct xfs_find_left_neighbor_info *info = priv;
 ...
 */
static int xfs_rmap_free_check_owner(
    struct xfs_btree_cur *cur,
    uint64_t ltoff,
...
static inline void xfs_rmap_update_hook(
    struct xfs_trans *tp,
    struct xfs_perag *pag,
 ...
 * function.
 */
STATIC int xfs_rmap_convert_shared(
    struct xfs_btree_cur *cur,
    xfs_agblock_t bno,
    xfs_extlen_t len,
    bool unwritten,
 ...
 */
STATIC int xfs_rmap_unmap_shared(
    struct xfs_btree_cur *cur,
    xfs_agblock_t bno,
    xfs_extlen_t len,
    bool unwritten,
 ...
 */
STATIC int xfs_rmap_map_shared(
    struct xfs_btree_cur *cur,
    xfs_agblock_t bno,
    xfs_extlen_t len,
    bool unwritten,
...
STATIC int xfs_rmap_query_range_helper(
    struct xfs_btree_cur *cur,
    const union xfs_btree_rec *rec,
    void *priv) {
...
void xfs_rmap_finish_one_cleanup(
    struct xfs_trans *tp,
    struct xfs_btree_cur *rcur,
    int error) {
  struct xfs_buf *agbp;
 ...
 */
static bool xfs_rmap_update_is_needed(
    struct xfs_mount *mp,
    int whichfork) {
...
static inline bool xfs_rmap_shareable(
    struct xfs_mount *mp,
...
static inline void xfs_rmap_ownercount_init(
...
STATIC int xfs_rmap_count_owners_helper(
    struct xfs_btree_cur *cur,
    const struct xfs_rmap_irec *rec,
    void *priv) {
