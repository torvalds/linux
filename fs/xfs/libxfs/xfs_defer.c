 ...
 * reoccur.
 */
STATIC struct xfs_log_item *xfs_defer_barrier_create_intent(
    struct xfs_trans *tp,
...
STATIC void xfs_defer_barrier_abort_intent(
    struct xfs_log_item *intent) {
  /* empty */
}

STATIC struct xfs_log_item *xfs_defer_barrier_create_done(
    struct xfs_trans *tp,
    struct xfs_log_item *intent,
    unsigned int count) {
  return NULL;
...
STATIC int xfs_defer_barrier_finish_item(
    struct xfs_trans *tp,
...
STATIC void xfs_defer_barrier_cancel_item(
    struct list_head *item) {
  ASSERT(0);
}
...
static inline void xfs_defer_create_done(
    struct xfs_trans *tp,
 ...
 */
static int xfs_defer_create_intent(
    struct xfs_trans *tp,
    struct xfs_defer_pending *dfp,
    bool sort) {
  struct xfs_log_item *lip;
 ...
 */
static int xfs_defer_create_intents(
    struct xfs_trans *tp) {
  struct xfs_defer_pending *dfp;
  int ret = 0;
...
static inline void xfs_defer_pending_abort(
    struct xfs_mount *mp,
    struct xfs_defer_pending *dfp) {
...
STATIC void xfs_defer_pending_abort_list(
    struct xfs_mount *mp,
...
STATIC void xfs_defer_trans_abort(
    struct xfs_trans *tp,
 ...
 */
static int xfs_defer_save_resources(
...
static void xfs_defer_restore_resources(
    struct xfs_trans *tp,
    struct xfs_defer_resources *dres) {
  unsigned short i;
...
STATIC int xfs_defer_trans_roll(
 ...
 */
static void xfs_defer_cancel_list(
    struct xfs_mount *mp,
    struct list_head *dop_list) {
  struct xfs_defer_pending *dfp;
...
static inline void xfs_defer_relog_intent(
    struct xfs_trans *tp,
    struct xfs_defer_pending *dfp) {
  struct xfs_log_item *lip;
...
static void xfs_defer_isolate_paused(
    struct xfs_trans *tp,
 ...
 */
static inline struct xfs_defer_pending *xfs_defer_find_last(
    struct xfs_trans *tp,
 ...
 * to the transaction.
 */
static inline bool xfs_defer_can_append(
    struct xfs_defer_pending *dfp,
    const struct xfs_defer_op_type *ops) {
  /* Already logged? */
  if (dfp->dfp_intent) {
...
static inline struct xfs_defer_pending *xfs_defer_alloc(
    struct list_head *dfops,
    const struct xfs_defer_op_type *ops) {
  struct xfs_defer_pending *dfp;
...
struct xfs_defer_pending *xfs_defer_add(
    struct xfs_trans *tp,
    struct list_head *li,
    const struct xfs_defer_op_type *ops) {
  struct xfs_defer_pending *dfp = NULL;
 ...
 */
static struct xfs_defer_capture *xfs_defer_ops_capture(
    struct xfs_trans *tp) {
...
void xfs_defer_ops_capture_abort(
    struct xfs_mount *mp,
    struct xfs_defer_capture *dfc) {
  unsigned short i;
...
static inline int __init xfs_defer_init_cache(void) {
...
static inline void xfs_defer_destroy_cache(void) {
