 ...
 * operations.
 */
static void xfs_rtbuf_verify_read(
    struct xfs_buf *bp) {
  return;
}

static void xfs_rtbuf_verify_write(
    struct xfs_buf *bp) {
  return;
}
...
static inline void xfs_trans_log_rtsummary(
    struct xfs_rtalloc_args *args,
...
static inline void xfs_trans_log_rtbitmap(
    struct xfs_rtalloc_args *args,
    unsigned int from,
    unsigned int next) {
 ...
 */
STATIC int xfs_rtcheck_alloc_range(
    struct xfs_rtalloc_args *args,
    xfs_rtxnum_t start,  /* starting rtext number of extent */
    xfs_rtxlen_t len) { /* length of extent */
...
int xfs_rtalloc_extent_is_free(
    struct xfs_mount *mp,
    struct xfs_trans *tp,
    xfs_rtxnum_t start,
    xfs_rtxlen_t len,
 ...
 * extents.
 */
xfs_filblks_t xfs_rtbitmap_blockcount(
    struct xfs_mount *mp,
 ...
 */
unsigned long long xfs_rtbitmap_wordcount(
    struct xfs_mount *mp,
    xfs_rtbxlen_t rtextents) {
...
xfs_filblks_t xfs_rtsummary_blockcount(
    struct xfs_mount *mp,
 ...
 */
unsigned long long xfs_rtsummary_wordcount(
    struct xfs_mount *mp,
    unsigned int rsumlevels,
    xfs_extlen_t rbmblocks) {
  xfs_filblks_t blocks;
