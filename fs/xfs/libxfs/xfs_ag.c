 ...
 */
struct xfs_perag *xfs_perag_get(
    struct xfs_mount *mp,
    xfs_agnumber_t agno) {
 ...
 */
struct xfs_perag *xfs_perag_get_tag(
    struct xfs_mount *mp,
...
struct xfs_perag *xfs_perag_hold(
    struct xfs_perag *pag) {
  ASSERT(atomic_read(&pag->pag_ref) > 0
 ...
 * instead.
 */
struct xfs_perag *xfs_perag_grab(
    struct xfs_mount *mp,
    xfs_agnumber_t agno) {
  struct xfs_perag *pag;
  rcu_read_lock();
 ...
 * search from @first to find the next perag with the given tag set.
 */
struct xfs_perag *xfs_perag_grab_tag(
    struct xfs_mount *mp,
    xfs_agnumber_t first,
    int tag) {
  struct xfs_perag *pag;
...
static xfs_agblock_t __xfs_ag_block_count(
    struct xfs_mount *mp,
    xfs_agnumber_t agno,
    xfs_agnumber_t agcount,
...
xfs_agblock_t xfs_ag_block_count(
    struct xfs_mount *mp,
    xfs_agnumber_t agno) {
 ...
 */
void xfs_free_unused_perag_range(
    struct xfs_mount *mp,
...
static void xfs_freesp_init_recs(
    struct xfs_mount *mp,
    struct xfs_buf *bp,
    struct aghdr_init_data *id) {
...
static void xfs_agflblock_init(
    struct xfs_mount *mp,
    struct xfs_buf *bp,
    struct aghdr_init_data *id) {
