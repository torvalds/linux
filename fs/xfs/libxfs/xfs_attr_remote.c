 ...
 */
static xfs_failaddr_t xfs_attr3_rmt_hdr_ok(
    void *ptr,
    xfs_ino_t ino,
    uint32_t offset,
    uint32_t size,
...
static xfs_failaddr_t xfs_attr3_rmt_verify(
    struct xfs_mount *mp,
    struct xfs_buf *bp,
    void *ptr,
    int fsbsize,
...
static int __xfs_attr3_rmt_read_verify(
    struct xfs_buf *bp,
    bool check_crc,
...
static void xfs_attr3_rmt_read_verify(
    struct xfs_buf *bp) {
  xfs_failaddr_t fa;
  int error;
...
static xfs_failaddr_t xfs_attr3_rmt_verify_struct(
    struct xfs_buf *bp) {
  xfs_failaddr_t fa;
  int error;
...
static void xfs_attr3_rmt_write_verify(
    struct xfs_buf *bp) {
  struct xfs_mount *mp = bp->b_mount;
  xfs_failaddr_t fa;
  int blksize = mp->m_attr_geo->blksize;
 ...
 */
STATIC int xfs_attr_rmtval_copyout(
    struct xfs_mount *mp,
    struct xfs_buf *bp,
    struct xfs_inode *dp,
    int *offset,
...
STATIC void xfs_attr_rmtval_copyin(
    struct xfs_mount *mp,
    struct xfs_buf *bp,
    xfs_ino_t ino,
    int *offset,
 ...
 */
int xfs_attr_rmtval_find_space(
 ...
 */
int xfs_attr_rmtval_invalidate(
    struct xfs_da_args *args) {
  xfs_dablk_t lblkno;
  int blkcnt;
  int error;
