...
static inline bool xfs_sb_has_compat_feature(
    struct xfs_sb *sbp,
    uint32_t feature) {
...
static inline void xfs_sb_remove_incompat_log_features(
    struct xfs_sb *sbp) {
  sbp->sb_features_log_incompat &= ~XFS_SB_FEAT_INCOMPAT_LOG_ALL;
}

static inline void xfs_sb_add_incompat_log_features(
    struct xfs_sb *sbp,
...
static inline bool xfs_is_quota_inode(struct xfs_sb *sbp, xfs_ino_t ino) {
...
#define XFS_FSB_TO_B(mp, \
      fsbno)  ((xfs_fsize_t) (fsbno) << (mp)->m_sb.sb_blocklog)
