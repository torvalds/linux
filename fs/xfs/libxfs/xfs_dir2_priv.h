...
extern struct xfs_dir2_data_free *xfs_dir2_data_freeinsert(
  struct xfs_dir2_data_hdr *hdr,
...
extern struct xfs_dir2_leaf_entry *xfs_dir3_leaf_find_entry(
...
static inline unsigned int xfs_dir2_data_entsize(
    struct xfs_mount *mp,
