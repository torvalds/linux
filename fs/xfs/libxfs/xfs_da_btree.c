...
void xfs_da3_node_hdr_from_disk(
    struct xfs_mount *mp,
 ...
 */
xfs_failaddr_t xfs_da3_blkinfo_verify(
    struct xfs_buf *bp,
...
static xfs_failaddr_t xfs_da3_node_verify(
    struct xfs_buf *bp) {
  struct xfs_mount *mp = bp->b_mount;
...
static void xfs_da3_node_write_verify(
    struct xfs_buf *bp) {
  struct xfs_mount *mp = bp->b_mount;
 ...
 */
static void xfs_da3_node_read_verify(
    struct xfs_buf *bp) {
...
static xfs_failaddr_t xfs_da3_node_verify_struct(
    struct xfs_buf *bp) {
  struct xfs_da_blkinfo *info = bp->b_addr;
  switch (be16_to_cpu(info->magic)) {
    case XFS_DA3_NODE_MAGIC:
...
static int xfs_da3_node_set_type(
    struct xfs_trans *tp,
    struct xfs_inode *dp,
    int whichfork,
    struct xfs_buf *bp) {
 ...
 */
STATIC void xfs_da3_node_rebalance(
    struct xfs_da_state *state,
    struct xfs_da_state_blk *blk1,
    struct xfs_da_state_blk *blk2) {
...
#ifdef  DEBUG
static void xfs_da_blkinfo_onlychild_validate(struct xfs_da_blkinfo *blkinfo,
    __u16 level) {
 ...
 */
STATIC int xfs_da3_node_toosmall(
    struct xfs_da_state *state,
    int *action) {
  struct xfs_da_intnode *node;
 ...
 */
STATIC uint xfs_da3_node_lasthash(
    struct xfs_inode *dp,
    struct xfs_buf *bp,
    int *count) {
  struct xfs_da3_icnode_hdr nodehdr;
 ...
 */
STATIC void xfs_da3_node_remove(
    struct xfs_da_state *state,
    struct xfs_da_state_blk *drop_blk) {
  struct xfs_da_intnode *node;
  struct xfs_da3_icnode_hdr nodehdr;
 ...
 */
STATIC void xfs_da3_node_unbalance(
    struct xfs_da_state *state,
    struct xfs_da_state_blk *drop_blk,
    struct xfs_da_state_blk *save_blk) {
...
enum xfs_dacmp xfs_da_compname(
    struct xfs_da_args *args,
 ...
 */
STATIC int xfs_da3_swap_lastblock(
    struct xfs_da_args *args,
