 ...
 * inode.
 */
STATIC int xfs_iformat_extents(
    struct xfs_inode *ip,
    struct xfs_dinode *dip,
    int whichfork) {
...
struct xfs_ifork *xfs_iext_state_to_fork(
    struct xfs_inode *ip,
    int state) {
...
int xfs_ifork_verify_local_attr(
    struct xfs_inode *ip) {
