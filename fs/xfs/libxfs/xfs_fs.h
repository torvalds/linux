 ...
 */
static inline uint32_t bstat_get_projid(const struct xfs_bstat *bs) {
...
typedef struct {
  __u32 val[2];
} xfs_fsid_t; /* file system id type */
...
#define XFS_IOC_ATTRLIST_BY_HANDLE   _IOW('X', 122, \
    struct xfs_fsop_attrlist_handlereq)
#define XFS_IOC_ATTRMULTI_BY_HANDLE  _IOW('X', 123, \
