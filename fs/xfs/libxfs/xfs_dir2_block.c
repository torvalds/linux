...
static xfs_failaddr_t xfs_dir3_block_verify(
    struct xfs_buf *bp) {
...
static void xfs_dir3_block_write_verify(
    struct xfs_buf *bp) {
  struct xfs_mount *mp = bp->b_mount;
...
static xfs_failaddr_t xfs_dir3_block_header_check(
    struct xfs_inode *dp,
    struct xfs_buf *bp) {
...
static void xfs_dir3_block_init(
    struct xfs_mount *mp,
    struct xfs_trans *tp,
    struct xfs_buf *bp,
    struct xfs_inode *dp) {
...
static void xfs_dir2_block_need_space(
    struct xfs_inode *dp,
 ...
 */
static void xfs_dir2_block_compact(
 ...
 */
static void xfs_dir2_block_log_leaf(
    xfs_trans_t *tp,    /* transaction structure */
 ...
 * Log the block tail.
 */
static void xfs_dir2_block_log_tail(
    xfs_trans_t *tp,    /* transaction structure */
    struct xfs_buf *bp) {  /* block buffer */
  xfs_dir2_data_hdr_t *hdr = bp->b_addr;
  xfs_dir2_block_tail_t *btp;
