 ...
 */
static inline uint32_t xfs_start_cksum_safe(char *buffer, size_t length,
 ...
 */
static inline uint32_t xfs_start_cksum_update(char *buffer, size_t length,
    unsigned long cksum_offset) {
  /* zero the CRC field */
 ...
 */
static inline __le32 xfs_end_cksum(uint32_t crc) {
 ...
 * access to the buffer while the calculation takes place.
 */
static inline void xfs_update_cksum(char *buffer, size_t length,
    unsigned long cksum_offset) {
 ...
 */
static inline int xfs_verify_cksum(char *buffer, size_t length,
    unsigned long cksum_offset) {
