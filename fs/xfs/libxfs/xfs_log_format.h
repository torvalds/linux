...
static inline void xfs_blft_to_flags(struct xfs_buf_log_format *blf,
    enum xfs_blft type) {
...
static inline uint16_t xfs_blft_from_flags(struct xfs_buf_log_format *blf) {
...
static inline size_t xfs_efi_log_format_sizeof(
    unsigned int nr) {
...
static inline size_t xfs_efi_log_format32_sizeof(
    unsigned int nr) {
...
static inline size_t xfs_efi_log_format64_sizeof(
    unsigned int nr) {
...
static inline size_t xfs_efd_log_format_sizeof(
    unsigned int nr) {
...
static inline size_t xfs_efd_log_format32_sizeof(
    unsigned int nr) {
...
static inline size_t xfs_efd_log_format64_sizeof(
    unsigned int nr) {
...
static inline size_t xfs_rui_log_format_sizeof(
    unsigned int nr) {
...
static inline size_t xfs_cui_log_format_sizeof(
    unsigned int nr) {
...
static inline size_t xfs_bui_log_format_sizeof(
    unsigned int nr) {
