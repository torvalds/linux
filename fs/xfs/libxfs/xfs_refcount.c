...
void xfs_refcount_btrec_to_irec(
...
static inline int xfs_refcount_complain_bad_rec(
    struct xfs_btree_cur *cur,
    xfs_failaddr_t fa,
    const struct xfs_refcount_irec *irec) {
 ...
 */
STATIC int xfs_refcount_update(
    struct xfs_btree_cur *cur,
    struct xfs_refcount_irec *irec) {
  union xfs_btree_rec rec;
  uint32_t start;
 ...
 * This either works (return 0) or gets an EFSCORRUPTED error.
 */
STATIC int xfs_refcount_delete(
    struct xfs_btree_cur *cur,
    int *i) {
  struct xfs_refcount_irec irec;
  int found_rec;
...
static inline xfs_agblock_t xfs_refc_next(
 ...
 */
STATIC int xfs_refcount_split_extent(
    struct xfs_btree_cur *cur,
    enum xfs_refc_domain domain,
    xfs_agblock_t agbno,
    bool *shape_changed) {
 ...
 */
STATIC int xfs_refcount_merge_center_extents(
    struct xfs_btree_cur *cur,
 ...
 */
STATIC int xfs_refcount_merge_left_extent(
    struct xfs_btree_cur *cur,
    struct xfs_refcount_irec *left,
 ...
 */
STATIC int xfs_refcount_merge_right_extent(
    struct xfs_btree_cur *cur,
    struct xfs_refcount_irec *right,
 ...
 */
STATIC int xfs_refcount_find_left_extents(
    struct xfs_btree_cur *cur,
    struct xfs_refcount_irec *left,
    struct xfs_refcount_irec *cleft,
    enum xfs_refc_domain domain,
 ...
 */
STATIC int xfs_refcount_find_right_extents(
    struct xfs_btree_cur *cur,
    struct xfs_refcount_irec *right,
    struct xfs_refcount_irec *cright,
    enum xfs_refc_domain domain,
...
static inline bool xfs_refc_valid(
    const struct xfs_refcount_irec *rc) {
  return rc->rc_startblock != NULLAGBLOCK;
}

static inline xfs_nlink_t xfs_refc_merge_refcount(
    const struct xfs_refcount_irec *irec,
...
static inline bool xfs_refc_want_merge_center(
...
static inline bool xfs_refc_want_merge_left(
    const struct xfs_refcount_irec *left,
    const struct xfs_refcount_irec *cleft,
    enum xfs_refc_adjust_op adjust) {
  unsigned long long ulen = left->rc_blockcount;
...
static inline bool xfs_refc_want_merge_right(
    const struct xfs_refcount_irec *cright,
    const struct xfs_refcount_irec *right,
    enum xfs_refc_adjust_op adjust) {
 ...
 */
STATIC int xfs_refcount_merge_extents(
    struct xfs_btree_cur *cur,
    enum xfs_refc_domain domain,
    xfs_agblock_t *agbno,
    xfs_extlen_t *aglen,
 ...
 */
static bool xfs_refcount_still_have_space(
    struct xfs_btree_cur *cur) {
 ...
 */
STATIC int xfs_refcount_adjust_extents(
    struct xfs_btree_cur *cur,
    xfs_agblock_t *agbno,
    xfs_extlen_t *aglen,
...
STATIC int xfs_refcount_adjust(
    struct xfs_btree_cur *cur,
    xfs_agblock_t *agbno,
    xfs_extlen_t *aglen,
    enum xfs_refc_adjust_op adj) {
 ...
 */
static inline int xfs_refcount_continue_op(
    struct xfs_btree_cur *cur,
 ...
 */
static void __xfs_refcount_add(
    struct xfs_trans *tp,
 ...
 */
void xfs_refcount_increase_extent(
    struct xfs_trans *tp,
 ...
 */
void xfs_refcount_decrease_extent(
    struct xfs_trans *tp,
    struct xfs_bmbt_irec *PREV) {
  if (!xfs_has_reflink(tp->t_mountp)) {
    return;
 ...
 */
STATIC int xfs_refcount_adjust_cow_extents(
    struct xfs_btree_cur *cur,
    xfs_agblock_t agbno,
    xfs_extlen_t aglen,
    enum xfs_refc_adjust_op adj) {
 ...
 */
STATIC int xfs_refcount_adjust_cow(
    struct xfs_btree_cur *cur,
    xfs_agblock_t agbno,
    xfs_extlen_t aglen,
    enum xfs_refc_adjust_op adj) {
 ...
 */
STATIC int __xfs_refcount_cow_alloc(
    struct xfs_btree_cur *rcur,
    xfs_agblock_t agbno,
    xfs_extlen_t aglen) {
 ...
 */
STATIC int __xfs_refcount_cow_free(
    struct xfs_btree_cur *rcur,
    xfs_agblock_t agbno,
    xfs_extlen_t aglen) {
...
void xfs_refcount_alloc_cow_extent(
    struct xfs_trans *tp,
    xfs_fsblock_t fsb,
    xfs_extlen_t len) {
  struct xfs_mount *mp = tp->t_mountp;
...
void xfs_refcount_free_cow_extent(
    struct xfs_trans *tp,
    xfs_fsblock_t fsb,
    xfs_extlen_t len) {
  struct xfs_mount *mp = tp->t_mountp;
...
STATIC int xfs_refcount_recover_extent(
    struct xfs_btree_cur *cur,
    const union xfs_btree_rec *rec,
    void *priv) {
...
int xfs_refcount_recover_cow_leftovers(
    struct xfs_mount *mp,
    struct xfs_perag *pag) {
  struct xfs_trans *tp;
  struct xfs_btree_cur *cur;
...
STATIC int xfs_refcount_query_range_helper(
    struct xfs_btree_cur *cur,
    const union xfs_btree_rec *rec,
    void *priv) {
...
int xfs_refcount_query_range(
  ...
  struct xfs_refcount_query_range_info query = {
    .priv = priv, .fn = fn
  };
