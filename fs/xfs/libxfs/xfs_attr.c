...
static int xfs_attr_sf_addname(
 ...
 */
static int xfs_attr_node_addname(
    struct xfs_attr_intent *attr) {
  struct xfs_da_args *args = attr->xattri_da_args;
  int error;
...
static int xfs_attr_rmtval_alloc(
    struct xfs_attr_intent *attr) {
  struct xfs_da_args *args = attr->xattri_da_args;
  int error = 0;
  /*
 ...
 */
static int xfs_attr_leaf_mark_incomplete(
    struct xfs_da_args *args,
    struct xfs_da_state *state) {
  int error;
  /*
...
static inline void xfs_attr_item_init_da_state(
    struct xfs_attr_intent *attr) {
  struct xfs_da_args *args = attr->xattri_da_args;
 ...
 */
static int xfs_attr_leaf_remove_attr(
    struct xfs_attr_intent *attr) {
  struct xfs_da_args *args = attr->xattri_da_args;
  struct xfs_inode *dp = args->dp;
 ...
 */
static int xfs_attr_leaf_shrink(
    struct xfs_da_args *args) {
  struct xfs_inode *dp = args->dp;
  struct xfs_buf *bp;
  int forkoff;
...
static void xfs_attr_defer_add(
    struct xfs_da_args *args,
 ...
 */
static int xfs_attr_shortform_addname(
    struct xfs_da_args *args) {
  int newsize, forkoff;
...
static void xfs_attr_save_rmt_blk(
    struct xfs_da_args *args) {
...
static void xfs_attr_restore_rmt_blk(
    struct xfs_da_args *args) {
 ...
 * Return EEXIST if attr is found, or ENOATTR if not
 */
STATIC int xfs_attr_leaf_hasname(
    struct xfs_da_args *args,
    struct xfs_buf **bp) {
  int error = 0;
  error = xfs_attr3_leaf_read(args->trans, args->dp, 0, bp);
 ...
 */
STATIC int xfs_attr_leaf_removename(
    struct xfs_da_args *args) {
  struct xfs_inode *dp;
  struct xfs_buf *bp;
  int error, forkoff;
...
/* Return EEXIST if attr is found, or ENOATTR if not. */
STATIC int xfs_attr_node_lookup(
    struct xfs_da_args *args,
    struct xfs_da_state *state) {
  int retval, error;
  /*
...
STATIC int xfs_attr_node_addname_find_attr(
    struct xfs_attr_intent *attr) {
  struct xfs_da_args *args = attr->xattri_da_args;
  int error;
  /*
 ...
 */
static int xfs_attr_node_try_addname(
    struct xfs_attr_intent *attr) {
...
static int xfs_attr_node_removename(
    struct xfs_da_args *args,
    struct xfs_da_state *state) {
  struct xfs_da_state_blk *blk;
  int retval;
...
static int xfs_attr_node_remove_attr(
    struct xfs_attr_intent *attr) {
  struct xfs_da_args *args = attr->xattri_da_args;
