...
void xfbtree_init_ptr_from_cur(
    struct xfs_btree_cur *cur,
...
struct xfs_btree_cur *xfbtree_dup_cursor(
    struct xfs_btree_cur *cur) {
...
STATIC int xfbtree_init_leaf_block(
    struct xfs_mount *mp,
    struct xfbtree *xfbt,
    const struct xfs_btree_ops *ops) {
  struct xfs_buf *bp;
...
static inline struct xfs_buf *xfbtree_buf_match(
    struct xfbtree *xfbt,
