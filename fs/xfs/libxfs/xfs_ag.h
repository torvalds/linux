...
static inline bool xfs_verify_agbno(struct xfs_perag *pag,
    xfs_agblock_t agbno) {
...
static inline bool xfs_verify_agbext(
 ...
 */
static inline bool xfs_verify_agino(struct xfs_perag *pag, xfs_agino_t agino) {
 ...
 */
static inline bool xfs_verify_agino_or_null(struct xfs_perag *pag,
    xfs_agino_t agino) {
  if (agino == NULLAGINO) {
    return true;
  }
...
static inline bool xfs_ag_contains_log(struct xfs_mount *mp,
    xfs_agnumber_t agno) {
 ...
 */
static inline struct xfs_perag *xfs_perag_next(
    struct xfs_perag *pag,
    xfs_agnumber_t *agno,
...
static inline struct xfs_perag *xfs_perag_next_wrap(
    struct xfs_perag *pag,
    xfs_agnumber_t *agno,
 ...
 * (start_agno - 1).
 */
#define for_each_perag_wrap_range(mp, start_agno, restart_agno, wrap_agno, agno, \
      pag) \
