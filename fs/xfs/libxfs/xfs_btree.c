 ...
 * bytes.
 */
static inline xfs_failaddr_t xfs_btree_check_fsblock_siblings(
    struct xfs_mount *mp,
    xfs_fsblock_t fsb,
    __be64 dsibling) {
...
static inline xfs_failaddr_t xfs_btree_check_memblock_siblings(
...
static inline xfs_failaddr_t xfs_btree_check_agblock_siblings(
...
static xfs_failaddr_t __xfs_btree_check_lblock_hdr(
 ...
 */
static xfs_failaddr_t __xfs_btree_check_fsblock(
    struct xfs_btree_cur *cur,
    struct xfs_btree_block *block,
    int level,
    struct xfs_buf *bp) {
 ...
 */
static xfs_failaddr_t __xfs_btree_check_memblock(
    struct xfs_btree_cur *cur,
    struct xfs_btree_block *block,
    int level,
    struct xfs_buf *bp) {
 ...
 * or NULL if everything is ok.
 */
static xfs_failaddr_t __xfs_btree_check_agblock(
    struct xfs_btree_cur *cur,
    struct xfs_btree_block *block,
    int level,
    struct xfs_buf *bp) {
 ...
 */
xfs_failaddr_t __xfs_btree_check_block(
    struct xfs_btree_cur *cur,
    struct xfs_btree_block *block,
    int level,
    struct xfs_buf *bp) {
 ...
 */
static int xfs_btree_check_ptr(
    struct xfs_btree_cur *cur,
    const union xfs_btree_ptr *ptr,
    int index,
    int level) {
 ...
 * it to disk.
 */
void xfs_btree_fsblock_calc_crc(
    struct xfs_buf *bp) {
...
bool xfs_btree_fsblock_verify_crc(
    struct xfs_buf *bp) {
  struct xfs_btree_block *block = XFS_BUF_TO_BLOCK(bp);
 ...
 * it to disk.
 */
void xfs_btree_agblock_calc_crc(
    struct xfs_buf *bp) {
  struct xfs_btree_block *block = XFS_BUF_TO_BLOCK(bp);
  struct xfs_buf_log_item *bip = bp->b_log_item;
  if (!xfs_has_crc(bp->b_mount)) {
...
bool xfs_btree_agblock_verify_crc(
    struct xfs_buf *bp) {
  struct xfs_btree_block *block = XFS_BUF_TO_BLOCK(bp);
  struct xfs_mount *mp = bp->b_mount;
  if (xfs_has_crc(mp)) {
...
static int xfs_btree_free_block(
    struct xfs_btree_cur *cur,
    struct xfs_buf *bp) {
  int error;
...
static inline struct xfs_buftarg *xfs_btree_buftarg(
    struct xfs_btree_cur *cur) {
...
static inline unsigned int xfs_btree_bbsize(
    struct xfs_btree_cur *cur) {
  if (cur->bc_ops->type == XFS_BTREE_TYPE_MEM) {
    return XFBNO_BBSIZE;
  }
 ...
 */
STATIC size_t xfs_btree_rec_offset(
    struct xfs_btree_cur *cur,
    int n) {
 ...
 */
STATIC size_t xfs_btree_key_offset(
    struct xfs_btree_cur *cur,
    int n) {
  return xfs_btree_block_len(cur)
 ...
 */
STATIC size_t xfs_btree_high_key_offset(
    struct xfs_btree_cur *cur,
    int n) {
  return xfs_btree_block_len(cur)
 ...
 */
STATIC size_t xfs_btree_ptr_offset(
    struct xfs_btree_cur *cur,
    int n,
    int level) {
  return xfs_btree_block_len(cur)
 ...
 */
union xfs_btree_rec *xfs_btree_rec_addr(
    struct xfs_btree_cur *cur,
    int n,
    struct xfs_btree_block *block) {
 ...
 */
union xfs_btree_key *xfs_btree_key_addr(
    struct xfs_btree_cur *cur,
    int n,
    struct xfs_btree_block *block) {
 ...
 */
union xfs_btree_key *xfs_btree_high_key_addr(
    struct xfs_btree_cur *cur,
    int n,
    struct xfs_btree_block *block) {
  return (union xfs_btree_key *)
 ...
 */
union xfs_btree_ptr *xfs_btree_ptr_addr(
    struct xfs_btree_cur *cur,
    int n,
    struct xfs_btree_block *block) {
...
struct xfs_ifork *xfs_btree_ifork_ptr(
    struct xfs_btree_cur *cur) {
 ...
 */
STATIC struct xfs_btree_block *xfs_btree_get_iroot(
    struct xfs_btree_cur *cur) {
...
STATIC int xfs_btree_readahead_fsblock(
    struct xfs_btree_cur *cur,
    int lr,
    struct xfs_btree_block *block) {
  struct xfs_mount *mp = cur->bc_mp;
...
STATIC int xfs_btree_readahead_memblock(
    struct xfs_btree_cur *cur,
    int lr,
    struct xfs_btree_block *block) {
  struct xfs_buftarg *btp = cur->bc_mem.xfbtree->target;
...
STATIC int xfs_btree_readahead_agblock(
    struct xfs_btree_cur *cur,
    int lr,
    struct xfs_btree_block *block) {
  struct xfs_mount *mp = cur->bc_mp;
 ...
 */
STATIC int xfs_btree_readahead(
    struct xfs_btree_cur *cur,   /* btree cursor */
...
STATIC int xfs_btree_ptr_to_daddr(
    struct xfs_btree_cur *cur,
    const union xfs_btree_ptr *ptr,
    xfs_daddr_t *daddr) {
  int error;
 ...
 */
STATIC void xfs_btree_readahead_ptr(
    struct xfs_btree_cur *cur,
...
static inline bool xfs_btree_ptrs_equal(
    struct xfs_btree_cur *cur,
...
static void __xfs_btree_init_block(
    struct xfs_mount *mp,
...
static inline __u64 xfs_btree_owner(
    struct xfs_btree_cur *cur) {
  switch (cur->bc_ops->type) {
    case XFS_BTREE_TYPE_MEM:
 ...
 */
STATIC int xfs_btree_is_lastrec(
    struct xfs_btree_cur *cur,
    struct xfs_btree_block *block,
    int level) {
  union xfs_btree_ptr ptr;
...
STATIC void xfs_btree_buf_to_ptr(
    struct xfs_btree_cur *cur,
    struct xfs_buf *bp,
    union xfs_btree_ptr *ptr) {
  switch (cur->bc_ops->type) {
...
static inline void xfs_btree_set_refs(
    struct xfs_btree_cur *cur,
    struct xfs_buf *bp) {
  xfs_buf_set_ref(bp, cur->bc_ops->lru_refs);
}

int xfs_btree_get_buf_block(
    struct xfs_btree_cur *cur,
    const union xfs_btree_ptr *ptr,
    struct xfs_btree_block **block,
    struct xfs_buf **bpp) {
 ...
 */
STATIC void xfs_btree_copy_recs(
    struct xfs_btree_cur *cur,
 ...
 */
STATIC void xfs_btree_shift_keys(
    struct xfs_btree_cur *cur,
 ...
 */
STATIC void xfs_btree_shift_recs(
    struct xfs_btree_cur *cur,
 ...
 */
STATIC void xfs_btree_shift_ptrs(
    struct xfs_btree_cur *cur,
    union xfs_btree_ptr *ptr,
    int dir,
    int numptrs) {
 ...
 */
STATIC void xfs_btree_log_keys(
    struct xfs_btree_cur *cur,
    struct xfs_buf *bp,
    int first,
    int last) {
 ...
 */
STATIC void xfs_btree_log_ptrs(
    struct xfs_btree_cur *cur, /* btree cursor */
 ...
 * real owner is.
 */
static inline xfs_failaddr_t xfs_btree_check_block_owner(
    struct xfs_btree_cur *cur,
    struct xfs_btree_block *block) {
  __u64 owner;
  if (!xfs_has_crc(cur->bc_mp)
...
int xfs_btree_lookup_get_block(
    struct xfs_btree_cur *cur, /* btree cursor */
 ...
 */
STATIC union xfs_btree_key *xfs_lookup_get_search_key(
    struct xfs_btree_cur *cur,
    int level,
    int keyno,
    struct xfs_btree_block *block,
 ...
 */
void xfs_btree_init_ptr_from_cur(
    struct xfs_btree_cur *cur,
    union xfs_btree_ptr *ptr) {
  if (cur->bc_ops->type == XFS_BTREE_TYPE_INODE) {
    /*
...
union xfs_btree_key *xfs_btree_high_key_from_key(
    struct xfs_btree_cur *cur,
    union xfs_btree_key *key) {
...
STATIC void xfs_btree_get_leaf_keys(
    struct xfs_btree_cur *cur,
    struct xfs_btree_block *block,
    union xfs_btree_key *key) {
...
STATIC void xfs_btree_get_node_keys(
    struct xfs_btree_cur *cur,
    struct xfs_btree_block *block,
    union xfs_btree_key *key) {
  union xfs_btree_key *hkey;
 ...
 * in the block.
 */
static inline bool xfs_btree_needs_key_update(
    struct xfs_btree_cur *cur,
    int ptr) {
 ...
 */
STATIC int __xfs_btree_updkeys(
    struct xfs_btree_cur *cur,
    int level,
    struct xfs_btree_block *block,
    struct xfs_buf *bp0,
...
STATIC int xfs_btree_updkeys_force(
    struct xfs_btree_cur *cur,
    int level) {
  struct xfs_buf *bp;
  struct xfs_btree_block *block;
 ...
 */
STATIC int xfs_btree_update_keys(
    struct xfs_btree_cur *cur,
    int level) {
  struct xfs_btree_block *block;
  struct xfs_buf *bp;
...
static inline int xfs_btree_alloc_block(
    struct xfs_btree_cur *cur,
 ...
 */
static void xfs_btree_split_worker(
    struct work_struct *work) {
...
static void xfs_btree_set_root(
    struct xfs_btree_cur *cur,
    const union xfs_btree_ptr *ptr,
    int inc) {
  if (cur->bc_flags & XFS_BTREE_STAGING) {
...
STATIC int xfs_btree_make_block_unfull(
    struct xfs_btree_cur *cur, /* btree cursor */
    int level,  /* btree level */
 ...
 * inode.
 */
STATIC int xfs_btree_kill_iroot(
    struct xfs_btree_cur *cur) {
 ...
 */
STATIC int xfs_btree_kill_root(
    struct xfs_btree_cur *cur,
    struct xfs_buf *bp,
    int level,
...
STATIC int xfs_btree_dec_cursor(
    struct xfs_btree_cur *cur,
    int level,
    int *stat) {
  int error;
...
STATIC int xfs_btree_visit_block(
    struct xfs_btree_cur *cur,
    int level,
...
static int xfs_btree_block_change_owner(
    struct xfs_btree_cur *cur,
    int level,
    void *data) {
...
xfs_failaddr_t xfs_btree_fsblock_v5hdr_verify(
    struct xfs_buf *bp,
    uint64_t owner) {
  struct xfs_mount *mp = bp->b_mount;
  struct xfs_btree_block *block = XFS_BUF_TO_BLOCK(bp);
...
xfs_failaddr_t xfs_btree_fsblock_verify(
    struct xfs_buf *bp,
...
xfs_failaddr_t xfs_btree_memblock_verify(
    struct xfs_buf *bp,
    unsigned int max_recs) {
  struct xfs_btree_block *block = XFS_BUF_TO_BLOCK(bp);
 ...
 */
xfs_failaddr_t xfs_btree_agblock_v5hdr_verify(
    struct xfs_buf *bp) {
  struct xfs_mount *mp = bp->b_mount;
  struct xfs_btree_block *block = XFS_BUF_TO_BLOCK(bp);
 ...
 */
xfs_failaddr_t xfs_btree_agblock_verify(
    struct xfs_buf *bp,
    unsigned int max_recs) {
  struct xfs_mount *mp = bp->b_mount;
  struct xfs_btree_block *block = XFS_BUF_TO_BLOCK(bp);
 ...
 */
unsigned int xfs_btree_compute_maxlevels(
 ...
 */
unsigned long long xfs_btree_calc_size(
    const unsigned int *limits,
    unsigned long long records) {
  unsigned long long level_blocks = howmany_64(records, limits[0]);
 ...
 */
unsigned int xfs_btree_space_to_height(
    const unsigned int *limits,
 ...
 */
STATIC int xfs_btree_simple_query_range(
    struct xfs_btree_cur *cur,
 ...
 */
STATIC int xfs_btree_overlapped_query_range(
    struct xfs_btree_cur *cur,
    const union xfs_btree_key *low_key,
    const union xfs_btree_key *high_key,
    xfs_btree_query_range_fn fn,
...
static inline void xfs_btree_key_from_irec(
    struct xfs_btree_cur *cur,
    union xfs_btree_key *key,
...
static int xfs_btree_count_blocks_helper(
    struct xfs_btree_cur *cur,
    int level,
    void *data) {
...
int64_t xfs_btree_diff_two_ptrs(
    struct xfs_btree_cur *cur,
...
STATIC int xfs_btree_has_records_helper(
    struct xfs_btree_cur *cur,
...
bool xfs_btree_has_more_records(
    struct xfs_btree_cur *cur) {
  struct xfs_btree_block *block;
  struct xfs_buf *bp;
  block = xfs_btree_get_block(cur, 0, &bp);
