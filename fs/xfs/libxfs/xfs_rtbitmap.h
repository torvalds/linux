...
static inline xfs_rtblock_t xfs_rtx_to_rtb(
    struct xfs_mount *mp,
    xfs_rtxnum_t rtx) {
  if (mp->m_rtxblklog >= 0) {
...
static inline xfs_extlen_t xfs_rtxlen_to_extlen(
    struct xfs_mount *mp,
    xfs_rtxlen_t rtxlen) {
  if (mp->m_rtxblklog >= 0) {
...
static inline unsigned int xfs_extlen_to_rtxmod(
    struct xfs_mount *mp,
    xfs_extlen_t len) {
  if (mp->m_rtxblklog >= 0) {
...
static inline xfs_rtxlen_t xfs_extlen_to_rtxlen(
    struct xfs_mount *mp,
    xfs_extlen_t len) {
  if (mp->m_rtxblklog >= 0) {
...
static inline xfs_rtxnum_t xfs_rtb_to_rtx(
    struct xfs_mount *mp,
    xfs_rtblock_t rtbno) {
...
static inline xfs_extlen_t xfs_rtb_to_rtxoff(
    struct xfs_mount *mp,
    xfs_rtblock_t rtbno) {
  if (likely(mp->m_rtxblklog >= 0)) {
 ...
 */
static inline xfs_rtxnum_t xfs_rtb_to_rtxrem(
    struct xfs_mount *mp,
    xfs_rtblock_t rtbno,
    xfs_extlen_t *off) {
  if (likely(mp->m_rtxblklog >= 0)) {
 ...
 */
static inline xfs_rtxnum_t xfs_rtb_to_rtxup(
    struct xfs_mount *mp,
    xfs_rtblock_t rtbno) {
  if (likely(mp->m_rtxblklog >= 0)) {
...
static inline xfs_rtblock_t xfs_rtb_roundup_rtx(
    struct xfs_mount *mp,
    xfs_rtblock_t rtbno) {
...
static inline xfs_rtblock_t xfs_rtb_rounddown_rtx(
    struct xfs_mount *mp,
    xfs_rtblock_t rtbno) {
...
static inline xfs_fileoff_t xfs_rtx_to_rbmblock(
    struct xfs_mount *mp,
    xfs_rtxnum_t rtx) {
...
static inline unsigned int xfs_rtx_to_rbmword(
    struct xfs_mount *mp,
    xfs_rtxnum_t rtx) {
...
static inline xfs_rtxnum_t xfs_rbmblock_to_rtx(
    struct xfs_mount *mp,
...
static inline union xfs_rtword_raw *xfs_rbmblock_wordptr(
...
static inline xfs_rtword_t xfs_rtbitmap_getword(
    struct xfs_rtalloc_args *args,
    unsigned int index) {
...
static inline void xfs_rtbitmap_setword(
    struct xfs_rtalloc_args *args,
    unsigned int index,
    xfs_rtword_t value) {
  union xfs_rtword_raw *word = xfs_rbmblock_wordptr(args, index);
 ...
 */
static inline xfs_rtsumoff_t xfs_rtsumoffs(
    struct xfs_mount *mp,
    int log2_len,
    xfs_fileoff_t rbmoff) {
 ...
 * file.
 */
static inline xfs_fileoff_t xfs_rtsumoffs_to_block(
    struct xfs_mount *mp,
 ...
 * block.
 */
static inline unsigned int xfs_rtsumoffs_to_infoword(
    struct xfs_mount *mp,
    xfs_rtsumoff_t rsumoff) {
...
static inline union xfs_suminfo_raw *xfs_rsumblock_infoptr(
    struct xfs_rtalloc_args *args,
    unsigned int index) {
...
static inline xfs_suminfo_t xfs_suminfo_get(
    struct xfs_rtalloc_args *args,
    unsigned int index) {
...
static inline xfs_suminfo_t xfs_suminfo_add(
    struct xfs_rtalloc_args *args,
    unsigned int index,
    int delta) {
  union xfs_suminfo_raw *info = xfs_rsumblock_infoptr(args, index);
...
static inline int xfs_rtbitmap_read_buf(
    struct xfs_rtalloc_args *args,
    xfs_fileoff_t block) {
  return xfs_rtbuf_get(args, block, 0);
}

static inline int xfs_rtsummary_read_buf(
    struct xfs_rtalloc_args *args,
    xfs_fileoff_t block) {
...
static inline xfs_filblks_t xfs_rtbitmap_blockcount(struct xfs_mount *mp,
    xfs_rtbxlen_t rtextents) {
  /* shut up gcc */
  return 0;
}
