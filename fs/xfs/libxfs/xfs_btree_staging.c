 ...
 */
void xfs_btree_stage_afakeroot(
 ...
 * this.
 */
void xfs_btree_commit_afakeroot(
    struct xfs_btree_cur *cur,
    struct xfs_trans *tp,
    struct xfs_buf *agbp) {
  ASSERT(cur->bc_flags & XFS_BTREE_STAGING);
 ...
 */
void xfs_btree_stage_ifakeroot(
    struct xfs_btree_cur *cur,
 ...
 * this.
 */
void xfs_btree_commit_ifakeroot(
    struct xfs_btree_cur *cur,
    struct xfs_trans *tp,
    int whichfork) {
  ASSERT(cur->bc_flags & XFS_BTREE_STAGING);
 ...
 * continuing.
 */
static int xfs_btree_bload_drop_buf(
 ...
 */
STATIC int xfs_btree_bload_prep_block(
    struct xfs_btree_cur *cur,
    struct xfs_btree_bload *bbl,
    struct list_head *buffers_list,
    unsigned int level,
...
/* Load one leaf block. */
STATIC int xfs_btree_bload_leaf(
    struct xfs_btree_cur *cur,
 ...
 */
STATIC int xfs_btree_bload_node(
    struct xfs_btree_cur *cur,
    unsigned int recs_this_block,
 ...
 */
STATIC unsigned int xfs_btree_bload_max_npb(
    struct xfs_btree_cur *cur,
    struct xfs_btree_bload *bbl,
    unsigned int level) {
  unsigned int ret;
 ...
 */
STATIC unsigned int xfs_btree_bload_desired_npb(
    struct xfs_btree_cur *cur,
    struct xfs_btree_bload *bbl,
    unsigned int level) {
 ...
 * one block.
 */
STATIC void xfs_btree_bload_level_geometry(
    struct xfs_btree_cur *cur,
    struct xfs_btree_bload *bbl,
    unsigned int level,
 ...
 */
static void xfs_btree_bload_ensure_slack(
    struct xfs_btree_cur *cur,
    int *slack,
    int level) {
  int maxr;
 ...
 */
int xfs_btree_bload_compute_geometry(
    struct xfs_btree_cur *cur,
    struct xfs_btree_bload *bbl,
    uint64_t nr_records) {
