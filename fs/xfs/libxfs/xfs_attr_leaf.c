...
static void xfs_attr3_leaf_firstused_from_disk(
...
static void xfs_attr3_leaf_firstused_to_disk(
    struct xfs_da_geometry *geo,
...
void xfs_attr3_leaf_hdr_from_disk(
    struct xfs_da_geometry *geo,
    struct xfs_attr3_icleaf_hdr *to,
    struct xfs_attr_leafblock *from) {
  int i;
...
void xfs_attr3_leaf_hdr_to_disk(
    struct xfs_da_geometry *geo,
    struct xfs_attr_leafblock *to,
    struct xfs_attr3_icleaf_hdr *from) {
  int i;
...
static xfs_failaddr_t xfs_attr3_leaf_verify_entry(
    struct xfs_mount *mp,
    char *buf_end,
 ...
 */
static xfs_failaddr_t xfs_attr3_leaf_verify(
    struct xfs_buf *bp) {
  struct xfs_attr3_icleaf_hdr ichdr;
...
static void xfs_attr3_leaf_write_verify(
    struct xfs_buf *bp) {
  struct xfs_mount *mp = bp->b_mount;
 ...
 */
static void xfs_attr3_leaf_read_verify(
    struct xfs_buf *bp) {
  struct xfs_mount *mp = bp->b_mount;
  xfs_failaddr_t fa;
  if (xfs_has_crc(mp)
...
static int xfs_attr_copy_value(
    struct xfs_da_args *args,
    unsigned char *value,
    int valuelen) {
  /*
 ...
 */
int xfs_attr_shortform_bytesfit(
    struct xfs_inode *dp,
    int bytes) {
 ...
 */
STATIC void xfs_sbversion_add_attr2(
    struct xfs_mount *mp,
    struct xfs_trans *tp) {
 ...
 */
void xfs_attr_shortform_create(
    struct xfs_da_args *args) {
 ...
 */
struct xfs_attr_sf_entry *xfs_attr_sf_findname(
    struct xfs_da_args *args) {
 ...
 * retrieve the value.
 */
int xfs_attr_shortform_getvalue(
    struct xfs_da_args *args) {
  struct xfs_attr_sf_entry *sfe;
...
int xfs_attr_shortform_to_leaf(
    struct xfs_da_args *args) {
  struct xfs_inode *dp = args->dp;
  struct xfs_ifork *ifp = &dp->i_af;
  struct xfs_attr_sf_hdr *sf = ifp->if_data;
...
xfs_failaddr_t xfs_attr_shortform_verify(
 ...
 */
STATIC int xfs_attr3_leaf_create(
    struct xfs_da_args *args,
    xfs_dablk_t blkno,
    struct xfs_buf **bpp) {
  struct xfs_attr_leafblock *leaf;
 ...
 */
STATIC void xfs_attr3_leaf_compact(
    struct xfs_da_args *args,
 ...
 */
STATIC void xfs_attr3_leaf_rebalance(
    struct xfs_da_state *state,
 ...
 */
STATIC int xfs_attr3_leaf_figure_balance(
    struct xfs_da_state *state,
    struct xfs_da_state_blk *blk1,
    struct xfs_attr3_icleaf_hdr *ichdr1,
    struct xfs_da_state_blk *blk2,
 ...
 */
/*ARGSUSED*/
STATIC void xfs_attr3_leaf_moveents(
    struct xfs_da_args *args,
 ...
 */
xfs_dahash_t xfs_attr_leaf_lasthash(
    struct xfs_buf *bp,
    int *count) {
  struct xfs_attr3_icleaf_hdr ichdr;
  struct xfs_attr_leaf_entry *entries;
