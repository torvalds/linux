...
unsigned int xfs_bmap_compute_attr_offset(
    struct xfs_mount *mp) {
 ...
 */
STATIC xfs_filblks_t xfs_bmap_worst_indlen(
 ...
 */
STATIC void xfs_bmap_forkoff_reset(
    xfs_inode_t *ip,
    int whichfork) {
...
#ifdef DEBUG
STATIC struct xfs_buf *xfs_bmap_get_bp(
    struct xfs_btree_cur *cur,
    xfs_fsblock_t bno) {
 ...
 */
STATIC void xfs_bmap_validate_ret(
    xfs_fileoff_t bno,
    xfs_filblks_t len,
    uint32_t flags,
...
#define xfs_bmap_validate_ret(bno, len, flags, mval, onmap, \
      nmap)  do {} while (0)
#endif /* DEBUG */
 ...
 */
void xfs_bmap_local_to_extents_empty(
    struct xfs_trans *tp,
    struct xfs_inode *ip,
    int whichfork) {
  struct xfs_ifork *ifp = xfs_ifork_ptr(ip, whichfork);
 ...
 */
static int xfs_bmap_set_attrforkoff(
    struct xfs_inode *ip,
    int size,
    int *version) {
...
static int xfs_iread_bmbt_block(
    struct xfs_btree_cur *cur,
    int level,
    void *priv) {
...
static xfs_extlen_t xfs_bmap_select_minlen(
...
static int xfs_bmap_btalloc_select_lengths(
    struct xfs_bmalloca *ap,
    struct xfs_alloc_arg *args,
    xfs_extlen_t *blen) {
...
static int xfs_bmap_compute_alignments(
    struct xfs_bmalloca *ap,
    struct xfs_alloc_arg *args) {
  struct xfs_mount *mp = args->mp;
...
static void xfs_bmap_process_allocated_extent(
    struct xfs_bmalloca *ap,
    struct xfs_alloc_arg *args,
...
#ifdef DEBUG
static int xfs_bmap_exact_minlen_extent_alloc(
    struct xfs_bmalloca *ap) {
 ...
 */
static int xfs_bmap_btalloc_at_eof(
    struct xfs_bmalloca *ap,
    struct xfs_alloc_arg *args,
    xfs_extlen_t blen,
    int stripe_align,
 ...
 */
int xfs_bmap_btalloc_low_space(
    struct xfs_bmalloca *ap,
    struct xfs_alloc_arg *args) {
  int error;
...
static int xfs_bmap_btalloc_filestreams(
    struct xfs_bmalloca *ap,
    struct xfs_alloc_arg *args,
    int stripe_align) {
  xfs_extlen_t blen = 0;
...
static int xfs_bmap_btalloc_best_length(
    struct xfs_bmalloca *ap,
    struct xfs_alloc_arg *args,
    int stripe_align) {
  xfs_extlen_t blen = 0;
 ...
 */
STATIC void xfs_bmapi_trim_map(
 ...
 */
STATIC void xfs_bmapi_update_map(
...
STATIC int xfs_bmapi_convert_unwritten(
    struct xfs_bmalloca *bma,
    struct xfs_bmbt_irec *mval,
    xfs_filblks_t len,
    uint32_t flags) {
...
xfs_extlen_t xfs_bmapi_minleft(
    struct xfs_trans *tp,
    struct xfs_inode *ip,
    int fork) {
 ...
 */
static xfs_filblks_t xfs_bmap_split_indlen(
...
static int xfs_bmap_shift_update_extent(
    struct xfs_trans *tp,
    struct xfs_inode *ip,
    int whichfork,
    struct xfs_iext_cursor *icur,
...
int xfs_bmap_can_insert_extents(
    struct xfs_inode *ip,
    xfs_fileoff_t off,
    xfs_fileoff_t shift) {
  struct xfs_bmbt_irec got;
...
static inline void __xfs_bmap_add(
    struct xfs_trans *tp,
...
xfs_failaddr_t xfs_bmap_validate_extent_raw(
    struct xfs_mount *mp,
    bool rtfile,
    int whichfork,
    struct xfs_bmbt_irec *irec) {
...
xfs_failaddr_t xfs_bmap_validate_extent(
    struct xfs_inode *ip,
    int whichfork,
    struct xfs_bmbt_irec *irec) {
...
STATIC int xfs_bmap_query_range_helper(
    struct xfs_btree_cur *cur,
