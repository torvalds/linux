 ...
 */
static xfs_dir2_db_t xfs_dir2_db_to_fdb(struct xfs_da_geometry *geo,
    xfs_dir2_db_t db) {
 ...
 */
static int xfs_dir2_db_to_fdindex(struct xfs_da_geometry *geo,
    xfs_dir2_db_t db) {
 ...
 */
#ifdef DEBUG
static xfs_failaddr_t xfs_dir3_leafn_check(
    struct xfs_inode *dp,
    struct xfs_buf *bp) {
...
static inline void xfs_dir3_leaf_check(
    struct xfs_inode *dp,
    struct xfs_buf *bp) {
  xfs_failaddr_t fa;
...
static xfs_failaddr_t xfs_dir3_free_verify(
    struct xfs_buf *bp) {
...
static void xfs_dir3_free_read_verify(
    struct xfs_buf *bp) {
  struct xfs_mount *mp = bp->b_mount;
  xfs_failaddr_t fa;
  if (xfs_has_crc(mp)
...
static void xfs_dir3_free_write_verify(
    struct xfs_buf *bp) {
  struct xfs_mount *mp = bp->b_mount;
...
static xfs_failaddr_t xfs_dir3_free_header_check(
    struct xfs_inode *dp,
    xfs_dablk_t fbno,
    struct xfs_buf *bp) {
...
static int __xfs_dir3_free_read(
    struct xfs_trans *tp,
    struct xfs_inode *dp,
    xfs_dablk_t fbno,
    unsigned int flags,
...
void xfs_dir2_free_hdr_from_disk(
    struct xfs_mount *mp,
...
static void xfs_dir2_free_hdr_to_disk(
    struct xfs_mount *mp,
...
static int xfs_dir2_free_try_read(
    struct xfs_trans *tp,
    struct xfs_inode *dp,
    xfs_dablk_t fbno,
    struct xfs_buf **bpp) {
...
static int xfs_dir3_free_get_buf(
    xfs_da_args_t *args,
    xfs_dir2_db_t fbno,
    struct xfs_buf **bpp) {
 ...
 */
STATIC void xfs_dir2_free_log_bests(
 ...
 */
static void xfs_dir2_free_log_header(
    struct xfs_da_args *args,
    struct xfs_buf *bp) {
#ifdef DEBUG
...
#ifdef DEBUG
static void xfs_dir2_free_hdr_check(
    struct xfs_inode *dp,
    struct xfs_buf *bp,
    xfs_dir2_db_t db) {
  struct xfs_dir3_icfree_hdr hdr;
 ...
 */
STATIC int xfs_dir2_leafn_lookup_for_addname(
    struct xfs_buf *bp,    /* leaf buffer */
    xfs_da_args_t *args,    /* operation arguments */
 ...
 */
STATIC int xfs_dir2_leafn_lookup_for_entry(
    struct xfs_buf *bp,    /* leaf buffer */
    xfs_da_args_t *args,    /* operation arguments */
    int *indexp,  /* out: leaf entry index */
    xfs_da_state_t *state) { /* state to fill in */
 ...
 */
static void xfs_dir3_leafn_moveents(
    xfs_da_args_t *args,  /* operation arguments */
 ...
 */
static void xfs_dir2_leafn_rebalance(
...
static int xfs_dir3_data_block_free(
    xfs_da_args_t *args,
 ...
 * has specified.
 */
static int xfs_dir2_node_add_datablk(
    struct xfs_da_args *args,
...
static int xfs_dir2_node_find_freeblk(
    struct xfs_da_args *args,
    struct xfs_da_state_blk *fblk,
    xfs_dir2_db_t *dbnop,
    struct xfs_buf **fbpp,
 ...
 */
static int xfs_dir2_node_addname_int(
    struct xfs_da_args *args,    /* operation arguments */
