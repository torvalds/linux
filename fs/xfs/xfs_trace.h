...
DECLARE_EVENT_CLASS(xfs_fs_class,
  ...
  __entry->sbflags = mp->m_super->s_flags;
    ...
    TP_printk(
    "dev %d:%d m_features 0x%llx opstate (%s) s_flags 0x%lx caller %pS",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->mflags,
...
TRACE_EVENT(xfs_irec_merge_pre,
    ...
    TP_printk(
    "dev %d:%d agno 0x%x agino 0x%x holemask 0x%x new_agino 0x%x new_holemask 0x%x",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->agno,
    __entry->agino,
    __entry->holemask,
...
TRACE_EVENT(xfs_bunmap,
    ...
    TP_printk(
    "dev %d:%d ino 0x%llx disize 0x%llx fileoff 0x%llx fsbcount 0x%llx "
    "flags %s caller %pS",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->ino,
    __entry->size,
...
TRACE_EVENT(xfs_extent_busy_trim,
    ...
    TP_printk(
    "dev %d:%d agno 0x%x agbno 0x%x fsbcount 0x%x found_agbno 0x%x found_fsbcount 0x%x",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->agno,
    __entry->agbno,
    __entry->len,
...
DECLARE_EVENT_CLASS(xfs_log_recover_icreate_item_class,
    ...
    TP_printk(
    "dev %d:%d agno 0x%x agbno 0x%x fsbcount 0x%x ireccount %u isize %u gen 0x%x",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->agno,
    __entry->agbno,
    __entry->length,
...
DECLARE_EVENT_CLASS(xfs_defer_pending_item_class,
    ...
    TP_printk(
    "dev %d:%d optype %s intent %p item %p flags %s committed %d nr %d",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __get_str(name),
    __entry->intent,
    __entry->item,
...
DECLARE_EVENT_CLASS(xfs_rmap_class,
  ...
  __entry->flags |= XFS_RMAP_UNWRITTEN;
    ...
    TP_printk(
    "dev %d:%d agno 0x%x agbno 0x%x fsbcount 0x%x owner 0x%llx fileoff 0x%llx flags 0x%lx",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->agno,
    __entry->agbno,
    __entry->len,
...
DECLARE_EVENT_CLASS(xfs_rmap_deferred_class,
    ...
    TP_printk(
    "dev %d:%d op %d agno 0x%x agbno 0x%x owner 0x%llx %s fileoff 0x%llx fsbcount 0x%llx state %d",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->op,
    __entry->agno,
    __entry->agbno,
...
DECLARE_EVENT_CLASS(xfs_bmap_deferred_class,
  ...
  __entry->opdev = __entry->dev;
    ...
    TP_printk(
    "dev %d:%d op %s opdev %d:%d ino 0x%llx agno 0x%x agbno 0x%x rtbno 0x%llx %s fileoff 0x%llx fsbcount 0x%llx state %d",
    MAJOR(__entry->dev), MINOR(__entry->dev),
...
DECLARE_EVENT_CLASS(xfs_refcount_extent_at_class,
    ...
    TP_printk(
    "dev %d:%d agno 0x%x dom %s agbno 0x%x fsbcount 0x%x refcount %u @ agbno 0x%x",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->agno,
    __print_symbolic(__entry->domain, XFS_REFC_DOMAIN_STRINGS),
    __entry->startblock,
...
DECLARE_EVENT_CLASS(xfs_refcount_double_extent_class,
    ...
    TP_printk(
    "dev %d:%d agno 0x%x dom %s agbno 0x%x fsbcount 0x%x refcount %u -- "
...
DECLARE_EVENT_CLASS(xfs_inode_irec_class,
    ...
    TP_printk(
    "dev %d:%d ino 0x%llx fileoff 0x%llx fsbcount 0x%x startblock 0x%llx st %d",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->ino,
    __entry->lblk,
    __entry->len,
...
DECLARE_EVENT_CLASS(xfs_wb_invalid_class,
    ...
    unsigned int wpcseq, int whichfork),
    ...
    TP_printk(
    "dev %d:%d ino 0x%llx pos 0x%llx addr 0x%llx bytecount 0x%llx type 0x%x flags 0x%x wpcseq 0x%x forkseq 0x%x",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->ino,
    __entry->pos,
    __entry->addr,
...
DECLARE_EVENT_CLASS(xfs_iomap_invalid_class,
    ...
    TP_printk(
    "dev %d:%d ino 0x%llx pos 0x%llx addr 0x%llx bytecount 0x%llx type 0x%x flags 0x%x validity_cookie 0x%llx inodeseq 0x%llx",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->ino,
    __entry->pos,
    __entry->addr,
...
DECLARE_EVENT_CLASS(xfs_fsmap_class,
    ...
    TP_printk(
    "dev %d:%d keydev %d:%d agno 0x%x startblock 0x%llx fsbcount 0x%llx owner 0x%llx fileoff 0x%llx flags 0x%x",
    MAJOR(__entry->dev), MINOR(__entry->dev),
...
DECLARE_EVENT_CLASS(xfs_getfsmap_class,
    ...
    TP_printk(
    "dev %d:%d keydev %d:%d daddr 0x%llx bbcount 0x%llx owner 0x%llx fileoff_daddr 0x%llx flags 0x%llx",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    MAJOR(__entry->keydev), MINOR(__entry->keydev),
    __entry->block,
    __entry->len,
...
TRACE_EVENT(xfs_iunlink_reload_next,
    ...
    TP_printk(
    "dev %d:%d agno 0x%x agino 0x%x prev_unlinked 0x%x next_unlinked 0x%x",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->agno,
    __entry->agino,
    __entry->prev_agino,
...
TRACE_EVENT(xfs_btree_commit_ifakeroot,
    ...
    TP_printk(
    "dev %d:%d %sbt agno 0x%x agino 0x%x whichfork %s levels %u blocks %u",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __get_str(name),
    __entry->agno,
    __entry->agino,
...
TRACE_EVENT(xfs_btree_bload_level_geometry,
    ...
    TP_printk(
    "dev %d:%d %sbt level %u/%u nr_this_level %llu nr_per_block %u desired_npb %u blocks %llu blocks_with_extra %llu",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __get_str(name),
    __entry->level,
    __entry->nlevels,
...
TRACE_EVENT(xfs_btree_bload_block,
  ...
  __entry->agbno = be32_to_cpu(ptr->s);
    ...
    TP_printk(
    "dev %d:%d %sbt level %u block %llu/%llu agno 0x%x agbno 0x%x recs %u",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __get_str(name),
    __entry->level,
    __entry->block_idx,
...
DECLARE_EVENT_CLASS(xfs_icwalk_class,
    ...
    TP_printk(
    "dev %d:%d flags 0x%x uid %u gid %u prid %u minsize %llu scan_limit %ld caller %pS",
    MAJOR(__entry->dev), MINOR(__entry->dev),
    __entry->flags,
    __entry->uid,
    __entry->gid,
...
DECLARE_EVENT_CLASS(xlog_iclog_class,
    ...
    TP_printk(
    "dev %d:%d state %s refcnt %d offset %u lsn 0x%llx flags %s caller %pS",
    MAJOR(__entry->dev), MINOR(__entry->dev),
...
TRACE_EVENT(xfbtree_init,
    ...
    TP_printk(
    "xfino 0x%lx btree_ops %pS owner 0x%llx leaf_mxr %u leaf_mnr %u node_mxr %u node_mnr %u",
    __entry->xfino,
    __entry->btree_ops,
    __entry->owner,
    __entry->leaf_mxr,
...
DECLARE_EVENT_CLASS(xfbtree_buf_class,
    ...
    TP_printk(
    "xfino 0x%lx daddr 0x%llx bbcount 0x%x hold %d pincount %d lock %d flags %s",
    __entry->xfino,
    (unsigned long long) __entry->bno,
    __entry->nblks,
    __entry->hold,
