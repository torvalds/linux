 ...
 */
STATIC void xfs_icreate_item_size(
 ...
 */
STATIC void xfs_icreate_item_format(
    struct xfs_log_item *lip,
...
STATIC void xfs_icreate_item_release(
    struct xfs_log_item *lip) {
...
static enum xlog_recover_reorder xlog_recover_icreate_reorder(
 ...
 */
STATIC int xlog_recover_icreate_commit_pass2(
    struct xlog *log,
