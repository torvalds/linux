...
static inline struct xfs_sysfs_attr *to_attr(struct attribute *attr) {
...
STATIC ssize_t xfs_sysfs_object_show(
...
STATIC ssize_t xfs_sysfs_object_store(
    struct kobject *kobject,
    struct attribute *attr,
    const char *buf,
    size_t count) {
...
STATIC ssize_t bug_on_assert_store(
    struct kobject *kobject,
    const char *buf,
    size_t count) {
  int ret;
...
STATIC ssize_t bug_on_assert_show(
    struct kobject *kobject,
    char *buf) {
...
STATIC ssize_t log_recovery_delay_store(
    struct kobject *kobject,
    const char *buf,
    size_t count) {
  int ret;
...
STATIC ssize_t log_recovery_delay_show(
    struct kobject *kobject,
    char *buf) {
...
STATIC ssize_t mount_delay_store(
    struct kobject *kobject,
    const char *buf,
    size_t count) {
  int ret;
...
STATIC ssize_t mount_delay_show(
    struct kobject *kobject,
    char *buf) {
...
static ssize_t always_cow_store(
    struct kobject *kobject,
    const char *buf,
    size_t count) {
  ssize_t ret;
...
static ssize_t always_cow_show(
    struct kobject *kobject,
    char *buf) {
 ...
 */
STATIC ssize_t pwork_threads_store(
    struct kobject *kobject,
    const char *buf,
    size_t count) {
  int ret;
...
STATIC ssize_t pwork_threads_show(
    struct kobject *kobject,
    char *buf) {
...
STATIC ssize_t bload_leaf_slack_store(
    struct kobject *kobject,
    const char *buf,
    size_t count) {
  int ret;
...
STATIC ssize_t bload_leaf_slack_show(
    struct kobject *kobject,
    char *buf) {
...
STATIC ssize_t bload_node_slack_store(
    struct kobject *kobject,
    const char *buf,
    size_t count) {
  int ret;
...
STATIC ssize_t bload_node_slack_show(
    struct kobject *kobject,
    char *buf) {
...
static inline struct xstats *to_xstats(struct kobject *kobject) {
...
STATIC ssize_t stats_clear_store(
    struct kobject *kobject,
    const char *buf,
    size_t count) {
  int ret;
...
static inline struct xlog *to_xlog(struct kobject *kobject) {
  struct xfs_kobj *kobj = to_kobj(kobject);
...
STATIC ssize_t log_tail_lsn_show(
    struct kobject *kobject,
    char *buf) {
  int cycle;
  int block;
...
STATIC ssize_t reserve_grant_head_show(
    struct kobject *kobject,
    char *buf) {
  int cycle;
  int bytes;
...
STATIC ssize_t write_grant_head_show(
    struct kobject *kobject,
    char *buf) {
  int cycle;
  int bytes;
 ...
 */
static inline struct xfs_error_cfg *to_error_cfg(struct kobject *kobject) {
  struct xfs_kobj *kobj = to_kobj(kobject);
  return container_of(kobj, struct xfs_error_cfg, kobj);
}

static inline struct xfs_mount *err_to_mp(struct kobject *kobject) {
  struct xfs_kobj *kobj = to_kobj(kobject);
  return container_of(kobj, struct xfs_mount, m_error_kobj);
}

static ssize_t max_retries_show(
    struct kobject *kobject,
    char *buf) {
  int retries;
...
static ssize_t max_retries_store(
    struct kobject *kobject,
    const char *buf,
    size_t count) {
  struct xfs_error_cfg *cfg = to_error_cfg(kobject);
...
static ssize_t retry_timeout_seconds_show(
    struct kobject *kobject,
    char *buf) {
  int timeout;
  struct xfs_error_cfg *cfg = to_error_cfg(kobject);
...
static ssize_t retry_timeout_seconds_store(
    struct kobject *kobject,
    const char *buf,
    size_t count) {
  struct xfs_error_cfg *cfg = to_error_cfg(kobject);
...
static ssize_t fail_at_unmount_show(
    struct kobject *kobject,
    char *buf) {
...
static ssize_t fail_at_unmount_store(
    struct kobject *kobject,
    const char *buf,
    size_t count) {
  struct xfs_mount *mp = err_to_mp(kobject);
...
static int xfs_error_sysfs_init_class(
    struct xfs_mount *mp,
    int class,
...
struct xfs_error_cfg *xfs_error_get_cfg(
    struct xfs_mount *mp,
    int error_class,
    int error) {
  struct xfs_error_cfg *cfg;
