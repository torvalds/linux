 ...
 */
STATIC int xfs_bulkstat_one_int(
    struct xfs_mount *mp,
 ...
 */
static inline bool xfs_bulkstat_already_done(
    struct xfs_mount *mp,
    xfs_ino_t startino) {
