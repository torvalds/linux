...
STATIC void xlog_recover_inode_ra_pass2(
    struct xlog *log,
...
STATIC int xfs_recover_inode_owner_change(
    struct xfs_mount *mp,
...
static inline xfs_timestamp_t xfs_log_dinode_to_disk_ts(
...
static inline void xfs_log_dinode_to_disk_iext_counters(
    struct xfs_log_dinode *from,
...
STATIC void xfs_log_dinode_to_disk(
    struct xfs_log_dinode *from,
    struct xfs_dinode *to,
    xfs_lsn_t lsn) {
...
STATIC int xlog_dinode_verify_extent_counts(
    struct xfs_mount *mp,
