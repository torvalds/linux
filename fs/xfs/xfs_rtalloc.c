 ...
 */
STATIC int xfs_rtallocate_range(
    struct xfs_rtalloc_args *args,
 ...
 */
static inline xfs_rtxlen_t xfs_rtallocate_clamp_len(
    struct xfs_mount *mp,
 ...
 */
STATIC int xfs_rtallocate_extent_block(
    struct xfs_rtalloc_args *args,
    xfs_fileoff_t bbno, /* bitmap block number */
 ...
 */
STATIC int xfs_rtallocate_extent_near(
    struct xfs_rtalloc_args *args,
    xfs_rtxnum_t start,  /* starting rtext number to allocate */
    xfs_rtxlen_t minlen, /* minimum length to allocate */
    xfs_rtxlen_t maxlen, /* maximum length to allocate */
...
static int xfs_rtalloc_sumlevel(
    struct xfs_rtalloc_args *args,
    int l,  /* level number */
    xfs_rtxlen_t minlen, /* minimum length to allocate */
    xfs_rtxlen_t maxlen, /* maximum length to allocate */
 ...
 * the length, if given.  The lengths are all in rtextents.
 */
STATIC int xfs_rtallocate_extent_size(
    struct xfs_rtalloc_args *args,
    xfs_rtxlen_t minlen, /* minimum length to allocate */
    xfs_rtxlen_t maxlen, /* maximum length to allocate */
    xfs_rtxlen_t *len, /* out: actual length allocated */
 ...
 */
STATIC int xfs_growfs_rt_alloc(
...
static void xfs_alloc_rsum_cache(
...
static int xfs_rtalloc_count_frextent(
    struct xfs_mount *mp,
    struct xfs_trans *tp,
 ...
 */
int xfs_rtalloc_reinit_frextents(
    struct xfs_mount *mp) {
  uint64_t val = 0;
  int error;
 ...
 */
static inline int xfs_rtmount_iread_extents(
    struct xfs_inode *ip,
...
static void xfs_rtalloc_align_minmax(
