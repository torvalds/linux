 ...
 */
STATIC void xfs_iwalk_ichunk_ra(
    struct xfs_mount *mp,
    struct xfs_perag *pag,
 ...
 */
STATIC void xfs_iwalk_adjust_start(
...
static inline void xfs_iwalk_del_inobt(
    struct xfs_trans *tp,
 ...
 */
STATIC int xfs_iwalk_run_callbacks(
    struct xfs_iwalk_ag *iwag,
    struct xfs_btree_cur **curpp,
    struct xfs_buf **agi_bpp,
    int *has_more) {
 ...
 */
static inline unsigned int xfs_iwalk_prefetch(
    unsigned int inodes) {
 ...
 */
static inline unsigned int xfs_inobt_walk_prefetch(
    unsigned int inobt_records) {
  /*
