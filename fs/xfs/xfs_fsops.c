 ...
 * anything.
 */
static int xfs_resizefs_init_new_ags(
    struct xfs_trans *tp,
 ...
 * growfs operations
 */
static int xfs_growfs_data_private(
 ...
 */
int xfs_fs_unreserve_ag_blocks(
    struct xfs_mount *mp) {
  xfs_agnumber_t agno;
  struct xfs_perag *pag;
  int error = 0;
