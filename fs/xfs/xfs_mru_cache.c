 ...
 */
STATIC unsigned long _xfs_mru_cache_migrate(
 ...
 */
STATIC void _xfs_mru_cache_list_insert(
    struct xfs_mru_cache *mru,
 ...
 */
STATIC void _xfs_mru_cache_clear_reap_list(
    struct xfs_mru_cache *mru)
 ...
 */
STATIC void _xfs_mru_cache_reap(
 ...
 */
static void xfs_mru_cache_flush(
    struct xfs_mru_cache *mru) {
  if (!mru || !mru->lists) {
    return;
  }
 ...
 */
struct xfs_mru_cache_elem *xfs_mru_cache_remove(
    struct xfs_mru_cache *mru,
    unsigned long key) {
  struct xfs_mru_cache_elem *elem;
  ASSERT(mru && mru->lists);
