 ...
 */
STATIC struct xfs_buf *xfs_trans_buf_item_match(
    struct xfs_trans *tp,
 ...
 */
struct xfs_buf *xfs_trans_getsb(
    struct xfs_trans *tp) {
 ...
 */
/* ARGSUSED */
void xfs_trans_inode_alloc_buf(
    xfs_trans_t *tp,
    struct xfs_buf *bp) {
  struct xfs_buf_log_item *bip = bp->b_log_item;
  ASSERT(bp->b_transp == tp);
