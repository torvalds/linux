 ...
 */
static struct vxfs_direct *vxfs_find_entry(struct inode *ip, struct dentry *dp,
    struct page **ppp) {
 ...
 */
static struct dentry *vxfs_lookup(struct inode *dip, struct dentry *dp,
    unsigned int flags) {
 ...
 *   Zero.
 */
static int vxfs_readdir(struct file *fp, struct dir_context *ctx) {
