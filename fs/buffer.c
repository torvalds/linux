 ...
 * So the locking for i_private_list is via the i_private_lock in the
 *address_space
...
static bool grow_buffers(struct block_device *bdev, sector_t block,
   ...
   * pagecache index.
   */
  if (check_mul_overflow(block, (sector_t) size,
      &pos) || pos > MAX_LFS_FILESIZE) {
 ...
 *bh->b_folio->mapping->i_private_lock,
...
static int iomap_to_bh(struct inode *inode, sector_t block,
    struct buffer_head *bh,
...
static bool drop_buffers(struct folio *folio,
