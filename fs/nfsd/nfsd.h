...
int nfsd_minorversion(struct nfsd_net *nn, u32 minorversion,
    enum vers_op change);
...
static inline struct user_namespace *nfsd_user_namespace(
...
#else
static inline int nfsd4_init_slabs(void) {
  return 0;
}
...
static inline int nfs4_state_start_net(struct net *net) {
  return 0;
}
...
static inline int nfs4_reset_recoverydir(char *recdir) {
  return 0;
}

static inline char *nfs4_recoverydir(void) {
  return NULL;
}
...
static inline int nfsd4_create_laundry_wq(void) {
  return 0;
}
...
#define nfserr_conn_not_bound_to_session cpu_to_be32( \
...
#define NFSD4_SUPPORTED_ATTRS_WORD0                                                         \
  (FATTR4_WORD0_SUPPORTED_ATTRS | FATTR4_WORD0_TYPE         \
  | FATTR4_WORD0_FH_EXPIRE_TYPE   \
  | FATTR4_WORD0_CHANGE | FATTR4_WORD0_SIZE | FATTR4_WORD0_LINK_SUPPORT     \
  | FATTR4_WORD0_SYMLINK_SUPPORT | FATTR4_WORD0_NAMED_ATTR | FATTR4_WORD0_FSID             \
  | FATTR4_WORD0_UNIQUE_HANDLES | FATTR4_WORD0_LEASE_TIME   \
