...
static __be32 *encode_nfstime3(__be32 *p, const struct timespec64 *time) {
  *p++ = cpu_to_be32((u32) time->tv_sec);
  *p++ = cpu_to_be32(time->tv_nsec);
  return p;
}

static bool svcxdr_decode_nfstime3(struct xdr_stream *xdr,
...
static bool svcxdr_encode_nfs_fh3(struct xdr_stream *xdr,
...
static bool svcxdr_encode_post_op_fh3(struct xdr_stream *xdr,
    const struct svc_fh *fhp) {
...
static bool svcxdr_encode_cookieverf3(struct xdr_stream *xdr,
    const __be32 *verf) {
  __be32 *p;
...
static bool svcxdr_encode_writeverf3(struct xdr_stream *xdr,
    const __be32 *verf) {
  __be32 *p;
...
static bool svcxdr_decode_filename3(struct xdr_stream *xdr, char **name,
    unsigned int *len) {
  u32 size, i;
  __be32 *p;
  char *c;
...
static bool svcxdr_decode_diropargs3(struct xdr_stream *xdr, struct svc_fh *fhp,
    char **name, unsigned int *len) {
  return svcxdr_decode_nfs_fh3(xdr, fhp)
    && svcxdr_decode_filename3(xdr, name, len);
}

static bool svcxdr_decode_sattr3(struct svc_rqst *rqstp, struct xdr_stream *xdr,
    struct iattr *iap) {
  u32 set_it;
  iap->ia_valid = 0;
...
static bool svcxdr_decode_sattrguard3(struct xdr_stream *xdr,
...
static bool svcxdr_decode_specdata3(struct xdr_stream *xdr,
...
static bool svcxdr_decode_devicedata3(struct svc_rqst *rqstp,
...
static bool svcxdr_encode_fattr3(struct svc_rqst *rqstp, struct xdr_stream *xdr,
...
static bool svcxdr_encode_wcc_attr(struct xdr_stream *xdr,
    const struct svc_fh *fhp) {
  __be32 *p;
...
static bool svcxdr_encode_pre_op_attr(struct xdr_stream *xdr,
    const struct svc_fh *fhp) {
  if (!fhp->fh_pre_saved) {
 ...
 */
static bool svcxdr_encode_wcc_data(struct svc_rqst *rqstp,
    struct xdr_stream *xdr,
    const struct svc_fh *fhp) {
  struct dentry *dentry = fhp->fh_dentry;
...
bool nfs3svc_decode_fhandleargs(struct svc_rqst *rqstp,
    struct xdr_stream *xdr) {
...
bool nfs3svc_decode_symlinkargs(struct svc_rqst *rqstp,
    struct xdr_stream *xdr) {
...
bool nfs3svc_decode_readdirargs(struct svc_rqst *rqstp,
    struct xdr_stream *xdr) {
...
/* READLINK */
bool nfs3svc_encode_readlinkres(struct svc_rqst *rqstp,
    struct xdr_stream *xdr) {
...
static __be32 compose_entry_fh(struct nfsd3_readdirres *cd, struct svc_fh *fhp,
...
static bool svcxdr_encode_entry3_common(struct nfsd3_readdirres *resp,
    const char *name,
...
static bool svcxdr_encode_entry3_plus(struct nfsd3_readdirres *resp,
    const char *name,
    int namlen, u64 ino) {
  struct xdr_stream *xdr = &resp->xdr;
...
static bool svcxdr_encode_fsstat3resok(struct xdr_stream *xdr,
...
static bool svcxdr_encode_fsinfo3resok(struct xdr_stream *xdr,
...
static bool svcxdr_encode_pathconf3resok(struct xdr_stream *xdr,
...
/* PATHCONF */
bool nfs3svc_encode_pathconfres(struct svc_rqst *rqstp,
    struct xdr_stream *xdr) {
 ...
 */
void nfs3svc_release_fhandle(struct svc_rqst *rqstp) {
  struct nfsd3_attrstat *resp = rqstp->rq_resp;
  fh_put(&resp->fh);
}

void nfs3svc_release_fhandle2(struct svc_rqst *rqstp) {
