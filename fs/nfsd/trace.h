...
TRACE_EVENT(nfsd_file_acquire,
    ...
    TP_printk(
    "xid=0x%x inode=%p may_flags=%s ref=%u nf_flags=%s nf_may=%s nf_file=%p status=%u",
    __entry->xid, __entry->inode,
...
TRACE_EVENT(nfsd_file_cons_err,
    ...
    TP_printk(
    "xid=0x%x inode=%p may_flags=%s ref=%u nf_flags=%s nf_may=%s nf_file=%p",
    __entry->xid, __entry->inode,
...
TRACE_EVENT(nfsd_drc_mismatch,
    ...
    TP_printk(
    "boot_time=%16llx xid=0x%08x cached-csum=0x%08x ingress-csum=0x%08x",
...
TRACE_EVENT(nfsd_cb_offload,
    ...
    TP_printk(
    "addr=%pISpc client %08x:%08x stateid %08x:%08x fh_hash=0x%08x count=%llu status=%d",
    __get_sockaddr(addr), __entry->cl_boot, __entry->cl_id,
    __entry->si_id, __entry->si_generation,
