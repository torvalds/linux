...
static ssize_t nfsctl_transaction_write(struct file *file,
...
static ssize_t nfsctl_transaction_read(struct file *file, char __user *buf,
...
static ssize_t nfsd_print_version_support(struct nfsd_net *nn, char *buf,
    int remaining,
...
static struct dentry *nfsd_mkdir(struct dentry *parent,
    struct nfsdfs_client *ncl, char *name) {
...
static int nfsd_fill_super(struct super_block *sb, struct fs_context *fc) {
  ...
  static const struct tree_descr nfsd_files[] = {
    ...
    [NFSD_MaxConnections]
      = {"max_connections", &transaction_ops, S_IWUSR | S_IRUGO},
    [NFSD_Filecache] = {"filecache", &nfsd_file_cache_stats_fops, S_IRUGO},
#ifdef CONFIG_NFSD_V4
    [NFSD_Leasetime] = {"nfsv4leasetime", &transaction_ops, S_IWUSR | S_IRUSR},
    [NFSD_Gracetime] = {"nfsv4gracetime", &transaction_ops, S_IWUSR | S_IRUSR},
    [NFSD_RecoveryDir]
      = {"nfsv4recoverydir", &transaction_ops, S_IWUSR | S_IRUSR},
