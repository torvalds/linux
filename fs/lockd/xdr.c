...
static inline loff_t s32_to_loff_t(__s32 offset) {
  return (loff_t) offset;
}

static inline __s32 loff_t_to_s32(loff_t offset) {
  __s32 res;
 ...
 * handle.
 */
static bool svcxdr_decode_fhandle(struct xdr_stream *xdr, struct nfs_fh *fh) {
  __be32 *p;
  u32 len;
...
static bool svcxdr_decode_lock(struct xdr_stream *xdr, struct nlm_lock *lock) {
...
static bool svcxdr_encode_holder(struct xdr_stream *xdr,
...
static bool svcxdr_encode_testrply(struct xdr_stream *xdr,
