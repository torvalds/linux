...
static inline bool svcxdr_decode_stats(struct xdr_stream *xdr, __be32 *status) {
  __be32 *p;
...
static inline bool svcxdr_encode_stats(struct xdr_stream *xdr, __be32 status) {
  __be32 *p;
...
static inline bool svcxdr_decode_string(struct xdr_stream *xdr, char **data,
 ...
 * specially.
 */
static inline bool svcxdr_decode_cookie(struct xdr_stream *xdr,
...
static inline bool svcxdr_encode_cookie(struct xdr_stream *xdr,
...
static inline bool svcxdr_decode_owner(struct xdr_stream *xdr,
...
static inline bool svcxdr_encode_owner(struct xdr_stream *xdr,
