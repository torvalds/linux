...
struct victim_sel_policy {
  ...
  unsigned long long oldest_age;  /* oldest age of segments having the same min
                                   * cost */
...
struct curseg_info {
  ...
  int fragment_remained_chunk;    /* remained block size in a chunk for block
                                   * fragmentation mode */
...
static inline void wake_up_discard_thread(struct f2fs_sb_info *sbi,
    bool force) {
