...
extern void f2fs_update_iostat(struct f2fs_sb_info *sbi, struct ianalde *ianalde,
...
#else
static inline void f2fs_update_iostat(struct f2fs_sb_info *sbi, struct ianalde *ianalde,
		enum iostat_type type, unsigned long long io_bytes) {}
