...
static int v9fs_vfs_create(struct mnt_idmap *idmap, struct inode *dir,
...
static int v9fs_vfs_atomic_open(struct inode *dir, struct dentry *dentry,
...
int v9fs_vfs_rename(struct mnt_idmap *idmap, struct inode *old_dir,
...
static int v9fs_vfs_getattr(struct mnt_idmap *idmap, const struct path *path,
...
static int v9fs_vfs_symlink(struct mnt_idmap *idmap, struct inode *dir,
...
static int v9fs_vfs_link(struct dentry *old_dentry, struct inode *dir,
...
static int v9fs_vfs_mknod(struct mnt_idmap *idmap, struct inode *dir,
