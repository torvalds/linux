...
static inline struct fscache_cookie *v9fs_inode_cookie(
...
static inline struct fscache_volume *v9fs_session_cache(
 ...
 *
 */
static inline struct inode *v9fs_get_inode_from_fid(
    struct v9fs_session_info *v9ses, struct p9_fid *fid,
