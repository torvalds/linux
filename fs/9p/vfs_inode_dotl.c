...
static int v9fs_vfs_mknod_dotl(struct mnt_idmap *idmap, struct inode *dir,
 ...
 *
 */
static int v9fs_vfs_create_dotl(struct mnt_idmap *idmap, struct inode *dir,
    struct dentry *dentry, umode_t omode, bool excl) {
  return v9fs_vfs_mknod_dotl(idmap, dir, dentry, omode, 0);
}

static int v9fs_vfs_atomic_open_dotl(struct inode *dir, struct dentry *dentry,
...
static int v9fs_vfs_getattr_dotl(struct mnt_idmap *idmap,
...
static int v9fs_vfs_symlink_dotl(struct mnt_idmap *idmap, struct inode *dir,
...
static int v9fs_vfs_link_dotl(struct dentry *old_dentry, struct inode *dir,
...
static const char *v9fs_vfs_get_link_dotl(struct dentry *dentry,
    struct inode *inode,
