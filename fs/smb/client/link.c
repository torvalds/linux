...
static int symlink_hash(unsigned int link_len, const char *link_str,
    u8 *md5_hash) {
  int rc;
...
static int parse_mf_symlink(const u8 *buf, unsigned int buf_len,
...
static int format_mf_symlink(u8 *buf, unsigned int buf_len,
    const char *link_str) {
  int rc;
  unsigned int link_len;
  unsigned int ofs;
...
static int create_mf_symlink(const unsigned int xid, struct cifs_tcon *tcon,
