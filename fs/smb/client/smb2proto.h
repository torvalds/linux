...
extern int smb2_query_reparse_tag(const unsigned int xid,
...
int smb2_parse_symlink_response(struct cifs_sb_info *cifs_sb,
    const struct kvec *iov, char **path);
...
extern int SMB311_posix_query_info(const unsigned int xid,
    struct cifs_tcon *tcon,
...
extern int smb2_handle_cancelled_close(struct cifs_tcon *tcon,
    ...
    __u64 volatile_fid);
extern int smb2_handle_cancelled_mid(struct mid_q_entry *mid,
    struct TCP_Server_Info *server);
