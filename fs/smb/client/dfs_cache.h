...
static inline struct dfs_cache_tgt_iterator *dfs_cache_get_next_tgt(
...
static inline struct dfs_cache_tgt_iterator *dfs_cache_get_tgt_iterator(
    struct dfs_cache_tgt_list *tl) {
  if (!tl) {
    return NULL;
  }
...
static inline const char *dfs_cache_get_tgt_name(
    const struct dfs_cache_tgt_iterator *it) {
  return it ? it->it_name : NULL;
}

static inline int dfs_cache_get_nr_tgts(const struct dfs_cache_tgt_list *tl) {
