...
static int check_smb2_hdr(struct smb2_hdr *shdr, __u64 mid) {
...
#define SMB311_NEGPROT_BASE_SIZE (sizeof(struct smb2_hdr) \
...
int smb2_check_message(char *buf, unsigned int len,
...
static void cifs_ses_oplock_break(struct work_struct *work) {
...
static void smb2_queue_pending_open_break(struct tcon_link *tlink,
    __u8 *lease_key,
...
static bool smb2_tcon_has_lease(struct cifs_tcon *tcon,
...
static struct cifs_pending_open *smb2_tcon_find_pending_open_lease(
...
static bool smb2_is_valid_lease_break(char *buffer,
    struct TCP_Server_Info *server) {
 ...
 */
static int __smb2_handle_cancelled_cmd(struct cifs_tcon *tcon, __u16 cmd,
    __u64 mid,
 ...
 */
int smb311_update_preauth_hash(struct cifs_ses *ses,
    struct TCP_Server_Info *server,
