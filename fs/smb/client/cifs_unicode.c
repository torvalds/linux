...
static bool convert_sfu_char(const __u16 src_char, char *target) {
  /*
...
static bool convert_sfm_char(const __u16 src_char, char *target) {
 ...
 */
static int cifs_mapchar(char *target, const __u16 *from,
...
static int cifs_local_to_utf16_bytes(const char *from, int len,
    const struct nls_table *codepage) {
  int charlen;
  int i;
  wchar_t wchar_to;
