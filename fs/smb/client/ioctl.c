...
static int cifs_dump_full_key(struct cifs_tcon *tcon,
    struct smb3_full_key_debug_info __user *in) {
...
search_end:
  ...
  switch (ses->server->cipher_type) {
    ...
    case SMB2_ENCRYPTION_AES128_GCM:
      ...
      out.server_in_key_length = out.server_out_key_length
  ...
  if (out.in_size
      < sizeof(out) + out.session_key_length + out.server_in_key_length
