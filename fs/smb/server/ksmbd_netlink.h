...
static inline char *ksmbd_share_config_path(
    struct ksmbd_share_config_response *sc) {
...
#define KSMBD_RPC_SRVSVC_METHOD_RETURN  (KSMBD_RPC_SRVSVC_METHOD_INVOKE \
  | KSMBD_RPC_METHOD_RETURN)
#define KSMBD_RPC_WKSSVC_METHOD_INVOKE  BIT(2)
#define KSMBD_RPC_WKSSVC_METHOD_RETURN  (KSMBD_RPC_WKSSVC_METHOD_INVOKE \
  | KSMBD_RPC_METHOD_RETURN)
...
#define KSMBD_RPC_SAMR_METHOD_RETURN  (KSMBD_RPC_SAMR_METHOD_INVOKE \
  | KSMBD_RPC_METHOD_RETURN)
#define KSMBD_RPC_LSARPC_METHOD_INVOKE  BIT(11)
#define KSMBD_RPC_LSARPC_METHOD_RETURN  (KSMBD_RPC_LSARPC_METHOD_INVOKE \
  | KSMBD_RPC_METHOD_RETURN)
