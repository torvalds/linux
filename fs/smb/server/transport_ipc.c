...
struct ksmbd_spnego_authen_response *ksmbd_ipc_spnego_authen_request(
    const char *spnego_blob, int blob_len) {
  struct ksmbd_ipc_msg *msg;
...
struct ksmbd_tree_connect_response *ksmbd_ipc_tree_connect_request(
...
struct ksmbd_share_config_response *ksmbd_ipc_share_config_request(
    const char *name) {
  struct ksmbd_ipc_msg *msg;
