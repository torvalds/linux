...
struct smb2_compression_payload_hdr {
  __le16 CompressionAlgorithm;
  __le16 Flags;
  __le32 Length; /* length of compressed playload including field below if
                  * present */
...
struct smb2_neg_context {
  ...
  __le16 DataLength;
  __le32 Reserved;
  /* Followed by array of data. NOTE: some servers require padding to 8 byte
   * boundary */
} __packed;
...
/* FILE_SYNCHRONOUS_IO_ALERT_LE   cpu_to_le32(0x00000010) should be zero,
 *ignored
 * FILE_SYNCHRONOUS_IO_NONALERT   cpu_to_le32(0x00000020) should be zero,
 *ignored*/
...
/* #define FILE_OPEN_FOR_FREE_SPACE_QUERY cpu_to_le32(0x00800000) should be
 * zero, ignored */
