 ...
 *
 * yeste: this header file must be the 1st include file
...
/*
 * Almost identical to Linux's timespec, but yest quite
 */
struct timestruc_t {
	__le32 tv_sec;
	__le32 tv_nsec;
...
#define	DXD_FILE	0x10	/* out-of-line file (iyesde) */
...
/*
 *	DASD limit information - stored in directory iyesde
 */
struct dasd {
