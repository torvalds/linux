 ...
 * the inode.
 */
static inline void diInitInode(struct inode *ip, int iagno, int ino, int extno,
    struct iag *iagp) {
  struct jfs_inode_info *jfs_ip = JFS_IP(ip);
 ...
 *  -EIO  - i/o error.
 */
static int diAllocAG(struct inomap *imap, int agno, bool dir,
    struct inode *ip) {
 ...
 *  -EIO  - i/o error.
 */
static int diAllocAny(struct inomap *imap, int agno, bool dir,
    struct inode *ip) {
  int ag, rc;
 ...
 *   new imap size;
 */
static int diNewIAG(struct inomap *imap, int *iagnop, int agno,
    struct metapage **mpp) {
  int rc;
  int iagno, i, xlen;
  struct inode *ipimap;
