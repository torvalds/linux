...
static inline void nilfs_set_default_options(struct super_block *sb,
    struct nilfs_super_block *sbp) {
  struct the_nilfs *nilfs = sb->s_fs_info;
  nilfs->ns_mount_opt
 ...
 */
static int nilfs_fill_super(struct super_block *sb, void *data, int silent) {
  struct the_nilfs *nilfs;
...
static struct dentry *nilfs_mount(struct file_system_type *fs_type, int flags,
