...
static inline void nilfs_sc_cstage_set(struct nilfs_sc_info *sci,
    int next_scnt) {
...
static int nilfs_segctor_reset_segment_buffer(struct nilfs_sc_info *sci) {
  ...
  sci->sc_finfo_ptr.bh = sumbh;
  sci->sc_finfo_ptr.offset = sumbytes;
  sci->sc_binfo_ptr.bh = sumbh;
  sci->sc_binfo_ptr.offset = sumbytes;
...
static int nilfs_segctor_update_payload_blocknr(struct nilfs_sc_info *sci,
    struct nilfs_segment_buffer *segbuf,
    int mode) {
...
static void nilfs_remove_written_gcinodes(struct the_nilfs *nilfs,
    struct list_head *head) {
  struct nilfs_inode_info *ii, *n;
  list_for_each_entry_safe(ii, n, head, i_dirty) {
...
static void nilfs_segctor_thread_construct(struct nilfs_sc_info *sci,
    int mode) {
  struct nilfs_transaction_info ti;
