 ...
 */
static inline unsigned long nilfs_palloc_groups_per_desc_block(
 ...
 * @inode: inode of metadata file using this allocator
 */
static inline unsigned long nilfs_palloc_groups_count(const struct inode *inode)
{
 ...
 */
static unsigned long nilfs_palloc_desc_blkoff(const struct inode *inode,
    unsigned long group) {
 ...
 */
static unsigned long nilfs_palloc_bitmap_blkoff(const struct inode *inode,
    unsigned long group) {
 ...
 */
static unsigned long nilfs_palloc_group_desc_nfrees(
 ...
 * @n: delta to be added
 */
static u32 nilfs_palloc_group_desc_add_entries(
 ...
 * @nr: serial number of the entry (e.g. inode number)
 */
static unsigned long nilfs_palloc_entry_blkoff(const struct inode *inode,
    __u64 nr) {
 ...
 * @kaddr: kernel address mapped for the page including the buffer
 */
static struct nilfs_palloc_group_desc *nilfs_palloc_block_get_group_desc(
    const struct inode *inode,
    unsigned long group,
 ...
 */
static unsigned long nilfs_palloc_rest_groups_in_desc_block(
    const struct inode *inode,
