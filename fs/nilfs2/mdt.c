...
static int nilfs_mdt_insert_new_block(struct inode *inode, unsigned long block,
...
static int nilfs_mdt_submit_block(struct inode *inode, unsigned long blkoff,
    blk_opf_t opf,
    struct buffer_head **out_bh) {
  struct buffer_head *bh;
  __u64 blknum = 0;
...
static int nilfs_mdt_write_page(struct page *page,
