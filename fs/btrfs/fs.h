...
static inline void btrfs_set_fs_generation(struct btrfs_fs_info *fs_info,
    u64 gen) {
...
static inline void btrfs_set_last_trans_committed(struct btrfs_fs_info *fs_info,
    u64 gen) {
...
static inline u64 btrfs_get_last_root_drop_gen(
    const struct btrfs_fs_info *fs_info) {
 ...
 * down the tree.
 */
static inline u64 btrfs_calc_insert_metadata_size(
    const struct btrfs_fs_info *fs_info,
    unsigned num_items) {
