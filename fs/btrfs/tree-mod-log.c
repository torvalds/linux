 ...
 */
static bool tree_mod_dont_log(struct btrfs_fs_info *fs_info,
...
static struct tree_mod_elem *__tree_mod_log_search(
 ...
 */
static struct tree_mod_elem *tree_mod_log_search_oldest(
    struct btrfs_fs_info *fs_info,
    u64 start, u64 min_seq) {
 ...
 */
static struct tree_mod_elem *tree_mod_log_oldest_root(
 ...
 */
struct extent_buffer *btrfs_get_old_root(struct btrfs_root *root,
    u64 time_seq) {
