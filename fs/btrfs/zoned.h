...
static inline int btrfs_advance_sb_log(struct btrfs_device *device,
    int mirror) {
  return 0;
}
...
static inline void btrfs_zoned_release_data_reloc_bg(
    struct btrfs_fs_info *fs_info,
    u64 logical, u64 length) {
}
...
static inline void btrfs_check_active_zone_reservation(
    struct btrfs_fs_info *fs_info) {
}
...
static inline bool btrfs_check_device_zone_type(
