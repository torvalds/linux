 ...
 *     surrounding whether or not we'd commit the transaction, but this waits
 *born
...
static const char *space_info_flag_to_str(
...
static inline u64 btrfs_calc_reclaim_metadata_size(
...
static bool need_preemptive_reclaim(struct btrfs_fs_info *fs_info,
    struct btrfs_space_info *space_info) {
  const u64 global_rsv_size = btrfs_block_rsv_reserved(
