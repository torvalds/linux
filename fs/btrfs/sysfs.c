...
static struct btrfs_feature_attr *to_btrfs_feature_attr(
 ...
 *
 * /sys/fs/btrfs/features      - all available features implemented by this
 *version
...
BTRFS_ATTR_RW(, offload_csum, btrfs_offload_csum_show,
    btrfs_offload_csum_store);
#endif
