 ...
 *
 * The lower boundary for the search is specified by the slot number
 *@first_slot.
 ...
 *
 * Slot may point to the total number of items (i.e. one position beyond the
 *last
 ...
 */
static int read_block_for_search(struct btrfs_root *root, struct btrfs_path *p,
 ...
 * start over
 */
static int setup_nodes_for_search(struct btrfs_trans_handle *trans,
