...
#define STATE_STRING_BUF_LEN  (sizeof(STATE_STRING_PREFACE) \
  + BTRFS_FS_STATE_COUNT + 1)

/*
 * Characters to print to indicate error conditions or uncommon filesystem
 *state.
 * RO is not an error.
 */
 ...
 *        of the original error should use EROFS when handling
