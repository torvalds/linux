...
static int do_zone_finish(struct btrfs_block_group *block_group,
    bool fully_written);
...
static inline u32 sb_zone_number(int shift, int mirror) {
  ...
  switch (mirror) {
    case 0:
      ...
      break;
    case 1:
      zone = 1ULL << (BTRFS_SB_LOG_FIRST_SHIFT - shift);
      break;
    case 2:
      zone = 1ULL << (BTRFS_SB_LOG_SECOND_SHIFT - shift);
      break;
  }
  ASSERT(zone <= U32_MAX);
  return (u32) zone;
...
struct btrfs_zoned_device_info *btrfs_clone_dev_zone_info(
