 ...
 */
void btrfs_lru_cache_init(struct btrfs_lru_cache *cache,
...
static struct btrfs_lru_cache_entry *match_entry(struct list_head *head,
    u64 key,
    u64 gen) {
 ...
 */
struct btrfs_lru_cache_entry *btrfs_lru_cache_lookup(
