 ...
 */
static noinline_for_stack bool lock_extent_buffer_for_io(
    struct extent_buffer *eb,
    struct writeback_control *wbc) {
  struct btrfs_fs_info *fs_info = eb->fs_info;
  bool ret = false;
 ...
 */
static int fiemap_search_slot(struct btrfs_inode *inode,
    struct btrfs_path *path,
    u64 file_offset) {
...
static bool folio_range_has_eb(struct btrfs_fs_info *fs_info,
    struct folio *folio) {
...
static struct extent_buffer *__alloc_extent_buffer(
    struct btrfs_fs_info *fs_info, u64 start,
    unsigned long len) {
...
static u8 *extent_buffer_get_byte(const struct extent_buffer *eb,
 ...
 */
void extent_buffer_bitmap_set(const struct extent_buffer *eb,
    unsigned long start,
