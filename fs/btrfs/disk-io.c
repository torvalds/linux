...
static int global_root_cmp(struct rb_node *a_node,
    const struct rb_node *b_node) {
...
int btrfs_global_root_insert(struct btrfs_root *root) {
  ...
  tmp
    = rb_find_add(&root->rb_node, &fs_info->global_root_tree, global_root_cmp);
...
static void free_root_pointers(struct btrfs_fs_info *info,
