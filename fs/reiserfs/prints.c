...
static int scnprintf_block_head(char *buf, size_t size,
...
static int scnprintf_buffer_head(char *buf, size_t size,
    struct buffer_head *bh) {
  return scnprintf(buf, size,
...
void store_print_tb(struct tree_balance *tb) {
  ...
  sprintf(print_tb_buf + strlen(print_tb_buf),
      "=====================================================================\n"
      "FEB list: ");
  /* print FEB list (list of buffers in form (bh (b_blocknr, b_count), that will
   * be used for new nodes) */
  h = 0;
