...
static int security_get(const struct xattr_handler *handler,
...
static int security_set(const struct xattr_handler *handler,
...
static int reiserfs_initxattrs(struct inode *inode,
