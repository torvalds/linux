...
static bool fill_with_dentries(struct dir_context *ctx, const char *name,
    int namelen,
 ...
 * inode->i_mutex: down
 */
int reiserfs_xattr_set_handle(struct reiserfs_transaction_handle *th,
 ...
 * inode->i_mutex: down
 */
int reiserfs_xattr_get(struct inode *inode, const char *name, void *buffer,
    size_t buffer_size) {
  ssize_t err = 0;
  struct dentry *dentry;
  size_t isize;
...
static inline bool reiserfs_xattr_list(
