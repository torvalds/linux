...
static void configfs_adjust_dir_dirent_depth_after_populate(
    struct configfs_dirent *sd) {
 ...
 */
static struct configfs_dirent *configfs_new_dirent(
...
static void link_obj(struct config_item *parent_item,
    struct config_item *item) {
  /*
...
static inline struct configfs_dirent *configfs_find_subsys_dentry(
