...
static void netfs_cache_read_terminated(void *priv,
 ...
 */
static void netfs_rreq_completed(struct netfs_io_request *rreq,
    bool was_async) {
...
static enum netfs_io_source netfs_cache_prepare_read(
    struct netfs_io_subrequest *subreq,
    loff_t i_size) {
  struct netfs_io_request *rreq = subreq->rreq;
  struct netfs_cache_resources *cres = &rreq->cache_resources;
 ...
 */
static enum netfs_io_source netfs_rreq_prepare_read(
    struct netfs_io_request *rreq,
    struct netfs_io_subrequest *subreq,
