...
static wait_queue_head_t glock_wait_table[GLOCK_WAIT_TABLE_SIZE]
__cacheline_aligned;
 ...
 * work queue.
 */
static void __gfs2_glock_queue_work(struct gfs2_glock *gl,
    unsigned long delay) {
...
static void glock_hash_walk(glock_examiner examiner,
