...
static int setup_new_flex_group_blocks(struct super_block *sb,
  ...
  int group_table_count[] = {
    1, 1, EXT4_SB(sb)->s_itb_per_group
  };
  ext4_fsblk_t start;
  ext4_fsblk_t block;
  struct ext4_sb_info *sbi = EXT4_SB(sb);
...
static struct buffer_head *ext4_get_bitmap(struct super_block *sb,
    __u64 block) {
...
/*
 * ext4_setup_new_descs() will set up the group descriptor descriptors of a flex
 *bg
 */
