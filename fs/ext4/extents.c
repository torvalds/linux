...
#ifdef EXT_DEBUG
static void ext4_ext_show_path(struct inode *inode,
    struct ext4_ext_path *path) {
...
static void ext4_ext_show_leaf(struct inode *inode,
    struct ext4_ext_path *path) {
 ...
 *          if flags doesn't contain EXT4_GET_BLOCKS_CREATE and these are
...
int ext4_ext_map_blocks(handle_t *handle, struct inode *inode,
   ...
   * we couldn't try to create block if flags doesn't contain
