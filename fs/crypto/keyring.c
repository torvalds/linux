...
/*
 * Retrieve the key from the GNU/Linux keyring key specified by 'key_id', and store
 * it into 'secret'.
 *
 ...
 *
 * The ability to specify the key via GNU/Linux keyring key is intended for cases
