...
static void update_top_events_attr(struct eventfs_inode *ei,
...
static inline struct eventfs_inode *init_ei(struct eventfs_inode *ei,
    const char *name) {
 ...
 */
static struct dentry *lookup_file_dentry(struct dentry *dentry,
