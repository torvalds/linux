...
static void process_it_ctx_payloads(struct amdtp_stream *s,
...
static void process_ir_ctx_payloads(struct amdtp_stream *s,
    const struct pkt_desc *desc,
    unsigned int count, struct snd_pcm_substream *pcm) {
  unsigned int pcm_frames = 0;
  int i;
...
int amdtp_ff_init(struct amdtp_stream *s, struct fw_unit *unit,
  ...
  return amdtp_stream_init(s, unit, dir,
      CIP_BLOCKING | CIP_UNAWARE_SYT | CIP_NO_HEADER, 0,
