...
int snd_efw_get_multiplier_mode(unsigned int sampling_rate,
    unsigned int *mode) {
  unsigned int i;
...
static void limit_channels(struct snd_pcm_hardware *hw,
...
static int pcm_init_hw_params(struct snd_efw *efw,
