...
static void copy_resp_to_buf(struct snd_efw *efw, void *data, size_t length,
    int *rcode) {
...
static void handle_resp_for_user(struct fw_card *card, int generation,
    int source,
...
static void handle_resp_for_kernel(struct fw_card *card, int generation,
    int source,
...
static void efw_response(struct fw_card *card, struct fw_request *request,
