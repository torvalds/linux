...
static int efw_transaction(struct snd_efw *efw, unsigned int category,
...
static int command_get_clock(struct snd_efw *efw, struct efc_clock *clock) {
  int err;
...
static int command_set_clock(struct snd_efw *efw,
