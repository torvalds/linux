...
static inline int saffire_read_block(struct snd_bebob *bebob, u64 offset,
...
static inline int saffire_read_quad(struct snd_bebob *bebob, u64 offset,
    u32 *value) {
  int err;
  __be32 tmp;
...
static inline int saffire_write_quad(struct snd_bebob *bebob, u64 offset,
    u32 value) {
...
static int saffirepro_both_clk_freq_get(struct snd_bebob *bebob,
    unsigned int *rate) {
  u32 id;
  int err;
...
static int saffirepro_both_clk_freq_set(struct snd_bebob *bebob,
    unsigned int rate) {
  u32 id;
 ...
 */
static int saffirepro_both_clk_src_get(struct snd_bebob *bebob,
    unsigned int *id) {
  int err;
...
static int saffire_both_clk_src_get(struct snd_bebob *bebob, unsigned int *id) {
  int err;
  u32 value;
...
static int saffire_meter_get(struct snd_bebob *bebob, u32 *buf,
    unsigned int size) {
