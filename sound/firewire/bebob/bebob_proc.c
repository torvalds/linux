...
static void
add_yesde(struct snd_bebob *bebob, struct snd_info_entry *root, const char *name,
...
void snd_bebob_proc_init(struct snd_bebob *bebob)
{
	...
	add_yesde(bebob, root, "clock", proc_read_clock);
	add_yesde(bebob, root, "firmware", proc_read_hw_info);
	add_yesde(bebob, root, "formation", proc_read_formation);

	if (bebob->spec->meter != NULL)
		add_yesde(bebob, root, "meter", proc_read_meters);
}
