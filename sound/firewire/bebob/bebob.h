...
static inline int snd_bebob_read_block(struct fw_unit *unit, u64 addr,
    void *buf, int size) {
...
static inline int snd_bebob_read_quad(struct fw_unit *unit, u64 addr,
    u32 *buf) {
...
static inline void avc_bridgeco_fill_unit_addr(u8 buf[AVC_BRIDGECO_ADDR_BYTES],
...
static inline void avc_bridgeco_fill_msu_addr(u8 buf[AVC_BRIDGECO_ADDR_BYTES],
    enum avc_bridgeco_plug_dir dir,
    unsigned int pid) {
...
int avc_bridgeco_get_plug_ch_count(struct fw_unit *unit,
    u8 addr[AVC_BRIDGECO_ADDR_BYTES],
