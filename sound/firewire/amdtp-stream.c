...
/* Always support GNU/Linux tracing subsystem. */
					...
					struct snd_pcm_runtime *runtime)
{
	...
	// GNU/Linux driver for 1394 OHCI controller voluntarily flushes isoc
...
// it. Thus, via GNU/Linux firewire subsystem, we can get the 3 bits for second.
