...
static struct hdac_ext_stream *hdac_ext_link_dma_stream_assign(
    struct hdac_bus *bus,
...
static struct hdac_ext_stream *hdac_ext_host_dma_stream_assign(
    struct hdac_bus *bus,
    struct snd_pcm_substream *substream) {
  struct hdac_ext_stream *res = NULL;
  struct hdac_stream *hstream = NULL;
 ...
 */
void snd_hdac_ext_stream_release(struct hdac_ext_stream *hext_stream,
    int type) {
