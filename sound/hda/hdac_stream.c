 ...
 * @direction: stream direction (SNDRV_PCM_STREAM_PLAYBACK or
...
/**
 * snd_hdac_stream_clear - helper to clear stream registers and stop DMA
 * transfers
...
void snd_hdac_stream_reset(struct hdac_stream *azx_dev) {
  ...
  snd_hdac_stream_readb_poll(azx_dev, SD_CTL, val, (val & SD_CTL_STREAM_RESET),
      3, 300);
...
int snd_hdac_stream_wait_drsm(struct hdac_stream *azx_dev) {
  ...
  ret = read_poll_timeout(snd_hdac_reg_readl, reg, !(reg & mask), 250, 2000,
      false, bus,
