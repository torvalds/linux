...
MODULE_AUTHOR(
    "Tugrul Galatali <galatalt@stuy.edu>, Jaroslav Kysela <perex@perex.cz>");
MODULE_LICENSE("GPL");
...
#ifdef CONFIG_PM
static int snd_ad1848_suspend(struct device *dev, unsigned int n,
    pm_message_t state) {
