...
#ifdef SNDRV_STB
static void snd_interwave_i2c_setlines(struct snd_i2c_bus *bus, int ctrl,
    int data) {
...
static void snd_interwave_detect_memory(struct snd_gus_card *gus) {
  ...
  snd_gf1_write8(gus, SNDRV_GF1_GB_GLOBAL_MODE,
      snd_gf1_read8(gus, SNDRV_GF1_GB_GLOBAL_MODE) | 0x01);   /* enhanced mode
                                                               * */
  snd_gf1_write8(gus, SNDRV_GF1_GB_MEMORY_CONTROL, 0x01); /* DRAM I/O cycles
                                                           * selected */
  snd_gf1_write16(gus, SNDRV_GF1_GW_MEMORY_CONFIG,
      (snd_gf1_look16(gus, SNDRV_GF1_GW_MEMORY_CONFIG) & 0xff10) | 0x004c);
...
#endif
  {
...
#endif
        snd_gf1_write16(gus, SNDRV_GF1_GW_MEMORY_CONFIG,
            (snd_gf1_look16(gus, SNDRV_GF1_GW_MEMORY_CONFIG) & 0xfff0) | i);
        snd_interwave_bank_sizes(gus, psizes);
        break;
      }
    }
    if (i >= ARRAY_SIZE(lmc) && !gus->gf1.enh_mode) {
      snd_gf1_write16(gus, SNDRV_GF1_GW_MEMORY_CONFIG,
          (snd_gf1_look16(gus, SNDRV_GF1_GW_MEMORY_CONFIG) & 0xfff0) | 2);
    }
    for (i = 0; i < 4; i++) {
  ...
  snd_gf1_write16(gus, SNDRV_GF1_GW_MEMORY_CONFIG,
      (snd_gf1_look16(gus, SNDRV_GF1_GW_MEMORY_CONFIG) & 0xff1f) | (4 << 5));
  gus->gf1.rom_banks = 0;
