...
MODULE_PARM_DESC(use_cs4232_midi,
...
static int snd_wavefront_pnp(int dev, snd_wavefront_card_t *acard,
   ...
   *
   * A. WSS I/O requires a block of 8 I/O addresses ("ports"). Of these, the
   * first
