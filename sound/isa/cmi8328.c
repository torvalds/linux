...
static char *id[CMI8328_MAX] = {
  [0 ... (CMI8328_MAX - 1)] = NULL
};
static long port[CMI8328_MAX] = {
  [0 ... (CMI8328_MAX - 1)] = SNDRV_AUTO_PORT
};
static int irq[CMI8328_MAX] = {
  [0 ... (CMI8328_MAX - 1)] = SNDRV_AUTO_IRQ
};
static int dma1[CMI8328_MAX] = {
  [0 ... (CMI8328_MAX - 1)] = SNDRV_AUTO_DMA
};
...
static int snd_cmi8328_probe(struct device *pdev, unsigned int ndev) {
...
#endif
  int err, pos;
  static const long mpu_ports[] = {
    0x330, 0x300, 0x310, 0x320, 0x332, 0x334,
    0x336, -1
  };
  static const u8 mpu_port_bits[] = {
    3, 0, 1, 2, 4, 5, 6
  };
  static const int mpu_irqs[] = {
    9, 7, 5, 3, -1
  };
  static const u8 mpu_irq_bits[] = {
    3, 2, 1, 0
  };
  static const int irqs[] = {
    9, 10, 11, 7, -1
  };
  static const u8 irq_bits[] = {
    2, 3, 4, 1
  };
  static const int dma1s[] = {
    3, 1, 0, -1
  };
  static const u8 dma_bits[] = {
    3, 2, 1
  };
  ...
  if (dma2[ndev] == SNDRV_AUTO_DMA) {
    ...
    if (dma2[ndev] < 0) {
      snd_printk(
          KERN_WARNING "unable to find a free DMA2, full-duplex will not work\n");
      dma2[ndev] = -1;
    }
  }
  /* configure WSS IRQ... */
