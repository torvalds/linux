...
static inline struct ac97_controller *to_ac97_controller(
    struct device *ac97_adapter) {
...
static struct ac97_codec_device *ac97_codec_find(
    struct ac97_controller *ac97_ctrl, unsigned int codec_num) {
...
static struct device_node *ac97_of_get_child_device(
    struct ac97_controller *ac97_ctrl, int idx,
