...
static inline bool ep_state_update(struct snd_usb_endpoint *ep, int old,
    int new) {
...
static struct snd_usb_packet_info *next_packet_fifo_enqueue(
...
static struct snd_usb_packet_info *next_packet_fifo_dequeue(
    struct snd_usb_endpoint *ep) {
  struct snd_usb_packet_info *p;
 ...
 */
static struct snd_usb_iface_ref *iface_ref_find(struct snd_usb_audio *chip,
    int iface) {
...
static struct snd_usb_clock_ref *clock_ref_find(struct snd_usb_audio *chip,
    int clock) {
