 ...
 */
static int parse_audio_format_rates_v1(struct snd_usb_audio *chip,
    struct audioformat *fp,
...
static int parse_audio_format_ii(struct snd_usb_audio *chip,
  ...
  switch (format) {
    case UAC_FORMAT_TYPE_II_AC3:
      ...
      fp->formats = SNDRV_PCM_FMTBIT_U8; /* temporary hack to receive byte
                                          * streams */
      break;
    ...
    case UAC_VERSION_1:
      {
        ...
        ret = parse_audio_format_rates_v1(chip, fp, _fmt, 8); /* fmt[8..] sample
                                                               * rates */
        break;
      }
    case UAC_VERSION_2:
