...
static long line6_hwdep_read(struct snd_hwdep *hwdep, char __user *buf,
    long count,
    loff_t *offset) {
...
static long line6_hwdep_write(struct snd_hwdep *hwdep, const char __user *data,
    long count,
    loff_t *offset) {
  struct usb_line6 *line6 = hwdep->private_data;
  int rv;
...
static __poll_t line6_hwdep_poll(struct snd_hwdep *hwdep, struct file *file,
    poll_table *wait) {
  __poll_t rv;
  struct usb_line6 *line6 = hwdep->private_data;
