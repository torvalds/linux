...
struct snd_usb_substream {
  ...
  const struct audioformat *cur_audiofmt; /* current audioformat pointer (for
                                           * hw_params callback) */
  ...
  unsigned int fmt_type;    /* USB audio format type (1-3) */
  unsigned int pkt_offset_adj;  /* Bytes to drop from beginning of packets (for
                                 * non-compliant devices) */
  unsigned int stream_offset_adj; /* Bytes to drop from beginning of stream (for
                                   * non-compliant devices) */
  ...
  bool trigger_tstamp_pending_update; /* trigger timestamp being updated from
                                       * initial estimate */
  bool lowlatency_playback; /* low-latency playback mode */
