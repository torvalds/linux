...
MODULE_PARM_DESC(delayed_register,
...
MODULE_PARM_DESC(skip_validation,
...
static const struct usb_audio_device_name *lookup_device_name(u32 id) {
...
static const struct snd_usb_audio_quirk *get_alias_quirk(struct usb_device *dev,
    unsigned int id) {
