...
struct snd_usb_midi2_endpoint {
  ...
  const struct usb_ms20_endpoint_descriptor *ms_ep; /* reference to EP
                                                     * descriptor */
...
static struct snd_usb_midi2_endpoint *ump_to_endpoint(
    struct snd_ump_endpoint *ump, int dir) {
...
static const struct usb_ms20_gr_trm_block_descriptor *find_group_terminal_block(
    struct snd_usb_midi2_interface *umidi, int id) {
...
static struct snd_usb_midi2_ump *find_midi2_ump(
    struct snd_usb_midi2_interface *umidi, int blk_id) {
  struct snd_usb_midi2_ump *rmidi;
  list_for_each_entry(rmidi, &umidi->rawmidi_list, list) {
