...
static const struct snd_usb_implicit_fb_match *find_implicit_fb_entry(
...
static struct snd_usb_substream *find_matching_substream(
    struct snd_usb_audio *chip, int stream, int ep_num,
    int fmt_type) {
