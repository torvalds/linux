...
static int snd_s1810c_send_ctl_packet(struct usb_device *dev, u32 a,
 ...
 */
static int snd_s1810c_get_switch_state(struct usb_mixer_interface *mixer,
 ...
 */
static int snd_s1810c_set_switch_state(struct usb_mixer_interface *mixer,
...
static int snd_s1810c_switch_get(struct snd_kcontrol *kctl,
...
static int snd_s1810c_switch_init(struct usb_mixer_interface *mixer,
...
static int snd_s1810c_ab_sw_info(struct snd_kcontrol *kctl,
    struct snd_ctl_elem_info *uinfo) {
  static const char * const texts[2] = {
    "1/2",
    "3/4"
