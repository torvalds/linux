...
static struct audioformat *audio_format_alloc_init(struct snd_usb_audio *chip,
    struct usb_host_interface *alts,
...
static struct audioformat *snd_usb_get_audioformat_uac12(
