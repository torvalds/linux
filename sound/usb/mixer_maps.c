 ...
 *
 * USB_IN[1]
 *--->FU[2]------------------------------+->MU[16]-->PU[17]-+->FU[18]--+->EU[27]--+->EU[21]-->FU[22]--+->FU[23]
 *> Dig_OUT[24]
 *                                               ^                  |          |
 *         |                   |
 * USB_IN[3] -+->SU[5]-->FU[6]--+->MU[14] ->PU[15]->+                  |
 *         |          |                   +->FU[25] > Dig_OUT[26]
 *         ^                 ^                   |                  |          |
 *         |
 * Dig_IN[4] -+                 |                   |                  |
 ...
 */
static const struct usbmix_dB_map mp3plus_dB_1 = {
  .min = -4781, .max = 0
};
/* just guess */
static const struct usbmix_dB_map mp3plus_dB_2 = {
  .min = -1781, .max = 618
};
/* just guess */
 ...
 * The USB Mixer publishes a Microphone and extra Volume controls for it, but
...
static const struct usbmix_dB_map bose_companion5_dB = {
  -5006, -6
};
...
static const struct usbmix_dB_map bose_soundlink_dB = {
  -8283, -0, true
};
 ...
 * negative maximum  */
static const struct usbmix_dB_map sennheiser_pc8_dB = {
  -9500, 0
};
...
static const struct usbmix_dB_map ms_usb_link_dB = {
  -3225, 0, true
};
