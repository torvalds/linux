...
static struct usb_desc_validator audio_validators[] = {
	...
	/* UAC_VERSION_2, UAC2_EFFECT_UNIT: yest implemented yet */
	...
	/* UAC_VERSION_2, UAC2_SAMPLE_RATE_CONVERTER: yest implemented yet */
	...
	/* UAC_VERSION_3, UAC3_EXTENDED_TERMINAL: yest implemented yet */
	FUNC(UAC_VERSION_3, UAC3_MIXER_UNIT, validate_mixer_unit),
	FUNC(UAC_VERSION_3, UAC3_SELECTOR_UNIT, validate_selector_unit),
	FUNC(UAC_VERSION_3, UAC_FEATURE_UNIT, validate_uac3_feature_unit),
	/*  UAC_VERSION_3, UAC3_EFFECT_UNIT: yest implemented yet */
	...
	/* UAC_VERSION_3, UAC3_SAMPLE_RATE_CONVERTER: yest implemented yet */
	/* UAC_VERSION_3, UAC3_CONNECTORS: yest implemented yet */
	{ } /* terminator */
};
			  ...
			  const struct usb_desc_validator *v)
{
	...
	return true; /* yest matching, skip validation */
}
