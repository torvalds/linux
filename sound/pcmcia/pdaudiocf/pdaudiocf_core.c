...
{
	printk(KERN_DE "PDAUDIOCF DUMP (0x%lx):\n", chip->port);
	printk(KERN_DE "WPD         : 0x%x\n",
	       inw(chip->port + PDAUDIOCF_REG_WDP));
	printk(KERN_DE "RDP         : 0x%x\n",
	       inw(chip->port + PDAUDIOCF_REG_RDP));
	printk(KERN_DE "TCR         : 0x%x\n",
	       inw(chip->port + PDAUDIOCF_REG_TCR));
	printk(KERN_DE "SCR         : 0x%x\n",
	       inw(chip->port + PDAUDIOCF_REG_SCR));
	printk(KERN_DE "ISR         : 0x%x\n",
	       inw(chip->port + PDAUDIOCF_REG_ISR));
	printk(KERN_DE "IER         : 0x%x\n",
	       inw(chip->port + PDAUDIOCF_REG_IER));
	printk(KERN_DE "AK_IFR      : 0x%x\n",
