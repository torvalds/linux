...
static unsigned char input_clk_map_imx53[ASRC_CLK_MAP_LEN] = {
   ...
   *  0xf */
  0x0, 0x1, 0x2, 0x7, 0x4, 0x5, 0x6, 0x3, 0x8, 0x9, 0xa, 0xb, 0xc, 0xf, 0xe,
  0xd,
...
static unsigned char output_clk_map_imx53[ASRC_CLK_MAP_LEN] = {
  /*  0x0  0x1  0x2  0x3  0x4  0x5  0x6  0x7  0x8  0x9  0xa  0xb  0xc  0xd  0xe
   *  0xf */
  0x8, 0x9, 0xa, 0x7, 0xc, 0x5, 0x6, 0xb, 0x0, 0x1, 0x2, 0x3, 0x4, 0xf, 0xe,
  0xd,
  0x7, 0x7, 0x7, 0x7, 0x7, 0x7, 0x7, 0x7, 0x7, 0x7, 0x7, 0x7, 0x7, 0x7, 0x7,
  0x7,
  0x7, 0x7, 0x7, 0x7, 0x7, 0x7, 0x7, 0x7, 0x7, 0x7, 0x7, 0x7, 0x7, 0x7, 0x7,
...
static unsigned char clk_map_imx8qm[2][ASRC_CLK_MAP_LEN] = {
  ...
  {
    0xf, 0xf, 0xf, 0xf, 0xf, 0x7, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf,
    0x0,
    0x0, 0x1, 0x2, 0x3, 0xb, 0xc, 0xf, 0xf, 0xd, 0xe, 0xf, 0xf, 0xf, 0xf, 0xf,
    0xf,
    0x4, 0x5, 0x6, 0xf, 0x8, 0x9, 0xa, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf,
    0xf,
  },
};
...
static unsigned char clk_map_imx8qxp[2][ASRC_CLK_MAP_LEN] = {
  {
    0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf,
    0x0,
    0x0, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0xf, 0x7, 0x8, 0x9, 0xa, 0xb, 0xc, 0xf,
    0xf,
    0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf,
    0xf,
  },
  {
    0xf, 0xf, 0xf, 0xf, 0xf, 0x7, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf,
    0x0,
    0x0, 0x1, 0x2, 0x3, 0x7, 0x8, 0xf, 0xf, 0x9, 0xa, 0xf, 0xf, 0xf, 0xf, 0xf,
    0xf,
    0xf, 0xf, 0x6, 0xf, 0xf, 0xf, 0xa, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf,
    0xf,
  },
};
 ...
 */
static void fsl_asrc_set_watermarks(struct fsl_asrc_pair *pair, u32 in,
    u32 out) {
  struct fsl_asrc *asrc = pair->asrc;
  enum asrc_pair_index index = pair->index;
...
/**
 * fsl_asrc_cal_asrck_divisor - Calculate the total divisor between asrck clock
 * rate and sample rate
 * @pair: pointer to pair
 * @div: divider
 *
...
static void fsl_asrc_select_clk(struct fsl_asrc_priv *asrc_priv,
  ...
  if (select_clk[IN] == ASRC_CLK_MAP_LEN
      || select_clk[OUT] == ASRC_CLK_MAP_LEN) {
...
static int fsl_asrc_probe(struct platform_device *pdev) {
  ...
  asrc->regmap
    = devm_regmap_init_mmio(&pdev->dev, regs, &fsl_asrc_regmap_config);
