...
static const struct snd_kcontrol_new fsl_micfil_snd_controls[] = {
  ...
  SOC_SINGLE_RANGE("HWVAD Detector Frame Time", REG_MICFIL_VAD0_CTRL2, 16, 0,
      63, 0),
  SOC_SINGLE("HWVAD Detector Initialization Time", REG_MICFIL_VAD0_CTRL1, 8, 31,
      0),
  SOC_SINGLE("HWVAD Noise Filter Adjustment", REG_MICFIL_VAD0_NCONFIG, 8, 31,
      0),
...
static int fsl_micfil_configure_hwvad_interrupts(struct fsl_micfil *micfil,
    int enable) {
...
static irqreturn_t micfil_isr(int irq, void *devid) {
  ...
  dma_enabled
    = FIELD_GET(MICFIL_CTRL1_DISEL, ctrl1_reg) == MICFIL_CTRL1_DISEL_DMA;
