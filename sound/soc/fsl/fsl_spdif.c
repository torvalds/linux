...
static int spdif_set_sample_rate(struct snd_pcm_substream *substream,
  ...
  struct fsl_spdif_priv *spdif_priv = snd_soc_dai_get_drvdata(snd_soc_rtd_to_cpu(
      rtd,
      0));
  struct spdif_mixer_control *ctrl = &spdif_priv->fsl_spdif_control;
  struct regmap *regmap = spdif_priv->regmap;
...
static int spdif_reparent_rootclk(struct fsl_spdif_priv *spdif_priv,
...
static int fsl_spdif_dai_probe(struct snd_soc_dai *dai) {
  ...
  spdif_private->rxrate_kcontrol = snd_soc_card_get_kcontrol(
      dai->component->card,
...
static int fsl_spdif_probe_txclk(struct fsl_spdif_priv *spdif_priv,
  ...
  if (clk_is_match(spdif_priv->txclk[spdif_priv->txclk_src[index]],
      spdif_priv->sysclk)) {
