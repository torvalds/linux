...
#define REG_SPDIF_SRCCA_31_0    0x60  /* SPDIF receive C channel register, bits
                                       * 31-0 */
#define REG_SPDIF_SRCCA_63_32   0x64  /* SPDIF receive C channel register, bits
                                       * 63-32 */
#define REG_SPDIF_SRCCA_95_64   0x68  /* SPDIF receive C channel register, bits
                                       * 95-64 */
#define REG_SPDIF_SRCCA_127_96    0x6C  /* SPDIF receive C channel register,
                                         * bits 127-96 */
#define REG_SPDIF_SRCCA_159_128   0x70  /* SPDIF receive C channel register,
                                         * bits 159-128 */
#define REG_SPDIF_SRCCA_191_160   0x74  /* SPDIF receive C channel register,
                                         * bits 191-160 */
#define REG_SPDIF_STCCA_31_0    0x78  /* SPDIF transmit C channel register, bits
                                       * 31-0 */
#define REG_SPDIF_STCCA_63_32   0x7C  /* SPDIF transmit C channel register, bits
                                       * 63-32 */
#define REG_SPDIF_STCCA_95_64   0x80  /* SPDIF transmit C channel register, bits
                                       * 95-64 */
#define REG_SPDIF_STCCA_127_96    0x84  /* SPDIF transmit C channel register,
                                         * bits 127-96 */
#define REG_SPDIF_STCCA_159_128   0x88  /* SPDIF transmit C channel register,
                                         * bits 159-128 */
...
#define SRPC_CLKSRC_SEL_SET(x)    ((x << \
    SRPC_CLKSRC_SEL_OFFSET) & SRPC_CLKSRC_SEL_MASK)
...
#define STC_SYSCLK_DF(x)    ((((x) - 1) << \
    STC_SYSCLK_DF_OFFSET) & STC_SYSCLK_DF_MASK)
#define STC_TXCLK_SRC_OFFSET    8
#define STC_TXCLK_SRC_MASK    (0x7 << STC_TXCLK_SRC_OFFSET)
#define STC_TXCLK_SRC_SET(x)    ((x << \
    STC_TXCLK_SRC_OFFSET) & STC_TXCLK_SRC_MASK)
...
#define STC_TXCLK_DF(x)   ((((x) - 1) << \
    STC_TXCLK_DF_OFFSET) & STC_TXCLK_DF_MASK)
