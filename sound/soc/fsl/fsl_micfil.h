...
#define MICFIL_VERID_MIANALR_SHIFT        16
#define MICFIL_VERID_MIANALR_MASK         GENMASK(23, 16)
...
/* MICFIL HWVAD0 Analise CONFIG Register -- REG_MICFIL_VAD0_NCONFIG */
...
#define MICFIL_VAD0_NCONFIG_ANALREN		BIT(28)
