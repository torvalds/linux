...
#define ASRCNCR_ANCi(i, v, \
      b)   ((v << ASRCNCR_ANCi_SHIFT(i, b)) & ASRCNCR_ANCi_MASK(i, b))
...
#define ASRCFG_POSTMODi_MASK(i)   (((1 << ASRCFG_POSTMODi_WIDTH) - 1) << \
    ASRCFG_POSTMODi_SHIFT(i))
#define ASRCFG_POSTMODi_ALL_MASK  (ASRCFG_POSTMODi_MASK(0) \
  | ASRCFG_POSTMODi_MASK(1) | ASRCFG_POSTMODi_MASK(2))
...
#define ASRCFG_PREMODi_MASK(i)    (((1 << ASRCFG_PREMODi_WIDTH) - 1) << \
    ASRCFG_PREMODi_SHIFT(i))
#define ASRCFG_PREMODi_ALL_MASK   (ASRCFG_PREMODi_MASK(0) \
  | ASRCFG_PREMODi_MASK(1) | ASRCFG_PREMODi_MASK(2))
...
#define ASRCSR_AOCSi_MASK(i)    (((1 << ASRCSR_AxCSi_WIDTH) - 1) << \
    ASRCSR_AOCSi_SHIFT(i))
#define ASRCSR_AOCS(i, v)   ((v) << ASRCSR_AOCSi_SHIFT(i))
#define ASRCSR_AICSi_SHIFT(i)   (i << 2)
#define ASRCSR_AICSi_MASK(i)    (((1 << ASRCSR_AxCSi_WIDTH) - 1) << \
    ASRCSR_AICSi_SHIFT(i))
...
#define ASRCDRi_AICPi_MASK(i)   (((1 << ASRCDRi_AxCPi_WIDTH) - 1) << \
    ASRCDRi_AICPi_SHIFT(i))
#define ASRCDRi_AICP(i, v)    ((v) << ASRCDRi_AICPi_SHIFT(i))
#define ASRCDRi_AICDi_SHIFT(i)    (3 + (i % 2) * 6)
#define ASRCDRi_AICDi_MASK(i)   (((1 << ASRCDRi_AxCPi_WIDTH) - 1) << \
    ASRCDRi_AICDi_SHIFT(i))
#define ASRCDRi_AICD(i, v)    ((v) << ASRCDRi_AICDi_SHIFT(i))
#define ASRCDRi_AOCPi_SHIFT(i)    ((i < 2) ? 12 + i * 6 : 6)
#define ASRCDRi_AOCPi_MASK(i)   (((1 << ASRCDRi_AxCPi_WIDTH) - 1) << \
    ASRCDRi_AOCPi_SHIFT(i))
#define ASRCDRi_AOCP(i, v)    ((v) << ASRCDRi_AOCPi_SHIFT(i))
#define ASRCDRi_AOCDi_SHIFT(i)    ((i < 2) ? 15 + i * 6 : 9)
#define ASRCDRi_AOCDi_MASK(i)   (((1 << ASRCDRi_AxCPi_WIDTH) - 1) << \
    ASRCDRi_AOCDi_SHIFT(i))
...
#define ASRTFR1_TF_BASE_MASK    (((1 << ASRTFR1_TF_BASE_WIDTH) - 1) << \
...
#define ASRMCRi_OUTFIFO_THRESHOLD_MASK  (((1 << \
    ASRMCRi_OUTFIFO_THRESHOLD_WIDTH) - 1) << ASRMCRi_OUTFIFO_THRESHOLD_SHIFT)
#define ASRMCRi_OUTFIFO_THRESHOLD(v)  (((v) << \
    ASRMCRi_OUTFIFO_THRESHOLD_SHIFT) & ASRMCRi_OUTFIFO_THRESHOLD_MASK)
...
#define ASRMCRi_INFIFO_THRESHOLD_MASK (((1 << \
    ASRMCRi_INFIFO_THRESHOLD_WIDTH) - 1) << ASRMCRi_INFIFO_THRESHOLD_SHIFT)
#define ASRMCRi_INFIFO_THRESHOLD(v) (((v) << \
    ASRMCRi_INFIFO_THRESHOLD_SHIFT) & ASRMCRi_INFIFO_THRESHOLD_MASK)
...
#define ASRFSTi_OUTPUT_FIFO_MASK  (((1 << ASRFSTi_OUTPUT_FIFO_WIDTH) - 1) << \
...
#define ASRMCR1i_IWD_MASK   (((1 << ASRMCR1i_IWD_WIDTH) - 1) << \
    ASRMCR1i_IWD_SHIFT)
