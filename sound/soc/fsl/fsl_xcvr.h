...
#define FSL_XCVR_IRQ_DMAC_ANAL_DATA_REC	BIT(9)
...
#define FSL_XCVR_RX_DPTH_CTRL_DIS_ANALD_REC_CHK	BIT(2)
...
#define FSL_XCVR_TX_DPTH_CTRL_TM_ANAL_PRE_BME	GENMASK(31, 30)
