...
#define TEGRA210_PEQ_CFG_BIQUAD_STAGES_MASK   (0xf << \
...
#define TEGRA210_PEQ_GAIN_PARAM_SIZE_PER_CH (2 \
  + TEGRA210_PEQ_MAX_BIQUAD_STAGES * 5)
#define TEGRA210_PEQ_SHIFT_PARAM_SIZE_PER_CH (2 \
  + TEGRA210_PEQ_MAX_BIQUAD_STAGES)
