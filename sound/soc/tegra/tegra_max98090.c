...
static int tegra_max98090_probe(struct platform_device *pdev)
{
	...
	tegra_max98090_dai.codecs->of_yesde = of_parse_phandle(np,
			"nvidia,audio-codec", 0);
	if (!tegra_max98090_dai.codecs->of_yesde) {
		dev_err(&pdev->dev,
	...
	tegra_max98090_dai.cpus->of_yesde = of_parse_phandle(np,
			"nvidia,i2s-controller", 0);
	if (!tegra_max98090_dai.cpus->of_yesde) {
		dev_err(&pdev->dev,
	...
	tegra_max98090_dai.platforms->of_yesde = tegra_max98090_dai.cpus->of_yesde;
