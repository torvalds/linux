...
#define TEGRA186_ASRC_STREAM_ENABLE_HW_RATIO_COMP_MASK    (1 << \
    TEGRA186_ASRC_STREAM_ENABLE_HW_RATIO_COMP_SHIFT)
#define TEGRA186_ASRC_STREAM_ENABLE_HW_RATIO_COMP_ENABLE  (1 << \
    TEGRA186_ASRC_STREAM_ENABLE_HW_RATIO_COMP_SHIFT)
#define TEGRA186_ASRC_STREAM_ENABLE_HW_RATIO_COMP_DISABLE (0 << \
    TEGRA186_ASRC_STREAM_ENABLE_HW_RATIO_COMP_SHIFT)

#define TEGRA186_ASRC_STREAM_RATIO_TYPE_SHIFT     0
#define TEGRA186_ASRC_STREAM_RATIO_TYPE_MASK      (1 << \
    TEGRA186_ASRC_STREAM_RATIO_TYPE_SHIFT)
...
#define TEGRA186_ASRC_STREAM_STATEBUF_CFG_SIZE_MASK   (0xffff << \
    TEGRA186_ASRC_STREAM_STATEBUF_CFG_SIZE_SHIFT)
#define TEGRA186_ASRC_STREAM_INSAMPLEBUF_CFG_SIZE_SHIFT   0
#define TEGRA186_ASRC_STREAM_INSAMPLEBUF_CFG_SIZE_MASK    (0xffff << \
    TEGRA186_ASRC_STREAM_INSAMPLEBUF_CFG_SIZE_SHIFT)
#define TEGRA186_ASRC_STREAM_OUTSAMPLEBUF_CFG_SIZE_SHIFT  0
#define TEGRA186_ASRC_STREAM_OUTSAMPLEBUF_CFG_SIZE_MASK   (0xffff << \
    TEGRA186_ASRC_STREAM_OUTSAMPLEBUF_CFG_SIZE_SHIFT)
