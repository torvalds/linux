...
#define TEGRA20_AC97_CMD_CMD_ADDR_MASK      (0xff << \
    TEGRA20_AC97_CMD_CMD_ADDR_SHIFT)
#define TEGRA20_AC97_CMD_CMD_DATA_SHIFT     8
#define TEGRA20_AC97_CMD_CMD_DATA_MASK      (0xffff << \
...
#define TEGRA20_AC97_STATUS1_STA_ADDR1_MASK   (0xff << \
    TEGRA20_AC97_STATUS1_STA_ADDR1_SHIFT)
#define TEGRA20_AC97_STATUS1_STA_DATA1_SHIFT    8
#define TEGRA20_AC97_STATUS1_STA_DATA1_MASK   (0xffff << \
...
#define TEGRA20_AC97_FIFO_SCR_REC_MT_CNT_MASK   (0x1f << \
    TEGRA20_AC97_FIFO_SCR_REC_MT_CNT_SHIFT)
#define TEGRA20_AC97_FIFO_SCR_PB_MT_CNT_SHIFT   22
#define TEGRA20_AC97_FIFO_SCR_PB_MT_CNT_MASK    (0x1f << \
