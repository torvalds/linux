...
#define TEGRA30_I2S_CTRL_FRAME_FORMAT_MASK    (7 << \
    TEGRA30_I2S_CTRL_FRAME_FORMAT_SHIFT)
#define TEGRA30_I2S_CTRL_FRAME_FORMAT_LRCK    (TEGRA30_I2S_FRAME_FORMAT_LRCK << \
    TEGRA30_I2S_CTRL_FRAME_FORMAT_SHIFT)
#define TEGRA30_I2S_CTRL_FRAME_FORMAT_FSYNC   (TEGRA30_I2S_FRAME_FORMAT_FSYNC << \
    TEGRA30_I2S_CTRL_FRAME_FORMAT_SHIFT)
...
#define TEGRA30_I2S_CTRL_LRCK_L_LOW     (TEGRA30_I2S_LRCK_LEFT_LOW << \
    TEGRA30_I2S_CTRL_LRCK_SHIFT)
#define TEGRA30_I2S_CTRL_LRCK_R_LOW     (TEGRA30_I2S_LRCK_RIGHT_LOW << \
    TEGRA30_I2S_CTRL_LRCK_SHIFT)
...
#define TEGRA30_I2S_CTRL_BIT_CODE_MASK      (3 << \
    TEGRA30_I2S_CTRL_BIT_CODE_SHIFT)
#define TEGRA30_I2S_CTRL_BIT_CODE_LINEAR    (TEGRA30_I2S_BIT_CODE_LINEAR << \
    TEGRA30_I2S_CTRL_BIT_CODE_SHIFT)
#define TEGRA30_I2S_CTRL_BIT_CODE_ULAW      (TEGRA30_I2S_BIT_CODE_ULAW << \
    TEGRA30_I2S_CTRL_BIT_CODE_SHIFT)
#define TEGRA30_I2S_CTRL_BIT_CODE_ALAW      (TEGRA30_I2S_BIT_CODE_ALAW << \
    TEGRA30_I2S_CTRL_BIT_CODE_SHIFT)
...
#define TEGRA30_I2S_CTRL_BIT_SIZE_MASK      (7 << \
    TEGRA30_I2S_CTRL_BIT_SIZE_SHIFT)
#define TEGRA30_I2S_CTRL_BIT_SIZE_8     (TEGRA30_I2S_BITS_8 << \
    TEGRA30_I2S_CTRL_BIT_SIZE_SHIFT)
#define TEGRA30_I2S_CTRL_BIT_SIZE_12      (TEGRA30_I2S_BITS_12 << \
    TEGRA30_I2S_CTRL_BIT_SIZE_SHIFT)
#define TEGRA30_I2S_CTRL_BIT_SIZE_16      (TEGRA30_I2S_BITS_16 << \
    TEGRA30_I2S_CTRL_BIT_SIZE_SHIFT)
#define TEGRA30_I2S_CTRL_BIT_SIZE_20      (TEGRA30_I2S_BITS_20 << \
    TEGRA30_I2S_CTRL_BIT_SIZE_SHIFT)
#define TEGRA30_I2S_CTRL_BIT_SIZE_24      (TEGRA30_I2S_BITS_24 << \
    TEGRA30_I2S_CTRL_BIT_SIZE_SHIFT)
#define TEGRA30_I2S_CTRL_BIT_SIZE_28      (TEGRA30_I2S_BITS_28 << \
    TEGRA30_I2S_CTRL_BIT_SIZE_SHIFT)
#define TEGRA30_I2S_CTRL_BIT_SIZE_32      (TEGRA30_I2S_BITS_32 << \
    TEGRA30_I2S_CTRL_BIT_SIZE_SHIFT)
...
#define TEGRA30_I2S_CH_CTRL_HIGHZ_CTRL_MASK   (3 << \
    TEGRA30_I2S_CH_CTRL_HIGHZ_CTRL_SHIFT)
#define TEGRA30_I2S_CH_CTRL_HIGHZ_CTRL_NO   (TEGRA30_I2S_HIGHZ_NO << \
    TEGRA30_I2S_CH_CTRL_HIGHZ_CTRL_SHIFT)
#define TEGRA30_I2S_CH_CTRL_HIGHZ_CTRL_YES    (TEGRA30_I2S_HIGHZ_YES << \
    TEGRA30_I2S_CH_CTRL_HIGHZ_CTRL_SHIFT)
...
#define TEGRA30_I2S_CH_CTRL_RX_BIT_ORDER_MASK   (1 << \
    TEGRA30_I2S_CH_CTRL_RX_BIT_ORDER_SHIFT)
#define TEGRA30_I2S_CH_CTRL_RX_BIT_ORDER_MSB_FIRST  (TEGRA30_I2S_MSB_FIRST << \
    TEGRA30_I2S_CH_CTRL_RX_BIT_ORDER_SHIFT)
#define TEGRA30_I2S_CH_CTRL_RX_BIT_ORDER_LSB_FIRST  (TEGRA30_I2S_LSB_FIRST << \
    TEGRA30_I2S_CH_CTRL_RX_BIT_ORDER_SHIFT)
#define TEGRA30_I2S_CH_CTRL_TX_BIT_ORDER_SHIFT    9
#define TEGRA30_I2S_CH_CTRL_TX_BIT_ORDER_MASK   (1 << \
    TEGRA30_I2S_CH_CTRL_TX_BIT_ORDER_SHIFT)
#define TEGRA30_I2S_CH_CTRL_TX_BIT_ORDER_MSB_FIRST  (TEGRA30_I2S_MSB_FIRST << \
    TEGRA30_I2S_CH_CTRL_TX_BIT_ORDER_SHIFT)
#define TEGRA30_I2S_CH_CTRL_TX_BIT_ORDER_LSB_FIRST  (TEGRA30_I2S_LSB_FIRST << \
    TEGRA30_I2S_CH_CTRL_TX_BIT_ORDER_SHIFT)
...
#define TEGRA30_I2S_CH_CTRL_EGDE_CTRL_MASK    (1 << \
    TEGRA30_I2S_CH_CTRL_EGDE_CTRL_SHIFT)
#define TEGRA30_I2S_CH_CTRL_EGDE_CTRL_POS_EDGE    (TEGRA30_I2S_POS_EDGE << \
    TEGRA30_I2S_CH_CTRL_EGDE_CTRL_SHIFT)
#define TEGRA30_I2S_CH_CTRL_EGDE_CTRL_NEG_EDGE    (TEGRA30_I2S_NEG_EDGE << \
    TEGRA30_I2S_CH_CTRL_EGDE_CTRL_SHIFT)
...
#define TEGRA30_I2S_SLOT_CTRL_RX_SLOT_ENABLES_MASK  (0xff << \
    TEGRA30_I2S_SLOT_CTRL_RX_SLOT_ENABLES_SHIFT)

#define TEGRA30_I2S_SLOT_CTRL_TX_SLOT_ENABLES_SHIFT 0
#define TEGRA30_I2S_SLOT_CTRL_TX_SLOT_ENABLES_MASK  (0xff << \
...
#define TEGRA30_I2S_FLOWCTL_FILTER_MASK     (1 << \
    TEGRA30_I2S_FLOWCTL_FILTER_SHIFT)
#define TEGRA30_I2S_FLOWCTL_FILTER_LINEAR   (TEGRA30_I2S_FILTER_LINEAR << \
    TEGRA30_I2S_FLOWCTL_FILTER_SHIFT)
#define TEGRA30_I2S_FLOWCTL_FILTER_QUAD     (TEGRA30_I2S_FILTER_QUAD << \
    TEGRA30_I2S_FLOWCTL_FILTER_SHIFT)
...
#define TEGRA30_I2S_TX_STEP_MASK      (TEGRA30_I2S_TX_STEP_MASK_US << \
...
#define TEGRA30_I2S_LCOEF_COEF_MASK     (TEGRA30_I2S_LCOEF_COEF_MASK_US << \
