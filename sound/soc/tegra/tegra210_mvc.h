...
#define TEGRA210_MVC_MUTE_MASK      (TEGRA210_MUTE_MASK_EN << \
    TEGRA210_MVC_MUTE_SHIFT)
#define TEGRA210_MVC_MUTE_EN      (TEGRA210_MUTE_MASK_EN << \
    TEGRA210_MVC_MUTE_SHIFT)
#define TEGRA210_MVC_CH0_MUTE_EN    1

#define TEGRA210_MVC_PER_CHAN_CTRL_EN_SHIFT 30
#define TEGRA210_MVC_PER_CHAN_CTRL_EN_MASK  (1 << \
    TEGRA210_MVC_PER_CHAN_CTRL_EN_SHIFT)
#define TEGRA210_MVC_PER_CHAN_CTRL_EN   (1 << \
    TEGRA210_MVC_PER_CHAN_CTRL_EN_SHIFT)
...
#define TEGRA210_MVC_VOLUME_SWITCH_MASK   (1 << \
    TEGRA210_MVC_VOLUME_SWITCH_SHIFT)
#define TEGRA210_MVC_VOLUME_SWITCH_TRIGGER  (1 << \
    TEGRA210_MVC_VOLUME_SWITCH_SHIFT)
...
#define TEGRA210_MVC_CFG_RAM_CTRL_RW_WRITE    (1 << \
    TEGRA210_MVC_CFG_RAM_CTRL_RW_SHIFT)

#define TEGRA210_MVC_CFG_RAM_CTRL_ADDR_INIT_EN_SHIFT  13
#define TEGRA210_MVC_CFG_RAM_CTRL_ADDR_INIT_EN    (1 << \
    TEGRA210_MVC_CFG_RAM_CTRL_ADDR_INIT_EN_SHIFT)

#define TEGRA210_MVC_CFG_RAM_CTRL_SEQ_ACCESS_EN_SHIFT 12
#define TEGRA210_MVC_CFG_RAM_CTRL_SEQ_ACCESS_EN   (1 << \
    TEGRA210_MVC_CFG_RAM_CTRL_SEQ_ACCESS_EN_SHIFT)

#define TEGRA210_MVC_CFG_RAM_CTRL_ADDR_SHIFT    0
#define TEGRA210_MVC_CFG_RAM_CTRL_ADDR_MASK   (0x1ff << \
    TEGRA210_MVC_CFG_RAM_CTRL_ADDR_SHIFT)
...
#define TEGRA210_GET_MUTE_VAL(val) (((val) >> \
  TEGRA210_MVC_MUTE_SHIFT) & TEGRA210_MUTE_MASK_EN)
