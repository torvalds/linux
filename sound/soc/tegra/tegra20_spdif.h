...
#define TEGRA20_SPDIF_CTRL_BIT_MODE_MASK      (3 << \
    TEGRA20_SPDIF_CTRL_BIT_MODE_SHIFT)
#define TEGRA20_SPDIF_CTRL_BIT_MODE_16BIT     (TEGRA20_SPDIF_BIT_MODE_16BIT << \
    TEGRA20_SPDIF_CTRL_BIT_MODE_SHIFT)
#define TEGRA20_SPDIF_CTRL_BIT_MODE_20BIT     (TEGRA20_SPDIF_BIT_MODE_20BIT << \
    TEGRA20_SPDIF_CTRL_BIT_MODE_SHIFT)
#define TEGRA20_SPDIF_CTRL_BIT_MODE_24BIT     (TEGRA20_SPDIF_BIT_MODE_24BIT << \
    TEGRA20_SPDIF_CTRL_BIT_MODE_SHIFT)
#define TEGRA20_SPDIF_CTRL_BIT_MODE_RAW       (TEGRA20_SPDIF_BIT_MODE_RAW << \
    TEGRA20_SPDIF_CTRL_BIT_MODE_SHIFT)
...
#define TEGRA20_SPDIF_STROBE_CTRL_PERIOD_MASK     (0xff << \
...
#define TEGRA20_SPDIF_STROBE_CTRL_DATA_STROBES_MASK   (0x1f << \
...
#define TEGRA20_SPDIF_STROBE_CTRL_CLOCK_PERIOD_MASK   (0x3f << \
...
#define TEGRA20_SPDIF_DATA_FIFO_CSR_RU_FULL_COUNT_MASK    (0x1f << \
...
#define TEGRA20_SPDIF_DATA_FIFO_CSR_TU_EMPTY_COUNT_MASK   (0x1f << \
    SPDIF_DATA_FIFO_CSR_TU_EMPTY_COUNT_SHIFT)
...
#define TEGRA20_SPDIF_DATA_FIFO_CSR_RX_FULL_COUNT_MASK    (0x1f << \
...
#define TEGRA20_SPDIF_DATA_FIFO_CSR_TX_EMPTY_COUNT_MASK   (0x1f << \
    SPDIF_DATA_FIFO_CSR_TX_EMPTY_COUNT_SHIFT)
