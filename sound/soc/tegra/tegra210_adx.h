...
#define TEGRA210_ADX_CFG_RAM_CTRL_RW_WRITE    (1 << \
    TEGRA210_ADX_CFG_RAM_CTRL_RW_SHIFT)

#define TEGRA210_ADX_CFG_RAM_CTRL_ADDR_INIT_EN_SHIFT  13
#define TEGRA210_ADX_CFG_RAM_CTRL_ADDR_INIT_EN    (1 << \
    TEGRA210_ADX_CFG_RAM_CTRL_ADDR_INIT_EN_SHIFT)

#define TEGRA210_ADX_CFG_RAM_CTRL_SEQ_ACCESS_EN_SHIFT 12
#define TEGRA210_ADX_CFG_RAM_CTRL_SEQ_ACCESS_EN   (1 << \
...
#define TEGRA210_ADX_SOFT_RESET_SOFT_RESET_MASK   (1 << \
    TEGRA210_ADX_SOFT_RESET_SOFT_RESET_SHIFT)
#define TEGRA210_ADX_SOFT_RESET_SOFT_EN     (1 << \
    TEGRA210_ADX_SOFT_RESET_SOFT_RESET_SHIFT)
#define TEGRA210_ADX_SOFT_RESET_SOFT_DEFAULT    (0 << \
    TEGRA210_ADX_SOFT_RESET_SOFT_RESET_SHIFT)
