...
#define TEGRA210_AMX_CTRL_MSTR_RX_NUM_MASK    (3 << \
    TEGRA210_AMX_CTRL_MSTR_RX_NUM_SHIFT)
...
#define TEGRA210_AMX_CFG_RAM_CTRL_RW_WRITE    (1 << \
    TEGRA210_AMX_CFG_RAM_CTRL_RW_SHIFT)

#define TEGRA210_AMX_CFG_RAM_CTRL_ADDR_INIT_EN_SHIFT  13
#define TEGRA210_AMX_CFG_RAM_CTRL_ADDR_INIT_EN    (1 << \
    TEGRA210_AMX_CFG_RAM_CTRL_ADDR_INIT_EN_SHIFT)

#define TEGRA210_AMX_CFG_RAM_CTRL_SEQ_ACCESS_EN_SHIFT 12
#define TEGRA210_AMX_CFG_RAM_CTRL_SEQ_ACCESS_EN   (1 << \
    TEGRA210_AMX_CFG_RAM_CTRL_SEQ_ACCESS_EN_SHIFT)
