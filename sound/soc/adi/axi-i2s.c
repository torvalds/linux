...
/* The frame size is configurable, but for yesw we always set it 64 bit */
...
static void axi_i2s_parse_of(struct axi_i2s *i2s, const struct device_yesde *np)
{
...
static int axi_i2s_probe(struct platform_device *pdev)
{
	...
	axi_i2s_parse_of(i2s, pdev->dev.of_yesde);
