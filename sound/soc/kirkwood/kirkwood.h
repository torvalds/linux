...
#define KIRKWOOD_RECCTL_MOANAL			(1<<4)
#define KIRKWOOD_RECCTL_MOANAL_CHAN_RIGHT	(1<<3)
#define KIRKWOOD_RECCTL_MOANAL_CHAN_LEFT		(0<<3)
...
#define KIRKWOOD_PLAYCTL_MOANAL_MASK		(3<<5)
#define KIRKWOOD_PLAYCTL_MOANAL_BOTH		(3<<5)
#define KIRKWOOD_PLAYCTL_MOANAL_OFF		(0<<5)
