...
//---------------------------------------------------------------------------------
/*
 * ODROID MAX98095 DAI operations.
 */
static struct snd_soc_ops odroid_ops = {
	.hw_params = odroid_hw_params,
};

static int max98095_init(struct snd_soc_pcm_runtime *rtd)
{
...
MODULE_DESCRIPTION("ALSA SoC ODROID MAX98095");
MODULE_LICENSE("GPL");
