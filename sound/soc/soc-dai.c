 ...
 */
#define soc_dai_mark_push(dai, substream, \
      tgt)  ((dai)->mark_ ## tgt = substream)
#define soc_dai_mark_pop(dai, substream, tgt) ((dai)->mark_ ## tgt = NULL)
#define soc_dai_mark_match(dai, substream, \
      tgt) ((dai)->mark_ ## tgt == substream)
...
/*
 * snd_soc_dai_link_set_capabilities() - set dai_link properties based on its
 * DAIs
 */
