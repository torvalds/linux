/*
 * rk_rk3028.c  --  SoC audio for rockchip
 *
 * Driver for rockchip rk3028 audio
 *
...
static int rk3028_init(struct snd_soc_pcm_runtime *rtd)
{
	...
	struct snd_pcm_hw_params *params)
{
	...
	#if defined(CONFIG_RK3028_USE_MCLK_12M)
...
static struct snd_soc_ops rk3028_hifi_ops = {
	.hw_params = rk_hifi_hw_params,
};

static struct snd_soc_ops rk3028_voice_ops = {
...
static struct snd_soc_dai_link rk_dai[] = {
	{
		.name = "RK3028 I2S1",
		.stream_name = "RK3028 PCM",
		.codec_name = "rk3028-codec",
	...
	},
	{
		...
		.cpu_dai_name = "rk29_i2s.1",
#endif
		.codec_dai_name = "rk3028-voice",
		.ops = &rk3028_voice_ops,
	},
};
