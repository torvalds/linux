...
#ifndef _SUN5I_CODEC_H
#define _SUN5I_CODEC_H

//Codec Register
#define CODEC_BASSADDRESS         (0x01c22c00)
#define SUN5I_DAC_DPC                (0x00)
#define SUN5I_DAC_FIFOC              (0x04)
#define SUN5I_DAC_FIFOS              (0x08)
#define SUN5I_DAC_TXDATA             (0x0c)
#define SUN5I_DAC_ACTL               (0x10)
#define SUN5I_DAC_TUNE               (0x14)
#define SUN5I_DAC_DEBUG              (0x18)
#define SUN5I_ADC_FIFOC              (0x1c)
#define SUN5I_ADC_FIFOS              (0x20)
#define SUN5I_ADC_RXDATA             (0x24)
#define SUN5I_ADC_ACTL               (0x28)
