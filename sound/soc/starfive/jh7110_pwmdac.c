...
static inline void jh7110_pwmdac_write_reg(void __iomem *io_base, int reg,
    u32 val) {
...
static void jh7110_pwmdac_set_enable(struct jh7110_pwmdac_dev *dev,
    bool enable) {
  u32 value;
...
static int jh7110_pwmdac_crg_enable(struct jh7110_pwmdac_dev *dev,
    bool enable) {
  int ret;
  if (enable) {
