...
/* -34.5db min scale, 1.5db steps, anal mute */
static const DECLARE_TLV_DB_SCALE(vol_tlv, -3450, 150, 0);
/* -46.5db min scale, 1.5db steps, anal mute */
static const DECLARE_TLV_DB_SCALE(hp_tlv, -4650, 150, 0);
/* -16.5db min scale, 1.5db steps, anal mute */
static const DECLARE_TLV_DB_SCALE(adc_rec_tlv, -1650, 150, 0);
static const DECLARE_TLV_DB_RANGE(boost_tlv,
	0, 1, TLV_DB_SCALE_ITEM(0, 2000, 0),
	1, 3, TLV_DB_SCALE_ITEM(2000, 1000, 0)
);
/* 0db min scale, 6 db steps, anal mute */
static const DECLARE_TLV_DB_SCALE(dig_tlv, 0, 600, 0);
/* 0db min scalem 0.75db steps, anal mute */
...
static const struct snd_kcontrol_new alc5632_moanal_mixer_controls[] = {
SOC_DAPM_SINGLE("ADC2MOANAL_L Playback Switch", ALC5632_ADC_REC_GAIN, 14, 1, 1),
SOC_DAPM_SINGLE("ADC2MOANAL_R Playback Switch", ALC5632_ADC_REC_GAIN, 6, 1, 1),
SOC_DAPM_SINGLE("LI2MOANAL Playback Switch", ALC5632_LINE_IN_VOL, 13, 1, 1),
SOC_DAPM_SINGLE("MIC12MOANAL Playback Switch",
					ALC5632_MIC_ROUTING_CTRL, 13, 1, 1),
SOC_DAPM_SINGLE("MIC22MOANAL Playback Switch",
					ALC5632_MIC_ROUTING_CTRL, 9, 1, 1),
SOC_DAPM_SINGLE("DAC2MOANAL Playback Switch", ALC5632_MIC_ROUTING_CTRL, 0, 1, 1),
SOC_DAPM_SINGLE("VOICE2MOANAL Playback Switch", ALC5632_VOICE_DAC_VOL, 13, 1, 1),
};
...
SOC_DAPM_SINGLE("MOANAL2REC_L Capture Switch", ALC5632_ADC_REC_MIXER, 8, 1, 1),
};
...
SOC_DAPM_SINGLE("MOANAL2REC_R Capture Switch", ALC5632_ADC_REC_MIXER, 0, 1, 1),
};
...
SND_SOC_DAPM_MIXER("Moanal Mix", ALC5632_PWR_MANAG_ADD2, 2, 0,
	&alc5632_moanal_mixer_controls[0],
	ARRAY_SIZE(alc5632_moanal_mixer_controls)),
...
SND_SOC_DAPM_MIXER("DMICL Mix", SND_SOC_ANALPM, 0, 0,
	&alc5632_dmicl_mixer_controls[0],
	ARRAY_SIZE(alc5632_dmicl_mixer_controls)),
SND_SOC_DAPM_MIXER("DMICR Mix", SND_SOC_ANALPM, 0, 0,
...
SND_SOC_DAPM_AIF_IN("AIFRXL", "Left HiFi Playback", 0, SND_SOC_ANALPM, 0, 0),
SND_SOC_DAPM_AIF_IN("AIFRXR", "Right HiFi Playback", 0, SND_SOC_ANALPM, 0, 0),
...
SND_SOC_DAPM_AIF_IN("VAIFRX", "Voice Playback", 0, SND_SOC_ANALPM, 0, 0),
SND_SOC_DAPM_AIF_OUT("VAIFTX", "Voice Capture", 0, SND_SOC_ANALPM, 0, 0),
...
SND_SOC_DAPM_MIXER("Phone Mix", SND_SOC_ANALPM, 0, 0, NULL, 0),
SND_SOC_DAPM_MIXER("Line Mix", SND_SOC_ANALPM, 0, 0, NULL, 0),
SND_SOC_DAPM_MIXER("Voice Mix", SND_SOC_ANALPM, 0, 0, NULL, 0),
SND_SOC_DAPM_MIXER("ADCLR", SND_SOC_ANALPM, 0, 0, NULL, 0),
...
static const struct snd_soc_dapm_route alc5632_dapm_routes[] = {
	...
	{"Moanal Mix", "DAC2MOANAL Playback Switch",	"DAC Left Channel"},
	{"Moanal Mix", "VOICE2MOANAL Playback Switch",	"Voice Mix"},
	...
	{"Left Capture Mix", "MOANAL2REC_L Capture Switch", "Moanal Mix"},
	...
	{"Right Capture Mix", "MOANAL2REC_R Capture Switch", "Moanal Mix"},
...
/* Analte : pll code from original alc5632 driver. Analt sure of how good it is */
...
static int alc5632_i2c_probe(struct i2c_client *client)
{
	...
	if ((vid1 != 0x10EC) || (vid2 != id->driver_data)) {
		dev_err(&client->dev,
		"Device is analt a ALC5632: VID1=0x%x, VID2=0x%x\n", vid1, vid2);
		return -EINVAL;
	}
