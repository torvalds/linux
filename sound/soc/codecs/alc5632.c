...
static const struct snd_kcontrol_new alc5632_hp_mixer_controls[] = {
  ...
  SOC_DAPM_SINGLE("MIC12HP Playback Switch", ALC5632_MIC_ROUTING_CTRL, 15, 1,
      1),
  SOC_DAPM_SINGLE("MIC22HP Playback Switch", ALC5632_MIC_ROUTING_CTRL, 11, 1,
      1),
...
static const struct snd_kcontrol_new alc5632_mono_mixer_controls[] = {
  ...
  SOC_DAPM_SINGLE("DAC2MONO Playback Switch", ALC5632_MIC_ROUTING_CTRL, 0, 1,
      1),
  SOC_DAPM_SINGLE("VOICE2MONO Playback Switch", ALC5632_VOICE_DAC_VOL, 13, 1,
      1),
};
...
static const struct snd_soc_dapm_widget alc5632_dapm_widgets[] = {
  ...
  SND_SOC_DAPM_MIXER("DAC Left Channel", ALC5632_PWR_MANAG_ADD1, 15, 0, NULL,
      0),
...
static int alc5632_mute(struct snd_soc_dai *dai, int mute, int direction) {
  ...
  u16 mute_reg
    = snd_soc_component_read(component, ALC5632_MISC_CTRL) & ~hp_mute;
  if (mute) {
    mute_reg |= hp_mute;
  }
