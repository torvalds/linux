...
static void wm8994_set_retune_mobile(struct snd_soc_component *component,
    int block) {
  struct wm8994_priv *wm8994 = snd_soc_component_get_drvdata(component);
  struct wm8994 *control = wm8994->wm8994;
  struct wm8994_pdata *pdata = &control->pdata;
...
static void wm1811_jackdet_set_mode(struct snd_soc_component *component,
    u16 mode) {
  struct wm8994_priv *wm8994 = snd_soc_component_get_drvdata(component);
...
static int aif_mclk_set(struct snd_soc_component *component, int aif,
    bool enable) {
  struct wm8994_priv *wm8994 = snd_soc_component_get_drvdata(component);
...
static const struct snd_kcontrol_new dac1r_mix[] = {
  WM8994_CLASS_W_SWITCH("Right Sidetone Switch",
...
static const struct snd_soc_dapm_widget wm8994_lateclk_revd_widgets[] = {
  ...
  SND_SOC_DAPM_MUX_E("Left Headphone Mux", SND_SOC_NOPM, 0, 0, &wm_hubs_hpl_mux,
      late_enable_ev, SND_SOC_DAPM_PRE_PMU),
  SND_SOC_DAPM_MUX_E("Right Headphone Mux", SND_SOC_NOPM, 0, 0,
      &wm_hubs_hpr_mux,
      late_enable_ev, SND_SOC_DAPM_PRE_PMU),
...
static int wm8994_hw_params(struct snd_pcm_substream *substream,
  ...
  snd_soc_component_update_bits(component, bclk_reg, WM8994_AIF1_BCLK_DIV_MASK,
      bclk);
...
static int wm8994_aif3_hw_params(struct snd_pcm_substream *substream,
  ...
  return snd_soc_component_update_bits(component, aif1_reg, WM8994_AIF1_WL_MASK,
      aif1);
}
...
int wm8994_mic_detect(struct snd_soc_component *component,
  ...
  snd_soc_component_update_bits(component, WM8994_MICBIAS, WM8994_MICD_ENA,
      reg);
...
static void wm1811_micd_stop(struct snd_soc_component *component) {
  ...
  snd_soc_component_update_bits(component, WM8958_MIC_DETECT_1, WM8958_MICD_ENA,
      0);
...
static irqreturn_t wm8958_mic_irq(int irq, void *data) {
  ...
  if (!(snd_soc_component_read(component,
      WM8958_MIC_DETECT_1) & WM8958_MICD_ENA)) {
    return IRQ_HANDLED;
  }
  cancel_delayed_work_sync(&wm8994->mic_complete_work);
