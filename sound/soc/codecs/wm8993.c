...
static int _wm8993_set_fll(struct snd_soc_component *component, int fll_id,
    int source,
  ...
  /* Enable the FLL */
  snd_soc_component_write(component, WM8993_FLL_CONTROL_1,
      reg1 | WM8993_FLL_ENA);
...
static int wm8993_set_dai_fmt(struct snd_soc_dai *dai,
  ...
  struct wm8993_priv *wm8993 = snd_soc_component_get_drvdata(component);
  unsigned int aif1
    = snd_soc_component_read(component, WM8993_AUDIO_INTERFACE_1);
  unsigned int aif4
    = snd_soc_component_read(component, WM8993_AUDIO_INTERFACE_4);
...
static int wm8993_probe(struct snd_soc_component *component) {
  ...
  snd_soc_component_update_bits(component, WM8993_CLOCKING_4, WM8993_SR_MODE,
      0);
