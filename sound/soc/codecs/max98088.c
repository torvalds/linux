 ...
 */
static void m98088_eq_band(struct snd_soc_component *component,
    unsigned int dai,
...
static int max98088_mic1pre_set(struct snd_kcontrol *kcontrol,
  ...
  snd_soc_component_update_bits(component, M98088_REG_35_LVL_MIC1,
      M98088_MICPRE_MASK,
...
static int max98088_mic2pre_set(struct snd_kcontrol *kcontrol,
  ...
  snd_soc_component_update_bits(component, M98088_REG_36_LVL_MIC2,
      M98088_MICPRE_MASK,
      (1 + sel) << M98088_MICPRE_SHIFT);
  return 0;
}
...
static int max98088_dai_set_sysclk(struct snd_soc_dai *dai,
  ...
  if (snd_soc_component_read(component,
      M98088_REG_51_PWR_SYS) & M98088_SHDNRUN) {
    snd_soc_component_update_bits(component, M98088_REG_51_PWR_SYS,
        M98088_SHDNRUN, 0);
    snd_soc_component_update_bits(component, M98088_REG_51_PWR_SYS,
...
static int max98088_get_channel(struct snd_soc_component *component,
    const char *name) {
  int ret;
...
static void max98088_setup_eq1(struct snd_soc_component *component) {
  ...
  snd_soc_component_update_bits(component, M98088_REG_49_CFG_LEVEL,
      M98088_EQ1EN, 0);
...
static void max98088_handle_eq_pdata(struct snd_soc_component *component) {
  ...
  ret
    = snd_soc_add_component_controls(component, controls,
      ARRAY_SIZE(controls));
  if (ret != 0) {
