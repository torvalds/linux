...
static struct wcd_mbhc_field wcd_mbhc_fields[WCD_MBHC_REG_FUNC_MAX] = {
  ...
  WCD_MBHC_FIELD(WCD_MBHC_MIC_CLAMP_CTL, WCD934X_MBHC_NEW_PLUG_DETECT_CTL,
      0x30),
  WCD_MBHC_FIELD(WCD_MBHC_ELECT_DETECTION_TYPE, WCD934X_ANA_MBHC_ELECT, 0x08),
  WCD_MBHC_FIELD(WCD_MBHC_HS_L_DET_PULL_UP_CTRL,
      WCD934X_MBHC_NEW_PLUG_DETECT_CTL, 0xC0),
  WCD_MBHC_FIELD(WCD_MBHC_HS_L_DET_PULL_UP_COMP_CTRL, WCD934X_ANA_MBHC_MECH,
      0x04),
...
static bool wcd934x_mbhc_micb_en_status(struct snd_soc_component *component,
    int micb_num) {
  u8 val;
...
static void wcd934x_mbhc_hph_l_pull_up_control(
    struct snd_soc_component *component,
...
static int wcd934x_mbhc_micb_ctrl_threshold_mic(
    struct snd_soc_component *component,
...
static int wcd934x_mbhc_init(struct snd_soc_component *component) {
  ...
  wcd->mbhc
    = wcd_mbhc_init(component, &mbhc_cb, intr_ids, wcd_mbhc_fields, true);
  if (IS_ERR(wcd->mbhc)) {
    wcd->mbhc = NULL;
    return -EINVAL;
  }
