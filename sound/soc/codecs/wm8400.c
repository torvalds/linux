...
static const struct snd_soc_dapm_widget wm8400_dapm_widgets[] = {
  ...
  /* AINLMUX */
  SND_SOC_DAPM_MUX("AILNMUX", SND_SOC_NOPM, 0, 0,
  ...
  /* AINRMUX */
  SND_SOC_DAPM_MUX("AIRNMUX", SND_SOC_NOPM, 0, 0,
  ...
  /* OUT3MIX */
  SND_SOC_DAPM_MIXER("OUT3MIX", WM8400_POWER_MANAGEMENT_1,
      WM8400_OUT3_ENA_SHIFT,
      0, &wm8400_dapm_out3mix_controls[0],
      ARRAY_SIZE(wm8400_dapm_out3mix_controls)),

  /* SPKMIX */
  SND_SOC_DAPM_MIXER_E("SPKMIX", WM8400_POWER_MANAGEMENT_1,
  ...
  /* OUT4MIX */
  SND_SOC_DAPM_MIXER("OUT4MIX", WM8400_POWER_MANAGEMENT_1,
  ...
  /* LOPGA */
  SND_SOC_DAPM_PGA("LOPGA", WM8400_POWER_MANAGEMENT_3, WM8400_LOPGA_ENA_SHIFT,
      0,
      NULL, 0),

  /* ROPGA */
  SND_SOC_DAPM_PGA("ROPGA", WM8400_POWER_MANAGEMENT_3, WM8400_ROPGA_ENA_SHIFT,
      0,
      NULL, 0),
...
static int wm8400_mute(struct snd_soc_dai *dai, int mute, int direction) {
  struct snd_soc_component *component = dai->component;
  u16 val
    = snd_soc_component_read(component, WM8400_DAC_CTRL) & ~WM8400_DAC_MUTE;
  if (mute) {
...
static int wm8400_set_bias_level(struct snd_soc_component *component,
  ...
  switch (level) {
    ...
    case SND_SOC_BIAS_OFF:
      ...
      snd_soc_component_write(component, WM8400_DAC_CTRL,
          val | WM8400_DAC_MUTE);
...
static int wm8400_component_probe(struct snd_soc_component *component) {
  ...
  snd_soc_component_write(component, WM8400_RIGHT_LINE_INPUT_1_2_VOLUME,
      reg & WM8400_IPVU);
  snd_soc_component_write(component, WM8400_LEFT_OUTPUT_VOLUME,
      0x50 | (1 << 8));
  snd_soc_component_write(component, WM8400_RIGHT_OUTPUT_VOLUME,
      0x50 | (1 << 8));
  return 0;
}
