...
#define CS42L43_DAPM_MUX(name_str, name) \
  SND_SOC_DAPM_MUX(name_str " Input", SND_SOC_NOPM, 0, 0, \
    &cs42l43_ ## name ## _mux)

#define CS42L43_DAPM_MIXER(name_str, name) \
  SND_SOC_DAPM_MUX(name_str " Input 1", SND_SOC_NOPM, 0, 0, \
    &cs42l43_ ## name ## _in1_mux), \
  SND_SOC_DAPM_MUX(name_str " Input 2", SND_SOC_NOPM, 0, 0, \
    &cs42l43_ ## name ## _in2_mux), \
  SND_SOC_DAPM_MUX(name_str " Input 3", SND_SOC_NOPM, 0, 0, \
    &cs42l43_ ## name ## _in3_mux), \
  SND_SOC_DAPM_MUX(name_str " Input 4", SND_SOC_NOPM, 0, 0, \
    &cs42l43_ ## name ## _in4_mux), \
...
static void cs42l43_hp_ilimit_work(struct work_struct *work) {
  ...
  dev_err(priv->dev,
      "Disabling headphone for %dmS, due to frequent current limit\n",
...
static int cs42l43_startup(struct snd_pcm_substream *substream,
...
static int cs42l43_set_sample_rate(struct snd_pcm_substream *substream,
  ...
  //FIXME: For now lets just set sample rate 1, this needs expanded in the
  // future
...
static SOC_ENUM_SINGLE_DECL(cs42l43_dec1_wnf_corner,
    CS42L43_DECIM_HPF_WNF_CTRL1,
    CS42L43_DECIM_WNF_CF_SHIFT, cs42l43_wnf_corner_text);
static SOC_ENUM_SINGLE_DECL(cs42l43_dec2_wnf_corner,
    CS42L43_DECIM_HPF_WNF_CTRL2,
    CS42L43_DECIM_WNF_CF_SHIFT, cs42l43_wnf_corner_text);
static SOC_ENUM_SINGLE_DECL(cs42l43_dec3_wnf_corner,
    CS42L43_DECIM_HPF_WNF_CTRL3,
    CS42L43_DECIM_WNF_CF_SHIFT, cs42l43_wnf_corner_text);
static SOC_ENUM_SINGLE_DECL(cs42l43_dec4_wnf_corner,
...
static SOC_ENUM_SINGLE_DECL(cs42l43_dec1_hpf_corner,
    CS42L43_DECIM_HPF_WNF_CTRL1,
    CS42L43_DECIM_HPF_CF_SHIFT, cs42l43_hpf_corner_text);
static SOC_ENUM_SINGLE_DECL(cs42l43_dec2_hpf_corner,
    CS42L43_DECIM_HPF_WNF_CTRL2,
    CS42L43_DECIM_HPF_CF_SHIFT, cs42l43_hpf_corner_text);
static SOC_ENUM_SINGLE_DECL(cs42l43_dec3_hpf_corner,
    CS42L43_DECIM_HPF_WNF_CTRL3,
    CS42L43_DECIM_HPF_CF_SHIFT, cs42l43_hpf_corner_text);
static SOC_ENUM_SINGLE_DECL(cs42l43_dec4_hpf_corner,
    CS42L43_DECIM_HPF_WNF_CTRL4,
    CS42L43_DECIM_HPF_CF_SHIFT, cs42l43_hpf_corner_text);

static SOC_ENUM_SINGLE_DECL(cs42l43_dec1_ramp_up,
    CS42L43_DECIM_VOL_CTRL_CH1_CH2,
    CS42L43_DECIM1_VI_RAMP_SHIFT, cs42l43_ramp_text);
static SOC_ENUM_SINGLE_DECL(cs42l43_dec1_ramp_down,
    CS42L43_DECIM_VOL_CTRL_CH1_CH2,
    CS42L43_DECIM1_VD_RAMP_SHIFT, cs42l43_ramp_text);
static SOC_ENUM_SINGLE_DECL(cs42l43_dec2_ramp_up,
    CS42L43_DECIM_VOL_CTRL_CH1_CH2,
    CS42L43_DECIM2_VI_RAMP_SHIFT, cs42l43_ramp_text);
static SOC_ENUM_SINGLE_DECL(cs42l43_dec2_ramp_down,
    CS42L43_DECIM_VOL_CTRL_CH1_CH2,
    CS42L43_DECIM2_VD_RAMP_SHIFT, cs42l43_ramp_text);
static SOC_ENUM_SINGLE_DECL(cs42l43_dec3_ramp_up,
    CS42L43_DECIM_VOL_CTRL_CH3_CH4,
    CS42L43_DECIM3_VI_RAMP_SHIFT, cs42l43_ramp_text);
static SOC_ENUM_SINGLE_DECL(cs42l43_dec3_ramp_down,
    CS42L43_DECIM_VOL_CTRL_CH3_CH4,
    CS42L43_DECIM3_VD_RAMP_SHIFT, cs42l43_ramp_text);
static SOC_ENUM_SINGLE_DECL(cs42l43_dec4_ramp_up,
    CS42L43_DECIM_VOL_CTRL_CH3_CH4,
    CS42L43_DECIM4_VI_RAMP_SHIFT, cs42l43_ramp_text);
static SOC_ENUM_SINGLE_DECL(cs42l43_dec4_ramp_down,
    CS42L43_DECIM_VOL_CTRL_CH3_CH4,
...
static int cs42l43_eq_get(struct snd_kcontrol *kcontrol,
  ...
  struct snd_soc_component *component = snd_soc_kcontrol_component(kcontrol);
  struct cs42l43_codec *priv = snd_soc_component_get_drvdata(component);
  memcpy(ucontrol->value.integer.value, priv->eq_coeffs,
      sizeof(priv->eq_coeffs));
  return 0;
}
...
static int cs42l43_eq_put(struct snd_kcontrol *kcontrol,
  ...
  struct cs42l43_codec *priv = snd_soc_component_get_drvdata(component);
  snd_soc_dapm_mutex_lock(dapm);
  memcpy(priv->eq_coeffs, ucontrol->value.integer.value,
      sizeof(priv->eq_coeffs));
  snd_soc_dapm_mutex_unlock(dapm);
  return 0;
}
...
static int cs42l43_set_pll(struct cs42l43_codec *priv, unsigned int src,
  ...
  if (regmap_test_bits(cs42l43->regmap, CS42L43_CTRL_REG,
      CS42L43_PLL_EN_MASK)) {
...
static int cs42l43_dapm_wait_completion(struct completion *pmu,
    struct completion *pmd,
  ...
  switch (event) {
    ...
    case SND_SOC_DAPM_POST_PMU:
      time_left
        = wait_for_completion_timeout(pmu, msecs_to_jiffies(timeout_ms));
      break;
    case SND_SOC_DAPM_POST_PMD:
      time_left
        = wait_for_completion_timeout(pmd, msecs_to_jiffies(timeout_ms));
      break;
    default:
      return 0;
  }
...
static const struct snd_soc_dapm_widget cs42l43_widgets[] = {
  ...
  SND_SOC_DAPM_SUPPLY_S("FSYNC", 0, CS42L43_ASP_CTRL,
      CS42L43_ASP_FSYNC_EN_SHIFT,
      0, NULL, 0),
  ...
  SND_SOC_DAPM_PGA_E("AMP1", CS42L43_BLOCK_EN10, CS42L43_AMP1_EN_SHIFT, 0, NULL,
      0,
      cs42l43_spkl_ev, SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU
      | SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD),
  SND_SOC_DAPM_PGA_E("AMP2", CS42L43_BLOCK_EN10, CS42L43_AMP2_EN_SHIFT, 0, NULL,
      0,
  ...
  SND_SOC_DAPM_SUPPLY("Tone Generator", CS42L43_BLOCK_EN9,
      CS42L43_TONE_EN_SHIFT,
      0, NULL, 0),
...
static const struct cs42l43_irq cs42l43_irqs[] = {
  ...
  { CS42L43_AMP2_THERM_SHDN, "spkr thermal shutdown",
    cs42l43_spkr_therm_shutdown },
  { CS42L43_AMP1_THERM_SHDN, "spkl thermal shutdown",
    cs42l43_spkl_therm_shutdown },
...
static const struct dev_pm_ops cs42l43_codec_pm_ops = {
  ...
  NOIRQ_SYSTEM_SLEEP_PM_OPS(cs42l43_codec_suspend_noirq,
      cs42l43_codec_resume_noirq)
