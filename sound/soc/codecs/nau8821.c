...
static const struct snd_kcontrol_new nau8821_controls[] = {
  ...
  SOC_ENUM("ADC DRC Peak Detection Attack Time",
      nau8821_detection_attack_time_enum),
  SOC_ENUM("ADC DRC Peak Detection Release Time",
      nau8821_detection_release_time_enum),
...
static const struct nau8821_osr_attr *nau8821_get_osr(struct nau8821 *nau8821,
    int stream) {
  unsigned int osr;
...
static int nau8821_set_dai_fmt(struct snd_soc_dai *codec_dai,
    unsigned int fmt) {
