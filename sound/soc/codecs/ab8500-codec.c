...
static int ab8500_audio_setup_mics(struct snd_soc_component *component,
  ...
  snd_soc_component_update_bits(component, AB8500_ANAGAIN1,
  ...
  snd_soc_component_update_bits(component, AB8500_ANAGAIN2,
      AB8500_ANAGAINX_ENSEMICX,
...
static int ab8500_audio_set_ear_cmv(struct snd_soc_component *component,
  ...
  dev_dbg(component->dev, "%s: Earpiece CM-voltage: %s\n", __func__,
      cmv_str);
  snd_soc_component_update_bits(component, AB8500_ANACONF1,
