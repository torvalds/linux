...
static int sgtl5000_mute_stream(struct snd_soc_dai *codec_dai, int mute,
    int direction) {
 ...
 */
static int sgtl5000_set_clock(struct snd_soc_component *component,
    int frame_rate) {
  struct sgtl5000_priv *sgtl5000 = snd_soc_component_get_drvdata(component);
  int clk_ctl = 0;
...
static int sgtl5000_probe(struct snd_soc_component *component) {
   ...
   */
  snd_soc_component_write(component, SGTL5000_DAP_AUDIO_EQ,
