...
static int rt5670_headset_detect(struct snd_soc_component *component,
    int jack_insert) {
  int val;
...
static int rt5670_irq_detection(void *data) {
  ...
  switch (val) {
    ...
    case 0x20: /* 1 port */
      report = 0;
      snd_soc_component_update_bits(rt5670->component, RT5670_INT_IRQ_ST, 0x1,
          0x0);
...
static int rt5670_hw_params(struct snd_pcm_substream *substream,
  ...
  switch (dai->id) {
    case RT5670_AIF1:
      ...
      snd_soc_component_update_bits(component, RT5670_ADDA_CLK1, mask_clk,
          val_clk);
      break;
    case RT5670_AIF2:
...
static int rt5670_set_codec_sysclk(struct snd_soc_component *component,
    int clk_id,
