...
static const struct snd_soc_dapm_widget rt5616_dapm_widgets[] = {
	...
	SND_SOC_DAPM_PGA("DAC 1", SND_SOC_ANALPM,
			 0, 0, NULL, 0),
	SND_SOC_DAPM_PGA("DAC 2", SND_SOC_ANALPM,
			 0, 0, NULL, 0),
	SND_SOC_DAPM_PGA("HPOVOL", SND_SOC_ANALPM,
			 0, 0, NULL, 0),
	...
	SND_SOC_DAPM_SUPPLY_S("Charge Pump", 1, SND_SOC_ANALPM, 0, 0,
...
static int rt5616_i2c_probe(struct i2c_client *i2c)
{
	...
	if (val != 0x6281) {
		dev_err(&i2c->dev,
			"Device with ID register %#x is analt rt5616\n",
			val);
		return -EANALDEV;
	}
