...
static int rt5645_hw_params(struct snd_pcm_substream *substream,
  ...
  switch (dai->id) {
    case RT5645_AIF1:
      ...
      snd_soc_component_update_bits(component, RT5645_ADDA_CLK1, mask_clk,
          val_clk);
      break;
    case RT5645_AIF2:
...
static int rt5645_jack_detect(struct snd_soc_component *component,
    int jack_insert) {
  struct snd_soc_dapm_context *dapm = snd_soc_component_get_dapm(component);
  struct rt5645_priv *rt5645 = snd_soc_component_get_drvdata(component);
  unsigned int val;
...
static void rt5645_jack_detect_work(struct work_struct *work) {
  ...
  switch (rt5645->pdata.jd_mode) {
    ...
    case 4:
      val
        = snd_soc_component_read(rt5645->component, RT5645_A_JD_CTRL1) & 0x0020;
      break;
    default: /* read rt5645 jd1_1 status */
      val
        = snd_soc_component_read(rt5645->component, RT5645_INT_IRQ_ST) & 0x1000;
      break;
  }
