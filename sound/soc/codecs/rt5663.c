...
static int rt5663_v2_jack_detect(struct snd_soc_component *component,
    int jack_insert) {
 ...
 * Returns detect status.
 */
static int rt5663_jack_detect(struct snd_soc_component *component,
    int jack_insert) {
  struct rt5663_priv *rt5663 = snd_soc_component_get_drvdata(component);
  int val, i = 0;
  dev_dbg(component->dev, "%s jack_insert:%d\n", __func__, jack_insert);
...
static int rt5663_impedance_sensing(struct snd_soc_component *component) {
  ...
  snd_soc_component_update_bits(component, RT5663_STO_DRE_9,
      RT5663_DRE_GAIN_HP_MASK,
      rt5663->imp_table[i].vol);
  snd_soc_component_update_bits(component, RT5663_STO_DRE_10,
      RT5663_DRE_GAIN_HP_MASK,
      rt5663->imp_table[i].vol);
  if (rt5663->jack_type == SND_JACK_HEADSET) {
    snd_soc_component_write(component, RT5663_MIC_DECRO_2,
...
static int rt5663_set_dai_pll(struct snd_soc_dai *dai, int pll_id, int source,
  ...
  snd_soc_component_update_bits(component, RT5663_GLB_CLK, mask,
      (val << shift));
