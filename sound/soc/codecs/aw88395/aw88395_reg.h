...
#define AW88395_AGC_DSP_CTL_MASK  \
  (~(((1 << AW88395_AGC_DSP_CTL_BITS_LEN) - 1) << \
...
#define AW88395_EF_VSN_GESLP_MASK \
  (~(((1 << AW88395_EF_VSN_GESLP_BITS_LEN) - 1) << \
    AW88395_EF_VSN_GESLP_START_BIT))
...
#define AW88395_EF_ISN_GESLP_MASK \
  (~(((1 << AW88395_EF_ISN_GESLP_BITS_LEN) - 1) << \
    AW88395_EF_ISN_GESLP_START_BIT))
