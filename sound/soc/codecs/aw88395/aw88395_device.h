...
int aw88395_init(struct aw_device **aw_dev, struct i2c_client *i2c,
    struct regmap *regmap);
...
int aw88395_dev_fw_update(struct aw_device *aw_dev, bool up_dsp_fw_en,
    bool force_up_en);
...
int aw88395_dev_get_prof_name(struct aw_device *aw_dev, int index,
    char **prof_name);
...
int aw88395_dev_load_acf_check(struct aw_device *aw_dev,
