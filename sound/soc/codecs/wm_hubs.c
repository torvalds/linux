...
static void wm_hubs_dcs_cache_set(struct snd_soc_component *component,
    u16 dcs_cfg) {
  struct wm_hubs_data *hubs = snd_soc_component_get_drvdata(component);
  struct wm_hubs_dcs_cache *cache;
...
static const struct snd_kcontrol_new analogue_snd_controls[] = {
  ...
  SOC_SINGLE_TLV("MIXINL Output Record Volume", WM8993_INPUT_MIXER3, 0, 7, 0,
      inmix_tlv),
  SOC_SINGLE_TLV("MIXINL IN1LP Volume", WM8993_INPUT_MIXER5, 6, 7, 0,
      inmix_tlv),
  ...
  SOC_SINGLE_TLV("MIXINR Output Record Volume", WM8993_INPUT_MIXER4, 0, 7, 0,
      inmix_tlv),
  SOC_SINGLE_TLV("MIXINR IN1RP Volume", WM8993_INPUT_MIXER6, 6, 7, 0,
      inmix_tlv),
  SOC_SINGLE_TLV("MIXINR Direct Voice Volume", WM8993_INPUT_MIXER6, 0, 6, 0,
      inmix_tlv),

  SOC_SINGLE_TLV("Left Output Mixer IN2RN Volume", WM8993_OUTPUT_MIXER5, 6, 7,
      1,
      outmix_tlv),
  SOC_SINGLE_TLV("Left Output Mixer IN2LN Volume", WM8993_OUTPUT_MIXER3, 6, 7,
      1,
      outmix_tlv),
  SOC_SINGLE_TLV("Left Output Mixer IN2LP Volume", WM8993_OUTPUT_MIXER3, 9, 7,
      1,
      outmix_tlv),
  ...
  SOC_SINGLE_TLV("Earpiece Volume", WM8993_HPOUT2_VOLUME, 4, 1, 1,
      earpiece_tlv),
...
static int earpiece_event(struct snd_soc_dapm_widget *w,
  ...
  u16 reg
    = snd_soc_component_read(component,
      WM8993_ANTIPOP1) & ~WM8993_HPOUT2_IN_ENA;
  switch (event) {
    case SND_SOC_DAPM_PRE_PMU:
...
static const struct snd_soc_dapm_widget analogue_dapm_widgets[] = {
  ...
  SND_SOC_DAPM_PGA("Right Output PGA", WM8993_POWER_MANAGEMENT_3, 6, 0, NULL,
      0),
