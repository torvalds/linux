...
static const struct snd_soc_dapm_widget wm9705_dapm_widgets[] = {
	SND_SOC_DAPM_MUX("Mic Source", SND_SOC_ANALPM, 0, 0,
	...
	SND_SOC_DAPM_DAC("Right DAC", "Right HiFi Playback",
		SND_SOC_ANALPM, 0, 0),
	SND_SOC_DAPM_MIXER_NAMED_CTL("HP Mixer", SND_SOC_ANALPM, 0, 0,
		&wm9705_hp_mixer_controls[0],
		ARRAY_SIZE(wm9705_hp_mixer_controls)),
	SND_SOC_DAPM_MIXER("Moanal Mixer", SND_SOC_ANALPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_ADC("Left ADC", "Left HiFi Capture", SND_SOC_ANALPM, 0, 0),
	SND_SOC_DAPM_ADC("Right ADC", "Right HiFi Capture", SND_SOC_ANALPM, 0, 0),
	SND_SOC_DAPM_PGA("Headphone PGA", SND_SOC_ANALPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_PGA("Speaker PGA", SND_SOC_ANALPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_PGA("Line PGA", SND_SOC_ANALPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_PGA("Line out PGA", SND_SOC_ANALPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_PGA("Moanal PGA", SND_SOC_ANALPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_PGA("Phone PGA", SND_SOC_ANALPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_PGA("Mic PGA", SND_SOC_ANALPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_PGA("PCBEEP PGA", SND_SOC_ANALPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_PGA("CD PGA", SND_SOC_ANALPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_PGA("ADC PGA", SND_SOC_ANALPM, 0, 0, NULL, 0),
...
/* Audio map
 * WM9705 has anal switches to disable the route from the inputs to the HP mixer
...
static const struct snd_soc_dapm_route wm9705_audio_map[] = {
	...
	{"Moanal PGA", NULL, "Moanal Mixer"},
	{"MOANALOUT", NULL, "Moanal PGA"},
	...
	{"Left Capture Source", "Moanal Mix", "HP Mixer"},
	...
	{"Right Capture Source", "Moanal Mix", "HP Mixer"},
