 ...
 */
static inline unsigned int uda1380_read_reg_cache(
    struct snd_soc_component *component,
    unsigned int reg) {
...
static const struct snd_kcontrol_new uda1380_snd_controls[] = {
  SOC_DOUBLE_TLV("Analog Mixer Volume", UDA1380_AMIX, 0, 8, 44, 1, amix_tlv), /*
                                                                               ...
                                                                               *
                                                                               **/
  SOC_DOUBLE_TLV("Master Playback Volume", UDA1380_MVOL, 0, 8, 252, 1,
      mvol_tlv), /* MVCL, MVCR */
  ...
  /**/ SOC_SINGLE("Master Playback Switch", UDA1380_DEEMP, 14, 1, 1),    /* MTM
                                                                          * */
  SOC_SINGLE("ADC Playback Switch", UDA1380_DEEMP, 11, 1, 1),   /* MT2 from
                                                                * decimation
                                                                * filter */
  SOC_ENUM("ADC Playback De-emphasis", uda1380_deemp_enum[0]),    /* DE2 */
  SOC_SINGLE("PCM Playback Switch", UDA1380_DEEMP, 3, 1, 1),    /* MT1, from
                                                                 * digital data
                                                                 * input */
  ...
  SOC_SINGLE_TLV("Mic Capture Volume", UDA1380_ADC, 8, 15, 0, vga_tlv), /*
                                                                         * VGA_CTRL
                                                                         * */
  SOC_SINGLE("DC Filter Bypass Switch", UDA1380_ADC, 1, 1, 0),    /* SKIP_DCFIL
                                                                   * (before
                                                                   * decimator)
                                                                   * */
  SOC_SINGLE("DC Filter Enable Switch", UDA1380_ADC, 0, 1, 0),    /* EN_DCFIL
                                                                   * (at output
                                                                   * of
                                                                   * decimator)
                                                                   * */
  SOC_SINGLE("AGC Timing", UDA1380_AGC, 8, 7, 0),     /* TODO: enum, see table
                                                       * 62 */
