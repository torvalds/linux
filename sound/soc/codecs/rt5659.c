...
static int rt5659_hp_vol_put(struct snd_kcontrol *kcontrol,
  ...
  if (snd_soc_component_read(component,
      RT5659_STO_NG2_CTRL_1) & RT5659_NG2_EN) {
...
static int rt5659_headset_detect(struct snd_soc_component *component,
    int jack_insert) {
  struct snd_soc_dapm_context *dapm = snd_soc_component_get_dapm(component);
  int val, i = 0, sleep_time[5] = {
    300, 150, 100, 50, 30
  };
  int reg_63;
...
static int rt5659_hw_params(struct snd_pcm_substream *substream,
  ...
  snd_soc_component_update_bits(component, RT5659_ADDA_CLK_1, mask_clk,
      val_clk);
...
static int rt5659_set_component_sysclk(struct snd_soc_component *component,
    int clk_id,
...
static int rt5659_set_component_pll(struct snd_soc_component *component,
    int pll_id,
