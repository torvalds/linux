...
static const struct snd_kcontrol_new cs35l41_aud_controls[] = {
  ...
  SOC_SINGLE("SCLK Force Switch", CS35L41_SP_FORMAT, CS35L41_SCLK_FRC_SHIFT, 1,
      0),
  SOC_SINGLE("LRCLK Force Switch", CS35L41_SP_FORMAT, CS35L41_LRCLK_FRC_SHIFT,
      1, 0),
...
static void cs35l41_boost_enable(struct cs35l41_private *cs35l41,
    unsigned int enable) {
...
static void cs35l41_error_release(struct cs35l41_private *cs35l41,
    unsigned int irq_err_bit,
    unsigned int rel_err_bit) {
  regmap_write(cs35l41->regmap, CS35L41_IRQ1_STATUS1, irq_err_bit);
  regmap_write(cs35l41->regmap, CS35L41_PROTECT_REL_ERR_IGN, 0);
  regmap_update_bits(cs35l41->regmap, CS35L41_PROTECT_REL_ERR_IGN, rel_err_bit,
      rel_err_bit);
  regmap_update_bits(cs35l41->regmap, CS35L41_PROTECT_REL_ERR_IGN, rel_err_bit,
      0);
}
...
static irqreturn_t cs35l41_irq(int irq, void *data) {
  ...
  if (status[0] & CS35L41_AMP_SHORT_ERR) {
    ...
    cs35l41_error_release(cs35l41, CS35L41_AMP_SHORT_ERR,
        CS35L41_AMP_SHORT_ERR_RLS);
    ret = IRQ_HANDLED;
  }
  if (status[0] & CS35L41_TEMP_WARN) {
    dev_crit_ratelimited(cs35l41->dev, "Over temperature warning\n");
    cs35l41_error_release(cs35l41, CS35L41_TEMP_WARN,
  ...
  if (status[0] & CS35L41_BST_OVP_ERR) {
    ...
    cs35l41_error_release(cs35l41, CS35L41_BST_OVP_ERR,
  ...
  if (status[0] & CS35L41_BST_DCM_UVP_ERR) {
    ...
    cs35l41_boost_enable(cs35l41, 0);
    cs35l41_error_release(cs35l41, CS35L41_BST_DCM_UVP_ERR,
  ...
  if (status[0] & CS35L41_BST_SHORT_ERR) {
    ...
    cs35l41_boost_enable(cs35l41, 0);
    cs35l41_error_release(cs35l41, CS35L41_BST_SHORT_ERR,
...
static int cs35l41_set_channel_map(struct snd_soc_dai *dai, unsigned int tx_n,
  ...
  return cs35l41_set_channels(cs35l41->dev, cs35l41->regmap, tx_n, tx_slot,
      rx_n, rx_slot);
}
...
static const struct snd_soc_dapm_widget cs35l41_ext_bst_widget[] = {
  SND_SOC_DAPM_SUPPLY("VSPK", CS35L41_GPIO1_CTRL1, CS35L41_GPIO_LVL_SHIFT, 0,
      NULL, 0),
};
...
static int cs35l41_handle_pdata(struct device *dev,
  ...
  unsigned int val;
  int ret;
  /* Some ACPI systems received the Shared Boost feature before the upstream
   * driver,
   * leaving those systems with deprecated _DSD properties.
   * To correctly configure those systems add shared-boost-active and
   * shared-boost-passive
   * properties mapped to the correct value in boost-type.
   * These two are not DT properties and should not be used in new systems
   * designs.
   */
  ...
  /* GPIO1 Pin Config */
  gpio1->pol_inv
    = device_property_read_bool(dev, "cirrus,gpio1-polarity-invert");
  ...
  /* GPIO2 Pin Config */
  gpio2->pol_inv
    = device_property_read_bool(dev, "cirrus,gpio2-polarity-invert");
...
static int cs35l41_acpi_get_name(struct cs35l41_private *cs35l41) {
  ...
  if (IS_ERR(sub)) {
    /* If bad ACPI, return 0 and fallback to legacy firmware path, otherwise
     * fail */
