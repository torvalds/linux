...
static const struct soc_enum wm9713_enum[] = {
  ...
  SOC_ENUM_SINGLE(AC97_PCI_SVID, 14, 4, wm9713_alc_select), /* alc source select
                                                             * 6*/
  SOC_ENUM_SINGLE(AC97_REC_GAIN, 14, 4, wm9713_mono_pga), /* mono input select 7
                                                           * */
  SOC_ENUM_SINGLE(AC97_REC_GAIN, 11, 8, wm9713_spk_pga), /* speaker left input
                                                          * select 8 */
  SOC_ENUM_SINGLE(AC97_REC_GAIN, 8, 8, wm9713_spk_pga), /* speaker right input
                                                         * select 9 */
  SOC_ENUM_SINGLE(AC97_REC_GAIN, 6, 3, wm9713_hp_pga), /* headphone left input
                                                        * 10 */
  SOC_ENUM_SINGLE(AC97_REC_GAIN, 4, 3, wm9713_hp_pga), /* headphone right input
                                                        * 11 */
  ...
  SOC_ENUM_SINGLE(AC97_3D_CONTROL, 12, 3, wm9713_mic_select), /* mic selection
                                                               * 18 */
...
static const struct snd_kcontrol_new wm9713_snd_ac97_controls[] = {
  ...
  SOC_SINGLE_TLV("Speaker Mixer Beep Playback Volume", AC97_AUX, 8, 7, 1,
      misc_tlv),
  SOC_SINGLE_TLV("Mono Mixer Beep Playback Volume", AC97_AUX, 4, 7, 1,
      misc_tlv),
...
static const struct snd_soc_dapm_widget wm9713_dapm_widgets[] = {
  ...
  SND_SOC_DAPM_ADC("Right Voice ADC", "Right Voice Capture", SND_SOC_NOPM, 0,
      0),
...
static int wm9713_set_dai_clkdiv(struct snd_soc_dai *codec_dai,
  ...
  switch (div_id) {
    ...
    case WM9713_PCMBCLK_DIV:
      snd_soc_component_update_bits(component, AC97_CENTER_LFE_MASTER, 0x0e00,
          div);
      break;
...
static int ac97_hifi_prepare(struct snd_pcm_substream *substream,
  ...
  int reg;
  snd_soc_component_update_bits(component, AC97_EXTENDED_STATUS, 0x0001,
      0x0001);
...
static int ac97_aux_prepare(struct snd_pcm_substream *substream,
  ...
  return snd_soc_component_write(component, AC97_PCM_SURR_DAC_RATE,
      runtime->rate);
}
...
static int wm9713_set_bias_level(struct snd_soc_component *component,
  ...
  switch (level) {
    case SND_SOC_BIAS_ON:
      ...
      snd_soc_component_update_bits(component, AC97_EXTENDED_MID, 0xe400,
          0x0000);
      break;
    ...
    case SND_SOC_BIAS_STANDBY:
      ...
      snd_soc_component_update_bits(component, AC97_EXTENDED_MID, 0xc400,
          0x0000);
