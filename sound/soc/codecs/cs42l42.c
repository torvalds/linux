...
static const struct snd_soc_dapm_widget cs42l42_dapm_widgets[] = {
  ...
  SND_SOC_DAPM_MIXER("MIXER", CS42L42_PWR_CTL1, CS42L42_MIXER_PDN_SHIFT, 1,
      NULL, 0),
  SND_SOC_DAPM_AIF_IN("SDIN1", NULL, 0, SND_SOC_NOPM, 0, 0),
  SND_SOC_DAPM_AIF_IN("SDIN2", NULL, 1, SND_SOC_NOPM, 0, 0),

  /* Playback Requirements */
  SND_SOC_DAPM_SUPPLY("ASP DAI0", CS42L42_PWR_CTL1, CS42L42_ASP_DAI_PDN_SHIFT,
      1, NULL, 0),
  ...
  SND_SOC_DAPM_ADC_E("ADC", NULL, CS42L42_PWR_CTL1, CS42L42_ADC_PDN_SHIFT, 1,
      cs42l42_hp_adc_ev, SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU),
  SND_SOC_DAPM_AIF_OUT("SDOUT1", NULL, 0, CS42L42_ASP_TX_CH_EN,
      CS42L42_ASP_TX0_CH1_SHIFT, 0),
  SND_SOC_DAPM_AIF_OUT("SDOUT2", NULL, 1, CS42L42_ASP_TX_CH_EN,
      CS42L42_ASP_TX0_CH2_SHIFT, 0),

  /* Capture Requirements */
  SND_SOC_DAPM_SUPPLY("ASP DAO0", CS42L42_PWR_CTL1, CS42L42_ASP_DAO_PDN_SHIFT,
      1, NULL, 0),
  SND_SOC_DAPM_SUPPLY("ASP TX EN", CS42L42_ASP_TX_SZ_EN,
      CS42L42_ASP_TX_EN_SHIFT, 0, NULL, 0),

  /* Playback/Capture Requirements */
  SND_SOC_DAPM_SUPPLY("SCLK", CS42L42_ASP_CLK_CFG, CS42L42_ASP_SCLK_EN_SHIFT, 0,
      NULL, 0),

  /* Soundwire SRC power control */
  SND_SOC_DAPM_PGA("DACSRC", CS42L42_PWR_CTL2, CS42L42_DAC_SRC_PDNB_SHIFT, 0,
      NULL, 0),
  SND_SOC_DAPM_PGA("ADCSRC", CS42L42_PWR_CTL2, CS42L42_ADC_SRC_PDNB_SHIFT, 0,
      NULL, 0),
};
...
static int cs42l42_set_jack(struct snd_soc_component *component,
    struct snd_soc_jack *jk, void *d) {
  struct cs42l42_private *cs42l42 = snd_soc_component_get_drvdata(component);
...
static int cs42l42_set_dai_fmt(struct snd_soc_dai *codec_dai,
    unsigned int fmt) {
...
static int cs42l42_dai_startup(struct snd_pcm_substream *substream,
...
static void cs42l42_process_hs_type_detect(struct cs42l42_private *cs42l42) {
   ...
   * We Re-Run with Manual Detection if the original detection was invalid or
   * headphones,
...
int cs42l42_suspend(struct device *dev) {
  ...
  regcache_drop_region(cs42l42->regmap, CS42L42_PAGE_REGISTER,
...
void cs42l42_resume_restore(struct device *dev) {
  ...
  regcache_sync_region(cs42l42->regmap, CS42L42_MIC_DET_CTL1,
      CS42L42_MIC_DET_CTL1);
...
int cs42l42_common_probe(struct cs42l42_private *cs42l42,
  ...
  BUILD_BUG_ON(ARRAY_SIZE(cs42l42_supply_names)
