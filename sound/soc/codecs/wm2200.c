...
static const struct snd_soc_dapm_widget wm2200_dapm_widgets[] = {
  ...
  SND_SOC_DAPM_SUPPLY("CP1", WM2200_DM_CHARGE_PUMP_1, WM2200_CPDM_ENA_SHIFT, 0,
      NULL, 0),
  SND_SOC_DAPM_SUPPLY("CP2", WM2200_MIC_CHARGE_PUMP_1, WM2200_CPMIC_ENA_SHIFT,
      0,
      NULL, 0),
  SND_SOC_DAPM_SUPPLY("MICBIAS1", WM2200_MIC_BIAS_CTRL_1,
      WM2200_MICB1_ENA_SHIFT,
      0, NULL, 0),
  SND_SOC_DAPM_SUPPLY("MICBIAS2", WM2200_MIC_BIAS_CTRL_2,
...
static int wm2200_set_fll(struct snd_soc_component *component, int fll_id,
    int source,
  ...
  snd_soc_component_update_bits(component, WM2200_FLL_CONTROL_1, WM2200_FLL_ENA,
      0);
  ...
  snd_soc_component_update_bits(component, WM2200_FLL_CONTROL_4,
      WM2200_FLL_THETA_MASK,
      factors.theta);
  snd_soc_component_update_bits(component, WM2200_FLL_CONTROL_6,
      WM2200_FLL_N_MASK,
      factors.n);
