...
#define AW88399_EF_ISN_GESLP_H_MASK   \
  (~(((1 << AW88399_EF_ISN_GESLP_H_BITS_LEN) - 1) << \
    AW88399_EF_ISN_GESLP_H_START_BIT))
...
#define AW88399_EF_VSN_GESLP_H_MASK   \
  (~(((1 << AW88399_EF_VSN_GESLP_H_BITS_LEN) - 1) << \
    AW88399_EF_VSN_GESLP_H_START_BIT))

#define AW88399_EF_ISN_GESLP_L_START_BIT  (0)
#define AW88399_EF_ISN_GESLP_L_BITS_LEN (10)
#define AW88399_EF_ISN_GESLP_L_MASK   \
  (~(((1 << AW88399_EF_ISN_GESLP_L_BITS_LEN) - 1) << \
    AW88399_EF_ISN_GESLP_L_START_BIT))
...
#define AW88399_EF_VSN_GESLP_L_MASK   \
  (~(((1 << AW88399_EF_VSN_GESLP_L_BITS_LEN) - 1) << \
    AW88399_EF_VSN_GESLP_L_START_BIT))
...
#define AW88399_INTERNAL_VSN_TRIM_H_MASK  \
  (~(((1 << AW88399_INTERNAL_VSN_TRIM_H_BITS_LEN) - 1) << \
    AW88399_INTERNAL_VSN_TRIM_H_START_BIT))
...
#define AW88399_INTERNAL_VSN_TRIM_L_MASK  \
  (~(((1 << AW88399_INTERNAL_VSN_TRIM_L_BITS_LEN) - 1) << \
...
#define AW88399_CRC_END_ADDR_MASK \
  (~(((1 << AW88399_CRC_END_ADDR_BITS_LEN) - 1) << \
    AW88399_CRC_END_ADDR_START_BIT))

#define AW88399_CRC_CODE_EN_START_BIT (13)
#define AW88399_CRC_CODE_EN_BITS_LEN  (1)
#define AW88399_CRC_CODE_EN_MASK  \
  (~(((1 << AW88399_CRC_CODE_EN_BITS_LEN) - 1) << \
    AW88399_CRC_CODE_EN_START_BIT))
...
#define AW88399_NOISE_GATE_EN_MASK  \
  (~(((1 << AW88399_NOISE_GATE_EN_BITS_LEN) - 1) << \
    AW88399_NOISE_GATE_EN_START_BIT))
