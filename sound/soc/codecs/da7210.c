...
static int da7210_put_alc_sw(struct snd_kcontrol *kcontrol,
  ...
  if (ucontrol->value.integer.value[0]) {
    ...
    if (snd_soc_component_read(component,
        DA7210_CONTROL) & DA7210_NOISE_SUP_EN) {
  ...
  if (ucontrol->value.integer.value[0]) {
    ...
    if (((snd_soc_component_read(component, DA7210_AUX1_L) & DA7210_AUX1_L_VOL)
        ...
        || ((snd_soc_component_read(component,
            DA7210_AUX1_R) & DA7210_AUX1_R_VOL)
        < DA7210_AUX1_MIN_VOL_NS)) {
      goto err;
    }
  }
...
static int da7210_set_dai_fmt(struct snd_soc_dai *codec_dai, u32 fmt) {
  ...
  if ((snd_soc_component_read(component, DA7210_PLL) & DA7210_PLL_EN)
      && (!(snd_soc_component_read(component,
          DA7210_PLL_DIV3) & DA7210_PLL_BYP))) {
    return -EINVAL;
  }
...
static int da7210_set_dai_pll(struct snd_soc_dai *codec_dai, int pll_id,
  ...
  /* Enable PLL */
  snd_soc_component_update_bits(component, DA7210_PLL, DA7210_PLL_EN,
      DA7210_PLL_EN);
  /* Enable active mode */
  snd_soc_component_update_bits(component, DA7210_STARTUP1, DA7210_SC_MST_EN,
      DA7210_SC_MST_EN);
...
static int da7210_probe(struct snd_soc_component *component) {
  ...
  snd_soc_component_write(component, DA7210_CONTROL,
      DA7210_REG_EN | DA7210_BIAS_EN);
  /*
   * ADC settings
   */
  /* Enable Left & Right MIC PGA and Mic Bias */
  snd_soc_component_write(component, DA7210_MIC_L,
      DA7210_MIC_L_EN | DA7210_MICBIAS_EN);
  ...
  snd_soc_component_write(component, DA7210_ADC,
      DA7210_ADC_L_EN | DA7210_ADC_R_EN);
  /*
   * DAC settings
   */
