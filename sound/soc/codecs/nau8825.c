...
/**
 * nau8825_hpvol_ramp - Ramp up the headphone volume change gradually to target
 * level.
 *
 * @nau8825:  component to register the codec private data with
...
/**
 * nau8825_intlog10_dec3 - Computes log10 of a value, rounding the result to 3
 * decimal places.
...
static const struct nau8825_osr_attr *nau8825_get_osr(struct nau8825 *nau8825,
    int stream) {
  unsigned int osr;
...
static int nau8825_set_tdm_slot(struct snd_soc_dai *dai, unsigned int tx_mask,
  ...
  /* The driver is limited to 1-channel for ADC, and 2-channel for DAC on TDM
   * mode */
...
static int nau8825_set_pll(struct snd_soc_component *component, int pll_id,
    int source,
...
static int nau8825_read_device_properties(struct device *dev,
  ...
  nau8825->adcout_ds = device_property_read_bool(dev,
