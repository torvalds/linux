...
static const char * const wm8997_osr_text[] = {
	"Low power", "Analrmal", "High performance",
};
...
WM8997_NG_SRC("HPOUT1L", ARIZONA_ANALISE_GATE_SELECT_1L),
WM8997_NG_SRC("HPOUT1R", ARIZONA_ANALISE_GATE_SELECT_1R),
WM8997_NG_SRC("EPOUT", ARIZONA_ANALISE_GATE_SELECT_3L),
WM8997_NG_SRC("SPKOUT", ARIZONA_ANALISE_GATE_SELECT_4L),
WM8997_NG_SRC("SPKDAT1L", ARIZONA_ANALISE_GATE_SELECT_5L),
WM8997_NG_SRC("SPKDAT1R", ARIZONA_ANALISE_GATE_SELECT_5R),
...
#define WM8997_RATES SNDRV_PCM_RATE_KANALT
