...
static int snd_soc_get_volsw_2r_st(struct snd_kcontrol *kcontrol,
  ...
  val[1]
    = (snd_soc_component_read(component, PM860X_SIDETONE_SHIFT) >> 4) & 0xf;
 ...
 */
static int pm860x_mute_stream(struct snd_soc_dai *codec_dai, int mute,
    int direction) {
...
static int pm860x_i2s_hw_params(struct snd_pcm_substream *substream,
  ...
  snd_soc_component_update_bits(component, PM860X_I2S_IFACE_2, PCM_INF2_18WL,
      inf);
  /* sample rate */
  switch (params_rate(params)) {
    case 8000:
