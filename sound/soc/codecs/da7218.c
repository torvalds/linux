...
static void da7218_alc_calib(struct snd_soc_component *component) {
  ...
  in_1_hpf_ctrl
    = snd_soc_component_read(component, DA7218_IN_1_HPF_FILTER_CTRL);
  in_2_hpf_ctrl
    = snd_soc_component_read(component, DA7218_IN_2_HPF_FILTER_CTRL);
  ...
  snd_soc_component_write(component, DA7218_IN_1_HPF_FILTER_CTRL,
      in_1_hpf_ctrl);
  snd_soc_component_write(component, DA7218_IN_2_HPF_FILTER_CTRL,
      in_2_hpf_ctrl);
...
int da7218_hpldet(struct snd_soc_component *component,
...
static enum da7218_micbias_voltage da7218_of_micbias_lvl(
...
static enum da7218_mic_amp_in_sel da7218_of_mic_amp_in_sel(
    struct snd_soc_component *component, const char *str) {
  if (!strcmp(str, "diff")) {
...
static enum da7218_dmic_data_sel da7218_of_dmic_data_sel(
    struct snd_soc_component *component, const char *str) {
...
static enum da7218_dmic_clk_rate da7218_of_dmic_clkrate(
    struct snd_soc_component *component, u32 val) {
  switch (val) {
    case 1500000:
...
static enum da7218_hpldet_jack_rate da7218_of_jack_rate(
    struct snd_soc_component *component, u32 val) {
  switch (val) {
    case 5:
...
static enum da7218_hpldet_jack_debounce da7218_of_jack_debounce(
    struct snd_soc_component *component, u32 val) {
  switch (val) {
    case 0:
...
static enum da7218_hpldet_jack_thr da7218_of_jack_thr(
    struct snd_soc_component *component, u32 val) {
  switch (val) {
    case 84:
...
static int da7218_probe(struct snd_soc_component *component) {
  ...
  snd_soc_component_write(component, DA7218_TONE_GEN_CYCLES,
