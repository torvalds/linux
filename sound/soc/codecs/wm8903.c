...
static const struct snd_kcontrol_new wm8903_snd_controls[] = {
  ...
  SOC_SINGLE("Right Input PGA Volume", WM8903_ANALOGUE_RIGHT_INPUT_0,
      0, 31, 0),
  SOC_SINGLE("Right Input PGA Common Mode Switch",
...
static const struct snd_kcontrol_new right_output_mixer[] = {
  ...
  SOC_DAPM_SINGLE_W("Right Bypass Switch", WM8903_ANALOGUE_RIGHT_MIX_0, 0, 1,
      0),
};
...
static const struct snd_kcontrol_new left_speaker_mixer[] = {
  ...
  SOC_DAPM_SINGLE("Left Bypass Switch", WM8903_ANALOGUE_SPK_MIX_LEFT_0, 1, 1,
      0),
...
static const struct snd_soc_dapm_widget wm8903_dapm_widgets[] = {
  ...
  SND_SOC_DAPM_MUX("Right Input Inverting Mux", SND_SOC_NOPM, 0, 0,
      &rinput_inv_mux),
  SND_SOC_DAPM_MUX("Right Input Mode Mux", SND_SOC_NOPM, 0, 0,
      &rinput_mode_mux),
  ...
  SND_SOC_DAPM_PGA_S("Left Line Output PGA", 0, WM8903_POWER_MANAGEMENT_3, 1, 0,
      NULL, 0),
  SND_SOC_DAPM_PGA_S("Right Line Output PGA", 0, WM8903_POWER_MANAGEMENT_3, 0,
      0,
      NULL, 0),
 ...
 */
int wm8903_mic_detect(struct snd_soc_component *component,
...
static void wm8903_gpio_set(struct gpio_chip *chip, unsigned offset,
    int value) {
  struct wm8903_priv *wm8903 = gpiochip_get_data(chip);
