...
#define CS42XX8_FUNCMOD_DAC_FM_MASK   (((1 << \
    CS42XX8_FUNCMOD_DAC_FM_WIDTH) - 1) << CS42XX8_FUNCMOD_DAC_FM_SHIFT)
...
#define CS42XX8_FUNCMOD_ADC_FM_MASK   (((1 << \
    CS42XX8_FUNCMOD_ADC_FM_WIDTH) - 1) << CS42XX8_FUNCMOD_ADC_FM_SHIFT)
#define CS42XX8_FUNCMOD_ADC_FM(v)   ((v) << CS42XX8_FUNCMOD_ADC_FM_SHIFT)
#define CS42XX8_FUNCMOD_xC_FM_MASK(x)   ((x) ? CS42XX8_FUNCMOD_DAC_FM_MASK   \
  : CS42XX8_FUNCMOD_ADC_FM_MASK)
#define CS42XX8_FUNCMOD_xC_FM(x, \
      v)   ((x) ? CS42XX8_FUNCMOD_DAC_FM(v) : CS42XX8_FUNCMOD_ADC_FM(v))
#define CS42XX8_FUNCMOD_MFREQ_SHIFT   1
#define CS42XX8_FUNCMOD_MFREQ_WIDTH   3
#define CS42XX8_FUNCMOD_MFREQ_MASK    (((1 << \
    CS42XX8_FUNCMOD_MFREQ_WIDTH) - 1) << CS42XX8_FUNCMOD_MFREQ_SHIFT)
#define CS42XX8_FUNCMOD_MFREQ_256(s)    ((0 << CS42XX8_FUNCMOD_MFREQ_SHIFT) >> \
  (s >> 1))
#define CS42XX8_FUNCMOD_MFREQ_384(s)    ((1 << CS42XX8_FUNCMOD_MFREQ_SHIFT) >> \
  (s >> 1))
#define CS42XX8_FUNCMOD_MFREQ_512(s)    ((2 << CS42XX8_FUNCMOD_MFREQ_SHIFT) >> \
  (s >> 1))
#define CS42XX8_FUNCMOD_MFREQ_768(s)    ((3 << CS42XX8_FUNCMOD_MFREQ_SHIFT) >> \
  (s >> 1))
#define CS42XX8_FUNCMOD_MFREQ_1024(s)   ((4 << CS42XX8_FUNCMOD_MFREQ_SHIFT) >> \
  (s >> 1))
...
#define CS42XX8_INTF_DAC_DIF_MASK   (((1 << CS42XX8_INTF_DAC_DIF_WIDTH) - 1) << \
...
#define CS42XX8_INTF_ADC_DIF_MASK   (((1 << CS42XX8_INTF_ADC_DIF_WIDTH) - 1) << \
...
#define CS42XX8_ADCCTL_ADC_HPF_FREEZE_MASK  (1 << \
    CS42XX8_ADCCTL_ADC_HPF_FREEZE_SHIFT)
#define CS42XX8_ADCCTL_ADC_HPF_FREEZE   (1 << \
    CS42XX8_ADCCTL_ADC_HPF_FREEZE_SHIFT)
...
#define CS42XX8_ADCCTL_ADC1_SINGLE_MASK   (1 << \
...
#define CS42XX8_ADCCTL_ADC2_SINGLE_MASK   (1 << \
...
#define CS42XX8_ADCCTL_ADC3_SINGLE_MASK   (1 << \
...
#define CS42XX8_TXCTL_DAC_SZC_MASK    (((1 << \
    CS42XX8_TXCTL_DAC_SZC_WIDTH) - 1) << CS42XX8_TXCTL_DAC_SZC_SHIFT)
...
#define CS42XX8_TXCTL_ADC_SZC_MASK    (((1 << \
    CS42XX8_TXCTL_ADC_SZC_WIDTH) - 1) << CS42XX8_TXCTL_ADC_SZC_SHIFT)
...
#define CS42XX8_STATUSCTL_INI_MASK    (((1 << \
    CS42XX8_STATUSCTL_INI_WIDTH) - 1) << CS42XX8_STATUSCTL_INI_SHIFT)
...
#define CS42XX8_STATUS_DAC_CLK_ERR_MASK   (1 << \
    CS42XX8_STATUS_DAC_CLK_ERR_SHIFT)
#define CS42XX8_STATUS_ADC_CLK_ERR_SHIFT  3
#define CS42XX8_STATUS_ADC_CLK_ERR_MASK   (1 << \
...
#define CS42XX8_MUTEC_MCPOLARITY_ACTIVE_LOW (0 << \
    CS42XX8_MUTEC_MCPOLARITY_SHIFT)
#define CS42XX8_MUTEC_MCPOLARITY_ACTIVE_HIGH  (1 << \
    CS42XX8_MUTEC_MCPOLARITY_SHIFT)
#define CS42XX8_MUTEC_MUTEC_ACTIVE_SHIFT  0
#define CS42XX8_MUTEC_MUTEC_ACTIVE_MASK   (1 << \
