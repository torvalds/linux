...
#define CS53L30_MCLK_DIV_MASK   (((1 << CS53L30_MCLK_DIV_WIDTH) - 1) << \
...
#define CS53L30_MIC_BIAS_CTRL_MASK  (((1 << CS53L30_MIC_BIAS_CTRL_WIDTH) - 1) << \
...
#define CS53L30_ASP_RATE_MASK   (((1 << CS53L30_ASP_RATE_WIDTH) - 1) << \
...
#define CS53L30_ASP_CHx_TX_LOC_MASK (((1 << \
    CS53L30_ASP_CHx_TX_LOC_WIDTH) - 1) << CS53L30_ASP_CHx_TX_LOC_SHIFT)
...
#define CS53L30_LRCK_TPWH_MASK    (((1 << CS53L30_LRCK_TPWH_WIDTH) - 1) << \
    CS53L30_LRCK_TPWH_SHIFT)
#define CS53L30_LRCK_TPWH(x)    (((x) << \
    CS53L30_LRCK_TPWH_SHIFT) & CS53L30_LRCK_TPWH_MASK)
...
#define CS53L30_MUTE_ASP_SDOUT2_PDN_MASK (1 << \
...
#define CS53L30_MUTE_ASP_SDOUT1_PDN_MASK (1 << \
    CS53L30_MUTE_ASP_SDOUT1_PDN_SHIFT)
#define CS53L30_MUTE_ASP_SDOUT1_PDN (1 << CS53L30_MUTE_ASP_SDOUT1_PDN_SHIFT)
/* Note: be careful - x starts from 0 */
#define CS53L30_MUTE_ASP_SDOUTx_PDN_SHIFT(x) ((x) \
  + CS53L30_MUTE_ASP_SDOUT1_PDN_SHIFT)
#define CS53L30_MUTE_ASP_SDOUTx_PDN_MASK(x) (1 << \
    CS53L30_MUTE_ASP_SDOUTx_PDN_SHIFT(x))
...
#define CS53L30_IN4M_BIAS_MASK    (((1 << CS53L30_IN4M_BIAS_WIDTH) - 1) << \
...
#define CS53L30_IN4P_BIAS_MASK    (((1 << CS53L30_IN4P_BIAS_WIDTH) - 1) << \
...
#define CS53L30_IN3M_BIAS_MASK    (((1 << CS53L30_IN3M_BIAS_WIDTH) - 1) << \
    CS53L30_IN4M_BIAS_SHIFT)
...
#define CS53L30_IN3P_BIAS_MASK    (((1 << CS53L30_IN3P_BIAS_WIDTH) - 1) << \
...
#define CS53L30_INBIAS_CTL1_DEFAULT (CS53L30_IN4M_BIAS_VCM \
...
#define CS53L30_IN2M_BIAS_MASK    (((1 << CS53L30_IN2M_BIAS_WIDTH) - 1) << \
...
#define CS53L30_IN2P_BIAS_MASK    (((1 << CS53L30_IN2P_BIAS_WIDTH) - 1) << \
...
#define CS53L30_IN1M_BIAS_MASK    (((1 << CS53L30_IN1M_BIAS_WIDTH) - 1) << \
...
#define CS53L30_IN1P_BIAS_MASK    (((1 << CS53L30_IN1P_BIAS_WIDTH) - 1) << \
...
#define CS53L30_INBIAS_CTL2_DEFAULT (CS53L30_IN2M_BIAS_VCM \
...
#define CS53L30_ADCx_HPF_CF_MASK  (((1 << CS53L30_ADCx_HPF_CF_WIDTH) - 1) << \
...
#define CS53L30_ADCx_NG_THRESH_MASK (((1 << \
    CS53L30_ADCx_NG_THRESH_WIDTH) - 1) << CS53L30_ADCx_NG_THRESH_SHIFT)
#define CS53L30_ADCx_NG_DELAY_SHIFT 0
#define CS53L30_ADCx_NG_DELAY_WIDTH 2
#define CS53L30_ADCx_NG_DELAY_MASK  (((1 << CS53L30_ADCx_NG_DELAY_WIDTH) - 1) << \
    CS53L30_ADCx_NG_DELAY_SHIFT)

#define CS53L30_ADCx_NG_CTL_DEFAULT (0)

/* R41/R42/R49/R50 (0x29/0x2A/0x31/0x32) CS53L30_ADCxy_AFE_CTL - ADC1A/1B/2A/2B
 * AFE Control */
#define CS53L30_ADCxy_PREAMP_SHIFT  6
#define CS53L30_ADCxy_PREAMP_WIDTH  2
#define CS53L30_ADCxy_PREAMP_MASK (((1 << CS53L30_ADCxy_PREAMP_WIDTH) - 1) << \
    CS53L30_ADCxy_PREAMP_SHIFT)
#define CS53L30_ADCxy_PGA_VOL_SHIFT 0
#define CS53L30_ADCxy_PGA_VOL_WIDTH 6
#define CS53L30_ADCxy_PGA_VOL_MASK  (((1 << CS53L30_ADCxy_PGA_VOL_WIDTH) - 1) << \
    CS53L30_ADCxy_PGA_VOL_SHIFT)

#define CS53L30_ADCxy_AFE_CTL_DEFAULT (0)

/* R43/R44/R51/R52 (0x2B/0x2C/0x33/0x34) CS53L30_ADCxy_DIG_VOL - ADC1A/1B/2A/2B
 * Digital Volume */
