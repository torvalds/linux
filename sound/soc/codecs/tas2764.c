...
static irqreturn_t tas2764_irq(int irq, void *data) {
  ...
  if (latched[0]) {
    dev_err_ratelimited(tas2764->dev,
        "other context to the fault: %02x,%02x,%02x,%02x,%02x",
...
static int tas2764_set_samplerate(struct tas2764_priv *tas2764,
    int samplerate) {
  struct snd_soc_component *component = tas2764->component;
  int ramp_rate_val;
  int ret;
...
static int tas2764_codec_probe(struct snd_soc_component *component) {
  ...
  if (tas2764->irq) {
    ...
    ret = devm_request_threaded_irq(tas2764->dev, tas2764->irq, NULL,
        tas2764_irq,
