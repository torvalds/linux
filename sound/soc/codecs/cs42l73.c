...
static int cs42l73_set_dai_fmt(struct snd_soc_dai *codec_dai,
    unsigned int fmt) {
...
static void cs42l73_update_asrc(struct snd_soc_component *component, int id,
    int srate) {
  u8 spfs = 0;
  if (srate > 0) {
...
static int cs42l73_set_bias_level(struct snd_soc_component *component,
  ...
  switch (level) {
    case SND_SOC_BIAS_ON:
      snd_soc_component_update_bits(component, CS42L73_DMMCC, CS42L73_MCLKDIS,
          0);
...
static int cs42l73_set_tristate(struct snd_soc_dai *dai, int tristate) {
  struct snd_soc_component *component = dai->component;
  int id = dai->id;
  return snd_soc_component_update_bits(component, CS42L73_SPC(
      id), CS42L73_SP_3ST,
      tristate << 7);
}
