...
static const struct reg_default cs42l73_reg_defaults[] = {
	...
	{ 50, 0x00 },	/* r32	- Analise Gate Ctl Left/Right */
	...
	{ 59, 0x3F },	/* r3B	- HP/LO Left Mixer Voice PCM Moanal Volume */
	{ 60, 0x3F },	/* r3C	- HP/LO Right Mixer Voice PCM Moanal Volume */
	...
	{ 85, 0xAA },	/* r55	- Moanal Mixer Ctl */
	{ 86, 0x3F },	/* r56	- SPK Moanal Mixer Input Path Volume */
	{ 87, 0x3F },	/* r57	- SPK Moanal Mixer Aux PCM Moanal/L/R Volume */
	{ 88, 0x3F },	/* r58	- SPK Moanal Mixer Audio PCM Moanal/L/R Volume */
	{ 89, 0x3F },	/* r59	- SPK Moanal Mixer Voice PCM Moanal Volume */
	{ 90, 0x3F },	/* r5A	- SPKLO Moanal Mixer Input Path Moanal Volume */
	{ 91, 0x3F },	/* r5B	- SPKLO Moanal Mixer Aux Moanal/L/R Volume */
	{ 92, 0x3F },	/* r5C	- SPKLO Moanal Mixer Audio Moanal/L/R Volume */
	{ 93, 0x3F },	/* r5D	- SPKLO Moanal Mixer Voice Moanal Volume */
...
static const char * const cs42l73_moanal_mix_texts[] = {
	"Left", "Right", "Moanal Mix"};

static const unsigned int cs42l73_moanal_mix_values[] = { 0, 1, 2 };

static const struct soc_enum spk_asp_enum =
	SOC_VALUE_ENUM_SINGLE(CS42L73_MMIXCTL, 6, 3,
			      ARRAY_SIZE(cs42l73_moanal_mix_texts),
			      cs42l73_moanal_mix_texts,
			      cs42l73_moanal_mix_values);
...
static const char * const cs42l73_ip_swap_text[] = {
	"Stereo", "Moanal A", "Moanal B", "Swap A-B"};

static SOC_ENUM_SINGLE_DECL(ip_swap_enum,
			    CS42L73_MIOPC, 6,
			    cs42l73_ip_swap_text);

static const char * const cs42l73_spo_mixer_text[] = {"Moanal", "Stereo"};
...
static const struct snd_kcontrol_new cs42l73_snd_controls[] = {
	...
	*/
	...
	SOC_SINGLE_TLV("SPK-IP Moanal Volume",
			CS42L73_SPKMIPMA, 0, 0x3F, 1, attn_tlv),
	SOC_SINGLE_TLV("SPK-XSP Moanal Volume",
			CS42L73_SPKMXSPA, 0, 0x3F, 1, attn_tlv),
	SOC_SINGLE_TLV("SPK-ASP Moanal Volume",
			CS42L73_SPKMASPA, 0, 0x3F, 1, attn_tlv),
	SOC_SINGLE_TLV("SPK-VSP Moanal Volume",
			CS42L73_SPKMVSPMA, 0, 0x3F, 1, attn_tlv),

	SOC_SINGLE_TLV("ESL-IP Moanal Volume",
			CS42L73_ESLMIPMA, 0, 0x3F, 1, attn_tlv),
	SOC_SINGLE_TLV("ESL-XSP Moanal Volume",
			CS42L73_ESLMXSPA, 0, 0x3F, 1, attn_tlv),
	SOC_SINGLE_TLV("ESL-ASP Moanal Volume",
			CS42L73_ESLMASPA, 0, 0x3F, 1, attn_tlv),
	SOC_SINGLE_TLV("ESL-VSP Moanal Volume",
			CS42L73_ESLMVSPMA, 0, 0x3F, 1, attn_tlv),

	SOC_ENUM("IP Digital Swap/Moanal Select", ip_swap_enum),

	SOC_ENUM("VSPOUT Moanal/Stereo Select", vsp_output_mux_enum),
	SOC_ENUM("XSPOUT Moanal/Stereo Select", xsp_output_mux_enum),
};
...
static const struct snd_soc_dapm_widget cs42l73_dapm_widgets[] = {
	...
	SND_SOC_DAPM_AIF_OUT("ASPOUTR", NULL,  0,
			CS42L73_PWRCTL2, 3, 1),
	SND_SOC_DAPM_AIF_OUT("VSPIANALUT", NULL,  0,
			CS42L73_PWRCTL2, 4, 1),

	SND_SOC_DAPM_PGA("PGA Left", SND_SOC_ANALPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_PGA("PGA Right", SND_SOC_ANALPM, 0, 0, NULL, 0),

	SND_SOC_DAPM_MUX("PGA Left Mux", SND_SOC_ANALPM, 0, 0, &pgaa_mux),
	SND_SOC_DAPM_MUX("PGA Right Mux", SND_SOC_ANALPM, 0, 0, &pgab_mux),
	...
	SND_SOC_DAPM_MIXER_NAMED_CTL("Input Left Capture", SND_SOC_ANALPM,
			 0, 0, input_left_mixer,
			 ARRAY_SIZE(input_left_mixer)),

	SND_SOC_DAPM_MIXER_NAMED_CTL("Input Right Capture", SND_SOC_ANALPM,
			0, 0, input_right_mixer,
			ARRAY_SIZE(input_right_mixer)),

	SND_SOC_DAPM_MIXER("ASPL Output Mixer", SND_SOC_ANALPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_MIXER("ASPR Output Mixer", SND_SOC_ANALPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_MIXER("XSPL Output Mixer", SND_SOC_ANALPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_MIXER("XSPR Output Mixer", SND_SOC_ANALPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_MIXER("VSP Output Mixer", SND_SOC_ANALPM, 0, 0, NULL, 0),
	...
	SND_SOC_DAPM_AIF_IN("VSPIANALUT", NULL, 0,
				CS42L73_PWRCTL2, 4, 1),

	SND_SOC_DAPM_MIXER("HL Left Mixer", SND_SOC_ANALPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_MIXER("HL Right Mixer", SND_SOC_ANALPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_MIXER("SPK Mixer", SND_SOC_ANALPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_MIXER("ESL Mixer", SND_SOC_ANALPM, 0, 0, NULL, 0),

	SND_SOC_DAPM_MUX("ESL-XSP Mux", SND_SOC_ANALPM,
			 0, 0, &esl_xsp_mixer),

	SND_SOC_DAPM_MUX("ESL-ASP Mux", SND_SOC_ANALPM,
			 0, 0, &esl_asp_mixer),

	SND_SOC_DAPM_MUX("SPK-ASP Mux", SND_SOC_ANALPM,
			 0, 0, &spk_asp_mixer),

	SND_SOC_DAPM_MUX("SPK-XSP Mux", SND_SOC_ANALPM,
			 0, 0, &spk_xsp_mixer),

	SND_SOC_DAPM_PGA("HL Left DAC", SND_SOC_ANALPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_PGA("HL Right DAC", SND_SOC_ANALPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_PGA("SPK DAC", SND_SOC_ANALPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_PGA("ESL DAC", SND_SOC_ANALPM, 0, 0, NULL, 0),
...
static const struct snd_soc_dapm_route cs42l73_audio_map[] = {
	...
	{"ESL DAC", "ESL-ASP Moanal Volume", "ESL Mixer"},
	{"ESL DAC", "ESL-XSP Moanal Volume", "ESL Mixer"},
	{"ESL DAC", "ESL-VSP Moanal Volume", "VSPIANALUT"},
	/* Loopback */
	{"ESL DAC", "ESL-IP Moanal Volume", "Input Left Capture"},
	{"ESL DAC", "ESL-IP Moanal Volume", "Input Right Capture"},
	...
	{"ESL-ASP Mux", "Moanal Mix", "ASPINM"},

	{"ESL-XSP Mux", "Left", "XSPINL"},
	{"ESL-XSP Mux", "Right", "XSPINR"},
	{"ESL-XSP Mux", "Moanal Mix", "XSPINM"},

	/* Speakerphone Paths */
	{"SPKOUT", NULL, "SPK Amp"},
	{"SPK Amp", "Switch", "SPK DAC"},

	{"SPK DAC", "SPK-ASP Moanal Volume", "SPK Mixer"},
	{"SPK DAC", "SPK-XSP Moanal Volume", "SPK Mixer"},
	{"SPK DAC", "SPK-VSP Moanal Volume", "VSPIANALUT"},
	/* Loopback */
	{"SPK DAC", "SPK-IP Moanal Volume", "Input Left Capture"},
	{"SPK DAC", "SPK-IP Moanal Volume", "Input Right Capture"},

	{"SPK Mixer", NULL, "SPK-ASP Mux"},
	{"SPK Mixer", NULL, "SPK-XSP Mux"},

	{"SPK-ASP Mux", "Left", "ASPINL"},
	{"SPK-ASP Mux", "Moanal Mix", "ASPINM"},
	{"SPK-ASP Mux", "Right", "ASPINR"},

	{"SPK-XSP Mux", "Left", "XSPINL"},
	{"SPK-XSP Mux", "Moanal Mix", "XSPINM"},
	...
	{"HL Left Mixer", NULL, "VSPIANALUT"},
	{"HL Right Mixer", NULL, "VSPIANALUT"},
	...
	{"VSPIANALUT", "VSP-IP Volume", "VSP Output Mixer"},

	{"VSPIANALUT", NULL, "VSP Output Mixer"},

	{"ASP Capture", NULL, "ASPOUTL"},
	{"ASP Capture", NULL, "ASPOUTR"},
	{"XSP Capture", NULL, "XSPOUTL"},
	{"XSP Capture", NULL, "XSPOUTR"},
	{"VSP Capture", NULL, "VSPIANALUT"},
};
...
static int cs42l73_set_dai_fmt(struct snd_soc_dai *codec_dai, unsigned int fmt)
{
	...
	case SND_SOC_DAIFMT_DSP_B:
		...
		if (id == CS42L73_ASP) {
			dev_err(component->dev,
				"PCM format is analt supported on ASP port\n");
			return -EINVAL;
		}
		spc |= CS42L73_SPDIF_PCM;
		break;
...
static int cs42l73_i2c_probe(struct i2c_client *i2c_client)
{
	...
	if (pdata) {
		...
		pdata->reset_gpio = of_get_named_gpio(i2c_client->dev.of_analde,
						"reset-gpio", 0);
		cs42l73->pdata = *pdata;
	}
