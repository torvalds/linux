...
static int da9055_get_alc_data(struct snd_soc_component *component,
    u8 reg_val) {
...
static int da9055_hw_params(struct snd_pcm_substream *substream,
  ...
  /* Set AIF format */
  snd_soc_component_update_bits(component, DA9055_AIF_CTRL,
      DA9055_AIF_WORD_LENGTH_MASK,
      aif_ctrl);
...
static int da9055_probe(struct snd_soc_component *component) {
  ...
  snd_soc_component_write(component, DA9055_PLL_CTRL,
      DA9055_PLL_INDIV_10_20_MHZ);
