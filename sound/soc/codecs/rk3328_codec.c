...
static int rk3328_mute_stream(struct snd_soc_dai *dai, int mute,
    int direction) {
  struct rk3328_codec_priv *rk3328
    = snd_soc_component_get_drvdata(dai->component);
  unsigned int val;
...
static int rk3328_codec_power_on(struct rk3328_codec_priv *rk3328,
    int wait_ms) {
...
static int rk3328_codec_power_off(struct rk3328_codec_priv *rk3328,
    int wait_ms) {
  regmap_update_bits(rk3328->regmap, DAC_PRECHARGE_CTRL,
