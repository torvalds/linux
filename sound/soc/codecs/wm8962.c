...
static int wm8962_dsp2_set_enable(struct snd_soc_component *component,
    u16 val) {
...
static int wm8962_dsp2_ena_put(struct snd_kcontrol *kcontrol,
  ...
  int ret = 0;
  int dsp2_running = snd_soc_component_read(component,
...
static const struct snd_kcontrol_new wm8962_snd_controls[] = {
  ...
  SOC_SINGLE("DAC Monomix Switch", WM8962_DAC_DSP_MIXING_1,
      WM8962_DAC_MONOMIX_SHIFT, 1, 0),
  SOC_SINGLE("ADC Monomix Switch", WM8962_THREED1, WM8962_ADC_MONOMIX_SHIFT, 1,
      0),
  ...
  SOC_DOUBLE_R("Headphone ZC Switch", WM8962_HPOUTL_VOLUME,
...
static const struct snd_kcontrol_new wm8962_spk_stereo_controls[] = {
  ...
  SOC_DOUBLE_EXT("Speaker Switch", WM8962_CLASS_D_CONTROL_1, 1, 0, 1, 1,
      snd_soc_get_volsw, wm8962_put_spk_sw),
  SOC_DOUBLE_R("Speaker ZC Switch", WM8962_SPKOUTL_VOLUME,
...
static int wm8962_set_fll(struct snd_soc_component *component, int fll_id,
    int source,
  ...
  snd_soc_component_update_bits(component, WM8962_FLL_CONTROL_1, WM8962_FLL_ENA,
      0);
  switch (fll_id) {
 ...
 */
int wm8962_mic_detect(struct snd_soc_component *component,
    struct snd_soc_jack *jack) {
  struct wm8962_priv *wm8962 = snd_soc_component_get_drvdata(component);
  struct snd_soc_dapm_context *dapm = snd_soc_component_get_dapm(component);
  int irq_mask, enable;
...
static void wm8962_gpio_set(struct gpio_chip *chip, unsigned offset,
    int value) {
  struct wm8962_priv *wm8962 = gpiochip_get_data(chip);
  struct snd_soc_component *component = wm8962->component;
