...
static int aw88399_dev_get_internal_vcalk(struct aw88399 *aw88399,
    int16_t *vcalk) {
  uint16_t vcalkh_val, vcalkl_val, vcalk_val;
  struct aw_device *aw_dev = aw88399->aw_pa;
  unsigned int reg_val;
...
static int aw_dev_set_vcalb(struct aw88399 *aw88399) {
  ...
  switch (vsense_select) {
    case AW88399_DEV_VDSEL_VSENSE:
      ...
      vcalb = AW88399_VCALB_ACCURACY * AW88399_VSCAL_FACTOR
          / AW88399_ISCAL_FACTOR
...
static int aw_dev_update_cali_re(struct aw_cali_desc *cali_desc) {
  ...
  re_hbits = (cali_re & (~AW88399_CALI_RE_HBITS_MASK)) >>
      AW88399_CALI_RE_HBITS_SHIFT;
  re_lbits = (cali_re & (~AW88399_CALI_RE_LBITS_MASK)) >>
      AW88399_CALI_RE_LBITS_SHIFT;
...
static int aw_dev_fw_crc_check(struct aw_device *aw_dev) {
  ...
  check_val = (reg_val & (~AW88399_CRC_CHECK_BITS_MASK)) >>
      AW88399_CRC_CHECK_START_BIT;
...
static int aw_dev_hw_crc_check(struct aw88399 *aw88399) {
  ...
  ret
    = regmap_write(aw_dev->regmap, AW88399_CRCCTRL_REG, aw88399->crc_init_val);
  if (ret) {
    return ret;
  }
  ret = regmap_update_bits(aw_dev->regmap, AW88399_I2SCFG1_REG,
...
static int aw_dev_set_volume(struct aw_device *aw_dev, unsigned int value) {
  ...
  u16 real_value;
  int ret;
  real_value = min((value + vol_desc->init_volume),
      (unsigned int) AW88399_MUTE_VOL);
  ...
  real_value
    = (real_value << AW88399_VOL_START_BIT) | (reg_value & AW88399_VOL_MASK);
...
static int aw_dev_check_sram(struct aw_device *aw_dev) {
  ...
  aw_dev_dsp_write_16bit(aw_dev, AW88399_DSP_CFG_ADDR,
      AW88399_DSP_ODD_NUM_BIT_TEST);
...
static int aw88399_dev_get_prof_name(struct aw_device *aw_dev, int index,
    char **prof_name) {
...
static int aw88399_dev_fw_update(struct aw88399 *aw88399, bool up_dsp_fw_en,
    bool force_up_en) {
  struct aw_device *aw_dev = aw88399->aw_pa;
...
static void aw88399_start_pa(struct aw88399 *aw88399) {
  ...
  for (i = 0; i < AW88399_START_RETRIES; i++) {
    ...
    if (ret) {
      dev_err(aw88399->aw_pa->dev, "aw88399 device start failed. retry = %d",
          i);
...
static int aw88399_profile_set(struct snd_kcontrol *kcontrol,
  ...
  int ret;
  mutex_lock(&aw88399->lock);
  ret = aw88399_dev_set_profile_index(aw88399->aw_pa,
...
static int aw88399_dev_init(struct aw88399 *aw88399,
  ...
  ret = aw88399_dev_fw_update(aw88399, AW88399_FORCE_UPDATE_ON,
      AW88399_DSP_FW_UPDATE_ON);
  if (ret) {
...
static int aw88399_init(struct aw88399 *aw88399, struct i2c_client *i2c,
...
static int aw88399_i2c_probe(struct i2c_client *i2c) {
  ...
  aw88399->reset_gpio = devm_gpiod_get_optional(&i2c->dev, "reset",
      GPIOD_OUT_LOW);
