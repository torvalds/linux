...
void da7219_aad_jack_det(struct snd_soc_component *component,
...
static void da7219_aad_hptest_work(struct work_struct *work) {
  ...
  /* Set gains to 0db */
  snd_soc_component_write(component, DA7219_DAC_L_GAIN,
      DA7219_DAC_DIGITAL_GAIN_0DB);
  snd_soc_component_write(component, DA7219_DAC_R_GAIN,
      DA7219_DAC_DIGITAL_GAIN_0DB);
  ...
  snd_soc_component_update_bits(component, DA7219_DAC_FILTERS1,
      DA7219_HPF_MODE_MASK,
      0);
  snd_soc_component_update_bits(component, DA7219_DAC_FILTERS4,
  ...
  snd_soc_component_write(component, DA7219_TONE_GEN_ON_PER,
  ...
  snd_soc_component_write(component, DA7219_TONE_GEN_CFG1,
...
static enum da7219_aad_micbias_pulse_lvl da7219_aad_fw_micbias_pulse_lvl(
...
static enum da7219_aad_btn_cfg da7219_aad_fw_btn_cfg(struct device *dev,
    u32 val) {
  switch (val) {
    case 2:
...
static enum da7219_aad_mic_det_thr da7219_aad_fw_mic_det_thr(struct device *dev,
    u32 val) {
  switch (val) {
    case 200:
...
static enum da7219_aad_jack_ins_deb da7219_aad_fw_jack_ins_deb(
    struct device *dev, u32 val) {
  switch (val) {
    case 5:
...
static enum da7219_aad_jack_ins_det_pty da7219_aad_fw_jack_ins_det_pty(
    struct device *dev, const char *str) {
  if (!strcmp(str, "low")) {
...
static enum da7219_aad_jack_det_rate da7219_aad_fw_jack_det_rate(
    struct device *dev, const char *str) {
  if (!strcmp(str, "32_64")) {
...
static enum da7219_aad_jack_rem_deb da7219_aad_fw_jack_rem_deb(
    struct device *dev, u32 val) {
  switch (val) {
    case 1:
...
static enum da7219_aad_btn_avg da7219_aad_fw_btn_avg(struct device *dev,
    u32 val) {
  switch (val) {
    case 1:
...
static enum da7219_aad_adc_1bit_rpt da7219_aad_fw_adc_1bit_rpt(
    struct device *dev, u32 val) {
  switch (val) {
    case 1:
...
static void da7219_aad_handle_gnd_switch_time(
