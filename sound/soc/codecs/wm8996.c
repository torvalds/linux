...
static void wm8996_set_retune_mobile(struct snd_soc_component *component,
    int block) {
...
static const struct snd_soc_dapm_widget wm8996_dapm_widgets[] = {
  ...
  SND_SOC_DAPM_PGA_S("HPOUT2L PGA", 0, WM8996_POWER_MANAGEMENT_1, 7, 0, NULL,
      0),
  ...
  SND_SOC_DAPM_PGA_S("HPOUT2R PGA", 0, WM8996_POWER_MANAGEMENT_1, 6, 0, NULL,
      0),
  ...
  SND_SOC_DAPM_PGA_S("HPOUT1L PGA", 0, WM8996_POWER_MANAGEMENT_1, 5, 0, NULL,
      0),
  ...
  SND_SOC_DAPM_PGA_S("HPOUT1R PGA", 0, WM8996_POWER_MANAGEMENT_1, 4, 0, NULL,
      0),
...
static int wm8996_set_fmt(struct snd_soc_dai *dai, unsigned int fmt) {
  ...
  snd_soc_component_update_bits(component, aifctrl_reg, WM8996_AIF1_FMT_MASK,
      aifctrl);
  snd_soc_component_update_bits(component, bclk_reg,
...
static int wm8996_hw_params(struct snd_pcm_substream *substream,
  ...
  switch (dai->id) {
    case 0:
      if (substream->stream == SNDRV_PCM_STREAM_PLAYBACK
          || (snd_soc_component_read(component,
              WM8996_GPIO_1)) & WM8996_GP1_FN_MASK) {
    ...
    case 1:
      if (substream->stream == SNDRV_PCM_STREAM_PLAYBACK
          || (snd_soc_component_read(component,
              WM8996_GPIO_2)) & WM8996_GP2_FN_MASK) {
...
static int wm8996_set_sysclk(struct snd_soc_dai *dai,
  ...
  old
    = snd_soc_component_read(component,
      WM8996_AIF_CLOCKING_1) & WM8996_SYSCLK_ENA;
  ...
  snd_soc_component_update_bits(component, WM8996_CLOCKING_1, WM8996_LFCLK_ENA,
      lfclk);
...
static int wm8996_set_fll(struct snd_soc_component *component, int fll_id,
    int source,
   ...
   * already enabled.
   */
  snd_soc_component_write(component, WM8996_FLL_CONTROL_6,
...
#ifdef CONFIG_GPIOLIB
static void wm8996_gpio_set(struct gpio_chip *chip, unsigned offset,
    int value) {
