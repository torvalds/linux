...
static int da732x_hw_params(struct snd_pcm_substream *substream,
  ...
  snd_soc_component_update_bits(component, DA732X_REG_CLK_CTRL, DA732X_SR1_MASK,
      fs);
  return 0;
}
...
static int da732x_set_dai_fmt(struct snd_soc_dai *dai, u32 fmt) {
  ...
  snd_soc_component_update_bits(component, reg_aif1, DA732X_AIF1_CLK_MASK,
      aif1);
...
static void da732x_dac_offset_adjust(struct snd_soc_component *component) {
  ...
  sign[DA732X_HPL_DAC]
    = (snd_soc_component_read(component, DA732X_REG_HPL_DAC_OFF_CNTL)
      & DA732X_HP_DAC_OFF_CNTL_COMPO);
  sign[DA732X_HPR_DAC]
    = (snd_soc_component_read(component, DA732X_REG_HPR_DAC_OFF_CNTL)
      & DA732X_HP_DAC_OFF_CNTL_COMPO);
...
static void da732x_hp_dc_offset_cancellation(
