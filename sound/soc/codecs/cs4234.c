...
static const struct snd_kcontrol_new cs4234_snd_controls[] = {
  ...
  SOC_SINGLE("DAC5 Soft Ramp Switch", CS4234_DAC_CTRL3, CS4234_DAC5_ATT_SHIFT,
      1, 1),
  SOC_SINGLE("DAC1-4 Soft Ramp Switch", CS4234_DAC_CTRL3,
      CS4234_DAC14_ATT_SHIFT, 1, 1),
  ...
  SOC_SINGLE("ADC1 Invert Switch", CS4234_ADC_CTRL1, CS4234_INV_ADC1_SHIFT, 1,
      0),
  SOC_SINGLE("ADC2 Invert Switch", CS4234_ADC_CTRL1, CS4234_INV_ADC2_SHIFT, 1,
      0),
  SOC_SINGLE("ADC3 Invert Switch", CS4234_ADC_CTRL1, CS4234_INV_ADC3_SHIFT, 1,
      0),
  SOC_SINGLE("ADC4 Invert Switch", CS4234_ADC_CTRL1, CS4234_INV_ADC4_SHIFT, 1,
      0),

  SOC_SINGLE("DAC1 Invert Switch", CS4234_DAC_CTRL2, CS4234_INV_DAC1_SHIFT, 1,
      0),
  SOC_SINGLE("DAC2 Invert Switch", CS4234_DAC_CTRL2, CS4234_INV_DAC2_SHIFT, 1,
      0),
  SOC_SINGLE("DAC3 Invert Switch", CS4234_DAC_CTRL2, CS4234_INV_DAC3_SHIFT, 1,
      0),
  SOC_SINGLE("DAC4 Invert Switch", CS4234_DAC_CTRL2, CS4234_INV_DAC4_SHIFT, 1,
      0),
  SOC_SINGLE("DAC5 Invert Switch", CS4234_DAC_CTRL2, CS4234_INV_DAC5_SHIFT, 1,
      0),
  ...
  SOC_SINGLE("Low-latency Switch", CS4234_DAC_CTRL3, CS4234_MUTE_LL_SHIFT, 1,
      1),
...
static int cs4234_dai_set_fmt(struct snd_soc_dai *codec_dai,
    unsigned int format) {
...
static int cs4234_dai_rule_rate(struct snd_pcm_hw_params *params,
...
static int cs4234_dai_startup(struct snd_pcm_substream *sub,
    struct snd_soc_dai *dai) {
...
static int cs4234_dai_set_tdm_slot(struct snd_soc_dai *dai,
...
static int cs4234_i2c_probe(struct i2c_client *i2c_client) {
  ...
  BUILD_BUG_ON(ARRAY_SIZE(cs4234->core_supplies)
      < ARRAY_SIZE(cs4234_core_supplies));
  ...
  ret = devm_regulator_bulk_get(dev, cs4234->num_core_supplies,
      cs4234->core_supplies);
  if (ret) {
