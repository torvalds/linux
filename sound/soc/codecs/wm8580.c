...
static int wm8580_set_dai_pll(struct snd_soc_dai *codec_dai, int pll_id,
  ...
  snd_soc_component_write(component, WM8580_PLLA2 + offset,
      (pll_div.k >> 9) & 0x1ff);
...
static int wm8580_set_paif_dai_fmt(struct snd_soc_dai *codec_dai,
  ...
  aifa
    = snd_soc_component_read(component, WM8580_PAIF1 + codec_dai->driver->id);
  aifb
    = snd_soc_component_read(component, WM8580_PAIF3 + codec_dai->driver->id);
  ...
  snd_soc_component_write(component, WM8580_PAIF1 + codec_dai->driver->id,
      aifa);
  snd_soc_component_write(component, WM8580_PAIF3 + codec_dai->driver->id,
      aifb);
  return 0;
}
