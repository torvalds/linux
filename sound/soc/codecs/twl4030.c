...
static unsigned int twl4030_read(struct snd_soc_component *component,
    unsigned int reg) {
...
static void twl4030_codec_enable(struct snd_soc_component *component,
    int enable) {
  struct twl4030_priv *twl4030 = snd_soc_component_get_drvdata(component);
  int mode;
...
static struct twl4030_board_params *twl4030_get_board_params(
...
static void twl4030_apll_enable(struct snd_soc_component *component,
    int enable) {
  struct twl4030_priv *twl4030 = snd_soc_component_get_drvdata(component);
  if (enable) {
...
static void handsfree_ramp(struct snd_soc_component *component, int reg,
    int ramp) {
...
static void twl4030_tdm_enable(struct snd_soc_component *component,
    int direction,
    int enable) {
  u8 reg, mask;
...
static void twl4030_voice_enable(struct snd_soc_component *component,
    int direction,
    int enable) {
  u8 reg, mask;
  reg = twl4030_read(component, TWL4030_REG_OPTION);
