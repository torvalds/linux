...
#define AIC31XX_CLKMUX    AIC31XX_REG(0, 4) /* Clock clock Gen muxing,
                                             * Multiplexers*/
...
#define AIC31XX_DOSRMSB   AIC31XX_REG(0, 13) /* DAC OSR setting register 1, MSB
                                              * value */
#define AIC31XX_DOSRLSB   AIC31XX_REG(0, 14) /* DAC OSR setting register 2, LSB
                                              * value */
...
#define AIC31XX_AOSR    AIC31XX_REG(0, 20) /* ADC Oversampling (AOSR) Register
                                            * */
#define AIC31XX_CLKOUTMUX AIC31XX_REG(0, 25) /* Clock setting register 9,
                                              * Multiplexers */
#define AIC31XX_CLKOUTMVAL  AIC31XX_REG(0, 26) /* Clock setting register 10,
                                               * CLOCKOUT M divider value */
#define AIC31XX_IFACE1    AIC31XX_REG(0, 27) /* Audio Interface Setting Register
                                              * 1 */
#define AIC31XX_DATA_OFFSET AIC31XX_REG(0, 28) /* Audio Data Slot Offset
                                                * Programming */
#define AIC31XX_IFACE2    AIC31XX_REG(0, 29) /* Audio Interface Setting Register
                                              * 2 */
#define AIC31XX_BCLKN   AIC31XX_REG(0, 30) /* Clock setting register 11, BCLK N
                                            * Divider */
#define AIC31XX_IFACESEC1 AIC31XX_REG(0, 31) /* Audio Interface Setting Register
                                              * 3, Secondary Audio Interface */
#define AIC31XX_IFACESEC2 AIC31XX_REG(0, 32) /* Audio Interface Setting Register
                                              * 4 */
#define AIC31XX_IFACESEC3 AIC31XX_REG(0, 33) /* Audio Interface Setting Register
                                              * 5 */
...
#define AIC31XX_DACMUTE   AIC31XX_REG(0, 64) /* DAC Mute and volume control
                                              * register */
#define AIC31XX_LDACVOL   AIC31XX_REG(0, 65) /* Left DAC channel digital volume
                                              * control */
#define AIC31XX_RDACVOL   AIC31XX_REG(0, 66) /* Right DAC channel digital volume
                                              * control */
#define AIC31XX_HSDETECT  AIC31XX_REG(0, 67) /* Headset detection */
#define AIC31XX_ADCSETUP  AIC31XX_REG(0, 81) /* ADC Digital Mic */
#define AIC31XX_ADCFGA    AIC31XX_REG(0, 82) /* ADC Digital Volume Control Fine
                                              * Adjust */
#define AIC31XX_ADCVOL    AIC31XX_REG(0, 83) /* ADC Digital Volume Control
                                              * Coarse Adjust */
...
#define AIC31XX_HPPOP   AIC31XX_REG(1, 33) /* HP Output Drivers POP Removal
                                            * Settings */
#define AIC31XX_SPPGARAMP AIC31XX_REG(1, 34) /* Output Driver PGA Ramp-Down
                                              * Period Control */
#define AIC31XX_DACMIXERROUTE AIC31XX_REG(1, 35) /* DAC_L and DAC_R Output Mixer
                                                  * Routing */
...
#define AIC31XX_MICPGAPI  AIC31XX_REG(1, 48) /* Delta-Sigma Mono ADC Channel
                                              * Fine-Gain Input Selection for
                                              * P-Terminal */
#define AIC31XX_MICPGAMI  AIC31XX_REG(1, 49) /* ADC Input Selection for
                                              * M-Terminal */
