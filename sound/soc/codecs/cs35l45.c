...
static const struct snd_soc_dapm_widget cs35l45_dapm_widgets[] = {
  ...
  SND_SOC_DAPM_SUPPLY("GLOBAL_EN", SND_SOC_NOPM, 0, 0,
      ...
      SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
  SND_SOC_DAPM_SUPPLY("ASP_EN", CS35L45_BLOCK_ENABLES2, CS35L45_ASP_EN_SHIFT, 0,
      NULL, 0),
  ...
  SND_SOC_DAPM_SUPPLY("VMON_EN", CS35L45_BLOCK_ENABLES, CS35L45_VMON_EN_SHIFT,
      0, NULL, 0),
  SND_SOC_DAPM_SUPPLY("IMON_EN", CS35L45_BLOCK_ENABLES, CS35L45_IMON_EN_SHIFT,
      0, NULL, 0),
  SND_SOC_DAPM_SUPPLY("TEMPMON_EN", CS35L45_BLOCK_ENABLES,
      CS35L45_TEMPMON_EN_SHIFT, 0, NULL, 0),
  SND_SOC_DAPM_SUPPLY("VDD_BATTMON_EN", CS35L45_BLOCK_ENABLES,
      CS35L45_VDD_BATTMON_EN_SHIFT, 0, NULL, 0),
  SND_SOC_DAPM_SUPPLY("VDD_BSTMON_EN", CS35L45_BLOCK_ENABLES,
      CS35L45_VDD_BSTMON_EN_SHIFT, 0, NULL, 0),
  ...
  SND_SOC_DAPM_AIF_IN("ASP_RX1", NULL, 0, CS35L45_ASP_ENABLES1,
      CS35L45_ASP_RX1_EN_SHIFT, 0),
  SND_SOC_DAPM_AIF_IN("ASP_RX2", NULL, 1, CS35L45_ASP_ENABLES1,
      CS35L45_ASP_RX2_EN_SHIFT, 0),

  SND_SOC_DAPM_AIF_OUT("ASP_TX1", NULL, 0, CS35L45_ASP_ENABLES1,
      CS35L45_ASP_TX1_EN_SHIFT, 0),
  SND_SOC_DAPM_AIF_OUT("ASP_TX2", NULL, 1, CS35L45_ASP_ENABLES1,
      CS35L45_ASP_TX2_EN_SHIFT, 0),
  SND_SOC_DAPM_AIF_OUT("ASP_TX3", NULL, 2, CS35L45_ASP_ENABLES1,
      CS35L45_ASP_TX3_EN_SHIFT, 0),
  SND_SOC_DAPM_AIF_OUT("ASP_TX4", NULL, 3, CS35L45_ASP_ENABLES1,
      CS35L45_ASP_TX4_EN_SHIFT, 0),
...
static int cs35l45_asp_set_fmt(struct snd_soc_dai *codec_dai,
    unsigned int fmt) {
...
static int cs35l45_apply_property_config(struct cs35l45_private *cs35l45) {
  ...
  unsigned int gpio_regs[] = {
    CS35L45_GPIO1_CTRL1, CS35L45_GPIO2_CTRL1,
    CS35L45_GPIO3_CTRL1
  };
  unsigned int pad_regs[] = {
    CS35L45_SYNC_GPIO1,
...
static irqreturn_t cs35l45_dsp_virt2_mbox_cb(int irq, void *data) {
  ...
  if (!ret && mbox_val) {
    cs35l45_dsp_virt2_mbox3_irq_handle(cs35l45,
...
static int cs35l45_initialize(struct cs35l45_private *cs35l45) {
  ...
  ret
    = regmap_bulk_read(cs35l45->regmap, CS35L45_DEVID, dev_id, ARRAY_SIZE(
      dev_id));
  if (ret) {
...
int cs35l45_probe(struct cs35l45_private *cs35l45) {
  ...
  if (cs35l45->irq) {
    ...
    ret = devm_regmap_add_irq_chip(dev, cs35l45->regmap, cs35l45->irq, irq_pol,
        0,
