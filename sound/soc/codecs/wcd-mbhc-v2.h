...
struct wcd_mbhc_cb {
  ...
  bool (*micbias_enable_status)(struct snd_soc_component *component,
      int micb_num);
  ...
  void (*mbhc_moisture_polling_ctrl)(struct snd_soc_component *component,
      bool enable);
  void (*mbhc_moisture_detect_en)(struct snd_soc_component *component,
      bool enable);
};
...
static inline struct wcd_mbhc *wcd_mbhc_init(
...
static inline int wcd_mbhc_event_notify(struct wcd_mbhc *mbhc,
    unsigned long event) {
  return -ENOTSUPP;
}
