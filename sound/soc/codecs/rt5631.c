 ...
 */
static void onebit_depop_power_stage(struct snd_soc_component *component,
    int enable) {
 ...
 */
static void onebit_depop_mute_stage(struct snd_soc_component *component,
    int enable) {
  unsigned int soft_vol, hp_zc;
  /* enable one-bit depop function */
  snd_soc_component_update_bits(component, RT5631_DEPOP_FUN_CTRL_2,
 ...
 */
static void depop_seq_power_stage(struct snd_soc_component *component,
    int enable) {
  unsigned int soft_vol, hp_zc;
 ...
 */
static void depop_seq_mute_stage(struct snd_soc_component *component,
    int enable) {
  unsigned int soft_vol, hp_zc;
  /* depop control by register */
  snd_soc_component_update_bits(component, RT5631_DEPOP_FUN_CTRL_2,
