...
static const struct snd_soc_dapm_widget wm8990_dapm_widgets[] = {
  ...
  /* OUT3MIX */
  SND_SOC_DAPM_MIXER("OUT3MIX", WM8990_POWER_MANAGEMENT_1, WM8990_OUT3_ENA_BIT,
      0,
      &wm8990_dapm_out3mix_controls[0],
      ARRAY_SIZE(wm8990_dapm_out3mix_controls)),

  /* SPKMIX */
  SND_SOC_DAPM_MIXER_E("SPKMIX", WM8990_POWER_MANAGEMENT_1, WM8990_SPK_ENA_BIT,
      0,
  ...
  /* OUT4MIX */
  SND_SOC_DAPM_MIXER("OUT4MIX", WM8990_POWER_MANAGEMENT_1, WM8990_OUT4_ENA_BIT,
      0,
  ...
  /* LOUT PGA */
  SND_SOC_DAPM_PGA("LOUT PGA", WM8990_POWER_MANAGEMENT_1, WM8990_LOUT_ENA_BIT,
      0,
      NULL, 0),

  /* ROUT PGA */
  SND_SOC_DAPM_PGA("ROUT PGA", WM8990_POWER_MANAGEMENT_1, WM8990_ROUT_ENA_BIT,
      0,
      NULL, 0),
...
static int wm8990_probe(struct snd_soc_component *component) {
  ...
  snd_soc_component_write(component, WM8990_LEFT_OUTPUT_VOLUME,
      0x50 | (1 << 8));
  snd_soc_component_write(component, WM8990_RIGHT_OUTPUT_VOLUME,
      0x50 | (1 << 8));
  return 0;
}
