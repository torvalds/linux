...
static int wm8904_set_fll(struct snd_soc_dai *dai, int fll_id, int source,
  ...
  snd_soc_component_update_bits(component, WM8904_FLL_NCO_TEST_1,
      WM8904_FLL_FRC_NCO,
      val);
  snd_soc_component_update_bits(component, WM8904_CONTROL_INTERFACE_TEST_1,
      WM8904_USER_KEY, 0);
  ...
  snd_soc_component_update_bits(component, WM8904_FLL_CONTROL_4,
      WM8904_FLL_N_MASK,
...
static void wm8904_handle_retune_mobile_pdata(
