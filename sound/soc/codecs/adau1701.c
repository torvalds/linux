...
static int adau1701_reset(struct snd_soc_component *component,
    unsigned int clkdiv,
    unsigned int rate) {
...
static int adau1701_mute_stream(struct snd_soc_dai *dai, int mute,
    int direction) {
  struct snd_soc_component *component = dai->component;
...
static int adau1701_i2c_probe(struct i2c_client *client) {
  ...
  adau1701->gpio_pll_mode = devm_gpiod_get_array_optional(dev, "adi,pll-mode",
      GPIOD_OUT_LOW);
