...
#define WSA884X_VTH_TO_REG(vth) \
  ((vth) \
  != 0 ? (((vth) - 150) * WSA884X_PBR_MAX_CODE \
  / (WSA884X_PBR_MAX_VOLTAGE * 100) + 1) : 0)
...
static const struct soc_enum wsa884x_dev_mode_enum
  = SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(wsa884x_dev_mode_text),
    wsa884x_dev_mode_text);
...
static const struct reg_sequence wsa884x_reg_init[] = {
  ...
  { WSA884X_CKWD_CTL_1,
    FIELD_PREP_CONST(WSA884X_CKWD_CTL_1_VPP_SW_CTL_MASK, 0x0)
  ...
  { WSA884X_PA_FSM_CTL1, (0xfe & ~WSA884X_PA_FSM_CTL1_NOISE_GATE_BLOCK_MASK)
    | FIELD_PREP_CONST(WSA884X_PA_FSM_CTL1_NOISE_GATE_BLOCK_MASK, 0x4) }, /* ==
                                                                           * 0xfe
                                                                           * */
  { WSA884X_VBAT_THRM_FLT_CTL,
    (0x7f & ~WSA884X_VBAT_THRM_FLT_CTL_VBAT_COEF_SEL_MASK)
    | FIELD_PREP_CONST(WSA884X_VBAT_THRM_FLT_CTL_VBAT_COEF_SEL_MASK, 0x4) },
  { WSA884X_VBAT_CAL_CTL, FIELD_PREP_CONST(WSA884X_VBAT_CAL_CTL_RESERVE_MASK,
      0x2)
    | FIELD_PREP_CONST(WSA884X_VBAT_CAL_CTL_VBAT_CAL_EN_MASK, 0x1) },
  { WSA884X_BOP_DEGLITCH_CTL, FIELD_PREP_CONST(
      WSA884X_BOP_DEGLITCH_CTL_BOP_DEGLITCH_SETTING_MASK, 0x8)
  ...
  { WSA884X_CDC_SPK_DSM_C_0, FIELD_PREP_CONST(
      WSA884X_CDC_SPK_DSM_C_0_COEF_C3_MASK, 0x6)
    | FIELD_PREP_CONST(WSA884X_CDC_SPK_DSM_C_0_COEF_C2_MASK, 0x8) },
  { WSA884X_CDC_SPK_DSM_C_2, FIELD_PREP_CONST(
      WSA884X_CDC_SPK_DSM_C_2_COEF_C7_MASK, 0xf) },
  { WSA884X_CDC_SPK_DSM_C_3, FIELD_PREP_CONST(
      WSA884X_CDC_SPK_DSM_C_3_COEF_C7_MASK, 0x20) },
  ...
  { WSA884X_DRE_CTL_0,
    FIELD_PREP_CONST(WSA884X_DRE_CTL_0_PROG_DELAY_MASK, 0x7) },
  ...
  { WSA884X_OTP_REG_40, FIELD_PREP_CONST(WSA884X_OTP_REG_40_ISENSE_RESCAL_MASK,
      0x8) },
};
