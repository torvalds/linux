...
/* ALC */
static int da7213_get_alc_data(struct snd_soc_component *component,
    u8 reg_val) {
...
static int da7213_set_auto_pll(struct snd_soc_component *component,
    bool enable) {
  struct da7213_priv *da7213 = snd_soc_component_get_drvdata(component);
  int mode;
...
static enum da7213_micbias_voltage da7213_of_micbias_lvl(
...
static enum da7213_dmic_data_sel da7213_of_dmic_data_sel(
...
static enum da7213_dmic_samplephase da7213_of_dmic_samplephase(
    struct snd_soc_component *component, const char *str) {
...
static enum da7213_dmic_clk_rate da7213_of_dmic_clkrate(
    struct snd_soc_component *component, u32 val) {
  switch (val) {
    case 1500000:
...
static int da7213_probe(struct snd_soc_component *component) {
  ...
  snd_soc_component_write(component, DA7213_TONE_GEN_CYCLES,
