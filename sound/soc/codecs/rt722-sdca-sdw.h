...
static const struct reg_default rt722_sdca_reg_defaults[] = {
  ...
  { SDW_SDCA_CTL(FUNC_NUM_MIC_ARRAY, RT722_SDCA_ENT_USER_FU1E,
    ...
    0x01 },
  { SDW_SDCA_CTL(FUNC_NUM_MIC_ARRAY, RT722_SDCA_ENT_USER_FU1E,
      RT722_SDCA_CTL_FU_MUTE, CH_02),
    0x01 },
  { SDW_SDCA_CTL(FUNC_NUM_MIC_ARRAY, RT722_SDCA_ENT_USER_FU1E,
      RT722_SDCA_CTL_FU_MUTE, CH_03),
    0x01 },
  { SDW_SDCA_CTL(FUNC_NUM_MIC_ARRAY, RT722_SDCA_ENT_USER_FU1E,
  ...
  { SDW_SDCA_CTL(FUNC_NUM_AMP, RT722_SDCA_ENT_CS31,
    ...
    0x09 },
  { SDW_SDCA_CTL(FUNC_NUM_AMP, RT722_SDCA_ENT_USER_FU06, RT722_SDCA_CTL_FU_MUTE,
      CH_L),
    0x01 },
  { SDW_SDCA_CTL(FUNC_NUM_AMP, RT722_SDCA_ENT_USER_FU06, RT722_SDCA_CTL_FU_MUTE,
      CH_R),
  ...
  { SDW_SDCA_CTL(FUNC_NUM_AMP, RT722_SDCA_ENT_PDE23,
      RT722_SDCA_CTL_REQ_POWER_STATE, 0),
    0x03 },
  { SDW_SDCA_CTL(FUNC_NUM_AMP, RT722_SDCA_ENT_OT23, RT722_SDCA_CTL_VENDOR_DEF,
      0), 0x00 },
};
...
static const struct reg_default rt722_sdca_mbq_defaults[] = {
  ...
  { SDW_SDCA_CTL(FUNC_NUM_MIC_ARRAY, RT722_SDCA_ENT_FU15,
    ...
    0x0000 },
  { SDW_SDCA_CTL(FUNC_NUM_MIC_ARRAY, RT722_SDCA_ENT_FU15,
      RT722_SDCA_CTL_FU_CH_GAIN, CH_02),
    0x0000 },
  { SDW_SDCA_CTL(FUNC_NUM_MIC_ARRAY, RT722_SDCA_ENT_FU15,
      RT722_SDCA_CTL_FU_CH_GAIN, CH_03),
    0x0000 },
  { SDW_SDCA_CTL(FUNC_NUM_MIC_ARRAY, RT722_SDCA_ENT_FU15,
      RT722_SDCA_CTL_FU_CH_GAIN, CH_04),
    0x0000 },
  { SDW_SDCA_CTL(FUNC_NUM_AMP, RT722_SDCA_ENT_USER_FU06,
      RT722_SDCA_CTL_FU_VOLUME, CH_L),
    0x0000 },
  { SDW_SDCA_CTL(FUNC_NUM_AMP, RT722_SDCA_ENT_USER_FU06,
      RT722_SDCA_CTL_FU_VOLUME, CH_R),
    0x0000 },
};
