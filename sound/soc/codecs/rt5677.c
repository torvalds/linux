...
static int rt5677_hw_params(struct snd_pcm_substream *substream,
  ...
  if (pre_div < 0) {
    dev_err(component->dev,
        "Unsupported clock setting: sysclk=%dHz lrck=%dHz\n",
...
static int rt5677_update_gpio_bits(struct rt5677_priv *rt5677, unsigned offset,
    int m, int v) {
...
static void rt5677_gpio_set(struct gpio_chip *chip, unsigned offset,
    int value) {
