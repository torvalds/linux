...
static inline int madera_set_fll_clks(struct madera_fll *fll, int base,
    bool ena) {
...
static inline int madera_set_fllao_clks(struct madera_fll *fll, int base,
    bool ena) {
  return madera_set_fll_clks_reg(fll, ena,
...
static inline int madera_set_fllhj_clks(struct madera_fll *fll, int base,
    bool ena) {
  return madera_set_fll_clks_reg(fll, ena,
