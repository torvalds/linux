...
static unsigned int twl6040_read(struct snd_soc_component *component,
    unsigned int reg) {
...
static inline void twl6040_update_dl12_cache(
    struct snd_soc_component *component,
    u8 reg, u8 value) {
  struct twl6040_data *priv = snd_soc_component_get_drvdata(component);
  switch (reg) {
...
static int headset_power_mode(struct snd_soc_component *component,
    int high_perf) {
  int hslctl, hsrctl;
...
int twl6040_get_trim_value(struct snd_soc_component *component,
...
static void twl6040_mute_path(struct snd_soc_component *component,
    enum twl6040_dai_id id,
    int mute) {
  struct twl6040 *twl6040 = to_twl6040(component);
  struct twl6040_data *priv = snd_soc_component_get_drvdata(component);
...
static int twl6040_mute_stream(struct snd_soc_dai *dai, int mute,
    int direction) {
  switch (dai->id) {
