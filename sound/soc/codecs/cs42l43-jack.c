...
static int cs42l43_find_index(struct cs42l43_codec *priv,
...
static void cs42l43_start_hs_bias(struct cs42l43_codec *priv,
    bool type_detect) {
  struct cs42l43 *cs42l43 = priv->core;
...
static void cs42l43_start_load_detect(struct cs42l43_codec *priv) {
  ...
  regmap_update_bits(cs42l43->regmap, CS42L43_DACCNFG2, CS42L43_HP_HPF_EN_MASK,
      0);
  regmap_update_bits(cs42l43->regmap, CS42L43_MIC_DETECT_CONTROL_1,
...
int cs42l43_jack_get(struct snd_kcontrol *kcontrol,
