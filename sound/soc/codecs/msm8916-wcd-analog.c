...
static void pm8916_wcd_analog_micbias_enable(
    struct snd_soc_component *component) {
...
static void pm8916_wcd_setup_mbhc(struct pm8916_wcd_analog_priv *wcd) {
  ...
  if (snd_soc_component_read(component,
      CDC_A_MICB_2_EN) & CDC_A_MICB_2_EN_ENABLE) {
  ...
  snd_soc_component_update_bits(component, CDC_D_INT_EN_SET, int_en_mask,
      int_en_mask);
