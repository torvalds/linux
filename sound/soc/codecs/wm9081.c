...
static int speaker_mode_put(struct snd_kcontrol *kcontrol,
    struct snd_ctl_elem_value *ucontrol) {
  struct snd_soc_component *component = snd_soc_kcontrol_component(kcontrol);
  unsigned int reg_pwr = snd_soc_component_read(component,
      WM9081_POWER_MANAGEMENT);
  unsigned int reg2 = snd_soc_component_read(component,
...
static const struct snd_kcontrol_new wm9081_snd_controls[] = {
  ...
  SOC_ENUM_EXT("Speaker Mode", speaker_mode, speaker_mode_get,
      speaker_mode_put),
};
...
static int wm9081_set_fll(struct snd_soc_component *component, int fll_id,
  ...
  /* Enable the FLL */
  snd_soc_component_write(component, WM9081_FLL_CONTROL_1,
      reg1 | WM9081_FLL_ENA);
...
static int wm9081_set_dai_fmt(struct snd_soc_dai *dai,
  ...
  struct wm9081_priv *wm9081 = snd_soc_component_get_drvdata(component);
  unsigned int aif2
    = snd_soc_component_read(component, WM9081_AUDIO_INTERFACE_2);
...
static int wm9081_set_tdm_slot(struct snd_soc_dai *dai,
  ...
  struct wm9081_priv *wm9081 = snd_soc_component_get_drvdata(component);
  unsigned int aif1
    = snd_soc_component_read(component, WM9081_AUDIO_INTERFACE_1);
