...
static int tas6424_power_off(struct snd_soc_component *component) {
  struct tas6424_data *tas6424 = snd_soc_component_get_drvdata(component);
  int ret;
  snd_soc_component_write(component, TAS6424_CH_STATE_CTRL,
...
static void tas6424_fault_check_work(struct work_struct *work) {
   ...
   */
  if ((reg & TAS6424_FAULT_OC_CH1)
      && !(tas6424->last_cfault & TAS6424_FAULT_OC_CH1)) {
    dev_crit(dev, "experienced a channel 1 overcurrent fault\n");
  }
  if ((reg & TAS6424_FAULT_OC_CH2)
      && !(tas6424->last_cfault & TAS6424_FAULT_OC_CH2)) {
    dev_crit(dev, "experienced a channel 2 overcurrent fault\n");
  }
  if ((reg & TAS6424_FAULT_OC_CH3)
      && !(tas6424->last_cfault & TAS6424_FAULT_OC_CH3)) {
    dev_crit(dev, "experienced a channel 3 overcurrent fault\n");
  }
  if ((reg & TAS6424_FAULT_OC_CH4)
      && !(tas6424->last_cfault & TAS6424_FAULT_OC_CH4)) {
    dev_crit(dev, "experienced a channel 4 overcurrent fault\n");
  }
  if ((reg & TAS6424_FAULT_DC_CH1)
      && !(tas6424->last_cfault & TAS6424_FAULT_DC_CH1)) {
    dev_crit(dev, "experienced a channel 1 DC fault\n");
  }
  if ((reg & TAS6424_FAULT_DC_CH2)
      && !(tas6424->last_cfault & TAS6424_FAULT_DC_CH2)) {
    dev_crit(dev, "experienced a channel 2 DC fault\n");
  }
  if ((reg & TAS6424_FAULT_DC_CH3)
      && !(tas6424->last_cfault & TAS6424_FAULT_DC_CH3)) {
    dev_crit(dev, "experienced a channel 3 DC fault\n");
  }
  if ((reg & TAS6424_FAULT_DC_CH4)
      && !(tas6424->last_cfault & TAS6424_FAULT_DC_CH4)) {
...
check_global_fault1_reg:
  ...
  if ((reg & TAS6424_FAULT_PVDD_OV)
      && !(tas6424->last_fault1 & TAS6424_FAULT_PVDD_OV)) {
    dev_crit(dev, "experienced a PVDD overvoltage fault\n");
  }
  if ((reg & TAS6424_FAULT_VBAT_OV)
      && !(tas6424->last_fault1 & TAS6424_FAULT_VBAT_OV)) {
    dev_crit(dev, "experienced a VBAT overvoltage fault\n");
  }
  if ((reg & TAS6424_FAULT_PVDD_UV)
      && !(tas6424->last_fault1 & TAS6424_FAULT_PVDD_UV)) {
    dev_crit(dev, "experienced a PVDD undervoltage fault\n");
  }
  if ((reg & TAS6424_FAULT_VBAT_UV)
      && !(tas6424->last_fault1 & TAS6424_FAULT_VBAT_UV)) {
...
check_global_fault2_reg:
  ...
  if ((reg & TAS6424_FAULT_OTSD)
      && !(tas6424->last_fault2 & TAS6424_FAULT_OTSD)) {
    dev_crit(dev, "experienced a global overtemp shutdown\n");
  }
  if ((reg & TAS6424_FAULT_OTSD_CH1)
      && !(tas6424->last_fault2 & TAS6424_FAULT_OTSD_CH1)) {
    dev_crit(dev, "experienced an overtemp shutdown on CH1\n");
  }
  if ((reg & TAS6424_FAULT_OTSD_CH2)
      && !(tas6424->last_fault2 & TAS6424_FAULT_OTSD_CH2)) {
    dev_crit(dev, "experienced an overtemp shutdown on CH2\n");
  }
  if ((reg & TAS6424_FAULT_OTSD_CH3)
      && !(tas6424->last_fault2 & TAS6424_FAULT_OTSD_CH3)) {
    dev_crit(dev, "experienced an overtemp shutdown on CH3\n");
  }
  if ((reg & TAS6424_FAULT_OTSD_CH4)
      && !(tas6424->last_fault2 & TAS6424_FAULT_OTSD_CH4)) {
...
check_warn_reg:
  ...
  if ((reg & TAS6424_WARN_VDD_UV)
      && !(tas6424->last_warn & TAS6424_WARN_VDD_UV)) {
    dev_warn(dev, "experienced a VDD under voltage condition\n");
  }
  if ((reg & TAS6424_WARN_VDD_POR)
      && !(tas6424->last_warn & TAS6424_WARN_VDD_POR)) {
    dev_warn(dev, "experienced a VDD POR condition\n");
  }
  if ((reg & TAS6424_WARN_VDD_OTW)
      && !(tas6424->last_warn & TAS6424_WARN_VDD_OTW)) {
    dev_warn(dev, "experienced a global overtemp warning\n");
  }
  if ((reg & TAS6424_WARN_VDD_OTW_CH1)
      && !(tas6424->last_warn & TAS6424_WARN_VDD_OTW_CH1)) {
    dev_warn(dev, "experienced an overtemp warning on CH1\n");
  }
  if ((reg & TAS6424_WARN_VDD_OTW_CH2)
      && !(tas6424->last_warn & TAS6424_WARN_VDD_OTW_CH2)) {
    dev_warn(dev, "experienced an overtemp warning on CH2\n");
  }
  if ((reg & TAS6424_WARN_VDD_OTW_CH3)
      && !(tas6424->last_warn & TAS6424_WARN_VDD_OTW_CH3)) {
    dev_warn(dev, "experienced an overtemp warning on CH3\n");
  }
  if ((reg & TAS6424_WARN_VDD_OTW_CH4)
      && !(tas6424->last_warn & TAS6424_WARN_VDD_OTW_CH4)) {
