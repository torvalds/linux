...
static void rt5682s_apply_patch_list(struct rt5682s_priv *rt5682s,
  ...
  int ret;
  ret
    = regmap_multi_reg_write(rt5682s->regmap, patch_list, ARRAY_SIZE(
      patch_list));
  if (ret) {
...
static void rt5682s_jd_check_handler(struct work_struct *work) {
  ...
  if (snd_soc_component_read(rt5682s->component,
      RT5682S_AJD1_CTRL) & RT5682S_JDH_RS_MASK) {
    /* jack out */
...
static const struct snd_kcontrol_new rt5682s_snd_controls[] = {
  ...
  SOC_DOUBLE_TLV("STO1 ADC Boost Gain Volume", RT5682S_STO1_ADC_BOOST,
      RT5682S_STO1_ADC_L_BST_SFT, RT5682S_STO1_ADC_R_BST_SFT, 3, 0,
      adc_bst_tlv),
};
...
static void rt5682s_set_filter_clk(struct rt5682s_priv *rt5682s, int reg,
    int ref) {
  struct snd_soc_component *component = rt5682s->component;
  int idx;
...
static void rt5682s_set_i2s(struct rt5682s_priv *rt5682s, int id, int on) {
  ...
  if (on && rt5682s->master[id]) {
    ...
    dev_dbg(component->dev,
        "lrck is %dHz and pre_div is %d for iis %d master\n",
...
static const struct snd_soc_dapm_widget rt5682s_dapm_widgets[] = {
  ...
  SND_SOC_DAPM_SUPPLY("DMIC1 Power", RT5682S_DMIC_CTRL_1, RT5682S_DMIC_1_EN_SFT,
      0,
  ...
  /* DACs */
  SND_SOC_DAPM_DAC("DAC L1", NULL, RT5682S_PWR_DIG_1, RT5682S_PWR_DAC_L1_BIT,
      0),
  SND_SOC_DAPM_DAC("DAC R1", NULL, RT5682S_PWR_DIG_1, RT5682S_PWR_DAC_R1_BIT,
      0),
...
static int rt5682s_set_bclk2_ratio(struct snd_soc_dai *dai,
    unsigned int ratio) {
  struct snd_soc_component *component = dai->component;
  struct rt5682s_priv *rt5682s = snd_soc_component_get_drvdata(component);
  rt5682s->bclk[dai->id] = ratio;
...
static int rt5682s_set_bias_level(struct snd_soc_component *component,
  ...
  switch (level) {
    ...
    case SND_SOC_BIAS_OFF:
      regmap_update_bits(rt5682s->regmap, RT5682S_PWR_DIG_1, RT5682S_PWR_LDO,
          0);
      if (!rt5682s->wclk_enabled) {
        regmap_update_bits(rt5682s->regmap, RT5682S_PWR_DIG_1,
