...
static const struct snd_kcontrol_new alc5623_hp_mixer_controls[] = {
  ...
  SOC_DAPM_SINGLE("MIC12HP Playback Switch", ALC5623_MIC_ROUTING_CTRL, 15, 1,
      1),
...
static const struct snd_kcontrol_new alc5623_mono_mixer_controls[] = {
  ...
  SOC_DAPM_SINGLE("MIC12MONO Playback Switch", ALC5623_MIC_ROUTING_CTRL, 13, 1,
      1),
  SOC_DAPM_SINGLE("MIC22MONO Playback Switch", ALC5623_MIC_ROUTING_CTRL, 5, 1,
      1),
...
static const struct snd_kcontrol_new alc5623_speaker_mixer_controls[] = {
  ...
  SOC_DAPM_SINGLE("MIC12SPK Playback Switch", ALC5623_MIC_ROUTING_CTRL, 14, 1,
      1),
  SOC_DAPM_SINGLE("MIC22SPK Playback Switch", ALC5623_MIC_ROUTING_CTRL, 6, 1,
      1),
...
static int alc5623_mute(struct snd_soc_dai *dai, int mute, int direction) {
  ...
  u16 mute_reg
    = snd_soc_component_read(component, ALC5623_MISC_CTRL) & ~hp_mute;
  if (mute) {
    mute_reg |= hp_mute;
  }
