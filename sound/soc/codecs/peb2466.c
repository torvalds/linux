...
static int peb2466_write_buf(struct peb2466 *peb2466, u8 cmd, const u8 *buf,
    unsigned int len) {
  struct spi_transfer xfer = {
    .tx_buf = &peb2466->spi_tx_buf,
    .len = len + 1,
...
static int peb2466_reg_write(void *context, unsigned int reg,
    unsigned int val) {
...
static int peb2466_reg_read(void *context, unsigned int reg,
    unsigned int *val) {
  struct peb2466 *peb2466 = context;
  int ret;
  u8 tmp;
...
static int peb2466_dai_set_tdm_slot(struct snd_soc_dai *dai,
...
static int peb2466_reset_audio(struct peb2466 *peb2466) {
  ...
  static const u8 imr1_p1[8] = {
    0x00, 0x90, 0x09, 0x00, 0x90, 0x09, 0x00, 0x00
  };
  static const u8 imr1_p2[8] = {
    0x7F, 0xFF, 0x00, 0x00, 0x90, 0x14, 0x40, 0x08
  };
  ...
  return regmap_multi_reg_write(peb2466->regmap, reg_reset, ARRAY_SIZE(
      reg_reset));
}
...
static int peb2466_load_coeffs(struct snd_soc_component *component,
    const char *fw_name) {
...
static int peb2466_chip_gpio_update_bits(struct peb2466 *peb2466,
    unsigned int xr_reg,
...
static void peb2466_chip_gpio_set(struct gpio_chip *c, unsigned int offset,
    int val) {
...
static int peb2466_chip_direction_input(struct gpio_chip *c,
    unsigned int offset) {
  struct peb2466 *peb2466 = gpiochip_get_data(c);
  unsigned int xr_reg;
  unsigned int mask;
...
static int peb2466_chip_direction_output(struct gpio_chip *c,
