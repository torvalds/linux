...
static const struct snd_soc_dapm_widget wm8991_dapm_widgets[] = {
  ...
  /* OUT3MIX */
  SND_SOC_DAPM_MIXER("OUT3MIX", WM8991_POWER_MANAGEMENT_1, WM8991_OUT3_ENA_BIT,
      0,
      &wm8991_dapm_out3mix_controls[0],
      ARRAY_SIZE(wm8991_dapm_out3mix_controls)),

  /* SPKMIX */
  SND_SOC_DAPM_MIXER_E("SPKMIX", WM8991_POWER_MANAGEMENT_1, WM8991_SPK_ENA_BIT,
      0,
  ...
  /* OUT4MIX */
  SND_SOC_DAPM_MIXER("OUT4MIX", WM8991_POWER_MANAGEMENT_1, WM8991_OUT4_ENA_BIT,
      0,
  ...
  /* LOUT PGA */
  SND_SOC_DAPM_PGA("LOUT PGA", WM8991_POWER_MANAGEMENT_1, WM8991_LOUT_ENA_BIT,
      0,
      NULL, 0),

  /* ROUT PGA */
  SND_SOC_DAPM_PGA("ROUT PGA", WM8991_POWER_MANAGEMENT_1, WM8991_ROUT_ENA_BIT,
      0,
      NULL, 0),
...
static int wm8991_set_dai_pll(struct snd_soc_dai *codec_dai,
  ...
  if (freq_in && freq_out) {
    ...
    snd_soc_component_write(component, WM8991_CLOCKING_2,
...
static int wm8991_set_bias_level(struct snd_soc_component *component,
  ...
  switch (level) {
    ...
    case SND_SOC_BIAS_OFF:
      ...
      snd_soc_component_write(component, WM8991_DAC_CTRL,
          val | WM8991_DAC_MUTE);
