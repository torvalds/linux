...
#ifdef DEBUG
static void get_current_sample_rates(struct snd_soc_component *component,
    int mclk,
...
static int set_sample_rate_control(struct snd_soc_component *component,
    int mclk,
    u32 sample_rate_adc, u32 sample_rate_dac) {
...
static int tlv320aic23_hw_params(struct snd_pcm_substream *substream,
  ...
  iface_reg
    = snd_soc_component_read(component, TLV320AIC23_DIGT_FMT) & ~(0x03 << 2);
