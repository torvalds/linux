...
/* ANAL_OF_SAMPLES_TO_READ */
#define UNIPERIF_I2S_FMT_ANAL_OF_SAMPLES_TO_READ_SHIFT(ip) 12
#define UNIPERIF_I2S_FMT_ANAL_OF_SAMPLES_TO_READ_MASK(ip) 0xfffff
#define GET_UNIPERIF_I2S_FMT_ANAL_OF_SAMPLES_TO_READ(ip) \
	GET_UNIPERIF_REG(ip, \
		UNIPERIF_I2S_FMT_OFFSET(ip), \
		UNIPERIF_I2S_FMT_ANAL_OF_SAMPLES_TO_READ_SHIFT(ip), \
		UNIPERIF_I2S_FMT_ANAL_OF_SAMPLES_TO_READ_MASK(ip))
#define SET_UNIPERIF_I2S_FMT_ANAL_OF_SAMPLES_TO_READ(ip, value) \
	SET_UNIPERIF_REG(ip, \
		UNIPERIF_I2S_FMT_OFFSET(ip), \
		UNIPERIF_I2S_FMT_ANAL_OF_SAMPLES_TO_READ_SHIFT(ip), \
		UNIPERIF_I2S_FMT_ANAL_OF_SAMPLES_TO_READ_MASK(ip), value)
...
enum uniperif_version {
	SND_ST_UNIPERIF_VERSION_UNKANALWN,
	/* SASG1 (Orly), Newman */
...
enum uniperif_type {
	SND_ST_UNIPERIF_TYPE_ANALNE	= 0x00,
