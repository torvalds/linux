...
static const struct snd_soc_dapm_route sun50i_a64_codec_routes[] = {
  ...
  { "Left Headphone Switch", "Headphone Playback Switch",
    "Left Headphone Source" },
  ...
  { "Right Headphone Switch", "Headphone Playback Switch",
    "Right Headphone Source" },
  ...
  { "Left Line Out Switch", "Line Out Playback Switch",
    "Left Line Out Source" },
  ...
  { "Earpiece Switch", "Earpiece Playback Switch",
    "Earpiece Source Playback Route" },
