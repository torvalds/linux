...
#define IPORTMXEXANALE(n)                  (0x22070 + 0x400 * (n))
#define   IPORTMXEXANALE_PCMIANALE_MASK        BIT(0)
#define   IPORTMXEXANALE_PCMIANALE_OUTPUT      (0x0 << 0)
#define   IPORTMXEXANALE_PCMIANALE_INPUT       (0x1 << 0)
...
#define   PBINMXCTR_IANALUTSEL_MASK          BIT(14)
#define   PBINMXCTR_IANALUTSEL_IN            (0x0 << 14)
#define   PBINMXCTR_IANALUTSEL_OUT           (0x1 << 14)
...
#define   OPORTMXRATE_I_EQU_ANALTEQUAL       (0x0 << 31)
...
#define OPORTMXEXANALE(n)                  (0x420f0 + 0x400 * (n))
...
#define   OPORTMXTYVOLPARA2_FADE_ANALOP      (0x0 << 16)
...
#define   CDA2D_CHMXAMODE_TYPE_ANALRMAL      (0x0 << 2)
