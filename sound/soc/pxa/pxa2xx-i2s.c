...
#define SACR1   (0x0004)  /* Serial Audio I 2 S/MSB-Justified Control Register
                           * */
#define SASR0   (0x000C)  /* Serial Audio I 2 S/MSB-Justified Interface and FIFO
                           * Status Register */
...
#define SADR    (0x0080)  /* Serial Audio Data Register (TX and RX FIFO access
                           * Register). */
...
static int pxa2xx_i2s_hw_params(struct snd_pcm_substream *substream,
  ...
  if (!(SACR0 & SACR0_ENB)) {
    ...
    writel(readl(i2s_reg_base + SACR0) | (SACR0_RFTH(14) | SACR0_TFTH(
        1)), i2s_reg_base + SACR0);
...
static void pxa2xx_i2s_shutdown(struct snd_pcm_substream *substream,
  ...
  if ((readl(i2s_reg_base + SACR1) & (SACR1_DREC | SACR1_DRPL))
...
static int pxa2xx_i2s_probe(struct snd_soc_dai *dai) {
  ...
  writel(readl(
      i2s_reg_base + SAIMR) & (~(SAIMR_RFS | SAIMR_TFS)), i2s_reg_base + SAIMR);
