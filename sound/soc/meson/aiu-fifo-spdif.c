...
/*
static struct snd_soc_dai_driver fifo_spdif_dai_drv = {
	.name = "AIU SPDIF FIFO",
	.playback = {
	...
	.ops		= &fifo_spdif_dai_ops,
	.pcm_new	= aiu_fifo_pcm_new,
};

static const struct snd_soc_component_driver fifo_spdif_component_drv = {
	.probe		= aiu_fifo_component_probe,
	.pointer	= aiu_fifo_pointer,
};

static const struct aiu_fifo_hw fifo_spdif_hw = {
	.fifo_block = 1,
	.mem_offset = AIU_MEM_IEC958_START,
	.pcm = &fifo_spdif_pcm,
};

static const struct aiu_fifo_match_data fifo_spdif_data = {
	.component_drv = &fifo_spdif_component_drv,
	.dai_drv = &fifo_spdif_dai_drv,
	.hw = &fifo_spdif_hw,
};

static const struct of_device_id aiu_fifo_spdif_of_match[] = {
	{
		.compatible = "amlogic,aiu-spdif-fifo",
		.data = &fifo_spdif_data,
	}, {}
};
MODULE_DEVICE_TABLE(of, aiu_fifo_spdif_of_match);

static struct platform_driver aiu_fifo_spdif_pdrv = {
	.probe = aiu_fifo_probe,
	.driver = {
		.name = "meson-aiu-spdif-fifo",
		.of_match_table = aiu_fifo_spdif_of_match,
	},
};
module_platform_driver(aiu_fifo_spdif_pdrv);
