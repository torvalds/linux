...
static struct snd_soc_dapm_widget *meson_codec_glue_get_input(
...
struct meson_codec_glue_input *meson_codec_glue_input_get_data(
...
static struct meson_codec_glue_input *meson_codec_glue_output_get_input_data(
    struct snd_soc_dapm_widget *w) {
  struct snd_soc_dapm_widget *in
