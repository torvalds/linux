...
static int avs_rt5663_codec_init(struct snd_soc_pcm_runtime *runtime) {
  ...
  snd_soc_component_set_jack(snd_soc_rtd_to_codec(runtime,
      0)->component, jack, NULL);
  return 0;
}

static void avs_rt5663_codec_exit(struct snd_soc_pcm_runtime *runtime) {
  snd_soc_component_set_jack(snd_soc_rtd_to_codec(runtime,
      0)->component, NULL, NULL);
}

static int avs_rt5663_be_fixup(struct snd_soc_pcm_runtime *runtime,
