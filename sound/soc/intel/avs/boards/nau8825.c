...
static int avs_nau8825_clock_control(struct snd_soc_dapm_widget *w,
  ...
  if (SND_SOC_DAPM_EVENT_ON(event)) {
    ...
    ret = snd_soc_dai_set_sysclk(codec_dai, NAU8825_CLK_INTERNAL, 0,
        SND_SOC_CLOCK_IN);
  }
  if (ret < 0) {
...
static int avs_nau8825_be_fixup(struct snd_soc_pcm_runtime *runtime,
