...
int avs_ipc_unload_modules(struct avs_dev *adev, u16 *mod_ids,
    u32 num_mod_ids) {
...
static int __avs_ipc_set_large_config(struct avs_dev *adev, u16 module_id,
    u8 instance_id,
...
int avs_ipc_get_modules_info(struct avs_dev *adev,
...
int avs_ipc_probe_get_dma(struct avs_dev *adev, struct avs_probe_dma **dmas,
  ...
  ret = avs_ipc_get_large_config(adev, module_id, AVS_PROBE_INST_ID,
