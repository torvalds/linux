...
static const struct acpi_gpio_params hp_gpios = {
  0, 0, false
};
static const struct acpi_gpio_params mic_gpios = {
  1, 0, false
};
...
#define SOF_CARD_NAME "bytcht max98090" /* card name will be 'sof-bytcht
                                         * max98090 */
