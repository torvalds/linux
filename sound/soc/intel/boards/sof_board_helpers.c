...
EXPORT_SYMBOL_NS(sof_intel_board_card_late_probe,
...
EXPORT_SYMBOL_NS(sof_intel_board_set_dmic_link,
    SND_SOC_INTEL_SOF_BOARD_HELPERS);
...
EXPORT_SYMBOL_NS(sof_intel_board_set_intel_hdmi_link,
    SND_SOC_INTEL_SOF_BOARD_HELPERS);
...
EXPORT_SYMBOL_NS(sof_intel_board_set_hdmi_in_link,
    SND_SOC_INTEL_SOF_BOARD_HELPERS);
