...
static struct catpt_stream_template *catpt_get_stream_template(
...
static snd_pcm_uframes_t catpt_component_pointer(
...
static int catpt_set_dspvol(struct catpt_dev *cdev, u8 stream_id,
    long *ctlvol) {
  u32 dspvol;
  int ret, i;
