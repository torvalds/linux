...
static const struct mt8195_afe_channel_merge *mt8195_afe_found_cm(
...
static int mt8195_afe_paired_memif_clk_prepare(
...
static int mt8195_afe_paired_memif_clk_enable(
    struct snd_pcm_substream *substream,
    struct snd_soc_dai *dai,
    int enable) {
  struct snd_soc_pcm_runtime *rtd = substream->private_data;
...
static int mt8195_afe_pcm_dev_probe(struct platform_device *pdev) {
  ...
  afe_priv->topckgen = syscon_regmap_lookup_by_phandle(dev->of_node,
      "mediatek,topckgen");
