...
static int mt8192_mt6359_cap1_startup(struct snd_pcm_substream *substream) {
...
static int mt8192_mt6359_rt5682_startup(struct snd_pcm_substream *substream) {
  static const unsigned int channels[] = {
    1, 2
  };
  static const struct snd_pcm_hw_constraint_list constraints_channels = {
...
static int mt8192_mt6359_dev_probe(struct platform_device *pdev) {
  ...
  struct device_node *platform_node, *hdmi_codec, *headset_codec,
      *speaker_codec;
  int ret, i;
  ...
  if (!speaker_codec) {
    ...
    dev_err_probe(&pdev->dev, ret,
        "Property 'speaker-codecs' missing or invalid\n");
