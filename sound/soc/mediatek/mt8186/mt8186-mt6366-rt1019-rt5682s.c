...
static int mt8186_rt5682s_init(struct snd_soc_pcm_runtime *rtd) {
  ...
  type = SND_JACK_HEADSET | SND_JACK_BTN_0 | SND_JACK_BTN_1 | SND_JACK_BTN_2
      | SND_JACK_BTN_3;
...
static int mt8186_mt6366_rt1019_rt5682s_playback_startup(
...
static int mt8186_mt6366_rt1019_rt5682s_capture_startup(
    struct snd_pcm_substream *substream) {
  static const unsigned int rates[] = {
    48000
  };
...
static int mt8186_mt6366_rt1019_rt5682s_dev_probe(struct platform_device *pdev)
{
  ...
  for_each_card_prelinks(card, i, dai_link) {
    ret
      = mt8186_mt6366_card_set_be_link(card, dai_link, playback_codec, "I2S3");
    if (ret) {
