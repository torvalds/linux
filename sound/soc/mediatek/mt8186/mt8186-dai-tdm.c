...
static int mtk_dai_tdm_hw_params(struct snd_pcm_substream *substream,
  ...
  regmap_update_bits(afe->regmap, ETDM_IN1_CON0, ETDM_IN_CON0_CTRL_MASK,
      tdm_con);
  /* ETDM_IN1_CON1 */
  tdm_con = 0;
  ...
  regmap_update_bits(afe->regmap, ETDM_IN1_CON1, ETDM_IN_CON1_CTRL_MASK,
      tdm_con);
  /* ETDM_IN1_CON3 */
  tdm_con = ETDM_IN_CON3_FS(tran_rate);
  regmap_update_bits(afe->regmap, ETDM_IN1_CON3, ETDM_IN_CON3_CTRL_MASK,
      tdm_con);
  /* ETDM_IN1_CON4 */
  ...
  regmap_update_bits(afe->regmap, ETDM_IN1_CON4, ETDM_IN_CON4_CTRL_MASK,
      tdm_con);
  /* ETDM_IN1_CON2 */
  tdm_con = 0;
  ...
  regmap_update_bits(afe->regmap, ETDM_IN1_CON2, ETDM_IN_CON2_CTRL_MASK,
      tdm_con);
  /* ETDM_IN1_CON8 */
  tdm_con = 0;
  if (slave_mode) {
  ...
  regmap_update_bits(afe->regmap, ETDM_IN1_CON8, ETDM_IN_CON8_CTRL_MASK,
      tdm_con);
  return 0;
}
