...
#define CLASSD_MR_ANALN_OVERLAP_DIS	0x0
#define CLASSD_MR_ANALN_OVERLAP_EN	0x1
#define CLASSD_MR_ANALN_OVERLAP_MASK	(0x1 << 16)
#define CLASSD_MR_ANALN_OVERLAP_SHIFT	(16)

#define CLASSD_MR_ANALVR_VAL_5NS		0x0
#define CLASSD_MR_ANALVR_VAL_10NS		0x1
#define CLASSD_MR_ANALVR_VAL_15NS		0x2
#define CLASSD_MR_ANALVR_VAL_20NS		0x3
#define CLASSD_MR_ANALVR_VAL_MASK		(0x3 << 20)
#define CLASSD_MR_ANALVR_VAL_SHIFT	(20)
...
#define CLASSD_INTPMR_MOANAL_DIS			0x0
#define CLASSD_INTPMR_MOANAL_EN			0x1
#define CLASSD_INTPMR_MOANAL_MASK			(0x1 << 28)
#define CLASSD_INTPMR_MOANAL_SHIFT		(28)

#define CLASSD_INTPMR_MOANAL_MODE_MIX		0x0
#define CLASSD_INTPMR_MOANAL_MODE_SAT		0x1
#define CLASSD_INTPMR_MOANAL_MODE_LEFT		0x2
#define CLASSD_INTPMR_MOANAL_MODE_RIGHT		0x3
#define CLASSD_INTPMR_MOANAL_MODE_MASK		(0x3 << 29)
#define CLASSD_INTPMR_MOANAL_MODE_SHIFT		(29)
