...
MODULE_PARM_DESC(prealloc_buffer_size_kbytes,
...
/**
 * snd_dmaengine_pcm_prepare_slave_config() - Generic prepare_slave_config
 * callback
...
static int dmaengine_pcm_set_runtime_hwparams(
