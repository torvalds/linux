...
#define soc_component_ret_reg_rw(dai, ret, reg) _soc_component_ret(dai, \
    __func__, \
    ret, reg)
 ...
 */
#define soc_component_mark_push(component, substream, \
      tgt)  ((component)->mark_ ## tgt = substream)
#define soc_component_mark_pop(component, substream, \
      tgt) ((component)->mark_ ## tgt = NULL)
#define soc_component_mark_match(component, substream, \
      tgt) ((component)->mark_ ## tgt == substream)
...
void snd_soc_pcm_component_hw_free(struct snd_pcm_substream *substream,
  ...
  for_each_rtd_components(rtd, i, component) {
    if (rollback
        && !soc_component_mark_match(component, substream, hw_params)) {
      continue;
    }
