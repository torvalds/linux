...
void config_pte_for_stream(struct acp_dev_data *adata,
    struct acp_stream *stream);
void config_acp_dma(struct acp_dev_data *adata, struct acp_stream *stream,
    int size);
...
static inline u64 acp_get_byte_count(struct acp_dev_data *adata, int dai_id,
    int direction) {
