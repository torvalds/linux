...
#define SDW_MAX_BUFFER (SDW_PLAYBACK_MAX_PERIOD_SIZE \
 ...
 * @is_sdw_dev: flag set to true when any SoundWire manager instances are
 * available
 * @is_pdm_dev: flag set to true when ACP PDM controller exists
 * @is_pdm_config: flat set to true when PDM configuration is selected from BIOS
 * @is_sdw_config: flag set to true when SDW configuration is selected from BIOS
 * @sdw_en_stat: flag set to true when any one of the SoundWire manager instance
 * is enabled
 * @addr: pci ioremap address
 * @reg_range: ACP reigister range
 * @sdw0-dma_intr_stat: DMA interrupt status array for SoundWire manager-SW0
 * instance
 * @sdw_dma_intr_stat: DMA interrupt status array for SoundWire manager-SW1
 * instance
 */
