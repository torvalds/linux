 ...
 * For TX/RX streams DMA registers programming for SDW1 instance, it uses
 * ACP_P1_AUDIO1 register
 * set as per hardware register documentation
 */
static struct sdw_dma_ring_buf_reg sdw1_dma_ring_buf_reg[
  ACP63_SDW1_DMA_MAX_STREAMS] = {
  {ACP_P1_AUDIO1_TX_DMA_SIZE, ACP_P1_AUDIO1_TX_FIFOADDR,
   ACP_P1_AUDIO1_TX_FIFOSIZE,
   ACP_P1_AUDIO1_TX_RINGBUFSIZE, ACP_P1_AUDIO1_TX_RINGBUFADDR,
   ACP_P1_AUDIO1_TX_INTR_WATERMARK_SIZE,
   ACP_P1_AUDIO1_TX_LINEARPOSITIONCNTR_LOW,
   ACP_P1_AUDIO1_TX_LINEARPOSITIONCNTR_HIGH},
  {ACP_P1_AUDIO1_RX_DMA_SIZE, ACP_P1_AUDIO1_RX_FIFOADDR,
   ACP_P1_AUDIO1_RX_FIFOSIZE,
   ACP_P1_AUDIO1_RX_RINGBUFSIZE, ACP_P1_AUDIO1_RX_RINGBUFADDR,
   ACP_P1_AUDIO1_RX_INTR_WATERMARK_SIZE,
   ACP_P1_AUDIO1_RX_LINEARPOSITIONCNTR_LOW,
...
static const struct snd_pcm_hardware acp63_sdw_hardware_playback = {
  ...
  .rate_min = 48000,
  .rate_max = 48000,
  .buffer_bytes_max = SDW_PLAYBACK_MAX_NUM_PERIODS
...
static void acp63_enable_disable_sdw_dma_interrupts(void __iomem *acp_base,
    bool enable) {
...
static void acp63_config_dma(struct acp_sdw_dma_stream *stream,
  ...
  /* Group Enable */
  writel(ACP_SDW_SRAM_PTE_OFFSET | BIT(
      31), acp_base + ACPAXI2AXI_ATU_BASE_ADDR_GRP_2);
...
static int acp63_configure_sdw_ringbuffer(void __iomem *acp_base, u32 stream_id,
    u32 size,
  ...
  sdw_ring_buf_addr = sdw_mem_window_offset
      + (stream_id * ACP_SDW_RING_BUFF_ADDR_OFFSET);
...
static int acp63_sdw_dma_hw_params(struct snd_soc_component *component,
  ...
  switch (stream->instance) {
    case ACP_SDW0:
      ...
      water_mark_size_reg
        = sdw0_dma_ring_buf_reg[stream_id].water_mark_size_reg;
...
static u64 acp63_sdw_get_byte_count(struct acp_sdw_dma_stream *stream,
    void __iomem *acp_base) {
