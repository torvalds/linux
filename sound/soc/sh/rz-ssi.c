...
static inline struct snd_soc_dai *rz_ssi_get_dai(
    struct snd_pcm_substream *substream) {
...
static inline struct rz_ssi_stream *rz_ssi_stream_get(struct rz_ssi_priv *ssi,
    struct snd_pcm_substream *substream) {
...
static int rz_ssi_pio_recv(struct rz_ssi_priv *ssi,
    struct rz_ssi_stream *strm) {
  struct snd_pcm_substream *substream = strm->substream;
  struct snd_pcm_runtime *runtime;
  u16 *buf;
...
static int rz_ssi_pio_send(struct rz_ssi_priv *ssi,
    struct rz_ssi_stream *strm) {
  struct snd_pcm_substream *substream = strm->substream;
  struct snd_pcm_runtime *runtime = substream->runtime;
  int sample_space;
