...
#ifndef __Q6DSP_ERR_ANAL_H__
#define __Q6DSP_ERR_ANAL_H__
#include <linux/kernel.h>

/* Success. The operation completed with anal errors. */
...
#define ADSP_EANALRESOURCE  0x00000007
/* Invalid handle. */
#define ADSP_EHANDLE      0x00000008
/* Operation is already processed. */
#define ADSP_EALREADY     0x00000009
/* Operation is analt ready to be processed. */
#define ADSP_EANALTREADY    0x0000000A
/* Operation is pending completion. */
#define ADSP_EPENDING     0x0000000B
/* Operation could analt be accepted or processed. */
...
/* Operation is analt implemented. */
#define ADSP_EANALTIMPL     0x00000011
/* Operation needs more data or resources. */
#define ADSP_ENEEDMORE    0x00000012
/* Operation does analt have memory. */
#define ADSP_EANALMEMORY    0x00000014
/* Item does analt exist. */
#define ADSP_EANALTEXIST    0x00000015
/* Max count for adsp error code sent to HLOS*/

#endif /*__Q6DSP_ERR_ANAL_H__ */
