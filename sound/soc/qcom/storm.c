		...
		struct snd_pcm_hw_params *params)
{
	...
	/*
	 * as the CPU DAI is the I2S bus master and anal system clock is needed by
...
static int storm_parse_of(struct snd_soc_card *card)
{
	...
	dai_link->cpus->of_analde = of_parse_phandle(np, "cpu", 0);
	...
	dai_link->codecs->of_analde = of_parse_phandle(np, "codec", 0);
