...
#define LPASS_HDMITX_APP_IRQSTAT_REG(v)     LPASS_HDMITX_APP_IRQ_REG_ADDR(v, \
    0x8)
#define LPASS_HDMITX_APP_IRQCLEAR_REG(v)    LPASS_HDMITX_APP_IRQ_REG_ADDR(v, \
    0xC)
...
#define LPAIF_HDMI_RDMACTL_REG(v, chan)   LPAIF_HDMI_RDMA_REG_ADDR(v, 0x00, \
    (chan))
#define LPAIF_HDMI_RDMABASE_REG(v, chan)  LPAIF_HDMI_RDMA_REG_ADDR(v, 0x04, \
    (chan))
#define LPAIF_HDMI_RDMABUFF_REG(v, chan)  LPAIF_HDMI_RDMA_REG_ADDR(v, 0x08, \
    (chan))
#define LPAIF_HDMI_RDMACURR_REG(v, chan)  LPAIF_HDMI_RDMA_REG_ADDR(v, 0x0C, \
    (chan))
#define LPAIF_HDMI_RDMAPER_REG(v, chan)   LPAIF_HDMI_RDMA_REG_ADDR(v, 0x10, \
    (chan))
#define LPAIF_HDMI_RDMAPERCNT_REG(v, chan)  LPAIF_HDMI_RDMA_REG_ADDR(v, 0x14, \
    (chan))
...
#define LPAIF_CDC_VA_RDMACTL_REG(v, chan, dai_id) LPAIF_CDC_RDMA_REG_ADDR(v, \
    0x00, \
    (chan), \
    dai_id)
#define LPAIF_CDC_VA_RDMABASE_REG(v, chan, dai_id) LPAIF_CDC_RDMA_REG_ADDR(v, \
    0x04, \
    (chan), \
    dai_id)
#define LPAIF_CDC_VA_RDMABUFF_REG(v, chan, dai_id) LPAIF_CDC_RDMA_REG_ADDR(v, \
    0x08, \
    (chan), \
    dai_id)
#define LPAIF_CDC_VA_RDMACURR_REG(v, chan, dai_id) LPAIF_CDC_RDMA_REG_ADDR(v, \
    0x0C, \
    (chan), \
    dai_id)
#define LPAIF_CDC_VA_RDMAPER_REG(v, chan, dai_id) LPAIF_CDC_RDMA_REG_ADDR(v, \
    0x10, \
    (chan), \
    dai_id)
...
#define __LPAIF_CDC_RDDMA_REG(v, chan, dir, reg, dai_id) \
  (is_rxtx_cdc_dma_port(dai_id) ? LPAIF_CDC_RXTX_RDMA ## reg ## _REG(v, chan, \
    dai_id)   \
  : LPAIF_CDC_VA_RDMA ## reg ## _REG(v, chan, dai_id))

#define __LPAIF_CDC_WRDMA_REG(v, chan, dir, reg, dai_id) \
  (is_rxtx_cdc_dma_port(dai_id) ? LPAIF_CDC_RXTX_WRDMA ## reg ## _REG(v, chan, \
    dai_id)   \
