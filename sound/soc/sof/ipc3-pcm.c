...
static void ssp_dai_config_pcm_params_match(struct snd_sof_dev *sdev,
...
static int sof_ipc3_pcm_dai_link_fixup(struct snd_soc_pcm_runtime *rtd,
  ...
  struct snd_sof_dai *dai = snd_sof_find_dai(component,
  ...
  switch (private->dai_config->type) {
    case SOF_DAI_INTEL_SSP:
      ...
      ssp_dai_config_pcm_params_match(sdev, (char *) rtd->dai_link->name,
          params);
