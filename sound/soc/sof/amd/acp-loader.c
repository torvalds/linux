...
static void configure_pte_for_fw_loading(int type, int num_pages,
    struct acp_dev_data *adata) {
  ...
  snd_sof_dsp_write(sdev, ACP_DSP_BAR, ACPAXI2AXI_ATU_CTRL,
...
int acp_dsp_pre_fw_run(struct snd_sof_dev *sdev) {
  ...
  ret = configure_and_run_sha_dma(adata, adata->bin_buf,
