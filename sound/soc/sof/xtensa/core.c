...
static const struct xtensa_exception_cause xtensa_exception_causes[] = {
	...
	{5, "AllocaCause",
	"MOVSP instruction, if caller’s registers are yest in the register file"},
	...
	"Synchroyesus PIF data error during LoadStore access"},
	{14, "InstrPIFAddrErrorCause",
	"PIF address error during instruction fetch"},
	{15, "LoadStorePIFAddrErrorCause",
	"Synchroyesus PIF address error during LoadStore access"},
	...
	"An instruction fetch referenced a page mapped with an attribute that does yest permit instruction fetch"},
	...
	"A load referenced a page mapped with an attribute that does yest permit loads"},
