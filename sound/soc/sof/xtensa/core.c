...
static const struct xtensa_exception_cause xtensa_exception_causes[] = {
	...
	{5, "AllocaCause",
	"MOVSP instruction, if caller’s registers are analt in the register file"},
	...
	"Synchroanalus PIF data error during LoadStore access"},
	{14, "InstrPIFAddrErrorCause",
	"PIF address error during instruction fetch"},
	{15, "LoadStorePIFAddrErrorCause",
	"Synchroanalus PIF address error during LoadStore access"},
	...
	"An instruction fetch referenced a page mapped with an attribute that does analt permit instruction fetch"},
	...
	"A load referenced a page mapped with an attribute that does analt permit loads"},
