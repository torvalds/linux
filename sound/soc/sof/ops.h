...
static inline int snd_sof_dsp_parse_platform_ext_manifest(
 ...
 */
static inline int snd_sof_dsp_get_bar_index(struct snd_sof_dev *sdev,
    u32 type) {
...
/* host stream hw free */
static inline int snd_sof_pcm_platform_hw_free(struct snd_sof_dev *sdev,
    struct snd_pcm_substream *substream) {
...
/* host stream trigger */
static inline int snd_sof_pcm_platform_trigger(struct snd_sof_dev *sdev,
...
static inline int snd_sof_set_stream_data_offset(struct snd_sof_dev *sdev,
    struct snd_sof_pcm_stream *sps,
    size_t posn_offset) {
...
/* host stream pointer */
static inline snd_pcm_uframes_t snd_sof_pcm_platform_pointer(
    struct snd_sof_dev *sdev,
    struct snd_pcm_substream *substream) {
...
static inline void snd_sof_machine_unregister(struct snd_sof_dev *sdev,
    void *pdata) {
...
static inline struct snd_soc_acpi_mach *snd_sof_machine_select(
    struct snd_sof_dev *sdev) {
...
static inline void snd_sof_set_mach_params(struct snd_soc_acpi_mach *mach,
    struct snd_sof_dev *sdev) {
...
static inline bool snd_sof_is_chain_dma_supported(struct snd_sof_dev *sdev,
    u32 dai_type) {
 ...
 */
#define snd_sof_dsp_read_poll_timeout(sdev, bar, offset, val, cond, sleep_us, \
      timeout_us) \
  ({ \
