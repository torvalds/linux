...
snd_pcm_uframes_t hda_dsp_pcm_pointer(struct snd_sof_dev *sdev,
    struct snd_pcm_substream *substream);
int hda_dsp_pcm_ack(struct snd_sof_dev *sdev,
    struct snd_pcm_substream *substream);
...
static inline void hda_codec_jack_wake_enable(struct snd_sof_dev *sdev,
    bool enable) {
}
...
static inline bool hda_codec_check_rirb_status(struct snd_sof_dev *sdev) {
  return false;
}

static inline void hda_codec_set_codec_wakeup(struct snd_sof_dev *sdev,
    bool status) {
}
...
static inline int hda_codec_i915_init(struct snd_sof_dev *sdev) {
  return 0;
}

static inline int hda_codec_i915_exit(struct snd_sof_dev *sdev) {
  return 0;
}
...
static inline void hda_common_enable_sdw_irq(struct snd_sof_dev *sdev,
    bool enable) {
}
...
#define SOF_HDA_POSITION_QUIRK_USE_DPIB_REGISTERS (1) /* recommended if VC0 only
                                                       * */
#define SOF_HDA_POSITION_QUIRK_USE_DPIB_DDR_UPDATE  (2) /* recommended with VC0
                                                         * or VC1 */
...
/**
 * struct hda_dai_widget_dma_ops - DAI DMA ops optional by default unless
 * specified otherwise
 * @get_hext_stream: Mandatory function pointer to get the saved pointer to
 ...
 * @calc_stream_format: Function pointer to determine stream format from
 * hw_params and
 * for HDaudio codec DAI from the .sig bits
 * @get_hlink: Mandatory function pointer to retrieve hlink, mainly to program
 * LOSIDV
...
struct hda_dai_widget_dma_ops {
  ...
  struct hdac_ext_stream *(*assign_hext_stream)(struct snd_sof_dev *sdev,
      struct snd_soc_dai *cpu_dai,
      struct snd_pcm_substream *substream);
  void (*release_hext_stream)(struct snd_sof_dev *sdev,
      struct snd_soc_dai *cpu_dai,
      struct snd_pcm_substream *substream);
  void (*setup_hext_stream)(struct snd_sof_dev *sdev,
      struct hdac_ext_stream *hext_stream,
      unsigned int format_val);
  void (*reset_hext_stream)(struct snd_sof_dev *sdev,
      struct hdac_ext_stream *hext_sream);
