 ...
 * @skip_during_fe_trigger: skip triggering this pipeline during the FE DAI
 * trigger
 */
 ...
 * @pipeline_instance_ids: Flexible array of IDs of the pipelines to be
 * triggered
 */
 ...
 *
 * This structure can be used for both output or input pins and the pin_index is
 * relative to the
 ...
 * @config_length: Length of gateway node configuration blob specified in
 *#config_data
...
/**
 * struct sof_ipc4_base_module_cfg_ext - base module config extension containing
 * the pin format
 * information for the module. Both @num_input_pin_fmts and @num_output_pin_fmts
 * cannot be 0 for a
 * module.
 ...
 * @reserved: reserved for future use
 * @pin_formats: flexible array consisting of @num_input_pin_fmts input pin
 * format items followed
