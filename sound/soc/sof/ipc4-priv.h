 ...
 * @id: Library ID. 0 is reserved for basefw, external libraries must have
 * unique
 ...
 * @num_playback_streams: max number of playback DMAs, needed for CHAIN_DMA
 * offset
 ...
 * @pipeline_state_mutex: Mutex to protect pipeline triggers, ref counts, states
 * and deletion
 */
struct sof_ipc4_fw_data {
  ...
  struct mutex pipeline_state_mutex; /* protect pipeline triggers, ref counts
                                      * and states */
};
...
struct sof_ipc4_fw_module *sof_ipc4_find_module_by_uuid(
