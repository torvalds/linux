 ...
 * NOTIFY indicates that the notifier signalling end of transfer is being
 * written.
...
/*
 * The Audio DMA engine uses 128-byte transfers, thus the address must be
 * aligned
...
/*
 * The TARGET field specifies the memory space containing the destination
 * address
