...
static void exclusive_note_off(struct snd_emux *emu, struct snd_emux_port *port,
    int exclass);
static void terminate_voice(struct snd_emux *emu, struct snd_emux_voice *vp,
    int free);
static void update_voice(struct snd_emux *emu, struct snd_emux_voice *vp,
    int update);
 ...
 * Start a note.
 */
void snd_emux_note_on(void *p, int note, int vel,
 ...
 */
void snd_emux_note_off(void *p, int note, int vel,
    struct snd_midi_channel *chan) {
  int ch;
  struct snd_emux *emu;
  struct snd_emux_voice *vp;
 ...
 * key pressure change
 */
void snd_emux_key_press(void *p, int note, int vel,
    struct snd_midi_channel *chan) {
  int ch;
  struct snd_emux *emu;
  struct snd_emux_voice *vp;
...
static const unsigned char pan_volumes[256] = {
  ,
...
static int calc_volume(struct snd_emux_voice *vp) {
  ...
  if (port->port_mode == SNDRV_EMUX_PORT_MODE_OSS_SYNTH) {
    ...
    main_vol = chan->control[MIDI_CTL_MSB_MAIN_VOLUME] * vp->reg.amplitude
        / 127;
