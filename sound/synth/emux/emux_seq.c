...
static int snd_emux_use(void *private_data,
    struct snd_seq_port_subscribe *info);
static int snd_emux_unuse(void *private_data,
    struct snd_seq_port_subscribe *info);
 ...
 */
static void free_port(void *private_data) {
  struct snd_emux_port *p;
  p = private_data;
  if (p) {
#ifdef SNDRV_EMUX_USE_RAW_EFFECT
 ...
 */
int snd_emux_event_input(struct snd_seq_event *ev, int direct,
    void *private_data,
    int atomic, int hop) {
 ...
 */
static int __snd_emux_inc_count(struct snd_emux *emu) {
  emu->used++;
 ...
 */
static void __snd_emux_dec_count(struct snd_emux *emu) {
