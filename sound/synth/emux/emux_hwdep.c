 ...
 * load patch
 */
static int snd_emux_hwdep_load_patch(struct snd_emux *emu, void __user *arg) {
  int err;
 ...
 * set misc mode
 */
static int snd_emux_hwdep_misc_mode(struct snd_emux *emu, void __user *arg) {
 ...
 * ioctl
 */
static int snd_emux_hwdep_ioctl(struct snd_hwdep *hw, struct file *file,
