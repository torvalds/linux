...
#define I2S_SF_MCLKDIV_OTHER(div)  (((div / 2 - 1) << \
    I2S_SF_MCLKDIV_SHIFT) & I2S_SF_MCLKDIV_MASK)
static inline int i2s_sf_mclkdiv(int div, int *out) {
  int d;
  switch (div) {
    case 1:
      *out |= I2S_SF_MCLKDIV_1;
      return 0;
    case 3:
      *out |= I2S_SF_MCLKDIV_3;
      return 0;
    case 5:
      *out |= I2S_SF_MCLKDIV_5;
      return 0;
    case 14:
      *out |= I2S_SF_MCLKDIV_14;
      return 0;
    default:
      if (div % 2) {
        return -1;
...
#define I2S_SF_SCLKDIV_OTHER(div)  (((div / 2 - 1) << \
    I2S_SF_SCLKDIV_SHIFT) & I2S_SF_SCLKDIV_MASK)
static inline int i2s_sf_sclkdiv(int div, int *out) {
  int d;
  switch (div) {
    case 1:
      *out |= I2S_SF_SCLKDIV_1;
      return 0;
    case 3:
      *out |= I2S_SF_SCLKDIV_3;
      return 0;
    default:
      if (div % 2) {
        return -1;
