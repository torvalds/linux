...
/* return 0 on success */
extern int aoa_codec_register(struct aoa_codec *codec);
extern void aoa_codec_unregister(struct aoa_codec *codec);
...
extern int aoa_fabric_register(struct aoa_fabric *fabric, struct device *dev);

/* it is vital to call this when the fabric exits!
 * When calling, the remove_codec will be called
 * for all codecs, unless it is NULL. */
extern void aoa_fabric_unregister(struct aoa_fabric *fabric);
...
extern void aoa_fabric_unlink_codec(struct aoa_codec *codec);
