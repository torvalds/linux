...
#define SOUNDFORMAT_FREQ_8000   0x00 | SOUNDFORMAT_XTAL1 /* also 0x0e |
                                                          * SOUNDFORMAT_XTAL1?
                                                          * */
#define SOUNDFORMAT_FREQ_9600   0x08 | SOUNDFORMAT_XTAL1
#define SOUNDFORMAT_FREQ_11025    0x00 | SOUNDFORMAT_XTAL2 /* also 0x0e |
                                                            * SOUNDFORMAT_XTAL2?
                                                            * */
#define SOUNDFORMAT_FREQ_SUSPECTED_13240  0x08 | SOUNDFORMAT_XTAL2 /* seems to
                                                                    * be 6620 *2
                                                                    * */
...
#define SOUNDFORMAT_FREQ_SUSPECTED_66200  0x06 | SOUNDFORMAT_XTAL2 /* 66200
                                                                   * (13240 *
                                                                   * 5); 64000
                                                                   * may have
                                                                   * been nicer
...
#define MIXER_ADVCTL1_HIFI3D_MASK 0x0300 /* yup, this is missing the high bit
                                         * that official AC97 contains, plus it
                                         * doesn't have linear bit value range
                                         * behaviour but instead acts weirdly
                                         * (possibly we're dealing with two
                                         * *different* 3D settings here??) */
#define IDX_MIXER_ADVCTL2       0x20 /* subset of AC97_GENERAL_PURPOSE reg! */
/* unlisted bits are unmodifiable */
#define MIXER_ADVCTL2_LPBK    0x0080 /* Loopback mode -- Win driver:
                                      * "WaveOut3DBypass"? mutes WaveOut at
                                      * LineOut */
#define MIXER_ADVCTL2_MS    0x0100 /* Mic Select 0=Mic1, 1=Mic2 -- Win driver:
                                    * "ModemOutSelect"?? */
#define MIXER_ADVCTL2_MIX   0x0200 /* Mono output select 0=Mix, 1=Mic; Win
                                    * driver: "MonoSelectSource"?? */
