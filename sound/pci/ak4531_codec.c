...
static void snd_ak4531_proc_init(struct snd_card *card,
...
static int snd_ak4531_put_single(struct snd_kcontrol *kcontrol,
    struct snd_ctl_elem_value *ucontrol) {
  struct snd_ak4531 *ak4531 = snd_kcontrol_chip(kcontrol);
  int reg = kcontrol->private_value & 0xff;
  int shift = (kcontrol->private_value >> 16) & 0x07;
...
#define AK4531_DOUBLE(xname, xindex, left_reg, right_reg, left_shift, \
      right_shift, mask, invert) \
  { .iface = SNDRV_CTL_ELEM_IFACE_MIXER, .name = xname, .index = xindex, \
    ...
    .private_value = left_reg \
        ...
        8) \
        | (left_shift << \
        16) | (right_shift << 19) | (mask << 24) | (invert << 22) }
#define AK4531_DOUBLE_TLV(xname, xindex, left_reg, right_reg, left_shift, \
      right_shift, mask, invert, xtlv) \
  { .iface = SNDRV_CTL_ELEM_IFACE_MIXER, \
    .access = SNDRV_CTL_ELEM_ACCESS_READWRITE | SNDRV_CTL_ELEM_ACCESS_TLV_READ, \
    .name = xname, .index = xindex, \
    .info = snd_ak4531_info_double, \
...
static int snd_ak4531_get_double(struct snd_kcontrol *kcontrol,
    struct snd_ctl_elem_value *ucontrol) {
  struct snd_ak4531 *ak4531 = snd_kcontrol_chip(kcontrol);
...
static int snd_ak4531_put_double(struct snd_kcontrol *kcontrol,
    struct snd_ctl_elem_value *ucontrol) {
  struct snd_ak4531 *ak4531 = snd_kcontrol_chip(kcontrol);
  int left_reg = kcontrol->private_value & 0xff;
  int right_reg = (kcontrol->private_value >> 8) & 0xff;
  ...
  if (left_reg == right_reg) {
    left
      = (ak4531->regs[left_reg]
        & ~((mask << left_shift) | (mask << right_shift))) | left | right;
...
#define AK4531_INPUT_SW(xname, xindex, reg1, reg2, left_shift, right_shift) \
  { .iface = SNDRV_CTL_ELEM_IFACE_MIXER, .name = xname, .index = xindex, \
    ...
    .private_value = reg1 \
        | (reg2 << 8) | (left_shift << 16) | (right_shift << 24) }
...
static int snd_ak4531_get_input_sw(struct snd_kcontrol *kcontrol,
    struct snd_ctl_elem_value *ucontrol) {
  struct snd_ak4531 *ak4531 = snd_kcontrol_chip(kcontrol);
...
static int snd_ak4531_put_input_sw(struct snd_kcontrol *kcontrol,
    struct snd_ctl_elem_value *ucontrol) {
  struct snd_ak4531 *ak4531 = snd_kcontrol_chip(kcontrol);
  int reg1 = kcontrol->private_value & 0xff;
  int reg2 = (kcontrol->private_value >> 8) & 0xff;
...
static const struct snd_kcontrol_new snd_ak4531_controls[] = {
  AK4531_DOUBLE_TLV("Master Playback Switch", 0,
      ...
      db_scale_master),
  AK4531_DOUBLE("Master Playback Volume", 0, AK4531_LMASTER, AK4531_RMASTER, 0,
      0, 0x1f, 1),
  ...
  AK4531_DOUBLE_TLV("PCM Volume", 0, AK4531_LVOICE, AK4531_RVOICE, 0, 0, 0x1f,
      1,
      db_scale_input),
  AK4531_DOUBLE("PCM Playback Switch", 0, AK4531_OUT_SW2, AK4531_OUT_SW2, 3, 2,
      1, 0),
  AK4531_DOUBLE("PCM Capture Switch", 0, AK4531_LIN_SW2, AK4531_RIN_SW2, 2, 2,
      1, 0),

  AK4531_DOUBLE("PCM Switch", 1, AK4531_LFM, AK4531_RFM, 7, 7, 1, 1),
  AK4531_DOUBLE_TLV("PCM Volume", 1, AK4531_LFM, AK4531_RFM, 0, 0, 0x1f, 1,
      db_scale_input),
  AK4531_DOUBLE("PCM Playback Switch", 1, AK4531_OUT_SW1, AK4531_OUT_SW1, 6, 5,
      1, 0),
  ...
  AK4531_DOUBLE_TLV("CD Volume", 0, AK4531_LCD, AK4531_RCD, 0, 0, 0x1f, 1,
      db_scale_input),
  AK4531_DOUBLE("CD Playback Switch", 0, AK4531_OUT_SW1, AK4531_OUT_SW1, 2, 1,
      1, 0),
  ...
  AK4531_DOUBLE_TLV("Line Volume", 0, AK4531_LLINE, AK4531_RLINE, 0, 0, 0x1f, 1,
      db_scale_input),
  AK4531_DOUBLE("Line Playback Switch", 0, AK4531_OUT_SW1, AK4531_OUT_SW1, 4, 3,
      1, 0),
  AK4531_INPUT_SW("Line Capture Route", 0, AK4531_LIN_SW1, AK4531_RIN_SW1, 4,
      3),
  ...
  AK4531_DOUBLE_TLV("Aux Volume", 0, AK4531_LAUXA, AK4531_RAUXA, 0, 0, 0x1f, 1,
      db_scale_input),
  AK4531_DOUBLE("Aux Playback Switch", 0, AK4531_OUT_SW2, AK4531_OUT_SW2, 5, 4,
      1, 0),
  ...
  AK4531_DOUBLE("Mono Capture Switch", 0, AK4531_LIN_SW2, AK4531_RIN_SW2, 0, 0,
      1, 0),
  ...
  AK4531_DOUBLE("Mono Capture Switch", 1, AK4531_LIN_SW2, AK4531_RIN_SW2, 1, 1,
      1, 0),
  ...
  AK4531_DOUBLE("Mic Capture Switch", 0, AK4531_LIN_SW1, AK4531_RIN_SW1, 0, 0,
      1, 0),

  AK4531_DOUBLE("Mic Bypass Capture Switch", 0, AK4531_LIN_SW2, AK4531_RIN_SW2,
      7, 7, 1, 0),
  AK4531_DOUBLE("Mono1 Bypass Capture Switch", 0, AK4531_LIN_SW2,
      AK4531_RIN_SW2, 6, 6, 1, 0),
  AK4531_DOUBLE("Mono2 Bypass Capture Switch", 0, AK4531_LIN_SW2,
      AK4531_RIN_SW2, 5, 5, 1, 0),
...
int snd_ak4531_mixer(struct snd_card *card,
  ...
  *ak4531 = *_ak4531;
  ...
  udelay(100);
  ak4531->write(ak4531, AK4531_CLOCK, 0x00);  /* CODEC ADC and CODEC DAC use
                                               * {LR,B}CLK2 and run off LRCLK2
                                               * PLL */
  for (idx = 0; idx <= 0x19; idx++) {
