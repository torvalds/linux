...
#ifndef writel_be
#define writel_be(data, addr) __raw_writel((__force u32) cpu_to_be32(data), \
    addr)
#endif
...
#ifndef writel_le
#define writel_le(data, addr) __raw_writel((__force u32) cpu_to_le32(data), \
    addr)
#endif
...
#define MSG_OUTBOUND_FREE_STACK     0x10C000    /* stack of free enveloped for
                                                 * EMB */
#define MSG_INBOUND_FREE_STACK      0x100000    /* stack of free enveloped for
                                                 * DRV */
...
#define MSG_FROM_AGENT_ITMF_OFFSET  (MSG_FRAME_OFFSET \
  + (MSG_FRAME_SIZE * MSG_FRAME_NUMBER))
#define MSG_TO_AGENT_ITMF_OFFSET    (MSG_FROM_AGENT_ITMF_OFFSET \
  + MSG_FRAME_SIZE)
...
#define MIXART_PCI_OMIMR_OFFSET                 0x34    /* outbound message
                                                         * interrupt mask
                                                         * register */
#define MIXART_PCI_OMISR_OFFSET                 0x30    /* outbound message
                                                         * interrupt status
                                                         * register */
#define MIXART_PCI_ODBR_OFFSET                  0x60    /* outbound doorbell
                                                         * register */

#define MIXART_BA1_BRUTAL_RESET_OFFSET          0x68    /* write 1 in LSBit to
                                                         * reset board */
