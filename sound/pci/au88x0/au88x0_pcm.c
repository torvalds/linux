...
/* hw_params callback */
static int snd_vortex_pcm_hw_params(struct snd_pcm_substream *substream,
...
/* trigger callback */
static int snd_vortex_pcm_trigger(struct snd_pcm_substream *substream,
    int cmd) {
  vortex_t *chip = snd_pcm_substream_chip(substream);
  stream_t *stream = (stream_t *) substream->runtime->private_data;
  int dma = stream->dma;
...
/* pointer callback */
static snd_pcm_uframes_t snd_vortex_pcm_pointer(
...
static int snd_vortex_spdif_info(struct snd_kcontrol *kcontrol,
...
static int snd_vortex_spdif_mask_get(struct snd_kcontrol *kcontrol,
