...
// (see "Management of Cards and Components")
static int snd_vortex_create(struct snd_card *card, struct pci_dev *pci) {
...
static int __snd_vortex_probe(struct pci_dev *pci,
...
static int snd_vortex_probe(struct pci_dev *pci,
    const struct pci_device_id *pci_id) {
