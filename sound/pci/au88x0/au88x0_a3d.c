...
static void a3dsrc_SetTimeConsts(a3dsrc_t *a, short HrtfTrack, short ItdTrack,
...
#if 0
static void a3dsrc_GetTimeConsts(a3dsrc_t *a, short *HrtfTrack, short *ItdTrack,
    short *GTrack, short *CTrack) {
  // stub!
}
...
static void a3dsrc_SetAtmosTarget(a3dsrc_t *a, short aa, short b, short c,
    short d,
    short e) {
  vortex_t *vortex = (vortex_t *) (a->vortex);
  hwwrite(vortex->mmio,
...
static void a3dsrc_SetAtmosCurrent(a3dsrc_t *a, short aa, short b, short c,
    short d,
    short e) {
  vortex_t *vortex = (vortex_t *) (a->vortex);
  hwwrite(vortex->mmio,
...
static void a3dsrc_SetAtmosState(a3dsrc_t *a, short x1, short x2, short y1,
    short y2) {
  vortex_t *vortex = (vortex_t *) (a->vortex);
...
#if 0
static void a3dsrc_GetAtmosTarget(a3dsrc_t *a, short *aa, short *b, short *c,
    short *d, short *e) {
}

static void a3dsrc_GetAtmosCurrent(a3dsrc_t *a, short *bb01, short *ab01,
    short *b2,
...
static void a3dsrc_GetAtmosState(a3dsrc_t *a, short *x1, short *x2, short *y1,
    short *y2) {
}
...
static void a3dsrc_SetHrtfTarget(a3dsrc_t *a, a3d_Hrtf_t const aa,
    a3d_Hrtf_t const b) {
  vortex_t *vortex = (vortex_t *) (a->vortex);
  int i;
  for (i = 0; i < HRTF_SZ; i++) {
...
static void a3dsrc_SetHrtfCurrent(a3dsrc_t *a, a3d_Hrtf_t const aa,
    a3d_Hrtf_t const b) {
  vortex_t *vortex = (vortex_t *) (a->vortex);
  int i;
  for (i = 0; i < HRTF_SZ; i++) {
...
static void a3dsrc_SetHrtfState(a3dsrc_t *a, a3d_Hrtf_t const aa,
    a3d_Hrtf_t const b) {
  vortex_t *vortex = (vortex_t *) (a->vortex);
  int i;
  for (i = 0; i < HRTF_SZ; i++) {
...
static void CA3dIO_WriteReg(a3dsrc_t *a, unsigned long addr, short aa,
    short b) {
  vortex_t *vortex = (vortex_t *) (a->vortex);
...
static int snd_vortex_a3d_hrtf_info(struct snd_kcontrol *kcontrol,
...
static int snd_vortex_a3d_itd_info(struct snd_kcontrol *kcontrol,
    struct snd_ctl_elem_info *uinfo) {
  uinfo->type = SNDRV_CTL_ELEM_TYPE_INTEGER;
  uinfo->count = 2;
  uinfo->value.integer.min = 0x00000000;
...
static int snd_vortex_a3d_ild_info(struct snd_kcontrol *kcontrol,
    struct snd_ctl_elem_info *uinfo) {
  uinfo->type = SNDRV_CTL_ELEM_TYPE_INTEGER;
  uinfo->count = 2;
  uinfo->value.integer.min = 0x00000000;
...
static int snd_vortex_a3d_filter_info(struct snd_kcontrol *kcontrol,
    struct snd_ctl_elem_info *uinfo) {
  uinfo->type = SNDRV_CTL_ELEM_TYPE_INTEGER;
  uinfo->count = 4;
  uinfo->value.integer.min = 0x00000000;
...
static int snd_vortex_a3d_hrtf_put(struct snd_kcontrol *kcontrol,
    struct snd_ctl_elem_value *ucontrol) {
  a3dsrc_t *a = kcontrol->private_data;
  int i;
  int coord[6];
...
static int snd_vortex_a3d_itd_put(struct snd_kcontrol *kcontrol,
    struct snd_ctl_elem_value *ucontrol) {
  a3dsrc_t *a = kcontrol->private_data;
  int coord[6];
  int i;
...
static int snd_vortex_a3d_ild_put(struct snd_kcontrol *kcontrol,
    struct snd_ctl_elem_value *ucontrol) {
  a3dsrc_t *a = kcontrol->private_data;
  int l, r;
...
static int snd_vortex_a3d_filter_put(struct snd_kcontrol *kcontrol,
    struct snd_ctl_elem_value *ucontrol) {
  a3dsrc_t *a = kcontrol->private_data;
  int i;
  int params[6];
