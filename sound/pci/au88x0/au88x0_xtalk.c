...
/*
 * XTalk EQ and XT*/
static void vortex_XtalkHw_SetLeftEQ(vortex_t *vortex, short arg_0, short arg_4,
...
static void vortex_XtalkHw_SetRightEQ(vortex_t *vortex, short arg_0,
    short arg_4,
    xtalk_coefs_t const coefs) {
  int i;
  for (i = 0; i < 5; i++) {
...
static void vortex_XtalkHw_SetLeftXT(vortex_t *vortex, short arg_0, short arg_4,
    xtalk_coefs_t const coefs) {
  int i;
  for (i = 0; i < 5; i++) {
...
static void vortex_XtalkHw_SetRightXT(vortex_t *vortex, short arg_0,
    short arg_4,
    xtalk_coefs_t const coefs) {
  int i;
  for (i = 0; i < 5; i++) {
...
static void vortex_XtalkHw_SetLeftEQStates(vortex_t *vortex,
...
static void vortex_XtalkHw_SetRightEQStates(vortex_t *vortex,
    xtalk_instate_t const arg_0,
    xtalk_state_t const coefs) {
  int i;
  for (i = 0; i < 5; i++) {
...
static void vortex_XtalkHw_SetLeftXTStates(vortex_t *vortex,
    xtalk_instate_t const arg_0,
    xtalk_state_t const coefs) {
  int i;
  for (i = 0; i < 5; i++) {
...
static void vortex_XtalkHw_SetRightXTStates(vortex_t *vortex,
    xtalk_instate_t const arg_0,
    xtalk_state_t const coefs) {
  int i;
  for (i = 0; i < 5; i++) {
...
#if 0
static void vortex_XtalkHw_GetLeftEQ(vortex_t *vortex, short *arg_0,
    short *arg_4,
    xtalk_coefs_t coefs) {
  int i;
  for (i = 0; i < 5; i++) {
...
static void vortex_XtalkHw_GetRightEQ(vortex_t *vortex, short *arg_0,
    short *arg_4,
    xtalk_coefs_t coefs) {
  int i;
  for (i = 0; i < 5; i++) {
...
static void vortex_XtalkHw_GetLeftXT(vortex_t *vortex, short *arg_0,
    short *arg_4,
    xtalk_coefs_t coefs) {
  int i;
  for (i = 0; i < 5; i++) {
...
static void vortex_XtalkHw_GetRightXT(vortex_t *vortex, short *arg_0,
    short *arg_4,
    xtalk_coefs_t coefs) {
  int i;
  for (i = 0; i < 5; i++) {
...
static void vortex_XtalkHw_GetLeftEQStates(vortex_t *vortex,
...
static void vortex_XtalkHw_GetRightEQStates(vortex_t *vortex,
    xtalk_instate_t arg_0,
    xtalk_state_t coefs) {
  int i;
  for (i = 0; i < 5; i++) {
...
static void vortex_XtalkHw_GetLeftXTStates(vortex_t *vortex,
    xtalk_instate_t arg_0,
    xtalk_state_t coefs) {
  int i;
  for (i = 0; i < 5; i++) {
...
static void vortex_XtalkHw_GetRightXTStates(vortex_t *vortex,
    xtalk_instate_t arg_0,
    xtalk_state_t coefs) {
  int i;
  for (i = 0; i < 5; i++) {
...
static void vortex_XtalkHw_SetDelay(vortex_t *vortex, unsigned short right,
    unsigned short left) {
  u32 esp0 = 0;
  esp0 &= 0x1FFFFFFF;
  esp0 |= 0xA0000000;
...
static void vortex_XtalkHw_SetLeftDline(vortex_t *vortex,
    xtalk_dline_t const dline) {
  int i;
  for (i = 0; i < 0x20; i++) {
...
static void vortex_XtalkHw_SetRightDline(vortex_t *vortex,
    xtalk_dline_t const dline) {
  int i;
  for (i = 0; i < 0x20; i++) {
...
#if 0
static void vortex_XtalkHw_GetDelay(vortex_t *vortex, unsigned short *right,
    unsigned short *left) {
  int esp0;
...
static void vortex_XtalkHw_GetRightDline(vortex_t *vortex,
    xtalk_dline_t dline) {
  int i;
  for (i = 0; i < 0x20; i++) {
    dline[i]
...
static void vortex_XtalkHw_ProgramXtalkNarrow(vortex_t *vortex) {
  ...
  vortex_XtalkHw_SetRightXT(vortex, sXtalkNarrowKLeftXt,
      sXtalkNarrowShiftLeftXt,
      asXtalkNarrowCoefsLeftXt);
  vortex_XtalkHw_SetDelay(vortex, wXtalkNarrowRightDelay,
      wXtalkNarrowLeftDelay); // inlined
}
