...
#define a3d_addrA(slice, source, \
      reg) (((slice) << 0xd) + ((source) * 0x3A4) + (reg))
#define a3d_addrB(slice, source, \
      reg) (((slice) << 0xd) + ((source) * 0x2C8) + (reg))
#define a3d_addrS(slice, reg) (((slice) << 0xd) + (reg))
//#define a3d_addr(slice,source,reg) (((reg)>=0x19000) ?
// a3d_addr2((slice),(source),(reg)) : a3d_addr1((slice),(source),(reg)))
