...
/*
* ******************************************************************************************************
* Audigy2 P16V pointer-offset register set, accessed through the PTR2 and DATA2
* registers
********************************************************************************************************/
 ...
 */
#define PLAYBACK_LIST_SIZE  0x01    /* Size of list in bytes << 16. E.g. 8
                                     * periods -> 0x00380000  */
#define PLAYBACK_LIST_PTR 0x02    /* Pointer to the current period being played
                                   * */
#define PLAYBACK_UNKNOWN3 0x03    /* Not used */
#define PLAYBACK_DMA_ADDR 0x04    /* Playback DMA address */
#define PLAYBACK_PERIOD_SIZE  0x05    /* Playback period size. win2000 uses
                                       * 0x04000000 */
#define PLAYBACK_POINTER  0x06    /* Playback period pointer. Used with
                                   * PLAYBACK_LIST_PTR to determine buffer
                                   * position currently in DAC */
#define PLAYBACK_FIFO_END_ADDRESS 0x07    /* Playback FIFO end address */
#define PLAYBACK_FIFO_POINTER 0x08    /* Playback FIFO pointer and number of
                                       * valid sound samples in cache */
#define PLAYBACK_UNKNOWN9 0x09    /* Not used */
#define CAPTURE_DMA_ADDR  0x10    /* Capture DMA address */
#define CAPTURE_BUFFER_SIZE 0x11    /* Capture buffer size */
#define CAPTURE_POINTER   0x12    /* Capture buffer pointer. Sample currently in
                                   * ADC */
#define CAPTURE_FIFO_POINTER  0x13    /* Capture FIFO pointer and number of
                                       * valid sound samples in cache */
...
#define PLAYBACK_LAST_SAMPLE    0x20    /* The sample currently being played.
                                         * Read only */
/* 0x21 - 0x3f unused */
#define BASIC_INTERRUPT         0x40    /* Used by both playback and capture
                                         * interrupt handler */
...
#define PLAYBACK_VOLUME_MIXER1  0x61    /* SRC48 Low to mixer input volume
                                         * control. */
#define PLAYBACK_VOLUME_MIXER2  0x62    /* SRC48 High to mixer input volume
                                         * control. */
#define PLAYBACK_VOLUME_MIXER3  0x63    /* SRCMULTI SPDIF Low to mixer input
                                         * volume control. */
#define PLAYBACK_VOLUME_MIXER4  0x64    /* SRCMULTI SPDIF High to mixer input
                                         * volume control. */
#define PLAYBACK_VOLUME_MIXER5  0x65    /* SRCMULTI I2S Low to mixer input
                                         * volume control. */
#define PLAYBACK_VOLUME_MIXER6  0x66    /* SRCMULTI I2S High to mixer input
                                         * volume control. */
#define PLAYBACK_VOLUME_MIXER7  0x67    /* P16V Low to SRCMULTI SPDIF mixer
                                         * input volume control. */
#define PLAYBACK_VOLUME_MIXER8  0x68    /* P16V High to SRCMULTI SPDIF mixer
                                         * input volume control. */
#define PLAYBACK_VOLUME_MIXER9  0x69    /* P16V Low to SRCMULTI I2S mixer input
                                         * volume control. */
/* 0xXXXX3030 = PCM0 Volume (Front).
 * 0x3030XXXX = PCM1 Volume (Center)
 */
#define PLAYBACK_VOLUME_MIXER10  0x6a   /* P16V High to SRCMULTI I2S mixer input
                                         * volume control. */
/* 0x3030XXXX = PCM3 Volume (Rear). */
#define PLAYBACK_VOLUME_MIXER11  0x6b   /* E10K2 Low to SRC48 mixer input volume
                                         * control. */
#define PLAYBACK_VOLUME_MIXER12 0x6c    /* E10K2 High to SRC48 mixer input
                                         * volume control. */
 ...
 */
#define SRCMULTI_ENABLE         0x6e            /* SRCMulti input audio enable.
                                                 * Default 0xffffffff */
/* SRCMulti converts 48khz samples rates to 44.1, 48, 96, 192 to 48. */
