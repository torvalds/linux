...
#define I2C_A_ADC_TRANS_MASK  0x00000010    /*Bit mask for I2c address DAC value
                                             *  */
#define I2C_A_ADC_ABORT_MASK  0x00000020  /*Bit mask for I2C transaction abort
                                           * flag */
...
#define ADC_TIMEOUT_DISABLE 0x00000008  //Value and mask to disable Timeout
                                        // clock
#define ADC_HPF_DISABLE   0x00000100  //Value and mask to disable High pass
                                      // filter
...
#define P17V_SRCSel   0x60  /* SRC48 and SRCMulti sample rate select
                             * and output select
                             */
#define P17V_MIXER_AC97_10K1_VOL_L  0x61  /* 10K to Mixer_AC97 input volume
                                           * control */
#define P17V_MIXER_AC97_10K1_VOL_H  0x62  /* 10K to Mixer_AC97 input volume
                                           * control */
#define P17V_MIXER_AC97_P17V_VOL_L  0x63  /* P17V to Mixer_AC97 input volume
                                           * control */
#define P17V_MIXER_AC97_P17V_VOL_H  0x64  /* P17V to Mixer_AC97 input volume
                                           * control */
#define P17V_MIXER_AC97_SRP_REC_VOL_L 0x65  /* SRP Record to Mixer_AC97 input
                                             * volume control */
#define P17V_MIXER_AC97_SRP_REC_VOL_H 0x66  /* SRP Record to Mixer_AC97 input
                                             * volume control */
/* 67 - 68: Reserved */
#define P17V_MIXER_Spdif_10K1_VOL_L 0x69  /* 10K to Mixer_Spdif input volume
                                           * control */
#define P17V_MIXER_Spdif_10K1_VOL_H 0x6A  /* 10K to Mixer_Spdif input volume
                                           * control */
#define P17V_MIXER_Spdif_P17V_VOL_L 0x6B  /* P17V to Mixer_Spdif input volume
                                           * control */
#define P17V_MIXER_Spdif_P17V_VOL_H 0x6C  /* P17V to Mixer_Spdif input volume
                                           * control */
#define P17V_MIXER_Spdif_SRP_REC_VOL_L  0x6D  /* SRP Record to Mixer_Spdif input
                                               * volume control */
#define P17V_MIXER_Spdif_SRP_REC_VOL_H  0x6E  /* SRP Record to Mixer_Spdif input
                                               * volume control */
/* 6f - 70: Reserved */
...
#define P17V_MIXER_I2S_10K1_VOL_H 0x72  /* 10K to Mixer_I2S input volume control
                                         * */
#define P17V_MIXER_I2S_P17V_VOL_L 0x73  /* P17V to Mixer_I2S input volume
                                         * control */
#define P17V_MIXER_I2S_P17V_VOL_H 0x74  /* P17V to Mixer_I2S input volume
                                         * control */
#define P17V_MIXER_I2S_SRP_REC_VOL_L  0x75  /* SRP Record to Mixer_I2S input
                                             * volume control */
#define P17V_MIXER_I2S_SRP_REC_VOL_H  0x76  /* SRP Record to Mixer_I2S input
                                             * volume control */
/* 77 - 78: Reserved */
...
#define P17V_I2S_CHANNEL_SWAP_PHASE_INVERSE 0x88  /* I2S out mono channel swap
                                                   * and phase inverse */
#define P17V_SPDIF_CHANNEL_SWAP_PHASE_INVERSE 0x89  /* SPDIF out mono channel
                                                     * swap
                                                     * and phase inverse */
/* 8A: Not used */
#define P17V_SRP_P17V_ESR   0x8B  /* SRP_P17V estimated sample rate and rate
                                   * lock */
