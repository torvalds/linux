...
static void mpu401_clear_rx(struct snd_emu10k1 *emu,
...
static void do_emu10k1_midi_interrupt(struct snd_emu10k1 *emu,
...
static void snd_emu10k1_midi_interrupt(struct snd_emu10k1 *emu,
    unsigned int status) {
  do_emu10k1_midi_interrupt(emu, &emu->midi, status);
}

static void snd_emu10k1_midi_interrupt2(struct snd_emu10k1 *emu,
    unsigned int status) {
  do_emu10k1_midi_interrupt(emu, &emu->midi2, status);
}

static int snd_emu10k1_midi_cmd(struct snd_emu10k1 *emu,
    struct snd_emu10k1_midi *midi,
...
static int snd_emu10k1_midi_input_open(struct snd_rawmidi_substream *substream)
{
  ...
  struct snd_emu10k1_midi *midi
    = (struct snd_emu10k1_midi *) substream->rmidi->private_data;
  emu = midi->emu;
  if (snd_BUG_ON(!emu)) {
    return -ENXIO;
  }
...
static int snd_emu10k1_midi_output_close(
...
static void snd_emu10k1_midi_output_trigger(
    struct snd_rawmidi_substream *substream, int up) {
  struct snd_emu10k1 *emu;
  struct snd_emu10k1_midi *midi
    = (struct snd_emu10k1_midi *) substream->rmidi->private_data;
...
static int emu10k1_midi_init(struct snd_emu10k1 *emu,
    struct snd_emu10k1_midi *midi, int device,
    char *name) {
