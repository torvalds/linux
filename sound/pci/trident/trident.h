...
#define TRIDENT_DEVICE_ID_DX    ((PCI_VENDOR_ID_TRIDENT << \
    16) | PCI_DEVICE_ID_TRIDENT_4DWAVE_DX)
#define TRIDENT_DEVICE_ID_NX    ((PCI_VENDOR_ID_TRIDENT << \
    16) | PCI_DEVICE_ID_TRIDENT_4DWAVE_NX)
#define TRIDENT_DEVICE_ID_SI7018  ((PCI_VENDOR_ID_SI << \
    16) | PCI_DEVICE_ID_SI_7018)
...
struct snd_trident_voice {
  ...
  struct snd_trident_voice *extra;  /* extra PCM voice (acts as interrupt
                                     * generator) */
