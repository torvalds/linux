...
typedef void (*hda_jack_callback_fn)(struct hda_codec *,
    struct hda_jack_callback *);
...
struct hda_jack_tbl {
  ...
  unsigned int block_report : 1;    /* in a transitional state - do not report
                                     * to userspace */
 ...
 */
static inline struct hda_jack_tbl *snd_hda_jack_tbl_get(struct hda_codec *codec,
    hda_nid_t nid) {
 ...
 */
static inline struct hda_jack_callback *snd_hda_jack_detect_enable_callback(
    struct hda_codec *codec, hda_nid_t nid,
 ...
 */
static inline int snd_hda_jack_detect_state(struct hda_codec *codec,
    hda_nid_t nid) {
 ...
 */
static inline int snd_hda_jack_add_kctl(struct hda_codec *codec, hda_nid_t nid,
