...
static void add_auto_cfg_input_pin(struct hda_codec *codec,
...
int snd_hda_parse_pin_defcfg(struct hda_codec *codec,
  ...
  if (cond_flags & HDA_PINCFG_HEADSET_MIC
      || cond_flags & HDA_PINCFG_HEADPHONE_MIC) {
...
/**
 * snd_hda_pick_fixup - Pick up a fixup matching with PCI/codec SSID or model
 * string
 * @codec: the HDA codec
