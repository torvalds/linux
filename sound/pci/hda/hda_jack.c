 ...
 */
struct hda_jack_tbl *snd_hda_jack_tbl_get_mst(struct hda_codec *codec,
...
static struct hda_jack_tbl *any_jack_tbl_get_from_nid(struct hda_codec *codec,
    hda_nid_t nid) {
  struct hda_jack_tbl *jack = codec->jacktbl.list;
  int i;
  if (!nid || !jack) {
 ...
 * @dev_id: pin device entry id
 */
static struct hda_jack_tbl *snd_hda_jack_tbl_new(struct hda_codec *codec,
    hda_nid_t nid, int dev_id) {
...
static struct hda_jack_callback *find_callback_from_list(
    struct hda_jack_tbl *jack,
