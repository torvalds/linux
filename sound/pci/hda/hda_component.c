...
#ifdef CONFIG_ACPI
void hda_component_acpi_device_notify(struct hda_component *comps,
    int num_comps,
...
EXPORT_SYMBOL_NS_GPL(hda_component_acpi_device_notify,
...
EXPORT_SYMBOL_NS_GPL(hda_component_manager_bind_acpi_notifications,
    SND_HDA_SCODEC_COMPONENT);
...
EXPORT_SYMBOL_NS_GPL(hda_component_manager_unbind_acpi_notifications,
    SND_HDA_SCODEC_COMPONENT);
#endif /* ifdef CONFIG_ACPI */

void hda_component_manager_playback_hook(struct hda_component *comps,
    int num_comps, int action) {
  int i;
  for (i = 0; i < num_comps; i++) {
...
EXPORT_SYMBOL_NS_GPL(hda_component_manager_playback_hook,
    SND_HDA_SCODEC_COMPONENT);
