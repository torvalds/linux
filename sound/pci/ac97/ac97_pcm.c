...
static int set_spdif_rate(struct snd_ac97 *ac97, unsigned short rate) {
  ...
  if (ac97->flags & AC97_CS_SPDIF) {
    ...
    switch (rate) {
      case 44100:
        bits = AC97_SC_SPSR_44K;
        break;
      case 48000:
        bits = AC97_SC_SPSR_48K;
        break;
      case 32000:
        bits = AC97_SC_SPSR_32K;
        break;
      default: /* invalid - disable output */
        snd_ac97_update_bits(ac97, AC97_EXTENDED_STATUS, AC97_EA_SPDIF, 0);
        return -EINVAL;
  ...
  if (old != bits) {
    ...
    if (sbits & IEC958_AES0_PROFESSIONAL) {
      ...
      switch (rate) {
        case 44100:
          sbits |= IEC958_AES0_PRO_FS_44100;
          break;
        case 48000:
          sbits |= IEC958_AES0_PRO_FS_48000;
          break;
        case 32000:
          sbits |= IEC958_AES0_PRO_FS_32000;
          break;
      }
    } else {
      ...
      switch (rate) {
        case 44100:
          sbits |= IEC958_AES3_CON_FS_44100 << 24;
          break;
        case 48000:
          sbits |= IEC958_AES3_CON_FS_48000 << 24;
          break;
        case 32000:
          sbits |= IEC958_AES3_CON_FS_32000 << 24;
          break;
      }
    }
...
static unsigned short get_pslots(struct snd_ac97 *ac97,
  ...
  if (ac97_is_rev22(ac97) || ac97_can_amap(ac97)) {
    ...
    if (ac97_is_rev22(ac97)) {
      ...
      switch (ac97->addr) {
        case 1:
        case 2:
          es |= (1 << AC97_EI_DACS_SLOT_SHIFT);
          break;
        case 3:
          es |= (2 << AC97_EI_DACS_SLOT_SHIFT);
          break;
      }
...
static unsigned int get_rates(struct ac97_pcm *pcm, unsigned int cidx,
    unsigned short slots, int dbl) {
  int i, idx;
  ...
  for (i = 3; i < 12; i++) {
    ...
    switch (reg) {
      case AC97_PCM_FRONT_DAC_RATE:
        idx = AC97_RATES_FRONT_DAC;
        break;
      case AC97_PCM_SURR_DAC_RATE:
        idx = AC97_RATES_SURR_DAC;
        break;
      case AC97_PCM_LFE_DAC_RATE:
        idx = AC97_RATES_LFE_DAC;
        break;
      case AC97_PCM_LR_ADC_RATE:
        idx = AC97_RATES_ADC;
        break;
      case AC97_PCM_MIC_ADC_RATE:
        idx = AC97_RATES_MIC_ADC;
        break;
      default:
        idx = AC97_RATES_SPDIF;
        break;
    }
