...
static int src_rsc_init(struct src *src, u32 idx,
...
static int get_src_rsc(struct src_mgr *mgr, const struct src_desc *desc,
    struct src **rsrc) {
...
static int srcimp_map(struct srcimp *srcimp, struct src *src,
    struct rsc *input) {
