...
static int hw20k2_i2c_unlock_full_access(struct hw *hw) {
  u8 UnlockKeySequence_FLASH_FULLACCESS_MODE[2] = {
    0xB3, 0xD4
  };
...
static int hw20k2_i2c_init(struct hw *hw, u8 dev_id, u8 addr_size,
    u8 data_size) {
...
/* ADC operations */
#define MAKE_WM8775_ADDR(addr, \
      data)  (u32) (((addr << 1) & 0xFE) | ((data >> 8) & 0x1))
