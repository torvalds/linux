...
MODULE_AUTHOR(
    "Jaroslav Kysela <perex@perex.cz>, Thomas Sailer <sailer@ife.ee.ethz.ch>");
MODULE_LICENSE("GPL");
#ifdef CHIP1370
...
#define   ES_1373_TEST_BIT  (1 << 28)   /* should be set to 0 for normal
                                         * operation */
#define   ES_1373_RECEN_B (1 << 27)   /* mix record with playback for I2S/SPDIF
                                       * out */
#define   ES_1373_SPDIF_THRU  (1 << 26)   /* 0 = SPDIF thru mode, 1 = SPDIF ==
                                           * dig out */
...
#define   ES_1371_GPIO_IN(i)  (((i) >> 20) & 0x0f) /* GPIO in [3:0] pins - R/O
                                                    * */
#define   ES_1370_PCLKDIVO(o) (((o) & 0x1fff) << 16) /* clock divide ratio for
                                                      * DAC2 */
#define   ES_1370_PCLKDIVM  ((0x1fff) << 16)  /* mask for above */
#define   ES_1370_PCLKDIVI(i) (((i) >> 16) & 0x1fff) /* clock divide ratio for
                                                      * DAC2 */
#define   ES_1371_GPIO_OUT(o) (((o) & 0x0f) << 16) /* GPIO out [3:0] pins - W/R
                                                    * */
#define   ES_1371_GPIO_OUTM     (0x0f << 16)  /* mask for above */
#define   ES_MSFMTSEL   (1 << 15)   /* MPEG serial data format; 0 = SONY, 1 =
                                     * I2S */
#define   ES_1370_M_SBB   (1 << 14)   /* clock source for DAC - 0 = clock
                                       * generator; 1 = MPEG clocks */
#define   ES_1371_SYNC_RES  (1 << 14)   /* Warm AC97 reset */
#define   ES_1370_WTSRSEL(o)  (((o) & 0x03) << 12) /* fixed frequency clock for
                                                    * DAC1 */
#define   ES_1370_WTSRSELM  (0x03 << 12)  /* mask for above */
#define   ES_1371_ADC_STOP  (1 << 13)   /* disable CCB transfer capture
                                         * information */
#define   ES_1371_PWR_INTRM (1 << 12)   /* power level change interrupts enable
                                         * */
#define   ES_1370_DAC_SYNC  (1 << 11)   /* DAC's are synchronous */
#define   ES_1371_M_CB    (1 << 11)   /* capture clock source; 0 = AC'97 ADC; 1
                                       * = I2S */
...
#define   ES_1373_REAR_BIT27  (1 << 27)   /* rear bits: 000 - front, 010 -
                                           * mirror, 101 - separate */
#define   ES_1373_REAR_BIT26  (1 << 26)
#define   ES_1373_REAR_BIT24  (1 << 24)
#define   ES_1373_GPIO_INT_EN(o) (((o) & 0x0f) << 20) /* GPIO [3:0] pins -
                                                       * interrupt enable */
#define   ES_1373_SPDIF_EN  (1 << 18)   /* SPDIF enable */
#define   ES_1373_SPDIF_TEST  (1 << 17)   /* SPDIF test */
#define   ES_1371_TEST          (1 << 16)   /* test ASIC */
#define   ES_1373_GPIO_INT(i) (((i) & 0x0f) >> 12) /* GPIO [3:0] pins -
                                                    * interrupt pending */
#define   ES_1370_CSTAT   (1 << 10)   /* CODEC is busy or register write in
                                       * progress */
...
#define   ES_1371_SYNC_ERR  (1 << 8)    /* CODEC synchronization error occurred
                                         * */
#define   ES_1371_VC(i)         (((i) >> 6) & 0x03) /* voice code from CCB
                                                     * module */
...
#define   ES_1371_CODEC_PIRD     (1 << 23)  /* codec read/write select register
                                             * */
#define   ES_1371_CODEC_WRITE(a, \
      d) ((((a) & 0x7f) << 16) | (((d) & 0xffff) << 0))
#define   ES_1371_CODEC_READS(a)   ((((a) & 0x7f) << 16) | ES_1371_CODEC_PIRD)
#define   ES_1371_CODEC_READ(i)    (((i) >> 0) & 0xffff)

#define ES_REG_1371_SMPRATE 0x10  /* W/R: Codec rate converter interface
                                   * register */
#define   ES_1371_SRC_RAM_ADDRO(o) (((o) & 0x7f) << 25) /* address of the sample
                                                         * rate converter */
#define   ES_1371_SRC_RAM_ADDRM    (0x7f << 25) /* mask for above */
#define   ES_1371_SRC_RAM_ADDRI(i) (((i) >> 25) & 0x7f) /* address of the sample
                                                         * rate converter */
#define   ES_1371_SRC_RAM_WE     (1 << 24)  /* R/W: read/write control for
...
#define   ES_1371_SRC_DISABLE      (1 << 22)  /* sample rate converter disable
                                               * */
#define   ES_1371_DIS_P1     (1 << 21)  /* playback channel 1 accumulator update
                                         * disable */
#define   ES_1371_DIS_P2     (1 << 20)  /* playback channel 1 accumulator update
                                         * disable */
#define   ES_1371_DIS_R1     (1 << 19)  /* capture channel accumulator update
                                         * disable */
#define   ES_1371_SRC_RAM_DATAO(o) (((o) & 0xffff) << 0) /* current value of the
                                                          * sample rate
                                                          * converter */
#define   ES_1371_SRC_RAM_DATAM    (0xffff << 0)  /* mask for above */
#define   ES_1371_SRC_RAM_DATAI(i) (((i) >> 0) & 0xffff) /* current value of the
                                                          * sample rate
                                                          * converter */
...
#define   ES_1371_VMPUO(o)  (((o) & 0x03) << 27) /* base register address; 0 =
                                                  * 0x320xH; 1 = 0x330xH; 2 =
                                                  * 0x340xH; 3 = 0x350xH */
#define   ES_1371_VMPUM   (0x03 << 27)  /* mask for above */
#define   ES_1371_VMPUI(i)  (((i) >> 27) & 0x03) /* base register address */
#define   ES_1371_VCDCO(o)  (((o) & 0x03) << 25) /* CODEC; 0 = 0x530xH; 1 =
                                                  * undefined; 2 = 0xe80xH; 3 =
                                                  * 0xF40xH */
...
#define   ES_1371_SDMACAP (1 << 23)   /* enable event capture for slave DMA
                                       * controller */
#define   ES_1371_SPICAP  (1 << 22)   /* enable event capture for slave IRQ
                                       * controller */
#define   ES_1371_MDMACAP (1 << 21)   /* enable event capture for master DMA
                                       * controller */
#define   ES_1371_MPICAP  (1 << 20)   /* enable event capture for master IRQ
                                       * controller */
#define   ES_1371_ADCAP   (1 << 19)   /* enable event capture for ADLIB
                                       * register; 0x388xH */
#define   ES_1371_SVCAP   (1 << 18)   /* enable event capture for SB registers
                                       * */
#define   ES_1371_CDCCAP  (1 << 17)   /* enable event capture for CODEC
                                       * registers */
#define   ES_1371_BACAP   (1 << 16)   /* enable event capture for SoundScape
                                       * base address */
...
#define   ES_1371_LEGINT  (1 << 0)  /* interrupt for legacy events; 0 =
                                     * interrupt did occur */

#define ES_REG_CHANNEL_STATUS 0x1c /* R/W: first 32-bits from S/PDIF channel
                                    * status block, es1373 */

#define ES_REG_SERIAL 0x20  /* R/W: Serial interface control register */
#define   ES_1371_DAC_TEST  (1 << 22)   /* DAC test mode enable */
#define   ES_P2_END_INCO(o) (((o) & 0x07) << 19) /* binary offset value to
                                                 * increment / loop end */
#define   ES_P2_END_INCM  (0x07 << 19)  /* mask for above */
#define   ES_P2_END_INCI(i) (((i) >> 16) & 0x07) /* binary offset value to
                                                 * increment / loop end */
#define   ES_P2_ST_INCO(o)  (((o) & 0x07) << 16) /* binary offset value to
                                                  * increment / start */
#define   ES_P2_ST_INCM   (0x07 << 16)  /* mask for above */
#define   ES_P2_ST_INCI(i)  (((i) << 16) & 0x07) /* binary offset value to
                                                  * increment / start */
...
#define   ES_P2_DAC_SEN   (1 << 6)    /* when stop mode: 0 - DAC2 play back
                                       * zeros; 1 = DAC2 play back last sample
                                       * */
#define   ES_R1_MODEO(o)  (((o) & 0x03) << 4) /* ADC mode; 0 = 8-bit mono; 1 =
                                               * 8-bit stereo; 2 = 16-bit mono;
                                               * 3 = 16-bit stereo */
...
static const struct snd_pcm_hw_constraint_ratnums
...
static unsigned int snd_es1371_src_read(struct ensoniq *ensoniq,
    unsigned short reg) {
...
static int snd_ensoniq_playback1_prepare(struct snd_pcm_substream *substream) {
  ...
  ensoniq->sctrl
    &= ~(ES_P1_LOOP_SEL | ES_P1_PAUSE | ES_P1_SCT_RLD | ES_P1_MODEM);
  ...
  switch (runtime->rate) {
    case 5512:
      ensoniq->ctrl |= ES_1370_WTSRSEL(0);
      break;
    case 11025:
      ensoniq->ctrl |= ES_1370_WTSRSEL(1);
      break;
    case 22050:
      ensoniq->ctrl |= ES_1370_WTSRSEL(2);
      break;
    case 44100:
      ensoniq->ctrl |= ES_1370_WTSRSEL(3);
      break;
    default:
      snd_BUG();
  }
...
static snd_pcm_uframes_t snd_ensoniq_playback1_pointer(
...
static snd_pcm_uframes_t snd_ensoniq_capture_pointer(
    struct snd_pcm_substream *substream) {
  struct ensoniq *ensoniq = snd_pcm_substream_chip(substream);
  size_t ptr;
  spin_lock(&ensoniq->reg_lock);
...
static int snd_es1373_rear_put(struct snd_kcontrol *kcontrol,
  ...
  ensoniq->cssr
    &= ~(ES_1373_REAR_BIT27 | ES_1373_REAR_BIT26 | ES_1373_REAR_BIT24);
  ensoniq->cssr |= nval1;
  outl(ensoniq->cssr, ES_REG(ensoniq, STATUS));
  spin_unlock_irq(&ensoniq->reg_lock);
  return change;
...
static const struct es1371_quirk es1371_spdif_present[] = {
  { .vid = PCI_VENDOR_ID_ENSONIQ, .did = PCI_DEVICE_ID_ENSONIQ_CT5880,
    .rev = CT5880REV_CT5880_C },
  { .vid = PCI_VENDOR_ID_ENSONIQ, .did = PCI_DEVICE_ID_ENSONIQ_CT5880,
    .rev = CT5880REV_CT5880_D },
  { .vid = PCI_VENDOR_ID_ENSONIQ, .did = PCI_DEVICE_ID_ENSONIQ_CT5880,
    .rev = CT5880REV_CT5880_E },
  { .vid = PCI_VENDOR_ID_ENSONIQ, .did = PCI_DEVICE_ID_ENSONIQ_ES1371,
    .rev = ES1371REV_CT5880_A },
  { .vid = PCI_VENDOR_ID_ENSONIQ, .did = PCI_DEVICE_ID_ENSONIQ_ES1371,
...
#else
static inline int snd_ensoniq_create_gameport(struct ensoniq *ensoniq,
    long port) {
  return -ENOSYS;
}
...
static DEFINE_SIMPLE_DEV_PM_OPS(snd_ensoniq_pm, snd_ensoniq_suspend,
    snd_ensoniq_resume);
...
static int snd_ensoniq_midi_output_close(
...
static void snd_ensoniq_midi_input_trigger(
...
static void snd_ensoniq_midi_output_trigger(
    struct snd_rawmidi_substream *substream, int up) {
  unsigned long flags;
  struct ensoniq *ensoniq = substream->rmidi->private_data;
  unsigned char byte;
