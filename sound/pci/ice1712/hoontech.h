...
#define ICE1712_SUBDEVICE_STDSP24   0x12141217  /* Hoontech SoundTrack Audio DSP
                                                 * 24 */
#define ICE1712_SUBDEVICE_STDSP24_VALUE   0x00010010  /* A dummy id for Hoontech
                                                       * SoundTrack Audio DSP 24
                                                       * Value */
#define ICE1712_SUBDEVICE_STDSP24_MEDIA7_1  0x16141217  /* Hoontech ST Audio
                                                        * DSP24 Media 7.1 */
#define ICE1712_SUBDEVICE_EVENT_EZ8   0x00010001  /* A dummy id for EZ8 */
#define ICE1712_SUBDEVICE_STAUDIO_ADCIII  0x00010002  /* A dummy id for STAudio
                                                       * ADCIII */
...
#define ICE1712_STDSP24_SET_ADDR(r, \
      a)  r[a & 3] = ((r[a & 3] & ~0x18) | (((a) & 3) << 3))
#define ICE1712_STDSP24_CLOCK(r, a, \
      c)  r[a & 3] = ((r[a & 3] & ~0x20) | (((c) & 1) << 5))
