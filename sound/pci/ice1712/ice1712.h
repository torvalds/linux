...
#define   ICE1712_SERR_ASSERT_DS_DMA  0x40    /* disabled SERR# assertion for
                                               * the DS DMA Ch-C irq otherwise
                                               * enabled */
#define   ICE1712_DOS_VOL   0x10    /* DOS WT/FM volume control */
#define   ICE1712_SERR_LEVEL    0x08  /* SERR# level otherwise edge */
#define   ICE1712_SERR_ASSERT_SB  0x02  /* disabled SERR# assertion for SB irq
                                         * otherwise enabled */
...
#define ice_has_con_ac97(ice) (!((ice)->eeprom.data[ICE_EEP1_CODEC] \
...
struct snd_ice1712_spdif {
  ...
  struct snd_ice1712_spdif_ops {
    ...
    void (*default_get)(struct snd_ice1712 *,
        struct snd_ctl_elem_value *ucontrol);
    int (*default_put)(struct snd_ice1712 *,
        struct snd_ctl_elem_value *ucontrol);
    void (*stream_get)(struct snd_ice1712 *,
        struct snd_ctl_elem_value *ucontrol);
    int (*stream_put)(struct snd_ice1712 *,
        struct snd_ctl_elem_value *ucontrol);
  } ops;
};
...
struct snd_ice1712 {
  ...
  const struct snd_pcm_hw_constraint_list *hw_rates; /* card-specific rate
                                                      * constraints */
 ...
 */
static inline void snd_ice1712_gpio_set_dir(struct snd_ice1712 *ice,
    unsigned int bits) {
...
static inline void snd_ice1712_gpio_set_mask(struct snd_ice1712 *ice,
    unsigned int bits) {
  ice->gpio.set_mask(ice, bits);
}

static inline void snd_ice1712_gpio_write(struct snd_ice1712 *ice,
    unsigned int val) {
...
static inline void snd_ice1712_write(struct snd_ice1712 *ice, u8 addr,
    u8 data) {
