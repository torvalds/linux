 ...
 * thanks to Kristof Pelckmans <Kristof.Pelckmans@antwerpen.be> for Delta410
 * info
 * 0x01 = DFS*/
...
/* low signal = select */
#define ICE1712_DELTA_AP_CS_CODEC 0x20  /* AK4528 (audiophile), AK4529
                                         * (Delta410) chip select */
/* low signal = select */
...
#define ICE1712_DELTA_1010LT_WORDCLOCK 0x80 /* sample clock source: 0 = Word
                                             * Clock Input, 1 = S/PDIF Input ???
                                             * */
