...
/* a yesn-standard I2C device for revo51 */
struct revo51_spec {
...
static const struct snd_ak4xxx_private akm_revo_front_priv = {
	...
	.cs_yesne = VT1724_REVO_CS0 | VT1724_REVO_CS1 | VT1724_REVO_CS2,
...
static const struct snd_ak4xxx_private akm_revo51_priv = {
	...
	.cs_yesne = VT1724_REVO_CS0 | VT1724_REVO_CS1,
	.add_flags = VT1724_REVO_CCLK, /* high at init */
	.mask_flags = 0,
};
...
static const struct snd_ak4xxx_private akm_ap192_priv = {
	...
	.cs_yesne = VT1724_REVO_CS0 | VT1724_REVO_CS3,
	.add_flags = VT1724_REVO_CCLK, /* high at init */
	.mask_flags = 0,
};
...
static int ap192_ak4114_init(struct snd_ice1712 *ice)
{
	...
	if (err < 0)
		return err;
	/* AK4114 in Revo canyest detect external rate correctly.
