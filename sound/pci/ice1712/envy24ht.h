...
/* look to VT1724_IRQ_* */
#define VT1724_REG_SYS_CFG    0x04  /* byte - system configuration PCI60 on
                                     * Envy24*/
...
#define   VT1724_CFG_SPDIF_OUT_INT  0x40  /*Internal S/PDIF output is
                                           * implemented*/
...
#define VT1724_REG_MPU_FIFO_WM  0x0e  /*byte set the high/low watermarks for
                                       * RX/TX fifos*/
...
#define VT1724_REG_GPIO_DIRECTION 0x18 /* dword? (3 bytes) 0=input 1=output.
                                        * bit3 - during reset used for Eeprom
                                        * power-on strapping
                                        * if TESTEN# pin active, bit 2 always
                                        * input*/
...
#define VT1724_MT_BURST     0x19  /* Interleaved playback DMA Active streams /
                                   * PCI burst size */
#define VT1724_MT_DMA_FIFO_ERR    0x1a  /*Global playback and record DMA FIFO
                                         * Underrun/Overrun */
...
#define VT1724_MT_DMA_PAUSE   0x1b  /*Global playback and record DMA FIFO
                                     * pause/resume */
...
unsigned char snd_vt1724_read_i2c(struct snd_ice1712 *ice, unsigned char dev,
    unsigned char addr);
void snd_vt1724_write_i2c(struct snd_ice1712 *ice, unsigned char dev,
