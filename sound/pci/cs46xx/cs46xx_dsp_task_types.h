...
\  -------+------         -------------      -------------      -------------
\     -----
| SBlaster IF  |______\| Foreground  |___\| Middlegr'nd |___\| Background
| |___\| Nul |
|              |Goto  /| tree header |g  /| tree header |g  /| tree header |g
| /| SCB |r
|  -------------- (g)     -------------      -------------      -------------
|     -----
|c                     |c                 |c                 |c
...
#define SLEEP_ACTIVE_INCREMENT    0   /* Enable task tree thread to go to sleep
                                       * This should only ever be used on the
                                       * Background thread */
#define STANDARD_ACTIVE_INCREMENT 1   /* Task tree thread normal operation */
#define SUSPEND_ACTIVE_INCREMENT  2   /* Cause execution to suspend in the task
                                       * tree thread
                                       *       This should only ever be used on
                                       * the Background thread */

#define HOSTFLAGS_DISABLE_BG_SLEEP  0       /* Host-controlled flag that
                                             * determines whether we go to sleep
                                             * at the end of BG */
