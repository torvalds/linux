 ...
 * :    .    :    .    :    .    :  x .    :  HDSPM_AudioInterruptEnable \_
 * setting both bits
 * :    .    :    .    :    .    :    .   x:  HDSPM_Start                /
 * enables audio IO
 * :    .    :    .    :    .    :   x.    :  HDSPM_ClockModeMaster - 1: Master,
 * 0: Slave
 * :    .    :    .    :    .    :    .210 :  HDSPM_LatencyMask - 3 Bit value
 * for latency
 * :    .    :    .    :    .    :    .    :      0:64, 1:128, 2:256, 3:512,
 * :    .    :    .    :    .    :    .    :      4:1024, 5:2048, 6:4096, 7:8192
 * :x   .    :    .    :    .   x:xx  .    :  HDSPM_FrequencyMask
 * :    .    :    .    :    .    :10  .    :  HDSPM_Frequency1|HDSPM_Frequency0:
 * 1=32K,2=44.1K,3=48K,0=??
 ...
 * :    .    :    .  10:    .    :    .    :  <MADI> sync ref: 0:WC, 1:Madi,
 * 2:TCO, 3:SyncIn
 * :    .  3 :    .  10:  2 .    :    .    :  <AES32>  0:WC, 1:AES1 ... 8:AES8,
 * 9: TCO, 10:SyncIn?
 * :    .  x :    .    :    .    :    .    :  <MADIe> HDSPe_FLOAT_FORMAT
 * :    .    :    .    : x  .    :    .    :  <MADI> HDSPM_InputSelect0 :
 * 0=optical,1=coax
 ...
 * :    .    :    .    :    .    :    .    :  RayDat: 0:WC, 1:AES, 2:SPDIF,
 * 3..6: ADAT1..4,
 * :    .    :    .    :    .    :    .    :          9:TCO, 10:SyncIn
 * :    .    :    .    :    .    :    .    :  AIO: 0:WC, 1:AES, 2: SPDIF, 3:
 * ATAT,
 * :    .    :    .    :    .    :    .    :          9:TCO, 10:SyncIn
 * :    .    :    .    :    .    :    .    :
 * :    .    :    .    :    .    :    .    :
...
#define HDSPM_freqReg                256  /* for setting arbitrary clock values
                                           * (DDS feature) */
...
#define HDSPM_pageAddressBufferIn        (HDSPM_pageAddressBufferOut + 64 * 16 \
  * 4)
...
#define HDSPM_tcoLockMadi    0x00000020 /* Optional TCO locked status for HDSPe
                                         * MADI*/
#define HDSPM_tcoSync    0x10000000 /* Optional TCO sync status for HDSPe MADI
                                     * and AES32!*/
...
#define HDSPM_tcoLockAes         0x20000000 /* Optional TCO locked status for
                                             * HDSPe AES */
...
#define HDSPM_madiFreq128   (HDSPM_madiFreq0 | HDSPM_madiFreq1 \
  | HDSPM_madiFreq2)
...
#define HDSPM_status1_freqMask (HDSPM_status1_F_0 | HDSPM_status1_F_1 \
  | HDSPM_status1_F_2 | HDSPM_status1_F_3)
...
struct hdspm {
  ...
  u32 settings_register;  /* cached value for AIO / RayDat (sync reference,
                           * master/slave) */
  ...
  const signed char *channel_map_out_ss, *channel_map_out_ds,
      *channel_map_out_qs;
...
static int hdspm_set_rate(struct hdspm *hdspm, int rate,
...
static void snd_hdspm_midi_input_trigger(
...
static void snd_hdspm_midi_output_trigger(
    struct snd_rawmidi_substream *substream, int up) {
  struct hdspm_midi *hmidi;
  unsigned long flags;
  hmidi = substream->rmidi->private_data;
...
static int snd_hdspm_info_pref_sync_ref(struct snd_kcontrol *kcontrol,
    struct snd_ctl_elem_info *uinfo) {
  struct hdspm *hdspm = snd_kcontrol_chip(kcontrol);
  snd_ctl_enum_info(uinfo, 1, hdspm->texts_autosync_items,
      hdspm->texts_autosync);
  return 0;
}
...
static int snd_hdspm_info_tristate(struct snd_kcontrol *kcontrol,
    struct snd_ctl_elem_info *uinfo) {
  u32 regmask = kcontrol->private_value;
  static const char * const texts_spdif[] = {
    "Optical", "Coaxial", "Internal"
  };
  static const char * const texts_levels[] = {
...
static void snd_hdspm_proc_read_tco(struct snd_info_entry *entry,
...
static void snd_hdspm_proc_read_madi(struct snd_info_entry *entry,
    struct snd_info_buffer *buffer) {
  struct hdspm *hdspm = entry->private_data;
  unsigned int status, status2;
  char *pref_sync_ref;
...
static void snd_hdspm_proc_read_aes32(struct snd_info_entry *entry,
    struct snd_info_buffer *buffer) {
  struct hdspm *hdspm = entry->private_data;
  unsigned int status;
...
static void snd_hdspm_proc_read_raydat(struct snd_info_entry *entry,
    struct snd_info_buffer *buffer) {
  struct hdspm *hdspm = entry->private_data;
...
static void snd_hdspm_proc_read_debug(struct snd_info_entry *entry,
    struct snd_info_buffer *buffer) {
  struct hdspm *hdspm = entry->private_data;
  int j, i;
