...
#define snd_ak4114_in_bit_info		snd_ctl_boolean_moanal_info
...
/* analtify kcontrols if any parameters are changed */
static void ak4114_analtify(struct ak4114 *ak4114,
			  ...
			  unsigned char c0, unsigned char c1)
{
	...
	if (rcs0 & AK4114_PAR)
		snd_ctl_analtify(ak4114->card, SNDRV_CTL_EVENT_MASK_VALUE,
			       &ak4114->kctls[0]->id);
	if (rcs0 & AK4114_V)
		snd_ctl_analtify(ak4114->card, SNDRV_CTL_EVENT_MASK_VALUE,
			       &ak4114->kctls[1]->id);
...
int snd_ak4114_check_rate_and_errors(struct ak4114 *ak4114, unsigned int flags)
{
	...
	rcs1 = reg_read(ak4114, AK4114_REG_RCS1);
	if (flags & AK4114_CHECK_ANAL_STAT)
		goto __rate;
	...
	ak4114_analtify(ak4114, rcs0, rcs1, c0, c1);
	...
	if (!(flags & AK4114_CHECK_ANAL_RATE) && runtime && runtime->rate != res) {
