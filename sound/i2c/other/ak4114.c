...
static void reg_write(struct ak4114 *ak4114, unsigned char reg,
    unsigned char val) {
...
static void reg_dump(struct ak4114 *ak4114) {
  ...
  for (i = 0; i < 0x20; i++) {
    printk(KERN_DEBUG "reg[%02x] = %02x (%02x)\n", i, reg_read(ak4114,
        i), i < ARRAY_SIZE(
        ak4114->regmap) ? ak4114->regmap[i] : 0);
  }
}
...
void snd_ak4114_reg_write(struct ak4114 *chip, unsigned char reg,
...
static unsigned int external_rate(unsigned char rcs1) {
  switch (rcs1 & (AK4114_FS0 | AK4114_FS1 | AK4114_FS2 | AK4114_FS3)) {
    case AK4114_FS_32000HZ:
      return 32000;
    case AK4114_FS_44100HZ:
      return 44100;
    case AK4114_FS_48000HZ:
      return 48000;
    case AK4114_FS_88200HZ:
      return 88200;
    case AK4114_FS_96000HZ:
      return 96000;
    case AK4114_FS_176400HZ:
      return 176400;
    case AK4114_FS_192000HZ:
      return 192000;
    default:
      return 0;
  }
...
static int snd_ak4114_rate_get(struct snd_kcontrol *kcontrol,
  ...
  struct ak4114 *chip = snd_kcontrol_chip(kcontrol);
  ucontrol->value.integer.value[0]
    = external_rate(reg_read(chip, AK4114_REG_RCS1));
  return 0;
}
...
static int snd_ak4114_spdif_qinfo(struct snd_kcontrol *kcontrol,
    struct snd_ctl_elem_info *uinfo) {
...
int snd_ak4114_check_rate_and_errors(struct ak4114 *ak4114,
  ...
  struct snd_pcm_runtime *runtime
    = ak4114->capture_substream ? ak4114->capture_substream->runtime : NULL;
  ...
  c0
    = (ak4114->rcs0
      & (AK4114_QINT | AK4114_CINT | AK4114_PEM | AK4114_AUDION | AK4114_AUTO
      | AK4114_UNLCK))
      ^ (rcs0
      & (AK4114_QINT | AK4114_CINT | AK4114_PEM | AK4114_AUDION | AK4114_AUTO
      | AK4114_UNLCK));
