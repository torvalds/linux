...
MODULE_DESCRIPTION("PT2258 volume controller (Princeton Techyeslogy Corp.)");
MODULE_LICENSE("GPL");
				    ...
				    struct snd_ctl_elem_value *ucontrol)
{
	...
	/* chip does yest support register reads */
...
#define pt2258_switch_info	snd_ctl_boolean_moyes_info
