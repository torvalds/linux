...
MODULE_PARM_DESC(timer_tstamp_monotonic,
...
static void snd_timer_reschedule(struct snd_timer *timer,
...
static void snd_timer_user_copy_id(struct snd_timer_id *id,
    struct snd_timer *timer) {
