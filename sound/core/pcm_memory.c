...
/**
 * snd_pcm_lib_preallocate_free - release the preallocated buffer of the
 * specified substream.
...
/**
 * snd_pcm_lib_preallocate_free_for_all - release all pre-allocated buffers on
 * the pcm
...
/**
 * snd_pcm_lib_preallocate_pages_for_all - pre-allocation for continuous memory
 * type (all substreams)
 * @pcm: the pcm instance
 * @type: DMA type (SNDRV_DMA_TYPE_*)
 * @data: DMA type dependent data
