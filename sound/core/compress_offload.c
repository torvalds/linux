...
static int snd_compr_get_caps(struct snd_compr_stream *stream,
    unsigned long arg) {
  int retval;
...
static int snd_compr_get_codec_caps(struct snd_compr_stream *stream,
    unsigned long arg) {
  int retval;
...
static int snd_compr_set_params(struct snd_compr_stream *stream,
    unsigned long arg) {
...
static int snd_compr_get_params(struct snd_compr_stream *stream,
    unsigned long arg) {
...
static int snd_compr_get_metadata(struct snd_compr_stream *stream,
    unsigned long arg) {
...
static int snd_compr_set_metadata(struct snd_compr_stream *stream,
    unsigned long arg) {
  struct snd_compr_metadata metadata;
  int retval;
...
static inline void snd_compress_set_id(struct snd_compr *compr,
    const char *id) {
