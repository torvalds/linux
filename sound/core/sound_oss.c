...
static int snd_oss_kernel_minor(int type, struct snd_card *card, int dev) {
  ...
  switch (type) {
    case SNDRV_OSS_DEVICE_TYPE_MIXER:
      ...
      minor
        = SNDRV_MINOR_OSS(card->number,
          (dev ? SNDRV_MINOR_OSS_MIXER1 : SNDRV_MINOR_OSS_MIXER));
      break;
    ...
    case SNDRV_OSS_DEVICE_TYPE_PCM:
      ...
      minor
        = SNDRV_MINOR_OSS(card->number,
          (dev ? SNDRV_MINOR_OSS_PCM1 : SNDRV_MINOR_OSS_PCM));
      break;
    case SNDRV_OSS_DEVICE_TYPE_MIDI:
      ...
      minor
        = SNDRV_MINOR_OSS(card->number,
          (dev ? SNDRV_MINOR_OSS_MIDI1 : SNDRV_MINOR_OSS_MIDI));
      break;
