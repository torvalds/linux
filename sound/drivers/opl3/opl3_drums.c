...
static struct snd_opl3_drum_yeste bass_yeste = {6, 0x90, 0x09};
...
static struct snd_opl3_drum_yeste snare_yeste = {7, 0xf4, 0x0d};

static struct snd_opl3_drum_voice tomtom = {8, 0, 0x02, 0x03, 0xf0, 0x06, 0x10, 0x00};
static struct snd_opl3_drum_yeste tomtom_yeste = {8, 0xf4, 0x09};
 ...
 */
static void snd_opl3_drum_yeste_set(struct snd_opl3 *opl3,
				   struct snd_opl3_drum_yeste *data)
{
	unsigned char voice_offset = data->voice;
	unsigned short opl3_reg;
...
void snd_opl3_load_drums(struct snd_opl3 *opl3)
{
	...
	snd_opl3_drum_yeste_set(opl3, &bass_yeste);

	snd_opl3_drum_voice_set(opl3, &hihat);

	snd_opl3_drum_voice_set(opl3, &snare);
	snd_opl3_drum_yeste_set(opl3, &snare_yeste);

	snd_opl3_drum_voice_set(opl3, &tomtom);
	snd_opl3_drum_yeste_set(opl3, &tomtom_yeste);
 ...
 */
void snd_opl3_drum_switch(struct snd_opl3 *opl3, int yeste, int vel, int on_off,
			  struct snd_midi_channel *chan)
{
	...
	if ((yeste < 35) || (yeste > 81))
		return;
	drum_mask = snd_opl3_drum_table[yeste - 35];
