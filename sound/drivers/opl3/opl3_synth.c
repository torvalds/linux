 ...
 * prototypes
 */
static int snd_opl3_play_note(struct snd_opl3 *opl3,
    struct snd_dm_fm_note *note);
static int snd_opl3_set_voice(struct snd_opl3 *opl3,
    struct snd_dm_fm_voice *voice);
static int snd_opl3_set_params(struct snd_opl3 *opl3,
...
static int snd_opl3_set_mode(struct snd_opl3 *opl3, int mode) {
  ...
  if (opl3->hardware >= OPL3_HW_OPL3) {
    opl3->command(opl3, OPL3_RIGHT | OPL3_REG_CONNECTION_SELECT, 0x00); /* Clear
                                                                         * 4-op
                                                                         * connections
                                                                         * */
  }
