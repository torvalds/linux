 ...
 *                     Hannu Savolainen
 *
 * Generic serial MIDI driver using the serdev serial bus API for hardware
 * interaction
 */
...
static int snd_serial_generic_ensure_serdev_open(
...
static int snd_serial_generic_input_open(
...
static int snd_serial_generic_input_close(
    struct snd_rawmidi_substream *substream) {
  struct snd_serial_generic *drvdata = substream->rmidi->card->private_data;
...
static void snd_serial_generic_input_trigger(
    struct snd_rawmidi_substream *substream,
    int up) {
  struct snd_serial_generic *drvdata = substream->rmidi->card->private_data;
  if (up) {
...
static int snd_serial_generic_output_open(
    struct snd_rawmidi_substream *substream) {
  struct snd_serial_generic *drvdata = substream->rmidi->card->private_data;
  int err;
...
static int snd_serial_generic_output_close(
    struct snd_rawmidi_substream *substream) {
  struct snd_serial_generic *drvdata = substream->rmidi->card->private_data;
...
static void snd_serial_generic_output_trigger(
    struct snd_rawmidi_substream *substream,
    int up) {
  struct snd_serial_generic *drvdata = substream->rmidi->card->private_data;
  if (up) {
...
static void snd_serial_generic_output_drain(
    struct snd_rawmidi_substream *substream) {
  struct snd_serial_generic *drvdata = substream->rmidi->card->private_data;
...
static void snd_serial_generic_substreams(struct snd_rawmidi_str *stream,
    int dev_num) {
  struct snd_rawmidi_substream *substream;
