...
int snd_vx_load_boot_image(struct vx_core *chip, const struct firmware *boot) {
...
#if 0
  {
    ...
    unsigned int c
      = ((u32) boot->data[0] <<
        16) | ((u32) boot->data[1] << 8) | boot->data[2];
    if (boot->size != (c + 2) * 3) {
      return -EINVAL;
    }
  }
...
static void vx_proc_read(struct snd_info_entry *entry,
    struct snd_info_buffer *buffer) {
  struct vx_core *chip = entry->private_data;
  static const char * const audio_src_vxp[] = {
    "Line", "Mic", "Digital"
  };
  static const char * const audio_src_vx2[] = {
    "Analog", "Analog", "Digital"
  };
  static const char * const clock_mode[] = {
    "Auto", "Internal", "External"
  };
  static const char * const clock_src[] = {
    "Internal", "External"
  };
  static const char * const uer_type[] = {
