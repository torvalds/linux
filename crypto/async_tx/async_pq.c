 ...
 */
static __async_inline struct dma_async_tx_descriptor *do_async_gen_syndrome(
 ...
 */
static void do_sync_gen_syndrome(struct page **blocks, unsigned int *offsets,
    int disks,
...
static inline bool is_dma_pq_aligned_offs(struct dma_device *dev,
    unsigned int *offs,
...
static inline struct dma_chan *pq_val_chan(struct async_submit_ctl *submit,
    struct page **blocks, int disks,
    size_t len) {
