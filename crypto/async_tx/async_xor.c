...
static __async_inline struct dma_async_tx_descriptor *do_async_xor(
    struct dma_chan *chan, struct dmaengine_unmap_data *unmap,
...
static void do_sync_xor_offs(struct page *dest, unsigned int offset,
...
static inline bool dma_xor_aligned_offsets(struct dma_device *device,
    unsigned int offset,
...
static inline struct dma_chan *xor_val_chan(struct async_submit_ctl *submit,
    struct page *dest,
