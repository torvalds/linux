...
extern int mconsole_yestify(char *sock_name, int type, const void *data,
			   int len);
extern char *mconsole_yestify_socket(void);
extern void lock_yestify(void);
extern void unlock_yestify(void);
