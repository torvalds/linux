...
static void sigio_reg_handler(int idx, struct irq_entry *entry,
    enum um_irq_type t,
...
void sigio_handler(int sig, struct siginfo *unused_si,
    struct uml_pt_regs *regs) {
...
static int _um_request_irq(int irq, int fd, enum um_irq_type type,
