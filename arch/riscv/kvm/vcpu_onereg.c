...
static int copy_sbi_ext_reg_indices(struct kvm_vcpu *vcpu,
    u64 __user *uindices) {
  unsigned int n = 0;
...
static int copy_sbi_reg_indices(struct kvm_vcpu *vcpu, u64 __user *uindices) {
  ...
  int total = 0;
  if (scontext->ext_status[KVM_RISCV_SBI_EXT_STA]
...
/*
 * kvm_riscv_vcpu_num_regs - how many registers do we present via
 * KVM_GET/SET_ONE_REG
 *
