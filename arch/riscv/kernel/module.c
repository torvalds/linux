...
static int apply_r_riscv_32_rela(struct module *me, void *location,
    Elf_Addr v) {
  if (v != (u32) v) {
...
static int apply_r_riscv_64_rela(struct module *me, void *location,
    Elf_Addr v) {
  *(u64 *) location = v;
  return 0;
}
...
static int apply_r_riscv_add8_rela(struct module *me, void *location,
    Elf_Addr v) {
  *(u8 *) location += (u8) v;
  return 0;
}
...
static int apply_r_riscv_sub8_rela(struct module *me, void *location,
    Elf_Addr v) {
  *(u8 *) location -= (u8) v;
  return 0;
}
...
static int apply_r_riscv_sub6_rela(struct module *me, void *location,
    Elf_Addr v) {
  u8 *byte = location;
  u8 value = v;
...
static int apply_r_riscv_set6_rela(struct module *me, void *location,
    Elf_Addr v) {
  u8 *byte = location;
  u8 value = v;
...
static int apply_r_riscv_set8_rela(struct module *me, void *location,
    Elf_Addr v) {
  *(u8 *) location = (u8) v;
  return 0;
}
...
static int apply_r_riscv_set_uleb128(struct module *me, void *location,
    Elf_Addr v) {
  *(long *) location = v;
  return 0;
}

static int apply_r_riscv_sub_uleb128(struct module *me, void *location,
    Elf_Addr v) {
  *(long *) location -= v;
  return 0;
}

static int apply_6_bit_accumulation(struct module *me, void *location,
    long buffer) {
  u8 *byte = location;
  u8 value = buffer;
  if (buffer > 0x3f) {
...
static int apply_8_bit_accumulation(struct module *me, void *location,
    long buffer) {
  if (buffer > U8_MAX) {
...
static int apply_16_bit_accumulation(struct module *me, void *location,
    long buffer) {
  if (buffer > U16_MAX) {
...
static int apply_32_bit_accumulation(struct module *me, void *location,
    long buffer) {
  if (buffer > U32_MAX) {
...
static int apply_64_bit_accumulation(struct module *me, void *location,
    long buffer) {
  *(u64 *) location = (u64) buffer;
  return 0;
}

static int apply_uleb128_accumulation(struct module *me, void *location,
    long buffer) {
  /*
...
static void process_accumulated_relocations(struct module *me,
...
static unsigned int initialize_relocation_hashtable(
   ...
   * hashtable_size.
   */
  int should_double_size
    = ((num_relocations + (num_relocations >> 2)) > (hashtable_size));
