...
static __always_inline void __kvm_riscv_vector_save(
    struct kvm_cpu_context *context) {
  __riscv_v_vstate_save(&context->vector, context->vector.datap);
}

static __always_inline void __kvm_riscv_vector_restore(
    struct kvm_cpu_context *context) {
...
static inline void kvm_riscv_vcpu_guest_vector_save(
    struct kvm_cpu_context *cntx,
    unsigned long *isa) {
}

static inline void kvm_riscv_vcpu_guest_vector_restore(
    struct kvm_cpu_context *cntx,
    unsigned long *isa) {
}
...
static inline void kvm_riscv_vcpu_host_vector_restore(
    struct kvm_cpu_context *cntx) {
}
