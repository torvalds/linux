...
#define RVC_MASK_C_JALR   (RVC_INSN_FUNCT4_MASK | RVC_INSN_J_RS2_MASK \
  | RVC_INSN_OPCODE_MASK)
#define RVC_MASK_C_JR   (RVC_INSN_FUNCT4_MASK | RVC_INSN_J_RS2_MASK \
  | RVC_INSN_OPCODE_MASK)
...
#define RV_EXTRACT_JTYPE_IMM(x) \
  ({typeof(x) x_ = (x); \
    ...
    | (RV_X(x_, RV_J_IMM_19_12_OPOFF, \
    RV_J_IMM_19_12_MASK) << RV_J_IMM_19_12_OFF)   \
...
static inline void riscv_insn_insert_jtype_imm(u32 *insn, s32 imm) {
  ...
  *insn &= ~GENMASK(31, 12);
  *insn
    |= (RV_X(imm, RV_J_IMM_10_1_OFF,
      RV_J_IMM_10_1_MASK) << RV_J_IMM_10_1_OPOFF)
      | (RV_X(imm, RV_J_IMM_11_OFF, RV_J_IMM_11_MASK) << RV_J_IMM_11_OPOFF)
      | (RV_X(imm, RV_J_IMM_19_12_OFF,
          RV_J_IMM_19_12_MASK) << RV_J_IMM_19_12_OPOFF)
