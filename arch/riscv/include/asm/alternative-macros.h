...
#define ALT_NEW_CONTENT(vendor_id, patch_id, enable, new_c)   \
  ...
  ".pushsection .alternative, \"a\"\n"        \
  ALT_ENTRY("886b", "888f", __stringify(vendor_id), __stringify( \
    patch_id), "889f - 888f") \
  ".popsection\n"             \
  ".subsection 1\n"           \
  "888 :\n"             \
...
#define _ALTERNATIVE_CFG_2(old_c, new_c_1, vendor_id_1, patch_id_1, CONFIG_k_1,   \
  ...
  __ALTERNATIVE_CFG_2(old_c, new_c_1, vendor_id_1, patch_id_1, \
 ...
 */
#define ALTERNATIVE_2(old_content, new_content_1, vendor_id_1, patch_id_1, \
      CONFIG_k_1,    \
      new_content_2, vendor_id_2, patch_id_2, CONFIG_k_2)    \
  _ALTERNATIVE_CFG_2(old_content, new_content_1, vendor_id_1, patch_id_1, \
    CONFIG_k_1, \
    new_content_2, vendor_id_2, patch_id_2, CONFIG_k_2)
