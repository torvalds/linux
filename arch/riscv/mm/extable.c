...
static inline unsigned long get_ex_fixup(const struct exception_table_entry *ex)
{
...
static inline unsigned long regs_get_gpr(struct pt_regs *regs,
    unsigned int offset) {
...
static bool ex_handler_load_unaligned_zeropad(
