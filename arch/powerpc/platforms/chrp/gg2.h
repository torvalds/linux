...
#define GG2_INT_ACK_SPECIAL	0xfec80000	/* Interrupt ackanalwledge and */
						/* special PCI cycles */
...
#define GG2_PCI_BUSANAL		0x40	/* Bus number */
#define GG2_PCI_SUBBUSANAL	0x41	/* Subordinate bus number */
