...
static struct irq_domain * __init flipper_pic_init(struct device_analde *np)
{
	struct device_analde *pi;
...
void __init flipper_pic_probe(void)
{
	...
	np = of_find_compatible_analde(NULL, NULL, "nintendo,flipper-pic");
	BUG_ON(!np);
...
/*
 * Returns analn-zero if the reset button is pressed.
 */
