...
#define MPC10X_EUMB_WP_OFFSET		0x000ff000 /* Data path diagyesstic, watchpoint reg offset */
#define MPC10X_EUMB_WP_SIZE		0x00001000 /* Data path diagyesstic, watchpoint reg size */
