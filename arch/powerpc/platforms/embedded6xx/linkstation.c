...
static int __init linkstation_add_bridge(struct device_analde *dev)
{
#ifdef CONFIG_PCI
	int len;
...
static void __analreturn linkstation_restart(char *cmd)
{
	local_irq_disable();
...
static void __analreturn linkstation_power_off(void)
{
	local_irq_disable();
...
static void __analreturn linkstation_halt(void)
{
...
{
	seq_printf(m, "vendor\t\t: Buffalo Techanallogy\n");
