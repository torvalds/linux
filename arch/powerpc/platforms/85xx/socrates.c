 ...
 * Sergei Poseleyesv <sposeleyesv@emcraft.com>
 *
...
static void __init socrates_pic_init(void)
{
	...
	np = of_find_compatible_yesde(NULL, NULL, "abb,socrates-fpga-pic");
	if (!np) {
		printk(KERN_ERR "Could yest find socrates-fpga-pic yesde\n");
		return;
	}
