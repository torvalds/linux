...
static int pseries_msi_ops_prepare(struct irq_domain *domain,
    struct device *dev,
 ...
 */
static void pseries_msi_post_free(struct irq_domain *domain,
    struct device *dev) {
...
static void pseries_msi_compose_msg(struct irq_data *data,
    struct msi_msg *msg) {
...
static int pseries_irq_parent_domain_alloc(struct irq_domain *domain,
    unsigned int virq,
...
static int pseries_irq_domain_alloc(struct irq_domain *domain,
    unsigned int virq,
...
static void pseries_irq_domain_free(struct irq_domain *domain,
    unsigned int virq,
