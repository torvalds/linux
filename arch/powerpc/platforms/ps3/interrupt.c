 ...
 * implementation equates HV plug value to GNU/Linux virq value, constrains each
 ...
 * @virq: The assigned GNU/Linux virq.
 *
...
/**
 * ps3_irq_chip - Represents the ps3_bmp as a GNU/Linux struct irq_chip.
 */
