...
static inline void spu_load_slb(struct spu *spu, int slbe,
...
static irqreturn_t spu_irq_class_0(int irq, void *data) {
  struct spu *spu;
...
static irqreturn_t spu_irq_class_1(int irq, void *data) {
  struct spu *spu;
...
static irqreturn_t spu_irq_class_2(int irq, void *data) {
  struct spu *spu;
  unsigned long stat;
  unsigned long mask;
