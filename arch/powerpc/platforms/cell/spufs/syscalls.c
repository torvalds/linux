...
struct spufs_calls spufs_calls = {
	...
	.spu_run = do_spu_run,
	.yestify_spus_active = do_yestify_spus_active,
	.owner = THIS_MODULE,
#ifdef CONFIG_COREDUMP
	.coredump_extra_yestes_size = spufs_coredump_extra_yestes_size,
	.coredump_extra_yestes_write = spufs_coredump_extra_yestes_write,
#endif
};
