...
int spufs_handle_class1(struct spu_context *ctx)
{
	 ...
	 * to the spu_context, to this function, but yest
	...
	/* we must yest hold the lock when entering copro_handle_mm_fault */
	spu_release(ctx);
	 ...
	 * time slicing will yest preempt the context while the page fault
