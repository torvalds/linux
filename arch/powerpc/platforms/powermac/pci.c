...
static void pmac_pci_fixup_u4_of_node(struct pci_dev *dev)
{
	 ...
	 * on U4. However, GNU/Linux sees it, causing the PCI <-> OF matching
 ...
 * causes problems with GNU/Linux which then re-assigns devices below the bridge,
