 ...
 */
static struct page *__meminit vmemmap_subsection_start(
    unsigned long vmemmap_addr) {
 ...
 */
int __meminit vmemmap_populated(unsigned long vmemmap_addr,
...
static int __meminit __vmemmap_populate(unsigned long start, unsigned long end,
    int node,
...
static void update_memory_block_size(unsigned long *block_size,
