 ...
 */
void __init pseries_add_gpage(u64 addr, u64 page_size,
...
static void free_hugepd_range(struct mmu_gather *tlb, hugepd_t *hpdp,
    int pdshift,
...
void __init gigantic_hugetlb_cma_reserve(void) {
  ...
  if (radix_enabled()) {
    order = PUD_SHIFT - PAGE_SHIFT;
      ...
      && mmu_psize_defs[MMU_PAGE_16G].shift) {
    /*
