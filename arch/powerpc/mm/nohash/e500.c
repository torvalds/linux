...
static void settlbcam(int index, unsigned long virt, phys_addr_t phys,
  ...
  TLBCAM[index].MAS1 = MAS1_VALID | MAS1_IPROT | MAS1_TSIZE(tsize) | MAS1_TID(
      pid);
...
#if defined(CONFIG_LOWMEM_CAM_NUM_BOOL) \
  && (CONFIG_LOWMEM_CAM_NUM >= NUM_TLBCAMS)
...
void mmu_mark_rodata_ro(void) {
  ...
  remapped = map_mem_in_cams(__max_low_memory, CONFIG_LOWMEM_CAM_NUM, false,
      false);
