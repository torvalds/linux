...
int kvmppc_uvmem_slot_init(struct kvm *kvm,
 ...
 */
static bool kvmppc_next_nontransitioned_gfn(
 ...
 */
unsigned long kvmppc_h_svm_page_out(struct kvm *kvm, unsigned long gpa,
