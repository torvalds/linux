...
static inline void fixup_tlbie_lpid(unsigned long rb_value,
    unsigned long lpid) {
...
static struct mmio_hpte_cache_entry *next_mmio_cache_entry(
...
long kvmppc_hv_find_lock_hpte(struct kvm *kvm, gva_t eaddr, unsigned long slb_v,
  ...
  hash
    = (vsid ^ ((eaddr & somask) >> pshift)) & kvmppc_hpt_mask(&kvm->arch.hpt);
