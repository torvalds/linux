...
static int kvmppc_book3s_vec2irqprio(unsigned int vec) {
  ...
  switch (vec) {
    ...
    case 0x300:
      ...
      break;
    case 0x380:
      prio = BOOK3S_IRQPRIO_DATA_SEGMENT;
      break;
    case 0x400:
      prio = BOOK3S_IRQPRIO_INST_STORAGE;
      break;
    case 0x480:
      prio = BOOK3S_IRQPRIO_INST_SEGMENT;
      break;
    case 0x500:
      prio = BOOK3S_IRQPRIO_EXTERNAL;
      break;
    case 0x600:
      prio = BOOK3S_IRQPRIO_ALIGNMENT;
      break;
    case 0x700:
      prio = BOOK3S_IRQPRIO_PROGRAM;
      break;
    case 0x800:
      prio = BOOK3S_IRQPRIO_FP_UNAVAIL;
      break;
    case 0x900:
      prio = BOOK3S_IRQPRIO_DECREMENTER;
      break;
    case 0xc00:
      prio = BOOK3S_IRQPRIO_SYSCALL;
      break;
    case 0xd00:
      prio = BOOK3S_IRQPRIO_DEBUG;
      break;
    case 0xf20:
      prio = BOOK3S_IRQPRIO_ALTIVEC;
      break;
    case 0xf40:
      prio = BOOK3S_IRQPRIO_VSX;
      break;
    case 0xf60:
      prio = BOOK3S_IRQPRIO_FAC_UNAVAIL;
      break;
    default:
      prio = BOOK3S_IRQPRIO_MAX;
      break;
  }
  return prio;
}
...
static int kvmppc_book3s_irqprio_deliver(struct kvm_vcpu *vcpu,
  ...
  switch (priority) {
    case BOOK3S_IRQPRIO_DECREMENTER:
      deliver = !kvmhv_is_nestedv2() && (kvmppc_get_msr(vcpu) & MSR_EE)
          && !crit;
...
void kvmppc_core_flush_memslot(struct kvm *kvm,
