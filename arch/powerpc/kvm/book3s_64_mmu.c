...
do_second:
	...
	/* Update PTE R and C bits, so the guest's swapper kyesws we used the
	 * page */
	if (gpte->may_read && !(r & HPTE_R_R)) {
		/*
		 * Set the accessed flag.
		 * We have to write this back with a single byte write
		 * because ayesther vcpu may be accessing this on
		 * yesn-PAPR platforms such as mac99, and this is
					     ...
					     u64 *vsid)
{
	 ...
	 * but yest if this segment contains the magic page.
	 */
