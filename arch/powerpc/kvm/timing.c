...
void kvmppc_update_timing_stats(struct kvm_vcpu *vcpu)
{
	...
	/* save exit time, used next exit when the reenter time is kyeswn */
				       ...
				       size_t count, loff_t *ppos)
{
	...
	if (c == 'c') {
		...
		/* Write does yest affect our buffers previously generated with
...
static int kvmppc_exit_timing_open(struct iyesde *iyesde, struct file *file)
{
	return single_open(file, kvmppc_exit_timing_show, iyesde->i_private);
}
