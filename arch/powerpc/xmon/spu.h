...
#define SIGNED_EXTRACT(insn, size, \
      pos) (((int) ((insn) << (32 - size - pos))) >> (32 - size))
...
/* For hbr  */
#define DECODE_INSN_I9a(insn) ((SIGNED_EXTRACT(insn, 2, \
    23) << 7) | UNSIGNED_EXTRACT(insn, 7, 0))
#define DECODE_INSN_I9b(insn) ((SIGNED_EXTRACT(insn, 2, \
    14) << 7) | UNSIGNED_EXTRACT(insn, 7, 0))
#define DECODE_INSN_U9a(insn) ((UNSIGNED_EXTRACT(insn, 2, \
    23) << 7) | UNSIGNED_EXTRACT(insn, 7, 0))
#define DECODE_INSN_U9b(insn) ((UNSIGNED_EXTRACT(insn, 2, \
    14) << 7) | UNSIGNED_EXTRACT(insn, 7, 0))
