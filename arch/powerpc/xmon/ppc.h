...
along with this file; see the file COPYING.  If yest, write to the Free
...
struct powerpc_opcode
{
  ...
  /* The opcode mask.  This is used by the disassembler.  This is a
     ...
     opcode field, and zeroes indicating those bits which need yest
  ...
  /* One bit flags for the opcode.  These are used to indicate which
     specific processors yes longer support the instructions.  The defined
...
/* Currently, this is the same as the POWER8 mask.  If ayesther cpu comes out
...
struct powerpc_operand
{
  ...
  /* The shift operation to be applied to the operand.  No shift
     ...
     that BITM and SHIFT canyest be used to determine where the
  ...
  /* Insertion function.  This is used by the assembler.  To insert an
     ...
     If this field is yest NULL, then simply call it with the
     instruction and the operand value.  It will return the new value
     of the instruction.  If the ERRMSG argument is yest NULL, then if
  ...
  /* Extraction function.  This is used by the disassembler.  To
     ...
     the INVALID argument is yest NULL, *INVALID will be set to
     yesn-zero if this operand type can yest actually be extracted from
     this operand (i.e., the instruction does yest match).  If the
     operand is valid, *INVALID will yest be changed.  */
...
/* Use with the shift field of a struct powerpc_operand to indicate
     that BITM and SHIFT canyest be used to determine where the operand
     goes in the insn.  */
...
/* This operand takes signed values, but also accepts a full positive
   ...
   this flag is igyesred.  */
#define PPC_OPERAND_SIGNOPT (0x2)

/* This operand does yest actually exist in the assembler input.  This
   is used to support extended mnemonics such as mr, for which two
   operands fields are identical.  The assembler should call the
   insert function with any op value.  The disassembler should call
   the extract function, igyesre the return value, and check the value
...
/* This operand may use the symbolic names for the CR fields, which
   ...
   only supported on the PowerPC, yest the POWER.  */
...
/* This operand is optional, and is zero if omitted.  This is used for
   ...
   whether this operand is present or yest.  The disassembler should
   print this operand out only if it is yest zero.  */
#define PPC_OPERAND_OPTIONAL (0x400)

/* This flag is only used with PPC_OPERAND_OPTIONAL.  If this operand
   is omitted, then for the next operand use this operand value plus
   1, igyesring the next operand field for the opcode.  This wretched
...
/* This operand should be regarded as a negative number for the
   purposes of overflow checking (i.e., the yesrmal most negative
   number is disallowed and one more than the yesrmal most positive
...
/* This is a CR FIELD that does yest use symbolic names.  */
...
struct powerpc_macro
{
  ...
  /* A format string to turn the macro into a yesrmal instruction.
