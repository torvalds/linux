...
static inline int kvmppc_hpte_base_page_shift(unsigned long h,
    unsigned long l) {
  return kvmppc_hpte_page_shifts(h, l) & 0xff;
}

static inline int kvmppc_hpte_actual_page_shift(unsigned long h,
    unsigned long l) {
...
static inline unsigned long kvmppc_actual_pgsz(unsigned long v,
    unsigned long r) {
...
extern void kvmhv_update_nest_rmap_rc_list(struct kvm *kvm,
    unsigned long *rmapp,
...
static inline pte_t *find_kvm_secondary_pte_unlocked(struct kvm *kvm,
    unsigned long ea,
    unsigned *hshift) {
  pte_t *pte;
