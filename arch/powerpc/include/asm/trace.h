...
TRACE_EVENT(rtas_output,
    ...
    TP_printk("%s status: %d, other outputs: %s", __get_str(name),
    __entry->status,
...
DECLARE_EVENT_CLASS(rtas_parameter_block,
    ...
    be32_to_cpu_array(__entry->params, rtas_args->args,
    ARRAY_SIZE(rtas_args->args));
    ),
    ...
    __entry->params[0], __entry->params[1], __entry->params[2],
    __entry->params[3],
    __entry->params[4], __entry->params[5], __entry->params[6],
    __entry->params[7],
    __entry->params[8], __entry->params[9], __entry->params[10],
    __entry->params[11],
    __entry->params[12], __entry->params[13], __entry->params[14],
    __entry->params[15]
    )
    );
