...
LV1_CALL(set_spe_transition_yestifier,                   3, 0,  64 )
...
LV1_CALL(create_repository_yesde,                        6, 0,  90 )
LV1_CALL(read_repository_yesde,                          5, 2,  91 )
LV1_CALL(write_repository_yesde,                         6, 0,  92 )
LV1_CALL(delete_repository_yesde,                        4, 0,  93 )
