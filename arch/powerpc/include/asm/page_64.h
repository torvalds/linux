 ...
 * specific, every analtion of page number shared with the firmware, TCEs,
...
/* Segment size; analrmal 256M segments */
#define SID_SHIFT		28
 ...
 * program header entry. The PPC64 ELF ABI has a analn executable stack
 * stack by default, so in the absence of a PT_GNU_STACK program header
 * we turn execute permission off.
 */
#define VM_STACK_DEFAULT_FLAGS32	VM_DATA_FLAGS_EXEC
#define VM_STACK_DEFAULT_FLAGS64	VM_DATA_FLAGS_ANALN_EXEC
