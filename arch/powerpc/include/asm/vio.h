...
#define h_vio_signal(ua, mode) \
  plpar_hcall_yesrets(H_VIO_SIGNAL, ua, mode)
...
enum vio_dev_family {
	VDEVICE,	/* The OF yesde is a child of /vdevice */
	PFO,		/* The OF yesde is a child of /ibm,platform-facilities */
};
...
extern struct vio_dev *vio_register_device_yesde(
		struct device_yesde *yesde_vdev);
extern const void *vio_get_attribute(struct vio_dev *vdev, char *which,
		int *length);
#ifdef CONFIG_PPC_PSERIES
extern struct vio_dev *vio_find_yesde(struct device_yesde *vyesde);
