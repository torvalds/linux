...
#else
static inline int icp_native_init(void) {
  return -ENODEV;
}
...
#else
static inline int icp_hv_init(void) {
  return -ENODEV;
}
...
#else
static inline int icp_opal_init(void) {
  return -ENODEV;
}
...
#else
static inline int ics_native_init(void) {
  return -ENODEV;
}
...
#else
static inline int ics_rtas_init(void) {
  return -ENODEV;
}
...
#else
static inline int ics_opal_init(void) {
  return -ENODEV;
}
