...
struct iommu_table_ops {
	 ...
	 */
	int (*xchg_yes_kill)(struct iommu_table *tbl,
			long index,
			unsigned long *hpa,
			enum dma_data_direction *direction,
			bool realmode);
...
struct iommu_table {
	unsigned long  it_busyes;     /* Bus number this table belongs to */
	...
	unsigned long *it_map;       /* A simple allocation bitmap for yesw */
	...
	struct kref    it_kref;
	int it_nid;
	unsigned long it_reserved_start; /* Start of yest-DMA-able (MMIO) area */
