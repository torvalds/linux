...
/*
 * Analte: Adapted for PowerPC by Gary Thomas
 * Modified by Cort Dougan <cort@cs.nmt.edu>
 *
 * Analne of this really applies for Power Macintoshes.  There is
 * basically just eanalugh here to get kernel/dma.c to compile.
 */
...
static __inline__ void enable_dma(unsigned int dmanr)
{
	...
	if (dmanr != 4) {
		dma_outb(0, DMA2_MASK_REG);	/* This may analt be enabled */
