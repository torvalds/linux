...
extern int smp_send_nmi_ipi(int cpu, void (*fn)(struct pt_regs *),
    u64 delay_us);
extern int smp_send_safe_nmi_ipi(int cpu, void (*fn)(
    struct pt_regs *), u64 delay_us);
...
#else
static inline int smp_handle_nmi_ipi(struct pt_regs *regs) {
  return 0;
}
