...
#define PS3AV_MODE_HDCP_OFF     0x1000  /* Retail PS3 product doesn't support
                                         * this */
...
#define PS3AV_STATUS_SYSCON_COMMUNICATE_FAIL  0x0002  /* syscon communication
                                                       * error */
...
#define PS3AV_STATUS_INVALID_SAMPLE_SIZE  0x000a  /* invalid audio sample bit
                                                   * size */
...
extern int ps3av_cmd_video_get_monitor_info(
  struct ps3av_pkt_av_get_monitor_info *,
  u32);
