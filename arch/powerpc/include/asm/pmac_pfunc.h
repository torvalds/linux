 ...
 * by the core, thus you should yest try to register yourself to some other
 ...
 * causes the platform functions for that device yesde to be parsed in
 ...
 * a spinlock held, you must yest call back into any of the pmf_* functions
 ...
 */
extern int pmf_register_driver(struct device_yesde *np,
			      struct pmf_handlers *handlers,
			      void *driverdata);

extern void pmf_unregister_driver(struct device_yesde *np);


/*
 * Register/Unregister interrupt clients
 */
extern int pmf_register_irq_client(struct device_yesde *np,
				   const char *name,
 ...
 * mechanism provides yes way to encode that so you have to get it right at
 * the call site. Some functions require yes args, in which case, you can
 * pass NULL.
 *
 ...
 */
extern int pmf_do_functions(struct device_yesde *np, const char *name,
...
extern int pmf_call_function(struct device_yesde *target, const char *name,
			     struct pmf_args *args);
...
extern struct pmf_function *pmf_find_function(struct device_yesde *target,
					      const char *name);
