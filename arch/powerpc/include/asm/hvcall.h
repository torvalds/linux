...
#define H_RESERVED_DABR -8  /* DABR address is reserved by the hypervisor on
                             * this processor" */
#define H_NO_MEM  -9
...
#define H_EXACT     (1UL << (63 - 24))  /* Use exact PTE or return H_PTEG_FULL
                                         * */
#define H_R_XLATE   (1UL << (63 - 25))  /* include a valid logical page num in
                                         * the pte if the valid bit is set */
