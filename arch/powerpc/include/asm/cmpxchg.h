...
#else
static __always_inline unsigned long __xchg_u8_local(volatile void *p,
    unsigned long val) {
  unsigned long prev;
  __asm__ __volatile__ (
...
static __always_inline unsigned long __xchg_u8_relaxed(u8 *p,
    unsigned long val) {
  unsigned long prev;
  __asm__ __volatile__ (
...
static __always_inline unsigned long __xchg_u16_local(volatile void *p,
    unsigned long val) {
  unsigned long prev;
  __asm__ __volatile__ (
...
static __always_inline unsigned long __xchg_u16_relaxed(u16 *p,
    unsigned long val) {
  unsigned long prev;
  __asm__ __volatile__ (
...
static __always_inline unsigned long __xchg_u32_local(volatile void *p,
    unsigned long val) {
  unsigned long prev;
  __asm__ __volatile__ (
    "1:	lwarx	%0,0,%2 \n"
...
static __always_inline unsigned long __xchg_u32_relaxed(u32 *p,
    unsigned long val) {
  unsigned long prev;
  __asm__ __volatile__ (
    "1:	lwarx	%0,0,%2\n"
...
#ifdef CONFIG_PPC64
static __always_inline unsigned long __xchg_u64_local(volatile void *p,
    unsigned long val) {
  unsigned long prev;
  __asm__ __volatile__ (
    "1:	ldarx	%0,0,%2 \n"
...
static __always_inline unsigned long __xchg_u64_relaxed(u64 *p,
    unsigned long val) {
  unsigned long prev;
  __asm__ __volatile__ (
    "1:	ldarx	%0,0,%2\n"
...
static __always_inline unsigned long __xchg_local(void *ptr, unsigned long x,
    unsigned int size) {
  switch (size) {
    case 1:
...
static __always_inline unsigned long __xchg_relaxed(void *ptr, unsigned long x,
    unsigned int size) {
  switch (size) {
    case 1:
...
#else
static __always_inline unsigned long __cmpxchg_u8(volatile unsigned char *p,
    unsigned long old,
    unsigned long new) {
  unsigned int prev;
  __asm__ __volatile__ (
...
static __always_inline unsigned long __cmpxchg_u8_local(
    volatile unsigned char *p, unsigned long old,
    unsigned long new) {
  unsigned int prev;
  __asm__ __volatile__ (
...
static __always_inline unsigned long __cmpxchg_u8_relaxed(u8 *p,
    unsigned long old,
    unsigned long new) {
  unsigned long prev;
  __asm__ __volatile__ (
...
static __always_inline unsigned long __cmpxchg_u8_acquire(u8 *p,
    unsigned long old,
    unsigned long new) {
  unsigned long prev;
  __asm__ __volatile__ (
...
static __always_inline unsigned long __cmpxchg_u16(volatile unsigned short *p,
    unsigned long old,
    unsigned long new) {
  unsigned int prev;
  __asm__ __volatile__ (
...
static __always_inline unsigned long __cmpxchg_u16_local(
    volatile unsigned short *p, unsigned long old,
    unsigned long new) {
  unsigned int prev;
  __asm__ __volatile__ (
...
static __always_inline unsigned long __cmpxchg_u16_relaxed(u16 *p,
    unsigned long old,
    unsigned long new) {
  unsigned long prev;
  __asm__ __volatile__ (
...
static __always_inline unsigned long __cmpxchg_u16_acquire(u16 *p,
    unsigned long old,
    unsigned long new) {
  unsigned long prev;
  __asm__ __volatile__ (
...
static __always_inline unsigned long __cmpxchg_u32(volatile unsigned int *p,
    unsigned long old,
    unsigned long new) {
  unsigned int prev;
  __asm__ __volatile__ (
...
static __always_inline unsigned long __cmpxchg_u32_local(
    volatile unsigned int *p, unsigned long old,
    unsigned long new) {
  unsigned int prev;
  __asm__ __volatile__ (
    "1:	lwarx	%0,0,%2		# __cmpxchg_u32\n\
...
static __always_inline unsigned long __cmpxchg_u32_relaxed(u32 *p,
    unsigned long old,
    unsigned long new) {
  unsigned long prev;
  __asm__ __volatile__ (
 ...
 */
static __always_inline unsigned long __cmpxchg_u32_acquire(u32 *p,
    unsigned long old,
    unsigned long new) {
  unsigned long prev;
  __asm__ __volatile__ (
...
#ifdef CONFIG_PPC64
static __always_inline unsigned long __cmpxchg_u64(volatile unsigned long *p,
    unsigned long old,
    unsigned long new) {
  unsigned long prev;
  __asm__ __volatile__ (
...
static __always_inline unsigned long __cmpxchg_u64_local(
    volatile unsigned long *p, unsigned long old,
    unsigned long new) {
  unsigned long prev;
  __asm__ __volatile__ (
    "1:	ldarx	%0,0,%2		# __cmpxchg_u64\n\
...
static __always_inline unsigned long __cmpxchg_u64_relaxed(u64 *p,
    unsigned long old,
    unsigned long new) {
  unsigned long prev;
  __asm__ __volatile__ (
...
static __always_inline unsigned long __cmpxchg_u64_acquire(u64 *p,
    unsigned long old,
    unsigned long new) {
  unsigned long prev;
  __asm__ __volatile__ (
...
static __always_inline unsigned long __cmpxchg_local(void *ptr,
    unsigned long old,
    unsigned long new,
    unsigned int size) {
  switch (size) {
...
static __always_inline unsigned long __cmpxchg_relaxed(void *ptr,
    unsigned long old,
    unsigned long new,
    unsigned int size) {
  switch (size) {
...
static __always_inline unsigned long __cmpxchg_acquire(void *ptr,
    unsigned long old,
    unsigned long new,
    unsigned int size) {
  switch (size) {
