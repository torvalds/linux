...
#define IPIC_SIPNR_L  0x0C  /* System Internal Interrupt Pending Register (LOW)
                             * */
#define IPIC_SIPRR_A  0x10  /* System Internal Interrupt group A Priority
                             * Register */
#define IPIC_SIPRR_B  0x14  /* System Internal Interrupt group B Priority
                             * Register */
#define IPIC_SIPRR_C  0x18  /* System Internal Interrupt group C Priority
                             * Register */
#define IPIC_SIPRR_D  0x1C  /* System Internal Interrupt group D Priority
                             * Register */
