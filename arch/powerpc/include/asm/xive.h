...
static inline bool xive_spapr_init(void) {
  return false;
}

static inline bool xive_native_init(void) {
  return false;
}
...
static inline int xive_smp_prepare_cpu(unsigned int cpu) {
  return -EINVAL;
}
