...
#define   DEXCR_PR_IBRTPD 0x10000000UL /* 3: Indirect Branch Recurrent Target
                                        * Prediction Disable */
#define   DEXCR_PR_SRAPD  0x08000000UL /* 4: Subroutine Return Address
                                        * Prediction Disable */
#define   DEXCR_PR_NPHIE  0x04000000UL /* 5: Non-Privileged Hash Instruction
                                        * Enable */
...
#define SPRN_PSSCR  0x357 /* Processor Stop Status and Control Register (ISA
                           * 3.0) */
...
#define   LPCR_AIL    ASM_CONST(0x0000000001800000) /* Alternate interrupt
                                                     * location */
#define   LPCR_AIL_0    ASM_CONST(0x0000000000000000) /* MMU off exception
                                                       * offset 0x0 */
#define   LPCR_AIL_3    ASM_CONST(0x0000000001800000)   /* MMU on exception
                                                         * offset 0xc00...4xxx
                                                         * */
...
#define   LPCR_PECE   ASM_CONST(0x000000000001f000) /* powersave exit cause
                                                     * enable */
#define     LPCR_PECEDP ASM_CONST(0x0000000000010000) /* directed priv dbells
                                                       * cause exit */
#define     LPCR_PECEDH ASM_CONST(0x0000000000008000) /* directed hyp dbells
                                                       * cause exit */
#define     LPCR_PECE0    ASM_CONST(0x0000000000004000) /* ext. exceptions can
                                                         * cause exit */
#define     LPCR_PECE1    ASM_CONST(0x0000000000002000) /* decrementer can cause
                                                         * exit */
#define     LPCR_PECE2    ASM_CONST(0x0000000000001000) /* machine check etc can
                                                         * cause exit */
#define     LPCR_PECE_HVEE  ASM_CONST(0x0000400000000000) /* P9 Wakeup on HV
                                                           * interrupts */
#define   LPCR_MER    ASM_CONST(0x0000000000000800) /* Mediated External
                                                     * Exception */
#define   LPCR_MER_SH   11
#define   LPCR_GTSE   ASM_CONST(0x0000000000000400)   /* Guest Translation
                                                       * Shootdown Enable */
#define   LPCR_TC   ASM_CONST(0x0000000000000200) /* Translation control */
#define   LPCR_HEIC   ASM_CONST(0x0000000000000010)   /* Hypervisor External
                                                      * Interrupt Control */
#define   LPCR_LPES   0x0000000c
#define   LPCR_LPES0    ASM_CONST(0x0000000000000008)      /* LPAR Env selector
                                                            * 0 */
#define   LPCR_LPES1    ASM_CONST(0x0000000000000004)      /* LPAR Env selector
                                                            * 1 */
#define   LPCR_LPES_SH    2
#define   LPCR_RMI    ASM_CONST(0x0000000000000002)      /* real mode is cache
                                                          * inhibit */
#define   LPCR_HVICE    ASM_CONST(0x0000000000000002)      /* P9: HV interrupt
                                                            * enable */
#define   LPCR_HDICE    ASM_CONST(0x0000000000000001)      /* Hyp Decr enable
                                                            * (HV,PR,EE) */
#define   LPCR_UPRT   ASM_CONST(0x0000000000400000)      /* Use Process Table
                                                          * (ISA 3) */
...
#define   SRR1_ISI_N_G_OR_CIP 0x10000000 /* ISI: Access is no-exec or G or CI
                                          * for a prefixed instruction */
#define   SRR1_ISI_PROT   0x08000000 /* ISI: Other protection fault */
#define   SRR1_WAKEMASK   0x00380000 /* reason for wakeup */
#define   SRR1_WAKEMASK_P8  0x003c0000 /* reason for wakeup on POWER8 and 9 */
#define   SRR1_WAKEMCE_RESVD  0x003c0000 /* Unused/reserved value used by MCE
                                          * wakeup to indicate cause to idle
                                          * wakeup handler */
...
#define   SRR1_BOUNDARY   0x10000000 /* Prefixed instruction crosses 64-byte
                                      * boundary */
...
#define   MMCR0_FCECE ASM_CONST(0x02000000) /* freeze ctrs on enabled cond or
                                             * event */
