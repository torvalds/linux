...
#define SAVE_16VSRS(n, b, base) SAVE_8VSRS(n, b, base); SAVE_8VSRS(n + 8, b, \
    base)
#define SAVE_32VSRS(n, b, base) SAVE_16VSRS(n, b, base); SAVE_16VSRS(n + 16, b, \
    base)
...
#define REST_16VSRS(n, b, base) REST_8VSRS(n, b, base); REST_8VSRS(n + 8, b, \
    base)
#define REST_32VSRS(n, b, base) REST_16VSRS(n, b, base); REST_16VSRS(n + 16, b, \
    base)
...
#define SAVE_4EVRS(n, s, b, o) SAVE_2EVRS(n, s, b, o); \
  SAVE_2EVRS(n + 2, s, b, o)
#define SAVE_8EVRS(n, s, b, o) SAVE_4EVRS(n, s, b, o); \
  SAVE_4EVRS(n + 4, s, b, o)
#define SAVE_16EVRS(n, s, b, o)  SAVE_8EVRS(n, s, b, o); SAVE_8EVRS(n + 8, s, b, \
    o)
#define SAVE_32EVRS(n, s, b, o)  SAVE_16EVRS(n, s, b, o); SAVE_16EVRS(n + 16, s, \
    b, o)
#define REST_EVR(n, s, b, o) lwz s, o + 4 * (n)(b); evmergelo n, s, n
#define REST_2EVRS(n, s, b, o) REST_EVR(n, s, b, o); REST_EVR(n + 1, s, b, o)
#define REST_4EVRS(n, s, b, o) REST_2EVRS(n, s, b, o); \
  REST_2EVRS(n + 2, s, b, o)
#define REST_8EVRS(n, s, b, o) REST_4EVRS(n, s, b, o); \
  REST_4EVRS(n + 4, s, b, o)
#define REST_16EVRS(n, s, b, o)  REST_8EVRS(n, s, b, o); REST_8EVRS(n + 8, s, b, \
    o)
#define REST_32EVRS(n, s, b, o)  REST_16EVRS(n, s, b, o); REST_16EVRS(n + 16, s, \
    b, o)
...
#define LOAD_REG_ADDR(reg, name)     \
  ...
  addi reg, reg, name@toc@l
              ...
              /*
               * This is used in register-constrained interrupt handlers. Not to
               * be used
               * by BOOK3S. ld complains with "got/toc optimization is not
               * supported" if r2
               * is not used for the TOC offset, so use @got(tocreg). If the
               * interrupt
...
#define LRSAVE  16
              ...
              /*
               * GCC stack frames follow a different pattern on 32 vs 64. This
               * can be used
...
#define PPC440EP_ERR42
              ...
              /* The following stops all load and store data streams associated
               * with stream
               * ID (ie. streams created explicitly).  The embedded and server
               * mnemonics for
...
#define DCBT_SETUP_STREAMS(from, from_parms, to, to_parms, scratch) \
  ...
  .machine pop;
               ...
               * 32-bit classic.
               *
               * On the other hand, I find it useful to have them behave as
               * expected
...
#define fromreal(rd)
              ...
              /*
               * We use addis to ensure compatibility with the "classic" ppc
               * versions of
               * these macros, which use rs = 0 to get the tophys offset in rd,
               * rather than
               * converting the address in r0, and so this version has to do
               * that too
