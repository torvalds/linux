...
static void iommu_debugfs_add(struct iommu_table *tbl) {
  ...
  debugfs_create_file_unsafe("weight", 0400, liobn_entry, tbl,
  ...
  debugfs_create_ulong("it_reserved_start", 0400, liobn_entry,
      &tbl->it_reserved_start);
  debugfs_create_ulong("it_reserved_end", 0400, liobn_entry,
      &tbl->it_reserved_end);
  debugfs_create_ulong("it_indirect_levels", 0400, liobn_entry,
...
static long spapr_tce_unset_window(struct iommu_table_group *table_group,
    int num) {
  return 0;
}
 ...
 */
static int spapr_tce_platform_iommu_attach_dev(
    struct iommu_domain *platform_domain,
    struct device *dev) {
...
static int spapr_tce_blocked_iommu_attach_dev(
    struct iommu_domain *platform_domain,
    struct device *dev) {
  struct iommu_group *grp = iommu_group_get(dev);
  struct iommu_table_group *table_group;
