...
static struct fadump_mrange_info crash_mrange_info = {
  "crash", NULL, 0, 0, 0, false
};
...
static struct fadump_mrange_info
  ...
  "reserved", rngs, RESERVED_RNGS_SZ, 0, RESERVED_RNGS_CNT, true
};
 ...
 * crash_save_vmcoreinfo_init(), which must run first to ensure vmcoreinfo
 * initialization
