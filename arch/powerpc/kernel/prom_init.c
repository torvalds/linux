...
static unsigned long __init prom_memparse(const char *ptr,
    const char **retptr) {
...
static const struct ibm_arch_vec ibm_architecture_vec_template __initconst = {
  ...
  .vec5 = {
    .byte1 = 0,       /* don't ignore, don't halt */
    .byte2 = OV5_FEAT(OV5_LPAR) | OV5_FEAT(OV5_SPLPAR) | OV5_FEAT(
        OV5_LARGE_PAGES)
    ...
    .papr_level = 0,
    .reserved1 = 0,
    .platform_facilities = OV5_FEAT(OV5_PFO_HW_RNG)
        | OV5_FEAT(OV5_PFO_HW_ENCR) | OV5_FEAT(OV5_PFO_HW_842),
    .reserved2 = 0,
    .reserved3 = 0,
    .subprocessors = 1,
...
static void __init prom_check_platform_support(void) {
  ...
  if (prop_len > 1) {
    ...
    prom_getprop(prom.chosen, "ibm,arch-vec-5-platform-support", &vec,
        sizeof(vec));
