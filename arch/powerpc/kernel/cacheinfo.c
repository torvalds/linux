...
struct cache {
  ...
  int group_id;                  /* id of the group of threads that share this
                                  * cache */
...
static struct cache *cache_do_one_devnode(struct device_node *node,
    int group_id, int level) {
  struct cache *cache;
...
static ssize_t associativity_show(struct kobject *k,
...
static ssize_t show_shared_cpumap(struct kobject *k,
    struct kobj_attribute *attr, char *buf,
    bool list) {
  struct cache_index_dir *index;
  struct cache *cache;
...
static ssize_t shared_cpu_list_show(struct kobject *k,
    struct kobj_attribute *attr, char *buf) {
