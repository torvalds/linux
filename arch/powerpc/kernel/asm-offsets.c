...
#define SVCPU_FIELD(x, f)  DEFINE(x, \
      offsetof(struct paca_struct, shadow_vcpu.f))
#else
...
#else /* 32-bit */
#define SVCPU_FIELD(x, f)  DEFINE(x, \
      offsetof(struct kvmppc_book3s_shadow_vcpu, f))
#define HSTATE_FIELD(x, f) DEFINE(x, \
      offsetof(struct kvmppc_book3s_shadow_vcpu, hstate.f))
#endif
