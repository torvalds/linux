...
.macro EXCEPTION_PROLOG trapno name handle_dar_dsisr = 0
    ...
    EXCEPTION_PROLOG_1
    EXCEPTION_PROLOG_2  \ trapno \ name handle_dar_dsisr = \ handle_dar_dsisr
    .endm
...
mflr r10
stw r10, _LINK(r11)
mfspr r12, SPRN_SPRG_THREAD tovirt(r12, r12)
.if \ handle_dar_dsisr
lwz r10, DAR(r12)
stw r10, _DAR(r11)
lwz r10, DSISR(r12)
...
#endif
COMMON_EXCEPTION_PROLOG_END \ trapno _ASM_NOKPROBE_SYMBOL(\ name \ ()_virt)
.endm
...
mfspr r9, SPRN_SRR1
mfspr r12, SPRN_SRR0 LOAD_REG_IMMEDIATE(r11, MSR_KERNEL)   /* can take
                                                            * exceptions */
lis r10, 1f @h
ori r10, r10, 1f @l
mtspr SPRN_SRR1, r11
