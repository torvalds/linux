...
FTR_SECTION_ELSE
mfcr r12 ALT_FTR_SECTION_END_IFSET(CPU_FTR_EMB_HV)
#else
mfcr r12
#endif
mfspr r9, SPRN_SRR1 BOOKE_CLEAR_BTB(r11)
mr r11, r1
 ...
 */
#define EXC_LEVEL_EXCEPTION_PROLOG(exc_level, trapno, intno, exc_level_srr0, \
      exc_level_srr1) \
