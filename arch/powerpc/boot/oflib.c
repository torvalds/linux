 ...
 * we claim the physical space in the /memory yesde and the virtual
 * space in the chosen mmu yesde, and then do a map operation to
...
void *of_vmlinux_alloc(unsigned long size)
{
	 ...
	 * will reside in.  Newer firmwares don't need this so we just igyesre
	 * the return value.
	 */
