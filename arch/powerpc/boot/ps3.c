...
extern int lv1_get_repository_yesde_value(u64 in_1, u64 in_2, u64 in_3,
...
static void ps3_exit(void)
{
	...
	lv1_panic(0); /* zero = do yest reboot */
	while (1);
}
...
static int ps3_repository_read_rm_size(u64 *rm_size)
{
	...
	*/
	...
	result = lv1_get_repository_yesde_value(lpar_id, 0x0000000062690000ULL,
