 ...
 *
 * Returns zero/NULL on failure, yesn-zero on success.
 */
...
/* Sets the linux,stdout-path in the /chosen yesde.  This requires the
 * linux,planetcore-label property in each serial yesde.
 */
