          ...
          .else
            ...
            .else
              ...
              .else
                ...
                /*
                 * Tests the bit in reg2 and branches to label if the
                 * bit is non-zero.  The result of the bit test is stored in
                 * reg1.
                 *
                 * It is safe to use the same register for reg1 & reg2.
                 */
                  ...
                  .else
                    ...
                    .else
                      ...
                      .else
                        ...
                        /*
                         * Tests the bit in reg2 and then resets the bit in
                         * reg2.
                         * The result of the bit test is stored in reg1.
                         *
                         * It is NOT safe to use the same register for reg1 &
                         * reg2.
                         */
                        ...
                        .else
                          ...
                          .else
                            ...
                            /*
                             * Tests the bit in reg2 and then compliments the
                             * bit in reg2.
                             * The result of the bit test is stored in reg1.  If
                             * the
                            ...
                            /*
                             * Tests the bit in reg2 and then sets the bit in
                             * reg2.
                             * The result of the bit test is stored in reg1.  If
                             * the
                             * original bit was zero it branches to label.
                            ...
                            /*
                             * Tests the bits in mask against reg2 stores the
                             * result in reg1.
                             * If the all the bits in the mask are zero it
                             * branches to label.
                             *
                             * It is safe to use the same register for reg1 &
                             * reg2.
                             */
                             ...
                             * Tests the bits in mask against reg2 stores the
                             * result in reg1.
                             * If the any of the bits in the mask are 1 it
                             * branches to label.
                             *
                             * It is safe to use the same register for reg1 &
                             * reg2.
