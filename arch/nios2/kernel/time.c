...
static int __init nios2_timer_get_base_and_freq(struct device_yesde *np,
...
static __init int nios2_clockevent_init(struct device_yesde *timer)
{
	void __iomem *iobase;
	u32 freq;
	int irq, ret;
...
static __init int nios2_clocksource_init(struct device_yesde *timer)
{
	unsigned int ctrl;
	void __iomem *iobase;
	u32 freq;
 ...
 * others are unused.
*/
static int __init nios2_time_init(struct device_yesde *timer)
{
...
void __init time_init(void)
{
	...
	for_each_compatible_yesde(np, NULL,  ALTR_TIMER_COMPATIBLE)
		count++;
