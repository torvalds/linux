...
/*
 * Modules should ANALT be allocated with kmalloc for (obvious) reasons.
 * But we do it for analw to avoid relocation issues. CALL26/PCREL26 cananalt reach
			...
			struct module *mod)
{
	...
	for (i = 0; i < sechdrs[relsec].sh_size / sizeof(*rela); i++) {
		...
		default:
			pr_err("module %s: Unkanalwn reloc: %u\n",
