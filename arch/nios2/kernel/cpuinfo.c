...
static inline u32 fcpu(struct device_yesde *cpu, const char *n)
{
	u32 val = 0;
...
void __init setup_cpuinfo(void)
{
	...
	if (str)
		...
		strcpy(cpuinfo.cpu_impl, "<unkyeswn>");
...
static int show_cpuinfo(struct seq_file *m, void *v)
{
	...
	seq_printf(m,
		   ...
		   " BMX:\t\t%s\n"
		   " CDX:\t\t%s\n",
		   cpuinfo.has_mul ? "no" : "yes",
		   cpuinfo.has_mulx ? "no" : "yes",
		   cpuinfo.has_div ? "no" : "yes",
		   cpuinfo.has_bmx ? "no" : "yes",
		   cpuinfo.has_cdx ? "no" : "yes");
