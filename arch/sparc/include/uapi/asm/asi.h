...
#define ASI_M_TLBDIAG       0x05   /* MMU TLB only Diagyesstics */
#define ASI_M_DIAGS         0x06   /* Reference MMU Diagyesstics */
#define ASI_M_IODIAG        0x07   /* MMU I/O TLB only Diagyesstics */
...
#define ASI_M_DCDR         0x39   /* Data Cache Diagyesstics Register rw, ss */
...
#define ASI_PNF			0x82 /* Primary, yes fault		*/
#define ASI_SNF			0x83 /* Secondary, yes fault		*/
#define ASI_PL			0x88 /* Primary, implicit, l-endian	*/
#define ASI_SL			0x89 /* Secondary, implicit, l-endian	*/
#define ASI_PNFL		0x8a /* Primary, yes fault, l-endian	*/
#define ASI_SNFL		0x8b /* Secondary, yes fault, l-endian	*/
...
#define ASI_PCACHE_SNOOP_TAG	0x33 /* (III) PCache syesop tag RAM diag	*/
#define ASI_QUAD_LDD_PHYS	0x34 /* (III+) PADDR, qword load	*/
#define ASI_WCACHE_VALID_BITS	0x38 /* (III) WCache Valid Bits diag	*/
#define ASI_WCACHE_DATA		0x39 /* (III) WCache data RAM diag	*/
#define ASI_WCACHE_TAG		0x3a /* (III) WCache tag RAM diag	*/
#define ASI_WCACHE_SNOOP_TAG	0x3b /* (III) WCache syesop tag RAM diag	*/
...
#define ASI_DCACHE_SNOOP_TAG	0x44 /* (III) DCache syesop tag RAM diag	*/
...
#define ASI_IC_STAG		0x68 /* (III) Insn cache syesop tag ram	*/
