 ...
 * processors that support ADI which do yest use IG, hence there is yes
 * functional conflict
 */
 ...
 * processors that support ADI which do yest support IG, hence there is
 * yes functional conflict
 */
