...
#define OPROMPCI2NODE   0x20004FF1  /* int pci_bus, pci_devfn - Sets current
                                     * node to PCI device's node */
#define OPROMPATH2NODE    0x20004FF2  /* char path[] - Set current node from
                                       * fully qualified PROM path */
