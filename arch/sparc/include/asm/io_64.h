...
static inline void writesb(void __iomem *port, const void *buf,
    unsigned long count) {
...
static inline void writesw(void __iomem *port, const void *buf,
    unsigned long count) {
...
static inline void writesl(void __iomem *port, const void *buf,
    unsigned long count) {
...
static inline void sbus_memset_io(volatile void __iomem *dst, int c,
    __kernel_size_t n) {
  while (n--) {
    sbus_writeb(c, dst);
    dst++;
...
static inline void __iomem *ioremap_np(unsigned long offset,
    unsigned long size) {
  return NULL;
}
