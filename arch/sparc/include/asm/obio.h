...
#define BB_STAT2_TMP_INTR 0x10  /* My Penguins are burning. Are you able to
                                 * smell it? */
#define BB_STAT2_FAN_INTR 0x20  /* My fan refuses to work */
#define BB_STAT2_PWR_INTR 0x40  /* On SC2000, one of the two ACs died. Ok, we go
                                 * on... */
#define BB_STAT2_MASK   (BB_STAT2_AC_INTR | BB_STAT2_TMP_INTR \
  | BB_STAT2_FAN_INTR | BB_STAT2_PWR_INTR)
