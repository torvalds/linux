...
#define __put_user_nocheck(x, addr, size) ({      \
    ...
    switch (size) {           \
      case 1: \
        __put_user_asm(x, b, addr, __pu_ret); break;  \
      case 2: \
        __put_user_asm(x, h, addr, __pu_ret); break;  \
      case 4: \
        __put_user_asm(x, , addr, __pu_ret); break; \
      case 8: \
        __put_user_asm(x, d, addr, __pu_ret); break;  \
      default: \
        __pu_ret = __put_user_bad(); break;    \
    } \
    __pu_ret; \
  })
...
#define __get_user_nocheck(x, addr, size, type) ({      \
    ...
    switch (size) {             \
      case 1: \
        __get_user_asm(__gu_val, ub, addr, __gu_ret); break;  \
      case 2: \
        __get_user_asm(__gu_val, uh, addr, __gu_ret); break;  \
      case 4: \
        __get_user_asm(__gu_val, , addr, __gu_ret); break;  \
      case 8: \
        __get_user_asm(__gu_val, d, addr, __gu_ret); break; \
      default:              \
        __gu_val = 0;           \
        __gu_ret = __get_user_bad();        \
        break;              \
...
unsigned long __copy_user(void __user *to, const void __user *from,
    unsigned long size);
...
static inline unsigned long __clear_user(void __user *addr,
    unsigned long size) {
  unsigned long ret;
  __asm__ __volatile__ (
    "mov %2, %%o1\n"
