...
#define get_thread_fault_code()   (__cur_thread_flag_byte_ptr[ \
    TI_FLAG_BYTE_FAULT_CODE])
#define set_thread_fault_code(val)  (__cur_thread_flag_byte_ptr[ \
    TI_FLAG_BYTE_FAULT_CODE] = (val))
...
#define set_thread_wstate(val)    (__cur_thread_flag_byte_ptr[ \
    TI_FLAG_BYTE_WSTATE] = (val))
#define get_thread_cwp()    (__cur_thread_flag_byte_ptr[TI_FLAG_BYTE_CWP])
#define set_thread_cwp(val)   (__cur_thread_flag_byte_ptr[TI_FLAG_BYTE_CWP] \
    = (val))
#define get_thread_noerror()    (__cur_thread_flag_byte_ptr[TI_FLAG_BYTE_NOERROR \
  ])
#define set_thread_noerror(val)   (__cur_thread_flag_byte_ptr[ \
    TI_FLAG_BYTE_NOERROR] = (val))
#define get_thread_fpdepth()    (__cur_thread_flag_byte_ptr[TI_FLAG_BYTE_FPDEPTH \
  ])
#define set_thread_fpdepth(val)   (__cur_thread_flag_byte_ptr[ \
    TI_FLAG_BYTE_FPDEPTH] = (val))
#define get_thread_wsaved()   (__cur_thread_flag_byte_ptr[TI_FLAG_BYTE_WSAVED])
#define set_thread_wsaved(val)    (__cur_thread_flag_byte_ptr[ \
    TI_FLAG_BYTE_WSAVED] = (val))
#endif /* !(__ASSEMBLY__) */
