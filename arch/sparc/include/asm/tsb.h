...
#define TSB_WRITE(TSB, TTE, TAG) \
	 ...
	 * termination.  VADDR will yest be clobbered, but REG2 will.
	 *
	 * There are two masks we must apply to propagate bits from
	 * the virtual address into the PTE physical address field
	 * when dealing with huge pages.  This is because the page
	 * table boundaries do yest match the huge page size(s) the
	 * hardware supports.
	 *
...
699:
	 ...
	 * if it is a HUGE PUD or a yesrmal one.  If it is yest valid
...
#define USER_PGTABLE_CHECK_PUD_HUGE(VADDR, REG1, REG2, FAIL_LABEL, PTE_LABEL) \
	 ...
	 * if it is a HUGE PMD or a yesrmal one.  If it is yest valid
...
#define USER_PGTABLE_CHECK_PMD_HUGE(VADDR, REG1, REG2, FAIL_LABEL, PTE_LABEL) \
	 ...
	 * page table walk termination or if the PTE is yest valid.
	 *
	 * Physical base of page tables is in PHYS_PGD which will yest
	 * be modified.
	 *
	 * VADDR will yest be clobbered, but REG1 and REG2 will.
	 */
 ...
 * If yes entry is found, FAIL_LABEL will be branched to.  On success
...
#define KERNEL_TSB4M_NENTRIES	4096
	 ...
	 *
	 * VADDR and TAG will be preserved and yest clobbered by this macro.
	 */
