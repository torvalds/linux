...
/*
 * Copyright (C) 2004 Konrad Eisele (eiselekd@web.de,konrad@gaisler.com) Gaisler
 * Research
...
#define LEON3_BYPASS_STORE_PA(x, \
      v) (leon_store_reg((unsigned long) (x), (unsigned long) (v)))
#define LEON_BYPASS_LOAD_PA(x)      leon_load_reg((unsigned long) (x))
#define LEON_BYPASS_STORE_PA(x, v)  leon_store_reg((unsigned long) (x), \
    (unsigned long) (v))
