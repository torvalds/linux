...
#define __nocache_va(PADDR) (__va((unsigned long) PADDR) \
  - (unsigned long) srmmu_nocache_pool + SRMMU_NOCACHE_VADDR)
...
static inline int srmmu_get_pte(unsigned long addr) {
