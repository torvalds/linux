...
#define UPA_PORTID_ECCVALID     0x0000000400000000 /* Zero if mod can generate
                                                    * ECC */
#define UPA_PORTID_ONEREAD      0x0000000200000000 /* Set if mod generates
                                                    * P_RASB  */
#define UPA_PORTID_PINTRDQ      0x0000000180000000 /* # outstanding P_INT_REQ's
                                                    *    */
#define UPA_PORTID_PREQDQ       0x000000007e000000 /* slave-wr's to mod
                                                    * supported  */
#define UPA_PORTID_PREQRD       0x0000000001e00000 /* # incoming P_REQ's
                                                    * supported */
