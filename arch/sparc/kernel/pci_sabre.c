...
#define  SABRE_UEAFSR_SDTE   0x0200000000000000UL /* Secondary DMA Translation
                                                   * Error */
#define  SABRE_UEAFSR_PDTE   0x0100000000000000UL /* Primary DMA Translation
                                                   * Error */
...
#define  SABRE_PCICTRL_MRLEN   0x0000001000000000UL /* Use MemoryReadLine for
                                                     * block loads/stores */
#define  SABRE_PCICTRL_SERR  0x0000000400000000UL /* Set when SERR asserted on
                                                   * PCI bus */
#define  SABRE_PCICTRL_ARBPARK   0x0000000000200000UL /* Bus Parking 0=Ultra-IIi
                                                       * 1=prev-bus-owner */
#define  SABRE_PCICTRL_CPUPRIO   0x0000000000100000UL /* Ultra-IIi granted every
                                                       * other bus cycle */
#define  SABRE_PCICTRL_ARBPRIO   0x00000000000f0000UL /* Slot which is granted
                                                       * every other bus cycle
                                                       * */
#define  SABRE_PCICTRL_ERREN   0x0000000000000100UL /* PCI Error Interrupt
                                                     * Enable */
#define  SABRE_PCICTRL_RTRYWE  0x0000000000000080UL /* DMA Flow Control
                                                     * 0=wait-if-possible
                                                     * 1=retry */
#define  SABRE_PCICTRL_AEN   0x000000000000000fUL /* Slot PCI arbitration
                                                   * enables */
...
#define  SABRE_PIOAFSR_SRTRY   0x0200000000000000UL /* Secondary Excessive
                                                     * Retries */
...
#define  SABRE_PCIDIAG_ELPBK   0x0000000000000001UL /* Loopback Enable - not
                                                     * supported */
#define SABRE_PCITASR   0x2028UL
#define  SABRE_PCITASR_EF  0x0000000000000080UL /* Respond to
                                                 * 0xe0000000-0xffffffff */
#define  SABRE_PCITASR_CD  0x0000000000000040UL /* Respond to
                                                 * 0xc0000000-0xdfffffff */
#define  SABRE_PCITASR_AB  0x0000000000000020UL /* Respond to
                                                 * 0xa0000000-0xbfffffff */
#define  SABRE_PCITASR_89  0x0000000000000010UL /* Respond to
                                                 * 0x80000000-0x9fffffff */
#define  SABRE_PCITASR_67  0x0000000000000008UL /* Respond to
                                                 * 0x60000000-0x7fffffff */
#define  SABRE_PCITASR_45  0x0000000000000004UL /* Respond to
                                                 * 0x40000000-0x5fffffff */
#define  SABRE_PCITASR_23  0x0000000000000002UL /* Respond to
                                                 * 0x20000000-0x3fffffff */
#define  SABRE_PCITASR_01  0x0000000000000001UL /* Respond to
...
#define SABRE_IOMMUDATA_PPN  0x00000000001fffffUL /* Physical Page Number
                                                   * [33:13] */
...
#define  SABRE_FFBCFG_ONEREAD  0x0000000000004000 /* Slave supports one
                                                  * outstanding read */
...
#define  SABRE_MCCTRL0_11BIT   0x0000000000001000 /* Enable 11-bit column
                                                   * addressing */
...
#define  SABRE_MCCTRL1_ARDC  0x0000000007000000 /* Advance DRAM Read Data Clock
                                                 * */
#define  SABRE_MCCTRL1_CSR   0x0000000000e00000 /* CAS to RAS delay for CBR
                                                 * refresh */
...
static int sabre_probe(struct platform_device *op) {
  ...
  /* Clear interrupts
   * PCI first*/
  for (clear_irq = SABRE_ICLR_A_SLOT0; clear_irq < SABRE_ICLR_B_SLOT0 + 0x80;
      clear_irq += 8) {
    upa_writeq(0x0UL, pbm->controller_regs + clear_irq);
  }
  /* Then OBIO */
  for (clear_irq = SABRE_ICLR_SCSI; clear_irq < SABRE_ICLR_SCSI + 0x80;
      clear_irq += 8) {
    upa_writeq(0x0UL, pbm->controller_regs + clear_irq);
  }
