...
#define  PSYCHO_CONTROL_IMPL   0xf000000000000000UL /* Implementation of this
                                                     * PSYCHO*/
...
#define  PSYCHO_CONTROL_RESV     0x00003ffffffffff0UL /* Reserved
                                                       *                     */
#define  PSYCHO_CONTROL_APCKEN   0x0000000000000008UL /* Address Parity Check
                                                       * Enable  */
#define  PSYCHO_CONTROL_APERR  0x0000000000000004UL /* Incoming System Addr
                                                     * Parerr  */
...
#define  PSYCHO_PCICTRL_RESV1  0xfffffff000000000UL /* Reserved
                                                     *                     */
#define  PSYCHO_PCICTRL_SBH_ERR  0x0000000800000000UL /* Streaming byte hole
                                                       * error    */
#define  PSYCHO_PCICTRL_SERR   0x0000000400000000UL /* SERR signal asserted
                                                     *         */
#define  PSYCHO_PCICTRL_SPEED  0x0000000200000000UL /* PCI speed (1 is U2P
                                                     * clock)   */
...
#define  PSYCHO_PCICTRL_RESV3  0x00000000001ff800UL /* Reserved
                                                     *                     */
#define  PSYCHO_PCICTRL_SBH_INT  0x0000000000000400UL /* Streaming byte hole int
                                                       * enab */
...
#define  PSYCHO_STRBUF_CTRL_DENAB   0x0000000000000002UL /* Diagnostic Mode
                                                          * Enable */
#define  PSYCHO_STRBUF_CTRL_ENAB    0x0000000000000001UL /* Streaming Buffer
                                                          * Enable */
...
#define  PSYCHO_IOMMU_CTRL_RESV     0xfffffffff9000000UL /* Reserved
                                                          *
                                                          *                   */
#define  PSYCHO_IOMMU_CTRL_XLTESTAT 0x0000000006000000UL /* Translation Error
                                                          * Status      */
#define  PSYCHO_IOMMU_CTRL_XLTEERR  0x0000000001000000UL /* Translation Error
                                                          * encountered */
#define  PSYCHO_IOMMU_CTRL_LCKEN    0x0000000000800000UL /* Enable translation
                                                          * locking    */
#define  PSYCHO_IOMMU_CTRL_LCKPTR   0x0000000000780000UL /* Translation lock
                                                          * pointer      */
#define  PSYCHO_IOMMU_CTRL_TSBSZ    0x0000000000070000UL /* TSB Size
                                                          *
                                                          *                   */
#define  PSYCHO_IOMMU_TSBSZ_1K      0x0000000000000000UL /* TSB Table 1024
                                                          * 8-byte entries */
#define  PSYCHO_IOMMU_TSBSZ_2K      0x0000000000010000UL /* TSB Table 2048
                                                          * 8-byte entries */
#define  PSYCHO_IOMMU_TSBSZ_4K      0x0000000000020000UL /* TSB Table 4096
                                                          * 8-byte entries */
#define  PSYCHO_IOMMU_TSBSZ_8K      0x0000000000030000UL /* TSB Table 8192
                                                          * 8-byte entries */
#define  PSYCHO_IOMMU_TSBSZ_16K     0x0000000000040000UL /* TSB Table 16k 8-byte
                                                          * entries  */
#define  PSYCHO_IOMMU_TSBSZ_32K     0x0000000000050000UL /* TSB Table 32k 8-byte
                                                          * entries  */
#define  PSYCHO_IOMMU_TSBSZ_64K     0x0000000000060000UL /* TSB Table 64k 8-byte
                                                          * entries  */
#define  PSYCHO_IOMMU_TSBSZ_128K    0x0000000000070000UL /* TSB Table 128k
                                                          * 8-byte entries */
#define  PSYCHO_IOMMU_CTRL_RESV2    0x000000000000fff8UL /* Reserved
                                                          *
                                                          *                   */
#define  PSYCHO_IOMMU_CTRL_TBWSZ    0x0000000000000004UL /* Assumed page size,
                                                          * 0=8k 1=64k */
#define  PSYCHO_IOMMU_CTRL_DENAB    0x0000000000000002UL /* Diagnostic mode
                                                         * enable        */
...
#define  PSYCHO_UEAFSR_SDRD 0x0800000000000000UL /* Secondary DVMA read is cause
                                                  * */
#define  PSYCHO_UEAFSR_SDWR 0x0400000000000000UL /* Secondary DVMA write is
                                                  * cause*/
...
#define  PSYCHO_CEAFSR_SDRD 0x0800000000000000UL /* Secondary DVMA read is cause
                                                  * */
#define  PSYCHO_CEAFSR_SDWR 0x0400000000000000UL /* Secondary DVMA write is
                                                  * cause*/
...
#define  PSYCHO_PCIDIAG_DRETRY   0x0000000000000040UL /* Disable retry limit
                                                       *          */
#define  PSYCHO_PCIDIAG_DISYNC   0x0000000000000020UL /* Disable DMA wr / irq
                                                       * sync    */
#define  PSYCHO_PCIDIAG_DDWSYNC  0x0000000000000010UL /* Disable DMA wr / PIO rd
                                                       * sync */
...
#define  PSYCHO_PCIDIAG_IPDPAR   0x0000000000000004UL /* Invert PIO data parity
                                                       *       */
#define  PSYCHO_PCIDIAG_IPAPAR   0x0000000000000002UL /* Invert PIO address
                                                       * parity    */
