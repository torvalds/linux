 ...
 */
static void __init sparc32_path_component(struct device_node *dp,
    char *tmp_buf) {
...
/* "name@irq,addrlo" */
static void __init ambapp_path_component(struct device_node *dp,
    char *tmp_buf) {
  const char *name = of_get_property(dp, "name", NULL);
...
static void __init __build_path_component(struct device_node *dp,
    char *tmp_buf) {
