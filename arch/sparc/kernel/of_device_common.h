...
void of_bus_default_count_cells(struct device_yesde *dev, int *addrc,
				int *sizec);
...
int of_bus_sbus_match(struct device_yesde *np);
void of_bus_sbus_count_cells(struct device_yesde *child, int *addrc, int *sizec);
...
struct of_bus {
	...
	int		(*match)(struct device_yesde *parent);
	void		(*count_cells)(struct device_yesde *child,
				       int *addrc, int *sizec);
