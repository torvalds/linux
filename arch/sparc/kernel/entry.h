...
void sun4v_yesnresum_error(struct pt_regs *regs,
			  unsigned long offset);
...
/* WARNING: The error trap handlers in assembly kyesw the precise
...
/*0x48*/u64 dcache_stag;	/* D-cache syesoptag	*/
...
/*0xa8*/u64 icache_stag;	/* I-cache syesoptag	*/
...
/* UPA yesdes send interrupt packet to UltraSparc with first data reg
 * value low 5 (7 on Starfire) bits holding the IRQ identifier being
 * delivered.  We must translate this into a yesn-vector IRQ so we can
 ...
 *
 * If you make changes to iyes_bucket, please update hand coded assembler
...
extern struct iyes_bucket *ivector_table;
