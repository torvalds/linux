...
static int find_sections64(const struct vdso_image *image,
    struct vdso_elfinfo *_e) {
...
static int find_sections32(const struct vdso_image *image,
    struct vdso_elfinfo *_e) {
...
static int stick_patch(const struct vdso_image *image, struct vdso_elfinfo *e,
    bool elf64) {
  int err;
