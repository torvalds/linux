...
do {								\
	...
	*prog++ = OPCODE | RS1(r_A) | RS2(r_X) | RD(r_A);	\
	 ...
	 * immediate instruction field.  Emit yesthing if K
	 * is zero.
	 */
...
/* A yeste about branch offset calculations.  The addrs[] array,
 ...
 * what "." would be in assembler yestation.  The "8" part is
...
void bpf_jit_compile(struct bpf_prog *fp)
{
	...
	for (pass = 0; pass < 10; pass++) {
		...
		/* yes prologue/epilogue for trivial filters (RET something) */
		proglen = 0;
		prog = temp;
