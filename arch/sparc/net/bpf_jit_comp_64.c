...
static void emit_branch(unsigned int br_opc, unsigned int from_idx,
    unsigned int to_idx,
    struct jit_ctx *ctx) {
...
static void emit_cbcond(unsigned int cb_opc, unsigned int from_idx,
    unsigned int to_idx,
...
static void emit_cbcondi(unsigned int cb_opc, unsigned int from_idx,
    unsigned int to_idx,
