...
COMPAT_SYSCALL_DEFINE3(s390_truncate64, const char __user *, path, u32, high,
    u32, low)
{
...
COMPAT_SYSCALL_DEFINE5(s390_pwrite64, unsigned int, fd, const char __user *,
    ubuf,
    compat_size_t, count, u32, high, u32, low)
{
  if ((compat_ssize_t) count < 0) {
...
COMPAT_SYSCALL_DEFINE2(s390_stat64, const char __user *, filename,
...
COMPAT_SYSCALL_DEFINE2(s390_lstat64, const char __user *, filename,
    struct stat64_emu31 __user *, statbuf)
{
  struct kstat stat;
...
COMPAT_SYSCALL_DEFINE2(s390_fstat64, unsigned int, fd,
    struct stat64_emu31 __user *, statbuf)
{
  struct kstat stat;
...
COMPAT_SYSCALL_DEFINE4(s390_fstatat64, unsigned int, dfd, const char __user *,
    filename,
...
COMPAT_SYSCALL_DEFINE1(s390_old_mmap, struct mmap_arg_struct_emu31 __user *,
    arg)
{
...
COMPAT_SYSCALL_DEFINE3(s390_write, unsigned int, fd, const char __user *, buf,
    compat_size_t, count)
{
  if ((compat_ssize_t) count < 0) {
    return -EINVAL;
...
COMPAT_SYSCALL_DEFINE1(s390_fadvise64_64, struct fadvise64_64_args __user *,
    args)
{
...
COMPAT_SYSCALL_DEFINE6(s390_fallocate, int, fd, int, mode, u32, offhigh, u32,
    offlow,
