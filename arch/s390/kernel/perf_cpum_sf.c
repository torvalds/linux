...
static int allocate_buffers(struct cpu_hw_sf *cpuhw,
    struct hw_perf_event *hwc) {
...
static unsigned long compute_sfb_extent(unsigned long ratio,
    unsigned long base) {
...
static inline unsigned long aux_sdb_num(unsigned long start,
    unsigned long end) {
...
static int aux_output_begin(struct perf_output_handle *handle,
  ...
  cpuhw->lsctl.tear = virt_to_phys((void *) base) + offset
