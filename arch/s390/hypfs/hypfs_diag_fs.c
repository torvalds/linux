...
static void *hypfs_create_lpar_files(struct dentry *systems_dir,
    void *part_hdr) {
...
static int hypfs_create_phys_cpu_files(struct dentry *cpus_dir,
    void *cpu_info) {
  struct dentry *cpu_dir;
  char buffer[TMP_SIZE];
  void *rc;
...
static void *hypfs_create_phys_files(struct dentry *parent_dir,
    void *phys_hdr) {
  int i;
  void *cpu_info;
  struct dentry *cpus_dir;
