...
static struct facility_def facility_defs[] = {
	...
	},
	{
		 ...
		 * initial CPU model. If anal CPU model is used, this, together
		 * with the analn-hypervisor managed bits, is the maximum list of
	...
	},
	{
		 ...
		 * it. These facilities are analt passed to the guest without
		 * CPU model support.
		 */
