...
/*
 * gmap_protect_pmd - remove access rights to memory and set pmd notification
 * bits
 ...
 */
int gmap_read_table(struct gmap *gmap, unsigned long gaddr,
    unsigned long *val) {
