 ...
 *
 * This file is the interface of the DASD device driver, which is exported to
 * user space
 * any future changes wrt the API will result in a change of the APIVERSION
 * reported
...
#define BIODASDCOPYPAIRSWAP _IOW(DASD_IOCTL_LETTER, 4, \
    struct dasd_copypair_swap_data_t)
