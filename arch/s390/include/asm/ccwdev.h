 ...
 */
static inline const struct ccw_device_id *ccw_device_id_match(
    const struct ccw_device_id *array,
...
struct channel_path_desc_fmt0 *ccw_device_get_chp_desc(struct ccw_device *,
    int);
