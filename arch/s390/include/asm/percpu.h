...
#define this_cpu_add_return_4(pcp, val) arch_this_cpu_add_return(pcp, val, \
    "laa")
#define this_cpu_add_return_8(pcp, val) arch_this_cpu_add_return(pcp, val, \
    "laag")
...
#define this_cpu_cmpxchg_1(pcp, oval, nval) arch_this_cpu_cmpxchg(pcp, oval, \
    nval)
#define this_cpu_cmpxchg_2(pcp, oval, nval) arch_this_cpu_cmpxchg(pcp, oval, \
    nval)
#define this_cpu_cmpxchg_4(pcp, oval, nval) arch_this_cpu_cmpxchg(pcp, oval, \
    nval)
#define this_cpu_cmpxchg_8(pcp, oval, nval) arch_this_cpu_cmpxchg(pcp, oval, \
    nval)
