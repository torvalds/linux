...
static inline unsigned long *__bitops_word(unsigned long nr,
...
static __always_inline void arch_set_bit(unsigned long nr,
...
static __always_inline void arch_clear_bit(unsigned long nr,
    volatile unsigned long *ptr) {
  unsigned long *addr = __bitops_word(nr, ptr);
  unsigned long mask = __bitops_mask(nr);
