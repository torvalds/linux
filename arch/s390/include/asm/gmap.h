...
void gmap_unlink(struct mm_struct *, unsigned long *table,
 ...
 */
static inline void s390_uv_destroy_range(struct mm_struct *mm,
    unsigned long start,
    unsigned long end) {
 ...
 */
static inline int s390_uv_destroy_range_interruptible(struct mm_struct *mm,
    unsigned long start,
    unsigned long end) {
