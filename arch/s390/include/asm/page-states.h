...
static __always_inline unsigned long essa(unsigned long paddr,
    unsigned char cmd) {
  unsigned long rc;
  asm volatile (
...
static __always_inline void __set_page_state(void *addr,
...
static inline void __set_page_stable_nodat(void *addr,
    unsigned long num_pages) {
