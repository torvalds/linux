 ...
 */
static inline dma64_t *idal_create_words(dma64_t *idaws, void *vaddr,
    unsigned int length) {
  dma64_t paddr = virt_to_dma64(vaddr);
  unsigned int cidaw;
  *idaws++ = paddr;
 ...
 */
static inline struct idal_buffer *idal_buffer_alloc(size_t size,
    int page_order) {
 ...
 */
static inline void idal_buffer_set_cda(struct idal_buffer *ib,
    struct ccw1 *ccw) {
  void *vaddr;
 ...
 */
static inline size_t idal_buffer_to_user(struct idal_buffer *ib,
 ...
 */
static inline size_t idal_buffer_from_user(struct idal_buffer *ib,
