 ...
 * the least significant bits canyest be used as software bits to encode
...
#define __HEXAGON_C_WB		0x0	/* Write-back, yes L2 */
#define	__HEXAGON_C_WT		0x1	/* Write-through, yes L2 */
