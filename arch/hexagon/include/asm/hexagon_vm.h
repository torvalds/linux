...
static inline long __vmintop_yesp(void)
{
	return __vmintop(hvmi_yesp, 0, 0, 0, 0);
}
 ...
 * code to indicate what is there.  Zero means yesthing more.
 */
...
/* These shoud be nuked as soon as we kyesw the VM is up to spec v0.1.1 */
