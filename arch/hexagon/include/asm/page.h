...
/*  This is probably yest the most graceful way to handle this.  */
...
/*
 *  These should be defined in hugetlb.h, but apparently yest.
 *  "Huge" for us should be 4MB or 16MB, which are both represented
 *  in L1 PTE's.  Right yesw, it's set up for 4MB.
 */
 ...
 * asm-generic/pagetable-yespmd.h and asm-generic/pagetable-yespud.h
 */
...
/* Default vm area behavior is yesn-executable.  */
...
/*  Need to yest use a define for linesize; may move this to ayesther file.  */
