 ...
 * This code was originally in atari/config.c, but I yesticed
 ...
 * error would cause ayesther bus error while fetching the exception
 * vector, and the CPU would do yesthing at all. So we needed to set up
...
int hwreg_write(volatile void *regp, unsigned short val)
{
	...
	__asm__ __volatile__ (
		...
		"yesp\n\t"
		/*
		 * If this yesp isn't present, 'ret' may already be loaded
