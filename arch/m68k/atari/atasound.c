 ...
 *
 * The author of atari_yessound, atari_mksound and atari_microwire_cmd is
 * unkyeswn. (++roman: That's me... :-)
 *
 ...
 *			 yes timer, atari_yessound removed.
 *
 */
...
void atari_mksound (unsigned int hz, unsigned int ticks)
{
	...
	if (ticks) {
		...
		/* Set generator A level to maximum, yes envelope.  */
		sound_ym.rd_data_reg_sel = 8;
		sound_ym.wd_data = 15;
	}
