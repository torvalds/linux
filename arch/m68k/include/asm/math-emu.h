...
.macro fp_get_fp_reg lea(FPD_FPREG, FPDATA, % d0.w *4), % a0 lea(% a0,
    % d0.w *8),
% a0
.endm
...
.if \ nr movestack(\ nr - 1), \ arg2, \ arg3, \ arg4, \ arg5
move.l  \ arg1, -(% sp)
.endif
.endm
...
jeq.Lpskip \ @
.endif
movestack \ nr, \ arg1, \ arg2, \ arg3, \ arg4, \ arg5
pea.Lpdata \ @
jsr printk lea((\ nr + 1) *4, % sp), % sp
.Lpskip \ @:
