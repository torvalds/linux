...
#define AC_M_SFSR     0x0300        /* shv Synchroyesus Fault Status Reg      */
#define AC_M_SFAR     0x0400        /* shv Synchroyesus Fault Address Reg     */
#define AC_M_AFSR     0x0500        /*  hv Asynchroyesus Fault Status Reg     */
#define AC_M_AFAR     0x0600        /*  hv Asynchroyesus Fault Address Reg    */
