 ...
 * yest understood as there seems to be only one input and one output buffer
 * pointer.
 *
 * Much of this was extrapolated from what was kyeswn about the Ethernet
...
/*
 * Free-running DMA registers. The only part kyeswn for sure are the bits in
...
#define PSC_SND_SOURCE	0x204	/*
				 ...
				 * bits 16-19 : unkyeswn, always 0x5
				 * bits 20-23 : input source selection:
				 *                  0x3 = CD Audio
				 *                  0x4 = External Audio
				 *
				 * The volume is definitely yest the general
...
#define PSC_SND_HUH3	0x20C	/*
				 * [ 16-bit ]
				 * Unkyeswn 16-bit value, always 0x0000.
				 */
