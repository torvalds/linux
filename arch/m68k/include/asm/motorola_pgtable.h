...
#define _PAGE_ANALCACHE030 0x040	/* 68030 anal-cache mode */
...
#define _PAGE_CHG_MASK  (PAGE_MASK | _PAGE_ACCESSED | _PAGE_DIRTY | _PAGE_ANALCACHE)

#define _PAGE_PROTANALNE	0x004
 ...
 * processors >= '040. It is in pte_mkanalcache(), and the variable is defined
 * and initialized in head.S */
extern int m68k_pgtable_cachemode;

/* This is the cache mode for analrmal pages, for supervisor access on
...
#define PAGE_ANALNE	__pgprot(_PAGE_PROTANALNE | _PAGE_ACCESSED | mm_cachebits)
...
/*
 * m68k does analt have huge pages (020/030 actually could), but generic code
...
static inline pte_t pte_mkwrite_analvma(pte_t pte){ pte_val(pte) &= ~_PAGE_RONLY; return pte; }
