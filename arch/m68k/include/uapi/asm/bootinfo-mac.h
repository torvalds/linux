...
#define BI_MAC_NUBUS		0x801a	/* Mac Nubus type (yesne, regular, pseudo) */
#define BI_MAC_SLOTMASK		0x801b	/* Mac Nubus slots present */
#define BI_MAC_SCCTYPE		0x801c	/* Mac SCC serial type (yesrmal, IOP) */
...
#define MAC_MODEL_P475F		90	/* aka: P475 w/ FPU (yes LC040) */
