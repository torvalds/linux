...
|
	...
	.set	deyesrm_bit,7		| bit determines if deyesrm or unyesrm
...
|
	...
	.set	nan_bit,0	|  yest-a-number result
|
	.set	q_sn_bit,7	|  sign bit of quotient byte
|
	.set	bsun_bit,7	|  branch on uyesrdered
...
|
|
	.set	yesrm_tag,0x00	|  tag bits in {7:5} position
	.set	zero_tag,0x20
	.set	inf_tag,0x40
	.set	nan_tag,0x60
	.set	dnrm_tag,0x80
