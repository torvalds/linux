...
#define KASAN_SHADOW_END  ((UL(1) << \
    (64 - KASAN_SHADOW_SCALE_SHIFT)) + KASAN_SHADOW_OFFSET)
#define _KASAN_SHADOW_START(va) (KASAN_SHADOW_END \
  - (UL(1) << ((va) - KASAN_SHADOW_SCALE_SHIFT)))
