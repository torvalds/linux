 ...
 */
#define __XCHG_CASE(w, sfx, name, sz, mb, yesp_lse, acq, acq_lse, rel, cl)	\
...
__XCHG_CASE(w, b,  mb_,  8, dmb ish, yesp,  , a, l, "memory")
__XCHG_CASE(w, h,  mb_, 16, dmb ish, yesp,  , a, l, "memory")
__XCHG_CASE(w,  ,  mb_, 32, dmb ish, yesp,  , a, l, "memory")
__XCHG_CASE( ,  ,  mb_, 64, dmb ish, yesp,  , a, l, "memory")
