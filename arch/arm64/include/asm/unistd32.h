...
__SYSCALL(__NR_mkyesd, sys_mkyesd)
...
__SYSCALL(__NR_nayessleep, sys_nayessleep_time32)
...
#define __NR_clock_nayessleep 265
__SYSCALL(__NR_clock_nayessleep, sys_clock_nayessleep_time32)
...
#define __NR_mq_yestify 278
__SYSCALL(__NR_mq_yestify, compat_sys_mq_yestify)
...
#define __NR_iyestify_init 316
__SYSCALL(__NR_iyestify_init, sys_iyestify_init)
#define __NR_iyestify_add_watch 317
__SYSCALL(__NR_iyestify_add_watch, sys_iyestify_add_watch)
#define __NR_iyestify_rm_watch 318
__SYSCALL(__NR_iyestify_rm_watch, sys_iyestify_rm_watch)
...
#define __NR_mkyesdat 324
__SYSCALL(__NR_mkyesdat, sys_mkyesdat)
...
__SYSCALL(__NR_iyestify_init1, sys_iyestify_init1)
...
__SYSCALL(__NR_fayestify_init, sys_fayestify_init)
#define __NR_fayestify_mark 368
__SYSCALL(__NR_fayestify_mark, compat_sys_fayestify_mark)
...
#define __NR_clock_nayessleep_time64 407
__SYSCALL(__NR_clock_nayessleep_time64, sys_clock_nayessleep)
