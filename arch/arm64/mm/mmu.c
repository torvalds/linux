...
static inline phys_addr_t arm64_kfence_alloc_pool(void) {
  return 0;
}
...
void mark_rodata_ro(void) {
  ...
  update_mapping_prot(__pa_symbol(
      __start_rodata), (unsigned long) __start_rodata,
...
static u8 idmap_ptes[IDMAP_LEVELS
    - 1][PAGE_SIZE] __aligned(PAGE_SIZE) __ro_after_init,
