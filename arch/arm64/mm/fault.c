...
static inline const struct fault_info *esr_to_debug_fault_info(
    unsigned long esr) {
...
static inline bool is_el1_permission_fault(unsigned long addr,
    unsigned long esr,
    struct pt_regs *regs) {
...
static const struct fault_info fault_info[] = {
  ...
  { do_sea, SIGBUS, BUS_OBJERR, "synchronous parity or ECC error" },  // Reserved
                                                                      // when
                                                                      // RAS is
                                                                      // implemented
  { do_bad, SIGKILL, SI_KERNEL, "unknown 25"      },
  { do_bad, SIGKILL, SI_KERNEL, "unknown 26"      },
  { do_sea, SIGKILL, SI_KERNEL,
    "level -1 synchronous parity error (translation table walk)"  },  // Reserved
                                                                      // when
                                                                      // RAS is
                                                                      // implemented
  { do_sea, SIGKILL, SI_KERNEL,
    "level 0 synchronous parity error (translation table walk)" },  // Reserved
                                                                    // when RAS
                                                                    // is
                                                                    // implemented
  { do_sea, SIGKILL, SI_KERNEL,
    "level 1 synchronous parity error (translation table walk)" },  // Reserved
                                                                    ...
                                                                    // implemented
  { do_sea, SIGKILL, SI_KERNEL,
    "level 2 synchronous parity error (translation table walk)" },  // Reserved
                                                                    // when RAS
                                                                    // is
                                                                    // implemented
  { do_sea, SIGKILL, SI_KERNEL,
    "level 3 synchronous parity error (translation table walk)" },  // Reserved
                                                                    // when RAS
                                                                    // is
                                                                    // implemented
...
void do_sp_pc_abort(unsigned long addr, unsigned long esr,
    struct pt_regs *regs) {
