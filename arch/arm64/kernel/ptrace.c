...
static int fpr_active(struct task_struct *target,
    const struct user_regset *regset) {
...
static int fpmr_set(struct task_struct *target,
    const struct user_regset *regset,
    unsigned int pos, unsigned int count,
    const void *kbuf, const void __user *ubuf) {
  int ret;
...
static inline compat_ulong_t compat_get_user_reg(struct task_struct *task,
    int idx) {
