...
static void compat_cntfrq_read_handler(unsigned long esr,
    struct pt_regs *regs) {
...
static void compat_cntvct_read_handler(unsigned long esr,
    struct pt_regs *regs) {
...
void __noreturn panic_bad_stack(struct pt_regs *regs, unsigned long esr,
    unsigned long far) {
