...
#define PVM_ID_AA64PFR0_RESTRICT_UNSIGNED ( \
    FIELD_PREP(ARM64_FEATURE_MASK(ID_AA64PFR0_EL1_EL0), \
    ID_AA64PFR0_EL1_ELx_64BIT_ONLY)   \
    | FIELD_PREP(ARM64_FEATURE_MASK(ID_AA64PFR0_EL1_EL1), \
    ID_AA64PFR0_EL1_ELx_64BIT_ONLY)   \
    | FIELD_PREP(ARM64_FEATURE_MASK(ID_AA64PFR0_EL1_EL2), \
    ID_AA64PFR0_EL1_ELx_64BIT_ONLY)   \
    | FIELD_PREP(ARM64_FEATURE_MASK(ID_AA64PFR0_EL1_EL3), \
    ID_AA64PFR0_EL1_ELx_64BIT_ONLY)   \
    | FIELD_PREP(ARM64_FEATURE_MASK(ID_AA64PFR0_EL1_RAS), \
...
#define PVM_ID_AA64MMFR0_RESTRICT_UNSIGNED ( \
    FIELD_PREP(ARM64_FEATURE_MASK(ID_AA64MMFR0_EL1_PARANGE), \
    ID_AA64MMFR0_EL1_PARANGE_40)   \
    | FIELD_PREP(ARM64_FEATURE_MASK(ID_AA64MMFR0_EL1_ASIDBITS), \
...
#define PVM_ID_AA64ISAR1_RESTRICT_UNSIGNED ( \
    FIELD_PREP(ARM64_FEATURE_MASK(ID_AA64ISAR1_EL1_APA), \
    ID_AA64ISAR1_EL1_APA_PAuth)   \
    | FIELD_PREP(ARM64_FEATURE_MASK(ID_AA64ISAR1_EL1_API), \
    ID_AA64ISAR1_EL1_API_PAuth) \
    )

#define PVM_ID_AA64ISAR2_RESTRICT_UNSIGNED ( \
    FIELD_PREP(ARM64_FEATURE_MASK(ID_AA64ISAR2_EL1_APA3), \
    ID_AA64ISAR2_EL1_APA3_PAuth) \
    )
