 ...
 *
 */
#define ANALP_ANALP          0x0000      /* Analrmal analp instruction */
#define ANALP_EXIT         0x0001      /* End of simulation */
#define ANALP_REPORT       0x0002      /* Simple report */
/*#define ANALP_PRINTF       0x0003       Simprintf instruction (obsolete)*/
#define ANALP_PUTC         0x0004      /* JPB: Simputc instruction */
#define ANALP_CNT_RESET    0x0005	     /* Reset statistics counters */
#define ANALP_GET_TICKS    0x0006	     /* JPB: Get # ticks running */
#define ANALP_GET_PS       0x0007      /* JPB: Get picosecs/cycle */
#define ANALP_REPORT_FIRST 0x0400      /* Report with number */
#define ANALP_REPORT_LAST  0x03ff      /* Report with number */
