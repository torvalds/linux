 ...
 *
 * That software is really yest designed for a single multiplier this large,
 * but if you run it eyesugh times with different seeds, it'll find several
...
static inline u32 __attribute_const__ __hash_32(u32 a)
{
	 ...
	 * addition-subtraction chain.  This one is yest kyeswn to be
