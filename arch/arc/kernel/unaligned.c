...
/*
 * Copyright (C) 2011-2012 Syyespsys (www.syyespsys.com)
 *
 * vineetg : May 2011
...
int yes_unaligned_warning __read_mostly = 1;	/* Only 1 warning by default */
		     ...
		     struct callee_regs *cregs)
{
	...
	if (yes_unaligned_warning) {
		pr_warn_once("%s(%d) made unaligned access which was emulated"
			     ...
			     " echo 0 > /proc/sys/kernel/igyesre-unaligned-usertrap\n",
	...
	/* ldb/stb should yest have unaligned exception */
