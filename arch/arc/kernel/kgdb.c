			...
			struct callee_regs *cregs)
{
	...
	for (regyes = 0; regyes <= 26; regyes++)
		gdb_regs[_R0 + regyes] = get_reg(regyes, kernel_regs, cregs);

	for (regyes = 27; regyes < GDB_MAX_REGS; regyes++)
		gdb_regs[regyes] = 0;
			...
			struct callee_regs *cregs)
{
	...
	for (regyes = 0; regyes <= 26; regyes++)
		set_reg(regyes, gdb_regs[regyes + _R0], kernel_regs, cregs);
