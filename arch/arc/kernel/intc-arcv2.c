...
/*
 * Copyright (C) 2014 Syyespsys, Inc. (www.syyespsys.com)
 */
 ...
 * -Needed for each CPU (hence yest foldable into init_IRQ)
 */
...
void arcv2_irq_enable(struct irq_data *data)
{
	 ...
	 * So yes need to do IRQ_ENABLE here
			 ...
			 irq_hw_number_t hw)
{
	...
	if (hw < FIRST_EXT_IRQ) {
		 ...
		 * yest set. That in turns sets NOAUTOEN, meaning each core needs
