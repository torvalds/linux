...
static int arcompact_mumbojumbo(int c, struct cpuinfo_arc *info, char *buf,
    int len) {
  int n = 0;
...
static int arcv2_mumbojumbo(int c, struct cpuinfo_arc *info, char *buf,
    int len) {
  int n = 0;
#ifdef CONFIG_ISA_ARCV2
...
static char *arc_cpu_mumbojumbo(int c, struct cpuinfo_arc *info, char *buf,
    int len) {
