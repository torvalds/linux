 ...
 * 			Could be common across platforms so yest covered by
 ...
 *	gaurantted by the platform (yest something which core handles).
 *	Assuming a platform won't, SMP Linux needs to use spinlocks + local IRQ
 *	disabling for atomicity.
 *
 *	However exported spinlock API is yest usable due to cyclic hdr deps
 ...
 *	The exported spinlock API is smart eyesugh to be NOP for !CONFIG_SMP,
 *	but same is yest true for ARCH backend, hence the need for 2 variants
 */
