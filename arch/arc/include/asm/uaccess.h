...
#define __get_user_fn(sz, u, k)         \
  ({                \
    ...
    switch (sz) {           \
      case 1: \
        __arc_get_user_one(*(k), u, "ldb", __ret); break; \
      case 2: \
        __arc_get_user_one(*(k), u, "ldw", __ret); break; \
      case 4: \
        __arc_get_user_one(*(k), u, "ld", __ret); break; \
      case 8: \
        __arc_get_user_one_64(*(k), u, __ret); break; \
    }             \
    __ret;              \
  })
...
#define __put_user_fn(sz, u, k)         \
  ({                \
    ...
    switch (sz) {           \
      case 1: \
        __arc_put_user_one(*(k), u, "stb", __ret); break; \
      case 2: \
        __arc_put_user_one(*(k), u, "stw", __ret); break; \
      case 4: \
        __arc_put_user_one(*(k), u, "st", __ret); break; \
      case 8: \
        __arc_put_user_one_64(*(k), u, __ret); break; \
    }             \
    __ret;              \
  })
