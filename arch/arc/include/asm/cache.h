...
/* In case $$ yest config, setup a dummy number for rest of kernel */
 ...
 * Default ARCH_SLAB_MINALIGN is __aligyesf__(long long) which has a relaxed
 * value of 4 (and yest 8) in ARC ABI.
 */
