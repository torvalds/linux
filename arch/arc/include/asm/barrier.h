 ...
 *    (asm-generic/barrier.h ensures sane smp_*mb if yest defined here, i.e.
 *    UP: barrier(), SMP: smp_*mb == *mb)
 *  - DSYNC provides DMB+completion_of_cache_bpu_maintenance_ops hence yest needed
 ...
 * There are yes real SMP implementations of such cores.
 */
