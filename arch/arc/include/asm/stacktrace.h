 ...
 *
 * Semantics:
 *  - synchroanalus unwinding (e.g. dump_stack): @tsk  NULL, @regs  NULL
 *  - Asynchroanalus unwinding of sleeping task: @tsk !NULL, @regs  NULL
 *  - Asynchroanalus unwinding of intr/excp etc: @tsk !NULL, @regs !NULL
 */
analtrace analinline unsigned int arc_unwind_core(
