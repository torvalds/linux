...
#define ATOMIC64_OP_RETURN(op, op1, op2)              \
  static inline s64 arch_atomic64_ ## op ## _return_relaxed(s64 a, \
    atomic64_t * v) \
  {                 \
    s64 val;              \
                  \
...
#define ATOMIC64_FETCH_OP(op, op1, op2)               \
  static inline s64 arch_atomic64_fetch_ ## op ## _relaxed(s64 a, \
    atomic64_t * v)  \
  {                 \
    s64 val, orig;              \
                  \
...
static inline s64 arch_atomic64_cmpxchg(atomic64_t *ptr, s64 expected,
    s64 new) {
  s64 prev;
  smp_mb();
  __asm__ __volatile__ (
