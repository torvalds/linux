...
static unsigned char rwa_unlock[] __initdata = {
  0x00, 0x00, 0x6a, 0xb5, 0xda, 0xed, 0xf6, 0xfb, 0x7d, 0xbe, 0xdf, 0x6f, 0x37,
  0x1b,
  0x0d, 0x86, 0xc3, 0x61, 0xb0, 0x58, 0x2c, 0x16, 0x8b, 0x45, 0xa2, 0xd1, 0xe8,
  0x74,
...
#define WRITE_RWA(r, v) do { outb((r), 0x279); udelay(10); outb((v), 0xa79); \
} while (0)
...
static inline void rwa010_soundblaster_init(int sb_base, int al_base, int irq,
    int dma) {
  int i;
  WRITE_RWA(7, 1);
 ...
 * the parameter page.
 */
static void __init fixup_netwinder(struct tag *tags, char **cmdline) {
#ifdef CONFIG_ISAPNP
