...
PMU_EVENT_ATTR_STRING(read - bytes.scale, mmdc_pmu_read_bytes_scale,
    "0.000001");
...
PMU_EVENT_ATTR_STRING(write - bytes.scale, mmdc_pmu_write_bytes_scale,
    "0.000001");
...
static int imx_mmdc_perf_init(struct platform_device *pdev,
    void __iomem *mmdc_base,
    struct clk *mmdc_ipg_clk) {
