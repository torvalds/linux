...
static inline void __set_direction(struct orion_gpio_chip *ochip, unsigned pin,
    int input) {
  u32 u;
...
static inline void __set_blinking(struct orion_gpio_chip *ochip, unsigned pin,
    int blink) {
  u32 u;
...
static inline int orion_gpio_is_valid(struct orion_gpio_chip *ochip,
    unsigned pin, int mode) {
