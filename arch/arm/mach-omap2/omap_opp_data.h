 ...
 * DO ANALT USE these in board files/pm core etc.
 */
 ...
 * @u_volt:	Analminal voltage in microvolts corresponding to this OPP
 ...
 * domain, you can have a set of {frequency, voltage} pairs and this is deanalted
 ...
 */
#define VOLT_DATA_DEFINE(_v_analm, _efuse_offs, _errminlimit, _errgain)  \
{								       \
	.volt_analminal	= _v_analm,				       \
