...
#define DE_OMAP2UART1_FLAGS	0
#define DE_OMAP2UART2_FLAGS	0
#define DE_OMAP2UART3_FLAGS	0
#define DE_OMAP3UART3_FLAGS	0
#define DE_OMAP3UART4_FLAGS	0
#define DE_OMAP4UART3_FLAGS	0
#define DE_OMAP4UART4_FLAGS	0
#define DE_TI81XXUART1_FLAGS	0
#define DE_TI81XXUART2_FLAGS	0
#define DE_TI81XXUART3_FLAGS	0
#define DE_AM33XXUART1_FLAGS	0

#define DE_OMAPUART_FLAGS	(HWMOD_INIT_NO_IDLE | HWMOD_INIT_NO_RESET)

#ifdef CONFIG_OMAP_GPMC_DE
#define DE_OMAP_GPMC_HWMOD_FLAGS	HWMOD_INIT_NO_RESET
#else
#define DE_OMAP_GPMC_HWMOD_FLAGS	0
#endif

#if defined(CONFIG_DE_OMAP2UART1)
#undef DE_OMAP2UART1_FLAGS
#define DE_OMAP2UART1_FLAGS DE_OMAPUART_FLAGS
#elif defined(CONFIG_DE_OMAP2UART2)
#undef DE_OMAP2UART2_FLAGS
#define DE_OMAP2UART2_FLAGS DE_OMAPUART_FLAGS
#elif defined(CONFIG_DE_OMAP2UART3)
#undef DE_OMAP2UART3_FLAGS
#define DE_OMAP2UART3_FLAGS DE_OMAPUART_FLAGS
#elif defined(CONFIG_DE_OMAP3UART3)
#undef DE_OMAP3UART3_FLAGS
#define DE_OMAP3UART3_FLAGS DE_OMAPUART_FLAGS
#elif defined(CONFIG_DE_OMAP3UART4)
#undef DE_OMAP3UART4_FLAGS
#define DE_OMAP3UART4_FLAGS DE_OMAPUART_FLAGS
#elif defined(CONFIG_DE_OMAP4UART3)
#undef DE_OMAP4UART3_FLAGS
#define DE_OMAP4UART3_FLAGS DE_OMAPUART_FLAGS
#elif defined(CONFIG_DE_OMAP4UART4)
#undef DE_OMAP4UART4_FLAGS
#define DE_OMAP4UART4_FLAGS DE_OMAPUART_FLAGS
#elif defined(CONFIG_DE_TI81XXUART1)
#undef DE_TI81XXUART1_FLAGS
#define DE_TI81XXUART1_FLAGS DE_OMAPUART_FLAGS
#elif defined(CONFIG_DE_TI81XXUART2)
#undef DE_TI81XXUART2_FLAGS
#define DE_TI81XXUART2_FLAGS DE_OMAPUART_FLAGS
#elif defined(CONFIG_DE_TI81XXUART3)
#undef DE_TI81XXUART3_FLAGS
#define DE_TI81XXUART3_FLAGS DE_OMAPUART_FLAGS
#elif defined(CONFIG_DE_AM33XXUART1)
#undef DE_AM33XXUART1_FLAGS
#define DE_AM33XXUART1_FLAGS DE_OMAPUART_FLAGS
#endif
