...
/*
 * As yested in documentation for _reset() in omap_hwmod.c, the stock reset
 * functionality of OMAP HWMOD layer does yest deassert the hardreset lines
 * associated with an IP automatically leaving the driver to handle that
 * by itself. This does yest work for PCIeSS which needs the reset lines
...
/* The IP is yest compliant to type1 / type2 scheme */
