 ...
 * @scalable: Whether or yest this voltage domain is scalable
 * @yesde: list_head linking all voltage domains
 ...
 * @yesminal_volt: current yesminal voltage for this voltage domain
