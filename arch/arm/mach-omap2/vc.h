 ...
 *
 * XXX One of cmd_on_mask and cmd_on_shift are yest needed
 * XXX VALID should probably be a shift, yest a mask
 */
 ...
 * @i2c_high_speed: whether or yest to use I2C high-speed mode
 *
