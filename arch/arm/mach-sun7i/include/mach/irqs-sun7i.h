...
#define SW_INT_IRQNO_UART0	(AW_IRQ_GIC_START + 1 )    /* UART0  */
#define SW_INT_IRQNO_UART1	(AW_IRQ_GIC_START + 2 )    /* UART1  */
#define SW_INT_IRQNO_UART2	(AW_IRQ_GIC_START + 3 )    /* UART2  */
...
#define SW_INT_IRQNO_UART4	(AW_IRQ_GIC_START + 17)    /* UART4  */
