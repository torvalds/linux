...
/* CLKDIV0 */
#define EXYNOS_AUDSS_CLKDIV_RP_MASK			(0xf<<0)
#define EXYNOS_AUDSS_CLKDIV_RP_SHIFT		(0)
#define EXYNOS_AUDSS_CLKDIV_BUSCLK_MASK		(0xf<<4)
#define EXYNOS_AUDSS_CLKDIV_BUSCLK_SHIFT	(4)
#define EXYNOS_AUDSS_CLKDIV_I2SCLK_MASK		(0xf<<8)
#define EXYNOS_AUDSS_CLKDIV_I2SCLK_SHIFT	(8)
