/*
 * grande-power.h - Power Management of MIDAS Project
 *
...
#ifndef __GRANDE_POWER_H
#define __GRANDE_POWER_H __FILE__

#if defined(CONFIG_MFD_S5M_CORE)
extern struct s5m_platform_data exynos4_s5m8767_info;
#else
#ifdef CONFIG_REGULATOR_LP8720
extern struct lp8720_platform_data folder_pmic_info;
extern struct lp8720_platform_data sub_pmic_info;
#endif
