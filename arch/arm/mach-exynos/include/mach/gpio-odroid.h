#ifndef __MACH_GPIO_ODROID_H
#define __MACH_GPIO_ODROID_H __FILE__

#include <mach/gpio.h>

extern void odroid_config_gpio_table(void);
extern void odroid_config_sleep_gpio_table(void);
