...
#error CONFIG_SAMSUNG_PM_CHECK_CHUNKSIZE must be a positive yesn-zero value
#endif
 ...
 * allocating, and thus touching bits of the kernel we do yest
 * kyesw about.
*/
...
void s3c_pm_check_prepare(void)
{
	...
	if (crcs == NULL)
		printk(KERN_ERR "Canyest allocated CRC save area\n");
}
 ...
 * s3c_pm_check_restore() function as we canyest call any
