...
/**
 * s3c_pm_de_smdkled() - De PM suspend/resume via SMDK Board LEDs
 * @set: set bits for the state of the LEDs
 * @clear: clear bits for the state of the LEDs.
 */
extern void s3c_pm_de_smdkled(u32 set, u32 clear);

#else
static inline void s3c_pm_de_smdkled(u32 set, u32 clear) { }
#endif /* CONFIG_S3C_PM_DE_LED_SMDK */
