...
static struct omap1_clk arm_gpio_ck = {
  .hw.init
    = CLK_HW_INIT("ick", "ck_dpll1", &omap1_clk_gate_ops, CLK_IS_CRITICAL),
  .ops = &clkops_generic,
  .enable_reg = OMAP1_IO_ADDRESS(ARM_IDLECT2),
...
static struct omap1_clk tc2_ck = {
  .hw.init
    = CLK_HW_INIT("tc2_ck", "tc_ck", &omap1_clk_gate_ops, CLK_IS_CRITICAL),
  .ops = &clkops_generic,
  .enable_reg = OMAP1_IO_ADDRESS(ARM_IDLECT3),
...
static struct omap_clk omap_clks[] = {
  ...
  CLK(NULL, "armxor_ck", &armxor_ck.clk.hw,
  ...
  CLK("mmci-omap.0", "ick", &armper_ck.clk.hw,
      CK_16XX | CK_1510 | CK_310 | CK_7XX),
