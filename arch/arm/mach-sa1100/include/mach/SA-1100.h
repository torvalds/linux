...
#define Ser0UDCOMP  __REG(0x80000008)  /* Ser. port 0 UDC Output Maximum Packet
                                        * size reg. */
#define Ser0UDCIMP  __REG(0x8000000C)  /* Ser. port 0 UDC Input Maximum Packet
                                        * size reg. */
#define Ser0UDCCS0  __REG(0x80000010)  /* Ser. port 0 UDC Control/Status reg.
                                        * end-point 0 */
#define Ser0UDCCS1  __REG(0x80000014)  /* Ser. port 0 UDC Control/Status reg.
                                        * end-point 1 (output) */
#define Ser0UDCCS2  __REG(0x80000018)  /* Ser. port 0 UDC Control/Status reg.
                                        * end-point 2 (input) */
#define Ser0UDCD0 __REG(0x8000001C)  /* Ser. port 0 UDC Data reg. end-point 0 */
#define Ser0UDCWC __REG(0x80000020)  /* Ser. port 0 UDC Write Count reg.
                                      * end-point 0 */
...
#define _UTCR0(Nb)  __REG(0x80010000 + ((Nb) - 1) * 0x00020000)  /* UART Control
                                                                  * Reg. 0
                                                                  * [1..3] */
#define _UTCR1(Nb)  __REG(0x80010004 + ((Nb) - 1) * 0x00020000)  /* UART Control
                                                                  * Reg. 1
                                                                  * [1..3] */
#define _UTCR2(Nb)  __REG(0x80010008 + ((Nb) - 1) * 0x00020000)  /* UART Control
                                                                  * Reg. 2
                                                                  * [1..3] */
#define _UTCR3(Nb)  __REG(0x8001000C + ((Nb) - 1) * 0x00020000)  /* UART Control
                                                                  * Reg. 3
                                                                  * [1..3] */
#define _UTCR4(Nb)  __REG(0x80010010 + ((Nb) - 1) * 0x00020000)  /* UART Control
                                                                  * Reg. 4 [2]
                                                                  * */
#define _UTDR(Nb) __REG(0x80010014 + ((Nb) - 1) * 0x00020000)  /* UART Data Reg.
                                                                * [1..3] */
#define _UTSR0(Nb)  __REG(0x8001001C + ((Nb) - 1) * 0x00020000)  /* UART Status
                                                                  * Reg. 0
                                                                  * [1..3] */
#define _UTSR1(Nb)  __REG(0x80010020 + ((Nb) - 1) * 0x00020000)  /* UART Status
                                                                  * Reg. 1
                                                                  * [1..3] */
...
#define MSC2    __REG(0xa000002c)  /* Static memory Control reg. 2, not
                                    * contiguous   */
...
/* Memory system:                  */
#define MECR    __REG(0xA0000018)  /*  Expansion memory bus (PCMCIA)
                                    * Configuration Reg.             */
