...
#define ASSABET_BCR_CF_PWR  (1 << 0)  /* Compact Flash Power (1 = 3.3v, 0 = off)
                                       * */
#define ASSABET_BCR_CF_RST  (1 << 1)  /* Compact Flash Reset (1 = power up
                                       * reset) */
#define ASSABET_BCR_NGFX_RST  (1 << 1)  /* Graphics Accelerator Reset (0 = hold
                                         * reset) */
#define ASSABET_BCR_NCODEC_RST  (1 << 2)  /* 0 = Holds UCB1300, ADI7171, and
                                           * UDA1341 in reset */
#define ASSABET_BCR_IRDA_FSEL (1 << 3)  /* IRDA Frequency select (0 = SIR, 1 =
                                         * MIR/ FIR) */
...
#define ASSABET_BCR_CF_BUS_OFF  (1 << 7)  /* Compact Flash bus (0 = on, 1 = off
                                           * (float)) */
