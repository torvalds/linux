...
static inline int acornfb_valid_pixrate(struct fb_var_screeninfo *var) {
  u_long limit;
  if (!var->pixclock) {
    return 0;
  }
 ...
 * data sheet.
 */
static inline u_int acornfb_vidc20_find_pll(u_int pixclk) {
...
static inline void acornfb_vidc20_find_rates(struct vidc_timing *vidc,
  ...
  switch (div) {
    case 1:
      ...
      break;
    case 2:
      vidc->control |= VIDC20_CTRL_PIX_CK2;
      break;
    case 3:
      vidc->control |= VIDC20_CTRL_PIX_CK3;
      break;
    case 4:
      vidc->control |= VIDC20_CTRL_PIX_CK4;
      break;
    case 5:
      vidc->control |= VIDC20_CTRL_PIX_CK5;
      break;
    case 6:
      vidc->control |= VIDC20_CTRL_PIX_CK6;
      break;
    case 7:
      vidc->control |= VIDC20_CTRL_PIX_CK7;
      break;
    case 8:
      vidc->control |= VIDC20_CTRL_PIX_CK8;
      break;
  }
  /*
