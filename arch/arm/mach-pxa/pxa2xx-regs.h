...
#define PRER    __REG(0x40F00010)  /* Power Manager GPIO Rising-Edge Detect
                                    * Enable Register */
#define PFER    __REG(0x40F00014)  /* Power Manager GPIO Falling-Edge Detect
                                    * Enable Register */
#define PEDR    __REG(0x40F00018)  /* Power Manager GPIO Edge Detect Status
                                    * Register */
#define PCFR    __REG(0x40F0001C)  /* Power Manager General Configuration
                                    * Register */
#define PGSR0   __REG(0x40F00020)  /* Power Manager GPIO Sleep State Register
                                    * for GP[31-0] */
#define PGSR1   __REG(0x40F00024)  /* Power Manager GPIO Sleep State Register
                                    * for GP[63-32] */
#define PGSR2   __REG(0x40F00028)  /* Power Manager GPIO Sleep State Register
                                    * for GP[84-64] */
#define PGSR3   __REG(0x40F0002C)  /* Power Manager GPIO Sleep State Register
                                    * for GP[118-96] */
