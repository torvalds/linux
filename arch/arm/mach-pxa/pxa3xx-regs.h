...
#define PCFR    __REG(0x40F5000C) /* Power Manager General Configuration
                                   * Register */
#define PWER    __REG(0x40F50010) /* Power Manager Wake-up Enable Register */
#define PWSR    __REG(0x40F50014) /* Power Manager Wake-up Status Register */
#define PECR    __REG(0x40F50018) /* Power Manager EXT_WAKEUP[1:0] Control
                                   * Register */
#define DCDCSR    __REG(0x40F50080) /* DC-DC Controller Status Register */
#define PVCR    __REG(0x40F50100) /* Power Manager Voltage Change Control
                                   * Register */
...
#define AD3ER   __REG(0x40f40008) /* Application Subsystem Wake-Up from D3
                                   * Enable */
#define AD3SR   __REG(0x40f4000c) /* Application Subsystem Wake-Up from D3
                                   * Status */
#define AD2D0ER   __REG(0x40f40010) /* Application Subsystem Wake-Up from D2 to
                                     * D0 Enable */
#define AD2D0SR   __REG(0x40f40014) /* Application Subsystem Wake-Up from D2 to
                                     * D0 Status */
#define AD2D1ER   __REG(0x40f40018) /* Application Subsystem Wake-Up from D2 to
                                     * D1 Enable */
#define AD2D1SR   __REG(0x40f4001c) /* Application Subsystem Wake-Up from D2 to
                                     * D1 Status */
#define AD1D0ER   __REG(0x40f40020) /* Application Subsystem Wake-Up from D1 to
                                     * D0 Enable */
#define AD1D0SR   __REG(0x40f40024) /* Application Subsystem Wake-Up from D1 to
                                     * D0 Status */
 ...
 */
#define ACCR    __REG(0x41340000) /* Application Subsystem Clock Configuration
                                   * Register */
#define ACSR    __REG(0x41340004) /* Application Subsystem Clock Status Register
                                   * */
#define AICSR   __REG(0x41340008) /* Application Subsystem Interrupt
