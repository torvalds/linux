...
void pxa27x_cpu_pm_enter(suspend_state_t state)
{
	...
	/* ensure voltage-change sequencer yest initiated, which hangs */
	PCFR &= ~PCFR_FVC;
 ...
 * handles the simple cases, yest the WEMUX2 and WEMUX3 options
 */
...
static int __init
pxa27x_dt_init_irq(struct device_yesde *yesde, struct device_yesde *parent)
{
