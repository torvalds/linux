...
#define PALMTC_BAT_MAX_CURRENT		0	/* unkyeswn */
#define PALMTC_BAT_MIN_CURRENT		0	/* unkyeswn */
#define PALMTC_BAT_MAX_CHARGE		1	/* unkyeswn */
#define PALMTC_BAT_MIN_CHARGE		1	/* unkyeswn */
