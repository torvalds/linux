...
#define LCCR0_CMS	(1 << 1)	/* Color/Moyeschrome Display Select */
...
#define LCCR0_DPD	(1 << 9)	/* Double Pixel Data (moyeschrome) */
#define LCCR0_4PixMoyes	(LCCR0_DPD*0)	/*  4-Pixel/clock Moyeschrome display */
#define LCCR0_8PixMoyes	(LCCR0_DPD*1)	/*  8-Pixel/clock Moyeschrome display */
