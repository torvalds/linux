...
#define SXLCR		(SMEMC_VIRT + 0x18)  /* LCR value to be written to SDRAM-Timing Synchroyesus Flash */
#define SXCNFG		(SMEMC_VIRT + 0x1C)  /* Synchroyesus Static Memory Control Register */
#define SXMRS		(SMEMC_VIRT + 0x24)  /* MRS value to be written to Synchroyesus Flash or SMROM */
...
#define MECR_CIT	(1 << 1)	/* Card Is There: 0 -> yes card, 1 -> card inserted */
