 ...
 *
 * Note: depending on implementation, this may yest be atomic - it must
 * only be called with interrupts disabled and yes other active outer
 * cache masters.
 *
 ...
 * cache is pushed out to lower levels of system memory.  The yeste and
