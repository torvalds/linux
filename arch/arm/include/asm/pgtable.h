...
#define PAGE_READONLY   _MOD_PROT(pgprot_user, \
    L_PTE_USER | L_PTE_RDONLY | L_PTE_XN)
#define PAGE_READONLY_EXEC  _MOD_PROT(pgprot_user, L_PTE_USER | L_PTE_RDONLY)
#define PAGE_KERNEL   _MOD_PROT(pgprot_kernel, L_PTE_XN)
#define PAGE_KERNEL_EXEC  pgprot_kernel

#define __PAGE_NONE   __pgprot( \
    _L_PTE_DEFAULT | L_PTE_RDONLY | L_PTE_XN | L_PTE_NONE)
#define __PAGE_SHARED   __pgprot(_L_PTE_DEFAULT | L_PTE_USER | L_PTE_XN)
#define __PAGE_SHARED_EXEC  __pgprot(_L_PTE_DEFAULT | L_PTE_USER)
#define __PAGE_COPY   __pgprot( \
    _L_PTE_DEFAULT | L_PTE_USER | L_PTE_RDONLY | L_PTE_XN)
#define __PAGE_COPY_EXEC  __pgprot(_L_PTE_DEFAULT | L_PTE_USER | L_PTE_RDONLY)
#define __PAGE_READONLY   __pgprot( \
    _L_PTE_DEFAULT | L_PTE_USER | L_PTE_RDONLY | L_PTE_XN)
#define __PAGE_READONLY_EXEC  __pgprot( \
    _L_PTE_DEFAULT | L_PTE_USER | L_PTE_RDONLY)
...
#define pgprot_device(prot) \
  __pgprot_modify(prot, L_PTE_MT_MASK, \
    L_PTE_MT_DEV_SHARED | L_PTE_SHARED | L_PTE_DIRTY | L_PTE_XN)
...
#define pte_accessible(mm, \
      pte) (mm_tlb_flush_pending(mm) ? pte_present(pte) : pte_valid(pte))
...
#define __swp_entry(type, \
      offset) ((swp_entry_t) { (((type) & __SWP_TYPE_MASK) << __SWP_TYPE_SHIFT)   \
                               | ((offset) << \
                               __SWP_OFFSET_SHIFT) })
