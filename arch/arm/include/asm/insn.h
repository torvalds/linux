...
static inline unsigned long arm_gen_branch(unsigned long pc,
    unsigned long addr) {
  return __arm_gen_branch(pc, addr, false, true);
}

static inline unsigned long arm_gen_branch_link(unsigned long pc,
    unsigned long addr, bool warn) {
