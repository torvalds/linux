...
#ifndef __DE_IMX_UART_H
#define __DE_IMX_UART_H
...
#define IMX_DE_UART_BASE(soc) soc##_UART_BASE(CONFIG_DE_IMX_UART_PORT)

#ifdef CONFIG_DE_IMX1_UART
#define UART_PADDR	IMX_DE_UART_BASE(IMX1)
#elif defined(CONFIG_DE_IMX21_IMX27_UART)
#define UART_PADDR	IMX_DE_UART_BASE(IMX21)
#elif defined(CONFIG_DE_IMX25_UART)
#define UART_PADDR	IMX_DE_UART_BASE(IMX25)
#elif defined(CONFIG_DE_IMX31_UART)
#define UART_PADDR	IMX_DE_UART_BASE(IMX31)
#elif defined(CONFIG_DE_IMX35_UART)
#define UART_PADDR	IMX_DE_UART_BASE(IMX35)
#elif defined(CONFIG_DE_IMX50_UART)
#define UART_PADDR	IMX_DE_UART_BASE(IMX50)
#elif defined(CONFIG_DE_IMX51_UART)
#define UART_PADDR	IMX_DE_UART_BASE(IMX51)
#elif defined(CONFIG_DE_IMX53_UART)
#define UART_PADDR	IMX_DE_UART_BASE(IMX53)
#elif defined(CONFIG_DE_IMX6Q_UART)
#define UART_PADDR	IMX_DE_UART_BASE(IMX6Q)
#elif defined(CONFIG_DE_IMX6SL_UART)
#define UART_PADDR	IMX_DE_UART_BASE(IMX6SL)
#elif defined(CONFIG_DE_IMX6SX_UART)
#define UART_PADDR	IMX_DE_UART_BASE(IMX6SX)
#elif defined(CONFIG_DE_IMX6UL_UART)
#define UART_PADDR	IMX_DE_UART_BASE(IMX6UL)
#elif defined(CONFIG_DE_IMX7D_UART)
#define UART_PADDR	IMX_DE_UART_BASE(IMX7D)

#endif

#endif /* __DE_IMX_UART_H */
