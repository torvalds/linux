 ...
 *
 * We yesw properly support a method by which the FIQ handlers can
 * be stacked onto the vector.  We still do yest support sharing
...
static int fiq_def_op(void *ref, int relinquish)
{
	if (!relinquish) {
		...
		/* FIXME: yestify irq controller to standard enable FIQs */
	}
