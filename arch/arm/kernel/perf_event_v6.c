...
static inline int armv6_pmcr_has_overflowed(unsigned long pmcr) {
  return pmcr & ARMV6_PMCR_OVERFLOWED_MASK;
}

static inline int armv6_pmcr_counter_has_overflowed(unsigned long pmcr,
...
static irqreturn_t armv6pmu_handle_irq(struct arm_pmu *cpu_pmu) {
...
static int armv6pmu_get_event_idx(struct pmu_hw_events *cpuc,
