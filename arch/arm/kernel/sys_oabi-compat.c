...
static int get_oabi_flock(struct flock64 *kernel,
    struct oabi_flock64 __user *arg) {
...
static int put_oabi_flock(struct flock64 *kernel,
    struct oabi_flock64 __user *arg) {
  struct oabi_flock64 user;
...
struct epoll_event __user *epoll_put_uevent(__poll_t revents, __u64 data,
