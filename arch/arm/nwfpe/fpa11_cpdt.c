...
static inline void loadSingle(const unsigned int Fn,
...
static inline void loadDouble(const unsigned int Fn,
    const unsigned int __user *pMem) {
  FPA11 *fpa11 = GET_FPA11();
  unsigned int *p;
...
static inline void loadExtended(const unsigned int Fn,
    const unsigned int __user *pMem) {
  FPA11 *fpa11 = GET_FPA11();
  unsigned int *p;
...
static inline void loadMultiple(const unsigned int Fn,
    const unsigned int __user *pMem) {
  FPA11 *fpa11 = GET_FPA11();
...
static inline void storeSingle(struct roundingData *roundData,
...
static inline void storeDouble(struct roundingData *roundData,
    const unsigned int Fn,
    unsigned int __user *pMem) {
  FPA11 *fpa11 = GET_FPA11();
  union {
...
#ifdef CONFIG_FPE_NWFPE_XP
static inline void storeExtended(const unsigned int Fn,
    unsigned int __user *pMem) {
  FPA11 *fpa11 = GET_FPA11();
  union {
    floatx80 f;
...
static inline void storeMultiple(const unsigned int Fn,
    unsigned int __user *pMem) {
  FPA11 *fpa11 = GET_FPA11();
