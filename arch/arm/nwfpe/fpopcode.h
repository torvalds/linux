 ...
 * ARM Floating Point Instruction Classes
 ...
 |c o n d|1 1 0 P|U|w|W|L|   Rn  |x|  Fd |0|0|1|0|  o f f s e t  | CPDT (copro
 |2)
 | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | |
...
#define STF_OP(opcode)  (STORE_OP(opcode) \
  && (getCoprocessorNumber(opcode) == 1))
#define SFM_OP(opcode)  (STORE_OP(opcode) \
  && (getCoprocessorNumber(opcode) == 2))
