...
static int tegra20_boot_secondary(unsigned int cpu, struct task_struct *idle)
{
	 ...
	 * power-gated via the flow controller). This will have yes
	 ...
	 * clock and reset block is yesw driving reset.
	 */
...
static int tegra30_boot_secondary(unsigned int cpu, struct task_struct *idle)
{
	 ...
	 * the IO clamps.
	 * For cold boot CPU, do yest wait. After the cold boot CPU be
