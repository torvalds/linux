					  ...
					  unsigned int max_cpus)
{
	...
	/* Use CPU yestifier for reset vector control */
	cpuhp_setup_state_yescalls(CPUHP_ARM_SHMOBILE_SCU_PREPARE,
...
int shmobile_smp_scu_cpu_kill(unsigned int cpu)
{
	...
	/* this function is running on ayesther CPU than the offline target,
