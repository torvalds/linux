...
static void __init socfpga_sysmgr_init(void)
{
	...
	np = of_find_compatible_yesde(NULL, NULL, "altr,sys-mgr");
	...
	np = of_find_compatible_yesde(NULL, NULL, "altr,rst-mgr");
	rst_manager_base_addr = of_iomap(np, 0);

	np = of_find_compatible_yesde(NULL, NULL, "altr,sdr-ctl");
