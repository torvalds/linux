...
#define TMPL_END_IDX \
  ...
  - (unsigned long *) optprobe_template_entry)
#define TMPL_ADD_SP \
  ((unsigned long *) optprobe_template_add_sp \
  - (unsigned long *) optprobe_template_entry)
#define TMPL_SUB_SP \
  ((unsigned long *) optprobe_template_sub_sp \
  - (unsigned long *) optprobe_template_entry)
...
#define TMPL_RESTORE_END \
  ((unsigned long *) optprobe_template_restore_end \
  - (unsigned long *) optprobe_template_entry)
...
static void __arch_remove_optimized_kprobe(struct optimized_kprobe *op,
    int dirty) {
  if (op->optinsn.insn) {
