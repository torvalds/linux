...
#define DATA_PROCESSING_DM(op, val)    \
  ...
  TEST_RRRR("smlalbb	r", 0, VAL1, ", r", 1, VAL2, ", r", 2, VAL3, ", r", 3,
      VAL4)
  TEST_RRRR("smlalbble	r", 8, VAL4, ", r", 9, VAL1, ", r", 10, VAL2, ", r", 11,
      VAL3)
  ...
  TEST_RRRR("smlaltb	r", 0, VAL1, ", r", 1, VAL2, ", r", 2, VAL3, ", r", 3,
      VAL4)
  TEST_RRRR("smlaltble	r", 8, VAL4, ", r", 9, VAL1, ", r", 10, VAL2, ", r", 11,
      VAL3)
  ...
  TEST_RRRR("smlalbt	r", 0, VAL1, ", r", 1, VAL2, ", r", 2, VAL3, ", r", 3,
      VAL4)
  TEST_RRRR("smlalbtle	r", 8, VAL4, ", r", 9, VAL1, ", r", 10, VAL2, ", r", 11,
      VAL3)
  ...
  TEST_RRRR("smlaltt	r", 0, VAL1, ", r", 1, VAL2, ", r", 2, VAL3, ", r", 3,
      VAL4)
  TEST_RRRR("smlalttle	r", 8, VAL4, ", r", 9, VAL1, ", r", 10, VAL2, ", r", 11,
      VAL3)
  ...
  TEST_RRRR("umlalle	r", 8, VAL4, ", r", 9, VAL1, ", r", 10, VAL2, ", r", 11,
      VAL3)
  ...
  TEST_RRRR("umlalsle	r", 8, VAL4, ", r", 9, VAL1, ", r", 10, VAL2, ", r", 11,
      VAL3)
  ...
  TEST_RRRR("smlalle	r", 8, VAL4, ", r", 9, VAL1, ", r", 10, VAL2, ", r", 11,
      VAL3)
  ...
  TEST_RRRR("smlalsle	r", 8, VAL4, ", r", 9, VAL1, ", r", 10, VAL2, ", r", 11,
      VAL3)
...
#define LOAD_STORE(byte)              \
  ...
  TEST_RPR("str"byte "	r", 12, VAL2, ", [r", 11, 24, ", r", 10, 4, \
      ", ror #31]!") \
...
#define COPROCESSOR_INSTRUCTIONS_ST_LD(two, cc)          \
  ...
  TEST_COPROCESSOR("stc"two "	p0, cr0, [r15, #-4]")     \
  TEST_UNSUPPORTED(__inst_arm( \
      0x ## cc ## daf0001) "	@ stc"two"	0, cr0, [r15, #4]!")  \
  TEST_UNSUPPORTED(__inst_arm( \
      0x ## cc ## d2f0001) "	@ stc"two"	0, cr0, [r15, #-4]!") \
  TEST_UNSUPPORTED(__inst_arm( \
      0x ## cc ## caf0001) "	@ stc"two"	0, cr0, [r15], #4") \
  TEST_UNSUPPORTED(__inst_arm( \
      0x ## cc ## c2f0001) "	@ stc"two"	0, cr0, [r15], #-4")  \
  TEST_COPROCESSOR("stc"two "	p0, cr0, [r15], {1}")     \
  TEST_COPROCESSOR("stc"two "l	p0, cr0, [r15, #4]")      \
  TEST_COPROCESSOR("stc"two "l	p0, cr0, [r15, #-4]")     \
  TEST_UNSUPPORTED(__inst_arm( \
      0x ## cc ## def0001) "	@ stc"two"l	0, cr0, [r15, #4]!")  \
  TEST_UNSUPPORTED(__inst_arm( \
      0x ## cc ## d6f0001) "	@ stc"two"l	0, cr0, [r15, #-4]!") \
  TEST_UNSUPPORTED(__inst_arm( \
      0x ## cc ## cef0001) "	@ stc"two"l	0, cr0, [r15], #4") \
  TEST_UNSUPPORTED(__inst_arm( \
      0x ## cc ## c6f0001) "	@ stc"two"l	0, cr0, [r15], #-4")  \
  TEST_COPROCESSOR("stc"two "l	p0, cr0, [r15], {1}")     \
  TEST_COPROCESSOR("ldc"two "	p0, cr0, [r15, #4]")      \
  TEST_COPROCESSOR("ldc"two "	p0, cr0, [r15, #-4]")     \
  TEST_UNSUPPORTED(__inst_arm( \
      0x ## cc ## dbf0001) "	@ ldc"two"	0, cr0, [r15, #4]!")  \
  TEST_UNSUPPORTED(__inst_arm( \
      0x ## cc ## d3f0001) "	@ ldc"two"	0, cr0, [r15, #-4]!") \
  TEST_UNSUPPORTED(__inst_arm( \
      0x ## cc ## cbf0001) "	@ ldc"two"	0, cr0, [r15], #4") \
  TEST_UNSUPPORTED(__inst_arm( \
      0x ## cc ## c3f0001) "	@ ldc"two"	0, cr0, [r15], #-4")  \
  TEST_COPROCESSOR("ldc"two "	p0, cr0, [r15], {1}")     \
  TEST_COPROCESSOR("ldc"two "l	p0, cr0, [r15, #4]")      \
  TEST_COPROCESSOR("ldc"two "l	p0, cr0, [r15, #-4]")     \
  TEST_UNSUPPORTED(__inst_arm( \
      0x ## cc ## dff0001) "	@ ldc"two"l	0, cr0, [r15, #4]!")  \
  TEST_UNSUPPORTED(__inst_arm( \
      0x ## cc ## d7f0001) "	@ ldc"two"l	0, cr0, [r15, #-4]!") \
  TEST_UNSUPPORTED(__inst_arm( \
      0x ## cc ## cff0001) "	@ ldc"two"l	0, cr0, [r15], #4") \
  TEST_UNSUPPORTED(__inst_arm( \
      0x ## cc ## c7f0001) "	@ ldc"two"l	0, cr0, [r15], #-4")  \
...
#define COPROCESSOR_INSTRUCTIONS_MC_MR(two, cc)          \
  ...
  TEST_UNSUPPORTED(__inst_arm( \
      0x ## cc ## c4f00f0) "	@ mcrr"two"	0, 15, r0, r15, cr0") \
  TEST_UNSUPPORTED(__inst_arm( \
      0x ## cc ## c40ff0f) "	@ mcrr"two"	15, 0, r15, r0, cr15")  \
  TEST_COPROCESSOR("mrrc"two "	p0, 15, r0, r14, cr0")      \
  TEST_COPROCESSOR("mrrc"two "	p15, 0, r14, r0, cr15")     \
  TEST_UNSUPPORTED(__inst_arm( \
      0x ## cc ## c5f00f0) "	@ mrrc"two"	0, 15, r0, r15, cr0") \
  TEST_UNSUPPORTED(__inst_arm( \
      0x ## cc ## c50ff0f) "	@ mrrc"two"	15, 0, r15, r0, cr15")  \
