 ...
 */
static probes_opcode_t __kprobes prepare_emulated_insn(probes_opcode_t insn,
    struct arch_probes_insn *asi,
    bool thumb) {
 ...
 */
static void __kprobes set_emulated_insn(probes_opcode_t insn,
    struct arch_probes_insn *asi,
    bool thumb) {
#ifdef CONFIG_THUMB2_KERNEL
  if (thumb) {
 ...
 *
 */
int __kprobes probes_decode_insn(probes_opcode_t insn,
    struct arch_probes_insn *asi,
