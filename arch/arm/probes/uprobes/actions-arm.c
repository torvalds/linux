...
enum probes_insn decode_pc_ro(probes_opcode_t insn,
...
enum probes_insn decode_wb_pc(probes_opcode_t insn,
    struct arch_probes_insn *asi,
...
enum probes_insn decode_rd12rn16rm0rs8_rwflags(probes_opcode_t insn,
    struct arch_probes_insn *asi,
    const struct decode_header *d) {
  return decode_wb_pc(insn, asi, d, true);
}

enum probes_insn decode_ldr(probes_opcode_t insn, struct arch_probes_insn *asi,
    const struct decode_header *d) {
