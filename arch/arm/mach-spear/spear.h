...
#define VA_SPEAR_ICM1_UART_BASE   (VA_SPEAR_ICM1_2_BASE - SPEAR_ICM1_2_BASE \
  + SPEAR_ICM1_UART_BASE)
...
#define VA_SPEAR_ICM3_SYS_CTRL_BASE (VA_SPEAR_ICM3_SMI_CTRL_BASE \
  - SPEAR_ICM3_SMI_CTRL_BASE + SPEAR_ICM3_SYS_CTRL_BASE)
#define SPEAR_ICM3_MISC_REG_BASE  UL(0xFCA80000)
#define VA_SPEAR_ICM3_MISC_REG_BASE (VA_SPEAR_ICM3_SMI_CTRL_BASE \
