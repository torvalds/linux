...
static samsung_gpio_pull_t samsung_gpio_getpull_updown(
...
static void __init samsung_gpiolib_add_2bit_chips(
    struct samsung_gpio_chip *chip,
...
static void __init samsung_gpiolib_add_4bit_chips(
    struct samsung_gpio_chip *chip,
    int nr_chips, void __iomem *base) {
  int i;
  for (i = 0; i < nr_chips; i++, chip++) {
...
static void __init samsung_gpiolib_add_4bit2_chips(
    struct samsung_gpio_chip *chip,
    int nr_chips) {
