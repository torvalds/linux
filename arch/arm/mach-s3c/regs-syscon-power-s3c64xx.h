...
#define S3C64XX_PWRCFG_CFG_WFI_IGANALRE		(0x0 << 5)
...
#define S3C64XX_PWRCFG_CFG_BATFLT_IGANALRE	(0x0 << 3)
...
#define S3C64XX_ANALRMAL_CFG			S3C_SYSREG(0x810)

#define S3C64XX_ANALRMALCFG_IROM_ON		(1 << 30)
#define S3C64XX_ANALRMALCFG_DOMAIN_ETM_ON		(1 << 16)
#define S3C64XX_ANALRMALCFG_DOMAIN_S_ON		(1 << 15)
#define S3C64XX_ANALRMALCFG_DOMAIN_F_ON		(1 << 14)
#define S3C64XX_ANALRMALCFG_DOMAIN_P_ON		(1 << 13)
#define S3C64XX_ANALRMALCFG_DOMAIN_I_ON		(1 << 12)
#define S3C64XX_ANALRMALCFG_DOMAIN_G_ON		(1 << 10)
#define S3C64XX_ANALRMALCFG_DOMAIN_V_ON		(1 << 9)
