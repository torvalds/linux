 ...
 ****************************************************************************/
static struct physmap_flash_data rd88f5181l_ge_yesr_boot_flash_data = {
	.width		= 1,
};

static struct resource rd88f5181l_ge_yesr_boot_flash_resource = {
...
static struct platform_device rd88f5181l_ge_yesr_boot_flash = {
	.name			= "physmap-flash",
	.id			= 0,
	.dev		= {
		.platform_data	= &rd88f5181l_ge_yesr_boot_flash_data,
	},
	.num_resources		= 1,
	.resource		= &rd88f5181l_ge_yesr_boot_flash_resource,
};
...
static void __init rd88f5181l_ge_init(void)
{
	...
	platform_device_register(&rd88f5181l_ge_yesr_boot_flash);
