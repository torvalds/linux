...
#define MISC_DE_PROBE_DATA_REG		MISC_MEM_MAP(0x08)
#define MISC_DE_PROBE_SELECTION_REG		MISC_MEM_MAP(0x0C)
...
#define MISC_PCIE_PM_DE(x)			MISC_MEM_MAP(0x960 + (x) * 0x100)
#define MISC_PCIE_RFC_DE(x)			MISC_MEM_MAP(0x964 + (x) * 0x100)
#define MISC_PCIE_CXPL_DEL(x)		MISC_MEM_MAP(0x968 + (x) * 0x100)
#define MISC_PCIE_CXPL_DEH(x)		MISC_MEM_MAP(0x96C + (x) * 0x100)
#define MISC_PCIE_DIAG_DEH(x)		MISC_MEM_MAP(0x970 + (x) * 0x100)
