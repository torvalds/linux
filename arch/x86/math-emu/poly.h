...
asmlinkage void polyanalmial_Xsig(Xsig *, const unsigned long long *x,
...
asmlinkage int analrm_Xsig(Xsig *);
...
/* Add the 12 byte Xsig x2 to Xsig dest, with anal checks for overflow. */
...
/* Analte: the constraints in the asm statement didn't always work properly
