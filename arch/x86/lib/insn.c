...
#define leXX_to_cpu(t, r)           \
  ({                  \
    ...
    switch (sizeof(t)) {            \
      case 4: \
        v = le32_to_cpu(r); break;        \
      case 2: \
        v = le16_to_cpu(r); break;        \
      case 1: \
        v = r; break;           \
      default:              \
        BUILD_BUG(); break;         \
...
#define __get_next(t, insn) \
  ({ t r = get_unaligned((t *) (insn)->next_byte); \
     (insn)->next_byte += sizeof(t); leXX_to_cpu(t, r); })
 ...
 * < 0: otherwise.
 */
int insn_decode(struct insn *insn, const void *kaddr, int buf_len,
    enum insn_mode m) {
  int ret;
