...
static int get_fpregs(struct user_i387_struct __user *buf,
...
static int set_fpregs(struct user_i387_struct __user *buf,
    struct task_struct *child) {
...
static int get_fpxregs(struct user_fxsr_struct __user *buf,
    struct task_struct *child) {
  int err, n, cpu = task_cpu(child);
...
static int set_fpxregs(struct user_fxsr_struct __user *buf,
    struct task_struct *child) {
  int n, cpu = task_cpu(child);
  struct user_fxsr_struct fpregs;
  n = copy_from_user(&fpregs, buf, sizeof(fpregs));
