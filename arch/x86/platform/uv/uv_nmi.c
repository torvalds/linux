...
static struct init_nmi {
  ...
  { /* PAD_CFG_DW0_GPP_D_0 */
     ...
     *
     *  19    GPIO Input Route SCI (GPIROUTSCI): = 0 # Routing does not cause
     * SCI.
     *  18    GPIO Input Route SMI (GPIROUTSMI): = 0 # Routing does not cause
     * SMI.
     ...
     *
     *   1 GPIO RX State (GPIORXSTATE): This is the current internal RX pad
     * state..
