...
static void reg_yesirq_read(struct sim_dev_reg *reg, u32 *value)
{
...
static struct sim_dev_reg bus1_fixups[] = {
	...
	DEFINE_REG(11, 7, 0x3c, 256, reg_init, reg_yesirq_read, reg_write)
	...
	DEFINE_REG(16, 0, 0x3c, 256, reg_init, reg_yesirq_read, reg_write)
	DEFINE_REG(17, 0, 0x10, (128*KB), reg_init, reg_read, reg_write)
	DEFINE_REG(18, 0, 0x10, (1*KB), reg_init, reg_read, reg_write)
	DEFINE_REG(18, 0, 0x3c, 256, reg_init, reg_yesirq_read, reg_write)
};
...
int bridge_read(unsigned int devfn, int reg, int len, u32 *value)
{
	...
	switch (reg) {
	/* Make BARs appear to yest request any memory. */
	...
	case PCI_MEMORY_LIMIT:
		 ...
		 * memory base, so yest claim prefetchable memory space.
		 */
	...
	case PCI_PREF_MEMORY_LIMIT:
		*value = 0x0;
		break;
		/* Make IO limit smaller than IO base, so yest claim IO space. */
	case PCI_IO_BASE:
		*value = 0xF0;
		break;
	case PCI_IO_LIMIT:
