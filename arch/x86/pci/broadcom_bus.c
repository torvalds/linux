...
static void __init cnb20le_res(u8 bus, u8 slot, u8 func)
{
	 ...
	 *
	 * These do yest exist anywhere in the bridge registers, AFAICT. I do
	 * yest have the datasheet, so this is the best I can do.
	 */
	if (fbus == 0) {
	...
	/* read the yesn-prefetchable memory window */
