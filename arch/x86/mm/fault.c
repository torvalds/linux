 ...
 */
static nokprobe_inline int kmmio_fault(struct pt_regs *regs,
    unsigned long addr) {
...
static void show_ldttss(const struct desc_ptr *gdt, const char *name,
    u16 index) {
...
DEFINE_IDTENTRY_RAW_ERRORCODE(exc_page_fault)
{
  ...
  address
    = cpu_feature_enabled(X86_FEATURE_FRED) ? fred_event_data(regs) : read_cr2();
