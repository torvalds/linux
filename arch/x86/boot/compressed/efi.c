...
/**
 * efi_get_type - Given a pointer to boot_params, determine the type of EFI
 * environment.
 *
...
/**
 * efi_get_system_table - Given a pointer to boot_params, retrieve the physical
 * address
...
/**
 * efi_get_conf_table - Given a pointer to boot_params, locate and return the
 * physical
