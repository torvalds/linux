...
static int setup_e820_entries(struct boot_params *params) {
  ...
  /* TODO: Pass entries more than E820_MAX_ENTRIES_ZEROPAGE in bootparams setup
   * data */
...
static void setup_rng_seed(struct boot_params *params,
...
static int prepare_add_efi_setup_data(struct boot_params *params,
    unsigned long params_load_addr,
...
static void setup_ima_state(const struct kimage *image,
...
static void *bzImage64_load(struct kimage *image, char *kernel,
  ...
  struct kexec_buf kbuf = {
    .image = image, .buf_max = ULONG_MAX,
    .top_down = true
  };
  struct kexec_buf pbuf = {
    .image = image, .buf_min = MIN_PURGATORY_ADDR,
