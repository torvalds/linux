...
extern int copy_uabi_from_kernel_to_xstate(struct fpstate *fpstate,
    const void *kbuf, u32 *pkru);
extern int copy_sigframe_from_user_to_xstate(struct task_struct *tsk,
...
#else
static inline void xfd_validate_state(struct fpstate *fpstate, u64 mask,
    bool rstor) {
}
