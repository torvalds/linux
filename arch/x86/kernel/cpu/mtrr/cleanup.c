...
static int __init x86_get_mtrr_mem_range(struct range *range, int nr_range,
...
static void __init set_var_mtrr(unsigned int reg, unsigned long basek,
    unsigned long sizek,
    unsigned char type) {
...
static void __init save_var_mtrr(unsigned int reg, unsigned long basek,
    unsigned long sizek,
    unsigned char type) {
...
static unsigned __init range_to_mtrr_with_hole(struct var_mtrr_state *state,
    unsigned long basek,
    unsigned long sizek) {
...
static void __init set_var_mtrr_range(struct var_mtrr_state *state,
    unsigned long base_pfn,
    unsigned long size_pfn) {
  unsigned long basek, sizek;
...
static int __init x86_setup_var_mtrrs(struct range *range, int nr_range,
...
static u64 __init real_trim_memory(unsigned long start_pfn,
  ...
  return e820__range_update(trim_start, trim_size, E820_TYPE_RAM,
      E820_TYPE_RESERVED);
}
