...
static inline bool intel_filter_mce(struct mce *m) {
  return false;
}

static inline bool intel_mce_usable_address(struct mce *m) {
  return false;
}
...
static inline bool mce_get_storm_mode(void) {
  return false;
}
...
#else
static inline bool amd_filter_mce(struct mce *m) {
  return false;
}

static inline bool amd_mce_usable_address(struct mce *m) {
  return false;
}
