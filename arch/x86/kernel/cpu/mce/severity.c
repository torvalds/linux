...
enum context {
  IN_KERNEL = 1, IN_USER = 2, IN_KERNEL_RECOV = 3
};
enum ser {
  SER_REQUIRED = 1, NO_SER = 2
};
enum exception {
  EXCP_CONTEXT = 1, NO_EXCP = 2
};
...
#define MCI_ADDR (MCI_STATUS_ADDRV | MCI_STATUS_MISCV)
  ...
  MCESEV(
      ...
      SER,
      MASK(MCI_STATUS_OVER | MCI_UC_SAR | MCI_ADDR | MCACOD,
...
static noinstr int mce_severity_amd(struct mce *m, struct pt_regs *regs,
...
int noinstr mce_severity(struct mce *m, struct pt_regs *regs, char **msg,
    bool is_excp) {
