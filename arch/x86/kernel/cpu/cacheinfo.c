...
static const struct _cache_table cache_table[] = {
  ...
  { 0x60, LVL_1_DATA, 16 }, /* 8-way set assoc, sectored cache, 64 byte line
                             * size */
  { 0x66, LVL_1_DATA, 8 },  /* 4-way set assoc, sectored cache, 64 byte line
                             * size */
  { 0x67, LVL_1_DATA, 16 }, /* 4-way set assoc, sectored cache, 64 byte line
                             * size */
  { 0x68, LVL_1_DATA, 32 }, /* 4-way set assoc, sectored cache, 64 byte line
                             * size */
...
static void amd_cpuid4(int leaf, union _cpuid4_leaf_eax *eax,
    union _cpuid4_leaf_ebx *ebx,
    union _cpuid4_leaf_ecx *ecx) {
  unsigned dummy;
...
static int cpuid4_cache_lookup_regs(int index,
