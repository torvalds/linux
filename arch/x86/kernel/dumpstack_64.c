...
static __always_inline bool in_exception_stack(unsigned long *stack,
...
static __always_inline bool in_irq_stack(unsigned long *stack,
    struct stack_info *info) {
  unsigned long *end = (unsigned long *) this_cpu_read(
      pcpu_hot.hardirq_stack_ptr);
  unsigned long *begin;
  /*
...
bool noinstr get_stack_info_noinstr(unsigned long *stack,
