...
struct mpc_table {
	...
	char oem[8];
	char productid[12];
	unsigned int oemptr;		/* 0 if yest present */
	unsigned short oemsize;		/* 0 if yest present */
...
#define	MP_INTSRC		3
#define	MP_LINTSRC		4
/* Used by IBM NUMA-Q to describe yesde locality */
 ...
 *
 *	1	2 CPU ISA 82489DX
 *	2	2 CPU EISA 82489DX neither IRQ 0 timer yesr IRQ 13 DMA chaining
