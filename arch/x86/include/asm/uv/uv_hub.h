...
static inline int is_uv(int uvmask) {
...
static inline int is_uv5_hub(void) {
  return is_uv(UV5);
}
...
/* UVY class: UV5,..? */
static inline int is_uvy_hub(void) {
  return is_uv(UVY);
}
 ...
 * memory.
 */
static inline volatile void __iomem *uv_global_mmr64_address(int pnode,
    unsigned long offset) {
...
static inline void uv_write_local_mmr8(unsigned long offset,
    unsigned char val) {
