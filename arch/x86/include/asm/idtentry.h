...
#else
static inline void fred_install_sysvec(unsigned int vector,
    const idtentry_t function) {
}
...
vector = vector + 1
    .endr SYM_CODE_END(irq_entries_start)

#ifdef CONFIG_X86_LOCAL_APIC
    .align IDT_ALIGN SYM_CODE_START(spurious_entries_start)
...
.fill 0b + IDT_ALIGN -., 1, 0xcc
vector = vector + 1
    .endr SYM_CODE_END(spurious_entries_start)
#endif
