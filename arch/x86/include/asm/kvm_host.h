...
#define MSR_ARCH_PERFMON_PERFCTR_MAX  (MSR_ARCH_PERFMON_PERFCTR0 \
  + KVM_INTEL_PMC_MAX_GENERIC - 1)
#define MSR_ARCH_PERFMON_EVENTSEL_MAX (MSR_ARCH_PERFMON_EVENTSEL0 \
  + KVM_INTEL_PMC_MAX_GENERIC - 1)
#define KVM_PMC_MAX_FIXED 3
#define MSR_ARCH_PERFMON_FIXED_CTR_MAX  (MSR_ARCH_PERFMON_FIXED_CTR0 \
  + KVM_PMC_MAX_FIXED - 1)
...
struct kvm_x86_ops {
  ...
  int (*mem_enc_unregister_region)(struct kvm *kvm,
  ...
  gva_t (*get_untagged_addr)(struct kvm_vcpu *vcpu, gva_t gva,
      unsigned int flags);
...
#define kvm_arch_pmi_in_guest(vcpu) \
  ...
  && (!!in_nmi() \
  == ((vcpu)->arch.handling_intr_from_guest == KVM_HANDLING_NMI)))
...
void kvm_post_set_cr0(struct kvm_vcpu *vcpu, unsigned long old_cr0,
    unsigned long cr0);
void kvm_post_set_cr4(struct kvm_vcpu *vcpu, unsigned long old_cr4,
    unsigned long cr4);
