...
#define __PAGE_KERNEL    (__PP | __RW | 0 | ___A | __NX | ___D | 0 | ___G)
#define __PAGE_KERNEL_EXEC   (__PP | __RW | 0 | ___A | 0 | ___D | 0 | ___G)
#define __PAGE_KERNEL_NOCACHE  (__PP | __RW | 0 | ___A | __NX | ___D | 0 \
  | ___G | __NC)
...
#define __PAGE_KERNEL_LARGE_EXEC (__PP | __RW | 0 | ___A | 0 | ___D | _PSE \
  | ___G)
#define __PAGE_KERNEL_WP   (__PP | __RW | 0 | ___A | __NX | ___D | 0 | ___G \
  | __WP)
...
#define PGD_PAE_PHYS_MASK (((1ULL << \
    __PHYSICAL_MASK_SHIFT) - 1) & PGD_PAE_PAGE_MASK)
...
static inline p4d_t native_make_p4d(pudval_t val) {
  return (p4d_t) {
      .pgd = native_make_pgd((pgdval_t) val)
  };
}
...
static inline pmd_t native_make_pmd(pmdval_t val) {
  return (pmd_t) {
      .pud.p4d.pgd = native_make_pgd(val)
  };
}
