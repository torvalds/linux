...
#define X86_FEATURE_ZEN5    (3 * 32 + 5) /* "" CPU based on Zen5
                                          * microarchitecture */
...
#define X86_FEATURE_AMD_LBR_V2    (3 * 32 + 17) /* AMD Last Branch Record
                                                 * Extension Version 2 */
...
#define X86_FEATURE_APERFMPERF    (3 * 32 + 28) /* P-State hardware coordination
                                                 * feedback capability
                                                 * (APERF/MPERF MSRs) */
...
#define X86_FEATURE_DSCPL   (4 * 32 + 4) /* "ds_cpl" CPL-qualified (filtered)
                                          * Debug Store */
...
#define X86_FEATURE_PERFCTR_LLC   (6 * 32 + 28) /* Last Level Cache performance
                                                 * counter extensions */
...
#define X86_FEATURE_TDX_HOST_PLATFORM (7 * 32 + 7) /* Platform supports being a
                                                    * TDX host */
#define X86_FEATURE_HW_PSTATE   (7 * 32 + 8) /* AMD HW-PState */
#define X86_FEATURE_PROC_FEEDBACK (7 * 32 + 9) /* AMD ProcFeedbackInterface */
#define X86_FEATURE_XCOMPACTED    (7 * 32 + 10) /* "" Use compacted XSTATE
                                                 * (XSAVES or XSAVEC) */
...
#define X86_FEATURE_VCPUPREEMPT   (8 * 32 + 21) /* "" PV vcpu_is_preempted
                                                 * function */
#define X86_FEATURE_TDX_GUEST   (8 * 32 + 22) /* Intel Trust Domain Extensions
                                               * Guest */
...
#define X86_FEATURE_FDP_EXCPTN_ONLY (9 * 32 + 6) /* "" FPU data pointer updated
                                                  * only on x87 exceptions */
...
#define X86_FEATURE_RETPOLINE   (11 * 32 + 12) /* "" Generic Retpoline
                                                * mitigation for Spectre variant
                                                * 2 */
#define X86_FEATURE_RETPOLINE_LFENCE  (11 * 32 + 13) /* "" Use LFENCE for
                                                      * Spectre variant 2 */
...
#define X86_FEATURE_MSR_TSX_CTRL  (11 * 32 + 20) /* "" MSR IA32_TSX_CTRL (Intel)
                                                  * implemented */
#define X86_FEATURE_SMBA    (11 * 32 + 21) /* "" Slow Memory Bandwidth
                                            * Allocation */
#define X86_FEATURE_BMEC    (11 * 32 + 22) /* "" Bandwidth Monitoring Event
                                            * Configuration */
#define X86_FEATURE_USER_SHSTK    (11 * 32 + 23) /* Shadow stack support for
                                                 * user mode applications */
#define X86_FEATURE_SRSO    (11 * 32 + 24) /* "" AMD BTB untrain RETs */
#define X86_FEATURE_SRSO_ALIAS    (11 * 32 + 25) /* "" AMD BTB untrain RETs
                                                  * through aliasing */
...
#define X86_FEATURE_APIC_MSRS_FENCE (11 * 32 + 27) /* "" IA32_TSC_DEADLINE and
                                                    ...
                                                    * */
#define X86_FEATURE_ZEN2    (11 * 32 + 28) /* "" CPU based on Zen2
                                            * microarchitecture */
#define X86_FEATURE_ZEN3    (11 * 32 + 29) /* "" CPU based on Zen3
                                            * microarchitecture */
#define X86_FEATURE_ZEN4    (11 * 32 + 30) /* "" CPU based on Zen4
                                            * microarchitecture */
#define X86_FEATURE_ZEN1    (11 * 32 + 31) /* "" CPU based on Zen1
                                            * microarchitecture */
...
#define X86_FEATURE_AVX512_BF16   (12 * 32 + 5) /* AVX512 BFLOAT16 instructions
                                                 * */
#define X86_FEATURE_CMPCCXADD           (12 * 32 + 7) /* "" CMPccXADD
                                                       * instructions */
...
#define X86_FEATURE_CPPC    (13 * 32 + 27) /* Collaborative Processor
                                            * Performance Control */
...
#define X86_FEATURE_TSCRATEMSR    (15 * 32 + 4) /* "tsc_scale" TSC scaling
                                                 * support */
#define X86_FEATURE_VMCBCLEAN   (15 * 32 + 5) /* "vmcb_clean" VMCB clean bits
                                               * support */
...
#define X86_FEATURE_ENQCMD    (16 * 32 + 29) /* ENQCMD and ENQCMDS instructions
                                              * */
#define X86_FEATURE_SGX_LC    (16 * 32 + 30) /* Software Guard Extensions Launch
                                              * Control */
...
#define X86_FEATURE_AVX512_4VNNIW (18 * 32 + 2) /* AVX-512 Neural Network
                                                 * Instructions */
#define X86_FEATURE_AVX512_4FMAPS (18 * 32 + 3) /* AVX-512 Multiply Accumulation
                                                 * Single precision */
...
#define X86_FEATURE_SEV_ES    (19 * 32 + 3) /* AMD Secure Encrypted
                                             ...
                                             * */
#define X86_FEATURE_SEV_SNP   (19 * 32 + 4) /* AMD Secure Encrypted
                                             * Virtualization - Secure Nested
                                             * Paging */
#define X86_FEATURE_V_TSC_AUX   (19 * 32 + 9) /* "" Virtual TSC_AUX */
#define X86_FEATURE_SME_COHERENT  (19 * 32 + 10) /* "" AMD hardware-enforced
                                                  * cache coherency */
#define X86_FEATURE_DEBUG_SWAP    (19 * 32 + 14) /* AMD SEV-ES full debug state
                                                  * swap support */

/* AMD-defined Extended Feature 2 EAX, CPUID level 0x80000021 (EAX), word 20 */
#define X86_FEATURE_NO_NESTED_DATA_BP (20 * 32 + 0) /* "" No Nested Data
                                                     * Breakpoints */
#define X86_FEATURE_WRMSR_XX_BASE_NS  (20 * 32 + 1) /* "" WRMSR to
                                                     * {FS,GS,KERNEL_GS}_BASE is
                                                     * non-serializing */
#define X86_FEATURE_LFENCE_RDTSC  (20 * 32 + 2) /* "" LFENCE always serializing
                                                 * / synchronizes RDTSC */
#define X86_FEATURE_NULL_SEL_CLR_BASE (20 * 32 + 6) /* "" Null Selector Clears
                                                     * Base */
...
#define X86_FEATURE_SBPB    (20 * 32 + 27) /* "" Selective Branch Prediction
                                            * Barrier */
#define X86_FEATURE_IBPB_BRTYPE   (20 * 32 + 28) /* "" MSR_PRED_CMD[IBPB]
                                                  * flushes all branch type
                                                  * predictions */
...
#define X86_BUG_CLFLUSH_MONITOR   X86_BUG(7) /* AAI65, CLFLUSH required before
                                              * MONITOR */
 ...
 * to avoid confusion.
 */
#define X86_BUG_ESPFIX      X86_BUG(9) /* "" IRET to 16-bit SS corrupts ESP/RSP
                                        * high bits */
#endif
...
#define X86_BUG_AMD_E400    X86_BUG(13) /* CPU is among the affected by Erratum
                                         * 400 */
#define X86_BUG_CPU_MELTDOWN    X86_BUG(14) /* CPU is affected by meltdown
                                             * attack and needs kernel page
                                             * table isolation */
#define X86_BUG_SPECTRE_V1    X86_BUG(15) /* CPU is affected by Spectre variant
                                           * 1 attack with conditional branches
                                           * */
#define X86_BUG_SPECTRE_V2    X86_BUG(16) /* CPU is affected by Spectre variant
                                           * 2 attack with indirect branches */
#define X86_BUG_SPEC_STORE_BYPASS X86_BUG(17) /* CPU is affected by speculative
                                               * store bypass attack */
#define X86_BUG_L1TF      X86_BUG(18) /* CPU is affected by L1 Terminal Fault */
#define X86_BUG_MDS     X86_BUG(19) /* CPU is affected by Microarchitectural
                                     * data sampling */
#define X86_BUG_MSBDS_ONLY    X86_BUG(20) /* CPU is only affected by the  MSDBS
                                           * variant of BUG_MDS */
#define X86_BUG_SWAPGS      X86_BUG(21) /* CPU is affected by speculation
                                         * through SWAPGS */
#define X86_BUG_TAA     X86_BUG(22) /* CPU is affected by TSX Async Abort(TAA)
                                     * */
#define X86_BUG_ITLB_MULTIHIT   X86_BUG(23) /* CPU may incur MCE during certain
                                             * page attribute changes */
#define X86_BUG_SRBDS     X86_BUG(24) /* CPU may leak RNG bits if not mitigated
                                       * */
#define X86_BUG_MMIO_STALE_DATA   X86_BUG(25) /* CPU is affected by Processor
                                               * MMIO Stale Data vulnerabilities
                                               * */
#define X86_BUG_MMIO_UNKNOWN    X86_BUG(26) /* CPU is too old and its MMIO Stale
                                             * Data status is unknown */
#define X86_BUG_RETBLEED    X86_BUG(27) /* CPU is affected by RETBleed */
#define X86_BUG_EIBRS_PBRSB   X86_BUG(28) /* EIBRS is vulnerable to Post Barrier
                                           * RSB Predictions */
#define X86_BUG_SMT_RSB     X86_BUG(29) /* CPU is vulnerable to Cross-Thread
                                         * Return Address Predictions */
#define X86_BUG_GDS     X86_BUG(30) /* CPU is affected by Gather Data Sampling
                                     * */
#define X86_BUG_TDX_PW_MCE    X86_BUG(31) /* CPU may incur #MC if non-TD
                                           * software does partial write to TDX
                                           * private memory */

/* BUG word 2 */
#define X86_BUG_SRSO      X86_BUG(1 * 32 + 0) /* AMD SRSO bug */
#define X86_BUG_DIV0      X86_BUG(1 * 32 + 1) /* AMD DIV0 speculation bug */
#define X86_BUG_RFDS      X86_BUG(1 * 32 + 2) /* CPU is vulnerable to Register
                                               * File Data Sampling */
