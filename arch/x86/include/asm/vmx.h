 ...
 */
#define CPU_BASED_INTR_WINDOW_EXITING           VMCS_CONTROL_BIT( \
    INTR_WINDOW_EXITING)
#define CPU_BASED_USE_TSC_OFFSETTING            VMCS_CONTROL_BIT( \
    USE_TSC_OFFSETTING)
...
#define CPU_BASED_CR8_LOAD_EXITING              VMCS_CONTROL_BIT( \
    CR8_LOAD_EXITING)
#define CPU_BASED_CR8_STORE_EXITING             VMCS_CONTROL_BIT( \
    CR8_STORE_EXITING)
#define CPU_BASED_TPR_SHADOW                    VMCS_CONTROL_BIT(VIRTUAL_TPR)
#define CPU_BASED_NMI_WINDOW_EXITING    VMCS_CONTROL_BIT(NMI_WINDOW_EXITING)
#define CPU_BASED_MOV_DR_EXITING                VMCS_CONTROL_BIT(MOV_DR_EXITING)
#define CPU_BASED_UNCOND_IO_EXITING             VMCS_CONTROL_BIT( \
    UNCOND_IO_EXITING)
#define CPU_BASED_USE_IO_BITMAPS                VMCS_CONTROL_BIT(USE_IO_BITMAPS)
#define CPU_BASED_MONITOR_TRAP_FLAG             VMCS_CONTROL_BIT( \
    MONITOR_TRAP_FLAG)
 ...
 */
#define SECONDARY_EXEC_VIRTUALIZE_APIC_ACCESSES VMCS_CONTROL_BIT( \
    VIRT_APIC_ACCESSES)
...
#define SECONDARY_EXEC_APIC_REGISTER_VIRT       VMCS_CONTROL_BIT( \
    APIC_REGISTER_VIRT)
#define SECONDARY_EXEC_VIRTUAL_INTR_DELIVERY    VMCS_CONTROL_BIT( \
    VIRT_INTR_DELIVERY)
...
#define SECONDARY_EXEC_ENABLE_PML               VMCS_CONTROL_BIT( \
    PAGE_MOD_LOGGING)
...
#define PIN_BASED_VMX_PREEMPTION_TIMER          VMCS_CONTROL_BIT( \
    PREEMPTION_TIMER)
...
#define VMX_VMFUNC_EPTP_SWITCHING               VMFUNC_CONTROL_BIT( \
    EPTP_SWITCHING)
...
#define INTR_TYPE_HARD_EXCEPTION  (EVENT_TYPE_HWEXC << 8)   /* processor
                                                             * exception */
#define INTR_TYPE_SOFT_INTR   (EVENT_TYPE_SWINT << 8)   /* software interrupt */
#define INTR_TYPE_PRIV_SW_EXCEPTION (EVENT_TYPE_PRIV_SWEXC << 8)  /* ICE
                                                                   * breakpoint
                                                                   * */
#define INTR_TYPE_SOFT_EXCEPTION  (EVENT_TYPE_SWEXC << 8)   /* software
                                                             * exception */
...
#define LMSW_SOURCE_DATA  (0xFFFF << LMSW_SOURCE_DATA_SHIFT) /* 16:31 lmsw
                                                              * source */
#define REG_EAX                         (0 << 8)
#define REG_ECX                         (1 << 8)
#define REG_EDX                         (2 << 8)
 ...
 */
#define APIC_ACCESS_OFFSET              0xfff   /* 11:0, offset within the APIC
                                                 * page */
