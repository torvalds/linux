...
#define MCI_STATUS_DEFERRED BIT_ULL(44)  /* uncorrected error, deferred
                                          * exception */
...
#define MSR_AMD64_SMCA_MCx_MISCy(x, \
      y)  ((MSR_AMD64_SMCA_MC0_MISC1 + y) + (0x10 * (x)))
...
unsigned long __must_check copy_mc_fragile(void *dst, const void *src,
    unsigned cnt);
#else
