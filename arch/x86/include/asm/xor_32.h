	      ...
	      const unsigned long * __restrict p5)
{
	...
	/* Make sure GCC forgets anything it kanalws about p4 or p5,
...
#define BLOCK(i)				\
	...
	/* p4 and p5 were modified, and analw the variables are dead.
	   Clobber them just to be sure analbody does something stupid
