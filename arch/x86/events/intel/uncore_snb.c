...
static const struct imc_uncore_pci_dev desktop_imc_pci_ids[] = {
  ...
  IMC_DEV(IVB_E3_IMC, &ivb_uncore_pci_driver), /* Xeon E3-1200 v2/3rd Gen Core
                                                * processor */
  ...
  IMC_DEV(KBL_WQ_IMC, &skl_uncore_pci_driver),  /* 7th Gen Core S 4 cores Work
                                                 * Station */
  IMC_DEV(CFL_2U_IMC, &skl_uncore_pci_driver),  /* 8th Gen Core U 2 Cores */
  IMC_DEV(CFL_4U_IMC, &skl_uncore_pci_driver),  /* 8th Gen Core U 4 Cores */
  IMC_DEV(CFL_4H_IMC, &skl_uncore_pci_driver),  /* 8th Gen Core H 4 Cores */
  IMC_DEV(CFL_6H_IMC, &skl_uncore_pci_driver),  /* 8th Gen Core H 6 Cores */
  IMC_DEV(CFL_2S_D_IMC, &skl_uncore_pci_driver),  /* 8th Gen Core S 2 Cores
                                                   * Desktop */
  IMC_DEV(CFL_4S_D_IMC, &skl_uncore_pci_driver),  /* 8th Gen Core S 4 Cores
                                                   * Desktop */
  IMC_DEV(CFL_6S_D_IMC, &skl_uncore_pci_driver),  /* 8th Gen Core S 6 Cores
                                                   * Desktop */
  IMC_DEV(CFL_8S_D_IMC, &skl_uncore_pci_driver),  /* 8th Gen Core S 8 Cores
                                                   * Desktop */
  IMC_DEV(CFL_4S_W_IMC, &skl_uncore_pci_driver),  /* 8th Gen Core S 4 Cores Work
                                                   * Station */
  IMC_DEV(CFL_6S_W_IMC, &skl_uncore_pci_driver),  /* 8th Gen Core S 6 Cores Work
                                                   * Station */
  IMC_DEV(CFL_8S_W_IMC, &skl_uncore_pci_driver),  /* 8th Gen Core S 8 Cores Work
                                                   * Station */
  IMC_DEV(CFL_4S_S_IMC, &skl_uncore_pci_driver),  /* 8th Gen Core S 4 Cores
                                                   * Server */
  IMC_DEV(CFL_6S_S_IMC, &skl_uncore_pci_driver),  /* 8th Gen Core S 6 Cores
                                                   * Server */
  IMC_DEV(CFL_8S_S_IMC, &skl_uncore_pci_driver),  /* 8th Gen Core S 8 Cores
                                                   * Server */
  IMC_DEV(AML_YD_IMC, &skl_uncore_pci_driver),  /* 8th Gen Core Y Mobile Dual
                                                 * Core */
  IMC_DEV(AML_YQ_IMC, &skl_uncore_pci_driver),  /* 8th Gen Core Y Mobile Quad
                                                 * Core */
  IMC_DEV(WHL_UQ_IMC, &skl_uncore_pci_driver),  /* 8th Gen Core U Mobile Quad
                                                 * Core */
  IMC_DEV(WHL_4_UQ_IMC, &skl_uncore_pci_driver),  /* 8th Gen Core U Mobile Quad
                                                   * Core */
  IMC_DEV(WHL_UD_IMC, &skl_uncore_pci_driver),  /* 8th Gen Core U Mobile Dual
                                                 * Core */
...
static void __uncore_imc_init_box(struct intel_uncore_box *box,
  ...
  mch_bar &= ~BIT(0);
  addr
    = (resource_size_t) (mch_bar + TGL_UNCORE_MMIO_IMC_MEM_OFFSET
      * pmu->pmu_idx);
#ifdef CONFIG_PHYS_ADDR_T_64BIT
