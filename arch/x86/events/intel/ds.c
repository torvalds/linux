...
static u64 pebs_data_source[] = {
  ...
  OP_LH | P(LVL, L3) | LEVEL(L3) | P(SNOOP, HITM),  /* 0x07: L3 hit, snoop hitm
                                                     * */
  OP_LH | P(LVL, REM_CCE1) | REM | LEVEL(L3) | P(SNOOP, HIT),  /* 0x08: L3 miss
                                                                * snoop hit */
  OP_LH | P(LVL, REM_CCE1) | REM | LEVEL(L3) | P(SNOOP, HITM), /* 0x09: L3 miss
                                                                * snoop hitm*/
  OP_LH | P(LVL, LOC_RAM) | LEVEL(RAM) | P(SNOOP, HIT),       /* 0x0a: L3 miss,
                                                               * shared */
  OP_LH | P(LVL, REM_RAM1) | REM | LEVEL(L3) | P(SNOOP, HIT),  /* 0x0b: L3 miss,
                                                                * shared */
  OP_LH | P(LVL, LOC_RAM) | LEVEL(RAM) | SNOOP_NONE_MISS,     /* 0x0c: L3 miss,
                                                               * excl */
  OP_LH | P(LVL, REM_RAM1) | LEVEL(RAM) | REM | SNOOP_NONE_MISS, /* 0x0d: L3
                                                                  * miss, excl
                                                                  * */
...
static void __init __intel_pmu_pebs_data_source_skl(bool pmem,
    u64 *data_source) {
...
struct event_constraint intel_icl_pebs_event_constraints[] = {
  INTEL_FLAGS_UEVENT_CONSTRAINT(0x01c0, 0x100000000ULL),  /* old
...
static void pebs_update_state(bool needed_cb, struct cpu_hw_events *cpuc,
...
static void setup_pebs_adaptive_sample_data(struct perf_event *event,
  ...
  *regs = *iregs;
  ...
  if ((sample_type & PERF_SAMPLE_WEIGHT_STRUCT)
    ...
    data->weight.var3_w = format_size >>
        PEBS_RETIRE_LATENCY_OFFSET & PEBS_LATENCY_MASK;
  }
  /*
...
static inline void *get_next_pebs_record_by_bit(void *base, void *top,
    int bit) {
  struct cpu_hw_events *cpuc = this_cpu_ptr(&cpu_hw_events);
  void *at;
  u64 pebs_status;
...
static __always_inline void __intel_pmu_pebs_event(struct perf_event *event,
