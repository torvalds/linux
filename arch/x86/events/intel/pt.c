...
static ssize_t pt_timing_attr_show(struct device *dev,
    struct device_attribute *attr,
    char *page) {
...
static struct topa_entry *pt_topa_entry_for_page(struct pt_buffer *buf,
    unsigned int pg) {
  struct topa_page *tp;
  struct topa *topa;
...
static struct topa_entry *pt_topa_prev_entry(struct pt_buffer *buf,
 ...
 */
static void *pt_buffer_setup_aux(struct perf_event *event, void **pages,
