...
static void *bts_buffer_setup_aux(struct perf_event *event, void **pages,
...
static unsigned long bts_buffer_offset(struct bts_buffer *buf,
    unsigned int idx) {
...
static int bts_buffer_reset(struct bts_buffer *buf,
    struct perf_output_handle *handle);
