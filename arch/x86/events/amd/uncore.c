...
static umode_t amd_f17h_uncore_is_visible(struct kobject *kobj,
    struct attribute *attr, int i) {
  return boot_cpu_data.x86 >= 0x17 && boot_cpu_data.x86 < 0x19
    ? attr->mode : 0;
}

static umode_t amd_f19h_uncore_is_visible(struct kobject *kobj,
    struct attribute *attr, int i) {
...
DEFINE_UNCORE_FORMAT_ATTR(umask12, umask, "config:8-15,24-27");    /* PerfMonV2
                                                                    * DF */
DEFINE_UNCORE_FORMAT_ATTR(coreid, coreid, "config:42-44");     /* F19h L3 */
DEFINE_UNCORE_FORMAT_ATTR(slicemask, slicemask, "config:48-51");     /* F17h L3
                                                                      * */
DEFINE_UNCORE_FORMAT_ATTR(threadmask8, threadmask, "config:56-63");     /* F17h
                                                                        * L3 */
DEFINE_UNCORE_FORMAT_ATTR(threadmask2, threadmask, "config:56-57");     /* F19h
                                                                        * L3 */
DEFINE_UNCORE_FORMAT_ATTR(enallslices, enallslices, "config:46");      /* F19h
                                                                       * L3 */
DEFINE_UNCORE_FORMAT_ATTR(enallcores, enallcores, "config:47");      /* F19h L3
                                                                      * */
DEFINE_UNCORE_FORMAT_ATTR(sliceid, sliceid, "config:48-50");     /* F19h L3 */
DEFINE_UNCORE_FORMAT_ATTR(rdwrmask, rdwrmask, "config:8-9");       /* PerfMonV2
                                                                    * UMC */
...
int amd_uncore_umc_ctx_init(struct amd_uncore *uncore, unsigned int cpu) {
  DECLARE_BITMAP(gmask, UNCORE_GROUP_MAX) = {
    0
  };
  u8 group_num_pmus[UNCORE_GROUP_MAX] = {
    0
  };
  u8 group_num_pmcs[UNCORE_GROUP_MAX] = {
    0
  };
  union amd_uncore_info info;
  struct amd_uncore_pmu *pmu;
