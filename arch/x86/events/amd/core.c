...
static inline bool amd_is_pair_event_code(struct hw_perf_event *hwc) {
  ...
  switch (amd_get_event_code(hwc)) {
    case 0x003:
      return true;  /* Retired SSE/AVX FLOPs */
    default:
      return false;
  }
}
 ...
 */
static struct event_constraint *__amd_get_nb_event_constraints(
...
static struct event_constraint *amd_get_event_constraints(
...
static struct event_constraint amd_f15_PMC30 = EVENT_CONSTRAINT_OVERLAP(0, 0x09,
    0);
static struct event_constraint amd_f15_PMC50 = EVENT_CONSTRAINT(0, 0x3F, 0);
static struct event_constraint amd_f15_PMC53 = EVENT_CONSTRAINT(0, 0x38, 0);

static struct event_constraint *amd_get_event_constraints_f15h(
    struct cpu_hw_events *cpuc, int idx,
    struct perf_event *event) {
  struct hw_perf_event *hwc = &event->hw;
...
static struct event_constraint *amd_get_event_constraints_f17h(
    struct cpu_hw_events *cpuc, int idx,
    struct perf_event *event) {
  struct hw_perf_event *hwc = &event->hw;
...
static struct event_constraint *amd_get_event_constraints_f19h(
    struct cpu_hw_events *cpuc, int idx,
    struct perf_event *event) {
  struct hw_perf_event *hwc = &event->hw;
...
static umode_t amd_branches_is_visible(struct kobject *kobj,
...
static umode_t amd_brs_is_visible(struct kobject *kobj, struct attribute *attr,
    int i) {
