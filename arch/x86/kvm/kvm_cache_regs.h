...
#define X86_CR4_TLBFLUSH_BITS (X86_CR4_PGE | X86_CR4_PCIDE | X86_CR4_PAE \
  | X86_CR4_SMEP)
#define X86_CR4_PDPTR_BITS    (X86_CR4_PGE | X86_CR4_PSE | X86_CR4_PAE \
  | X86_CR4_SMEP)
 ...
 */
static __always_inline bool kvm_register_test_and_mark_available(
    struct kvm_vcpu *vcpu,
    enum kvm_reg reg) {
 ...
 */
static inline unsigned long kvm_register_read_raw(struct kvm_vcpu *vcpu,
    int reg) {
...
static inline void kvm_pdptr_write(struct kvm_vcpu *vcpu, int index,
    u64 value) {
