 ...
 */
#define SPTE_MMIO_ALLOWED_MASK (BIT_ULL(63) \
  | GENMASK_ULL(51, 12) | GENMASK_ULL(2, 0))
static_assert(!(SPTE_MMIO_ALLOWED_MASK
    & (SPTE_MMU_PRESENT_MASK | MMIO_SPTE_GEN_LOW_MASK
...
#define MMIO_SPTE_GEN_MASK    GENMASK_ULL( \
    MMIO_SPTE_GEN_LOW_BITS + MMIO_SPTE_GEN_HIGH_BITS - 1, 0)
