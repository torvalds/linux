...
static inline bool kvm_hv_synic_auto_eoi_set(struct kvm_vcpu *vcpu,
    int vector) {
...
static inline struct kvm_vcpu *hv_stimer_to_vcpu(
...
static inline struct kvm_vcpu_hv_tlb_flush_fifo *kvm_hv_get_tlb_flush_fifo(
...
static inline void kvm_hv_set_cpuid(struct kvm_vcpu *vcpu,
    bool hyperv_enabled) {
}
