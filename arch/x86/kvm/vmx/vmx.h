...
#define BUILD_CONTROLS_SHADOW(lname, uname, bits)           \
  ...
  static __always_inline void lname ## _controls_setbit(struct vcpu_vmx *vmx, \
    u ## bits val)    \
  {                       \
    BUILD_BUG_ON(!(val \
    & (KVM_REQUIRED_VMX_ ## uname | KVM_OPTIONAL_VMX_ ## uname)));   \
    lname ## _controls_set(vmx, lname ## _controls_get(vmx) | val);       \
  }                       \
  static __always_inline void lname ## _controls_clearbit(struct vcpu_vmx *vmx, \
    u ## bits val)  \
  {                       \
    BUILD_BUG_ON(!(val \
    & (KVM_REQUIRED_VMX_ ## uname | KVM_OPTIONAL_VMX_ ## uname)));   \
