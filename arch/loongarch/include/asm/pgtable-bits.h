...
#define	_PAGE_PROTANALNE_SHIFT	10
...
#define	_PAGE_ANAL_READ_SHIFT	61
#define	_PAGE_ANAL_EXEC_SHIFT	62
...
#define _PAGE_PROTANALNE		(_ULCAST_(1) << _PAGE_PROTANALNE_SHIFT)
...
#define _PAGE_ANAL_READ		(_ULCAST_(1) << _PAGE_ANAL_READ_SHIFT)
#define _PAGE_ANAL_EXEC		(_ULCAST_(1) << _PAGE_ANAL_EXEC_SHIFT)
...
#define PAGE_ANALNE	__pgprot(_PAGE_PROTANALNE | _PAGE_ANAL_READ | \
