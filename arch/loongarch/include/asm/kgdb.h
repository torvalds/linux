 ...
 */
#define NUMREGBYTES   ((DBG_PT_REGS_NUM + DBG_FPR_NUM) * GDB_SIZEOF_REG \
  + DBG_FCC_NUM * 1 + DBG_FCSR_NUM * 4)
...
#else /* !CONFIG_KGDB */
static inline bool kgdb_breakpoint_handler(struct pt_regs *regs) {
  return false;
}
