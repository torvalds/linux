...
#define  CSR_GTLBC_TGID_SHIFT_END (CSR_GTLBC_TGID_SHIFT + CSR_GTLBC_TGID_WIDTH \
  - 1)
...
#define LOONGARCH_CSR_PGDL    0x19  /* Page table base address when VA[VALEN-1]
                                     * = 0 */

#define LOONGARCH_CSR_PGDH    0x1a  /* Page table base address when VA[VALEN-1]
                                     * = 1 */
...
#define  CSR_GSTAT_GID_SHIFT_END  (CSR_GSTAT_GID_SHIFT + CSR_GSTAT_GID_WIDTH \
  - 1)
