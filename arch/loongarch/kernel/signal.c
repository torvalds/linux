...
extern asmlinkage int _save_fp_context(void __user *fpregs, void __user *fcc,
    void __user *csr);
extern asmlinkage int _restore_fp_context(void __user *fpregs, void __user *fcc,
    void __user *csr);
extern asmlinkage int _save_lsx_context(void __user *fpregs, void __user *fcc,
    void __user *fcsr);
extern asmlinkage int _restore_lsx_context(void __user *fpregs,
    void __user *fcc, void __user *fcsr);
extern asmlinkage int _save_lasx_context(void __user *fpregs, void __user *fcc,
    void __user *fcsr);
extern asmlinkage int _restore_lasx_context(void __user *fpregs,
    void __user *fcc,
    void __user *fcsr);

#ifdef CONFIG_CPU_HAS_LBT
extern asmlinkage int _save_lbt_context(void __user *regs, void __user *eflags);
extern asmlinkage int _restore_lbt_context(void __user *regs,
    void __user *eflags);
...
static int protected_save_fpu_context(struct extctx_layout *extctx) {
  ...
  struct fpu_context __user *fpu_ctx
    = (struct fpu_context *) get_ctx_through_ctxinfo(info);
...
static int protected_save_lsx_context(struct extctx_layout *extctx) {
  ...
  struct lsx_context __user *lsx_ctx
    = (struct lsx_context *) get_ctx_through_ctxinfo(info);
...
static int parse_extcontext(struct sigcontext __user *sc,
    struct extctx_layout *extctx) {
  int err = 0;
  unsigned int magic, size;
  struct sctx_info __user *info
    = (struct sctx_info __user *) &sc->sc_extcontext;
  while (1) {
...
static unsigned long setup_extcontext(struct extctx_layout *extctx,
    unsigned long sp) {
...
static void handle_signal(struct ksignal *ksig, struct pt_regs *regs) {
  ...
  ret = setup_rt_frame(vdso + current->thread.vdso->offset_sigreturn, ksig,
      regs, oldset);
