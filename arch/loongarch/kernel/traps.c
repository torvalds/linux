...
static void print_bool_fragment(const char *key, unsigned long val,
    bool first) {
  /* e.g. "+PG", "-DA" */
...
static const char *humanize_exc_name(unsigned int ecode,
  ...
  switch (ecode) {
    ...
    case EXCCODE_FPE:
      switch (esubcode) {
        case EXCSUBCODE_FPE:
          return "FPE";
        case EXCSUBCODE_VFPE:
          return "VFPE";
      }
      break;
    case EXCCODE_WATCH:
      switch (esubcode) {
        case EXCSUBCODE_WPEF:
          return "WPEF";
        case EXCSUBCODE_WPEM:
          return "WPEM";
      }
      break;
    case EXCCODE_BTDIS:
    ...
    case EXCCODE_GCM:
      switch (esubcode) {
        case EXCSUBCODE_GCSC:
          return "GCSC";
        case EXCSUBCODE_GCHC:
          return "GCHC";
      }
      break;
    /*
