...
static inline int bpf2la_offset(int bpf_insn, int off,
...
static inline void emit_zext_32(struct jit_ctx *ctx, enum loongarch_gpr reg,
    bool is32) {
  if (!is32) {
    return;
  }
...
static inline void move_addr(struct jit_ctx *ctx, enum loongarch_gpr rd,
    u64 addr) {
...
static inline void move_imm(struct jit_ctx *ctx, enum loongarch_gpr rd,
    long imm, bool is32) {
...
static inline void cond_jmp_offset(struct jit_ctx *ctx, u8 cond,
    enum loongarch_gpr rj,
...
static inline void cond_jmp_offs26(struct jit_ctx *ctx, u8 cond,
    enum loongarch_gpr rj,
    enum loongarch_gpr rd, int jmp_offset) {
...
static inline int emit_cond_jmp(struct jit_ctx *ctx, u8 cond,
    enum loongarch_gpr rj,
    enum loongarch_gpr rd, int jmp_offset) {
  /*
...
static inline int emit_tailcall_jmp(struct jit_ctx *ctx, u8 cond,
    enum loongarch_gpr rj,
    enum loongarch_gpr rd, int jmp_offset) {
