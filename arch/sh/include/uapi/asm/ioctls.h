...
#define TCSBRKP   _IOW('T', 37, int) /* 0x5425 */ /* Needed for POSIX
                                      * tcsendbreak() */
#define TIOCSBRK  _IO('T', 39) /* 0x5427 */ /* BSD compatibility */
#define TIOCCBRK  _IO('T', 40) /* 0x5428 */ /* BSD compatibility */
#define TIOCGSID  _IOR('T', 41, pid_t) /* 0x5429 */ /* Return the session ID of
                                        * FD */
...
#define TIOCSERGSTRUCT  0x80d85458  /* _IOR('T', 88, struct async_struct) 0x5458
                                     * */ /* For debugging only */
#define TIOCSERGETLSR   _IOR('T', 89, unsigned int) /* 0x5459 */ /* Get line
                                                     * status register */
/* ioctl (fd, TIOCSERGETLSR, &result) where result may be as below */
#define TIOCSER_TEMT    0x01 /* Transmitter physically empty */
#define TIOCSERGETMULTI 0x80A8545A  /* _IOR('T', 90, struct
                                     * serial_multiport_struct) 0x545A */ /* Get
                                     * multiport config */
#define TIOCSERSETMULTI 0x40A8545B  /* _IOW('T', 91, struct
                                     * serial_multiport_struct) 0x545B */ /* Set
                                     * multiport config */

#define TIOCMIWAIT  _IO('T', 92) /* 0x545C */ /* wait for a change on serial
                                  * input line(s) */
