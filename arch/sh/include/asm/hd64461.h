...
#define HD64461_LDHNCR    HD64461_IO_OFFSET(0x1014) /* Number of horizontal
                                                     * characters */
#define HD64461_LDHNSR    HD64461_IO_OFFSET(0x1016) /* Specify output start
                                                     * position + width of CL1
                                                     * */
#define HD64461_LDVNTR    HD64461_IO_OFFSET(0x1018) /* Specify total vertical
                                                     * lines */
#define HD64461_LDVNDR    HD64461_IO_OFFSET(0x101a) /* specify number of display
                                                     * vertical lines */
#define HD64461_LDVSPR    HD64461_IO_OFFSET(0x101c) /* specify vertical
                                                     * synchronization pos and
                                                     * AC nr */
...
/* Palette Registers */
#define HD64461_CPTWAR    HD64461_IO_OFFSET(0x1030) /* Color Palette Write
                                                     * Address Register */
#define HD64461_CPTWDR    HD64461_IO_OFFSET(0x1032) /* Color Palette Write Data
                                                     * Register */
#define HD64461_CPTRAR    HD64461_IO_OFFSET(0x1034) /* Color Palette Read
                                                    * Address Register */
#define HD64461_CPTRDR    HD64461_IO_OFFSET(0x1036) /* Color Palette Read Data
                                                     * Register */

#define HD64461_GRDOR   HD64461_IO_OFFSET(0x1040) /* Display Resolution Offset
                                                   * Register */
#define HD64461_GRSCR   HD64461_IO_OFFSET(0x1042) /* Solid Color Register */
#define HD64461_GRCFGR    HD64461_IO_OFFSET(0x1044) /* Accelerator Configuration
                                                     * Register */
...
#define HD64461_LNSARH    HD64461_IO_OFFSET(0x1046) /* Line Start Address
                                                     * Register (H) */
#define HD64461_LNSARL    HD64461_IO_OFFSET(0x1048) /* Line Start Address
                                                     * Register (L) */
#define HD64461_LNAXLR    HD64461_IO_OFFSET(0x104a) /* Axis Pixel Length
                                                     * Register */
...
/* BitBLT Registers */
#define HD64461_BBTSSARH  HD64461_IO_OFFSET(0x1054) /* Source Start Address
                                                     * Register (H) */
#define HD64461_BBTSSARL  HD64461_IO_OFFSET(0x1056) /* Source Start Address
                                                     * Register (L) */
#define HD64461_BBTDSARH  HD64461_IO_OFFSET(0x1058) /* Destination Start Address
                                                     * Register (H) */
#define HD64461_BBTDSARL  HD64461_IO_OFFSET(0x105a) /* Destination Start Address
                                                     * Register (L) */
#define HD64461_BBTDWR    HD64461_IO_OFFSET(0x105c) /* Destination Block Width
                                                     * Register */
#define HD64461_BBTDHR    HD64461_IO_OFFSET(0x105e) /* Destination Block Height
                                                     * Register */
#define HD64461_BBTPARH   HD64461_IO_OFFSET(0x1060) /* Pattern Start Address
                                                     * Register (H) */
#define HD64461_BBTPARL   HD64461_IO_OFFSET(0x1062) /* Pattern Start Address
                                                     * Register (L) */
#define HD64461_BBTMARH   HD64461_IO_OFFSET(0x1064) /* Mask Start Address
                                                     * Register (H) */
#define HD64461_BBTMARL   HD64461_IO_OFFSET(0x1066) /* Mask Start Address
                                                     * Register (L) */
...
#define HD64461_PCC0GCR   HD64461_IO_OFFSET(0x2002) /* socket 0 general control
                                                     * */
#define HD64461_PCC0CSCR  HD64461_IO_OFFSET(0x2004) /* socket 0 card status
                                                     * change */
#define HD64461_PCC0CSCIER  HD64461_IO_OFFSET(0x2006) /* socket 0 card status
...
#define HD64461_PCC1GCR   HD64461_IO_OFFSET(0x2012) /* socket 1 general control
                                                     * */
#define HD64461_PCC1CSCR  HD64461_IO_OFFSET(0x2014) /* socket 1 card status
                                                     * change */
#define HD64461_PCC1CSCIER  HD64461_IO_OFFSET(0x2016) /* socket 1 card status
                                                       * change interrupt enable
                                                       * */
