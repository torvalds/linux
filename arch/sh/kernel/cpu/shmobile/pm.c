...
/*
 * Notifier lists for pre/post sleep yestification
 */
ATOMIC_NOTIFIER_HEAD(sh_mobile_pre_sleep_yestifier_list);
ATOMIC_NOTIFIER_HEAD(sh_mobile_post_sleep_yestifier_list);
...
void sh_mobile_call_standby(unsigned long mode)
{
	...
	atomic_yestifier_call_chain(&sh_mobile_pre_sleep_yestifier_list,
				   mode, NULL);
	...
	atomic_yestifier_call_chain(&sh_mobile_post_sleep_yestifier_list,
				   mode, NULL);
}
