...
enum {
  DIV4_I, DIV4_U, DIV4_SH, DIV4_B, DIV4_B3, DIV4_P, DIV4_NR
};
...
enum {
  DIV4_SIUA, DIV4_SIUB, DIV4_REPARENT_NR
};
...
static struct clk mstp_clks[HWBLK_NR] = {
  [HWBLK_URAM] = SH_CLK_MSTP32(&div4_clks[DIV4_U], MSTPCR0, 28,
      CLK_ENABLE_ON_INIT),
  [HWBLK_XYMEM] = SH_CLK_MSTP32(&div4_clks[DIV4_B], MSTPCR0, 26,
      CLK_ENABLE_ON_INIT),
