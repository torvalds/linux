...
static struct clk mstp_clks[] = {
  ...
  [HWBLK_L2C] = SH_CLK_MSTP32(&div4_clks[DIV4_SH], MSTPCR0, 28,
      CLK_ENABLE_ON_INIT),
  [HWBLK_ILMEM] = SH_CLK_MSTP32(&div4_clks[DIV4_I], MSTPCR0, 27,
      CLK_ENABLE_ON_INIT),
  [HWBLK_FPU] = SH_CLK_MSTP32(&div4_clks[DIV4_I], MSTPCR0, 24,
      CLK_ENABLE_ON_INIT),
  [HWBLK_INTC] = SH_CLK_MSTP32(&div4_clks[DIV4_I], MSTPCR0, 22,
      CLK_ENABLE_ON_INIT),
  ...
  [HWBLK_ICB] = SH_CLK_MSTP32(&div4_clks[DIV4_B], MSTPCR2, 21,
      CLK_ENABLE_ON_INIT),
