...
static void print_ftrace_graph_addr(unsigned long addr, void *data,
...
#else
static inline void print_ftrace_graph_addr(unsigned long addr, void *data,
    const struct stacktrace_ops *ops,
    struct thread_info *tinfo, int *graph) {
}
...
void stack_reader_dump(struct task_struct *task, struct pt_regs *regs,
