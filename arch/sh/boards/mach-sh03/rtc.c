...
again:
  ...
  != (__raw_readb(RTC_SEC1) & 0xf) + (__raw_readb(RTC_SEC10) & 0x7) * 10);
  if (year == 0 || mon < 1 || mon > 12 || day > 31 || day < 1
    ...
    __raw_writeb(0, RTC_SEC1);
    __raw_writeb(0, RTC_SEC10);
    __raw_writeb(0, RTC_MIN1);
    __raw_writeb(0, RTC_MIN10);
    __raw_writeb(0, RTC_HOU1);
    __raw_writeb(0, RTC_HOU10);
    __raw_writeb(6, RTC_WEE1);
    __raw_writeb(1, RTC_DAY1);
    __raw_writeb(0, RTC_DAY10);
    __raw_writeb(1, RTC_MON1);
    __raw_writeb(0, RTC_MON10);
    __raw_writeb(0, RTC_YEA1);
    __raw_writeb(0, RTC_YEA10);
...
static int set_rtc_mmss(struct rtc_time *tm) {
  ...
  cmos_minutes = (__raw_readb(RTC_MIN1) & 0xf)
      + (__raw_readb(RTC_MIN10) & 0xf) * 10;
