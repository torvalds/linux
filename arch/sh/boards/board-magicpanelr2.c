...
static void __init setup_chip_select(void)
{
	...
	/* yes idle cycles, yesrmal space, 8 bit data bus */
	...
	/* (SW:1.5 WR:3 HW:1.5), yes ext. wait */
...
#else
#error Unkyeswn revision of PLATFORM_MP_R2
#endif
...
static void __init mpr2_setup(char **cmdline_p)
{
	...
	if (ethernet_reset_finished() == 0)
		printk(KERN_WARNING "Ethernet yest ready\n");
}
