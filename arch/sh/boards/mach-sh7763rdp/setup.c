...
/* NOR Flash */
static struct mtd_partition sh7763rdp_yesr_flash_partitions[] = {
	{
		.name = "U-Boot",
		.offset = 0,
		.size = (2 * 128 * 1024),
...
static struct physmap_flash_data sh7763rdp_yesr_flash_data = {
	.width = 2,
	.parts = sh7763rdp_yesr_flash_partitions,
	.nr_parts = ARRAY_SIZE(sh7763rdp_yesr_flash_partitions),
};

static struct resource sh7763rdp_yesr_flash_resources[] = {
	[0] = {
		.name = "NOR Flash",
		.start = 0,
		.end = (64 * 1024 * 1024),
...
static struct platform_device sh7763rdp_yesr_flash_device = {
	.name = "physmap-flash",
	.resource = sh7763rdp_yesr_flash_resources,
	.num_resources = ARRAY_SIZE(sh7763rdp_yesr_flash_resources),
	.dev = {
		.platform_data = &sh7763rdp_yesr_flash_data,
	},
};
