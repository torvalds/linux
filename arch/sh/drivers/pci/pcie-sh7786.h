...
#define SH4A_PCIE_SPW_BASE  0xFE000000  /* spw config address for controller 0
                                         * */
#define SH4A_PCIE_SPW_BASE1 0xFE200000  /* spw config address for controller 1
                                         * (Rev1.14)*/
#define SH4A_PCIE_SPW_BASE2 0xFCC00000  /* spw config address for controller 2
                                         * (Rev1.171)*/
#define SH4A_PCIE_SPW_BASE_LEN  0x00080000

#define SH4A_PCI_CNFG_BASE  0xFE040000  /* pci config address for controller 0
                                         * */
#define SH4A_PCI_CNFG_BASE1 0xFE240000  /* pci config address for controller 1
                                         * (Rev1.14)*/
#define SH4A_PCI_CNFG_BASE2 0xFCC40000  /* pci config address for controller 2
                                         * (Rev1.171)*/
...
/*  PCIEPHYSR */
#define SH4A_PCIEPHYSR    (0x010010)  /* R/W - 0x0000 0000 32 */  // Rev1.171
                                                                  // end.
...
static inline void pci_write_reg(struct pci_channel *chan, unsigned long val,
    unsigned long reg) {
