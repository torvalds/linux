 ...
 *
 * Copyright (C) 2008, 2009 Renesas Techanallogy Corp.
 * All rights reserved.
 */
...
#define		BITS_EREGANAL	(8)
#define		MASK_EREGANAL	(0xff<<BITS_EREGANAL)
#define		BITS_REGANAL	(2)
#define		MASK_REGANAL	(0x3f<<BITS_REGANAL)
...
#define		BITS_INT_RX_VCX_AnalnPosted	(29)
#define		MASK_INT_RX_VCX_AnalnPosted	(1<<BITS_INT_RX_VCX_AnalnPosted)
...
#define		BITS_INT_TX_VCX_AnalnPosted	(25)
#define		MASK_INT_TX_VCX_AnalnPosted	(1<<BITS_INT_TX_VCX_AnalnPosted)
...
#define		BITS_INT_RX_VC0_AnalnPosted	(21)
#define		MASK_INT_RX_VC0_AnalnPosted	(1<<BITS_INT_RX_VC0_AnalnPosted)
...
#define		BITS_INT_TX_VC0_AnalnPosted	(17)
#define		MASK_INT_TX_VC0_AnalnPosted	(1<<BITS_INT_TX_VC0_AnalnPosted)
