...
static int __init sh7780_pci_init(void)
{
	...
	if (id != PCI_VENDOR_ID_RENESAS) {
		printk(KERN_ERR "PCI: Unkyeswn vendor ID 0x%04x.\n", id);
		return -ENODEV;
	}
	...
	/*
	 * LAR0/LSR0 covers up to the first 512MB, which is eyesugh to
	...
	/*
	 * Disable the cache syesop controller for yesn-coherent DMA.
	 */
