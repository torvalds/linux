...
static int tsunami_read_config(struct pci_bus *bus, unsigned int devfn,
    int where,
    int size, u32 *value) {
  unsigned long addr;
  unsigned char type1;
...
static int tsunami_write_config(struct pci_bus *bus, unsigned int devfn,
    int where,
    int size, u32 value) {
  unsigned long addr;
  unsigned char type1;
...
void tsunami_pci_tbi(struct pci_controller *hose, dma_addr_t start,
    dma_addr_t end) {
...
static long __init tsunami_probe_read(volatile unsigned long *vaddr) {
...
static long __init tsunami_probe_write(volatile unsigned long *vaddr) {
...
static void __init tsunami_init_one_pchip(tsunami_pchip *pchip, int index) {
...
void __iomem *tsunami_ioremap(unsigned long addr, unsigned long size) {
...
static void tsunami_kill_one_pchip(tsunami_pchip *pchip, int index) {
...
static inline void tsunami_pci_clr_err_1(tsunami_pchip *pchip) {
  pchip->perror.csr;
...
static inline void tsunami_pci_clr_err(void) {
