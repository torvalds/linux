...
static int irongate_read_config(struct pci_bus *bus, unsigned int devfn,
    int where,
    int size, u32 *value) {
  unsigned long addr;
  unsigned char type1;
...
static int irongate_write_config(struct pci_bus *bus, unsigned int devfn,
    int where,
    int size, u32 value) {
  unsigned long addr;
  unsigned char type1;
...
static void __init albacore_init_arch(void) {
...
static void __init irongate_setup_agp(void) {
...
void __iomem *irongate_ioremap(unsigned long addr, unsigned long size) {
