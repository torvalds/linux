...
static struct pci_controller *__init default_vga_hose_select(
    struct pci_controller *h1, struct pci_controller *h2) {
...
void __init locate_and_init_vga(void *(*sel_func)(void *, void *)) {
  struct pci_controller *hose = NULL;
  struct pci_dev *dev = NULL;
  /* Default the select function */
  if (!sel_func) {
    sel_func = (void *) default_vga_hose_select;
  }
...
void __init find_console_vga_hose(void) {
