...
static int __init SMC37c669_xlate_irq(int irq) {
  ...
  if (SMC37c669_IS_DEVICE_IRQ(irq)) {
    ...
    */
    for (i = 0;
        (SMC37c669_irq_table[i].device_irq != -1)
        || (SMC37c669_irq_table[i].isa_irq != -1); i++) {
    ...
    */
    for (i = 0;
        (SMC37c669_irq_table[i].isa_irq != -1)
        || (SMC37c669_irq_table[i].device_irq != -1); i++) {
...
static int __init SMC37c669_xlate_drq(int drq) {
  ...
  if (SMC37c669_IS_DEVICE_DRQ(drq)) {
    ...
    */
    for (i = 0;
        (SMC37c669_drq_table[i].device_drq != -1)
        || (SMC37c669_drq_table[i].isa_drq != -1); i++) {
    ...
    */
    for (i = 0;
        (SMC37c669_drq_table[i].isa_drq != -1)
        || (SMC37c669_drq_table[i].device_drq != -1); i++) {
