...
static void __init sx164_init_irq(void) {
...
static int sx164_map_irq(const struct pci_dev *dev, u8 slot, u8 pin) {
...
static void __init sx164_init_pci(void) {
  cia_init_pci();
  SMC669_Init(0);
}

static void __init sx164_init_arch(void) {
  /*
