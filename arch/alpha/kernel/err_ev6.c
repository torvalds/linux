...
static int ev6_parse_ibox(u64 i_stat, int print) {
...
static int ev6_parse_mbox(u64 mm_stat, u64 d_stat, u64 c_stat, int print) {
  int status = MCHK_DISPOSITION_REPORT;
...
static int ev6_parse_cbox(u64 c_addr, u64 c1_syn, u64 c2_syn,
  ...
  static const char * const streamname[] = {
    "D", "I"
  };
  static const char * const bitsname[] = {
    "SINGLE", "DOUBLE"
  };
  int status = MCHK_DISPOSITION_REPORT;
