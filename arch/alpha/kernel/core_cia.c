...
static int mk_conf_addr(struct pci_bus *bus_dev, unsigned int device_fn,
    int where,
...
static int cia_read_config(struct pci_bus *bus, unsigned int devfn, int where,
    int size,
    u32 *value) {
...
static int cia_write_config(struct pci_bus *bus, unsigned int devfn, int where,
    int size,
    u32 value) {
  unsigned long addr, pci_addr;
  long mask;
...
void cia_pci_tbi(struct pci_controller *hose, dma_addr_t start,
    dma_addr_t end) {
  wmb();
...
static inline void cia_prepare_tbia_workaround(int window) {
...
static void __init verify_tb_operation(void) {
...
void cia_save_srm_settings(int is_pyxis) {
  int i;
...
void cia_restore_srm_settings(void) {
  int i;
  for (i = 0; i < 4; i++) {
...
static void __init do_init_arch(int is_pyxis) {
...
static inline void cia_pci_clr_err(void) {
  int jd;
...
static void cia_decode_pci_error(struct el_CIA_sysdata_mcheck *cia,
    const char *msg) {
...
static void cia_decode_mem_error(struct el_CIA_sysdata_mcheck *cia,
    const char *msg) {
  ...
  switch (tmp) {
    case 0x00:
      set_select = "Set 0 selected";
      break;
    case 0x01:
      set_select = "Set 1 selected";
      break;
    case 0x02:
      set_select = "Set 2 selected";
      break;
    case 0x03:
      set_select = "Set 3 selected";
      break;
    case 0x04:
      set_select = "Set 4 selected";
      break;
    case 0x05:
      set_select = "Set 5 selected";
      break;
    case 0x06:
      set_select = "Set 6 selected";
      break;
    case 0x07:
      set_select = "Set 7 selected";
      break;
    case 0x08:
      set_select = "Set 8 selected";
      break;
    case 0x09:
      set_select = "Set 9 selected";
      break;
    case 0x0A:
      set_select = "Set A selected";
      break;
    case 0x0B:
      set_select = "Set B selected";
      break;
    case 0x0C:
      set_select = "Set C selected";
      break;
    case 0x0D:
      set_select = "Set D selected";
      break;
    case 0x0E:
      set_select = "Set E selected";
      break;
    case 0x0F:
      set_select = "Set F selected";
      break;
    case 0x10:
      set_select = "No set selected";
      break;
    case 0x1F:
      set_select = "Refresh cycle";
      break;
    default:
      set_select = "Unknown";
      break;
...
static void cia_decode_ecc_error(struct el_CIA_sysdata_mcheck *cia,
    const char *msg) {
  long syn;
  long i;
  const char *fmt;
...
static void cia_decode_parity_error(struct el_CIA_sysdata_mcheck *cia) {
...
static int cia_decode_mchk(unsigned long la_ptr) {
