...
void wildfire_pci_tbi(struct pci_controller *hose, dma_addr_t start,
    dma_addr_t end) {
...
static int wildfire_read_config(struct pci_bus *bus, unsigned int devfn,
    int where,
    int size, u32 *value) {
  unsigned long addr;
  unsigned char type1;
...
static int wildfire_write_config(struct pci_bus *bus, unsigned int devfn,
    int where,
    int size, u32 value) {
  unsigned long addr;
  unsigned char type1;
...
static void __init wildfire_dump_pci_regs(int qbbno, int hoseno) {
  wildfire_pci *pci = WILDFIRE_pci(qbbno, hoseno);
  int i;
...
static void __init wildfire_dump_pca_regs(int qbbno, int pcano) {
...
static void __init wildfire_dump_qsa_regs(int qbbno) {
...
static void __init wildfire_dump_qsd_regs(int qbbno) {
...
static void __init wildfire_dump_iop_regs(int qbbno) {
...
static void __init wildfire_dump_gp_regs(int qbbno) {
...
#if DEBUG_DUMP_CONFIG
static void __init wildfire_dump_hardware_config(void) {
  int i;
