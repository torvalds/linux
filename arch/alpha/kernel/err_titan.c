...
static int titan_parse_c_misc(u64 c_misc, int print) {
...
static int titan_parse_p_serror(int which, u64 serror, int print) {
  int status = MCHK_DISPOSITION_REPORT;
#ifdef CONFIG_VERBOSE_MCHECK
...
static int titan_parse_p_perror(int which, int port, u64 perror, int print) {
  int cmd;
  unsigned long addr;
  int status = MCHK_DISPOSITION_REPORT;
#ifdef CONFIG_VERBOSE_MCHECK
...
static int titan_parse_p_agperror(int which, u64 agperror, int print) {
  int status = MCHK_DISPOSITION_REPORT;
#ifdef CONFIG_VERBOSE_MCHECK
  int cmd, len;
  unsigned long addr;
...
static int titan_parse_p_chip(int which, u64 serror, u64 gperror,
...
static struct el_subpacket *el_process_regatta_subpacket(
...
static int privateer_process_680_frame(struct el_common *mchk_header,
    int print) {
  int status = MCHK_DISPOSITION_UNKNOWN_ERROR;
#ifdef CONFIG_VERBOSE_MCHECK
