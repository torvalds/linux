				    ...
				    struct ev7_lf_subpackets *lf_subpackets)
{
	...
	for (i = 0;
		...
		default:
			/*
			 * Don't kyesw what kind of frame this is.
			 */
			return NULL;
		}
	}
...
static char *el_ev7_processor_subpacket_anyestation[] = {
...
static char *el_ev7_zbox_subpacket_anyestation[] = {
	"Subpacket Header", 	
...
static char *el_ev7_rbox_subpacket_anyestation[] = {
...
static char *el_ev7_io_subpacket_anyestation[] = {
...
static struct el_subpacket_anyestation el_ev7_pal_anyestations[] = {
	SUBPACKET_ANNOTATION(EL_CLASS__PAL,
			     EL_TYPE__PAL__EV7_PROCESSOR,
			     1,
			     "EV7 Processor Subpacket",
			     el_ev7_processor_subpacket_anyestation),
	SUBPACKET_ANNOTATION(EL_CLASS__PAL,
			     EL_TYPE__PAL__EV7_ZBOX,
			     1,
			     "EV7 ZBOX Subpacket",
			     el_ev7_zbox_subpacket_anyestation),
	SUBPACKET_ANNOTATION(EL_CLASS__PAL,
			     EL_TYPE__PAL__EV7_RBOX,
			     1,
			     "EV7 RBOX Subpacket",
			     el_ev7_rbox_subpacket_anyestation),
	SUBPACKET_ANNOTATION(EL_CLASS__PAL,
			     EL_TYPE__PAL__EV7_IO,
			     1,
			     "EV7 IO Subpacket",
			     el_ev7_io_subpacket_anyestation)
};
...
ev7_register_error_handlers(void)
{
	...
	for (i = 0; i < ARRAY_SIZE(el_ev7_pal_anyestations); i++)
		cdl_register_subpacket_anyestation(&el_ev7_pal_anyestations[i]);
