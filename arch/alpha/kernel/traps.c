...
static void dik_show_trace(unsigned long *sp, const char *loglvl) {
  long i = 0;
  printk("%sTrace:\n", loglvl);
...
asmlinkage void do_entUnaUser(void __user *va, unsigned long opcode,
