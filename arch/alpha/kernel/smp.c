 ...
 */
static inline void __init smp_store_cpu_info(int cpuid) {
 ...
 */
static inline void __init smp_setup_percpu_timer(int cpuid) {
...
static int wait_for_txrdy(unsigned long cpumask) {
 ...
 * interesting message.  ;-)
 */
static void send_secondary_console_msg(char *str, int cpuid) {
 ...
 */
static void recv_secondary_console_msg(void) {
  int mycpu, i, cnt;
...
static void ipi_imb(void *ignored) {
  imb();
}
