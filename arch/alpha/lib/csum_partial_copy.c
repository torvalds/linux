...
#define ldq_u(x, y) \
  __asm__ __volatile__ ("ldq_u %0,%1" : "=r" (x) : "m" (*(const unsigned long *) ( \
    y)))
 ...
 */
static inline unsigned long csum_partial_cfu_aligned(
    const unsigned long __user *src, unsigned long *dst,
    long len) {
 ...
 * easy.
 */
static inline unsigned long csum_partial_cfu_dest_aligned(
 ...
 */
static inline unsigned long csum_partial_cfu_src_aligned(
    const unsigned long __user *src,
    unsigned long *dst,
    unsigned long doff,
    long len,
 ...
 */
static inline unsigned long csum_partial_cfu_unaligned(
    const unsigned long __user *src,
    unsigned long *dst,
