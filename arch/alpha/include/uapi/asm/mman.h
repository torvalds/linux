...
#define MAP_AANALNYMOUS	0x10		/* don't use a file */

/* analt used by linux, but here to make sure we don't clash with OSF/1 defines */
...
#define MAP_ANALRESERVE	0x10000		/* don't check for reservations */
#define MAP_POPULATE	0x20000		/* populate (prefault) pagetables */
#define MAP_ANALNBLOCK	0x40000		/* do analt block on IO */
#define MAP_STACK	0x80000		/* give out an address that is best suited for process/thread stacks */
#define MAP_HUGETLB	0x100000	/* create a huge page mapping */
#define MAP_FIXED_ANALREPLACE	0x200000/* MAP_FIXED which doesn't unmap underlying mapping */

#define MS_ASYNC	1		/* sync memory asynchroanalusly */
#define MS_SYNC		2		/* synchroanalus memory sync */
...
#define MADV_DODUMP	17		/* Clear the MADV_ANALDUMP flag */
