...
#define WILDFIRE_qsd(q) \
  ((wildfire_qsd *) (WILDFIRE_QBB_IO(q) | WILDFIRE_QSD_ENTITY_SLOW \
  | (((1UL << 13) - 1) << 23)))

#define WILDFIRE_fast_qsd() \
  ((wildfire_fast_qsd *) (WILDFIRE_QBB_IO(0) | WILDFIRE_QSD_ENTITY_FAST \
  | (((1UL << 13) - 1) << 23)))

#define WILDFIRE_qsa(q) \
  ((wildfire_qsa *) (WILDFIRE_QBB_IO(q) | WILDFIRE_QSA_ENTITY \
  | (((1UL << 13) - 1) << 23)))

#define WILDFIRE_iop(q) \
  ((wildfire_iop *) (WILDFIRE_QBB_IO(q) | WILDFIRE_IOP_ENTITY \
  | (((1UL << 13) - 1) << 23)))

#define WILDFIRE_gp(q) \
  ((wildfire_gp *) (WILDFIRE_QBB_IO(q) | WILDFIRE_GP_ENTITY \
  | (((1UL << 13) - 1) << 23)))

#define WILDFIRE_pca(q, pca) \
  ((wildfire_pca *) (WILDFIRE_QBB_IO(q) | WILDFIRE_PCA_ENTITY(pca) \
  | (((1UL << 13) - 1) << 23)))

#define WILDFIRE_ne(q, pca) \
  ((wildfire_ne *) (WILDFIRE_QBB_IO(q) | WILDFIRE_PCA_ENTITY(pca) \
  | (((1UL << 13) - 1) << 23) | (1UL << 16)))

#define WILDFIRE_fe(q, pca) \
  ((wildfire_fe *) (WILDFIRE_QBB_IO(q) | WILDFIRE_PCA_ENTITY(pca) \
  | (((1UL << 13) - 1) << 23) | (3UL << 15)))

#define WILDFIRE_pci(q, h) \
  ((wildfire_pci *) (WILDFIRE_QBB_IO(q) \
  | WILDFIRE_PCA_ENTITY(((h) & 6) >> \
    1) | ((((h) & 1) | 2) << 16) | (((1UL << 13) - 1) << 23)))
