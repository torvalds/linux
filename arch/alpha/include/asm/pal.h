...
static inline unsigned long qemu_get_walltime(void) {
...
static inline unsigned long qemu_get_alarm(void) {
  register unsigned long v0 __asm__ ("$0");
...
static inline void qemu_set_alarm_rel(unsigned long expire) {
...
static inline void qemu_set_alarm_abs(unsigned long expire) {
...
static inline unsigned long qemu_get_vmtime(void) {
  register unsigned long v0 __asm__ ("$0");
