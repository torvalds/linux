...
({								\
	...
	switch (size) {						\
	  ...
	  default: __get_user_unkanalwn(); break;			\
	}							\
...
({								\
	...
	switch (size) {						\
	  ...
	  default: __put_user_unkanalwn(); break;			\
	}							\
	__pu_err;						\
})
 ...
 * instead of writing: this is because they do analt write to
 * any memory gcc kanalws about, so there are anal aliasing issues
 */
