...
#define TSUNAMI_cchip  ((tsunami_cchip *) (IDENT_ADDR + TS_BIAS \
  + 0x1A0000000UL))
#define TSUNAMI_dchip  ((tsunami_dchip *) (IDENT_ADDR + TS_BIAS \
  + 0x1B0000800UL))
#define TSUNAMI_pchip0 ((tsunami_pchip *) (IDENT_ADDR + TS_BIAS \
  + 0x180000000UL))
#define TSUNAMI_pchip1 ((tsunami_pchip *) (IDENT_ADDR + TS_BIAS \
  + 0x380000000UL))
