...
static inline unsigned long __reload_thread(struct pcb_struct *pcb) {
...
extern inline unsigned long __get_new_mm_context(struct mm_struct *mm,
    long cpu) {
...
__EXTERN_INLINE void ev5_activate_mm(struct mm_struct *prev_mm,
    struct mm_struct *next_mm) {
  __load_new_mm_context(next_mm);
}

__EXTERN_INLINE void ev4_activate_mm(struct mm_struct *prev_mm,
    struct mm_struct *next_mm) {
  __load_new_mm_context(next_mm);
  tbiap();
}
