...
#define __put_user_size(x, ptr, size, retval)       \
  do {                  \
    ...
    switch (size) {             \
      case 1: \
        __put_user_asm(x, ptr, retval, 1, "s8i", __cb); break; \
      case 2: \
        __put_user_asm(x, ptr, retval, 2, "s16i", __cb); break; \
      case 4: \
        __put_user_asm(x, ptr, retval, 4, "s32i", __cb); break; \
      case 8: \
        {             \
...
#define __get_user_size(x, ptr, size, retval)       \
  do {                  \
    ...
    switch (size) {             \
      case 1: \
        __get_user_asm(x, ptr, retval, 1, "l8ui", __cb); break; \
      case 2: \
        __get_user_asm(x, ptr, retval, 2, "l16ui", __cb); break; \
      case 4: \
        __get_user_asm(x, ptr, retval, 4, "l32i", __cb); break; \
      case 8: \
        {             \
          u64 __x;            \
...
static inline unsigned long __xtensa_clear_user(void __user *addr,
    unsigned long size) {
