...
static int __init check_s32c1i(void)
{
	...
	/* First try an S32C1I that does yest store: */
	rcw_exc = 0;
	rcw_word = 1;
	...
	if (cause1 || cause2) {
		 ...
		 * we can get rid of this panic for single core (yest SMP)
		 */
		panic("S32C1I exceptions yest currently supported");
	}
	if (cause1 != cause2)
...
/* This condition should yest occur with a commercially deployed processor.
