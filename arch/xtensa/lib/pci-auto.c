...
static void __init pciauto_setup_bars(struct pci_dev *dev, int bar_limit) {
  int bar_size;
  int bar, bar_nr;
  int *upper_limit;
  int found_mem64 = 0;
...
static void __init pciauto_setup_irq(struct pci_controller *pci_ctrl,
    struct pci_dev *dev, int devfn) {
  u8 pin;
  int irq = 0;
...
static void __init pciauto_prescan_setup_bridge(struct pci_dev *dev,
    int current_bus,
...
static void __init pciauto_postscan_setup_bridge(struct pci_dev *dev,
    int current_bus, int sub_bus,
