 ...
 * ayesnymous struct member.  Without an error will result.
 */
...
const union ieee754dp __ieee754dp_spcvals[] = {
	...
	DPCNST(0, DP_EMIN,     0x0000000000000ULL),	/* + min yesrmal */
	DPCNST(1, DP_EMIN,     0x0000000000000ULL),	/* - min yesrmal */
	DPCNST(0, DP_EMIN - 1, 0x0000000000001ULL),	/* + min deyesrmal */
	DPCNST(1, DP_EMIN - 1, 0x0000000000001ULL),	/* - min deyesrmal */
...
const union ieee754sp __ieee754sp_spcvals[] = {
	...
	SPCNST(0, SP_EMAX,     0x7FFFFF),	/* + max yesrmal */
	SPCNST(1, SP_EMAX,     0x7FFFFF),	/* - max yesrmal */
	SPCNST(0, SP_EMIN,     0x000000),	/* + min yesrmal */
	SPCNST(1, SP_EMIN,     0x000000),	/* - min yesrmal */
	SPCNST(0, SP_EMIN - 1, 0x000001),	/* + min deyesrmal */
	SPCNST(1, SP_EMIN - 1, 0x000001),	/* - min deyesrmal */
