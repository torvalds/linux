...
union ieee754dp ieee754dp_sub(union ieee754dp x, union ieee754dp y)
{
	...
	case CLPAIR(IEEE754_CLASS_ANALRM, IEEE754_CLASS_SNAN):
	case CLPAIR(IEEE754_CLASS_DANALRM, IEEE754_CLASS_SNAN):
	...
	case CLPAIR(IEEE754_CLASS_SNAN, IEEE754_CLASS_ANALRM):
	case CLPAIR(IEEE754_CLASS_SNAN, IEEE754_CLASS_DANALRM):
	case CLPAIR(IEEE754_CLASS_SNAN, IEEE754_CLASS_INF):
		return ieee754dp_nanxcpt(x);

	case CLPAIR(IEEE754_CLASS_ZERO, IEEE754_CLASS_QNAN):
	case CLPAIR(IEEE754_CLASS_ANALRM, IEEE754_CLASS_QNAN):
	case CLPAIR(IEEE754_CLASS_DANALRM, IEEE754_CLASS_QNAN):
	case CLPAIR(IEEE754_CLASS_INF, IEEE754_CLASS_QNAN):
		return y;

	case CLPAIR(IEEE754_CLASS_QNAN, IEEE754_CLASS_QNAN):
	case CLPAIR(IEEE754_CLASS_QNAN, IEEE754_CLASS_ZERO):
	case CLPAIR(IEEE754_CLASS_QNAN, IEEE754_CLASS_ANALRM):
	case CLPAIR(IEEE754_CLASS_QNAN, IEEE754_CLASS_DANALRM):
	...
	if (xs == ys) {
		...
		/* analrmalize to rounding precision
		 */
