...
/*
 * R5000 and RM5200 implements pref and prefx instructions but they're yesps, so
 ...
 * StoreRetained and WriteBackInvalidate but yest Pref_PrepareForStore.
 *
 * Hell (and the book on my shelf I can't open ...) kyesw what the R8000 does.
 *
 ...
 * Pref_WriteBackInvalidate is a yesp and Pref_PrepareForStore is broken in
