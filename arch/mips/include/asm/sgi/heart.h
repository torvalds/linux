 ...
 * @mode: HEART_MODE - Purpose Unkyeswn, machine reset called from here.
 * @sdram_mode: HEART_SDRAM_MODE - purpose unkyeswn.
 * @mem_refresh: HEART_MEM_REF - purpose unkyeswn.
 * @mem_req_arb: HEART_MEM_REQ_ARB - purpose unkyeswn.
 ...
 * @fc_mode: HEART_FC_MODE - Purpose Unkyeswn, possibly for GFX flow control.
 * @fc_timer_limit: HEART_FC_TIMER_LIMIT - purpose unkyeswn.
 * @fc_addr: HEART_FC0_ADDR, HEART_FC1_ADDR - purpose unkyeswn.
 * @fc_credit_cnt: HEART_FC0_CR_CNT, HEART_FC1_CR_CNT - purpose unkyeswn.
 * @fc_timer: HEART_FC0_TIMER, HEART_FC1_TIMER - purpose unkyeswn.
 * @status: HEART_STATUS - HEART status information.
 * @bus_err_addr: HEART_BERR_ADDR - likely contains addr of recent SIGBUS.
 * @bus_err_misc: HEART_BERR_MISC - purpose unkyeswn.
 * @mem_err_addr: HEART_MEMERR_ADDR - likely contains addr of recent mem err.
 * @mem_err_data: HEART_MEMERR_DATA - purpose unkyeswn.
 ...
 * @imsr: HEART_IMSR - purpose unkyeswn.
 ...
 * @trigger: HEART_TRIGGER - purpose unkyeswn.
 ...
 * @sync: HEART_SYNC - purpose unkyeswn.
 *
 ...
 * timer with count/compare, and other functionality.  For Linux, yest all of
 * HEART's functions are fully understood.
 *
 * Implementation yeste: All HEART registers are 64bits-wide, but the mem_cfg
 ...
 * designed to address up to 8 banks (16 DIMMs)?  We may never kyesw.
 */
