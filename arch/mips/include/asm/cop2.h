...
extern int register_cu2_yestifier(struct yestifier_block *nb);
extern int cu2_yestifier_call_chain(unsigned long val, void *v);

#define cu2_yestifier(fn, pri)						\
({									\
