...
#define __get_dbe(x, ptr, size)           \
  ({                  \
    ...
    switch (size) {             \
      case 1: \
        __get_dbe_asm("lb"); break;       \
      case 2: \
        __get_dbe_asm("lh"); break;       \
      case 4: \
        __get_dbe_asm("lw"); break;       \
      case 8:  \
        __get_dbe_asm("ld"); break;        \
      default: \
        __get_dbe_unknown(); break;        \
    }               \
...
#define __put_dbe(x, ptr, size)           \
  ({                  \
    ...
    switch (size) {             \
      case 1: \
        __put_dbe_asm("sb"); break;       \
      case 2: \
        __put_dbe_asm("sh"); break;       \
      case 4: \
        __put_dbe_asm("sw"); break;       \
      case 8: \
        __put_dbe_asm("sd"); break;       \
      default: \
        __put_dbe_unknown(); break;        \
    }               \
    __pu_err;             \
  })
