 ...
 * by sending a DBE error like accessing possibly yesn-existent memory or
 * devices.
 */
...
({									\
	...
	default: __get_dbe_unkyeswn(); break;				\
	}								\
...
extern void __get_dbe_unkyeswn(void);
...
({									\
	...
	default: __put_dbe_unkyeswn(); break;				\
	}								\
	__pu_err;							\
})
...
extern void __put_dbe_unkyeswn(void);
