...
#define cpu_guest_has_rw_llb  (cpu_has_mips_r6 \
  || (cpu_data[0].guest.options & MIPS_CPU_RW_LLB))
#endif
...
#define cpu_guest_has_dyn_contextconfig (cpu_data[0].guest.options_dyn \
  & MIPS_CPU_CTXTC)
#endif
