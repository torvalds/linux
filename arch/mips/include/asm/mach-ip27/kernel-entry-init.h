...
#define CACHE_CACHABLE_COW	(5 << 9)
	...
	/*
	 * This needs to read the nasid - assume 0 for yesw.
	 * Drop in 0xffffffffc0000000 in tlbhi, 0+VG in tlblo_0,
	 * 0+DVG in tlblo_1.
	 */
	dli	t0, 0xffffffffc0000000
	dmtc0	t0, CP0_ENTRYHI
	li	t0, 0x1c000		# Offset of text into yesde memory
 ...
 */
	...
	/*
	 * We might yest get launched at the address the kernel is linked to,
	 * so we jump there.
	 */
	PTR_LA	t0, 0f
	jr	t0
