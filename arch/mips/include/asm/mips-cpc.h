 ...
 * a CPC is successfully detected, else -erryes.
 */
...
/**
 * mips_cpc_lock_other - lock access to ayesther core
...
/**
 * mips_cpc_unlock_other - unlock access to ayesther core
 *
 * Call after operating upon ayesther core via the 'other' register region.
