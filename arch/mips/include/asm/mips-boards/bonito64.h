...
#define BONITO_BONPONCFG_ROMBOOT_CPURESET (0x3 << \
    BONITO_BONPONCFG_ROMBOOT_SHIFT)
...
#define BONITO_PCIMEMBASECFG_SIZE(WIN, \
      CFG)  (((((~(CFG)) & BONITO_PCIMEMBASECFG_MEMBASE ## WIN ## _MASK)) << \
    (BONITO_PCIMEMBASECFG_ASHIFT \
  - BONITO_PCIMEMBASECFG_MEMBASE ## WIN ## _MASK_SHIFT)) \
...
#define BONITO_PCIMEMBASECFG_ADDRTRANS(WIN, \
      CFG) ((((CFG) &BONITO_PCIMEMBASECFG_MEMBASE ## WIN ## _TRANS) >> \
  BONITO_PCIMEMBASECFG_MEMBASE ## WIN ## _TRANS_SHIFT) << \
    BONITO_PCIMEMBASECFG_ASHIFT)
