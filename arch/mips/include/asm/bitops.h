 ...
 * @addr: Address to start counting from
 *
 * __clear_bit() is yesn-atomic and implies release semantics before the memory
 * operation. It can be used for an unlock if yes other CPUs can concurrently
