...
#define pte_pfn(x)    (((unsigned long) ((x).pte_high >> \
  PFN_PTE_SHIFT)) | (unsigned long) ((x).pte_low << _PAGE_PRESENT_SHIFT))
...
#define pfn_pte(pfn, prot)  __pte(((unsigned long long) (pfn) << PFN_PTE_SHIFT) | pgprot_val( \
    prot))
#define pfn_pmd(pfn, prot)  __pmd(((unsigned long long) (pfn) << PFN_PTE_SHIFT) | pgprot_val( \
    prot))
...
#define __swp_entry(type, \
      offset) ((swp_entry_t) { (((type) & 0x1f) << 10) | ((offset) << 15) })
...
#define __swp_entry(type, \
      offset) ((swp_entry_t)  { (((type) & 0x1f) << 4) | ((offset) << 9) })
...
#define __swp_entry(type, \
      offset) ((swp_entry_t)  { (((type) & 0x1f) << 2) | ((offset) << 7) })
#define __pte_to_swp_entry(pte)   ((swp_entry_t) { (pte).pte_high })
#define __swp_entry_to_pte(x)   ((pte_t) { 0, (x).val })
...
#define __swp_entry(type, \
      offset) ((swp_entry_t)  { ((type) << 8) | ((offset) << 13) })
#define __pte_to_swp_entry(pte)   ((swp_entry_t) { pte_val(pte) })
#define __swp_entry_to_pte(x)   ((pte_t) { (x).val })
