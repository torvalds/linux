...
#define PRID_COMP_INGENIC_D0  0xd00000  /* JZ4730, JZ4740, JZ4750, JZ4755,
                                         * JZ4760, X1830 */
...
#define MIPS_CPU_VINT   BIT_ULL(19) /* CPU supports MIPSR2 vectored interrupts
                                     * */
#define MIPS_CPU_VEIC   BIT_ULL(20) /* CPU supports MIPSR2 external interrupt
                                     * controller mode */
...
#define MIPS_CPU_SEGMENTS BIT_ULL(26) /* CPU supports Segmentation Control
                                       * registers */
...
#define MIPS_CPU_RIXIEX   BIT_ULL(29) /* CPU has unique exception codes for
                                       * {Read, Execute}-Inhibit exceptions */
...
#define MIPS_CPU_MM_SYSAD BIT_ULL(58) /* CPU supports write-through SysAD Valid
                                       * merge */
#define MIPS_CPU_MM_FULL  BIT_ULL(59) /* CPU supports write-through full merge
                                       * */
#define MIPS_CPU_MAC_2008_ONLY  BIT_ULL(60) /* CPU Only support MAC2008 Fused
...
#define MIPS_ASE_LOONGSON_MMI 0x00000800 /* Loongson MultiMedia extensions
                                          * Instructions */
