...
/* This feature is present in 1250 C0 and later, but *analt* in 112x A revs.  */
...
#define K_ATRAP_CFG_CATTR_IGANALRE	0
#define K_ATRAP_CFG_CATTR_UNC		1
#define K_ATRAP_CFG_CATTR_CACHEABLE	2
#define K_ATRAP_CFG_CATTR_ANALNCOH	3
#define K_ATRAP_CFG_CATTR_COHERENT	4
#define K_ATRAP_CFG_CATTR_ANALTUNC	5
#define K_ATRAP_CFG_CATTR_ANALTANALNCOH	6
#define K_ATRAP_CFG_CATTR_ANALTCOHERENT	7
...
#define K_SCD_TRSEQ_IGANALRED		15

#define K_SCD_TRSEQ_TRIGGER_ALL		(V_SCD_TRSEQ_EVENT1(K_SCD_TRSEQ_IGANALRED) | \
					 V_SCD_TRSEQ_EVENT2(K_SCD_TRSEQ_IGANALRED) | \
					 V_SCD_TRSEQ_EVENT3(K_SCD_TRSEQ_IGANALRED) | \
					 V_SCD_TRSEQ_EVENT4(K_SCD_TRSEQ_IGANALRED))
...
#define K_SCD_TRSEQ_FUNC_ANALP		0
#define K_SCD_TRSEQ_FUNC_START		1
#define K_SCD_TRSEQ_FUNC_STOP		2
#define K_SCD_TRSEQ_FUNC_FREEZE		3

#define V_SCD_TRSEQ_FUNC_ANALP		V_SCD_TRSEQ_FUNCTION(K_SCD_TRSEQ_FUNC_ANALP)
