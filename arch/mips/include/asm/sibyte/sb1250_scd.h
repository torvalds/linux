...
#define G_SYS_WAFERID1_200(x)   _SB_GETVALUE(x, S_SYS_WAFERID1_200, \
    M_SYS_WAFERID1_200)
...
#define G_SYS_WAFERID_300(x)    _SB_GETVALUE(x, S_SYS_WAFERID_300, \
    M_SYS_WAFERID_300)
...
#define G_SYS_BOOT_MODE(x)      _SB_GETVALUE(x, S_SYS_BOOT_MODE, \
    M_SYS_BOOT_MODE)
...
#define G_SCD_WDOG_RESET_TYPE(x)    _SB_GETVALUE(x, S_SCD_WDOG_RESET_TYPE, \
...
#define G_SCD_TIMER_INIT(x)     _SB_GETVALUE(x, S_SCD_TIMER_INIT, \
    M_SCD_TIMER_INIT)
...
#define G_SCD_BERR_DCODE(x)   _SB_GETVALUE(x, S_SCD_BERR_DCODE, \
    M_SCD_BERR_DCODE)
...
#define G_SCD_L2ECC_BAD_D(x)    _SB_GETVALUE(x, S_SCD_L2ECC_BAD_D, \
    M_SCD_L2ECC_BAD_D)
...
#define G_SCD_L2ECC_CORR_T(x)   _SB_GETVALUE(x, S_SCD_L2ECC_CORR_T, \
    M_SCD_L2ECC_CORR_T)
...
#define G_SCD_L2ECC_BAD_T(x)    _SB_GETVALUE(x, S_SCD_L2ECC_BAD_T, \
    M_SCD_L2ECC_BAD_T)
...
#define G_SCD_MEM_ECC_CORR(x)   _SB_GETVALUE(x, S_SCD_MEM_ECC_CORR, \
    M_SCD_MEM_ECC_CORR)
...
#define G_SCD_MEM_ECC_BAD(x)    _SB_GETVALUE(x, S_SCD_MEM_ECC_BAD, \
    M_SCD_MEM_ECC_BAD)
...
#define G_SCD_MEM_BUSERR(x)   _SB_GETVALUE(x, S_SCD_MEM_BUSERR, \
    M_SCD_MEM_BUSERR)
...
#define G_ATRAP_CFG_AGENTID(x)  _SB_GETVALUE(x, S_ATRAP_CFG_AGENTID, \
    M_ATRAP_CFG_AGENTID)
...
#define G_ATRAP_CFG_CATTR(x)  _SB_GETVALUE(x, S_ATRAP_CFG_CATTR, \
    M_ATRAP_CFG_CATTR)
...
#define G_SCD_TRACE_CFG_CUR_ADDR(x) _SB_GETVALUE(x, S_SCD_TRACE_CFG_CUR_ADDR, \
...
#define G_SCD_TREVT_ADDR_MATCH(x) _SB_GETVALUE(x, S_SCD_TREVT_ADDR_MATCH, \
...
#define G_SCD_TREVT_REQID(x)    _SB_GETVALUE(x, S_SCD_TREVT_REQID, \
    M_SCD_TREVT_REQID)
...
#define G_SCD_TREVT_RESPID(x)   _SB_GETVALUE(x, S_SCD_TREVT_RESPID, \
    M_SCD_TREVT_RESPID)
...
#define G_SCD_TREVT_DATAID(x)   _SB_GETVALUE(x, S_SCD_TREVT_DATAID, \
    M_SCD_TREVT_DATID)
...
#define G_SCD_TREVT_COUNT(x)    _SB_GETVALUE(x, S_SCD_TREVT_COUNT, \
    M_SCD_TREVT_COUNT)
...
#define G_SCD_TRSEQ_EVENT4(x)   _SB_GETVALUE(x, S_SCD_TRSEQ_EVENT4, \
    M_SCD_TRSEQ_EVENT4)
...
#define G_SCD_TRSEQ_EVENT3(x)   _SB_GETVALUE(x, S_SCD_TRSEQ_EVENT3, \
    M_SCD_TRSEQ_EVENT3)
...
#define G_SCD_TRSEQ_EVENT1(x)   _SB_GETVALUE(x, S_SCD_TRSEQ_EVENT1, \
    M_SCD_TRSEQ_EVENT1)
...
#define G_SCD_TRSEQ_FUNCTION(x)   _SB_GETVALUE(x, S_SCD_TRSEQ_FUNCTION, \
