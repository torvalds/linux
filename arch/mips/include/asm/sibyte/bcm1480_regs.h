...
#define A_BCM1480_MC_BASE(ctlid)      (A_BCM1480_MC_BASE_0 + (ctlid) \
  * BCM1480_MC_REGISTER_SPACING)
...
#define A_BCM1480_L2_MAKECACHEDISABLE(x)    (A_BCM1480_L2_CACHE_DISABLE \
  | (((x) & 0xF) << 12))
#define A_BCM1480_L2_WAY_ENABLE_3_0     0x0010040080  /* x080 */
#define A_BCM1480_L2_WAY_ENABLE_7_4     0x00100400A0  /* x0A0 */
#define A_BCM1480_L2_MAKE_WAY_ENABLE_LO(x)  (A_BCM1480_L2_WAY_ENABLE_3_0 \
  | (((x) & 0xF) << 12))
#define A_BCM1480_L2_MAKE_WAY_ENABLE_HI(x)  (A_BCM1480_L2_WAY_ENABLE_7_4 \
  | (((x) & 0xF) << 12))
#define A_BCM1480_L2_MAKE_WAY_DISABLE_LO(x)  (A_BCM1480_L2_WAY_ENABLE_3_0 \
  | (((~x) & 0xF) << 12))
#define A_BCM1480_L2_MAKE_WAY_DISABLE_HI(x)  (A_BCM1480_L2_WAY_ENABLE_7_4 \
  | (((~x) & 0xF) << 12))
...
#define A_BCM1480_L2_BANK_ADDRESS(b)      (A_BCM1480_L2_BANK_BASE \
  | (((b) & 0x7) << 17))
...
#define A_BCM1480_DUART(chan)       ((((chan) & 2) \
  == 0) ? A_BCM1480_DUART0 : A_BCM1480_DUART1)
...
#define A_BCM1480_SCD_WDOG_BASE(w)   (A_BCM1480_SCD_WDOG_0 + ((w) & 2) \
  * 0x1000 + ((w) & 1) * 0x100)
...
#define A_BCM1480_IMR_MAPPER(cpu) (A_BCM1480_IMR_CPU0_BASE + (cpu) \
  * BCM1480_IMR_REGISTER_SPACING)
...
#define A_BCM1480_SCD_PERF_CNT(n) (A_SCD_PERF_CNT_0 \
  + (n * BCM1480_SCD_PERF_CNT_SPACING))
...
#define A_BCM1480_HT_PORT_HEADER(x)    (A_BCM1480_HT_PORT0_HEADER \
  + ((x) * BCM1480_HT_PORT_SPACING))
...
#define A_BCM1480_HR_BASE(idx)        (A_BCM1480_HR_BASE_0 \
  + ((idx) * BCM1480_HR_REGISTER_SPACING))
...
#define R_BCM1480_HR_RULE_OP(idx)     (BCM1480_HR_OP_OFFSET \
  + ((idx) * BCM1480_HR_RULE_SPACING))
#define R_BCM1480_HR_RULE_TYPE(idx)     (BCM1480_HR_TYPE_OFFSET \
  + ((idx) * BCM1480_HR_RULE_SPACING))

#define BCM1480_HR_LEAF_SPACING       0x0000000010
#define BCM1480_HR_NUM_LEAVES       10
#define BCM1480_HR_LEAF_OFFSET        0x0000000300
#define R_BCM1480_HR_HA_LEAF0(idx)      (BCM1480_HR_LEAF_OFFSET \
...
#define R_BCM1480_HR_PATH(idx)        (BCM1480_HR_PATH_OFFSET \
  + ((idx) * BCM1480_HR_PATH_SPACING))
...
#define R_BCM1480_HR_RT_WORD(idx)     (BCM1480_HR_ROUTE_OFFSET \
  + ((idx) * BCM1480_HR_ROUTE_SPACING))
...
#define A_BCM1480_PMI_LCL_BASE(idx)   (A_BCM1480_PMI_LCL_0 \
  + ((idx) * BCM1480_PM_LCL_REGISTER_SPACING))
#define A_BCM1480_PMI_LCL_REGISTER(idx, \
      reg)   (A_BCM1480_PMI_LCL_BASE(idx) + (reg))
#define A_BCM1480_PMO_LCL_BASE(idx)   (A_BCM1480_PMO_LCL_0 \
  + ((idx) * BCM1480_PM_LCL_REGISTER_SPACING))
...
/*
 * DMA channel registers relative to A_BCM1480_PMI_LCL_BASE(n) and
 * A_BCM1480_PMO_LCL_BASE(n)
 */
...
/*
 * PM to TX Mapping Register relative to A_BCM1480_PMI_GLB_0 and
 * A_BCM1480_PMO_GLB_0
 */

#define R_BCM1480_PM_PMO_MAPPING      0x00000008C8   /* PMO only */

#define A_BCM1480_PM_PMO_MAPPING  (A_BCM1480_PMO_GLB_0 \
...
#define A_BCM1480_PMI_INT_OFFSET_0      (A_BCM1480_PMI_INT_0 \
  - A_BCM1480_PM_BASE)
#define A_BCM1480_PMO_INT_0       0x0010057800
#define A_BCM1480_PMO_INT(q)        (A_BCM1480_PMO_INT_0 + ((q >> 8) << 8))
#define A_BCM1480_PMO_INT_OFFSET_0      (A_BCM1480_PMO_INT_0 \
  - A_BCM1480_PM_BASE)
...
#define A_BCM1480_SWTRC_MATCH_CONTROL(x) (A_BCM1480_SWTRC_MATCH_CONTROL_0 \
  + ((x) * 8))
...
#define A_BCM1480_SWTRC_MATCH_DATA_VALUE(x) (A_BCM1480_SWTRC_MATCH_DATA_VALUE_0 \
  + ((x) * 16))
#define A_BCM1480_SWTRC_MATCH_DATA_MASK(x) (A_BCM1480_SWTRC_MATCH_DATA_MASK_0 \
  + ((x) * 16))
#define A_BCM1480_SWTRC_MATCH_TAG_VALUE(x) (A_BCM1480_SWTRC_MATCH_TAG_VALUE_0 \
  + ((x) * 16))
#define A_BCM1480_SWTRC_MATCH_TAG_MASK(x) (A_BCM1480_SWTRC_MATCH_TAG_MASK_0 \
  + ((x) * 16))
...
#define R_BCM1480_HSP_RX_SPI_WATERMARK(idx)   (R_BCM1480_HSP_RX_SPI_WATERMARK_0 \
  + 8 * (idx))
...
#define R_BCM1480_HSP_TX_PKT_RAMALLOC(idx)    (R_BCM1480_HSP_TX_PKT_RAMALLOC_0 \
  + 8 * (idx))
...
#define R_BCM1480_HSP_TX_PKT_RXPHITCNT(idx)   (R_BCM1480_HSP_TX_PKT_RXPHITCNT_0 \
  + 8 * (idx))
...
#define R_BCM1480_HSP_TX_PKT_TXPHITCNT(idx)   (R_BCM1480_HSP_TX_PKT_TXPHITCNT_0 \
  + 8 * (idx))
...
#define R_BCM1480_HSP_TX_NEXT_ADDR_REGISTER(x)  (R_BCM1480_HSP_TX_NEXT_ADDR_BASE \
  + 8 * (x))
