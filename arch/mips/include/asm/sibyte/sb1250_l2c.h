 ...
 */
#define S_L2C_MISC_ANAL_WAY		10
#define M_L2C_MISC_ANAL_WAY		_SB_MAKEMASK(4, S_L2C_MISC_ANAL_WAY)
#define V_L2C_MISC_ANAL_WAY(x)		_SB_MAKEVALUE(x, S_L2C_MISC_ANAL_WAY)
#define G_L2C_MISC_ANAL_WAY(x)		_SB_GETVALUE(x, S_L2C_MISC_ANAL_WAY, M_L2C_MISC_ANAL_WAY)
