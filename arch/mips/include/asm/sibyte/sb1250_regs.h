...
#define R_MAC_DE_STATUS		0x00000448
...
#define A_DUART_INPORT_CHNG_DE   0x00100603F0
#endif /* 1250 PASS2 || 112x PASS1 */
...
#define R_SER_STATUS_DE	    0x000001A8
...
#if SIBYTE_HDR_FEATURE(1250, PASS2) || SIBYTE_HDR_FEATURE(112x, PASS1) || SIBYTE_HDR_FEATURE_CHIP(1480)
#define A_ADDR_TRAP_REG_DE	    0x0010020460
#endif /* 1250 PASS2 || 112x PASS1 || 1480 */
...
#if SIBYTE_HDR_FEATURE(1250, PASS2) || SIBYTE_HDR_FEATURE(112x, PASS1)
#define A_SCD_BUS_ERR_STATUS_DE  0x00100208D0
#define A_BUS_ERR_STATUS_DE	0x00100208D0
#endif /* 1250 PASS2 || 112x PASS1 */
...
/*  *********************************************************************
    * System De Controller Registers
    ********************************************************************* */
...
#define R_DM_DSCR_BASE_DE	    0x0000000018
