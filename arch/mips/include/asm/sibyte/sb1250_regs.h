...
#if SIBYTE_HDR_FEATURE(1250, PASS3) || SIBYTE_HDR_FEATURE(112x, \
...
#define A_IO_EXT_CS_BASE(cs)      (A_IO_EXT_CFG_BASE + IO_EXT_REGISTER_SPACING \
  * (cs))
...
#define A_SCD_TIMER_BASE(w)     (A_SCD_TIMER_0 + 0x08 * ((w) & 1) + 0x100 \
  * (((w) & 2) >> 1))
...
#define A_DM_PARTIAL(idx)     (A_DM_PARTIAL_0 \
  + ((idx) * DM_PARTIAL_REGISTER_SPACING))
#endif /* 1250 PASS3 || 112x PASS1 */
