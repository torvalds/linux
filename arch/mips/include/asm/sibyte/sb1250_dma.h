...
#define G_DMA_DESC_TYPE(x)      _SB_GETVALUE(x, S_DMA_DESC_TYPE, \
    M_DMA_DESC_TYPE)
...
#define G_DMA_INT_PKTCNT(x)     _SB_GETVALUE(x, S_DMA_INT_PKTCNT, \
    M_DMA_INT_PKTCNT)
...
#define G_DMA_HIGH_WATERMARK(x)     _SB_GETVALUE(x, S_DMA_HIGH_WATERMARK, \
...
#define G_DMA_LOW_WATERMARK(x)      _SB_GETVALUE(x, S_DMA_LOW_WATERMARK, \
    M_DMA_LOW_WATERMARK)
...
#define G_DMA_INT_TIMEOUT(x)      _SB_GETVALUE(x, S_DMA_INT_TIMEOUT, \
    M_DMA_INT_TIMEOUT)
...
#define G_DMA_OODLOST_RX(x)    _SB_GETVALUE(x, S_DMA_OODLOST_RX, \
    M_DMA_OODLOST_RX)

#define S_DMA_EOP_COUNT_RX     _SB_MAKE64(16)
#define M_DMA_EOP_COUNT_RX     _SB_MAKEMASK(8, S_DMA_EOP_COUNT_RX)
#define G_DMA_EOP_COUNT_RX(x)    _SB_GETVALUE(x, S_DMA_EOP_COUNT_RX, \
    M_DMA_EOP_COUNT_RX)
#endif /* 1250 PASS3 || 112x PASS1 || 1480 */
...
#define G_DMA_DSCRA_OFFSET(x)     _SB_GETVALUE(x, S_DMA_DSCRA_OFFSET, \
    M_DMA_DSCRA_OFFSET)
...
#define G_DMA_DSCRA_A_SIZE(x)     _SB_GETVALUE(x, S_DMA_DSCRA_A_SIZE, \
    M_DMA_DSCRA_A_SIZE)
...
#define G_DMA_DSCRA_DSCR_CNT(x)     _SB_GETVALUE(x, S_DMA_DSCRA_DSCR_CNT, \
...
#define G_DMA_DSCRA_STATUS(x)     _SB_GETVALUE(x, S_DMA_DSCRA_STATUS, \
    M_DMA_DSCRA_STATUS)
...
#define G_DMA_DSCRB_A_SIZE(x)   _SB_GETVALUE(x, S_DMA_DSCRB_A_SIZE, \
    M_DMA_DSCRB_A_SIZE)
#endif /* 1250 PASS3 || 112x PASS1 || 1480 */
...
#define G_DMA_DSCRB_B_SIZE(x)     _SB_GETVALUE(x, S_DMA_DSCRB_B_SIZE, \
    M_DMA_DSCRB_B_SIZE)
...
#define G_DMA_DSCRB_PKT_SIZE(x)     _SB_GETVALUE(x, S_DMA_DSCRB_PKT_SIZE, \
...
#define G_DMA_DSCRB_STATUS(x)     _SB_GETVALUE(x, S_DMA_DSCRB_STATUS, \
    M_DMA_DSCRB_STATUS)
...
#define G_DMA_ETHRX_PKTTYPE(x)      _SB_GETVALUE(x, S_DMA_ETHRX_PKTTYPE, \
    M_DMA_ETHRX_PKTTYPE)
...
#define G_DM_DSCR_BASE_RINGSZ(x)    _SB_GETVALUE(x, S_DM_DSCR_BASE_RINGSZ, \
...
#define G_DM_DSCRA_DIR_DEST(x)      _SB_GETVALUE(x, S_DM_DSCRA_DIR_DEST, \
    M_DM_DSCRA_DIR_DEST)
...
#define G_DM_DSCRA_DIR_SRC(x)     _SB_GETVALUE(x, S_DM_DSCRA_DIR_SRC, \
    M_DM_DSCRA_DIR_SRC)
...
#define G_DM_DSCRB_SRC_LENGTH(x)    _SB_GETVALUE(x, S_DM_DSCRB_SRC_LENGTH, \
