...
#define G_MAC_SPEED_SEL(x)      _SB_GETVALUE(x, S_MAC_SPEED_SEL, \
    M_MAC_SPEED_SEL)
...
#define G_MAC_BYPASS_CFG(x)     _SB_GETVALUE(x, S_MAC_BYPASS_CFG, \
    M_MAC_BYPASS_CFG)
...
#define G_MAC_BYPASS_IFG(x)     _SB_GETVALUE(x, S_MAC_BYPASS_IFG, \
    M_MAC_BYPASS_IFG)
...
#define G_MAC_TXD_WEIGHT0(x)      _SB_GETVALUE(x, S_MAC_TXD_WEIGHT0, \
    M_MAC_TXD_WEIGHT0)
...
#define G_MAC_TX_WR_THRSH(x)      _SB_GETVALUE(x, S_MAC_TX_WR_THRSH, \
    M_MAC_TX_WR_THRSH)
...
#define G_MAC_TX_RD_THRSH(x)      _SB_GETVALUE(x, S_MAC_TX_RD_THRSH, \
    M_MAC_TX_RD_THRSH)
...
#define G_MAC_TX_RL_THRSH(x)      _SB_GETVALUE(x, S_MAC_TX_RL_THRSH, \
    M_MAC_TX_RL_THRSH)
...
#define G_MAC_RX_PL_THRSH(x)      _SB_GETVALUE(x, S_MAC_RX_PL_THRSH, \
    M_MAC_RX_PL_THRSH)
...
#define G_MAC_RX_RD_THRSH(x)      _SB_GETVALUE(x, S_MAC_RX_RD_THRSH, \
    M_MAC_RX_RD_THRSH)
...
#define G_MAC_RX_RL_THRSH(x)      _SB_GETVALUE(x, S_MAC_RX_RL_THRSH, \
    M_MAC_RX_RL_THRSH)
...
#define G_MAC_ENC_FC_THRSH(x)      _SB_GETVALUE(x, S_MAC_ENC_FC_THRSH, \
    M_MAC_ENC_FC_THRSH)
#endif /* 1250 PASS2 || 112x PASS1 || 1480 */
...
#define G_MAC_IFG_THRSH(x)      _SB_GETVALUE(x, S_MAC_IFG_THRSH, \
    M_MAC_IFG_THRSH)
...
#define G_MAC_BACKOFF_SEL(x)      _SB_GETVALUE(x, S_MAC_BACKOFF_SEL, \
    M_MAC_BACKOFF_SEL)
...
#define G_MAC_LFSR_SEED(x)      _SB_GETVALUE(x, S_MAC_LFSR_SEED, \
    M_MAC_LFSR_SEED)
...
#define G_MAC_SLOT_SIZE(x)      _SB_GETVALUE(x, S_MAC_SLOT_SIZE, \
    M_MAC_SLOT_SIZE)
...
#define G_MAC_MIN_FRAMESZ(x)      _SB_GETVALUE(x, S_MAC_MIN_FRAMESZ, \
    M_MAC_MIN_FRAMESZ)
...
#define G_MAC_MAX_FRAMESZ(x)      _SB_GETVALUE(x, S_MAC_MAX_FRAMESZ, \
    M_MAC_MAX_FRAMESZ)
...
#define G_MAC_TX_PKT_OFFSET(x)   _SB_GETVALUE(x, S_MAC_TX_PKT_OFFSET, \
    M_MAC_TX_PKT_OFFSET)
...
#define G_MAC_TX_CRC_OFFSET(x)   _SB_GETVALUE(x, S_MAC_TX_CRC_OFFSET, \
    M_MAC_TX_CRC_OFFSET)
 ...
 */
#define S_MAC_STATUS_CH_OFFSET(ch, txrx) _SB_MAKE64( \
    ((ch) + 2 * (txrx)) * S_MAC_CHANWIDTH)

#define M_MAC_STATUS_CHANNEL(ch, txrx)   _SB_MAKEVALUE(_SB_MAKEMASK(8, \
    0), S_MAC_STATUS_CH_OFFSET( \
    ch, txrx))
#define M_MAC_STATUS_EOP_COUNT(ch, txrx) _SB_MAKEVALUE(M_MAC_INT_EOP_COUNT, S_MAC_STATUS_CH_OFFSET( \
    ch, \
    txrx))
#define M_MAC_STATUS_EOP_TIMER(ch, txrx) _SB_MAKEVALUE(M_MAC_INT_EOP_TIMER, S_MAC_STATUS_CH_OFFSET( \
    ch, \
    txrx))
#define M_MAC_STATUS_EOP_SEEN(ch, txrx)  _SB_MAKEVALUE(M_MAC_INT_EOP_SEEN, S_MAC_STATUS_CH_OFFSET( \
    ch, \
    txrx))
#define M_MAC_STATUS_HWM(ch, txrx)   _SB_MAKEVALUE(M_MAC_INT_HWM, S_MAC_STATUS_CH_OFFSET( \
    ch, \
    txrx))
#define M_MAC_STATUS_LWM(ch, txrx)   _SB_MAKEVALUE(M_MAC_INT_LWM, S_MAC_STATUS_CH_OFFSET( \
    ch, \
    txrx))
#define M_MAC_STATUS_DSCR(ch, txrx)  _SB_MAKEVALUE(M_MAC_INT_DSCR, S_MAC_STATUS_CH_OFFSET( \
    ch, \
    txrx))
#define M_MAC_STATUS_ERR(ch, txrx)   _SB_MAKEVALUE(M_MAC_INT_ERR, S_MAC_STATUS_CH_OFFSET( \
    ch, \
    txrx))
#define M_MAC_STATUS_DZERO(ch, txrx)   _SB_MAKEVALUE(M_MAC_INT_DZERO, S_MAC_STATUS_CH_OFFSET( \
    ch, \
    txrx))
#define M_MAC_STATUS_DROP(ch, txrx)  _SB_MAKEVALUE(M_MAC_INT_DROP, S_MAC_STATUS_CH_OFFSET( \
    ch, \
    txrx))
...
#define G_MAC_COUNTER_ADDR(x)     _SB_GETVALUE(x, S_MAC_COUNTER_ADDR, \
    M_MAC_COUNTER_ADDR)
...
#define G_MAC_TX_EOP_COUNTER(x)     _SB_GETVALUE(x, S_MAC_TX_EOP_COUNTER, \
...
#define G_MAC_IPHDR_OFFSET(x) _SB_GETVALUE(x, S_MAC_IPHDR_OFFSET, \
    M_MAC_IPHDR_OFFSET)
...
#define G_MAC_RX_CRC_OFFSET(x)  _SB_GETVALUE(x, S_MAC_RX_CRC_OFFSET, \
    M_MAC_RX_CRC_OFFSET)
...
#define G_MAC_RX_PKT_OFFSET(x)  _SB_GETVALUE(x, S_MAC_RX_PKT_OFFSET, \
    M_MAC_RX_PKT_OFFSET)
...
#define G_MAC_RX_CH_MSN_SEL(x)  _SB_GETVALUE(x, S_MAC_RX_CH_MSN_SEL, \
    M_MAC_RX_CH_MSN_SEL)
#endif /* 1250 PASS3 || 112x PASS1 || 1480 */
