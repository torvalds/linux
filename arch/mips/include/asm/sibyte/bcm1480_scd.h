...
#define G_BCM1480_SYS_PLL_DIV(x)      _SB_GETVALUE(x, S_BCM1480_SYS_PLL_DIV, \
...
#define G_BCM1480_SYS_BOOT_MODE(x)      _SB_GETVALUE(x, S_BCM1480_SYS_BOOT_MODE, \
...
#define G_BCM1480_SYS_NODEID(x)       _SB_GETVALUE(x, S_BCM1480_SYS_NODEID, \
...
#define G_BCM1480_SPC_CNT_COUNT(x)      _SB_GETVALUE(x, S_BCM1480_SPC_CNT_COUNT, \
...
#define G_BCM1480_ATRAP_CFG_CNT(x)     _SB_GETVALUE(x, S_BCM1480_ATRAP_CFG_CNT, \
