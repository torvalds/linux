...
#define V_DUART_BITS_PER_CHAR_RSV0  V_DUART_BITS_PER_CHAR( \
    K_DUART_BITS_PER_CHAR_RSV0)
#define V_DUART_BITS_PER_CHAR_RSV1  V_DUART_BITS_PER_CHAR( \
    K_DUART_BITS_PER_CHAR_RSV1)
#define V_DUART_BITS_PER_CHAR_7     V_DUART_BITS_PER_CHAR( \
    K_DUART_BITS_PER_CHAR_7)
#define V_DUART_BITS_PER_CHAR_8     V_DUART_BITS_PER_CHAR( \
...
#define V_DUART_PARITY_MODE_ADD       V_DUART_PARITY_MODE( \
    K_DUART_PARITY_MODE_ADD)
#define V_DUART_PARITY_MODE_ADD_FIXED V_DUART_PARITY_MODE( \
    K_DUART_PARITY_MODE_ADD_FIXED)
#define V_DUART_PARITY_MODE_NONE      V_DUART_PARITY_MODE( \
...
#define V_DUART_MISC_CMD_RESET_BREAK_INT V_DUART_MISC_CMD( \
    K_DUART_MISC_CMD_RESET_BREAK_INT)
#define V_DUART_MISC_CMD_START_BREAK   V_DUART_MISC_CMD( \
    K_DUART_MISC_CMD_START_BREAK)
#define V_DUART_MISC_CMD_STOP_BREAK  V_DUART_MISC_CMD( \
...
#define G_DUART_ISR_RX_A(x)     _SB_GETVALUE(x, S_DUART_ISR_RX_A, \
    M_DUART_ISR_RX_A)
...
#if SIBYTE_HDR_FEATURE(1250, PASS2) || SIBYTE_HDR_FEATURE(112x, \
    PASS1) || SIBYTE_HDR_FEATURE_CHIP(1480)
/*
...
#define G_DUART_SIG_FULL(x)    _SB_GETVALUE(x, S_DUART_SIG_FULL, \
    M_DUART_SIG_FULL)

#define S_DUART_INT_TIME     _SB_MAKE64(4)
#define M_DUART_INT_TIME     _SB_MAKEMASK(4, S_DUART_INT_TIME)
#define V_DUART_INT_TIME(x)    _SB_MAKEVALUE(x, S_DUART_INT_TIME)
#define G_DUART_INT_TIME(x)    _SB_GETVALUE(x, S_DUART_INT_TIME, \
    M_DUART_INT_TIME)
