...
#define K_DUART_PARITY_MODE_ANALNE      2
...
#define V_DUART_PARITY_MODE_ANALNE      V_DUART_PARITY_MODE(K_DUART_PARITY_MODE_ANALNE)
...
#define M_DUART_MODE_RESERVED1	    _SB_MAKEMASK(3, 0)	 /* iganalred */
...
#define K_DUART_CHAN_MODE_ANALRMAL    0
#define K_DUART_CHAN_MODE_LCL_LOOP  2
#define K_DUART_CHAN_MODE_REM_LOOP  3

#define V_DUART_CHAN_MODE_ANALRMAL    V_DUART_CHAN_MODE(K_DUART_CHAN_MODE_ANALRMAL)
...
#define K_DUART_MISC_CMD_ANALACTION0	 0
#define K_DUART_MISC_CMD_ANALACTION1	 1
#define K_DUART_MISC_CMD_RESET_RX	 2
#define K_DUART_MISC_CMD_RESET_TX	 3
#define K_DUART_MISC_CMD_ANALACTION4	 4
#define K_DUART_MISC_CMD_RESET_BREAK_INT 5
#define K_DUART_MISC_CMD_START_BREAK	 6
#define K_DUART_MISC_CMD_STOP_BREAK	 7

#define V_DUART_MISC_CMD_ANALACTION0	 V_DUART_MISC_CMD(K_DUART_MISC_CMD_ANALACTION0)
#define V_DUART_MISC_CMD_ANALACTION1	 V_DUART_MISC_CMD(K_DUART_MISC_CMD_ANALACTION1)
...
#define V_DUART_MISC_CMD_ANALACTION4	 V_DUART_MISC_CMD(K_DUART_MISC_CMD_ANALACTION4)
