...
#define G_IO_BURST_WIDTH(x)    _SB_GETVALUE(x, S_IO_BURST_WIDTH, \
    M_IO_BURST_WIDTH)
#endif /* 1250 PASS2 || 112x PASS1 || 1480 */
...
#define G_IO_ALE_TO_WRITE(x)  _SB_GETVALUE(x, S_IO_ALE_TO_WRITE, \
    M_IO_ALE_TO_WRITE)
...
#define G_GPIO_INTR_TYPEX(n, x) _SB_GETVALUE(x, S_GPIO_INTR_TYPEX( \
    n), M_GPIO_INTR_TYPEX(n))
...
#define G_GPIO_INTR_TYPE0(x)  _SB_GETVALUE(x, S_GPIO_INTR_TYPE0, \
    M_GPIO_INTR_TYPE0)
...
#define G_GPIO_INTR_TYPE2(x)  _SB_GETVALUE(x, S_GPIO_INTR_TYPE2, \
    M_GPIO_INTR_TYPE2)
...
#define G_GPIO_INTR_TYPE4(x)  _SB_GETVALUE(x, S_GPIO_INTR_TYPE4, \
    M_GPIO_INTR_TYPE4)
...
#define G_GPIO_INTR_TYPE6(x)  _SB_GETVALUE(x, S_GPIO_INTR_TYPE6, \
    M_GPIO_INTR_TYPE6)
...
#define G_GPIO_INTR_TYPE8(x)  _SB_GETVALUE(x, S_GPIO_INTR_TYPE8, \
    M_GPIO_INTR_TYPE8)
...
#define G_GPIO_INTR_TYPE10(x) _SB_GETVALUE(x, S_GPIO_INTR_TYPE10, \
    M_GPIO_INTR_TYPE10)
...
#define G_GPIO_INTR_TYPE14(x) _SB_GETVALUE(x, S_GPIO_INTR_TYPE14, \
    M_GPIO_INTR_TYPE14)
...
#define G_GPIO_INTR_ATYPEX(n, x)  _SB_GETVALUE(x, S_GPIO_INTR_ATYPEX( \
    n), M_GPIO_INTR_ATYPEX(n))
...
#define G_GPIO_INTR_ATYPE0(x) _SB_GETVALUE(x, S_GPIO_INTR_ATYPE0, \
    M_GPIO_INTR_ATYPE0)
...
#define G_GPIO_INTR_ATYPE2(x) _SB_GETVALUE(x, S_GPIO_INTR_ATYPE2, \
    M_GPIO_INTR_ATYPE2)
...
#define G_GPIO_INTR_ATYPE4(x) _SB_GETVALUE(x, S_GPIO_INTR_ATYPE4, \
    M_GPIO_INTR_ATYPE4)
...
#define G_GPIO_INTR_ATYPE6(x) _SB_GETVALUE(x, S_GPIO_INTR_ATYPE6, \
    M_GPIO_INTR_ATYPE6)
...
#define G_GPIO_INTR_ATYPE8(x) _SB_GETVALUE(x, S_GPIO_INTR_ATYPE8, \
    M_GPIO_INTR_ATYPE8)
...
#define G_GPIO_INTR_ATYPE10(x)  _SB_GETVALUE(x, S_GPIO_INTR_ATYPE10, \
    M_GPIO_INTR_ATYPE10)
...
#define G_GPIO_INTR_ATYPE12(x)  _SB_GETVALUE(x, S_GPIO_INTR_ATYPE12, \
    M_GPIO_INTR_ATYPE12)
...
#define G_GPIO_INTR_ATYPE14(x)  _SB_GETVALUE(x, S_GPIO_INTR_ATYPE14, \
    M_GPIO_INTR_ATYPE14)
#endif
