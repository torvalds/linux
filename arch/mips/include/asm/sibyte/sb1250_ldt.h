...
#define G_LDT_DEVICEID_VENDOR(x)  _SB_GETVALUE_32(x, S_LDT_DEVICEID_VENDOR, \
...
#define G_LDT_DEVICEID_DEVICEID(x)  _SB_GETVALUE_32(x, S_LDT_DEVICEID_DEVICEID, \
...
#define G_LDT_CLASSREV_REV(x)   _SB_GETVALUE_32(x, S_LDT_CLASSREV_REV, \
    M_LDT_CLASSREV_REV)
...
#define G_LDT_CLASSREV_CLASS(x)   _SB_GETVALUE_32(x, S_LDT_CLASSREV_CLASS, \
...
#define G_LDT_DEVHDR_CLINESZ(x)   _SB_GETVALUE_32(x, S_LDT_DEVHDR_CLINESZ, \
...
#define G_LDT_DEVHDR_LATTMR(x)    _SB_GETVALUE_32(x, S_LDT_DEVHDR_LATTMR, \
    M_LDT_DEVHDR_LATTMR)
...
#define G_LDT_DEVHDR_HDRTYPE(x)   _SB_GETVALUE_32(x, S_LDT_DEVHDR_HDRTYPE, \
...
#define G_LDT_DEVHDR_BIST(x)    _SB_GETVALUE_32(x, S_LDT_DEVHDR_BIST, \
    M_LDT_DEVHDR_BIST)
...
#define G_LDT_CMD_CAPTYPE(x)    _SB_GETVALUE_32(x, S_LDT_CMD_CAPTYPE, \
    M_LDT_CMD_CAPTYPE)
...
#define G_LDT_LINKCTRL_CRCERR(x)  _SB_GETVALUE_32(x, S_LDT_LINKCTRL_CRCERR, \
...
#define G_LDT_LINKCTRL_MAXIN(x)   _SB_GETVALUE_32(x, S_LDT_LINKCTRL_MAXIN, \
...
#define G_LDT_LINKCTRL_MAXOUT(x)  _SB_GETVALUE_32(x, S_LDT_LINKCTRL_MAXOUT, \
...
#define G_LDT_LINKCTRL_WIDTHIN(x) _SB_GETVALUE_32(x, S_LDT_LINKCTRL_WIDTHIN, \
...
#define G_LDT_LINKFREQ_FREQ(x)    _SB_GETVALUE_32(x, S_LDT_LINKFREQ_FREQ, \
    M_LDT_LINKFREQ_FREQ)
...
#define G_LDT_SRICMD_RXMARGIN(x)  _SB_GETVALUE_32(x, S_LDT_SRICMD_RXMARGIN, \
...
#define G_LDT_SRICTRL_NEEDRESP(x) _SB_GETVALUE_32(x, S_LDT_SRICTRL_NEEDRESP, \
...
#define G_LDT_SRICTRL_NEEDPREQ(x) _SB_GETVALUE_32(x, S_LDT_SRICTRL_NEEDPREQ, \
...
#define G_LDT_SRICTRL_WANTRESP(x) _SB_GETVALUE_32(x, S_LDT_SRICTRL_WANTRESP, \
...
#define G_LDT_SRICTRL_WANTNPREQ(x)  _SB_GETVALUE_32(x, S_LDT_SRICTRL_WANTNPREQ, \
...
#define G_LDT_SRICTRL_WANTPREQ(x) _SB_GETVALUE_32(x, S_LDT_SRICTRL_WANTPREQ, \
...
#define G_LDT_TXBUFCNT_PCMD(x)    _SB_GETVALUE_32(x, S_LDT_TXBUFCNT_PCMD, \
    M_LDT_TXBUFCNT_PCMD)
...
#define G_LDT_TXBUFCNT_PDATA(x)   _SB_GETVALUE_32(x, S_LDT_TXBUFCNT_PDATA, \
...
#define G_LDT_TXBUFCNT_NPCMD(x)   _SB_GETVALUE_32(x, S_LDT_TXBUFCNT_NPCMD, \
...
#define G_LDT_TXBUFCNT_NPDATA(x)  _SB_GETVALUE_32(x, S_LDT_TXBUFCNT_NPDATA, \
...
#define G_LDT_TXBUFCNT_RCMD(x)    _SB_GETVALUE_32(x, S_LDT_TXBUFCNT_RCMD, \
    M_LDT_TXBUFCNT_RCMD)
...
#define G_LDT_TXBUFCNT_RDATA(x)   _SB_GETVALUE_32(x, S_LDT_TXBUFCNT_RDATA, \
