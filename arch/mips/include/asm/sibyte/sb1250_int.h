...
#define G_INT_LDT_INTMSG(x)       _SB_GETVALUE(x, S_INT_LDT_INTMSG, \
    M_INT_LDT_INTMSG)
...
#define G_INT_LDT_INTDEST(x)        _SB_GETVALUE(x, S_INT_LDT_INTDEST, \
    M_INT_LDT_INTDEST)
...
#define G_INT_LDT_VECTOR(x)       _SB_GETVALUE(x, S_INT_LDT_VECTOR, \
    M_INT_LDT_VECTOR)
