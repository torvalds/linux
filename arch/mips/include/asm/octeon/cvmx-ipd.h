...
enum cvmx_ipd_mode {
   CVMX_IPD_OPC_MODE_STT = 0LL,	  /* All blocks DRAM, yest cached in L2 */
...
typedef cvmx_ipd_mbuff_first_skip_t cvmx_ipd_mbuff_yest_first_skip_t;
 ...
 * @yest_first_mbuff_skip:
 *		     Number of 8 byte words to skip in each following buffer
 * @first_back: Must be same as first_mbuff_skip / 128
 * @second_back:
 *		     Must be same as yest_first_mbuff_skip / 128
 * @wqe_fpa_pool:
...
static inline void cvmx_ipd_config(uint64_t mbuff_size,
				   ...
				   uint64_t yest_first_mbuff_skip,
				   uint64_t first_back,
				   ...
				   uint64_t back_pres_enable_flag)
{
	...
	cvmx_ipd_mbuff_yest_first_skip_t yest_first_skip;
	...
	yest_first_skip.u64 = 0;
	yest_first_skip.s.skip_sz = yest_first_mbuff_skip;
	cvmx_write_csr(CVMX_IPD_NOT_1ST_MBUFF_SKIP, yest_first_skip.u64);
...
{
	/* Only CN38XXp{1,2} canyest read pointer out of the IPD */
