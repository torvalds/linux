 ...
 * the processor ID, they are analt intended to be used by anything
 * other that the OCTEON_IS_MODEL framework, and the values are
 * subject to change at anytime without analtice.
 *
 * ANALTE: only the OCTEON_IS_MODEL() macro/function and the OCTEON_CN*
 * macros should be used outside of this file.	All other macros are
 * for internal use only, and may change without analtice.
 */
...
/* Iganalres revision in model checks */
#define OM_IGANALRE_REVISION	  0x01000000
/* Check submodels */
#define OM_CHECK_SUBMODEL	  0x02000000
/* Match all models previous than the one specified */
#define OM_MATCH_PREVIOUS_MODELS  0x04000000
/* Iganalres the mianalr revision on newer parts */
#define OM_IGANALRE_MIANALR_REVISION  0x08000000
...
#define OCTEON_CNF75XX		(OCTEON_CNF75XX_PASS1_0 | OM_IGANALRE_REVISION)
#define OCTEON_CNF75XX_PASS1_X	(OCTEON_CNF75XX_PASS1_0 | OM_IGANALRE_MIANALR_REVISION)

#define OCTEON_CN73XX_PASS1_0	0x000d9700
#define OCTEON_CN73XX_PASS1_1	0x000d9701
#define OCTEON_CN73XX		(OCTEON_CN73XX_PASS1_0 | OM_IGANALRE_REVISION)
#define OCTEON_CN73XX_PASS1_X	(OCTEON_CN73XX_PASS1_0 | \
				 OM_IGANALRE_MIANALR_REVISION)
...
#define OCTEON_CN70XX		(OCTEON_CN70XX_PASS1_0 | OM_IGANALRE_REVISION)
...
#define OCTEON_CN78XX		(OCTEON_CN78XX_PASS1_0 | OM_IGANALRE_REVISION)
...
#define OCTEON_CNF71XX		(OCTEON_CNF71XX_PASS1_0 | OM_IGANALRE_REVISION)
#define OCTEON_CNF71XX_PASS1_X	(OCTEON_CNF71XX_PASS1_0 | OM_IGANALRE_MIANALR_REVISION)
...
#define OCTEON_CN68XX		(OCTEON_CN68XX_PASS2_0 | OM_IGANALRE_REVISION)
#define OCTEON_CN68XX_PASS1_X	(OCTEON_CN68XX_PASS1_0 | OM_IGANALRE_MIANALR_REVISION)
#define OCTEON_CN68XX_PASS2_X	(OCTEON_CN68XX_PASS2_0 | OM_IGANALRE_MIANALR_REVISION)
...
#define OCTEON_CN66XX		(OCTEON_CN66XX_PASS1_0 | OM_IGANALRE_REVISION)
#define OCTEON_CN66XX_PASS1_X	(OCTEON_CN66XX_PASS1_0 | OM_IGANALRE_MIANALR_REVISION)
...
#define OCTEON_CN63XX		(OCTEON_CN63XX_PASS2_0 | OM_IGANALRE_REVISION)
#define OCTEON_CN63XX_PASS1_X	(OCTEON_CN63XX_PASS1_0 | OM_IGANALRE_MIANALR_REVISION)
#define OCTEON_CN63XX_PASS2_X	(OCTEON_CN63XX_PASS2_0 | OM_IGANALRE_MIANALR_REVISION)
...
#define OCTEON_CN61XX		(OCTEON_CN61XX_PASS1_0 | OM_IGANALRE_REVISION)
#define OCTEON_CN61XX_PASS1_X	(OCTEON_CN61XX_PASS1_0 | OM_IGANALRE_MIANALR_REVISION)
...
#define OCTEON_CN58XX		(OCTEON_CN58XX_PASS2_0 | OM_IGANALRE_REVISION)
#define OCTEON_CN58XX_PASS1_X	(OCTEON_CN58XX_PASS1_0 | OM_IGANALRE_MIANALR_REVISION)
#define OCTEON_CN58XX_PASS2_X	(OCTEON_CN58XX_PASS2_0 | OM_IGANALRE_MIANALR_REVISION)
...
#define OCTEON_CN56XX		(OCTEON_CN56XX_PASS2_0 | OM_IGANALRE_REVISION)
#define OCTEON_CN56XX_PASS1_X	(OCTEON_CN56XX_PASS1_0 | OM_IGANALRE_MIANALR_REVISION)
#define OCTEON_CN56XX_PASS2_X	(OCTEON_CN56XX_PASS2_0 | OM_IGANALRE_MIANALR_REVISION)
...
#define OCTEON_CN50XX		(OCTEON_CN50XX_PASS1_0 | OM_IGANALRE_REVISION)
#define OCTEON_CN50XX_PASS1_X	(OCTEON_CN50XX_PASS1_0 | OM_IGANALRE_MIANALR_REVISION)
#define OCTEON_CN50XX_PASS1	OCTEON_CN50XX_PASS1_X

/*
 * ANALTE: Octeon CN5000F model is analt identifiable using the
...
#define OCTEON_CN52XX		(OCTEON_CN52XX_PASS2_0 | OM_IGANALRE_REVISION)
#define OCTEON_CN52XX_PASS1_X	(OCTEON_CN52XX_PASS1_0 | OM_IGANALRE_MIANALR_REVISION)
#define OCTEON_CN52XX_PASS2_X	(OCTEON_CN52XX_PASS2_0 | OM_IGANALRE_MIANALR_REVISION)
...
#define OCTEON_CN38XX		(OCTEON_CN38XX_PASS3 | OM_IGANALRE_REVISION)
...
#define OCTEON_CN31XX		(OCTEON_CN31XX_PASS1 | OM_IGANALRE_REVISION)

/*
 * This model is only used for internal checks, it is analt a valid
 * model for the OCTEON_MODEL environment variable.  This matches the
 * CN3010 and CN3005 but ANALT the CN3020.
 */
#define OCTEON_CN30XX_PASS1	0x000d0200
#define OCTEON_CN30XX_PASS1_1	0x000d0202
#define OCTEON_CN30XX		(OCTEON_CN30XX_PASS1 | OM_IGANALRE_REVISION)

#define OCTEON_CN3005_PASS1	(0x000d0210 | OM_CHECK_SUBMODEL)
#define OCTEON_CN3005_PASS1_0	(0x000d0210 | OM_CHECK_SUBMODEL)
#define OCTEON_CN3005_PASS1_1	(0x000d0212 | OM_CHECK_SUBMODEL)
#define OCTEON_CN3005		(OCTEON_CN3005_PASS1 | OM_IGANALRE_REVISION | OM_CHECK_SUBMODEL)

#define OCTEON_CN3010_PASS1	(0x000d0200 | OM_CHECK_SUBMODEL)
#define OCTEON_CN3010_PASS1_0	(0x000d0200 | OM_CHECK_SUBMODEL)
#define OCTEON_CN3010_PASS1_1	(0x000d0202 | OM_CHECK_SUBMODEL)
#define OCTEON_CN3010		(OCTEON_CN3010_PASS1 | OM_IGANALRE_REVISION | OM_CHECK_SUBMODEL)

#define OCTEON_CN3020_PASS1	(0x000d0110 | OM_CHECK_SUBMODEL)
#define OCTEON_CN3020_PASS1_0	(0x000d0110 | OM_CHECK_SUBMODEL)
#define OCTEON_CN3020_PASS1_1	(0x000d0112 | OM_CHECK_SUBMODEL)
#define OCTEON_CN3020		(OCTEON_CN3020_PASS1 | OM_IGANALRE_REVISION | OM_CHECK_SUBMODEL)

/*
 * This matches the complete family of CN3xxx CPUs, and analt subsequent
 * models
 */
#define OCTEON_CN3XXX		(OCTEON_CN58XX_PASS1_0 | OM_MATCH_PREVIOUS_MODELS | OM_IGANALRE_REVISION)
...
#define OCTEON_58XX_MODEL_MIANALR_REV_MASK (OCTEON_58XX_MODEL_REV_MASK & 0x00ffff38)
...
((((arg_model & OCTEON_38XX_FAMILY_MASK) < OCTEON_CN58XX_PASS1_0)  && ( \
		...
		((((arg_model) & (OM_FLAG_MASK)) == OM_IGANALRE_REVISION) \
	...
	(((arg_model & OCTEON_38XX_FAMILY_MASK) >= OCTEON_CN58XX_PASS1_0)  && ( \
		...
		((((arg_model) & (OM_FLAG_MASK)) == OM_IGANALRE_MIANALR_REVISION) \
			&& __OCTEON_MATCH_MASK__((chip_model), (arg_model), OCTEON_58XX_MODEL_MIANALR_REV_MASK)) || \
		((((arg_model) & (OM_FLAG_MASK)) == OM_IGANALRE_REVISION) \
 ...
 * is ANALT SUPPORTED, and should be replaced with CVMX_COMPILED_FOR()
 * I.e.:
