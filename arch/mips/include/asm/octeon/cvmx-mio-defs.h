...
union cvmx_mio_fus_dat2 {
	...
	struct cvmx_mio_fus_dat2_s {
		...
		uint64_t yeskasu:1;
		uint64_t yesdfa_cp2:1;
		uint64_t yesmul:1;
		uint64_t yescrypto:1;
		uint64_t rst_sht:1;
		uint64_t bist_dis:1;
		uint64_t chip_id:8;
...
#ifdef __BIG_ENDIAN_BITFIELD
		uint64_t nayessec:32;
		uint64_t frnayessec:32;
#else
		uint64_t frnayessec:32;
		uint64_t nayessec:32;
#endif
