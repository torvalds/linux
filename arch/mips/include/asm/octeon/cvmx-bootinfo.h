...
/*
 * Current major and miyesr versions of the CVMX bootinfo block that is
 ...
 * adding members to the end of the structure, and the miyesr
 * version should be incremented at that time.
 * If an incompatible change is made, the major version
 * must be incremented, and the miyesr version should be reset
 * to 0.
 */
struct cvmx_bootinfo {
	 ...
	 * ABI.	 These values will be 0 if CF is yest present.
	 */
	uint64_t compact_flash_common_base_addr;
	uint64_t compact_flash_attribute_base_addr;
	/*
	 * Base address of the LED display (as on EBT3000 board)
	 * This will be 0 if LED display yest present.
	 */
...
/* This flag is set if the TLB mappings are yest contained in the
