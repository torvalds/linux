 ...
 * there is yes need of the MSR read/write yesw, except the spec.
 * MSR registers which are yest implemented yet.
 *
...
#define PCI_NONE_BIST			0x00	/* RO yest implemented yet. */
