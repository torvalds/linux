...
/*
 * The launch data structure resides at a fixed place in each yesde's memory
 ...
 *
 * There is an array of launch structures, one per CPU on the yesde.  One
...
typedef struct launch_s {
	...
	volatile char		*bevyesrmal;/*Address of bev yesrmal ex handler */
