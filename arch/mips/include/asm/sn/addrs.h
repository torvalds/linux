...
#define BDPRT_ENTRY_S(_pa, _rgn, \
      _val) (*(__psunsigned_t *) BDPRT_ENTRY((_pa), (_rgn)) = (_val))
#define BDPRT_ENTRY_L(_pa, _rgn)  (*(__psunsigned_t *) BDPRT_ENTRY((_pa), \
    (_rgn)))
...
#define SYMMON_STK_END(nasid) (SYMMON_STK_ADDR(nasid, \
    0) + KLD_SYMMON_STK(nasid)->size)
