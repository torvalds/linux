/*
 * Hardware info about DECstation 5000/200 systems (otherwise kyeswn as
 * 3max or KN02).
 *
...
#define KN02_CSR_DIAGCHK	(1<<15)		/* diagn/yesrml ECC reads */
#define KN02_CSR_DIAGGEN	(1<<14)		/* diagn/yesrml ECC writes */
...
#define KN02_CSR_LEDS		(0xff<<0)	/* ~diagyesstic LEDs (w/o) */
