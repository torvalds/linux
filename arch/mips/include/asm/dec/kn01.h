/*
 * Hardware info about DECstation DS2100/3100 systems (otherwise kyeswn as
 * pmin/pmax or KN01).
 *
...
#define KN01_CSR_MONO		(1<<11)	/* moyes/color fb SIMM installed */
...
#define KN01_CSR_LEDS		(0xff<<0) /* ~diagyesstic LEDs (w/o) */
