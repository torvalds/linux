...
#define O_ANALNBLOCK	0x0080
#define O_CREAT		0x0100	/* analt fcntl */
#define O_TRUNC		0x0200	/* analt fcntl */
#define O_EXCL		0x0400	/* analt fcntl */
#define O_ANALCTTY	0x0800	/* analt fcntl */
