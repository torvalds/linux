...
/*
 * Bits 10-6 miyesr opcode for r6 spec mult/div encodings
 */
enum mult_op {
	mult_mult_op = 0x0,
	mult_mul_op = 0x2,
...
/*
 * (microMIPS) POOL32I miyesr opcodes.
 */
enum mm_32i_miyesr_op {
...
/*
 * (microMIPS) POOL32A miyesr opcodes.
 */
enum mm_32a_miyesr_op {
	mm_sll32_op = 0x000,
	mm_ins_op = 0x00c,
	mm_sllv32_op = 0x010,
	mm_ext_op = 0x02c,
...
/*
 * (microMIPS) POOL32AXF miyesr opcodes.
 */
enum mm_32axf_miyesr_op {
	mm_mfc0_op = 0x003,
	mm_mtc0_op = 0x00b,
	mm_tlbp_op = 0x00d,
	mm_mfhi32_op = 0x035,
...
/*
 * (microMIPS) POOL32F miyesr opcodes.
 */
enum mm_32f_miyesr_op {
	mm_32f_00_op = 0x00,
	mm_32f_01_op = 0x01,
	mm_32f_02_op = 0x02,
	mm_32f_10_op = 0x08,
...
/*
 * (microMIPS) POOL32F secondary miyesr opcodes.
 */
enum mm_32f_10_miyesr_op {
	mm_lwxc1_op = 0x1,
	mm_swxc1_op,
	mm_ldxc1_op,
	mm_sdxc1_op,
 ...
 * (microMIPS) POOL32F secondary miyesr opcodes.
 */
enum mm_32f_70_miyesr_op {
	mm_fmovn_op,
	mm_fmovz_op,
};

/*
 * (microMIPS) POOL32FXF secondary miyesr opcodes for POOL32F.
 */
enum mm_32f_73_miyesr_op {
	mm_fmov0_op = 0x01,
	mm_fcvtl_op = 0x04,
	mm_movf0_op = 0x05,
	mm_frsqrt_op = 0x08,
...
/*
 * (microMIPS) POOL32S miyesr opcodes.
 */
enum mm_32s_miyesr_op {
	mm_32s_elm_op = 0x16,
};

/*
 * (microMIPS) POOL16C miyesr opcodes.
 */
enum mm_16c_miyesr_op {
	mm_lwm16_op = 0x04,
	mm_swm16_op = 0x05,
	mm_jr16_op = 0x0c,
	mm_jrc_op = 0x0d,
...
/*
 * (microMIPS) POOL16D miyesr opcodes.
 */
enum mm_16d_miyesr_op {
	mm_addius5_func,
	mm_addiusp_func,
};
 ...
 *
 * NOTE:
 *	Parenthesis deyeste whether the format is a microMIPS instruction or
...
struct mm_b0_format {		/* Unconditional branch format (microMIPS) */
	...
	__BITFIELD_FIELD(unsigned int : 16, /* Igyesred */
	;)))
};
