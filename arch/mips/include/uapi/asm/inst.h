...
struct j_format {
  __BITFIELD_FIELD(unsigned int opcode:
      6, /* Jump format */
      __BITFIELD_FIELD(unsigned int target:
      26,
      ;
      ))
};
...
struct i_format {     /* signed immediate format */
  __BITFIELD_FIELD(unsigned int opcode:
      6,
      __BITFIELD_FIELD(unsigned int rs:
      5,
      __BITFIELD_FIELD(unsigned int rt:
      5,
      __BITFIELD_FIELD(signed int simmediate:
      16,
      ;
      ))))
};
...
struct u_format {     /* unsigned immediate format */
  __BITFIELD_FIELD(unsigned int opcode:
      ...
      __BITFIELD_FIELD(unsigned int rt:
      5,
      __BITFIELD_FIELD(unsigned int uimmediate:
      16,
      ;
      ))))
};
...
struct c_format {     /* Cache (>= R6000) format */
  __BITFIELD_FIELD(unsigned int opcode:
      ...
      __BITFIELD_FIELD(unsigned int rs:
      5,
      __BITFIELD_FIELD(unsigned int c_op:
      3,
      __BITFIELD_FIELD(unsigned int cache:
      2,
      __BITFIELD_FIELD(unsigned int simmediate:
      16,
      ;
      )))))
};
...
struct r_format {     /* Register format */
  __BITFIELD_FIELD(unsigned int opcode:
      ...
      __BITFIELD_FIELD(unsigned int rt:
      5,
      __BITFIELD_FIELD(unsigned int rd:
      5,
      __BITFIELD_FIELD(unsigned int re:
      5,
      __BITFIELD_FIELD(unsigned int func:
      6,
      ;
      ))))))
};
...
struct c0r_format {     /* C0 register format */
  __BITFIELD_FIELD(unsigned int opcode:
      ...
      __BITFIELD_FIELD(unsigned int rd:
      5,
      __BITFIELD_FIELD(unsigned int z:
      8,
      __BITFIELD_FIELD(unsigned int sel:
      3,
      ;
      ))))))
};
...
struct mfmc0_format {     /* MFMC0 register format */
  __BITFIELD_FIELD(unsigned int opcode:
      ...
      __BITFIELD_FIELD(unsigned int re:
      5,
      __BITFIELD_FIELD(unsigned int sc:
      1,
...
struct co_format {      /* C0 CO format */
  __BITFIELD_FIELD(unsigned int opcode:
      6,
      __BITFIELD_FIELD(unsigned int co:
      1,
      __BITFIELD_FIELD(unsigned int code:
      19,
      __BITFIELD_FIELD(unsigned int func:
      6,
      ;
...
struct f_format {     /* FPU register format */
  __BITFIELD_FIELD(unsigned int opcode:
      ...
      __BITFIELD_FIELD(unsigned int fmt:
      4,
      __BITFIELD_FIELD(unsigned int rt:
      5,
      __BITFIELD_FIELD(unsigned int rd:
...
struct ma_format {    /* FPU multiply and add format (MIPS IV) */
  __BITFIELD_FIELD(unsigned int opcode:
      6,
      __BITFIELD_FIELD(unsigned int fr:
      5,
      __BITFIELD_FIELD(unsigned int ft:
      5,
      __BITFIELD_FIELD(unsigned int fs:
      5,
      __BITFIELD_FIELD(unsigned int fd:
      5,
      __BITFIELD_FIELD(unsigned int func:
      4,
      __BITFIELD_FIELD(unsigned int fmt:
...
struct v_format {       /* MDMX vector format */
  __BITFIELD_FIELD(unsigned int opcode:
      ...
      __BITFIELD_FIELD(unsigned int fmt:
      1,
      __BITFIELD_FIELD(unsigned int vt:
      5,
      __BITFIELD_FIELD(unsigned int vs:
      5,
      __BITFIELD_FIELD(unsigned int vd:
      5,
      __BITFIELD_FIELD(unsigned int func:
      6,
      ;
...
struct msa_mi10_format {    /* MSA MI10 */
  __BITFIELD_FIELD(unsigned int opcode:
      6,
      __BITFIELD_FIELD(signed int s10:
      10,
      __BITFIELD_FIELD(unsigned int rs:
      5,
      __BITFIELD_FIELD(unsigned int wd:
      5,
      __BITFIELD_FIELD(unsigned int func:
      4,
      __BITFIELD_FIELD(unsigned int df:
      2,
      ;
      ))))))
};
...
struct dsp_format {   /* SPEC3 DSP format instructions */
  __BITFIELD_FIELD(unsigned int opcode:
      6,
      __BITFIELD_FIELD(unsigned int base:
      5,
      __BITFIELD_FIELD(unsigned int index:
      5,
      __BITFIELD_FIELD(unsigned int rd:
      5,
      __BITFIELD_FIELD(unsigned int op:
      5,
      __BITFIELD_FIELD(unsigned int func:
      6,
      ;
...
struct mxu_lx_format {    /* SPEC2 MXU LX format instructions */
  __BITFIELD_FIELD(unsigned int opcode:
      ...
      __BITFIELD_FIELD(unsigned int rd:
      5,
      __BITFIELD_FIELD(unsigned int strd:
      2,
      __BITFIELD_FIELD(unsigned int op:
      3,
      __BITFIELD_FIELD(unsigned int func:
...
struct fb_format {    /* FPU branch format (MIPS32) */
  __BITFIELD_FIELD(unsigned int opcode:
      6,
      __BITFIELD_FIELD(unsigned int bc:
      5,
      __BITFIELD_FIELD(unsigned int cc:
      3,
      __BITFIELD_FIELD(unsigned int flag:
      2,
      __BITFIELD_FIELD(signed int simmediate:
      16,
      ;
...
struct mm_fp2_format {    /* FPU movt and movf format (microMIPS) */
  __BITFIELD_FIELD(unsigned int opcode:
      ...
      __BITFIELD_FIELD(unsigned int cc:
      3,
      __BITFIELD_FIELD(unsigned int zero:
      2,
      __BITFIELD_FIELD(unsigned int fmt:
      2,
      __BITFIELD_FIELD(unsigned int op:
...
struct mm_fp4_format {    /* FPU c.cond format (microMIPS) */
  __BITFIELD_FIELD(unsigned int opcode:
      ...
      __BITFIELD_FIELD(unsigned int fmt:
      3,
      __BITFIELD_FIELD(unsigned int cond:
      4,
      __BITFIELD_FIELD(unsigned int func:
      6,
      ;
...
struct mm16_m_format {    /* Multi-word load/store format */
  __BITFIELD_FIELD(unsigned int opcode:
      ...
      __BITFIELD_FIELD(unsigned int func:
      4,
      __BITFIELD_FIELD(unsigned int rlist:
      2,
      __BITFIELD_FIELD(unsigned int imm:
      4,
      __BITFIELD_FIELD(unsigned int : 16, /* Ignored */
      ;
      )))))
...
struct loongson3_lswc2_format {
  /* Loongson-3 overridden lwc2/swc2 Load/Store
   * format */
  __BITFIELD_FIELD(unsigned int opcode:
      6,
      __BITFIELD_FIELD(unsigned int base:
      ...
      __BITFIELD_FIELD(unsigned int fr:
      1,
      __BITFIELD_FIELD(unsigned int offset:
      9,
      __BITFIELD_FIELD(unsigned int ls:
      1,
      __BITFIELD_FIELD(unsigned int rq:
      5,
      ;
      )))))))
};
...
struct loongson3_lsdc2_format {
  /* Loongson-3 overridden ldc2/sdc2 Load/Store
   * format */
  __BITFIELD_FIELD(unsigned int opcode:
      6,
      __BITFIELD_FIELD(unsigned int base:
      ...
      __BITFIELD_FIELD(unsigned int offset:
      8,
      __BITFIELD_FIELD(unsigned int opcode1:
      3,
      ;
      ))))))
};
...
struct m16e_rr {
  __BITFIELD_FIELD(unsigned int opcode:
      5,
      __BITFIELD_FIELD(unsigned int rx:
      3,
      __BITFIELD_FIELD(unsigned int nd:
      1,
      __BITFIELD_FIELD(unsigned int l:
      1,
      __BITFIELD_FIELD(unsigned int ra:
      1,
      __BITFIELD_FIELD(unsigned int func:
      5,
      ;
...
struct m16e_jal {
  __BITFIELD_FIELD(unsigned int opcode:
      5,
      __BITFIELD_FIELD(unsigned int x:
      1,
      __BITFIELD_FIELD(unsigned int imm20_16:
      5,
      __BITFIELD_FIELD(signed int imm25_21:
      5,
      ;
      ))))
};
...
struct m16e_ri64 {
  __BITFIELD_FIELD(unsigned int opcode:
      ...
      __BITFIELD_FIELD(unsigned int func:
      3,
      __BITFIELD_FIELD(unsigned int ry:
      3,
      __BITFIELD_FIELD(unsigned int imm:
      5,
      ;
