...
static int __init early_read_config_word(struct pci_controller *hose,
 ...
 */
struct pci_controller *__init txx9_alloc_pci_controller(
...
static int __init txx9_arch_pci_init(void) {
