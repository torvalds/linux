...
static const struct gpio_led
  ...
  BCM47XX_GPIO_LED(1, "unk", "power", 1, LEDS_GPIO_DEFSTATE_ON), /* Labeled
                                                                  * "READY"
                                                                  * (there is no
                                                                  * "power"
                                                                  * LED).
...
static const struct gpio_led
  ...
  BCM47XX_GPIO_LED_TRIGGER(0, "green", "status", 1, "timer"), /* Originally
                                                               * blinking when
                                                               * device is
                                                               * ready,
                                                               * separated from
...
static const struct gpio_led
  ...
  BCM47XX_GPIO_LED(2, "unk", "unk", 1, LEDS_GPIO_DEFSTATE_OFF), /* There are
                                                                 * only 3 LEDs:
                                                                 * Power,
                                                                 * Wireless and
                                                                 * Device
...
static const struct gpio_led
  ...
  BCM47XX_GPIO_LED(1, "unk", "status", 1, LEDS_GPIO_DEFSTATE_OFF), /* "Ready"
                                                                    * LED */
};
