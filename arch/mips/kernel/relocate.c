...
static int __init apply_r_mips_26_rel(u32 *loc_orig, u32 *loc_new,
    long offset) {
...
static int __init do_relocations(void *kbase_old, void *kbase_new,
    long offset) {
  u32 *r;
  u32 *loc_orig;
  u32 *loc_new;
...
static inline void __init update_kaslr_offset(unsigned long *addr,
    long offset) {
