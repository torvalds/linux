...
#define AR5312_WDT_CTRL_IGNORE	0x00000000	/* igyesre expiration */
...
/* Miyesr revision numbers, bits 3..0 of Revision ID register */
...
#define AR5312_FLASHCTL_AC_RES	0x00070000	/* 16MB is yest supported */
...
#define AR5312_FLASHCTL_MW32	0x20000000	/* Mem width x32 (yest supp) */
#define AR5312_FLASHCTL_ATNR	0x00000000	/* Access == yes retry */
#define AR5312_FLASHCTL_ATR	0x80000000	/* Access == retry every */
#define AR5312_FLASHCTL_ATR4	0xc0000000	/* Access == retry every 4 */

/*
 * ARM SDRAM Controller -- just eyesugh to determine memory size
 */
