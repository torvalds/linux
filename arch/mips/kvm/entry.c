...
static unsigned int scratch_vcpu[2] = {
  C0_DDATALO
};
...
void *kvm_mips_build_vcpu_run(void *addr) {
   ...
   * are enabled
   */
  uasm_i_addiu(&p, GPR_K0, GPR_ZERO,
      ST0_EXL | KSU_USER | ST0_IE | ST0_KX_IF_64);
...
static void *kvm_mips_build_enter_guest(void *addr) {
   ...
   */
  uasm_i_addiu(&p, GPR_T3, GPR_ZERO,
      sizeof(struct cpuinfo_mips) / sizeof(long));
