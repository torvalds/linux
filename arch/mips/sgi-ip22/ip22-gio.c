 ...
 */
static const struct gio_device_id *gio_match_device(
...
/**
 * gio_release_dev - free an gio device structure when all users of it are
 * finished.
...
static int gio_device_uevent(const struct device *dev,
