...
** (eg Diyes or LBA) are required to place at the top of their own
...
struct pci_hba_data {
	...
	/* NOTE: Diyes code assumes it can use *all* of the lmmio_space,
...
** address space.
**
** While I'm at it more PA programming yestes:
**
...
**
** 2) The Programmed I/O (PIO) data may yest always be strongly ordered with
 ...
 *   the busses rather than treat each Diyes as a separate PCI domain.
