...
extern const char * const cpu_name_version[][2]; /* mapping from enum cpu_type
                                                  * to strings */
...
extern const struct parisc_device *find_pa_parent_type(
  const struct parisc_device *, int);
