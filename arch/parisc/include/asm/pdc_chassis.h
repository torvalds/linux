 ...
 * Direct call names
 * -----------------
 * They setup everything for you, the Log message and the corresponding LED
 * state
 */
...
#define PDC_CHASSIS_LSTATE_BFAIL_NCRIT  (PDC_CHASSIS_LED_RUN_FLASH    \
  ...
  | PDC_CHASSIS_LED_FAULT_ON   \
  | PDC_CHASSIS_LED_VALID)
/* Unexpected reboot/recovering - Executing non-OS code - Non-critical error
 * detected */
...
#define PDC_CHASSIS_LSTATE_NOCODE_NCRIT (PDC_CHASSIS_LED_RUN_OFF    \
  ...
  | PDC_CHASSIS_LED_FAULT_OFF    \
  | PDC_CHASSIS_LED_VALID)
/* Boot failed - OS not up - Fatal failure detected - Non-critical error
 * detected */
...
#define PDC_CHASSIS_ALERT_CONF_CHG  (4ULL << 36)  /* unexpected configuration
                                                   * change */
#define PDC_CHASSIS_ALERT_ENV_PB  (5ULL << 36)  /* boot possible, environmental
                                                 * pb */
#define PDC_CHASSIS_ALERT_PENDING (6ULL << 36)  /* boot possible, pending
                                                 * failure */
#define PDC_CHASSIS_ALERT_PERF_IMP  (8ULL << 36)  /* boot possible, performance
                                                   * impaired */
#define PDC_CHASSIS_ALERT_FUNC_IMP  (10ULL << 36) /* boot possible,
...
#define PDC_CHASSIS_ALERT_ENV_FATAL (14ULL << 36) /* fatal power or
                                                   * environmental pb */
