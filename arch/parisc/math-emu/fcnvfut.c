 ...
 */
/*ARGSUSED*/
int sgl_to_sgl_fcnvfut(sgl_floating_point *srcptr, unsigned int *_nullptr,
 ...
 */
/*ARGSUSED*/
int sgl_to_dbl_fcnvfut(sgl_floating_point *srcptr, unsigned int *_nullptr,
 ...
 */
/*ARGSUSED*/
int dbl_to_sgl_fcnvfut(dbl_floating_point *srcptr, unsigned int *_nullptr,
    unsigned int *dstptr, unsigned int *status) {
 ...
 */
/*ARGSUSED*/
int dbl_to_dbl_fcnvfut(dbl_floating_point *srcptr, unsigned int *_nullptr,
    dbl_unsigned *dstptr, unsigned int *status) {
  register int src_exponent;
