 ...
 */
/*ARGSUSED*/
int dbl_to_sgl_fcnvfu(dbl_floating_point *srcptr, unsigned int *_nullptr,
 ...
 */
/*ARGSUSED*/
int dbl_to_dbl_fcnvfu(dbl_floating_point *srcptr, unsigned int *_nullptr,
