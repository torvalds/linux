 ...
 *
 *  Purpose:
 *      <<please update with a synopis of the functionality provided by this
 * file>>
 *
 *  BE header:  no
 *
...
#define Deposit_shigh2mantissa(object, value) Bitfield_deposit(value, 9, 2, \
    object)
#define Deposit_sexponentmantissa(object, value) \
  Bitfield_deposit(value, 1, 31, object)
#define Deposit_ssignexponent(object, value) Bitfield_deposit(value, 0, 9, \
    object)
...
#define Deposit_dmantissap1(object, value) Bitfield_deposit(value, 12, 20, \
    object)
#define Deposit_dhigh2mantissa(object, value) Bitfield_deposit(value, 12, 2, \
    object)
#define Deposit_dexponentmantissap1(object, value) \
  Bitfield_deposit(value, 1, 31, object)
#define Deposit_dsignexponent(object, value) Bitfield_deposit(value, 0, 12, \
    object)
