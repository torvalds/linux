...
static u_int decode_0c(u_int ir, u_int class, u_int subop, u_int fpregs[]) {
...
static u_int decode_0e(ir, class, subop, fpregs)
 ...
 */
static u_int decode_06(ir, fpregs)
u_int ir;
u_int fpregs[];
{
 ...
 */
static u_int decode_26(ir, fpregs)
u_int ir;
u_int fpregs[];
{
  u_int rm1, rm2, tm, ra, ta; /* operands */
 ...
 */
static u_int decode_2e(ir, fpregs)
u_int ir;
u_int fpregs[];
{
 ...
 */
static void update_status_cbit(status, new_status, fpu_type, y_field)
