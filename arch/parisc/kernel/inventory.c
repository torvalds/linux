...
static void __init set_pmem_entry(physmem_range_t *pmem_ptr,
    unsigned long start,
...
static int __init pat_query_module(ulong pcell_loc, ulong mod_index) {
...
static struct parisc_device *__init legacy_create_device(
 ...
 */
static void __init add_system_map_addresses(struct parisc_device *dev,
    int num_addrs,
    int module_instance) {
  int i;
  long status;
