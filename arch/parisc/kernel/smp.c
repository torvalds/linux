...
*/
static void ipi_init(int cpuid) {
...
**
*/
static void halt_processor(void) {
...
static inline void ipi_send(int cpu, enum ipi_message_type op) {
...
static inline void send_IPI_single(int dest_cpu, enum ipi_message_type op) {
...
inline void smp_send_stop(void) {
 ...
 */
static void smp_cpu_init(int cpunum) {
