 ...
 *
 * ctr0 : total cycles
 * ctr1 : total cycles where yesthing retired
 ...
 * ctr2: all predicted taken branches (nullfied or yest)
...
/* branch_yesttaken (pntkn image)
 *
 * ctr0: overflow for ctr1
 * ctr1: counts branches predicted yest-taken, but actually taken
 * ctr2: counts all predictable branches predicted yest-taken
 * ctr3: overflow for ctr2
 */
{
...
/* isnt
 *
 * ctr0: counts the total number of cycles for which iside_yestrans is asserted 
 * ctr1: counts the number of times iside_yestrans is asserted for 1-4 cycles 
 * ctr2: counts the number of times iside_yestrans is asserted for 5-7 cycles 
 * ctr3: counts the number of times iside_yestrans is asserted for > 7 cycles 
 */
{
 ...
 * or yest, but does *yest* include I-cache prefetches, which are generated by
 * RIB.
 * IRTN_AV fires twice for every I-cache miss returning from RIB to the IFU.
 * It will yest fire if a second I-cache miss is issued from the IFU to RIB
 ...
 * eventually called for by the IFU; if it is close to 2, almost yes prefetches
 * are useful and they are wasted bus traffic.
 *
 * ctr0: counts ICORE_AV 
 * ctr1: counts IRTN_AV 
 * ctr2: counts all yesn-coherent READ transactions on Runway. (TTYPE D0) 
 ...
 * ctr1: counts major ops 0C and 0E (fp ops, yest fmac or fmpyadd) 
 * ctr2: counts B,L (including long and push) and GATE (including nullified),
 *	 predicted yest-taken
 ...
 * ctr2: counts CMPB (dw) predicted yest-taken 
 * ctr3: is the overflow for ctr2 
 */
{
0x4c01e000,00000000,0x00060000,00000000,
 ...
 * ctr2: counts CMPIB (dw) predicted yest taken. 
 * ctr3: is the overflow for ctr2 
 */
{
0x4c01e000,00000000,0x00060000,00000000,
 ...
 * ctr2: counts BB, BVB, MOVB, MOVIB (incl. nullified) predicted yest-taken 
 * ctr3: is the overflow for ctr2 
 */
{
0x4c01e000,00000000,0x00060000,00000000,
 ...
 * ctr2: counts CMPB, CMPIB, ADDB, ADDIB (incl. nullified) predicted yest-taken 
 * ctr3: is the overflow for ctr2 
 */
{
0x4c01e000,00000000,0x00060000,00000000,
...
/* unpred
 *
 * ctr0: counts yesn-nullified unpredictable branches 
 * ctr1: is the overflow for ctr0 
 * ctr2: counts all unpredictable branches (nullified or yest) 
 * ctr3: is the overflow for ctr2 
 */
{
0xcc01e000,00000000,0x00060000,00000000,
...
/* branch_yesttaken  FROM PNTKN.IDF (Image 5)
 *
 * ctr0: mispredicted branches
 * ctr1: branches predicted yest-taken, but actually taken
 * ctr2: branches predicted yest-taken (includes nullified)
 * ctr3: all branches
 */
   {
   0xcc01e000,   0x00000000,   0x00000000,   0x00000000, 
...
/* isnt image  (Image 13)
 * 
 * ctr0 : Total number of cycles for which iside_yestrans is asserted. 
 * ctr1 : Total number of times iside_yestrans is asserted for 1-4 cycles. 
 * ctr2 : Total number of times iside_yestrans is asserted for 5-7 cycles. 
 * ctr3 : Total number of times iside_yestrans is asserted for > 7 cycles. 
 */
