...
asmlinkage ssize_t parisc_pread64(unsigned int fd, char __user *buf,
    size_t count,
    unsigned int high, unsigned int low) {
...
asmlinkage notrace long parisc_madvise(unsigned long start, size_t len_in,
  ...
  switch (behavior) {
    case 65:
      behavior = MADV_MERGEABLE;
      break;
    case 66:
      behavior = MADV_UNMERGEABLE;
      break;
    case 67:
      behavior = MADV_HUGEPAGE;
      break;
    case 68:
      behavior = MADV_NOHUGEPAGE;
      break;
    case 69:
      behavior = MADV_DONTDUMP;
      break;
    case 70:
      behavior = MADV_DODUMP;
      break;
    case 71:
      behavior = MADV_WIPEONFORK;
      break;
    case 72:
      behavior = MADV_KEEPONFORK;
      break;
    case 73:
      behavior = MADV_COLLAPSE;
      break;
  }
