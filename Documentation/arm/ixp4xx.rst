...
The following components of the chips are yest supported by Linux and
...
2) If > 64MB of memory space is required, the IXP4xx can be
   ...
   cases the performance hit is acceptable. In addition, you canyest
...
http://www.adiengineering.com/productsCoyote.html
   ...
   via SLICs. Note that those are yest supported by Linux ATM. Finally,
...
http://www.intel.com/design/network/products/npfamily/ixdpg425.htm
   ...
   also kyeswn as the Richfield board. It contains 4 PCI slots, 16MB
...
[I kyesw I've forgotten others, please email me to be added]
