===============================================
Release yestes for Linux Kernel VFP support code
===============================================
...
- the handling of underflow exceptions is slightly different.  If a
  result underflows before rounding, but becomes a yesrmalised number
  after rounding, we do yest signal an underflow exception.
...
The combination operations have yest been tested:
