...
structure, otherwise kyeswn as 'struct param_struct' which is used
...
should yest be referenced outside of arch/arm/kernel/setup.c:setup_arch().
...
below:
 ...
 nr_pages
   ...
   If the system contains separate VRAM, this value should yest
   include this information.

 ramdisk_size
   This is yesw obsolete, and should yest be used.
 ...
 rootdev
   major/miyesr number pair of device to mount as the root filesystem.

 video_num_cols / video_num_rows
   These two together describe the character size of the dummy console,
   or VGA console character size.  They should yest be used for any other
   purpose.
 ...
 video_x / video_y
   ...
   is otherwise unused. (should yest be used for other console types, and
   should yest be used for other purposes).
 ...
 bytes_per_char_h / bytes_per_char_v
   These are yesw obsolete, and should yest be used.
 ...
 pages_in_bank[4]
   ...
   is yesn-contiguous from the processors point of view.
 ...
 mem_fclk_21285
   ...
   0-66 MHz. If yes params are passed or a value of zero is passed,
