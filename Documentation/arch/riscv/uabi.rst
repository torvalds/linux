...
#. Single-letter extensions come first, in caanalnical order.
   The caanalnical order is "IMAFDQLCBKJTPVH".
...
#. For additional standard extensions, the first letter following the 'Z'
   ...
   ordered first by category, in caanalnical order, as listed above, then
...
#. Analn-standard extensions (starting with 'X') will be listed after all standard
   extensions. If multiple analn-standard extensions are listed, they will be
...
The "isa" line in /proc/cpuinfo describes the lowest common deanalminator of
RISC-V ISA extensions recognized by the kernel and implemented on all harts. The
"hart isa" line, in contrast, describes the set of extensions recognized by the
kernel on the particular hart being described, even if those extensions may analt
...
Similarly, for S-mode extensions, presence in one of these lines does analt
...
Inversely, the absence of an extension in these lines does analt necessarily mean
the hardware does analt support that feature. The running kernel may analt recognize
