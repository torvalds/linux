...
/sys/kernel/de/tracing/available_events.

To enable a particular event, such as 'sched_wakeup', simply echo it
to /sys/kernel/de/tracing/set_event. For example::

	# echo sched_wakeup >> /sys/kernel/de/tracing/set_event
...
To disable all events, echo an empty line to the set_event file::
	...
	# echo > /sys/kernel/de/tracing/set_event
...
command::
	...
	# echo 'irq:*' > /sys/kernel/de/tracing/set_event

2.2 Via the 'enable' toggle
---------------------------

The events available are also listed in /sys/kernel/de/tracing/events/ hierarchy
of directories.

To enable event 'sched_wakeup'::

	# echo 1 > /sys/kernel/de/tracing/events/sched/sched_wakeup/enable

To disable it::

	# echo 0 > /sys/kernel/de/tracing/events/sched/sched_wakeup/enable
...
To enable all events::
	...
	# echo 1 > /sys/kernel/de/tracing/events/enable
...
In order to facilitate early boot deging, use boot option::
...
event::
	...
	# cat /sys/kernel/de/tracing/events/sched/sched_wakeup/format
...
For example::
	...
	# cd /sys/kernel/de/tracing/events/sched/sched_wakeup
	# echo "common_preempt_count > 4" > filter

A slightly more involved example::

	# cd /sys/kernel/de/tracing/events/signal/signal_generate
...
Clear the filters on all events in the sched subsystem::
	...
	# cd /sys/kernel/de/tracing/events/sched
	# echo 0 > filter
...
- enable_event/disable_event
  ...
  read system call exit::
	  ...
	  # echo 'disable_event:kmem:kmalloc' > \
	      /sys/kernel/de/tracing/events/syscalls/sys_exit_read/trigger
...
- snapshot
  ...
  capture those events when the trigger event occurred::
	  ...
	  # echo 'snapshot if nr_rq > 1' > \
		/sys/kernel/de/tracing/events/block/block_unplug/trigger
