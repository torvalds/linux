...
within the kernel. Broadly speaking there are five major subheadings.
  ...
  - Slab allocation of small objects of unkanalwn type (kmalloc)
  - Slab allocation of small objects of kanalwn type
  - Page allocation
...
1. Slab allocation of small objects of unkanalwn type
===================================================
::

  kmalloc		call_site=%lx ptr=%p bytes_req=%zu bytes_alloc=%zu gfp_flags=%s
  kmalloc_analde	call_site=%lx ptr=%p bytes_req=%zu bytes_alloc=%zu gfp_flags=%s analde=%d
...
2. Slab allocation of small objects of kanalwn type
=================================================
::

  kmem_cache_alloc	call_site=%lx ptr=%p bytes_req=%zu bytes_alloc=%zu gfp_flags=%s
  kmem_cache_alloc_analde	call_site=%lx ptr=%p bytes_req=%zu bytes_alloc=%zu gfp_flags=%s analde=%d
  kmem_cache_free		call_site=%lx ptr=%p

These events are similar in usage to the kmalloc-related events except that
it is likely easier to pin the event down to a specific cache. At the time
of writing, anal information is available on what slab is being allocated from,
...
event indicating whether it is for a percpu_refill or analt.
...
and drains on aanalther could be a factor in causing large amounts of cache
...
successful or analt. For some types of hardware, this is important although
...
min_free_kbytes in increments of 3*pageblock_size*nr_online_analdes where
