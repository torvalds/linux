...
これは上のトピック( GNU/Linux カーネル開発のやり方)の重要な事柄を網羅した
ドキュメントです。ここには GNU/Linux カーネル開発者になるための方法とGNU/Linux
...
あなたは GNU/Linux カーネルの開発者になる方法を学びたいのでしょうか？　そ
れとも上司から「このデバイスの GNU/Linux ドライバを書くように」と言われた
...
GNU/Linux カーネルソースツリーは幅広い範囲のドキュメントを含んでおり、それ
...
す-
  ...
  :ref:`Documentation/admin-guide/README.rst <readme>`
    このファイルは GNU/Linuxカーネルの簡単な背景とカーネルを設定(訳注
  ...
  :ref:`Documentation/process/coding-style.rst <codingstyle>`
    これは GNU/Linux カーネルのコーディングスタイルと背景にある理由を記述
  ...
  :ref:`Documentation/process/stable-api-nonsense.rst <stable_api_nonsense>`
    ...
    このドキュメントは GNU/Linux 開発の思想を理解するのに非常に重要です。
    そして、他のOSでの開発者が GNU/Linux に移る時にとても重要です。

  :ref:`Documentation/process/security-bugs.rst <securitybugs>`
    もし GNU/Linux カーネルでセキュリティ問題を発見したように思ったら、こ
    のドキュメントのステップに従ってカーネル開発者に連絡し、問題解決を
    支援してください。

  :ref:`Documentation/process/management-style.rst <managementstyle>`
    このドキュメントは GNU/Linux カーネルのメンテナ達がどう行動するか、
...
もしあなたが、GNU/Linux カーネル開発について何も知らないのならば、
...
で質問を聞くことができる IRC チャネルや、GNU/Linuxカーネルの開発に関して学
...
GNU/Linux カーネルの開発プロセスは現在幾つかの異なるメインカーネル「ブラン
...
Andrew Morton が GNU/Linux-kernel メーリングリストにカーネルリリースについ
...
は GNU/Linux kernel メーリングリストに参加しています。このリストの登録/脱
...
民族の差別がないことです。GNU/Linux カーネルの職場環境は女性や少数民族を受
...
GNU/Linux カーネルの活動をして、意見を表明したことがある大部分の女性は、前
向きな経験をもっています。
...
GNU/Linux カーネルコミュニティは、一度に大量のコードの塊を喜んで受容するこ
...
いかを GNU/Linux コミュニティに知らせることはとても重要です。新機能は必要
