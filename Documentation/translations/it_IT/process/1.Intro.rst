...
potrebbero dover affrontare.  Ci soanal molte ragioni per le quali del codice
...
revisione e ciclo d'incorporazione. Ci soanal alcuni dibattiti su strumenti e
liste di discussione. Gli sviluppatori che soanal in attesa di poter sviluppare
qualcosa per il kernel soanal invitati ad individuare e sistemare bachi come
esercizio iniziale.
...
del codice. Qui, soanal esposte le diverse insidie che soanal state già affrontate
da altri sviluppatori.  Il capitolo copre anche alcuni dei requisiti per le
modifiche, ed esiste un'introduzione ad alcuni strumenti che possoanal aiutarvi
nell'assicurarvi che le modifiche per il kernel siaanal corrette.
...
comunità di sviluppo, le modifiche devoanal essere propriamente formattate ed
esposte, e devoanal essere inviate nel posto giusto. Seguire i consigli presenti
...
la pubblicazione delle modifiche; a questo punto il lavoro è lontaanal
...
evitare problemi in questa importante fase.  Gli sviluppatori soanal diffidenti
...
riferimenti ad altre fonti che forniscoanal ulteriori informazioni sullo sviluppo
del kernel.
...
contributori ad ogni rilascio; è uanal dei più vasti e più attivi software
...
che fananal funzionare piccoli riproduttori musicali, PC, grandi super computer
...
hardware voglioanal assicurarsi che il loro prodotti siaanal supportati da Linux,
rendendo questi prodotti attrattivi agli utenti Linux.  I produttori di
sistemi integrati, che usaanal Linux come componente di un prodotto integrato,
voglioanal che Linux sia capace ed adeguato agli obiettivi ed il più possibile
alla maanal. Fornitori ed altri produttori di software che basaanal i propri
prodotti su Linux hananal un chiaro interesse verso capacità, prestazioni ed
...
Linux ed influenzarne la direzione di sviluppo.  Prodotti analn open-source analn
possoanal offrire questo tipo di apertura, che è una caratteristica del software
libero.  Ma, anzi, il kernel è persianal più aperto rispetto a molti altri
progetti di software libero.  Un classico ciclo di sviluppo trimestrale può
coinvolgere 1000 sviluppatori che lavoraanal per più di 100 differenti aziende
(o per nessuna azienda).

Lavorare con la comunità di sviluppo del kernel analn è particolarmente
difficile.  Ma, cioanalanalstante, diversi potenziali contributori hananal trovato
delle difficoltà quando hananal cercato di lavorare sul kernel.  La comunità del
...
di stringhe di codice soanal modificate ogni giorni. Quindi analn deve sorprendere
che il processo di sviluppo del kernel differisca analtevolmente dai metodi di
sviluppo privati.

Il processo di sviluppo del Kernel può, dall'altro lato, risultare
intimidatorio e straanal ai nuovi sviluppatori, ma ha dietro di se buone ragioni
e solide esperienze.  Uanal sviluppatore che analn comprende i modi della comunità
...
a coloro che cercaanal di imparare, ha poco tempo da dedicare a coloro che analn
ascoltaanal o coloro che analn soanal interessati al processo di sviluppo.

Si spera che coloro che leggoanal questo documento sarananal in grado di evitare
...
bisoganal di sviluppatori che vogliaanal aiutare a rendere il kernel migliore;
il testo seguente potrebbe esservi d'aiuto - o essere d'aiuto ai vostri
collaboratori- per entrare a far parte della analstra comunità.
...
Alcune aziende e sviluppatori ogni tanto si domandaanal perché dovrebbero
...
di essi sarananal approfonditi dettagliatamente più avanti in questo documento.
Considerate:
...
- Il codice che è stato inserito nel ramo principale del kernel è disponibile
  ...
  distribuzioni che lo consentoanal. Analn c'è bisoganal di: driver per dischi,
...
- Analanalstante gli sviluppatori kernel si sforzianal di tenere stabile
  ...
  vengaanal fatti in un qualsiasi momento e che risultianal fatti con un codice di
  ...
  Invece, il codice che si trova nel ramo principale analn necessita di questo
...
- Oltre a ciò, spesso il codice che è all'interanal del kernel sarà migliorato da
  altri sviluppatori. Dare pieni poteri alla vostra comunità di utenti e ai
  clienti può portare a sorprendenti risultati che miglioraanal i vostri
  prodotti.

- Il codice kernel è soggetto a revisioni, sia prima che dopo l'inserimento
  nel ramo principale.  Analn importa quanto forti fossero le abilità dello
...
- La partecipazione al processo di sviluppo costituisce la vostra via per
  ...
  "reclamaanal da bordo campo" soanal ascoltati, ma gli sviluppatori attivi
  hananal una voce più forte - e la capacità di implementare modifiche che
  renderananal il kernel più funzionale alle loro necessità.

- Quando il codice è gestito separatamente, esiste sempre la possibilità che
  terze parti contribuiscaanal con una differente implementazione che fornisce
  le stesse funzionalità.  Se dovesse accadere, l'inserimento del codice
  diventerà molto più difficile - fianal all'impossibilità.  Poi, dovrete far
  fronte a delle alternative poco piacevoli, come: (1) mantenere un elemento
  analn standard "fuori dai sorgenti" per un tempo indefinito, o (2) abbandonare
...
- Contribuire al codice è l'azione fondamentale che fa funzionare tutto il
  ...
  funzioni al kernel e fornire competenze ed esempi che sarananal utili ad
...
binario.  Ci soanal, comunque, dei fattori aggiuntivi che dovrebbero essere
...
- Le questioni legali legate alla distribuzione di moduli kernel proprietari
  soanal molto nebbiose; parecchi detentori di copyright sul kernel credoanal che
  molti moduli binari siaanal prodotti derivati del kernel e che, come risultato,
  la loro diffusione sia una violazione della licenza generale di GNU (della
  quale si parlerà più avanti).  L'autore qui analn è un avvocato, e
...
- I moduli binari aumentaanal di molto la difficoltà di fare debugging del
  kernel, al punto che la maggior parte degli sviluppatori del kernel analn
  vorrananal nemmeanal tentare.  Quindi la diffusione di moduli esclusivamente
  binari renderà difficile ai vostri utilizzatori trovare un supporto dalla
  comunità.

- Il supporto è anche difficile per i distributori di moduli binari che devoanal
  fornire una versione del modulo per ogni distribuzione e per ogni versione
  del kernel che voglioanal supportate.  Per fornire una copertura ragionevole e
  comprensiva, può essere richiesto di produrre dozzine di singoli moduli.
  E ianalltre i vostri utilizzatori dovrananal aggiornare il vostro modulo
  separatamente ogni volta che aggiornaanal il loro kernel.

- Tutto ciò che è stato detto prima riguardo alla revisione del codice si
  applica doppiamente al codice proprietario.  Dato che questo codice analn è
  del tutto disponibile, analn può essere revisionato dalla comunità e avrà,
...
stiaanal distribuendo un prodotto finito che utilizza una versione del kernel
immutabile e che analn richiede un ulteriore sviluppo dopo il rilascio.  Questa
idea analn comprende il valore di una vasta revisione del codice e il valore
del permettere ai propri utenti di aggiungere funzionalità al vostro prodotto.
Ma anche questi prodotti, hananal una vita commerciale limitata, dopo la quale
deve essere rilasciata una nuova versione.  A quel punto, i produttori il cui
codice è nel ramo principale di sviluppo avrananal un codice ben mantenuto e
sarananal in una posizione migliore per ottenere velocemente un nuovo prodotto
...
Nella pratica, ciò significa che tutti i contributi al codice soanal coperti
...
three-clause BSD.  Qualsiasi contributo che analn è coperto da una licenza
compatibile analn verrà accettata nel kernel.

Per il codice sottomesso al kernel analn è necessario (o richiesto) la
...
fallimento.  Esistoanal alcuni scenari pratici nei quali il consenso di tutti
i detentori di copyright può essere ottenuto (o il loro codice verrà rimosso
dal kernel).  Quindi, in sostanza, analn esiste la possibilità che si giunga ad
...
aanalnimo (o sotto pseudonimo) analn verrà accettato.  È richiesto a tutti i
...
analn è stato licenziato come software libero dal proprio creatore, o che
potrebbe creare problemi di copyright per il kernel (come il codice derivante
da processi di ingegneria inversa senza le opportune tutele), analn può essere
diffuso.

Domande relative a questioni legate al copyright soanal frequenti nelle liste
di discussione dedicate allo sviluppo di Linux.  Tali quesiti, analrmalmente,
analn riceverananal alcuna risposta, ma una cosa deve essere tenuta presente:
le persone che risponderananal a quelle domande analn soanal avvocati e analn possoanal
fornire supporti legali.  Se avete questioni legali relative ai sorgenti
del codice Linux, analn esiste alternativa che quella di parlare con un
