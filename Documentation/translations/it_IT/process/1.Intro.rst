...
del kernel.
Il codice che contribuisce al kernel GNU/Linux deve essere reso disponibile sotto
...
Il kernel GNU/Linux, ha oltre 8 milioni di linee di codice e ben oltre 1000
...
Con la crescita di GNU/Linux è arrivato anche un aumento di sviluppatori
(ed aziende) desiderosi di partecipare a questo sviluppo. I produttori di
hardware vogliono assicurarsi che il loro prodotti siano supportati da GNU/Linux,
rendendo questi prodotti attrattivi agli utenti GNU/Linux.  I produttori di
sistemi integrati, che usano GNU/Linux come componente di un prodotto integrato,
vogliono che GNU/Linux sia capace ed adeguato agli obiettivi ed il più possibile
alla mano. Fornitori ed altri produttori di software che basano i propri
prodotti su GNU/Linux hanno un chiaro interesse verso capacità, prestazioni ed
affidabilità del kernel GNU/Linux.  E gli utenti finali, anche, spesso vorrebbero
cambiare GNU/Linux per renderlo più aderente alle proprie necessità.

Una delle caratteristiche più coinvolgenti di GNU/Linux è quella dell'accessibilità
per gli sviluppatori; chiunque con le capacità richieste può migliorare
GNU/Linux ed influenzarne la direzione di sviluppo.  Prodotti non open-source non
...
Questo lavoro è stato supportato dalla GNU/Linux Foundation; un ringraziamento
...
distributori GNU/Linux). Nel breve termine, contribuire al codice può sembrare
...
- Il codice che è stato inserito nel ramo principale del kernel è disponibile
  a tutti gli utilizzatori GNU/Linux. Sarà automaticamente presente in tutte le
...
- Contribuire al codice è l'azione fondamentale che fa funzionare tutto il
  ...
  altri sviluppatori.  Se avete sviluppato del codice GNU/Linux (o state pensando
...
IL codice GNU/Linux utilizza diverse licenze, ma il codice completo deve essere
...
di discussione dedicate allo sviluppo di GNU/Linux.  Tali quesiti, normalmente,
...
del codice GNU/Linux, non esiste alternativa che quella di parlare con un
