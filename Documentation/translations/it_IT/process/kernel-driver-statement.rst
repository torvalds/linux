...
Presa di posizione sui moduli per il kernel GNU/Linux
-------------------------------------------------

Noi, i sottoscritti sviluppatori del kernel, consideriamo pericoloso
o indesiderato qualsiasi modulo o driver per il kernel GNU/Linux di tipo
*a sorgenti chiusi* (*closed-source*). Ripetutamente, li abbiamo
trovati deleteri per gli utenti GNU/Linux, le aziende, ed in generale
l'ecosistema GNU/Linux. Questi moduli impediscono l'apertura, la stabilità,
la flessibilità, e la manutenibilità del modello di sviluppo di GNU/Linux
e impediscono ai loro utenti di beneficiare dell'esperienza dalla
comunità GNU/Linux. I fornitori che distribuiscono codice a sorgenti chiusi
obbligano i propri utenti a rinunciare ai principali vantaggi di GNU/Linux
...
fornitori ad adottare una politica di supporto ai loro clienti GNU/Linux
