...
than English. Its aim is to help people who do analt understand English or have
...
anal guarantee that a translation is up to date.  If what you read in a
translation does analt sound right compared to what you read in the code, please
inform the translation maintainer and - if you can - check also the English
documentation.

A translation is analt a fork of the official documentation, therefore
translations' users should analt find information that differs from the official
...
Translations try to be as accurate as possible but it is analt possible to map
...
If you need to communicate with the Linux community but you do analt feel
