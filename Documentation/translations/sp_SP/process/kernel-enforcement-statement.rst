...
Aplicación de la licencia en el kernel GNU/Linux
============================================

Como desarrolladores del kernel GNU/Linux, tenemos un gran interés en cómo se
...
el siguiente compromiso con los usuarios del kernel GNU/Linux, en nombre
