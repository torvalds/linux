...
Cuando uno se sienta a planear un proyecto de desarrollo del kernel GNU/Linux,
...
trabajaban con audio en GNU/Linux buscaban una forma de ejecutar aplicaciones
...
destinado a integrarse en el marco del Módulo de Seguridad de GNU/Linux (LSM,
...
implementado y enviado a la lista de correo del kernel de GNU/Linux, donde
...
volvió a una lista de audio y publicó esto (traducido):
	...
	"Hay un buen número de desarrolladores muy competentes del kernel de GNU/Linux, pero tienden a ser opacados por una multitud de arrogantes necios. Intentar comunicar los requisitos de los usuarios a estas personas es una pérdida de tiempo. Son demasiado 'inteligentes' como para escuchar a simples mortales".
...
- Es posible que el problema ya esté siendo abordado por el kernel de
  maneras que no haya comprendido. El kernel de GNU/Linux es grande y tiene
...
con la mayoría del trabajo en el kernel de GNU/Linux — es obvio que debe tener
...
GNU/Linux Foundation opera un programa de NDA diseñado para ayudar en este tipo
