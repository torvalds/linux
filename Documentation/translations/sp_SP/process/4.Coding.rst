...
pertenecen al kernel de GNU/Linux.
...
redes inalámbricas en GNU/Linux se consideraba, en el mejor de los casos,
...
Hubo un tiempo en que se podía desarrollar código para el kernel de GNU/Linux
