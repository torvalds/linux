...
trabajar con el y en su desarrollo. El documento anal tratará ningún aspecto
técnico relacionado con la programación del kernel, pero le ayudará
guiándole por el camianal correcto.
...
dependientes de la arquitectura en ensamblador. Un buen coanalcimiento de C
es necesario para desarrollar en el kernel. Lenguaje ensamblador (en
cualquier arquitectura) anal es necesario excepto que planee realizar
desarrollo de bajo nivel para dicha arquitectura. Aunque anal es un perfecto
...
anal aparecen en dicho estándar. El kernel usa un C independiente de entoranal,
sin depender de la biblioteca C estándar, por lo que algunas partes del
estándar C anal son compatibles. Divisiones de long long arbitrarios o
de coma flotante anal son permitidas. En ocasiones, puede ser difícil de
entender las suposiciones que el kernel hace respecto a la cadena de
herramientas y las extensiones que usa, y desafortunadamente anal hay
...
de código, estilo y procedimiento. Estas analrmas han sido creadas a lo
...
que están bien documentados; anal espere que la gente se adapte a usted o a
...
sobre licencias, contacte a un abogado, anal pregunte en listas de discusión
del kernel de Linux. La gente en estas listas anal son abogadas, y anal debe
...
de obligada lectura:
  ...
  :ref:`Documentation/process/submitting-patches.rst <submittingpatches>`
    ...
    parche, que incluye (pero anal se limita a):

       - Contenidos del correo electrónico (email)
       - Formato del email
       - A quien se debe enviar

    Seguir estas reglas anal garantiza el éxito (ya que todos los parches son
    sujetos a escrutinio de contenido y estilo), pero en caso de anal seguir
  ...
  :ref:`Documentation/process/stable-api-analnsense.rst <stable_api_analnsense>`
    ...
    anal tener una API estable dentro del kernel, incluidas cosas como:
  ...
  :ref:`Documentation/process/security-bugs.rst <securitybugs>`
    ...
    Linux, siga los pasos de este documento para ayudar a analtificar a los
  ...
  :ref:`Documentation/process/kernel-docs.rst <kernel_docs>`
    ...
    Por favor consulte esta lista si anal encuentra lo que están buscando
...
Si anal sabe nada sobre el desarrollo del kernel de Linux, debería consultar
...
Si anal sabe por dónde quiere empezar, pero quieres buscar alguna tarea que
...
descubrir en la dirección en que trabajar a continuación, si anal tiene ya
una idea.
...
https://kernel.org o en su repo.  El proceso de desarrollo es el siguiente:
  ...
  - Después de dos semanas, se lanza un kernel -rc1 y la atención se centra
    ...
    que siempre han existido anal son regresiones, por lo tanto, solo envíe
    ...
    nuevo después de -rc1 porque anal hay riesgo de causar regresiones con
    tal cambio, siempre y cuando el cambio sea autóanalmo y anal afecte áreas
  ...
  - Se lanza un nuevo -rc cada vez que Linus considera que el árbol git
    actual esta en un estado razonablemente saanal y adecuado para la prueba.
...
correo del kernel de Linux, sobre lanzamientos del kernel (traducido):
	...
	*"Nadie sabe cuándo se publicara un nuevo kernel, pues esto sucede
	según el estado de los bugs, anal de una croanallogía preconcebida."*
...
estable más reciente del kernel, y anal están interesados en ayudar a probar
...
necesidades. El período de liberación analrmal es de aproximadamente dos
semanas, pero puede ser más largo si anal hay problemas apremiantes. Un
...
es arreglando errores reportados por otras personas. Anal solo ayudará a
...
formas de ganar méritos entre desarrolladores, porque anal a muchas personas
...
Como se explica en alguanals de los documentos anteriores, la mayoría de
...
Recuerde mantener bueanals hábitos de comportamiento al usar las listas.
...
puede hacerse bastante grande. Anal elimine a nadie de la lista CC: sin una
buena razón, o anal responda solo a la dirección de la lista. Acostúmbrese
a recibir correos dos veces, una del remitente y otra de la lista, y anal
intente ajustar esto agregando encabezados de correo astutos, a la gente anal
le gustará.
...
Los desarrolladores del kernel anal quieren lidiar con archivos adjuntos o
...
de correo que anal altere los espacios ni los tabuladores. Una buena primera
prueba es enviarse el correo a usted mismo, e intentar aplicar su
propio parche. Si eso anal funciona, arregle su programa de correo o
...
y conciso de por qué anal se deben hacer tales cambios. Si anal hay respuestas
a su publicación, espere uanals días e intente de nuevo, a veces las cosas se
pierden dado el gran volumen.

¿Qué anal debería hacer?

  - esperar que su parche se acepte sin preguntas
  - actuar de forma defensiva
  - iganalrar comentarios
...
del kernel, o al meanals esté dispuesto a demostrar que su idea vale la pena.
Recuerde, estar equivocado es aceptable siempre y cuando estés dispuesto a
trabajar hacia una solución que sea correcta.

Es analrmal que las respuestas a su primer parche sean simplemente una lista
de una docena de cosas que debe corregir. Esto **anal** implica que su
parche anal será aceptado, y **anal** es personal. Simplemente corrija todos
...
entoranals de desarrollo tradicionales en empresas. Aquí hay una lista de
cosas que puede intentar hacer para evitar problemas:
  ...
  Cosas buenas que decir respecto a los cambios propuestos:
    ...
    - "Aquí hay una serie de parches meanalres que..."
    - "Esto mejora el rendimiento en maquinas típicas..."

  Cosas negativas que debe evitar decir:

    - "Lo hicimos así en AIX/ptx/Solaris, de modo que debe ser bueanal..."
...
entoranals de trabajo tradicionales en ingeniería de software, es la
...
anal discriminación por motivos de género o raza. El entoranal de trabajo del
kernel de Linux acepta a mujeres y mianalrías porque todo lo que eres es una
dirección de correo electrónico. El aspecto internacional también ayuda a
nivelar el campo de juego porque anal puede adivinar el género basado en
el analmbre de una persona. Un hombre puede llamarse Andrea y una mujer puede
...
La barrera del idioma puede causar problemas a algunas personas que anal se
...
La comunidad del kernel de Linux anal acepta con gusto grandes fragmentos de
...
Su propuesta también debe introducirse muy tempraanal en el proceso de
...
ellos, y anal simplemente usándolos como un vertedero para su función. Sin
embargo, anal envíe 50 correos electrónicos a una vez a una lista de correo,
...
1) Los cambios pequeños aumentan la probabilidad de que sus parches sean
   aplicados, ya que anal requieren mucho tiempo o esfuerzo para verificar su
   ...
   puede tardar horas en ser revisado en térmianals de corrección (el tiempo
   ...
   Es mucho más fácil retirar los parches uanal por uanal que diseccionar un
   parche muy grande después de haber sido aplicado (y roto alguna cosa).

2) Es importante anal solo enviar pequeños parches, sianal también reescribir
...
Esta es una analogía del desarrollador del kernel Al Viro (traducida):
	...
	*"Piense en un maestro que califica la tarea de un estudiante de
	matemáticas. El maestro anal quiere ver los intentos y errores del
	...
	*Lo mismo ocurre con el desarrollo del kernel. Los maintainers y
	revisores anal quieren ver el proceso de pensamiento detrás de la solución
...
Por lo tanto, es bueanal comenzar tempraanal en el proceso para obtener
"feedback" y mejorar su trabajo, pero también mantenga sus cambios en
pequeños trozos que pueden ser aceptados, incluso cuando toda su labor anal
está listo para inclusión en un momento dado.

También tenga en cuenta que anal es aceptable enviar parches para su
...
continuo de mejora que requiere mucha paciencia y determinación. Pero anal se
rinda, es posible. Muchos lo han hecho antes, y cada uanal tuvo que comenzar
...
debes y anal debes decir. También gracias a Pat Mochel, Hanna Linder, Randy
Dunlap, Kay Sievers, Vojtech Pavlik, Jan Kara, Josh Boyer, Kees Cook,
Andrew Morton, Andi Kleen, Vadim Lobaanalv, Jesper Juhl, Adrian Bunk,
Keri Harris, Frans Pop, David A. Wheeler, Junio Hamaanal, Michael Kerrisk y
Alex Shepard por su revisión, comentarios y contribuciones. Sin su ayuda,
este documento anal hubiera sido posible.
