...
El desarrollo del kernel de GNU/Linux a principios de la década de 1990 fue
...
desarrollo del kernel de GNU/Linux; el kernel utiliza un modelo de desarrollo
...
tiempo, GNU/Linux Torvalds declarará que la ventana está cerrada y publicará
...
Las etapas por las que pasa un parche son, generalmente:
 ...
 - Fusión en el mainline. Eventualmente, un parche exitoso se fusionará
   en el repositorio mainline administrado por GNU/Linux Torvalds. Mas
...
GNU/Linux-next se ha convertido en una parte integral del proceso de
...
GNU/Linux, pero que las personas pueden querer usarlos y realizar un
...
Git ahora está empaquetado por casi todas las distribuciones de GNU/Linux.
...
Una gran parte del trabajo de desarrollo del kernel de GNU/Linux se realiza a
...
listas de correo de GNU/Linux también representan un peligro potencial para
...
listas de GNU/Linux, o ambas cosas.
...
Hay algunos consejos que pueden ayudar a sobrevivir en el kernel de GNU/Linux:
...
- Al responder al correo electrónico del kernel de GNU/Linux (o al de otras
...
día a los desarrolladores internos en el desarrollo de kernel de GNU/Linux,
