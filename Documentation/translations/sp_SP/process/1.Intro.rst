...
desarrollo del kernel. El código contribuido al kernel de GNU/Linux debe
...
El kernel de GNU/Linux, con más de 8 millones de líneas de código y más de
...
Con el crecimiento de GNU/Linux, ha llegado un aumento en el número de
desarrolladores (y empresas) que desean participar en su desarrollo. Los
vendedores de hardware quieren asegurarse de que GNU/Linux sea compatible con
sus productos, lo que hace que esos productos sean atractivos para los
usuarios de GNU/Linux. Los vendedores de sistemas embebidos, que utilizan
GNU/Linux como componente de un producto integrado, quieren que GNU/Linux sea lo
más capaz y adecuado posible para tarea en cuestión. Los distribuidores
y otros vendedores de software que basan sus productos en GNU/Linux tienen un
claro interés en las capacidades, el rendimiento, y la fiabilidad del
kernel de GNU/Linux. Y los usuarios finales, también, a menudo desearán
cambiar GNU/Linux para que se adapte mejor a sus necesidades.

Una de las características más convincentes de GNU/Linux es que es accesible
a estos desarrolladores; cualquier persona con las habilidades necesarias
puede mejorar GNU/Linux e influir en la dirección de su desarrollo. Los
...
proceso de desarrollo del kernel de GNU/Linux difiera mucho de los métodos de
...
Jochen Voß.
Este trabajo fue respaldado por la Fundación GNU/Linux; gracias especialmente
...
distribuidores de GNU/Linux. A corto plazo, contribuir con código puede
...
- El código que se ha fusionado con el kernel mainline está disponible
  para todos los usuarios de GNU/Linux. Estará presente automáticamente en
...
- La contribución del código es la acción fundamental que hace que todo
  ...
  para GNU/Linux (o está pensando en hacerlo), claramente tiene un interés
...
El código se contribuye al kernel de GNU/Linux bajo varias licencias, pero
...
comunes en las listas de correo de desarrollo de GNU/Linux. Normalmente, estas
...
con el código fuente de GNU/Linux, no hay sustituto para hablar con un abogado
