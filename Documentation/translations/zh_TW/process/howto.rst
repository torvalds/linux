...
這是一篇將如何參與GNU/Linux內核開發的相關問題一網打盡的終極祕笈。它將指導你
成爲一名GNU/Linux內核開發者，並且學會如何同GNU/Linux內核開發社區合作。它儘可能不
...
你想了解如何成爲一名GNU/Linux內核開發者？或者老闆吩咐你「給這個設備寫個GNU/Linux
驅動程序」？這篇文章的目的就是教會你達成這些目標的全部訣竅，它將描述你需
要經過的流程以及給出如何同內核社區合作的一些提示。它還將試圖解釋內核社區
爲何這樣運作。

GNU/Linux內核大部分是由C語言寫成的，一些體系結構相關的代碼用到了彙編語言。要
...
GNU/Linux內核使用GNU C和GNU工具鏈開發。雖然它遵循ISO C11標準，但也用到了一些
...
GNU/Linux內核原始碼都是在GPL（通用公共許可證）的保護下發布的。要了解這種許可
的細節請查看原始碼主目錄下的COPYING文件。GNU/Linux內核許可準則和如何使用
`SPDX <https://spdx.org/>` 標誌符說明在這個文件中
:ref:`Documentation/translations/zh_TW/process/license-rules.rst <tw_kernel_licensing>`
如果你對它還有更深入問題請聯繫律師，而不要在GNU/Linux內核郵件組上提問。因爲
...
GNU/Linux內核代碼中包含有大量的文檔。這些文檔對於學習如何與內核社區互動有著
...
以下是內核代碼中需要閱讀的文檔：
  :ref:`Documentation/admin-guide/README.rst <readme>`
    文件簡要介紹了GNU/Linux內核的背景，並且描述了如何配置和編譯內核。內核的
    新用戶應該從這裡開始。
  ...
  :ref:`Documentation/translations/zh_TW/process/coding-style.rst <tw_codingstyle>`
    描述GNU/Linux內核的代碼風格和理由。所有新代碼需要遵守這篇文檔中定義的規
  ...
  :ref:`Documentation/translations/zh_TW/process/stable-api-nonsense.rst <tw_stable_api_nonsense>`
    ...
    這篇文檔對於理解GNU/Linux的開發哲學至關重要。對於將開發平台從其他操作系
    統轉移到GNU/Linux的人來說也很重要。

  :ref:`Documentation/process/security-bugs.rst <securitybugs>`
    如果你認爲自己發現了GNU/Linux內核的安全性問題，請根據這篇文檔中的步驟來
    提醒其他內核開發者並幫助解決這個問題。
...
如何成爲內核開發者
------------------
如果你對GNU/Linux內核開發一無所知，你應該訪問「GNU/Linux內核新手」計劃：

	https://kernelnewbies.org

它擁有一個可以問各種最基本的內核開發問題的郵件列表（在提問之前一定要記得
查找已往的郵件，確認是否有人已經回答過相同的問題）。它還擁有一個可以獲得
實時反饋的IRC聊天頻道，以及大量對於學習GNU/Linux內核開發相當有幫助的文檔。
...
一些特製的工具還可以提供幫助。例如，「GNU/Linux代碼交叉引用」項目就是一個值得
...
目前GNU/Linux內核開發流程包括幾個「主內核分支」和很多子系統相關的內核分支。這
些分支包括：
...
通過這種方式，GNU/Linux-next 對下一個合併階段將進入主線內核的內容給出了一個概要
展望。非常歡冒險的測試者運行測試GNU/Linux-next。
...
bugzilla.kernel.org是GNU/Linux內核開發者們用來跟蹤內核Bug的網站。我們鼓勵用
...
正如上面的文檔所描述，大多數的骨幹內核開發者都加入了GNU/Linux Kernel郵件列
...
將會更少。GNU/Linux內核的工作環境更能接受婦女和少數族羣，因爲每個人在別人眼
里只是一個郵件地址。國際化也幫助了公平的實現，因爲你無法通過姓名來判斷人
的性別。男人有可能叫李麗，女人也有可能叫王剛。大多數在GNU/Linux內核上工作過
...
GNU/Linux內核社區並不喜歡一下接收大段的代碼。修改需要被恰當地介紹、討論並且
...
證明修改的必要性
----------------
除了將補丁拆成小塊，很重要的一點是讓GNU/Linux社區了解他們爲什麼需要這樣修改。
