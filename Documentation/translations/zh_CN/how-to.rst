...
过去几年，在广大社区爱好者的友好合作下，GNU/Linux 内核中文文档迎来了蓬勃的发
...
GNU/Linux 发行版和简单地使用 GNU/Linux 命令行，那么可以迅速开始了。若您尚不具备该
...
新手任务
--------
对于首次参与 GNU/Linux 内核中文文档翻译的新手，建议您在 linux 目录中运行以下命令：
::
