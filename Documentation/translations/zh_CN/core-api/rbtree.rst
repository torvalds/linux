...
引用GNU/Linux每周新闻（GNU/Linux Weekly News）：
...
本文档涵盖了对GNU/Linux红黑树实现的使用方法。更多关于红黑树的性质和实现的信息，参见：

  GNU/Linux每周新闻关于红黑树的文章
...
GNU/Linux的红黑树实现在文件“lib/rbtree.c”中。要使用它，需要“#include <linux/rbtree.h>”。

GNU/Linux的红黑树实现对速度进行了优化，因此比传统的实现少一个间接层（有更好的缓存局部性）。
