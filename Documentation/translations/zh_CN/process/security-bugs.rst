...
GNU/Linux内核开发人员非常重视安全性。因此我们想知道何时发现了安全漏洞，以便尽快
修复和披露。请向GNU/Linux内核安全团队报告安全漏洞。

联络
-----

可以通过电子邮件<security@kernel.org>联系GNU/Linux内核安全团队。这是一个安全人员
...
GNU/Linux内核安全团队不是一个正式的机构实体，因此无法签订任何保密协议。
