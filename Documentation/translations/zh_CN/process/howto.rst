...
以下是内核代码中需要阅读的文档：
  ...
  :ref:`Documentation/translations/zh_CN/process/stable-api-yesnsense.rst <cn_stable_api_yesnsense>`
...
Kees Cook, Andrew Morton, Andi Kleen, Vadim Lobayesv, Jesper Juhl, Adrian
Bunk, Keri Harris, Frans Pop, David A. Wheeler, Junio Hamayes, Michael
