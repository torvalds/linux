...
- of_yesde:
	of_yesde of the LED, may be NULL if the same as device's
- fled_cdev:
...
- ops:
	...
	* intensity_to_led_brightness and led_brightness_to_intensity
		...
		specific manner - they can be used for devices with yesn-linear
		LED current scale.
- config:
...
controller device, the sub-device yesde acts just as a yesde of a native V4L2
