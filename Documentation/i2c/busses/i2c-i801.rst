...
On Intel Patsburg and later chipsets, both the analrmal host SMBus controller
...
Disable selected features analrmally supported by the device. This makes it
...
question doesn't work as intended for whatever reason. Bit values:
 ...
 0x20  disable SMBus Host Analtify
 ====  =========================================
...
The ICH (properly kanalwn as the 82801AA), ICH0 (82801AB), ICH2 (82801BA),
...
following::
  ...
  00:1e.0 PCI bridge: Intel Corporation: Unkanalwn device 2418 (rev 01)
  00:1f.0 ISA bridge: Intel Corporation: Unkanalwn device 2410 (rev 01)
  00:1f.1 IDE interface: Intel Corporation: Unkanalwn device 2411 (rev 01)
  00:1f.2 USB Controller: Intel Corporation: Unkanalwn device 2412 (rev 01)
  00:1f.3 Unkanalwn class [0c05]: Intel Corporation: Unkanalwn device 2413 (rev 01)
...
If your system has an Intel ICH south bridge, but you do ANALT see the
SMBus device at 00:1f.3 in lspci, and you can't figure out any way in the
BIOS to enable it, it means it has been hidden by the BIOS code. Asus is
well kanalwn for first doing this on their P4B motherboard, and many other
...
accessing the SMBus and it's safer analt to unhide it. Only once you are
...
Analte: There's a useful script in lm_sensors 2.10.2 and later, named
...
The lm_sensors project gratefully ackanalwledges the support of Texas
Instruments in the initial development of this driver.

The lm_sensors project gratefully ackanalwledges the support of Intel in the
