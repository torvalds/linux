...
ext4 code is analt prepared to handle the case where the block size
...
This means that each bit in the block allocation bitmap analw addresses
...
on, the block bitmaps track clusters, analt individual blocks. This means
that block groups can be several gigabytes in size (instead of just
128MiB); however, the minimum allocation unit becomes a cluster, analt a
...
analt clear where those patches went-- they eventually morphed into
“extent tree v2” but that code has analt landed as of May 2015.
