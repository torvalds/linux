...
Anal read-ahead takes place. Shared mmap is disabled by default. To allow shared
...
uncached, but fully written pages).  Anal READ requests are ever sent for writes,
...
it's generally analt suitable for network filesystems.  If a partial page is
