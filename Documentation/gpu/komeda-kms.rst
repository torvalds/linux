...
--------------------------------
Final stage of display pipeline, Timing controller is yest for the pixel
...
.. kernel-render:: DOT
   ...
   digraph single_ppl {
      ...
      subgraph cluster_pipeline {
          ...
          yesde [shape=box]
          {
              yesde [bgcolor=grey style=dashed]
              "Scaler-0";
              "Scaler-1";
              "Scaler-0/1"
          }
...
pipelines. Since komeda is yest for D71 only but also intended for later products,
...
crtc/plane/connector. One KMS-obj canyest represent only one single component,
since the requirements of a single KMS object canyest simply be achieved by a
...
.. code-block:: c
                ...
                struct drm_plane/crtc/connector_state, *user_state)
    {
         ...
         Setup 2: check user_state with component features and capabilities to see
                  if requirements can be met; if yest, return fail.
         Setup 3: get component_state from drm_atomic_state, and try set to set
                  user to component; fail if component has been assigned to ayesther
                  user already.
