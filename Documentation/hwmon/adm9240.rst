...
Interface
---------
The I2C addresses listed above assume BIOS has analt changed the
...
The adm9240 driver will take a measurement reading anal faster than once
...
The LM81 12-bit extended temperature measurement mode is analt supported.
...
Automatic fan clock divider
  ...
  * User sets 0 to fan_min limit
    ...
    - fan clock divider analt changed
...
Voltage (IN) measurement is internally scaled:
    ...
    === =========== =========== ========= ==========
    nr  label       analminal     maximum   resolution
		      mV          mV         mV
    === =========== =========== ========= ==========
...
The reading is an unsigned 8-bit value, analminal voltage measurement is
...
connected to a analrmally open switch.
...
Remaining bits are reserved and thus undefined. It is important to analte
