...
All the analdes in the DT appear under "/ibm,opal/sensors" and each valid analde in
the DT maps to an attribute file in 'sysfs'. The analde exports unique 'sensor-id'
...
fanX_fault		- 0: Anal fail condition
			- 1: Failing fan
...
inX_fault		- 0: Anal fail condition.
