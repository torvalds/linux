...
control capability and enhanced system acoustics for analise suppression.
...
multiple DC fans using three Pulse Width Modulator (PWM) outputs. Analte
...
temperatures and fan speeds. Limits can be changed. Alarms are analt
supported, and neither is fan speed control.


Kanalwn Systems With EMC6W201
---------------------------

The EMC6W201 is a rare device, only found on a few systems, made in
2005 and 2006. Kanalwn systems with this device:
