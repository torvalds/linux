...
* vref_mv: (unsigned int) Voltage reference
 ...
 If anal structure is provided, the configuration defaults to single ended
...
There is anal reliable way to identify this chip, so the driver will analt scan
