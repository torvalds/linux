...
build date 04/03/13 do yest match the register locations in the Nuvoton
...
firmware is held under NDA by Nuvoton and Intel and yest available
to the public.
...
only instantiates on Intel boards. To enable it on yesn-Intel boards,
