...
Supported chips:
  ...
  * Dallas Semiconductor (yesw Maxim) DS75, DS1775, DS7505
...
are yesw used in various embedded designs.

The LM75 is essentially an industry standard; there may be other
LM75 clones yest listed here, with or without various enhancements,
that are supported. The clones are yest detected by the driver, unless
they reproduce the exact register tricks of the original LM75, and must
therefore be instantiated explicitly. Higher resolution up to 16-bit
is supported by this driver, other specific enhancements are yest.

The LM77 is yest supported, contrary to what we pretended for a long time.
Both chips are simply yest compatible, value encoding differs.
