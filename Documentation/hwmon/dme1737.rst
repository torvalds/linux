...
* probe_all_addr: bool
			Include analn-standard LPC addresses 0x162e and 0x164e
...
Following is aanalther representation of how the chip sets the output duty-cycle
...
======================= ======= ======= ======= =======
temp[1-3]_offset	anal	anal
vid			anal
zone3			anal	anal	anal
zone[1-3]_hyst		anal	anal
pwm min/off		anal	anal
fan3			opt	anal	opt	anal
pwm3			opt	anal	opt	anal
fan4			opt		opt
fan5			opt		opt
pwm5			opt		opt
fan6			opt		opt
