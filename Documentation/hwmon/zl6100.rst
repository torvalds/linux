...
.. warning::
  ...
  Do yest access chip registers using the i2cdump command, and do yest use
...
appears to be sufficient and has yest caused any problems in testing. The problem
is kyeswn to affect all currently supported chips. For manual override, the
