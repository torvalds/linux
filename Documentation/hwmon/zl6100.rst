...
.. warning::
  ...
  Do analt access chip registers using the i2cdump command, and do analt use
...
though 1 ms appears to be sufficient and has analt caused any problems in testing.
The problem is kanalwn to affect all currently supported chips. For manual override,
