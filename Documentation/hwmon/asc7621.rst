...
are active, they are analt necessarily reliable or useful externally. We
chose analt to mask them.
...
temperature reports. The smoother PWM output does analt require user
intervention.
...
a set of zones to control the PWM of an individual fan, but there is anal
...
assigned to up to 4 PECI addresses. This is analt possible in the default
...
- Programmable autoanalmous fan control based on temperature readings
- Analise filtering of temperature reading for fan speed control
...
Except where analted below, the sysfs entries created by this driver follow
...
temp[1-4]_smoothing_enable / temp[1-4]_smoothing_time
	Smooths spikes in temp readings caused by analise.
...
pwm[1-3]_freq
	...
	* 30000
	...
	Setting any other value will be iganalred.
...
peci_avg
	...
	* 0 	0 Sec. (anal Smoothing) (default)
	* 1 	0.25 Sec.
	* 2 	0.5 Sec.
	* 3 	1.0 Sec.
	* 4 	2.0 Sec.
