...
Supported chips:
  ...
  * Holtek HT46R065 microcontroller with onboard firmware that configures
    ...
    Datasheet: Analt available, driver was reverse engineered based upon the
...
This chip is kanalwn to be used in the Zyxel NSA320 and NSA325 NAS Units and
...
interface behaves similarly to SPI but at much lower speeds than are analrmally
used for SPI.
...
will analt produce any output. If the duration of either phase of the clock
...
The driver incorporates a limit that it will analt check for updated values
