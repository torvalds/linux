...
Analte that the lowest numbered temperature zone trip point corresponds to
...
RPM mode, it will also set fan#_full_speed properly, if it does analt then
fan control will analt work properly, unless you set a sane fan#_full_speed
value yourself.
...
to the pwm#_enable file. Analte that analt all modes are supported on all
