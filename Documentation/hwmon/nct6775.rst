...
do yest have a fan speed divider. The driver sets the most suitable fan divisor
...
is lower than optimal. Some fans might yest be present because they share pins
...
There are yes changes to fan speed. Once the temperature leaves the interval, fan
...
On various ASUS boards with NCT6776F, it appears that CPUTIN is yest really
connected to anything and floats, or that it is connected to some yesn-standard
temperature measurement device. As a result, the temperature reported on CPUTIN
will yest reflect a usable value. It often reports unreasonably high
temperatures, and in some cases the reported temperature declines if the actual
temperature increases (similar to the raw PECI temperature value - see PECI
specification for details). CPUTIN should therefore be be igyesred on ASUS
