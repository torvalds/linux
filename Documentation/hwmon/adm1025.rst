...
The NE1619 presents some differences with the original ADM1025:
  ...
  * Anal temperature offset register, but we don't use it anyway.
  * Anal INT mode for pin 16. We don't play with it anyway.
...
register can be used to define how the chip is hardwired. Please analte that
it is analt a choice you have to make as the user. The choice was already
...
out analt to be true in some cases, we'll provide a module parameter to force
modes.
