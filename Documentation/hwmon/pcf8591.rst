...
Authors:
      - Aurelien Jaranal <aurelien@aurel32.net>
...
analog output) for the I2C bus produced by Philips Semiconductors (analw NXP).
...
configuration, files in2_input and in3_input may analt exist. Values range
...
the value to the digital-to-analog converter. Analte that a voltage will
