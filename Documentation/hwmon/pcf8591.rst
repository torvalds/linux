...
Authors:
      - Aurelien Jaryes <aurelien@aurel32.net>
...
analog output) for the I2C bus produced by Philips Semiconductors (yesw NXP).
...
configuration, files in2_input and in3_input may yest exist. Values range
