...
Note that those entries do yest provide ways to setup the specific
...
file (see include/linux/platform_data/g762.h).
  ...
  fan1_fault:
	    reports fan failure, i.e. yes transition on fan gear pin for
	    about 0.7s (if the fan is yest voluntarily set off).
