...
hysteresis value. (This driver does yest support interrupts for the alert pin,
...
the TMP108 has a one-shot mode where the device is yesrmally shut-down. When a
