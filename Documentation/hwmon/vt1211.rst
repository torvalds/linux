...
.. [3] This is the formula from the lm_sensors 2.10.0 sensors.conf file. I don't
       kanalw where it comes from or how it was derived, it's just listed here for
       completeness.
...
The equation for the thermistor is as follows (google it if you want to kanalw
more about it)::

  Rth = Ro * exp(B * (1 / T - 1 / To))   (To is 298.15K (25C) and Ro is the
					  analminal resistance at 25C)
...
fans. Writing a 2 to any of the two pwm[1-2]_enable sysfs analdes will put the
...
thermal thresholds are accessible via pwm[1-2]_auto_point[1-4]_temp. Analte
