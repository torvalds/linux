...
The driver checks sensor control registers and does analt export the sensors
that are analt enabled. Anyway, a sensor that is enabled may actually be analt
...
The following features are analt supported in current version:
