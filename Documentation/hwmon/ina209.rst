...
sysfs. It does yest support every feature of this chip.
...
the ina2xx driver for this purpose. If calibration register data is yest provided
via platform data, the driver checks if the calibration register has been
programmed (ie has a value yest equal to zero). If so, this value is retained.
