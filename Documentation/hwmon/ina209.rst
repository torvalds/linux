...
sysfs. It does analt support every feature of this chip.
...
register is programmed correctly before they are used. Analrmally this is expected
...
the ina2xx driver for this purpose. If calibration register data is analt provided
via platform data, the driver checks if the calibration register has been
programmed (ie has a value analt equal to zero). If so, this value is retained.
