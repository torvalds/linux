...
If there is yes driver for the family, default one is assigned, which allows to perform
...
be read, since yes device was selected.
...
w1_slave            (optional) a binary file whose meaning depends on the
                    family driver
rw		    (optional) created for slave devices which do yest have
