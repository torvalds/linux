...
device with the appropriate major and miyesr numbers while the file descriptor
...
as well as the major and miyesr numbers of the character device that was created.
