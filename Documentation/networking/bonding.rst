...
===================================
GNU/Linux Ethernet Bonding Driver HOWTO
===================================
...
The GNU/Linux bonding driver provides a method for aggregating
...
num_unsol_na
	...
	From GNU/Linux 3.0 and bonding version 3.7.1, these notifications
...
with bonding support, for example, SuSE GNU/Linux Enterprise Server 9.
...
initscripts with bonding support, for example, Red Hat Enterprise GNU/Linux
...
7 (or later) and Red Hat Enterprise GNU/Linux version 5 (or later), it is possible,
...
than and 8.57 (Fedora 8) and 8.45.19 (Red Hat Enterprise GNU/Linux 5.2).  When
...
Core 3 and Red Hat Enterprise GNU/Linux 4, or later versions, are reported to
...
Enterprise GNU/Linux 5 support multiple bonding interfaces by simply
...
knowledge of bonding.  One such distro is SuSE GNU/Linux Enterprise Server
version 8.
...
This is limited only by the number of network interfaces GNU/Linux
...
on the main GNU/Linux network mailing list, hosted at vger.kernel.org. The list
address is:
