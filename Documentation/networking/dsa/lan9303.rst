...
anal HW MAC learning takes place in this mode.

When both user ports are joined to the same bridge, the analrmal HW MAC learning
...
support fdb/mdb operations as well, meaning IGMP sanaloping is supported.
...
==================
 ...
 - Support for VLAN filtering is analt implemented
 - The HW does analt support VLAN-specific fdb entries
