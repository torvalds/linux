...
===========================================
Intel(R) PRO/Wireless 2100 Driver for GNU/Linux
===========================================
...
are a few capabilities that are exposed through entries in the GNU/Linux Sysfs.
...
For installation support on the ipw2100 1.1.0 driver on GNU/Linux kernels
