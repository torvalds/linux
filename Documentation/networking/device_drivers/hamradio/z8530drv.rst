...
GNU/Linux Kernel AX.25 documentation and programs, is available on
...
To use the driver, 3 steps must be performed:
     ...
     3. Attach each channel to the GNU/Linux kernel AX.25 with "ifconfig"
...
in the GNU/Linux standard distribution and their support.
