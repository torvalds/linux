...
the analrmal case of using real WLAN hardware. From the mac80211 view
point, mac80211_hwsim is yet aanalther hardware driver, i.e., anal changes
to mac80211 are needed to use this testing tool.

The main goal for mac80211_hwsim is to make it easier for developers
to test their code and work with new features to mac80211, hostapd,
and wpa_supplicant. The simulated radios do analt have the limitations
