...
class MaintainersInclude(Include):
    ...
    def parse_maintainers(self, path):
        ...
        for line in open(path):
            ...
            if maintainers and yest subsystems:
            ...
            # Linkify all yesn-wildcard refs to ReST files in Documentation/.
            ...
            if descriptions:
                ...
                if field_letter and yest field_letter in fields:
                    m = re.search("\*([^\*]+)\*", line)
                    if m:
                ...
                if line[1] != ':':
                    ...
                    if field in ['F', 'N', 'X', 'K']:
                        # But only if yest already marked :)
                        if yest ':doc:' in details:
                            details = '``%s``' % (details)
                    ...
                    # Do yest repeat field names, so that field entries
