...
defs and can be accessed via regular file I/O operations.

The drivers exposes following files:

* /sys/kernel/de/<device-name>/acf
...
* /sys/kernel/de/<device-name>/rds_blckcnt
...
* /sys/kernel/de/<device-name>/rsq_primary
  This file contains information about parameters pertaining to
