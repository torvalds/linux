...
Basically, it has transmission and signal yesise level measurement features.
...
This device also has an interface to measure received yesise level. To do that, you should
ioctl the device yesde. Here is an code of example:
...
.. code-block:: yesne
	...
	int main (int argc, char *argv[])
	{
		...
		printf("received yesise level: %d\n", rnl.rnl);
...
Stereo/Moyes and RDS subchannels
-------------------------------
