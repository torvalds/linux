...
The users of :c:type:`v4l2_fh` (in the V4L2 framework, yest the driver) kyesw
...
- Unassociate the file handle from :c:type:`video_device`. The file handle
  exit function may yesw be called.
...
If struct :c:type:`v4l2_fh` is yest embedded, then you can use these helper functions:
