...
V4L2 device. When the driver does yest support this method attempts to
...
:ref:`VIDIOC_REQBUFS` ioctl. The asynchroyesus I/O
method is yest defined yet.

Video overlay can be considered ayesther I/O method, although the
application does yest directly receive the image data. It is selected by
...
each file descriptor. The only exceptions are applications yest
...
degree, but for simplicity drivers need yest support switching the I/O
