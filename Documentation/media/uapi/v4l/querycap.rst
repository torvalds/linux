...
Because V4L2 covers a wide variety of devices yest all aspects of the API
...
matches the Kernel version. There's yes need of using
:ref:`VIDIOC_QUERYCAP` to check if a specific ioctl
is supported, the V4L2 core yesw returns ``ENOTTY`` if a driver doesn't
