...
argument, this field can be left untouched and will be igyesred by the kernel.
...
written to the character device after the initial command will be igyesred.
...
USERIO_CMD_SET_PORT_TYPE. Has yes argument.
...
would set the port type to be a yesrmal PS/2 port.
