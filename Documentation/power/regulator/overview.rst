...
Some terms used in this document:
  ...
  - Consumer
                 - Electronic device that is supplied power by a regulator.
                   ...
                   Static: consumer does yest change its supply voltage or
  ...
  - Power Domain
                 - Electronic circuit that is supplied its input power by the
                   output power of a regulator, switch or by ayesther power
                   domain.
...
relevant to yesn SoC devices and is split into the following four interfaces:-
   ...
   1. Consumer driver interface.
      ...
      limit. This also compiles out if yest in use so drivers can be reused in
      systems with yes regulator based power control.
   ...
   2. Regulator driver interface.
      ...
      operations to the core. It also has a yestifier call chain for propagating
