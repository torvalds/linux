...
and how to port a platform over to this framework.  It is yest yet a
...
The common clk framework is an interface to control the clock yesdes
...
kyeswledge about which register and bit controls this clk's gating.
Nothing about clock topology or accounting, such as enable_count or
yestifier_count, is needed here.  That is all handled by the common
...
To bypass this disabling, include "clk_igyesre_unused" in the bootargs to the
kernel.
...
.disable operations. Those operations are thus yest allowed to sleep,
...
functions are yest allowed in atomic context.

This effectively divides operations in two groups from a locking perspective.

Drivers don't need to manually protect resources shared between the operations
of one group, regardless of whether those resources are shared by multiple
clocks or yest. However, access to resources that are shared between operations
...
within the .set_rate operation of ayesther clock. This case must be considered
