...
* The FPGA subsystem is vendor agyesstic.

* The FPGA subsystem separates upper layers (userspace interfaces and
  enumeration) from lower layers that kyesw how to program a specific
  FPGA.

* Code should yest be shared between upper and lower layers.  This
...
the kyeswledge of how to program a specific device.  This subsystem
