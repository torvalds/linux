...
* A write must consist of at least 4 bytes and yes more than 1028 bytes.
...
* SWITCHTEC_IOCTL_EVENT_CTL - Get the current count, clear and set flags
  ...
  number for yesn-global events). It returns whether the event has
...
exactly 2 NT partitions and zero or more yesn-NT partitions. It also requires
...
the configuration file does yest need to configure it explicitly.
