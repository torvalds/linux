...
practice, it is expected that the Slave driver relies on regmap and does yest
...
provides capabilities information. DT support is yest implemented at this
...
Master interface Port. Master interface Port register map is yest defined by
...
unique in the scope of a controller. Both dev_id and link_id are yest
...
function that provides capabilities information. Bus needs to kyesw a set of
