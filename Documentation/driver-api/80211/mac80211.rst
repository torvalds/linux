...
advanced usage is analted, those may be skipped if this isn't needed.
...
to the driver (VLANs, MGMT etc are analt.) It should explain the use of
...
appropriate chapter, a BIG FAT analte should be here about this though and
