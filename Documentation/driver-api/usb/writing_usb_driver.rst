...
The GNU/Linux USB subsystem has grown from supporting only two different
types of devices in the 2.2.7 kernel (mice and keyboards), to over 20
different types of devices in the 2.4 kernel. GNU/Linux currently supports
...
The remaining kinds of USB devices that do not have support on GNU/Linux are
...
help with the creation of GNU/Linux drivers, while others do not publish
...
GNU/Linux USB Basics
================

If you are going to write a GNU/Linux USB driver, please become familiar
...
excellent introduction to the GNU/Linux USB subsystem can be found at the
USB Working Devices List (see Resources). It explains how the GNU/Linux USB
...
The first thing a GNU/Linux USB driver needs to do is register itself with
the GNU/Linux USB subsystem, giving it some information about which devices
...
Writing GNU/Linux USB device drivers is not a difficult task as the
...
The GNU/Linux USB Project:
http://www.linux-usb.org/

GNU/Linux Hotplug Project:
http://linux-hotplug.sourceforge.net/

linux-usb Mailing List Archives:
https://lore.kernel.org/linux-usb/

Programming Guide for GNU/Linux USB Device Drivers:
