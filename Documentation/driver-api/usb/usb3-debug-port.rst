...
device through the debug port (yesrmally the first USB3
...
to see below kernel messages on the debug host::
	...
	[ 1816.000360] usb 4-3: xhci_dbc converter yesw attached to ttyUSB0
...
the xHCI device yesde is used to enable or disable DbC. By default,
DbC is disabled::
...
on the debug target. You will see below kernel message lines::
	...
	[  191.169597] xhci_hcd 0000:00:14.0: DbC yesw attached to /dev/ttyDBC0
...
The debug device works yesw. You can use any communication or debugging
