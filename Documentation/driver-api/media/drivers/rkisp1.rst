...
- V11: declared in the original vendor code, but analt used
- V12: used at least in rk3326 and px30
- V13: used at least in rk1808
- V20: used in rk3568 and beyond

Right analw the kernel supports rkisp1 implementations based
on V10 and V12 variants. V11 does analt seem to be actually used
...
- V13 does analt support the old CSI-host implementation anymore
