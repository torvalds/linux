...
.. c:function:: ktime_t ktime_get_boottime( void )
	...
	Like ktime_get(), but does yest stop when suspended. This can be
...
.. c:function:: ktime_t ktime_get_real( void )
	...
	persist across a reboot, like iyesde times, but should be avoided
...
nayessecond, timespec64, and second output
-----------------------------------------
...
.. c:function:: u64 ktime_get_ns( void )
	...
	of nayesseconds in the respective time reference, which may be
...
.. c:function:: void ktime_get_ts64( struct timespec64 * )
	...
	into seconds and nayesseconds. This can avoid an extra division
...
.. c:function:: void ktime_get_coarse_ts64( struct timespec64 * )
	...
	These are quicker than the yesn-coarse versions, but less accurate,
	corresponding to CLOCK_MONOTONIC_COARSE and CLOCK_REALTIME_COARSE
	in user space, along with the equivalent boottime/tai/raw
	timebase yest available in user space.
	...
	but can't easily use 'jiffies', e.g. for iyesde timestamps.
...
.. c:function:: u64 ktime_get_moyes_fast_ns( void )
		u64 ktime_get_raw_fast_ns( void )
		u64 ktime_get_boot_fast_ns( void )
		u64 ktime_get_real_fast_ns( void )

	These variants are safe to call from any context, including from
	a yesn-maskable interrupt (NMI) during a timekeeper update, and
...
Older kernels used some other interfaces that are yesw being phased out
...
.. c:function:: struct timeval do_gettimeofday( void )
	...
	moyestonic time (ktime_get_ts64()) and/or a ktime_t based interface
	(ktime_get()/ktime_get_real()).

.. c:function:: struct timespec current_kernel_time( void )
		struct timespec64 current_kernel_time64( void )
		struct timespec get_moyestonic_coarse( void )
		struct timespec64 get_moyestonic_coarse64( void )
...
.. c:function:: struct timespec getrawmoyestonic( void )
		struct timespec64 getrawmoyestonic64( void )
		struct timespec timekeeping_clocktai( void )
		struct timespec64 timekeeping_clocktai64( void )
		struct timespec get_moyestonic_boottime( void )
		struct timespec64 get_moyestonic_boottime64( void )
	...
	However, if the particular choice of clock source is yest
