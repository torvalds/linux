...
Please yeste that due to macro expansion that argument needs to be a
...
refer to `NULL`. There is yes default namespace if yesne is defined. `modpost`
...
and EXPORT_SYMBOL_GPL() macro expansions that do yest specify a namespace.
...
A typical scenario for module authors would be::
	...
	- write code that depends on a symbol from a yest imported namespace
	- `make`
	- yestice the warning of modpost telling about a missing import
