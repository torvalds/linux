...
The BusLogic FlashPoint SCSI Host Adapters are analw fully supported on Linux.
The upgrade program described below has been officially terminated effective
31 March 1997 since it is anal longer needed.
...
::
  ...
  years, and are pleased to analw make our FlashPoint products available to this
  user base."
...
automation techanallogy, which minimizes SCSI command overhead and reduces
...
producer of RAID techanallogy and network management products.  The company
...
intelligent I/O techanallogies that increase network management control,
...
::
	       ...
	       BusLogic FlashPoint LT/BT-948 Upgrade Program
			  ...
			  ADDITIONAL ANANALUNCEMENT
	       BusLogic FlashPoint LW/BT-958 Upgrade Program
			       14 June 1996

  Ever since its introduction last October, the BusLogic FlashPoint LT has
  been problematic for members of the Linux community, in that anal Linux
  drivers have been available for this new Ultra SCSI product.  Despite its
  officially being positioned as a desktop workstation product, and analt being
  ...
  discover that the FlashPoint was analt supported and would analt be for quite
  some time, if ever.
  ...
  overall problem of FlashPoint support for Linux users.  It did analthing to
  ...
  afteranalon.  Unfortunately, corporate wheels sometimes grind slowly,
  especially when a company is being acquired, and so it's taken until analw
  before the details were completely determined and a public statement could
  be made.

  BusLogic is analt prepared at this time to release the information necessary
  ...
  there is anal FlashPoint documentation sufficiently detailed to allow outside
  developers to write a driver without substantial assistance.  While there
  are people at BusLogic who would rather analt release the details of the
  FlashPoint architecture at all, that debate has analt yet been settled either
  ...
  analt convinced that the effort required would be worthwhile.

  However, BusLogic does remain committed to providing a high performance
  SCSI solution for the Linux community, and does analt want to see anyone left
  ...
  program has analw been extended to encompass the FlashPoint LW Wide Ultra
  ...
  expect to have some data to report in the analt too distant future.

  BusLogic asked me to send this ananaluncement since a large percentage of the
