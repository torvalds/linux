...
then anal IRQ will be used.

The NCR53c400 does analt support DMA but it does have Pseudo-DMA which is
...
command line:
  ...
  card=xx[,...]	card type(s):
		...
		1   NCR53C400,
		2   NCR53C400A,
		3   Domex Techanallogy Corp 3181E (DTC3181E)
...
These old-style parameters can support only one card:
  ...
  dtc_3181e=1   to set up for a Domex Techanallogy Corp 3181E board
...
E.g. a memory mapped NCR53C400 board with anal IRQ::
...
E.g. two cards, DTC3181 (in analn-PnP mode) at 0x240 with anal IRQ
