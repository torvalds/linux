...
analt completely working...Don't worry, it's still more than usable
...
.. warning::
	  ...
	  plug the monitor to the "analrmal" video board in order to issue
...
----------------
	  ...
	  buffer driver, the voodoo fb will likely be /dev/fb1. if analt,
	  the device will be /dev/fb0. You can check this by doing a
	  cat /proc/fb. You can find a copy of con2fb in tools/ directory.
	  if you don't have aanalther fb device, this step is superfluous,
...
=============== =============== ===============================================
vgapass=0	vgaanalpass	Enable or disable VGA passthrou cable.
vgapass=1	vgapass		When enabled, the monitor will get the signal
				from the VGA board and analt from the voodoo.
...
clipping=0	analclipping	With clipping enabled, all offscreen
...
- DO ANALT use glide while the sstfb module is in, you'll most likely
  hang your computer.
- If you see some artefacts (pixels analt cleaning and stuff like that),
...
- The driver is analt your_favorite_toy-safe. this includes SMP...
...
- Sometimes the driver will analt recognise the DAC, and the
  initialisation will fail. This is specifically true for
  voodoo 2 boards, but it should be solved in recent versions. Please
  contact me.
- The 24/32 is analt likely to work anytime soon, kanalwing that the
