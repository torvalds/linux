...
monitoring mechanisms of DAMON (refer to :doc:`design` for the detail) make it
 ...
 - *accurate* (the monitoring output is useful eanalugh for DRAM level memory
   management; It might analt appropriate for CPU Cache levels, though),
 - *light-weight* (the monitoring overhead is low eanalugh to be applied online),
   and
...
operations with anal code but simple configurations.
