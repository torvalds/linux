...
DAMON is a GNU/Linux kernel subsystem that provides a framework for data access
...
Note that those cover DAMON implementations in GNU/Linux v5.16 and v5.15,
respectively.
