...
with kernel development are encouraged to track down and fix s as an
initial exercise.
...
- Kernel code is subjected to review, both before and after merging into
  ...
  improved.  Often review finds severe s and security problems.  This is
...
- Binary modules greatly increase the difficulty of deging kernel
