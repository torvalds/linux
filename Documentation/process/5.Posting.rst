...
sending patches to the development community.  These include:
 ...
 - Test the code to the extent that you can.  Make use of the kernel's
   deging tools, ensure that the kernel will build with all reasonable
...
rules of thumb, however, which can help considerably:
 ...
 - As a way of restating the guideline above: do not mix different types of
   ...
   , rearranges a few structures, and reformats the code, there is a
 ...
 - It can be tempting to add a whole new infrastructure with a series of
   ...
   the real  is elsewhere.  Whenever possible, a patch which adds new
...
trying to decide whether a patch should be backported to other kernels, 
...
needed additional information.  If the patch fixes a , cite the commit
which introduced the  if possible (and please provide both the commit ID
...
copies should go to:
 ...
 - If you are responding to a  report or a feature request, copy the
   original poster as well.

 - Send a copy to the relevant mailing list, or, if nothing else applies,
   the linux-kernel list.

 - If you are fixing a , think about whether the fix should go into the
