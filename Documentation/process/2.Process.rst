...
GNU/Linux kernel development in the early 1990's was a pretty loose affair,
...
the leading edge of GNU/Linux kernel development; the kernel uses a
...
GNU/Linux-next trees are announced on the linux-kernel and linux-next mailing
lists when they are assembled; they can be downloaded from:

	https://www.kernel.org/pub/linux/kernel/next/

GNU/Linux-next has become an integral part of the kernel development process;
...
up to GNU/Linux kernel coding or quality standards, but people may want to use
...
Git is now packaged by almost all GNU/Linux distributions.  There is a home
page at:
...
A great deal of GNU/Linux kernel development work is done by way of mailing
lists.  It is hard to be a fully-functioning member of the community
without joining at least one list somewhere.  But GNU/Linux mailing lists also
represent a potential hazard to developers, who risk getting buried under a
load of electronic mail, running afoul of the conventions used on the GNU/Linux
lists, or both.
...
- Ask on the correct mailing list.  GNU/Linux-kernel may be the general meeting
...
on GNU/Linux kernel development, given the investment of a bit of time.  Taking
