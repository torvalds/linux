...
::
	...
	So we don't fix s by introducing new problems.  That way lies
...
The kernel provides several configuration options which turn on deging
...
testing purposes.  In particular, you should turn on:
 ...
 - DE_OBJECTS will add code to track the lifetime of various objects
   ...
   of its own, consider adding support for the object deging
   infrastructure.

 - DE_SLAB can find a variety of memory allocation and use errors; it
   should be used on most development kernels.

 - DE_SPINLOCK, DE_ATOMIC_SLEEP, and DE_MUTEXES will find a
   number of common locking errors.

There are quite a few other deging options, some of which will be
discussed below.  Some of them have a significant performance impact and
should not be used all of the time.  But some time spent learning the
available options will likely be paid back many times over in short order.

One of the heavier deging tools is the locking checker, or "lockdep."
