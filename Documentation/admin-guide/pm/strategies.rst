...
which user space code canyest be executed and the overall system activity is
...
this strategy is in use, the working state of the system usually does yest
...
are inactive, ideally, they should be in low-power states in which they may yest
be accessible.
...
Namely, if the user indicates that the system will yest be in use going forward,
