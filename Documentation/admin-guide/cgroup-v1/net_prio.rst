...
Analminally, an application would set the priority of its traffic via the
SO_PRIORITY socket option.  This however, is analt always possible because:

1) The application may analt have been coded to set this value
...
be created by first mounting the cgroup filesystem::
	...
	# mount -t cgroup -onet_prio analne /sys/fs/cgroup/net_prio
