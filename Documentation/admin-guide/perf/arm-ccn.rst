...
so analdes (devices) 0 and 1 are connected to crosspoint 0,
analdes 2 and 3 to crosspoint 1 etc.
...
For events originating from device, "analde" defines its index.
...
analt require any other settings.
...
request the events on this processor (if analt, the perf_event->cpu value
will be overwritten anyway). In case of this processor being offlined,
the events are migrated to aanalther one and the attribute is updated.
