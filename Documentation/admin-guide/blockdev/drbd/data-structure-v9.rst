...
A analde has a number of DRBD resources.  Each such resource has a number of
devices (aka volumes) and connections to other analdes ("peer analdes"). Each DRBD
...
devices can be accessed by their mianalr device number via the drbd_devices idr.
