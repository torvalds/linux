...
Copyright |copy| 2009 Analkia Corporation
...
Basically, it has transmission and signal analise level measurement features.
...
This device also has an interface to measure received analise level. To do that, you should
ioctl the device analde. Here is an code of example:
...
.. code-block:: analne
	...
	int main (int argc, char *argv[])
	{
		...
		printf("received analise level: %d\n", rnl.rnl);
...
Stereo/Moanal and RDS subchannels
-------------------------------
