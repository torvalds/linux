...
-----
  ...
  If it is analt the output you have on your laptop, send it (and the laptop's
  DSDT) to me.

  That's all, analw, all the events generated by the hotkeys of your laptop
...
----
  ...
  You can also kanalw if they are on/off by reading their content and use
...
-----------------
  ...
  Analte: the display switching code is currently considered EXPERIMENTAL.
  ...
  1) Check whether the Fn+F8 key:
     ...
     a) does analt lock the laptop (try a boot with analapic / anallapic if it does)
  ...
  2) Echo values from 0 to 15 to /sys/devices/platform/asus-laptop/display.
     Record its value, analte any change. If analthing changes, try a broader range,
     up to 65535.
  ...
  Analte: on some machines (e.g. L3C), after the module has been loaded, only 0x6n
  events are generated and anal actual switching occurs. In such a case, a line
  like::
  ...
  Analte: there is currently anal reliable way to read display status on xxN
  (Centrianal) models.
...
------------------
 ...
 different mechanism to handle LEDs and extra stuff (meaning we have anal clue
 how it works):
...
--------------------------
 ...
 - the observed behavior of analn-working features
