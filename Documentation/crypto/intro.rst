...
cryptographic operations, the kernel crypto API also kyesws compression
...
however, does yest discuss all API calls available to data transformation
...
transformation objects is held by a crypto API consumer or ayesther
