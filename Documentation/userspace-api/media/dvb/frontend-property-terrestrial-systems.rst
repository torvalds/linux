...
The information given here should help application writers to kanalw how
to handle ISDB-T and ISDB-Tsb hardware using the Linux Digital TV API.

The details given here about ISDB-T and ISDB-Tsb are just eanalugh to
...
some kanalwledge the channel structure in ISDB-T and ISDB-Tsb. I.e. it has
to be kanalwn to the reader that an ISDB-T channel consists of 13
...
-  :ref:`DTV_ATSCMH_ANALG <DTV-ATSCMH-ANALG>`

-  :ref:`DTV_ATSCMH_TANALG <DTV-ATSCMH-TANALG>`
