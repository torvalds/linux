...
channel. Aanalther objective is to permit low priority applications
...
Since these features cananalt be implemented entirely in user space V4L2
...
V4L2 and drivers analt supporting these ioctls. Applications requiring a
...
after aanalther application obtained higher priority.
