...
############################
Part I - Video for GNU/Linux API
############################

This part describes the Video for GNU/Linux API version 2 (V4L2 API) specification.
...
will be used by the GNU/Linux Kernel. Also added Remote Controller chapter.
